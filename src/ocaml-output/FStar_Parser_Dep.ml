            ...
            let record_open_module_or_namespace uu____504 =
              ...
              | (lid,kind) ->
                  (match kind with
                   ...
                   | Open_module  ->
                       let uu____509 = record_open_module lid  in ())
               in
                   ...
                   (check_module_declaration_against_filename lid filename;
                    ...
                    then
                      (let uu____697 =
                         ...
                         enter_namespace original_map working_map uu____698
                          in
                       ())
                    else ();
                         ...
                         FStar_List.iter
                           (fun uu____707  ->
                              ...
                              | (m,r) ->
                                  let uu____715 =
                                    let uu____716 =
                                      let uu____717 = string_of_lid lid true
                                         in
                                      FStar_String.lowercase uu____717  in
                                    (FStar_String.lowercase m) = uu____716
                                     in
                                  if uu____715
                   ...
                   (check_module_declaration_against_filename lid filename;
                    ...
                    then
                      (let uu____731 =
                         ...
                         enter_namespace original_map working_map uu____732
                          in
                       ())
                    else ();
                    (match verify_mode with
                         ...
                         FStar_List.iter
                           (fun uu____741  ->
                              ...
                              | (m,r) ->
                                  let uu____749 =
                                    let uu____750 =
                                      let uu____751 = string_of_lid lid true
                                         in
                                      FStar_String.lowercase uu____751  in
                                    (FStar_String.lowercase m) = uu____750
                                     in
                                  if uu____749
                                  then FStar_ST.write r true
                                  else ()) verify_flags);
             ...
             and collect_decl uu___88_759 =
               ...
               | FStar_Parser_AST.Tycon (uu____798,ts) ->
                   let ts1 =
                     FStar_List.map
                       (fun uu____813  ->
                          match uu____813 with | (x,doc1) -> x) ts
                      in
               ...
               FStar_List.existsML
                 (fun f1  ->
                    (let uu____1521 = lowercase_module_name f1  in
                     uu____1521 = m1) && (is_implementation f1)) filenames
                in
                   ...
                   (let all_deps =
                      let uu____1583 =
                        let uu____1585 =
                          FStar_List.map
                            (fun dep1  ->
                               let uu____1590 = discover (key :: cycle) dep1
                                  in
                               dep1 :: uu____1590) direct_deps
                           in
                        FStar_List.flatten uu____1585  in
                      FStar_List.unique uu____1583  in
                    FStar_Util.smap_add graph key (all_deps, Black);
                    (let uu____1598 =
                       let uu____1600 = FStar_ST.read topologically_sorted
                          in
                       key :: uu____1600  in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   (f, deps_as_filenames)) as_list) uu____1672
          in
