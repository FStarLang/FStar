                     ...
                     ((let uu____4477 = is_interface f  in
                      ...
                      (let uu____4481 = is_implementation f  in
                       ...
                       then
                         ((let uu____4483 = output_ml_file f  in
                          ...
                          (let cmx_files =
                             ...
                             FStar_All.pipe_right extracted_fst_files
                              ...
                              in
                           (let uu____4509 =
                              let uu____4510 = lowercase_module_name f  in
                              FStar_Options.should_extract uu____4510  in
                            if uu____4509
                            then
                              let uu____4511 = output_cmx_file f  in
                              let uu____4512 = output_ml_file f  in
                              FStar_Util.print3 "%s: %s \\\n\t%s\n\n"
                                uu____4511 uu____4512
                                (FStar_String.concat "\\\n\t" cmx_files)
                            else ());
                           (let uu____4514 = output_krml_file f  in
                         ...
                         (let uu____4517 =
                            (let uu____4520 =
                               let uu____4521 = lowercase_module_name f  in
                               has_implementation file_system_map uu____4521
                                in
            ...
            FStar_All.pipe_right all_fst_files
              (FStar_List.iter
                 (fun fst_file  ->
                    ...
                    let uu____4554 = FStar_Options.should_extract mname  in
                    if uu____4554
                    then
                      let uu____4555 = output_ml_file fst_file  in
                      FStar_Util.smap_add ml_file_map mname uu____4555
                    else ()));
          ...
          let all_krml_files =
            ...
            FStar_All.pipe_right keys
              (FStar_List.iter
                 (fun fst_file  ->
                    let mname = lowercase_module_name fst_file  in
                    let uu____4571 = output_krml_file fst_file  in
                    FStar_Util.smap_add krml_file_map mname uu____4571));
            sort_output_files krml_file_map  in
          (let uu____4573 =
             let uu____4574 =
               FStar_All.pipe_right all_fst_files (FStar_List.map norm_path)
                in
             FStar_All.pipe_right uu____4574 (FStar_String.concat " \\\n\t")
              in
          ...
          (let uu____4584 =
             let uu____4585 =
               FStar_All.pipe_right all_ml_files (FStar_List.map norm_path)
                in
             FStar_All.pipe_right uu____4585 (FStar_String.concat " \\\n\t")
              in
