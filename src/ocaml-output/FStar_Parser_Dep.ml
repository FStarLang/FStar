    ...
    let matches =
      FStar_List.map
        (fun ext  ->
           ...
           if uu___
           then
             let uu___1 = FStar_String.substring f Prims.int_zero (l - lext)
                in
...
let (is_interface : Prims.string -> Prims.bool) =
  fun f  ->
    let uu___ = FStar_String.get f ((FStar_String.length f) - Prims.int_one)
       in
    uu___ = 105
...
let (module_name_of_file : Prims.string -> Prims.string) =
  fun f  ->
    let uu___ =
      let uu___1 = FStar_Util.basename f  in check_and_strip_suffix uu___1
       in
    match uu___ with
...
let (lowercase_module_name : Prims.string -> Prims.string) =
  fun f  ->
    let uu___ = module_name_of_file f  in FStar_String.lowercase uu___
...
let (deps_add_dep : dependence_graph -> Prims.string -> dep_node -> unit) =
  fun uu___  ->
    fun k  ->
      fun v  -> match uu___ with | Deps m -> FStar_Util.smap_add m k v
               ...
               (fun k  ->
                  ...
                  let print dep =
                    ...
                    FStar_Util.format2 "  \"%s\" -> \"%s\"" uu___8
                     ...
                     in
                  FStar_List.map print deps1) uu___7
              in
           FStar_String.concat "\n" uu___6  in
...
let (core_modules : Prims.string Prims.list) =
  let uu___ =
    ...
    let uu___2 =
      ...
      let uu___4 =
        let uu___5 = FStar_Options.pervasives_native_basename ()  in [uu___5]
         in
      uu___3 :: uu___4  in
    uu___1 :: uu___2  in
      ...
      fun get_parsing_data_from_cache  ->
        let from_parsing_data pd original_map1 filename1 =
          ...
          let add_dep deps2 d =
            ...
            then
              let uu___1 =
                let uu___2 = FStar_ST.op_Bang deps2  in d :: uu___2  in
              ...
              let uu___1 =
                let uu___2 =
                  ...
                  FStar_Util.format1
                    ...
                    uu___3
                   in
                (FStar_Errors.Warning_ModuleOrFileNotFoundWarning, uu___2)
                 in
          ...
          let record_open_module_or_namespace uu___ =
            ...
            | (lid,kind) ->
                (match kind with
                 ...
                 | Open_module  ->
                     let uu___1 = record_open_module false lid  in ())
             in
               ...
               then
                 ...
                 let uu___4 =
                   let uu___5 =
                     ...
                     FStar_Util.format1 "Unbound module reference %s" uu___6
                      in
        ...
        let uu___ = FStar_All.pipe_right data_from_cache FStar_Util.is_some
           in
        if uu___
        then
          ((let uu___2 =
          ...
          (let num_of_toplevelmods = FStar_Util.mk_ref Prims.int_zero  in
           ...
           let add_to_parsing_data elt =
             ...
             then
               let uu___3 =
                 let uu___4 = FStar_ST.op_Bang pd  in elt :: uu___4  in
           ...
           and collect_binder b =
             ...
             (match b with
              ...
              | {
                  FStar_Parser_AST.b = FStar_Parser_AST.TAnnotated (uu___3,t);
                  FStar_Parser_AST.brange = uu___4;
                  FStar_Parser_AST.blevel = uu___5;
                  FStar_Parser_AST.aqual = uu___6;_} -> collect_term t
           ...
           and collect_constant uu___2 =
             ...
             | FStar_Const.Const_int
                 ...
                 let uu___4 =
                   let uu___5 =
                     let uu___6 =
                       let uu___7 = FStar_Util.format2 "fstar.%sint%s" u w
                          in
           ...
           and collect_term' uu___2 =
             ...
             | FStar_Parser_AST.Op (s,ts) ->
                 ((let uu___4 =
                     let uu___5 = FStar_Ident.string_of_id s  in uu___5 = "@"
                      in
                   if uu___4
                   then
                     let uu___5 =
           ...
           and collect_pattern' uu___2 =
             ...
             | FStar_Parser_AST.PatTvar (uu___3,aqual) -> collect_aqual aqual
        ...
        (FStar_List.map
           (fun uu___1  ->
              ...
              | (m,d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu___2))
       in
    ...
    let sort_output_files orig_output_file_map =
      ...
      let emit_output_file_opt ml_file_opt =
        ...
        | FStar_Pervasives_Native.Some ml_file ->
            ...
            FStar_ST.op_Colon_Equals order uu___
         in
      let rec aux uu___ =
        match uu___ with
        | [] -> ()
               ...
               (fun all_checked_files1  ->
                  fun file_name1  ->
                    let process_one_key uu___1 =
                      let dep_node1 =
                        let uu___2 = deps_try_find deps1.dep_graph file_name1
                           in
                      ...
                      let uu___2 =
                        ...
                        then
                          ...
                          (let uu___5 =
                             let uu___6 = lowercase_module_name file_name1
                                in
                           ...
                           | FStar_Pervasives_Native.Some iface ->
                               ...
                               ((FStar_Pervasives_Native.Some iface), uu___6))
                         in
                      match uu___2 with
                      | (iface_fn,iface_deps) ->
                          let iface_deps1 =
                          ...
                          let all_checked_files2 =
                            let uu___3 =
                              let uu___4 =
                                let uu___5 = module_name_of_file file_name1
                                   in
                                FStar_Options.should_be_already_cached uu___5
                                 in
                           ...
                           | (all_fst_files_dep,widened1) ->
                               ...
                               let all_checked_fst_dep_files_string =
                                 FStar_String.concat " \\\n\t"
                                  ...
                                  in
                               ((let uu___5 = is_implementation file_name1
                                    in
                                 if uu___5
                                 then
                                   ((let uu___7 =
                                    ...
                                    (let cmx_files =
                                     ...
                                     then
                                       ...
                                       let uu___9 = output_ml_file file_name1
                                          in
        ...
        (FStar_All.pipe_right all_fsti_files
           (FStar_List.iter
              (fun fsti  ->
                 ...
                 let uu___2 =
                   let uu___3 = has_implementation deps1.file_system_map mn
                      in
                   Prims.op_Negation uu___3  in
                 if uu___2
                 then
