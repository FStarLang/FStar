...
in (
# 78 "dep.fs"
let cwd = (let _174_21 = (FStar_Util.getcwd ())
...
in (
# 80 "dep.fs"
let _72_52 = (FStar_List.iter (fun d -> if (FStar_Util.file_exists d) then begin
(
# 82 "dep.fs"
...
in (
# 93 "dep.fs"
let _72_48 = if ((is_interface existing_file) = (is_interface f)) then begin
...
in (
# 106 "dep.fs"
let _72_55 = (FStar_List.iter (fun f -> (let _174_29 = (lowercase_module_name f)
...
in (
# 118 "dep.fs"
let _72_67 = (let _174_39 = (let _174_38 = (FStar_Util.smap_keys original_map)
...
in (
# 123 "dep.fs"
let filename = (let _174_37 = (FStar_Util.smap_try_find original_map k)
in (FStar_Util.must _174_37))
in (
# 124 "dep.fs"
let _72_65 = (FStar_Util.smap_add working_map suffix filename)
...
in (
# 132 "dep.fs"
let names = (let _174_45 = (FStar_List.map (fun x -> x.FStar_Ident.idText) l.FStar_Ident.ns)
...
in (
# 154 "dep.fs"
let add_dep = (fun d -> if (not ((let _174_68 = (FStar_ST.read deps)
...
in (
# 193 "dep.fs"
let me = (let _174_86 = (let _174_85 = (let _174_84 = (FStar_Util.basename filename)
...
in (
# 201 "dep.fs"
let _72_119 = (FStar_List.iter record_open auto_open)
in (
# 203 "dep.fs"
let rec collect_fragment = (fun _72_1 -> (match (_72_1) with
...
in (
# 253 "dep.fs"
let _72_239 = (FStar_Util.iter_opt k collect_term)
in (collect_term t)))
end
...
in (
# 257 "dep.fs"
let _72_250 = (FStar_Util.iter_opt k collect_term)
...
in (
# 261 "dep.fs"
let _72_265 = (FStar_Util.iter_opt k collect_term)
...
in (
# 343 "dep.fs"
let _72_431 = (FStar_List.iter (FStar_List.iter collect_term) ts)
in (collect_term t)))
end
...
in (
# 391 "dep.fs"
let _72_509 = (FStar_Util.iter_opt t1 collect_term)
in (collect_term t2)))
end))
in (
# 395 "dep.fs"
...
in (
# 417 "dep.fs"
let _72_521 = (FStar_Util.smap_add graph key (deps, White))
...
in (
# 420 "dep.fs"
let _72_523 = (let _174_143 = (FStar_List.map lowercase_module_name filenames)
in (FStar_List.iter discover_one _174_143))
in (
# 423 "dep.fs"
let print_graph = (fun _72_526 -> (match (()) with
| () -> begin
...
# 433 "dep.fs"
let _72_533 = (let _174_155 = (FStar_Util.smap_try_find graph key)
...
in (
# 437 "dep.fs"
let _72_537 = (FStar_Util.print_string "Here\'s the (non-transitive) dependency graph:\n")
in (
# 438 "dep.fs"
let _72_539 = (print_graph ())
in (
# 439 "dep.fs"
let _72_541 = (FStar_Util.print_string "\n")
in (FStar_All.exit 1)))))
end
| Black -> begin
direct_deps
...
in (
# 448 "dep.fs"
let all_deps = (let _174_159 = (let _174_158 = (FStar_List.map (fun dep -> (let _174_157 = (discover dep)
in (dep)::_174_157)) direct_deps)
in (FStar_List.flatten _174_158))
in (FStar_List.unique _174_159))
in (
# 452 "dep.fs"
let _72_549 = (FStar_Util.smap_add graph key (all_deps, Black))
in (
# 454 "dep.fs"
let _72_551 = (let _174_161 = (let _174_160 = (FStar_ST.read topologically_sorted)
in (key)::_174_160)
...
in (
# 459 "dep.fs"
let must_find = (fun k -> (let _174_164 = (FStar_Util.smap_try_find m k)
in (FStar_Util.must _174_164)))
in (
# 462 "dep.fs"
let by_target = (let _174_169 = (FStar_Util.smap_keys graph)
in (FStar_List.map (fun k -> (
# 463 "dep.fs"
let deps = (let _174_166 = (discover k)
...
in (
# 466 "dep.fs"
let topologically_sorted = (let _174_170 = (FStar_ST.read topologically_sorted)
