           ...
           ((let uu____3278 =
               ((is_interface filename) &&
                 ...
                 (let uu____3280 = FStar_Options.dep ()  in
                  uu____3280 = (FStar_Pervasives_Native.Some "full"))
                in
             if uu____3278
             ...
             (match color with
                  ...
                  ((let uu____3574 =
                      let uu____3579 =
                        FStar_Util.format1
                         ...
                         in
                      (FStar_Errors.Warning_RecursiveDependency, uu____3579)
                       in
              ...
              | White  ->
                  (deps_add_dep dep_graph filename (direct_deps, Gray);
                   ...
                   (let uu____3591 =
                      let uu____3594 = FStar_ST.op_Bang topologically_sorted
                         in
                      filename :: uu____3594  in
                    FStar_ST.op_Colon_Equals topologically_sorted uu____3591)))
          in
          ...
          let interface_hash =
            ...
            then
              let uu____3827 =
                let uu____3832 =
                  let uu____3833 =
                    let uu____3834 = interface_of file_system_map module_name
                       in
            ...
            FStar_List.sortWith
              (fun fn11  ->
                 fun fn2  ->
                   ...
                   FStar_String.compare uu____3875 uu____3876) binary_deps
             in
        ...
        (FStar_List.map
           (fun uu____4009  ->
              ...
              | (m,d) ->
                  ...
                  FStar_Util.format2 "%s:%s" m uu____4016))
       in
             ...
             FStar_Option.isSome uu____4117) ||
              (let uu____4121 =
                 FStar_Util.smap_try_find visited_other_modules
                   lc_module_name
                  in
               FStar_Option.isNone uu____4121)
             in
            ...
            | FStar_Pervasives_Native.Some ml_file ->
                let uu____4144 =
                  let uu____4147 = FStar_ST.op_Bang order  in ml_file ::
                    uu____4147
                   in
                FStar_ST.op_Colon_Equals order uu____4144
             in
                       ...
                       then
                         ...
                         (let uu____4504 =
                            (let uu____4507 =
                               ...
                               has_implementation file_system_map uu____4508
                                in
