          ...
          | PreferInterface key when has_interface file_system_map key ->
              ...
              then
                ...
                (if uu____758
                 then
                   let uu____759 =
                     let uu____760 = implementation_of file_system_map key
                        in
         ...
         let uu____966 =
           let uu____967 =
             let uu____970 =
               ...
               FStar_List.unique uu____973  in
             FStar_List.collect
               (fun k  ->
                  let deps =
                    let uu____982 =
                  ...
                  let print7 dep1 =
                    FStar_Util.format2 " %s -> %s" (r k)
                     ...
                     in
                  FStar_List.map print7 deps) uu____970
              in
           FStar_String.concat "\n" uu____967  in
              ...
              then
                let suffix =
                  FStar_String.substring k (FStar_String.length prefix2)
                   ...
                   in
                let filename =
                  let uu____1292 = FStar_Util.smap_try_find original_map k
                     in
      ...
      let names =
        let uu____1530 =
          FStar_List.map (fun x  -> x.FStar_Ident.idText) l.FStar_Ident.ns
           in
        FStar_List.append uu____1530 suffix  in
...
let (lowercase_join_longident :
  ...
  fun l  ->
    fun last1  ->
      let uu____1541 = string_of_lid l last1  in
      FStar_String.lowercase uu____1541
  
let (namespace_of_lid : FStar_Ident.lident -> Prims.string) =
  fun l  ->
    let uu____1545 = FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns
       in
    FStar_String.concat "_" uu____1545
    ...
    fun filename  ->
      ...
      let uu____1555 =
        let uu____1556 =
          let uu____1557 =
            let uu____1558 =
              let uu____1561 = FStar_Util.basename filename  in
              check_and_strip_suffix uu____1561  in
            FStar_Util.must uu____1558  in
          FStar_String.lowercase uu____1557  in
        uu____1556 <> k'  in
      if uu____1555
      then
        let uu____1562 =
          let uu____1567 =
            let uu____1568 = string_of_lid lid true  in
            FStar_Util.format2
              "The module declaration \"module %s\" found in file %s does not match its filename. Dependencies will be incorrect and the module will not be verified.\n"
              uu____1568 filename
             in
          (FStar_Errors.Error_ModuleFileNameMismatch, uu____1567)  in
        FStar_Errors.log_issue (FStar_Ident.range_of_lid lid) uu____1562
      else ()
  
exception Exit 
let (uu___is_Exit : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with | Exit  -> true | uu____1573 -> false
...
let (hard_coded_dependencies :
  ...
  fun full_filename  ->
    ...
    let corelibs =
      let uu____1587 = FStar_Options.prims_basename ()  in
      let uu____1588 =
        let uu____1591 = FStar_Options.pervasives_basename ()  in
        let uu____1592 =
          let uu____1595 = FStar_Options.pervasives_native_basename ()  in
          [uu____1595]  in
    ...
    then []
      ...
      (let implicit_deps =
       ...
       let uu____1630 =
         let uu____1633 = lowercase_module_name full_filename  in
         namespace_of_module uu____1633  in
  ...
  fun original_map  ->
    fun filename  ->
      ...
      let add_dep deps1 d =
        let uu____1874 =
          let uu____1875 =
            let uu____1876 = FStar_ST.op_Bang deps1  in
            FStar_List.existsML (fun d'  -> d' = d) uu____1876  in
          Prims.op_Negation uu____1875  in
        if uu____1874
        then
          let uu____1998 =
            let uu____2001 = FStar_ST.op_Bang deps1  in d :: uu____2001  in
          FStar_ST.op_Colon_Equals deps1 uu____1998
        else ()  in
      let working_map = FStar_Util.smap_copy original_map  in
      let add_dependence_edge original_or_working_map lid =
        let key = lowercase_join_longident lid true  in
        let uu____2266 = resolve_module_name original_or_working_map key  in
            ...
            (add_dep deps (PreferInterface module_name);
             (let uu____2383 =
                ((has_interface original_or_working_map module_name) &&
                  ...
                  &&
                  (let uu____2385 = FStar_Options.dep ()  in
                   uu____2385 = (FStar_Pervasives_Native.Some "full"))
                 in
              if uu____2383
           ...
           then
             (let uu____2515 =
                let uu____2520 =
                  ...
                  FStar_Util.format1 "Module not found: %s" uu____2521  in
      ...
      let record_open_namespace lid =
        ...
        then
          let uu____2529 =
            let uu____2534 =
              let uu____2535 = string_of_lid lid true  in
              FStar_Util.format1
                "No modules in namespace %s and no file with that name either"
                uu____2535
               in
            (FStar_Errors.Warning_ModuleOrFileNotFoundWarning, uu____2534)
             in
          FStar_Errors.log_issue (FStar_Ident.range_of_lid lid) uu____2529
        else ()  in
      let record_open let_open lid =
        let uu____2544 = record_open_module let_open lid  in
        if uu____2544
        then ()
        else
         ...
         in
      let record_open_module_or_namespace uu____2554 =
        match uu____2554 with
        | (lid,kind) ->
            (match kind with
             | Open_namespace  -> record_open_namespace lid
             | Open_module  ->
                 let uu____2561 = record_open_module false lid  in ())
         in
      let record_module_alias ident lid =
        let key = FStar_String.lowercase (FStar_Ident.text_of_id ident)  in
        let alias = lowercase_join_longident lid true  in
        let uu____2571 = FStar_Util.smap_try_find original_map alias  in
      ...
      let record_lid lid =
        ...
        | uu____2635 ->
            ...
            let uu____2639 = add_dependence_edge working_map module_name  in
            if uu____2639
            then ()
            else
              (let uu____2641 = FStar_Options.debug_any ()  in
               if uu____2641
               then
                 let uu____2642 =
                   let uu____2647 =
                     let uu____2648 = FStar_Ident.string_of_lid module_name
                        in
                     FStar_Util.format1 "Unbound module reference %s"
                       uu____2648
                      in
                   (FStar_Errors.Warning_UnboundModuleReference, uu____2647)
                    in
                 FStar_Errors.log_issue (FStar_Ident.range_of_lid lid)
                   uu____2642
               else ())
      ...
      (let num_of_toplevelmods = FStar_Util.mk_ref (Prims.parse_int "0")  in
       let rec collect_module uu___54_2734 =
         match uu___54_2734 with
         | FStar_Parser_AST.Module (lid,decls) ->
             (check_module_declaration_against_filename lid filename;
              ...
              then
                (let uu____2743 =
                   let uu____2744 = namespace_of_lid lid  in
                   enter_namespace original_map working_map uu____2744  in
                 ())
              else ();
              collect_decls decls)
         | FStar_Parser_AST.Interface (lid,decls,uu____2748) ->
             (check_module_declaration_against_filename lid filename;
              if
                (FStar_List.length lid.FStar_Ident.ns) >
                  (Prims.parse_int "0")
              then
                (let uu____2755 =
                   let uu____2756 = namespace_of_lid lid  in
                   enter_namespace original_map working_map uu____2756  in
                 ())
              else ();
              collect_decls decls)
       ...
       and collect_decl uu___55_2765 =
         match uu___55_2765 with
         | FStar_Parser_AST.Include lid -> record_open false lid
         | FStar_Parser_AST.Open lid -> record_open false lid
         | FStar_Parser_AST.ModuleAbbrev (ident,lid) ->
             let uu____2770 = record_module_alias ident lid  in
             if uu____2770
             then
               let uu____2771 =
                 let uu____2772 = lowercase_join_longident lid true  in
                 PreferInterface uu____2772  in
               add_dep deps uu____2771
             else ()
         | FStar_Parser_AST.TopLevelLet (uu____2885,patterms) ->
             FStar_List.iter
               (fun uu____2907  ->
         ...
         | FStar_Parser_AST.Assume (uu____2916,t) -> collect_term t
         | FStar_Parser_AST.SubEffect
             { FStar_Parser_AST.msource = uu____2918;
               FStar_Parser_AST.mdest = uu____2919;
               FStar_Parser_AST.lift_op = FStar_Parser_AST.NonReifiableLift t;_}
             -> collect_term t
         | FStar_Parser_AST.SubEffect
             { FStar_Parser_AST.msource = uu____2921;
               FStar_Parser_AST.mdest = uu____2922;
               FStar_Parser_AST.lift_op = FStar_Parser_AST.LiftForFree t;_}
             -> collect_term t
         | FStar_Parser_AST.Val (uu____2924,t) -> collect_term t
         | FStar_Parser_AST.SubEffect
             { FStar_Parser_AST.msource = uu____2926;
               FStar_Parser_AST.mdest = uu____2927;
               FStar_Parser_AST.lift_op = FStar_Parser_AST.ReifiableLift
                 (t0,t1);_}
             -> (collect_term t0; collect_term t1)
         | FStar_Parser_AST.Tycon (uu____2931,ts) ->
             let ts1 =
               FStar_List.map
                 (fun uu____2961  -> match uu____2961 with | (x,docnik) -> x)
                 ts
                in
             FStar_List.iter collect_tycon ts1
         | FStar_Parser_AST.Exception (uu____2974,t) ->
             FStar_Util.iter_opt t collect_term
         | FStar_Parser_AST.NewEffect ed -> collect_effect_decl ed
         | FStar_Parser_AST.Fsdoc uu____2981 -> ()
         | FStar_Parser_AST.Pragma uu____2982 -> ()
         | FStar_Parser_AST.TopLevelModule lid ->
             (FStar_Util.incr num_of_toplevelmods;
              (let uu____3096 =
                 let uu____3097 = FStar_ST.op_Bang num_of_toplevelmods  in
                 uu____3097 > (Prims.parse_int "1")  in
               if uu____3096
               then
                 let uu____3191 =
                   let uu____3196 =
                     let uu____3197 = string_of_lid lid true  in
                     FStar_Util.format1
                       "Automatic dependency analysis demands one module per file (module %s not supported)"
                       uu____3197
                      in
                   (FStar_Errors.Fatal_OneModulePerFile, uu____3196)  in
                 FStar_Errors.raise_error uu____3191
                   (FStar_Ident.range_of_lid lid)
               else ()))
       
       and collect_tycon uu___56_3199 =
         match uu___56_3199 with
         | FStar_Parser_AST.TyconAbstract (uu____3200,binders,k) ->
             (collect_binders binders; FStar_Util.iter_opt k collect_term)
         | FStar_Parser_AST.TyconAbbrev (uu____3212,binders,k,t) ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              collect_term t)
         | FStar_Parser_AST.TyconRecord (uu____3226,binders,k,identterms) ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              FStar_List.iter
                (fun uu____3272  ->
                   match uu____3272 with
                   | (uu____3281,t,uu____3283) -> collect_term t) identterms)
         | FStar_Parser_AST.TyconVariant (uu____3288,binders,k,identterms) ->
             (collect_binders binders;
              FStar_Util.iter_opt k collect_term;
              FStar_List.iter
                (fun uu____3347  ->
                   match uu____3347 with
                   | (uu____3360,t,uu____3362,uu____3363) ->
                       FStar_Util.iter_opt t collect_term) identterms)
       
       and collect_effect_decl uu___57_3372 =
         match uu___57_3372 with
         | FStar_Parser_AST.DefineEffect (uu____3373,binders,t,decls) ->
             (collect_binders binders; collect_term t; collect_decls decls)
         | FStar_Parser_AST.RedefineEffect (uu____3387,binders,t) ->
             (collect_binders binders; collect_term t)
       
       and collect_binders binders = FStar_List.iter collect_binder binders
       
       and collect_binder uu___58_3398 =
         match uu___58_3398 with
         | { FStar_Parser_AST.b = FStar_Parser_AST.Annotated (uu____3399,t);
             FStar_Parser_AST.brange = uu____3401;
             FStar_Parser_AST.blevel = uu____3402;
             FStar_Parser_AST.aqual = uu____3403;_} -> collect_term t
         | { FStar_Parser_AST.b = FStar_Parser_AST.TAnnotated (uu____3404,t);
             FStar_Parser_AST.brange = uu____3406;
             FStar_Parser_AST.blevel = uu____3407;
             FStar_Parser_AST.aqual = uu____3408;_} -> collect_term t
         | { FStar_Parser_AST.b = FStar_Parser_AST.NoName t;
             FStar_Parser_AST.brange = uu____3410;
             FStar_Parser_AST.blevel = uu____3411;
             FStar_Parser_AST.aqual = uu____3412;_} -> collect_term t
         | uu____3413 -> ()
       
       and collect_term t = collect_term' t.FStar_Parser_AST.tm
       
       and collect_constant uu___59_3415 =
         match uu___59_3415 with
         | FStar_Const.Const_int
             (uu____3416,FStar_Pervasives_Native.Some (signedness,width)) ->
             let u =
             ...
             let uu____3431 =
               let uu____3432 = FStar_Util.format2 "fstar.%sint%s" u w  in
               PreferInterface uu____3432  in
             add_dep deps uu____3431
         | FStar_Const.Const_char uu____3544 ->
             add_dep deps (PreferInterface "fstar.char")
         | FStar_Const.Const_float uu____3656 ->
             add_dep deps (PreferInterface "fstar.float")
         | uu____3768 -> ()
       
       and collect_term' uu___60_3769 =
         match uu___60_3769 with
                ...
                (let uu____3778 =
                   let uu____3779 =
                     FStar_Ident.lid_of_path
                       ...
                       FStar_Range.dummyRange
                      in
                   FStar_Parser_AST.Name uu____3779  in
                 collect_term' uu____3778)
              else ();
              FStar_List.iter collect_term ts)
         | FStar_Parser_AST.Tvar uu____3781 -> ()
         | FStar_Parser_AST.Uvar uu____3782 -> ()
         | FStar_Parser_AST.Var lid -> record_lid lid
         | FStar_Parser_AST.Projector (lid,uu____3785) -> record_lid lid
         ...
         | FStar_Parser_AST.Construct (lid,termimps) ->
             (if (FStar_List.length termimps) = (Prims.parse_int "1")
              ...
              FStar_List.iter
                (fun uu____3815  ->
                   match uu____3815 with | (t,uu____3821) -> collect_term t)
                termimps)
         | FStar_Parser_AST.Abs (pats,t) ->
             (collect_patterns pats; collect_term t)
         | FStar_Parser_AST.App (t1,t2,uu____3831) ->
             (collect_term t1; collect_term t2)
         | FStar_Parser_AST.Let (uu____3833,patterms,t) ->
             (FStar_List.iter
                (fun uu____3857  ->
         ...
         | FStar_Parser_AST.Bind (uu____3868,t1,t2) ->
             (collect_term t1; collect_term t2)
         ...
         | FStar_Parser_AST.Record (t,idterms) ->
             (FStar_Util.iter_opt t collect_term;
              FStar_List.iter
                (fun uu____3964  ->
                   match uu____3964 with | (uu____3969,t1) -> collect_term t1)
                idterms)
         | FStar_Parser_AST.Project (t,uu____3972) -> collect_term t
         ...
         | FStar_Parser_AST.NamedTyp (uu____4028,t) -> collect_term t
         | FStar_Parser_AST.Paren t -> collect_term t
         | FStar_Parser_AST.Assign (uu____4031,t) -> collect_term t
         | FStar_Parser_AST.Requires (t,uu____4034) -> collect_term t
         | FStar_Parser_AST.Ensures (t,uu____4040) -> collect_term t
         | FStar_Parser_AST.Labeled (t,uu____4046,uu____4047) ->
             collect_term t
       ...
       and collect_pattern' uu___61_4055 =
         match uu___61_4055 with
         | FStar_Parser_AST.PatWild  -> ()
         | FStar_Parser_AST.PatOp uu____4056 -> ()
         | FStar_Parser_AST.PatConst uu____4057 -> ()
         | FStar_Parser_AST.PatApp (p,ps) ->
             (collect_pattern p; collect_patterns ps)
         | FStar_Parser_AST.PatVar uu____4065 -> ()
         | FStar_Parser_AST.PatName uu____4072 -> ()
         | FStar_Parser_AST.PatTvar uu____4073 -> ()
         | FStar_Parser_AST.PatList ps -> collect_patterns ps
         | FStar_Parser_AST.PatOr ps -> collect_patterns ps
         | FStar_Parser_AST.PatTuple (ps,uu____4087) -> collect_patterns ps
         | FStar_Parser_AST.PatRecord lidpats ->
             FStar_List.iter
               (fun uu____4106  ->
                  match uu____4106 with | (uu____4111,p) -> collect_pattern p)
               lidpats
       ...
       and collect_branch uu____4135 =
         ...
         | (pat,t1,t2) ->
             (collect_pattern pat;
              ...
              collect_term t2)
        in
       let uu____4153 = FStar_Parser_Driver.parse_file filename  in
       ...
       | (ast,uu____4173) ->
           ...
           ((let uu____4188 =
               ((is_interface filename) &&
                 ...
                 &&
                 (let uu____4190 = FStar_Options.dep ()  in
                  uu____4190 = (FStar_Pervasives_Native.Some "full"))
                in
             if uu____4188
             then add_dep mo_roots (UseImplementation mname)
             else ());
            collect_module ast;
            (let uu____4308 = FStar_ST.op_Bang deps  in
             let uu____4408 = FStar_ST.op_Bang mo_roots  in
             (uu____4308, uu____4408))))
  ...
  fun all_cmd_line_files  ->
    let all_cmd_line_files1 =
      FStar_All.pipe_right all_cmd_line_files
        (FStar_List.map
           (fun fn  ->
              let uu____4542 = FStar_Options.find_file fn  in
                  ...
                  let uu____4545 =
                    let uu____4550 =
                      FStar_Util.format1 "File %s could not be found\n" fn
                       in
                    (FStar_Errors.Fatal_ModuleOrFileNotFound, uu____4550)  in
    ...
    let rec discover_one file_name =
      let uu____4558 =
        let uu____4559 = deps_try_find dep_graph file_name  in
        uu____4559 = FStar_Pervasives_Native.None  in
      if uu____4558
      then
        let uu____4576 = collect_one file_system_map file_name  in
        ...
        | (deps,mo_roots) ->
            ...
            ((let uu____4604 =
                let uu____4609 = FStar_List.unique deps1  in
                (uu____4609, White)  in
              deps_add_dep dep_graph file_name uu____4604);
             (let uu____4614 =
                FStar_List.map
                  (file_of_dep file_system_map all_cmd_line_files1)
                  (FStar_List.append deps1 mo_roots)
                 in
              FStar_List.iter discover_one uu____4614))
      else ()  in
    ...
    (let topological_dependences_of all_command_line_files =
       ...
       let rec aux cycle filename =
         let uu____4647 =
           let uu____4652 = deps_try_find dep_graph filename  in
           FStar_Util.must uu____4652  in
                  ...
                  ((let uu____4666 =
                      let uu____4671 =
                        FStar_Util.format1
                         ...
                         in
                      (FStar_Errors.Warning_RecursiveDependency, uu____4671)
                       in
                    FStar_Errors.log_issue FStar_Range.dummyRange uu____4666);
                   FStar_Util.print1
                  ...
                  (deps_add_dep dep_graph filename (direct_deps, Gray);
                   (let uu____4677 =
                      dependences_of file_system_map dep_graph
                       ...
                       in
                    FStar_List.iter (fun k  -> aux (k :: cycle) k) uu____4677);
                   deps_add_dep dep_graph filename (direct_deps, Black);
                   (let uu____4683 =
                      let uu____4686 = FStar_ST.op_Bang topologically_sorted
                         in
                      filename :: uu____4686  in
                    FStar_ST.op_Colon_Equals topologically_sorted uu____4683)))
          in
     ...
     (let uu____4988 = topological_dependences_of all_cmd_line_files1  in
      (uu____4988, (Mk (dep_graph, file_system_map, all_cmd_line_files1)))))
...
let (hash_dependences :
  ...
  fun uu____5026  ->
    fun fn  ->
      ...
      | Mk (deps,file_system_map,all_cmd_line_files) ->
          let fn1 =
            let uu____5044 = FStar_Options.find_file fn  in
          ...
          let interface_hash =
            ...
            then
              let uu____5075 =
                let uu____5080 =
                  let uu____5081 =
                    let uu____5082 = interface_of file_system_map module_name
                       in
                    FStar_Option.get uu____5082  in
                  digest_of_file1 uu____5081  in
                ("interface", uu____5080)  in
              [uu____5075]
            else []  in
          let binary_deps =
            let uu____5101 =
            ...
            FStar_All.pipe_right uu____5101
              (FStar_List.filter
                 (fun fn2  ->
                    let uu____5111 =
                      (is_interface fn2) &&
                        (let uu____5113 = lowercase_module_name fn2  in
                         uu____5113 = module_name)
                       in
          ...
          let binary_deps1 =
            FStar_List.sortWith
              (fun fn11  ->
                 fun fn2  ->
                   let uu____5123 = lowercase_module_name fn11  in
                   let uu____5124 = lowercase_module_name fn2  in
                   FStar_String.compare uu____5123 uu____5124) binary_deps
             in
          let rec hash_deps out uu___62_5147 =
            match uu___62_5147 with
            | [] ->
                FStar_Pervasives_Native.Some
            ...
            | fn2::deps1 ->
                ...
                then
                  let uu____5191 =
                    let uu____5198 =
                      let uu____5203 = lowercase_module_name fn2  in
                      let uu____5204 = digest_of_file1 cache_fn  in
                      (uu____5203, uu____5204)  in
                    uu____5198 :: out  in
                  hash_deps uu____5191 deps1
                else
                  ((let uu____5211 = FStar_Options.debug_any ()  in
                    if uu____5211
                    then
      ...
      FStar_All.pipe_right dig
        (FStar_List.map
           (fun uu____5257  ->
              ...
              | (m,d) ->
                  let uu____5264 = FStar_Util.base64_encode d  in
                  FStar_Util.format2 "%s:%s" m uu____5264))
       in
    ...
    | Mk (deps,file_system_map,all_cmd_line_files) ->
        ...
        FStar_All.pipe_right keys
          (FStar_List.iter
             (fun f  ->
                let uu____5289 =
                  let uu____5294 = deps_try_find deps f  in
                  FStar_All.pipe_right uu____5294 FStar_Option.get  in
    ...
    | Mk (deps,file_system_map,all_cmd_line_files) ->
        let sort_output_files orig_output_file_map =
          ...
          let should_visit lc_module_name =
            (let uu____5365 =
               FStar_Util.smap_try_find remaining_output_files lc_module_name
                in
             FStar_Option.isSome uu____5365) ||
              (let uu____5369 =
                 FStar_Util.smap_try_find visited_other_modules
                   lc_module_name
                  in
               FStar_Option.isNone uu____5369)
             in
          ...
          let emit_output_file_opt ml_file_opt =
            ...
            | FStar_Pervasives_Native.Some ml_file ->
                let uu____5392 =
                  let uu____5395 = FStar_ST.op_Bang order  in ml_file ::
                    uu____5395
                   in
                FStar_ST.op_Colon_Equals order uu____5392
             in
          let rec aux uu___63_5597 =
            match uu___63_5597 with
            | [] -> ()
            | lc_module_name::modules_to_extract ->
                let visit_file file_opt =
                  ...
                  | FStar_Pervasives_Native.Some file_name ->
                      let uu____5613 = deps_try_find deps file_name  in
          ...
          (let uu____5654 = FStar_ST.op_Bang order  in
           FStar_List.rev uu____5654)
           in
        let keys = deps_keys deps  in
        let output_file ext fst_file =
          let ml_base_name =
            let uu____5765 =
              let uu____5766 =
                let uu____5769 = FStar_Util.basename fst_file  in
                check_and_strip_suffix uu____5769  in
              FStar_Option.get uu____5766  in
            FStar_Util.replace_chars uu____5765 46 "_"  in
          FStar_Options.prepend_output_dir (Prims.strcat ml_base_name ext)
           in
        let norm_path s = FStar_Util.replace_chars s 92 "/"  in
        let output_ml_file f =
          let uu____5780 = output_file ".ml" f  in norm_path uu____5780  in
        let output_krml_file f =
          let uu____5785 = output_file ".krml" f  in norm_path uu____5785  in
        let output_cmx_file f =
          let uu____5790 = output_file ".cmx" f  in norm_path uu____5790  in
        let cache_file f =
          let uu____5795 = cache_file_name f  in norm_path uu____5795  in
        (FStar_All.pipe_right keys
           (FStar_List.iter
              (fun f  ->
                 let uu____5817 =
                   let uu____5822 = deps_try_find deps f  in
                   FStar_All.pipe_right uu____5822 FStar_Option.get  in
                 ...
                 | (f_deps,uu____5844) ->
                     ...
                     ((let uu____5860 = is_interface f  in
                       if uu____5860
                       then
                         let uu____5861 =
                           let uu____5862 =
                             FStar_Options.prepend_cache_dir norm_f  in
                           norm_path uu____5862  in
                         FStar_Util.print3
                           "%s.source: %s \\\n\t%s\n\ttouch $@\n\n"
                           uu____5861 norm_f files3
                       else ());
                      (let uu____5865 = cache_file f  in
                       FStar_Util.print3 "%s: %s \\\n\t%s\n\n" uu____5865
                         norm_f files3);
                      (let uu____5866 = is_implementation f  in
                       if uu____5866
                       then
                         ((let uu____5868 = output_ml_file f  in
                           let uu____5869 = cache_file f  in
                           FStar_Util.print2 "%s: %s\n\n" uu____5868
                             uu____5869);
                          (let cmx_files =
                             let fst_files =
                             ...
                             FStar_All.pipe_right extracted_fst_files
                              ...
                              in
                           (let uu____5900 =
                              let uu____5901 = lowercase_module_name f  in
                              FStar_Options.should_extract uu____5901  in
                            if uu____5900
                            then
                              let uu____5902 = output_cmx_file f  in
                              let uu____5903 = output_ml_file f  in
                              FStar_Util.print3 "%s: %s \\\n\t%s\n\n"
                                uu____5902 uu____5903
                                (FStar_String.concat "\\\n\t" cmx_files)
                            else ());
                           (let uu____5905 = output_krml_file f  in
                            let uu____5906 = cache_file f  in
                            FStar_Util.print2 "%s: %s\n\n" uu____5905
                              uu____5906)))
                       else
                         (let uu____5908 =
                            (let uu____5911 =
                               let uu____5912 = lowercase_module_name f  in
                               has_implementation file_system_map uu____5912
                                in
                             Prims.op_Negation uu____5911) &&
                              (is_interface f)
                             in
                          if uu____5908
                          then
            ...
            FStar_All.pipe_right all_fst_files
              (FStar_List.iter
                 (fun fst_file  ->
                    ...
                    let uu____5945 = FStar_Options.should_extract mname  in
                    if uu____5945
                    then
                      let uu____5946 = output_ml_file fst_file  in
                      FStar_Util.smap_add ml_file_map mname uu____5946
                    else ()));
          ...
          let all_krml_files =
            ...
            FStar_All.pipe_right keys
              (FStar_List.iter
                 (fun fst_file  ->
                    let mname = lowercase_module_name fst_file  in
                    let uu____5962 = output_krml_file fst_file  in
                    FStar_Util.smap_add krml_file_map mname uu____5962));
          ...
          (let uu____5975 =
             let uu____5976 =
               FStar_All.pipe_right all_ml_files (FStar_List.map norm_path)
                in
             FStar_All.pipe_right uu____5976 (FStar_String.concat " \\\n\t")
              in
