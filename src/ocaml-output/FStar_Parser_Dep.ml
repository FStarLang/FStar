  ...
  fun original_map  ->
    fun filename  ->
      ...
      (let num_of_toplevelmods = FStar_Util.mk_ref (Prims.parse_int "0") in
       let rec collect_module uu___66_2682 =
         match uu___66_2682 with
       ...
       and collect_decl uu___67_2713 =
         match uu___67_2713 with
       ...
       and collect_tycon uu___68_2935 =
         match uu___68_2935 with
       ...
       and collect_effect_decl uu___69_3108 =
         match uu___69_3108 with
       ...
       and collect_binder uu___70_3134 =
         match uu___70_3134 with
       ...
       and collect_constant uu___71_3151 =
         match uu___71_3151 with
         ...
         | uu____3234 -> ()
       and collect_term' uu___72_3235 =
         match uu___72_3235 with
       ...
       and collect_pattern' uu___73_3521 =
         match uu___73_3521 with
  ...
  fun uu____4175  ->
    fun fn  ->
      ...
      | Mk (deps,file_system_map,all_cmd_line_files) ->
          ...
          let rec hash_deps out uu___74_4243 =
            match uu___74_4243 with
            | [] ->
                FStar_Pervasives_Native.Some
  ...
  fun uu____4330  ->
    ...
    | Mk (deps,file_system_map,all_cmd_line_files) ->
        ...
        let output_ml_file fst_file =
          ...
          let dir =
            let uu____4352 = FStar_Options.output_dir () in
        ...
        (FStar_All.pipe_right keys
           (FStar_List.iter
              (fun f  ->
                 let uu____4372 =
                   let uu____4377 = deps_try_find deps f in
                   FStar_All.pipe_right uu____4377 FStar_Option.get in
                 ...
                 | (f_deps,uu____4399) ->
                     ...
                     let files1 =
                       FStar_List.map
                         ...
                         files in
                     ((let uu____4409 = is_interface f in
                       if uu____4409
                       then
                         FStar_Util.print3
                           "%s.source: %s \\\n\t%s\n\ttouch $@\n\n" f f
                      ...
                      (let uu____4412 = cache_file_name f in
                       FStar_Util.print3 "%s: %s \\\n\t%s\n\n" uu____4412 f
                         (FStar_String.concat " \\\n\t" files1));
                      (let uu____4413 = is_implementation f in
                       if uu____4413
                       then
                         let ml_base_name =
                           let uu____4415 =
                             let uu____4416 =
                               let uu____4419 = FStar_Util.basename f in
                               check_and_strip_suffix uu____4419 in
                             FStar_Option.get uu____4416 in
                           FStar_Util.replace_chars uu____4415 46 "_" in
                         let uu____4420 = output_ml_file f in
                         let uu____4421 = cache_file_name f in
            ...
            let uu____4440 =
              FStar_All.pipe_right all_fst_files
                (FStar_List.collect
                   (fun fst_file  ->
                      let uu____4451 =
                        let uu____4452 = lowercase_module_name fst_file in
                        FStar_Options.should_extract uu____4452 in
                      if uu____4451
                      then
                        let uu____4455 = output_ml_file fst_file in
                        [uu____4455]
                      else [])) in
