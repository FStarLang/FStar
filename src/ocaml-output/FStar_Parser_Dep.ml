...
in (FStar_Pervasives.raise uu____212))
end)))
...
in (FStar_Pervasives.raise uu____379))
...
let uu____490 = (FStar_List.map (fun x -> x.FStar_Ident.idText) l.FStar_Ident.ns)
in (FStar_List.append uu____490 suffix))
in (FStar_String.concat "." names))))


let lowercase_join_longident : FStar_Ident.lident  ->  Prims.bool  ->  Prims.string = (fun l last1 -> (

let uu____503 = (string_of_lid l last1)
in (FStar_String.lowercase uu____503)))


let namespace_of_lid : FStar_Ident.lident  ->  Prims.string = (fun l -> (

let uu____508 = (FStar_List.map FStar_Ident.text_of_id l.FStar_Ident.ns)
in (FStar_String.concat "_" uu____508)))
...
let uu____526 = (FStar_Util.basename filename)
in (check_and_strip_suffix uu____526))
in (FStar_Util.must uu____523))
in (FStar_String.lowercase uu____522))
in (uu____521 <> k'))
in (match (uu____520) with
| true -> begin
(

let uu____527 = (string_of_lid lid true)
...
let uu____548 = (FStar_Options.prims_basename ())
in (

let uu____549 = (

let uu____552 = (FStar_Options.pervasives_basename ())
in (

let uu____553 = (

let uu____556 = (FStar_Options.pervasives_native_basename ())
in (uu____556)::[])
...
let uu____637 = (FStar_ST.read deps)
in (FStar_List.existsML (fun d' -> (d' = d)) uu____637))
in (not (uu____636)))
...
let uu____649 = (FStar_ST.read deps)
in (d)::uu____649)
in (FStar_ST.write deps uu____646))
end
| uu____660 -> begin
()
end)))
...
let uu____688 = (FStar_Util.smap_try_find working_map key)
in (match (uu____688) with
| FStar_Pervasives_Native.Some (pair) -> begin
((FStar_List.iter (fun f -> (

let uu____728 = (lowercase_module_name f)
in (add_dep uu____728))) (list_of_pair pair));
true;
)
end
| FStar_Pervasives_Native.None -> begin
...
let uu____740 = (string_of_lid lid true)
...
let uu____756 = (string_of_lid lid true)
...
let uu____765 = (record_open_module let_open lid)
...
let record_open_module_or_namespace = (fun uu____780 -> (match (uu____780) with
| (lid, kind) -> begin
(match (kind) with
| Open_namespace -> begin
...
let uu____787 = (record_open_module false lid)
in ())
end)
end))
in (
...
let uu____797 = (FStar_Util.smap_try_find original_map alias)
...
let uu____850 = (FStar_Util.format1 "module not found in search path: %s\n" alias)
in FStar_Errors.Err (uu____850))
in (FStar_Pervasives.raise uu____849))
end)))))
in (
...
let uu____859 = (FStar_Util.smap_try_find working_map key)
in (match (uu____859) with
| FStar_Pervasives_Native.Some (pair) -> begin
(FStar_List.iter (fun f -> (

let uu____898 = (lowercase_module_name f)
in (add_dep uu____898))) (list_of_pair pair))
end
| FStar_Pervasives_Native.None -> begin
(

let uu____907 = (((FStar_List.length lid.FStar_Ident.ns) > (Prims.parse_int "0")) && (FStar_Options.debug_any ()))
in (match (uu____907) with
| true -> begin
(

let uu____908 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid lid))
in (

let uu____909 = (string_of_lid lid false)
...
let uu____912 = (lowercase_join_longident lid false)
in (try_key uu____912))))
in (
...
let rec collect_file = (fun uu___84_1002 -> (match (uu___84_1002) with
| (modul)::[] -> begin
...
and collect_module = (fun uu___85_1010 -> (match (uu___85_1010) with
...
let uu____1020 = (namespace_of_lid lid)
in (enter_namespace original_map working_map uu____1020))
in ())
end
| uu____1021 -> begin
()
...
let uu____1023 = (string_of_lid lid true)
in (FStar_Options.add_verify_module uu____1023))
end
| VerifyFigureItOut -> begin
...
let uu____1024 = (string_of_lid lid true)
in (FStar_Options.add_verify_module uu____1024))
end
| uu____1025 -> begin
()
end)
...
let uu____1051 = (string_of_lid lid true)
in (FStar_String.lowercase uu____1051))
in ((FStar_String.lowercase m) = uu____1050))
...
| FStar_Parser_AST.Interface (lid, decls, uu____1057) -> begin
((check_module_declaration_against_filename lid filename);
(match (((FStar_List.length lid.FStar_Ident.ns) > (Prims.parse_int "0"))) with
| true -> begin
(
...
let uu____1065 = (namespace_of_lid lid)
in (enter_namespace original_map working_map uu____1065))
in ())
end
| uu____1066 -> begin
()
...
let uu____1068 = (string_of_lid lid true)
in (FStar_Options.add_verify_module uu____1068))
end
| VerifyFigureItOut -> begin
(match (is_user_provided_filename) with
| true -> begin
...
let uu____1069 = (string_of_lid lid true)
in (FStar_Options.add_verify_module uu____1069))
end
| uu____1070 -> begin
()
end)
...
| VerifyUserList -> begin
(FStar_List.iter (fun uu____1081 -> (match (uu____1081) with
| (m, r) -> begin
(
...
let uu____1096 = (string_of_lid lid true)
in (FStar_String.lowercase uu____1096))
in ((FStar_String.lowercase m) = uu____1095))
...
and collect_decl = (fun uu___86_1107 -> (match (uu___86_1107) with
...
let uu____1113 = (lowercase_join_longident lid true)
in (add_dep uu____1113));
(record_module_alias ident lid);
)
end
| FStar_Parser_AST.TopLevelLet (uu____1114, patterms) -> begin
(FStar_List.iter (fun uu____1136 -> (match (uu____1136) with
| (pat, t) -> begin
((collect_pattern pat);
(collect_term t);
)
...
| FStar_Parser_AST.Assume (uu____1145, t) -> begin
(collect_term t)
end
| FStar_Parser_AST.SubEffect ({FStar_Parser_AST.msource = uu____1147; FStar_Parser_AST.mdest = uu____1148; FStar_Parser_AST.lift_op = FStar_Parser_AST.NonReifiableLift (t)}) -> begin
(collect_term t)
end
| FStar_Parser_AST.SubEffect ({FStar_Parser_AST.msource = uu____1150; FStar_Parser_AST.mdest = uu____1151; FStar_Parser_AST.lift_op = FStar_Parser_AST.LiftForFree (t)}) -> begin
(collect_term t)
end
| FStar_Parser_AST.Val (uu____1153, t) -> begin
(collect_term t)
end
| FStar_Parser_AST.SubEffect ({FStar_Parser_AST.msource = uu____1155; FStar_Parser_AST.mdest = uu____1156; FStar_Parser_AST.lift_op = FStar_Parser_AST.ReifiableLift (t0, t1)}) -> begin
((collect_term t0);
(collect_term t1);
)
end
| FStar_Parser_AST.Tycon (uu____1160, ts) -> begin
(

let ts1 = (FStar_List.map (fun uu____1190 -> (match (uu____1190) with
| (x, docnik) -> begin
x
end)) ts)
in (FStar_List.iter collect_tycon ts1))
end
| FStar_Parser_AST.Exception (uu____1203, t) -> begin
(FStar_Util.iter_opt t collect_term)
end
| FStar_Parser_AST.NewEffect (ed) -> begin
(collect_effect_decl ed)
end
| FStar_Parser_AST.Fsdoc (uu____1210) -> begin
()
end
| FStar_Parser_AST.Pragma (uu____1211) -> begin
()
end
...
let uu____1218 = (FStar_ST.read num_of_toplevelmods)
in (uu____1218 > (Prims.parse_int "1")))
...
let uu____1223 = (string_of_lid lid true)
in (FStar_Util.format1 "Automatic dependency analysis demands one module per file (module %s not supported)" uu____1223))
in FStar_Errors.Err (uu____1222))
in (FStar_Pervasives.raise uu____1221))
end
| uu____1224 -> begin
()
end));
...
and collect_tycon = (fun uu___87_1225 -> (match (uu___87_1225) with
| FStar_Parser_AST.TyconAbstract (uu____1226, binders, k) -> begin
((collect_binders binders);
(FStar_Util.iter_opt k collect_term);
)
end
| FStar_Parser_AST.TyconAbbrev (uu____1238, binders, k, t) -> begin
((collect_binders binders);
(FStar_Util.iter_opt k collect_term);
(collect_term t);
)
end
| FStar_Parser_AST.TyconRecord (uu____1252, binders, k, identterms) -> begin
((collect_binders binders);
(FStar_Util.iter_opt k collect_term);
(FStar_List.iter (fun uu____1298 -> (match (uu____1298) with
| (uu____1307, t, uu____1309) -> begin
(collect_term t)
end)) identterms);
)
end
| FStar_Parser_AST.TyconVariant (uu____1314, binders, k, identterms) -> begin
((collect_binders binders);
(FStar_Util.iter_opt k collect_term);
(FStar_List.iter (fun uu____1373 -> (match (uu____1373) with
| (uu____1386, t, uu____1388, uu____1389) -> begin
(FStar_Util.iter_opt t collect_term)
end)) identterms);
)
end))
and collect_effect_decl = (fun uu___88_1398 -> (match (uu___88_1398) with
| FStar_Parser_AST.DefineEffect (uu____1399, binders, t, decls) -> begin
((collect_binders binders);
(collect_term t);
(collect_decls decls);
)
end
| FStar_Parser_AST.RedefineEffect (uu____1413, binders, t) -> begin
((collect_binders binders);
(collect_term t);
)
end))
and collect_binders = (fun binders -> (FStar_List.iter collect_binder binders))
and collect_binder = (fun uu___89_1424 -> (match (uu___89_1424) with
| {FStar_Parser_AST.b = FStar_Parser_AST.Annotated (uu____1425, t); FStar_Parser_AST.brange = uu____1427; FStar_Parser_AST.blevel = uu____1428; FStar_Parser_AST.aqual = uu____1429} -> begin
(collect_term t)
end
| {FStar_Parser_AST.b = FStar_Parser_AST.TAnnotated (uu____1430, t); FStar_Parser_AST.brange = uu____1432; FStar_Parser_AST.blevel = uu____1433; FStar_Parser_AST.aqual = uu____1434} -> begin
(collect_term t)
end
| {FStar_Parser_AST.b = FStar_Parser_AST.NoName (t); FStar_Parser_AST.brange = uu____1436; FStar_Parser_AST.blevel = uu____1437; FStar_Parser_AST.aqual = uu____1438} -> begin
(collect_term t)
end
| uu____1439 -> begin
()
...
and collect_constant = (fun uu___90_1441 -> (match (uu___90_1441) with
| FStar_Const.Const_int (uu____1442, FStar_Pervasives_Native.Some (signedness, width)) -> begin
(
...
let uu____1457 = (FStar_Util.format2 "fstar.%sint%s" u w)
in (add_dep uu____1457))))
end
| uu____1458 -> begin
()
end))
and collect_term' = (fun uu___91_1459 -> (match (uu___91_1459) with
...
let uu____1469 = (FStar_Ident.lid_of_path (FStar_Ident.path_of_text "FStar.List.Tot.Base.append") FStar_Range.dummyRange)
in FStar_Parser_AST.Name (uu____1469))
in (collect_term' uu____1468))
end
| uu____1470 -> begin
()
end);
...
| FStar_Parser_AST.Tvar (uu____1471) -> begin
()
end
| FStar_Parser_AST.Uvar (uu____1472) -> begin
()
end
| FStar_Parser_AST.Var (lid) -> begin
(record_lid lid)
end
| FStar_Parser_AST.Projector (lid, uu____1475) -> begin
(record_lid lid)
end
...
(FStar_List.iter (fun uu____1505 -> (match (uu____1505) with
| (t, uu____1511) -> begin
(collect_term t)
end)) termimps);
)
...
| FStar_Parser_AST.App (t1, t2, uu____1521) -> begin
((collect_term t1);
(collect_term t2);
)
end
| FStar_Parser_AST.Let (uu____1523, patterms, t) -> begin
((FStar_List.iter (fun uu____1547 -> (match (uu____1547) with
| (pat, t1) -> begin
((collect_pattern pat);
(collect_term t1);
)
...
| FStar_Parser_AST.Bind (uu____1558, t1, t2) -> begin
((collect_term t1);
(collect_term t2);
)
end
...
((FStar_Util.iter_opt t collect_term);
(FStar_List.iter (fun uu____1654 -> (match (uu____1654) with
| (uu____1659, t1) -> begin
(collect_term t1)
end)) idterms);
)
end
| FStar_Parser_AST.Project (t, uu____1662) -> begin
(collect_term t)
end
...
| FStar_Parser_AST.NamedTyp (uu____1718, t) -> begin
(collect_term t)
end
| FStar_Parser_AST.Paren (t) -> begin
(collect_term t)
end
| FStar_Parser_AST.Assign (uu____1721, t) -> begin
(collect_term t)
end
| FStar_Parser_AST.Requires (t, uu____1724) -> begin
(collect_term t)
end
| FStar_Parser_AST.Ensures (t, uu____1730) -> begin
(collect_term t)
end
| FStar_Parser_AST.Labeled (t, uu____1736, uu____1737) -> begin
(collect_term t)
end
...
and collect_pattern' = (fun uu___92_1745 -> (match (uu___92_1745) with
| FStar_Parser_AST.PatWild -> begin
()
end
| FStar_Parser_AST.PatOp (uu____1746) -> begin
()
end
| FStar_Parser_AST.PatConst (uu____1747) -> begin
()
end
...
| FStar_Parser_AST.PatVar (uu____1755) -> begin
()
end
| FStar_Parser_AST.PatName (uu____1762) -> begin
()
end
| FStar_Parser_AST.PatTvar (uu____1763) -> begin
()
end
...
| FStar_Parser_AST.PatTuple (ps, uu____1777) -> begin
(collect_patterns ps)
end
| FStar_Parser_AST.PatRecord (lidpats) -> begin
(FStar_List.iter (fun uu____1796 -> (match (uu____1796) with
| (uu____1801, p) -> begin
(collect_pattern p)
end)) lidpats)
end
...
and collect_branch = (fun uu____1825 -> (match (uu____1825) with
| (pat, t1, t2) -> begin
((collect_pattern pat);
...
let uu____1843 = (FStar_Parser_Driver.parse_file filename)
in (match (uu____1843) with
| (ast, uu____1857) -> begin
((collect_file ast);
(FStar_ST.read deps);
)
end))));
...
let print_graph : 'Auu____1879 . (Prims.string Prims.list * 'Auu____1879) FStar_Util.smap  ->  Prims.unit = (fun graph -> ((FStar_Util.print_endline "A DOT-format graph has been dumped in the current directory as dep.graph");
...
let uu____1912 = (FStar_Util.smap_keys graph)
in (FStar_List.unique uu____1912))
...
let uu____1935 = (FStar_Util.smap_try_find graph k)
in (FStar_Util.must uu____1935))
in (FStar_Pervasives_Native.fst uu____1928))
in (

let r = (fun s -> (FStar_Util.replace_char s '.' '_'))
in (FStar_List.map (fun dep1 -> (FStar_Util.format2 "  %s -> %s" (r k) (r dep1))) deps)))) uu____1909))
in (FStar_String.concat "\n" uu____1906))
in (Prims.strcat uu____1905 "\n}\n"))
in (Prims.strcat "digraph {\n" uu____1904))
in (FStar_Util.write_file "dep.graph" uu____1903));
))
...
let uu____2024 = (FStar_Options.verify_module ())
in (FStar_List.map (fun f -> (

let uu____2036 = (FStar_Util.mk_ref false)
in ((f), (uu____2036)))) uu____2024))
in (

let partial_discovery = (

let uu____2044 = ((FStar_Options.verify_all ()) || (FStar_Options.extract_all ()))
in (not (uu____2044)))
in (
...
let uu____2059 = (FStar_Util.smap_try_find m k)
in (FStar_Util.must uu____2059))
...
| (FStar_Pervasives_Native.Some (i), uu____2115) when partial_discovery -> begin
i
end
...
let uu____2148 = (FStar_Util.smap_try_find graph key)
in (uu____2148 = FStar_Pervasives_Native.None))
...
let uu____2186 = (FStar_Util.smap_try_find m key)
in (FStar_Util.must uu____2186))
...
| (FStar_Pervasives_Native.Some (impl1), FStar_Pervasives_Native.Some (uu____2239)) when interface_only -> begin
[]
end
| (FStar_Pervasives_Native.Some (impl1), uu____2245) -> begin
(collect_one1 is_user_provided_filename m impl1)
end
| (FStar_Pervasives_Native.None, uu____2252) -> begin
[]
end)
in (
...
let uu____2279 = (FStar_List.existsML (fun f1 -> ((

let uu____2284 = (lowercase_module_name f1)
in (uu____2284 = m1)) && (is_implementation f1))) filenames)
in (not (uu____2279))))
...
let uu____2328 = (FStar_Util.smap_try_find graph key)
in (FStar_Util.must uu____2328))
...
let uu____2387 = (FStar_List.map (fun dep1 -> (

let uu____2397 = (discover ((key)::cycle) dep1)
in (dep1)::uu____2397)) direct_deps)
in (FStar_List.flatten uu____2387))
in (FStar_List.unique uu____2384))
in ((FStar_Util.smap_add graph key ((all_deps), (Black)));
(

let uu____2410 = (

let uu____2413 = (FStar_ST.read topologically_sorted)
in (key)::uu____2413)
in (FStar_ST.write topologically_sorted uu____2410));
all_deps;
));
)
end)
...
let uu____2444 = (FStar_Util.smap_try_find m k)
in (FStar_Util.must uu____2444))
in (match (uu____2435) with
| (FStar_Pervasives_Native.Some (intf), FStar_Pervasives_Native.Some (impl)) when ((not (partial_discovery)) && (

let uu____2480 = (FStar_List.existsML (fun f -> (

let uu____2484 = (lowercase_module_name f)
in (uu____2484 = k))) filenames)
in (not (uu____2480)))) -> begin
(intf)::(impl)::[]
end
| (FStar_Pervasives_Native.Some (intf), FStar_Pervasives_Native.Some (impl)) when (FStar_List.existsML (fun f -> ((is_implementation f) && (

let uu____2494 = (lowercase_module_name f)
in (uu____2494 = k)))) filenames) -> begin
(intf)::(impl)::[]
end
| (FStar_Pervasives_Native.Some (intf), uu____2496) -> begin
(intf)::[]
end
...
let uu____2518 = (must_find f)
in (FStar_List.rev uu____2518)))
in (
...
let uu____2533 = (FStar_Util.smap_keys graph)
in (FStar_List.sortWith (fun x y -> (FStar_String.compare x y)) uu____2533))
in (FStar_List.collect (fun k -> (
...
let uu____2587 = (FStar_Util.smap_try_find m k1)
in (FStar_Util.must uu____2587))
in (match (uu____2578) with
| (FStar_Pervasives_Native.Some (intf), uu____2617) when should_append_fsti -> begin
(intf)::[]
end
| uu____2624 -> begin
[]
...
let uu____2636 = (discover1 k1)
in (FStar_List.rev uu____2636))
in (

let deps_as_filenames = (

let uu____2642 = (FStar_List.collect must_find deps)
in (FStar_List.append uu____2642 suffix))
in ((f), (deps_as_filenames)))))))) as_list)))) uu____2530))
in (

let topologically_sorted1 = (

let uu____2650 = (FStar_ST.read topologically_sorted)
in (FStar_List.collect must_find_r uu____2650))
in ((FStar_List.iter (fun uu____2670 -> (match (uu____2670) with
| (m1, r) -> begin
(

let uu____2683 = ((

let uu____2686 = (FStar_ST.read r)
in (not (uu____2686))) && (

let uu____2690 = (FStar_Options.interactive ())
in (not (uu____2690))))
...
let uu____2693 = ((k > (Prims.parse_int "4")) && (

let uu____2701 = (FStar_String.substring m1 (k - (Prims.parse_int "4")) (Prims.parse_int "4"))
in (uu____2701 = ".fst")))
in (match (uu____2693) with
| true -> begin
(

let uu____2708 = (FStar_String.substring m1 (Prims.parse_int "0") (k - (Prims.parse_int "4")))
in (FStar_Util.format1 " Did you mean %s ?" uu____2708))
end
| uu____2715 -> begin
""
end)))
...
let uu____2717 = (FStar_Util.format3 "You passed --verify_module %s but I found no file that contains [module %s] in the dependency graph.%s\n" m1 m1 maybe_fst)
in FStar_Errors.Err (uu____2717))
in (FStar_Pervasives.raise uu____2716)))
end
| uu____2718 -> begin
()
end))
...
let print_make : (Prims.string * Prims.string Prims.list) Prims.list  ->  Prims.unit = (fun deps -> (FStar_List.iter (fun uu____2767 -> (match (uu____2767) with
| (f, deps1) -> begin
(
...
let print : 'a 'b . ((Prims.string * Prims.string Prims.list) Prims.list * 'a * (Prims.string Prims.list * 'b) FStar_Util.smap)  ->  Prims.unit = (fun uu____2818 -> (match (uu____2818) with
| (make_deps, uu____2842, graph) -> begin
(

let uu____2876 = (FStar_Options.dep ())
...
| FStar_Pervasives_Native.Some (uu____2879) -> begin
