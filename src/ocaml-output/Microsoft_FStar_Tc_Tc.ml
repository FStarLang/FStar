...
let log = (fun env -> ((ST.read Microsoft_FStar_Options.log_types) && (not ((let _104_14 = (Microsoft_FStar_Tc_Env.current_module env)
...
let mk_lex_list = (fun vs -> (Microsoft_FStar_List.fold_right (fun v tl -> (let r = (match ((tl.Microsoft_FStar_Absyn_Syntax.pos = Microsoft_FStar_Absyn_Syntax.dummyRange)) with
| true -> begin
v.Microsoft_FStar_Absyn_Syntax.pos
end
| false -> begin
(Microsoft_FStar_Range.union_ranges v.Microsoft_FStar_Absyn_Syntax.pos tl.Microsoft_FStar_Absyn_Syntax.pos)
end)
in (let _104_34 = (let _104_33 = (let _104_32 = (let _104_27 = (let _104_26 = (Microsoft_FStar_Tc_Recheck.recompute_typ v)
in (All.pipe_left (fun _104_25 -> Microsoft_FStar_Util.Inl (_104_25)) _104_26))
...
let fxv_check = (fun head env kt fvs -> (let rec aux = (fun norm kt -> (match ((Microsoft_FStar_Util.set_is_empty fvs)) with
| true -> begin
()
end
| false -> begin
(let fvs' = (match (kt) with
| Microsoft_FStar_Util.Inl (k) -> begin
...
| Microsoft_FStar_Util.Inr (t) -> begin
...
in (let a = (Microsoft_FStar_Util.set_intersect fvs fvs'.Microsoft_FStar_Absyn_Syntax.fxvs)
in (match ((Microsoft_FStar_Util.set_is_empty a)) with
| true -> begin
()
end
| false -> begin
...
| () -> begin
(let escaping = (let _104_82 = (let _104_81 = (Microsoft_FStar_Util.set_elements a)
in (All.pipe_right _104_81 (Microsoft_FStar_List.map (fun x -> (Microsoft_FStar_Absyn_Print.strBvd x.Microsoft_FStar_Absyn_Syntax.v)))))
in (All.pipe_right _104_82 (Microsoft_FStar_String.concat ", ")))
in (let msg = (match (((Microsoft_FStar_Util.set_count a) > 1)) with
| true -> begin
(let _104_83 = (Microsoft_FStar_Tc_Normalize.exp_norm_to_string env head)
in (Microsoft_FStar_Util.format2 "Bound variables \'{%s}\' in the type of \'%s\' escape because of impure applications; add explicit let-bindings" escaping _104_83))
end
| false -> begin
(let _104_84 = (Microsoft_FStar_Tc_Normalize.exp_norm_to_string env head)
in (Microsoft_FStar_Util.format2 "Bound variable \'%s\' in the type of \'%s\' escapes because of impure applications; add explicit let-bindings" escaping _104_84))
end)
...
| Microsoft_FStar_Util.Inl (Some (a), t) -> begin
(Microsoft_FStar_Util.Inl ((a, t)))::[]
end
| Microsoft_FStar_Util.Inr (Some (x), e) -> begin
(Microsoft_FStar_Util.Inr ((x, e)))::[]
end
| _38_99 -> begin
[]
end))
...
in Microsoft_FStar_Util.Inl (_104_97))
in (_104_98)::s)
end)
end
...
in Microsoft_FStar_Util.Inr (_104_100))
in (_104_101)::s)
end)
end
| _38_114 -> begin
...
| (Microsoft_FStar_Util.Inl (a), Microsoft_FStar_Util.Inl (t)) -> begin
(Microsoft_FStar_Util.Inl ((a.Microsoft_FStar_Absyn_Syntax.v, t)))::s
end
| (Microsoft_FStar_Util.Inr (x), Microsoft_FStar_Util.Inr (e)) -> begin
(Microsoft_FStar_Util.Inr ((x.Microsoft_FStar_Absyn_Syntax.v, e)))::s
end
| _38_129 -> begin
(All.failwith "Impossible")
end)
...
| Microsoft_FStar_Util.Inr (lc) -> begin
lc
end)
...
in (Microsoft_FStar_Util.fprint2 "Computed return type %s; expected type %s\n" _104_119 _104_118)))
end
| false -> begin
()
end)
...
| (e, g) -> begin
(let _38_154 = (let _104_125 = (All.pipe_left (fun _104_124 -> Some (_104_124)) (Microsoft_FStar_Tc_Errors.subtyping_failed env t t'))
...
in (Microsoft_FStar_Util.fprint1 "Return comp type is %s\n" _104_126))
end
| false -> begin
()
end)
...
| true -> begin
(let _104_142 = (Microsoft_FStar_Range.string_of_range e.Microsoft_FStar_Absyn_Syntax.pos)
...
in (Microsoft_FStar_Util.fprint3 "(%s) About to check\n\t%s\nagainst expected effect\n\t%s\n" _104_142 _104_141 _104_140))))
end
| false -> begin
()
end)
in (let c = (norm_c env c)
in (let expected_c' = (let _104_143 = (All.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp expected_c)
...
in (All.pipe_left (Microsoft_FStar_Tc_Util.check_comp env e c) _104_144))
in (match (_38_195) with
| (e, _38_193, g) -> begin
(let _38_196 = (match ((Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low)) with
| true -> begin
(let _104_146 = (Microsoft_FStar_Range.string_of_range e.Microsoft_FStar_Absyn_Syntax.pos)
in (let _104_145 = (Microsoft_FStar_Tc_Rel.guard_to_string env g)
in (Microsoft_FStar_Util.fprint2 "(%s) DONE check_expected_effect; guard is: %s\n" _104_146 _104_145)))
end
| false -> begin
()
end)
...
| None -> begin
(Microsoft_FStar_Util.print_string "Expected type is None")
end
| Some (t) -> begin
(let _104_159 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Microsoft_FStar_Util.fprint1 "Expected type is %s" _104_159))
end))

let with_implicits = (fun imps _38_220 -> (match (_38_220) with
| (e, l, g) -> begin
(e, l, (let _38_221 = g
in {Microsoft_FStar_Tc_Rel.guard_f = _38_221.Microsoft_FStar_Tc_Rel.guard_f; Microsoft_FStar_Tc_Rel.deferred = _38_221.Microsoft_FStar_Tc_Rel.deferred; Microsoft_FStar_Tc_Rel.implicits = (Microsoft_FStar_List.append imps g.Microsoft_FStar_Tc_Rel.implicits)}))
end))
...
| true -> begin
(let _104_210 = (Microsoft_FStar_Range.string_of_range k.Microsoft_FStar_Absyn_Syntax.pos)
in (let _104_209 = (Microsoft_FStar_Absyn_Print.kind_to_string k)
in (Microsoft_FStar_Util.fprint2 "(%s) - Checking kind %s" _104_210 _104_209)))
end
| false -> begin
()
end)
...
| (args, g) -> begin
(let _104_212 = (All.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_uvar (u, args)))
in (_104_212, g))
end))
end)))
end
...
| (args, g) -> begin
(match (((Microsoft_FStar_List.length binders) <> (Microsoft_FStar_List.length args))) with
| true -> begin
...
| false -> begin
(let _38_308 = (Microsoft_FStar_List.fold_left2 (fun _38_279 b a -> (match (_38_279) with
...
| (e, _38_299, g) -> begin
(let subst = (Microsoft_FStar_Util.Inr ((x.Microsoft_FStar_Absyn_Syntax.v, e)))::subst
...
| _38_304 -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Ill-typed argument to kind abbreviation", (Microsoft_FStar_Absyn_Util.range_of_arg a)))))
end)
end)) ([], [], []) binders args)
in (match (_38_308) with
| (subst, args, guards) -> begin
(let args = (Microsoft_FStar_List.rev args)
in (let k = (All.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_abbrev ((l, args), Microsoft_FStar_Absyn_Syntax.mk_Kind_unknown)))
in (let k' = (Microsoft_FStar_Tc_Normalize.norm_kind ((Microsoft_FStar_Tc_Normalize.DeltaHard)::[]) env k)
in (let k = (All.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_abbrev ((l, args), k')))
in (let _104_228 = (Microsoft_FStar_List.fold_left Microsoft_FStar_Tc_Rel.conj_guard g guards)
in (k', _104_228))))))
end))
end)
end))
...
| (k, f) -> begin
(let _38_322 = (All.pipe_left (tc_args env) (Prims.snd kabr))
in (match (_38_322) with
| (args, g) -> begin
(let kabr = ((Prims.fst kabr), args)
in (let kk = (All.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_abbrev (kabr, k)))
...
in (let _104_233 = (All.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (bs, k)))
...
| (k, g) -> begin
(let b = (Microsoft_FStar_Util.Inl ((let _38_363 = a
...
| (x, env', g) -> begin
(let b = (Microsoft_FStar_Util.Inr (x), imp)
...
in (aux env bs)))
and tc_args = (fun env args -> (Microsoft_FStar_List.fold_right (fun _38_386 _38_389 -> (match ((_38_386, _38_389)) with
...
in (((Microsoft_FStar_Util.Inl (t), imp))::args, _104_252))
end))
end
...
in (((Microsoft_FStar_Util.Inr (e), imp))::args, _104_253))
end))
end)
...
| (Microsoft_FStar_Util.Inl (res), _38_427)::args -> begin
(res, args)
end
| _38_431 -> begin
(All.failwith "Impossible")
...
| (res, args) -> begin
(let _38_450 = (let _104_261 = (All.pipe_right c.Microsoft_FStar_Absyn_Syntax.flags (Microsoft_FStar_List.map (fun _38_3 -> (match (_38_3) with
...
in (All.pipe_right _104_261 Microsoft_FStar_List.unzip))
...
in (let _104_262 = (Microsoft_FStar_List.fold_left Microsoft_FStar_Tc_Rel.conj_guard f guards)
...
in (let t = (All.pipe_left (w k) (Microsoft_FStar_Absyn_Syntax.mk_Typ_btvar a))
in (let _38_470 = (Microsoft_FStar_Tc_Util.maybe_instantiate_typ env t k)
in (match (_38_470) with
| (t, k, implicits) -> begin
(All.pipe_left (with_implicits implicits) (t, k, Microsoft_FStar_Tc_Rel.trivial_guard))
end)))))
end
...
| (t, k, imps) -> begin
(All.pipe_left (with_implicits imps) (t, k, Microsoft_FStar_Tc_Rel.trivial_guard))
end)))))
end
...
| (cod, f) -> begin
(let t = (All.pipe_left (w Microsoft_FStar_Absyn_Syntax.ktype) (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (bs, cod)))
in (let _38_550 = (match ((Microsoft_FStar_Absyn_Util.is_smt_lemma t)) with
| true -> begin
(match (cod.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Comp ({Microsoft_FStar_Absyn_Syntax.effect_name = _38_533; Microsoft_FStar_Absyn_Syntax.result_typ = _38_531; Microsoft_FStar_Absyn_Syntax.effect_args = (Microsoft_FStar_Util.Inl (pre), _38_527)::(Microsoft_FStar_Util.Inl (post), _38_522)::(Microsoft_FStar_Util.Inr (pats), _38_517)::[]; Microsoft_FStar_Absyn_Syntax.flags = _38_513}) -> begin
(let fvs = (Microsoft_FStar_Absyn_Util.freevars_exp pats)
in (match ((All.pipe_right bs (Microsoft_FStar_Util.find_opt (fun _38_540 -> (match (_38_540) with
| (b, _38_539) -> begin
(match (b) with
| Microsoft_FStar_Util.Inl (a) -> begin
(not ((Microsoft_FStar_Util.set_mem a fvs.Microsoft_FStar_Absyn_Syntax.ftvs)))
end
| Microsoft_FStar_Util.Inr (x) -> begin
(not ((Microsoft_FStar_Util.set_mem x fvs.Microsoft_FStar_Absyn_Syntax.fxvs)))
end)
end))))) with
| None -> begin
()
...
in (Microsoft_FStar_Util.format1 "Pattern misses at least one bound variables: %s" _104_291))
...
in (let _104_299 = (All.pipe_left (w k) (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam (bs, t)))
in (let _104_298 = (let _104_297 = (Microsoft_FStar_Tc_Rel.close_guard bs f)
in (All.pipe_left (Microsoft_FStar_Tc_Rel.conj_guard g) _104_297))
...
| true -> begin
(let _104_302 = (Microsoft_FStar_Range.string_of_range top.Microsoft_FStar_Absyn_Syntax.pos)
...
in (Microsoft_FStar_Util.fprint3 "(%s) Checking refinement formula %s; env expects type %s\n" _104_302 _104_301 _104_300))))
end
| false -> begin
()
end)
...
| (phi, f2) -> begin
(let _104_309 = (All.pipe_left (w Microsoft_FStar_Absyn_Syntax.ktype) (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine (x, phi)))
...
| true -> begin
(let _104_312 = (Microsoft_FStar_Range.string_of_range top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _104_311 = (All.pipe_left Microsoft_FStar_Util.string_of_int (Microsoft_FStar_List.length args))
in (let _104_310 = (Microsoft_FStar_Absyn_Print.typ_to_string top)
in (Microsoft_FStar_Util.fprint3 "(%s) Checking type application (%s): %s\n" _104_312 _104_311 _104_310))))
end
| false -> begin
()
end)
...
| true -> begin
(let _104_316 = (Microsoft_FStar_Range.string_of_range head.Microsoft_FStar_Absyn_Syntax.pos)
...
in (Microsoft_FStar_Util.fprint4 "(%s) head %s has kind %s ... after norm %s\n" _104_316 _104_315 _104_314 _104_313)))))
end
| false -> begin
()
end)
...
in (All.pipe_right _104_319 Prims.fst))
...
in (All.pipe_left (Microsoft_FStar_Tc_Util.force_trivial env) _104_321))
in (kres, args, g)))))))
end))
end
...
in (_104_332, (Microsoft_FStar_List.rev outargs), g))
end
...
(let _104_336 = (let _104_335 = (let _104_334 = (let _104_333 = (Microsoft_FStar_List.hd args)
...
| (((Microsoft_FStar_Util.Inl (a), Some (Microsoft_FStar_Absyn_Syntax.Implicit))::rest, (_, None)::_)) | (((Microsoft_FStar_Util.Inl (a), Some (Microsoft_FStar_Absyn_Syntax.Implicit))::rest, [])) -> begin
(let formal = (Microsoft_FStar_List.hd formals)
...
| (t, u) -> begin
(let targ = (Microsoft_FStar_Util.Inl (t), Some (Microsoft_FStar_Absyn_Syntax.Implicit))
in (let g = (add_implicit (Microsoft_FStar_Util.Inl (u)) g)
in (let subst = (maybe_extend_subst subst formal targ)
in (check_args ((targ)::outargs) subst g rest args))))
end)))
end
| (((Microsoft_FStar_Util.Inr (x), Some (Microsoft_FStar_Absyn_Syntax.Implicit))::rest, (_, None)::_)) | (((Microsoft_FStar_Util.Inr (x), Some (Microsoft_FStar_Absyn_Syntax.Implicit))::rest, [])) -> begin
(let formal = (Microsoft_FStar_List.hd formals)
...
| (e, u) -> begin
(let varg = (Microsoft_FStar_Util.Inr (e), Some (Microsoft_FStar_Absyn_Syntax.Implicit))
in (let g = (add_implicit (Microsoft_FStar_Util.Inr (u)) g)
...
| ((Microsoft_FStar_Util.Inl (a), aqual), (Microsoft_FStar_Util.Inl (t), imp)) -> begin
...
in (Microsoft_FStar_Util.fprint2 "Checking argument %s against expected kind %s\n" _104_340 _104_339)))
end
| false -> begin
()
end)
...
in (Microsoft_FStar_Util.fprint1 ">>>Got guard %s\n" _104_341))
end
| false -> begin
()
end)
in (let actual = (Microsoft_FStar_Util.Inl (t), imp)
in (let g' = (let _104_343 = (let _104_342 = (Microsoft_FStar_Tc_Util.short_circuit_typ (Microsoft_FStar_Util.Inl (head)) outargs)
in (All.pipe_left Microsoft_FStar_Tc_Rel.guard_of_guard_formula _104_342))
...
| ((Microsoft_FStar_Util.Inr (x), aqual), (Microsoft_FStar_Util.Inr (v), imp)) -> begin
...
in (Microsoft_FStar_Util.fprint2 "Checking argument %s against expected type %s\n" _104_346 _104_345)))
end
| false -> begin
()
end)
...
| (v, _38_761, g') -> begin
(let actual = (Microsoft_FStar_Util.Inr (v), imp)
in (let g' = (let _104_348 = (let _104_347 = (Microsoft_FStar_Tc_Util.short_circuit_typ (Microsoft_FStar_Util.Inl (head)) outargs)
in (All.pipe_left Microsoft_FStar_Tc_Rel.guard_of_guard_formula _104_347))
...
| ((Microsoft_FStar_Util.Inl (a), _38_770), (Microsoft_FStar_Util.Inr (v), imp)) -> begin
...
| _38_780 -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Expected a type; got an expression", v.Microsoft_FStar_Absyn_Syntax.pos))))
end)
end
| ((Microsoft_FStar_Util.Inr (_38_782), _38_785), (Microsoft_FStar_Util.Inl (_38_788), _38_791)) -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Expected an expression; got a type", (Microsoft_FStar_Absyn_Util.range_of_arg actual)))))
end)
end
| (_38_795, []) -> begin
...
in (_104_353, (Microsoft_FStar_List.rev outargs), g))
end
| ([], _38_800) -> begin
(let _104_361 = (let _104_360 = (let _104_359 = (let _104_358 = (let _104_356 = (let _104_355 = (All.pipe_right outargs (Microsoft_FStar_List.filter (fun _38_4 -> (match (_38_4) with
...
in (Microsoft_FStar_List.length _104_355))
in (All.pipe_right _104_356 Microsoft_FStar_Util.string_of_int))
in (let _104_357 = (All.pipe_right (Microsoft_FStar_List.length args0) Microsoft_FStar_Util.string_of_int)
in (Microsoft_FStar_Util.format2 "Too many arguments to type; expected %s arguments but got %s" _104_358 _104_357)))
...
| (Microsoft_FStar_Absyn_Syntax.Typ_uvar (_38_813), Microsoft_FStar_Absyn_Syntax.Kind_arrow (formals, k)) when ((Microsoft_FStar_List.length args) = (Microsoft_FStar_List.length formals)) -> begin
(let result_k = (let s = (Microsoft_FStar_List.map2 Microsoft_FStar_Absyn_Util.subst_formal formals args)
...
| (t1, f2) -> begin
(let _104_372 = (All.pipe_left (w k1) (Microsoft_FStar_Absyn_Syntax.mk_Typ_ascribed' (t1, k1)))
...
in (match (s.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_uvar (u, k1) -> begin
(let _38_870 = (match ((All.pipe_left (Microsoft_FStar_Tc_Env.debug env) Microsoft_FStar_Options.High)) with
| true -> begin
(let _104_374 = (Microsoft_FStar_Absyn_Print.typ_to_string s)
in (let _104_373 = (Microsoft_FStar_Absyn_Print.kind_to_string k1)
in (Microsoft_FStar_Util.fprint2 "Admitting un-instantiated uvar %s at kind %s\n" _104_374 _104_373)))
end
| false -> begin
()
end)
in (let _104_377 = (All.pipe_left (w k1) (Microsoft_FStar_Absyn_Syntax.mk_Typ_uvar' (u, k1)))
in (_104_377, k1, Microsoft_FStar_Tc_Rel.trivial_guard)))
end
| _38_873 -> begin
(let _38_874 = (match ((All.pipe_left (Microsoft_FStar_Tc_Env.debug env) Microsoft_FStar_Options.High)) with
| true -> begin
(let _104_379 = (Microsoft_FStar_Absyn_Print.typ_to_string s)
in (let _104_378 = (Microsoft_FStar_Absyn_Print.kind_to_string k1)
in (Microsoft_FStar_Util.fprint2 "Admitting instantiated uvar %s at kind %s\n" _104_379 _104_378)))
end
| false -> begin
()
end)
...
in (Microsoft_FStar_Util.format1 "Unexpected type : %s\n" _104_386))
in (All.failwith _104_387))
end))))))
...
(value_check_expected_typ env e (Microsoft_FStar_Util.Inl (t1)))
end
...
| true -> begin
Microsoft_FStar_Util.Inl (t)
end
| false -> begin
(let _104_394 = (let _104_393 = (Microsoft_FStar_Absyn_Syntax.mk_Total t)
in (All.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp _104_393))
in Microsoft_FStar_Util.Inr (_104_394))
end)
in (let _104_395 = (value_check_expected_typ env e tc)
in (All.pipe_left (with_implicits implicits) _104_395)))
end))))
end
...
in (All.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp _104_396))
in Microsoft_FStar_Util.Inr (_104_397))
end)
...
| true -> begin
(let _104_403 = (let _104_402 = (let _104_401 = (Microsoft_FStar_Util.format1 "Expected a data constructor; got %s" v.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.str)
...
in (All.pipe_left (with_implicits implicits) _104_404))
end)))
end))))
end
...
in (value_check_expected_typ env e (Microsoft_FStar_Util.Inl (t)))))
end
...
in ((Microsoft_FStar_List.rev out), env, g, _104_427))
end
| (hdannot::tl_annot, hd::tl) -> begin
(match ((hdannot, hd)) with
| ((Microsoft_FStar_Util.Inl (_38_1062), _38_1065), (Microsoft_FStar_Util.Inr (_38_1068), _38_1071)) -> begin
(let env = (maybe_push_binding env hdannot)
in (tc_binders ((hdannot)::out, env, g, subst) tl_annot c bs))
end
| ((Microsoft_FStar_Util.Inl (a), _38_1078), (Microsoft_FStar_Util.Inl (b), imp)) -> begin
...
| (k, g) -> begin
(let b = (Microsoft_FStar_Util.Inl ((let _38_1097 = b
...
| ((Microsoft_FStar_Util.Inr (x), _38_1105), (Microsoft_FStar_Util.Inr (y), imp)) -> begin
(let tx = (Microsoft_FStar_Absyn_Util.subst_typ subst x.Microsoft_FStar_Absyn_Syntax.sort)
...
in (Microsoft_FStar_Util.fprint1 "Checking binder %s\n" _104_430))
end
| false -> begin
()
end)
...
| (t, g) -> begin
(let b = (Microsoft_FStar_Util.Inr ((let _38_1128 = y
...
in (Microsoft_FStar_Util.format2 "Annotated %s; given %s" _104_433 _104_432)))
in (fail _104_434 t))
end)
end
| ([], _38_1137) -> begin
...
| true -> begin
(match ((All.pipe_right (Microsoft_FStar_Absyn_Util.comp_result c) (whnf env))) with
...
in (Microsoft_FStar_Util.format1 "More arguments than annotated type (%s)" _104_435))
in (fail _104_436 t))
end)
end
| false -> begin
...
in ((Microsoft_FStar_List.rev out), env, g, _104_438)))
end)
end))
...
in (Microsoft_FStar_Util.fprint1 "Building let-rec environment... type of this abstraction is %s\n" _104_443))
end
| false -> begin
()
end)
...
in (let filter_types_and_functions = (fun bs -> (All.pipe_right bs (Microsoft_FStar_List.collect (fun b -> (match (b) with
| (Microsoft_FStar_Util.Inl (_38_1173), _38_1176) -> begin
[]
end
| (Microsoft_FStar_Util.Inr (x), _38_1181) -> begin
...
in (match ((All.pipe_right ct.Microsoft_FStar_Absyn_Syntax.flags (Microsoft_FStar_List.tryFind (fun _38_6 -> (match (_38_6) with
...
(let _38_1212 = (match (((Microsoft_FStar_List.length bs') <> (Microsoft_FStar_List.length actuals))) with
| true -> begin
(let _104_459 = (let _104_458 = (let _104_457 = (let _104_455 = (Microsoft_FStar_Util.string_of_int (Microsoft_FStar_List.length bs'))
in (let _104_454 = (Microsoft_FStar_Util.string_of_int (Microsoft_FStar_List.length actuals))
in (Microsoft_FStar_Util.format2 "Decreases clause on a function with an unexpected number of arguments (expected %s; got %s)" _104_455 _104_454)))
...
in (let subst = (Microsoft_FStar_List.map2 (fun b a -> (match ((b, a)) with
| ((Microsoft_FStar_Util.Inl (formal), _38_1220), (Microsoft_FStar_Util.Inl (actual), _38_1225)) -> begin
...
in Microsoft_FStar_Util.Inl (_104_463))
end
| ((Microsoft_FStar_Util.Inr (formal), _38_1231), (Microsoft_FStar_Util.Inr (actual), _38_1236)) -> begin
(let _104_465 = (let _104_464 = (Microsoft_FStar_Absyn_Util.bvar_to_exp actual)
in (formal.Microsoft_FStar_Absyn_Syntax.v, _104_464))
in Microsoft_FStar_Util.Inr (_104_465))
end
| _38_1240 -> begin
(All.failwith "impossible")
end)) bs' actuals)
...
| _38_1243 -> begin
(let actual_args = (All.pipe_right actuals filter_types_and_functions)
...
in (let letrecs = (All.pipe_right letrecs (Microsoft_FStar_List.map (fun _38_1252 -> (match (_38_1252) with
| (l, t0) -> begin
...
(match ((Microsoft_FStar_Util.prefix formals)) with
| (bs, (Microsoft_FStar_Util.Inr (x), imp)) -> begin
...
in (let precedes = (match ((All.pipe_right ct.Microsoft_FStar_Absyn_Syntax.flags (Microsoft_FStar_List.tryFind (fun _38_7 -> (match (_38_7) with
...
in Microsoft_FStar_Util.Inr (_104_470))
in (_104_471)::[])
in (Microsoft_FStar_Absyn_Util.subst_exp subst dec))
...
in (_104_477)::[])
in (Microsoft_FStar_List.append bs _104_478))
in (All.pipe_right _104_479 filter_types_and_functions))
...
in (let bs = (Microsoft_FStar_List.append bs (((Microsoft_FStar_Util.Inr ((let _38_1288 = x
...
in (let _104_495 = (All.pipe_right letrecs (Microsoft_FStar_List.fold_left (fun env _38_1308 -> (match (_38_1308) with
| (x, t) -> begin
(Microsoft_FStar_Tc_Env.push_local_binding env (binding_of_lb x t))
end)) env))
in (let _104_494 = (All.pipe_right letrecs (Microsoft_FStar_List.collect (fun _38_8 -> (match (_38_8) with
| (Microsoft_FStar_Util.Inl (x), t) -> begin
...
in (Microsoft_FStar_Util.fprint3 "!!!!!!!!!!!!!!!body %s has type %s\nguard is %s\n" _104_499 _104_498 _104_497))))
end
| false -> begin
()
end)
in (let guard_body = (Microsoft_FStar_Tc_Rel.solve_deferred_constraints envbody guard_body)
in (let _38_1369 = (match ((All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Implicits")))) with
| true -> begin
(let _104_500 = (All.pipe_left Microsoft_FStar_Util.string_of_int (Microsoft_FStar_List.length guard_body.Microsoft_FStar_Tc_Rel.implicits))
in (Microsoft_FStar_Util.fprint1 "Introduced %s implicits in body of abstraction\n" _104_500))
end
| false -> begin
()
end)
...
| false -> begin
(let guard = (Microsoft_FStar_Tc_Rel.close_guard (Microsoft_FStar_List.append bs letrec_binders) guard)
...
in (Microsoft_FStar_Util.fprint3 "!!!!!!!!!!!!!!!Annotating lambda with type %s (%s)\nGuard is %s\n" _104_514 _104_513 _104_512))))
end
| false -> begin
()
end)
...
in (Microsoft_FStar_Util.format1 "Unexpected value: %s" _104_517))
in (All.failwith _104_518))
end))))
...
in (All.pipe_left Microsoft_FStar_Range.string_of_range _104_521))
in (let _104_522 = (Microsoft_FStar_Absyn_Print.tag_of_exp e)
in (Microsoft_FStar_Util.fprint2 "%s (%s)\n" _104_523 _104_522)))
end
| false -> begin
()
end)
in (let w = (fun lc -> (All.pipe_left (Microsoft_FStar_Absyn_Syntax.syn e.Microsoft_FStar_Absyn_Syntax.pos) (Some (lc.Microsoft_FStar_Absyn_Syntax.res_typ))))
in (let top = e
in (match (e.Microsoft_FStar_Absyn_Syntax.n) with
...
in (All.pipe_left _104_555 (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed (e1, t1, Some (c.Microsoft_FStar_Absyn_Syntax.eff_name)))))
...
in (All.pipe_left _104_568 _104_567)))
...
in (All.pipe_right _104_576 Prims.fst))
in (All.pipe_right _104_577 instantiate_both))
in (let _38_1508 = (match ((Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High)) with
| true -> begin
(let _104_579 = (Microsoft_FStar_Range.string_of_range top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _104_578 = (Microsoft_FStar_Absyn_Print.exp_to_string top)
in (Microsoft_FStar_Util.fprint2 "(%s) Checking app %s\n" _104_579 _104_578)))
end
| false -> begin
()
end)
...
| () -> begin
(let n_args = (Microsoft_FStar_List.length args)
...
in (match (args) with
| (Microsoft_FStar_Util.Inr (e1), _38_1531)::(Microsoft_FStar_Util.Inr (e2), _38_1526)::[] -> begin
...
in (All.pipe_left Microsoft_FStar_Absyn_Util.b2t _104_582))
in (let _104_584 = (let _104_583 = (Microsoft_FStar_Tc_Util.return_value env Microsoft_FStar_Absyn_Util.t_bool xexp)
in (All.pipe_right _104_583 Microsoft_FStar_Tc_Util.lcomp_of_comp))
...
in (All.pipe_left Microsoft_FStar_Absyn_Util.b2t _104_586))
in (let _104_588 = (let _104_587 = (Microsoft_FStar_Tc_Util.return_value env Microsoft_FStar_Absyn_Util.t_bool xexp)
in (All.pipe_right _104_587 Microsoft_FStar_Tc_Util.lcomp_of_comp))
in (Microsoft_FStar_Tc_Util.ite env _104_589 _104_588 c2)))
end)
in (let c = (let _104_592 = (let _104_591 = (All.pipe_left (fun _104_590 -> Some (_104_590)) (Microsoft_FStar_Tc_Env.Binding_var ((x.Microsoft_FStar_Absyn_Syntax.v, Microsoft_FStar_Absyn_Util.t_bool))))
in (_104_591, c2))
...
| _38_1548 -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Expected two boolean arguments", head.Microsoft_FStar_Absyn_Syntax.pos))))
end))
end
| _38_1550 -> begin
...
| true -> begin
(let _104_601 = (Microsoft_FStar_Range.string_of_range head.Microsoft_FStar_Absyn_Syntax.pos)
in (let _104_600 = (Microsoft_FStar_Absyn_Print.typ_to_string thead)
in (Microsoft_FStar_Util.fprint2 "(%s) Type of head is %s\n" _104_601 _104_600)))
end
| false -> begin
()
end)
...
| (Microsoft_FStar_Util.Inl (t), _38_1585)::_38_1581 -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Explicit type applications on a term with unknown type; add an annotation?", t.Microsoft_FStar_Absyn_Syntax.pos))))
end
| (Microsoft_FStar_Util.Inr (e), imp)::tl -> begin
...
in (((Microsoft_FStar_Util.Inr (e), imp))::args, (c)::comps, _104_611))
end))
end))
end))
...
in (All.pipe_left (Microsoft_FStar_Tc_Util.force_trivial env) _104_615))
in (let comp = (let _104_618 = (All.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp cres)
in (Microsoft_FStar_List.fold_right (fun c out -> (Microsoft_FStar_Tc_Util.bind env None c (None, out))) ((chead)::comps) _104_618))
...
(match ((bs, args)) with
| ((Microsoft_FStar_Util.Inl (a), Some (Microsoft_FStar_Absyn_Syntax.Implicit))::rest, (_38_1639, None)::_38_1637) -> begin
(let k = (Microsoft_FStar_Absyn_Util.subst_kind subst a.Microsoft_FStar_Absyn_Syntax.sort)
in (let _38_1645 = (fxv_check head env (Microsoft_FStar_Util.Inl (k)) fvs)
in (let _38_1649 = (let _104_656 = (let _104_655 = (Microsoft_FStar_List.hd args)
...
in (Microsoft_FStar_Util.fprint2 "Instantiating %s to %s" _104_658 _104_657)))
end
| false -> begin
()
end)
in (let subst = (Microsoft_FStar_Util.Inl ((a.Microsoft_FStar_Absyn_Syntax.v, targ)))::subst
in (let arg = (let _104_659 = (Microsoft_FStar_Absyn_Syntax.as_implicit true)
in (Microsoft_FStar_Util.Inl (targ), _104_659))
...
in Microsoft_FStar_Util.Inl (_104_665))
in (add_implicit _104_666 g))
in (subst, (arg)::outargs, (arg)::arg_rets, comps, _104_667, fvs))
in (tc_args _104_668 rest cres args)))))
end))))
end
| ((Microsoft_FStar_Util.Inr (x), Some (Microsoft_FStar_Absyn_Syntax.Implicit))::rest, (_38_1664, None)::_38_1662) -> begin
(let t = (Microsoft_FStar_Absyn_Util.subst_typ subst x.Microsoft_FStar_Absyn_Syntax.sort)
in (let _38_1670 = (fxv_check head env (Microsoft_FStar_Util.Inr (t)) fvs)
in (let _38_1674 = (Microsoft_FStar_Tc_Util.new_implicit_evar env t)
in (match (_38_1674) with
| (varg, u) -> begin
(let subst = (Microsoft_FStar_Util.Inr ((x.Microsoft_FStar_Absyn_Syntax.v, varg)))::subst
in (let arg = (let _104_669 = (Microsoft_FStar_Absyn_Syntax.as_implicit true)
in (Microsoft_FStar_Util.Inr (varg), _104_669))
in (tc_args (subst, (arg)::outargs, (arg)::arg_rets, comps, (add_implicit (Microsoft_FStar_Util.Inr (u)) g), fvs) rest cres args)))
end))))
end
| ((Microsoft_FStar_Util.Inl (a), aqual)::rest, (Microsoft_FStar_Util.Inl (t), aq)::rest') -> begin
...
in (Microsoft_FStar_Util.fprint2 "\tGot a type arg for %s = %s\n" _104_675 _104_674)))
end
| false -> begin
()
end)
in (let k = (Microsoft_FStar_Absyn_Util.subst_kind subst a.Microsoft_FStar_Absyn_Syntax.sort)
in (let _38_1693 = (fxv_check head env (Microsoft_FStar_Util.Inl (k)) fvs)
...
in (let arg = (Microsoft_FStar_Util.Inl (t), aq)
in (let subst = (let _104_677 = (Microsoft_FStar_List.hd bs)
...
| ((Microsoft_FStar_Util.Inr (x), aqual)::rest, (Microsoft_FStar_Util.Inr (e), aq)::rest') -> begin
...
in (Microsoft_FStar_Util.fprint2 "\tType of arg (before subst (%s)) = %s\n" _104_685 _104_684)))
end
| false -> begin
()
end)
...
in (Microsoft_FStar_Util.fprint1 "\tType of arg (after subst) = %s\n" _104_686))
end
| false -> begin
()
end)
in (let _38_1724 = (fxv_check head env (Microsoft_FStar_Util.Inr (targ)) fvs)
...
in (let _38_1730 = (match (((All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("EQ"))) && env.Microsoft_FStar_Tc_Env.use_eq)) with
| true -> begin
(let _104_688 = (Microsoft_FStar_Absyn_Print.exp_to_string e)
in (let _104_687 = (Microsoft_FStar_Absyn_Print.typ_to_string targ)
in (Microsoft_FStar_Util.fprint2 "Checking arg %s at type %s with an equality constraint!\n" _104_688 _104_687)))
end
| false -> begin
()
end)
...
in (Microsoft_FStar_Util.fprint3 "Checking arg (%s) %s at type %s\n" _104_691 _104_690 _104_689))))
end
| false -> begin
()
end)
...
in (Microsoft_FStar_Util.fprint2 "Guard on this arg is %s;\naccumulated guard is %s\n" _104_693 _104_692)))
end
| false -> begin
()
end)
in (let arg = (Microsoft_FStar_Util.Inr (e), aq)
in (match ((Microsoft_FStar_Absyn_Util.is_tot_or_gtot_lcomp c)) with
| true -> begin
(let subst = (let _104_694 = (Microsoft_FStar_List.hd bs)
...
| true -> begin
(let subst = (let _104_699 = (Microsoft_FStar_List.hd bs)
...
| false -> begin
(match ((let _104_704 = (Microsoft_FStar_List.hd bs)
...
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.varg _104_705))
...
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.varg _104_710))
in (_104_711)::arg_rets)
in (let _104_716 = (let _104_714 = (let _104_713 = (All.pipe_left (fun _104_712 -> Some (_104_712)) (Microsoft_FStar_Tc_Env.Binding_var ((x.Microsoft_FStar_Absyn_Syntax.v, targ))))
in (_104_713, c))
in (_104_714)::comps)
in (let _104_715 = (Microsoft_FStar_Util.set_add x fvs)
...
| ((Microsoft_FStar_Util.Inr (_38_1753), _38_1756)::_38_1751, (Microsoft_FStar_Util.Inl (_38_1762), _38_1765)::_38_1760) -> begin
(let _104_722 = (let _104_721 = (let _104_720 = (let _104_719 = (Microsoft_FStar_List.hd args)
...
| ((Microsoft_FStar_Util.Inl (_38_1772), _38_1775)::_38_1770, (Microsoft_FStar_Util.Inr (_38_1781), _38_1784)::_38_1779) -> begin
(let _104_726 = (let _104_725 = (let _104_724 = (let _104_723 = (Microsoft_FStar_List.hd args)
...
| (_38_1789, []) -> begin
(let _38_1792 = (fxv_check head env (Microsoft_FStar_Util.Inr (cres.Microsoft_FStar_Absyn_Syntax.res_typ)) fvs)
...
in (let refine_with_equality = ((Microsoft_FStar_Absyn_Util.is_pure_or_ghost_lcomp cres) && (All.pipe_right comps (Microsoft_FStar_Util.for_some (fun _38_1800 -> (match (_38_1800) with
| (_38_1798, c) -> begin
(not ((Microsoft_FStar_Absyn_Util.is_pure_or_ghost_lcomp c)))
end)))))
in (let cres = (match (refine_with_equality) with
| true -> begin
(let _104_728 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app_flat (head, (Microsoft_FStar_List.rev arg_rets)) (Some (cres.Microsoft_FStar_Absyn_Syntax.res_typ)) top.Microsoft_FStar_Absyn_Syntax.pos)
...
in (Microsoft_FStar_Util.fprint3 "Not refining result: f=%s; cres=%s; guard=%s\n" _104_731 _104_730 _104_729))))
end
| false -> begin
()
end)
...
in (All.pipe_right _104_733 (Microsoft_FStar_Tc_Rel.solve_deferred_constraints env)))
...
in (All.pipe_left (Microsoft_FStar_Absyn_Util.subst_typ subst) _104_736))
in (Microsoft_FStar_Absyn_Syntax.mk_Total _104_737))
in (All.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp _104_738))
in (_104_739, g)))
end)
...
in (Microsoft_FStar_Util.fprint1 "\t Type of result cres is %s\n" _104_740))
end
| false -> begin
()
end)
in (let comp = (Microsoft_FStar_List.fold_left (fun out c -> (Microsoft_FStar_Tc_Util.bind env None (Prims.snd c) ((Prims.fst c), out))) cres comps)
in (let comp = (Microsoft_FStar_Tc_Util.bind env None chead (None, comp))
in (let app = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app_flat (head, (Microsoft_FStar_List.rev outargs)) (Some (comp.Microsoft_FStar_Absyn_Syntax.res_typ)) top.Microsoft_FStar_Absyn_Syntax.pos)
...
in (Microsoft_FStar_Util.fprint2 "\t Type of app term %s is %s\n" _104_746 _104_745)))
end
| false -> begin
()
end)
...
in (All.pipe_right _104_751 Microsoft_FStar_Absyn_Util.unrefine))
...
| true -> begin
(let _104_752 = (Microsoft_FStar_Range.string_of_range tres.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Util.fprint1 "%s: Warning: Potentially redundant explicit currying of a function type \n" _104_752))
end
| false -> begin
()
end)
...
in (Microsoft_FStar_Util.format2 "Too many arguments to function of type %s; got %s" _104_760 _104_759)))
...
| (e, c, g) -> begin
(let _38_1849 = (match ((All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Implicits")))) with
| true -> begin
(let _104_771 = (All.pipe_left Microsoft_FStar_Util.string_of_int (Microsoft_FStar_List.length g.Microsoft_FStar_Tc_Rel.implicits))
in (Microsoft_FStar_Util.fprint1 "Introduced %s implicits in application\n" _104_771))
end
| false -> begin
()
end)
...
| true -> begin
(let _104_776 = (Microsoft_FStar_Range.string_of_range e.Microsoft_FStar_Absyn_Syntax.pos)
...
in (All.pipe_right _104_773 (fun x -> (match (x) with
| None -> begin
"None"
end
| Some (t) -> begin
...
in (Microsoft_FStar_Util.fprint3 "(%s) About to check %s against expected typ %s\n" _104_776 _104_775 _104_774))))
end
| false -> begin
()
end)
...
(let guard_x = (let _104_780 = (All.pipe_left (fun _104_779 -> Some (_104_779)) e1.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Absyn_Util.new_bvd _104_780))
in (let t_eqns = (All.pipe_right eqns (Microsoft_FStar_List.map (tc_eqn guard_x c1.Microsoft_FStar_Absyn_Syntax.res_typ env_branches)))
in (let _38_1897 = (let _38_1894 = (Microsoft_FStar_List.fold_right (fun _38_1888 _38_1891 -> (match ((_38_1888, _38_1891)) with
...
| true -> begin
(let _104_788 = (Microsoft_FStar_Range.string_of_range top.Microsoft_FStar_Absyn_Syntax.pos)
...
in (Microsoft_FStar_Util.fprint4 "(%s) comp\n\tscrutinee: %s\n\tbranches: %s\nguard = %s\n" _104_788 _104_787 _104_786 _104_785)))))
end
| false -> begin
()
end)
in (let cres = (let _104_791 = (let _104_790 = (All.pipe_left (fun _104_789 -> Some (_104_789)) (Microsoft_FStar_Tc_Env.Binding_var ((guard_x, c1.Microsoft_FStar_Absyn_Syntax.res_typ))))
in (_104_790, c_branches))
in (Microsoft_FStar_Tc_Util.bind env (Some (e1)) c1 _104_791))
in (let e = (let _104_798 = (w cres)
in (let _104_797 = (let _104_796 = (let _104_795 = (Microsoft_FStar_List.map (fun _38_1908 -> (match (_38_1908) with
| (f, _38_1903, _38_1905, _38_1907) -> begin
f
end)) t_eqns)
in (e1, _104_795))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_match _104_796))
in (All.pipe_left _104_798 _104_797)))
...
| Microsoft_FStar_Util.Inr (_38_1926) -> begin
true
end
| _38_1929 -> begin
false
...
| true -> begin
(let _104_803 = (Microsoft_FStar_Range.string_of_range top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _104_802 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Microsoft_FStar_Util.fprint2 "(%s) Checked type annotation %s\n" _104_803 _104_802)))
end
| false -> begin
()
end)
...
| (c1, guard_f) -> begin
(match (x) with
| Microsoft_FStar_Util.Inr (_38_1959) -> begin
...
| false -> begin
(let _38_1964 = (match ((ST.read Microsoft_FStar_Options.warn_top_level_effects)) with
| true -> begin
...
in (All.pipe_left Microsoft_FStar_List.hd _104_813))
end
| false -> begin
(x, e1, c1)
end)
...
in (All.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp _104_814))
...
in (let _38_1978 = (ST.op_Colon_Equals e2.Microsoft_FStar_Absyn_Syntax.tk (Some (Microsoft_FStar_Tc_Recheck.t_unit)))
...
in (All.pipe_left _104_823 _104_822)))
...
in (All.pipe_left _104_833 _104_832)))
...
in (All.pipe_left (fun _104_836 -> Microsoft_FStar_Tc_Rel.NonTrivial (_104_836)) _104_838))
in (Microsoft_FStar_Tc_Rel.guard_of_guard_formula _104_839))
in (Microsoft_FStar_Tc_Rel.imp_guard _104_840 g2))
in (All.pipe_left _104_842 _104_841)))
...
in (match ((Microsoft_FStar_Util.set_mem (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s bvd t) fvs.Microsoft_FStar_Absyn_Syntax.fxvs)) with
| true -> begin
...
in (All.pipe_left (Microsoft_FStar_Tc_Rel.try_discharge_guard env) _104_844))
in (e, cres, guard)))
end
| false -> begin
(e, cres, guard)
...
| (env0, topt) -> begin
(let is_inner_let = (All.pipe_right lbs (Microsoft_FStar_Util.for_some (fun _38_9 -> (match (_38_9) with
| {Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inl (_38_2025); Microsoft_FStar_Absyn_Syntax.lbtyp = _38_2023; Microsoft_FStar_Absyn_Syntax.lbeff = _38_2021; Microsoft_FStar_Absyn_Syntax.lbdef = _38_2019} -> begin
true
end
| _38_2029 -> begin
false
end))))
in (let _38_2056 = (All.pipe_right lbs (Microsoft_FStar_List.fold_left (fun _38_2033 _38_2039 -> (match ((_38_2033, _38_2039)) with
...
| true -> begin
(let _38_2046 = (match ((All.pipe_left (Microsoft_FStar_Tc_Env.debug env) Microsoft_FStar_Options.High)) with
| true -> begin
(let _104_848 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Microsoft_FStar_Util.fprint1 "Type %s is marked as no-generalize\n" _104_848))
end
| false -> begin
()
end)
...
in (All.pipe_right _104_849 (norm_t env)))
end)
end)
...
| (lbs, env') -> begin
(let _38_2071 = (let _104_855 = (let _104_854 = (All.pipe_right lbs Microsoft_FStar_List.rev)
in (All.pipe_right _104_854 (Microsoft_FStar_List.map (fun _38_2060 -> (match (_38_2060) with
| (x, t, e) -> begin
...
in (Microsoft_FStar_Util.fprint3 "Checking %s = %s against type %s\n" _104_853 _104_852 _104_851))))
end
| false -> begin
()
end)
...
in (All.pipe_right _104_855 Microsoft_FStar_List.unzip))
in (match (_38_2071) with
| (lbs, gs) -> begin
(let g_lbs = (Microsoft_FStar_List.fold_right Microsoft_FStar_Tc_Rel.conj_guard gs Microsoft_FStar_Tc_Rel.trivial_guard)
in (let _38_2090 = (match (((not (env.Microsoft_FStar_Tc_Env.generalize)) || is_inner_let)) with
| true -> begin
(let _104_857 = (Microsoft_FStar_List.map (fun _38_2076 -> (match (_38_2076) with
| (x, t, e) -> begin
...
in (let ecs = (let _104_861 = (All.pipe_right lbs (Microsoft_FStar_List.map (fun _38_2082 -> (match (_38_2082) with
| (x, t, e) -> begin
(let _104_860 = (let _104_859 = (Microsoft_FStar_Absyn_Util.range_of_lb (x, t, e))
in (All.pipe_left (Microsoft_FStar_Absyn_Util.total_comp t) _104_859))
in (x, e, _104_860))
end))))
in (Microsoft_FStar_Tc_Util.generalize true env _104_861))
in (let _104_863 = (Microsoft_FStar_List.map (fun _38_2087 -> (match (_38_2087) with
| (x, e, c) -> begin
...
in (All.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp _104_864))
in (let _38_2092 = (Microsoft_FStar_Tc_Util.discharge_guard env g_lbs)
in (let _38_2094 = (ST.op_Colon_Equals e1.Microsoft_FStar_Absyn_Syntax.tk (Some (Microsoft_FStar_Tc_Recheck.t_unit)))
in (let _104_868 = (let _104_867 = (w cres)
in (All.pipe_left _104_867 (Microsoft_FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))))
in (_104_868, cres, Microsoft_FStar_Tc_Rel.trivial_guard)))))
end
| false -> begin
(let _38_2110 = (All.pipe_right lbs (Microsoft_FStar_List.fold_left (fun _38_2098 _38_2105 -> (match ((_38_2098, _38_2105)) with
...
in (All.pipe_left _104_873 (Microsoft_FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))))
in (match (topt) with
| Some (_38_2123) -> begin
(e, cres, guard)
end
| None -> begin
(let fvs = (All.pipe_left Microsoft_FStar_Absyn_Util.freevars_typ tres)
in (match ((All.pipe_right lbs (Microsoft_FStar_List.tryFind (fun _38_10 -> (match (_38_10) with
| {Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inr (_38_2135); Microsoft_FStar_Absyn_Syntax.lbtyp = _38_2133; Microsoft_FStar_Absyn_Syntax.lbeff = _38_2131; Microsoft_FStar_Absyn_Syntax.lbdef = _38_2129} -> begin
false
end
| {Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inl (x); Microsoft_FStar_Absyn_Syntax.lbtyp = _38_2143; Microsoft_FStar_Absyn_Syntax.lbeff = _38_2141; Microsoft_FStar_Absyn_Syntax.lbdef = _38_2139} -> begin
(Microsoft_FStar_Util.set_mem (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x Microsoft_FStar_Absyn_Syntax.tun) fvs.Microsoft_FStar_Absyn_Syntax.fxvs)
end))))) with
| Some ({Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inl (y); Microsoft_FStar_Absyn_Syntax.lbtyp = _38_2152; Microsoft_FStar_Absyn_Syntax.lbeff = _38_2150; Microsoft_FStar_Absyn_Syntax.lbdef = _38_2148}) -> begin
(let t' = (Microsoft_FStar_Tc_Util.new_tvar env0 Microsoft_FStar_Absyn_Syntax.ktype)
in (let _38_2158 = (let _104_875 = (Microsoft_FStar_Tc_Rel.teq env tres t')
in (All.pipe_left (Microsoft_FStar_Tc_Rel.try_discharge_guard env) _104_875))
in (e, cres, guard)))
end
| _38_2161 -> begin
(e, cres, guard)
...
(let pat_env = (Microsoft_FStar_List.fold_left Microsoft_FStar_Tc_Env.push_local_binding env bindings)
in (let _38_2185 = (match ((All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Pat")))) with
| true -> begin
(All.pipe_right bindings (Microsoft_FStar_List.iter (fun _38_11 -> (match (_38_11) with
...
in (Microsoft_FStar_Util.fprint2 "Before tc ... pattern var %s  : %s\n" _104_888 _104_887)))
end
| _38_2184 -> begin
()
end))))
...
in (let exps = (All.pipe_right exps (Microsoft_FStar_List.map (fun e -> (let _38_2196 = (match ((Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High)) with
| true -> begin
(let _104_891 = (Microsoft_FStar_Absyn_Print.exp_to_string e)
in (let _104_890 = (Microsoft_FStar_Absyn_Print.typ_to_string pat_t)
in (Microsoft_FStar_Util.fprint2 "Checking pattern expression %s against expected type %s\n" _104_891 _104_890)))
end
| false -> begin
()
end)
...
in (Microsoft_FStar_Util.fprint2 "Pre-checked pattern expression %s at type %s\n" _104_893 _104_892)))
end
| false -> begin
()
end)
...
in (All.pipe_left Prims.ignore _104_894))
...
in (All.pipe_left Prims.op_Negation _104_897))) with
| true -> begin
...
in (Microsoft_FStar_Util.format2 "Implicit pattern variables in %s could not be resolved against expected type %s; please bind them explicitly" _104_899 _104_898)))
...
in (Microsoft_FStar_Util.fprint1 "Done checking pattern expression %s\n" _104_903))
end
| false -> begin
()
end)
...
in (let _38_2222 = (match ((All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Pat")))) with
| true -> begin
(All.pipe_right bindings (Microsoft_FStar_List.iter (fun _38_12 -> (match (_38_12) with
| Microsoft_FStar_Tc_Env.Binding_var (x, t) -> begin
(let _104_906 = (Microsoft_FStar_Absyn_Print.strBvd x)
in (let _104_905 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Microsoft_FStar_Util.fprint2 "Pattern var %s  : %s\n" _104_906 _104_905)))
end
| _38_2221 -> begin
()
end))))
...
| true -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("When clauses are not yet supported in --verify mode; they soon will be", e.Microsoft_FStar_Absyn_Syntax.pos))))
end
| false -> begin
...
in (All.pipe_left (fun _104_908 -> Some (_104_908)) _104_909))
end)
...
in (All.pipe_right _104_910 Microsoft_FStar_Tc_Env.clear_expected_typ))
in (match (_38_2252) with
| (scrutinee_env, _38_2251) -> begin
(let c = (let eqs = (All.pipe_right disj_exps (Microsoft_FStar_List.fold_left (fun fopt e -> (let e = (Microsoft_FStar_Absyn_Util.compress_exp e)
in (match (e.Microsoft_FStar_Absyn_Syntax.n) with
...
in (All.pipe_left (fun _104_915 -> Some (_104_915)) _104_916))
end))
end))) None))
...
in (All.pipe_left (fun _104_917 -> Microsoft_FStar_Tc_Rel.NonTrivial (_104_917)) _104_918))
...
in (All.pipe_left _104_926 _104_925)))
in (let disc = (let _104_929 = (let _104_928 = (let _104_927 = (All.pipe_left Microsoft_FStar_Absyn_Syntax.varg scrutinee)
in (_104_927)::[])
in (disc, _104_928))
...
in (let sub_term_guards = (let _104_946 = (All.pipe_right args (Microsoft_FStar_List.mapi (fun i arg -> (match ((Prims.fst arg)) with
| Microsoft_FStar_Util.Inl (_38_2352) -> begin
[]
end
| Microsoft_FStar_Util.Inr (ei) -> begin
...
in (All.pipe_right _104_946 Microsoft_FStar_List.flatten))
in (Microsoft_FStar_Absyn_Util.mk_conj_l ((head)::sub_term_guards))))
end
| _38_2360 -> begin
(let _104_949 = (let _104_948 = (Microsoft_FStar_Range.string_of_range pat_exp.Microsoft_FStar_Absyn_Syntax.pos)
in (let _104_947 = (Microsoft_FStar_Absyn_Print.exp_to_string pat_exp)
in (Microsoft_FStar_Util.format2 "tc_eqn: Impossible (%s) %s" _104_948 _104_947)))
in (All.failwith _104_949))
end)))
...
in (let path_guard = (let _104_958 = (All.pipe_right disj_exps (Microsoft_FStar_List.map (fun e -> (let _104_957 = (Microsoft_FStar_Tc_Normalize.norm_exp ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env e)
in (mk_guard scrutinee pat_t _104_957)))))
in (All.pipe_right _104_958 Microsoft_FStar_Absyn_Util.mk_disj_l))
...
in (All.pipe_left (Microsoft_FStar_Util.fprint1 "Carrying guard from match: %s\n") _104_960))
end
| false -> begin
()
end)
...
in (All.pipe_right _104_972 (norm_c env)))
...
in (All.pipe_right _104_981 (norm_c env)))
...
| Microsoft_FStar_Absyn_Syntax.Kind_arrow ((Microsoft_FStar_Util.Inl (a), _38_2454)::(Microsoft_FStar_Util.Inl (wp), _38_2449)::(Microsoft_FStar_Util.Inl (_38_2441), _38_2444)::[], _38_2458) -> begin
...
in (let kwp_b = (Microsoft_FStar_Absyn_Util.subst_kind ((Microsoft_FStar_Util.Inl ((a.Microsoft_FStar_Absyn_Syntax.v, b_typ)))::[]) kwp_a)
in (let kwlp_a = kwp_a
in (let kwlp_b = kwp_b
...
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Failed to process pragma: use \'fstar --help\' to see which options are available", r))))
end
| Microsoft_FStar_Getopt.Die (s) -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (((Prims.strcat "Failed to process pragma: " s), r))))
end)
end
...
in (All.pipe_right _104_1166 Prims.ignore))
in (se, env)))
end)
end
...
in Microsoft_FStar_Util.Inl (_104_1170))
in (_104_1171)::[])
...
in (Microsoft_FStar_Util.fprint2 "Checked %s at kind %s\n" _104_1181 _104_1180)))
end
| false -> begin
()
end)
...
in (All.pipe_left (Microsoft_FStar_Tc_Util.force_trivial env) _104_1182))
end
| _38_2590 -> begin
()
end)
...
| (c, g) -> begin
(let tags = (All.pipe_right tags (Microsoft_FStar_List.map (fun _38_13 -> (match (_38_13) with
| Microsoft_FStar_Absyn_Syntax.DefaultEffect (None) -> begin
(let c' = (Microsoft_FStar_Tc_Normalize.weak_norm_comp env c)
in (let _104_1185 = (All.pipe_right c'.Microsoft_FStar_Absyn_Syntax.effect_name (fun _104_1184 -> Some (_104_1184)))
...
in (All.pipe_right _104_1189 (fun _38_2645 -> (match (_38_2645) with
| (t, k) -> begin
...
in (All.pipe_right _104_1190 (norm_k env)))
in (let _38_2653 = (let _104_1191 = (Microsoft_FStar_Tc_Rel.keq env' (Some (t)) k1 k2)
in (All.pipe_left (Microsoft_FStar_Tc_Util.force_trivial env') _104_1191))
in k2))
end)
...
| Microsoft_FStar_Util.Inl (_38_2687) -> begin
()
end
| Microsoft_FStar_Util.Inr (x) -> begin
...
in (All.pipe_right _104_1194 Microsoft_FStar_Util.must))
in (match (_38_2695) with
| (formals, _38_2694) -> begin
(All.pipe_right formals (Microsoft_FStar_List.iter (fun _38_2699 -> (match (_38_2699) with
| (a, _38_2698) -> begin
(match (a) with
| Microsoft_FStar_Util.Inl (_38_2701) -> begin
()
end
| Microsoft_FStar_Util.Inr (y) -> begin
...
(match ((Microsoft_FStar_List.tryFind (Microsoft_FStar_Absyn_Syntax.lid_equals f.Microsoft_FStar_Absyn_Syntax.v) mutuals)) with
| None -> begin
()
end
| Some (tname) -> begin
...
in (let _38_2715 = (All.pipe_right formals (Microsoft_FStar_List.iter positivity_check))
...
in (Microsoft_FStar_Util.format2 "data %s : %s\n" lid.Microsoft_FStar_Absyn_Syntax.str _104_1212))
in (All.pipe_left Microsoft_FStar_Util.print_string _104_1213))
end
| false -> begin
()
end)
...
in (All.pipe_right _104_1214 (Microsoft_FStar_Tc_Normalize.norm_typ ((Microsoft_FStar_Tc_Normalize.Beta)::(Microsoft_FStar_Tc_Normalize.SNComp)::[]) env)))
...
in (Microsoft_FStar_Util.format2 "val %s : %s\n" lid.Microsoft_FStar_Absyn_Syntax.str _104_1215))
in (All.pipe_left Microsoft_FStar_Util.print_string _104_1216))
end
| false -> begin
()
end)
...
in (All.pipe_right _104_1217 (norm_t env)))
...
(let env = (Microsoft_FStar_Tc_Env.set_range env r)
in (let _38_2803 = (All.pipe_right (Prims.snd lbs) (Microsoft_FStar_List.fold_left (fun _38_2763 lb -> (match (_38_2763) with
| (gen, lbs) -> begin
(let _38_2800 = (match (lb) with
| {Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inl (_38_2772); Microsoft_FStar_Absyn_Syntax.lbtyp = _38_2770; Microsoft_FStar_Absyn_Syntax.lbeff = _38_2768; Microsoft_FStar_Absyn_Syntax.lbdef = _38_2766} -> begin
(All.failwith "impossible")
end
| {Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inr (l); Microsoft_FStar_Absyn_Syntax.lbtyp = t; Microsoft_FStar_Absyn_Syntax.lbeff = _38_2777; Microsoft_FStar_Absyn_Syntax.lbdef = e} -> begin
...
in (Microsoft_FStar_Util.fprint2 "Using annotation %s for let binding %s\n" _104_1220 l.Microsoft_FStar_Absyn_Syntax.str))
end
| false -> begin
()
end)
in (match (t.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_unknown -> begin
(let _104_1221 = (Microsoft_FStar_Absyn_Syntax.mk_lb (Microsoft_FStar_Util.Inr (l), Microsoft_FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _104_1221))
end
| _38_2792 -> begin
(let _38_2793 = (match ((not (deserialized))) with
| true -> begin
(let _104_1223 = (let _104_1222 = (Microsoft_FStar_Range.string_of_range r)
in (Microsoft_FStar_Util.format1 "%s: Warning: Annotation from val declaration overrides inline type annotation\n" _104_1222))
in (All.pipe_left Microsoft_FStar_Util.print_string _104_1223))
end
| false -> begin
()
end)
in (let _104_1224 = (Microsoft_FStar_Absyn_Syntax.mk_lb (Microsoft_FStar_Util.Inr (l), Microsoft_FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _104_1224)))
end))
end)
...
in (All.pipe_left _104_1227 (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant Microsoft_FStar_Absyn_Syntax.Const_unit)))
...
| true -> begin
(let _104_1235 = (let _104_1234 = (All.pipe_right (Prims.snd lbs) (Microsoft_FStar_List.map (fun lb -> (let should_log = (match ((let _104_1231 = (Microsoft_FStar_Util.right lb.Microsoft_FStar_Absyn_Syntax.lbname)
...
in (Microsoft_FStar_Util.format2 "let %s : %s" _104_1233 _104_1232)))
end
| false -> begin
""
end)))))
in (All.pipe_right _104_1234 (Microsoft_FStar_String.concat "\n")))
in (Microsoft_FStar_Util.fprint1 "%s\n" _104_1235))
end
| false -> begin
()
end)
...
(let env = (Microsoft_FStar_Tc_Env.set_range env r)
in (let _38_2882 = (All.pipe_right ses (Microsoft_FStar_List.partition (fun _38_14 -> (match (_38_14) with
...
| (tycons, rest) -> begin
(let _38_2891 = (All.pipe_right rest (Microsoft_FStar_List.partition (fun _38_15 -> (match (_38_15) with
...
| (abbrevs, rest) -> begin
(let recs = (All.pipe_right abbrevs (Microsoft_FStar_List.map (fun _38_16 -> (match (_38_16) with
| Microsoft_FStar_Absyn_Syntax.Sig_typ_abbrev (lid, tps, k, t, [], r) -> begin
(let k = (match (k.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Kind_unknown -> begin
(let _104_1244 = (Microsoft_FStar_Tc_Rel.new_kvar r tps)
in (All.pipe_right _104_1244 Prims.fst))
end
| _38_2903 -> begin
k
end)
...
in (let _38_2910 = (Microsoft_FStar_List.split recs)
in (match (_38_2910) with
| (recs, abbrev_defs) -> begin
(let msg = (match ((ST.read Microsoft_FStar_Options.logQueries)) with
| true -> begin
(let _104_1245 = (Microsoft_FStar_Absyn_Print.sigelt_to_string_short se)
in (Microsoft_FStar_Util.format1 "Recursive bindings: %s" _104_1245))
end
| false -> begin
""
end)
...
(let env1 = (Microsoft_FStar_Tc_Env.push_sigelt env (Microsoft_FStar_Absyn_Syntax.Sig_bundle (((Microsoft_FStar_List.append tycons recs), quals, lids, r))))
in (let _38_2932 = (tc_decls false env1 rest deserialized)
in (match (_38_2932) with
| (rest, _38_2929, _38_2931) -> begin
(let abbrevs = (Microsoft_FStar_List.map2 (fun se t -> (match (se) with
...
| _38_2959 -> begin
(let _104_1252 = (let _104_1251 = (Microsoft_FStar_Range.string_of_range r)
in (Microsoft_FStar_Util.format1 "(%s) Impossible" _104_1251))
in (All.failwith _104_1252))
end)) recs abbrev_defs)
in (let _38_2961 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.pop msg)
in (let se = Microsoft_FStar_Absyn_Syntax.Sig_bundle (((Microsoft_FStar_List.append (Microsoft_FStar_List.append tycons abbrevs) rest), quals, lids, r))
in (let env = (Microsoft_FStar_Tc_Env.push_sigelt env se)
in (se, env)))))
end)))
end))
...
and tc_decls = (fun for_export env ses deserialized -> (let _38_2985 = (All.pipe_right ses (Microsoft_FStar_List.fold_left (fun _38_2972 se -> (match (_38_2972) with
...
in (Microsoft_FStar_Util.format1 "Checking sigelt\t%s\n" _104_1259))
in (Microsoft_FStar_Util.print_string _104_1260))
end
| false -> begin
()
end)
...
| (ses, all_non_private, env) -> begin
(let _104_1261 = (All.pipe_right (Microsoft_FStar_List.rev all_non_private) Microsoft_FStar_List.flatten)
in ((Microsoft_FStar_List.rev ses), _104_1261, env))
end)))
and non_private = (fun env se -> (let is_private = (fun quals -> (Microsoft_FStar_List.contains Microsoft_FStar_Absyn_Syntax.Private quals))
in (match (se) with
...
| {Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inr (l); Microsoft_FStar_Absyn_Syntax.lbtyp = _38_3074; Microsoft_FStar_Absyn_Syntax.lbeff = _38_3072; Microsoft_FStar_Absyn_Syntax.lbdef = _38_3070} -> begin
(match ((Microsoft_FStar_Tc_Env.try_lookup_val_decl env l)) with
| Some (_38_3079, qs) -> begin
(Microsoft_FStar_List.contains Microsoft_FStar_Absyn_Syntax.Private qs)
end
| _38_3084 -> begin
false
end)
...
in (let some_priv = (All.pipe_right lbs (Microsoft_FStar_Util.for_some is_priv))
in (match (some_priv) with
| true -> begin
(match ((All.pipe_right lbs (Microsoft_FStar_Util.for_some (fun x -> (let _104_1271 = (is_priv x)
in (All.pipe_right _104_1271 Prims.op_Negation)))))) with
| true -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Some but not all functions in this mutually recursive nest are marked private", r))))
end
| false -> begin
true
end)
...
in (let _38_3093 = (All.pipe_right (Prims.snd lbs) (Microsoft_FStar_List.partition (fun lb -> ((Microsoft_FStar_Absyn_Util.is_pure_or_ghost_function lb.Microsoft_FStar_Absyn_Syntax.lbtyp) && (let _104_1273 = (Microsoft_FStar_Absyn_Util.is_lemma lb.Microsoft_FStar_Absyn_Syntax.lbtyp)
in (All.pipe_left Prims.op_Negation _104_1273))))))
in (match (_38_3093) with
| (pure_funs, rest) -> begin
(match ((pure_funs, rest)) with
| (_38_3097::_38_3095, _38_3102::_38_3100) -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Pure functions cannot be mutually recursive with impure functions", r))))
end
...
| false -> begin
(All.pipe_right rest (Microsoft_FStar_List.collect (fun lb -> (match (lb.Microsoft_FStar_Absyn_Syntax.lbname) with
| Microsoft_FStar_Util.Inl (_38_3121) -> begin
(All.failwith "impossible")
end
...
let get_exports = (fun env modul non_private_decls -> (let assume_vals = (fun decls -> (All.pipe_right decls (Microsoft_FStar_List.map (fun _38_18 -> (match (_38_18) with
| Microsoft_FStar_Absyn_Syntax.Sig_val_decl (lid, t, quals, r) -> begin
...
in (Microsoft_FStar_Util.find_map _104_1289 (fun m -> (match ((m.Microsoft_FStar_Absyn_Syntax.is_interface && (Microsoft_FStar_Absyn_Syntax.lid_equals modul.Microsoft_FStar_Absyn_Syntax.name m.Microsoft_FStar_Absyn_Syntax.name))) with
| true -> begin
(let _104_1288 = (All.pipe_right m.Microsoft_FStar_Absyn_Syntax.exports assume_vals)
in Some (_104_1288))
end
| false -> begin
None
...
let tc_partial_modul = (fun env modul -> (let name = (Microsoft_FStar_Util.format2 "%s %s" (match (modul.Microsoft_FStar_Absyn_Syntax.is_interface) with
| true -> begin
"interface"
end
| false -> begin
...
| true -> begin
(let _38_3180 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.pop (Prims.strcat "Ending modul " modul.Microsoft_FStar_Absyn_Syntax.name.Microsoft_FStar_Absyn_Syntax.str))
in (let _38_3182 = (match (((not (modul.Microsoft_FStar_Absyn_Syntax.is_interface)) || (let _104_1307 = (ST.read Microsoft_FStar_Options.admit_fsi)
in (Microsoft_FStar_List.contains modul.Microsoft_FStar_Absyn_Syntax.name.Microsoft_FStar_Absyn_Syntax.str _104_1307)))) with
| true -> begin
...
in (All.pipe_right _104_1308 Prims.ignore)))))
end
| false -> begin
()
end)
...
in (let _104_1321 = (Microsoft_FStar_List.fold_left do_sigelt en m.Microsoft_FStar_Absyn_Syntax.exports)
in (Microsoft_FStar_Tc_Env.finish_module _104_1321 m)))))

let check_module = (fun env m -> (let _38_3205 = (match (((let _104_1326 = (ST.read Microsoft_FStar_Options.debug)
in (Microsoft_FStar_List.length _104_1326)) <> 0)) with
| true -> begin
(let _104_1327 = (Microsoft_FStar_Absyn_Print.sli m.Microsoft_FStar_Absyn_Syntax.name)
in (Microsoft_FStar_Util.fprint2 "Checking %s: %s\n" (match (m.Microsoft_FStar_Absyn_Syntax.is_interface) with
| true -> begin
"i\'face"
end
| false -> begin
...
| (m, env) -> begin
(let _38_3214 = (match ((ST.read Microsoft_FStar_Options.serialize_mods)) with
| true -> begin
...
in (Prims.strcat _104_1329 Microsoft_FStar_Options.cache_dir))
...
in (Microsoft_FStar_Util.print_string _104_1336))
in (let _104_1337 = (Microsoft_FStar_Util.get_owriter c_file_name)
