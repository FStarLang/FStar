...
let syn' = (fun ( env ) ( k ) -> (let _68_15956 = (Microsoft_FStar_Tc_Env.get_range env)
in (Microsoft_FStar_Absyn_Syntax.syn _68_15956 (Some (k)))))

let log = (fun ( env ) -> ((Support.ST.read Microsoft_FStar_Options.log_types) && (not ((let _68_15959 = (Microsoft_FStar_Tc_Env.current_module env)
in (Microsoft_FStar_Absyn_Syntax.lid_equals Microsoft_FStar_Absyn_Const.prims_lid _68_15959))))))
...
in (let _68_15979 = (let _68_15978 = (let _68_15977 = (let _68_15972 = (let _68_15971 = (Microsoft_FStar_Tc_Recheck.recompute_typ v)
in (Support.Prims.pipe_left (fun ( _68_15970 ) -> Support.Microsoft.FStar.Util.Inl (_68_15970)) _68_15971))
in (_68_15972, Some (Microsoft_FStar_Absyn_Syntax.Implicit)))
in (let _68_15976 = (let _68_15975 = (Microsoft_FStar_Absyn_Syntax.varg v)
in (let _68_15974 = (let _68_15973 = (Microsoft_FStar_Absyn_Syntax.varg tl)
in (_68_15973)::[])
in (_68_15975)::_68_15974))
in (_68_15977)::_68_15976))
in (Microsoft_FStar_Absyn_Util.lex_pair, _68_15978))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _68_15979 (Some (Microsoft_FStar_Absyn_Util.lex_t)) r)))) vs Microsoft_FStar_Absyn_Util.lex_top))
...
let norm_t = (fun ( env ) ( t ) -> (let _68_15992 = (steps env)
in (Microsoft_FStar_Tc_Normalize.norm_typ _68_15992 env t)))

let norm_k = (fun ( env ) ( k ) -> (let _68_15997 = (steps env)
in (Microsoft_FStar_Tc_Normalize.norm_kind _68_15997 env k)))

let norm_c = (fun ( env ) ( c ) -> (let _68_16002 = (steps env)
in (Microsoft_FStar_Tc_Normalize.norm_comp _68_16002 env c)))
...
in (Microsoft_FStar_Absyn_Util.freevars_kind _68_16021))
end
| Support.Microsoft.FStar.Util.Inr (t) -> begin
(let _68_16022 = (match (norm) with
| true -> begin
(norm_t env t)
end
| false -> begin
...
in (Microsoft_FStar_Absyn_Util.freevars_typ _68_16022))
end)
...
| () -> begin
(let escaping = (let _68_16027 = (let _68_16026 = (Support.Microsoft.FStar.Util.set_elements a)
in (Support.Prims.pipe_right _68_16026 (Support.List.map (fun ( x ) -> (Microsoft_FStar_Absyn_Print.strBvd x.Microsoft_FStar_Absyn_Syntax.v)))))
in (Support.Prims.pipe_right _68_16027 (Support.String.concat ", ")))
in (let msg = (match (((Support.Microsoft.FStar.Util.set_count a) > 1)) with
| true -> begin
(let _68_16028 = (Microsoft_FStar_Tc_Normalize.exp_norm_to_string env head)
in (Support.Microsoft.FStar.Util.format2 "Bound variables \'{%s}\' in the type of \'%s\' escape because of impure applications; add explicit let-bindings" escaping _68_16028))
end
| false -> begin
(let _68_16029 = (Microsoft_FStar_Tc_Normalize.exp_norm_to_string env head)
in (Support.Microsoft.FStar.Util.format2 "Bound variable \'%s\' in the type of \'%s\' escapes because of impure applications; add explicit let-bindings" escaping _68_16029))
end)
in (let _68_16032 = (let _68_16031 = (let _68_16030 = (Microsoft_FStar_Tc_Env.get_range env)
in (msg, _68_16030))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16031))
in (raise (_68_16032)))))
end))
in (match (kt) with
| Support.Microsoft.FStar.Util.Inl (k) -> begin
...
| false -> begin
(let _68_16043 = (let _68_16042 = (let _68_16041 = (Microsoft_FStar_Absyn_Util.btvar_to_typ b)
in (a.Microsoft_FStar_Absyn_Syntax.v, _68_16041))
in Support.Microsoft.FStar.Util.Inl (_68_16042))
in (_68_16043)::s)
end)
end
...
| false -> begin
(let _68_16046 = (let _68_16045 = (let _68_16044 = (Microsoft_FStar_Absyn_Util.bvar_to_exp y)
in (x.Microsoft_FStar_Absyn_Syntax.v, _68_16044))
in Support.Microsoft.FStar.Util.Inr (_68_16045))
in (_68_16046)::s)
end)
end
| _ -> begin
...
| () -> begin
(let _68_16055 = (lc.Microsoft_FStar_Absyn_Syntax.comp ())
in (Microsoft_FStar_Absyn_Util.set_result_typ _68_16055 t))
end))}))

let value_check_expected_typ = (fun ( env ) ( e ) ( tlc ) -> (let lc = (match (tlc) with
| Support.Microsoft.FStar.Util.Inl (t) -> begin
(let _68_16062 = (match ((not ((Microsoft_FStar_Absyn_Util.is_pure_or_ghost_function t)))) with
| true -> begin
...
in (Microsoft_FStar_Tc_Util.lcomp_of_comp _68_16062))
end
...
| true -> begin
(let _68_16064 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (let _68_16063 = (Microsoft_FStar_Absyn_Print.typ_to_string t')
...
| (e, g) -> begin
(let _36_154 = (let _68_16070 = (Support.Prims.pipe_left (fun ( _68_16069 ) -> Some (_68_16069)) (Microsoft_FStar_Tc_Errors.subtyping_failed env t t'))
in (Microsoft_FStar_Tc_Util.strengthen_precondition _68_16070 env e lc g))
...
| true -> begin
(let _68_16071 = (Microsoft_FStar_Absyn_Print.lcomp_typ_to_string lc)
...
| None -> begin
(let _68_16084 = (norm_c env c)
in (e, _68_16084, Microsoft_FStar_Tc_Rel.trivial_guard))
end
| Some (expected_c) -> begin
(let _36_187 = (match ((Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low)) with
| true -> begin
(let _68_16087 = (Support.Microsoft.FStar.Range.string_of_range e.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16086 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string c)
in (let _68_16085 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string expected_c)
in (Support.Microsoft.FStar.Util.fprint3 "(%s) About to check\n\t%s\nagainst expected effect\n\t%s\n" _68_16087 _68_16086 _68_16085))))
end
| false -> begin
()
end)
in (let c = (norm_c env c)
in (let expected_c' = (let _68_16088 = (Support.Prims.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp expected_c)
in (Microsoft_FStar_Tc_Util.refresh_comp_label env true _68_16088))
in (let _36_195 = (let _68_16089 = (expected_c'.Microsoft_FStar_Absyn_Syntax.comp ())
in (Support.Prims.pipe_left (Microsoft_FStar_Tc_Util.check_comp env e c) _68_16089))
in (match (_36_195) with
| (e, _, g) -> begin
(let _36_196 = (match ((Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low)) with
| true -> begin
(let _68_16091 = (Support.Microsoft.FStar.Range.string_of_range e.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16090 = (Microsoft_FStar_Tc_Rel.guard_to_string env g)
...
(let _68_16097 = (let _68_16096 = (let _68_16095 = (Microsoft_FStar_Tc_Errors.unexpected_non_trivial_precondition_on_term env f)
in (let _68_16094 = (Microsoft_FStar_Tc_Env.get_range env)
in (_68_16095, _68_16094)))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16096))
in (raise (_68_16097)))
end)
end))
...
| Some (t) -> begin
(let _68_16104 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.fprint1 "Expected type is %s" _68_16104))
end))
...
| true -> begin
(let _68_16155 = (Support.Microsoft.FStar.Range.string_of_range k.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16154 = (Microsoft_FStar_Absyn_Print.kind_to_string k)
in (Support.Microsoft.FStar.Util.fprint2 "(%s) - Checking kind %s" _68_16155 _68_16154)))
end
| false -> begin
()
end)
...
| (args, g) -> begin
(let _68_16157 = (Support.Prims.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_uvar (u, args)))
in (_68_16157, g))
end))
end)))
end
...
| true -> begin
(let _68_16161 = (let _68_16160 = (let _68_16159 = (let _68_16158 = (Microsoft_FStar_Absyn_Print.sli l)
in (Support.String.strcat "Unexpected number of arguments to kind abbreviation " _68_16158))
in (_68_16159, k.Microsoft_FStar_Absyn_Syntax.pos))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16160))
in (raise (_68_16161)))
end
| false -> begin
...
| (Support.Microsoft.FStar.Util.Inl (a), Support.Microsoft.FStar.Util.Inl (t)) -> begin
(let _36_289 = (let _68_16165 = (Microsoft_FStar_Absyn_Util.subst_kind subst a.Microsoft_FStar_Absyn_Syntax.sort)
in (tc_typ_check env t _68_16165))
in (match (_36_289) with
| (t, g) -> begin
(let subst = (Support.Microsoft.FStar.Util.Inl ((a.Microsoft_FStar_Absyn_Syntax.v, t)))::subst
in (let _68_16167 = (let _68_16166 = (Microsoft_FStar_Absyn_Syntax.targ t)
in (_68_16166)::args)
in (subst, _68_16167, (g)::guards)))
end))
end
| (Support.Microsoft.FStar.Util.Inr (x), Support.Microsoft.FStar.Util.Inr (e)) -> begin
(let env = (let _68_16168 = (Microsoft_FStar_Absyn_Util.subst_typ subst x.Microsoft_FStar_Absyn_Syntax.sort)
in (Microsoft_FStar_Tc_Env.set_expected_typ env _68_16168))
...
in (let _68_16170 = (let _68_16169 = (Microsoft_FStar_Absyn_Syntax.varg e)
in (_68_16169)::args)
...
in (let _68_16173 = (Support.List.fold_left Microsoft_FStar_Tc_Rel.conj_guard g guards)
in (k', _68_16173))))))
end))
end)
end))
...
in (let _68_16175 = (Microsoft_FStar_Tc_Rel.conj_guard f g)
in (kk, _68_16175))))
end))
end))
end
...
in (let _68_16178 = (Support.Prims.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (bs, k)))
in (let _68_16177 = (Microsoft_FStar_Tc_Rel.conj_guard g f)
in (_68_16178, _68_16177))))
end))
end))
end
| Microsoft_FStar_Absyn_Syntax.Kind_unknown -> begin
(let _68_16179 = (Microsoft_FStar_Tc_Util.new_kvar env)
in (_68_16179, Microsoft_FStar_Tc_Rel.trivial_guard))
end))))
...
in (let env' = (let _68_16182 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (maybe_push_binding env _68_16182))
in (x, env', g)))
end)))
...
| (bs, env', g') -> begin
(let _68_16190 = (let _68_16189 = (Microsoft_FStar_Tc_Rel.close_guard ((b)::[]) g')
in (Microsoft_FStar_Tc_Rel.conj_guard g _68_16189))
in ((b)::bs, env', _68_16190))
end))))
end))
end
| Support.Microsoft.FStar.Util.Inr (x) -> begin
...
| (bs, env', g') -> begin
(let _68_16192 = (let _68_16191 = (Microsoft_FStar_Tc_Rel.close_guard ((b)::[]) g')
in (Microsoft_FStar_Tc_Rel.conj_guard g _68_16191))
in ((b)::bs, env', _68_16192))
end)))
end))
end)
end))
...
| (t, _, g') -> begin
(let _68_16197 = (Microsoft_FStar_Tc_Rel.conj_guard g g')
in (((Support.Microsoft.FStar.Util.Inl (t), imp))::args, _68_16197))
end))
end
...
| (e, _, g') -> begin
(let _68_16198 = (Microsoft_FStar_Tc_Rel.conj_guard g g')
in (((Support.Microsoft.FStar.Util.Inr (e), imp))::args, _68_16198))
end))
end)
...
| (t, g) -> begin
(let _68_16201 = (Microsoft_FStar_Absyn_Syntax.mk_Total t)
in (_68_16201, g))
end))
end
...
in (let tc = (let _68_16204 = (let _68_16203 = (let _68_16202 = (Microsoft_FStar_Absyn_Syntax.targ c.Microsoft_FStar_Absyn_Syntax.result_typ)
in (_68_16202)::c.Microsoft_FStar_Absyn_Syntax.effect_args)
in (head, _68_16203))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _68_16204 None c.Microsoft_FStar_Absyn_Syntax.result_typ.Microsoft_FStar_Absyn_Syntax.pos))
...
| (res, args) -> begin
(let _36_450 = (let _68_16206 = (Support.Prims.pipe_right c.Microsoft_FStar_Absyn_Syntax.flags (Support.List.map (fun ( _36_3 ) -> (match (_36_3) with
...
in (Support.Prims.pipe_right _68_16206 Support.List.unzip))
in (match (_36_450) with
| (flags, guards) -> begin
(let _68_16208 = (Microsoft_FStar_Absyn_Syntax.mk_Comp (let _36_451 = c
...
in (let _68_16207 = (Support.List.fold_left Microsoft_FStar_Tc_Rel.conj_guard f guards)
in (_68_16208, _68_16207)))
end))
end))
end))
end)))))
...
in (let _68_16231 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_const i (Some (qk)) t.Microsoft_FStar_Absyn_Syntax.pos)
in (_68_16231, qk, Microsoft_FStar_Tc_Rel.trivial_guard)))))
end
...
in (let _68_16232 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_const i (Some (qk)) t.Microsoft_FStar_Absyn_Syntax.pos)
in (_68_16232, qk, Microsoft_FStar_Tc_Rel.trivial_guard)))))
end
...
| Some (b) -> begin
(let _68_16237 = (let _68_16236 = (Microsoft_FStar_Absyn_Print.binder_to_string b)
in (Support.Microsoft.FStar.Util.format1 "Pattern misses at least one bound variables: %s" _68_16236))
in (Microsoft_FStar_Tc_Errors.warn t.Microsoft_FStar_Absyn_Syntax.pos _68_16237))
end))
end
| _ -> begin
()
...
in (let _68_16239 = (let _68_16238 = (Microsoft_FStar_Tc_Rel.close_guard bs f)
in (Microsoft_FStar_Tc_Rel.conj_guard g _68_16238))
in (t, Microsoft_FStar_Absyn_Syntax.ktype, _68_16239))))
end))
end))
end
...
in (let _68_16244 = (Support.Prims.pipe_left (w k) (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam (bs, t)))
in (let _68_16243 = (let _68_16242 = (Microsoft_FStar_Tc_Rel.close_guard bs f)
in (Support.Prims.pipe_left (Microsoft_FStar_Tc_Rel.conj_guard g) _68_16242))
in (_68_16244, k, _68_16243))))
end))
end))
end
...
| true -> begin
(let _68_16247 = (Support.Microsoft.FStar.Range.string_of_range top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16246 = (Microsoft_FStar_Absyn_Print.typ_to_string phi)
in (let _68_16245 = (match ((Microsoft_FStar_Tc_Env.expected_typ env)) with
| None -> begin
"None"
end
| Some (t) -> begin
...
| (phi, f2) -> begin
(let _68_16254 = (Support.Prims.pipe_left (w Microsoft_FStar_Absyn_Syntax.ktype) (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine (x, phi)))
in (let _68_16253 = (let _68_16252 = (let _68_16251 = (let _68_16250 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (_68_16250)::[])
in (Microsoft_FStar_Tc_Rel.close_guard _68_16251 f2))
in (Microsoft_FStar_Tc_Rel.conj_guard f1 _68_16252))
in (_68_16254, Microsoft_FStar_Absyn_Syntax.ktype, _68_16253)))
end)))
end))
end
...
| true -> begin
(let _68_16257 = (Support.Microsoft.FStar.Range.string_of_range top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16256 = (Support.Prims.pipe_left Support.Microsoft.FStar.Util.string_of_int (Support.List.length args))
in (let _68_16255 = (Microsoft_FStar_Absyn_Print.typ_to_string top)
in (Support.Microsoft.FStar.Util.fprint3 "(%s) Checking type application (%s): %s\n" _68_16257 _68_16256 _68_16255))))
end
| false -> begin
()
end)
...
| true -> begin
(let _68_16261 = (Support.Microsoft.FStar.Range.string_of_range head.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16260 = (Microsoft_FStar_Absyn_Print.typ_to_string head)
in (let _68_16259 = (Microsoft_FStar_Absyn_Print.kind_to_string k1')
in (let _68_16258 = (Microsoft_FStar_Absyn_Print.kind_to_string k1)
in (Support.Microsoft.FStar.Util.fprint4 "(%s) head %s has kind %s ... after norm %s\n" _68_16261 _68_16260 _68_16259 _68_16258)))))
end
| false -> begin
()
end)
...
in (let kres = (let _68_16264 = (Microsoft_FStar_Tc_Rel.new_kvar k1.Microsoft_FStar_Absyn_Syntax.pos binders)
in (Support.Prims.pipe_right _68_16264 Support.Prims.fst))
in (let bs = (let _68_16265 = (Microsoft_FStar_Tc_Util.tks_of_args args)
in (Microsoft_FStar_Absyn_Util.null_binders_of_tks _68_16265))
in (let kar = (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (bs, kres) k1.Microsoft_FStar_Absyn_Syntax.pos)
in (let _36_608 = (let _68_16266 = (Microsoft_FStar_Tc_Rel.keq env None k1 kar)
in (Support.Prims.pipe_left (Microsoft_FStar_Tc_Util.force_trivial env) _68_16266))
in (kres, args, g)))))))
end))
end
...
| ([], []) -> begin
(let _68_16277 = (Microsoft_FStar_Absyn_Util.subst_kind subst kres)
in (_68_16277, (Support.List.rev outargs), g))
end
...
(let _68_16281 = (let _68_16280 = (let _68_16279 = (let _68_16278 = (Support.List.hd args)
in (Microsoft_FStar_Absyn_Util.range_of_arg _68_16278))
in ("Argument is marked as instantiating an implicit parameter; although the expected parameter is explicit", _68_16279))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16280))
in (raise (_68_16281)))
end
...
in (let _36_681 = (let _68_16282 = (Microsoft_FStar_Absyn_Util.subst_kind subst a.Microsoft_FStar_Absyn_Syntax.sort)
in (Microsoft_FStar_Tc_Util.new_implicit_tvar env _68_16282))
...
(let formal = (Support.List.hd formals)
in (let _36_710 = (let _68_16283 = (Microsoft_FStar_Absyn_Util.subst_typ subst x.Microsoft_FStar_Absyn_Syntax.sort)
in (Microsoft_FStar_Tc_Util.new_implicit_evar env _68_16283))
...
| true -> begin
(let _68_16285 = (Microsoft_FStar_Absyn_Print.arg_to_string actual)
in (let _68_16284 = (Microsoft_FStar_Absyn_Print.kind_to_string formal_k)
...
| true -> begin
(let _68_16286 = (Microsoft_FStar_Tc_Rel.guard_to_string env g')
...
in (let g' = (let _68_16288 = (let _68_16287 = (Microsoft_FStar_Tc_Util.short_circuit_typ (Support.Microsoft.FStar.Util.Inl (head)) outargs)
in (Support.Prims.pipe_left Microsoft_FStar_Tc_Rel.guard_of_guard_formula _68_16287))
in (Microsoft_FStar_Tc_Rel.imp_guard _68_16288 g'))
in (let subst = (maybe_extend_subst subst formal actual)
in (let _68_16289 = (Microsoft_FStar_Tc_Rel.conj_guard g g')
in (check_args ((actual)::outargs) subst _68_16289 formals actuals))))))
end))))
end
...
| true -> begin
(let _68_16291 = (Microsoft_FStar_Absyn_Print.arg_to_string actual)
in (let _68_16290 = (Microsoft_FStar_Absyn_Print.typ_to_string tx)
...
in (let g' = (let _68_16293 = (let _68_16292 = (Microsoft_FStar_Tc_Util.short_circuit_typ (Support.Microsoft.FStar.Util.Inl (head)) outargs)
in (Support.Prims.pipe_left Microsoft_FStar_Tc_Rel.guard_of_guard_formula _68_16292))
in (Microsoft_FStar_Tc_Rel.imp_guard _68_16293 g'))
in (let subst = (maybe_extend_subst subst formal actual)
in (let _68_16294 = (Microsoft_FStar_Tc_Rel.conj_guard g g')
in (check_args ((actual)::outargs) subst _68_16294 formals actuals)))))
end))))))
end
...
in (let _68_16296 = (let _68_16295 = (Microsoft_FStar_Absyn_Syntax.targ tv)
in (_68_16295)::actuals)
in (check_args outargs subst g ((formal)::formals) _68_16296)))
end
| _ -> begin
...
| (_, []) -> begin
(let _68_16298 = (let _68_16297 = (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (formals, kres) kres.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Absyn_Util.subst_kind subst _68_16297))
in (_68_16298, (Support.List.rev outargs), g))
end
| ([], _) -> begin
(let _68_16306 = (let _68_16305 = (let _68_16304 = (let _68_16303 = (let _68_16301 = (let _68_16300 = (Support.Prims.pipe_right outargs (Support.List.filter (fun ( _36_4 ) -> (match (_36_4) with
...
in (Support.List.length _68_16300))
in (Support.Prims.pipe_right _68_16301 Support.Microsoft.FStar.Util.string_of_int))
in (let _68_16302 = (Support.Prims.pipe_right (Support.List.length args0) Support.Microsoft.FStar.Util.string_of_int)
in (Support.Microsoft.FStar.Util.format2 "Too many arguments to type; expected %s arguments but got %s" _68_16303 _68_16302)))
in (_68_16304, top.Microsoft_FStar_Absyn_Syntax.pos))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16305))
in (raise (_68_16306)))
end))
in (check_args [] [] f1 formals args))
end
| _ -> begin
(let _68_16309 = (let _68_16308 = (let _68_16307 = (Microsoft_FStar_Tc_Errors.expected_tcon_kind env top k1)
in (_68_16307, top.Microsoft_FStar_Absyn_Syntax.pos))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16308))
in (raise (_68_16309)))
end)
end))
in (match ((let _68_16313 = (let _68_16310 = (Microsoft_FStar_Absyn_Util.compress_typ head)
in _68_16310.Microsoft_FStar_Absyn_Syntax.n)
in (let _68_16312 = (let _68_16311 = (Microsoft_FStar_Absyn_Util.compress_kind k1)
in _68_16311.Microsoft_FStar_Absyn_Syntax.n)
in (_68_16313, _68_16312)))) with
...
| (t1, f2) -> begin
(let _68_16317 = (Support.Prims.pipe_left (w k1) (Microsoft_FStar_Absyn_Syntax.mk_Typ_ascribed' (t1, k1)))
in (let _68_16316 = (Microsoft_FStar_Tc_Rel.conj_guard f1 f2)
in (_68_16317, k1, _68_16316)))
end))
end))
end
...
| true -> begin
(let _68_16319 = (Microsoft_FStar_Absyn_Print.typ_to_string s)
in (let _68_16318 = (Microsoft_FStar_Absyn_Print.kind_to_string k1)
in (Support.Microsoft.FStar.Util.fprint2 "Admitting un-instantiated uvar %s at kind %s\n" _68_16319 _68_16318)))
end
| false -> begin
()
end)
in (let _68_16322 = (Support.Prims.pipe_left (w k1) (Microsoft_FStar_Absyn_Syntax.mk_Typ_uvar' (u, k1)))
in (_68_16322, k1, Microsoft_FStar_Tc_Rel.trivial_guard)))
end
| _ -> begin
(let _36_874 = (match ((Support.Prims.pipe_left (Microsoft_FStar_Tc_Env.debug env) Microsoft_FStar_Options.High)) with
| true -> begin
(let _68_16324 = (Microsoft_FStar_Absyn_Print.typ_to_string s)
in (let _68_16323 = (Microsoft_FStar_Absyn_Print.kind_to_string k1)
...
| (t, k, f) -> begin
(let _68_16325 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta (Microsoft_FStar_Absyn_Syntax.Meta_refresh_label ((t, b, r))))
in (_68_16325, k, f))
end))
end
...
| (t, k, f) -> begin
(let _68_16326 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta (Microsoft_FStar_Absyn_Syntax.Meta_labeled ((t, l, r, p))))
in (_68_16326, k, f))
end))
end
...
| (t, k, f) -> begin
(let _68_16327 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta (Microsoft_FStar_Absyn_Syntax.Meta_named ((t, l))))
in (_68_16327, k, f))
end))
end
...
| (pats, g) -> begin
(let _68_16330 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta (Microsoft_FStar_Absyn_Syntax.Meta_pattern ((quant, pats))))
in (let _68_16329 = (Microsoft_FStar_Tc_Util.force_tk quant)
in (let _68_16328 = (Microsoft_FStar_Tc_Rel.conj_guard f g)
in (_68_16330, _68_16329, _68_16328))))
end))
end))
end
...
| _ -> begin
(let _68_16332 = (let _68_16331 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.format1 "Unexpected type : %s\n" _68_16331))
in (failwith (_68_16332)))
end))))))
...
| false -> begin
(let _68_16339 = (let _68_16338 = (Microsoft_FStar_Absyn_Syntax.mk_Total t)
in (Support.Prims.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp _68_16338))
in Support.Microsoft.FStar.Util.Inr (_68_16339))
end)
in (let _68_16340 = (value_check_expected_typ env e tc)
in (Support.Prims.pipe_left (with_implicits implicits) _68_16340)))
end))))
end
...
| true -> begin
(let _68_16348 = (let _68_16347 = (let _68_16346 = (Support.Microsoft.FStar.Util.format1 "Expected a data constructor; got %s" v.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.str)
in (let _68_16345 = (Microsoft_FStar_Tc_Env.get_range env)
in (_68_16346, _68_16345)))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16347))
in (raise (_68_16348)))
end
| false -> begin
(let _68_16349 = (value_check_expected_typ env e tc)
in (Support.Prims.pipe_left (with_implicits implicits) _68_16349))
end)))
end))))
end
...
(let fail = (fun ( msg ) ( t ) -> (let _68_16354 = (let _68_16353 = (let _68_16352 = (Microsoft_FStar_Tc_Errors.expected_a_term_of_type_t_got_a_function env msg t top)
in (_68_16352, top.Microsoft_FStar_Absyn_Syntax.pos))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16353))
in (raise (_68_16354))))
...
in (let rec as_function_typ = (fun ( norm ) ( t ) -> (match ((let _68_16363 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _68_16363.Microsoft_FStar_Absyn_Syntax.n)) with
...
| ([], []) -> begin
(let _68_16372 = (Microsoft_FStar_Absyn_Util.subst_comp subst c)
in ((Support.List.rev out), env, g, _68_16372))
end
...
in (let g = (let _68_16373 = (Microsoft_FStar_Tc_Rel.conj_guard g1 g2)
in (Microsoft_FStar_Tc_Rel.conj_guard g _68_16373))
in (k, g)))
end))
end)
...
(let tx = (Microsoft_FStar_Absyn_Util.subst_typ subst x.Microsoft_FStar_Absyn_Syntax.sort)
in (let _36_1127 = (match ((let _68_16374 = (Microsoft_FStar_Absyn_Util.unmeta_typ y.Microsoft_FStar_Absyn_Syntax.sort)
in _68_16374.Microsoft_FStar_Absyn_Syntax.n)) with
| Microsoft_FStar_Absyn_Syntax.Typ_unknown -> begin
(tx, g)
end
| _ -> begin
...
| true -> begin
(let _68_16375 = (Microsoft_FStar_Absyn_Print.binder_to_string hd)
...
| _ -> begin
(let _68_16379 = (let _68_16378 = (Microsoft_FStar_Absyn_Print.binder_to_string hdannot)
in (let _68_16377 = (Microsoft_FStar_Absyn_Print.binder_to_string hd)
in (Support.Microsoft.FStar.Util.format2 "Annotated %s; given %s" _68_16378 _68_16377)))
in (fail _68_16379 t))
end)
end
| ([], _) -> begin
...
| t -> begin
(let _68_16381 = (let _68_16380 = (Microsoft_FStar_Absyn_Print.tag_of_typ t)
in (Support.Microsoft.FStar.Util.format1 "More arguments than annotated type (%s)" _68_16380))
in (fail _68_16381 t))
end)
end
| false -> begin
...
| (_, []) -> begin
(let c = (let _68_16382 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (bs_annot, c) (Some (Microsoft_FStar_Absyn_Syntax.ktype)) c.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Absyn_Util.total_comp _68_16382 c.Microsoft_FStar_Absyn_Syntax.pos))
in (let _68_16383 = (Microsoft_FStar_Absyn_Util.subst_comp subst c)
in ((Support.List.rev out), env, g, _68_16383)))
end)
end))
...
| true -> begin
(let _68_16388 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
...
(match ((let _68_16394 = (let _68_16393 = (let _68_16392 = (Microsoft_FStar_Absyn_Util.unrefine x.Microsoft_FStar_Absyn_Syntax.sort)
in (whnf env _68_16392))
in (Microsoft_FStar_Absyn_Util.unrefine _68_16393))
in _68_16394.Microsoft_FStar_Absyn_Syntax.n)) with
| Microsoft_FStar_Absyn_Syntax.Typ_fun (_) -> begin
[]
end
| _ -> begin
(let _68_16395 = (Microsoft_FStar_Absyn_Util.bvar_to_exp x)
in (_68_16395)::[])
end)
end)))))
...
| true -> begin
(let _68_16404 = (let _68_16403 = (let _68_16402 = (let _68_16400 = (Support.Microsoft.FStar.Util.string_of_int (Support.List.length bs'))
in (let _68_16399 = (Support.Microsoft.FStar.Util.string_of_int (Support.List.length actuals))
in (Support.Microsoft.FStar.Util.format2 "Decreases clause on a function with an unexpected number of arguments (expected %s; got %s)" _68_16400 _68_16399)))
in (let _68_16401 = (Microsoft_FStar_Tc_Env.get_range env)
in (_68_16402, _68_16401)))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16403))
in (raise (_68_16404)))
end
| false -> begin
()
...
(let _68_16408 = (let _68_16407 = (Microsoft_FStar_Absyn_Util.btvar_to_typ actual)
in (formal.Microsoft_FStar_Absyn_Syntax.v, _68_16407))
in Support.Microsoft.FStar.Util.Inl (_68_16408))
end
| ((Support.Microsoft.FStar.Util.Inr (formal), _), (Support.Microsoft.FStar.Util.Inr (actual), _)) -> begin
(let _68_16410 = (let _68_16409 = (Microsoft_FStar_Absyn_Util.bvar_to_exp actual)
in (formal.Microsoft_FStar_Absyn_Syntax.v, _68_16409))
in Support.Microsoft.FStar.Util.Inr (_68_16410))
end
| _ -> begin
(failwith ("impossible"))
end)) bs' actuals)
...
in (match ((let _68_16412 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _68_16412.Microsoft_FStar_Absyn_Syntax.n)) with
...
in (let dec = (let subst = (let _68_16416 = (let _68_16415 = (let _68_16414 = (Microsoft_FStar_Absyn_Util.bvar_to_exp y)
in (x.Microsoft_FStar_Absyn_Syntax.v, _68_16414))
in Support.Microsoft.FStar.Util.Inr (_68_16415))
in (_68_16416)::[])
in (Microsoft_FStar_Absyn_Util.subst_exp subst dec))
in (let _68_16421 = (let _68_16420 = (let _68_16419 = (Microsoft_FStar_Absyn_Syntax.varg dec)
in (let _68_16418 = (let _68_16417 = (Microsoft_FStar_Absyn_Syntax.varg prev_dec)
in (_68_16417)::[])
in (_68_16419)::_68_16418))
in (precedes, _68_16420))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _68_16421 None r))))
end
| _ -> begin
(let formal_args = (let _68_16424 = (let _68_16423 = (let _68_16422 = (Microsoft_FStar_Absyn_Syntax.v_binder y)
in (_68_16422)::[])
in (Support.List.append bs _68_16423))
in (Support.Prims.pipe_right _68_16424 filter_types_and_functions))
...
in (let _68_16429 = (let _68_16428 = (let _68_16427 = (Microsoft_FStar_Absyn_Syntax.varg lhs)
in (let _68_16426 = (let _68_16425 = (Microsoft_FStar_Absyn_Syntax.varg prev_dec)
in (_68_16425)::[])
in (_68_16427)::_68_16426))
in (precedes, _68_16428))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _68_16429 None r))))
end)
...
| true -> begin
(let _68_16432 = (Microsoft_FStar_Absyn_Print.lbname_to_string l)
in (let _68_16431 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (let _68_16430 = (Microsoft_FStar_Absyn_Print.typ_to_string t')
in (Support.Microsoft.FStar.Util.fprint3 "Refined let rec %s\n\tfrom type %s\n\tto type %s\n" _68_16432 _68_16431 _68_16430))))
end
| false -> begin
()
end)
in (let _36_1299 = (let _68_16434 = (let _68_16433 = (Microsoft_FStar_Tc_Env.clear_expected_typ env)
in (Support.Prims.pipe_right _68_16433 Support.Prims.fst))
in (tc_typ _68_16434 t'))
...
in (let _68_16440 = (Support.Prims.pipe_right letrecs (Support.List.fold_left (fun ( env ) ( _36_1308 ) -> (match (_36_1308) with
| (x, t) -> begin
(Microsoft_FStar_Tc_Env.push_local_binding env (binding_of_lb x t))
end)) env))
in (let _68_16439 = (Support.Prims.pipe_right letrecs (Support.List.collect (fun ( _36_8 ) -> (match (_36_8) with
| (Support.Microsoft.FStar.Util.Inl (x), t) -> begin
(let _68_16438 = (Microsoft_FStar_Absyn_Syntax.v_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_68_16438)::[])
end
| _ -> begin
[]
end))))
in (_68_16440, _68_16439)))))))))))
end))
...
(match ((not (norm))) with
| true -> begin
(let _68_16441 = (whnf env t)
in (as_function_typ true _68_16441))
end
| false -> begin
...
| true -> begin
(let _68_16444 = (Microsoft_FStar_Absyn_Print.exp_to_string body)
in (let _68_16443 = (Microsoft_FStar_Absyn_Print.lcomp_typ_to_string cbody)
in (let _68_16442 = (Microsoft_FStar_Tc_Rel.guard_to_string env guard_body)
in (Support.Microsoft.FStar.Util.fprint3 "!!!!!!!!!!!!!!!body %s has type %s\nguard is %s\n" _68_16444 _68_16443 _68_16442))))
end
| false -> begin
()
end)
...
| true -> begin
(let _36_1378 = (let _68_16448 = (Microsoft_FStar_Tc_Rel.conj_guard g guard)
in (Microsoft_FStar_Tc_Util.discharge_guard envbody _68_16448))
...
in (let e = (let _68_16450 = (let _68_16449 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_abs (bs, body) (Some (tfun_computed)) top.Microsoft_FStar_Absyn_Syntax.pos)
in (_68_16449, tfun_computed, Some (Microsoft_FStar_Absyn_Const.effect_Tot_lid)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed _68_16450 None top.Microsoft_FStar_Absyn_Syntax.pos))
in (let _36_1403 = (match (tfun_opt) with
| Some ((t, use_teq)) -> begin
(let t = (Microsoft_FStar_Absyn_Util.compress_typ t)
in (match (t.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_fun (_) -> begin
(let _68_16453 = (let _68_16452 = (let _68_16451 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_abs (bs, body) (Some (t)) e.Microsoft_FStar_Absyn_Syntax.pos)
in (_68_16451, t, Some (Microsoft_FStar_Absyn_Const.effect_Tot_lid)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed _68_16452 None top.Microsoft_FStar_Absyn_Syntax.pos))
in (_68_16453, t, guard))
end
| _ -> begin
(let _36_1398 = (match (use_teq) with
| true -> begin
(let _68_16454 = (Microsoft_FStar_Tc_Rel.teq env t tfun_computed)
in (e, _68_16454))
end
| false -> begin
...
| (e, guard') -> begin
(let _68_16456 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed (e, t, Some (Microsoft_FStar_Absyn_Const.effect_Tot_lid)) None top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16455 = (Microsoft_FStar_Tc_Rel.conj_guard guard guard')
in (_68_16456, t, _68_16455)))
end))
end))
end
| None -> begin
...
| true -> begin
(let _68_16459 = (Microsoft_FStar_Absyn_Print.typ_to_string tfun)
in (let _68_16458 = (Microsoft_FStar_Absyn_Print.tag_of_typ tfun)
in (let _68_16457 = (Microsoft_FStar_Tc_Rel.guard_to_string env guard)
in (Support.Microsoft.FStar.Util.fprint3 "!!!!!!!!!!!!!!!Annotating lambda with type %s (%s)\nGuard is %s\n" _68_16459 _68_16458 _68_16457))))
end
| false -> begin
()
end)
...
in (let _36_1409 = (let _68_16461 = (Microsoft_FStar_Tc_Util.lcomp_of_comp c)
in (Microsoft_FStar_Tc_Util.strengthen_precondition None env e _68_16461 guard))
...
| _ -> begin
(let _68_16463 = (let _68_16462 = (Microsoft_FStar_Absyn_Print.exp_to_string e)
in (Support.Microsoft.FStar.Util.format1 "Unexpected value: %s" _68_16462))
in (failwith (_68_16463)))
end))))
...
| true -> begin
(let _68_16468 = (let _68_16466 = (Microsoft_FStar_Tc_Env.get_range env)
in (Support.Prims.pipe_left Support.Microsoft.FStar.Range.string_of_range _68_16466))
in (let _68_16467 = (Microsoft_FStar_Absyn_Print.tag_of_exp e)
...
(let _68_16492 = (Microsoft_FStar_Absyn_Util.compress_exp e)
in (tc_exp env _68_16492))
end
...
| (t1, f) -> begin
(let _36_1450 = (let _68_16493 = (Microsoft_FStar_Tc_Env.set_expected_typ env t1)
in (tc_exp _68_16493 e1))
in (match (_36_1450) with
| (e1, c, g) -> begin
(let _36_1454 = (let _68_16497 = (Microsoft_FStar_Tc_Env.set_range env t1.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Tc_Util.strengthen_precondition (Some ((fun ( _36_1451 ) -> (match (()) with
| () -> begin
Microsoft_FStar_Tc_Errors.ill_kinded_type
end)))) _68_16497 e1 c f))
in (match (_36_1454) with
| (c, f) -> begin
(let _36_1458 = (let _68_16501 = (let _68_16500 = (w c)
in (Support.Prims.pipe_left _68_16500 (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed (e1, t1, Some (c.Microsoft_FStar_Absyn_Syntax.eff_name)))))
in (comp_check_expected_typ env _68_16501 c))
in (match (_36_1458) with
| (e, c, f2) -> begin
(let _68_16503 = (let _68_16502 = (Microsoft_FStar_Tc_Rel.conj_guard g f2)
in (Microsoft_FStar_Tc_Rel.conj_guard f _68_16502))
in (e, c, _68_16503))
end))
end))
end))
...
(match ((let _68_16504 = (Microsoft_FStar_Absyn_Util.compress_exp e)
in _68_16504.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let _36_1481 = (let _68_16505 = (Microsoft_FStar_Tc_Env.set_expected_typ env Microsoft_FStar_Tc_Recheck.t_unit)
in (tc_exp _68_16505 e1))
...
in (let _68_16518 = (let _68_16516 = (let _68_16515 = (let _68_16514 = (let _68_16513 = (w c)
in (let _68_16512 = (let _68_16511 = (let _68_16510 = (let _68_16509 = (let _68_16508 = (Microsoft_FStar_Absyn_Syntax.mk_lb (x, c1.Microsoft_FStar_Absyn_Syntax.eff_name, Microsoft_FStar_Tc_Recheck.t_unit, e1))
in (_68_16508)::[])
in (false, _68_16509))
in (_68_16510, e2))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_let _68_16511))
in (Support.Prims.pipe_left _68_16513 _68_16512)))
in (_68_16514, Microsoft_FStar_Absyn_Syntax.Sequence))
in Microsoft_FStar_Absyn_Syntax.Meta_desugared (_68_16515))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta _68_16516))
in (let _68_16517 = (Microsoft_FStar_Tc_Rel.conj_guard g1 g2)
in (_68_16518, c, _68_16517))))
end))
end))
end
| _ -> begin
...
| (e, c, g) -> begin
(let _68_16519 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta (Microsoft_FStar_Absyn_Syntax.Meta_desugared ((e, Microsoft_FStar_Absyn_Syntax.Sequence))))
in (_68_16519, c, g))
end))
end)
end
...
| (e, c, g) -> begin
(let _68_16520 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta (Microsoft_FStar_Absyn_Syntax.Meta_desugared ((e, i))))
in (_68_16520, c, g))
end))
end
| Microsoft_FStar_Absyn_Syntax.Exp_app ((head, args)) -> begin
(let env0 = env
in (let env = (let _68_16522 = (let _68_16521 = (Microsoft_FStar_Tc_Env.clear_expected_typ env)
in (Support.Prims.pipe_right _68_16521 Support.Prims.fst))
in (Support.Prims.pipe_right _68_16522 instantiate_both))
in (let _36_1508 = (match ((Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High)) with
| true -> begin
(let _68_16524 = (Support.Microsoft.FStar.Range.string_of_range top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16523 = (Microsoft_FStar_Absyn_Print.exp_to_string top)
...
| true -> begin
(let _68_16530 = (let _68_16527 = (Microsoft_FStar_Absyn_Util.bvar_to_exp x)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Util.b2t _68_16527))
in (let _68_16529 = (let _68_16528 = (Microsoft_FStar_Tc_Util.return_value env Microsoft_FStar_Absyn_Util.t_bool xexp)
in (Support.Prims.pipe_right _68_16528 Microsoft_FStar_Tc_Util.lcomp_of_comp))
in (Microsoft_FStar_Tc_Util.ite env _68_16530 c2 _68_16529)))
end
| false -> begin
(let _68_16534 = (let _68_16531 = (Microsoft_FStar_Absyn_Util.bvar_to_exp x)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Util.b2t _68_16531))
in (let _68_16533 = (let _68_16532 = (Microsoft_FStar_Tc_Util.return_value env Microsoft_FStar_Absyn_Util.t_bool xexp)
in (Support.Prims.pipe_right _68_16532 Microsoft_FStar_Tc_Util.lcomp_of_comp))
in (Microsoft_FStar_Tc_Util.ite env _68_16534 _68_16533 c2)))
end)
in (let c = (let _68_16537 = (let _68_16536 = (Support.Prims.pipe_left (fun ( _68_16535 ) -> Some (_68_16535)) (Microsoft_FStar_Tc_Env.Binding_var ((x.Microsoft_FStar_Absyn_Syntax.v, Microsoft_FStar_Absyn_Util.t_bool))))
in (_68_16536, c2))
in (Microsoft_FStar_Tc_Util.bind env None c1 _68_16537))
in (let e = (let _68_16542 = (let _68_16541 = (let _68_16540 = (Microsoft_FStar_Absyn_Syntax.varg e1)
in (let _68_16539 = (let _68_16538 = (Microsoft_FStar_Absyn_Syntax.varg e2)
in (_68_16538)::[])
in (_68_16540)::_68_16539))
in (head, _68_16541))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _68_16542 (Some (Microsoft_FStar_Absyn_Util.t_bool)) top.Microsoft_FStar_Absyn_Syntax.pos))
in (let _68_16544 = (let _68_16543 = (Microsoft_FStar_Tc_Rel.conj_guard g1 g2)
in (Microsoft_FStar_Tc_Rel.conj_guard g_head _68_16543))
in (e, c, _68_16544)))))))
end))
end))
end
...
| true -> begin
(let _68_16546 = (Support.Microsoft.FStar.Range.string_of_range head.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16545 = (Microsoft_FStar_Absyn_Print.typ_to_string thead)
in (Support.Microsoft.FStar.Util.fprint2 "(%s) Type of head is %s\n" _68_16546 _68_16545)))
end
| false -> begin
()
end)
in (let rec check_function_app = (fun ( norm ) ( tf ) -> (match ((let _68_16551 = (Microsoft_FStar_Absyn_Util.unrefine tf)
in _68_16551.Microsoft_FStar_Absyn_Syntax.n)) with
| (Microsoft_FStar_Absyn_Syntax.Typ_uvar (_)) | (Microsoft_FStar_Absyn_Syntax.Typ_app (({Microsoft_FStar_Absyn_Syntax.n = Microsoft_FStar_Absyn_Syntax.Typ_uvar (_); Microsoft_FStar_Absyn_Syntax.tk = _; Microsoft_FStar_Absyn_Syntax.pos = _; Microsoft_FStar_Absyn_Syntax.fvs = _; Microsoft_FStar_Absyn_Syntax.uvs = _}, _))) -> begin
...
(let _68_16556 = (Microsoft_FStar_Tc_Rel.conj_guard g_e g_rest)
in (((Support.Microsoft.FStar.Util.Inr (e), imp))::args, (c)::comps, _68_16556))
end))
end))
end))
...
(let bs = (let _68_16557 = (Microsoft_FStar_Tc_Util.tks_of_args args)
in (Microsoft_FStar_Absyn_Util.null_binders_of_tks _68_16557))
in (let cres = (let _68_16558 = (Microsoft_FStar_Tc_Util.new_tvar env Microsoft_FStar_Absyn_Syntax.ktype)
in (Microsoft_FStar_Absyn_Util.ml_comp _68_16558 top.Microsoft_FStar_Absyn_Syntax.pos))
in (let _36_1608 = (let _68_16560 = (let _68_16559 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (bs, cres) (Some (Microsoft_FStar_Absyn_Syntax.ktype)) tf.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Tc_Rel.teq env tf _68_16559))
in (Support.Prims.pipe_left (Microsoft_FStar_Tc_Util.force_trivial env) _68_16560))
in (let comp = (let _68_16563 = (Support.Prims.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp cres)
in (Support.List.fold_right (fun ( c ) ( out ) -> (Microsoft_FStar_Tc_Util.bind env None c (None, out))) ((chead)::comps) _68_16563))
in (let _68_16565 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app (head, args) (Some (comp.Microsoft_FStar_Absyn_Syntax.res_typ)) top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16564 = (Microsoft_FStar_Tc_Rel.conj_guard g_head g_args)
in (_68_16565, comp, _68_16564)))))))
end)))
end
| Microsoft_FStar_Absyn_Syntax.Typ_fun ((bs, c)) -> begin
...
in (let _36_1649 = (let _68_16601 = (let _68_16600 = (Support.List.hd args)
in (Microsoft_FStar_Absyn_Util.range_of_arg _68_16600))
in (Microsoft_FStar_Tc_Rel.new_tvar _68_16601 vars k))
in (match (_36_1649) with
| (targ, u) -> begin
(let _36_1650 = (match ((Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Extreme)) with
| true -> begin
(let _68_16603 = (Microsoft_FStar_Absyn_Print.strBvd a.Microsoft_FStar_Absyn_Syntax.v)
in (let _68_16602 = (Microsoft_FStar_Absyn_Print.typ_to_string targ)
in (Support.Microsoft.FStar.Util.fprint2 "Instantiating %s to %s" _68_16603 _68_16602)))
end
| false -> begin
()
end)
in (let subst = (Support.Microsoft.FStar.Util.Inl ((a.Microsoft_FStar_Absyn_Syntax.v, targ)))::subst
in (let arg = (let _68_16604 = (Microsoft_FStar_Absyn_Syntax.as_implicit true)
in (Support.Microsoft.FStar.Util.Inl (targ), _68_16604))
in (let _68_16613 = (let _68_16612 = (let _68_16611 = (let _68_16610 = (let _68_16609 = (Microsoft_FStar_Tc_Util.as_uvar_t u)
in (_68_16609, u.Microsoft_FStar_Absyn_Syntax.pos))
in Support.Microsoft.FStar.Util.Inl (_68_16610))
in (add_implicit _68_16611 g))
in (subst, (arg)::outargs, (arg)::arg_rets, comps, _68_16612, fvs))
in (tc_args _68_16613 rest cres args)))))
end))))
end
...
in (let arg = (let _68_16614 = (Microsoft_FStar_Absyn_Syntax.as_implicit true)
in (Support.Microsoft.FStar.Util.Inr (varg), _68_16614))
...
| true -> begin
(let _68_16620 = (Microsoft_FStar_Absyn_Print.strBvd a.Microsoft_FStar_Absyn_Syntax.v)
in (let _68_16619 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
...
| (t, g') -> begin
(let f = (let _68_16621 = (Microsoft_FStar_Tc_Rel.guard_f g')
in (Microsoft_FStar_Tc_Util.label_guard Microsoft_FStar_Tc_Errors.ill_kinded_type t.Microsoft_FStar_Absyn_Syntax.pos _68_16621))
...
in (let subst = (let _68_16622 = (Support.List.hd bs)
in (maybe_extend_subst subst _68_16622 arg))
in (let _68_16628 = (let _68_16627 = (Microsoft_FStar_Tc_Rel.conj_guard g g')
in (subst, (arg)::outargs, (arg)::arg_rets, comps, _68_16627, fvs))
in (tc_args _68_16628 rest cres rest'))))))
end)))))
end
...
| true -> begin
(let _68_16630 = (Microsoft_FStar_Absyn_Print.subst_to_string subst)
in (let _68_16629 = (Microsoft_FStar_Absyn_Print.typ_to_string x.Microsoft_FStar_Absyn_Syntax.sort)
...
| true -> begin
(let _68_16631 = (Microsoft_FStar_Absyn_Print.typ_to_string targ)
...
| true -> begin
(let _68_16633 = (Microsoft_FStar_Absyn_Print.exp_to_string e)
in (let _68_16632 = (Microsoft_FStar_Absyn_Print.typ_to_string targ)
...
| true -> begin
(let _68_16636 = (Microsoft_FStar_Absyn_Print.tag_of_exp e)
in (let _68_16635 = (Microsoft_FStar_Absyn_Print.exp_to_string e)
in (let _68_16634 = (Microsoft_FStar_Absyn_Print.typ_to_string targ)
in (Support.Microsoft.FStar.Util.fprint3 "Checking arg (%s) %s at type %s\n" _68_16636 _68_16635 _68_16634))))
end
| false -> begin
()
end)
...
| true -> begin
(let _68_16638 = (Microsoft_FStar_Tc_Rel.guard_to_string env g_e)
in (let _68_16637 = (Microsoft_FStar_Tc_Rel.guard_to_string env g)
...
| true -> begin
(let subst = (let _68_16639 = (Support.List.hd bs)
in (maybe_extend_subst subst _68_16639 arg))
in (tc_args (subst, (arg)::outargs, (arg)::arg_rets, comps, g, fvs) rest cres rest'))
end
| false -> begin
(match ((Microsoft_FStar_Tc_Util.is_pure_effect env c.Microsoft_FStar_Absyn_Syntax.eff_name)) with
| true -> begin
(let subst = (let _68_16644 = (Support.List.hd bs)
in (maybe_extend_subst subst _68_16644 arg))
...
| false -> begin
(match ((let _68_16649 = (Support.List.hd bs)
in (Microsoft_FStar_Absyn_Syntax.is_null_binder _68_16649))) with
| true -> begin
(let newx = (Microsoft_FStar_Absyn_Util.gen_bvar_p e.Microsoft_FStar_Absyn_Syntax.pos c.Microsoft_FStar_Absyn_Syntax.res_typ)
in (let arg' = (let _68_16650 = (Microsoft_FStar_Absyn_Util.bvar_to_exp newx)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.varg _68_16650))
...
| false -> begin
(let _68_16663 = (let _68_16662 = (let _68_16656 = (let _68_16655 = (Microsoft_FStar_Absyn_Util.bvar_to_exp x)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.varg _68_16655))
in (_68_16656)::arg_rets)
in (let _68_16661 = (let _68_16659 = (let _68_16658 = (Support.Prims.pipe_left (fun ( _68_16657 ) -> Some (_68_16657)) (Microsoft_FStar_Tc_Env.Binding_var ((x.Microsoft_FStar_Absyn_Syntax.v, targ))))
in (_68_16658, c))
in (_68_16659)::comps)
in (let _68_16660 = (Support.Microsoft.FStar.Util.set_add x fvs)
in (subst, (arg)::outargs, _68_16662, _68_16661, g, _68_16660))))
in (tc_args _68_16663 rest cres rest'))
end)
end)
end))))
end))))))))))
...
(let _68_16667 = (let _68_16666 = (let _68_16665 = (let _68_16664 = (Support.List.hd args)
in (Microsoft_FStar_Absyn_Util.range_of_arg _68_16664))
in ("Expected an expression; got a type", _68_16665))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16666))
in (raise (_68_16667)))
end
| ((Support.Microsoft.FStar.Util.Inl (_), _)::_, (Support.Microsoft.FStar.Util.Inr (_), _)::_) -> begin
(let _68_16671 = (let _68_16670 = (let _68_16669 = (let _68_16668 = (Support.List.hd args)
in (Microsoft_FStar_Absyn_Util.range_of_arg _68_16668))
in ("Expected a type; got an expression", _68_16669))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16670))
in (raise (_68_16671)))
end
| (_, []) -> begin
...
| true -> begin
(let _68_16673 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app_flat (head, (Support.List.rev arg_rets)) (Some (cres.Microsoft_FStar_Absyn_Syntax.res_typ)) top.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Tc_Util.maybe_assume_result_eq_pure_term env _68_16673 cres))
end
| false -> begin
(let _36_1802 = (match ((Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low)) with
| true -> begin
(let _68_16676 = (Microsoft_FStar_Absyn_Print.exp_to_string head)
in (let _68_16675 = (Microsoft_FStar_Absyn_Print.lcomp_typ_to_string cres)
in (let _68_16674 = (Microsoft_FStar_Tc_Rel.guard_to_string env g)
in (Support.Microsoft.FStar.Util.fprint3 "Not refining result: f=%s; cres=%s; guard=%s\n" _68_16676 _68_16675 _68_16674))))
end
| false -> begin
()
end)
...
in (let _68_16677 = (Microsoft_FStar_Tc_Util.refresh_comp_label env false cres)
in (_68_16677, g))))))
end
| _ -> begin
(let g = (let _68_16678 = (Microsoft_FStar_Tc_Rel.conj_guard g_head g)
in (Support.Prims.pipe_right _68_16678 (Microsoft_FStar_Tc_Rel.solve_deferred_constraints env)))
in (let _68_16684 = (let _68_16683 = (let _68_16682 = (let _68_16681 = (let _68_16680 = (let _68_16679 = (cres.Microsoft_FStar_Absyn_Syntax.comp ())
in (bs, _68_16679))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun _68_16680 (Some (Microsoft_FStar_Absyn_Syntax.ktype)) top.Microsoft_FStar_Absyn_Syntax.pos))
in (Support.Prims.pipe_left (Microsoft_FStar_Absyn_Util.subst_typ subst) _68_16681))
in (Microsoft_FStar_Absyn_Syntax.mk_Total _68_16682))
in (Support.Prims.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp _68_16683))
in (_68_16684, g)))
end)
...
| true -> begin
(let _68_16685 = (Microsoft_FStar_Absyn_Print.lcomp_typ_to_string cres)
...
| true -> begin
(let _68_16691 = (Microsoft_FStar_Tc_Normalize.exp_norm_to_string env app)
in (let _68_16690 = (let _68_16689 = (comp.Microsoft_FStar_Absyn_Syntax.comp ())
in (Microsoft_FStar_Absyn_Print.comp_typ_to_string _68_16689))
...
| ([], arg::_) -> begin
(let rec aux = (fun ( norm ) ( tres ) -> (let tres = (let _68_16696 = (Microsoft_FStar_Absyn_Util.compress_typ tres)
in (Support.Prims.pipe_right _68_16696 Microsoft_FStar_Absyn_Util.unrefine))
...
| true -> begin
(let _68_16697 = (Support.Microsoft.FStar.Range.string_of_range tres.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Microsoft.FStar.Util.fprint1 "%s: Warning: Potentially redundant explicit currying of a function type \n" _68_16697))
end
| false -> begin
()
end)
in (let _68_16702 = (Microsoft_FStar_Tc_Util.lcomp_of_comp cres')
in (tc_args (subst, outargs, arg_rets, ((None, cres))::comps, g, fvs) bs _68_16702 args)))
end
| _ when (not (norm)) -> begin
(let _68_16703 = (whnf env tres)
in (aux true _68_16703))
end
| _ -> begin
(let _68_16709 = (let _68_16708 = (let _68_16707 = (let _68_16705 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env tf)
in (let _68_16704 = (Microsoft_FStar_Absyn_Print.exp_to_string top)
in (Support.Microsoft.FStar.Util.format2 "Too many arguments to function of type %s; got %s" _68_16705 _68_16704)))
in (let _68_16706 = (Microsoft_FStar_Absyn_Syntax.argpos arg)
in (_68_16707, _68_16706)))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16708))
in (raise (_68_16709)))
end)))
in (aux false cres.Microsoft_FStar_Absyn_Syntax.res_typ))
end)
end))
in (let _68_16710 = (Microsoft_FStar_Tc_Util.lcomp_of_comp c)
in (tc_args ([], [], [], [], Microsoft_FStar_Tc_Rel.trivial_guard, Microsoft_FStar_Absyn_Syntax.no_fvs.Microsoft_FStar_Absyn_Syntax.fxvs) bs _68_16710 args))))
end
| _ -> begin
(match ((not (norm))) with
| true -> begin
(let _68_16711 = (whnf env tf)
in (check_function_app true _68_16711))
end
| false -> begin
(let _68_16714 = (let _68_16713 = (let _68_16712 = (Microsoft_FStar_Tc_Errors.expected_function_typ env tf)
in (_68_16712, head.Microsoft_FStar_Absyn_Syntax.pos))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16713))
in (raise (_68_16714)))
end)
end))
in (let _68_16715 = (Microsoft_FStar_Absyn_Util.unrefine thead)
in (check_function_app false _68_16715)))))
end))
end))
in (let _36_1848 = (aux ())
...
| true -> begin
(let _68_16716 = (Support.Prims.pipe_left Support.Microsoft.FStar.Util.string_of_int (Support.List.length g.Microsoft_FStar_Tc_Rel.implicits))
...
| true -> begin
(let _68_16721 = (Support.Microsoft.FStar.Range.string_of_range e.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16720 = (Microsoft_FStar_Absyn_Print.typ_to_string c.Microsoft_FStar_Absyn_Syntax.res_typ)
in (let _68_16719 = (let _68_16718 = (Microsoft_FStar_Tc_Env.expected_typ env0)
in (Support.Prims.pipe_right _68_16718 (fun ( x ) -> (match (x) with
| None -> begin
"None"
end
| Some (t) -> begin
...
| (e, c, g') -> begin
(let _68_16722 = (Microsoft_FStar_Tc_Rel.conj_guard g g')
in (e, c, _68_16722))
end)))))
end)))
end)))))
...
in (let _68_16723 = (Microsoft_FStar_Tc_Env.set_expected_typ env res_t)
in (_68_16723, res_t)))
end)
in (match (_36_1880) with
| (env_branches, res_t) -> begin
(let guard_x = (let _68_16725 = (Support.Prims.pipe_left (fun ( _68_16724 ) -> Some (_68_16724)) e1.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Absyn_Util.new_bvd _68_16725))
...
(let _68_16728 = (Microsoft_FStar_Tc_Rel.conj_guard g gaccum)
in (((f, c))::caccum, _68_16728))
end)) t_eqns ([], Microsoft_FStar_Tc_Rel.trivial_guard))
in (match (_36_1894) with
| (cases, g) -> begin
(let _68_16729 = (Microsoft_FStar_Tc_Util.bind_cases env res_t cases)
in (_68_16729, g))
end))
...
| true -> begin
(let _68_16733 = (Support.Microsoft.FStar.Range.string_of_range top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16732 = (Microsoft_FStar_Absyn_Print.lcomp_typ_to_string c1)
in (let _68_16731 = (Microsoft_FStar_Absyn_Print.lcomp_typ_to_string c_branches)
in (let _68_16730 = (Microsoft_FStar_Tc_Rel.guard_to_string env g_branches)
in (Support.Microsoft.FStar.Util.fprint4 "(%s) comp\n\tscrutinee: %s\n\tbranches: %s\nguard = %s\n" _68_16733 _68_16732 _68_16731 _68_16730)))))
end
| false -> begin
()
end)
in (let cres = (let _68_16736 = (let _68_16735 = (Support.Prims.pipe_left (fun ( _68_16734 ) -> Some (_68_16734)) (Microsoft_FStar_Tc_Env.Binding_var ((guard_x, c1.Microsoft_FStar_Absyn_Syntax.res_typ))))
in (_68_16735, c_branches))
in (Microsoft_FStar_Tc_Util.bind env (Some (e1)) c1 _68_16736))
in (let e = (let _68_16743 = (w cres)
in (let _68_16742 = (let _68_16741 = (let _68_16740 = (Support.List.map (fun ( _36_1908 ) -> (match (_36_1908) with
| (f, _, _, _) -> begin
f
end)) t_eqns)
in (e1, _68_16740))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_match _68_16741))
in (Support.Prims.pipe_left _68_16743 _68_16742)))
in (let _68_16745 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed (e, cres.Microsoft_FStar_Absyn_Syntax.res_typ, Some (cres.Microsoft_FStar_Absyn_Syntax.eff_name)) None e.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16744 = (Microsoft_FStar_Tc_Rel.conj_guard g1 g_branches)
in (_68_16745, cres, _68_16744))))))
end))))
end))
end)))
end))
...
| true -> begin
(let _68_16746 = (Microsoft_FStar_Tc_Env.set_expected_typ env1 t)
in (Microsoft_FStar_Tc_Rel.trivial_guard, _68_16746))
end
| false -> begin
...
| true -> begin
(let _68_16748 = (Support.Microsoft.FStar.Range.string_of_range top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16747 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
...
| (e1, c1, g1) -> begin
(let _36_1957 = (let _68_16752 = (Microsoft_FStar_Tc_Env.set_range env t.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Tc_Util.strengthen_precondition (Some ((fun ( _36_1954 ) -> (match (()) with
| () -> begin
Microsoft_FStar_Tc_Errors.ill_kinded_type
end)))) _68_16752 e1 c1 f))
...
| true -> begin
(let _36_1963 = (let _68_16753 = (Microsoft_FStar_Tc_Rel.conj_guard g1 guard_f)
in (Microsoft_FStar_Tc_Util.check_top_level env _68_16753 c1))
...
| true -> begin
(let _68_16754 = (Microsoft_FStar_Tc_Env.get_range env)
in (Microsoft_FStar_Tc_Errors.warn _68_16754 Microsoft_FStar_Tc_Errors.top_level_effect))
end
| false -> begin
()
end)
in (let _68_16755 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta (Microsoft_FStar_Absyn_Syntax.Meta_desugared ((e2, Microsoft_FStar_Absyn_Syntax.MaskedEffect))))
in (_68_16755, c1)))
end)
end))
end
| false -> begin
(let _36_1966 = (let _68_16756 = (Microsoft_FStar_Tc_Rel.conj_guard g1 guard_f)
in (Microsoft_FStar_Tc_Util.discharge_guard env _68_16756))
in (let _68_16757 = (c1.Microsoft_FStar_Absyn_Syntax.comp ())
in (e2, _68_16757)))
end)
...
| true -> begin
(let _68_16758 = (Microsoft_FStar_Tc_Util.generalize false env1 (((x, e1, c1))::[]))
in (Support.Prims.pipe_left Support.List.hd _68_16758))
end
| false -> begin
(x, e1, c1)
end)
...
| (_, e1, c1) -> begin
(let cres = (let _68_16759 = (Microsoft_FStar_Absyn_Util.ml_comp Microsoft_FStar_Tc_Recheck.t_unit top.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Prims.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp _68_16759))
in (let cres = (match ((Microsoft_FStar_Absyn_Util.is_total_comp c1)) with
| true -> begin
cres
end
| false -> begin
(let _68_16760 = (Microsoft_FStar_Tc_Util.lcomp_of_comp c1)
in (Microsoft_FStar_Tc_Util.bind env None _68_16760 (None, cres)))
end)
in (let _36_1978 = (Support.ST.op_Colon_Equals e2.Microsoft_FStar_Absyn_Syntax.tk (Some (Microsoft_FStar_Tc_Recheck.t_unit)))
in (let _68_16769 = (let _68_16768 = (w cres)
in (let _68_16767 = (let _68_16766 = (let _68_16765 = (let _68_16764 = (let _68_16763 = (Microsoft_FStar_Absyn_Syntax.mk_lb (x, (Microsoft_FStar_Absyn_Util.comp_effect_name c1), (Microsoft_FStar_Absyn_Util.comp_result c1), e1))
in (_68_16763)::[])
in (false, _68_16764))
in (_68_16765, e2))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_let _68_16766))
in (Support.Prims.pipe_left _68_16768 _68_16767)))
in (_68_16769, cres, Microsoft_FStar_Tc_Rel.trivial_guard)))))
end))
end))
end
| Support.Microsoft.FStar.Util.Inl (bvd) -> begin
(let b = (binding_of_lb x c1.Microsoft_FStar_Absyn_Syntax.res_typ)
in (let _36_1986 = (let _68_16770 = (Microsoft_FStar_Tc_Env.push_local_binding env b)
in (tc_exp _68_16770 e2))
in (match (_36_1986) with
| (e2, c2, g2) -> begin
(let cres = (Microsoft_FStar_Tc_Util.bind env (Some (e1)) c1 (Some (b), c2))
in (let e = (let _68_16778 = (w cres)
in (let _68_16777 = (let _68_16776 = (let _68_16775 = (let _68_16774 = (let _68_16773 = (Microsoft_FStar_Absyn_Syntax.mk_lb (x, c1.Microsoft_FStar_Absyn_Syntax.eff_name, c1.Microsoft_FStar_Absyn_Syntax.res_typ, e1))
in (_68_16773)::[])
in (false, _68_16774))
in (_68_16775, e2))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_let _68_16776))
in (Support.Prims.pipe_left _68_16778 _68_16777)))
in (let g2 = (let _68_16787 = (let _68_16780 = (let _68_16779 = (Microsoft_FStar_Absyn_Syntax.v_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s bvd c1.Microsoft_FStar_Absyn_Syntax.res_typ))
in (_68_16779)::[])
in (Microsoft_FStar_Tc_Rel.close_guard _68_16780))
in (let _68_16786 = (let _68_16785 = (let _68_16784 = (let _68_16783 = (let _68_16782 = (Microsoft_FStar_Absyn_Util.bvd_to_exp bvd c1.Microsoft_FStar_Absyn_Syntax.res_typ)
in (Microsoft_FStar_Absyn_Util.mk_eq c1.Microsoft_FStar_Absyn_Syntax.res_typ c1.Microsoft_FStar_Absyn_Syntax.res_typ _68_16782 e1))
in (Support.Prims.pipe_left (fun ( _68_16781 ) -> Microsoft_FStar_Tc_Rel.NonTrivial (_68_16781)) _68_16783))
in (Microsoft_FStar_Tc_Rel.guard_of_guard_formula _68_16784))
in (Microsoft_FStar_Tc_Rel.imp_guard _68_16785 g2))
in (Support.Prims.pipe_left _68_16787 _68_16786)))
in (let guard = (let _68_16788 = (Microsoft_FStar_Tc_Rel.conj_guard g1 g2)
in (Microsoft_FStar_Tc_Rel.conj_guard guard_f _68_16788))
in (match (topt) with
| None -> begin
...
in (let _36_1995 = (let _68_16789 = (Microsoft_FStar_Tc_Rel.teq env tres t)
in (Support.Prims.pipe_left (Microsoft_FStar_Tc_Rel.try_discharge_guard env) _68_16789))
in (e, cres, guard)))
end
| false -> begin
(e, cres, guard)
...
| true -> begin
(let _68_16793 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
...
| false -> begin
(let _68_16794 = (tc_typ_check_trivial (let _36_2048 = env0
...
in (Support.Prims.pipe_right _68_16794 (norm_t env)))
end)
end)
...
| (lbs, env') -> begin
(let _36_2071 = (let _68_16800 = (let _68_16799 = (Support.Prims.pipe_right lbs Support.List.rev)
in (Support.Prims.pipe_right _68_16799 (Support.List.map (fun ( _36_2060 ) -> (match (_36_2060) with
| (x, t, e) -> begin
...
| true -> begin
(let _68_16798 = (Microsoft_FStar_Absyn_Print.lbname_to_string x)
in (let _68_16797 = (Microsoft_FStar_Absyn_Print.exp_to_string e)
in (let _68_16796 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.fprint3 "Checking %s = %s against type %s\n" _68_16798 _68_16797 _68_16796))))
end
| false -> begin
()
end)
...
in (Support.Prims.pipe_right _68_16800 Support.List.unzip))
...
| true -> begin
(let _68_16802 = (Support.List.map (fun ( _36_2076 ) -> (match (_36_2076) with
| (x, t, e) -> begin
...
in (let ecs = (let _68_16806 = (Support.Prims.pipe_right lbs (Support.List.map (fun ( _36_2082 ) -> (match (_36_2082) with
| (x, t, e) -> begin
(let _68_16805 = (let _68_16804 = (Microsoft_FStar_Absyn_Util.range_of_lb (x, t, e))
in (Support.Prims.pipe_left (Microsoft_FStar_Absyn_Util.total_comp t) _68_16804))
in (x, e, _68_16805))
end))))
in (Microsoft_FStar_Tc_Util.generalize true env _68_16806))
in (let _68_16808 = (Support.List.map (fun ( _36_2087 ) -> (match (_36_2087) with
| (x, e, c) -> begin
...
in (_68_16808, Microsoft_FStar_Tc_Rel.trivial_guard))))
end)
in (match (_36_2090) with
| (lbs, g_lbs) -> begin
(match ((not (is_inner_let))) with
| true -> begin
(let cres = (let _68_16809 = (Microsoft_FStar_Absyn_Util.total_comp Microsoft_FStar_Tc_Recheck.t_unit top.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Prims.pipe_left Microsoft_FStar_Tc_Util.lcomp_of_comp _68_16809))
...
in (let _68_16813 = (let _68_16812 = (w cres)
in (Support.Prims.pipe_left _68_16812 (Microsoft_FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))))
in (_68_16813, cres, Microsoft_FStar_Tc_Rel.trivial_guard)))))
end
| false -> begin
...
in (let e = (let _68_16818 = (w cres)
in (Support.Prims.pipe_left _68_16818 (Microsoft_FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))))
in (match (topt) with
| Some (_) -> begin
(e, cres, guard)
end
...
(let t' = (Microsoft_FStar_Tc_Util.new_tvar env0 Microsoft_FStar_Absyn_Syntax.ktype)
in (let _36_2158 = (let _68_16820 = (Microsoft_FStar_Tc_Rel.teq env tres t')
...
(let _68_16833 = (Microsoft_FStar_Absyn_Print.strBvd x)
in (let _68_16832 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env t)
...
| true -> begin
(let _68_16836 = (Microsoft_FStar_Absyn_Print.exp_to_string e)
in (let _68_16835 = (Microsoft_FStar_Absyn_Print.typ_to_string pat_t)
...
| true -> begin
(let _68_16838 = (Microsoft_FStar_Tc_Normalize.exp_norm_to_string env e)
in (let _68_16837 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env lc.Microsoft_FStar_Absyn_Syntax.res_typ)
...
in (let _36_2206 = (let _68_16839 = (Microsoft_FStar_Tc_Rel.solve_deferred_constraints env g)
in (Support.Prims.pipe_left Support.Prims.ignore _68_16839))
in (let e' = (Microsoft_FStar_Tc_Normalize.norm_exp ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env e)
in (let _36_2209 = (match ((let _68_16842 = (let _68_16841 = (Microsoft_FStar_Absyn_Util.uvars_in_exp e')
in (let _68_16840 = (Microsoft_FStar_Absyn_Util.uvars_in_typ expected_pat_t)
in (Microsoft_FStar_Absyn_Util.uvars_included_in _68_16841 _68_16840)))
in (Support.Prims.pipe_left Support.Prims.op_Negation _68_16842))) with
| true -> begin
(let _68_16847 = (let _68_16846 = (let _68_16845 = (let _68_16844 = (Microsoft_FStar_Absyn_Print.exp_to_string e')
in (let _68_16843 = (Microsoft_FStar_Absyn_Print.typ_to_string expected_pat_t)
in (Support.Microsoft.FStar.Util.format2 "Implicit pattern variables in %s could not be resolved against expected type %s; please bind them explicitly" _68_16844 _68_16843)))
in (_68_16845, p.Microsoft_FStar_Absyn_Syntax.p))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16846))
in (raise (_68_16847)))
end
| false -> begin
()
...
| true -> begin
(let _68_16848 = (Microsoft_FStar_Tc_Normalize.exp_norm_to_string env e)
...
| Microsoft_FStar_Tc_Env.Binding_var ((x, t)) -> begin
(let _68_16851 = (Microsoft_FStar_Absyn_Print.strBvd x)
in (let _68_16850 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
...
| false -> begin
(let _36_2236 = (let _68_16852 = (Microsoft_FStar_Tc_Env.set_expected_typ pat_env Microsoft_FStar_Tc_Recheck.t_bool)
in (tc_exp _68_16852 e))
...
| Some (w) -> begin
(let _68_16854 = (Microsoft_FStar_Absyn_Util.mk_eq Microsoft_FStar_Absyn_Util.t_bool Microsoft_FStar_Absyn_Util.t_bool w Microsoft_FStar_Absyn_Const.exp_true_bool)
in (Support.Prims.pipe_left (fun ( _68_16853 ) -> Some (_68_16853)) _68_16854))
end)
...
in (let _36_2252 = (let _68_16855 = (Microsoft_FStar_Tc_Env.push_local_binding env (Microsoft_FStar_Tc_Env.Binding_var ((scrutinee_x, pat_t))))
in (Support.Prims.pipe_right _68_16855 Microsoft_FStar_Tc_Env.clear_expected_typ))
...
| _ -> begin
(let clause = (let _68_16859 = (Microsoft_FStar_Tc_Recheck.recompute_typ scrutinee)
in (let _68_16858 = (Microsoft_FStar_Tc_Recheck.recompute_typ e)
in (Microsoft_FStar_Absyn_Util.mk_eq _68_16859 _68_16858 scrutinee e)))
in (match (fopt) with
| None -> begin
Some (clause)
end
| Some (f) -> begin
(let _68_16861 = (Microsoft_FStar_Absyn_Util.mk_disj clause f)
in (Support.Prims.pipe_left (fun ( _68_16860 ) -> Some (_68_16860)) _68_16861))
end))
end))) None))
...
| (Some (f), Some (w)) -> begin
(let _68_16864 = (let _68_16863 = (Microsoft_FStar_Absyn_Util.mk_conj f w)
in (Support.Prims.pipe_left (fun ( _68_16862 ) -> Microsoft_FStar_Tc_Rel.NonTrivial (_68_16862)) _68_16863))
in (Microsoft_FStar_Tc_Util.weaken_precondition env c _68_16864))
end
| (None, Some (w)) -> begin
...
in (let discriminate = (fun ( scrutinee ) ( f ) -> (let disc = (let _68_16871 = (let _68_16869 = (Microsoft_FStar_Absyn_Util.mk_discriminator f.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Util.fvar None _68_16869))
in (let _68_16870 = (Microsoft_FStar_Absyn_Syntax.range_of_lid f.Microsoft_FStar_Absyn_Syntax.v)
in (Support.Prims.pipe_left _68_16871 _68_16870)))
in (let disc = (let _68_16874 = (let _68_16873 = (let _68_16872 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.varg scrutinee)
in (_68_16872)::[])
in (disc, _68_16873))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _68_16874 None scrutinee.Microsoft_FStar_Absyn_Syntax.pos))
...
(let _68_16883 = (let _68_16882 = (let _68_16881 = (Microsoft_FStar_Absyn_Syntax.varg scrutinee)
in (let _68_16880 = (let _68_16879 = (Microsoft_FStar_Absyn_Syntax.varg pat_exp)
in (_68_16879)::[])
in (_68_16881)::_68_16880))
in (Microsoft_FStar_Absyn_Util.teq, _68_16882))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _68_16883 None scrutinee.Microsoft_FStar_Absyn_Syntax.pos))
end
...
in (let sub_term_guards = (let _68_16891 = (Support.Prims.pipe_right args (Support.List.mapi (fun ( i ) ( arg ) -> (match ((Support.Prims.fst arg)) with
...
in (let sub_term = (let _68_16889 = (let _68_16888 = (Microsoft_FStar_Absyn_Util.fvar None projector f.Microsoft_FStar_Absyn_Syntax.p)
in (let _68_16887 = (let _68_16886 = (Microsoft_FStar_Absyn_Syntax.varg scrutinee)
in (_68_16886)::[])
in (_68_16888, _68_16887)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _68_16889 None f.Microsoft_FStar_Absyn_Syntax.p))
in (let _68_16890 = (mk_guard sub_term ei)
in (_68_16890)::[])))
end))))
in (Support.Prims.pipe_right _68_16891 Support.List.flatten))
in (Microsoft_FStar_Absyn_Util.mk_conj_l ((head)::sub_term_guards))))
end
| _ -> begin
(let _68_16894 = (let _68_16893 = (Support.Microsoft.FStar.Range.string_of_range pat_exp.Microsoft_FStar_Absyn_Syntax.pos)
in (let _68_16892 = (Microsoft_FStar_Absyn_Print.exp_to_string pat_exp)
in (Support.Microsoft.FStar.Util.format2 "tc_eqn: Impossible (%s) %s" _68_16893 _68_16892)))
in (failwith (_68_16894)))
end)))
...
in (let path_guard = (let _68_16903 = (Support.Prims.pipe_right disj_exps (Support.List.map (fun ( e ) -> (let _68_16902 = (Microsoft_FStar_Tc_Normalize.norm_exp ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env e)
in (mk_guard scrutinee pat_t _68_16902)))))
in (Support.Prims.pipe_right _68_16903 Microsoft_FStar_Absyn_Util.mk_disj_l))
...
in (let guard = (let _68_16904 = (Microsoft_FStar_Tc_Rel.conj_guard g_when g_branch)
in (Microsoft_FStar_Tc_Rel.conj_guard g_pat _68_16904))
in (let _36_2377 = (match ((Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High)) with
| true -> begin
(let _68_16905 = (Microsoft_FStar_Tc_Rel.guard_to_string env guard)
in (Support.Prims.pipe_left (Support.Microsoft.FStar.Util.fprint1 "Carrying guard from match: %s\n") _68_16905))
end
| false -> begin
()
end)
in (let _68_16907 = (let _68_16906 = (Microsoft_FStar_Tc_Rel.conj_guard g_when g_branch)
in (Microsoft_FStar_Tc_Rel.conj_guard g_pat _68_16906))
in ((pattern, when_clause, branch), path_guard, c, _68_16907))))))))))
end)))
end)))
end))
end)))
...
in (let c = (let _68_16917 = (c.Microsoft_FStar_Absyn_Syntax.comp ())
in (Support.Prims.pipe_right _68_16917 (norm_c env)))
in (match ((let _68_16919 = (let _68_16918 = (Microsoft_FStar_Tc_Env.get_range env)
in (Microsoft_FStar_Absyn_Util.total_comp (Microsoft_FStar_Absyn_Util.comp_result c) _68_16918))
in (Microsoft_FStar_Tc_Rel.sub_comp env c _68_16919))) with
| Some (g') -> begin
(let _68_16920 = (Microsoft_FStar_Tc_Rel.conj_guard g g')
in (e, (Microsoft_FStar_Absyn_Util.comp_result c), _68_16920))
end
| _ -> begin
(let _68_16923 = (let _68_16922 = (let _68_16921 = (Microsoft_FStar_Tc_Errors.expected_pure_expression e c)
in (_68_16921, e.Microsoft_FStar_Absyn_Syntax.pos))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16922))
in (raise (_68_16923)))
end)))
end)
end)))
...
| false -> begin
(let c = (let _68_16926 = (c.Microsoft_FStar_Absyn_Syntax.comp ())
in (Support.Prims.pipe_right _68_16926 (norm_c env)))
...
| Some (g') -> begin
(let _68_16927 = (Microsoft_FStar_Tc_Rel.conj_guard g g')
in (e, (Microsoft_FStar_Absyn_Util.comp_result c), _68_16927))
end
| _ -> begin
(let _68_16930 = (let _68_16929 = (let _68_16928 = (Microsoft_FStar_Tc_Errors.expected_ghost_expression e c)
in (_68_16928, e.Microsoft_FStar_Absyn_Syntax.pos))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16929))
in (raise (_68_16930)))
end))))
end)
end)))
...
| _ -> begin
(let _68_16944 = (let _68_16943 = (let _68_16942 = (Microsoft_FStar_Tc_Errors.unexpected_signature_for_monad env m s)
in (let _68_16941 = (Microsoft_FStar_Absyn_Syntax.range_of_lid m)
in (_68_16942, _68_16941)))
in Microsoft_FStar_Absyn_Syntax.Error (_68_16943))
in (raise (_68_16944)))
end))
...
in (let b = (let _68_16958 = (Microsoft_FStar_Absyn_Syntax.range_of_lid m.Microsoft_FStar_Absyn_Syntax.mname)
in (Microsoft_FStar_Absyn_Util.gen_bvar_p _68_16958 Microsoft_FStar_Absyn_Syntax.ktype))
...
in (let kwlp_a = kwp_a
in (let kwlp_b = kwp_b
in (let a_kwp_b = (let _68_16961 = (let _68_16960 = (let _68_16959 = (Microsoft_FStar_Absyn_Syntax.null_v_binder a_typ)
in (_68_16959)::[])
in (_68_16960, kwp_b))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_16961 a_typ.Microsoft_FStar_Absyn_Syntax.pos))
in (let a_kwlp_b = a_kwp_b
in (let w = (fun ( k ) -> (let _68_16969 = (Microsoft_FStar_Absyn_Syntax.range_of_lid m.Microsoft_FStar_Absyn_Syntax.mname)
in (k _68_16969)))
in (let ret = (let expected_k = (let _68_16976 = (let _68_16975 = (let _68_16974 = (let _68_16973 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_16972 = (let _68_16971 = (Microsoft_FStar_Absyn_Syntax.null_v_binder a_typ)
in (_68_16971)::[])
in (_68_16973)::_68_16972))
in (_68_16974, kwp_a))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_16975))
in (Support.Prims.pipe_left w _68_16976))
in (let _68_16977 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.ret expected_k)
in (Support.Prims.pipe_right _68_16977 (norm_t env))))
in (let bind_wp = (let expected_k = (let _68_16992 = (let _68_16991 = (let _68_16990 = (let _68_16989 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_16988 = (let _68_16987 = (Microsoft_FStar_Absyn_Syntax.t_binder b)
in (let _68_16986 = (let _68_16985 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwp_a)
in (let _68_16984 = (let _68_16983 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (let _68_16982 = (let _68_16981 = (Microsoft_FStar_Absyn_Syntax.null_t_binder a_kwp_b)
in (let _68_16980 = (let _68_16979 = (Microsoft_FStar_Absyn_Syntax.null_t_binder a_kwlp_b)
in (_68_16979)::[])
in (_68_16981)::_68_16980))
in (_68_16983)::_68_16982))
in (_68_16985)::_68_16984))
in (_68_16987)::_68_16986))
in (_68_16989)::_68_16988))
in (_68_16990, kwp_b))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_16991))
in (Support.Prims.pipe_left w _68_16992))
in (let _68_16993 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.bind_wp expected_k)
in (Support.Prims.pipe_right _68_16993 (norm_t env))))
in (let bind_wlp = (let expected_k = (let _68_17004 = (let _68_17003 = (let _68_17002 = (let _68_17001 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17000 = (let _68_16999 = (Microsoft_FStar_Absyn_Syntax.t_binder b)
in (let _68_16998 = (let _68_16997 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (let _68_16996 = (let _68_16995 = (Microsoft_FStar_Absyn_Syntax.null_t_binder a_kwlp_b)
in (_68_16995)::[])
in (_68_16997)::_68_16996))
in (_68_16999)::_68_16998))
in (_68_17001)::_68_17000))
in (_68_17002, kwlp_b))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17003))
in (Support.Prims.pipe_left w _68_17004))
in (let _68_17005 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.bind_wlp expected_k)
in (Support.Prims.pipe_right _68_17005 (norm_t env))))
in (let if_then_else = (let expected_k = (let _68_17016 = (let _68_17015 = (let _68_17014 = (let _68_17013 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17012 = (let _68_17011 = (Microsoft_FStar_Absyn_Syntax.t_binder b)
in (let _68_17010 = (let _68_17009 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwp_a)
in (let _68_17008 = (let _68_17007 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_68_17007)::[])
in (_68_17009)::_68_17008))
in (_68_17011)::_68_17010))
in (_68_17013)::_68_17012))
in (_68_17014, kwp_a))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17015))
in (Support.Prims.pipe_left w _68_17016))
in (let _68_17017 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.if_then_else expected_k)
in (Support.Prims.pipe_right _68_17017 (norm_t env))))
in (let ite_wp = (let expected_k = (let _68_17026 = (let _68_17025 = (let _68_17024 = (let _68_17023 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17022 = (let _68_17021 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (let _68_17020 = (let _68_17019 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_68_17019)::[])
in (_68_17021)::_68_17020))
in (_68_17023)::_68_17022))
in (_68_17024, kwp_a))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17025))
in (Support.Prims.pipe_left w _68_17026))
in (let _68_17027 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.ite_wp expected_k)
in (Support.Prims.pipe_right _68_17027 (norm_t env))))
in (let ite_wlp = (let expected_k = (let _68_17034 = (let _68_17033 = (let _68_17032 = (let _68_17031 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17030 = (let _68_17029 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (_68_17029)::[])
in (_68_17031)::_68_17030))
in (_68_17032, kwlp_a))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17033))
in (Support.Prims.pipe_left w _68_17034))
in (let _68_17035 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.ite_wlp expected_k)
in (Support.Prims.pipe_right _68_17035 (norm_t env))))
in (let wp_binop = (let expected_k = (let _68_17047 = (let _68_17046 = (let _68_17045 = (let _68_17044 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17043 = (let _68_17042 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwp_a)
in (let _68_17041 = (let _68_17040 = (let _68_17037 = (Microsoft_FStar_Absyn_Const.kbin Microsoft_FStar_Absyn_Syntax.ktype Microsoft_FStar_Absyn_Syntax.ktype Microsoft_FStar_Absyn_Syntax.ktype)
in (Microsoft_FStar_Absyn_Syntax.null_t_binder _68_17037))
...
in (let _68_17048 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.wp_binop expected_k)
in (Support.Prims.pipe_right _68_17048 (norm_t env))))
in (let wp_as_type = (let expected_k = (let _68_17055 = (let _68_17054 = (let _68_17053 = (let _68_17052 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17051 = (let _68_17050 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_68_17050)::[])
in (_68_17052)::_68_17051))
in (_68_17053, Microsoft_FStar_Absyn_Syntax.ktype))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17054))
in (Support.Prims.pipe_left w _68_17055))
in (let _68_17056 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.wp_as_type expected_k)
in (Support.Prims.pipe_right _68_17056 (norm_t env))))
in (let close_wp = (let expected_k = (let _68_17065 = (let _68_17064 = (let _68_17063 = (let _68_17062 = (Microsoft_FStar_Absyn_Syntax.t_binder b)
in (let _68_17061 = (let _68_17060 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17059 = (let _68_17058 = (Microsoft_FStar_Absyn_Syntax.null_t_binder a_kwp_b)
in (_68_17058)::[])
in (_68_17060)::_68_17059))
in (_68_17062)::_68_17061))
in (_68_17063, kwp_b))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17064))
in (Support.Prims.pipe_left w _68_17065))
in (let _68_17066 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.close_wp expected_k)
in (Support.Prims.pipe_right _68_17066 (norm_t env))))
in (let close_wp_t = (let expected_k = (let _68_17079 = (let _68_17078 = (let _68_17077 = (let _68_17076 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17075 = (let _68_17074 = (let _68_17073 = (let _68_17072 = (let _68_17071 = (let _68_17070 = (let _68_17069 = (Microsoft_FStar_Absyn_Syntax.null_t_binder Microsoft_FStar_Absyn_Syntax.ktype)
in (_68_17069)::[])
in (_68_17070, kwp_a))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17071))
in (Support.Prims.pipe_left w _68_17072))
in (Microsoft_FStar_Absyn_Syntax.null_t_binder _68_17073))
in (_68_17074)::[])
in (_68_17076)::_68_17075))
in (_68_17077, kwp_a))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17078))
in (Support.Prims.pipe_left w _68_17079))
in (let _68_17080 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.close_wp_t expected_k)
in (Support.Prims.pipe_right _68_17080 (norm_t env))))
in (let _36_2508 = (let expected_k = (let _68_17089 = (let _68_17088 = (let _68_17087 = (let _68_17086 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17085 = (let _68_17084 = (Microsoft_FStar_Absyn_Syntax.null_t_binder Microsoft_FStar_Absyn_Syntax.ktype)
in (let _68_17083 = (let _68_17082 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_68_17082)::[])
in (_68_17084)::_68_17083))
in (_68_17086)::_68_17085))
in (_68_17087, kwp_a))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17088))
in (Support.Prims.pipe_left w _68_17089))
in (let _68_17093 = (let _68_17090 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.assert_p expected_k)
in (Support.Prims.pipe_right _68_17090 (norm_t env)))
in (let _68_17092 = (let _68_17091 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.assume_p expected_k)
in (Support.Prims.pipe_right _68_17091 (norm_t env)))
in (_68_17093, _68_17092))))
in (match (_36_2508) with
| (assert_p, assume_p) -> begin
(let null_wp = (let expected_k = (let _68_17098 = (let _68_17097 = (let _68_17096 = (let _68_17095 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (_68_17095)::[])
in (_68_17096, kwp_a))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17097))
in (Support.Prims.pipe_left w _68_17098))
in (let _68_17099 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.null_wp expected_k)
in (Support.Prims.pipe_right _68_17099 (norm_t env))))
in (let trivial_wp = (let expected_k = (let _68_17106 = (let _68_17105 = (let _68_17104 = (let _68_17103 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17102 = (let _68_17101 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_68_17101)::[])
in (_68_17103)::_68_17102))
in (_68_17104, Microsoft_FStar_Absyn_Syntax.ktype))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17105))
in (Support.Prims.pipe_left w _68_17106))
in (let _68_17107 = (tc_typ_check_trivial env m.Microsoft_FStar_Absyn_Syntax.trivial expected_k)
in (Support.Prims.pipe_right _68_17107 (norm_t env))))
...
in (let _36_2529 = (let _68_17111 = (Microsoft_FStar_Options.reset_options ())
in (Support.Prims.pipe_right _68_17111 Support.Prims.ignore))
in (se, env)))
end)
end
...
(let _36_2544 = (let _68_17112 = (Microsoft_FStar_Tc_Env.lookup_effect_lid env sub.Microsoft_FStar_Absyn_Syntax.source)
in (a_kwp_a env sub.Microsoft_FStar_Absyn_Syntax.source _68_17112))
in (match (_36_2544) with
| (a, kwp_a_src) -> begin
(let _36_2547 = (let _68_17113 = (Microsoft_FStar_Tc_Env.lookup_effect_lid env sub.Microsoft_FStar_Absyn_Syntax.target)
in (a_kwp_a env sub.Microsoft_FStar_Absyn_Syntax.target _68_17113))
in (match (_36_2547) with
| (b, kwp_b_tgt) -> begin
(let kwp_a_tgt = (let _68_17117 = (let _68_17116 = (let _68_17115 = (let _68_17114 = (Microsoft_FStar_Absyn_Util.btvar_to_typ a)
in (b.Microsoft_FStar_Absyn_Syntax.v, _68_17114))
in Support.Microsoft.FStar.Util.Inl (_68_17115))
in (_68_17116)::[])
in (Microsoft_FStar_Absyn_Util.subst_kind _68_17117 kwp_b_tgt))
in (let expected_k = (let _68_17123 = (let _68_17122 = (let _68_17121 = (let _68_17120 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (let _68_17119 = (let _68_17118 = (Microsoft_FStar_Absyn_Syntax.null_t_binder kwp_a_src)
in (_68_17118)::[])
in (_68_17120)::_68_17119))
in (_68_17121, kwp_a_tgt))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_17122))
in (Support.Prims.pipe_right r _68_17123))
...
| true -> begin
(let _68_17126 = (Microsoft_FStar_Absyn_Print.sli lid)
in (let _68_17125 = (let _68_17124 = (Microsoft_FStar_Absyn_Util.close_kind tps k)
in (Microsoft_FStar_Absyn_Print.kind_to_string _68_17124))
...
(let _68_17127 = (Microsoft_FStar_Tc_Rel.keq env None k Microsoft_FStar_Absyn_Syntax.ktype)
in (Support.Prims.pipe_left (Microsoft_FStar_Tc_Util.force_trivial env) _68_17127))
end
| _ -> begin
()
end)
...
in (let _68_17130 = (Support.Prims.pipe_right c'.Microsoft_FStar_Absyn_Syntax.effect_name (fun ( _68_17129 ) -> Some (_68_17129)))
in Microsoft_FStar_Absyn_Syntax.DefaultEffect (_68_17130)))
end
| t -> begin
t
end))))
...
| (tps, env') -> begin
(let _36_2648 = (let _68_17134 = (tc_typ_trivial env' t)
in (Support.Prims.pipe_right _68_17134 (fun ( _36_2645 ) -> (match (_36_2645) with
| (t, k) -> begin
(let _68_17133 = (norm_t env' t)
in (let _68_17132 = (norm_k env' k)
in (_68_17133, _68_17132)))
end))))
...
| _ -> begin
(let k2 = (let _68_17135 = (tc_kind_trivial env' k)
in (Support.Prims.pipe_right _68_17135 (norm_k env)))
in (let _36_2653 = (let _68_17136 = (Microsoft_FStar_Tc_Rel.keq env' (Some (t)) k1 k2)
in (Support.Prims.pipe_left (Microsoft_FStar_Tc_Util.force_trivial env') _68_17136))
in k2))
end)
...
| true -> begin
(let _36_2695 = (let _68_17139 = (Microsoft_FStar_Absyn_Util.function_formals t)
in (Support.Prims.pipe_right _68_17139 Support.Microsoft.FStar.Util.must))
...
in (Microsoft_FStar_Absyn_Visit.collect_from_typ (fun ( b ) ( t ) -> (match ((let _68_17143 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _68_17143.Microsoft_FStar_Absyn_Syntax.n)) with
...
| Some (tname) -> begin
(let _68_17149 = (let _68_17148 = (let _68_17147 = (let _68_17145 = (let _68_17144 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar (Some (Microsoft_FStar_Absyn_Syntax.Data_ctor)) lid _68_17144))
in (Microsoft_FStar_Tc_Errors.constructor_fails_the_positivity_check env _68_17145 tname))
in (let _68_17146 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (_68_17147, _68_17146)))
in Microsoft_FStar_Absyn_Syntax.Error (_68_17148))
in (raise (_68_17149)))
end)
end
| _ -> begin
...
| _ -> begin
(let _68_17156 = (let _68_17155 = (let _68_17154 = (let _68_17152 = (let _68_17150 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (Microsoft_FStar_Absyn_Util.fvar (Some (Microsoft_FStar_Absyn_Syntax.Data_ctor)) lid _68_17150))
in (let _68_17151 = (Microsoft_FStar_Absyn_Util.ftv tname Microsoft_FStar_Absyn_Syntax.kun)
in (Microsoft_FStar_Tc_Errors.constructor_builds_the_wrong_type env _68_17152 result_t _68_17151)))
in (let _68_17153 = (Microsoft_FStar_Absyn_Syntax.range_of_lid lid)
in (_68_17154, _68_17153)))
in Microsoft_FStar_Absyn_Syntax.Error (_68_17155))
in (raise (_68_17156)))
end)
...
| true -> begin
(let _68_17158 = (let _68_17157 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env t)
in (Support.Microsoft.FStar.Util.format2 "data %s : %s\n" lid.Microsoft_FStar_Absyn_Syntax.str _68_17157))
in (Support.Prims.pipe_left Support.Microsoft.FStar.Util.print_string _68_17158))
end
| false -> begin
()
end)
...
(let env = (Microsoft_FStar_Tc_Env.set_range env r)
in (let t = (let _68_17159 = (tc_typ_check_trivial env t Microsoft_FStar_Absyn_Syntax.ktype)
in (Support.Prims.pipe_right _68_17159 (Microsoft_FStar_Tc_Normalize.norm_typ ((Microsoft_FStar_Tc_Normalize.Beta)::(Microsoft_FStar_Tc_Normalize.SNComp)::[]) env)))
...
(let env = (Microsoft_FStar_Tc_Env.set_range env r)
in (let phi = (let _68_17162 = (tc_typ_check_trivial env phi Microsoft_FStar_Absyn_Syntax.ktype)
in (Support.Prims.pipe_right _68_17162 (norm_t env)))
...
| true -> begin
(let _68_17165 = (Microsoft_FStar_Absyn_Print.typ_to_string t')
in (Support.Microsoft.FStar.Util.fprint2 "Using annotation %s for let binding %s\n" _68_17165 l.Microsoft_FStar_Absyn_Syntax.str))
end
| false -> begin
()
end)
in (match (t.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_unknown -> begin
(let _68_17166 = (Microsoft_FStar_Absyn_Syntax.mk_lb (Support.Microsoft.FStar.Util.Inr (l), Microsoft_FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _68_17166))
end
| _ -> begin
(let _36_2793 = (match ((not (deserialized))) with
| true -> begin
(let _68_17168 = (let _68_17167 = (Support.Microsoft.FStar.Range.string_of_range r)
in (Support.Microsoft.FStar.Util.format1 "%s: Warning: Annotation from val declaration overrides inline type annotation\n" _68_17167))
in (Support.Prims.pipe_left Support.Microsoft.FStar.Util.print_string _68_17168))
end
| false -> begin
()
end)
in (let _68_17169 = (Microsoft_FStar_Absyn_Syntax.mk_lb (Support.Microsoft.FStar.Util.Inr (l), Microsoft_FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _68_17169)))
end))
end)
...
in (let e = (let _68_17174 = (let _68_17173 = (let _68_17172 = (syn' env Microsoft_FStar_Tc_Recheck.t_unit)
in (Support.Prims.pipe_left _68_17172 (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant Microsoft_FStar_Absyn_Syntax.Const_unit)))
in (((Support.Prims.fst lbs), lbs'), _68_17173))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_let _68_17174 None r))
...
| true -> begin
(let _68_17180 = (let _68_17179 = (Support.Prims.pipe_right (Support.Prims.snd lbs) (Support.List.map (fun ( lb ) -> (let should_log = (match ((let _68_17176 = (Support.Microsoft.FStar.Util.right lb.Microsoft_FStar_Absyn_Syntax.lbname)
in (Microsoft_FStar_Tc_Env.try_lookup_val_decl env _68_17176))) with
| None -> begin
true
end
| _ -> begin
...
| true -> begin
(let _68_17178 = (Microsoft_FStar_Absyn_Print.lbname_to_string lb.Microsoft_FStar_Absyn_Syntax.lbname)
in (let _68_17177 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env lb.Microsoft_FStar_Absyn_Syntax.lbtyp)
in (Support.Microsoft.FStar.Util.format2 "let %s : %s" _68_17178 _68_17177)))
end
| false -> begin
""
end)))))
in (Support.Prims.pipe_right _68_17179 (Support.String.concat "\n")))
...
in (let _36_2862 = (let _68_17184 = (let _68_17181 = (Microsoft_FStar_Absyn_Util.ml_comp Microsoft_FStar_Tc_Recheck.t_unit r)
in Some (_68_17181))
in (let _68_17183 = (let _68_17182 = (c.Microsoft_FStar_Absyn_Syntax.comp ())
in (e, _68_17182))
in (check_expected_effect env _68_17184 _68_17183)))
in (match (_36_2862) with
| (e, _, g) -> begin
(let _36_2863 = (let _68_17185 = (Microsoft_FStar_Tc_Rel.conj_guard g1 g)
in (Microsoft_FStar_Tc_Util.discharge_guard env _68_17185))
...
(let k = (match (k.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Kind_unknown -> begin
(let _68_17189 = (Microsoft_FStar_Tc_Rel.new_kvar r tps)
in (Support.Prims.pipe_right _68_17189 Support.Prims.fst))
end
| _ -> begin
k
end)
...
| true -> begin
(let _68_17190 = (Microsoft_FStar_Absyn_Print.sigelt_to_string_short se)
in (Support.Microsoft.FStar.Util.format1 "Recursive bindings: %s" _68_17190))
end
| false -> begin
""
end)
...
(let tt = (let _68_17193 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_ascribed (t, k) t.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Absyn_Util.close_with_lam tps _68_17193))
...
| (tps, t) -> begin
(let _68_17195 = (let _68_17194 = (Microsoft_FStar_Absyn_Util.compress_kind k)
in (lid, tps, _68_17194, t, [], r))
in Microsoft_FStar_Absyn_Syntax.Sig_typ_abbrev (_68_17195))
end))
end)))
end
| _ -> begin
(let _68_17197 = (let _68_17196 = (Support.Microsoft.FStar.Range.string_of_range r)
in (Support.Microsoft.FStar.Util.format1 "(%s) Impossible" _68_17196))
in (failwith (_68_17197)))
...
| true -> begin
(let _68_17205 = (let _68_17204 = (Microsoft_FStar_Absyn_Print.sigelt_to_string se)
in (Support.Microsoft.FStar.Util.format1 "Checking sigelt\t%s\n" _68_17204))
in (Support.Microsoft.FStar.Util.print_string _68_17205))
end
| false -> begin
()
end)
...
| (ses, all_non_private, env) -> begin
(let _68_17206 = (Support.Prims.pipe_right (Support.List.rev all_non_private) Support.List.flatten)
in ((Support.List.rev ses), _68_17206, env))
end)))
...
| true -> begin
(match ((Support.Prims.pipe_right lbs (Support.Microsoft.FStar.Util.for_some (fun ( x ) -> (let _68_17216 = (is_priv x)
in (Support.Prims.pipe_right _68_17216 Support.Prims.op_Negation)))))) with
| true -> begin
...
in (let _36_3093 = (Support.Prims.pipe_right (Support.Prims.snd lbs) (Support.List.partition (fun ( lb ) -> ((Microsoft_FStar_Absyn_Util.is_pure_or_ghost_function lb.Microsoft_FStar_Absyn_Syntax.lbtyp) && (let _68_17218 = (Microsoft_FStar_Absyn_Util.is_lemma lb.Microsoft_FStar_Absyn_Syntax.lbtyp)
in (Support.Prims.pipe_left Support.Prims.op_Negation _68_17218))))))
...
(let _68_17222 = (let _68_17221 = (let _68_17220 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (l, lb.Microsoft_FStar_Absyn_Syntax.lbtyp, (Microsoft_FStar_Absyn_Syntax.Assumption)::[], _68_17220))
in Microsoft_FStar_Absyn_Syntax.Sig_val_decl (_68_17221))
in (_68_17222)::[])
end))))
end)
end
...
| false -> begin
(let exports = (let _68_17234 = (Microsoft_FStar_Tc_Env.modules env)
in (Support.Microsoft.FStar.Util.find_map _68_17234 (fun ( m ) -> (match ((m.Microsoft_FStar_Absyn_Syntax.is_interface && (Microsoft_FStar_Absyn_Syntax.lid_equals modul.Microsoft_FStar_Absyn_Syntax.name m.Microsoft_FStar_Absyn_Syntax.name))) with
| true -> begin
(let _68_17233 = (Support.Prims.pipe_right m.Microsoft_FStar_Absyn_Syntax.exports assume_vals)
in Some (_68_17233))
end
| false -> begin
None
...
in (let _36_3182 = (match (((not (modul.Microsoft_FStar_Absyn_Syntax.is_interface)) || (let _68_17252 = (Support.ST.read Microsoft_FStar_Options.admit_fsi)
in (Support.List.contains modul.Microsoft_FStar_Absyn_Syntax.name.Microsoft_FStar_Absyn_Syntax.str _68_17252)))) with
| true -> begin
...
in (let _68_17253 = (Microsoft_FStar_Options.reset_options ())
in (Support.Prims.pipe_right _68_17253 Support.Prims.ignore)))))
end
| false -> begin
()
end)
...
in (let _68_17266 = (Support.List.fold_left do_sigelt en m.Microsoft_FStar_Absyn_Syntax.exports)
in (Microsoft_FStar_Tc_Env.finish_module _68_17266 m)))))

let check_module = (fun ( env ) ( m ) -> (let _36_3205 = (match (((let _68_17271 = (Support.ST.read Microsoft_FStar_Options.debug)
in (Support.List.length _68_17271)) <> 0)) with
| true -> begin
(let _68_17272 = (Microsoft_FStar_Absyn_Print.sli m.Microsoft_FStar_Absyn_Syntax.name)
...
| true -> begin
(let c_file_name = (let _68_17278 = (let _68_17277 = (let _68_17275 = (let _68_17274 = (let _68_17273 = (Microsoft_FStar_Options.get_fstar_home ())
in (Support.String.strcat _68_17273 "/"))
in (Support.String.strcat _68_17274 Microsoft_FStar_Options.cache_dir))
in (Support.String.strcat _68_17275 "/"))
in (let _68_17276 = (Microsoft_FStar_Absyn_Syntax.text_of_lid m.Microsoft_FStar_Absyn_Syntax.name)
in (Support.String.strcat _68_17277 _68_17276)))
in (Support.String.strcat _68_17278 ".cache"))
in (let _36_3212 = (let _68_17281 = (let _68_17280 = (let _68_17279 = (Microsoft_FStar_Absyn_Syntax.text_of_lid m.Microsoft_FStar_Absyn_Syntax.name)
in (Support.String.strcat "Serializing module " _68_17279))
in (Support.String.strcat _68_17280 "\n"))
in (Support.Microsoft.FStar.Util.print_string _68_17281))
in (let _68_17282 = (Support.Microsoft.FStar.Util.get_owriter c_file_name)
in (Microsoft_FStar_Absyn_SSyntax.serialize_modul _68_17282 m))))
end
| false -> begin
()
end)
...
| true -> begin
(let _68_17283 = (Microsoft_FStar_Absyn_Print.modul_to_string m)
in (Support.Microsoft.FStar.Util.fprint1 "%s\n" _68_17283))
end
| false -> begin
()
