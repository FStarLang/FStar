...
in (match (((Support.Microsoft.FStar.Util.find_opt (fun ( _31_539 ) -> (match (_31_539) with
| (b, _) -> begin
(match (b) with
| Support.Microsoft.FStar.Util.Inl (a) -> begin
...
(let _31_1201 = if ((Support.List.length bs') <> (Support.List.length actuals)) then begin
...
(let _31_1326 = (as_function_typ norm b.Microsoft_FStar_Absyn_Syntax.sort)
in (match (_31_1326) with
...
(let _31_1337 = (expected_function_typ env None)
in (match (_31_1337) with
...
in (let _31_1341 = (Microsoft_FStar_Tc_Env.clear_expected_typ env)
in (match (_31_1341) with
| (env, topt) -> begin
(let _31_1348 = (expected_function_typ env topt)
in (match (_31_1348) with
| (tfun_opt, bs, letrec_binders, c_opt, envbody, g) -> begin
(let _31_1354 = (tc_exp (let _31_1349 = envbody
in {Microsoft_FStar_Tc_Env.solver = _31_1349.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_1349.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_1349.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_1349.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_1349.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_1349.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_1349.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_1349.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = _31_1349.Microsoft_FStar_Tc_Env.is_pattern; Microsoft_FStar_Tc_Env.instantiate_targs = _31_1349.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_1349.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_1349.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = _31_1349.Microsoft_FStar_Tc_Env.generalize; Microsoft_FStar_Tc_Env.letrecs = _31_1349.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = false; Microsoft_FStar_Tc_Env.check_uvars = _31_1349.Microsoft_FStar_Tc_Env.check_uvars; Microsoft_FStar_Tc_Env.use_eq = use_eq; Microsoft_FStar_Tc_Env.is_iface = _31_1349.Microsoft_FStar_Tc_Env.is_iface; Microsoft_FStar_Tc_Env.admit = _31_1349.Microsoft_FStar_Tc_Env.admit; Microsoft_FStar_Tc_Env.default_effects = _31_1349.Microsoft_FStar_Tc_Env.default_effects}) body)
in (match (_31_1354) with
| (body, cbody, guard_body) -> begin
(let _31_1355 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Medium) then begin
...
in (let _31_1358 = if ((Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Implicits"))) then begin
...
in (let _31_1365 = (check_expected_effect (let _31_1360 = envbody
in {Microsoft_FStar_Tc_Env.solver = _31_1360.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_1360.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_1360.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_1360.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_1360.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_1360.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_1360.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_1360.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = _31_1360.Microsoft_FStar_Tc_Env.is_pattern; Microsoft_FStar_Tc_Env.instantiate_targs = _31_1360.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_1360.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_1360.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = _31_1360.Microsoft_FStar_Tc_Env.generalize; Microsoft_FStar_Tc_Env.letrecs = _31_1360.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = _31_1360.Microsoft_FStar_Tc_Env.top_level; Microsoft_FStar_Tc_Env.check_uvars = _31_1360.Microsoft_FStar_Tc_Env.check_uvars; Microsoft_FStar_Tc_Env.use_eq = use_eq; Microsoft_FStar_Tc_Env.is_iface = _31_1360.Microsoft_FStar_Tc_Env.is_iface; Microsoft_FStar_Tc_Env.admit = _31_1360.Microsoft_FStar_Tc_Env.admit; Microsoft_FStar_Tc_Env.default_effects = _31_1360.Microsoft_FStar_Tc_Env.default_effects}) c_opt (body, (cbody.Microsoft_FStar_Absyn_Syntax.comp ())))
in (match (_31_1365) with
...
(let _31_1367 = (Microsoft_FStar_Tc_Util.discharge_guard envbody (Microsoft_FStar_Tc_Rel.conj_guard g guard))
in (let _31_1369 = Microsoft_FStar_Tc_Rel.trivial_guard
in {Microsoft_FStar_Tc_Rel.guard_f = _31_1369.Microsoft_FStar_Tc_Rel.guard_f; Microsoft_FStar_Tc_Rel.deferred = _31_1369.Microsoft_FStar_Tc_Rel.deferred; Microsoft_FStar_Tc_Rel.implicits = guard.Microsoft_FStar_Tc_Rel.implicits}))
end else begin
...
in (let e = (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed ((Microsoft_FStar_Absyn_Syntax.mk_Exp_abs (bs, body) (Some (tfun_computed)) top.Microsoft_FStar_Absyn_Syntax.pos), tfun_computed, Some (Microsoft_FStar_Absyn_Const.effect_Tot_lid)) None top.Microsoft_FStar_Absyn_Syntax.pos)
in (let _31_1392 = (match (tfun_opt) with
| Some ((t, use_teq)) -> begin
(let t = (Microsoft_FStar_Absyn_Util.compress_typ t)
in (match (t.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_fun (_) -> begin
((Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed ((Microsoft_FStar_Absyn_Syntax.mk_Exp_abs (bs, body) (Some (t)) e.Microsoft_FStar_Absyn_Syntax.pos), t, Some (Microsoft_FStar_Absyn_Const.effect_Tot_lid)) None top.Microsoft_FStar_Absyn_Syntax.pos), t, guard)
end
| _ -> begin
(let _31_1387 = if use_teq then begin
(e, (Microsoft_FStar_Tc_Rel.teq env t tfun_computed))
end else begin
(Microsoft_FStar_Tc_Util.check_and_ascribe env e tfun_computed t)
end
in (match (_31_1387) with
| (e, guard') -> begin
((Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed (e, t, Some (Microsoft_FStar_Absyn_Const.effect_Tot_lid)) None top.Microsoft_FStar_Absyn_Syntax.pos), t, (Microsoft_FStar_Tc_Rel.conj_guard guard guard'))
end))
end))
end
| None -> begin
...
in (match (_31_1392) with
| (e, tfun, guard) -> begin
(let _31_1393 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low) then begin
...
in (let _31_1398 = (Microsoft_FStar_Tc_Util.strengthen_precondition None env e (Microsoft_FStar_Tc_Util.lcomp_of_comp c) guard)
in (match (_31_1398) with
| (c, g) -> begin
(e, c, g)
end))))
end))))))
...
in (let _31_1404 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low) then begin
...
(let _31_1435 = (tc_typ_check env t1 Microsoft_FStar_Absyn_Syntax.ktype)
in (match (_31_1435) with
| (t1, f) -> begin
(let _31_1439 = (tc_exp (Microsoft_FStar_Tc_Env.set_expected_typ env t1) e1)
in (match (_31_1439) with
| (e1, c, g) -> begin
(let _31_1443 = (Microsoft_FStar_Tc_Util.strengthen_precondition (Some ((fun ( _31_1440 ) -> (match (_31_1440) with
| () -> begin
...
in (match (_31_1443) with
| (c, f) -> begin
(let _31_1447 = (comp_check_expected_typ env ((w c) (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed (e1, t1, Some (c.Microsoft_FStar_Absyn_Syntax.eff_name)))) c)
...
(let _31_1470 = (tc_exp (Microsoft_FStar_Tc_Env.set_expected_typ env Microsoft_FStar_Tc_Recheck.t_unit) e1)
in (match (_31_1470) with
| (e1, c1, g1) -> begin
(let _31_1474 = (tc_exp env e2)
in (match (_31_1474) with
| (e2, c2, g2) -> begin
...
| _ -> begin
(let _31_1481 = (tc_exp env e)
in (match (_31_1481) with
| (e, c, g) -> begin
...
in (let _31_1497 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High) then begin
...
in (let _31_1502 = (tc_exp (no_inst env) head)
in (match (_31_1502) with
| (head, chead, g_head) -> begin
(let aux = (fun ( _31_1504 ) -> (match (_31_1504) with
| () -> begin
...
(let _31_1526 = (tc_exp env e1)
in (match (_31_1526) with
| (e1, c1, g1) -> begin
(let _31_1530 = (tc_exp env e2)
in (match (_31_1530) with
| (e2, c2, g2) -> begin
...
in (let _31_1541 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High) then begin
...
(let _31_1586 = (tc_exp env e)
in (match (_31_1586) with
| (e, c, g_e) -> begin
(let _31_1590 = (tc_args env tl)
in (match (_31_1590) with
| (args, comps, g_rest) -> begin
(((Support.Microsoft.FStar.Util.Inr (e), imp))::args, (c)::comps, (Microsoft_FStar_Tc_Rel.conj_guard g_e g_rest))
end))
end))
end))
in (let _31_1594 = (tc_args env args)
in (match (_31_1594) with
...
in (let _31_1597 = ((Microsoft_FStar_Tc_Util.force_trivial env) (Microsoft_FStar_Tc_Rel.teq env tf (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (bs, cres) (Some (Microsoft_FStar_Absyn_Syntax.ktype)) tf.Microsoft_FStar_Absyn_Syntax.pos)))
...
in (let rec tc_args = (fun ( _31_1614 ) ( bs ) ( cres ) ( args ) -> (match (_31_1614) with
...
in (let _31_1634 = (fxv_check head env (Support.Microsoft.FStar.Util.Inl (k)) fvs)
in (let _31_1638 = (Microsoft_FStar_Tc_Rel.new_tvar (Microsoft_FStar_Absyn_Util.range_of_arg (Support.List.hd args)) vars k)
in (match (_31_1638) with
| (targ, u) -> begin
(let _31_1639 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Extreme) then begin
...
in (let _31_1659 = (fxv_check head env (Support.Microsoft.FStar.Util.Inr (t)) fvs)
in (let _31_1663 = (Microsoft_FStar_Tc_Util.new_implicit_evar env t)
in (match (_31_1663) with
| (varg, u) -> begin
...
(let _31_1679 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Extreme) then begin
...
in (let _31_1682 = (fxv_check head env (Support.Microsoft.FStar.Util.Inl (k)) fvs)
in (let _31_1688 = (tc_typ_check (let _31_1684 = env
in {Microsoft_FStar_Tc_Env.solver = _31_1684.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_1684.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_1684.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_1684.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_1684.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_1684.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_1684.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_1684.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = _31_1684.Microsoft_FStar_Tc_Env.is_pattern; Microsoft_FStar_Tc_Env.instantiate_targs = _31_1684.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_1684.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_1684.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = _31_1684.Microsoft_FStar_Tc_Env.generalize; Microsoft_FStar_Tc_Env.letrecs = _31_1684.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = _31_1684.Microsoft_FStar_Tc_Env.top_level; Microsoft_FStar_Tc_Env.check_uvars = _31_1684.Microsoft_FStar_Tc_Env.check_uvars; Microsoft_FStar_Tc_Env.use_eq = (is_eq aqual); Microsoft_FStar_Tc_Env.is_iface = _31_1684.Microsoft_FStar_Tc_Env.is_iface; Microsoft_FStar_Tc_Env.admit = _31_1684.Microsoft_FStar_Tc_Env.admit; Microsoft_FStar_Tc_Env.default_effects = _31_1684.Microsoft_FStar_Tc_Env.default_effects}) t k)
in (match (_31_1688) with
| (t, g') -> begin
...
in (let g' = (let _31_1690 = g'
in {Microsoft_FStar_Tc_Rel.guard_f = f; Microsoft_FStar_Tc_Rel.deferred = _31_1690.Microsoft_FStar_Tc_Rel.deferred; Microsoft_FStar_Tc_Rel.implicits = _31_1690.Microsoft_FStar_Tc_Rel.implicits})
...
(let _31_1708 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Extreme) then begin
...
in (let _31_1711 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Extreme) then begin
(Support.Microsoft.FStar.Util.fprint1 "\tType of arg (after subst) = %s\n" (Microsoft_FStar_Absyn_Print.typ_to_string targ))
end
in (let _31_1713 = (fxv_check head env (Support.Microsoft.FStar.Util.Inr (targ)) fvs)
in (let env = (Microsoft_FStar_Tc_Env.set_expected_typ env targ)
in (let env = (let _31_1716 = env
in {Microsoft_FStar_Tc_Env.solver = _31_1716.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_1716.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_1716.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_1716.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_1716.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_1716.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_1716.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_1716.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = _31_1716.Microsoft_FStar_Tc_Env.is_pattern; Microsoft_FStar_Tc_Env.instantiate_targs = _31_1716.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_1716.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_1716.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = _31_1716.Microsoft_FStar_Tc_Env.generalize; Microsoft_FStar_Tc_Env.letrecs = _31_1716.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = _31_1716.Microsoft_FStar_Tc_Env.top_level; Microsoft_FStar_Tc_Env.check_uvars = _31_1716.Microsoft_FStar_Tc_Env.check_uvars; Microsoft_FStar_Tc_Env.use_eq = (is_eq aqual); Microsoft_FStar_Tc_Env.is_iface = _31_1716.Microsoft_FStar_Tc_Env.is_iface; Microsoft_FStar_Tc_Env.admit = _31_1716.Microsoft_FStar_Tc_Env.admit; Microsoft_FStar_Tc_Env.default_effects = _31_1716.Microsoft_FStar_Tc_Env.default_effects})
in (let _31_1719 = if (((Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("EQ"))) && env.Microsoft_FStar_Tc_Env.use_eq) then begin
...
in (let _31_1721 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High) then begin
...
in (let _31_1726 = (tc_exp env e)
in (match (_31_1726) with
| (e, c, g_e) -> begin
(let g = (Microsoft_FStar_Tc_Rel.conj_guard g g_e)
in (let _31_1728 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High) then begin
...
(let subst = (maybe_extend_subst subst (Support.List.hd bs) arg)
in (let _31_1735 = (((Some (Microsoft_FStar_Tc_Env.Binding_var ((x.Microsoft_FStar_Absyn_Syntax.v, targ))), c))::comps, g)
in (match (_31_1735) with
| (comps, guard) -> begin
...
| (_, []) -> begin
(let _31_1781 = (fxv_check head env (Support.Microsoft.FStar.Util.Inr (cres.Microsoft_FStar_Absyn_Syntax.res_typ)) fvs)
in (let _31_1799 = (match (bs) with
| [] -> begin
(let cres = (Microsoft_FStar_Tc_Util.subst_lcomp subst cres)
in (let g = (Microsoft_FStar_Tc_Rel.conj_guard g_head g)
in (let refine_with_equality = ((Microsoft_FStar_Absyn_Util.is_pure_or_ghost_lcomp cres) && ((Support.Microsoft.FStar.Util.for_some (fun ( _31_1789 ) -> (match (_31_1789) with
| (_, c) -> begin
...
(let _31_1791 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low) then begin
...
in (match (_31_1799) with
| (cres, g) -> begin
(let _31_1800 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low) then begin
...
in (let _31_1809 = (Microsoft_FStar_Tc_Util.strengthen_precondition None env app comp g)
in (match (_31_1809) with
| (comp, g) -> begin
(let _31_1810 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low) then begin
...
(let _31_1826 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low) then begin
...
in (let _31_1837 = (aux ())
in (match (_31_1837) with
| (e, c, g) -> begin
(let _31_1838 = if ((Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Implicits"))) then begin
...
in (let _31_1845 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Extreme) then begin
...
in (let _31_1850 = (comp_check_expected_typ env0 e c)
...
(let _31_1857 = (Microsoft_FStar_Tc_Env.clear_expected_typ env)
in (match (_31_1857) with
| (env1, topt) -> begin
(let env1 = (instantiate_both env1)
in (let _31_1862 = (tc_exp env1 e1)
in (match (_31_1862) with
| (e1, c1, g1) -> begin
(let _31_1869 = (match (topt) with
| Some (t) -> begin
(env, t)
end
| None -> begin
...
in (let _31_1886 = (let _31_1883 = (Support.List.fold_right (fun ( _31_1877 ) ( _31_1880 ) -> (match ((_31_1877, _31_1880)) with
...
in (match (_31_1883) with
| (cases, g) -> begin
((Microsoft_FStar_Tc_Util.bind_cases env res_t cases), g)
end))
in (match (_31_1886) with
| (c_branches, g_branches) -> begin
(let _31_1887 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Extreme) then begin
...
in (let e = ((w cres) (Microsoft_FStar_Absyn_Syntax.mk_Exp_match (e1, (Support.List.map (fun ( _31_1897 ) -> (match (_31_1897) with
| (f, _, _, _) -> begin
f
end)) t_eqns))))
in ((Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed (e, cres.Microsoft_FStar_Absyn_Syntax.res_typ, Some (cres.Microsoft_FStar_Absyn_Syntax.eff_name)) None e.Microsoft_FStar_Absyn_Syntax.pos), cres, (Microsoft_FStar_Tc_Rel.conj_guard g1 g_branches)))))
end))))
end))
end)))
end))
...
in (let _31_1923 = (Microsoft_FStar_Tc_Env.clear_expected_typ env)
in (match (_31_1923) with
| (env1, _) -> begin
(let _31_1936 = (match (t.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_unknown -> begin
...
(let _31_1929 = (tc_typ_check env1 t Microsoft_FStar_Absyn_Syntax.ktype)
in (match (_31_1929) with
| (t, f) -> begin
(let _31_1930 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Medium) then begin
...
in (match (_31_1936) with
| (f, env1) -> begin
(let _31_1942 = (tc_exp (let _31_1937 = env1
in {Microsoft_FStar_Tc_Env.solver = _31_1937.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_1937.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_1937.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_1937.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_1937.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_1937.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_1937.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_1937.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = _31_1937.Microsoft_FStar_Tc_Env.is_pattern; Microsoft_FStar_Tc_Env.instantiate_targs = _31_1937.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_1937.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_1937.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = _31_1937.Microsoft_FStar_Tc_Env.generalize; Microsoft_FStar_Tc_Env.letrecs = _31_1937.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = top_level; Microsoft_FStar_Tc_Env.check_uvars = _31_1937.Microsoft_FStar_Tc_Env.check_uvars; Microsoft_FStar_Tc_Env.use_eq = _31_1937.Microsoft_FStar_Tc_Env.use_eq; Microsoft_FStar_Tc_Env.is_iface = _31_1937.Microsoft_FStar_Tc_Env.is_iface; Microsoft_FStar_Tc_Env.admit = _31_1937.Microsoft_FStar_Tc_Env.admit; Microsoft_FStar_Tc_Env.default_effects = _31_1937.Microsoft_FStar_Tc_Env.default_effects}) e1)
in (match (_31_1942) with
| (e1, c1, g1) -> begin
(let _31_1946 = (Microsoft_FStar_Tc_Util.strengthen_precondition (Some ((fun ( _31_1943 ) -> (match (_31_1943) with
| () -> begin
Microsoft_FStar_Tc_Errors.ill_kinded_type
end)))) (Microsoft_FStar_Tc_Env.set_range env t.Microsoft_FStar_Absyn_Syntax.pos) e1 c1 f)
in (match (_31_1946) with
| (c1, guard_f) -> begin
(match (x) with
| Support.Microsoft.FStar.Util.Inr (_) -> begin
(let _31_1959 = if (Microsoft_FStar_Options.should_verify env.Microsoft_FStar_Tc_Env.curmodule.Microsoft_FStar_Absyn_Syntax.str) then begin
(let _31_1952 = (Microsoft_FStar_Tc_Util.check_top_level env (Microsoft_FStar_Tc_Rel.conj_guard g1 guard_f) c1)
in (match (_31_1952) with
| (ok, c1) -> begin
if ok then begin
(e2, c1)
end else begin
(let _31_1953 = if (! (Microsoft_FStar_Options.warn_top_level_effects)) then begin
...
(let _31_1955 = (Microsoft_FStar_Tc_Util.discharge_guard env (Microsoft_FStar_Tc_Rel.conj_guard g1 guard_f))
in (e2, (c1.Microsoft_FStar_Absyn_Syntax.comp ())))
end
in (match (_31_1959) with
| (e2, c1) -> begin
(let _31_1964 = if env.Microsoft_FStar_Tc_Env.generalize then begin
((Support.List.hd) (Microsoft_FStar_Tc_Util.generalize false env1 (((x, e1, c1))::[])))
end else begin
(x, e1, c1)
end
in (match (_31_1964) with
| (_, e1, c1) -> begin
...
in (let _31_1967 = (Support.ST.op_Colon_Equals e2.Microsoft_FStar_Absyn_Syntax.tk (Some (Microsoft_FStar_Tc_Recheck.t_unit)))
...
in (let _31_1975 = (tc_exp (Microsoft_FStar_Tc_Env.push_local_binding env b) e2)
in (match (_31_1975) with
| (e2, c2, g2) -> begin
...
in (let _31_1984 = ((Microsoft_FStar_Tc_Rel.try_discharge_guard env) (Microsoft_FStar_Tc_Rel.teq env tres t))
in (e, cres, guard)))
end else begin
(e, cres, guard)
end))
...
(let env = (instantiate_both env)
in (let _31_2005 = (Microsoft_FStar_Tc_Env.clear_expected_typ env)
...
in (let _31_2045 = ((Support.List.fold_left (fun ( _31_2022 ) ( _31_2028 ) -> (match ((_31_2022, _31_2028)) with
...
(let _31_2033 = (Microsoft_FStar_Tc_Util.extract_lb_annotation env t e)
...
(let _31_2035 = if ((Microsoft_FStar_Tc_Env.debug env) Microsoft_FStar_Options.High) then begin
(Support.Microsoft.FStar.Util.fprint1 "Type %s is marked as no-generalize\n" (Microsoft_FStar_Absyn_Print.typ_to_string t))
end
in t)
end else begin
((norm_t env) (tc_typ_check_trivial (let _31_2037 = env0
in {Microsoft_FStar_Tc_Env.solver = _31_2037.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_2037.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_2037.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_2037.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_2037.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_2037.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_2037.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_2037.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = _31_2037.Microsoft_FStar_Tc_Env.is_pattern; Microsoft_FStar_Tc_Env.instantiate_targs = _31_2037.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_2037.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_2037.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = _31_2037.Microsoft_FStar_Tc_Env.generalize; Microsoft_FStar_Tc_Env.letrecs = _31_2037.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = _31_2037.Microsoft_FStar_Tc_Env.top_level; Microsoft_FStar_Tc_Env.check_uvars = true; Microsoft_FStar_Tc_Env.use_eq = _31_2037.Microsoft_FStar_Tc_Env.use_eq; Microsoft_FStar_Tc_Env.is_iface = _31_2037.Microsoft_FStar_Tc_Env.is_iface; Microsoft_FStar_Tc_Env.admit = _31_2037.Microsoft_FStar_Tc_Env.admit; Microsoft_FStar_Tc_Env.default_effects = _31_2037.Microsoft_FStar_Tc_Env.default_effects}) t Microsoft_FStar_Absyn_Syntax.ktype))
end
end
...
(let _31_2040 = env
in {Microsoft_FStar_Tc_Env.solver = _31_2040.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_2040.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_2040.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_2040.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_2040.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_2040.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_2040.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_2040.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = _31_2040.Microsoft_FStar_Tc_Env.is_pattern; Microsoft_FStar_Tc_Env.instantiate_targs = _31_2040.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_2040.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_2040.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = _31_2040.Microsoft_FStar_Tc_Env.generalize; Microsoft_FStar_Tc_Env.letrecs = ((x, t))::env.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = _31_2040.Microsoft_FStar_Tc_Env.top_level; Microsoft_FStar_Tc_Env.check_uvars = _31_2040.Microsoft_FStar_Tc_Env.check_uvars; Microsoft_FStar_Tc_Env.use_eq = _31_2040.Microsoft_FStar_Tc_Env.use_eq; Microsoft_FStar_Tc_Env.is_iface = _31_2040.Microsoft_FStar_Tc_Env.is_iface; Microsoft_FStar_Tc_Env.admit = _31_2040.Microsoft_FStar_Tc_Env.admit; Microsoft_FStar_Tc_Env.default_effects = _31_2040.Microsoft_FStar_Tc_Env.default_effects})
end else begin
(Microsoft_FStar_Tc_Env.push_local_binding env (binding_of_lb x t))
end
in (((x, t, e))::xts, env))))
...
| (lbs, env') -> begin
(let _31_2060 = ((Support.List.unzip) ((Support.List.map (fun ( _31_2049 ) -> (match (_31_2049) with
| (x, t, e) -> begin
(let t = (Microsoft_FStar_Tc_Normalize.norm_typ ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env t)
in (let _31_2051 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High) then begin
...
in (let _31_2057 = (tc_total_exp env' e)
in (match (_31_2057) with
| (e, t, g) -> begin
((x, t, e), g)
end)))))
end))) ((Support.List.rev) lbs)))
in (match (_31_2060) with
| (lbs, gs) -> begin
(let g_lbs = (Support.List.fold_right Microsoft_FStar_Tc_Rel.conj_guard gs Microsoft_FStar_Tc_Rel.trivial_guard)
in (let _31_2079 = if ((not (env.Microsoft_FStar_Tc_Env.generalize)) || is_inner_let) then begin
((Support.List.map (fun ( _31_2065 ) -> (match (_31_2065) with
| (x, t, e) -> begin
(Microsoft_FStar_Absyn_Syntax.mk_lb (x, Microsoft_FStar_Absyn_Const.effect_Tot_lid, t, e))
end)) lbs), g_lbs)
end else begin
(let _31_2066 = (Microsoft_FStar_Tc_Util.discharge_guard env g_lbs)
in (let ecs = (Microsoft_FStar_Tc_Util.generalize true env ((Support.List.map (fun ( _31_2071 ) -> (match (_31_2071) with
| (x, t, e) -> begin
(x, e, ((Microsoft_FStar_Absyn_Util.total_comp t) (Microsoft_FStar_Absyn_Util.range_of_lb (x, t, e))))
end))) lbs))
in ((Support.List.map (fun ( _31_2076 ) -> (match (_31_2076) with
| (x, e, c) -> begin
...
in (let _31_2081 = (Microsoft_FStar_Tc_Util.discharge_guard env g_lbs)
in (let _31_2083 = (Support.ST.op_Colon_Equals e1.Microsoft_FStar_Absyn_Syntax.tk (Some (Microsoft_FStar_Tc_Recheck.t_unit)))
in (((w cres) (Microsoft_FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))), cres, Microsoft_FStar_Tc_Rel.trivial_guard))))
end else begin
(let _31_2099 = ((Support.List.fold_left (fun ( _31_2087 ) ( _31_2094 ) -> (match ((_31_2087, _31_2094)) with
...
in (match (_31_2099) with
| (bindings, env) -> begin
(let _31_2103 = (tc_exp env e1)
in (match (_31_2103) with
| (e1, cres, g1) -> begin
...
in (let cres = (let _31_2107 = cres
in {Microsoft_FStar_Absyn_Syntax.eff_name = _31_2107.Microsoft_FStar_Absyn_Syntax.eff_name; Microsoft_FStar_Absyn_Syntax.res_typ = tres; Microsoft_FStar_Absyn_Syntax.cflags = _31_2107.Microsoft_FStar_Absyn_Syntax.cflags; Microsoft_FStar_Absyn_Syntax.comp = _31_2107.Microsoft_FStar_Absyn_Syntax.comp})
...
(let t' = (Microsoft_FStar_Tc_Util.new_tvar env0 Microsoft_FStar_Absyn_Syntax.ktype)
in (let _31_2147 = ((Microsoft_FStar_Tc_Rel.try_discharge_guard env) (Microsoft_FStar_Tc_Rel.teq env tres t'))
in (e, cres, guard)))
end
| _ -> begin
(e, cres, guard)
...
and tc_eqn = (fun ( scrutinee_x ) ( pat_t ) ( env ) ( _31_2157 ) -> (match (_31_2157) with
| (pattern, when_clause, branch) -> begin
(let tc_pat = (fun ( allow_implicits ) ( pat_t ) ( p0 ) -> (let _31_2165 = (Microsoft_FStar_Tc_Util.pat_as_exps allow_implicits env p0)
in (match (_31_2165) with
| (bindings, exps, p) -> begin
(let pat_env = (Support.List.fold_left Microsoft_FStar_Tc_Env.push_local_binding env bindings)
in (let _31_2174 = if ((Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Pat"))) then begin
...
in (let _31_2179 = (Microsoft_FStar_Tc_Env.clear_expected_typ pat_env)
in (match (_31_2179) with
| (env1, _) -> begin
(let env1 = (let _31_2180 = env1
in {Microsoft_FStar_Tc_Env.solver = _31_2180.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_2180.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_2180.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_2180.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_2180.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_2180.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_2180.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_2180.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = true; Microsoft_FStar_Tc_Env.instantiate_targs = _31_2180.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_2180.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_2180.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = _31_2180.Microsoft_FStar_Tc_Env.generalize; Microsoft_FStar_Tc_Env.letrecs = _31_2180.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = _31_2180.Microsoft_FStar_Tc_Env.top_level; Microsoft_FStar_Tc_Env.check_uvars = _31_2180.Microsoft_FStar_Tc_Env.check_uvars; Microsoft_FStar_Tc_Env.use_eq = _31_2180.Microsoft_FStar_Tc_Env.use_eq; Microsoft_FStar_Tc_Env.is_iface = _31_2180.Microsoft_FStar_Tc_Env.is_iface; Microsoft_FStar_Tc_Env.admit = _31_2180.Microsoft_FStar_Tc_Env.admit; Microsoft_FStar_Tc_Env.default_effects = _31_2180.Microsoft_FStar_Tc_Env.default_effects})
in (let expected_pat_t = (Microsoft_FStar_Tc_Rel.unrefine env pat_t)
in (let exps = ((Support.List.map (fun ( e ) -> (let _31_2185 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High) then begin
...
in (let _31_2190 = (tc_exp env1 e)
in (match (_31_2190) with
| (e, lc, g) -> begin
(let _31_2191 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High) then begin
...
in (let _31_2195 = ((Support.Prims.ignore) (Microsoft_FStar_Tc_Rel.solve_deferred_constraints env g))
in (let e' = (Microsoft_FStar_Tc_Normalize.norm_exp ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env e)
in (let _31_2198 = if (not ((Microsoft_FStar_Absyn_Util.uvars_included_in (Microsoft_FStar_Absyn_Util.uvars_in_exp e') (Microsoft_FStar_Absyn_Util.uvars_in_typ expected_pat_t)))) then begin
...
in (let _31_2200 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High) then begin
...
in (let _31_2211 = if ((Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Pat"))) then begin
...
in (let _31_2218 = (tc_pat true pat_t pattern)
in (match (_31_2218) with
| (pattern, bindings, pat_env, disj_exps, g_pat) -> begin
(let _31_2228 = (match (when_clause) with
| None -> begin
...
(let _31_2225 = (tc_exp (Microsoft_FStar_Tc_Env.set_expected_typ pat_env Microsoft_FStar_Tc_Recheck.t_bool) e)
in (match (_31_2225) with
| (e, c, g) -> begin
(Some (e), g)
end))
end
end)
in (match (_31_2228) with
...
in (let _31_2236 = (tc_exp pat_env branch)
in (match (_31_2236) with
| (branch, c, g_branch) -> begin
(let scrutinee = (Microsoft_FStar_Absyn_Util.bvd_to_exp scrutinee_x pat_t)
in (let _31_2241 = (Microsoft_FStar_Tc_Env.clear_expected_typ (Microsoft_FStar_Tc_Env.push_local_binding env (Microsoft_FStar_Tc_Env.Binding_var ((scrutinee_x, pat_t)))))
in (match (_31_2241) with
...
in (let _31_2358 = (tc_typ_check scrutinee_env t Microsoft_FStar_Absyn_Syntax.mk_Kind_type)
in (match (_31_2358) with
| (t, _) -> begin
t
end)))
end)
...
in (let _31_2366 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.High) then begin
...
and tc_kind_trivial = (fun ( env ) ( k ) -> (let _31_2372 = (tc_kind env k)
in (match (_31_2372) with
| (k, g) -> begin
(let _31_2373 = (Microsoft_FStar_Tc_Util.discharge_guard env g)
in k)
end)))
and tc_typ_trivial = (fun ( env ) ( t ) -> (let _31_2380 = (tc_typ env t)
in (match (_31_2380) with
| (t, k, g) -> begin
(let _31_2381 = (Microsoft_FStar_Tc_Util.discharge_guard env g)
in (t, k))
end)))
and tc_typ_check_trivial = (fun ( env ) ( t ) ( k ) -> (let _31_2388 = (tc_typ_check env t k)
in (match (_31_2388) with
| (t, f) -> begin
(let _31_2389 = (Microsoft_FStar_Tc_Util.discharge_guard env f)
in t)
end)))
and tc_total_exp = (fun ( env ) ( e ) -> (let _31_2396 = (tc_exp env e)
...
and tc_ghost_exp = (fun ( env ) ( e ) -> (let _31_2408 = (tc_exp env e)
in (match (_31_2408) with
| (e, c, g) -> begin
if (Microsoft_FStar_Absyn_Util.is_total_lcomp c) then begin
(e, c.Microsoft_FStar_Absyn_Syntax.res_typ, g)
end else begin
...
in (match ((Microsoft_FStar_Tc_Rel.sub_comp (let _31_2412 = env
in {Microsoft_FStar_Tc_Env.solver = _31_2412.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_2412.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_2412.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_2412.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_2412.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_2412.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_2412.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_2412.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = _31_2412.Microsoft_FStar_Tc_Env.is_pattern; Microsoft_FStar_Tc_Env.instantiate_targs = _31_2412.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_2412.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_2412.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = _31_2412.Microsoft_FStar_Tc_Env.generalize; Microsoft_FStar_Tc_Env.letrecs = _31_2412.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = _31_2412.Microsoft_FStar_Tc_Env.top_level; Microsoft_FStar_Tc_Env.check_uvars = _31_2412.Microsoft_FStar_Tc_Env.check_uvars; Microsoft_FStar_Tc_Env.use_eq = false; Microsoft_FStar_Tc_Env.is_iface = _31_2412.Microsoft_FStar_Tc_Env.is_iface; Microsoft_FStar_Tc_Env.admit = _31_2412.Microsoft_FStar_Tc_Env.admit; Microsoft_FStar_Tc_Env.default_effects = _31_2412.Microsoft_FStar_Tc_Env.default_effects}) c expected_c)) with
| Some (g') -> begin
(e, (Microsoft_FStar_Absyn_Util.comp_result c), (Microsoft_FStar_Tc_Rel.conj_guard g g'))
end
| _ -> begin
...
let tc_tparams = (fun ( env ) ( tps ) -> (let _31_2423 = (tc_binders env tps)
in (match (_31_2423) with
| (tps, env, g) -> begin
(let _31_2424 = (Microsoft_FStar_Tc_Util.force_trivial env g)
in (tps, env))
end)))
...
let rec tc_eff_decl = (fun ( env ) ( m ) -> (let _31_2457 = (tc_binders env m.Microsoft_FStar_Absyn_Syntax.binders)
in (match (_31_2457) with
| (binders, env, g) -> begin
(let _31_2458 = (Microsoft_FStar_Tc_Util.discharge_guard env g)
in (let mk = (tc_kind_trivial env m.Microsoft_FStar_Absyn_Syntax.signature)
in (let _31_2463 = (a_kwp_a env m.Microsoft_FStar_Absyn_Syntax.mname mk)
...
in (let _31_2497 = (let expected_k = (w (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (((Microsoft_FStar_Absyn_Syntax.t_binder a))::((Microsoft_FStar_Absyn_Syntax.null_t_binder Microsoft_FStar_Absyn_Syntax.ktype))::((Microsoft_FStar_Absyn_Syntax.null_t_binder kwp_a))::[], kwp_a)))
...
(let _31_2516 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.refresh ())
in (let _31_2518 = ((Support.Prims.ignore) (Microsoft_FStar_Options.reset_options ()))
in (se, env)))
end)
end
...
(let _31_2533 = (a_kwp_a env sub.Microsoft_FStar_Absyn_Syntax.source (Microsoft_FStar_Tc_Env.lookup_effect_lid env sub.Microsoft_FStar_Absyn_Syntax.source))
in (match (_31_2533) with
| (a, kwp_a_src) -> begin
(let _31_2536 = (a_kwp_a env sub.Microsoft_FStar_Absyn_Syntax.target (Microsoft_FStar_Tc_Env.lookup_effect_lid env sub.Microsoft_FStar_Absyn_Syntax.target))
in (match (_31_2536) with
| (b, kwp_b_tgt) -> begin
...
in (let sub = (let _31_2540 = sub
in {Microsoft_FStar_Absyn_Syntax.source = _31_2540.Microsoft_FStar_Absyn_Syntax.source; Microsoft_FStar_Absyn_Syntax.target = _31_2540.Microsoft_FStar_Absyn_Syntax.target; Microsoft_FStar_Absyn_Syntax.lift = lift})
...
in (let _31_2557 = (tc_tparams env tps)
in (match (_31_2557) with
| (tps, env) -> begin
...
in (let _31_2562 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Extreme) then begin
...
in (let _31_2580 = (match ((Microsoft_FStar_Absyn_Util.compress_kind k)) with
...
in (let _31_2593 = (tc_tparams env tps)
in (match (_31_2593) with
| (tps, env) -> begin
...
(let env0 = env
in (let env = (Microsoft_FStar_Tc_Env.set_range env r)
in (let _31_2608 = (tc_tparams env tps)
in (match (_31_2608) with
| (tps, env) -> begin
(let _31_2611 = (tc_comp env c)
...
(let env = (Microsoft_FStar_Tc_Env.set_range env r)
in (let _31_2631 = (tc_tparams env tps)
in (match (_31_2631) with
| (tps, env') -> begin
(let _31_2637 = ((fun ( _31_2634 ) -> (match (_31_2634) with
| (t, k) -> begin
((norm_t env' t), (norm_k env' k))
end)) (tc_typ_trivial env' t))
in (match (_31_2637) with
| (t, k1) -> begin
...
in (let _31_2642 = ((Microsoft_FStar_Tc_Util.force_trivial env') (Microsoft_FStar_Tc_Rel.keq env' (Some (t)) k1 k2))
in k2))
end)
...
in (let _31_2672 = (match ((Microsoft_FStar_Absyn_Util.function_formals t)) with
...
(let _31_2684 = ((Support.Microsoft.FStar.Util.must) (Microsoft_FStar_Absyn_Util.function_formals t))
in (match (_31_2684) with
| (formals, _) -> begin
((Support.List.iter (fun ( _31_2688 ) -> (match (_31_2688) with
| (a, _) -> begin
(match (a) with
| Support.Microsoft.FStar.Util.Inl (_) -> begin
()
...
in (let _31_2704 = ((Support.List.iter positivity_check) formals)
in (let _31_2711 = (match ((Microsoft_FStar_Absyn_Util.destruct result_t tname)) with
| Some (_) -> begin
()
end
| _ -> begin
...
in (let env = (Microsoft_FStar_Tc_Env.push_sigelt env se)
in (let _31_2715 = if (log env) then begin
...
in (let _31_2725 = (Microsoft_FStar_Tc_Util.check_uvars r t)
in (let se = Microsoft_FStar_Absyn_Syntax.Sig_val_decl ((lid, t, quals, r))
in (let env = (Microsoft_FStar_Tc_Env.push_sigelt env se)
in (let _31_2729 = if (log env) then begin
...
in (let _31_2739 = (Microsoft_FStar_Tc_Util.check_uvars r phi)
...
(let env = (Microsoft_FStar_Tc_Env.set_range env r)
in (let _31_2792 = ((Support.List.fold_left (fun ( _31_2752 ) ( lb ) -> (match (_31_2752) with
| (gen, lbs) -> begin
(let _31_2789 = (match (lb) with
| {Microsoft_FStar_Absyn_Syntax.lbname = Support.Microsoft.FStar.Util.Inl (_); Microsoft_FStar_Absyn_Syntax.lbtyp = _; Microsoft_FStar_Absyn_Syntax.lbeff = _; Microsoft_FStar_Absyn_Syntax.lbdef = _} -> begin
(failwith "impossible")
end
...
(let _31_2786 = (match ((Microsoft_FStar_Tc_Env.try_lookup_val_decl env l)) with
| None -> begin
(gen, lb)
end
| Some ((t', _)) -> begin
(let _31_2777 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Medium) then begin
...
| _ -> begin
(let _31_2782 = if (not (deserialized)) then begin
...
in (match (_31_2786) with
| (gen, lb) -> begin
(gen, lb)
end))
end)
in (match (_31_2789) with
| (gen, lb) -> begin
(gen, (lb)::lbs)
end))
end)) (true, [])) (Support.Prims.snd lbs))
in (match (_31_2792) with
...
in (let _31_2827 = (match ((tc_exp (let _31_2795 = env
in {Microsoft_FStar_Tc_Env.solver = _31_2795.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_2795.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_2795.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_2795.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_2795.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_2795.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_2795.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_2795.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = _31_2795.Microsoft_FStar_Tc_Env.is_pattern; Microsoft_FStar_Tc_Env.instantiate_targs = _31_2795.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_2795.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_2795.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = generalize; Microsoft_FStar_Tc_Env.letrecs = _31_2795.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = _31_2795.Microsoft_FStar_Tc_Env.top_level; Microsoft_FStar_Tc_Env.check_uvars = _31_2795.Microsoft_FStar_Tc_Env.check_uvars; Microsoft_FStar_Tc_Env.use_eq = _31_2795.Microsoft_FStar_Tc_Env.use_eq; Microsoft_FStar_Tc_Env.is_iface = _31_2795.Microsoft_FStar_Tc_Env.is_iface; Microsoft_FStar_Tc_Env.admit = _31_2795.Microsoft_FStar_Tc_Env.admit; Microsoft_FStar_Tc_Env.default_effects = _31_2795.Microsoft_FStar_Tc_Env.default_effects}) e)) with
...
in (match (_31_2827) with
| (se, lbs) -> begin
(let _31_2829 = if (log env) then begin
...
in (let _31_2841 = (tc_exp env e)
in (match (_31_2841) with
| (e, c, g1) -> begin
(let g1 = (Microsoft_FStar_Tc_Rel.solve_deferred_constraints env g1)
in (let _31_2847 = (check_expected_effect env (Some ((Microsoft_FStar_Absyn_Util.ml_comp Microsoft_FStar_Tc_Recheck.t_unit r))) (e, (c.Microsoft_FStar_Absyn_Syntax.comp ())))
in (match (_31_2847) with
| (e, _, g) -> begin
(let _31_2848 = (Microsoft_FStar_Tc_Util.discharge_guard env (Microsoft_FStar_Tc_Rel.conj_guard g1 g))
...
(let env = (Microsoft_FStar_Tc_Env.set_range env r)
in (let _31_2867 = ((Support.List.partition (fun ( _31_13 ) -> (match (_31_13) with
...
in (match (_31_2867) with
| (tycons, rest) -> begin
(let _31_2876 = ((Support.List.partition (fun ( _31_14 ) -> (match (_31_14) with
...
in (let _31_2895 = (Support.List.split recs)
in (match (_31_2895) with
...
in (let _31_2897 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.push msg)
in (let _31_2904 = (tc_decls false env tycons deserialized)
in (match (_31_2904) with
| (tycons, _, _) -> begin
(let _31_2910 = (tc_decls false env recs deserialized)
in (match (_31_2910) with
| (recs, _, _) -> begin
...
in (let _31_2917 = (tc_decls false env1 rest deserialized)
in (match (_31_2917) with
| (rest, _, _) -> begin
...
in (let _31_2933 = (tc_typ_trivial env1 tt)
in (match (_31_2933) with
| (tt, _) -> begin
(let _31_2942 = (match (tt.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_lam ((bs, t)) -> begin
(bs, t)
end
| _ -> begin
...
in (let _31_2946 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.pop msg)
...
and tc_decls = (fun ( for_export ) ( env ) ( ses ) ( deserialized ) -> (let _31_2970 = ((Support.List.fold_left (fun ( _31_2957 ) ( se ) -> (match (_31_2957) with
| (ses, all_non_private, env) -> begin
(let _31_2959 = if (Microsoft_FStar_Tc_Env.debug env Microsoft_FStar_Options.Low) then begin
...
in (let _31_2963 = (tc_decl env se deserialized)
in (match (_31_2963) with
| (se, env) -> begin
(let _31_2964 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.encode_sig env se)
...
in (let _31_3078 = ((Support.List.partition (fun ( lb ) -> ((Microsoft_FStar_Absyn_Util.is_pure_or_ghost_function lb.Microsoft_FStar_Absyn_Syntax.lbtyp) && (not ((Microsoft_FStar_Absyn_Util.is_lemma lb.Microsoft_FStar_Absyn_Syntax.lbtyp)))))) (Support.Prims.snd lbs))
in (match (_31_3078) with
...
in (let env = (let _31_3135 = env
in {Microsoft_FStar_Tc_Env.solver = _31_3135.Microsoft_FStar_Tc_Env.solver; Microsoft_FStar_Tc_Env.range = _31_3135.Microsoft_FStar_Tc_Env.range; Microsoft_FStar_Tc_Env.curmodule = _31_3135.Microsoft_FStar_Tc_Env.curmodule; Microsoft_FStar_Tc_Env.gamma = _31_3135.Microsoft_FStar_Tc_Env.gamma; Microsoft_FStar_Tc_Env.modules = _31_3135.Microsoft_FStar_Tc_Env.modules; Microsoft_FStar_Tc_Env.expected_typ = _31_3135.Microsoft_FStar_Tc_Env.expected_typ; Microsoft_FStar_Tc_Env.level = _31_3135.Microsoft_FStar_Tc_Env.level; Microsoft_FStar_Tc_Env.sigtab = _31_3135.Microsoft_FStar_Tc_Env.sigtab; Microsoft_FStar_Tc_Env.is_pattern = _31_3135.Microsoft_FStar_Tc_Env.is_pattern; Microsoft_FStar_Tc_Env.instantiate_targs = _31_3135.Microsoft_FStar_Tc_Env.instantiate_targs; Microsoft_FStar_Tc_Env.instantiate_vargs = _31_3135.Microsoft_FStar_Tc_Env.instantiate_vargs; Microsoft_FStar_Tc_Env.effects = _31_3135.Microsoft_FStar_Tc_Env.effects; Microsoft_FStar_Tc_Env.generalize = _31_3135.Microsoft_FStar_Tc_Env.generalize; Microsoft_FStar_Tc_Env.letrecs = _31_3135.Microsoft_FStar_Tc_Env.letrecs; Microsoft_FStar_Tc_Env.top_level = _31_3135.Microsoft_FStar_Tc_Env.top_level; Microsoft_FStar_Tc_Env.check_uvars = _31_3135.Microsoft_FStar_Tc_Env.check_uvars; Microsoft_FStar_Tc_Env.use_eq = _31_3135.Microsoft_FStar_Tc_Env.use_eq; Microsoft_FStar_Tc_Env.is_iface = modul.Microsoft_FStar_Absyn_Syntax.is_interface; Microsoft_FStar_Tc_Env.admit = (not ((Microsoft_FStar_Options.should_verify modul.Microsoft_FStar_Absyn_Syntax.name.Microsoft_FStar_Absyn_Syntax.str))); Microsoft_FStar_Tc_Env.default_effects = _31_3135.Microsoft_FStar_Tc_Env.default_effects})
in (let _31_3138 = if (not ((Microsoft_FStar_Absyn_Syntax.lid_equals modul.Microsoft_FStar_Absyn_Syntax.name Microsoft_FStar_Absyn_Const.prims_lid))) then begin
...
in (let _31_3144 = (tc_decls true env modul.Microsoft_FStar_Absyn_Syntax.declarations modul.Microsoft_FStar_Absyn_Syntax.is_deserialized)
in (match (_31_3144) with
| (ses, non_private_decls, env) -> begin
((let _31_3145 = modul
in {Microsoft_FStar_Absyn_Syntax.name = _31_3145.Microsoft_FStar_Absyn_Syntax.name; Microsoft_FStar_Absyn_Syntax.declarations = ses; Microsoft_FStar_Absyn_Syntax.exports = _31_3145.Microsoft_FStar_Absyn_Syntax.exports; Microsoft_FStar_Absyn_Syntax.is_interface = _31_3145.Microsoft_FStar_Absyn_Syntax.is_interface; Microsoft_FStar_Absyn_Syntax.is_deserialized = _31_3145.Microsoft_FStar_Absyn_Syntax.is_deserialized}), non_private_decls, env)
end))))))))

let tc_more_partial_modul = (fun ( env ) ( modul ) ( decls ) -> (let _31_3153 = (tc_decls true env decls false)
in (match (_31_3153) with
| (ses, non_private_decls, env) -> begin
(let modul = (let _31_3154 = modul
in {Microsoft_FStar_Absyn_Syntax.name = _31_3154.Microsoft_FStar_Absyn_Syntax.name; Microsoft_FStar_Absyn_Syntax.declarations = (Support.List.append modul.Microsoft_FStar_Absyn_Syntax.declarations ses); Microsoft_FStar_Absyn_Syntax.exports = _31_3154.Microsoft_FStar_Absyn_Syntax.exports; Microsoft_FStar_Absyn_Syntax.is_interface = _31_3154.Microsoft_FStar_Absyn_Syntax.is_interface; Microsoft_FStar_Absyn_Syntax.is_deserialized = _31_3154.Microsoft_FStar_Absyn_Syntax.is_deserialized})
in (modul, non_private_decls, env))
end)))

let finish_partial_modul = (fun ( env ) ( modul ) ( npds ) -> (let exports = (get_exports env modul npds)
in (let modul = (let _31_3161 = modul
in {Microsoft_FStar_Absyn_Syntax.name = _31_3161.Microsoft_FStar_Absyn_Syntax.name; Microsoft_FStar_Absyn_Syntax.declarations = _31_3161.Microsoft_FStar_Absyn_Syntax.declarations; Microsoft_FStar_Absyn_Syntax.exports = exports; Microsoft_FStar_Absyn_Syntax.is_interface = modul.Microsoft_FStar_Absyn_Syntax.is_interface; Microsoft_FStar_Absyn_Syntax.is_deserialized = modul.Microsoft_FStar_Absyn_Syntax.is_deserialized})
in (let env = (Microsoft_FStar_Tc_Env.finish_module env modul)
in (let _31_3171 = if (not ((Microsoft_FStar_Absyn_Syntax.lid_equals modul.Microsoft_FStar_Absyn_Syntax.name Microsoft_FStar_Absyn_Const.prims_lid))) then begin
(let _31_3165 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.pop (Support.String.strcat "Ending modul " modul.Microsoft_FStar_Absyn_Syntax.name.Microsoft_FStar_Absyn_Syntax.str))
in (let _31_3167 = if ((not (modul.Microsoft_FStar_Absyn_Syntax.is_interface)) || (Support.List.contains modul.Microsoft_FStar_Absyn_Syntax.name.Microsoft_FStar_Absyn_Syntax.str (! (Microsoft_FStar_Options.admit_fsi)))) then begin
(env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.encode_modul env modul)
end
in (let _31_3169 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.refresh ())
in ((Support.Prims.ignore) (Microsoft_FStar_Options.reset_options ())))))
end
in (modul, env))))))

let tc_modul = (fun ( env ) ( modul ) -> (let _31_3178 = (tc_partial_modul env modul)
in (match (_31_3178) with
...
in (let _31_3185 = (env.Microsoft_FStar_Tc_Env.solver.Microsoft_FStar_Tc_Env.encode_sig env elt)
in env)))
...
let check_module = (fun ( env ) ( m ) -> (let _31_3190 = if ((Support.List.length (! (Microsoft_FStar_Options.debug))) <> 0) then begin
...
in (let _31_3203 = if m.Microsoft_FStar_Absyn_Syntax.is_deserialized then begin
(let env' = (add_modul_to_tcenv env m)
in (m, env'))
end else begin
(let _31_3195 = (tc_modul env m)
in (match (_31_3195) with
| (m, env) -> begin
(let _31_3199 = if (! (Microsoft_FStar_Options.serialize_mods)) then begin
...
in (let _31_3197 = (Support.Microsoft.FStar.Util.print_string (Support.String.strcat (Support.String.strcat "Serializing module " (Microsoft_FStar_Absyn_Syntax.text_of_lid m.Microsoft_FStar_Absyn_Syntax.name)) "\n"))
in (Microsoft_FStar_Absyn_SSyntax.serialize_modul (Support.Microsoft.FStar.Util.get_owriter c_file_name) m)))
end
in (m, env))
end))
end
in (match (_31_3203) with
| (m, env) -> begin
(let _31_3204 = if (Microsoft_FStar_Options.should_dump m.Microsoft_FStar_Absyn_Syntax.name.Microsoft_FStar_Absyn_Syntax.str) then begin
