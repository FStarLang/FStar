...
let uu___79 : unit = (FStar_Version.dummy ())
...
in (FStar_All.pipe_right uu____147 (fun a243 -> ())));
(
...
let main : 'Auu____628 . unit  ->  'Auu____628 = (fun uu____633 -> (FStar_All.try_with (fun uu___81_643 -> (match (()) with
| () -> begin
...
let uu____761 = (FStar_Util.record_time go)
in (match (uu____761) with
| (uu____766, time) -> begin
((

let uu____769 = (FStar_Options.query_stats ())
in (match (uu____769) with
| true -> begin
(

let uu____770 = (FStar_Util.string_of_int time)
in (

let uu____771 = (

let uu____772 = (FStar_Getopt.cmdline ())
in (FStar_String.concat " " uu____772))
...
end)) (fun uu___80_783 -> (match (uu___80_783) with
| e -> begin
(
...
let uu____789 = (FStar_Options.trace_error ())
in (match (uu____789) with
| true -> begin
(

let uu____790 = (FStar_Util.message_of_exn e)
...
let uu____792 = (FStar_Util.message_of_exn e)
