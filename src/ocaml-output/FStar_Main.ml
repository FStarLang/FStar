        ...
        then
          ...
          (match opt with
           ...
           | Some "Kremlin" ->
               ...
               let uu____143 = FStar_Options.prepend_output_dir "out.krml" in
              ...
              then
                ((let uu____185 = FStar_Options.explicit_deps () in
                 ...
                 (let filename = FStar_List.hd filenames in
                  (let uu____197 =
                     let uu____198 = FStar_Options.verify_module () in
                     uu____198 <> [] in
                   if uu____197
                   then
                 ...
                 then FStar_Fsdoc_Generator.generate filenames
                   ...
                   (let uu____207 = FStar_Options.indent () in
                    ...
                    then
                      ...
                      then
                        (let verify_mode =
                           let uu____217 = FStar_Options.verify_all () in
                           if uu____217
                           then
                             ((let uu____219 =
                                 let uu____220 =
                         ...
                         let filenames1 =
                           FStar_Dependencies.find_deps_if_needed verify_mode
                             filenames in
                         (let uu____234 = FStar_Options.load () in
...
let main uu____306 =
  ...
  | e ->
      ...
      (if FStar_Errors.handleable e then FStar_Errors.err_exn e else ();
       (let uu____316 = FStar_Options.trace_error () in
        if uu____316
        then
          let uu____317 = FStar_Util.message_of_exn e in
