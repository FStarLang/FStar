open Prims
let uu___398 : Prims.unit = FStar_Version.dummy () 
let process_args :
  Prims.unit ->
...
let go : 'Auu____385 . 'Auu____385 -> Prims.unit =
  fun uu____389  ->
    let uu____390 = process_args ()  in
                  ...
                  then
                    ...
                    | uu____429::uu____430::uu____431 ->
                        (FStar_Util.print_error
                         ...
                         FStar_All.exit (Prims.parse_int "1"))
                    | filename::[] ->
                        let uu____436 = FStar_Options.legacy_interactive ()
                           in
                        (if uu____436
                         then
