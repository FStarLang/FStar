               ...
               then
                 ...
                 (let uu____393 =
                  ...
                  then
                    ...
                    (let uu____395 = FStar_Options.interactive ()  in
                     if uu____395
                     then
                       ...
                       (let uu____407 = FStar_Options.doc ()  in
                        if uu____407
                        then FStar_Fsdoc_Generator.generate filenames
                        else
                          (let uu____409 = FStar_Options.indent ()  in
                           if uu____409
                           then
...
let main : 'Auu____568 . Prims.unit -> 'Auu____568 =
  fun uu____572  ->
    try
      ...
      (let uu____679 = FStar_Util.record_time go  in
       match uu____679 with
       | (uu____684,time) ->
           ((let uu____687 = FStar_Options.query_stats ()  in
             if uu____687
             then
               let uu____688 = FStar_Util.string_of_int time  in
               let uu____689 =
                 let uu____690 = FStar_Getopt.cmdline ()  in
                 FStar_String.concat " " uu____690  in
        ...
        (if FStar_Errors.handleable e then FStar_Errors.err_exn e else ();
         (let uu____707 = FStar_Options.trace_error ()  in
          ...
          then
            ...
            then
              (let uu____710 = FStar_Util.message_of_exn e  in
               FStar_Util.print1_error
