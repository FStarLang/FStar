...
let (load_native_tactics : unit -> unit) =
  fun uu____296 ->
    let modules_to_load =
      ...
      FStar_All.pipe_right uu____300 (FStar_List.map FStar_Ident.lid_of_str) in
    let ml_module_name m =
      let uu____313 = FStar_Extraction_ML_Util.mlpath_of_lid m in
      FStar_All.pipe_right uu____313 FStar_Extraction_ML_Util.flatten_mlpath in
    let ml_file m =
      let uu____332 = ml_module_name m in Prims.strcat uu____332 ".ml" in
    let cmxs_file m =
      let cmxs =
        let uu____340 = ml_module_name m in Prims.strcat uu____340 ".cmxs" in
      let uu____341 = FStar_Options.find_file cmxs in
      match uu____341 with
      | FStar_Pervasives_Native.Some f -> f
      | FStar_Pervasives_Native.None ->
          let uu____345 =
            let uu____348 = ml_file m in FStar_Options.find_file uu____348 in
               ...
               let uu____349 =
                 let uu____354 =
                   ...
                   FStar_Util.format1
                     ...
                     uu____355 in
                 (FStar_Errors.Fatal_FailToCompileNativeTactic, uu____354) in
               ...
               then
                 ...
                 (let uu____439 =
                    ((FStar_Options.use_extracted_interfaces ()) &&
                       (let uu____441 = FStar_Options.expose_interfaces () in
