...
let finished_message :
  ...
  fun fmods  ->
    fun errs  ->
      ...
      let uu____39 =
        let uu____40 = FStar_Options.silent ()  in Prims.op_Negation uu____40
         in
      if uu____39
      then
                        ...
                        then
                          let uu____64 =
                            ...
                            FStar_Util.format3
                              ...
                              (FStar_Ident.text_of_lid name) uu____65
                             in
                          print_to uu____64
                        else
                          (let uu____67 =
          ...
          (match opt with
           ...
           | Some "Kremlin" ->
               ...
               let bin = (FStar_Extraction_Kremlin.current_version, programs)
                  in
               let uu____149 = FStar_Options.prepend_output_dir "out.krml"
                  in
