...
let (finished_message :
  ((Prims.bool,FStar_Ident.lident) FStar_Pervasives_Native_Tuple2.tuple2,
    Prims.int) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list ->
    Prims.int -> unit)
  =
  fun fmods  ->
    fun errs  ->
...
let (report_errors :
  ((Prims.bool,FStar_Ident.lident) FStar_Pervasives_Native_Tuple2.tuple2,
    Prims.int) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list -> unit)
  =
  fun fmods  ->
...
let (main : unit -> unit) =
  fun uu____910  ->
    ...
    with
    | uu___484_1010 ->
        (handle_error uu___484_1010; FStar_All.exit (Prims.parse_int "1"))
