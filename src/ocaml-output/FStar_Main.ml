             ...
             (init_native_tactics ();
              (let uu____404 =
               ...
               then
                 ...
                 (let uu____421 = FStar_Options.interactive () in
                  if uu____421
                  then
    ...
    | e ->
        ...
        (if FStar_Errors.handleable e then FStar_Errors.err_exn e else ();
         (let uu____614 = FStar_Options.trace_error () in
          if uu____614
          then
            let uu____615 = FStar_Util.message_of_exn e in
