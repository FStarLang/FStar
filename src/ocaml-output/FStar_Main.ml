...
let (load_native_tactics : unit -> unit) =
  fun uu___  ->
    ...
    let cmxs_file m =
      let cmxs =
        let uu___1 = ml_module_name m  in Prims.op_Hat uu___1 ".cmxs"  in
      let uu___1 =
        let uu___2 =
      ...
      | FStar_Pervasives_Native.None  ->
          let uu___2 =
            let uu___3 =
              ...
              FStar_All.pipe_right uu___4 FStar_Options.prepend_output_dir
               in
                     ...
                     let uu___5 =
                       let uu___6 =
                         FStar_Util.format1
                           ...
                           cmxs
                          in
                       (FStar_Errors.Fatal_FailToCompileNativeTactic, uu___6)
                        in
