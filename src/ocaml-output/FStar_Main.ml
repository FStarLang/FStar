...
let uu____190 = (let _0_840 = (FStar_Options.verify_module ())
in (_0_840 <> []))
...
let uu____204 = (let _0_841 = (FStar_Options.verify_module ())
in (_0_841 <> []))
...
let uu____209 = (let _0_842 = (FStar_Options.verify_module ())
in (_0_842 <> []))
