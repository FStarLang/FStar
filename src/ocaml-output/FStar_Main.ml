...
let init_native_tactics : Prims.unit  ->  Prims.unit = (fun uu____345 -> ((

let uu____347 = (FStar_Options.load ())
in (FStar_Tactics_Load.load_tactics uu____347));
(

let uu____350 = (FStar_Options.use_native_tactics ())
...
let go : 'Auu____359 . 'Auu____359  ->  Prims.unit = (fun uu____363 -> (

let uu____364 = (process_args ())
...
let uu____381 = (FStar_Options.dep ())
in (Prims.op_disEquality uu____381 FStar_Pervasives_Native.None))
in (match (uu____380) with
| true -> begin
(

let uu____386 = (FStar_Parser_Dep.collect FStar_Parser_Dep.VerifyAll filenames)
in (FStar_Parser_Dep.print uu____386))
end
| uu____413 -> begin
(

let uu____414 = (FStar_Options.interactive ())
in (match (uu____414) with
| true -> begin
((

let uu____416 = (FStar_Options.explicit_deps ())
...
let uu____425 = (FStar_Options.verify_module ())
in (Prims.op_disEquality uu____425 []))
...
let uu____431 = (FStar_Options.legacy_interactive ())
...
let uu____434 = (FStar_Options.doc ())
...
let uu____436 = (FStar_Options.indent ())
...
let uu____440 = (FStar_Options.verify_all ())
...
let uu____443 = (FStar_Options.verify_module ())
in (Prims.op_disEquality uu____443 []))
...
let uu____452 = (FStar_Options.verify_module ())
in (Prims.op_disEquality uu____452 []))
...
let uu____462 = (FStar_Options.gen_native_tactics ())
...
let uu____467 = (FStar_Universal.batch_mode_tc filenames1)
in (match (uu____467) with
| (fmods, dsenv, env) -> begin
(

let module_names_and_times = (FStar_All.pipe_right fmods (FStar_List.map (fun uu____537 -> (match (uu____537) with
| (x, t) -> begin
...
let uu____565 = (FStar_All.pipe_right fmods (FStar_List.map FStar_Pervasives_Native.fst))
in ((uu____565), (env)))
in (codegen uu____558));
(

let uu____583 = (FStar_Options.gen_native_tactics ())
...
let uu____594 = (FStar_All.pipe_right fmods (FStar_List.map FStar_Pervasives_Native.fst))
in ((uu____594), (env)))
in (gen_native_tactics uu____587 dir))
end
| FStar_Pervasives_Native.None -> begin
()
end));
...
let main : 'Auu____616 . Prims.unit  ->  'Auu____616 = (fun uu____620 -> (FStar_All.try_with (fun uu___235_624 -> (match (()) with
| () -> begin
((go ());
(cleanup ());
(FStar_All.exit (Prims.parse_int "0"));
)
end)) (fun uu___234_633 -> (match (uu___234_633) with
| e -> begin
(
...
let uu____639 = (FStar_Options.trace_error ())
in (match (uu____639) with
| true -> begin
(

let uu____640 = (FStar_Util.message_of_exn e)
...
let uu____642 = (FStar_Util.message_of_exn e)
