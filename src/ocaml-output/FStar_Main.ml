...
let (finished_message :
  ...
  fun fmods ->
    fun errs ->
      ...
      let uu____67 =
        let uu____69 = FStar_Options.silent () in Prims.op_Negation uu____69 in
      if uu____67
      then
...
let (load_native_tactics : unit -> unit) =
  fun uu____177 ->
    let modules_to_load =
      ...
      FStar_All.pipe_right uu____181 (FStar_List.map FStar_Ident.lid_of_str) in
    let ml_module_name m =
      let uu____198 = FStar_Extraction_ML_Util.mlpath_of_lid m in
      FStar_All.pipe_right uu____198 FStar_Extraction_ML_Util.flatten_mlpath in
    let ml_file m =
      let uu____223 = ml_module_name m in Prims.op_Hat uu____223 ".ml" in
    let cmxs_file m =
      let cmxs =
        let uu____235 = ml_module_name m in Prims.op_Hat uu____235 ".cmxs" in
      let uu____238 = FStar_Options.find_file cmxs in
      match uu____238 with
      | FStar_Pervasives_Native.Some f -> f
      | FStar_Pervasives_Native.None ->
          let uu____247 =
            let uu____251 = ml_file m in FStar_Options.find_file uu____251 in
               ...
               let uu____255 =
                 let uu____261 =
                   ...
                   FStar_Util.format1
                     ...
                     uu____263 in
                 (FStar_Errors.Fatal_FailToCompileNativeTactic, uu____261) in
               ...
               then
                 ...
                 (let uu____437 =
                    ((FStar_Options.use_extracted_interfaces ()) &&
                       (let uu____440 = FStar_Options.expose_interfaces () in
                      ...
                      | FStar_Pervasives_Native.None ->
                          (FStar_Util.print_error
                           ...
                           (let uu____881 = FStar_Options.query_stats () in
                            if uu____881
                            then
                              let uu____884 = FStar_Util.string_of_int time in
                              let uu____886 =
