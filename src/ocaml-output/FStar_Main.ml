...
let main : 'Auu____611 . Prims.unit -> 'Auu____611 =
  fun uu____615  ->
    try
      let uu____623 = FStar_Util.record_time go  in
      match uu____623 with
      | (uu____628,time) ->
          ((let uu____631 = FStar_Options.query_stats ()  in
            if uu____631
            then
              let uu____632 = FStar_Util.string_of_int time  in
              let uu____633 =
                let uu____634 = FStar_Getopt.cmdline ()  in
                FStar_String.concat " " uu____634  in
