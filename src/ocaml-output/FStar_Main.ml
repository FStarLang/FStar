...
in (FStar_List.iter (fun uu____123 -> (match (uu____123) with
| (n, d) -> begin
...
let go = (fun uu____142 -> (

let uu____143 = (process_args ())
...
let uu____153 = (let _0_839 = (FStar_Options.dep ())
in (_0_839 <> None))
...
let uu____157 = (FStar_Options.interactive ())
in (match (uu____157) with
| true -> begin
((

let uu____159 = (FStar_Options.explicit_deps ())
...
let uu____170 = (let _0_840 = (FStar_Options.verify_module ())
in (_0_840 <> []))
...
let uu____184 = (let _0_841 = (FStar_Options.verify_module ())
in (_0_841 <> []))
...
let uu____189 = (let _0_842 = (FStar_Options.verify_module ())
in (_0_842 <> []))
