...
let (load_native_tactics : Prims.unit -> Prims.unit) =
  fun uu____253 ->
    let modules_to_load =
      ...
      FStar_All.pipe_right uu____257 (FStar_List.map FStar_Ident.lid_of_str) in
    let ml_module_name m =
      let uu____268 = FStar_Extraction_ML_Util.mlpath_of_lid m in
      FStar_All.pipe_right uu____268 FStar_Extraction_ML_Util.flatten_mlpath in
    let ml_file m =
      let uu____285 = ml_module_name m in Prims.strcat uu____285 ".ml" in
    let cmxs_file m =
      let cmxs =
        let uu____291 = ml_module_name m in Prims.strcat uu____291 ".cmxs" in
      let uu____292 = FStar_Options.find_file cmxs in
      match uu____292 with
      | FStar_Pervasives_Native.Some f -> f
      | FStar_Pervasives_Native.None ->
          let uu____296 =
            let uu____299 = ml_file m in FStar_Options.find_file uu____299 in
               ...
               let uu____300 =
                 let uu____305 =
                   ...
                   FStar_Util.format1
                     ...
                     uu____306 in
                 (FStar_Errors.Fatal_FailToCompileNativeTactic, uu____305) in
               ...
               then
                 ...
                 (let uu____385 =
                  ...
                  then
                    ...
                    (let uu____387 = FStar_Options.interactive () in
                     if uu____387
                     then
                       ...
                       (let uu____399 = FStar_Options.doc () in
                        if uu____399
                        then FStar_Fsdoc_Generator.generate filenames
                        else
                          (let uu____401 = FStar_Options.indent () in
                           if uu____401
                           then
...
let main : 'Auu____539 . Prims.unit -> 'Auu____539 =
  fun uu____543 ->
    try
      ...
      (let uu____650 = FStar_Util.record_time go in
       ...
       | (uu____655, time) ->
           ((let uu____658 = FStar_Options.query_stats () in
             if uu____658
             then
               let uu____659 = FStar_Util.string_of_int time in
               let uu____660 =
                 let uu____661 = FStar_Getopt.cmdline () in
                 FStar_String.concat " " uu____661 in
    ...
    | e ->
        ...
        (if FStar_Errors.handleable e then FStar_Errors.err_exn e else ();
         (let uu____678 = FStar_Options.trace_error () in
          if uu____678
          then
            ...
            then
              (let uu____681 = FStar_Util.message_of_exn e in
               FStar_Util.print1_error
