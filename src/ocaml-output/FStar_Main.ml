open Prims
let uu___604: Prims.unit = FStar_Version.dummy ()
let process_args:
  Prims.unit ->
         ...
         | FStar_Getopt.Success  ->
             (init_native_tactics ();
              (let uu____415 =
               ...
               then
                 let uu____421 =
                   let uu____422 = FStar_Parser_Dep.collect filenames in
                   FStar_Pervasives_Native.snd uu____422 in
                                          ...
                                          let uu____582 =
                                            FStar_All.pipe_right fmods
                                              (FStar_List.map
                                                 FStar_Pervasives_Native.fst) in
                                          (uu____582, env) in
                                        gen_native_tactics uu____575 dir
                                    | FStar_Pervasives_Native.None  -> ());
