...
open Prims
# 8 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
...
# 11 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let empty : doc = Doc ("")

# 12 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let hardline : doc = Doc ("\n")

# 15 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let text : Prims.string  ->  doc = (fun s -> Doc (s))

# 16 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let num : Prims.int  ->  doc = (fun i -> Doc ((Prims.string_of_int i)))

# 19 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let break_ : Prims.int  ->  doc = (fun i -> Doc (""))

# 21 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let break0 : doc = (break_ 0)

# 22 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let break1 : doc = (text " ")

# 25 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
...
# 28 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
...
# 29 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
...
# 30 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
...
# 33 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
...
# 36 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let reduce : doc Prims.list  ->  doc = (fun docs -> (FStar_List.fold_left cat empty docs))

# 40 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
...
# 43 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let groups : doc Prims.list  ->  doc = (fun docs -> (let _126_35 = (reduce docs)
in (group _126_35)))

# 47 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
...
# 53 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let cat1 : doc  ->  doc  ->  doc = (fun d1 d2 -> (reduce ((d1)::(break1)::(d2)::[])))

# 57 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let reduce1 : doc Prims.list  ->  doc = (fun docs -> (combine break1 docs))

# 61 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
...
# 65 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
...
# 70 "D:\\workspace\\FStar\\src\\format\\formatml.fs"

let hbox : doc  ->  doc = (fun d -> d)

# 73 "D:\\workspace\\FStar\\src\\format\\formatml.fs"
