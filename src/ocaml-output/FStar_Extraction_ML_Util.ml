    ...
    let cint i =
      let uu____159 =
        ...
        FStar_All.pipe_right uu____160
          (fun _186 -> FStar_Extraction_ML_Syntax.MLE_Const _186) in
    ...
    let cstr s =
      let uu____195 =
        FStar_All.pipe_right (FStar_Extraction_ML_Syntax.MLC_String s)
          (fun _196 -> FStar_Extraction_ML_Syntax.MLE_Const _196) in
    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Var x ->
          let uu____290 =
            FStar_Util.find_opt
              (fun uu____306 ->
                 match uu____306 with | (y, uu____314) -> y = x) subst1 in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Fun (t1, f, t2) ->
          let uu____338 =
            ...
            let uu____346 = subst_aux subst1 t2 in (uu____345, f, uu____346) in
                ...
                | FStar_Pervasives_Native.None ->
                    let uu____468 =
                      ...
                      FStar_Util.format3
                        ...
                        uu____470 uu____472 uu____474 in
                    failwith uu____468
    ...
    fun e ->
      fun t ->
        fun t' ->
             ...
             FStar_Extraction_ML_Syntax.MLTY_Fun (t1', f', t2')) ->
              let mk_fun xs body =
                ...
                | uu____719 ->
                    ...
                    FStar_Extraction_ML_Syntax.with_ty uu____764 e1 in
              (match e with
                      ...
                      then
                           ...
                           let uu____835 =
                             let uu____838 =
                               let uu____839 =
                                 ...
                                 FStar_Extraction_ML_Syntax.with_ty uu____844 in
                        ...
                        (let uu____884 =
                           let uu____892 =
                             ...
                             FStar_All.pipe_left
                               (fun _898 -> FStar_Pervasives_Native.Some _898)
                               uu____895 in
                         ...
                         | (ok, body1) ->
                             let res =
                               ...
                               | uu____931 -> FStar_Pervasives_Native.None in
                             (ok, res)))
                   else (false, FStar_Pervasives_Native.None)
               | uu____943 ->
                   let uu____946 =
          ...
          | (FStar_Extraction_ML_Syntax.MLTY_Tuple ts,
             FStar_Extraction_ML_Syntax.MLTY_Tuple ts') ->
              let uu____1040 = FStar_List.forall2 (type_leq unfold_ty) ts ts' in
              if uu____1040
              then (true, e)
              else (false, FStar_Pervasives_Native.None)
    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (lty, mlp) ->
          ...
          then FStar_Extraction_ML_UEnv.erasedContent
            ...
            (let uu____1675 =
               let uu____1682 = FStar_List.map (eraseTypeDeep unfold_ty) lty in
               (uu____1682, mlp) in
...
let (argTypes :
  ...
  =
  fun t ->
    let uu____1872 = doms_and_cod t in FStar_Pervasives_Native.fst uu____1872
...
let (uu___is_NBE_t : emb_loc -> Prims.bool) =
  fun projectee -> match projectee with | NBE_t -> true | uu____2015 -> false
        ...
        fun arity_opt ->
          fun ml_fv ->
            ...
            let lid_to_top_name l =
              ...
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____2105 in
            let str_to_name s =
            ...
            let fstar_refl_nbeemb_prefix s =
              str_to_name (Prims.op_Hat "FStar_Reflection_NBEEmbeddings." s) in
            let fv_lid_embedded =
              let uu____2162 =
                let uu____2163 =
                  ...
                  let uu____2172 =
                    let uu____2175 =
                      let uu____2176 =
                        let uu____2177 =
                          let uu____2178 = FStar_Ident.string_of_lid fv_lid1 in
                          FStar_Extraction_ML_Syntax.MLC_String uu____2178 in
                        FStar_Extraction_ML_Syntax.MLE_Const uu____2177 in
                      FStar_All.pipe_left
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu____2176 in
                    [uu____2175] in
                  (uu____2170, uu____2172) in
                FStar_Extraction_ML_Syntax.MLE_App uu____2163 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____2162 in
            ...
            let mk_basic_embedding l s = emb_prefix l (Prims.op_Hat "e_" s) in
                            ...
                            let uu____2464 =
                              let uu____2479 =
                                let uu____2492 =
                                  ...
                                  (uu____2501, (Prims.of_int (2)), "tuple2") in
                                  ...
                                  let uu____2581 =
                                    let uu____2594 =
                                      let uu____2603 =
                                        FStar_Reflection_Data.fstar_refl_types_lid
                                          "sigelt" in
                                      (uu____2603, Prims.int_zero, "sigelt") in
                                    ...
                                    let uu____2632 =
                                      let uu____2645 =
                                        let uu____2654 =
                                          FStar_Reflection_Data.fstar_refl_types_lid
                                            "fv" in
                                        (uu____2654, Prims.int_zero, "fv") in
              ...
              let nbe_cs =
                FStar_List.map
                  (fun uu___5_3126 ->
                     ...
                     | uu____3201 -> failwith "Impossible") term_cs in
              fun uu___6_3227 ->
                match uu___6_3227 with
                | Syntax_term -> term_cs
                | Refl_emb -> term_cs
                | uu____3242 -> nbe_cs in
            ...
            let rec mk_embedding l env t2 =
              ...
              | FStar_Syntax_Syntax.Tm_arrow (b::more::bs, c) ->
                  ...
                  let t4 =
                    let uu____3600 =
                      let uu____3607 =
                        let uu____3608 =
                          let uu____3623 = FStar_Syntax_Syntax.mk_Total tail1 in
                          ([b], uu____3623) in
              ...
              | FStar_Syntax_Syntax.Tm_fvar uu____3648 ->
                  ...
                  (match uu____3649 with
                   | (head1, args) ->
                       ...
                       let uu____3701 =
                         let uu____3702 = FStar_Syntax_Util.un_uinst head1 in
                              ...
                              let uu____3756 =
                                FStar_Util.find_opt
                                  (fun uu____3788 ->
                                     ...
                                     | ((x, uu____3803, uu____3804),
                                        uu____3805) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____3756 FStar_Util.must in
                            (match uu____3743 with
                             | ((uu____3856, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head2 =
              ...
              | FStar_Syntax_Syntax.Tm_uinst uu____3885 ->
                  ...
                  (match uu____3892 with
                   | (head1, args) ->
                       let n_args = FStar_List.length args in
                       let uu____3944 =
                         let uu____3945 = FStar_Syntax_Util.un_uinst head1 in
                              ...
                              let uu____3999 =
                                FStar_Util.find_opt
                                  (fun uu____4031 ->
                                     ...
                                     | ((x, uu____4046, uu____4047),
                                        uu____4048) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____3999 FStar_Util.must in
                            (match uu____3986 with
                             | ((uu____4099, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head2 =
                                   mk_basic_embedding loc_embedding nm in
                                 (match t_arity with
                              ...
                              let uu____4252 =
                                FStar_Util.find_opt
                                  (fun uu____4284 ->
                                     ...
                                     | ((x, uu____4299, uu____4300),
                                        uu____4301) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____4252 FStar_Util.must in
                            (match uu____4239 with
                             | ((uu____4352, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head2 =
                                   mk_basic_embedding loc_embedding nm in
                                 (match t_arity with
              ...
              | uu____4381 ->
                  let uu____4382 =
                    let uu____4383 =
                      let uu____4385 = FStar_Syntax_Print.term_to_string t3 in
                            ...
                            let uu____4421 =
                              let uu____4422 =
                                ...
                                FStar_Extraction_ML_Syntax.MLC_String
                                  uu____4423 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu____4422 in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                              uu____4421 in
              ...
              | uu____4449 ->
                  ...
                  let default_branch =
                    ...
                    (FStar_Extraction_ML_Syntax.MLP_Wild,
                      FStar_Pervasives_Native.None, uu____4525) in
                  let body1 =
                    let uu____4548 =
                      let uu____4549 =
                          ...
                          let uu____4614 =
                            let uu____4615 =
                              let uu____4616 =
                                ...
                                FStar_Extraction_ML_Syntax.MLC_String
                                  uu____4617 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu____4616 in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                              uu____4615 in
                          let uu____4619 =
                            let uu____4622 = mk_lam "_" body1 in [uu____4622] in
                          ...
                          (let uu____4753 = FStar_Util.first_N n1 bs in
                           ...
                           | (bs1, rest) ->
                               let c1 =
                                 ...
                                 FStar_All.pipe_left
                                   FStar_Syntax_Syntax.mk_Total uu____4831 in
                               (bs1, c1))
                        else
                          (let msg =
                             let uu____4848 =
                             ...
                             let uu____4852 = FStar_Util.string_of_int n_bs in
                             FStar_Util.format3
                               "Embedding not defined for %s; expected arity at least %s; got %s"
                               uu____4848 uu____4850 uu____4852 in
                      ...
                      | (type_vars, bs2) ->
                            ...
                            FStar_List.mapi
                              (fun i ->
                                 fun tv ->
                                   ...
                                   Prims.op_Hat "tv_" uu____5229) type_vars in
                          let tvar_context =
                            FStar_List.map2
                              (fun b ->
                                 fun nm ->
                          ...
                          let rec aux loc accum_embeddings bs3 =
                                          ...
                                          let uu____5356 =
                                            ...
                                            FStar_All.pipe_left
                                              (FStar_Extraction_ML_Syntax.with_ty
                                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                                              uu____5357 in
                                          [uu____5356; fv_lid_embedded; cb] in
                            ...
                            | (b, uu____5484)::bs4 ->
                                ...
                                aux loc uu____5504 bs4 in
                          (try
                             (fun uu___687_5529 ->
                                match () with
                                | () ->
                                    let uu____5542 = aux Syntax_term [] bs2 in
                                    (match uu____5542 with
                                     | (w1, a, b) ->
                                         let uu____5570 = aux NBE_t [] bs2 in
