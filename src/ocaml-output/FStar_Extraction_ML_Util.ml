...
let mk_tactic_unembedding :
  ...
  fun args  ->
    ...
    let reify_tactic =
      ...
      FStar_All.pipe_left
        (FStar_Extraction_ML_Syntax.with_ty
           FStar_Extraction_ML_Syntax.MLTY_Top) uu____1511
       in
    let from_tac =
      let uu____1527 =
        let uu____1528 =
      ...
      let uu____1530 =
        let uu____1531 =
          FStar_Util.string_of_int
            ((FStar_List.length args) - (Prims.parse_int "1"))
           in
        Prims.strcat "FStar_Tactics_Interpreter.unembed_tactic_" uu____1531
         in
    ...
    let app =
          ...
          let uu____1533 =
            let uu____1540 =
              let uu____1543 =
                ...
                FStar_Extraction_ML_Syntax.with_ty
                  FStar_Extraction_ML_Syntax.MLTY_Top uu____1544
                 in
              [uu____1543]  in
      ...
      | n1 ->
          let uu____1563 =
            let uu____1564 =
              let uu____1567 = FStar_Util.string_of_int n1  in [uu____1567]
               in
            FStar_Util.format
...
let rec mk_tac_param_type :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1629 = FStar_Reflection_Data.fstar_refl_types_lid "binder"
           in
        FStar_Syntax_Syntax.fv_eq_lid fv uu____1629 ->
        fstar_refl_data_prefix "t_binder"
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1631 = FStar_Reflection_Data.fstar_refl_types_lid "term"
           in
    ...
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1635 = FStar_Reflection_Data.fstar_refl_syntax_lid "binder"
           in
         ...
         | FStar_Syntax_Syntax.Tm_uinst (h',uu____1665) ->
             ...
             (match uu____1670 with
              | FStar_Syntax_Syntax.Tm_fvar fv when
                  ...
                  let uu____1693 =
                    let uu____1700 =
                      ...
                      FStar_Extraction_ML_Syntax.with_ty
                        FStar_Extraction_ML_Syntax.MLTY_Top uu____1701
                       in
                    let uu____1702 =
                      let uu____1705 =
                      ...
                      FStar_List.map
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu____1705
                       in
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv when
                  ...
                  let uu____1730 =
                    let uu____1737 =
                      let uu____1738 = fstar_tc_common_prefix "t_option_of"
                         in
                      FStar_Extraction_ML_Syntax.with_ty
                        FStar_Extraction_ML_Syntax.MLTY_Top uu____1738
                       in
                    let uu____1739 =
                      let uu____1742 =
...
let rec mk_tac_embedding_path :
  ...
  fun m  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv when
          let uu____1776 = FStar_Reflection_Data.fstar_refl_types_lid "term"
             in
          FStar_Syntax_Syntax.fv_eq_lid fv uu____1776 ->
          mk_embedding m "term"
      | FStar_Syntax_Syntax.Tm_fvar fv when
          let uu____1778 = FStar_Reflection_Data.fstar_refl_types_lid "fv"
             in
                    ...
                    then
                      ...
                      (let uu____1946 =
                         let uu____1953 =
                           ...
                           FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top uu____1954
                            in
                         let uu____1955 =
                           FStar_List.map
                             (FStar_Extraction_ML_Syntax.with_ty
      ...
      fun t  ->
        fun bs  ->
            ...
            let uu____2036 =
              let uu____2043 =
                let uu____2044 =
                  ...
                  Prims.strcat "FStar_Tactics_Native.from_tactic_" uu____2045
                   in
            ...
            let uu____2076 =
              ...
              let uu____2082 =
                ...
                let uu____2086 =
                  ...
                  let uu____2090 =
                    let uu____2093 =
                      let uu____2096 = str_to_name "args"  in [uu____2096]
                       in
          ...
          let app =
            ...
            FStar_All.pipe_left
              (FStar_Extraction_ML_Syntax.with_ty
                 FStar_Extraction_ML_Syntax.MLTY_Top) uu____2098
             in
          FStar_Extraction_ML_Syntax.MLE_Fun
