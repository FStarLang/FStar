...
let udelta_unfold : FStar_Extraction_ML_UEnv.env  ->  FStar_Extraction_ML_Syntax.mlty  ->  FStar_Extraction_ML_Syntax.mlty FStar_Pervasives_Native.option = (fun g uu___116_240 -> (match (uu___116_240) with
...
let eff_to_string : FStar_Extraction_ML_Syntax.e_tag  ->  Prims.string = (fun uu___117_288 -> (match (uu___117_288) with
...
let uu____478 = ((mk_ty_fun ()) xs body.FStar_Extraction_ML_Syntax.mlty)
...
let uu____549 = ((mk_ty_fun ()) ((x)::[]) body1.FStar_Extraction_ML_Syntax.mlty)
...
in (FStar_All.pipe_left (fun _0_42 -> FStar_Pervasives_Native.Some (_0_42)) uu____588))
...
let is_type_abstraction : 'Auu____828 'Auu____829 'Auu____830 . (('Auu____830, 'Auu____829) FStar_Util.either * 'Auu____828) Prims.list  ->  Prims.bool = (fun uu___118_844 -> (match (uu___118_844) with
...
let record_field_path : FStar_Ident.lident Prims.list  ->  Prims.string Prims.list = (fun uu___119_949 -> (match (uu___119_949) with
| (f)::uu____955 -> begin
(
...
let uu____1226 = ((mk_ty_fun ()) (((((("x"), ((Prims.parse_int "0")))), (FStar_Extraction_ML_Syntax.ml_bool_ty)))::((((("y"), ((Prims.parse_int "0")))), (FStar_Extraction_ML_Syntax.ml_bool_ty)))::[]) FStar_Extraction_ML_Syntax.ml_bool_ty)
...
let uu____1506 = (FStar_Syntax_Subst.compress t)
...
let uu____1518 = (FStar_Reflection_Data.fstar_refl_types_lid "fv")
...
in (FStar_Syntax_Syntax.fv_eq_lid fv uu____1520)) -> begin
(fstar_refl_data_prefix "t_binders")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) when (

let uu____1522 = (FStar_Reflection_Data.fstar_refl_syntax_lid "norm_step")
in (FStar_Syntax_Syntax.fv_eq_lid fv uu____1522)) -> begin
...
| FStar_Syntax_Syntax.Tm_uinst (h', uu____1550) -> begin
(

let uu____1555 = (

let uu____1556 = (FStar_Syntax_Subst.compress h')
...
let uu____1563 = (FStar_List.hd args)
in (FStar_Pervasives_Native.fst uu____1563))
in (
...
let uu____1586 = (fstar_tc_common_prefix "t_list_of")
in (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top uu____1586))
in (
...
let uu____1593 = (mk_tac_param_type arg_term)
in (uu____1593)::[])
in (FStar_List.map (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) uu____1590))
in ((uu____1585), (uu____1587))))
in FStar_Extraction_ML_Syntax.MLE_App (uu____1578)))
end
...
let uu____1600 = (FStar_List.hd args)
in (FStar_Pervasives_Native.fst uu____1600))
in (
...
in (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top uu____1623))
in (
...
let uu____1630 = (mk_tac_param_type arg_term)
in (uu____1630)::[])
in (FStar_List.map (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) uu____1627))
in ((uu____1622), (uu____1624))))
in FStar_Extraction_ML_Syntax.MLE_App (uu____1615)))
end
| uu____1633 -> begin
(
...
let uu____1636 = (FStar_Syntax_Subst.compress h')
in (FStar_Syntax_Print.term_to_string uu____1636))
in (Prims.strcat "Type term not defined for higher-order type " uu____1635))
in (failwith uu____1634))
end))
end
| uu____1637 -> begin
(failwith "Impossible")
...
let uu____1641 = (FStar_Syntax_Subst.compress t)
in (FStar_Syntax_Print.term_to_string uu____1641))
in (Prims.strcat "Type term not defined for " uu____1640))
in (failwith uu____1639))
end)))
...
let uu____1651 = (FStar_Syntax_Subst.compress t)
in uu____1651.FStar_Syntax_Syntax.n)
...
let uu____1659 = (FStar_Reflection_Data.fstar_refl_types_lid "binder")
...
let uu____1665 = (FStar_Reflection_Data.fstar_refl_syntax_lid "binders")
in (FStar_Syntax_Syntax.fv_eq_lid fv uu____1665)) -> begin
(mk_embedding m "binders")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) when (

let uu____1667 = (FStar_Reflection_Data.fstar_refl_syntax_lid "norm_step")
in (FStar_Syntax_Syntax.fv_eq_lid fv uu____1667)) -> begin
...
let uu____1691 = (FStar_Syntax_Subst.compress h)
in uu____1691.FStar_Syntax_Syntax.n)
in (match (uu____1690) with
| FStar_Syntax_Syntax.Tm_uinst (h', uu____1695) -> begin
(
...
let uu____1710 = (FStar_Syntax_Subst.compress h')
...
let uu____1725 = (FStar_List.hd args)
in (FStar_Pervasives_Native.fst uu____1725))
in (

let uu____1740 = (

let uu____1743 = (mk_tac_embedding_path m arg_term)
in (uu____1743)::[])
in (

let uu____1744 = (mk_tac_param_type arg_term)
in (("list"), (uu____1740), (uu____1744)))))
end
| FStar_Syntax_Syntax.Tm_fvar (fv) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.option_lid) -> begin
(
...
let uu____1751 = (FStar_List.hd args)
in (FStar_Pervasives_Native.fst uu____1751))
in (

let uu____1766 = (

let uu____1769 = (mk_tac_embedding_path m arg_term)
in (uu____1769)::[])
in (

let uu____1770 = (mk_tac_param_type arg_term)
in (("option"), (uu____1766), (uu____1770)))))
end
...
let uu____1785 = (FStar_Syntax_Subst.compress h')
in (FStar_Syntax_Print.term_to_string uu____1785))
in (Prims.strcat "Embedding not defined for higher-order type " uu____1784))
in (failwith uu____1783))
end))
...
let uu____1814 = (mk_embedding m ht)
in (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top uu____1814))
in (

let uu____1815 = (FStar_List.map (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) hargs1)
in ((uu____1813), (uu____1815))))
in FStar_Extraction_ML_Syntax.MLE_App (uu____1806)))
end))
end
| uu____1820 -> begin
(failwith "Impossible")
...
in (FStar_Syntax_Print.term_to_string uu____1824))
in (Prims.strcat "Embedding not defined for type " uu____1823))
in (failwith uu____1822))
end)))


let mk_interpretation_fun : 'Auu____1835 . FStar_Ident.lident  ->  FStar_Extraction_ML_Syntax.mlexpr'  ->  FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.bv * 'Auu____1835) Prims.list  ->  FStar_Extraction_ML_Syntax.mlexpr' = (fun tac_lid assm_lid t bs -> (
...
let uu____1888 = (FStar_Util.string_of_int arity)
in (Prims.strcat "FStar_Tactics_Interpreter.mk_tactic_interpretation_" uu____1888))
in (str_to_top_name uu____1887))
in (
...
let uu____1905 = (FStar_Util.string_of_int arity)
in (Prims.strcat "FStar_Tactics_Native.from_tactic_" uu____1905))
in (str_to_top_name uu____1904))
in (

let uu____1912 = (

let uu____1915 = (lid_to_top_name tac_lid)
in (uu____1915)::[])
in ((uu____1903), (uu____1912))))
in FStar_Extraction_ML_Syntax.MLE_App (uu____1896))
in (
...
let uu____1926 = (str_to_top_name "FStar_Ident.lid_of_str")
in ((uu____1926), (((FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top assm_lid))::[])))
in FStar_Extraction_ML_Syntax.MLE_App (uu____1919))
in (
...
let uu____1935 = (str_to_name "ps")
in (uu____1935)::(tac_fun)::[])
in (

let uu____1936 = (

let uu____1939 = (FStar_List.map (mk_tac_embedding_path Unembed) arg_types)
in (

let uu____1942 = (

let uu____1945 = (mk_tac_embedding_path Embed t)
in (

let uu____1946 = (

let uu____1949 = (mk_tac_param_type t)
in (
...
let uu____1956 = (str_to_name "args")
in (uu____1956)::[])
in (tac_lid_app)::uu____1953)
in (uu____1949)::uu____1950))
in (uu____1945)::uu____1946))
in (FStar_List.append uu____1939 uu____1942)))
in (FStar_List.append uu____1932 uu____1936)))
in (
...
let uu____1966 = (FStar_List.map (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) args)
in ((h), (uu____1966)))
in FStar_Extraction_ML_Syntax.MLE_App (uu____1959))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) uu____1958))
