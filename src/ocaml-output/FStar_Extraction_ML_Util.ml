          ...
          fun ml_fv ->
              ...
              let nbe_cs =
                FStar_List.map
                  (fun uu___5_3063 ->
                     ...
                     | uu____3138 -> failwith "Impossible") term_cs in
              fun uu___6_3164 ->
                match uu___6_3164 with
                | Syntax_term -> term_cs
                | Refl_emb -> term_cs
                | uu____3179 -> nbe_cs in
            ...
            let rec mk_embedding l env t2 =
              ...
              | FStar_Syntax_Syntax.Tm_arrow (b::more::bs, c) ->
                  ...
                  let t4 =
                    let uu____3537 =
                      let uu____3544 =
                        let uu____3545 =
                          let uu____3560 = FStar_Syntax_Syntax.mk_Total tail1 in
                          ([b], uu____3560) in
              ...
              | FStar_Syntax_Syntax.Tm_fvar uu____3585 ->
                  ...
                  (match uu____3586 with
                   | (head1, args) ->
                       ...
                       let uu____3638 =
                         let uu____3639 = FStar_Syntax_Util.un_uinst head1 in
                              ...
                              let uu____3693 =
                                FStar_Util.find_opt
                                  (fun uu____3725 ->
                                     ...
                                     | ((x, uu____3740, uu____3741),
                                        uu____3742) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____3693 FStar_Util.must in
                            (match uu____3680 with
                             | ((uu____3793, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head2 =
              ...
              | FStar_Syntax_Syntax.Tm_uinst uu____3822 ->
                  ...
                  (match uu____3829 with
                   | (head1, args) ->
                       let n_args = FStar_List.length args in
                       let uu____3881 =
                         let uu____3882 = FStar_Syntax_Util.un_uinst head1 in
                              ...
                              let uu____3936 =
                                FStar_Util.find_opt
                                  (fun uu____3968 ->
                                     ...
                                     | ((x, uu____3983, uu____3984),
                                        uu____3985) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____3936 FStar_Util.must in
                            (match uu____3923 with
                             | ((uu____4036, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head2 =
                                   mk_basic_embedding loc_embedding nm in
                                 (match t_arity with
              ...
              | FStar_Syntax_Syntax.Tm_app uu____4065 ->
                  ...
                  (match uu____4082 with
                   | (head1, args) ->
                       let n_args = FStar_List.length args in
                       let uu____4134 =
                         let uu____4135 = FStar_Syntax_Util.un_uinst head1 in
                              ...
                              let uu____4189 =
                                FStar_Util.find_opt
                                  (fun uu____4221 ->
                                     ...
                                     | ((x, uu____4236, uu____4237),
                                        uu____4238) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____4189 FStar_Util.must in
                            (match uu____4176 with
                             | ((uu____4289, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head2 =
                                   mk_basic_embedding loc_embedding nm in
                                 (match t_arity with
              ...
              | uu____4318 ->
                  let uu____4319 =
                    let uu____4320 =
                      let uu____4322 = FStar_Syntax_Print.term_to_string t3 in
                      Prims.op_Hat "Embedding not defined for type "
                        uu____4322 in
                    NoTacticEmbedding uu____4320 in
                  FStar_Exn.raise uu____4319 in
                            ...
                            let uu____4358 =
                              let uu____4359 =
                                ...
                                FStar_Extraction_ML_Syntax.MLC_String
                                  uu____4360 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu____4359 in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                              uu____4358 in
              ...
              | uu____4386 ->
                  ...
                  let default_branch =
                    ...
                    (FStar_Extraction_ML_Syntax.MLP_Wild,
                      FStar_Pervasives_Native.None, uu____4462) in
                  let body1 =
                    let uu____4485 =
                      let uu____4486 =
                          ...
                          let uu____4551 =
                            let uu____4552 =
                              let uu____4553 =
                                ...
                                FStar_Extraction_ML_Syntax.MLC_String
                                  uu____4554 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu____4553 in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                              uu____4552 in
                          let uu____4556 =
                            let uu____4559 = mk_lam "_" body1 in [uu____4559] in
                          ...
                          (let uu____4690 = FStar_Util.first_N n1 bs in
                           ...
                           | (bs1, rest) ->
                               let c1 =
                                 ...
                                 FStar_All.pipe_left
                                   FStar_Syntax_Syntax.mk_Total uu____4768 in
                               (bs1, c1))
                        else
                          (let msg =
                             let uu____4785 =
                             ...
                             let uu____4789 = FStar_Util.string_of_int n_bs in
                             FStar_Util.format3
                               "Embedding not defined for %s; expected arity at least %s; got %s"
                               uu____4785 uu____4787 uu____4789 in
                      ...
                      | (type_vars, bs2) ->
                            ...
                            FStar_List.mapi
                              (fun i ->
                                 fun tv ->
                                   ...
                                   Prims.op_Hat "tv_" uu____5166) type_vars in
                          let tvar_context =
                            FStar_List.map2
                              (fun b ->
                                 fun nm ->
                          ...
                          let rec aux loc accum_embeddings bs3 =
                                          ...
                                          let uu____5293 =
                                            ...
                                            FStar_All.pipe_left
                                              (FStar_Extraction_ML_Syntax.with_ty
                                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                                              uu____5294 in
                                          [uu____5293; fv_lid_embedded; cb] in
                            ...
                            | (b, uu____5421)::bs4 ->
                                ...
                                aux loc uu____5441 bs4 in
                          (try
                             (fun uu___687_5466 ->
                                match () with
                                | () ->
                                    let uu____5479 = aux Syntax_term [] bs2 in
                                    (match uu____5479 with
                                     | (w1, a, b) ->
                                         let uu____5507 = aux NBE_t [] bs2 in
