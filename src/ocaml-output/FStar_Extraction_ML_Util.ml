    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (lty, mlp) ->
          ...
          then FStar_Extraction_ML_Syntax.MLTY_Erased
            ...
            (let uu____1745 =
               let uu____1752 = FStar_List.map (eraseTypeDeep unfold_ty) lty in
               (uu____1752, mlp) in
...
let (argTypes :
  ...
  =
  fun t ->
    let uu____1942 = doms_and_cod t in FStar_Pervasives_Native.fst uu____1942
...
let (uu___is_NBE_t : emb_loc -> Prims.bool) =
  fun projectee -> match projectee with | NBE_t -> true | uu____2100 -> false
        ...
        fun arity_opt ->
          fun ml_fv ->
            ...
            let lid_to_name l =
              ...
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____2189 in
            ...
            let fv_lid_embedded =
              let uu____2265 =
                let uu____2266 =
                  let uu____2273 = as_name (["FStar_Ident"], "lid_of_str") in
                  let uu____2282 =
                    let uu____2285 =
                      let uu____2286 =
                        let uu____2287 =
                          let uu____2288 = FStar_Ident.string_of_lid fv_lid in
                          FStar_Extraction_ML_Syntax.MLC_String uu____2288 in
                        FStar_Extraction_ML_Syntax.MLE_Const uu____2287 in
                      FStar_All.pipe_left
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu____2286 in
                    [uu____2285] in
                  (uu____2273, uu____2282) in
                FStar_Extraction_ML_Syntax.MLE_App uu____2266 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____2265 in
                            ...
                            let uu____2641 =
                              let uu____2656 =
                                let uu____2669 =
                                  ...
                                  (uu____2678, (Prims.of_int (2)), "tuple2") in
                                  ...
                                  let uu____2758 =
                                    let uu____2771 =
                                      let uu____2780 =
                                        FStar_Reflection_Data.fstar_refl_types_lid
                                          "sigelt" in
                                      (uu____2780, Prims.int_zero, "sigelt") in
                                    ...
                                    let uu____2809 =
                                      let uu____2822 =
                                        let uu____2831 =
                                          FStar_Reflection_Data.fstar_refl_types_lid
                                            "fv" in
                                        (uu____2831, Prims.int_zero, "fv") in
              ...
              let nbe_cs =
                FStar_List.map
                  (fun uu___5_3303 ->
                     ...
                     | uu____3378 -> failwith "Impossible") term_cs in
              fun uu___6_3404 ->
                match uu___6_3404 with
                | Syntax_term -> term_cs
                | Refl_emb -> term_cs
                | uu____3419 -> nbe_cs in
            ...
            let rec mk_embedding l env1 t2 =
              ...
              | FStar_Syntax_Syntax.Tm_arrow (b::more::bs, c) ->
                  ...
                  let t4 =
                    let uu____3777 =
                      let uu____3778 =
                        let uu____3793 = FStar_Syntax_Syntax.mk_Total tail in
                        ([b], uu____3793) in
                              ...
                              let uu____3927 =
                                FStar_Util.find_opt
                                  (fun uu____3959 ->
                                     ...
                                     | ((x, uu____3974, uu____3975),
                                        uu____3976) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____3927 FStar_Util.must in
                            (match uu____3914 with
                             | ((uu____4027, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head1 =
                              ...
                              let uu____4171 =
                                FStar_Util.find_opt
                                  (fun uu____4203 ->
                                     ...
                                     | ((x, uu____4218, uu____4219),
                                        uu____4220) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____4171 FStar_Util.must in
                            (match uu____4158 with
                             | ((uu____4271, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head1 =
                                   mk_basic_embedding loc_embedding nm in
                                 (match t_arity with
                              ...
                              let uu____4425 =
                                FStar_Util.find_opt
                                  (fun uu____4457 ->
                                     ...
                                     | ((x, uu____4472, uu____4473),
                                        uu____4474) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____4425 FStar_Util.must in
                            (match uu____4412 with
                             | ((uu____4525, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head1 =
                                   mk_basic_embedding loc_embedding nm in
                                 (match t_arity with
              ...
              | uu____4554 ->
                  let uu____4555 =
                    let uu____4556 =
                      let uu____4558 = FStar_Syntax_Print.term_to_string t3 in
                      Prims.op_Hat "Embedding not defined for type "
                        uu____4558 in
                    NoTacticEmbedding uu____4556 in
                  FStar_Exn.raise uu____4555 in
                            ...
                            let uu____4601 =
                              let uu____4602 =
                                ...
                                FStar_Extraction_ML_Syntax.MLC_String
                                  uu____4603 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu____4602 in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                              uu____4601 in
              ...
              | uu____4629 ->
                  ...
                  let default_branch =
                    ...
                    (FStar_Extraction_ML_Syntax.MLP_Wild,
                      FStar_Pervasives_Native.None, uu____4710) in
                  let body1 =
                    let uu____4733 =
                      let uu____4734 =
                          ...
                          let uu____4811 =
                            let uu____4812 =
                              let uu____4813 =
                                ...
                                FStar_Extraction_ML_Syntax.MLC_String
                                  uu____4814 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu____4813 in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                              uu____4812 in
                          let uu____4816 =
                            let uu____4819 = mk_lam "_" body1 in [uu____4819] in
                          ...
                          (let uu____4926 = FStar_Util.first_N n bs in
                           ...
                           | (bs1, rest) ->
                               let c1 =
                                 ...
                                 FStar_All.pipe_left
                                   FStar_Syntax_Syntax.mk_Total uu____5004 in
                               (bs1, c1))
                        else
                          (let msg =
                             let uu____5021 =
                             ...
                             let uu____5025 = FStar_Util.string_of_int n_bs in
                             FStar_Util.format3
                               "Embedding not defined for %s; expected arity at least %s; got %s"
                               uu____5021 uu____5023 uu____5025 in
                      ...
                      | (type_vars, bs2) ->
                            ...
                            FStar_List.mapi
                              (fun i ->
                                 fun tv ->
                                   ...
                                   Prims.op_Hat "tv_" uu____5402) type_vars in
                          let tvar_context =
                            FStar_List.map2
                              (fun b ->
                                 fun nm ->
                          ...
                          let rec aux loc accum_embeddings bs3 =
                            ...
                            | [] ->
                                ...
                                then
                                  ...
                                  let args =
                                    let uu____5519 =
                                      let uu____5522 =
                                        let uu____5525 = lid_to_name fv_lid1 in
                                        let uu____5526 =
                                          let uu____5529 =
                                            let uu____5530 =
                                              let uu____5531 =
                                            ...
                                            FStar_All.pipe_left
                                              (FStar_Extraction_ML_Syntax.with_ty
                                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                                              uu____5530 in
                                          [uu____5529; fv_lid_embedded; cb] in
                            ...
                            | (b, uu____5649)::bs4 ->
                                ...
                                aux loc uu____5669 bs4 in
                          (try
                             (fun uu___715_5694 ->
                                match () with
                                | () ->
                                    let uu____5707 = aux Syntax_term [] bs2 in
                                    (match uu____5707 with
                                     | (w1, a, b) ->
                                         let uu____5735 = aux NBE_t [] bs2 in
