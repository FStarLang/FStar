...
let udelta_unfold : FStar_Extraction_ML_UEnv.env  ->  FStar_Extraction_ML_Syntax.mlty  ->  FStar_Extraction_ML_Syntax.mlty Prims.option = (fun g uu___112_140 -> (match (uu___112_140) with
...
let eff_to_string : FStar_Extraction_ML_Syntax.e_tag  ->  Prims.string = (fun uu___113_166 -> (match (uu___113_166) with
...
in (FStar_All.pipe_left (fun _0_30 -> Some (_0_30)) uu____367))
...
let is_type_abstraction = (fun uu___114_536 -> (match (uu___114_536) with
...
let record_field_path : FStar_Ident.lident Prims.list  ->  Prims.string Prims.list = (fun uu___115_597 -> (match (uu___115_597) with
| (f)::uu____601 -> begin
(
