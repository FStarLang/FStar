    ...
    let cstr s =
      let uu____150 =
        FStar_All.pipe_right (FStar_Extraction_ML_Syntax.MLC_String s)
          (fun _0_19 -> FStar_Extraction_ML_Syntax.MLE_Const _0_19) in
    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Var x ->
          let uu____225 =
            FStar_Util.find_opt
              (fun uu____239 ->
                 match uu____239 with | (y, uu____245) -> y = x) subst1 in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Fun (t1, f, t2) ->
          let uu____262 =
            ...
            let uu____270 = subst_aux subst1 t2 in (uu____269, f, uu____270) in
    ...
    fun e ->
      fun t ->
        fun t' ->
             ...
             FStar_Extraction_ML_Syntax.MLTY_Fun (t1', f', t2')) ->
              let mk_fun xs body =
                ...
                | uu____590 ->
                    ...
                    FStar_Extraction_ML_Syntax.with_ty uu____629 e1 in
              (match e with
                           ...
                           let uu____693 =
                             let uu____696 =
                               let uu____697 =
                                 ...
                                 FStar_Extraction_ML_Syntax.with_ty uu____702 in
          ...
          | (FStar_Extraction_ML_Syntax.MLTY_Tuple ts,
             FStar_Extraction_ML_Syntax.MLTY_Tuple ts') ->
              let uu____873 = FStar_List.forall2 (type_leq unfold_ty) ts ts' in
              if uu____873
              then (true, e)
              else (false, FStar_Pervasives_Native.None)
    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (lty, mlp) ->
          ...
          then FStar_Extraction_ML_UEnv.erasedContent
            ...
            (let uu____1364 =
               let uu____1371 = FStar_List.map (eraseTypeDeep unfold_ty) lty in
               (uu____1371, mlp) in
...
let (argTypes :
  ...
  =
  fun t ->
    let uu____1535 = doms_and_cod t in FStar_Pervasives_Native.fst uu____1535
    ...
    fun fv ->
      fun t ->
        fun ml_fv ->
          ...
          let lid_to_name l =
            let uu____1679 =
              let uu____1680 = FStar_Extraction_ML_Syntax.mlpath_of_lident l in
              FStar_Extraction_ML_Syntax.MLE_Name uu____1680 in
            FStar_All.pipe_left
              (FStar_Extraction_ML_Syntax.with_ty
                 FStar_Extraction_ML_Syntax.MLTY_Top) uu____1679 in
          let lid_to_top_name l =
            let uu____1687 =
              let uu____1688 = FStar_Extraction_ML_Syntax.mlpath_of_lident l in
                        ...
                        let uu____1885 =
                          let uu____1894 =
                            FStar_Reflection_Data.fstar_refl_types_lid
                              "binder" in
                          (uu____1894, (Prims.parse_int "0"), "binder", R) in
                        let uu____1895 =
                          let uu____1906 =
                            let uu____1915 =
                              FStar_Reflection_Data.fstar_refl_syntax_lid
                                "binders" in
                            (uu____1915, (Prims.parse_int "0"), "binders", R) in
                          let uu____1916 =
                            let uu____1927 =
                              let uu____1938 =
                                let uu____1949 =
                          ...
                          let uu____2342 =
                            let uu____2351 =
                              FStar_Util.find_opt
                                ...
                                known_type_constructors in
                            FStar_All.pipe_right uu____2351 FStar_Util.must in
                ...
                let branch1 =
                  let uu____2484 =
                    let uu____2485 =
                      let uu____2486 =
                        let uu____2493 =
                          let uu____2496 = str_to_name "args_tail" in
                          [uu____2496] in
                        (body, uu____2493) in
                      FStar_Extraction_ML_Syntax.MLE_App uu____2486 in
                    FStar_All.pipe_left w uu____2485 in
                  (pattern, FStar_Pervasives_Native.None, uu____2484) in
                let default_branch =
                  let uu____2510 =
                    let uu____2511 =
                      let uu____2512 =
                        let uu____2519 = str_to_name "failwith" in
                        let uu____2520 =
                          let uu____2523 =
                            let uu____2524 =
                      ...
                      FStar_Extraction_ML_Syntax.MLE_App uu____2512 in
                    FStar_All.pipe_left w uu____2511 in
                  (FStar_Extraction_ML_Syntax.MLP_Wild,
                    FStar_Pervasives_Native.None, uu____2510) in
                let body1 =
                  let uu____2530 =
                    let uu____2531 =
                      let uu____2546 = str_to_name "args" in
                      (uu____2546, [branch1; default_branch]) in
                    FStar_Extraction_ML_Syntax.MLE_Match uu____2531 in
                  FStar_All.pipe_left w uu____2530 in
                mk_lam "args" body1 in
          let uu____2581 = FStar_Syntax_Util.arrow_formals_comp t1 in
                    ...
                    (fun uu____2673 ->
                       ...
                       | (b, uu____2679) ->
                           ...
                           (match uu____2680 with
                            | FStar_Syntax_Syntax.Tm_type uu____2684 -> false
                            | uu____2685 -> true)) bs in
               ...
               | (type_vars, bs1) ->
                   ...
                   let tvar_names =
                     FStar_List.mapi
                       (fun i ->
                          fun tv ->
                            let uu____2868 = FStar_Util.string_of_int i in
                            Prims.strcat "tv_" uu____2868) type_vars in
                   let tvar_context =
                     FStar_List.map2
                       (fun b ->
                   ...
                   let rec aux accum_embeddings env bs2 =
                     ...
                     | [] ->
                         ...
                         let uu____2960 = FStar_Syntax_Util.is_pure_comp c in
                         if uu____2960
                         then
                           let embed_fun_N =
                           ...
                           let args =
                             let uu____2979 =
                               let uu____2982 =
                                 let uu____2985 = lid_to_top_name fv in
                                 [uu____2985] in
                               res_embedding :: uu____2982 in
                             FStar_List.append arg_unembeddings uu____2979 in
                           let fun_embedding =
                             FStar_All.pipe_left w
                               (FStar_Extraction_ML_Syntax.MLE_App
                                  (embed_fun_N, args)) in
                           ...
                           let uu____2990 =
                             let uu____2997 = mk_lam "_psc" tabs in
                             (uu____2997, arity, true) in
                           FStar_Pervasives_Native.Some uu____2990
                         else
                           (let uu____3009 =
                              let uu____3010 =
                                FStar_TypeChecker_Env.norm_eff_name tcenv
                                  (FStar_Syntax_Util.comp_effect_name c) in
                              FStar_Ident.lid_equals uu____3010
                                    ...
                                    let uu____3037 =
                                      let uu____3038 =
                                        ...
                                        Prims.strcat
                                          ...
                                          uu____3039 in
                                      str_to_top_name uu____3038 in
                                    let uu____3046 =
                                      let uu____3049 = lid_to_top_name fv in
                                      [uu____3049] in
                                    (uu____3037, uu____3046) in
                                  FStar_Extraction_ML_Syntax.MLE_App
                                    uu____3030 in
                                FStar_All.pipe_left w uu____3029 in
                              let tac_lid_app =
                                let uu____3053 =
                                  let uu____3054 =
                                    let uu____3061 =
                                    ...
                                    (uu____3061, [w ml_fv]) in
                                  FStar_Extraction_ML_Syntax.MLE_App
                                    uu____3054 in
                                FStar_All.pipe_left w uu____3053 in
                                    ...
                                    FStar_All.pipe_left w
                                      (FStar_Extraction_ML_Syntax.MLE_Const
                                         (FStar_Extraction_ML_Syntax.MLC_Bool
                                            true)) in
                                  [uu____3072; tac_fun] in
                                FStar_List.append uu____3069
                                  (FStar_List.append arg_unembeddings
                                     [res_embedding; tac_lid_app; psc]) in
                              let tabs =
                                match tvar_names with
                                | [] ->
                                    let uu____3074 =
                                        ...
                                        (FStar_Extraction_ML_Syntax.MLE_App
                                           (h,
                                             (FStar_List.append args
                                                [all_args]))) in
                                    mk_lam "args" uu____3074
                                | uu____3077 ->
                                    let uu____3080 =
                                      FStar_All.pipe_left w
                                        (FStar_Extraction_ML_Syntax.MLE_App
                                           (h, args)) in
                                    abstract_tvars tvar_names uu____3080 in
                              let uu____3083 =
                                let uu____3090 = mk_lam "psc" tabs in
                                (uu____3090, (arity + (Prims.parse_int "1")),
                                  false) in
                              FStar_Pervasives_Native.Some uu____3083
                            else
                              (let uu____3104 =
                                 let uu____3105 =
                                   let uu____3106 =
                                   ...
                                   Prims.strcat
                                     ...
                                     uu____3106 in
                                 NoTacticEmbedding uu____3105 in
                               FStar_Exn.raise uu____3104))
                     | (b, uu____3116)::bs3 ->
                         let uu____3128 =
                           let uu____3131 =
                             mk_embedding env b.FStar_Syntax_Syntax.sort in
                           uu____3131 :: accum_embeddings in
                         aux uu____3128 env bs3 in
                   (try aux [] tvar_context bs1
                    with
                    | NoTacticEmbedding msg ->
                        ((let uu____3164 = FStar_Ident.string_of_lid fv in
