...
let mk_ty_fun:
  'Auu____192 .
    Prims.unit ->
      ('Auu____192,FStar_Extraction_ML_Syntax.mlty)
        FStar_Pervasives_Native.tuple2 Prims.list ->
        FStar_Extraction_ML_Syntax.mlty -> FStar_Extraction_ML_Syntax.mlty
  =
  fun uu____200  ->
                        ...
                        (let uu____361 =
                         ...
                         | (ok,body1) ->
                             let res =
                               ...
                               | uu____388 -> FStar_Pervasives_Native.None in
                             (ok, res)))
                   else (false, FStar_Pervasives_Native.None)
               | uu____393 ->
                   let uu____395 =
...
let is_type_abstraction:
  'Auu____525 'Auu____526 'Auu____527 .
    (('Auu____527,'Auu____526) FStar_Util.either,'Auu____525)
...
let is_xtuple:
  ...
  fun uu____568  ->
    ...
    | (ns,n1) ->
        let uu____577 =
          let uu____578 = FStar_Util.concat_l "." (FStar_List.append ns [n1]) in
...
let record_fields:
  'Auu____624 .
    FStar_Ident.lident Prims.list ->
      'Auu____624 Prims.list ->
        (Prims.string,'Auu____624) FStar_Pervasives_Native.tuple2 Prims.list
  =
  fun fs  ->
    fun vs  ->
      FStar_List.map2
...
let is_xtuple_ty:
  ...
  fun uu____650  ->
    ...
    | (ns,n1) ->
        let uu____659 =
          let uu____660 = FStar_Util.concat_l "." (FStar_List.append ns [n1]) in
...
let codegen_fsharp: Prims.unit -> Prims.bool =
  fun uu____680  ->
    let uu____681 =
      let uu____682 = FStar_Options.codegen () in FStar_Option.get uu____682 in
    uu____681 = "FSharp"
    ...
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (lty,mlp) ->
          ...
          then FStar_Extraction_ML_UEnv.erasedContent
            ...
            (let uu____769 =
               let uu____773 = FStar_List.map (eraseTypeDeep unfold_ty) lty in
               (uu____773, mlp) in
...
let rec doms_and_cod:
  ...
  fun t  ->
    match t with
    | FStar_Extraction_ML_Syntax.MLTY_Fun (a,uu____866,b) ->
        let uu____868 = doms_and_cod b in
        (match uu____868 with | (ds,c) -> ((a :: ds), c))
    | uu____880 -> ([], t)
let argTypes:
  FStar_Extraction_ML_Syntax.mlty ->
    FStar_Extraction_ML_Syntax.mlty Prims.list
  =
  fun t  ->
    let uu____887 = doms_and_cod t in FStar_Pervasives_Native.fst uu____887
let rec uncurry_mlty_fun:
  ...
  fun t  ->
    match t with
    | FStar_Extraction_ML_Syntax.MLTY_Fun (a,uu____902,b) ->
        let uu____904 = uncurry_mlty_fun b in
        (match uu____904 with | (args,res) -> ((a :: args), res))
    | uu____916 -> ([], t)