...
let (uu___is_Covariant : variance -> Prims.bool) =
  fun projectee  ->
    match projectee with | Covariant  -> true | uu____1504 -> false
  
let (uu___is_Contravariant : variance -> Prims.bool) =
  fun projectee  ->
    match projectee with | Contravariant  -> true | uu____1508 -> false
  
let (uu___is_Invariant : variance -> Prims.bool) =
  fun projectee  ->
    match projectee with | Invariant  -> true | uu____1512 -> false
    ...
    fun fv  ->
      fun t  ->
        fun ml_fv  ->
          ...
          let lid_to_name l =
            let uu____1541 =
              let uu____1542 = FStar_Extraction_ML_Syntax.mlpath_of_lident l
                 in
              FStar_Extraction_ML_Syntax.MLE_Name uu____1542  in
            FStar_All.pipe_left
              (FStar_Extraction_ML_Syntax.with_ty
                 FStar_Extraction_ML_Syntax.MLTY_Top) uu____1541
             in
          let lid_to_top_name l =
            let uu____1547 =
              let uu____1548 = FStar_Extraction_ML_Syntax.mlpath_of_lident l
                 in
              FStar_Extraction_ML_Syntax.MLE_Name uu____1548  in
            FStar_All.pipe_left
              (FStar_Extraction_ML_Syntax.with_ty
                 FStar_Extraction_ML_Syntax.MLTY_Top) uu____1547
             in
          let str_to_name s =
            let uu____1553 = FStar_Ident.lid_of_str s  in
            lid_to_name uu____1553  in
          let str_to_top_name s =
            let uu____1558 = FStar_Ident.lid_of_str s  in
            lid_to_top_name uu____1558  in
          ...
          let mk_lam nm e =
            FStar_All.pipe_left w
             ...
             in
          let id_embedding nm =
            let uu____1611 = mk_basic_embedding Embed "any"  in
            let uu____1612 = mk_basic_embedding Unembed "any"  in
            let uu____1613 = str_to_name nm  in
            {
              embed = uu____1611;
              unembed = uu____1612;
              type_repr = uu____1613
            }  in
          let known_type_constructors =
            let uu____1625 =
              let uu____1634 = fstar_syn_syn_prefix "t_int"  in
              (FStar_Parser_Const.int_lid, [], uu____1634)  in
            let uu____1637 =
              let uu____1648 =
                let uu____1657 = fstar_syn_syn_prefix "t_bool"  in
                (FStar_Parser_Const.bool_lid, [], uu____1657)  in
              let uu____1660 =
                let uu____1671 =
                  let uu____1680 = fstar_syn_syn_prefix "t_unit"  in
                  (FStar_Parser_Const.unit_lid, [], uu____1680)  in
                let uu____1683 =
                  let uu____1694 =
                    let uu____1703 = fstar_syn_syn_prefix "t_string"  in
                    (FStar_Parser_Const.string_lid, [], uu____1703)  in
                  let uu____1706 =
                    let uu____1717 =
                      let uu____1726 =
                        FStar_Reflection_Data.fstar_refl_types_lid "term"  in
                      let uu____1727 = fstar_refl_data_prefix "t_term"  in
                      (uu____1726, [], uu____1727)  in
                    let uu____1730 =
                      let uu____1741 =
                        let uu____1750 =
                          FStar_Reflection_Data.fstar_refl_types_lid "fv"  in
                        let uu____1751 = fstar_refl_data_prefix "t_fv"  in
                        ...
                        let uu____1765 =
                          let uu____1774 =
                            FStar_Reflection_Data.fstar_refl_types_lid
                              "binder"
                             in
                          let uu____1775 = fstar_refl_data_prefix "t_binder"
                             in
                                  ...
                                  let uu____1883 =
                                    ...
                                    let uu____1893 =
                                      fstar_tc_common_prefix "t_tuple2_of"
                                       in
                                    (uu____1892, [Covariant; Covariant],
                                      uu____1893)
                                     in
                                  [uu____1883]  in
                                uu____1860 :: uu____1872  in
                              uu____1837 :: uu____1849  in
                            uu____1813 :: uu____1826  in
                          uu____1789 :: uu____1802  in
                        uu____1765 :: uu____1778  in
                      uu____1741 :: uu____1754  in
                    uu____1717 :: uu____1730  in
                  uu____1694 :: uu____1706  in
                uu____1671 :: uu____1683  in
              uu____1648 :: uu____1660  in
            uu____1625 :: uu____1637  in
              ...
              let uu____2064 =
                FStar_Util.find_opt
                  (fun uu____2087  ->
                     ...
                     | (x,uu____2097,uu____2098) ->
                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                  known_type_constructors
                 in
              FStar_All.pipe_right uu____2064 FStar_Util.must  in
            match uu____2055 with
            | (uu____2129,variances,trepr_head) ->
                        ...
                        let uu____2176 =
                          let uu____2183 =
                            FStar_List.map (fun x  -> x.type_repr)
                              arg_embeddings
                             in
                          (trepr_head, uu____2183)  in
                        FStar_Extraction_ML_Syntax.MLE_App uu____2176  in
                      FStar_All.pipe_left w uu____2175
                   in
                let uu____2190 = mk1 Embed  in
                let uu____2191 = mk1 Unembed  in
                { embed = uu____2190; unembed = uu____2191; type_repr }
             in
          let find_env_entry bv uu____2202 =
            match uu____2202 with
            | (bv',uu____2208) -> FStar_Syntax_Syntax.bv_eq bv bv'  in
          let rec mk_embedding env t2 =
            let uu____2228 =
              let uu____2229 = FStar_Syntax_Subst.compress t2  in
            ...
            | FStar_Syntax_Syntax.Tm_name bv when
                ...
                FStar_Pervasives_Native.snd uu____2237
            | uu____2257 ->
                let t3 = FStar_TypeChecker_Normalize.unfold_whnf tcenv t2  in
                let uu____2259 = FStar_Syntax_Util.head_and_args t3  in
                (match uu____2259 with
                 | (head1,args) ->
                     ...
                     (match uu____2303 with
                      | FStar_Syntax_Syntax.Tm_refine (b,uu____2308) ->
                          ...
                          let arg_embeddings =
                            FStar_List.map
                              (fun uu____2328  ->
                                 ...
                                 | (t4,uu____2334) -> mk_embedding env t4)
                              args
                             in
                      ...
                      | uu____2335 ->
                          let uu____2336 =
                            ...
                            (FStar_Errors.Fatal_CallNotImplemented,
                              uu____2341)
                             in
                          FStar_Errors.raise_err uu____2336))
             in
                ...
                let branch1 =
                  let uu____2391 =
                    let uu____2392 =
                      let uu____2393 =
                        let uu____2400 =
                          let uu____2403 = str_to_name "args_tail"  in
                          [uu____2403]  in
                        (body, uu____2400)  in
                      FStar_Extraction_ML_Syntax.MLE_App uu____2393  in
                    FStar_All.pipe_left w uu____2392  in
                  (pattern, FStar_Pervasives_Native.None, uu____2391)  in
                let default_branch =
                  let uu____2417 =
                    let uu____2418 =
                      let uu____2419 =
                        let uu____2426 = str_to_name "failwith"  in
                        let uu____2427 =
                          let uu____2430 =
                            let uu____2431 =
                      ...
                      FStar_Extraction_ML_Syntax.MLE_App uu____2419  in
                    FStar_All.pipe_left w uu____2418  in
                  (FStar_Extraction_ML_Syntax.MLP_Wild,
                    FStar_Pervasives_Native.None, uu____2417)
                   in
                let body1 =
                  let uu____2437 =
                    let uu____2438 =
                      let uu____2453 = str_to_name "args"  in
                      (uu____2453, [branch1; default_branch])  in
                    FStar_Extraction_ML_Syntax.MLE_Match uu____2438  in
                  FStar_All.pipe_left w uu____2437  in
                mk_lam "args" body1
             in
          let uu____2488 = FStar_Syntax_Util.arrow_formals_comp t1  in
                    ...
                    (fun uu____2580  ->
                       ...
                       | (b,uu____2586) ->
                           ...
                           (match uu____2587 with
                            | FStar_Syntax_Syntax.Tm_type uu____2591 -> false
                            | uu____2592 -> true)) bs
                   in
               ...
               | (type_vars,bs1) ->
                   ...
                   let tvar_names =
                     FStar_List.mapi
                       (fun i  ->
                          fun tv  ->
                            let uu____2775 = FStar_Util.string_of_int i  in
                            Prims.strcat "tv_" uu____2775) type_vars
                      in
                   let tvar_context =
                     FStar_List.map2
                       (fun b  ->
                          fun nm  ->
                            let uu____2800 = id_embedding nm  in
                            ((FStar_Pervasives_Native.fst b), uu____2800))
                   ...
                   let rec aux accum_embeddings env bs2 =
                     ...
                     | [] ->
                         ...
                         let uu____2869 = FStar_Syntax_Util.is_pure_comp c
                            in
                         if uu____2869
                         then
                           let embed_fun_N =
                             let uu____2879 =
                               ...
                               Prims.strcat "arrow_" uu____2880  in
                             mk_basic_embedding Embed uu____2879  in
                           let args =
                             let uu____2890 =
                               let uu____2893 =
                                 let uu____2896 = lid_to_top_name fv  in
                                 [uu____2896]  in
                               (res_embedding.embed) :: uu____2893  in
                             FStar_List.append arg_unembeddings uu____2890
                              in
                           let fun_embedding =
                             FStar_All.pipe_left w
                               (FStar_Extraction_ML_Syntax.MLE_App
                           ...
                           let tabs = abstract_tvars tvar_names fun_embedding
                              in
                           let uu____2901 =
                             let uu____2908 = mk_lam "_psc" tabs  in
                             (uu____2908, arity, true)  in
                           ...
                           (let uu____2920 =
                              let uu____2921 =
                                FStar_TypeChecker_Env.norm_eff_name tcenv
                                 ...
                                 in
                              FStar_Ident.lid_equals uu____2921
                            ...
                            then
                                    ...
                                    let uu____2948 =
                                      let uu____2949 =
                                        ...
                                        Prims.strcat
                                          ...
                                          uu____2950
                                         in
                                      str_to_top_name uu____2949  in
                                    let uu____2957 =
                                      let uu____2960 = lid_to_top_name fv  in
                                      [uu____2960]  in
                                    (uu____2948, uu____2957)  in
                                  FStar_Extraction_ML_Syntax.MLE_App
                                    uu____2941
                                   in
                                FStar_All.pipe_left w uu____2940  in
                              let tac_lid_app =
                                let uu____2964 =
                                  let uu____2965 =
                                    let uu____2972 =
                                      str_to_top_name
                                       ...
                                       in
                                    (uu____2972, [w ml_fv])  in
                                  FStar_Extraction_ML_Syntax.MLE_App
                                    uu____2965
                                   in
                                FStar_All.pipe_left w uu____2964  in
                                    ...
                                    FStar_All.pipe_left w
                                      (FStar_Extraction_ML_Syntax.MLE_Const
                                         (FStar_Extraction_ML_Syntax.MLC_Bool
                                            true))
                                     in
                                  [uu____2983; tac_fun]  in
                                FStar_List.append uu____2980
                                    ...
                                    let uu____2993 =
                                      FStar_All.pipe_left w
                                        (FStar_Extraction_ML_Syntax.MLE_App
                                           (h, args1))
                                       in
                                    mk_lam "args" uu____2993  in
                                  FStar_All.pipe_left (mk_lam "psc")
                                    uu____2992
                                   in
                                (uu____2991, arity, false)  in
                              ...
                              (let uu____3007 =
                                 ...
                                 (FStar_Errors.Fatal_CallNotImplemented,
                                   uu____3012)
                                  in
                               FStar_Errors.raise_err uu____3007))
                     | (b,uu____3023)::bs3 ->
                         let uu____3035 =
                           let uu____3038 =
                             mk_embedding env b.FStar_Syntax_Syntax.sort  in
                           uu____3038 :: accum_embeddings  in
                         aux uu____3035 env bs3
                      in
