    ...
    let cint i =
      let uu___ =
        ...
        FStar_All.pipe_right uu___1
          (fun uu___2  -> FStar_Extraction_ML_Syntax.MLE_Const uu___2)
         in
    ...
    let cstr s =
      let uu___ =
        FStar_All.pipe_right (FStar_Extraction_ML_Syntax.MLC_String s)
          (fun uu___1  -> FStar_Extraction_ML_Syntax.MLE_Const uu___1)
         in
      FStar_All.pipe_right uu___
        (FStar_Extraction_ML_Syntax.with_ty
  ...
  fun subst  ->
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Var x ->
          let uu___ =
            FStar_Util.find_opt
              (fun uu___1  -> match uu___1 with | (y,uu___2) -> y = x) subst
             in
          (match uu___ with
    ...
    fun args  ->
      ...
      | (formals,t) ->
          ...
          then FStar_Pervasives_Native.None
            ...
            (let uu___2 =
               let uu___3 = FStar_List.zip formals args  in
             ...
             (t1,f,t2),FStar_Extraction_ML_Syntax.MLTY_Fun (t1',f',t2')) ->
              let mk_fun xs body =
                ...
                | uu___ ->
                    ...
                    FStar_Extraction_ML_Syntax.with_ty uu___1 e1
                 in
              (match e with
               | FStar_Pervasives_Native.Some
                   ...
                   ->
                   let uu___2 = (type_leq unfold_ty t1' t1) && (eff_leq f f')
                      in
                   if uu___2
                   then
                     (if
                      ...
                      then
                               ...
                               let uu___6 =
                                 let uu___7 =
                                   mk_ty_fun [x]
                                    ...
                                    in
                                 FStar_Extraction_ML_Syntax.with_ty uu___7
                                  in
                        ...
                        (let uu___4 =
                           let uu___5 =
                             ...
                             FStar_All.pipe_left
                               (fun uu___7  ->
                                  FStar_Pervasives_Native.Some uu___7) uu___6
                              in
...
let (record_field_path :
  ...
  fun uu___  ->
    ...
    | f::uu___1 ->
        let uu___2 =
          let uu___3 = FStar_Ident.ns_of_lid f  in FStar_Util.prefix uu___3
           in
        (match uu___2 with
         | (ns,uu___3) ->
  ...
  fun l  ->
    let mlp =
      let uu___ =
        ...
        FStar_All.pipe_right uu___1 (FStar_List.map FStar_Ident.string_of_id)
         in
      let uu___1 =
          ...
          fun ml_fv  ->
            ...
            let t1 =
              FStar_TypeChecker_Normalize.normalize
                ...
                FStar_TypeChecker_Env.ForExtraction] tcenv t
               in
            let w =
              FStar_Extraction_ML_Syntax.with_ty
                FStar_Extraction_ML_Syntax.MLTY_Top
            ...
            let lid_to_name l =
              let uu___ =
                let uu___1 = FStar_Extraction_ML_UEnv.mlpath_of_lident env l
                   in
                FStar_Extraction_ML_Syntax.MLE_Name uu___1  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu___
               in
                ...
                let uu___1 =
                  ...
                  let uu___3 =
                    let uu___4 =
                      ...
                      FStar_All.pipe_left
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu___5
                       in
                    [uu___4]  in
                  (uu___2, uu___3)  in
            ...
            let emb_arrow l e1 e2 =
              let uu___ =
                let uu___1 =
                  let uu___2 = emb_prefix l "e_arrow"  in (uu___2, [e1; e2])
                   in
                FStar_Extraction_ML_Syntax.MLE_App uu___1  in
              FStar_All.pipe_left w uu___  in
              ...
              let nbe_cs =
                FStar_List.map
                  (fun uu___  ->
                     ...
                     | uu___1 -> failwith "Impossible") term_cs
                 in
              fun uu___  ->
                match uu___ with
                | Syntax_term  -> term_cs
            ...
            let rec mk_embedding l env1 t2 =
              let t3 =
                FStar_TypeChecker_Normalize.unfold_whnf'
                  [FStar_TypeChecker_Env.ForExtraction] tcenv t2
                 in
              let uu___ =
              ...
              | FStar_Syntax_Syntax.Tm_arrow (b::more::bs,c) ->
                  ...
                  let t4 =
                    ...
                    FStar_Syntax_Syntax.mk uu___1 t3.FStar_Syntax_Syntax.pos
                     in
                  mk_embedding l env1 t4
                   ...
                   | (head,args) ->
                       ...
                       (match uu___3 with
                        | FStar_Syntax_Syntax.Tm_fvar fv1 when
                            ...
                            let arg_embeddings =
                              FStar_All.pipe_right args
                                (FStar_List.map
                                   (fun uu___4  ->
                                      match uu___4 with
                                      | (t4,uu___5) -> mk_embedding l env1 t4))
                               in
                            let nm =
                              let uu___4 =
                            ...
                            (match uu___4 with
                             | ((uu___5,t_arity,_trepr_head),loc_embedding)
                                 ->
                                 let head1 =
                        ...
                        | uu___4 ->
                            let uu___5 =
                              let uu___6 =
                                ...
                                Prims.op_Hat
                                  "Embedding not defined for type " uu___7
                                 in
              ...
              | uu___1 ->
                  let uu___2 =
                    let uu___3 =
                      ...
                      Prims.op_Hat "Embedding not defined for type " uu___4
                       in
                    NoTacticEmbedding uu___3  in
                  FStar_Exn.raise uu___2
               in
                      ...
                      let uu___1 =
                        ...
                        let uu___3 =
                          let uu___4 =
                            let uu___5 =
                              let uu___6 =
                                let uu___7 = FStar_Ident.string_of_lid fv_lid
                                   in
                                FStar_Extraction_ML_Syntax.MLC_String uu___7
                                 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu___6  in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                ...
                                let uu___8 =
                                  let uu___9 =
                                    let uu___10 =
                                      ...
                                      [uu___11]  in
                                    (body, uu___10)  in
                                  FStar_Extraction_ML_Syntax.MLE_App uu___9
                                   in
                  ...
                  let branch =
                    let uu___1 =
                      let uu___2 =
                        let uu___3 =
                          let uu___4 =
                            let uu___5 = as_name ([], "args")  in [uu___5]
                             in
                          (body, uu___4)  in
                      ...
                      let uu___2 =
                        ...
                        let uu___4 =
                          let uu___5 =
                            let uu___6 =
                              let uu___7 =
                                let uu___8 = FStar_Ident.string_of_lid fv_lid
                                   in
                                FStar_Extraction_ML_Syntax.MLC_String uu___8
                                 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu___7  in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top) uu___6
                             in
                          let uu___6 =
                      ...
                      then (bs, c)
                        ...
                        then
                          (let uu___3 = FStar_Util.first_N n bs  in
                           ...
                           | (bs1,rest) ->
                               let c1 =
                                 let uu___4 = FStar_Syntax_Util.arrow rest c
                                    in
                                 FStar_All.pipe_left
                                   FStar_Syntax_Syntax.mk_Total uu___4
                                  in
                               (bs1, c1))
                        else
                          (let msg =
                             let uu___4 = FStar_Ident.string_of_lid fv_lid
                                in
                      ...
                      | (type_vars,bs2) ->
                          ...
                          let tvar_names =
                            FStar_List.mapi
                              (fun i  ->
                                 fun tv  ->
                                   let uu___3 = FStar_Util.string_of_int i
                                      in
                                   Prims.op_Hat "tv_" uu___3) type_vars
                             in
                          let tvar_context =
                            FStar_List.map2
                              (fun b  ->
                            ...
                            | [] ->
                                ...
                                then
                                  ...
                                  let args =
                                    ...
                                    FStar_List.append arg_unembeddings uu___4
                                     in
                                  let fun_embedding =
                                    FStar_All.pipe_left w
                                      (FStar_Extraction_ML_Syntax.MLE_App
                                           ...
                                           let uu___7 =
                                             FStar_All.pipe_left w
                                               (FStar_Extraction_ML_Syntax.MLE_App
                                                  (h, args))
                                              in
                                           abstract_tvars tvar_names uu___7
                                        in
                                     let uu___6 =
