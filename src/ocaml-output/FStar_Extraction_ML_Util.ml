                        ...
                        | FStar_Syntax_Syntax.Tm_fvar fv1 when
                            ...
                            (match uu____3743 with
                             | ((uu____3856,t_arity,_trepr_head),loc_embedding)
                                 ...
                                 (match t_arity with
                                  | uu____3873 when
                                      uu____3873 = Prims.int_zero -> head2
                                  | n1 ->
                                      FStar_All.pipe_left w
                        ...
                        | FStar_Syntax_Syntax.Tm_fvar fv1 when
                            ...
                            (match uu____3986 with
                             | ((uu____4099,t_arity,_trepr_head),loc_embedding)
                                 ...
                                 (match t_arity with
                                  | uu____4116 when
                                      uu____4116 = Prims.int_zero -> head2
                                  | n1 ->
                                      FStar_All.pipe_left w
                                        (FStar_Extraction_ML_Syntax.MLE_App
                                           (head2, arg_embeddings))))
                        ...
                        | FStar_Syntax_Syntax.Tm_fvar fv1 when
                            ...
                            (match uu____4239 with
                             | ((uu____4352,t_arity,_trepr_head),loc_embedding)
                                 ...
                                 (match t_arity with
                                  | uu____4369 when
                                      uu____4369 = Prims.int_zero -> head2
                                  | n1 ->
                                      FStar_All.pipe_left w
                                        (FStar_Extraction_ML_Syntax.MLE_App
                                           (head2, arg_embeddings))))
                ...
                let uu____4636 =
                  ...
                  | FStar_Pervasives_Native.Some n1 ->
                      ...
                      then (bs, c)
                        ...
                        if n1 < n_bs
                        then
                          (let uu____4729 = FStar_Util.first_N n1 bs  in
                           ...
                           | (bs1,rest) ->
                               let c1 =
                                 ...
                                 FStar_All.pipe_left
                                   FStar_Syntax_Syntax.mk_Total uu____4807
                                  in
                               (bs1, c1))
                        else
                          (let msg =
                             let uu____4824 =
                               FStar_Ident.string_of_lid fv_lid1  in
                             let uu____4826 = FStar_Util.string_of_int n1  in
                             let uu____4828 = FStar_Util.string_of_int n_bs
                                in
                             FStar_Util.format3
                               "Embedding not defined for %s; expected arity at least %s; got %s"
                               uu____4824 uu____4826 uu____4828
                              in
                           ...
                           (fun uu____4942  ->
                              ...
                              | (b,uu____4951) ->
                                  ...
                                  (match uu____4956 with
                                   | FStar_Syntax_Syntax.Tm_type uu____4961
                                       -> false
                                   | uu____4963 -> true)) bs1
                          in
                            ...
                            FStar_List.mapi
                              (fun i  ->
                                 fun tv  ->
                                   ...
                                   Prims.op_Hat "tv_" uu____5205) type_vars
                             in
                          let tvar_context =
                            FStar_List.map2
                              (fun b  ->
                                        ...
                                        let uu____5329 =
                                          let uu____5332 =
                                            ...
                                            FStar_All.pipe_left
                                              ...
                                              uu____5333
                                             in
                                          [uu____5332; fv_lid_embedded; cb]
                                           in
                                        uu____5328 :: uu____5329  in
                                      res_embedding :: uu____5325  in
                                     ...
                                     let uu____5378 =
                                       FStar_TypeChecker_Env.norm_eff_name
                                         ...
                                         (FStar_Syntax_Util.comp_effect_name
                                            c1)
                                        in
                                     FStar_Ident.lid_equals uu____5378
                                   ...
                                   then
                                           ...
                                           let uu____5402 =
                                             let uu____5403 =
                                               ...
                                               Prims.op_Hat
                                                 ...
                                                 uu____5405
                                                in
                                             str_to_top_name uu____5403  in
                                           let uu____5407 =
                                             let uu____5410 =
                                               lid_to_top_name fv_lid2  in
                                             [uu____5410]  in
                                           (uu____5402, uu____5407)  in
                                         FStar_Extraction_ML_Syntax.MLE_App
                                           uu____5395
                                          in
                                       FStar_All.pipe_left w uu____5394  in
                                     ...
                                     let tabs =
                                       ...
                                       | uu____5428 ->
                                        ...
                                        in
                                     let uu____5435 =
                                       let uu____5436 = mk_lam "ncb" tabs  in
                                       mk_lam "psc" uu____5436  in
                                     (uu____5435, (arity + Prims.int_one),
                                       false)
                                   else
                                     (let uu____5445 =
                                        let uu____5446 =
                                          ...
                                          Prims.op_Hat
                                            ...
                                            uu____5448
                                           in
                                        NoTacticEmbedding uu____5446  in
                                      FStar_Exn.raise uu____5445))
                            | (b,uu____5460)::bs4 ->
                                let uu____5480 =
                                  let uu____5483 =
                                    mk_embedding loc tvar_context
                                      b.FStar_Syntax_Syntax.sort
                                     in
                                  uu____5483 :: accum_embeddings  in
                                aux loc uu____5480 bs4
                             in
                          (try
                             (fun uu___687_5505  ->
                                match () with
                                | () ->
                                    let uu____5518 = aux Syntax_term [] bs2
                                       in
                                    (match uu____5518 with
                                     | (w1,a,b) ->
                                         let uu____5546 = aux NBE_t [] bs2
                                            in
                                         (match uu____5546 with
                                          | (w',uu____5568,uu____5569) ->
                                              FStar_Pervasives_Native.Some
                                                (w1, w', a, b)))) ()
                           with
                           | NoTacticEmbedding msg ->
                               ((let uu____5605 =
                                 ...
                                 not_implemented_warning
                                   t1.FStar_Syntax_Syntax.pos uu____5605 msg);
                                FStar_Pervasives_Native.None))))
