  ...
  fun l ->
    FStar_List.fold_right
      (fun x ll ->
        ...
        | FStar_Pervasives_Native.None -> ll )
      l []
...
let mlconst_of_const'
  ...
  fun sctt ->
    ...
    | FStar_Const.Const_int (s, i) -> FStar_Extraction_ML_Syntax.MLC_Int (s, i)
      ...
      let uu____95 =
        let uu____96 =
          let uu____97 =
            ...
            (uu____108, FStar_Pervasives_Native.None)
          in
          FStar_Extraction_ML_Syntax.MLC_Int uu____97
        in
        FStar_All.pipe_right uu____96 (fun _0_41 ->
    ...
    let uu____124 =
      let uu____131 =
        let uu____134 =
          ...
          FStar_All.pipe_right uu____135 cstr
        in
        let uu____136 =
          let uu____139 =
            let uu____140 =
              let uu____141 = FStar_Range.start_of_range r in
              FStar_All.pipe_right uu____141 FStar_Range.line_of_pos
            in
            FStar_All.pipe_right uu____140 cint
          in
          let uu____142 =
            let uu____145 =
              let uu____146 =
                let uu____147 = FStar_Range.start_of_range r in
                FStar_All.pipe_right uu____147 FStar_Range.col_of_pos
              in
              FStar_All.pipe_right uu____146 cint
            in
            let uu____148 =
              let uu____151 =
                let uu____152 =
                  let uu____153 = FStar_Range.end_of_range r in
                  FStar_All.pipe_right uu____153 FStar_Range.line_of_pos
                in
                FStar_All.pipe_right uu____152 cint
              in
              let uu____154 =
                let uu____157 =
                  let uu____158 =
                    let uu____159 = FStar_Range.end_of_range r in
                    FStar_All.pipe_right uu____159 FStar_Range.col_of_pos
                  in
                  FStar_All.pipe_right uu____158 cint
                in
                [uu____157]
              in
              uu____151 :: uu____154
...
let rec subst_aux
  ...
  fun subst1 t ->
    ...
    | FStar_Extraction_ML_Syntax.MLTY_Var x -> (
        let uu____190 =
          FStar_Util.find_opt
            (fun uu____204 -> match uu____204 with y, uu____210 -> y = x)
            subst1
        in
    ...
    | FStar_Extraction_ML_Syntax.MLTY_Fun (t1, f, t2) ->
        let uu____227 =
          ...
          let uu____235 = subst_aux subst1 t2 in
          (uu____234, f, uu____235)
        in
...
let try_subst
  ...
  fun uu____268 args ->
    match uu____268 with formals, t ->
      if FStar_List.length formals <> FStar_List.length args then
        FStar_Pervasives_Native.None
      else
        let uu____279 =
          let uu____280 = FStar_List.zip formals args in
          subst_aux uu____280 t
        in
    ...
    | FStar_Extraction_ML_Syntax.MLTY_Named (args, n1) -> (
        ...
        | FStar_Pervasives_Native.Some ts -> (
            ...
            | FStar_Pervasives_Native.None ->
                let uu____328 =
                  let uu____329 =
                    FStar_Extraction_ML_Syntax.string_of_mlpath n1
                  in
                  let uu____330 =
...
let eff_leq
  ...
  fun f f' ->
    ...
    | FStar_Extraction_ML_Syntax.E_GHOST, FStar_Extraction_ML_Syntax.E_GHOST ->
        true
    | FStar_Extraction_ML_Syntax.E_IMPURE, FStar_Extraction_ML_Syntax.E_IMPURE ->
        true
    | uu____346 -> false
...
let join
    : FStar_Range.range -> FStar_Extraction_ML_Syntax.e_tag
      -> FStar_Extraction_ML_Syntax.e_tag -> FStar_Extraction_ML_Syntax.e_tag =
  fun r f f' ->
    match (f, f') with
    | FStar_Extraction_ML_Syntax.E_IMPURE, FStar_Extraction_ML_Syntax.E_PURE ->
        FStar_Extraction_ML_Syntax.E_IMPURE
    | FStar_Extraction_ML_Syntax.E_PURE, FStar_Extraction_ML_Syntax.E_IMPURE ->
        FStar_Extraction_ML_Syntax.E_IMPURE
    | FStar_Extraction_ML_Syntax.E_IMPURE, FStar_Extraction_ML_Syntax.E_IMPURE ->
        FStar_Extraction_ML_Syntax.E_IMPURE
    | FStar_Extraction_ML_Syntax.E_GHOST, FStar_Extraction_ML_Syntax.E_GHOST ->
        FStar_Extraction_ML_Syntax.E_GHOST
    | FStar_Extraction_ML_Syntax.E_PURE, FStar_Extraction_ML_Syntax.E_GHOST ->
        FStar_Extraction_ML_Syntax.E_GHOST
    | FStar_Extraction_ML_Syntax.E_GHOST, FStar_Extraction_ML_Syntax.E_PURE ->
        FStar_Extraction_ML_Syntax.E_GHOST
    | FStar_Extraction_ML_Syntax.E_PURE, FStar_Extraction_ML_Syntax.E_PURE ->
        FStar_Extraction_ML_Syntax.E_PURE
    | uu____363 ->
        let uu____368 =
          let uu____369 = FStar_Range.string_of_range r in
          FStar_Util.format3 "Impossible (%s): Inconsistent effects %s and %s"
            uu____369 (eff_to_string f) (eff_to_string f')
        in
        failwith uu____368


let join_l
    : FStar_Range.range -> FStar_Extraction_ML_Syntax.e_tag Prims.list
...
let mk_ty_fun:
      ...
      -> FStar_Extraction_ML_Syntax.mlty =
  fun uu____394 ->
    FStar_List.fold_right (fun uu____403 t ->
        match uu____403 with uu____409, t0 ->
  ...
  fun unfold_ty e t t' ->
    ...
    | ( FStar_Extraction_ML_Syntax.MLTY_Fun (t1, f, t2)
      ...
      -> (
        let mk_fun xs body =
          ...
          | uu____496 ->
              let e1 =
                ...
                | uu____528 -> FStar_Extraction_ML_Syntax.MLE_Fun (xs, body)
              in
              let uu____535 =
        ...
        | FStar_Pervasives_Native.Some
            ...
            let uu____567 = type_leq unfold_ty t1' t1 && eff_leq f f' in
            if uu____567 then
              if f = FStar_Extraction_ML_Syntax.E_PURE
              ...
              then
                ...
                if uu____583 then
                  let body1 =
                    ...
                    in
                    if uu____594 then FStar_Extraction_ML_Syntax.ml_unit
                    else
                      FStar_All.pipe_left
                  ...
                  let uu____599 =
                    let uu____602 =
                      ...
                      FStar_All.pipe_left uu____603
                        (FStar_Extraction_ML_Syntax.MLE_Fun ([x], body1))
                    in
                    FStar_Pervasives_Native.Some uu____602
                  in
                  (true, uu____599)
                ...
                let uu____635 =
                  let uu____642 =
                    ...
                    FStar_All.pipe_left
                      ...
                      uu____645
                  in
                  type_leq_c unfold_ty uu____642 t2 t2'
                in
                match uu____635 with ok, body1 ->
                  let res =
                    match body1 with
        ...
        | uu____686 ->
            ...
            in
            if uu____689 then (true, e)
            else (false, FStar_Pervasives_Native.None) )
    | ( FStar_Extraction_ML_Syntax.MLTY_Named (args, path)
      , FStar_Extraction_ML_Syntax.MLTY_Named (args', path') )
      -> (
        if path = path' then
          let uu____725 = FStar_List.forall2 (type_leq unfold_ty) args args' in
          if uu____725 then (true, e) else (false, FStar_Pervasives_Native.None)
        else
    ...
    | ( FStar_Extraction_ML_Syntax.MLTY_Tuple ts
      , FStar_Extraction_ML_Syntax.MLTY_Tuple ts' ) ->
        ...
        if uu____777 then (true, e) else (false, FStar_Pervasives_Native.None)
    | FStar_Extraction_ML_Syntax.MLTY_Top, FStar_Extraction_ML_Syntax.MLTY_Top ->
        (true, e)
...
and type_leq
    : unfold_t -> FStar_Extraction_ML_Syntax.mlty
...
let is_type_abstraction:
      ...
      ( ('Auu____883, 'Auu____882) FStar_Util.either
      , 'Auu____881 )
      FStar_Pervasives_Native.tuple2
...
let record_field_path
  ...
  fun uu___62_999 ->
    ...
    | f :: uu____1005 -> (
        ...
        match uu____1008 with ns, uu____1018 ->
...
let record_fields:
      'Auu____1037. FStar_Ident.lident Prims.list -> 'Auu____1037 Prims.list
      -> (Prims.string, 'Auu____1037) FStar_Pervasives_Native.tuple2 Prims.list =
  fun fs vs ->
    FStar_List.map2
      (fun f e -> (f.FStar_Ident.ident.FStar_Ident.idText, e))
      fs vs
...
let is_xtuple_ty
    : (Prims.string Prims.list, Prims.string) FStar_Pervasives_Native.tuple2
      -> Prims.int FStar_Pervasives_Native.option =
  fun uu____1078 ->
    match uu____1078 with ns, n1 ->
      let uu____1093 =
        let uu____1094 = FStar_Util.concat_l "." (FStar_List.append ns [n1]) in
        FStar_Parser_Const.is_tuple_constructor_string uu____1094
      in
      if uu____1093 then
        let uu____1097 =
          let uu____1098 = FStar_Util.char_at n1 (Prims.parse_int "5") in
          FStar_Util.int_of_char uu____1098
        in
...
let flatten_ns : Prims.string Prims.list -> Prims.string =
  fun ns ->
    ...
    if uu____1124 then FStar_String.concat "." ns
...
let flatten_mlpath
    : (Prims.string Prims.list, Prims.string) FStar_Pervasives_Native.tuple2
      -> Prims.string =
  fun uu____1134 ->
    match uu____1134 with ns, n1 ->
      let uu____1147 = FStar_Options.codegen_fsharp () in
      if uu____1147 then FStar_String.concat "." (FStar_List.append ns [n1])
...
let prims_op_amp_amp : FStar_Extraction_ML_Syntax.mlexpr =
  let uu____1254 =
    ...
    in
    FStar_Extraction_ML_Syntax.with_ty uu____1257
  in
...
let conjoin
  ...
  fun e1 e2 ->
    FStar_All.pipe_left
      (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty)
...
let mlloc_of_range
  ...
  fun r ->
    ...
    let uu____1332 = FStar_Range.file_of_range r in
    (line, uu____1332)
...
let not_implemented_warning
  ...
  fun r t msg ->
    let uu____1442 =
      let uu____1447 =
        FStar_Util.format2 ". Tactic %s will not run natively because %s.\n" t
          msg
      in
      (FStar_Errors.Warning_CallNotImplementedAsWarning, uu____1447)
    in
    FStar_Errors.log_issue r uu____1442


type emb_decl = Embed | Unembed [@@deriving show]

let uu___is_Embed : emb_decl -> Prims.bool =
  fun projectee -> match projectee with Embed -> true | uu____1451 -> false


let uu___is_Unembed : emb_decl -> Prims.bool =
  fun projectee -> match projectee with Unembed -> true | uu____1455 -> false
...
let lid_to_top_name : FStar_Ident.lident -> FStar_Extraction_ML_Syntax.mlexpr =
  fun l ->
    let uu____1463 =
      ...
      FStar_Extraction_ML_Syntax.MLE_Name uu____1464
    in
    FStar_All.pipe_left
      (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top)
      uu____1463
...
let str_to_name : Prims.string -> FStar_Extraction_ML_Syntax.mlexpr' =
  fun s ->
    let uu____1468 = FStar_Ident.lid_of_str s in
    lid_to_name uu____1468


let str_to_top_name : Prims.string -> FStar_Extraction_ML_Syntax.mlexpr =
  fun s ->
    let uu____1472 = FStar_Ident.lid_of_str s in
    lid_to_top_name uu____1472
...
let fstar_tc_common_prefix : Prims.string -> FStar_Extraction_ML_Syntax.mlexpr' =
...
let fstar_refl_data_prefix : Prims.string -> FStar_Extraction_ML_Syntax.mlexpr' =
  fun s -> str_to_name (Prims.strcat "FStar_Reflection_Data." s)


let fstar_emb_basic_prefix : Prims.string -> FStar_Extraction_ML_Syntax.mlexpr' =
  ...
  fun args ->
    ...
    let reify_tactic =
      let uu____1509 =
        let uu____1510 =
          let uu____1517 =
            str_to_top_name "FStar_Tactics_Interpreter.reify_tactic"
          in
          let uu____1518 =
            let uu____1521 = str_to_top_name tac_arg in
            [uu____1521]
          in
          (uu____1517, uu____1518)
        in
        FStar_Extraction_ML_Syntax.MLE_App uu____1510
      in
      FStar_All.pipe_left
        (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top)
        uu____1509
    ...
    let from_tac =
      let uu____1525 =
        ...
        in
        Prims.strcat "FStar_Tactics_Builtins.from_tac_" uu____1526
      in
      str_to_top_name uu____1525
    in
    let unembed_tactic =
      let uu____1528 =
        let uu____1529 =
                    ...
                    let uu____1550 =
                      let uu____1553 =
                        FStar_List.map
                          ...
                          args
                      in
                      FStar_List.append uu____1553 [reify_tactic]
                    in
                    (unembed_tactic, uu____1550)
                  in
          ...
          let uu____1561 =
            let uu____1566 =
              ...
              FStar_Util.format1
                ...
                uu____1567
            in
            (FStar_Errors.Fatal_CallNotImplemented, uu____1566)
          in
  ...
  fun tcenv t ->
    let rec try_mk t1 unrefined =
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.int_lid ->
          fstar_syn_syn_prefix "t_int"
      | FStar_Syntax_Syntax.Tm_fvar fv
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.bool_lid ->
          fstar_syn_syn_prefix "t_bool"
      | FStar_Syntax_Syntax.Tm_fvar fv
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.unit_lid ->
          fstar_syn_syn_prefix "t_unit"
      | FStar_Syntax_Syntax.Tm_fvar fv
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.string_lid ->
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv
        when let uu____1620 =
               FStar_Reflection_Data.fstar_refl_syntax_lid "binder"
             in
             FStar_Syntax_Syntax.fv_eq_lid fv uu____1620 ->
          fstar_refl_data_prefix "t_binders"
      | FStar_Syntax_Syntax.Tm_fvar fv
        when let uu____1622 =
               FStar_Reflection_Data.fstar_refl_syntax_lid "norm_step"
             in
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv
                when FStar_Syntax_Syntax.fv_eq_lid fv
                  ...
                  let arg_term =
                    ...
                    FStar_Pervasives_Native.fst uu____1663
                  in
                  let uu____1678 =
                    let uu____1685 =
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv
                when FStar_Syntax_Syntax.fv_eq_lid fv
                  ...
                  let arg_term =
                    ...
                    FStar_Pervasives_Native.fst uu____1700
                  in
                  let uu____1715 =
                    let uu____1722 =
                      let uu____1723 = fstar_tc_common_prefix "t_option_of" in
                      FStar_Extraction_ML_Syntax.with_ty
                  ...
                  let uu____1734 =
                    let uu____1739 =
                      let uu____1740 =
                        ...
                        FStar_Syntax_Print.term_to_string uu____1741
                      in
                      Prims.strcat
          ...
          let uu____1747 =
            let uu____1752 =
              let uu____1753 =
                ...
                FStar_Syntax_Print.term_to_string uu____1754
              in
              Prims.strcat "Type term not defined for " uu____1753
            in
            (FStar_Errors.Fatal_CallNotImplemented, uu____1752)
          in
...
let rec mk_tac_embedding_path
    : FStar_TypeChecker_Env.env -> emb_decl -> FStar_Syntax_Syntax.term
      -> FStar_Extraction_ML_Syntax.mlexpr' =
  fun tcenv m t ->
    let rec try_mk t1 unrefined =
      let uu____1771 =
        let uu____1772 = FStar_Syntax_Subst.compress t1 in
        uu____1772.FStar_Syntax_Syntax.n
      in
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv
        when let uu____1786 =
               FStar_Reflection_Data.fstar_refl_syntax_lid "binders"
             in
      ...
      | FStar_Syntax_Syntax.Tm_app (h, args) -> (
          let uu____1811 =
            ...
            uu____1812.FStar_Syntax_Syntax.n
          in
          ...
          | FStar_Syntax_Syntax.Tm_uinst (h', uu____1816) -> (
              let uu____1821 =
                let uu____1832 =
                  ...
                  uu____1833.FStar_Syntax_Syntax.n
                in
                ...
                | FStar_Syntax_Syntax.Tm_fvar fv
                  when FStar_Syntax_Syntax.fv_eq_lid fv
                    ...
                    let arg_term =
                      ...
                      FStar_Pervasives_Native.fst uu____1850
                    in
                    let uu____1865 =
                      let uu____1868 =
                        mk_tac_embedding_path tcenv m arg_term
                      in
                      [uu____1868]
                    in
                ...
                | FStar_Syntax_Syntax.Tm_fvar fv
                  when FStar_Syntax_Syntax.fv_eq_lid fv
                    ...
                    let arg_term =
                      ...
                      FStar_Pervasives_Native.fst uu____1902
                    in
                    let uu____1917 =
                      let uu____1920 =
                        mk_tac_embedding_path tcenv m arg_term
                    ...
                    let uu____1925 =
                      let uu____1930 =
                        ...
                        Prims.strcat
                          ...
                          uu____1931
                      in
                      (FStar_Errors.Fatal_CallNotImplemented, uu____1930)
                    in
                    FStar_Errors.raise_err uu____1925
              in
              match uu____1821 with ht, hargs, type_arg, is_tactic ->
                let hargs1 =
                  match m with
                ...
                if is_tactic then
                  ...
                  let uu____1957 =
                    let uu____1964 =
                      ...
                      FStar_Extraction_ML_Syntax.with_ty
                        FStar_Extraction_ML_Syntax.MLTY_Top uu____1965
                    in
                    let uu____1966 =
                      FStar_List.map
                        (FStar_Extraction_ML_Syntax.with_ty
          ...
          let uu____1976 =
            let uu____1981 =
              let uu____1982 =
                ...
                FStar_Syntax_Print.term_to_string uu____1983
              in
              Prims.strcat "Embedding not defined for type " uu____1982
            in
            (FStar_Errors.Fatal_CallNotImplemented, uu____1981)
          in
...
let mk_interpretation_fun:
      'Auu____1990. FStar_TypeChecker_Env.env -> FStar_Ident.lident
      -> FStar_Extraction_ML_Syntax.mlexpr' -> FStar_Syntax_Syntax.term
      -> (FStar_Syntax_Syntax.bv, 'Auu____1990) FStar_Pervasives_Native.tuple2
         Prims.list
      -> FStar_Extraction_ML_Syntax.mlexpr' FStar_Pervasives_Native.option =
  fun tcenv tac_lid assm_lid t bs ->
    try
      let arg_types =
        FStar_List.map
          (fun x -> (FStar_Pervasives_Native.fst x).FStar_Syntax_Syntax.sort)
          bs
      in
        ...
        let uu____2071 =
          let uu____2078 =
            let uu____2079 =
              ...
              Prims.strcat "FStar_Tactics_Native.from_tactic_" uu____2080
            in
            str_to_top_name uu____2079
          in
          let uu____2087 =
            let uu____2090 = lid_to_top_name tac_lid in
            [uu____2090]
          in
          (uu____2078, uu____2087)
        in
        FStar_Extraction_ML_Syntax.MLE_App uu____2071
      in
      let tac_lid_app =
        let uu____2094 =
        ...
        in
        FStar_Extraction_ML_Syntax.MLE_App uu____2094
      in
      let psc = str_to_name "psc" in
      let args =
        let uu____2108 =
          let uu____2111 =
            FStar_List.map (mk_tac_embedding_path tcenv Unembed) arg_types
          in
          let uu____2114 =
            ...
            let uu____2118 =
              ...
              let uu____2122 =
                let uu____2125 =
                  ...
                  psc :: uu____2128
                in
                tac_lid_app :: uu____2125
              in
              uu____2121 :: uu____2122
            in
            uu____2117 :: uu____2118
          in
          FStar_List.append uu____2111 uu____2114
        in
        FStar_List.append [tac_fun] uu____2108
      in
      let app =
        let uu____2133 =
          let uu____2134 =
            ...
            (h, uu____2141)
          in
          FStar_Extraction_ML_Syntax.MLE_App uu____2134
        in
        FStar_All.pipe_left
          (FStar_Extraction_ML_Syntax.with_ty
             FStar_Extraction_ML_Syntax.MLTY_Top)
      ...
      FStar_Pervasives_Native.Some
        (FStar_Extraction_ML_Syntax.MLE_Fun
           ( [ ("psc", FStar_Extraction_ML_Syntax.MLTY_Top)
             ; ("args", FStar_Extraction_ML_Syntax.MLTY_Top) ]
           , app ))
    ...
    ->
      (let uu____2174 = FStar_Ident.string_of_lid tac_lid in
       not_implemented_warning t.FStar_Syntax_Syntax.pos uu____2174 msg) ;
      FStar_Pervasives_Native.None
