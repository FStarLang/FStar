  ...
  fun uu____1060  ->
    ...
    | (ns,n1) ->
        ...
        then
          let uu____1079 =
            let uu____1080 =
              FStar_Util.char_at n1 (Prims.lift_native_int (7))  in
  ...
  fun uu____1195  ->
    ...
    | (ns,n1) ->
        ...
        then
          let uu____1214 =
            let uu____1215 =
              FStar_Util.char_at n1 (Prims.lift_native_int (5))  in
                ...
                let uu____1821 =
                  let uu____1832 =
                    let uu____1843 =
                      ...
                      (uu____1852, (Prims.lift_native_int (0)), "term", R)
                       in
                    let uu____1853 =
                      let uu____1864 =
                        let uu____1873 =
                          FStar_Reflection_Data.fstar_refl_types_lid "fv"  in
                        (uu____1873, (Prims.lift_native_int (0)), "fv", R)
                         in
                      let uu____1874 =
                        let uu____1885 =
                          let uu____1894 =
                            FStar_Reflection_Data.fstar_refl_types_lid
                              "binder"
                             in
                          (uu____1894, (Prims.lift_native_int (0)), "binder",
                            R)
                           in
                        let uu____1895 =
                          let uu____1906 =
                            let uu____1915 =
                              FStar_Reflection_Data.fstar_refl_syntax_lid
                                "binders"
                               in
                            (uu____1915, (Prims.lift_native_int (0)),
                              "binders", R)
                             in
                          let uu____1916 =
                            let uu____1927 =
                                  ...
                                  let uu____1960 =
                                    let uu____1969 =
                                      FStar_Parser_Const.mk_tuple_lid
                                       ...
                                       in
                                    (uu____1969, (Prims.lift_native_int (2)),
                                      "tuple2", S)
                                     in
                                  let uu____1970 =
                                    let uu____1981 =
                                      let uu____1990 =
                                        FStar_Reflection_Data.fstar_refl_data_lid
                                         ...
                                         in
                                      (uu____1990,
                                        (Prims.lift_native_int (0)), "exp",
                                        R)
                                       in
                                    [uu____1981]  in
                                  uu____1960 :: uu____1970  in
                                (FStar_Parser_Const.option_lid,
                                  (Prims.lift_native_int (1)), "option", S)
                                  :: uu____1949
                                 in
                              (FStar_Parser_Const.list_lid,
                                (Prims.lift_native_int (1)), "list", S) ::
                                uu____1938
                               in
                            (FStar_Parser_Const.norm_step_lid,
                              (Prims.lift_native_int (0)), "norm_step", S) ::
                              uu____1927
                             in
                  ...
                  (FStar_Parser_Const.string_lid,
                    (Prims.lift_native_int (0)), "string", S) :: uu____1832
                   in
                (FStar_Parser_Const.unit_lid, (Prims.lift_native_int (0)),
                  "unit", S) :: uu____1821
                 in
              (FStar_Parser_Const.bool_lid, (Prims.lift_native_int (0)),
                "bool", S) :: uu____1810
               in
            (FStar_Parser_Const.int_lid, (Prims.lift_native_int (0)), "int",
              S) :: uu____1799
             in
          ...
          let abstract_tvars tvar_names body =
            ...
            | uu____2441 ->
                ...
                let default_branch =
                  ...
                  (FStar_Extraction_ML_Syntax.MLP_Wild,
                    FStar_Pervasives_Native.None, uu____2510)
                   in
                let body1 =
                  let uu____2530 =
                    let uu____2531 =
                     ...
                     FStar_List.mapi
                       (fun i  ->
                          fun tv  ->
                            ...
                            Prims.strcat "tv_" uu____2868) type_vars
                      in
                   let tvar_context =
                     FStar_List.map2
                       (fun b  ->
                     ...
                     | [] ->
                         ...
                         then
                           ...
                           let args =
                             ...
                             FStar_List.append arg_unembeddings uu____2979
                              in
                           let fun_embedding =
                             FStar_All.pipe_left w
                               (FStar_Extraction_ML_Syntax.MLE_App
                                    ...
                                    let uu____3080 =
                                      FStar_All.pipe_left w
                                        (FStar_Extraction_ML_Syntax.MLE_App
                                           (h, args))
                                       in
                                    abstract_tvars tvar_names uu____3080
                                 in
                              let uu____3083 =
                                let uu____3090 = mk_lam "psc" tabs  in
                                (uu____3090,
                                  (arity + (Prims.lift_native_int (1))),
                                  false)
                                 in
