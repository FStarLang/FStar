...
let mk_tactic_unembedding :
  ...
  fun args  ->
    ...
    let reify_tactic =
      ...
      FStar_All.pipe_left
        (FStar_Extraction_ML_Syntax.with_ty
           FStar_Extraction_ML_Syntax.MLTY_Top) uu____1501
       in
    let from_tac =
      let uu____1517 =
        let uu____1518 =
      ...
      let uu____1520 =
        let uu____1521 =
          FStar_Util.string_of_int
            ((FStar_List.length args) - (Prims.parse_int "1"))
           in
        Prims.strcat "FStar_Tactics_Interpreter.unembed_tactic_" uu____1521
         in
...
let rec mk_tac_param_type :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1591 = FStar_Reflection_Data.fstar_refl_types_lid "binder"
           in
        FStar_Syntax_Syntax.fv_eq_lid fv uu____1591 ->
        fstar_refl_data_prefix "t_binder"
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1593 = FStar_Reflection_Data.fstar_refl_types_lid "term"
           in
    ...
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1597 = FStar_Reflection_Data.fstar_refl_syntax_lid "binder"
           in
         ...
         | FStar_Syntax_Syntax.Tm_uinst (h',uu____1627) ->
             ...
             (match uu____1632 with
              | FStar_Syntax_Syntax.Tm_fvar fv when
                  ...
                  let uu____1655 =
                    let uu____1662 =
                      ...
                      FStar_Extraction_ML_Syntax.with_ty
                        FStar_Extraction_ML_Syntax.MLTY_Top uu____1663
                       in
                    let uu____1664 =
                      let uu____1667 =
                      ...
                      FStar_List.map
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu____1667
                       in
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv when
                  ...
                  let uu____1692 =
                    let uu____1699 =
                      let uu____1700 = fstar_tc_common_prefix "t_option_of"
                         in
                      FStar_Extraction_ML_Syntax.with_ty
                    ...
                    let uu____1701 =
                      ...
                      FStar_List.map
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu____1704
                       in
...
let rec mk_tac_embedding_path :
  ...
  fun m  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv when
          let uu____1739 = FStar_Reflection_Data.fstar_refl_types_lid "term"
             in
          FStar_Syntax_Syntax.fv_eq_lid fv uu____1739 ->
          mk_embedding m "term"
      | FStar_Syntax_Syntax.Tm_fvar fv when
          let uu____1741 = FStar_Reflection_Data.fstar_refl_types_lid "fv"
             in
           ...
           | FStar_Syntax_Syntax.Tm_uinst (h',uu____1773) ->
               let uu____1778 =
                 ...
                 | uu____1881 ->
                     ((let uu____1883 =
                         let uu____1884 =
                           let uu____1885 = FStar_Syntax_Subst.compress h'
                              in
                    ...
                    then
                      ...
                      (let uu____1911 =
                         let uu____1918 =
                           ...
                           FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top uu____1919
                            in
                         let uu____1920 =
                           FStar_List.map
                             (FStar_Extraction_ML_Syntax.with_ty
          ...
          try
            ...
            let tac_fun =
              let uu____2014 =
                ...
                let uu____2030 =
                  let uu____2033 = lid_to_top_name tac_lid  in [uu____2033]
                   in
                ...
                let uu____2057 =
                  ...
                  let uu____2061 =
                    ...
                    let uu____2065 =
                      let uu____2068 =
                        let uu____2071 =
                          let uu____2074 = str_to_name "args"  in
                          [uu____2074]  in
                        psc :: uu____2071  in
            ...
            let app =
              ...
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____2076
               in
            FStar_Pervasives_Native.Some
              (FStar_Extraction_ML_Syntax.MLE_Fun
