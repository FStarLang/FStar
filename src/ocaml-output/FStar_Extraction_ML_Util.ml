      ...
      fun t ->
        fun ml_fv ->
          ...
          let lid_to_name l =
            ...
            FStar_All.pipe_left
              (FStar_Extraction_ML_Syntax.with_ty
                 FStar_Extraction_ML_Syntax.MLTY_Top) uu____1514 in
          let lid_to_top_name l =
            let uu____1520 =
              let uu____1521 = FStar_Extraction_ML_Syntax.mlpath_of_lident l in
                        ...
                        let uu____1695 =
                          let uu____1704 =
                            FStar_Reflection_Data.fstar_refl_types_lid
                              "binder" in
                          (uu____1704, (Prims.parse_int "0"), "binder", R) in
                        let uu____1705 =
                          let uu____1716 =
                            let uu____1725 =
                              FStar_Reflection_Data.fstar_refl_syntax_lid
                                "binders" in
                            (uu____1725, (Prims.parse_int "0"), "binders", R) in
                          let uu____1726 =
                            let uu____1737 =
                              let uu____1748 =
                                let uu____1759 =
                          ...
                          let uu____2140 =
                            let uu____2149 =
                              FStar_Util.find_opt
                                ...
                                known_type_constructors in
                            FStar_All.pipe_right uu____2149 FStar_Util.must in
            ...
            | uu____2235 ->
                ...
                let default_branch =
                  ...
                  (FStar_Extraction_ML_Syntax.MLP_Wild,
                    FStar_Pervasives_Native.None, uu____2298) in
                let body1 =
                  let uu____2318 =
                    let uu____2319 =
               ...
               | (type_vars, bs1) ->
                     ...
                     FStar_List.mapi
                       (fun i ->
                          fun tv ->
                            ...
                            Prims.strcat "tv_" uu____2656) type_vars in
                   let tvar_context =
                     FStar_List.map2
                       (fun b ->
                   ...
                   let rec aux accum_embeddings env bs2 =
                     ...
                     | [] ->
                         ...
                         let uu____2742 = FStar_Syntax_Util.is_pure_comp c in
                         if uu____2742
                         then
                           let embed_fun_N =
                           ...
                           let args =
                             ...
                             FStar_List.append arg_unembeddings uu____2761 in
                           let fun_embedding =
                             FStar_All.pipe_left w
                               (FStar_Extraction_ML_Syntax.MLE_App
                                  (embed_fun_N, args)) in
                                ...
                                | uu____2859 ->
                                    let uu____2862 =
                                      FStar_All.pipe_left w
                                        (FStar_Extraction_ML_Syntax.MLE_App
                                           (h, args)) in
                                    abstract_tvars tvar_names uu____2862 in
                              let uu____2865 =
