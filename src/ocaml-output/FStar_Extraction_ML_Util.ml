...
let udelta_unfold : FStar_Extraction_ML_UEnv.env  ->  FStar_Extraction_ML_Syntax.mlty  ->  FStar_Extraction_ML_Syntax.mlty Prims.option = (fun g uu___115_140 -> (match (uu___115_140) with
...
let eff_to_string : FStar_Extraction_ML_Syntax.e_tag  ->  Prims.string = (fun uu___116_166 -> (match (uu___116_166) with
...
let is_type_abstraction = (fun uu___117_536 -> (match (uu___117_536) with
...
let record_field_path : FStar_Ident.lident Prims.list  ->  Prims.string Prims.list = (fun uu___118_597 -> (match (uu___118_597) with
| (f)::uu____601 -> begin
(
