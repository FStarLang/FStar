    ...
    fun args  ->
      ...
      | (formals,t) ->
          ...
          then
            ...
            (let _0_192 = FStar_List.zip formals args in subst_aux _0_192 t)
let udelta_unfold:
             ...
             (t1,f,t2),FStar_Extraction_ML_Syntax.MLTY_Fun (t1',f',t2')) ->
              let mk_fun xs body =
                ...
                | uu____251 ->
                    ...
                    FStar_Extraction_ML_Syntax.with_ty _0_194 e in
              (match e with
               | Some
                   {
                      ...
                      then
                        ...
                        (let uu____329 =
                           let _0_199 =
                             ...
                             FStar_All.pipe_left (fun _0_197  -> Some _0_197)
                               _0_198 in
    ...
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (lty,mlp) ->
          ...
          then FStar_Extraction_ML_UEnv.erasedContent
            ...
            FStar_Extraction_ML_Syntax.MLTY_Named
              ((let _0_205 = FStar_List.map (eraseTypeDeep unfold_ty) lty in
                (_0_205, mlp)))
