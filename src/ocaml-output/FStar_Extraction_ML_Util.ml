          ...
          let abstract_tvars tvar_names body =
            ...
            | uu____2435 ->
                ...
                let default_branch =
                  ...
                  (FStar_Extraction_ML_Syntax.MLP_Wild,
                    FStar_Pervasives_Native.None, uu____2498)
                   in
                let body1 =
                  let uu____2518 =
                    let uu____2519 =
               ...
               | (type_vars,bs1) ->
                     ...
                     FStar_List.mapi
                       (fun i  ->
                          fun tv  ->
                            ...
                            Prims.strcat "tv_" uu____2856) type_vars
                      in
                   let tvar_context =
                     FStar_List.map2
                       (fun b  ->
                   ...
                   let rec aux accum_embeddings env bs2 =
                     ...
                     | [] ->
                         ...
                         let uu____2950 = FStar_Syntax_Util.is_pure_comp c
                            in
                         if uu____2950
                         then
                           let embed_fun_N =
                           ...
                           let args =
                             ...
                             FStar_List.append arg_unembeddings uu____2971
                              in
                           let fun_embedding =
                             FStar_All.pipe_left w
                               (FStar_Extraction_ML_Syntax.MLE_App
