...
let argTypes :
  ...
  =
  fun t  ->
    let uu____1378 = doms_and_cod t  in
    FStar_Pervasives_Native.fst uu____1378
  ...
  fun args  ->
    ...
    let app =
      ...
      | n1 ->
          ((let uu____1570 =
              let uu____1571 =
                let uu____1574 = FStar_Util.string_of_int n1  in [uu____1574]
                 in
              FStar_Util.format
...
let rec mk_tac_param_type :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1636 = FStar_Reflection_Data.fstar_refl_types_lid "binder"
           in
        FStar_Syntax_Syntax.fv_eq_lid fv uu____1636 ->
        fstar_refl_data_prefix "t_binder"
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1638 = FStar_Reflection_Data.fstar_refl_types_lid "term"
           in
    ...
    | FStar_Syntax_Syntax.Tm_fvar fv when
        let uu____1642 = FStar_Reflection_Data.fstar_refl_syntax_lid "binder"
           in
         ...
         | FStar_Syntax_Syntax.Tm_uinst (h',uu____1672) ->
             ...
             (match uu____1677 with
              | FStar_Syntax_Syntax.Tm_fvar fv when
                  ...
                  let uu____1700 =
                    let uu____1707 =
                      ...
                      FStar_Extraction_ML_Syntax.with_ty
                        FStar_Extraction_ML_Syntax.MLTY_Top uu____1708
                       in
                    let uu____1709 =
                      let uu____1712 =
                      ...
                      FStar_List.map
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu____1712
                       in
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv when
                  ...
                  let uu____1737 =
                    let uu____1744 =
                      let uu____1745 = fstar_tc_common_prefix "t_option_of"
                         in
                      FStar_Extraction_ML_Syntax.with_ty
                        FStar_Extraction_ML_Syntax.MLTY_Top uu____1745
                       in
                    let uu____1746 =
                      let uu____1749 =
                      ...
                      FStar_List.map
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu____1749
                       in
...
let rec mk_tac_embedding_path :
  ...
  fun m  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv when
          let uu____1786 = FStar_Reflection_Data.fstar_refl_types_lid "term"
             in
          FStar_Syntax_Syntax.fv_eq_lid fv uu____1786 ->
          mk_embedding m "term"
      | FStar_Syntax_Syntax.Tm_fvar fv when
          let uu____1788 = FStar_Reflection_Data.fstar_refl_types_lid "fv"
             in
           ...
           | FStar_Syntax_Syntax.Tm_uinst (h',uu____1820) ->
               let uu____1825 =
                 ...
                 | uu____1928 ->
                     ((let uu____1930 =
                         let uu____1931 =
                           let uu____1932 = FStar_Syntax_Subst.compress h'
                              in
                    ...
                    then
                      ...
                      (let uu____1958 =
                         let uu____1965 =
                           ...
                           FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top uu____1966
                            in
                         let uu____1967 =
                           FStar_List.map
                             (FStar_Extraction_ML_Syntax.with_ty
          ...
          try
            ...
            let tac_fun =
              let uu____2065 =
                ...
                let uu____2081 =
                  let uu____2084 = lid_to_top_name tac_lid  in [uu____2084]
                   in
            ...
            let args =
              let uu____2101 =
                let uu____2104 = str_to_name "ps"  in [uu____2104; tac_fun]
                 in
              let uu____2105 =
                let uu____2108 =
                ...
                let uu____2111 =
                  ...
                  let uu____2115 =
                    ...
                    let uu____2119 =
                      let uu____2122 =
                        let uu____2125 = str_to_name "args"  in [uu____2125]
                         in
            ...
            let app =
              ...
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____2127
               in
            FStar_Pervasives_Native.Some
              (FStar_Extraction_ML_Syntax.MLE_Fun
