...
let (mlconst_of_const :
  ...
  fun p ->
    fun c ->
      try (fun uu___273_103 -> match () with | () -> mlconst_of_const' c) ()
      with
      | uu___272_106 ->
          let uu____107 =
    ...
    let cint i =
      let uu____121 =
        ...
        FStar_All.pipe_right uu____122
          (fun _0_17 -> FStar_Extraction_ML_Syntax.MLE_Const _0_17) in
    ...
    let cstr s =
      let uu____151 =
        FStar_All.pipe_right (FStar_Extraction_ML_Syntax.MLC_String s)
          (fun _0_18 -> FStar_Extraction_ML_Syntax.MLE_Const _0_18) in
    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Var x ->
          let uu____226 =
            FStar_Util.find_opt
              (fun uu____240 ->
                 match uu____240 with | (y, uu____246) -> y = x) subst1 in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Fun (t1, f, t2) ->
          let uu____263 =
            ...
            let uu____271 = subst_aux subst1 t2 in (uu____270, f, uu____271) in
                ...
                | FStar_Pervasives_Native.None ->
                    let uu____384 =
                      ...
                      FStar_Util.format3
                        ...
                        uu____385 uu____386 uu____387 in
                    failwith uu____384
    ...
    fun e ->
      fun t ->
        fun t' ->
             ...
             FStar_Extraction_ML_Syntax.MLTY_Fun (t1', f', t2')) ->
              let mk_fun xs body =
                ...
                | uu____591 ->
                    ...
                    FStar_Extraction_ML_Syntax.with_ty uu____630 e1 in
              (match e with
                           ...
                           let uu____694 =
                             let uu____697 =
                               let uu____698 =
                                 ...
                                 FStar_Extraction_ML_Syntax.with_ty uu____703 in
                        ...
                        (let uu____732 =
                         ...
                         | (ok, body1) ->
                             let res =
                               ...
                               | uu____775 -> FStar_Pervasives_Native.None in
                             (ok, res)))
                   else (false, FStar_Pervasives_Native.None)
               | uu____783 ->
                   let uu____786 =
          ...
          | (FStar_Extraction_ML_Syntax.MLTY_Tuple ts,
             FStar_Extraction_ML_Syntax.MLTY_Tuple ts') ->
              let uu____874 = FStar_List.forall2 (type_leq unfold_ty) ts ts' in
              if uu____874
              then (true, e)
              else (false, FStar_Pervasives_Native.None)
    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (lty, mlp) ->
          ...
          then FStar_Extraction_ML_UEnv.erasedContent
            ...
            (let uu____1367 =
               let uu____1374 = FStar_List.map (eraseTypeDeep unfold_ty) lty in
               (uu____1374, mlp) in
...
let (argTypes :
  ...
  =
  fun t ->
    let uu____1538 = doms_and_cod t in FStar_Pervasives_Native.fst uu____1538
...
let (uu___is_NBE_t : emb_loc -> Prims.bool) =
  fun projectee -> match projectee with | NBE_t -> true | uu____1647 -> false
        ...
        fun arity_opt ->
          fun ml_fv ->
            ...
            let lid_to_name l =
              ...
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____1716 in
            ...
            let fstar_refl_nbeemb_prefix s =
              str_to_name (Prims.strcat "FStar_Reflection_NBEEmbeddings." s) in
            let fv_lid_embedded =
              let uu____1765 =
                let uu____1766 =
                  ...
                  let uu____1774 =
                    let uu____1777 =
                      let uu____1778 =
                        let uu____1779 =
                          let uu____1780 = FStar_Ident.string_of_lid fv_lid1 in
                          FStar_Extraction_ML_Syntax.MLC_String uu____1780 in
                        FStar_Extraction_ML_Syntax.MLE_Const uu____1779 in
                      FStar_All.pipe_left
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu____1778 in
                    [uu____1777] in
                  (uu____1773, uu____1774) in
                FStar_Extraction_ML_Syntax.MLE_App uu____1766 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____1765 in
            let emb_prefix uu___269_1793 =
              match uu___269_1793 with
            ...
            let mk_tactic_interpretation l =
              ...
              | uu____1803 ->
                  "FStar_Tactics_InterpFuns.mk_nbe_tactic_interpretation_" in
            let mk_from_tactic l =
              match l with
              | Syntax_term -> "FStar_Tactics_Native.from_tactic_"
              | uu____1810 -> "FStar_Tactics_Native.from_nbe_tactic_" in
            let mk_basic_embedding l s = emb_prefix l (Prims.strcat "e_" s) in
            ...
            let known_type_constructors =
              let term_cs =
                ...
                ((FStar_Parser_Const.int_lid, (Prims.parse_int "0"), "int"),
                  Syntax_term) :: uu____1943 in
              let nbe_cs =
                FStar_List.map
                  (fun uu___270_2466 ->
                     match uu___270_2466 with
                     | (x, Syntax_term) -> (x, NBE_t)
                     | (x, Refl_emb) -> (x, NBERefl_emb)
                     | uu____2525 -> failwith "Impossible") term_cs in
              fun uu___271_2546 ->
                match uu___271_2546 with
                | Syntax_term -> term_cs
                | Refl_emb -> term_cs
                | uu____2559 -> nbe_cs in
            ...
            let rec mk_embedding l env t2 =
              ...
              | FStar_Syntax_Syntax.Tm_arrow (b::more::bs, c) ->
                  ...
                  let t4 =
                    let uu____2886 =
                      let uu____2893 =
                        let uu____2894 =
                          let uu____2909 = FStar_Syntax_Syntax.mk_Total tail1 in
                          ([b], uu____2909) in
              ...
              | FStar_Syntax_Syntax.Tm_fvar uu____2937 ->
                  ...
                  (match uu____2938 with
                   | (head1, args) ->
                       ...
                       let uu____2990 =
                         let uu____2991 = FStar_Syntax_Util.un_uinst head1 in
                              ...
                              let uu____3046 =
                                FStar_Util.find_opt
                                  (fun uu____3074 ->
                                     ...
                                     | ((x, uu____3086, uu____3087),
                                        uu____3088) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____3046 FStar_Util.must in
                            (match uu____3035 with
                             | ((uu____3127, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head2 =
              ...
              | FStar_Syntax_Syntax.Tm_uinst uu____3145 ->
                  ...
                  (match uu____3152 with
                   | (head1, args) ->
                       let n_args = FStar_List.length args in
                       let uu____3204 =
                         let uu____3205 = FStar_Syntax_Util.un_uinst head1 in
                              ...
                              let uu____3260 =
                                FStar_Util.find_opt
                                  (fun uu____3288 ->
                                     ...
                                     | ((x, uu____3300, uu____3301),
                                        uu____3302) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____3260 FStar_Util.must in
                            (match uu____3249 with
                             | ((uu____3341, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head2 =
                                   mk_basic_embedding loc_embedding nm in
                                 (match t_arity with
              ...
              | FStar_Syntax_Syntax.Tm_app uu____3359 ->
                  ...
                  (match uu____3376 with
                   | (head1, args) ->
                       let n_args = FStar_List.length args in
                       let uu____3428 =
                         let uu____3429 = FStar_Syntax_Util.un_uinst head1 in
                              ...
                              let uu____3484 =
                                FStar_Util.find_opt
                                  (fun uu____3512 ->
                                     ...
                                     | ((x, uu____3524, uu____3525),
                                        uu____3526) ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l) in
                              FStar_All.pipe_right uu____3484 FStar_Util.must in
                            (match uu____3473 with
                             | ((uu____3565, t_arity, _trepr_head),
                                loc_embedding) ->
                                 let head2 =
                                   mk_basic_embedding loc_embedding nm in
                                 (match t_arity with
              ...
              | uu____3583 ->
                  let uu____3584 =
                    let uu____3585 =
                      let uu____3586 = FStar_Syntax_Print.term_to_string t3 in
                      Prims.strcat "Embedding not defined for type "
                        uu____3586 in
                    NoTacticEmbedding uu____3585 in
                  FStar_Exn.raise uu____3584 in
              ...
              | [] ->
                  let body1 =
                    let uu____3603 =
                      let uu____3604 =
                        let uu____3611 =
                          str_to_name "FStar_Syntax_Embeddings.debug_wrap" in
                        let uu____3612 =
                          let uu____3615 =
                            let uu____3616 =
                              let uu____3617 =
                                ...
                                FStar_Extraction_ML_Syntax.MLC_String
                                  uu____3618 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu____3617 in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                              uu____3616 in
              ...
              | uu____3640 ->
                  ...
                  let default_branch =
                    ...
                    (FStar_Extraction_ML_Syntax.MLP_Wild,
                      FStar_Pervasives_Native.None, uu____3703) in
                  let body1 =
                    let uu____3723 =
                      let uu____3724 =
                          ...
                          let uu____3787 =
                            let uu____3788 =
                              let uu____3789 =
                                ...
                                FStar_Extraction_ML_Syntax.MLC_String
                                  uu____3790 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu____3789 in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                              uu____3788 in
                          let uu____3791 =
                            let uu____3794 = mk_lam "_" body1 in [uu____3794] in
                          ...
                          (let uu____3924 = FStar_Util.first_N n1 bs in
                           ...
                           | (bs1, rest) ->
                               let c1 =
                                 ...
                                 FStar_All.pipe_left
                                   FStar_Syntax_Syntax.mk_Total uu____4002 in
                               (bs1, c1))
                        else
                          (let msg =
                             let uu____4017 =
                             ...
                             let uu____4019 = FStar_Util.string_of_int n_bs in
                             FStar_Util.format3
                               "Embedding not defined for %s; expected arity at least %s; got %s"
                               uu____4017 uu____4018 uu____4019 in
                      ...
                      | (type_vars, bs2) ->
                            ...
                            FStar_List.mapi
                              (fun i ->
                                 fun tv ->
                                   ...
                                   Prims.strcat "tv_" uu____4393) type_vars in
                          let tvar_context =
                            FStar_List.map2
                              (fun b ->
                                 fun nm ->
                          ...
                          let rec aux loc accum_embeddings bs3 =
                                          ...
                                          let uu____4508 =
                                            ...
                                            FStar_All.pipe_left
                                              (FStar_Extraction_ML_Syntax.with_ty
                                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                                              uu____4509 in
                                          [uu____4508; fv_lid_embedded; cb] in
                            ...
                            | (b, uu____4627)::bs4 ->
                                ...
                                aux loc uu____4647 bs4 in
                          (try
                             (fun uu___275_4670 ->
                                match () with
                                | () ->
                                    let uu____4681 = aux Syntax_term [] bs2 in
                                    (match uu____4681 with
                                     | (w1, a, b) ->
                                         let uu____4701 = aux NBE_t [] bs2 in
