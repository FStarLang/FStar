    ...
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Fun (t1,f,t2) ->
          let uu____101 =
            ...
            let uu____106 = subst_aux subst1 t2  in (uu____105, f, uu____106)
             in
        ...
        fun t'  ->
                ...
                | uu____301 ->
                    ...
                    let uu____323 =
                      (mk_ty_fun ()) xs body.FStar_Extraction_ML_Syntax.mlty
                       in
                    FStar_Extraction_ML_Syntax.with_ty uu____323 e1
                 in
              (match e with
               | Some
                   {
                               ...
                               let uu____368 =
                                 let uu____371 =
                                   (mk_ty_fun ()) [x]
                                    ...
                                    in
                                 FStar_Extraction_ML_Syntax.with_ty uu____371
                                  in
          ...
          | (FStar_Extraction_ML_Syntax.MLTY_Tuple
             ts,FStar_Extraction_ML_Syntax.MLTY_Tuple ts') ->
              let uu____481 = FStar_List.forall2 (type_leq unfold_ty) ts ts'
                 in
...
let is_type_abstraction uu___115_566 =
  match uu___115_566 with
...
let codegen_fsharp : Prims.unit -> Prims.bool =
  fun uu____714  ->
    let uu____715 =
      let uu____716 = FStar_Options.codegen ()  in FStar_Option.get uu____716
       in
    uu____715 = "FSharp"
    ...
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (lty,mlp) ->
          ...
          then FStar_Extraction_ML_UEnv.erasedContent
            ...
            (let uu____810 =
               let uu____814 = FStar_List.map (eraseTypeDeep unfold_ty) lty
                  in
               (uu____814, mlp)  in
...
let str_to_name : Prims.string -> FStar_Extraction_ML_Syntax.mlexpr' =
  fun s  ->
    let uu____954 = FStar_Ident.lid_of_str s  in lid_to_name uu____954
