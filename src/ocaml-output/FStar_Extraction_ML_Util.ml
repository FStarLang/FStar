...
let mlconst_of_const' : FStar_Range.range  ->  FStar_Const.sconst  ->  FStar_Extraction_ML_Syntax.mlconstant = (fun p c -> (FStar_All.try_with (fun uu___145_82 -> (match (()) with
| () -> begin
(mlconst_of_const c)
end)) (fun uu___144_86 -> (match (uu___144_86) with
| uu____87 -> begin
(
...
let udelta_unfold : FStar_Extraction_ML_UEnv.env  ->  FStar_Extraction_ML_Syntax.mlty  ->  FStar_Extraction_ML_Syntax.mlty FStar_Pervasives_Native.option = (fun g uu___140_236 -> (match (uu___140_236) with
...
let eff_to_string : FStar_Extraction_ML_Syntax.e_tag  ->  Prims.string = (fun uu___141_284 -> (match (uu___141_284) with
...
let is_type_abstraction : 'Auu____824 'Auu____825 'Auu____826 . (('Auu____826, 'Auu____825) FStar_Util.either * 'Auu____824) Prims.list  ->  Prims.bool = (fun uu___142_840 -> (match (uu___142_840) with
...
let record_field_path : FStar_Ident.lident Prims.list  ->  Prims.string Prims.list = (fun uu___143_945 -> (match (uu___143_945) with
| (f)::uu____951 -> begin
(
...
let mk_interpretation_fun : 'Auu____1941 . FStar_Ident.lident  ->  FStar_Extraction_ML_Syntax.mlexpr'  ->  FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.bv * 'Auu____1941) Prims.list  ->  FStar_Extraction_ML_Syntax.mlexpr' FStar_Pervasives_Native.option = (fun tac_lid assm_lid t bs -> (FStar_All.try_with (fun uu___147_1982 -> (match (()) with
| () -> begin
(
...
end)) (fun uu___146_2112 -> (match (uu___146_2112) with
| CallNotImplemented -> begin
((
