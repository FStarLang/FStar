                                    ...
                                    let uu____2596 =
                                      let uu____2605 =
                                        FStar_Reflection_Data.fstar_refl_types_lid
                                          "fv"
                                         in
                                      (uu____2605, Prims.int_zero, "fv")  in
                        ...
                        | FStar_Syntax_Syntax.Tm_fvar fv1 when
                            ...
                            (match uu____3682 with
                             | ((uu____3795,t_arity,_trepr_head),loc_embedding)
                                 ...
                                 (match t_arity with
                                  | _3812 when _3812 = Prims.int_zero ->
                                      head2
                                  | n1 ->
                                      FStar_All.pipe_left w
                            ...
                            (match uu____3925 with
                             | ((uu____4038,t_arity,_trepr_head),loc_embedding)
                                 ...
                                 let head2 =
                                   mk_basic_embedding loc_embedding nm  in
                                 (match t_arity with
                                  | _4055 when _4055 = Prims.int_zero ->
                                      head2
                                  | n1 ->
                                      FStar_All.pipe_left w
                                        (FStar_Extraction_ML_Syntax.MLE_App
                            ...
                            (match uu____4178 with
                             | ((uu____4291,t_arity,_trepr_head),loc_embedding)
                                 ...
                                 let head2 =
                                   mk_basic_embedding loc_embedding nm  in
                                 (match t_arity with
                                  | _4308 when _4308 = Prims.int_zero ->
                                      head2
                                  | n1 ->
                                      FStar_All.pipe_left w
                                        (FStar_Extraction_ML_Syntax.MLE_App
                                ...
                                then
                                  ...
                                  (let uu____5339 =
                                   ...
                                   then
                                     ...
                                     (uu____5398, (arity + Prims.int_one),
                                       false)
                                   else
                                     (let uu____5408 =
                                        let uu____5409 =
