...
let (mlconst_of_const :
  ...
  fun p  ->
    fun c  ->
      try (fun uu___282_132  -> match () with | () -> mlconst_of_const' c) ()
      with
      | uu___281_135 ->
          let uu____136 =
...
let is_type_abstraction :
  'a 'b 'c .
    (('a,'b) FStar_Util.either,'c) FStar_Pervasives_Native_Tuple2.tuple2
      Prims.list -> Prims.bool
  =
  fun uu___276_1243  ->
    match uu___276_1243 with
  ...
  fun uu____1307  ->
    ...
    | (ns,n1) ->
        let uu____1327 = FStar_Util.concat_l "." (FStar_List.append ns [n1])
           in
        FStar_Parser_Const.is_tuple_datacon_string uu____1327
...
let (record_field_path :
  ...
  fun uu___277_1361  ->
    match uu___277_1361 with
    | f::uu____1368 ->
        let uu____1371 = FStar_Util.prefix f.FStar_Ident.ns  in
        (match uu____1371 with
         | (ns,uu____1382) ->
             FStar_All.pipe_right ns
               (FStar_List.map (fun id1  -> id1.FStar_Ident.idText)))
    | uu____1395 -> failwith "impos"
  
let record_fields :
  'a .
    FStar_Ident.lident Prims.list ->
      'a Prims.list ->
        (Prims.string,'a) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list
  =
  fun fs  ->
    fun vs  ->
      FStar_List.map2
  ...
  fun uu____1459  ->
    ...
    | (ns,n1) ->
        let uu____1479 = FStar_Util.concat_l "." (FStar_List.append ns [n1])
           in
        FStar_Parser_Const.is_tuple_constructor_string uu____1479
...
let (resugar_mlty :
  ...
  fun t  ->
    ...
    | FStar_Extraction_ML_Syntax.MLTY_Named (args,mlp) ->
        ...
        if uu____1497 then FStar_Extraction_ML_Syntax.MLTY_Tuple args else t
    | uu____1502 -> t
  
let (flatten_ns : Prims.string Prims.list -> Prims.string) =
  fun ns  ->
    let uu____1516 = codegen_fsharp ()  in
    if uu____1516
...
let (flatten_mlpath :
  ...
  fun uu____1538  ->
    ...
    | (ns,n1) ->
        let uu____1558 = codegen_fsharp ()  in
        if uu____1558
  ...
  fun l  ->
    let uu____1586 =
      FStar_All.pipe_right l.FStar_Ident.ns
       ...
       in
    (uu____1586, ((l.FStar_Ident.ident).FStar_Ident.idText))
  
let rec (erasableType :
  unfold_t -> FStar_Extraction_ML_Syntax.mlty -> Prims.bool) =
  fun unfold_ty  ->
    fun t  ->
      let uu____1620 = FStar_Extraction_ML_UEnv.erasableTypeNoDelta t  in
      if uu____1620
      then true
      else
        (let uu____1627 = unfold_ty t  in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Fun (tyd,etag,tycd) ->
          ...
          then
            let uu____1657 =
              ...
              let uu____1668 = eraseTypeDeep unfold_ty tycd  in
              (uu____1664, etag, uu____1668)  in
            FStar_Extraction_ML_Syntax.MLTY_Fun uu____1657
          else t
      | FStar_Extraction_ML_Syntax.MLTY_Named (lty,mlp) ->
          let uu____1680 = erasableType unfold_ty t  in
          if uu____1680
          then FStar_Extraction_ML_UEnv.erasedContent
            ...
            (let uu____1688 =
               let uu____1695 = FStar_List.map (eraseTypeDeep unfold_ty) lty
                  in
               (uu____1695, mlp)  in
             FStar_Extraction_ML_Syntax.MLTY_Named uu____1688)
      | FStar_Extraction_ML_Syntax.MLTY_Tuple lty ->
          let uu____1706 = FStar_List.map (eraseTypeDeep unfold_ty) lty  in
          FStar_Extraction_ML_Syntax.MLTY_Tuple uu____1706
      | uu____1712 -> t
  ...
  let uu____1723 =
    let uu____1728 =
      mk_ty_fun
       ...
       in
    FStar_Extraction_ML_Syntax.with_ty uu____1728  in
  FStar_All.pipe_left uu____1723
  ...
  fun e1  ->
    fun e2  ->
      ...
      | (FStar_Pervasives_Native.Some x,FStar_Pervasives_Native.Some y) ->
          let uu____1816 = conjoin x y  in
          FStar_Pervasives_Native.Some uu____1816
  
let (mlloc_of_range :
  FStar_Range.range ->
    (Prims.int,Prims.string) FStar_Pervasives_Native_Tuple2.tuple2)
  =
  fun r  ->
    let pos = FStar_Range.start_of_range r  in
    let line = FStar_Range.line_of_pos pos  in
    let uu____1832 = FStar_Range.file_of_range r  in (line, uu____1832)
...
let rec (doms_and_cod :
  ...
  fun t  ->
    match t with
    | FStar_Extraction_ML_Syntax.MLTY_Fun (a,uu____1855,b) ->
        let uu____1857 = doms_and_cod b  in
        (match uu____1857 with | (ds,c) -> ((a :: ds), c))
    | uu____1878 -> ([], t)
...
let (argTypes :
  ...
  =
  fun t  ->
    let uu____1891 = doms_and_cod t  in
    FStar_Pervasives_Native.fst uu____1891
...
let rec (uncurry_mlty_fun :
  ...
  fun t  ->
    match t with
    | FStar_Extraction_ML_Syntax.MLTY_Fun (a,uu____1919,b) ->
        let uu____1921 = uncurry_mlty_fun b  in
        (match uu____1921 with | (args,res) -> ((a :: args), res))
    | uu____1942 -> ([], t)
...
let (uu___is_NoTacticEmbedding : Prims.exn -> Prims.bool) =
  fun projectee  ->
    ...
    | NoTacticEmbedding uu____1958 -> true
    | uu____1961 -> false
  
let (__proj__NoTacticEmbedding__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | NoTacticEmbedding uu____1972 -> uu____1972
        ...
        let uu____1994 =
          let uu____2000 =
            FStar_Util.format2
             ...
             in
          (FStar_Errors.Warning_CallNotImplementedAsWarning, uu____2000)  in
        FStar_Errors.log_issue r uu____1994
...
let (uu___is_Syntax_term : emb_loc -> Prims.bool) =
  fun projectee  ->
    match projectee with | Syntax_term  -> true | uu____2013 -> false
  
let (uu___is_Refl_emb : emb_loc -> Prims.bool) =
  fun projectee  ->
    match projectee with | Refl_emb  -> true | uu____2024 -> false
  
let (uu___is_NBE_t : emb_loc -> Prims.bool) =
  fun projectee  ->
    match projectee with | NBE_t  -> true | uu____2035 -> false
  
let (uu___is_NBERefl_emb : emb_loc -> Prims.bool) =
  fun projectee  ->
    match projectee with | NBERefl_emb  -> true | uu____2046 -> false
  
type wrapped_term =
  (FStar_Extraction_ML_Syntax.mlexpr,FStar_Extraction_ML_Syntax.mlexpr,
    Prims.int,Prims.bool) FStar_Pervasives_Native_Tuple4.tuple4
          ...
          fun ml_fv  ->
            ...
            let lid_to_name l =
              let uu____2117 =
                ...
                FStar_Extraction_ML_Syntax.MLE_Name uu____2118  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____2117
               in
            let lid_to_top_name l =
              let uu____2125 =
                let uu____2126 =
                  FStar_Extraction_ML_Syntax.mlpath_of_lident l  in
                FStar_Extraction_ML_Syntax.MLE_Name uu____2126  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____2125
               in
            let str_to_name s =
              let uu____2135 = FStar_Ident.lid_of_str s  in
              lid_to_name uu____2135  in
            let str_to_top_name s =
              let uu____2144 = FStar_Ident.lid_of_str s  in
              lid_to_top_name uu____2144  in
            ...
            let fv_lid_embedded =
              let uu____2182 =
                let uu____2183 =
                  let uu____2190 = str_to_name "FStar_Ident.lid_of_str"  in
                  let uu____2192 =
                    let uu____2195 =
                      let uu____2196 =
                        let uu____2197 =
                          let uu____2198 = FStar_Ident.string_of_lid fv_lid1
                             in
                          FStar_Extraction_ML_Syntax.MLC_String uu____2198
                           in
                        FStar_Extraction_ML_Syntax.MLE_Const uu____2197  in
                      FStar_All.pipe_left
                        (FStar_Extraction_ML_Syntax.with_ty
                           FStar_Extraction_ML_Syntax.MLTY_Top) uu____2196
                       in
                    [uu____2195]  in
                  (uu____2190, uu____2192)  in
                FStar_Extraction_ML_Syntax.MLE_App uu____2183  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top) uu____2182
               in
            let emb_prefix uu___278_2213 =
              match uu___278_2213 with
            ...
            let mk_from_tactic l =
              ...
              | uu____2238 -> "FStar_Tactics_Native.from_nbe_tactic_"  in
            let mk_basic_embedding l s = emb_prefix l (Prims.strcat "e_" s)
               in
            let mk_arrow_as_prim_step l arity =
              let uu____2267 =
                let uu____2269 = FStar_Util.string_of_int arity  in
                Prims.strcat "arrow_as_prim_step_" uu____2269  in
              emb_prefix l uu____2267  in
            let mk_any_embedding l s =
              let uu____2285 =
                let uu____2286 =
                  let uu____2293 = emb_prefix l "mk_any_emb"  in
                  let uu____2295 =
                    let uu____2298 = str_to_name s  in [uu____2298]  in
                  (uu____2293, uu____2295)  in
                FStar_Extraction_ML_Syntax.MLE_App uu____2286  in
              FStar_All.pipe_left w uu____2285  in
            let mk_lam nm e =
            ...
            let emb_arrow l e1 e2 =
              let uu____2348 =
                let uu____2349 =
                  let uu____2356 = emb_prefix l "e_arrow"  in
                  (uu____2356, [e1; e2])  in
                FStar_Extraction_ML_Syntax.MLE_App uu____2349  in
              FStar_All.pipe_left w uu____2348  in
            let known_type_constructors =
                                ...
                                let uu____2512 =
                                  let uu____2521 =
                                    FStar_Parser_Const.mk_tuple_lid
                                     ...
                                     in
                                  (uu____2521, (Prims.parse_int "2"),
                                    "tuple2")
                                   in
                                (uu____2512, Syntax_term)  in
                              let uu____2535 =
                                let uu____2550 =
                                  let uu____2563 =
                                    let uu____2572 =
                                      FStar_Reflection_Data.fstar_refl_types_lid
                                        "term"
                                       in
                                    (uu____2572, (Prims.parse_int "0"),
                                      "term")
                                     in
                                  (uu____2563, Refl_emb)  in
                                let uu____2586 =
                                  let uu____2601 =
                                    let uu____2614 =
                                      let uu____2623 =
                                        FStar_Reflection_Data.fstar_refl_types_lid
                                          "fv"
                                         in
                                      (uu____2623, (Prims.parse_int "0"),
                                        "fv")
                                       in
                                    (uu____2614, Refl_emb)  in
                                  let uu____2637 =
                                    let uu____2652 =
                                      let uu____2665 =
                                        let uu____2674 =
                                ...
                                uu____2550 :: uu____2586  in
                              uu____2499 :: uu____2535  in
              ...
              let nbe_cs =
                FStar_List.map
                  (fun uu___279_3083  ->
                     match uu___279_3083 with
                     | (x,Syntax_term ) -> (x, NBE_t)
                     | (x,Refl_emb ) -> (x, NBERefl_emb)
                     | uu____3158 -> failwith "Impossible") term_cs
                 in
              fun uu___280_3184  ->
                match uu___280_3184 with
                | Syntax_term  -> term_cs
                | Refl_emb  -> term_cs
                | uu____3199 -> nbe_cs
               in
              ...
              | FStar_Syntax_Syntax.Tm_name bv when
                  ...
                  let uu____3335 =
                    let uu____3337 =
                      ...
                      FStar_Util.must uu____3343  in
                    FStar_Pervasives_Native.snd uu____3337  in
                  FStar_All.pipe_left (mk_any_embedding l) uu____3335
              | FStar_Syntax_Syntax.Tm_refine (x,uu____3364) ->
                  mk_embedding l env x.FStar_Syntax_Syntax.sort
              | FStar_Syntax_Syntax.Tm_ascribed (t4,uu____3370,uu____3371) ->
                  mk_embedding l env t4
              | FStar_Syntax_Syntax.Tm_arrow (b::[],c) when
                  FStar_Syntax_Util.is_pure_comp c ->
                  let uu____3444 = FStar_Syntax_Subst.open_comp [b] c  in
                  (match uu____3444 with
                   | (bs,c1) ->
                       let t0 =
                         let uu____3466 =
                           let uu____3467 = FStar_List.hd bs  in
                           FStar_Pervasives_Native.fst uu____3467  in
                         uu____3466.FStar_Syntax_Syntax.sort  in
                       let t11 = FStar_Syntax_Util.comp_result c1  in
                       let uu____3485 = mk_embedding l env t0  in
                       let uu____3486 = mk_embedding l env t11  in
                       emb_arrow l uu____3485 uu____3486)
                      ...
                      let uu____3564 =
                        let uu____3565 =
                          let uu____3580 = FStar_Syntax_Syntax.mk_Total tail1
                             in
                          ([b], uu____3580)  in
                        FStar_Syntax_Syntax.Tm_arrow uu____3565  in
                      FStar_Syntax_Syntax.mk uu____3564  in
                    uu____3557 FStar_Pervasives_Native.None
                      t3.FStar_Syntax_Syntax.pos
                     in
                  mk_embedding l env t4
              | FStar_Syntax_Syntax.Tm_fvar uu____3608 ->
                  let uu____3609 = FStar_Syntax_Util.head_and_args t3  in
                              ...
                              let uu____3720 =
                                FStar_Util.find_opt
                                  (fun uu____3752  ->
                                     ...
                                     | ((x,uu____3767,uu____3768),uu____3769)
                                         ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l)
                                 in
                              FStar_All.pipe_right uu____3720 FStar_Util.must
                               in
                            (match uu____3707 with
                             | ((uu____3820,t_arity,_trepr_head),loc_embedding)
                                 ->
                                 let head2 =
                            ...
                            let uu____3842 =
                              let uu____3843 =
                                ...
                                Prims.strcat
                                  ...
                                  uu____3845
                                 in
                              NoTacticEmbedding uu____3843  in
                            FStar_Exn.raise uu____3842))
              | FStar_Syntax_Syntax.Tm_uinst uu____3848 ->
                  let uu____3855 = FStar_Syntax_Util.head_and_args t3  in
                              ...
                              let uu____3966 =
                                FStar_Util.find_opt
                                  (fun uu____3998  ->
                                     ...
                                     | ((x,uu____4013,uu____4014),uu____4015)
                                         ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l)
                                 in
                              FStar_All.pipe_right uu____3966 FStar_Util.must
                               in
                            (match uu____3953 with
                             | ((uu____4066,t_arity,_trepr_head),loc_embedding)
                                 ->
                                 let head2 =
                                   mk_basic_embedding loc_embedding nm  in
                                 (match t_arity with
                            ...
                            let uu____4088 =
                              let uu____4089 =
                                ...
                                Prims.strcat
                                  ...
                                  uu____4091
                                 in
                              NoTacticEmbedding uu____4089  in
                            FStar_Exn.raise uu____4088))
              | FStar_Syntax_Syntax.Tm_app uu____4094 ->
                  let uu____4111 = FStar_Syntax_Util.head_and_args t3  in
                   ...
                   | (head1,args) ->
                       ...
                       let uu____4163 =
                         let uu____4164 = FStar_Syntax_Util.un_uinst head1
                            in
                         uu____4164.FStar_Syntax_Syntax.n  in
                              ...
                              let uu____4222 =
                                FStar_Util.find_opt
                                  (fun uu____4254  ->
                                     ...
                                     | ((x,uu____4269,uu____4270),uu____4271)
                                         ->
                                         FStar_Syntax_Syntax.fv_eq_lid fv1 x)
                                  (known_type_constructors l)
                                 in
                              FStar_All.pipe_right uu____4222 FStar_Util.must
                               in
                            (match uu____4209 with
                             | ((uu____4322,t_arity,_trepr_head),loc_embedding)
                                 ->
                                 let head2 =
                                   mk_basic_embedding loc_embedding nm  in
                                 (match t_arity with
                            ...
                            let uu____4344 =
                              let uu____4345 =
                                ...
                                Prims.strcat
                                  ...
                                  uu____4347
                                 in
                              NoTacticEmbedding uu____4345  in
                            FStar_Exn.raise uu____4344))
              | uu____4350 ->
                  let uu____4351 =
                    let uu____4352 =
                      ...
                      Prims.strcat "Embedding not defined for type "
                        uu____4354
                       in
                    NoTacticEmbedding uu____4352  in
                  FStar_Exn.raise uu____4351
               in
                            ...
                            let uu____4390 =
                              let uu____4391 =
                                ...
                                FStar_Extraction_ML_Syntax.MLC_String
                                  uu____4392
                                 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu____4391
                               in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                            ...
                            let uu____4397 =
                              let uu____4398 =
                                let uu____4399 =
                                  let uu____4400 =
                                    let uu____4407 =
                                      let uu____4410 = str_to_name "args"  in
                                      [uu____4410]  in
                                    (body, uu____4407)  in
                                  FStar_Extraction_ML_Syntax.MLE_App
                                    uu____4400
                                   in
                                FStar_All.pipe_left w uu____4399  in
                              mk_lam "_" uu____4398  in
                            [uu____4397]  in
                          uu____4389 :: uu____4394  in
                        (uu____4384, uu____4386)  in
                      FStar_Extraction_ML_Syntax.MLE_App uu____4377  in
                    FStar_All.pipe_left w uu____4376  in
                  mk_lam "args" body1
              | uu____4418 ->
                  let args_tail =
                  ...
                  let branch1 =
                    let uu____4467 =
                      let uu____4468 =
                        let uu____4469 =
                          let uu____4476 =
                            let uu____4479 = str_to_name "args"  in
                            [uu____4479]  in
                          (body, uu____4476)  in
                        FStar_Extraction_ML_Syntax.MLE_App uu____4469  in
                      FStar_All.pipe_left w uu____4468  in
                    (pattern, FStar_Pervasives_Native.None, uu____4467)  in
                  let default_branch =
                    let uu____4494 =
                      let uu____4495 =
                        let uu____4496 =
                          let uu____4503 = str_to_name "failwith"  in
                          let uu____4505 =
                            let uu____4508 =
                              let uu____4509 =
                                mlexpr_of_const FStar_Range.dummyRange
                                  (FStar_Const.Const_string
                                     ("arity mismatch",
                                       FStar_Range.dummyRange))
                                 in
                              FStar_All.pipe_left w uu____4509  in
                            [uu____4508]  in
                          (uu____4503, uu____4505)  in
                        FStar_Extraction_ML_Syntax.MLE_App uu____4496  in
                      FStar_All.pipe_left w uu____4495  in
                    (FStar_Extraction_ML_Syntax.MLP_Wild,
                      FStar_Pervasives_Native.None, uu____4494)
                     in
                  let body1 =
                    let uu____4517 =
                      let uu____4518 =
                        let uu____4533 = str_to_name "args"  in
                        (uu____4533, [branch1; default_branch])  in
                      FStar_Extraction_ML_Syntax.MLE_Match uu____4518  in
                            ...
                            let uu____4584 =
                              let uu____4585 =
                                ...
                                FStar_Extraction_ML_Syntax.MLC_String
                                  uu____4586
                                 in
                              FStar_Extraction_ML_Syntax.MLE_Const uu____4585
                               in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.MLTY_Top)
                             ...
                             in
                          let uu____4588 =
                            let uu____4591 = mk_lam "_" body1  in
                            [uu____4591]  in
                          uu____4583 :: uu____4588  in
                        (uu____4578, uu____4580)  in
                      FStar_Extraction_ML_Syntax.MLE_App uu____4571  in
                    FStar_All.pipe_left w uu____4570  in
                  mk_lam "args" body2
               in
            let uu____4596 = FStar_Syntax_Util.arrow_formals_comp t1  in
                ...
                let uu____4629 =
                  ...
                  | FStar_Pervasives_Native.Some n1 ->
                      ...
                      then (bs, c)
                        ...
                        if n1 < n_bs
                        then
                          (let uu____4730 = FStar_Util.first_N n1 bs  in
                           ...
                           | (bs1,rest) ->
                               let c1 =
                                 ...
                                 FStar_All.pipe_left
                                   FStar_Syntax_Syntax.mk_Total uu____4808
                                  in
                               (bs1, c1))
                        else
                          (let msg =
                             ...
                             FStar_Util.format3
                               ...
                               uu____4825 uu____4827 uu____4829
                              in
                            ...
                            FStar_List.mapi
                              (fun i  ->
                                 fun tv  ->
                                   ...
                                   Prims.strcat "tv_" uu____5212) type_vars
                             in
                          let tvar_context =
                            FStar_List.map2
                              (fun b  ->
                                        ...
                                        let uu____5340 =
                                          let uu____5343 =
                                            ...
                                            FStar_All.pipe_left
                                              ...
                                              uu____5344
                                             in
                                          [uu____5343; fv_lid_embedded; cb]
                                           in
                                        uu____5339 :: uu____5340  in
                                      res_embedding :: uu____5336  in
                                     ...
                                     let uu____5399 =
                                       FStar_TypeChecker_Env.norm_eff_name
                                         ...
                                         (FStar_Syntax_Util.comp_effect_name
                                            c1)
                                        in
                                     FStar_Ident.lid_equals uu____5399
                                   ...
                                   then
                                           ...
                                           let uu____5429 =
                                             let uu____5430 =
                                               ...
                                               Prims.strcat
                                                 ...
                                                 uu____5432
                                                in
                                             str_to_top_name uu____5430  in
                                           let uu____5440 =
                                             let uu____5443 =
                                               lid_to_top_name fv_lid2  in
                                             [uu____5443]  in
                                           (uu____5429, uu____5440)  in
                                         FStar_Extraction_ML_Syntax.MLE_App
                                           uu____5422
                                          in
                                       FStar_All.pipe_left w uu____5421  in
                                     ...
                                     let tabs =
                                       ...
                                       | uu____5461 ->
                                        ...
                                        in
                                     let uu____5468 =
                                       let uu____5469 = mk_lam "ncb" tabs  in
                                       mk_lam "psc" uu____5469  in
                                     (uu____5468,
                                     ...
                                     (let uu____5484 =
                                        let uu____5485 =
                                          ...
                                          Prims.strcat
                                            ...
                                            uu____5487
                                           in
                                        NoTacticEmbedding uu____5485  in
                                ...
                                let uu____5519 =
                                  let uu____5522 =
                                    mk_embedding loc tvar_context
                                      b.FStar_Syntax_Syntax.sort
                                     in
                                  uu____5522 :: accum_embeddings  in
                                aux loc uu____5519 bs4
                             in
                          (try
                             (fun uu___284_5544  ->
                                match () with
                           ...
                           | NoTacticEmbedding msg ->
                               ((let uu____5644 =
                                 ...
                                 not_implemented_warning
                                   t1.FStar_Syntax_Syntax.pos uu____5644 msg);
                                FStar_Pervasives_Native.None))))
