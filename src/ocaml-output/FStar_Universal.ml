...
(let _0_695 = FStar_Parser_AST.Module ((let _0_694 = (FStar_Parser_Interleave.interleave decls1 decls2)
in ((lid1), (_0_694))))
in (_0_695)::[])
end
| uu____68 -> begin
...
let uu____90 = (let _0_696 = (FStar_ToSyntax_Env.empty_env ())
in (parse _0_696 None prims_filename))
in (match (uu____90) with
| (dsenv, prims_mod) -> begin
(

let uu____103 = (FStar_Util.record_time (fun uu____110 -> (let _0_697 = (FStar_List.hd prims_mod)
in (FStar_TypeChecker_Tc.check_module env _0_697))))
...
in (((m1 = m2) && (let _0_698 = (FStar_Util.get_file_extension intf)
in (_0_698 = "fsti"))) && (let _0_699 = (FStar_Util.get_file_extension impl)
in (_0_699 = "fst"))))))
...
| (dsenv, env) -> begin
((let _0_700 = (FStar_ToSyntax_Env.pop dsenv)
in (FStar_All.pipe_right _0_700 Prims.ignore));
(let _0_701 = (FStar_TypeChecker_Env.pop env msg)
...
| Some (uu____490) when (let _0_702 = (FStar_Options.codegen ())
in (_0_702 <> None)) -> begin
((
...
(let _0_703 = (tc_one_file_and_intf (Some (intf)) impl dsenv env)
in ((remaining), (_0_703)))
end
| (intf_or_impl)::remaining -> begin
(let _0_704 = (tc_one_file_and_intf None intf_or_impl dsenv env)
in ((remaining), (_0_704)))
end
| [] -> begin
(([]), ((([]), (dsenv), (env))))
...
let uu____783 = ((FStar_Options.interactive ()) && (let _0_705 = (FStar_Errors.get_err_count ())
in (_0_705 = (Prims.parse_int "0"))))
...
(let _0_707 = (let _0_706 = (FStar_Options.verify_module ())
in (FStar_String.concat " " _0_706))
...
| true -> begin
(let _0_708 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _0_708 Prims.ignore))
end
| uu____1079 -> begin
()
end);
...
Some ((let _0_709 = (FStar_Errors.get_err_count ())
in ((m), (((dsenv), (env))), (_0_709))))
end
| uu____1218 -> begin
None
end))
...
| FStar_Errors.Err (msg) when (not ((FStar_Options.trace_error ()))) -> begin
((let _0_712 = (let _0_711 = (let _0_710 = (FStar_TypeChecker_Env.get_range env)
in ((msg), (_0_710)))
in (_0_711)::[])
in (FStar_TypeChecker_Err.add_errors env _0_712));
None;
)
end
end))
...
let report_fail = (fun uu____1266 -> ((let _0_713 = (FStar_Errors.report_all ())
