            ...
            (let uu___9_51 = tcenv in
             {
               ...
               FStar_TypeChecker_Env.enable_defer_to_tac =
                 (uu___9_51.FStar_TypeChecker_Env.enable_defer_to_tac)
             }))
let with_tcenv_of_env :
  ...
  fun e ->
    fun f ->
      let uu____87 =
        let uu____92 = FStar_Extraction_ML_UEnv.tcenv_of_uenv e in f uu____92 in
      match uu____87 with
      | (a1, t') ->
  ...
  fun deps ->
    ...
    let env =
      ...
      FStar_TypeChecker_Env.initial_env deps FStar_TypeChecker_TcTerm.tc_term
        ...
        FStar_Parser_Const.prims_lid uu____392 in
    let env1 =
      let uu___69_411 = env in
      {
        ...
        FStar_TypeChecker_Env.enable_defer_to_tac =
          (uu___69_411.FStar_TypeChecker_Env.enable_defer_to_tac)
      } in
    let env2 =
      let uu___72_413 = env1 in
      {
        ...
        FStar_TypeChecker_Env.enable_defer_to_tac =
          (uu___72_413.FStar_TypeChecker_Env.enable_defer_to_tac)
      } in
    let env3 =
      let uu___75_415 = env2 in
      {
        ...
        FStar_TypeChecker_Env.enable_defer_to_tac =
          (uu___75_415.FStar_TypeChecker_Env.enable_defer_to_tac)
      } in
    let env4 =
      let uu___78_417 = env3 in
      {
        ...
        FStar_TypeChecker_Env.enable_defer_to_tac =
          (uu___78_417.FStar_TypeChecker_Env.enable_defer_to_tac)
      } in
    let env5 =
      let uu___81_419 = env4 in
      {
        ...
        FStar_TypeChecker_Env.enable_defer_to_tac =
          (uu___81_419.FStar_TypeChecker_Env.enable_defer_to_tac)
      } in
      ...
      fun frag ->
        ...
        let range_of_first_mod_decl modul =
          ...
          | FStar_Parser_AST.Module
              (uu____488,
               { FStar_Parser_AST.d = uu____489; FStar_Parser_AST.drange = d;
          ...
          | FStar_Parser_AST.Interface
              (uu____498,
               { FStar_Parser_AST.d = uu____499; FStar_Parser_AST.drange = d;
                 ...
                 FStar_Parser_AST.attrs = uu____502;_}::uu____503,
               uu____504)
              -> d
            ...
            (match uu____524 with
             | (ast_modul1, env1) ->
                 let uu____550 =
                   ...
                   FStar_All.pipe_left (with_dsenv_of_tcenv env1) uu____555 in
                        ...
                        then
                          let msg =
                            let uu____583 =
                              ...
                              FStar_Parser_Dep.module_name_of_file uu____585 in
                            FStar_Util.format1
                          ...
                          then ((modul, []), env2)
                            ...
                            (let uu____625 =
                               FStar_TypeChecker_Tc.tc_partial_modul env2
                                 modul in
                             match uu____625 with | (m, i, e) -> ((m, i), e)) in
  ...
  fun env ->
    fun interface_file_name ->
      ...
      | FStar_Parser_ParseIt.ASTFragment
          (FStar_Util.Inl (FStar_Parser_AST.Interface (l, decls, uu____878)),
           uu____879)
          ->
          let uu____902 =
            let uu____907 =
