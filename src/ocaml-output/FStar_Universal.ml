...
(let _0_1059 = FStar_Parser_AST.Module ((let _0_1058 = (FStar_Parser_Interleave.interleave decls1 decls2)
in ((lid1), (_0_1058))))
in (_0_1059)::[])
end
| uu____68 -> begin
...
let uu____90 = (let _0_1060 = (FStar_ToSyntax_Env.empty_env ())
in (parse _0_1060 None prims_filename))
in (match (uu____90) with
| (dsenv, prims_mod) -> begin
(

let uu____103 = (FStar_Util.record_time (fun uu____110 -> (let _0_1061 = (FStar_List.hd prims_mod)
in (FStar_TypeChecker_Tc.check_module env _0_1061))))
...
in (((m1 = m2) && (let _0_1062 = (FStar_Util.get_file_extension intf)
in (_0_1062 = "fsti"))) && (let _0_1063 = (FStar_Util.get_file_extension impl)
in (_0_1063 = "fst"))))))
...
| (dsenv, env) -> begin
((let _0_1064 = (FStar_ToSyntax_Env.pop dsenv)
in (FStar_All.pipe_right _0_1064 Prims.ignore));
(let _0_1065 = (FStar_TypeChecker_Env.pop env msg)
in (FStar_All.pipe_right _0_1065 Prims.ignore));
...
| Some (uu____490) when (let _0_1066 = (FStar_Options.codegen ())
in (_0_1066 <> None)) -> begin
((
...
(let _0_1067 = (tc_one_file_and_intf (Some (intf)) impl dsenv env)
in ((remaining), (_0_1067)))
end
| (intf_or_impl)::remaining -> begin
(let _0_1068 = (tc_one_file_and_intf None intf_or_impl dsenv env)
in ((remaining), (_0_1068)))
end
| [] -> begin
(([]), ((([]), (dsenv), (env))))
end)
...
let uu____783 = ((FStar_Options.interactive ()) && (let _0_1069 = (FStar_Errors.get_err_count ())
in (_0_1069 = (Prims.parse_int "0"))))
...
(let _0_1071 = (let _0_1070 = (FStar_Options.verify_module ())
in (FStar_String.concat " " _0_1070))
...
let uu___226_1073 = env
in {FStar_TypeChecker_Env.solver = uu___226_1073.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___226_1073.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___226_1073.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___226_1073.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___226_1073.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___226_1073.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___226_1073.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___226_1073.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___226_1073.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___226_1073.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___226_1073.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___226_1073.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___226_1073.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___226_1073.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___226_1073.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___226_1073.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___226_1073.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___226_1073.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax; FStar_TypeChecker_Env.lax_universes = uu___226_1073.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___226_1073.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___226_1073.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___226_1073.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___226_1073.FStar_TypeChecker_Env.qname_and_index})
in (
...
| true -> begin
(let _0_1072 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _0_1072 Prims.ignore))
end
| uu____1079 -> begin
()
end);
...
Some ((let _0_1073 = (FStar_Errors.get_err_count ())
in ((m), (((dsenv), (env))), (_0_1073))))
end
| uu____1218 -> begin
None
end))
...
| FStar_Errors.Err (msg) when (not ((FStar_Options.trace_error ()))) -> begin
((let _0_1076 = (let _0_1075 = (let _0_1074 = (FStar_TypeChecker_Env.get_range env)
in ((msg), (_0_1074)))
in (_0_1075)::[])
in (FStar_TypeChecker_Err.add_errors env _0_1076));
None;
)
end
end))
...
let report_fail = (fun uu____1266 -> ((let _0_1077 = (FStar_Errors.report_all ())
in (FStar_All.pipe_right _0_1077 Prims.ignore));
