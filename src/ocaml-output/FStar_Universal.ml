...
(let _0_674 = FStar_Parser_AST.Module ((let _0_673 = (FStar_Parser_Interleave.interleave decls1 decls2)
in ((lid1), (_0_673))))
in (_0_674)::[])
end
| uu____68 -> begin
...
let uu____90 = (let _0_675 = (FStar_ToSyntax_Env.empty_env ())
in (parse _0_675 None prims_filename))
in (match (uu____90) with
| (dsenv, prims_mod) -> begin
(

let uu____103 = (FStar_Util.record_time (fun uu____110 -> (let _0_676 = (FStar_List.hd prims_mod)
in (FStar_TypeChecker_Tc.check_module env _0_676))))
...
in (((m1 = m2) && (let _0_677 = (FStar_Util.get_file_extension intf)
in (_0_677 = "fsti"))) && (let _0_678 = (FStar_Util.get_file_extension impl)
in (_0_678 = "fst"))))))
...
| (dsenv, env) -> begin
((let _0_679 = (FStar_ToSyntax_Env.pop dsenv)
in (FStar_All.pipe_right _0_679 Prims.ignore));
(let _0_680 = (FStar_TypeChecker_Env.pop env msg)
...
| Some (uu____490) when (let _0_681 = (FStar_Options.codegen ())
in (_0_681 <> None)) -> begin
((
...
(let _0_682 = (tc_one_file_and_intf (Some (intf)) impl dsenv env)
in ((remaining), (_0_682)))
end
| (intf_or_impl)::remaining -> begin
(let _0_683 = (tc_one_file_and_intf None intf_or_impl dsenv env)
in ((remaining), (_0_683)))
end
| [] -> begin
(([]), ((([]), (dsenv), (env))))
...
let uu____783 = ((FStar_Options.interactive ()) && (let _0_684 = (FStar_Errors.get_err_count ())
in (_0_684 = (Prims.parse_int "0"))))
...
(let _0_686 = (let _0_685 = (FStar_Options.verify_module ())
in (FStar_String.concat " " _0_685))
...
| true -> begin
(let _0_687 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _0_687 Prims.ignore))
end
| uu____1079 -> begin
()
end);
...
Some ((let _0_688 = (FStar_Errors.get_err_count ())
in ((m), (((dsenv), (env))), (_0_688))))
end
| uu____1218 -> begin
None
end))
...
| FStar_Errors.Err (msg) when (not ((FStar_Options.trace_error ()))) -> begin
((let _0_691 = (let _0_690 = (let _0_689 = (FStar_TypeChecker_Env.get_range env)
in ((msg), (_0_689)))
in (_0_690)::[])
in (FStar_TypeChecker_Err.add_errors env _0_691));
None;
)
end
end))
...
let report_fail = (fun uu____1266 -> ((let _0_692 = (FStar_Errors.report_all ())
