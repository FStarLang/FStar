            ...
            (let uu___415_55 = env  in
             {
               ...
               FStar_TypeChecker_Env.fv_delta_depths =
                 (uu___415_55.FStar_TypeChecker_Env.fv_delta_depths);
  ...
  fun deps  ->
    ...
    let env1 =
      let uu___417_271 = env  in
      {
        ...
        FStar_TypeChecker_Env.fv_delta_depths =
          (uu___417_271.FStar_TypeChecker_Env.fv_delta_depths);
        FStar_TypeChecker_Env.proof_ns =
    ...
    let env2 =
      let uu___418_273 = env1  in
      {
        ...
        FStar_TypeChecker_Env.fv_delta_depths =
          (uu___418_273.FStar_TypeChecker_Env.fv_delta_depths);
        FStar_TypeChecker_Env.proof_ns =
    ...
    let env3 =
      let uu___419_275 = env2  in
      {
        ...
        FStar_TypeChecker_Env.fv_delta_depths =
          (uu___419_275.FStar_TypeChecker_Env.fv_delta_depths);
        FStar_TypeChecker_Env.proof_ns =
    ...
    | FStar_Pervasives_Native.Some (vnum,digest,tcmod,tcmod_iface_opt,mii) ->
        ...
        then FStar_Util.Inl "Stale, because inconsistent cache version"
          ...
          (let uu____969 =
                   ...
                   then
                     ((let uu____1036 =
                         FStar_Util.string_of_int (FStar_List.length digest')
                          in
                       let uu____1041 = FStar_Parser_Dep.print_digest digest'
                          in
                       let uu____1042 =
                         FStar_Util.string_of_int (FStar_List.length digest)
                          in
                       let uu____1047 = FStar_Parser_Dep.print_digest digest
                          in
                       FStar_Util.print4
                         "Expected (%s) hashes:\n%s\n\nGot (%s) hashes:\n\t%s\n"
           ...
           | uu____1131 -> FStar_Util.Inl "Unable to compute digest of")
     in
  fun env  ->
    fun fn  ->
            ...
            (let uu____1335 =
             ...
             | FStar_Pervasives_Native.Some alt_cache_file ->
                 ...
                 (match uu____1350 with
                  ...
                  | FStar_Util.Inr res ->
                      ((let uu____1400 = FStar_Options.should_verify_file fn
                           in
                        if uu____1400
