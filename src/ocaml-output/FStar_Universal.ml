          ...
          (let maybe_restore_opts uu____1053 =
             ...
             then
               let uu____1059 = FStar_Options.restore_cmd_line_options true
                  in
               FStar_All.pipe_right uu____1059 (fun uu____1061  -> ())
             else ()  in
           let post_smt_encoding uu____1069 = FStar_SMTEncoding_Z3.refresh ()
              in
           let maybe_extract_mldefs tcmod env1 =
             let uu____1088 =
               (let uu____1092 = FStar_Options.codegen ()  in
                 ...
                 (fun uu____1117  ->
                    with_env env1
                      (fun env2  ->
                         ...
                         match uu____1125 with | (uu____1134,defs) -> defs))
              in
           let maybe_extract_ml_iface tcmod env1 =
             let uu____1156 =
               let uu____1158 = FStar_Options.codegen ()  in
                 ...
                 (fun uu____1177  ->
                    let uu____1178 =
                      with_env env1
                       ...
                       in
                    match uu____1178 with | (env2,uu____1190) -> env2)
              in
           let tc_source_file uu____1204 =
             let uu____1205 = parse env pre_fn fn  in
             ...
             | (fmod,env1) ->
                 let mii =
                   let uu____1221 =
                     ...
                     uu____1222.FStar_TypeChecker_Env.dsenv  in
                   FStar_Syntax_DsEnv.inclusion_info uu____1221
                     fmod.FStar_Syntax_Syntax.name
                    in
                 let check_mod uu____1236 =
                   let check1 env2 =
                     with_tcenv_of_env env2
                          ...
                          (let uu____1280 =
                           ...
                           | (modul,env3) ->
                               (maybe_restore_opts ();
                                (let smt_decls =
                                   let uu____1310 =
                                     let uu____1312 = FStar_Options.lax ()
                                        in
                                     Prims.op_Negation uu____1312  in
                                   if uu____1310
                                   then
                                     let smt_decls =
                      ...
                      in
                   let uu____1349 =
                     FStar_Profiling.profile (fun uu____1379  -> check1 env1)
                   ...
                   | ((tcmod,smt_decls),env2) ->
                       ...
                       let uu____1418 = maybe_extract_mldefs tcmod env2  in
                 ...
                 if uu____1462
                 then
                   let uu____1473 = FStar_Parser_ParseIt.find_file fn  in
                   FStar_SMTEncoding_Solver.with_hints_db uu____1473
                     check_mod
                 else check_mod ()
              in
           let uu____1485 =
             let uu____1487 = FStar_Options.cache_off ()  in
             Prims.op_Negation uu____1487  in
           if uu____1485
           then
             let uu____1498 =
             ...
             | FStar_Pervasives_Native.None  ->
                 ((let uu____1510 =
                     let uu____1512 = FStar_Parser_Dep.module_name_of_file fn
                        in
                     FStar_Options.should_be_already_cached uu____1512  in
                   if uu____1510
                   then
                     let uu____1515 =
                       let uu____1521 =
                       ...
                       (FStar_Errors.Error_AlreadyCachedAssertionFailure,
                         uu____1521)
                        in
                     FStar_Errors.raise_err uu____1515
                   else ());
                  (let uu____1528 =
                     (let uu____1532 = FStar_Options.codegen ()  in
                   ...
                   then
                     let uu____1536 =
                       ...
                       (FStar_Errors.Error_AlreadyCachedAssertionFailure,
                         uu____1542)
                        in
                     FStar_Errors.raise_err uu____1536
                   else ());
                  (let uu____1548 = tc_source_file ()  in
                   match uu____1548 with
                   | (tc_result,mllib,env1) ->
                       ((let uu____1573 =
                           (let uu____1577 = FStar_Errors.get_err_count ()
                               in
                            uu____1577 = Prims.int_zero) &&
                             ((FStar_Options.lax ()) ||
                                (FStar_Options.should_verify
                 ...
                 ((let uu____1596 =
                  ...
                  (let extend_tcenv tcmod1 tcenv =
                     ...
                     | (uu____1640,tcenv1) ->
                         ...
                         (maybe_restore_opts ();
                          (let uu____1645 =
                             let uu____1647 = FStar_Options.lax ()  in
                   ...
                   let mllib =
                     let uu____1671 =
                       ((let uu____1675 = FStar_Options.codegen ()  in
                         uu____1675 <> FStar_Pervasives_Native.None) &&
                          (FStar_Options.should_extract
                             (tcmod.FStar_Syntax_Syntax.name).FStar_Ident.str))
                         &&
                         ((Prims.op_Negation
                            ...
                            ||
                            (let uu____1681 = FStar_Options.codegen ()  in
                             uu____1681 =
                               (FStar_Pervasives_Native.Some
                     ...
                     if uu____1671
                     then
                       let uu____1689 = maybe_extract_mldefs tcmod env1  in
                       match uu____1689 with
                       | (extracted_defs,_extraction_time) -> extracted_defs
                     else FStar_Pervasives_Native.None  in
                   let uu____1709 = maybe_extract_ml_iface tcmod env1  in
                   match uu____1709 with
                   | (env2,_time) -> (tc_result, mllib, env2)))
           else
             (let uu____1731 = tc_source_file ()  in
    ...
    fun pre_fn  ->
      fun fn  ->
        fun parsing_data  ->
          ...
          let uu____1795 = tc_one_file env1 pre_fn fn parsing_data  in
          match uu____1795 with
          | (tc_result,uu____1809,env2) ->
              let uu____1815 = FStar_Extraction_ML_UEnv.tcenv_of_uenv env2
                 in
              (tc_result, uu____1815)
