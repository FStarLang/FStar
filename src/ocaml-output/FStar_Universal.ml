...
let module_or_interface_name
  ...
  fun m -> (m.FStar_Syntax_Syntax.is_interface, m.FStar_Syntax_Syntax.name)
...
let with_tcenv:
      'a. FStar_TypeChecker_Env.env -> 'a FStar_ToSyntax_Env.withenv
      -> ('a, FStar_TypeChecker_Env.env) FStar_Pervasives_Native.tuple2 =
  fun env f ->
    let uu____47 = f env.FStar_TypeChecker_Env.dsenv in
    match uu____47 with a, dsenv ->
      ( a
      , let uu___51_61 = env in
        { FStar_TypeChecker_Env.solver= uu___51_61.FStar_TypeChecker_Env.solver
        ; FStar_TypeChecker_Env.range= uu___51_61.FStar_TypeChecker_Env.range
        ; FStar_TypeChecker_Env.curmodule=
            uu___51_61.FStar_TypeChecker_Env.curmodule
        ; FStar_TypeChecker_Env.gamma= uu___51_61.FStar_TypeChecker_Env.gamma
        ...
        ; FStar_TypeChecker_Env.sigtab= uu___51_61.FStar_TypeChecker_Env.sigtab
        ...
        ; FStar_TypeChecker_Env.use_eq= uu___51_61.FStar_TypeChecker_Env.use_eq
        ; FStar_TypeChecker_Env.is_iface=
            uu___51_61.FStar_TypeChecker_Env.is_iface
        ; FStar_TypeChecker_Env.admit= uu___51_61.FStar_TypeChecker_Env.admit
        ; FStar_TypeChecker_Env.lax= uu___51_61.FStar_TypeChecker_Env.lax
        ...
        ; FStar_TypeChecker_Env.synth= uu___51_61.FStar_TypeChecker_Env.synth
...
let parse
    : FStar_TypeChecker_Env.env -> Prims.string FStar_Pervasives_Native.option
      -> Prims.string
      -> ( FStar_Syntax_Syntax.modul
  ...
  fun env pre_fn fn ->
    ...
    match uu____83 with ast, uu____99 ->
      let uu____112 =
        match pre_fn with
        | FStar_Pervasives_Native.None -> (ast, env)
        | FStar_Pervasives_Native.Some pre_fn1 ->
            let uu____122 = FStar_Parser_Driver.parse_file pre_fn1 in
            match uu____122 with pre_ast, uu____138 ->
              match (pre_ast, ast) with
              | ( FStar_Parser_AST.Interface (lid1, decls1, uu____157)
                , FStar_Parser_AST.Module (lid2, decls2) )
                when FStar_Ident.lid_equals lid1 lid2
                -> (
                  let uu____168 =
                    let uu____173 =
                      FStar_ToSyntax_Interleave.initialize_interface lid1
                        decls1
                    in
                    FStar_All.pipe_left (with_tcenv env) uu____173
                  in
                  match uu____168 with uu____190, env1 ->
                    let uu____192 =
                      FStar_ToSyntax_Interleave.interleave_module ast true
                    in
                    FStar_All.pipe_left (with_tcenv env1) uu____192 )
              | uu____205 ->
                  FStar_Errors.raise_err
                    ( FStar_Errors.Fatal_PreModuleMismatch
                    , "mismatch between pre-module and module\n" )
      in
      match uu____112 with ast1, env1 ->
        let uu____220 = FStar_ToSyntax_ToSyntax.ast_modul_to_modul ast1 in
...
let init_env : FStar_Parser_Dep.deps -> FStar_TypeChecker_Env.env =
  fun deps ->
    let solver1 =
      ...
      if uu____237 then FStar_SMTEncoding_Solver.dummy
      else
        let uu___52_239 = FStar_SMTEncoding_Solver.solver in
        { FStar_TypeChecker_Env.init= uu___52_239.FStar_TypeChecker_Env.init
        ; FStar_TypeChecker_Env.push= uu___52_239.FStar_TypeChecker_Env.push
        ; FStar_TypeChecker_Env.pop= uu___52_239.FStar_TypeChecker_Env.pop
        ...
        ; FStar_TypeChecker_Env.solve= uu___52_239.FStar_TypeChecker_Env.solve
    ...
    let env1 =
      ...
      { FStar_TypeChecker_Env.solver= uu___53_242.FStar_TypeChecker_Env.solver
      ; FStar_TypeChecker_Env.range= uu___53_242.FStar_TypeChecker_Env.range
      ; FStar_TypeChecker_Env.curmodule=
          uu___53_242.FStar_TypeChecker_Env.curmodule
      ; FStar_TypeChecker_Env.gamma= uu___53_242.FStar_TypeChecker_Env.gamma
      ; FStar_TypeChecker_Env.gamma_cache=
      ...
      ; FStar_TypeChecker_Env.sigtab= uu___53_242.FStar_TypeChecker_Env.sigtab
      ; FStar_TypeChecker_Env.is_pattern=
      ...
      ; FStar_TypeChecker_Env.use_eq= uu___53_242.FStar_TypeChecker_Env.use_eq
      ; FStar_TypeChecker_Env.is_iface=
          uu___53_242.FStar_TypeChecker_Env.is_iface
      ; FStar_TypeChecker_Env.admit= uu___53_242.FStar_TypeChecker_Env.admit
      ...
      ; FStar_TypeChecker_Env.dsenv= uu___53_242.FStar_TypeChecker_Env.dsenv
      ; FStar_TypeChecker_Env.dep_graph=
          uu___53_242.FStar_TypeChecker_Env.dep_graph }
    in
    let env2 =
      let uu___54_244 = env1 in
      { FStar_TypeChecker_Env.solver= uu___54_244.FStar_TypeChecker_Env.solver
      ; FStar_TypeChecker_Env.range= uu___54_244.FStar_TypeChecker_Env.range
      ; FStar_TypeChecker_Env.curmodule=
          uu___54_244.FStar_TypeChecker_Env.curmodule
      ; FStar_TypeChecker_Env.gamma= uu___54_244.FStar_TypeChecker_Env.gamma
      ; FStar_TypeChecker_Env.gamma_cache=
      ...
      ; FStar_TypeChecker_Env.sigtab= uu___54_244.FStar_TypeChecker_Env.sigtab
      ; FStar_TypeChecker_Env.is_pattern=
      ...
      ; FStar_TypeChecker_Env.use_eq= uu___54_244.FStar_TypeChecker_Env.use_eq
      ; FStar_TypeChecker_Env.is_iface=
          uu___54_244.FStar_TypeChecker_Env.is_iface
      ; FStar_TypeChecker_Env.admit= uu___54_244.FStar_TypeChecker_Env.admit
      ...
      ; FStar_TypeChecker_Env.synth= uu___54_244.FStar_TypeChecker_Env.synth
      ; FStar_TypeChecker_Env.is_native_tactic=
      ...
      ; FStar_TypeChecker_Env.dsenv= uu___54_244.FStar_TypeChecker_Env.dsenv
      ; FStar_TypeChecker_Env.dep_graph=
...
let tc_one_fragment
    : FStar_Syntax_Syntax.modul FStar_Pervasives_Native.option
      -> FStar_TypeChecker_Env.env -> FStar_Parser_ParseIt.input_frag
      -> ( FStar_Syntax_Syntax.modul FStar_Pervasives_Native.option
         , FStar_TypeChecker_Env.env )
         FStar_Pervasives_Native.tuple2 =
  fun curmod env frag ->
    let acceptable_mod_name modul =
      let uu____269 =
        let uu____270 =
          ...
          FStar_List.hd uu____271
        in
        FStar_Parser_Dep.lowercase_module_name uu____270
      in
      let uu____274 =
        let uu____275 =
          FStar_Ident.string_of_lid modul.FStar_Syntax_Syntax.name
        in
        FStar_String.lowercase uu____275
      in
      uu____269 = uu____274
    in
    let range_of_first_mod_decl modul =
      ...
      | FStar_Parser_AST.Module
          ( uu____280
          , { FStar_Parser_AST.d= uu____281
            ; FStar_Parser_AST.drange= d
            ; FStar_Parser_AST.doc= uu____283
            ; FStar_Parser_AST.quals= uu____284
            ; FStar_Parser_AST.attrs= uu____285; _ }
            :: uu____286 ) ->
          d
      | FStar_Parser_AST.Interface
          ( uu____293
          , { FStar_Parser_AST.d= uu____294
            ; FStar_Parser_AST.drange= d
            ; FStar_Parser_AST.doc= uu____296
            ; FStar_Parser_AST.quals= uu____297
            ; FStar_Parser_AST.attrs= uu____298; _ }
            :: uu____299
          , uu____300 ) ->
          d
      | uu____307 -> FStar_Range.dummyRange
    in
    ...
    | FStar_Parser_Driver.Modul ast_modul -> (
        let uu____320 =
          ...
          in
          FStar_All.pipe_left (with_tcenv env) uu____325
        in
        match uu____320 with ast_modul1, env1 ->
          let uu____346 =
            let uu____351 =
              FStar_ToSyntax_ToSyntax.partial_ast_modul_to_modul curmod
                ast_modul1
            in
            FStar_All.pipe_left (with_tcenv env1) uu____351
          in
          match uu____346 with modul, env2 ->
            (let uu____373 =
            ...
            let uu____382 =
              let uu____391 =
                FStar_ToSyntax_Env.syntax_only env2.FStar_TypeChecker_Env.dsenv
              in
              if uu____391 then (modul, [], env2)
              else FStar_TypeChecker_Tc.tc_partial_modul env2 modul false
            in
            match uu____382 with modul1, uu____410, env3 ->
          ...
          let uu____448 =
            FStar_Util.fold_map
              (fun env1 a_decl ->
                ...
                in
                match uu____466 with decls, env2 -> (env2, decls) )
              env ast_decls
          in
          match uu____448 with env1, ast_decls_l ->
            let uu____524 =
              let uu____529 =
                FStar_ToSyntax_ToSyntax.decls_to_sigelts
                  (FStar_List.flatten ast_decls_l)
              in
              FStar_All.pipe_left (with_tcenv env1) uu____529
            in
            match uu____524 with sigelts, env2 ->
              let uu____550 =
                let uu____559 =
                  FStar_ToSyntax_Env.syntax_only
                    env2.FStar_TypeChecker_Env.dsenv
                in
                if uu____559 then (modul, [], env2)
                else
                  FStar_TypeChecker_Tc.tc_more_partial_modul env2 modul sigelts
              in
              match uu____550 with modul1, uu____578, env3 ->
                (FStar_Pervasives_Native.Some modul1, env3)


let load_interface_decls
    : FStar_TypeChecker_Env.env -> FStar_Parser_ParseIt.filename
      -> FStar_TypeChecker_Env.env =
  fun env interface_file_name ->
    let r =
    ...
    | FStar_Parser_ParseIt.ASTFragment
        ( FStar_Util.Inl FStar_Parser_AST.Interface (l, decls, uu____595)
        , uu____596 ) ->
        let uu____621 =
          let uu____626 =
            FStar_ToSyntax_Interleave.initialize_interface l decls
          in
          FStar_All.pipe_left (with_tcenv env) uu____626
        in
        ...
        let uu____650 =
          let uu____655 =
            FStar_Util.format1
              ...
              interface_file_name
          in
          (FStar_Errors.Fatal_ParseErrors, uu____655)
        in
...
let load_module_from_cache
    : FStar_TypeChecker_Env.env -> Prims.string
      -> ( FStar_Syntax_Syntax.modul
    ...
    let fail1 tag =
      (let uu____690 =
         ...
         let uu____692 =
           FStar_Range.mk_pos (Prims.parse_int "0") (Prims.parse_int "0")
         in
         FStar_Range.mk_range fn uu____691 uu____692
       in
       let uu____693 =
         let uu____698 =
           FStar_Util.format3 "%s cache file %s; will recheck %s" tag
             cache_file fn
         in
         (FStar_Errors.Warning_CachedFile, uu____698)
       in
       FStar_Errors.log_issue uu____690 uu____693) ;
      FStar_Pervasives_Native.None
    in
    if FStar_Util.file_exists cache_file then
      ...
      | FStar_Pervasives_Native.Some (digest, tcmod, mii) ->
          ...
          | FStar_Pervasives_Native.Some digest' ->
              if digest = digest' then FStar_Pervasives_Native.Some (tcmod, mii)
              else (
                (let uu____827 = FStar_Options.debug_any () in
                 if uu____827 then (
                   (let uu____829 =
                    ...
                    in
                    let uu____834 = FStar_Parser_Dep.print_digest digest' in
                    let uu____835 =
                      FStar_Util.string_of_int (FStar_List.length digest)
                    in
                   ...
                   if FStar_List.length digest = FStar_List.length digest' then
                     FStar_List.iter2
                       (fun uu____865 uu____866 ->
                         match (uu____865, uu____866)
                         with (x, y), (x', y') ->
                           if x <> x || y <> y' then
                             let uu____895 =
...
let store_module_to_cache
    : FStar_TypeChecker_Env.env -> Prims.string -> FStar_Syntax_Syntax.modul
      -> FStar_ToSyntax_Env.module_inclusion_info -> Prims.unit =
  fun env fn modul mii ->
    let cache_file = FStar_Parser_Dep.cache_file_name fn in
    let digest =
      FStar_Parser_Dep.hash_dependences env.FStar_TypeChecker_Env.dep_graph fn
    in
    match digest with
    ...
    | uu____979 ->
        let uu____988 =
          ...
          let uu____990 =
            FStar_Range.mk_pos (Prims.parse_int "0") (Prims.parse_int "0")
          in
          FStar_Range.mk_range fn uu____989 uu____990
        in
        let uu____991 =
          let uu____996 =
            FStar_Util.format1
              ...
              cache_file
          in
          (FStar_Errors.Warning_FileNotWritten, uu____996)
        in
...
let tc_one_file
  ...
  fun env pre_fn fn ->
    ...
    let tc_source_file uu____1040 =
      ...
      match uu____1041 with fmod, env1 ->
        let check_mod uu____1069 =
          let uu____1070 =
            FStar_Util.record_time (fun uu____1084 ->
                FStar_TypeChecker_Tc.check_module env1 fmod )
          in
          match uu____1070 with (tcmod, env2), time -> ((tcmod, time), env2)
        in
        let uu____1104 =
          let uu____1113 =
            FStar_Options.should_verify
              fmod.FStar_Syntax_Syntax.name.FStar_Ident.str
            && (FStar_Options.record_hints () || FStar_Options.use_hints ())
          in
          if uu____1113 then
            let uu____1122 = FStar_Parser_ParseIt.find_file fn in
            FStar_SMTEncoding_Solver.with_hints_db uu____1122 check_mod
          else check_mod ()
        in
        match uu____1104 with tcmod, env2 ->
          let mii =
            FStar_ToSyntax_Env.inclusion_info env2.FStar_TypeChecker_Env.dsenv
    ...
    if uu____1157 then
      ...
      | FStar_Pervasives_Native.None -> (
          ...
          match uu____1185 with tcmod, mii, env1 ->
            (let uu____1216 =
      ...
      | FStar_Pervasives_Native.Some (tcmod, mii) ->
          let uu____1231 =
            ...
            in
            FStar_All.pipe_left (with_tcenv env) uu____1236
          in
          match uu____1231 with uu____1257, env1 ->
            let env2 = FStar_TypeChecker_Tc.load_checked_module env1 tcmod in
...
let push_context
  ...
  fun env msg ->
    ...
    let uu___55_1349 = env1 in
    { FStar_TypeChecker_Env.solver= uu___55_1349.FStar_TypeChecker_Env.solver
    ; FStar_TypeChecker_Env.range= uu___55_1349.FStar_TypeChecker_Env.range
    ; FStar_TypeChecker_Env.curmodule=
        uu___55_1349.FStar_TypeChecker_Env.curmodule
    ; FStar_TypeChecker_Env.gamma= uu___55_1349.FStar_TypeChecker_Env.gamma
    ; FStar_TypeChecker_Env.gamma_cache=
        uu___55_1349.FStar_TypeChecker_Env.gamma_cache
    ; FStar_TypeChecker_Env.modules= uu___55_1349.FStar_TypeChecker_Env.modules
    ; FStar_TypeChecker_Env.expected_typ=
        uu___55_1349.FStar_TypeChecker_Env.expected_typ
    ; FStar_TypeChecker_Env.sigtab= uu___55_1349.FStar_TypeChecker_Env.sigtab
    ; FStar_TypeChecker_Env.is_pattern=
        uu___55_1349.FStar_TypeChecker_Env.is_pattern
    ; FStar_TypeChecker_Env.instantiate_imp=
        uu___55_1349.FStar_TypeChecker_Env.instantiate_imp
    ; FStar_TypeChecker_Env.effects= uu___55_1349.FStar_TypeChecker_Env.effects
    ; FStar_TypeChecker_Env.generalize=
        uu___55_1349.FStar_TypeChecker_Env.generalize
    ; FStar_TypeChecker_Env.letrecs= uu___55_1349.FStar_TypeChecker_Env.letrecs
    ; FStar_TypeChecker_Env.top_level=
        uu___55_1349.FStar_TypeChecker_Env.top_level
    ; FStar_TypeChecker_Env.check_uvars=
        uu___55_1349.FStar_TypeChecker_Env.check_uvars
    ; FStar_TypeChecker_Env.use_eq= uu___55_1349.FStar_TypeChecker_Env.use_eq
    ; FStar_TypeChecker_Env.is_iface=
        uu___55_1349.FStar_TypeChecker_Env.is_iface
    ; FStar_TypeChecker_Env.admit= uu___55_1349.FStar_TypeChecker_Env.admit
    ; FStar_TypeChecker_Env.lax= uu___55_1349.FStar_TypeChecker_Env.lax
    ; FStar_TypeChecker_Env.lax_universes=
        uu___55_1349.FStar_TypeChecker_Env.lax_universes
    ; FStar_TypeChecker_Env.failhard=
        uu___55_1349.FStar_TypeChecker_Env.failhard
    ; FStar_TypeChecker_Env.nosynth= uu___55_1349.FStar_TypeChecker_Env.nosynth
    ; FStar_TypeChecker_Env.tc_term= uu___55_1349.FStar_TypeChecker_Env.tc_term
    ; FStar_TypeChecker_Env.type_of= uu___55_1349.FStar_TypeChecker_Env.type_of
    ; FStar_TypeChecker_Env.universe_of=
        uu___55_1349.FStar_TypeChecker_Env.universe_of
    ; FStar_TypeChecker_Env.check_type_of=
        uu___55_1349.FStar_TypeChecker_Env.check_type_of
    ; FStar_TypeChecker_Env.use_bv_sorts=
        uu___55_1349.FStar_TypeChecker_Env.use_bv_sorts
    ; FStar_TypeChecker_Env.qname_and_index=
        uu___55_1349.FStar_TypeChecker_Env.qname_and_index
    ; FStar_TypeChecker_Env.proof_ns=
        uu___55_1349.FStar_TypeChecker_Env.proof_ns
    ; FStar_TypeChecker_Env.synth= uu___55_1349.FStar_TypeChecker_Env.synth
    ; FStar_TypeChecker_Env.is_native_tactic=
        uu___55_1349.FStar_TypeChecker_Env.is_native_tactic
    ; FStar_TypeChecker_Env.identifier_info=
        uu___55_1349.FStar_TypeChecker_Env.identifier_info
    ; FStar_TypeChecker_Env.tc_hooks=
        uu___55_1349.FStar_TypeChecker_Env.tc_hooks
    ; FStar_TypeChecker_Env.dsenv
    ; FStar_TypeChecker_Env.dep_graph=
        uu___55_1349.FStar_TypeChecker_Env.dep_graph }


let tc_one_file_from_remaining
    : Prims.string Prims.list -> FStar_TypeChecker_Env.env
  ...
  fun remaining env ->
    let uu____1374 =
      ...
      | [] -> ([], ([], env))
    in
    match uu____1374 with remaining1, (nmods, env1) -> (remaining1, nmods, env1)
...
let rec tc_fold_interleave
  ...
  fun acc remaining ->
    ...
    | uu____1661 ->
        ...
        match uu____1664 with mods, env ->
          let uu____1699 = tc_one_file_from_remaining remaining env in
          match uu____1699 with remaining1, nmods, env1 ->
...
let batch_mode_tc
  ...
  fun filenames dep_graph1 ->
    (let uu____1774 = FStar_Options.debug_any () in
     if uu____1774 then (
       ...
       let uu____1777 =
         ...
         in
         FStar_String.concat " " uu____1778
       in
    ...
    match uu____1787 with all_mods, env1 ->
      (let uu____1833 =
         FStar_Options.interactive ()
         &&
         let uu____1835 = FStar_Errors.get_err_count () in
         uu____1835 = Prims.parse_int "0"
       in
       if uu____1833 then
         env1.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ()
       else env1.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.finish ()) ;
      (all_mods, env1)
