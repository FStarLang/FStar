         ...
         let uu____103 =
           FStar_Util.record_time
             (fun uu____110  ->
                ...
                FStar_TypeChecker_Tc.check_module env _0_675) in
      ...
      | (dsenv,env) ->
          let uu____561 =
            ...
            | intf::impl::remaining when needs_interleaving intf impl ->
                let _0_684 = tc_one_file_and_intf (Some intf) impl dsenv env in
                (remaining, _0_684)
            | intf_or_impl::remaining ->
                let _0_685 = tc_one_file_and_intf None intf_or_impl dsenv env in
                (remaining, _0_685)
            | [] -> ([], ([], dsenv, env)) in
