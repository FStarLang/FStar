    ...
    fun fn  ->
      let load_it uu____72791 =
        ...
        let fail1 msg cache_file1 =
          invalidate_cache ();
          (let uu____72810 =
             let uu____72812 = FStar_Options.should_verify_file fn  in
             Prims.op_Negation uu____72812  in
           if uu____72810
           then
             let uu____72815 =
               let uu____72816 =
               ...
               let uu____72819 =
                 FStar_Range.mk_pos (Prims.parse_int "0")
                   (Prims.parse_int "0")
                  in
               FStar_Range.mk_range fn uu____72816 uu____72819  in
             let uu____72822 =
               let uu____72828 =
                 FStar_Util.format3
                   ...
                   cache_file1 msg fn
                  in
               (FStar_Errors.Warning_CachedFile, uu____72828)  in
             FStar_Errors.log_issue uu____72815 uu____72822
           else ())
           in
        let uu____72834 = FStar_ST.op_Bang some_cache_invalid  in
        match uu____72834 with
        | FStar_Pervasives_Native.Some uu____72862 ->
            FStar_Pervasives_Native.None
        | uu____72863 ->
      ...
      FStar_Options.profile load_it
        (fun res  ->
           ...
           let uu____72905 = FStar_Parser_Dep.cache_file_name fn  in
           FStar_Util.format2 "Loading checked file %s ... %s" uu____72905
             msg)
        ...
        fun tc_result  ->
          let uu____72931 =
            (FStar_Options.cache_checked_modules ()) &&
              (let uu____72934 = FStar_Options.cache_off ()  in
               Prims.op_Negation uu____72934)
             in
          if uu____72931
          then
            let cache_file = FStar_Parser_Dep.cache_file_name fn  in
            let digest =
              let uu____72953 =
                FStar_TypeChecker_Env.dep_graph
                 ...
                 in
              FStar_Parser_Dep.hash_dependences uu____72953 fn cache_file  in
            match digest with
            | FStar_Util.Inr hashes ->
                let tc_result1 =
                  let uu___994_72973 = tc_result  in
                  {
                    checked_module = (uu___994_72973.checked_module);
                    mii = (uu___994_72973.mii);
                    smt_decls = (uu___994_72973.smt_decls);
                    tc_time = (Prims.parse_int "0");
                    extraction_time = (uu___994_72973.extraction_time)
                  }  in
                let uu____72975 =
                  let uu____72976 = FStar_Util.digest_of_file fn  in
                  (cache_version_number, hashes, uu____72976, parsing_data,
                    tc_result1)
                   in
                store_value_to_cache cache_file uu____72975
            | FStar_Util.Inl msg ->
                let uu____72999 =
                  let uu____73000 =
                    FStar_Range.mk_pos (Prims.parse_int "0")
                  ...
                  let uu____73003 =
                    FStar_Range.mk_pos (Prims.parse_int "0")
                      (Prims.parse_int "0")
                     in
                  FStar_Range.mk_range fn uu____73000 uu____73003  in
                let uu____73006 =
                  let uu____73012 =
                    FStar_Util.format2
                      ...
                      cache_file msg
                     in
                  (FStar_Errors.Warning_FileNotWritten, uu____73012)  in
                FStar_Errors.log_issue uu____72999 uu____73006
          else ()
  ...
  fun f  ->
    fun g  ->
      ...
      | FStar_Pervasives_Native.Some f1 ->
          FStar_Pervasives_Native.Some
            ((fun e  -> let uu____73089 = f1 e  in g uu____73089))
  ...
  fun mllibs  ->
    ...
    then
      let ext =
        ...
        | uu____73113 -> failwith "Unrecognized option"  in
      match opt with
      ...
      | FStar_Pervasives_Native.Some (FStar_Options.Kremlin ) ->
          ...
          (match programs with
           | (name,uu____73138)::[] ->
               ...
               FStar_Util.save_value_to_file uu____73141 bin
           | uu____73143 ->
               let uu____73146 = FStar_Options.prepend_output_dir "out.krml"
                  in
               FStar_Util.save_value_to_file uu____73146 bin)
      | uu____73149 -> failwith "Unrecognized option"
    else ()
      ...
      fun pre_fn  ->
        fun fn  ->
          fun parsing_data  ->
            ...
            (let post_smt_encoding uu____73215 =
               FStar_SMTEncoding_Z3.refresh ();
               (let uu____73217 =
                  let uu____73219 = FStar_Options.interactive ()  in
                  Prims.op_Negation uu____73219  in
                if uu____73217
                then
                  let uu____73222 =
                    FStar_Options.restore_cmd_line_options true  in
                  FStar_All.pipe_right uu____73222 (fun a1  -> ())
                else ())
                in
             let maybe_extract_mldefs tcmod env1 =
               let uu____73244 =
                 (let uu____73248 = FStar_Options.codegen ()  in
                  uu____73248 = FStar_Pervasives_Native.None) ||
                   (let uu____73254 =
                      FStar_Options.should_extract
                        (tcmod.FStar_Syntax_Syntax.name).FStar_Ident.str
                       in
                    Prims.op_Negation uu____73254)
                  in
               if uu____73244
               then (FStar_Pervasives_Native.None, (Prims.parse_int "0"))
                 ...
                 FStar_Util.record_time
                   (fun uu____73276  ->
                      ...
                      match uu____73277 with | (uu____73286,defs) -> defs)
                in
             let maybe_extract_ml_iface tcmod env1 =
               let uu____73308 =
                 let uu____73310 = FStar_Options.codegen ()  in
                 uu____73310 = FStar_Pervasives_Native.None  in
               if uu____73308
               then (env1, (Prims.parse_int "0"))
                ...
                in
             let tc_source_file uu____73369 =
               let env1 = apply_delta_env env delta1  in
               let uu____73371 = parse env1 pre_fn fn  in
               ...
               | (fmod,env2) ->
                                  ...
                                  | (modul,env3) ->
                                      let smt_decls =
                                        let uu____73488 =
                                          ...
                                          Prims.op_Negation uu____73490  in
                                        if uu____73488
                                        then
                                          let smt_decls =
                   ...
                   if uu____73633
                   then
                     let uu____73644 = FStar_Parser_ParseIt.find_file fn  in
                     FStar_SMTEncoding_Solver.with_hints_db uu____73644
                       check_mod
                   else check_mod ()
                in
             let uu____73656 =
               let uu____73658 = FStar_Options.cache_off ()  in
               Prims.op_Negation uu____73658  in
             if uu____73656
             then
               let uu____73671 = load_module_from_cache env fn  in
               match uu____73671 with
               | FStar_Pervasives_Native.None  ->
                   ((let uu____73685 =
                       let uu____73687 =
                         FStar_Parser_Dep.module_name_of_file fn  in
                       FStar_Options.should_be_already_cached uu____73687  in
                     if uu____73685
                     then
                       let uu____73690 =
                         let uu____73696 =
                         ...
                         (FStar_Errors.Error_AlreadyCachedAssertionFailure,
                           uu____73696)
                          in
                       FStar_Errors.raise_err uu____73690
                     else ());
                    (let uu____73703 =
                       (let uu____73707 = FStar_Options.codegen ()  in
                        FStar_Option.isSome uu____73707) &&
                         (FStar_Options.cmi ())
                        in
                     if uu____73703
                     then
                       let uu____73711 =
                         ...
                         (FStar_Errors.Error_AlreadyCachedAssertionFailure,
                           uu____73717)
                          in
                       FStar_Errors.raise_err uu____73711
                     else ());
                    (let uu____73723 = tc_source_file ()  in
                     match uu____73723 with
                     | (tc_result,mllib,env1) ->
                         ((let uu____73750 =
                             (let uu____73754 = FStar_Errors.get_err_count ()
                                 in
                              uu____73754 = (Prims.parse_int "0")) &&
                               ((FStar_Options.lax ()) ||
                                  (FStar_Options.should_verify
               ...
               | FStar_Pervasives_Native.Some tc_result ->
                   ...
                   ((let uu____73776 =
                    ...
                    (let delta_tcenv tcmod1 tcenv =
                       ...
                       | (uu____73820,tcenv1) ->
                           let env1 =
                             FStar_TypeChecker_Tc.load_checked_module tcenv1
                              ...
                              in
                           ((let uu____73824 =
                               let uu____73826 = FStar_Options.lax ()  in
                               Prims.op_Negation uu____73826  in
                             if uu____73824
                             then
                     ...
                     let mllib =
                       let uu____73835 =
                         ((let uu____73839 = FStar_Options.codegen ()  in
                           uu____73839 <> FStar_Pervasives_Native.None) &&
                            (FStar_Options.should_extract
                               (tcmod.FStar_Syntax_Syntax.name).FStar_Ident.str))
                           &&
                           ((Prims.op_Negation
                              ...
                              ||
                              (let uu____73845 = FStar_Options.codegen ()  in
                               uu____73845 =
                                 (FStar_Pervasives_Native.Some
                           ...
                           (fun env1  ->
                              ...
                              let extract_defs tcmod1 env3 =
                                ...
                                | (uu____73893,env4) ->
                                 ...
                                 in
                              let uu____73895 = extract_defs tcmod env2  in
               ...
               (let uu____73958 = tc_source_file ()  in
    ...
    fun pre_fn  ->
      fun fn  ->
        fun parsing_data  ->
          ...
          | (tc_result,uu____74046,env2,delta1) ->
              let uu____74053 =
                let uu____74054 = apply_delta_env env2 delta1  in
                uu____74054.FStar_Extraction_ML_UEnv.env_tcenv  in
              (tc_result, uu____74053)
...
let (needs_interleaving : Prims.string -> Prims.string -> Prims.bool) =
  fun intf  ->
    fun impl  ->
      ...
      ((m1 = m2) &&
         (let uu____74077 = FStar_Util.get_file_extension intf  in
          FStar_List.mem uu____74077 ["fsti"; "fsi"]))
        &&
        (let uu____74086 = FStar_Util.get_file_extension impl  in
         FStar_List.mem uu____74086 ["fst"; "fs"])
            ...
            | intf::impl::remaining1 when needs_interleaving intf impl ->
                let uu____74187 =
                  ...
                  tc_one_file env delta_env
                    (FStar_Pervasives_Native.Some intf) impl uu____74198
                   in
...
let rec (tc_fold_interleave :
  ...
  fun deps  ->
    fun acc  ->
      fun remaining  ->
        let as_list uu___690_74457 =
          match uu___690_74457 with
          | FStar_Pervasives_Native.None  -> []
          | FStar_Pervasives_Native.Some l -> [l]  in
        match remaining with
        | [] -> acc
        | uu____74476 ->
            let uu____74480 = acc  in
...
let (batch_mode_tc :
  ...
  fun filenames  ->
    fun dep_graph1  ->
      (let uu____74601 = FStar_Options.debug_any ()  in
       if uu____74601
       then
          ...
          (let uu____74609 =
             let uu____74611 =
               FStar_All.pipe_right filenames
                ...
                in
             FStar_String.concat " " uu____74611  in
           FStar_Util.print1
             "Here's the list of modules we will verify: %s\n" uu____74609))
       else ());
      (let env =
         let uu____74627 = init_env dep_graph1  in
         FStar_Extraction_ML_UEnv.mkContext uu____74627  in
       let uu____74628 =
                   ...
                   (fun tcenv  ->
                      (let uu____74689 =
                         (FStar_Options.interactive ()) &&
                           (let uu____74692 = FStar_Errors.get_err_count ()
                               in
                            uu____74692 = (Prims.parse_int "0"))
                          in
                       if uu____74689
                       then
                      ...
                      ((), tcenv))
                  in
               FStar_All.pipe_left FStar_Pervasives_Native.snd uu____74680
                in
