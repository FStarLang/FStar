...
let (pop_env : uenv -> uenv) =
  fun env  ->
    let uu___ =
      with_tcenv_of_env env
        (fun tcenv  ->
           let uu___1 = FStar_TypeChecker_Env.pop tcenv "top-level: pop_env"
              in
           ((), uu___1))
       in
    FStar_Pervasives_Native.snd uu___
    ...
    fun pre_fn  ->
      fun fn  ->
        ...
        | (ast,uu___1) ->
                   ...
                   | (pre_ast,uu___4) ->
                       (match (pre_ast, ast) with
                        | (FStar_Parser_AST.Interface
                           (lid1,decls1,uu___5),FStar_Parser_AST.Module
                           (lid2,decls2)) when
            ...
            (match uu___2 with
             | (ast1,env1) ->
                 let uu___3 = FStar_ToSyntax_ToSyntax.ast_modul_to_modul ast1
                    in
      ...
      fun frag  ->
        let fname env1 =
          ...
          then
            ...
            (let uu___2 = FStar_Options.file_list ()  in FStar_List.hd uu___2)
           in
        ...
        let range_of_first_mod_decl modul =
          ...
          | FStar_Parser_AST.Module
              (uu___,{ FStar_Parser_AST.d = uu___1;
          ...
          | FStar_Parser_AST.Interface
              (uu___,{ FStar_Parser_AST.d = uu___1;
                       FStar_Parser_AST.drange = d;
                       FStar_Parser_AST.quals = uu___2;
                       FStar_Parser_AST.attrs = uu___3;_}::uu___4,uu___5)
              -> d
                      ...
                      let uu___2 =
                        let uu___3 =
                          FStar_ToSyntax_ToSyntax.decls_to_sigelts
                           ...
                           in
                        FStar_All.pipe_left (with_dsenv_of_tcenv env1) uu___3
                         in
                      (match uu___2 with
                       | (sigelts,env2) ->
                           let uu___3 =
          ...
          (let maybe_restore_opts uu___1 =
                 ...
                 (fun uu___3  ->
                    with_env env1
                      (fun env2  ->
                         ...
                         match uu___4 with | (uu___5,defs) -> defs))
              in
                 ...
                 (fun uu___3  ->
                    let uu___4 =
                      with_env env1
                       ...
                       in
                    match uu___4 with | (env2,uu___5) -> env2)
              in
           let tc_source_file uu___1 =
             ...
             | (fmod,env1) ->
                 let mii =
                   let uu___3 =
                     let uu___4 = FStar_Extraction_ML_UEnv.tcenv_of_uenv env1
                        in
                 ...
                 let check_mod uu___3 =
                   ...
                   let uu___4 =
                     ...
                     FStar_Profiling.profile (fun uu___6  -> check env1)
                       uu___5 "FStar.Universal.tc_source_file"
                      in
                   match uu___4 with
                   | ((tcmod,smt_decls),env2) ->
                       ...
                       (match uu___5 with
                        | (extracted_defs,extract_time) ->
                            let uu___6 = maybe_extract_ml_iface tcmod env2
                               in
                            (match uu___6 with
           ...
           then
                 ...
                 ((let uu___3 =
                  ...
                  (let uu___4 =
                     (let uu___5 = FStar_Options.codegen ()  in
                      FStar_Option.isSome uu___5) && (FStar_Options.cmi ())
                      in
                   if uu___4
                   then
                     let uu___5 =
                             ...
                             ((FStar_Options.lax ()) ||
                                (let uu___7 =
                                   FStar_Ident.string_of_lid
                                    ...
                                    in
                                 FStar_Options.should_verify uu___7))
                            in
                         if uu___6
                         then
             ...
             | FStar_Pervasives_Native.Some tc_result ->
                 ...
                 ((let uu___3 =
                   ...
                   if uu___3
                   then
                     let uu___4 = FStar_Syntax_Print.modul_to_string tcmod
                        in
    ...
    fun acc  ->
      fun remaining  ->
        ...
        | uu___ ->
            ...
            (match uu___1 with
             | (mods,mllibs,env) ->
                 let uu___2 = tc_one_file_from_remaining remaining env deps
                    in
                 (match uu___2 with
