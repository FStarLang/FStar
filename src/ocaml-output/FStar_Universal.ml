open Prims
let cache_version_number : Prims.int = (Prims.lift_native_int (1)) 
  ...
  fun env  ->
    fun fn  ->
      ...
      let fail1 tag =
        ...
        (let uu____1146 =
           let uu____1147 =
             FStar_Range.mk_pos (Prims.lift_native_int (0))
                  ...
                  | (tcmod,tcmod_iface_opt,mii,env1) ->
                      ((let uu____1877 =
                          (let uu____1880 = FStar_Errors.get_err_count ()  in
                           uu____1880 = (Prims.lift_native_int (0))) &&
                            ((FStar_Options.lax ()) ||
                               (FStar_Options.should_verify
             ...
             | FStar_Pervasives_Native.Some (tcmod,tcmod_iface_opt,mii) ->
                 ...
                 let delta_env env1 =
                   ...
                   | (uu____1947,env2) ->
                    ...
                    in
                 ((tcmod1, (Prims.lift_native_int (0))), env,
             ...
             (let uu____2662 =
                (FStar_Options.interactive ()) &&
                  (let uu____2664 = FStar_Errors.get_err_count ()  in
                   uu____2664 = (Prims.lift_native_int (0)))
                 in
              if uu____2662
              then
