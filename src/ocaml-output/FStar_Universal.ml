        ...
        fun tc_result  ->
          ...
          then
            ...
            | FStar_Pervasives_Native.Some hashes ->
                let tc_result1 =
                  let uu___22_2021 = tc_result  in
                  {
                    checked_module = (uu___22_2021.checked_module);
                    mii = (uu___22_2021.mii);
                    smt_decls = (uu___22_2021.smt_decls);
                    tc_time = (Prims.parse_int "0");
                    extraction_time = (uu___22_2021.extraction_time)
                  }  in
                let uu____2023 =
...
let rec (tc_fold_interleave :
  ...
  fun deps  ->
    fun acc  ->
      fun remaining  ->
        let as_list uu___11_3541 =
          match uu___11_3541 with
          | FStar_Pervasives_Native.None  -> []
