      ...
      fun tc_result  ->
        ...
        then
          ...
          | FStar_Pervasives_Native.Some hashes ->
              let tc_result1 =
                let uu___466_1706 = tc_result  in
                {
                  checked_module = (uu___466_1706.checked_module);
                  extracted_iface = (uu___466_1706.extracted_iface);
                  mii = (uu___466_1706.mii);
    ...
    then
      ...
      | FStar_Pervasives_Native.Some (FStar_Options.Kremlin ) ->
          let programs =
            ...
            FStar_List.flatten uu____1890  in
          let bin = (FStar_Extraction_Kremlin.current_version, programs)  in
          (match programs with
           | (name,uu____1917)::[] ->
               let uu____1930 =
                 FStar_Options.prepend_output_dir (Prims.strcat name ext)  in
               FStar_Util.save_value_to_file uu____1930 bin
           | uu____1932 ->
               let uu____1940 = FStar_Options.prepend_output_dir "out.krml"
                  in
               FStar_Util.save_value_to_file uu____1940 bin)
      | uu____1943 -> failwith "Unrecognized option"
    else ()
        ...
        fun fn  ->
          ...
          (let maybe_extract_mldefs tcmod env1 =
             ...
             then (FStar_Pervasives_Native.None, (Prims.parse_int "0"))
              ...
              in
           let tc_source_file uu____2084 =
             let env1 = apply_delta_env env delta1  in
             let uu____2088 = parse env1 pre_fn fn  in
             ...
             | (fmod,env2) ->
                 ...
                 if uu____2206
                 then
                   let uu____2213 = FStar_Parser_ParseIt.find_file fn  in
                   FStar_SMTEncoding_Solver.with_hints_db uu____2213
                     check_mod
                 else check_mod ()
              in
           let uu____2221 =
           ...
           if uu____2221
           then
             let uu____2232 = load_module_from_cache env fn  in
             match uu____2232 with
             | FStar_Pervasives_Native.None  ->
                 ((let uu____2242 =
                     (let uu____2246 = FStar_Options.codegen ()  in
                      FStar_Option.isSome uu____2246) &&
                       (FStar_Options.cmi ())
                      in
                   if uu____2242
                   then
                     let uu____2250 =
                       let uu____2256 =
                         FStar_Util.format1
                           ...
                           fn
                          in
                       (FStar_Errors.Error_UncheckedFile, uu____2256)  in
                     FStar_Errors.raise_err uu____2250
                   else ());
                  (let uu____2262 = tc_source_file ()  in
                   match uu____2262 with
                   | (tc_result,env1) ->
                       ((let uu____2276 =
                           (let uu____2280 = FStar_Errors.get_err_count ()
                               in
                            uu____2280 = (Prims.parse_int "0")) &&
                             ((FStar_Options.lax ()) ||
                                (FStar_Options.should_verify
                 ...
                 ((let uu____2293 =
                  ...
                  (let delta_tcenv tcmod1 tcenv =
                     ...
                     | (uu____2341,tcenv1) ->
                      ...
                      in
                   (let uu____2345 =
                      ((let uu____2349 = FStar_Options.codegen ()  in
                        uu____2349 <> FStar_Pervasives_Native.None) &&
                         (FStar_Options.should_extract
                            (tcmod.FStar_Syntax_Syntax.name).FStar_Ident.str))
                        &&
                        (Prims.op_Negation
                        ...
                        (fun env1  ->
                           ...
                           let extract_defs tcmod1 env3 =
                             ...
                             | (uu____2399,env4) ->
                              ...
                              in
                           let uu____2401 = extract_defs tcmod env2  in ())
                    else ());
                   (let delta_env env1 =
                      let uu____2419 =
             ...
             (let uu____2431 = tc_source_file ()  in
    ...
    fun pre_fn  ->
      fun fn  ->
        ...
        | (tc_result,env2,delta1) ->
            let uu____2497 =
              let uu____2498 = apply_delta_env env2 delta1  in
              uu____2498.FStar_Extraction_ML_UEnv.env_tcenv  in
            (tc_result, uu____2497)
...
let (needs_interleaving : Prims.string -> Prims.string -> Prims.bool) =
  fun intf  ->
    fun impl  ->
      ...
      ((m1 = m2) &&
         (let uu____2523 = FStar_Util.get_file_extension intf  in
          FStar_List.mem uu____2523 ["fsti"; "fsi"]))
        &&
        (let uu____2532 = FStar_Util.get_file_extension impl  in
         FStar_List.mem uu____2532 ["fst"; "fs"])
...
let (batch_mode_tc :
  ...
  fun filenames  ->
    fun dep_graph1  ->
      (let uu____2921 = FStar_Options.debug_any ()  in
       if uu____2921
       then
          ...
          (let uu____2929 =
             let uu____2931 =
               FStar_All.pipe_right filenames
                ...
                in
             FStar_String.concat " " uu____2931  in
           FStar_Util.print1
             "Here's the list of modules we will verify: %s\n" uu____2929))
       else ());
      (let env =
         let uu____2947 = init_env dep_graph1  in
         FStar_Extraction_ML_UEnv.mkContext uu____2947  in
       let uu____2948 =
                 ...
                 (fun tcenv  ->
                    (let uu____2997 =
                       (FStar_Options.interactive ()) &&
                         (let uu____3000 = FStar_Errors.get_err_count ()  in
                          uu____3000 = (Prims.parse_int "0"))
                        in
                     if uu____2997
                     then
                    ...
                    ((), tcenv))
                in
             FStar_All.pipe_left FStar_Pervasives_Native.snd uu____2988  in
