          ...
          (let maybe_extract_mldefs tcmod env1 =
           ...
           let tc_source_file uu____2084 =
             ...
             | (fmod,env2) ->
                 ...
                 if uu____2212
                 then
                   let uu____2219 = FStar_Parser_ParseIt.find_file fn  in
                   FStar_SMTEncoding_Solver.with_hints_db uu____2219
                     check_mod
                 else check_mod ()
              in
           let uu____2227 =
             let uu____2229 = FStar_Options.cache_off ()  in
           ...
           then
             ...
             | FStar_Pervasives_Native.None  ->
                 ((let uu____2248 =
                     (let uu____2252 = FStar_Options.codegen ()  in
                      FStar_Option.isSome uu____2252) &&
                       (FStar_Options.cmi ())
                      in
                   if uu____2248
                   then
                  ...
                  (let uu____2268 = tc_source_file ()  in
                   match uu____2268 with
                   | (tc_result,env1) ->
                       ((let uu____2282 =
                           (let uu____2286 = FStar_Errors.get_err_count ()
                               in
                 ...
                 ((let uu____2299 =
                  ...
                  (let delta_tcenv tcmod1 tcenv =
                     ...
                     | (uu____2347,tcenv1) ->
                      ...
                      in
                   (let uu____2351 =
                      ((let uu____2355 = FStar_Options.codegen ()  in
                        ...
                        ((Prims.op_Negation
                           ...
                           ||
                           (let uu____2361 = FStar_Options.codegen ()  in
                            uu____2361 =
                              (FStar_Pervasives_Native.Some
                        ...
                        (fun env1  ->
                           ...
                           let extract_defs tcmod1 env3 =
                             ...
                             | (uu____2411,env4) ->
                              ...
                              in
                           let uu____2413 = extract_defs tcmod env2  in ())
                    else ());
                   (let delta_env env1 =
                      let uu____2431 =
             ...
             (let uu____2443 = tc_source_file ()  in
    ...
    fun pre_fn  ->
      fun fn  ->
        ...
        | (tc_result,env2,delta1) ->
            let uu____2509 =
              let uu____2510 = apply_delta_env env2 delta1  in
              uu____2510.FStar_Extraction_ML_UEnv.env_tcenv  in
            (tc_result, uu____2509)
...
let (needs_interleaving : Prims.string -> Prims.string -> Prims.bool) =
  fun intf  ->
    fun impl  ->
      ...
      ((m1 = m2) &&
         (let uu____2535 = FStar_Util.get_file_extension intf  in
          FStar_List.mem uu____2535 ["fsti"; "fsi"]))
        &&
        (let uu____2544 = FStar_Util.get_file_extension impl  in
         FStar_List.mem uu____2544 ["fst"; "fs"])
...
let (batch_mode_tc :
  ...
  fun filenames  ->
    fun dep_graph1  ->
      (let uu____2933 = FStar_Options.debug_any ()  in
       if uu____2933
       then
          ...
          (let uu____2941 =
             let uu____2943 =
               FStar_All.pipe_right filenames
                ...
                in
             FStar_String.concat " " uu____2943  in
           FStar_Util.print1
             "Here's the list of modules we will verify: %s\n" uu____2941))
       else ());
      (let env =
         let uu____2959 = init_env dep_graph1  in
         FStar_Extraction_ML_UEnv.mkContext uu____2959  in
       let uu____2960 =
                 ...
                 (fun tcenv  ->
                    (let uu____3009 =
                       (FStar_Options.interactive ()) &&
                         (let uu____3012 = FStar_Errors.get_err_count ()  in
                          uu____3012 = (Prims.parse_int "0"))
                        in
                     if uu____3009
                     then
                    ...
                    ((), tcenv))
                in
             FStar_All.pipe_left FStar_Pervasives_Native.snd uu____3000  in
