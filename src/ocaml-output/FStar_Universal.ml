    ...
    fun env ->
      fun frag ->
        ...
        let range_of_first_mod_decl modul =
          ...
          | FStar_Parser_AST.Interface
              (uu____500,
               { FStar_Parser_AST.d = uu____501; FStar_Parser_AST.drange = d;
                 FStar_Parser_AST.doc = uu____503;
                 FStar_Parser_AST.quals = uu____504;
                 FStar_Parser_AST.attrs = uu____505;_}::uu____506,
               uu____507)
              -> d
            ...
            (match uu____529 with
             | (ast_modul1, env1) ->
                 let uu____555 =
                   ...
                   FStar_All.pipe_left (with_dsenv_of_tcenv env1) uu____560 in
                        ...
                        then
                          let msg =
                            let uu____588 =
                              ...
                              FStar_Parser_Dep.module_name_of_file uu____590 in
                            FStar_Util.format1
                          ...
                          then ((modul, []), env2)
                            ...
                            (let uu____630 =
                               FStar_TypeChecker_Tc.tc_partial_modul env2
                                 modul in
                             match uu____630 with | (m, i, e) -> ((m, i), e)) in
  ...
  fun env ->
    fun interface_file_name ->
      ...
      | FStar_Parser_ParseIt.ASTFragment
          (FStar_Util.Inl (FStar_Parser_AST.Interface (l, decls, uu____872)),
           uu____873)
          ->
          let uu____896 =
            let uu____901 =
    ...
    then
      ...
      | FStar_Pervasives_Native.Some (FStar_Options.Kremlin) ->
          ...
          (match programs with
           ...
           | uu____996 ->
               let uu____999 = FStar_Options.prepend_output_dir "out.krml" in
      ...
      fun fn ->
        fun parsing_data ->
          ...
          (let maybe_restore_opts uu____1059 =
             ...
             if uu____1060
             then
               let uu____1065 = FStar_Options.restore_cmd_line_options true in
               FStar_All.pipe_right uu____1065 (fun a1 -> ())
             else () in
           let post_smt_encoding uu____1074 = FStar_SMTEncoding_Z3.refresh () in
                 ...
                 (fun uu____1122 ->
                    with_env env1
                      (fun env2 ->
                         ...
                         match uu____1130 with | (uu____1139, defs) -> defs)) in
             ...
             then (env1, Prims.int_zero)
               ...
               FStar_Util.record_time
                 (fun uu____1182 ->
                    ...
                    match uu____1183 with | (env2, uu____1195) -> env2) in
                 ...
                 let check_mod uu____1239 =
                          ...
                          (let uu____1283 =
                           ...
                           | (modul, env3) ->
                               (maybe_restore_opts ();
                                (let smt_decls =
                                   let uu____1313 =
                                     let uu____1315 = FStar_Options.lax () in
                   ...
                   let uu____1352 =
                     FStar_Profiling.profile (fun uu____1382 -> check1 env1)
                       ...
                       "FStar.Universal.tc_source_file" in
  ...
  fun filenames ->
    fun dep_graph1 ->
      ...
      (let env =
       ...
       let uu____2313 = tc_fold_interleave dep_graph1 ([], [], env) filenames in
                   ...
                   (fun tcenv ->
                      (let uu____2366 =
                         (FStar_Options.interactive ()) &&
                           (let uu____2369 = FStar_Errors.get_err_count () in
                            uu____2369 = Prims.int_zero) in
                       if uu____2366
                       then
