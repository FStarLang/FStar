...
(let _0_1009 = FStar_Parser_AST.Module ((let _0_1008 = (FStar_Parser_Interleave.interleave decls1 decls2)
in ((lid1), (_0_1008))))
in (_0_1009)::[])
end
| uu____68 -> begin
...
let uu____90 = (let _0_1010 = (FStar_ToSyntax_Env.empty_env ())
in (parse _0_1010 None prims_filename))
in (match (uu____90) with
| (dsenv, prims_mod) -> begin
(

let uu____103 = (FStar_Util.record_time (fun uu____110 -> (let _0_1011 = (FStar_List.hd prims_mod)
in (FStar_TypeChecker_Tc.check_module env _0_1011))))
...
in (((m1 = m2) && (let _0_1012 = (FStar_Util.get_file_extension intf)
in (_0_1012 = "fsti"))) && (let _0_1013 = (FStar_Util.get_file_extension impl)
in (_0_1013 = "fst"))))))
...
| (dsenv, env) -> begin
((let _0_1014 = (FStar_ToSyntax_Env.pop dsenv)
in (FStar_All.pipe_right _0_1014 Prims.ignore));
(let _0_1015 = (FStar_TypeChecker_Env.pop env msg)
in (FStar_All.pipe_right _0_1015 Prims.ignore));
...
| Some (uu____490) when (let _0_1016 = (FStar_Options.codegen ())
in (_0_1016 <> None)) -> begin
((
...
(let _0_1017 = (tc_one_file_and_intf (Some (intf)) impl dsenv env)
in ((remaining), (_0_1017)))
end
| (intf_or_impl)::remaining -> begin
(let _0_1018 = (tc_one_file_and_intf None intf_or_impl dsenv env)
in ((remaining), (_0_1018)))
end
| [] -> begin
(([]), ((([]), (dsenv), (env))))
end)
...
let uu____783 = ((FStar_Options.interactive ()) && (let _0_1019 = (FStar_Errors.get_err_count ())
in (_0_1019 = (Prims.parse_int "0"))))
...
(let _0_1021 = (let _0_1020 = (FStar_Options.verify_module ())
in (FStar_String.concat " " _0_1020))
...
| true -> begin
(let _0_1022 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _0_1022 Prims.ignore))
end
| uu____1079 -> begin
()
end);
...
Some ((let _0_1023 = (FStar_Errors.get_err_count ())
in ((m), (((dsenv), (env))), (_0_1023))))
end
| uu____1218 -> begin
None
end))
...
| FStar_Errors.Err (msg) when (not ((FStar_Options.trace_error ()))) -> begin
((let _0_1026 = (let _0_1025 = (let _0_1024 = (FStar_TypeChecker_Env.get_range env)
in ((msg), (_0_1024)))
in (_0_1025)::[])
in (FStar_TypeChecker_Err.add_errors env _0_1026));
None;
)
end
end))
...
let report_fail = (fun uu____1266 -> ((let _0_1027 = (FStar_Errors.report_all ())
in (FStar_All.pipe_right _0_1027 Prims.ignore));
