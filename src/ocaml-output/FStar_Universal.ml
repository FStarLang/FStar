        ...
        fun parsing_data ->
          ...
          (let post_smt_encoding uu____1048 =
             ...
             (let uu____1050 =
              ...
              if uu____1050
              then
                let uu____1055 = FStar_Options.restore_cmd_line_options true in
             ...
             then (FStar_Pervasives_Native.None, (Prims.parse_int "0"))
               ...
               FStar_Util.record_time
                 (fun uu____1109 ->
                    ...
                    match uu____1110 with | (uu____1119, defs) -> defs) in
                            ...
                            (fun tcenv ->
                               ...
                               (let uu____1291 =
                                ...
                                | (modul, env2) ->
                                    let smt_decls =
                                      let uu____1320 =
                                        let uu____1322 = FStar_Options.lax () in
           ...
           then
             ...
             | FStar_Pervasives_Native.None ->
                 ((let uu____1513 =
                     let uu____1515 = FStar_Parser_Dep.module_name_of_file fn in
                  ...
                  (let uu____1551 = tc_source_file () in
                   ...
                   | (tc_result, mllib, env1) ->
                       ((let uu____1576 =
                           (let uu____1580 = FStar_Errors.get_err_count () in
                  ...
                  (let extend_tcenv tcmod1 tcenv =
                   ...
                   let mllib =
                     ...
                     then
                       with_env env1
                         (fun env2 ->
                            let uu____1699 = maybe_extract_mldefs tcmod env2 in
  ...
  fun filenames ->
    fun dep_graph1 ->
      ...
      (let env =
       ...
       let uu____2351 = tc_fold_interleave dep_graph1 ([], [], env) filenames in
                   ...
                   (fun tcenv ->
                      (let uu____2404 =
                         (FStar_Options.interactive ()) &&
                           (let uu____2407 = FStar_Errors.get_err_count () in
                            uu____2407 = (Prims.parse_int "0")) in
                       if uu____2404
                       then
