         ...
         let uu____111 =
           FStar_Util.record_time
             (fun uu____118  ->
                ...
                FStar_TypeChecker_Tc.check_module env uu____119)
            in
    ...
    | (prims_mod,dsenv,env) ->
        ((let uu____856 =
            (let uu____857 = FStar_Options.explicit_deps ()  in
             Prims.op_Negation uu____857) && (FStar_Options.debug_any ())
             in
          if uu____856
          then
