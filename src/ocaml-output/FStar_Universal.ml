      ...
      fun frag  ->
        ...
        let range_of_first_mod_decl modul =
          ...
          | FStar_Parser_AST.Module
              (uu____474,{ FStar_Parser_AST.d = uu____475;
          ...
          | FStar_Parser_AST.Interface
              (uu____487,{ FStar_Parser_AST.d = uu____488;
                           ...
                           FStar_Parser_AST.attrs = uu____492;_}::uu____493,uu____494)
              -> d
                 ...
                 let uu____542 =
                   let uu____547 =
                     FStar_ToSyntax_ToSyntax.partial_ast_modul_to_modul
                       curmod ast_modul1
                      in
                   FStar_All.pipe_left (with_dsenv_of_tcenv env1) uu____547
                    in
                        ...
                        then
                          let msg =
                            let uu____575 =
                              ...
                              FStar_Parser_Dep.module_name_of_file uu____577
                               in
                            FStar_Util.format1
                          ...
                          then ((modul, []), env2)
                            ...
                            (let uu____617 =
                               FStar_TypeChecker_Tc.tc_partial_modul env2
                                 modul
                                in
                             match uu____617 with | (m,i,e) -> ((m, i), e))
                           in
    ...
    then
      ...
      | FStar_Pervasives_Native.Some (FStar_Options.Kremlin ) ->
          ...
          (match programs with
           ...
           | uu____983 ->
               let uu____986 = FStar_Options.prepend_output_dir "out.krml"
                  in
      ...
      fun fn  ->
        fun parsing_data  ->
          ...
          (let maybe_restore_opts uu____1046 =
             ...
             if uu____1047
             then
               let uu____1052 = FStar_Options.restore_cmd_line_options true
                  in
               FStar_All.pipe_right uu____1052 (fun a1  -> ())
             else ()  in
           let post_smt_encoding uu____1061 = FStar_SMTEncoding_Z3.refresh ()
              in
             ...
             then (FStar_Pervasives_Native.None, (Prims.parse_int "0"))
               ...
               FStar_Util.record_time
                 (fun uu____1112  ->
                    ...
                    match uu____1113 with | (uu____1122,defs) -> defs)
              in
           ...
           then
             ...
             | FStar_Pervasives_Native.None  ->
                 ((let uu____1518 =
                     let uu____1520 = FStar_Parser_Dep.module_name_of_file fn
                        in
                  ...
                  (let uu____1556 = tc_source_file ()  in
                   ...
                   | (tc_result,mllib,env1) ->
                       ((let uu____1581 =
                           (let uu____1585 = FStar_Errors.get_err_count ()
                               in
                  ...
                  (let extend_tcenv tcmod1 tcenv =
                   ...
                   let mllib =
                     ...
                     then
                       with_env env1
                         (fun env2  ->
                            let uu____1705 = maybe_extract_mldefs tcmod env2
                               in
