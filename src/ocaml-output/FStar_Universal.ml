...
(let _0_686 = FStar_Parser_AST.Module ((let _0_685 = (FStar_Parser_Interleave.interleave decls1 decls2)
in ((lid1), (_0_685))))
in (_0_686)::[])
end
| uu____68 -> begin
...
let uu____90 = (let _0_687 = (FStar_ToSyntax_Env.empty_env ())
in (parse _0_687 None prims_filename))
in (match (uu____90) with
| (dsenv, prims_mod) -> begin
(

let uu____103 = (FStar_Util.record_time (fun uu____110 -> (let _0_688 = (FStar_List.hd prims_mod)
in (FStar_TypeChecker_Tc.check_module env _0_688))))
...
in (((m1 = m2) && (let _0_689 = (FStar_Util.get_file_extension intf)
in (_0_689 = "fsti"))) && (let _0_690 = (FStar_Util.get_file_extension impl)
in (_0_690 = "fst"))))))
...
| (dsenv, env) -> begin
((let _0_691 = (FStar_ToSyntax_Env.pop dsenv)
in (FStar_All.pipe_right _0_691 Prims.ignore));
(let _0_692 = (FStar_TypeChecker_Env.pop env msg)
...
| Some (uu____490) when (let _0_693 = (FStar_Options.codegen ())
in (_0_693 <> None)) -> begin
((
...
(let _0_694 = (tc_one_file_and_intf (Some (intf)) impl dsenv env)
in ((remaining), (_0_694)))
end
| (intf_or_impl)::remaining -> begin
(let _0_695 = (tc_one_file_and_intf None intf_or_impl dsenv env)
in ((remaining), (_0_695)))
end
| [] -> begin
(([]), ((([]), (dsenv), (env))))
...
let uu____783 = ((FStar_Options.interactive ()) && (let _0_696 = (FStar_Errors.get_err_count ())
in (_0_696 = (Prims.parse_int "0"))))
...
(let _0_698 = (let _0_697 = (FStar_Options.verify_module ())
in (FStar_String.concat " " _0_697))
...
| true -> begin
(let _0_699 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _0_699 Prims.ignore))
end
| uu____1079 -> begin
()
end);
...
Some ((let _0_700 = (FStar_Errors.get_err_count ())
in ((m), (((dsenv), (env))), (_0_700))))
end
| uu____1218 -> begin
None
end))
...
| FStar_Errors.Err (msg) when (not ((FStar_Options.trace_error ()))) -> begin
((let _0_703 = (let _0_702 = (let _0_701 = (FStar_TypeChecker_Env.get_range env)
in ((msg), (_0_701)))
in (_0_702)::[])
in (FStar_TypeChecker_Err.add_errors env _0_703));
None;
)
end
end))
...
let report_fail = (fun uu____1266 -> ((let _0_704 = (FStar_Errors.report_all ())
in (FStar_All.pipe_right _0_704 Prims.ignore));
