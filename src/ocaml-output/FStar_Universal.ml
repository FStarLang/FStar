...
let tc_prims : Prims.unit  ->  (FStar_Syntax_Syntax.modul * FStar_Parser_Env.env * FStar_TypeChecker_Env.env) = (fun _82_5 -> (match (()) with
| () -> begin
(
...
let _82_8 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.init env)
in (
# 59 "FStar.Universal.fst"
let p = (FStar_Options.prims ())
in (
# 60 "FStar.Universal.fst"
let _82_13 = (let _166_9 = (FStar_Parser_Env.empty_env ())
in (parse _166_9 p))
in (match (_82_13) with
| (dsenv, prims_mod) -> begin
(
# 61 "FStar.Universal.fst"
let _82_16 = (let _166_10 = (FStar_List.hd prims_mod)
in (FStar_TypeChecker_Tc.check_module env _166_10))
...
let _82_29 = (FStar_TypeChecker_Tc.check_module env m)
...
let _82_41 = (FStar_Syntax_Syntax.reset_gensym ())
in (
...
let _82_51 = if ((FStar_ST.read FStar_Options.interactive) && ((FStar_TypeChecker_Errors.get_err_count ()) = 0)) then begin
...
let tc_one_fragment : FStar_Syntax_Syntax.modul Prims.option  ->  FStar_Parser_Env.env  ->  FStar_TypeChecker_Env.env  ->  Prims.string  ->  (FStar_Syntax_Syntax.modul Prims.option * FStar_Parser_Env.env * FStar_TypeChecker_Env.env) Prims.option = (fun curmod dsenv env frag -> (FStar_All.try_with (fun _82_70 -> (match (()) with
| () -> begin
...
let _82_90 = (FStar_Parser_ToSyntax.desugar_partial_modul curmod dsenv ast_modul)
...
let _82_100 = (FStar_TypeChecker_Tc.tc_partial_modul env modul)
in (match (_82_100) with
| (modul, _82_98, env) -> begin
...
let _82_105 = (FStar_Parser_ToSyntax.desugar_decls dsenv ast_decls)
...
let _82_107 = (FStar_Util.print_error "fragment without an enclosing module")
in (FStar_All.exit 1))
end
| Some (modul) -> begin
(
# 120 "FStar.Universal.fst"
let _82_115 = (FStar_TypeChecker_Tc.tc_more_partial_modul env modul decls)
in (match (_82_115) with
| (modul, _82_113, env) -> begin
Some ((Some (modul), dsenv, env))
end))
end)
end))
...
let _82_76 = (FStar_TypeChecker_Errors.add_errors env (((msg, r))::[]))
in None)
end
| FStar_Syntax_Syntax.Err (msg) -> begin
(
# 128 "FStar.Universal.fst"
let _82_80 = (FStar_TypeChecker_Errors.add_errors env (((msg, FStar_Range.dummyRange))::[]))
in None)
end
| e -> begin
(Prims.raise e)
...
let pop = (fun _82_119 msg -> (match (_82_119) with
| (dsenv, env) -> begin
(
# 137 "FStar.Universal.fst"
let _82_121 = (let _166_43 = (FStar_Parser_Env.pop dsenv)
in (FStar_All.pipe_right _166_43 Prims.ignore))
in (
# 138 "FStar.Universal.fst"
let _82_123 = (let _166_44 = (FStar_TypeChecker_Env.pop env msg)
in (FStar_All.pipe_right _166_44 Prims.ignore))
in (
# 139 "FStar.Universal.fst"
let _82_125 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (let _166_45 = (FStar_Options.reset_options ())
in (FStar_All.pipe_right _166_45 Prims.ignore)))))
end))
in (
# 142 "FStar.Universal.fst"
let push = (fun _82_130 msg -> (match (_82_130) with
| (dsenv, env) -> begin
(
...
let mark = (fun _82_137 -> (match (_82_137) with
| (dsenv, env) -> begin
(
...
let reset_mark = (fun _82_143 -> (match (_82_143) with
| (dsenv, env) -> begin
(
...
let commit_mark = (fun _82_149 -> (match (_82_149) with
| (dsenv, env) -> begin
(
...
let check_frag = (fun _82_155 curmod text -> (match (_82_155) with
| (dsenv, env) -> begin
(match ((tc_one_fragment curmod dsenv env text)) with
| Some (m, dsenv, env) -> begin
(let _166_63 = (let _166_62 = (FStar_TypeChecker_Errors.get_err_count ())
in (m, (dsenv, env), _166_62))
in Some (_166_63))
end
| _82_164 -> begin
None
...
let report_fail = (fun _82_166 -> (match (()) with
| () -> begin
(
# 169 "FStar.Universal.fst"
let _82_167 = (let _166_66 = (FStar_TypeChecker_Errors.report_all ())
in (FStar_All.pipe_right _166_66 Prims.ignore))
