  ...
  fun uu____85  ->
    let solver1 =
      ...
      then FStar_SMTEncoding_Solver.dummy
        ...
        (let uu___218_94 = FStar_SMTEncoding_Solver.solver  in
         {
           FStar_TypeChecker_Env.init =
             (uu___218_94.FStar_TypeChecker_Env.init);
           FStar_TypeChecker_Env.push =
             (uu___218_94.FStar_TypeChecker_Env.push);
           FStar_TypeChecker_Env.pop =
             (uu___218_94.FStar_TypeChecker_Env.pop);
           FStar_TypeChecker_Env.mark =
             (uu___218_94.FStar_TypeChecker_Env.mark);
           FStar_TypeChecker_Env.reset_mark =
             (uu___218_94.FStar_TypeChecker_Env.reset_mark);
           FStar_TypeChecker_Env.commit_mark =
             (uu___218_94.FStar_TypeChecker_Env.commit_mark);
           FStar_TypeChecker_Env.encode_modul =
             (uu___218_94.FStar_TypeChecker_Env.encode_modul);
           FStar_TypeChecker_Env.encode_sig =
             (uu___218_94.FStar_TypeChecker_Env.encode_sig);
           FStar_TypeChecker_Env.preprocess =
             FStar_Tactics_Interpreter.preprocess;
           FStar_TypeChecker_Env.solve =
             (uu___218_94.FStar_TypeChecker_Env.solve);
           FStar_TypeChecker_Env.is_trivial =
             (uu___218_94.FStar_TypeChecker_Env.is_trivial);
           FStar_TypeChecker_Env.finish =
             (uu___218_94.FStar_TypeChecker_Env.finish);
           FStar_TypeChecker_Env.refresh =
             (uu___218_94.FStar_TypeChecker_Env.refresh)
         })
       in
    let env =
         ...
         let uu____112 =
           FStar_Util.record_time
             (fun uu____119  ->
                ...
                FStar_TypeChecker_Tc.check_module env uu____120)
            in
    ...
    | (prims_mod,dsenv,env) ->
        ((let uu____857 =
            (let uu____858 = FStar_Options.explicit_deps ()  in
             Prims.op_Negation uu____858) && (FStar_Options.debug_any ())
             in
          if uu____857
          then
