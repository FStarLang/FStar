    ...
    fun interface_file_name  ->
      ...
      | FStar_Parser_ParseIt.ASTFragment
          (FStar_Util.Inl (FStar_Parser_AST.Interface
           (l,decls,uu____587)),uu____588)
          ->
          let uu____613 =
            let uu____618 =
              FStar_ToSyntax_Interleave.initialize_interface l decls in
            FStar_All.pipe_left (with_tcenv env) uu____618 in
          FStar_Pervasives_Native.snd uu____613
      | FStar_Parser_ParseIt.ASTFragment uu____631 ->
          let uu____642 =
            let uu____643 =
              FStar_Util.format1
                "Unexpected result from parsing %s; expected a single interface"
                interface_file_name in
            FStar_Errors.Err uu____643 in
          FStar_Exn.raise uu____642
      | FStar_Parser_ParseIt.ParseError (err1,rng) ->
          FStar_Exn.raise (FStar_Errors.Error (err1, rng))
      | FStar_Parser_ParseIt.Term uu____646 -> failwith "Impossible"
    ...
    fun fn  ->
      ...
      let fail4 tag =
        (let uu____677 =
           ...
           let uu____679 =
             FStar_Range.mk_pos (Prims.parse_int "0") (Prims.parse_int "0") in
           FStar_Range.mk_range fn uu____678 uu____679 in
         let uu____680 =
           FStar_Util.format3 "%s cache file %s; will recheck %s" tag
             cache_file fn in
         FStar_Errors.warn uu____677 uu____680);
        FStar_Pervasives_Native.None in
      if FStar_Util.file_exists cache_file
      then
        let uu____691 = FStar_Util.load_value_from_file cache_file in
          ...
          | uu____804 ->
              let uu____809 =
                ...
                let uu____811 =
                  FStar_Range.mk_pos (Prims.parse_int "0")
                    (Prims.parse_int "0") in
                FStar_Range.mk_range fn uu____810 uu____811 in
              let uu____812 =
                FStar_Util.format1
                  "%s was not written, since some of its dependences were not also checked"
                  cache_file in
              FStar_Errors.warn uu____809 uu____812
let tc_one_file:
  FStar_TypeChecker_Env.env ->
    Prims.string FStar_Pervasives_Native.option ->
      Prims.string ->
  ...
  fun env  ->
    fun pre_fn  ->
      fun fn  ->
        ...
        (let tc_source_file uu____856 =
           let uu____857 = parse env pre_fn fn in
           match uu____857 with
           | (fmod,env1) ->
               let check_mod uu____885 =
                 let uu____886 =
               ...
               let uu____920 =
                 ...
                 if uu____929
                 then
                   let uu____938 = FStar_Parser_ParseIt.find_file fn in
                   FStar_SMTEncoding_Solver.with_hints_db uu____938 check_mod
                 else check_mod () in
               (match uu____920 with
                | (tcmod,env2) ->
                    ...
                    (tcmod, mii, env2)) in
         let uu____973 = FStar_Options.cache_checked_modules () in
         if uu____973
         then
           let uu____982 = load_module_from_cache env fn in
           match uu____982 with
           | FStar_Pervasives_Native.None  ->
               let uu____1001 = tc_source_file () in
               (match uu____1001 with
                | (tcmod,mii,env1) ->
                    ((let uu____1032 =
                        let uu____1033 = FStar_Errors.get_err_count () in
                        uu____1033 = (Prims.parse_int "0") in
                      if uu____1032
                      then
           ...
           | FStar_Pervasives_Native.Some (tcmod,mii) ->
               let uu____1045 =
                 ...
                 FStar_All.pipe_left (with_tcenv env) uu____1050 in
           ...
           (let uu____1079 = tc_source_file () in
            match uu____1079 with | (tcmod,uu____1099,env1) -> (tcmod, env1)))
let tc_prims:
  FStar_TypeChecker_Env.env ->
    ((FStar_Syntax_Syntax.modul,Prims.int) FStar_Pervasives_Native.tuple2,
      FStar_TypeChecker_Env.env) FStar_Pervasives_Native.tuple2
  =
  fun env  ->
    let uu____1132 = FStar_Options.prims () in
    tc_one_file env FStar_Pervasives_Native.None uu____1132
let needs_interleaving: Prims.string -> Prims.string -> Prims.bool =
  fun intf  ->
    fun impl  ->
      ...
      ((m1 = m2) &&
         (let uu____1142 = FStar_Util.get_file_extension intf in
          FStar_List.mem uu____1142 ["fsti"; "fsi"]))
        &&
        (let uu____1144 = FStar_Util.get_file_extension impl in
         FStar_List.mem uu____1144 ["fst"; "fs"])
let pop_context: FStar_TypeChecker_Env.env -> Prims.string -> Prims.unit =
  fun env  ->
    fun msg  ->
      (let uu____1152 = FStar_ToSyntax_Env.pop () in
       FStar_All.pipe_right uu____1152 FStar_Pervasives.ignore);
      (let uu____1154 = FStar_TypeChecker_Env.pop env msg in
       FStar_All.pipe_right uu____1154 FStar_Pervasives.ignore);
...
let push_context:
  ...
  fun env  ->
    fun msg  ->
      ...
      let uu___526_1163 = env1 in
      {
        FStar_TypeChecker_Env.solver =
          (uu___526_1163.FStar_TypeChecker_Env.solver);
        FStar_TypeChecker_Env.range =
          (uu___526_1163.FStar_TypeChecker_Env.range);
        FStar_TypeChecker_Env.curmodule =
          (uu___526_1163.FStar_TypeChecker_Env.curmodule);
        FStar_TypeChecker_Env.gamma =
          (uu___526_1163.FStar_TypeChecker_Env.gamma);
        FStar_TypeChecker_Env.gamma_cache =
          (uu___526_1163.FStar_TypeChecker_Env.gamma_cache);
        FStar_TypeChecker_Env.modules =
          (uu___526_1163.FStar_TypeChecker_Env.modules);
        FStar_TypeChecker_Env.expected_typ =
          (uu___526_1163.FStar_TypeChecker_Env.expected_typ);
        FStar_TypeChecker_Env.sigtab =
          (uu___526_1163.FStar_TypeChecker_Env.sigtab);
        FStar_TypeChecker_Env.is_pattern =
          (uu___526_1163.FStar_TypeChecker_Env.is_pattern);
        FStar_TypeChecker_Env.instantiate_imp =
          (uu___526_1163.FStar_TypeChecker_Env.instantiate_imp);
        FStar_TypeChecker_Env.effects =
          (uu___526_1163.FStar_TypeChecker_Env.effects);
        FStar_TypeChecker_Env.generalize =
          (uu___526_1163.FStar_TypeChecker_Env.generalize);
        FStar_TypeChecker_Env.letrecs =
          (uu___526_1163.FStar_TypeChecker_Env.letrecs);
        FStar_TypeChecker_Env.top_level =
          (uu___526_1163.FStar_TypeChecker_Env.top_level);
        FStar_TypeChecker_Env.check_uvars =
          (uu___526_1163.FStar_TypeChecker_Env.check_uvars);
        FStar_TypeChecker_Env.use_eq =
          (uu___526_1163.FStar_TypeChecker_Env.use_eq);
        FStar_TypeChecker_Env.is_iface =
          (uu___526_1163.FStar_TypeChecker_Env.is_iface);
        FStar_TypeChecker_Env.admit =
          (uu___526_1163.FStar_TypeChecker_Env.admit);
        FStar_TypeChecker_Env.lax = (uu___526_1163.FStar_TypeChecker_Env.lax);
        FStar_TypeChecker_Env.lax_universes =
          (uu___526_1163.FStar_TypeChecker_Env.lax_universes);
        FStar_TypeChecker_Env.failhard =
          (uu___526_1163.FStar_TypeChecker_Env.failhard);
        FStar_TypeChecker_Env.nosynth =
          (uu___526_1163.FStar_TypeChecker_Env.nosynth);
        FStar_TypeChecker_Env.tc_term =
          (uu___526_1163.FStar_TypeChecker_Env.tc_term);
        FStar_TypeChecker_Env.type_of =
          (uu___526_1163.FStar_TypeChecker_Env.type_of);
        FStar_TypeChecker_Env.universe_of =
          (uu___526_1163.FStar_TypeChecker_Env.universe_of);
        FStar_TypeChecker_Env.use_bv_sorts =
          (uu___526_1163.FStar_TypeChecker_Env.use_bv_sorts);
        FStar_TypeChecker_Env.qname_and_index =
          (uu___526_1163.FStar_TypeChecker_Env.qname_and_index);
        FStar_TypeChecker_Env.proof_ns =
          (uu___526_1163.FStar_TypeChecker_Env.proof_ns);
        FStar_TypeChecker_Env.synth =
          (uu___526_1163.FStar_TypeChecker_Env.synth);
        FStar_TypeChecker_Env.is_native_tactic =
          (uu___526_1163.FStar_TypeChecker_Env.is_native_tactic);
        FStar_TypeChecker_Env.identifier_info =
          (uu___526_1163.FStar_TypeChecker_Env.identifier_info);
        FStar_TypeChecker_Env.tc_hooks =
          (uu___526_1163.FStar_TypeChecker_Env.tc_hooks);
        FStar_TypeChecker_Env.dsenv = dsenv;
        FStar_TypeChecker_Env.dep_graph =
          (uu___526_1163.FStar_TypeChecker_Env.dep_graph)
      }
    ...
    fun env  ->
      let uu____1188 =
        ...
        | intf::impl::remaining1 when needs_interleaving intf impl ->
            ...
            (match uu____1226 with | (m,env1) -> (remaining1, ([m], env1)))
...
let rec tc_fold_interleave:
  ...
  fun acc  ->
    fun remaining  ->
      ...
      | [] -> acc
      | uu____1475 ->
          let uu____1478 = acc in
          (match uu____1478 with
           | (mods,env) ->
               let uu____1513 = tc_one_file_from_remaining remaining env in
...
let batch_mode_tc:
  ...
  fun filenames  ->
    fun dep_graph1  ->
      (let uu____1588 = FStar_Options.debug_any () in
       if uu____1588
       then
         (FStar_Util.print_endline "Auto-deps kicked in; here's some info.";
          ...
          (let uu____1591 =
             ...
             FStar_String.concat " " uu____1592 in
           FStar_Util.print1
             "Here's the list of modules we will verify: %s\n" uu____1591))
       else ());
      (let env = init_env dep_graph1 in
       let uu____1601 = tc_fold_interleave ([], env) filenames in
       match uu____1601 with
       | (all_mods,env1) ->
           ((let uu____1647 =
               (FStar_Options.interactive ()) &&
                 (let uu____1649 = FStar_Errors.get_err_count () in
                  uu____1649 = (Prims.parse_int "0")) in
             if uu____1647
             then
