...
type either_replst =
  (FStar_JsonHelper.repl_state,FStar_JsonHelper.repl_state) FStar_Util.either
               ...
               | intf::impl::[] ->
                   ((let uu____304 =
                    ...
                    (let uu____339 =
                       ...
                       FStar_JsonHelper.LDInterfaceOfCurrentFile uu____340
                        in
                     [uu____339]))
               | impl::[] -> []
               | uu____346 ->
    ...
    fun st  ->
      ...
      | (depth,(uu____684,st'))::stack_tl ->
          ...
          (FStar_ST.op_Colon_Equals repl_stack stack_tl;
           (let uu____731 =
              FStar_Util.physical_equality env st'.FStar_JsonHelper.repl_env
               in
    ...
    fun name_events  ->
      let names1 =
        commit_name_tracking' st.FStar_JsonHelper.repl_curmod
          st.FStar_JsonHelper.repl_names name_events
         in
...
let (update_task_timestamps :
  ...
  fun uu___0_1659  ->
    ...
    | FStar_JsonHelper.LDSingle intf_or_impl ->
        let uu____1670 = tf_of_fname intf_or_impl.FStar_JsonHelper.tf_fname
           in
    ...
    fun tasks  ->
      let rec revert_many st1 uu___1_1709 =
        ...
        | (_id,(task,_st'))::entries ->
            ...
            let dep_graph1 =
              FStar_TypeChecker_Env.dep_graph st1.FStar_JsonHelper.repl_env
               in
            let st'1 =
