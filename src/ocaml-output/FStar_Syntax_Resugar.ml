    ...
    | FStar_Syntax_Syntax.Comp c1 ->
        ...
        then
          ...
          let args =
            ...
            then
              let rec aux l uu___203_3028 =
                match uu___203_3028 with
                | [] -> l
                | (t,aq)::tl1 ->
                    (match t.FStar_Syntax_Syntax.n with
                     | FStar_Syntax_Syntax.Tm_fvar fv when
                         ...
                         -> aux l tl1
                     | FStar_Syntax_Syntax.Tm_meta uu____3070 -> aux l tl1
                     | uu____3075 -> aux ((t, aq) :: l) tl1) in
          ...
          let args1 =
            FStar_List.map
              (fun uu____3095  ->
                 ...
                 | (e,uu____3101) ->
                     let uu____3102 = resugar_term e in
                     (uu____3102, FStar_Parser_AST.Nothing)) args in
          let rec aux l uu___204_3116 =
            match uu___204_3116 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
                 | FStar_Syntax_Syntax.DECREASES e ->
                     let e1 =
                       let uu____3136 = resugar_term e in
                       (uu____3136, FStar_Parser_AST.Nothing) in
                     aux (e1 :: l) tl1
                 | uu____3139 -> aux l tl1) in
      ...
      | (x,imp) ->
          ...
          (match e.FStar_Parser_AST.tm with
           | FStar_Parser_AST.Wild  ->
               let uu____3167 =
                 let uu____3168 = bv_as_unique_ident x in
                 FStar_Parser_AST.Variable uu____3168 in
               FStar_Parser_AST.mk_binder uu____3167 r
                 FStar_Parser_AST.Type_level None
           | uu____3169 ->
               let uu____3170 = FStar_Syntax_Syntax.is_null_bv x in
               if uu____3170
               then
                 ...
                 (let uu____3172 =
                    let uu____3173 =
                      ...
                      (uu____3176, e) in
                    FStar_Parser_AST.Annotated uu____3173 in
...
and resugar_bv_as_pat:
  ...
  fun x  ->
    fun qual  ->
      let mk1 a =
        let uu____3184 = FStar_Syntax_Syntax.range_of_bv x in
        FStar_Parser_AST.mk_pattern a uu____3184 in
      let uu____3185 =
        let uu____3186 =
      ...
      | FStar_Syntax_Syntax.Tm_unknown  ->
          ...
          then
            let uu____3192 = mk1 FStar_Parser_AST.PatWild in Some uu____3192
          else
            (let uu____3194 = resugar_arg_qual qual in
             FStar_Util.bind_opt uu____3194
               (fun aq  ->
                  let uu____3200 =
                    let uu____3201 =
                      let uu____3202 =
                        let uu____3206 = bv_as_unique_ident x in
                        (uu____3206, aq) in
                      FStar_Parser_AST.PatVar uu____3202 in
                    mk1 uu____3201 in
                  Some uu____3200))
      | uu____3208 ->
          let uu____3209 = resugar_arg_qual qual in
          FStar_Util.bind_opt uu____3209
            (fun aq  ->
               let pat =
                 let uu____3216 =
                   let uu____3217 =
                     let uu____3221 = bv_as_unique_ident x in
                     (uu____3221, aq) in
                   FStar_Parser_AST.PatVar uu____3217 in
                 mk1 uu____3216 in
               let uu____3223 = FStar_Options.print_bound_var_types () in
               if uu____3223
               then
                 let uu____3225 =
                   let uu____3226 =
                     let uu____3227 =
                       ...
                       (pat, uu____3230) in
                     FStar_Parser_AST.PatAscribed uu____3227 in
                   mk1 uu____3226 in
                 Some uu____3225
               else Some pat)
  ...
  fun p  ->
    ...
    let rec aux p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv,args) when
          ...
          let args1 =
            FStar_List.map
              (fun uu____3276  -> match uu____3276 with | (p2,b) -> aux p2)
              args in
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv,args) when
          ...
          let args1 =
            FStar_List.map
              (fun uu____3305  -> match uu____3305 with | (p2,b) -> aux p2)
              args in
          let uu____3310 =
            FStar_Syntax_Util.is_dtuple_data_lid'
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ({ FStar_Syntax_Syntax.fv_name = uu____3318;
             FStar_Syntax_Syntax.fv_delta = uu____3319;
          ...
          let fields1 =
            ...
            FStar_All.pipe_right uu____3340 FStar_List.rev in
          let args1 =
            let uu____3349 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____3359  ->
                      match uu____3359 with | (p2,b) -> aux p2)) in
            FStar_All.pipe_right uu____3349 FStar_List.rev in
          let rec map21 l1 l2 =
            match (l1, l2) with
            | ([],[]) -> []
            | ([],hd1::tl1) -> []
            | (hd1::tl1,[]) ->
                let uu____3401 = map21 tl1 [] in
                (hd1, (mk1 FStar_Parser_AST.PatWild)) :: uu____3401
            | (hd1::tl1,hd2::tl2) ->
                let uu____3415 = map21 tl1 tl2 in (hd1, hd2) :: uu____3415 in
          let args2 =
            let uu____3425 = map21 fields1 args1 in
            FStar_All.pipe_right uu____3425 FStar_List.rev in
          mk1 (FStar_Parser_AST.PatRecord args2)
      | FStar_Syntax_Syntax.Pat_cons (fv,args) ->
          let args1 =
            FStar_List.map
              (fun uu____3453  -> match uu____3453 with | (p2,b) -> aux p2)
              args in
          mk1
            (FStar_Parser_AST.PatApp
               ((mk1
      ...
      | FStar_Syntax_Syntax.Pat_var v1 ->
          ...
          (match uu____3464 with
           ...
           | None  ->
               let uu____3474 =
                 let uu____3475 =
                   let uu____3479 = bv_as_unique_ident v1 in
                   (uu____3479, None) in
                 FStar_Parser_AST.PatVar uu____3475 in
               mk1 uu____3474)
      ...
      | FStar_Syntax_Syntax.Pat_dot_term (bv,term) ->
          let pat =
            let uu____3489 =
              let uu____3490 =
                let uu____3494 = bv_as_unique_ident bv in (uu____3494, None) in
              FStar_Parser_AST.PatVar uu____3490 in
            mk1 uu____3489 in
          let uu____3496 = FStar_Options.print_bound_var_types () in
          if uu____3496
          then
            let uu____3497 =
              let uu____3498 =
                let uu____3501 = resugar_term term in (pat, uu____3501) in
              FStar_Parser_AST.PatAscribed uu____3498 in
            mk1 uu____3497
          else pat in
    aux p
let resugar_qualifier:
  ...
  fun uu___205_3507  ->
    ...
    | FStar_Syntax_Syntax.Reflectable uu____3513 ->
        Some FStar_Parser_AST.Reflectable
    | FStar_Syntax_Syntax.Discriminator uu____3514 -> None
    | FStar_Syntax_Syntax.Projector uu____3515 -> None
    | FStar_Syntax_Syntax.RecordType uu____3518 -> None
    | FStar_Syntax_Syntax.RecordConstructor uu____3523 -> None
    | FStar_Syntax_Syntax.Action uu____3528 -> None
...
let mk_decl:
  ...
  fun r  ->
    fun q  ->
      fun d'  ->
        let uu____3853 = FStar_List.choose resugar_qualifier q in
        {
          FStar_Parser_AST.d = d';
          FStar_Parser_AST.drange = r;
          FStar_Parser_AST.doc = None;
          FStar_Parser_AST.quals = uu____3853;
            ...
            let uu____3877 =
              let uu____3884 =
                let uu____3889 =
                  let uu____3893 =
                    let uu____3894 =
                      let uu____3901 = resugar_term typ in
                      (name1, [], None, uu____3901) in
                    FStar_Parser_AST.TyconAbbrev uu____3894 in
                  (uu____3893, None) in
                [uu____3889] in
              (false, uu____3884) in
            FStar_Parser_AST.Tycon uu____3877 in
          mk_decl typ.FStar_Syntax_Syntax.pos [] uu____3876
    ...
    fun r  ->
      fun q  ->
        fun ed  ->
          let resugar_action d for_free1 =
            ...
            | (bs,action_defn) ->
                ...
                (match uu____3950 with
                 | (bs1,action_typ) ->
                     let action_params1 =
                       let uu____3956 = FStar_Options.print_implicits () in
                       if uu____3956
                       then action_params
                     ...
                     let action_params2 =
                       ...
                       FStar_All.pipe_right uu____3960 FStar_List.rev in
                     ...
                     then
                       let a =
                         ...
                         FStar_Parser_AST.Construct uu____3969 in
                       let t =
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                let uu____4020 = FStar_Options.print_implicits () in
                if uu____4020 then eff_binders else filter_imp eff_binders in
              let eff_binders2 =
                let uu____4024 =
                  FStar_All.pipe_right eff_binders1
                    (FStar_List.map (fun b  -> resugar_binder b r)) in
                FStar_All.pipe_right uu____4024 FStar_List.rev in
...
let resugar_sigelt:
  ...
  fun se  ->
    match se.FStar_Syntax_Syntax.sigel with
    | FStar_Syntax_Syntax.Sig_bundle (ses,uu____4066) ->
        let uu____4071 =
          FStar_All.pipe_right ses
            (FStar_List.partition
               (fun se1  ->
                  match se1.FStar_Syntax_Syntax.sigel with
                  | FStar_Syntax_Syntax.Sig_inductive_typ uu____4082 -> true
                  | FStar_Syntax_Syntax.Sig_declare_typ uu____4091 -> true
                  | FStar_Syntax_Syntax.Sig_datacon uu____4095 -> false
                  | uu____4103 ->
                      failwith
                        "Found a sigelt which is neither a type declaration or a data constructor in a sigelt")) in
        (match uu____4071 with
         | (decl_typ_ses,datacon_ses) ->
             let retrieve_datacons_and_resugar uu____4123 se1 =
               match uu____4123 with
               | (datacon_ses1,tycons) ->
                   let uu____4138 = resugar_typ datacon_ses1 se1 in
             ...
             (match uu____4147 with
              | (leftover_datacons,tycons) ->
                  (match leftover_datacons with
                           ...
                           let uu____4168 =
                             let uu____4175 =
                               FStar_List.map (fun tyc  -> (tyc, None))
                                 tycons in
                             (false, uu____4175) in
                           FStar_Parser_AST.Tycon uu____4168 in
                         decl'_to_decl se uu____4167 in
                       Some uu____4166
                   | se1::[] ->
                       (match se1.FStar_Syntax_Syntax.sigel with
                        | FStar_Syntax_Syntax.Sig_datacon
                            (l,uu____4192,uu____4193,uu____4194,uu____4195,uu____4196)
                            ->
                            let uu____4199 =
                              decl'_to_decl se1
                   ...
                   | uu____4203 -> failwith "Should not happen hopefully")))
    | FStar_Syntax_Syntax.Sig_let (lbs,uu____4207,attrs) ->
        let uu____4213 =
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___208_4215  ->
                  match uu___208_4215 with
                  | FStar_Syntax_Syntax.Projector (uu____4216,uu____4217) ->
                      true
                  | FStar_Syntax_Syntax.Discriminator uu____4218 -> true
                  | uu____4219 -> false)) in
        if uu____4213
        then None
        else
          (let mk1 e =
           ...
           | FStar_Parser_AST.Let (isrec,lets,uu____4244) ->
               let uu____4251 =
                 decl'_to_decl se
                   (FStar_Parser_AST.TopLevelLet (isrec, lets)) in
               Some uu____4251
           | uu____4255 -> failwith "Should not happen hopefully")
    | FStar_Syntax_Syntax.Sig_assume (lid,fml) ->
        let uu____4259 =
          let uu____4260 =
            let uu____4261 =
              let uu____4264 = resugar_term fml in
              ((lid.FStar_Ident.ident), uu____4264) in
            FStar_Parser_AST.Assume uu____4261 in
    ...
    | FStar_Syntax_Syntax.Sig_sub_effect e ->
        ...
        let lift =
          ...
          | Some (uu____4288,t) ->
              let uu____4295 = resugar_term t in Some uu____4295
          | uu____4296 -> None in
        let op =
          ...
          | uu____4311 -> failwith "Should not happen hopefully" in
        let uu____4316 =
          decl'_to_decl se
    ...
    | FStar_Syntax_Syntax.Sig_effect_abbrev (lid,vs,bs,c,flags) ->
        let uu____4324 = FStar_Syntax_Subst.open_comp bs c in
        (match uu____4324 with
         | (bs1,c1) ->
             let bs2 =
               let uu____4331 = FStar_Options.print_implicits () in
               if uu____4331 then bs1 else filter_imp bs1 in
             let bs3 =
                 ...
                 let uu____4339 =
                   let uu____4346 =
                     let uu____4351 =
                       let uu____4355 =
                         let uu____4356 =
                           let uu____4363 = resugar_comp c1 in
                           ((lid.FStar_Ident.ident), bs3, None, uu____4363) in
                         FStar_Parser_AST.TyconAbbrev uu____4356 in
                       (uu____4355, None) in
                     [uu____4351] in
                   (false, uu____4346) in
                 FStar_Parser_AST.Tycon uu____4339 in
               decl'_to_decl se uu____4338 in
             Some uu____4337)
    ...
    | FStar_Syntax_Syntax.Sig_declare_typ (lid,uvs,t) ->
        let uu____4382 =
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___209_4384  ->
                  match uu___209_4384 with
                  | FStar_Syntax_Syntax.Projector (uu____4385,uu____4386) ->
                      true
                  | FStar_Syntax_Syntax.Discriminator uu____4387 -> true
                  | uu____4388 -> false)) in
        if uu____4382
        then None
        else
          (let uu____4391 =
             let uu____4392 =
               let uu____4393 =
                 let uu____4396 = resugar_term t in
                 ((lid.FStar_Ident.ident), uu____4396) in
               FStar_Parser_AST.Val uu____4393 in
             decl'_to_decl se uu____4392 in
           Some uu____4391)
    | FStar_Syntax_Syntax.Sig_inductive_typ uu____4397 -> None
    | FStar_Syntax_Syntax.Sig_datacon uu____4406 -> None
    | FStar_Syntax_Syntax.Sig_main uu____4414 -> None