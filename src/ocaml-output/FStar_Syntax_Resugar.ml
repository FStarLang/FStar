...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_app (e,args) ->
        let rec last1 uu___68_1293 =
          match uu___68_1293 with
          | hd1::[] -> [hd1]
          | hd1::tl1 -> last1 tl1
          | uu____1363 -> failwith "last of an empty list"  in
        let rec last_two uu___69_1399 =
          match uu___69_1399 with
          | [] ->
              failwith
        ...
        let rec last_three uu___70_1548 =
          match uu___70_1548 with
          | [] ->
              failwith
             ...
             let resugar body =
               ...
               | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____2598) ->
                   ...
                   (match uu____2619 with
                    | (xs1,body2) ->
                        let xs2 =
                          let uu____2627 = FStar_Options.print_implicits ()
                             in
         ...
         | FStar_Pervasives_Native.Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____3005  ->
                       match uu____3005 with | (e1,qual) -> resugar_term e1))
                in
             (match arity with
              ...
              | _0_43 when
                  ...
                  let uu____3098 =
                    let uu____3099 =
                      let uu____3106 =
                        let uu____3109 = last_two args1  in
                        resugar uu____3109  in
                      (op1, uu____3106)  in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____3477) ->
        ...
        let uu____3544 =
          let uu____3545 =
            let uu____3554 = resugar_term e  in (uu____3554, term, tac_opt1)
             in
             ...
             let resugar_one_binding bnd =
               let uu____3603 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd.FStar_Syntax_Syntax.lbunivs uu____3608
                  in
               ...
               | (univs1,td) ->
                   ...
                   (match uu____3619 with
                    | (typ,def) ->
                        let uu____3714 =
                          let uu____3721 =
                            let uu____3722 = FStar_Syntax_Subst.compress def
                               in
                              ...
                              (match uu____3754 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____3768 then b1 else filter_imp b1
                                      in
                                   (b2, t2, true))
                             ...
                             (match uu____3794 with
                              | (pat,term1) ->
                                  ...
                                  then
                                    ...
                                    (let uu____3902 =
                                       let uu____3907 = resugar_term term1
                                          in
                                       (pat, uu____3907)  in
                                     let uu____3908 =
                                       universe_to_string univs1  in
                                     (uu____3902, uu____3908)))))
                in
    ...
    | FStar_Syntax_Syntax.Tm_meta (e,m) ->
        let resugar_meta_desugared uu___72_4054 =
          match uu___72_4054 with
                    ...
                    let uu____4382 =
                      let uu____4387 =
                        ...
                        FStar_Util.format1 "wrong Data_app head format %s"
                          uu____4388
                         in
                      (FStar_Errors.Fatal_WrongDataAppHeadFormat, uu____4387)
                       in
                   ...
                   let universes1 =
                     FStar_List.map
                       (fun u  ->
                          ...
                          (uu____4443, FStar_Parser_AST.UnivApp)) universes
                      in
                   let args1 =
                   ...
                   let args2 =
                     let uu____4517 =
                       (FStar_Parser_Const.is_tuple_data_lid' head1) ||
                         (let uu____4519 = FStar_Options.print_universes ()
                             in
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____4604 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____4641 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
            ...
            FStar_List.map
              (fun uu____5198  ->
                 ...
                 | (e,uu____5208) ->
                     ...
                     (uu____5209, FStar_Parser_AST.Nothing)) args
             in
          let rec aux l uu___73_5230 =
            match uu___73_5230 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____5707 = map21 tl1 tl2  in (hd1, hd2) :: uu____5707
             in
          let args2 =
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____5960 -> failwith "unexpected"))
             in
                 ...
                 then
                   let resugar_datacon_as_fields fields se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_datacon
                         ...
                         ->
                         let uu____6062 =
                           let uu____6063 = FStar_Syntax_Subst.compress term
                              in
                ...
                let uu____6476 =
                  let uu____6483 =
                    let uu____6484 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____6497)
                       in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____6678 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____6683 =
                       ...
                       let uu____7196 =
                         let uu____7197 =
                           ...
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____7210)
                            in
          ...
          (let t' =
             let uu____7257 =
               (let uu____7260 = FStar_Options.print_universes ()  in
                Prims.op_Negation uu____7260) || (FStar_List.isEmpty uvs)
                in
             if uu____7257
             then resugar_term t
             else
