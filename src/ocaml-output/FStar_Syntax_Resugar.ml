  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_meta (e,m) ->
          let resugar_meta_desugared uu___192_4844 =
            match uu___192_4844 with
          ...
          then
            ...
            let args1 =
              FStar_List.map
               ...
               in
            let rec aux l uu___193_5558 =
              match uu___193_5558 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
