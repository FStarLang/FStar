          ...
          then
            ...
            let args1 =
              FStar_List.map
               ...
               in
            let rec aux l uu___199_5740 =
              match uu___199_5740 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
