...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_bvar x ->
        let l =
          let uu____559 =
            let uu____561 = bv_as_unique_ident x  in [uu____561]  in
          FStar_Ident.lid_of_ids uu____559  in
        mk1 (FStar_Parser_AST.Var l)
    | FStar_Syntax_Syntax.Tm_name x ->
        let l =
          let uu____564 =
            let uu____566 = bv_as_unique_ident x  in [uu____566]  in
          ...
          then
            ...
            (let uu____605 =
               ((FStar_Ident.lid_equals a FStar_Syntax_Const.assert_lid) ||
                 ...
                 ||
                 (let uu____606 =
                    let uu____607 = FStar_String.get s (Prims.parse_int "0")
                       in
                    FStar_Char.uppercase uu____607  in
                  let uu____608 = FStar_String.get s (Prims.parse_int "0")
                     in
                  uu____606 <> uu____608)
                in
             if uu____605
    ...
    | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
        let uu____734 =
          let uu____737 =
            let uu____738 = FStar_Syntax_Syntax.mk_binder x  in [uu____738]
             in
        ...
        let resugar_as_app e1 args1 =
          let args2 =
            FStar_All.pipe_right args1
              (FStar_List.map
                 (fun uu____1098  ->
                    match uu____1098 with | (e2,qual) -> resugar_term e2))
             in
                               ...
                               let uu____1178 =
                                 let uu____1182 =
                                   let uu____1184 =
                                     ...
                                     [uu____1186]  in
                                   e1 :: uu____1184  in
                                 ((FStar_Ident.id_of_text "*"), uu____1182)
                                  in
             ...
             (match uu____1237 with
              | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____1243) ->
                  ...
                  (match uu____1256 with
                   | (xs1,body2) ->
                       let xs2 =
                         let uu____1262 = FStar_Options.print_implicits ()
                            in
              ...
              | (body,handler) ->
                  let decomp term =
                    ...
                    | FStar_Syntax_Syntax.Tm_abs (x,e1,uu____1420) ->
                        let uu____1433 = FStar_Syntax_Subst.open_term x e1
                           in
                    ...
                    | uu____1438 ->
                     ...
                     in
                  let body1 =
                    let uu____1440 = decomp body  in resugar_term uu____1440
                     in
                  let handler1 =
             ...
             let resugar body =
               ...
               | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____1606) ->
                   ...
                   (match uu____1619 with
                    | (xs1,body2) ->
                        let xs2 =
                          let uu____1625 = FStar_Options.print_implicits ()
                             in
         ...
         | Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____1838  ->
                       match uu____1838 with | (e1,qual) -> resugar_term e1))
                in
             (match arity with
              ...
              | _0_42 when
                  ...
                  let uu____1909 =
                    let uu____1910 =
                      let uu____1914 =
                        let uu____1916 = last_two args1  in
                        resugar uu____1916  in
                      (op1, uu____1914)  in
        ...
        let resugar_branch uu____2119 =
          ...
          | (pat,wopt,b) ->
              ...
              let wopt1 =
                ...
                | None  -> None
                | Some e1 ->
                    let uu____2138 = resugar_term e1  in Some uu____2138
                 in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____2173) ->
        ...
        let uu____2226 =
          let uu____2227 =
            let uu____2232 = resugar_term e  in (uu____2232, term, tac_opt1)
             in
             ...
             let resugar_one_binding bnd =
               let uu____2266 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd.FStar_Syntax_Syntax.lbunivs uu____2269
                  in
               ...
               | (univs1,td) ->
                   ...
                   (match uu____2276 with
                    | (typ,def) ->
                        let uu____2352 =
                          let uu____2356 =
                            let uu____2357 = FStar_Syntax_Subst.compress def
                               in
                              ...
                              (match uu____2378 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____2387 then b1 else filter_imp b1
                                      in
                                   (b2, t2, true))
                             ...
                             (match uu____2416 with
                              | (pat,term1) ->
                                  ...
                                  then
                                    ...
                                    (let uu____2471 =
                                       let uu____2474 = resugar_term term1
                                          in
                                       (pat, uu____2474)  in
                                     let uu____2475 =
                                       universe_to_string univs1  in
                                     (uu____2471, uu____2475)))))
                in
              ...
              (match uu____2541 with
               | FStar_Syntax_Syntax.Tm_app (head1,args) ->
                   let rec aux h =
                     ...
                     | FStar_Syntax_Syntax.Tm_fvar fv ->
                         let uu____2576 = FStar_Syntax_Syntax.lid_of_fv fv
                            in
                         (uu____2576, [])
                     ...
                     | uu____2596 -> failwith "wrong Data_app head format"
                      in
                   ...
                   (match uu____2600 with
                    | (head2,universes) ->
                        ...
                        then mk1 (FStar_Parser_AST.Construct (head2, args1))
                          ...
                          (let uu____2637 = FStar_Options.print_universes ()
                              in
                           if uu____2637
                           then
                             mk1
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____2705 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____2736 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
         ...
         | FStar_Syntax_Syntax.Meta_alien (uu____2773,s) -> resugar_term e
         | FStar_Syntax_Syntax.Meta_named t1 ->
             mk1 (FStar_Parser_AST.Name t1)
         | FStar_Syntax_Syntax.Meta_monadic (name1,t1) ->
             let uu____2782 =
               let uu____2783 =
                 let uu____2788 = resugar_term e  in
                 let uu____2789 =
                   let uu____2790 =
                     let uu____2791 =
                       let uu____2797 =
                         let uu____2801 =
                           let uu____2804 = resugar_term t1  in
                           (uu____2804, FStar_Parser_AST.Nothing)  in
                         [uu____2801]  in
                       (name1, uu____2797)  in
                     FStar_Parser_AST.Construct uu____2791  in
                   mk1 uu____2790  in
                 (uu____2788, uu____2789, None)  in
               FStar_Parser_AST.Ascribed uu____2783  in
             mk1 uu____2782
         | FStar_Syntax_Syntax.Meta_monadic_lift (name1,uu____2814,t1) ->
             let uu____2820 =
               let uu____2821 =
                 let uu____2826 = resugar_term e  in
                 let uu____2827 =
                   let uu____2828 =
                     let uu____2829 =
                       let uu____2835 =
                         let uu____2839 =
                           let uu____2842 = resugar_term t1  in
                           (uu____2842, FStar_Parser_AST.Nothing)  in
                         [uu____2839]  in
                       (name1, uu____2835)  in
                     FStar_Parser_AST.Construct uu____2829  in
                   mk1 uu____2828  in
                 (uu____2826, uu____2827, None)  in
               FStar_Parser_AST.Ascribed uu____2821  in
             mk1 uu____2820)
...
and resugar_comp : FStar_Syntax_Syntax.comp -> FStar_Parser_AST.term =
  fun c  ->
             ...
             mk1
               (FStar_Parser_AST.Construct
                  (FStar_Syntax_Const.effect_GTot_lid,
                    [(t, FStar_Parser_AST.Nothing)]))
         | Some u1 ->
             let uu____2909 = FStar_Options.print_universes ()  in
             if uu____2909
             then
               let u2 = resugar_universe u1 c.FStar_Syntax_Syntax.pos  in
               mk1
    ...
    | FStar_Syntax_Syntax.Comp c1 ->
        let result =
          let uu____2932 = resugar_term c1.FStar_Syntax_Syntax.result_typ  in
          (uu____2932, FStar_Parser_AST.Nothing)  in
        let uu____2933 = FStar_Options.print_effect_args ()  in
        if uu____2933
        then
          let universe =
          ...
          let args =
            ...
            then
              let rec aux l uu___203_2973 =
                match uu___203_2973 with
                | [] -> l
                | (t,aq)::tl1 ->
                    (match t.FStar_Syntax_Syntax.n with
                     | FStar_Syntax_Syntax.Tm_fvar fv when
                         ...
                         -> aux l tl1
                     | FStar_Syntax_Syntax.Tm_meta uu____3015 -> aux l tl1
                     | uu____3020 -> aux ((t, aq) :: l) tl1)
                 in
          ...
          let args1 =
            FStar_List.map
              (fun uu____3040  ->
                 ...
                 | (e,uu____3046) ->
                     let uu____3047 = resugar_term e  in
                     (uu____3047, FStar_Parser_AST.Nothing)) args
             in
          let rec aux l uu___204_3061 =
            match uu___204_3061 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
                 | FStar_Syntax_Syntax.DECREASES e ->
                     let e1 =
                       let uu____3081 = resugar_term e  in
                       (uu____3081, FStar_Parser_AST.Nothing)  in
                     aux (e1 :: l) tl1
                 | uu____3084 -> aux l tl1)
             in
      ...
      | (x,imp) ->
          ...
          (match e.FStar_Parser_AST.tm with
           | FStar_Parser_AST.Wild  ->
               let uu____3112 =
                 let uu____3113 = bv_as_unique_ident x  in
                 FStar_Parser_AST.Variable uu____3113  in
               FStar_Parser_AST.mk_binder uu____3112 r
                 FStar_Parser_AST.Type_level None
           | uu____3114 ->
               let uu____3115 = FStar_Syntax_Syntax.is_null_bv x  in
               if uu____3115
               then
                 ...
                 (let uu____3117 =
                    let uu____3118 =
                      let uu____3121 = bv_as_unique_ident x  in
                      (uu____3121, e)  in
                    FStar_Parser_AST.Annotated uu____3118  in
                  FStar_Parser_AST.mk_binder uu____3117 r
                    FStar_Parser_AST.Type_level None))
...
and resugar_bv_as_pat :
  ...
  fun x  ->
    fun qual  ->
      let mk1 a =
        let uu____3129 = FStar_Syntax_Syntax.range_of_bv x  in
        FStar_Parser_AST.mk_pattern a uu____3129  in
      let uu____3130 =
        let uu____3131 =
      ...
      | FStar_Syntax_Syntax.Tm_unknown  ->
          ...
          then
            let uu____3137 = mk1 FStar_Parser_AST.PatWild  in Some uu____3137
          else
            (let uu____3139 = resugar_arg_qual qual  in
             FStar_Util.bind_opt uu____3139
               (fun aq  ->
                  let uu____3145 =
                    let uu____3146 =
                      let uu____3147 =
                        let uu____3151 = bv_as_unique_ident x  in
                        (uu____3151, aq)  in
                      FStar_Parser_AST.PatVar uu____3147  in
                    mk1 uu____3146  in
                  Some uu____3145))
      | uu____3153 ->
          let uu____3154 = resugar_arg_qual qual  in
          FStar_Util.bind_opt uu____3154
            (fun aq  ->
               let pat =
                 let uu____3161 =
                   let uu____3162 =
                     let uu____3166 = bv_as_unique_ident x  in
                     (uu____3166, aq)  in
                   FStar_Parser_AST.PatVar uu____3162  in
                 mk1 uu____3161  in
               let uu____3168 = FStar_Options.print_bound_var_types ()  in
               if uu____3168
               then
                 let uu____3170 =
                   let uu____3171 =
                     let uu____3172 =
                       ...
                       (pat, uu____3175)  in
                     FStar_Parser_AST.PatAscribed uu____3172  in
                   mk1 uu____3171  in
                 Some uu____3170
               else Some pat)
  ...
  fun p  ->
    ...
    let rec aux p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv,args) when
          ...
          let args1 =
            FStar_List.map
              (fun uu____3221  -> match uu____3221 with | (p2,b) -> aux p2)
              args
             in
      ...
      | FStar_Syntax_Syntax.Pat_cons (fv,args) when
          ...
          let args1 =
            FStar_List.map
              (fun uu____3250  -> match uu____3250 with | (p2,b) -> aux p2)
              args
             in
          let uu____3255 =
            FStar_Syntax_Util.is_dtuple_data_lid'
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ({ FStar_Syntax_Syntax.fv_name = uu____3263;
             FStar_Syntax_Syntax.fv_delta = uu____3264;
          ...
          let fields1 =
            let uu____3285 =
              FStar_All.pipe_right fields
               ...
               in
            FStar_All.pipe_right uu____3285 FStar_List.rev  in
          let args1 =
            let uu____3294 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____3304  ->
                      match uu____3304 with | (p2,b) -> aux p2))
               in
            FStar_All.pipe_right uu____3294 FStar_List.rev  in
          let rec map21 l1 l2 =
            match (l1, l2) with
            | ([],[]) -> []
            | ([],hd1::tl1) -> []
            | (hd1::tl1,[]) ->
                let uu____3346 = map21 tl1 []  in
                (hd1, (mk1 FStar_Parser_AST.PatWild)) :: uu____3346
            | (hd1::tl1,hd2::tl2) ->
                let uu____3360 = map21 tl1 tl2  in (hd1, hd2) :: uu____3360
             in
          let args2 =
            let uu____3370 = map21 fields1 args1  in
            FStar_All.pipe_right uu____3370 FStar_List.rev  in
          mk1 (FStar_Parser_AST.PatRecord args2)
      | FStar_Syntax_Syntax.Pat_cons (fv,args) ->
          let args1 =
            FStar_List.map
              (fun uu____3398  -> match uu____3398 with | (p2,b) -> aux p2)
              args
             in
          mk1
            (FStar_Parser_AST.PatApp
      ...
      | FStar_Syntax_Syntax.Pat_var v1 ->
          ...
          (match uu____3409 with
           ...
           | None  ->
               let uu____3419 =
                 let uu____3420 =
                   let uu____3424 = bv_as_unique_ident v1  in
                   (uu____3424, None)  in
                 FStar_Parser_AST.PatVar uu____3420  in
               mk1 uu____3419)
      | FStar_Syntax_Syntax.Pat_wild uu____3426 ->
          mk1 FStar_Parser_AST.PatWild
      | FStar_Syntax_Syntax.Pat_dot_term (bv,term) ->
          let pat =
            let uu____3434 =
              let uu____3435 =
                let uu____3439 = bv_as_unique_ident bv  in (uu____3439, None)
                 in
              FStar_Parser_AST.PatVar uu____3435  in
            mk1 uu____3434  in
          let uu____3441 = FStar_Options.print_bound_var_types ()  in
          if uu____3441
          then
            let uu____3442 =
              let uu____3443 =
                let uu____3446 = resugar_term term  in (pat, uu____3446)  in
              FStar_Parser_AST.PatAscribed uu____3443  in
            mk1 uu____3442
          else pat
       in
    aux p
...
let resugar_qualifier :
  ...
  fun uu___205_3451  ->
    ...
    | FStar_Syntax_Syntax.Reflectable uu____3457 ->
        Some FStar_Parser_AST.Reflectable
    | FStar_Syntax_Syntax.Discriminator uu____3458 -> None
    | FStar_Syntax_Syntax.Projector uu____3459 -> None
    | FStar_Syntax_Syntax.RecordType uu____3462 -> None
    | FStar_Syntax_Syntax.RecordConstructor uu____3467 -> None
    | FStar_Syntax_Syntax.Action uu____3472 -> None
  ...
  fun datacon_ses  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_inductive_typ
          (tylid,uvs,bs,t,uu____3497,datacons) ->
          let uu____3503 =
              ...
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | FStar_Syntax_Syntax.Sig_datacon
                        (uu____3514,uu____3515,uu____3516,inductive_lid,uu____3518,uu____3519)
                        -> FStar_Ident.lid_equals inductive_lid tylid
                    | uu____3522 -> failwith "unexpected"))
             in
          (match uu____3503 with
           | (current_datacons,other_datacons) ->
               let bs1 =
                 let uu____3533 = FStar_Options.print_implicits ()  in
                 if uu____3533 then bs else filter_imp bs  in
               let bs2 =
               ...
               let tyc =
                 ...
                 then
                   let resugar_datacon_as_fields fields se1 =
                     match se1.FStar_Syntax_Syntax.sigel with
                     | FStar_Syntax_Syntax.Sig_datacon
                         (uu____3576,univs1,term,uu____3579,num,uu____3581)
                         ->
                         let uu____3584 =
                           let uu____3585 = FStar_Syntax_Subst.compress term
                              in
                           uu____3585.FStar_Syntax_Syntax.n  in
                         (match uu____3584 with
                          | FStar_Syntax_Syntax.Tm_arrow (bs3,uu____3594) ->
                              let mfields =
                                        ...
                                        | (b,qual) ->
                                            ...
                                            let uu____3636 =
                                              resugar_term
                                               ...
                                               in
                                            (uu____3634, uu____3636, None)))
                                 in
                              FStar_List.append mfields fields
                          | uu____3642 -> failwith "unexpected")
                     | uu____3648 -> failwith "unexpected"  in
                   let fields =
                   ...
                   (let resugar_datacon constructors se1 =
                      match se1.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_datacon
                          (l,univs1,term,uu____3715,num,uu____3717) ->
                          let c =
                            let uu____3727 =
                              let uu____3729 = resugar_term term  in
                              Some uu____3729  in
                            ((l.FStar_Ident.ident), uu____3727, None, false)
                             in
                          c :: constructors
                      | uu____3738 -> failwith "unexpected"  in
                    let constructors =
...
let mk_decl :
  ...
  fun r  ->
    fun q  ->
      fun d'  ->
        let uu____3791 = FStar_List.choose resugar_qualifier q  in
        {
          FStar_Parser_AST.d = d';
          FStar_Parser_AST.drange = r;
          FStar_Parser_AST.doc = None;
          FStar_Parser_AST.quals = uu____3791;
            ...
            let uu____3811 =
              let uu____3818 =
                let uu____3823 =
                  let uu____3827 =
                    let uu____3828 =
                      let uu____3835 = resugar_term typ  in
                      (name1, [], None, uu____3835)  in
                    FStar_Parser_AST.TyconAbbrev uu____3828  in
                  (uu____3827, None)  in
                [uu____3823]  in
              (false, uu____3818)  in
            FStar_Parser_AST.Tycon uu____3811  in
          mk_decl typ.FStar_Syntax_Syntax.pos [] uu____3810
    ...
    fun r  ->
      fun q  ->
        fun ed  ->
          let resugar_action d for_free1 =
            ...
            | (bs,action_defn) ->
                ...
                (match uu____3879 with
                 | (bs1,action_typ) ->
                     let action_params1 =
                       let uu____3885 = FStar_Options.print_implicits ()  in
                       if uu____3885
                       then action_params
                     ...
                     let action_params2 =
                       let uu____3889 =
                         FStar_All.pipe_right action_params1
                          ...
                          in
                       FStar_All.pipe_right uu____3889 FStar_List.rev  in
                       ...
                       let a =
                         let uu____3898 =
                           ...
                           (uu____3904,
                            ...
                            in
                         FStar_Parser_AST.Construct uu____3898  in
                       let t =
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                let uu____3949 = FStar_Options.print_implicits ()  in
                if uu____3949 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____3953 =
...
let resugar_sigelt :
  ...
  fun se  ->
    match se.FStar_Syntax_Syntax.sigel with
    | FStar_Syntax_Syntax.Sig_bundle (ses,uu____3994) ->
        let uu____3999 =
          FStar_All.pipe_right ses
            (FStar_List.partition
               (fun se1  ->
                  match se1.FStar_Syntax_Syntax.sigel with
                  | FStar_Syntax_Syntax.Sig_inductive_typ uu____4010 -> true
                  | FStar_Syntax_Syntax.Sig_declare_typ uu____4019 -> true
                  | FStar_Syntax_Syntax.Sig_datacon uu____4023 -> false
                  | uu____4031 ->
                      failwith
        ...
        (match uu____3999 with
         | (decl_typ_ses,datacon_ses) ->
             let retrieve_datacons_and_resugar uu____4051 se1 =
               match uu____4051 with
               | (datacon_ses1,tycons) ->
                   let uu____4066 = resugar_typ datacon_ses1 se1  in
             ...
             (match uu____4075 with
              | (leftover_datacons,tycons) ->
                  (match leftover_datacons with
                           ...
                           let uu____4096 =
                             let uu____4103 =
                               FStar_List.map (fun tyc  -> (tyc, None))
                                ...
                                in
                             (false, uu____4103)  in
                           FStar_Parser_AST.Tycon uu____4096  in
                         decl'_to_decl se uu____4095  in
                       Some uu____4094
                   | se1::[] ->
                       (match se1.FStar_Syntax_Syntax.sigel with
                        | FStar_Syntax_Syntax.Sig_datacon
                            (l,uu____4120,uu____4121,uu____4122,uu____4123,uu____4124)
                            ->
                            let uu____4127 =
                              decl'_to_decl se1
                   ...
                   | uu____4131 -> failwith "Should not happen hopefully")))
    | FStar_Syntax_Syntax.Sig_let (lbs,uu____4135,attrs) ->
        let uu____4141 =
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___208_4143  ->
                  match uu___208_4143 with
                  | FStar_Syntax_Syntax.Projector (uu____4144,uu____4145) ->
                      true
                  | FStar_Syntax_Syntax.Discriminator uu____4146 -> true
                  | uu____4147 -> false))
           in
        if uu____4141
        then None
          ...
          (let mk1 e =
           ...
           | FStar_Parser_AST.Let (isrec,lets,uu____4172) ->
               let uu____4179 =
                 decl'_to_decl se
                   (FStar_Parser_AST.TopLevelLet (isrec, lets))
                  in
               Some uu____4179
           | uu____4183 -> failwith "Should not happen hopefully")
    | FStar_Syntax_Syntax.Sig_assume (lid,fml) ->
        let uu____4187 =
          let uu____4188 =
            let uu____4189 =
              let uu____4192 = resugar_term fml  in
              ((lid.FStar_Ident.ident), uu____4192)  in
            FStar_Parser_AST.Assume uu____4189  in
          decl'_to_decl se uu____4188  in
        Some uu____4187
    ...
    | FStar_Syntax_Syntax.Sig_sub_effect e ->
        ...
        let lift_wp =
          ...
          | Some (uu____4203,t) ->
              let uu____4210 = resugar_term t  in Some uu____4210
          | uu____4211 -> None  in
        let lift =
          match e.FStar_Syntax_Syntax.lift with
          | Some (uu____4216,t) ->
              let uu____4223 = resugar_term t  in Some uu____4223
          | uu____4224 -> None  in
        let op =
          ...
          | uu____4239 -> failwith "Should not happen hopefully"  in
        let uu____4244 =
          decl'_to_decl se
    ...
    | FStar_Syntax_Syntax.Sig_effect_abbrev (lid,vs,bs,c,flags) ->
        let uu____4252 = FStar_Syntax_Subst.open_comp bs c  in
        (match uu____4252 with
         | (bs1,c1) ->
             let bs2 =
               let uu____4259 = FStar_Options.print_implicits ()  in
               if uu____4259 then bs1 else filter_imp bs1  in
             let bs3 =
                 ...
                 let uu____4267 =
                   let uu____4274 =
                     let uu____4279 =
                       let uu____4283 =
                         let uu____4284 =
                           let uu____4291 = resugar_comp c1  in
                           ((lid.FStar_Ident.ident), bs3, None, uu____4291)
                            in
                         FStar_Parser_AST.TyconAbbrev uu____4284  in
                       (uu____4283, None)  in
                     [uu____4279]  in
                   (false, uu____4274)  in
                 FStar_Parser_AST.Tycon uu____4267  in
               decl'_to_decl se uu____4266  in
             Some uu____4265)
    ...
    | FStar_Syntax_Syntax.Sig_declare_typ (lid,uvs,t) ->
        let uu____4310 =
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___209_4312  ->
                  match uu___209_4312 with
                  | FStar_Syntax_Syntax.Projector (uu____4313,uu____4314) ->
                      true
                  | FStar_Syntax_Syntax.Discriminator uu____4315 -> true
                  | uu____4316 -> false))
           in
        if uu____4310
        then None
          ...
          (let uu____4319 =
             let uu____4320 =
               let uu____4321 =
                 let uu____4324 = resugar_term t  in
                 ((lid.FStar_Ident.ident), uu____4324)  in
               FStar_Parser_AST.Val uu____4321  in
             decl'_to_decl se uu____4320  in
           Some uu____4319)
    | FStar_Syntax_Syntax.Sig_inductive_typ uu____4325 -> None
    | FStar_Syntax_Syntax.Sig_datacon uu____4334 -> None
    | FStar_Syntax_Syntax.Sig_main uu____4342 -> None
