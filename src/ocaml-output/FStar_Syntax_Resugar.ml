...
let (string_to_op :
  ...
  =
  fun s  ->
    let name_of_op uu___154_449 =
      match uu___154_449 with
      | "Amp" ->
          FStar_Pervasives_Native.Some ("&", FStar_Pervasives_Native.None)
      | "At" ->
          FStar_Pervasives_Native.Some ("@", FStar_Pervasives_Native.None)
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
          ...
          (match uu____1629 with
           | (xs1,body1) ->
               ...
               let rec aux body3 uu___155_1672 =
                 match uu___155_1672 with
                 | [] -> body3
                 | hd1::tl1 ->
                     let body4 =
      ...
      | FStar_Syntax_Syntax.Tm_app (e,args) ->
          let rec last1 uu___156_1804 =
            match uu___156_1804 with
            | hd1::[] -> [hd1]
            | hd1::tl1 -> last1 tl1
            | uu____1874 -> failwith "last of an empty list"  in
          let rec last_two uu___157_1912 =
            match uu___157_1912 with
            | [] ->
                failwith
      ...
      | FStar_Syntax_Syntax.Tm_meta (e,m) ->
          let resugar_meta_desugared uu___158_4846 =
            match uu___158_4846 with
          ...
          then
            ...
            let args1 =
              FStar_List.map
               ...
               in
            let rec aux l uu___159_5596 =
              match uu___159_5596 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
