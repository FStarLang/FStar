      ...
      fun r  ->
        fun q  ->
          fun ed  ->
            ...
            | (eff_binders,eff_typ) ->
                let eff_binders1 =
                  let uu____8565 = FStar_Options.print_implicits ()  in
                  if uu____8565 then eff_binders else filter_imp eff_binders
                   in
                let eff_binders2 =
                  let uu____8575 =
                    FStar_All.pipe_right eff_binders1
                     ...
                     in
                  FStar_All.pipe_right uu____8575 FStar_List.rev  in
