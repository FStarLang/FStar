...
let uu____32 = (FStar_Util.choose_map (fun uu____36 x -> (

let uu____38 = (f x)
in ((()), (uu____38)))) () l)
in (FStar_Pervasives_Native.snd uu____32)))
...
in (Prims.strcat x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText uu____46))
end
| uu____47 -> begin
...
let filter_imp = (fun a -> (FStar_All.pipe_right a (FStar_List.filter (fun uu___183_78 -> (match (uu___183_78) with
| (uu____82, FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____83))) -> begin
false
end
| uu____85 -> begin
true
...
let uu____130 = (FStar_Options.print_universes ())
in (match (uu____130) with
| true -> begin
(

let uu____131 = (FStar_List.map (fun x -> x.FStar_Ident.idText) univs1)
in (FStar_All.pipe_right uu____131 (FStar_String.concat ", ")))
end
| uu____135 -> begin
""
end)))
...
| FStar_Syntax_Syntax.U_succ (uu____154) -> begin
(

let uu____155 = (universe_to_int (Prims.parse_int "0") u)
...
let uu____168 = (FStar_Util.string_of_int n1)
in ((uu____168), (FStar_Pervasives_Native.None)))
in FStar_Const.Const_int (uu____162))
in FStar_Parser_AST.Const (uu____161))
in (mk1 uu____160 r))
end
| uu____174 -> begin
(
...
let uu____184 = (FStar_Util.string_of_int n1)
in ((uu____184), (FStar_Pervasives_Native.None)))
in FStar_Const.Const_int (uu____178))
in FStar_Parser_AST.Const (uu____177))
in (mk1 uu____176 r))
in (
...
let uu____198 = (FStar_Ident.lid_of_path (("max")::[]) r)
in FStar_Parser_AST.Var (uu____198))
in (mk1 uu____197 r))
...
let uu____206 = (resugar_universe x r)
in ((acc), (uu____206), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____202))
in (mk1 uu____201 r))) t l))
end)
end
| FStar_Syntax_Syntax.U_name (u1) -> begin
(mk1 (FStar_Parser_AST.Uvar (u1)) r)
end
| FStar_Syntax_Syntax.U_unif (uu____208) -> begin
...
let uu____217 = (FStar_Util.string_of_int x)
in (FStar_Util.strcat "uu__univ_bvar_" uu____217))
in ((uu____216), (r)))
in (FStar_Ident.mk_ident uu____213))
...
let name_of_op = (fun uu___184_230 -> (match (uu___184_230) with
| "Amp" -> begin
...
let uu____288 = (FStar_Util.substring_from s (FStar_String.length "op_"))
in (FStar_Util.split uu____288 "_"))
in (match (s1) with
| (op)::[] -> begin
(name_of_op op)
end
...
let uu____298 = (FStar_List.map name_of_op s1)
in (FStar_List.fold_left (fun acc x -> (match (x) with
| FStar_Pervasives_Native.Some (op, uu____315) -> begin
(Prims.strcat acc op)
end
| FStar_Pervasives_Native.None -> begin
...
let uu____413 = (FStar_All.pipe_right infix_prim_ops (FStar_Util.find_opt (fun d -> (FStar_Syntax_Syntax.fv_eq_lid fv (FStar_Pervasives_Native.fst d)))))
...
let uu____481 = (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.sread_lid)
...
let uu____495 = (FStar_Syntax_Subst.compress t)
...
| FStar_Syntax_Syntax.Pat_wild (uu____557) -> begin
true
end
| uu____558 -> begin
false
...
let uu____587 = (FStar_Ident.lid_of_path ((a)::[]) r)
in FStar_Parser_AST.Name (uu____587)))
in (

let var = (fun a r -> (

let uu____595 = (FStar_Ident.lid_of_path ((a)::[]) r)
in FStar_Parser_AST.Var (uu____595)))
in (
...
| FStar_Syntax_Syntax.Tm_delayed (uu____600) -> begin
...
let uu____625 = (bv_as_unique_ident x)
in (uu____625)::[])
in (FStar_Ident.lid_of_ids uu____623))
...
let uu____630 = (bv_as_unique_ident x)
in (uu____630)::[])
in (FStar_Ident.lid_of_ids uu____628))
in (mk1 (FStar_Parser_AST.Var (l))))
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
(
...
let uu____655 = (FStar_Ident.lid_of_path ((rest)::[]) t.FStar_Syntax_Syntax.pos)
in FStar_Parser_AST.Discrim (uu____655))
in (mk1 uu____654)))
end
| uu____656 -> begin
...
let uu____669 = (((FStar_Ident.lid_equals a FStar_Parser_Const.assert_lid) || (FStar_Ident.lid_equals a FStar_Parser_Const.assume_lid)) || (

let uu____670 = (

let uu____671 = (FStar_String.get s (Prims.parse_int "0"))
in (FStar_Char.uppercase uu____671))
in (

let uu____672 = (FStar_String.get s (Prims.parse_int "0"))
in (uu____670 <> uu____672))))
in (match (uu____669) with
| true -> begin
(

let uu____673 = (var a.FStar_Ident.str t.FStar_Syntax_Syntax.pos)
in (mk1 uu____673))
end
| uu____674 -> begin
(

let uu____675 = (name a.FStar_Ident.str t.FStar_Syntax_Syntax.pos)
in (mk1 uu____675))
end))
end)
end)))))
...
let uu____682 = (FStar_Options.print_universes ())
...
let uu____691 = (resugar_universe x t.FStar_Syntax_Syntax.pos)
in ((acc), (uu____691), (FStar_Parser_AST.UnivApp)))
in FStar_Parser_AST.App (uu____687))
in (mk1 uu____686))) e1 universes))
end
| uu____692 -> begin
(resugar_term e)
end))
...
let uu____694 = (FStar_Syntax_Syntax.is_teff t)
in (match (uu____694) with
| true -> begin
(

let uu____695 = (name "Effect" t.FStar_Syntax_Syntax.pos)
in (mk1 uu____695))
end
| uu____696 -> begin
...
let uu____698 = (name "Type0" t.FStar_Syntax_Syntax.pos)
in (mk1 uu____698))
end
| FStar_Syntax_Syntax.U_unknown -> begin
(

let uu____699 = (name "Type" t.FStar_Syntax_Syntax.pos)
in (mk1 uu____699))
end
| uu____700 -> begin
(

let uu____701 = (FStar_Options.print_universes ())
...
let uu____712 = (name "Type" t.FStar_Syntax_Syntax.pos)
in (mk1 uu____712))
end))
end)
end
| FStar_Syntax_Syntax.Tm_abs (xs, body, uu____715) -> begin
(

let uu____738 = (FStar_Syntax_Subst.open_term xs body)
...
let uu____744 = (FStar_Options.print_implicits ())
...
let patterns = (FStar_All.pipe_right xs2 (FStar_List.choose (fun uu____751 -> (match (uu____751) with
| (x, qual) -> begin
...
let uu____771 = (FStar_Syntax_Subst.open_comp xs body)
...
let uu____777 = (FStar_Options.print_implicits ())
...
let uu____782 = (FStar_All.pipe_right xs2 (map_opt (fun b -> (resugar_binder b t.FStar_Syntax_Syntax.pos))))
in (FStar_All.pipe_right uu____782 FStar_List.rev))
in (

let rec aux = (fun body3 uu___185_795 -> (match (uu___185_795) with
| [] -> begin
body3
end
| (hd1)::tl1 -> begin
...
let uu____812 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____812)::[])
in (FStar_Syntax_Subst.open_term uu____811 phi))
...
let uu____818 = (FStar_List.hd x1)
in (resugar_binder uu____818 t.FStar_Syntax_Syntax.pos))
in (FStar_Util.must uu____816))
in (
...
let uu____825 = (resugar_term phi1)
in ((b), (uu____825)))
in FStar_Parser_AST.Refine (uu____822))
in (mk1 uu____821)))
end))
end
...
let rec last1 = (fun uu___186_855 -> (match (uu___186_855) with
| (hd1)::[] -> begin
(hd1)::[]
end
| (hd1)::tl1 -> begin
...
let rec last_two = (fun uu___187_926 -> (match (uu___187_926) with
| [] -> begin
...
let rec last_three = (fun uu___188_1026 -> (match (uu___188_1026) with
| [] -> begin
...
let args2 = (FStar_All.pipe_right args1 (FStar_List.map (fun uu____1187 -> (match (uu____1187) with
| (e2, qual) -> begin
(

let uu____1198 = (resugar_term e2)
in ((uu____1198), (qual)))
end))))
in (

let e2 = (resugar_term e1)
in (FStar_List.fold_left (fun acc uu____1205 -> (match (uu____1205) with
| (x, qual) -> begin
(
...
let uu____1218 = (resugar_imp qual)
in ((acc), (x), (uu____1218)))
in FStar_Parser_AST.App (uu____1214))
in (mk1 uu____1213))
end)) e2 args2))))
in (
...
let uu____1234 = (resugar_term_as_op e)
in (match (uu____1234) with
| FStar_Pervasives_Native.None -> begin
(resugar_as_app e args1)
end
| FStar_Pervasives_Native.Some ("tuple", uu____1240) -> begin
(match (args1) with
| ((fst1, uu____1244))::((snd1, uu____1246))::rest -> begin
(
...
let uu____1277 = (resugar_term fst1)
in (

let uu____1278 = (

let uu____1280 = (resugar_term snd1)
in (uu____1280)::[])
in (uu____1277)::uu____1278))
in (((FStar_Ident.id_of_text "*")), (uu____1275)))
in FStar_Parser_AST.Op (uu____1271))
in (mk1 uu____1270))
in (FStar_List.fold_left (fun acc uu____1285 -> (match (uu____1285) with
| (x, uu____1289) -> begin
(
...
let uu____1299 = (resugar_term x)
in (uu____1299)::[])
in (e1)::uu____1297)
in (((FStar_Ident.id_of_text "*")), (uu____1295)))
in FStar_Parser_AST.Op (uu____1291))
in (mk1 uu____1290))
end)) e1 rest))
end
| uu____1301 -> begin
...
| FStar_Pervasives_Native.Some ("dtuple", uu____1307) when ((FStar_List.length args1) > (Prims.parse_int "0")) -> begin
(
...
let uu____1351 = (FStar_Syntax_Subst.compress body)
in uu____1351.FStar_Syntax_Syntax.n)
in (match (uu____1350) with
| FStar_Syntax_Syntax.Tm_abs (xs, body1, uu____1356) -> begin
(

let uu____1379 = (FStar_Syntax_Subst.open_term xs body1)
...
let args3 = (FStar_All.pipe_right args2 (FStar_List.map (fun uu____1404 -> (match (uu____1404) with
| (e1, qual) -> begin
(resugar_term e1)
end))))
in (
...
| FStar_Pervasives_Native.Some ("dtuple", uu____1412) -> begin
(resugar_as_app e args1)
end
| FStar_Pervasives_Native.Some (ref_read, uu____1416) when (ref_read = FStar_Parser_Const.sread_lid.FStar_Ident.str) -> begin
(

let uu____1419 = (FStar_List.hd args1)
...
let uu____1435 = (FStar_Syntax_Subst.compress t1)
in uu____1435.FStar_Syntax_Syntax.n)
...
let uu____1452 = (resugar_term t1)
in ((uu____1452), (f)))
in FStar_Parser_AST.Project (uu____1449))
in (mk1 uu____1448)))
end
| uu____1453 -> begin
(resugar_term t1)
...
| FStar_Pervasives_Native.Some ("try_with", uu____1454) when ((FStar_List.length args1) > (Prims.parse_int "1")) -> begin
(

let new_args = (last_two args1)
in (

let uu____1470 = (match (new_args) with
| ((a1, uu____1484))::((a2, uu____1486))::[] -> begin
((a1), (a2))
end
| uu____1511 -> begin
...
let uu____1538 = (FStar_Syntax_Subst.compress term)
in uu____1538.FStar_Syntax_Syntax.n)
in (match (uu____1537) with
| FStar_Syntax_Syntax.Tm_abs (x, e1, uu____1543) -> begin
(
...
let uu____1573 = (decomp body)
in (resugar_term uu____1573))
in (

let handler1 = (

let uu____1575 = (decomp handler)
in (resugar_term uu____1575))
in (

let rec resugar_body = (fun t1 -> (match (t1.FStar_Parser_AST.tm) with
| FStar_Parser_AST.Match (e1, ((uu____1581, uu____1582, b))::[]) -> begin
b
end
| FStar_Parser_AST.Let (uu____1599, uu____1600, b) -> begin
b
end
...
let uu____1619 = (resugar_body t11)
in ((uu____1619), (t2), (t3)))
in FStar_Parser_AST.Ascribed (uu____1614))
in (mk1 uu____1613))
end
| uu____1621 -> begin
...
| FStar_Pervasives_Native.Some ("try_with", uu____1670) -> begin
(resugar_as_app e args1)
end
| FStar_Pervasives_Native.Some (op, uu____1674) when ((op = "forall") || (op = "exists")) -> begin
(
...
let uu____1734 = (FStar_Syntax_Subst.compress body)
in uu____1734.FStar_Syntax_Syntax.n)
in (match (uu____1733) with
| FStar_Syntax_Syntax.Tm_abs (xs, body1, uu____1739) -> begin
(

let uu____1762 = (FStar_Syntax_Subst.open_term xs body1)
...
let uu____1780 = (FStar_Syntax_Subst.compress body2)
in uu____1780.FStar_Syntax_Syntax.n)
...
(FStar_List.map (fun es -> (FStar_All.pipe_right es (FStar_List.map (fun uu____1820 -> (match (uu____1820) with
| (e2, uu____1824) -> begin
(resugar_term e2)
end))))) pats)
end
| FStar_Syntax_Syntax.Meta_labeled (s, r, uu____1827) -> begin
(
...
let uu____1840 = (resugar_term body2)
in (([]), (uu____1840)))
end))
...
let uu____1850 = (uncurry xs3 pats body3)
...
let uu____1886 = (resugar_term body)
in (([]), (([])::[]), (uu____1886)))
in FStar_Parser_AST.QForall (uu____1879))
in (mk1 uu____1878))
end
| uu____1892 -> begin
(
...
let uu____1901 = (resugar_term body)
in (([]), (([])::[]), (uu____1901)))
in FStar_Parser_AST.QExists (uu____1894))
in (mk1 uu____1893))
end)
end)))
...
| FStar_Pervasives_Native.Some ("alloc", uu____1941) -> begin
(

let uu____1944 = (FStar_List.hd args1)
...
let resugar = (fun args2 -> (FStar_All.pipe_right args2 (FStar_List.map (fun uu____1981 -> (match (uu____1981) with
| (e1, qual) -> begin
(resugar_term e1)
end)))))
in (match (arity) with
...
let uu____1986 = (FStar_Parser_ToDocument.handleable_args_length op1)
in (match (uu____1986) with
| _0_29 when ((_0_29 = (Prims.parse_int "1")) && ((FStar_List.length args1) > (Prims.parse_int "0"))) -> begin
(
...
let uu____2001 = (last1 args1)
in (resugar uu____2001))
in ((op1), (uu____1999)))
in FStar_Parser_AST.Op (uu____1995))
in (mk1 uu____1994))
end
| _0_30 when ((_0_30 = (Prims.parse_int "2")) && ((FStar_List.length args1) > (Prims.parse_int "1"))) -> begin
(
...
let uu____2020 = (last_two args1)
in (resugar uu____2020))
in ((op1), (uu____2018)))
in FStar_Parser_AST.Op (uu____2014))
in (mk1 uu____2013))
end
| _0_31 when ((_0_31 = (Prims.parse_int "3")) && ((FStar_List.length args1) > (Prims.parse_int "2"))) -> begin
(
...
let uu____2039 = (last_three args1)
in (resugar uu____2039))
in ((op1), (uu____2037)))
in FStar_Parser_AST.Op (uu____2033))
in (mk1 uu____2032))
end
| uu____2044 -> begin
(resugar_as_app e args1)
...
| _0_32 when ((_0_32 = (Prims.parse_int "2")) && ((FStar_List.length args1) > (Prims.parse_int "1"))) -> begin
(
...
let uu____2059 = (last_two args1)
in (resugar uu____2059))
in ((op1), (uu____2057)))
in FStar_Parser_AST.Op (uu____2053))
in (mk1 uu____2052))
end
| uu____2064 -> begin
(resugar_as_app e args1)
...
| FStar_Syntax_Syntax.Tm_match (e, ((pat, uu____2067, t1))::[]) -> begin
(
...
let uu____2125 = (resugar_pat pat)
in (

let uu____2126 = (resugar_term e)
in ((uu____2125), (uu____2126))))
in (uu____2122)::[])
in (
...
| FStar_Syntax_Syntax.Tm_match (e, ((pat1, uu____2137, t1))::((pat2, uu____2140, t2))::[]) when ((is_true_pat pat1) && (is_wild_pat pat2)) -> begin
(
...
let uu____2220 = (resugar_term e)
in (

let uu____2221 = (resugar_term t1)
in (

let uu____2222 = (resugar_term t2)
in ((uu____2220), (uu____2221), (uu____2222)))))
in FStar_Parser_AST.If (uu____2216))
in (mk1 uu____2215))
end
| FStar_Syntax_Syntax.Tm_match (e, branches) -> begin
(

let resugar_branch = (fun uu____2262 -> (match (uu____2262) with
| (pat, wopt, b) -> begin
(
...
let uu____2281 = (resugar_term e1)
in FStar_Pervasives_Native.Some (uu____2281))
end)
in (
...
let uu____2293 = (resugar_term e)
in (

let uu____2294 = (FStar_List.map resugar_branch branches)
in ((uu____2293), (uu____2294))))
in FStar_Parser_AST.Match (uu____2285))
in (mk1 uu____2284)))
end
| FStar_Syntax_Syntax.Tm_ascribed (e, (asc, tac_opt), uu____2316) -> begin
(
...
let uu____2375 = (resugar_term e)
in ((uu____2375), (term), (tac_opt1)))
in FStar_Parser_AST.Ascribed (uu____2370))
in (mk1 uu____2369))))
end
...
let uu____2393 = (FStar_Syntax_Subst.open_let_rec bnds body)
...
let uu____2412 = (FStar_Syntax_Util.mk_conj bnd.FStar_Syntax_Syntax.lbtyp bnd.FStar_Syntax_Syntax.lbdef)
in (FStar_Syntax_Subst.open_univ_vars bnd.FStar_Syntax_Syntax.lbunivs uu____2412))
...
let uu____2427 = (FStar_Syntax_Subst.compress td)
in uu____2427.FStar_Syntax_Syntax.n)
in (match (uu____2426) with
| FStar_Syntax_Syntax.Tm_app (uu____2436, ((t1, uu____2438))::((d, uu____2440))::[]) -> begin
((t1), (d))
end
| uu____2474 -> begin
...
| FStar_Syntax_Syntax.Tm_abs (b, t1, uu____2508) -> begin
(

let uu____2531 = (FStar_Syntax_Subst.open_term b t1)
...
let uu____2540 = (FStar_Options.print_implicits ())
...
let uu____2557 = (match (bnd.FStar_Syntax_Syntax.lbname) with
...
let args = (FStar_All.pipe_right binders (map_opt (fun uu____2592 -> (match (uu____2592) with
| (bv, q) -> begin
(

let uu____2601 = (resugar_arg_qual q)
in (FStar_Util.map_opt uu____2601 (fun q1 -> (

let uu____2607 = (

let uu____2608 = (

let uu____2612 = (bv_as_unique_ident bv)
in ((uu____2612), (q1)))
in FStar_Parser_AST.PatVar (uu____2608))
in (mk_pat uu____2607)))))
end))))
in (

let uu____2614 = (

let uu____2617 = (resugar_term term1)
in (((mk_pat (FStar_Parser_AST.PatApp (((pat), (args)))))), (uu____2617)))
in (

let uu____2619 = (universe_to_string univs1)
in ((uu____2614), (uu____2619)))))
end
| uu____2622 -> begin
(
...
let uu____2627 = (universe_to_string univs1)
in ((uu____2623), (uu____2627))))
end)
end))
end))
end))
...
let uu____2654 = (FStar_Options.print_universes ())
in (not (uu____2654)))
in (Obj.magic ((match (uu____2653) with
| true -> begin
FStar_Pervasives_Native.fst
end
| uu____2665 -> begin
(fun uu___189_2666 -> (match (uu___189_2666) with
| ((pat, body2), univs1) -> begin
(

let uu____2678 = (match ((univs1 = "")) with
| true -> begin
body2
end
| uu____2679 -> begin
...
| FStar_Syntax_Syntax.Tm_uvar (u, uu____2692) -> begin
(
...
let uu____2707 = (FStar_Unionfind.uvar_id u)
in (FStar_All.pipe_right uu____2707 FStar_Util.string_of_int))
in (Prims.strcat "uu___unification_ " uu____2706))
in (

let uu____2711 = (var s t.FStar_Syntax_Syntax.pos)
in (mk1 uu____2711)))
end
| FStar_Syntax_Syntax.Tm_meta (e, m) -> begin
(

let resugar_meta_desugared = (fun uu___190_2721 -> (match (uu___190_2721) with
...
let uu____2736 = (FStar_Syntax_Subst.compress h)
in uu____2736.FStar_Syntax_Syntax.n)
in (match (uu____2735) with
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
(

let uu____2749 = (FStar_Syntax_Syntax.lid_of_fv fv)
in ((uu____2749), ([]), ([])))
end
| FStar_Syntax_Syntax.Tm_uinst (h1, u) -> begin
(

let uu____2766 = (head_fv_universes_args h1)
...
let uu____2822 = (head_fv_universes_args head1)
...
let uu____2870 = (resugar_term h)
in (parser_term_to_string uu____2870))
in (FStar_Util.format1 "Not an application or a fv %s" uu____2869))
in FStar_Errors.Err (uu____2868))
in (FStar_Pervasives.raise uu____2867))
end)))
in (
...
let uu____2909 = (FStar_Syntax_Util.unmeta e)
in (head_fv_universes_args uu____2909))
end)
with
| FStar_Errors.Err (uu____2920) -> begin
(
...
let uu____2927 = (resugar_term e)
in (parser_term_to_string uu____2927))
in (FStar_Util.format1 "wrong Data_app head format %s" uu____2926))
in ((uu____2925), (e.FStar_Syntax_Syntax.pos)))
...
let uu____2959 = (resugar_universe u t.FStar_Syntax_Syntax.pos)
in ((uu____2959), (FStar_Parser_AST.UnivApp)))) universes)
in (

let args1 = (FStar_List.map (fun uu____2969 -> (match (uu____2969) with
| (t1, q) -> begin
(

let uu____2979 = (resugar_term t1)
in (

let uu____2980 = (resugar_imp q)
in ((uu____2979), (uu____2980))))
end)) args)
in (

let args2 = (

let uu____2985 = ((FStar_Parser_Const.is_tuple_data_lid' head1) || (
...
| FStar_Parser_AST.Let (uu____3001, ((p, t11))::[], t2) -> begin
...
let uu____3023 = (resugar_seq t11)
in ((uu____3023), (t2), (t3)))
in FStar_Parser_AST.Ascribed (uu____3018))
in (mk1 uu____3017))
end
| uu____3025 -> begin
t1
...
let uu____3041 = (FStar_Syntax_Subst.compress e)
in uu____3041.FStar_Syntax_Syntax.n)
in (match (uu____3040) with
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv1); FStar_Syntax_Syntax.tk = uu____3045; FStar_Syntax_Syntax.pos = uu____3046; FStar_Syntax_Syntax.vars = uu____3047}, ((term, uu____3049))::[]) -> begin
(resugar_term term)
end
| uu____3071 -> begin
...
let pats1 = (FStar_All.pipe_right (FStar_List.flatten pats) (FStar_List.map (fun uu____3093 -> (match (uu____3093) with
| (x, uu____3097) -> begin
(resugar_term x)
end))))
in (mk1 (FStar_Parser_AST.Attributes (pats1))))
end
| FStar_Syntax_Syntax.Meta_labeled (l, uu____3099, p) -> begin
(
...
let uu____3106 = (resugar_term e)
in ((uu____3106), (l), (p)))
in FStar_Parser_AST.Labeled (uu____3102))
in (mk1 uu____3101))
end
...
let uu____3137 = (resugar_term t1)
in ((uu____3137), (FStar_Parser_AST.Nothing)))
in (uu____3134)::[])
in ((name1), (uu____3130)))
in FStar_Parser_AST.Construct (uu____3124))
in (mk1 uu____3123))
in ((uu____3121), (uu____3122), (FStar_Pervasives_Native.None))))
in FStar_Parser_AST.Ascribed (uu____3116))
in (mk1 uu____3115))
end
| FStar_Syntax_Syntax.Meta_monadic_lift (name1, uu____3147, t1) -> begin
(
...
let uu____3175 = (resugar_term t1)
in ((uu____3175), (FStar_Parser_AST.Nothing)))
in (uu____3172)::[])
in ((name1), (uu____3168)))
in FStar_Parser_AST.Construct (uu____3162))
in (mk1 uu____3161))
in ((uu____3159), (uu____3160), (FStar_Pervasives_Native.None))))
in FStar_Parser_AST.Ascribed (uu____3154))
in (mk1 uu____3153))
end))
end
...
let uu____3206 = (FStar_Options.print_universes ())
...
let uu____3242 = (FStar_Options.print_universes ())
...
let uu____3265 = (resugar_term c1.FStar_Syntax_Syntax.result_typ)
in ((uu____3265), (FStar_Parser_AST.Nothing)))
in (

let uu____3266 = (FStar_Options.print_effect_args ())
...
let rec aux = (fun l uu___191_3306 -> (match (uu___191_3306) with
| [] -> begin
l
end
| ((t, aq))::tl1 -> begin
...
| FStar_Syntax_Syntax.Tm_meta (uu____3348) -> begin
(aux l tl1)
end
| uu____3353 -> begin
(aux ((((t), (aq)))::l) tl1)
...
let args1 = (FStar_List.map (fun uu____3373 -> (match (uu____3373) with
| (e, uu____3379) -> begin
(

let uu____3380 = (resugar_term e)
in ((uu____3380), (FStar_Parser_AST.Nothing)))
end)) args)
in (

let rec aux = (fun l uu___192_3394 -> (match (uu___192_3394) with
| [] -> begin
l
end
| (hd1)::tl1 -> begin
...
let uu____3414 = (resugar_term e)
in ((uu____3414), (FStar_Parser_AST.Nothing)))
in (aux ((e1)::l) tl1))
end
| uu____3417 -> begin
(aux l tl1)
...
let uu____3446 = (resugar_arg_qual aq)
in (FStar_Util.map_opt uu____3446 (fun imp -> (
...
let uu____3454 = (bv_as_unique_ident x)
in FStar_Parser_AST.Variable (uu____3454))
in (FStar_Parser_AST.mk_binder uu____3453 r FStar_Parser_AST.Type_level imp))
end
| uu____3455 -> begin
(

let uu____3456 = (FStar_Syntax_Syntax.is_null_bv x)
...
let uu____3462 = (bv_as_unique_ident x)
in ((uu____3462), (e)))
in FStar_Parser_AST.Annotated (uu____3459))
in (FStar_Parser_AST.mk_binder uu____3458 r FStar_Parser_AST.Type_level imp))
end))
end)))))
end)))
...
let uu____3470 = (FStar_Syntax_Syntax.range_of_bv x)
in (FStar_Parser_AST.mk_pattern a uu____3470)))
in (

let uu____3471 = (

let uu____3472 = (FStar_Syntax_Subst.compress x.FStar_Syntax_Syntax.sort)
...
let uu____3478 = (mk1 FStar_Parser_AST.PatWild)
in FStar_Pervasives_Native.Some (uu____3478))
end
| uu____3479 -> begin
(

let uu____3480 = (resugar_arg_qual qual)
in (FStar_Util.bind_opt uu____3480 (fun aq -> (
...
let uu____3492 = (bv_as_unique_ident x)
in ((uu____3492), (aq)))
in FStar_Parser_AST.PatVar (uu____3488))
in (mk1 uu____3487))
...
let uu____3495 = (resugar_arg_qual qual)
in (FStar_Util.bind_opt uu____3495 (fun aq -> (
...
let uu____3507 = (bv_as_unique_ident x)
in ((uu____3507), (aq)))
in FStar_Parser_AST.PatVar (uu____3503))
in (mk1 uu____3502))
in (

let uu____3509 = (FStar_Options.print_bound_var_types ())
...
let uu____3516 = (resugar_term x.FStar_Syntax_Syntax.sort)
in ((pat), (uu____3516)))
in FStar_Parser_AST.PatAscribed (uu____3513))
in (mk1 uu____3512))
in FStar_Pervasives_Native.Some (uu____3511))
end
| uu____3517 -> begin
...
let args1 = (FStar_List.map (fun uu____3577 -> (match (uu____3577) with
| (p2, b) -> begin
...
let args1 = (FStar_List.map (fun uu____3606 -> (match (uu____3606) with
| (p2, b) -> begin
(aux p2 (FStar_Pervasives_Native.Some (b)))
end)) args)
in (

let uu____3611 = (FStar_Parser_Const.is_dtuple_data_lid' fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
...
| FStar_Syntax_Syntax.Pat_cons ({FStar_Syntax_Syntax.fv_name = uu____3619; FStar_Syntax_Syntax.fv_delta = uu____3620; FStar_Syntax_Syntax.fv_qual = FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Record_ctor (name, fields))}, args) -> begin
(

let fields1 = (

let uu____3641 = (FStar_All.pipe_right fields (FStar_List.map (fun f -> (FStar_Ident.lid_of_ids ((f)::[])))))
in (FStar_All.pipe_right uu____3641 FStar_List.rev))
in (

let args1 = (

let uu____3650 = (FStar_All.pipe_right args (FStar_List.map (fun uu____3660 -> (match (uu____3660) with
| (p2, b) -> begin
(aux p2 (FStar_Pervasives_Native.Some (b)))
end))))
in (FStar_All.pipe_right uu____3650 FStar_List.rev))
in (
...
let uu____3702 = (map21 tl1 [])
in (((hd1), ((mk1 FStar_Parser_AST.PatWild))))::uu____3702)
end
| ((hd1)::tl1, (hd2)::tl2) -> begin
(

let uu____3716 = (map21 tl1 tl2)
in (((hd1), (hd2)))::uu____3716)
end))
in (

let args2 = (

let uu____3726 = (map21 fields1 args1)
in (FStar_All.pipe_right uu____3726 FStar_List.rev))
in (mk1 (FStar_Parser_AST.PatRecord (args2)))))))
end
| FStar_Syntax_Syntax.Pat_cons (fv, args) -> begin
(

let args1 = (FStar_List.map (fun uu____3754 -> (match (uu____3754) with
| (p2, b) -> begin
(aux p2 (FStar_Pervasives_Native.Some (b)))
end)) args)
...
let uu____3765 = (string_to_op v1.FStar_Syntax_Syntax.ppname.FStar_Ident.idText)
in (match (uu____3765) with
| FStar_Pervasives_Native.Some (op, uu____3770) -> begin
...
let uu____3780 = (bv_as_unique_ident v1)
in (

let uu____3781 = (to_arg_qual imp_opt)
in ((uu____3780), (uu____3781))))
in FStar_Parser_AST.PatVar (uu____3776))
in (mk1 uu____3775))
end))
end
| FStar_Syntax_Syntax.Pat_wild (uu____3784) -> begin
...
let uu____3797 = (bv_as_unique_ident bv)
in ((uu____3797), (FStar_Pervasives_Native.Some (FStar_Parser_AST.Implicit))))
in FStar_Parser_AST.PatVar (uu____3793))
in (mk1 uu____3792))
in (

let uu____3799 = (FStar_Options.print_bound_var_types ())
...
let uu____3804 = (resugar_term term)
in ((pat), (uu____3804)))
in FStar_Parser_AST.PatAscribed (uu____3801))
in (mk1 uu____3800))
end
| uu____3805 -> begin
pat
...
let resugar_qualifier : FStar_Syntax_Syntax.qualifier  ->  FStar_Parser_AST.qualifier FStar_Pervasives_Native.option = (fun uu___193_3809 -> (match (uu___193_3809) with
...
| FStar_Syntax_Syntax.Reflectable (uu____3815) -> begin
FStar_Pervasives_Native.Some (FStar_Parser_AST.Reflectable)
end
| FStar_Syntax_Syntax.Discriminator (uu____3816) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Projector (uu____3817) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.RecordType (uu____3820) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.RecordConstructor (uu____3825) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Action (uu____3830) -> begin
FStar_Pervasives_Native.None
end
...
let resugar_pragma : FStar_Syntax_Syntax.pragma  ->  FStar_Parser_AST.pragma = (fun uu___194_3833 -> (match (uu___194_3833) with
...
| FStar_Syntax_Syntax.Sig_inductive_typ (tylid, uvs, bs, t, uu____3855, datacons) -> begin
(

let uu____3861 = (FStar_All.pipe_right datacon_ses (FStar_List.partition (fun se1 -> (match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (uu____3872, uu____3873, uu____3874, inductive_lid, uu____3876, uu____3877) -> begin
...
let uu____3891 = (FStar_Options.print_implicits ())
...
let uu____3898 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___195_3900 -> (match (uu___195_3900) with
| FStar_Syntax_Syntax.RecordType (uu____3901) -> begin
true
end
| uu____3906 -> begin
false
...
| FStar_Syntax_Syntax.Sig_datacon (uu____3934, univs1, term, uu____3937, num, uu____3939) -> begin
(

let uu____3942 = (

let uu____3943 = (FStar_Syntax_Subst.compress term)
in uu____3943.FStar_Syntax_Syntax.n)
in (match (uu____3942) with
| FStar_Syntax_Syntax.Tm_arrow (bs3, uu____3952) -> begin
(

let mfields = (FStar_All.pipe_right bs3 (FStar_List.map (fun uu____3983 -> (match (uu____3983) with
| (b, qual) -> begin
(

let uu____3992 = (

let uu____3993 = (bv_as_unique_ident b)
in (FStar_Syntax_Util.unmangle_field_name uu____3993))
in (

let uu____3994 = (resugar_term b.FStar_Syntax_Syntax.sort)
in ((uu____3992), (uu____3994), (FStar_Pervasives_Native.None))))
end))))
...
| FStar_Syntax_Syntax.Sig_datacon (l, univs1, term, uu____4073, num, uu____4075) -> begin
(
...
let uu____4087 = (resugar_term term)
in FStar_Pervasives_Native.Some (uu____4087))
in ((l.FStar_Ident.ident), (uu____4085), (FStar_Pervasives_Native.None), (false)))
in (c)::constructors)
end
| uu____4096 -> begin
(failwith "unexpected")
...
let uu____4149 = (FStar_List.choose resugar_qualifier q)
in {FStar_Parser_AST.d = d'; FStar_Parser_AST.drange = r; FStar_Parser_AST.doc = FStar_Pervasives_Native.None; FStar_Parser_AST.quals = uu____4149; FStar_Parser_AST.attrs = []}))
...
let uu____4193 = (resugar_term typ)
in ((name1), ([]), (FStar_Pervasives_Native.None), (uu____4193)))
in FStar_Parser_AST.TyconAbbrev (uu____4186))
in ((uu____4185), (FStar_Pervasives_Native.None)))
in (uu____4181)::[])
in ((false), (uu____4176)))
in FStar_Parser_AST.Tycon (uu____4169))
in (mk_decl typ.FStar_Syntax_Syntax.pos [] uu____4168)))
end)))
...
let uu____4232 = (FStar_Syntax_Subst.open_term action_params d.FStar_Syntax_Syntax.action_defn)
in (match (uu____4232) with
| (bs, action_defn) -> begin
(

let uu____4237 = (FStar_Syntax_Subst.open_term action_params d.FStar_Syntax_Syntax.action_typ)
...
let uu____4243 = (FStar_Options.print_implicits ())
...
let uu____4247 = (FStar_All.pipe_right action_params1 (map_opt (fun b -> (resugar_binder b r))))
in (FStar_All.pipe_right uu____4247 FStar_List.rev))
in (
...
let uu____4262 = (FStar_Ident.lid_of_str "construct")
in ((uu____4262), ((((action_defn1), (FStar_Parser_AST.Nothing)))::(((action_typ1), (FStar_Parser_AST.Nothing)))::[])))
in FStar_Parser_AST.Construct (uu____4256))
in (
...
let uu____4301 = (FStar_Syntax_Subst.open_term ed.FStar_Syntax_Syntax.binders ed.FStar_Syntax_Syntax.signature)
...
let uu____4307 = (FStar_Options.print_implicits ())
...
let uu____4311 = (FStar_All.pipe_right eff_binders1 (map_opt (fun b -> (resugar_binder b r))))
in (FStar_All.pipe_right uu____4311 FStar_List.rev))
in (
...
| FStar_Syntax_Syntax.Sig_bundle (ses, uu____4352) -> begin
(

let uu____4357 = (FStar_All.pipe_right ses (FStar_List.partition (fun se1 -> (match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____4368) -> begin
true
end
| FStar_Syntax_Syntax.Sig_declare_typ (uu____4377) -> begin
true
end
| FStar_Syntax_Syntax.Sig_datacon (uu____4381) -> begin
false
end
| uu____4389 -> begin
...
let retrieve_datacons_and_resugar = (fun uu____4409 se1 -> (match (uu____4409) with
| (datacon_ses1, tycons) -> begin
(

let uu____4424 = (resugar_typ datacon_ses1 se1)
...
let uu____4433 = (FStar_List.fold_left retrieve_datacons_and_resugar ((datacon_ses), ([])) decl_typ_ses)
...
let uu____4461 = (FStar_List.map (fun tyc -> ((tyc), (FStar_Pervasives_Native.None))) tycons)
in ((false), (uu____4461)))
in FStar_Parser_AST.Tycon (uu____4454))
in (decl'_to_decl se uu____4453))
in FStar_Pervasives_Native.Some (uu____4452))
end
| (se1)::[] -> begin
(match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (l, uu____4478, uu____4479, uu____4480, uu____4481, uu____4482) -> begin
(

let uu____4485 = (decl'_to_decl se1 (FStar_Parser_AST.Exception (((l.FStar_Ident.ident), (FStar_Pervasives_Native.None)))))
in FStar_Pervasives_Native.Some (uu____4485))
end
| uu____4487 -> begin
...
| FStar_Syntax_Syntax.Sig_let (lbs, uu____4493, attrs) -> begin
(

let uu____4499 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___196_4501 -> (match (uu___196_4501) with
| FStar_Syntax_Syntax.Projector (uu____4502, uu____4503) -> begin
true
end
| FStar_Syntax_Syntax.Discriminator (uu____4504) -> begin
true
end
| uu____4505 -> begin
false
...
| FStar_Parser_AST.Let (isrec, lets, uu____4530) -> begin
(

let uu____4537 = (decl'_to_decl se (FStar_Parser_AST.TopLevelLet (((isrec), (lets)))))
in FStar_Pervasives_Native.Some (uu____4537))
end
| uu____4541 -> begin
(failwith "Should not happen hopefully")
end)))))
...
| FStar_Syntax_Syntax.Sig_assume (lid, fml) -> begin
(
...
let uu____4550 = (resugar_term fml)
in ((lid.FStar_Ident.ident), (uu____4550)))
in FStar_Parser_AST.Assume (uu____4547))
in (decl'_to_decl se uu____4546))
in FStar_Pervasives_Native.Some (uu____4545))
end
| FStar_Syntax_Syntax.Sig_new_effect (ed) -> begin
(

let uu____4552 = (resugar_eff_decl false se.FStar_Syntax_Syntax.sigrng se.FStar_Syntax_Syntax.sigquals ed)
in FStar_Pervasives_Native.Some (uu____4552))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ed) -> begin
(

let uu____4554 = (resugar_eff_decl true se.FStar_Syntax_Syntax.sigrng se.FStar_Syntax_Syntax.sigquals ed)
in FStar_Pervasives_Native.Some (uu____4554))
end
...
| FStar_Pervasives_Native.Some (uu____4561, t) -> begin
(

let uu____4568 = (resugar_term t)
in FStar_Pervasives_Native.Some (uu____4568))
end
| uu____4569 -> begin
FStar_Pervasives_Native.None
end)
...
| FStar_Pervasives_Native.Some (uu____4574, t) -> begin
(

let uu____4581 = (resugar_term t)
in FStar_Pervasives_Native.Some (uu____4581))
end
| uu____4582 -> begin
FStar_Pervasives_Native.None
end)
...
let uu____4602 = (decl'_to_decl se (FStar_Parser_AST.SubEffect ({FStar_Parser_AST.msource = src; FStar_Parser_AST.mdest = dst; FStar_Parser_AST.lift_op = op})))
in FStar_Pervasives_Native.Some (uu____4602)))))))
end
| FStar_Syntax_Syntax.Sig_effect_abbrev (lid, vs, bs, c, flags) -> begin
(

let uu____4610 = (FStar_Syntax_Subst.open_comp bs c)
...
let uu____4617 = (FStar_Options.print_implicits ())
...
let uu____4649 = (resugar_comp c1)
in ((lid.FStar_Ident.ident), (bs3), (FStar_Pervasives_Native.None), (uu____4649)))
in FStar_Parser_AST.TyconAbbrev (uu____4642))
in ((uu____4641), (FStar_Pervasives_Native.None)))
in (uu____4637)::[])
in ((false), (uu____4632)))
in FStar_Parser_AST.Tycon (uu____4625))
in (decl'_to_decl se uu____4624))
...
let uu____4664 = (decl'_to_decl se (FStar_Parser_AST.Pragma ((resugar_pragma p))))
in FStar_Pervasives_Native.Some (uu____4664))
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uvs, t) -> begin
(

let uu____4668 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___197_4670 -> (match (uu___197_4670) with
| FStar_Syntax_Syntax.Projector (uu____4671, uu____4672) -> begin
true
end
| FStar_Syntax_Syntax.Discriminator (uu____4673) -> begin
true
end
| uu____4674 -> begin
false
...
let uu____4679 = (FStar_Options.print_universes ())
in (not (uu____4679))) || (FStar_List.isEmpty uvs))
...
let uu____4681 = (FStar_Syntax_Subst.open_univ_vars uvs t)
...
in ((uu____4692), (universes), (true)))
in FStar_Parser_AST.Labeled (uu____4688))
in (FStar_Parser_AST.mk_term uu____4687 t1.FStar_Syntax_Syntax.pos FStar_Parser_AST.Un)))
end))
end))
in (

let uu____4693 = (decl'_to_decl se (FStar_Parser_AST.Val (((lid.FStar_Ident.ident), (t')))))
in FStar_Pervasives_Native.Some (uu____4693)))
end))
end
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____4694) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Sig_datacon (uu____4703) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Sig_main (uu____4711) -> begin
FStar_Pervasives_Native.None
end))
