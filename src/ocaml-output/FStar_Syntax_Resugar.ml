                                              ...
                                              | (bv,uu____2599) ->
                                                  let uu____2600 =
                                                    ...
                                                    FStar_Parser_AST.PatVar
                                                      uu____2601 in
                                                  mk_pat uu____2600)) in
                                    let uu____2607 =
                                      let uu____2610 = resugar_term term1 in
                                      ((mk_pat
                                          (FStar_Parser_AST.PatApp
                                             (pat, args))), uu____2610) in
                                    let uu____2612 =
                                      universe_to_string univs1 in
                                    (uu____2607, uu____2612)
                                  else
                                    (let uu____2616 =
                                       let uu____2619 = resugar_term term1 in
                                       (pat, uu____2619) in
                                     let uu____2620 =
                                       universe_to_string univs1 in
                   ...
                   let universes1 =
                     FStar_List.map
                       (fun u  ->
                          ...
                          (uu____2960, FStar_Parser_AST.UnivApp)) universes in
                   let args1 =
                     FStar_List.map
                       (fun uu____2975  ->
                          ...
                          | (t1,q) ->
                              ...
                              (uu____2985, uu____2986)) args in
                   let args2 =
                     let uu____2991 =
                       (FStar_Parser_Const.is_tuple_data_lid' head1) ||
                         (let uu____2993 = FStar_Options.print_universes () in
                          Prims.op_Negation uu____2993) in
                     if uu____2991
                     then args1
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____3047 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____3078 -> failwith "mutable_rval should have app term") in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
               FStar_All.pipe_right (FStar_List.flatten pats)
                 (FStar_List.map
                    (fun uu____3103  ->
                       ...
                       | (x,uu____3107) -> resugar_term x)) in
            ...
            FStar_List.map
              (fun uu____3390  ->
                 ...
                 | (e,uu____3396) ->
                     ...
                     (uu____3397, FStar_Parser_AST.Nothing)) args in
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____3721 = map21 tl1 tl2 in (hd1, hd2) :: uu____3721 in
          let args2 =
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____3891 -> failwith "unexpected")) in
                 ...
                 then
                   let resugar_datacon_as_fields fields se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_datacon
                         ...
                         ->
                         let uu____3957 =
                           let uu____3958 = FStar_Syntax_Subst.compress term in
                ...
                let uu____4208 =
                  let uu____4212 =
                    let uu____4213 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____4220) in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____4340 then eff_binders else filter_imp eff_binders in
              let eff_binders2 =
                let uu____4344 =
...
let resugar_sigelt:
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_let (lbs,uu____4531,attrs) ->
        let uu____4537 =
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___200_4542  ->
                  match uu___200_4542 with
                  | FStar_Syntax_Syntax.Projector (uu____4543,uu____4544) ->
                      true
                  | FStar_Syntax_Syntax.Discriminator uu____4545 -> true
                  | uu____4546 -> false)) in
        if uu____4537
        then FStar_Pervasives_Native.None
        else
          (let mk1 e =
           ...
           | FStar_Parser_AST.Let (isrec,lets,uu____4571) ->
               let uu____4578 =
                 decl'_to_decl se
                   (FStar_Parser_AST.TopLevelLet (isrec, lets)) in
               FStar_Pervasives_Native.Some uu____4578
           | uu____4582 -> failwith "Should not happen hopefully")
    | FStar_Syntax_Syntax.Sig_assume (lid,uu____4585,fml) ->
        let uu____4587 =
          let uu____4588 =
            let uu____4589 =
              let uu____4592 = resugar_term fml in
              ((lid.FStar_Ident.ident), uu____4592) in
            FStar_Parser_AST.Assume uu____4589 in
          decl'_to_decl se uu____4588 in
        FStar_Pervasives_Native.Some uu____4587
    | FStar_Syntax_Syntax.Sig_new_effect ed ->
        let uu____4594 =
          resugar_eff_decl false se.FStar_Syntax_Syntax.sigrng
            se.FStar_Syntax_Syntax.sigquals ed in
        FStar_Pervasives_Native.Some uu____4594
    ...
    | FStar_Syntax_Syntax.Sig_sub_effect e ->
        ...
        let lift_wp =
          ...
          | FStar_Pervasives_Native.Some (uu____4603,t) ->
              let uu____4610 = resugar_term t in
              FStar_Pervasives_Native.Some uu____4610
          | uu____4611 -> FStar_Pervasives_Native.None in
        let lift =
          match e.FStar_Syntax_Syntax.lift with
          | FStar_Pervasives_Native.Some (uu____4616,t) ->
              let uu____4623 = resugar_term t in
        ...
        let op =
          ...
          | uu____4639 -> failwith "Should not happen hopefully" in
        let uu____4644 =
          decl'_to_decl se
    ...
    | FStar_Syntax_Syntax.Sig_effect_abbrev (lid,vs,bs,c,flags) ->
        ...
        (match uu____4652 with
         | (bs1,c1) ->
             let bs2 =
               let uu____4659 = FStar_Options.print_implicits () in
               if uu____4659 then bs1 else filter_imp bs1 in
             let bs3 =
                 ...
                 let uu____4668 =
                   let uu____4675 =
                     let uu____4680 =
                       let uu____4684 =
                         let uu____4685 =
                           let uu____4692 = resugar_comp c1 in
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____4692) in
                         FStar_Parser_AST.TyconAbbrev uu____4685 in
                       (uu____4684, FStar_Pervasives_Native.None) in
                     [uu____4680] in
                   (false, uu____4675) in
                 FStar_Parser_AST.Tycon uu____4668 in
               decl'_to_decl se uu____4667 in
             FStar_Pervasives_Native.Some uu____4666)
    ...
    | FStar_Syntax_Syntax.Sig_declare_typ (lid,uvs,t) ->
        let uu____4711 =
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___201_4716  ->
                  match uu___201_4716 with
                  | FStar_Syntax_Syntax.Projector (uu____4717,uu____4718) ->
                      true
                  | FStar_Syntax_Syntax.Discriminator uu____4719 -> true
                  | uu____4720 -> false)) in
        if uu____4711
        then FStar_Pervasives_Native.None
        else
          (let t' =
             let uu____4724 =
               (let uu____4727 = FStar_Options.print_universes () in
                Prims.op_Negation uu____4727) || (FStar_List.isEmpty uvs) in
             if uu____4724
             then resugar_term t
             else
               (let uu____4729 = FStar_Syntax_Subst.open_univ_vars uvs t in
                match uu____4729 with
                | (uvs1,t1) ->
                    let universes = universe_to_string uvs1 in
                    let uu____4735 =
                      let uu____4736 =
                        let uu____4740 = resugar_term t1 in
                        (uu____4740, universes, true) in
                      FStar_Parser_AST.Labeled uu____4736 in
                    FStar_Parser_AST.mk_term uu____4735
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ uu____4742 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Sig_datacon uu____4751 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Sig_main uu____4759 -> FStar_Pervasives_Native.None