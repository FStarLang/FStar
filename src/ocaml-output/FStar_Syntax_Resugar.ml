  ...
  fun env  ->
    fun t  ->
                                       ...
                                       let uu____4443 =
                                         let uu____4444 =
                                           ...
                                           (uu____4451,
                                             FStar_Pervasives_Native.None)
                                            in
                                         FStar_Parser_AST.PatVar uu____4444
                                          in
                                       mk_pat uu____4443  in
                                     (uu____4442, term)
                                  in
                                    ...
                                    let uu____4472 =
                                      ...
                                      then
                                        ...
                                        (let uu____4564 =
                                         ...
                                         let uu____4570 =
                                           universe_to_string univs1  in
                                         (uu____4564, uu____4570))
                                       in
                                    (attrs_opt, uu____4472))))
                  in
            ...
            let uu____4803 =
              let uu____4804 =
                FStar_Syntax_Unionfind.uvar_id
                 ...
                 in
              FStar_All.pipe_right uu____4804 FStar_Util.string_of_int  in
            Prims.strcat "?u" uu____4803  in
          let uu____4805 = mk1 FStar_Parser_AST.Wild  in label s uu____4805
      | FStar_Syntax_Syntax.Tm_quoted (tm,qi) ->
          ...
          let uu____4813 =
            let uu____4814 =
              let uu____4819 = resugar_term' env tm  in (uu____4819, qi1)  in
            FStar_Parser_AST.Quote uu____4814  in
          mk1 uu____4813
      | FStar_Syntax_Syntax.Tm_meta (e,m) ->
          let resugar_meta_desugared uu___72_4831 =
            match uu___72_4831 with
            | FStar_Syntax_Syntax.Sequence  ->
                let term = resugar_term' env e  in
                let rec resugar_seq t1 =
                  match t1.FStar_Parser_AST.tm with
                  | FStar_Parser_AST.Let
                      (uu____4839,(uu____4840,(p,t11))::[],t2) ->
                      mk1 (FStar_Parser_AST.Seq (t11, t2))
                  | FStar_Parser_AST.Ascribed (t11,t2,t3) ->
                      let uu____4901 =
                        let uu____4902 =
                          let uu____4911 = resugar_seq t11  in
                          (uu____4911, t2, t3)  in
                        FStar_Parser_AST.Ascribed uu____4902  in
                      mk1 uu____4901
                  | uu____4914 -> t1  in
                resugar_seq term
            ...
            | FStar_Syntax_Syntax.Mutable_rval  ->
                let fv =
                  FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.sread_lid
                   ...
                   in
                let uu____4962 =
                  let uu____4963 = FStar_Syntax_Subst.compress e  in
                ...
                (match uu____4962 with
                 | FStar_Syntax_Syntax.Tm_app
                     ({
                        ...
                        FStar_Syntax_Syntax.vars = uu____4968;_},(term,uu____4970)::[])
                     -> resugar_term' env term
                 | uu____4999 -> failwith "mutable_rval should have app term")
             in
          (match m with
           | FStar_Syntax_Syntax.Meta_pattern pats ->
               let pats1 =
                 FStar_All.pipe_right (FStar_List.flatten pats)
                   (FStar_List.map
                      (fun uu____5035  ->
                         ...
                         | (x,uu____5041) -> resugar_term' env x))
                  in
               mk1 (FStar_Parser_AST.Attributes pats1)
           | FStar_Syntax_Syntax.Meta_labeled (l,uu____5043,p) ->
               let uu____5045 =
                 let uu____5046 =
                   let uu____5053 = resugar_term' env e  in
                   (uu____5053, l, p)  in
                 FStar_Parser_AST.Labeled uu____5046  in
               mk1 uu____5045
                   ...
                   let uu____5073 =
                     let uu____5074 =
                       let uu____5075 =
                         let uu____5086 =
                           let uu____5093 =
                             let uu____5098 = resugar_term' env t1  in
                             (uu____5098, FStar_Parser_AST.Nothing)  in
                           [uu____5093]  in
                         (name1, uu____5086)  in
                       FStar_Parser_AST.Construct uu____5075  in
                     mk1 uu____5074  in
                   (uu____5072, uu____5073, FStar_Pervasives_Native.None)  in
                 FStar_Parser_AST.Ascribed uu____5063  in
               mk1 uu____5062
           | FStar_Syntax_Syntax.Meta_monadic_lift (name1,uu____5116,t1) ->
               let uu____5122 =
                 let uu____5123 =
                   let uu____5132 = resugar_term' env e  in
                   let uu____5133 =
                     let uu____5134 =
                       let uu____5135 =
                         let uu____5146 =
                           let uu____5153 =
                             let uu____5158 = resugar_term' env t1  in
                             (uu____5158, FStar_Parser_AST.Nothing)  in
                           [uu____5153]  in
                         (name1, uu____5146)  in
                       FStar_Parser_AST.Construct uu____5135  in
                     mk1 uu____5134  in
                   (uu____5132, uu____5133, FStar_Pervasives_Native.None)  in
                 FStar_Parser_AST.Ascribed uu____5123  in
               mk1 uu____5122)
    ...
    fun c  ->
      ...
      | FStar_Syntax_Syntax.Total (typ,u) ->
          ...
          (match u with
           ...
           | FStar_Pervasives_Native.Some u1 ->
               let uu____5209 = FStar_Options.print_universes ()  in
               if uu____5209
               then
               ...
               mk1
                 (FStar_Parser_AST.Construct
                    (FStar_Parser_Const.effect_GTot_lid,
                      [(t, FStar_Parser_AST.Nothing)]))
           | FStar_Pervasives_Native.Some u1 ->
               let uu____5270 = FStar_Options.print_universes ()  in
               if uu____5270
               then
                 let u2 = resugar_universe u1 c.FStar_Syntax_Syntax.pos  in
                 mk1
      ...
      | FStar_Syntax_Syntax.Comp c1 ->
          let result =
            ...
            (uu____5311, FStar_Parser_AST.Nothing)  in
          let uu____5312 = FStar_Options.print_effect_args ()  in
          if uu____5312
          then
            let universe =
                    ...
                    let post1 =
                      let uu____5396 =
                        FStar_Syntax_Util.unthunk_lemma_post
                         ...
                         in
                      (uu____5396, (FStar_Pervasives_Native.snd post))  in
                    let uu____5405 =
                      let uu____5414 =
                        FStar_Syntax_Util.is_fvar FStar_Parser_Const.true_lid
                          (FStar_Pervasives_Native.fst pre)
                         in
                      if uu____5414 then [] else [pre]  in
                    let uu____5444 =
                      let uu____5453 =
                        let uu____5462 =
                          FStar_Syntax_Util.is_fvar
                           ...
                           in
                        if uu____5462 then [] else [pats]  in
                      FStar_List.append [post1] uu____5453  in
                    FStar_List.append uu____5405 uu____5444
                | uu____5516 -> c1.FStar_Syntax_Syntax.effect_args
            ...
            let args1 =
              FStar_List.map
                (fun uu____5545  ->
                   ...
                   | (e,uu____5555) ->
                       let uu____5556 = resugar_term' env e  in
                       (uu____5556, FStar_Parser_AST.Nothing)) args
               in
            let rec aux l uu___73_5581 =
              match uu___73_5581 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
                   | FStar_Syntax_Syntax.DECREASES e ->
                       let e1 =
                         let uu____5614 = resugar_term' env e  in
                         (uu____5614, FStar_Parser_AST.Nothing)  in
                       aux (e1 :: l) tl1
                   | uu____5619 -> aux l tl1)
               in
  ...
  fun env  ->
    fun b  ->
      fun r  ->
        ...
        | (x,aq) ->
            let uu____5670 = resugar_arg_qual aq  in
            FStar_Util.map_opt uu____5670
              (fun imp  ->
                 let e = resugar_term' env x.FStar_Syntax_Syntax.sort  in
                 match e.FStar_Parser_AST.tm with
                 | FStar_Parser_AST.Wild  ->
                     let uu____5684 =
                       let uu____5685 = bv_as_unique_ident x  in
                       FStar_Parser_AST.Variable uu____5685  in
                     FStar_Parser_AST.mk_binder uu____5684 r
                       FStar_Parser_AST.Type_level imp
                 | uu____5686 ->
                     let uu____5687 = FStar_Syntax_Syntax.is_null_bv x  in
                     if uu____5687
                     then
                       ...
                       (let uu____5689 =
                          let uu____5690 =
                            let uu____5695 = bv_as_unique_ident x  in
                            (uu____5695, e)  in
                          FStar_Parser_AST.Annotated uu____5690  in
                        FStar_Parser_AST.mk_binder uu____5689 r
                          FStar_Parser_AST.Type_level imp))
    ...
    fun v1  ->
      fun aqual  ->
        fun body_bv  ->
          fun typ_opt  ->
            let mk1 a =
              let uu____5715 = FStar_Syntax_Syntax.range_of_bv v1  in
              FStar_Parser_AST.mk_pattern a uu____5715  in
              ...
              let uu____5718 =
                ...
                then
                  let uu____5719 =
                    ...
                    (uu____5726, aqual)  in
                  FStar_Parser_AST.PatVar uu____5719
            ...
            | FStar_Pervasives_Native.Some
                { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_unknown ;
                  FStar_Syntax_Syntax.pos = uu____5732;
                  FStar_Syntax_Syntax.vars = uu____5733;_}
                -> pat
            | FStar_Pervasives_Native.Some typ ->
                let uu____5743 = FStar_Options.print_bound_var_types ()  in
                if uu____5743
                then
                  let uu____5744 =
                    let uu____5745 =
                      let uu____5756 =
                        let uu____5763 = resugar_term' env typ  in
                        (uu____5763, FStar_Pervasives_Native.None)  in
                      (pat, uu____5756)  in
                    FStar_Parser_AST.PatAscribed uu____5745  in
                  mk1 uu____5744
                else pat
...
and (resugar_bv_as_pat :
  ...
  fun env  ->
    fun x  ->
      fun qual  ->
        fun body_bv  ->
          let uu____5781 = resugar_arg_qual qual  in
            ...
            (fun aqual  ->
               let uu____5793 =
                 ...
                 FStar_All.pipe_left
                   ...
                   uu____5798
                  in
               resugar_bv_as_pat' env x aqual body_bv uu____5793)
    ...
    fun p  ->
      fun branch_bv  ->
        ...
        let may_drop_implicits args =
          (let uu____5861 = FStar_Options.print_implicits ()  in
                 ...
                 (fun uu____5874  ->
                    ...
                    | (pattern,is_implicit1) ->
                        let might_be_used =
                          ...
                          | FStar_Syntax_Syntax.Pat_dot_term (bv,uu____5890)
                              -> FStar_Util.set_mem bv branch_bv
                          | FStar_Syntax_Syntax.Pat_wild uu____5895 -> false
                          | uu____5896 -> true  in
                        is_implicit1 && might_be_used) args
                in
             Prims.op_Negation uu____5863)
           in
        ...
        let rec resugar_plain_pat_cons fv args =
          let args1 =
            let uu____5959 = may_drop_implicits args  in
            if uu____5959 then filter_pattern_imp args else args  in
          let args2 =
            FStar_List.map
              (fun uu____5979  ->
        ...
        and aux p1 imp_opt =
          ...
          | FStar_Syntax_Syntax.Pat_cons (fv,args) when
              ...
              ((let uu____6025 =
                  let uu____6026 =
                    let uu____6027 = filter_pattern_imp args  in
                    FStar_List.isEmpty uu____6027  in
                  Prims.op_Negation uu____6026  in
                if uu____6025
                then
          ...
          | FStar_Syntax_Syntax.Pat_cons (fv,args) when
              (FStar_Ident.lid_equals
                ...
                && (may_drop_implicits args)
              ->
              let uu____6063 = filter_pattern_imp args  in
          ...
          | FStar_Syntax_Syntax.Pat_cons
              ({ FStar_Syntax_Syntax.fv_name = uu____6184;
                 FStar_Syntax_Syntax.fv_delta = uu____6185;
              ...
              let fields1 =
                let uu____6212 =
                  FStar_All.pipe_right fields
                   ...
                   in
                FStar_All.pipe_right uu____6212 FStar_List.rev  in
              let args1 =
                let uu____6228 =
                  FStar_All.pipe_right args
                    (FStar_List.map
                   ...
                   in
                FStar_All.pipe_right uu____6228 FStar_List.rev  in
              let rec map21 l1 l2 =
                match (l1, l2) with
                | ([],[]) -> []
                | ([],hd1::tl1) -> []
                | (hd1::tl1,[]) ->
                    let uu____6320 = map21 tl1 []  in
                    (hd1, (mk1 FStar_Parser_AST.PatWild)) :: uu____6320
                | (hd1::tl1,hd2::tl2) ->
                    let uu____6343 = map21 tl1 tl2  in (hd1, hd2) ::
                      uu____6343
                 in
              let args2 =
                let uu____6361 = map21 fields1 args1  in
                FStar_All.pipe_right uu____6361 FStar_List.rev  in
          ...
          | FStar_Syntax_Syntax.Pat_var v1 ->
              ...
              (match uu____6403 with
               | FStar_Pervasives_Native.Some (op,uu____6413) ->
                   let uu____6424 =
                     let uu____6425 =
                       FStar_Ident.mk_ident
                         (op,
                        ...
                        in
                     FStar_Parser_AST.PatOp uu____6425  in
                   mk1 uu____6424
               | FStar_Pervasives_Native.None  ->
                   let uu____6432 = to_arg_qual imp_opt  in
                   resugar_bv_as_pat' env v1 uu____6432 branch_bv
                     FStar_Pervasives_Native.None)
          | FStar_Syntax_Syntax.Pat_wild uu____6437 ->
...
let (resugar_qualifier :
  ...
  fun uu___74_6452  ->
    ...
    | FStar_Syntax_Syntax.Reflectable uu____6461 ->
        FStar_Pervasives_Native.Some FStar_Parser_AST.Reflectable
    | FStar_Syntax_Syntax.Discriminator uu____6462 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Projector uu____6463 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordType uu____6468 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordConstructor uu____6477 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Action uu____6486 -> FStar_Pervasives_Native.None
    ...
    fun datacon_ses  ->
      fun se  ->
        ...
        | FStar_Syntax_Syntax.Sig_inductive_typ
            (tylid,uvs,bs,t,uu____6527,datacons) ->
            let uu____6537 =
                ...
                (FStar_List.partition
                   (fun se1  ->
                      ...
                      | FStar_Syntax_Syntax.Sig_datacon
                          (uu____6564,uu____6565,uu____6566,inductive_lid,uu____6568,uu____6569)
                          -> FStar_Ident.lid_equals inductive_lid tylid
                      | uu____6574 -> failwith "unexpected"))
               in
            (match uu____6537 with
             | (current_datacons,other_datacons) ->
                 let bs1 =
                   let uu____6593 = FStar_Options.print_implicits ()  in
                   if uu____6593 then bs else filter_imp bs  in
                 let bs2 =
                 ...
                 let tyc =
                   let uu____6607 =
                     FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                       (FStar_Util.for_some
                          (fun uu___76_6612  ->
                             match uu___76_6612 with
                             | FStar_Syntax_Syntax.RecordType uu____6613 ->
                                 true
                             | uu____6622 -> false))
                      in
                   if uu____6607
                   then
                     let resugar_datacon_as_fields fields se1 =
                       match se1.FStar_Syntax_Syntax.sigel with
                       | FStar_Syntax_Syntax.Sig_datacon
                           (uu____6674,univs1,term,uu____6677,num,uu____6679)
                           ->
                           let uu____6684 =
                             let uu____6685 =
                               FStar_Syntax_Subst.compress term  in
                             uu____6685.FStar_Syntax_Syntax.n  in
                           (match uu____6684 with
                            | FStar_Syntax_Syntax.Tm_arrow (bs3,uu____6699)
                                ->
                                let mfields =
                                          ...
                                          | (b,qual) ->
                                              ...
                                              let uu____6777 =
                                                resugar_term' env
                                                 ...
                                                 in
                                              (uu____6775, uu____6777,
                                                FStar_Pervasives_Native.None)))
                                   in
                                FStar_List.append mfields fields
                            | uu____6788 -> failwith "unexpected")
                       | uu____6799 -> failwith "unexpected"  in
                     let fields =
                     ...
                     (let resugar_datacon constructors se1 =
                        match se1.FStar_Syntax_Syntax.sigel with
                        | FStar_Syntax_Syntax.Sig_datacon
                            (l,univs1,term,uu____6924,num,uu____6926) ->
                            let c =
                              let uu____6944 =
                                let uu____6947 = resugar_term' env term  in
                                FStar_Pervasives_Native.Some uu____6947  in
                              ((l.FStar_Ident.ident), uu____6944,
                                FStar_Pervasives_Native.None, false)
                               in
                            c :: constructors
                        | uu____6964 -> failwith "unexpected"  in
                      let constructors =
...
let (mk_decl :
  ...
  fun r  ->
    fun q  ->
      fun d'  ->
        let uu____7062 = FStar_List.choose resugar_qualifier q  in
        {
          FStar_Parser_AST.d = d';
          FStar_Parser_AST.drange = r;
          FStar_Parser_AST.doc = FStar_Pervasives_Native.None;
          FStar_Parser_AST.quals = uu____7062;
              ...
              let uu____7101 =
                let uu____7114 =
                  let uu____7123 =
                    let uu____7130 =
                      let uu____7131 =
                        let uu____7144 = resugar_term' env typ  in
                        (name1, [], FStar_Pervasives_Native.None, uu____7144)
                         in
                      FStar_Parser_AST.TyconAbbrev uu____7131  in
                    (uu____7130, FStar_Pervasives_Native.None)  in
                  [uu____7123]  in
                (false, uu____7114)  in
              FStar_Parser_AST.Tycon uu____7101  in
            mk_decl typ.FStar_Syntax_Syntax.pos [] uu____7100
      ...
      fun r  ->
        fun q  ->
          fun ed  ->
            let resugar_action d for_free1 =
              ...
              | (bs,action_defn) ->
                  ...
                  (match uu____7229 with
                   | (bs1,action_typ) ->
                       let action_params1 =
                         let uu____7239 = FStar_Options.print_implicits ()
                            in
                         if uu____7239
                         then action_params
                         ...
                         let a =
                           let uu____7262 =
                             ...
                             (uu____7273,
                              ...
                              in
                           FStar_Parser_AST.Construct uu____7262  in
                         let t =
            ...
            | (eff_binders,eff_typ) ->
                let eff_binders1 =
                  let uu____7357 = FStar_Options.print_implicits ()  in
                  if uu____7357 then eff_binders else filter_imp eff_binders
                   in
                let eff_binders2 =
                  let uu____7364 =
                    FStar_All.pipe_right eff_binders1
                     ...
                     in
                  FStar_All.pipe_right uu____7364 FStar_List.rev  in
...
let (resugar_sigelt' :
  ...
  fun env  ->
    fun se  ->
      match se.FStar_Syntax_Syntax.sigel with
      | FStar_Syntax_Syntax.Sig_bundle (ses,uu____7432) ->
          let uu____7441 =
              ...
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | FStar_Syntax_Syntax.Sig_inductive_typ uu____7463 ->
                        true
                    | FStar_Syntax_Syntax.Sig_declare_typ uu____7480 -> true
                    | FStar_Syntax_Syntax.Sig_datacon uu____7487 -> false
                    | uu____7502 ->
                        failwith
          ...
          (match uu____7441 with
           | (decl_typ_ses,datacon_ses) ->
               let retrieve_datacons_and_resugar uu____7538 se1 =
                 match uu____7538 with
                 | (datacon_ses1,tycons) ->
                     let uu____7564 = resugar_typ env datacon_ses1 se1  in
               ...
               (match uu____7579 with
                | (leftover_datacons,tycons) ->
                    (match leftover_datacons with
                             ...
                             let uu____7616 =
                               let uu____7629 =
                                 FStar_List.map
                                  ...
                                  in
                               (false, uu____7629)  in
                             FStar_Parser_AST.Tycon uu____7616  in
                           decl'_to_decl se uu____7615  in
                         FStar_Pervasives_Native.Some uu____7614
                     | se1::[] ->
                         (match se1.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_datacon
                              (l,uu____7660,uu____7661,uu____7662,uu____7663,uu____7664)
                              ->
                              let uu____7669 =
                                decl'_to_decl se1
                     ...
                     | uu____7675 -> failwith "Should not happen hopefully")))
      | FStar_Syntax_Syntax.Sig_let (lbs,uu____7681) ->
          let uu____7686 =
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
              (FStar_Util.for_some
                 (fun uu___77_7692  ->
                    match uu___77_7692 with
                    | FStar_Syntax_Syntax.Projector (uu____7693,uu____7694)
                        -> true
          ...
          then FStar_Pervasives_Native.None
            ...
            (let mk1 e =
             ...
             | FStar_Parser_AST.Let (isrec,lets,uu____7727) ->
                 let uu____7756 =
                   let uu____7757 =
                     let uu____7758 =
                       let uu____7769 =
                       ...
                       (isrec, uu____7769)  in
                     FStar_Parser_AST.TopLevelLet uu____7758  in
                   decl'_to_decl se uu____7757  in
                 FStar_Pervasives_Native.Some uu____7756
             | uu____7806 -> failwith "Should not happen hopefully")
      | FStar_Syntax_Syntax.Sig_assume (lid,uu____7810,fml) ->
          let uu____7812 =
            let uu____7813 =
              let uu____7814 =
                let uu____7819 = resugar_term' env fml  in
                ((lid.FStar_Ident.ident), uu____7819)  in
              FStar_Parser_AST.Assume uu____7814  in
            decl'_to_decl se uu____7813  in
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect e ->
          ...
          let lift_wp =
            ...
            | FStar_Pervasives_Native.Some (uu____7832,t) ->
                let uu____7842 = resugar_term' env t  in
                FStar_Pervasives_Native.Some uu____7842
            | uu____7843 -> FStar_Pervasives_Native.None  in
          let lift =
            match e.FStar_Syntax_Syntax.lift with
            | FStar_Pervasives_Native.Some (uu____7851,t) ->
                let uu____7861 = resugar_term' env t  in
          ...
          let op =
            ...
            | uu____7886 -> failwith "Should not happen hopefully"  in
          let uu____7895 =
            decl'_to_decl se
      ...
      | FStar_Syntax_Syntax.Sig_effect_abbrev (lid,vs,bs,c,flags1) ->
          let uu____7905 = FStar_Syntax_Subst.open_comp bs c  in
          (match uu____7905 with
           | (bs1,c1) ->
               let bs2 =
                 let uu____7917 = FStar_Options.print_implicits ()  in
                 if uu____7917 then bs1 else filter_imp bs1  in
               let bs3 =
                   ...
                   let uu____7932 =
                     let uu____7945 =
                       let uu____7954 =
                         let uu____7961 =
                           let uu____7962 =
                             let uu____7975 = resugar_comp' env c1  in
                             ((lid.FStar_Ident.ident), bs3,
                               FStar_Pervasives_Native.None, uu____7975)
                              in
                           FStar_Parser_AST.TyconAbbrev uu____7962  in
                         (uu____7961, FStar_Pervasives_Native.None)  in
                       [uu____7954]  in
                     (false, uu____7945)  in
                   FStar_Parser_AST.Tycon uu____7932  in
                 decl'_to_decl se uu____7931  in
      ...
      | FStar_Syntax_Syntax.Sig_declare_typ (lid,uvs,t) ->
          let uu____8007 =
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
              (FStar_Util.for_some
                 (fun uu___78_8013  ->
                    match uu___78_8013 with
                    | FStar_Syntax_Syntax.Projector (uu____8014,uu____8015)
                        -> true
                    | FStar_Syntax_Syntax.Discriminator uu____8016 -> true
                    | uu____8017 -> false))
             in
          if uu____8007
          then FStar_Pervasives_Native.None
            ...
            (let t' =
               let uu____8022 =
                 (let uu____8025 = FStar_Options.print_universes ()  in
                  Prims.op_Negation uu____8025) || (FStar_List.isEmpty uvs)
                  in
               if uu____8022
               then resugar_term' env t
               else
                 (let uu____8027 = FStar_Syntax_Subst.open_univ_vars uvs t
                     in
                  match uu____8027 with
                  | (uvs1,t1) ->
                      let universes = universe_to_string uvs1  in
                      let uu____8035 = resugar_term' env t1  in
                      label universes uu____8035)
                in
             let uu____8036 =
               decl'_to_decl se
                 (FStar_Parser_AST.Val ((lid.FStar_Ident.ident), t'))
                in
             FStar_Pervasives_Native.Some uu____8036)
          ...
          let uu____8043 =
            let uu____8044 =
              let uu____8045 =
                ...
                let uu____8057 = resugar_term' env t  in
                (uu____8052, uu____8057)  in
              FStar_Parser_AST.Splice uu____8045  in
            decl'_to_decl se uu____8044  in
          FStar_Pervasives_Native.Some uu____8043
      | FStar_Syntax_Syntax.Sig_inductive_typ uu____8060 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Sig_datacon uu____8077 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Sig_main uu____8092 ->
          FStar_Pervasives_Native.None
  
let (empty_env : FStar_Syntax_DsEnv.env) = FStar_Syntax_DsEnv.empty_env () 
let noenv : 'a . (FStar_Syntax_DsEnv.env -> 'a) -> 'a = fun f  -> f empty_env 
let (resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term) =
  fun t  -> let uu____8113 = noenv resugar_term'  in uu____8113 t 
let (resugar_sigelt :
  FStar_Syntax_Syntax.sigelt ->
    FStar_Parser_AST.decl FStar_Pervasives_Native.option)
  = fun se  -> let uu____8130 = noenv resugar_sigelt'  in uu____8130 se 
let (resugar_comp : FStar_Syntax_Syntax.comp -> FStar_Parser_AST.term) =
  fun c  -> let uu____8147 = noenv resugar_comp'  in uu____8147 c 
let (resugar_pat :
  FStar_Syntax_Syntax.pat ->
    FStar_Syntax_Syntax.bv FStar_Util.set -> FStar_Parser_AST.pattern)
  =
  fun p  ->
    fun branch_bv  ->
      let uu____8169 = noenv resugar_pat'  in uu____8169 p branch_bv
...
let (resugar_binder :
  ...
  =
  fun b  ->
    fun r  -> let uu____8202 = noenv resugar_binder'  in uu____8202 b r
  
let (resugar_tscheme : FStar_Syntax_Syntax.tscheme -> FStar_Parser_AST.decl)
  = fun ts  -> let uu____8226 = noenv resugar_tscheme'  in uu____8226 ts 
let (resugar_eff_decl :
  Prims.bool ->
    FStar_Range.range ->
      FStar_Syntax_Syntax.qualifier Prims.list ->
  ...
  fun for_free  ->
    fun r  ->
      fun q  ->
        fun ed  ->
          let uu____8258 = noenv resugar_eff_decl'  in
          uu____8258 for_free r q ed
