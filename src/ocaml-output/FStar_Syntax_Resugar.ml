...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_bvar x ->
        let l =
          let uu____980 =
            let uu____983 = bv_as_unique_ident x  in [uu____983]  in
          FStar_Ident.lid_of_ids uu____980  in
        mk1 (FStar_Parser_AST.Var l)
    | FStar_Syntax_Syntax.Tm_name x ->
        let l =
          let uu____986 =
            let uu____989 = bv_as_unique_ident x  in [uu____989]  in
    ...
    | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
        ...
        (match uu____1156 with
         | (xs1,body1) ->
             ...
             let rec aux body3 uu___189_1189 =
               match uu___189_1189 with
               | [] -> body3
               | hd1::tl1 ->
    ...
    | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
        let uu____1205 =
          let uu____1210 =
            let uu____1211 = FStar_Syntax_Syntax.mk_binder x  in [uu____1211]
             in
    ...
    | FStar_Syntax_Syntax.Tm_app (e,args) ->
        let rec last1 uu___190_1271 =
          match uu___190_1271 with
          | hd1::[] -> [hd1]
          | hd1::tl1 -> last1 tl1
          | uu____1341 -> failwith "last of an empty list"  in
        let rec last_two uu___191_1377 =
          match uu___191_1377 with
          | [] ->
              failwith
        ...
        let rec last_three uu___192_1526 =
          match uu___192_1526 with
          | [] ->
              failwith
                               ...
                               let uu____1943 =
                                 let uu____1950 =
                                   let uu____1953 =
                                     ...
                                     [uu____1956]  in
                                   e1 :: uu____1953  in
                                 ((FStar_Ident.id_of_text "*"), uu____1950)
                                  in
              ...
              | (body,handler) ->
                  let decomp term =
                    ...
                    | uu____2282 ->
                     ...
                     in
                  let body1 =
                    let uu____2284 = decomp body  in resugar_term uu____2284
                     in
                  let handler1 =
         ...
         | FStar_Pervasives_Native.Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____2923  ->
                       match uu____2923 with | (e1,qual) -> resugar_term e1))
                in
             (match arity with
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____3395) ->
        ...
        let uu____3462 =
          let uu____3463 =
            let uu____3472 = resugar_term e  in (uu____3472, term, tac_opt1)
             in
             ...
             let resugar_one_binding bnd =
               let uu____3521 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd.FStar_Syntax_Syntax.lbunivs uu____3526
                  in
                              ...
                              (match uu____3672 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____3686 then b1 else filter_imp b1
                                      in
                                   (b2, t2, true))
    ...
    | FStar_Syntax_Syntax.Tm_meta (e,m) ->
        let resugar_meta_desugared uu___194_3974 =
          match uu___194_3974 with
                   ...
                   let universes1 =
                     FStar_List.map
                       (fun u  ->
                          ...
                          (uu____4356, FStar_Parser_AST.UnivApp)) universes
                      in
                   let args1 =
                     FStar_List.map
                       (fun uu____4379  ->
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____4492 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____4529 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
    ...
    | FStar_Syntax_Syntax.Comp c1 ->
        ...
        then
          ...
          let args =
            ...
            then
              let rec aux l uu___195_4900 =
                match uu___195_4900 with
                | [] -> l
                | (t,aq)::tl1 ->
            ...
            FStar_List.map
              (fun uu____5003  ->
                 ...
                 | (e,uu____5013) ->
                     ...
                     (uu____5014, FStar_Parser_AST.Nothing)) args
             in
          let rec aux l uu___196_5035 =
            match uu___196_5035 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____5512 = map21 tl1 tl2  in (hd1, hd2) :: uu____5512
             in
          let args2 =
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____5769 -> failwith "unexpected"))
             in
                ...
                let uu____6292 =
                  let uu____6299 =
                    let uu____6300 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____6313)
                       in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____6499 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____6504 =
                       ...
                       let uu____7018 =
                         let uu____7019 =
                           ...
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____7032)
                            in
          ...
          (let t' =
             let uu____7079 =
               (let uu____7082 = FStar_Options.print_universes ()  in
                Prims.op_Negation uu____7082) || (FStar_List.isEmpty uvs)
                in
             if uu____7079
             then resugar_term t
             else
