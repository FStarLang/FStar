                ...
                | (leftover_datacons, tycons) ->
                    (match leftover_datacons with
                     ...
                     | se1::[] ->
                         (match se1.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_datacon
                              (l, uu____8894, uu____8895, uu____8896,
                         ...
                         let uu____9219 =
                           let uu____9220 =
                             ...
                             ((lid.FStar_Ident.ident), bs3,
                               FStar_Pervasives_Native.None, uu____9233) in
            ...
            (let t' =
               let uu____9292 =
                 (let uu____9296 = FStar_Options.print_universes () in
                  Prims.op_Negation uu____9296) || (FStar_List.isEmpty uvs) in
               if uu____9292
               then resugar_term' env t
               else
                 (let uu____9301 = FStar_Syntax_Subst.open_univ_vars uvs t in
                  match uu____9301 with
                  | (uvs1, t1) ->
                      let universes = universe_to_string uvs1 in
                      let uu____9310 = resugar_term' env t1 in
                      label universes uu____9310) in
             let uu____9311 =
               decl'_to_decl se
...
let (resugar_binder :
  FStar_Syntax_Syntax.binder ->
    FStar_Range.range ->
      FStar_Parser_AST.binder FStar_Pervasives_Native.option)
  =
  fun b -> fun r -> let uu____9485 = noenv resugar_binder' in uu____9485 b r
