...
let filter_imp : 'Auu____45 . ('Auu____45 * FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option) Prims.list  ->  ('Auu____45 * FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option) Prims.list = (fun a -> (FStar_All.pipe_right a (FStar_List.filter (fun uu___193_99 -> (match (uu___193_99) with
...
let name_of_op = (fun uu___194_356 -> (match (uu___194_356) with
| "Amp" -> begin
...
let rec aux = (fun body3 uu___195_1192 -> (match (uu___195_1192) with
| [] -> begin
body3
end
| (hd1)::tl1 -> begin
...
let rec last1 = (fun uu___196_1274 -> (match (uu___196_1274) with
| (hd1)::[] -> begin
(hd1)::[]
end
| (hd1)::tl1 -> begin
...
let rec last_two = (fun uu___197_1380 -> (match (uu___197_1380) with
| [] -> begin
...
let rec last_three = (fun uu___198_1529 -> (match (uu___198_1529) with
| [] -> begin
...
| _0_40 when ((_0_40 = (Prims.parse_int "1")) && ((FStar_List.length args1) > (Prims.parse_int "0"))) -> begin
(
...
| _0_41 when ((_0_41 = (Prims.parse_int "2")) && ((FStar_List.length args1) > (Prims.parse_int "1"))) -> begin
(
...
| _0_42 when ((_0_42 = (Prims.parse_int "3")) && ((FStar_List.length args1) > (Prims.parse_int "2"))) -> begin
(
...
| _0_43 when ((_0_43 = (Prims.parse_int "2")) && ((FStar_List.length args1) > (Prims.parse_int "1"))) -> begin
(
...
| uu____3913 -> begin
(fun uu___199_3914 -> (match (uu___199_3914) with
...
let resugar_meta_desugared = (fun uu___200_3993 -> (match (uu___200_3993) with
...
let uu____4239 = (FStar_All.try_with (fun uu___208_4274 -> (match (()) with
| () -> begin
(

let uu____4291 = (FStar_Syntax_Util.unmeta e)
in (head_fv_universes_args uu____4291))
end)) (fun uu___207_4295 -> (match (uu___207_4295) with
...
let uu____4981 = (FStar_Syntax_Util.unthunk_lemma_post (FStar_Pervasives_Native.fst post))
in ((uu____4981), ((FStar_Pervasives_Native.snd post))))
in (

let uu____4990 = (

let uu____4999 = (FStar_Syntax_Util.is_fvar FStar_Parser_Const.true_lid (FStar_Pervasives_Native.fst pre))
...
let uu____5047 = (FStar_Syntax_Util.is_fvar FStar_Parser_Const.nil_lid (FStar_Pervasives_Native.fst pats))
...
in (FStar_List.append ((post1)::[]) uu____5038))
in (FStar_List.append uu____4990 uu____5029))))
end
| uu____5101 -> begin
...
let args1 = (FStar_List.map (fun uu____5130 -> (match (uu____5130) with
| (e, uu____5140) -> begin
(

let uu____5141 = (resugar_term e)
in ((uu____5141), (FStar_Parser_AST.Nothing)))
end)) args)
in (

let rec aux = (fun l uu___201_5162 -> (match (uu___201_5162) with
| [] -> begin
l
end
| (hd1)::tl1 -> begin
...
let uu____5195 = (resugar_term e)
in ((uu____5195), (FStar_Parser_AST.Nothing)))
in (aux ((e1)::l) tl1))
end
| uu____5200 -> begin
(aux l tl1)
...
let uu____5250 = (resugar_arg_qual aq)
in (FStar_Util.map_opt uu____5250 (fun imp -> (
...
let uu____5265 = (bv_as_unique_ident x)
in FStar_Parser_AST.Variable (uu____5265))
in (FStar_Parser_AST.mk_binder uu____5264 r FStar_Parser_AST.Type_level imp))
end
| uu____5266 -> begin
(

let uu____5267 = (FStar_Syntax_Syntax.is_null_bv x)
...
let uu____5275 = (bv_as_unique_ident x)
in ((uu____5275), (e)))
in FStar_Parser_AST.Annotated (uu____5270))
in (FStar_Parser_AST.mk_binder uu____5269 r FStar_Parser_AST.Type_level imp))
end))
end)))))
end)))
...
let uu____5284 = (FStar_Syntax_Syntax.range_of_bv x)
in (FStar_Parser_AST.mk_pattern a uu____5284)))
in (

let uu____5285 = (

let uu____5286 = (FStar_Syntax_Subst.compress x.FStar_Syntax_Syntax.sort)
...
let uu____5294 = (mk1 FStar_Parser_AST.PatWild)
in FStar_Pervasives_Native.Some (uu____5294))
end
| uu____5295 -> begin
(

let uu____5296 = (resugar_arg_qual qual)
in (FStar_Util.bind_opt uu____5296 (fun aq -> (
...
let uu____5317 = (bv_as_unique_ident x)
in ((uu____5317), (aq)))
in FStar_Parser_AST.PatVar (uu____5310))
in (mk1 uu____5309))
in FStar_Pervasives_Native.Some (uu____5308)))))
end))
end
| uu____5320 -> begin
(

let uu____5321 = (resugar_arg_qual qual)
in (FStar_Util.bind_opt uu____5321 (fun aq -> (
...
let uu____5344 = (bv_as_unique_ident x)
in ((uu____5344), (aq)))
in FStar_Parser_AST.PatVar (uu____5337))
in (mk1 uu____5336))
in (

let uu____5347 = (FStar_Options.print_bound_var_types ())
...
let uu____5357 = (resugar_term x.FStar_Syntax_Syntax.sort)
in ((pat), (uu____5357)))
in FStar_Parser_AST.PatAscribed (uu____5352))
in (mk1 uu____5351))
in FStar_Pervasives_Native.Some (uu____5350))
end
| uu____5358 -> begin
...
let args1 = (FStar_List.map (fun uu____5434 -> (match (uu____5434) with
| (p2, b) -> begin
...
let args1 = (FStar_List.map (fun uu____5469 -> (match (uu____5469) with
| (p2, b) -> begin
(aux p2 (FStar_Pervasives_Native.Some (b)))
end)) args)
in (

let uu____5476 = (FStar_Parser_Const.is_dtuple_data_lid' fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
...
| FStar_Syntax_Syntax.Pat_cons ({FStar_Syntax_Syntax.fv_name = uu____5482; FStar_Syntax_Syntax.fv_delta = uu____5483; FStar_Syntax_Syntax.fv_qual = FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Record_ctor (name, fields))}, args) -> begin
(

let fields1 = (

let uu____5510 = (FStar_All.pipe_right fields (FStar_List.map (fun f -> (FStar_Ident.lid_of_ids ((f)::[])))))
in (FStar_All.pipe_right uu____5510 FStar_List.rev))
in (

let args1 = (

let uu____5526 = (FStar_All.pipe_right args (FStar_List.map (fun uu____5546 -> (match (uu____5546) with
| (p2, b) -> begin
(aux p2 (FStar_Pervasives_Native.Some (b)))
end))))
in (FStar_All.pipe_right uu____5526 FStar_List.rev))
in (
...
let uu____5616 = (map21 tl1 [])
in (((hd1), ((mk1 FStar_Parser_AST.PatWild))))::uu____5616)
end
| ((hd1)::tl1, (hd2)::tl2) -> begin
(

let uu____5639 = (map21 tl1 tl2)
in (((hd1), (hd2)))::uu____5639)
end))
in (

let args2 = (

let uu____5657 = (map21 fields1 args1)
in (FStar_All.pipe_right uu____5657 FStar_List.rev))
in (mk1 (FStar_Parser_AST.PatRecord (args2)))))))
end
| FStar_Syntax_Syntax.Pat_cons (fv, args) -> begin
(

let args1 = (FStar_List.map (fun uu____5708 -> (match (uu____5708) with
| (p2, b) -> begin
(aux p2 (FStar_Pervasives_Native.Some (b)))
end)) args)
...
let uu____5718 = (string_to_op v1.FStar_Syntax_Syntax.ppname.FStar_Ident.idText)
in (match (uu____5718) with
| FStar_Pervasives_Native.Some (op, uu____5726) -> begin
...
let uu____5743 = (bv_as_unique_ident v1)
in (

let uu____5744 = (to_arg_qual imp_opt)
in ((uu____5743), (uu____5744))))
in FStar_Parser_AST.PatVar (uu____5736))
in (mk1 uu____5735))
end))
end
| FStar_Syntax_Syntax.Pat_wild (uu____5749) -> begin
...
let uu____5765 = (bv_as_unique_ident bv)
in ((uu____5765), (FStar_Pervasives_Native.Some (FStar_Parser_AST.Implicit))))
in FStar_Parser_AST.PatVar (uu____5758))
in (mk1 uu____5757))
in (

let uu____5768 = (FStar_Options.print_bound_var_types ())
...
let uu____5775 = (resugar_term term)
in ((pat), (uu____5775)))
in FStar_Parser_AST.PatAscribed (uu____5770))
in (mk1 uu____5769))
end
| uu____5776 -> begin
pat
...
let resugar_qualifier : FStar_Syntax_Syntax.qualifier  ->  FStar_Parser_AST.qualifier FStar_Pervasives_Native.option = (fun uu___202_5782 -> (match (uu___202_5782) with
...
| FStar_Syntax_Syntax.Reflectable (uu____5791) -> begin
FStar_Pervasives_Native.Some (FStar_Parser_AST.Reflectable)
end
| FStar_Syntax_Syntax.Discriminator (uu____5792) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Projector (uu____5793) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.RecordType (uu____5798) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.RecordConstructor (uu____5807) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Action (uu____5816) -> begin
FStar_Pervasives_Native.None
end
...
let resugar_pragma : FStar_Syntax_Syntax.pragma  ->  FStar_Parser_AST.pragma = (fun uu___203_5820 -> (match (uu___203_5820) with
...
| FStar_Syntax_Syntax.Sig_inductive_typ (tylid, uvs, bs, t, uu____5849, datacons) -> begin
(

let uu____5859 = (FStar_All.pipe_right datacon_ses (FStar_List.partition (fun se1 -> (match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (uu____5886, uu____5887, uu____5888, inductive_lid, uu____5890, uu____5891) -> begin
...
let uu____5915 = (FStar_Options.print_implicits ())
...
let uu____5925 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___204_5930 -> (match (uu___204_5930) with
| FStar_Syntax_Syntax.RecordType (uu____5931) -> begin
true
end
| uu____5940 -> begin
false
...
| FStar_Syntax_Syntax.Sig_datacon (uu____5988, univs1, term, uu____5991, num, uu____5993) -> begin
(

let uu____5998 = (

let uu____5999 = (FStar_Syntax_Subst.compress term)
in uu____5999.FStar_Syntax_Syntax.n)
in (match (uu____5998) with
| FStar_Syntax_Syntax.Tm_arrow (bs3, uu____6013) -> begin
(

let mfields = (FStar_All.pipe_right bs3 (FStar_List.map (fun uu____6074 -> (match (uu____6074) with
| (b, qual) -> begin
(

let uu____6089 = (

let uu____6090 = (bv_as_unique_ident b)
in (FStar_Syntax_Util.unmangle_field_name uu____6090))
in (

let uu____6091 = (resugar_term b.FStar_Syntax_Syntax.sort)
in ((uu____6089), (uu____6091), (FStar_Pervasives_Native.None))))
end))))
...
| FStar_Syntax_Syntax.Sig_datacon (l, univs1, term, uu____6234, num, uu____6236) -> begin
(
...
let uu____6257 = (resugar_term term)
in FStar_Pervasives_Native.Some (uu____6257))
in ((l.FStar_Ident.ident), (uu____6254), (FStar_Pervasives_Native.None), (false)))
in (c)::constructors)
end
| uu____6274 -> begin
(failwith "unexpected")
...
let uu____6371 = (FStar_List.choose resugar_qualifier q)
in {FStar_Parser_AST.d = d'; FStar_Parser_AST.drange = r; FStar_Parser_AST.doc = FStar_Pervasives_Native.None; FStar_Parser_AST.quals = uu____6371; FStar_Parser_AST.attrs = []}))
...
let uu____6440 = (resugar_term typ)
in ((name1), ([]), (FStar_Pervasives_Native.None), (uu____6440)))
in FStar_Parser_AST.TyconAbbrev (uu____6427))
in ((uu____6426), (FStar_Pervasives_Native.None)))
in (uu____6419)::[])
in ((false), (uu____6410)))
in FStar_Parser_AST.Tycon (uu____6397))
in (mk_decl typ.FStar_Syntax_Syntax.pos [] uu____6396)))
end)))


let resugar_tscheme : FStar_Syntax_Syntax.tscheme  ->  FStar_Parser_AST.decl = (fun ts -> (resugar_tscheme' "tscheme" ts))
...
let uu____6499 = (FStar_Syntax_Subst.open_term action_params d.FStar_Syntax_Syntax.action_defn)
in (match (uu____6499) with
| (bs, action_defn) -> begin
(

let uu____6506 = (FStar_Syntax_Subst.open_term action_params d.FStar_Syntax_Syntax.action_typ)
...
let uu____6514 = (FStar_Options.print_implicits ())
...
let uu____6519 = (FStar_All.pipe_right action_params1 ((map_opt ()) (fun b -> (resugar_binder b r))))
in (FStar_All.pipe_right uu____6519 FStar_List.rev))
in (
...
let uu____6544 = (FStar_Ident.lid_of_str "construct")
in ((uu____6544), ((((action_defn1), (FStar_Parser_AST.Nothing)))::(((action_typ1), (FStar_Parser_AST.Nothing)))::[])))
in FStar_Parser_AST.Construct (uu____6533))
in (
...
let uu____6618 = (FStar_Syntax_Subst.open_term ed.FStar_Syntax_Syntax.binders ed.FStar_Syntax_Syntax.signature)
...
let uu____6626 = (FStar_Options.print_implicits ())
...
let uu____6631 = (FStar_All.pipe_right eff_binders1 ((map_opt ()) (fun b -> (resugar_binder b r))))
in (FStar_All.pipe_right uu____6631 FStar_List.rev))
in (
...
| FStar_Syntax_Syntax.Sig_bundle (ses, uu____6689) -> begin
(

let uu____6698 = (FStar_All.pipe_right ses (FStar_List.partition (fun se1 -> (match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____6720) -> begin
true
end
| FStar_Syntax_Syntax.Sig_declare_typ (uu____6737) -> begin
true
end
| FStar_Syntax_Syntax.Sig_datacon (uu____6744) -> begin
false
end
| uu____6759 -> begin
...
let retrieve_datacons_and_resugar = (fun uu____6791 se1 -> (match (uu____6791) with
| (datacon_ses1, tycons) -> begin
(

let uu____6817 = (resugar_typ datacon_ses1 se1)
...
let uu____6832 = (FStar_List.fold_left retrieve_datacons_and_resugar ((datacon_ses), ([])) decl_typ_ses)
...
let uu____6882 = (FStar_List.map (fun tyc -> ((tyc), (FStar_Pervasives_Native.None))) tycons)
in ((false), (uu____6882)))
in FStar_Parser_AST.Tycon (uu____6869))
in (decl'_to_decl se uu____6868))
in FStar_Pervasives_Native.Some (uu____6867))
end
| (se1)::[] -> begin
(match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (l, uu____6913, uu____6914, uu____6915, uu____6916, uu____6917) -> begin
(

let uu____6922 = (decl'_to_decl se1 (FStar_Parser_AST.Exception (((l.FStar_Ident.ident), (FStar_Pervasives_Native.None)))))
in FStar_Pervasives_Native.Some (uu____6922))
end
| uu____6925 -> begin
...
| FStar_Syntax_Syntax.Sig_let (lbs, uu____6934) -> begin
(

let uu____6939 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___205_6945 -> (match (uu___205_6945) with
| FStar_Syntax_Syntax.Projector (uu____6946, uu____6947) -> begin
true
end
| FStar_Syntax_Syntax.Discriminator (uu____6948) -> begin
true
end
| uu____6949 -> begin
false
...
| FStar_Parser_AST.Let (isrec, lets, uu____6972) -> begin
(

let uu____6985 = (decl'_to_decl se (FStar_Parser_AST.TopLevelLet (((isrec), (lets)))))
in FStar_Pervasives_Native.Some (uu____6985))
end
| uu____6992 -> begin
(failwith "Should not happen hopefully")
end)))))
...
| FStar_Syntax_Syntax.Sig_assume (lid, uu____6996, fml) -> begin
(
...
let uu____7005 = (resugar_term fml)
in ((lid.FStar_Ident.ident), (uu____7005)))
in FStar_Parser_AST.Assume (uu____7000))
in (decl'_to_decl se uu____6999))
in FStar_Pervasives_Native.Some (uu____6998))
end
| FStar_Syntax_Syntax.Sig_new_effect (ed) -> begin
(

let uu____7007 = (resugar_eff_decl false se.FStar_Syntax_Syntax.sigrng se.FStar_Syntax_Syntax.sigquals ed)
in FStar_Pervasives_Native.Some (uu____7007))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ed) -> begin
(

let uu____7009 = (resugar_eff_decl true se.FStar_Syntax_Syntax.sigrng se.FStar_Syntax_Syntax.sigquals ed)
in FStar_Pervasives_Native.Some (uu____7009))
end
...
| FStar_Pervasives_Native.Some (uu____7018, t) -> begin
(

let uu____7030 = (resugar_term t)
in FStar_Pervasives_Native.Some (uu____7030))
end
| uu____7031 -> begin
FStar_Pervasives_Native.None
end)
...
| FStar_Pervasives_Native.Some (uu____7039, t) -> begin
(

let uu____7051 = (resugar_term t)
...
let uu____7085 = (decl'_to_decl se (FStar_Parser_AST.SubEffect ({FStar_Parser_AST.msource = src; FStar_Parser_AST.mdest = dst; FStar_Parser_AST.lift_op = op})))
in FStar_Pervasives_Native.Some (uu____7085)))))))
end
| FStar_Syntax_Syntax.Sig_effect_abbrev (lid, vs, bs, c, flags) -> begin
(

let uu____7095 = (FStar_Syntax_Subst.open_comp bs c)
...
let uu____7105 = (FStar_Options.print_implicits ())
...
let uu____7159 = (resugar_comp c1)
in ((lid.FStar_Ident.ident), (bs3), (FStar_Pervasives_Native.None), (uu____7159)))
in FStar_Parser_AST.TyconAbbrev (uu____7146))
in ((uu____7145), (FStar_Pervasives_Native.None)))
in (uu____7138)::[])
in ((false), (uu____7129)))
in FStar_Parser_AST.Tycon (uu____7116))
in (decl'_to_decl se uu____7115))
in FStar_Pervasives_Native.Some (uu____7114))))
end))
end
| FStar_Syntax_Syntax.Sig_pragma (p) -> begin
(

let uu____7187 = (decl'_to_decl se (FStar_Parser_AST.Pragma ((resugar_pragma p))))
in FStar_Pervasives_Native.Some (uu____7187))
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uvs, t) -> begin
(

let uu____7191 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___206_7197 -> (match (uu___206_7197) with
| FStar_Syntax_Syntax.Projector (uu____7198, uu____7199) -> begin
true
end
| FStar_Syntax_Syntax.Discriminator (uu____7200) -> begin
true
end
| uu____7201 -> begin
false
...
let uu____7209 = (FStar_Options.print_universes ())
in (not (uu____7209))) || (FStar_List.isEmpty uvs))
...
let uu____7211 = (FStar_Syntax_Subst.open_univ_vars uvs t)
...
let uu____7219 = (resugar_term t1)
in (label universes uu____7219)))
end))
end))
in (

let uu____7220 = (decl'_to_decl se (FStar_Parser_AST.Val (((lid.FStar_Ident.ident), (t')))))
in FStar_Pervasives_Native.Some (uu____7220)))
end))
end
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____7221) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Sig_datacon (uu____7238) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Sig_main (uu____7253) -> begin
FStar_Pervasives_Native.None
end))
