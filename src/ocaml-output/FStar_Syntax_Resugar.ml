...
let filter_imp : 'Auu____57 . ('Auu____57 * FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option) Prims.list  ->  ('Auu____57 * FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option) Prims.list = (fun a -> (FStar_All.pipe_right a (FStar_List.filter (fun uu___199_112 -> (match (uu___199_112) with
| (uu____119, FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Meta (t))) when (FStar_Syntax_Util.is_fvar FStar_Parser_Const.tcresolve_lid t) -> begin
true
end
| (uu____125, FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (uu____126))) -> begin
false
end
| (uu____129, FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Meta (uu____130))) -> begin
false
end
| uu____135 -> begin
true
...
let filter_pattern_imp : 'Auu____146 . ('Auu____146 * Prims.bool) Prims.list  ->  ('Auu____146 * Prims.bool) Prims.list = (fun xs -> (FStar_List.filter (fun uu____177 -> (match (uu____177) with
| (uu____182, is_implicit1) -> begin
(not (is_implicit1))
end)) xs))
...
let uu____224 = (FStar_Options.print_universes ())
in (match (uu____224) with
| true -> begin
(

let uu____225 = (FStar_List.map (fun x -> x.FStar_Ident.idText) univs1)
in (FStar_All.pipe_right uu____225 (FStar_String.concat ", ")))
end
| uu____232 -> begin
""
end)))
...
| FStar_Syntax_Syntax.U_succ (uu____279) -> begin
(

let uu____280 = (universe_to_int (Prims.parse_int "0") u)
...
in ((uu____300), (FStar_Pervasives_Native.None)))
in FStar_Const.Const_int (uu____289))
in FStar_Parser_AST.Const (uu____288))
in (mk1 uu____287 r))
end
| uu____311 -> begin
(
...
let uu____326 = (FStar_Util.string_of_int n1)
in ((uu____326), (FStar_Pervasives_Native.None)))
in FStar_Const.Const_int (uu____315))
in FStar_Parser_AST.Const (uu____314))
in (mk1 uu____313 r))
in (
...
let uu____346 = (FStar_Ident.id_of_text "+")
in ((uu____346), ((e1)::(e2)::[])))
in FStar_Parser_AST.Op (uu____339))
in (mk1 uu____338 r))))
end)
end))
end
...
let uu____357 = (FStar_Ident.lid_of_path (("max")::[]) r)
in FStar_Parser_AST.Var (uu____357))
in (mk1 uu____356 r))
...
let uu____371 = (resugar_universe x r)
in ((acc), (uu____371), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____364))
in (mk1 uu____363 r))) t l))
end)
end
| FStar_Syntax_Syntax.U_name (u1) -> begin
(mk1 (FStar_Parser_AST.Uvar (u1)) r)
end
| FStar_Syntax_Syntax.U_unif (uu____373) -> begin
...
let uu____390 = (FStar_Util.string_of_int x)
in (FStar_Util.strcat "uu__univ_bvar_" uu____390))
in ((uu____389), (r)))
in (FStar_Ident.mk_ident uu____384))
...
let name_of_op = (fun uu___200_417 -> (match (uu___200_417) with
| "Amp" -> begin
...
let uu____653 = (FStar_Util.substring_from s (FStar_String.length "op_"))
in (FStar_Util.split uu____653 "_"))
in (match (s1) with
| (op)::[] -> begin
(name_of_op op)
end
...
let uu____667 = (FStar_List.map name_of_op s1)
in (FStar_List.fold_left (fun acc x -> (match (x) with
| FStar_Pervasives_Native.Some (op, uu____709) -> begin
(Prims.strcat acc op)
end
...
let uu____917 = (FStar_All.pipe_right infix_prim_ops (FStar_Util.find_opt (fun d -> (FStar_Syntax_Syntax.fv_eq_lid fv (FStar_Pervasives_Native.fst d)))))
...
let uu____1042 = (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.sread_lid)
...
let uu____1067 = (FStar_Syntax_Subst.compress t)
in uu____1067.FStar_Syntax_Syntax.n)
...
| FStar_Syntax_Syntax.Pat_wild (uu____1153) -> begin
true
end
| uu____1154 -> begin
false
...
let uu____1166 = (is_tuple_constructor_lid lid)
in (not (uu____1166)))
end))
...
let uu____1178 = (may_shorten lid)
...
let uu____1317 = (FStar_Ident.lid_of_path ((a)::[]) r)
in FStar_Parser_AST.Name (uu____1317)))
in (

let uu____1318 = (

let uu____1319 = (FStar_Syntax_Subst.compress t)
in uu____1319.FStar_Syntax_Syntax.n)
in (match (uu____1318) with
| FStar_Syntax_Syntax.Tm_delayed (uu____1322) -> begin
(failwith "Tm_delayed is impossible after compress")
end
| FStar_Syntax_Syntax.Tm_lazy (i) -> begin
(

let uu____1346 = (FStar_Syntax_Util.unfold_lazy i)
in (resugar_term' env uu____1346))
end
...
let uu____1358 = (bv_as_unique_ident x)
in (uu____1358)::[])
in (FStar_Ident.lid_of_ids uu____1355))
in (mk1 (FStar_Parser_AST.Var (l))))
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
(
...
let uu____1377 = (FStar_Ident.lid_of_path ((rest)::[]) t.FStar_Syntax_Syntax.pos)
in FStar_Parser_AST.Discrim (uu____1377))
in (mk1 uu____1376)))
end
| uu____1378 -> begin
...
let uu____1391 = (((FStar_Ident.lid_equals a FStar_Parser_Const.assert_lid) || (FStar_Ident.lid_equals a FStar_Parser_Const.assume_lid)) || (

let uu____1394 = (

let uu____1396 = (FStar_String.get s (Prims.parse_int "0"))
in (FStar_Char.uppercase uu____1396))
in (

let uu____1398 = (FStar_String.get s (Prims.parse_int "0"))
in (Prims.op_disEquality uu____1394 uu____1398))))
...
let uu____1402 = (maybe_shorten_fv env fv)
in FStar_Parser_AST.Var (uu____1402))
in (mk1 uu____1401))
end
| uu____1403 -> begin
(
...
let uu____1416 = (maybe_shorten_fv env fv)
in ((uu____1416), ([])))
in FStar_Parser_AST.Construct (uu____1405))
in (mk1 uu____1404))
end))
end)
end)))))
...
let uu____1434 = (FStar_Options.print_universes ())
...
let uu____1463 = (FStar_List.map (fun u -> ((u), (FStar_Parser_AST.UnivApp))) univs1)
in (FStar_List.append args uu____1463))
...
let uu____1493 = (FStar_Syntax_Syntax.is_teff t)
in (match (uu____1493) with
| true -> begin
(

let uu____1494 = (name "Effect" t.FStar_Syntax_Syntax.pos)
in (mk1 uu____1494))
end
| uu____1495 -> begin
...
let uu____1510 = (name nm t.FStar_Syntax_Syntax.pos)
in (mk1 uu____1510))
in (

let uu____1511 = (needs_app && (FStar_Options.print_universes ()))
...
let uu____1520 = (resugar_universe u t.FStar_Syntax_Syntax.pos)
in ((typ), (uu____1520), (FStar_Parser_AST.UnivApp)))
in FStar_Parser_AST.App (uu____1513))
in (mk1 uu____1512))
end
| uu____1521 -> begin
typ
...
| FStar_Syntax_Syntax.Tm_abs (xs, body, uu____1524) -> begin
(

let uu____1549 = (FStar_Syntax_Subst.open_term xs body)
...
let uu____1565 = (FStar_Options.print_implicits ())
...
let patterns = (FStar_All.pipe_right xs2 (FStar_List.choose (fun uu____1600 -> (match (uu____1600) with
| (x, qual) -> begin
...
let uu____1640 = (FStar_Syntax_Subst.open_comp xs body)
...
let uu____1650 = (FStar_Options.print_implicits ())
...
let uu____1658 = (FStar_All.pipe_right xs2 ((map_opt ()) (fun b -> (resugar_binder' env b t.FStar_Syntax_Syntax.pos))))
in (FStar_All.pipe_right uu____1658 FStar_List.rev))
in (

let rec aux = (fun body3 uu___201_1683 -> (match (uu___201_1683) with
| [] -> begin
body3
end
| (hd1)::tl1 -> begin
...
let uu____1705 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____1705)::[])
in (FStar_Syntax_Subst.open_term uu____1704 phi))
...
let uu____1730 = (FStar_List.hd x1)
in (resugar_binder' env uu____1730 t.FStar_Syntax_Syntax.pos))
...
let uu____1743 = (resugar_term' env phi1)
in ((b), (uu____1743)))
in FStar_Parser_AST.Refine (uu____1738))
in (mk1 uu____1737)))
end))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____1745; FStar_Syntax_Syntax.vars = uu____1746}, ((e, uu____1748))::[]) when ((

let uu____1789 = (FStar_Options.print_implicits ())
in (not (uu____1789))) && (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.b2t_lid)) -> begin
(resugar_term' env e)
end
| FStar_Syntax_Syntax.Tm_app (e, args) -> begin
(

let rec last1 = (fun uu___202_1837 -> (match (uu___202_1837) with
| (hd1)::[] -> begin
(hd1)::[]
end
| (hd1)::tl1 -> begin
...
let rec last_two = (fun uu___203_1945 -> (match (uu___203_1945) with
| [] -> begin
...
let args2 = (FStar_List.map (fun uu____2124 -> (match (uu____2124) with
| (e2, qual) -> begin
(

let uu____2141 = (resugar_term' env e2)
in (

let uu____2142 = (resugar_imp env qual)
in ((uu____2141), (uu____2142))))
end)) args1)
in (

let uu____2143 = (resugar_term' env e1)
...
| e2 -> begin
(FStar_List.fold_left (fun acc uu____2180 -> (match (uu____2180) with
| (x, qual) -> begin
...
let uu____2196 = (FStar_Options.print_implicits ())
...
let uu____2208 = (resugar_term_as_op e)
in (match (uu____2208) with
| FStar_Pervasives_Native.None -> begin
(resugar_as_app e args1)
end
| FStar_Pervasives_Native.Some ("tuple", uu____2219) -> begin
(

let out = (FStar_List.fold_left (fun out uu____2241 -> (match (uu____2241) with
| (x, uu____2253) -> begin
(
...
let uu____2271 = (FStar_Ident.id_of_text "*")
in ((uu____2271), ((prefix1)::(x1)::[])))
in FStar_Parser_AST.Op (uu____2264))
in (mk1 uu____2263))
...
| FStar_Pervasives_Native.Some ("dtuple", uu____2274) when ((FStar_List.length args1) > (Prims.parse_int "0")) -> begin
(
...
let uu____2323 = (FStar_Syntax_Subst.compress body)
in uu____2323.FStar_Syntax_Syntax.n)
in (match (uu____2322) with
| FStar_Syntax_Syntax.Tm_abs (xs, body1, uu____2328) -> begin
(
...
let uu____2389 = (FStar_List.map (fun _0_1 -> FStar_Util.Inl (_0_1)) xs3)
in ((uu____2389), (body3)))
in FStar_Parser_AST.Sum (uu____2378))
in (mk1 uu____2377)))))
end))
end
| uu____2406 -> begin
...
let args3 = (FStar_All.pipe_right args2 (FStar_List.map (fun uu____2429 -> (match (uu____2429) with
| (e1, qual) -> begin
(resugar_term' env e1)
end))))
in (
...
| FStar_Pervasives_Native.Some ("dtuple", uu____2447) -> begin
(resugar_as_app e args1)
end
| FStar_Pervasives_Native.Some (ref_read, uu____2453) when (Prims.op_Equality ref_read FStar_Parser_Const.sread_lid.FStar_Ident.str) -> begin
(

let uu____2458 = (FStar_List.hd args1)
...
let uu____2489 = (resugar_term' env t1)
in ((uu____2489), (f)))
in FStar_Parser_AST.Project (uu____2484))
in (mk1 uu____2483)))
end
| uu____2490 -> begin
(resugar_term' env t1)
...
| FStar_Pervasives_Native.Some ("try_with", uu____2491) when ((FStar_List.length args1) > (Prims.parse_int "1")) -> begin
(

let new_args = (last_two args1)
in (

let uu____2511 = (match (new_args) with
| ((a1, uu____2521))::((a2, uu____2523))::[] -> begin
((a1), (a2))
end
| uu____2550 -> begin
...
let uu____2572 = (FStar_Syntax_Subst.compress term)
in uu____2572.FStar_Syntax_Syntax.n)
in (match (uu____2571) with
| FStar_Syntax_Syntax.Tm_abs (x, e1, uu____2577) -> begin
(
...
let uu____2611 = (decomp body)
in (resugar_term' env uu____2611))
in (

let handler1 = (

let uu____2613 = (decomp handler)
in (resugar_term' env uu____2613))
in (

let rec resugar_body = (fun t1 -> (match (t1.FStar_Parser_AST.tm) with
| FStar_Parser_AST.Match (e1, ((uu____2621, uu____2622, b))::[]) -> begin
b
end
| FStar_Parser_AST.Let (uu____2654, uu____2655, b) -> begin
b
end
...
let uu____2702 = (resugar_body t11)
in ((uu____2702), (t2), (t3)))
in FStar_Parser_AST.Ascribed (uu____2693))
in (mk1 uu____2692))
end
| uu____2705 -> begin
...
| FStar_Pervasives_Native.Some ("try_with", uu____2792) -> begin
(resugar_as_app e args1)
end
| FStar_Pervasives_Native.Some (op, uu____2798) when (((((((Prims.op_Equality op "=") || (Prims.op_Equality op "==")) || (Prims.op_Equality op "===")) || (Prims.op_Equality op "@")) || (Prims.op_Equality op ":=")) || (Prims.op_Equality op "|>")) && (FStar_Options.print_implicits ())) -> begin
(resugar_as_app e args1)
end
| FStar_Pervasives_Native.Some (op, uu____2804) when ((Prims.op_Equality op "forall") || (Prims.op_Equality op "exists")) -> begin
(
...
let uu____2909 = (FStar_Syntax_Subst.compress body)
in uu____2909.FStar_Syntax_Syntax.n)
in (match (uu____2908) with
| FStar_Syntax_Syntax.Tm_abs (xs, body1, uu____2914) -> begin
(
...
let uu____2972 = (FStar_Syntax_Subst.compress body2)
in uu____2972.FStar_Syntax_Syntax.n)
...
let uu____2990 = (match (m) with
| FStar_Syntax_Syntax.Meta_pattern (pats) -> begin
(

let uu____3020 = (FStar_List.map (fun es -> (FStar_All.pipe_right es (FStar_List.map (fun uu____3064 -> (match (uu____3064) with
| (e2, uu____3072) -> begin
(resugar_term' env e2)
end))))) pats)
in ((uu____3020), (body3)))
...
let uu____3084 = (mk1 (FStar_Parser_AST.Labeled (((body3), (s), (p)))))
in (([]), (uu____3084)))
end
| uu____3091 -> begin
...
let uu____3123 = (resugar_term' env body2)
in (([]), (uu____3123)))
end))
...
let uu____3140 = (uncurry xs3 pats body3)
...
let uu____3203 = (resugar_term' env body)
in (([]), (([])::[]), (uu____3203)))
in FStar_Parser_AST.QForall (uu____3190))
in (mk1 uu____3189))
end
| uu____3214 -> begin
(
...
let uu____3229 = (resugar_term' env body)
in (([]), (([])::[]), (uu____3229)))
in FStar_Parser_AST.QExists (uu____3216))
in (mk1 uu____3215))
end)
end)))
...
| FStar_Pervasives_Native.Some ("alloc", uu____3283) -> begin
(

let uu____3288 = (FStar_List.hd args1)
...
let resugar = (fun args2 -> (FStar_All.pipe_right args2 (FStar_List.map (fun uu____3371 -> (match (uu____3371) with
| (e1, qual) -> begin
(

let uu____3388 = (resugar_term' env e1)
in (

let uu____3389 = (resugar_imp env qual)
...
let uu____3402 = (FStar_Util.first_N expect_n resugared_args)
...
let uu____3458 = (FStar_List.map FStar_Pervasives_Native.fst op_args)
in ((op1), (uu____3458)))
in FStar_Parser_AST.Op (uu____3451))
in (mk1 uu____3450))
in (FStar_List.fold_left (fun head2 uu____3476 -> (match (uu____3476) with
| (arg, qual) -> begin
...
let uu____3502 = (resugar args1)
in (FStar_List.map FStar_Pervasives_Native.fst uu____3502))
in ((op1), (uu____3499)))
in FStar_Parser_AST.Op (uu____3492))
in (mk1 uu____3491))
end
| uu____3515 -> begin
(resugar_as_app e args1)
...
let uu____3584 = (FStar_Syntax_Subst.open_branch ((pat), (wopt), (t1)))
...
let uu____3648 = (resugar_pat' env pat1 branch_bv)
in (

let uu____3649 = (resugar_term' env e)
in ((uu____3648), (uu____3649))))
in ((FStar_Pervasives_Native.None), (uu____3643)))
in (uu____3630)::[])
in (
...
| FStar_Syntax_Syntax.Tm_match (e, ((pat1, uu____3701, t1))::((pat2, uu____3704, t2))::[]) when ((is_true_pat pat1) && (is_wild_pat pat2)) -> begin
(
...
let uu____3808 = (resugar_term' env e)
in (

let uu____3809 = (resugar_term' env t1)
in (

let uu____3810 = (resugar_term' env t2)
in ((uu____3808), (uu____3809), (uu____3810)))))
in FStar_Parser_AST.If (uu____3801))
in (mk1 uu____3800))
end
| FStar_Syntax_Syntax.Tm_match (e, branches) -> begin
(

let resugar_branch = (fun uu____3876 -> (match (uu____3876) with
| (pat, wopt, b) -> begin
(

let uu____3918 = (FStar_Syntax_Subst.open_branch ((pat), (wopt), (b)))
...
let uu____3970 = (resugar_term' env e1)
in FStar_Pervasives_Native.Some (uu____3970))
end)
in (
...
let uu____3990 = (resugar_term' env e)
in (

let uu____3991 = (FStar_List.map resugar_branch branches)
in ((uu____3990), (uu____3991))))
in FStar_Parser_AST.Match (uu____3975))
in (mk1 uu____3974)))
end
| FStar_Syntax_Syntax.Tm_ascribed (e, (asc, tac_opt), uu____4037) -> begin
(
...
let uu____4116 = (resugar_term' env e)
in ((uu____4116), (term), (tac_opt1)))
in FStar_Parser_AST.Ascribed (uu____4107))
in (mk1 uu____4106))))
end
...
let uu____4195 = (FStar_List.map (resugar_term' env) tms)
in FStar_Pervasives_Native.Some (uu____4195))
end)
in (

let uu____4202 = (

let uu____4207 = (FStar_Syntax_Util.mk_conj bnd.FStar_Syntax_Syntax.lbtyp bnd.FStar_Syntax_Syntax.lbdef)
in (FStar_Syntax_Subst.open_univ_vars bnd.FStar_Syntax_Syntax.lbunivs uu____4207))
...
let uu____4234 = (FStar_Syntax_Subst.compress td)
in uu____4234.FStar_Syntax_Syntax.n)
in (match (uu____4233) with
| FStar_Syntax_Syntax.Tm_app (uu____4243, ((t1, uu____4245))::((d, uu____4247))::[]) -> begin
((t1), (d))
end
| uu____4304 -> begin
...
let uu____4349 = (FStar_Syntax_Subst.compress def)
in uu____4349.FStar_Syntax_Syntax.n)
in (match (uu____4348) with
| FStar_Syntax_Syntax.Tm_abs (b, t1, uu____4368) -> begin
(

let uu____4393 = (FStar_Syntax_Subst.open_term b t1)
...
let uu____4423 = (FStar_Options.print_implicits ())
...
let uu____4491 = (match (bnd.FStar_Syntax_Syntax.lbname) with
...
let uu____4511 = (bv_as_unique_ident bv)
in ((uu____4511), (FStar_Pervasives_Native.None)))
in FStar_Parser_AST.PatVar (uu____4504))
in (mk_pat uu____4503))
in ((uu____4502), (term)))
end)
...
let uu____4532 = (match (is_pat_app) with
| true -> begin
(

let args = (FStar_All.pipe_right binders ((map_opt ()) (fun uu____4572 -> (match (uu____4572) with
| (bv, q) -> begin
(

let uu____4587 = (resugar_arg_qual env q)
in (FStar_Util.map_opt uu____4587 (fun q1 -> (

let uu____4599 = (

let uu____4600 = (

let uu____4607 = (bv_as_unique_ident bv)
in ((uu____4607), (q1)))
in FStar_Parser_AST.PatVar (uu____4600))
in (mk_pat uu____4599)))))
end))))
in (

let uu____4610 = (

let uu____4615 = (resugar_term' env term1)
in (((mk_pat (FStar_Parser_AST.PatApp (((pat), (args)))))), (uu____4615)))
in (

let uu____4618 = (universe_to_string univs1)
in ((uu____4610), (uu____4618)))))
end
| uu____4623 -> begin
(
...
let uu____4629 = (resugar_term' env term1)
in ((pat), (uu____4629)))
in (

let uu____4630 = (universe_to_string univs1)
in ((uu____4624), (uu____4630))))
end)
in ((attrs_opt), (uu____4532)))
end))
end))
end))
end))))
...
let f = (fun uu____4730 -> (match (uu____4730) with
...
| FStar_Syntax_Syntax.Tm_uvar (u, uu____4862) -> begin
(
...
let uu____4881 = (FStar_Syntax_Unionfind.uvar_id u.FStar_Syntax_Syntax.ctx_uvar_head)
in (FStar_All.pipe_right uu____4881 FStar_Util.string_of_int))
in (Prims.strcat "?u" uu____4880))
in (

let uu____4882 = (mk1 FStar_Parser_AST.Wild)
in (label s uu____4882)))
end
...
let uu____4896 = (resugar_term' env tm)
in ((uu____4896), (qi1)))
in FStar_Parser_AST.Quote (uu____4891))
in (mk1 uu____4890)))
end
| FStar_Syntax_Syntax.Tm_meta (e, m) -> begin
(

let resugar_meta_desugared = (fun uu___204_4908 -> (match (uu___204_4908) with
...
| FStar_Parser_AST.Let (uu____4916, ((uu____4917, (p, t11)))::[], t2) -> begin
...
let uu____4988 = (resugar_seq t11)
in ((uu____4988), (t2), (t3)))
in FStar_Parser_AST.Ascribed (uu____4979))
in (mk1 uu____4978))
end
| uu____4991 -> begin
t1
...
let pats1 = (FStar_All.pipe_right (FStar_List.flatten pats) (FStar_List.map (fun uu____5035 -> (match (uu____5035) with
| (x, uu____5043) -> begin
(resugar_term' env x)
end))))
in (mk1 (FStar_Parser_AST.Attributes (pats1))))
end
| FStar_Syntax_Syntax.Meta_labeled (uu____5048) -> begin
(resugar_term' env e)
end
...
let uu____5073 = (resugar_term' env e)
in (
...
let uu____5099 = (resugar_term' env t1)
in ((uu____5099), (FStar_Parser_AST.Nothing)))
in (uu____5094)::[])
in ((name1), (uu____5087)))
in FStar_Parser_AST.Construct (uu____5076))
in (mk1 uu____5075))
in ((uu____5073), (uu____5074), (FStar_Pervasives_Native.None))))
in FStar_Parser_AST.Ascribed (uu____5064))
in (mk1 uu____5063))
end
| FStar_Syntax_Syntax.Meta_monadic_lift (name1, uu____5117, t1) -> begin
(
...
let uu____5133 = (resugar_term' env e)
in (
...
let uu____5159 = (resugar_term' env t1)
in ((uu____5159), (FStar_Parser_AST.Nothing)))
in (uu____5154)::[])
in ((name1), (uu____5147)))
in FStar_Parser_AST.Construct (uu____5136))
in (mk1 uu____5135))
in ((uu____5133), (uu____5134), (FStar_Pervasives_Native.None))))
in FStar_Parser_AST.Ascribed (uu____5124))
in (mk1 uu____5123))
end))
end
...
let uu____5210 = (FStar_Options.print_universes ())
...
let uu____5271 = (FStar_Options.print_universes ())
...
let uu____5312 = (resugar_term' env c1.FStar_Syntax_Syntax.result_typ)
in ((uu____5312), (FStar_Parser_AST.Nothing)))
in (

let uu____5313 = (FStar_Options.print_effect_args ())
...
let uu____5334 = (FStar_Ident.lid_equals c1.FStar_Syntax_Syntax.effect_name FStar_Parser_Const.effect_Lemma_lid)
...
let uu____5417 = (FStar_Syntax_Util.unthunk_lemma_post (FStar_Pervasives_Native.fst post))
in ((uu____5417), ((FStar_Pervasives_Native.snd post))))
in (

let uu____5428 = (

let uu____5437 = (FStar_Syntax_Util.is_fvar FStar_Parser_Const.true_lid (FStar_Pervasives_Native.fst pre))
...
let uu____5487 = (FStar_Syntax_Util.is_fvar FStar_Parser_Const.nil_lid (FStar_Pervasives_Native.fst pats))
...
in (FStar_List.append ((post1)::[]) uu____5478))
in (FStar_List.append uu____5428 uu____5469))))
end
| uu____5543 -> begin
...
let args1 = (FStar_List.map (fun uu____5576 -> (match (uu____5576) with
| (e, uu____5588) -> begin
(

let uu____5593 = (resugar_term' env e)
in ((uu____5593), (FStar_Parser_AST.Nothing)))
end)) args)
in (

let rec aux = (fun l uu___205_5618 -> (match (uu___205_5618) with
| [] -> begin
l
end
| (hd1)::tl1 -> begin
...
let uu____5651 = (resugar_term' env e)
in ((uu____5651), (FStar_Parser_AST.Nothing)))
in (aux ((e1)::l) tl1))
end
| uu____5656 -> begin
(aux l tl1)
...
let uu____5711 = (resugar_arg_qual env aq)
in (FStar_Util.map_opt uu____5711 (fun imp -> (
...
let uu____5726 = (bv_as_unique_ident x)
in FStar_Parser_AST.Variable (uu____5726))
in (FStar_Parser_AST.mk_binder uu____5725 r FStar_Parser_AST.Type_level imp))
end
| uu____5727 -> begin
(

let uu____5728 = (FStar_Syntax_Syntax.is_null_bv x)
...
let uu____5736 = (bv_as_unique_ident x)
in ((uu____5736), (e)))
in FStar_Parser_AST.Annotated (uu____5731))
in (FStar_Parser_AST.mk_binder uu____5730 r FStar_Parser_AST.Type_level imp))
end))
end)))))
end)))
...
let uu____5756 = (FStar_Syntax_Syntax.range_of_bv v1)
in (FStar_Parser_AST.mk_pattern a uu____5756)))
in (
...
let uu____5759 = (match (used) with
| true -> begin
(

let uu____5760 = (

let uu____5767 = (bv_as_unique_ident v1)
in ((uu____5767), (aqual)))
in FStar_Parser_AST.PatVar (uu____5760))
end
| uu____5770 -> begin
...
| FStar_Pervasives_Native.Some ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_unknown; FStar_Syntax_Syntax.pos = uu____5773; FStar_Syntax_Syntax.vars = uu____5774}) -> begin
pat
end
| FStar_Pervasives_Native.Some (typ) -> begin
(

let uu____5784 = (FStar_Options.print_bound_var_types ())
...
let uu____5804 = (resugar_term' env typ)
in ((uu____5804), (FStar_Pervasives_Native.None)))
in ((pat), (uu____5797)))
in FStar_Parser_AST.PatAscribed (uu____5786))
in (mk1 uu____5785))
end
| uu____5813 -> begin
pat
...
let uu____5824 = (resugar_arg_qual env qual)
in (FStar_Util.map_opt uu____5824 (fun aqual -> (

let uu____5836 = (

let uu____5841 = (FStar_Syntax_Subst.compress x.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_left (fun _0_2 -> FStar_Pervasives_Native.Some (_0_2)) uu____5841))
in (resugar_bv_as_pat' env x aqual body_bv uu____5836))))))
...
let uu____5904 = (FStar_Options.print_implicits ())
in (not (uu____5904))) && (

let uu____5906 = (FStar_List.existsML (fun uu____5917 -> (match (uu____5917) with
...
| FStar_Syntax_Syntax.Pat_dot_term (bv, uu____5933) -> begin
(FStar_Util.set_mem bv branch_bv)
end
| FStar_Syntax_Syntax.Pat_wild (uu____5938) -> begin
false
end
| uu____5939 -> begin
true
...
let uu____6002 = (may_drop_implicits args)
...
let args2 = (FStar_List.map (fun uu____6022 -> (match (uu____6022) with
| (p1, b) -> begin
...
let uu____6070 = (filter_pattern_imp args)
in (FStar_List.isEmpty uu____6070))
in (not (uu____6069)))
...
let uu____6106 = (filter_pattern_imp args)
...
let uu____6146 = (aux tl1 (FStar_Pervasives_Native.Some (false)))
...
let uu____6168 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args'))
in (FStar_Util.format1 "Prims.Cons applied to %s explicit arguments" uu____6168))
in ((FStar_Errors.Warning_ConsAppliedExplicitArgs), (uu____6167)))
in (FStar_Errors.log_issue p1.FStar_Syntax_Syntax.p uu____6162));
...
let args1 = (FStar_All.pipe_right args (FStar_List.filter_map (fun uu____6211 -> (match (uu____6211) with
...
let uu____6223 = (aux p2 (FStar_Pervasives_Native.Some (false)))
...
| FStar_Syntax_Syntax.Pat_cons ({FStar_Syntax_Syntax.fv_name = uu____6227; FStar_Syntax_Syntax.fv_delta = uu____6228; FStar_Syntax_Syntax.fv_qual = FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Record_ctor (name, fields))}, args) -> begin
(

let fields1 = (

let uu____6255 = (FStar_All.pipe_right fields (FStar_List.map (fun f -> (FStar_Ident.lid_of_ids ((f)::[])))))
in (FStar_All.pipe_right uu____6255 FStar_List.rev))
in (

let args1 = (

let uu____6271 = (FStar_All.pipe_right args (FStar_List.map (fun uu____6289 -> (match (uu____6289) with
| (p2, b) -> begin
(aux p2 (FStar_Pervasives_Native.Some (b)))
end))))
in (FStar_All.pipe_right uu____6271 FStar_List.rev))
in (
...
let uu____6363 = (map21 tl1 [])
in (((hd1), ((mk1 (FStar_Parser_AST.PatWild (FStar_Pervasives_Native.None))))))::uu____6363)
end
| ((hd1)::tl1, (hd2)::tl2) -> begin
(

let uu____6386 = (map21 tl1 tl2)
in (((hd1), (hd2)))::uu____6386)
end))
in (

let args2 = (

let uu____6404 = (map21 fields1 args1)
in (FStar_All.pipe_right uu____6404 FStar_List.rev))
...
let uu____6446 = (string_to_op v1.FStar_Syntax_Syntax.ppname.FStar_Ident.idText)
in (match (uu____6446) with
| FStar_Pervasives_Native.Some (op, uu____6456) -> begin
(

let uu____6467 = (

let uu____6468 = (FStar_Ident.mk_ident ((op), (v1.FStar_Syntax_Syntax.ppname.FStar_Ident.idRange)))
in FStar_Parser_AST.PatOp (uu____6468))
in (mk1 uu____6467))
end
| FStar_Pervasives_Native.None -> begin
(

let uu____6475 = (to_arg_qual imp_opt)
in (resugar_bv_as_pat' env v1 uu____6475 branch_bv FStar_Pervasives_Native.None))
end))
end
| FStar_Syntax_Syntax.Pat_wild (uu____6480) -> begin
(

let uu____6481 = (

let uu____6482 = (to_arg_qual imp_opt)
in FStar_Parser_AST.PatWild (uu____6482))
in (mk1 uu____6481))
end
...
let uu____6522 = (resugar_term' env t)
in FStar_Parser_AST.Meta (uu____6522))
in FStar_Pervasives_Native.Some (uu____6521))
in FStar_Pervasives_Native.Some (uu____6518))
end))
...
let uu____6532 = (resugar_term' env t)
in FStar_Parser_AST.HashBrace (uu____6532))
end))


let resugar_qualifier : FStar_Syntax_Syntax.qualifier  ->  FStar_Parser_AST.qualifier FStar_Pervasives_Native.option = (fun uu___206_6539 -> (match (uu___206_6539) with
...
| FStar_Syntax_Syntax.Reflectable (uu____6546) -> begin
FStar_Pervasives_Native.Some (FStar_Parser_AST.Reflectable)
end
| FStar_Syntax_Syntax.Discriminator (uu____6547) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Projector (uu____6548) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.RecordType (uu____6553) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.RecordConstructor (uu____6562) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Action (uu____6571) -> begin
FStar_Pervasives_Native.None
end
...
let resugar_pragma : FStar_Syntax_Syntax.pragma  ->  FStar_Parser_AST.pragma = (fun uu___207_6576 -> (match (uu___207_6576) with
...
| FStar_Syntax_Syntax.Sig_inductive_typ (tylid, uvs, bs, t, uu____6615, datacons) -> begin
(

let uu____6625 = (FStar_All.pipe_right datacon_ses (FStar_List.partition (fun se1 -> (match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (uu____6652, uu____6653, uu____6654, inductive_lid, uu____6656, uu____6657) -> begin
...
let uu____6681 = (FStar_Options.print_implicits ())
...
let uu____6695 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___208_6700 -> (match (uu___208_6700) with
| FStar_Syntax_Syntax.RecordType (uu____6701) -> begin
true
end
| uu____6710 -> begin
false
...
| FStar_Syntax_Syntax.Sig_datacon (uu____6762, univs1, term, uu____6765, num, uu____6767) -> begin
(

let uu____6772 = (

let uu____6773 = (FStar_Syntax_Subst.compress term)
in uu____6773.FStar_Syntax_Syntax.n)
in (match (uu____6772) with
| FStar_Syntax_Syntax.Tm_arrow (bs3, uu____6787) -> begin
(

let mfields = (FStar_All.pipe_right bs3 (FStar_List.map (fun uu____6856 -> (match (uu____6856) with
| (b, qual) -> begin
(

let uu____6877 = (bv_as_unique_ident b)
in (

let uu____6878 = (resugar_term' env b.FStar_Syntax_Syntax.sort)
in ((uu____6877), (uu____6878), (FStar_Pervasives_Native.None))))
end))))
...
| FStar_Syntax_Syntax.Sig_datacon (l, univs1, term, uu____7025, num, uu____7027) -> begin
(
...
let uu____7048 = (resugar_term' env term)
in FStar_Pervasives_Native.Some (uu____7048))
in ((l.FStar_Ident.ident), (uu____7045), (FStar_Pervasives_Native.None), (false)))
in (c)::constructors)
end
| uu____7065 -> begin
(failwith "unexpected")
...
let uu____7163 = (FStar_List.choose resugar_qualifier q)
in {FStar_Parser_AST.d = d'; FStar_Parser_AST.drange = r; FStar_Parser_AST.doc = FStar_Pervasives_Native.None; FStar_Parser_AST.quals = uu____7163; FStar_Parser_AST.attrs = []}))
...
let uu____7247 = (resugar_term' env typ)
in ((name1), ([]), (FStar_Pervasives_Native.None), (uu____7247)))
in FStar_Parser_AST.TyconAbbrev (uu____7234))
in ((uu____7233), (FStar_Pervasives_Native.None)))
in (uu____7226)::[])
in ((false), (false), (uu____7217)))
in FStar_Parser_AST.Tycon (uu____7202))
in (mk_decl typ.FStar_Syntax_Syntax.pos [] uu____7201)))
end)))
...
let uu____7325 = (FStar_Syntax_Subst.open_term action_params d.FStar_Syntax_Syntax.action_defn)
in (match (uu____7325) with
| (bs, action_defn) -> begin
(

let uu____7332 = (FStar_Syntax_Subst.open_term action_params d.FStar_Syntax_Syntax.action_typ)
...
let uu____7349 = (FStar_All.pipe_right action_params1 ((map_opt ()) (fun b -> (resugar_binder' env b r))))
in (FStar_All.pipe_right uu____7349 FStar_List.rev))
in (
...
let uu____7376 = (FStar_Ident.lid_of_str "construct")
in ((uu____7376), ((((action_defn1), (FStar_Parser_AST.Nothing)))::(((action_typ1), (FStar_Parser_AST.Nothing)))::[])))
in FStar_Parser_AST.Construct (uu____7365))
in (
...
let uu____7450 = (FStar_Syntax_Subst.open_term ed.FStar_Syntax_Syntax.binders ed.FStar_Syntax_Syntax.signature)
...
let uu____7460 = (FStar_Options.print_implicits ())
...
let uu____7467 = (FStar_All.pipe_right eff_binders1 ((map_opt ()) (fun b -> (resugar_binder' env b r))))
in (FStar_All.pipe_right uu____7467 FStar_List.rev))
in (
...
| FStar_Syntax_Syntax.Sig_bundle (ses, uu____7535) -> begin
(

let uu____7544 = (FStar_All.pipe_right ses (FStar_List.partition (fun se1 -> (match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____7566) -> begin
true
end
| FStar_Syntax_Syntax.Sig_declare_typ (uu____7583) -> begin
true
end
| FStar_Syntax_Syntax.Sig_datacon (uu____7590) -> begin
false
end
| uu____7605 -> begin
...
let retrieve_datacons_and_resugar = (fun uu____7641 se1 -> (match (uu____7641) with
| (datacon_ses1, tycons) -> begin
(

let uu____7667 = (resugar_typ env datacon_ses1 se1)
...
let uu____7682 = (FStar_List.fold_left retrieve_datacons_and_resugar ((datacon_ses), ([])) decl_typ_ses)
...
let uu____7734 = (FStar_List.map (fun tyc -> ((tyc), (FStar_Pervasives_Native.None))) tycons)
in ((false), (false), (uu____7734)))
in FStar_Parser_AST.Tycon (uu____7719))
in (decl'_to_decl se uu____7718))
in FStar_Pervasives_Native.Some (uu____7717))
end
| (se1)::[] -> begin
(match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (l, uu____7765, uu____7766, uu____7767, uu____7768, uu____7769) -> begin
(

let uu____7774 = (decl'_to_decl se1 (FStar_Parser_AST.Exception (((l.FStar_Ident.ident), (FStar_Pervasives_Native.None)))))
in FStar_Pervasives_Native.Some (uu____7774))
end
| uu____7777 -> begin
...
| FStar_Syntax_Syntax.Sig_let (lbs, uu____7786) -> begin
(

let uu____7791 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___209_7797 -> (match (uu___209_7797) with
| FStar_Syntax_Syntax.Projector (uu____7798, uu____7799) -> begin
true
end
| FStar_Syntax_Syntax.Discriminator (uu____7800) -> begin
true
end
| uu____7801 -> begin
false
end))))
in (match (uu____7791) with
| true -> begin
FStar_Pervasives_Native.None
end
| uu____7804 -> begin
...
| FStar_Parser_AST.Let (isrec, lets, uu____7832) -> begin
(
...
let uu____7874 = (FStar_List.map FStar_Pervasives_Native.snd lets)
in ((isrec), (uu____7874)))
in FStar_Parser_AST.TopLevelLet (uu____7863))
in (decl'_to_decl se uu____7862))
...
| FStar_Syntax_Syntax.Sig_assume (lid, uu____7915, fml) -> begin
(
...
let uu____7924 = (resugar_term' env fml)
in ((lid.FStar_Ident.ident), (uu____7924)))
in FStar_Parser_AST.Assume (uu____7919))
in (decl'_to_decl se uu____7918))
in FStar_Pervasives_Native.Some (uu____7917))
end
| FStar_Syntax_Syntax.Sig_new_effect (ed) -> begin
(

let uu____7926 = (resugar_eff_decl' env false se.FStar_Syntax_Syntax.sigrng se.FStar_Syntax_Syntax.sigquals ed)
in FStar_Pervasives_Native.Some (uu____7926))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ed) -> begin
(

let uu____7928 = (resugar_eff_decl' env true se.FStar_Syntax_Syntax.sigrng se.FStar_Syntax_Syntax.sigquals ed)
...
| FStar_Pervasives_Native.Some (uu____7937, t) -> begin
(

let uu____7947 = (resugar_term' env t)
in FStar_Pervasives_Native.Some (uu____7947))
end
| uu____7948 -> begin
FStar_Pervasives_Native.None
end)
...
| FStar_Pervasives_Native.Some (uu____7956, t) -> begin
(

let uu____7966 = (resugar_term' env t)
in FStar_Pervasives_Native.Some (uu____7966))
end
| uu____7967 -> begin
FStar_Pervasives_Native.None
end)
...
let uu____8000 = (decl'_to_decl se (FStar_Parser_AST.SubEffect ({FStar_Parser_AST.msource = src; FStar_Parser_AST.mdest = dst; FStar_Parser_AST.lift_op = op})))
in FStar_Pervasives_Native.Some (uu____8000)))))))
end
| FStar_Syntax_Syntax.Sig_effect_abbrev (lid, vs, bs, c, flags1) -> begin
(

let uu____8010 = (FStar_Syntax_Subst.open_comp bs c)
...
let uu____8022 = (FStar_Options.print_implicits ())
...
let uu____8082 = (resugar_comp' env c1)
in ((lid.FStar_Ident.ident), (bs3), (FStar_Pervasives_Native.None), (uu____8082)))
in FStar_Parser_AST.TyconAbbrev (uu____8069))
in ((uu____8068), (FStar_Pervasives_Native.None)))
in (uu____8061)::[])
in ((false), (false), (uu____8052)))
...
let uu____8110 = (decl'_to_decl se (FStar_Parser_AST.Pragma ((resugar_pragma p))))
in FStar_Pervasives_Native.Some (uu____8110))
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uvs, t) -> begin
(

let uu____8114 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___210_8120 -> (match (uu___210_8120) with
| FStar_Syntax_Syntax.Projector (uu____8121, uu____8122) -> begin
true
end
| FStar_Syntax_Syntax.Discriminator (uu____8123) -> begin
true
end
| uu____8124 -> begin
false
...
let uu____8132 = (FStar_Options.print_universes ())
in (not (uu____8132))) || (FStar_List.isEmpty uvs))
...
let uu____8142 = (resugar_term' env t1)
in (label universes uu____8142)))
end))
end))
in (

let uu____8143 = (decl'_to_decl se (FStar_Parser_AST.Val (((lid.FStar_Ident.ident), (t')))))
in FStar_Pervasives_Native.Some (uu____8143)))
end))
end
...
let uu____8159 = (FStar_List.map (fun l -> l.FStar_Ident.ident) ids)
in (

let uu____8164 = (resugar_term' env t)
in ((uu____8159), (uu____8164))))
in FStar_Parser_AST.Splice (uu____8152))
in (decl'_to_decl se uu____8151))
in FStar_Pervasives_Native.Some (uu____8150))
end
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____8167) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Sig_datacon (uu____8184) -> begin
FStar_Pervasives_Native.None
end
| FStar_Syntax_Syntax.Sig_main (uu____8199) -> begin
FStar_Pervasives_Native.None
end))
...
let uu____8365 = (noenv resugar_eff_decl')
in (uu____8365 for_free r q ed)))
