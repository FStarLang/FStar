...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_bvar x ->
        let l =
          let uu____983 =
            let uu____986 = bv_as_unique_ident x  in [uu____986]  in
          FStar_Ident.lid_of_ids uu____983  in
        mk1 (FStar_Parser_AST.Var l)
    | FStar_Syntax_Syntax.Tm_name x ->
        let l =
          let uu____989 =
            let uu____992 = bv_as_unique_ident x  in [uu____992]  in
    ...
    | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
        let uu____1208 =
          let uu____1213 =
            let uu____1214 = FStar_Syntax_Syntax.mk_binder x  in [uu____1214]
             in
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____4536 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____4573 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
            ...
            FStar_List.map
              (fun uu____5130  ->
                 ...
                 | (e,uu____5140) ->
                     ...
                     (uu____5141, FStar_Parser_AST.Nothing)) args
             in
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____5639 = map21 tl1 tl2  in (hd1, hd2) :: uu____5639
             in
          let args2 =
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____5896 -> failwith "unexpected"))
             in
                ...
                let uu____6419 =
                  let uu____6426 =
                    let uu____6427 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____6440)
                       in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____6626 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____6631 =
                       ...
                       let uu____7145 =
                         let uu____7146 =
                           ...
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____7159)
                            in
          ...
          (let t' =
             let uu____7206 =
               (let uu____7209 = FStar_Options.print_universes ()  in
                Prims.op_Negation uu____7209) || (FStar_List.isEmpty uvs)
                in
             if uu____7206
             then resugar_term t
             else
