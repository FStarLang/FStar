...
let map_opt:
      'Auu____12 'Auu____13. Prims.unit
  ...
  fun x ->
    let unique_name =
      ...
      if uu____32 then
        ...
        Prims.strcat x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText uu____33
...
let filter_imp:
  ...
  fun a ->
    FStar_All.pipe_right a
      (FStar_List.filter (fun uu___66_91 ->
           match uu___66_91 with
           | ( uu____98
             , FStar_Pervasives_Native.Some
                 FStar_Syntax_Syntax.Implicit uu____99 ) ->
               false
           | uu____102 -> true ))
...
let resugar_arg_qual
  ...
  fun q ->
    ...
    | FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Implicit b ->
        if b then FStar_Pervasives_Native.None
        else
          FStar_Pervasives_Native.Some
...
let rec resugar_universe
    : FStar_Syntax_Syntax.universe -> FStar_Range.range
              ...
              let uu____225 =
                let uu____226 =
                  let uu____227 =
                    ...
                    (uu____238, FStar_Pervasives_Native.None)
                  in
                  FStar_Const.Const_int uu____227
                in
                FStar_Parser_AST.Const uu____226
              in
              mk1 uu____225 r
          | uu____249 ->
              let e1 =
                let uu____251 =
                  let uu____252 =
                    ...
                    in
                    FStar_Const.Const_int uu____253
                  in
                  FStar_Parser_AST.Const uu____252
                in
                mk1 uu____251 r
              in
              let e2 = resugar_universe u1 r in
              mk1 (FStar_Parser_AST.Op (FStar_Ident.id_of_text "+", [e1; e2]))
                r )
      ...
      | uu____281 ->
          let t =
            let uu____285 =
              ...
              FStar_Parser_AST.Var uu____286
            in
            mk1 uu____285 r
          in
            ...
            (fun acc x ->
              let uu____292 =
                let uu____293 =
                  ...
                  (acc, uu____300, FStar_Parser_AST.Nothing)
                in
                FStar_Parser_AST.App uu____293
              in
              mk1 uu____292 r )
            t l )
        ...
        let id1 =
          let uu____313 =
            let uu____318 =
              ...
              FStar_Util.strcat "uu__univ_bvar_" uu____319
            in
            (uu____318, r)
          in
          FStar_Ident.mk_ident uu____313
        in
...
let string_to_op
  ...
  fun s ->
    let name_of_op uu___67_338 =
      ...
      | "Subtraction" -> FStar_Pervasives_Native.Some ("-", Prims.parse_int "2")
      | "Tilde" -> FStar_Pervasives_Native.Some ("~", Prims.parse_int "0")
      | "Slash" -> FStar_Pervasives_Native.Some ("/", Prims.parse_int "0")
      | "Backslash" -> FStar_Pervasives_Native.Some ("\\", Prims.parse_int "0")
      | "Less" -> FStar_Pervasives_Native.Some ("<", Prims.parse_int "0")
      | "Equals" -> FStar_Pervasives_Native.Some ("=", Prims.parse_int "0")
      | "Greater" -> FStar_Pervasives_Native.Some (">", Prims.parse_int "0")
      | "Underscore" -> FStar_Pervasives_Native.Some ("_", Prims.parse_int "0")
      ...
      | "Percent" -> FStar_Pervasives_Native.Some ("%", Prims.parse_int "0")
      | "Star" -> FStar_Pervasives_Native.Some ("*", Prims.parse_int "0")
      | "Question" -> FStar_Pervasives_Native.Some ("?", Prims.parse_int "0")
    ...
    | "op_Array_Access" ->
        FStar_Pervasives_Native.Some (".()", Prims.parse_int "0")
    | uu____456 ->
        if FStar_Util.starts_with s "op_" then
          let s1 =
            let uu____466 =
              FStar_Util.substring_from s (FStar_String.length "op_")
            in
            FStar_Util.split uu____466 "_"
          in
          match s1 with
          | [op] -> name_of_op op
          | uu____474 ->
  ...
  fun t ->
    ...
    let fallback fv =
      ...
      | uu____746 ->
          ...
          in
          let str =
            if length1 = Prims.parse_int "0" then
              fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v
                .FStar_Ident.str
            else
          ...
          in
          if FStar_Util.starts_with str "dtuple" then
            FStar_Pervasives_Native.Some ("dtuple", Prims.parse_int "0")
          else if FStar_Util.starts_with str "tuple" then
            FStar_Pervasives_Native.Some ("tuple", Prims.parse_int "0")
          else if FStar_Util.starts_with str "try_with" then
    ...
    let uu____815 =
      ...
      uu____816.FStar_Syntax_Syntax.n
    in
...
let is_true_pat : FStar_Syntax_Syntax.pat -> Prims.bool =
  fun p ->
    ...
    | FStar_Syntax_Syntax.Pat_constant FStar_Const.Const_bool true -> true
    | uu____886 -> false
...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t ->
    let mk1 a =
      FStar_Parser_AST.mk_term a t.FStar_Syntax_Syntax.pos FStar_Parser_AST.Un
    in
    let name a r =
      let uu____922 = FStar_Ident.lid_of_path [a] r in
      FStar_Parser_AST.Name uu____922
    in
    let var a r =
      let uu____930 = FStar_Ident.lid_of_path [a] r in
      FStar_Parser_AST.Var uu____930
    in
    let uu____931 =
    ...
    | FStar_Syntax_Syntax.Tm_bvar x ->
        let l =
          let uu____962 =
            let uu____965 = bv_as_unique_ident x in
            [uu____965]
          in
          FStar_Ident.lid_of_ids uu____962
        in
        mk1 (FStar_Parser_AST.Var l)
    | FStar_Syntax_Syntax.Tm_name x ->
        let l =
          let uu____968 =
            let uu____971 = bv_as_unique_ident x in
            [uu____971]
          in
          FStar_Ident.lid_of_ids uu____968
        in
        mk1 (FStar_Parser_AST.Var l)
    | FStar_Syntax_Syntax.Tm_fvar fv ->
        ...
        in
        let s =
          if length1 = Prims.parse_int "0" then a.FStar_Ident.str
          else
            FStar_Util.substring_from a.FStar_Ident.str
              (length1 + Prims.parse_int "1")
        in
        let is_prefix = Prims.strcat FStar_Ident.reserved_prefix "is_" in
        if FStar_Util.starts_with s is_prefix then
          let rest =
            FStar_Util.substring_from s (FStar_String.length is_prefix)
          in
          let uu____989 =
            let uu____990 =
              FStar_Ident.lid_of_path [rest] t.FStar_Syntax_Syntax.pos
            in
            FStar_Parser_AST.Discrim uu____990
          in
          mk1 uu____989
        else if FStar_Util.starts_with s
                  FStar_Syntax_Util.field_projector_prefix
        then
          let rest =
            FStar_Util.substring_from s
              (FStar_String.length FStar_Syntax_Util.field_projector_prefix)
          in
          let r =
          ...
          let uu____1004 =
            ...
            let uu____1007 =
              ...
              FStar_Char.uppercase uu____1009
            in
            let uu____1011 = FStar_String.get s (Prims.parse_int "0") in
            uu____1007 <> uu____1011
          in
          if uu____1004 then
            let uu____1014 = var a.FStar_Ident.str t.FStar_Syntax_Syntax.pos in
            mk1 uu____1014
          else
            let uu____1016 =
              name a.FStar_Ident.str t.FStar_Syntax_Syntax.pos
            in
            mk1 uu____1016
          ...
          FStar_List.fold_left
            (fun acc x ->
              let uu____1030 =
                let uu____1031 =
                  let uu____1038 =
                    resugar_universe x t.FStar_Syntax_Syntax.pos
                  in
                  (acc, uu____1038, FStar_Parser_AST.UnivApp)
                in
                FStar_Parser_AST.App uu____1031
              in
              mk1 uu____1030 )
            e1 universes
        else resugar_term e
    ...
    | FStar_Syntax_Syntax.Tm_type u -> (
      ...
      | uu____1047 ->
          ...
          if uu____1048 then
            ...
            in
            mk1
              (FStar_Parser_AST.Construct (l, [(u1, FStar_Parser_AST.UnivApp)]))
          else
    ...
    | FStar_Syntax_Syntax.Tm_abs (xs, body, uu____1069) -> (
        ...
        match uu____1090 with xs1, body1 ->
          let xs2 =
            let uu____1098 = FStar_Options.print_implicits () in
            if uu____1098 then xs1 else filter_imp xs1
          in
          let patterns =
            FStar_All.pipe_right xs2
              (FStar_List.choose (fun uu____1112 ->
                   match uu____1112 with x, qual -> resugar_bv_as_pat x qual ))
          in
          let body2 = resugar_term body1 in
          mk1 (FStar_Parser_AST.Abs (patterns, body2)) )
    | FStar_Syntax_Syntax.Tm_arrow (xs, body) -> (
        let uu____1142 = FStar_Syntax_Subst.open_comp xs body in
        match uu____1142 with xs1, body1 ->
          let xs2 =
            let uu____1150 = FStar_Options.print_implicits () in
            if uu____1150 then xs1 else filter_imp xs1
          in
          ...
          let xs3 =
            ...
            in
            FStar_All.pipe_right uu____1156 FStar_List.rev
          in
    ...
    | FStar_Syntax_Syntax.Tm_refine (x, phi) -> (
        let uu____1191 =
          let uu____1196 =
            let uu____1197 = FStar_Syntax_Syntax.mk_binder x in
            [uu____1197]
          in
          FStar_Syntax_Subst.open_term uu____1196 phi
        in
        match uu____1191 with x1, phi1 ->
          let b =
            let uu____1201 =
              let uu____1204 = FStar_List.hd x1 in
              resugar_binder uu____1204 t.FStar_Syntax_Syntax.pos
            in
            FStar_Util.must uu____1201
          in
          let uu____1209 =
            let uu____1210 =
              let uu____1215 = resugar_term phi1 in
              (b, uu____1215)
            in
            FStar_Parser_AST.Refine uu____1210
          in
          mk1 uu____1209 )
    | FStar_Syntax_Syntax.Tm_app
        ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar fv
          ; FStar_Syntax_Syntax.pos= uu____1217
          ; FStar_Syntax_Syntax.vars= uu____1218; _ }
        , [(e, uu____1220)] )
      when (let uu____1251 = FStar_Options.print_implicits () in
    ...
    | FStar_Syntax_Syntax.Tm_app (e, args) -> (
        let rec last1 uu___69_1293 =
          ...
          | [hd1] -> [hd1]
          | hd1 :: tl1 -> last1 tl1
          | uu____1363 -> failwith "last of an empty list"
        in
        ...
        let rec last_three uu___71_1548 =
          ...
          | [uu____1606; uu____1607] ->
              failwith
                "last three elements of a list with less than three elements "
          | [a1; a2; a3] -> [a1; a2; a3]
          | uu____1715 :: t1 -> last_three t1
        in
        let resugar_as_app e1 args1 =
          let args2 =
            FStar_All.pipe_right args1
              (FStar_List.map (fun uu____1801 ->
                   match uu____1801 with e2, qual ->
          ...
          FStar_List.fold_left
            (fun acc uu____1859 ->
              match uu____1859 with x, qual ->
                let uu____1872 =
                  let uu____1873 =
                    let uu____1880 = res_impl x qual in
                    (acc, x, uu____1880)
                  in
                  FStar_Parser_AST.App uu____1873
                in
                mk1 uu____1872 )
            e2 args2
        in
        let args1 =
          ...
          if uu____1890 then args else filter_imp args
        in
              ...
              let e1 =
                let uu____1952 =
                  let uu____1953 =
                    ...
                    in
                    (FStar_Ident.id_of_text "*", uu____1960)
                  in
                  FStar_Parser_AST.Op uu____1953
                in
                mk1 uu____1952
              in
              FStar_List.fold_left
                (fun acc uu____1980 ->
                  match uu____1980 with x, uu____1986 ->
                    let uu____1987 =
                      ...
                      in
                      FStar_Parser_AST.Op uu____1988
                    in
                    mk1 uu____1987 )
                e1 rest
          | uu____2004 -> resugar_as_app e args1 )
        | FStar_Pervasives_Native.Some ("dtuple", uu____2013)
          when FStar_List.length args1 > Prims.parse_int "0"
          -> (
            let args2 = last1 args1 in
            let body =
              match args2 with
              | [(b, uu____2039)] -> b
              | uu____2056 -> failwith "wrong arguments to dtuple"
            in
            let uu____2067 =
              let uu____2068 = FStar_Syntax_Subst.compress body in
              uu____2068.FStar_Syntax_Syntax.n
            in
            ...
            | FStar_Syntax_Syntax.Tm_abs (xs, body1, uu____2073) -> (
                ...
                match uu____2094 with xs1, body2 ->
                  let xs2 =
                    let uu____2102 = FStar_Options.print_implicits () in
                    if uu____2102 then xs1 else filter_imp xs1
                  in
                  let xs3 =
                    FStar_All.pipe_right xs2
                      ((map_opt ()) (fun b ->
            ...
            | uu____2114 ->
                let args3 =
                  FStar_All.pipe_right args2
                    (FStar_List.map (fun uu____2135 ->
                         match uu____2135 with e1, qual -> resugar_term e1 ))
                in
                let e1 = resugar_term e in
                FStar_List.fold_left
                  (fun acc x ->
        ...
        | FStar_Pervasives_Native.Some (ref_read, uu____2153)
          when ref_read = FStar_Parser_Const.sread_lid.FStar_Ident.str
          -> (
            let uu____2158 = FStar_List.hd args1 in
            match uu____2158 with t1, uu____2172 ->
              let uu____2177 =
                let uu____2178 = FStar_Syntax_Subst.compress t1 in
                uu____2178.FStar_Syntax_Syntax.n
              in
              match uu____2177 with
              | FStar_Syntax_Syntax.Tm_fvar fv
                when FStar_Syntax_Util.field_projector_contains_constructor
                       fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v
                         .FStar_Ident.str ->
                  let f =
                    FStar_Ident.lid_of_path
                      [ fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v
                          .FStar_Ident.str ] t1.FStar_Syntax_Syntax.pos
                  in
                  let uu____2183 =
                    let uu____2184 =
                      ...
                      (uu____2189, f)
                    in
                    FStar_Parser_AST.Project uu____2184
                  in
                  mk1 uu____2183
              | uu____2190 -> resugar_term t1 )
        | FStar_Pervasives_Native.Some ("try_with", uu____2191)
          when FStar_List.length args1 > Prims.parse_int "1"
          -> (
            let new_args = last_two args1 in
            let uu____2211 =
              match new_args with
              | [(a1, uu____2229); (a2, uu____2231)] -> (a1, a2)
              | uu____2262 -> failwith "wrong arguments to try_with"
            in
            match uu____2211 with body, handler ->
              let decomp term =
                let uu____2293 =
                  let uu____2294 = FStar_Syntax_Subst.compress term in
                  uu____2294.FStar_Syntax_Syntax.n
                in
                ...
                | uu____2327 -> failwith "wrong argument format to try_with"
              in
              let body1 =
                let uu____2329 = decomp body in
                resugar_term uu____2329
              in
              let handler1 =
                let uu____2331 = decomp handler in
                resugar_term uu____2331
              in
              let rec resugar_body t1 =
                match t1.FStar_Parser_AST.tm with
                | FStar_Parser_AST.Match (e1, [(uu____2337, uu____2338, b)]) ->
                    b
                ...
                | FStar_Parser_AST.Ascribed (t11, t2, t3) ->
                    let uu____2408 =
                      let uu____2409 =
                        ...
                        (uu____2418, t2, t3)
                      in
                      FStar_Parser_AST.Ascribed uu____2409
                    in
                    mk1 uu____2408
                | uu____2421 -> failwith "unexpected body format to try_with"
              in
        ...
        | FStar_Pervasives_Native.Some ("try_with", uu____2506) ->
            resugar_as_app e args1
        | FStar_Pervasives_Native.Some (op, uu____2512)
          when op = "forall" || op = "exists" ->
            let rec uncurry xs pat t1 =
              ...
              | FStar_Parser_AST.QForall (x, p, body) ->
                  uncurry (FStar_List.append x xs) (FStar_List.append p pat)
                    body
              | uu____2597 -> (xs, pat, t1)
            in
            let resugar body =
              let uu____2608 =
                let uu____2609 = FStar_Syntax_Subst.compress body in
                uu____2609.FStar_Syntax_Syntax.n
              in
              ...
              | FStar_Syntax_Syntax.Tm_abs (xs, body1, uu____2614) -> (
                  ...
                  match uu____2635 with xs1, body2 ->
                    let xs2 =
                      let uu____2643 = FStar_Options.print_implicits () in
                      if uu____2643 then xs1 else filter_imp xs1
                    in
                    let xs3 =
                      FStar_All.pipe_right xs2
                        ((map_opt ()) (fun b ->
                    ...
                    let uu____2652 =
                      let uu____2661 =
                        let uu____2662 = FStar_Syntax_Subst.compress body2 in
                        uu____2662.FStar_Syntax_Syntax.n
                      in
                      ...
                      | FStar_Syntax_Syntax.Tm_meta (e1, m) -> (
                          ...
                          let uu____2680 =
                            ...
                            | FStar_Syntax_Syntax.Meta_labeled (s, r, p) ->
                                let uu____2758 =
                                  mk1 (FStar_Parser_AST.Labeled (body3, s, p))
                                in
                                ([], uu____2758)
                            | uu____2765 ->
                                failwith
                          ...
                          in
                          match uu____2680 with pats, body4 -> (pats, body4) )
                      | uu____2796 ->
                          let uu____2797 = resugar_term body2 in
                          ([], uu____2797)
                    in
                    match uu____2652 with pats, body3 ->
                      let uu____2814 = uncurry xs3 pats body3 in
                      match uu____2814 with xs4, pats1, body4 ->
                        let xs5 = FStar_All.pipe_right xs4 FStar_List.rev in
                        if op = "forall" then
                          mk1 (FStar_Parser_AST.QForall (xs5, pats1, body4))
                        else mk1 (FStar_Parser_AST.QExists (xs5, pats1, body4))
                  )
              | uu____2862 ->
                  if op = "forall" then
                    let uu____2863 =
                      let uu____2864 =
                        ...
                        ([], [[]], uu____2877)
                      in
                      FStar_Parser_AST.QForall uu____2864
                    in
                    mk1 uu____2863
                  else
                    let uu____2889 =
                      let uu____2890 =
                        ...
                        ([], [[]], uu____2903)
                      in
                      FStar_Parser_AST.QExists uu____2890
                    in
                    mk1 uu____2889
            in
        ...
        | FStar_Pervasives_Native.Some (op, arity) ->
            ...
            let resugar args2 =
              FStar_All.pipe_right args2
                (FStar_List.map (fun uu____3021 ->
                     match uu____3021 with e1, qual -> resugar_term e1 ))
            in
            match arity with
            | _0_39 when _0_39 = Prims.parse_int "0" -> (
                let uu____3028 =
                  FStar_Parser_ToDocument.handleable_args_length op1
                in
                match uu____3028 with
                | _0_40
                  when _0_40 = Prims.parse_int "1"
                    ...
                    let uu____3035 =
                      let uu____3036 =
                        ...
                        (op1, uu____3043)
                      in
                      FStar_Parser_AST.Op uu____3036
                    in
                    mk1 uu____3035
                | _0_41
                  when _0_41 = Prims.parse_int "2"
                    ...
                    let uu____3061 =
                      let uu____3062 =
                        ...
                        (op1, uu____3069)
                      in
                      FStar_Parser_AST.Op uu____3062
                    in
                    mk1 uu____3061
                | _0_42
                  when _0_42 = Prims.parse_int "3"
                    ...
                    let uu____3087 =
                      let uu____3088 =
                        ...
                        (op1, uu____3095)
                      in
                      FStar_Parser_AST.Op uu____3088
                    in
                    mk1 uu____3087
                | uu____3107 -> resugar_as_app e args1 )
            | _0_43
              when _0_43 = Prims.parse_int "2"
                   && FStar_List.length args1 > Prims.parse_int "1" ->
                let uu____3114 =
                  let uu____3115 =
                    let uu____3122 =
                    ...
                    (op1, uu____3122)
                  in
                  FStar_Parser_AST.Op uu____3115
                in
                mk1 uu____3114
        ...
        let bnds =
          let uu____3218 =
            let uu____3231 =
              ...
              let uu____3237 = resugar_term e in
              (uu____3236, uu____3237)
            in
    ...
    | FStar_Syntax_Syntax.Tm_match
        (e, [(pat1, uu____3289, t1); (pat2, uu____3292, t2)])
      when is_true_pat pat1 && is_wild_pat pat2 ->
        let uu____3388 =
          let uu____3389 =
            ...
            (uu____3396, uu____3397, uu____3398)
          in
          FStar_Parser_AST.If uu____3389
        in
        mk1 uu____3388
    | FStar_Syntax_Syntax.Tm_match (e, branches) ->
        let resugar_branch uu____3456 =
          match uu____3456 with pat, wopt, b ->
        ...
        let uu____3491 =
          ...
          in
          FStar_Parser_AST.Match uu____3492
        in
        mk1 uu____3491
    | FStar_Syntax_Syntax.Tm_ascribed (e, (asc, tac_opt), uu____3548) ->
        let term =
          ...
          | FStar_Util.Inr n1 -> resugar_comp n1
        in
        let tac_opt1 = FStar_Option.map resugar_term tac_opt in
        let uu____3615 =
          let uu____3616 =
            let uu____3625 = resugar_term e in
            (uu____3625, term, tac_opt1)
          in
          FStar_Parser_AST.Ascribed uu____3616
        in
        mk1 uu____3615
    | FStar_Syntax_Syntax.Tm_let ((is_rec, source_lbs), body) -> (
        let mk_pat a =
          FStar_Parser_AST.mk_pattern a t.FStar_Syntax_Syntax.pos
        in
        let uu____3649 = FStar_Syntax_Subst.open_let_rec source_lbs body in
        match uu____3649 with source_lbs1, body1 ->
          let resugar_one_binding bnd =
            ...
            let uu____3705 =
              ...
              in
              FStar_Syntax_Subst.open_univ_vars bnd.FStar_Syntax_Syntax.lbunivs
                uu____3710
            in
            match uu____3705 with univs1, td ->
              let uu____3729 =
                let uu____3738 =
                  let uu____3739 = FStar_Syntax_Subst.compress td in
                  uu____3739.FStar_Syntax_Syntax.n
                in
                match uu____3738 with
                | FStar_Syntax_Syntax.Tm_app
                    (uu____3750, [(t1, uu____3752); (d, uu____3754)]) ->
                    (t1, d)
                | uu____3797 -> failwith "wrong let binding format"
              in
              match uu____3729 with typ, def ->
                let uu____3832 =
                  let uu____3839 =
                  ...
                  | FStar_Syntax_Syntax.Tm_abs (b, t1, uu____3851) -> (
                      let uu____3872 = FStar_Syntax_Subst.open_term b t1 in
                      match uu____3872 with b1, t2 ->
                        let b2 =
                          let uu____3886 = FStar_Options.print_implicits () in
                          if uu____3886 then b1 else filter_imp b1
                        in
                        (b2, t2, true) )
                  | uu____3888 -> ([], def, false)
                in
                match uu____3832 with binders, term, is_pat_app ->
                  let uu____3920 =
                    ...
                    | FStar_Util.Inl bv ->
                        let uu____3931 =
                          let uu____3932 =
                            let uu____3933 =
                              let uu____3940 = bv_as_unique_ident bv in
                              (uu____3940, FStar_Pervasives_Native.None)
                            in
                            FStar_Parser_AST.PatVar uu____3933
                          in
                          mk_pat uu____3932
                        in
                        (uu____3931, term)
                  in
                  match uu____3920 with pat, term1 ->
                    let uu____3961 =
                      if is_pat_app then
                        let args =
                          FStar_All.pipe_right binders
                            ((map_opt ()) (fun uu____3993 ->
                                 match uu____3993 with bv, q ->
                                   let uu____4008 = resugar_arg_qual q in
                                   FStar_Util.map_opt uu____4008 (fun q1 ->
                                       let uu____4020 =
                                         let uu____4021 =
                                           let uu____4028 =
                                           ...
                                           (uu____4028, q1)
                                         in
                                         FStar_Parser_AST.PatVar uu____4021
                                       in
                                       mk_pat uu____4020 ) ))
                        in
                        let uu____4031 =
                          let uu____4036 = resugar_term term1 in
                          ( mk_pat (FStar_Parser_AST.PatApp (pat, args))
                          , uu____4036 )
                        in
                        let uu____4039 = universe_to_string univs1 in
                        ...
                        let uu____4045 =
                          ...
                          (pat, uu____4050)
                        in
                        let uu____4051 = universe_to_string univs1 in
          ...
          mk1
            (FStar_Parser_AST.Let
               ( ( if is_rec then FStar_Parser_AST.Rec
                 else FStar_Parser_AST.NoLetQualifier )
               , bnds
               , body2 )) )
    | FStar_Syntax_Syntax.Tm_uvar (u, uu____4281) ->
        let s =
          let uu____4307 =
            ...
            FStar_All.pipe_right uu____4308 FStar_Util.string_of_int
          in
          Prims.strcat "?u" uu____4307
        in
        let uu____4309 = mk1 FStar_Parser_AST.Wild in
        label s uu____4309
    | FStar_Syntax_Syntax.Tm_meta (e, m) -> (
        let resugar_meta_desugared uu___72_4319 =
          ...
          | FStar_Syntax_Syntax.Data_app -> (
                    ...
                    let uu____4545 =
                      let uu____4550 =
                        let uu____4551 =
                          ...
                          parser_term_to_string uu____4552
                        in
                        FStar_Util.format1 "Not an application or a fv %s"
                          uu____4551
                      in
                      (FStar_Errors.Fatal_NotApplicationOrFv, uu____4550)
                    in
              ...
              let uu____4569 =
                ...
                with FStar_Errors.Err uu____4642 ->
                  let uu____4647 =
                    let uu____4652 =
                      let uu____4653 =
                        let uu____4654 = resugar_term e in
                        parser_term_to_string uu____4654
                      in
                  ...
                  in
                  FStar_Errors.raise_error uu____4647 e.FStar_Syntax_Syntax.pos
              in
              match uu____4569 with head1, universes, args ->
                let universes1 =
                  FStar_List.map
                    (fun u ->
                      let uu____4708 =
                      ...
                      in
                      (uu____4708, FStar_Parser_AST.UnivApp) )
                    universes
                in
                let args1 =
                  FStar_List.filter_map
                    (fun uu____4732 ->
                      match uu____4732 with t1, q ->
                ...
                let args2 =
                  ...
                  in
                  if uu____4782 then args1
                  else FStar_List.append universes1 args1
                in
                ...
                | FStar_Parser_AST.Ascribed (t11, t2, t3) ->
                    let uu____4866 =
                      let uu____4867 =
                        ...
                        (uu____4876, t2, t3)
                      in
                      FStar_Parser_AST.Ascribed uu____4867
                    in
                    mk1 uu____4866
                | uu____4879 -> t1
              in
          ...
          | FStar_Syntax_Syntax.Mutable_rval ->
              ...
              let uu____4927 =
                ...
                uu____4928.FStar_Syntax_Syntax.n
              in
        ...
        | FStar_Syntax_Syntax.Meta_pattern pats ->
            let pats1 =
              FStar_All.pipe_right (FStar_List.flatten pats)
                (FStar_List.map (fun uu____5002 ->
                     match uu____5002 with x, uu____5008 -> resugar_term x ))
            in
            mk1 (FStar_Parser_AST.Attributes pats1)
        | FStar_Syntax_Syntax.Meta_labeled (l, uu____5010, p) ->
            let uu____5012 =
              let uu____5013 =
                let uu____5020 = resugar_term e in
                (uu____5020, l, p)
              in
              FStar_Parser_AST.Labeled uu____5013
            in
            mk1 uu____5012
        ...
        | FStar_Syntax_Syntax.Meta_alien (uu____5022, s, uu____5024) -> (
          ...
          | uu____5029 ->
              ...
              resugar_term e )
        | FStar_Syntax_Syntax.Meta_named t1 -> mk1 (FStar_Parser_AST.Name t1)
                    ...
                    let uu____5051 =
                      let uu____5062 =
                        let uu____5069 =
                          ...
                          (uu____5074, FStar_Parser_AST.Nothing)
                        in
                        [uu____5069]
                      in
                      (name1, uu____5062)
                    in
                    FStar_Parser_AST.Construct uu____5051
                  in
                  mk1 uu____5050
                in
                (uu____5048, uu____5049, FStar_Pervasives_Native.None)
              in
              FStar_Parser_AST.Ascribed uu____5039
            in
            mk1 uu____5038
                    ...
                    let uu____5111 =
                      let uu____5122 =
                        let uu____5129 =
                          ...
                          (uu____5134, FStar_Parser_AST.Nothing)
                        in
                        [uu____5129]
                      in
                      (name1, uu____5122)
                    in
                    FStar_Parser_AST.Construct uu____5111
                  in
                  mk1 uu____5110
                in
                (uu____5108, uu____5109, FStar_Pervasives_Native.None)
              in
              FStar_Parser_AST.Ascribed uu____5099
            in
            mk1 uu____5098 )
...
and resugar_comp : FStar_Syntax_Syntax.comp -> FStar_Parser_AST.term =
  fun c ->
    let mk1 a =
      FStar_Parser_AST.mk_term a c.FStar_Syntax_Syntax.pos FStar_Parser_AST.Un
    in
    ...
    | FStar_Syntax_Syntax.Comp c1 ->
        let result =
          ...
          (uu____5284, FStar_Parser_AST.Nothing)
        in
        let uu____5285 = FStar_Options.print_effect_args () in
        if uu____5285 then
          let universe =
            FStar_List.map
              (fun u -> resugar_universe u)
              c1.FStar_Syntax_Syntax.comp_univs
          in
          let args =
            if FStar_Ident.lid_equals c1.FStar_Syntax_Syntax.effect_name
            ...
            then
              ...
              | [pre; post; pats] ->
                  let post1 =
                    ...
                    in
                    (uu____5372, FStar_Pervasives_Native.snd post)
                  in
                  let uu____5381 =
                    let uu____5390 =
                  ...
                  let uu____5420 =
                    let uu____5429 =
                      ...
                      in
                      if uu____5438 then [] else [pats]
                    in
                    FStar_List.append [post1] uu____5429
                  in
          ...
          let args1 =
            FStar_List.map
              (fun uu____5521 ->
                match uu____5521 with e, uu____5531 ->
                  let uu____5532 = resugar_term e in
                  (uu____5532, FStar_Parser_AST.Nothing) )
              args
          in
            ...
            | hd1 :: tl1 ->
              ...
              | FStar_Syntax_Syntax.DECREASES e ->
                  let e1 =
                    ...
                    (uu____5586, FStar_Parser_AST.Nothing)
                  in
                  aux (e1 :: l) tl1
...
and resugar_binder
    : FStar_Syntax_Syntax.binder -> FStar_Range.range
      -> FStar_Parser_AST.binder FStar_Pervasives_Native.option =
  fun b r ->
    let uu____5636 = b in
    match uu____5636 with x, aq ->
      let uu____5641 = resugar_arg_qual aq in
      FStar_Util.map_opt uu____5641 (fun imp ->
          let e = resugar_term x.FStar_Syntax_Syntax.sort in
          match e.FStar_Parser_AST.tm with
          | FStar_Parser_AST.Wild ->
              let uu____5655 =
                let uu____5656 = bv_as_unique_ident x in
                FStar_Parser_AST.Variable uu____5656
              in
              ...
              if uu____5658 then
                ...
                let uu____5660 =
                  let uu____5661 =
                    ...
                    (uu____5666, e)
                  in
                  FStar_Parser_AST.Annotated uu____5661
                in
...
and resugar_bv_as_pat
  ...
  fun x qual ->
    let mk1 a =
      ...
      FStar_Parser_AST.mk_pattern a uu____5675
    in
    let uu____5676 =
      let uu____5677 =
        FStar_Syntax_Subst.compress x.FStar_Syntax_Syntax.sort
      in
      uu____5677.FStar_Syntax_Syntax.n
    in
    match uu____5676 with
    | FStar_Syntax_Syntax.Tm_unknown ->
        let i =
          FStar_String.compare x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText
        ...
        if i = Prims.parse_int "0" then
          ...
          FStar_Util.bind_opt uu____5687 (fun aq ->
              let uu____5699 =
                let uu____5700 =
                  let uu____5701 =
                    ...
                    (uu____5708, aq)
                  in
                  FStar_Parser_AST.PatVar uu____5701
                in
                mk1 uu____5700
              in
    ...
    | uu____5711 ->
        ...
        FStar_Util.bind_opt uu____5712 (fun aq ->
            let pat =
              let uu____5727 =
                let uu____5728 =
                  ...
                  (uu____5735, aq)
                in
                FStar_Parser_AST.PatVar uu____5728
              in
              mk1 uu____5727
            in
            ...
            if uu____5738 then
              let uu____5741 =
                let uu____5742 =
                  let uu____5743 =
                    let uu____5748 = resugar_term x.FStar_Syntax_Syntax.sort in
                    (pat, uu____5748)
                  in
                  FStar_Parser_AST.PatAscribed uu____5743
                in
                mk1 uu____5742
              in
...
and resugar_pat : FStar_Syntax_Syntax.pat -> FStar_Parser_AST.pattern =
  fun p ->
    ...
    let to_arg_qual bopt =
      FStar_Util.bind_opt bopt (fun b ->
          if b then FStar_Pervasives_Native.Some FStar_Parser_AST.Implicit
          else FStar_Pervasives_Native.None )
    in
    let rec aux p1 imp_opt =
      match p1.FStar_Syntax_Syntax.v with
      | FStar_Syntax_Syntax.Pat_constant c -> mk1 (FStar_Parser_AST.PatConst c)
        ...
        when FStar_Parser_Const.is_tuple_data_lid'
          ...
          let uu____5867 =
            FStar_Parser_Const.is_dtuple_data_lid'
              fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v
          in
          if uu____5867 then mk1 (FStar_Parser_AST.PatTuple (args1, true))
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let fields1 =
            ...
            in
            FStar_All.pipe_right uu____5901 FStar_List.rev
          in
          let args1 =
            let uu____5917 =
              FStar_All.pipe_right args
                (FStar_List.map (fun uu____5937 ->
                     match uu____5937 with p2, b ->
                       aux p2 (FStar_Pervasives_Native.Some b) ))
            in
            FStar_All.pipe_right uu____5917 FStar_List.rev
          in
          let rec map21 l1 l2 =
            match (l1, l2) with
            | [], [] -> []
            ...
            | hd1 :: tl1, hd2 :: tl2 ->
                let uu____6030 = map21 tl1 tl2 in
                (hd1, hd2) :: uu____6030
          in
          let args2 =
            let uu____6048 = map21 fields1 args1 in
            FStar_All.pipe_right uu____6048 FStar_List.rev
          in
          ...
          | FStar_Pervasives_Native.Some (op, uu____6117) ->
              mk1
                (FStar_Parser_AST.PatOp
                   (FStar_Ident.mk_ident
                      (op, v1.FStar_Syntax_Syntax.ppname.FStar_Ident.idRange)))
          | FStar_Pervasives_Native.None ->
              let uu____6126 =
                let uu____6127 =
                ...
                in
                FStar_Parser_AST.PatVar uu____6127
              in
              mk1 uu____6126 )
      | FStar_Syntax_Syntax.Pat_wild uu____6140 -> mk1 FStar_Parser_AST.PatWild
      | FStar_Syntax_Syntax.Pat_dot_term (bv, term) ->
          let pat =
            let uu____6148 =
              let uu____6149 =
                ...
                , FStar_Pervasives_Native.Some FStar_Parser_AST.Implicit )
              in
              FStar_Parser_AST.PatVar uu____6149
            in
            mk1 uu____6148
          in
          ...
          if uu____6159 then
            let uu____6160 =
              let uu____6161 =
                let uu____6166 = resugar_term term in
                (pat, uu____6166)
              in
              FStar_Parser_AST.PatAscribed uu____6161
            in
            mk1 uu____6160
          else pat
    in
...
let resugar_qualifier
  ...
  fun uu___74_6172 ->
    ...
    | FStar_Syntax_Syntax.Visible_default ->
        if true then FStar_Pervasives_Native.None
    ...
    | FStar_Syntax_Syntax.Discriminator uu____6182 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Projector uu____6183 -> FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordType uu____6188 -> FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordConstructor uu____6197 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Action uu____6206 -> FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.ExceptionConstructor -> FStar_Pervasives_Native.None
  ...
  fun datacon_ses se ->
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ
      ...
      -> (
        ...
        in
        match uu____6246 with current_datacons, other_datacons ->
          let bs1 =
            let uu____6302 = FStar_Options.print_implicits () in
            if uu____6302 then bs else filter_imp bs
          in
          let bs2 =
          ...
          let tyc =
            let uu____6312 =
              FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                (FStar_Util.for_some (fun uu___76_6317 ->
                     match uu___76_6317 with
                     | FStar_Syntax_Syntax.RecordType uu____6318 -> true
                     | uu____6327 -> false ))
            in
            if uu____6312 then
              let resugar_datacon_as_fields fields se1 =
                ...
                | FStar_Syntax_Syntax.Sig_datacon
                  ...
                  -> (
                    let uu____6385 =
                      ...
                      uu____6386.FStar_Syntax_Syntax.n
                    in
                    match uu____6385 with
                    | FStar_Syntax_Syntax.Tm_arrow (bs3, uu____6400) ->
                        let mfields =
                          FStar_All.pipe_right bs3
                            (FStar_List.map (fun uu____6461 ->
                                 match uu____6461 with b, qual ->
                                   let uu____6476 =
                                     let uu____6477 = bv_as_unique_ident b in
                                     FStar_Syntax_Util.unmangle_field_name
                                       uu____6477
                                   in
                                   let uu____6478 =
                                     resugar_term b.FStar_Syntax_Syntax.sort
                                   in
                                   ( uu____6476
                                   , uu____6478
                                   , FStar_Pervasives_Native.None ) ))
                ...
                | uu____6500 -> failwith "unexpected"
              in
              let fields =
                ...
                | FStar_Syntax_Syntax.Sig_datacon
                    ...
                    let c =
                      let uu____6641 =
                        ...
                        FStar_Pervasives_Native.Some uu____6644
                      in
                      ( l.FStar_Ident.ident
                      , uu____6641
                      , FStar_Pervasives_Native.None
                    ...
                    in
                    c :: constructors
                | uu____6661 -> failwith "unexpected"
              in
              let constructors =
                FStar_List.fold_left resugar_datacon [] current_datacons
              in
...
let mk_decl
    : FStar_Range.range -> FStar_Syntax_Syntax.qualifier Prims.list
...
let decl'_to_decl
    : FStar_Syntax_Syntax.sigelt -> FStar_Parser_AST.decl'
      -> FStar_Parser_AST.decl =
  fun se d' ->
    mk_decl se.FStar_Syntax_Syntax.sigrng se.FStar_Syntax_Syntax.sigquals d'
...
let resugar_tscheme'
  ...
  fun name ts ->
    ...
    match uu____6768 with univs1, typ ->
      let name1 = FStar_Ident.mk_ident (name, typ.FStar_Syntax_Syntax.pos) in
      let uu____6776 =
        let uu____6777 =
          let uu____6790 =
            let uu____6799 =
              let uu____6806 =
                ...
                in
                FStar_Parser_AST.TyconAbbrev uu____6807
              in
          ...
          (false, uu____6790)
        in
        FStar_Parser_AST.Tycon uu____6777
      in
...
let resugar_eff_decl
    : Prims.bool -> FStar_Range.range
      -> FStar_Syntax_Syntax.qualifier Prims.list
      -> FStar_Syntax_Syntax.eff_decl -> FStar_Parser_AST.decl =
  fun for_free r q ed ->
    let resugar_action d for_free1 =
      let action_params =
        FStar_Syntax_Subst.open_binders d.FStar_Syntax_Syntax.action_params
      in
      let uu____6874 =
        FStar_Syntax_Subst.open_term action_params
          d.FStar_Syntax_Syntax.action_defn
      in
      match uu____6874 with bs, action_defn ->
        let uu____6881 =
          FStar_Syntax_Subst.open_term action_params
            d.FStar_Syntax_Syntax.action_typ
        in
        match uu____6881 with bs1, action_typ ->
          let action_params1 =
            let uu____6889 = FStar_Options.print_implicits () in
            if uu____6889 then action_params else filter_imp action_params
          in
          let action_params2 =
            let uu____6894 =
            ...
            in
            FStar_All.pipe_right uu____6894 FStar_List.rev
          in
          ...
          if for_free1 then
            let a =
              let uu____6908 =
                let uu____6919 = FStar_Ident.lid_of_str "construct" in
                ( uu____6919
                , [ (action_defn1, FStar_Parser_AST.Nothing)
                  ; (action_typ1, FStar_Parser_AST.Nothing) ] )
              in
              FStar_Parser_AST.Construct uu____6908
            in
    ...
    in
    match uu____6993 with eff_binders, eff_typ ->
      let eff_binders1 =
      ...
      let eff_binders2 =
        let uu____7006 =
          FStar_All.pipe_right eff_binders1
            ((map_opt ()) (fun b -> resugar_binder b r))
        in
        FStar_All.pipe_right uu____7006 FStar_List.rev
      in
      let eff_typ1 = resugar_term eff_typ in
      let ret_wp = resugar_tscheme' "ret_wp" ed.FStar_Syntax_Syntax.ret_wp in
      let bind_wp = resugar_tscheme' "bind_wp" ed.FStar_Syntax_Syntax.ret_wp in
      let if_then_else1 =
        resugar_tscheme' "if_then_else" ed.FStar_Syntax_Syntax.if_then_else
      in
      let ite_wp = resugar_tscheme' "ite_wp" ed.FStar_Syntax_Syntax.ite_wp in
      let stronger =
      ...
      in
      let null_wp =
        resugar_tscheme' "null_wp" ed.FStar_Syntax_Syntax.null_wp
      in
      let trivial =
        resugar_tscheme' "trivial" ed.FStar_Syntax_Syntax.trivial
      in
      let repr = resugar_tscheme' "repr" ([], ed.FStar_Syntax_Syntax.repr) in
      let return_repr =
        resugar_tscheme' "return_repr" ed.FStar_Syntax_Syntax.return_repr
      in
      let bind_repr =
...
let resugar_sigelt
  ...
  fun se ->
    ...
    | FStar_Syntax_Syntax.Sig_bundle (ses, uu____7063) -> (
        ...
        in
        match uu____7072 with decl_typ_ses, datacon_ses ->
          let retrieve_datacons_and_resugar uu____7165 se1 =
            match uu____7165 with datacon_ses1, tycons ->
              let uu____7191 = resugar_typ datacon_ses1 se1 in
              match uu____7191 with datacon_ses2, tyc ->
          ...
          in
          match uu____7206 with leftover_datacons, tycons ->
                ...
                let uu____7241 =
                  let uu____7242 =
                    let uu____7243 =
                      let uu____7256 =
                        FStar_List.map
                          (fun tyc -> (tyc, FStar_Pervasives_Native.None))
                          tycons
                      in
                      (false, uu____7256)
                    in
                    FStar_Parser_AST.Tycon uu____7243
                  in
                  decl'_to_decl se uu____7242
                in
                  ...
                  let uu____7296 =
                    decl'_to_decl se1
                      (FStar_Parser_AST.Exception
                         (l.FStar_Ident.ident, FStar_Pervasives_Native.None))
                  in
                  FStar_Pervasives_Native.Some uu____7296
              | uu____7299 -> failwith "wrong format for resguar to Exception"
              )
            | uu____7302 -> failwith "Should not happen hopefully" )
    | FStar_Syntax_Syntax.Sig_let (lbs, uu____7308) -> (
        let uu____7313 =
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some (fun uu___77_7319 ->
                 ...
                 | uu____7323 -> false ))
        in
        if uu____7313 then FStar_Pervasives_Native.None
        else
          let mk1 e =
          ...
          | FStar_Parser_AST.Let (isrec, lets, uu____7346) ->
              let uu____7375 =
                let uu____7376 =
                  let uu____7377 =
                    let uu____7388 =
                      FStar_List.map FStar_Pervasives_Native.snd lets
                    in
                    (isrec, uu____7388)
                  in
                  FStar_Parser_AST.TopLevelLet uu____7377
                in
                decl'_to_decl se uu____7376
              in
        ...
        let uu____7431 =
          let uu____7432 =
            let uu____7433 =
              ...
              (lid.FStar_Ident.ident, uu____7438)
            in
            FStar_Parser_AST.Assume uu____7433
          in
          decl'_to_decl se uu____7432
        in
    ...
    | FStar_Syntax_Syntax.Sig_effect_abbrev (lid, vs, bs, c, flags1) -> (
        ...
        match uu____7528 with bs1, c1 ->
          let bs2 =
            let uu____7538 = FStar_Options.print_implicits () in
            if uu____7538 then bs1 else filter_imp bs1
          in
          let bs3 =
            FStar_All.pipe_right bs2
              ((map_opt ()) (fun b ->
                   resugar_binder b se.FStar_Syntax_Syntax.sigrng ))
          in
          let uu____7547 =
            let uu____7548 =
              let uu____7549 =
                  ...
                  let uu____7571 =
                    let uu____7578 =
                      let uu____7579 =
                        ...
                        , uu____7592 )
                      in
                      FStar_Parser_AST.TyconAbbrev uu____7579
                    in
                ...
                (false, uu____7562)
              in
              FStar_Parser_AST.Tycon uu____7549
            in
            decl'_to_decl se uu____7548
          in
          FStar_Pervasives_Native.Some uu____7547 )
    | FStar_Syntax_Syntax.Sig_pragma p ->
        let uu____7620 =
          decl'_to_decl se (FStar_Parser_AST.Pragma (resugar_pragma p))
        in
        FStar_Pervasives_Native.Some uu____7620
    | FStar_Syntax_Syntax.Sig_declare_typ (lid, uvs, t) ->
        let uu____7624 =
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some (fun uu___78_7630 ->
                 ...
                 | uu____7634 -> false ))
        in
        if uu____7624 then FStar_Pervasives_Native.None
        else
          let t' =
            let uu____7639 =
              (let uu____7642 = FStar_Options.print_universes () in
               Prims.op_Negation uu____7642)
              || FStar_List.isEmpty uvs
            in
            if uu____7639 then resugar_term t
            else
              let uu____7644 = FStar_Syntax_Subst.open_univ_vars uvs t in
              match uu____7644 with uvs1, t1 ->
                let universes = universe_to_string uvs1 in
                let uu____7652 = resugar_term t1 in
                label universes uu____7652
          in
          let uu____7653 =
            decl'_to_decl se (FStar_Parser_AST.Val (lid.FStar_Ident.ident, t'))
          in
