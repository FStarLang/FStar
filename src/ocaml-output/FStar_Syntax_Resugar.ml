...
let rec resugar_term: FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
        ...
        (match uu____721 with
         | (xs1,body1) ->
             ...
             let rec aux body3 uu___198_745 =
               match uu___198_745 with
               | [] -> body3
               | hd1::tl1 ->
    ...
    | FStar_Syntax_Syntax.Tm_app (e,args) ->
        let rec last1 uu___199_803 =
          match uu___199_803 with
          | hd1::[] -> [hd1]
          | hd1::tl1 -> last1 tl1
          | uu____850 -> failwith "last of an empty list" in
        let rec last_two uu___200_874 =
          match uu___200_874 with
          | []|_::[] ->
              failwith
                "last two elements of a list with less than two elements "
          | a1::a2::[] -> [a1; a2]
          | uu____937::t1 -> last_two t1 in
        let rec last_three uu___201_965 =
          match uu___201_965 with
          | []|_::[]|_::_::[] ->
              failwith
    ...
    | FStar_Syntax_Syntax.Tm_meta (e,m) ->
        let resugar_meta_desugared uu___202_2573 =
          match uu___202_2573 with
