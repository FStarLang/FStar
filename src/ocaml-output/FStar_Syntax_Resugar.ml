...
let filter_pattern_imp :
  'Auu____170 .
    ('Auu____170,Prims.bool) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list
      ->
      ('Auu____170,Prims.bool) FStar_Pervasives_Native_Tuple2.tuple2
        Prims.list
  =
  fun xs  ->
    FStar_List.filter
...
let (string_to_op :
  ...
  =
  fun s  ->
    let name_of_op uu___202_510 =
      match uu___202_510 with
      | "Amp" ->
...
let rec (resugar_term_as_op :
  FStar_Syntax_Syntax.term ->
    (Prims.string,expected_arity) FStar_Pervasives_Native_Tuple2.tuple2
      FStar_Pervasives_Native.option)
  =
  fun t  ->
    let infix_prim_ops =
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
          ...
          (match uu____2319 with
           | (xs1,body1) ->
               ...
               let rec aux body3 uu___203_2365 =
                 match uu___203_2365 with
                 | [] -> body3
                 | hd1::tl1 ->
                     let body4 =
      ...
      | FStar_Syntax_Syntax.Tm_app (e,args) ->
          let rec last1 uu___204_2520 =
            match uu___204_2520 with
            | hd1::[] -> [hd1]
            | hd1::tl1 -> last1 tl1
            | uu____2590 -> failwith "last of an empty list"  in
          let rec last_two uu___205_2629 =
            match uu___205_2629 with
            | [] ->
                failwith
      ...
      | FStar_Syntax_Syntax.Tm_meta (e,m) ->
          let resugar_meta_desugared uu___206_5737 =
            match uu___206_5737 with
          ...
          then
            ...
            let args1 =
              FStar_List.map
               ...
               in
            let rec aux l uu___207_6360 =
              match uu___207_6360 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
