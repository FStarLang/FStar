...
let string_to_op:
  ...
  =
  fun s  ->
    let name_of_op uu___194_378 =
      match uu___194_378 with
...
let rec resugar_term: FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
        ...
        (match uu____1181 with
         | (xs1,body1) ->
             ...
             let rec aux body3 uu___195_1214 =
               match uu___195_1214 with
               | [] -> body3
               | hd1::tl1 ->
    ...
    | FStar_Syntax_Syntax.Tm_app (e,args) ->
        let rec last1 uu___196_1296 =
          match uu___196_1296 with
          | hd1::[] -> [hd1]
          | hd1::tl1 -> last1 tl1
          | uu____1366 -> failwith "last of an empty list" in
        let rec last_two uu___197_1402 =
          match uu___197_1402 with
          | [] ->
              failwith
        ...
        let rec last_three uu___198_1551 =
          match uu___198_1551 with
          | [] ->
              failwith
    ...
    | FStar_Syntax_Syntax.Tm_meta (e,m) ->
        let resugar_meta_desugared uu___200_3997 =
          match uu___200_3997 with
            ...
            then
              ...
              | pre::post::pats::[] ->
                  let post1 =
                    ...
                    (uu____4958, (FStar_Pervasives_Native.snd post)) in
                  let uu____4967 =
                    let uu____4976 =
                      FStar_Syntax_Util.is_fvar FStar_Parser_Const.true_lid
                        (FStar_Pervasives_Native.fst pre) in
                    if uu____4976 then [] else [pre] in
                  let uu____5006 =
                    let uu____5015 =
                      let uu____5024 =
                        FStar_Syntax_Util.is_fvar FStar_Parser_Const.nil_lid
                          (FStar_Pervasives_Native.fst pats) in
                      if uu____5024 then [] else [pats] in
                    FStar_List.append [post1] uu____5015 in
                  FStar_List.append uu____4967 uu____5006
              | uu____5078 -> c1.FStar_Syntax_Syntax.effect_args
          ...
          let args1 =
            FStar_List.map
              (fun uu____5107  ->
                 ...
                 | (e,uu____5117) ->
                     let uu____5118 = resugar_term e in
                     (uu____5118, FStar_Parser_AST.Nothing)) args in
          let rec aux l uu___201_5139 =
            match uu___201_5139 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
                 | FStar_Syntax_Syntax.DECREASES e ->
                     let e1 =
                       let uu____5172 = resugar_term e in
                       (uu____5172, FStar_Parser_AST.Nothing) in
                     aux (e1 :: l) tl1
                 | uu____5177 -> aux l tl1) in
...
and resugar_binder:
  ...
  fun b  ->
    fun r  ->
      ...
      | (x,aq) ->
          let uu____5227 = resugar_arg_qual aq in
          FStar_Util.map_opt uu____5227
            (fun imp  ->
               let e = resugar_term x.FStar_Syntax_Syntax.sort in
               match e.FStar_Parser_AST.tm with
               | FStar_Parser_AST.Wild  ->
                   let uu____5241 =
                     let uu____5242 = bv_as_unique_ident x in
                     FStar_Parser_AST.Variable uu____5242 in
                   FStar_Parser_AST.mk_binder uu____5241 r
                     FStar_Parser_AST.Type_level imp
               | uu____5243 ->
                   let uu____5244 = FStar_Syntax_Syntax.is_null_bv x in
                   if uu____5244
                   then
                     ...
                     (let uu____5246 =
                        let uu____5247 =
                          let uu____5252 = bv_as_unique_ident x in
                          (uu____5252, e) in
                        FStar_Parser_AST.Annotated uu____5247 in
                      FStar_Parser_AST.mk_binder uu____5246 r
                        FStar_Parser_AST.Type_level imp))
and resugar_bv_as_pat:
  ...
  fun x  ->
    fun qual  ->
      let mk1 a =
        let uu____5261 = FStar_Syntax_Syntax.range_of_bv x in
        FStar_Parser_AST.mk_pattern a uu____5261 in
      let uu____5262 =
        let uu____5263 =
          FStar_Syntax_Subst.compress x.FStar_Syntax_Syntax.sort in
        uu____5263.FStar_Syntax_Syntax.n in
      ...
      | FStar_Syntax_Syntax.Tm_unknown  ->
          ...
          then
            let uu____5271 = mk1 FStar_Parser_AST.PatWild in
            FStar_Pervasives_Native.Some uu____5271
          else
            (let uu____5273 = resugar_arg_qual qual in
             FStar_Util.bind_opt uu____5273
               (fun aq  ->
                  let uu____5285 =
                    let uu____5286 =
                      let uu____5287 =
                        let uu____5294 = bv_as_unique_ident x in
                        (uu____5294, aq) in
                      FStar_Parser_AST.PatVar uu____5287 in
                    mk1 uu____5286 in
                  FStar_Pervasives_Native.Some uu____5285))
      | uu____5297 ->
          let uu____5298 = resugar_arg_qual qual in
          FStar_Util.bind_opt uu____5298
            (fun aq  ->
               let pat =
                 let uu____5313 =
                   let uu____5314 =
                     let uu____5321 = bv_as_unique_ident x in
                     (uu____5321, aq) in
                   FStar_Parser_AST.PatVar uu____5314 in
                 mk1 uu____5313 in
               let uu____5324 = FStar_Options.print_bound_var_types () in
               if uu____5324
               then
                 let uu____5327 =
                   let uu____5328 =
                     let uu____5329 =
                       ...
                       (pat, uu____5334) in
                     FStar_Parser_AST.PatAscribed uu____5329 in
                   mk1 uu____5328 in
  ...
  fun p  ->
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ({ FStar_Syntax_Syntax.fv_name = uu____5459;
             FStar_Syntax_Syntax.fv_delta = uu____5460;
          ...
          let args1 =
            ...
            FStar_All.pipe_right uu____5503 FStar_List.rev in
          let rec map21 l1 l2 =
            match (l1, l2) with
            | ([],[]) -> []
            | ([],hd1::tl1) -> []
            | (hd1::tl1,[]) ->
                let uu____5593 = map21 tl1 [] in
                (hd1, (mk1 FStar_Parser_AST.PatWild)) :: uu____5593
            | (hd1::tl1,hd2::tl2) ->
                let uu____5616 = map21 tl1 tl2 in (hd1, hd2) :: uu____5616 in
          let args2 =
            let uu____5634 = map21 fields1 args1 in
            FStar_All.pipe_right uu____5634 FStar_List.rev in
      ...
      | FStar_Syntax_Syntax.Pat_var v1 ->
          ...
          (match uu____5695 with
           | FStar_Pervasives_Native.Some (op,uu____5703) ->
               mk1
           ...
           | FStar_Pervasives_Native.None  ->
               let uu____5712 =
                 let uu____5713 =
                   ...
                   let uu____5721 = to_arg_qual imp_opt in
                   (uu____5720, uu____5721) in
                 FStar_Parser_AST.PatVar uu____5713 in
               mk1 uu____5712)
      | FStar_Syntax_Syntax.Pat_wild uu____5726 ->
          mk1 FStar_Parser_AST.PatWild
      | FStar_Syntax_Syntax.Pat_dot_term (bv,term) ->
          let pat =
            let uu____5734 =
              let uu____5735 =
                let uu____5742 = bv_as_unique_ident bv in
                (uu____5742,
                  (FStar_Pervasives_Native.Some FStar_Parser_AST.Implicit)) in
              FStar_Parser_AST.PatVar uu____5735 in
            mk1 uu____5734 in
          let uu____5745 = FStar_Options.print_bound_var_types () in
          if uu____5745
          then
            let uu____5746 =
              let uu____5747 =
                let uu____5752 = resugar_term term in (pat, uu____5752) in
              FStar_Parser_AST.PatAscribed uu____5747 in
            mk1 uu____5746
          else pat in
  ...
  fun datacon_ses  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_inductive_typ
          (tylid,uvs,bs,t,uu____5826,datacons) ->
          let uu____5836 =
              ...
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | FStar_Syntax_Syntax.Sig_datacon
                        (uu____5863,uu____5864,uu____5865,inductive_lid,uu____5867,uu____5868)
                        -> FStar_Ident.lid_equals inductive_lid tylid
                    | uu____5873 -> failwith "unexpected")) in
          (match uu____5836 with
           | (current_datacons,other_datacons) ->
               let bs1 =
                 let uu____5892 = FStar_Options.print_implicits () in
                 if uu____5892 then bs else filter_imp bs in
               let bs2 =
               ...
               let tyc =
                 let uu____5902 =
                   FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                     (FStar_Util.for_some
                        (fun uu___204_5907  ->
                           match uu___204_5907 with
                           | FStar_Syntax_Syntax.RecordType uu____5908 ->
                               true
                           | uu____5917 -> false)) in
                 if uu____5902
                 then
                   let resugar_datacon_as_fields fields se1 =
                     match se1.FStar_Syntax_Syntax.sigel with
                     | FStar_Syntax_Syntax.Sig_datacon
                         (uu____5965,univs1,term,uu____5968,num,uu____5970)
                         ->
                         let uu____5975 =
                           let uu____5976 = FStar_Syntax_Subst.compress term in
                           uu____5976.FStar_Syntax_Syntax.n in
                         (match uu____5975 with
                          | FStar_Syntax_Syntax.Tm_arrow (bs3,uu____5990) ->
                              let mfields =
                                  ...
                                  (FStar_List.map
                                     (fun uu____6051  ->
                                        ...
                                        | (b,qual) ->
                                            ...
                                            (uu____6066, uu____6068,
                                              FStar_Pervasives_Native.None))) in
                              FStar_List.append mfields fields
                          | uu____6079 -> failwith "unexpected")
                     | uu____6090 -> failwith "unexpected" in
                   let fields =
                   ...
                   (let resugar_datacon constructors se1 =
                      match se1.FStar_Syntax_Syntax.sigel with
                      | FStar_Syntax_Syntax.Sig_datacon
                          (l,univs1,term,uu____6211,num,uu____6213) ->
                          let c =
                            let uu____6231 =
                              let uu____6234 = resugar_term term in
                              FStar_Pervasives_Native.Some uu____6234 in
                            ((l.FStar_Ident.ident), uu____6231,
                              FStar_Pervasives_Native.None, false) in
                          c :: constructors
                      | uu____6251 -> failwith "unexpected" in
                    let constructors =
...
let mk_decl:
  ...
  fun r  ->
    fun q  ->
      fun d'  ->
        let uu____6348 = FStar_List.choose resugar_qualifier q in
        {
          FStar_Parser_AST.d = d';
          FStar_Parser_AST.drange = r;
          FStar_Parser_AST.doc = FStar_Pervasives_Native.None;
          FStar_Parser_AST.quals = uu____6348;
    ...
    fun r  ->
      fun q  ->
        fun ed  ->
          let resugar_action d for_free1 =
            ...
            | (bs,action_defn) ->
                ...
                (match uu____6483 with
                 | (bs1,action_typ) ->
                     let action_params1 =
                       let uu____6491 = FStar_Options.print_implicits () in
                       if uu____6491
                       then action_params
                     ...
                     let action_params2 =
                       ...
                       FStar_All.pipe_right uu____6496 FStar_List.rev in
                     ...
                     then
                       let a =
                         ...
                         FStar_Parser_AST.Construct uu____6510 in
                       let t =
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                let uu____6603 = FStar_Options.print_implicits () in
                if uu____6603 then eff_binders else filter_imp eff_binders in
              let eff_binders2 =
                let uu____6608 =
                  FStar_All.pipe_right eff_binders1
                    (map_opt (fun b  -> resugar_binder b r)) in
                FStar_All.pipe_right uu____6608 FStar_List.rev in
...
let resugar_sigelt:
  ...
  fun se  ->
    match se.FStar_Syntax_Syntax.sigel with
    | FStar_Syntax_Syntax.Sig_bundle (ses,uu____6666) ->
        let uu____6675 =
          FStar_All.pipe_right ses
            (FStar_List.partition
               (fun se1  ->
                  match se1.FStar_Syntax_Syntax.sigel with
                  | FStar_Syntax_Syntax.Sig_inductive_typ uu____6697 -> true
                  | FStar_Syntax_Syntax.Sig_declare_typ uu____6714 -> true
                  | FStar_Syntax_Syntax.Sig_datacon uu____6721 -> false
                  | uu____6736 ->
                      failwith
                        "Found a sigelt which is neither a type declaration or a data constructor in a sigelt")) in
        (match uu____6675 with
         | (decl_typ_ses,datacon_ses) ->
             let retrieve_datacons_and_resugar uu____6768 se1 =
               match uu____6768 with
               | (datacon_ses1,tycons) ->
                   let uu____6794 = resugar_typ datacon_ses1 se1 in
             ...
             (match uu____6809 with
              | (leftover_datacons,tycons) ->
                  (match leftover_datacons with
                           ...
                           let uu____6846 =
                             let uu____6859 =
                               FStar_List.map
                                 ...
                                 tycons in
                             (false, uu____6859) in
                           FStar_Parser_AST.Tycon uu____6846 in
                         decl'_to_decl se uu____6845 in
                       FStar_Pervasives_Native.Some uu____6844
                   | se1::[] ->
                       (match se1.FStar_Syntax_Syntax.sigel with
                        | FStar_Syntax_Syntax.Sig_datacon
                            (l,uu____6890,uu____6891,uu____6892,uu____6893,uu____6894)
                            ->
                            let uu____6899 =
                              decl'_to_decl se1
                   ...
                   | uu____6905 -> failwith "Should not happen hopefully")))
    | FStar_Syntax_Syntax.Sig_let (lbs,uu____6911) ->
        let uu____6916 =
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___205_6922  ->
                  match uu___205_6922 with
                  | FStar_Syntax_Syntax.Projector (uu____6923,uu____6924) ->
                      true
                  | FStar_Syntax_Syntax.Discriminator uu____6925 -> true
                  | uu____6926 -> false)) in
        if uu____6916
        then FStar_Pervasives_Native.None
        else
          (let mk1 e =
           ...
           | FStar_Parser_AST.Let (isrec,lets,uu____6949) ->
               let uu____6962 =
                 decl'_to_decl se
                   (FStar_Parser_AST.TopLevelLet (isrec, lets)) in
               FStar_Pervasives_Native.Some uu____6962
           | uu____6969 -> failwith "Should not happen hopefully")
    | FStar_Syntax_Syntax.Sig_assume (lid,uu____6973,fml) ->
        let uu____6975 =
          let uu____6976 =
            let uu____6977 =
              let uu____6982 = resugar_term fml in
              ((lid.FStar_Ident.ident), uu____6982) in
            FStar_Parser_AST.Assume uu____6977 in
          decl'_to_decl se uu____6976 in
    ...
    | FStar_Syntax_Syntax.Sig_sub_effect e ->
        ...
        let lift_wp =
          ...
          | FStar_Pervasives_Native.Some (uu____6995,t) ->
              let uu____7007 = resugar_term t in
              FStar_Pervasives_Native.Some uu____7007
          | uu____7008 -> FStar_Pervasives_Native.None in
        let lift =
          match e.FStar_Syntax_Syntax.lift with
          | FStar_Pervasives_Native.Some (uu____7016,t) ->
              let uu____7028 = resugar_term t in
        ...
        let op =
          ...
          | uu____7053 -> failwith "Should not happen hopefully" in
        let uu____7062 =
          decl'_to_decl se
        ...
        FStar_Pervasives_Native.Some uu____7062
    | FStar_Syntax_Syntax.Sig_effect_abbrev (lid,vs,bs,c,flags) ->
        let uu____7072 = FStar_Syntax_Subst.open_comp bs c in
        (match uu____7072 with
         | (bs1,c1) ->
             let bs2 =
               let uu____7082 = FStar_Options.print_implicits () in
               if uu____7082 then bs1 else filter_imp bs1 in
             let bs3 =
                 ...
                 let uu____7093 =
                   let uu____7106 =
                     let uu____7115 =
                       let uu____7122 =
                         let uu____7123 =
                           let uu____7136 = resugar_comp c1 in
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____7136) in
                         FStar_Parser_AST.TyconAbbrev uu____7123 in
                       (uu____7122, FStar_Pervasives_Native.None) in
                     [uu____7115] in
                   (false, uu____7106) in
                 FStar_Parser_AST.Tycon uu____7093 in
               decl'_to_decl se uu____7092 in
             FStar_Pervasives_Native.Some uu____7091)
    | FStar_Syntax_Syntax.Sig_pragma p ->
        let uu____7164 =
          decl'_to_decl se (FStar_Parser_AST.Pragma (resugar_pragma p)) in
        FStar_Pervasives_Native.Some uu____7164
    | FStar_Syntax_Syntax.Sig_declare_typ (lid,uvs,t) ->
        let uu____7168 =
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___206_7174  ->
                  match uu___206_7174 with
                  | FStar_Syntax_Syntax.Projector (uu____7175,uu____7176) ->
                      true
                  | FStar_Syntax_Syntax.Discriminator uu____7177 -> true
                  | uu____7178 -> false)) in
        if uu____7168
        then FStar_Pervasives_Native.None
        else
          (let t' =
             let uu____7183 =
               (let uu____7186 = FStar_Options.print_universes () in
                Prims.op_Negation uu____7186) || (FStar_List.isEmpty uvs) in
             if uu____7183
             then resugar_term t
             else
               (let uu____7188 = FStar_Syntax_Subst.open_univ_vars uvs t in
                match uu____7188 with
                | (uvs1,t1) ->
                    let universes = universe_to_string uvs1 in
                    let uu____7196 = resugar_term t1 in
                    label universes uu____7196) in
           let uu____7197 =
             decl'_to_decl se
               (FStar_Parser_AST.Val ((lid.FStar_Ident.ident), t')) in
           FStar_Pervasives_Native.Some uu____7197)
    | FStar_Syntax_Syntax.Sig_inductive_typ uu____7198 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Sig_datacon uu____7215 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Sig_main uu____7230 -> FStar_Pervasives_Native.None