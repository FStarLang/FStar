    ...
    | FStar_Syntax_Syntax.Comp c1 ->
        ...
        then
          ...
          let args =
            ...
            then
              let rec aux l uu___203_3006 =
                match uu___203_3006 with
                | [] -> l
                | (t,aq)::tl1 ->
          ...
          let rec aux l uu___204_3094 =
            match uu___204_3094 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
