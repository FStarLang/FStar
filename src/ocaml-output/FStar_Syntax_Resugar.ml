  ...
  fun env ->
    fun t ->
              ...
              (let uu____1289 =
                 ((FStar_Ident.lid_equals a FStar_Parser_Const.assert_lid) ||
                   ...
                   (let uu____1292 =
                    ...
                    let uu____1296 = FStar_String.get s (Prims.parse_int "0") in
                    uu____1292 <> uu____1296) in
               if uu____1289
               then
                 let uu____1299 =
           ...
           | (x1, phi1) ->
               let b =
                 let uu____1557 =
                   ...
                   resugar_binder' env uu____1560 t.FStar_Syntax_Syntax.pos in
                 FStar_Util.must uu____1557 in
               let uu____1565 =
                 let uu____1566 =
                   let uu____1571 = resugar_term' env phi1 in (b, uu____1571) in
                 FStar_Parser_AST.Refine uu____1566 in
               mk1 uu____1565)
      | FStar_Syntax_Syntax.Tm_app
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             FStar_Syntax_Syntax.pos = uu____1573;
             FStar_Syntax_Syntax.vars = uu____1574;_},
           (e, uu____1576)::[])
          when
              ...
              FStar_List.map
                (fun uu____1930 ->
                   ...
                   | (e2, qual) ->
                       ...
                       (uu____1947, uu____1948)) args1 in
                           ...
                           | (x, uu____2099) ->
                               let uu____2100 =
                                 let uu____2101 =
                                   ...
                                   let uu____2109 =
                                     let uu____2112 =
                                       let uu____2115 = resugar_term' env x in
                                       [uu____2115] in
                                     e1 :: uu____2112 in
           ...
           | FStar_Pervasives_Native.Some ("dtuple", uu____2127) when
               ...
               (match uu____2181 with
                | FStar_Syntax_Syntax.Tm_abs (xs, body1, uu____2187) ->
                    let uu____2208 = FStar_Syntax_Subst.open_term xs body1 in
                ...
                | (body, handler) ->
                    let decomp term =
                      ...
                      | FStar_Syntax_Syntax.Tm_abs (x, e1, uu____2413) ->
                          let uu____2434 = FStar_Syntax_Subst.open_term x e1 in
           ...
           | FStar_Pervasives_Native.Some (op, uu____2626) when
               ...
               let resugar body =
                 ...
                 | FStar_Syntax_Syntax.Tm_abs (xs, body1, uu____2728) ->
                     let uu____2749 = FStar_Syntax_Subst.open_term xs body1 in
                     (match uu____2749 with
                      | (xs1, body2) ->
                          let xs2 =
                            let uu____2757 = FStar_Options.print_implicits () in
                 ...
                 | (pat1, wopt1, b1) ->
                     ...
                     let wopt2 =
                       ...
                       | FStar_Pervasives_Native.Some e1 ->
                           ...
                           FStar_Pervasives_Native.Some uu____3754 in
      ...
      | FStar_Syntax_Syntax.Tm_let ((is_rec, source_lbs), body) ->
          ...
          let uu____3922 = FStar_Syntax_Subst.open_let_rec source_lbs body in
           ...
           | (source_lbs1, body1) ->
               let resugar_one_binding bnd =
                 let attrs_opt =
                   ...
                   | tms ->
                       ...
                       FStar_Pervasives_Native.Some uu____3973 in
                 let uu____3978 =
                   let uu____3983 =
                     FStar_Syntax_Util.mk_conj bnd.FStar_Syntax_Syntax.lbtyp
                       bnd.FStar_Syntax_Syntax.lbdef in
                   FStar_Syntax_Subst.open_univ_vars
                     bnd.FStar_Syntax_Syntax.lbunivs uu____3983 in
                 ...
                 | (univs1, td) ->
                     let uu____4002 =
                       ...
                       | FStar_Syntax_Syntax.Tm_app
                           (uu____4023,
                            (t1, uu____4025)::(d, uu____4027)::[])
                           -> (t1, d)
                       | uu____4070 -> failwith "wrong let binding format" in
                                 ...
                                 | FStar_Util.Inl bv ->
                                     let uu____4204 =
                                       let uu____4205 =
                                         ...
                                         FStar_Parser_AST.PatVar uu____4206 in
                                                        ...
                                                        (fun q1 ->
                                                           let uu____4293 =
                                                             ...
                                                             FStar_Parser_AST.PatVar
                                                               uu____4294 in
                                                           mk_pat uu____4293))) in
                                        let uu____4304 =
                                          let uu____4309 =
                                            resugar_term' env term1 in
                                          ((mk_pat
                                              (FStar_Parser_AST.PatApp
                                                 (pat, args))), uu____4309) in
                                        let uu____4312 =
               ...
               let bnds =
                 let f uu____4422 =
                   ...
                   | (attrs, (pb, univs1)) ->
                       let uu____4478 =
                         let uu____4479 = FStar_Options.print_universes () in
                ...
                (match uu____4735 with
                 | FStar_Syntax_Syntax.Tm_app
                     ({
                        ...
                        FStar_Syntax_Syntax.vars = uu____4741;_},
                      (term, uu____4743)::[])
                     -> resugar_term' env term
                 | uu____4772 -> failwith "mutable_rval should have app term") in
          (match m with
           | FStar_Syntax_Syntax.Meta_pattern pats ->
               let pats1 =
                 FStar_All.pipe_right (FStar_List.flatten pats)
                   (FStar_List.map
                      (fun uu____4810 ->
                         ...
                         | (x, uu____4816) -> resugar_term' env x)) in
               mk1 (FStar_Parser_AST.Attributes pats1)
           | FStar_Syntax_Syntax.Meta_labeled (l, uu____4818, p) ->
               let uu____4820 =
                 let uu____4821 =
                   let uu____4828 = resugar_term' env e in (uu____4828, l, p) in
              ...
              FStar_List.map
                (fun uu____5322 ->
                   ...
                   | (e, uu____5332) ->
                       ...
                       (uu____5333, FStar_Parser_AST.Nothing)) args in
          ...
          (let uu____5618 = FStar_Options.print_implicits () in
           Prims.op_Negation uu____5618) &&
            (let uu____5620 =
             ...
             Prims.op_Negation uu____5620) in
                        ...
                        | (p2, is_implicit1) ->
                            ...
                            then FStar_Pervasives_Native.None
                              ...
                              (let uu____5931 =
                               ...
                               FStar_Pervasives_Native.Some uu____5931))) in
                ...
                (FStar_List.partition
                   (fun se1 ->
                      ...
                      | FStar_Syntax_Syntax.Sig_datacon
                          (uu____6303, uu____6304, uu____6305, inductive_lid,
                           uu____6307, uu____6308)
                          -> FStar_Ident.lid_equals inductive_lid tylid
                      | uu____6313 -> failwith "unexpected")) in
                 ...
                 let tyc =
                   ...
                   then
                     let resugar_datacon_as_fields fields se1 =
                       match se1.FStar_Syntax_Syntax.sigel with
                       | FStar_Syntax_Syntax.Sig_datacon
                           (uu____6405, univs1, term, uu____6408, num,
                            uu____6410)
                           ->
                           let uu____6415 =
                             let uu____6416 =
                  ...
                  let uu____6832 =
                    let uu____6839 =
                      let uu____6840 =
                        ...
                        (name1, [], FStar_Pervasives_Native.None, uu____6853) in
          ...
          fun ed ->
            let resugar_action d for_free1 =
              ...
              | (bs, action_defn) ->
                  ...
                  (match uu____6920 with
                   | (bs1, action_typ) ->
                       let action_params1 =
                         let uu____6928 = FStar_Options.print_implicits () in
                         if uu____6928
                         then action_params
            ...
            | (eff_binders, eff_typ) ->
                let eff_binders1 =
                  ...
                  if uu____7040 then eff_binders else filter_imp eff_binders in
                let eff_binders2 =
                  let uu____7045 =
                ...
                | (leftover_datacons, tycons) ->
                    (match leftover_datacons with
                     ...
                     | se1::[] ->
                         (match se1.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_datacon
                              (l, uu____7329, uu____7330, uu____7331,
                         ...
                         let uu____7620 =
                           let uu____7621 =
                             ...
                             ((lid.FStar_Ident.ident), bs3,
                               FStar_Pervasives_Native.None, uu____7634) in
            ...
            (let t' =
               let uu____7681 =
                 (let uu____7684 = FStar_Options.print_universes () in
                  Prims.op_Negation uu____7684) || (FStar_List.isEmpty uvs) in
               if uu____7681
               then resugar_term' env t
               else
                 (let uu____7686 = FStar_Syntax_Subst.open_univ_vars uvs t in
                  match uu____7686 with
                  | (uvs1, t1) ->
                      let universes = universe_to_string uvs1 in
                      let uu____7694 = resugar_term' env t1 in
                      label universes uu____7694) in
             let uu____7695 =
               decl'_to_decl se
...
let (resugar_binder :
  FStar_Syntax_Syntax.binder ->
    FStar_Range.range ->
      FStar_Parser_AST.binder FStar_Pervasives_Native.option)
  =
  fun b -> fun r -> let uu____7829 = noenv resugar_binder' in uu____7829 b r
