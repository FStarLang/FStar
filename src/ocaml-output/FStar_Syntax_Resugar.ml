                ...
                (FStar_List.partition
                   (fun se1  ->
                      ...
                      | FStar_Syntax_Syntax.Sig_datacon
                          (uu____9404,uu____9405,uu____9406,inductive_lid,uu____9408,uu____9409)
                          -> FStar_Ident.lid_equals inductive_lid tylid
                      | uu____9416 -> failwith "unexpected"))
               in
                 ...
                 let tyc =
                   ...
                   then
                     let resugar_datacon_as_fields fields se1 =
                       match se1.FStar_Syntax_Syntax.sigel with
                       | FStar_Syntax_Syntax.Sig_datacon
                           (uu____9511,univs,term,uu____9514,num,uu____9516)
                           ->
                           let uu____9523 =
                             let uu____9524 =
                               FStar_Syntax_Subst.compress term  in
                     ...
                     (let resugar_datacon constructors se1 =
                      ...
                      let uu____9819 =
                        ...
                        (uu____9843, bs2, FStar_Pervasives_Native.None,
                          constructors)
                         in
                      FStar_Parser_AST.TyconVariant uu____9819)
                    in
                 (other_datacons, tyc))
        | uu____9859 ->
            failwith
                ...
                let uu____9940 =
                  let uu____9943 =
                    let uu____9944 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____9957)
                       in
...
let (resugar_layered_eff_combinators :
  ...
  fun env  ->
    fun combs  ->
      ...
      let uu____10110 =
        let uu____10113 = resugar "return" combs.FStar_Syntax_Syntax.l_return
           in
        let uu____10115 =
          let uu____10118 = resugar "bind" combs.FStar_Syntax_Syntax.l_bind
             in
          let uu____10120 =
            let uu____10123 =
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____10371 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____10381 =
  ...
  fun env  ->
    fun se  ->
                ...
                | (leftover_datacons,tycons) ->
                    (match leftover_datacons with
                     ...
                     | se1::[] ->
                         (match se1.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_datacon
                              (l,uu____10631,uu____10632,uu____10633,uu____10634,uu____10635)
                              ->
                              let uu____10642 =
                                let uu____10643 =
                                  let uu____10644 =
            ...
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
              (FStar_Util.for_some
                 (fun uu___9_10691  ->
                    ...
                    | FStar_Syntax_Syntax.Projector (uu____10693,uu____10694)
                        -> true
            ...
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
              (FStar_Util.for_some
                 (fun uu___10_10995  ->
                    ...
                    | FStar_Syntax_Syntax.Projector (uu____10997,uu____10998)
                        -> true
            ...
            (let t' =
               let uu____11010 =
                 (let uu____11014 = FStar_Options.print_universes ()  in
                  Prims.op_Negation uu____11014) || (FStar_List.isEmpty uvs)
                  in
               if uu____11010
               then resugar_term' env t
               else
                 (let uu____11019 = FStar_Syntax_Subst.open_univ_vars uvs t
                     in
                  match uu____11019 with
                  | (uvs1,t1) ->
                      let universes = universe_to_string uvs1  in
                      let uu____11028 = resugar_term' env t1  in
                      label universes uu____11028)
                in
             let uu____11029 =
               let uu____11030 =
                 let uu____11031 =
      ...
      | FStar_Syntax_Syntax.Sig_polymonadic_subcomp
          (m,n,(uu____11121,t),uu____11123) ->
          let uu____11132 =
            let uu____11133 =
              let uu____11134 =
                let uu____11141 = resugar_term' env t  in (m, n, uu____11141)
                 in
              FStar_Parser_AST.Polymonadic_subcomp uu____11134  in
            decl'_to_decl se uu____11133  in
...
let (resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term) =
  fun t  -> let uu____11165 = noenv resugar_term'  in uu____11165 t 
let (resugar_sigelt :
  FStar_Syntax_Syntax.sigelt ->
    FStar_Parser_AST.decl FStar_Pervasives_Native.option)
  = fun se  -> let uu____11183 = noenv resugar_sigelt'  in uu____11183 se 
let (resugar_comp : FStar_Syntax_Syntax.comp -> FStar_Parser_AST.term) =
  fun c  -> let uu____11201 = noenv resugar_comp'  in uu____11201 c 
let (resugar_pat :
  FStar_Syntax_Syntax.pat ->
    FStar_Syntax_Syntax.bv FStar_Util.set -> FStar_Parser_AST.pattern)
  =
  fun p  ->
    fun branch_bv  ->
      let uu____11224 = noenv resugar_pat'  in uu____11224 p branch_bv
...
let (resugar_binder :
  ...
  =
  fun b  ->
    fun r  -> let uu____11258 = noenv resugar_binder'  in uu____11258 b r
  
let (resugar_tscheme : FStar_Syntax_Syntax.tscheme -> FStar_Parser_AST.decl)
  = fun ts  -> let uu____11283 = noenv resugar_tscheme'  in uu____11283 ts 
let (resugar_eff_decl :
  FStar_Range.range ->
    FStar_Syntax_Syntax.qualifier Prims.list ->
      FStar_Syntax_Syntax.eff_decl -> FStar_Parser_AST.decl)
  ...
  fun r  ->
    fun q  ->
      fun ed  ->
        let uu____11311 = noenv resugar_eff_decl'  in uu____11311 r q ed
