    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_meta (e,m) ->
          ...
          (match m with
           ...
           | FStar_Syntax_Syntax.Meta_monadic (uu____6180,t1) ->
               resugar_term' env e
           | FStar_Syntax_Syntax.Meta_monadic_lift (uu____6186,uu____6187,t1)
               -> resugar_term' env e)
  ...
  fun env  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_polymonadic_bind
          (m,n1,p,(uu____9642,t),uu____9644) ->
          let uu____9653 =
            let uu____9654 =
              let uu____9655 =
                let uu____9664 = resugar_term' env t  in
                (m, n1, p, uu____9664)  in
              FStar_Parser_AST.Polymonadic_bind uu____9655  in
            decl'_to_decl se uu____9654  in
          FStar_Pervasives_Native.Some uu____9653
  
let (empty_env : FStar_Syntax_DsEnv.env) =
  FStar_Syntax_DsEnv.empty_env FStar_Parser_Dep.empty_deps 
let noenv : 'a . (FStar_Syntax_DsEnv.env -> 'a) -> 'a = fun f  -> f empty_env 
let (resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term) =
  fun t  -> let uu____9688 = noenv resugar_term'  in uu____9688 t 
let (resugar_sigelt :
  FStar_Syntax_Syntax.sigelt ->
    FStar_Parser_AST.decl FStar_Pervasives_Native.option)
  = fun se  -> let uu____9706 = noenv resugar_sigelt'  in uu____9706 se 
let (resugar_comp : FStar_Syntax_Syntax.comp -> FStar_Parser_AST.term) =
  fun c  -> let uu____9724 = noenv resugar_comp'  in uu____9724 c 
let (resugar_pat :
  FStar_Syntax_Syntax.pat ->
    FStar_Syntax_Syntax.bv FStar_Util.set -> FStar_Parser_AST.pattern)
  =
  fun p  ->
    fun branch_bv  ->
      let uu____9747 = noenv resugar_pat'  in uu____9747 p branch_bv
...
let (resugar_binder :
  ...
  =
  fun b  ->
    fun r  -> let uu____9781 = noenv resugar_binder'  in uu____9781 b r
  
let (resugar_tscheme : FStar_Syntax_Syntax.tscheme -> FStar_Parser_AST.decl)
  = fun ts  -> let uu____9806 = noenv resugar_tscheme'  in uu____9806 ts 
let (resugar_eff_decl :
  FStar_Range.range ->
    FStar_Syntax_Syntax.qualifier Prims.list ->
      FStar_Syntax_Syntax.eff_decl -> FStar_Parser_AST.decl)
  ...
  fun r  ->
    fun q  ->
      fun ed  ->
        let uu____9834 = noenv resugar_eff_decl'  in uu____9834 r q ed
