...
let (universe_to_string : FStar_Ident.ident Prims.list -> Prims.string) =
  fun univs1 ->
    ...
    if uu____218
    then
      let uu____219 = FStar_List.map (fun x -> x.FStar_Ident.idText) univs1 in
...
let (string_to_op :
  ...
  =
  fun s ->
    let name_of_op uu___193_411 =
      match uu___193_411 with
      | "Amp" ->
  ...
  fun env ->
    fun t ->
              ...
              (let uu____1385 =
                 ((FStar_Ident.lid_equals a FStar_Parser_Const.assert_lid) ||
                   ...
                   (let uu____1388 =
                    ...
                    let uu____1392 = FStar_String.get s (Prims.parse_int "0") in
                    uu____1388 <> uu____1392) in
               if uu____1385
               then
                 let uu____1395 =
      ...
      | FStar_Syntax_Syntax.Tm_arrow (xs, body) ->
          ...
          (match uu____1634 with
           | (xs1, body1) ->
               ...
               let rec aux body3 uu___194_1677 =
                 match uu___194_1677 with
                 | [] -> body3
                 | hd1::tl1 ->
                     let body4 =
           ...
           | (x1, phi1) ->
               let b =
                 let uu____1721 =
                   ...
                   resugar_binder' env uu____1724 t.FStar_Syntax_Syntax.pos in
                 FStar_Util.must uu____1721 in
               let uu____1731 =
                 let uu____1732 =
                   let uu____1737 = resugar_term' env phi1 in (b, uu____1737) in
                 FStar_Parser_AST.Refine uu____1732 in
               mk1 uu____1731)
      | FStar_Syntax_Syntax.Tm_app
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             FStar_Syntax_Syntax.pos = uu____1739;
             FStar_Syntax_Syntax.vars = uu____1740;_},
           (e, uu____1742)::[])
          when
      ...
      | FStar_Syntax_Syntax.Tm_app (e, args) ->
          let rec last1 uu___195_1831 =
            match uu___195_1831 with
            | hd1::[] -> [hd1]
            | hd1::tl1 -> last1 tl1
            | uu____1901 -> failwith "last of an empty list" in
          let rec last_two uu___196_1939 =
            match uu___196_1939 with
            | [] ->
                failwith
                           ...
                           | (x, uu____2291) ->
                               let uu____2296 =
                                 let uu____2297 =
                                   ...
                                   let uu____2305 =
                                     let uu____2308 =
                                       let uu____2311 = resugar_term' env x in
                                       [uu____2311] in
                                     e1 :: uu____2308 in
           ...
           | FStar_Pervasives_Native.Some ("dtuple", uu____2323) when
               ...
               (match uu____2371 with
                | FStar_Syntax_Syntax.Tm_abs (xs, body1, uu____2377) ->
                    let uu____2402 = FStar_Syntax_Subst.open_term xs body1 in
                    (match uu____2402 with
                     | (xs1, body2) ->
                         let xs2 =
                           let uu____2412 = FStar_Options.print_implicits () in
                ...
                | (body, handler) ->
                    let decomp term =
                      ...
                      | FStar_Syntax_Syntax.Tm_abs (x, e1, uu____2599) ->
                          let uu____2624 = FStar_Syntax_Subst.open_term x e1 in
           ...
           | FStar_Pervasives_Native.Some (op, uu____2826) when
               ...
               let resugar body =
                 ...
                 | FStar_Syntax_Syntax.Tm_abs (xs, body1, uu____2936) ->
                     let uu____2961 = FStar_Syntax_Subst.open_term xs body1 in
      ...
      | FStar_Syntax_Syntax.Tm_let ((is_rec, source_lbs), body) ->
          ...
          let uu____4164 = FStar_Syntax_Subst.open_let_rec source_lbs body in
               ...
               let resugar_one_binding bnd =
                 let attrs_opt =
                   ...
                   | tms ->
                       ...
                       FStar_Pervasives_Native.Some uu____4217 in
                 let uu____4224 =
                   let uu____4229 =
                     FStar_Syntax_Util.mk_conj bnd.FStar_Syntax_Syntax.lbtyp
                       bnd.FStar_Syntax_Syntax.lbdef in
                   FStar_Syntax_Subst.open_univ_vars
                     bnd.FStar_Syntax_Syntax.lbunivs uu____4229 in
                 ...
                 | (univs1, td) ->
                     let uu____4248 =
                       ...
                       | FStar_Syntax_Syntax.Tm_app
                           (uu____4265,
                            (t1, uu____4267)::(d, uu____4269)::[])
                           -> (t1, d)
                       | uu____4326 -> failwith "wrong let binding format" in
                                 ...
                                 | FStar_Util.Inl bv ->
                                     let uu____4524 =
                                       let uu____4525 =
                                         ...
                                         FStar_Parser_AST.PatVar uu____4526 in
                                    ...
                                    let uu____4554 =
                                      ...
                                      then
                                                        ...
                                                        (fun q1 ->
                                                           let uu____4621 =
                                                             ...
                                                             FStar_Parser_AST.PatVar
                                                               uu____4622 in
                                                           mk_pat uu____4621))) in
                                        let uu____4632 =
                                          let uu____4637 =
                                            resugar_term' env term1 in
                                          ((mk_pat
                                              (FStar_Parser_AST.PatApp
                                                 (pat, args))), uu____4637) in
                                        let uu____4640 =
                                        ...
                                        (let uu____4646 =
                                         ...
                                         let uu____4652 =
                                           universe_to_string univs1 in
                                         (uu____4646, uu____4652)) in
                                    (attrs_opt, uu____4554)))) in
      ...
      | FStar_Syntax_Syntax.Tm_meta (e, m) ->
          let resugar_meta_desugared uu___197_4930 =
            match uu___197_4930 with
                ...
                (match uu____5061 with
                 | FStar_Syntax_Syntax.Tm_app
                     ({
                        ...
                        FStar_Syntax_Syntax.vars = uu____5067;_},
                      (term, uu____5069)::[])
                     -> resugar_term' env term
                 | uu____5108 -> failwith "mutable_rval should have app term") in
          (match m with
           | FStar_Syntax_Syntax.Meta_pattern pats ->
               let pats1 =
                 FStar_All.pipe_right (FStar_List.flatten pats)
                   (FStar_List.map
                      (fun uu____5152 ->
                         ...
                         | (x, uu____5160) -> resugar_term' env x)) in
               mk1 (FStar_Parser_AST.Attributes pats1)
           | FStar_Syntax_Syntax.Meta_labeled (l, uu____5166, p) ->
               let uu____5168 =
                 let uu____5169 =
                   let uu____5176 = resugar_term' env e in (uu____5176, l, p) in
              ...
              FStar_List.map
                (fun uu____5698 ->
                   ...
                   | (e, uu____5710) ->
                       ...
                       (uu____5715, FStar_Parser_AST.Nothing)) args in
            let rec aux l uu___198_5740 =
              match uu___198_5740 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
      ...
      fun branch_bv ->
          ...
          (let uu____6026 = FStar_Options.print_implicits () in
           Prims.op_Negation uu____6026) &&
            (let uu____6028 =
             ...
             Prims.op_Negation uu____6028) in
        ...
        and aux p1 imp_opt =
                        ...
                        | (p2, is_implicit1) ->
                            ...
                            then FStar_Pervasives_Native.None
                              ...
                              (let uu____6345 =
                               ...
                               FStar_Pervasives_Native.Some uu____6345))) in
          ...
          | FStar_Syntax_Syntax.Pat_wild uu____6602 ->
              let uu____6603 =
                let uu____6604 = to_arg_qual imp_opt in
                FStar_Parser_AST.PatWild uu____6604 in
              mk1 uu____6603
  ...
  fun env ->
    fun q ->
      ...
      | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Meta t) ->
          let uu____6640 =
            let uu____6643 =
              let uu____6644 = resugar_term' env t in
              FStar_Parser_AST.Meta uu____6644 in
  ...
  fun env ->
    fun q ->
      ...
      | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Implicit (true)) ->
          FStar_Parser_AST.Nothing
      | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Meta t) ->
          let uu____6654 = resugar_term' env t in
          FStar_Parser_AST.HashBrace uu____6654
let (resugar_qualifier :
  FStar_Syntax_Syntax.qualifier ->
    FStar_Parser_AST.qualifier FStar_Pervasives_Native.option)
  =
  fun uu___199_6661 ->
    match uu___199_6661 with
    ...
    | FStar_Syntax_Syntax.Reflectable uu____6668 ->
        FStar_Pervasives_Native.Some FStar_Parser_AST.Reflectable
    | FStar_Syntax_Syntax.Discriminator uu____6669 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Projector uu____6670 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordType uu____6675 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordConstructor uu____6684 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Action uu____6693 -> FStar_Pervasives_Native.None
    ...
    fun datacon_ses ->
      fun se ->
        ...
        | FStar_Syntax_Syntax.Sig_inductive_typ
            (tylid, uvs, bs, t, uu____6737, datacons) ->
            let uu____6747 =
                ...
                (FStar_List.partition
                   (fun se1 ->
                      ...
                      | FStar_Syntax_Syntax.Sig_datacon
                          (uu____6774, uu____6775, uu____6776, inductive_lid,
                           uu____6778, uu____6779)
                          -> FStar_Ident.lid_equals inductive_lid tylid
                      | uu____6784 -> failwith "unexpected")) in
            (match uu____6747 with
             | (current_datacons, other_datacons) ->
                 let bs1 =
                   let uu____6803 = FStar_Options.print_implicits () in
                   if uu____6803 then bs else filter_imp bs in
                 let bs2 =
                 ...
                 let tyc =
                   let uu____6817 =
                     FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                       (FStar_Util.for_some
                          (fun uu___201_6822 ->
                             match uu___201_6822 with
                             | FStar_Syntax_Syntax.RecordType uu____6823 ->
                                 true
                             | uu____6832 -> false)) in
                   if uu____6817
                   then
                     let resugar_datacon_as_fields fields se1 =
                       match se1.FStar_Syntax_Syntax.sigel with
                       | FStar_Syntax_Syntax.Sig_datacon
                           (uu____6884, univs1, term, uu____6887, num,
                            uu____6889)
                           ->
                           let uu____6894 =
                             let uu____6895 =
                           ...
                           (match uu____6894 with
                            | FStar_Syntax_Syntax.Tm_arrow (bs3, uu____6909)
                                ->
                                let mfields =
                                    ...
                                    (FStar_List.map
                                       (fun uu____6978 ->
                                          ...
                                          | (b, qual) ->
                                              ...
                                              (uu____6999, uu____7001,
                                                FStar_Pervasives_Native.None))) in
                                FStar_List.append mfields fields
                            | uu____7012 -> failwith "unexpected")
                       | uu____7023 -> failwith "unexpected" in
                     let fields =
                     ...
                     (let resugar_datacon constructors se1 =
                        match se1.FStar_Syntax_Syntax.sigel with
                        | FStar_Syntax_Syntax.Sig_datacon
                            (l, univs1, term, uu____7148, num, uu____7150) ->
                            let c =
                              let uu____7168 =
                                let uu____7171 = resugar_term' env term in
                                FStar_Pervasives_Native.Some uu____7171 in
                              ((l.FStar_Ident.ident), uu____7168,
                                FStar_Pervasives_Native.None, false) in
                            c :: constructors
                        | uu____7188 -> failwith "unexpected" in
                      let constructors =
...
let (mk_decl :
  ...
  fun r ->
    fun q ->
      fun d' ->
        let uu____7286 = FStar_List.choose resugar_qualifier q in
        {
          FStar_Parser_AST.d = d';
          FStar_Parser_AST.drange = r;
          FStar_Parser_AST.doc = FStar_Pervasives_Native.None;
          FStar_Parser_AST.quals = uu____7286;
              ...
              let uu____7325 =
                let uu____7340 =
                  let uu____7349 =
                    let uu____7356 =
                      let uu____7357 =
                        let uu____7370 = resugar_term' env typ in
                        (name1, [], FStar_Pervasives_Native.None, uu____7370) in
                      FStar_Parser_AST.TyconAbbrev uu____7357 in
                    (uu____7356, FStar_Pervasives_Native.None) in
                  [uu____7349] in
                (false, false, uu____7340) in
              FStar_Parser_AST.Tycon uu____7325 in
            mk_decl typ.FStar_Syntax_Syntax.pos [] uu____7324
let (resugar_tscheme' :
  FStar_Syntax_DsEnv.env ->
      ...
      fun r ->
        fun q ->
          fun ed ->
            let resugar_action d for_free1 =
              ...
              | (bs, action_defn) ->
                  ...
                  (match uu____7455 with
                   | (bs1, action_typ) ->
                       let action_params1 =
                         let uu____7465 = FStar_Options.print_implicits () in
                         if uu____7465
                         then action_params
                       ...
                       let action_params2 =
                         ...
                         FStar_All.pipe_right uu____7472 FStar_List.rev in
                       ...
                       then
                         let a =
                           ...
                           FStar_Parser_AST.Construct uu____7488 in
                         let t =
            ...
            | (eff_binders, eff_typ) ->
                let eff_binders1 =
                  let uu____7583 = FStar_Options.print_implicits () in
                  if uu____7583 then eff_binders else filter_imp eff_binders in
                let eff_binders2 =
                  let uu____7590 =
                    FStar_All.pipe_right eff_binders1
                      ((map_opt ()) (fun b -> resugar_binder' env b r)) in
                  FStar_All.pipe_right uu____7590 FStar_List.rev in
...
let (resugar_sigelt' :
  ...
  fun env ->
    fun se ->
      match se.FStar_Syntax_Syntax.sigel with
      | FStar_Syntax_Syntax.Sig_bundle (ses, uu____7658) ->
          let uu____7667 =
            FStar_All.pipe_right ses
              (FStar_List.partition
                 (fun se1 ->
                    match se1.FStar_Syntax_Syntax.sigel with
                    | FStar_Syntax_Syntax.Sig_inductive_typ uu____7689 ->
                        true
                    | FStar_Syntax_Syntax.Sig_declare_typ uu____7706 -> true
                    | FStar_Syntax_Syntax.Sig_datacon uu____7713 -> false
                    | uu____7728 ->
                        failwith
                          "Found a sigelt which is neither a type declaration or a data constructor in a sigelt")) in
          (match uu____7667 with
           | (decl_typ_ses, datacon_ses) ->
               let retrieve_datacons_and_resugar uu____7764 se1 =
                 match uu____7764 with
                 | (datacon_ses1, tycons) ->
                     let uu____7790 = resugar_typ env datacon_ses1 se1 in
               ...
               (match uu____7805 with
                | (leftover_datacons, tycons) ->
                    (match leftover_datacons with
                             ...
                             let uu____7842 =
                               let uu____7857 =
                                 FStar_List.map
                                   ...
                                   tycons in
                               (false, false, uu____7857) in
                             FStar_Parser_AST.Tycon uu____7842 in
                           decl'_to_decl se uu____7841 in
                         FStar_Pervasives_Native.Some uu____7840
                     | se1::[] ->
                         (match se1.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_datacon
                              (l, uu____7888, uu____7889, uu____7890,
                               uu____7891, uu____7892)
                              ->
                              let uu____7897 =
                                decl'_to_decl se1
                     ...
                     | uu____7903 -> failwith "Should not happen hopefully")))
      | FStar_Syntax_Syntax.Sig_let (lbs, uu____7909) ->
          let uu____7914 =
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
              (FStar_Util.for_some
                 (fun uu___202_7920 ->
                    match uu___202_7920 with
                    | FStar_Syntax_Syntax.Projector (uu____7921, uu____7922)
                        -> true
                    | FStar_Syntax_Syntax.Discriminator uu____7923 -> true
                    | uu____7924 -> false)) in
          if uu____7914
          then FStar_Pervasives_Native.None
          else
            (let mk1 e =
             ...
             | FStar_Parser_AST.Let (isrec, lets, uu____7955) ->
                 let uu____7984 =
                   let uu____7985 =
                     let uu____7986 =
                       let uu____7997 =
                       ...
                       (isrec, uu____7997) in
                     FStar_Parser_AST.TopLevelLet uu____7986 in
                   decl'_to_decl se uu____7985 in
                 FStar_Pervasives_Native.Some uu____7984
             | uu____8034 -> failwith "Should not happen hopefully")
      | FStar_Syntax_Syntax.Sig_assume (lid, uu____8038, fml) ->
          let uu____8040 =
            let uu____8041 =
              let uu____8042 =
                let uu____8047 = resugar_term' env fml in
                ((lid.FStar_Ident.ident), uu____8047) in
              FStar_Parser_AST.Assume uu____8042 in
            decl'_to_decl se uu____8041 in
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect e ->
          ...
          let lift_wp =
            ...
            | FStar_Pervasives_Native.Some (uu____8060, t) ->
          ...
          let lift =
            ...
            | FStar_Pervasives_Native.Some (uu____8079, t) ->
                let uu____8089 = resugar_term' env t in
                FStar_Pervasives_Native.Some uu____8089
            | uu____8090 -> FStar_Pervasives_Native.None in
          let op =
            ...
            | uu____8114 -> failwith "Should not happen hopefully" in
          let uu____8123 =
            decl'_to_decl se
      ...
      | FStar_Syntax_Syntax.Sig_effect_abbrev (lid, vs, bs, c, flags1) ->
          let uu____8133 = FStar_Syntax_Subst.open_comp bs c in
          (match uu____8133 with
           | (bs1, c1) ->
               let bs2 =
                 let uu____8145 = FStar_Options.print_implicits () in
                 if uu____8145 then bs1 else filter_imp bs1 in
               let bs3 =
                   ...
                   let uu____8160 =
                     let uu____8175 =
                       let uu____8184 =
                         let uu____8191 =
                           let uu____8192 =
                             let uu____8205 = resugar_comp' env c1 in
                             ((lid.FStar_Ident.ident), bs3,
                               FStar_Pervasives_Native.None, uu____8205) in
                           FStar_Parser_AST.TyconAbbrev uu____8192 in
                         (uu____8191, FStar_Pervasives_Native.None) in
                       [uu____8184] in
                     (false, false, uu____8175) in
                   FStar_Parser_AST.Tycon uu____8160 in
                 decl'_to_decl se uu____8159 in
      ...
      | FStar_Syntax_Syntax.Sig_declare_typ (lid, uvs, t) ->
          let uu____8237 =
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
              (FStar_Util.for_some
                 (fun uu___203_8243 ->
                    match uu___203_8243 with
                    | FStar_Syntax_Syntax.Projector (uu____8244, uu____8245)
                        -> true
                    | FStar_Syntax_Syntax.Discriminator uu____8246 -> true
                    | uu____8247 -> false)) in
          if uu____8237
          then FStar_Pervasives_Native.None
          else
            (let t' =
               let uu____8252 =
                 (let uu____8255 = FStar_Options.print_universes () in
                  Prims.op_Negation uu____8255) || (FStar_List.isEmpty uvs) in
               if uu____8252
               then resugar_term' env t
               else
                 (let uu____8257 = FStar_Syntax_Subst.open_univ_vars uvs t in
                  match uu____8257 with
                  | (uvs1, t1) ->
                      let universes = universe_to_string uvs1 in
                      let uu____8265 = resugar_term' env t1 in
                      label universes uu____8265) in
             let uu____8266 =
               decl'_to_decl se
          ...
          let uu____8273 =
            let uu____8274 =
              let uu____8275 =
                ...
                let uu____8287 = resugar_term' env t in
                (uu____8282, uu____8287) in
              FStar_Parser_AST.Splice uu____8275 in
            decl'_to_decl se uu____8274 in
          FStar_Pervasives_Native.Some uu____8273
      | FStar_Syntax_Syntax.Sig_inductive_typ uu____8290 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Sig_datacon uu____8307 ->
          FStar_Pervasives_Native.None
...
let (resugar_sigelt :
  FStar_Syntax_Syntax.sigelt ->
    FStar_Parser_AST.decl FStar_Pervasives_Native.option)
  = fun se -> let uu____8360 = noenv resugar_sigelt' in uu____8360 se
let (resugar_comp : FStar_Syntax_Syntax.comp -> FStar_Parser_AST.term) =
  fun c -> let uu____8377 = noenv resugar_comp' in uu____8377 c
let (resugar_pat :
  FStar_Syntax_Syntax.pat ->
    FStar_Syntax_Syntax.bv FStar_Util.set -> FStar_Parser_AST.pattern)
  =
  fun p ->
    fun branch_bv ->
      let uu____8399 = noenv resugar_pat' in uu____8399 p branch_bv
let (resugar_binder :
  FStar_Syntax_Syntax.binder ->
    FStar_Range.range ->
      FStar_Parser_AST.binder FStar_Pervasives_Native.option)
  =
  fun b -> fun r -> let uu____8432 = noenv resugar_binder' in uu____8432 b r
let (resugar_tscheme : FStar_Syntax_Syntax.tscheme -> FStar_Parser_AST.decl)
  = fun ts -> let uu____8456 = noenv resugar_tscheme' in uu____8456 ts
let (resugar_eff_decl :
  Prims.bool ->
    FStar_Range.range ->
      FStar_Syntax_Syntax.qualifier Prims.list ->
  ...
  fun for_free ->
    fun r ->
      fun q ->
        fun ed ->
          let uu____8488 = noenv resugar_eff_decl' in
          uu____8488 for_free r q ed