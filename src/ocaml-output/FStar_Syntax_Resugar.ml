  ...
  fun env  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_polymonadic_subcomp
          (m,n,(uu____11114,t),uu____11116) ->
          let uu____11125 =
            let uu____11126 =
              let uu____11127 =
                let uu____11134 = resugar_term' env t  in (m, n, uu____11134)
                 in
              FStar_Parser_AST.Polymonadic_subcomp uu____11127  in
            decl'_to_decl se uu____11126  in
...
let (resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term) =
  fun t  -> let uu____11158 = noenv resugar_term'  in uu____11158 t 
let (resugar_sigelt :
  FStar_Syntax_Syntax.sigelt ->
    FStar_Parser_AST.decl FStar_Pervasives_Native.option)
  = fun se  -> let uu____11176 = noenv resugar_sigelt'  in uu____11176 se 
let (resugar_comp : FStar_Syntax_Syntax.comp -> FStar_Parser_AST.term) =
  fun c  -> let uu____11194 = noenv resugar_comp'  in uu____11194 c 
let (resugar_pat :
  FStar_Syntax_Syntax.pat ->
    FStar_Syntax_Syntax.bv FStar_Util.set -> FStar_Parser_AST.pattern)
  =
  fun p  ->
    fun branch_bv  ->
      let uu____11217 = noenv resugar_pat'  in uu____11217 p branch_bv
...
let (resugar_binder :
  ...
  =
  fun b  ->
    fun r  -> let uu____11251 = noenv resugar_binder'  in uu____11251 b r
  
let (resugar_tscheme : FStar_Syntax_Syntax.tscheme -> FStar_Parser_AST.decl)
  = fun ts  -> let uu____11276 = noenv resugar_tscheme'  in uu____11276 ts 
let (resugar_eff_decl :
  FStar_Range.range ->
    FStar_Syntax_Syntax.qualifier Prims.list ->
      FStar_Syntax_Syntax.eff_decl -> FStar_Parser_AST.decl)
  ...
  fun r  ->
    fun q  ->
      fun ed  ->
        let uu____11304 = noenv resugar_eff_decl'  in uu____11304 r q ed
