...
let (resugar_sigelt' :
  ...
  fun env  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_fail uu____8951 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Sig_let (lbs,uu____8965) ->
          let uu____8970 =
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
              (FStar_Util.for_some
                 (fun uu___9_8978  ->
                    match uu___9_8978 with
                    | FStar_Syntax_Syntax.Projector (uu____8980,uu____8981)
                        -> true
                    | FStar_Syntax_Syntax.Discriminator uu____8983 -> true
                    | uu____8985 -> false))
             in
          if uu____8970
          then FStar_Pervasives_Native.None
            ...
            (let mk1 e =
             ...
             | FStar_Parser_AST.Let (isrec,lets,uu____9020) ->
                 let uu____9049 =
                   let uu____9050 =
                     let uu____9051 =
                       let uu____9062 =
                       ...
                       (isrec, uu____9062)  in
                     FStar_Parser_AST.TopLevelLet uu____9051  in
                   decl'_to_decl se uu____9050  in
                 FStar_Pervasives_Native.Some uu____9049
             | uu____9099 -> failwith "Should not happen hopefully")
      | FStar_Syntax_Syntax.Sig_assume (lid,uu____9104,fml) ->
          let uu____9106 =
            let uu____9107 =
              let uu____9108 =
                let uu____9113 = resugar_term' env fml  in
                ((lid.FStar_Ident.ident), uu____9113)  in
              FStar_Parser_AST.Assume uu____9108  in
            decl'_to_decl se uu____9107  in
          FStar_Pervasives_Native.Some uu____9106
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect e ->
          ...
          let lift_wp =
            ...
            | FStar_Pervasives_Native.Some (uu____9124,t) ->
                let uu____9134 = resugar_term' env t  in
                FStar_Pervasives_Native.Some uu____9134
            | uu____9135 -> FStar_Pervasives_Native.None  in
          let lift =
            match e.FStar_Syntax_Syntax.lift with
            | FStar_Pervasives_Native.Some (uu____9143,t) ->
                let uu____9153 = resugar_term' env t  in
                FStar_Pervasives_Native.Some uu____9153
            | uu____9154 -> FStar_Pervasives_Native.None  in
          let op =
            ...
            | uu____9178 -> failwith "Should not happen hopefully"  in
          let uu____9188 =
            decl'_to_decl se
      ...
      | FStar_Syntax_Syntax.Sig_effect_abbrev (lid,vs,bs,c,flags) ->
          let uu____9198 = FStar_Syntax_Subst.open_comp bs c  in
          (match uu____9198 with
           | (bs1,c1) ->
               let bs2 =
                 let uu____9210 = FStar_Options.print_implicits ()  in
                 if uu____9210 then bs1 else filter_imp bs1  in
               let bs3 =
                 ...
                 let uu____9227 =
                   let uu____9228 =
                     let uu____9239 =
                       let uu____9242 =
                         let uu____9243 =
                           let uu____9256 = resugar_comp' env c1  in
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____9256)
                            in
                         FStar_Parser_AST.TyconAbbrev uu____9243  in
                       [uu____9242]  in
                     (false, false, uu____9239)  in
                   FStar_Parser_AST.Tycon uu____9228  in
                 decl'_to_decl se uu____9227  in
      ...
      | FStar_Syntax_Syntax.Sig_declare_typ (lid,uvs,t) ->
          let uu____9272 =
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
              (FStar_Util.for_some
                 (fun uu___10_9280  ->
                    match uu___10_9280 with
                    | FStar_Syntax_Syntax.Projector (uu____9282,uu____9283)
                        -> true
                    | FStar_Syntax_Syntax.Discriminator uu____9285 -> true
                    | uu____9287 -> false))
             in
          if uu____9272
          then FStar_Pervasives_Native.None
            ...
            (let t' =
               let uu____9295 =
                 (let uu____9299 = FStar_Options.print_universes ()  in
                  Prims.op_Negation uu____9299) || (FStar_List.isEmpty uvs)
                  in
               if uu____9295
               then resugar_term' env t
               else
                 (let uu____9304 = FStar_Syntax_Subst.open_univ_vars uvs t
                     in
                  match uu____9304 with
                  | (uvs1,t1) ->
                      let universes = universe_to_string uvs1  in
                      let uu____9313 = resugar_term' env t1  in
                      label universes uu____9313)
                in
             let uu____9314 =
               decl'_to_decl se
          ...
          let uu____9321 =
            let uu____9322 =
              let uu____9323 =
                ...
                let uu____9335 = resugar_term' env t  in
                (uu____9330, uu____9335)  in
              FStar_Parser_AST.Splice uu____9323  in
            decl'_to_decl se uu____9322  in
          FStar_Pervasives_Native.Some uu____9321
      | FStar_Syntax_Syntax.Sig_inductive_typ uu____9338 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Sig_datacon uu____9355 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Sig_main uu____9371 ->
          FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Sig_polymonadic_bind
          (m,n1,p,(uu____9375,t),uu____9377) ->
          let uu____9386 =
            let uu____9387 =
              let uu____9388 =
                let uu____9397 = resugar_term' env t  in
                (m, n1, p, uu____9397)  in
              FStar_Parser_AST.Polymonadic_bind uu____9388  in
            decl'_to_decl se uu____9387  in
...
let (resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term) =
  fun t  -> let uu____9421 = noenv resugar_term'  in uu____9421 t 
let (resugar_sigelt :
  FStar_Syntax_Syntax.sigelt ->
    FStar_Parser_AST.decl FStar_Pervasives_Native.option)
  = fun se  -> let uu____9439 = noenv resugar_sigelt'  in uu____9439 se 
let (resugar_comp : FStar_Syntax_Syntax.comp -> FStar_Parser_AST.term) =
  fun c  -> let uu____9457 = noenv resugar_comp'  in uu____9457 c 
let (resugar_pat :
  FStar_Syntax_Syntax.pat ->
    FStar_Syntax_Syntax.bv FStar_Util.set -> FStar_Parser_AST.pattern)
  =
  fun p  ->
    fun branch_bv  ->
      let uu____9480 = noenv resugar_pat'  in uu____9480 p branch_bv
...
let (resugar_binder :
  ...
  =
  fun b  ->
    fun r  -> let uu____9514 = noenv resugar_binder'  in uu____9514 b r
  
let (resugar_tscheme : FStar_Syntax_Syntax.tscheme -> FStar_Parser_AST.decl)
  = fun ts  -> let uu____9539 = noenv resugar_tscheme'  in uu____9539 ts 
let (resugar_eff_decl :
  FStar_Range.range ->
    FStar_Syntax_Syntax.qualifier Prims.list ->
      FStar_Syntax_Syntax.eff_decl -> FStar_Parser_AST.decl)
  ...
  fun r  ->
    fun q  ->
      fun ed  ->
        let uu____9567 = noenv resugar_eff_decl'  in uu____9567 r q ed
