...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_bvar x ->
        let l =
          let uu____573 =
            let uu____575 = bv_as_unique_ident x  in [uu____575]  in
          FStar_Ident.lid_of_ids uu____573  in
        mk1 (FStar_Parser_AST.Var l)
    | FStar_Syntax_Syntax.Tm_name x ->
        let l =
          let uu____578 =
            let uu____580 = bv_as_unique_ident x  in [uu____580]  in
          ...
          then
            ...
            (let uu____619 =
               ((FStar_Ident.lid_equals a FStar_Syntax_Const.assert_lid) ||
                 ...
                 ||
                 (let uu____620 =
                    let uu____621 = FStar_String.get s (Prims.parse_int "0")
                       in
                    FStar_Char.uppercase uu____621  in
                  let uu____622 = FStar_String.get s (Prims.parse_int "0")
                     in
                  uu____620 <> uu____622)
                in
             if uu____619
    ...
    | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
        let uu____758 =
          let uu____761 =
            let uu____762 = FStar_Syntax_Syntax.mk_binder x  in [uu____762]
             in
        ...
        let resugar_as_app e1 args1 =
          let args2 =
            FStar_All.pipe_right args1
              (FStar_List.map
                 (fun uu____1091  ->
                    match uu____1091 with | (e2,qual) -> resugar_term e2))
             in
                               ...
                               let uu____1171 =
                                 let uu____1175 =
                                   let uu____1177 =
                                     ...
                                     [uu____1179]  in
                                   e1 :: uu____1177  in
                                 ((FStar_Ident.id_of_text "*"), uu____1175)
                                  in
             ...
             (match uu____1230 with
              | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____1236) ->
                  ...
                  (match uu____1259 with
                   | (xs1,body2) ->
                       let xs2 =
                         let uu____1265 = FStar_Options.print_implicits ()
                            in
              ...
              | (body,handler) ->
                  let decomp term =
                    ...
                    | FStar_Syntax_Syntax.Tm_abs (x,e1,uu____1423) ->
                        let uu____1446 = FStar_Syntax_Subst.open_term x e1
                           in
                    ...
                    | uu____1451 ->
                     ...
                     in
                  let body1 =
                    let uu____1453 = decomp body  in resugar_term uu____1453
                     in
                  let handler1 =
         ...
         | Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____1857  ->
                       match uu____1857 with | (e1,qual) -> resugar_term e1))
                in
             (match arity with
              ...
              | _0_32 when
                  ...
                  let uu____1928 =
                    let uu____1929 =
                      let uu____1933 =
                        let uu____1935 = last_two args1  in
                        resugar uu____1935  in
                      (op1, uu____1933)  in
        ...
        let resugar_branch uu____2139 =
          ...
          | (pat,wopt,b) ->
              ...
              let wopt1 =
                ...
                | None  -> None
                | Some e1 ->
                    let uu____2158 = resugar_term e1  in Some uu____2158
                 in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____2193) ->
        ...
        let uu____2246 =
          let uu____2247 =
            let uu____2252 = resugar_term e  in (uu____2252, term, tac_opt1)
             in
             ...
             let resugar_one_binding bnd =
               let uu____2286 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd.FStar_Syntax_Syntax.lbunivs uu____2289
                  in
               ...
               | (univs1,td) ->
                   ...
                   (match uu____2296 with
                    | (typ,def) ->
                        let uu____2372 =
                          let uu____2376 =
                            let uu____2377 = FStar_Syntax_Subst.compress def
                               in
                              ...
                              (match uu____2408 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____2417 then b1 else filter_imp b1
                                      in
                                   (b2, t2, true))
                             ...
                             (match uu____2446 with
                              | (pat,term1) ->
                                  ...
                                  then
                                    ...
                                    (let uu____2501 =
                                       let uu____2504 = resugar_term term1
                                          in
                                       (pat, uu____2504)  in
                                     let uu____2505 =
                                       universe_to_string univs1  in
                                     (uu____2501, uu____2505)))))
                in
              ...
              (match uu____2574 with
               | FStar_Syntax_Syntax.Tm_app (head1,args) ->
                   let rec aux h =
                     ...
                     | FStar_Syntax_Syntax.Tm_fvar fv ->
                         let uu____2609 = FStar_Syntax_Syntax.lid_of_fv fv
                            in
                         (uu____2609, [])
                     ...
                     | uu____2629 -> failwith "wrong Data_app head format"
                      in
                   ...
                   (match uu____2633 with
                    | (head2,universes) ->
                        ...
                        then mk1 (FStar_Parser_AST.Construct (head2, args1))
                          ...
                          (let uu____2670 = FStar_Options.print_universes ()
                              in
                           if uu____2670
                           then
                             mk1
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____2738 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____2769 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
            ...
            FStar_List.map
              (fun uu____3038  ->
                 ...
                 | (e,uu____3044) ->
                     ...
                     (uu____3045, FStar_Parser_AST.Nothing)) args
             in
    ...
    let rec aux p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let args1 =
            let uu____3299 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____3309  ->
                      match uu____3309 with | (p2,b) -> aux p2))
               in
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____3365 = map21 tl1 tl2  in (hd1, hd2) :: uu____3365
             in
          let args2 =
      ...
      | FStar_Syntax_Syntax.Pat_dot_term (bv,term) ->
          let pat =
            let uu____3439 =
              let uu____3440 =
                let uu____3444 = bv_as_unique_ident bv  in (uu____3444, None)
                 in
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____3527 -> failwith "unexpected"))
             in
                 ...
                 then
                   let resugar_datacon_as_fields fields se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_datacon
                         ...
                         ->
                         let uu____3589 =
                           let uu____3590 = FStar_Syntax_Subst.compress term
                              in
                      ...
                      | FStar_Syntax_Syntax.Sig_datacon
                          ...
                          let c =
                            let uu____3732 =
                              ...
                              Some uu____3734  in
                            ((l.FStar_Ident.ident), uu____3732, None, false)
                             in
                          c :: constructors
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____3954 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____3958 =
                     ...
                     let uu____4273 =
                       let uu____4277 =
                         let uu____4278 =
                           ...
                           ((lid.FStar_Ident.ident), bs3, None, uu____4285)
                            in
