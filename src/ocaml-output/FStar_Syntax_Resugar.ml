          ...
          then
            ...
            let args1 =
              FStar_List.map
               ...
               in
            let rec aux l uu___205_6466 =
              match uu___205_6466 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
