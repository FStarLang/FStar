...
let (string_to_op :
  ...
  =
  fun s  ->
    let name_of_op uu___201_417 =
      match uu___201_417 with
      | "Amp" ->
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
          ...
          (match uu____1640 with
           | (xs1,body1) ->
               ...
               let rec aux body3 uu___202_1683 =
                 match uu___202_1683 with
                 | [] -> body3
                 | hd1::tl1 ->
                     let body4 =
      ...
      | FStar_Syntax_Syntax.Tm_app (e,args) ->
          let rec last1 uu___203_1837 =
            match uu___203_1837 with
            | hd1::[] -> [hd1]
            | hd1::tl1 -> last1 tl1
            | uu____1907 -> failwith "last of an empty list"  in
          let rec last_two uu___204_1945 =
      ...
      | FStar_Syntax_Syntax.Tm_meta (e,m) ->
          let resugar_meta_desugared uu___205_4908 =
            match uu___205_4908 with
          ...
          then
            ...
            let args1 =
              FStar_List.map
               ...
               in
            let rec aux l uu___206_5618 =
              match uu___206_5618 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
