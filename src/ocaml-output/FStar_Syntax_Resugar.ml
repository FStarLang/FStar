                    ...
                    let uu____103 =
                      let uu____104 =
                        let uu____105 =
                          ...
                          (uu____111, FStar_Pervasives_Native.None)  in
                      ...
                      let uu____119 =
                        let uu____120 =
                          let uu____121 =
                            ...
                            (uu____127, FStar_Pervasives_Native.None)  in
...
let string_to_op :
  ...
  fun s  ->
    let name_of_op uu___184_173 =
      ...
      | uu____211 -> FStar_Pervasives_Native.None  in
    match s with
               ...
               let op =
                 ...
                 FStar_List.fold_left
                   (fun acc  ->
                      fun x  ->
                        match x with
                        | FStar_Pervasives_Native.Some (op,uu____258) ->
                            Prims.strcat acc op
                        | FStar_Pervasives_Native.None  ->
...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_bvar x ->
        let l =
          let uu____565 =
            let uu____567 = bv_as_unique_ident x  in [uu____567]  in
          FStar_Ident.lid_of_ids uu____565  in
        mk1 (FStar_Parser_AST.Var l)
    | FStar_Syntax_Syntax.Tm_name x ->
        let l =
          let uu____570 =
            let uu____572 = bv_as_unique_ident x  in [uu____572]  in
          ...
          then
            ...
            (let uu____611 =
               ((FStar_Ident.lid_equals a FStar_Parser_Const.assert_lid) ||
                 ...
                 ||
                 (let uu____612 =
                    let uu____613 = FStar_String.get s (Prims.parse_int "0")
                       in
                    FStar_Char.uppercase uu____613  in
                  let uu____614 = FStar_String.get s (Prims.parse_int "0")
                     in
                  uu____612 <> uu____614)
                in
             if uu____611
    ...
    | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
        let uu____750 =
          let uu____753 =
            let uu____754 = FStar_Syntax_Syntax.mk_binder x  in [uu____754]
             in
    ...
    | FStar_Syntax_Syntax.Tm_app (e,args) ->
        ...
        let resugar_as_app e1 args1 =
          let args2 =
            FStar_All.pipe_right args1
              (FStar_List.map
                 (fun uu____1114  ->
                    match uu____1114 with | (e2,qual) -> resugar_term e2))
             in
        ...
        (match uu____1137 with
         ...
         | FStar_Pervasives_Native.Some ("tuple",uu____1143) ->
             (match args1 with
             ...
             (match uu____1253 with
              | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____1259) ->
                  ...
                  (match uu____1282 with
                   | (xs1,body2) ->
                       let xs2 =
                         let uu____1288 = FStar_Options.print_implicits ()
                            in
         ...
         | FStar_Pervasives_Native.Some ("dtuple",uu____1315) ->
             resugar_as_app e args1
         | FStar_Pervasives_Native.Some (ref_read,uu____1319) when
         ...
         | FStar_Pervasives_Native.Some ("try_with",uu____1357) when
              ...
              | (body,handler) ->
                  let decomp term =
                    ...
                    | FStar_Syntax_Syntax.Tm_abs (x,e1,uu____1446) ->
                        let uu____1469 = FStar_Syntax_Subst.open_term x e1
                           in
                    ...
                    | uu____1474 ->
                     ...
                     in
                  let body1 =
                    let uu____1476 = decomp body  in resugar_term uu____1476
                     in
                  let handler1 =
             ...
             let resugar body =
               ...
               | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____1642) ->
                   ...
                   (match uu____1665 with
                    | (xs1,body2) ->
                        let xs2 =
                          let uu____1671 = FStar_Options.print_implicits ()
                             in
         ...
         | FStar_Pervasives_Native.Some ("alloc",uu____1844) ->
         ...
         | FStar_Pervasives_Native.Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____1884  ->
                       match uu____1884 with | (e1,qual) -> resugar_term e1))
                in
             (match arity with
          ...
          | (pat,wopt,b) ->
              ...
              let wopt1 =
                ...
                | FStar_Pervasives_Native.Some e1 ->
                    let uu____2184 = resugar_term e1  in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____2219) ->
        ...
        let uu____2272 =
          let uu____2273 =
            let uu____2278 = resugar_term e  in (uu____2278, term, tac_opt1)
             in
             ...
             let resugar_one_binding bnd =
               let uu____2312 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd.FStar_Syntax_Syntax.lbunivs uu____2315
                  in
               ...
               | (univs1,td) ->
                   ...
                   (match uu____2322 with
                    | (typ,def) ->
                        let uu____2398 =
                          let uu____2402 =
                            let uu____2403 = FStar_Syntax_Subst.compress def
                               in
                              ...
                              (match uu____2434 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____2443 then b1 else filter_imp b1
                                      in
                                   (b2, t2, true))
                             ...
                             (match uu____2472 with
                              | (pat,term1) ->
                                  ...
                                  then
                                    ...
                                    (let uu____2527 =
                                       let uu____2530 = resugar_term term1
                                          in
                                       (pat, uu____2530)  in
                                     let uu____2531 =
                                       universe_to_string univs1  in
                                     (uu____2527, uu____2531)))))
                in
              ...
              (match uu____2600 with
               | FStar_Syntax_Syntax.Tm_app (head1,args) ->
                   let rec aux h =
                     ...
                     | FStar_Syntax_Syntax.Tm_fvar fv ->
                         let uu____2635 = FStar_Syntax_Syntax.lid_of_fv fv
                            in
                         (uu____2635, [])
                     ...
                     | uu____2655 -> failwith "wrong Data_app head format"
                      in
                   ...
                   (match uu____2659 with
                    | (head2,universes) ->
                        ...
                        then mk1 (FStar_Parser_AST.Construct (head2, args1))
                          ...
                          (let uu____2696 = FStar_Options.print_universes ()
                              in
                           if uu____2696
                           then
                             mk1
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____2764 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____2795 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
             ...
             let uu____2839 =
               let uu____2840 =
                 ...
                 let uu____2846 =
                   ...
                   mk1 uu____2847  in
                 (uu____2845, uu____2846, FStar_Pervasives_Native.None)  in
             ...
             let uu____2877 =
               let uu____2878 =
                 ...
                 let uu____2884 =
                   ...
                   mk1 uu____2885  in
                 (uu____2883, uu____2884, FStar_Pervasives_Native.None)  in
  ...
  fun x  ->
    fun qual  ->
      ...
      | FStar_Syntax_Syntax.Tm_unknown  ->
          ...
          then
            let uu____3194 = mk1 FStar_Parser_AST.PatWild  in
             ...
             FStar_Util.bind_opt uu____3196
               (fun aq  ->
                  let uu____3202 =
                    ...
                    mk1 uu____3203  in
                  FStar_Pervasives_Native.Some uu____3202))
      | uu____3210 ->
    ...
    let rec aux p1 =
      ...
      | FStar_Syntax_Syntax.Pat_var v1 ->
          ...
          (match uu____3466 with
           | FStar_Pervasives_Native.Some (op,uu____3471) ->
               mk1
      ...
      | FStar_Syntax_Syntax.Pat_dot_term (bv,term) ->
          let pat =
            let uu____3491 =
              let uu____3492 =
                let uu____3496 = bv_as_unique_ident bv  in
                (uu____3496, FStar_Pervasives_Native.None)  in
...
let resugar_qualifier :
  ...
  fun uu___192_3508  ->
    ...
    | FStar_Syntax_Syntax.Discriminator uu____3515 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Projector uu____3516 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordType uu____3519 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.RecordConstructor uu____3524 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Action uu____3529 -> FStar_Pervasives_Native.None
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____3579 -> failwith "unexpected"))
             in
                 ...
                 then
                   let resugar_datacon_as_fields fields se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_datacon
                         ...
                         ->
                         let uu____3641 =
                           let uu____3642 = FStar_Syntax_Subst.compress term
                              in
                   ...
                   (let resugar_datacon constructors se1 =
                      ...
                      | FStar_Syntax_Syntax.Sig_datacon
                          ...
                          let c =
                            ...
                            ((l.FStar_Ident.ident), uu____3784,
                ...
                let uu____3880 =
                  let uu____3884 =
                    let uu____3885 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____3892)
                       in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____4006 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____4010 =
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_sub_effect e ->
        ...
        let lift_wp =
          ...
          | FStar_Pervasives_Native.Some (uu____4260,t) ->
              let uu____4267 = resugar_term t  in
              FStar_Pervasives_Native.Some uu____4267
          | uu____4268 -> FStar_Pervasives_Native.None  in
        let lift =
          match e.FStar_Syntax_Syntax.lift with
          | FStar_Pervasives_Native.Some (uu____4273,t) ->
              let uu____4280 = resugar_term t  in
              FStar_Pervasives_Native.Some uu____4280
          | uu____4281 -> FStar_Pervasives_Native.None  in
        let op =
                       ...
                       let uu____4340 =
                         let uu____4341 =
                           ...
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____4348)
                            in
                         FStar_Parser_AST.TyconAbbrev uu____4341  in
                       (uu____4340, FStar_Pervasives_Native.None)  in
                     [uu____4336]  in
                   (false, uu____4331)  in
    ...
    | FStar_Syntax_Syntax.Sig_pragma p ->
        ...
        FStar_Pervasives_Native.Some uu____4363
    ...
    | FStar_Syntax_Syntax.Sig_inductive_typ uu____4382 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Sig_datacon uu____4391 ->
        FStar_Pervasives_Native.None
    | FStar_Syntax_Syntax.Sig_main uu____4399 -> FStar_Pervasives_Native.None
