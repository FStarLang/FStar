...
in (Prims.op_disEquality uu____1050 uu____1052))))
...
| FStar_Pervasives_Native.Some (ref_read, uu____2133) when (Prims.op_Equality ref_read FStar_Parser_Const.sread_lid.FStar_Ident.str) -> begin
(
...
| FStar_Pervasives_Native.Some (op, uu____2476) when ((Prims.op_Equality op "forall") || (Prims.op_Equality op "exists")) -> begin
(
...
let uu____4243 = (FStar_All.try_with (fun uu___202_4278 -> (match (()) with
| () -> begin
(

let uu____4295 = (FStar_Syntax_Util.unmeta e)
in (head_fv_universes_args uu____4295))
end)) (fun uu___201_4299 -> (match (uu___201_4299) with
