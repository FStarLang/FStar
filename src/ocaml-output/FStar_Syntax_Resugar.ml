    ...
    let fallback fv =
      ...
      | uu___1 ->
            ...
            then
              ...
              (let uu___3 =
                 FStar_Ident.string_of_lid
                   (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                  in
               FStar_Util.substring_from uu___3 (length + Prims.int_one))
             in
          let uu___2 =
          ...
          then
            let uu___3 =
              let uu___4 =
                let uu___5 = FStar_Util.substring_from str (Prims.of_int (6))
                   in
          ...
          then
            ...
            (let uu___2 =
               FStar_Ident.string_of_lid
                 (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                in
             FStar_Util.substring_from uu___2 (length + Prims.int_one))
           in
...
let (may_shorten : FStar_Ident.lident -> Prims.bool) =
  fun lid  ->
    ...
    | "Prims.Cons" -> false
    | uu___1 ->
        let uu___2 = is_tuple_constructor_lid lid  in
  ...
  fun env  ->
    fun t  ->
                  ...
                  then
                    ...
                    (let uu___7 =
                       ((FStar_Ident.lid_equals a
                         ...
                         ||
                         (let uu___8 =
                            let uu___9 = FStar_String.get s Prims.int_zero
                               in
      ...
      | FStar_Syntax_Syntax.Tm_constant c ->
          ...
          if uu___1
          then
            let uu___2 = name "Effect" t.FStar_Syntax_Syntax.pos  in
            mk uu___2
      ...
      | FStar_Syntax_Syntax.Tm_type u ->
          ...
          (match uu___1 with
           | (nm,needs_app) ->
               let typ =
                 let uu___2 = name nm t.FStar_Syntax_Syntax.pos  in mk uu___2
                  in
               let uu___2 = needs_app && (FStar_Options.print_universes ())
                  in
               if uu___2
               then
                 let uu___3 =
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
             ...
             FStar_Syntax_Syntax.vars = uu___2;_},(e,uu___3)::[])
          when
          (let uu___4 = FStar_Options.print_implicits ()  in
                     ...
                     | (xs1,body2) ->
                         ...
                         let uu___6 =
                           let uu___7 =
                             let uu___8 =
                               FStar_List.map
                                 (fun uu___9  -> FStar_Util.Inl uu___9) xs3
                                in
                             (uu___8, body3)  in
                ...
                | (t1,uu___4) ->
                    ...
                    (match uu___5 with
                     | FStar_Syntax_Syntax.Tm_fvar fv when
                         ...
                         let uu___6 =
                           let uu___7 =
                             let uu___8 = resugar_term' env t1  in
                             (uu___8, f)  in
                  ...
                  (fun uu___3  ->
                     ...
                     | () ->
                         ...
                         let uu___4 =
                           ...
                           | uu___5 -> failwith "wrong arguments to try_with"
                            in
                         (match uu___4 with
                          | (body,handler) ->
                              let decomp term =
                                ...
                                | uu___6 ->
                                    let uu___7 =
                                      let uu___8 =
                                        let uu___9 = resugar_term' env term
                                           in
                              ...
                              let rec resugar_body t1 =
                                ...
                                | FStar_Parser_AST.Let (uu___5,uu___6,b) -> b
                 ...
                 | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu___4) ->
                     ...
                     (match uu___5 with
                      | (xs1,body2) ->
                          ...
                          let uu___6 =
                            let uu___7 =
                              let uu___8 = FStar_Syntax_Subst.compress body2
                                 in
           ...
           | FStar_Pervasives_Native.Some (op,expected_arity1) ->
               ...
               (match expected_arity1 with
                | FStar_Pervasives_Native.None  ->
                    ...
                    then
                      let uu___2 = FStar_Util.first_N expect_n resugared_args
                         in
                      (match uu___2 with
                       | (op_args,rest) ->
                           let head =
               ...
               let bnds =
                 let uu___2 =
                   let uu___3 =
                     ...
                     let uu___5 = resugar_term' env e  in (uu___4, uu___5)
                      in
      ...
      | FStar_Syntax_Syntax.Tm_match
          ...
          let uu___3 =
            let uu___4 =
              ...
              let uu___7 = resugar_term' env t2  in (uu___5, uu___6, uu___7)
               in
      ...
      | FStar_Syntax_Syntax.Tm_match (e,branches) ->
          let resugar_branch uu___1 =
            match uu___1 with
            | (pat,wopt,b) ->
                let uu___2 = FStar_Syntax_Subst.open_branch (pat, wopt, b)
                   in
                (match uu___2 with
                 | (pat1,wopt1,b1) ->
      ...
      | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu___1) ->
          ...
          let uu___2 =
            let uu___3 =
              let uu___4 = resugar_term' env e  in (uu___4, term, tac_opt1)
               in
           ...
           | (source_lbs1,body1) ->
               let resugar_one_binding bnd =
                 let attrs_opt =
                   ...
                   | [] -> FStar_Pervasives_Native.None
                   | tms ->
                       let uu___2 = FStar_List.map (resugar_term' env) tms
                          in
                       FStar_Pervasives_Native.Some uu___2
                    in
                 let uu___2 =
                   ...
                   FStar_Syntax_Subst.open_univ_vars
                     bnd.FStar_Syntax_Syntax.lbunivs uu___3
                    in
                 match uu___2 with
                 | (univs,td) ->
                     let uu___3 =
                     ...
                     (match uu___3 with
                      | (typ,def) ->
                          let uu___4 =
                            let uu___5 =
                              let uu___6 = FStar_Syntax_Subst.compress def
                                 in
                              uu___6.FStar_Syntax_Syntax.n  in
                            match uu___5 with
                                ...
                                (match uu___7 with
                                 | (b1,t2) ->
                                     let b2 =
                                       ...
                                       if uu___8 then b1 else filter_imp b1
                                        in
                                     (b2, t2, true))
                            | uu___6 -> ([], def, false)  in
                          (match uu___4 with
                               ...
                               let uu___5 =
                                 ...
                                 | FStar_Util.Inl bv ->
                                     let uu___6 =
                                       let uu___7 =
                                         let uu___8 =
                                           let uu___9 = bv_as_unique_ident bv
                                              in
                                           (uu___9,
                                             FStar_Pervasives_Native.None)
                                            in
                                        ...
                                        let uu___7 =
                                          ...
                                          ((mk_pat
                                              (FStar_Parser_AST.PatApp
                                                 (pat, args))), uu___8)
                                           in
                                        let uu___8 = universe_to_string univs
                                           in
                                        (uu___7, uu___8)
                                      else
                                        (let uu___8 =
      ...
      | FStar_Syntax_Syntax.Tm_quoted (tm,qi) ->
          let qi1 =
            ...
            | FStar_Syntax_Syntax.Quote_dynamic  -> FStar_Parser_AST.Dynamic
             in
          let uu___1 =
            let uu___2 = let uu___3 = resugar_term' env tm  in (uu___3, qi1)
               in
            ...
            | FStar_Syntax_Syntax.Sequence  ->
                ...
                let rec resugar_seq t1 =
                  ...
                  | FStar_Parser_AST.Ascribed (t11,t2,t3) ->
                      let uu___2 =
                        let uu___3 =
                          let uu___4 = resugar_seq t11  in (uu___4, t2, t3)
                           in
                        FStar_Parser_AST.Ascribed uu___3  in
                      mk uu___2
                  | uu___2 -> t1  in
            ...
            (match uu___1 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu___2,FStar_Pervasives_Native.Some
                    (FStar_Syntax_Syntax.Implicit uu___3))::(rel,FStar_Pervasives_Native.None
                                                             )::(uu___4,FStar_Pervasives_Native.Some
                                                                 (FStar_Syntax_Syntax.Implicit
                                                                 uu___5))::
                (uu___6,FStar_Pervasives_Native.Some
                 (FStar_Syntax_Syntax.Implicit uu___7))::(pf,FStar_Pervasives_Native.None
                                                          )::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      let resugar_step pack =
        ...
        | (hd,args) ->
            ...
            (match uu___1 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu___2,FStar_Pervasives_Native.Some
                    (FStar_Syntax_Syntax.Implicit uu___3))::(uu___4,FStar_Pervasives_Native.Some
                                                             (FStar_Syntax_Syntax.Implicit
                                                             uu___5))::
                (uu___6,FStar_Pervasives_Native.Some
                 (FStar_Syntax_Syntax.Implicit uu___7))::(rel,FStar_Pervasives_Native.None
                                                          )::(z,FStar_Pervasives_Native.None
                                                              )::(pf,FStar_Pervasives_Native.None
                                                                  )::
      ...
      let resugar_init pack =
        ...
        | (hd,args) ->
            ...
            (match uu___1 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu___2,FStar_Pervasives_Native.Some
                    (FStar_Syntax_Syntax.Implicit uu___3))::(x,FStar_Pervasives_Native.None
                                                             )::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fv
            ...
            let uu___1 =
              (FStar_Options.print_implicits ()) &&
                (FStar_List.existsb
                   (fun uu___2  ->
                      match uu___2 with
                      | (uu___3,q) -> FStar_Syntax_Syntax.is_implicit q) args)
               in
            if uu___1
            then fallback ()
            else
              (let uu___3 = resugar_term_as_op hd  in
               ...
               | FStar_Pervasives_Native.Some
                   ...
                   let uu___4 =
                     let uu___5 =
                       let uu___6 = FStar_Ident.id_of_text s  in (uu___6, [])
                        in
               ...
               | FStar_Pervasives_Native.Some
                   ...
                   let uu___5 =
                     let uu___6 =
                       let uu___7 = FStar_Ident.id_of_text s  in (uu___7, [])
                        in
              ...
              FStar_List.map
                (fun uu___5  ->
                   ...
                   | (z,rel1,j) ->
                       ...
                       FStar_Parser_AST.CalcStep uu___6) steps
               in
  ...
  fun env  ->
    fun c  ->
      ...
      | FStar_Syntax_Syntax.Comp c1 ->
          let result =
            let uu___ = resugar_term' env c1.FStar_Syntax_Syntax.result_typ
               in
            ...
            let args1 =
              FStar_List.map
                (fun uu___1  ->
                   ...
                   | (e,uu___2) ->
                       let uu___3 = resugar_term' env e  in
                       (uu___3, FStar_Parser_AST.Nothing)) args
               in
              ...
              (fun imp  ->
                 ...
                 | uu___2 ->
                     ...
                     then
                       ...
                       (let uu___5 =
                          let uu___6 =
                            let uu___7 = bv_as_unique_ident x  in (uu___7, e)
                             in
          ...
          | FStar_Syntax_Syntax.Pat_cons (fv,args) when
              ...
              (match uu___ with
               | (hd,false )::(tl,false )::[] ->
                   ...
                   let uu___1 = aux tl (FStar_Pervasives_Native.Some false)
                      in
                   (match uu___1 with
                   ...
                   ((let uu___2 =
                       let uu___3 =
                         ...
                         FStar_Util.format1
                           ...
                           uu___4
                          in
                       (FStar_Errors.Warning_ConsAppliedExplicitArgs, uu___3)
                        in
              ...
              let rec map2 l1 l2 =
                ...
                | (hd::tl,[]) ->
                    ...
                    (hd,
                      ...
                      :: uu___2
                | (hd1::tl1,hd2::tl2) ->
                    let uu___2 = map2 tl1 tl2  in (hd1, hd2) :: uu___2
                 in
              let args2 =
                ...
                (FStar_List.partition
                   (fun se1  ->
                      ...
                      | FStar_Syntax_Syntax.Sig_datacon
                          (uu___2,uu___3,uu___4,inductive_lid,uu___5,uu___6)
                          -> FStar_Ident.lid_equals inductive_lid tylid
                      | uu___2 -> failwith "unexpected"))
               in
            (match uu___1 with
                   ...
                   then
                     let resugar_datacon_as_fields fields se1 =
                       ...
                       | FStar_Syntax_Syntax.Sig_datacon
                           ...
                           let uu___7 =
                             let uu___8 = FStar_Syntax_Subst.compress term
                                in
                             uu___8.FStar_Syntax_Syntax.n  in
                           (match uu___7 with
                     ...
                     let uu___4 =
                       ...
                       (uu___5, bs2, FStar_Pervasives_Native.None, fields)
                        in
                     ...
                     (let resugar_datacon constructors se1 =
                      ...
                      let uu___5 =
                        ...
                        (uu___6, bs2, FStar_Pervasives_Native.None,
                          constructors)
                         in
                      FStar_Parser_AST.TyconVariant uu___5)
                    in
                 (other_datacons, tyc))
        | uu___ ->
            failwith
                ...
                (match uu___1 with
                 | (bs1,action_typ) ->
                     ...
                     then
                       let a =
                         let uu___2 =
                           let uu___3 = FStar_Ident.lid_of_str "construct"
                              in
                           (uu___3,
...
let (resugar_sigelt' :
  ...
  fun env  ->
    fun se  ->
                         ...
                         (match se1.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_datacon
                              ...
                              let uu___8 =
                                let uu___9 =
                                  let uu___10 =
                                    let uu___11 = FStar_Ident.ident_of_lid l
                                       in
            ...
            (let t' =
               let uu___2 =
                 (let uu___3 = FStar_Options.print_universes ()  in
                  Prims.op_Negation uu___3) || (FStar_List.isEmpty uvs)
                  in
               if uu___2
               then resugar_term' env t
                 ...
                 (let uu___4 = FStar_Syntax_Subst.open_univ_vars uvs t  in
                  ...
                  | (uvs1,t1) ->
                      ...
                      label universes uu___5)
                in
             let uu___2 =
               let uu___3 =
                 let uu___4 =
                   let uu___5 = FStar_Ident.ident_of_lid lid  in (uu___5, t')
                    in
      ...
      | FStar_Syntax_Syntax.Sig_polymonadic_bind (m,n,p,(uu___,t),uu___1) ->
          let uu___2 =
            let uu___3 =
              let uu___4 =
            ...
            decl'_to_decl se uu___3  in
          FStar_Pervasives_Native.Some uu___2
      | FStar_Syntax_Syntax.Sig_polymonadic_subcomp (m,n,(uu___,t),uu___1) ->
          let uu___2 =
            let uu___3 =
              let uu___4 =
                let uu___5 = resugar_term' env t  in (m, n, uu___5)  in
