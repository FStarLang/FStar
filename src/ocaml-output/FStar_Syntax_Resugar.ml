...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
        let uu____764 =
          let uu____767 =
            let uu____768 = FStar_Syntax_Syntax.mk_binder x  in [uu____768]
             in
         ...
         | (x1,phi1) ->
             ...
             (match uu____771 with
              | (b,uu____777) ->
                  ...
                  let uu____779 =
                    let uu____780 =
                      let uu____783 = resugar_term phi1  in (b1, uu____783)
                       in
        ...
        let resugar_as_app e1 args1 =
          let args2 =
            FStar_All.pipe_right args1
              (FStar_List.map
                 (fun uu____1101  ->
                    match uu____1101 with | (e2,qual) -> resugar_term e2))
             in
                               ...
                               let uu____1181 =
                                 let uu____1185 =
                                   let uu____1187 =
                                     ...
                                     [uu____1189]  in
                                   e1 :: uu____1187  in
                                 ((FStar_Ident.id_of_text "*"), uu____1185)
                                  in
             ...
             (match uu____1240 with
              | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____1246) ->
                  ...
                  (match uu____1269 with
                   | (xs1,body2) ->
                       let xs2 =
                         let uu____1275 = FStar_Options.print_implicits ()
                            in
              ...
              | (body,handler) ->
                  let decomp term =
                    ...
                    | FStar_Syntax_Syntax.Tm_abs (x,e1,uu____1439) ->
                        let uu____1462 = FStar_Syntax_Subst.open_term x e1
                           in
                    ...
                    | uu____1467 ->
                     ...
                     in
                  let body1 =
                    let uu____1469 = decomp body  in resugar_term uu____1469
                     in
                  let handler1 =
             ...
             let resugar body =
               ...
               | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____1631) ->
                   ...
                   (match uu____1654 with
                    | (xs1,body2) ->
                        let xs2 =
                          let uu____1660 = FStar_Options.print_implicits ()
                             in
         ...
         | Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____1893  ->
                       match uu____1893 with | (e1,qual) -> resugar_term e1))
                in
             (match arity with
              ...
              | _0_32 when
                  ...
                  let uu____1964 =
                    let uu____1965 =
                      let uu____1969 =
                        let uu____1971 = last_two args1  in
                        resugar uu____1971  in
                      (op1, uu____1969)  in
        ...
        let resugar_branch uu____2175 =
          ...
          | (pat,wopt,b) ->
              ...
              let wopt1 =
                ...
                | None  -> None
                | Some e1 ->
                    let uu____2194 = resugar_term e1  in Some uu____2194
                 in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____2229) ->
        ...
        let uu____2282 =
          let uu____2283 =
            let uu____2288 = resugar_term e  in (uu____2288, term, tac_opt1)
             in
             ...
             let resugar_one_binding bnd =
               let uu____2322 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd.FStar_Syntax_Syntax.lbunivs uu____2325
                  in
               ...
               | (univs1,td) ->
                   ...
                   (match uu____2332 with
                    | (typ,def) ->
                        let uu____2408 =
                          let uu____2412 =
                            let uu____2413 = FStar_Syntax_Subst.compress def
                               in
                              ...
                              (match uu____2444 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____2453 then b1 else filter_imp b1
                                      in
                                   (b2, t2, true))
                             ...
                             (match uu____2482 with
                              | (pat,term1) ->
                                  ...
                                  then
                                    ...
                                    (let uu____2537 =
                                       let uu____2540 = resugar_term term1
                                          in
                                       (pat, uu____2540)  in
                                     let uu____2541 =
                                       universe_to_string univs1  in
                                     (uu____2537, uu____2541)))))
                in
              ...
              (match uu____2610 with
               | FStar_Syntax_Syntax.Tm_app (head1,args) ->
                   let rec aux h =
                     ...
                     | FStar_Syntax_Syntax.Tm_fvar fv ->
                         let uu____2645 = FStar_Syntax_Syntax.lid_of_fv fv
                            in
                         (uu____2645, [])
                     ...
                     | uu____2665 -> failwith "wrong Data_app head format"
                      in
                   ...
                   (match uu____2669 with
                    | (head2,universes) ->
                        ...
                        then mk1 (FStar_Parser_AST.Construct (head2, args1))
                          ...
                          (let uu____2705 = FStar_Options.print_universes ()
                              in
                           if uu____2705
                           then
                             mk1
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____2773 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____2804 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
            ...
            FStar_List.map
              (fun uu____3073  ->
                 ...
                 | (e,uu____3079) ->
                     ...
                     (uu____3080, FStar_Parser_AST.Nothing)) args
             in
    ...
    fun r  ->
      ...
      | uu____3144 ->
          ...
          then
            ...
            (let uu____3147 =
               let uu____3148 =
                 let uu____3151 = bv_as_unique_ident x  in (uu____3151, e)
                  in
    ...
    let rec aux p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let args1 =
            let uu____3330 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____3340  ->
                      match uu____3340 with | (p2,b) -> aux p2))
               in
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____3396 = map21 tl1 tl2  in (hd1, hd2) :: uu____3396
             in
          let args2 =
      ...
      | FStar_Syntax_Syntax.Pat_dot_term (bv,term) ->
          let pat =
            let uu____3470 =
              let uu____3471 =
                let uu____3475 = bv_as_unique_ident bv  in (uu____3475, None)
                 in
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____3558 -> failwith "unexpected"))
             in
...
let decl'_to_decl :
  ...
  fun se  ->
    fun d'  ->
      let uu____3594 =
        FStar_List.choose resugar_qualifier se.FStar_Syntax_Syntax.sigquals
         in
      {
