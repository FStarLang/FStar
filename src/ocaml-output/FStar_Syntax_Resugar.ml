...
let string_to_op :
  ...
  =
  fun s  ->
    let name_of_op uu___107_338 =
      match uu___107_338 with
...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
        ...
        (match uu____1142 with
         | (xs1,body1) ->
             ...
             let rec aux body3 uu___108_1175 =
               match uu___108_1175 with
               | [] -> body3
               | hd1::tl1 ->
    ...
    | FStar_Syntax_Syntax.Tm_app (e,args) ->
        let rec last1 uu___109_1257 =
          match uu___109_1257 with
          | hd1::[] -> [hd1]
          | hd1::tl1 -> last1 tl1
          | uu____1327 -> failwith "last of an empty list"  in
        let rec last_two uu___110_1363 =
          match uu___110_1363 with
          | [] ->
              failwith
        ...
        let rec last_three uu___111_1512 =
          match uu___111_1512 with
          | [] ->
              failwith
         ...
         | FStar_Pervasives_Native.Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____2932  ->
                       match uu____2932 with | (e1,qual) -> resugar_term e1))
                in
             (match arity with
              ...
              | _0_43 when
                  ...
                  let uu____3025 =
                    let uu____3026 =
                      let uu____3033 =
                        let uu____3036 = last_two args1  in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____3404) ->
        ...
        let uu____3471 =
          let uu____3472 =
            let uu____3481 = resugar_term e  in (uu____3481, term, tac_opt1)
             in
             ...
             let resugar_one_binding bnd =
               let uu____3530 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd.FStar_Syntax_Syntax.lbunivs uu____3535
                  in
               ...
               | (univs1,td) ->
                   ...
                   (match uu____3546 with
                    | (typ,def) ->
                        let uu____3641 =
                          let uu____3648 =
                            let uu____3649 = FStar_Syntax_Subst.compress def
                               in
                              ...
                              (match uu____3681 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____3695 then b1 else filter_imp b1
                                      in
                                   (b2, t2, true))
                             ...
                             (match uu____3721 with
                              | (pat,term1) ->
                                  ...
                                  then
                                    ...
                                    (let uu____3829 =
                                       let uu____3834 = resugar_term term1
                                          in
                                       (pat, uu____3834)  in
                                     let uu____3835 =
                                       universe_to_string univs1  in
                                     (uu____3829, uu____3835)))))
                in
    ...
    | FStar_Syntax_Syntax.Tm_meta (e,m) ->
        let resugar_meta_desugared uu___113_3981 =
          match uu___113_3981 with
                    ...
                    let uu____4309 =
                      let uu____4314 =
                        ...
                        FStar_Util.format1 "wrong Data_app head format %s"
                          uu____4315
                         in
                      (FStar_Errors.Fatal_WrongDataAppHeadFormat, uu____4314)
                       in
                   ...
                   let universes1 =
                     FStar_List.map
                       (fun u  ->
                          ...
                          (uu____4370, FStar_Parser_AST.UnivApp)) universes
                      in
                   let args1 =
                   ...
                   let args2 =
                     let uu____4444 =
                       (FStar_Parser_Const.is_tuple_data_lid' head1) ||
                         (let uu____4446 = FStar_Options.print_universes ()
                             in
                          Prims.op_Negation uu____4446)
                        in
                     if uu____4444
                     then args1
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____4531 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____4568 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
            ...
            FStar_List.map
              (fun uu____5125  ->
                 ...
                 | (e,uu____5135) ->
                     ...
                     (uu____5136, FStar_Parser_AST.Nothing)) args
             in
          let rec aux l uu___114_5157 =
            match uu___114_5157 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____5634 = map21 tl1 tl2  in (hd1, hd2) :: uu____5634
             in
          let args2 =
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____5887 -> failwith "unexpected"))
             in
                 ...
                 then
                   let resugar_datacon_as_fields fields se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_datacon
                         ...
                         ->
                         let uu____5989 =
                           let uu____5990 = FStar_Syntax_Subst.compress term
                              in
                ...
                let uu____6403 =
                  let uu____6410 =
                    let uu____6411 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____6424)
                       in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____6605 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____6610 =
                       ...
                       let uu____7123 =
                         let uu____7124 =
                           ...
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____7137)
                            in
          ...
          (let t' =
             let uu____7184 =
               (let uu____7187 = FStar_Options.print_universes ()  in
                Prims.op_Negation uu____7187) || (FStar_List.isEmpty uvs)
                in
             if uu____7184
             then resugar_term t
             else
