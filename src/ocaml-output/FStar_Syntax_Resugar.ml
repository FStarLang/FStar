...
let string_to_op:
  ...
  =
  fun s  ->
    let name_of_op uu___208_356 =
      match uu___208_356 with
...
let rec resugar_term: FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
        ...
        (match uu____1159 with
         | (xs1,body1) ->
             ...
             let rec aux body3 uu___209_1192 =
               match uu___209_1192 with
               | [] -> body3
               | hd1::tl1 ->
    ...
    | FStar_Syntax_Syntax.Tm_app (e,args) ->
        let rec last1 uu___210_1274 =
          match uu___210_1274 with
          | hd1::[] -> [hd1]
          | hd1::tl1 -> last1 tl1
          | uu____1344 -> failwith "last of an empty list" in
        let rec last_two uu___211_1380 =
          match uu___211_1380 with
          | [] ->
              failwith
        ...
        let rec last_three uu___212_1529 =
          match uu___212_1529 with
          | [] ->
              failwith
    ...
    | FStar_Syntax_Syntax.Tm_meta (e,m) ->
        let resugar_meta_desugared uu___214_3993 =
          match uu___214_3993 with
  ...
  fun c  ->
    ...
    | FStar_Syntax_Syntax.Comp c1 ->
        ...
        then
          ...
          let rec aux l uu___215_5162 =
            match uu___215_5162 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
