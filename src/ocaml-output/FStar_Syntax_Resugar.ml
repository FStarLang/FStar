...
let string_to_op: Prims.string -> Prims.string Prims.option =
  fun s  ->
    let name_of_op uu___198_159 =
      match uu___198_159 with
      | "Amp" -> Some "&"
      | "At" -> Some "@"
      | "Plus" -> Some "+"
      | "Minus" -> Some "-"
...
let rec resugar_term: FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_bvar x ->
        let l =
          let uu____437 = let uu____439 = bv_as_unique_ident x in [uu____439] in
          FStar_Ident.lid_of_ids uu____437 in
        mk1 (FStar_Parser_AST.Var l)
    | FStar_Syntax_Syntax.Tm_name x ->
        let l =
          let uu____442 = let uu____444 = bv_as_unique_ident x in [uu____444] in
          ...
          then
            ...
            (let uu____483 =
               ((FStar_Ident.lid_equals a FStar_Syntax_Const.assert_lid) ||
                 ...
                 ||
                 (let uu____484 =
                    let uu____485 = FStar_String.get s (Prims.parse_int "0") in
                    FStar_Char.uppercase uu____485 in
                  let uu____486 = FStar_String.get s (Prims.parse_int "0") in
                  uu____484 <> uu____486) in
             if uu____483
             then
    ...
    | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
        ...
        (match uu____584 with
         | (xs1,body1) ->
             ...
             let rec aux body3 uu___199_614 =
               match uu___199_614 with
               | [] -> body3
               | hd1::tl1 ->
    ...
    | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
        let uu____627 =
          let uu____630 =
            let uu____631 = FStar_Syntax_Syntax.mk_binder x in [uu____631] in
         ...
         | (x1,phi1) ->
             ...
             (match uu____634 with
              | (b,uu____640) ->
                  ...
                  let uu____642 =
                    let uu____643 =
                      let uu____646 = resugar_term phi1 in (b1, uu____646) in
                    FStar_Parser_AST.Refine uu____643 in
                  mk1 uu____642))
    | FStar_Syntax_Syntax.Tm_app (e,args) ->
        let rec last1 uu___200_676 =
          match uu___200_676 with
          | hd1::[] -> [hd1]
          | hd1::tl1 -> last1 tl1
          | uu____723 -> failwith "last of an empty list" in
        let rec last_two uu___201_747 =
          match uu___201_747 with
          | []|_::[] ->
              failwith
                "last two elements of a list with less than two elements "
          | a1::a2::[] -> [a1; a2]
          | uu____810::t1 -> last_two t1 in
        let rec last_three uu___202_838 =
          match uu___202_838 with
          | []|_::[]|_::_::[] ->
              failwith
        ...
        let resugar_as_app e1 args1 =
          let args2 =
            FStar_All.pipe_right args1
              (FStar_List.map
                 (fun uu____964  ->
                    match uu____964 with | (e2,qual) -> resugar_term e2)) in
                               ...
                               let uu____1037 =
                                 let uu____1041 =
                                   let uu____1043 =
                                     ...
                                     [uu____1045] in
                                   e1 :: uu____1043 in
                                 ((FStar_Ident.id_of_text "*"), uu____1041) in
              ...
              | (body,handler) ->
                  let decomp term =
                    ...
                    | FStar_Syntax_Syntax.Tm_abs (x,e1,uu____1283) ->
                        let uu____1306 = FStar_Syntax_Subst.open_term x e1 in
                        (match uu____1306 with | (x1,e2) -> e2)
                    | uu____1311 ->
                        failwith "wrong argument format to try_with" in
                  let body1 =
                    let uu____1313 = decomp body in resugar_term uu____1313 in
                  let handler1 =
             ...
             let resugar body =
               ...
               | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____1460) ->
                   ...
                   (match uu____1483 with
                    | (xs1,body2) ->
                        let xs2 =
                          let uu____1489 = FStar_Options.print_implicits () in
         ...
         | Some op ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____1716  ->
                       match uu____1716 with | (e1,qual) -> resugar_term e1)) in
             let uu____1721 =
             ...
             (match uu____1721 with
              | _0_27 when
                  ...
                  let uu____1729 =
                    let uu____1730 =
                      let uu____1734 =
                        let uu____1736 = last1 args1 in resugar uu____1736 in
                      (op1, uu____1734) in
              ...
              | _0_28 when
                  ...
                  let uu____1748 =
                    let uu____1749 =
                      let uu____1753 =
                        let uu____1755 = last_two args1 in resugar uu____1755 in
                      (op1, uu____1753) in
        ...
        let resugar_branch uu____1907 =
          ...
          | (pat,wopt,b) ->
              ...
              let wopt1 =
                ...
                | None  -> None
                | Some e1 ->
                    let uu____1926 = resugar_term e1 in Some uu____1926 in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____1961) ->
        ...
        let uu____2014 =
          let uu____2015 =
            let uu____2020 = resugar_term e in (uu____2020, term, tac_opt1) in
             ...
             let resugar_one_binding bnd1 =
               let uu____2054 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd1.FStar_Syntax_Syntax.lbunivs uu____2057 in
               ...
               | (univs1,td) ->
                   ...
                   (match uu____2064 with
                    | (typ,def) ->
                        let uu____2140 =
                          let uu____2144 =
                            let uu____2145 = FStar_Syntax_Subst.compress def in
                              ...
                              (match uu____2176 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____2185 then b1 else filter_imp b1 in
                                   (b2, t2, true))
                                           ...
                                           (fun uu____2266  ->
                                              ...
                                              | (bv,uu____2270) ->
                                                  let uu____2271 =
                                                    ...
                                                    FStar_Parser_AST.PatVar
                                                      uu____2272 in
                                                  mk_pat uu____2271)) in
                                    let uu____2278 =
                                      let uu____2281 = resugar_term term1 in
                                      ((mk_pat
                                          (FStar_Parser_AST.PatApp
                                             (pat, args))), uu____2281) in
                                    let uu____2283 =
                                      universe_to_string univs1 in
                                    (uu____2278, uu____2283)
                                  else
                                    (let uu____2287 =
                                       let uu____2290 = resugar_term term1 in
                                       (pat, uu____2290) in
                                     let uu____2291 =
                                       universe_to_string univs1 in
                                     (uu____2287, uu____2291))))) in
    ...
    | FStar_Syntax_Syntax.Tm_meta (e,m) ->
        let resugar_meta_desugared uu___203_2359 =
          match uu___203_2359 with
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____2523 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____2554 -> failwith "mutable_rval should have app term") in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
               FStar_All.pipe_right (FStar_List.flatten pats)
                 (FStar_List.map
                    (fun uu____2576  ->
                       ...
                       | (x,uu____2580) -> resugar_term x)) in
    ...
    | FStar_Syntax_Syntax.Comp c1 ->
        ...
        then
          ...
          let args =
            ...
            then
              let rec aux l uu___204_2756 =
                match uu___204_2756 with
                | [] -> l
                | (t,aq)::tl1 ->
            ...
            FStar_List.map
              (fun uu____2823  ->
                 ...
                 | (e,uu____2829) ->
                     ...
                     (uu____2830, FStar_Parser_AST.Nothing)) args in
          let rec aux l uu___205_2844 =
            match uu___205_2844 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
    ...
    fun r  ->
      ...
      | uu____2894 ->
          ...
          then
            ...
            (let uu____2897 =
               let uu____2898 =
                 let uu____2901 = bv_as_unique_ident x in (uu____2901, e) in
    ...
    let rec aux p1 =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let args1 =
            let uu____3065 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____3075  ->
                      match uu____3075 with | (p2,b) -> aux p2)) in
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____3131 = map21 tl1 tl2 in (hd1, hd2) :: uu____3131 in
          let args2 =
      ...
      | FStar_Syntax_Syntax.Pat_dot_term (bv,term) ->
          let pat =
            let uu____3198 =
              let uu____3199 =
                let uu____3203 = bv_as_unique_ident bv in (uu____3203, None) in
