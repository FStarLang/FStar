...
let string_to_op :
  ...
  =
  fun s  ->
    let name_of_op uu___106_338 =
      match uu___106_338 with
...
let rec resugar_term : FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
        ...
        (match uu____1142 with
         | (xs1,body1) ->
             ...
             let rec aux body3 uu___107_1175 =
               match uu___107_1175 with
               | [] -> body3
               | hd1::tl1 ->
    ...
    | FStar_Syntax_Syntax.Tm_app (e,args) ->
        let rec last1 uu___108_1257 =
          match uu___108_1257 with
          | hd1::[] -> [hd1]
          | hd1::tl1 -> last1 tl1
          | uu____1327 -> failwith "last of an empty list"  in
        let rec last_two uu___109_1363 =
          match uu___109_1363 with
          | [] ->
              failwith
        ...
        let rec last_three uu___110_1512 =
          match uu___110_1512 with
          | [] ->
              failwith
                               ...
                               let uu____1947 =
                                 let uu____1954 =
                                   let uu____1957 =
                                     ...
                                     [uu____1960]  in
                                   e1 :: uu____1957  in
                                 ((FStar_Ident.id_of_text "*"), uu____1954)
                                  in
             ...
             (match uu____2026 with
              | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____2032) ->
                  ...
                  (match uu____2053 with
                   | (xs1,body2) ->
                       let xs2 =
                         let uu____2061 = FStar_Options.print_implicits ()
                            in
              ...
              | (body,handler) ->
                  let decomp term =
                    ...
                    | FStar_Syntax_Syntax.Tm_abs (x,e1,uu____2258) ->
                        let uu____2279 = FStar_Syntax_Subst.open_term x e1
                           in
                    ...
                    | uu____2286 ->
                     ...
                     in
                  let body1 =
                    let uu____2288 = decomp body  in resugar_term uu____2288
                     in
                  let handler1 =
             ...
             let resugar body =
               ...
               | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____2557) ->
                   ...
                   (match uu____2578 with
                    | (xs1,body2) ->
                        let xs2 =
                          let uu____2586 = FStar_Options.print_implicits ()
                             in
         ...
         | FStar_Pervasives_Native.Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____2927  ->
                       match uu____2927 with | (e1,qual) -> resugar_term e1))
                in
             (match arity with
              ...
              | _0_43 when
                  ...
                  let uu____3020 =
                    let uu____3021 =
                      let uu____3028 =
                        let uu____3031 = last_two args1  in
                        resugar uu____3031  in
                      (op1, uu____3028)  in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____3399) ->
        ...
        let uu____3466 =
          let uu____3467 =
            let uu____3476 = resugar_term e  in (uu____3476, term, tac_opt1)
             in
             ...
             let resugar_one_binding bnd =
               let uu____3525 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd.FStar_Syntax_Syntax.lbunivs uu____3530
                  in
               ...
               | (univs1,td) ->
                   ...
                   (match uu____3541 with
                    | (typ,def) ->
                        let uu____3636 =
                          let uu____3643 =
                            let uu____3644 = FStar_Syntax_Subst.compress def
                               in
                              ...
                              (match uu____3676 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____3690 then b1 else filter_imp b1
                                      in
                                   (b2, t2, true))
                             ...
                             (match uu____3716 with
                              | (pat,term1) ->
                                  ...
                                  then
                                    ...
                                    (let uu____3824 =
                                       let uu____3829 = resugar_term term1
                                          in
                                       (pat, uu____3829)  in
                                     let uu____3830 =
                                       universe_to_string univs1  in
                                     (uu____3824, uu____3830)))))
                in
    ...
    | FStar_Syntax_Syntax.Tm_meta (e,m) ->
        let resugar_meta_desugared uu___112_3976 =
          match uu___112_3976 with
                   ...
                   let universes1 =
                     FStar_List.map
                       (fun u  ->
                          ...
                          (uu____4358, FStar_Parser_AST.UnivApp)) universes
                      in
                   let args1 =
                   ...
                   let args2 =
                     let uu____4432 =
                       (FStar_Parser_Const.is_tuple_data_lid' head1) ||
                         (let uu____4434 = FStar_Options.print_universes ()
                             in
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____4519 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____4556 -> failwith "mutable_rval should have app term")
           in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
            ...
            FStar_List.map
              (fun uu____5113  ->
                 ...
                 | (e,uu____5123) ->
                     ...
                     (uu____5124, FStar_Parser_AST.Nothing)) args
             in
          let rec aux l uu___113_5145 =
            match uu___113_5145 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____5622 = map21 tl1 tl2  in (hd1, hd2) :: uu____5622
             in
          let args2 =
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____5875 -> failwith "unexpected"))
             in
                 ...
                 then
                   let resugar_datacon_as_fields fields se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_datacon
                         ...
                         ->
                         let uu____5977 =
                           let uu____5978 = FStar_Syntax_Subst.compress term
                              in
                ...
                let uu____6391 =
                  let uu____6398 =
                    let uu____6399 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____6412)
                       in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____6593 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____6598 =
                       ...
                       let uu____7111 =
                         let uu____7112 =
                           ...
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____7125)
                            in
          ...
          (let t' =
             let uu____7172 =
               (let uu____7175 = FStar_Options.print_universes ()  in
                Prims.op_Negation uu____7175) || (FStar_List.isEmpty uvs)
                in
             if uu____7172
             then resugar_term t
             else
