         ...
         | FStar_Pervasives_Native.Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                ...
                in
             (match arity with
              | _0_31 when _0_31 = (Prims.parse_int "0") ->
                  let uu____2955 =
                    FStar_Parser_ToDocument.handleable_args_length op1  in
                  (match uu____2955 with
                   | _0_32 when
                       (_0_32 = (Prims.parse_int "1")) &&
                         ((FStar_List.length args1) > (Prims.parse_int "0"))
                       ->
                       let uu____2962 =
                         let uu____2963 =
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____5535 = map21 tl1 tl2  in (hd1, hd2) :: uu____5535
             in
          let args2 =
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____5792 -> failwith "unexpected"))
             in
                ...
                let uu____6315 =
                  let uu____6322 =
                    let uu____6323 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____6336)
                       in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____6522 then eff_binders else filter_imp eff_binders
                 in
              let eff_binders2 =
                let uu____6527 =
                       ...
                       let uu____7041 =
                         let uu____7042 =
                           ...
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____7055)
                            in
          ...
          (let t' =
             let uu____7102 =
               (let uu____7105 = FStar_Options.print_universes ()  in
                Prims.op_Negation uu____7105) || (FStar_List.isEmpty uvs)
                in
             if uu____7102
             then resugar_term t
             else
