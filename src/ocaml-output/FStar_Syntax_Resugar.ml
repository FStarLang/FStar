...
let name_of_op = (fun uu___183_378 -> (match (uu___183_378) with
| "Amp" -> begin
...
let rec aux = (fun body3 uu___184_1214 -> (match (uu___184_1214) with
| [] -> begin
body3
end
| (hd1)::tl1 -> begin
...
let rec last1 = (fun uu___185_1296 -> (match (uu___185_1296) with
| (hd1)::[] -> begin
(hd1)::[]
end
| (hd1)::tl1 -> begin
...
let rec last_two = (fun uu___186_1402 -> (match (uu___186_1402) with
| [] -> begin
...
let rec last_three = (fun uu___187_1551 -> (match (uu___187_1551) with
| [] -> begin
...
| uu____3917 -> begin
(fun uu___188_3918 -> (match (uu___188_3918) with
...
let resugar_meta_desugared = (fun uu___189_3997 -> (match (uu___189_3997) with
...
let rec aux = (fun l uu___190_4923 -> (match (uu___190_4923) with
| [] -> begin
l
end
| ((t, aq))::tl1 -> begin
...
let rec aux = (fun l uu___191_5058 -> (match (uu___191_5058) with
| [] -> begin
l
end
| (hd1)::tl1 -> begin
...
let resugar_qualifier : FStar_Syntax_Syntax.qualifier  ->  FStar_Parser_AST.qualifier FStar_Pervasives_Native.option = (fun uu___192_5678 -> (match (uu___192_5678) with
...
let resugar_pragma : FStar_Syntax_Syntax.pragma  ->  FStar_Parser_AST.pragma = (fun uu___193_5716 -> (match (uu___193_5716) with
...
let uu____5821 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___194_5826 -> (match (uu___194_5826) with
...
let uu____6835 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___195_6841 -> (match (uu___195_6841) with
...
let uu____7087 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___196_7093 -> (match (uu___196_7093) with
