  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
          ...
          (match uu____2319 with
           | (xs1,body1) ->
               ...
               let rec aux body3 uu___58_2365 =
                 match uu___58_2365 with
                 | [] -> body3
                 | hd1::tl1 ->
                     let body4 =
      ...
      | FStar_Syntax_Syntax.Tm_app (e,args) ->
          let rec last1 uu___59_2520 =
            match uu___59_2520 with
            | hd1::[] -> [hd1]
            | hd1::tl1 -> last1 tl1
            | uu____2590 -> failwith "last of an empty list"  in
          let rec last_two uu___60_2629 =
            match uu___60_2629 with
            | [] ->
                failwith
      ...
      | FStar_Syntax_Syntax.Tm_meta (e,m) ->
          let resugar_meta_desugared uu___61_5737 =
            match uu___61_5737 with
          ...
          then
            ...
            let args1 =
              FStar_List.map
               ...
               in
            let rec aux l uu___62_6360 =
              match uu___62_6360 with
              | [] -> l
              | hd1::tl1 ->
                  (match hd1 with
