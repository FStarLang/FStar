...
let rec resugar_term: FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
             ...
             let resugar body =
               ...
               | FStar_Syntax_Syntax.Tm_abs (xs,body1,uu____2604) ->
                   ...
                   (match uu____2625 with
                    | (xs1,body2) ->
                        let xs2 =
                          let uu____2633 = FStar_Options.print_implicits () in
         ...
         | FStar_Pervasives_Native.Some (op,arity) ->
             ...
             let resugar args2 =
               FStar_All.pipe_right args2
                 (FStar_List.map
                    (fun uu____3011  ->
                       match uu____3011 with | (e1,qual) -> resugar_term e1)) in
             (match arity with
              ...
              | _0_43 when
                  ...
                  let uu____3104 =
                    let uu____3105 =
                      let uu____3112 =
                        let uu____3115 = last_two args1 in resugar uu____3115 in
                      (op1, uu____3112) in
          ...
          | (pat,wopt,b) ->
              ...
              let wopt1 =
                ...
                | FStar_Pervasives_Native.Some e1 ->
                    ...
                    FStar_Pervasives_Native.Some uu____3428 in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (e,(asc,tac_opt),uu____3489) ->
        ...
        let uu____3556 =
          let uu____3557 =
            let uu____3566 = resugar_term e in (uu____3566, term, tac_opt1) in
             ...
             let resugar_one_binding bnd =
               let uu____3615 =
                 ...
                 FStar_Syntax_Subst.open_univ_vars
                   bnd.FStar_Syntax_Syntax.lbunivs uu____3620 in
               ...
               | (univs1,td) ->
                   ...
                   (match uu____3631 with
                    | (typ,def) ->
                        let uu____3726 =
                          let uu____3733 =
                            let uu____3734 = FStar_Syntax_Subst.compress def in
                              ...
                              (match uu____3766 with
                               | (b1,t2) ->
                                   let b2 =
                                     ...
                                     if uu____3780 then b1 else filter_imp b1 in
                                   (b2, t2, true))
                                                    ...
                                                    (fun q1  ->
                                                       let uu____3889 =
                                                         ...
                                                         FStar_Parser_AST.PatVar
                                                           uu____3890 in
                                                       mk_pat uu____3889))) in
                                    let uu____3900 =
                                      let uu____3905 = resugar_term term1 in
                                      ((mk_pat
                                          (FStar_Parser_AST.PatApp
                                             (pat, args))), uu____3905) in
                                    let uu____3908 =
                                      universe_to_string univs1 in
                                    (uu____3900, uu____3908)
                                  else
                                    (let uu____3914 =
                                       let uu____3919 = resugar_term term1 in
                                       (pat, uu____3919) in
                                     let uu____3920 =
                                       universe_to_string univs1 in
                                     (uu____3914, uu____3920))))) in
             ...
             let attrs =
               ...
               | { FStar_Syntax_Syntax.lbname = uu____4030;
                   ...
                   (match attrs with
                    | [] -> FStar_Pervasives_Native.None
                    | uu____4058 ->
                        let uu____4063 = FStar_List.map resugar_term attrs in
                        FStar_Pervasives_Native.Some uu____4063) in
             mk1
               (FStar_Parser_AST.Let
                  (attrs,
                    (if is_rec
                    ...
                    let uu____4446 =
                      let uu____4451 =
                        ...
                        FStar_Util.format1 "wrong Data_app head format %s"
                          uu____4452 in
                      (FStar_Errors.Fatal_WrongDataAppHeadFormat, uu____4451) in
                   ...
                   let universes1 =
                     FStar_List.map
                       (fun u  ->
                          ...
                          (uu____4507, FStar_Parser_AST.UnivApp)) universes in
                   let args1 =
                   ...
                   let args2 =
                     let uu____4581 =
                       (FStar_Parser_Const.is_tuple_data_lid' head1) ||
                         (let uu____4583 = FStar_Options.print_universes () in
          ...
          | FStar_Syntax_Syntax.Mutable_rval  ->
              ...
              (match uu____4690 with
               | FStar_Syntax_Syntax.Tm_app
                   ...
                   -> resugar_term term
               | uu____4727 -> failwith "mutable_rval should have app term") in
        (match m with
         | FStar_Syntax_Syntax.Meta_pattern pats ->
             let pats1 =
               FStar_All.pipe_right (FStar_List.flatten pats)
                 (FStar_List.map
                    (fun uu____4765  ->
                       ...
                       | (x,uu____4771) -> resugar_term x)) in
            ...
            FStar_List.map
              (fun uu____5284  ->
                 ...
                 | (e,uu____5294) ->
                     ...
                     (uu____5295, FStar_Parser_AST.Nothing)) args in
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____5793 = map21 tl1 tl2 in (hd1, hd2) :: uu____5793 in
          let args2 =
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____6046 -> failwith "unexpected")) in
                 ...
                 then
                   let resugar_datacon_as_fields fields se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_datacon
                         ...
                         ->
                         let uu____6148 =
                           let uu____6149 = FStar_Syntax_Subst.compress term in
                ...
                let uu____6562 =
                  let uu____6569 =
                    let uu____6570 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____6583) in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____6764 then eff_binders else filter_imp eff_binders in
              let eff_binders2 =
                let uu____6769 =
                       ...
                       let uu____7291 =
                         let uu____7292 =
                           ...
                           ((lid.FStar_Ident.ident), bs3,
                             FStar_Pervasives_Native.None, uu____7305) in
          ...
          (let t' =
             let uu____7352 =
               (let uu____7355 = FStar_Options.print_universes () in
                Prims.op_Negation uu____7355) || (FStar_List.isEmpty uvs) in
             if uu____7352
             then resugar_term t
             else
