...
let string_to_op:
  ...
  =
  fun s  ->
    let name_of_op uu___188_378 =
      match uu___188_378 with
...
let rec resugar_term: FStar_Syntax_Syntax.term -> FStar_Parser_AST.term =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (xs,body) ->
        ...
        (match uu____1181 with
         | (xs1,body1) ->
             ...
             let rec aux body3 uu___189_1214 =
               match uu___189_1214 with
               | [] -> body3
               | hd1::tl1 ->
    ...
    | FStar_Syntax_Syntax.Tm_app (e,args) ->
        let rec last1 uu___190_1296 =
          match uu___190_1296 with
          | hd1::[] -> [hd1]
          | hd1::tl1 -> last1 tl1
          | uu____1366 -> failwith "last of an empty list" in
        let rec last_two uu___191_1402 =
          match uu___191_1402 with
          | [] ->
              failwith
        ...
        let rec last_three uu___192_1551 =
          match uu___192_1551 with
          | [] ->
              failwith
    ...
    | FStar_Syntax_Syntax.Tm_meta (e,m) ->
        let resugar_meta_desugared uu___194_3997 =
          match uu___194_3997 with
  ...
  fun c  ->
    ...
    | FStar_Syntax_Syntax.Comp c1 ->
        ...
        then
          ...
          let rec aux l uu___195_5123 =
            match uu___195_5123 with
            | [] -> l
            | hd1::tl1 ->
                (match hd1 with
    ...
    let rec aux p1 imp_opt =
      ...
      | FStar_Syntax_Syntax.Pat_cons
          ...
          let rec map21 l1 l2 =
            ...
            | (hd1::tl1,hd2::tl2) ->
                let uu____5600 = map21 tl1 tl2 in (hd1, hd2) :: uu____5600 in
          let args2 =
            ...
            FStar_All.pipe_right datacon_ses
              (FStar_List.partition
                 (fun se1  ->
                    ...
                    | uu____5857 -> failwith "unexpected")) in
                 ...
                 then
                   let resugar_datacon_as_fields fields se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_datacon
                         ...
                         ->
                         let uu____5959 =
                           let uu____5960 = FStar_Syntax_Subst.compress term in
                ...
                let uu____6380 =
                  let uu____6387 =
                    let uu____6388 =
                      ...
                      (name1, [], FStar_Pervasives_Native.None, uu____6401) in
        ...
        fun ed  ->
          ...
          | (eff_binders,eff_typ) ->
              let eff_binders1 =
                ...
                if uu____6587 then eff_binders else filter_imp eff_binders in
              let eff_binders2 =
                let uu____6592 =
