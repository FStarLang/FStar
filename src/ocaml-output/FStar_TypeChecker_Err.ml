               ...
               (fun uu____302 ->
                  ...
                  | (e, msg, r) ->
                      let uu____322 =
                        ...
                        then
                          let uu____338 = FStar_TypeChecker_Env.get_range env in
                          (e, msg, uu____338)
                        else
                          (let r' =
...
let (unexpected_signature_for_monad :
  ...
  fun env ->
    fun m ->
      fun k ->
        let uu____634 =
          let uu____636 = FStar_TypeChecker_Normalize.term_to_string env k in
          FStar_Util.format2
            "Unexpected signature for monad \"%s\". Expected a signature of the form (a:Type => WP a => Effect); got %s"
            m.FStar_Ident.str uu____636 in
...
let (incompatible_kinds :
  ...
  fun env ->
    fun k1 ->
      fun k2 ->
        let uu____870 =
          let uu____872 = FStar_TypeChecker_Normalize.term_to_string env k1 in
          let uu____874 = FStar_TypeChecker_Normalize.term_to_string env k2 in
          FStar_Util.format2 "Kinds \"%s\" and \"%s\" are incompatible"
            uu____872 uu____874 in
      ...
      fun t ->
        fun t' ->
          let uu____904 =
            ...
            let uu____908 = FStar_TypeChecker_Normalize.term_to_string env t in
            let uu____910 = FStar_TypeChecker_Normalize.term_to_string env t' in
            FStar_Util.format3
              "Constructor \"%s\" builds a value of type \"%s\"; expected \"%s\""
              uu____906 uu____908 uu____910 in
...
let (inferred_type_causes_variable_to_escape :
  ...
  fun env ->
    fun t ->
      fun x ->
        let uu____990 =
          let uu____992 = FStar_TypeChecker_Normalize.term_to_string env t in
          let uu____994 = FStar_Syntax_Print.bv_to_string x in
          FStar_Util.format2
            "Inferred type \"%s\" causes variable \"%s\" to escape its scope"
            uu____992 uu____994 in
  ...
  fun env ->
    fun t ->
      let uu____1014 =
        ...
        FStar_Util.format1
          "Expected a function; got an expression of type \"%s\"" uu____1016 in
      ...
      fun t ->
        fun targ ->
          let uu____1046 =
            ...
            let uu____1050 = FStar_TypeChecker_Normalize.term_to_string env t in
            let uu____1052 =
            ...
            FStar_Util.format3
              ...
              uu____1048 uu____1050 uu____1052 in
  ...
  fun env ->
    fun f ->
      let uu____1356 =
        ...
        FStar_Util.format1
          "Term has an unexpected non-trivial pre-condition: %s" uu____1358 in
  ...
  fun l ->
    fun lbls ->
      let uu____1502 =
        ...
        let uu____1506 = FStar_All.pipe_right lbls (FStar_String.concat ", ") in
        FStar_Util.format2
          "Failed to prove specification of %s; assertions at [%s] may fail"
          uu____1504 uu____1506 in
