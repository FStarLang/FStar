                      ...
                      (let r' =
                       ...
                       then
                         let _0_553 =
                           let _0_551 =
                             let _0_550 =
                               let _0_549 = FStar_Range.string_of_use_range r
                                  in
    ...
    fun f  ->
      fun t  ->
        fun targ  ->
          ...
          let _0_584 = FStar_TypeChecker_Normalize.term_to_string env targ
             in
          FStar_Util.format3
...
let expected_pure_expression e c =
  ...
  let _0_595 =
    let _0_594 = name_and_result c  in FStar_All.pipe_left Prims.fst _0_594
     in
  FStar_Util.format2
...
let expected_ghost_expression e c =
  ...
  let _0_598 =
    let _0_597 = name_and_result c  in FStar_All.pipe_left Prims.fst _0_597
     in
  FStar_Util.format2
