...
let expected_a_term_of_type_t_got_a_function :
  ...
  fun env  ->
    fun msg  ->
      fun t  ->
        fun e  ->
          let uu____223 = FStar_TypeChecker_Normalize.term_to_string env t
             in
    ...
    fun d  ->
      fun t  ->
        fun t'  ->
          ...
          let uu____346 = FStar_TypeChecker_Normalize.term_to_string env t
             in
          let uu____347 = FStar_TypeChecker_Normalize.term_to_string env t'
             in
          FStar_Util.format3
    ...
    fun f  ->
      fun t  ->
        fun targ  ->
          ...
          let uu____416 = FStar_TypeChecker_Normalize.term_to_string env t
             in
          let uu____417 = FStar_TypeChecker_Normalize.term_to_string env targ
             in
          FStar_Util.format3
...
let failed_to_prove_specification_of :
  ...
  fun l  ->
    fun lbls  ->
      ...
      let uu____651 = FStar_All.pipe_right lbls (FStar_String.concat ", ")
         in
      FStar_Util.format2
