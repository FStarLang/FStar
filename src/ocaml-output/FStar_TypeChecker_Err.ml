        ...
        fun t'  ->
          let uu____501 =
            ...
            FStar_Util.format3
              ...
              uu____502 uu____503 uu____504 in
  ...
  fun env  ->
    fun t  ->
      let uu____564 =
        ...
        FStar_Util.format1
          "Expected a function; got an expression of type \"%s\"" uu____565 in
        ...
        fun targ  ->
          let uu____582 =
            ...
            FStar_Util.format3
              ...
              uu____583 uu____584 uu____585 in
  ...
  fun env  ->
    fun f  ->
      let uu____770 =
        ...
        FStar_Util.format1
          "Term has an unexpected non-trivial pre-condition: %s" uu____771 in
