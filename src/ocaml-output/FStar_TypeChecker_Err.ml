...
let unexpected_signature_for_monad :
  ...
  fun env  ->
    fun m  ->
      fun k  ->
        let uu____353 =
          let uu____354 = FStar_TypeChecker_Normalize.term_to_string env k
             in
          FStar_Util.format2
            "Unexpected signature for monad \"%s\". Expected a signature of the form (a:Type => WP a => Effect); got %s"
            m.FStar_Ident.str uu____354
           in
...
let incompatible_kinds :
  ...
  fun env  ->
    fun k1  ->
      fun k2  ->
        let uu____511 =
          let uu____512 = FStar_TypeChecker_Normalize.term_to_string env k1
             in
          let uu____513 = FStar_TypeChecker_Normalize.term_to_string env k2
             in
      ...
      fun t  ->
        fun t'  ->
          let uu____530 =
            ...
            let uu____532 = FStar_TypeChecker_Normalize.term_to_string env t
               in
            let uu____533 = FStar_TypeChecker_Normalize.term_to_string env t'
               in
            FStar_Util.format3
              "Constructor \"%s\" builds a value of type \"%s\"; expected \"%s\""
              uu____531 uu____532 uu____533
             in
...
let inferred_type_causes_variable_to_escape :
  ...
  fun env  ->
    fun t  ->
      fun x  ->
        let uu____580 =
          let uu____581 = FStar_TypeChecker_Normalize.term_to_string env t
             in
  ...
  fun env  ->
    fun t  ->
      let uu____593 =
        ...
        FStar_Util.format1
          "Expected a function; got an expression of type \"%s\"" uu____594
         in
      ...
      fun t  ->
        fun targ  ->
          let uu____611 =
            ...
            let uu____613 = FStar_TypeChecker_Normalize.term_to_string env t
               in
            let uu____614 =
  ...
  fun env  ->
    fun f  ->
      let uu____799 =
        ...
        FStar_Util.format1
          "Term has an unexpected non-trivial pre-condition: %s" uu____800
         in
  ...
  fun l  ->
    fun lbls  ->
      let uu____892 =
        ...
        let uu____894 = FStar_All.pipe_right lbls (FStar_String.concat ", ")
           in
        FStar_Util.format2
