  ...
  fun env  ->
    fun t  ->
      let uu____912 =
        ...
        FStar_Util.format1
          "Expected a function; got an expression of type \"%s\"" uu____914
         in
  ...
  fun env  ->
    fun f  ->
      let uu____1254 =
        ...
        FStar_Util.format1
          "Term has an unexpected non-trivial pre-condition: %s" uu____1256
         in
