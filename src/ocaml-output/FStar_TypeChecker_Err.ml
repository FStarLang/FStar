          ...
          | () ->
              (set cur;
               (let uu___1 = print ()  in
                match uu___1 with
                | (xs,ys,true ) -> (xs, ys)
                | uu___2 -> let uu___3 = succ cur  in go uu___3))
           in
               ...
               (fun uu___  ->
                  ...
                  | (e,msg,r) ->
                      let uu___1 =
                        ...
                        then
                          let uu___2 = FStar_TypeChecker_Env.get_range env
                             in
                          (e, msg, uu___2)
                        else
                          (let r' =
                           ...
                           then
                             ...
                             let uu___5 = FStar_TypeChecker_Env.get_range env
                                in
                             (e, uu___4, uu___5)
                           else (e, msg, r))
                         in
  ...
  fun env  ->
    fun t  ->
      let uu___ =
        let uu___1 = FStar_TypeChecker_Normalize.term_to_string env t  in
        FStar_Util.format1
          "Expected a function; got an expression of type \"%s\"" uu___1
         in
      ...
      fun t  ->
        fun targ  ->
          let uu___ =
            ...
            let uu___3 = FStar_TypeChecker_Normalize.term_to_string env targ
               in
            FStar_Util.format3
  ...
  fun env  ->
    fun f  ->
      let uu___ =
        ...
        FStar_Util.format1
          "Term has an unexpected non-trivial pre-condition: %s" uu___1
         in
    ...
    fun c  ->
      fun reason  ->
        ...
        let uu___ =
          ...
          FStar_Util.format2
            (Prims.op_Hat msg1
               "; got an expression \"%s\" with effect \"%s\"") uu___1 uu___2
           in
...
let (cardinality_constraint_violated :
  ...
  fun l  ->
    fun a  ->
      let uu___ =
        let uu___1 = FStar_Syntax_Print.lid_to_string l  in
        let uu___2 = FStar_Syntax_Print.bv_to_string a.FStar_Syntax_Syntax.v
           in
        FStar_Util.format2
