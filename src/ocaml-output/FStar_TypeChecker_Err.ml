...
let expected_a_term_of_type_t_got_a_function :
  ...
  fun env  ->
    fun msg  ->
      fun t  ->
        fun e  ->
          let uu____338 = FStar_TypeChecker_Normalize.term_to_string env t
             in
    ...
    fun d  ->
      fun t  ->
        fun t'  ->
          ...
          let uu____449 = FStar_TypeChecker_Normalize.term_to_string env t
             in
          let uu____450 = FStar_TypeChecker_Normalize.term_to_string env t'
             in
          FStar_Util.format3
      ...
      fun t  ->
        fun targ  ->
          ...
          let uu____505 = FStar_TypeChecker_Normalize.term_to_string env t
             in
          let uu____506 = FStar_TypeChecker_Normalize.term_to_string env targ
             in
          FStar_Util.format3
...
let failed_to_prove_specification_of :
  ...
  fun l  ->
    fun lbls  ->
      ...
      let uu____734 = FStar_All.pipe_right lbls (FStar_String.concat ", ")
         in
      FStar_Util.format2
...
let cardinality_constraint_violated :
  ...
  fun l  ->
    fun a  ->
      ...
      let uu____761 = FStar_Syntax_Print.bv_to_string a.FStar_Syntax_Syntax.v
         in
      FStar_Util.format2
