...
let computed_computation_type_does_not_match_annotation env e c c' =
  ...
  | (f1,r1) ->
      ...
      (match uu____410 with
       | (f2,r2) ->
           let uu____421 = FStar_TypeChecker_Normalize.term_to_string env r1
              in
           let uu____422 = FStar_TypeChecker_Normalize.term_to_string env r2
              in
           FStar_Util.format4
...
let failed_to_prove_specification_of :
  ...
  fun l  ->
    fun lbls  ->
      ...
      let uu____505 = FStar_All.pipe_right lbls (FStar_String.concat ", ")
         in
      FStar_Util.format2
