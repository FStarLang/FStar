               ...
               (fun uu____320 ->
                  ...
                  | (e, msg, r) ->
                      let uu____340 =
                        ...
                        then
                          let uu____356 = FStar_TypeChecker_Env.get_range env in
                          (e, msg, uu____356)
                        else
                          (let r' =
...
let (unexpected_signature_for_monad :
  ...
  fun env ->
    fun m ->
      fun k ->
        let uu____708 =
          let uu____710 = FStar_TypeChecker_Normalize.term_to_string env k in
          FStar_Util.format2
            "Unexpected signature for monad \"%s\". Expected a signature of the form (a:Type => WP a => Effect); got %s"
            m.FStar_Ident.str uu____710 in
...
let (incompatible_kinds :
  ...
  fun env ->
    fun k1 ->
      fun k2 ->
        let uu____944 =
          let uu____946 = FStar_TypeChecker_Normalize.term_to_string env k1 in
          let uu____948 = FStar_TypeChecker_Normalize.term_to_string env k2 in
      ...
      fun t ->
        fun t' ->
          let uu____978 =
            ...
            let uu____982 = FStar_TypeChecker_Normalize.term_to_string env t in
            let uu____984 = FStar_TypeChecker_Normalize.term_to_string env t' in
            FStar_Util.format3
              "Constructor \"%s\" builds a value of type \"%s\"; expected \"%s\""
              uu____980 uu____982 uu____984 in
...
let (inferred_type_causes_variable_to_escape :
  ...
  fun env ->
    fun t ->
      fun x ->
        let uu____1064 =
          let uu____1066 = FStar_TypeChecker_Normalize.term_to_string env t in
          let uu____1068 = FStar_Syntax_Print.bv_to_string x in
          FStar_Util.format2
            "Inferred type \"%s\" causes variable \"%s\" to escape its scope"
            uu____1066 uu____1068 in
  ...
  fun env ->
    fun t ->
      let uu____1088 =
        ...
        FStar_Util.format1
          "Expected a function; got an expression of type \"%s\"" uu____1090 in
      ...
      fun t ->
        fun targ ->
          let uu____1120 =
            ...
            let uu____1124 = FStar_TypeChecker_Normalize.term_to_string env t in
            let uu____1126 =
            ...
            FStar_Util.format3
              ...
              uu____1122 uu____1124 uu____1126 in
  ...
  fun env ->
    fun f ->
      let uu____1430 =
        ...
        FStar_Util.format1
          "Term has an unexpected non-trivial pre-condition: %s" uu____1432 in
  ...
  fun l ->
    fun lbls ->
      let uu____1576 =
        ...
        let uu____1580 = FStar_All.pipe_right lbls (FStar_String.concat ", ") in
        FStar_Util.format2
          "Failed to prove specification of %s; assertions at [%s] may fail"
          uu____1578 uu____1580 in
