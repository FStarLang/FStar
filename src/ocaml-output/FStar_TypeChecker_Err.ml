                    ...
                    then
                      ...
                      (let r' =
                       ...
                       then
                         ...
                         let uu____256 = FStar_TypeChecker_Env.get_range env
                            in
                         (uu____252, uu____256)
                       else (msg, r))))
         in
...
let expected_a_term_of_type_t_got_a_function :
  ...
  fun env  ->
    fun msg  ->
      fun t  ->
        fun e  ->
          let uu____336 = FStar_TypeChecker_Normalize.term_to_string env t
             in
    ...
    fun d  ->
      fun t  ->
        fun t'  ->
          ...
          let uu____447 = FStar_TypeChecker_Normalize.term_to_string env t
             in
          let uu____448 = FStar_TypeChecker_Normalize.term_to_string env t'
             in
          FStar_Util.format3
      ...
      fun t  ->
        fun targ  ->
          ...
          let uu____503 = FStar_TypeChecker_Normalize.term_to_string env t
             in
          let uu____504 = FStar_TypeChecker_Normalize.term_to_string env targ
             in
          FStar_Util.format3
...
let failed_to_prove_specification_of :
  ...
  fun l  ->
    fun lbls  ->
      ...
      let uu____732 = FStar_All.pipe_right lbls (FStar_String.concat ", ")
         in
      FStar_Util.format2
...
let cardinality_constraint_violated :
  ...
  fun l  ->
    fun a  ->
      ...
      let uu____759 = FStar_Syntax_Print.bv_to_string a.FStar_Syntax_Syntax.v
         in
      FStar_Util.format2
