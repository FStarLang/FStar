             ...
             (fun uu____231  ->
                ...
                | (msg,r) ->
                    ...
                    then
                      ...
                      (let r' =
                         let uu___269_249 = r in
                         {
                           FStar_Range.def_range = (r.FStar_Range.use_range);
                           FStar_Range.use_range =
                             (uu___269_249.FStar_Range.use_range)
                         } in
                       let uu____250 =
...
let expected_a_term_of_type_t_got_a_function:
  ...
  fun env  ->
    fun msg  ->
      fun t  ->
        fun e  ->
          let uu____356 = FStar_TypeChecker_Normalize.term_to_string env t in
    ...
    fun d  ->
      fun t  ->
        fun t'  ->
          ...
          let uu____490 = FStar_TypeChecker_Normalize.term_to_string env t' in
          FStar_Util.format3
    ...
    fun f  ->
      fun t  ->
        fun targ  ->
          ...
          let uu____559 = FStar_TypeChecker_Normalize.term_to_string env t in
          let uu____560 = FStar_TypeChecker_Normalize.term_to_string env targ in
          FStar_Util.format3
...
let failed_to_prove_specification_of:
  ...
  fun l  ->
    fun lbls  ->
      ...
      let uu____807 = FStar_All.pipe_right lbls (FStar_String.concat ", ") in
      FStar_Util.format2
...
let cardinality_constraint_violated:
  ...
  fun l  ->
    fun a  ->
      ...
      let uu____837 = FStar_Syntax_Print.bv_to_string a.FStar_Syntax_Syntax.v in
      FStar_Util.format2
