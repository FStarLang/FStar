             ...
             (fun uu____124  ->
                ...
                | (msg,r) ->
                    ...
                    then
                      ...
                      (let r' =
                         let uu___236_136 = r in
                         {
                           FStar_Range.def_range = (r.FStar_Range.use_range);
                           FStar_Range.use_range =
                             (uu___236_136.FStar_Range.use_range)
                         } in
                       let uu____137 =
                       ...
                       then
                         ...
                         let uu____147 = FStar_TypeChecker_Env.get_range env in
                         (uu____143, uu____147)
                       else (msg, r)))) in
...
let expected_a_term_of_type_t_got_a_function:
  ...
  fun env  ->
    fun msg  ->
      fun t  ->
        fun e  ->
          let uu____231 = FStar_TypeChecker_Normalize.term_to_string env t in
    ...
    fun d  ->
      fun t  ->
        fun t'  ->
          ...
          let uu____354 = FStar_TypeChecker_Normalize.term_to_string env t in
          let uu____355 = FStar_TypeChecker_Normalize.term_to_string env t' in
          FStar_Util.format3
    ...
    fun f  ->
      fun t  ->
        fun targ  ->
          ...
          let uu____424 = FStar_TypeChecker_Normalize.term_to_string env t in
          let uu____425 = FStar_TypeChecker_Normalize.term_to_string env targ in
          FStar_Util.format3
...
let unexpected_non_trivial_precondition_on_term:
  ...
  fun env  ->
    fun f  ->
      let uu____545 = FStar_TypeChecker_Normalize.term_to_string env f in
      FStar_Util.format1
        "Term has an unexpected non-trivial pre-condition: %s" uu____545
let expected_pure_expression:
  ...
  fun e  ->
    fun c  ->
      let uu____556 = FStar_Syntax_Print.term_to_string e in
      let uu____557 =
        let uu____558 = name_and_result c in
        FStar_All.pipe_left FStar_Pervasives_Native.fst uu____558 in
      FStar_Util.format2
...
let expected_ghost_expression:
  ...
  fun e  ->
    fun c  ->
      let uu____576 = FStar_Syntax_Print.term_to_string e in
      let uu____577 =
        let uu____578 = name_and_result c in
        FStar_All.pipe_left FStar_Pervasives_Native.fst uu____578 in
      FStar_Util.format2
...
let expected_effect_1_got_effect_2:
  ...
  fun c1  ->
    fun c2  ->
      let uu____594 = FStar_Syntax_Print.lid_to_string c1 in
      let uu____595 = FStar_Syntax_Print.lid_to_string c2 in
      FStar_Util.format2
...
let failed_to_prove_specification_of:
  ...
  fun l  ->
    fun lbls  ->
      let uu____606 = FStar_Syntax_Print.lbname_to_string l in
      let uu____607 = FStar_All.pipe_right lbls (FStar_String.concat ", ") in
      FStar_Util.format2
...
let cardinality_constraint_violated:
  ...
  fun l  ->
    fun a  ->
      let uu____629 = FStar_Syntax_Print.lid_to_string l in
      let uu____630 = FStar_Syntax_Print.bv_to_string a.FStar_Syntax_Syntax.v in
      FStar_Util.format2
