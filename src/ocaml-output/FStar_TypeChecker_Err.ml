...
let info_at_pos
    : FStar_TypeChecker_Env.env -> Prims.string -> Prims.int -> Prims.int
      -> ( (Prims.string, FStar_Ident.lid) FStar_Util.either
         , FStar_Syntax_Syntax.typ
         , FStar_Range.range )
         FStar_Pervasives_Native.tuple3
         FStar_Pervasives_Native.option =
  fun env file row col ->
    let uu____25 =
      let uu____28 =
        FStar_ST.op_Bang env.FStar_TypeChecker_Env.identifier_info
      in
      FStar_TypeChecker_Common.id_info_at_pos uu____28 file row col
    in
    match uu____25 with
      ...
      | FStar_Util.Inl bv ->
          let uu____84 =
            let uu____95 =
              ...
              FStar_Util.Inl uu____100
            in
            let uu____101 = FStar_Syntax_Syntax.range_of_bv bv in
            (uu____95, info.FStar_TypeChecker_Common.identifier_ty, uu____101)
          in
      ...
      | FStar_Util.Inr fv ->
          let uu____117 =
            let uu____128 =
              ...
              FStar_Util.Inr uu____133
            in
            let uu____134 = FStar_Syntax_Syntax.range_of_fv fv in
            (uu____128, info.FStar_TypeChecker_Common.identifier_ty, uu____134)
          in
               ...
               if r = FStar_Range.dummyRange then
                 ...
                 if uu____239 then
                   let uu____249 =
                     let uu____250 =
                       let uu____251 =
                         let uu____252 = FStar_Range.string_of_use_range r in
                         Prims.strcat uu____252 ")"
                       in
                       Prims.strcat "(Also see: " uu____251
                     in
                     Prims.strcat msg uu____250
                   in
...
let err_msg_type_strings
  ...
  fun env t1 t2 ->
    ...
    if s1 = s2 then
      FStar_Options.with_saved_options (fun uu____286 ->
          (let uu____288 =
             FStar_Options.set_options FStar_Options.Set
               "--print_full_names --print_universes"
           in
           ()) ;
          let uu____289 = FStar_TypeChecker_Normalize.term_to_string env t1 in
          let uu____290 = FStar_TypeChecker_Normalize.term_to_string env t2 in
          (uu____289, uu____290) )
    else (s1, s2)
...
let expected_a_term_of_type_t_got_a_function
    : FStar_TypeChecker_Env.env -> Prims.string -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term
      -> (FStar_Errors.raw_error, Prims.string) FStar_Pervasives_Native.tuple2 =
  fun env msg t e ->
    let uu____342 =
      ...
      FStar_Util.format3
        "Expected a term of type \"%s\"; got a function \"%s\" (%s)" uu____343
        uu____344 msg
    in
...
let basic_type_error
  ...
  fun env eopt t1 t2 ->
    ...
    match uu____447 with s1, s2 ->
      let msg =
        match eopt with
        | FStar_Pervasives_Native.None ->
            FStar_Util.format2 "Expected type \"%s\"; got type \"%s\"" s1 s2
        | FStar_Pervasives_Native.Some e ->
            let uu____460 = FStar_TypeChecker_Normalize.term_to_string env e in
            FStar_Util.format3
              "Expected type \"%s\"; but \"%s\" has type \"%s\"" s1 uu____460
              s2
      in
...
let incompatible_kinds
  ...
  fun env k1 k2 ->
    let uu____482 =
      let uu____483 = FStar_TypeChecker_Normalize.term_to_string env k1 in
      let uu____484 = FStar_TypeChecker_Normalize.term_to_string env k2 in
      FStar_Util.format2 "Kinds \"%s\" and \"%s\" are incompatible" uu____483
        uu____484
    in
...
let constructor_builds_the_wrong_type
  ...
  fun env d t t' ->
    let uu____501 =
      ...
      let uu____504 = FStar_TypeChecker_Normalize.term_to_string env t' in
      FStar_Util.format3
...
let constructor_fails_the_positivity_check:
      'Auu____509. 'Auu____509 -> FStar_Syntax_Syntax.term -> FStar_Ident.lid
      -> (FStar_Errors.raw_error, Prims.string) FStar_Pervasives_Native.tuple2 =
  fun env d l ->
    let uu____526 =
...
let inferred_type_causes_variable_to_escape
  ...
  fun env t x ->
    let uu____551 =
      let uu____552 = FStar_TypeChecker_Normalize.term_to_string env t in
...
let expected_poly_typ
  ...
  fun env f t targ ->
    let uu____582 =
      ...
      let uu____584 = FStar_TypeChecker_Normalize.term_to_string env t in
      let uu____585 = FStar_TypeChecker_Normalize.term_to_string env targ in
      FStar_Util.format3
...
let disjunctive_pattern_vars
    : FStar_Syntax_Syntax.bv Prims.list -> FStar_Syntax_Syntax.bv Prims.list
      -> (FStar_Errors.raw_error, Prims.string) FStar_Pervasives_Native.tuple2 =
  fun v1 v2 ->
    let vars v3 =
      let uu____621 =
      ...
      in
      FStar_All.pipe_right uu____621 (FStar_String.concat ", ")
    in
    let uu____630 =
...
let computed_computation_type_does_not_match_annotation:
      'Auu____685. FStar_TypeChecker_Env.env -> 'Auu____685
      -> FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax
      -> FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax
      -> (FStar_Errors.raw_error, Prims.string) FStar_Pervasives_Native.tuple2 =
  fun env e c c' ->
    let uu____714 = name_and_result c in
    match uu____714 with f1, r1 ->
      let uu____731 = name_and_result c' in
      match uu____731 with f2, r2 ->
        let uu____748 = err_msg_type_strings env r1 r2 in
        match uu____748 with s1, s2 ->
          let uu____759 =
            FStar_Util.format4
              "Computed type \"%s\" and effect \"%s\" is not compatible with the annotated type \"%s\" effect \"%s\""
              s1 f1 s2 f2
          in
          (FStar_Errors.Fatal_ComputedTypeNotMatchAnnotation, uu____759)
...
let unexpected_non_trivial_precondition_on_term
  ...
  fun env f ->
    let uu____770 =
      ...
      FStar_Util.format1 "Term has an unexpected non-trivial pre-condition: %s"
        uu____771
    in
  ...
  fun e c ->
    let uu____786 =
      ...
      let uu____788 =
        ...
        FStar_All.pipe_left FStar_Pervasives_Native.fst uu____789
      in
      FStar_Util.format2
  ...
  fun e c ->
    let uu____818 =
      ...
      let uu____820 =
        ...
        FStar_All.pipe_left FStar_Pervasives_Native.fst uu____821
      in
      FStar_Util.format2
...
let expected_effect_1_got_effect_2
    : FStar_Ident.lident -> FStar_Ident.lident
      -> (FStar_Errors.raw_error, Prims.string) FStar_Pervasives_Native.tuple2 =
  fun c1 c2 ->
    let uu____846 =
      ...
      FStar_Util.format2
        "Expected a computation with effect %s; but it has effect %s" uu____847
        uu____848
    in
...
let failed_to_prove_specification_of
    : FStar_Syntax_Syntax.lbname -> Prims.string Prims.list
      -> (FStar_Errors.raw_error, Prims.string) FStar_Pervasives_Native.tuple2 =
  fun l lbls ->
    let uu____863 =
      let uu____864 = FStar_Syntax_Print.lbname_to_string l in
      let uu____865 = FStar_All.pipe_right lbls (FStar_String.concat ", ") in
      FStar_Util.format2
...
let cardinality_constraint_violated
    : FStar_Ident.lid -> FStar_Syntax_Syntax.bv FStar_Syntax_Syntax.withinfo_t
      -> (FStar_Errors.raw_error, Prims.string) FStar_Pervasives_Native.tuple2 =
  fun l a ->
    let uu____904 =
      let uu____905 = FStar_Syntax_Print.lid_to_string l in
      let uu____906 =
        FStar_Syntax_Print.bv_to_string a.FStar_Syntax_Syntax.v
      in
      FStar_Util.format2
