                      ...
                      (let r' =
                       ...
                       then
                         let _0_532 =
                           let _0_530 =
                             let _0_529 =
                               let _0_528 = FStar_Range.string_of_use_range r in
                               Prims.strcat _0_528 ")" in
                             Prims.strcat "(Also see: " _0_529 in
                           Prims.strcat msg _0_530 in
                         let _0_531 = FStar_TypeChecker_Env.get_range env in
                         (_0_532, _0_531)
                       else (msg, r)))) in
    ...
    fun f  ->
      fun t  ->
        fun targ  ->
          ...
          let _0_569 = FStar_TypeChecker_Normalize.term_to_string env targ in
          FStar_Util.format3
...
let expected_pure_expression e c =
  ...
  let _0_580 =
    let _0_579 = name_and_result c in FStar_All.pipe_left Prims.fst _0_579 in
  FStar_Util.format2
...
let expected_ghost_expression e c =
  ...
  let _0_583 =
    let _0_582 = name_and_result c in FStar_All.pipe_left Prims.fst _0_582 in
  FStar_Util.format2
