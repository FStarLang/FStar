...
let (disjunctive_pattern_vars :
  ...
  fun v1 ->
    fun v2 ->
      let vars v =
        let uu___ =
          FStar_Compiler_Effect.pipe_right v
            (FStar_Compiler_List.map FStar_Syntax_Print.bv_to_string) in
        FStar_Compiler_Effect.pipe_right uu___ (FStar_String.concat ", ") in
      let uu___ =
      ...
      fun reason ->
        ...
        let uu___ =
          ...
          let uu___2 =
            ...
            FStar_Compiler_Effect.pipe_left FStar_Pervasives_Native.fst
              uu___3 in
          FStar_Compiler_Util.format2
            (Prims.op_Hat msg1
  ...
  fun l ->
    fun lbls ->
      let uu___ =
        ...
        let uu___2 =
          FStar_Compiler_Effect.pipe_right lbls (FStar_String.concat ", ") in
        FStar_Compiler_Util.format2
...
let (failed_to_prove_specification :
  ...
  fun lbls ->
    let msg =
      ...
      | uu___ ->
          let uu___1 =
            FStar_Compiler_Effect.pipe_right lbls
              (FStar_String.concat "\n\t") in
          FStar_Compiler_Util.format1
