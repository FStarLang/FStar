                      ...
                      (let r' =
                       ...
                       then
                         let _0_539 =
                           let _0_537 =
                             let _0_536 =
                               let _0_535 = FStar_Range.string_of_use_range r
                                  in
        ...
        fun t2  ->
          ...
          | None  ->
              let _0_554 = FStar_TypeChecker_Normalize.term_to_string env t1
                 in
              let _0_553 = FStar_TypeChecker_Normalize.term_to_string env t2
                 in
              FStar_Util.format2 "Expected type \"%s\"; got type \"%s\""
                _0_554 _0_553
          | Some e ->
              let _0_557 = FStar_TypeChecker_Normalize.term_to_string env t1
                 in
              let _0_556 = FStar_Syntax_Print.term_to_string e  in
              let _0_555 = FStar_TypeChecker_Normalize.term_to_string env t2
                 in
              FStar_Util.format3
    ...
    fun f  ->
      fun t  ->
        fun targ  ->
          ...
          let _0_576 = FStar_TypeChecker_Normalize.term_to_string env targ
             in
          FStar_Util.format3
...
let expected_ghost_expression e c =
  ...
  let _0_590 =
    let _0_589 = name_and_result c  in FStar_All.pipe_left Prims.fst _0_589
     in
  FStar_Util.format2
