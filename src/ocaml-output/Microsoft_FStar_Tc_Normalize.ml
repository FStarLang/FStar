...
let is_Mkconfig = (fun ( _  :  'a config ) -> (failwith ("Not yet implemented")))

let is_Mkenvironment = (fun ( _  :  environment ) -> (failwith ("Not yet implemented")))

let is_Mkstack = (fun ( _  :  stack ) -> (failwith ("Not yet implemented")))
...
let extend_env' = (fun ( env  :  environment ) ( b  :  env_entry ) -> (let _30_29 = env
in {context = (b)::env.context; label_suffix = _30_29.label_suffix}))

let extend_env = (fun ( env  :  environment ) ( bindings  :  env_entry list ) -> (let _30_33 = env
in {context = (Support.List.append bindings env.context); label_suffix = _30_33.label_suffix}))

let lookup_env = (fun ( env  :  environment ) ( key  :  string ) -> (Support.Prims.pipe_right env.context (Support.Microsoft.FStar.Util.find_opt (fun ( _30_1  :  env_entry ) -> (match (_30_1) with
| T ((a, _)) -> begin
...
let fold_env = (fun ( env  :  environment ) ( f  :  string  ->  env_entry  ->  'u30u1676  ->  'u30u1676 ) ( acc  :  'u30u1676 ) -> (Support.List.fold_left (fun ( acc  :  'u30u1676 ) ( v  :  env_entry ) -> (match (v) with
| T ((a, _)) -> begin
...
let rec subst_of_env' = (fun ( env  :  environment ) -> (fold_env env (fun ( _30_64  :  string ) ( v  :  env_entry ) ( acc  :  ((Microsoft_FStar_Absyn_Syntax.btvdef * (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax), (Microsoft_FStar_Absyn_Syntax.bvvdef * (Microsoft_FStar_Absyn_Syntax.exp', (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax)) Support.Microsoft.FStar.Util.either list ) -> (match (v) with
| T ((a, (t, env'))) -> begin
...
let subst_of_env = (fun ( tcenv  :  'u30u1918 ) ( env  :  environment ) -> (subst_of_env' env))

let with_new_code = (fun ( c  :  'u30u1934 config ) ( e  :  'u30u1933 ) -> {code = e; environment = c.environment; stack = empty_stack; close = None; steps = c.steps})

let rec eta_expand = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( t  :  Microsoft_FStar_Absyn_Syntax.typ ) -> (let k = (let _52_8738 = (Microsoft_FStar_Tc_Recheck.recompute_kind t)
in (Support.Prims.pipe_right _52_8738 Microsoft_FStar_Absyn_Util.compress_kind))
in (let rec aux = (fun ( t  :  (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax ) ( k  :  (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax ) -> (match (k.Microsoft_FStar_Absyn_Syntax.n) with
...
let is_var = (fun ( t  :  (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax ) -> (match ((Microsoft_FStar_Absyn_Util.compress_typ t)) with
...
let rec eta_expand_exp = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( e  :  Microsoft_FStar_Absyn_Syntax.exp ) -> (let t = (let _52_8758 = (Microsoft_FStar_Tc_Recheck.recompute_typ e)
...
let no_eta = (Support.List.filter (fun ( _30_2  :  step ) -> (match (_30_2) with
| Eta -> begin
false
end
| _ -> begin
...
let no_eta_cfg = (fun ( c  :  'u30u3085 config ) -> (let _30_188 = c
...
let whnf_only = (fun ( config  :  'u30u3122 config ) -> (Support.Prims.pipe_right config.steps (Support.List.contains WHNF)))

let unmeta = (fun ( config  :  'u30u3159 config ) -> (Support.Prims.pipe_right config.steps (Support.List.contains Unmeta)))

let unlabel = (fun ( config  :  'u30u3185 config ) -> (let _52_8770 = (unmeta config)
in (let _52_8769 = (Support.Prims.pipe_right config.steps (Support.List.contains Unlabel))
in (_52_8770 || _52_8769))))

let is_stack_empty = (fun ( config  :  'u30u3217 config ) -> (match (config.stack.args) with
| [] -> begin
true
end
| _ -> begin
...
let has_eta = (fun ( cfg  :  'u30u3254 config ) -> (Support.Prims.pipe_right cfg.steps (Support.List.contains Eta)))

let rec weak_norm_comp = (fun ( env  :  Microsoft_FStar_Tc_Env.env ) ( comp  :  Microsoft_FStar_Absyn_Syntax.comp ) -> (let c = (Microsoft_FStar_Absyn_Util.comp_to_comp_typ comp)
in (match ((Microsoft_FStar_Tc_Env.lookup_effect_abbrev env c.Microsoft_FStar_Absyn_Syntax.effect_name)) with
| None -> begin
c
end
| Some ((binders, cdef)) -> begin
(let binders' = (Support.List.map (fun ( _30_3  :  ((((Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.withinfo_t, ((Microsoft_FStar_Absyn_Syntax.exp', (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.withinfo_t) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) ) -> (match (_30_3) with
...
let t_config = (fun ( code  :  'u30u4019 ) ( env  :  environment ) ( steps  :  step list ) -> {code = code; environment = env; stack = empty_stack; close = None; steps = steps})

let k_config = (fun ( code  :  'u30u4033 ) ( env  :  environment ) ( steps  :  step list ) -> {code = code; environment = env; stack = empty_stack; close = None; steps = steps})

let e_config = (fun ( code  :  'u30u4047 ) ( env  :  environment ) ( steps  :  step list ) -> {code = code; environment = env; stack = empty_stack; close = None; steps = steps})

let c_config = (fun ( code  :  'u30u4061 ) ( env  :  environment ) ( steps  :  step list ) -> {code = code; environment = env; stack = empty_stack; close = None; steps = steps})

let close_with_config = (fun ( cfg  :  'u30u4127 config ) ( f  :  'u30u4126  ->  'u30u4127 ) -> Some ((fun ( t  :  'u30u4126 ) -> (let t = (f t)
...
let rec is_head_symbol = (fun ( t  :  (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax ) -> (match ((let _52_8816 = (Microsoft_FStar_Absyn_Util.compress_typ t)
...
let simplify_then_apply = (fun ( steps  :  step list ) ( head  :  Microsoft_FStar_Absyn_Syntax.typ ) ( args  :  Microsoft_FStar_Absyn_Syntax.args ) ( pos  :  Support.Microsoft.FStar.Range.range ) -> (let fallback = (fun ( _30_264  :  unit ) -> (match (()) with
| () -> begin
(Microsoft_FStar_Absyn_Syntax.mk_Typ_app (head, args) None pos)
end))
in (let simp_t = (fun ( t  :  (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax ) -> (match (t.Microsoft_FStar_Absyn_Syntax.n) with
...
let rec sn_delay = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( cfg  :  Microsoft_FStar_Absyn_Syntax.typ config ) -> (let aux = (fun ( _30_451  :  unit ) -> (match (()) with
| () -> begin
...
and sn = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( cfg  :  Microsoft_FStar_Absyn_Syntax.typ config ) -> (let rebuild = (fun ( config  :  Microsoft_FStar_Absyn_Syntax.typ config ) -> (let rebuild_stack = (fun ( config  :  Microsoft_FStar_Absyn_Syntax.typ config ) -> (match ((is_stack_empty config)) with
| true -> begin
config
end
| false -> begin
(let s' = (no_eta config.steps)
in (let args = (Support.Prims.pipe_right config.stack.args (Support.List.map (fun ( _30_4  :  (((Microsoft_FStar_Absyn_Syntax.typ, Microsoft_FStar_Absyn_Syntax.exp) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) * environment) ) -> (match (_30_4) with
| ((Support.Microsoft.FStar.Util.Inl (t), imp), env) -> begin
(let _52_8869 = (let _52_8868 = (let _52_8867 = (sn tcenv (t_config t env s'))
in _52_8867.code)
in (Support.Prims.pipe_left (fun ( _52_8866  :  Microsoft_FStar_Absyn_Syntax.typ ) -> Support.Microsoft.FStar.Util.Inl (_52_8866)) _52_8868))
in (_52_8869, imp))
end
| ((Support.Microsoft.FStar.Util.Inr (v), imp), env) -> begin
(let _52_8873 = (let _52_8872 = (let _52_8871 = (wne tcenv (e_config v env s'))
in _52_8871.code)
in (Support.Prims.pipe_left (fun ( _52_8870  :  Microsoft_FStar_Absyn_Syntax.exp ) -> Support.Microsoft.FStar.Util.Inr (_52_8870)) _52_8872))
in (_52_8873, imp))
end))))
...
in (let wk = (fun ( f  :  Microsoft_FStar_Absyn_Syntax.knd option  ->  Support.Microsoft.FStar.Range.range  ->  Microsoft_FStar_Absyn_Syntax.typ ) -> (match ((Support.ST.read cfg.code.Microsoft_FStar_Absyn_Syntax.tk)) with
...
in (let is_flex = (fun ( u  :  Obj.t Microsoft_FStar_Absyn_Syntax.uvar_basis Support.Microsoft.FStar.Unionfind.uvar ) -> (match ((Support.Microsoft.FStar.Unionfind.find u)) with
...
(let args = (Support.List.fold_right (fun ( a  :  (((Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax, (Microsoft_FStar_Absyn_Syntax.exp', (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) ) ( out  :  ((((Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax, (Microsoft_FStar_Absyn_Syntax.exp', (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) * environment) list ) -> ((a, config.environment))::out) args config.stack.args)
...
(let mk_lam = (fun ( t  :  Microsoft_FStar_Absyn_Syntax.typ ) -> (let lam = (Support.Prims.pipe_left wk (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam (binders, t)))
in (match (cfg.close) with
| None -> begin
lam
end
...
| args -> begin
(let rec beta = (fun ( env_entries  :  env_entry list ) ( binders  :  ((((Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.withinfo_t, ((Microsoft_FStar_Absyn_Syntax.exp', (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.withinfo_t) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) list ) ( args  :  (Microsoft_FStar_Absyn_Syntax.arg * environment) list ) -> (match ((binders, args)) with
| ([], _) -> begin
...
(let refine = (fun ( t  :  Microsoft_FStar_Absyn_Syntax.formula ) -> (Support.Prims.pipe_left wk (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine (x, t))))
...
| false -> begin
(let pat = (fun ( t  :  Microsoft_FStar_Absyn_Syntax.typ ) -> (let ps = (sn_args true tcenv config.environment config.steps ps)
...
| false -> begin
(let lab = (fun ( t  :  (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax ) -> (match (t.Microsoft_FStar_Absyn_Syntax.n) with
...
and sn_binders = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( binders  :  Microsoft_FStar_Absyn_Syntax.binders ) ( env  :  environment ) ( steps  :  step list ) -> (let rec aux = (fun ( out  :  ((((Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, Microsoft_FStar_Absyn_Syntax.knd) Microsoft_FStar_Absyn_Syntax.withinfo_t, ((Microsoft_FStar_Absyn_Syntax.exp', (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, Microsoft_FStar_Absyn_Syntax.typ) Microsoft_FStar_Absyn_Syntax.withinfo_t) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) list ) ( env  :  environment ) ( _30_5  :  ((((Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, Microsoft_FStar_Absyn_Syntax.knd) Microsoft_FStar_Absyn_Syntax.withinfo_t, ((Microsoft_FStar_Absyn_Syntax.exp', (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, Microsoft_FStar_Absyn_Syntax.typ) Microsoft_FStar_Absyn_Syntax.withinfo_t) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) list ) -> (match (_30_5) with
...
in (aux [] env binders)))
and sncomp = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( cfg  :  Microsoft_FStar_Absyn_Syntax.comp config ) -> (let m = cfg.code
...
and sncomp_typ = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( cfg  :  Microsoft_FStar_Absyn_Syntax.comp_typ config ) -> (let m = cfg.code
in (let norm = (fun ( _30_785  :  unit ) -> (match (()) with
| () -> begin
(let remake = (fun ( l  :  Microsoft_FStar_Absyn_Syntax.lident ) ( r  :  Microsoft_FStar_Absyn_Syntax.typ ) ( eargs  :  Microsoft_FStar_Absyn_Syntax.args ) ( flags  :  Microsoft_FStar_Absyn_Syntax.cflags list ) -> (let c = {Microsoft_FStar_Absyn_Syntax.effect_name = l; Microsoft_FStar_Absyn_Syntax.result_typ = r; Microsoft_FStar_Absyn_Syntax.effect_args = eargs; Microsoft_FStar_Absyn_Syntax.flags = flags}
in (let _30_792 = cfg
...
in _52_8980.code)
in (let sn_flags = (fun ( flags  :  Microsoft_FStar_Absyn_Syntax.cflags list ) -> (Support.Prims.pipe_right flags (Support.List.map (fun ( _30_6  :  Microsoft_FStar_Absyn_Syntax.cflags ) -> (match (_30_6) with
...
and sn_args = (fun ( delay  :  bool ) ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( env  :  environment ) ( steps  :  step list ) ( args  :  Microsoft_FStar_Absyn_Syntax.arg list ) -> (Support.Prims.pipe_right args (Support.List.map (fun ( _30_7  :  ((Microsoft_FStar_Absyn_Syntax.typ, Microsoft_FStar_Absyn_Syntax.exp) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) ) -> (match (_30_7) with
...
in _52_8995.code)
in (Support.Prims.pipe_left (fun ( _52_8994  :  Microsoft_FStar_Absyn_Syntax.typ ) -> Support.Microsoft.FStar.Util.Inl (_52_8994)) _52_8996))
in (_52_8997, imp))
end
| (Support.Microsoft.FStar.Util.Inl (t), imp) -> begin
(let _52_9001 = (let _52_9000 = (let _52_8999 = (sn tcenv (t_config t env steps))
in _52_8999.code)
in (Support.Prims.pipe_left (fun ( _52_8998  :  Microsoft_FStar_Absyn_Syntax.typ ) -> Support.Microsoft.FStar.Util.Inl (_52_8998)) _52_9000))
in (_52_9001, imp))
end
| (Support.Microsoft.FStar.Util.Inr (e), imp) -> begin
(let _52_9005 = (let _52_9004 = (let _52_9003 = (wne tcenv (e_config e env steps))
in _52_9003.code)
in (Support.Prims.pipe_left (fun ( _52_9002  :  Microsoft_FStar_Absyn_Syntax.exp ) -> Support.Microsoft.FStar.Util.Inr (_52_9002)) _52_9004))
in (_52_9005, imp))
end)))))
and snk = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( cfg  :  Microsoft_FStar_Absyn_Syntax.knd config ) -> (let w = (fun ( f  :  Support.Microsoft.FStar.Range.range  ->  Microsoft_FStar_Absyn_Syntax.knd ) -> (f cfg.code.Microsoft_FStar_Absyn_Syntax.pos))
...
and wne = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( cfg  :  Microsoft_FStar_Absyn_Syntax.exp config ) -> (let e = (Microsoft_FStar_Absyn_Util.compress_exp cfg.code)
...
in (let rebuild = (fun ( config  :  Microsoft_FStar_Absyn_Syntax.exp config ) -> (match ((is_stack_empty config)) with
| true -> begin
config
end
| false -> begin
(let s' = (no_eta config.steps)
in (let args = (Support.Prims.pipe_right config.stack.args (Support.List.map (fun ( _30_8  :  (((Microsoft_FStar_Absyn_Syntax.typ, Microsoft_FStar_Absyn_Syntax.exp) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) * environment) ) -> (match (_30_8) with
| ((Support.Microsoft.FStar.Util.Inl (t), imp), env) -> begin
(let _52_9031 = (let _52_9030 = (let _52_9029 = (sn tcenv (t_config t env s'))
in _52_9029.code)
in (Support.Prims.pipe_left (fun ( _52_9028  :  Microsoft_FStar_Absyn_Syntax.typ ) -> Support.Microsoft.FStar.Util.Inl (_52_9028)) _52_9030))
in (_52_9031, imp))
end
| ((Support.Microsoft.FStar.Util.Inr (v), imp), env) -> begin
(let _52_9035 = (let _52_9034 = (let _52_9033 = (wne tcenv (e_config v env s'))
in _52_9033.code)
in (Support.Prims.pipe_left (fun ( _52_9032  :  Microsoft_FStar_Absyn_Syntax.exp ) -> Support.Microsoft.FStar.Util.Inr (_52_9032)) _52_9034))
in (_52_9035, imp))
end))))
...
(let rec beta = (fun ( entries  :  env_entry list ) ( binders  :  ((((Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.withinfo_t, ((Microsoft_FStar_Absyn_Syntax.exp', (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.withinfo_t) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) list ) ( args  :  (Microsoft_FStar_Absyn_Syntax.arg * environment) list ) -> (match ((binders, args)) with
| ([], _) -> begin
...
| (binders, env) -> begin
(let mk_abs = (fun ( t  :  Microsoft_FStar_Absyn_Syntax.exp ) -> (Microsoft_FStar_Absyn_Syntax.mk_Exp_abs (binders, t) None body.Microsoft_FStar_Absyn_Syntax.pos))
...
in (let norm_bvvar = (fun ( x  :  ((Microsoft_FStar_Absyn_Syntax.exp', (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, Microsoft_FStar_Absyn_Syntax.typ) Microsoft_FStar_Absyn_Syntax.withinfo_t ) -> (let t = (sn tcenv (t_config x.Microsoft_FStar_Absyn_Syntax.sort config.environment config.steps))
in (let _30_1088 = x
...
in (let norm_btvar = (fun ( a  :  ((Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax Microsoft_FStar_Absyn_Syntax.bvdef, Microsoft_FStar_Absyn_Syntax.knd) Microsoft_FStar_Absyn_Syntax.withinfo_t ) -> (let k = (snk tcenv (k_config a.Microsoft_FStar_Absyn_Syntax.sort config.environment config.steps))
in (let _30_1093 = a
...
in (let rec norm_pat = (fun ( p  :  (Microsoft_FStar_Absyn_Syntax.pat', ((Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax, (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax) Support.Microsoft.FStar.Util.either option) Microsoft_FStar_Absyn_Syntax.withinfo_t ) -> (match (p.Microsoft_FStar_Absyn_Syntax.v) with
...
in (let env_entries = (Support.List.fold_left (fun ( entries  :  env_entry list ) ( b  :  ((Microsoft_FStar_Absyn_Syntax.btvar, Microsoft_FStar_Absyn_Syntax.bvvar) Support.Microsoft.FStar.Util.either * Microsoft_FStar_Absyn_Syntax.arg_qualifier option) ) -> (match ((Support.Prims.fst b)) with
...
(let _30_1181 = (Support.Prims.pipe_right lbs (Support.List.fold_left (fun ( _30_1159  :  (environment * Microsoft_FStar_Absyn_Syntax.letbinding list) ) ( _30_1164  :  Microsoft_FStar_Absyn_Syntax.letbinding ) -> (match ((_30_1159, _30_1164)) with
...
let norm_kind = (fun ( steps  :  steps ) ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( k  :  Microsoft_FStar_Absyn_Syntax.knd ) -> (let c = (snk tcenv (k_config k empty_env steps))
in (Microsoft_FStar_Absyn_Util.compress_kind c.code)))

let norm_typ = (fun ( steps  :  steps ) ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( t  :  Microsoft_FStar_Absyn_Syntax.typ ) -> (let c = (sn tcenv (t_config t empty_env steps))
in c.code))

let norm_exp = (fun ( steps  :  steps ) ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( e  :  Microsoft_FStar_Absyn_Syntax.exp ) -> (let c = (wne tcenv (e_config e empty_env steps))
in c.code))

let norm_sigelt = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( _30_9  :  Microsoft_FStar_Absyn_Syntax.sigelt ) -> (match (_30_9) with
...
let whnf = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( t  :  Microsoft_FStar_Absyn_Syntax.typ ) -> (let t = (Microsoft_FStar_Absyn_Util.compress_typ t)
in (match (t.Microsoft_FStar_Absyn_Syntax.n) with
...
let norm_comp = (fun ( steps  :  steps ) ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( c  :  Microsoft_FStar_Absyn_Syntax.comp ) -> (let c = (sncomp tcenv (c_config c empty_env steps))
in c.code))

let normalize_kind = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( k  :  Microsoft_FStar_Absyn_Syntax.knd ) -> (let steps = (Eta)::(Delta)::(Beta)::[]
in (norm_kind steps tcenv k)))

let normalize_comp = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( c  :  Microsoft_FStar_Absyn_Syntax.comp ) -> (let steps = (Eta)::(Delta)::(Beta)::(SNComp)::(DeltaComp)::[]
in (norm_comp steps tcenv c)))

let normalize = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( t  :  Microsoft_FStar_Absyn_Syntax.typ ) -> (norm_typ ((DeltaHard)::(Beta)::(Eta)::[]) tcenv t))

let exp_norm_to_string = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( e  :  Microsoft_FStar_Absyn_Syntax.exp ) -> (let _52_9150 = (norm_exp ((Beta)::(SNComp)::(Unmeta)::[]) tcenv e)
in (Microsoft_FStar_Absyn_Print.exp_to_string _52_9150)))

let typ_norm_to_string = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( t  :  Microsoft_FStar_Absyn_Syntax.typ ) -> (let _52_9155 = (norm_typ ((Beta)::(SNComp)::(Unmeta)::[]) tcenv t)
in (Microsoft_FStar_Absyn_Print.typ_to_string _52_9155)))

let kind_norm_to_string = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( k  :  Microsoft_FStar_Absyn_Syntax.knd ) -> (let _52_9160 = (norm_kind ((Beta)::(SNComp)::(Unmeta)::[]) tcenv k)
in (Microsoft_FStar_Absyn_Print.kind_to_string _52_9160)))

let formula_norm_to_string = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( f  :  Microsoft_FStar_Absyn_Syntax.typ ) -> (let _52_9165 = (norm_typ ((Beta)::(SNComp)::(Unmeta)::[]) tcenv f)
in (Microsoft_FStar_Absyn_Print.formula_to_string _52_9165)))

let comp_typ_norm_to_string = (fun ( tcenv  :  Microsoft_FStar_Tc_Env.env ) ( c  :  Microsoft_FStar_Absyn_Syntax.comp ) -> (let _52_9170 = (norm_comp ((Beta)::(SNComp)::(Unmeta)::[]) tcenv c)
in (Microsoft_FStar_Absyn_Print.comp_typ_to_string _52_9170)))

let normalize_refinement = (fun ( env  :  Microsoft_FStar_Tc_Env.env ) ( t0  :  Microsoft_FStar_Absyn_Syntax.typ ) -> (let t = (norm_typ ((Beta)::(WHNF)::(DeltaHard)::[]) env t0)
in (let rec aux = (fun ( t  :  (Microsoft_FStar_Absyn_Syntax.typ', (Microsoft_FStar_Absyn_Syntax.knd', unit) Microsoft_FStar_Absyn_Syntax.syntax) Microsoft_FStar_Absyn_Syntax.syntax ) -> (let t = (Microsoft_FStar_Absyn_Util.compress_typ t)
in (match (t.Microsoft_FStar_Absyn_Syntax.n) with
