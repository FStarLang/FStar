...
| T ((a, (t, env'))) -> begin
(let _103_112 = (let _103_111 = (let _103_110 = (let _103_109 = (subst_of_env' env')
in (Microsoft_FStar_Absyn_Util.subst_typ _103_109 t))
in (a, _103_110))
in Support.Microsoft.FStar.Util.Inl (_103_111))
in (_103_112)::acc)
end
| V ((x, (v, env'))) -> begin
(let _103_116 = (let _103_115 = (let _103_114 = (let _103_113 = (subst_of_env' env')
in (Microsoft_FStar_Absyn_Util.subst_exp _103_113 v))
in (x, _103_114))
in Support.Microsoft.FStar.Util.Inr (_103_115))
in (_103_116)::acc)
end)) []))
...
let rec eta_expand = (fun ( tcenv ) ( t ) -> (let k = (let _103_126 = (Microsoft_FStar_Tc_Recheck.recompute_kind t)
in (Support.All.pipe_right _103_126 Microsoft_FStar_Absyn_Util.compress_kind))
...
(match ((let _103_131 = (Microsoft_FStar_Absyn_Util.unascribe_typ t)
in _103_131.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let _103_139 = (let _103_138 = (let _103_136 = (Microsoft_FStar_Tc_Env.get_range tcenv)
in (Support.All.pipe_right _103_136 Support.Microsoft.FStar.Range.string_of_range))
in (let _103_137 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.format2 "%s: Impossible: Kind_unknown: %s" _103_138 _103_137)))
in (Support.All.failwith _103_139))
end))
in (aux t k))))
...
let rec eta_expand_exp = (fun ( tcenv ) ( e ) -> (let t = (let _103_146 = (Microsoft_FStar_Tc_Recheck.recompute_typ e)
in (Support.All.pipe_right _103_146 Microsoft_FStar_Absyn_Util.compress_typ))
in (match (t.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_fun ((bs, c)) -> begin
(match ((let _103_147 = (Microsoft_FStar_Absyn_Util.compress_exp e)
in _103_147.Microsoft_FStar_Absyn_Syntax.n)) with
...
| (bs, args) -> begin
(let _103_149 = (let _103_148 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app (e, args) None e.Microsoft_FStar_Absyn_Syntax.pos)
in (bs, _103_148))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_abs _103_149 (Some (t)) e.Microsoft_FStar_Absyn_Syntax.pos))
end))
end)
end
| _32_184 -> begin
...
in (let _103_154 = (no_eta c.steps)
in {code = _32_191.code; environment = _32_191.environment; stack = _32_191.stack; close = _32_191.close; steps = _103_154})))
...
(let _103_166 = (let _103_165 = (Microsoft_FStar_Absyn_Util.freshen_bvar b)
in Support.Microsoft.FStar.Util.Inl (_103_165))
in (_103_166, imp))
end
| (Support.Microsoft.FStar.Util.Inr (b), imp) -> begin
(let _103_168 = (let _103_167 = (Microsoft_FStar_Absyn_Util.freshen_bvar b)
in Support.Microsoft.FStar.Util.Inr (_103_167))
in (_103_168, imp))
end)) binders)
in (let subst = (let _103_170 = (let _103_169 = (Microsoft_FStar_Absyn_Util.args_of_binders binders')
in (Support.All.pipe_right _103_169 Support.Prims.snd))
in (Microsoft_FStar_Absyn_Util.subst_of_list binders _103_170))
in (let cdef = (Microsoft_FStar_Absyn_Util.subst_comp subst cdef)
in (let subst = (let _103_172 = (let _103_171 = (Microsoft_FStar_Absyn_Syntax.targ c.Microsoft_FStar_Absyn_Syntax.result_typ)
in (_103_171)::c.Microsoft_FStar_Absyn_Syntax.effect_args)
in (Microsoft_FStar_Absyn_Util.subst_of_list binders' _103_172))
...
let rec is_head_symbol = (fun ( t ) -> (match ((let _103_203 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _103_203.Microsoft_FStar_Absyn_Syntax.n)) with
...
(match ((let _103_218 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _103_218.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let _103_256 = (let _103_255 = (let _103_254 = (sn tcenv (t_config t env s'))
in _103_254.code)
in (Support.All.pipe_left (fun ( _103_253 ) -> Support.Microsoft.FStar.Util.Inl (_103_253)) _103_255))
in (_103_256, imp))
end
| ((Support.Microsoft.FStar.Util.Inr (v), imp), env) -> begin
(let _103_260 = (let _103_259 = (let _103_258 = (wne tcenv (e_config v env s'))
in _103_258.code)
in (Support.All.pipe_left (fun ( _103_257 ) -> Support.Microsoft.FStar.Util.Inr (_103_257)) _103_259))
in (_103_260, imp))
end))))
...
| true -> begin
(let _32_487 = config
in (let _103_262 = (eta_expand tcenv t)
in {code = _103_262; environment = _32_487.environment; stack = _32_487.stack; close = _32_487.close; steps = _32_487.steps}))
end
| false -> begin
(let _32_489 = config
...
in (let _103_275 = (Microsoft_FStar_Absyn_Util.compress_typ cfg.code)
in {code = _103_275; environment = _32_506.environment; stack = _32_506.stack; close = _32_506.close; steps = _32_506.steps}))
...
in (let t2_cfg = (let _103_290 = (let _103_289 = (no_eta config.steps)
in {code = t2; environment = environment; stack = empty_stack; close = None; steps = _103_289})
in (sn_delay tcenv _103_290))
in (let _32_571 = t2_cfg
in (let _103_291 = (mk_lam t2_cfg.code)
in {code = _103_291; environment = _32_571.environment; stack = _32_571.stack; close = _32_571.close; steps = _32_571.steps}))))
end))
end
| args -> begin
...
| _32_629 -> begin
(let _103_302 = (let _103_301 = (let _103_298 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.argpos (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Range.string_of_range _103_298))
in (let _103_300 = (Microsoft_FStar_Absyn_Print.binder_to_string formal)
in (let _103_299 = (Support.All.pipe_left Microsoft_FStar_Absyn_Print.arg_to_string (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: ill-typed redex\n formal is %s\nactual is %s\n" _103_301 _103_300 _103_299))))
in (Support.All.failwith _103_302))
end)
...
in (let _103_305 = (Support.All.pipe_left wk (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (binders, c2.code)))
in {code = _103_305; environment = _32_648.environment; stack = _32_648.stack; close = _32_648.close; steps = _32_648.steps})))
end))
end
| Microsoft_FStar_Absyn_Syntax.Typ_refine ((x, t)) -> begin
(match ((let _103_307 = (let _103_306 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (_103_306)::[])
in (sn_binders tcenv _103_307 config.environment config.steps))) with
...
| true -> begin
(let _103_318 = (Support.Microsoft.FStar.Range.string_of_range sfx)
...
| true -> begin
(let _103_319 = (Support.Microsoft.FStar.Range.string_of_range sfx)
...
| true -> begin
(let _103_325 = (let _32_731 = config
in (let _103_324 = (Microsoft_FStar_Absyn_Util.mk_conj t1 t2)
in {code = _103_324; environment = _32_731.environment; stack = _32_731.stack; close = _32_731.close; steps = _32_731.steps}))
in (sn tcenv _103_325))
end
| false -> begin
...
in (let _103_327 = (let _32_735 = config
in (let _103_326 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta (Microsoft_FStar_Absyn_Syntax.Meta_slack_formula ((c1.code, c2.code, flag))))
in {code = _103_326; environment = _32_735.environment; stack = _32_735.stack; close = _32_735.close; steps = _32_735.steps}))
in (rebuild _103_327))))
end)
end
...
(let _103_332 = (let _103_331 = (let _103_328 = (Microsoft_FStar_Tc_Env.get_range tcenv)
in (Support.All.pipe_right _103_328 Support.Microsoft.FStar.Range.string_of_range))
in (let _103_330 = (Microsoft_FStar_Absyn_Print.tag_of_typ config.code)
in (let _103_329 = (Microsoft_FStar_Absyn_Print.typ_to_string config.code)
in (Support.Microsoft.FStar.Util.format3 "(%s) Unexpected type (%s): %s" _103_331 _103_330 _103_329))))
in (Support.All.failwith _103_332))
end)
end))))))
...
in (let b = (let _103_343 = (Microsoft_FStar_Absyn_Util.freshen_bvd a.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _103_343 c.code))
...
in (let y = (let _103_344 = (Microsoft_FStar_Absyn_Util.freshen_bvd x.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _103_344 c.code))
...
in (let _32_779 = cfg
in (let _103_347 = (Microsoft_FStar_Absyn_Syntax.mk_Comp ctconf.code)
in {code = _103_347; environment = _32_779.environment; stack = _32_779.stack; close = _32_779.close; steps = _32_779.steps})))
end
| Microsoft_FStar_Absyn_Syntax.Total (t) -> begin
(match ((Support.List.contains DeltaComp cfg.steps)) with
| true -> begin
(let _103_351 = (let _103_350 = (let _103_349 = (let _103_348 = (Microsoft_FStar_Absyn_Syntax.mk_Total t)
in (Microsoft_FStar_Absyn_Util.comp_to_comp_typ _103_348))
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.mk_Comp _103_349))
in (with_new_code cfg _103_350))
in (Support.All.pipe_left (sncomp tcenv) _103_351))
end
| false -> begin
(let t = (sn tcenv (with_new_code cfg t))
in (let _103_352 = (Microsoft_FStar_Absyn_Syntax.mk_Total t.code)
in (with_new_code cfg _103_352)))
end)
end)))
...
in (let res = (let _103_365 = (sn tcenv (with_new_code cfg m.Microsoft_FStar_Absyn_Syntax.result_typ))
in _103_365.code)
in (let sn_flags = (fun ( flags ) -> (Support.All.pipe_right flags (Support.List.map (fun ( _32_6 ) -> (match (_32_6) with
| Microsoft_FStar_Absyn_Syntax.DECREASES (e) -> begin
(let e = (let _103_369 = (wne tcenv (e_config e cfg.environment cfg.steps))
in _103_369.code)
...
in (let _32_807 = (let _103_371 = (sn_flags m.Microsoft_FStar_Absyn_Syntax.flags)
in (let _103_370 = (sn_args true tcenv cfg.environment cfg.steps m.Microsoft_FStar_Absyn_Syntax.effect_args)
in (_103_371, _103_370)))
...
| Some (_32_809) -> begin
(let c = (let _103_372 = (Microsoft_FStar_Absyn_Syntax.mk_Comp m)
in (weak_norm_comp tcenv _103_372))
...
(let _103_382 = (let _103_381 = (let _103_380 = (sn_delay tcenv (t_config t env steps))
in _103_380.code)
in (Support.All.pipe_left (fun ( _103_379 ) -> Support.Microsoft.FStar.Util.Inl (_103_379)) _103_381))
in (_103_382, imp))
end
| (Support.Microsoft.FStar.Util.Inl (t), imp) -> begin
(let _103_386 = (let _103_385 = (let _103_384 = (sn tcenv (t_config t env steps))
in _103_384.code)
in (Support.All.pipe_left (fun ( _103_383 ) -> Support.Microsoft.FStar.Util.Inl (_103_383)) _103_385))
in (_103_386, imp))
end
| (Support.Microsoft.FStar.Util.Inr (e), imp) -> begin
(let _103_390 = (let _103_389 = (let _103_388 = (wne tcenv (e_config e env steps))
in _103_388.code)
in (Support.All.pipe_left (fun ( _103_387 ) -> Support.Microsoft.FStar.Util.Inr (_103_387)) _103_389))
in (_103_390, imp))
end)))))
and snk = (fun ( tcenv ) ( cfg ) -> (let w = (fun ( f ) -> (f cfg.code.Microsoft_FStar_Absyn_Syntax.pos))
in (match ((let _103_400 = (Microsoft_FStar_Absyn_Util.compress_kind cfg.code)
in _103_400.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let args = (let _103_401 = (no_eta cfg.steps)
in (sn_args false tcenv cfg.environment _103_401 args))
in (let _32_851 = cfg
in (let _103_403 = (Support.All.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_uvar (uv, args)))
in {code = _103_403; environment = _32_851.environment; stack = _32_851.stack; close = _32_851.close; steps = _32_851.steps})))
end
...
in (let _103_405 = (let _32_874 = cfg
in (let _103_404 = (Microsoft_FStar_Absyn_Util.subst_kind subst body)
in {code = _103_404; environment = _32_874.environment; stack = _32_874.stack; close = _32_874.close; steps = _32_874.steps}))
in (snk tcenv _103_405)))
end))
end
...
| (bs, rhs) -> begin
(let _32_900 = cfg
in (let _103_407 = (Support.All.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (bs, rhs)))
in {code = _103_407; environment = _32_900.environment; stack = _32_900.stack; close = _32_900.close; steps = _32_900.steps}))
end)))
end))
end
| Microsoft_FStar_Absyn_Syntax.Kind_unknown -> begin
...
| ((Support.Microsoft.FStar.Util.Inl (t), imp), env) -> begin
(let _103_416 = (let _103_415 = (let _103_414 = (sn tcenv (t_config t env s'))
in _103_414.code)
in (Support.All.pipe_left (fun ( _103_413 ) -> Support.Microsoft.FStar.Util.Inl (_103_413)) _103_415))
in (_103_416, imp))
end
| ((Support.Microsoft.FStar.Util.Inr (v), imp), env) -> begin
(let _103_420 = (let _103_419 = (let _103_418 = (wne tcenv (e_config v env s'))
in _103_418.code)
in (Support.All.pipe_left (fun ( _103_417 ) -> Support.Microsoft.FStar.Util.Inr (_103_417)) _103_419))
in (_103_420, imp))
end))))
in (let _32_926 = config
in (let _103_421 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app (config.code, args) None config.code.Microsoft_FStar_Absyn_Syntax.pos)
in {code = _103_421; environment = _32_926.environment; stack = empty_stack; close = _32_926.close; steps = _32_926.steps}))))
end))
...
in (let c = (let _103_433 = (let _32_994 = config
in (let _103_432 = (no_eta config.steps)
in {code = body; environment = env; stack = (let _32_996 = config.stack
in {args = []}); close = _32_994.close; steps = _103_432}))
in (wne tcenv _103_433))
in (let _32_999 = c
in (let _103_434 = (mk_abs c.code)
in {code = _103_434; environment = _32_999.environment; stack = _32_999.stack; close = _32_999.close; steps = _32_999.steps}))))
end)))
end
| (formal::rest, actual::rest') -> begin
(let m = (match ((formal, actual)) with
...
| _32_1035 -> begin
(let _103_439 = (let _103_438 = (let _103_435 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.argpos (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Range.string_of_range _103_435))
in (let _103_437 = (Microsoft_FStar_Absyn_Print.binder_to_string formal)
in (let _103_436 = (Support.All.pipe_left Microsoft_FStar_Absyn_Print.arg_to_string (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: ill-typed redex\n formal is %s\nactual is %s\n" _103_438 _103_437 _103_436))))
in (Support.All.failwith _103_439))
end)
...
(let _103_445 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (_103_445)::[])
end
| Microsoft_FStar_Absyn_Syntax.Pat_tvar (a) -> begin
(let _103_446 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (_103_446)::[])
end
...
(let _103_454 = (let _103_453 = (Support.List.map norm_pat pats)
in Microsoft_FStar_Absyn_Syntax.Pat_disj (_103_453))
in (Microsoft_FStar_Absyn_Util.withinfo _103_454 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_cons ((fv, q, pats)) -> begin
(let _103_459 = (let _103_458 = (let _103_457 = (Support.List.map (fun ( _32_1110 ) -> (match (_32_1110) with
| (x, i) -> begin
(let _103_456 = (norm_pat x)
in (_103_456, i))
end)) pats)
in (fv, q, _103_457))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_103_458))
in (Microsoft_FStar_Absyn_Util.withinfo _103_459 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_var (x) -> begin
(let _103_461 = (let _103_460 = (norm_bvvar x)
in Microsoft_FStar_Absyn_Syntax.Pat_var (_103_460))
in (Microsoft_FStar_Absyn_Util.withinfo _103_461 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_tvar (a) -> begin
(let _103_463 = (let _103_462 = (norm_btvar a)
in Microsoft_FStar_Absyn_Syntax.Pat_tvar (_103_462))
in (Microsoft_FStar_Absyn_Util.withinfo _103_463 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_wild (x) -> begin
(let _103_465 = (let _103_464 = (norm_bvvar x)
in Microsoft_FStar_Absyn_Syntax.Pat_wild (_103_464))
in (Microsoft_FStar_Absyn_Util.withinfo _103_465 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_twild (a) -> begin
(let _103_467 = (let _103_466 = (norm_btvar a)
in Microsoft_FStar_Absyn_Syntax.Pat_twild (_103_466))
in (Microsoft_FStar_Absyn_Util.withinfo _103_467 None p.Microsoft_FStar_Absyn_Syntax.p))
end
...
in (let _103_470 = (let _103_469 = (let _103_468 = (norm_bvvar x)
in (_103_468, e.code))
in Microsoft_FStar_Absyn_Syntax.Pat_dot_term (_103_469))
in (Microsoft_FStar_Absyn_Util.withinfo _103_470 None p.Microsoft_FStar_Absyn_Syntax.p)))
end
| Microsoft_FStar_Absyn_Syntax.Pat_dot_typ ((a, t)) -> begin
(let t = (sn tcenv (t_config t config.environment config.steps))
in (let _103_473 = (let _103_472 = (let _103_471 = (norm_btvar a)
in (_103_471, t.code))
in Microsoft_FStar_Absyn_Syntax.Pat_dot_typ (_103_472))
in (Microsoft_FStar_Absyn_Util.withinfo _103_473 None p.Microsoft_FStar_Absyn_Syntax.p)))
end))
...
in (let _103_476 = (norm_pat pat)
in (_103_476, w, c_body.code)))))))))))
end))
...
(let y = (let _103_479 = (match (is_rec) with
| true -> begin
x
end
| false -> begin
...
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _103_479 t.code))
in (let yexp = (Microsoft_FStar_Absyn_Util.bvar_to_exp y)
...
| (y, env) -> begin
(let _103_481 = (let _103_480 = (Microsoft_FStar_Absyn_Syntax.mk_lb (y, eff, t.code, c.code))
in (_103_480)::lbs)
in (env, _103_481))
end))))
...
| true -> begin
(let t = (sn tcenv (t_config t config.environment config.steps))
in (let _103_483 = (let _32_1203 = config
in (let _103_482 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed (c.code, t.code, l) None e.Microsoft_FStar_Absyn_Syntax.pos)
in {code = _103_482; environment = _32_1203.environment; stack = _32_1203.stack; close = _32_1203.close; steps = _32_1203.steps}))
in (rebuild _103_483)))
end
| false -> begin
c
...
in (match ((is_stack_empty config)) with
| true -> begin
(let _103_485 = (let _32_1213 = config
in (let _103_484 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta (Microsoft_FStar_Absyn_Syntax.Meta_desugared ((c.code, info))))
in {code = _103_484; environment = _32_1213.environment; stack = _32_1213.stack; close = _32_1213.close; steps = _32_1213.steps}))
in (rebuild _103_485))
end
| false -> begin
c
...
(let e = (let _103_509 = (let _103_508 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant Microsoft_FStar_Absyn_Syntax.Const_unit None r)
in (lbs, _103_508))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_let _103_509 None r))
...
(let _103_514 = (eta_expand tcenv t)
in (Support.All.pipe_right _103_514 Microsoft_FStar_Absyn_Util.compress_typ))
end
...
let exp_norm_to_string = (fun ( tcenv ) ( e ) -> (let _103_537 = (norm_exp ((Beta)::(SNComp)::(Unmeta)::[]) tcenv e)
in (Microsoft_FStar_Absyn_Print.exp_to_string _103_537)))

let typ_norm_to_string = (fun ( tcenv ) ( t ) -> (let _103_542 = (norm_typ ((Beta)::(SNComp)::(Unmeta)::[]) tcenv t)
in (Microsoft_FStar_Absyn_Print.typ_to_string _103_542)))

let kind_norm_to_string = (fun ( tcenv ) ( k ) -> (let _103_547 = (norm_kind ((Beta)::(SNComp)::(Unmeta)::[]) tcenv k)
in (Microsoft_FStar_Absyn_Print.kind_to_string _103_547)))

let formula_norm_to_string = (fun ( tcenv ) ( f ) -> (let _103_552 = (norm_typ ((Beta)::(SNComp)::(Unmeta)::[]) tcenv f)
in (Microsoft_FStar_Absyn_Print.formula_to_string _103_552)))

let comp_typ_norm_to_string = (fun ( tcenv ) ( c ) -> (let _103_557 = (norm_comp ((Beta)::(SNComp)::(Unmeta)::[]) tcenv c)
in (Microsoft_FStar_Absyn_Print.comp_typ_to_string _103_557)))
...
(let _103_570 = (let _103_569 = (let _103_568 = (let _103_567 = (let _103_566 = (let _103_565 = (let _103_564 = (Microsoft_FStar_Absyn_Util.bvar_to_exp y)
in (x.Microsoft_FStar_Absyn_Syntax.v, _103_564))
in Support.Microsoft.FStar.Util.Inr (_103_565))
in (_103_566)::[])
in (Microsoft_FStar_Absyn_Util.subst_typ _103_567 phi))
in (Microsoft_FStar_Absyn_Util.mk_conj phi1 _103_568))
in (y, _103_569))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine _103_570 (Some (Microsoft_FStar_Absyn_Syntax.ktype)) t0.Microsoft_FStar_Absyn_Syntax.pos))
end
| _32_1351 -> begin
t
end))
