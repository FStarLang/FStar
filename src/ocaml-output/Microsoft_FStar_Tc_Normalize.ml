...
| T ((a, (t, env'))) -> begin
(let _65_12146 = (let _65_12145 = (let _65_12144 = (let _65_12143 = (subst_of_env' env')
in (Microsoft_FStar_Absyn_Util.subst_typ _65_12143 t))
in (a, _65_12144))
in Support.Microsoft.FStar.Util.Inl (_65_12145))
in (_65_12146)::acc)
end
| V ((x, (v, env'))) -> begin
(let _65_12150 = (let _65_12149 = (let _65_12148 = (let _65_12147 = (subst_of_env' env')
in (Microsoft_FStar_Absyn_Util.subst_exp _65_12147 v))
in (x, _65_12148))
in Support.Microsoft.FStar.Util.Inr (_65_12149))
in (_65_12150)::acc)
end)) []))
...
let rec eta_expand = (fun ( tcenv ) ( t ) -> (let k = (let _65_12160 = (Microsoft_FStar_Tc_Recheck.recompute_kind t)
in (Support.Prims.pipe_right _65_12160 Microsoft_FStar_Absyn_Util.compress_kind))
...
(match ((let _65_12165 = (Microsoft_FStar_Absyn_Util.unascribe_typ t)
in _65_12165.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let _65_12173 = (let _65_12172 = (let _65_12170 = (Microsoft_FStar_Tc_Env.get_range tcenv)
in (Support.Prims.pipe_right _65_12170 Support.Microsoft.FStar.Range.string_of_range))
in (let _65_12171 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.format2 "%s: Impossible: Kind_unknown: %s" _65_12172 _65_12171)))
in (failwith (_65_12173)))
end))
in (aux t k))))
...
let rec eta_expand_exp = (fun ( tcenv ) ( e ) -> (let t = (let _65_12180 = (Microsoft_FStar_Tc_Recheck.recompute_typ e)
in (Support.Prims.pipe_right _65_12180 Microsoft_FStar_Absyn_Util.compress_typ))
in (match (t.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_fun ((bs, c)) -> begin
(match ((let _65_12181 = (Microsoft_FStar_Absyn_Util.compress_exp e)
in _65_12181.Microsoft_FStar_Absyn_Syntax.n)) with
...
| (bs, args) -> begin
(let _65_12183 = (let _65_12182 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app (e, args) None e.Microsoft_FStar_Absyn_Syntax.pos)
in (bs, _65_12182))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_abs _65_12183 (Some (t)) e.Microsoft_FStar_Absyn_Syntax.pos))
end))
end)
end
| _ -> begin
...
in (let _65_12187 = (no_eta c.steps)
in {code = _30_188.code; environment = _30_188.environment; stack = _30_188.stack; close = _30_188.close; steps = _65_12187})))
...
(let _65_12199 = (let _65_12198 = (Microsoft_FStar_Absyn_Util.freshen_bvar b)
in Support.Microsoft.FStar.Util.Inl (_65_12198))
in (_65_12199, imp))
end
| (Support.Microsoft.FStar.Util.Inr (b), imp) -> begin
(let _65_12201 = (let _65_12200 = (Microsoft_FStar_Absyn_Util.freshen_bvar b)
in Support.Microsoft.FStar.Util.Inr (_65_12200))
in (_65_12201, imp))
end)) binders)
in (let subst = (let _65_12203 = (let _65_12202 = (Microsoft_FStar_Absyn_Util.args_of_binders binders')
in (Support.Prims.pipe_right _65_12202 Support.Prims.snd))
in (Microsoft_FStar_Absyn_Util.subst_of_list binders _65_12203))
in (let cdef = (Microsoft_FStar_Absyn_Util.subst_comp subst cdef)
in (let subst = (let _65_12205 = (let _65_12204 = (Microsoft_FStar_Absyn_Syntax.targ c.Microsoft_FStar_Absyn_Syntax.result_typ)
in (_65_12204)::c.Microsoft_FStar_Absyn_Syntax.effect_args)
in (Microsoft_FStar_Absyn_Util.subst_of_list binders' _65_12205))
...
let rec is_head_symbol = (fun ( t ) -> (match ((let _65_12236 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _65_12236.Microsoft_FStar_Absyn_Syntax.n)) with
...
(match ((let _65_12251 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _65_12251.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let _65_12289 = (let _65_12288 = (let _65_12287 = (sn tcenv (t_config t env s'))
in _65_12287.code)
in (Support.Prims.pipe_left (fun ( _65_12286 ) -> Support.Microsoft.FStar.Util.Inl (_65_12286)) _65_12288))
in (_65_12289, imp))
end
| ((Support.Microsoft.FStar.Util.Inr (v), imp), env) -> begin
(let _65_12293 = (let _65_12292 = (let _65_12291 = (wne tcenv (e_config v env s'))
in _65_12291.code)
in (Support.Prims.pipe_left (fun ( _65_12290 ) -> Support.Microsoft.FStar.Util.Inr (_65_12290)) _65_12292))
in (_65_12293, imp))
end))))
...
| true -> begin
(let _30_484 = config
in (let _65_12295 = (eta_expand tcenv t)
in {code = _65_12295; environment = _30_484.environment; stack = _30_484.stack; close = _30_484.close; steps = _30_484.steps}))
end
| false -> begin
(let _30_486 = config
...
in (let _65_12308 = (Microsoft_FStar_Absyn_Util.compress_typ cfg.code)
in {code = _65_12308; environment = _30_503.environment; stack = _30_503.stack; close = _30_503.close; steps = _30_503.steps}))
...
in (let t2_cfg = (let _65_12320 = (let _65_12319 = (no_eta config.steps)
in {code = t2; environment = environment; stack = empty_stack; close = None; steps = _65_12319})
in (sn_delay tcenv _65_12320))
in (let _30_568 = t2_cfg
in (let _65_12321 = (mk_lam t2_cfg.code)
in {code = _65_12321; environment = _30_568.environment; stack = _30_568.stack; close = _30_568.close; steps = _30_568.steps}))))
end))
end
| args -> begin
...
| _ -> begin
(let _65_12332 = (let _65_12331 = (let _65_12328 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.argpos (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Range.string_of_range _65_12328))
in (let _65_12330 = (Microsoft_FStar_Absyn_Print.binder_to_string formal)
in (let _65_12329 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Print.arg_to_string (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: ill-typed redex\n formal is %s\nactual is %s\n" _65_12331 _65_12330 _65_12329))))
in (failwith (_65_12332)))
end)
...
in (let _65_12335 = (Support.Prims.pipe_left wk (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (binders, c2.code)))
in {code = _65_12335; environment = _30_645.environment; stack = _30_645.stack; close = _30_645.close; steps = _30_645.steps})))
end))
end
| Microsoft_FStar_Absyn_Syntax.Typ_refine ((x, t)) -> begin
(match ((let _65_12337 = (let _65_12336 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (_65_12336)::[])
in (sn_binders tcenv _65_12337 config.environment config.steps))) with
...
| true -> begin
(let _65_12349 = (Support.Microsoft.FStar.Range.string_of_range sfx)
...
| true -> begin
(let _65_12355 = (let _30_728 = config
in (let _65_12354 = (Microsoft_FStar_Absyn_Util.mk_conj t1 t2)
in {code = _65_12354; environment = _30_728.environment; stack = _30_728.stack; close = _30_728.close; steps = _30_728.steps}))
in (sn tcenv _65_12355))
end
| false -> begin
...
in (let _65_12357 = (let _30_732 = config
in (let _65_12356 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta (Microsoft_FStar_Absyn_Syntax.Meta_slack_formula ((c1.code, c2.code, flag))))
in {code = _65_12356; environment = _30_732.environment; stack = _30_732.stack; close = _30_732.close; steps = _30_732.steps}))
in (rebuild _65_12357))))
end)
end
...
(let _65_12362 = (let _65_12361 = (let _65_12358 = (Microsoft_FStar_Tc_Env.get_range tcenv)
in (Support.Prims.pipe_right _65_12358 Support.Microsoft.FStar.Range.string_of_range))
in (let _65_12360 = (Microsoft_FStar_Absyn_Print.tag_of_typ config.code)
in (let _65_12359 = (Microsoft_FStar_Absyn_Print.typ_to_string config.code)
in (Support.Microsoft.FStar.Util.format3 "(%s) Unexpected type (%s): %s" _65_12361 _65_12360 _65_12359))))
in (failwith (_65_12362)))
end)
end))))))
...
in (let b = (let _65_12373 = (Microsoft_FStar_Absyn_Util.freshen_bvd a.Microsoft_FStar_Absyn_Syntax.v)
...
in (let y = (let _65_12374 = (Microsoft_FStar_Absyn_Util.freshen_bvd x.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _65_12374 c.code))
...
in (let _30_776 = cfg
in (let _65_12377 = (Microsoft_FStar_Absyn_Syntax.mk_Comp ctconf.code)
in {code = _65_12377; environment = _30_776.environment; stack = _30_776.stack; close = _30_776.close; steps = _30_776.steps})))
end
| Microsoft_FStar_Absyn_Syntax.Total (t) -> begin
(match ((Support.List.contains DeltaComp cfg.steps)) with
| true -> begin
(let _65_12381 = (let _65_12380 = (let _65_12379 = (let _65_12378 = (Microsoft_FStar_Absyn_Syntax.mk_Total t)
in (Microsoft_FStar_Absyn_Util.comp_to_comp_typ _65_12378))
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.mk_Comp _65_12379))
in (with_new_code cfg _65_12380))
in (Support.Prims.pipe_left (sncomp tcenv) _65_12381))
end
| false -> begin
(let t = (sn tcenv (with_new_code cfg t))
in (let _65_12382 = (Microsoft_FStar_Absyn_Syntax.mk_Total t.code)
in (with_new_code cfg _65_12382)))
end)
end)))
...
in (let res = (let _65_12395 = (sn tcenv (with_new_code cfg m.Microsoft_FStar_Absyn_Syntax.result_typ))
in _65_12395.code)
in (let sn_flags = (fun ( flags ) -> (Support.Prims.pipe_right flags (Support.List.map (fun ( _30_6 ) -> (match (_30_6) with
| Microsoft_FStar_Absyn_Syntax.DECREASES (e) -> begin
(let e = (let _65_12399 = (wne tcenv (e_config e cfg.environment cfg.steps))
in _65_12399.code)
...
in (let _30_804 = (let _65_12401 = (sn_flags m.Microsoft_FStar_Absyn_Syntax.flags)
in (let _65_12400 = (sn_args true tcenv cfg.environment cfg.steps m.Microsoft_FStar_Absyn_Syntax.effect_args)
in (_65_12401, _65_12400)))
...
| Some (_) -> begin
(let c = (let _65_12402 = (Microsoft_FStar_Absyn_Syntax.mk_Comp m)
in (weak_norm_comp tcenv _65_12402))
...
(let _65_12412 = (let _65_12411 = (let _65_12410 = (sn_delay tcenv (t_config t env steps))
in _65_12410.code)
in (Support.Prims.pipe_left (fun ( _65_12409 ) -> Support.Microsoft.FStar.Util.Inl (_65_12409)) _65_12411))
in (_65_12412, imp))
end
| (Support.Microsoft.FStar.Util.Inl (t), imp) -> begin
(let _65_12416 = (let _65_12415 = (let _65_12414 = (sn tcenv (t_config t env steps))
in _65_12414.code)
in (Support.Prims.pipe_left (fun ( _65_12413 ) -> Support.Microsoft.FStar.Util.Inl (_65_12413)) _65_12415))
in (_65_12416, imp))
end
| (Support.Microsoft.FStar.Util.Inr (e), imp) -> begin
(let _65_12420 = (let _65_12419 = (let _65_12418 = (wne tcenv (e_config e env steps))
in _65_12418.code)
in (Support.Prims.pipe_left (fun ( _65_12417 ) -> Support.Microsoft.FStar.Util.Inr (_65_12417)) _65_12419))
in (_65_12420, imp))
end)))))
and snk = (fun ( tcenv ) ( cfg ) -> (let w = (fun ( f ) -> (f cfg.code.Microsoft_FStar_Absyn_Syntax.pos))
in (match ((let _65_12430 = (Microsoft_FStar_Absyn_Util.compress_kind cfg.code)
in _65_12430.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let args = (let _65_12431 = (no_eta cfg.steps)
in (sn_args false tcenv cfg.environment _65_12431 args))
in (let _30_848 = cfg
in (let _65_12433 = (Support.Prims.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_uvar (uv, args)))
in {code = _65_12433; environment = _30_848.environment; stack = _30_848.stack; close = _30_848.close; steps = _30_848.steps})))
end
...
in (let _65_12435 = (let _30_871 = cfg
in (let _65_12434 = (Microsoft_FStar_Absyn_Util.subst_kind subst body)
in {code = _65_12434; environment = _30_871.environment; stack = _30_871.stack; close = _30_871.close; steps = _30_871.steps}))
in (snk tcenv _65_12435)))
end))
end
| Microsoft_FStar_Absyn_Syntax.Kind_abbrev ((_, k)) -> begin
...
| (bs, rhs) -> begin
(let _30_897 = cfg
in (let _65_12437 = (Support.Prims.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (bs, rhs)))
in {code = _65_12437; environment = _30_897.environment; stack = _30_897.stack; close = _30_897.close; steps = _30_897.steps}))
end)))
end))
end
| Microsoft_FStar_Absyn_Syntax.Kind_unknown -> begin
...
| ((Support.Microsoft.FStar.Util.Inl (t), imp), env) -> begin
(let _65_12446 = (let _65_12445 = (let _65_12444 = (sn tcenv (t_config t env s'))
in _65_12444.code)
in (Support.Prims.pipe_left (fun ( _65_12443 ) -> Support.Microsoft.FStar.Util.Inl (_65_12443)) _65_12445))
in (_65_12446, imp))
end
| ((Support.Microsoft.FStar.Util.Inr (v), imp), env) -> begin
(let _65_12450 = (let _65_12449 = (let _65_12448 = (wne tcenv (e_config v env s'))
in _65_12448.code)
in (Support.Prims.pipe_left (fun ( _65_12447 ) -> Support.Microsoft.FStar.Util.Inr (_65_12447)) _65_12449))
in (_65_12450, imp))
end))))
in (let _30_923 = config
in (let _65_12451 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app (config.code, args) None config.code.Microsoft_FStar_Absyn_Syntax.pos)
in {code = _65_12451; environment = _30_923.environment; stack = empty_stack; close = _30_923.close; steps = _30_923.steps}))))
end))
...
in (let c = (let _65_12463 = (let _30_991 = config
in (let _65_12462 = (no_eta config.steps)
in {code = body; environment = env; stack = (let _30_993 = config.stack
in {args = []}); close = _30_991.close; steps = _65_12462}))
in (wne tcenv _65_12463))
in (let _30_996 = c
in (let _65_12464 = (mk_abs c.code)
in {code = _65_12464; environment = _30_996.environment; stack = _30_996.stack; close = _30_996.close; steps = _30_996.steps}))))
end)))
end
| (formal::rest, actual::rest') -> begin
(let m = (match ((formal, actual)) with
...
| _ -> begin
(let _65_12469 = (let _65_12468 = (let _65_12465 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.argpos (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Range.string_of_range _65_12465))
in (let _65_12467 = (Microsoft_FStar_Absyn_Print.binder_to_string formal)
in (let _65_12466 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Print.arg_to_string (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: ill-typed redex\n formal is %s\nactual is %s\n" _65_12468 _65_12467 _65_12466))))
in (failwith (_65_12469)))
end)
...
(let _65_12474 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (_65_12474)::[])
end
| Microsoft_FStar_Absyn_Syntax.Pat_tvar (a) -> begin
(let _65_12475 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (_65_12475)::[])
end
...
(let _65_12483 = (let _65_12482 = (Support.List.map norm_pat pats)
in Microsoft_FStar_Absyn_Syntax.Pat_disj (_65_12482))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12483 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_cons ((fv, q, pats)) -> begin
(let _65_12486 = (let _65_12485 = (let _65_12484 = (Support.List.map norm_pat pats)
in (fv, q, _65_12484))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_65_12485))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12486 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_var ((x, b)) -> begin
(let _65_12489 = (let _65_12488 = (let _65_12487 = (norm_bvvar x)
in (_65_12487, b))
in Microsoft_FStar_Absyn_Syntax.Pat_var (_65_12488))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12489 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_tvar (a) -> begin
(let _65_12491 = (let _65_12490 = (norm_btvar a)
in Microsoft_FStar_Absyn_Syntax.Pat_tvar (_65_12490))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12491 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_wild (x) -> begin
(let _65_12493 = (let _65_12492 = (norm_bvvar x)
in Microsoft_FStar_Absyn_Syntax.Pat_wild (_65_12492))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12493 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_twild (a) -> begin
(let _65_12495 = (let _65_12494 = (norm_btvar a)
in Microsoft_FStar_Absyn_Syntax.Pat_twild (_65_12494))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12495 None p.Microsoft_FStar_Absyn_Syntax.p))
end
...
in (let _65_12498 = (let _65_12497 = (let _65_12496 = (norm_bvvar x)
in (_65_12496, e.code))
in Microsoft_FStar_Absyn_Syntax.Pat_dot_term (_65_12497))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12498 None p.Microsoft_FStar_Absyn_Syntax.p)))
end
| Microsoft_FStar_Absyn_Syntax.Pat_dot_typ ((a, t)) -> begin
(let t = (sn tcenv (t_config t config.environment config.steps))
in (let _65_12501 = (let _65_12500 = (let _65_12499 = (norm_btvar a)
in (_65_12499, t.code))
in Microsoft_FStar_Absyn_Syntax.Pat_dot_typ (_65_12500))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12501 None p.Microsoft_FStar_Absyn_Syntax.p)))
end))
...
in (let _65_12504 = (norm_pat pat)
in (_65_12504, w, c_body.code)))))))))))
end))
...
(let y = (let _65_12507 = (match (is_rec) with
| true -> begin
x
end
| false -> begin
...
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _65_12507 t.code))
in (let yexp = (Microsoft_FStar_Absyn_Util.bvar_to_exp y)
...
| (y, env) -> begin
(let _65_12509 = (let _65_12508 = (Microsoft_FStar_Absyn_Syntax.mk_lb (y, eff, t.code, c.code))
in (_65_12508)::lbs)
in (env, _65_12509))
end))))
...
| true -> begin
(let t = (sn tcenv (t_config t config.environment config.steps))
in (let _65_12511 = (let _30_1198 = config
in (let _65_12510 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed (c.code, t.code, l) None e.Microsoft_FStar_Absyn_Syntax.pos)
in {code = _65_12510; environment = _30_1198.environment; stack = _30_1198.stack; close = _30_1198.close; steps = _30_1198.steps}))
in (rebuild _65_12511)))
end
| false -> begin
c
end))
...
in (match ((is_stack_empty config)) with
| true -> begin
(let _65_12513 = (let _30_1208 = config
in (let _65_12512 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta (Microsoft_FStar_Absyn_Syntax.Meta_desugared ((c.code, info))))
in {code = _65_12512; environment = _30_1208.environment; stack = _30_1208.stack; close = _30_1208.close; steps = _30_1208.steps}))
in (rebuild _65_12513))
end
| false -> begin
c
end))
...
(let e = (let _65_12537 = (let _65_12536 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant Microsoft_FStar_Absyn_Syntax.Const_unit None r)
in (lbs, _65_12536))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_let _65_12537 None r))
...
(let _65_12542 = (eta_expand tcenv t)
in (Support.Prims.pipe_right _65_12542 Microsoft_FStar_Absyn_Util.compress_typ))
end
...
let exp_norm_to_string = (fun ( tcenv ) ( e ) -> (let _65_12565 = (norm_exp ((Beta)::(SNComp)::(Unmeta)::[]) tcenv e)
in (Microsoft_FStar_Absyn_Print.exp_to_string _65_12565)))

let typ_norm_to_string = (fun ( tcenv ) ( t ) -> (let _65_12570 = (norm_typ ((Beta)::(SNComp)::(Unmeta)::[]) tcenv t)
in (Microsoft_FStar_Absyn_Print.typ_to_string _65_12570)))

let kind_norm_to_string = (fun ( tcenv ) ( k ) -> (let _65_12575 = (norm_kind ((Beta)::(SNComp)::(Unmeta)::[]) tcenv k)
in (Microsoft_FStar_Absyn_Print.kind_to_string _65_12575)))

let formula_norm_to_string = (fun ( tcenv ) ( f ) -> (let _65_12580 = (norm_typ ((Beta)::(SNComp)::(Unmeta)::[]) tcenv f)
in (Microsoft_FStar_Absyn_Print.formula_to_string _65_12580)))

let comp_typ_norm_to_string = (fun ( tcenv ) ( c ) -> (let _65_12585 = (norm_comp ((Beta)::(SNComp)::(Unmeta)::[]) tcenv c)
in (Microsoft_FStar_Absyn_Print.comp_typ_to_string _65_12585)))
...
(let _65_12598 = (let _65_12597 = (let _65_12596 = (let _65_12595 = (let _65_12594 = (let _65_12593 = (let _65_12592 = (Microsoft_FStar_Absyn_Util.bvar_to_exp y)
in (x.Microsoft_FStar_Absyn_Syntax.v, _65_12592))
in Support.Microsoft.FStar.Util.Inr (_65_12593))
in (_65_12594)::[])
in (Microsoft_FStar_Absyn_Util.subst_typ _65_12595 phi))
in (Microsoft_FStar_Absyn_Util.mk_conj phi1 _65_12596))
in (y, _65_12597))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine _65_12598 (Some (Microsoft_FStar_Absyn_Syntax.ktype)) t0.Microsoft_FStar_Absyn_Syntax.pos))
end
| _ -> begin
t
end))
