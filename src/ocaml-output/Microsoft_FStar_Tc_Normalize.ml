...
| T ((a, (t, env'))) -> begin
(let _65_12140 = (let _65_12139 = (let _65_12138 = (let _65_12137 = (subst_of_env' env')
in (Microsoft_FStar_Absyn_Util.subst_typ _65_12137 t))
in (a, _65_12138))
in Support.Microsoft.FStar.Util.Inl (_65_12139))
in (_65_12140)::acc)
end
| V ((x, (v, env'))) -> begin
(let _65_12144 = (let _65_12143 = (let _65_12142 = (let _65_12141 = (subst_of_env' env')
in (Microsoft_FStar_Absyn_Util.subst_exp _65_12141 v))
in (x, _65_12142))
in Support.Microsoft.FStar.Util.Inr (_65_12143))
in (_65_12144)::acc)
end)) []))
...
let rec eta_expand = (fun ( tcenv ) ( t ) -> (let k = (let _65_12154 = (Microsoft_FStar_Tc_Recheck.recompute_kind t)
in (Support.Prims.pipe_right _65_12154 Microsoft_FStar_Absyn_Util.compress_kind))
...
(match ((let _65_12159 = (Microsoft_FStar_Absyn_Util.unascribe_typ t)
in _65_12159.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let _65_12167 = (let _65_12166 = (let _65_12164 = (Microsoft_FStar_Tc_Env.get_range tcenv)
in (Support.Prims.pipe_right _65_12164 Support.Microsoft.FStar.Range.string_of_range))
in (let _65_12165 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.format2 "%s: Impossible: Kind_unknown: %s" _65_12166 _65_12165)))
in (failwith (_65_12167)))
end))
in (aux t k))))
...
let rec eta_expand_exp = (fun ( tcenv ) ( e ) -> (let t = (let _65_12174 = (Microsoft_FStar_Tc_Recheck.recompute_typ e)
in (Support.Prims.pipe_right _65_12174 Microsoft_FStar_Absyn_Util.compress_typ))
in (match (t.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_fun ((bs, c)) -> begin
(match ((let _65_12175 = (Microsoft_FStar_Absyn_Util.compress_exp e)
in _65_12175.Microsoft_FStar_Absyn_Syntax.n)) with
...
| (bs, args) -> begin
(let _65_12177 = (let _65_12176 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app (e, args) None e.Microsoft_FStar_Absyn_Syntax.pos)
in (bs, _65_12176))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_abs _65_12177 (Some (t)) e.Microsoft_FStar_Absyn_Syntax.pos))
end))
end)
end
| _ -> begin
...
in (let _65_12181 = (no_eta c.steps)
in {code = _30_188.code; environment = _30_188.environment; stack = _30_188.stack; close = _30_188.close; steps = _65_12181})))
...
(let _65_12193 = (let _65_12192 = (Microsoft_FStar_Absyn_Util.freshen_bvar b)
in Support.Microsoft.FStar.Util.Inl (_65_12192))
in (_65_12193, imp))
end
| (Support.Microsoft.FStar.Util.Inr (b), imp) -> begin
(let _65_12195 = (let _65_12194 = (Microsoft_FStar_Absyn_Util.freshen_bvar b)
in Support.Microsoft.FStar.Util.Inr (_65_12194))
in (_65_12195, imp))
end)) binders)
in (let subst = (let _65_12197 = (let _65_12196 = (Microsoft_FStar_Absyn_Util.args_of_binders binders')
in (Support.Prims.pipe_right _65_12196 Support.Prims.snd))
in (Microsoft_FStar_Absyn_Util.subst_of_list binders _65_12197))
in (let cdef = (Microsoft_FStar_Absyn_Util.subst_comp subst cdef)
in (let subst = (let _65_12199 = (let _65_12198 = (Microsoft_FStar_Absyn_Syntax.targ c.Microsoft_FStar_Absyn_Syntax.result_typ)
in (_65_12198)::c.Microsoft_FStar_Absyn_Syntax.effect_args)
in (Microsoft_FStar_Absyn_Util.subst_of_list binders' _65_12199))
...
let rec is_head_symbol = (fun ( t ) -> (match ((let _65_12230 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _65_12230.Microsoft_FStar_Absyn_Syntax.n)) with
...
(match ((let _65_12245 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _65_12245.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let _65_12283 = (let _65_12282 = (let _65_12281 = (sn tcenv (t_config t env s'))
in _65_12281.code)
in (Support.Prims.pipe_left (fun ( _65_12280 ) -> Support.Microsoft.FStar.Util.Inl (_65_12280)) _65_12282))
in (_65_12283, imp))
end
| ((Support.Microsoft.FStar.Util.Inr (v), imp), env) -> begin
(let _65_12287 = (let _65_12286 = (let _65_12285 = (wne tcenv (e_config v env s'))
in _65_12285.code)
in (Support.Prims.pipe_left (fun ( _65_12284 ) -> Support.Microsoft.FStar.Util.Inr (_65_12284)) _65_12286))
in (_65_12287, imp))
end))))
...
| true -> begin
(let _30_484 = config
in (let _65_12289 = (eta_expand tcenv t)
in {code = _65_12289; environment = _30_484.environment; stack = _30_484.stack; close = _30_484.close; steps = _30_484.steps}))
end
| false -> begin
(let _30_486 = config
...
in (let _65_12302 = (Microsoft_FStar_Absyn_Util.compress_typ cfg.code)
in {code = _65_12302; environment = _30_503.environment; stack = _30_503.stack; close = _30_503.close; steps = _30_503.steps}))
...
in (let t2_cfg = (let _65_12314 = (let _65_12313 = (no_eta config.steps)
in {code = t2; environment = environment; stack = empty_stack; close = None; steps = _65_12313})
in (sn_delay tcenv _65_12314))
in (let _30_568 = t2_cfg
in (let _65_12315 = (mk_lam t2_cfg.code)
in {code = _65_12315; environment = _30_568.environment; stack = _30_568.stack; close = _30_568.close; steps = _30_568.steps}))))
end))
end
| args -> begin
...
| _ -> begin
(let _65_12326 = (let _65_12325 = (let _65_12322 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.argpos (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Range.string_of_range _65_12322))
in (let _65_12324 = (Microsoft_FStar_Absyn_Print.binder_to_string formal)
in (let _65_12323 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Print.arg_to_string (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: ill-typed redex\n formal is %s\nactual is %s\n" _65_12325 _65_12324 _65_12323))))
in (failwith (_65_12326)))
end)
...
in (let _65_12329 = (Support.Prims.pipe_left wk (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (binders, c2.code)))
in {code = _65_12329; environment = _30_645.environment; stack = _30_645.stack; close = _30_645.close; steps = _30_645.steps})))
end))
end
| Microsoft_FStar_Absyn_Syntax.Typ_refine ((x, t)) -> begin
(match ((let _65_12331 = (let _65_12330 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (_65_12330)::[])
in (sn_binders tcenv _65_12331 config.environment config.steps))) with
...
| true -> begin
(let _65_12342 = (Support.Microsoft.FStar.Range.string_of_range sfx)
...
| true -> begin
(let _65_12343 = (Support.Microsoft.FStar.Range.string_of_range sfx)
...
| true -> begin
(let _65_12349 = (let _30_728 = config
in (let _65_12348 = (Microsoft_FStar_Absyn_Util.mk_conj t1 t2)
in {code = _65_12348; environment = _30_728.environment; stack = _30_728.stack; close = _30_728.close; steps = _30_728.steps}))
in (sn tcenv _65_12349))
end
| false -> begin
...
in (let _65_12351 = (let _30_732 = config
in (let _65_12350 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta (Microsoft_FStar_Absyn_Syntax.Meta_slack_formula ((c1.code, c2.code, flag))))
in {code = _65_12350; environment = _30_732.environment; stack = _30_732.stack; close = _30_732.close; steps = _30_732.steps}))
in (rebuild _65_12351))))
end)
end
...
(let _65_12356 = (let _65_12355 = (let _65_12352 = (Microsoft_FStar_Tc_Env.get_range tcenv)
in (Support.Prims.pipe_right _65_12352 Support.Microsoft.FStar.Range.string_of_range))
in (let _65_12354 = (Microsoft_FStar_Absyn_Print.tag_of_typ config.code)
in (let _65_12353 = (Microsoft_FStar_Absyn_Print.typ_to_string config.code)
in (Support.Microsoft.FStar.Util.format3 "(%s) Unexpected type (%s): %s" _65_12355 _65_12354 _65_12353))))
in (failwith (_65_12356)))
end)
end))))))
...
in (let b = (let _65_12367 = (Microsoft_FStar_Absyn_Util.freshen_bvd a.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _65_12367 c.code))
...
in (let y = (let _65_12368 = (Microsoft_FStar_Absyn_Util.freshen_bvd x.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _65_12368 c.code))
...
in (let _30_776 = cfg
in (let _65_12371 = (Microsoft_FStar_Absyn_Syntax.mk_Comp ctconf.code)
in {code = _65_12371; environment = _30_776.environment; stack = _30_776.stack; close = _30_776.close; steps = _30_776.steps})))
end
| Microsoft_FStar_Absyn_Syntax.Total (t) -> begin
(match ((Support.List.contains DeltaComp cfg.steps)) with
| true -> begin
(let _65_12375 = (let _65_12374 = (let _65_12373 = (let _65_12372 = (Microsoft_FStar_Absyn_Syntax.mk_Total t)
in (Microsoft_FStar_Absyn_Util.comp_to_comp_typ _65_12372))
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.mk_Comp _65_12373))
in (with_new_code cfg _65_12374))
in (Support.Prims.pipe_left (sncomp tcenv) _65_12375))
end
| false -> begin
(let t = (sn tcenv (with_new_code cfg t))
in (let _65_12376 = (Microsoft_FStar_Absyn_Syntax.mk_Total t.code)
in (with_new_code cfg _65_12376)))
end)
end)))
...
in (let res = (let _65_12389 = (sn tcenv (with_new_code cfg m.Microsoft_FStar_Absyn_Syntax.result_typ))
in _65_12389.code)
in (let sn_flags = (fun ( flags ) -> (Support.Prims.pipe_right flags (Support.List.map (fun ( _30_6 ) -> (match (_30_6) with
| Microsoft_FStar_Absyn_Syntax.DECREASES (e) -> begin
(let e = (let _65_12393 = (wne tcenv (e_config e cfg.environment cfg.steps))
in _65_12393.code)
...
in (let _30_804 = (let _65_12395 = (sn_flags m.Microsoft_FStar_Absyn_Syntax.flags)
in (let _65_12394 = (sn_args true tcenv cfg.environment cfg.steps m.Microsoft_FStar_Absyn_Syntax.effect_args)
in (_65_12395, _65_12394)))
...
| Some (_) -> begin
(let c = (let _65_12396 = (Microsoft_FStar_Absyn_Syntax.mk_Comp m)
in (weak_norm_comp tcenv _65_12396))
...
(let _65_12406 = (let _65_12405 = (let _65_12404 = (sn_delay tcenv (t_config t env steps))
in _65_12404.code)
in (Support.Prims.pipe_left (fun ( _65_12403 ) -> Support.Microsoft.FStar.Util.Inl (_65_12403)) _65_12405))
in (_65_12406, imp))
end
| (Support.Microsoft.FStar.Util.Inl (t), imp) -> begin
(let _65_12410 = (let _65_12409 = (let _65_12408 = (sn tcenv (t_config t env steps))
in _65_12408.code)
in (Support.Prims.pipe_left (fun ( _65_12407 ) -> Support.Microsoft.FStar.Util.Inl (_65_12407)) _65_12409))
in (_65_12410, imp))
end
| (Support.Microsoft.FStar.Util.Inr (e), imp) -> begin
(let _65_12414 = (let _65_12413 = (let _65_12412 = (wne tcenv (e_config e env steps))
in _65_12412.code)
in (Support.Prims.pipe_left (fun ( _65_12411 ) -> Support.Microsoft.FStar.Util.Inr (_65_12411)) _65_12413))
in (_65_12414, imp))
end)))))
and snk = (fun ( tcenv ) ( cfg ) -> (let w = (fun ( f ) -> (f cfg.code.Microsoft_FStar_Absyn_Syntax.pos))
in (match ((let _65_12424 = (Microsoft_FStar_Absyn_Util.compress_kind cfg.code)
in _65_12424.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let args = (let _65_12425 = (no_eta cfg.steps)
in (sn_args false tcenv cfg.environment _65_12425 args))
in (let _30_848 = cfg
in (let _65_12427 = (Support.Prims.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_uvar (uv, args)))
in {code = _65_12427; environment = _30_848.environment; stack = _30_848.stack; close = _30_848.close; steps = _30_848.steps})))
end
...
in (let _65_12429 = (let _30_871 = cfg
in (let _65_12428 = (Microsoft_FStar_Absyn_Util.subst_kind subst body)
in {code = _65_12428; environment = _30_871.environment; stack = _30_871.stack; close = _30_871.close; steps = _30_871.steps}))
in (snk tcenv _65_12429)))
end))
end
| Microsoft_FStar_Absyn_Syntax.Kind_abbrev ((_, k)) -> begin
...
| (bs, rhs) -> begin
(let _30_897 = cfg
in (let _65_12431 = (Support.Prims.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (bs, rhs)))
in {code = _65_12431; environment = _30_897.environment; stack = _30_897.stack; close = _30_897.close; steps = _30_897.steps}))
end)))
end))
end
| Microsoft_FStar_Absyn_Syntax.Kind_unknown -> begin
...
| ((Support.Microsoft.FStar.Util.Inl (t), imp), env) -> begin
(let _65_12440 = (let _65_12439 = (let _65_12438 = (sn tcenv (t_config t env s'))
in _65_12438.code)
in (Support.Prims.pipe_left (fun ( _65_12437 ) -> Support.Microsoft.FStar.Util.Inl (_65_12437)) _65_12439))
in (_65_12440, imp))
end
| ((Support.Microsoft.FStar.Util.Inr (v), imp), env) -> begin
(let _65_12444 = (let _65_12443 = (let _65_12442 = (wne tcenv (e_config v env s'))
in _65_12442.code)
in (Support.Prims.pipe_left (fun ( _65_12441 ) -> Support.Microsoft.FStar.Util.Inr (_65_12441)) _65_12443))
in (_65_12444, imp))
end))))
in (let _30_923 = config
in (let _65_12445 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app (config.code, args) None config.code.Microsoft_FStar_Absyn_Syntax.pos)
in {code = _65_12445; environment = _30_923.environment; stack = empty_stack; close = _30_923.close; steps = _30_923.steps}))))
end))
...
in (let c = (let _65_12457 = (let _30_991 = config
in (let _65_12456 = (no_eta config.steps)
in {code = body; environment = env; stack = (let _30_993 = config.stack
in {args = []}); close = _30_991.close; steps = _65_12456}))
in (wne tcenv _65_12457))
in (let _30_996 = c
in (let _65_12458 = (mk_abs c.code)
in {code = _65_12458; environment = _30_996.environment; stack = _30_996.stack; close = _30_996.close; steps = _30_996.steps}))))
end)))
end
| (formal::rest, actual::rest') -> begin
(let m = (match ((formal, actual)) with
...
| _ -> begin
(let _65_12463 = (let _65_12462 = (let _65_12459 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.argpos (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Range.string_of_range _65_12459))
in (let _65_12461 = (Microsoft_FStar_Absyn_Print.binder_to_string formal)
in (let _65_12460 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Print.arg_to_string (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: ill-typed redex\n formal is %s\nactual is %s\n" _65_12462 _65_12461 _65_12460))))
in (failwith (_65_12463)))
end)
...
(let _65_12468 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (_65_12468)::[])
end
| Microsoft_FStar_Absyn_Syntax.Pat_tvar (a) -> begin
(let _65_12469 = (Microsoft_FStar_Absyn_Syntax.t_binder a)
in (_65_12469)::[])
end
...
(let _65_12477 = (let _65_12476 = (Support.List.map norm_pat pats)
in Microsoft_FStar_Absyn_Syntax.Pat_disj (_65_12476))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12477 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_cons ((fv, q, pats)) -> begin
(let _65_12480 = (let _65_12479 = (let _65_12478 = (Support.List.map norm_pat pats)
in (fv, q, _65_12478))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_65_12479))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12480 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_var ((x, b)) -> begin
(let _65_12483 = (let _65_12482 = (let _65_12481 = (norm_bvvar x)
in (_65_12481, b))
in Microsoft_FStar_Absyn_Syntax.Pat_var (_65_12482))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12483 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_tvar (a) -> begin
(let _65_12485 = (let _65_12484 = (norm_btvar a)
in Microsoft_FStar_Absyn_Syntax.Pat_tvar (_65_12484))
...
(let _65_12487 = (let _65_12486 = (norm_bvvar x)
in Microsoft_FStar_Absyn_Syntax.Pat_wild (_65_12486))
in (Microsoft_FStar_Absyn_Util.withinfo _65_12487 None p.Microsoft_FStar_Absyn_Syntax.p))
end
| Microsoft_FStar_Absyn_Syntax.Pat_twild (a) -> begin
(let _65_12489 = (let _65_12488 = (norm_btvar a)
in Microsoft_FStar_Absyn_Syntax.Pat_twild (_65_12488))
...
in (let _65_12492 = (let _65_12491 = (let _65_12490 = (norm_bvvar x)
in (_65_12490, e.code))
in Microsoft_FStar_Absyn_Syntax.Pat_dot_term (_65_12491))
...
in (let _65_12495 = (let _65_12494 = (let _65_12493 = (norm_btvar a)
in (_65_12493, t.code))
in Microsoft_FStar_Absyn_Syntax.Pat_dot_typ (_65_12494))
...
in (let _65_12498 = (norm_pat pat)
in (_65_12498, w, c_body.code)))))))))))
end))
...
(let y = (let _65_12501 = (match (is_rec) with
| true -> begin
x
end
| false -> begin
...
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _65_12501 t.code))
in (let yexp = (Microsoft_FStar_Absyn_Util.bvar_to_exp y)
...
| (y, env) -> begin
(let _65_12503 = (let _65_12502 = (Microsoft_FStar_Absyn_Syntax.mk_lb (y, eff, t.code, c.code))
in (_65_12502)::lbs)
in (env, _65_12503))
end))))
...
| true -> begin
(let t = (sn tcenv (t_config t config.environment config.steps))
in (let _65_12505 = (let _30_1198 = config
in (let _65_12504 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed (c.code, t.code, l) None e.Microsoft_FStar_Absyn_Syntax.pos)
in {code = _65_12504; environment = _30_1198.environment; stack = _30_1198.stack; close = _30_1198.close; steps = _30_1198.steps}))
in (rebuild _65_12505)))
end
| false -> begin
c
end))
...
in (match ((is_stack_empty config)) with
| true -> begin
(let _65_12507 = (let _30_1208 = config
in (let _65_12506 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta (Microsoft_FStar_Absyn_Syntax.Meta_desugared ((c.code, info))))
in {code = _65_12506; environment = _30_1208.environment; stack = _30_1208.stack; close = _30_1208.close; steps = _30_1208.steps}))
in (rebuild _65_12507))
end
| false -> begin
c
end))
...
(let e = (let _65_12531 = (let _65_12530 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant Microsoft_FStar_Absyn_Syntax.Const_unit None r)
in (lbs, _65_12530))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_let _65_12531 None r))
...
(let _65_12536 = (eta_expand tcenv t)
in (Support.Prims.pipe_right _65_12536 Microsoft_FStar_Absyn_Util.compress_typ))
end
...
let exp_norm_to_string = (fun ( tcenv ) ( e ) -> (let _65_12559 = (norm_exp ((Beta)::(SNComp)::(Unmeta)::[]) tcenv e)
in (Microsoft_FStar_Absyn_Print.exp_to_string _65_12559)))

let typ_norm_to_string = (fun ( tcenv ) ( t ) -> (let _65_12564 = (norm_typ ((Beta)::(SNComp)::(Unmeta)::[]) tcenv t)
in (Microsoft_FStar_Absyn_Print.typ_to_string _65_12564)))

let kind_norm_to_string = (fun ( tcenv ) ( k ) -> (let _65_12569 = (norm_kind ((Beta)::(SNComp)::(Unmeta)::[]) tcenv k)
in (Microsoft_FStar_Absyn_Print.kind_to_string _65_12569)))

let formula_norm_to_string = (fun ( tcenv ) ( f ) -> (let _65_12574 = (norm_typ ((Beta)::(SNComp)::(Unmeta)::[]) tcenv f)
in (Microsoft_FStar_Absyn_Print.formula_to_string _65_12574)))

let comp_typ_norm_to_string = (fun ( tcenv ) ( c ) -> (let _65_12579 = (norm_comp ((Beta)::(SNComp)::(Unmeta)::[]) tcenv c)
in (Microsoft_FStar_Absyn_Print.comp_typ_to_string _65_12579)))
...
(let _65_12592 = (let _65_12591 = (let _65_12590 = (let _65_12589 = (let _65_12588 = (let _65_12587 = (let _65_12586 = (Microsoft_FStar_Absyn_Util.bvar_to_exp y)
in (x.Microsoft_FStar_Absyn_Syntax.v, _65_12586))
in Support.Microsoft.FStar.Util.Inr (_65_12587))
in (_65_12588)::[])
in (Microsoft_FStar_Absyn_Util.subst_typ _65_12589 phi))
in (Microsoft_FStar_Absyn_Util.mk_conj phi1 _65_12590))
in (y, _65_12591))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine _65_12592 (Some (Microsoft_FStar_Absyn_Syntax.ktype)) t0.Microsoft_FStar_Absyn_Syntax.pos))
end
| _ -> begin
t
end))
