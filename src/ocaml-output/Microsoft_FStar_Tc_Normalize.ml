...
in (a, _98_110))
in Support.Microsoft.FStar.Util.Inl (_98_111))
in (_98_112)::acc)
end
| V ((x, (v, env'))) -> begin
...
in (x, _98_114))
in Support.Microsoft.FStar.Util.Inr (_98_115))
in (_98_116)::acc)
end)) []))
...
in (Support.All.pipe_right _98_126 Microsoft_FStar_Absyn_Util.compress_kind))
...
in (Support.All.pipe_right _98_136 Support.Microsoft.FStar.Range.string_of_range))
in (let _98_137 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.format2 "%s: Impossible: Kind_unknown: %s" _98_138 _98_137)))
in (Support.All.failwith _98_139))
end))
in (aux t k))))
...
in (Support.All.pipe_right _98_146 Microsoft_FStar_Absyn_Util.compress_typ))
...
in _98_254.code)
in (Support.All.pipe_left (fun ( _98_253 ) -> Support.Microsoft.FStar.Util.Inl (_98_253)) _98_255))
in (_98_256, imp))
end
| ((Support.Microsoft.FStar.Util.Inr (v), imp), env) -> begin
(let _98_260 = (let _98_259 = (let _98_258 = (wne tcenv (e_config v env s'))
in _98_258.code)
in (Support.All.pipe_left (fun ( _98_257 ) -> Support.Microsoft.FStar.Util.Inr (_98_257)) _98_259))
in (_98_260, imp))
end))))
...
| ((Support.Microsoft.FStar.Util.Inl (a), _32_598), ((Support.Microsoft.FStar.Util.Inl (t), _32_603), env)) -> begin
T ((a.Microsoft_FStar_Absyn_Syntax.v, (t, env)))
end
| ((Support.Microsoft.FStar.Util.Inr (x), _32_611), ((Support.Microsoft.FStar.Util.Inr (v), _32_616), env)) -> begin
V ((x.Microsoft_FStar_Absyn_Syntax.v, (v, env)))
end
| _32_622 -> begin
(let _98_300 = (let _98_299 = (let _98_296 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.argpos (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Range.string_of_range _98_296))
in (let _98_298 = (Microsoft_FStar_Absyn_Print.binder_to_string formal)
in (let _98_297 = (Support.All.pipe_left Microsoft_FStar_Absyn_Print.arg_to_string (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: ill-typed redex\n formal is %s\nactual is %s\n" _98_299 _98_298 _98_297))))
in (Support.All.failwith _98_300))
end)
...
in (let _98_303 = (Support.All.pipe_left wk (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (binders, c2.code)))
...
| ((Support.Microsoft.FStar.Util.Inr (x), _32_650)::[], env) -> begin
...
| true -> begin
(let _98_316 = (Support.Microsoft.FStar.Range.string_of_range sfx)
...
| true -> begin
(let _98_317 = (Support.Microsoft.FStar.Range.string_of_range sfx)
...
in (Support.All.pipe_right _98_326 Support.Microsoft.FStar.Range.string_of_range))
...
in (Support.Microsoft.FStar.Util.format3 "(%s) Unexpected type (%s): %s" _98_329 _98_328 _98_327))))
in (Support.All.failwith _98_330))
end)
end)))))
...
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.mk_Comp _98_347))
in (with_new_code cfg _98_348))
in (Support.All.pipe_left (sncomp tcenv) _98_349))
end
| false -> begin
...
in _98_378.code)
in (Support.All.pipe_left (fun ( _98_377 ) -> Support.Microsoft.FStar.Util.Inl (_98_377)) _98_379))
in (_98_380, imp))
end
| (Support.Microsoft.FStar.Util.Inl (t), imp) -> begin
(let _98_384 = (let _98_383 = (let _98_382 = (sn tcenv (t_config t env steps))
in _98_382.code)
in (Support.All.pipe_left (fun ( _98_381 ) -> Support.Microsoft.FStar.Util.Inl (_98_381)) _98_383))
in (_98_384, imp))
end
| (Support.Microsoft.FStar.Util.Inr (e), imp) -> begin
(let _98_388 = (let _98_387 = (let _98_386 = (wne tcenv (e_config e env steps))
in _98_386.code)
in (Support.All.pipe_left (fun ( _98_385 ) -> Support.Microsoft.FStar.Util.Inr (_98_385)) _98_387))
in (_98_388, imp))
end)))))
...
in (let _32_844 = cfg
in (let _98_401 = (Support.All.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_uvar (uv, args)))
...
| (bs, rhs) -> begin
(let _32_893 = cfg
in (let _98_405 = (Support.All.pipe_left w (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (bs, rhs)))
...
in _98_412.code)
in (Support.All.pipe_left (fun ( _98_411 ) -> Support.Microsoft.FStar.Util.Inl (_98_411)) _98_413))
in (_98_414, imp))
end
| ((Support.Microsoft.FStar.Util.Inr (v), imp), env) -> begin
(let _98_418 = (let _98_417 = (let _98_416 = (wne tcenv (e_config v env s'))
in _98_416.code)
in (Support.All.pipe_left (fun ( _98_415 ) -> Support.Microsoft.FStar.Util.Inr (_98_415)) _98_417))
in (_98_418, imp))
end))))
...
| (formal::rest, actual::rest') -> begin
(let m = (match ((formal, actual)) with
| ((Support.Microsoft.FStar.Util.Inl (a), _32_1004), ((Support.Microsoft.FStar.Util.Inl (t), _32_1009), env)) -> begin
T ((a.Microsoft_FStar_Absyn_Syntax.v, (t, env)))
end
| ((Support.Microsoft.FStar.Util.Inr (x), _32_1017), ((Support.Microsoft.FStar.Util.Inr (v), _32_1022), env)) -> begin
V ((x.Microsoft_FStar_Absyn_Syntax.v, (v, env)))
end
| _32_1028 -> begin
(let _98_437 = (let _98_436 = (let _98_433 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.argpos (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Range.string_of_range _98_433))
in (let _98_435 = (Microsoft_FStar_Absyn_Print.binder_to_string formal)
in (let _98_434 = (Support.All.pipe_left Microsoft_FStar_Absyn_Print.arg_to_string (Support.Prims.fst actual))
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: ill-typed redex\n formal is %s\nactual is %s\n" _98_436 _98_435 _98_434))))
in (Support.All.failwith _98_437))
end)
...
(Support.List.collect (fun ( _32_1061 ) -> (match (_32_1061) with
| (x, _32_1060) -> begin
(pat_vars x)
end)) pats)
end
...
(let _98_452 = (let _98_451 = (Support.List.map norm_pat pats)
...
(let _98_457 = (let _98_456 = (let _98_455 = (Support.List.map (fun ( _32_1103 ) -> (match (_32_1103) with
| (x, i) -> begin
...
in (Support.All.pipe_right (let _32_1147 = config
...
(let _32_1179 = (Support.All.pipe_right lbs (Support.List.fold_left (fun ( _32_1157 ) ( _32_1162 ) -> (match ((_32_1157, _32_1162)) with
...
in (Support.All.pipe_right (let _32_1185 = config
...
in (Support.All.pipe_right _98_512 Microsoft_FStar_Absyn_Util.compress_typ))
end
...
in Support.Microsoft.FStar.Util.Inr (_98_563))
in (_98_564)::[])
