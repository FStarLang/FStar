                   ...
                   (FStar_Util.print_string
                    ...
                    FStar_List.iter
                      (fun gd  ->
                         ...
                         FStar_Util.print_string uu____1972) goal_deps2)
                 else ());
                (let goal_deps3 =
                   let uu____1979 = topological_sort goal_deps2  in
                    ...
                    (FStar_Util.print_string
                     ...
                     FStar_List.iter
                       (fun gd  ->
                          ...
                          FStar_Util.print_string uu____2004) goal_deps3)
                  else ());
