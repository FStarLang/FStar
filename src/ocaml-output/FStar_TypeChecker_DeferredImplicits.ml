           ...
           | (reason,prob) ->
               (match prob with
                | FStar_TypeChecker_Common.TProb tp when
                    ...
                    ->
                    let uu___2 = FStar_TypeChecker_Env.clear_expected_typ env
                       in
                    (match uu___2 with
                     | (env1,uu___3) ->
                         let env2 =
                          ...
                          | (uu___5,t_eq,uu___6) ->
                              ...
                              (match uu___7 with
                               | (goal,ctx_uvar,uu___8) ->
                                   let imp =
                                     let uu___9 =
                                       let uu___10 = FStar_List.hd ctx_uvar
                                          in
                                       FStar_Pervasives_Native.fst uu___10
                                        in
                                     {
                                   ...
                                   (match sigelt with
                                    ...
                                    | FStar_Pervasives_Native.Some se ->
                                        (imp, se)))))
                | uu___2 -> failwith "Unexpected problem deferred to tactic")
            in
         let eqs =
         ...
         | (more,imps) ->
             let bucketize is =
                    ...
                    | (i,s) ->
                        ...
                        (match uu___4 with
                         ...
                         | FStar_Pervasives_Native.Some l ->
                             ...
                             let uu___5 = FStar_Util.smap_try_find map lstr
                                in
                             (match uu___5 with
                              | FStar_Pervasives_Native.None  ->
               ...
               FStar_Util.smap_fold map
                 (fun uu___3  -> fun is1  -> fun out  -> is1 :: out) []
                in
