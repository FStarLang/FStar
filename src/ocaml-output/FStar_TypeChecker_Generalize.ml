           ...
           | (univs, uvs, lec_hd) ->
               ...
               let force_uvars_eq lec2 u1 u2 =
                 let uvars_subseteq u11 u21 =
                   FStar_Compiler_Effect.pipe_right u11
                     (FStar_Compiler_Util.for_all
                        (fun u ->
                           FStar_Compiler_Effect.pipe_right u21
               ...
               let ecs =
                 FStar_Compiler_Effect.pipe_right lecs2
                   (FStar_Compiler_List.map
                      (fun uu___3 ->
                         match uu___3 with
                         | (lbname, e, c) ->
        ...
        (let univnames_lecs =
         ...
         let generalized_lecs =
           ...
           | FStar_Pervasives_Native.None ->
               FStar_Compiler_Effect.pipe_right lecs
                 (FStar_Compiler_List.map
                    (fun uu___3 ->
           ...
           | FStar_Pervasives_Native.Some luecs ->
               ((let uu___4 =
                 ...
                 if uu___4
                 then
                   FStar_Compiler_Effect.pipe_right luecs
