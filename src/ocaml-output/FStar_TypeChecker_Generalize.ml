      ...
      FStar_All.pipe_right uu___1
        (FStar_List.map
           (fun u  ->
              ...
              FStar_All.pipe_right uu___2 FStar_Util.string_of_int))
       in
              ...
              (FStar_List.map
                 (fun u  ->
                    ...
                    (let uu___4 =
                     ...
                     then
                       let uu___5 =
                         let uu___6 = FStar_Syntax_Unionfind.univ_uvar_id u
                            in
                         FStar_All.pipe_left FStar_Util.string_of_int uu___6
                          in
                       let uu___6 =
          ...
          (let norm c =
           ...
           let univs_and_uvars_of_lec uu___2 =
             ...
             | (lbname,e,c) ->
                           ...
                           (FStar_List.map
                              (fun u  ->
                                 FStar_Syntax_Print.univ_to_string
                                   (FStar_Syntax_Syntax.U_unif u)))
                          in
                       FStar_All.pipe_right uu___6 (FStar_String.concat ", ")
                        in
                     let uu___6 =
                       let uu___7 =
                           ...
                           (FStar_List.map
                              (fun u  ->
                                 ...
                                 FStar_Util.format2 "(%s : %s)" uu___9
                                   uu___10))
                          in
                       FStar_All.pipe_right uu___7 (FStar_String.concat ", ")
                        in
                     FStar_Util.print2
                       "^^^^\n\tFree univs = %s\n\tFree uvt=%s\n" uu___5
                       uu___6
                          ...
                          fun uv  ->
                            let uu___5 =
                              FStar_Syntax_Free.univs
                               ...
                               in
                            FStar_Util.set_union univs2 uu___5) univs uu___4
                      in
              ...
              in
           let uu___2 =
             let uu___3 = FStar_List.hd lecs  in
               ...
               let gen_types uvs1 =
                 let fail rng k =
                   ...
                   | (lbname,e,c) ->
                       let uu___4 =
                         let uu___5 =
                           let uu___6 = FStar_Syntax_Print.term_to_string k
                              in
                           let uu___7 =
                         ...
                         | uu___4 ->
                             let k =
                               FStar_TypeChecker_Normalize.normalize
                                 ...
                                 u.FStar_Syntax_Syntax.ctx_uvar_typ
                                in
                             let uu___5 = FStar_Syntax_Util.arrow_formals k
                                in
                             (match uu___5 with
                              | (bs,kres) ->
                                  ((let uu___7 =
                                        ...
                                        FStar_All.pipe_left
                                          (fun uu___9  ->
                                             FStar_Pervasives_Native.Some
                                               uu___9) uu___8
                                         in
                                      FStar_Syntax_Syntax.new_bv uu___7 kres
                                       in
                                    let t =
                                      match bs with
                                      | [] ->
