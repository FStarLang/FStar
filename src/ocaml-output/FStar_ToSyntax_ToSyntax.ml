        ...
        (let push_bv_maybe_mut =
         ...
         let aux_maybe_or env1 p1 =
           ...
           | FStar_Parser_AST.PatOr (p2::ps) ->
               let uu____2616 = aux loc env1 p2  in
               (match uu____2616 with
                | (loc1,env2,var,p3,uu____2634) ->
                    let uu____2639 =
                      FStar_List.fold_left
                        (fun uu____2652  ->
                           fun p4  ->
                             ...
                             | (loc2,env3,ps1) ->
                                 let uu____2675 = aux loc2 env3 p4  in
                                 (match uu____2675 with
                                  | (loc3,env4,uu____2691,p5,uu____2693) ->
                                      (loc3, env4, (p5 :: ps1))))
                        (loc1, env2, []) ps
                       in
      ...
      fun p  ->
        fun is_mut  ->
          let mklet x =
            let uu____2809 =
              let uu____2810 =
                let uu____2813 = FStar_ToSyntax_Env.qualify env x  in
                (uu____2813, FStar_Syntax_Syntax.tun)  in
              LetBinder uu____2810  in
            (env, uu____2809, [])  in
          if top
          then
            match p.FStar_Parser_AST.pat with
                  ...
                  let uu____2825 =
                    let uu____2828 =
                      FStar_Parser_AST.compile_op (Prims.parse_int "0")
                        x.FStar_Ident.idText
                       in
                    (uu____2828, (x.FStar_Ident.idRange))  in
                  FStar_Ident.mk_ident uu____2825  in
                mklet uu____2824
            | FStar_Parser_AST.PatVar (x,uu____2830) -> mklet x
            | FStar_Parser_AST.PatAscribed
                ({
                   FStar_Parser_AST.pat = FStar_Parser_AST.PatVar
                     (x,uu____2834);
                   FStar_Parser_AST.prange = uu____2835;_},t)
                ->
                let uu____2839 =
                  let uu____2840 =
                    let uu____2843 = FStar_ToSyntax_Env.qualify env x  in
                    let uu____2844 = desugar_term env t  in
                    (uu____2843, uu____2844)  in
                  LetBinder uu____2840  in
                (env, uu____2839, [])
            | uu____2846 ->
                raise
                  (FStar_Errors.Error
            ...
            (let uu____2852 = desugar_data_pat env p is_mut  in
                 ...
                 let p2 =
                   ...
                   | {
                       FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var
                         uu____2869;
                       FStar_Syntax_Syntax.ty = uu____2870;
                       FStar_Syntax_Syntax.p = uu____2871;_}::[] -> []
                   | {
...
and desugar_match_pat_maybe_top :
  ...
  fun uu____2888  ->
    fun env  ->
      fun pat  ->
        let uu____2891 = desugar_data_pat env pat false  in
        match uu____2891 with | (env1,uu____2900,pat1) -> (env1, pat1)
    ...
    fun repr  ->
      fun uu____2915  ->
        fun range  ->
          ...
          | (signedness,width) ->
              let uu____2923 = FStar_Const.bounds signedness width  in
              (match uu____2923 with
               | (lower,upper) ->
                   let value =
                     let uu____2931 = FStar_Util.ensure_decimal repr  in
                     FStar_Util.int_of_string uu____2931  in
                   let tnm =
                     Prims.strcat "FStar."
                       (Prims.strcat
                            ...
                            | FStar_Syntax_Syntax.Tm_fvar fv ->
                                ...
                                let private_fv =
                                  ...
                                  FStar_Syntax_Syntax.lid_as_fv private_lid
                                    uu____2961 fv.FStar_Syntax_Syntax.fv_qual
                                   in
    ...
    fun env  ->
      fun top  ->
              ...
              FStar_All.pipe_right uu____3193
                (FStar_List.map
                   (fun t  ->
                      ...
                      FStar_Syntax_Syntax.as_arg uu____3199))
               in
            let uu____3200 =
              let uu____3203 =
                FStar_Syntax_Util.mk_tuple_lid (FStar_List.length targs)
                 ...
                 in
              FStar_ToSyntax_Env.fail_or env
                (FStar_ToSyntax_Env.try_lookup_lid env) uu____3203
               in
        ...
        | FStar_Parser_AST.Projector (l,i) ->
            (FStar_ToSyntax_Env.fail_if_qualified_by_curmodule env l;
             (let name =
                let uu____3325 = FStar_ToSyntax_Env.try_lookup_datacon env l
                   in
                match uu____3325 with
                | Some uu____3330 -> Some (true, l)
                | None  ->
                    let uu____3333 =
        ...
        | FStar_Parser_AST.Discrim lid ->
            (FStar_ToSyntax_Env.fail_if_qualified_by_curmodule env lid;
             (let uu____3361 = FStar_ToSyntax_Env.try_lookup_datacon env lid
                 in
        ...
        | FStar_Parser_AST.Construct (l,args) ->
            (FStar_ToSyntax_Env.fail_if_qualified_by_curmodule env l;
             (let uu____3380 = FStar_ToSyntax_Env.try_lookup_datacon env l
                 in
              match uu____3380 with
              | Some head1 ->
                  let uu____3383 =
                    let uu____3388 = mk1 (FStar_Syntax_Syntax.Tm_fvar head1)
                       in
                    (uu____3388, true)  in
                 ...
                 let uu____3615 =
                   let uu____3618 =
                     FStar_Syntax_Util.mk_dtuple_lid
                      ...
                      in
                   FStar_ToSyntax_Env.fail_or env1
                     (FStar_ToSyntax_Env.try_lookup_lid env1) uu____3618
                    in
        ...
        | FStar_Parser_AST.Refine (b,f) ->
            ...
            (match uu____3693 with
             | (None ,uu____3697) -> failwith "Missing binder in refinement"
             | b1 ->
                 let uu____3703 = as_binder env None b1  in
                     ...
                     | (env1,ftvs) ->
                         (match pat.FStar_Parser_AST.pat with
                          | FStar_Parser_AST.PatAscribed (uu____3749,t) ->
                              ...
                              (env1, uu____3751)
                          | uu____3756 -> (env1, ftvs))) (env, []) binders1
               in
        ...
        | FStar_Parser_AST.App
            ...
            let rec aux universes e =
              let uu____4220 =
                let uu____4221 = unparen e  in uu____4221.FStar_Parser_AST.tm
                 in
        ...
        | FStar_Parser_AST.App uu____4230 ->
            let rec aux args e =
              let uu____4251 =
                let uu____4252 = unparen e  in uu____4252.FStar_Parser_AST.tm
                 in
        ...
        | FStar_Parser_AST.Let (qual1,(pat,_snd)::_tl,body) ->
            ...
            let ds_let_rec_or_app uu____4338 =
              ...
              | (env',fnames,rec_bindings) ->
                        ...
                        let def1 =
                          ...
                          | Some t ->
                              ...
                              FStar_Parser_AST.mk_term
                                ...
                                uu____4839 FStar_Parser_AST.Expr
                           in
                        let def2 =
                          match args1 with
                          | [] -> def1
                  ...
                  FStar_All.pipe_left mk1 uu____4873
               in
                    ...
                    | LocalBinder (x,uu____4938) ->
                        ...
                        let body2 =
                          ...
                          | uu____4948 ->
                              ...
                              uu____4950 None body1.FStar_Syntax_Syntax.pos
                           in
                        let uu____4984 =
                          let uu____4985 =
                            let uu____4993 =
                        ...
                        FStar_All.pipe_left mk1 uu____4984
                     in
                  if is_mutable
                  then
                    FStar_All.pipe_left mk1
        ...
        | FStar_Parser_AST.Match (e,branches) ->
            ...
            let uu____5231 =
              let uu____5232 =
                ...
                let uu____5249 = FStar_List.collect desugar_branch branches
                   in
        ...
        | FStar_Parser_AST.Ascribed (e,t,tac_opt) ->
            let annot =
              ...
              if uu____5268
              then
                let uu____5273 = desugar_comp t.FStar_Parser_AST.range env t
                   in
                FStar_Util.Inr uu____5273
              else
                (let uu____5279 = desugar_term env t  in
                 FStar_Util.Inl uu____5279)
               in
            let tac_opt1 = FStar_Util.map_opt tac_opt (desugar_term env)  in
            let uu____5284 =
              let uu____5285 =
                let uu____5303 = desugar_term env e  in
                (uu____5303, (annot, tac_opt1), None)  in
                      ...
                      FStar_All.pipe_right record.FStar_ToSyntax_Env.fields
                        (FStar_List.map
                           (fun uu____5417  ->
                              ...
                              | (f,uu____5423) ->
                                  let uu____5424 =
                                    let uu____5425 = get_field None f  in
                                    FStar_All.pipe_left FStar_Pervasives.snd
                                      uu____5425
                                     in
                                  (uu____5424, FStar_Parser_AST.Nothing)))
                       in
                        ...
                        FStar_All.pipe_right record.FStar_ToSyntax_Env.fields
                          (FStar_List.map
                             (fun uu____5460  ->
                                ...
                                | (f,uu____5466) -> get_field (Some xterm) f))
                         in
                      (None, uu____5446)  in
                     ...
                     let uu____5511 =
                       let uu____5521 =
                         ...
                         FStar_Syntax_Syntax.fvar
                           ...
                           FStar_Syntax_Syntax.Delta_constant uu____5522
                          in
                       (uu____5521, args)  in
    ...
    fun env  ->
      fun t  ->
        ...
        let is_requires uu____5662 =
          ...
          | (t1,uu____5666) ->
              let uu____5667 =
                let uu____5668 = unparen t1  in
                uu____5668.FStar_Parser_AST.tm  in
        ...
        let is_ensures uu____5679 =
          ...
          | (t1,uu____5683) ->
              let uu____5684 =
                let uu____5685 = unparen t1  in
                uu____5685.FStar_Parser_AST.tm  in
        ...
        let is_app head1 uu____5699 =
          ...
          | (t1,uu____5703) ->
              let uu____5704 =
                let uu____5705 = unparen t1  in
                uu____5705.FStar_Parser_AST.tm  in
        ...
        let is_smt_pat uu____5717 =
          ...
          | (t1,uu____5721) ->
              let uu____5722 =
                let uu____5723 = unparen t1  in
                uu____5723.FStar_Parser_AST.tm  in
          ...
          | (head1,args) ->
              (match head1.FStar_Parser_AST.tm with
               ...
               | FStar_Parser_AST.Name l when
                   ...
                   (uu____5984, args)
               | FStar_Parser_AST.Name l when
                   (let uu____5998 = FStar_ToSyntax_Env.current_module env
                       in
               ...
               | FStar_Parser_AST.Name l when
                   (let uu____6007 = FStar_ToSyntax_Env.current_module env
                       in
          ...
          (fun uu____6853  ->
             fun b  ->
               ...
               | (env1,out) ->
                   ...
                   (match tk with
                    | (Some a,k) ->
                        let uu____6891 = FStar_ToSyntax_Env.push_bv env1 a
                           in
  ...
  fun env  ->
    fun b  ->
      ...
      | FStar_Parser_AST.TAnnotated (x,t) ->
          let uu____6962 = desugar_typ env t  in ((Some x), uu____6962)
      | FStar_Parser_AST.Annotated (x,t) ->
          let uu____6966 = desugar_typ env t  in ((Some x), uu____6966)
      | FStar_Parser_AST.TVariable x ->
          let uu____6969 =
            (FStar_Syntax_Syntax.mk
          ...
          ((Some x), uu____6969)
      | FStar_Parser_AST.NoName t ->
          let uu____6984 = desugar_typ env t  in (None, uu____6984)
                           ...
                           | uu____7823 ->
                               let uu____7824 =
                                 let uu____7827 =
                                   ...
                                   FStar_Syntax_Syntax.Tm_arrow uu____7828
                                    in
                                 FStar_Syntax_Syntax.mk uu____7827  in
                               uu____7824 None se.FStar_Syntax_Syntax.sigrng
                            in
                              ...
                              let uu____8294 =
                                let uu____8296 =
                                  let uu____8297 =
                                    ...
                                    (uu____8302, fs)  in
                                  FStar_Syntax_Syntax.RecordType uu____8297
                                   in
                                  ...
                                  | (env_tps,tps) ->
                                      ...
                                      (match uu____9091 with
                                       | (constrNames,constrs1) ->
                                           ...
                                           :: constrs1))
                             | uu____9360 -> failwith "impossible"))
                      in
                   let name_docs =
                     FStar_All.pipe_right docs_tps_sigelts
                       (FStar_List.map
                          (fun uu____9425  ->
                             ...
                             | (name_doc,uu____9440,uu____9441) -> name_doc))
                      in
                   let sigelts =
                     FStar_All.pipe_right docs_tps_sigelts
                       (FStar_List.map
                                     ...
                                     FStar_Util.for_some
                                       (fun uu___220_10057  ->
                                          ...
                                          | FStar_Syntax_Syntax.Reflectable
                                              uu____10058 -> true
                                          | uu____10059 -> false) qualifiers
                                      in
                                   let un_ts = ([], FStar_Syntax_Syntax.tun)
                                      in
                                   let uu____10065 =
                                     let uu____10066 =
                                       let uu____10067 = lookup "return_wp"
                                          in
                                       let uu____10068 = lookup "bind_wp"  in
                                       let uu____10069 =
                                         lookup "if_then_else"  in
                                       let uu____10070 = lookup "ite_wp"  in
                                       let uu____10071 = lookup "stronger"
                                          in
                                       let uu____10072 = lookup "close_wp"
                                          in
                                       let uu____10073 = lookup "assert_p"
                                          in
                                       let uu____10074 = lookup "assume_p"
                                          in
                      ...
                      | (head1,args) ->
                                      ...
                                      let uu____10190 =
                                        let uu____10191 =
                                          FStar_Parser_AST.term_to_string
                                            head1
                                           in
                                        Prims.strcat uu____10191 " not found"
                                         in
                          ...
                          (match uu____10193 with
                           | (cattributes,args1) ->
                               ...
                               (lid, ed, uu____10264, uu____10269))
                       in
    ...
    fun d  ->
      ...
      | FStar_Parser_AST.Tycon (is_effect,tcs) ->
          ...
          let tcs1 =
            FStar_List.map
              (fun uu____10486  ->
                 match uu____10486 with | (x,uu____10491) -> x) tcs
             in
            ...
            (let uu____10679 =
             ...
             | (pat,body) ->
                 ...
                 let bvs =
                   ...
                   FStar_All.pipe_right uu____10783 FStar_Util.set_elements
                    in
      ...
      | FStar_Parser_AST.Val (id,t) ->
          let quals = d.FStar_Parser_AST.quals  in
          let t1 =
            let uu____10804 = close_fun env t  in
            desugar_term env uu____10804  in
          let quals1 =
            let uu____10807 =
              ...
              let uu____10864 =
                let uu____10865 =
                  FStar_ToSyntax_Env.fail_or env
                   ...
                   in
                fst uu____10865  in
              FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total uu____10864
               in
...
let desugar_modul :
  ...
  fun env  ->
    fun m  ->
      let uu____11248 = desugar_modul_common None env m  in
