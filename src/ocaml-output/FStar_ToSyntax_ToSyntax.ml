...
let uu___238_2693 = x
in {FStar_Syntax_Syntax.ppname = uu___238_2693.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___238_2693.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})), (aq)));
))
end)
...
in {FStar_Syntax_Syntax.fv_name = uu___239_3790.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = uu___239_3790.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu____3791}))
in ((uu____3789), (args1)))
...
let uu___240_4368 = intro_term
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (private_fv); FStar_Syntax_Syntax.pos = uu___240_4368.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___240_4368.FStar_Syntax_Syntax.vars})))
end
| uu____4369 -> begin
...
let uu___241_4546 = e
in {FStar_Syntax_Syntax.n = uu___241_4546.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = top.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___241_4546.FStar_Syntax_Syntax.vars}))
in (
...
in {FStar_Parser_AST.tm = uu____4755; FStar_Parser_AST.range = uu___243_4754.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___243_4754.FStar_Parser_AST.level}))
in ((uu____4753), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4746))
in {FStar_Parser_AST.tm = uu____4745; FStar_Parser_AST.range = uu___242_4744.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___242_4744.FStar_Parser_AST.level}))
...
in {FStar_Parser_AST.tm = uu____4786; FStar_Parser_AST.range = uu___245_4785.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___245_4785.FStar_Parser_AST.level}))
in ((uu____4784), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4777))
in {FStar_Parser_AST.tm = uu____4776; FStar_Parser_AST.range = uu___244_4775.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___244_4775.FStar_Parser_AST.level}))
...
in {FStar_Parser_AST.tm = uu____4817; FStar_Parser_AST.range = uu___247_4816.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___247_4816.FStar_Parser_AST.level}))
in ((uu____4815), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4808))
in {FStar_Parser_AST.tm = uu____4807; FStar_Parser_AST.range = uu___246_4806.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___246_4806.FStar_Parser_AST.level}))
...
let uu___248_5365 = x
in {FStar_Syntax_Syntax.ppname = uu___248_5365.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___248_5365.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})), (FStar_Pervasives_Native.None)))::[]))), (uu____5332)))
end))
end))
...
let rec aux = (fun env1 bs1 uu___219_5465 -> (match (uu___219_5465) with
| [] -> begin
(
...
let rec aux = (fun env1 bs sc_pat_opt uu___220_5680 -> (match (uu___220_5680) with
| [] -> begin
(
...
let uu___249_10195 = t
in {FStar_Syntax_Syntax.n = uu___249_10195.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = f.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___249_10195.FStar_Syntax_Syntax.vars}))
in (
...
let uu___250_10229 = b
in {FStar_Parser_AST.b = uu___250_10229.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___250_10229.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___250_10229.FStar_Parser_AST.aqual}))
in (
...
let uu___251_10311 = a1
in {FStar_Syntax_Syntax.ppname = uu___251_10311.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___251_10311.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
in (
...
let uu___252_10697 = b
in {FStar_Parser_AST.b = uu___252_10697.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___252_10697.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___252_10697.FStar_Parser_AST.aqual}))
in (match (tk) with
| (FStar_Pervasives_Native.Some (a), k) -> begin
(
...
let uu___253_10734 = a1
in {FStar_Syntax_Syntax.ppname = uu___253_10734.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___253_10734.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
...
let quals1 = (FStar_All.pipe_right quals (FStar_List.filter (fun uu___221_10891 -> (match (uu___221_10891) with
...
let uu____11023 = (FStar_List.filter (fun uu___222_11027 -> (match (uu___222_11027) with
| FStar_Syntax_Syntax.Abstract -> begin
false
end
| uu____11028 -> begin
...
let iquals1 = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___223_11041 -> (match (uu___223_11041) with
| FStar_Syntax_Syntax.Abstract -> begin
true
end
| FStar_Syntax_Syntax.Private -> begin
...
let filter_records = (fun uu___224_11181 -> (match (uu___224_11181) with
...
let tycon_id = (fun uu___225_11382 -> (match (uu___225_11382) with
...
let tycon_record_as_variant = (fun uu___226_11537 -> (match (uu___226_11537) with
...
let desugar_abstract_tc = (fun quals1 _env mutuals uu___227_11737 -> (match (uu___227_11737) with
...
let uu___254_12188 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), ([]), (t))); FStar_Syntax_Syntax.sigrng = uu___254_12188.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals2; FStar_Syntax_Syntax.sigmeta = uu___254_12188.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___254_12188.FStar_Syntax_Syntax.sigattrs}))))
end
| uu____12191 -> begin
(failwith "Impossible")
end)
...
let uu____12245 = (FStar_Util.for_some (fun uu___228_12247 -> (match (uu___228_12247) with
...
let uu____12255 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___229_12259 -> (match (uu___229_12259) with
...
let quals2 = (FStar_All.pipe_right quals1 (FStar_List.filter (fun uu___230_12453 -> (match (uu___230_12453) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| uu____12454 -> begin
...
let docs_tps_sigelts = (FStar_All.pipe_right tcs2 (FStar_List.collect (fun uu___232_14052 -> (match (uu___232_14052) with
...
let quals2 = (FStar_All.pipe_right tname_quals (FStar_List.collect (fun uu___231_14747 -> (match (uu___231_14747) with
...
let rr = (FStar_Util.for_some (fun uu___233_16271 -> (match (uu___233_16271) with
...
let uu___255_17012 = sigelt
in {FStar_Syntax_Syntax.sigel = uu___255_17012.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___255_17012.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___255_17012.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___255_17012.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = attrs2})) sigelts)
in ((env1), (uu____17006))))))
end)))
...
| uu____17251 -> begin
(FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) (FStar_List.collect (fun uu___234_17264 -> (match (uu___234_17264) with
...
let uu___256_17346 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inr ((

let uu___257_17348 = fv
in {FStar_Syntax_Syntax.fv_name = uu___257_17348.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_abstract (fv.FStar_Syntax_Syntax.fv_delta); FStar_Syntax_Syntax.fv_qual = uu___257_17348.FStar_Syntax_Syntax.fv_qual})); FStar_Syntax_Syntax.lbunivs = uu___256_17346.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___256_17346.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___256_17346.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___256_17346.FStar_Syntax_Syntax.lbdef})))))
...
let uu___258_17429 = pat1
in {FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed (((var_pat), (ty))); FStar_Parser_AST.prange = uu___258_17429.FStar_Parser_AST.prange})
end
| uu____17430 -> begin
var_pat
end))
...
let uu___259_17437 = d
in {FStar_Parser_AST.d = FStar_Parser_AST.TopLevelLet (((isrec), ((((fresh_pat), (body)))::[]))); FStar_Parser_AST.drange = uu___259_17437.FStar_Parser_AST.drange; FStar_Parser_AST.doc = uu___259_17437.FStar_Parser_AST.doc; FStar_Parser_AST.quals = (FStar_Parser_AST.Private)::d.FStar_Parser_AST.quals; FStar_Parser_AST.attrs = uu___259_17437.FStar_Parser_AST.attrs}))
in (
...
let rec forward = (fun acc uu___236_18090 -> (match (uu___236_18090) with
...
let uu___260_18122 = se2
in (

let uu____18123 = (

let uu____18126 = (FStar_List.filter (fun uu___235_18140 -> (match (uu___235_18140) with
...
in {FStar_Syntax_Syntax.sigel = uu___260_18122.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___260_18122.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___260_18122.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___260_18122.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu____18123}))
