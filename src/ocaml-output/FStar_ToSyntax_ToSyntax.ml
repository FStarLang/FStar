                   ...
                   (match uu___2 with
                    | (field_names, pats) ->
                        ...
                        let candidate_constructor =
                          ...
                          let lid =
                            FStar_Ident.set_lid_range name
                              p1.FStar_Parser_AST.prange in
                          let uu___3 =
                            let uu___4 =
                              let uu___5 =
                                  ...
                                  qualify_field_names record field_names in
                                {
                                  ...
                                  FStar_Syntax_Syntax.uc_fields = uu___6
                                } in
                              FStar_Syntax_Syntax.Unresolved_constructor
                                uu___5 in
                            FStar_Pervasives_Native.Some uu___4 in
                          FStar_Syntax_Syntax.lid_as_fv lid
                            FStar_Syntax_Syntax.delta_constant uu___3 in
                        let uu___3 =
                          FStar_Compiler_List.fold_left
                            (fun uu___4 ->
                               fun p2 ->
                                 match uu___4 with
                                 | (loc1, env2, annots, pats1) ->
                                     let uu___5 = aux loc1 env2 p2 in
                                     (match uu___5 with
                                      | (loc2, env3, uu___6, pat, ann) ->
                                          (loc2, env3,
                        ...
                        (match uu___3 with
                         | (loc1, env2, annots, pats1) ->
                             ...
                             let x =
                               let uu___4 = tun_r p1.FStar_Parser_AST.prange in
                               FStar_Syntax_Syntax.new_bv
                                 (FStar_Pervasives_Native.Some
                                    (p1.FStar_Parser_AST.prange)) uu___4 in
                             (loc1, env2,
                               (LocalBinder
      ...
      fun top ->
                               ...
                               let uu___6 =
                                 let uu___7 =
                                     ...
                                     qualify_field_names record field_names in
                                   {
                                     ...
                                     FStar_Syntax_Syntax.uc_typename =
                                       (record.FStar_Syntax_DsEnv.typename);
                                     FStar_Syntax_Syntax.uc_fields = uu___8
                                   } in
                                 FStar_Syntax_Syntax.Unresolved_constructor
                                   uu___7 in
                               FStar_Pervasives_Native.Some uu___6 in
                             FStar_Syntax_Syntax.fvar candidate_constructor
                               FStar_Syntax_Syntax.delta_constant uu___5 in
                           let mk_result args1 =
             ...
             | (env', bs1) ->
                 ...
                 let mk_exists_intro t p2 v e2 =
                   ...
                   let args =
                     ...
                     (e2, FStar_Pervasives_Native.None)] in
                   FStar_Syntax_Syntax.mk_Tm_app head args
                     top.FStar_Parser_AST.range in
        ...
        | FStar_Parser_AST.IntroOr (lr, p, q, e) ->
            ...
            let args =
              ...
              (q1, FStar_Pervasives_Native.None);
              (e1, FStar_Pervasives_Native.None)] in
            let uu___1 =
              FStar_Syntax_Syntax.mk_Tm_app head args
                top.FStar_Parser_AST.range in
            (uu___1, noaqs)
        | FStar_Parser_AST.IntroAnd (p, q, e1, e2) ->
            ...
            let args =
              [(p1, FStar_Pervasives_Native.None);
              (q1, FStar_Pervasives_Native.None);
              (e11, FStar_Pervasives_Native.None);
                   ...
                   let uu___2 =
                     let uu___3 =
                       let uu___4 =
                         ...
                         (FStar_Syntax_Util.exp_unit,
                           FStar_Pervasives_Native.None) :: uu___5 in
                       (r1, FStar_Pervasives_Native.None) :: uu___4 in
                     (q1, FStar_Pervasives_Native.None) :: uu___3 in
                   (p1, FStar_Pervasives_Native.None) :: uu___2 in
                 let uu___2 =
                   FStar_Syntax_Syntax.mk_Tm_app head args
