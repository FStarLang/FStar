      ...
      fun uu___203_782  ->
        ...
        | (Some a,k) ->
            ...
            (match uu____795 with
             | (env1,a1) ->
                 (((let uu___224_806 = a1 in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___224_806.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___224_806.FStar_Syntax_Syntax.index);
                    ...
                    let binder1 =
                      ...
                      | LocalBinder (x,aq) ->
                          ...
                          (if
                           ...
                           LocalBinder
                             (((let uu___225_1771 = x in
                                {
                                  FStar_Syntax_Syntax.ppname =
                                    (uu___225_1771.FStar_Syntax_Syntax.ppname);
                                  FStar_Syntax_Syntax.index =
                                    (uu___225_1771.FStar_Syntax_Syntax.index);
                              ...
                              let uu____2462 =
                                  ...
                                  Some uu____2466 in
                                {
                                  FStar_Syntax_Syntax.fv_name =
                                    (uu___226_2463.FStar_Syntax_Syntax.fv_name);
                                  FStar_Syntax_Syntax.fv_delta =
                                    (uu___226_2463.FStar_Syntax_Syntax.fv_delta);
  ...
  fun top_level  ->
    fun env  ->
      fun top  ->
        ...
        let setpos e =
          let uu___227_2792 = e in
          {
            FStar_Syntax_Syntax.n = (uu___227_2792.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.tk = (uu___227_2792.FStar_Syntax_Syntax.tk);
            FStar_Syntax_Syntax.pos = (top.FStar_Parser_AST.range);
            FStar_Syntax_Syntax.vars =
              (uu___227_2792.FStar_Syntax_Syntax.vars)
          } in
        let uu____2799 =
                               ...
                               | (env2,x) ->
                                   ...
                                   (env2,
                                     (FStar_List.append tparams
                                        [(((let uu___228_3245 = x in
                                            {
                                              FStar_Syntax_Syntax.ppname =
                                                (uu___228_3245.FStar_Syntax_Syntax.ppname);
                                              FStar_Syntax_Syntax.index =
                                                (uu___228_3245.FStar_Syntax_Syntax.index);
                                              FStar_Syntax_Syntax.sort = t1
                                            })), None)]), uu____3227))))
                (env, [], [])
        ...
        | FStar_Parser_AST.Product (binders,t) ->
            ...
            (match uu____3288 with
             | (bs,t1) ->
                 let rec aux env1 bs1 uu___208_3311 =
                   match uu___208_3311 with
                   | [] ->
                       let cod =
        ...
        | FStar_Parser_AST.Abs (binders,body) ->
            ...
            (match uu____3382 with
             | (uu____3414,ftv) ->
                 ...
                 let rec aux env1 bs sc_pat_opt uu___209_3451 =
                   match uu___209_3451 with
                   | [] ->
...
and desugar_formula:
  ...
  fun env  ->
    fun f  ->
      ...
      let setpos t =
        let uu___229_6170 = t in
        {
          FStar_Syntax_Syntax.n = (uu___229_6170.FStar_Syntax_Syntax.n);
          FStar_Syntax_Syntax.tk = (uu___229_6170.FStar_Syntax_Syntax.tk);
          FStar_Syntax_Syntax.pos = (f.FStar_Parser_AST.range);
          FStar_Syntax_Syntax.vars = (uu___229_6170.FStar_Syntax_Syntax.vars)
        } in
      let desugar_quant q b pats body =
        let tk =
          desugar_binder env
            (let uu___230_6200 = b in
             {
               FStar_Parser_AST.b = (uu___230_6200.FStar_Parser_AST.b);
               FStar_Parser_AST.brange =
                 (uu___230_6200.FStar_Parser_AST.brange);
               FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
               FStar_Parser_AST.aqual =
                 (uu___230_6200.FStar_Parser_AST.aqual)
             }) in
        ...
        | (Some a,k) ->
            ...
            (match uu____6242 with
             | (env1,a1) ->
                 let a2 =
                   let uu___231_6250 = a1 in
                   {
                     FStar_Syntax_Syntax.ppname =
                       (uu___231_6250.FStar_Syntax_Syntax.ppname);
                     FStar_Syntax_Syntax.index =
                       (uu___231_6250.FStar_Syntax_Syntax.index);
                     FStar_Syntax_Syntax.sort = k
                   } in
          ...
          (fun uu____6454  ->
             fun b  ->
               ...
               | (env1,out) ->
                   let tk =
                     desugar_binder env1
                       (let uu___232_6482 = b in
                        {
                          FStar_Parser_AST.b =
                            (uu___232_6482.FStar_Parser_AST.b);
                          FStar_Parser_AST.brange =
                            (uu___232_6482.FStar_Parser_AST.brange);
                          FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
                          FStar_Parser_AST.aqual =
                            (uu___232_6482.FStar_Parser_AST.aqual)
                        }) in
                   (match tk with
                    | (Some a,k) ->
                        ...
                        (match uu____6492 with
                         | (env2,a1) ->
                             let a2 =
                               let uu___233_6504 = a1 in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___233_6504.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___233_6504.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = k
                               } in
                             (env2,
           ...
           (match uu____6812 with
            | (formals,uu____6822) ->
                (match formals with
                 | [] -> []
                 | uu____6836 ->
                     let filter_records uu___213_6844 =
                       match uu___213_6844 with
    ...
    fun d  ->
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___214_6975 =
            match uu___214_6975 with
          ...
          let apply_binders t binders =
            ...
            FStar_List.fold_left
              ...
              binders in
          let tycon_record_as_variant uu___215_7052 =
            match uu___215_7052 with
          ...
          let desugar_abstract_tc quals1 _env mutuals uu___216_7165 =
            match uu___216_7165 with
               ...
               | (uu____7385,uu____7386,se,uu____7388) ->
                   let se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         ...
                         let uu___234_7433 = se in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ
                                (l, [], t, quals2));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___234_7433.FStar_Syntax_Syntax.sigrng)
                         }
                       ...
                       FStar_All.pipe_right (Prims.snd lbs)
                         (FStar_List.map
                            (fun lb  ->
                               ...
                               let uu___235_10244 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___236_10245 = fv in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___236_10245.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___236_10245.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___235_10244.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___235_10244.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___235_10244.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___235_10244.FStar_Syntax_Syntax.lbdef)
                               })) in
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___237_10304 = pat1 in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___237_10304.FStar_Parser_AST.prange)
                       }
                   | uu____10305 -> var_pat in
                 let main_let =
                   desugar_decl env
                     (let uu___238_10309 = d in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___238_10309.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___238_10309.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___238_10309.FStar_Parser_AST.attrs)
                      }) in
