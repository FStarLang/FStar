      ...
      fun uu___200_782  ->
        ...
        | (Some a,k) ->
            ...
            (match uu____795 with
             | (env1,a1) ->
                 (((let uu___221_806 = a1  in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___221_806.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___221_806.FStar_Syntax_Syntax.index);
                    ...
                    let binder1 =
                      ...
                      | LocalBinder (x,aq) ->
                          ...
                          (if
                           ...
                           LocalBinder
                             (((let uu___222_1771 = x  in
                                {
                                  FStar_Syntax_Syntax.ppname =
                                    (uu___222_1771.FStar_Syntax_Syntax.ppname);
                                  FStar_Syntax_Syntax.index =
                                    (uu___222_1771.FStar_Syntax_Syntax.index);
                              ...
                              let uu____2462 =
                                  ...
                                  Some uu____2466  in
                                {
                                  FStar_Syntax_Syntax.fv_name =
                                    (uu___223_2463.FStar_Syntax_Syntax.fv_name);
                                  FStar_Syntax_Syntax.fv_delta =
                                    (uu___223_2463.FStar_Syntax_Syntax.fv_delta);
  ...
  fun top_level  ->
    fun env  ->
      fun top  ->
        ...
        let setpos e =
          let uu___224_2792 = e  in
          {
            FStar_Syntax_Syntax.n = (uu___224_2792.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.tk = (uu___224_2792.FStar_Syntax_Syntax.tk);
            FStar_Syntax_Syntax.pos = (top.FStar_Parser_AST.range);
            FStar_Syntax_Syntax.vars =
              (uu___224_2792.FStar_Syntax_Syntax.vars)
          }  in
        let uu____2799 =
                               ...
                               | (env2,x) ->
                                   ...
                                   (env2,
                                     (FStar_List.append tparams
                                        [(((let uu___225_3245 = x  in
                                            {
                                              FStar_Syntax_Syntax.ppname =
                                                (uu___225_3245.FStar_Syntax_Syntax.ppname);
                                              FStar_Syntax_Syntax.index =
                                                (uu___225_3245.FStar_Syntax_Syntax.index);
                                              FStar_Syntax_Syntax.sort = t1
                                            })), None)]), uu____3227))))
                (env, [], [])
        ...
        | FStar_Parser_AST.Product (binders,t) ->
            ...
            (match uu____3288 with
             | (bs,t1) ->
                 let rec aux env1 bs1 uu___205_3311 =
                   match uu___205_3311 with
                   | [] ->
                       let cod =
        ...
        | FStar_Parser_AST.Abs (binders,body) ->
            ...
            (match uu____3382 with
             | (uu____3414,ftv) ->
                 ...
                 let rec aux env1 bs sc_pat_opt uu___206_3451 =
                   match uu___206_3451 with
                   | [] ->
...
and desugar_formula :
  ...
  fun env  ->
    fun f  ->
      ...
      let setpos t =
        let uu___226_6170 = t  in
        {
          FStar_Syntax_Syntax.n = (uu___226_6170.FStar_Syntax_Syntax.n);
          FStar_Syntax_Syntax.tk = (uu___226_6170.FStar_Syntax_Syntax.tk);
          FStar_Syntax_Syntax.pos = (f.FStar_Parser_AST.range);
          FStar_Syntax_Syntax.vars = (uu___226_6170.FStar_Syntax_Syntax.vars)
        }  in
      let desugar_quant q b pats body =
        let tk =
          desugar_binder env
            (let uu___227_6200 = b  in
             {
               FStar_Parser_AST.b = (uu___227_6200.FStar_Parser_AST.b);
               FStar_Parser_AST.brange =
                 (uu___227_6200.FStar_Parser_AST.brange);
               FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
               FStar_Parser_AST.aqual =
                 (uu___227_6200.FStar_Parser_AST.aqual)
             })
           in
        ...
        | (Some a,k) ->
            ...
            (match uu____6242 with
             | (env1,a1) ->
                 let a2 =
                   let uu___228_6250 = a1  in
                   {
                     FStar_Syntax_Syntax.ppname =
                       (uu___228_6250.FStar_Syntax_Syntax.ppname);
                     FStar_Syntax_Syntax.index =
                       (uu___228_6250.FStar_Syntax_Syntax.index);
                     FStar_Syntax_Syntax.sort = k
                   }  in
          ...
          (fun uu____6454  ->
             fun b  ->
               ...
               | (env1,out) ->
                   let tk =
                     desugar_binder env1
                       (let uu___229_6482 = b  in
                        {
                          FStar_Parser_AST.b =
                            (uu___229_6482.FStar_Parser_AST.b);
                          FStar_Parser_AST.brange =
                            (uu___229_6482.FStar_Parser_AST.brange);
                          FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
                          FStar_Parser_AST.aqual =
                            (uu___229_6482.FStar_Parser_AST.aqual)
                        })
                      in
                   (match tk with
                    | (Some a,k) ->
                        ...
                        (match uu____6492 with
                         | (env2,a1) ->
                             let a2 =
                               let uu___230_6504 = a1  in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___230_6504.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___230_6504.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = k
                               }  in
                             (env2,
           ...
           (match uu____6812 with
            | (formals,uu____6822) ->
                (match formals with
                 | [] -> []
                 | uu____6836 ->
                     let filter_records uu___210_6844 =
                       match uu___210_6844 with
    ...
    fun d  ->
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___211_6975 =
            match uu___211_6975 with
          ...
          let apply_binders t binders =
            ...
            FStar_List.fold_left
              ...
              binders
             in
          let tycon_record_as_variant uu___212_7052 =
            match uu___212_7052 with
          ...
          let desugar_abstract_tc quals1 _env mutuals uu___213_7165 =
            match uu___213_7165 with
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         ...
                         let t =
                           ...
                           | uu____7411 ->
                            ...
                            in
                         let uu___231_7433 = se  in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ
                                (l, [], t, quals2));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___231_7433.FStar_Syntax_Syntax.sigrng)
                         }
                              ...
                              let se =
                                ...
                                then
                                  ...
                                  (let rr =
                                     FStar_Util.for_some
                                       (fun uu___219_9662  ->
                                          match uu___219_9662 with
                                          | FStar_Syntax_Syntax.Reifiable 
                                            |FStar_Syntax_Syntax.Reflectable
                                            _ -> true
                                          | uu____9664 -> false) qualifiers
                                      in
                                      ...
                                      let uu____9794 =
                                        let uu____9795 =
                                          FStar_Parser_AST.term_to_string
                                            head1
                                           in
                                        Prims.strcat uu____9795 " not found"
                                         in
                                      Prims.strcat "Effect " uu____9794  in
                                    (uu____9793, (d.FStar_Parser_AST.drange))
                                     in
                                  FStar_Errors.Error uu____9790  in
                                Prims.raise uu____9789
                             in
                          let ed =
                            FStar_ToSyntax_Env.fail_or env2
    ...
    fun d  ->
      ...
      | FStar_Parser_AST.Tycon (is_effect,tcs) ->
          ...
          let tcs1 =
            FStar_List.map
              (fun uu____10089  ->
                 match uu____10089 with | (x,uu____10094) -> x) tcs
             in
                            ...
                            (fun lb  ->
                               let fv =
                                 FStar_Util.right
                                   lb.FStar_Syntax_Syntax.lbname
                                  in
                               let uu___232_10244 = lb  in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___233_10245 = fv  in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___233_10245.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___233_10245.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___232_10244.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___232_10244.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___232_10244.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___232_10244.FStar_Syntax_Syntax.lbdef)
                               }))
                        in
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___234_10304 = pat1  in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___234_10304.FStar_Parser_AST.prange)
                       }
                   | uu____10305 -> var_pat  in
                 let main_let =
                   desugar_decl env
                     (let uu___235_10309 = d  in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___235_10309.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___235_10309.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___235_10309.FStar_Parser_AST.attrs)
                      })
                    in
                 ...
                 let bvs =
                   ...
                   FStar_All.pipe_right uu____10381 FStar_Util.set_elements
                    in
      ...
      | FStar_Parser_AST.Val (id,t) ->
          let quals = d.FStar_Parser_AST.quals  in
          let t1 =
            let uu____10403 = close_fun env t  in
            desugar_term env uu____10403  in
          let quals1 =
            let uu____10406 =
      ...
      | FStar_Parser_AST.Exception (id,Some term) ->
          ...
          let t1 =
            ...
            let uu____10468 =
              ...
              FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total uu____10471
               in
      ...
      | FStar_Parser_AST.SubEffect l ->
          ...
          let uu____10531 =
            ...
            | FStar_Parser_AST.ReifiableLift (wp,t) ->
                ...
                let uu____10594 =
                  let uu____10599 =
                    let uu____10603 = desugar_term env t  in
                    ([], uu____10603)  in
                  Some uu____10599  in
            ...
            | FStar_Parser_AST.LiftForFree t ->
                let uu____10617 =
                  let uu____10622 =
                    let uu____10626 = desugar_term env t  in
                    ([], uu____10626)  in
                  Some uu____10622  in
                (None, uu____10617)
             in
