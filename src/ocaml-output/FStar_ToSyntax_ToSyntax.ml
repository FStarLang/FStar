...
let tm_type_z : FStar_Range.range  ->  FStar_Parser_AST.term = (fun r -> (let _0_384 = FStar_Parser_AST.Name ((FStar_Ident.lid_of_path (("Type0")::[]) r))
in (FStar_Parser_AST.mk_term _0_384 r FStar_Parser_AST.Kind)))


let tm_type : FStar_Range.range  ->  FStar_Parser_AST.term = (fun r -> (let _0_385 = FStar_Parser_AST.Name ((FStar_Ident.lid_of_path (("Type")::[]) r))
in (FStar_Parser_AST.mk_term _0_385 r FStar_Parser_AST.Kind)))
...
(let _0_386 = (FStar_ToSyntax_Env.try_lookup_effect_name env l)
in (FStar_All.pipe_right _0_386 FStar_Option.isSome))
end
...
let compile_op_lid : Prims.int  ->  Prims.string  ->  FStar_Range.range  ->  FStar_Ident.lident = (fun n s r -> (let _0_389 = (let _0_388 = (FStar_Ident.mk_ident (let _0_387 = (FStar_Parser_AST.compile_op n s)
in ((_0_387), (r))))
in (_0_388)::[])
in (FStar_All.pipe_right _0_389 FStar_Ident.lid_of_ids)))
...
let r = (fun l dd -> Some ((let _0_390 = (FStar_Syntax_Syntax.lid_as_fv (FStar_Ident.set_lid_range l rng) dd None)
in (FStar_All.pipe_right _0_390 FStar_Syntax_Syntax.fv_to_tm))))
in (
...
let uu____152 = (let _0_391 = (compile_op_lid arity s rng)
in (FStar_ToSyntax_Env.try_lookup_lid env _0_391))
...
let sort_ftv : FStar_Ident.ident Prims.list  ->  FStar_Ident.ident Prims.list = (fun ftv -> (let _0_392 = (FStar_Util.remove_dups (fun x y -> (x.FStar_Ident.idText = y.FStar_Ident.idText)) ftv)
in (FStar_All.pipe_left (FStar_Util.sort_with (fun x y -> (FStar_String.compare x.FStar_Ident.idText y.FStar_Ident.idText))) _0_392)))
...
(let _0_393 = (free_type_vars env term)
in ((env), (_0_393)))
end
...
(let _0_394 = (free_type_vars env t)
in ((env), (_0_394)))
end))
...
(let _0_396 = (free_type_vars env t1)
in (let _0_395 = (free_type_vars env t2)
in (FStar_List.append _0_396 _0_395)))
end
...
| (env, f) -> begin
(let _0_397 = (free_type_vars env t)
in (FStar_List.append f _0_397))
end))
end
...
| (env, free) -> begin
(let _0_398 = (free_type_vars env body)
in (FStar_List.append free _0_398))
end))
end
...
let ftv = (let _0_399 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _0_399))
...
let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _0_401 = FStar_Parser_AST.TAnnotated ((let _0_400 = (tm_type x.FStar_Ident.idRange)
in ((x), (_0_400))))
in (FStar_Parser_AST.mk_binder _0_401 x.FStar_Ident.idRange FStar_Parser_AST.Type_level (Some (FStar_Parser_AST.Implicit)))))))
in (
...
let ftv = (let _0_402 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _0_402))
in (match (((FStar_List.length ftv) = (Prims.parse_int "0"))) with
| true -> begin
t
end
...
let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _0_404 = FStar_Parser_AST.TAnnotated ((let _0_403 = (tm_type x.FStar_Ident.idRange)
in ((x), (_0_403))))
in (FStar_Parser_AST.mk_binder _0_404 x.FStar_Ident.idRange FStar_Parser_AST.Type_level (Some (FStar_Parser_AST.Implicit)))))))
in (
...
(let _0_405 = FStar_Util.Inr ((FStar_ToSyntax_Env.qualify env id))
in ((_0_405), (args), (None)))
end
...
| (None, k) -> begin
(let _0_406 = (FStar_Syntax_Syntax.null_binder k)
in ((_0_406), (env)))
end
| (Some (a), k) -> begin
(
...
let tm' = FStar_Syntax_Syntax.Tm_app ((let _0_410 = (FStar_Syntax_Syntax.fv_to_tm (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.sread_lid FStar_Syntax_Syntax.Delta_constant None))
...
let tm' = FStar_Syntax_Syntax.Tm_app ((let _0_414 = (FStar_Syntax_Syntax.fv_to_tm (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.salloc_lid FStar_Syntax_Syntax.Delta_constant None))
in (let _0_413 = (let _0_412 = (let _0_411 = (FStar_Syntax_Syntax.as_implicit false)
in ((tm), (_0_411)))
in (_0_412)::[])
in ((_0_414), (_0_413)))))
in (FStar_Syntax_Syntax.mk tm' None tm.FStar_Syntax_Syntax.pos)))
...
let tm = FStar_Syntax_Syntax.Tm_app ((let _0_421 = (FStar_Syntax_Syntax.fv_to_tm (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.swrite_lid FStar_Syntax_Syntax.Delta_constant None))
in (let _0_420 = (let _0_419 = (let _0_415 = (FStar_Syntax_Syntax.as_implicit false)
in ((t1), (_0_415)))
in (let _0_418 = (let _0_417 = (let _0_416 = (FStar_Syntax_Syntax.as_implicit false)
in ((t2), (_0_416)))
in (_0_417)::[])
in (_0_419)::_0_418))
in ((_0_421), (_0_420)))))
...
(Prims.raise (FStar_Errors.Error ((let _0_423 = (let _0_422 = (FStar_Parser_AST.term_to_string t)
in (Prims.strcat "This universe might contain a sum of two universe variables " _0_422))
in ((_0_423), (t.FStar_Parser_AST.range))))))
end)))
end
...
| uu____1057 -> begin
(Prims.raise (FStar_Errors.Error ((let _0_426 = (let _0_425 = (let _0_424 = (FStar_Parser_AST.term_to_string t)
in (Prims.strcat _0_424 " in universe context"))
in (Prims.strcat "Unexpected term " _0_425))
in ((_0_426), (t.FStar_Parser_AST.range))))))
end)))
in (aux t []))
end
| uu____1062 -> begin
(Prims.raise (FStar_Errors.Error ((let _0_429 = (let _0_428 = (let _0_427 = (FStar_Parser_AST.term_to_string t)
in (Prims.strcat _0_427 " in universe context"))
in (Prims.strcat "Unexpected term " _0_428))
in ((_0_429), (t.FStar_Parser_AST.range))))))
end)))
...
in ((let _0_430 = (FStar_List.tl fields)
in (FStar_List.iter check_field _0_430));
(match (()) with
| () -> begin
record
end);
...
| (p, uu____1300) -> begin
(let _0_431 = (pat_vars p)
in (FStar_Util.set_union out _0_431))
...
(let _0_434 = (let _0_433 = FStar_Parser_AST.PatVar ((let _0_432 = (FStar_Ident.id_of_text (FStar_Parser_AST.compile_op (Prims.parse_int "0") op))
in ((_0_432), (None))))
in {FStar_Parser_AST.pat = _0_433; FStar_Parser_AST.prange = p.FStar_Parser_AST.prange})
in (aux loc env _0_434))
end
...
let t = (let _0_435 = (close_fun env t)
in (desugar_term env _0_435))
...
| true -> begin
(let _0_438 = (FStar_Syntax_Print.bv_to_string x)
in (let _0_437 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (let _0_436 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print3_warning "Multiple ascriptions for %s in pattern, type %s was shadowed by %s" _0_438 _0_437 _0_436))))
end
| uu____1573 -> begin
()
end);
...
in (let _0_439 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_wild (x)))
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _0_440 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_constant (c)))
...
| (loc, env, xbv) -> begin
(let _0_441 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_var (xbv)))
in ((loc), (env), (LocalBinder (((xbv), (aq)))), (_0_441), (imp)))
end))))
end
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _0_442 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l), ([])))))
in ((loc), (env), (LocalBinder (((x), (None)))), (_0_442), (false)))))
end
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _0_443 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l), (args)))))
in ((loc), (env), (LocalBinder (((x), (None)))), (_0_443), (false)))))
end))
end
...
let pat = (let _0_449 = (let _0_448 = (pos_r (FStar_Range.end_range p.FStar_Parser_AST.prange))
in (let _0_447 = FStar_Syntax_Syntax.Pat_cons ((let _0_446 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.nil_lid FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in ((_0_446), ([]))))
in (FStar_All.pipe_left _0_448 _0_447)))
in (FStar_List.fold_right (fun hd tl -> (

let r = (FStar_Range.union_ranges hd.FStar_Syntax_Syntax.p tl.FStar_Syntax_Syntax.p)
in (let _0_445 = FStar_Syntax_Syntax.Pat_cons ((let _0_444 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.cons_lid FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in ((_0_444), ((((hd), (false)))::(((tl), (false)))::[]))))
in (FStar_All.pipe_left (pos_r r) _0_445)))) pats _0_449))
in (
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _0_450 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l), (args)))))
in ((loc), (env), (LocalBinder (((x), (None)))), (_0_450), (false)))))
end))))
end))
end
...
let app = (let _0_453 = FStar_Parser_AST.PatApp ((let _0_452 = (let _0_451 = FStar_Parser_AST.PatName ((FStar_Ident.lid_of_ids (FStar_List.append record.FStar_ToSyntax_Env.typename.FStar_Ident.ns ((record.FStar_ToSyntax_Env.constrname)::[]))))
in (FStar_Parser_AST.mk_pattern _0_451 p.FStar_Parser_AST.prange))
in ((_0_452), (args))))
in (FStar_Parser_AST.mk_pattern _0_453 p.FStar_Parser_AST.prange))
in (
...
(let _0_457 = FStar_Syntax_Syntax.Pat_cons ((let _0_456 = (

let uu___211_2208 = fv
in (let _0_455 = Some (FStar_Syntax_Syntax.Record_ctor ((let _0_454 = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map Prims.fst))
in ((record.FStar_ToSyntax_Env.typename), (_0_454)))))
in {FStar_Syntax_Syntax.fv_name = uu___211_2208.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = uu___211_2208.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = _0_455}))
in ((_0_456), (args))))
in (FStar_All.pipe_left pos _0_457))
end
| uu____2219 -> begin
p
end)
...
((let _0_458 = (check_linear_pattern_variables p)
in (FStar_All.pipe_left Prims.ignore _0_458));
((env), (b), (p));
)
end)))));
)))
...
let mklet = (fun x -> (let _0_460 = LetBinder ((let _0_459 = (FStar_ToSyntax_Env.qualify env x)
in ((_0_459), (FStar_Syntax_Syntax.tun))))
in ((env), (_0_460), (None))))
in (match (top) with
| true -> begin
...
(let _0_463 = LetBinder ((let _0_462 = (FStar_ToSyntax_Env.qualify env x)
in (let _0_461 = (desugar_term env t)
in ((_0_462), (_0_461)))))
in ((env), (_0_463), (None)))
end
| uu____2282 -> begin
...
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_466 = (let _0_465 = (let _0_464 = (FStar_Syntax_Syntax.as_implicit false)
in ((repr), (_0_464)))
in (_0_465)::[])
in ((lid), (_0_466)))))) None range)))))
end))
...
in (match (mut) with
| true -> begin
(let _0_468 = FStar_Syntax_Syntax.Tm_meta ((let _0_467 = (mk_ref_read tm)
in ((_0_467), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Mutable_rval)))))
in (FStar_All.pipe_left mk _0_468))
end
| uu____2415 -> begin
tm
end))
...
| uu____2429 -> begin
(Prims.raise (FStar_Errors.Error ((let _0_470 = (let _0_469 = (FStar_Parser_AST.term_to_string t)
in (Prims.strcat "Unknown attribute " _0_469))
in ((_0_470), (t.FStar_Parser_AST.range))))))
end)))
...
| FStar_Parser_AST.Op ("*", (uu____2494)::(uu____2495)::[]) when (let _0_471 = (op_as_term env (Prims.parse_int "2") top.FStar_Parser_AST.range "*")
in (FStar_All.pipe_right _0_471 FStar_Option.isNone)) -> begin
(

let rec flatten = (fun t -> (match (t.FStar_Parser_AST.tm) with
| FStar_Parser_AST.Op ("*", (t1)::(t2)::[]) -> begin
(let _0_472 = (flatten t1)
in (FStar_List.append _0_472 ((t2)::[])))
end
| uu____2507 -> begin
(t)::[]
end))
...
let targs = (let _0_473 = (flatten (unparen top))
in (FStar_All.pipe_right _0_473 (FStar_List.map (fun t -> (FStar_Syntax_Syntax.as_arg (desugar_typ env t))))))
in (

let uu____2513 = (let _0_474 = (FStar_Syntax_Util.mk_tuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
...
| FStar_Parser_AST.Tvar (a) -> begin
(let _0_475 = (Prims.fst (FStar_ToSyntax_Env.fail_or2 (FStar_ToSyntax_Env.try_lookup_id env) a))
...
let args = (FStar_All.pipe_right args (FStar_List.map (fun t -> (let _0_476 = (desugar_term env t)
in ((_0_476), (None))))))
...
| Some (ed) -> begin
(let _0_477 = (FStar_Ident.lid_of_path (FStar_Ident.path_of_text (Prims.strcat (FStar_Ident.text_of_lid ed.FStar_Syntax_Syntax.mname) (Prims.strcat "_" txt))) FStar_Range.dummyRange)
in (FStar_Syntax_Syntax.fvar _0_477 (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) None))
end
| None -> begin
...
in (match (found) with
| true -> begin
(let _0_478 = (FStar_Syntax_Util.mk_field_projector_name_from_ident l i)
in (desugar_name mk setpos env _0_478))
end
| uu____2618 -> begin
(Prims.raise (FStar_Errors.Error ((let _0_479 = (FStar_Util.format1 "Data constructor or effect %s not found" l.FStar_Ident.str)
in ((_0_479), (top.FStar_Parser_AST.range))))))
end))
end
...
| None -> begin
(Prims.raise (FStar_Errors.Error ((let _0_480 = (FStar_Util.format1 "Data constructor %s not found" lid.FStar_Ident.str)
in ((_0_480), (top.FStar_Parser_AST.range))))))
end
| uu____2622 -> begin
(
...
let uu____2636 = (let _0_481 = (mk (FStar_Syntax_Syntax.Tm_fvar (head)))
in ((_0_481), (true)))
...
| None -> begin
(let _0_482 = (FStar_Syntax_Syntax.new_bv (Some (top.FStar_Parser_AST.range)) FStar_Syntax_Syntax.tun)
in ((env), (_0_482)))
end
| Some (x) -> begin
...
| (env, x) -> begin
(let _0_486 = (let _0_485 = (let _0_484 = (let _0_483 = (no_annot_abs tparams t)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _0_483))
in (_0_484)::[])
in (FStar_List.append typs _0_485))
in ((env), ((FStar_List.append tparams (((((

let uu___215_2829 = x
in {FStar_Syntax_Syntax.ppname = uu___215_2829.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___215_2829.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (None)))::[]))), (_0_486)))
end))
end))
...
let uu____2854 = (let _0_487 = (FStar_Syntax_Util.mk_dtuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_lid env) _0_487))
...
in (let _0_488 = (FStar_Syntax_Util.arrow (FStar_List.rev bs) cod)
in (FStar_All.pipe_left setpos _0_488)))
end
| (hd)::tl -> begin
(
...
in (let _0_489 = (FStar_Syntax_Util.refine x f)
in (FStar_All.pipe_left setpos _0_489)))
end))
end))
end
...
(let _0_491 = (let _0_490 = (free_type_vars env t)
in (FStar_List.append _0_490 ftvs))
in ((env), (_0_491)))
end
| uu____2984 -> begin
((env), (ftvs))
...
let binders = (let _0_492 = (FStar_All.pipe_right ftv (FStar_List.map (fun a -> (FStar_Parser_AST.mk_pattern (FStar_Parser_AST.PatTvar (((a), (Some (FStar_Parser_AST.Implicit))))) top.FStar_Parser_AST.range))))
in (FStar_List.append _0_492 binders))
in (
...
let body = (let _0_494 = (let _0_493 = (FStar_Syntax_Syntax.pat_bvs pat)
in (FStar_All.pipe_right _0_493 (FStar_List.map FStar_Syntax_Syntax.mk_binder)))
in (FStar_Syntax_Subst.close _0_494 body))
...
| (Some (p), None) -> begin
Some ((let _0_495 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_0_495), (p))))
end
...
let tup2 = (let _0_496 = (FStar_Syntax_Util.mk_tuple_data_lid (Prims.parse_int "2") top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.lid_as_fv _0_496 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))
in (

let sc = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_502 = (mk (FStar_Syntax_Syntax.Tm_fvar (tup2)))
in (let _0_501 = (let _0_500 = (FStar_Syntax_Syntax.as_arg sc)
in (let _0_499 = (let _0_498 = (let _0_497 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _0_497))
in (_0_498)::[])
in (_0_500)::_0_499))
in ((_0_502), (_0_501))))))) None top.FStar_Parser_AST.range)
in (

let p = (let _0_503 = (FStar_Range.union_ranges p'.FStar_Syntax_Syntax.p p.FStar_Syntax_Syntax.p)
in (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_cons (((tup2), ((((p'), (false)))::(((p), (false)))::[])))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n _0_503))
in Some (((sc), (p))))))
end
| (FStar_Syntax_Syntax.Tm_app (uu____3244, args), FStar_Syntax_Syntax.Pat_cons (uu____3246, pats)) -> begin
(

let tupn = (let _0_504 = (FStar_Syntax_Util.mk_tuple_data_lid ((Prims.parse_int "1") + (FStar_List.length args)) top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.lid_as_fv _0_504 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))
in (

let sc = (mk (FStar_Syntax_Syntax.Tm_app ((let _0_509 = (mk (FStar_Syntax_Syntax.Tm_fvar (tupn)))
in (let _0_508 = (let _0_507 = (let _0_506 = (let _0_505 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _0_505))
in (_0_506)::[])
in (FStar_List.append args _0_507))
in ((_0_509), (_0_508)))))))
in (

let p = (let _0_510 = (FStar_Range.union_ranges p'.FStar_Syntax_Syntax.p p.FStar_Syntax_Syntax.p)
in (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_cons (((tupn), ((FStar_List.append pats ((((p), (false)))::[])))))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n _0_510))
in Some (((sc), (p))))))
end
| uu____3319 -> begin
(failwith "Impossible")
...
in (mk (FStar_Syntax_Syntax.Tm_app ((let _0_516 = (FStar_Syntax_Syntax.fvar a FStar_Syntax_Syntax.Delta_equational None)
in (let _0_515 = (let _0_514 = (FStar_Syntax_Syntax.as_arg phi)
in (let _0_513 = (let _0_512 = (let _0_511 = (mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)))
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _0_511))
in (_0_512)::[])
in (_0_514)::_0_513))
in ((_0_516), (_0_515)))))))))
end
...
let arg = (let _0_517 = (desugar_term env t)
in (FStar_All.pipe_left (arg_withimp_e imp) _0_517))
in (aux ((arg)::args) e))
end
| uu____3427 -> begin
(
...
(mk (FStar_Syntax_Syntax.Tm_meta ((let _0_518 = (desugar_term env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((FStar_Parser_AST.NoLetQualifier), (((((FStar_Parser_AST.mk_pattern FStar_Parser_AST.PatWild t1.FStar_Parser_AST.range)), (t1)))::[]), (t2)))) top.FStar_Parser_AST.range FStar_Parser_AST.Expr))
in ((_0_518), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Sequence)))))))
end
...
| true -> begin
(let _0_519 = (destruct_app_pattern env top_level p)
in ((_0_519), (def)))
end
| uu____3540 -> begin
(match ((FStar_Parser_AST.un_function p def)) with
| Some (p, def) -> begin
(let _0_520 = (destruct_app_pattern env top_level p)
in ((_0_520), (def)))
end
| uu____3561 -> begin
(match (p.FStar_Parser_AST.pat) with
...
(match (top_level) with
| true -> begin
(let _0_524 = (let _0_523 = FStar_Util.Inr ((FStar_ToSyntax_Env.qualify env id))
in ((_0_523), ([]), (None)))
in ((_0_524), (def)))
end
| uu____3636 -> begin
...
| (env, xx) -> begin
(let _0_526 = (let _0_525 = (FStar_Syntax_Syntax.mk_binder xx)
in (_0_525)::rec_bindings)
in ((env), (FStar_Util.Inl (xx)), (_0_526)))
end))
end
| FStar_Util.Inr (l) -> begin
(let _0_527 = (FStar_ToSyntax_Env.push_top_level_rec_binding env l.FStar_Ident.ident FStar_Syntax_Syntax.Delta_equational)
in ((_0_527), (FStar_Util.Inr (l)), (rec_bindings)))
end)
...
in (let _0_528 = (FStar_Range.union_ranges t.FStar_Parser_AST.range def.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term (FStar_Parser_AST.Ascribed (((def), (t)))) _0_528 FStar_Parser_AST.Expr)))
end)
in (
...
| FStar_Util.Inr (l) -> begin
FStar_Util.Inr ((let _0_529 = (FStar_Syntax_Util.incr_delta_qualifier body)
in (FStar_Syntax_Syntax.lid_as_fv l _0_529 None)))
end)
in (
...
let body = (desugar_term env' body)
in (let _0_531 = FStar_Syntax_Syntax.Tm_let ((let _0_530 = (FStar_Syntax_Subst.close rec_bindings body)
in ((((is_rec), (lbs))), (_0_530))))
in (FStar_All.pipe_left mk _0_531)))))))
end)))))
in (
...
let fv = (let _0_532 = (FStar_Syntax_Util.incr_delta_qualifier t1)
in (FStar_Syntax_Syntax.lid_as_fv l _0_532 None))
...
| Some (pat) -> begin
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match ((let _0_535 = (FStar_Syntax_Syntax.bv_to_name x)
in (let _0_534 = (let _0_533 = (FStar_Syntax_Util.branch ((pat), (None), (body)))
in (_0_533)::[])
in ((_0_535), (_0_534))))))) None body.FStar_Syntax_Syntax.pos)
end)
in (let _0_539 = FStar_Syntax_Syntax.Tm_let ((let _0_538 = (let _0_537 = (let _0_536 = (FStar_Syntax_Syntax.mk_binder x)
in (_0_536)::[])
in (FStar_Syntax_Subst.close _0_537 body))
in ((((false), (((mk_lb ((FStar_Util.Inl (x)), (x.FStar_Syntax_Syntax.sort), (t1))))::[]))), (_0_538))))
...
in (mk (FStar_Syntax_Syntax.Tm_match ((let _0_548 = (desugar_term env t1)
in (let _0_547 = (let _0_546 = (let _0_541 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Parser_AST.range)
in (let _0_540 = (desugar_term env t2)
in ((_0_541), (None), (_0_540))))
in (let _0_545 = (let _0_544 = (let _0_543 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_wild (x)) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t3.FStar_Parser_AST.range)
in (let _0_542 = (desugar_term env t3)
in ((_0_543), (None), (_0_542))))
in (_0_544)::[])
in (_0_546)::_0_545))
in ((_0_548), (_0_547))))))))
end
...
in (let _0_551 = FStar_Syntax_Syntax.Tm_match ((let _0_550 = (desugar_term env e)
in (let _0_549 = (FStar_List.map desugar_branch branches)
in ((_0_550), (_0_549)))))
...
in (let _0_553 = FStar_Syntax_Syntax.Tm_ascribed ((let _0_552 = (desugar_term env e)
in ((_0_552), (annot), (None))))
...
(match (xopt) with
| None -> begin
(Prims.raise (FStar_Errors.Error ((let _0_554 = (FStar_Util.format2 "Field %s of record type %s is missing" f.FStar_Ident.idText record.FStar_ToSyntax_Env.typename.FStar_Ident.str)
in ((_0_554), (top.FStar_Parser_AST.range))))))
end
| Some (x) -> begin
...
| None -> begin
FStar_Parser_AST.Construct ((let _0_557 = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map (fun uu____4283 -> (match (uu____4283) with
| (f, uu____4289) -> begin
(let _0_556 = (let _0_555 = (get_field None f)
in (FStar_All.pipe_left Prims.snd _0_555))
in ((_0_556), (FStar_Parser_AST.Nothing)))
end))))
in ((user_constrname), (_0_557))))
end
| Some (e) -> begin
(
...
let xterm = (let _0_558 = FStar_Parser_AST.Var ((FStar_Ident.lid_of_ids ((x)::[])))
in (FStar_Parser_AST.mk_term _0_558 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
in (

let record = FStar_Parser_AST.Record ((let _0_559 = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map (fun uu____4310 -> (match (uu____4310) with
| (f, uu____4316) -> begin
...
let e = (let _0_563 = FStar_Syntax_Syntax.Tm_app ((let _0_562 = (let _0_561 = Some (FStar_Syntax_Syntax.Record_ctor ((let _0_560 = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map Prims.fst))
in ((record.FStar_ToSyntax_Env.typename), (_0_560)))))
in (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v e.FStar_Syntax_Syntax.pos) FStar_Syntax_Syntax.Delta_constant _0_561))
in ((_0_562), (args))))
...
in (let _0_567 = FStar_Syntax_Syntax.Tm_app ((let _0_566 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range projname (FStar_Ident.range_of_lid f)) FStar_Syntax_Syntax.Delta_equational qual)
in (let _0_565 = (let _0_564 = (FStar_Syntax_Syntax.as_arg e)
in (_0_564)::[])
in ((_0_566), (_0_565)))))
in (FStar_All.pipe_left mk _0_567)))))
end))
end
...
| (a, imp) -> begin
(let _0_568 = (desugar_term env a)
in (arg_withimp_e imp _0_568))
end)))))
...
(let _0_569 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_effect_name_and_attributes env) l)
in ((_0_569), (args)))
end
| FStar_Parser_AST.Name (l) when ((let _0_570 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.lid_equals _0_570 FStar_Syntax_Const.prims_lid)) && (l.FStar_Ident.ident.FStar_Ident.idText = "Tot")) -> begin
(((((FStar_Ident.set_lid_range FStar_Syntax_Const.effect_Tot_lid head.FStar_Parser_AST.range)), ([]))), (args))
end
| FStar_Parser_AST.Name (l) when ((let _0_571 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.lid_equals _0_571 FStar_Syntax_Const.prims_lid)) && (l.FStar_Ident.ident.FStar_Ident.idText = "GTot")) -> begin
...
((match (((FStar_List.length args) = (Prims.parse_int "0"))) with
| true -> begin
(fail (let _0_572 = (FStar_Syntax_Print.lid_to_string eff)
in (FStar_Util.format1 "Not enough args to effect %s" _0_572)))
end
| uu____4783 -> begin
()
end);
...
let uu____4830 = (let _0_574 = (FStar_List.hd args)
in (let _0_573 = (FStar_List.tl args)
in ((_0_574), (_0_573))))
...
let pattern = (let _0_575 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range FStar_Syntax_Const.pattern_lid pat.FStar_Syntax_Syntax.pos) FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.mk_Tm_uinst _0_575 ((FStar_Syntax_Syntax.U_zero)::[])))
in ((FStar_Syntax_Syntax.mk_Tm_app nil ((((pattern), (Some (FStar_Syntax_Syntax.imp_tag))))::[])) None pat.FStar_Syntax_Syntax.pos)))
end
| uu____5141 -> begin
pat
end)
in (let _0_579 = (let _0_578 = (let _0_577 = (let _0_576 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((pat), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Meta_smt_pat)))))) None pat.FStar_Syntax_Syntax.pos)
in ((_0_576), (aq)))
in (_0_577)::[])
in (ens)::_0_578)
in (req)::_0_579))
...
let desugar_pats = (fun env pats -> (FStar_List.map (fun es -> (FStar_All.pipe_right es (FStar_List.map (fun e -> (let _0_580 = (desugar_term env e)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _0_580)))))) pats))
in (match (tk) with
| (Some (a), k) -> begin
(
...
let body = (let _0_583 = (let _0_582 = (let _0_581 = (FStar_Syntax_Syntax.mk_binder a)
in (_0_581)::[])
in (no_annot_abs _0_582 body))
in (FStar_All.pipe_left setpos _0_583))
in (let _0_587 = FStar_Syntax_Syntax.Tm_app ((let _0_586 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range q b.FStar_Parser_AST.brange) (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) None)
in (let _0_585 = (let _0_584 = (FStar_Syntax_Syntax.as_arg body)
in (_0_584)::[])
in ((_0_586), (_0_585)))))
in (FStar_All.pipe_left mk _0_587)))))))
end))
end
| uu____5344 -> begin
(failwith "impossible")
...
let body = (let _0_589 = (q ((rest), (pats), (body)))
in (let _0_588 = (FStar_Range.union_ranges b'.FStar_Parser_AST.brange body.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term _0_589 _0_588 FStar_Parser_AST.Formula)))
in (let _0_590 = (q (((b)::[]), ([]), (body)))
in (FStar_Parser_AST.mk_term _0_590 f.FStar_Parser_AST.range FStar_Parser_AST.Formula))))
end
| uu____5400 -> begin
(failwith "impossible")
end))
...
in (let _0_591 = (push_quant (fun x -> FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env _0_591)))
end
| FStar_Parser_AST.QExists ((_1)::(_2)::_3, pats, body) -> begin
(

let binders = (_1)::(_2)::_3
in (let _0_592 = (push_quant (fun x -> FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env _0_592)))
end
...
| FStar_Parser_AST.TVariable (x) -> begin
(let _0_594 = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_unknown))) None x.FStar_Ident.idRange)
in ((Some (x)), (_0_594)))
end
| FStar_Parser_AST.NoName (t) -> begin
(let _0_595 = (desugar_typ env t)
in ((None), (_0_595)))
end
...
in FStar_Syntax_Syntax.Sig_declare_typ ((let _0_596 = (quals ((FStar_Syntax_Syntax.OnlyName)::(FStar_Syntax_Syntax.Discriminator (d))::[]))
in ((disc_name), ([]), (FStar_Syntax_Syntax.tun), (_0_596), ((FStar_Ident.range_of_lid disc_name))))))))))))
...
in (let _0_603 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i uu____5717 -> (match (uu____5717) with
| (x, uu____5722) -> begin
(
...
let only_decl = (((let _0_597 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Syntax_Const.prims_lid _0_597)) || (fvq <> FStar_Syntax_Syntax.Data_ctor)) || (FStar_Options.dont_gen_projectors (FStar_ToSyntax_Env.current_module env).FStar_Ident.str))
in (
...
| true -> begin
(let _0_598 = (FStar_List.filter (fun uu___196_5739 -> (match (uu___196_5739) with
...
in (FStar_Syntax_Syntax.Assumption)::_0_598)
end
| uu____5741 -> begin
q
end))
...
let lb = (let _0_599 = FStar_Util.Inr ((FStar_Syntax_Syntax.lid_as_fv field_name dd None))
in {FStar_Syntax_Syntax.lbname = _0_599; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = FStar_Syntax_Syntax.tun; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = FStar_Syntax_Syntax.tun})
in (

let impl = FStar_Syntax_Syntax.Sig_let ((let _0_602 = (let _0_601 = (let _0_600 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right _0_600 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (_0_601)::[])
in ((((false), ((lb)::[]))), (p), (_0_602), (quals), ([]))))
...
in (FStar_All.pipe_right _0_603 FStar_List.flatten))))
...
let lb = (let _0_607 = FStar_Util.Inr ((FStar_Syntax_Syntax.lid_as_fv lid dd None))
in (let _0_606 = (let _0_604 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_Syntax_Util.arrow typars _0_604))
in (let _0_605 = (no_annot_abs typars t)
in {FStar_Syntax_Syntax.lbname = _0_607; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = _0_606; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = _0_605})))
...
(let _0_608 = FStar_Parser_AST.Var ((FStar_Ident.lid_of_ids ((x)::[])))
in (FStar_Parser_AST.mk_term _0_608 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
...
in (FStar_List.fold_left (fun out b -> (let _0_610 = FStar_Parser_AST.App ((let _0_609 = (binder_to_term b)
in ((out), (_0_609), ((imp_of_aqual b)))))
in (FStar_Parser_AST.mk_term _0_610 out.FStar_Parser_AST.range out.FStar_Parser_AST.level))) t binders)))
in (
...
let result = (let _0_612 = (let _0_611 = FStar_Parser_AST.Var ((FStar_Ident.lid_of_ids ((id)::[])))
in (FStar_Parser_AST.mk_term _0_611 id.FStar_Ident.idRange FStar_Parser_AST.Type_level))
in (apply_binders _0_612 parms))
in (
...
in (let _0_613 = (FStar_All.pipe_right fields (FStar_List.map (fun uu____6109 -> (match (uu____6109) with
| (x, uu____6115, uu____6116) -> begin
(FStar_Syntax_Util.unmangle_field_name x)
end))))
in ((FStar_Parser_AST.TyconVariant (((id), (parms), (kopt), ((((constrName), (Some (constrTyp)), (None), (false)))::[])))), (_0_613)))))))
end
| uu____6119 -> begin
(failwith "impossible")
end))
...
let tconstr = (let _0_615 = (let _0_614 = FStar_Parser_AST.Var ((FStar_Ident.lid_of_ids ((id)::[])))
in (FStar_Parser_AST.mk_term _0_614 id.FStar_Ident.idRange FStar_Parser_AST.Type_level))
in (apply_binders _0_615 binders))
in (
...
| uu____6377 -> begin
((let _0_617 = (FStar_Range.string_of_range rng)
in (let _0_616 = (FStar_Syntax_Print.lid_to_string l)
...
| uu____6382 -> begin
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((let _0_618 = (FStar_Syntax_Syntax.mk_Total k)
in ((typars), (_0_618)))))) None rng)
end)
...
(let _0_619 = (desugar_attributes env cattributes)
in (((FStar_Parser_AST.mk_term (FStar_Parser_AST.Construct (((head), (args)))) t.FStar_Parser_AST.range t.FStar_Parser_AST.level)), (_0_619)))
end))
end
| uu____6527 -> begin
((t), ([]))
...
in FStar_Syntax_Syntax.Sig_effect_abbrev ((let _0_621 = (FStar_ToSyntax_Env.qualify env id)
in (let _0_620 = (FStar_All.pipe_right quals (FStar_List.filter (fun uu___204_6543 -> (match (uu___204_6543) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| uu____6544 -> begin
...
in ((_0_621), ([]), (typars), (c), (_0_620), ((FStar_List.append cattributes (FStar_Syntax_Util.comp_flags c))), (rng))))))))
end))
end
| uu____6545 -> begin
(
...
| (t, fs) -> begin
(let _0_624 = (let _0_623 = FStar_Syntax_Syntax.RecordType ((let _0_622 = (FStar_Ident.ids_of_lid (FStar_ToSyntax_Env.current_module env))
in ((_0_622), (fs))))
in (_0_623)::quals)
in (desugar_tycon env rng _0_624 ((t)::[])))
end)))
end
...
| (t, fs) -> begin
(let _0_627 = (let _0_626 = FStar_Syntax_Syntax.RecordType ((let _0_625 = (FStar_Ident.ids_of_lid (FStar_ToSyntax_Env.current_module env))
in ((_0_625), (fs))))
in (_0_626)::quals)
in (collect_tcs _0_627 ((env), (tcs)) t))
end)))
end
...
in (let _0_629 = (let _0_628 = (mk_typ_abbrev id uvs tpars k t ((id)::[]) quals rng)
in (([]), (_0_628)))
in (_0_629)::[]))
end
...
let uu____7563 = (let _0_635 = (FStar_All.pipe_right constrs (FStar_List.map (fun uu____7629 -> (match (uu____7629) with
...
let t = (let _0_630 = (close env_tps t)
in (desugar_term env_tps _0_630))
in (
...
in (let _0_634 = (let _0_633 = FStar_Syntax_Syntax.Sig_datacon ((let _0_632 = (let _0_631 = (FStar_Syntax_Syntax.mk_Total (FStar_All.pipe_right t FStar_Syntax_Util.name_function_binders))
in (FStar_Syntax_Util.arrow data_tpars _0_631))
in ((name), (univs), (_0_632), (tname), (ntps), (quals), (mutuals), (rng))))
in ((tps), (_0_633)))
in ((name), (_0_634))))))))
end))))
in (FStar_All.pipe_left FStar_List.split _0_635))
...
let uu____7783 = (let _0_636 = (FStar_List.collect FStar_Syntax_Util.lids_of_sigelt sigelts)
in (FStar_Syntax_MutRecTy.disentangle_abbrevs_from_bundle sigelts quals _0_636 rng))
...
| (env, a) -> begin
(let _0_638 = (let _0_637 = (FStar_Syntax_Syntax.mk_binder (
...
| (env, ses) -> begin
(let _0_640 = (let _0_639 = (FStar_List.hd ses)
in (_0_639)::out)
in ((env), (_0_640)))
end))
end)) ((env), ([]))))
...
(let _0_645 = (FStar_ToSyntax_Env.qualify env name)
in (let _0_644 = (let _0_641 = (desugar_term env def)
in (FStar_Syntax_Subst.close binders _0_641))
in (let _0_643 = (let _0_642 = (desugar_typ env cps_type)
in (FStar_Syntax_Subst.close binders _0_642))
in {FStar_Syntax_Syntax.action_name = _0_645; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_defn = _0_644; FStar_Syntax_Syntax.action_typ = _0_643})))
end
...
(let _0_648 = (FStar_ToSyntax_Env.qualify env name)
in (let _0_647 = (let _0_646 = (desugar_term env defn)
in (FStar_Syntax_Subst.close binders _0_646))
in {FStar_Syntax_Syntax.action_name = _0_648; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_defn = _0_647; FStar_Syntax_Syntax.action_typ = FStar_Syntax_Syntax.tun}))
end
| uu____8110 -> begin
...
in (let _0_650 = (let _0_649 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_definition env) l)
in (FStar_All.pipe_left (FStar_Syntax_Subst.close binders) _0_649))
in (([]), (_0_650)))))
in (
...
in FStar_Syntax_Syntax.Sig_new_effect ((let _0_670 = (let _0_669 = (lookup "return_wp")
in (let _0_668 = (lookup "bind_wp")
in (let _0_667 = (lookup "if_then_else")
in (let _0_666 = (lookup "ite_wp")
in (let _0_665 = (lookup "stronger")
in (let _0_664 = (lookup "close_wp")
in (let _0_663 = (lookup "assert_p")
in (let _0_662 = (lookup "assume_p")
in (let _0_661 = (lookup "null_wp")
in (let _0_660 = (lookup "trivial")
in (let _0_659 = (match (rr) with
| true -> begin
(let _0_656 = (lookup "repr")
in (FStar_All.pipe_left Prims.snd _0_656))
end
| uu____8156 -> begin
FStar_Syntax_Syntax.tun
end)
in (let _0_658 = (match (rr) with
| true -> begin
(lookup "return")
end
| uu____8157 -> begin
...
in {FStar_Syntax_Syntax.qualifiers = qualifiers; FStar_Syntax_Syntax.cattributes = []; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = eff_k; FStar_Syntax_Syntax.ret_wp = _0_669; FStar_Syntax_Syntax.bind_wp = _0_668; FStar_Syntax_Syntax.if_then_else = _0_667; FStar_Syntax_Syntax.ite_wp = _0_666; FStar_Syntax_Syntax.stronger = _0_665; FStar_Syntax_Syntax.close_wp = _0_664; FStar_Syntax_Syntax.assert_p = _0_663; FStar_Syntax_Syntax.assume_p = _0_662; FStar_Syntax_Syntax.null_wp = _0_661; FStar_Syntax_Syntax.trivial = _0_660; FStar_Syntax_Syntax.repr = _0_659; FStar_Syntax_Syntax.return_repr = _0_658; FStar_Syntax_Syntax.bind_repr = _0_657; FStar_Syntax_Syntax.actions = actions})))))))))))))
...
let env = (FStar_All.pipe_right actions (FStar_List.fold_left (fun env a -> (let _0_671 = (FStar_Syntax_Util.action_as_lb mname a)
in (FStar_ToSyntax_Env.push_sigelt env _0_671))) env))
in (
...
| uu____8237 -> begin
(Prims.raise (FStar_Errors.Error ((let _0_674 = (let _0_673 = (let _0_672 = (FStar_Parser_AST.term_to_string head)
in (Prims.strcat _0_672 " not found"))
in (Prims.strcat "Effect " _0_673))
in ((_0_674), (d.FStar_Parser_AST.drange))))))
end)
in (
...
| (cattributes, args) -> begin
(let _0_676 = (desugar_args env args)
in (let _0_675 = (desugar_attributes env cattributes)
in ((ed), (_0_676), (_0_675))))
end)))
end))
...
in (let _0_678 = (let _0_677 = (FStar_Syntax_Subst.subst s x)
in (FStar_Syntax_Subst.close binders _0_677))
in (([]), (_0_678))));
)
end))
end))
...
let ed = (let _0_698 = (let _0_679 = (trans_qual (Some (mname)))
in (FStar_List.map _0_679 quals))
in (let _0_697 = (Prims.snd (sub (([]), (ed.FStar_Syntax_Syntax.signature))))
in (let _0_696 = (sub ed.FStar_Syntax_Syntax.ret_wp)
in (let _0_695 = (sub ed.FStar_Syntax_Syntax.bind_wp)
in (let _0_694 = (sub ed.FStar_Syntax_Syntax.if_then_else)
in (let _0_693 = (sub ed.FStar_Syntax_Syntax.ite_wp)
in (let _0_692 = (sub ed.FStar_Syntax_Syntax.stronger)
in (let _0_691 = (sub ed.FStar_Syntax_Syntax.close_wp)
in (let _0_690 = (sub ed.FStar_Syntax_Syntax.assert_p)
in (let _0_689 = (sub ed.FStar_Syntax_Syntax.assume_p)
in (let _0_688 = (sub ed.FStar_Syntax_Syntax.null_wp)
in (let _0_687 = (sub ed.FStar_Syntax_Syntax.trivial)
in (let _0_686 = (Prims.snd (sub (([]), (ed.FStar_Syntax_Syntax.repr))))
in (let _0_685 = (sub ed.FStar_Syntax_Syntax.return_repr)
in (let _0_684 = (sub ed.FStar_Syntax_Syntax.bind_repr)
in (let _0_683 = (FStar_List.map (fun action -> (let _0_682 = (FStar_ToSyntax_Env.qualify env action.FStar_Syntax_Syntax.action_unqualified_name)
in (let _0_681 = (Prims.snd (sub (([]), (action.FStar_Syntax_Syntax.action_defn))))
in (let _0_680 = (Prims.snd (sub (([]), (action.FStar_Syntax_Syntax.action_typ))))
in {FStar_Syntax_Syntax.action_name = _0_682; FStar_Syntax_Syntax.action_unqualified_name = action.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = action.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_defn = _0_681; FStar_Syntax_Syntax.action_typ = _0_680})))) ed.FStar_Syntax_Syntax.actions)
in {FStar_Syntax_Syntax.qualifiers = _0_698; FStar_Syntax_Syntax.cattributes = cattributes; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = _0_697; FStar_Syntax_Syntax.ret_wp = _0_696; FStar_Syntax_Syntax.bind_wp = _0_695; FStar_Syntax_Syntax.if_then_else = _0_694; FStar_Syntax_Syntax.ite_wp = _0_693; FStar_Syntax_Syntax.stronger = _0_692; FStar_Syntax_Syntax.close_wp = _0_691; FStar_Syntax_Syntax.assert_p = _0_690; FStar_Syntax_Syntax.assume_p = _0_689; FStar_Syntax_Syntax.null_wp = _0_688; FStar_Syntax_Syntax.trivial = _0_687; FStar_Syntax_Syntax.repr = _0_686; FStar_Syntax_Syntax.return_repr = _0_685; FStar_Syntax_Syntax.bind_repr = _0_684; FStar_Syntax_Syntax.actions = _0_683}))))))))))))))))
in (
...
let env = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.actions (FStar_List.fold_left (fun env a -> (let _0_699 = (FStar_Syntax_Util.action_as_lb mname a)
in (FStar_ToSyntax_Env.push_sigelt env _0_699))) env))
in (
...
(let _0_700 = (FStar_ToSyntax_Env.push_module_abbrev env x l)
in ((_0_700), ([])))
end
...
in (let _0_701 = (FStar_List.map (trans_qual None) quals)
in (desugar_tycon env d.FStar_Parser_AST.drange _0_701 tcs))))
end
...
| true -> begin
(let _0_702 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (
...
let s = FStar_Syntax_Syntax.Sig_let ((let _0_703 = (FStar_All.pipe_right fvs (FStar_List.map (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in ((lbs), (d.FStar_Parser_AST.drange), (_0_703), (quals), (attrs))))
in (
...
let main = (let _0_704 = FStar_Parser_AST.Var ((FStar_Ident.lid_of_ids ((fresh_toplevel_name)::[])))
in (FStar_Parser_AST.mk_term _0_704 FStar_Range.dummyRange FStar_Parser_AST.Expr))
in (
...
let bvs = (let _0_705 = (gather_pattern_bound_vars pat)
in (FStar_All.pipe_right _0_705 FStar_Util.set_elements))
...
in (let _0_708 = (let _0_707 = FStar_Syntax_Syntax.Sig_assume ((let _0_706 = (FStar_ToSyntax_Env.qualify env id)
in ((_0_706), (f), ((FStar_Syntax_Syntax.Assumption)::[]), (d.FStar_Parser_AST.drange))))
in (_0_707)::[])
in ((env), (_0_708))))
end
...
let t = (let _0_709 = (close_fun env t)
in (desugar_term env _0_709))
in (
...
let se = FStar_Syntax_Syntax.Sig_declare_typ ((let _0_711 = (FStar_ToSyntax_Env.qualify env id)
in (let _0_710 = (FStar_List.map (trans_qual None) quals)
in ((_0_711), ([]), (t), (_0_710), (d.FStar_Parser_AST.drange)))))
in (
...
let t = (let _0_715 = (let _0_712 = (FStar_Syntax_Syntax.null_binder t)
in (_0_712)::[])
in (let _0_714 = (let _0_713 = (Prims.fst (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_lid env) FStar_Syntax_Const.exn_lid))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total _0_713))
in (FStar_Syntax_Util.arrow _0_715 _0_714)))
in (
...
| None -> begin
(Prims.raise (FStar_Errors.Error ((let _0_718 = (let _0_717 = (let _0_716 = (FStar_Syntax_Print.lid_to_string l)
in (Prims.strcat _0_716 " not found"))
in (Prims.strcat "Effect name " _0_717))
in ((_0_718), (d.FStar_Parser_AST.drange))))))
end
| Some (l) -> begin
l
end)))
...
(let _0_720 = Some ((let _0_719 = (desugar_term env t)
in (([]), (_0_719))))
in ((_0_720), (None)))
end
| FStar_Parser_AST.ReifiableLift (wp, t) -> begin
(let _0_724 = Some ((let _0_721 = (desugar_term env wp)
in (([]), (_0_721))))
in (let _0_723 = Some ((let _0_722 = (desugar_term env t)
in (([]), (_0_722))))
in ((_0_724), (_0_723))))
end
| FStar_Parser_AST.LiftForFree (t) -> begin
(let _0_726 = Some ((let _0_725 = (desugar_term env t)
in (([]), (_0_725))))
in ((None), (_0_726)))
end)
...
(let _0_727 = (FStar_ToSyntax_Env.prepare_module_or_interface true admitted env mname)
in ((_0_727), (mname), (decls), (true)))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(let _0_728 = (FStar_ToSyntax_Env.prepare_module_or_interface false false env mname)
in ((_0_728), (mname), (decls), (false)))
end)
...
let uu____9087 = ((FStar_Options.interactive ()) && (let _0_729 = (FStar_Util.get_file_extension (FStar_List.hd (FStar_Options.file_list ())))
in (_0_729 = "fsti")))
...
| true -> begin
(let _0_730 = (FStar_Syntax_Print.modul_to_string modul)
in (FStar_Util.print1 "%s\n" _0_730))
end
| uu____9130 -> begin
()
end));
(let _0_731 = (match (pop_when_done) with
| true -> begin
