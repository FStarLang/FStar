    ...
    fun s  ->
      fun r  ->
        let uu___ =
          let uu___1 =
            let uu___2 =
              let uu___3 = FStar_Parser_AST.compile_op n s r  in (uu___3, r)
               in
      ...
      FStar_Util.remove_dups
        (fun x  ->
           fun y  ->
             ...
             let uu___2 = FStar_Ident.string_of_id y  in uu___1 = uu___2) ftv
       in
    FStar_All.pipe_left
              ...
              FStar_List.collect
                (fun uu___5  ->
                   ...
                   | FStar_Parser_AST.CalcStep (rel1,just,next) ->
                       ...
                       FStar_List.append uu___6 uu___7) steps
               in
      ...
      then t
        ...
        (let binders =
           FStar_All.pipe_right ftv
            ...
            in
         let t1 =
           let uu___1 = let uu___2 = unparen t  in uu___2.FStar_Parser_AST.tm
              in
           match uu___1 with
      ...
      fun p  ->
        ...
        | FStar_Parser_AST.PatApp
            ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (id,uu___);
               FStar_Parser_AST.prange = uu___1;_},args)
            when is_top_level ->
            let uu___2 =
  ...
  fun acc  ->
    fun p  ->
      ...
      | FStar_Parser_AST.PatRecord guarded_pats ->
          let uu___ = FStar_List.map FStar_Pervasives_Native.snd guarded_pats
             in
      ...
      (fun id1  ->
         fun id2  ->
           let uu___ =
             ...
             let uu___2 = FStar_Ident.string_of_id id2  in uu___1 = uu___2
              in
           if uu___ then Prims.int_zero else Prims.int_one)
     in
...
let rec (generalize_annotated_univs :
  ...
  fun s  ->
    let bs_univnames bs =
      let uu___ =
        let uu___1 = FStar_Util.new_set FStar_Syntax_Syntax.order_univ_name
           in
        FStar_List.fold_left
          (fun uvs  ->
             fun uu___2  ->
               ...
               | ({ FStar_Syntax_Syntax.ppname = uu___3;
                    ...
                    FStar_Syntax_Syntax.sort = t;_},uu___5)
                   ->
                   let uu___6 = FStar_Syntax_Free.univnames t  in
                   FStar_Util.set_union uvs uu___6) uu___1
         in
                    ...
                    fun se  ->
                      let se_univs =
                        ...
                        | uu___1 ->
                         ...
                         in
                      FStar_Util.set_union uvs1 se_univs) empty_set)
             in
                ...
                (FStar_List.map
                   (fun se  ->
                      ...
                      | FStar_Syntax_Syntax.Sig_datacon
                          ...
                          let uu___6 =
                            let uu___7 =
                              let uu___8 = FStar_Syntax_Subst.subst usubst t
                                 in
              ...
              (FStar_List.fold_left
                 (fun uvs  ->
                    fun lb  ->
                      ...
                      FStar_Util.set_union uvs uu___1) empty_set)
             in
          FStar_All.pipe_right uu___ FStar_Util.set_elements  in
  ...
  fun t  ->
    ...
    | FStar_Parser_AST.App uu___1 ->
        let rec aux t1 univargs =
          let uu___2 = let uu___3 = unparen t1  in uu___3.FStar_Parser_AST.tm
             in
          match uu___2 with
          ...
          | uu___3 ->
              ...
              FStar_Errors.raise_error uu___4 t1.FStar_Parser_AST.range
           in
        aux t []
    | uu___1 ->
        let uu___2 =
      ...
      fun p  ->
        let resolvex l e x =
          ...
          | uu___1 ->
              ...
              (match uu___2 with | (e1,xbv) -> ((xbv :: l), e1, xbv))
           in
        let rec aux' top loc env1 p1 =
              ...
              let id_op =
                let uu___ =
                  let uu___1 =
                    let uu___2 = FStar_Ident.string_of_id op  in
                    let uu___3 = FStar_Ident.range_of_id op  in
                    FStar_Parser_AST.compile_op Prims.int_zero uu___2 uu___3
                     in
          ...
          | FStar_Parser_AST.PatApp
              ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatName l;
                 FStar_Parser_AST.prange = uu___;_},args)
              ->
              let uu___1 =
                   ...
                   let x =
                     ...
                     FStar_Syntax_Syntax.new_bv
                       (FStar_Pervasives_Native.Some
                          (p1.FStar_Parser_AST.prange)) uu___2
                      in
                   let uu___2 =
                     FStar_All.pipe_left pos
              ...
              (match uu___ with
               | (loc1,env2,annots,pats1) ->
                   ...
                   let x =
                     ...
                     FStar_Syntax_Syntax.new_bv
                       (FStar_Pervasives_Native.Some
                          (p1.FStar_Parser_AST.prange)) uu___1
                      in
                   (loc1, env2,
                             ...
                             | FStar_Pervasives_Native.None  ->
                                 FStar_Parser_AST.mk_pattern
                                   (FStar_Parser_AST.PatWild
                                      FStar_Pervasives_Native.None)
                                   p1.FStar_Parser_AST.prange
                             | FStar_Pervasives_Native.Some (uu___3,p2) -> p2)))
                 in
              let app =
                let uu___ =
                  let uu___1 =
                ...
                FStar_Parser_AST.mk_pattern uu___ p1.FStar_Parser_AST.prange
                 in
        ...
        match uu___ with
        | (env1,b,pats) ->
            ((let uu___2 = FStar_List.map FStar_Pervasives_Native.fst pats
                 in
        ...
        then
          ...
          | FStar_Parser_AST.PatAscribed
              ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatOp x;
                 FStar_Parser_AST.prange = uu___;_},(t,tacopt))
              ->
          ...
          | FStar_Parser_AST.PatAscribed
              ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (x,uu___);
                 FStar_Parser_AST.prange = uu___1;_},(t,tacopt))
              ->
              let tacopt1 = FStar_Util.map_opt tacopt (desugar_term env)  in
               ...
               let p2 =
                 ...
                 | ({
                      FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var
                        uu___2;
                      FStar_Syntax_Syntax.p = uu___3;_},uu___4)::[]
                     -> []
                 | ({
               ...
               (let private_intro_nm =
                      ...
                      let uu___3 =
                        let uu___4 =
                          FStar_Util.format1
                            ...
                            tnm
                           in
                        (FStar_Errors.Fatal_UnexpectedNumericLiteral, uu___4)
                         in
                      FStar_Errors.raise_error uu___3 range
                   in
                let repr1 =
                  FStar_Syntax_Syntax.mk
                ...
                let uu___2 =
                  let uu___3 =
                    let uu___4 =
                      let uu___5 =
                        let uu___6 = FStar_Syntax_Syntax.as_implicit false
                           in
                        (repr1, uu___6)  in
                      [uu___5]  in
                    (lid1, uu___4)  in
  ...
  fun top_level  ->
    fun env  ->
      fun top  ->
        ...
        let uu___ = let uu___1 = unparen top  in uu___1.FStar_Parser_AST.tm
           in
        match uu___ with
        ...
        | FStar_Parser_AST.Op (op_star,lhs::rhs::[]) when
            ...
            let rec flatten t =
              ...
              | FStar_Parser_AST.Op (id,t1::t2::[]) when
                  (let uu___1 = FStar_Ident.string_of_id id  in uu___1 = "*")
                    &&
                    (let uu___1 = op_as_term env (Prims.of_int (2)) op_star
                        in
                     FStar_All.pipe_right uu___1 FStar_Option.isNone)
                  ->
             ...
             | FStar_Pervasives_Native.None  ->
                 let uu___2 =
                   let uu___3 =
                     ...
                     Prims.op_Hat "Unexpected or unbound operator: " uu___4
                      in
                   (FStar_Errors.Fatal_UnepxectedOrUnboundOperator, uu___3)
                    in
                ...
                let uu___5 =
                  let uu___6 =
                    let uu___7 =
                      let uu___8 = top  in
                      let uu___9 =
                        let uu___10 = smt_pat_lid top.FStar_Parser_AST.range
                           in
              ...
              let uu___4 =
                let uu___5 =
                  let uu___6 =
                    let uu___7 = top  in
                    let uu___8 =
                      let uu___9 = smt_pat_or_lid top.FStar_Parser_AST.range
                         in
                      FStar_Parser_AST.Var uu___9  in
                    {
                      FStar_Parser_AST.tm = uu___8;
        ...
        | FStar_Parser_AST.Var l ->
            let uu___1 = desugar_name mk setpos env true l  in
            (uu___1, noaqs)
        | FStar_Parser_AST.Name l ->
            let uu___1 = desugar_name mk setpos env true l  in
            (uu___1, noaqs)
             ...
             | uu___1 ->
                 let uu___2 =
                   let uu___3 =
                     ...
                     FStar_Util.format1
                       "Data constructor or effect %s not found" uu___4
                      in
                  ...
                  | uu___2 ->
                      let uu___3 =
                        FStar_Util.take
                          (fun uu___4  ->
                             match uu___4 with
                             | (uu___5,imp) -> imp = FStar_Parser_AST.UnivApp)
                          args
                         in
                      (match uu___3 with
                       | (universes,args1) ->
                             ...
                             let uu___5 =
                               FStar_List.map
                                 (fun uu___6  ->
                                    match uu___6 with
                                    | (t,imp) ->
                                        let uu___7 = desugar_term_aq env t
                                           in
                                        (match uu___7 with
                                         | (te,aq) ->
             ...
             | FStar_Pervasives_Native.None  ->
                 let err =
                   ...
                   | FStar_Pervasives_Native.Some uu___3 ->
                       ...
                       (FStar_Errors.Fatal_UnexpectedEffect, uu___4)
                    in
                ...
                FStar_All.pipe_right binders
                  (FStar_List.map
                     (fun uu___2  ->
                        match uu___2 with
                        | FStar_Util.Inr x -> x
                        | FStar_Util.Inl uu___3 -> failwith "Impossible"))
                 in
                 ...
                 let tup =
                   let uu___2 =
                     FStar_Parser_Const.mk_tuple_lid
                      ...
                      in
                   FStar_Syntax_DsEnv.fail_or env
                     (FStar_Syntax_DsEnv.try_lookup_lid env) uu___2
                    in
                 let uu___2 = mk (FStar_Syntax_Syntax.Tm_app (tup, targs))
                    in
                 (uu___2, (join_aqs aqs)))
            ...
            let uu___1 =
              let uu___2 =
                let uu___3 =
                  let uu___4 =
                    FStar_All.pipe_left
                      (fun uu___5  -> FStar_Util.Inl uu___5)
                              ...
                              (match uu___5 with
                               | (env2,x) ->
                                   let uu___6 =
                                     let uu___7 =
                                       let uu___8 =
                                         let uu___9 = no_annot_abs tparams t1
                                            in
                                         FStar_All.pipe_left
                 ...
                 let tup =
                   let uu___3 =
                     FStar_Parser_Const.mk_dtuple_lid
                      ...
                      in
                   FStar_Syntax_DsEnv.fail_or env1
                     (FStar_Syntax_DsEnv.try_lookup_lid env1) uu___3
                    in
                 let uu___3 =
        ...
        | FStar_Parser_AST.Refine (b,f) ->
            ...
            (match uu___1 with
             ...
             | b1 ->
                 let uu___2 = as_binder env FStar_Pervasives_Native.None b1
                    in
                 (match uu___2 with
                  | ((x,uu___3),env1) ->
                  ...
                  let uu___3 =
                    let uu___4 =
                      ...
                      FStar_Util.format1
                        ...
                        uu___5
                       in
                    (FStar_Errors.Fatal_NonLinearPatternNotPermitted, uu___4)
                     in
                                   ...
                                   let body3 =
                                     let uu___5 =
                                       ...
                                       FStar_All.pipe_right uu___6
                                        ...
                                        in
                                     FStar_Syntax_Subst.close uu___5 body1
                                      in
                                   FStar_Syntax_Syntax.mk
                                          ...
                                          | (FStar_Syntax_Syntax.Tm_name
                                             uu___6,uu___7) ->
                                              ...
                                              FStar_Pervasives_Native.Some
                                                (sc1, p2)
                                          | (FStar_Syntax_Syntax.Tm_app
                                             (uu___6,args),FStar_Syntax_Syntax.Pat_cons
                                             (uu___7,pats1)) ->
                                              let tupn =
                                                let uu___8 =
                                                  FStar_Parser_Const.mk_tuple_data_lid
                                    ...
                                    | FStar_Parser_AST.PatAscribed
                                        ({
                                           FStar_Parser_AST.pat =
                                             FStar_Parser_AST.PatVar
                                             (id,uu___6);
                                           FStar_Parser_AST.prange = uu___7;_},t)
                                        ->
                                        if top_level
                                        then
                                          let uu___8 =
                     ...
                     fun uu___4  ->
                       ...
                       | ((env1,fnames,rec_bindings,used_markers),(_attr_opt,
                           ...
                           let uu___8 =
                             ...
                             | FStar_Util.Inr l ->
                                 let uu___9 =
                                   let uu___10 = FStar_Ident.ident_of_lid l
                                      in
                                  ...
                                  let body2 =
                                    ...
                                    | ({
                                         FStar_Syntax_Syntax.v =
                                           ...
                                           uu___6;
                                         FStar_Syntax_Syntax.p = uu___7;_},uu___8)::[]
                                        -> body1
                                    | uu___6 ->
                                        let uu___7 =
                                          let uu___8 =
                                            ...
                                            let uu___10 =
                                              desugar_disjunctive_pattern
                                               ...
                                               in
                                            (uu___9, uu___10)  in
                                          FStar_Syntax_Syntax.Tm_match uu___8
                                           in
             ...
             | (t1',aq1) ->
                 let t1'1 =
                   FStar_Syntax_Util.ascribe t1'
                     ((FStar_Util.Inl t_bool), FStar_Pervasives_Native.None)
                    in
        ...
        | FStar_Parser_AST.Ascribed (e,t,tac_opt) ->
            let uu___1 =
              ...
              then
                ...
                (let uu___4 = desugar_term_aq env t  in
                 match uu___4 with | (tm,aq) -> ((FStar_Util.Inl tm), aq))
               in
            (match uu___1 with
             | (annot,aq0) ->
                       ...
                       let uu___1 =
                         let uu___2 =
                           ...
                           FStar_Util.format2
                             ...
                             uu___4
                            in
                         (FStar_Errors.Fatal_MissingFieldInRecord, uu___2)
                          in
                                  ...
                                  let uu___5 =
                                    let uu___6 =
                                      get_field FStar_Pervasives_Native.None
                                       ...
                                       in
                                    FStar_All.pipe_left
                                      FStar_Pervasives_Native.snd uu___6
                                     in
                      ...
                      let uu___3 =
                        let uu___4 =
                          let uu___5 =
                            ...
                            FStar_Parser_AST.mk_pattern
                              (FStar_Parser_AST.PatVar
                                 (x, FStar_Pervasives_Native.None)) uu___6
                             in
                          (uu___5, e)  in
                 ...
                 (match e.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Tm_app
                      ({
                         ...
                         FStar_Syntax_Syntax.vars = uu___3;_},args)
                      ->
                      let uu___4 =
                        let uu___5 =
                          let uu___6 =
                            let uu___7 =
                              ...
                              FStar_Syntax_Syntax.fvar uu___8
                                FStar_Syntax_Syntax.delta_constant uu___9
                               in
                            (uu___7, args)  in
             ...
             | uu___2 ->
                 let uu___3 =
                   let uu___4 =
                     ...
                     Prims.op_Hat "VQuote, expected an fvar, got: " uu___5
                      in
        ...
        | FStar_Parser_AST.Antiquote e ->
            ...
            let uu___2 =
              let uu___3 = let uu___4 = desugar_term env e  in (bv, uu___4)
                 in
              [uu___3]  in
            (uu___1, uu___2)
        | FStar_Parser_AST.Quote (e,FStar_Parser_AST.Dynamic ) ->
            ...
            let uu___1 =
              let uu___2 =
                let uu___3 = let uu___4 = desugar_term env e  in (uu___4, qi)
                   in
                         ...
                         let pf =
                           let uu___4 =
                             let uu___5 =
                                   ...
                                   let uu___9 =
                                     let uu___10 =
                                       let uu___11 =
                                         ...
                                         (uu___12, FStar_Parser_AST.Nothing)
                                          in
                                       let uu___12 =
                                         let uu___13 =
                                           let uu___14 =
                               ...
                               (init_expr, FStar_Parser_AST.Hash) :: uu___6
                                in
                             ((wild rel2.FStar_Parser_AST.range),
                               FStar_Parser_AST.Hash) :: uu___5
                              in
                           FStar_Parser_AST.mkApp
      ...
      FStar_All.pipe_right args
        (FStar_List.map
           (fun uu___  ->
              match uu___ with
              | (a,imp) ->
                  let uu___1 = desugar_term env a  in
                  arg_withimp_e imp uu___1))
                ...
                (match uu___2 with
                 | FStar_Parser_AST.App
                     ({ FStar_Parser_AST.tm = FStar_Parser_AST.Var d;
                        ...
                        FStar_Parser_AST.level = uu___4;_},uu___5,uu___6)
                     ->
                     let uu___7 =
            ...
            | (t1,uu___1) ->
                ...
                (match uu___2 with
                 | FStar_Parser_AST.Construct
                     (cons,({
                              FStar_Parser_AST.tm =
                                FStar_Parser_AST.Construct (smtpat,uu___3);
                              FStar_Parser_AST.range = uu___4;
                              FStar_Parser_AST.level = uu___5;_},uu___6)::uu___7::[])
                     ->
                     (FStar_Ident.lid_equals cons FStar_Parser_Const.cons_lid)
                       &&
                       (FStar_Util.for_some
                          (fun s  ->
                             let uu___8 = FStar_Ident.string_of_lid smtpat
                                in
                 ...
                 | FStar_Parser_AST.Construct
                     ...
                     (FStar_Ident.lid_equals cons FStar_Parser_Const.cons_lid)
                       ...
                       (FStar_Util.for_some
                          (fun s  ->
                             let uu___7 = FStar_Ident.string_of_lid smtpat
                                in
                 ...
                 | uu___1 when allow_type_promotion ->
                     let default_effect =
                       ...
                       then FStar_Parser_Const.effect_ML_lid
                         ...
                         ((let uu___5 = FStar_Options.warn_default_effects ()
                              in
                           if uu___5
                           then
               ...
               (let is_universe uu___2 =
                ...
                | (universes,args1) ->
                    ...
                    let uu___3 =
                      ...
                      let uu___5 = FStar_List.tl args1  in (uu___4, uu___5)
                       in
                    (match uu___3 with
                     | (result_arg,rest) ->
                         let result_typ =
                                            ...
                                            (match t1.FStar_Syntax_Syntax.n
                                             ...
                                             | FStar_Syntax_Syntax.Tm_app
                                                 ...
                                                 FStar_Syntax_Syntax.DECREASES
                                                   arg
                                             | uu___7 -> failwith "impos")))
                                 in
                              let no_additional_args =
                                let is_empty l =
                                  match l with | [] -> true | uu___5 -> false
                                   in
                             ...
                             FStar_All.pipe_right es
                               (FStar_List.map
                                  (fun e  ->
                                     ...
                                     FStar_All.pipe_left
                                       (arg_withimp_t
                                          FStar_Parser_AST.Nothing) uu___2))))
                      in
                   mk
                     (FStar_Syntax_Syntax.Tm_meta
                        (body1,
            ...
            let body1 =
              ...
              let uu___1 =
                FStar_Range.union_ranges b'.FStar_Parser_AST.brange
                 ...
                 in
              FStar_Parser_AST.mk_term uu___ uu___1 FStar_Parser_AST.Formula
               in
  ...
  fun env  ->
    fun b  ->
      ...
      | FStar_Parser_AST.Variable x ->
          let uu___ = let uu___1 = FStar_Ident.range_of_id x  in tun_r uu___1
             in
          ((FStar_Pervasives_Native.Some x), uu___)
...
let (binder_ident :
  ...
  fun b  ->
    match b.FStar_Parser_AST.b with
    | FStar_Parser_AST.TAnnotated (x,uu___) -> FStar_Pervasives_Native.Some x
                            ...
                            let only_decl =
                              ((let uu___3 =
                                ...
                                (let uu___3 =
                                 ...
                                 FStar_Options.dont_gen_projectors uu___3)
                               in
                            let no_decl =
...
let (mk_data_projector_names :
  ...
  fun iquals  ->
    fun env  ->
      fun se  ->
        match se.FStar_Syntax_Syntax.sigel with
        | FStar_Syntax_Syntax.Sig_datacon (lid,uu___,t,uu___1,n,uu___2) when
            let uu___3 =
      ...
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___ =
            ...
            | FStar_Parser_AST.TyconVariant (id,uu___1,uu___2,uu___3) -> id
             in
            ...
            | FStar_Parser_AST.TyconRecord (id,parms,kopt,fields) ->
                ...
                let constrTyp =
                  ...
                  FStar_Parser_AST.mk_term
                    ...
                    FStar_Parser_AST.Type_level
                   in
                let names = let uu___1 = binder_idents parms  in id :: uu___1
                   in
                (FStar_List.iter
                   (fun uu___2  ->
                      match uu___2 with
               ...
               | (t,fs) ->
                   let uu___2 =
                     let uu___3 =
                       let uu___4 =
                         let uu___5 =
                           let uu___6 = FStar_Syntax_DsEnv.current_module env
                              in
                          ...
                          (fun uu___3  ->
                             ...
                             | FStar_Util.Inr
                                 ({
                                    ...
                                    FStar_Syntax_Syntax.sigopts = uu___10;_},binders,t,quals1)
                                 ->
                                 let t1 =
                                   let uu___11 =
                                   ...
                                   match uu___11 with
                                   | (env2,tpars1) ->
                                       let uu___12 = push_tparams env2 tpars1
                                          in
                                       (match uu___12 with
                                        | (env_tps,tpars2) ->
                                            let t2 = desugar_typ env_tps t
                                               in
                                            let tpars3 =
                          ...
                          FStar_All.pipe_right sigelts
                            (FStar_List.collect
                               (fun se  ->
                                  match se.FStar_Syntax_Syntax.sigel with
                                  | FStar_Syntax_Syntax.Sig_inductive_typ
                                      (tname,uu___4,tps,k,uu___5,constrs) ->
                                      let quals1 =
                                                      ...
                                                      FStar_All.pipe_right
                                                        ...
                                                        (FStar_List.find
                                                           (fun se1  ->
                                                              ...
                                                              with
                                                              | FStar_Syntax_Syntax.Sig_datacon
                                                                  (name,uu___8,uu___9,uu___10,uu___11,uu___12)
                                                                  ->
                                                                  FStar_Ident.lid_equals
                                                                    name
                                                                    data_lid
    ...
    fun binders  ->
      let uu___ =
        FStar_List.fold_left
         ...
         in
      match uu___ with | (env1,binders1) -> (env1, (FStar_List.rev binders1))
    ...
    fun at  ->
      let rebind res b =
        ...
        | FStar_Pervasives_Native.Some l ->
         ...
         in
      let uu___ = parse_attr_with_list warn at FStar_Parser_Const.fail_attr
         in
      match uu___ with
      | (res,matched) ->
          if matched
                         ...
                         (let for_free = num_indices = Prims.int_one  in
                          ...
                          let name_of_eff_decl decl =
                            ...
                            | FStar_Parser_AST.Tycon
                                (uu___2,uu___3,(FStar_Parser_AST.TyconAbbrev
                                     ...
                                     FStar_All.pipe_right actions
                                       (FStar_List.map
                                          (fun d1  ->
                                             ...
                                             | FStar_Parser_AST.Tycon
                                                 (uu___4,uu___5,(FStar_Parser_AST.TyconAbbrev
                                     ...
                                     let l =
                                       let uu___4 =
                                         FStar_Ident.mk_ident
                                          ...
                                          in
                                       FStar_Syntax_DsEnv.qualify env2 uu___4
                                        in
                                     let uu___4 =
                                       let uu___5 =
                                         FStar_Syntax_DsEnv.fail_or env2
                                       ...
                                       then
                                         ...
                                         (let rr =
                                            FStar_Util.for_some
                                             ...
                                             in
                                          let uu___6 =
                                            let uu___7 = lookup "return_wp"
                                               in
                                            let uu___8 = lookup "bind_wp"  in
                                            let uu___9 = lookup "stronger"
                                               in
                                            let uu___10 =
                                              lookup "if_then_else"  in
                                            let uu___11 = lookup "ite_wp"  in
                                            let uu___12 = lookup "close_wp"
                                               in
                                            let uu___13 = lookup "trivial"
                                               in
                                            let uu___14 =
                                              if rr
                                              then
                                                let uu___15 = lookup "repr"
                                                   in
                                                FStar_Pervasives_Native.Some
                                                  uu___15
                                              else
                          ...
                          let lid =
                            ...
                            | uu___3 ->
                                let uu___4 =
                                  ...
                                  (FStar_Errors.Fatal_EffectNotFound, uu___5)
                                   in
                                        ...
                                        let uu___9 =
                                          let uu___10 =
                                            sub' nparam
                                             ...
                                             in
                                          FStar_Pervasives_Native.snd uu___10
                                           in
                                        let uu___10 =
                                          let uu___11 =
                                            sub' nparam
                                             ...
                                             in
                                          FStar_Pervasives_Native.snd uu___11
                                           in
                                        {
                                          FStar_Syntax_Syntax.action_name =
                                            uu___8;
    ...
    fun d  ->
              ...
              FStar_Errors.catch_errors
                (fun uu___3  ->
                   FStar_Options.with_saved_options
                     (fun uu___4  -> desugar_decl_noattrs env d1))
               in
            (match uu___2 with
             | (errs,r) ->
                 (match (errs, r) with
                                 ...
                                 let uu___8 =
                                   ...
                                   let uu___10 =
                                     FStar_Common.string_of_list
                                      ...
                                      in
                                   let uu___11 = FStar_Util.string_of_int e
                                      in
                                   let uu___12 = FStar_Util.string_of_int n2
                                      in
                                   let uu___13 = FStar_Util.string_of_int n1
                                      in
                                   FStar_Util.format5
      ...
      | (env1,sigelts) ->
          let rec val_attrs ses =
            ...
            | uu___1 -> []  in
          let attrs1 =
            let uu___1 = val_attrs sigelts  in FStar_List.append attrs uu___1
             in
          let uu___1 =
            FStar_List.map
              (fun sigelt  ->
                ...
                then
                  ...
                  (let uu___6 =
                     let uu___7 =
                       ...
                       FStar_Parser_Dep.deps_has_implementation uu___8 lid
                        in
                 ...
                 let uu___1 =
                   let uu___2 =
                     let uu___3 =
                       ...
                       FStar_Syntax_Syntax.new_bv
                         (FStar_Pervasives_Native.Some r) uu___4
                        in
              ...
              (match lets with
               ...
               | ({
                    FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed
                      ({ FStar_Parser_AST.pat = FStar_Parser_AST.PatOp uu___;
                         FStar_Parser_AST.prange = uu___1;_},uu___2);
                    FStar_Parser_AST.prange = uu___3;_},uu___4)::[]
                   -> false
               | ({
                    FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed
                      ({
      ...
      | FStar_Parser_AST.Exception (id,t_opt) ->
          let t =
            ...
            | FStar_Pervasives_Native.Some term ->
                ...
                FStar_Syntax_Util.arrow uu___ uu___1
             in
          ...
          let uu___ =
            let uu___1 =
              let uu___2 =
                let uu___3 =
                  let uu___4 =
                    let uu___5 = desugar_term env subcomp  in ([], uu___5)
                     in
                  ((m.FStar_Syntax_Syntax.mname),
        ...
        let env1 =
          ...
          | (FStar_Pervasives_Native.Some
             { FStar_Syntax_Syntax.name = prev_lid;
               ...
               FStar_Syntax_Syntax.is_interface = uu___1;_},FStar_Parser_AST.Module
             (current_lid,uu___2)) when
          ...
          let uu___ =
            (FStar_Options.interactive ()) &&
              (let uu___1 =
               ...
               FStar_List.mem uu___1 ["fsti"; "fsi"])
             in
        ...
        fun en  ->
          let erase_univs_ed ed =
            ...
            let uu___ =
              ...
              FStar_Syntax_Subst.open_term' uu___1 FStar_Syntax_Syntax.t_unit
               in
            match uu___ with
            | (binders,uu___1,binders_opening) ->
                let erase_term t =
                  let uu___2 =
                    let uu___3 = FStar_Syntax_Subst.subst binders_opening t
                       in
                ...
                let erase_action action =
                  ...
                  let erased_action_params =
                    ...
                    | uu___2 ->
                        ...
                        let uu___3 =
                          let uu___4 =
                            let uu___5 = FStar_Syntax_Subst.close binders t
                               in
                ...
                let uu___4 = erase_tscheme ed.FStar_Syntax_Syntax.signature
                   in
                let uu___5 =
