      ...
      fun top  ->
        ...
        | FStar_Parser_AST.Let (qual,(pat,_snd)::_tl,body) ->
            ...
            (match uu____4655 with
             ...
             | uu____4656 -> ds_non_rec pat _snd body)
...
let mk_data_discriminators quals env t tps k datas =
  ...
  let quals q =
    ...
    | uu____6529 -> FStar_List.append q quals  in
              ...
              fun quals  ->
                fun rng  ->
                  let dd =
                    ...
                    | uu____6817 -> FStar_Syntax_Util.incr_delta_qualifier t
                     in
                  let lb =
                    let uu____6819 =
                      let uu____6822 =
                   ...
                   let k =
                     ...
                     | None  ->
                         ...
                         (match uu____7354 with
                          ...
                          | uu____7357 -> FStar_Syntax_Syntax.tun)
    ...
    fun d  ->
      ...
      | FStar_Parser_AST.Tycon (is_effect,tcs) ->
          let quals =
            ...
            | uu____9563 -> d.FStar_Parser_AST.quals  in
          let tcs =
            FStar_List.map
               ...
               (match uu____9763 with
                | (pat,body) ->
                    ...
                    let bvs =
                      ...
                      FStar_All.pipe_right uu____9867 FStar_Util.set_elements
                       in
      ...
      | FStar_Parser_AST.Val (id,t) ->
          let quals = d.FStar_Parser_AST.quals  in
          let t =
            let uu____9897 = close_fun env t  in desugar_term env uu____9897
             in
          let quals =
          ...
          let se =
            let uu____9903 =
              ...
              (uu____9910, [], t, uu____9911, (d.FStar_Parser_AST.drange))
               in
      ...
      | FStar_Parser_AST.SubEffect l ->
          ...
          let uu____10046 =
            ...
            | FStar_Parser_AST.NonReifiableLift t ->
                let uu____10068 =
                  let uu____10073 =
                    let uu____10077 = desugar_term env t  in
                    ([], uu____10077)  in
                  Some uu____10073  in
                (uu____10068, None)
            | FStar_Parser_AST.ReifiableLift (wp,t) ->
                ...
                let uu____10109 =
                  let uu____10114 =
                    let uu____10118 = desugar_term env t  in
                    ([], uu____10118)  in
                  Some uu____10114  in
      ...
      fun m  ->
        ...
        | (x,y,pop_when_done) ->
            ((match pop_when_done with
              | true  -> let uu____10359 = FStar_ToSyntax_Env.pop ()  in ()
              | uu____10360 -> ());
             (x, y))
