...
let uu___235_2691 = x
in {FStar_Syntax_Syntax.ppname = uu___235_2691.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___235_2691.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})), (aq)));
))
end)
...
in {FStar_Syntax_Syntax.fv_name = uu___236_3788.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = uu___236_3788.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu____3789}))
in ((uu____3787), (args1)))
...
let uu___237_4362 = intro_term
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (private_fv); FStar_Syntax_Syntax.pos = uu___237_4362.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___237_4362.FStar_Syntax_Syntax.vars})))
end
| uu____4363 -> begin
...
let uu___238_4540 = e
in {FStar_Syntax_Syntax.n = uu___238_4540.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = top.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___238_4540.FStar_Syntax_Syntax.vars}))
in (
...
in {FStar_Parser_AST.tm = uu____4749; FStar_Parser_AST.range = uu___240_4748.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___240_4748.FStar_Parser_AST.level}))
in ((uu____4747), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4740))
in {FStar_Parser_AST.tm = uu____4739; FStar_Parser_AST.range = uu___239_4738.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___239_4738.FStar_Parser_AST.level}))
...
in {FStar_Parser_AST.tm = uu____4780; FStar_Parser_AST.range = uu___242_4779.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___242_4779.FStar_Parser_AST.level}))
in ((uu____4778), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4771))
in {FStar_Parser_AST.tm = uu____4770; FStar_Parser_AST.range = uu___241_4769.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___241_4769.FStar_Parser_AST.level}))
...
in {FStar_Parser_AST.tm = uu____4811; FStar_Parser_AST.range = uu___244_4810.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___244_4810.FStar_Parser_AST.level}))
in ((uu____4809), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4802))
in {FStar_Parser_AST.tm = uu____4801; FStar_Parser_AST.range = uu___243_4800.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___243_4800.FStar_Parser_AST.level}))
...
let uu___245_5359 = x
in {FStar_Syntax_Syntax.ppname = uu___245_5359.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___245_5359.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})), (FStar_Pervasives_Native.None)))::[]))), (uu____5326)))
end))
end))
...
let rec aux = (fun env1 bs1 uu___216_5459 -> (match (uu___216_5459) with
| [] -> begin
(
...
let rec aux = (fun env1 bs sc_pat_opt uu___217_5674 -> (match (uu___217_5674) with
| [] -> begin
(
...
let uu___246_10189 = t
in {FStar_Syntax_Syntax.n = uu___246_10189.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = f.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___246_10189.FStar_Syntax_Syntax.vars}))
in (
...
let uu___247_10223 = b
in {FStar_Parser_AST.b = uu___247_10223.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___247_10223.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___247_10223.FStar_Parser_AST.aqual}))
in (
...
let uu___248_10305 = a1
in {FStar_Syntax_Syntax.ppname = uu___248_10305.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___248_10305.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
in (
...
let uu___249_10691 = b
in {FStar_Parser_AST.b = uu___249_10691.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___249_10691.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___249_10691.FStar_Parser_AST.aqual}))
in (match (tk) with
| (FStar_Pervasives_Native.Some (a), k) -> begin
(
...
let uu___250_10728 = a1
in {FStar_Syntax_Syntax.ppname = uu___250_10728.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___250_10728.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
...
let quals1 = (FStar_All.pipe_right quals (FStar_List.filter (fun uu___218_10885 -> (match (uu___218_10885) with
...
let uu____11017 = (FStar_List.filter (fun uu___219_11021 -> (match (uu___219_11021) with
| FStar_Syntax_Syntax.Abstract -> begin
false
end
| uu____11022 -> begin
...
let iquals1 = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___220_11035 -> (match (uu___220_11035) with
| FStar_Syntax_Syntax.Abstract -> begin
true
end
| FStar_Syntax_Syntax.Private -> begin
...
let filter_records = (fun uu___221_11175 -> (match (uu___221_11175) with
...
let tycon_id = (fun uu___222_11376 -> (match (uu___222_11376) with
...
let tycon_record_as_variant = (fun uu___223_11531 -> (match (uu___223_11531) with
...
let desugar_abstract_tc = (fun quals1 _env mutuals uu___224_11731 -> (match (uu___224_11731) with
...
let uu___251_12182 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), ([]), (t))); FStar_Syntax_Syntax.sigrng = uu___251_12182.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals2; FStar_Syntax_Syntax.sigmeta = uu___251_12182.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___251_12182.FStar_Syntax_Syntax.sigattrs}))))
end
| uu____12185 -> begin
(failwith "Impossible")
end)
...
let uu____12239 = (FStar_Util.for_some (fun uu___225_12241 -> (match (uu___225_12241) with
...
let uu____12249 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___226_12253 -> (match (uu___226_12253) with
...
let quals2 = (FStar_All.pipe_right quals1 (FStar_List.filter (fun uu___227_12447 -> (match (uu___227_12447) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| uu____12448 -> begin
...
let docs_tps_sigelts = (FStar_All.pipe_right tcs2 (FStar_List.collect (fun uu___229_14046 -> (match (uu___229_14046) with
...
let quals2 = (FStar_All.pipe_right tname_quals (FStar_List.collect (fun uu___228_14741 -> (match (uu___228_14741) with
...
let rr = (FStar_Util.for_some (fun uu___230_16265 -> (match (uu___230_16265) with
...
let uu___252_17006 = sigelt
in {FStar_Syntax_Syntax.sigel = uu___252_17006.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___252_17006.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___252_17006.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___252_17006.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = attrs2})) sigelts)
in ((env1), (uu____17000))))))
end)))
...
| uu____17245 -> begin
(FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) (FStar_List.collect (fun uu___231_17258 -> (match (uu___231_17258) with
...
let uu___253_17340 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inr ((

let uu___254_17342 = fv
in {FStar_Syntax_Syntax.fv_name = uu___254_17342.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_abstract (fv.FStar_Syntax_Syntax.fv_delta); FStar_Syntax_Syntax.fv_qual = uu___254_17342.FStar_Syntax_Syntax.fv_qual})); FStar_Syntax_Syntax.lbunivs = uu___253_17340.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___253_17340.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___253_17340.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___253_17340.FStar_Syntax_Syntax.lbdef})))))
...
let uu___255_17423 = pat1
in {FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed (((var_pat), (ty))); FStar_Parser_AST.prange = uu___255_17423.FStar_Parser_AST.prange})
end
| uu____17424 -> begin
var_pat
end))
...
let uu___256_17431 = d
in {FStar_Parser_AST.d = FStar_Parser_AST.TopLevelLet (((isrec), ((((fresh_pat), (body)))::[]))); FStar_Parser_AST.drange = uu___256_17431.FStar_Parser_AST.drange; FStar_Parser_AST.doc = uu___256_17431.FStar_Parser_AST.doc; FStar_Parser_AST.quals = (FStar_Parser_AST.Private)::d.FStar_Parser_AST.quals; FStar_Parser_AST.attrs = uu___256_17431.FStar_Parser_AST.attrs}))
in (
...
let uu____18005 = (FStar_List.fold_left (fun uu____18025 d -> (match (uu____18025) with
| (env1, sigelts) -> begin
(

let uu____18045 = (desugar_decl env1 d)
...
let rec forward = (fun acc uu___233_18084 -> (match (uu___233_18084) with
| (se1)::(se2)::sigelts1 -> begin
(match (((se1.FStar_Syntax_Syntax.sigel), (se2.FStar_Syntax_Syntax.sigel))) with
| (FStar_Syntax_Syntax.Sig_declare_typ (uu____18098), FStar_Syntax_Syntax.Sig_let (uu____18099)) -> begin
(
...
let uu___257_18116 = se2
in (

let uu____18117 = (

let uu____18120 = (FStar_List.filter (fun uu___232_18134 -> (match (uu___232_18134) with
| {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____18138; FStar_Syntax_Syntax.vars = uu____18139}, uu____18140); FStar_Syntax_Syntax.pos = uu____18141; FStar_Syntax_Syntax.vars = uu____18142} when (

let uu____18165 = (

let uu____18166 = (FStar_Syntax_Syntax.lid_of_fv fv)
in (FStar_Ident.string_of_lid uu____18166))
in (Prims.op_Equality uu____18165 "FStar.Pervasives.Comment")) -> begin
true
end
| uu____18167 -> begin
false
end)) se1.FStar_Syntax_Syntax.sigattrs)
in (FStar_List.append uu____18120 se2.FStar_Syntax_Syntax.sigattrs))
in {FStar_Syntax_Syntax.sigel = uu___257_18116.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___257_18116.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___257_18116.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___257_18116.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu____18117}))
in (uu____18115)::(se1)::acc)
in (forward uu____18112 sigelts1))
end
| uu____18172 -> begin
...
let uu____18180 = (forward [] sigelts)
in ((env1), (uu____18180))))
end)))
...
| (FStar_Pervasives_Native.None, uu____18234) -> begin
env
end
| (FStar_Pervasives_Native.Some ({FStar_Syntax_Syntax.name = prev_lid; FStar_Syntax_Syntax.declarations = uu____18238; FStar_Syntax_Syntax.exports = uu____18239; FStar_Syntax_Syntax.is_interface = uu____18240}), FStar_Parser_AST.Module (current_lid, uu____18242)) when ((FStar_Ident.lid_equals prev_lid current_lid) && (FStar_Options.interactive ())) -> begin
env
end
| (FStar_Pervasives_Native.Some (prev_mod), uu____18250) -> begin
(FStar_ToSyntax_Env.finish_module_or_interface env prev_mod)
end)
in (

let uu____18253 = (match (m) with
| FStar_Parser_AST.Interface (mname, decls, admitted) -> begin
(

let uu____18289 = (FStar_ToSyntax_Env.prepare_module_or_interface true admitted env1 mname FStar_ToSyntax_Env.default_mii)
in ((uu____18289), (mname), (decls), (true)))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(

let uu____18306 = (FStar_ToSyntax_Env.prepare_module_or_interface false false env1 mname FStar_ToSyntax_Env.default_mii)
in ((uu____18306), (mname), (decls), (false)))
end)
in (match (uu____18253) with
| ((env2, pop_when_done), mname, decls, intf) -> begin
(

let uu____18336 = (desugar_decls env2 decls)
in (match (uu____18336) with
| (env3, sigelts) -> begin
(
...
let uu____18388 = ((FStar_Options.interactive ()) && (

let uu____18390 = (

let uu____18391 = (

let uu____18392 = (FStar_Options.file_list ())
in (FStar_List.hd uu____18392))
in (FStar_Util.get_file_extension uu____18391))
in (FStar_List.mem uu____18390 (("fsti")::("fsi")::[]))))
...
let uu____18396 = (desugar_modul_common curmod env m1)
...
let uu____18411 = (FStar_ToSyntax_Env.pop ())
in ())
end
| uu____18412 -> begin
()
...
let uu____18429 = (desugar_modul_common FStar_Pervasives_Native.None env m)
...
let uu____18445 = (FStar_Options.dump_module modul.FStar_Syntax_Syntax.name.FStar_Ident.str)
in (match (uu____18445) with
| true -> begin
(

let uu____18446 = (FStar_Syntax_Print.modul_to_string modul)
...
let uu____18448 = (match (pop_when_done) with
| true -> begin
...
let uu____18462 = (FStar_ToSyntax_Env.prepare_module_or_interface false false en m.FStar_Syntax_Syntax.name mii)
in (match (uu____18462) with
| (en1, pop_when_done) -> begin
(

let en2 = (

let uu____18470 = (FStar_ToSyntax_Env.set_current_module en1 m.FStar_Syntax_Syntax.name)
in (FStar_List.fold_left FStar_ToSyntax_Env.push_sigelt uu____18470 m.FStar_Syntax_Syntax.exports))
in (
