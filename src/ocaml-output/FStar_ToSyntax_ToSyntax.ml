...
let trans_aqual : FStar_Parser_AST.arg_qualifier FStar_Pervasives_Native.option  ->  FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option = (fun uu___206_62 -> (match (uu___206_62) with
...
let trans_qual : FStar_Range.range  ->  FStar_Ident.lident FStar_Pervasives_Native.option  ->  FStar_Parser_AST.qualifier  ->  FStar_Syntax_Syntax.qualifier = (fun r maybe_effect_id uu___207_83 -> (match (uu___207_83) with
...
let trans_pragma : FStar_Parser_AST.pragma  ->  FStar_Syntax_Syntax.pragma = (fun uu___208_91 -> (match (uu___208_91) with
...
let as_imp : FStar_Parser_AST.imp  ->  FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option = (fun uu___209_101 -> (match (uu___209_101) with
...
let binder_of_bnd : bnd  ->  (FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.aqual) = (fun uu___210_1455 -> (match (uu___210_1455) with
...
let as_binder : FStar_ToSyntax_Env.env  ->  FStar_Parser_AST.arg_qualifier FStar_Pervasives_Native.option  ->  (FStar_Ident.ident FStar_Pervasives_Native.option * FStar_Syntax_Syntax.term)  ->  (FStar_Syntax_Syntax.binder * FStar_ToSyntax_Env.env) = (fun env imp uu___211_1490 -> (match (uu___211_1490) with
...
let uu___234_1531 = a1
in {FStar_Syntax_Syntax.ppname = uu___234_1531.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___234_1531.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})), ((trans_aqual imp)))), (env1))
end))
end))
...
let is_special_effect_combinator : Prims.string  ->  Prims.bool = (fun uu___212_1834 -> (match (uu___212_1834) with
| "repr" -> begin
true
end
| "post" -> begin
...
(match ((FStar_List.existsb (fun uu___213_2042 -> (match (uu___213_2042) with
...
let uu____2054 = (FStar_List.map (fun uu___214_2063 -> (match (uu___214_2063) with
...
let nargs = (FStar_List.map (fun uu___215_2080 -> (match (uu___215_2080) with
| FStar_Util.Inl (n1) -> begin
n1
end
...
let uu____2525 = (FStar_All.pipe_right l (FStar_Util.find_opt (fun y -> (Prims.op_Equality y.FStar_Syntax_Syntax.ppname.FStar_Ident.idText x.FStar_Ident.idText))))
...
let uu___235_2693 = x
in {FStar_Syntax_Syntax.ppname = uu___235_2693.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___235_2693.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})), (aq)));
))
end)
...
in {FStar_Syntax_Syntax.fv_name = uu___236_3790.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = uu___236_3790.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu____3791}))
in ((uu____3789), (args1)))
...
let uu___237_4368 = intro_term
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (private_fv); FStar_Syntax_Syntax.pos = uu___237_4368.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___237_4368.FStar_Syntax_Syntax.vars})))
end
| uu____4369 -> begin
...
let uu___238_4546 = e
in {FStar_Syntax_Syntax.n = uu___238_4546.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = top.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___238_4546.FStar_Syntax_Syntax.vars}))
in (
...
| FStar_Parser_AST.Op (op_star, (uu____4602)::(uu____4603)::[]) when ((Prims.op_Equality (FStar_Ident.text_of_id op_star) "*") && (
...
| FStar_Parser_AST.Construct (n1, ((a, uu____4728))::[]) when (Prims.op_Equality n1.FStar_Ident.str "SMTPat") -> begin
(

let uu____4743 = (

let uu___239_4744 = top
in (
...
in {FStar_Parser_AST.tm = uu____4755; FStar_Parser_AST.range = uu___240_4754.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___240_4754.FStar_Parser_AST.level}))
in ((uu____4753), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4746))
in {FStar_Parser_AST.tm = uu____4745; FStar_Parser_AST.range = uu___239_4744.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___239_4744.FStar_Parser_AST.level}))
in (desugar_term_maybe_top top_level env uu____4743))
end
| FStar_Parser_AST.Construct (n1, ((a, uu____4759))::[]) when (Prims.op_Equality n1.FStar_Ident.str "SMTPatT") -> begin
(

let uu____4774 = (

let uu___241_4775 = top
in (
...
in {FStar_Parser_AST.tm = uu____4786; FStar_Parser_AST.range = uu___242_4785.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___242_4785.FStar_Parser_AST.level}))
in ((uu____4784), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4777))
in {FStar_Parser_AST.tm = uu____4776; FStar_Parser_AST.range = uu___241_4775.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___241_4775.FStar_Parser_AST.level}))
in (desugar_term_maybe_top top_level env uu____4774))
end
| FStar_Parser_AST.Construct (n1, ((a, uu____4790))::[]) when (Prims.op_Equality n1.FStar_Ident.str "SMTPatOr") -> begin
(

let uu____4805 = (

let uu___243_4806 = top
in (
...
in {FStar_Parser_AST.tm = uu____4817; FStar_Parser_AST.range = uu___244_4816.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___244_4816.FStar_Parser_AST.level}))
in ((uu____4815), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4808))
in {FStar_Parser_AST.tm = uu____4807; FStar_Parser_AST.range = uu___243_4806.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___243_4806.FStar_Parser_AST.level}))
...
let uu___245_5365 = x
in {FStar_Syntax_Syntax.ppname = uu___245_5365.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___245_5365.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})), (FStar_Pervasives_Native.None)))::[]))), (uu____5332)))
end))
end))
...
let rec aux = (fun env1 bs1 uu___216_5465 -> (match (uu___216_5465) with
| [] -> begin
(
...
let rec aux = (fun env1 bs sc_pat_opt uu___217_5680 -> (match (uu___217_5680) with
| [] -> begin
(
...
in (FStar_Option.isSome uu____7372))) && ((not (is_rec)) || (Prims.op_disEquality (FStar_List.length args1) (Prims.parse_int "0"))))
...
| uu____8473 when (Prims.op_Equality top.FStar_Parser_AST.level FStar_Parser_AST.Formula) -> begin
(desugar_formula env top)
end
| uu____8474 -> begin
...
let uu____9051 = (is_requires ens)
in (not (uu____9051))) && (

let uu____9053 = (is_smt_pat ens)
in (not (uu____9053)))) && (

let uu____9055 = (is_decreases ens)
in (not (uu____9055)))) && (is_smt_pat smtpat)) -> begin
...
let uu____9344 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_effect_name_and_attributes env) l)
in ((uu____9344), (args)))
end
| FStar_Parser_AST.Name (l) when ((

let uu____9372 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.lid_equals uu____9372 FStar_Parser_Const.prims_lid)) && (Prims.op_Equality l.FStar_Ident.ident.FStar_Ident.idText "Tot")) -> begin
(((((FStar_Ident.set_lid_range FStar_Parser_Const.effect_Tot_lid head1.FStar_Parser_AST.range)), ([]))), (args))
end
| FStar_Parser_AST.Name (l) when ((

let uu____9390 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.lid_equals uu____9390 FStar_Parser_Const.prims_lid)) && (Prims.op_Equality l.FStar_Ident.ident.FStar_Ident.idText "GTot")) -> begin
...
let uu____9430 = (FStar_Options.ml_ish ())
...
let uu____9433 = (FStar_Options.warn_default_effects ())
...
let uu____9457 = (pre_process_comp_typ t)
...
let uu____9507 = (FStar_Syntax_Print.lid_to_string eff)
in (FStar_Util.format1 "Not enough args to effect %s" uu____9507))
in (fail uu____9506))
end
| uu____9508 -> begin
()
...
let is_universe = (fun uu____9516 -> (match (uu____9516) with
| (uu____9521, imp) -> begin
(Prims.op_Equality imp FStar_Parser_AST.UnivApp)
end))
in (

let uu____9523 = (FStar_Util.take is_universe args)
in (match (uu____9523) with
| (universes, args1) -> begin
(

let universes1 = (FStar_List.map (fun uu____9582 -> (match (uu____9582) with
| (u, imp) -> begin
(desugar_universe u)
end)) universes)
in (
...
let uu____9604 = (FStar_List.hd args1)
in (

let uu____9613 = (FStar_List.tl args1)
in ((uu____9604), (uu____9613))))
...
let is_decrease = (fun uu____9704 -> (match (uu____9704) with
| (t1, uu____9714) -> begin
(match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____9724; FStar_Syntax_Syntax.vars = uu____9725}, (uu____9726)::[]) -> begin
...
let decreases_clause = (FStar_All.pipe_right dec (FStar_List.map (fun uu____9871 -> (match (uu____9871) with
| (t1, uu____9881) -> begin
(match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_app (uu____9890, ((arg, uu____9892))::[]) -> begin
...
let uu____10115 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((pat1), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Meta_smt_pat))))) FStar_Pervasives_Native.None pat1.FStar_Syntax_Syntax.pos)
in ((uu____10115), (aq)))
in (uu____10106)::[])
in (ens)::uu____10095)
in (req)::uu____10084))
...
let uu___246_10195 = t
in {FStar_Syntax_Syntax.n = uu___246_10195.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = f.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___246_10195.FStar_Syntax_Syntax.vars}))
in (
...
let uu___247_10229 = b
in {FStar_Parser_AST.b = uu___247_10229.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___247_10229.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___247_10229.FStar_Parser_AST.aqual}))
in (

let desugar_pats = (fun env1 pats1 -> (FStar_List.map (fun es -> (FStar_All.pipe_right es (FStar_List.map (fun e -> (

let uu____10288 = (desugar_term env1 e)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) uu____10288)))))) pats1))
in (match (tk) with
| (FStar_Pervasives_Native.Some (a), k) -> begin
(

let uu____10301 = (FStar_ToSyntax_Env.push_bv env a)
...
let uu___248_10311 = a1
in {FStar_Syntax_Syntax.ppname = uu___248_10311.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___248_10311.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
in (
...
let uu____10351 = (FStar_Syntax_Syntax.mk_binder a2)
in (uu____10351)::[])
in (no_annot_abs uu____10350 body2))
in (FStar_All.pipe_left setpos uu____10347))
in (
...
let uu____10372 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range q b.FStar_Parser_AST.brange) (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) FStar_Pervasives_Native.None)
in (

let uu____10373 = (

let uu____10376 = (FStar_Syntax_Syntax.as_arg body3)
in (uu____10376)::[])
in ((uu____10372), (uu____10373))))
in FStar_Syntax_Syntax.Tm_app (uu____10357))
in (FStar_All.pipe_left mk1 uu____10356)))))))
end))
end
| uu____10381 -> begin
(failwith "impossible")
...
let uu____10453 = (q ((rest), (pats), (body)))
in (

let uu____10460 = (FStar_Range.union_ranges b'.FStar_Parser_AST.brange body.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term uu____10453 uu____10460 FStar_Parser_AST.Formula)))
in (

let uu____10461 = (q (((b)::[]), ([]), (body1)))
in (FStar_Parser_AST.mk_term uu____10461 f.FStar_Parser_AST.range FStar_Parser_AST.Formula))))
end
| uu____10470 -> begin
(failwith "impossible")
end))
...
let uu____10474 = (unparen f)
in uu____10474.FStar_Parser_AST.tm)
...
| FStar_Parser_AST.QForall ([], uu____10481, uu____10482) -> begin
(failwith "Impossible: Quantifier without binders")
end
| FStar_Parser_AST.QExists ([], uu____10493, uu____10494) -> begin
(failwith "Impossible: Quantifier without binders")
end
...
let uu____10525 = (push_quant (fun x -> FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env uu____10525)))
end
...
let uu____10561 = (push_quant (fun x -> FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env uu____10561)))
end
...
let uu____10609 = (FStar_List.fold_left (fun uu____10645 b -> (match (uu____10645) with
| (env1, out) -> begin
(

let tk = (desugar_binder env1 (

let uu___249_10697 = b
in {FStar_Parser_AST.b = uu___249_10697.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___249_10697.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___249_10697.FStar_Parser_AST.aqual}))
in (match (tk) with
| (FStar_Pervasives_Native.Some (a), k) -> begin
(

let uu____10714 = (FStar_ToSyntax_Env.push_bv env1 a)
...
let uu___250_10734 = a1
in {FStar_Syntax_Syntax.ppname = uu___250_10734.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___250_10734.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
...
let uu____10838 = (desugar_typ env t)
in ((FStar_Pervasives_Native.Some (x)), (uu____10838)))
end
| FStar_Parser_AST.Annotated (x, t) -> begin
(

let uu____10843 = (desugar_typ env t)
in ((FStar_Pervasives_Native.Some (x)), (uu____10843)))
end
| FStar_Parser_AST.TVariable (x) -> begin
(

let uu____10847 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_unknown)) FStar_Pervasives_Native.None x.FStar_Ident.idRange)
in ((FStar_Pervasives_Native.Some (x)), (uu____10847)))
end
| FStar_Parser_AST.NoName (t) -> begin
(

let uu____10855 = (desugar_typ env t)
in ((FStar_Pervasives_Native.None), (uu____10855)))
end
...
let quals1 = (FStar_All.pipe_right quals (FStar_List.filter (fun uu___218_10891 -> (match (uu___218_10891) with
...
let uu____10906 = (FStar_ToSyntax_Env.iface env)
in (not (uu____10906))) || (FStar_ToSyntax_Env.admitted_iface env))
...
let uu____10919 = (quals2 ((FStar_Syntax_Syntax.OnlyName)::(FStar_Syntax_Syntax.Discriminator (d))::[]))
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((disc_name), ([]), (FStar_Syntax_Syntax.tun))); FStar_Syntax_Syntax.sigrng = (FStar_Ident.range_of_lid disc_name); FStar_Syntax_Syntax.sigquals = uu____10919; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []}))))))))
...
let uu____10955 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i uu____10985 -> (match (uu____10985) with
| (x, uu____10993) -> begin
(

let uu____10994 = (FStar_Syntax_Util.mk_field_projector_name lid x i)
in (match (uu____10994) with
| (field_name, uu____11002) -> begin
(

let only_decl = (((

let uu____11006 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Parser_Const.prims_lid uu____11006)) || (Prims.op_disEquality fvq FStar_Syntax_Syntax.Data_ctor)) || (

let uu____11008 = (

let uu____11009 = (FStar_ToSyntax_Env.current_module env)
in uu____11009.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors uu____11008)))
in (
...
let uu____11023 = (FStar_List.filter (fun uu___219_11027 -> (match (uu___219_11027) with
| FStar_Syntax_Syntax.Abstract -> begin
false
end
| uu____11028 -> begin
...
in (FStar_Syntax_Syntax.Assumption)::uu____11023)
end
| uu____11029 -> begin
q
end))
...
let iquals1 = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___220_11041 -> (match (uu___220_11041) with
| FStar_Syntax_Syntax.Abstract -> begin
true
end
| FStar_Syntax_Syntax.Private -> begin
...
let uu____11050 = (FStar_All.pipe_right quals1 (FStar_List.contains FStar_Syntax_Syntax.Abstract))
...
let uu____11060 = (FStar_Syntax_Syntax.lid_as_fv field_name dd FStar_Pervasives_Native.None)
in FStar_Util.Inr (uu____11060))
in {FStar_Syntax_Syntax.lbname = uu____11055; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = FStar_Syntax_Syntax.tun; FStar_Syntax_Syntax.lbeff = FStar_Parser_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = FStar_Syntax_Syntax.tun})
in (
...
let uu____11074 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right uu____11074 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (uu____11073)::[])
in ((((false), ((lb)::[]))), (uu____11070)))
in FStar_Syntax_Syntax.Sig_let (uu____11063))
in {FStar_Syntax_Syntax.sigel = uu____11062; FStar_Syntax_Syntax.sigrng = p; FStar_Syntax_Syntax.sigquals = quals1; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []})
...
in (FStar_All.pipe_right uu____10955 FStar_List.flatten))))
...
| FStar_Syntax_Syntax.Sig_datacon (lid, uu____11121, t, uu____11123, n1, uu____11125) when (not ((FStar_Ident.lid_equals lid FStar_Parser_Const.lexcons_lid))) -> begin
(

let uu____11130 = (FStar_Syntax_Util.arrow_formals t)
in (match (uu____11130) with
| (formals, uu____11146) -> begin
(match (formals) with
| [] -> begin
[]
end
...
let filter_records = (fun uu___221_11181 -> (match (uu___221_11181) with
| FStar_Syntax_Syntax.RecordConstructor (uu____11184, fns) -> begin
...
let uu____11198 = (FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals filter_records)
...
let uu____11208 = (FStar_Util.first_N n1 formals)
in (match (uu____11208) with
| (uu____11231, rest) -> begin
...
let uu____11315 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract))
in (match (uu____11315) with
| true -> begin
(

let uu____11318 = (FStar_Syntax_Util.incr_delta_qualifier t)
in FStar_Syntax_Syntax.Delta_abstract (uu____11318))
end
| uu____11319 -> begin
...
let uu____11326 = (FStar_Syntax_Syntax.lid_as_fv lid dd FStar_Pervasives_Native.None)
in FStar_Util.Inr (uu____11326))
in (

let uu____11327 = (

let uu____11330 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_Syntax_Util.arrow typars uu____11330))
in (

let uu____11333 = (no_annot_abs typars t)
in {FStar_Syntax_Syntax.lbname = uu____11321; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = uu____11327; FStar_Syntax_Syntax.lbeff = FStar_Parser_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = uu____11333})))
...
let tycon_id = (fun uu___222_11382 -> (match (uu___222_11382) with
| FStar_Parser_AST.TyconAbstract (id, uu____11384, uu____11385) -> begin
id
end
| FStar_Parser_AST.TyconAbbrev (id, uu____11395, uu____11396, uu____11397) -> begin
id
end
| FStar_Parser_AST.TyconRecord (id, uu____11407, uu____11408, uu____11409) -> begin
id
end
| FStar_Parser_AST.TyconVariant (id, uu____11439, uu____11440, uu____11441) -> begin
id
end))
in (

let binder_to_term = (fun b -> (match (b.FStar_Parser_AST.b) with
| FStar_Parser_AST.Annotated (x, uu____11483) -> begin
(

let uu____11484 = (

let uu____11485 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (uu____11485))
in (FStar_Parser_AST.mk_term uu____11484 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
| FStar_Parser_AST.Variable (x) -> begin
(
...
let uu____11488 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (uu____11488))
in (FStar_Parser_AST.mk_term uu____11487 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
| FStar_Parser_AST.TAnnotated (a, uu____11490) -> begin
...
let uu____11527 = (binder_to_term b)
in ((out), (uu____11527), ((imp_of_aqual b))))
in FStar_Parser_AST.App (uu____11520))
in (FStar_Parser_AST.mk_term uu____11519 out.FStar_Parser_AST.range out.FStar_Parser_AST.level))) t binders)))
in (

let tycon_record_as_variant = (fun uu___223_11537 -> (match (uu___223_11537) with
...
let mfields = (FStar_List.map (fun uu____11592 -> (match (uu____11592) with
| (x, t, uu____11603) -> begin
...
let uu____11611 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (uu____11611))
in (FStar_Parser_AST.mk_term uu____11610 id.FStar_Ident.idRange FStar_Parser_AST.Type_level))
in (apply_binders uu____11609 parms))
in (
...
let uu____11615 = (FStar_All.pipe_right fields (FStar_List.map (fun uu____11642 -> (match (uu____11642) with
| (x, uu____11652, uu____11653) -> begin
(FStar_Syntax_Util.unmangle_field_name x)
end))))
in ((FStar_Parser_AST.TyconVariant (((id), (parms), (kopt), ((((constrName), (FStar_Pervasives_Native.Some (constrTyp)), (FStar_Pervasives_Native.None), (false)))::[])))), (uu____11615)))))))
end
| uu____11706 -> begin
(failwith "impossible")
end))
...
let desugar_abstract_tc = (fun quals1 _env mutuals uu___224_11737 -> (match (uu___224_11737) with
| FStar_Parser_AST.TyconAbstract (id, binders, kopt) -> begin
(

let uu____11761 = (typars_of_binders _env binders)
...
let uu____11809 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (uu____11809))
in (FStar_Parser_AST.mk_term uu____11808 id.FStar_Ident.idRange FStar_Parser_AST.Type_level))
in (apply_binders uu____11807 binders))
in (
...
let uu____11866 = (FStar_List.fold_left (fun uu____11906 uu____11907 -> (match (((uu____11906), (uu____11907))) with
| ((env2, tps), (x, imp)) -> begin
(

let uu____11998 = (FStar_ToSyntax_Env.push_bv env2 x.FStar_Syntax_Syntax.ppname)
...
let uu____12111 = (tm_type_z id.FStar_Ident.idRange)
in FStar_Pervasives_Native.Some (uu____12111))
end
| uu____12112 -> begin
kopt
end)
...
let uu____12120 = (desugar_abstract_tc quals env [] tc)
in (match (uu____12120) with
| (uu____12133, uu____12134, se, uu____12136) -> begin
(

let se1 = (match (se.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, uu____12139, typars, k, [], []) -> begin
(
...
let uu____12157 = (FStar_Options.ml_ish ())
in (not (uu____12157)))
...
let uu____12159 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format1 "Adding an implicit \'assume new\' qualifier on %s" uu____12159))
in (FStar_Errors.warn se.FStar_Syntax_Syntax.sigrng uu____12158))
end
| uu____12160 -> begin
()
end));
...
let uu____12184 = (FStar_Syntax_Syntax.mk_Total k)
in ((typars), (uu____12184)))
in FStar_Syntax_Syntax.Tm_arrow (uu____12171))
in (FStar_Syntax_Syntax.mk uu____12170))
in (uu____12167 FStar_Pervasives_Native.None se.FStar_Syntax_Syntax.sigrng))
end)
in (

let uu___251_12188 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), ([]), (t))); FStar_Syntax_Syntax.sigrng = uu___251_12188.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals2; FStar_Syntax_Syntax.sigmeta = uu___251_12188.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___251_12188.FStar_Syntax_Syntax.sigattrs}))))
end
| uu____12191 -> begin
(failwith "Impossible")
end)
...
let uu____12194 = (FStar_ToSyntax_Env.qualify env1 id)
in (FStar_ToSyntax_Env.push_doc env1 uu____12194 d.FStar_Parser_AST.doc))
in ((env2), ((se1)::[])))))
end))))
end
...
let uu____12209 = (typars_of_binders env binders)
...
let uu____12245 = (FStar_Util.for_some (fun uu___225_12247 -> (match (uu___225_12247) with
...
let uu____12255 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___226_12259 -> (match (uu___226_12259) with
...
let uu____12269 = (FStar_All.pipe_right quals1 (FStar_List.contains FStar_Syntax_Syntax.Effect))
...
let uu____12280 = (unparen t)
in uu____12280.FStar_Parser_AST.tm)
in (match (uu____12279) with
| FStar_Parser_AST.Construct (head1, args) -> begin
(

let uu____12301 = (match ((FStar_List.rev args)) with
| ((last_arg, uu____12331))::args_rev -> begin
(

let uu____12343 = (

let uu____12344 = (unparen last_arg)
in uu____12344.FStar_Parser_AST.tm)
...
let uu____12420 = (desugar_attributes env cattributes)
in (((FStar_Parser_AST.mk_term (FStar_Parser_AST.Construct (((head1), (args1)))) t.FStar_Parser_AST.range t.FStar_Parser_AST.level)), (uu____12420)))
end))
end
| uu____12431 -> begin
((t), ([]))
...
let quals2 = (FStar_All.pipe_right quals1 (FStar_List.filter (fun uu___227_12453 -> (match (uu___227_12453) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| uu____12454 -> begin
...
| (FStar_Parser_AST.TyconRecord (uu____12465))::[] -> begin
(

let trec = (FStar_List.hd tcs)
in (

let uu____12489 = (tycon_record_as_variant trec)
...
let uu____12522 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.ids_of_lid uu____12522))
in ((uu____12519), (fs)))
in FStar_Syntax_Syntax.RecordType (uu____12510))
in (uu____12509)::quals)
in (desugar_tycon env d uu____12506 ((t)::[])))
end)))
end
| (uu____12527)::uu____12528 -> begin
(
...
| (env1, tcs1) -> begin
(match (tc) with
| FStar_Parser_AST.TyconRecord (uu____12914) -> begin
(

let trec = tc
in (

let uu____12938 = (tycon_record_as_variant trec)
...
let uu____13013 = (FStar_ToSyntax_Env.current_module env1)
in (FStar_Ident.ids_of_lid uu____13013))
in ((uu____13010), (fs)))
in FStar_Syntax_Syntax.RecordType (uu____13001))
in (uu____13000)::quals1)
in (collect_tcs uu____12997 ((env1), (tcs1)) t))
end)))
end
| FStar_Parser_AST.TyconVariant (id, binders, kopt, constructors) -> begin
(

let uu____13100 = (desugar_abstract_tc quals1 env1 mutuals (FStar_Parser_AST.TyconAbstract (((id), (binders), (kopt)))))
in (match (uu____13100) with
| (env2, uu____13160, se, tconstr) -> begin
...
let uu____13309 = (desugar_abstract_tc quals1 env1 mutuals (FStar_Parser_AST.TyconAbstract (((id), (binders), (kopt)))))
in (match (uu____13309) with
| (env2, uu____13369, se, tconstr) -> begin
...
let uu____13541 = (FStar_List.fold_left (collect_tcs quals) ((env), ([])) tcs)
...
let docs_tps_sigelts = (FStar_All.pipe_right tcs2 (FStar_List.collect (fun uu___229_14052 -> (match (uu___229_14052) with
| FStar_Util.Inr ({FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (id, uvs, tpars, k, uu____14119, uu____14120); FStar_Syntax_Syntax.sigrng = uu____14121; FStar_Syntax_Syntax.sigquals = uu____14122; FStar_Syntax_Syntax.sigmeta = uu____14123; FStar_Syntax_Syntax.sigattrs = uu____14124}, binders, t, quals1) -> begin
(

let t1 = (

let uu____14185 = (typars_of_binders env1 binders)
in (match (uu____14185) with
| (env2, tpars1) -> begin
(

let uu____14216 = (push_tparams env2 tpars1)
...
let uu____14270 = (mk_typ_abbrev id uvs tpars k t1 ((id)::[]) quals1 rng)
in ((((id), (d.FStar_Parser_AST.doc))), ([]), (uu____14270)))
in (uu____14249)::[]))
end
| FStar_Util.Inl ({FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (tname, univs1, tpars, k, mutuals1, uu____14338); FStar_Syntax_Syntax.sigrng = uu____14339; FStar_Syntax_Syntax.sigquals = tname_quals; FStar_Syntax_Syntax.sigmeta = uu____14341; FStar_Syntax_Syntax.sigattrs = uu____14342}, constrs, tconstr, quals1) -> begin
(
...
let uu____14438 = (push_tparams env1 tpars)
in (match (uu____14438) with
| (env_tps, tps) -> begin
(

let data_tpars = (FStar_List.map (fun uu____14515 -> (match (uu____14515) with
| (x, uu____14529) -> begin
...
let uu____14566 = (FStar_All.pipe_right constrs (FStar_List.map (fun uu____14680 -> (match (uu____14680) with
...
let uu____14736 = (close env_tps t)
in (desugar_term env_tps uu____14736))
in (

let name = (FStar_ToSyntax_Env.qualify env1 id)
in (

let quals2 = (FStar_All.pipe_right tname_quals (FStar_List.collect (fun uu___228_14747 -> (match (uu___228_14747) with
...
let uu____14811 = (FStar_All.pipe_right t1 FStar_Syntax_Util.name_function_binders)
in (FStar_Syntax_Syntax.mk_Total uu____14811))
in (FStar_Syntax_Util.arrow data_tpars uu____14808))
in ((name), (univs1), (uu____14805), (tname), (ntps), (mutuals1)))
in FStar_Syntax_Syntax.Sig_datacon (uu____14790))
in {FStar_Syntax_Syntax.sigel = uu____14789; FStar_Syntax_Syntax.sigrng = rng; FStar_Syntax_Syntax.sigquals = quals2; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []})
in ((((name), (doc1))), (tps), (uu____14788)))
in ((name), (uu____14767))))))))
end))))
in (FStar_All.pipe_left FStar_List.split uu____14566))
in (match (uu____14537) with
...
let name_docs = (FStar_All.pipe_right docs_tps_sigelts (FStar_List.map (fun uu____15182 -> (match (uu____15182) with
| (name_doc, uu____15210, uu____15211) -> begin
name_doc
end))))
in (

let sigelts = (FStar_All.pipe_right docs_tps_sigelts (FStar_List.map (fun uu____15291 -> (match (uu____15291) with
| (uu____15312, uu____15313, se) -> begin
se
end))))
in (
...
let uu____15350 = (FStar_List.collect FStar_Syntax_Util.lids_of_sigelt sigelts)
in (FStar_Syntax_MutRecTy.disentangle_abbrevs_from_bundle sigelts quals uu____15350 rng))
...
let data_ops = (FStar_All.pipe_right docs_tps_sigelts (FStar_List.collect (fun uu____15416 -> (match (uu____15416) with
| (uu____15439, tps, se) -> begin
(mk_data_projector_names quals env3 se)
end))))
in (

let discs = (FStar_All.pipe_right sigelts (FStar_List.collect (fun se -> (match (se.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (tname, uu____15490, tps, k, uu____15493, constrs) when ((FStar_List.length constrs) > (Prims.parse_int "1")) -> begin
(
...
let env5 = (FStar_List.fold_left (fun acc uu____15529 -> (match (uu____15529) with
| (lid, doc1) -> begin
...
let uu____15566 = (FStar_List.fold_left (fun uu____15589 b -> (match (uu____15589) with
| (env1, binders1) -> begin
(

let uu____15609 = (desugar_binder env1 b)
in (match (uu____15609) with
| (FStar_Pervasives_Native.Some (a), k) -> begin
(

let uu____15626 = (as_binder env1 b.FStar_Parser_AST.aqual ((FStar_Pervasives_Native.Some (a)), (k)))
in (match (uu____15626) with
| (binder, env2) -> begin
...
let uu____15761 = (desugar_binders monad_env eff_binders)
...
let uu____15790 = (FStar_Syntax_Util.arrow_formals eff_t)
in (FStar_Pervasives_Native.fst uu____15790))
in (FStar_List.length uu____15783))
in (Prims.op_Equality uu____15782 (Prims.parse_int "1")))
in (
...
| FStar_Parser_AST.Tycon (uu____15832, ((FStar_Parser_AST.TyconAbbrev (name, uu____15834, uu____15835, uu____15836), uu____15837))::[]) -> begin
...
let uu____15871 = (FStar_List.partition (fun decl -> (

let uu____15883 = (name_of_eff_decl decl)
in (FStar_List.mem uu____15883 mandatory_members))) eff_decls)
in (match (uu____15871) with
| (mandatory_members_decls, actions) -> begin
(

let uu____15900 = (FStar_All.pipe_right mandatory_members_decls (FStar_List.fold_left (fun uu____15929 decl -> (match (uu____15929) with
| (env2, out) -> begin
(

let uu____15949 = (desugar_decl env2 decl)
...
let uu____15965 = (FStar_List.hd ses)
in (uu____15965)::out)
in ((env3), (uu____15962)))
end))
end)) ((env1), ([]))))
in (match (uu____15900) with
| (env2, decls) -> begin
(
...
| FStar_Parser_AST.Tycon (uu____16033, ((FStar_Parser_AST.TyconAbbrev (name, action_params, uu____16036, {FStar_Parser_AST.tm = FStar_Parser_AST.Construct (uu____16037, ((def, uu____16039))::((cps_type, uu____16041))::[]); FStar_Parser_AST.range = uu____16042; FStar_Parser_AST.level = uu____16043}), doc1))::[]) when (not (for_free)) -> begin
(

let uu____16095 = (desugar_binders env2 action_params)
...
let uu____16116 = (FStar_ToSyntax_Env.qualify env3 name)
in (

let uu____16117 = (

let uu____16118 = (desugar_term env3 def)
in (FStar_Syntax_Subst.close (FStar_List.append binders1 action_params2) uu____16118))
in (

let uu____16123 = (

let uu____16124 = (desugar_typ env3 cps_type)
in (FStar_Syntax_Subst.close (FStar_List.append binders1 action_params2) uu____16124))
in {FStar_Syntax_Syntax.action_name = uu____16116; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_params = action_params2; FStar_Syntax_Syntax.action_defn = uu____16117; FStar_Syntax_Syntax.action_typ = uu____16123})))
in ((uu____16115), (doc1))))
end))
end
| FStar_Parser_AST.Tycon (uu____16131, ((FStar_Parser_AST.TyconAbbrev (name, action_params, uu____16134, defn), doc1))::[]) when for_free -> begin
(

let uu____16169 = (desugar_binders env2 action_params)
...
let uu____16190 = (FStar_ToSyntax_Env.qualify env3 name)
in (

let uu____16191 = (

let uu____16192 = (desugar_term env3 defn)
in (FStar_Syntax_Subst.close (FStar_List.append binders1 action_params2) uu____16192))
in {FStar_Syntax_Syntax.action_name = uu____16190; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_params = action_params2; FStar_Syntax_Syntax.action_defn = uu____16191; FStar_Syntax_Syntax.action_typ = FStar_Syntax_Syntax.tun}))
in ((uu____16189), (doc1))))
end))
end
| uu____16199 -> begin
...
let uu____16230 = (FStar_ToSyntax_Env.fail_or env2 (FStar_ToSyntax_Env.try_lookup_definition env2) l)
in (FStar_All.pipe_left (FStar_Syntax_Subst.close binders1) uu____16230))
in (([]), (uu____16229)))))
in (
...
let uu____16247 = (FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown FStar_Pervasives_Native.None FStar_Range.dummyRange)
in (([]), (uu____16247)))
in (
...
let uu____16257 = (lookup "repr")
in (FStar_Pervasives_Native.snd uu____16257))
in (

let uu____16266 = (lookup "return")
in (

let uu____16267 = (lookup "bind")
in {FStar_Syntax_Syntax.cattributes = []; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders1; FStar_Syntax_Syntax.signature = eff_t1; FStar_Syntax_Syntax.ret_wp = dummy_tscheme; FStar_Syntax_Syntax.bind_wp = dummy_tscheme; FStar_Syntax_Syntax.if_then_else = dummy_tscheme; FStar_Syntax_Syntax.ite_wp = dummy_tscheme; FStar_Syntax_Syntax.stronger = dummy_tscheme; FStar_Syntax_Syntax.close_wp = dummy_tscheme; FStar_Syntax_Syntax.assert_p = dummy_tscheme; FStar_Syntax_Syntax.assume_p = dummy_tscheme; FStar_Syntax_Syntax.null_wp = dummy_tscheme; FStar_Syntax_Syntax.trivial = dummy_tscheme; FStar_Syntax_Syntax.repr = uu____16256; FStar_Syntax_Syntax.return_repr = uu____16266; FStar_Syntax_Syntax.bind_repr = uu____16267; FStar_Syntax_Syntax.actions = actions1})))
in FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____16255))
in {FStar_Syntax_Syntax.sigel = uu____16254; FStar_Syntax_Syntax.sigrng = d.FStar_Parser_AST.drange; FStar_Syntax_Syntax.sigquals = qualifiers; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []}))
end
| uu____16268 -> begin
(

let rr = (FStar_Util.for_some (fun uu___230_16271 -> (match (uu___230_16271) with
| FStar_Syntax_Syntax.Reifiable -> begin
true
end
| FStar_Syntax_Syntax.Reflectable (uu____16272) -> begin
true
end
| uu____16273 -> begin
false
...
let uu____16285 = (lookup "return_wp")
in (

let uu____16286 = (lookup "bind_wp")
in (

let uu____16287 = (lookup "if_then_else")
in (

let uu____16288 = (lookup "ite_wp")
in (

let uu____16289 = (lookup "stronger")
in (

let uu____16290 = (lookup "close_wp")
in (

let uu____16291 = (lookup "assert_p")
in (

let uu____16292 = (lookup "assume_p")
in (

let uu____16293 = (lookup "null_wp")
in (

let uu____16294 = (lookup "trivial")
in (

let uu____16295 = (match (rr) with
| true -> begin
(

let uu____16296 = (lookup "repr")
in (FStar_All.pipe_left FStar_Pervasives_Native.snd uu____16296))
end
| uu____16311 -> begin
...
in {FStar_Syntax_Syntax.cattributes = []; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders1; FStar_Syntax_Syntax.signature = eff_t1; FStar_Syntax_Syntax.ret_wp = uu____16285; FStar_Syntax_Syntax.bind_wp = uu____16286; FStar_Syntax_Syntax.if_then_else = uu____16287; FStar_Syntax_Syntax.ite_wp = uu____16288; FStar_Syntax_Syntax.stronger = uu____16289; FStar_Syntax_Syntax.close_wp = uu____16290; FStar_Syntax_Syntax.assert_p = uu____16291; FStar_Syntax_Syntax.assume_p = uu____16292; FStar_Syntax_Syntax.null_wp = uu____16293; FStar_Syntax_Syntax.trivial = uu____16294; FStar_Syntax_Syntax.repr = uu____16295; FStar_Syntax_Syntax.return_repr = uu____16312; FStar_Syntax_Syntax.bind_repr = uu____16314; FStar_Syntax_Syntax.actions = actions1})))))))))))))
in FStar_Syntax_Syntax.Sig_new_effect (uu____16284))
in {FStar_Syntax_Syntax.sigel = uu____16283; FStar_Syntax_Syntax.sigrng = d.FStar_Parser_AST.drange; FStar_Syntax_Syntax.sigquals = qualifiers; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []})))
end)
in (
...
let env5 = (FStar_All.pipe_right actions_docs (FStar_List.fold_left (fun env5 uu____16339 -> (match (uu____16339) with
| (a, doc1) -> begin
(

let env6 = (

let uu____16353 = (FStar_Syntax_Util.action_as_lb mname a)
in (FStar_ToSyntax_Env.push_sigelt env5 uu____16353))
...
let uu____16355 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Parser_AST.Reflectable))
...
let uu____16386 = (desugar_binders env1 eff_binders)
in (match (uu____16386) with
| (env2, binders) -> begin
(

let uu____16405 = (

let uu____16424 = (head_and_args defn)
...
let uu____16478 = (FStar_Parser_AST.term_to_string head1)
in (Prims.strcat uu____16478 " not found"))
in (Prims.strcat "Effect " uu____16477))
in ((uu____16476), (d.FStar_Parser_AST.drange)))
in FStar_Errors.Error (uu____16471))
in (FStar_Exn.raise uu____16470))
end)
in (
...
let uu____16480 = (match ((FStar_List.rev args)) with
| ((last_arg, uu____16510))::args_rev -> begin
(

let uu____16522 = (

let uu____16523 = (unparen last_arg)
in uu____16523.FStar_Parser_AST.tm)
in (match (uu____16522) with
| FStar_Parser_AST.Attributes (ts) -> begin
((ts), ((FStar_List.rev args_rev)))
end
| uu____16551 -> begin
...
let uu____16611 = (desugar_args env2 args1)
in (

let uu____16620 = (desugar_attributes env2 cattributes)
in ((lid), (ed), (uu____16611), (uu____16620))))
end))))
end))
...
let sub1 = (fun uu____16679 -> (match (uu____16679) with
| (uu____16692, x) -> begin
(

let uu____16698 = (FStar_Syntax_Subst.open_term ed.FStar_Syntax_Syntax.binders x)
in (match (uu____16698) with
| (edb, x1) -> begin
...
let uu____16725 = (FStar_Syntax_Subst.subst s x1)
in (FStar_Syntax_Subst.close binders1 uu____16725))
in (([]), (uu____16724))));
)
end))
end))
...
let uu____16731 = (sub1 (([]), (ed.FStar_Syntax_Syntax.signature)))
in (FStar_Pervasives_Native.snd uu____16731))
in (

let uu____16742 = (sub1 ed.FStar_Syntax_Syntax.ret_wp)
in (

let uu____16743 = (sub1 ed.FStar_Syntax_Syntax.bind_wp)
in (

let uu____16744 = (sub1 ed.FStar_Syntax_Syntax.if_then_else)
in (

let uu____16745 = (sub1 ed.FStar_Syntax_Syntax.ite_wp)
in (

let uu____16746 = (sub1 ed.FStar_Syntax_Syntax.stronger)
in (

let uu____16747 = (sub1 ed.FStar_Syntax_Syntax.close_wp)
in (

let uu____16748 = (sub1 ed.FStar_Syntax_Syntax.assert_p)
in (

let uu____16749 = (sub1 ed.FStar_Syntax_Syntax.assume_p)
in (

let uu____16750 = (sub1 ed.FStar_Syntax_Syntax.null_wp)
in (

let uu____16751 = (sub1 ed.FStar_Syntax_Syntax.trivial)
in (

let uu____16752 = (

let uu____16753 = (sub1 (([]), (ed.FStar_Syntax_Syntax.repr)))
in (FStar_Pervasives_Native.snd uu____16753))
in (

let uu____16764 = (sub1 ed.FStar_Syntax_Syntax.return_repr)
in (

let uu____16765 = (sub1 ed.FStar_Syntax_Syntax.bind_repr)
in (

let uu____16766 = (FStar_List.map (fun action -> (

let uu____16774 = (FStar_ToSyntax_Env.qualify env2 action.FStar_Syntax_Syntax.action_unqualified_name)
in (

let uu____16775 = (

let uu____16776 = (sub1 (([]), (action.FStar_Syntax_Syntax.action_defn)))
in (FStar_Pervasives_Native.snd uu____16776))
in (

let uu____16787 = (

let uu____16788 = (sub1 (([]), (action.FStar_Syntax_Syntax.action_typ)))
in (FStar_Pervasives_Native.snd uu____16788))
in {FStar_Syntax_Syntax.action_name = uu____16774; FStar_Syntax_Syntax.action_unqualified_name = action.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = action.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_params = action.FStar_Syntax_Syntax.action_params; FStar_Syntax_Syntax.action_defn = uu____16775; FStar_Syntax_Syntax.action_typ = uu____16787})))) ed.FStar_Syntax_Syntax.actions)
in {FStar_Syntax_Syntax.cattributes = cattributes; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders1; FStar_Syntax_Syntax.signature = uu____16730; FStar_Syntax_Syntax.ret_wp = uu____16742; FStar_Syntax_Syntax.bind_wp = uu____16743; FStar_Syntax_Syntax.if_then_else = uu____16744; FStar_Syntax_Syntax.ite_wp = uu____16745; FStar_Syntax_Syntax.stronger = uu____16746; FStar_Syntax_Syntax.close_wp = uu____16747; FStar_Syntax_Syntax.assert_p = uu____16748; FStar_Syntax_Syntax.assume_p = uu____16749; FStar_Syntax_Syntax.null_wp = uu____16750; FStar_Syntax_Syntax.trivial = uu____16751; FStar_Syntax_Syntax.repr = uu____16752; FStar_Syntax_Syntax.return_repr = uu____16764; FStar_Syntax_Syntax.bind_repr = uu____16765; FStar_Syntax_Syntax.actions = uu____16766})))))))))))))))
in (
...
let uu____16809 = (FStar_Syntax_Util.arrow_formals ed1.FStar_Syntax_Syntax.signature)
in (FStar_Pervasives_Native.fst uu____16809))
in (FStar_List.length uu____16802))
in (Prims.op_Equality uu____16801 (Prims.parse_int "1")))
in (

let uu____16838 = (

let uu____16841 = (trans_qual1 (FStar_Pervasives_Native.Some (mname)))
in (FStar_List.map uu____16841 quals))
...
end); FStar_Syntax_Syntax.sigrng = d.FStar_Parser_AST.drange; FStar_Syntax_Syntax.sigquals = uu____16838; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []}))
in (
...
let uu____16861 = (FStar_Syntax_Util.action_as_lb mname a)
in (FStar_ToSyntax_Env.push_sigelt env5 uu____16861))
in (FStar_ToSyntax_Env.push_doc env6 a.FStar_Syntax_Syntax.action_name doc1)))) env4))
in (

let env6 = (

let uu____16863 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Parser_AST.Reflectable))
...
let uu____16878 = (match (d.FStar_Parser_AST.doc) with
| FStar_Pervasives_Native.None -> begin
((""), ([]))
end
...
| FStar_Pervasives_Native.Some (uu____16929) -> begin
(

let uu____16930 = (

let uu____16931 = (FStar_Parser_ToDocument.signature_to_document d)
in (FStar_Pprint.pretty_string 0.950000 (Prims.parse_int "80") uu____16931))
in (Prims.strcat "\n  " uu____16930))
end
| uu____16932 -> begin
""
...
let other = (FStar_List.filter_map (fun uu____16945 -> (match (uu____16945) with
| (k, v1) -> begin
...
let uu____16963 = (FStar_Ident.lid_of_str "FStar.Pervasives.Comment")
in (FStar_Syntax_Syntax.fvar uu____16963 FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None))
in (
...
let uu____16974 = (FStar_Syntax_Syntax.as_arg arg)
in (uu____16974)::[])
in (FStar_Syntax_Util.mk_app fv uu____16965)))))))))
end)))
and desugar_decl : env_t  ->  FStar_Parser_AST.decl  ->  (env_t * FStar_Syntax_Syntax.sigelts) = (fun env d -> (

let uu____16981 = (desugar_decl_noattrs env d)
...
let uu____17001 = (mk_comment_attr d)
in (uu____17001)::attrs1)
in (

let uu____17006 = (FStar_List.map (fun sigelt -> (

let uu___252_17012 = sigelt
in {FStar_Syntax_Syntax.sigel = uu___252_17012.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___252_17012.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___252_17012.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___252_17012.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = attrs2})) sigelts)
in ((env1), (uu____17006))))))
end)))
...
| FStar_Parser_AST.Fsdoc (uu____17038) -> begin
((env), ([]))
end
...
let uu____17054 = (FStar_ToSyntax_Env.push_module_abbrev env x l)
in ((uu____17054), ([])))
end
...
let tcs1 = (FStar_List.map (fun uu____17093 -> (match (uu____17093) with
| (x, uu____17101) -> begin
x
end)) tcs)
in (

let uu____17106 = (FStar_List.map (trans_qual1 FStar_Pervasives_Native.None) quals)
in (desugar_tycon env d uu____17106 tcs1))))
end
...
| (({FStar_Parser_AST.pat = FStar_Parser_AST.PatOp (uu____17128); FStar_Parser_AST.prange = uu____17129}, uu____17130))::[] -> begin
false
end
| (({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (uu____17139); FStar_Parser_AST.prange = uu____17140}, uu____17141))::[] -> begin
false
end
| (({FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (uu____17156); FStar_Parser_AST.prange = uu____17157}, uu____17158); FStar_Parser_AST.prange = uu____17159}, uu____17160))::[] -> begin
false
end
| ((p, uu____17176))::[] -> begin
(

let uu____17185 = (is_app_pattern p)
in (not (uu____17185)))
end
| uu____17186 -> begin
false
...
let uu____17206 = (FStar_All.pipe_left FStar_Syntax_Subst.compress ds_lets)
in uu____17206.FStar_Syntax_Syntax.n)
in (match (uu____17205) with
| FStar_Syntax_Syntax.Tm_let (lbs, uu____17214) -> begin
(
...
| (uu____17247)::uu____17248 -> begin
(FStar_List.map (trans_qual1 FStar_Pervasives_Native.None) quals)
end
| uu____17251 -> begin
(FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) (FStar_List.collect (fun uu___231_17264 -> (match (uu___231_17264) with
| {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (uu____17267); FStar_Syntax_Syntax.lbunivs = uu____17268; FStar_Syntax_Syntax.lbtyp = uu____17269; FStar_Syntax_Syntax.lbeff = uu____17270; FStar_Syntax_Syntax.lbdef = uu____17271} -> begin
[]
end
| {FStar_Syntax_Syntax.lbname = FStar_Util.Inr (fv); FStar_Syntax_Syntax.lbunivs = uu____17279; FStar_Syntax_Syntax.lbtyp = uu____17280; FStar_Syntax_Syntax.lbeff = uu____17281; FStar_Syntax_Syntax.lbdef = uu____17282} -> begin
...
let uu____17292 = (FStar_All.pipe_right lets (FStar_Util.for_some (fun uu____17306 -> (match (uu____17306) with
| (uu____17311, t) -> begin
...
let uu____17323 = (FStar_All.pipe_right quals2 (FStar_List.contains FStar_Syntax_Syntax.Abstract))
in (match (uu____17323) with
| true -> begin
(

let uu____17332 = (FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) (FStar_List.map (fun lb -> (

let fv = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (

let uu___253_17346 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inr ((

let uu___254_17348 = fv
in {FStar_Syntax_Syntax.fv_name = uu___254_17348.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_abstract (fv.FStar_Syntax_Syntax.fv_delta); FStar_Syntax_Syntax.fv_qual = uu___254_17348.FStar_Syntax_Syntax.fv_qual})); FStar_Syntax_Syntax.lbunivs = uu___253_17346.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___253_17346.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___253_17346.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___253_17346.FStar_Syntax_Syntax.lbdef})))))
in (((FStar_Pervasives_Native.fst lbs)), (uu____17332)))
end
| uu____17353 -> begin
lbs
end))
...
let uu____17386 = (match (lets) with
| ((pat, body))::[] -> begin
((pat), (body))
end
| uu____17405 -> begin
...
let uu___255_17429 = pat1
in {FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed (((var_pat), (ty))); FStar_Parser_AST.prange = uu___255_17429.FStar_Parser_AST.prange})
end
| uu____17430 -> begin
var_pat
end))
...
let uu___256_17437 = d
in {FStar_Parser_AST.d = FStar_Parser_AST.TopLevelLet (((isrec), ((((fresh_pat), (body)))::[]))); FStar_Parser_AST.drange = uu___256_17437.FStar_Parser_AST.drange; FStar_Parser_AST.doc = uu___256_17437.FStar_Parser_AST.doc; FStar_Parser_AST.quals = (FStar_Parser_AST.Private)::d.FStar_Parser_AST.quals; FStar_Parser_AST.attrs = uu___256_17437.FStar_Parser_AST.attrs}))
in (

let build_projection = (fun uu____17469 id -> (match (uu____17469) with
| (env1, ses) -> begin
(
...
let uu____17491 = (FStar_Ident.lid_of_ids ((fresh_toplevel_name)::[]))
in FStar_Parser_AST.Var (uu____17491))
in (FStar_Parser_AST.mk_term uu____17490 FStar_Range.dummyRange FStar_Parser_AST.Expr))
in (
...
let uu____17541 = (desugar_decl env1 id_decl)
...
let uu____17559 = (gather_pattern_bound_vars pat)
in (FStar_All.pipe_right uu____17559 FStar_Util.set_elements))
...
let uu____17590 = (close_fun env t)
in (desugar_term env uu____17590))
in (

let quals1 = (

let uu____17594 = ((FStar_ToSyntax_Env.iface env) && (FStar_ToSyntax_Env.admitted_iface env))
...
let uu____17600 = (FStar_List.map (trans_qual1 FStar_Pervasives_Native.None) quals1)
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((lid), ([]), (t1))); FStar_Syntax_Syntax.sigrng = d.FStar_Parser_AST.drange; FStar_Syntax_Syntax.sigquals = uu____17600; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []})
in (
...
let uu____17612 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_lid env) FStar_Parser_Const.exn_lid)
...
let uu____17667 = (FStar_Syntax_Syntax.null_binder t)
in (uu____17667)::[])
in (
...
let uu____17672 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_lid env) FStar_Parser_Const.exn_lid)
in (FStar_Pervasives_Native.fst uu____17672))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total uu____17671))
in (FStar_Syntax_Util.arrow uu____17660 uu____17668)))
in (
...
let uu____17734 = (FStar_ToSyntax_Env.try_lookup_effect_name env l1)
in (match (uu____17734) with
| FStar_Pervasives_Native.None -> begin
(
...
let uu____17745 = (FStar_Syntax_Print.lid_to_string l1)
in (Prims.strcat uu____17745 " not found"))
in (Prims.strcat "Effect name " uu____17744))
in ((uu____17743), (d.FStar_Parser_AST.drange)))
in FStar_Errors.Error (uu____17738))
in (FStar_Exn.raise uu____17737))
end
...
let uu____17749 = (match (l.FStar_Parser_AST.lift_op) with
...
let uu____17807 = (desugar_term env t)
in (([]), (uu____17807)))
in FStar_Pervasives_Native.Some (uu____17800))
in ((uu____17791), (FStar_Pervasives_Native.None)))
end
...
let uu____17856 = (desugar_term env wp)
in (([]), (uu____17856)))
in FStar_Pervasives_Native.Some (uu____17849))
in (
...
let uu____17881 = (desugar_term env t)
in (([]), (uu____17881)))
in FStar_Pervasives_Native.Some (uu____17874))
in ((uu____17840), (uu____17865))))
end
...
let uu____17923 = (desugar_term env t)
in (([]), (uu____17923)))
in FStar_Pervasives_Native.Some (uu____17916))
in ((FStar_Pervasives_Native.None), (uu____17907)))
end)
...
let desugar_decls : FStar_ToSyntax_Env.env  ->  FStar_Parser_AST.decl Prims.list  ->  (FStar_ToSyntax_Env.env * FStar_Syntax_Syntax.sigelts) = (fun env decls -> (

let uu____18011 = (FStar_List.fold_left (fun uu____18031 d -> (match (uu____18031) with
| (env1, sigelts) -> begin
(

let uu____18051 = (desugar_decl env1 d)
...
let rec forward = (fun acc uu___233_18090 -> (match (uu___233_18090) with
| (se1)::(se2)::sigelts1 -> begin
(match (((se1.FStar_Syntax_Syntax.sigel), (se2.FStar_Syntax_Syntax.sigel))) with
| (FStar_Syntax_Syntax.Sig_declare_typ (uu____18104), FStar_Syntax_Syntax.Sig_let (uu____18105)) -> begin
(
...
let uu___257_18122 = se2
in (

let uu____18123 = (

let uu____18126 = (FStar_List.filter (fun uu___232_18140 -> (match (uu___232_18140) with
| {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____18144; FStar_Syntax_Syntax.vars = uu____18145}, uu____18146); FStar_Syntax_Syntax.pos = uu____18147; FStar_Syntax_Syntax.vars = uu____18148} when (

let uu____18171 = (

let uu____18172 = (FStar_Syntax_Syntax.lid_of_fv fv)
in (FStar_Ident.string_of_lid uu____18172))
in (Prims.op_Equality uu____18171 "FStar.Pervasives.Comment")) -> begin
true
end
| uu____18173 -> begin
false
end)) se1.FStar_Syntax_Syntax.sigattrs)
in (FStar_List.append uu____18126 se2.FStar_Syntax_Syntax.sigattrs))
in {FStar_Syntax_Syntax.sigel = uu___257_18122.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___257_18122.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___257_18122.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___257_18122.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu____18123}))
in (uu____18121)::(se1)::acc)
in (forward uu____18118 sigelts1))
end
| uu____18178 -> begin
...
let uu____18186 = (forward [] sigelts)
in ((env1), (uu____18186))))
end)))
...
| (FStar_Pervasives_Native.None, uu____18240) -> begin
env
end
| (FStar_Pervasives_Native.Some ({FStar_Syntax_Syntax.name = prev_lid; FStar_Syntax_Syntax.declarations = uu____18244; FStar_Syntax_Syntax.exports = uu____18245; FStar_Syntax_Syntax.is_interface = uu____18246}), FStar_Parser_AST.Module (current_lid, uu____18248)) when ((FStar_Ident.lid_equals prev_lid current_lid) && (FStar_Options.interactive ())) -> begin
env
end
| (FStar_Pervasives_Native.Some (prev_mod), uu____18256) -> begin
(FStar_ToSyntax_Env.finish_module_or_interface env prev_mod)
end)
in (

let uu____18259 = (match (m) with
| FStar_Parser_AST.Interface (mname, decls, admitted) -> begin
(

let uu____18295 = (FStar_ToSyntax_Env.prepare_module_or_interface true admitted env1 mname FStar_ToSyntax_Env.default_mii)
in ((uu____18295), (mname), (decls), (true)))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(

let uu____18312 = (FStar_ToSyntax_Env.prepare_module_or_interface false false env1 mname FStar_ToSyntax_Env.default_mii)
in ((uu____18312), (mname), (decls), (false)))
end)
in (match (uu____18259) with
| ((env2, pop_when_done), mname, decls, intf) -> begin
(

let uu____18342 = (desugar_decls env2 decls)
...
let uu____18394 = ((FStar_Options.interactive ()) && (

let uu____18396 = (

let uu____18397 = (

let uu____18398 = (FStar_Options.file_list ())
in (FStar_List.hd uu____18398))
in (FStar_Util.get_file_extension uu____18397))
in (FStar_List.mem uu____18396 (("fsti")::("fsi")::[]))))
in (match (uu____18394) with
| true -> begin
(as_interface m)
end
| uu____18401 -> begin
...
let uu____18402 = (desugar_modul_common curmod env m1)
...
let uu____18417 = (FStar_ToSyntax_Env.pop ())
in ())
end
| uu____18418 -> begin
()
...
let uu____18435 = (desugar_modul_common FStar_Pervasives_Native.None env m)
in (match (uu____18435) with
...
let uu____18451 = (FStar_Options.dump_module modul.FStar_Syntax_Syntax.name.FStar_Ident.str)
in (match (uu____18451) with
| true -> begin
(

let uu____18452 = (FStar_Syntax_Print.modul_to_string modul)
...
let uu____18454 = (match (pop_when_done) with
| true -> begin
...
let uu____18468 = (FStar_ToSyntax_Env.prepare_module_or_interface false false en m.FStar_Syntax_Syntax.name mii)
...
let uu____18476 = (FStar_ToSyntax_Env.set_current_module en1 m.FStar_Syntax_Syntax.name)
in (FStar_List.fold_left FStar_ToSyntax_Env.push_sigelt uu____18476 m.FStar_Syntax_Syntax.exports))
in (
