      ...
      fun top  ->
        ...
        | FStar_Parser_AST.Ascribed (e,t,tac_opt) ->
            let annot =
              ...
              if uu____4932
              then
                let uu____4937 = desugar_comp t.FStar_Parser_AST.range env t
                   in
                FStar_Util.Inr uu____4937
              else
                (let uu____4943 = desugar_term env t  in
                 FStar_Util.Inl uu____4943)
               in
                           ...
                           (fun uu____5081  ->
                              ...
                              | (f,uu____5087) ->
                                  let uu____5088 =
                                    ...
                                    FStar_All.pipe_left Prims.snd uu____5089
                                     in
                                  (uu____5088, FStar_Parser_AST.Nothing)))
                       in
                        ...
                        FStar_All.pipe_right record.FStar_ToSyntax_Env.fields
                          (FStar_List.map
                             (fun uu____5124  ->
                                ...
                                | (f,uu____5130) -> get_field (Some xterm) f))
                         in
                      (None, uu____5110)  in
                     ...
                     let uu____5175 =
                       let uu____5185 =
                         ...
                         FStar_Syntax_Syntax.fvar
                           ...
                           FStar_Syntax_Syntax.Delta_constant uu____5186
                          in
                       (uu____5185, args)  in
    ...
    fun env  ->
      fun t  ->
        ...
        let is_requires uu____5325 =
          ...
          | (t1,uu____5329) ->
              let uu____5330 =
                let uu____5331 = unparen t1  in
                uu____5331.FStar_Parser_AST.tm  in
        ...
        let is_ensures uu____5342 =
          ...
          | (t1,uu____5346) ->
              let uu____5347 =
                let uu____5348 = unparen t1  in
                uu____5348.FStar_Parser_AST.tm  in
        ...
        let is_app head1 uu____5362 =
          ...
          | (t1,uu____5366) ->
              let uu____5367 =
                let uu____5368 = unparen t1  in
                uu____5368.FStar_Parser_AST.tm  in
        ...
        let is_smt_pat uu____5380 =
          ...
          | (t1,uu____5384) ->
              let uu____5385 =
                let uu____5386 = unparen t1  in
                uu____5386.FStar_Parser_AST.tm  in
          ...
          | (head1,args) ->
              (match head1.FStar_Parser_AST.tm with
               ...
               | FStar_Parser_AST.Name l when
                   ...
                   (uu____5647, args)
               | FStar_Parser_AST.Name l when
                   (let uu____5661 = FStar_ToSyntax_Env.current_module env
                       in
               ...
               | FStar_Parser_AST.Name l when
                   (let uu____5670 = FStar_ToSyntax_Env.current_module env
                       in
...
and desugar_formula :
  ...
  fun env  ->
    fun f  ->
      ...
      let setpos t =
        let uu___229_6228 = t  in
        {
          FStar_Syntax_Syntax.n = (uu___229_6228.FStar_Syntax_Syntax.n);
          FStar_Syntax_Syntax.tk = (uu___229_6228.FStar_Syntax_Syntax.tk);
          FStar_Syntax_Syntax.pos = (f.FStar_Parser_AST.range);
          FStar_Syntax_Syntax.vars = (uu___229_6228.FStar_Syntax_Syntax.vars)
        }  in
      let desugar_quant q b pats body =
        let tk =
          desugar_binder env
            (let uu___230_6258 = b  in
             {
               FStar_Parser_AST.b = (uu___230_6258.FStar_Parser_AST.b);
               FStar_Parser_AST.brange =
                 (uu___230_6258.FStar_Parser_AST.brange);
               FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
               FStar_Parser_AST.aqual =
                 (uu___230_6258.FStar_Parser_AST.aqual)
             })
           in
        ...
        | (Some a,k) ->
            ...
            (match uu____6300 with
             | (env1,a1) ->
                 let a2 =
                   let uu___231_6308 = a1  in
                   {
                     FStar_Syntax_Syntax.ppname =
                       (uu___231_6308.FStar_Syntax_Syntax.ppname);
                     FStar_Syntax_Syntax.index =
                       (uu___231_6308.FStar_Syntax_Syntax.index);
                     FStar_Syntax_Syntax.sort = k
                   }  in
          ...
          (fun uu____6512  ->
             fun b  ->
               ...
               | (env1,out) ->
                   let tk =
                     desugar_binder env1
                       (let uu___232_6540 = b  in
                        {
                          FStar_Parser_AST.b =
                            (uu___232_6540.FStar_Parser_AST.b);
                          FStar_Parser_AST.brange =
                            (uu___232_6540.FStar_Parser_AST.brange);
                          FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
                          FStar_Parser_AST.aqual =
                            (uu___232_6540.FStar_Parser_AST.aqual)
                        })
                      in
                   (match tk with
                    | (Some a,k) ->
                        let uu____6550 = FStar_ToSyntax_Env.push_bv env1 a
                           in
                        (match uu____6550 with
                         | (env2,a1) ->
                             let a2 =
                               let uu___233_6562 = a1  in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___233_6562.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___233_6562.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = k
                               }  in
                             (env2,
           ...
           (match uu____6855 with
            | (formals,uu____6865) ->
                (match formals with
                 | [] -> []
                 | uu____6879 ->
                     let filter_records uu___213_6887 =
                       match uu___213_6887 with
    ...
    fun d  ->
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___214_7017 =
            match uu___214_7017 with
          ...
          let apply_binders t binders =
            ...
            FStar_List.fold_left
              ...
              binders
             in
          let tycon_record_as_variant uu___215_7094 =
            match uu___215_7094 with
          ...
          let desugar_abstract_tc quals1 _env mutuals uu___216_7207 =
            match uu___216_7207 with
                           ...
                           | uu____7451 ->
                               let uu____7452 =
                                 let uu____7455 =
                                   ...
                                   FStar_Syntax_Syntax.Tm_arrow uu____7456
                                    in
                                 FStar_Syntax_Syntax.mk uu____7455  in
                               uu____7452 None se.FStar_Syntax_Syntax.sigrng
                            in
                         let uu___234_7473 = se  in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ (l, [], t));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___234_7473.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals = quals2;
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___234_7473.FStar_Syntax_Syntax.sigmeta)
                         }
                   ...
                   let k =
                     ...
                     | None  ->
                         let uu____7508 =
                           FStar_Util.for_some
                             (fun uu___217_7509  ->
                                match uu___217_7509 with
                                | FStar_Syntax_Syntax.Effect  -> true
                                | uu____7510 -> false) quals
                            in
                         if uu____7508
                              ...
                              let uu____7922 =
                                let uu____7924 =
                                  let uu____7925 =
                                    ...
                                    (uu____7930, fs)  in
                                  FStar_Syntax_Syntax.RecordType uu____7925
                                   in
                     ...
                     FStar_All.pipe_right docs_tps_sigelts
                       (FStar_List.map
                          (fun uu____9053  ->
                             ...
                             | (name_doc,uu____9068,uu____9069) -> name_doc))
                      in
                   let sigelts =
                     FStar_All.pipe_right docs_tps_sigelts
                       (FStar_List.map
                              ...
                              let se =
                                ...
                                then
                                  ...
                                  (let rr =
                                     FStar_Util.for_some
                                       (fun uu___222_9685  ->
                                          match uu___222_9685 with
                                          | FStar_Syntax_Syntax.Reifiable 
                                            |FStar_Syntax_Syntax.Reflectable
                                            _ -> true
                                          | uu____9687 -> false) qualifiers
                                      in
                                   let un_ts = ([], FStar_Syntax_Syntax.tun)
                                      in
                                   let uu____9693 =
                                     let uu____9694 =
                                       let uu____9695 = lookup "return_wp"
                                          in
                                       let uu____9696 = lookup "bind_wp"  in
                                       let uu____9697 = lookup "if_then_else"
                                          in
                                      ...
                                      let uu____9818 =
                                        let uu____9819 =
                                          FStar_Parser_AST.term_to_string
                                            head1
                                           in
                                        Prims.strcat uu____9819 " not found"
                                         in
                                      Prims.strcat "Effect " uu____9818  in
                                    (uu____9817, (d.FStar_Parser_AST.drange))
                                     in
                                  FStar_Errors.Error uu____9814  in
                                Prims.raise uu____9813
                             in
                          let ed =
                            FStar_ToSyntax_Env.fail_or env2
    ...
    fun d  ->
      ...
      | FStar_Parser_AST.Tycon (is_effect,tcs) ->
          ...
          let tcs1 =
            FStar_List.map
              (fun uu____10114  ->
                 match uu____10114 with | (x,uu____10119) -> x) tcs
             in
                            ...
                            (fun lb  ->
                               let fv =
                                 FStar_Util.right
                                   lb.FStar_Syntax_Syntax.lbname
                                  in
                               let uu___235_10269 = lb  in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___236_10270 = fv  in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___236_10270.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___236_10270.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___235_10269.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___235_10269.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___235_10269.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___235_10269.FStar_Syntax_Syntax.lbdef)
                               }))
                        in
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___237_10328 = pat1  in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___237_10328.FStar_Parser_AST.prange)
                       }
                   | uu____10329 -> var_pat  in
                 let main_let =
                   desugar_decl env
                     (let uu___238_10333 = d  in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___238_10333.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___238_10333.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___238_10333.FStar_Parser_AST.attrs)
                      })
                    in
                 ...
                 let bvs =
                   ...
                   FStar_All.pipe_right uu____10405 FStar_Util.set_elements
                    in
      ...
      | FStar_Parser_AST.Val (id,t) ->
          let quals = d.FStar_Parser_AST.quals  in
          let t1 =
            let uu____10426 = close_fun env t  in
            desugar_term env uu____10426  in
          let quals1 =
            let uu____10429 =
      ...
      | FStar_Parser_AST.Exception (id,Some term) ->
          ...
          let t1 =
            ...
            let uu____10483 =
              ...
              FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total uu____10486
               in
      ...
      | FStar_Parser_AST.SubEffect l ->
            ...
            | None  ->
                let uu____10536 =
                  let uu____10537 =
                    let uu____10540 =
                      let uu____10541 =
                        let uu____10542 = FStar_Syntax_Print.lid_to_string l1
                           in
          ...
          let uu____10546 =
            ...
            | FStar_Parser_AST.NonReifiableLift t ->
                let uu____10568 =
                  let uu____10573 =
                    let uu____10577 = desugar_term env t  in
                    ([], uu____10577)  in
                  Some uu____10573  in
                (uu____10568, None)
            | FStar_Parser_AST.ReifiableLift (wp,t) ->
                ...
                let uu____10609 =
                  let uu____10614 =
                    let uu____10618 = desugar_term env t  in
                    ([], uu____10618)  in
                  Some uu____10614  in
            ...
            | FStar_Parser_AST.LiftForFree t ->
                let uu____10632 =
                  let uu____10637 =
                    let uu____10641 = desugar_term env t  in
                    ([], uu____10641)  in
                  Some uu____10637  in
                (None, uu____10632)
             in
