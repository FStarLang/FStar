...
| FStar_Parser_AST.PatOr (uu____2627) -> begin
(failwith "impossible")
end
...
let uu____2658 = (FStar_Parser_AST.compile_op (Prims.parse_int "0") op.FStar_Ident.idText op.FStar_Ident.idRange)
in ((uu____2658), (op.FStar_Ident.idRange)))
in (FStar_Ident.mk_ident uu____2653))
in ((uu____2652), (FStar_Pervasives_Native.None)))
in FStar_Parser_AST.PatVar (uu____2645))
in {FStar_Parser_AST.pat = uu____2644; FStar_Parser_AST.prange = p1.FStar_Parser_AST.prange})
in (aux loc env1 uu____2643))
end
| FStar_Parser_AST.PatAscribed (p2, t) -> begin
(

let uu____2663 = (aux loc env1 p2)
...
let uu___248_2717 = p4
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var ((

let uu___249_2722 = x
in {FStar_Syntax_Syntax.ppname = uu___249_2722.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___249_2722.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})); FStar_Syntax_Syntax.p = uu___248_2717.FStar_Syntax_Syntax.p})
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(

let uu___250_2724 = p4
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild ((

let uu___251_2729 = x
in {FStar_Syntax_Syntax.ppname = uu___251_2729.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___251_2729.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})); FStar_Syntax_Syntax.p = uu___250_2724.FStar_Syntax_Syntax.p})
end
| uu____2730 when top -> begin
p4
end
| uu____2731 -> begin
...
let uu____2734 = (match (binder) with
| LetBinder (uu____2747) -> begin
(failwith "impossible")
end
...
let uu____2761 = (close_fun env1 t)
in (desugar_term env1 uu____2761))
...
let uu____2765 = (FStar_Syntax_Print.term_to_string x.FStar_Syntax_Syntax.sort)
in (

let uu____2766 = (FStar_Syntax_Print.term_to_string t1)
...
let uu____2768 = (annot_pat_var p3 t1)
in ((uu____2768), (LocalBinder ((((

let uu___252_2774 = x
in {FStar_Syntax_Syntax.ppname = uu___252_2774.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___252_2774.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})), (aq))))));
))
end)
...
let uu____2796 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_wild (x)))
in ((loc), (env1), (LocalBinder (((x), (FStar_Pervasives_Native.None)))), (uu____2796), (false))))
end
...
let uu____2807 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_constant (c)))
in ((loc), (env1), (LocalBinder (((x), (FStar_Pervasives_Native.None)))), (uu____2807), (false))))
end
...
let uu____2828 = (resolvex loc env1 x)
in (match (uu____2828) with
| (loc1, env2, xbv) -> begin
(

let uu____2850 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_var (xbv)))
in ((loc1), (env2), (LocalBinder (((xbv), (aq1)))), (uu____2850), (imp)))
end))))
end
...
let uu____2871 = (resolvex loc env1 x)
in (match (uu____2871) with
| (loc1, env2, xbv) -> begin
(

let uu____2893 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_var (xbv)))
in ((loc1), (env2), (LocalBinder (((xbv), (aq1)))), (uu____2893), (imp)))
end))))
end
...
let uu____2905 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l1), ([])))))
in ((loc), (env1), (LocalBinder (((x), (FStar_Pervasives_Native.None)))), (uu____2905), (false)))))
end
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatName (l); FStar_Parser_AST.prange = uu____2929}, args) -> begin
(

let uu____2935 = (FStar_List.fold_right (fun arg uu____2976 -> (match (uu____2976) with
| (loc1, env2, args1) -> begin
(

let uu____3024 = (aux loc1 env2 arg)
in (match (uu____3024) with
| (loc2, env3, uu____3053, arg1, imp) -> begin
...
let uu____3123 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l1), (args1)))))
in ((loc1), (env2), (LocalBinder (((x), (FStar_Pervasives_Native.None)))), (uu____3123), (false)))))
end))
end
| FStar_Parser_AST.PatApp (uu____3140) -> begin
(FStar_Exn.raise (FStar_Errors.Error ((("Unexpected pattern"), (p1.FStar_Parser_AST.prange)))))
end
| FStar_Parser_AST.PatList (pats) -> begin
(

let uu____3162 = (FStar_List.fold_right (fun pat uu____3195 -> (match (uu____3195) with
| (loc1, env2, pats1) -> begin
(

let uu____3227 = (aux loc1 env2 pat)
in (match (uu____3227) with
| (loc2, env3, uu____3252, pat1, uu____3254) -> begin
...
let uu____3305 = (FStar_Range.end_range p1.FStar_Parser_AST.prange)
in (pos_r uu____3305))
in (
...
let uu____3320 = (FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.nil_lid FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in ((uu____3320), ([])))
in FStar_Syntax_Syntax.Pat_cons (uu____3307))
in (FStar_All.pipe_left uu____3300 uu____3306)))
...
let uu____3366 = (FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.cons_lid FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in ((uu____3366), ((((hd1), (false)))::(((tl1), (false)))::[])))
in FStar_Syntax_Syntax.Pat_cons (uu____3353))
in (FStar_All.pipe_left (pos_r r) uu____3352)))) pats1 uu____3297))
in (
...
let uu____3410 = (FStar_List.fold_left (fun uu____3450 p2 -> (match (uu____3450) with
| (loc1, env2, pats) -> begin
(

let uu____3499 = (aux loc1 env2 p2)
in (match (uu____3499) with
| (loc2, env3, uu____3528, pat, uu____3530) -> begin
...
let uu____3625 = (FStar_ToSyntax_Env.fail_or env2 (FStar_ToSyntax_Env.try_lookup_lid env2) l)
in (match (uu____3625) with
| (constr, uu____3647) -> begin
(
...
let uu____3652 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l1), (args2)))))
in ((loc1), (env2), (LocalBinder (((x), (FStar_Pervasives_Native.None)))), (uu____3652), (false)))))
end))))
end))
end
...
let fields1 = (FStar_All.pipe_right fields (FStar_List.map (fun uu____3723 -> (match (uu____3723) with
| (f, p2) -> begin
((f.FStar_Ident.ident), (p2))
end))))
in (

let args = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map (fun uu____3753 -> (match (uu____3753) with
| (f, uu____3759) -> begin
(

let uu____3760 = (FStar_All.pipe_right fields1 (FStar_List.tryFind (fun uu____3786 -> (match (uu____3786) with
| (g, uu____3792) -> begin
...
| FStar_Pervasives_Native.Some (uu____3797, p2) -> begin
p2
end))
end))))
in (
...
let uu____3814 = (FStar_Ident.lid_of_ids (FStar_List.append record.FStar_ToSyntax_Env.typename.FStar_Ident.ns ((record.FStar_ToSyntax_Env.constrname)::[])))
in FStar_Parser_AST.PatName (uu____3814))
in (FStar_Parser_AST.mk_pattern uu____3813 p1.FStar_Parser_AST.prange))
in ((uu____3812), (args)))
in FStar_Parser_AST.PatApp (uu____3805))
in (FStar_Parser_AST.mk_pattern uu____3804 p1.FStar_Parser_AST.prange))
in (

let uu____3817 = (aux loc env1 app)
in (match (uu____3817) with
| (env2, e, b, p2, uu____3846) -> begin
(
...
let uu____3901 = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map FStar_Pervasives_Native.fst))
in ((record.FStar_ToSyntax_Env.typename), (uu____3901)))
in FStar_Syntax_Syntax.Record_ctor (uu____3894))
in FStar_Pervasives_Native.Some (uu____3893))
in {FStar_Syntax_Syntax.fv_name = uu___253_3889.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = uu___253_3889.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu____3890}))
in ((uu____3888), (args1)))
in FStar_Syntax_Syntax.Pat_cons (uu____3875))
in (FStar_All.pipe_left pos uu____3874))
end
| uu____3928 -> begin
p2
end)
...
let uu____3978 = (aux' true loc env1 p2)
in (match (uu____3978) with
| (loc1, env2, var, p3, uu____4005) -> begin
(

let uu____4010 = (FStar_List.fold_left (fun uu____4042 p4 -> (match (uu____4042) with
| (loc2, env3, ps1) -> begin
(

let uu____4075 = (aux' true loc2 env3 p4)
in (match (uu____4075) with
| (loc3, env4, uu____4100, p5, uu____4102) -> begin
((loc3), (env4), ((p5)::ps1))
end))
end)) ((loc1), (env2), ([])) ps)
...
let uu____4154 = (aux' true loc env1 p1)
...
let uu____4194 = (aux_maybe_or env p)
in (match (uu____4194) with
| (env1, b, pats) -> begin
((

let uu____4225 = (FStar_List.map check_linear_pattern_variables pats)
in (FStar_All.pipe_left FStar_Pervasives.ignore uu____4225));
((env1), (b), (pats));
)
end))))));
)))
...
let uu____4266 = (FStar_ToSyntax_Env.qualify env x)
in ((uu____4266), (FStar_Syntax_Syntax.tun)))
in LetBinder (uu____4261))
in ((env), (uu____4260), ([]))))
in (match (top) with
| true -> begin
...
let uu____4292 = (FStar_Parser_AST.compile_op (Prims.parse_int "0") x.FStar_Ident.idText x.FStar_Ident.idRange)
in ((uu____4292), (x.FStar_Ident.idRange)))
in (FStar_Ident.mk_ident uu____4287))
in (mklet uu____4286))
end
| FStar_Parser_AST.PatVar (x, uu____4294) -> begin
(mklet x)
end
| FStar_Parser_AST.PatAscribed ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (x, uu____4300); FStar_Parser_AST.prange = uu____4301}, t) -> begin
(
...
let uu____4313 = (FStar_ToSyntax_Env.qualify env x)
in (

let uu____4314 = (desugar_term env t)
in ((uu____4313), (uu____4314))))
in LetBinder (uu____4308))
in ((env), (uu____4307), ([])))
end
| uu____4317 -> begin
...
let uu____4327 = (desugar_data_pat env p is_mut)
in (match (uu____4327) with
| (env1, binder, p1) -> begin
(

let p2 = (match (p1) with
| ({FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (uu____4356); FStar_Syntax_Syntax.p = uu____4357})::[] -> begin
[]
end
| ({FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (uu____4362); FStar_Syntax_Syntax.p = uu____4363})::[] -> begin
[]
end
| uu____4368 -> begin
p1
...
and desugar_match_pat_maybe_top : Prims.bool  ->  FStar_ToSyntax_Env.env  ->  FStar_Parser_AST.pattern  ->  (env_t * FStar_Syntax_Syntax.pat Prims.list) = (fun uu____4375 env pat -> (

let uu____4378 = (desugar_data_pat env pat false)
in (match (uu____4378) with
| (env1, uu____4394, pat1) -> begin
((env1), (pat1))
end)))
...
in (desugar_term_maybe_top false env1 e)))
and desugar_machine_integer : FStar_ToSyntax_Env.env  ->  Prims.string  ->  (FStar_Const.signedness * FStar_Const.width)  ->  FStar_Range.range  ->  FStar_Syntax_Syntax.term = (fun env repr uu____4412 range -> (match (uu____4412) with
| (signedness, width) -> begin
(

let uu____4420 = (FStar_Const.bounds signedness width)
...
let uu____4428 = (FStar_Util.ensure_decimal repr)
in (FStar_Util.int_of_string uu____4428))
in (
...
let uu____4437 = (FStar_Util.format2 "%s is not in the expected range for %s" repr tnm)
in ((uu____4437), (range)))
in FStar_Errors.Error (uu____4432))
in (FStar_Exn.raise uu____4431))
end
| uu____4438 -> begin
()
end);
...
let uu____4445 = (FStar_ToSyntax_Env.try_lookup_lid env lid)
in (match (uu____4445) with
| FStar_Pervasives_Native.Some (intro_term, uu____4455) -> begin
...
let uu____4465 = (FStar_Syntax_Util.incr_delta_depth fv.FStar_Syntax_Syntax.fv_delta)
in (FStar_Syntax_Syntax.lid_as_fv private_lid uu____4465 fv.FStar_Syntax_Syntax.fv_qual))
in (

let uu___254_4466 = intro_term
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (private_fv); FStar_Syntax_Syntax.pos = uu___254_4466.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___254_4466.FStar_Syntax_Syntax.vars})))
end
| uu____4467 -> begin
...
let uu____4480 = (FStar_Util.format1 "Unexpected numeric literal.  Restart F* to load %s." tnm)
in ((uu____4480), (range)))
in FStar_Errors.Error (uu____4475))
in (FStar_Exn.raise uu____4474))
end))
in (
...
let uu____4531 = (FStar_Syntax_Syntax.as_implicit false)
in ((repr1), (uu____4531)))
in (uu____4524)::[])
in ((lid1), (uu____4515)))
in FStar_Syntax_Syntax.Tm_app (uu____4500))
in (FStar_Syntax_Syntax.mk uu____4499))
in (uu____4496 FStar_Pervasives_Native.None range)))))));
)))
end))
end))
...
let uu____4570 = (FStar_ToSyntax_Env.fail_or env ((match (resolve) with
| true -> begin
...
let uu____4593 = (mk_ref_read tm1)
in ((uu____4593), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Mutable_rval))))
in FStar_Syntax_Syntax.Tm_meta (uu____4586))
in (FStar_All.pipe_left mk1 uu____4585))
end
| uu____4598 -> begin
tm1
end))
...
let uu____4610 = (unparen t)
in uu____4610.FStar_Parser_AST.tm)
in (match (uu____4609) with
| FStar_Parser_AST.Var ({FStar_Ident.ns = uu____4611; FStar_Ident.ident = uu____4612; FStar_Ident.nsstr = uu____4613; FStar_Ident.str = "cps"}) -> begin
...
let uu____4624 = (FStar_Parser_AST.term_to_string t)
in (Prims.strcat "Unknown attribute " uu____4624))
in ((uu____4623), (t.FStar_Parser_AST.range)))
in FStar_Errors.Error (uu____4618))
in (FStar_Exn.raise uu____4617))
end)))
...
let uu___255_4644 = e
in {FStar_Syntax_Syntax.n = uu___255_4644.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = top.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___255_4644.FStar_Syntax_Syntax.vars}))
in (

let uu____4647 = (

let uu____4648 = (unparen top)
in uu____4648.FStar_Parser_AST.tm)
in (match (uu____4647) with
| FStar_Parser_AST.Wild -> begin
(setpos FStar_Syntax_Syntax.tun)
end
| FStar_Parser_AST.Labeled (uu____4649) -> begin
...
| FStar_Parser_AST.Op (op_star, (uu____4700)::(uu____4701)::[]) when ((Prims.op_Equality (FStar_Ident.text_of_id op_star) "*") && (

let uu____4705 = (op_as_term env (Prims.parse_int "2") top.FStar_Parser_AST.range op_star)
in (FStar_All.pipe_right uu____4705 FStar_Option.isNone))) -> begin
(

let rec flatten1 = (fun t -> (match (t.FStar_Parser_AST.tm) with
| FStar_Parser_AST.Op ({FStar_Ident.idText = "*"; FStar_Ident.idRange = uu____4718}, (t1)::(t2)::[]) -> begin
(

let uu____4723 = (flatten1 t1)
in (FStar_List.append uu____4723 ((t2)::[])))
end
| uu____4726 -> begin
(t)::[]
end))
...
let uu____4733 = (unparen top)
in (flatten1 uu____4733))
in (FStar_All.pipe_right uu____4730 (FStar_List.map (fun t -> (

let uu____4741 = (desugar_typ env t)
in (FStar_Syntax_Syntax.as_arg uu____4741))))))
in (

let uu____4742 = (

let uu____4747 = (FStar_Parser_Const.mk_tuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_lid env) uu____4747))
in (match (uu____4742) with
| (tup, uu____4753) -> begin
...
let uu____4760 = (FStar_ToSyntax_Env.fail_or2 (FStar_ToSyntax_Env.try_lookup_id env) a)
in (FStar_Pervasives_Native.fst uu____4760))
in (FStar_All.pipe_left setpos uu____4757))
end
| FStar_Parser_AST.Uvar (u) -> begin
...
let uu____4780 = (op_as_term env (FStar_List.length args) top.FStar_Parser_AST.range s)
...
let uu____4812 = (desugar_term env t)
in ((uu____4812), (FStar_Pervasives_Native.None))))))
...
| FStar_Parser_AST.Construct (n1, ((a, uu____4826))::[]) when (Prims.op_Equality n1.FStar_Ident.str "SMTPat") -> begin
(

let uu____4841 = (

let uu___256_4842 = top
in (
...
let uu___257_4852 = top
in (

let uu____4853 = (

let uu____4854 = (FStar_Ident.lid_of_path (("Prims")::("smt_pat")::[]) top.FStar_Parser_AST.range)
in FStar_Parser_AST.Var (uu____4854))
in {FStar_Parser_AST.tm = uu____4853; FStar_Parser_AST.range = uu___257_4852.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___257_4852.FStar_Parser_AST.level}))
in ((uu____4851), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4844))
in {FStar_Parser_AST.tm = uu____4843; FStar_Parser_AST.range = uu___256_4842.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___256_4842.FStar_Parser_AST.level}))
in (desugar_term_maybe_top top_level env uu____4841))
end
| FStar_Parser_AST.Construct (n1, ((a, uu____4857))::[]) when (Prims.op_Equality n1.FStar_Ident.str "SMTPatT") -> begin
((FStar_Errors.warn top.FStar_Parser_AST.range "SMTPatT is deprecated; please just use SMTPat");
(

let uu____4873 = (

let uu___258_4874 = top
in (
...
let uu___259_4884 = top
in (

let uu____4885 = (

let uu____4886 = (FStar_Ident.lid_of_path (("Prims")::("smt_pat")::[]) top.FStar_Parser_AST.range)
in FStar_Parser_AST.Var (uu____4886))
in {FStar_Parser_AST.tm = uu____4885; FStar_Parser_AST.range = uu___259_4884.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___259_4884.FStar_Parser_AST.level}))
in ((uu____4883), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4876))
in {FStar_Parser_AST.tm = uu____4875; FStar_Parser_AST.range = uu___258_4874.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___258_4874.FStar_Parser_AST.level}))
in (desugar_term_maybe_top top_level env uu____4873));
)
end
| FStar_Parser_AST.Construct (n1, ((a, uu____4889))::[]) when (Prims.op_Equality n1.FStar_Ident.str "SMTPatOr") -> begin
(

let uu____4904 = (

let uu___260_4905 = top
in (
...
let uu___261_4915 = top
in (

let uu____4916 = (

let uu____4917 = (FStar_Ident.lid_of_path (("Prims")::("smt_pat_or")::[]) top.FStar_Parser_AST.range)
in FStar_Parser_AST.Var (uu____4917))
in {FStar_Parser_AST.tm = uu____4916; FStar_Parser_AST.range = uu___261_4915.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___261_4915.FStar_Parser_AST.level}))
in ((uu____4914), (a), (FStar_Parser_AST.Nothing)))
in FStar_Parser_AST.App (uu____4907))
in {FStar_Parser_AST.tm = uu____4906; FStar_Parser_AST.range = uu___260_4905.FStar_Parser_AST.range; FStar_Parser_AST.level = uu___260_4905.FStar_Parser_AST.level}))
in (desugar_term_maybe_top top_level env uu____4904))
end
| FStar_Parser_AST.Name ({FStar_Ident.ns = uu____4918; FStar_Ident.ident = uu____4919; FStar_Ident.nsstr = uu____4920; FStar_Ident.str = "Type0"}) -> begin
(mk1 (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_zero)))
end
| FStar_Parser_AST.Name ({FStar_Ident.ns = uu____4923; FStar_Ident.ident = uu____4924; FStar_Ident.nsstr = uu____4925; FStar_Ident.str = "Type"}) -> begin
(mk1 (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_unknown)))
end
| FStar_Parser_AST.Construct ({FStar_Ident.ns = uu____4928; FStar_Ident.ident = uu____4929; FStar_Ident.nsstr = uu____4930; FStar_Ident.str = "Type"}, ((t, FStar_Parser_AST.UnivApp))::[]) -> begin
(

let uu____4948 = (

let uu____4949 = (desugar_universe t)
in FStar_Syntax_Syntax.Tm_type (uu____4949))
in (mk1 uu____4948))
end
| FStar_Parser_AST.Name ({FStar_Ident.ns = uu____4950; FStar_Ident.ident = uu____4951; FStar_Ident.nsstr = uu____4952; FStar_Ident.str = "Effect"}) -> begin
(mk1 (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_effect)))
end
| FStar_Parser_AST.Name ({FStar_Ident.ns = uu____4955; FStar_Ident.ident = uu____4956; FStar_Ident.nsstr = uu____4957; FStar_Ident.str = "True"}) -> begin
...
| FStar_Parser_AST.Name ({FStar_Ident.ns = uu____4960; FStar_Ident.ident = uu____4961; FStar_Ident.nsstr = uu____4962; FStar_Ident.str = "False"}) -> begin
...
| FStar_Parser_AST.Projector (eff_name, {FStar_Ident.idText = txt; FStar_Ident.idRange = uu____4967}) when ((is_special_effect_combinator txt) && (FStar_ToSyntax_Env.is_effect_name env eff_name)) -> begin
((FStar_ToSyntax_Env.fail_if_qualified_by_curmodule env eff_name);
(

let uu____4969 = (FStar_ToSyntax_Env.try_lookup_effect_defn env eff_name)
...
let uu____4974 = (FStar_Util.format2 "Member %s of effect %s is not accessible (using an effect abbreviation instead of the original effect ?)" (FStar_Ident.text_of_lid eff_name) txt)
in (failwith uu____4974))
end));
)
end
...
let uu____4978 = (FStar_ToSyntax_Env.fail_or2 (FStar_ToSyntax_Env.try_lookup_id env) ident)
...
let uu____5005 = (FStar_ToSyntax_Env.try_lookup_datacon env l)
in (match (uu____5005) with
| FStar_Pervasives_Native.Some (uu____5014) -> begin
FStar_Pervasives_Native.Some (((true), (l)))
end
| FStar_Pervasives_Native.None -> begin
(

let uu____5019 = (FStar_ToSyntax_Env.try_lookup_root_effect_name env l)
...
let uu____5046 = (FStar_Syntax_Util.mk_field_projector_name_from_ident new_name i)
in (desugar_name mk1 setpos env resolve uu____5046))
end
| uu____5047 -> begin
(
...
let uu____5060 = (FStar_Util.format1 "Data constructor or effect %s not found" l.FStar_Ident.str)
in ((uu____5060), (top.FStar_Parser_AST.range)))
in FStar_Errors.Error (uu____5055))
in (FStar_Exn.raise uu____5054))
end));
)
end
...
let uu____5063 = (FStar_ToSyntax_Env.try_lookup_datacon env lid)
...
let uu____5072 = (FStar_Util.format1 "Data constructor %s not found" lid.FStar_Ident.str)
in ((uu____5072), (top.FStar_Parser_AST.range)))
...
let uu____5092 = (FStar_ToSyntax_Env.try_lookup_datacon env l)
...
let uu____5103 = (mk1 (FStar_Syntax_Syntax.Tm_fvar (head1)))
in ((uu____5103), (true)))
...
let uu____5125 = (FStar_Util.take (fun uu____5149 -> (match (uu____5149) with
| (uu____5154, imp) -> begin
...
let args2 = (FStar_List.map (fun uu____5218 -> (match (uu____5218) with
| (t, imp) -> begin
(
...
let uu____5261 = (FStar_ToSyntax_Env.try_lookup_effect_name env l)
in (match (uu____5261) with
| FStar_Pervasives_Native.None -> begin
(Prims.strcat "Constructor " (Prims.strcat l.FStar_Ident.str " not found"))
end
| FStar_Pervasives_Native.Some (uu____5264) -> begin
...
let uu____5271 = (FStar_List.fold_left (fun uu____5316 b -> (match (uu____5316) with
| (env1, tparams, typs) -> begin
(

let uu____5373 = (desugar_binder env1 b)
in (match (uu____5373) with
| (xopt, t1) -> begin
(

let uu____5402 = (match (xopt) with
| FStar_Pervasives_Native.None -> begin
(

let uu____5411 = (FStar_Syntax_Syntax.new_bv (FStar_Pervasives_Native.Some (top.FStar_Parser_AST.range)) FStar_Syntax_Syntax.tun)
in ((env1), (uu____5411)))
end
...
let uu____5438 = (no_annot_abs tparams t1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg uu____5438))
in (uu____5437)::[])
in (FStar_List.append typs uu____5434))
in ((env2), ((FStar_List.append tparams (((((

let uu___262_5464 = x
in {FStar_Syntax_Syntax.ppname = uu___262_5464.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___262_5464.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})), (FStar_Pervasives_Native.None)))::[]))), (uu____5431)))
end))
end))
...
| (env1, uu____5488, targs) -> begin
(

let uu____5510 = (

let uu____5515 = (FStar_Parser_Const.mk_dtuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_ToSyntax_Env.fail_or env1 (FStar_ToSyntax_Env.try_lookup_lid env1) uu____5515))
in (match (uu____5510) with
| (tup, uu____5521) -> begin
...
let uu____5532 = (uncurry binders t)
in (match (uu____5532) with
| (bs, t1) -> begin
(

let rec aux = (fun env1 bs1 uu___229_5564 -> (match (uu___229_5564) with
| [] -> begin
(
...
let uu____5578 = (FStar_Syntax_Util.arrow (FStar_List.rev bs1) cod)
in (FStar_All.pipe_left setpos uu____5578)))
end
| (hd1)::tl1 -> begin
(
...
let uu____5600 = (as_binder env1 hd1.FStar_Parser_AST.aqual bb)
...
let uu____5615 = (desugar_binder env b)
in (match (uu____5615) with
| (FStar_Pervasives_Native.None, uu____5622) -> begin
(failwith "Missing binder in refinement")
end
| b1 -> begin
(

let uu____5632 = (as_binder env FStar_Pervasives_Native.None b1)
in (match (uu____5632) with
| ((x, uu____5638), env1) -> begin
(

let f1 = (desugar_formula env1 f)
in (

let uu____5645 = (FStar_Syntax_Util.refine x f1)
in (FStar_All.pipe_left setpos uu____5645)))
end))
end))
end
...
let uu____5665 = (FStar_List.fold_left (fun uu____5685 pat -> (match (uu____5685) with
| (env1, ftvs) -> begin
(match (pat.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatAscribed (uu____5711, t) -> begin
(

let uu____5713 = (

let uu____5716 = (free_type_vars env1 t)
in (FStar_List.append uu____5716 ftvs))
in ((env1), (uu____5713)))
end
| uu____5721 -> begin
((env1), (ftvs))
...
let uu____5738 = (FStar_All.pipe_right ftv1 (FStar_List.map (fun a -> (FStar_Parser_AST.mk_pattern (FStar_Parser_AST.PatTvar (((a), (FStar_Pervasives_Native.Some (FStar_Parser_AST.Implicit))))) top.FStar_Parser_AST.range))))
in (FStar_List.append uu____5738 binders1))
in (

let rec aux = (fun env1 bs sc_pat_opt uu___230_5779 -> (match (uu___230_5779) with
| [] -> begin
(
...
let uu____5818 = (FStar_Syntax_Syntax.pat_bvs pat)
in (FStar_All.pipe_right uu____5818 (FStar_List.map FStar_Syntax_Syntax.mk_binder)))
in (FStar_Syntax_Subst.close uu____5817 body1))
...
let uu____5871 = (no_annot_abs (FStar_List.rev bs) body2)
in (setpos uu____5871))))
end
| (p)::rest -> begin
(

let uu____5882 = (desugar_binding_pat env1 p)
...
let uu____5911 = (match (b) with
| LetBinder (uu____5944) -> begin
(failwith "Impossible")
end
| LocalBinder (x, aq) -> begin
(
...
| (FStar_Pervasives_Native.None, uu____5994) -> begin
sc_pat_opt
end
...
let uu____6035 = (FStar_Syntax_Syntax.bv_to_name x)
in ((uu____6035), (p1)))
in FStar_Pervasives_Native.Some (uu____6030))
end
| (FStar_Pervasives_Native.Some (p1), FStar_Pervasives_Native.Some (sc, p')) -> begin
(match (((sc.FStar_Syntax_Syntax.n), (p'.FStar_Syntax_Syntax.v))) with
| (FStar_Syntax_Syntax.Tm_name (uu____6071), uu____6072) -> begin
(

let tup2 = (

let uu____6074 = (FStar_Parser_Const.mk_tuple_data_lid (Prims.parse_int "2") top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.lid_as_fv uu____6074 FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor))))
in (
...
let uu____6097 = (mk1 (FStar_Syntax_Syntax.Tm_fvar (tup2)))
in (

let uu____6100 = (

let uu____6103 = (FStar_Syntax_Syntax.as_arg sc)
in (
...
let uu____6108 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg uu____6108))
in (uu____6107)::[])
in (uu____6103)::uu____6104))
in ((uu____6097), (uu____6100))))
in FStar_Syntax_Syntax.Tm_app (uu____6082))
in (FStar_Syntax_Syntax.mk uu____6081))
in (uu____6078 FStar_Pervasives_Native.None top.FStar_Parser_AST.range))
in (

let p2 = (

let uu____6119 = (FStar_Range.union_ranges p'.FStar_Syntax_Syntax.p p1.FStar_Syntax_Syntax.p)
in (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_cons (((tup2), ((((p'), (false)))::(((p1), (false)))::[])))) uu____6119))
in FStar_Pervasives_Native.Some (((sc1), (p2))))))
end
| (FStar_Syntax_Syntax.Tm_app (uu____6150, args), FStar_Syntax_Syntax.Pat_cons (uu____6152, pats)) -> begin
(

let tupn = (

let uu____6191 = (FStar_Parser_Const.mk_tuple_data_lid ((Prims.parse_int "1") + (FStar_List.length args)) top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.lid_as_fv uu____6191 FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor))))
in (
...
let uu____6217 = (mk1 (FStar_Syntax_Syntax.Tm_fvar (tupn)))
in (
...
let uu____6239 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg uu____6239))
in (uu____6238)::[])
in (FStar_List.append args uu____6229))
in ((uu____6217), (uu____6220))))
in FStar_Syntax_Syntax.Tm_app (uu____6202))
in (mk1 uu____6201))
in (

let p2 = (

let uu____6259 = (FStar_Range.union_ranges p'.FStar_Syntax_Syntax.p p1.FStar_Syntax_Syntax.p)
in (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_cons (((tupn), ((FStar_List.append pats ((((p1), (false)))::[])))))) uu____6259))
in FStar_Pervasives_Native.Some (((sc1), (p2))))))
end
| uu____6294 -> begin
(failwith "Impossible")
...
| FStar_Parser_AST.App (uu____6361, uu____6362, FStar_Parser_AST.UnivApp) -> begin
(
...
let uu____6377 = (unparen e)
in uu____6377.FStar_Parser_AST.tm)
...
| FStar_Parser_AST.App (uu____6387) -> begin
(
...
let uu____6420 = (unparen e)
in uu____6420.FStar_Parser_AST.tm)
...
let uu____6433 = (desugar_term env t)
in (FStar_All.pipe_left (arg_withimp_e imp) uu____6433))
in (aux ((arg)::args) e1))
end
| uu____6446 -> begin
(
...
let uu____6473 = (FStar_Ident.lid_of_path (("bind")::[]) x.FStar_Ident.idRange)
in FStar_Parser_AST.Var (uu____6473))
in (FStar_Parser_AST.mk_term uu____6472 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
in (

let uu____6474 = (FStar_Parser_AST.mkExplicitApp bind1 ((t1)::(k)::[]) top.FStar_Parser_AST.range)
in (desugar_term env uu____6474)))))
end
...
let uu____6485 = (desugar_term env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((FStar_Parser_AST.NoLetQualifier), (((((FStar_Parser_AST.mk_pattern FStar_Parser_AST.PatWild t1.FStar_Parser_AST.range)), (t1)))::[]), (t2)))) top.FStar_Parser_AST.range FStar_Parser_AST.Expr))
in ((uu____6485), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Sequence))))
in FStar_Syntax_Syntax.Tm_meta (uu____6478))
in (mk1 uu____6477))
end
...
let uu____6508 = (FStar_ToSyntax_Env.expect_typ env1)
...
let ds_let_rec_or_app = (fun uu____6541 -> (

let bindings = (((pat), (_snd)))::_tl
in (

let funs = (FStar_All.pipe_right bindings (FStar_List.map (fun uu____6627 -> (match (uu____6627) with
| (p, def) -> begin
(

let uu____6652 = (is_app_pattern p)
in (match (uu____6652) with
| true -> begin
(

let uu____6671 = (destruct_app_pattern env top_level p)
in ((uu____6671), (def)))
end
| uu____6700 -> begin
...
let uu____6725 = (destruct_app_pattern env top_level p1)
in ((uu____6725), (def1)))
end
| uu____6754 -> begin
(match (p.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatAscribed ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (id, uu____6780); FStar_Parser_AST.prange = uu____6781}, t) -> begin
...
let uu____6825 = (FStar_ToSyntax_Env.qualify env id)
in FStar_Util.Inr (uu____6825))
in ((uu____6820), ([]), (FStar_Pervasives_Native.Some (t))))
in ((uu____6805), (def)))
end
| uu____6848 -> begin
...
| FStar_Parser_AST.PatVar (id, uu____6872) -> begin
(match (top_level) with
| true -> begin
(
...
let uu____6915 = (FStar_ToSyntax_Env.qualify env id)
in FStar_Util.Inr (uu____6915))
in ((uu____6910), ([]), (FStar_Pervasives_Native.None)))
in ((uu____6895), (def)))
end
| uu____6938 -> begin
...
let uu____6980 = (FStar_List.fold_left (fun uu____7040 uu____7041 -> (match (((uu____7040), (uu____7041))) with
| ((env1, fnames, rec_bindings), ((f, uu____7124, uu____7125), uu____7126)) -> begin
(

let uu____7205 = (match (f) with
| FStar_Util.Inl (x) -> begin
(

let uu____7231 = (FStar_ToSyntax_Env.push_bv env1 x)
...
let uu____7253 = (FStar_Syntax_Syntax.mk_binder xx)
in (uu____7253)::rec_bindings)
in ((env2), (FStar_Util.Inl (xx)), (uu____7250)))
end))
end
| FStar_Util.Inr (l) -> begin
(

let uu____7261 = (FStar_ToSyntax_Env.push_top_level_rec_binding env1 l.FStar_Ident.ident FStar_Syntax_Syntax.Delta_equational)
in ((uu____7261), (FStar_Util.Inr (l)), (rec_bindings)))
end)
...
let desugar_one_def = (fun env1 lbname uu____7387 -> (match (uu____7387) with
| ((uu____7410, args, result_t), def) -> begin
(
...
let uu____7454 = (is_comp_type env1 t)
in (match (uu____7454) with
| true -> begin
((

let uu____7456 = (FStar_All.pipe_right args1 (FStar_List.tryFind (fun x -> (

let uu____7466 = (is_var_pattern x)
in (not (uu____7466))))))
...
let uu____7469 = (((FStar_Options.ml_ish ()) && (

let uu____7471 = (FStar_ToSyntax_Env.try_lookup_effect_name env1 FStar_Parser_Const.effect_ML_lid)
in (FStar_Option.isSome uu____7471))) && ((not (is_rec)) || (Prims.op_disEquality (FStar_List.length args1) (Prims.parse_int "0"))))
...
let uu____7475 = (FStar_Range.union_ranges t1.FStar_Parser_AST.range def.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term (FStar_Parser_AST.Ascribed (((def), (t1), (FStar_Pervasives_Native.None)))) uu____7475 FStar_Parser_AST.Expr)))
end)
in (
...
let uu____7495 = (FStar_Syntax_Util.incr_delta_qualifier body1)
in (FStar_Syntax_Syntax.lid_as_fv l uu____7495 FStar_Pervasives_Native.None))
in FStar_Util.Inr (uu____7494))
end)
in (
...
let uu____7543 = (FStar_Syntax_Subst.close rec_bindings1 body1)
in ((((is_rec), (lbs))), (uu____7543)))
in FStar_Syntax_Syntax.Tm_let (uu____7530))
in (FStar_All.pipe_left mk1 uu____7529)))))))
end)))))
in (
...
let uu____7574 = (desugar_binding_pat_maybe_top top_level env pat1 is_mutable)
...
let uu____7601 = (FStar_Syntax_Util.incr_delta_qualifier t12)
in (FStar_Syntax_Syntax.lid_as_fv l uu____7601 FStar_Pervasives_Native.None))
...
| LocalBinder (x, uu____7613) -> begin
(
...
| ({FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (uu____7616); FStar_Syntax_Syntax.p = uu____7617})::[] -> begin
body1
end
| uu____7622 -> begin
(
...
let uu____7652 = (FStar_Syntax_Syntax.bv_to_name x)
in (

let uu____7653 = (desugar_disjunctive_pattern pat2 FStar_Pervasives_Native.None body1)
in ((uu____7652), (uu____7653))))
in FStar_Syntax_Syntax.Tm_match (uu____7629))
in (FStar_Syntax_Syntax.mk uu____7628))
in (uu____7625 FStar_Pervasives_Native.None top.FStar_Parser_AST.range))
end)
in (
...
let uu____7679 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____7679)::[])
in (FStar_Syntax_Subst.close uu____7678 body2))
in ((((false), (((mk_lb ((FStar_Util.Inl (x)), (x.FStar_Syntax_Syntax.sort), (t12))))::[]))), (uu____7677)))
in FStar_Syntax_Syntax.Tm_let (uu____7664))
in (FStar_All.pipe_left mk1 uu____7663))))
end)
...
let uu____7705 = (is_rec || (is_app_pattern pat))
...
let uu____7715 = (FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.bool_lid FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None)
in FStar_Syntax_Syntax.Tm_fvar (uu____7715))
in (mk1 uu____7714))
in (
...
let uu____7743 = (desugar_term env t1)
in (FStar_Syntax_Util.ascribe uu____7743 ((FStar_Util.Inl (t_bool1)), (FStar_Pervasives_Native.None))))
in (
...
let uu____7792 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) t2.FStar_Parser_AST.range)
in (

let uu____7795 = (desugar_term env t2)
in ((uu____7792), (FStar_Pervasives_Native.None), (uu____7795))))
in (
...
let uu____7832 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_wild (x)) t3.FStar_Parser_AST.range)
in (

let uu____7835 = (desugar_term env t3)
in ((uu____7832), (FStar_Pervasives_Native.None), (uu____7835))))
in (uu____7819)::[])
in (uu____7779)::uu____7804))
in ((uu____7740), (uu____7764))))
...
let desugar_branch = (fun uu____7976 -> (match (uu____7976) with
| (pat, wopt, b) -> begin
(

let uu____7994 = (desugar_match_pat env pat)
...
let uu____8015 = (desugar_term env1 e1)
in FStar_Pervasives_Native.Some (uu____8015))
end)
in (
...
let uu____8041 = (desugar_term env e)
in (

let uu____8042 = (FStar_List.collect desugar_branch branches)
in ((uu____8041), (uu____8042))))
in FStar_Syntax_Syntax.Tm_match (uu____8018))
in (FStar_All.pipe_left mk1 uu____8017)))
end
...
let uu____8071 = (is_comp_type env t)
in (match (uu____8071) with
| true -> begin
(

let uu____8078 = (desugar_comp t.FStar_Parser_AST.range env t)
in FStar_Util.Inr (uu____8078))
end
| uu____8083 -> begin
(

let uu____8084 = (desugar_term env t)
in FStar_Util.Inl (uu____8084))
end))
in (
...
let uu____8118 = (desugar_term env e)
in ((uu____8118), (((annot), (tac_opt1))), (FStar_Pervasives_Native.None)))
in FStar_Syntax_Syntax.Tm_ascribed (uu____8091))
in (FStar_All.pipe_left mk1 uu____8090))))
end
| FStar_Parser_AST.Record (uu____8143, []) -> begin
...
let uu____8180 = (FStar_List.hd fields)
...
let found = (FStar_All.pipe_right fields (FStar_Util.find_opt (fun uu____8234 -> (match (uu____8234) with
| (g, uu____8240) -> begin
...
in (match (found) with
| FStar_Pervasives_Native.Some (uu____8246, e) -> begin
((fn), (e))
end
| FStar_Pervasives_Native.None -> begin
(match (xopt) with
...
let uu____8266 = (FStar_Util.format2 "Field %s of record type %s is missing" f.FStar_Ident.idText record.FStar_ToSyntax_Env.typename.FStar_Ident.str)
in ((uu____8266), (top.FStar_Parser_AST.range)))
in FStar_Errors.Error (uu____8261))
in (FStar_Exn.raise uu____8260))
end
| FStar_Pervasives_Native.Some (x) -> begin
...
let uu____8285 = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map (fun uu____8316 -> (match (uu____8316) with
| (f, uu____8326) -> begin
(

let uu____8327 = (

let uu____8328 = (get_field FStar_Pervasives_Native.None f)
in (FStar_All.pipe_left FStar_Pervasives_Native.snd uu____8328))
in ((uu____8327), (FStar_Parser_AST.Nothing)))
end))))
in ((user_constrname), (uu____8285)))
in FStar_Parser_AST.Construct (uu____8274))
end
...
let uu____8347 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (uu____8347))
in (FStar_Parser_AST.mk_term uu____8346 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
in (
...
let uu____8362 = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map (fun uu____8392 -> (match (uu____8392) with
| (f, uu____8402) -> begin
(get_field (FStar_Pervasives_Native.Some (xterm)) f)
end))))
in ((FStar_Pervasives_Native.None), (uu____8362)))
in FStar_Parser_AST.Record (uu____8349))
...
| FStar_Syntax_Syntax.Tm_meta ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____8430; FStar_Syntax_Syntax.vars = uu____8431}, args); FStar_Syntax_Syntax.pos = uu____8433; FStar_Syntax_Syntax.vars = uu____8434}, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Data_app)) -> begin
(
...
let uu____8490 = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map FStar_Pervasives_Native.fst))
in ((record.FStar_ToSyntax_Env.typename), (uu____8490)))
in FStar_Syntax_Syntax.Record_ctor (uu____8483))
in FStar_Pervasives_Native.Some (uu____8482))
in (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v e.FStar_Syntax_Syntax.pos) FStar_Syntax_Syntax.Delta_constant uu____8479))
in ((uu____8478), (args)))
in FStar_Syntax_Syntax.Tm_app (uu____8463))
in (FStar_All.pipe_left mk1 uu____8462))
...
let uu____8525 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_dc_by_field_name env) f)
...
let uu____8560 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range projname (FStar_Ident.range_of_lid f)) FStar_Syntax_Syntax.Delta_equational qual1)
in (

let uu____8561 = (

let uu____8564 = (FStar_Syntax_Syntax.as_arg e1)
in (uu____8564)::[])
in ((uu____8560), (uu____8561))))
in FStar_Syntax_Syntax.Tm_app (uu____8545))
in (FStar_All.pipe_left mk1 uu____8544)))))
end));
)
end
| FStar_Parser_AST.NamedTyp (uu____8569, e) -> begin
(desugar_term env e)
end
| FStar_Parser_AST.Paren (e) -> begin
(desugar_term env e)
end
| uu____8572 when (Prims.op_Equality top.FStar_Parser_AST.level FStar_Parser_AST.Formula) -> begin
(desugar_formula env top)
end
| uu____8573 -> begin
(FStar_Parser_AST.error "Unexpected term" top top.FStar_Parser_AST.range)
end
| FStar_Parser_AST.Let (uu____8574, uu____8575, uu____8576) -> begin
(failwith "Not implemented yet")
end
| FStar_Parser_AST.QForall (uu____8589, uu____8590, uu____8591) -> begin
(failwith "Not implemented yet")
end
| FStar_Parser_AST.QExists (uu____8604, uu____8605, uu____8606) -> begin
(failwith "Not implemented yet")
end)))))
and not_ascribed : FStar_Parser_AST.term  ->  Prims.bool = (fun t -> (match (t.FStar_Parser_AST.tm) with
| FStar_Parser_AST.Ascribed (uu____8620) -> begin
false
end
| uu____8629 -> begin
true
...
let uu____8635 = (FStar_ToSyntax_Env.resolve_to_fully_qualified_name e lid)
...
and desugar_args : FStar_ToSyntax_Env.env  ->  (FStar_Parser_AST.term * FStar_Parser_AST.imp) Prims.list  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier FStar_Pervasives_Native.option) Prims.list = (fun env args -> (FStar_All.pipe_right args (FStar_List.map (fun uu____8676 -> (match (uu____8676) with
| (a, imp) -> begin
(

let uu____8689 = (desugar_term env a)
in (arg_withimp_e imp uu____8689))
end)))))
...
let is_requires = (fun uu____8708 -> (match (uu____8708) with
| (t1, uu____8714) -> begin
(

let uu____8715 = (

let uu____8716 = (unparen t1)
in uu____8716.FStar_Parser_AST.tm)
in (match (uu____8715) with
| FStar_Parser_AST.Requires (uu____8717) -> begin
true
end
| uu____8724 -> begin
false
...
let is_ensures = (fun uu____8732 -> (match (uu____8732) with
| (t1, uu____8738) -> begin
(

let uu____8739 = (

let uu____8740 = (unparen t1)
in uu____8740.FStar_Parser_AST.tm)
in (match (uu____8739) with
| FStar_Parser_AST.Ensures (uu____8741) -> begin
true
end
| uu____8748 -> begin
false
...
let is_app = (fun head1 uu____8759 -> (match (uu____8759) with
| (t1, uu____8765) -> begin
(

let uu____8766 = (

let uu____8767 = (unparen t1)
in uu____8767.FStar_Parser_AST.tm)
in (match (uu____8766) with
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (d); FStar_Parser_AST.range = uu____8769; FStar_Parser_AST.level = uu____8770}, uu____8771, uu____8772) -> begin
...
let is_smt_pat = (fun uu____8781 -> (match (uu____8781) with
| (t1, uu____8787) -> begin
(

let uu____8788 = (

let uu____8789 = (unparen t1)
in uu____8789.FStar_Parser_AST.tm)
in (match (uu____8788) with
| FStar_Parser_AST.Construct (cons1, (({FStar_Parser_AST.tm = FStar_Parser_AST.Construct (smtpat, uu____8792); FStar_Parser_AST.range = uu____8793; FStar_Parser_AST.level = uu____8794}, uu____8795))::(uu____8796)::[]) -> begin
...
| FStar_Parser_AST.Construct (cons1, (({FStar_Parser_AST.tm = FStar_Parser_AST.Var (smtpat); FStar_Parser_AST.range = uu____8835; FStar_Parser_AST.level = uu____8836}, uu____8837))::(uu____8838)::[]) -> begin
...
let uu____8891 = (head_and_args t1)
...
let thunk_ens = (fun uu____8985 -> (match (uu____8985) with
| (e, i) -> begin
(

let uu____8996 = (thunk_ens_ e)
in ((uu____8996), (i)))
end))
in (

let fail_lemma = (fun uu____9006 -> (
...
let uu____9100 = (thunk_ens ens)
in (uu____9100)::(nil_pat)::[])
in (req_true)::uu____9093)
in (unit_tm)::uu____9086)
end
...
let uu____9161 = (thunk_ens ens)
in (uu____9161)::(nil_pat)::[])
in (req)::uu____9154)
in (unit_tm)::uu____9147)
end
| (ens)::(smtpat)::[] when ((((

let uu____9210 = (is_requires ens)
in (not (uu____9210))) && (

let uu____9212 = (is_smt_pat ens)
in (not (uu____9212)))) && (

let uu____9214 = (is_decreases ens)
in (not (uu____9214)))) && (is_smt_pat smtpat)) -> begin
(
...
let uu____9229 = (thunk_ens ens)
in (uu____9229)::(smtpat)::[])
in (req_true)::uu____9222)
in (unit_tm)::uu____9215)
end
...
let uu____9290 = (thunk_ens ens)
in (uu____9290)::(nil_pat)::(dec)::[])
in (req_true)::uu____9283)
in (unit_tm)::uu____9276)
end
...
let uu____9364 = (thunk_ens ens)
in (uu____9364)::(smtpat)::(dec)::[])
in (req_true)::uu____9357)
in (unit_tm)::uu____9350)
end
...
let uu____9438 = (thunk_ens ens)
in (uu____9438)::(nil_pat)::(dec)::[])
in (req)::uu____9431)
in (unit_tm)::uu____9424)
end
...
let uu____9512 = (thunk_ens ens)
in (uu____9512)::(smtpat)::[])
in (req)::uu____9505)
in (unit_tm)::uu____9498)
end
...
let uu____9591 = (thunk_ens ens)
in (uu____9591)::(dec)::(smtpat)::[])
in (req)::uu____9584)
in (unit_tm)::uu____9577)
end
| _other -> begin
(fail_lemma ())
end)
...
let uu____9653 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_effect_name_and_attributes env) l)
in ((uu____9653), (args)))
end
| FStar_Parser_AST.Name (l) when ((

let uu____9681 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.lid_equals uu____9681 FStar_Parser_Const.prims_lid)) && (Prims.op_Equality l.FStar_Ident.ident.FStar_Ident.idText "Tot")) -> begin
(((((FStar_Ident.set_lid_range FStar_Parser_Const.effect_Tot_lid head1.FStar_Parser_AST.range)), ([]))), (args))
end
| FStar_Parser_AST.Name (l) when ((

let uu____9699 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.lid_equals uu____9699 FStar_Parser_Const.prims_lid)) && (Prims.op_Equality l.FStar_Ident.ident.FStar_Ident.idText "GTot")) -> begin
...
let uu____9739 = (FStar_Options.ml_ish ())
...
let uu____9742 = (FStar_Options.warn_default_effects ())
...
let uu____9766 = (pre_process_comp_typ t)
...
let uu____9816 = (FStar_Syntax_Print.lid_to_string eff)
in (FStar_Util.format1 "Not enough args to effect %s" uu____9816))
in (fail uu____9815))
end
| uu____9817 -> begin
()
...
let is_universe = (fun uu____9825 -> (match (uu____9825) with
| (uu____9830, imp) -> begin
(Prims.op_Equality imp FStar_Parser_AST.UnivApp)
end))
in (

let uu____9832 = (FStar_Util.take is_universe args)
in (match (uu____9832) with
| (universes, args1) -> begin
(

let universes1 = (FStar_List.map (fun uu____9891 -> (match (uu____9891) with
| (u, imp) -> begin
(desugar_universe u)
end)) universes)
in (
...
let uu____9913 = (FStar_List.hd args1)
in (

let uu____9922 = (FStar_List.tl args1)
in ((uu____9913), (uu____9922))))
...
let is_decrease = (fun uu____10013 -> (match (uu____10013) with
| (t1, uu____10023) -> begin
(match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____10033; FStar_Syntax_Syntax.vars = uu____10034}, (uu____10035)::[]) -> begin
...
let decreases_clause = (FStar_All.pipe_right dec (FStar_List.map (fun uu____10180 -> (match (uu____10180) with
| (t1, uu____10190) -> begin
(match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_app (uu____10199, ((arg, uu____10201))::[]) -> begin
...
let uu____10424 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((pat1), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Meta_smt_pat))))) FStar_Pervasives_Native.None pat1.FStar_Syntax_Syntax.pos)
in ((uu____10424), (aq)))
in (uu____10415)::[])
in (ens)::uu____10404)
in (req)::uu____10393))
...
let uu___263_10504 = t
in {FStar_Syntax_Syntax.n = uu___263_10504.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.pos = f.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___263_10504.FStar_Syntax_Syntax.vars}))
in (
...
let uu___264_10538 = b
in {FStar_Parser_AST.b = uu___264_10538.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___264_10538.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___264_10538.FStar_Parser_AST.aqual}))
in (

let desugar_pats = (fun env1 pats1 -> (FStar_List.map (fun es -> (FStar_All.pipe_right es (FStar_List.map (fun e -> (

let uu____10597 = (desugar_term env1 e)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) uu____10597)))))) pats1))
in (match (tk) with
| (FStar_Pervasives_Native.Some (a), k) -> begin
(

let uu____10610 = (FStar_ToSyntax_Env.push_bv env a)
...
let uu___265_10620 = a1
in {FStar_Syntax_Syntax.ppname = uu___265_10620.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___265_10620.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
in (
...
let uu____10660 = (FStar_Syntax_Syntax.mk_binder a2)
in (uu____10660)::[])
in (no_annot_abs uu____10659 body2))
in (FStar_All.pipe_left setpos uu____10656))
in (
...
let uu____10681 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range q b.FStar_Parser_AST.brange) (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) FStar_Pervasives_Native.None)
in (

let uu____10682 = (

let uu____10685 = (FStar_Syntax_Syntax.as_arg body3)
in (uu____10685)::[])
in ((uu____10681), (uu____10682))))
in FStar_Syntax_Syntax.Tm_app (uu____10666))
in (FStar_All.pipe_left mk1 uu____10665)))))))
end))
end
| uu____10690 -> begin
(failwith "impossible")
...
let uu____10762 = (q ((rest), (pats), (body)))
in (

let uu____10769 = (FStar_Range.union_ranges b'.FStar_Parser_AST.brange body.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term uu____10762 uu____10769 FStar_Parser_AST.Formula)))
in (

let uu____10770 = (q (((b)::[]), ([]), (body1)))
in (FStar_Parser_AST.mk_term uu____10770 f.FStar_Parser_AST.range FStar_Parser_AST.Formula))))
end
| uu____10779 -> begin
(failwith "impossible")
end))
...
let uu____10783 = (unparen f)
in uu____10783.FStar_Parser_AST.tm)
...
| FStar_Parser_AST.QForall ([], uu____10790, uu____10791) -> begin
(failwith "Impossible: Quantifier without binders")
end
| FStar_Parser_AST.QExists ([], uu____10802, uu____10803) -> begin
(failwith "Impossible: Quantifier without binders")
end
...
let uu____10834 = (push_quant (fun x -> FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env uu____10834)))
end
...
let uu____10870 = (push_quant (fun x -> FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env uu____10870)))
end
...
let uu____10918 = (FStar_List.fold_left (fun uu____10954 b -> (match (uu____10954) with
| (env1, out) -> begin
(

let tk = (desugar_binder env1 (

let uu___266_11006 = b
in {FStar_Parser_AST.b = uu___266_11006.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___266_11006.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___266_11006.FStar_Parser_AST.aqual}))
in (match (tk) with
| (FStar_Pervasives_Native.Some (a), k) -> begin
(

let uu____11023 = (FStar_ToSyntax_Env.push_bv env1 a)
...
let uu___267_11043 = a1
in {FStar_Syntax_Syntax.ppname = uu___267_11043.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___267_11043.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
...
let uu____11147 = (desugar_typ env t)
in ((FStar_Pervasives_Native.Some (x)), (uu____11147)))
end
| FStar_Parser_AST.Annotated (x, t) -> begin
(

let uu____11152 = (desugar_typ env t)
in ((FStar_Pervasives_Native.Some (x)), (uu____11152)))
end
| FStar_Parser_AST.TVariable (x) -> begin
(

let uu____11156 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_unknown)) FStar_Pervasives_Native.None x.FStar_Ident.idRange)
in ((FStar_Pervasives_Native.Some (x)), (uu____11156)))
end
| FStar_Parser_AST.NoName (t) -> begin
(

let uu____11164 = (desugar_typ env t)
in ((FStar_Pervasives_Native.None), (uu____11164)))
end
...
let quals1 = (FStar_All.pipe_right quals (FStar_List.filter (fun uu___231_11200 -> (match (uu___231_11200) with
...
let uu____11215 = (FStar_ToSyntax_Env.iface env)
in (not (uu____11215))) || (FStar_ToSyntax_Env.admitted_iface env))
in (match (uu____11212) with
| true -> begin
...
let uu____11228 = (quals2 ((FStar_Syntax_Syntax.OnlyName)::(FStar_Syntax_Syntax.Discriminator (d))::[]))
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((disc_name), ([]), (FStar_Syntax_Syntax.tun))); FStar_Syntax_Syntax.sigrng = (FStar_Ident.range_of_lid disc_name); FStar_Syntax_Syntax.sigquals = uu____11228; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []}))))))))
...
let uu____11264 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i uu____11294 -> (match (uu____11294) with
| (x, uu____11302) -> begin
(

let uu____11303 = (FStar_Syntax_Util.mk_field_projector_name lid x i)
in (match (uu____11303) with
| (field_name, uu____11311) -> begin
(

let only_decl = (((

let uu____11315 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Parser_Const.prims_lid uu____11315)) || (Prims.op_disEquality fvq FStar_Syntax_Syntax.Data_ctor)) || (

let uu____11317 = (

let uu____11318 = (FStar_ToSyntax_Env.current_module env)
in uu____11318.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors uu____11317)))
in (
...
let uu____11332 = (FStar_List.filter (fun uu___232_11336 -> (match (uu___232_11336) with
| FStar_Syntax_Syntax.Abstract -> begin
false
end
| uu____11337 -> begin
...
in (FStar_Syntax_Syntax.Assumption)::uu____11332)
end
| uu____11338 -> begin
q
end))
...
let iquals1 = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___233_11350 -> (match (uu___233_11350) with
| FStar_Syntax_Syntax.Abstract -> begin
true
end
| FStar_Syntax_Syntax.Private -> begin
...
let uu____11359 = (FStar_All.pipe_right quals1 (FStar_List.contains FStar_Syntax_Syntax.Abstract))
...
let uu____11369 = (FStar_Syntax_Syntax.lid_as_fv field_name dd FStar_Pervasives_Native.None)
in FStar_Util.Inr (uu____11369))
in {FStar_Syntax_Syntax.lbname = uu____11364; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = FStar_Syntax_Syntax.tun; FStar_Syntax_Syntax.lbeff = FStar_Parser_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = FStar_Syntax_Syntax.tun})
in (
...
let uu____11383 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right uu____11383 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (uu____11382)::[])
in ((((false), ((lb)::[]))), (uu____11379)))
in FStar_Syntax_Syntax.Sig_let (uu____11372))
in {FStar_Syntax_Syntax.sigel = uu____11371; FStar_Syntax_Syntax.sigrng = p; FStar_Syntax_Syntax.sigquals = quals1; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []})
...
in (FStar_All.pipe_right uu____11264 FStar_List.flatten))))
...
| FStar_Syntax_Syntax.Sig_datacon (lid, uu____11430, t, uu____11432, n1, uu____11434) when (not ((FStar_Ident.lid_equals lid FStar_Parser_Const.lexcons_lid))) -> begin
(

let uu____11439 = (FStar_Syntax_Util.arrow_formals t)
in (match (uu____11439) with
| (formals, uu____11455) -> begin
(match (formals) with
| [] -> begin
[]
end
...
let filter_records = (fun uu___234_11490 -> (match (uu___234_11490) with
| FStar_Syntax_Syntax.RecordConstructor (uu____11493, fns) -> begin
...
let uu____11507 = (FStar_Util.find_map se.FStar_Syntax_Syntax.sigquals filter_records)
...
let uu____11517 = (FStar_Util.first_N n1 formals)
in (match (uu____11517) with
| (uu____11540, rest) -> begin
...
let uu____11624 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract))
in (match (uu____11624) with
| true -> begin
(

let uu____11627 = (FStar_Syntax_Util.incr_delta_qualifier t)
in FStar_Syntax_Syntax.Delta_abstract (uu____11627))
end
| uu____11628 -> begin
...
let uu____11635 = (FStar_Syntax_Syntax.lid_as_fv lid dd FStar_Pervasives_Native.None)
in FStar_Util.Inr (uu____11635))
in (

let uu____11636 = (

let uu____11639 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_Syntax_Util.arrow typars uu____11639))
in (

let uu____11642 = (no_annot_abs typars t)
in {FStar_Syntax_Syntax.lbname = uu____11630; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = uu____11636; FStar_Syntax_Syntax.lbeff = FStar_Parser_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = uu____11642})))
...
let tycon_id = (fun uu___235_11691 -> (match (uu___235_11691) with
| FStar_Parser_AST.TyconAbstract (id, uu____11693, uu____11694) -> begin
id
end
| FStar_Parser_AST.TyconAbbrev (id, uu____11704, uu____11705, uu____11706) -> begin
id
end
| FStar_Parser_AST.TyconRecord (id, uu____11716, uu____11717, uu____11718) -> begin
id
end
| FStar_Parser_AST.TyconVariant (id, uu____11748, uu____11749, uu____11750) -> begin
id
end))
in (

let binder_to_term = (fun b -> (match (b.FStar_Parser_AST.b) with
| FStar_Parser_AST.Annotated (x, uu____11792) -> begin
(

let uu____11793 = (

let uu____11794 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (uu____11794))
in (FStar_Parser_AST.mk_term uu____11793 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
| FStar_Parser_AST.Variable (x) -> begin
(
...
let uu____11797 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (uu____11797))
in (FStar_Parser_AST.mk_term uu____11796 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
| FStar_Parser_AST.TAnnotated (a, uu____11799) -> begin
...
let uu____11836 = (binder_to_term b)
in ((out), (uu____11836), ((imp_of_aqual b))))
in FStar_Parser_AST.App (uu____11829))
in (FStar_Parser_AST.mk_term uu____11828 out.FStar_Parser_AST.range out.FStar_Parser_AST.level))) t binders)))
in (

let tycon_record_as_variant = (fun uu___236_11846 -> (match (uu___236_11846) with
...
let mfields = (FStar_List.map (fun uu____11901 -> (match (uu____11901) with
| (x, t, uu____11912) -> begin
...
let uu____11920 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (uu____11920))
in (FStar_Parser_AST.mk_term uu____11919 id.FStar_Ident.idRange FStar_Parser_AST.Type_level))
in (apply_binders uu____11918 parms))
in (
...
let uu____11924 = (FStar_All.pipe_right fields (FStar_List.map (fun uu____11951 -> (match (uu____11951) with
| (x, uu____11961, uu____11962) -> begin
(FStar_Syntax_Util.unmangle_field_name x)
end))))
in ((FStar_Parser_AST.TyconVariant (((id), (parms), (kopt), ((((constrName), (FStar_Pervasives_Native.Some (constrTyp)), (FStar_Pervasives_Native.None), (false)))::[])))), (uu____11924)))))))
end
| uu____12015 -> begin
(failwith "impossible")
end))
...
let desugar_abstract_tc = (fun quals1 _env mutuals uu___237_12046 -> (match (uu___237_12046) with
| FStar_Parser_AST.TyconAbstract (id, binders, kopt) -> begin
(

let uu____12070 = (typars_of_binders _env binders)
...
let uu____12118 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (uu____12118))
in (FStar_Parser_AST.mk_term uu____12117 id.FStar_Ident.idRange FStar_Parser_AST.Type_level))
in (apply_binders uu____12116 binders))
in (
...
let uu____12175 = (FStar_List.fold_left (fun uu____12215 uu____12216 -> (match (((uu____12215), (uu____12216))) with
| ((env2, tps), (x, imp)) -> begin
(

let uu____12307 = (FStar_ToSyntax_Env.push_bv env2 x.FStar_Syntax_Syntax.ppname)
...
let uu____12420 = (tm_type_z id.FStar_Ident.idRange)
in FStar_Pervasives_Native.Some (uu____12420))
end
| uu____12421 -> begin
kopt
end)
...
let uu____12429 = (desugar_abstract_tc quals env [] tc)
in (match (uu____12429) with
| (uu____12442, uu____12443, se, uu____12445) -> begin
(

let se1 = (match (se.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, uu____12448, typars, k, [], []) -> begin
(
...
let uu____12466 = (FStar_Options.ml_ish ())
in (not (uu____12466)))
...
let uu____12468 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format1 "Adding an implicit \'assume new\' qualifier on %s" uu____12468))
in (FStar_Errors.warn se.FStar_Syntax_Syntax.sigrng uu____12467))
end
| uu____12469 -> begin
()
end));
...
let uu____12493 = (FStar_Syntax_Syntax.mk_Total k)
in ((typars), (uu____12493)))
in FStar_Syntax_Syntax.Tm_arrow (uu____12480))
in (FStar_Syntax_Syntax.mk uu____12479))
in (uu____12476 FStar_Pervasives_Native.None se.FStar_Syntax_Syntax.sigrng))
end)
in (

let uu___268_12497 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), ([]), (t))); FStar_Syntax_Syntax.sigrng = uu___268_12497.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals2; FStar_Syntax_Syntax.sigmeta = uu___268_12497.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___268_12497.FStar_Syntax_Syntax.sigattrs}))))
end
| uu____12500 -> begin
(failwith "Impossible")
end)
...
let uu____12503 = (FStar_ToSyntax_Env.qualify env1 id)
in (FStar_ToSyntax_Env.push_doc env1 uu____12503 d.FStar_Parser_AST.doc))
in ((env2), ((se1)::[])))))
end))))
end
...
let uu____12518 = (typars_of_binders env binders)
...
let uu____12554 = (FStar_Util.for_some (fun uu___238_12556 -> (match (uu___238_12556) with
...
let uu____12564 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___239_12568 -> (match (uu___239_12568) with
...
let uu____12578 = (FStar_All.pipe_right quals1 (FStar_List.contains FStar_Syntax_Syntax.Effect))
...
let uu____12589 = (unparen t)
in uu____12589.FStar_Parser_AST.tm)
in (match (uu____12588) with
| FStar_Parser_AST.Construct (head1, args) -> begin
(

let uu____12610 = (match ((FStar_List.rev args)) with
| ((last_arg, uu____12640))::args_rev -> begin
(

let uu____12652 = (

let uu____12653 = (unparen last_arg)
in uu____12653.FStar_Parser_AST.tm)
...
in (match (uu____12610) with
| (cattributes, args1) -> begin
(

let uu____12729 = (desugar_attributes env cattributes)
in (((FStar_Parser_AST.mk_term (FStar_Parser_AST.Construct (((head1), (args1)))) t.FStar_Parser_AST.range t.FStar_Parser_AST.level)), (uu____12729)))
end))
end
| uu____12740 -> begin
((t), ([]))
...
let quals2 = (FStar_All.pipe_right quals1 (FStar_List.filter (fun uu___240_12762 -> (match (uu___240_12762) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| uu____12763 -> begin
...
| (FStar_Parser_AST.TyconRecord (uu____12774))::[] -> begin
(

let trec = (FStar_List.hd tcs)
in (

let uu____12798 = (tycon_record_as_variant trec)
...
let uu____12831 = (FStar_ToSyntax_Env.current_module env)
in (FStar_Ident.ids_of_lid uu____12831))
in ((uu____12828), (fs)))
in FStar_Syntax_Syntax.RecordType (uu____12819))
in (uu____12818)::quals)
in (desugar_tycon env d uu____12815 ((t)::[])))
end)))
end
| (uu____12836)::uu____12837 -> begin
(
...
| (env1, tcs1) -> begin
(match (tc) with
| FStar_Parser_AST.TyconRecord (uu____13223) -> begin
(

let trec = tc
in (

let uu____13247 = (tycon_record_as_variant trec)
in (match (uu____13247) with
| (t, fs) -> begin
(
...
let uu____13322 = (FStar_ToSyntax_Env.current_module env1)
in (FStar_Ident.ids_of_lid uu____13322))
in ((uu____13319), (fs)))
in FStar_Syntax_Syntax.RecordType (uu____13310))
in (uu____13309)::quals1)
in (collect_tcs uu____13306 ((env1), (tcs1)) t))
end)))
end
| FStar_Parser_AST.TyconVariant (id, binders, kopt, constructors) -> begin
(

let uu____13409 = (desugar_abstract_tc quals1 env1 mutuals (FStar_Parser_AST.TyconAbstract (((id), (binders), (kopt)))))
in (match (uu____13409) with
| (env2, uu____13469, se, tconstr) -> begin
...
let uu____13618 = (desugar_abstract_tc quals1 env1 mutuals (FStar_Parser_AST.TyconAbstract (((id), (binders), (kopt)))))
in (match (uu____13618) with
| (env2, uu____13678, se, tconstr) -> begin
...
let uu____13850 = (FStar_List.fold_left (collect_tcs quals) ((env), ([])) tcs)
...
let docs_tps_sigelts = (FStar_All.pipe_right tcs2 (FStar_List.collect (fun uu___242_14361 -> (match (uu___242_14361) with
| FStar_Util.Inr ({FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (id, uvs, tpars, k, uu____14428, uu____14429); FStar_Syntax_Syntax.sigrng = uu____14430; FStar_Syntax_Syntax.sigquals = uu____14431; FStar_Syntax_Syntax.sigmeta = uu____14432; FStar_Syntax_Syntax.sigattrs = uu____14433}, binders, t, quals1) -> begin
(

let t1 = (

let uu____14494 = (typars_of_binders env1 binders)
in (match (uu____14494) with
| (env2, tpars1) -> begin
(

let uu____14525 = (push_tparams env2 tpars1)
...
let uu____14579 = (mk_typ_abbrev id uvs tpars k t1 ((id)::[]) quals1 rng)
in ((((id), (d.FStar_Parser_AST.doc))), ([]), (uu____14579)))
in (uu____14558)::[]))
end
| FStar_Util.Inl ({FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (tname, univs1, tpars, k, mutuals1, uu____14647); FStar_Syntax_Syntax.sigrng = uu____14648; FStar_Syntax_Syntax.sigquals = tname_quals; FStar_Syntax_Syntax.sigmeta = uu____14650; FStar_Syntax_Syntax.sigattrs = uu____14651}, constrs, tconstr, quals1) -> begin
(
...
let uu____14747 = (push_tparams env1 tpars)
in (match (uu____14747) with
| (env_tps, tps) -> begin
(

let data_tpars = (FStar_List.map (fun uu____14824 -> (match (uu____14824) with
| (x, uu____14838) -> begin
...
let uu____14875 = (FStar_All.pipe_right constrs (FStar_List.map (fun uu____14989 -> (match (uu____14989) with
...
let uu____15045 = (close env_tps t)
in (desugar_term env_tps uu____15045))
in (

let name = (FStar_ToSyntax_Env.qualify env1 id)
in (

let quals2 = (FStar_All.pipe_right tname_quals (FStar_List.collect (fun uu___241_15056 -> (match (uu___241_15056) with
...
let uu____15120 = (FStar_All.pipe_right t1 FStar_Syntax_Util.name_function_binders)
in (FStar_Syntax_Syntax.mk_Total uu____15120))
in (FStar_Syntax_Util.arrow data_tpars uu____15117))
in ((name), (univs1), (uu____15114), (tname), (ntps), (mutuals1)))
in FStar_Syntax_Syntax.Sig_datacon (uu____15099))
in {FStar_Syntax_Syntax.sigel = uu____15098; FStar_Syntax_Syntax.sigrng = rng; FStar_Syntax_Syntax.sigquals = quals2; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []})
in ((((name), (doc1))), (tps), (uu____15097)))
in ((name), (uu____15076))))))))
end))))
in (FStar_All.pipe_left FStar_List.split uu____14875))
...
let name_docs = (FStar_All.pipe_right docs_tps_sigelts (FStar_List.map (fun uu____15491 -> (match (uu____15491) with
| (name_doc, uu____15519, uu____15520) -> begin
name_doc
end))))
in (

let sigelts = (FStar_All.pipe_right docs_tps_sigelts (FStar_List.map (fun uu____15600 -> (match (uu____15600) with
| (uu____15621, uu____15622, se) -> begin
se
end))))
in (
...
let uu____15659 = (FStar_List.collect FStar_Syntax_Util.lids_of_sigelt sigelts)
in (FStar_Syntax_MutRecTy.disentangle_abbrevs_from_bundle sigelts quals uu____15659 rng))
...
let data_ops = (FStar_All.pipe_right docs_tps_sigelts (FStar_List.collect (fun uu____15725 -> (match (uu____15725) with
| (uu____15748, tps, se) -> begin
(mk_data_projector_names quals env3 se)
end))))
in (

let discs = (FStar_All.pipe_right sigelts (FStar_List.collect (fun se -> (match (se.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (tname, uu____15799, tps, k, uu____15802, constrs) when ((FStar_List.length constrs) > (Prims.parse_int "1")) -> begin
(
...
let env5 = (FStar_List.fold_left (fun acc uu____15838 -> (match (uu____15838) with
| (lid, doc1) -> begin
...
let uu____15875 = (FStar_List.fold_left (fun uu____15898 b -> (match (uu____15898) with
| (env1, binders1) -> begin
(

let uu____15918 = (desugar_binder env1 b)
in (match (uu____15918) with
| (FStar_Pervasives_Native.Some (a), k) -> begin
(

let uu____15935 = (as_binder env1 b.FStar_Parser_AST.aqual ((FStar_Pervasives_Native.Some (a)), (k)))
...
let uu____16070 = (desugar_binders monad_env eff_binders)
...
let uu____16099 = (FStar_Syntax_Util.arrow_formals eff_t)
in (FStar_Pervasives_Native.fst uu____16099))
in (FStar_List.length uu____16092))
in (Prims.op_Equality uu____16091 (Prims.parse_int "1")))
in (
...
| FStar_Parser_AST.Tycon (uu____16141, ((FStar_Parser_AST.TyconAbbrev (name, uu____16143, uu____16144, uu____16145), uu____16146))::[]) -> begin
...
let uu____16180 = (FStar_List.partition (fun decl -> (

let uu____16192 = (name_of_eff_decl decl)
in (FStar_List.mem uu____16192 mandatory_members))) eff_decls)
in (match (uu____16180) with
| (mandatory_members_decls, actions) -> begin
(

let uu____16209 = (FStar_All.pipe_right mandatory_members_decls (FStar_List.fold_left (fun uu____16238 decl -> (match (uu____16238) with
| (env2, out) -> begin
(

let uu____16258 = (desugar_decl env2 decl)
...
let uu____16274 = (FStar_List.hd ses)
in (uu____16274)::out)
in ((env3), (uu____16271)))
end))
end)) ((env1), ([]))))
...
| FStar_Parser_AST.Tycon (uu____16342, ((FStar_Parser_AST.TyconAbbrev (name, action_params, uu____16345, {FStar_Parser_AST.tm = FStar_Parser_AST.Construct (uu____16346, ((def, uu____16348))::((cps_type, uu____16350))::[]); FStar_Parser_AST.range = uu____16351; FStar_Parser_AST.level = uu____16352}), doc1))::[]) when (not (for_free)) -> begin
(

let uu____16404 = (desugar_binders env2 action_params)
...
let uu____16425 = (FStar_ToSyntax_Env.qualify env3 name)
in (

let uu____16426 = (

let uu____16427 = (desugar_term env3 def)
in (FStar_Syntax_Subst.close (FStar_List.append binders1 action_params2) uu____16427))
in (

let uu____16432 = (

let uu____16433 = (desugar_typ env3 cps_type)
in (FStar_Syntax_Subst.close (FStar_List.append binders1 action_params2) uu____16433))
in {FStar_Syntax_Syntax.action_name = uu____16425; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_params = action_params2; FStar_Syntax_Syntax.action_defn = uu____16426; FStar_Syntax_Syntax.action_typ = uu____16432})))
in ((uu____16424), (doc1))))
end))
end
| FStar_Parser_AST.Tycon (uu____16440, ((FStar_Parser_AST.TyconAbbrev (name, action_params, uu____16443, defn), doc1))::[]) when for_free -> begin
(

let uu____16478 = (desugar_binders env2 action_params)
in (match (uu____16478) with
| (env3, action_params1) -> begin
(
...
let uu____16499 = (FStar_ToSyntax_Env.qualify env3 name)
in (

let uu____16500 = (

let uu____16501 = (desugar_term env3 defn)
in (FStar_Syntax_Subst.close (FStar_List.append binders1 action_params2) uu____16501))
in {FStar_Syntax_Syntax.action_name = uu____16499; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_params = action_params2; FStar_Syntax_Syntax.action_defn = uu____16500; FStar_Syntax_Syntax.action_typ = FStar_Syntax_Syntax.tun}))
in ((uu____16498), (doc1))))
end))
end
| uu____16508 -> begin
...
let uu____16539 = (FStar_ToSyntax_Env.fail_or env2 (FStar_ToSyntax_Env.try_lookup_definition env2) l)
in (FStar_All.pipe_left (FStar_Syntax_Subst.close binders1) uu____16539))
in (([]), (uu____16538)))))
in (
...
let uu____16556 = (FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown FStar_Pervasives_Native.None FStar_Range.dummyRange)
in (([]), (uu____16556)))
in (
...
let uu____16566 = (lookup "repr")
in (FStar_Pervasives_Native.snd uu____16566))
in (

let uu____16575 = (lookup "return")
in (

let uu____16576 = (lookup "bind")
in {FStar_Syntax_Syntax.cattributes = []; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders1; FStar_Syntax_Syntax.signature = eff_t1; FStar_Syntax_Syntax.ret_wp = dummy_tscheme; FStar_Syntax_Syntax.bind_wp = dummy_tscheme; FStar_Syntax_Syntax.if_then_else = dummy_tscheme; FStar_Syntax_Syntax.ite_wp = dummy_tscheme; FStar_Syntax_Syntax.stronger = dummy_tscheme; FStar_Syntax_Syntax.close_wp = dummy_tscheme; FStar_Syntax_Syntax.assert_p = dummy_tscheme; FStar_Syntax_Syntax.assume_p = dummy_tscheme; FStar_Syntax_Syntax.null_wp = dummy_tscheme; FStar_Syntax_Syntax.trivial = dummy_tscheme; FStar_Syntax_Syntax.repr = uu____16565; FStar_Syntax_Syntax.return_repr = uu____16575; FStar_Syntax_Syntax.bind_repr = uu____16576; FStar_Syntax_Syntax.actions = actions1})))
in FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____16564))
in {FStar_Syntax_Syntax.sigel = uu____16563; FStar_Syntax_Syntax.sigrng = d.FStar_Parser_AST.drange; FStar_Syntax_Syntax.sigquals = qualifiers; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []}))
end
| uu____16577 -> begin
(

let rr = (FStar_Util.for_some (fun uu___243_16580 -> (match (uu___243_16580) with
| FStar_Syntax_Syntax.Reifiable -> begin
true
end
| FStar_Syntax_Syntax.Reflectable (uu____16581) -> begin
true
end
| uu____16582 -> begin
false
...
let uu____16594 = (lookup "return_wp")
in (

let uu____16595 = (lookup "bind_wp")
in (

let uu____16596 = (lookup "if_then_else")
in (

let uu____16597 = (lookup "ite_wp")
in (

let uu____16598 = (lookup "stronger")
in (

let uu____16599 = (lookup "close_wp")
in (

let uu____16600 = (lookup "assert_p")
in (

let uu____16601 = (lookup "assume_p")
in (

let uu____16602 = (lookup "null_wp")
in (

let uu____16603 = (lookup "trivial")
in (

let uu____16604 = (match (rr) with
| true -> begin
(

let uu____16605 = (lookup "repr")
in (FStar_All.pipe_left FStar_Pervasives_Native.snd uu____16605))
end
| uu____16620 -> begin
...
in {FStar_Syntax_Syntax.cattributes = []; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders1; FStar_Syntax_Syntax.signature = eff_t1; FStar_Syntax_Syntax.ret_wp = uu____16594; FStar_Syntax_Syntax.bind_wp = uu____16595; FStar_Syntax_Syntax.if_then_else = uu____16596; FStar_Syntax_Syntax.ite_wp = uu____16597; FStar_Syntax_Syntax.stronger = uu____16598; FStar_Syntax_Syntax.close_wp = uu____16599; FStar_Syntax_Syntax.assert_p = uu____16600; FStar_Syntax_Syntax.assume_p = uu____16601; FStar_Syntax_Syntax.null_wp = uu____16602; FStar_Syntax_Syntax.trivial = uu____16603; FStar_Syntax_Syntax.repr = uu____16604; FStar_Syntax_Syntax.return_repr = uu____16621; FStar_Syntax_Syntax.bind_repr = uu____16623; FStar_Syntax_Syntax.actions = actions1})))))))))))))
in FStar_Syntax_Syntax.Sig_new_effect (uu____16593))
in {FStar_Syntax_Syntax.sigel = uu____16592; FStar_Syntax_Syntax.sigrng = d.FStar_Parser_AST.drange; FStar_Syntax_Syntax.sigquals = qualifiers; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []})))
end)
in (
...
let env5 = (FStar_All.pipe_right actions_docs (FStar_List.fold_left (fun env5 uu____16648 -> (match (uu____16648) with
| (a, doc1) -> begin
(

let env6 = (

let uu____16662 = (FStar_Syntax_Util.action_as_lb mname a)
in (FStar_ToSyntax_Env.push_sigelt env5 uu____16662))
...
let uu____16664 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Parser_AST.Reflectable))
...
let uu____16695 = (desugar_binders env1 eff_binders)
...
let uu____16733 = (head_and_args defn)
in (match (uu____16733) with
| (head1, args) -> begin
(
...
let uu____16787 = (FStar_Parser_AST.term_to_string head1)
in (Prims.strcat uu____16787 " not found"))
in (Prims.strcat "Effect " uu____16786))
in ((uu____16785), (d.FStar_Parser_AST.drange)))
in FStar_Errors.Error (uu____16780))
in (FStar_Exn.raise uu____16779))
end)
in (
...
let uu____16789 = (match ((FStar_List.rev args)) with
| ((last_arg, uu____16819))::args_rev -> begin
(

let uu____16831 = (

let uu____16832 = (unparen last_arg)
in uu____16832.FStar_Parser_AST.tm)
...
let uu____16920 = (desugar_args env2 args1)
in (

let uu____16929 = (desugar_attributes env2 cattributes)
in ((lid), (ed), (uu____16920), (uu____16929))))
end))))
end))
in (match (uu____16714) with
...
let sub1 = (fun uu____16988 -> (match (uu____16988) with
| (uu____17001, x) -> begin
(

let uu____17007 = (FStar_Syntax_Subst.open_term ed.FStar_Syntax_Syntax.binders x)
...
let uu____17034 = (FStar_Syntax_Subst.subst s x1)
in (FStar_Syntax_Subst.close binders1 uu____17034))
in (([]), (uu____17033))));
)
end))
end))
...
let uu____17040 = (sub1 (([]), (ed.FStar_Syntax_Syntax.signature)))
in (FStar_Pervasives_Native.snd uu____17040))
in (

let uu____17051 = (sub1 ed.FStar_Syntax_Syntax.ret_wp)
in (

let uu____17052 = (sub1 ed.FStar_Syntax_Syntax.bind_wp)
in (

let uu____17053 = (sub1 ed.FStar_Syntax_Syntax.if_then_else)
in (

let uu____17054 = (sub1 ed.FStar_Syntax_Syntax.ite_wp)
in (

let uu____17055 = (sub1 ed.FStar_Syntax_Syntax.stronger)
in (

let uu____17056 = (sub1 ed.FStar_Syntax_Syntax.close_wp)
in (

let uu____17057 = (sub1 ed.FStar_Syntax_Syntax.assert_p)
in (

let uu____17058 = (sub1 ed.FStar_Syntax_Syntax.assume_p)
in (

let uu____17059 = (sub1 ed.FStar_Syntax_Syntax.null_wp)
in (

let uu____17060 = (sub1 ed.FStar_Syntax_Syntax.trivial)
in (

let uu____17061 = (

let uu____17062 = (sub1 (([]), (ed.FStar_Syntax_Syntax.repr)))
in (FStar_Pervasives_Native.snd uu____17062))
in (

let uu____17073 = (sub1 ed.FStar_Syntax_Syntax.return_repr)
in (

let uu____17074 = (sub1 ed.FStar_Syntax_Syntax.bind_repr)
in (

let uu____17075 = (FStar_List.map (fun action -> (

let uu____17083 = (FStar_ToSyntax_Env.qualify env2 action.FStar_Syntax_Syntax.action_unqualified_name)
in (

let uu____17084 = (

let uu____17085 = (sub1 (([]), (action.FStar_Syntax_Syntax.action_defn)))
in (FStar_Pervasives_Native.snd uu____17085))
in (

let uu____17096 = (

let uu____17097 = (sub1 (([]), (action.FStar_Syntax_Syntax.action_typ)))
in (FStar_Pervasives_Native.snd uu____17097))
in {FStar_Syntax_Syntax.action_name = uu____17083; FStar_Syntax_Syntax.action_unqualified_name = action.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = action.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_params = action.FStar_Syntax_Syntax.action_params; FStar_Syntax_Syntax.action_defn = uu____17084; FStar_Syntax_Syntax.action_typ = uu____17096})))) ed.FStar_Syntax_Syntax.actions)
in {FStar_Syntax_Syntax.cattributes = cattributes; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders1; FStar_Syntax_Syntax.signature = uu____17039; FStar_Syntax_Syntax.ret_wp = uu____17051; FStar_Syntax_Syntax.bind_wp = uu____17052; FStar_Syntax_Syntax.if_then_else = uu____17053; FStar_Syntax_Syntax.ite_wp = uu____17054; FStar_Syntax_Syntax.stronger = uu____17055; FStar_Syntax_Syntax.close_wp = uu____17056; FStar_Syntax_Syntax.assert_p = uu____17057; FStar_Syntax_Syntax.assume_p = uu____17058; FStar_Syntax_Syntax.null_wp = uu____17059; FStar_Syntax_Syntax.trivial = uu____17060; FStar_Syntax_Syntax.repr = uu____17061; FStar_Syntax_Syntax.return_repr = uu____17073; FStar_Syntax_Syntax.bind_repr = uu____17074; FStar_Syntax_Syntax.actions = uu____17075})))))))))))))))
in (
...
let uu____17118 = (FStar_Syntax_Util.arrow_formals ed1.FStar_Syntax_Syntax.signature)
in (FStar_Pervasives_Native.fst uu____17118))
in (FStar_List.length uu____17111))
in (Prims.op_Equality uu____17110 (Prims.parse_int "1")))
in (

let uu____17147 = (

let uu____17150 = (trans_qual1 (FStar_Pervasives_Native.Some (mname)))
in (FStar_List.map uu____17150 quals))
...
end); FStar_Syntax_Syntax.sigrng = d.FStar_Parser_AST.drange; FStar_Syntax_Syntax.sigquals = uu____17147; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []}))
in (
...
let uu____17170 = (FStar_Syntax_Util.action_as_lb mname a)
in (FStar_ToSyntax_Env.push_sigelt env5 uu____17170))
in (FStar_ToSyntax_Env.push_doc env6 a.FStar_Syntax_Syntax.action_name doc1)))) env4))
in (

let env6 = (

let uu____17172 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Parser_AST.Reflectable))
...
let uu____17187 = (match (d.FStar_Parser_AST.doc) with
| FStar_Pervasives_Native.None -> begin
((""), ([]))
end
...
| FStar_Pervasives_Native.Some (uu____17238) -> begin
(

let uu____17239 = (

let uu____17240 = (FStar_Parser_ToDocument.signature_to_document d)
in (FStar_Pprint.pretty_string 0.950000 (Prims.parse_int "80") uu____17240))
in (Prims.strcat "\n  " uu____17239))
end
| uu____17241 -> begin
""
...
let other = (FStar_List.filter_map (fun uu____17254 -> (match (uu____17254) with
| (k, v1) -> begin
...
let uu____17272 = (FStar_Ident.lid_of_str "FStar.Pervasives.Comment")
in (FStar_Syntax_Syntax.fvar uu____17272 FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None))
in (
...
let uu____17283 = (FStar_Syntax_Syntax.as_arg arg)
in (uu____17283)::[])
in (FStar_Syntax_Util.mk_app fv uu____17274)))))))))
end)))
and desugar_decl : env_t  ->  FStar_Parser_AST.decl  ->  (env_t * FStar_Syntax_Syntax.sigelts) = (fun env d -> (

let uu____17290 = (desugar_decl_noattrs env d)
...
let uu____17310 = (mk_comment_attr d)
in (uu____17310)::attrs1)
in (

let uu____17315 = (FStar_List.map (fun sigelt -> (

let uu___269_17321 = sigelt
in {FStar_Syntax_Syntax.sigel = uu___269_17321.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___269_17321.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___269_17321.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___269_17321.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = attrs2})) sigelts)
in ((env1), (uu____17315))))))
end)))
...
| FStar_Parser_AST.Fsdoc (uu____17347) -> begin
((env), ([]))
end
...
let uu____17363 = (FStar_ToSyntax_Env.push_module_abbrev env x l)
in ((uu____17363), ([])))
end
...
let tcs1 = (FStar_List.map (fun uu____17402 -> (match (uu____17402) with
| (x, uu____17410) -> begin
x
end)) tcs)
in (

let uu____17415 = (FStar_List.map (trans_qual1 FStar_Pervasives_Native.None) quals)
in (desugar_tycon env d uu____17415 tcs1))))
end
...
| (({FStar_Parser_AST.pat = FStar_Parser_AST.PatOp (uu____17437); FStar_Parser_AST.prange = uu____17438}, uu____17439))::[] -> begin
false
end
| (({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (uu____17448); FStar_Parser_AST.prange = uu____17449}, uu____17450))::[] -> begin
false
end
| (({FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (uu____17465); FStar_Parser_AST.prange = uu____17466}, uu____17467); FStar_Parser_AST.prange = uu____17468}, uu____17469))::[] -> begin
false
end
| ((p, uu____17485))::[] -> begin
(

let uu____17494 = (is_app_pattern p)
in (not (uu____17494)))
end
| uu____17495 -> begin
false
...
let uu____17515 = (FStar_All.pipe_left FStar_Syntax_Subst.compress ds_lets)
in uu____17515.FStar_Syntax_Syntax.n)
in (match (uu____17514) with
| FStar_Syntax_Syntax.Tm_let (lbs, uu____17523) -> begin
(
...
| (uu____17556)::uu____17557 -> begin
(FStar_List.map (trans_qual1 FStar_Pervasives_Native.None) quals)
end
| uu____17560 -> begin
(FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) (FStar_List.collect (fun uu___244_17573 -> (match (uu___244_17573) with
| {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (uu____17576); FStar_Syntax_Syntax.lbunivs = uu____17577; FStar_Syntax_Syntax.lbtyp = uu____17578; FStar_Syntax_Syntax.lbeff = uu____17579; FStar_Syntax_Syntax.lbdef = uu____17580} -> begin
[]
end
| {FStar_Syntax_Syntax.lbname = FStar_Util.Inr (fv); FStar_Syntax_Syntax.lbunivs = uu____17588; FStar_Syntax_Syntax.lbtyp = uu____17589; FStar_Syntax_Syntax.lbeff = uu____17590; FStar_Syntax_Syntax.lbdef = uu____17591} -> begin
...
let uu____17601 = (FStar_All.pipe_right lets (FStar_Util.for_some (fun uu____17615 -> (match (uu____17615) with
| (uu____17620, t) -> begin
(Prims.op_Equality t.FStar_Parser_AST.level FStar_Parser_AST.Formula)
end))))
in (match (uu____17601) with
| true -> begin
...
let uu____17632 = (FStar_All.pipe_right quals2 (FStar_List.contains FStar_Syntax_Syntax.Abstract))
in (match (uu____17632) with
| true -> begin
(

let uu____17641 = (FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) (FStar_List.map (fun lb -> (

let fv = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (

let uu___270_17655 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inr ((

let uu___271_17657 = fv
in {FStar_Syntax_Syntax.fv_name = uu___271_17657.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_abstract (fv.FStar_Syntax_Syntax.fv_delta); FStar_Syntax_Syntax.fv_qual = uu___271_17657.FStar_Syntax_Syntax.fv_qual})); FStar_Syntax_Syntax.lbunivs = uu___270_17655.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___270_17655.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___270_17655.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___270_17655.FStar_Syntax_Syntax.lbdef})))))
in (((FStar_Pervasives_Native.fst lbs)), (uu____17641)))
end
| uu____17662 -> begin
lbs
end))
...
let uu____17695 = (match (lets) with
| ((pat, body))::[] -> begin
((pat), (body))
end
| uu____17714 -> begin
...
let uu___272_17738 = pat1
in {FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed (((var_pat), (ty))); FStar_Parser_AST.prange = uu___272_17738.FStar_Parser_AST.prange})
end
| uu____17739 -> begin
var_pat
end))
...
let uu___273_17746 = d
in {FStar_Parser_AST.d = FStar_Parser_AST.TopLevelLet (((isrec), ((((fresh_pat), (body)))::[]))); FStar_Parser_AST.drange = uu___273_17746.FStar_Parser_AST.drange; FStar_Parser_AST.doc = uu___273_17746.FStar_Parser_AST.doc; FStar_Parser_AST.quals = (FStar_Parser_AST.Private)::d.FStar_Parser_AST.quals; FStar_Parser_AST.attrs = uu___273_17746.FStar_Parser_AST.attrs}))
in (

let build_projection = (fun uu____17778 id -> (match (uu____17778) with
| (env1, ses) -> begin
(
...
let uu____17800 = (FStar_Ident.lid_of_ids ((fresh_toplevel_name)::[]))
in FStar_Parser_AST.Var (uu____17800))
in (FStar_Parser_AST.mk_term uu____17799 FStar_Range.dummyRange FStar_Parser_AST.Expr))
in (
...
let uu____17850 = (desugar_decl env1 id_decl)
...
let uu____17868 = (gather_pattern_bound_vars pat)
in (FStar_All.pipe_right uu____17868 FStar_Util.set_elements))
...
let uu____17899 = (close_fun env t)
in (desugar_term env uu____17899))
in (

let quals1 = (

let uu____17903 = ((FStar_ToSyntax_Env.iface env) && (FStar_ToSyntax_Env.admitted_iface env))
in (match (uu____17903) with
| true -> begin
...
let uu____17909 = (FStar_List.map (trans_qual1 FStar_Pervasives_Native.None) quals1)
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((lid), ([]), (t1))); FStar_Syntax_Syntax.sigrng = d.FStar_Parser_AST.drange; FStar_Syntax_Syntax.sigquals = uu____17909; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []})
in (
...
let uu____17921 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_lid env) FStar_Parser_Const.exn_lid)
...
let uu____17976 = (FStar_Syntax_Syntax.null_binder t)
in (uu____17976)::[])
in (
...
let uu____17981 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_lid env) FStar_Parser_Const.exn_lid)
in (FStar_Pervasives_Native.fst uu____17981))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total uu____17980))
in (FStar_Syntax_Util.arrow uu____17969 uu____17977)))
in (
...
let uu____18043 = (FStar_ToSyntax_Env.try_lookup_effect_name env l1)
...
let uu____18054 = (FStar_Syntax_Print.lid_to_string l1)
in (Prims.strcat uu____18054 " not found"))
in (Prims.strcat "Effect name " uu____18053))
in ((uu____18052), (d.FStar_Parser_AST.drange)))
in FStar_Errors.Error (uu____18047))
in (FStar_Exn.raise uu____18046))
end
...
let uu____18058 = (match (l.FStar_Parser_AST.lift_op) with
...
let uu____18116 = (desugar_term env t)
in (([]), (uu____18116)))
in FStar_Pervasives_Native.Some (uu____18109))
in ((uu____18100), (FStar_Pervasives_Native.None)))
end
...
let uu____18165 = (desugar_term env wp)
in (([]), (uu____18165)))
in FStar_Pervasives_Native.Some (uu____18158))
in (
...
let uu____18190 = (desugar_term env t)
in (([]), (uu____18190)))
in FStar_Pervasives_Native.Some (uu____18183))
in ((uu____18149), (uu____18174))))
end
...
let uu____18232 = (desugar_term env t)
in (([]), (uu____18232)))
in FStar_Pervasives_Native.Some (uu____18225))
in ((FStar_Pervasives_Native.None), (uu____18216)))
end)
...
let uu____18322 = (FStar_List.fold_left (fun uu____18342 d -> (match (uu____18342) with
| (env1, sigelts) -> begin
(

let uu____18362 = (desugar_decl env1 d)
in (match (uu____18362) with
| (env2, se) -> begin
((env2), ((FStar_List.append sigelts se)))
end))
end)) ((env), ([])) decls)
in (match (uu____18322) with
| (env1, sigelts) -> begin
(

let rec forward = (fun acc uu___246_18403 -> (match (uu___246_18403) with
| (se1)::(se2)::sigelts1 -> begin
(match (((se1.FStar_Syntax_Syntax.sigel), (se2.FStar_Syntax_Syntax.sigel))) with
| (FStar_Syntax_Syntax.Sig_declare_typ (uu____18417), FStar_Syntax_Syntax.Sig_let (uu____18418)) -> begin
(
...
let uu___274_18435 = se2
in (

let uu____18436 = (

let uu____18439 = (FStar_List.filter (fun uu___245_18453 -> (match (uu___245_18453) with
| {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.pos = uu____18457; FStar_Syntax_Syntax.vars = uu____18458}, uu____18459); FStar_Syntax_Syntax.pos = uu____18460; FStar_Syntax_Syntax.vars = uu____18461} when (

let uu____18484 = (

let uu____18485 = (FStar_Syntax_Syntax.lid_of_fv fv)
in (FStar_Ident.string_of_lid uu____18485))
in (Prims.op_Equality uu____18484 "FStar.Pervasives.Comment")) -> begin
true
end
| uu____18486 -> begin
false
end)) se1.FStar_Syntax_Syntax.sigattrs)
in (FStar_List.append uu____18439 se2.FStar_Syntax_Syntax.sigattrs))
in {FStar_Syntax_Syntax.sigel = uu___274_18435.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___274_18435.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___274_18435.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___274_18435.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu____18436}))
in (uu____18434)::(se1)::acc)
in (forward uu____18431 sigelts1))
end
| uu____18491 -> begin
...
let uu____18499 = (forward [] sigelts)
in ((env1), (uu____18499))))
end)))
...
| (FStar_Pervasives_Native.None, uu____18553) -> begin
env
end
| (FStar_Pervasives_Native.Some ({FStar_Syntax_Syntax.name = prev_lid; FStar_Syntax_Syntax.declarations = uu____18557; FStar_Syntax_Syntax.exports = uu____18558; FStar_Syntax_Syntax.is_interface = uu____18559}), FStar_Parser_AST.Module (current_lid, uu____18561)) when ((FStar_Ident.lid_equals prev_lid current_lid) && (FStar_Options.interactive ())) -> begin
env
end
| (FStar_Pervasives_Native.Some (prev_mod), uu____18569) -> begin
(FStar_ToSyntax_Env.finish_module_or_interface env prev_mod)
end)
in (

let uu____18572 = (match (m) with
| FStar_Parser_AST.Interface (mname, decls, admitted) -> begin
(

let uu____18608 = (FStar_ToSyntax_Env.prepare_module_or_interface true admitted env1 mname FStar_ToSyntax_Env.default_mii)
in ((uu____18608), (mname), (decls), (true)))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(

let uu____18625 = (FStar_ToSyntax_Env.prepare_module_or_interface false false env1 mname FStar_ToSyntax_Env.default_mii)
in ((uu____18625), (mname), (decls), (false)))
end)
in (match (uu____18572) with
| ((env2, pop_when_done), mname, decls, intf) -> begin
(

let uu____18655 = (desugar_decls env2 decls)
in (match (uu____18655) with
| (env3, sigelts) -> begin
(
...
let uu____18713 = ((FStar_Options.interactive ()) && (

let uu____18715 = (

let uu____18716 = (

let uu____18717 = (FStar_Options.file_list ())
in (FStar_List.hd uu____18717))
in (FStar_Util.get_file_extension uu____18716))
in (FStar_List.mem uu____18715 (("fsti")::("fsi")::[]))))
in (match (uu____18713) with
| true -> begin
(as_interface m)
end
| uu____18720 -> begin
...
let uu____18721 = (desugar_modul_common curmod env m1)
...
let uu____18736 = (FStar_ToSyntax_Env.pop ())
in ())
end
| uu____18737 -> begin
()
...
let uu____18754 = (desugar_modul_common FStar_Pervasives_Native.None env m)
in (match (uu____18754) with
...
let uu____18770 = (FStar_Options.dump_module modul.FStar_Syntax_Syntax.name.FStar_Ident.str)
in (match (uu____18770) with
| true -> begin
(

let uu____18771 = (FStar_Syntax_Print.modul_to_string modul)
...
let uu____18773 = (match (pop_when_done) with
| true -> begin
...
let uu____18788 = (desugar_modul env modul)
...
let uu____18816 = (desugar_decls env decls)
in (match (uu____18816) with
| (env1, sigelts) -> begin
((sigelts), (env1))
end)))
...
let uu____18856 = (desugar_partial_modul modul env a_modul)
...
let uu____18884 = (FStar_ToSyntax_Env.prepare_module_or_interface false false en m.FStar_Syntax_Syntax.name mii)
...
let uu____18896 = (FStar_ToSyntax_Env.set_current_module en1 m.FStar_Syntax_Syntax.name)
in (FStar_List.fold_left FStar_ToSyntax_Env.push_sigelt uu____18896 m.FStar_Syntax_Syntax.exports))
in (

let env = (FStar_ToSyntax_Env.finish en2 m)
in (

let uu____18898 = (match (pop_when_done) with
| true -> begin
