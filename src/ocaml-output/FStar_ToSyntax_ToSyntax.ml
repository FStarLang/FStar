...
let trans_aqual : FStar_Parser_AST.arg_qualifier Prims.option  ->  FStar_Syntax_Syntax.arg_qualifier Prims.option = (fun uu___194_5 -> (match (uu___194_5) with
...
let trans_qual : FStar_Range.range  ->  FStar_Ident.lident Prims.option  ->  FStar_Parser_AST.qualifier  ->  FStar_Syntax_Syntax.qualifier = (fun r maybe_effect_id uu___195_19 -> (match (uu___195_19) with
...
let trans_pragma : FStar_Parser_AST.pragma  ->  FStar_Syntax_Syntax.pragma = (fun uu___196_25 -> (match (uu___196_25) with
...
let as_imp : FStar_Parser_AST.imp  ->  FStar_Syntax_Syntax.arg_qualifier Prims.option = (fun uu___197_32 -> (match (uu___197_32) with
...
let binder_of_bnd : bnd  ->  (FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.aqual) = (fun uu___198_760 -> (match (uu___198_760) with
...
let as_binder : FStar_ToSyntax_Env.env  ->  FStar_Parser_AST.arg_qualifier Prims.option  ->  (FStar_Ident.ident Prims.option * FStar_Syntax_Syntax.term)  ->  (FStar_Syntax_Syntax.binder * FStar_ToSyntax_Env.env) = (fun env imp uu___199_782 -> (match (uu___199_782) with
| (None, k) -> begin
(
...
let uu___220_806 = a1
in {FStar_Syntax_Syntax.ppname = uu___220_806.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___220_806.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})), ((trans_aqual imp)))), (env1))
end))
end))
...
let is_special_effect_combinator : Prims.string  ->  Prims.bool = (fun uu___200_1060 -> (match (uu___200_1060) with
...
(match ((FStar_List.existsb (fun uu___201_1186 -> (match (uu___201_1186) with
...
let uu____1194 = (FStar_List.map (fun uu___202_1198 -> (match (uu___202_1198) with
...
let nargs = (FStar_List.map (fun uu___203_1208 -> (match (uu___203_1208) with
| FStar_Util.Inl (n1) -> begin
n1
end
...
let uu___221_1771 = x
in {FStar_Syntax_Syntax.ppname = uu___221_1771.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___221_1771.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})), (aq)));
))
end)
...
in Some (uu____2466))
in {FStar_Syntax_Syntax.fv_name = uu___222_2463.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = uu___222_2463.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = uu____2464}))
in ((uu____2462), (args1)))
...
let uu___223_2792 = e
in {FStar_Syntax_Syntax.n = uu___223_2792.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___223_2792.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = top.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___223_2792.FStar_Syntax_Syntax.vars}))
in (
...
let uu____2957 = (FStar_Ident.lid_of_path (FStar_Ident.path_of_text (Prims.strcat (FStar_Ident.text_of_lid ed.FStar_Syntax_Syntax.mname) (Prims.strcat "_" txt))) FStar_Range.dummyRange)
in (FStar_Syntax_Syntax.fvar uu____2957 (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) None))
end
| None -> begin
(
...
let uu___224_3245 = x
in {FStar_Syntax_Syntax.ppname = uu___224_3245.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___224_3245.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1})), (None)))::[]))), (uu____3227)))
end))
end))
...
let rec aux = (fun env1 bs1 uu___204_3311 -> (match (uu___204_3311) with
| [] -> begin
(
...
let rec aux = (fun env1 bs sc_pat_opt uu___205_3451 -> (match (uu___205_3451) with
| [] -> begin
(
...
let uu___225_6170 = t
in {FStar_Syntax_Syntax.n = uu___225_6170.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___225_6170.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = f.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___225_6170.FStar_Syntax_Syntax.vars}))
in (
...
let uu___226_6200 = b
in {FStar_Parser_AST.b = uu___226_6200.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___226_6200.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___226_6200.FStar_Parser_AST.aqual}))
in (
...
let uu___227_6250 = a1
in {FStar_Syntax_Syntax.ppname = uu___227_6250.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___227_6250.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
in (
...
let uu___228_6482 = b
in {FStar_Parser_AST.b = uu___228_6482.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___228_6482.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___228_6482.FStar_Parser_AST.aqual}))
in (match (tk) with
| (Some (a), k) -> begin
(
...
let uu___229_6504 = a1
in {FStar_Syntax_Syntax.ppname = uu___229_6504.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___229_6504.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
...
let quals1 = (FStar_All.pipe_right quals (FStar_List.filter (fun uu___206_6630 -> (match (uu___206_6630) with
...
let uu____6714 = (FStar_List.filter (fun uu___207_6716 -> (match (uu___207_6716) with
...
let iquals1 = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___208_6725 -> (match (uu___208_6725) with
| (FStar_Syntax_Syntax.Abstract) | (FStar_Syntax_Syntax.Private) -> begin
true
end
| uu____6726 -> begin
...
let filter_records = (fun uu___209_6844 -> (match (uu___209_6844) with
...
let tycon_id = (fun uu___210_6975 -> (match (uu___210_6975) with
...
let tycon_record_as_variant = (fun uu___211_7052 -> (match (uu___211_7052) with
...
let desugar_abstract_tc = (fun quals1 _env mutuals uu___212_7165 -> (match (uu___212_7165) with
...
let uu___230_7433 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), ([]), (t), (quals2))); FStar_Syntax_Syntax.sigrng = uu___230_7433.FStar_Syntax_Syntax.sigrng})))
end
| uu____7436 -> begin
(failwith "Impossible")
end)
...
let uu____7469 = (FStar_Util.for_some (fun uu___213_7470 -> (match (uu___213_7470) with
...
let uu____7477 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___214_7479 -> (match (uu___214_7479) with
...
let uu____7598 = (FStar_All.pipe_right quals1 (FStar_List.filter (fun uu___215_7602 -> (match (uu___215_7602) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| uu____7603 -> begin
...
let docs_tps_sigelts = (FStar_All.pipe_right tcs2 (FStar_List.collect (fun uu___217_8428 -> (match (uu___217_8428) with
...
let quals2 = (FStar_All.pipe_right tags (FStar_List.collect (fun uu___216_8797 -> (match (uu___216_8797) with
...
let rr = (FStar_Util.for_some (fun uu___218_9662 -> (match (uu___218_9662) with
...
| uu____10183 -> begin
(FStar_All.pipe_right (Prims.snd lbs) (FStar_List.collect (fun uu___219_10187 -> (match (uu___219_10187) with
...
let uu___231_10244 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inr ((

let uu___232_10245 = fv
in {FStar_Syntax_Syntax.fv_name = uu___232_10245.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_abstract (fv.FStar_Syntax_Syntax.fv_delta); FStar_Syntax_Syntax.fv_qual = uu___232_10245.FStar_Syntax_Syntax.fv_qual})); FStar_Syntax_Syntax.lbunivs = uu___231_10244.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___231_10244.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___231_10244.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___231_10244.FStar_Syntax_Syntax.lbdef})))))
...
let uu___233_10304 = pat1
in {FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed (((var_pat), (ty))); FStar_Parser_AST.prange = uu___233_10304.FStar_Parser_AST.prange})
end
| uu____10305 -> begin
var_pat
end))
...
let uu___234_10309 = d
in {FStar_Parser_AST.d = FStar_Parser_AST.TopLevelLet (((isrec), ((((fresh_pat), (body)))::[]))); FStar_Parser_AST.drange = uu___234_10309.FStar_Parser_AST.drange; FStar_Parser_AST.doc = uu___234_10309.FStar_Parser_AST.doc; FStar_Parser_AST.quals = (FStar_Parser_AST.Private)::d.FStar_Parser_AST.quals; FStar_Parser_AST.attrs = uu___234_10309.FStar_Parser_AST.attrs}))
in (
