           ...
           (match uu____6843 with
            | (formals,uu____6853) ->
                (match formals with
                 | [] -> []
                 | uu____6867 ->
                     let filter_records uu___214_6875 =
                       match uu___214_6875 with
    ...
    fun d  ->
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___215_7006 =
            match uu___215_7006 with
          ...
          let apply_binders t binders =
            ...
            FStar_List.fold_left
              ...
              binders in
          let tycon_record_as_variant uu___216_7083 =
            match uu___216_7083 with
          ...
          let desugar_abstract_tc quals1 _env mutuals uu___217_7196 =
            match uu___217_7196 with
               ...
               | (uu____7416,uu____7417,se,uu____7419) ->
                   let se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         ...
                         let uu___235_7464 = se in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ
                                (l, [], t, quals2));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___235_7464.FStar_Syntax_Syntax.sigrng)
                         }
                       ...
                       FStar_All.pipe_right (Prims.snd lbs)
                         (FStar_List.map
                            (fun lb  ->
                               ...
                               let uu___236_10275 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___237_10276 = fv in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___237_10276.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___237_10276.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___236_10275.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___236_10275.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___236_10275.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___236_10275.FStar_Syntax_Syntax.lbdef)
                               })) in
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___238_10335 = pat1 in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___238_10335.FStar_Parser_AST.prange)
                       }
                   | uu____10336 -> var_pat in
                 let main_let =
                   desugar_decl env
                     (let uu___239_10340 = d in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___239_10340.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___239_10340.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___239_10340.FStar_Parser_AST.attrs)
                      }) in
