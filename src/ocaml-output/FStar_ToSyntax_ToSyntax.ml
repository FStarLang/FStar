      ...
      fun uu___301_1436  ->
        ...
        | (FStar_Pervasives_Native.Some a,k) ->
            ...
            (match uu____1457 with
             | (env1,a1) ->
                 (((let uu___324_1477 = a1 in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___324_1477.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___324_1477.FStar_Syntax_Syntax.index);
               ...
               (match uu____2607 with
                | (loc1,env',binder,p3,imp) ->
                    let annot_pat_var p4 t1 =
                      ...
                      | FStar_Syntax_Syntax.Pat_var x ->
                          let uu___325_2661 = p4 in
                          {
                            FStar_Syntax_Syntax.v =
                              (FStar_Syntax_Syntax.Pat_var
                                 (let uu___326_2666 = x in
                                  {
                                    FStar_Syntax_Syntax.ppname =
                                      (uu___326_2666.FStar_Syntax_Syntax.ppname);
                                    FStar_Syntax_Syntax.index =
                                      (uu___326_2666.FStar_Syntax_Syntax.index);
                                    FStar_Syntax_Syntax.sort = t1
                                  }));
                            FStar_Syntax_Syntax.p =
                              (uu___325_2661.FStar_Syntax_Syntax.p)
                          }
                      | FStar_Syntax_Syntax.Pat_wild x ->
                          let uu___327_2668 = p4 in
                          {
                            FStar_Syntax_Syntax.v =
                              (FStar_Syntax_Syntax.Pat_wild
                                 (let uu___328_2673 = x in
                                  {
                                    FStar_Syntax_Syntax.ppname =
                                      (uu___328_2673.FStar_Syntax_Syntax.ppname);
                                    FStar_Syntax_Syntax.index =
                                      (uu___328_2673.FStar_Syntax_Syntax.index);
                                    FStar_Syntax_Syntax.sort = t1
                                  }));
                            FStar_Syntax_Syntax.p =
                              (uu___327_2668.FStar_Syntax_Syntax.p)
                          }
                      ...
                      | LocalBinder (x,aq) ->
                          ...
                          (if
                           ...
                           (let uu____2712 = annot_pat_var p3 t1 in
                            (uu____2712,
                              (LocalBinder
                                 ((let uu___329_2718 = x in
                                   {
                                     FStar_Syntax_Syntax.ppname =
                                       (uu___329_2718.FStar_Syntax_Syntax.ppname);
                                     FStar_Syntax_Syntax.index =
                                       (uu___329_2718.FStar_Syntax_Syntax.index);
                                     FStar_Syntax_Syntax.sort = t1
                                   }), aq))))) in
                              ...
                              let uu____3832 =
                                  ...
                                  FStar_Pervasives_Native.Some uu____3837 in
                                {
                                  FStar_Syntax_Syntax.fv_name =
                                    (uu___330_3833.FStar_Syntax_Syntax.fv_name);
                                  FStar_Syntax_Syntax.fv_delta =
                                    (uu___330_3833.FStar_Syntax_Syntax.fv_delta);
                  ...
                  | FStar_Pervasives_Native.Some (intro_term,uu____4394) ->
                      (match intro_term.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_fvar fv ->
                           ...
                           let uu___331_4405 = intro_term in
                           {
                             FStar_Syntax_Syntax.n =
                               (FStar_Syntax_Syntax.Tm_fvar private_fv);
                             FStar_Syntax_Syntax.pos =
                               (uu___331_4405.FStar_Syntax_Syntax.pos);
                             FStar_Syntax_Syntax.vars =
                               (uu___331_4405.FStar_Syntax_Syntax.vars)
                           }
                       | uu____4406 ->
                           failwith
  ...
  fun top_level  ->
    fun env  ->
      fun top  ->
        ...
        let setpos e =
          let uu___332_4583 = e in
          {
            FStar_Syntax_Syntax.n = (uu___332_4583.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.pos = (top.FStar_Parser_AST.range);
            FStar_Syntax_Syntax.vars =
              (uu___332_4583.FStar_Syntax_Syntax.vars)
          } in
        let uu____4586 =
        ...
        | FStar_Parser_AST.Construct (n1,(a,uu____4765)::[]) when
            ...
            let uu____4780 =
              let uu___333_4781 = top in
              let uu____4782 =
                let uu____4783 =
                  let uu____4790 =
                    let uu___334_4791 = top in
                    let uu____4792 =
                      let uu____4793 =
                      ...
                      FStar_Parser_AST.Var uu____4793 in
                    {
                      ...
                      FStar_Parser_AST.range =
                        (uu___334_4791.FStar_Parser_AST.range);
                      FStar_Parser_AST.level =
                        (uu___334_4791.FStar_Parser_AST.level)
                    } in
                ...
                FStar_Parser_AST.App uu____4783 in
              {
                ...
                FStar_Parser_AST.range =
                  (uu___333_4781.FStar_Parser_AST.range);
                FStar_Parser_AST.level =
                  (uu___333_4781.FStar_Parser_AST.level)
              } in
        ...
        | FStar_Parser_AST.Construct (n1,(a,uu____4796)::[]) when
            ...
            (FStar_Errors.warn top.FStar_Parser_AST.range
             ...
             (let uu____4812 =
                let uu___335_4813 = top in
                let uu____4814 =
                  let uu____4815 =
                    let uu____4822 =
                      let uu___336_4823 = top in
                      let uu____4824 =
                        let uu____4825 =
                          FStar_Ident.lid_of_path ["Prims"; "smt_pat"]
                            top.FStar_Parser_AST.range in
                        FStar_Parser_AST.Var uu____4825 in
                      {
                        ...
                        FStar_Parser_AST.range =
                          (uu___336_4823.FStar_Parser_AST.range);
                        FStar_Parser_AST.level =
                          (uu___336_4823.FStar_Parser_AST.level)
                      } in
                  ...
                  FStar_Parser_AST.App uu____4815 in
                {
                  ...
                  FStar_Parser_AST.range =
                    (uu___335_4813.FStar_Parser_AST.range);
                  FStar_Parser_AST.level =
                    (uu___335_4813.FStar_Parser_AST.level)
                } in
              desugar_term_maybe_top top_level env uu____4812))
        | FStar_Parser_AST.Construct (n1,(a,uu____4828)::[]) when
            n1.FStar_Ident.str = "SMTPatOr" ->
            let uu____4843 =
              let uu___337_4844 = top in
              let uu____4845 =
                let uu____4846 =
                  let uu____4853 =
                    let uu___338_4854 = top in
                    let uu____4855 =
                      let uu____4856 =
                      ...
                      FStar_Parser_AST.Var uu____4856 in
                    {
                      ...
                      FStar_Parser_AST.range =
                        (uu___338_4854.FStar_Parser_AST.range);
                      FStar_Parser_AST.level =
                        (uu___338_4854.FStar_Parser_AST.level)
                    } in
                ...
                FStar_Parser_AST.App uu____4846 in
              {
                ...
                FStar_Parser_AST.range =
                  (uu___337_4844.FStar_Parser_AST.range);
                FStar_Parser_AST.level =
                  (uu___337_4844.FStar_Parser_AST.level)
              } in
                               ...
                               | (env2,x) ->
                                   ...
                                   (env2,
                                     (FStar_List.append tparams
                                        [(((let uu___339_5403 = x in
                                            {
                                              FStar_Syntax_Syntax.ppname =
                                                (uu___339_5403.FStar_Syntax_Syntax.ppname);
                                              FStar_Syntax_Syntax.index =
                                                (uu___339_5403.FStar_Syntax_Syntax.index);
                                              FStar_Syntax_Syntax.sort = t1
                                            })),
                                           FStar_Pervasives_Native.None)]),
                                     uu____5370)))) (env, [], [])
        ...
        | FStar_Parser_AST.Product (binders,t) ->
            ...
            (match uu____5471 with
             | (bs,t1) ->
                 let rec aux env1 bs1 uu___306_5503 =
                   match uu___306_5503 with
                   | [] ->
                       let cod =
        ...
        | FStar_Parser_AST.Abs (binders,body) ->
            ...
            (match uu____5604 with
             | (uu____5665,ftv) ->
                 ...
                 let rec aux env1 bs sc_pat_opt uu___307_5718 =
                   match uu___307_5718 with
                   | [] ->
...
and desugar_formula:
  ...
  fun env  ->
    fun f  ->
      ...
      let setpos t =
        let uu___340_10443 = t in
        {
          FStar_Syntax_Syntax.n = (uu___340_10443.FStar_Syntax_Syntax.n);
          FStar_Syntax_Syntax.pos = (f.FStar_Parser_AST.range);
          FStar_Syntax_Syntax.vars =
            (uu___340_10443.FStar_Syntax_Syntax.vars)
        } in
      let desugar_quant q b pats body =
        let tk =
          desugar_binder env
            (let uu___341_10477 = b in
             {
               FStar_Parser_AST.b = (uu___341_10477.FStar_Parser_AST.b);
               FStar_Parser_AST.brange =
                 (uu___341_10477.FStar_Parser_AST.brange);
               FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
               FStar_Parser_AST.aqual =
                 (uu___341_10477.FStar_Parser_AST.aqual)
             }) in
        ...
        | (FStar_Pervasives_Native.Some a,k) ->
            ...
            (match uu____10549 with
             | (env1,a1) ->
                 let a2 =
                   let uu___342_10559 = a1 in
                   {
                     FStar_Syntax_Syntax.ppname =
                       (uu___342_10559.FStar_Syntax_Syntax.ppname);
                     FStar_Syntax_Syntax.index =
                       (uu___342_10559.FStar_Syntax_Syntax.index);
                     FStar_Syntax_Syntax.sort = k
                   } in
          ...
          (fun uu____10893  ->
             fun b  ->
               ...
               | (env1,out) ->
                   let tk =
                     desugar_binder env1
                       (let uu___343_10945 = b in
                        {
                          FStar_Parser_AST.b =
                            (uu___343_10945.FStar_Parser_AST.b);
                          FStar_Parser_AST.brange =
                            (uu___343_10945.FStar_Parser_AST.brange);
                          FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
                          FStar_Parser_AST.aqual =
                            (uu___343_10945.FStar_Parser_AST.aqual)
                        }) in
                   (match tk with
                    | (FStar_Pervasives_Native.Some a,k) ->
                        ...
                        (match uu____10962 with
                         | (env2,a1) ->
                             let a2 =
                               let uu___344_10982 = a1 in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___344_10982.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___344_10982.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = k
                               } in
                             (env2,
            ...
            (match uu____11367 with
             | (formals,uu____11383) ->
                 (match formals with
                  | [] -> []
                  | uu____11406 ->
                      let filter_records uu___311_11418 =
                        match uu___311_11418 with
    ...
    fun d  ->
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___312_11607 =
            match uu___312_11607 with
          ...
          let apply_binders t binders =
            ...
            FStar_List.fold_left
              ...
              binders in
          let tycon_record_as_variant uu___313_11762 =
            match uu___313_11762 with
          ...
          let desugar_abstract_tc quals1 _env mutuals uu___314_11962 =
            match uu___314_11962 with
               ...
               | (uu____12358,uu____12359,se,uu____12361) ->
                   let se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         ...
                         let uu___345_12413 = se in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ (l, [], t));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___345_12413.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals = quals2;
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___345_12413.FStar_Syntax_Syntax.sigmeta);
                           FStar_Syntax_Syntax.sigattrs =
                             (uu___345_12413.FStar_Syntax_Syntax.sigattrs)
                         }
                     ...
                     | (ed_lid,ed,args,cattributes) ->
                         ...
                         let ed1 =
                           let uu____16953 =
                             ...
                             FStar_Pervasives_Native.snd uu____16954 in
                           let uu____16965 =
                           ...
                           let uu____16975 =
                             ...
                             FStar_Pervasives_Native.snd uu____16976 in
                           let uu____16987 =
                             ...
                             FStar_List.map
                               (fun action  ->
                                  ...
                                  let uu____16998 =
                                    ...
                                    FStar_Pervasives_Native.snd uu____16999 in
                                  let uu____17010 =
                                    let uu____17011 =
                                      sub1
                                        ([],
                                  ...
                                  }) ed.FStar_Syntax_Syntax.actions in
                           {
                             ...
                             FStar_Syntax_Syntax.signature = uu____16953;
                             FStar_Syntax_Syntax.ret_wp = uu____16965;
                             FStar_Syntax_Syntax.bind_wp = uu____16966;
                             FStar_Syntax_Syntax.if_then_else = uu____16967;
                             FStar_Syntax_Syntax.ite_wp = uu____16968;
                             FStar_Syntax_Syntax.stronger = uu____16969;
                             FStar_Syntax_Syntax.close_wp = uu____16970;
                             FStar_Syntax_Syntax.assert_p = uu____16971;
                             FStar_Syntax_Syntax.assume_p = uu____16972;
                             FStar_Syntax_Syntax.null_wp = uu____16973;
                             FStar_Syntax_Syntax.trivial = uu____16974;
                             FStar_Syntax_Syntax.repr = uu____16975;
                             FStar_Syntax_Syntax.return_repr = uu____16987;
                             FStar_Syntax_Syntax.bind_repr = uu____16988;
                             FStar_Syntax_Syntax.actions = uu____16989
                           } in
                         let se =
                           let for_free =
                             let uu____17024 =
                               let uu____17025 =
                                 ...
                                 FStar_Pervasives_Native.fst uu____17032 in
                               FStar_List.length uu____17025 in
                             uu____17024 = (Prims.parse_int "1") in
                           let uu____17061 =
                             let uu____17064 =
                               trans_qual1
                                 (FStar_Pervasives_Native.Some mname) in
                             FStar_List.map uu____17064 quals in
                           {
                             FStar_Syntax_Syntax.sigel =
                               (if for_free
                                then
                             ...
                             FStar_Syntax_Syntax.sigrng =
                               (d.FStar_Parser_AST.drange);
                             FStar_Syntax_Syntax.sigquals = uu____17061;
                             FStar_Syntax_Syntax.sigmeta =
                               FStar_Syntax_Syntax.default_sigmeta;
                             FStar_Syntax_Syntax.sigattrs = []
                           } in
  ...
  fun d  ->
    ...
    | (text,kv) ->
        ...
        let pp =
          ...
          | FStar_Pervasives_Native.Some uu____17152 ->
              let uu____17153 =
                let uu____17154 =
        ...
        let fv =
          let uu____17186 = FStar_Ident.lid_of_str "FStar.Pervasives.Comment" in
          FStar_Syntax_Syntax.fvar uu____17186
            FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None in
        let arg = FStar_Syntax_Util.exp_string str in
        let uu____17188 =
          let uu____17197 = FStar_Syntax_Syntax.as_arg arg in [uu____17197] in
        FStar_Syntax_Util.mk_app fv uu____17188
and desugar_decl:
  env_t ->
    FStar_Parser_AST.decl ->
      (env_t,FStar_Syntax_Syntax.sigelts) FStar_Pervasives_Native.tuple2
  ...
  fun env  ->
    fun d  ->
      let uu____17204 = desugar_decl_noattrs env d in
      match uu____17204 with
      | (env1,sigelts) ->
          let attrs = d.FStar_Parser_AST.attrs in
          let attrs1 = FStar_List.map (desugar_term env1) attrs in
          let attrs2 =
            let uu____17224 = mk_comment_attr d in uu____17224 :: attrs1 in
          let uu____17229 =
            FStar_List.map
              (fun sigelt  ->
                 let uu___346_17235 = sigelt in
                 {
                   FStar_Syntax_Syntax.sigel =
                     (uu___346_17235.FStar_Syntax_Syntax.sigel);
                   FStar_Syntax_Syntax.sigrng =
                     (uu___346_17235.FStar_Syntax_Syntax.sigrng);
                   FStar_Syntax_Syntax.sigquals =
                     (uu___346_17235.FStar_Syntax_Syntax.sigquals);
                   FStar_Syntax_Syntax.sigmeta =
                     (uu___346_17235.FStar_Syntax_Syntax.sigmeta);
    ...
    fun d  ->
      ...
      | FStar_Parser_AST.Pragma p ->
          ...
          (if p = FStar_Parser_AST.LightOff
           ...
           (env, [se]))
      | FStar_Parser_AST.Fsdoc uu____17261 -> (env, [])
      ...
      | FStar_Parser_AST.ModuleAbbrev (x,l) ->
          let uu____17277 = FStar_ToSyntax_Env.push_module_abbrev env x l in
          (uu____17277, [])
      | FStar_Parser_AST.Tycon (is_effect,tcs) ->
          ...
          let tcs1 =
            FStar_List.map
              (fun uu____17316  ->
                 match uu____17316 with | (x,uu____17324) -> x) tcs in
          let uu____17329 =
            FStar_List.map (trans_qual1 FStar_Pervasives_Native.None) quals in
          desugar_tycon env d uu____17329 tcs1
      | FStar_Parser_AST.TopLevelLet (isrec,lets) ->
          ...
          let expand_toplevel_pattern =
            (isrec = FStar_Parser_AST.NoLetQualifier) &&
              (match lets with
               | ({
                    FStar_Parser_AST.pat = FStar_Parser_AST.PatOp uu____17351;
                    FStar_Parser_AST.prange = uu____17352;_},uu____17353)::[]
                   -> false
               | ({
                    FStar_Parser_AST.pat = FStar_Parser_AST.PatVar
                      uu____17362;
               ...
               | ({
                    FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed
                      ({
                         FStar_Parser_AST.pat = FStar_Parser_AST.PatVar
                           uu____17379;
                         FStar_Parser_AST.prange = uu____17380;_},uu____17381);
                    FStar_Parser_AST.prange = uu____17382;_},uu____17383)::[]
                   -> false
               | (p,uu____17399)::[] ->
                   let uu____17408 = is_app_pattern p in
                   Prims.op_Negation uu____17408
               | uu____17409 -> false) in
          ...
          then
            ...
            (match uu____17428 with
             | FStar_Syntax_Syntax.Tm_let (lbs,uu____17437) ->
                 let fvs =
                 ...
                 let quals1 =
                   ...
                   | uu____17474 ->
                       FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                         (FStar_List.collect
                            (fun uu___321_17487  ->
                               match uu___321_17487 with
                               | {
                                   FStar_Syntax_Syntax.lbname =
                                     FStar_Util.Inl uu____17490;
                                   FStar_Syntax_Syntax.lbunivs = uu____17491;
                                   FStar_Syntax_Syntax.lbtyp = uu____17492;
                                   FStar_Syntax_Syntax.lbeff = uu____17493;
                                   FStar_Syntax_Syntax.lbdef = uu____17494;_}
                                   -> []
                               | {
                                   FStar_Syntax_Syntax.lbname =
                                     FStar_Util.Inr fv;
                                   FStar_Syntax_Syntax.lbunivs = uu____17502;
                                   FStar_Syntax_Syntax.lbtyp = uu____17503;
                                   FStar_Syntax_Syntax.lbeff = uu____17504;
                                   FStar_Syntax_Syntax.lbdef = uu____17505;_}
                                   ->
                       ...
                       FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                         (FStar_List.map
                            (fun lb  ->
                               ...
                               let uu___347_17569 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___348_17571 = fv in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___348_17571.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___348_17571.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___347_17569.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___347_17569.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___347_17569.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___347_17569.FStar_Syntax_Syntax.lbdef)
                               })) in
                     ((FStar_Pervasives_Native.fst lbs), uu____17555)
                   else lbs in
                 let names1 =
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___349_17652 = pat1 in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___349_17652.FStar_Parser_AST.prange)
                       }
                   | uu____17653 -> var_pat in
                 let main_let =
                   desugar_decl env
                     (let uu___350_17660 = d in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___350_17660.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___350_17660.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___350_17660.FStar_Parser_AST.attrs)
                      }) in
                 let build_projection uu____17692 id =
                   ...
                   | (env1,ses) ->
                       let main =
                         let uu____17713 =
                           ...
                           FStar_Parser_AST.Var uu____17714 in
                         FStar_Parser_AST.mk_term uu____17713
                       ...
                       let uu____17764 = desugar_decl env1 id_decl in
                       (match uu____17764 with
                        | (env2,ses') -> (env2, (FStar_List.append ses ses'))) in
                 let bvs =
                   let uu____17782 = gather_pattern_bound_vars pat in
                   FStar_All.pipe_right uu____17782 FStar_Util.set_elements in
      ...
      | FStar_Parser_AST.Val (id,t) ->
          let quals = d.FStar_Parser_AST.quals in
          let t1 =
            let uu____17813 = close_fun env t in desugar_term env uu____17813 in
          let quals1 =
            let uu____17817 =
          ...
          let se =
                ...
                quals1 in
            {
              ...
              FStar_Syntax_Syntax.sigrng = (d.FStar_Parser_AST.drange);
              FStar_Syntax_Syntax.sigquals = uu____17823;
              FStar_Syntax_Syntax.sigmeta =
                FStar_Syntax_Syntax.default_sigmeta;
              FStar_Syntax_Syntax.sigattrs = []
            } in
      ...
      | FStar_Parser_AST.Exception (id,FStar_Pervasives_Native.Some term) ->
          ...
          let t1 =
            let uu____17883 =
              let uu____17890 = FStar_Syntax_Syntax.null_binder t in
              [uu____17890] in
            let uu____17891 =
              let uu____17894 =
                let uu____17895 =
                  FStar_ToSyntax_Env.fail_or env
                    (FStar_ToSyntax_Env.try_lookup_lid env)
                    FStar_Parser_Const.exn_lid in
                FStar_Pervasives_Native.fst uu____17895 in
              FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total uu____17894 in
            FStar_Syntax_Util.arrow uu____17883 uu____17891 in
          let l = FStar_ToSyntax_Env.qualify env id in
          let qual1 = [FStar_Syntax_Syntax.ExceptionConstructor] in
          let se =
            {
      ...
      | FStar_Parser_AST.SubEffect l ->
            ...
            | FStar_Pervasives_Native.None  ->
                let uu____17960 =
                  let uu____17961 =
                    let uu____17966 =
                      let uu____17967 =
                        let uu____17968 = FStar_Syntax_Print.lid_to_string l1 in
                        Prims.strcat uu____17968 " not found" in
                      Prims.strcat "Effect name " uu____17967 in
                    (uu____17966, (d.FStar_Parser_AST.drange)) in
                  FStar_Errors.Error uu____17961 in
                FStar_Exn.raise uu____17960
          ...
          let uu____17972 =
            ...
            | FStar_Parser_AST.NonReifiableLift t ->
                let uu____18014 =
                  let uu____18023 =
                    let uu____18030 = desugar_term env t in ([], uu____18030) in
                  FStar_Pervasives_Native.Some uu____18023 in
                (uu____18014, FStar_Pervasives_Native.None)
            | FStar_Parser_AST.ReifiableLift (wp,t) ->
                let uu____18063 =
                  let uu____18072 =
                    let uu____18079 = desugar_term env wp in
                    ([], uu____18079) in
                  FStar_Pervasives_Native.Some uu____18072 in
                let uu____18088 =
                  let uu____18097 =
                    let uu____18104 = desugar_term env t in ([], uu____18104) in
                  FStar_Pervasives_Native.Some uu____18097 in
                (uu____18063, uu____18088)
            | FStar_Parser_AST.LiftForFree t ->
                let uu____18130 =
                  let uu____18139 =
                    let uu____18146 = desugar_term env t in ([], uu____18146) in
                  FStar_Pervasives_Native.Some uu____18139 in
                (FStar_Pervasives_Native.None, uu____18130) in
        ...
        FStar_List.fold_left
          (fun uu____18254  ->
             fun d  ->
               ...
               | (env1,sigelts) ->
                   let uu____18274 = desugar_decl env1 d in
                   (match uu____18274 with
                    | (env2,se) -> (env2, (FStar_List.append sigelts se))))
          (env, []) decls in
      match uu____18234 with
      | (env1,sigelts) ->
          let rec forward acc uu___323_18315 =
            match uu___323_18315 with
            | se1::se2::sigelts1 ->
                (match ((se1.FStar_Syntax_Syntax.sigel),
                         (se2.FStar_Syntax_Syntax.sigel))
                 with
                 | (FStar_Syntax_Syntax.Sig_declare_typ
                    uu____18329,FStar_Syntax_Syntax.Sig_let uu____18330) ->
                     let uu____18343 =
                       let uu____18346 =
                         let uu___351_18347 = se2 in
                         let uu____18348 =
                           let uu____18351 =
                             FStar_List.filter
                               (fun uu___322_18365  ->
                                  match uu___322_18365 with
                                  | {
                                      FStar_Syntax_Syntax.n =
                                        FStar_Syntax_Syntax.Tm_app
                                        ({
                                           ...
                                           FStar_Syntax_Syntax.pos =
                                             uu____18369;
                                           FStar_Syntax_Syntax.vars =
                                             uu____18370;_},uu____18371);
                                      FStar_Syntax_Syntax.pos = uu____18372;
                                      FStar_Syntax_Syntax.vars = uu____18373;_}
                                      when
                                      let uu____18396 =
                                        let uu____18397 =
                                          FStar_Syntax_Syntax.lid_of_fv fv in
                                        FStar_Ident.string_of_lid uu____18397 in
                                      uu____18396 =
                                        "FStar.Pervasives.Comment"
                                      -> true
                                  | uu____18398 -> false)
                               se1.FStar_Syntax_Syntax.sigattrs in
                           FStar_List.append uu____18351
                             se2.FStar_Syntax_Syntax.sigattrs in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (uu___351_18347.FStar_Syntax_Syntax.sigel);
                           FStar_Syntax_Syntax.sigrng =
                             (uu___351_18347.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             (uu___351_18347.FStar_Syntax_Syntax.sigquals);
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___351_18347.FStar_Syntax_Syntax.sigmeta);
                           FStar_Syntax_Syntax.sigattrs = uu____18348
                         } in
                       uu____18346 :: se1 :: acc in
                     forward uu____18343 sigelts1
                 | uu____18403 -> forward (se1 :: acc) (se2 :: sigelts1))
            | sigelts1 -> FStar_List.rev_append acc sigelts1 in
          let uu____18411 = forward [] sigelts in (env1, uu____18411)
let open_prims_all:
  ...
  fun curmod  ->
    fun env  ->
      fun m  ->
        let env1 =
          match (curmod, m) with
          | (FStar_Pervasives_Native.None ,uu____18462) -> env
          | (FStar_Pervasives_Native.Some
             { FStar_Syntax_Syntax.name = prev_lid;
               FStar_Syntax_Syntax.declarations = uu____18466;
               FStar_Syntax_Syntax.exports = uu____18467;
               FStar_Syntax_Syntax.is_interface = uu____18468;_},FStar_Parser_AST.Module
             (current_lid,uu____18470)) when
              (FStar_Ident.lid_equals prev_lid current_lid) &&
                (FStar_Options.interactive ())
              -> env
          | (FStar_Pervasives_Native.Some prev_mod,uu____18478) ->
        ...
        let uu____18481 =
          ...
          | FStar_Parser_AST.Interface (mname,decls,admitted) ->
              ...
              (uu____18517, mname, decls, true)
          | FStar_Parser_AST.Module (mname,decls) ->
              let uu____18534 =
                FStar_ToSyntax_Env.prepare_module_or_interface false false
                  env1 mname FStar_ToSyntax_Env.default_mii in
              (uu____18534, mname, decls, false) in
        match uu____18481 with
        | ((env2,pop_when_done),mname,decls,intf) ->
            let uu____18564 = desugar_decls env2 decls in
        ...
        let m1 =
          let uu____18618 =
            (FStar_Options.interactive ()) &&
              (let uu____18620 =
                 let uu____18621 =
                   let uu____18622 = FStar_Options.file_list () in
                   FStar_List.hd uu____18622 in
                 FStar_Util.get_file_extension uu____18621 in
               FStar_List.mem uu____18620 ["fsti"; "fsi"]) in
          if uu____18618 then as_interface m else m in
        let uu____18626 = desugar_modul_common curmod env m1 in
        match uu____18626 with
        | (x,y,pop_when_done) ->
            (if pop_when_done
             then (let uu____18641 = FStar_ToSyntax_Env.pop () in ())
             else ();
             (x, y))
let desugar_modul:
  FStar_ToSyntax_Env.env ->
    ...
    fun m  ->
      ...
      | (env1,modul,pop_when_done) ->
          ...
          ((let uu____18673 =
            ...
            if uu____18673
            then
              let uu____18674 = FStar_Syntax_Print.modul_to_string modul in
              FStar_Util.print1 "%s\n" uu____18674
            else ());
           (let uu____18676 =
              if pop_when_done
...
let ast_modul_to_modul:
  ...
  fun modul  ->
    fun env  ->
      let uu____18690 = desugar_modul env modul in
      match uu____18690 with | (env1,modul1) -> (modul1, env1)
let decls_to_sigelts:
  ...
  fun decls  ->
    fun env  ->
      let uu____18717 = desugar_decls env decls in
      match uu____18717 with | (env1,sigelts) -> (sigelts, env1)
let partial_ast_modul_to_modul:
  ...
  fun modul  ->
    fun a_modul  ->
      fun env  ->
        let uu____18755 = desugar_partial_modul modul env a_modul in
        match uu____18755 with | (env1,modul1) -> (modul1, env1)
      ...
      fun en  ->
        ...
        | (en1,pop_when_done) ->
            let en2 =
              ...
              FStar_List.fold_left FStar_ToSyntax_Env.push_sigelt uu____18793
