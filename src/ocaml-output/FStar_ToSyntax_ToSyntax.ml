                 ...
                 let uu____3257 =
                   let uu____3260 =
                     FStar_Syntax_Util.mk_dtuple_lid
                      ...
                      in
                   FStar_ToSyntax_Env.fail_or env
                     (FStar_ToSyntax_Env.try_lookup_lid env) uu____3260
                    in
                     ...
                     | (env,ftvs) ->
                         (match pat.FStar_Parser_AST.pat with
                          | FStar_Parser_AST.PatAscribed (uu____3391,t) ->
                              ...
                              (env, uu____3393)
                          | uu____3398 -> (env, ftvs))) (env, []) binders
               in
        ...
        | FStar_Parser_AST.Let (qual,(pat,_snd)::_tl,body) ->
            ...
            let ds_let_rec_or_app uu____3978 =
              ...
              | (env',fnames,rec_bindings) ->
                  ...
                  FStar_All.pipe_left mk uu____4512
               in
                    ...
                    | LocalBinder (x,uu____4577) ->
                        ...
                        let body =
                          ...
                          | Some pat ->
                              ...
                              uu____4586 None body.FStar_Syntax_Syntax.pos
                           in
                        let uu____4624 =
                          let uu____4625 =
                            let uu____4633 =
                        ...
                        FStar_All.pipe_left mk uu____4624
                     in
                  if is_mutable
                  then
                    FStar_All.pipe_left mk
    ...
    fun env  ->
      fun t  ->
        ...
        let is_requires uu____5250 =
          ...
          | (t,uu____5254) ->
              let uu____5255 =
                let uu____5256 = unparen t  in uu____5256.FStar_Parser_AST.tm
                 in
        ...
        let is_ensures uu____5267 =
          ...
          | (t,uu____5271) ->
              let uu____5272 =
                let uu____5273 = unparen t  in uu____5273.FStar_Parser_AST.tm
                 in
        ...
        let is_app head uu____5287 =
          ...
          | (t,uu____5291) ->
              let uu____5292 =
                let uu____5293 = unparen t  in uu____5293.FStar_Parser_AST.tm
                 in
          ...
          let push_tparams env bs =
            let uu____7133 =
              FStar_List.fold_left
                ...
                bs
               in
            match uu____7133 with | (env,bs) -> (env, (FStar_List.rev bs))
             in
          match tcs with
      ...
      | FStar_Parser_AST.Val (id,t) ->
          ...
          let se =
            let uu____9981 =
              ...
              (uu____9988, [], t, uu____9989, (d.FStar_Parser_AST.drange))
               in
