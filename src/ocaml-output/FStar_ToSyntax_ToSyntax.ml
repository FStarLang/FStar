...
in {FStar_Syntax_Syntax.fv_name = uu___212_2210.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = uu___212_2210.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = _0_453}))
in ((_0_454), (args))))
...
let uu___215_2468 = e
in {FStar_Syntax_Syntax.n = uu___215_2468.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___215_2468.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = top.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___215_2468.FStar_Syntax_Syntax.vars}))
in (
...
| FStar_Parser_AST.Op ("*", (uu____2505)::(uu____2506)::[]) when (let _0_469 = (op_as_term env (Prims.parse_int "2") top.FStar_Parser_AST.range "*")
...
let uu____2524 = (let _0_472 = (FStar_Syntax_Util.mk_tuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
...
(let _0_476 = (FStar_Syntax_Util.mk_field_projector_name_from_ident new_name i)
in (desugar_name mk setpos env resolve _0_476))
end
| uu____2656 -> begin
...
let uu____2677 = (let _0_479 = (mk (FStar_Syntax_Syntax.Tm_fvar (head)))
in ((_0_479), (true)))
...
let uu___216_2870 = x
in {FStar_Syntax_Syntax.ppname = uu___216_2870.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___216_2870.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (None)))::[]))), (_0_484)))
end))
end))
...
let uu____2895 = (let _0_485 = (FStar_Syntax_Util.mk_dtuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
...
let rec aux = (fun env bs uu___194_2935 -> (match (uu___194_2935) with
| [] -> begin
(
...
let rec aux = (fun env bs sc_pat_opt uu___195_3063 -> (match (uu___195_3063) with
| [] -> begin
(
...
let uu____3951 = (FStar_All.pipe_right args (FStar_List.tryFind (fun x -> (not ((is_var_pattern x))))))
...
let uu____3958 = (((FStar_Options.ml_ish ()) && (FStar_Option.isSome (FStar_ToSyntax_Env.try_lookup_effect_name env FStar_Syntax_Const.effect_ML_lid))) && ((not (is_rec)) || ((FStar_List.length args) <> (Prims.parse_int "0"))))
...
let uu____4018 = (desugar_binding_pat_maybe_top top_level env pat is_mutable)
...
| LocalBinder (x, uu____4046) -> begin
(
...
let uu____4088 = (is_rec || (is_app_pattern pat))
...
let desugar_branch = (fun uu____4186 -> (match (uu____4186) with
| (pat, wopt, b) -> begin
(

let uu____4196 = (desugar_match_pat env pat)
...
let uu____4221 = (is_comp_type env t)
...
| FStar_Parser_AST.Record (uu____4238, []) -> begin
...
let uu____4259 = (FStar_List.hd fields)
...
let found = (FStar_All.pipe_right fields (FStar_Util.find_opt (fun uu____4290 -> (match (uu____4290) with
| (g, uu____4294) -> begin
...
| None -> begin
FStar_Parser_AST.Construct ((let _0_555 = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map (fun uu____4324 -> (match (uu____4324) with
| (f, uu____4330) -> begin
...
let record = FStar_Parser_AST.Record ((let _0_557 = (FStar_All.pipe_right record.FStar_ToSyntax_Env.fields (FStar_List.map (fun uu____4351 -> (match (uu____4351) with
| (f, uu____4357) -> begin
...
| FStar_Syntax_Syntax.Tm_meta ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.tk = uu____4369; FStar_Syntax_Syntax.pos = uu____4370; FStar_Syntax_Syntax.vars = uu____4371}, args); FStar_Syntax_Syntax.tk = uu____4373; FStar_Syntax_Syntax.pos = uu____4374; FStar_Syntax_Syntax.vars = uu____4375}, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Data_app)) -> begin
(
...
let uu____4422 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_dc_by_field_name env) f)
...
| uu____4440 when (top.FStar_Parser_AST.level = FStar_Parser_AST.Formula) -> begin
(desugar_formula env top)
end
| uu____4441 -> begin
(FStar_Parser_AST.error "Unexpected term" top top.FStar_Parser_AST.range)
end
| FStar_Parser_AST.Let (uu____4442, uu____4443, uu____4444) -> begin
(failwith "Not implemented yet")
end
| FStar_Parser_AST.QForall (uu____4451, uu____4452, uu____4453) -> begin
(failwith "Not implemented yet")
end
| FStar_Parser_AST.QExists (uu____4460, uu____4461, uu____4462) -> begin
(failwith "Not implemented yet")
end)))))
and desugar_args : FStar_ToSyntax_Env.env  ->  (FStar_Parser_AST.term * FStar_Parser_AST.imp) Prims.list  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier Prims.option) Prims.list = (fun env args -> (FStar_All.pipe_right args (FStar_List.map (fun uu____4486 -> (match (uu____4486) with
| (a, imp) -> begin
...
let is_requires = (fun uu____4510 -> (match (uu____4510) with
| (t, uu____4514) -> begin
(

let uu____4515 = (unparen t).FStar_Parser_AST.tm
in (match (uu____4515) with
| FStar_Parser_AST.Requires (uu____4516) -> begin
true
end
| uu____4520 -> begin
false
...
let is_ensures = (fun uu____4526 -> (match (uu____4526) with
| (t, uu____4530) -> begin
(

let uu____4531 = (unparen t).FStar_Parser_AST.tm
in (match (uu____4531) with
| FStar_Parser_AST.Ensures (uu____4532) -> begin
true
end
| uu____4536 -> begin
false
...
let is_app = (fun head uu____4545 -> (match (uu____4545) with
| (t, uu____4549) -> begin
(

let uu____4550 = (unparen t).FStar_Parser_AST.tm
in (match (uu____4550) with
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (d); FStar_Parser_AST.range = uu____4552; FStar_Parser_AST.level = uu____4553}, uu____4554, uu____4555) -> begin
...
let uu____4574 = (head_and_args t)
...
let uu____4778 = (FStar_Options.ml_ish ())
...
let uu____4781 = (FStar_Options.warn_default_effects ())
...
let uu____4794 = (pre_process_comp_typ t)
...
let is_universe = (fun uu____4830 -> (match (uu____4830) with
| (uu____4833, imp) -> begin
(imp = FStar_Parser_AST.UnivApp)
end))
in (

let uu____4835 = (FStar_Util.take is_universe args)
in (match (uu____4835) with
| (universes, args) -> begin
(

let universes = (FStar_List.map (fun uu____4866 -> (match (uu____4866) with
| (u, imp) -> begin
(desugar_universe u)
end)) universes)
in (

let uu____4871 = (let _0_572 = (FStar_List.hd args)
...
let uu____4908 = (FStar_All.pipe_right rest (FStar_List.partition (fun uu____4946 -> (match (uu____4946) with
| (t, uu____4953) -> begin
(match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.tk = uu____4961; FStar_Syntax_Syntax.pos = uu____4962; FStar_Syntax_Syntax.vars = uu____4963}, (uu____4964)::[]) -> begin
...
let decreases_clause = (FStar_All.pipe_right dec (FStar_List.map (fun uu____5029 -> (match (uu____5029) with
| (t, uu____5036) -> begin
(match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_app (uu____5043, ((arg, uu____5045))::[]) -> begin
...
let uu___217_5277 = t
in {FStar_Syntax_Syntax.n = uu___217_5277.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___217_5277.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = f.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = uu___217_5277.FStar_Syntax_Syntax.vars}))
in (
...
let uu___218_5307 = b
in {FStar_Parser_AST.b = uu___218_5307.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___218_5307.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___218_5307.FStar_Parser_AST.aqual}))
in (
...
let uu____5348 = (FStar_ToSyntax_Env.push_bv env a)
...
let uu___219_5356 = a
in {FStar_Syntax_Syntax.ppname = uu___219_5356.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___219_5356.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
in (
...
let uu____5443 = (unparen f).FStar_Parser_AST.tm
...
let uu____5521 = (FStar_List.fold_left (fun uu____5534 b -> (match (uu____5534) with
| (env, out) -> begin
(
...
let uu___220_5562 = b
in {FStar_Parser_AST.b = uu___220_5562.FStar_Parser_AST.b; FStar_Parser_AST.brange = uu___220_5562.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = uu___220_5562.FStar_Parser_AST.aqual}))
in (match (tk) with
| (Some (a), k) -> begin
(

let uu____5572 = (FStar_ToSyntax_Env.push_bv env a)
...
let uu___221_5584 = a
in {FStar_Syntax_Syntax.ppname = uu___221_5584.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___221_5584.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
...
let quals = (FStar_All.pipe_right quals (FStar_List.filter (fun uu___196_5709 -> (match (uu___196_5709) with
...
let uu____5718 = ((FStar_All.pipe_left Prims.op_Negation env.FStar_ToSyntax_Env.iface) || env.FStar_ToSyntax_Env.admitted_iface)
...
in (let _0_601 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i uu____5758 -> (match (uu____5758) with
| (x, uu____5763) -> begin
(

let uu____5764 = (FStar_Syntax_Util.mk_field_projector_name lid x i)
in (match (uu____5764) with
| (field_name, uu____5769) -> begin
(
...
| true -> begin
(let _0_596 = (FStar_List.filter (fun uu___197_5780 -> (match (uu___197_5780) with
...
let iquals = (FStar_All.pipe_right iquals (FStar_List.filter (fun uu___198_5789 -> (match (uu___198_5789) with
| (FStar_Syntax_Syntax.Abstract) | (FStar_Syntax_Syntax.Private) -> begin
true
end
| uu____5790 -> begin
...
let uu____5797 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract))
...
let mk_data_projector_names = (fun iquals env uu____5838 -> (match (uu____5838) with
| (inductive_tps, se) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_datacon (lid, uu____5846, t, uu____5848, n, quals, uu____5851, uu____5852) when (not ((FStar_Ident.lid_equals lid FStar_Syntax_Const.lexcons_lid))) -> begin
(

let uu____5857 = (FStar_Syntax_Util.arrow_formals t)
in (match (uu____5857) with
| (formals, uu____5867) -> begin
(match (formals) with
| [] -> begin
[]
end
...
let filter_records = (fun uu___199_5889 -> (match (uu___199_5889) with
| FStar_Syntax_Syntax.RecordConstructor (uu____5891, fns) -> begin
...
let uu____5900 = (FStar_Util.find_map quals filter_records)
...
let uu____5907 = (FStar_Util.first_N n formals)
in (match (uu____5907) with
| (uu____5919, rest) -> begin
...
let uu____5971 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract))
...
let tycon_id = (fun uu___200_6005 -> (match (uu___200_6005) with
...
let tycon_record_as_variant = (fun uu___201_6074 -> (match (uu___201_6074) with
...
let mfields = (FStar_List.map (fun uu____6103 -> (match (uu____6103) with
| (x, t, uu____6110) -> begin
...
in (let _0_611 = (FStar_All.pipe_right fields (FStar_List.map (fun uu____6150 -> (match (uu____6150) with
| (x, uu____6156, uu____6157) -> begin
...
let desugar_abstract_tc = (fun quals _env mutuals uu___202_6182 -> (match (uu___202_6182) with
| FStar_Parser_AST.TyconAbstract (id, binders, kopt) -> begin
(

let uu____6196 = (typars_of_binders _env binders)
...
let uu____6260 = (FStar_List.fold_left (fun uu____6276 uu____6277 -> (match (((uu____6276), (uu____6277))) with
| ((env, tps), (x, imp)) -> begin
(

let uu____6325 = (FStar_ToSyntax_Env.push_bv env x.FStar_Syntax_Syntax.ppname)
...
let uu____6391 = (desugar_abstract_tc quals env [] tc)
in (match (uu____6391) with
| (uu____6398, uu____6399, se, uu____6401) -> begin
(

let se = (match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, uu____6404, typars, k, [], [], quals, rng) -> begin
(

let quals = (

let uu____6415 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Assumption))
...
let uu____6445 = (typars_of_binders env binders)
...
let uu____6465 = (FStar_Util.for_some (fun uu___203_6466 -> (match (uu___203_6466) with
...
let uu____6473 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___204_6475 -> (match (uu___204_6475) with
...
let uu____6482 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Effect))
...
let uu____6500 = (match ((FStar_List.rev args)) with
| ((last_arg, uu____6516))::args_rev -> begin
(

let uu____6523 = (unparen last_arg).FStar_Parser_AST.tm
...
in (let _0_618 = (FStar_All.pipe_right quals (FStar_List.filter (fun uu___205_6584 -> (match (uu___205_6584) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| uu____6585 -> begin
...
| (FStar_Parser_AST.TyconRecord (uu____6591))::[] -> begin
(

let trec = (FStar_List.hd tcs)
in (

let uu____6604 = (tycon_record_as_variant trec)
...
| (env, tcs) -> begin
(match (tc) with
| FStar_Parser_AST.TyconRecord (uu____6818) -> begin
(

let trec = tc
in (

let uu____6831 = (tycon_record_as_variant trec)
...
let uu____6907 = (desugar_abstract_tc quals env mutuals (FStar_Parser_AST.TyconAbstract (((id), (binders), (kopt)))))
in (match (uu____6907) with
| (env, uu____6938, se, tconstr) -> begin
...
let uu____7016 = (desugar_abstract_tc quals env mutuals (FStar_Parser_AST.TyconAbstract (((id), (binders), (kopt)))))
in (match (uu____7016) with
| (env, uu____7047, se, tconstr) -> begin
...
let uu____7135 = (FStar_List.fold_left (collect_tcs quals) ((env), ([])) tcs)
...
let tps_sigelts = (FStar_All.pipe_right tcs (FStar_List.collect (fun uu___207_7373 -> (match (uu___207_7373) with
| FStar_Util.Inr (FStar_Syntax_Syntax.Sig_inductive_typ (id, uvs, tpars, k, uu____7405, uu____7406, uu____7407, uu____7408), binders, t, quals) -> begin
(

let t = (

let uu____7441 = (typars_of_binders env binders)
in (match (uu____7441) with
| (env, tpars) -> begin
(

let uu____7458 = (push_tparams env tpars)
...
| FStar_Util.Inl (FStar_Syntax_Syntax.Sig_inductive_typ (tname, univs, tpars, k, mutuals, uu____7501, tags, uu____7503), constrs, tconstr, quals) -> begin
(
...
let uu____7556 = (push_tparams env tpars)
in (match (uu____7556) with
| (env_tps, tps) -> begin
(

let data_tpars = (FStar_List.map (fun uu____7591 -> (match (uu____7591) with
| (x, uu____7599) -> begin
...
let uu____7604 = (let _0_633 = (FStar_All.pipe_right constrs (FStar_List.map (fun uu____7670 -> (match (uu____7670) with
| (id, topt, uu____7687, of_notation) -> begin
(
...
let quals = (FStar_All.pipe_right tags (FStar_List.collect (fun uu___206_7704 -> (match (uu___206_7704) with
...
let uu____7824 = (let _0_634 = (FStar_List.collect FStar_Syntax_Util.lids_of_sigelt sigelts)
...
let discs = (FStar_All.pipe_right sigelts (FStar_List.collect (fun uu___208_7860 -> (match (uu___208_7860) with
| FStar_Syntax_Syntax.Sig_inductive_typ (tname, uu____7863, tps, k, uu____7866, constrs, quals, uu____7869) when ((FStar_List.length constrs) > (Prims.parse_int "1")) -> begin
(
...
let uu____7901 = (FStar_List.fold_left (fun uu____7908 b -> (match (uu____7908) with
| (env, binders) -> begin
(

let uu____7920 = (desugar_binder env b)
in (match (uu____7920) with
| (Some (a), k) -> begin
(

let uu____7930 = (FStar_ToSyntax_Env.push_bv env a)
in (match (uu____7930) with
| (env, a) -> begin
(let _0_636 = (let _0_635 = (FStar_Syntax_Syntax.mk_binder (

let uu___222_7939 = a
in {FStar_Syntax_Syntax.ppname = uu___222_7939.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___222_7939.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k}))
in (_0_635)::binders)
in ((env), (_0_636)))
end))
end
...
let uu____8046 = (FStar_All.pipe_right eff_decls (FStar_List.fold_left (fun uu____8057 decl -> (match (uu____8057) with
| (env, out) -> begin
(

let uu____8069 = (desugar_decl env decl)
...
| FStar_Parser_AST.Tycon (uu____8092, ((FStar_Parser_AST.TyconAbbrev (name, uu____8094, uu____8095, {FStar_Parser_AST.tm = FStar_Parser_AST.Construct (uu____8096, ((def, uu____8098))::((cps_type, uu____8100))::[]); FStar_Parser_AST.range = uu____8101; FStar_Parser_AST.level = uu____8102}), uu____8103))::[]) when (not (for_free)) -> begin
...
| FStar_Parser_AST.Tycon (uu____8129, ((FStar_Parser_AST.TyconAbbrev (name, uu____8131, uu____8132, defn), uu____8134))::[]) when for_free -> begin
...
let uu____8206 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Parser_AST.Reflectable))
...
let uu____8234 = (desugar_binders env eff_binders)
...
let uu____8254 = (head_and_args defn)
...
let uu____8279 = (match ((FStar_List.rev args)) with
| ((last_arg, uu____8295))::args_rev -> begin
(

let uu____8302 = (unparen last_arg).FStar_Parser_AST.tm
...
let sub = (fun uu____8379 -> (match (uu____8379) with
| (uu____8386, x) -> begin
(

let uu____8390 = (FStar_Syntax_Subst.open_term ed.FStar_Syntax_Syntax.binders x)
...
let uu____8430 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Parser_AST.Reflectable))
...
| FStar_Parser_AST.Fsdoc (uu____8455) -> begin
((env), ([]))
end
...
let tcs = (FStar_List.map (fun uu____8487 -> (match (uu____8487) with
| (x, uu____8492) -> begin
x
end)) tcs)
...
let uu____8548 = (FStar_All.pipe_left FStar_Syntax_Subst.compress ds_lets).FStar_Syntax_Syntax.n
in (match (uu____8548) with
| FStar_Syntax_Syntax.Tm_let (lbs, uu____8552) -> begin
(
...
| (uu____8572)::uu____8573 -> begin
(FStar_List.map (trans_qual None) quals)
end
| uu____8575 -> begin
(FStar_All.pipe_right (Prims.snd lbs) (FStar_List.collect (fun uu___209_8579 -> (match (uu___209_8579) with
| {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (uu____8581); FStar_Syntax_Syntax.lbunivs = uu____8582; FStar_Syntax_Syntax.lbtyp = uu____8583; FStar_Syntax_Syntax.lbeff = uu____8584; FStar_Syntax_Syntax.lbdef = uu____8585} -> begin
[]
end
| {FStar_Syntax_Syntax.lbname = FStar_Util.Inr (fv); FStar_Syntax_Syntax.lbunivs = uu____8592; FStar_Syntax_Syntax.lbtyp = uu____8593; FStar_Syntax_Syntax.lbeff = uu____8594; FStar_Syntax_Syntax.lbdef = uu____8595} -> begin
...
let uu____8607 = (FStar_All.pipe_right lets (FStar_Util.for_some (fun uu____8613 -> (match (uu____8613) with
| (uu____8616, t) -> begin
...
let uu____8624 = (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract))
...
let uu___223_8636 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inr ((

let uu___224_8637 = fv
in {FStar_Syntax_Syntax.fv_name = uu___224_8637.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_abstract (fv.FStar_Syntax_Syntax.fv_delta); FStar_Syntax_Syntax.fv_qual = uu___224_8637.FStar_Syntax_Syntax.fv_qual})); FStar_Syntax_Syntax.lbunivs = uu___223_8636.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___223_8636.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___223_8636.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___223_8636.FStar_Syntax_Syntax.lbdef})))))
...
let uu____8662 = (match (lets) with
| ((pat, body))::[] -> begin
((pat), (body))
end
| uu____8673 -> begin
...
let uu___225_8689 = pat
in {FStar_Parser_AST.pat = FStar_Parser_AST.PatAscribed (((var_pat), (ty))); FStar_Parser_AST.prange = uu___225_8689.FStar_Parser_AST.prange})
end
| uu____8690 -> begin
var_pat
end))
...
let uu___226_8694 = d
in {FStar_Parser_AST.d = FStar_Parser_AST.TopLevelLet (((isrec), ((((fresh_pat), (body)))::[]))); FStar_Parser_AST.drange = uu___226_8694.FStar_Parser_AST.drange; FStar_Parser_AST.doc = uu___226_8694.FStar_Parser_AST.doc; FStar_Parser_AST.quals = (FStar_Parser_AST.Private)::d.FStar_Parser_AST.quals; FStar_Parser_AST.attrs = uu___226_8694.FStar_Parser_AST.attrs}))
in (

let build_projection = (fun uu____8713 id -> (match (uu____8713) with
| (env, ses) -> begin
(
...
let uu____8753 = (desugar_decl env id_decl)
...
let uu____8793 = (FStar_ToSyntax_Env.fail_or env (FStar_ToSyntax_Env.try_lookup_lid env) FStar_Syntax_Const.exn_lid)
...
let uu____8901 = (match (l.FStar_Parser_AST.lift_op) with
...
let desugar_decls : FStar_ToSyntax_Env.env  ->  FStar_Parser_AST.decl Prims.list  ->  (FStar_ToSyntax_Env.env * FStar_Syntax_Syntax.sigelts) = (fun env decls -> (FStar_List.fold_left (fun uu____9007 d -> (match (uu____9007) with
| (env, sigelts) -> begin
(

let uu____9019 = (desugar_decl env d)
...
| (None, uu____9061) -> begin
env
end
| (Some ({FStar_Syntax_Syntax.name = prev_lid; FStar_Syntax_Syntax.declarations = uu____9064; FStar_Syntax_Syntax.exports = uu____9065; FStar_Syntax_Syntax.is_interface = uu____9066}), FStar_Parser_AST.Module (current_lid, uu____9068)) when ((FStar_Ident.lid_equals prev_lid current_lid) && (FStar_Options.interactive ())) -> begin
env
end
| (Some (prev_mod), uu____9073) -> begin
(FStar_ToSyntax_Env.finish_module_or_interface env prev_mod)
end)
in (

let uu____9075 = (match (m) with
...
let uu____9117 = (desugar_decls env decls)
...
let uu____9142 = ((FStar_Options.interactive ()) && (let _0_727 = (FStar_Util.get_file_extension (FStar_List.hd (FStar_Options.file_list ())))
in (_0_727 = "fsti")))
...
| FStar_Parser_AST.Interface (mname, uu____9149, uu____9150) -> begin
...
let uu____9154 = (desugar_modul_common curmod env m)
in (match (uu____9154) with
| (x, y, pop_when_done) -> begin
((match (pop_when_done) with
| true -> begin
(Prims.ignore (FStar_ToSyntax_Env.pop ()))
end
| uu____9164 -> begin
()
end);
...
let uu____9175 = (desugar_modul_common None env m)
...
let uu____9186 = (FStar_Options.dump_module modul.FStar_Syntax_Syntax.name.FStar_Ident.str)
...
let uu____9198 = (FStar_List.fold_left (fun uu____9205 m -> (match (uu____9205) with
| (env, mods) -> begin
(

let uu____9217 = (desugar_modul env m)
...
let uu____9241 = (FStar_ToSyntax_Env.prepare_module_or_interface false false en m.FStar_Syntax_Syntax.name)
...
let uu___227_9247 = en
in {FStar_ToSyntax_Env.curmodule = Some (m.FStar_Syntax_Syntax.name); FStar_ToSyntax_Env.curmonad = uu___227_9247.FStar_ToSyntax_Env.curmonad; FStar_ToSyntax_Env.modules = uu___227_9247.FStar_ToSyntax_Env.modules; FStar_ToSyntax_Env.scope_mods = uu___227_9247.FStar_ToSyntax_Env.scope_mods; FStar_ToSyntax_Env.exported_ids = uu___227_9247.FStar_ToSyntax_Env.exported_ids; FStar_ToSyntax_Env.trans_exported_ids = uu___227_9247.FStar_ToSyntax_Env.trans_exported_ids; FStar_ToSyntax_Env.includes = uu___227_9247.FStar_ToSyntax_Env.includes; FStar_ToSyntax_Env.sigaccum = uu___227_9247.FStar_ToSyntax_Env.sigaccum; FStar_ToSyntax_Env.sigmap = uu___227_9247.FStar_ToSyntax_Env.sigmap; FStar_ToSyntax_Env.iface = uu___227_9247.FStar_ToSyntax_Env.iface; FStar_ToSyntax_Env.admitted_iface = uu___227_9247.FStar_ToSyntax_Env.admitted_iface; FStar_ToSyntax_Env.expect_typ = uu___227_9247.FStar_ToSyntax_Env.expect_typ}) m.FStar_Syntax_Syntax.exports)
in (
