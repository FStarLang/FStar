  ...
  fun env  ->
    fun d  ->
                     ...
                     FStar_All.pipe_right lets1
                       (FStar_Util.for_some
                          (fun uu____18136  ->
                             ...
                             | (uu____18149,(uu____18150,t)) -> is_logic t))
                      in
                   if uu____18105
                            ...
                            (fun lb  ->
                               let fv =
                                 FStar_Util.right
                                   lb.FStar_Syntax_Syntax.lbname
                                  in
                               let uu___134_18197 = lb  in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___135_18199 = fv  in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___135_18199.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___135_18199.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___134_18197.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___134_18197.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___134_18197.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___134_18197.FStar_Syntax_Syntax.lbdef);
                                 FStar_Syntax_Syntax.lbattrs =
                                   (uu___134_18197.FStar_Syntax_Syntax.lbattrs)
                               }))
                        in
                     ((FStar_Pervasives_Native.fst lbs), uu____18183)
                   else lbs  in
                 let names1 =
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___136_18283 = pat1  in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___136_18283.FStar_Parser_AST.prange)
                       }
                   | uu____18284 -> var_pat  in
                 let main_let =
                   desugar_decl env
                     (let uu___137_18291 = d  in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___137_18291.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___137_18291.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___137_18291.FStar_Parser_AST.attrs)
                      })
                    in
                 let build_projection uu____18323 id1 =
                   ...
                   | (env1,ses) ->
                       let main =
                         let uu____18344 =
                           ...
                           FStar_Parser_AST.Var uu____18345  in
                         FStar_Parser_AST.mk_term uu____18344
                       ...
                       let id_decl =
                         FStar_Parser_AST.mk_decl
                          ...
                          in
                       let uu____18395 = desugar_decl env1 id_decl  in
                       (match uu____18395 with
                        | (env2,ses') -> (env2, (FStar_List.append ses ses')))
                    in
                 let bvs =
                   let uu____18413 = gather_pattern_bound_vars pat  in
                   FStar_All.pipe_right uu____18413 FStar_Util.set_elements
                    in
      ...
      | FStar_Parser_AST.Val (id1,t) ->
          let quals = d.FStar_Parser_AST.quals  in
          let t1 =
            let uu____18444 = close_fun env t  in
            desugar_term env uu____18444  in
          let quals1 =
            let uu____18448 =
          ...
          let se =
               ...
               in
            {
              ...
              FStar_Syntax_Syntax.sigrng = (d.FStar_Parser_AST.drange);
              FStar_Syntax_Syntax.sigquals = uu____18454;
              FStar_Syntax_Syntax.sigmeta =
                FStar_Syntax_Syntax.default_sigmeta;
              FStar_Syntax_Syntax.sigattrs = []
            }  in
      ...
      | FStar_Parser_AST.Exception (id1,FStar_Pervasives_Native.Some term) ->
          ...
          let t1 =
            let uu____18514 =
              let uu____18521 = FStar_Syntax_Syntax.null_binder t  in
              [uu____18521]  in
            let uu____18522 =
              let uu____18525 =
                let uu____18526 =
                  FStar_ToSyntax_Env.fail_or env
                    ...
                    FStar_Parser_Const.exn_lid
                   in
                FStar_Pervasives_Native.fst uu____18526  in
              FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total uu____18525
               in
            FStar_Syntax_Util.arrow uu____18514 uu____18522  in
          let l = FStar_ToSyntax_Env.qualify env id1  in
          let qual = [FStar_Syntax_Syntax.ExceptionConstructor]  in
          let se =
            {
      ...
      | FStar_Parser_AST.SubEffect l ->
          let lookup l1 =
            ...
            | FStar_Pervasives_Native.None  ->
                let uu____18591 =
                  let uu____18596 =
                    let uu____18597 =
                      let uu____18598 = FStar_Syntax_Print.lid_to_string l1
                         in
                      Prims.strcat uu____18598 " not found"  in
                    Prims.strcat "Effect name " uu____18597  in
                  (FStar_Errors.Fatal_EffectNotFound, uu____18596)  in
                FStar_Errors.raise_error uu____18591
                  d.FStar_Parser_AST.drange
          ...
          let uu____18602 =
            ...
            | FStar_Parser_AST.NonReifiableLift t ->
                let uu____18644 =
                  let uu____18653 =
                    let uu____18660 = desugar_term env t  in
                    ([], uu____18660)  in
            ...
            | FStar_Parser_AST.ReifiableLift (wp,t) ->
                let uu____18693 =
                  let uu____18702 =
                    let uu____18709 = desugar_term env wp  in
                    ([], uu____18709)  in
                  FStar_Pervasives_Native.Some uu____18702  in
                let uu____18718 =
                  let uu____18727 =
                    let uu____18734 = desugar_term env t  in
                    ([], uu____18734)  in
                  FStar_Pervasives_Native.Some uu____18727  in
                (uu____18693, uu____18718)
            | FStar_Parser_AST.LiftForFree t ->
                let uu____18760 =
                  let uu____18769 =
                    let uu____18776 = desugar_term env t  in
                    ([], uu____18776)  in
                  FStar_Pervasives_Native.Some uu____18769  in
                (FStar_Pervasives_Native.None, uu____18760)
             in
...
let (desugar_decls :
  ...
  fun env  ->
    fun decls  ->
        ...
        FStar_List.fold_left
          (fun uu____18884  ->
             fun d  ->
               ...
               | (env1,sigelts) ->
                   let uu____18904 = desugar_decl env1 d  in
      ...
      | (env1,sigelts) ->
          let rec forward acc uu___110_18945 =
            match uu___110_18945 with
            | se1::se2::sigelts1 ->
                (match ((se1.FStar_Syntax_Syntax.sigel),
                         (se2.FStar_Syntax_Syntax.sigel))
                 with
                 | (FStar_Syntax_Syntax.Sig_declare_typ
                    uu____18959,FStar_Syntax_Syntax.Sig_let uu____18960) ->
                     let uu____18973 =
                       let uu____18976 =
                         let uu___138_18977 = se2  in
                         let uu____18978 =
                           let uu____18981 =
                             FStar_List.filter
                               (fun uu___109_18995  ->
                                  match uu___109_18995 with
                                  | {
                                      FStar_Syntax_Syntax.n =
                                        FStar_Syntax_Syntax.Tm_app
                                        ({
                                           ...
                                           FStar_Syntax_Syntax.pos =
                                             uu____18999;
                                           FStar_Syntax_Syntax.vars =
                                             uu____19000;_},uu____19001);
                                      FStar_Syntax_Syntax.pos = uu____19002;
                                      FStar_Syntax_Syntax.vars = uu____19003;_}
                                      when
                                      let uu____19026 =
                                        let uu____19027 =
                              ...
                              in
                           FStar_List.append uu____18981
                             se2.FStar_Syntax_Syntax.sigattrs
                            in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (uu___138_18977.FStar_Syntax_Syntax.sigel);
                           FStar_Syntax_Syntax.sigrng =
                             (uu___138_18977.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             (uu___138_18977.FStar_Syntax_Syntax.sigquals);
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___138_18977.FStar_Syntax_Syntax.sigmeta);
                           FStar_Syntax_Syntax.sigattrs = uu____18978
                         }  in
                       uu____18976 :: se1 :: acc  in
                     forward uu____18973 sigelts1
  ...
  fun curmod  ->
    fun env  ->
      fun m  ->
        ...
        | (x,y,pop_when_done) ->
            (if pop_when_done
             then (let uu____19276 = FStar_ToSyntax_Env.pop ()  in ())
             else ();
             (x, y))
          ...
          let erase_univs_ed ed =
            ...
            | (binders,uu____19540,binders_opening) ->
                ...
                let erase_action action =
                  ...
                  {
                    FStar_Syntax_Syntax.action_name =
                      (uu___139_19701.FStar_Syntax_Syntax.action_name);
                    FStar_Syntax_Syntax.action_unqualified_name =
                      (uu___139_19701.FStar_Syntax_Syntax.action_unqualified_name);
                    FStar_Syntax_Syntax.action_univs = [];
                    FStar_Syntax_Syntax.action_params = erased_action_params;
                    FStar_Syntax_Syntax.action_defn = uu____19702;
                    FStar_Syntax_Syntax.action_typ = uu____19703
                  }  in
                let uu___140_19704 = ed  in
                ...
                {
                  FStar_Syntax_Syntax.cattributes =
                    (uu___140_19704.FStar_Syntax_Syntax.cattributes);
                  FStar_Syntax_Syntax.mname =
                    (uu___140_19704.FStar_Syntax_Syntax.mname);
                  FStar_Syntax_Syntax.univs = [];
            ...
            | FStar_Syntax_Syntax.Sig_new_effect ed ->
                let se' =
                    ...
                    FStar_Syntax_Syntax.Sig_new_effect uu____19734  in
                  {
                    ...
                    FStar_Syntax_Syntax.sigrng =
                      (uu___141_19732.FStar_Syntax_Syntax.sigrng);
                    FStar_Syntax_Syntax.sigquals =
                      (uu___141_19732.FStar_Syntax_Syntax.sigquals);
                    FStar_Syntax_Syntax.sigmeta =
                      (uu___141_19732.FStar_Syntax_Syntax.sigmeta);
                    FStar_Syntax_Syntax.sigattrs =
                      (uu___141_19732.FStar_Syntax_Syntax.sigattrs)
                  }  in
                let env1 = FStar_ToSyntax_Env.push_sigelt env se'  in
            ...
            | FStar_Syntax_Syntax.Sig_new_effect_for_free ed ->
                let se' =
                     ...
                     in
                  {
                    ...
                    FStar_Syntax_Syntax.sigrng =
                      (uu___142_19738.FStar_Syntax_Syntax.sigrng);
                    FStar_Syntax_Syntax.sigquals =
                      (uu___142_19738.FStar_Syntax_Syntax.sigquals);
                    FStar_Syntax_Syntax.sigmeta =
                      (uu___142_19738.FStar_Syntax_Syntax.sigmeta);
                    FStar_Syntax_Syntax.sigattrs =
                      (uu___142_19738.FStar_Syntax_Syntax.sigattrs)
                  }  in
                let env1 = FStar_ToSyntax_Env.push_sigelt env se'  in
                push_reflect_effect env1 se.FStar_Syntax_Syntax.sigquals
                  ed.FStar_Syntax_Syntax.mname se.FStar_Syntax_Syntax.sigrng
            | uu____19742 -> FStar_ToSyntax_Env.push_sigelt env se  in
          let uu____19743 =
