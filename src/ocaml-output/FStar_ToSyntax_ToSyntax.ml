    ...
    FStar_Util.new_set
      (fun id1  ->
         fun id2  ->
           ...
           else Prims.parse_int "1") (fun uu____713  -> Prims.parse_int "0") in
      ...
      fun uu___203_791  ->
        ...
        | (Some a,k) ->
            ...
            (match uu____804 with
             | (env1,a1) ->
                 (((let uu___224_815 = a1 in
                    {
                      FStar_Syntax_Syntax.ppname =
                        (uu___224_815.FStar_Syntax_Syntax.ppname);
                      FStar_Syntax_Syntax.index =
                        (uu___224_815.FStar_Syntax_Syntax.index);
  ...
  fun t  ->
    ...
    | FStar_Parser_AST.App uu____1158 ->
        let rec aux t1 univargs =
          let uu____1177 =
            let uu____1178 = unparen t1 in uu____1178.FStar_Parser_AST.tm in
        ...
        (let push_bv_maybe_mut =
         ...
         let resolvex l e x =
           ...
           | uu____1550 ->
               ...
               (match uu____1552 with | (e1,x1) -> ((x1 :: l), e1, x1)) in
                    ...
                    let binder1 =
                      ...
                      | LocalBinder (x,aq) ->
                          ...
                          (if
                           ...
                           LocalBinder
                             (((let uu___225_1783 = x in
                                {
                                  FStar_Syntax_Syntax.ppname =
                                    (uu___225_1783.FStar_Syntax_Syntax.ppname);
                                  FStar_Syntax_Syntax.index =
                                    (uu___225_1783.FStar_Syntax_Syntax.index);
                               ...
                               let uu____2133 =
                                 let uu____2141 =
                                   FStar_Syntax_Syntax.lid_as_fv
                                     ...
                                     FStar_Syntax_Syntax.Delta_constant
                                     (Some FStar_Syntax_Syntax.Data_ctor) in
                                 (uu____2141, [(hd1, false); (tl1, false)]) in
                              ...
                              let uu____2474 =
                                  ...
                                  Some uu____2478 in
                                {
                                  FStar_Syntax_Syntax.fv_name =
                                    (uu___226_2475.FStar_Syntax_Syntax.fv_name);
                                  FStar_Syntax_Syntax.fv_delta =
                                    (uu___226_2475.FStar_Syntax_Syntax.fv_delta);
      ...
      fun uu____2630  ->
        fun range  ->
          ...
          | (signedness,width) ->
              ...
              let lid2 =
                let uu____2641 = FStar_ToSyntax_Env.try_lookup_lid env lid1 in
  ...
  fun top_level  ->
    fun env  ->
      fun top  ->
        ...
        let setpos e =
          let uu___227_2807 = e in
          {
            FStar_Syntax_Syntax.n = (uu___227_2807.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.tk = (uu___227_2807.FStar_Syntax_Syntax.tk);
            FStar_Syntax_Syntax.pos = (top.FStar_Parser_AST.range);
            FStar_Syntax_Syntax.vars =
              (uu___227_2807.FStar_Syntax_Syntax.vars)
          } in
        let uu____2814 =
        ...
        | FStar_Parser_AST.Op (op_star,uu____2848::uu____2849::[]) when
            ...
            let uu____2876 =
              ...
              FStar_ToSyntax_Env.fail_or env
                (FStar_ToSyntax_Env.try_lookup_lid env) uu____2879 in
        ...
        | FStar_Parser_AST.Projector (l,i) ->
            (FStar_ToSyntax_Env.fail_if_qualified_by_curmodule env l;
             (let name =
                let uu____2999 = FStar_ToSyntax_Env.try_lookup_datacon env l in
        ...
        | FStar_Parser_AST.Discrim lid ->
            (FStar_ToSyntax_Env.fail_if_qualified_by_curmodule env lid;
             (let uu____3035 = FStar_ToSyntax_Env.try_lookup_datacon env lid in
        ...
        | FStar_Parser_AST.Construct (l,args) ->
            (FStar_ToSyntax_Env.fail_if_qualified_by_curmodule env l;
             (let uu____3054 = FStar_ToSyntax_Env.try_lookup_datacon env l in
              match uu____3054 with
              | Some head1 ->
                  let uu____3057 =
                    let uu____3062 = mk1 (FStar_Syntax_Syntax.Tm_fvar head1) in
                    (uu____3062, true) in
                               ...
                               | (env2,x) ->
                                   ...
                                   (env2,
                                     (FStar_List.append tparams
                                        [(((let uu___228_3264 = x in
                                            {
                                              FStar_Syntax_Syntax.ppname =
                                                (uu___228_3264.FStar_Syntax_Syntax.ppname);
                                              FStar_Syntax_Syntax.index =
                                                (uu___228_3264.FStar_Syntax_Syntax.index);
                                              FStar_Syntax_Syntax.sort = t1
                                            })), None)]), uu____3246))))
                (env, [], [])
            ...
            (match uu____3165 with
             | (env1,uu____3277,targs) ->
                 let uu____3289 =
                   ...
                   FStar_ToSyntax_Env.fail_or env1
                     (FStar_ToSyntax_Env.try_lookup_lid env1) uu____3292 in
        ...
        | FStar_Parser_AST.Product (binders,t) ->
            ...
            (match uu____3307 with
             | (bs,t1) ->
                 let rec aux env1 bs1 uu___208_3330 =
                   match uu___208_3330 with
                   | [] ->
                       let cod =
        ...
        | FStar_Parser_AST.Abs (binders,body) ->
                     ...
                     | (env1,ftvs) ->
                         (match pat.FStar_Parser_AST.pat with
                          | FStar_Parser_AST.PatAscribed (uu____3423,t) ->
                              ...
                              (env1, uu____3425)
                          | uu____3430 -> (env1, ftvs))) (env, []) binders1 in
            (match uu____3401 with
             | (uu____3433,ftv) ->
                 ...
                 let rec aux env1 bs sc_pat_opt uu___209_3470 =
                   match uu___209_3470 with
                   | [] ->
        ...
        | FStar_Parser_AST.App
            ...
            let rec aux universes e =
              let uu____3887 =
                let uu____3888 = unparen e in uu____3888.FStar_Parser_AST.tm in
        ...
        | FStar_Parser_AST.App uu____3897 ->
            let rec aux args e =
              let uu____3918 =
                let uu____3919 = unparen e in uu____3919.FStar_Parser_AST.tm in
        ...
        | FStar_Parser_AST.Let (qual1,(pat,_snd)::_tl,body) ->
            ...
            let ds_let_rec_or_app uu____3994 =
              ...
              | (env',fnames,rec_bindings) ->
                        ...
                        let def1 =
                          ...
                          | Some t ->
                                      ...
                                      FStar_All.pipe_right args1
                                        (FStar_List.tryFind
                                           (fun x  ->
                                              let uu____4486 =
                                                is_var_pattern x in
                                              Prims.op_Negation uu____4486)) in
                              ...
                              FStar_Parser_AST.mk_term
                                ...
                                uu____4495 FStar_Parser_AST.Expr in
                        let def2 =
                          match args1 with
                          | [] -> def1
                          | uu____4498 ->
                  ...
                  FStar_All.pipe_left mk1 uu____4529 in
                    ...
                    | LocalBinder (x,uu____4594) ->
                        ...
                        let body2 =
                          ...
                          | Some pat3 ->
                              ...
                              uu____4603 None body1.FStar_Syntax_Syntax.pos in
                        let uu____4641 =
                          let uu____4642 =
                            let uu____4650 =
                              let uu____4651 =
                        ...
                        FStar_All.pipe_left mk1 uu____4641 in
                  if is_mutable
                  then
                    FStar_All.pipe_left mk1
                      (FStar_Syntax_Syntax.Tm_meta
        ...
        | FStar_Parser_AST.Ascribed (e,t,tac_opt) ->
            let annot =
              ...
              if uu____4893
              then
                let uu____4898 = desugar_comp t.FStar_Parser_AST.range env t in
                FStar_Util.Inr uu____4898
              else
                (let uu____4904 = desugar_term env t in
                 FStar_Util.Inl uu____4904) in
                           ...
                           (fun uu____5042  ->
                              ...
                              | (f,uu____5048) ->
                                  let uu____5049 =
                                    ...
                                    FStar_All.pipe_left Prims.snd uu____5050 in
                                  (uu____5049, FStar_Parser_AST.Nothing))) in
                        ...
                        FStar_All.pipe_right record.FStar_ToSyntax_Env.fields
                          (FStar_List.map
                             (fun uu____5085  ->
                                ...
                                | (f,uu____5091) -> get_field (Some xterm) f)) in
                      (None, uu____5071) in
                     ...
                     let uu____5136 =
                       let uu____5146 =
                         ...
                         FStar_Syntax_Syntax.fvar
                           ...
                           FStar_Syntax_Syntax.Delta_constant uu____5147 in
                       (uu____5146, args) in
    ...
    fun env  ->
      fun t  ->
        ...
        let is_ensures uu____5303 =
          ...
          | (t1,uu____5307) ->
              let uu____5308 =
                let uu____5309 = unparen t1 in uu____5309.FStar_Parser_AST.tm in
        ...
        let is_app head1 uu____5323 =
          ...
          | (t1,uu____5327) ->
              let uu____5328 =
                let uu____5329 = unparen t1 in uu____5329.FStar_Parser_AST.tm in
        ...
        let is_smt_pat uu____5341 =
          ...
          | (t1,uu____5345) ->
              let uu____5346 =
                let uu____5347 = unparen t1 in uu____5347.FStar_Parser_AST.tm in
          ...
          | (head1,args) ->
              (match head1.FStar_Parser_AST.tm with
               ...
               | FStar_Parser_AST.Name l when
                   ...
                   (uu____5608, args)
               | FStar_Parser_AST.Name l when
                   (let uu____5622 = FStar_ToSyntax_Env.current_module env in
               ...
               | FStar_Parser_AST.Name l when
                   (let uu____5631 = FStar_ToSyntax_Env.current_module env in
...
and desugar_formula:
  ...
  fun env  ->
    fun f  ->
      ...
      let setpos t =
        let uu___229_6189 = t in
        {
          FStar_Syntax_Syntax.n = (uu___229_6189.FStar_Syntax_Syntax.n);
          FStar_Syntax_Syntax.tk = (uu___229_6189.FStar_Syntax_Syntax.tk);
          FStar_Syntax_Syntax.pos = (f.FStar_Parser_AST.range);
          FStar_Syntax_Syntax.vars = (uu___229_6189.FStar_Syntax_Syntax.vars)
        } in
      let desugar_quant q b pats body =
        let tk =
          desugar_binder env
            (let uu___230_6219 = b in
             {
               FStar_Parser_AST.b = (uu___230_6219.FStar_Parser_AST.b);
               FStar_Parser_AST.brange =
                 (uu___230_6219.FStar_Parser_AST.brange);
               FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
               FStar_Parser_AST.aqual =
                 (uu___230_6219.FStar_Parser_AST.aqual)
             }) in
        ...
        | (Some a,k) ->
            ...
            (match uu____6261 with
             | (env1,a1) ->
                 let a2 =
                   let uu___231_6269 = a1 in
                   {
                     FStar_Syntax_Syntax.ppname =
                       (uu___231_6269.FStar_Syntax_Syntax.ppname);
                     FStar_Syntax_Syntax.index =
                       (uu___231_6269.FStar_Syntax_Syntax.index);
                     FStar_Syntax_Syntax.sort = k
                   } in
          ...
          (fun uu____6473  ->
             fun b  ->
               ...
               | (env1,out) ->
                   let tk =
                     desugar_binder env1
                       (let uu___232_6501 = b in
                        {
                          FStar_Parser_AST.b =
                            (uu___232_6501.FStar_Parser_AST.b);
                          FStar_Parser_AST.brange =
                            (uu___232_6501.FStar_Parser_AST.brange);
                          FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
                          FStar_Parser_AST.aqual =
                            (uu___232_6501.FStar_Parser_AST.aqual)
                        }) in
                   (match tk with
                    | (Some a,k) ->
                        let uu____6511 = FStar_ToSyntax_Env.push_bv env1 a in
                        (match uu____6511 with
                         | (env2,a1) ->
                             let a2 =
                               let uu___233_6523 = a1 in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___233_6523.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___233_6523.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = k
                               } in
                             (env2,
                                 ...
                                 let quals q =
                                   ...
                                   then
                                     let uu____6733 =
                                       FStar_List.filter
                                         (fun uu___211_6735  ->
                                            match uu___211_6735 with
                                            | FStar_Syntax_Syntax.Abstract 
                                                -> false
                                            | uu____6736 -> true) q in
           ...
           (match uu____6831 with
            | (formals,uu____6841) ->
                (match formals with
                 | [] -> []
                 | uu____6855 ->
                     let filter_records uu___213_6863 =
                       match uu___213_6863 with
    ...
    fun d  ->
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___214_6994 =
            match uu___214_6994 with
          ...
          let apply_binders t binders =
            ...
            FStar_List.fold_left
              ...
              binders in
          let tycon_record_as_variant uu___215_7071 =
            match uu___215_7071 with
          ...
          let desugar_abstract_tc quals1 _env mutuals uu___216_7184 =
            match uu___216_7184 with
                           ...
                           | uu____7430 ->
                               let uu____7431 =
                                 let uu____7434 =
                                   ...
                                   FStar_Syntax_Syntax.Tm_arrow uu____7435 in
                                 FStar_Syntax_Syntax.mk uu____7434 in
                               uu____7431 None se.FStar_Syntax_Syntax.sigrng in
                         let uu___234_7452 = se in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ
                                (l, [], t, quals2));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___234_7452.FStar_Syntax_Syntax.sigrng)
                         }
                   ...
                   let k =
                     ...
                     | None  ->
                         let uu____7488 =
                           FStar_Util.for_some
                             (fun uu___217_7489  ->
                                match uu___217_7489 with
                                | FStar_Syntax_Syntax.Effect  -> true
                                | uu____7490 -> false) quals in
                         if uu____7488
                     ...
                     then
                       ...
                       | (t1,cattributes) ->
                           ...
                           let uu____7607 =
                             ...
                             FStar_Syntax_Syntax.Sig_effect_abbrev uu____7608 in
                           {
                              ...
                              let uu____7913 =
                                let uu____7915 =
                                  let uu____7916 =
                                    ...
                                    (uu____7921, fs) in
                                  FStar_Syntax_Syntax.RecordType uu____7916 in
                     ...
                     FStar_All.pipe_right docs_tps_sigelts
                       (FStar_List.map
                          (fun uu____9048  ->
                             ...
                             | (name_doc,uu____9063,uu____9064) -> name_doc)) in
                   let sigelts =
                     FStar_All.pipe_right docs_tps_sigelts
                       (FStar_List.map
                          (fun uu____9103  ->
                             match uu____9103 with
                             | (uu____9114,uu____9115,se) -> se)) in
                   let uu____9131 =
                     let uu____9135 =
                       FStar_List.collect FStar_Syntax_Util.lids_of_sigelt
                         sigelts in
                     FStar_Syntax_MutRecTy.disentangle_abbrevs_from_bundle
                       sigelts quals uu____9135 rng in
                              ...
                              let se =
                                ...
                                then
                                  ...
                                  (let rr =
                                     FStar_Util.for_some
                                       (fun uu___222_9681  ->
                                          match uu___222_9681 with
                                          | FStar_Syntax_Syntax.Reifiable 
                                            |FStar_Syntax_Syntax.Reflectable
                                            _ -> true
                                          | uu____9683 -> false) qualifiers in
                                   let un_ts = ([], FStar_Syntax_Syntax.tun) in
                                   let uu____9689 =
                                     let uu____9690 =
                                       let uu____9691 = lookup "return_wp" in
                                       let uu____9692 = lookup "bind_wp" in
                                       let uu____9693 = lookup "if_then_else" in
                      ...
                      | (head1,args) ->
                                      ...
                                      let uu____9813 =
                                        let uu____9814 =
                                          FStar_Parser_AST.term_to_string
                                            head1 in
                                        Prims.strcat uu____9814 " not found" in
                                      Prims.strcat "Effect " uu____9813 in
                                    (uu____9812, (d.FStar_Parser_AST.drange)) in
                                  FStar_Errors.Error uu____9809 in
                                Prims.raise uu____9808 in
                          let ed =
                            FStar_ToSyntax_Env.fail_or env2
                          ...
                          (match uu____9816 with
                           | (cattributes,args1) ->
                               ...
                               (lid, ed, uu____9887, uu____9892)) in
    ...
    fun d  ->
      ...
      | FStar_Parser_AST.Tycon (is_effect,tcs) ->
          ...
          let tcs1 =
            FStar_List.map
              (fun uu____10108  ->
                 match uu____10108 with | (x,uu____10113) -> x) tcs in
                       ...
                       FStar_All.pipe_right (Prims.snd lbs)
                         (FStar_List.map
                            (fun lb  ->
                               ...
                               let uu___235_10263 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___236_10264 = fv in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___236_10264.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___236_10264.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___235_10263.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___235_10263.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___235_10263.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___235_10263.FStar_Syntax_Syntax.lbdef)
                               })) in
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___237_10323 = pat1 in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___237_10323.FStar_Parser_AST.prange)
                       }
                   | uu____10324 -> var_pat in
                 let main_let =
                   desugar_decl env
                     (let uu___238_10328 = d in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___238_10328.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___238_10328.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___238_10328.FStar_Parser_AST.attrs)
                      }) in
                 ...
                 let bvs =
                   ...
                   FStar_All.pipe_right uu____10400 FStar_Util.set_elements in
      ...
      | FStar_Parser_AST.Val (id,t) ->
          let quals = d.FStar_Parser_AST.quals in
          let t1 =
            let uu____10422 = close_fun env t in desugar_term env uu____10422 in
          let quals1 =
            let uu____10425 =
          ...
          let se =
            let uu____10430 =
              let uu____10431 =
                let uu____10437 = FStar_List.map (trans_qual1 None) quals1 in
      ...
      | FStar_Parser_AST.Exception (id,Some term) ->
          ...
          let t1 =
            ...
            let uu____10487 =
              ...
              FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total uu____10490 in
      ...
      | FStar_Parser_AST.SubEffect l ->
            ...
            | None  ->
                let uu____10540 =
                  let uu____10541 =
                    let uu____10544 =
                      let uu____10545 =
                        let uu____10546 = FStar_Syntax_Print.lid_to_string l1 in
          ...
          let uu____10550 =
            ...
            | FStar_Parser_AST.NonReifiableLift t ->
                let uu____10572 =
                  let uu____10577 =
                    let uu____10581 = desugar_term env t in ([], uu____10581) in
                  Some uu____10577 in
                (uu____10572, None)
            | FStar_Parser_AST.ReifiableLift (wp,t) ->
                ...
                let uu____10613 =
                  let uu____10618 =
                    let uu____10622 = desugar_term env t in ([], uu____10622) in
                  Some uu____10618 in
                (uu____10599, uu____10613)
            | FStar_Parser_AST.LiftForFree t ->
                let uu____10636 =
                  let uu____10641 =
                    let uu____10645 = desugar_term env t in ([], uu____10645) in
                  Some uu____10641 in
                (None, uu____10636) in
          ...
          | FStar_Parser_AST.Module (mname,decls) ->
              let uu____10794 =
                FStar_ToSyntax_Env.prepare_module_or_interface false false
                  env1 mname in
              (uu____10794, mname, decls, false) in
