                            ...
                            | FStar_Syntax_Syntax.Tm_fvar fv ->
                                ...
                                let private_fv =
                                  ...
                                  FStar_Syntax_Syntax.lid_as_fv private_lid
                                    uu____2946 fv.FStar_Syntax_Syntax.fv_qual
                                   in
      ...
      fun top  ->
              ...
              FStar_All.pipe_right uu____3178
                (FStar_List.map
                   (fun t  ->
                      ...
                      FStar_Syntax_Syntax.as_arg uu____3184))
               in
            let uu____3185 =
              let uu____3188 =
                FStar_Syntax_Util.mk_tuple_lid (FStar_List.length targs)
                 ...
                 in
              FStar_ToSyntax_Env.fail_or env
                (FStar_ToSyntax_Env.try_lookup_lid env) uu____3188
               in
                 ...
                 let uu____3663 =
                   let uu____3666 =
                     FStar_Syntax_Util.mk_dtuple_lid
                      ...
                      in
                   FStar_ToSyntax_Env.fail_or env1
                     (FStar_ToSyntax_Env.try_lookup_lid env1) uu____3666
                    in
                     ...
                     | (env1,ftvs) ->
                         (match pat.FStar_Parser_AST.pat with
                          | FStar_Parser_AST.PatAscribed (uu____3797,t) ->
                              ...
                              (env1, uu____3799)
                          | uu____3804 -> (env1, ftvs))) (env, []) binders1
               in
        ...
        | FStar_Parser_AST.App
            ...
            let rec aux universes e =
              let uu____4268 =
                let uu____4269 = unparen e  in uu____4269.FStar_Parser_AST.tm
                 in
        ...
        | FStar_Parser_AST.App uu____4278 ->
            let rec aux args e =
              let uu____4299 =
                let uu____4300 = unparen e  in uu____4300.FStar_Parser_AST.tm
                 in
                        ...
                        let def1 =
                          ...
                          | Some t ->
                              ...
                              FStar_Parser_AST.mk_term
                                ...
                                uu____4887 FStar_Parser_AST.Expr
                           in
                        let def2 =
                          match args1 with
                          | [] -> def1
                    ...
                    | LocalBinder (x,uu____4986) ->
                        ...
                        let body2 =
                          ...
                          | uu____4996 ->
                              ...
                              uu____4998 None body1.FStar_Syntax_Syntax.pos
                           in
                        let uu____5032 =
                          let uu____5033 =
                            let uu____5041 =
                        ...
                        FStar_All.pipe_left mk1 uu____5032
                     in
                  if is_mutable
                  then
                    FStar_All.pipe_left mk1
        ...
        | FStar_Parser_AST.Match (e,branches) ->
            ...
            let uu____5279 =
              let uu____5280 =
                ...
                let uu____5297 = FStar_List.collect desugar_branch branches
                   in
        ...
        | FStar_Parser_AST.Ascribed (e,t,tac_opt) ->
            let annot =
              ...
              if uu____5316
              then
                let uu____5321 = desugar_comp t.FStar_Parser_AST.range env t
                   in
                              ...
                              | (f,uu____5471) ->
                                  let uu____5472 =
                                    ...
                                    FStar_All.pipe_left FStar_Pervasives.snd
                                      uu____5473
                                     in
                                  (uu____5472, FStar_Parser_AST.Nothing)))
                       in
                        ...
                        FStar_All.pipe_right record.FStar_ToSyntax_Env.fields
                          (FStar_List.map
                             (fun uu____5508  ->
                                ...
                                | (f,uu____5514) -> get_field (Some xterm) f))
                         in
                      (None, uu____5494)  in
                     ...
                     let uu____5559 =
                       let uu____5569 =
                         ...
                         FStar_Syntax_Syntax.fvar
                           ...
                           FStar_Syntax_Syntax.Delta_constant uu____5570
                          in
                       (uu____5569, args)  in
    ...
    fun env  ->
      fun t  ->
        ...
        let is_requires uu____5710 =
          ...
          | (t1,uu____5714) ->
              let uu____5715 =
                let uu____5716 = unparen t1  in
                uu____5716.FStar_Parser_AST.tm  in
        ...
        let is_ensures uu____5727 =
          ...
          | (t1,uu____5731) ->
              let uu____5732 =
                let uu____5733 = unparen t1  in
                uu____5733.FStar_Parser_AST.tm  in
        ...
        let is_app head1 uu____5747 =
          ...
          | (t1,uu____5751) ->
              let uu____5752 =
                let uu____5753 = unparen t1  in
                uu____5753.FStar_Parser_AST.tm  in
        ...
        let is_smt_pat uu____5765 =
          ...
          | (t1,uu____5769) ->
              let uu____5770 =
                let uu____5771 = unparen t1  in
                uu____5771.FStar_Parser_AST.tm  in
          ...
          | (head1,args) ->
              (match head1.FStar_Parser_AST.tm with
               ...
               | FStar_Parser_AST.Name l when
                   ...
                   (uu____6050, args)
               | FStar_Parser_AST.Name l when
                   (let uu____6064 = FStar_ToSyntax_Env.current_module env
                       in
               ...
               | FStar_Parser_AST.Name l when
                   (let uu____6073 = FStar_ToSyntax_Env.current_module env
                       in
          ...
          (fun uu____6902  ->
             fun b  ->
               ...
               | (env1,out) ->
                   ...
                   (match tk with
                    | (Some a,k) ->
                        let uu____6940 = FStar_ToSyntax_Env.push_bv env1 a
                           in
                           ...
                           | uu____7831 ->
                               let uu____7832 =
                                 let uu____7835 =
                                   ...
                                   FStar_Syntax_Syntax.Tm_arrow uu____7836
                                    in
                                 FStar_Syntax_Syntax.mk uu____7835  in
                               uu____7832 None se.FStar_Syntax_Syntax.sigrng
                            in
                              ...
                              let uu____8302 =
                                let uu____8304 =
                                  let uu____8305 =
                                    ...
                                    (uu____8310, fs)  in
                                  FStar_Syntax_Syntax.RecordType uu____8305
                                   in
                                  ...
                                  | (env_tps,tps) ->
                                      ...
                                      (match uu____9099 with
                                       | (constrNames,constrs1) ->
                                           ...
                                           :: constrs1))
                             | uu____9368 -> failwith "impossible"))
                      in
                   let name_docs =
                     FStar_All.pipe_right docs_tps_sigelts
                       (FStar_List.map
                          (fun uu____9433  ->
                             ...
                             | (name_doc,uu____9448,uu____9449) -> name_doc))
                      in
                   let sigelts =
                     FStar_All.pipe_right docs_tps_sigelts
                       (FStar_List.map
              ...
              let uu____10861 =
                let uu____10862 =
                  FStar_ToSyntax_Env.fail_or env
                   ...
                   in
                fst uu____10862  in
              FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total uu____10861
               in
      ...
      | FStar_Parser_AST.SubEffect l ->
            ...
            | None  ->
                let uu____10908 =
                  let uu____10909 =
                    let uu____10912 =
                      let uu____10913 =
                        let uu____10914 = FStar_Syntax_Print.lid_to_string l1
                           in
          ...
          let uu____10918 =
            ...
            | FStar_Parser_AST.NonReifiableLift t ->
                let uu____10940 =
                  let uu____10945 =
                    let uu____10949 = desugar_term env t  in
                    ([], uu____10949)  in
                  Some uu____10945  in
                (uu____10940, None)
            ...
            | FStar_Parser_AST.LiftForFree t ->
                let uu____11004 =
                  let uu____11009 =
                    let uu____11013 = desugar_term env t  in
                    ([], uu____11013)  in
                  Some uu____11009  in
                (None, uu____11004)
             in
