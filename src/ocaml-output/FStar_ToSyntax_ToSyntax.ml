...
| FStar_Parser_AST.Tycon (uu____9502, ((FStar_Parser_AST.TyconAbbrev (name, action_params, uu____9505, {FStar_Parser_AST.tm = FStar_Parser_AST.Construct (uu____9506, ((def, uu____9508))::((cps_type, uu____9510))::[]); FStar_Parser_AST.range = uu____9511; FStar_Parser_AST.level = uu____9512}), doc1))::[]) when (not (for_free)) -> begin
(

let uu____9539 = (desugar_binders env2 action_params)
...
in (FStar_Syntax_Subst.close (FStar_List.append binders1 action_params2) uu____9554))
in (

let uu____9557 = (

let uu____9558 = (desugar_typ env3 cps_type)
in (FStar_Syntax_Subst.close (FStar_List.append binders1 action_params2) uu____9558))
in {FStar_Syntax_Syntax.action_name = uu____9552; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_params = action_params2; FStar_Syntax_Syntax.action_defn = uu____9553; FStar_Syntax_Syntax.action_typ = uu____9557})))
in ((uu____9551), (doc1))))
end))
end
| FStar_Parser_AST.Tycon (uu____9562, ((FStar_Parser_AST.TyconAbbrev (name, action_params, uu____9565, defn), doc1))::[]) when for_free -> begin
(

let uu____9584 = (desugar_binders env2 action_params)
...
in (FStar_Syntax_Subst.close (FStar_List.append binders1 action_params2) uu____9599))
in {FStar_Syntax_Syntax.action_name = uu____9597; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_params = action_params2; FStar_Syntax_Syntax.action_defn = uu____9598; FStar_Syntax_Syntax.action_typ = FStar_Syntax_Syntax.tun}))
in ((uu____9596), (doc1))))
end))
end
| uu____9603 -> begin
