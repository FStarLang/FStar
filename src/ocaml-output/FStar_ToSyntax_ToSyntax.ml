          ...
          | (FStar_Pervasives_Native.Some prev_mod,uu____19134) ->
              let uu____19137 =
                FStar_ToSyntax_Env.finish_module_or_interface env prev_mod
                 in
              FStar_Pervasives_Native.fst uu____19137
           in
        let uu____19142 =
          match m with
          | FStar_Parser_AST.Interface (mname,decls,admitted) ->
              let uu____19178 =
                FStar_ToSyntax_Env.prepare_module_or_interface true admitted
                 ...
                 in
              (uu____19178, mname, decls, true)
          | FStar_Parser_AST.Module (mname,decls) ->
              let uu____19195 =
                FStar_ToSyntax_Env.prepare_module_or_interface false false
                  env1 mname FStar_ToSyntax_Env.default_mii
                 in
              (uu____19195, mname, decls, false)
           in
        match uu____19142 with
        | ((env2,pop_when_done),mname,decls,intf) ->
            let uu____19225 = desugar_decls env2 decls  in
        ...
        let m1 =
          let uu____19279 =
            (FStar_Options.interactive ()) &&
              (let uu____19281 =
                 let uu____19282 =
                   let uu____19283 = FStar_Options.file_list ()  in
                   FStar_List.hd uu____19283  in
                 FStar_Util.get_file_extension uu____19282  in
               FStar_List.mem uu____19281 ["fsti"; "fsi"])
             in
          if uu____19279 then as_interface m else m  in
        let uu____19287 = desugar_modul_common curmod env m1  in
        match uu____19287 with
        | (x,y,pop_when_done) ->
            (if pop_when_done
             then (let uu____19302 = FStar_ToSyntax_Env.pop ()  in ())
             else ();
             (x, y))
...
let (ast_modul_to_modul :
  ...
  fun modul  ->
    fun env  ->
      let uu____19361 = desugar_modul env modul  in
...
let (decls_to_sigelts :
  ...
  fun decls  ->
    fun env  ->
      let uu____19388 = desugar_decls env decls  in
      match uu____19388 with | (env1,sigelts) -> (sigelts, env1)
...
let (partial_ast_modul_to_modul :
  ...
  fun modul  ->
    fun a_modul  ->
      fun env  ->
        let uu____19426 = desugar_partial_modul modul env a_modul  in
        match uu____19426 with | (env1,modul1) -> (modul1, env1)
        ...
        fun en  ->
          let erase_univs_ed ed =
            let erase_binders bs =
              ...
              | uu____19500 ->
                  ...
                  let uu____19517 =
                    let uu____19518 = FStar_Syntax_Subst.compress t  in
                    uu____19518.FStar_Syntax_Syntax.n  in
                  (match uu____19517 with
                   | FStar_Syntax_Syntax.Tm_abs (bs1,uu____19528,uu____19529)
                       -> bs1
                   | uu____19550 -> failwith "Impossible")
               in
            let uu____19557 =
              let uu____19564 = erase_binders ed.FStar_Syntax_Syntax.binders
                 in
              FStar_Syntax_Subst.open_term' uu____19564
                FStar_Syntax_Syntax.t_unit
               in
            match uu____19557 with
            | (binders,uu____19566,binders_opening) ->
                let erase_term t =
                  let uu____19572 =
                    let uu____19573 =
                      FStar_Syntax_Subst.subst binders_opening t  in
                    erase_univs uu____19573  in
                  FStar_Syntax_Subst.close binders uu____19572  in
                let erase_tscheme uu____19589 =
                      ...
                      let t1 =
                        let uu____19609 =
                          FStar_Syntax_Subst.shift_subst
                           ...
                           in
                        FStar_Syntax_Subst.subst uu____19609 t  in
                      let uu____19612 =
                        let uu____19613 = erase_univs t1  in
                        FStar_Syntax_Subst.close binders uu____19613  in
                      ([], uu____19612)
                   in
                let erase_action action =
                    ...
                    | uu____19642 ->
                        let bs =
                          let uu____19650 =
                            FStar_Syntax_Subst.subst_binders opening
                              action.FStar_Syntax_Syntax.action_params
                             in
                          FStar_All.pipe_left erase_binders uu____19650  in
                        let t =
                          FStar_Syntax_Syntax.mk
                            (FStar_Syntax_Syntax.Tm_abs
                               (bs, FStar_Syntax_Syntax.t_unit,
                        ...
                        let uu____19680 =
                          let uu____19681 =
                            ...
                            FStar_Syntax_Subst.compress uu____19684  in
                          uu____19681.FStar_Syntax_Syntax.n  in
                        (match uu____19680 with
                         | FStar_Syntax_Syntax.Tm_abs
                             (bs1,uu____19692,uu____19693) -> bs1
                         | uu____19714 -> failwith "Impossible")
                     in
                  let erase_term1 t =
                    let uu____19725 =
                      let uu____19726 = FStar_Syntax_Subst.subst opening t
                         in
                      erase_univs uu____19726  in
                    FStar_Syntax_Subst.close binders uu____19725  in
                  let uu___139_19727 = action  in
                  let uu____19728 =
                  ...
                  {
                    FStar_Syntax_Syntax.action_name =
                      (uu___139_19727.FStar_Syntax_Syntax.action_name);
                    FStar_Syntax_Syntax.action_unqualified_name =
                      (uu___139_19727.FStar_Syntax_Syntax.action_unqualified_name);
                    FStar_Syntax_Syntax.action_univs = [];
                    FStar_Syntax_Syntax.action_params = erased_action_params;
                    FStar_Syntax_Syntax.action_defn = uu____19728;
                    FStar_Syntax_Syntax.action_typ = uu____19729
                  }  in
                let uu___140_19730 = ed  in
                let uu____19731 = FStar_Syntax_Subst.close_binders binders
                   in
                let uu____19732 = erase_term ed.FStar_Syntax_Syntax.signature
                   in
                let uu____19733 = erase_tscheme ed.FStar_Syntax_Syntax.ret_wp
                   in
                let uu____19734 =
                  erase_tscheme ed.FStar_Syntax_Syntax.bind_wp  in
                let uu____19735 =
                  erase_tscheme ed.FStar_Syntax_Syntax.if_then_else  in
                let uu____19736 = erase_tscheme ed.FStar_Syntax_Syntax.ite_wp
                   in
                let uu____19737 =
                ...
                let uu____19743 = erase_term ed.FStar_Syntax_Syntax.repr  in
                let uu____19744 =
                ...
                {
                  FStar_Syntax_Syntax.cattributes =
                    (uu___140_19730.FStar_Syntax_Syntax.cattributes);
                  FStar_Syntax_Syntax.mname =
                    (uu___140_19730.FStar_Syntax_Syntax.mname);
                  FStar_Syntax_Syntax.univs = [];
                  FStar_Syntax_Syntax.binders = uu____19731;
                  FStar_Syntax_Syntax.signature = uu____19732;
                  FStar_Syntax_Syntax.ret_wp = uu____19733;
                  FStar_Syntax_Syntax.bind_wp = uu____19734;
                  FStar_Syntax_Syntax.if_then_else = uu____19735;
                  FStar_Syntax_Syntax.ite_wp = uu____19736;
                  FStar_Syntax_Syntax.stronger = uu____19737;
                  FStar_Syntax_Syntax.close_wp = uu____19738;
                  FStar_Syntax_Syntax.assert_p = uu____19739;
                  FStar_Syntax_Syntax.assume_p = uu____19740;
                  FStar_Syntax_Syntax.null_wp = uu____19741;
                  FStar_Syntax_Syntax.trivial = uu____19742;
                  FStar_Syntax_Syntax.repr = uu____19743;
                  FStar_Syntax_Syntax.return_repr = uu____19744;
                  FStar_Syntax_Syntax.bind_repr = uu____19745;
                  FStar_Syntax_Syntax.actions = uu____19746
                }
             in
          let push_sigelt1 env se =
            ...
            | FStar_Syntax_Syntax.Sig_new_effect ed ->
                let se' =
                  let uu___141_19758 = se  in
                  let uu____19759 =
                    let uu____19760 = erase_univs_ed ed  in
                    FStar_Syntax_Syntax.Sig_new_effect uu____19760  in
                  {
                    FStar_Syntax_Syntax.sigel = uu____19759;
                    FStar_Syntax_Syntax.sigrng =
                      (uu___141_19758.FStar_Syntax_Syntax.sigrng);
                    FStar_Syntax_Syntax.sigquals =
                      (uu___141_19758.FStar_Syntax_Syntax.sigquals);
                    FStar_Syntax_Syntax.sigmeta =
                      (uu___141_19758.FStar_Syntax_Syntax.sigmeta);
                    FStar_Syntax_Syntax.sigattrs =
                      (uu___141_19758.FStar_Syntax_Syntax.sigattrs)
                  }  in
                let env1 = FStar_ToSyntax_Env.push_sigelt env se'  in
            ...
            | FStar_Syntax_Syntax.Sig_new_effect_for_free ed ->
                let se' =
                  let uu___142_19764 = se  in
                  let uu____19765 =
                    let uu____19766 = erase_univs_ed ed  in
                    FStar_Syntax_Syntax.Sig_new_effect_for_free uu____19766
                     in
                  {
                    FStar_Syntax_Syntax.sigel = uu____19765;
                    FStar_Syntax_Syntax.sigrng =
                      (uu___142_19764.FStar_Syntax_Syntax.sigrng);
                    FStar_Syntax_Syntax.sigquals =
                      (uu___142_19764.FStar_Syntax_Syntax.sigquals);
                    FStar_Syntax_Syntax.sigmeta =
                      (uu___142_19764.FStar_Syntax_Syntax.sigmeta);
                    FStar_Syntax_Syntax.sigattrs =
                      (uu___142_19764.FStar_Syntax_Syntax.sigattrs)
                  }  in
                let env1 = FStar_ToSyntax_Env.push_sigelt env se'  in
                push_reflect_effect env1 se.FStar_Syntax_Syntax.sigquals
                  ed.FStar_Syntax_Syntax.mname se.FStar_Syntax_Syntax.sigrng
            | uu____19768 -> FStar_ToSyntax_Env.push_sigelt env se  in
          let uu____19769 =
              ...
              let en2 =
                let uu____19781 =
                  FStar_ToSyntax_Env.set_current_module en1
                   ...
                   in
                FStar_List.fold_left push_sigelt1 uu____19781
