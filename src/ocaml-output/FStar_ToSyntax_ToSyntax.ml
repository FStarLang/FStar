...
let uu____9103 = (desugar_decls env decls)
...
let uu____9128 = ((FStar_Options.interactive ()) && (let _0_727 = (FStar_Util.get_file_extension (FStar_List.hd (FStar_Options.file_list ())))
in (_0_727 = "fsti")))
...
| FStar_Parser_AST.Interface (mname, uu____9135, uu____9136) -> begin
...
let uu____9140 = (desugar_modul_common curmod env m)
in (match (uu____9140) with
| (x, y, uu____9148) -> begin
((x), (y))
end))))
...
let uu____9159 = (desugar_modul_common None env m)
...
let uu____9170 = (FStar_Options.dump_module modul.FStar_Syntax_Syntax.name.FStar_Ident.str)
...
let uu____9182 = (FStar_List.fold_left (fun uu____9189 m -> (match (uu____9189) with
| (env, mods) -> begin
(

let uu____9201 = (desugar_modul env m)
...
let uu____9225 = (FStar_ToSyntax_Env.prepare_module_or_interface false false en m.FStar_Syntax_Syntax.name)
...
let uu___227_9231 = en
in {FStar_ToSyntax_Env.curmodule = Some (m.FStar_Syntax_Syntax.name); FStar_ToSyntax_Env.curmonad = uu___227_9231.FStar_ToSyntax_Env.curmonad; FStar_ToSyntax_Env.modules = uu___227_9231.FStar_ToSyntax_Env.modules; FStar_ToSyntax_Env.scope_mods = uu___227_9231.FStar_ToSyntax_Env.scope_mods; FStar_ToSyntax_Env.exported_ids = uu___227_9231.FStar_ToSyntax_Env.exported_ids; FStar_ToSyntax_Env.trans_exported_ids = uu___227_9231.FStar_ToSyntax_Env.trans_exported_ids; FStar_ToSyntax_Env.includes = uu___227_9231.FStar_ToSyntax_Env.includes; FStar_ToSyntax_Env.sigaccum = uu___227_9231.FStar_ToSyntax_Env.sigaccum; FStar_ToSyntax_Env.sigmap = uu___227_9231.FStar_ToSyntax_Env.sigmap; FStar_ToSyntax_Env.iface = uu___227_9231.FStar_ToSyntax_Env.iface; FStar_ToSyntax_Env.admitted_iface = uu___227_9231.FStar_ToSyntax_Env.admitted_iface; FStar_ToSyntax_Env.expect_typ = uu___227_9231.FStar_ToSyntax_Env.expect_typ}) m.FStar_Syntax_Syntax.exports)
in (
