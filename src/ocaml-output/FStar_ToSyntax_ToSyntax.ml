  ...
  fun top_level  ->
    fun env  ->
      fun top  ->
        ...
        let setpos e =
          let uu___229_2808 = e in
          {
            FStar_Syntax_Syntax.n = (uu___229_2808.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.tk = (uu___229_2808.FStar_Syntax_Syntax.tk);
            FStar_Syntax_Syntax.pos = (top.FStar_Parser_AST.range);
            FStar_Syntax_Syntax.vars =
              (uu___229_2808.FStar_Syntax_Syntax.vars)
          } in
        let uu____2815 =
                               ...
                               | (env2,x) ->
                                   ...
                                   (env2,
                                     (FStar_List.append tparams
                                        [(((let uu___230_3265 = x in
                                            {
                                              FStar_Syntax_Syntax.ppname =
                                                (uu___230_3265.FStar_Syntax_Syntax.ppname);
                                              FStar_Syntax_Syntax.index =
                                                (uu___230_3265.FStar_Syntax_Syntax.index);
                                              FStar_Syntax_Syntax.sort = t1
                                            })), None)]), uu____3247))))
                (env, [], [])
        ...
        | FStar_Parser_AST.Product (binders,t) ->
            ...
            (match uu____3308 with
             | (bs,t1) ->
                 let rec aux env1 bs1 uu___210_3331 =
                   match uu___210_3331 with
                   | [] ->
                       let cod =
        ...
        | FStar_Parser_AST.Abs (binders,body) ->
            ...
            (match uu____3402 with
             | (uu____3434,ftv) ->
                 ...
                 let rec aux env1 bs sc_pat_opt uu___211_3471 =
                   match uu___211_3471 with
                   | [] ->
...
and desugar_formula:
  ...
  fun env  ->
    fun f  ->
      ...
      let setpos t =
        let uu___231_6228 = t in
        {
          FStar_Syntax_Syntax.n = (uu___231_6228.FStar_Syntax_Syntax.n);
          FStar_Syntax_Syntax.tk = (uu___231_6228.FStar_Syntax_Syntax.tk);
          FStar_Syntax_Syntax.pos = (f.FStar_Parser_AST.range);
          FStar_Syntax_Syntax.vars = (uu___231_6228.FStar_Syntax_Syntax.vars)
        } in
      let desugar_quant q b pats body =
        let tk =
          desugar_binder env
            (let uu___232_6258 = b in
             {
               FStar_Parser_AST.b = (uu___232_6258.FStar_Parser_AST.b);
               FStar_Parser_AST.brange =
                 (uu___232_6258.FStar_Parser_AST.brange);
               FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
               FStar_Parser_AST.aqual =
                 (uu___232_6258.FStar_Parser_AST.aqual)
             }) in
        ...
        | (Some a,k) ->
            ...
            (match uu____6300 with
             | (env1,a1) ->
                 let a2 =
                   let uu___233_6308 = a1 in
                   {
                     FStar_Syntax_Syntax.ppname =
                       (uu___233_6308.FStar_Syntax_Syntax.ppname);
                     FStar_Syntax_Syntax.index =
                       (uu___233_6308.FStar_Syntax_Syntax.index);
                     FStar_Syntax_Syntax.sort = k
                   } in
          ...
          (fun uu____6512  ->
             fun b  ->
               ...
               | (env1,out) ->
                   let tk =
                     desugar_binder env1
                       (let uu___234_6540 = b in
                        {
                          FStar_Parser_AST.b =
                            (uu___234_6540.FStar_Parser_AST.b);
                          FStar_Parser_AST.brange =
                            (uu___234_6540.FStar_Parser_AST.brange);
                          FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
                          FStar_Parser_AST.aqual =
                            (uu___234_6540.FStar_Parser_AST.aqual)
                        }) in
                   (match tk with
                    | (Some a,k) ->
                        ...
                        (match uu____6550 with
                         | (env2,a1) ->
                             let a2 =
                               let uu___235_6562 = a1 in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___235_6562.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___235_6562.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = k
                               } in
                             (env2,
           ...
           (match uu____6855 with
            | (formals,uu____6865) ->
                (match formals with
                 | [] -> []
                 | uu____6879 ->
                     let filter_records uu___215_6887 =
                       match uu___215_6887 with
    ...
    fun d  ->
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___216_7017 =
            match uu___216_7017 with
          ...
          let apply_binders t binders =
            ...
            FStar_List.fold_left
              ...
              binders in
          let tycon_record_as_variant uu___217_7094 =
            match uu___217_7094 with
          ...
          let desugar_abstract_tc quals1 _env mutuals uu___218_7207 =
            match uu___218_7207 with
               ...
               | (uu____7426,uu____7427,se,uu____7429) ->
                   let se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         ...
                         let uu___236_7473 = se in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ (l, [], t));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___236_7473.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals = quals2;
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___236_7473.FStar_Syntax_Syntax.sigmeta)
                         }
                       ...
                       FStar_All.pipe_right (Prims.snd lbs)
                         (FStar_List.map
                            (fun lb  ->
                               ...
                               let uu___237_10269 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___238_10270 = fv in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___238_10270.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___238_10270.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___237_10269.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___237_10269.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___237_10269.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___237_10269.FStar_Syntax_Syntax.lbdef)
                               })) in
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___239_10328 = pat1 in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___239_10328.FStar_Parser_AST.prange)
                       }
                   | uu____10329 -> var_pat in
                 let main_let =
                   desugar_decl env
                     (let uu___240_10333 = d in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___240_10333.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___240_10333.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___240_10333.FStar_Parser_AST.attrs)
                      }) in
