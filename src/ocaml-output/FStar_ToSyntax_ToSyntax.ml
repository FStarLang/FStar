...
let uu____6302 = (FStar_Syntax_Syntax.fvar lid (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) FStar_Pervasives_Native.None)
in ((uu____6302), (noaqs))))
end
| FStar_Pervasives_Native.None -> begin
(
...
in (FStar_Syntax_Syntax.fvar uu____13725 (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) FStar_Pervasives_Native.None))
in (
