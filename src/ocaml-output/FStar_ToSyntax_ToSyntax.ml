          ...
          | FStar_Parser_AST.Interface (mname,decls,admitted) ->
              let uu____19098 =
                FStar_ToSyntax_Env.prepare_module_or_interface true admitted
                 ...
                 in
              (uu____19098, mname, decls, true)
          | FStar_Parser_AST.Module (mname,decls) ->
              let uu____19115 =
                FStar_ToSyntax_Env.prepare_module_or_interface false false
                  env1 mname FStar_ToSyntax_Env.default_mii
                 in
              (uu____19115, mname, decls, false)
           in
        match uu____19062 with
        | ((env2,pop_when_done),mname,decls,intf) ->
            let uu____19145 = desugar_decls env2 decls  in
        ...
        let m1 =
          let uu____19199 =
            (FStar_Options.interactive ()) &&
              (let uu____19201 =
                 let uu____19202 =
                   let uu____19203 = FStar_Options.file_list ()  in
                   FStar_List.hd uu____19203  in
                 FStar_Util.get_file_extension uu____19202  in
               FStar_List.mem uu____19201 ["fsti"; "fsi"])
             in
          if uu____19199 then as_interface m else m  in
        let uu____19207 = desugar_modul_common curmod env m1  in
        match uu____19207 with
        | (x,y,pop_when_done) ->
            (if pop_when_done
             then (let uu____19222 = FStar_ToSyntax_Env.pop ()  in ())
             else ();
             (x, y))
    ...
    fun m  ->
      ...
      | (env1,modul,pop_when_done) ->
          ...
          ((let uu____19254 =
            ...
            if uu____19254
            then
              let uu____19255 = FStar_Syntax_Print.modul_to_string modul  in
              FStar_Util.print1 "%s\n" uu____19255
            else ());
           (let uu____19257 =
              if pop_when_done
...
let (ast_modul_to_modul :
  ...
  fun modul  ->
    fun env  ->
      let uu____19271 = desugar_modul env modul  in
      match uu____19271 with | (env1,modul1) -> (modul1, env1)
...
let (decls_to_sigelts :
  ...
  fun decls  ->
    fun env  ->
      let uu____19298 = desugar_decls env decls  in
      match uu____19298 with | (env1,sigelts) -> (sigelts, env1)
...
let (partial_ast_modul_to_modul :
  ...
  fun modul  ->
    fun a_modul  ->
      fun env  ->
        let uu____19336 = desugar_partial_modul modul env a_modul  in
        match uu____19336 with | (env1,modul1) -> (modul1, env1)
        ...
        fun en  ->
                  ...
                  let t =
                    let uu____19418 =
                      FStar_Syntax_Syntax.mk
                       ...
                       in
                    erase_univs uu____19418  in
                  let uu____19427 =
                    let uu____19428 = FStar_Syntax_Subst.compress t  in
                    uu____19428.FStar_Syntax_Syntax.n  in
                  (match uu____19427 with
                   | FStar_Syntax_Syntax.Tm_abs (bs1,uu____19438,uu____19439)
                       -> bs1
                   | uu____19460 -> failwith "Impossible")
               in
            let uu____19467 =
              let uu____19474 = erase_binders ed.FStar_Syntax_Syntax.binders
                 in
              FStar_Syntax_Subst.open_term' uu____19474
                FStar_Syntax_Syntax.t_unit
               in
            match uu____19467 with
            | (binders,uu____19476,binders_opening) ->
                let erase_term t =
                  let uu____19482 =
                    let uu____19483 =
                      FStar_Syntax_Subst.subst binders_opening t  in
                    erase_univs uu____19483  in
                  FStar_Syntax_Subst.close binders uu____19482  in
                let erase_tscheme uu____19499 =
                      ...
                      let t1 =
                        let uu____19519 =
                          FStar_Syntax_Subst.shift_subst
                           ...
                           in
                        FStar_Syntax_Subst.subst uu____19519 t  in
                      let uu____19522 =
                        let uu____19523 = erase_univs t1  in
                        FStar_Syntax_Subst.close binders uu____19523  in
                      ([], uu____19522)
                   in
                let erase_action action =
                    ...
                    | uu____19552 ->
                        let bs =
                          let uu____19560 =
                            FStar_Syntax_Subst.subst_binders opening
                              action.FStar_Syntax_Syntax.action_params
                             in
                          FStar_All.pipe_left erase_binders uu____19560  in
                        let t =
                          FStar_Syntax_Syntax.mk
                            (FStar_Syntax_Syntax.Tm_abs
                               (bs, FStar_Syntax_Syntax.t_unit,
                        ...
                        let uu____19590 =
                          let uu____19591 =
                            ...
                            FStar_Syntax_Subst.compress uu____19594  in
                          uu____19591.FStar_Syntax_Syntax.n  in
                        (match uu____19590 with
                         | FStar_Syntax_Syntax.Tm_abs
                             (bs1,uu____19602,uu____19603) -> bs1
                         | uu____19624 -> failwith "Impossible")
                     in
                  let erase_term1 t =
                    let uu____19635 =
                      let uu____19636 = FStar_Syntax_Subst.subst opening t
                         in
                      erase_univs uu____19636  in
                    FStar_Syntax_Subst.close binders uu____19635  in
                  let uu___139_19637 = action  in
                  let uu____19638 =
                  ...
                  {
                    FStar_Syntax_Syntax.action_name =
                      (uu___139_19637.FStar_Syntax_Syntax.action_name);
                    FStar_Syntax_Syntax.action_unqualified_name =
                      (uu___139_19637.FStar_Syntax_Syntax.action_unqualified_name);
                    FStar_Syntax_Syntax.action_univs = [];
                    FStar_Syntax_Syntax.action_params = erased_action_params;
                    FStar_Syntax_Syntax.action_defn = uu____19638;
                    FStar_Syntax_Syntax.action_typ = uu____19639
                  }  in
                let uu___140_19640 = ed  in
                let uu____19641 = FStar_Syntax_Subst.close_binders binders
                   in
                let uu____19642 = erase_term ed.FStar_Syntax_Syntax.signature
                   in
                let uu____19643 = erase_tscheme ed.FStar_Syntax_Syntax.ret_wp
                   in
                let uu____19644 =
                  erase_tscheme ed.FStar_Syntax_Syntax.bind_wp  in
                let uu____19645 =
                  erase_tscheme ed.FStar_Syntax_Syntax.if_then_else  in
                let uu____19646 = erase_tscheme ed.FStar_Syntax_Syntax.ite_wp
                   in
                let uu____19647 =
                ...
                let uu____19653 = erase_term ed.FStar_Syntax_Syntax.repr  in
                let uu____19654 =
                ...
                {
                  FStar_Syntax_Syntax.cattributes =
                    (uu___140_19640.FStar_Syntax_Syntax.cattributes);
                  FStar_Syntax_Syntax.mname =
                    (uu___140_19640.FStar_Syntax_Syntax.mname);
                  FStar_Syntax_Syntax.univs = [];
                  FStar_Syntax_Syntax.binders = uu____19641;
                  FStar_Syntax_Syntax.signature = uu____19642;
                  FStar_Syntax_Syntax.ret_wp = uu____19643;
                  FStar_Syntax_Syntax.bind_wp = uu____19644;
                  FStar_Syntax_Syntax.if_then_else = uu____19645;
                  FStar_Syntax_Syntax.ite_wp = uu____19646;
                  FStar_Syntax_Syntax.stronger = uu____19647;
                  FStar_Syntax_Syntax.close_wp = uu____19648;
                  FStar_Syntax_Syntax.assert_p = uu____19649;
                  FStar_Syntax_Syntax.assume_p = uu____19650;
                  FStar_Syntax_Syntax.null_wp = uu____19651;
                  FStar_Syntax_Syntax.trivial = uu____19652;
                  FStar_Syntax_Syntax.repr = uu____19653;
                  FStar_Syntax_Syntax.return_repr = uu____19654;
                  FStar_Syntax_Syntax.bind_repr = uu____19655;
                  FStar_Syntax_Syntax.actions = uu____19656
                }
             in
          let push_sigelt1 env se =
            ...
            | FStar_Syntax_Syntax.Sig_new_effect ed ->
                let se' =
                  let uu___141_19668 = se  in
                  let uu____19669 =
                    let uu____19670 = erase_univs_ed ed  in
                    FStar_Syntax_Syntax.Sig_new_effect uu____19670  in
                  {
                    FStar_Syntax_Syntax.sigel = uu____19669;
                    FStar_Syntax_Syntax.sigrng =
                      (uu___141_19668.FStar_Syntax_Syntax.sigrng);
                    FStar_Syntax_Syntax.sigquals =
                      (uu___141_19668.FStar_Syntax_Syntax.sigquals);
                    FStar_Syntax_Syntax.sigmeta =
                      (uu___141_19668.FStar_Syntax_Syntax.sigmeta);
                    FStar_Syntax_Syntax.sigattrs =
                      (uu___141_19668.FStar_Syntax_Syntax.sigattrs)
                  }  in
                let env1 = FStar_ToSyntax_Env.push_sigelt env se'  in
            ...
            | FStar_Syntax_Syntax.Sig_new_effect_for_free ed ->
                let se' =
                  let uu___142_19674 = se  in
                  let uu____19675 =
                    let uu____19676 = erase_univs_ed ed  in
                    FStar_Syntax_Syntax.Sig_new_effect_for_free uu____19676
                     in
                  {
                    FStar_Syntax_Syntax.sigel = uu____19675;
                    FStar_Syntax_Syntax.sigrng =
                      (uu___142_19674.FStar_Syntax_Syntax.sigrng);
                    FStar_Syntax_Syntax.sigquals =
                      (uu___142_19674.FStar_Syntax_Syntax.sigquals);
                    FStar_Syntax_Syntax.sigmeta =
                      (uu___142_19674.FStar_Syntax_Syntax.sigmeta);
                    FStar_Syntax_Syntax.sigattrs =
                      (uu___142_19674.FStar_Syntax_Syntax.sigattrs)
                  }  in
                let env1 = FStar_ToSyntax_Env.push_sigelt env se'  in
                push_reflect_effect env1 se.FStar_Syntax_Syntax.sigquals
                  ed.FStar_Syntax_Syntax.mname se.FStar_Syntax_Syntax.sigrng
            | uu____19678 -> FStar_ToSyntax_Env.push_sigelt env se  in
          let uu____19679 =
              ...
              let en2 =
                let uu____19691 =
                  FStar_ToSyntax_Env.set_current_module en1
                   ...
                   in
                FStar_List.fold_left push_sigelt1 uu____19691
