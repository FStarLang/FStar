        ...
        (let push_bv_maybe_mut =
         ...
         let aux_maybe_or env1 p1 =
           ...
           | FStar_Parser_AST.PatOr (p2::ps) ->
               let uu____2599 = aux loc env1 p2 in
               (match uu____2599 with
                | (loc1,env2,var,p3,uu____2617) ->
                    let uu____2622 =
                      FStar_List.fold_left
                        (fun uu____2635  ->
                           fun p4  ->
                             ...
                             | (loc2,env3,ps1) ->
                                 let uu____2658 = aux loc2 env3 p4 in
                                 (match uu____2658 with
                                  | (loc3,env4,uu____2674,p5,uu____2676) ->
                                      (loc3, env4, (p5 :: ps1))))
                        (loc1, env2, []) ps in
      ...
      fun p  ->
        fun is_mut  ->
          let mklet x =
            let uu____2792 =
              let uu____2793 =
                let uu____2796 = FStar_ToSyntax_Env.qualify env x in
                (uu____2796, FStar_Syntax_Syntax.tun) in
              LetBinder uu____2793 in
            (env, uu____2792, []) in
          if top
          then
            match p.FStar_Parser_AST.pat with
                ...
                let uu____2807 =
                  let uu____2808 =
                    let uu____2811 =
                      FStar_Parser_AST.compile_op (Prims.parse_int "0")
                        x.FStar_Ident.idText in
                    (uu____2811, (x.FStar_Ident.idRange)) in
                  FStar_Ident.mk_ident uu____2808 in
                mklet uu____2807
            | FStar_Parser_AST.PatVar (x,uu____2813) -> mklet x
            | FStar_Parser_AST.PatAscribed
                ({
                   FStar_Parser_AST.pat = FStar_Parser_AST.PatVar
                     (x,uu____2817);
                   FStar_Parser_AST.prange = uu____2818;_},t)
                ->
                let uu____2822 =
                  let uu____2823 =
                    let uu____2826 = FStar_ToSyntax_Env.qualify env x in
                    let uu____2827 = desugar_term env t in
                    (uu____2826, uu____2827) in
                  LetBinder uu____2823 in
                (env, uu____2822, [])
            | uu____2829 ->
                raise
                  (FStar_Errors.Error
            ...
            (let uu____2835 = desugar_data_pat env p is_mut in
                 ...
                 let p2 =
                   ...
                   | {
                       FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var
                         uu____2852;
                       FStar_Syntax_Syntax.ty = uu____2853;
                       FStar_Syntax_Syntax.p = uu____2854;_}::[] -> []
                   | {
                       FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild
                         uu____2859;
                       FStar_Syntax_Syntax.ty = uu____2860;
                       FStar_Syntax_Syntax.p = uu____2861;_}::[] -> []
                   | uu____2866 -> p1 in
                 (env1, binder, p2))
...
and desugar_match_pat_maybe_top:
  ...
  fun uu____2871  ->
    fun env  ->
      fun pat  ->
        let uu____2874 = desugar_data_pat env pat false in
        match uu____2874 with | (env1,uu____2883,pat1) -> (env1, pat1)
    ...
    fun repr  ->
      fun uu____2898  ->
        fun range  ->
          ...
          | (signedness,width) ->
              let uu____2906 = FStar_Const.bounds signedness width in
              (match uu____2906 with
               | (lower,upper) ->
                   let value =
                     let uu____2914 = FStar_Util.ensure_decimal repr in
                     FStar_Util.int_of_string uu____2914 in
                   let tnm =
                     Prims.strcat "FStar."
                       (Prims.strcat
                   ...
                   ((let uu____2917 =
                       (let uu____2918 = FStar_Options.lax () in
                        Prims.op_Negation uu____2918) &&
                         (Prims.op_Negation
                    ...
                    (let private_intro_nm =
                     ...
                     let lid1 =
                       ...
                       | FStar_Pervasives_Native.Some (intro_term,uu____2938)
                           ->
                     ...
                     uu____2976 FStar_Pervasives_Native.None range)))
and desugar_name:
  (FStar_Syntax_Syntax.term' -> FStar_Syntax_Syntax.term) ->
      ...
      fun top  ->
        ...
        | FStar_Parser_AST.Tvar a ->
            let uu____3198 =
              ...
              FStar_Pervasives_Native.fst uu____3201 in
        ...
        | FStar_Parser_AST.Projector (l,i) ->
            (FStar_ToSyntax_Env.fail_if_qualified_by_curmodule env l;
             (let name =
                ...
                | FStar_Pervasives_Native.Some uu____3315 ->
                ...
                | FStar_Pervasives_Native.None  ->
                    ...
                    (match uu____3318 with
                     ...
                     | uu____3326 -> FStar_Pervasives_Native.None) in
              match name with
        ...
        | FStar_Parser_AST.Refine (b,f) ->
            ...
            (match uu____3678 with
             | (FStar_Pervasives_Native.None ,uu____3682) ->
                  ...
                  let tm =
                    ...
                    | LetBinder (l,t) ->
                        ...
                        let fv =
                          ...
                          FStar_Syntax_Syntax.lid_as_fv l uu____4915
                            FStar_Pervasives_Native.None in
                        FStar_All.pipe_left mk1
              ...
              let uu____5012 =
                ...
                let uu____5049 =
                  let uu____5059 =
                    ...
                    (uu____5068, FStar_Pervasives_Native.None, uu____5071) in
                  let uu____5079 =
                    let uu____5089 =
                      let uu____5098 =
                        FStar_Syntax_Syntax.withinfo
                      ...
                      (uu____5098, FStar_Pervasives_Native.None, uu____5101) in
                    [uu____5089] in
                   ...
                   | (env1,pat1) ->
                       let wopt1 =
                         ...
                         | FStar_Pervasives_Native.Some e1 ->
                             ...
                             FStar_Pervasives_Native.Some uu____5214 in
        ...
        | FStar_Parser_AST.Ascribed (e,t,tac_opt) ->
            ...
            let uu____5269 =
              let uu____5270 =
                ...
                (uu____5288, (annot, tac_opt1), FStar_Pervasives_Native.None) in
        ...
        | FStar_Parser_AST.Record (eopt,fields) ->
            ...
            let get_field xopt f =
              ...
              match found with
              | FStar_Pervasives_Native.Some (uu____5364,e) -> (fn, e)
              | FStar_Pervasives_Native.None  ->
                  (match xopt with
                   | FStar_Pervasives_Native.None  ->
                       let uu____5372 =
                                  ...
                                  let uu____5409 =
                                    let uu____5410 =
                                      get_field FStar_Pervasives_Native.None
                                        f in
                                    FStar_All.pipe_left
                                      FStar_Pervasives_Native.snd uu____5410 in
              ...
              | FStar_Pervasives_Native.Some e ->
                  ...
                  let record1 =
                    let uu____5424 =
                      ...
                      (FStar_Pervasives_Native.None, uu____5431) in
                     ...
                     let uu____5496 =
                       let uu____5506 =
                         let uu____5507 =
                           ...
                           FStar_Pervasives_Native.Some uu____5509 in
                         FStar_Syntax_Syntax.fvar
  ...
  fun env  ->
    fun b  ->
      ...
      | FStar_Parser_AST.TAnnotated (x,t) ->
          let uu____6931 = desugar_typ env t in
          ((FStar_Pervasives_Native.Some x), uu____6931)
      | FStar_Parser_AST.Annotated (x,t) ->
          let uu____6935 = desugar_typ env t in
          ((FStar_Pervasives_Native.Some x), uu____6935)
      | FStar_Parser_AST.TVariable x ->
          let uu____6938 =
            (FStar_Syntax_Syntax.mk
               (FStar_Syntax_Syntax.Tm_type FStar_Syntax_Syntax.U_unknown))
              FStar_Pervasives_Native.None x.FStar_Ident.idRange in
          ((FStar_Pervasives_Native.Some x), uu____6938)
      | FStar_Parser_AST.NoName t ->
          let uu____6953 = desugar_typ env t in
                 ...
                 (match formals with
                  ...
                  | uu____7152 ->
                      let filter_records uu___211_7160 =
                        ...
                        | uu____7169 -> FStar_Pervasives_Native.None in
                      let fv_qual =
                        let uu____7171 =
                ...
                ((FStar_Parser_AST.TyconVariant
                    (id, parms, kopt,
                      [(constrName, (FStar_Pervasives_Native.Some constrTyp),
                         FStar_Pervasives_Native.None, false)])), uu____7439)
                    ...
                    let for_free =
                      let uu____9689 =
                        let uu____9690 =
                          ...
                          FStar_Pervasives_Native.fst uu____9694 in
                     ...
                     | (ed_lid,ed,args,cattributes) ->
                         ...
                         let ed1 =
                           ...
                           let uu____10276 =
                             ...
                             FStar_Pervasives_Native.snd uu____10277 in
                           let uu____10283 =
                             ...
                             FStar_List.map
                               (fun action  ->
                                  ...
                                  let uu____10289 =
                                    ...
                                    FStar_Pervasives_Native.snd uu____10290 in
                                  let uu____10296 =
                                    let uu____10297 =
                                      sub1
                                        ([],
                           ...
                           let for_free =
                             let uu____10305 =
                               let uu____10306 =
                                 ...
                                 FStar_Pervasives_Native.fst uu____10310 in
             ...
             | FStar_Syntax_Syntax.Tm_let (lbs,uu____10483) ->
                 ...
                 let lbs1 =
                   ...
                   then
                     ...
                     ((FStar_Pervasives_Native.fst lbs), uu____10560)
                   else lbs in
                 let names =
              ...
              let uu____10781 =
                let uu____10782 =
                  FStar_ToSyntax_Env.fail_or env
                    (FStar_ToSyntax_Env.try_lookup_lid env)
                    FStar_Parser_Const.exn_lid in
                FStar_Pervasives_Native.fst uu____10782 in
      ...
      | FStar_Parser_AST.SubEffect l ->
          ...
          let uu____10838 =
            ...
            | FStar_Parser_AST.NonReifiableLift t ->
                ...
                (uu____10860, FStar_Pervasives_Native.None)
            | FStar_Parser_AST.ReifiableLift (wp,t) ->
                let uu____10887 =
                  let uu____10892 =
                    let uu____10896 = desugar_term env wp in
                    ([], uu____10896) in
                  FStar_Pervasives_Native.Some uu____10892 in
                let uu____10901 =
                  let uu____10906 =
            ...
            | FStar_Parser_AST.LiftForFree t ->
                let uu____10924 =
                  ...
                  FStar_Pervasives_Native.Some uu____10929 in
                (FStar_Pervasives_Native.None, uu____10924) in
  ...
  fun curmod  ->
    fun env  ->
      fun m  ->
        let env1 =
          match (curmod, m) with
          | (FStar_Pervasives_Native.None ,uu____11038) -> env
          | (FStar_Pervasives_Native.Some
             ...
             (current_lid,uu____11045)) when
              ...
              -> env
          | (FStar_Pervasives_Native.Some prev_mod,uu____11050) ->
