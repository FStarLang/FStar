...
| T (a, (t, env')) -> begin
(let _102_112 = (let _102_111 = (let _102_110 = (let _102_109 = (subst_of_env' env')
in (FStar_Absyn_Util.subst_typ _102_109 t))
in (a, _102_110))
in FStar_Util.Inl (_102_111))
in (_102_112)::acc)
end
| V (x, (v, env')) -> begin
(let _102_116 = (let _102_115 = (let _102_114 = (let _102_113 = (subst_of_env' env')
in (FStar_Absyn_Util.subst_exp _102_113 v))
in (x, _102_114))
in FStar_Util.Inr (_102_115))
in (_102_116)::acc)
end)) []))
...
let rec eta_expand = (fun tcenv t -> (let k = (let _102_126 = (FStar_Tc_Recheck.recompute_kind t)
in (FStar_All.pipe_right _102_126 FStar_Absyn_Util.compress_kind))
...
(match ((let _102_131 = (FStar_Absyn_Util.unascribe_typ t)
in _102_131.FStar_Absyn_Syntax.n)) with
...
(let _102_139 = (let _102_138 = (let _102_136 = (FStar_Tc_Env.get_range tcenv)
in (FStar_All.pipe_right _102_136 FStar_Range.string_of_range))
in (let _102_137 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format2 "%s: Impossible: Kind_unknown: %s" _102_138 _102_137)))
in (FStar_All.failwith _102_139))
end))
in (aux t k))))
...
let rec eta_expand_exp = (fun tcenv e -> (let t = (let _102_146 = (FStar_Tc_Recheck.recompute_typ e)
in (FStar_All.pipe_right _102_146 FStar_Absyn_Util.compress_typ))
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_fun (bs, c) -> begin
(match ((let _102_147 = (FStar_Absyn_Util.compress_exp e)
in _102_147.FStar_Absyn_Syntax.n)) with
...
| (bs, args) -> begin
(let _102_149 = (let _102_148 = (FStar_Absyn_Syntax.mk_Exp_app (e, args) None e.FStar_Absyn_Syntax.pos)
in (bs, _102_148))
in (FStar_Absyn_Syntax.mk_Exp_abs _102_149 (Some (t)) e.FStar_Absyn_Syntax.pos))
end))
end)
end
| _33_184 -> begin
...
in (let _102_154 = (no_eta c.steps)
in {code = _33_191.code; environment = _33_191.environment; stack = _33_191.stack; close = _33_191.close; steps = _102_154})))
...
(let _102_166 = (let _102_165 = (FStar_Absyn_Util.freshen_bvar b)
in FStar_Util.Inl (_102_165))
in (_102_166, imp))
end
| (FStar_Util.Inr (b), imp) -> begin
(let _102_168 = (let _102_167 = (FStar_Absyn_Util.freshen_bvar b)
in FStar_Util.Inr (_102_167))
in (_102_168, imp))
end)) binders)
in (let subst = (let _102_170 = (let _102_169 = (FStar_Absyn_Util.args_of_binders binders')
in (FStar_All.pipe_right _102_169 Prims.snd))
in (FStar_Absyn_Util.subst_of_list binders _102_170))
in (let cdef = (FStar_Absyn_Util.subst_comp subst cdef)
in (let subst = (let _102_172 = (let _102_171 = (FStar_Absyn_Syntax.targ c.FStar_Absyn_Syntax.result_typ)
in (_102_171)::c.FStar_Absyn_Syntax.effect_args)
in (FStar_Absyn_Util.subst_of_list binders' _102_172))
...
let rec is_head_symbol = (fun t -> (match ((let _102_203 = (FStar_Absyn_Util.compress_typ t)
in _102_203.FStar_Absyn_Syntax.n)) with
...
(match ((let _102_218 = (FStar_Absyn_Util.compress_typ t)
in _102_218.FStar_Absyn_Syntax.n)) with
...
(let _102_256 = (let _102_255 = (let _102_254 = (sn tcenv (t_config t env s'))
in _102_254.code)
in (FStar_All.pipe_left (fun _102_253 -> FStar_Util.Inl (_102_253)) _102_255))
in (_102_256, imp))
end
| ((FStar_Util.Inr (v), imp), env) -> begin
(let _102_260 = (let _102_259 = (let _102_258 = (wne tcenv (e_config v env s'))
in _102_258.code)
in (FStar_All.pipe_left (fun _102_257 -> FStar_Util.Inr (_102_257)) _102_259))
in (_102_260, imp))
end))))
...
| true -> begin
(let _33_487 = config
in (let _102_262 = (eta_expand tcenv t)
in {code = _102_262; environment = _33_487.environment; stack = _33_487.stack; close = _33_487.close; steps = _33_487.steps}))
end
| false -> begin
(let _33_489 = config
...
in (let _102_275 = (FStar_Absyn_Util.compress_typ cfg.code)
in {code = _102_275; environment = _33_506.environment; stack = _33_506.stack; close = _33_506.close; steps = _33_506.steps}))
...
in (let t2_cfg = (let _102_288 = (let _102_287 = (no_eta config.steps)
in {code = t2; environment = environment; stack = empty_stack; close = None; steps = _102_287})
in (sn_delay tcenv _102_288))
in (let _33_564 = t2_cfg
in (let _102_289 = (mk_lam t2_cfg.code)
in {code = _102_289; environment = _33_564.environment; stack = _33_564.stack; close = _33_564.close; steps = _33_564.steps}))))
end))
end
| args -> begin
...
| _33_622 -> begin
(let _102_300 = (let _102_299 = (let _102_296 = (FStar_All.pipe_left FStar_Absyn_Syntax.argpos (Prims.fst actual))
in (FStar_Range.string_of_range _102_296))
in (let _102_298 = (FStar_Absyn_Print.binder_to_string formal)
in (let _102_297 = (FStar_All.pipe_left FStar_Absyn_Print.arg_to_string (Prims.fst actual))
in (FStar_Util.format3 "(%s) Impossible: ill-typed redex\n formal is %s\nactual is %s\n" _102_299 _102_298 _102_297))))
in (FStar_All.failwith _102_300))
end)
...
in (let _102_303 = (FStar_All.pipe_left wk (FStar_Absyn_Syntax.mk_Typ_fun (binders, c2.code)))
in {code = _102_303; environment = _33_641.environment; stack = _33_641.stack; close = _33_641.close; steps = _33_641.steps})))
end))
end
| FStar_Absyn_Syntax.Typ_refine (x, t) -> begin
(match ((let _102_305 = (let _102_304 = (FStar_Absyn_Syntax.v_binder x)
in (_102_304)::[])
in (sn_binders tcenv _102_305 config.environment config.steps))) with
...
| true -> begin
(let _102_316 = (FStar_Range.string_of_range sfx)
...
| true -> begin
(let _102_317 = (FStar_Range.string_of_range sfx)
...
| true -> begin
(let _102_323 = (let _33_724 = config
in (let _102_322 = (FStar_Absyn_Util.mk_conj t1 t2)
in {code = _102_322; environment = _33_724.environment; stack = _33_724.stack; close = _33_724.close; steps = _33_724.steps}))
in (sn tcenv _102_323))
end
| false -> begin
...
in (let _102_325 = (let _33_728 = config
in (let _102_324 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_slack_formula ((c1.code, c2.code, flag))))
in {code = _102_324; environment = _33_728.environment; stack = _33_728.stack; close = _33_728.close; steps = _33_728.steps}))
in (rebuild _102_325))))
end)
end
| (FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_named (_))) | (FStar_Absyn_Syntax.Typ_unknown) | (_) -> begin
(let _102_330 = (let _102_329 = (let _102_326 = (FStar_Tc_Env.get_range tcenv)
in (FStar_All.pipe_right _102_326 FStar_Range.string_of_range))
in (let _102_328 = (FStar_Absyn_Print.tag_of_typ config.code)
in (let _102_327 = (FStar_Absyn_Print.typ_to_string config.code)
in (FStar_Util.format3 "(%s) Unexpected type (%s): %s" _102_329 _102_328 _102_327))))
in (FStar_All.failwith _102_330))
end)
end)))))
...
in (let b = (let _102_341 = (FStar_Absyn_Util.freshen_bvd a.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Util.bvd_to_bvar_s _102_341 c.code))
...
in (let y = (let _102_342 = (FStar_Absyn_Util.freshen_bvd x.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Util.bvd_to_bvar_s _102_342 c.code))
...
in (let _33_772 = cfg
in (let _102_345 = (FStar_Absyn_Syntax.mk_Comp ctconf.code)
in {code = _102_345; environment = _33_772.environment; stack = _33_772.stack; close = _33_772.close; steps = _33_772.steps})))
end
| FStar_Absyn_Syntax.Total (t) -> begin
(match ((FStar_List.contains DeltaComp cfg.steps)) with
| true -> begin
(let _102_349 = (let _102_348 = (let _102_347 = (let _102_346 = (FStar_Absyn_Syntax.mk_Total t)
in (FStar_Absyn_Util.comp_to_comp_typ _102_346))
in (FStar_All.pipe_left FStar_Absyn_Syntax.mk_Comp _102_347))
in (with_new_code cfg _102_348))
in (FStar_All.pipe_left (sncomp tcenv) _102_349))
end
| false -> begin
(let t = (sn tcenv (with_new_code cfg t))
in (let _102_350 = (FStar_Absyn_Syntax.mk_Total t.code)
in (with_new_code cfg _102_350)))
end)
end)))
...
in (let res = (let _102_363 = (sn tcenv (with_new_code cfg m.FStar_Absyn_Syntax.result_typ))
in _102_363.code)
in (let sn_flags = (fun flags -> (FStar_All.pipe_right flags (FStar_List.map (fun _33_6 -> (match (_33_6) with
| FStar_Absyn_Syntax.DECREASES (e) -> begin
(let e = (let _102_367 = (wne tcenv (e_config e cfg.environment cfg.steps))
in _102_367.code)
...
in (let _33_800 = (let _102_369 = (sn_flags m.FStar_Absyn_Syntax.flags)
in (let _102_368 = (sn_args true tcenv cfg.environment cfg.steps m.FStar_Absyn_Syntax.effect_args)
in (_102_369, _102_368)))
...
| Some (_33_802) -> begin
(let c = (let _102_370 = (FStar_Absyn_Syntax.mk_Comp m)
in (weak_norm_comp tcenv _102_370))
...
(let _102_380 = (let _102_379 = (let _102_378 = (sn_delay tcenv (t_config t env steps))
in _102_378.code)
in (FStar_All.pipe_left (fun _102_377 -> FStar_Util.Inl (_102_377)) _102_379))
in (_102_380, imp))
end
| (FStar_Util.Inl (t), imp) -> begin
(let _102_384 = (let _102_383 = (let _102_382 = (sn tcenv (t_config t env steps))
in _102_382.code)
in (FStar_All.pipe_left (fun _102_381 -> FStar_Util.Inl (_102_381)) _102_383))
in (_102_384, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _102_388 = (let _102_387 = (let _102_386 = (wne tcenv (e_config e env steps))
in _102_386.code)
in (FStar_All.pipe_left (fun _102_385 -> FStar_Util.Inr (_102_385)) _102_387))
in (_102_388, imp))
end)))))
and snk = (fun tcenv cfg -> (let w = (fun f -> (f cfg.code.FStar_Absyn_Syntax.pos))
in (match ((let _102_398 = (FStar_Absyn_Util.compress_kind cfg.code)
in _102_398.FStar_Absyn_Syntax.n)) with
...
(let args = (let _102_399 = (no_eta cfg.steps)
in (sn_args false tcenv cfg.environment _102_399 args))
in (let _33_844 = cfg
in (let _102_401 = (FStar_All.pipe_left w (FStar_Absyn_Syntax.mk_Kind_uvar (uv, args)))
in {code = _102_401; environment = _33_844.environment; stack = _33_844.stack; close = _33_844.close; steps = _33_844.steps})))
end
...
in (let _102_403 = (let _33_867 = cfg
in (let _102_402 = (FStar_Absyn_Util.subst_kind subst body)
in {code = _102_402; environment = _33_867.environment; stack = _33_867.stack; close = _33_867.close; steps = _33_867.steps}))
in (snk tcenv _102_403)))
end))
end
...
| (bs, rhs) -> begin
(let _33_893 = cfg
in (let _102_405 = (FStar_All.pipe_left w (FStar_Absyn_Syntax.mk_Kind_arrow (bs, rhs)))
in {code = _102_405; environment = _33_893.environment; stack = _33_893.stack; close = _33_893.close; steps = _33_893.steps}))
end)))
end))
end
| FStar_Absyn_Syntax.Kind_unknown -> begin
...
| ((FStar_Util.Inl (t), imp), env) -> begin
(let _102_414 = (let _102_413 = (let _102_412 = (sn tcenv (t_config t env s'))
in _102_412.code)
in (FStar_All.pipe_left (fun _102_411 -> FStar_Util.Inl (_102_411)) _102_413))
in (_102_414, imp))
end
| ((FStar_Util.Inr (v), imp), env) -> begin
(let _102_418 = (let _102_417 = (let _102_416 = (wne tcenv (e_config v env s'))
in _102_416.code)
in (FStar_All.pipe_left (fun _102_415 -> FStar_Util.Inr (_102_415)) _102_417))
in (_102_418, imp))
end))))
in (let _33_919 = config
in (let _102_419 = (FStar_Absyn_Syntax.mk_Exp_app (config.code, args) None config.code.FStar_Absyn_Syntax.pos)
in {code = _102_419; environment = _33_919.environment; stack = empty_stack; close = _33_919.close; steps = _33_919.steps}))))
end))
...
in (let c = (let _102_431 = (let _33_987 = config
in (let _102_430 = (no_eta config.steps)
in {code = body; environment = env; stack = (let _33_989 = config.stack
in {args = []}); close = _33_987.close; steps = _102_430}))
in (wne tcenv _102_431))
in (let _33_992 = c
in (let _102_432 = (mk_abs c.code)
in {code = _102_432; environment = _33_992.environment; stack = _33_992.stack; close = _33_992.close; steps = _33_992.steps}))))
end)))
end
| (formal::rest, actual::rest') -> begin
(let m = (match ((formal, actual)) with
...
| _33_1028 -> begin
(let _102_437 = (let _102_436 = (let _102_433 = (FStar_All.pipe_left FStar_Absyn_Syntax.argpos (Prims.fst actual))
in (FStar_Range.string_of_range _102_433))
in (let _102_435 = (FStar_Absyn_Print.binder_to_string formal)
in (let _102_434 = (FStar_All.pipe_left FStar_Absyn_Print.arg_to_string (Prims.fst actual))
in (FStar_Util.format3 "(%s) Impossible: ill-typed redex\n formal is %s\nactual is %s\n" _102_436 _102_435 _102_434))))
in (FStar_All.failwith _102_437))
end)
...
(let _102_443 = (FStar_Absyn_Syntax.v_binder x)
in (_102_443)::[])
end
| FStar_Absyn_Syntax.Pat_tvar (a) -> begin
(let _102_444 = (FStar_Absyn_Syntax.t_binder a)
in (_102_444)::[])
end
...
(let _102_452 = (let _102_451 = (FStar_List.map norm_pat pats)
in FStar_Absyn_Syntax.Pat_disj (_102_451))
in (FStar_Absyn_Util.withinfo _102_452 None p.FStar_Absyn_Syntax.p))
end
| FStar_Absyn_Syntax.Pat_cons (fv, q, pats) -> begin
(let _102_457 = (let _102_456 = (let _102_455 = (FStar_List.map (fun _33_1103 -> (match (_33_1103) with
| (x, i) -> begin
(let _102_454 = (norm_pat x)
in (_102_454, i))
end)) pats)
in (fv, q, _102_455))
in FStar_Absyn_Syntax.Pat_cons (_102_456))
in (FStar_Absyn_Util.withinfo _102_457 None p.FStar_Absyn_Syntax.p))
end
| FStar_Absyn_Syntax.Pat_var (x) -> begin
(let _102_459 = (let _102_458 = (norm_bvvar x)
in FStar_Absyn_Syntax.Pat_var (_102_458))
in (FStar_Absyn_Util.withinfo _102_459 None p.FStar_Absyn_Syntax.p))
end
| FStar_Absyn_Syntax.Pat_tvar (a) -> begin
(let _102_461 = (let _102_460 = (norm_btvar a)
in FStar_Absyn_Syntax.Pat_tvar (_102_460))
in (FStar_Absyn_Util.withinfo _102_461 None p.FStar_Absyn_Syntax.p))
end
| FStar_Absyn_Syntax.Pat_wild (x) -> begin
(let _102_463 = (let _102_462 = (norm_bvvar x)
in FStar_Absyn_Syntax.Pat_wild (_102_462))
in (FStar_Absyn_Util.withinfo _102_463 None p.FStar_Absyn_Syntax.p))
end
| FStar_Absyn_Syntax.Pat_twild (a) -> begin
(let _102_465 = (let _102_464 = (norm_btvar a)
in FStar_Absyn_Syntax.Pat_twild (_102_464))
in (FStar_Absyn_Util.withinfo _102_465 None p.FStar_Absyn_Syntax.p))
end
...
in (let _102_468 = (let _102_467 = (let _102_466 = (norm_bvvar x)
in (_102_466, e.code))
in FStar_Absyn_Syntax.Pat_dot_term (_102_467))
in (FStar_Absyn_Util.withinfo _102_468 None p.FStar_Absyn_Syntax.p)))
end
| FStar_Absyn_Syntax.Pat_dot_typ (a, t) -> begin
(let t = (sn tcenv (t_config t config.environment config.steps))
in (let _102_471 = (let _102_470 = (let _102_469 = (norm_btvar a)
in (_102_469, t.code))
in FStar_Absyn_Syntax.Pat_dot_typ (_102_470))
in (FStar_Absyn_Util.withinfo _102_471 None p.FStar_Absyn_Syntax.p)))
end))
...
in (let _102_474 = (norm_pat pat)
in (_102_474, w, c_body.code)))))))))))
end))
...
(let y = (let _102_477 = (match (is_rec) with
| true -> begin
x
end
| false -> begin
...
in (FStar_Absyn_Util.bvd_to_bvar_s _102_477 t.code))
in (let yexp = (FStar_Absyn_Util.bvar_to_exp y)
...
| (y, env) -> begin
(let _102_479 = (let _102_478 = (FStar_Absyn_Syntax.mk_lb (y, eff, t.code, c.code))
in (_102_478)::lbs)
in (env, _102_479))
end))))
...
| true -> begin
(let t = (sn tcenv (t_config t config.environment config.steps))
in (let _102_481 = (let _33_1196 = config
in (let _102_480 = (FStar_Absyn_Syntax.mk_Exp_ascribed (c.code, t.code, l) None e.FStar_Absyn_Syntax.pos)
in {code = _102_480; environment = _33_1196.environment; stack = _33_1196.stack; close = _33_1196.close; steps = _33_1196.steps}))
in (rebuild _102_481)))
end
| false -> begin
c
...
in (match ((is_stack_empty config)) with
| true -> begin
(let _102_483 = (let _33_1206 = config
in (let _102_482 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared ((c.code, info))))
in {code = _102_482; environment = _33_1206.environment; stack = _33_1206.stack; close = _33_1206.close; steps = _33_1206.steps}))
in (rebuild _102_483))
end
| false -> begin
c
...
(let e = (let _102_507 = (let _102_506 = (FStar_Absyn_Syntax.mk_Exp_constant FStar_Absyn_Syntax.Const_unit None r)
in (lbs, _102_506))
in (FStar_Absyn_Syntax.mk_Exp_let _102_507 None r))
...
(let _102_512 = (eta_expand tcenv t)
in (FStar_All.pipe_right _102_512 FStar_Absyn_Util.compress_typ))
end
...
let exp_norm_to_string = (fun tcenv e -> (let _102_535 = (norm_exp ((Beta)::(SNComp)::(Unmeta)::[]) tcenv e)
in (FStar_Absyn_Print.exp_to_string _102_535)))

let typ_norm_to_string = (fun tcenv t -> (let _102_540 = (norm_typ ((Beta)::(SNComp)::(Unmeta)::[]) tcenv t)
in (FStar_Absyn_Print.typ_to_string _102_540)))

let kind_norm_to_string = (fun tcenv k -> (let _102_545 = (norm_kind ((Beta)::(SNComp)::(Unmeta)::[]) tcenv k)
in (FStar_Absyn_Print.kind_to_string _102_545)))

let formula_norm_to_string = (fun tcenv f -> (let _102_550 = (norm_typ ((Beta)::(SNComp)::(Unmeta)::[]) tcenv f)
in (FStar_Absyn_Print.formula_to_string _102_550)))

let comp_typ_norm_to_string = (fun tcenv c -> (let _102_555 = (norm_comp ((Beta)::(SNComp)::(Unmeta)::[]) tcenv c)
in (FStar_Absyn_Print.comp_typ_to_string _102_555)))
...
(let _102_568 = (let _102_567 = (let _102_566 = (let _102_565 = (let _102_564 = (let _102_563 = (let _102_562 = (FStar_Absyn_Util.bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _102_562))
in FStar_Util.Inr (_102_563))
in (_102_564)::[])
in (FStar_Absyn_Util.subst_typ _102_565 phi))
in (FStar_Absyn_Util.mk_conj phi1 _102_566))
in (y, _102_567))
in (FStar_Absyn_Syntax.mk_Typ_refine _102_568 (Some (FStar_Absyn_Syntax.ktype)) t0.FStar_Absyn_Syntax.pos))
end
| _33_1344 -> begin
t
end))
