...
in {context = (FStar_List.append bindings env.context); label_suffix = _32_35.label_suffix}))

let lookup_env = (fun env key -> (FStar_All.pipe_right env.context (FStar_Util.find_opt (fun _32_1 -> (match (_32_1) with
| T (a, _32_42) -> begin
...
| FStar_Absyn_Syntax.Kind_abbrev (_32_98, k) -> begin
(aux t k)
end
...
| ([], more) -> begin
(let _32_137 = (FStar_Absyn_Util.args_of_binders more)
...
| _32_140 -> begin
(let _32_143 = (FStar_Absyn_Util.args_of_binders binders)
...
| {FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Typ_btvar (_32_162); FStar_Absyn_Syntax.tk = _32_160; FStar_Absyn_Syntax.pos = _32_158; FStar_Absyn_Syntax.fvs = _32_156; FStar_Absyn_Syntax.uvs = _32_154} -> begin
true
end
| _32_166 -> begin
false
...
| _32_179 -> begin
(let _32_182 = (FStar_Absyn_Util.args_of_binders bs)
...
let no_eta = (fun s -> (FStar_All.pipe_right s (FStar_List.filter (fun _32_2 -> (match (_32_2) with
| Eta -> begin
false
end
| _32_189 -> begin
...
in (let c = (FStar_All.pipe_right (let _32_223 = (FStar_Absyn_Util.comp_to_comp_typ c1)
in {FStar_Absyn_Syntax.effect_name = _32_223.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = _32_223.FStar_Absyn_Syntax.result_typ; FStar_Absyn_Syntax.effect_args = _32_223.FStar_Absyn_Syntax.effect_args; FStar_Absyn_Syntax.flags = c.FStar_Absyn_Syntax.flags}) FStar_Absyn_Syntax.mk_Comp)
...
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_refresh_label (t, _32_254, _32_256)) -> begin
(is_head_symbol t)
end
| _32_261 -> begin
false
...
| (Some (true), _32_401)::(_32_391, (FStar_Util.Inl (arg), _32_395))::[] -> begin
arg
end
| _32_405 -> begin
(fallback ())
...
| FStar_Absyn_Syntax.Typ_lam (_32_434::[], body) -> begin
...
in (let args = (FStar_All.pipe_right config.stack.args (FStar_List.map (fun _32_4 -> (match (_32_4) with
...
| Some ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Kind_type; FStar_Absyn_Syntax.tk = _32_500; FStar_Absyn_Syntax.pos = _32_498; FStar_Absyn_Syntax.fvs = _32_496; FStar_Absyn_Syntax.uvs = _32_494}) -> begin
...
| FStar_Absyn_Syntax.Typ_delayed (_32_510) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Absyn_Syntax.Typ_uvar (_32_513) -> begin
(rebuild config)
end
| FStar_Absyn_Syntax.Typ_const (fv) -> begin
...
| ((FStar_Util.Inl (a), _32_598), ((FStar_Util.Inl (t), _32_603), env)) -> begin
T ((a.FStar_Absyn_Syntax.v, (t, env)))
end
| ((FStar_Util.Inr (x), _32_611), ((FStar_Util.Inr (v), _32_616), env)) -> begin
...
| FStar_Absyn_Syntax.Typ_ascribed (t, _32_626) -> begin
...
| ((FStar_Util.Inr (x), _32_650)::[], env) -> begin
...
| true -> begin
(let _32_692 = (match ((FStar_Tc_Env.debug tcenv FStar_Options.Low)) with
| true -> begin
...
| false -> begin
(let _32_694 = (match ((FStar_Tc_Env.debug tcenv FStar_Options.Low)) with
| true -> begin
...
in _98_363.code)
in (let sn_flags = (fun flags -> (FStar_All.pipe_right flags (FStar_List.map (fun _32_6 -> (match (_32_6) with
...
in (let _32_800 = (let _98_369 = (sn_flags m.FStar_Absyn_Syntax.flags)
...
and sn_args = (fun delay tcenv env steps args -> (FStar_All.pipe_right args (FStar_List.map (fun _32_7 -> (match (_32_7) with
...
| FStar_Absyn_Syntax.Kind_abbrev ((l, args), {FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Kind_unknown; FStar_Absyn_Syntax.tk = _32_856; FStar_Absyn_Syntax.pos = _32_854; FStar_Absyn_Syntax.fvs = _32_852; FStar_Absyn_Syntax.uvs = _32_850}) -> begin
(let _32_865 = (FStar_Tc_Env.lookup_kind_abbrev tcenv l)
...
| FStar_Absyn_Syntax.Kind_abbrev (_32_870, k) -> begin
...
in (let _32_892 = (match (c2.code.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_arrow (bs', k) -> begin
...
in (let args = (FStar_All.pipe_right config.stack.args (FStar_List.map (fun _32_8 -> (match (_32_8) with
| ((FStar_Util.Inl (t), imp), env) -> begin
...
| FStar_Absyn_Syntax.Exp_delayed (_32_922) -> begin
(FStar_All.failwith "Impossible")
end
...
| (formal::rest, actual::rest') -> begin
(let m = (match ((formal, actual)) with
| ((FStar_Util.Inl (a), _32_1004), ((FStar_Util.Inl (t), _32_1009), env)) -> begin
T ((a.FStar_Absyn_Syntax.v, (t, env)))
end
| ((FStar_Util.Inr (x), _32_1017), ((FStar_Util.Inr (v), _32_1022), env)) -> begin
V ((x.FStar_Absyn_Syntax.v, (v, env)))
end
| _32_1028 -> begin
...
| FStar_Absyn_Syntax.Pat_disj (p::_32_1047) -> begin
(pat_vars p)
end
| FStar_Absyn_Syntax.Pat_cons (_32_1052, _32_1054, pats) -> begin
(FStar_List.collect (fun _32_1061 -> (match (_32_1061) with
| (x, _32_1060) -> begin
(pat_vars x)
end)) pats)
end
...
in (let _32_1085 = x
in {FStar_Absyn_Syntax.v = _32_1085.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = t.code; FStar_Absyn_Syntax.p = _32_1085.FStar_Absyn_Syntax.p})))
in (let norm_btvar = (fun a -> (let k = (snk tcenv (k_config a.FStar_Absyn_Syntax.sort config.environment config.steps))
in (let _32_1090 = a
in {FStar_Absyn_Syntax.v = _32_1090.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = k.code; FStar_Absyn_Syntax.p = _32_1090.FStar_Absyn_Syntax.p})))
...
(let _98_457 = (let _98_456 = (let _98_455 = (FStar_List.map (fun _32_1103 -> (match (_32_1103) with
| (x, i) -> begin
...
| FStar_Absyn_Syntax.Pat_constant (_32_1113) -> begin
p
end
...
in (FStar_All.pipe_right (let _32_1147 = config
...
(let _32_1179 = (FStar_All.pipe_right lbs (FStar_List.fold_left (fun _32_1157 _32_1162 -> (match ((_32_1157, _32_1162)) with
...
in (FStar_All.pipe_right (let _32_1185 = config
...
in (match (e.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_let (lbs, _32_1232) -> begin
