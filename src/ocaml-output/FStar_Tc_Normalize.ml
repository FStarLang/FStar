...
in {code = _43_192.code; environment = _43_192.environment; stack = _43_192.stack; close = _43_192.close; steps = _143_155})))
...
in {code = _143_263; environment = _43_488.environment; stack = _43_488.stack; close = _43_488.close; steps = _43_488.steps}))
end else begin
(
...
in {code = _143_276; environment = _43_507.environment; stack = _43_507.stack; close = _43_507.close; steps = _43_507.steps}))
...
in {code = _143_290; environment = _43_566.environment; stack = _43_566.stack; close = _43_566.close; steps = _43_566.steps}))))
end))
end
| args -> begin
(
...
in {code = _143_304; environment = _43_643.environment; stack = _43_643.stack; close = _43_643.close; steps = _43_643.steps}))
in (rebuild _143_305)))
end))
end
...
in (let _143_314 = (let _143_313 = (FStar_All.pipe_right config.steps (FStar_List.filter (fun _43_5 -> (match (_43_5) with
| UnfoldOpaque -> begin
false
end
| _43_662 -> begin
...
in {code = _143_327; environment = _43_730.environment; stack = _43_730.stack; close = _43_730.close; steps = _43_730.steps}))
...
in {code = _143_329; environment = _43_734.environment; stack = _43_734.stack; close = _43_734.close; steps = _43_734.steps}))
in (rebuild _143_330))))
end
end
...
in {code = _143_350; environment = _43_778.environment; stack = _43_778.stack; close = _43_778.close; steps = _43_778.steps})))
end
...
let _43_806 = (let _143_374 = (sn_flags m.FStar_Absyn_Syntax.flags)
...
in {code = _143_406; environment = _43_850.environment; stack = _43_850.stack; close = _43_850.close; steps = _43_850.steps})))
end
...
in {code = _143_407; environment = _43_873.environment; stack = _43_873.stack; close = _43_873.close; steps = _43_873.steps}))
...
in {code = _143_410; environment = _43_899.environment; stack = _43_899.stack; close = _43_899.close; steps = _43_899.steps}))
end)))
end))
end
| FStar_Absyn_Syntax.Kind_unknown -> begin
...
in {code = _143_424; environment = _43_925.environment; stack = empty_stack; close = _43_925.close; steps = _43_925.steps}))))
end)
...
in {args = []}); close = _43_993.close; steps = _143_435}))
in (wne tcenv _143_436))
in (

let _43_998 = c
in (let _143_437 = (mk_abs c.code)
in {code = _143_437; environment = _43_998.environment; stack = _43_998.stack; close = _43_998.close; steps = _43_998.steps}))))
end)))
end
| ((formal)::rest, (actual)::rest') -> begin
(
...
(let _143_462 = (let _143_461 = (let _143_460 = (FStar_List.map (fun _43_1109 -> (match (_43_1109) with
| (x, i) -> begin
...
in {code = _143_485; environment = _43_1202.environment; stack = _43_1202.stack; close = _43_1202.close; steps = _43_1202.steps}))
in (rebuild _143_486)))
end else begin
c
end)
...
in {code = _143_487; environment = _43_1212.environment; stack = _43_1212.stack; close = _43_1212.close; steps = _43_1212.steps}))
in (rebuild _143_488))
end else begin
c
end)
