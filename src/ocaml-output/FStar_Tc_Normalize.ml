...
in {code = _42_192.code; environment = _42_192.environment; stack = _42_192.stack; close = _42_192.close; steps = _139_155})))
...
in {code = _139_263; environment = _42_488.environment; stack = _42_488.stack; close = _42_488.close; steps = _42_488.steps}))
end else begin
(
...
in {code = _139_276; environment = _42_507.environment; stack = _42_507.stack; close = _42_507.close; steps = _42_507.steps}))
...
in {code = _139_290; environment = _42_566.environment; stack = _42_566.stack; close = _42_566.close; steps = _42_566.steps}))))
end))
end
| args -> begin
(
...
in {code = _139_304; environment = _42_643.environment; stack = _42_643.stack; close = _42_643.close; steps = _42_643.steps}))
in (rebuild _139_305)))
end))
end
...
in (let _139_314 = (let _139_313 = (FStar_All.pipe_right config.steps (FStar_List.filter (fun _42_5 -> (match (_42_5) with
| UnfoldOpaque -> begin
false
end
| _42_662 -> begin
...
in {code = _139_327; environment = _42_730.environment; stack = _42_730.stack; close = _42_730.close; steps = _42_730.steps}))
...
in {code = _139_329; environment = _42_734.environment; stack = _42_734.stack; close = _42_734.close; steps = _42_734.steps}))
in (rebuild _139_330))))
end
end
...
in {code = _139_350; environment = _42_778.environment; stack = _42_778.stack; close = _42_778.close; steps = _42_778.steps})))
end
...
let _42_806 = (let _139_374 = (sn_flags m.FStar_Absyn_Syntax.flags)
...
in {code = _139_406; environment = _42_850.environment; stack = _42_850.stack; close = _42_850.close; steps = _42_850.steps})))
end
...
in {code = _139_407; environment = _42_873.environment; stack = _42_873.stack; close = _42_873.close; steps = _42_873.steps}))
...
in {code = _139_410; environment = _42_899.environment; stack = _42_899.stack; close = _42_899.close; steps = _42_899.steps}))
end)))
end))
end
| FStar_Absyn_Syntax.Kind_unknown -> begin
...
in {code = _139_424; environment = _42_925.environment; stack = empty_stack; close = _42_925.close; steps = _42_925.steps}))))
end)
...
in {args = []}); close = _42_993.close; steps = _139_435}))
in (wne tcenv _139_436))
in (

let _42_998 = c
in (let _139_437 = (mk_abs c.code)
in {code = _139_437; environment = _42_998.environment; stack = _42_998.stack; close = _42_998.close; steps = _42_998.steps}))))
end)))
end
| ((formal)::rest, (actual)::rest') -> begin
(
...
(let _139_462 = (let _139_461 = (let _139_460 = (FStar_List.map (fun _42_1109 -> (match (_42_1109) with
| (x, i) -> begin
...
in {code = _139_485; environment = _42_1202.environment; stack = _42_1202.stack; close = _42_1202.close; steps = _42_1202.steps}))
in (rebuild _139_486)))
end else begin
c
end)
...
in {code = _139_487; environment = _42_1212.environment; stack = _42_1212.stack; close = _42_1212.close; steps = _42_1212.steps}))
in (rebuild _139_488))
end else begin
c
end)
