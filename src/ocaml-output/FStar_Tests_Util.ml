  ...
  fun id  ->
    fun b  ->
      ...
      then ()
        ...
        (let uu____8 =
           let uu____13 =
             let uu____14 = FStar_Util.string_of_int id in
             FStar_Util.format1 "Assertion failed: test %s" uu____14 in
           (FStar_Errors.AssertionFailure, uu____13) in
  ...
  fun t1  ->
    fun t2  ->
      ...
      | (FStar_Syntax_Syntax.Tm_uinst
         (t,uu____239),FStar_Syntax_Syntax.Tm_uinst (s,uu____241)) ->
          term_eq' t s
      ...
      | (FStar_Syntax_Syntax.Tm_abs
         (xs,t,uu____256),FStar_Syntax_Syntax.Tm_abs (ys,u,uu____259)) when
          (FStar_List.length xs) = (FStar_List.length ys) ->
      ...
      | (FStar_Syntax_Syntax.Tm_app
         ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv_eq_1;
            ...
            FStar_Syntax_Syntax.vars = uu____615;_},(uu____616,FStar_Pervasives_Native.Some
                                                     (FStar_Syntax_Syntax.Implicit
                                                     uu____617))::t12::t22::[]),FStar_Syntax_Syntax.Tm_app
         ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv_eq_2;
            FStar_Syntax_Syntax.pos = uu____621;
            FStar_Syntax_Syntax.vars = uu____622;_},(uu____623,FStar_Pervasives_Native.Some
                                                     (FStar_Syntax_Syntax.Implicit
                                                     uu____624))::s1::s2::[]))
          when
