  ...
  fun t1  ->
    fun t2  ->
                  ...
                  | ((a,imp),(b,imp')) ->
                      (term_eq' a b) &&
                        (let uu___2 = FStar_Syntax_Util.eq_aqual imp imp'  in
                         uu___2 = FStar_Syntax_Util.Equal)) xs ys)
         in
      let comp_eq c d =
      ...
      | (FStar_Syntax_Syntax.Tm_lazy l,uu___) ->
          let uu___1 =
            let uu___2 =
              let uu___3 = FStar_ST.op_Bang FStar_Syntax_Syntax.lazy_chooser
                 in
      ...
      | (FStar_Syntax_Syntax.Tm_uinst (t,uu___),FStar_Syntax_Syntax.Tm_uinst
         (s,uu___1)) -> term_eq' t s
      | (FStar_Syntax_Syntax.Tm_constant c1,FStar_Syntax_Syntax.Tm_constant
         c2) -> FStar_Const.eq_const c1 c2
      | (FStar_Syntax_Syntax.Tm_type u,FStar_Syntax_Syntax.Tm_type v) ->
          u = v
      | (FStar_Syntax_Syntax.Tm_abs (xs,t,uu___),FStar_Syntax_Syntax.Tm_abs
         (ys,u,uu___1)) when (FStar_List.length xs) = (FStar_List.length ys)
            ...
            (match uu___2 with
             | (xs1,xs') ->
                 let t12 =
                   ...
                   FStar_Syntax_Syntax.mk uu___3 t11.FStar_Syntax_Syntax.pos
                    in
                 term_eq' t12 t21)
          else
            (let uu___3 = FStar_Util.first_N (FStar_List.length xs) ys  in
             ...
             | (ys1,ys') ->
                 let t22 =
                   ...
                   FStar_Syntax_Syntax.mk uu___4 t21.FStar_Syntax_Syntax.pos
                    in
                 term_eq' t11 t22)
      ...
      | (FStar_Syntax_Syntax.Tm_app
         ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv_eq_1;
            ...
            FStar_Syntax_Syntax.vars = uu___1;_},(uu___2,FStar_Pervasives_Native.Some
                                                  (FStar_Syntax_Syntax.Implicit
                                                  uu___3))::t12::t22::[]),FStar_Syntax_Syntax.Tm_app
         ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv_eq_2;
            FStar_Syntax_Syntax.pos = uu___4;
            FStar_Syntax_Syntax.vars = uu___5;_},(uu___6,FStar_Pervasives_Native.Some
                                                  (FStar_Syntax_Syntax.Implicit
                                                  uu___7))::s1::s2::[]))
          when
      ...
      | (FStar_Syntax_Syntax.Tm_ascribed
         (t12,(FStar_Util.Inl t22,uu___),uu___1),FStar_Syntax_Syntax.Tm_ascribed
      ...
      | (FStar_Syntax_Syntax.Tm_meta (t12,uu___),uu___1) -> term_eq' t12 t21
      | (uu___,FStar_Syntax_Syntax.Tm_meta (t22,uu___1)) -> term_eq' t11 t22
