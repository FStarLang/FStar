  ...
  fun t1  ->
    fun t2  ->
      ...
      | (FStar_Syntax_Syntax.Tm_uinst
         (t,uu____532),FStar_Syntax_Syntax.Tm_uinst (s,uu____534)) ->
          term_eq' t s
      ...
      | (FStar_Syntax_Syntax.Tm_abs
         (xs,t,uu____549),FStar_Syntax_Syntax.Tm_abs (ys,u,uu____552)) when
          (FStar_List.length xs) = (FStar_List.length ys) ->
          (binders_eq xs ys) && (term_eq' t u)
      | (FStar_Syntax_Syntax.Tm_abs
         (xs,t,uu____615),FStar_Syntax_Syntax.Tm_abs (ys,u,uu____618)) ->
      ...
      | (FStar_Syntax_Syntax.Tm_app
         ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv_eq_1;
            ...
            FStar_Syntax_Syntax.vars = uu____992;_},(uu____993,FStar_Pervasives_Native.Some
                                                     (FStar_Syntax_Syntax.Implicit
                                                     uu____994))::t12::t22::[]),FStar_Syntax_Syntax.Tm_app
         ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv_eq_2;
            FStar_Syntax_Syntax.pos = uu____998;
            FStar_Syntax_Syntax.vars = uu____999;_},(uu____1000,FStar_Pervasives_Native.Some
                                                     (FStar_Syntax_Syntax.Implicit
                                                     uu____1001))::s1::s2::[]))
          when
             ...
             (FStar_List.forall2
                (fun uu____1380  ->
                   fun uu____1381  ->
                     ...
                     | ((uu____1438,uu____1439,e),(uu____1441,uu____1442,e'))
                         -> term_eq' e e') pats pats'))
            && (term_eq' t t')
      | (FStar_Syntax_Syntax.Tm_ascribed
         (t12,(FStar_Util.Inl t22,uu____1506),uu____1507),FStar_Syntax_Syntax.Tm_ascribed
      ...
      | (FStar_Syntax_Syntax.Tm_uvar
         (u,uu____1643),FStar_Syntax_Syntax.Tm_uvar (u',uu____1645)) ->
      ...
      | (FStar_Syntax_Syntax.Tm_delayed uu____1692,uu____1693) ->
          let uu____1716 =
            ...
            FStar_Util.format2 "Impossible: %s and %s" uu____1717 uu____1718
             in
          failwith uu____1716
      | (uu____1719,FStar_Syntax_Syntax.Tm_delayed uu____1720) ->
          let uu____1743 =
            ...
            FStar_Util.format2 "Impossible: %s and %s" uu____1744 uu____1745
             in
          failwith uu____1743
