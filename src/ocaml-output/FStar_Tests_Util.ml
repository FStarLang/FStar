...
let rec (term_eq' :
  ...
  fun t1 ->
    fun t2 ->
          ...
          (FStar_List.forall2
             (fun uu____305 ->
                fun uu____306 ->
                  ...
                  | ((a, imp), (b, imp')) ->
                      (term_eq' a b) &&
                        (let uu____377 = FStar_Syntax_Util.eq_aqual imp imp' in
                         uu____377 = FStar_Syntax_Util.Equal)) xs ys) in
      let comp_eq c d =
        match ((c.FStar_Syntax_Syntax.n), (d.FStar_Syntax_Syntax.n)) with
        | (FStar_Syntax_Syntax.Total (t, uu____392),
           FStar_Syntax_Syntax.Total (s, uu____394)) -> term_eq' t s
      ...
      | (FStar_Syntax_Syntax.Tm_uinst (t, uu____556),
         FStar_Syntax_Syntax.Tm_uinst (s, uu____558)) -> term_eq' t s
      | (FStar_Syntax_Syntax.Tm_constant c1, FStar_Syntax_Syntax.Tm_constant
         c2) -> FStar_Const.eq_const c1 c2
      | (FStar_Syntax_Syntax.Tm_type u, FStar_Syntax_Syntax.Tm_type v) ->
          u = v
      | (FStar_Syntax_Syntax.Tm_abs (xs, t, uu____573),
         FStar_Syntax_Syntax.Tm_abs (ys, u, uu____576)) when
          (FStar_List.length xs) = (FStar_List.length ys) ->
          (binders_eq xs ys) && (term_eq' t u)
      | (FStar_Syntax_Syntax.Tm_abs (xs, t, uu____639),
         FStar_Syntax_Syntax.Tm_abs (ys, u, uu____642)) ->
      ...
      | (FStar_Syntax_Syntax.Tm_app
         ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv_eq_1;
            ...
            FStar_Syntax_Syntax.vars = uu____1001;_},
          (uu____1002, FStar_Pervasives_Native.Some
           (FStar_Syntax_Syntax.Implicit uu____1003))::t12::t22::[]),
         FStar_Syntax_Syntax.Tm_app
         ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv_eq_2;
            FStar_Syntax_Syntax.pos = uu____1007;
            FStar_Syntax_Syntax.vars = uu____1008;_},
          (uu____1009, FStar_Pervasives_Native.Some
           (FStar_Syntax_Syntax.Implicit uu____1010))::s1::s2::[]))
          when
             ...
             (FStar_List.forall2
                (fun uu____1391 ->
                   fun uu____1392 ->
                     ...
                     | ((uu____1450, uu____1451, e),
                        (uu____1453, uu____1454, e')) -> term_eq' e e') pats
                pats'))
            && (term_eq' t t')
      | (FStar_Syntax_Syntax.Tm_ascribed
         (t12, (FStar_Util.Inl t22, uu____1518), uu____1519),
         FStar_Syntax_Syntax.Tm_ascribed
      ...
      | (FStar_Syntax_Syntax.Tm_let ((is_rec, lbs), t),
         FStar_Syntax_Syntax.Tm_let ((is_rec', lbs'), s)) when
          ...
          (((FStar_List.length lbs) = (FStar_List.length lbs')) &&
            ...
            && (term_eq' t s)
      | (FStar_Syntax_Syntax.Tm_uvar (u, uu____1662),
         FStar_Syntax_Syntax.Tm_uvar (u', uu____1664)) ->
      ...
      | (FStar_Syntax_Syntax.Tm_delayed uu____1711, uu____1712) ->
          let uu____1727 =
            ...
            FStar_Util.format2 "Impossible: %s and %s" uu____1729 uu____1731 in
          failwith uu____1727
      | (uu____1735, FStar_Syntax_Syntax.Tm_delayed uu____1736) ->
          let uu____1751 =
            ...
            FStar_Util.format2 "Impossible: %s and %s" uu____1753 uu____1755 in
          failwith uu____1751
