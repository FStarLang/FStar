  ...
  fun t1 ->
    fun t2 ->
      ...
      let comp_eq c d =
        ...
        | (FStar_Syntax_Syntax.Total (t, uu____239),
           FStar_Syntax_Syntax.Total (s, uu____241)) -> term_eq' t s
      ...
      | (FStar_Syntax_Syntax.Tm_uinst (t, uu____272),
         FStar_Syntax_Syntax.Tm_uinst (s, uu____274)) -> term_eq' t s
      | (FStar_Syntax_Syntax.Tm_constant c1, FStar_Syntax_Syntax.Tm_constant
         c2) -> c1 = c2
      | (FStar_Syntax_Syntax.Tm_type u, FStar_Syntax_Syntax.Tm_type v1) ->
          u = v1
      | (FStar_Syntax_Syntax.Tm_abs (xs, t, uu____289),
         FStar_Syntax_Syntax.Tm_abs (ys, u, uu____292)) when
          (FStar_List.length xs) = (FStar_List.length ys) ->
          (binders_eq xs ys) && (term_eq' t u)
      | (FStar_Syntax_Syntax.Tm_abs (xs, t, uu____343),
         FStar_Syntax_Syntax.Tm_abs (ys, u, uu____346)) ->
      ...
      | (FStar_Syntax_Syntax.Tm_app
         ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv_eq_1;
            ...
            FStar_Syntax_Syntax.vars = uu____656;_},
          (uu____657, FStar_Pervasives_Native.Some
           (FStar_Syntax_Syntax.Implicit uu____658))::t12::t22::[]),
         FStar_Syntax_Syntax.Tm_app
         ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv_eq_2;
            FStar_Syntax_Syntax.pos = uu____662;
            FStar_Syntax_Syntax.vars = uu____663;_},
          (uu____664, FStar_Pervasives_Native.Some
           (FStar_Syntax_Syntax.Implicit uu____665))::s1::s2::[]))
          when
             ...
             (FStar_List.forall2
                (fun uu____1032 ->
                   fun uu____1033 ->
                     ...
                     | ((uu____1082, uu____1083, e),
                        (uu____1085, uu____1086, e')) -> term_eq' e e') pats
                pats'))
            && (term_eq' t t')
      | (FStar_Syntax_Syntax.Tm_ascribed
         (t12, (FStar_Util.Inl t22, uu____1138), uu____1139),
         FStar_Syntax_Syntax.Tm_ascribed
      ...
      | (FStar_Syntax_Syntax.Tm_let ((is_rec, lbs), t),
         FStar_Syntax_Syntax.Tm_let ((is_rec', lbs'), s)) when
          ...
          (((FStar_List.length lbs) = (FStar_List.length lbs')) &&
            ...
            && (term_eq' t s)
      | (FStar_Syntax_Syntax.Tm_uvar (u, uu____1275),
         FStar_Syntax_Syntax.Tm_uvar (u', uu____1277)) ->
      ...
      | (FStar_Syntax_Syntax.Tm_delayed uu____1340, uu____1341) ->
          let uu____1366 =
            ...
            FStar_Util.format2 "Impossible: %s and %s" uu____1367 uu____1368 in
          failwith uu____1366
      | (uu____1369, FStar_Syntax_Syntax.Tm_delayed uu____1370) ->
          let uu____1395 =
            ...
            FStar_Util.format2 "Impossible: %s and %s" uu____1396 uu____1397 in
          failwith uu____1395
