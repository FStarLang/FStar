...
let idsym = (fun _497568 -> (match (_497568) with
| (s, _) -> begin
s
end))

let ptsym = (fun _497571 -> (match (_497571) with
| (p, s) -> begin
...
let ptctor = (fun _497575 -> (match (_497575) with
| (p, s) -> begin
...
let mlif = (fun b _497687 -> (match (_497687) with
| (e1, e2) -> begin
(match (e2) with
