...
let idsym = (fun _497647 -> (match (_497647) with
| (s, _) -> begin
s
end))

let ptsym = (fun _497650 -> (match (_497650) with
| (p, s) -> begin
...
let ptctor = (fun _497654 -> (match (_497654) with
| (p, s) -> begin
...
let mlif = (fun b _497766 -> (match (_497766) with
| (e1, e2) -> begin
(match (e2) with
