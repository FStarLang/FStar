...
let idsym = (fun _497637 -> (match (_497637) with
| (s, _) -> begin
s
end))

let ptsym = (fun _497640 -> (match (_497640) with
| (p, s) -> begin
...
let ptctor = (fun _497644 -> (match (_497644) with
| (p, s) -> begin
...
let mlif = (fun b _497756 -> (match (_497756) with
| (e1, e2) -> begin
(match (e2) with
