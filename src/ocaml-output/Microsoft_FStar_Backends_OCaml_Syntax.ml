...
let idsym = (fun _499738 -> (match (_499738) with
| (s, _) -> begin
s
end))

let ptsym = (fun _499741 -> (match (_499741) with
| (p, s) -> begin
...
let ptctor = (fun _499745 -> (match (_499745) with
| (p, s) -> begin
...
let mlif = (fun b _499857 -> (match (_499857) with
| (e1, e2) -> begin
(match (e2) with
