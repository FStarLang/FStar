...
let idsym = (fun _495999 -> (match (_495999) with
| (s, _) -> begin
s
end))

let ptsym = (fun _496002 -> (match (_496002) with
| (p, s) -> begin
...
let ptctor = (fun _496006 -> (match (_496006) with
| (p, s) -> begin
...
let mlif = (fun b _496118 -> (match (_496118) with
| (e1, e2) -> begin
(match (e2) with
