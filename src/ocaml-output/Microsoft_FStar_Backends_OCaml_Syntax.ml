...
let idsym = (fun _499442 -> (match (_499442) with
| (s, _) -> begin
s
end))

let ptsym = (fun _499445 -> (match (_499445) with
| (p, s) -> begin
...
let ptctor = (fun _499449 -> (match (_499449) with
| (p, s) -> begin
...
let mlif = (fun b _499561 -> (match (_499561) with
| (e1, e2) -> begin
(match (e2) with
