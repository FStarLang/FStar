      ...
      let uu____310 =
        FStar_Syntax_Syntax.mk
          (FStar_Syntax_Syntax.Tm_bvar
             (let uu___80_315 = FStar_Tests_Util.x in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___80_315.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index = (Prims.parse_int "0");
                FStar_Syntax_Syntax.sort =
                  (uu___80_315.FStar_Syntax_Syntax.sort)
    ...
    let rec aux out n2 =
      ...
      then out
        ...
        (let uu____638 = snat out in
         aux uu____638 (n2 - (Prims.parse_int "1"))) in
    aux znat n1
let (run :
...
let (run_all : unit -> unit) =
  fun uu____681 ->
               ...
               let uu____743 =
                 let uu____746 =
                   let uu____749 =
                     ...
                     let uu____753 =
                       let uu____756 = FStar_Tests_Util.nm FStar_Tests_Util.m in
                       [uu____756] in
    ...
    (let uu____786 =
       let uu____787 =
         let uu____790 = FStar_Tests_Util.app succ [one] in [uu____790; one] in
