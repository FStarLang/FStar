...
let rec encode : Prims.int -> FStar_Syntax_Syntax.term =
  fun n1 ->
    if n1 = Prims.parse_int "0" then z
    else
      let uu____7 =
        let uu____10 = encode (n1 - Prims.parse_int "1") in
        [uu____10]
      in
...
let minus
    : FStar_Syntax_Syntax.term
      ...
      -> FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax =
  fun m1 n1 -> FStar_Tests_Util.app n1 [pred; m1]
...
let let_
  ...
  fun x1 e e' ->
    let uu____32 =
      let uu____35 =
        let uu____36 = b x1 in
        [uu____36]
      in
      FStar_Syntax_Util.abs uu____35 e' FStar_Pervasives_Native.None
    in
  ...
  fun x1 e e' ->
    ...
    FStar_Syntax_Syntax.mk
      (FStar_Syntax_Syntax.Tm_let
         ...
         , e'1 )) FStar_Pervasives_Native.None FStar_Range.dummyRange
    ...
    let uu____78 =
      let uu____81 =
        let uu____82 =
          ...
          let uu____100 =
            let uu____103 = FStar_Syntax_Syntax.as_arg s in
            [uu____103]
          in
          (uu____97, uu____100)
        in
        FStar_Syntax_Syntax.Tm_app uu____82
      in
      FStar_Syntax_Syntax.mk uu____81
    in
    uu____78 FStar_Pervasives_Native.None FStar_Range.dummyRange


let pat: 'Auu____113. 'Auu____113 -> 'Auu____113 FStar_Syntax_Syntax.withinfo_t =
...
let mk_match
  ...
  fun h1 branches ->
    let branches1 =
      FStar_All.pipe_right branches (FStar_List.map FStar_Syntax_Util.branch)
    in
...
let pred_nat
  ...
  fun s ->
    let zbranch =
      ...
      (uu____171, FStar_Pervasives_Native.None, znat)
    in
    let sbranch =
      let uu____213 =
        let uu____216 =
          let uu____217 =
            let uu____230 =
              let uu____239 =
                let uu____246 =
                  pat (FStar_Syntax_Syntax.Pat_var FStar_Tests_Util.x)
                in
                (uu____246, false)
              in
              [uu____239]
            ...
            (snat_l, uu____230)
          in
          FStar_Syntax_Syntax.Pat_cons uu____217
        in
        pat uu____216
      in
      let uu____271 =
        FStar_Syntax_Syntax.mk
          (FStar_Syntax_Syntax.Tm_bvar
             (let uu___75_276 = FStar_Tests_Util.x in
              ...
              ; FStar_Syntax_Syntax.sort= uu___75_276.FStar_Syntax_Syntax.sort
              }))
          FStar_Pervasives_Native.None FStar_Range.dummyRange
      in
      (uu____213, FStar_Pervasives_Native.None, uu____271)
    in
...
let minus_nat
  ...
  fun t1 t2 ->
    ...
    let zbranch =
      ...
      (uu____351, FStar_Pervasives_Native.None, uu____368)
    in
    let sbranch =
      let uu____392 =
        let uu____395 =
          let uu____396 =
            let uu____409 =
              let uu____418 =
                let uu____425 =
                  pat (FStar_Syntax_Syntax.Pat_var FStar_Tests_Util.n)
                in
                (uu____425, false)
              in
              [uu____418]
            ...
            (snat_l, uu____409)
          in
          FStar_Syntax_Syntax.Pat_cons uu____396
        in
        pat uu____395
      in
      let uu____450 =
        ...
        let uu____456 =
          ...
          uu____459 :: uu____465
        in
        FStar_Tests_Util.app uu____453 uu____456
      in
      (uu____392, FStar_Pervasives_Native.None, uu____450)
    in
    let lb =
      let uu____484 =
        FStar_Ident.lid_of_path ["Pure"] FStar_Range.dummyRange
      in
      let uu____485 =
        let uu____488 =
          let uu____489 =
            ...
            let uu____491 =
              let uu____494 = b FStar_Tests_Util.y in
              [uu____494]
            in
            uu____490 :: uu____491
          in
          let uu____495 =
            ...
            mk_match uu____496 [zbranch; sbranch]
          in
          FStar_Syntax_Util.abs uu____489 uu____495
            FStar_Pervasives_Native.None
        in
        FStar_Syntax_Subst.subst
          [FStar_Syntax_Syntax.NM (minus1, Prims.parse_int "0")] uu____488
      in
        ...
        let uu____545 =
          let uu____558 =
            let uu____559 =
              ...
              FStar_Tests_Util.app uu____560 [t1; t2]
            in
            FStar_Syntax_Subst.subst
              [FStar_Syntax_Syntax.NM (minus1, Prims.parse_int "0")] uu____559
          in
          ((true, [lb]), uu____558)
        in
        FStar_Syntax_Syntax.Tm_let uu____545
      in
      FStar_Syntax_Syntax.mk uu____544
    in
...
let encode_nat : Prims.int -> FStar_Syntax_Syntax.term =
  fun n1 ->
    let rec aux out n2 =
      if n2 = Prims.parse_int "0" then out
      else
...
let run
  ...
  fun i r expected ->
    ...
    let uu____622 =
      ...
      FStar_Tests_Util.term_eq uu____623 expected
    in
  ...
  fun uu____626 ->
    ...
    (let uu____634 =
       let uu____635 =
         ...
         one :: uu____638
       in
       FStar_Tests_Util.app apply uu____635
     in
    ...
    (let uu____647 =
       let uu____648 =
         ...
         tt :: uu____651
       in
       FStar_Tests_Util.app apply uu____648
     in
    ...
    (let uu____661 =
       let uu____662 =
         ...
         ff :: uu____665
       in
       FStar_Tests_Util.app apply uu____662
     in
    ...
    (let uu____675 =
       let uu____676 =
               ...
               let uu____688 =
                 let uu____691 =
                   let uu____694 =
                     ...
                     let uu____698 =
                       let uu____701 =
                         FStar_Tests_Util.nm FStar_Tests_Util.m
                       in
                       [uu____701]
                     in
                     uu____697 :: uu____698
         ...
         apply :: uu____679
       in
       FStar_Tests_Util.app apply uu____676
     in
    ...
    (let uu____753 =
       ...
       let uu____755 =
         ...
         minus uu____756 uu____757
       in
       let_ FStar_Tests_Util.x uu____754 uu____755
     in
       ...
       let uu____763 =
         let uu____764 =
           let uu____765 =
             ...
             uu____768 :: uu____769
           in
           FStar_Tests_Util.app mul uu____765
         in
         let uu____773 =
           let uu____774 =
             let uu____775 =
               ...
               uu____778 :: uu____779
             in
             FStar_Tests_Util.app mul uu____775
           in
           let uu____783 =
             let uu____784 = FStar_Tests_Util.nm FStar_Tests_Util.h in
             let uu____785 = FStar_Tests_Util.nm FStar_Tests_Util.h in
             minus uu____784 uu____785
           in
           let_ FStar_Tests_Util.h uu____774 uu____783
         in
         let_ FStar_Tests_Util.y uu____764 uu____773
       in
       let_ FStar_Tests_Util.x uu____762 uu____763
     in
       ...
       let uu____793 =
         let uu____794 =
           let uu____797 =
             ...
             uu____800 :: uu____801
           in
           FStar_Tests_Util.app mul uu____797
         in
         let uu____805 =
           let uu____806 =
             let uu____809 =
               ...
               uu____812 :: uu____813
             in
             FStar_Tests_Util.app mul uu____809
           in
           let uu____817 =
             let uu____818 = FStar_Tests_Util.nm FStar_Tests_Util.h in
             let uu____819 = FStar_Tests_Util.nm FStar_Tests_Util.h in
             minus uu____818 uu____819
           in
           mk_let FStar_Tests_Util.h uu____806 uu____817
         in
         mk_let FStar_Tests_Util.y uu____794 uu____805
       in
       mk_let FStar_Tests_Util.x uu____790 uu____793
     in
     run (Prims.parse_int "15") uu____789 z) ;
    (let uu____823 =
       let uu____824 =
         let uu____827 = snat znat in
         snat uu____827
       in
       pred_nat uu____824
     in
    ...
    (let uu____830 =
       let uu____831 =
         let uu____832 = snat znat in
         snat uu____832
       in
       let uu____833 = snat znat in
       minus_nat uu____831 uu____833
     in
