      ...
      let uu____416 =
        FStar_Syntax_Syntax.mk
          (FStar_Syntax_Syntax.Tm_bvar
             (let uu___477_421 = FStar_Tests_Util.x  in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___477_421.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index = (Prims.parse_int "0");
                FStar_Syntax_Syntax.sort =
                  (uu___477_421.FStar_Syntax_Syntax.sort)
              })) FStar_Pervasives_Native.None FStar_Range.dummyRange
         in
        ...
        fun normalizer  ->
          ...
          (let tcenv = FStar_Tests_Pars.init ()  in
           (let uu____3416 = FStar_Main.process_args ()  in
            FStar_All.pipe_right uu____3416 (fun a240  -> ()));
...
let run_tests :
  ...
  fun run1  ->
    ...
    (let l =
       FStar_List.map
         (fun uu___476_3598  ->
            match uu___476_3598 with | (no,test,res) -> run1 no test res)
         tests
        in
