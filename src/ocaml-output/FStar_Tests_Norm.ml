      ...
      let uu____269 =
        FStar_Syntax_Syntax.mk
          (FStar_Syntax_Syntax.Tm_bvar
             (let uu___398_274 = FStar_Tests_Util.x  in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___398_274.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index = (Prims.parse_int "0");
                FStar_Syntax_Syntax.sort =
                  (uu___398_274.FStar_Syntax_Syntax.sort)
              })) FStar_Pervasives_Native.None FStar_Range.dummyRange
         in
    ...
    let rec aux out n2 =
      ...
      then out
        ...
        (let uu____581 = snat out  in
         aux uu____581 (n2 - (Prims.parse_int "1")))
       in
    aux znat n1
...
let run_all : Prims.unit -> Prims.unit =
  fun uu____622  ->
           ...
           let uu____678 =
             let uu____681 =
               let uu____684 =
                 let uu____687 =
                   let uu____690 =
                     let uu____693 = FStar_Tests_Util.nm FStar_Tests_Util.n
                        in
                     let uu____694 =
                       let uu____697 = FStar_Tests_Util.nm FStar_Tests_Util.m
                          in
                       [uu____697]  in
    ...
    (let uu____727 =
       let uu____728 =
         let uu____731 = FStar_Tests_Util.app succ [one]  in [uu____731; one]
          in
