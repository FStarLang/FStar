        ...
        let uu____668 =
          let uu____671 =
            ...
            FStar_Syntax_Util.abs uu____672 uu____714
             ...
             in
          FStar_Syntax_Subst.subst
            [FStar_Syntax_Syntax.NM (minus1, Prims.int_zero)] uu____671
           in
        {
        ...
        let uu____731 =
          let uu____732 =
            let uu____746 =
              ...
              FStar_Syntax_Subst.subst
                [FStar_Syntax_Syntax.NM (minus1, Prims.int_zero)] uu____749
               in
...
let (encode_nat : Prims.int -> FStar_Syntax_Syntax.term) =
  fun n1  ->
    let rec aux out n2 =
      ...
      then out
      else (let uu____794 = snat out  in aux uu____794 (n2 - Prims.int_one))
       in
    aux znat n1
...
let (tests :
  ...
  (let uu____860 =
     ...
     (Prims.int_zero, uu____872, uu____885)  in
   let uu____894 =
     let uu____908 =
       let uu____920 =
         let uu____923 =
       ...
       (Prims.int_one, uu____920, uu____927)  in
     let uu____936 =
       let uu____950 =
         let uu____962 =
           let uu____965 =
         ...
         (Prims.int_one, uu____962, uu____976)  in
       let uu____985 =
         let uu____999 =
           let uu____1011 =
             let uu____1014 =
           ...
           ((Prims.of_int (2)), uu____1011, uu____1025)  in
         let uu____1034 =
           let uu____1048 =
             let uu____1060 =
               let uu____1063 =
             ...
             ((Prims.of_int (3)), uu____1060, uu____1089)  in
           let uu____1098 =
             let uu____1112 =
               let uu____1124 =
                 let uu____1127 =
                     ...
                     let uu____1290 =
                       ...
                       let uu____1325 =
                         let uu____1339 =
                           ...
                           ((Prims.of_int (10)), uu____1351, two)  in
                         let uu____1364 =
                           let uu____1378 =
                             let uu____1390 =
                               let uu____1393 = encode (Prims.of_int (10))
                                  in
                               let uu____1395 = encode (Prims.of_int (10))
                                  in
                               minus uu____1393 uu____1395  in
                             ((Prims.of_int (11)), uu____1390, z)  in
                           let uu____1405 =
                             let uu____1419 =
                               let uu____1431 =
                                 let uu____1434 = encode (Prims.of_int (100))
                                    in
                                 let uu____1436 = encode (Prims.of_int (100))
                                    in
                                 minus uu____1434 uu____1436  in
                               ((Prims.of_int (12)), uu____1431, z)  in
                             let uu____1446 =
                               let uu____1460 =
                                 let uu____1472 =
                                   let uu____1475 =
                                   ...
                                   let_ FStar_Tests_Util.x uu____1475
                                     uu____1477
                                    in
                                 ((Prims.of_int (13)), uu____1472, z)  in
                               let uu____1490 =
                                 let uu____1504 =
                                   let uu____1516 =
                                     let uu____1519 =
                                     ...
                                     let_ FStar_Tests_Util.x uu____1519
                                       uu____1520
                                      in
                                   ((Prims.of_int (15)), uu____1516, z)  in
                                 let uu____1557 =
                                   let uu____1571 =
                                     let uu____1583 =
                                       let uu____1586 =
                                       ...
                                       mk_let FStar_Tests_Util.x uu____1586
                                         uu____1589
                                        in
                                     ((Prims.of_int (16)), uu____1583, z)  in
                                   let uu____1624 =
                                     let uu____1638 =
                                       let uu____1650 =
                                         let uu____1653 =
      ...
      'Auu____3904 ->
        FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax ->
          (FStar_TypeChecker_Env.env ->
             'Auu____3904 -> FStar_Syntax_Syntax.term)
            -> unit
  =
  fun i  ->
    fun r  ->
      fun expected  ->
        fun normalizer  ->
          (let uu____3942 = FStar_Util.string_of_int i  in
           FStar_Util.print1 "%s: ... \n\n" uu____3942);
          (let tcenv = FStar_Tests_Pars.init ()  in
           (let uu____3947 = FStar_Main.process_args ()  in
            FStar_All.pipe_right uu____3947 (fun a1  -> ()));
           (let x1 = normalizer tcenv r  in
            ...
            FStar_Options.set_option "print_implicits"
              (FStar_Options.Bool true);
            (let uu____3970 =
               let uu____3972 = FStar_Syntax_Util.unascribe x1  in
               FStar_Tests_Util.term_eq uu____3972 expected  in
             FStar_Tests_Util.always i uu____3970)))
...
let (run_interpreter_with_time :
  ...
  fun i  ->
    fun r  ->
      fun expected  ->
        let interp uu____4051 = run_interpreter i r expected  in
        let uu____4052 =
          let uu____4053 = FStar_Util.return_execution_time interp  in
...
let (run_nbe_with_time :
  ...
  fun i  ->
    fun r  ->
      fun expected  ->
        let nbe1 uu____4091 = run_nbe i r expected  in
        let uu____4092 =
          let uu____4093 = FStar_Util.return_execution_time nbe1  in
          FStar_Pervasives_Native.snd uu____4093  in
        (i, uu____4092)
...
let run_tests :
  'Auu____4104 .
    (Prims.int ->
       FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax ->
         FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax -> 'Auu____4104)
  ...
  fun run1  ->
    ...
    (let l =
       FStar_List.map
         (fun uu___0_4156  ->
            match uu___0_4156 with | (no,test,res) -> run1 no test res) tests
        in
...
let (run_both_with_time :
  ...
  fun i  ->
    fun r  ->
      fun expected  ->
        let nbe1 uu____4293 = run_nbe i r expected  in
        let norm1 uu____4299 = run_interpreter i r expected  in
...
let (compare : unit -> unit) =
  fun uu____4312  ->
    ...
    (let uu____4315 =
       let uu____4316 = encode (Prims.of_int (1000))  in
       let uu____4318 =
         let uu____4321 = FStar_Tests_Util.nm FStar_Tests_Util.x  in
         let uu____4322 = FStar_Tests_Util.nm FStar_Tests_Util.x  in
         minus uu____4321 uu____4322  in
       let_ FStar_Tests_Util.x uu____4316 uu____4318  in
     run_both_with_time (Prims.of_int (14)) uu____4315 z)
  ...
  fun l_int  ->
    fun l_nbe  ->
      ...
      FStar_List.iter2
        (fun res1  ->
           fun res2  ->
             let uu____4398 = res1  in
             match uu____4398 with
             | (t1,time_int) ->
                 let uu____4408 = res2  in
                 (match uu____4408 with
                  | (t2,time_nbe) ->
                      if t1 = t2
                      then
                        let uu____4420 = FStar_Util.string_of_int t1  in
                        FStar_Util.print3 "Test %s\nNBE %s\nInterpreter %s\n"
                          uu____4420 (FStar_Util.string_of_float time_nbe)
...
let (run_all : unit -> unit) =
  fun uu____4431  ->
    (let uu____4433 = FStar_Syntax_Print.term_to_string znat  in
     FStar_Util.print1 "%s" uu____4433);
