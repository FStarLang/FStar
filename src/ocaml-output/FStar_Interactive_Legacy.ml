...
let uu____4846 = (FStar_Options.codegen ())
in (FStar_Option.isSome uu____4846))
...
let uu____4854 = (deps_of_our_file filename)
...
let uu____4883 = (tc_deps FStar_Pervasives_Native.None [] env filenames [])
...
let uu____4912 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (

let uu____4915 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (FStar_Range.mk_range "<input>" uu____4912 uu____4915)))
in (
