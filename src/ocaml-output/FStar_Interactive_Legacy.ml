    ...
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,env) ->
              let env1 =
                let uu___266_369 = env in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___266_369.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___266_369.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___266_369.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___266_369.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___266_369.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___266_369.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___266_369.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___266_369.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___266_369.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___266_369.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___266_369.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___266_369.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___266_369.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___266_369.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___266_369.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___266_369.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___266_369.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___266_369.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = lax1;
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___266_369.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.failhard =
                    (uu___266_369.FStar_TypeChecker_Env.failhard);
                  FStar_TypeChecker_Env.nosynth =
                    (uu___266_369.FStar_TypeChecker_Env.nosynth);
                  FStar_TypeChecker_Env.tc_term =
                    (uu___266_369.FStar_TypeChecker_Env.tc_term);
                  FStar_TypeChecker_Env.type_of =
                    (uu___266_369.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___266_369.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___266_369.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___266_369.FStar_TypeChecker_Env.qname_and_index);
                  FStar_TypeChecker_Env.proof_ns =
                    (uu___266_369.FStar_TypeChecker_Env.proof_ns);
                  FStar_TypeChecker_Env.synth =
                    (uu___266_369.FStar_TypeChecker_Env.synth);
                  FStar_TypeChecker_Env.is_native_tactic =
                    (uu___266_369.FStar_TypeChecker_Env.is_native_tactic);
                  FStar_TypeChecker_Env.identifier_info =
                    (uu___266_369.FStar_TypeChecker_Env.identifier_info);
                  FStar_TypeChecker_Env.tc_hooks =
                    (uu___266_369.FStar_TypeChecker_Env.tc_hooks)
                } in
...
let rec read_chunk: Prims.unit -> input_chunks =
  fun uu____1212  ->
    ...
    let log1 =
      ...
      else (fun uu____1330  -> ()) in
    let stdin =
      let uu____1332 = FStar_ST.op_Bang s.stdin in
      ...
      | FStar_Pervasives_Native.None  ->
          ...
          (FStar_ST.op_Colon_Equals s.stdin (FStar_Pervasives_Native.Some i);
           i) in
    let line =
      let uu____1439 = FStar_Util.read_line stdin in
    ...
    (let l = FStar_Util.trim_string line in
     ...
     then
       let responses =
         ...
         | uu____1454::ok::fail4::[] -> (ok, fail4)
         | uu____1457 -> ("ok", "fail") in
         ...
         then
           (FStar_Util.clear_string_builder s.chunk;
            (let lc_lax =
               ...
               FStar_Util.trim_string uu____1471 in
             let lc =
               match FStar_Util.split lc_lax " " with
               | l1::c::"#lax"::[] ->
                   let uu____1487 = FStar_Util.int_of_string l1 in
                   let uu____1488 = FStar_Util.int_of_string c in
                   (true, uu____1487, uu____1488)
               | l1::c::[] ->
                   let uu____1491 = FStar_Util.int_of_string l1 in
                   let uu____1492 = FStar_Util.int_of_string c in
                   (false, uu____1491, uu____1492)
               | uu____1493 ->
           ...
           then
             (match FStar_Util.split l " " with
              ...
              | uu____1515::symbol::file::row::col::[] ->
                  (FStar_Util.clear_string_builder s.chunk;
                   (let uu____1521 =
                      let uu____1536 =
                        let uu____1545 =
                          let uu____1552 = FStar_Util.int_of_string row in
                          let uu____1553 = FStar_Util.int_of_string col in
                          (file, uu____1552, uu____1553) in
                        FStar_Pervasives_Native.Some uu____1545 in
                      (symbol, false, uu____1536) in
                    Info uu____1521))
              | uu____1568 ->
...
let shift_chunk: Prims.unit -> input_chunks =
  fun uu____1587  ->
    let s = the_interactive_state in
    let uu____1589 = FStar_ST.op_Bang s.buffer in
...
let fill_buffer: Prims.unit -> Prims.unit =
  fun uu____1700  ->
    ...
    let uu____1702 =
      ...
      let uu____1758 = let uu____1761 = read_chunk () in [uu____1761] in
      FStar_List.append uu____1705 uu____1758 in
    FStar_ST.op_Colon_Equals s.buffer uu____1702
  ...
  fun filename  ->
    ...
    let uu____1827 =
      FStar_List.partition
        (fun x  ->
           let uu____1840 = FStar_Parser_Dep.lowercase_module_name x in
           let uu____1841 = FStar_Parser_Dep.lowercase_module_name filename in
           uu____1840 <> uu____1841) deps in
    ...
    | (deps1,same_name) ->
        let maybe_intf =
          ...
          | intf::impl::[] ->
              ((let uu____1868 =
                  (let uu____1871 = FStar_Parser_Dep.is_interface intf in
                   Prims.op_Negation uu____1871) ||
          ...
          | uu____1877 ->
              ((let uu____1881 =
                ...
                FStar_Util.print_warning uu____1881);
          ...
          fun ts  ->
            ...
            | uu____1936 ->
                ...
                let env1 =
                  ...
                  push_with_kind env uu____1955 true "typecheck_modul" in
                let uu____1956 = tc_one_file remaining env1 in
            ...
            let rec iterate depnames st env' ts1 good_stack good_ts =
              ...
              let rec pop_tc_and_stack env1 stack ts2 =
                ...
                | uu____2331::ts3 ->
                    (pop env1 "";
                     (let uu____2372 =
                        let uu____2387 = FStar_List.hd stack in
                        let uu____2396 = FStar_List.tl stack in
                        (uu____2387, uu____2396) in
                      match uu____2372 with
                      | ((env2,uu____2422),stack1) ->
                          pop_tc_and_stack env2 stack1 ts3)) in
              match ts1 with
              | ts_elt::ts' ->
                  let uu____2486 = ts_elt in
                  (match uu____2486 with
                   | (intf,impl,intf_t,impl_t) ->
                       let uu____2517 = match_dep depnames intf impl in
                       (match uu____2517 with
                        | (b,depnames') ->
                            ...
                            then
                              ...
                              (let uu____2557 =
                                 let uu____2572 = FStar_List.hd st in
                                 let uu____2581 = FStar_List.tl st in
                                 (uu____2572, uu____2581) in
                               match uu____2557 with
                               | (stack_elt,st') ->
                                   iterate depnames' st' env' ts' (stack_elt
                                     :: good_stack) (ts_elt :: good_ts))))
              | [] -> tc_deps m good_stack env' depnames good_ts in
            let uu____2658 = deps_of_our_file filename in
            match uu____2658 with
            | (filenames,uu____2674) ->
  ...
  fun env  ->
    fun name  ->
      fun typ  ->
        fun range  ->
          fun doc1  ->
            let uu____2755 = FStar_Range.string_of_range range in
            let uu____2756 =
            ...
            let uu____2757 =
              ...
              | FStar_Pervasives_Native.None  -> "" in
            FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2755 name
    ...
    fun filename  ->
      fun stack  ->
        fun curmod  ->
          fun env  ->
            fun ts  ->
              let uu____2791 = shift_chunk () in
              match uu____2791 with
              | Info (symbol,fqn_only,pos_opt) ->
                  let uu____2811 = env in
                  (match uu____2811 with
                   | (dsenv,tcenv) ->
                       ...
                       let info_opt =
                         ...
                         | FStar_Pervasives_Native.Some uu____2889 ->
                             info_at_pos_opt
                         | FStar_Pervasives_Native.None  ->
                             if symbol = ""
                             then FStar_Pervasives_Native.None
                               ...
                               (let lid =
                                  ...
                                  FStar_Ident.lid_of_ids uu____2944 in
                                let lid1 =
                                  if fqn_only
                                  then lid
                                  else
              ...
              | Completions search_term ->
                  let rec measure_anchored_match search_term1 candidate =
                    ...
                    | ([],uu____3159) ->
                        FStar_Pervasives_Native.Some
                          ([], (Prims.parse_int "0"))
                    | (uu____3174,[]) -> FStar_Pervasives_Native.None
                    | (hs::ts1,hc::tc) ->
                        ...
                        then
                          (match ts1 with
                           ...
                           | uu____3224 ->
                               let uu____3227 = measure_anchored_match ts1 tc in
                  ...
                  let rec locate_match needle candidate =
                    let uu____3322 = measure_anchored_match needle candidate in
                    ...
                    | FStar_Pervasives_Native.None  ->
                        (match candidate with
                         | [] -> FStar_Pervasives_Native.None
                         | hc::tc ->
                             let uu____3401 = locate_match needle tc in
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____3588 with
                         | (stripped_ns,shortened) ->
                             let uu____3615 = str_of_ids shortened in
                             let uu____3616 = str_of_ids matched in
                             let uu____3617 = str_of_ids stripped_ns in
                             (uu____3615, uu____3616, uu____3617, match_len)) in
                  let prepare_candidate uu____3635 =
                  ...
                  let matches =
                                ...
                                FStar_Option.map
                                  (fun fqn  ->
                                     let uu____3780 =
                                       ...
                                       FStar_List.append uu____3783
                                         [fqn.FStar_Ident.ident] in
                                     ([], uu____3780, matched_length))
                                  uu____3764
                              else FStar_Pervasives_Native.None)) in
                    let case_b_find_matches_in_env uu____3816 =
                      let uu____3829 = env in
                                      ...
                                      (match uu____3928 with
                                       ...
                                       | FStar_Pervasives_Native.Some l ->
                                           ...
                                           FStar_Ident.lid_equals l
                                             uu____3933))) in
                    let uu____3934 = FStar_Util.prefix needle in
                    ...
                    | (ns,id) ->
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x  ->
                                let uu____4049 = shorten_namespace x in
                                prepare_candidate uu____4049)) in
                  ((let uu____4059 =
                      FStar_Util.sort_with
                        (fun uu____4082  ->
                           fun uu____4083  ->
                             match (uu____4082, uu____4083) with
                             | ((cd1,ns1,uu____4110),(cd2,ns2,uu____4113)) ->
              ...
              | Code (text1,(ok,fail4)) ->
                  ...
                  (match res with
                   ...
                   | uu____4418 -> fail5 curmod env)
let interactive_mode: Prims.string -> Prims.unit =
  fun filename  ->
    (let uu____4438 =
       let uu____4439 = FStar_Options.codegen () in
       FStar_Option.isSome uu____4439 in
     if uu____4438
     then
       FStar_Util.print_warning
         "code-generation is not supported in interactive mode, ignoring the codegen flag"
     else ());
    (let uu____4443 = deps_of_our_file filename in
          ...
          | (stack,env1,ts) ->
              let initial_range1 =
                ...
                let uu____4495 =
                  FStar_Range.mk_pos (Prims.parse_int "1")
                    (Prims.parse_int "0") in
                FStar_Range.mk_range "<input>" uu____4494 uu____4495 in
              let env2 =
                let uu____4501 =
                  FStar_TypeChecker_Env.set_range
                    (FStar_Pervasives_Native.snd env1) initial_range1 in
                ((FStar_Pervasives_Native.fst env1), uu____4501) in
              let env3 =
              ...
              then
                let uu____4513 =
                  let uu____4514 = FStar_Options.file_list () in
                  FStar_List.hd uu____4514 in
                FStar_SMTEncoding_Solver.with_hints_db uu____4513
                  (fun uu____4518  ->
