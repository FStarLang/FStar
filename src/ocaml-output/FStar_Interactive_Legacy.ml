      ...
      fun frag  ->
        try
          (fun uu___  ->
             match () with
             | () ->
                 let uu___1 = FStar_Universal.tc_one_fragment curmod env frag
                    in
                 (match uu___1 with
                  | (m,env1) ->
                      let uu___2 =
    ...
    let log =
      ...
      then
        let transcript =
          ...
          | FStar_Pervasives_Native.None  ->
              let transcript1 = FStar_Util.open_file_for_writing "transcript"
                 in
        ...
        let uu___1 =
          FStar_List.partition
            (fun x  ->
               ...
               let uu___3 = FStar_Parser_Dep.lowercase_module_name filename
                  in
               uu___2 <> uu___3) deps
           in
        (match uu___1 with
                ...
                | uu___::ts3 ->
                    (pop env1 "";
                     (let uu___2 =
                        ...
                        let uu___4 = FStar_List.tl stack  in (uu___3, uu___4)
                         in
                      match uu___2 with
                      | ((env2,uu___3),stack1) ->
      ...
      fun typ  ->
        fun range  ->
          fun doc  ->
            ...
            let uu___1 = FStar_TypeChecker_Normalize.term_to_string env typ
               in
            let uu___2 =
              match doc with
            ...
            fun ts  ->
              ...
              | Info (symbol,fqn_only,pos_opt) ->
                           ...
                           let lid1 =
                             ...
                             then lid
                               ...
                               (let uu___3 =
                                ...
                                | FStar_Pervasives_Native.Some lid2 -> lid2)
                              in
                           let uu___2 =
                  ...
                  ((match info_opt with
                    ...
                    | FStar_Pervasives_Native.Some (name_or_lid,typ,rng) ->
                        ...
                        (match uu___2 with
                         | (name,doc) ->
                             let uu___3 = format_info env name typ rng doc
                                in
                             FStar_Util.print1 "%s\n#done-ok\n" uu___3));
              ...
              | Completions search_term ->
                  ...
                  let rec locate_match needle candidate =
                    ...
                    | FStar_Pervasives_Native.None  ->
                     ...
                     in
                  let str_of_ids ids =
                    let uu___1 = FStar_List.map FStar_Ident.string_of_id ids
                       in
                    ...
                    | (prefix,matched,match_len) ->
                        ...
                        (match uu___2 with
                         | (stripped_ns,shortened) ->
                             ...
                             (uu___3, uu___4, uu___5, match_len))
                     in
                           ...
                           (fun n  ->
                              ...
                              then
                                let lid =
                                  ...
                                  FStar_Ident.lid_of_ns_and_id uu___1 uu___2
                                   in
                                let uu___1 =
                                  FStar_Syntax_DsEnv.resolve_to_fully_qualified_name
                                    env.FStar_TypeChecker_Env.dsenv lid
                      ...
                      FStar_All.pipe_right matches1
                        (FStar_List.filter
                           (fun uu___2  ->
                              ...
                              | (ns,id,uu___3) ->
                                  let uu___4 =
                                    let uu___5 = FStar_Ident.lid_of_ids id
                                       in
                                    FStar_Syntax_DsEnv.resolve_to_fully_qualified_name
                                      env.FStar_TypeChecker_Env.dsenv uu___5
                                     in
                                  (match uu___4 with
                                   | FStar_Pervasives_Native.None  -> false
                    ...
                    FStar_List.iter
                      (fun uu___3  ->
                         ...
                         | (candidate,ns,match_len) ->
                             let uu___4 = FStar_Util.string_of_int match_len
                                in
              ...
              | Push (lax,l,c) ->
                  let uu___1 =
                    ...
                    then
                      let uu___2 = update_deps filename curmod stack env ts
                         in
                      (true, uu___2)
...
let (interactive_mode : Prims.string -> unit) =
  fun filename  ->
    (let uu___1 =
       let uu___2 = FStar_Options.codegen ()  in FStar_Option.isSome uu___2
        in
     if uu___1
     then
       FStar_Errors.log_issue FStar_Range.dummyRange
    ...
    (let uu___1 = deps_of_our_file filename  in
     ...
     | (filenames,maybe_intf,dep_graph) ->
         ...
         (match uu___2 with
          | (stack,env1,ts) ->
              let initial_range =
                let uu___3 = FStar_Range.mk_pos Prims.int_one Prims.int_zero
                   in
                let uu___4 = FStar_Range.mk_pos Prims.int_one Prims.int_zero
                   in
