...
let uu____25 = (match (remaining) with
| (intf)::(impl)::remaining1 when (FStar_Universal.needs_interleaving intf impl) -> begin
(

let uu____59 = (FStar_Universal.tc_one_file env (FStar_Pervasives_Native.Some (intf)) impl)
...
let uu____106 = (FStar_Universal.tc_one_file env FStar_Pervasives_Native.None intf_or_impl)
in (match (uu____106) with
| (uu____129, env1) -> begin
...
let uu___59_233 = env
in {FStar_TypeChecker_Env.solver = uu___59_233.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___59_233.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___59_233.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___59_233.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___59_233.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___59_233.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___59_233.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___59_233.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___59_233.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___59_233.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___59_233.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___59_233.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___59_233.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___59_233.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___59_233.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___59_233.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___59_233.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___59_233.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax1; FStar_TypeChecker_Env.lax_universes = uu___59_233.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___59_233.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___59_233.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___59_233.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___59_233.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___59_233.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.check_type_of = uu___59_233.FStar_TypeChecker_Env.check_type_of; FStar_TypeChecker_Env.use_bv_sorts = uu___59_233.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qtbl_name_and_index = uu___59_233.FStar_TypeChecker_Env.qtbl_name_and_index; FStar_TypeChecker_Env.proof_ns = uu___59_233.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth_hook = uu___59_233.FStar_TypeChecker_Env.synth_hook; FStar_TypeChecker_Env.splice = uu___59_233.FStar_TypeChecker_Env.splice; FStar_TypeChecker_Env.is_native_tactic = uu___59_233.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___59_233.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___59_233.FStar_TypeChecker_Env.tc_hooks; FStar_TypeChecker_Env.dsenv = uu___59_233.FStar_TypeChecker_Env.dsenv; FStar_TypeChecker_Env.dep_graph = uu___59_233.FStar_TypeChecker_Env.dep_graph})
in (
...
let uu____237 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right uu____237 FStar_Pervasives.ignore))
end
| uu____238 -> begin
()
end);
...
let uu____320 = (FStar_Errors.get_err_count ())
in ((m), (env1), (uu____320)))
in FStar_Pervasives_Native.Some (uu____311))
end))
end)) (fun uu___60_336 -> (match (uu___60_336) with
| FStar_Errors.Error (e, msg, r) when (

let uu____350 = (FStar_Options.trace_error ())
in (not (uu____350))) -> begin
...
let uu____374 = (FStar_Options.trace_error ())
in (not (uu____374))) -> begin
((
...
let uu____392 = (FStar_TypeChecker_Env.get_range env)
in ((e), (msg), (uu____392)))
in (uu____385)::[])
in (FStar_TypeChecker_Err.add_errors env uu____376));
FStar_Pervasives_Native.None;
)
end))))


let report_fail : Prims.unit  ->  Prims.unit = (fun uu____415 -> ((

let uu____417 = (FStar_Errors.report_all ())
in (FStar_All.pipe_right uu____417 FStar_Pervasives.ignore));
(FStar_Errors.clear ());
))
...
let uu____1294 = (FStar_Util.new_string_builder ())
in (

let uu____1295 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in (

let uu____1302 = (FStar_Util.mk_ref [])
in (

let uu____1309 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in {chunk = uu____1294; stdin = uu____1295; buffer = uu____1302; log = uu____1309}))))


let rec read_chunk : Prims.unit  ->  input_chunks = (fun uu____1528 -> (
...
let uu____1533 = (FStar_Options.debug_any ())
...
let uu____1537 = (FStar_ST.op_Bang s.log)
...
let uu____1606 = (FStar_ST.op_Bang s.stdin)
...
let uu____1671 = (FStar_Util.read_line stdin)
...
let uu____1703 = (FStar_Util.substring_from l (FStar_String.length "#push"))
in (FStar_Util.trim_string uu____1703))
in (
...
let uu____1719 = (FStar_Util.int_of_string l1)
in (

let uu____1720 = (FStar_Util.int_of_string c)
in ((true), (uu____1719), (uu____1720))))
end
| (l1)::(c)::[] -> begin
(

let uu____1723 = (FStar_Util.int_of_string l1)
in (

let uu____1724 = (FStar_Util.int_of_string c)
in ((false), (uu____1723), (uu____1724))))
end
| uu____1725 -> begin
...
| (uu____1730)::(symbol)::[] -> begin
((FStar_Util.clear_string_builder s.chunk);
Info (((symbol), (true), (FStar_Pervasives_Native.None)));
)
end
| (uu____1747)::(symbol)::(file)::(row)::(col)::[] -> begin
((FStar_Util.clear_string_builder s.chunk);
(
...
let uu____1784 = (FStar_Util.int_of_string row)
in (

let uu____1785 = (FStar_Util.int_of_string col)
in ((file), (uu____1784), (uu____1785))))
in FStar_Pervasives_Native.Some (uu____1777))
in ((symbol), (false), (uu____1768)))
in Info (uu____1753));
)
end
| uu____1800 -> begin
...
let shift_chunk : Prims.unit  ->  input_chunks = (fun uu____1818 -> (

let s = the_interactive_state
in (

let uu____1820 = (FStar_ST.op_Bang s.buffer)
...
let fill_buffer : Prims.unit  ->  Prims.unit = (fun uu____1888 -> (
...
let uu____1893 = (FStar_ST.op_Bang s.buffer)
in (

let uu____1925 = (

let uu____1928 = (read_chunk ())
in (uu____1928)::[])
in (FStar_List.append uu____1893 uu____1925)))
in (FStar_ST.op_Colon_Equals s.buffer uu____1890))))
...
let uu____1971 = (FStar_Dependencies.find_deps_if_needed ((filename)::[]))
in (match (uu____1971) with
| (deps, dep_graph1) -> begin
(

let uu____1994 = (FStar_List.partition (fun x -> (

let uu____2007 = (FStar_Parser_Dep.lowercase_module_name x)
in (

let uu____2008 = (FStar_Parser_Dep.lowercase_module_name filename)
in (Prims.op_disEquality uu____2007 uu____2008)))) deps)
...
let uu____2040 = (FStar_Parser_Dep.is_interface intf)
in (not (uu____2040))) || (

let uu____2042 = (FStar_Parser_Dep.is_implementation impl)
in (not (uu____2042))))
...
let uu____2048 = (FStar_Util.format2 "Found %s and %s but not an interface + implementation" intf impl)
in ((FStar_Errors.Warning_MissingInterfaceOrImplementation), (uu____2048)))
in (FStar_Errors.log_issue FStar_Range.dummyRange uu____2043))
end
| uu____2049 -> begin
()
end));
...
let uu____2060 = (FStar_Util.format1 "Unexpected: ended up with %s" (FStar_String.concat " " same_name))
in ((FStar_Errors.Warning_UnexpectedFile), (uu____2060)))
in (FStar_Errors.log_issue FStar_Range.dummyRange uu____2055));
FStar_Pervasives_Native.None;
)
end)
...
let uu____2125 = (FStar_Options.lax ())
in (push_with_kind env uu____2125 true "typecheck_modul"))
in (

let uu____2126 = (tc_one_file remaining env1)
...
let uu____2178 = (FStar_Parser_ParseIt.get_file_last_modification_time intf1)
in FStar_Pervasives_Native.Some (uu____2178))
end
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end)
...
| (uu____2468)::ts3 -> begin
((pop env1 "");
(

let uu____2509 = (

let uu____2524 = (FStar_List.hd stack)
in (

let uu____2533 = (FStar_List.tl stack)
in ((uu____2524), (uu____2533))))
in (match (uu____2509) with
| ((env2, uu____2555), stack1) -> begin
...
let uu____2619 = ts_elt
in (match (uu____2619) with
| (intf, impl, intf_t, impl_t) -> begin
(

let uu____2650 = (match_dep depnames intf impl)
in (match (uu____2650) with
| (b, depnames') -> begin
(

let uu____2669 = ((not (b)) || (is_stale intf impl intf_t impl_t))
...
let uu____2701 = (FStar_List.hd st)
in (

let uu____2710 = (FStar_List.tl st)
in ((uu____2701), (uu____2710))))
...
let uu____2787 = (deps_of_our_file filename)
in (match (uu____2787) with
| (filenames, uu____2805, dep_graph1) -> begin
...
let uu____2882 = (FStar_Range.string_of_range range)
in (

let uu____2883 = (FStar_TypeChecker_Normalize.term_to_string env typ)
in (

let uu____2884 = (match (doc1) with
...
in (FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2882 name uu____2883 uu____2884)))))
...
| FStar_Pervasives_Native.Some (uu____3007) -> begin
info_at_pos_opt
end
| FStar_Pervasives_Native.None -> begin
...
let uu____3062 = (FStar_List.map FStar_Ident.id_of_text (FStar_Util.split symbol "."))
in (FStar_Ident.lid_of_ids uu____3062))
in (
...
let uu____3067 = (FStar_Syntax_DsEnv.resolve_to_fully_qualified_name env.FStar_TypeChecker_Env.dsenv lid)
...
let uu____3071 = (FStar_TypeChecker_Env.try_lookup_lid env lid1)
in (FStar_All.pipe_right uu____3071 (FStar_Util.map_option (fun uu____3126 -> (match (uu____3126) with
| ((uu____3145, typ), r) -> begin
...
let uu____3188 = (match (name_or_lid) with
...
let uu____3209 = (FStar_Syntax_DsEnv.try_lookup_doc env.FStar_TypeChecker_Env.dsenv lid)
in (FStar_All.pipe_right uu____3209 (FStar_Util.map_option FStar_Pervasives_Native.fst)))
in ((uu____3205), (uu____3206))))
end)
in (match (uu____3188) with
| (name, doc1) -> begin
(

let uu____3240 = (format_info env name typ rng doc1)
...
let uu____3345 = (measure_anchored_match ts1 tc1)
in (FStar_All.pipe_right uu____3345 (FStar_Util.map_option (fun uu____3385 -> (match (uu____3385) with
| (matched, len) -> begin
...
let uu____3440 = (measure_anchored_match needle candidate)
...
let uu____3519 = (locate_match needle tc1)
in (FStar_All.pipe_right uu____3519 (FStar_Util.map_option (fun uu____3580 -> (match (uu____3580) with
...
let uu____3624 = (FStar_List.map FStar_Ident.text_of_id ids)
in (FStar_Util.concat_l "." uu____3624)))
in (
...
let shorten_namespace = (fun uu____3671 -> (match (uu____3671) with
...
let uu____3706 = (FStar_Syntax_DsEnv.shorten_module_path env.FStar_TypeChecker_Env.dsenv prefix1 naked_match)
in (match (uu____3706) with
| (stripped_ns, shortened) -> begin
(

let uu____3733 = (str_of_ids shortened)
in (

let uu____3734 = (str_of_ids matched)
in (

let uu____3735 = (str_of_ids stripped_ns)
in ((uu____3733), (uu____3734), (uu____3735), (match_len)))))
end)))
end))
in (

let prepare_candidate = (fun uu____3753 -> (match (uu____3753) with
...
let uu____3881 = (FStar_Syntax_DsEnv.resolve_to_fully_qualified_name env.FStar_TypeChecker_Env.dsenv lid)
in (FStar_Option.map (fun fqn -> (

let uu____3897 = (

let uu____3900 = (FStar_List.map FStar_Ident.id_of_text orig_ns)
in (FStar_List.append uu____3900 ((fqn.FStar_Ident.ident)::[])))
in (([]), (uu____3897), (matched_length)))) uu____3881)))
end
| uu____3907 -> begin
FStar_Pervasives_Native.None
end)))))))
...
let case_b_find_matches_in_env = (fun uu____3933 -> (

let matches = (FStar_List.filter_map (match_lident_against needle) all_lidents_in_env)
in (FStar_All.pipe_right matches (FStar_List.filter (fun uu____4008 -> (match (uu____4008) with
| (ns, id1, uu____4021) -> begin
(

let uu____4030 = (

let uu____4033 = (FStar_Ident.lid_of_ids id1)
in (FStar_Syntax_DsEnv.resolve_to_fully_qualified_name env.FStar_TypeChecker_Env.dsenv uu____4033))
...
let uu____4035 = (FStar_Ident.lid_of_ids (FStar_List.append ns id1))
in (FStar_Ident.lid_equals l uu____4035))
end))
end))))))
in (

let uu____4036 = (FStar_Util.prefix needle)
...
let uu____4086 = (FStar_Syntax_DsEnv.resolve_module_name env.FStar_TypeChecker_Env.dsenv l true)
...
let uu____4151 = (shorten_namespace x)
in (prepare_candidate uu____4151))))))
end))))
in ((

let uu____4161 = (FStar_Util.sort_with (fun uu____4184 uu____4185 -> (match (((uu____4184), (uu____4185))) with
| ((cd1, ns1, uu____4212), (cd2, ns2, uu____4215)) -> begin
...
in (FStar_List.iter (fun uu____4240 -> (match (uu____4240) with
| (candidate, ns, match_len) -> begin
(

let uu____4250 = (FStar_Util.string_of_int match_len)
in (FStar_Util.print3 "%s %s %s \n" uu____4250 ns candidate))
end)) uu____4161));
...
let uu____4254 = (match (stack) with
| [] -> begin
...
let uu____4350 = (match ((Prims.op_Equality (FStar_List.length stack) (FStar_List.length ts))) with
| true -> begin
(

let uu____4387 = (update_deps filename curmod stack env ts)
in ((true), (uu____4387)))
end
| uu____4400 -> begin
((false), (((stack), (env), (ts))))
...
let uu____4490 = (FStar_Options.codegen ())
in (FStar_Option.isSome uu____4490))
...
let uu____4494 = (deps_of_our_file filename)
...
let uu____4517 = (tc_deps FStar_Pervasives_Native.None [] env filenames [])
...
let uu____4544 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (

let uu____4545 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (FStar_Range.mk_range "<input>" uu____4544 uu____4545)))
in (
...
let uu____4549 = ((FStar_Options.record_hints ()) || (FStar_Options.use_hints ()))
...
let uu____4551 = (FStar_Options.file_list ())
in (FStar_List.hd uu____4551))
in (FStar_SMTEncoding_Solver.with_hints_db uu____4550 (fun uu____4555 -> (go (((Prims.parse_int "1")), ((Prims.parse_int "0"))) filename stack FStar_Pervasives_Native.None env3 ts))))
end
| uu____4556 -> begin
