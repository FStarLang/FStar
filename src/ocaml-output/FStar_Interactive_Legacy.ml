  ...
  fun env  ->
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          let env1 =
            let uu___58_267 = env  in
            {
              FStar_TypeChecker_Env.solver =
                (uu___58_267.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___58_267.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___58_267.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___58_267.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___58_267.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___58_267.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___58_267.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___58_267.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___58_267.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___58_267.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___58_267.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___58_267.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___58_267.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___58_267.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___58_267.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___58_267.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___58_267.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___58_267.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax = lax1;
              FStar_TypeChecker_Env.lax_universes =
                (uu___58_267.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___58_267.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___58_267.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___58_267.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___58_267.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___58_267.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___58_267.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___58_267.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___58_267.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___58_267.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.proof_ns =
                (uu___58_267.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___58_267.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___58_267.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___58_267.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___58_267.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___58_267.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___58_267.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.dep_graph =
                (uu___58_267.FStar_TypeChecker_Env.dep_graph)
            }  in
...
let check_frag :
  ...
  fun env  ->
    fun curmod  ->
      fun frag  ->
        try
          let uu____328 = FStar_Universal.tc_one_fragment curmod env frag  in
          match uu____328 with
          | (m,env1) ->
              let uu____351 =
                let uu____360 = FStar_Errors.get_err_count ()  in
                (m, env1, uu____360)  in
              FStar_Pervasives_Native.Some uu____351
        with
        ...
        | FStar_Errors.Err (e,msg) when
            let uu____414 = FStar_Options.trace_error ()  in
            Prims.op_Negation uu____414 ->
            ((let uu____416 =
                let uu____425 =
                  let uu____432 = FStar_TypeChecker_Env.get_range env  in
                  (e, msg, uu____432)  in
                [uu____425]  in
              FStar_TypeChecker_Err.add_errors env uu____416);
             FStar_Pervasives_Native.None)
...
let uu___is_Push : input_chunks -> Prims.bool =
  fun projectee  ->
    match projectee with | Push _0 -> true | uu____529 -> false
...
let uu___is_Info : input_chunks -> Prims.bool =
  fun projectee  ->
    match projectee with | Info _0 -> true | uu____635 -> false
...
let uu___is_Completions : input_chunks -> Prims.bool =
  fun projectee  ->
    match projectee with | Completions _0 -> true | uu____691 -> false
...
let the_interactive_state : interactive_state =
  let uu____1001 = FStar_Util.new_string_builder ()  in
  let uu____1002 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
  let uu____1009 = FStar_Util.mk_ref []  in
  let uu____1016 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
  {
    chunk = uu____1001;
    stdin = uu____1002;
    buffer = uu____1009;
...
let rec read_chunk : unit -> input_chunks =
  fun uu____1093  ->
    ...
    let log1 =
      let uu____1100 = FStar_Options.debug_any ()  in
      if uu____1100
      then
        let transcript =
          let uu____1105 = FStar_ST.op_Bang s.log  in
      ...
      else (fun uu____1168  -> ())  in
    let stdin =
      let uu____1170 = FStar_ST.op_Bang s.stdin  in
      ...
      | FStar_Pervasives_Native.None  ->
       ...
       in
    let line =
      let uu____1231 = FStar_Util.read_line stdin  in
    ...
    (let l = FStar_Util.trim_string line  in
     ...
     then
       let responses =
         ...
         | uu____1246::ok::fail1::[] -> (ok, fail1)
         | uu____1249 -> ("ok", "fail")  in
         ...
         then
            ...
            (let lc_lax =
               let uu____1263 =
                 FStar_Util.substring_from l (FStar_String.length "#push")
                  in
               FStar_Util.trim_string uu____1263  in
             let lc =
               match FStar_Util.split lc_lax " " with
               | l1::c::"#lax"::[] ->
                   let uu____1279 = FStar_Util.int_of_string l1  in
                   let uu____1280 = FStar_Util.int_of_string c  in
                   (true, uu____1279, uu____1280)
               | l1::c::[] ->
                   let uu____1283 = FStar_Util.int_of_string l1  in
                   let uu____1284 = FStar_Util.int_of_string c  in
                   (false, uu____1283, uu____1284)
               | uu____1285 ->
           ...
           then
             (match FStar_Util.split l " " with
              ...
              | uu____1307::symbol::file::row::col::[] ->
                  (FStar_Util.clear_string_builder s.chunk;
                   (let uu____1313 =
                      let uu____1328 =
                        let uu____1337 =
                          let uu____1344 = FStar_Util.int_of_string row  in
                          let uu____1345 = FStar_Util.int_of_string col  in
                          (file, uu____1344, uu____1345)  in
                        FStar_Pervasives_Native.Some uu____1337  in
                      (symbol, false, uu____1328)  in
                    Info uu____1313))
              | uu____1360 ->
                  (FStar_Errors.log_issue FStar_Range.dummyRange
             ...
             then
               ...
               if l = "#finish"
               then FStar_All.exit (Prims.lift_native_int (0))
               else
...
let shift_chunk : unit -> input_chunks =
  fun uu____1380  ->
    let s = the_interactive_state  in
    let uu____1382 = FStar_ST.op_Bang s.buffer  in
...
let fill_buffer : unit -> unit =
  fun uu____1448  ->
    let s = the_interactive_state  in
    let uu____1450 =
      let uu____1453 = FStar_ST.op_Bang s.buffer  in
      let uu____1483 = let uu____1486 = read_chunk ()  in [uu____1486]  in
      FStar_List.append uu____1453 uu____1483  in
    FStar_ST.op_Colon_Equals s.buffer uu____1450
...
let deps_of_our_file :
  ...
  =
  fun filename  ->
    let uu____1529 = FStar_Dependencies.find_deps_if_needed [filename]  in
    match uu____1529 with
    | (deps,dep_graph1) ->
        let uu____1552 =
          FStar_List.partition
            (fun x  ->
               let uu____1565 = FStar_Parser_Dep.lowercase_module_name x  in
               let uu____1566 =
                 FStar_Parser_Dep.lowercase_module_name filename  in
               uu____1565 <> uu____1566) deps
           in
                   ...
                   ((let uu____1613 =
                       let uu____1618 =
                         FStar_Util.format1 "Unexpected: ended up with %s"
                          ...
                          in
                       (FStar_Errors.Warning_UnexpectedFile, uu____1618)  in
                     FStar_Errors.log_issue FStar_Range.dummyRange uu____1613);
                    FStar_Pervasives_Native.None)
                in
          ...
          fun ts  ->
            ...
            | uu____1678 ->
                ...
                let env1 =
                  ...
                  push_with_kind env uu____1693 true "typecheck_modul"  in
                let uu____1694 = tc_one_file remaining env1  in
                         ...
                         | FStar_Pervasives_Native.Some intf1 ->
                             let uu____1746 =
                               FStar_Parser_ParseIt.get_file_last_modification_time
                                 intf1
                                in
                             FStar_Pervasives_Native.Some uu____1746
                         | FStar_Pervasives_Native.None  ->
                             FStar_Pervasives_Native.None
                          in
                       let impl_t =
      ...
      fun stk  ->
        fun env  ->
          fun ts  ->
            ...
            let rec iterate depnames st env' ts1 good_stack good_ts =
              ...
              let rec pop_tc_and_stack env1 stack ts2 =
                ...
                | uu____2078::ts3 ->
                    (pop env1 "";
                     (let uu____2119 =
                        let uu____2134 = FStar_List.hd stack  in
                        let uu____2143 = FStar_List.tl stack  in
                        (uu____2134, uu____2143)  in
                      match uu____2119 with
                      | ((env2,uu____2165),stack1) ->
                          pop_tc_and_stack env2 stack1 ts3))
                 in
              match ts1 with
              | ts_elt::ts' ->
                  let uu____2229 = ts_elt  in
                  (match uu____2229 with
                   | (intf,impl,intf_t,impl_t) ->
                       let uu____2260 = match_dep depnames intf impl  in
                       (match uu____2260 with
                        | (b,depnames') ->
                            ...
                            then
                              ...
                              (let uu____2296 =
                                 let uu____2311 = FStar_List.hd st  in
                                 let uu____2320 = FStar_List.tl st  in
            ...
            let uu____2397 = deps_of_our_file filename  in
            match uu____2397 with
            | (filenames,uu____2415,dep_graph1) ->
  ...
  fun env  ->
    fun name  ->
      fun typ  ->
        fun range  ->
          fun doc1  ->
            let uu____2502 = FStar_Range.string_of_range range  in
            let uu____2503 =
            ...
            FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2502 name
              uu____2503 uu____2504
            ...
            fun ts  ->
              ...
              | Info (symbol,fqn_only,pos_opt) ->
                  ...
                  let info_opt =
                    ...
                    | FStar_Pervasives_Native.Some uu____2639 ->
                        info_at_pos_opt
                    | FStar_Pervasives_Native.None  ->
                        if symbol = ""
                          ...
                          (let lid =
                             let uu____2694 =
                               FStar_List.map FStar_Ident.id_of_text
                                ...
                                in
                             FStar_Ident.lid_of_ids uu____2694  in
                           let lid1 =
                             if fqn_only
                             then lid
                             else
                           ...
                           let uu____2703 =
                             FStar_TypeChecker_Env.try_lookup_lid env lid1
                              in
                           FStar_All.pipe_right uu____2703
                  ...
                  ((match info_opt with
                    ...
                    | FStar_Pervasives_Native.Some (name_or_lid,typ,rng) ->
                        let uu____2820 =
                          ...
                          | FStar_Util.Inr lid ->
                              let uu____2837 = FStar_Ident.string_of_lid lid
                                 in
                              let uu____2838 =
                                let uu____2841 =
                                  FStar_Syntax_DsEnv.try_lookup_doc
                                    env.FStar_TypeChecker_Env.dsenv lid
                                   in
                                FStar_All.pipe_right uu____2841
                                  (FStar_Util.map_option
              ...
              | Completions search_term ->
                        ...
                        then
                          (match ts1 with
                           ...
                           | uu____2978 ->
                               ...
                               FStar_All.pipe_right uu____2981
                                 (FStar_Util.map_option
                                    (fun uu____3021  ->
                  ...
                  let rec locate_match needle candidate =
                    let uu____3080 = measure_anchored_match needle candidate
                       in
                    ...
                    | FStar_Pervasives_Native.None  ->
                        (match candidate with
                         | [] -> FStar_Pervasives_Native.None
                         | hc::tc1 ->
                             let uu____3159 = locate_match needle tc1  in
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____3354 with
                         | (stripped_ns,shortened) ->
                             let uu____3381 = str_of_ids shortened  in
                             let uu____3382 = str_of_ids matched  in
                             let uu____3383 = str_of_ids stripped_ns  in
                             (uu____3381, uu____3382, uu____3383, match_len))
                     in
                  let prepare_candidate uu____3403 =
                  ...
                  let matches =
                      ...
                      FStar_All.pipe_right exported_names
                        (FStar_List.filter_map
                           (fun n1  ->
                              ...
                              then
                                let lid =
                                  let uu____3537 = FStar_Ident.ids_of_lid m
                                     in
                                  let uu____3540 = FStar_Ident.id_of_text n1
                                     in
                                  FStar_Ident.lid_of_ns_and_id uu____3537
                                    uu____3540
                                   in
                                let uu____3541 =
                                  FStar_Syntax_DsEnv.resolve_to_fully_qualified_name
                                     ...
                                     let uu____3557 =
                                       let uu____3560 =
                                         FStar_List.map
                                          ...
                                          in
                                       FStar_List.append uu____3560
                                         [fqn.FStar_Ident.ident]
                                        in
                                     ([], uu____3557, matched_length))
                                  uu____3541
                              else FStar_Pervasives_Native.None))
                       in
                    let case_b_find_matches_in_env uu____3595 =
                      let matches =
                                   ...
                                   | FStar_Pervasives_Native.Some l ->
                                       let uu____3697 =
                                         FStar_Ident.lid_of_ids
                                          ...
                                          in
                                       FStar_Ident.lid_equals l uu____3697)))
                       in
                    let uu____3698 = FStar_Util.prefix needle  in
                    ...
                    | (ns,id1) ->
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x  ->
                                let uu____3813 = shorten_namespace x  in
                                prepare_candidate uu____3813))
                     in
                  ((let uu____3823 =
              ...
              | Code (text,(ok,fail1)) ->
                  ...
                  (match res with
                   | FStar_Pervasives_Native.Some (curmod1,env1,n_errs) ->
                       if n_errs = (Prims.lift_native_int (0))
                       then
                         (FStar_Util.print1 "\n%s\n" ok;
                          go line_col filename stack curmod1 env1 ts)
                       else fail2 curmod1 env1
                   | uu____4140 -> fail2 curmod env)
  
let interactive_mode : Prims.string -> unit =
  fun filename  ->
    (let uu____4157 =
       let uu____4158 = FStar_Options.codegen ()  in
       FStar_Option.isSome uu____4158  in
     if uu____4157
     then
       FStar_Errors.log_issue FStar_Range.dummyRange
    ...
    (let uu____4162 = deps_of_our_file filename  in
     ...
     | (filenames,maybe_intf,dep_graph1) ->
         ...
         (match uu____4185 with
          | (stack,env1,ts) ->
              let initial_range =
                ...
                let uu____4213 =
                  FStar_Range.mk_pos (Prims.lift_native_int (1))
                    (Prims.lift_native_int (0))
                   in
                FStar_Range.mk_range "<input>" uu____4212 uu____4213  in
              ...
              then
                let uu____4218 =
                  let uu____4219 = FStar_Options.file_list ()  in
                  FStar_List.hd uu____4219  in
                FStar_SMTEncoding_Solver.with_hints_db uu____4218
                  (fun uu____4223  ->
                     go
                       ((Prims.lift_native_int (1)),
                         (Prims.lift_native_int (0))) filename stack
                       FStar_Pervasives_Native.None env3 ts)
              else
                go ((Prims.lift_native_int (1)), (Prims.lift_native_int (0)))
