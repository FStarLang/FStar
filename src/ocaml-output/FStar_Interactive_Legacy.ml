  ...
  fun env  ->
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          let env1 =
            let uu___557_265 = env in
            {
              FStar_TypeChecker_Env.solver =
                (uu___557_265.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___557_265.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___557_265.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___557_265.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___557_265.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___557_265.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___557_265.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___557_265.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___557_265.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___557_265.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___557_265.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___557_265.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___557_265.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___557_265.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___557_265.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___557_265.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___557_265.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___557_265.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax = lax1;
              FStar_TypeChecker_Env.lax_universes =
                (uu___557_265.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___557_265.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___557_265.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___557_265.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___557_265.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___557_265.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___557_265.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qname_and_index =
                (uu___557_265.FStar_TypeChecker_Env.qname_and_index);
              FStar_TypeChecker_Env.proof_ns =
                (uu___557_265.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth =
                (uu___557_265.FStar_TypeChecker_Env.synth);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___557_265.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___557_265.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___557_265.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___557_265.FStar_TypeChecker_Env.dsenv)
            } in
...
let check_frag:
  ...
  fun env  ->
    fun curmod  ->
      fun frag  ->
        try
          let uu____323 = FStar_Universal.tc_one_fragment curmod env frag in
          match uu____323 with
          | (m,env1) ->
              let uu____346 =
                let uu____355 = FStar_Errors.get_err_count () in
                (m, env1, uu____355) in
              FStar_Pervasives_Native.Some uu____346
        with
        | FStar_Errors.Error (msg,r) when
            let uu____383 = FStar_Options.trace_error () in
            Prims.op_Negation uu____383 ->
            (FStar_TypeChecker_Err.add_errors env [(msg, r)];
             FStar_Pervasives_Native.None)
        | FStar_Errors.Err msg when
            let uu____402 = FStar_Options.trace_error () in
            Prims.op_Negation uu____402 ->
            ((let uu____404 =
                let uu____411 =
                  let uu____416 = FStar_TypeChecker_Env.get_range env in
                  (msg, uu____416) in
                [uu____411] in
              FStar_TypeChecker_Err.add_errors env uu____404);
             FStar_Pervasives_Native.None)
let report_fail: Prims.unit -> Prims.unit =
  fun uu____436  ->
    (let uu____438 = FStar_Errors.report_all () in
     FStar_All.pipe_right uu____438 FStar_Pervasives.ignore);
    FStar_Errors.clear ()
type input_chunks =
...
let uu___is_Push: input_chunks -> Prims.bool =
  fun projectee  ->
    match projectee with | Push _0 -> true | uu____504 -> false
...
let uu___is_Info: input_chunks -> Prims.bool =
  fun projectee  ->
    match projectee with | Info _0 -> true | uu____610 -> false
...
let uu___is_Completions: input_chunks -> Prims.bool =
  fun projectee  ->
    match projectee with | Completions _0 -> true | uu____666 -> false
...
let the_interactive_state: interactive_state =
  let uu____909 = FStar_Util.new_string_builder () in
  let uu____910 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
  let uu____917 = FStar_Util.mk_ref [] in
  let uu____924 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
  { chunk = uu____909; stdin = uu____910; buffer = uu____917; log = uu____924
  }
let rec read_chunk: Prims.unit -> input_chunks =
  fun uu____976  ->
    let s = the_interactive_state in
    let log1 =
      let uu____981 = FStar_Options.debug_any () in
      if uu____981
      then
        let transcript =
          let uu____985 = FStar_ST.op_Bang s.log in
      ...
      else (fun uu____1094  -> ()) in
    let stdin =
      let uu____1096 = FStar_ST.op_Bang s.stdin in
...
let fill_buffer: Prims.unit -> Prims.unit =
  fun uu____1464  ->
    let s = the_interactive_state in
    let uu____1466 =
      let uu____1469 = FStar_ST.op_Bang s.buffer in
      let uu____1522 = let uu____1525 = read_chunk () in [uu____1525] in
      FStar_List.append uu____1469 uu____1522 in
    FStar_ST.op_Colon_Equals s.buffer uu____1466
  ...
  fun filename  ->
    ...
    let uu____1591 =
      FStar_List.partition
        (fun x  ->
           let uu____1604 = FStar_Parser_Dep.lowercase_module_name x in
           let uu____1605 = FStar_Parser_Dep.lowercase_module_name filename in
           uu____1604 <> uu____1605) deps in
              ...
              ((let uu____1632 =
                  (let uu____1635 = FStar_Parser_Dep.is_interface intf in
                   Prims.op_Negation uu____1635) ||
                    (let uu____1637 = FStar_Parser_Dep.is_implementation impl in
