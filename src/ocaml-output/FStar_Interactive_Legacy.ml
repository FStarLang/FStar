  ...
  fun env  ->
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          let env1 =
            let uu___340_233 = env in
            {
              FStar_TypeChecker_Env.solver =
                (uu___340_233.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___340_233.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___340_233.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___340_233.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___340_233.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___340_233.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___340_233.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___340_233.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___340_233.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___340_233.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___340_233.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___340_233.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___340_233.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___340_233.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___340_233.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___340_233.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___340_233.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___340_233.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax = lax1;
              FStar_TypeChecker_Env.lax_universes =
                (uu___340_233.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___340_233.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___340_233.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___340_233.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___340_233.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___340_233.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___340_233.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qname_and_index =
                (uu___340_233.FStar_TypeChecker_Env.qname_and_index);
              FStar_TypeChecker_Env.proof_ns =
                (uu___340_233.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth =
                (uu___340_233.FStar_TypeChecker_Env.synth);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___340_233.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___340_233.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___340_233.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___340_233.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.dep_graph =
                (uu___340_233.FStar_TypeChecker_Env.dep_graph)
            } in
         ...
         then
             ...
             let lc =
               ...
               | uu____1221 ->
                   (FStar_Errors.maybe_fatal_err
                      (FStar_Errors.WrongErrorLocation,
                        (Prims.strcat
           ...
           then
             (match FStar_Util.split l " " with
              ...
              | uu____1296 ->
                  (FStar_Errors.maybe_fatal_err
                     ((FStar_Errors.IDEUnrecognized "info"),
             ...
             then
               (match FStar_Util.split l " " with
                ...
                | uu____1304 ->
                    (FStar_Errors.maybe_fatal_err
                       ((FStar_Errors.IDEUnrecognized "completion"),
                         (Prims.strcat
             ...
             let maybe_intf =
                       ...
                       let uu____1623 =
                         let uu____1628 =
                           FStar_Util.format2
                             ...
                             intf impl in
                         (FStar_Errors.MissingInterfaceOrImplementation,
                           uu____1628) in
                       FStar_Errors.maybe_fatal_err uu____1623
                     else ());
               ...
               | uu____1631 ->
                   ((let uu____1635 =
                       ...
                       (FStar_Errors.UnexpectedFile, uu____1640) in
                     FStar_Errors.maybe_fatal_err uu____1635);
        ...
        fun remaining  ->
          fun ts  ->
            ...
            | uu____1690 ->
                ...
                let env1 =
                  let uu____1705 = FStar_Options.lax () in
                  push_with_kind env uu____1705 true "typecheck_modul" in
                let uu____1706 = tc_one_file remaining env1 in
                         ...
                         | FStar_Pervasives_Native.Some intf1 ->
                             let uu____1758 =
                               FStar_Parser_ParseIt.get_file_last_modification_time
                                 intf1 in
                             FStar_Pervasives_Native.Some uu____1758
                         | FStar_Pervasives_Native.None  ->
                             FStar_Pervasives_Native.None in
                       let impl_t =
                         FStar_Parser_ParseIt.get_file_last_modification_time
            ...
            let rec iterate depnames st env' ts1 good_stack good_ts =
              ...
              let rec pop_tc_and_stack env1 stack ts2 =
                ...
                | uu____2048::ts3 ->
                    (pop env1 "";
                     (let uu____2089 =
                        let uu____2104 = FStar_List.hd stack in
                        let uu____2113 = FStar_List.tl stack in
                        (uu____2104, uu____2113) in
                      match uu____2089 with
                      | ((env2,uu____2135),stack1) ->
                          pop_tc_and_stack env2 stack1 ts3)) in
              match ts1 with
              | ts_elt::ts' ->
                  let uu____2199 = ts_elt in
                  (match uu____2199 with
                   | (intf,impl,intf_t,impl_t) ->
                       let uu____2230 = match_dep depnames intf impl in
                       (match uu____2230 with
                        | (b,depnames') ->
                            ...
                            then
                              ...
                              (let uu____2266 =
                                 let uu____2281 = FStar_List.hd st in
                                 let uu____2290 = FStar_List.tl st in
                                 (uu____2281, uu____2290) in
  ...
  fun env  ->
    fun name  ->
      fun typ  ->
        fun range  ->
          fun doc1  ->
            let uu____2462 = FStar_Range.string_of_range range in
            let uu____2463 =
            ...
            let uu____2464 =
              ...
              | FStar_Pervasives_Native.None  -> "" in
            FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2462 name
            ...
            fun ts  ->
                  ...
                  ((match info_opt with
                    ...
                    | FStar_Pervasives_Native.Some (name_or_lid,typ,rng) ->
                        let uu____2768 =
                          ...
                          | FStar_Util.Inr lid ->
                              let uu____2785 = FStar_Ident.string_of_lid lid in
                              let uu____2786 =
                                let uu____2789 =
              ...
              | Completions search_term ->
                  let rec measure_anchored_match search_term1 candidate =
                    ...
                    | ([],uu____2857) ->
                        FStar_Pervasives_Native.Some
                          ([], (Prims.parse_int "0"))
                    | (uu____2872,[]) -> FStar_Pervasives_Native.None
                    | (hs::ts1,hc::tc1) ->
                  ...
                  let rec locate_match needle candidate =
                    let uu____3020 = measure_anchored_match needle candidate in
                    ...
                    | FStar_Pervasives_Native.None  ->
                        (match candidate with
                         | [] -> FStar_Pervasives_Native.None
                         | hc::tc1 ->
                             let uu____3099 = locate_match needle tc1 in
                             FStar_All.pipe_right uu____3099
                               (FStar_Util.map_option
                                  (fun uu____3160  ->
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____3286 with
                         | (stripped_ns,shortened) ->
                             let uu____3313 = str_of_ids shortened in
                             let uu____3314 = str_of_ids matched in
                             let uu____3315 = str_of_ids stripped_ns in
                             (uu____3313, uu____3314, uu____3315, match_len)) in
                  let prepare_candidate uu____3333 =
                  ...
                  let matches =
                                ...
                                FStar_Option.map
                                  (fun fqn  ->
                                     let uu____3477 =
                                       ...
                                       FStar_List.append uu____3480
                                         [fqn.FStar_Ident.ident] in
                                     ([], uu____3477, matched_length))
                                  uu____3461
                              else FStar_Pervasives_Native.None)) in
                    let case_b_find_matches_in_env uu____3513 =
                      let matches =
                              ...
                              | (ns,id1,uu____3601) ->
                                  ...
                                  (match uu____3610 with
                                   ...
                                   | FStar_Pervasives_Native.Some l ->
                                       ...
                                       FStar_Ident.lid_equals l uu____3615))) in
                    let uu____3616 = FStar_Util.prefix needle in
                    ...
                    | (ns,id1) ->
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x  ->
                                let uu____3731 = shorten_namespace x in
                                prepare_candidate uu____3731)) in
                  ((let uu____3741 =
                      FStar_Util.sort_with
                        (fun uu____3764  ->
                           fun uu____3765  ->
                             match (uu____3764, uu____3765) with
                             | ((cd1,ns1,uu____3792),(cd2,ns2,uu____3795)) ->
              ...
              | Pop msg ->
                  (pop env msg;
                   (let uu____3834 =
                      ...
                      | [] ->
                          (FStar_Errors.maybe_fatal_err
                             (FStar_Errors.IDETooManyPops, "too many pops");
                           FStar_All.exit (Prims.parse_int "1"))
                      | hd1::tl1 -> (hd1, tl1) in
              ...
              | Code (text,(ok,fail4)) ->
                  ...
                  (match res with
                   ...
                   | uu____4054 -> fail5 curmod env)
let interactive_mode: Prims.string -> Prims.unit =
  fun filename  ->
    (let uu____4069 =
       let uu____4070 = FStar_Options.codegen () in
       FStar_Option.isSome uu____4070 in
     if uu____4069
     then
       FStar_Errors.maybe_fatal_err
         (FStar_Errors.IDEIgnoreCodeGen,
           "code-generation is not supported in interactive mode, ignoring the codegen flag")
     else ());
    (let uu____4074 = deps_of_our_file filename in
     ...
     | (filenames,maybe_intf,dep_graph1) ->
         ...
         (match uu____4097 with
          | (stack,env1,ts) ->
              ...
              then
                let uu____4130 =
                  let uu____4131 = FStar_Options.file_list () in
                  FStar_List.hd uu____4131 in
                FStar_SMTEncoding_Solver.with_hints_db uu____4130
                  (fun uu____4135  ->
