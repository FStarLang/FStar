        ...
        (match uu____1590 with
         | (deps1,same_name) ->
             let maybe_intf =
               ...
               | intf::impl::[] ->
                   ((let uu____1633 =
                       (let uu____1636 = FStar_Parser_Dep.is_interface intf
                           in
            ...
            fun ts  ->
                  ...
                  ((match info_opt with
                    ...
                    | FStar_Pervasives_Native.Some (name_or_lid,typ,rng) ->
                        let uu____2784 =
                          ...
                          | FStar_Util.Inr lid ->
                              let uu____2801 = FStar_Ident.string_of_lid lid
                                 in
                              let uu____2802 =
                                let uu____2805 =
              ...
              | Completions search_term ->
                  ...
                  let rec locate_match needle candidate =
                    let uu____3036 = measure_anchored_match needle candidate
                       in
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____3302 with
                         | (stripped_ns,shortened) ->
                             ...
                             (uu____3329, uu____3330, uu____3331, match_len))
                     in
                                   ...
                                   | FStar_Pervasives_Native.Some l ->
                                       let uu____3631 =
                                         FStar_Ident.lid_of_ids
                                          ...
                                          in
                                       FStar_Ident.lid_equals l uu____3631)))
                       in
