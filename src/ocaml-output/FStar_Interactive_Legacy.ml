          ...
          let env1 =
            let uu___415_268 = env in
            {
              ...
              FStar_TypeChecker_Env.fv_delta_depths =
                (uu___415_268.FStar_TypeChecker_Env.fv_delta_depths);
...
let (uu___is_Pop : input_chunks -> Prims.bool) =
  fun projectee -> match projectee with | Pop _0 -> true | uu____562 -> false
        ...
        (match uu____1521 with
         | (deps1, same_name) ->
             let maybe_intf =
               ...
               | intf::impl::[] ->
                   ((let uu____1564 =
                       (let uu____1567 = FStar_Parser_Dep.is_interface intf in
            ...
            fun ts ->
              ...
              | Completions search_term ->
                  ...
                  let rec locate_match needle candidate =
                    let uu____3039 = measure_anchored_match needle candidate in
                    ...
                    | (prefix1, matched, match_len) ->
                        ...
                        (match uu____3313 with
                         | (stripped_ns, shortened) ->
                             ...
                             (uu____3340, uu____3341, uu____3342, match_len)) in
                      ...
                      FStar_All.pipe_right exported_names
                        (FStar_List.filter_map
                           (fun n1 ->
                              ...
                              then
                                let lid =
                                  let uu____3496 = FStar_Ident.ids_of_lid m in
                                  let uu____3499 = FStar_Ident.id_of_text n1 in
                              ...
                              | (ns, id1, uu____3642) ->
                                  ...
                                  (match uu____3651 with
                                   ...
                                   | FStar_Pervasives_Native.Some l ->
                                       ...
                                       FStar_Ident.lid_equals l uu____3656))) in
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x ->
                                ...
                                prepare_candidate uu____3772)) in
                  ((let uu____3782 =
