  ...
  fun env  ->
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          let env1 =
            let uu___81_268 = env  in
            {
              FStar_TypeChecker_Env.solver =
                (uu___81_268.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___81_268.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___81_268.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___81_268.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___81_268.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___81_268.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___81_268.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___81_268.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___81_268.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___81_268.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___81_268.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___81_268.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___81_268.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___81_268.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___81_268.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___81_268.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___81_268.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___81_268.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax = lax1;
              FStar_TypeChecker_Env.lax_universes =
                (uu___81_268.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___81_268.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___81_268.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___81_268.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___81_268.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___81_268.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___81_268.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___81_268.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___81_268.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___81_268.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.proof_ns =
                (uu___81_268.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___81_268.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___81_268.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___81_268.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___81_268.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___81_268.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___81_268.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.dep_graph =
                (uu___81_268.FStar_TypeChecker_Env.dep_graph)
            }  in
          ...
          then
            (let uu____272 = FStar_Options.restore_cmd_line_options false  in
             FStar_All.pipe_right uu____272 (fun a238  -> ()))
          else ();
          res
...
let (report_fail : unit -> unit) =
  fun uu____458  ->
    (let uu____460 = FStar_Errors.report_all ()  in
     FStar_All.pipe_right uu____460 (fun a239  -> ()));
    FStar_Errors.clear ()
...
let rec (read_chunk : unit -> input_chunks) =
  fun uu____1094  ->
    ...
    let log1 =
      ...
      else (fun uu____1169  -> ())  in
    let stdin =
      let uu____1171 = FStar_ST.op_Bang s.stdin  in
      ...
      | FStar_Pervasives_Native.None  ->
       ...
       in
    let line =
      let uu____1232 = FStar_Util.read_line stdin  in
    ...
    (let l = FStar_Util.trim_string line  in
     ...
     then
       let responses =
         ...
         | uu____1247::ok::fail1::[] -> (ok, fail1)
         | uu____1250 -> ("ok", "fail")  in
         ...
         then
            ...
            (let lc_lax =
               let uu____1264 =
                 FStar_Util.substring_from l (FStar_String.length "#push")
                  in
               FStar_Util.trim_string uu____1264  in
             let lc =
               match FStar_Util.split lc_lax " " with
               | l1::c::"#lax"::[] ->
                   let uu____1280 = FStar_Util.int_of_string l1  in
                   let uu____1281 = FStar_Util.int_of_string c  in
                   (true, uu____1280, uu____1281)
               | l1::c::[] ->
                   let uu____1284 = FStar_Util.int_of_string l1  in
                   let uu____1285 = FStar_Util.int_of_string c  in
                   (false, uu____1284, uu____1285)
               | uu____1286 ->
           ...
           then
             (match FStar_Util.split l " " with
              ...
              | uu____1308::symbol::file::row::col::[] ->
                  (FStar_Util.clear_string_builder s.chunk;
                   (let uu____1314 =
                      let uu____1329 =
                        let uu____1338 =
                          let uu____1345 = FStar_Util.int_of_string row  in
                          let uu____1346 = FStar_Util.int_of_string col  in
                          (file, uu____1345, uu____1346)  in
                        FStar_Pervasives_Native.Some uu____1338  in
                      (symbol, false, uu____1329)  in
                    Info uu____1314))
              | uu____1361 ->
                  (FStar_Errors.log_issue FStar_Range.dummyRange
...
let (shift_chunk : unit -> input_chunks) =
  fun uu____1381  ->
    let s = the_interactive_state  in
    let uu____1383 = FStar_ST.op_Bang s.buffer  in
...
let (fill_buffer : unit -> unit) =
  fun uu____1449  ->
    let s = the_interactive_state  in
    let uu____1451 =
      let uu____1454 = FStar_ST.op_Bang s.buffer  in
      let uu____1484 = let uu____1487 = read_chunk ()  in [uu____1487]  in
      FStar_List.append uu____1454 uu____1484  in
    FStar_ST.op_Colon_Equals s.buffer uu____1451
...
let (deps_of_our_file :
  ...
  =
  fun filename  ->
    let uu____1530 = FStar_Dependencies.find_deps_if_needed [filename]  in
    match uu____1530 with
    | (deps,dep_graph1) ->
        let uu____1553 =
          FStar_List.partition
            (fun x  ->
               let uu____1566 = FStar_Parser_Dep.lowercase_module_name x  in
               let uu____1567 =
                 FStar_Parser_Dep.lowercase_module_name filename  in
               uu____1566 <> uu____1567) deps
           in
        (match uu____1553 with
         | (deps1,same_name) ->
             let maybe_intf =
               ...
               | intf::impl::[] ->
                   ((let uu____1596 =
                       (let uu____1599 = FStar_Parser_Dep.is_interface intf
                           in
                        Prims.op_Negation uu____1599) ||
                         (let uu____1601 =
                            FStar_Parser_Dep.is_implementation impl  in
                          Prims.op_Negation uu____1601)
                        in
                     if uu____1596
                     then
                       let uu____1602 =
                   ...
                   ((let uu____1614 =
                       let uu____1619 =
                         FStar_Util.format1 "Unexpected: ended up with %s"
                          ...
                          in
                       (FStar_Errors.Warning_UnexpectedFile, uu____1619)  in
                     FStar_Errors.log_issue FStar_Range.dummyRange uu____1614);
                    FStar_Pervasives_Native.None)
                in
          ...
          fun ts  ->
            ...
            | uu____1679 ->
                ...
                let env1 =
                  ...
                  push_with_kind env uu____1694 true "typecheck_modul"  in
                let uu____1695 = tc_one_file remaining env1  in
            ...
            let rec iterate depnames st env' ts1 good_stack good_ts =
              ...
              let rec pop_tc_and_stack env1 stack ts2 =
                ...
                | uu____2079::ts3 ->
                    (pop env1 "";
                     (let uu____2120 =
                        let uu____2135 = FStar_List.hd stack  in
                        let uu____2144 = FStar_List.tl stack  in
                       ...
                       (match uu____2261 with
                        | (b,depnames') ->
                            ...
                            then
                              ...
                              (let uu____2297 =
                                 let uu____2312 = FStar_List.hd st  in
                                 let uu____2321 = FStar_List.tl st  in
                                 (uu____2312, uu____2321)  in
                               match uu____2297 with
                               | (stack_elt,st') ->
                                   iterate depnames' st' env' ts' (stack_elt
                                     :: good_stack) (ts_elt :: good_ts))))
              | [] -> tc_deps m good_stack env' depnames good_ts  in
            let uu____2398 = deps_of_our_file filename  in
            match uu____2398 with
            | (filenames,uu____2416,dep_graph1) ->
  ...
  fun env  ->
    fun name  ->
      fun typ  ->
        fun range  ->
          fun doc1  ->
            let uu____2503 = FStar_Range.string_of_range range  in
            let uu____2504 =
            ...
            FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2503 name
            ...
            fun ts  ->
                          ...
                          (let lid =
                             let uu____2695 =
                               FStar_List.map FStar_Ident.id_of_text
                                ...
                                in
                             FStar_Ident.lid_of_ids uu____2695  in
                           let lid1 =
                             if fqn_only
                             then lid
                             else
                  ...
                  ((match info_opt with
                    ...
                    | FStar_Pervasives_Native.Some (name_or_lid,typ,rng) ->
                        let uu____2821 =
                          ...
                          | FStar_Util.Inr lid ->
                              let uu____2838 = FStar_Ident.string_of_lid lid
                                 in
                              let uu____2839 =
                                let uu____2842 =
              ...
              | Completions search_term ->
                  ...
                  let rec locate_match needle candidate =
                    let uu____3081 = measure_anchored_match needle candidate
                       in
                    ...
                    | FStar_Pervasives_Native.None  ->
                        (match candidate with
                         | [] -> FStar_Pervasives_Native.None
                         | hc::tc1 ->
                             let uu____3160 = locate_match needle tc1  in
                             FStar_All.pipe_right uu____3160
                               (FStar_Util.map_option
                                  (fun uu____3221  ->
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____3355 with
                         | (stripped_ns,shortened) ->
                             let uu____3382 = str_of_ids shortened  in
                             let uu____3383 = str_of_ids matched  in
                             let uu____3384 = str_of_ids stripped_ns  in
                             (uu____3382, uu____3383, uu____3384, match_len))
                     in
                  let prepare_candidate uu____3404 =
                  ...
                  let matches =
                      ...
                      FStar_All.pipe_right exported_names
                        (FStar_List.filter_map
                           (fun n1  ->
                              ...
                              then
                                let lid =
                                  let uu____3538 = FStar_Ident.ids_of_lid m
                                     in
                                  let uu____3541 = FStar_Ident.id_of_text n1
                                     in
                                  FStar_Ident.lid_of_ns_and_id uu____3538
                                    uu____3541
                                   in
                                let uu____3542 =
                                  FStar_Syntax_DsEnv.resolve_to_fully_qualified_name
                                     ...
                                     let uu____3558 =
                                       let uu____3561 =
                                         FStar_List.map
                                          ...
                                          in
                                       FStar_List.append uu____3561
                                         [fqn.FStar_Ident.ident]
                                        in
                                     ([], uu____3558, matched_length))
                                  uu____3542
                              else FStar_Pervasives_Native.None))
                       in
                    let case_b_find_matches_in_env uu____3596 =
                      let matches =
                                   ...
                                   | FStar_Pervasives_Native.Some l ->
                                       let uu____3698 =
                                         FStar_Ident.lid_of_ids
                                          ...
                                          in
                                       FStar_Ident.lid_equals l uu____3698)))
                       in
                    let uu____3699 = FStar_Util.prefix needle  in
                    ...
                    | (ns,id1) ->
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x  ->
                                let uu____3814 = shorten_namespace x  in
                                prepare_candidate uu____3814))
                     in
                  ((let uu____3824 =
                      FStar_Util.sort_with
                        (fun uu____3847  ->
                           fun uu____3848  ->
                             match (uu____3847, uu____3848) with
                             | ((cd1,ns1,uu____3875),(cd2,ns2,uu____3878)) ->
              ...
              | Code (text,(ok,fail1)) ->
                  ...
                  (match res with
                   ...
                   | uu____4141 -> fail2 curmod env)
  
let (interactive_mode : Prims.string -> unit) =
  fun filename  ->
    (let uu____4158 =
       let uu____4159 = FStar_Options.codegen ()  in
       FStar_Option.isSome uu____4159  in
     if uu____4158
     then
       FStar_Errors.log_issue FStar_Range.dummyRange
    ...
    (let uu____4163 = deps_of_our_file filename  in
     ...
     | (filenames,maybe_intf,dep_graph1) ->
         ...
         (match uu____4186 with
          | (stack,env1,ts) ->
              let initial_range =
                ...
                let uu____4214 =
                  FStar_Range.mk_pos (Prims.parse_int "1")
                    (Prims.parse_int "0")
                   in
                FStar_Range.mk_range "<input>" uu____4213 uu____4214  in
              ...
              then
                let uu____4219 =
                  let uu____4220 = FStar_Options.file_list ()  in
                  FStar_List.hd uu____4220  in
                FStar_SMTEncoding_Solver.with_hints_db uu____4219
                  (fun uu____4224  ->
