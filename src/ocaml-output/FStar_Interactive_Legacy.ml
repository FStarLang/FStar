...
let (pop : FStar_TypeChecker_Env.env -> Prims.string -> unit) =
  fun env  ->
    fun msg  ->
      let uu____245 = FStar_Universal.pop_context env msg  in
      FStar_Options.pop ()
    ...
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          let uu____269 = FStar_Options.push ()  in
          let uu____270 =
    ...
    fun curmod  ->
      fun frag  ->
        ...
        | FStar_Errors.Error (e,msg,r) when
            ...
            let uu____391 =
              FStar_TypeChecker_Err.add_errors env [(e, msg, r)]  in
            ...
            let uu____415 =
              let uu____416 =
                let uu____425 =
                  ...
                  (e, msg, uu____432)  in
                [uu____425]  in
              FStar_TypeChecker_Err.add_errors env uu____416  in
            FStar_Pervasives_Native.None
...
let (uu___is_Push : input_chunks -> Prims.bool) =
  fun projectee  ->
    match projectee with | Push _0 -> true | uu____524 -> false
...
let (uu___is_Info : input_chunks -> Prims.bool) =
  fun projectee  ->
    match projectee with | Info _0 -> true | uu____630 -> false
...
let (uu___is_Completions : input_chunks -> Prims.bool) =
  fun projectee  ->
    match projectee with | Completions _0 -> true | uu____686 -> false
...
let (the_interactive_state : interactive_state) =
  let uu____992 = FStar_Util.new_string_builder ()  in
  let uu____993 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
  let uu____1000 = FStar_Util.mk_ref []  in
  let uu____1007 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
  {
    chunk = uu____992;
    stdin = uu____993;
    buffer = uu____1000;
