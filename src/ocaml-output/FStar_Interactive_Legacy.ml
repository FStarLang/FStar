  ...
  fun env  ->
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          let env1 =
            let uu___60_267 = env  in
            {
              FStar_TypeChecker_Env.solver =
                (uu___60_267.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___60_267.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___60_267.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___60_267.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_sig =
                (uu___60_267.FStar_TypeChecker_Env.gamma_sig);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___60_267.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___60_267.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___60_267.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___60_267.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___60_267.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___60_267.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___60_267.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___60_267.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___60_267.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___60_267.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___60_267.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___60_267.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___60_267.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___60_267.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax = lax1;
              FStar_TypeChecker_Env.lax_universes =
                (uu___60_267.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___60_267.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___60_267.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___60_267.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___60_267.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___60_267.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___60_267.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___60_267.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___60_267.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.normalized_eff_names =
                (uu___60_267.FStar_TypeChecker_Env.normalized_eff_names);
              FStar_TypeChecker_Env.proof_ns =
                (uu___60_267.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___60_267.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___60_267.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___60_267.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___60_267.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___60_267.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___60_267.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.dep_graph =
                (uu___60_267.FStar_TypeChecker_Env.dep_graph)
            }  in
                       ...
                       (match uu____2260 with
                        | (b,depnames') ->
                            ...
                            then
                              ...
                              (let uu____2296 =
                                 let uu____2305 = FStar_List.hd st  in
                                 let uu____2314 = FStar_List.tl st  in
                                 (uu____2305, uu____2314)  in
                               match uu____2296 with
                               | (stack_elt,st') ->
                                   iterate depnames' st' env' ts' (stack_elt
                                     :: good_stack) (ts_elt :: good_ts))))
              | [] -> tc_deps m good_stack env' depnames good_ts  in
            let uu____2367 = deps_of_our_file filename  in
            match uu____2367 with
            | (filenames,uu____2385,dep_graph1) ->
  ...
  fun env  ->
    fun name  ->
      fun typ  ->
        fun range  ->
          fun doc1  ->
            let uu____2472 = FStar_Range.string_of_range range  in
            let uu____2473 =
            ...
            FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2472 name
            ...
            fun ts  ->
              ...
              | Info (symbol,fqn_only,pos_opt) ->
                  ...
                  let info_opt =
                    ...
                    | FStar_Pervasives_Native.Some uu____2609 ->
                        info_at_pos_opt
                    | FStar_Pervasives_Native.None  ->
                        if symbol = ""
                          ...
                          (let lid =
                             let uu____2664 =
                               FStar_List.map FStar_Ident.id_of_text
                                ...
                                in
                             FStar_Ident.lid_of_ids uu____2664  in
                           let lid1 =
                             if fqn_only
                             then lid
                             else
                  ...
                  let rec locate_match needle candidate =
                    ...
                    | FStar_Pervasives_Native.None  ->
                        (match candidate with
                         | [] -> FStar_Pervasives_Native.None
                         | hc::tc1 ->
                             let uu____3149 = locate_match needle tc1  in
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____3344 with
                         | (stripped_ns,shortened) ->
                             let uu____3371 = str_of_ids shortened  in
                             let uu____3372 = str_of_ids matched  in
                             let uu____3373 = str_of_ids stripped_ns  in
                             (uu____3371, uu____3372, uu____3373, match_len))
                     in
                  ...
                  let matches =
                              ...
                              then
                                let lid =
                                  ...
                                  let uu____3530 = FStar_Ident.id_of_text n1
                                     in
                                  FStar_Ident.lid_of_ns_and_id uu____3527
                                    uu____3530
                                   in
                                let uu____3531 =
                                  FStar_Syntax_DsEnv.resolve_to_fully_qualified_name
                                     ...
                                     let uu____3547 =
                                       let uu____3550 =
                                         FStar_List.map
                                          ...
                                          in
                                       FStar_List.append uu____3550
                                         [fqn.FStar_Ident.ident]
                                        in
                                     ([], uu____3547, matched_length))
                                  uu____3531
                              else FStar_Pervasives_Native.None))
                       in
                    let case_b_find_matches_in_env uu____3585 =
                      let matches =
                                   ...
                                   | FStar_Pervasives_Native.Some l ->
                                       let uu____3687 =
                                         FStar_Ident.lid_of_ids
                                          ...
                                          in
                                       FStar_Ident.lid_equals l uu____3687)))
                       in
                    let uu____3688 = FStar_Util.prefix needle  in
                    ...
                    | (ns,id1) ->
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x  ->
                                let uu____3803 = shorten_namespace x  in
                                prepare_candidate uu____3803))
                     in
                  ((let uu____3813 =
                      FStar_Util.sort_with
                        (fun uu____3836  ->
                           fun uu____3837  ->
                             ...
                             | ((cd1,ns1,uu____3864),(cd2,ns2,uu____3867)) ->
...
let (interactive_mode : Prims.string -> unit) =
  fun filename  ->
    ...
    (let uu____4152 = deps_of_our_file filename  in
     ...
     | (filenames,maybe_intf,dep_graph1) ->
         ...
         (match uu____4175 with
          | (stack,env1,ts) ->
              let initial_range =
                ...
                let uu____4203 =
                  FStar_Range.mk_pos (Prims.parse_int "1")
                    (Prims.parse_int "0")
                   in
                FStar_Range.mk_range "<input>" uu____4202 uu____4203  in
              ...
              then
                let uu____4208 =
                  let uu____4209 = FStar_Options.file_list ()  in
                  FStar_List.hd uu____4209  in
                FStar_SMTEncoding_Solver.with_hints_db uu____4208
                  (fun uu____4213  ->
