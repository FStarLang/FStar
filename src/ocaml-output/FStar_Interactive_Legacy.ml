...
let uu____276 = (FStar_Universal.init_env ())
in (FStar_Universal.tc_prims uu____276))
in (match (uu____265) with
| (uu____285, dsenv, env) -> begin
((dsenv), (env))
end)))
...
let pop : 'Auu____314 . ('Auu____314 * FStar_TypeChecker_Env.env)  ->  Prims.string  ->  Prims.unit = (fun uu____325 msg -> (match (uu____325) with
| (uu____331, env) -> begin
...
let push_with_kind : (FStar_ToSyntax_Env.env * FStar_TypeChecker_Env.env)  ->  Prims.bool  ->  Prims.bool  ->  Prims.string  ->  (FStar_ToSyntax_Env.env * FStar_TypeChecker_Env.env) = (fun uu____354 lax1 restore_cmd_line_options1 msg -> (match (uu____354) with
| (dsenv, env) -> begin
(

let env1 = (

let uu___267_369 = env
in {FStar_TypeChecker_Env.solver = uu___267_369.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___267_369.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___267_369.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___267_369.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___267_369.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___267_369.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___267_369.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___267_369.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___267_369.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___267_369.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___267_369.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___267_369.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___267_369.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___267_369.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___267_369.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___267_369.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___267_369.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___267_369.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax1; FStar_TypeChecker_Env.lax_universes = uu___267_369.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___267_369.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___267_369.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.tc_term = uu___267_369.FStar_TypeChecker_Env.tc_term; FStar_TypeChecker_Env.type_of = uu___267_369.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___267_369.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___267_369.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___267_369.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___267_369.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___267_369.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___267_369.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___267_369.FStar_TypeChecker_Env.identifier_info; FStar_TypeChecker_Env.tc_hooks = uu___267_369.FStar_TypeChecker_Env.tc_hooks})
in (
...
let uu____377 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right uu____377 FStar_Pervasives.ignore))
end
| uu____378 -> begin
()
end);
...
let uu____548 = (FStar_Errors.get_err_count ())
in ((m), (((dsenv1), (env1))), (uu____548)))
in FStar_Pervasives_Native.Some (uu____535))
end
| uu____567 -> begin
FStar_Pervasives_Native.None
end))
end)) (fun uu___268_594 -> (match (uu___268_594) with
...
let uu____634 = (FStar_Options.trace_error ())
in (not (uu____634))) -> begin
((
...
let uu____648 = (FStar_TypeChecker_Env.get_range env)
in ((msg), (uu____648)))
in (uu____643)::[])
in (FStar_TypeChecker_Err.add_errors env uu____636));
FStar_Pervasives_Native.None;
)
end)))
end))
...
let report_fail : Prims.unit  ->  Prims.unit = (fun uu____672 -> ((

let uu____674 = (FStar_Errors.report_all ())
in (FStar_All.pipe_right uu____674 FStar_Pervasives.ignore));
(FStar_Errors.clear ());
))
...
let uu____1145 = (FStar_Util.new_string_builder ())
in (

let uu____1146 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in (

let uu____1153 = (FStar_Util.mk_ref [])
in (

let uu____1160 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in {chunk = uu____1145; stdin = uu____1146; buffer = uu____1153; log = uu____1160}))))


let rec read_chunk : Prims.unit  ->  input_chunks = (fun uu____1212 -> (
...
let uu____1217 = (FStar_Options.debug_any ())
...
let uu____1221 = (FStar_ST.op_Bang s.log)
...
let uu____1332 = (FStar_ST.op_Bang s.stdin)
...
let uu____1439 = (FStar_Util.read_line stdin)
...
let uu____1471 = (FStar_Util.substring_from l (FStar_String.length "#push"))
in (FStar_Util.trim_string uu____1471))
in (
...
let uu____1487 = (FStar_Util.int_of_string l1)
in (

let uu____1488 = (FStar_Util.int_of_string c)
in ((true), (uu____1487), (uu____1488))))
end
| (l1)::(c)::[] -> begin
(

let uu____1491 = (FStar_Util.int_of_string l1)
in (

let uu____1492 = (FStar_Util.int_of_string c)
in ((false), (uu____1491), (uu____1492))))
end
| uu____1493 -> begin
...
| (uu____1498)::(symbol)::[] -> begin
((FStar_Util.clear_string_builder s.chunk);
Info (((symbol), (true), (FStar_Pervasives_Native.None)));
)
end
| (uu____1515)::(symbol)::(file)::(row)::(col)::[] -> begin
((FStar_Util.clear_string_builder s.chunk);
(
...
let uu____1552 = (FStar_Util.int_of_string row)
in (

let uu____1553 = (FStar_Util.int_of_string col)
in ((file), (uu____1552), (uu____1553))))
in FStar_Pervasives_Native.Some (uu____1545))
in ((symbol), (false), (uu____1536)))
in Info (uu____1521));
)
end
| uu____1568 -> begin
...
let shift_chunk : Prims.unit  ->  input_chunks = (fun uu____1587 -> (

let s = the_interactive_state
in (

let uu____1589 = (FStar_ST.op_Bang s.buffer)
...
let fill_buffer : Prims.unit  ->  Prims.unit = (fun uu____1700 -> (
...
let uu____1705 = (FStar_ST.op_Bang s.buffer)
in (

let uu____1758 = (

let uu____1761 = (read_chunk ())
in (uu____1761)::[])
in (FStar_List.append uu____1705 uu____1758)))
in (FStar_ST.op_Colon_Equals s.buffer uu____1702))))
...
let uu____1827 = (FStar_List.partition (fun x -> (

let uu____1840 = (FStar_Parser_Dep.lowercase_module_name x)
in (

let uu____1841 = (FStar_Parser_Dep.lowercase_module_name filename)
in (Prims.op_disEquality uu____1840 uu____1841)))) deps)
...
let uu____1871 = (FStar_Parser_Dep.is_interface intf)
in (not (uu____1871))) || (
...
let uu____1874 = (FStar_Util.format2 "Found %s and %s but not an interface + implementation" intf impl)
in (FStar_Util.print_warning uu____1874))
end
| uu____1875 -> begin
()
end));
...
let uu____1881 = (FStar_Util.format1 "Unexpected: ended up with %s" (FStar_String.concat " " same_name))
in (FStar_Util.print_warning uu____1881));
FStar_Pervasives_Native.None;
)
end)
in ((deps1), (maybe_intf)))
...
let uu____1955 = (FStar_Options.lax ())
in (push_with_kind env uu____1955 true "typecheck_modul"))
in (

let uu____1956 = (tc_one_file remaining env1)
...
let uu____2020 = (FStar_Util.get_file_last_modification_time intf1)
in FStar_Pervasives_Native.Some (uu____2020))
end
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end)
...
| (uu____2331)::ts3 -> begin
((pop env1 "");
(

let uu____2372 = (

let uu____2387 = (FStar_List.hd stack)
in (

let uu____2396 = (FStar_List.tl stack)
in ((uu____2387), (uu____2396))))
in (match (uu____2372) with
| ((env2, uu____2422), stack1) -> begin
...
let uu____2486 = ts_elt
in (match (uu____2486) with
| (intf, impl, intf_t, impl_t) -> begin
(

let uu____2517 = (match_dep depnames intf impl)
in (match (uu____2517) with
| (b, depnames') -> begin
(

let uu____2536 = ((not (b)) || (is_stale intf impl intf_t impl_t))
...
let uu____2572 = (FStar_List.hd st)
in (

let uu____2581 = (FStar_List.tl st)
in ((uu____2572), (uu____2581))))
...
let uu____2658 = (deps_of_our_file filename)
in (match (uu____2658) with
| (filenames, uu____2674) -> begin
...
let uu____2755 = (FStar_Range.string_of_range range)
in (

let uu____2756 = (FStar_TypeChecker_Normalize.term_to_string env typ)
in (

let uu____2757 = (match (doc1) with
...
in (FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2755 name uu____2756 uu____2757)))))
...
| FStar_Pervasives_Native.Some (uu____2889) -> begin
info_at_pos_opt
end
| FStar_Pervasives_Native.None -> begin
...
let uu____2944 = (FStar_List.map FStar_Ident.id_of_text (FStar_Util.split symbol "."))
in (FStar_Ident.lid_of_ids uu____2944))
in (
...
let uu____2949 = (FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv lid)
...
let uu____2953 = (FStar_TypeChecker_Env.try_lookup_lid (FStar_Pervasives_Native.snd env) lid1)
in (FStar_All.pipe_right uu____2953 (FStar_Util.map_option (fun uu____3008 -> (match (uu____3008) with
| ((uu____3027, typ), r) -> begin
...
let uu____3070 = (match (name_or_lid) with
...
let uu____3087 = (FStar_Ident.string_of_lid lid)
in (

let uu____3088 = (

let uu____3091 = (FStar_ToSyntax_Env.try_lookup_doc dsenv lid)
in (FStar_All.pipe_right uu____3091 (FStar_Util.map_option FStar_Pervasives_Native.fst)))
in ((uu____3087), (uu____3088))))
end)
in (match (uu____3070) with
| (name, doc1) -> begin
(

let uu____3122 = (format_info (FStar_Pervasives_Native.snd env) name typ rng doc1)
...
let uu____3227 = (measure_anchored_match ts1 tc)
in (FStar_All.pipe_right uu____3227 (FStar_Util.map_option (fun uu____3267 -> (match (uu____3267) with
| (matched, len) -> begin
...
let uu____3322 = (measure_anchored_match needle candidate)
...
let uu____3401 = (locate_match needle tc)
in (FStar_All.pipe_right uu____3401 (FStar_Util.map_option (fun uu____3462 -> (match (uu____3462) with
...
let uu____3506 = (FStar_List.map FStar_Ident.text_of_id ids)
in (FStar_Util.concat_l "." uu____3506)))
in (
...
let shorten_namespace = (fun uu____3553 -> (match (uu____3553) with
...
let uu____3588 = (FStar_ToSyntax_Env.shorten_module_path (FStar_Pervasives_Native.fst env) prefix1 naked_match)
in (match (uu____3588) with
| (stripped_ns, shortened) -> begin
(

let uu____3615 = (str_of_ids shortened)
in (

let uu____3616 = (str_of_ids matched)
in (

let uu____3617 = (str_of_ids stripped_ns)
in ((uu____3615), (uu____3616), (uu____3617), (match_len)))))
end)))
end))
in (

let prepare_candidate = (fun uu____3635 -> (match (uu____3635) with
...
let uu____3764 = (FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv lid)
in (FStar_Option.map (fun fqn -> (

let uu____3780 = (

let uu____3783 = (FStar_List.map FStar_Ident.id_of_text orig_ns)
in (FStar_List.append uu____3783 ((fqn.FStar_Ident.ident)::[])))
in (([]), (uu____3780), (matched_length)))) uu____3764)))
end
| uu____3790 -> begin
FStar_Pervasives_Native.None
end))))))))
...
let case_b_find_matches_in_env = (fun uu____3816 -> (

let uu____3829 = env
in (match (uu____3829) with
| (dsenv, uu____3843) -> begin
(

let matches = (FStar_List.filter_map (match_lident_against needle) all_lidents_in_env)
in (FStar_All.pipe_right matches (FStar_List.filter (fun uu____3906 -> (match (uu____3906) with
| (ns, id, uu____3919) -> begin
(

let uu____3928 = (

let uu____3931 = (FStar_Ident.lid_of_ids id)
in (FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv uu____3931))
...
let uu____3933 = (FStar_Ident.lid_of_ids (FStar_List.append ns id))
in (FStar_Ident.lid_equals l uu____3933))
end))
end)))))
end)))
in (

let uu____3934 = (FStar_Util.prefix needle)
...
let uu____3984 = (FStar_ToSyntax_Env.resolve_module_name (FStar_Pervasives_Native.fst env) l true)
...
let uu____4049 = (shorten_namespace x)
in (prepare_candidate uu____4049))))))
end))))
in ((

let uu____4059 = (FStar_Util.sort_with (fun uu____4082 uu____4083 -> (match (((uu____4082), (uu____4083))) with
| ((cd1, ns1, uu____4110), (cd2, ns2, uu____4113)) -> begin
...
in (FStar_List.iter (fun uu____4138 -> (match (uu____4138) with
| (candidate, ns, match_len) -> begin
(

let uu____4148 = (FStar_Util.string_of_int match_len)
in (FStar_Util.print3 "%s %s %s \n" uu____4148 ns candidate))
end)) uu____4059));
...
let uu____4152 = (match (stack) with
| [] -> begin
...
let uu____4266 = (match ((Prims.op_Equality (FStar_List.length stack) (FStar_List.length ts))) with
| true -> begin
(

let uu____4303 = (update_deps filename curmod stack env ts)
in ((true), (uu____4303)))
end
| uu____4316 -> begin
((false), (((stack), (env), (ts))))
...
let uu____4439 = (FStar_Options.codegen ())
in (FStar_Option.isSome uu____4439))
...
let uu____4443 = (deps_of_our_file filename)
...
let uu____4467 = (tc_deps FStar_Pervasives_Native.None [] env filenames [])
...
let uu____4494 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (

let uu____4495 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (FStar_Range.mk_range "<input>" uu____4494 uu____4495)))
in (

let env2 = (

let uu____4501 = (FStar_TypeChecker_Env.set_range (FStar_Pervasives_Native.snd env1) initial_range1)
in (((FStar_Pervasives_Native.fst env1)), (uu____4501)))
in (
...
let uu____4512 = ((FStar_Options.record_hints ()) || (FStar_Options.use_hints ()))
...
let uu____4514 = (FStar_Options.file_list ())
in (FStar_List.hd uu____4514))
in (FStar_SMTEncoding_Solver.with_hints_db uu____4513 (fun uu____4518 -> (go (((Prims.parse_int "1")), ((Prims.parse_int "0"))) filename stack FStar_Pervasives_Native.None env3 ts))))
end
| uu____4519 -> begin
