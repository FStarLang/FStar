  ...
  fun env ->
    fun lax1 ->
      fun restore_cmd_line_options1 ->
        fun msg ->
          let env1 =
            let uu___58_233 = env in
            {
              FStar_TypeChecker_Env.solver =
                (uu___58_233.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___58_233.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___58_233.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___58_233.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___58_233.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___58_233.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___58_233.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___58_233.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___58_233.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___58_233.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___58_233.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___58_233.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___58_233.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___58_233.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___58_233.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___58_233.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___58_233.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___58_233.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax = lax1;
              FStar_TypeChecker_Env.lax_universes =
                (uu___58_233.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___58_233.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___58_233.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___58_233.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___58_233.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___58_233.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___58_233.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___58_233.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___58_233.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.proof_ns =
                (uu___58_233.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___58_233.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___58_233.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___58_233.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___58_233.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___58_233.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___58_233.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.dep_graph =
                (uu___58_233.FStar_TypeChecker_Env.dep_graph)
            } in
            ...
            fun ts ->
                  ...
                  let matches =
                      ...
                      FStar_All.pipe_right exported_names
                        (FStar_List.filter_map
                           (fun n1 ->
                              ...
                              then
                                let lid =
                                  let uu____3329 = FStar_Ident.ids_of_lid m in
                                  let uu____3332 = FStar_Ident.id_of_text n1 in
                                  FStar_Ident.lid_of_ns_and_id uu____3329
                                    uu____3332 in
                                let uu____3333 =
                                  FStar_Syntax_DsEnv.resolve_to_fully_qualified_name
                                    env.FStar_TypeChecker_Env.dsenv lid in
                                FStar_Option.map
                                  (fun fqn ->
                                     let uu____3349 =
                                       ...
                                       FStar_List.append uu____3352
                                         [fqn.FStar_Ident.ident] in
                                     ([], uu____3349, matched_length))
                                  uu____3333
                              else FStar_Pervasives_Native.None)) in
                    let case_b_find_matches_in_env uu____3385 =
                      let matches =
                              ...
                              | (ns, id1, uu____3473) ->
                                  ...
                                  (match uu____3482 with
                                   ...
                                   | FStar_Pervasives_Native.Some l ->
                                       ...
                                       FStar_Ident.lid_equals l uu____3487))) in
                    let uu____3488 = FStar_Util.prefix needle in
                    ...
                    | (ns, id1) ->
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x ->
                                let uu____3603 = shorten_namespace x in
                                prepare_candidate uu____3603)) in
                  ((let uu____3613 =
              ...
              | Code (text, (ok, fail1)) ->
                  ...
                  (match res with
                   ...
                   | uu____3926 -> fail2 curmod env)
let (interactive_mode : Prims.string -> Prims.unit) =
  fun filename ->
    (let uu____3941 =
       let uu____3942 = FStar_Options.codegen () in
       FStar_Option.isSome uu____3942 in
     if uu____3941
     then
       FStar_Errors.log_issue FStar_Range.dummyRange
    ...
    (let uu____3946 = deps_of_our_file filename in
          ...
          | (stack, env1, ts) ->
              let initial_range =
                ...
                let uu____3997 =
                  FStar_Range.mk_pos (Prims.parse_int "1")
                    (Prims.parse_int "0") in
                FStar_Range.mk_range "<input>" uu____3996 uu____3997 in
              ...
              then
                let uu____4002 =
                  let uu____4003 = FStar_Options.file_list () in
                  FStar_List.hd uu____4003 in
                FStar_SMTEncoding_Solver.with_hints_db uu____4002
                  (fun uu____4007 ->
