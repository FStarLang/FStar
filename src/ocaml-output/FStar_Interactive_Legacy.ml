...
let tc_prims: Prims.unit -> FStar_TypeChecker_Env.env =
  fun uu____207  ->
    let uu____208 =
      let uu____217 = FStar_Universal.init_env () in
      FStar_Universal.tc_prims uu____217 in
    match uu____208 with | (uu____218,env) -> env
  ...
  fun env  ->
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          let env1 =
            let uu___574_256 = env in
            {
              FStar_TypeChecker_Env.solver =
                (uu___574_256.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___574_256.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___574_256.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___574_256.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___574_256.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___574_256.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___574_256.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___574_256.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___574_256.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___574_256.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___574_256.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___574_256.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___574_256.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___574_256.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___574_256.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___574_256.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___574_256.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___574_256.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax = lax1;
              FStar_TypeChecker_Env.lax_universes =
                (uu___574_256.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___574_256.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___574_256.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___574_256.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___574_256.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___574_256.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___574_256.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qname_and_index =
                (uu___574_256.FStar_TypeChecker_Env.qname_and_index);
              FStar_TypeChecker_Env.proof_ns =
                (uu___574_256.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth =
                (uu___574_256.FStar_TypeChecker_Env.synth);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___574_256.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___574_256.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___574_256.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___574_256.FStar_TypeChecker_Env.dsenv)
            } in
          let res = FStar_Universal.push_context env1 msg in
          FStar_Options.push ();
          if restore_cmd_line_options1
          then
            (let uu____260 = FStar_Options.restore_cmd_line_options false in
             FStar_All.pipe_right uu____260 FStar_Pervasives.ignore)
          else ();
          res
let check_frag:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun curmod  ->
      fun frag  ->
        try
          let uu____311 = FStar_Universal.tc_one_fragment curmod env frag in
          match uu____311 with
          | (m,env1) ->
              let uu____334 =
                let uu____343 = FStar_Errors.get_err_count () in
                (m, env1, uu____343) in
              FStar_Pervasives_Native.Some uu____334
        with
        | FStar_Errors.Error (msg,r) when
            let uu____371 = FStar_Options.trace_error () in
            Prims.op_Negation uu____371 ->
        ...
        | FStar_Errors.Err msg when
            ...
            ((let uu____392 =
                let uu____399 =
                  let uu____404 = FStar_TypeChecker_Env.get_range env in
                  (msg, uu____404) in
                [uu____399] in
...
let report_fail: Prims.unit -> Prims.unit =
  fun uu____423  ->
    (let uu____425 = FStar_Errors.report_all () in
     FStar_All.pipe_right uu____425 FStar_Pervasives.ignore);
    FStar_Errors.clear ()
type input_chunks =
...
let uu___is_Push: input_chunks -> Prims.bool =
  fun projectee  ->
    match projectee with | Push _0 -> true | uu____490 -> false
...
let uu___is_Info: input_chunks -> Prims.bool =
  fun projectee  ->
    match projectee with | Info _0 -> true | uu____590 -> false
...
let uu___is_Completions: input_chunks -> Prims.bool =
  fun projectee  ->
    match projectee with | Completions _0 -> true | uu____644 -> false
...
let the_interactive_state: interactive_state =
  let uu____882 = FStar_Util.new_string_builder () in
  let uu____883 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
  let uu____890 = FStar_Util.mk_ref [] in
  let uu____897 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
  { chunk = uu____882; stdin = uu____883; buffer = uu____890; log = uu____897
  }
let rec read_chunk: Prims.unit -> input_chunks =
  fun uu____948  ->
    ...
    let log1 =
      ...
      then
        let transcript =
          let uu____957 = FStar_ST.op_Bang s.log in
      ...
      else (fun uu____1066  -> ()) in
    let stdin =
      let uu____1068 = FStar_ST.op_Bang s.stdin in
      ...
      | FStar_Pervasives_Native.None  ->
          ...
          (FStar_ST.op_Colon_Equals s.stdin (FStar_Pervasives_Native.Some i);
           i) in
    let line =
      let uu____1175 = FStar_Util.read_line stdin in
    ...
    (let l = FStar_Util.trim_string line in
     ...
     then
       let responses =
         ...
         | uu____1190::ok::fail4::[] -> (ok, fail4)
         | uu____1193 -> ("ok", "fail") in
         ...
         then
           (FStar_Util.clear_string_builder s.chunk;
            (let lc_lax =
               ...
               FStar_Util.trim_string uu____1207 in
             let lc =
               match FStar_Util.split lc_lax " " with
               | l1::c::"#lax"::[] ->
                   let uu____1223 = FStar_Util.int_of_string l1 in
                   let uu____1224 = FStar_Util.int_of_string c in
                   (true, uu____1223, uu____1224)
               | l1::c::[] ->
                   let uu____1227 = FStar_Util.int_of_string l1 in
                   let uu____1228 = FStar_Util.int_of_string c in
                   (false, uu____1227, uu____1228)
               | uu____1229 ->
           ...
           then
             (match FStar_Util.split l " " with
              ...
              | uu____1251::symbol::file::row::col::[] ->
                  (FStar_Util.clear_string_builder s.chunk;
                   (let uu____1257 =
                      let uu____1272 =
                        let uu____1281 =
                          let uu____1288 = FStar_Util.int_of_string row in
                          let uu____1289 = FStar_Util.int_of_string col in
                          (file, uu____1288, uu____1289) in
                        FStar_Pervasives_Native.Some uu____1281 in
                      (symbol, false, uu____1272) in
                    Info uu____1257))
              | uu____1304 ->
...
let shift_chunk: Prims.unit -> input_chunks =
  fun uu____1322  ->
    let s = the_interactive_state in
    let uu____1324 = FStar_ST.op_Bang s.buffer in
...
let fill_buffer: Prims.unit -> Prims.unit =
  fun uu____1434  ->
    ...
    let uu____1436 =
      ...
      let uu____1492 = let uu____1495 = read_chunk () in [uu____1495] in
      FStar_List.append uu____1439 uu____1492 in
...
let deps_of_our_file:
  ...
  =
  fun filename  ->
    let deps = FStar_Dependencies.find_deps_if_needed [filename] in
    let uu____1560 =
      FStar_List.partition
        (fun x  ->
           let uu____1573 = FStar_Parser_Dep.lowercase_module_name x in
           let uu____1574 = FStar_Parser_Dep.lowercase_module_name filename in
           uu____1573 <> uu____1574) deps in
    ...
    | (deps1,same_name) ->
        let maybe_intf =
          ...
          | intf::impl::[] ->
              ((let uu____1601 =
                  (let uu____1604 = FStar_Parser_Dep.is_interface intf in
                   Prims.op_Negation uu____1604) ||
                    (let uu____1606 = FStar_Parser_Dep.is_implementation impl in
                     Prims.op_Negation uu____1606) in
                if uu____1601
                then
                  let uu____1607 =
                    FStar_Util.format2
                      ...
                      intf impl in
                  FStar_Util.print_warning uu____1607
                else ());
          ...
          | uu____1610 ->
              ((let uu____1614 =
                ...
                FStar_Util.print_warning uu____1614);
        ...
        fun remaining  ->
          fun ts  ->
            ...
            | uu____1664 ->
                ...
                let env1 =
                  let uu____1679 = FStar_Options.lax () in
                  push_with_kind env uu____1679 true "typecheck_modul" in
                let uu____1680 = tc_one_file remaining env1 in
                         ...
                         | FStar_Pervasives_Native.Some intf1 ->
                             let uu____1732 =
                               FStar_Parser_ParseIt.get_file_last_modification_time
                                 intf1 in
                             FStar_Pervasives_Native.Some uu____1732
                         | FStar_Pervasives_Native.None  ->
                             FStar_Pervasives_Native.None in
                       let impl_t =
                         FStar_Parser_ParseIt.get_file_last_modification_time
      ...
      fun stk  ->
        fun env  ->
          fun ts  ->
            ...
            let rec iterate depnames st env' ts1 good_stack good_ts =
              ...
              let rec pop_tc_and_stack env1 stack ts2 =
                ...
                | uu____2022::ts3 ->
                    (pop env1 "";
                     (let uu____2063 =
                        let uu____2078 = FStar_List.hd stack in
                        let uu____2087 = FStar_List.tl stack in
                        (uu____2078, uu____2087) in
                      match uu____2063 with
                      | ((env2,uu____2109),stack1) ->
                          pop_tc_and_stack env2 stack1 ts3)) in
              match ts1 with
              | ts_elt::ts' ->
                  let uu____2173 = ts_elt in
                  (match uu____2173 with
                   | (intf,impl,intf_t,impl_t) ->
                       let uu____2204 = match_dep depnames intf impl in
                       (match uu____2204 with
                        | (b,depnames') ->
                            ...
                            then
                              ...
                              (let uu____2240 =
                                 let uu____2255 = FStar_List.hd st in
                                 let uu____2264 = FStar_List.tl st in
            ...
            let uu____2341 = deps_of_our_file filename in
            match uu____2341 with
            | (filenames,uu____2357) ->
  ...
  fun env  ->
    fun name  ->
      fun typ  ->
        fun range  ->
          fun doc1  ->
            let uu____2433 = FStar_Range.string_of_range range in
            let uu____2434 =
            ...
            let uu____2435 =
              ...
              | FStar_Pervasives_Native.None  -> "" in
            FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2433 name
            ...
            fun ts  ->
              ...
              | Info (symbol,fqn_only,pos_opt) ->
                  ...
                  let info_opt =
                    ...
                    | FStar_Pervasives_Native.Some uu____2558 ->
                        info_at_pos_opt
                    | FStar_Pervasives_Native.None  ->
                        if symbol = ""
                        then FStar_Pervasives_Native.None
                          ...
                          (let lid =
                             ...
                             FStar_Ident.lid_of_ids uu____2613 in
                           let lid1 =
                             if fqn_only
                             then lid
                             else
                  ...
                  ((match info_opt with
                    ...
                    | FStar_Pervasives_Native.Some (name_or_lid,typ,rng) ->
                        let uu____2739 =
                          ...
                          | FStar_Util.Inr lid ->
                              let uu____2756 = FStar_Ident.string_of_lid lid in
                              let uu____2757 =
                                let uu____2760 =
              ...
              | Completions search_term ->
                        ...
                        then
                          (match ts1 with
                           ...
                           | uu____2893 ->
                               ...
                               FStar_All.pipe_right uu____2896
                                 (FStar_Util.map_option
                                    (fun uu____2936  ->
                  ...
                  let rec locate_match needle candidate =
                    let uu____2991 = measure_anchored_match needle candidate in
                    ...
                    | FStar_Pervasives_Native.None  ->
                        (match candidate with
                         | [] -> FStar_Pervasives_Native.None
                         | hc::tc1 ->
                             let uu____3070 = locate_match needle tc1 in
                             FStar_All.pipe_right uu____3070
                               (FStar_Util.map_option
                                  (fun uu____3131  ->
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____3257 with
                         | (stripped_ns,shortened) ->
                             let uu____3284 = str_of_ids shortened in
                             let uu____3285 = str_of_ids matched in
                             let uu____3286 = str_of_ids stripped_ns in
                             (uu____3284, uu____3285, uu____3286, match_len)) in
                  let prepare_candidate uu____3304 =
                  ...
                  let matches =
                                ...
                                FStar_Option.map
                                  (fun fqn  ->
                                     let uu____3448 =
                                       ...
                                       FStar_List.append uu____3451
                                         [fqn.FStar_Ident.ident] in
                                     ([], uu____3448, matched_length))
                                  uu____3432
                              else FStar_Pervasives_Native.None)) in
                    let case_b_find_matches_in_env uu____3484 =
                      let matches =
                              ...
                              | (ns,id,uu____3572) ->
                                  ...
                                  (match uu____3581 with
                                   ...
                                   | FStar_Pervasives_Native.Some l ->
                                       ...
                                       FStar_Ident.lid_equals l uu____3586))) in
                    let uu____3587 = FStar_Util.prefix needle in
                    ...
                    | (ns,id) ->
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x  ->
                                let uu____3702 = shorten_namespace x in
                                prepare_candidate uu____3702)) in
                  ((let uu____3712 =
                      FStar_Util.sort_with
                        (fun uu____3735  ->
                           fun uu____3736  ->
                             match (uu____3735, uu____3736) with
                             | ((cd1,ns1,uu____3763),(cd2,ns2,uu____3766)) ->
              ...
              | Code (text,(ok,fail4)) ->
                  ...
                  (match res with
                   ...
                   | uu____4025 -> fail5 curmod env)
let interactive_mode: Prims.string -> Prims.unit =
  fun filename  ->
    (let uu____4040 =
       let uu____4041 = FStar_Options.codegen () in
       FStar_Option.isSome uu____4041 in
     if uu____4040
     then
       FStar_Util.print_warning
         "code-generation is not supported in interactive mode, ignoring the codegen flag"
     else ());
    (let uu____4045 = deps_of_our_file filename in
          ...
          | (stack,env1,ts) ->
              let initial_range1 =
                ...
                let uu____4093 =
                  FStar_Range.mk_pos (Prims.parse_int "1")
                    (Prims.parse_int "0") in
                FStar_Range.mk_range "<input>" uu____4092 uu____4093 in
              ...
              then
                let uu____4098 =
                  let uu____4099 = FStar_Options.file_list () in
                  FStar_List.hd uu____4099 in
                FStar_SMTEncoding_Solver.with_hints_db uu____4098
                  (fun uu____4103  ->
