  ...
  fun env ->
    fun lax1 ->
      fun restore_cmd_line_options1 ->
        fun msg ->
          let env1 =
            let uu___59_233 = env in
            {
              FStar_TypeChecker_Env.solver =
                (uu___59_233.FStar_TypeChecker_Env.solver);
              FStar_TypeChecker_Env.range =
                (uu___59_233.FStar_TypeChecker_Env.range);
              FStar_TypeChecker_Env.curmodule =
                (uu___59_233.FStar_TypeChecker_Env.curmodule);
              FStar_TypeChecker_Env.gamma =
                (uu___59_233.FStar_TypeChecker_Env.gamma);
              FStar_TypeChecker_Env.gamma_cache =
                (uu___59_233.FStar_TypeChecker_Env.gamma_cache);
              FStar_TypeChecker_Env.modules =
                (uu___59_233.FStar_TypeChecker_Env.modules);
              FStar_TypeChecker_Env.expected_typ =
                (uu___59_233.FStar_TypeChecker_Env.expected_typ);
              FStar_TypeChecker_Env.sigtab =
                (uu___59_233.FStar_TypeChecker_Env.sigtab);
              FStar_TypeChecker_Env.is_pattern =
                (uu___59_233.FStar_TypeChecker_Env.is_pattern);
              FStar_TypeChecker_Env.instantiate_imp =
                (uu___59_233.FStar_TypeChecker_Env.instantiate_imp);
              FStar_TypeChecker_Env.effects =
                (uu___59_233.FStar_TypeChecker_Env.effects);
              FStar_TypeChecker_Env.generalize =
                (uu___59_233.FStar_TypeChecker_Env.generalize);
              FStar_TypeChecker_Env.letrecs =
                (uu___59_233.FStar_TypeChecker_Env.letrecs);
              FStar_TypeChecker_Env.top_level =
                (uu___59_233.FStar_TypeChecker_Env.top_level);
              FStar_TypeChecker_Env.check_uvars =
                (uu___59_233.FStar_TypeChecker_Env.check_uvars);
              FStar_TypeChecker_Env.use_eq =
                (uu___59_233.FStar_TypeChecker_Env.use_eq);
              FStar_TypeChecker_Env.is_iface =
                (uu___59_233.FStar_TypeChecker_Env.is_iface);
              FStar_TypeChecker_Env.admit =
                (uu___59_233.FStar_TypeChecker_Env.admit);
              FStar_TypeChecker_Env.lax = lax1;
              FStar_TypeChecker_Env.lax_universes =
                (uu___59_233.FStar_TypeChecker_Env.lax_universes);
              FStar_TypeChecker_Env.failhard =
                (uu___59_233.FStar_TypeChecker_Env.failhard);
              FStar_TypeChecker_Env.nosynth =
                (uu___59_233.FStar_TypeChecker_Env.nosynth);
              FStar_TypeChecker_Env.tc_term =
                (uu___59_233.FStar_TypeChecker_Env.tc_term);
              FStar_TypeChecker_Env.type_of =
                (uu___59_233.FStar_TypeChecker_Env.type_of);
              FStar_TypeChecker_Env.universe_of =
                (uu___59_233.FStar_TypeChecker_Env.universe_of);
              FStar_TypeChecker_Env.check_type_of =
                (uu___59_233.FStar_TypeChecker_Env.check_type_of);
              FStar_TypeChecker_Env.use_bv_sorts =
                (uu___59_233.FStar_TypeChecker_Env.use_bv_sorts);
              FStar_TypeChecker_Env.qtbl_name_and_index =
                (uu___59_233.FStar_TypeChecker_Env.qtbl_name_and_index);
              FStar_TypeChecker_Env.proof_ns =
                (uu___59_233.FStar_TypeChecker_Env.proof_ns);
              FStar_TypeChecker_Env.synth_hook =
                (uu___59_233.FStar_TypeChecker_Env.synth_hook);
              FStar_TypeChecker_Env.splice =
                (uu___59_233.FStar_TypeChecker_Env.splice);
              FStar_TypeChecker_Env.is_native_tactic =
                (uu___59_233.FStar_TypeChecker_Env.is_native_tactic);
              FStar_TypeChecker_Env.identifier_info =
                (uu___59_233.FStar_TypeChecker_Env.identifier_info);
              FStar_TypeChecker_Env.tc_hooks =
                (uu___59_233.FStar_TypeChecker_Env.tc_hooks);
              FStar_TypeChecker_Env.dsenv =
                (uu___59_233.FStar_TypeChecker_Env.dsenv);
              FStar_TypeChecker_Env.dep_graph =
                (uu___59_233.FStar_TypeChecker_Env.dep_graph)
            } in
...
let (the_interactive_state : interactive_state) =
  let uu____1294 = FStar_Util.new_string_builder () in
  let uu____1295 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
  let uu____1302 = FStar_Util.mk_ref [] in
  let uu____1309 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
  {
    chunk = uu____1294;
    stdin = uu____1295;
    buffer = uu____1302;
...
let rec (read_chunk : Prims.unit -> input_chunks) =
  fun uu____1528 ->
    ...
    let log1 =
      let uu____1533 = FStar_Options.debug_any () in
      if uu____1533
      then
        let transcript =
          let uu____1537 = FStar_ST.op_Bang s.log in
      ...
      else (fun uu____1604 -> ()) in
    let stdin =
      let uu____1606 = FStar_ST.op_Bang s.stdin in
      ...
      | FStar_Pervasives_Native.None ->
          ...
          (FStar_ST.op_Colon_Equals s.stdin (FStar_Pervasives_Native.Some i);
           i) in
    let line =
      let uu____1671 = FStar_Util.read_line stdin in
    ...
    (let l = FStar_Util.trim_string line in
     ...
     then
       let responses =
         ...
         | uu____1686::ok::fail1::[] -> (ok, fail1)
         | uu____1689 -> ("ok", "fail") in
         ...
         then
           (FStar_Util.clear_string_builder s.chunk;
            (let lc_lax =
               ...
               FStar_Util.trim_string uu____1703 in
             let lc =
               match FStar_Util.split lc_lax " " with
               | l1::c::"#lax"::[] ->
                   let uu____1719 = FStar_Util.int_of_string l1 in
                   let uu____1720 = FStar_Util.int_of_string c in
                   (true, uu____1719, uu____1720)
               | l1::c::[] ->
                   let uu____1723 = FStar_Util.int_of_string l1 in
                   let uu____1724 = FStar_Util.int_of_string c in
                   (false, uu____1723, uu____1724)
               | uu____1725 ->
           ...
           then
             (match FStar_Util.split l " " with
              ...
              | uu____1747::symbol::file::row::col::[] ->
                  (FStar_Util.clear_string_builder s.chunk;
                   (let uu____1753 =
                      let uu____1768 =
                        let uu____1777 =
                          let uu____1784 = FStar_Util.int_of_string row in
                          let uu____1785 = FStar_Util.int_of_string col in
                          (file, uu____1784, uu____1785) in
                        FStar_Pervasives_Native.Some uu____1777 in
                      (symbol, false, uu____1768) in
                    Info uu____1753))
              | uu____1800 ->
                  (FStar_Errors.log_issue FStar_Range.dummyRange
...
let (shift_chunk : Prims.unit -> input_chunks) =
  fun uu____1818 ->
    let s = the_interactive_state in
    let uu____1820 = FStar_ST.op_Bang s.buffer in
...
let (fill_buffer : Prims.unit -> Prims.unit) =
  fun uu____1888 ->
    let s = the_interactive_state in
    let uu____1890 =
      let uu____1893 = FStar_ST.op_Bang s.buffer in
      let uu____1925 = let uu____1928 = read_chunk () in [uu____1928] in
      FStar_List.append uu____1893 uu____1925 in
    FStar_ST.op_Colon_Equals s.buffer uu____1890
let (deps_of_our_file :
  ...
  =
  fun filename ->
    let uu____1971 = FStar_Dependencies.find_deps_if_needed [filename] in
    match uu____1971 with
    | (deps, dep_graph1) ->
        let uu____1994 =
          FStar_List.partition
            (fun x ->
               let uu____2007 = FStar_Parser_Dep.lowercase_module_name x in
               let uu____2008 =
                 FStar_Parser_Dep.lowercase_module_name filename in
               uu____2007 <> uu____2008) deps in
        (match uu____1994 with
         | (deps1, same_name) ->
             let maybe_intf =
               ...
               | intf::impl::[] ->
                   ((let uu____2037 =
                       (let uu____2040 = FStar_Parser_Dep.is_interface intf in
                        Prims.op_Negation uu____2040) ||
                         (let uu____2042 =
               ...
               | uu____2051 ->
                   ((let uu____2055 =
                       ...
                       (FStar_Errors.Warning_UnexpectedFile, uu____2060) in
                     FStar_Errors.log_issue FStar_Range.dummyRange uu____2055);
        ...
        fun remaining ->
          fun ts ->
            ...
            | uu____2110 ->
                ...
                let env1 =
                  let uu____2125 = FStar_Options.lax () in
                  push_with_kind env uu____2125 true "typecheck_modul" in
                let uu____2126 = tc_one_file remaining env1 in
                         ...
                         | FStar_Pervasives_Native.Some intf1 ->
                             let uu____2178 =
                               FStar_Parser_ParseIt.get_file_last_modification_time
                                 intf1 in
                             FStar_Pervasives_Native.Some uu____2178
                         | FStar_Pervasives_Native.None ->
                             FStar_Pervasives_Native.None in
                       let impl_t =
                         FStar_Parser_ParseIt.get_file_last_modification_time
      ...
      fun stk ->
        fun env ->
          fun ts ->
            ...
            let rec iterate depnames st env' ts1 good_stack good_ts =
              ...
              let rec pop_tc_and_stack env1 stack ts2 =
                ...
                | uu____2468::ts3 ->
                    (pop env1 "";
                     (let uu____2509 =
                        let uu____2524 = FStar_List.hd stack in
                        let uu____2533 = FStar_List.tl stack in
                        (uu____2524, uu____2533) in
                      match uu____2509 with
                      | ((env2, uu____2555), stack1) ->
                          pop_tc_and_stack env2 stack1 ts3)) in
              match ts1 with
              | ts_elt::ts' ->
                  let uu____2619 = ts_elt in
                  (match uu____2619 with
                   | (intf, impl, intf_t, impl_t) ->
                       let uu____2650 = match_dep depnames intf impl in
                       (match uu____2650 with
                        | (b, depnames') ->
                            ...
                            then
                              ...
                              (let uu____2686 =
                                 let uu____2701 = FStar_List.hd st in
                                 let uu____2710 = FStar_List.tl st in
            ...
            let uu____2787 = deps_of_our_file filename in
            match uu____2787 with
            | (filenames, uu____2805, dep_graph1) ->
  ...
  fun env ->
    fun name ->
      fun typ ->
        fun range ->
          fun doc1 ->
            let uu____2882 = FStar_Range.string_of_range range in
            let uu____2883 =
            ...
            let uu____2884 =
              ...
              | FStar_Pervasives_Native.None -> "" in
            FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2882 name
            ...
            fun ts ->
              ...
              | Info (symbol, fqn_only, pos_opt) ->
                  ...
                  let info_opt =
                    ...
                    | FStar_Pervasives_Native.Some uu____3007 ->
                        info_at_pos_opt
                    | FStar_Pervasives_Native.None ->
                        if symbol = ""
                        then FStar_Pervasives_Native.None
                          ...
                          (let lid =
                             ...
                             FStar_Ident.lid_of_ids uu____3062 in
                           let lid1 =
                             if fqn_only
                             then lid
                             else
                              ...
                              let uu____3206 =
                                let uu____3209 =
                                  FStar_Syntax_DsEnv.try_lookup_doc
                                    env.FStar_TypeChecker_Env.dsenv lid in
                                FStar_All.pipe_right uu____3209
                                  (FStar_Util.map_option
              ...
              | Completions search_term ->
                  ...
                  let rec locate_match needle candidate =
                    let uu____3440 = measure_anchored_match needle candidate in
                    ...
                    | FStar_Pervasives_Native.None ->
                        (match candidate with
                         | [] -> FStar_Pervasives_Native.None
                         | hc::tc1 ->
                             let uu____3519 = locate_match needle tc1 in
                    ...
                    | (prefix1, matched, match_len) ->
                        ...
                        (match uu____3706 with
                         | (stripped_ns, shortened) ->
                             let uu____3733 = str_of_ids shortened in
                             let uu____3734 = str_of_ids matched in
                             let uu____3735 = str_of_ids stripped_ns in
                             (uu____3733, uu____3734, uu____3735, match_len)) in
                  let prepare_candidate uu____3753 =
                  ...
                  let matches =
                                ...
                                FStar_Option.map
                                  (fun fqn ->
                                     let uu____3897 =
                                       ...
                                       FStar_List.append uu____3900
                                         [fqn.FStar_Ident.ident] in
                                     ([], uu____3897, matched_length))
                                  uu____3881
                              else FStar_Pervasives_Native.None)) in
                    let case_b_find_matches_in_env uu____3933 =
                      let matches =
                              ...
                              | (ns, id1, uu____4021) ->
                                  ...
                                  (match uu____4030 with
                                   ...
                                   | FStar_Pervasives_Native.Some l ->
                                       ...
                                       FStar_Ident.lid_equals l uu____4035))) in
                    let uu____4036 = FStar_Util.prefix needle in
                    ...
                    | (ns, id1) ->
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x ->
                                let uu____4151 = shorten_namespace x in
                                prepare_candidate uu____4151)) in
                  ((let uu____4161 =
                      FStar_Util.sort_with
                        (fun uu____4184 ->
                           fun uu____4185 ->
                             match (uu____4184, uu____4185) with
                             | ((cd1, ns1, uu____4212),
                                (cd2, ns2, uu____4215)) ->
              ...
              | Code (text, (ok, fail1)) ->
                  ...
                  (match res with
                   ...
                   | uu____4474 -> fail2 curmod env)
let (interactive_mode : Prims.string -> Prims.unit) =
  fun filename ->
    (let uu____4489 =
       let uu____4490 = FStar_Options.codegen () in
       FStar_Option.isSome uu____4490 in
     if uu____4489
     then
       FStar_Errors.log_issue FStar_Range.dummyRange
    ...
    (let uu____4494 = deps_of_our_file filename in
          ...
          | (stack, env1, ts) ->
              let initial_range =
                ...
                let uu____4545 =
                  FStar_Range.mk_pos (Prims.parse_int "1")
                    (Prims.parse_int "0") in
                FStar_Range.mk_range "<input>" uu____4544 uu____4545 in
              ...
              then
                let uu____4550 =
                  let uu____4551 = FStar_Options.file_list () in
                  FStar_List.hd uu____4551 in
                FStar_SMTEncoding_Solver.with_hints_db uu____4550
                  (fun uu____4555 ->
