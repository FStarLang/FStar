...
let is_inr = (fun _95357 -> (match (_95357) with
...
in (let exps = (Support.List.map (fun _95358 -> (match (_95358) with
...
(Support.Prims.try_with (fun _95470 -> (match (_95470) with
| () -> begin
(let _95476 = (Support.Microsoft.FStar.Util.int_of_string (Support.Microsoft.FStar.Util.substring_from bvd.Microsoft_FStar_Absyn_Syntax.ppname.Microsoft_FStar_Absyn_Syntax.idText 1))
in "_?")
end)) (fun _95469 -> bvd.Microsoft_FStar_Absyn_Syntax.ppname.Microsoft_FStar_Absyn_Syntax.idText))
end else begin
bvd.Microsoft_FStar_Absyn_Syntax.ppname.Microsoft_FStar_Absyn_Syntax.idText
end
end)

let filter_imp = (fun a -> ((Support.List.filter (fun _95359 -> (match (_95359) with
...
and meta_e_to_string = (fun _95360 -> (match (_95360) with
...
(Support.List.filter (fun _95361 -> (match (_95361) with
| (_, Some (Microsoft_FStar_Absyn_Syntax.Implicit)) -> begin
false
end
| _ -> begin
...
and uvar_t_to_string = (fun _95689 -> (match (_95689) with
| (uv, k) -> begin
...
and imp_to_string = (fun s _95362 -> (match (_95362) with
...
and arg_to_string = (fun _95363 -> (match (_95363) with
| (Support.Microsoft.FStar.Util.Inl (a), imp) -> begin
...
(let basic = if (((Support.Microsoft.FStar.Util.for_some (fun _95364 -> (match (_95364) with
...
if ((not ((! (Microsoft_FStar_Options.print_effect_args)))) && ((Support.Microsoft.FStar.Util.for_some (fun _95365 -> (match (_95365) with
...
in (let dec = ((Support.String.concat " ") ((Support.List.collect (fun _95366 -> (match (_95366) with
...
and formula_to_string_old_now_unused = (fun phi -> (let const_op = (fun f _95760 -> f)
in (let un_op = (fun f _95367 -> (match (_95367) with
...
in (let bin_top = (fun f _95368 -> (match (_95368) with
...
in (let bin_eop = (fun f _95369 -> (match (_95369) with
...
in (let ite = (fun _95370 -> (match (_95370) with
...
in (let eq_op = (fun _95371 -> (match (_95371) with
...
(match (((Support.List.tryFind (fun _95879 -> (match (_95879) with
| (l, _) -> begin
...
| None -> begin
(let args' = ((Support.List.filter (fun _95372 -> (match (_95372) with
...
and uvar_e_to_string = (fun _95967 -> (match (_95967) with
| (uv, _) -> begin
...
""
end) (Support.Microsoft.FStar.Util.concat_l "\n and " ((Support.List.map (fun _95972 -> (match (_95972) with
| (x, t, e) -> begin
...
and uvar_k_to_string' = (fun _96043 -> (match (_96043) with
| (uv, args) -> begin
...
let subst_to_string = (fun subst -> ((Support.Microsoft.FStar.Util.format1 "{%s}") ((Support.String.concat ", ") (Support.List.map (fun _95373 -> (match (_95373) with
...
let qual_to_string = (fun _95374 -> (match (_95374) with
