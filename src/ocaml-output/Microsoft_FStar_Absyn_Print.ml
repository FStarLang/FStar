...
let is_inr = (fun _96246 -> (match (_96246) with
...
in (let exps = (Support.List.map (fun _96247 -> (match (_96247) with
...
(Support.Prims.try_with (fun _96359 -> (match (_96359) with
| () -> begin
(let _96365 = (Support.Microsoft.FStar.Util.int_of_string (Support.Microsoft.FStar.Util.substring_from bvd.Microsoft_FStar_Absyn_Syntax.ppname.Microsoft_FStar_Absyn_Syntax.idText 1))
in "_?")
end)) (fun _96358 -> bvd.Microsoft_FStar_Absyn_Syntax.ppname.Microsoft_FStar_Absyn_Syntax.idText))
end else begin
bvd.Microsoft_FStar_Absyn_Syntax.ppname.Microsoft_FStar_Absyn_Syntax.idText
end
end)

let filter_imp = (fun a -> ((Support.List.filter (fun _96248 -> (match (_96248) with
...
and meta_e_to_string = (fun _96249 -> (match (_96249) with
...
(Support.List.filter (fun _96250 -> (match (_96250) with
| (_, Some (Microsoft_FStar_Absyn_Syntax.Implicit)) -> begin
false
end
| _ -> begin
...
and uvar_t_to_string = (fun _96578 -> (match (_96578) with
| (uv, k) -> begin
...
and imp_to_string = (fun s _96251 -> (match (_96251) with
...
and arg_to_string = (fun _96252 -> (match (_96252) with
| (Support.Microsoft.FStar.Util.Inl (a), imp) -> begin
...
(let basic = if (((Support.Microsoft.FStar.Util.for_some (fun _96253 -> (match (_96253) with
...
if ((not ((! (Microsoft_FStar_Options.print_effect_args)))) && ((Support.Microsoft.FStar.Util.for_some (fun _96254 -> (match (_96254) with
...
in (let dec = ((Support.String.concat " ") ((Support.List.collect (fun _96255 -> (match (_96255) with
...
and formula_to_string_old_now_unused = (fun phi -> (let const_op = (fun f _96649 -> f)
in (let un_op = (fun f _96256 -> (match (_96256) with
...
in (let bin_top = (fun f _96257 -> (match (_96257) with
...
in (let bin_eop = (fun f _96258 -> (match (_96258) with
...
in (let ite = (fun _96259 -> (match (_96259) with
...
in (let eq_op = (fun _96260 -> (match (_96260) with
...
(match (((Support.List.tryFind (fun _96768 -> (match (_96768) with
| (l, _) -> begin
...
| None -> begin
(let args' = ((Support.List.filter (fun _96261 -> (match (_96261) with
...
and uvar_e_to_string = (fun _96856 -> (match (_96856) with
| (uv, _) -> begin
...
""
end) (Support.Microsoft.FStar.Util.concat_l "\n and " ((Support.List.map (fun _96861 -> (match (_96861) with
| (x, t, e) -> begin
...
and uvar_k_to_string' = (fun _96932 -> (match (_96932) with
| (uv, args) -> begin
...
let subst_to_string = (fun subst -> ((Support.Microsoft.FStar.Util.format1 "{%s}") ((Support.String.concat ", ") (Support.List.map (fun _96262 -> (match (_96262) with
...
let qual_to_string = (fun _96263 -> (match (_96263) with
