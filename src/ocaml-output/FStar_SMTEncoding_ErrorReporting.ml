                        ...
                        | () ->
                            (match arg.FStar_SMTEncoding_Term.tm with
                             | FStar_SMTEncoding_Term.Quant
                                 ...
                                 let post_name =
                                   let uu____845 =
                                     let uu____847 = FStar_Ident.next_id () in
                                     FStar_All.pipe_left
                                       FStar_Util.string_of_int uu____847 in
                                   Prims.op_Hat "^^post_condition_" uu____845 in
                                 let names =
                                   let uu____855 =
                                            ...
                                            let uu____1116 =
                                              let uu____1117 =
                                                ...
                                                Prims.op_Hat
                                                  "LHS not a conjunct: "
                                                  uu____1119 in
                                              Not_a_wp_implication uu____1117 in
                                            FStar_Exn.raise uu____1116 in
                           ...
                           FStar_List.map
                             (fun s ->
                                let uu____1287 =
                                  let uu____1293 =
                                    let uu____1295 =
                                      let uu____1297 = FStar_Ident.next_id () in
                                      FStar_All.pipe_left
                                        FStar_Util.string_of_int uu____1297 in
                   ...
                   | (labels2, q12) ->
                       ...
                       (match uu____1641 with
                        | (labels3, q21) ->
                            ...
                            (labels3, uu____1660)))
              | FStar_SMTEncoding_Term.Quant
                  (FStar_SMTEncoding_Term.Exists, uu____1663, uu____1664,
        ...
        fun askZ3 ->
          let print_banner uu____2365 =
            let msg1 =
              ...
              let uu____2371 = FStar_Util.string_of_int (Prims.of_int (5)) in
              let uu____2374 =
                    ...
                    (let uu____2439 =
                       let uu____2445 =
                         ...
                         FStar_Util.format2
                           ...
                           uu____2447 msg1 in
                       (FStar_Errors.Error_ProofObligationFailed, uu____2445) in
                     FStar_Errors.log_issue r uu____2439) in
          let elim labs =
                 ...
                 (fun uu____2500 ->
                    ...
                    | (l, uu____2509, uu____2510) ->
                        let a =
                          ...
                          let uu____2521 =
                            let uu____2523 = FStar_SMTEncoding_Term.fv_name l in
             ...
             | hd::tl ->
                 ((let uu____2637 =
                  ...
                  (let decls =
                   ...
                   | uu____2670 -> linear_check eliminated (hd :: errors) tl))) in
          print_banner ();
