...
let uu___127_524 = r1
in {FStar_Range.def_range = rng.FStar_Range.def_range; FStar_Range.use_range = uu___127_524.FStar_Range.use_range})
end)
...
in (FStar_All.try_with (fun uu___129_623 -> (match (()) with
| () -> begin
...
end)) (fun uu___128_977 -> (match (uu___128_977) with
