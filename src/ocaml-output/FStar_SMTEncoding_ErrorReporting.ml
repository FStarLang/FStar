...
let _87_281 = (let _182_100 = (FStar_SMTEncoding_Term.inst instantiation lhs)
...
let _87_533 = (let _182_156 = (FStar_All.pipe_left elim (FStar_List.append eliminated (FStar_List.append errors tl)))
in (askZ3 _182_156))
