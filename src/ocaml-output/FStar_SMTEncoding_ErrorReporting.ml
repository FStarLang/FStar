      ...
      fun t  ->
        let l =
          ...
          (let uu____143 =
           ...
           FStar_Util.format1 "label_%s" uu____143)
           in
        ...
        | (flag,msg_prefix) ->
            let fresh_label1 msg ropt rng t =
              ...
              let rng1 =
                ...
                | None  -> rng
                | Some r1 ->
                    let uu___105_302 = r1  in
                    {
                      FStar_Range.def_range = (rng.FStar_Range.def_range);
                      FStar_Range.use_range =
                        (uu___105_302.FStar_Range.use_range)
                    }
                 in
              ...
              | FStar_SMTEncoding_Term.Quant
                  ...
                  let post_name =
                    let uu____587 =
                      ...
                      FStar_All.pipe_left FStar_Util.string_of_int uu____588
                       in
                    Prims.strcat "^^post_condition_" uu____587  in
                  let names1 = (post_name, post)  in
                  let instantiation =
                    let uu____594 = FStar_SMTEncoding_Util.mkFreeV names1  in
                    [uu____594]  in
                  let uu____595 =
                    let uu____598 =
