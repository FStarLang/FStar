                            ...
                            | FStar_SMTEncoding_Term.Quant
                                ...
                                let post_name =
                                  let uu____376 =
                                    ...
                                    FStar_All.pipe_left
                                      FStar_Util.string_of_int uu____377
                                     in
                                  Prims.strcat "^^post_condition_" uu____376
                                   in
                                let names =
                                  let uu____382 =
                                    FStar_List.mapi
                                           ...
                                           let uu____508 =
                                             let uu____509 =
                                               ...
                                               Prims.strcat
                                                 ...
                                                 uu____510
                                                in
                                             Not_a_wp_implication uu____509
                                              in
                                ...
                                let uu____553 =
                                  let uu____554 =
                                    FStar_SMTEncoding_Term.print_smt_term arg
                                     in
                                  Prims.strcat "arg not a quant: " uu____554
                                   in
                                fallback uu____553))
                    (fun uu___100_555  ->
                       match uu___100_555 with
        ...
        let print_result uu____940 =
          ...
          | ((uu____946,msg,r),success) ->
              (match success with
               ...
               | uu____954 -> FStar_Errors.report r msg)
           in
        let elim labs =
