...
(let _0_438 = (FStar_Util.string_of_int (FStar_ST.read ctr))
in (FStar_Util.format1 "label_%s" _0_438));
)
in (
...
let post_name = (let _0_441 = (let _0_440 = (FStar_Syntax_Syntax.next_id ())
in (FStar_All.pipe_left FStar_Util.string_of_int _0_440))
in (Prims.strcat "^^post_condition_" _0_441))
in (

let names = (let _0_444 = (FStar_List.mapi (fun i s -> (let _0_443 = (let _0_442 = (FStar_Util.string_of_int i)
in (Prims.strcat "^^" _0_442))
in ((_0_443), (s)))) sorts)
in (((post_name), (post)))::_0_444)
in (

let instantiation = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV names)
in (

let uu____387 = (let _0_446 = (FStar_SMTEncoding_Term.inst instantiation lhs)
in (let _0_445 = (FStar_SMTEncoding_Term.inst instantiation rhs)
in ((_0_446), (_0_445))))
...
let ens = (let _0_448 = FStar_SMTEncoding_Term.Quant ((let _0_447 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.App (((FStar_SMTEncoding_Term.Imp), ((ensures_conjuncts)::(post)::[])))) rng_ens)
in ((FStar_SMTEncoding_Term.Forall), (pats_ens), (iopt_ens), (sorts_ens), (_0_447))))
in (FStar_SMTEncoding_Term.mk _0_448 ens.FStar_SMTEncoding_Term.rng))
in (
...
in (let _0_449 = (FStar_SMTEncoding_Term.abstr names lhs)
in ((labels), (_0_449))))))
end))
end
| uu____472 -> begin
(Prims.raise (Not_a_wp_implication ((let _0_452 = (let _0_451 = (let _0_450 = (FStar_SMTEncoding_Term.print_smt_term ens)
in (Prims.strcat "  ... " _0_450))
in (Prims.strcat post_name _0_451))
in (Prims.strcat "Ensures clause doesn\'t match post name:  " _0_452)))))
end)
end))
end
| uu____476 -> begin
(Prims.raise (Not_a_wp_implication ((let _0_453 = (FStar_SMTEncoding_Term.print_smt_term lhs)
in (Prims.strcat "LHS not a conjunct: " _0_453)))))
end)
...
| (labels, rhs) -> begin
(let _0_454 = (FStar_SMTEncoding_Term.abstr names rhs)
in ((labels), (_0_454)))
end))
...
in (let _0_455 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.Quant (((FStar_SMTEncoding_Term.Forall), (pats), (iopt), ((post)::sorts), (body)))) q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_455))))
end))
end))
end)))))
...
| uu____516 -> begin
(fallback (let _0_456 = (FStar_SMTEncoding_Term.print_smt_term arg)
in (Prims.strcat "arg not a quant: " _0_456)))
end)
end)
with
...
let post_name = (let _0_458 = (let _0_457 = (FStar_Syntax_Syntax.next_id ())
in (FStar_All.pipe_left FStar_Util.string_of_int _0_457))
in (Prims.strcat "^^post_condition_" _0_458))
in (

let names = ((post_name), (post))
in (

let instantiation = (let _0_459 = (FStar_SMTEncoding_Util.mkFreeV names)
in (_0_459)::[])
in (

let uu____546 = (let _0_461 = (FStar_SMTEncoding_Term.inst instantiation lhs)
in (let _0_460 = (FStar_SMTEncoding_Term.inst instantiation rhs)
in ((_0_461), (_0_460))))
...
| (labels, r) -> begin
(let _0_464 = (let _0_463 = FStar_SMTEncoding_Term.Quant ((let _0_462 = (FStar_SMTEncoding_Util.norng FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.App (((FStar_SMTEncoding_Term.Iff), ((l)::(r)::[])))))
in ((FStar_SMTEncoding_Term.Forall), (((p)::[])::[]), (Some ((Prims.parse_int "0"))), (sorts), (_0_462))))
in (FStar_SMTEncoding_Term.mk _0_463 q.FStar_SMTEncoding_Term.rng))
in ((labels), (_0_464)))
end))
end
| uu____612 -> begin
...
let body = (let _0_467 = (let _0_466 = (let _0_465 = (FStar_SMTEncoding_Term.mk_and_l lhs_conjs lhs.FStar_SMTEncoding_Term.rng)
in ((_0_465), (rhs)))
in (FStar_SMTEncoding_Term.mkImp _0_466 rng))
in (FStar_All.pipe_right _0_467 (FStar_SMTEncoding_Term.abstr ((names)::[]))))
in (
...
(let _0_469 = (FStar_SMTEncoding_Term.mk_and_l conjuncts q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_469)))
end))
end
...
| (labels, q2) -> begin
(let _0_470 = (FStar_SMTEncoding_Term.mkITE ((hd), (q1), (q2)) q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_470)))
end))
end))
end
...
| (labels, body) -> begin
(let _0_471 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.Quant (((FStar_SMTEncoding_Term.Forall), (pats), (iopt), (sorts), (body)))) q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_471)))
end))
end))
...
let print_banner = (fun uu____841 -> (let _0_474 = (FStar_Range.string_of_range (FStar_TypeChecker_Env.get_range env))
in (let _0_473 = (FStar_Util.string_of_int (Prims.parse_int "5"))
in (let _0_472 = (FStar_Util.string_of_int (FStar_List.length all_labels))
...
(match (success) with
| true -> begin
(let _0_475 = (FStar_Range.string_of_range r)
...
FStar_SMTEncoding_Term.Assume ((let _0_477 = (FStar_SMTEncoding_Util.mkEq (let _0_476 = (FStar_SMTEncoding_Util.mkFreeV l)
in ((_0_476), (FStar_SMTEncoding_Util.mkTrue))))
in ((_0_477), (Some ("Disabling label")), (Some ((Prims.strcat "disable_label_" (Prims.fst l)))))))
end)))))
in (
...
let results = (let _0_479 = (FStar_List.map (fun x -> ((x), (true))) eliminated)
in (let _0_478 = (FStar_List.map (fun x -> ((x), (false))) errors)
in (FStar_List.append _0_479 _0_478)))
in (sort_labels results))
end
| (hd)::tl -> begin
((let _0_480 = (FStar_Util.string_of_int (FStar_List.length active))
in (FStar_Util.print1 "%s, " _0_480));
