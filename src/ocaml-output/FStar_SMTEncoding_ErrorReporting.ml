      ...
      fun t ->
        let l =
          ...
          (let uu____290 =
           ...
           FStar_Util.format1 "label_%s" uu____290) in
      ...
      fun q ->
          ...
          | FStar_SMTEncoding_Term.Quant
              (FStar_SMTEncoding_Term.Forall,
               ({
                  ...
                  FStar_SMTEncoding_Term.rng = uu____454;_}::[])::[],
               iopt, uu____456,
               {
                 FStar_SMTEncoding_Term.tm = FStar_SMTEncoding_Term.App
        ...
        let uu____506 =
          ...
          | FStar_Pervasives_Native.Some f ->
              let uu____525 = f () in (true, uu____525) in
                ...
                | FStar_Pervasives_Native.Some r1 ->
                    ...
                    then rng
                      ...
                      (let uu____569 = FStar_Range.def_range rng in
                       FStar_Range.set_def_range r1 uu____569) in
                             ...
                             | FStar_SMTEncoding_Term.Quant
                                 ...
                                 let post_name =
                                   let uu____728 =
                                     ...
                                     FStar_All.pipe_left
                                       FStar_Util.string_of_int uu____729 in
                                   Prims.strcat "^^post_condition_" uu____728 in
                                 let names1 =
                                   let uu____737 =
                                     FStar_List.map
                                       (fun s ->
              ...
              | FStar_SMTEncoding_Term.Quant
                  ...
                  (match uu____1090 with
                   | (sorts', post) ->
                       let new_post_name =
                         let uu____1110 =
                           let uu____1111 = FStar_Syntax_Syntax.next_id () in
                                ...
                                let uu____1133 =
                                  let uu____1134 =
                                    let uu____1135 =
                                      FStar_Syntax_Syntax.next_id () in
                                    FStar_All.pipe_left
                                      FStar_Util.string_of_int uu____1135 in
                                  Prims.strcat "^^" uu____1134 in
                                (uu____1133, s)) sorts' in
                         FStar_List.append uu____1119 [(new_post_name, post)] in
                       let instantiation =
                   ...
                   | (labels1, q12) ->
                       ...
                       (match uu____1463 with
                        | (labels2, q21) ->
                            ...
                            (labels2, uu____1482)))
              | FStar_SMTEncoding_Term.Quant
                  (FStar_SMTEncoding_Term.Exists, uu____1485, uu____1486,
        ...
        fun askZ3 ->
          let print_banner uu____2132 =
            let msg =
              ...
              let uu____2136 = FStar_Util.string_of_int (Prims.parse_int "5") in
              let uu____2137 =
