...
(let _0_443 = (FStar_Util.string_of_int (FStar_ST.read ctr))
in (FStar_Util.format1 "label_%s" _0_443));
)
in (
...
let post_name = (let _0_446 = (let _0_445 = (FStar_Syntax_Syntax.next_id ())
in (FStar_All.pipe_left FStar_Util.string_of_int _0_445))
in (Prims.strcat "^^post_condition_" _0_446))
in (

let names = (let _0_449 = (FStar_List.mapi (fun i s -> (let _0_448 = (let _0_447 = (FStar_Util.string_of_int i)
in (Prims.strcat "^^" _0_447))
in ((_0_448), (s)))) sorts)
in (((post_name), (post)))::_0_449)
in (

let instantiation = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV names)
in (

let uu____387 = (let _0_451 = (FStar_SMTEncoding_Term.inst instantiation lhs)
in (let _0_450 = (FStar_SMTEncoding_Term.inst instantiation rhs)
in ((_0_451), (_0_450))))
...
let ens = (let _0_453 = FStar_SMTEncoding_Term.Quant ((let _0_452 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.App (((FStar_SMTEncoding_Term.Imp), ((ensures_conjuncts)::(post)::[])))) rng_ens)
in ((FStar_SMTEncoding_Term.Forall), (pats_ens), (iopt_ens), (sorts_ens), (_0_452))))
in (FStar_SMTEncoding_Term.mk _0_453 ens.FStar_SMTEncoding_Term.rng))
in (
...
in (let _0_454 = (FStar_SMTEncoding_Term.abstr names lhs)
in ((labels), (_0_454))))))
end))
end
| uu____472 -> begin
(Prims.raise (Not_a_wp_implication ((let _0_457 = (let _0_456 = (let _0_455 = (FStar_SMTEncoding_Term.print_smt_term ens)
in (Prims.strcat "  ... " _0_455))
in (Prims.strcat post_name _0_456))
in (Prims.strcat "Ensures clause doesn\'t match post name:  " _0_457)))))
end)
end))
end
| uu____476 -> begin
(Prims.raise (Not_a_wp_implication ((let _0_458 = (FStar_SMTEncoding_Term.print_smt_term lhs)
in (Prims.strcat "LHS not a conjunct: " _0_458)))))
end)
...
| (labels, rhs) -> begin
(let _0_459 = (FStar_SMTEncoding_Term.abstr names rhs)
in ((labels), (_0_459)))
end))
...
in (let _0_460 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.Quant (((FStar_SMTEncoding_Term.Forall), (pats), (iopt), ((post)::sorts), (body)))) q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_460))))
end))
end))
end)))))
...
| uu____516 -> begin
(fallback (let _0_461 = (FStar_SMTEncoding_Term.print_smt_term arg)
in (Prims.strcat "arg not a quant: " _0_461)))
end)
end)
with
...
let post_name = (let _0_463 = (let _0_462 = (FStar_Syntax_Syntax.next_id ())
in (FStar_All.pipe_left FStar_Util.string_of_int _0_462))
in (Prims.strcat "^^post_condition_" _0_463))
in (

let names = ((post_name), (post))
in (

let instantiation = (let _0_464 = (FStar_SMTEncoding_Util.mkFreeV names)
in (_0_464)::[])
in (

let uu____546 = (let _0_466 = (FStar_SMTEncoding_Term.inst instantiation lhs)
in (let _0_465 = (FStar_SMTEncoding_Term.inst instantiation rhs)
in ((_0_466), (_0_465))))
...
| (labels, r) -> begin
(let _0_469 = (let _0_468 = FStar_SMTEncoding_Term.Quant ((let _0_467 = (FStar_SMTEncoding_Util.norng FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.App (((FStar_SMTEncoding_Term.Iff), ((l)::(r)::[])))))
in ((FStar_SMTEncoding_Term.Forall), (((p)::[])::[]), (Some ((Prims.parse_int "0"))), (sorts), (_0_467))))
in (FStar_SMTEncoding_Term.mk _0_468 q.FStar_SMTEncoding_Term.rng))
in ((labels), (_0_469)))
end))
end
| uu____612 -> begin
...
let body = (let _0_472 = (let _0_471 = (let _0_470 = (FStar_SMTEncoding_Term.mk_and_l lhs_conjs lhs.FStar_SMTEncoding_Term.rng)
in ((_0_470), (rhs)))
in (FStar_SMTEncoding_Term.mkImp _0_471 rng))
in (FStar_All.pipe_right _0_472 (FStar_SMTEncoding_Term.abstr ((names)::[]))))
in (
...
| (labels, rhs) -> begin
(let _0_473 = (FStar_SMTEncoding_Util.mkImp ((lhs), (rhs)))
in ((labels), (_0_473)))
end))
end
...
(let _0_474 = (FStar_SMTEncoding_Term.mk_and_l conjuncts q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_474)))
end))
end
...
| (labels, q2) -> begin
(let _0_475 = (FStar_SMTEncoding_Term.mkITE ((hd), (q1), (q2)) q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_475)))
end))
end))
end
...
| (labels, body) -> begin
(let _0_476 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.Quant (((FStar_SMTEncoding_Term.Forall), (pats), (iopt), (sorts), (body)))) q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_476)))
end))
end))
...
let print_banner = (fun uu____841 -> (let _0_479 = (FStar_Range.string_of_range (FStar_TypeChecker_Env.get_range env))
in (let _0_478 = (FStar_Util.string_of_int (Prims.parse_int "5"))
in (let _0_477 = (FStar_Util.string_of_int (FStar_List.length all_labels))
...
(match (success) with
| true -> begin
(let _0_480 = (FStar_Range.string_of_range r)
...
FStar_SMTEncoding_Term.Assume ((let _0_482 = (FStar_SMTEncoding_Util.mkEq (let _0_481 = (FStar_SMTEncoding_Util.mkFreeV l)
in ((_0_481), (FStar_SMTEncoding_Util.mkTrue))))
in ((_0_482), (Some ("Disabling label")), (Some ((Prims.strcat "disable_label_" (Prims.fst l)))))))
end)))))
in (
...
let results = (let _0_484 = (FStar_List.map (fun x -> ((x), (true))) eliminated)
in (let _0_483 = (FStar_List.map (fun x -> ((x), (false))) errors)
in (FStar_List.append _0_484 _0_483)))
in (sort_labels results))
end
| (hd)::tl -> begin
((let _0_485 = (FStar_Util.string_of_int (FStar_List.length active))
in (FStar_Util.print1 "%s, " _0_485));
