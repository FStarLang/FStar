      ...
      fun q ->
        ...
        let uu____573 =
          ...
          | FStar_Pervasives_Native.Some f ->
              let uu____603 = f () in (true, uu____603) in
                ...
                | FStar_Pervasives_Native.Some r1 ->
                    ...
                    then rng
                      ...
                      (let uu____666 = FStar_Range.def_range rng in
                       FStar_Range.set_def_range r1 uu____666) in
                        ...
                        | () ->
                            (match arg.FStar_SMTEncoding_Term.tm with
                             | FStar_SMTEncoding_Term.Quant
                                 ...
                                 let post_name =
                                   let uu____856 =
                                     let uu____858 = FStar_Ident.next_id () in
                                     FStar_All.pipe_left
                                       FStar_Util.string_of_int uu____858 in
                                   Prims.op_Hat "^^post_condition_" uu____856 in
                                 let names1 =
                                   let uu____866 =
                                            ...
                                            let uu____1150 =
                                              let uu____1151 =
                                                ...
                                                Prims.op_Hat
                                                  "LHS not a conjunct: "
                                                  uu____1153 in
                                              Not_a_wp_implication uu____1151 in
                                            FStar_Exn.raise uu____1150 in
                           ...
                           FStar_List.map
                             (fun s ->
                                let uu____1365 =
                                  let uu____1371 =
                                    let uu____1373 =
                                      let uu____1375 = FStar_Ident.next_id () in
                                      FStar_All.pipe_left
                                        FStar_Util.string_of_int uu____1375 in
                   ...
                   | (labels1, q12) ->
                       ...
                       (match uu____1780 with
                        | (labels2, q21) ->
                            ...
                            (labels2, uu____1799)))
              | FStar_SMTEncoding_Term.Quant
                  (FStar_SMTEncoding_Term.Exists, uu____1802, uu____1803,
        ...
        fun askZ3 ->
          let print_banner uu____2555 =
            let msg =
              ...
              let uu____2561 = FStar_Util.string_of_int (Prims.parse_int "5") in
              let uu____2564 =
                    ...
                    (let uu____2629 =
                       let uu____2635 =
                         ...
                         FStar_Util.format2
                           ...
                           uu____2637 msg in
                       (FStar_Errors.Error_ProofObligationFailed, uu____2635) in
                     FStar_Errors.log_issue r uu____2629) in
          let elim labs =
                 ...
                 (fun uu____2690 ->
                    ...
                    | (l, uu____2699, uu____2700) ->
                        let a =
                          ...
                          let uu____2711 =
                            let uu____2713 = FStar_SMTEncoding_Term.fv_name l in
