...
(let _0_426 = (FStar_Util.string_of_int (FStar_ST.read ctr))
in (FStar_Util.format1 "label_%s" _0_426));
)
in (
...
let post_name = (let _0_429 = (let _0_428 = (FStar_Syntax_Syntax.next_id ())
in (FStar_All.pipe_left FStar_Util.string_of_int _0_428))
in (Prims.strcat "^^post_condition_" _0_429))
in (

let names = (let _0_432 = (FStar_List.mapi (fun i s -> (let _0_431 = (let _0_430 = (FStar_Util.string_of_int i)
in (Prims.strcat "^^" _0_430))
in ((_0_431), (s)))) sorts)
in (((post_name), (post)))::_0_432)
in (

let instantiation = (FStar_List.map FStar_SMTEncoding_Util.mkFreeV names)
in (

let uu____387 = (let _0_434 = (FStar_SMTEncoding_Term.inst instantiation lhs)
in (let _0_433 = (FStar_SMTEncoding_Term.inst instantiation rhs)
in ((_0_434), (_0_433))))
...
let ens = (let _0_436 = FStar_SMTEncoding_Term.Quant ((let _0_435 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.App (((FStar_SMTEncoding_Term.Imp), ((ensures_conjuncts)::(post)::[])))) rng_ens)
in ((FStar_SMTEncoding_Term.Forall), (pats_ens), (iopt_ens), (sorts_ens), (_0_435))))
in (FStar_SMTEncoding_Term.mk _0_436 ens.FStar_SMTEncoding_Term.rng))
in (
...
in (let _0_437 = (FStar_SMTEncoding_Term.abstr names lhs)
in ((labels), (_0_437))))))
end))
end
| uu____472 -> begin
(Prims.raise (Not_a_wp_implication ((let _0_440 = (let _0_439 = (let _0_438 = (FStar_SMTEncoding_Term.print_smt_term ens)
in (Prims.strcat "  ... " _0_438))
in (Prims.strcat post_name _0_439))
in (Prims.strcat "Ensures clause doesn\'t match post name:  " _0_440)))))
end)
end))
end
| uu____476 -> begin
(Prims.raise (Not_a_wp_implication ((let _0_441 = (FStar_SMTEncoding_Term.print_smt_term lhs)
in (Prims.strcat "LHS not a conjunct: " _0_441)))))
end)
...
| (labels, rhs) -> begin
(let _0_442 = (FStar_SMTEncoding_Term.abstr names rhs)
in ((labels), (_0_442)))
end))
...
in (let _0_443 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.Quant (((FStar_SMTEncoding_Term.Forall), (pats), (iopt), ((post)::sorts), (body)))) q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_443))))
end))
end))
end)))))
...
| uu____516 -> begin
(fallback (let _0_444 = (FStar_SMTEncoding_Term.print_smt_term arg)
in (Prims.strcat "arg not a quant: " _0_444)))
end)
end)
with
...
let instantiation = (let _0_447 = (FStar_SMTEncoding_Util.mkFreeV names)
in (_0_447)::[])
in (

let uu____546 = (let _0_449 = (FStar_SMTEncoding_Term.inst instantiation lhs)
...
| (labels, r) -> begin
(let _0_452 = (let _0_451 = FStar_SMTEncoding_Term.Quant ((let _0_450 = (FStar_SMTEncoding_Util.norng FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.App (((FStar_SMTEncoding_Term.Iff), ((l)::(r)::[])))))
in ((FStar_SMTEncoding_Term.Forall), (((p)::[])::[]), (Some ((Prims.parse_int "0"))), (sorts), (_0_450))))
in (FStar_SMTEncoding_Term.mk _0_451 q.FStar_SMTEncoding_Term.rng))
in ((labels), (_0_452)))
end))
end
| uu____612 -> begin
...
let body = (let _0_455 = (let _0_454 = (let _0_453 = (FStar_SMTEncoding_Term.mk_and_l lhs_conjs lhs.FStar_SMTEncoding_Term.rng)
in ((_0_453), (rhs)))
in (FStar_SMTEncoding_Term.mkImp _0_454 rng))
in (FStar_All.pipe_right _0_455 (FStar_SMTEncoding_Term.abstr ((names)::[]))))
in (
...
| (labels, rhs) -> begin
(let _0_456 = (FStar_SMTEncoding_Util.mkImp ((lhs), (rhs)))
in ((labels), (_0_456)))
end))
end
...
(let _0_457 = (FStar_SMTEncoding_Term.mk_and_l conjuncts q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_457)))
end))
end
...
| (labels, q2) -> begin
(let _0_458 = (FStar_SMTEncoding_Term.mkITE ((hd), (q1), (q2)) q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_458)))
end))
end))
end
...
| (labels, body) -> begin
(let _0_459 = (FStar_SMTEncoding_Term.mk (FStar_SMTEncoding_Term.Quant (((FStar_SMTEncoding_Term.Forall), (pats), (iopt), (sorts), (body)))) q.FStar_SMTEncoding_Term.rng)
in ((labels), (_0_459)))
end))
end))
...
let print_banner = (fun uu____841 -> (let _0_462 = (FStar_Range.string_of_range (FStar_TypeChecker_Env.get_range env))
in (let _0_461 = (FStar_Util.string_of_int (Prims.parse_int "5"))
in (let _0_460 = (FStar_Util.string_of_int (FStar_List.length all_labels))
...
(match (success) with
| true -> begin
(let _0_463 = (FStar_Range.string_of_range r)
...
FStar_SMTEncoding_Term.Assume ((let _0_465 = (FStar_SMTEncoding_Util.mkEq (let _0_464 = (FStar_SMTEncoding_Util.mkFreeV l)
in ((_0_464), (FStar_SMTEncoding_Util.mkTrue))))
in ((_0_465), (Some ("Disabling label")), (Some ((Prims.strcat "disable_label_" (Prims.fst l)))))))
end)))))
in (
...
let results = (let _0_467 = (FStar_List.map (fun x -> ((x), (true))) eliminated)
in (let _0_466 = (FStar_List.map (fun x -> ((x), (false))) errors)
