        ...
        | (flag,msg_prefix) ->
            let fresh_label msg ropt rng t =
              ...
              let rng =
                ...
                | None  -> rng
                | Some r ->
                    let uu___99_297 = r in
                    {
                      FStar_Range.def_range = (rng.FStar_Range.def_range);
                      FStar_Range.use_range =
                        (uu___99_297.FStar_Range.use_range)
                    } in
...
let detail_errors:
  ...
  fun env  ->
    fun all_labels  ->
      fun askZ3  ->
        let print_banner uu____906 =
          let uu____907 =
            let uu____908 = FStar_TypeChecker_Env.get_range env in
            FStar_Range.string_of_range uu____908 in
          let uu____909 = FStar_Util.string_of_int (Prims.parse_int "5") in
          let uu____910 =
          ...
          FStar_Util.print3_error
            ...
            uu____907 uu____909 uu____910 in
        let print_result uu____922 =
          match uu____922 with
          | ((uu____928,msg,r),success) ->
              (match success with
               | true  ->
                   let uu____935 = FStar_Range.string_of_range r in
                   FStar_Util.print1_error
                     "OK: proof obligation at %s was proven\n" uu____935
               | uu____936 -> FStar_Errors.report r msg) in
        let elim labs =
          FStar_All.pipe_right labs
            (FStar_List.map
               (fun uu____966  ->
                  match uu____966 with
                  | (l,uu____973,uu____974) ->
                      let uu____979 =
                        let uu____984 =
                          let uu____985 =
                            let uu____988 = FStar_SMTEncoding_Util.mkFreeV l in
                            (uu____988, FStar_SMTEncoding_Util.mkTrue) in
                          FStar_SMTEncoding_Util.mkEq uu____985 in
                        (uu____984, (Some "Disabling label"),
                          (Some (Prims.strcat "disable_label_" (Prims.fst l)))) in
                      FStar_SMTEncoding_Term.Assume uu____979)) in
        let rec linear_check eliminated errors active =
          ...
          | [] ->
              let results =
                ...
                let uu____1030 = FStar_List.map (fun x  -> (x, false)) errors in
                FStar_List.append uu____1023 uu____1030 in
              sort_labels results
          | hd::tl ->
              ((let uu____1043 =
                  FStar_Util.string_of_int (FStar_List.length active) in
                FStar_Util.print1 "%s, " uu____1043);
               ...
               (let uu____1048 =
                ...
                | (result,uu____1070) ->
                    let uu____1079 = FStar_Util.is_left result in
