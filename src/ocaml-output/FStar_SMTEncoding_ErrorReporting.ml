    ...
    FStar_List.sortWith
      (fun uu____68 ->
         fun uu____69 ->
           ...
           | (((uu____110, uu____111, r1), uu____113),
              ((uu____114, uu____115, r2), uu____117)) ->
    ...
    FStar_Util.remove_dups
      (fun uu____177 ->
         fun uu____178 ->
           ...
           | ((uu____203, m1, r1), (uu____206, m2, r2)) ->
               (r1 = r2) && (m1 = m2)) l
    ...
    fun range ->
      fun t ->
        let l =
          FStar_Util.incr ctr;
          (let uu____362 =
             let uu____363 = FStar_ST.op_Bang ctr in
             FStar_Util.string_of_int uu____363 in
           FStar_Util.format1 "label_%s" uu____362) in
    ...
    fun r ->
      fun q ->
        let rec is_a_post_condition post_name_opt tm =
          ...
          | (FStar_Pervasives_Native.None, uu____544) -> false
          | (FStar_Pervasives_Native.Some nm, FStar_SMTEncoding_Term.FreeV
             (nm', uu____549)) -> nm = nm'
          | (uu____552, FStar_SMTEncoding_Term.App
             (FStar_SMTEncoding_Term.Var "Valid", tm1::[])) ->
              is_a_post_condition post_name_opt tm1
          | (uu____560, FStar_SMTEncoding_Term.App
             (FStar_SMTEncoding_Term.Var "ApplyTT", tm1::uu____562)) ->
              is_a_post_condition post_name_opt tm1
          | uu____571 -> false in
        let conjuncts t =
          ...
          | FStar_SMTEncoding_Term.Quant
              (FStar_SMTEncoding_Term.Forall,
               ({
                  ...
                  FStar_SMTEncoding_Term.rng = uu____602;_}::[])::[],
               iopt, uu____604,
               {
                 FStar_SMTEncoding_Term.tm = FStar_SMTEncoding_Term.App
                   (FStar_SMTEncoding_Term.Iff, l::r1::[]);
                 FStar_SMTEncoding_Term.freevars = uu____607;
                 FStar_SMTEncoding_Term.rng = uu____608;_})
              -> true
          | uu____645 -> false in
        ...
        let uu____654 =
          ...
          | FStar_Pervasives_Native.Some f ->
              let uu____673 = f () in (true, uu____673) in
            ...
            let fresh_label1 msg ropt rng t =
              ...
              let rng1 =
                ...
                | FStar_Pervasives_Native.Some r1 ->
                    let uu____713 = FStar_Range.def_range rng in
                    FStar_Range.set_def_range r1 uu____713 in
              fresh_label msg1 rng1 t in
            let rec aux default_msg ropt post_name_opt labels q1 =
              match q1.FStar_SMTEncoding_Term.tm with
              | FStar_SMTEncoding_Term.BoundV uu____764 -> (labels, q1)
              | FStar_SMTEncoding_Term.Integer uu____767 -> (labels, q1)
              | FStar_SMTEncoding_Term.LblPos uu____770 ->
                  failwith "Impossible"
              | FStar_SMTEncoding_Term.Labeled
                  (arg, "could not prove post-condition", uu____782) ->
                  let fallback msg =
                  ...
                  (try
                     ...
                     | FStar_SMTEncoding_Term.Quant
                         (FStar_SMTEncoding_Term.Forall, pats, iopt,
                          post::sorts,
                          {
                            ...
                            FStar_SMTEncoding_Term.freevars = uu____843;
                            FStar_SMTEncoding_Term.rng = rng;_})
                         ->
                         let post_name =
                           let uu____872 =
                             let uu____873 = FStar_Syntax_Syntax.next_id () in
                             FStar_All.pipe_left FStar_Util.string_of_int
                               uu____873 in
                           Prims.strcat "^^post_condition_" uu____872 in
                         let names1 =
                           let uu____881 =
                             FStar_List.mapi
                               (fun i ->
                                  fun s ->
                                    let uu____897 =
                                      ...
                                      Prims.strcat "^^" uu____898 in
                                    (uu____897, s)) sorts in
                           (post_name, post) :: uu____881 in
                         let instantiation =
                                    ...
                                    let uu____1099 =
                                      let uu____1100 =
                                        ...
                                        Prims.strcat "LHS not a conjunct: "
                                          uu____1101 in
                                      Not_a_wp_implication uu____1100 in
                                    FStar_Exn.raise uu____1099 in
                     ...
                     | uu____1173 ->
                         let uu____1174 =
                           ...
                           Prims.strcat "arg not a quant: " uu____1175 in
                         fallback uu____1174
              ...
              | FStar_SMTEncoding_Term.Quant
                  (FStar_SMTEncoding_Term.Forall, [],
                   FStar_Pervasives_Native.None, post::[],
                   {
                     FStar_SMTEncoding_Term.tm = FStar_SMTEncoding_Term.App
                       (FStar_SMTEncoding_Term.Imp, lhs::rhs::[]);
                     FStar_SMTEncoding_Term.freevars = uu____1192;
                     FStar_SMTEncoding_Term.rng = rng;_})
                  when is_a_named_continuation lhs ->
                  let post_name =
                    let uu____1215 =
                      let uu____1216 = FStar_Syntax_Syntax.next_id () in
                      FStar_All.pipe_left FStar_Util.string_of_int uu____1216 in
                    Prims.strcat "^^post_condition_" uu____1215 in
                  let names1 = (post_name, post) in
                  let instantiation =
                    let uu____1225 = FStar_SMTEncoding_Util.mkFreeV names1 in
                    [uu____1225] in
                  let uu____1226 =
                    let uu____1231 =
                      FStar_SMTEncoding_Term.inst instantiation lhs in
                                     ...
                                     let uu____1419 =
                                       let uu____1424 =
                                         FStar_SMTEncoding_Term.mk_and_l
                                           ...
                                           lhs1.FStar_SMTEncoding_Term.rng in
                                       (uu____1424, rhs2) in
                                     FStar_SMTEncoding_Term.mkImp uu____1419
                                       rng in
                   ...
                   | (labels1, q12) ->
                       ...
                       (match uu____1531 with
                        | (labels2, q21) ->
                            ...
                            (labels2, uu____1550)))
              | FStar_SMTEncoding_Term.Quant
                  (FStar_SMTEncoding_Term.Exists, uu____1553, uu____1554,
              ...
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Iff, uu____1588) ->
                  let uu____1593 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1593 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Or, uu____1608) ->
                  let uu____1613 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1613 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Var uu____1628, uu____1629) when
                  is_a_post_condition post_name_opt q1 -> (labels, q1)
              | FStar_SMTEncoding_Term.FreeV uu____1636 ->
                  let uu____1641 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1641 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.TrueOp, uu____1656) ->
                  let uu____1661 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1661 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.FalseOp, uu____1676) ->
                  let uu____1681 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1681 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Not, uu____1696) ->
                  let uu____1701 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1701 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Eq, uu____1716) ->
                  let uu____1721 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1721 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.LT, uu____1736) ->
                  let uu____1741 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1741 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.LTE, uu____1756) ->
                  let uu____1761 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1761 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.GT, uu____1776) ->
                  let uu____1781 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1781 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.GTE, uu____1796) ->
                  let uu____1801 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1801 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvUlt, uu____1816) ->
                  let uu____1821 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1821 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Var uu____1836, uu____1837) ->
                  let uu____1842 =
                    fresh_label1 default_msg ropt
                      q1.FStar_SMTEncoding_Term.rng q1 in
                  (match uu____1842 with | (lab, q2) -> ((lab :: labels), q2))
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Add, uu____1857) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Sub, uu____1868) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Div, uu____1879) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Mul, uu____1890) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Minus, uu____1901) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Mod, uu____1912) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvAnd, uu____1923) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvXor, uu____1934) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvOr, uu____1945) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvAdd, uu____1956) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvSub, uu____1967) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvShl, uu____1978) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvShr, uu____1989) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvUdiv, uu____2000) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvMod, uu____2011) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvMul, uu____2022) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvUext uu____2033, uu____2034) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvToNat, uu____2045) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.NatToBv uu____2056, uu____2057) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.ITE, uu____2068) ->
                  failwith "Impossible: arity mismatch"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Imp, uu____2079) ->
                  failwith "Impossible: arity mismatch"
              | FStar_SMTEncoding_Term.Quant
...
let (detail_errors :
  ...
  fun hint_replay ->
    fun env ->
      fun all_labels ->
        fun askZ3 ->
          let print_banner uu____2200 =
            let msg =
              let uu____2202 =
                let uu____2203 = FStar_TypeChecker_Env.get_range env in
                FStar_Range.string_of_range uu____2203 in
              let uu____2204 = FStar_Util.string_of_int (Prims.parse_int "5") in
              let uu____2205 =
                FStar_Util.string_of_int (FStar_List.length all_labels) in
              FStar_Util.format4
                "Detailed %s report follows for %s\nTaking %s seconds per proof obligation (%s proofs in total)\n"
                (if hint_replay then "hint replay" else "error") uu____2202
                uu____2204 uu____2205 in
            FStar_Util.print_error msg in
          let print_result uu____2222 =
            match uu____2222 with
            | ((uu____2233, msg, r), success) ->
                if success
                then
                  let uu____2243 = FStar_Range.string_of_range r in
                  ...
                  then
                    ...
                    (let uu____2246 =
                       let uu____2251 =
                         let uu____2252 = FStar_Range.string_of_range r in
                         FStar_Util.format2
                           "XX: proof obligation at %s failed\n\t%s\n"
                           uu____2252 msg in
                       (FStar_Errors.Error_ProofObligationFailed, uu____2251) in
                     FStar_Errors.log_issue r uu____2246) in
          let elim labs =
            FStar_All.pipe_right labs
              (FStar_List.map
                 (fun uu____2314 ->
                    match uu____2314 with
                    | (l, uu____2326, uu____2327) ->
                        let a =
                          let uu____2337 =
                            let uu____2338 =
                              let uu____2343 =
                                FStar_SMTEncoding_Util.mkFreeV l in
                              (uu____2343, FStar_SMTEncoding_Util.mkTrue) in
                            FStar_SMTEncoding_Util.mkEq uu____2338 in
                          {
            ...
            (match active with
             | [] ->
                 let results =
                   ...
                   FStar_List.append uu____2404 uu____2417 in
                 sort_labels results
             | hd1::tl1 ->
                 ((let uu____2439 =
                     FStar_Util.string_of_int (FStar_List.length active) in
                   FStar_Util.print1 "%s, " uu____2439);
                  (let decls =
                   ...
                   | FStar_SMTEncoding_Z3.UNSAT uu____2470 ->
