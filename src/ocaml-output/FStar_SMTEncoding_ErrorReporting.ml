      ...
      fun q  ->
        ...
        | (flag,msg_prefix) ->
            ...
            let rec aux default_msg ropt post_name_opt labels q1 =
                        ...
                        | () ->
                            (match arg.FStar_SMTEncoding_Term.tm with
                             | FStar_SMTEncoding_Term.Quant
                                 ...
                                 let post_name =
                                   let uu____898 =
                                     let uu____900 = FStar_Ident.next_id ()
                                        in
                                     FStar_All.pipe_left
              ...
              | FStar_SMTEncoding_Term.Quant
                  ...
                  (match uu____1303 with
                   | (sorts',post) ->
                       let new_post_name =
                         let uu____1324 =
                           let uu____1326 = FStar_Ident.next_id ()  in
                           ...
                           FStar_List.map
                             (fun s  ->
                                let uu____1340 =
                                  let uu____1346 =
                                    let uu____1348 =
                                      let uu____1350 = FStar_Ident.next_id ()
                                         in
                                      FStar_All.pipe_left
              ...
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.RealDiv ,uu____2028) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Add ,uu____2040) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Sub ,uu____2052) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Div ,uu____2064) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Mul ,uu____2076) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Minus ,uu____2088) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Mod ,uu____2100) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvAnd ,uu____2112) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvXor ,uu____2124) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvOr ,uu____2136) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvAdd ,uu____2148) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvSub ,uu____2160) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvShl ,uu____2172) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvShr ,uu____2184) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvUdiv ,uu____2196) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvMod ,uu____2208) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvMul ,uu____2220) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvUext uu____2232,uu____2233) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.BvToNat ,uu____2246) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.NatToBv uu____2258,uu____2259) ->
                  failwith "Impossible: non-propositional term"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.ITE ,uu____2272) ->
                  failwith "Impossible: arity mismatch"
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Imp ,uu____2284) ->
                  failwith "Impossible: arity mismatch"
              | FStar_SMTEncoding_Term.Quant
...
let (detail_errors :
  ...
  fun hint_replay  ->
    fun env  ->
      fun all_labels  ->
        fun askZ3  ->
          let print_banner uu____2418 =
            let msg =
              let uu____2421 =
                let uu____2423 = FStar_TypeChecker_Env.get_range env  in
                FStar_Range.string_of_range uu____2423  in
              let uu____2424 = FStar_Util.string_of_int (Prims.parse_int "5")
                 in
              let uu____2427 =
                FStar_Util.string_of_int (FStar_List.length all_labels)  in
              FStar_Util.format4
                "Detailed %s report follows for %s\nTaking %s seconds per proof obligation (%s proofs in total)\n"
                (if hint_replay then "hint replay" else "error") uu____2421
                uu____2424 uu____2427
               in
            FStar_Util.print_error msg  in
          let print_result uu____2453 =
            match uu____2453 with
            | ((uu____2466,msg,r),success) ->
                if success
                then
                  let uu____2482 = FStar_Range.string_of_range r  in
                  FStar_Util.print1
                    ...
                    (let uu____2492 =
                       let uu____2498 =
                         ...
                         FStar_Util.format2
                           ...
                           uu____2500 msg
                          in
                       (FStar_Errors.Error_ProofObligationFailed, uu____2498)
                        in
                     FStar_Errors.log_issue r uu____2492)
             in
          let elim labs =
            FStar_All.pipe_right labs
              (FStar_List.map
                 (fun uu____2553  ->
                    ...
                    | (l,uu____2562,uu____2563) ->
                        let a =
                          let uu____2567 =
                            let uu____2568 =
                              let uu____2573 =
                                FStar_SMTEncoding_Util.mkFreeV l  in
                              (uu____2573, FStar_SMTEncoding_Util.mkTrue)  in
                            FStar_SMTEncoding_Util.mkEq uu____2568  in
                          let uu____2574 =
                            let uu____2576 = FStar_SMTEncoding_Term.fv_name l
                               in
                            Prims.op_Hat "@disable_label_" uu____2576  in
                          {
            ...
            (match active with
             | [] ->
                 let results =
                   ...
                   FStar_List.append uu____2646 uu____2663  in
                 sort_labels results
             | hd1::tl1 ->
                 ((let uu____2690 =
                     FStar_Util.string_of_int (FStar_List.length active)  in
                   FStar_Util.print1 "%s, " uu____2690);
                  (let decls =
                   ...
                   | FStar_SMTEncoding_Z3.UNSAT uu____2722 ->
