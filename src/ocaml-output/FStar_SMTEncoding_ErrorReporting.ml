...
let uu___131_560 = r1
in {FStar_Range.def_range = rng.FStar_Range.def_range; FStar_Range.use_range = uu___131_560.FStar_Range.use_range})
end)
...
in (FStar_All.try_with (fun uu___133_659 -> (match (()) with
| () -> begin
...
end)) (fun uu___132_1013 -> (match (uu___132_1013) with
...
| FStar_SMTEncoding_Z3.UNSAT (uu____2262) -> begin
