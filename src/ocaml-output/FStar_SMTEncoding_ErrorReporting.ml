...
let uu___109_524 = r1
in {FStar_Range.def_range = rng.FStar_Range.def_range; FStar_Range.use_range = uu___109_524.FStar_Range.use_range})
end)
...
let print_banner = (fun uu____1999 -> (

let msg = (

let uu____2001 = (

let uu____2002 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Range.string_of_range uu____2002))
in (

let uu____2003 = (FStar_Util.string_of_int (Prims.parse_int "5"))
in (

let uu____2004 = (FStar_Util.string_of_int (FStar_List.length all_labels))
...
| uu____2005 -> begin
"error"
end) uu____2001 uu____2003 uu____2004))))
in (FStar_Util.print_error msg)))
in (

let print_result = (fun uu____2019 -> (match (uu____2019) with
| ((uu____2030, msg, r), success) -> begin
(match (success) with
| true -> begin
(

let uu____2040 = (FStar_Range.string_of_range r)
