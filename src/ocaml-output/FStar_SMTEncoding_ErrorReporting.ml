  ...
  fun message  ->
    fun range  ->
      fun t  ->
        let l =
          FStar_Util.incr ctr;
          (let _0_470 = FStar_Util.string_of_int (FStar_ST.read ctr)  in
           FStar_Util.format1 "label_%s" _0_470)
           in
    ...
    fun r  ->
      fun q  ->
        ...
        let uu____257 =
          ...
          | None  -> (false, "")
          | Some f -> let _0_471 = f ()  in (true, _0_471)  in
        ...
        | (flag,msg_prefix) ->
            ...
            let rec aux default_msg ropt post_name_opt labels q =
              ...
              | FStar_SMTEncoding_Term.Labeled
                  ...
                  (try
                     ...
                     | FStar_SMTEncoding_Term.Quant
                         ...
                         let post_name =
                           let _0_473 =
                             let _0_472 = FStar_Syntax_Syntax.next_id ()  in
                             FStar_All.pipe_left FStar_Util.string_of_int
                               _0_472
                              in
                           Prims.strcat "^^post_condition_" _0_473  in
                         let names =
                           let _0_476 =
                             FStar_List.mapi
                               (fun i  ->
                                  fun s  ->
                                    let _0_475 =
                                      let _0_474 = FStar_Util.string_of_int i
                                         in
                                      Prims.strcat "^^" _0_474  in
                                    (_0_475, s)) sorts
                              in
                           (post_name, post) :: _0_476  in
                         let instantiation =
                     ...
                     | uu____516 ->
                         fallback
                           (let _0_488 =
                            ...
                            Prims.strcat "arg not a quant: " _0_488)
              ...
              | FStar_SMTEncoding_Term.Quant
                  ...
                  let post_name =
                    let _0_490 =
                      let _0_489 = FStar_Syntax_Syntax.next_id ()  in
                      FStar_All.pipe_left FStar_Util.string_of_int _0_489  in
                    Prims.strcat "^^post_condition_" _0_490  in
                  let names = (post_name, post)  in
                  let instantiation =
                    let _0_491 = FStar_SMTEncoding_Util.mkFreeV names  in
                    [_0_491]  in
                  let uu____546 =
                    let _0_493 =
                                             ...
                                             FStar_SMTEncoding_Term.Quant
                                               (let _0_494 =
                                                ...
                                                (FStar_SMTEncoding_Term.Forall,
                                                  ...
                                                  sorts, _0_494))
                                              in
                                           FStar_SMTEncoding_Term.mk _0_495
                                             q.FStar_SMTEncoding_Term.rng
                                            in
                                         (labels, _0_496))
                                     ...
                                     let _0_498 =
                                       let _0_497 =
                                         FStar_SMTEncoding_Term.mk_and_l
                                          ...
                                          in
                                       (_0_497, rhs)  in
                                     FStar_SMTEncoding_Term.mkImp _0_498 rng
                                      in
              ...
              | FStar_SMTEncoding_Term.App
                  ...
                  (match uu____649 with
                   | (labels,rhs) ->
                       let _0_500 = FStar_SMTEncoding_Util.mkImp (lhs, rhs)
                          in
                       (labels, _0_500))
              | FStar_SMTEncoding_Term.App
