      ...
      fun t  ->
        let l =
          ...
          (let _0_449 = FStar_Util.string_of_int (FStar_ST.read ctr) in
           FStar_Util.format1 "label_%s" _0_449) in
            ...
            let rec aux default_msg ropt post_name_opt labels q =
                           ...
                           let _0_455 =
                             FStar_List.mapi
                               (fun i  ->
                                  fun s  ->
                                    let _0_454 =
                                      let _0_453 = FStar_Util.string_of_int i in
                                     ...
                                     let _0_477 =
                                       let _0_476 =
                                         FStar_SMTEncoding_Term.mk_and_l
                                           ...
                                           lhs.FStar_SMTEncoding_Term.rng in
                                       (_0_476, rhs) in
                                     FStar_SMTEncoding_Term.mkImp _0_477 rng in
              ...
              | FStar_SMTEncoding_Term.App
                  ...
                  (match uu____649 with
                   | (labels,rhs) ->
                       let _0_479 = FStar_SMTEncoding_Util.mkImp (lhs, rhs) in
                       (labels, _0_479))
              | FStar_SMTEncoding_Term.App
    ...
    fun all_labels  ->
      fun askZ3  ->
                      ...
                      FStar_SMTEncoding_Term.Assume
                        (let _0_488 =
                           FStar_SMTEncoding_Util.mkEq
                             (let _0_487 = FStar_SMTEncoding_Util.mkFreeV l in
                              (_0_487, FStar_SMTEncoding_Util.mkTrue)) in
        ...
        let rec linear_check eliminated errors active =
          ...
          | [] ->
              let results =
                let _0_490 = FStar_List.map (fun x  -> (x, true)) eliminated in
