      ...
      fun t  ->
        let l =
          ...
          (let _0_463 = FStar_Util.string_of_int (FStar_ST.read ctr)  in
           FStar_Util.format1 "label_%s" _0_463)
           in
            ...
            let rec aux default_msg ropt post_name_opt labels q =
                           ...
                           let _0_469 =
                             FStar_List.mapi
                               (fun i  ->
                                  fun s  ->
                                    let _0_468 =
                                      let _0_467 = FStar_Util.string_of_int i
                                         in
                                     ...
                                     let _0_491 =
                                       let _0_490 =
                                         FStar_SMTEncoding_Term.mk_and_l
                                          ...
                                          in
                                       (_0_490, rhs)  in
                                     FStar_SMTEncoding_Term.mkImp _0_491 rng
                                      in
              ...
              | FStar_SMTEncoding_Term.App
                  ...
                  (match uu____649 with
                   | (labels,rhs) ->
                       let _0_493 = FStar_SMTEncoding_Util.mkImp (lhs, rhs)
                          in
                       (labels, _0_493))
              | FStar_SMTEncoding_Term.App
    ...
    fun all_labels  ->
      fun askZ3  ->
                      ...
                      FStar_SMTEncoding_Term.Assume
                        (let _0_502 =
                           FStar_SMTEncoding_Util.mkEq
                             (let _0_501 = FStar_SMTEncoding_Util.mkFreeV l
                                 in
                              (_0_501, FStar_SMTEncoding_Util.mkTrue))
                            in
        ...
        let rec linear_check eliminated errors active =
          ...
          | [] ->
              let results =
                let _0_504 = FStar_List.map (fun x  -> (x, true)) eliminated
                   in
