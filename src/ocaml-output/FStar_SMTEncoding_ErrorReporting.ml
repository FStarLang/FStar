  ...
  fun message  ->
    fun range  ->
      fun t  ->
        let l =
          FStar_Util.incr ctr;
          (let _0_448 = FStar_Util.string_of_int (FStar_ST.read ctr) in
           FStar_Util.format1 "label_%s" _0_448) in
    ...
    fun r  ->
      fun q  ->
        ...
        let uu____257 =
          ...
          | None  -> (false, "")
          | Some f -> let _0_449 = f () in (true, _0_449) in
        ...
        | (flag,msg_prefix) ->
            ...
            let rec aux default_msg ropt post_name_opt labels q =
              ...
              | FStar_SMTEncoding_Term.Labeled
                  ...
                  (try
                     ...
                     | FStar_SMTEncoding_Term.Quant
                         ...
                         let post_name =
                           let _0_451 =
                             let _0_450 = FStar_Syntax_Syntax.next_id () in
                             FStar_All.pipe_left FStar_Util.string_of_int
                               _0_450 in
                           Prims.strcat "^^post_condition_" _0_451 in
                         let names =
                           let _0_454 =
                             FStar_List.mapi
                               (fun i  ->
                                  fun s  ->
                                    let _0_453 =
                                      let _0_452 = FStar_Util.string_of_int i in
                                      Prims.strcat "^^" _0_452 in
                                    (_0_453, s)) sorts in
                           (post_name, post) :: _0_454 in
                         let instantiation =
                     ...
                     | uu____516 ->
                         fallback
                           (let _0_466 =
                            ...
                            Prims.strcat "arg not a quant: " _0_466)
              ...
              | FStar_SMTEncoding_Term.Quant
                  ...
                  let post_name =
                    let _0_468 =
                      let _0_467 = FStar_Syntax_Syntax.next_id () in
                      FStar_All.pipe_left FStar_Util.string_of_int _0_467 in
                    Prims.strcat "^^post_condition_" _0_468 in
                  let names = (post_name, post) in
                  let instantiation =
                    let _0_469 = FStar_SMTEncoding_Util.mkFreeV names in
                    [_0_469] in
                  let uu____546 =
                    let _0_471 =
                      FStar_SMTEncoding_Term.inst instantiation lhs in
                                             ...
                                             FStar_SMTEncoding_Term.Quant
                                               (let _0_472 =
                                                ...
                                                (FStar_SMTEncoding_Term.Forall,
                                                  ...
                                                  sorts, _0_472)) in
                                           FStar_SMTEncoding_Term.mk _0_473
                                             q.FStar_SMTEncoding_Term.rng in
                                         (labels, _0_474))
                                     ...
                                     let _0_476 =
                                       let _0_475 =
                                         FStar_SMTEncoding_Term.mk_and_l
                                           ...
                                           lhs.FStar_SMTEncoding_Term.rng in
                                       (_0_475, rhs) in
                                     FStar_SMTEncoding_Term.mkImp _0_476 rng in
              ...
              | FStar_SMTEncoding_Term.App
                  ...
                  (match uu____649 with
                   | (labels,rhs) ->
                       let _0_478 = FStar_SMTEncoding_Util.mkImp (lhs, rhs) in
                       (labels, _0_478))
              | FStar_SMTEncoding_Term.App
    ...
    fun all_labels  ->
      fun askZ3  ->
        let print_banner uu____841 =
          ...
          let _0_483 = FStar_Util.string_of_int (Prims.parse_int "5") in
          let _0_482 =
        ...
        let print_result uu____853 =
          ...
          | ((uu____859,msg,r),success) ->
              (match success with
               | true  ->
                   let _0_485 = FStar_Range.string_of_range r in
                   FStar_Util.print1_error
                     "OK: proof obligation at %s was proven\n" _0_485
               | uu____866 -> FStar_Errors.report r msg) in
        let elim labs =
                      ...
                      FStar_SMTEncoding_Term.Assume
                        (let _0_487 =
                           FStar_SMTEncoding_Util.mkEq
                             (let _0_486 = FStar_SMTEncoding_Util.mkFreeV l in
                              (_0_486, FStar_SMTEncoding_Util.mkTrue)) in
                         (_0_487, (Some "Disabling label"),
                           (Some
        ...
        let rec linear_check eliminated errors active =
          ...
          | [] ->
              let results =
                let _0_489 = FStar_List.map (fun x  -> (x, true)) eliminated in
                let _0_488 = FStar_List.map (fun x  -> (x, false)) errors in
                FStar_List.append _0_489 _0_488 in
              sort_labels results
          | hd::tl ->
              ((let _0_490 =
                  FStar_Util.string_of_int (FStar_List.length active) in
                FStar_Util.print1 "%s, " _0_490);
               ...
               (let uu____959 =
                ...
                | (result,uu____980) ->
                    ...
                    (match uu____989 with
                     ...
                     | uu____998 -> linear_check eliminated (hd :: errors) tl))) in
        print_banner ();
