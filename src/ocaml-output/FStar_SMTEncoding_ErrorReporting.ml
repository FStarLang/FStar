  ...
  fun message  ->
    fun range  ->
      fun t  ->
        let l =
          FStar_Util.incr ctr;
          (let _0_463 = FStar_Util.string_of_int (FStar_ST.read ctr) in
           FStar_Util.format1 "label_%s" _0_463) in
    ...
    fun r  ->
      fun q  ->
        let rec is_a_post_condition post_name_opt tm =
          ...
          | (None ,uu____192) -> false
          | (Some nm,FStar_SMTEncoding_Term.FreeV (nm',uu____196)) ->
              nm = nm'
          ...
          | FStar_SMTEncoding_Term.Quant
              (FStar_SMTEncoding_Term.Forall
               ,({
                   ...
                   FStar_SMTEncoding_Term.freevars = uu____225;
                   FStar_SMTEncoding_Term.rng = uu____226;_}::[])::[],iopt,uu____228,
               {
                 FStar_SMTEncoding_Term.tm = FStar_SMTEncoding_Term.App
        ...
        let uu____257 =
          ...
          | None  -> (false, "")
          | Some f -> let _0_464 = f () in (true, _0_464) in
        ...
        | (flag,msg_prefix) ->
            let fresh_label msg ropt rng t =
              ...
              let rng =
                ...
                | None  -> rng
                | Some r ->
                    let uu___101_294 = r in
                    {
                      FStar_Range.def_range = (rng.FStar_Range.def_range);
                      FStar_Range.use_range =
                        (uu___101_294.FStar_Range.use_range)
                    } in
            ...
            let rec aux default_msg ropt post_name_opt labels q =
              ...
              | FStar_SMTEncoding_Term.LblPos uu____326 ->
                  failwith "Impossible"
              | FStar_SMTEncoding_Term.Labeled
                  ...
                  (try
                     ...
                     | FStar_SMTEncoding_Term.Quant
                         ...
                         let post_name =
                           let _0_466 =
                             let _0_465 = FStar_Syntax_Syntax.next_id () in
                             FStar_All.pipe_left FStar_Util.string_of_int
                               _0_465 in
                           Prims.strcat "^^post_condition_" _0_466 in
                         let names =
                           let _0_469 =
                             FStar_List.mapi
                               (fun i  ->
                                  fun s  ->
                                    let _0_468 =
                                      let _0_467 = FStar_Util.string_of_int i in
                                      Prims.strcat "^^" _0_467 in
                                    (_0_468, s)) sorts in
                           (post_name, post) :: _0_469 in
                         let instantiation =
                     ...
                     | uu____516 ->
                         fallback
                           (let _0_481 =
                            ...
                            Prims.strcat "arg not a quant: " _0_481)
              ...
              | FStar_SMTEncoding_Term.Quant
                  (FStar_SMTEncoding_Term.Forall ,[],None
                   ,post::[],{
                               ...
                               FStar_SMTEncoding_Term.freevars = uu____528;
                               FStar_SMTEncoding_Term.rng = rng;_})
                  when is_a_named_continuation lhs ->
                  let post_name =
                    let _0_483 =
                      let _0_482 = FStar_Syntax_Syntax.next_id () in
                      FStar_All.pipe_left FStar_Util.string_of_int _0_482 in
                    Prims.strcat "^^post_condition_" _0_483 in
                  let names = (post_name, post) in
                  let instantiation =
                    let _0_484 = FStar_SMTEncoding_Util.mkFreeV names in
                    [_0_484] in
                  let uu____546 =
                    let _0_486 =
                      FStar_SMTEncoding_Term.inst instantiation lhs in
                                ...
                                | FStar_SMTEncoding_Term.Quant
                                    (FStar_SMTEncoding_Term.Forall
                                           ...
                                           uu____568;_}::[])::[],iopt,sorts,
                                     {
                                       ...
                                       FStar_SMTEncoding_Term.freevars =
                                         uu____573;
                                       FStar_SMTEncoding_Term.rng = uu____574;_})
                                    ->
                                    let uu____593 =
                                             ...
                                             FStar_SMTEncoding_Term.Quant
                                               (let _0_487 =
                                                ...
                                                (FStar_SMTEncoding_Term.Forall,
                                                  ...
                                                  sorts, _0_487)) in
                                           FStar_SMTEncoding_Term.mk _0_488
                                             q.FStar_SMTEncoding_Term.rng in
                                         (labels, _0_489))
                                     ...
                                     let _0_491 =
                                       let _0_490 =
                                         FStar_SMTEncoding_Term.mk_and_l
                                           ...
                                           lhs.FStar_SMTEncoding_Term.rng in
                                       (_0_490, rhs) in
                                     FStar_SMTEncoding_Term.mkImp _0_491 rng in
                                   FStar_All.pipe_right _0_492
              ...
              | FStar_SMTEncoding_Term.App
                  ...
                  (match uu____649 with
                   | (labels,rhs) ->
                       let _0_493 = FStar_SMTEncoding_Util.mkImp (lhs, rhs) in
                       (labels, _0_493))
              | FStar_SMTEncoding_Term.App
    ...
    fun all_labels  ->
      fun askZ3  ->
        let print_banner uu____841 =
          ...
          let _0_498 = FStar_Util.string_of_int (Prims.parse_int "5") in
          let _0_497 =
                      ...
                      FStar_SMTEncoding_Term.Assume
                        (let _0_502 =
                           FStar_SMTEncoding_Util.mkEq
                             (let _0_501 = FStar_SMTEncoding_Util.mkFreeV l in
                              (_0_501, FStar_SMTEncoding_Util.mkTrue)) in
                         (_0_502, (Some "Disabling label"),
                           (Some
        ...
        let rec linear_check eliminated errors active =
          ...
          | [] ->
              let results =
                let _0_504 = FStar_List.map (fun x  -> (x, true)) eliminated in
                let _0_503 = FStar_List.map (fun x  -> (x, false)) errors in
                FStar_List.append _0_504 _0_503 in
              sort_labels results
          | hd::tl ->
              ((let _0_505 =
                  FStar_Util.string_of_int (FStar_List.length active) in
                FStar_Util.print1 "%s, " _0_505);
