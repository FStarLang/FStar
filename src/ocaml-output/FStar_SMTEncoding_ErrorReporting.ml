...
let (__proj__Not_a_wp_implication__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | Not_a_wp_implication uu___ -> uu___
      ...
      fun t  ->
        let l =
          ...
          (let uu___1 =
           ...
           FStar_Util.format1 "label_%s" uu___1)
           in
        let lvar =
      ...
      fun q  ->
          ...
          | FStar_SMTEncoding_Term.Quant
              (FStar_SMTEncoding_Term.Forall
               ,({
                   ...
                   FStar_SMTEncoding_Term.rng = uu___1;_}::[])::[],iopt,uu___2,
               {
                 FStar_SMTEncoding_Term.tm = FStar_SMTEncoding_Term.App
        ...
        | (flag,msg_prefix) ->
                ...
                | FStar_Pervasives_Native.Some r1 ->
                    ...
                    then rng
                      ...
                      (let uu___3 = FStar_Range.def_range rng  in
                       FStar_Range.set_def_range r1 uu___3)
                 in
            ...
            let rec aux default_msg ropt post_name_opt labels1 q1 =
                             ...
                             | FStar_SMTEncoding_Term.Quant
                                 ...
                                 let post_name =
                                   let uu___4 =
                                     ...
                                     FStar_All.pipe_left
                                       FStar_Util.string_of_int uu___5
                                      in
                                   Prims.op_Hat "^^post_condition_" uu___4
                                    in
                                 let names =
                                   let uu___4 =
                                 ...
                                 let uu___4 =
                                   let uu___5 =
                                     FStar_SMTEncoding_Term.print_smt_term
                                       arg
                                      in
                                   Prims.op_Hat "arg not a quant: " uu___5
                                    in
                                 fallback uu___4)) ()
                                ...
                                let uu___4 =
                                  let uu___5 =
                                    let uu___6 =
                                      ...
                                      FStar_All.pipe_left
                                        FStar_Util.string_of_int uu___7
                                       in
                                    Prims.op_Hat "^^" uu___6  in
                                  (uu___5, s)  in
                                FStar_SMTEncoding_Term.mk_fv uu___4) sorts'
                            in
                         let uu___4 =
                           let uu___5 =
                             FStar_SMTEncoding_Term.mk_fv
              ...
              | FStar_SMTEncoding_Term.App
                  (FStar_SMTEncoding_Term.Imp ,lhs::rhs::[]) ->
                  let uu___1 = aux default_msg ropt post_name_opt labels1 rhs
                     in
                  (match uu___1 with
                   | (labels2,rhs1) ->
                       let uu___2 = FStar_SMTEncoding_Util.mkImp (lhs, rhs1)
                          in
                       (labels2, uu___2))
              | FStar_SMTEncoding_Term.App
              ...
              | FStar_SMTEncoding_Term.App
                  ...
                  let uu___1 = aux default_msg ropt post_name_opt labels1 q11
                     in
                  (match uu___1 with
                   | (labels2,q12) ->
                       let uu___2 =
      ...
      fun all_labels  ->
        fun askZ3  ->
                 ...
                 (fun uu___  ->
                    ...
                    | (l,uu___1,uu___2) ->
                        let a =
                          let uu___3 =
                            let uu___4 =
                              let uu___5 = FStar_SMTEncoding_Util.mkFreeV l
                                 in
            ...
            (match active with
             | [] ->
                 let results =
                   ...
                   let uu___2 = FStar_List.map (fun x  -> (x, false)) errors
                      in
             ...
             | hd::tl ->
                 ((let uu___2 =
                  ...
                  (let decls =
                   ...
                   | uu___2 -> linear_check eliminated (hd :: errors) tl)))
             in
          print_banner ();
          ...
          (let res = linear_check [] [] all_labels  in
           ...
           (let uu___4 = FStar_Util.for_all FStar_Pervasives_Native.snd res
               in
            if uu___4
            then
              FStar_Util.print_string
