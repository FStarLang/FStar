...
let uu____1232 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Range.string_of_range uu____1232))
in (

let uu____1233 = (

let uu____1234 = (FStar_Options.max_fuel ())
in (FStar_All.pipe_right uu____1234 FStar_Util.string_of_int))
in (

let uu____1235 = (

let uu____1236 = (FStar_Options.max_ifuel ())
in (FStar_All.pipe_right uu____1236 FStar_Util.string_of_int))
...
let uu____1238 = (FStar_All.pipe_right (FStar_Pervasives_Native.fst errs1) (FStar_List.map (fun uu____1250 -> (match (uu____1250) with
| (uu____1256, x, y) -> begin
((x), (y))
end))))
in (FStar_TypeChecker_Err.add_errors env uu____1238));
)))
in (

let use_errors = (fun errs result -> (match (((errs), (result))) with
| (([], uu____1272), uu____1273) -> begin
result
end
| (uu____1278, FStar_Util.Inl (uu____1279)) -> begin
result
end
| (uu____1286, FStar_Util.Inr (uu____1287)) -> begin
FStar_Util.Inr (errs)
end))
in (
...
| (uu____1362, FStar_SMTEncoding_Z3.Kill) -> begin
(report1 p1 errs)
end
| ((mi)::tl1, uu____1373) -> begin
(

let uu____1388 = (with_fuel [] p1 mi)
in (FStar_SMTEncoding_Z3.ask filter_facts_without_core all_labels uu____1388 (FStar_Pervasives_Native.Some (scope)) (fun uu____1390 -> (match (uu____1390) with
| (result, elapsed_time, statistics) -> begin
(

let uu____1402 = (

let uu____1406 = (use_errors errs result)
in ((uu____1406), (elapsed_time), (statistics)))
in (cb false mi p1 tl1 scope uu____1402))
end))))
end);
))
and cb = (fun used_hint uu____1408 p1 alt scope uu____1412 -> (match (((uu____1408), (uu____1412))) with
...
let uu____1443 = (FStar_TypeChecker_Env.get_range env)
in (record_hint_stat hint_opt result elapsed_time uu____1443));
)
end
| uu____1444 -> begin
()
...
let uu____1446 = ((FStar_Options.z3_refresh ()) || (FStar_Options.check_hints ()))
...
let uu____1465 = (((FStar_Options.print_fuels ()) || (FStar_Options.hint_info ())) || (FStar_Options.print_z3_statistics ()))
...
let uu____1470 = (match (env1) with
...
let uu____1474 = (FStar_TypeChecker_Env.get_range e)
in (FStar_Range.string_of_range uu____1474))
in (

let uu____1475 = (

let uu____1476 = (FStar_SMTEncoding_Z3.at_log_file ())
in (Prims.strcat uu____1476 ")"))
in (Prims.strcat uu____1473 uu____1475)))
in (Prims.strcat "(" uu____1472))
end
| FStar_Pervasives_Native.None -> begin
""
end)
...
let uu____1483 = (FStar_Util.string_of_int query_index)
in (
...
let uu____1490 = (FStar_Util.string_of_int elapsed_time)
in (

let uu____1491 = (

let uu____1493 = (FStar_Util.string_of_int prev_fuel)
in (

let uu____1494 = (

let uu____1496 = (FStar_Util.string_of_int prev_ifuel)
in (

let uu____1497 = (

let uu____1499 = (FStar_Util.string_of_int rlimit)
in (uu____1499)::[])
in (uu____1496)::uu____1497))
in (uu____1493)::uu____1494))
in (uu____1490)::uu____1491))
in ((match (env1) with
| FStar_Pervasives_Native.Some (e) -> begin
(match (used_hint) with
| true -> begin
...
in (tag)::uu____1486)
in (uu____1483)::uu____1484))
in (query_name)::uu____1481)
in (name)::uu____1479)
in (uu____1470)::uu____1477))
in (
...
let uu____1505 = (FStar_Options.print_z3_statistics ())
...
let uu____1517 = (FStar_Util.substring str (Prims.parse_int "0") ((FStar_String.length str) - (Prims.parse_int "1")))
in (Prims.strcat uu____1517 "}"))))
end
| uu____1521 -> begin
(

let uu____1522 = (FStar_Util.smap_try_find statistics1 "reason-unknown")
...
in (uu____1504)::[])
in (FStar_List.append uu____1468 uu____1502)))
...
let uu____1546 = (FStar_ST.read hint_worked)
in (not (uu____1546)))
in (match (uu____1545) with
| true -> begin
(

let hint_check_cb = (fun uu____1560 -> (match (uu____1560) with
| (result1, elapsed_time1, statistics1) -> begin
(

let tag = (match (result1) with
| FStar_Util.Inl (uu____1583) -> begin
((FStar_ST.write hint_worked true);
"succeeded";
)
end
| FStar_Util.Inr (uu____1589) -> begin
"failed"
end)
in (

let uu____1594 = (FStar_Options.hint_info ())
...
let uu____1603 = (FStar_ST.read current_core)
in (filter_assertions uu____1603))
in (

let uu____1606 = (with_fuel [] p1 ((prev_fuel), (prev_ifuel), (rlimit)))
in (FStar_SMTEncoding_Z3.ask uu____1598 all_labels uu____1606 (FStar_Pervasives_Native.Some (scope1)) hint_check_cb)));
(

let uu____1608 = (

let uu____1609 = (FStar_ST.read hint_worked)
in (not (uu____1609)))
...
let uu____1625 = (FStar_Util.string_of_int core_ext_max_dist)
in (uu____1625)::[])
in (FStar_Util.format "smt.core.extend_patterns.max_distance=%s" uu____1623))
in FStar_Options.String (uu____1622))
in (uu____1621)::[])
in (FStar_Options.String ("smt.core.extend_patterns=true"))::uu____1619)
in FStar_Options.List (uu____1617))
in (FStar_Options.set_option "z3cliopt" uu____1616));
(

let hint_refinement_cb = (fun uu____1637 -> (match (uu____1637) with
| (result1, elapsed_time1, statistics1) -> begin
(

let uu____1659 = (FStar_Options.hint_info ())
...
let uu____1670 = (FStar_Util.string_of_int core_ext_max_dist)
in (FStar_Util.format1 "succeeded (with smt.core.extend_patterns.max_distance=%s)" uu____1670));
)
end
...
let uu____1679 = (with_fuel [] p1 ((prev_fuel), (prev_ifuel), (rlimit)))
in (FStar_SMTEncoding_Z3.ask filter_facts_without_core all_labels uu____1679 (FStar_Pervasives_Native.Some (scope1)) hint_refinement_cb));
(

let uu____1681 = (FStar_ST.read refinement_ok)
...
let uu____1688 = (FStar_Util.string_of_int cutoff)
in (uu____1688)::[])
in (FStar_Util.print "\tHint-fallback smt.core.extend_patterns.max_distance=%s reached, aborting refinement." uu____1686));
...
let uu____1704 = (FStar_List.map (fun x -> FStar_Options.String (x)) z3cliopts_before)
in FStar_Options.List (uu____1704))
in (FStar_Options.set_option "z3cliopt" uu____1703));
(FStar_Options.set_option "log_queries" (FStar_Options.Bool (log_queries_before)));
)));
(

let uu____1707 = (FStar_ST.read current_core)
in {FStar_Util.hint_name = query_name; FStar_Util.hint_index = query_index; FStar_Util.fuel = prev_fuel; FStar_Util.ifuel = prev_ifuel; FStar_Util.unsat_core = uu____1707; FStar_Util.query_elapsed_time = elapsed_time});
)))))
...
let uu____1716 = ((not (used_hint)) && (FStar_Options.record_hints ()))
...
let uu____1719 = (FStar_Options.check_hints ())
...
in FStar_Pervasives_Native.Some (uu____1718))
end
| uu____1721 -> begin
hint_opt
end))
in (record_hint uu____1714));
)
end
| FStar_Util.Inr (errs) -> begin
...
let uu____1725 = (used_hint && (FStar_Options.hint_info ()))
...
let uu____1732 = (FStar_List.map (fun x -> (FStar_Util.print_string (Prims.strcat " " x))) core)
in ());
...
let uu____1738 = ((FStar_Option.isSome unsat_core) || (FStar_Options.z3_refresh ()))
...
let uu____1744 = (FStar_SMTEncoding_Z3.mk_fresh_scope ())
in (cb (FStar_Option.isSome unsat_core) initial_config p alt_configs uu____1744))
in (FStar_SMTEncoding_Z3.ask (filter_assertions unsat_core) all_labels wf FStar_Pervasives_Native.None uu____1743)));
)))))
end))))))
in (
...
let uu____1757 = (FStar_Options.admit_except ())
in ((uu____1756), (uu____1757))))
in (match (uu____1752) with
| (true, uu____1760) -> begin
()
end
...
let uu____1770 = (FStar_Util.string_of_int query_index)
in (Prims.strcat uu____1770 ")"))
in (Prims.strcat ", " uu____1769))
in (Prims.strcat query_name uu____1768))
in (Prims.strcat "(" uu____1767))
...
let uu____1791 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range uu____1791))
in (FStar_Util.format1 "Starting query at %s" uu____1790))
in (FStar_SMTEncoding_Encode.push uu____1789));
(

let tcenv1 = (FStar_TypeChecker_Env.incr_query_index tcenv)
in (

let uu____1793 = (FStar_SMTEncoding_Encode.encode_query use_env_msg tcenv1 q)
in (match (uu____1793) with
| (prefix1, labels, qry, suffix) -> begin
(

let pop1 = (fun uu____1814 -> (

let uu____1815 = (

let uu____1816 = (

let uu____1817 = (FStar_TypeChecker_Env.get_range tcenv1)
in (FStar_All.pipe_left FStar_Range.string_of_range uu____1817))
in (FStar_Util.format1 "Ending query at %s" uu____1816))
in (FStar_SMTEncoding_Encode.pop uu____1815)))
in (match (qry) with
| FStar_SMTEncoding_Term.Assume ({FStar_SMTEncoding_Term.assumption_term = {FStar_SMTEncoding_Term.tm = FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.FalseOp, uu____1818); FStar_SMTEncoding_Term.freevars = uu____1819; FStar_SMTEncoding_Term.rng = uu____1820}; FStar_SMTEncoding_Term.assumption_caption = uu____1821; FStar_SMTEncoding_Term.assumption_name = uu____1822; FStar_SMTEncoding_Term.assumption_fact_ids = uu____1823}) -> begin
(pop1 ())
end
| uu____1831 when tcenv1.FStar_TypeChecker_Env.admit -> begin
(pop1 ())
end
| FStar_SMTEncoding_Term.Assume (uu____1832) -> begin
...
let dummy : FStar_TypeChecker_Env.solver_t = {FStar_TypeChecker_Env.init = (fun uu____1841 -> ()); FStar_TypeChecker_Env.push = (fun uu____1842 -> ()); FStar_TypeChecker_Env.pop = (fun uu____1843 -> ()); FStar_TypeChecker_Env.mark = (fun uu____1844 -> ()); FStar_TypeChecker_Env.reset_mark = (fun uu____1845 -> ()); FStar_TypeChecker_Env.commit_mark = (fun uu____1846 -> ()); FStar_TypeChecker_Env.encode_modul = (fun uu____1847 uu____1848 -> ()); FStar_TypeChecker_Env.encode_sig = (fun uu____1849 uu____1850 -> ()); FStar_TypeChecker_Env.preprocess = (fun e g -> (((e), (g)))::[]); FStar_TypeChecker_Env.solve = (fun uu____1857 uu____1858 uu____1859 -> ()); FStar_TypeChecker_Env.is_trivial = (fun uu____1863 uu____1864 -> false); FStar_TypeChecker_Env.finish = (fun uu____1865 -> ()); FStar_TypeChecker_Env.refresh = (fun uu____1866 -> ())}
