  ...
  fun e  ->
    fun theory  ->
      ...
      let pruned_theory =
        ...
        let keep_decl uu___387_438 =
          match uu___387_438 with
...
let (report_errors : query_settings -> unit) =
  fun settings  ->
    ...
    (let uu____2216 =
     ...
     then
       let initial_fuel1 =
         let uu___389_2225 = settings  in
         let uu____2226 = FStar_Options.initial_fuel ()  in
         let uu____2228 = FStar_Options.initial_ifuel ()  in
         {
           query_env = (uu___389_2225.query_env);
           query_decl = (uu___389_2225.query_decl);
           query_name = (uu___389_2225.query_name);
           query_index = (uu___389_2225.query_index);
           query_range = (uu___389_2225.query_range);
           query_fuel = uu____2226;
           query_ifuel = uu____2228;
           query_rlimit = (uu___389_2225.query_rlimit);
           query_hint = FStar_Pervasives_Native.None;
           query_errors = (uu___389_2225.query_errors);
           query_all_labels = (uu___389_2225.query_all_labels);
           query_suffix = (uu___389_2225.query_suffix);
           query_hash = (uu___389_2225.query_hash)
         }  in
       let ask_z3 label_assumptions =
         let res = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
         (let uu____2251 =
            ...
            (let uu____3453 =
             ...
             | (default_settings,next_hint) ->
                 let use_hints_setting =
                   ...
                   | FStar_Pervasives_Native.Some
                       { FStar_Util.hint_name = uu____3596;
                         ...
                         FStar_Util.hash = h;_}
                       ->
                       [(let uu___390_3618 = default_settings  in
                         {
                           query_env = (uu___390_3618.query_env);
                           query_decl = (uu___390_3618.query_decl);
                           query_name = (uu___390_3618.query_name);
                           query_index = (uu___390_3618.query_index);
                           query_range = (uu___390_3618.query_range);
                           query_fuel = i;
                           query_ifuel = j;
                           query_rlimit = (uu___390_3618.query_rlimit);
                           query_hint = (FStar_Pervasives_Native.Some core);
                           query_errors = (uu___390_3618.query_errors);
                           query_all_labels =
                             (uu___390_3618.query_all_labels);
                           query_suffix = (uu___390_3618.query_suffix);
                           query_hash = (uu___390_3618.query_hash)
                         })]
                   | uu____3622 -> []  in
                 let initial_fuel_max_ifuel =
                   ...
                   then
                     let uu____3637 =
                       let uu___391_3638 = default_settings  in
                       let uu____3639 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___391_3638.query_env);
                         query_decl = (uu___391_3638.query_decl);
                         query_name = (uu___391_3638.query_name);
                         query_index = (uu___391_3638.query_index);
                         query_range = (uu___391_3638.query_range);
                         query_fuel = (uu___391_3638.query_fuel);
                         query_ifuel = uu____3639;
                         query_rlimit = (uu___391_3638.query_rlimit);
                         query_hint = (uu___391_3638.query_hint);
                         query_errors = (uu___391_3638.query_errors);
                         query_all_labels = (uu___391_3638.query_all_labels);
                         query_suffix = (uu___391_3638.query_suffix);
                         query_hash = (uu___391_3638.query_hash)
                       }  in
                     [uu____3637]
                   else []  in
                 let half_max_fuel_max_ifuel =
                   ...
                   then
                     let uu____3658 =
                       let uu___392_3659 = default_settings  in
                       let uu____3660 =
                         let uu____3662 = FStar_Options.max_fuel ()  in
                         uu____3662 / (Prims.parse_int "2")  in
                       let uu____3665 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___392_3659.query_env);
                         query_decl = (uu___392_3659.query_decl);
                         query_name = (uu___392_3659.query_name);
                         query_index = (uu___392_3659.query_index);
                         query_range = (uu___392_3659.query_range);
                         query_fuel = uu____3660;
                         query_ifuel = uu____3665;
                         query_rlimit = (uu___392_3659.query_rlimit);
                         query_hint = (uu___392_3659.query_hint);
                         query_errors = (uu___392_3659.query_errors);
                         query_all_labels = (uu___392_3659.query_all_labels);
                         query_suffix = (uu___392_3659.query_suffix);
                         query_hash = (uu___392_3659.query_hash)
                       }  in
                     [uu____3658]
                   else []  in
                 let max_fuel_max_ifuel =
                   ...
                   then
                     let uu____3691 =
                       let uu___393_3692 = default_settings  in
                       let uu____3693 = FStar_Options.max_fuel ()  in
                       let uu____3695 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___393_3692.query_env);
                         query_decl = (uu___393_3692.query_decl);
                         query_name = (uu___393_3692.query_name);
                         query_index = (uu___393_3692.query_index);
                         query_range = (uu___393_3692.query_range);
                         query_fuel = uu____3693;
                         query_ifuel = uu____3695;
                         query_rlimit = (uu___393_3692.query_rlimit);
                         query_hint = (uu___393_3692.query_hint);
                         query_errors = (uu___393_3692.query_errors);
                         query_all_labels = (uu___393_3692.query_all_labels);
                         query_suffix = (uu___393_3692.query_suffix);
                         query_hash = (uu___393_3692.query_hash)
                       }  in
                     [uu____3691]
                   else []  in
                 let min_fuel1 =
                   ...
                   then
                     let uu____3711 =
                       let uu___394_3712 = default_settings  in
                       let uu____3713 = FStar_Options.min_fuel ()  in
                       {
                         query_env = (uu___394_3712.query_env);
                         query_decl = (uu___394_3712.query_decl);
                         query_name = (uu___394_3712.query_name);
                         query_index = (uu___394_3712.query_index);
                         query_range = (uu___394_3712.query_range);
                         query_fuel = uu____3713;
                         query_ifuel = (Prims.parse_int "1");
                         query_rlimit = (uu___394_3712.query_rlimit);
                         query_hint = (uu___394_3712.query_hint);
                         query_errors = (uu___394_3712.query_errors);
                         query_all_labels = (uu___394_3712.query_all_labels);
                         query_suffix = (uu___394_3712.query_suffix);
                         query_hash = (uu___394_3712.query_hash)
                       }  in
                     [uu____3711]
                   else []  in
                 let all_configs =
                 ...
                 let check_all_configs configs =
                   let report1 errs =
                     report_errors
                       (let uu___395_3772 = default_settings  in
                        {
                          query_env = (uu___395_3772.query_env);
                          query_decl = (uu___395_3772.query_decl);
                          query_name = (uu___395_3772.query_name);
                          query_index = (uu___395_3772.query_index);
                          query_range = (uu___395_3772.query_range);
                          query_fuel = (uu___395_3772.query_fuel);
                          query_ifuel = (uu___395_3772.query_ifuel);
                          query_rlimit = (uu___395_3772.query_rlimit);
                          query_hint = (uu___395_3772.query_hint);
                          query_errors = errs;
                          query_all_labels = (uu___395_3772.query_all_labels);
                          query_suffix = (uu___395_3772.query_suffix);
                          query_hash = (uu___395_3772.query_hash)
                        })
                      in
