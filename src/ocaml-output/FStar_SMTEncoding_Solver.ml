...
type z3_replay_result =
  (FStar_SMTEncoding_Z3.unsat_core,FStar_SMTEncoding_Term.error_labels)
    FStar_Util.either
let z3_result_as_replay_result uu___92_23 =
  match uu___92_23 with
...
let record_hint: FStar_Util.hint Prims.option -> Prims.unit =
  fun hint  ->
    let hint1 =
      ...
      | Some h ->
          Some
            (let uu___95_225 = h in
             {
               FStar_Util.hint_name = (uu___95_225.FStar_Util.hint_name);
               FStar_Util.hint_index = (uu___95_225.FStar_Util.hint_index);
               FStar_Util.fuel = (uu___95_225.FStar_Util.fuel);
               FStar_Util.ifuel = (uu___95_225.FStar_Util.ifuel);
               FStar_Util.unsat_core = (uu___95_225.FStar_Util.unsat_core);
          ...
          fun suffix  ->
            ...
            (let uu____299 =
             ...
             | (query_name,query_index) ->
                 ...
                 let set_minimum_workable_fuel f uu___94_355 =
                   match uu___94_355 with
                   | ([],uu____362) -> ()
                   | errs ->
