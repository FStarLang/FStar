...
let solver : FStar_TypeChecker_Env.solver_t = {FStar_TypeChecker_Env.init = FStar_SMTEncoding_Encode.init; FStar_TypeChecker_Env.push = FStar_SMTEncoding_Encode.push; FStar_TypeChecker_Env.pop = FStar_SMTEncoding_Encode.pop; FStar_TypeChecker_Env.stsize = FStar_SMTEncoding_Encode.stsize; FStar_TypeChecker_Env.mark = FStar_SMTEncoding_Encode.mark; FStar_TypeChecker_Env.reset_mark = FStar_SMTEncoding_Encode.reset_mark; FStar_TypeChecker_Env.commit_mark = FStar_SMTEncoding_Encode.commit_mark; FStar_TypeChecker_Env.encode_modul = FStar_SMTEncoding_Encode.encode_modul; FStar_TypeChecker_Env.encode_sig = FStar_SMTEncoding_Encode.encode_sig; FStar_TypeChecker_Env.solve = solve; FStar_TypeChecker_Env.is_trivial = FStar_SMTEncoding_Encode.is_trivial; FStar_TypeChecker_Env.finish = FStar_SMTEncoding_Z3.finish; FStar_TypeChecker_Env.refresh = FStar_SMTEncoding_Z3.refresh}


let dummy : FStar_TypeChecker_Env.solver_t = {FStar_TypeChecker_Env.init = (fun _89_313 -> ()); FStar_TypeChecker_Env.push = (fun _89_315 -> ()); FStar_TypeChecker_Env.pop = (fun _89_317 -> ()); FStar_TypeChecker_Env.stsize = (fun _89_319 -> (Prims.parse_int "0")); FStar_TypeChecker_Env.mark = (fun _89_321 -> ()); FStar_TypeChecker_Env.reset_mark = (fun _89_323 -> ()); FStar_TypeChecker_Env.commit_mark = (fun _89_325 -> ()); FStar_TypeChecker_Env.encode_modul = (fun _89_327 _89_329 -> ()); FStar_TypeChecker_Env.encode_sig = (fun _89_331 _89_333 -> ()); FStar_TypeChecker_Env.solve = (fun _89_335 _89_337 _89_339 -> ()); FStar_TypeChecker_Env.is_trivial = (fun _89_341 _89_343 -> false); FStar_TypeChecker_Env.finish = (fun _89_345 -> ()); FStar_TypeChecker_Env.refresh = (fun _89_346 -> ())}
