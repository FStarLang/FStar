  ...
  fun src_filename  ->
    (let uu____131 = FStar_Options.record_hints () in
     ...
     then
       ...
       let hints_db =
         let _0_339 = FStar_Util.digest_of_file src_filename in
         { FStar_Util.module_digest = _0_339; FStar_Util.hints = hints } in
    ...
    (let uu____140 = FStar_Options.hint_info () in
     ...
     then
       let stats =
         let _0_340 = FStar_ST.read hint_stats in
         FStar_All.pipe_right _0_340 FStar_List.rev in
       FStar_All.pipe_right stats
         (FStar_List.iter
            (fun s  ->
               match s.replay_result with
               | FStar_Util.Inl _unsat_core ->
                   let _0_342 = FStar_Range.string_of_range s.source_location in
                   let _0_341 = FStar_Util.string_of_int s.elapsed_time in
                   FStar_Util.print2
                     "Hint-info (%s): Replay succeeded in %s milliseconds\n"
                     _0_342 _0_341
               | FStar_Util.Inr _error ->
                   let _0_344 = FStar_Range.string_of_range s.source_location in
                   let _0_343 = FStar_Util.string_of_int s.elapsed_time in
                   FStar_Util.print2
    ...
    fun res  ->
      fun time  ->
        fun r  ->
          ...
          let _0_346 = let _0_345 = FStar_ST.read hint_stats in s :: _0_345 in
          FStar_ST.write hint_stats _0_346
          ...
          fun suffix  ->
            ...
            (let uu____286 =
             ...
             | (query_name,query_index) ->
                       ...
                       let _0_368 =
                         let _0_359 =
                           FStar_SMTEncoding_Term.Caption
                             (let _0_348 = FStar_Util.string_of_int n in
                              let _0_347 = FStar_Util.string_of_int i in
                         ...
                         let _0_366 =
                           ...
                           let _0_364 =
                             let _0_363 =
                               ...
                               FStar_List.append _0_362 suffix in
                             FStar_List.append
                               [FStar_SMTEncoding_Term.CheckSat] _0_363 in
                           FStar_List.append _0_365 _0_364 in
                         FStar_List.append label_assumptions _0_366 in
                       FStar_List.append _0_368 _0_367 in
                 let check p =
                   let rlimit =
                     let _0_369 = FStar_Options.z3_rlimit () in
                     _0_369 * (Prims.parse_int "544656") in
                   let default_initial_config =
                     let _0_371 = FStar_Options.initial_fuel () in
                     let _0_370 = FStar_Options.initial_ifuel () in
                     (_0_371, _0_370, rlimit) in
                   ...
                   | (unsat_core,initial_config) ->
                       let alt_configs =
                         FStar_List.flatten
                           (let _0_402 =
                              let _0_401 =
                                let uu____571 =
                                  let _0_373 = FStar_Options.max_ifuel () in
                                  let _0_372 = FStar_Options.initial_ifuel () in
                                  _0_373 > _0_372 in
                                if uu____571
                                then
                                  let _0_376 =
                              ...
                              let _0_400 =
                                let _0_399 =
                                  let uu____590 =
                                    let _0_379 =
                                      let _0_377 = FStar_Options.max_fuel () in
                                      _0_377 / (Prims.parse_int "2") in
                                    let _0_378 =
                                      FStar_Options.initial_fuel () in
                                    _0_379 > _0_378 in
                                  if uu____590
                                  then
                                    let _0_383 =
                                      let _0_382 =
                                        ...
                                        _0_380 / (Prims.parse_int "2") in
                                      let _0_381 = FStar_Options.max_ifuel () in
                                ...
                                let _0_398 =
                                  let _0_397 =
                                    let uu____609 =
                                      (let _0_385 = FStar_Options.max_fuel () in
                                       let _0_384 =
                                         FStar_Options.initial_fuel () in
                                       _0_385 > _0_384) &&
                                        (let _0_387 =
                       ...
                       let report p errs =
                         let errs =
                           let uu____655 =
                             (FStar_Options.detail_errors ()) &&
                               (let _0_403 = FStar_Options.n_cores () in
                                _0_403 = (Prims.parse_int "1")) in
                           if uu____655
                           then
                             let uu____656 =
                               let uu____665 =
                               ...
                               | None  ->
                                   let _0_405 =
                                     let _0_404 = FStar_Options.min_fuel () in
                                     (_0_404, (Prims.parse_int "1"), rlimit) in
                                   (_0_405, errs) in
                             ...
                             | (min_fuel,potential_errors) ->
                                 ...
                                 (_0_407, FStar_SMTEncoding_Z3.Default)
                           else
                             (match errs with
                         ...
                         (let uu____882 = FStar_Options.print_fuels () in
                          ...
                          then
                            ...
                            let _0_411 =
                              let _0_408 = FStar_Options.max_fuel () in
                              FStar_All.pipe_right _0_408
                                FStar_Util.string_of_int in
                            let _0_410 =
                              let _0_409 = FStar_Options.max_ifuel () in
                         ...
                         (let _0_413 =
                          ...
                          FStar_TypeChecker_Err.add_errors env _0_413) in
                       ...
                       let rec try_alt_configs prev_f p errs cfgs =
                         ...
                         (match (cfgs, (Prims.snd errs)) with
                          ...
                          | (mi::[],uu____1006) ->
                              (match errs with
                               | ([],uu____1020) ->
                                   let _0_414 = with_fuel [] p mi in
                                   FStar_SMTEncoding_Z3.ask None all_labels
                                     _0_414 (cb false mi p [])
                               | uu____1026 ->
                                   (set_minimum_workable_fuel prev_f errs;
                                    report p errs))
                          | (mi::tl,uu____1030) ->
                              let _0_417 = with_fuel [] p mi in
                              FStar_SMTEncoding_Z3.ask None all_labels _0_417
                                (fun uu____1046  ->
                                   match uu____1046 with
                                   | (result,elapsed_time) ->
                                       let _0_416 =
                                         let _0_415 = use_errors errs result in
                                         (_0_415, elapsed_time) in
                                       cb false mi p tl _0_416))
                       ...
                       (if FStar_Option.isSome unsat_core
                        ...
                        (let _0_434 = with_fuel [] p initial_config in
                 ...
                 let process_query q =
                   let uu____1147 =
                     let _0_435 = FStar_Options.split_cases () in
                     _0_435 > (Prims.parse_int "0") in
                   if uu____1147
                   then
                     let uu____1148 =
                       let _0_436 = FStar_Options.split_cases () in
      ...
      fun q  ->
        FStar_SMTEncoding_Encode.push
          (let _0_438 =
             ...
             FStar_All.pipe_left FStar_Range.string_of_range _0_437 in
           FStar_Util.format1 "Starting query at %s" _0_438);
         ...
         | (prefix,labels,qry,suffix) ->
             let pop uu____1214 =
               FStar_SMTEncoding_Encode.pop
                 (let _0_440 =
                    let _0_439 = FStar_TypeChecker_Env.get_range tcenv in
                    FStar_All.pipe_left FStar_Range.string_of_range _0_439 in
                  FStar_Util.format1 "Ending query at %s" _0_440) in
             (match qry with
              | FStar_SMTEncoding_Term.Assume
                  ({
