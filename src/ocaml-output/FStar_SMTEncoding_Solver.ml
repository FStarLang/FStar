...
let (report_errors : query_settings -> unit) =
  fun settings  ->
    ...
    (let uu____1628 =
     ...
     then
       let initial_fuel1 =
         let uu___362_1632 = settings  in
         let uu____1633 = FStar_Options.initial_fuel ()  in
         let uu____1634 = FStar_Options.initial_ifuel ()  in
         {
           query_env = (uu___362_1632.query_env);
           query_decl = (uu___362_1632.query_decl);
           query_name = (uu___362_1632.query_name);
           query_index = (uu___362_1632.query_index);
           query_range = (uu___362_1632.query_range);
           query_fuel = uu____1633;
           query_ifuel = uu____1634;
           query_rlimit = (uu___362_1632.query_rlimit);
           query_hint = FStar_Pervasives_Native.None;
           query_errors = (uu___362_1632.query_errors);
           query_all_labels = (uu___362_1632.query_all_labels);
           query_suffix = (uu___362_1632.query_suffix);
           query_hash = (uu___362_1632.query_hash)
         }  in
       let ask_z3 label_assumptions =
         let res = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
         (let uu____1655 =
            ...
            (let uu____2142 =
             ...
             | (default_settings,next_hint) ->
                 let use_hints_setting =
                   ...
                   | FStar_Pervasives_Native.Some
                       { FStar_Util.hint_name = uu____2244;
                         ...
                         FStar_Util.hash = h;_}
                       ->
                       [(let uu___363_2258 = default_settings  in
                         {
                           query_env = (uu___363_2258.query_env);
                           query_decl = (uu___363_2258.query_decl);
                           query_name = (uu___363_2258.query_name);
                           query_index = (uu___363_2258.query_index);
                           query_range = (uu___363_2258.query_range);
                           query_fuel = i;
                           query_ifuel = j;
                           query_rlimit = (uu___363_2258.query_rlimit);
                           query_hint = (FStar_Pervasives_Native.Some core);
                           query_errors = (uu___363_2258.query_errors);
                           query_all_labels =
                             (uu___363_2258.query_all_labels);
                           query_suffix = (uu___363_2258.query_suffix);
                           query_hash = (uu___363_2258.query_hash)
                         })]
                   | uu____2261 -> []  in
                   ...
                   then
                     let uu____2272 =
                       ...
                       let uu____2274 = FStar_Options.max_ifuel ()  in
                       {
                         ...
                         query_fuel = (uu___364_2273.query_fuel);
                 ...
                 let half_max_fuel_max_ifuel =
                   ...
                   then
                     let uu____2285 =
                       let uu___365_2286 = default_settings  in
                       let uu____2287 =
                         let uu____2288 = FStar_Options.max_fuel ()  in
                         uu____2288 / (Prims.parse_int "2")  in
                       let uu____2289 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___365_2286.query_env);
                         query_decl = (uu___365_2286.query_decl);
                         query_name = (uu___365_2286.query_name);
                         query_index = (uu___365_2286.query_index);
                         query_range = (uu___365_2286.query_range);
                         query_fuel = uu____2287;
                         query_ifuel = uu____2289;
                         query_rlimit = (uu___365_2286.query_rlimit);
                         query_hint = (uu___365_2286.query_hint);
                         query_errors = (uu___365_2286.query_errors);
                         query_all_labels = (uu___365_2286.query_all_labels);
                         query_suffix = (uu___365_2286.query_suffix);
                         query_hash = (uu___365_2286.query_hash)
                       }  in
                     [uu____2285]
                   else []  in
                 let max_fuel_max_ifuel =
                   ...
                   then
                     let uu____2307 =
                       let uu___366_2308 = default_settings  in
                       let uu____2309 = FStar_Options.max_fuel ()  in
                       let uu____2310 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___366_2308.query_env);
                         query_decl = (uu___366_2308.query_decl);
                         query_name = (uu___366_2308.query_name);
                         query_index = (uu___366_2308.query_index);
                         query_range = (uu___366_2308.query_range);
                         query_fuel = uu____2309;
                         query_ifuel = uu____2310;
                         query_rlimit = (uu___366_2308.query_rlimit);
                         query_hint = (uu___366_2308.query_hint);
                         query_errors = (uu___366_2308.query_errors);
                         query_all_labels = (uu___366_2308.query_all_labels);
                         query_suffix = (uu___366_2308.query_suffix);
                         query_hash = (uu___366_2308.query_hash)
                       }  in
                     [uu____2307]
                   else []  in
                 let min_fuel1 =
                   ...
                   then
                     let uu____2320 =
                       let uu___367_2321 = default_settings  in
                       let uu____2322 = FStar_Options.min_fuel ()  in
                       {
                         query_env = (uu___367_2321.query_env);
                         query_decl = (uu___367_2321.query_decl);
                         query_name = (uu___367_2321.query_name);
                         query_index = (uu___367_2321.query_index);
                         query_range = (uu___367_2321.query_range);
                         query_fuel = uu____2322;
                         query_ifuel = (Prims.parse_int "1");
                         query_rlimit = (uu___367_2321.query_rlimit);
                         query_hint = (uu___367_2321.query_hint);
                         query_errors = (uu___367_2321.query_errors);
                         query_all_labels = (uu___367_2321.query_all_labels);
                         query_suffix = (uu___367_2321.query_suffix);
                         query_hash = (uu___367_2321.query_hash)
                       }  in
                     [uu____2320]
                   else []  in
                 let all_configs =
                 ...
                 let check_all_configs configs =
                   let report1 errs =
                     report_errors
                       (let uu___368_2375 = default_settings  in
                        {
                          query_env = (uu___368_2375.query_env);
                          query_decl = (uu___368_2375.query_decl);
                          query_name = (uu___368_2375.query_name);
                          query_index = (uu___368_2375.query_index);
                          query_range = (uu___368_2375.query_range);
                          query_fuel = (uu___368_2375.query_fuel);
                          query_ifuel = (uu___368_2375.query_ifuel);
                          query_rlimit = (uu___368_2375.query_rlimit);
                          query_hint = (uu___368_2375.query_hint);
                          query_errors = errs;
                          query_all_labels = (uu___368_2375.query_all_labels);
                          query_suffix = (uu___368_2375.query_suffix);
                          query_hash = (uu___368_2375.query_hash)
                        })
                      in
