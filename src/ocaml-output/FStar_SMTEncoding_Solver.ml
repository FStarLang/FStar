...
let z3_result_as_replay_result :
  'uuuuu 'uuuuu1 'uuuuu2 .
    ('uuuuu, ('uuuuu1 * 'uuuuu2)) Prims.either ->
      ('uuuuu, 'uuuuu1) Prims.either
  =
  fun uu___ ->
    match uu___ with
    | Prims.Inl l -> Prims.Inl l
    | Prims.Inr (r, uu___1) -> Prims.Inr r
let (recorded_hints :
          ...
          (let uu___2 =
           ...
           | (incomplete_count, canceled_count, unknown_count) ->
               FStar_Compiler_Effect.op_Bar_Greater
                 ...
                 (fun uu___3 -> Prims.Inl uu___3)) in
  ...
  query_settings Prims.list ->
    (query_settings -> FStar_SMTEncoding_Z3.z3result) ->
      (query_settings ->
        ...
        -> (errors Prims.list, query_settings) Prims.either)
  =
  fun qs ->
    fun ask ->
      fun f ->
        let rec aux acc qs1 =
          ...
          | q::qs2 ->
              ...
              (match uu___ with
               | FStar_Pervasives_Native.None -> Prims.Inr q
