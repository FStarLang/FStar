      ...
      let uu____1171 =
        let uu____1174 =
          let uu____1175 =
            ...
            FStar_Util.format2 "<fuel='%s' ifuel='%s'>" uu____1176 uu____1177
             in
  ...
  fun settings  ->
    ...
    then
      ...
      let ask_z3 label_assumptions =
        ...
        (let uu____1705 = FStar_ST.op_Bang res  in
         FStar_Option.get uu____1705)
         in
               ...
               FStar_All.pipe_right settings.query_errors
                 (FStar_List.map
                    (fun e  ->
                       ...
                       Prims.strcat "SMT solver says: " uu____1798))
                in
                     ...
                     | (uu____1914,msg,range1) ->
                         let e =
                           FStar_Errors.mk_issue FStar_Errors.EInfo
                             (FStar_Pervasives_Native.Some range1) msg
                            in
                         let tag1 =
