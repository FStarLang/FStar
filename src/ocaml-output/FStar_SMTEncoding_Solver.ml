  ...
  fun src_filename  ->
    (let uu____131 = FStar_Options.record_hints ()  in
     ...
     then
       ...
       let hints_db =
         let _0_337 = FStar_Util.digest_of_file src_filename  in
         { FStar_Util.module_digest = _0_337; FStar_Util.hints = hints }  in
    ...
    (let uu____140 = FStar_Options.hint_info ()  in
     ...
     then
       let stats =
         let _0_338 = FStar_ST.read hint_stats  in
         FStar_All.pipe_right _0_338 FStar_List.rev  in
       FStar_All.pipe_right stats
         (FStar_List.iter
            (fun s  ->
               match s.replay_result with
               | FStar_Util.Inl _unsat_core ->
                   let _0_340 = FStar_Range.string_of_range s.source_location
                      in
                   let _0_339 = FStar_Util.string_of_int s.elapsed_time  in
                   FStar_Util.print2
                     "Hint-info (%s): Replay succeeded in %s milliseconds\n"
                     _0_340 _0_339
               | FStar_Util.Inr _error ->
                   let _0_342 = FStar_Range.string_of_range s.source_location
                      in
                   let _0_341 = FStar_Util.string_of_int s.elapsed_time  in
                   FStar_Util.print2
    ...
    fun res  ->
      fun time  ->
        fun r  ->
          ...
          let _0_344 = let _0_343 = FStar_ST.read hint_stats  in s :: _0_343
             in
          FStar_ST.write hint_stats _0_344
            ...
            (let uu____286 =
             ...
             | (query_name,query_index) ->
                       ...
                       let _0_366 =
                         let _0_357 =
                           FStar_SMTEncoding_Term.Caption
                             (let _0_346 = FStar_Util.string_of_int n  in
                              let _0_345 = FStar_Util.string_of_int i  in
                         ...
                         let _0_364 =
                           ...
                           let _0_362 =
                             let _0_361 =
                               ...
                               FStar_List.append _0_360 suffix  in
                             FStar_List.append
                               [FStar_SMTEncoding_Term.CheckSat] _0_361
                              in
                           FStar_List.append _0_363 _0_362  in
                         FStar_List.append label_assumptions _0_364  in
                       FStar_List.append _0_366 _0_365
                    in
                 let check p =
                   let rlimit =
                     let _0_367 = FStar_Options.z3_rlimit ()  in
                     _0_367 * (Prims.parse_int "544656")  in
                   let default_initial_config =
                     let _0_369 = FStar_Options.initial_fuel ()  in
                     let _0_368 = FStar_Options.initial_ifuel ()  in
                   ...
                   | (unsat_core,initial_config) ->
                       let alt_configs =
                         FStar_List.flatten
                           (let _0_400 =
                              let _0_399 =
                                let uu____571 =
                                  let _0_371 = FStar_Options.max_ifuel ()  in
                                  let _0_370 = FStar_Options.initial_ifuel ()
                                     in
                                  _0_371 > _0_370  in
                                if uu____571
                                then
                                  let _0_374 =
                                    ...
                                    let _0_372 = FStar_Options.max_ifuel ()
                                       in
                                    (_0_373, _0_372, rlimit)  in
                                  [_0_374]
                                else []  in
                              let _0_398 =
                                let _0_397 =
                                  let uu____590 =
                                    let _0_377 =
                                      let _0_375 = FStar_Options.max_fuel ()
                                         in
                                      _0_375 / (Prims.parse_int "2")  in
                                    let _0_376 =
                                      FStar_Options.initial_fuel ()  in
                                    _0_377 > _0_376  in
                                  if uu____590
                                  then
                                    let _0_381 =
                                      let _0_380 =
                                        ...
                                        _0_378 / (Prims.parse_int "2")  in
                                      let _0_379 = FStar_Options.max_ifuel ()
                                         in
                                      (_0_380, _0_379, rlimit)  in
                                    [_0_381]
                                  else []  in
                                let _0_396 =
                                  let _0_395 =
                                    let uu____609 =
                                      (let _0_383 = FStar_Options.max_fuel ()
                                          in
                                       let _0_382 =
                                         FStar_Options.initial_fuel ()  in
                                       _0_383 > _0_382) &&
                         ...
                         let errs =
                           let uu____655 =
                             (FStar_Options.detail_errors ()) &&
                               (let _0_401 = FStar_Options.n_cores ()  in
                                _0_401 = (Prims.parse_int "1"))
                              in
                           if uu____655
                           then
                             let uu____656 =
                               ...
                               | None  ->
                                   let _0_403 =
                                     let _0_402 = FStar_Options.min_fuel ()
                                        in
                                     (_0_402, (Prims.parse_int "1"), rlimit)
                                      in
                                   (_0_403, errs)
                                in
                             ...
                             | (min_fuel,potential_errors) ->
                                 ...
                                 let _0_405 =
                                   FStar_SMTEncoding_ErrorReporting.detail_errors
                                    ...
                                    in
                                 (_0_405, FStar_SMTEncoding_Z3.Default)
                           else
                             (match errs with
                          ...
                          then
                            let _0_410 =
                              FStar_Range.string_of_range
                               ...
                               in
                            let _0_409 =
                              let _0_406 = FStar_Options.max_fuel ()  in
                              FStar_All.pipe_right _0_406
                                FStar_Util.string_of_int
                               in
                            let _0_408 =
                              let _0_407 = FStar_Options.max_ifuel ()  in
                              FStar_All.pipe_right _0_407
                                FStar_Util.string_of_int
                               in
                            FStar_Util.print3
                            ...
                            FStar_All.pipe_right (Prims.fst errs)
                              (FStar_List.map
                                 (fun uu____892  ->
                                    ...
                                    | (uu____898,x,y) -> (x, y)))
                             in
                          FStar_TypeChecker_Err.add_errors env _0_411)
                          in
                       ...
                       let rec try_alt_configs prev_f p errs cfgs =
                         ...
                         (match (cfgs, (Prims.snd errs)) with
                          ...
                          | (mi::[],uu____1006) ->
                              (match errs with
                               | ([],uu____1020) ->
                                   let _0_412 = with_fuel [] p mi  in
                                   FStar_SMTEncoding_Z3.ask None all_labels
                                     _0_412 (cb false mi p [])
                               | uu____1026 ->
                                   (set_minimum_workable_fuel prev_f errs;
                                    report p errs))
                          | (mi::tl,uu____1030) ->
                              let _0_415 = with_fuel [] p mi  in
                              FStar_SMTEncoding_Z3.ask None all_labels _0_415
                                (fun uu____1046  ->
                                   match uu____1046 with
                                   | (result,elapsed_time) ->
                                       let _0_414 =
                                         let _0_413 = use_errors errs result
                                            in
                                         (_0_413, elapsed_time)  in
                                       cb false mi p tl _0_414))
                       ...
                       (if FStar_Option.isSome unsat_core
                        ...
                        (let _0_432 = with_fuel [] p initial_config  in
                 ...
                 let process_query q =
                   ...
                   then
                     let uu____1148 =
                       let _0_434 = FStar_Options.split_cases ()  in
    ...
    fun tcenv  ->
      fun q  ->
        FStar_SMTEncoding_Encode.push
          (let _0_436 =
             let _0_435 = FStar_TypeChecker_Env.get_range tcenv  in
             FStar_All.pipe_left FStar_Range.string_of_range _0_435  in
           FStar_Util.format1 "Starting query at %s" _0_436);
         ...
         | (prefix,labels,qry,suffix) ->
             let pop uu____1214 =
               FStar_SMTEncoding_Encode.pop
                 (let _0_438 =
                    let _0_437 = FStar_TypeChecker_Env.get_range tcenv  in
                    FStar_All.pipe_left FStar_Range.string_of_range _0_437
                     in
                  FStar_Util.format1 "Ending query at %s" _0_438)
                in
             (match qry with
              | FStar_SMTEncoding_Term.Assume
                  ({
