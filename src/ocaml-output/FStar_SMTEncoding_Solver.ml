    ...
    (let uu____240 = FStar_Options.record_hints ()  in
     ...
     then
       ...
       let hints_db =
         ...
         { FStar_Util.module_digest = uu____298; FStar_Util.hints = hints }
          in
       let norm_src_filename = FStar_Util.normalize_file_path src_filename
          in
       let val_filename =
      ...
      let uu____1195 =
        let uu____1198 =
          let uu____1199 =
            ...
            FStar_Util.format2 "<fuel='%s' ifuel='%s'>" uu____1200 uu____1201
             in
  ...
  fun settings  ->
    ...
    then
      ...
      let ask_z3 label_assumptions =
        ...
        (let uu____1763 = FStar_ST.op_Bang res  in
         FStar_Option.get uu____1763)
         in
               ...
               FStar_All.pipe_right settings.query_errors
                 (FStar_List.map
                    (fun e  ->
                       ...
                       Prims.strcat "SMT solver says: " uu____1864))
                in
             ...
             | (default_settings,next_hint) ->
                 ...
                 let check_one_config config k =
                   ...
                   (let uu____2471 = with_fuel_and_diagnostics config []  in
                    let uu____2474 =
                      let uu____2477 = FStar_SMTEncoding_Z3.mk_fresh_scope ()
                         in
        ...
        (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv  in
         ...
         | (prefix1,labels,qry,suffix) ->
             let pop1 uu____2585 =
               let uu____2586 =
                 let uu____2587 =
                   let uu____2588 = FStar_TypeChecker_Env.get_range tcenv1
                      in
                   FStar_All.pipe_left FStar_Range.string_of_range uu____2588
                    in
...
let dummy : FStar_TypeChecker_Env.solver_t =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2658 =
             let uu____2665 = FStar_Options.peek ()  in (e, g, uu____2665)
              in
           [uu____2658]);
