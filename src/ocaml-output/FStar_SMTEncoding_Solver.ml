        ...
        then
          ...
          ((let uu____4308 = should_refresh tcenv  in
           ...
           (let pop1 uu____4327 =
              let uu____4328 =
                let uu____4330 =
                  let uu____4332 = FStar_TypeChecker_Env.get_range tcenv  in
                  FStar_All.pipe_left FStar_Range.string_of_range uu____4332
                   in
                FStar_Util.format1 "Ending query at %s" uu____4330  in
              FStar_SMTEncoding_Encode.pop uu____4328  in
            try
              (fun uu___530_4348  ->
                 match () with
                 | () ->
                      ...
                      | (prefix1,labels,qry,suffix) ->
                          ...
                          (match qry with
                                 ...
                                 FStar_SMTEncoding_Term.assumption_term =
                                   {
                                     ...
                                     FStar_SMTEncoding_Term.freevars =
                                       uu____4382;
                                     FStar_SMTEncoding_Term.rng = uu____4383;_};
                           ...
                           | uu____4406 when
                               ...
                               pop1 ()
                           | FStar_SMTEncoding_Term.Assume uu____4407 ->
                               (ask_and_report_errors tcenv1 labels prefix1
                                  qry suffix;
                                pop1 ())
                           | uu____4409 -> failwith "Impossible"))) ()
            with
            | FStar_SMTEncoding_Env.Inner_let_rec (s,uu____4418) ->
                (pop1 ();
                 (let uu____4422 =
                    let uu____4432 =
                      let uu____4440 =
                      ...
                      (FStar_Errors.Error_NonTopRecFunctionNotFullyEncoded,
                        uu____4440, (tcenv.FStar_TypeChecker_Env.range))
                       in
                    [uu____4432]  in
                  FStar_TypeChecker_Err.add_errors tcenv uu____4422))))
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____4470 =
             let uu____4477 = FStar_Options.peek ()  in (e, g, uu____4477)
              in
           [uu____4470]);
...
let (dummy : FStar_TypeChecker_Env.solver_t) =
  {
    FStar_TypeChecker_Env.init = (fun uu____4493  -> ());
    FStar_TypeChecker_Env.push = (fun uu____4495  -> ());
    FStar_TypeChecker_Env.pop = (fun uu____4498  -> ());
    FStar_TypeChecker_Env.snapshot =
      (fun uu____4501  ->
         (((Prims.parse_int "0"), (Prims.parse_int "0"),
            (Prims.parse_int "0")), ()));
    FStar_TypeChecker_Env.rollback =
      (fun uu____4520  -> fun uu____4521  -> ());
    FStar_TypeChecker_Env.encode_sig =
      (fun uu____4536  -> fun uu____4537  -> ());
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____4543 =
             let uu____4550 = FStar_Options.peek ()  in (e, g, uu____4550)
              in
           [uu____4543]);
    FStar_TypeChecker_Env.solve =
      (fun uu____4566  -> fun uu____4567  -> fun uu____4568  -> ());
    FStar_TypeChecker_Env.finish = (fun uu____4575  -> ());
    FStar_TypeChecker_Env.refresh = (fun uu____4577  -> ())
  } 