    ...
    (let uu____206 = FStar_Options.record_hints () in
     ...
     then
       ...
       let hints_db =
         ...
         { FStar_Util.module_digest = uu____237; FStar_Util.hints = hints } in
       let norm_src_filename = FStar_Util.normalize_file_path src_filename in
       let val_filename = FStar_Options.hint_file_for_src norm_src_filename in
        ...
        | uu____359 ->
            (FStar_All.pipe_right
              ...
              (let uu____373 =
               ...
               FStar_Option.isSome uu____373) in
          ...
          (fun out ->
             fun d ->
               ...
               | uu____463 ->
                   ...
                   if uu____464 then d :: out else out) [] theory_rev in
      pruned_theory
  ...
  fun settings ->
    fun label_assumptions ->
      ...
      let uu____1732 =
        let uu____1735 =
          let uu____1736 =
            let uu____1738 = FStar_Util.string_of_int n1 in
            let uu____1740 = FStar_Util.string_of_int i in
            FStar_Util.format2 "<fuel='%s' ifuel='%s'>" uu____1738 uu____1740 in
          FStar_SMTEncoding_Term.Caption uu____1736 in
        let uu____1743 =
          let uu____1746 =
            let uu____1747 =
              let uu____1755 =
                let uu____1756 =
                  ...
                  let uu____1766 = FStar_SMTEncoding_Term.n_fuel n1 in
                  (uu____1761, uu____1766) in
                FStar_SMTEncoding_Util.mkEq uu____1756 in
              (uu____1755, FStar_Pervasives_Native.None,
                "@MaxFuel_assumption") in
            FStar_SMTEncoding_Util.mkAssume uu____1747 in
          let uu____1770 =
            let uu____1773 =
              let uu____1774 =
                let uu____1782 =
                  let uu____1783 =
                    ...
                    let uu____1793 = FStar_SMTEncoding_Term.n_fuel i in
                    (uu____1788, uu____1793) in
                  FStar_SMTEncoding_Util.mkEq uu____1783 in
                (uu____1782, FStar_Pervasives_Native.None,
                  "@MaxIFuel_assumption") in
              FStar_SMTEncoding_Util.mkAssume uu____1774 in
            [uu____1773; settings.query_decl] in
          uu____1746 :: uu____1770 in
        uu____1735 :: uu____1743 in
      let uu____1797 =
        let uu____1800 =
          let uu____1803 =
            let uu____1806 =
              let uu____1807 =
                let uu____1814 = FStar_Util.string_of_int rlimit in
                ("rlimit", uu____1814) in
              FStar_SMTEncoding_Term.SetOption uu____1807 in
            [uu____1806;
          ...
          FStar_List.append uu____1803 uu____1823 in
        FStar_List.append label_assumptions uu____1800 in
      FStar_List.append uu____1732 uu____1797
        ...
        | _failed ->
            let ask_z3 label_assumptions =
              ...
              FStar_SMTEncoding_Z3.ask (settings_to_info settings)
                ...
                settings.query_hash settings.query_all_labels uu____2015
...
let (find_localized_errors :
  ...
  fun errs ->
    FStar_All.pipe_right errs
      (FStar_List.tryFind
         (fun err ->
            match err.error_messages with | [] -> false | uu____2049 -> true))
let (errors_to_report : query_settings -> FStar_Errors.error Prims.list) =
  fun settings ->
    ...
    let basic_errors =
      let smt_error =
        let uu____2090 = FStar_Options.query_stats () in
        if uu____2090
        then
          let uu____2099 =
            let uu____2101 =
            ...
            FStar_All.pipe_right uu____2101 format_smt_error in
          FStar_All.pipe_right uu____2099 (fun _2129 -> FStar_Util.Inr _2129)
        else
          (let uu____2132 =
             FStar_List.fold_left
               (fun uu____2157 ->
           ...
           | (incomplete_count, canceled_count, unknown_count) ->
               FStar_All.pipe_right
                 (match (incomplete_count, canceled_count, unknown_count)
                  with
                  | (uu____2262, _2267, _2268) when
                      ((_2267 = Prims.int_zero) && (_2268 = Prims.int_zero))
                  ...
                  | (_2275, uu____2271, _2277) when
                      ((_2275 = Prims.int_zero) && (_2277 = Prims.int_zero))
                        && (canceled_count > Prims.int_zero)
                      ->
                      "The SMT query timed out, you might want to increase the rlimit"
                  | (uu____2280, uu____2281, uu____2282) ->
                      "Try with --query_stats to get more details")
                 (fun _2292 -> FStar_Util.Inl _2292)) in
      let uu____2293 = find_localized_errors settings.query_errors in
    ...
    (let uu____2316 = FStar_Options.detail_errors () in
     if uu____2316
     then
       let initial_fuel1 =
         let uu___250_2320 = settings in
         let uu____2321 = FStar_Options.initial_fuel () in
         let uu____2323 = FStar_Options.initial_ifuel () in
         {
           query_env = (uu___250_2320.query_env);
           query_decl = (uu___250_2320.query_decl);
           query_name = (uu___250_2320.query_name);
           query_index = (uu___250_2320.query_index);
           query_range = (uu___250_2320.query_range);
           query_fuel = uu____2321;
           query_ifuel = uu____2323;
           query_rlimit = (uu___250_2320.query_rlimit);
           query_hint = FStar_Pervasives_Native.None;
           query_errors = (uu___250_2320.query_errors);
           query_all_labels = (uu___250_2320.query_all_labels);
           query_suffix = (uu___250_2320.query_suffix);
           query_hash = (uu___250_2320.query_hash)
         } in
       let ask_z3 label_assumptions =
         let uu____2338 =
         ...
         FStar_SMTEncoding_Z3.ask (settings_to_info settings)
           ...
           settings.query_all_labels uu____2338 FStar_Pervasives_Native.None
           false in
...
let (report_errors : query_settings -> unit) =
  fun qry_settings ->
    let uu____2351 = errors_to_report qry_settings in
    FStar_Errors.add_errors uu____2351
let (query_info : query_settings -> FStar_SMTEncoding_Z3.z3result -> unit) =
  fun settings ->
    fun z3result ->
      let process_unsat_core core =
        let accumulator uu____2397 =
          ...
          let uu____2408 =
            ...
            ((fun m ->
              ...
              (fun uu____2508 ->
                 let uu____2509 = FStar_ST.op_Bang module_names in
                 FStar_All.pipe_right uu____2509
                   (FStar_Util.sort_with FStar_String.compare))) in
          match uu____2408 with | (add1, get1) -> (add1, get1) in
        let uu____2591 = accumulator () in
        match uu____2591 with
        | (add_module_name, get_module_names) ->
            let uu____2628 = accumulator () in
             ...
             | (add_discarded_name, get_discarded_names) ->
                 let parse_axiom_name s =
                   ...
                   | FStar_Pervasives_Native.Some first_upper_index1 ->
                           ...
                           FStar_Util.find_map excluded_suffixes
                             (fun sfx ->
                                ...
                                then
                                  ...
                                  FStar_Pervasives_Native.Some uu____2751
                       ...
                       let components1 =
                         ...
                         | [] -> []
                         | uu____2796 ->
                             let uu____2800 = FStar_Util.prefix components in
                             (match uu____2800 with
                              | (module_name, last1) ->
                                  let components1 =
                                    let uu____2827 = exclude_suffix last1 in
                                    FStar_List.append module_name uu____2827 in
                 ...
                 (match core with
                  ...
                  | FStar_Pervasives_Native.Some core1 ->
                      ...
                      ((let uu____2882 =
                          let uu____2884 = get_module_names () in
                       ...
                       (let uu____2897 =
                          let uu____2899 = get_discarded_names () in
             ...
             | (tag, core) ->
                 let range =
                   let uu____2958 =
                     ...
                     Prims.op_Hat uu____2960 (Prims.op_Hat at_log_file ")") in
                   Prims.op_Hat "(" uu____2958 in
                 let used_hint_tag =
                   if used_hint settings then " (with hint)" else "" in
                 let stats =
                   let uu____2974 = FStar_Options.query_stats () in
                   if uu____2974
                   then
                     let f k v1 a =
                       Prims.op_Hat a
                       ...
                       let uu____3025 =
                         ...
                         let uu____3031 =
                           let uu____3035 =
                             ...
                             used_hint_tag :: uu____3039 in
                           tag :: uu____3035 in
                         uu____3029 :: uu____3031 in
                       (settings.query_name) :: uu____3025 in
                     range :: uu____3021 in
                   FStar_Util.print
                     "%s\tQuery-stats (%s, %s)\t%s%s in %s milliseconds with fuel %s and ifuel %s and rlimit %s %s\n"
                     uu____3017);
                  (let uu____3076 = FStar_Options.print_z3_statistics () in
                   if uu____3076 then process_unsat_core core else ());
                  FStar_All.pipe_right errs
                    (FStar_List.iter
                       (fun uu____3102 ->
                          match uu____3102 with
                          | (uu____3110, msg, range1) ->
                              let tag1 =
...
let (record_hint : query_settings -> FStar_SMTEncoding_Z3.z3result -> unit) =
  fun settings ->
    fun z3result ->
      let uu____3137 =
        let uu____3139 = FStar_Options.record_hints () in
        Prims.op_Negation uu____3139 in
      if uu____3137
      then ()
      else
        (let mk_hint core =
         ...
         let store_hint hint =
           let uu____3174 = FStar_ST.op_Bang recorded_hints in
         ...
         | FStar_SMTEncoding_Z3.UNSAT (FStar_Pervasives_Native.None) ->
             let uu____3237 =
               ...
               FStar_Option.get uu____3238 in
             store_hint uu____3237
...
let (full_query_id : query_settings -> Prims.string) =
  fun settings ->
    let uu____3375 =
      let uu____3377 =
        let uu____3379 =
          let uu____3381 = FStar_Util.string_of_int settings.query_index in
          Prims.op_Hat uu____3381 ")" in
        Prims.op_Hat ", " uu____3379 in
      Prims.op_Hat settings.query_name uu____3377 in
    Prims.op_Hat "(" uu____3375
  ...
  fun l ->
    ...
    let rec add_one1 acc1 x =
      ...
      | (h, n1)::t ->
          ...
          else (let uu____3511 = add_one1 t x in (h, n1) :: uu____3511) in
          ...
          fun suffix ->
            ...
            (let uu____3567 =
               let uu____3574 =
                 ...
                 | (uu____3587, FStar_Pervasives_Native.None) ->
                     failwith "No query name set!"
                 | (uu____3613, FStar_Pervasives_Native.Some (q, n1)) ->
                     let uu____3636 = FStar_Ident.text_of_lid q in
                     (uu____3636, n1) in
               match uu____3574 with
               | (qname, index1) ->
                   let rlimit =
                     let uu____3654 = FStar_Options.z3_rlimit_factor () in
                     let uu____3656 =
                       let uu____3658 = FStar_Options.z3_rlimit () in
                       uu____3658 * (Prims.parse_int "544656") in
                     uu____3654 * uu____3656 in
                   let next_hint = get_hint_for qname index1 in
                   let default_settings =
                     let uu____3665 = FStar_TypeChecker_Env.get_range env in
                     let uu____3666 = FStar_Options.initial_fuel () in
                     let uu____3668 = FStar_Options.initial_ifuel () in
                     {
                       ...
                       query_name = qname;
                       query_index = index1;
                       query_range = uu____3665;
                       query_fuel = uu____3666;
                       query_ifuel = uu____3668;
                       query_rlimit = rlimit;
                       query_hint = FStar_Pervasives_Native.None;
                       query_errors = [];
                       ...
                       query_hash =
                         (match next_hint with
                          | FStar_Pervasives_Native.None ->
                              FStar_Pervasives_Native.None
                          | FStar_Pervasives_Native.Some
                              { FStar_Util.hint_name = uu____3677;
                                FStar_Util.hint_index = uu____3678;
                                FStar_Util.fuel = uu____3679;
                                FStar_Util.ifuel = uu____3680;
                                FStar_Util.unsat_core = uu____3681;
                                FStar_Util.query_elapsed_time = uu____3682;
                                FStar_Util.hash = h;_}
                              -> h)
                     } in
             ...
             | (default_settings, next_hint) ->
                 let use_hints_setting =
                   match next_hint with
                   | FStar_Pervasives_Native.Some
                       { FStar_Util.hint_name = uu____3710;
                         FStar_Util.hint_index = uu____3711;
                         FStar_Util.fuel = i; FStar_Util.ifuel = j;
                         FStar_Util.unsat_core = FStar_Pervasives_Native.Some
                           core;
                         FStar_Util.query_elapsed_time = uu____3715;
                         FStar_Util.hash = h;_}
                       ->
                       [(let uu___451_3732 = default_settings in
                         {
                           query_env = (uu___451_3732.query_env);
                           query_decl = (uu___451_3732.query_decl);
                           query_name = (uu___451_3732.query_name);
                           query_index = (uu___451_3732.query_index);
                           query_range = (uu___451_3732.query_range);
                           query_fuel = i;
                           query_ifuel = j;
                           query_rlimit = (uu___451_3732.query_rlimit);
                           query_hint = (FStar_Pervasives_Native.Some core);
                           query_errors = (uu___451_3732.query_errors);
                           query_all_labels =
                             (uu___451_3732.query_all_labels);
                           query_suffix = (uu___451_3732.query_suffix);
                           query_hash = (uu___451_3732.query_hash)
                         })]
                   | uu____3736 -> [] in
                 let initial_fuel_max_ifuel =
                   let uu____3742 =
                     let uu____3744 = FStar_Options.max_ifuel () in
                     let uu____3746 = FStar_Options.initial_ifuel () in
                     uu____3744 > uu____3746 in
                   if uu____3742
                   then
                     let uu____3751 =
                       let uu___456_3752 = default_settings in
                       let uu____3753 = FStar_Options.max_ifuel () in
                       {
                         query_env = (uu___456_3752.query_env);
                         query_decl = (uu___456_3752.query_decl);
                         query_name = (uu___456_3752.query_name);
                         query_index = (uu___456_3752.query_index);
                         query_range = (uu___456_3752.query_range);
                         query_fuel = (uu___456_3752.query_fuel);
                         query_ifuel = uu____3753;
                         query_rlimit = (uu___456_3752.query_rlimit);
                         query_hint = (uu___456_3752.query_hint);
                         query_errors = (uu___456_3752.query_errors);
                         query_all_labels = (uu___456_3752.query_all_labels);
                         query_suffix = (uu___456_3752.query_suffix);
                         query_hash = (uu___456_3752.query_hash)
                       } in
                     [uu____3751]
                   else [] in
                 let half_max_fuel_max_ifuel =
                   let uu____3760 =
                     let uu____3762 =
                       let uu____3764 = FStar_Options.max_fuel () in
                       uu____3764 / (Prims.of_int (2)) in
                     let uu____3767 = FStar_Options.initial_fuel () in
                     uu____3762 > uu____3767 in
                   if uu____3760
                   then
                     let uu____3772 =
                       let uu___460_3773 = default_settings in
                       let uu____3774 =
                         let uu____3776 = FStar_Options.max_fuel () in
                         uu____3776 / (Prims.of_int (2)) in
                       let uu____3779 = FStar_Options.max_ifuel () in
                       {
                         query_env = (uu___460_3773.query_env);
                         query_decl = (uu___460_3773.query_decl);
                         query_name = (uu___460_3773.query_name);
                         query_index = (uu___460_3773.query_index);
                         query_range = (uu___460_3773.query_range);
                         query_fuel = uu____3774;
                         query_ifuel = uu____3779;
                         query_rlimit = (uu___460_3773.query_rlimit);
                         query_hint = (uu___460_3773.query_hint);
                         query_errors = (uu___460_3773.query_errors);
                         query_all_labels = (uu___460_3773.query_all_labels);
                         query_suffix = (uu___460_3773.query_suffix);
                         query_hash = (uu___460_3773.query_hash)
                       } in
                     [uu____3772]
                   else [] in
                 let max_fuel_max_ifuel =
                   let uu____3786 =
                     (let uu____3792 = FStar_Options.max_fuel () in
                      let uu____3794 = FStar_Options.initial_fuel () in
                      uu____3792 > uu____3794) &&
                       (let uu____3798 = FStar_Options.max_ifuel () in
                        let uu____3800 = FStar_Options.initial_ifuel () in
                        uu____3798 >= uu____3800) in
                   if uu____3786
                   then
                     let uu____3805 =
                       let uu___464_3806 = default_settings in
                       let uu____3807 = FStar_Options.max_fuel () in
                       let uu____3809 = FStar_Options.max_ifuel () in
                       {
                         query_env = (uu___464_3806.query_env);
                         query_decl = (uu___464_3806.query_decl);
                         query_name = (uu___464_3806.query_name);
                         query_index = (uu___464_3806.query_index);
                         query_range = (uu___464_3806.query_range);
                         query_fuel = uu____3807;
                         query_ifuel = uu____3809;
                         query_rlimit = (uu___464_3806.query_rlimit);
                         query_hint = (uu___464_3806.query_hint);
                         query_errors = (uu___464_3806.query_errors);
                         query_all_labels = (uu___464_3806.query_all_labels);
                         query_suffix = (uu___464_3806.query_suffix);
                         query_hash = (uu___464_3806.query_hash)
                       } in
                     [uu____3805]
                   else [] in
                 let min_fuel1 =
                   let uu____3816 =
                     let uu____3818 = FStar_Options.min_fuel () in
                     let uu____3820 = FStar_Options.initial_fuel () in
                     uu____3818 < uu____3820 in
                   if uu____3816
                   then
                     let uu____3825 =
                       let uu___468_3826 = default_settings in
                       let uu____3827 = FStar_Options.min_fuel () in
                       {
                         query_env = (uu___468_3826.query_env);
                         query_decl = (uu___468_3826.query_decl);
                         query_name = (uu___468_3826.query_name);
                         query_index = (uu___468_3826.query_index);
                         query_range = (uu___468_3826.query_range);
                         query_fuel = uu____3827;
                         query_ifuel = Prims.int_one;
                         query_rlimit = (uu___468_3826.query_rlimit);
                         query_hint = (uu___468_3826.query_hint);
                         query_errors = (uu___468_3826.query_errors);
                         query_all_labels = (uu___468_3826.query_all_labels);
                         query_suffix = (uu___468_3826.query_suffix);
                         query_hash = (uu___468_3826.query_hash)
                       } in
                     [uu____3825]
                   else [] in
                 let all_configs =
                 ...
                 let check_one_config config1 =
                   (let uu____3842 = FStar_Options.z3_refresh () in
                    if uu____3842
                    then FStar_SMTEncoding_Z3.refresh ()
                    else ());
                   (let uu____3847 = with_fuel_and_diagnostics config1 [] in
                    let uu____3850 =
                      let uu____3853 = FStar_SMTEncoding_Z3.mk_fresh_scope () in
                    ...
                    FStar_SMTEncoding_Z3.ask (settings_to_info config1)
                      ...
                      config1.query_hash config1.query_all_labels uu____3847
                      uu____3850 (used_hint config1)) in
                 ...
                 let quake_and_check_all_configs configs =
                   ...
                   let run_one seed1 =
                     let uu____3931 = FStar_Options.z3_refresh () in
                     if uu____3931
                     then
                   ...
                   let rec fold_nat' f acc lo2 hi2 =
                     ...
                     then acc
                       ...
                       (let uu____4004 = f acc lo2 in
                        fold_nat' f uu____4004 (lo2 + Prims.int_one) hi2) in
                   let best_fuel =
                     FStar_Util.mk_ref FStar_Pervasives_Native.None in
                   let best_ifuel =
                     FStar_Util.mk_ref FStar_Pervasives_Native.None in
                   let maybe_improve r n1 =
                     let uu____4127 = FStar_ST.op_Bang r in
                   ...
                   let uu____4215 =
                     fold_nat'
                            ...
                            | (nsucc, rs) ->
                                ...
                                ((let uu____4322 =
                                  ...
                                  then
                                    ...
                                    let uu____4328 =
                                      FStar_Util.string_of_int
                                        ((n1 + Prims.int_one) - nsucc1) in
                                    let uu____4331 =
                                      FStar_Util.string_of_int
                                        ((hi1 - Prims.int_one) - n1) in
                                    FStar_Util.print4
                       ...
                       Prims.int_zero (hi1 - Prims.int_one) in
                   ...
                   | (nsuccess, rs) ->
                       (if quaking
                        then
                          (let fuel_msg =
                             let uu____4394 =
                               let uu____4405 = FStar_ST.op_Bang best_fuel in
                               let uu____4434 = FStar_ST.op_Bang best_ifuel in
                               (uu____4405, uu____4434) in
                             match uu____4394 with
                             | (FStar_Pervasives_Native.Some f,
                                FStar_Pervasives_Native.Some i) ->
                                 let uu____4482 = FStar_Util.string_of_int f in
                                 let uu____4484 = FStar_Util.string_of_int i in
                                 FStar_Util.format2
                                   " (best fuel=%s, best ifuel=%s)"
                                   uu____4482 uu____4484
                             | (uu____4487, uu____4488) -> "" in
                           let uu____4502 = FStar_Util.string_of_int nsuccess in
                           let uu____4504 = FStar_Util.string_of_int hi1 in
                           FStar_Util.print4
                             "Quake: query %s succeeded %s/%s times%s\n" name
                             uu____4502 uu____4504 fuel_msg)
                        else ();
                        if nsuccess < lo1
                        then
                          (let all_errs =
                             FStar_List.concatMap
                               (fun uu___4_4525 ->
                                  match uu___4_4525 with
                                  | FStar_Util.Inr uu____4536 -> []
                                  | FStar_Util.Inl es -> [es]) rs in
                           let uu____4550 =
                             quaking &&
                               (let uu____4553 = FStar_Options.query_stats () in
                                Prims.op_Negation uu____4553) in
                           if uu____4550
                           then
                             let errors_to_report1 errs =
                               errors_to_report
                                 (let uu___548_4570 = default_settings in
                                  {
                                    query_env = (uu___548_4570.query_env);
                                    query_decl = (uu___548_4570.query_decl);
                                    query_name = (uu___548_4570.query_name);
                                    query_index = (uu___548_4570.query_index);
                                    query_range = (uu___548_4570.query_range);
                                    query_fuel = (uu___548_4570.query_fuel);
                                    query_ifuel = (uu___548_4570.query_ifuel);
                                    query_rlimit =
                                      (uu___548_4570.query_rlimit);
                                    query_hint = (uu___548_4570.query_hint);
                                    query_errors = errs;
                                    query_all_labels =
                                      (uu___548_4570.query_all_labels);
                                    query_suffix =
                                      (uu___548_4570.query_suffix);
                                    query_hash = (uu___548_4570.query_hash)
                                  }) in
                             let errs =
                             ...
                             let errs1 =
                               ...
                               FStar_All.pipe_right uu____4595 collect in
                             let errs2 =
                                               ...
                                               let uu____4724 =
                                                 let uu____4726 =
                                                   FStar_Util.string_of_int
                                                     n1 in
                                                 FStar_Util.format1
                                                   " (%s times)" uu____4726 in
                                               Prims.op_Hat m uu____4724 in
                                             (e, uu____4722, r)
                                           else (e, m, r))) in
                             (FStar_Errors.add_errors errs2;
                              (let rng =
                                 ...
                                 | uu____4754 -> FStar_Range.dummyRange in
                               let uu____4762 =
                                 let uu____4772 =
                                   let uu____4780 =
                                     let uu____4782 =
                                     ...
                                     FStar_Util.format4
                                       ...
                                       name uu____4782 uu____4784 uu____4786 in
                             ...
                             (let report1 errs =
                                report_errors
                                  (let uu___569_4818 = default_settings in
                                   {
                                     query_env = (uu___569_4818.query_env);
                                     query_decl = (uu___569_4818.query_decl);
                                     query_name = (uu___569_4818.query_name);
                                     query_index =
                                       (uu___569_4818.query_index);
                                     query_range =
                                       (uu___569_4818.query_range);
                                     query_fuel = (uu___569_4818.query_fuel);
                                     query_ifuel =
                                       (uu___569_4818.query_ifuel);
                                     query_rlimit =
                                       (uu___569_4818.query_rlimit);
                                     query_hint = (uu___569_4818.query_hint);
                                     query_errors = errs;
                                     query_all_labels =
                                       (uu___569_4818.query_all_labels);
                                     query_suffix =
                                       (uu___569_4818.query_suffix);
                                     query_hash = (uu___569_4818.query_hash)
                                   }) in
                              FStar_List.iter report1 all_errs))
                        else ()) in
                 let uu____4823 =
                   let uu____4832 = FStar_Options.admit_smt_queries () in
                   let uu____4834 = FStar_Options.admit_except () in
                   (uu____4832, uu____4834) in
                 (match uu____4823 with
                  ...
                  | (false, FStar_Pervasives_Native.Some id1) ->
                      let skip =
                        ...
                        then
                          let uu____4870 = full_query_id default_settings in
                          uu____4870 <> id1
...
let (get_cfg : FStar_TypeChecker_Env.env -> solver_cfg) =
  fun env ->
    let uu____5100 = FStar_Options.z3_seed () in
    let uu____5102 = FStar_Options.z3_cliopt () in
    let uu____5106 = FStar_Options.smtencoding_valid_intro () in
    let uu____5108 = FStar_Options.smtencoding_valid_elim () in
    {
      seed = uu____5100;
      cliopt = uu____5102;
      facts = (env.FStar_TypeChecker_Env.proof_ns);
      valid_intro = uu____5106;
      valid_elim = uu____5108
    }
let (save_cfg : FStar_TypeChecker_Env.env -> unit) =
  fun env ->
    let uu____5116 =
      let uu____5119 = get_cfg env in FStar_Pervasives_Native.Some uu____5119 in
    FStar_ST.op_Colon_Equals _last_cfg uu____5116
let (should_refresh : FStar_TypeChecker_Env.env -> Prims.bool) =
  fun env ->
    let uu____5150 = FStar_ST.op_Bang _last_cfg in
    match uu____5150 with
    | FStar_Pervasives_Native.None -> (save_cfg env; false)
    | FStar_Pervasives_Native.Some cfg ->
        let uu____5180 = let uu____5182 = get_cfg env in cfg = uu____5182 in
        Prims.op_Negation uu____5180
let (do_solve :
  ...
  fun use_env_msg ->
    fun tcenv ->
      fun q ->
        (let uu____5211 = should_refresh tcenv in
         if uu____5211
         then (save_cfg tcenv; FStar_SMTEncoding_Z3.refresh ())
         else ());
        (let uu____5218 =
           let uu____5220 =
             let uu____5222 = FStar_TypeChecker_Env.get_range tcenv in
             FStar_All.pipe_left FStar_Range.string_of_range uu____5222 in
           FStar_Util.format1 "Starting query at %s" uu____5220 in
         FStar_SMTEncoding_Encode.push uu____5218);
        (let pop1 uu____5230 =
           let uu____5231 =
             let uu____5233 =
               let uu____5235 = FStar_TypeChecker_Env.get_range tcenv in
               FStar_All.pipe_left FStar_Range.string_of_range uu____5235 in
             FStar_Util.format1 "Ending query at %s" uu____5233 in
           FStar_SMTEncoding_Encode.pop uu____5231 in
         try
           (fun uu___616_5251 ->
              match () with
              | () ->
                        ...
                        | FStar_SMTEncoding_Term.Assume
                            {
                              FStar_SMTEncoding_Term.assumption_term =
                                {
                                  ...
                                  FStar_SMTEncoding_Term.freevars =
                                    uu____5285;
                                  FStar_SMTEncoding_Term.rng = uu____5286;_};
                              ...
                              FStar_SMTEncoding_Term.assumption_fact_ids =
                                uu____5289;_}
                            -> pop1 ()
                        | uu____5309 when tcenv1.FStar_TypeChecker_Env.admit
                            -> pop1 ()
                        | FStar_SMTEncoding_Term.Assume uu____5310 ->
                            (ask_and_report_errors tcenv1 labels prefix1 qry
                               suffix;
                             pop1 ())
                        | uu____5312 -> failwith "Impossible"))) ()
         with
              ...
              (let uu____5328 =
                 let uu____5338 =
                   let uu____5346 =
                     let uu____5348 =
                       let uu____5350 =
                         FStar_List.map FStar_Pervasives_Native.fst names1 in
                       FStar_String.concat "," uu____5350 in
                     FStar_Util.format1
                   ...
                   (FStar_Errors.Error_NonTopRecFunctionNotFullyEncoded,
                     uu____5346, (tcenv.FStar_TypeChecker_Env.range)) in
                 [uu____5338] in
               FStar_TypeChecker_Err.add_errors tcenv uu____5328)))
let (solve :
  (unit -> Prims.string) FStar_Pervasives_Native.option ->
    FStar_TypeChecker_Env.env -> FStar_Syntax_Syntax.term -> unit)
  =
  fun use_env_msg ->
    fun tcenv ->
      fun q ->
        let uu____5405 = FStar_Options.no_smt () in
        if uu____5405
        then
          let uu____5408 =
            let uu____5418 =
              let uu____5426 =
                let uu____5428 = FStar_Syntax_Print.term_to_string q in
                FStar_Util.format1
                  "Q = %s\nA query could not be solved internally, and --no_smt was given"
                  uu____5428 in
              (FStar_Errors.Error_NoSMTButNeeded, uu____5426,
                (tcenv.FStar_TypeChecker_Env.range)) in
            [uu____5418] in
          FStar_TypeChecker_Err.add_errors tcenv uu____5408
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____5460 =
             let uu____5467 = FStar_Options.peek () in (e, g, uu____5467) in
           [uu____5460]);
...
let (dummy : FStar_TypeChecker_Env.solver_t) =
  {
    FStar_TypeChecker_Env.init = (fun uu____5483 -> ());
    FStar_TypeChecker_Env.push = (fun uu____5485 -> ());
    FStar_TypeChecker_Env.pop = (fun uu____5488 -> ());
    FStar_TypeChecker_Env.snapshot =
      (fun uu____5491 ->
         ((Prims.int_zero, Prims.int_zero, Prims.int_zero), ()));
    FStar_TypeChecker_Env.rollback = (fun uu____5510 -> fun uu____5511 -> ());
    FStar_TypeChecker_Env.encode_sig =
      (fun uu____5526 -> fun uu____5527 -> ());
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____5533 =
             let uu____5540 = FStar_Options.peek () in (e, g, uu____5540) in
           [uu____5533]);
    FStar_TypeChecker_Env.solve =
      (fun uu____5556 -> fun uu____5557 -> fun uu____5558 -> ());
    FStar_TypeChecker_Env.finish = (fun uu____5565 -> ());
    FStar_TypeChecker_Env.refresh = (fun uu____5567 -> ())
  }