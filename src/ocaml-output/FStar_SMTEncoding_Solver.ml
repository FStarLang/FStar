         ...
         (FStar_List.iter
            (fun s  ->
               ...
               | FStar_Util.Inr _error ->
                   let _0_338 = FStar_Range.string_of_range s.source_location
                      in
    ...
    fun res  ->
      fun time  ->
        fun r  ->
          ...
          let _0_340 = let _0_339 = FStar_ST.read hint_stats  in s :: _0_339
             in
                           ...
                           (let _0_396 =
                              let _0_395 =
                                let uu____571 =
                                  ...
                                  let _0_366 = FStar_Options.initial_ifuel ()
                                     in
                                  _0_367 > _0_366  in
                                if uu____571
                                then
                                  let _0_370 =
                                    ...
                                    let _0_368 = FStar_Options.max_ifuel ()
                                       in
                              ...
                              let _0_394 =
                                let _0_393 =
                                  let uu____590 =
                                    let _0_373 =
                                      let _0_371 = FStar_Options.max_fuel ()
                                         in
                                  ...
                                  then
                                    let _0_377 =
                                      ...
                                      let _0_375 = FStar_Options.max_ifuel ()
                                         in
                                ...
                                let _0_392 =
                                  let _0_391 =
                                    let uu____609 =
                                      (let _0_379 = FStar_Options.max_fuel ()
                                          in
                                       let _0_378 =
                                         FStar_Options.initial_fuel ()  in
                                       _0_379 > _0_378) &&
                         ...
                         let errs =
                           ...
                           then
                             let uu____656 =
                               ...
                               | None  ->
                                   let _0_399 =
                                     let _0_398 = FStar_Options.min_fuel ()
                                        in
                                     (_0_398, (Prims.parse_int "1"), rlimit)
                                      in
                                   (_0_399, errs)
                                in
                            ...
                            FStar_All.pipe_right (Prims.fst errs)
                              (FStar_List.map
                                 (fun uu____892  ->
                                    ...
                                    | (uu____898,x,y) -> (x, y)))
                             in
                          FStar_TypeChecker_Err.add_errors env _0_407)
                          in
                          ...
                          | (mi::tl,uu____1030) ->
                              ...
                              FStar_SMTEncoding_Z3.ask None all_labels _0_411
                                (fun uu____1046  ->
                                   ...
                                   | (result,elapsed_time) ->
                                       let _0_410 =
                                         let _0_409 = use_errors errs result
                                            in
             ...
             let pop uu____1214 =
               FStar_SMTEncoding_Encode.pop
                 (let _0_434 =
                    ...
                    FStar_All.pipe_left FStar_Range.string_of_range _0_433
                     in
                  FStar_Util.format1 "Ending query at %s" _0_434)
                in
             (match qry with
              | FStar_SMTEncoding_Term.Assume
                  ({
