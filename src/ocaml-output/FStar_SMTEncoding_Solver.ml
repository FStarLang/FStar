         ...
         (FStar_List.iter
            (fun s  ->
               ...
               | FStar_Util.Inl _unsat_core ->
                   let _0_354 = FStar_Range.string_of_range s.source_location
                      in
               ...
               | FStar_Util.Inr _error ->
                   let _0_356 = FStar_Range.string_of_range s.source_location
                      in
    ...
    fun res  ->
      fun time  ->
        fun r  ->
          ...
          let _0_358 = let _0_357 = FStar_ST.read hint_stats  in s :: _0_357
             in
                           ...
                           (let _0_414 =
                              let _0_413 =
                                let uu____571 =
                                  ...
                                  let _0_384 = FStar_Options.initial_ifuel ()
                                     in
                                  _0_385 > _0_384  in
                                if uu____571
                                then
                                  let _0_388 =
                                    ...
                                    let _0_386 = FStar_Options.max_ifuel ()
                                       in
                              ...
                              let _0_412 =
                                let _0_411 =
                                  let uu____590 =
                                    let _0_391 =
                                      let _0_389 = FStar_Options.max_fuel ()
                                         in
                                ...
                                let _0_410 =
                                  let _0_409 =
                                    let uu____609 =
                                      (let _0_397 = FStar_Options.max_fuel ()
                                          in
                                       let _0_396 =
                                         FStar_Options.initial_fuel ()  in
                                       _0_397 > _0_396) &&
                         ...
                         let errs =
                           ...
                           then
                             let uu____656 =
                               ...
                               | None  ->
                                   let _0_417 =
                                     let _0_416 = FStar_Options.min_fuel ()
                                        in
                                     (_0_416, (Prims.parse_int "1"), rlimit)
                                      in
                                   (_0_417, errs)
                                in
                            ...
                            FStar_All.pipe_right (Prims.fst errs)
                              (FStar_List.map
                                 (fun uu____892  ->
                                    ...
                                    | (uu____898,x,y) -> (x, y)))
                             in
                          FStar_TypeChecker_Err.add_errors env _0_425)
                          in
                          ...
                          | (mi::tl,uu____1030) ->
                              ...
                              FStar_SMTEncoding_Z3.ask None all_labels _0_429
                                (fun uu____1046  ->
                                   ...
                                   | (result,elapsed_time) ->
                                       let _0_428 =
                                         let _0_427 = use_errors errs result
                                            in
             ...
             let pop uu____1214 =
               FStar_SMTEncoding_Encode.pop
                 (let _0_452 =
                    ...
                    FStar_All.pipe_left FStar_Range.string_of_range _0_451
                     in
                  FStar_Util.format1 "Ending query at %s" _0_452)
                in
             (match qry with
              | FStar_SMTEncoding_Term.Assume
                  ({
...
let lean_solver : FStar_TypeChecker_Env.solver_t =
  {
    FStar_TypeChecker_Env.init =
      (fun uu____1238  -> FStar_Util.print_endline "LEAN INIT");
    FStar_TypeChecker_Env.push = (fun uu____1240  -> ());
    FStar_TypeChecker_Env.pop = (fun uu____1241  -> ());
    FStar_TypeChecker_Env.mark = (fun uu____1242  -> ());
    FStar_TypeChecker_Env.reset_mark = (fun uu____1243  -> ());
    FStar_TypeChecker_Env.commit_mark = (fun uu____1244  -> ());
    FStar_TypeChecker_Env.encode_modul =
      (fun uu____1245  -> fun uu____1246  -> ());
    FStar_TypeChecker_Env.encode_sig =
      (fun uu____1247  -> fun uu____1248  -> ());
    FStar_TypeChecker_Env.solve =
      (fun uu____1249  -> fun uu____1250  -> fun uu____1251  -> ());
    FStar_TypeChecker_Env.is_trivial =
      (fun uu____1255  -> fun uu____1256  -> false);
    FStar_TypeChecker_Env.finish = (fun uu____1257  -> ());
    FStar_TypeChecker_Env.refresh = (fun uu____1258  -> ())
  } 
let dummy : FStar_TypeChecker_Env.solver_t =
  {
    FStar_TypeChecker_Env.init = (fun uu____1259  -> ());
    FStar_TypeChecker_Env.push = (fun uu____1260  -> ());
    FStar_TypeChecker_Env.pop = (fun uu____1261  -> ());
    FStar_TypeChecker_Env.mark = (fun uu____1262  -> ());
    FStar_TypeChecker_Env.reset_mark = (fun uu____1263  -> ());
    FStar_TypeChecker_Env.commit_mark = (fun uu____1264  -> ());
    FStar_TypeChecker_Env.encode_modul =
      (fun uu____1265  -> fun uu____1266  -> ());
    FStar_TypeChecker_Env.encode_sig =
      (fun uu____1267  -> fun uu____1268  -> ());
    FStar_TypeChecker_Env.solve =
      (fun uu____1269  -> fun uu____1270  -> fun uu____1271  -> ());
    FStar_TypeChecker_Env.is_trivial =
      (fun uu____1275  -> fun uu____1276  -> false);
    FStar_TypeChecker_Env.finish = (fun uu____1277  -> ());
    FStar_TypeChecker_Env.refresh = (fun uu____1278  -> ())
  } 