             ...
             | (default_settings, next_hint) ->
                 ...
                 let check_one_config config k =
                   ...
                   (let uu____2134 = with_fuel_and_diagnostics config [] in
                    let uu____2137 =
                      let uu____2140 = FStar_SMTEncoding_Z3.mk_fresh_scope () in
           ...
           (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv in
            ...
            | (prefix1, labels, qry, suffix) ->
                let pop1 uu____2280 =
                  let uu____2281 =
                    let uu____2282 =
                      let uu____2283 = FStar_TypeChecker_Env.get_range tcenv1 in
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____2313 =
             let uu____2320 = FStar_Options.peek () in (e, g, uu____2320) in
           [uu____2313]);
...
let (dummy : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____2353 =
             let uu____2360 = FStar_Options.peek () in (e, g, uu____2360) in
           [uu____2353]);
