...
let query_errors:
  ...
  fun settings  ->
    fun z3result  ->
      ...
      | FStar_SMTEncoding_Z3.UNSAT uu____1481 -> FStar_Pervasives_Native.None
      | uu____1482 ->
          let uu____1483 =
           ...
           | (msg,error_labels) ->
               let err1 =
                 let uu____1493 =
                   FStar_List.map
                     (fun uu____1514  ->
                        match uu____1514 with | (uu____1525,x,y) -> (x, y))
                     error_labels in
                 {
                   error_reason = msg;
...
let detail_hint_replay:
  ...
  fun settings  ->
    fun z3result  ->
      ...
      then
        match z3result.FStar_SMTEncoding_Z3.z3result_status with
        | FStar_SMTEncoding_Z3.UNSAT uu____1537 -> ()
        | _failed ->
            let ask_z3 label_assumptions =
              ...
              (let uu____1555 =
               ...
               FStar_SMTEncoding_Z3.ask
                 ...
                 settings.query_all_labels uu____1555
                 FStar_Pervasives_Native.None
                 (fun r  ->
                    FStar_ST.op_Colon_Equals res
                      (FStar_Pervasives_Native.Some r)));
              (let uu____1626 = FStar_ST.op_Bang res in
               FStar_Option.get uu____1626) in
...
let find_localized_errors:
  ...
  fun errs  ->
    FStar_All.pipe_right errs
      (FStar_List.tryFind
         (fun err1  ->
            match err1.error_messages with | [] -> false | uu____1714 -> true))
let has_localized_errors: errors Prims.list -> Prims.bool =
  fun errs  ->
    let uu____1729 = find_localized_errors errs in
    FStar_Option.isSome uu____1729
let report_errors: query_settings -> Prims.unit =
  fun settings  ->
    let uu____1736 =
      (FStar_Options.detail_errors ()) &&
        (let uu____1738 = FStar_Options.n_cores () in
         uu____1738 = (Prims.parse_int "1")) in
    if uu____1736
    then
      let initial_fuel1 =
        let uu___89_1740 = settings in
        let uu____1741 = FStar_Options.initial_fuel () in
        let uu____1742 = FStar_Options.initial_ifuel () in
        {
          query_env = (uu___89_1740.query_env);
          query_decl = (uu___89_1740.query_decl);
          query_name = (uu___89_1740.query_name);
          query_index = (uu___89_1740.query_index);
          query_range = (uu___89_1740.query_range);
          query_fuel = uu____1741;
          query_ifuel = uu____1742;
          query_rlimit = (uu___89_1740.query_rlimit);
          query_hint = FStar_Pervasives_Native.None;
          query_errors = (uu___89_1740.query_errors);
          query_all_labels = (uu___89_1740.query_all_labels);
          query_suffix = (uu___89_1740.query_suffix);
          query_hash = (uu___89_1740.query_hash)
        } in
      let ask_z3 label_assumptions =
        let res = FStar_Util.mk_ref FStar_Pervasives_Native.None in
        (let uu____1761 =
         ...
         FStar_SMTEncoding_Z3.ask
           ...
           settings.query_all_labels uu____1761 FStar_Pervasives_Native.None
           (fun r  ->
              FStar_ST.op_Colon_Equals res (FStar_Pervasives_Native.Some r)));
        (let uu____1838 = FStar_ST.op_Bang res in FStar_Option.get uu____1838) in
      FStar_SMTEncoding_ErrorReporting.detail_errors false settings.query_env
        settings.query_all_labels ask_z3
    else
      (let uu____1906 = find_localized_errors settings.query_errors in
       ...
       | FStar_Pervasives_Native.Some err1 ->
           (FStar_All.pipe_right settings.query_errors
              (FStar_List.iter
                 (fun e  ->
                    let uu____1916 =
                      let uu____1917 = error_to_short_string e in
                      Prims.strcat "SMT solver says: " uu____1917 in
                    FStar_Errors.diag settings.query_range uu____1916));
           ...
           let err_detail =
             let uu____1919 =
               FStar_All.pipe_right settings.query_errors
                 (FStar_List.map
                    (fun e  ->
                       let uu____1929 = error_to_short_string e in
                       Prims.strcat "SMT solver says: " uu____1929)) in
             ...
             let uu____1939 =
               let uu____1944 =
                 FStar_Util.format1 "Unknown assertion failed (%s)"
                   err_detail in
               (uu____1944, (settings.query_range)) in
             [uu____1939] in
           FStar_TypeChecker_Err.add_errors settings.query_env uu____1932)
    ...
    fun z3result  ->
      ...
      then
        ...
        | (status_string,errs) ->
            let tag =
              match z3result.FStar_SMTEncoding_Z3.z3result_status with
              | FStar_SMTEncoding_Z3.UNSAT uu____1970 -> "succeeded"
              | uu____1971 ->
            ...
            let range =
              let uu____1973 =
                ...
                let uu____1975 =
                  let uu____1976 = FStar_SMTEncoding_Z3.at_log_file () in
                  Prims.strcat uu____1976 ")" in
                Prims.strcat uu____1974 uu____1975 in
              Prims.strcat "(" uu____1973 in
            let used_hint_tag =
              if used_hint settings then " (with hint)" else "" in
            let stats =
              let uu____1980 = FStar_Options.print_z3_statistics () in
              if uu____1980
              then
                let f k v1 a =
                  Prims.strcat a
                  ...
                  let uu____2001 =
                    ...
                    let uu____2005 =
                      let uu____2008 =
                        ...
                        used_hint_tag :: uu____2011 in
                      tag :: uu____2008 in
                    uu____2004 :: uu____2005 in
                  (settings.query_name) :: uu____2001 in
                range :: uu____1998 in
              FStar_Util.print
               ...
               (FStar_List.iter
                  (fun uu____2040  ->
                     ...
                     | (uu____2047,msg,range1) ->
                         ...
                         let uu____2053 = FStar_Errors.format_issue e in
...
let record_hint:
  ...
  fun settings  ->
    fun z3result  ->
      let uu____2063 =
        let uu____2064 = FStar_Options.record_hints () in
        ...
        (let mk_hint core =
           {
             ...
             FStar_Util.hash =
               (match z3result.FStar_SMTEncoding_Z3.z3result_status with
                ...
                | uu____2082 -> FStar_Pervasives_Native.None)
           } in
         let store_hint hint =
           let uu____2087 = FStar_ST.op_Bang recorded_hints in
...
let process_result:
  ...
  fun settings  ->
    fun result  ->
      (let uu____2223 =
         (used_hint settings) &&
           (let uu____2225 = FStar_Options.z3_refresh () in
            Prims.op_Negation uu____2225) in
       if uu____2223 then FStar_SMTEncoding_Z3.refresh () else ());
        ...
        fun query  ->
          fun suffix  ->
            ...
            (let default_settings =
               ...
               | (qname,index1) ->
                   let rlimit =
                     let uu____2375 = FStar_Options.z3_rlimit_factor () in
                     let uu____2376 =
                       let uu____2377 = FStar_Options.z3_rlimit () in
                       uu____2377 * (Prims.parse_int "544656") in
                     uu____2375 * uu____2376 in
                   let uu____2378 = FStar_TypeChecker_Env.get_range env in
                   let uu____2379 = FStar_Options.initial_fuel () in
                   let uu____2380 = FStar_Options.initial_ifuel () in
                   {
                     query_env = env;
                     query_decl = query;
                     query_name = qname;
                     query_index = index1;
                     query_range = uu____2378;
                     query_fuel = uu____2379;
                     query_ifuel = uu____2380;
                     query_rlimit = rlimit;
                     query_hint = FStar_Pervasives_Native.None;
                     query_errors = [];
             ...
             let use_hints_setting =
               let uu____2386 = next_hint default_settings in
               match uu____2386 with
               | FStar_Pervasives_Native.Some
                   { FStar_Util.hint_name = uu____2391;
                     FStar_Util.hint_index = uu____2392; FStar_Util.fuel = i;
                     FStar_Util.ifuel = j;
                     FStar_Util.unsat_core = FStar_Pervasives_Native.Some
                       core;
                     FStar_Util.query_elapsed_time = uu____2396;
                     FStar_Util.hash = h;_}
                   ->
                   [(let uu___90_2405 = default_settings in
                     {
                       query_env = (uu___90_2405.query_env);
                       query_decl = (uu___90_2405.query_decl);
                       query_name = (uu___90_2405.query_name);
                       query_index = (uu___90_2405.query_index);
                       query_range = (uu___90_2405.query_range);
                       query_fuel = i;
                       query_ifuel = j;
                       query_rlimit = (uu___90_2405.query_rlimit);
                       query_hint = (FStar_Pervasives_Native.Some core);
                       query_errors = (uu___90_2405.query_errors);
                       query_all_labels = (uu___90_2405.query_all_labels);
                       query_suffix = (uu___90_2405.query_suffix);
                       query_hash = h
                     })]
               | uu____2408 -> [] in
             let initial_fuel_max_ifuel =
               let uu____2414 =
                 let uu____2415 = FStar_Options.max_ifuel () in
                 let uu____2416 = FStar_Options.initial_ifuel () in
                 uu____2415 > uu____2416 in
               if uu____2414
               then
                 let uu____2419 =
                   let uu___91_2420 = default_settings in
                   let uu____2421 = FStar_Options.max_ifuel () in
                   {
                     query_env = (uu___91_2420.query_env);
                     query_decl = (uu___91_2420.query_decl);
                     query_name = (uu___91_2420.query_name);
                     query_index = (uu___91_2420.query_index);
                     query_range = (uu___91_2420.query_range);
                     query_fuel = (uu___91_2420.query_fuel);
                     query_ifuel = uu____2421;
                     query_rlimit = (uu___91_2420.query_rlimit);
                     query_hint = (uu___91_2420.query_hint);
                     query_errors = (uu___91_2420.query_errors);
                     query_all_labels = (uu___91_2420.query_all_labels);
                     query_suffix = (uu___91_2420.query_suffix);
                     query_hash = (uu___91_2420.query_hash)
                   } in
                 [uu____2419]
               else [] in
             let half_max_fuel_max_ifuel =
               let uu____2426 =
                 let uu____2427 =
                   ...
                   uu____2428 / (Prims.parse_int "2") in
                 let uu____2435 = FStar_Options.initial_fuel () in
                 uu____2427 > uu____2435 in
               if uu____2426
               then
                 let uu____2438 =
                   let uu___92_2439 = default_settings in
                   let uu____2440 =
                     let uu____2441 = FStar_Options.max_fuel () in
                     uu____2441 / (Prims.parse_int "2") in
                   let uu____2448 = FStar_Options.max_ifuel () in
                   {
                     query_env = (uu___92_2439.query_env);
                     query_decl = (uu___92_2439.query_decl);
                     query_name = (uu___92_2439.query_name);
                     query_index = (uu___92_2439.query_index);
                     query_range = (uu___92_2439.query_range);
                     query_fuel = uu____2440;
                     query_ifuel = uu____2448;
                     query_rlimit = (uu___92_2439.query_rlimit);
                     query_hint = (uu___92_2439.query_hint);
                     query_errors = (uu___92_2439.query_errors);
                     query_all_labels = (uu___92_2439.query_all_labels);
                     query_suffix = (uu___92_2439.query_suffix);
                     query_hash = (uu___92_2439.query_hash)
                   } in
                 [uu____2438]
               else [] in
             let max_fuel_max_ifuel =
               let uu____2453 =
                 (let uu____2458 = FStar_Options.max_fuel () in
                  let uu____2459 = FStar_Options.initial_fuel () in
                  uu____2458 > uu____2459) &&
                   (let uu____2462 = FStar_Options.max_ifuel () in
                    let uu____2463 = FStar_Options.initial_ifuel () in
                    uu____2462 >= uu____2463) in
               if uu____2453
               then
                 let uu____2466 =
                   let uu___93_2467 = default_settings in
                   let uu____2468 = FStar_Options.max_fuel () in
                   let uu____2469 = FStar_Options.max_ifuel () in
                   {
                     query_env = (uu___93_2467.query_env);
                     query_decl = (uu___93_2467.query_decl);
                     query_name = (uu___93_2467.query_name);
                     query_index = (uu___93_2467.query_index);
                     query_range = (uu___93_2467.query_range);
                     query_fuel = uu____2468;
                     query_ifuel = uu____2469;
                     query_rlimit = (uu___93_2467.query_rlimit);
                     query_hint = (uu___93_2467.query_hint);
                     query_errors = (uu___93_2467.query_errors);
                     query_all_labels = (uu___93_2467.query_all_labels);
                     query_suffix = (uu___93_2467.query_suffix);
                     query_hash = (uu___93_2467.query_hash)
                   } in
                 [uu____2466]
               else [] in
             let min_fuel1 =
               let uu____2474 =
                 let uu____2475 = FStar_Options.min_fuel () in
                 let uu____2476 = FStar_Options.initial_fuel () in
                 uu____2475 < uu____2476 in
               if uu____2474
               then
                 let uu____2479 =
                   let uu___94_2480 = default_settings in
                   let uu____2481 = FStar_Options.min_fuel () in
                   {
                     query_env = (uu___94_2480.query_env);
                     query_decl = (uu___94_2480.query_decl);
                     query_name = (uu___94_2480.query_name);
                     query_index = (uu___94_2480.query_index);
                     query_range = (uu___94_2480.query_range);
                     query_fuel = uu____2481;
                     query_ifuel = (Prims.parse_int "1");
                     query_rlimit = (uu___94_2480.query_rlimit);
                     query_hint = (uu___94_2480.query_hint);
                     query_errors = (uu___94_2480.query_errors);
                     query_all_labels = (uu___94_2480.query_all_labels);
                     query_suffix = (uu___94_2480.query_suffix);
                     query_hash = (uu___94_2480.query_hash)
                   } in
                 [uu____2479]
               else [] in
             let all_configs =
             ...
             let check_one_config config k =
               (let uu____2499 =
                ...
                if uu____2499 then FStar_SMTEncoding_Z3.refresh () else ());
               (let uu____2501 = with_fuel_and_diagnostics config [] in
                let uu____2504 =
                  let uu____2507 = FStar_SMTEncoding_Z3.mk_fresh_scope () in
                ...
                FStar_SMTEncoding_Z3.ask
                  ...
                  config.query_all_labels uu____2501 uu____2504 k) in
             let check_all_configs configs =
               let report1 errs =
                 report_errors
                   (let uu___95_2528 = default_settings in
                    {
                      query_env = (uu___95_2528.query_env);
                      query_decl = (uu___95_2528.query_decl);
                      query_name = (uu___95_2528.query_name);
                      query_index = (uu___95_2528.query_index);
                      query_range = (uu___95_2528.query_range);
                      query_fuel = (uu___95_2528.query_fuel);
                      query_ifuel = (uu___95_2528.query_ifuel);
                      query_rlimit = (uu___95_2528.query_rlimit);
                      query_hint = (uu___95_2528.query_hint);
                      query_errors = errs;
                      query_all_labels = (uu___95_2528.query_all_labels);
                      query_suffix = (uu___95_2528.query_suffix);
                      query_hash = (uu___95_2528.query_hash)
                    }) in
               fold_queries configs check_one_config process_result report1 in
             let uu____2529 =
               let uu____2536 = FStar_Options.admit_smt_queries () in
               let uu____2537 = FStar_Options.admit_except () in
                   ...
                   then
                     let full_query_id =
                       let uu____2554 =
                         ...
                         Prims.strcat default_settings.query_name uu____2555 in
                       Prims.strcat "(" uu____2554 in
                     full_query_id <> id
  ...
  fun use_env_msg  ->
    fun tcenv  ->
      fun q  ->
        (let uu____2582 =
           let uu____2583 =
             let uu____2584 = FStar_TypeChecker_Env.get_range tcenv in
             FStar_All.pipe_left FStar_Range.string_of_range uu____2584 in
           FStar_Util.format1 "Starting query at %s" uu____2583 in
         FStar_SMTEncoding_Encode.push uu____2582);
        (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv in
         ...
         | (prefix1,labels,qry,suffix) ->
             let pop1 uu____2620 =
               let uu____2621 =
                 let uu____2622 =
                   let uu____2623 = FStar_TypeChecker_Env.get_range tcenv1 in
                   FStar_All.pipe_left FStar_Range.string_of_range uu____2623 in
                 FStar_Util.format1 "Ending query at %s" uu____2622 in
               FStar_SMTEncoding_Encode.pop uu____2621 in
             (match qry with
                    ...
                    FStar_SMTEncoding_Term.assumption_term =
                      {
                        FStar_SMTEncoding_Term.tm =
                          ...
                          (FStar_SMTEncoding_Term.FalseOp ,uu____2624);
                        FStar_SMTEncoding_Term.freevars = uu____2625;
                        FStar_SMTEncoding_Term.rng = uu____2626;_};
                    FStar_SMTEncoding_Term.assumption_caption = uu____2627;
                    FStar_SMTEncoding_Term.assumption_name = uu____2628;
                    FStar_SMTEncoding_Term.assumption_fact_ids = uu____2629;_}
                  -> pop1 ()
              | uu____2644 when tcenv1.FStar_TypeChecker_Env.admit -> pop1 ()
              | FStar_SMTEncoding_Term.Assume uu____2645 ->
                  (ask_and_report_errors tcenv1 labels prefix1 qry suffix;
                   pop1 ())
              | uu____2647 -> failwith "Impossible"))
let solver: FStar_TypeChecker_Env.solver_t =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2653 =
             let uu____2660 = FStar_Options.peek () in (e, g, uu____2660) in
           [uu____2653]);
...
let dummy: FStar_TypeChecker_Env.solver_t =
  {
    FStar_TypeChecker_Env.init = (fun uu____2675  -> ());
    FStar_TypeChecker_Env.push = (fun uu____2677  -> ());
    FStar_TypeChecker_Env.pop = (fun uu____2679  -> ());
    FStar_TypeChecker_Env.encode_modul =
      (fun uu____2682  -> fun uu____2683  -> ());
    FStar_TypeChecker_Env.encode_sig =
      (fun uu____2686  -> fun uu____2687  -> ());
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2693 =
             let uu____2700 = FStar_Options.peek () in (e, g, uu____2700) in
           [uu____2693]);
    FStar_TypeChecker_Env.solve =
      (fun uu____2716  -> fun uu____2717  -> fun uu____2718  -> ());
    FStar_TypeChecker_Env.is_trivial =
      (fun uu____2725  -> fun uu____2726  -> false);
    FStar_TypeChecker_Env.finish = (fun uu____2728  -> ());
    FStar_TypeChecker_Env.refresh = (fun uu____2730  -> ())
  }