...
in (match (qry) with
| FStar_SMTEncoding_Term.Assume ({FStar_SMTEncoding_Term.tm = FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.False, _91_270); FStar_SMTEncoding_Term.freevars = _91_267}, _91_275, _91_277) -> begin
(

let _91_280 = (pop ())
in ())
end
| _91_283 when tcenv.FStar_TypeChecker_Env.admit -> begin
(

let _91_284 = (pop ())
in ())
end
| FStar_SMTEncoding_Term.Assume (q, _91_288, _91_290) -> begin
(

let _91_293 = (ask_and_report_errors tcenv labels prefix qry suffix)
in (pop ()))
end
| _91_296 -> begin
...
let dummy : FStar_TypeChecker_Env.solver_t = {FStar_TypeChecker_Env.init = (fun _91_297 -> ()); FStar_TypeChecker_Env.push = (fun _91_299 -> ()); FStar_TypeChecker_Env.pop = (fun _91_301 -> ()); FStar_TypeChecker_Env.mark = (fun _91_303 -> ()); FStar_TypeChecker_Env.reset_mark = (fun _91_305 -> ()); FStar_TypeChecker_Env.commit_mark = (fun _91_307 -> ()); FStar_TypeChecker_Env.encode_modul = (fun _91_309 _91_311 -> ()); FStar_TypeChecker_Env.encode_sig = (fun _91_313 _91_315 -> ()); FStar_TypeChecker_Env.solve = (fun _91_317 _91_319 _91_321 -> ()); FStar_TypeChecker_Env.is_trivial = (fun _91_323 _91_325 -> false); FStar_TypeChecker_Env.finish = (fun _91_327 -> ()); FStar_TypeChecker_Env.refresh = (fun _91_328 -> ())}
