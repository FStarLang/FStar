      ...
      let uu____1737 =
        let uu____1740 =
          let uu____1741 =
            ...
            FStar_Util.format2 "<fuel='%s' ifuel='%s'>" uu____1743 uu____1745 in
        ...
        | _failed ->
            let ask_z3 label_assumptions =
              ...
              (let uu____2053 = FStar_ST.op_Bang res in
               FStar_Option.get uu____2053) in
             ...
             FStar_All.pipe_right settings.query_errors
               (FStar_List.map
                  (fun e ->
                     ...
                     Prims.op_Hat "SMT solver says: " uu____2171)) in
    ...
    (let uu____2215 =
       (FStar_Options.detail_errors ()) &&
         (let uu____2218 = FStar_Options.n_cores () in
          uu____2218 = (Prims.parse_int "1")) in
     if uu____2215
     then
       let initial_fuel1 =
       ...
       let ask_z3 label_assumptions =
         ...
         (let uu____2279 = FStar_ST.op_Bang res in
          FStar_Option.get uu____2279) in
                 ...
                 let parse_axiom_name s =
                   ...
                   | FStar_Pervasives_Native.Some first_upper_index1 ->
                       ...
                       let components1 =
                         ...
                         | [] -> []
                         | uu____2743 ->
                             let uu____2747 = FStar_Util.prefix components in
                             (match uu____2747 with
                              | (module_name, last1) ->
                                  let components1 =
                                    let uu____2774 = exclude_suffix last1 in
                                    FStar_List.append module_name uu____2774 in
             ...
             | (tag, core) ->
                 let range =
                   let uu____2905 =
                     ...
                     Prims.op_Hat uu____2907 (Prims.op_Hat at_log_file ")") in
             ...
             | (default_settings, next_hint) ->
                 ...
                 let check_one_config config1 k =
                   ...
                   (let uu____3632 = with_fuel_and_diagnostics config1 [] in
                    let uu____3635 =
                      let uu____3638 = FStar_SMTEncoding_Z3.mk_fresh_scope () in
                    ...
                    FStar_SMTEncoding_Z3.ask (settings_to_info config1)
                      ...
                      uu____3635 k (used_hint config1)) in
           ...
           (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv in
            ...
            | (prefix1, labels, qry, suffix) ->
                let pop1 uu____3844 =
                  let uu____3845 =
                    let uu____3847 =
                      let uu____3849 = FStar_TypeChecker_Env.get_range tcenv1 in
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____3888 =
             let uu____3895 = FStar_Options.peek () in (e, g, uu____3895) in
           [uu____3888]);
...
let (dummy : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.snapshot =
      (fun uu____3919 ->
         (((Prims.parse_int "0"), (Prims.parse_int "0"),
            (Prims.parse_int "0")), ()));
    FStar_TypeChecker_Env.rollback = (fun uu____3938 -> fun uu____3939 -> ());
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____3961 =
             let uu____3968 = FStar_Options.peek () in (e, g, uu____3968) in
           [uu____3961]);
