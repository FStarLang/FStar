...
let (report_errors : query_settings -> unit) =
  fun settings  ->
    ...
    (let uu____2001 =
     ...
     then
       let initial_fuel1 =
         let uu___378_2010 = settings  in
         let uu____2011 = FStar_Options.initial_fuel ()  in
         let uu____2013 = FStar_Options.initial_ifuel ()  in
         {
           query_env = (uu___378_2010.query_env);
           query_decl = (uu___378_2010.query_decl);
           query_name = (uu___378_2010.query_name);
           query_index = (uu___378_2010.query_index);
           query_range = (uu___378_2010.query_range);
           query_fuel = uu____2011;
           query_ifuel = uu____2013;
           query_rlimit = (uu___378_2010.query_rlimit);
           query_hint = FStar_Pervasives_Native.None;
           query_errors = (uu___378_2010.query_errors);
           query_all_labels = (uu___378_2010.query_all_labels);
           query_suffix = (uu___378_2010.query_suffix);
           query_hash = (uu___378_2010.query_hash)
         }  in
       let ask_z3 label_assumptions =
         let res = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
         (let uu____2036 =
            ...
            (let uu____2615 =
             ...
             | (default_settings,next_hint) ->
                 let use_hints_setting =
                   ...
                   | FStar_Pervasives_Native.Some
                       { FStar_Util.hint_name = uu____2758;
                         ...
                         FStar_Util.hash = h;_}
                       ->
                       [(let uu___379_2780 = default_settings  in
                         {
                           query_env = (uu___379_2780.query_env);
                           query_decl = (uu___379_2780.query_decl);
                           query_name = (uu___379_2780.query_name);
                           query_index = (uu___379_2780.query_index);
                           query_range = (uu___379_2780.query_range);
                           query_fuel = i;
                           query_ifuel = j;
                           query_rlimit = (uu___379_2780.query_rlimit);
                           query_hint = (FStar_Pervasives_Native.Some core);
                           query_errors = (uu___379_2780.query_errors);
                           query_all_labels =
                             (uu___379_2780.query_all_labels);
                           query_suffix = (uu___379_2780.query_suffix);
                           query_hash = (uu___379_2780.query_hash)
                         })]
                   | uu____2784 -> []  in
                 let initial_fuel_max_ifuel =
                   ...
                   then
                     let uu____2799 =
                       let uu___380_2800 = default_settings  in
                       let uu____2801 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___380_2800.query_env);
                         query_decl = (uu___380_2800.query_decl);
                         query_name = (uu___380_2800.query_name);
                         query_index = (uu___380_2800.query_index);
                         query_range = (uu___380_2800.query_range);
                         query_fuel = (uu___380_2800.query_fuel);
                         query_ifuel = uu____2801;
                         query_rlimit = (uu___380_2800.query_rlimit);
                         query_hint = (uu___380_2800.query_hint);
                         query_errors = (uu___380_2800.query_errors);
                         query_all_labels = (uu___380_2800.query_all_labels);
                         query_suffix = (uu___380_2800.query_suffix);
                         query_hash = (uu___380_2800.query_hash)
                       }  in
                     [uu____2799]
                   else []  in
                 let half_max_fuel_max_ifuel =
                   ...
                   then
                     let uu____2820 =
                       let uu___381_2821 = default_settings  in
                       let uu____2822 =
                         let uu____2824 = FStar_Options.max_fuel ()  in
                         uu____2824 / (Prims.parse_int "2")  in
                       let uu____2827 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___381_2821.query_env);
                         query_decl = (uu___381_2821.query_decl);
                         query_name = (uu___381_2821.query_name);
                         query_index = (uu___381_2821.query_index);
                         query_range = (uu___381_2821.query_range);
                         query_fuel = uu____2822;
                         query_ifuel = uu____2827;
                         query_rlimit = (uu___381_2821.query_rlimit);
                         query_hint = (uu___381_2821.query_hint);
                         query_errors = (uu___381_2821.query_errors);
                         query_all_labels = (uu___381_2821.query_all_labels);
                         query_suffix = (uu___381_2821.query_suffix);
                         query_hash = (uu___381_2821.query_hash)
                       }  in
                     [uu____2820]
                   else []  in
                 let max_fuel_max_ifuel =
                   ...
                   then
                     let uu____2853 =
                       let uu___382_2854 = default_settings  in
                       let uu____2855 = FStar_Options.max_fuel ()  in
                       let uu____2857 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___382_2854.query_env);
                         query_decl = (uu___382_2854.query_decl);
                         query_name = (uu___382_2854.query_name);
                         query_index = (uu___382_2854.query_index);
                         query_range = (uu___382_2854.query_range);
                         query_fuel = uu____2855;
                         query_ifuel = uu____2857;
                         query_rlimit = (uu___382_2854.query_rlimit);
                         query_hint = (uu___382_2854.query_hint);
                         query_errors = (uu___382_2854.query_errors);
                         query_all_labels = (uu___382_2854.query_all_labels);
                         query_suffix = (uu___382_2854.query_suffix);
                         query_hash = (uu___382_2854.query_hash)
                       }  in
                     [uu____2853]
                   else []  in
                 let min_fuel1 =
                   ...
                   then
                     let uu____2873 =
                       let uu___383_2874 = default_settings  in
                       let uu____2875 = FStar_Options.min_fuel ()  in
                       {
                         query_env = (uu___383_2874.query_env);
                         query_decl = (uu___383_2874.query_decl);
                         query_name = (uu___383_2874.query_name);
                         query_index = (uu___383_2874.query_index);
                         query_range = (uu___383_2874.query_range);
                         query_fuel = uu____2875;
                         query_ifuel = (Prims.parse_int "1");
                         query_rlimit = (uu___383_2874.query_rlimit);
                         query_hint = (uu___383_2874.query_hint);
                         query_errors = (uu___383_2874.query_errors);
                         query_all_labels = (uu___383_2874.query_all_labels);
                         query_suffix = (uu___383_2874.query_suffix);
                         query_hash = (uu___383_2874.query_hash)
                       }  in
                     [uu____2873]
                   else []  in
                 let all_configs =
                 ...
                 let check_all_configs configs =
                   let report1 errs =
                     report_errors
                       (let uu___384_2934 = default_settings  in
                        {
                          query_env = (uu___384_2934.query_env);
                          query_decl = (uu___384_2934.query_decl);
                          query_name = (uu___384_2934.query_name);
                          query_index = (uu___384_2934.query_index);
                          query_range = (uu___384_2934.query_range);
                          query_fuel = (uu___384_2934.query_fuel);
                          query_ifuel = (uu___384_2934.query_ifuel);
                          query_rlimit = (uu___384_2934.query_rlimit);
                          query_hint = (uu___384_2934.query_hint);
                          query_errors = errs;
                          query_all_labels = (uu___384_2934.query_all_labels);
                          query_suffix = (uu___384_2934.query_suffix);
                          query_hash = (uu___384_2934.query_hash)
                        })
                      in
