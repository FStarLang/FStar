        ...
        fun query  ->
          fun suffix  ->
            ...
            (let uu____1934 =
               ...
               | (qname,index1) ->
                   let rlimit =
                     let uu____1995 = FStar_Options.z3_rlimit_factor ()  in
                     let uu____1996 =
                       let uu____1997 = FStar_Options.z3_rlimit ()  in
                       uu____1997 * (Prims.parse_int "544656")  in
                     uu____1995 * uu____1996  in
                   let next_hint = get_hint_for qname index1  in
                   let default_settings =
                     let uu____2002 = FStar_TypeChecker_Env.get_range env  in
                     let uu____2003 = FStar_Options.initial_fuel ()  in
                     let uu____2004 = FStar_Options.initial_ifuel ()  in
                     {
                       query_env = env;
                       query_decl = query;
                       query_name = qname;
                       query_index = index1;
                       query_range = uu____2002;
                       query_fuel = uu____2003;
                       query_ifuel = uu____2004;
                       query_rlimit = rlimit;
                       query_hint = FStar_Pervasives_Native.None;
                       query_errors = [];
                       ...
                       query_hash =
                         (match next_hint with
                          | FStar_Pervasives_Native.None  ->
                              FStar_Pervasives_Native.None
                          | FStar_Pervasives_Native.Some
                              { FStar_Util.hint_name = uu____2009;
                                FStar_Util.hint_index = uu____2010;
                                FStar_Util.fuel = uu____2011;
                                FStar_Util.ifuel = uu____2012;
                                FStar_Util.unsat_core = uu____2013;
                                FStar_Util.query_elapsed_time = uu____2014;
                                FStar_Util.hash = h;_}
                              -> h)
                     }  in
             ...
             | (default_settings,next_hint) ->
                 let use_hints_setting =
                   match next_hint with
                   | FStar_Pervasives_Native.Some
                       { FStar_Util.hint_name = uu____2035;
                         FStar_Util.hint_index = uu____2036;
                         FStar_Util.fuel = i; FStar_Util.ifuel = j;
                         FStar_Util.unsat_core = FStar_Pervasives_Native.Some
                           core;
                         FStar_Util.query_elapsed_time = uu____2040;
                         FStar_Util.hash = h;_}
                       ->
                       [(let uu___63_2049 = default_settings  in
                         {
                           query_env = (uu___63_2049.query_env);
                           query_decl = (uu___63_2049.query_decl);
                           query_name = (uu___63_2049.query_name);
                           query_index = (uu___63_2049.query_index);
                           query_range = (uu___63_2049.query_range);
                           query_fuel = i;
                           query_ifuel = j;
                           query_rlimit = (uu___63_2049.query_rlimit);
                           query_hint = (FStar_Pervasives_Native.Some core);
                           query_errors = (uu___63_2049.query_errors);
                           query_all_labels = (uu___63_2049.query_all_labels);
                           query_suffix = (uu___63_2049.query_suffix);
                           query_hash = (uu___63_2049.query_hash)
                         })]
                   | uu____2052 -> []  in
                 let initial_fuel_max_ifuel =
                   let uu____2058 =
                     let uu____2059 = FStar_Options.max_ifuel ()  in
                     let uu____2060 = FStar_Options.initial_ifuel ()  in
                     uu____2059 > uu____2060  in
                   if uu____2058
                   then
                     let uu____2063 =
                       let uu___64_2064 = default_settings  in
                       let uu____2065 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___64_2064.query_env);
                         query_decl = (uu___64_2064.query_decl);
                         query_name = (uu___64_2064.query_name);
                         query_index = (uu___64_2064.query_index);
                         query_range = (uu___64_2064.query_range);
                         query_fuel = (uu___64_2064.query_fuel);
                         query_ifuel = uu____2065;
                         query_rlimit = (uu___64_2064.query_rlimit);
                         query_hint = (uu___64_2064.query_hint);
                         query_errors = (uu___64_2064.query_errors);
                         query_all_labels = (uu___64_2064.query_all_labels);
                         query_suffix = (uu___64_2064.query_suffix);
                         query_hash = (uu___64_2064.query_hash)
                       }  in
                     [uu____2063]
                   else []  in
                 let half_max_fuel_max_ifuel =
                   let uu____2070 =
                     let uu____2071 =
                       let uu____2072 = FStar_Options.max_fuel ()  in
                       uu____2072 / (Prims.parse_int "2")  in
                     let uu____2073 = FStar_Options.initial_fuel ()  in
                     uu____2071 > uu____2073  in
                   if uu____2070
                   then
                     let uu____2076 =
                       let uu___65_2077 = default_settings  in
                       let uu____2078 =
                         let uu____2079 = FStar_Options.max_fuel ()  in
                         uu____2079 / (Prims.parse_int "2")  in
                       let uu____2080 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___65_2077.query_env);
                         query_decl = (uu___65_2077.query_decl);
                         query_name = (uu___65_2077.query_name);
                         query_index = (uu___65_2077.query_index);
                         query_range = (uu___65_2077.query_range);
                         query_fuel = uu____2078;
                         query_ifuel = uu____2080;
                         query_rlimit = (uu___65_2077.query_rlimit);
                         query_hint = (uu___65_2077.query_hint);
                         query_errors = (uu___65_2077.query_errors);
                         query_all_labels = (uu___65_2077.query_all_labels);
                         query_suffix = (uu___65_2077.query_suffix);
                         query_hash = (uu___65_2077.query_hash)
                       }  in
                     [uu____2076]
                   else []  in
                 let max_fuel_max_ifuel =
                   let uu____2085 =
                     (let uu____2090 = FStar_Options.max_fuel ()  in
                      let uu____2091 = FStar_Options.initial_fuel ()  in
                      uu____2090 > uu____2091) &&
                       (let uu____2094 = FStar_Options.max_ifuel ()  in
                        let uu____2095 = FStar_Options.initial_ifuel ()  in
                        uu____2094 >= uu____2095)
                      in
                   if uu____2085
                   then
                     let uu____2098 =
                       let uu___66_2099 = default_settings  in
                       let uu____2100 = FStar_Options.max_fuel ()  in
                       let uu____2101 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___66_2099.query_env);
                         query_decl = (uu___66_2099.query_decl);
                         query_name = (uu___66_2099.query_name);
                         query_index = (uu___66_2099.query_index);
                         query_range = (uu___66_2099.query_range);
                         query_fuel = uu____2100;
                         query_ifuel = uu____2101;
                         query_rlimit = (uu___66_2099.query_rlimit);
                         query_hint = (uu___66_2099.query_hint);
                         query_errors = (uu___66_2099.query_errors);
                         query_all_labels = (uu___66_2099.query_all_labels);
                         query_suffix = (uu___66_2099.query_suffix);
                         query_hash = (uu___66_2099.query_hash)
                       }  in
                     [uu____2098]
                   else []  in
                 let min_fuel1 =
                   let uu____2106 =
                     let uu____2107 = FStar_Options.min_fuel ()  in
                     let uu____2108 = FStar_Options.initial_fuel ()  in
                     uu____2107 < uu____2108  in
                   if uu____2106
                   then
                     let uu____2111 =
                       let uu___67_2112 = default_settings  in
                       let uu____2113 = FStar_Options.min_fuel ()  in
                       {
                         query_env = (uu___67_2112.query_env);
                         query_decl = (uu___67_2112.query_decl);
                         query_name = (uu___67_2112.query_name);
                         query_index = (uu___67_2112.query_index);
                         query_range = (uu___67_2112.query_range);
                         query_fuel = uu____2113;
                         query_ifuel = (Prims.parse_int "1");
                         query_rlimit = (uu___67_2112.query_rlimit);
                         query_hint = (uu___67_2112.query_hint);
                         query_errors = (uu___67_2112.query_errors);
                         query_all_labels = (uu___67_2112.query_all_labels);
                         query_suffix = (uu___67_2112.query_suffix);
                         query_hash = (uu___67_2112.query_hash)
                       }  in
                     [uu____2111]
                   else []  in
                 let all_configs =
                 ...
                 let check_one_config config k =
                   ...
                   (let uu____2133 = with_fuel_and_diagnostics config []  in
                    let uu____2136 =
                      let uu____2139 = FStar_SMTEncoding_Z3.mk_fresh_scope ()
                         in
                      FStar_Pervasives_Native.Some uu____2139  in
                    FStar_SMTEncoding_Z3.ask
                      (filter_assertions config.query_env config.query_hint)
                      config.query_hash config.query_all_labels uu____2133
                      uu____2136 k)
                    in
                 let check_all_configs configs =
                   let report1 errs =
                     report_errors
                       (let uu___68_2158 = default_settings  in
                        {
                          query_env = (uu___68_2158.query_env);
                          query_decl = (uu___68_2158.query_decl);
                          query_name = (uu___68_2158.query_name);
                          query_index = (uu___68_2158.query_index);
                          query_range = (uu___68_2158.query_range);
                          query_fuel = (uu___68_2158.query_fuel);
                          query_ifuel = (uu___68_2158.query_ifuel);
                          query_rlimit = (uu___68_2158.query_rlimit);
                          query_hint = (uu___68_2158.query_hint);
                          query_errors = errs;
                          query_all_labels = (uu___68_2158.query_all_labels);
                          query_suffix = (uu___68_2158.query_suffix);
                          query_hash = (uu___68_2158.query_hash)
                        })
                      in
                   fold_queries configs check_one_config process_result
                    ...
                    in
                 let uu____2159 =
                   let uu____2166 = FStar_Options.admit_smt_queries ()  in
                   let uu____2167 = FStar_Options.admit_except ()  in
  ...
  fun use_env_msg  ->
    fun tcenv  ->
      fun q  ->
        (let uu____2209 =
           let uu____2210 =
             let uu____2211 = FStar_TypeChecker_Env.get_range tcenv  in
             FStar_All.pipe_left FStar_Range.string_of_range uu____2211  in
           FStar_Util.format1 "Starting query at %s" uu____2210  in
         FStar_SMTEncoding_Encode.push uu____2209);
        (let uu____2212 = FStar_Options.no_smt ()  in
         if uu____2212
         then
           let uu____2213 =
             let uu____2222 =
               let uu____2229 =
                 let uu____2230 = FStar_Syntax_Print.term_to_string q  in
                 FStar_Util.format1
                   "Q = %s\nA query could not be solved internally, and --no_smt was given"
                   uu____2230
                  in
               (FStar_Errors.Error_NoSMTButNeeded, uu____2229,
                 (tcenv.FStar_TypeChecker_Env.range))
                in
             [uu____2222]  in
           FStar_TypeChecker_Err.add_errors tcenv uu____2213
         else
           (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv  in
            ...
            | (prefix1,labels,qry,suffix) ->
                let pop1 uu____2279 =
                  let uu____2280 =
                    let uu____2281 =
                      let uu____2282 = FStar_TypeChecker_Env.get_range tcenv1
                         in
                      FStar_All.pipe_left FStar_Range.string_of_range
                        uu____2282
                       in
                    FStar_Util.format1 "Ending query at %s" uu____2281  in
                  FStar_SMTEncoding_Encode.pop uu____2280  in
                (match qry with
                       ...
                       FStar_SMTEncoding_Term.assumption_term =
                         {
                           FStar_SMTEncoding_Term.tm =
                             ...
                             (FStar_SMTEncoding_Term.FalseOp ,uu____2283);
                           FStar_SMTEncoding_Term.freevars = uu____2284;
                           FStar_SMTEncoding_Term.rng = uu____2285;_};
                       FStar_SMTEncoding_Term.assumption_caption = uu____2286;
                       FStar_SMTEncoding_Term.assumption_name = uu____2287;
                       FStar_SMTEncoding_Term.assumption_fact_ids =
                         uu____2288;_}
                     -> pop1 ()
                 | uu____2303 when tcenv1.FStar_TypeChecker_Env.admit ->
                     pop1 ()
                 | FStar_SMTEncoding_Term.Assume uu____2304 ->
                     (ask_and_report_errors tcenv1 labels prefix1 qry suffix;
                      pop1 ())
                 | uu____2306 -> failwith "Impossible")))
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2312 =
             let uu____2319 = FStar_Options.peek ()  in (e, g, uu____2319)
              in
           [uu____2312]);
...
let (dummy : FStar_TypeChecker_Env.solver_t) =
  {
    FStar_TypeChecker_Env.init = (fun uu____2334  -> ());
    FStar_TypeChecker_Env.push = (fun uu____2336  -> ());
    FStar_TypeChecker_Env.pop = (fun uu____2338  -> ());
    FStar_TypeChecker_Env.encode_modul =
      (fun uu____2341  -> fun uu____2342  -> ());
    FStar_TypeChecker_Env.encode_sig =
      (fun uu____2345  -> fun uu____2346  -> ());
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2352 =
             let uu____2359 = FStar_Options.peek ()  in (e, g, uu____2359)
              in
           [uu____2352]);
    FStar_TypeChecker_Env.solve =
      (fun uu____2375  -> fun uu____2376  -> fun uu____2377  -> ());
    FStar_TypeChecker_Env.finish = (fun uu____2383  -> ());
    FStar_TypeChecker_Env.refresh = (fun uu____2385  -> ())
  } 