    ...
    (let uu____144 = FStar_Options.record_hints ()  in
     ...
     then
       ...
       let hints_db =
         ...
         { FStar_Util.module_digest = uu____152; FStar_Util.hints = hints }
          in
                               ...
                               FStar_All.pipe_right th
                                 (FStar_Util.for_some
                                    (fun uu___86_460  ->
                                       ...
                                       | uu____462 -> false))
                                in
                             FStar_All.pipe_right uu____458 Prims.op_Negation))
                      in
                   FStar_All.pipe_right uu____453 (FStar_String.concat ", ")
                    in
                 let included =
                   let uu____465 =
                     FStar_All.pipe_right th
                       (FStar_List.collect
                          (fun uu___87_469  ->
                             ...
                             | uu____472 -> []))
                      in
                   FStar_All.pipe_right uu____465 (FStar_String.concat ", ")
                    in
                   ...
                   | (unsat_core,initial_config) ->
                         ...
                         (let uu____1230 = FStar_Options.print_fuels ()  in
                          ...
                          then
                            let uu____1231 =
                              let uu____1232 =
                                let uu____1233 =
                                  FStar_Util.colorize_red " failed "  in
                                Prims.strcat uu____1233
                                  " with maximum fuel %s and ifuel %s\n"
                                 in
                              Prims.strcat "(%s) Query " uu____1232  in
                            let uu____1234 =
                              let uu____1235 =
                                FStar_TypeChecker_Env.get_range env  in
                              FStar_Range.string_of_range uu____1235  in
                            let uu____1236 =
                              let uu____1237 = FStar_Options.max_fuel ()  in
                              FStar_All.pipe_right uu____1237
                                FStar_Util.string_of_int
                               in
                            let uu____1238 =
                              let uu____1239 = FStar_Options.max_ifuel ()  in
                              FStar_All.pipe_right uu____1239
                                FStar_Util.string_of_int
                               in
                            FStar_Util.print3 uu____1231 uu____1234
                              uu____1236 uu____1238
                          else ());
                         (let uu____1241 =
                            FStar_All.pipe_right
                              ...
                              (FStar_List.map
                                 (fun uu____1253  ->
                                    ...
                                    | (uu____1259,x,y) -> (x, y)))
                             in
                          FStar_TypeChecker_Err.add_errors env uu____1241)
                          in
                       let use_errors errs result =
                         match (errs, result) with
                         | (([],uu____1275),uu____1276) -> result
                         | (uu____1281,FStar_Util.Inl uu____1282) -> result
                         | (uu____1289,FStar_Util.Inr uu____1290) ->
                             FStar_Util.Inr errs
                          in
                       let rec try_alt_configs prev_f p1 errs cfgs scope =
                         ...
                         (match (cfgs, (FStar_Pervasives_Native.snd errs))
                          with
                          | ([],uu____1357) -> report1 p1 errs
                          | (uu____1365,FStar_SMTEncoding_Z3.Kill ) ->
                              report1 p1 errs
                          | (mi::tl1,uu____1376) ->
                              let uu____1391 = with_fuel [] p1 mi  in
                              FStar_SMTEncoding_Z3.ask
                                filter_facts_without_core all_labels
                                uu____1391
                                ...
                                (fun uu____1393  ->
                                   ...
                                   | (result,elapsed_time,statistics) ->
                                       let uu____1405 =
                                         ...
                                         (uu____1409, elapsed_time,
                                           statistics)
                                          in
                                       cb false mi p1 tl1 scope uu____1405))
                       
                       and cb used_hint uu____1411 p1 alt scope uu____1415 =
                         match (uu____1411, uu____1415) with
                                               ...
                                               let uu____1478 =
                                                 let uu____1479 =
                                                   FStar_SMTEncoding_Z3.at_log_file
                                                     ()
                                                    in
                                                 Prims.strcat uu____1479 ")"
                                                  in
                                               Prims.strcat uu____1476
                                                 uu____1478
                                                in
                                         ...
                                         let uu____1482 =
                                           ...
                                           let uu____1490 =
                                             let uu____1492 =
                                               match tag with
                                               | "failed" ->
                                                   FStar_Util.colorize_red
                                                     tag
                                               | "succeeded" ->
                                                   FStar_Util.colorize_green
                                                     tag
                                               | uu____1493 ->
                                                   FStar_Util.colorize_bold
                                                     tag
                                             ...
                                             let uu____1494 =
                                               ...
                                               (match env1 with
                                                ...
                                                | FStar_Pervasives_Native.None
                                                 ...
                                                 :: uu____1496
                                                in
                                             uu____1492 :: uu____1494  in
                                           uu____1484 :: uu____1490  in
                                         name :: uu____1482  in
                                     ...
                                     let uu____1510 =
                                       let uu____1512 =
                                         ...
                                         then
                                          ...
                                          in
                                       [uu____1512]  in
                                     FStar_List.append uu____1471 uu____1510
                                      in
                                   FStar_Util.print
                                     "%s\t%s %s\t%s%s in %s milliseconds with fuel %s and ifuel %s and rlimit %s %s\n"
                                     uu____1469
                                 else ()  in
                               let refine_hint unsat_core1 scope1 =
                                   ...
                                   then
                                     ...
                                     (FStar_SMTEncoding_Z3.refresh ();
                                      (let uu____1606 =
                                         ...
                                         filter_assertions uu____1611  in
                                       let uu____1614 =
                                         with_fuel [] p1
                                           (prev_fuel, prev_ifuel, rlimit)
                                          in
                                       FStar_SMTEncoding_Z3.ask uu____1606
                                         all_labels uu____1614
                                         ...
                                         ((let uu____1624 =
                                             let uu____1625 =
                                               ...
                                               (FStar_Options.String
                                                 ...
                                                 :: uu____1627
                                                in
                                             FStar_Options.List uu____1625
                                              in
                                           FStar_Options.set_option
                                             "z3cliopt" uu____1624);
                                          (let hint_refinement_cb uu____1645
                                             =
                                  ...
                                  (let uu____1711 =
                                     let uu____1712 =
                                       FStar_List.map
                                         ...
                                         z3cliopts_before
                                        in
                                     FStar_Options.List uu____1712  in
                                 ...
                                 (let uu____1715 = FStar_ST.read current_core
                                     in
                                  {
                                    ...
                                    FStar_Util.unsat_core = uu____1715;
                       ...
                       ((let uu____1753 =
                        ...
                        (let uu____1756 = FStar_Options.admit_smt_queries ()
                         ...
                         if uu____1756
                         then
                           let uu____1757 = FStar_Options.log_queries ()  in
                           (if uu____1757
                            then FStar_SMTEncoding_Z3.ask_offline fcore wf
                            else
                              (let uu____1759 =
                                 let uu____1760 =
                                   FStar_SMTEncoding_Z3.mk_fresh_scope ()  in
                                 cb (FStar_Option.isSome unsat_core)
                                   initial_config p alt_configs uu____1760
                                  in
                               FStar_SMTEncoding_Z3.ask fcore all_labels wf
                                 FStar_Pervasives_Native.None uu____1759))
                         else ()))
                    in
                 let uu____1765 = FStar_Options.lax_except ()  in
                 (match uu____1765 with
                  | FStar_Pervasives_Native.None  -> check query
                  | FStar_Pervasives_Native.Some id ->
                      let cur_id =
                        let uu____1769 =
                          ...
                          Prims.strcat query_name uu____1770  in
                        Prims.strcat "(" uu____1769  in
                      if cur_id = id then check query else ()))
  ...
  fun use_env_msg  ->
    fun tcenv  ->
      fun q  ->
        (let uu____1791 =
           let uu____1792 =
             let uu____1793 = FStar_TypeChecker_Env.get_range tcenv  in
             FStar_All.pipe_left FStar_Range.string_of_range uu____1793  in
           FStar_Util.format1 "Starting query at %s" uu____1792  in
         FStar_SMTEncoding_Encode.push uu____1791);
               ...
               let uu____1817 =
                 let uu____1818 =
                   let uu____1819 = FStar_TypeChecker_Env.get_range tcenv1
                      in
                   FStar_All.pipe_left FStar_Range.string_of_range uu____1819
                    in
                 FStar_Util.format1 "Ending query at %s" uu____1818  in
               FStar_SMTEncoding_Encode.pop uu____1817  in
             (match qry with
                    ...
                    FStar_SMTEncoding_Term.assumption_term =
                      {
                        FStar_SMTEncoding_Term.tm =
                          ...
                          (FStar_SMTEncoding_Term.FalseOp ,uu____1820);
                        FStar_SMTEncoding_Term.freevars = uu____1821;
                        FStar_SMTEncoding_Term.rng = uu____1822;_};
                    FStar_SMTEncoding_Term.assumption_caption = uu____1823;
                    FStar_SMTEncoding_Term.assumption_name = uu____1824;
                    FStar_SMTEncoding_Term.assumption_fact_ids = uu____1825;_}
                  -> pop1 ()
              | uu____1833 when tcenv1.FStar_TypeChecker_Env.admit -> pop1 ()
              | FStar_SMTEncoding_Term.Assume uu____1834 ->
                  (ask_and_report_errors tcenv1 labels prefix1 qry suffix;
                   pop1 ())
              | uu____1836 -> failwith "Impossible"))
...
let dummy : FStar_TypeChecker_Env.solver_t =
  {
    FStar_TypeChecker_Env.init = (fun uu____1843  -> ());
    FStar_TypeChecker_Env.push = (fun uu____1844  -> ());
    FStar_TypeChecker_Env.pop = (fun uu____1845  -> ());
    FStar_TypeChecker_Env.mark = (fun uu____1846  -> ());
    FStar_TypeChecker_Env.reset_mark = (fun uu____1847  -> ());
    FStar_TypeChecker_Env.commit_mark = (fun uu____1848  -> ());
    FStar_TypeChecker_Env.encode_modul =
      (fun uu____1849  -> fun uu____1850  -> ());
    FStar_TypeChecker_Env.encode_sig =
      (fun uu____1851  -> fun uu____1852  -> ());
    FStar_TypeChecker_Env.preprocess = (fun e  -> fun g  -> [(e, g)]);
    FStar_TypeChecker_Env.solve =
      (fun uu____1859  -> fun uu____1860  -> fun uu____1861  -> ());
    FStar_TypeChecker_Env.is_trivial =
      (fun uu____1865  -> fun uu____1866  -> false);
    FStar_TypeChecker_Env.finish = (fun uu____1867  -> ());
    FStar_TypeChecker_Env.refresh = (fun uu____1868  -> ())
  } 