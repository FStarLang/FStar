        ...
        | _failed ->
            let ask_z3 label_assumptions =
              ...
              (let uu____2047 = FStar_ST.op_Bang res in
               FStar_Option.get uu____2047) in
             ...
             FStar_All.pipe_right settings.query_errors
               (FStar_List.map
                  (fun e ->
                     ...
                     Prims.op_Hat "SMT solver says: " uu____2165)) in
    ...
    (let uu____2209 =
       (FStar_Options.detail_errors ()) &&
         (let uu____2212 = FStar_Options.n_cores () in
          uu____2212 = (Prims.parse_int "1")) in
     if uu____2209
     then
       let initial_fuel1 =
       ...
       let ask_z3 label_assumptions =
         ...
         (let uu____2273 = FStar_ST.op_Bang res in
          FStar_Option.get uu____2273) in
                 ...
                 let parse_axiom_name s =
                   ...
                   | FStar_Pervasives_Native.Some first_upper_index1 ->
                       ...
                       let components1 =
                         ...
                         | [] -> []
                         | uu____2737 ->
                             let uu____2741 = FStar_Util.prefix components in
                             (match uu____2741 with
                              | (module_name, last1) ->
                                  let components1 =
                                    let uu____2768 = exclude_suffix last1 in
                                    FStar_List.append module_name uu____2768 in
             ...
             | (tag, core) ->
                 let range =
                   let uu____2899 =
                     ...
                     Prims.op_Hat uu____2901 (Prims.op_Hat at_log_file ")") in
             ...
             | (default_settings, next_hint) ->
                 ...
                 let check_one_config config1 k =
                   ...
                   (let uu____3626 = with_fuel_and_diagnostics config1 [] in
                    let uu____3629 =
                      let uu____3632 = FStar_SMTEncoding_Z3.mk_fresh_scope () in
                    ...
                    FStar_SMTEncoding_Z3.ask config1.query_range
                      ...
                      uu____3629 k (used_hint config1)) in
           ...
           (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv in
            ...
            | (prefix1, labels, qry, suffix) ->
                let pop1 uu____3838 =
                  let uu____3839 =
                    let uu____3841 =
                      let uu____3843 = FStar_TypeChecker_Env.get_range tcenv1 in
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____3882 =
             let uu____3889 = FStar_Options.peek () in (e, g, uu____3889) in
           [uu____3882]);
...
let (dummy : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.snapshot =
      (fun uu____3913 ->
         (((Prims.parse_int "0"), (Prims.parse_int "0"),
            (Prims.parse_int "0")), ()));
    FStar_TypeChecker_Env.rollback = (fun uu____3932 -> fun uu____3933 -> ());
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____3955 =
             let uu____3962 = FStar_Options.peek () in (e, g, uu____3962) in
           [uu____3955]);
