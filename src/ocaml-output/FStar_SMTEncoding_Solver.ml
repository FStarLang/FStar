         ...
         (FStar_List.iter
            (fun s  ->
               ...
               | FStar_Util.Inr _error ->
                   let _0_344 = FStar_Range.string_of_range s.source_location
                      in
    ...
    fun res  ->
      fun time  ->
        fun r  ->
          ...
          let _0_346 = let _0_345 = FStar_ST.read hint_stats  in s :: _0_345
             in
                           ...
                           (let _0_402 =
                              let _0_401 =
                                let uu____571 =
                                  ...
                                  let _0_372 = FStar_Options.initial_ifuel ()
                                     in
                                  _0_373 > _0_372  in
                                if uu____571
                                then
                              ...
                              let _0_400 =
                                let _0_399 =
                                  let uu____590 =
                                    let _0_379 =
                                      let _0_377 = FStar_Options.max_fuel ()
                                         in
                                  ...
                                  then
                                    let _0_383 =
                                      ...
                                      let _0_381 = FStar_Options.max_ifuel ()
                                         in
                                ...
                                let _0_398 =
                                  let _0_397 =
                                    let uu____609 =
                                      (let _0_385 = FStar_Options.max_fuel ()
                                          in
                                       let _0_384 =
                                         FStar_Options.initial_fuel ()  in
                                       _0_385 > _0_384) &&
                         ...
                         let errs =
                           ...
                           then
                             let uu____656 =
                               ...
                               | None  ->
                                   let _0_405 =
                                     let _0_404 = FStar_Options.min_fuel ()
                                        in
                                     (_0_404, (Prims.parse_int "1"), rlimit)
                                      in
                                   (_0_405, errs)
                                in
                            ...
                            FStar_All.pipe_right (Prims.fst errs)
                              (FStar_List.map
                                 (fun uu____892  ->
                                    ...
                                    | (uu____898,x,y) -> (x, y)))
                             in
                          FStar_TypeChecker_Err.add_errors env _0_413)
                          in
                          ...
                          | (mi::tl,uu____1030) ->
                              ...
                              FStar_SMTEncoding_Z3.ask None all_labels _0_417
                                (fun uu____1046  ->
                                   ...
                                   | (result,elapsed_time) ->
                                       let _0_416 =
                                         let _0_415 = use_errors errs result
                                            in
             ...
             let pop uu____1214 =
               FStar_SMTEncoding_Encode.pop
                 (let _0_440 =
                    ...
                    FStar_All.pipe_left FStar_Range.string_of_range _0_439
                     in
                  FStar_Util.format1 "Ending query at %s" _0_440)
                in
             (match qry with
              | FStar_SMTEncoding_Term.Assume
                  ({
