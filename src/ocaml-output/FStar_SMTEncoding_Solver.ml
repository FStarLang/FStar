    ...
    (let uu____164 = FStar_Options.record_hints ()  in
     ...
     then
       ...
       let hints_db =
         ...
         { FStar_Util.module_digest = uu____172; FStar_Util.hints = hints }
          in
         ...
         (FStar_List.iter
            (fun s  ->
               ...
               | FStar_Util.Inl _unsat_core ->
                   ...
                   let uu____190 = FStar_Util.string_of_int s.elapsed_time
                      in
                   FStar_Util.print2
               ...
               | FStar_Util.Inr _error ->
                   let uu____192 =
                     FStar_Range.string_of_range s.source_location  in
                   let uu____193 = FStar_Util.string_of_int s.elapsed_time
                      in
                   FStar_Util.print2
            ...
            (let uu____582 =
             ...
             | (query_name,query_index) ->
                 ...
                 let set_minimum_workable_fuel f uu___88_638 =
                   ...
                   | ([],uu____645) -> ()
                   | errs ->
                       let uu____651 = FStar_ST.read minimum_workable_fuel
                          in
                           ...
                           let uu____766 =
                             let uu____768 =
                               let uu____769 =
                                 ...
                                 (uu____773, None, "@MaxIFuel_assumption")
                                  in
                       ...
                       let alt_configs =
                         let uu____904 =
                           let uu____910 =
                             let uu____916 =
                               let uu____921 =
                                 let uu____922 = FStar_Options.max_ifuel ()
                                    in
                                 let uu____923 =
                               ...
                               then
                                 let uu____928 =
                                   ...
                                   let uu____933 = FStar_Options.max_ifuel ()
                                      in
                            ...
                            FStar_All.pipe_right (fst errs1)
                              (FStar_List.map
                                 (fun uu____1317  ->
                                    ...
                                    | (uu____1323,x,y) -> (x, y)))
                             in
                          FStar_TypeChecker_Err.add_errors env uu____1305)
                          in
                             ...
                             (if used_hint
                              ...
                              (let query_info env1 name tag statistics1 =
                                     ...
                                     let uu____1569 =
                                       let uu____1571 =
                                         ...
                                         then
                                          ...
                                          in
                                       [uu____1571]  in
                                     FStar_List.append uu____1535 uu____1569
                                      in
                                   FStar_Util.print
                               ...
                               let refine_hint unsat_core1 scope1 =
                                 ...
                                 (let uu____1777 = FStar_ST.read current_core
                                     in
                                  {
        ...
        (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv  in
         ...
         | (prefix1,labels,qry,suffix) ->
             let pop1 uu____1869 =
               let uu____1870 =
                 let uu____1871 =
                   let uu____1872 = FStar_TypeChecker_Env.get_range tcenv1
                      in
                   FStar_All.pipe_left FStar_Range.string_of_range uu____1872
                    in
...
let solver : FStar_TypeChecker_Env.solver_t =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____1892 =
             let uu____1896 = FStar_Options.peek ()  in (e, g, uu____1896)
              in
           [uu____1892]);
...
let dummy : FStar_TypeChecker_Env.solver_t =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____1915 =
             let uu____1919 = FStar_Options.peek ()  in (e, g, uu____1919)
              in
           [uu____1915]);
