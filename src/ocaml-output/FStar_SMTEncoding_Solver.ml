...
type z3_replay_result =
  (FStar_SMTEncoding_Z3.unsat_core,FStar_SMTEncoding_Term.error_labels)
    FStar_Util.either
let z3_result_as_replay_result uu___88_23 =
  match uu___88_23 with
  ...
  fun src_filename  ->
    (let uu____131 = FStar_Options.record_hints () in
     ...
     then
       ...
       let hints_db =
         let _0_333 = FStar_Util.digest_of_file src_filename in
         { FStar_Util.module_digest = _0_333; FStar_Util.hints = hints } in
    ...
    (let uu____140 = FStar_Options.hint_info () in
     ...
     then
       let stats =
         let _0_334 = FStar_ST.read hint_stats in
         FStar_All.pipe_right _0_334 FStar_List.rev in
       FStar_All.pipe_right stats
         (FStar_List.iter
            (fun s  ->
               match s.replay_result with
               | FStar_Util.Inl _unsat_core ->
                   let _0_336 = FStar_Range.string_of_range s.source_location in
                   let _0_335 = FStar_Util.string_of_int s.elapsed_time in
                   FStar_Util.print2
                     "Hint-info (%s): Replay succeeded in %s milliseconds\n"
                     _0_336 _0_335
               | FStar_Util.Inr _error ->
                   let _0_338 = FStar_Range.string_of_range s.source_location in
                   let _0_337 = FStar_Util.string_of_int s.elapsed_time in
                   FStar_Util.print2
            ...
            (let uu___91_216 = h in
             {
               ...
               FStar_Util.fuel = (uu___91_216.FStar_Util.fuel);
    ...
    fun res  ->
      fun time  ->
        fun r  ->
          ...
          let _0_340 = let _0_339 = FStar_ST.read hint_stats in s :: _0_339 in
          FStar_ST.write hint_stats _0_340
             ...
             | (query_name,query_index) ->
                       ...
                       let _0_362 =
                         let _0_353 =
                           FStar_SMTEncoding_Term.Caption
                             (let _0_342 = FStar_Util.string_of_int n in
                              let _0_341 = FStar_Util.string_of_int i in
                         ...
                         let _0_360 =
                           ...
                           let _0_358 =
                             let _0_357 =
                               ...
                               FStar_List.append _0_356 suffix in
                             FStar_List.append
                               [FStar_SMTEncoding_Term.CheckSat] _0_357 in
                           FStar_List.append _0_359 _0_358 in
                         FStar_List.append label_assumptions _0_360 in
                       FStar_List.append _0_362 _0_361 in
                 let check p =
                   let rlimit =
                     let _0_363 = FStar_Options.z3_rlimit () in
                     _0_363 * (Prims.parse_int "544656") in
                   let default_initial_config =
                     let _0_365 = FStar_Options.initial_fuel () in
                     let _0_364 = FStar_Options.initial_ifuel () in
                     (_0_365, _0_364, rlimit) in
                   ...
                   | (unsat_core,initial_config) ->
                           ...
                           (let _0_396 =
                              let _0_395 =
                                let uu____571 =
                                  ...
                                  let _0_366 = FStar_Options.initial_ifuel () in
                                  _0_367 > _0_366 in
                                if uu____571
                                then
                                  let _0_370 =
                                    ...
                                    let _0_368 = FStar_Options.max_ifuel () in
                                    (_0_369, _0_368, rlimit) in
                                  [_0_370]
                                else [] in
                              let _0_394 =
                                let _0_393 =
                                  let uu____590 =
                                    let _0_373 =
                                      let _0_371 = FStar_Options.max_fuel () in
                                      _0_371 / (Prims.parse_int "2") in
                                    let _0_372 =
                                      FStar_Options.initial_fuel () in
                                    _0_373 > _0_372 in
                                  if uu____590
                                  then
                                    let _0_377 =
                                      let _0_376 =
                                        ...
                                        _0_374 / (Prims.parse_int "2") in
                                      let _0_375 = FStar_Options.max_ifuel () in
                                      (_0_376, _0_375, rlimit) in
                                    [_0_377]
                                  else [] in
                                let _0_392 =
                                  let _0_391 =
                                    let uu____609 =
                                      (let _0_379 = FStar_Options.max_fuel () in
                                       let _0_378 =
                                         FStar_Options.initial_fuel () in
                                       _0_379 > _0_378) &&
                                        (let _0_381 =
                       ...
                       let report p errs =
                         let errs =
                           let uu____655 =
                             (FStar_Options.detail_errors ()) &&
                               (let _0_397 = FStar_Options.n_cores () in
                                _0_397 = (Prims.parse_int "1")) in
                           if uu____655
                           then
                             let uu____656 =
                               let uu____665 =
                               ...
                               | None  ->
                                   let _0_399 =
                                     let _0_398 = FStar_Options.min_fuel () in
                                     (_0_398, (Prims.parse_int "1"), rlimit) in
                                   (_0_399, errs) in
                             ...
                             | (min_fuel,potential_errors) ->
                                 ...
                                 (_0_401, FStar_SMTEncoding_Z3.Default)
                           else
                             (match errs with
                         ...
                         (let uu____882 = FStar_Options.print_fuels () in
                          ...
                          then
                            ...
                            let _0_405 =
                              let _0_402 = FStar_Options.max_fuel () in
                              FStar_All.pipe_right _0_402
                                FStar_Util.string_of_int in
                            let _0_404 =
                              let _0_403 = FStar_Options.max_ifuel () in
                              FStar_All.pipe_right _0_403
                                FStar_Util.string_of_int in
                            FStar_Util.print3
                              "(%s) Query failed with maximum fuel %s and ifuel %s\n"
                              _0_406 _0_405 _0_404
                          else ());
                         (let _0_407 =
                          ...
                          FStar_TypeChecker_Err.add_errors env _0_407) in
                       ...
                       let rec try_alt_configs prev_f p errs cfgs =
                         ...
                         (match (cfgs, (Prims.snd errs)) with
                          ...
                          | (mi::[],uu____1006) ->
                              (match errs with
                               | ([],uu____1020) ->
                                   let _0_408 = with_fuel [] p mi in
                                   FStar_SMTEncoding_Z3.ask None all_labels
                                     _0_408 (cb false mi p [])
                               | uu____1026 ->
                                   (set_minimum_workable_fuel prev_f errs;
                                    report p errs))
                          | (mi::tl,uu____1030) ->
                              let _0_411 = with_fuel [] p mi in
                              FStar_SMTEncoding_Z3.ask None all_labels _0_411
                                (fun uu____1046  ->
                                   match uu____1046 with
                                   | (result,elapsed_time) ->
                                       let _0_410 =
                                         let _0_409 = use_errors errs result in
                                         (_0_409, elapsed_time) in
                                       cb false mi p tl _0_410))
                       ...
                       (if FStar_Option.isSome unsat_core
                        ...
                        (let _0_428 = with_fuel [] p initial_config in
                 ...
                 let process_query q =
                   let uu____1147 =
                     ...
                     _0_429 > (Prims.parse_int "0") in
                   if uu____1147
                   then
                     let uu____1148 =
                       let _0_430 = FStar_Options.split_cases () in
    ...
    fun tcenv  ->
      fun q  ->
        FStar_SMTEncoding_Encode.push
          (let _0_432 =
             let _0_431 = FStar_TypeChecker_Env.get_range tcenv in
             FStar_All.pipe_left FStar_Range.string_of_range _0_431 in
           FStar_Util.format1 "Starting query at %s" _0_432);
         ...
         | (prefix,labels,qry,suffix) ->
             let pop uu____1214 =
               FStar_SMTEncoding_Encode.pop
                 (let _0_434 =
                    let _0_433 = FStar_TypeChecker_Env.get_range tcenv in
                    FStar_All.pipe_left FStar_Range.string_of_range _0_433 in
                  FStar_Util.format1 "Ending query at %s" _0_434) in
             (match qry with
              | FStar_SMTEncoding_Term.Assume
                  ({
