    ...
    (let uu____242 = FStar_Options.record_hints () in
     ...
     then
       ...
       let hints_db =
         ...
         { FStar_Util.module_digest = uu____273; FStar_Util.hints = hints } in
       let norm_src_filename = FStar_Util.normalize_file_path src_filename in
       let val_filename =
        ...
        | uu____404 ->
            (FStar_All.pipe_right
              ...
              (let uu____418 =
               ...
               FStar_Option.isSome uu____418) in
          ...
          (fun out ->
             fun d ->
               ...
               | uu____508 ->
                   ...
                   if uu____509 then d :: out else out) [] theory_rev in
      pruned_theory
      ...
      let uu____1771 =
        let uu____1774 =
          let uu____1775 =
            ...
            FStar_Util.format2 "<fuel='%s' ifuel='%s'>" uu____1777 uu____1779 in
        ...
        | _failed ->
            let ask_z3 label_assumptions =
              ...
              (let uu____2091 = FStar_ST.op_Bang res in
               FStar_Option.get uu____2091) in
         ...
         (let uu____2238 =
            FStar_List.fold_left
              ...
              ((Prims.parse_int "0"), (Prims.parse_int "0"),
                (Prims.parse_int "0")) settings.query_errors in
          ...
          | (incomplete_count, canceled_count, unknown_count) ->
              FStar_All.pipe_right
                ...
                (fun _2398 -> FStar_Util.Inl _2398)) in
     ...
     then
       ...
       let ask_z3 label_assumptions =
         ...
         (let uu____2478 = FStar_ST.op_Bang res in
          FStar_Option.get uu____2478) in
                 ...
                 let parse_axiom_name s =
                   ...
                   | FStar_Pervasives_Native.Some first_upper_index1 ->
                       ...
                       let components1 =
                         ...
                         | [] -> []
                         | uu____2942 ->
                             let uu____2946 = FStar_Util.prefix components in
                             (match uu____2946 with
                              | (module_name, last1) ->
                                  let components1 =
                                    let uu____2973 = exclude_suffix last1 in
                                    FStar_List.append module_name uu____2973 in
             ...
             | (tag, core) ->
                 let range =
                   let uu____3104 =
                     ...
                     Prims.op_Hat uu____3106 (Prims.op_Hat at_log_file ")") in
             ...
             | (default_settings, next_hint) ->
                 ...
                 let check_one_config config1 k =
                   ...
                   (let uu____3831 = with_fuel_and_diagnostics config1 [] in
                    let uu____3834 =
                      let uu____3837 = FStar_SMTEncoding_Z3.mk_fresh_scope () in
                    ...
                    FStar_SMTEncoding_Z3.ask config1.query_range
                      ...
                      uu____3834 k (used_hint config1)) in
...
let (save_cfg : FStar_TypeChecker_Env.env -> unit) =
  fun env ->
    let uu____4165 =
      let uu____4168 = get_cfg env in FStar_Pervasives_Native.Some uu____4168 in
...
let (should_refresh : FStar_TypeChecker_Env.env -> Prims.bool) =
  fun env ->
    ...
    | FStar_Pervasives_Native.Some cfg ->
        let uu____4229 = let uu____4231 = get_cfg env in cfg = uu____4231 in
          ...
          ((let uu____4303 = should_refresh tcenv in
           ...
           (let uu____4310 =
              let uu____4312 =
                ...
                FStar_All.pipe_left FStar_Range.string_of_range uu____4314 in
           ...
           (let pop1 uu____4322 =
              let uu____4323 =
                let uu____4325 =
                  ...
                  FStar_All.pipe_left FStar_Range.string_of_range uu____4327 in
                 ...
                 (let uu____4420 =
                    let uu____4430 =
                      ...
                      (FStar_Errors.Error_NonTopRecFunctionNotFullyEncoded,
                        uu____4438, (tcenv.FStar_TypeChecker_Env.range)) in
                    [uu____4430] in
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____4482 =
             let uu____4489 = FStar_Options.peek () in (e, g, uu____4489) in
           [uu____4482]);
...
let (dummy : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.snapshot =
      (fun uu____4513 ->
         (((Prims.parse_int "0"), (Prims.parse_int "0"),
            (Prims.parse_int "0")), ()));
    FStar_TypeChecker_Env.rollback = (fun uu____4532 -> fun uu____4533 -> ());
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____4555 =
             let uu____4562 = FStar_Options.peek () in (e, g, uu____4562) in
           [uu____4555]);
