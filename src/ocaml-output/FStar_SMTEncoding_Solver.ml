      ...
      let uu____1732 =
        let uu____1735 =
          let uu____1736 =
            ...
            FStar_Util.format2 "<fuel='%s' ifuel='%s'>" uu____1738 uu____1740
             in
      ...
      let smt_error =
        ...
        then
          ...
          FStar_All.pipe_right uu____2099
            (fun _2129  -> FStar_Util.Inr _2129)
        else
          (let uu____2132 =
             FStar_List.fold_left
               (fun uu____2157  ->
           ...
           | (incomplete_count,canceled_count,unknown_count) ->
               FStar_All.pipe_right
                 ...
                 (fun _2292  -> FStar_Util.Inl _2292))
         in
                             ...
                             (match uu____2800 with
                              | (module_name,last1) ->
                                  let components1 =
                                    ...
                                    FStar_List.append module_name uu____2827
                                     in
             ...
             | (tag,core) ->
                 let range =
                   let uu____2958 =
                     ...
                     Prims.op_Hat uu____2960 (Prims.op_Hat at_log_file ")")
                      in
  ...
  fun l  ->
    ...
    let rec add_one1 acc1 x =
      ...
      | (h,n1)::t ->
          ...
          else (let uu____3511 = add_one1 t x  in (h, n1) :: uu____3511)
       in
                   ...
                   let rec fold_nat' f acc lo2 hi2 =
                     ...
                     then acc
                       ...
                       (let uu____4004 = f acc lo2  in
                        fold_nat' f uu____4004 (lo2 + Prims.int_one) hi2)
                      in
                   let best_fuel =
                                 ...
                                 let uu____4772 =
                                   let uu____4780 =
                                     ...
                                     FStar_Util.format4
                                       ...
                                       name uu____4782 uu____4784 uu____4786
                                      in
...
let (save_cfg : FStar_TypeChecker_Env.env -> unit) =
  fun env  ->
    let uu____5116 =
      let uu____5119 = get_cfg env  in
      FStar_Pervasives_Native.Some uu____5119  in
...
let (should_refresh : FStar_TypeChecker_Env.env -> Prims.bool) =
  fun env  ->
    ...
    | FStar_Pervasives_Native.Some cfg ->
        let uu____5180 = let uu____5182 = get_cfg env  in cfg = uu____5182
           in
              ...
              (let uu____5328 =
                 let uu____5338 =
                   ...
                   (FStar_Errors.Error_NonTopRecFunctionNotFullyEncoded,
                     uu____5346, (tcenv.FStar_TypeChecker_Env.range))
                    in
                 [uu____5338]  in
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____5460 =
             let uu____5467 = FStar_Options.peek ()  in (e, g, uu____5467)
              in
           [uu____5460]);
...
let (dummy : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____5533 =
             let uu____5540 = FStar_Options.peek ()  in (e, g, uu____5540)
              in
           [uu____5533]);
