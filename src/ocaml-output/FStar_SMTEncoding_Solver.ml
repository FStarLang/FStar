...
let hints_db = (let _0_317 = (FStar_Util.digest_of_file src_filename)
in {FStar_Util.module_digest = _0_317; FStar_Util.hints = hints})
in (
...
let stats = (let _0_318 = (FStar_ST.read hint_stats)
in (FStar_All.pipe_right _0_318 FStar_List.rev))
in (FStar_All.pipe_right stats (FStar_List.iter (fun s -> (match (s.replay_result) with
| FStar_Util.Inl (_unsat_core) -> begin
(let _0_320 = (FStar_Range.string_of_range s.source_location)
in (let _0_319 = (FStar_Util.string_of_int s.elapsed_time)
in (FStar_Util.print2 "Hint-info (%s): Replay succeeded in %s milliseconds\n" _0_320 _0_319)))
end
| FStar_Util.Inr (_error) -> begin
(let _0_322 = (FStar_Range.string_of_range s.source_location)
in (let _0_321 = (FStar_Util.string_of_int s.elapsed_time)
...
in (let _0_324 = (let _0_323 = (FStar_ST.read hint_stats)
in (s)::_0_323)
in (FStar_ST.write hint_stats _0_324))))
...
| (n, i, rlimit) -> begin
(let _0_346 = (let _0_337 = FStar_SMTEncoding_Term.Caption ((let _0_326 = (FStar_Util.string_of_int n)
in (let _0_325 = (FStar_Util.string_of_int i)
in (FStar_Util.format2 "<fuel=\'%s\' ifuel=\'%s\'>" _0_326 _0_325))))
in (let _0_336 = (let _0_335 = FStar_SMTEncoding_Term.Assume ((let _0_329 = (FStar_SMTEncoding_Util.mkEq (let _0_328 = (FStar_SMTEncoding_Util.mkApp (("MaxFuel"), ([])))
in (let _0_327 = (FStar_SMTEncoding_Term.n_fuel n)
in ((_0_328), (_0_327)))))
in ((_0_329), (None), (None))))
in (let _0_334 = (let _0_333 = FStar_SMTEncoding_Term.Assume ((let _0_332 = (FStar_SMTEncoding_Util.mkEq (let _0_331 = (FStar_SMTEncoding_Util.mkApp (("MaxIFuel"), ([])))
in (let _0_330 = (FStar_SMTEncoding_Term.n_fuel i)
in ((_0_331), (_0_330)))))
in ((_0_332), (None), (None))))
in (_0_333)::(p)::[])
in (_0_335)::_0_334))
in (_0_337)::_0_336))
in (let _0_345 = (let _0_344 = (let _0_343 = (let _0_339 = FStar_SMTEncoding_Term.SetOption ((let _0_338 = (FStar_Util.string_of_int rlimit)
in (("rlimit"), (_0_338))))
in (_0_339)::[])
in (let _0_342 = (let _0_341 = (let _0_340 = (
...
in (FStar_List.append _0_340 suffix))
in (FStar_List.append ((FStar_SMTEncoding_Term.CheckSat)::[]) _0_341))
in (FStar_List.append _0_343 _0_342)))
in (FStar_List.append label_assumptions _0_344))
in (FStar_List.append _0_346 _0_345)))
end))
in (

let check = (fun p -> (

let rlimit = (let _0_347 = (FStar_Options.z3_rlimit ())
in (_0_347 * (Prims.parse_int "544656")))
in (

let default_initial_config = (let _0_349 = (FStar_Options.initial_fuel ())
in (let _0_348 = (FStar_Options.initial_ifuel ())
...
let alt_configs = (FStar_List.flatten (let _0_380 = (let _0_379 = (

let uu____571 = (let _0_351 = (FStar_Options.max_ifuel ())
in (let _0_350 = (FStar_Options.initial_ifuel ())
in (_0_351 > _0_350)))
in (match (uu____571) with
| true -> begin
(let _0_354 = (let _0_353 = (FStar_Options.initial_fuel ())
in (let _0_352 = (FStar_Options.max_ifuel ())
in ((_0_353), (_0_352), (rlimit))))
in (_0_354)::[])
end
| uu____582 -> begin
[]
end))
in (let _0_378 = (let _0_377 = (

let uu____590 = (let _0_357 = (let _0_355 = (FStar_Options.max_fuel ())
in (_0_355 / (Prims.parse_int "2")))
in (let _0_356 = (FStar_Options.initial_fuel ())
in (_0_357 > _0_356)))
in (match (uu____590) with
| true -> begin
(let _0_361 = (let _0_360 = (let _0_358 = (FStar_Options.max_fuel ())
in (_0_358 / (Prims.parse_int "2")))
in (let _0_359 = (FStar_Options.max_ifuel ())
...
in (let _0_376 = (let _0_375 = (

let uu____609 = ((let _0_363 = (FStar_Options.max_fuel ())
in (let _0_362 = (FStar_Options.initial_fuel ())
in (_0_363 > _0_362))) && (let _0_365 = (FStar_Options.max_ifuel ())
in (let _0_364 = (FStar_Options.initial_ifuel ())
in (_0_365 > _0_364))))
in (match (uu____609) with
| true -> begin
(let _0_368 = (let _0_367 = (FStar_Options.max_fuel ())
in (let _0_366 = (FStar_Options.max_ifuel ())
in ((_0_367), (_0_366), (rlimit))))
in (_0_368)::[])
end
| uu____620 -> begin
[]
...
let uu____628 = (let _0_370 = (FStar_Options.min_fuel ())
in (let _0_369 = (FStar_Options.initial_fuel ())
in (_0_370 < _0_369)))
in (match (uu____628) with
| true -> begin
(let _0_372 = (let _0_371 = (FStar_Options.min_fuel ())
in ((_0_371), ((Prims.parse_int "1")), (rlimit)))
in (_0_372)::[])
end
| uu____639 -> begin
[]
...
let uu____655 = ((FStar_Options.detail_errors ()) && (let _0_381 = (FStar_Options.n_cores ())
in (_0_381 = (Prims.parse_int "1"))))
...
in ((let _0_384 = (with_fuel label_assumptions p min_fuel)
in (FStar_SMTEncoding_Z3.ask None all_labels _0_384 (fun r -> (FStar_ST.write res (Some (r))))));
(FStar_Option.get (FStar_ST.read res));
)))
in (let _0_385 = (FStar_SMTEncoding_ErrorReporting.detail_errors env all_labels ask_z3)
in ((_0_385), (FStar_SMTEncoding_Z3.Default))))
end))
end
| uu____821 -> begin
(match (errs) with
...
| true -> begin
(let _0_390 = (FStar_Range.string_of_range (FStar_TypeChecker_Env.get_range env))
in (let _0_389 = (let _0_386 = (FStar_Options.max_fuel ())
in (FStar_All.pipe_right _0_386 FStar_Util.string_of_int))
in (let _0_388 = (let _0_387 = (FStar_Options.max_ifuel ())
in (FStar_All.pipe_right _0_387 FStar_Util.string_of_int))
in (FStar_Util.print3 "(%s) Query failed with maximum fuel %s and ifuel %s\n" _0_390 _0_389 _0_388))))
end
| uu____883 -> begin
()
end));
(let _0_391 = (FStar_All.pipe_right (Prims.fst errs) (FStar_List.map (fun uu____892 -> (match (uu____892) with
| (uu____898, x, y) -> begin
((x), (y))
end))))
in (FStar_TypeChecker_Err.add_errors env _0_391));
)))
in (
...
(match (errs) with
| ([], uu____1020) -> begin
(let _0_392 = (with_fuel [] p mi)
in (FStar_SMTEncoding_Z3.ask None all_labels _0_392 (cb false mi p [])))
end
| uu____1026 -> begin
...
(let _0_395 = (with_fuel [] p mi)
in (FStar_SMTEncoding_Z3.ask None all_labels _0_395 (fun uu____1046 -> (match (uu____1046) with
| (result, elapsed_time) -> begin
(let _0_394 = (let _0_393 = (use_errors errs result)
in ((_0_393), (elapsed_time)))
in (cb false mi p tl _0_394))
end))))
end);
))
...
(let _0_396 = (FStar_TypeChecker_Env.get_range env)
in (record_hint_stat hint_opt result elapsed_time _0_396));
)
end
| uu____1114 -> begin
()
...
let query_info = (fun tag -> (let _0_411 = (let _0_410 = (FStar_Range.string_of_range (FStar_TypeChecker_Env.get_range env))
in (let _0_409 = (let _0_408 = (FStar_SMTEncoding_Z3.at_log_file ())
in (let _0_407 = (let _0_406 = (let _0_405 = (FStar_Util.string_of_int query_index)
in (let _0_404 = (let _0_403 = (let _0_402 = (let _0_401 = (FStar_Util.string_of_int elapsed_time)
in (let _0_400 = (let _0_399 = (FStar_Util.string_of_int prev_fuel)
in (let _0_398 = (let _0_397 = (FStar_Util.string_of_int prev_ifuel)
in (_0_397)::[])
in (_0_399)::_0_398))
in (_0_401)::_0_400))
...
(let _0_412 = (with_fuel [] p initial_config)
in (FStar_SMTEncoding_Z3.ask unsat_core all_labels _0_412 (cb (FStar_Option.isSome unsat_core) initial_config p alt_configs)));
)))))
end))))))
in (
...
let uu____1147 = (let _0_413 = (FStar_Options.split_cases ())
in (_0_413 > (Prims.parse_int "0")))
in (match (uu____1147) with
| true -> begin
(

let uu____1148 = (let _0_414 = (FStar_Options.split_cases ())
in (FStar_SMTEncoding_SplitQueryCases.can_handle_query _0_414 q))
...
let solve : (Prims.unit  ->  Prims.string) Prims.option  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  Prims.unit = (fun use_env_msg tcenv q -> ((FStar_SMTEncoding_Encode.push (let _0_416 = (let _0_415 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _0_415))
in (FStar_Util.format1 "Starting query at %s" _0_416)));
(
...
let pop = (fun uu____1214 -> (FStar_SMTEncoding_Encode.pop (let _0_418 = (let _0_417 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range _0_417))
in (FStar_Util.format1 "Ending query at %s" _0_418))))
in (match (qry) with
