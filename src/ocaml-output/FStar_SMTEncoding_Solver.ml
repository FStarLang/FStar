...
(FStar_All.pipe_right errs (FStar_List.iter (fun uu____1854 -> (match (uu____1854) with
| (uu____1861, msg, range1) -> begin
(
...
let uu____1878 = (FStar_Options.record_hints ())
in (not (uu____1878)))
...
let uu____1905 = (FStar_ST.op_Bang recorded_hints)
...
let uu____1976 = (get_hint_for settings.query_name settings.query_index)
in (FStar_Option.get uu____1976))
in (store_hint uu____1975))
end
...
let uu____1997 = ((used_hint settings) && (

let uu____1999 = (FStar_Options.z3_refresh ())
in (not (uu____1999))))
...
let uu____2140 = (match (env.FStar_TypeChecker_Env.qtbl_name_and_index) with
| (uu____2149, FStar_Pervasives_Native.None) -> begin
(failwith "No query name set!")
end
| (uu____2168, FStar_Pervasives_Native.Some (q, n1)) -> begin
(

let uu____2185 = (FStar_Ident.text_of_lid q)
in ((uu____2185), (n1)))
end)
...
let uu____2195 = (FStar_Options.z3_rlimit_factor ())
in (

let uu____2196 = (

let uu____2197 = (FStar_Options.z3_rlimit ())
in (uu____2197 * (Prims.parse_int "544656")))
in (uu____2195 * uu____2196)))
in (
...
let uu____2202 = (FStar_TypeChecker_Env.get_range env)
in (

let uu____2203 = (FStar_Options.initial_fuel ())
in (

let uu____2204 = (FStar_Options.initial_ifuel ())
in {query_env = env; query_decl = query; query_name = qname; query_index = index1; query_range = uu____2202; query_fuel = uu____2203; query_ifuel = uu____2204; query_rlimit = rlimit; query_hint = FStar_Pervasives_Native.None; query_errors = []; query_all_labels = all_labels; query_suffix = suffix; query_hash = (match (next_hint) with
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end
| FStar_Pervasives_Native.Some ({FStar_Util.hint_name = uu____2209; FStar_Util.hint_index = uu____2210; FStar_Util.fuel = uu____2211; FStar_Util.ifuel = uu____2212; FStar_Util.unsat_core = uu____2213; FStar_Util.query_elapsed_time = uu____2214; FStar_Util.hash = h}) -> begin
h
end)})))
...
| FStar_Pervasives_Native.Some ({FStar_Util.hint_name = uu____2235; FStar_Util.hint_index = uu____2236; FStar_Util.fuel = i; FStar_Util.ifuel = j; FStar_Util.unsat_core = FStar_Pervasives_Native.Some (core); FStar_Util.query_elapsed_time = uu____2240; FStar_Util.hash = h}) -> begin
((

let uu___65_2249 = default_settings
in {query_env = uu___65_2249.query_env; query_decl = uu___65_2249.query_decl; query_name = uu___65_2249.query_name; query_index = uu___65_2249.query_index; query_range = uu___65_2249.query_range; query_fuel = i; query_ifuel = j; query_rlimit = uu___65_2249.query_rlimit; query_hint = FStar_Pervasives_Native.Some (core); query_errors = uu___65_2249.query_errors; query_all_labels = uu___65_2249.query_all_labels; query_suffix = uu___65_2249.query_suffix; query_hash = uu___65_2249.query_hash}))::[]
end
| uu____2252 -> begin
[]
end)
...
let uu____2259 = (FStar_Options.max_ifuel ())
in (

let uu____2260 = (FStar_Options.initial_ifuel ())
in (uu____2259 > uu____2260)))
...
let uu___66_2264 = default_settings
in (

let uu____2265 = (FStar_Options.max_ifuel ())
in {query_env = uu___66_2264.query_env; query_decl = uu___66_2264.query_decl; query_name = uu___66_2264.query_name; query_index = uu___66_2264.query_index; query_range = uu___66_2264.query_range; query_fuel = uu___66_2264.query_fuel; query_ifuel = uu____2265; query_rlimit = uu___66_2264.query_rlimit; query_hint = uu___66_2264.query_hint; query_errors = uu___66_2264.query_errors; query_all_labels = uu___66_2264.query_all_labels; query_suffix = uu___66_2264.query_suffix; query_hash = uu___66_2264.query_hash}))
in (uu____2263)::[])
end
| uu____2266 -> begin
[]
...
let uu____2272 = (FStar_Options.max_fuel ())
in (uu____2272 / (Prims.parse_int "2")))
in (

let uu____2273 = (FStar_Options.initial_fuel ())
in (uu____2271 > uu____2273)))
...
let uu___67_2277 = default_settings
in (

let uu____2278 = (

let uu____2279 = (FStar_Options.max_fuel ())
in (uu____2279 / (Prims.parse_int "2")))
in (

let uu____2280 = (FStar_Options.max_ifuel ())
in {query_env = uu___67_2277.query_env; query_decl = uu___67_2277.query_decl; query_name = uu___67_2277.query_name; query_index = uu___67_2277.query_index; query_range = uu___67_2277.query_range; query_fuel = uu____2278; query_ifuel = uu____2280; query_rlimit = uu___67_2277.query_rlimit; query_hint = uu___67_2277.query_hint; query_errors = uu___67_2277.query_errors; query_all_labels = uu___67_2277.query_all_labels; query_suffix = uu___67_2277.query_suffix; query_hash = uu___67_2277.query_hash})))
in (uu____2276)::[])
end
| uu____2281 -> begin
[]
...
let uu____2290 = (FStar_Options.max_fuel ())
in (

let uu____2291 = (FStar_Options.initial_fuel ())
in (uu____2290 > uu____2291))) && (

let uu____2294 = (FStar_Options.max_ifuel ())
in (

let uu____2295 = (FStar_Options.initial_ifuel ())
in (uu____2294 >= uu____2295))))
...
let uu___68_2299 = default_settings
in (

let uu____2300 = (FStar_Options.max_fuel ())
in (

let uu____2301 = (FStar_Options.max_ifuel ())
in {query_env = uu___68_2299.query_env; query_decl = uu___68_2299.query_decl; query_name = uu___68_2299.query_name; query_index = uu___68_2299.query_index; query_range = uu___68_2299.query_range; query_fuel = uu____2300; query_ifuel = uu____2301; query_rlimit = uu___68_2299.query_rlimit; query_hint = uu___68_2299.query_hint; query_errors = uu___68_2299.query_errors; query_all_labels = uu___68_2299.query_all_labels; query_suffix = uu___68_2299.query_suffix; query_hash = uu___68_2299.query_hash})))
in (uu____2298)::[])
end
| uu____2302 -> begin
[]
...
let uu____2307 = (FStar_Options.min_fuel ())
in (

let uu____2308 = (FStar_Options.initial_fuel ())
...
let uu___69_2312 = default_settings
in (

let uu____2313 = (FStar_Options.min_fuel ())
in {query_env = uu___69_2312.query_env; query_decl = uu___69_2312.query_decl; query_name = uu___69_2312.query_name; query_index = uu___69_2312.query_index; query_range = uu___69_2312.query_range; query_fuel = uu____2313; query_ifuel = (Prims.parse_int "1"); query_rlimit = uu___69_2312.query_rlimit; query_hint = uu___69_2312.query_hint; query_errors = uu___69_2312.query_errors; query_all_labels = uu___69_2312.query_all_labels; query_suffix = uu___69_2312.query_suffix; query_hash = uu___69_2312.query_hash}))
in (uu____2311)::[])
end
| uu____2314 -> begin
[]
...
let uu____2335 = ((used_hint config) || (FStar_Options.z3_refresh ()))
...
let uu____2337 = (with_fuel_and_diagnostics config [])
in (

let uu____2340 = (

let uu____2343 = (FStar_SMTEncoding_Z3.mk_fresh_scope ())
in FStar_Pervasives_Native.Some (uu____2343))
in (FStar_SMTEncoding_Z3.ask (filter_assertions config.query_env config.query_hint) config.query_hash config.query_all_labels uu____2337 uu____2340 k)));
))
in (
...
let uu___70_2366 = default_settings
in {query_env = uu___70_2366.query_env; query_decl = uu___70_2366.query_decl; query_name = uu___70_2366.query_name; query_index = uu___70_2366.query_index; query_range = uu___70_2366.query_range; query_fuel = uu___70_2366.query_fuel; query_ifuel = uu___70_2366.query_ifuel; query_rlimit = uu___70_2366.query_rlimit; query_hint = uu___70_2366.query_hint; query_errors = errs; query_all_labels = uu___70_2366.query_all_labels; query_suffix = uu___70_2366.query_suffix; query_hash = uu___70_2366.query_hash})))
in (fold_queries configs check_one_config process_result report1)))
in (

let uu____2367 = (

let uu____2374 = (FStar_Options.admit_smt_queries ())
in (

let uu____2375 = (FStar_Options.admit_except ())
in ((uu____2374), (uu____2375))))
in (match (uu____2367) with
| (true, uu____2380) -> begin
()
end
...
let uu____2395 = (FStar_Util.string_of_int default_settings.query_index)
in (Prims.strcat uu____2395 ")"))
in (Prims.strcat ", " uu____2394))
in (Prims.strcat default_settings.query_name uu____2393))
in (Prims.strcat "(" uu____2392))
...
let uu____2425 = (FStar_TypeChecker_Env.get_range tcenv)
in (FStar_All.pipe_left FStar_Range.string_of_range uu____2425))
in (FStar_Util.format1 "Starting query at %s" uu____2424))
in (FStar_SMTEncoding_Encode.push uu____2423));
(

let uu____2426 = (FStar_Options.no_smt ())
...
let uu____2444 = (FStar_Syntax_Print.term_to_string q)
in (FStar_Util.format1 "Q = %s\nA query could not be solved internally, and --no_smt was given" uu____2444))
in ((FStar_Errors.Error_NoSMTButNeeded), (uu____2443), (tcenv.FStar_TypeChecker_Env.range)))
in (uu____2436)::[])
in (FStar_TypeChecker_Err.add_errors tcenv uu____2427))
end
| uu____2457 -> begin
(
...
let uu____2459 = (FStar_SMTEncoding_Encode.encode_query use_env_msg tcenv1 q)
in (match (uu____2459) with
| (prefix1, labels, qry, suffix) -> begin
(

let pop1 = (fun uu____2495 -> (

let uu____2496 = (

let uu____2497 = (

let uu____2498 = (FStar_TypeChecker_Env.get_range tcenv1)
in (FStar_All.pipe_left FStar_Range.string_of_range uu____2498))
in (FStar_Util.format1 "Ending query at %s" uu____2497))
in (FStar_SMTEncoding_Encode.pop uu____2496)))
in (match (qry) with
| FStar_SMTEncoding_Term.Assume ({FStar_SMTEncoding_Term.assumption_term = {FStar_SMTEncoding_Term.tm = FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.FalseOp, uu____2499); FStar_SMTEncoding_Term.freevars = uu____2500; FStar_SMTEncoding_Term.rng = uu____2501}; FStar_SMTEncoding_Term.assumption_caption = uu____2502; FStar_SMTEncoding_Term.assumption_name = uu____2503; FStar_SMTEncoding_Term.assumption_fact_ids = uu____2504}) -> begin
(pop1 ())
end
| uu____2519 when tcenv1.FStar_TypeChecker_Env.admit -> begin
(pop1 ())
end
| FStar_SMTEncoding_Term.Assume (uu____2520) -> begin
...
let uu____2535 = (FStar_Options.peek ())
in ((e), (g), (uu____2535)))
in (uu____2528)::[])); FStar_TypeChecker_Env.solve = solve; FStar_TypeChecker_Env.finish = FStar_SMTEncoding_Z3.finish; FStar_TypeChecker_Env.refresh = FStar_SMTEncoding_Z3.refresh}


let dummy : FStar_TypeChecker_Env.solver_t = {FStar_TypeChecker_Env.init = (fun uu____2550 -> ()); FStar_TypeChecker_Env.push = (fun uu____2552 -> ()); FStar_TypeChecker_Env.pop = (fun uu____2554 -> ()); FStar_TypeChecker_Env.encode_modul = (fun uu____2557 uu____2558 -> ()); FStar_TypeChecker_Env.encode_sig = (fun uu____2561 uu____2562 -> ()); FStar_TypeChecker_Env.preprocess = (fun e g -> (

let uu____2568 = (

let uu____2575 = (FStar_Options.peek ())
in ((e), (g), (uu____2575)))
in (uu____2568)::[])); FStar_TypeChecker_Env.solve = (fun uu____2591 uu____2592 uu____2593 -> ()); FStar_TypeChecker_Env.finish = (fun uu____2599 -> ()); FStar_TypeChecker_Env.refresh = (fun uu____2601 -> ())}
