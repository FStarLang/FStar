...
let (report_errors : query_settings -> unit) =
  fun settings  ->
    ...
    (let uu____2001 =
     ...
     then
       let initial_fuel1 =
         let uu___420_2010 = settings  in
         let uu____2011 = FStar_Options.initial_fuel ()  in
         let uu____2013 = FStar_Options.initial_ifuel ()  in
         {
           query_env = (uu___420_2010.query_env);
           query_decl = (uu___420_2010.query_decl);
           query_name = (uu___420_2010.query_name);
           query_index = (uu___420_2010.query_index);
           query_range = (uu___420_2010.query_range);
           query_fuel = uu____2011;
           query_ifuel = uu____2013;
           query_rlimit = (uu___420_2010.query_rlimit);
           query_hint = FStar_Pervasives_Native.None;
           query_errors = (uu___420_2010.query_errors);
           query_all_labels = (uu___420_2010.query_all_labels);
           query_suffix = (uu___420_2010.query_suffix);
           query_hash = (uu___420_2010.query_hash)
         }  in
       let ask_z3 label_assumptions =
         let res = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
         (let uu____2036 =
            ...
            (let uu____2615 =
             ...
             | (default_settings,next_hint) ->
                 let use_hints_setting =
                   ...
                   | FStar_Pervasives_Native.Some
                       { FStar_Util.hint_name = uu____2758;
                         ...
                         FStar_Util.hash = h;_}
                       ->
                       [(let uu___421_2780 = default_settings  in
                         {
                           query_env = (uu___421_2780.query_env);
                           query_decl = (uu___421_2780.query_decl);
                           query_name = (uu___421_2780.query_name);
                           query_index = (uu___421_2780.query_index);
                           query_range = (uu___421_2780.query_range);
                           query_fuel = i;
                           query_ifuel = j;
                           query_rlimit = (uu___421_2780.query_rlimit);
                           query_hint = (FStar_Pervasives_Native.Some core);
                           query_errors = (uu___421_2780.query_errors);
                           query_all_labels =
                             (uu___421_2780.query_all_labels);
                           query_suffix = (uu___421_2780.query_suffix);
                           query_hash = (uu___421_2780.query_hash)
                         })]
                   | uu____2784 -> []  in
                 let initial_fuel_max_ifuel =
                   ...
                   then
                     let uu____2799 =
                       let uu___422_2800 = default_settings  in
                       let uu____2801 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___422_2800.query_env);
                         query_decl = (uu___422_2800.query_decl);
                         query_name = (uu___422_2800.query_name);
                         query_index = (uu___422_2800.query_index);
                         query_range = (uu___422_2800.query_range);
                         query_fuel = (uu___422_2800.query_fuel);
                         query_ifuel = uu____2801;
                         query_rlimit = (uu___422_2800.query_rlimit);
                         query_hint = (uu___422_2800.query_hint);
                         query_errors = (uu___422_2800.query_errors);
                         query_all_labels = (uu___422_2800.query_all_labels);
                         query_suffix = (uu___422_2800.query_suffix);
                         query_hash = (uu___422_2800.query_hash)
                       }  in
                     [uu____2799]
                   else []  in
                 let half_max_fuel_max_ifuel =
                   ...
                   then
                     let uu____2820 =
                       let uu___423_2821 = default_settings  in
                       let uu____2822 =
                         let uu____2824 = FStar_Options.max_fuel ()  in
                         uu____2824 / (Prims.parse_int "2")  in
                       let uu____2827 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___423_2821.query_env);
                         query_decl = (uu___423_2821.query_decl);
                         query_name = (uu___423_2821.query_name);
                         query_index = (uu___423_2821.query_index);
                         query_range = (uu___423_2821.query_range);
                         query_fuel = uu____2822;
                         query_ifuel = uu____2827;
                         query_rlimit = (uu___423_2821.query_rlimit);
                         query_hint = (uu___423_2821.query_hint);
                         query_errors = (uu___423_2821.query_errors);
                         query_all_labels = (uu___423_2821.query_all_labels);
                         query_suffix = (uu___423_2821.query_suffix);
                         query_hash = (uu___423_2821.query_hash)
                       }  in
                     [uu____2820]
                   else []  in
                 let max_fuel_max_ifuel =
                   ...
                   then
                     let uu____2853 =
                       let uu___424_2854 = default_settings  in
                       let uu____2855 = FStar_Options.max_fuel ()  in
                       let uu____2857 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___424_2854.query_env);
                         query_decl = (uu___424_2854.query_decl);
                         query_name = (uu___424_2854.query_name);
                         query_index = (uu___424_2854.query_index);
                         query_range = (uu___424_2854.query_range);
                         query_fuel = uu____2855;
                         query_ifuel = uu____2857;
                         query_rlimit = (uu___424_2854.query_rlimit);
                         query_hint = (uu___424_2854.query_hint);
                         query_errors = (uu___424_2854.query_errors);
                         query_all_labels = (uu___424_2854.query_all_labels);
                         query_suffix = (uu___424_2854.query_suffix);
                         query_hash = (uu___424_2854.query_hash)
                       }  in
                     [uu____2853]
                   else []  in
                 let min_fuel1 =
                   ...
                   then
                     let uu____2873 =
                       let uu___425_2874 = default_settings  in
                       let uu____2875 = FStar_Options.min_fuel ()  in
                       {
                         query_env = (uu___425_2874.query_env);
                         query_decl = (uu___425_2874.query_decl);
                         query_name = (uu___425_2874.query_name);
                         query_index = (uu___425_2874.query_index);
                         query_range = (uu___425_2874.query_range);
                         query_fuel = uu____2875;
                         query_ifuel = (Prims.parse_int "1");
                         query_rlimit = (uu___425_2874.query_rlimit);
                         query_hint = (uu___425_2874.query_hint);
                         query_errors = (uu___425_2874.query_errors);
                         query_all_labels = (uu___425_2874.query_all_labels);
                         query_suffix = (uu___425_2874.query_suffix);
                         query_hash = (uu___425_2874.query_hash)
                       }  in
                     [uu____2873]
                   else []  in
                 let all_configs =
                 ...
                 let check_all_configs configs =
                   let report1 errs =
                     report_errors
                       (let uu___426_2934 = default_settings  in
                        {
                          query_env = (uu___426_2934.query_env);
                          query_decl = (uu___426_2934.query_decl);
                          query_name = (uu___426_2934.query_name);
                          query_index = (uu___426_2934.query_index);
                          query_range = (uu___426_2934.query_range);
                          query_fuel = (uu___426_2934.query_fuel);
                          query_ifuel = (uu___426_2934.query_ifuel);
                          query_rlimit = (uu___426_2934.query_rlimit);
                          query_hint = (uu___426_2934.query_hint);
                          query_errors = errs;
                          query_all_labels = (uu___426_2934.query_all_labels);
                          query_suffix = (uu___426_2934.query_suffix);
                          query_hash = (uu___426_2934.query_hash)
                        })
                      in
