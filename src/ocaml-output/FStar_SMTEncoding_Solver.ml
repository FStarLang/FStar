    ...
    (let uu____225 = FStar_Options.record_hints ()  in
     ...
     then
       ...
       let hints_db =
         ...
         { FStar_Util.module_digest = uu____256; FStar_Util.hints = hints }
          in
       let norm_src_filename = FStar_Util.normalize_file_path src_filename
          in
       let val_filename = FStar_Options.hint_file_for_src norm_src_filename
          ...
          (fun out  ->
             fun d  ->
               ...
               | uu____482 ->
                   ...
                   if uu____483 then d :: out else out) [] theory_rev
         in
      pruned_theory
      ...
      let uu____1745 =
        let uu____1748 =
          let uu____1749 =
            ...
            FStar_Util.format2 "<fuel='%s' ifuel='%s'>" uu____1751 uu____1753
             in
          ...
          (let uu____2145 =
           ...
           | (incomplete_count,canceled_count,unknown_count) ->
               FStar_All.pipe_right
                 ...
                 (fun uu____2305  -> FStar_Util.Inl uu____2305))
         in
                 ...
                 let parse_axiom_name s =
                   ...
                   | FStar_Pervasives_Native.Some first_upper_index1 ->
                       ...
                       let components1 =
                         ...
                         | [] -> []
                         | uu____2809 ->
                             let uu____2813 = FStar_Util.prefix components
                                in
                             (match uu____2813 with
                              | (module_name,last) ->
                                  let components1 =
                                    let uu____2840 = exclude_suffix last  in
                                    FStar_List.append module_name uu____2840
                                     in
             ...
             | (tag,core) ->
                 let range =
                   let uu____2971 =
                     ...
                     Prims.op_Hat uu____2973 (Prims.op_Hat at_log_file ")")
                      in
  ...
  fun l  ->
    ...
    let rec add_one acc1 x =
      ...
      | (h,n)::t ->
          ...
          else (let uu____3524 = add_one t x  in (h, n) :: uu____3524)
       in
            ...
            (let uu____3580 =
               let uu____3587 =
                 ...
                 | (uu____3626,FStar_Pervasives_Native.Some (q,n)) ->
                     let uu____3649 = FStar_Ident.text_of_lid q  in
                     (uu____3649, n)
                  in
             ...
             | (default_settings,next_hint) ->
                 ...
                 let check_one_config config =
                   ...
                   (let uu____3870 = with_fuel_and_diagnostics config []  in
                    let uu____3873 =
                      let uu____3876 = FStar_SMTEncoding_Z3.mk_fresh_scope ()
                         in
                   ...
                   let rec fold_nat' f acc lo2 hi2 =
                     ...
                     then acc
                       ...
                       (let uu____4033 = f acc lo2  in
                        fold_nat' f uu____4033 (lo2 + Prims.int_one) hi2)
                      in
                   let best_fuel =
                   ...
                   | (nsuccess,nfailures,rs) ->
                       ...
                       (if quaking
                        then
                          (let fuel_msg =
                             let uu____4536 =
                               let uu____4547 = FStar_ST.op_Bang best_fuel
                                  in
                               let uu____4576 = FStar_ST.op_Bang best_ifuel
                                  in
                               (uu____4547, uu____4576)  in
                             match uu____4536 with
                             | (FStar_Pervasives_Native.Some
                                f,FStar_Pervasives_Native.Some i) ->
                                 let uu____4624 = FStar_Util.string_of_int f
                                    in
                                 let uu____4626 = FStar_Util.string_of_int i
                                    in
                                 FStar_Util.format2
                                   " (best fuel=%s, best ifuel=%s)"
                                   uu____4624 uu____4626
                             | (uu____4629,uu____4630) -> ""  in
                           let uu____4644 = FStar_Util.string_of_int nsuccess
                              in
                           let uu____4646 =
                        ...
                        then
                          (let all_errs =
                           ...
                           let uu____4698 =
                             quaking_or_retrying &&
                               (let uu____4701 = FStar_Options.query_stats ()
                                   in
                   ...
                   (FStar_Options.admit_smt_queries ()) ||
                     (let uu____4987 = FStar_Options.admit_except ()  in
                      ...
                      | FStar_Pervasives_Native.Some id ->
                          ...
                          then
                            let uu____4998 = full_query_id default_settings
                               in
                            uu____4998 <> id
...
let (save_cfg : FStar_TypeChecker_Env.env -> unit) =
  fun env  ->
    let uu____5257 =
      let uu____5260 = get_cfg env  in
      FStar_Pervasives_Native.Some uu____5260  in
...
let (should_refresh : FStar_TypeChecker_Env.env -> Prims.bool) =
  fun env  ->
    ...
    | FStar_Pervasives_Native.Some cfg ->
        let uu____5321 = let uu____5323 = get_cfg env  in cfg = uu____5323
           in
              ...
              (let uu____5469 =
                 let uu____5479 =
                   ...
                   (FStar_Errors.Error_NonTopRecFunctionNotFullyEncoded,
                     uu____5487, (tcenv.FStar_TypeChecker_Env.range))
                    in
                 [uu____5479]  in
    ...
    fun tcenv  ->
      fun q  ->
        ...
        then
          ...
          (let uu____5589 =
             let uu____5593 =
               let uu____5595 = FStar_TypeChecker_Env.current_module tcenv
                  in
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____5612 =
             let uu____5619 = FStar_Options.peek ()  in (e, g, uu____5619)
              in
           [uu____5612]);
...
let (dummy : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____5685 =
             let uu____5692 = FStar_Options.peek ()  in (e, g, uu____5692)
              in
           [uu____5685]);
