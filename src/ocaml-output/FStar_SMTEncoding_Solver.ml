             ...
             | (default_settings, next_hint) ->
                 ...
                 let check_one_config config k =
                   ...
                   (let uu____2133 = with_fuel_and_diagnostics config [] in
                    let uu____2136 =
                      let uu____2139 = FStar_SMTEncoding_Z3.mk_fresh_scope () in
        ...
        (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv in
         ...
         | (prefix1, labels, qry, suffix) ->
             let pop1 uu____2247 =
               let uu____2248 =
                 let uu____2249 =
                   let uu____2250 = FStar_TypeChecker_Env.get_range tcenv1 in
                   FStar_All.pipe_left FStar_Range.string_of_range uu____2250 in
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____2280 =
             let uu____2287 = FStar_Options.peek () in (e, g, uu____2287) in
           [uu____2280]);
...
let (dummy : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e ->
         fun g ->
           let uu____2320 =
             let uu____2327 = FStar_Options.peek () in (e, g, uu____2327) in
           [uu____2320]);
