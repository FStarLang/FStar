...
let finalize_hints_db: Prims.string -> Prims.unit =
  fun src_filename  ->
    (let uu____277 = FStar_Options.record_hints () in
     ...
     then
       let hints =
         let uu____279 = FStar_ST.read recorded_hints in
    ...
    (let uu____310 = FStar_Options.hint_info () in
     ...
     then
       let stats =
         let uu____314 = FStar_ST.read hint_stats in
...
let next_hint:
  ...
  fun qname  ->
    fun qindex  ->
      let uu____440 = FStar_ST.read replaying_hints in
      match uu____440 with
      | FStar_Pervasives_Native.Some hints ->
          FStar_Util.find_map hints
            (fun uu___85_468  ->
               match uu___85_468 with
    ...
    let hint1 =
      ...
      | FStar_Pervasives_Native.Some h ->
          FStar_Pervasives_Native.Some
            (let uu___89_495 = h in
             {
               FStar_Util.hint_name = (uu___89_495.FStar_Util.hint_name);
               FStar_Util.hint_index = (uu___89_495.FStar_Util.hint_index);
               FStar_Util.fuel = (uu___89_495.FStar_Util.fuel);
               FStar_Util.ifuel = (uu___89_495.FStar_Util.ifuel);
               FStar_Util.unsat_core = (uu___89_495.FStar_Util.unsat_core);
               FStar_Util.query_elapsed_time = (Prims.parse_int "0")
             }) in
    let uu____496 = FStar_ST.read recorded_hints in
    ...
    fun res  ->
      fun time  ->
        fun r  ->
          ...
          let uu____570 =
            let uu____573 = FStar_ST.read hint_stats in s :: uu____573 in
          FStar_ST.write hint_stats uu____570
          ...
          fun suffix  ->
            ...
            (let uu____1029 =
             ...
             | (query_name,query_index) ->
                 ...
                 let set_minimum_workable_fuel f uu___88_1127 =
                   match uu___88_1127 with
                   | ([],uu____1140) -> ()
                   | errs ->
                       let uu____1150 = FStar_ST.read minimum_workable_fuel in
                           ...
                           then
                             ...
                             | (min_fuel1,potential_errors) ->
                                 let ask_z3 label_assumptions =
                                   ...
                                   (let uu____2399 = FStar_ST.read res in
                             ...
                             (if used_hint
                              ...
                              (let query_info env1 name tag statistics1 =
                               ...
                               let refine_hint unsat_core1 scope1 =
                                 ...
                                 (let uu____3439 = FStar_ST.read current_core in
                                  {
                                          ...
                                          FStar_SMTEncoding_Z3.ask
                                            ...
                                            (fun r  ->
                                               FStar_ST.write res
                                                 (FStar_Pervasives_Native.Some
                                                    r)));
                                         (let uu____3551 = FStar_ST.read res in
