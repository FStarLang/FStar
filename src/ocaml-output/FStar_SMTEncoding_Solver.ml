      ...
      let uu____1184 =
        let uu____1187 =
          let uu____1188 =
            ...
            FStar_Util.format2 "<fuel='%s' ifuel='%s'>" uu____1189 uu____1190
             in
                      ...
                      let uu____1396 =
                        FStar_List.map
                          (fun uu____1417  ->
                             ...
                             | (uu____1428,x,y) -> (x, y)) error_labels
                         in
                      {
                        error_reason = msg;
  ...
  fun settings  ->
    ...
    then
      ...
      let ask_z3 label_assumptions =
        ...
        (let uu____1660 = FStar_ST.op_Bang res  in
         FStar_Option.get uu____1660)
         in
             ...
             | (status_string,errs) ->
                 ...
                 let range =
                   let uu____1795 =
                     ...
                     let uu____1797 =
                       let uu____1798 = FStar_SMTEncoding_Z3.at_log_file ()
                          in
                    ...
                    (FStar_List.iter
                       (fun uu____1862  ->
                          ...
                          | (uu____1869,msg,range1) ->
                              ...
                              let uu____1875 = FStar_Errors.format_issue e
                                 in
    ...
    fun z3result  ->
      ...
      | (z3status,elapsed_time,uu____1916) ->
          ...
          let hint_opt =
            ...
            else FStar_Pervasives_Native.Some (mk_hint settings.query_hint)
             in
             ...
             let check_one_config config k =
               ...
               (let uu____2303 = with_fuel_and_diagnostics config []  in
                ...
                FStar_SMTEncoding_Z3.ask
                  ...
                  config.query_all_labels uu____2303 uu____2306 k)
                in
                   ...
                   then
                     let full_query_id =
                       let uu____2354 =
                         ...
                         Prims.strcat default_settings.query_name uu____2355
                          in
        ...
        (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv  in
         ...
         | (prefix1,labels,qry,suffix) ->
             let pop1 uu____2420 =
               let uu____2421 =
                 let uu____2422 =
                   let uu____2423 = FStar_TypeChecker_Env.get_range tcenv1
                      in
                   FStar_All.pipe_left FStar_Range.string_of_range uu____2423
                    in
...
let solver : FStar_TypeChecker_Env.solver_t =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2453 =
             let uu____2460 = FStar_Options.peek ()  in (e, g, uu____2460)
              in
           [uu____2453]);
...
let dummy : FStar_TypeChecker_Env.solver_t =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2499 =
             let uu____2506 = FStar_Options.peek ()  in (e, g, uu____2506)
              in
           [uu____2499]);
