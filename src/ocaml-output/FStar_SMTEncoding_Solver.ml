          ...
          (fun out  ->
             fun d  ->
               ...
               | uu___ ->
                   ...
                   if uu___1 then d :: out else out) [] theory_rev
         in
      pruned_theory
...
let (filter_facts_without_core :
  ...
  =
  fun e  ->
    fun x  -> let uu___ = filter_using_facts_from e x  in (uu___, false)
        ...
        let uu___2 =
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 =
                  let uu___7 = FStar_SMTEncoding_Util.mkApp ("MaxFuel", [])
                     in
                  let uu___8 = FStar_SMTEncoding_Term.n_fuel n  in
                  (uu___7, uu___8)  in
                FStar_SMTEncoding_Util.mkEq uu___6  in
              (uu___5, FStar_Pervasives_Native.None, "@MaxFuel_assumption")
               in
            ...
            let uu___5 =
              let uu___6 =
                (FStar_Options.print_z3_statistics ()) ||
                 ...
                 in
              if uu___6 then [FStar_SMTEncoding_Term.GetStatistics] else []
               in
          ...
          (let uu___2 =
           ...
           | (incomplete_count,canceled_count,unknown_count) ->
               FStar_All.pipe_right
                 ...
                 (fun uu___3  -> FStar_Util.Inl uu___3))
         in
  ...
  fun l  ->
    ...
    let rec add_one acc1 x =
      ...
      | (h,n)::t ->
          ...
          else (let uu___1 = add_one t x  in (h, n) :: uu___1)
       in
            ...
            (let uu___1 =
               let uu___2 =
                 ...
                 | (uu___3,FStar_Pervasives_Native.Some (q,n)) ->
                     let uu___4 = FStar_Ident.string_of_lid q  in (uu___4, n)
                  in
               match uu___2 with
               | (qname,index) ->
                   let rlimit =
                   ...
                   let rec fold_nat' f acc lo2 hi2 =
                     ...
                     then acc
                       ...
                       (let uu___3 = f acc lo2  in
                        fold_nat' f uu___3 (lo2 + Prims.int_one) hi2)
                      in
                   let best_fuel =
                     ...
                     fold_nat'
                       (fun uu___3  ->
                          fun n  ->
                            ...
                            | (nsucc,nfail,rs) ->
                                let uu___4 =
                                  (let uu___5 = FStar_Options.quake_keep ()
                                      in
                       ...
                       (if quaking
                        then
                          (let fuel_msg =
                           ...
                           let uu___5 = FStar_Util.string_of_int total_ran
                              in
                           FStar_Util.print5
              ...
              (let uu___4 =
                 let uu___5 =
                   ...
                   (FStar_Errors.Error_NonTopRecFunctionNotFullyEncoded,
                     uu___6, (tcenv.FStar_TypeChecker_Env.range))
                    in
                 [uu___5]  in
...
let (solver : FStar_TypeChecker_Env.solver_t) =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu___ = let uu___1 = FStar_Options.peek ()  in (e, g, uu___1)
              in
           [uu___]);
