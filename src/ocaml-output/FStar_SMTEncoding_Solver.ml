    ...
    (let uu____237 = FStar_Options.record_hints ()  in
     ...
     then
       ...
       let hints_db =
         ...
         { FStar_Util.module_digest = uu____293; FStar_Util.hints = hints }
          in
       let norm_src_filename = FStar_Util.normalize_file_path src_filename
          in
       let val_filename =
      ...
      let uu____1275 =
        let uu____1278 =
          let uu____1279 =
            ...
            FStar_Util.format2 "<fuel='%s' ifuel='%s'>" uu____1280 uu____1281
             in
  ...
  fun settings  ->
    ...
    then
      ...
      let ask_z3 label_assumptions =
        ...
        (let uu____1821 = FStar_ST.op_Bang res  in
         FStar_Option.get uu____1821)
         in
               ...
               FStar_All.pipe_right settings.query_errors
                 (FStar_List.map
                    (fun e  ->
                       ...
                       Prims.strcat "SMT solver says: " uu____1912))
                in
                 ...
                 let check_one_config config k =
                   ...
                   (let uu____2520 = with_fuel_and_diagnostics config []  in
                    ...
                    FStar_SMTEncoding_Z3.ask
                      ...
                      config.query_all_labels uu____2520 uu____2523 k)
                    in
               ...
               let uu____2640 =
                 let uu____2641 =
                   let uu____2642 = FStar_TypeChecker_Env.get_range tcenv1
                      in
                   FStar_All.pipe_left FStar_Range.string_of_range uu____2642
                    in
...
let solver : FStar_TypeChecker_Env.solver_t =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2672 =
             let uu____2679 = FStar_Options.peek ()  in (e, g, uu____2679)
              in
           [uu____2672]);
...
let dummy : FStar_TypeChecker_Env.solver_t =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2712 =
             let uu____2719 = FStar_Options.peek ()  in (e, g, uu____2719)
              in
           [uu____2712]);
