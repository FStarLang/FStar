...
let (report_errors : query_settings -> unit) =
  fun settings  ->
    ...
    (let uu____2257 =
     ...
     then
       let initial_fuel1 =
         let uu___67_2266 = settings  in
         let uu____2267 = FStar_Options.initial_fuel ()  in
         let uu____2269 = FStar_Options.initial_ifuel ()  in
         {
           query_env = (uu___67_2266.query_env);
           query_decl = (uu___67_2266.query_decl);
           query_name = (uu___67_2266.query_name);
           query_index = (uu___67_2266.query_index);
           query_range = (uu___67_2266.query_range);
           query_fuel = uu____2267;
           query_ifuel = uu____2269;
           query_rlimit = (uu___67_2266.query_rlimit);
           query_hint = FStar_Pervasives_Native.None;
           query_errors = (uu___67_2266.query_errors);
           query_all_labels = (uu___67_2266.query_all_labels);
           query_suffix = (uu___67_2266.query_suffix);
           query_hash = (uu___67_2266.query_hash)
         }  in
       let ask_z3 label_assumptions =
         let res = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
         (let uu____2292 =
            ...
            (let uu____3497 =
             ...
             | (default_settings,next_hint) ->
                 let use_hints_setting =
                   ...
                   | FStar_Pervasives_Native.Some
                       { FStar_Util.hint_name = uu____3640;
                         ...
                         FStar_Util.hash = h;_}
                       ->
                       [(let uu___68_3662 = default_settings  in
                         {
                           query_env = (uu___68_3662.query_env);
                           query_decl = (uu___68_3662.query_decl);
                           query_name = (uu___68_3662.query_name);
                           query_index = (uu___68_3662.query_index);
                           query_range = (uu___68_3662.query_range);
                           query_fuel = i;
                           query_ifuel = j;
                           query_rlimit = (uu___68_3662.query_rlimit);
                           query_hint = (FStar_Pervasives_Native.Some core);
                           query_errors = (uu___68_3662.query_errors);
                           query_all_labels = (uu___68_3662.query_all_labels);
                           query_suffix = (uu___68_3662.query_suffix);
                           query_hash = (uu___68_3662.query_hash)
                         })]
                   | uu____3666 -> []  in
                 let initial_fuel_max_ifuel =
                   ...
                   then
                     let uu____3681 =
                       let uu___69_3682 = default_settings  in
                       let uu____3683 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___69_3682.query_env);
                         query_decl = (uu___69_3682.query_decl);
                         query_name = (uu___69_3682.query_name);
                         query_index = (uu___69_3682.query_index);
                         query_range = (uu___69_3682.query_range);
                         query_fuel = (uu___69_3682.query_fuel);
                         query_ifuel = uu____3683;
                         query_rlimit = (uu___69_3682.query_rlimit);
                         query_hint = (uu___69_3682.query_hint);
                         query_errors = (uu___69_3682.query_errors);
                         query_all_labels = (uu___69_3682.query_all_labels);
                         query_suffix = (uu___69_3682.query_suffix);
                         query_hash = (uu___69_3682.query_hash)
                       }  in
                     [uu____3681]
                   else []  in
                 let half_max_fuel_max_ifuel =
                   ...
                   then
                     let uu____3702 =
                       let uu___70_3703 = default_settings  in
                       let uu____3704 =
                         let uu____3706 = FStar_Options.max_fuel ()  in
                         uu____3706 / (Prims.parse_int "2")  in
                       let uu____3709 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___70_3703.query_env);
                         query_decl = (uu___70_3703.query_decl);
                         query_name = (uu___70_3703.query_name);
                         query_index = (uu___70_3703.query_index);
                         query_range = (uu___70_3703.query_range);
                         query_fuel = uu____3704;
                         query_ifuel = uu____3709;
                         query_rlimit = (uu___70_3703.query_rlimit);
                         query_hint = (uu___70_3703.query_hint);
                         query_errors = (uu___70_3703.query_errors);
                         query_all_labels = (uu___70_3703.query_all_labels);
                         query_suffix = (uu___70_3703.query_suffix);
                         query_hash = (uu___70_3703.query_hash)
                       }  in
                     [uu____3702]
                   else []  in
                 let max_fuel_max_ifuel =
                   ...
                   then
                     let uu____3735 =
                       let uu___71_3736 = default_settings  in
                       let uu____3737 = FStar_Options.max_fuel ()  in
                       let uu____3739 = FStar_Options.max_ifuel ()  in
                       {
                         query_env = (uu___71_3736.query_env);
                         query_decl = (uu___71_3736.query_decl);
                         query_name = (uu___71_3736.query_name);
                         query_index = (uu___71_3736.query_index);
                         query_range = (uu___71_3736.query_range);
                         query_fuel = uu____3737;
                         query_ifuel = uu____3739;
                         query_rlimit = (uu___71_3736.query_rlimit);
                         query_hint = (uu___71_3736.query_hint);
                         query_errors = (uu___71_3736.query_errors);
                         query_all_labels = (uu___71_3736.query_all_labels);
                         query_suffix = (uu___71_3736.query_suffix);
                         query_hash = (uu___71_3736.query_hash)
                       }  in
                     [uu____3735]
                   else []  in
                 let min_fuel1 =
                   ...
                   then
                     let uu____3755 =
                       let uu___72_3756 = default_settings  in
                       let uu____3757 = FStar_Options.min_fuel ()  in
                       {
                         query_env = (uu___72_3756.query_env);
                         query_decl = (uu___72_3756.query_decl);
                         query_name = (uu___72_3756.query_name);
                         query_index = (uu___72_3756.query_index);
                         query_range = (uu___72_3756.query_range);
                         query_fuel = uu____3757;
                         query_ifuel = (Prims.parse_int "1");
                         query_rlimit = (uu___72_3756.query_rlimit);
                         query_hint = (uu___72_3756.query_hint);
                         query_errors = (uu___72_3756.query_errors);
                         query_all_labels = (uu___72_3756.query_all_labels);
                         query_suffix = (uu___72_3756.query_suffix);
                         query_hash = (uu___72_3756.query_hash)
                       }  in
                     [uu____3755]
                   else []  in
                 let all_configs =
                 ...
                 let check_all_configs configs =
                   let report1 errs =
                     report_errors
                       (let uu___73_3816 = default_settings  in
                        {
                          query_env = (uu___73_3816.query_env);
                          query_decl = (uu___73_3816.query_decl);
                          query_name = (uu___73_3816.query_name);
                          query_index = (uu___73_3816.query_index);
                          query_range = (uu___73_3816.query_range);
                          query_fuel = (uu___73_3816.query_fuel);
                          query_ifuel = (uu___73_3816.query_ifuel);
                          query_rlimit = (uu___73_3816.query_rlimit);
                          query_hint = (uu___73_3816.query_hint);
                          query_errors = errs;
                          query_all_labels = (uu___73_3816.query_all_labels);
                          query_suffix = (uu___73_3816.query_suffix);
                          query_hash = (uu___73_3816.query_hash)
                        })
                      in
