...
let error_to_short_string: errors -> Prims.string =
  fun err1  ->
    let uu____795 = FStar_Util.string_of_int err1.error_fuel in
    let uu____796 = FStar_Util.string_of_int err1.error_ifuel in
  ...
  fun settings  ->
    fun label_assumptions  ->
      ...
      let uu____1171 =
        let uu____1174 =
          let uu____1175 =
            let uu____1176 = FStar_Util.string_of_int n1 in
            let uu____1177 = FStar_Util.string_of_int i in
            FStar_Util.format2 "<fuel='%s' ifuel='%s'>" uu____1176 uu____1177 in
          FStar_SMTEncoding_Term.Caption uu____1175 in
        let uu____1178 =
          let uu____1181 =
            let uu____1182 =
              let uu____1189 =
                let uu____1190 =
                  ...
                  let uu____1198 = FStar_SMTEncoding_Term.n_fuel n1 in
              ...
              let uu____1205 =
                let uu____1212 =
                  let uu____1213 =
                    ...
                    let uu____1221 = FStar_SMTEncoding_Term.n_fuel i in
                    (uu____1218, uu____1221) in
                  FStar_SMTEncoding_Util.mkEq uu____1213 in
                (uu____1212, FStar_Pervasives_Native.None,
                  "@MaxIFuel_assumption") in
              FStar_SMTEncoding_Util.mkAssume uu____1205 in
            [uu____1204; settings.query_decl] in
          uu____1181 :: uu____1201 in
        uu____1174 :: uu____1178 in
      let uu____1224 =
        let uu____1227 =
          let uu____1230 =
            let uu____1233 =
              let uu____1234 =
                let uu____1239 = FStar_Util.string_of_int rlimit in
                ("rlimit", uu____1239) in
              FStar_SMTEncoding_Term.SetOption uu____1234 in
            [uu____1233;
            FStar_SMTEncoding_Term.CheckSat;
            FStar_SMTEncoding_Term.GetReasonUnknown] in
          let uu____1240 =
            let uu____1243 =
              let uu____1246 = FStar_Options.record_hints () in
              if uu____1246
              then [FStar_SMTEncoding_Term.GetUnsatCore]
              else [] in
            let uu____1250 =
              let uu____1253 =
                let uu____1256 = FStar_Options.print_z3_statistics () in
                if uu____1256
                then [FStar_SMTEncoding_Term.GetStatistics]
                else [] in
              FStar_List.append uu____1253 settings.query_suffix in
            FStar_List.append uu____1243 uu____1250 in
          FStar_List.append uu____1230 uu____1240 in
        FStar_List.append label_assumptions uu____1227 in
      FStar_List.append uu____1171 uu____1224
...
let get_hint_for:
  ...
  fun qname  ->
    fun qindex  ->
      let uu____1273 = FStar_ST.op_Bang replaying_hints in
      match uu____1273 with
      | FStar_Pervasives_Native.Some hints ->
          FStar_Util.find_map hints
            (fun uu___307_1335  ->
               match uu___307_1335 with
...
let query_errors:
  ...
  fun settings  ->
    fun z3result  ->
      ...
      | FStar_SMTEncoding_Z3.UNSAT uu____1357 -> FStar_Pervasives_Native.None
      | uu____1358 ->
          let uu____1359 =
           ...
           | (msg,error_labels) ->
               let err1 =
                 let uu____1369 =
                   FStar_List.map
                     (fun uu____1390  ->
                        match uu____1390 with | (uu____1401,x,y) -> (x, y))
                     error_labels in
                 {
                   error_reason = msg;
            ...
            let ask_z3 label_assumptions =
              ...
              (let uu____1429 =
               ...
               FStar_SMTEncoding_Z3.ask
                 ...
                 settings.query_hash settings.query_all_labels uu____1429
                 FStar_Pervasives_Native.None
                 (fun r  ->
                    FStar_ST.op_Colon_Equals res
                      (FStar_Pervasives_Native.Some r)));
              (let uu____1500 = FStar_ST.op_Bang res in
               FStar_Option.get uu____1500) in
...
let find_localized_errors:
  ...
  fun errs  ->
    FStar_All.pipe_right errs
      (FStar_List.tryFind
         (fun err1  ->
            match err1.error_messages with | [] -> false | uu____1589 -> true))
let has_localized_errors: errors Prims.list -> Prims.bool =
  fun errs  ->
    let uu____1603 = find_localized_errors errs in
    FStar_Option.isSome uu____1603
let report_errors: query_settings -> Prims.unit =
  fun settings  ->
    let uu____1609 =
      (FStar_Options.detail_errors ()) &&
        (let uu____1611 = FStar_Options.n_cores () in
         uu____1611 = (Prims.parse_int "1")) in
    if uu____1609
    then
      let initial_fuel1 =
        let uu___308_1613 = settings in
        let uu____1614 = FStar_Options.initial_fuel () in
        let uu____1615 = FStar_Options.initial_ifuel () in
        {
          query_env = (uu___308_1613.query_env);
          query_decl = (uu___308_1613.query_decl);
          query_name = (uu___308_1613.query_name);
          query_index = (uu___308_1613.query_index);
          query_range = (uu___308_1613.query_range);
          query_fuel = uu____1614;
          query_ifuel = uu____1615;
          query_rlimit = (uu___308_1613.query_rlimit);
          query_hint = FStar_Pervasives_Native.None;
          query_errors = (uu___308_1613.query_errors);
          query_all_labels = (uu___308_1613.query_all_labels);
          query_suffix = (uu___308_1613.query_suffix);
          query_hash = (uu___308_1613.query_hash)
        } in
      let ask_z3 label_assumptions =
        let res = FStar_Util.mk_ref FStar_Pervasives_Native.None in
        (let uu____1634 =
         ...
         FStar_SMTEncoding_Z3.ask
           ...
           settings.query_all_labels uu____1634 FStar_Pervasives_Native.None
           (fun r  ->
              FStar_ST.op_Colon_Equals res (FStar_Pervasives_Native.Some r)));
        (let uu____1705 = FStar_ST.op_Bang res in FStar_Option.get uu____1705) in
      FStar_SMTEncoding_ErrorReporting.detail_errors false settings.query_env
        settings.query_all_labels ask_z3
    else
      (let uu____1775 = find_localized_errors settings.query_errors in
       ...
       | FStar_Pervasives_Native.Some err1 ->
           (FStar_All.pipe_right settings.query_errors
              (FStar_List.iter
                 (fun e  ->
                    let uu____1785 =
                      let uu____1786 = error_to_short_string e in
                      Prims.strcat "SMT solver says: " uu____1786 in
                    FStar_Errors.diag settings.query_range uu____1785));
           ...
           let err_detail =
             let uu____1788 =
               FStar_All.pipe_right settings.query_errors
                 (FStar_List.map
                    (fun e  ->
                       let uu____1798 = error_to_short_string e in
                       Prims.strcat "SMT solver says: " uu____1798)) in
             FStar_All.pipe_right uu____1788 (FStar_String.concat "; ") in
           let uu____1801 =
             let uu____1808 =
               let uu____1813 =
                 FStar_Util.format1 "Unknown assertion failed (%s)"
                   err_detail in
               (uu____1813, (settings.query_range)) in
             [uu____1808] in
           FStar_TypeChecker_Err.add_errors settings.query_env uu____1801)
    ...
    fun z3result  ->
      ...
      then
        ...
        | (status_string,errs) ->
            let tag =
              match z3result.FStar_SMTEncoding_Z3.z3result_status with
              | FStar_SMTEncoding_Z3.UNSAT uu____1837 -> "succeeded"
              | uu____1838 ->
            ...
            let range =
              let uu____1840 =
                ...
                let uu____1842 =
                  let uu____1843 = FStar_SMTEncoding_Z3.at_log_file () in
                  Prims.strcat uu____1843 ")" in
                Prims.strcat uu____1841 uu____1842 in
              Prims.strcat "(" uu____1840 in
            let used_hint_tag =
              if used_hint settings then " (with hint)" else "" in
            let stats =
              let uu____1847 = FStar_Options.print_z3_statistics () in
              if uu____1847
              then
                let f k v1 a =
                  Prims.strcat a
                  ...
                  let uu____1868 =
                    ...
                    let uu____1872 =
                      let uu____1875 =
                        ...
                        used_hint_tag :: uu____1878 in
                      tag :: uu____1875 in
                    uu____1871 :: uu____1872 in
                  (settings.query_name) :: uu____1868 in
                range :: uu____1865 in
              FStar_Util.print
               ...
               (FStar_List.iter
                  (fun uu____1907  ->
                     ...
                     | (uu____1914,msg,range1) ->
                         ...
                         let uu____1920 = FStar_Errors.format_issue e in
...
let record_hint:
  ...
  fun settings  ->
    fun z3result  ->
      let uu____1928 =
        let uu____1929 = FStar_Options.record_hints () in
        Prims.op_Negation uu____1929 in
      if uu____1928
      then ()
      else
        (let mk_hint core =
         ...
         let store_hint hint =
           let uu____1952 = FStar_ST.op_Bang recorded_hints in
            ...
            (let uu____2212 =
             ...
             | (default_settings,next_hint) ->
                 let use_hints_setting =
                   ...
                   | FStar_Pervasives_Native.Some
                       { FStar_Util.hint_name = uu____2291;
                         ...
                         FStar_Util.hash = h;_}
                       ->
                       [(let uu___309_2305 = default_settings in
                         {
                           query_env = (uu___309_2305.query_env);
                           query_decl = (uu___309_2305.query_decl);
                           query_name = (uu___309_2305.query_name);
                           query_index = (uu___309_2305.query_index);
                           query_range = (uu___309_2305.query_range);
                           query_fuel = i;
                           query_ifuel = j;
                           query_rlimit = (uu___309_2305.query_rlimit);
                           query_hint = (FStar_Pervasives_Native.Some core);
                           query_errors = (uu___309_2305.query_errors);
                           query_all_labels =
                             (uu___309_2305.query_all_labels);
                           query_suffix = (uu___309_2305.query_suffix);
                           query_hash = (uu___309_2305.query_hash)
                         })]
                   | uu____2308 -> [] in
                 let initial_fuel_max_ifuel =
                   ...
                   then
                     let uu____2319 =
                       let uu___310_2320 = default_settings in
                       let uu____2321 = FStar_Options.max_ifuel () in
                       {
                         query_env = (uu___310_2320.query_env);
                         query_decl = (uu___310_2320.query_decl);
                         query_name = (uu___310_2320.query_name);
                         query_index = (uu___310_2320.query_index);
                         query_range = (uu___310_2320.query_range);
                         query_fuel = (uu___310_2320.query_fuel);
                         query_ifuel = uu____2321;
                         query_rlimit = (uu___310_2320.query_rlimit);
                         query_hint = (uu___310_2320.query_hint);
                         query_errors = (uu___310_2320.query_errors);
                         query_all_labels = (uu___310_2320.query_all_labels);
                         query_suffix = (uu___310_2320.query_suffix);
                         query_hash = (uu___310_2320.query_hash)
                       } in
                     [uu____2319]
                   else [] in
                 let half_max_fuel_max_ifuel =
                   ...
                   then
                     let uu____2338 =
                       let uu___311_2339 = default_settings in
                       let uu____2340 =
                         let uu____2341 = FStar_Options.max_fuel () in
                         uu____2341 / (Prims.parse_int "2") in
                       let uu____2348 = FStar_Options.max_ifuel () in
                       {
                         query_env = (uu___311_2339.query_env);
                         query_decl = (uu___311_2339.query_decl);
                         query_name = (uu___311_2339.query_name);
                         query_index = (uu___311_2339.query_index);
                         query_range = (uu___311_2339.query_range);
                         query_fuel = uu____2340;
                         query_ifuel = uu____2348;
                         query_rlimit = (uu___311_2339.query_rlimit);
                         query_hint = (uu___311_2339.query_hint);
                         query_errors = (uu___311_2339.query_errors);
                         query_all_labels = (uu___311_2339.query_all_labels);
                         query_suffix = (uu___311_2339.query_suffix);
                         query_hash = (uu___311_2339.query_hash)
                       } in
                     [uu____2338]
                   else [] in
                 let max_fuel_max_ifuel =
                   ...
                   then
                     let uu____2366 =
                       let uu___312_2367 = default_settings in
                       let uu____2368 = FStar_Options.max_fuel () in
                       let uu____2369 = FStar_Options.max_ifuel () in
                       {
                         query_env = (uu___312_2367.query_env);
                         query_decl = (uu___312_2367.query_decl);
                         query_name = (uu___312_2367.query_name);
                         query_index = (uu___312_2367.query_index);
                         query_range = (uu___312_2367.query_range);
                         query_fuel = uu____2368;
                         query_ifuel = uu____2369;
                         query_rlimit = (uu___312_2367.query_rlimit);
                         query_hint = (uu___312_2367.query_hint);
                         query_errors = (uu___312_2367.query_errors);
                         query_all_labels = (uu___312_2367.query_all_labels);
                         query_suffix = (uu___312_2367.query_suffix);
                         query_hash = (uu___312_2367.query_hash)
                       } in
                     [uu____2366]
                   else [] in
                 let min_fuel1 =
                   ...
                   then
                     let uu____2379 =
                       let uu___313_2380 = default_settings in
                       let uu____2381 = FStar_Options.min_fuel () in
                       {
                         query_env = (uu___313_2380.query_env);
                         query_decl = (uu___313_2380.query_decl);
                         query_name = (uu___313_2380.query_name);
                         query_index = (uu___313_2380.query_index);
                         query_range = (uu___313_2380.query_range);
                         query_fuel = uu____2381;
                         query_ifuel = (Prims.parse_int "1");
                         query_rlimit = (uu___313_2380.query_rlimit);
                         query_hint = (uu___313_2380.query_hint);
                         query_errors = (uu___313_2380.query_errors);
                         query_all_labels = (uu___313_2380.query_all_labels);
                         query_suffix = (uu___313_2380.query_suffix);
                         query_hash = (uu___313_2380.query_hash)
                       } in
                     [uu____2379]
                   else [] in
                 let all_configs =
                 ...
                 let check_one_config config k =
                   ...
                   (let uu____2401 = with_fuel_and_diagnostics config [] in
                    let uu____2404 =
                      let uu____2407 = FStar_SMTEncoding_Z3.mk_fresh_scope () in
                 ...
                 let check_all_configs configs =
                   let report1 errs =
                     report_errors
                       (let uu___314_2426 = default_settings in
                        {
                          query_env = (uu___314_2426.query_env);
                          query_decl = (uu___314_2426.query_decl);
                          query_name = (uu___314_2426.query_name);
                          query_index = (uu___314_2426.query_index);
                          query_range = (uu___314_2426.query_range);
                          query_fuel = (uu___314_2426.query_fuel);
                          query_ifuel = (uu___314_2426.query_ifuel);
                          query_rlimit = (uu___314_2426.query_rlimit);
                          query_hint = (uu___314_2426.query_hint);
                          query_errors = errs;
                          query_all_labels = (uu___314_2426.query_all_labels);
                          query_suffix = (uu___314_2426.query_suffix);
                          query_hash = (uu___314_2426.query_hash)
                        }) in
        ...
        (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv in
         ...
         | (prefix1,labels,qry,suffix) ->
             let pop1 uu____2515 =
               let uu____2516 =
                 let uu____2517 =
                   let uu____2518 = FStar_TypeChecker_Env.get_range tcenv1 in
                   FStar_All.pipe_left FStar_Range.string_of_range uu____2518 in
...
let solver: FStar_TypeChecker_Env.solver_t =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2548 =
             let uu____2555 = FStar_Options.peek () in (e, g, uu____2555) in
           [uu____2548]);
...
let dummy: FStar_TypeChecker_Env.solver_t =
  {
    ...
    FStar_TypeChecker_Env.preprocess =
      (fun e  ->
         fun g  ->
           let uu____2588 =
             let uu____2595 = FStar_Options.peek () in (e, g, uu____2595) in
           [uu____2588]);
