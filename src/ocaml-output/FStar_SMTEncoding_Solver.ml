...
let next_hint :
  ...
  fun qname  ->
    fun qindex  ->
      ...
      | uu____218 -> FStar_Pervasives_Native.None
                               ...
                               FStar_All.pipe_right th
                                 (FStar_Util.for_some
                                    (fun uu___86_449  ->
                                       ...
                                       | uu____451 -> false))
                                in
                             FStar_All.pipe_right uu____447 Prims.op_Negation))
                      in
                   FStar_All.pipe_right uu____442 (FStar_String.concat ", ")
                    in
                 let included =
                   let uu____454 =
                     FStar_All.pipe_right th
                       (FStar_List.collect
                          (fun uu___87_458  ->
                             ...
                             | uu____461 -> []))
                      in
                   FStar_All.pipe_right uu____454 (FStar_String.concat ", ")
                    in
            ...
            (let uu____517 =
             ...
             | (query_name,query_index) ->
                 ...
                 let set_minimum_workable_fuel f uu___88_573 =
                   ...
                   | ([],uu____580) -> ()
                   | errs ->
                       let uu____586 = FStar_ST.read minimum_workable_fuel
                          in
                           ...
                           let uu____701 =
                             let uu____703 =
                               let uu____704 =
                                 ...
                                 (uu____708, FStar_Pervasives_Native.None,
                                   "@MaxIFuel_assumption")
                                  in
                       ...
                       let alt_configs =
                         let uu____839 =
                           let uu____845 =
                             let uu____851 =
                               let uu____856 =
                                 let uu____857 = FStar_Options.max_ifuel ()
                                    in
                                 let uu____858 =
                               ...
                               then
                                 let uu____863 =
                                   ...
                                   let uu____868 = FStar_Options.max_ifuel ()
                                      in
                            ...
                            FStar_All.pipe_right
                              ...
                              (FStar_List.map
                                 (fun uu____1246  ->
                                    ...
                                    | (uu____1252,x,y) -> (x, y)))
                             in
                          FStar_TypeChecker_Err.add_errors env uu____1234)
                          in
                             ...
                             (if used_hint
                              ...
                              (let query_info env1 name tag statistics1 =
                                     ...
                                     let uu____1498 =
                                       let uu____1500 =
                                         ...
                                         then
                                          ...
                                          in
                                       [uu____1500]  in
                                     FStar_List.append uu____1464 uu____1498
                                      in
                                   FStar_Util.print
                               ...
                               let refine_hint unsat_core1 scope1 =
                                 ...
                                 (let uu____1703 = FStar_ST.read current_core
                                     in
                                  {
                        ...
                        (let wf = with_fuel [] p initial_config  in
                         let uu____1739 =
                           ...
                           cb (FStar_Option.isSome unsat_core) initial_config
                             p alt_configs uu____1740
                            in
                         FStar_SMTEncoding_Z3.ask
                           (filter_assertions unsat_core) all_labels wf
                           FStar_Pervasives_Native.None uu____1739))
                    in
        ...
        (let tcenv1 = FStar_TypeChecker_Env.incr_query_index tcenv  in
         ...
         | (prefix1,labels,qry,suffix) ->
             let pop1 uu____1792 =
               let uu____1793 =
                 let uu____1794 =
                   let uu____1795 = FStar_TypeChecker_Env.get_range tcenv1
                      in
                   FStar_All.pipe_left FStar_Range.string_of_range uu____1795
                    in
