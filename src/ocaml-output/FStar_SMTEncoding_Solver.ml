...
let report_errors: query_settings -> Prims.unit =
  fun settings  ->
    ...
    then
      let initial_fuel1 =
        let uu___308_1597 = settings in
        let uu____1598 = FStar_Options.initial_fuel () in
        let uu____1599 = FStar_Options.initial_ifuel () in
        {
          query_env = (uu___308_1597.query_env);
          query_decl = (uu___308_1597.query_decl);
          query_name = (uu___308_1597.query_name);
          query_index = (uu___308_1597.query_index);
          query_range = (uu___308_1597.query_range);
          query_fuel = uu____1598;
          query_ifuel = uu____1599;
          query_rlimit = (uu___308_1597.query_rlimit);
          query_hint = FStar_Pervasives_Native.None;
          query_errors = (uu___308_1597.query_errors);
          query_all_labels = (uu___308_1597.query_all_labels);
          query_suffix = (uu___308_1597.query_suffix);
          query_hash = (uu___308_1597.query_hash)
        } in
      let ask_z3 label_assumptions =
        let res = FStar_Util.mk_ref FStar_Pervasives_Native.None in
        (let uu____1618 =
            ...
            (let uu____2188 =
             ...
             | (default_settings,next_hint) ->
                 let use_hints_setting =
                   ...
                   | FStar_Pervasives_Native.Some
                       { FStar_Util.hint_name = uu____2267;
                         ...
                         FStar_Util.hash = h;_}
                       ->
                       [(let uu___309_2281 = default_settings in
                         {
                           query_env = (uu___309_2281.query_env);
                           query_decl = (uu___309_2281.query_decl);
                           query_name = (uu___309_2281.query_name);
                           query_index = (uu___309_2281.query_index);
                           query_range = (uu___309_2281.query_range);
                           query_fuel = i;
                           query_ifuel = j;
                           query_rlimit = (uu___309_2281.query_rlimit);
                           query_hint = (FStar_Pervasives_Native.Some core);
                           query_errors = (uu___309_2281.query_errors);
                           query_all_labels =
                             (uu___309_2281.query_all_labels);
                           query_suffix = (uu___309_2281.query_suffix);
                           query_hash = (uu___309_2281.query_hash)
                         })]
                   | uu____2284 -> [] in
                 let initial_fuel_max_ifuel =
                   ...
                   then
                     let uu____2295 =
                       let uu___310_2296 = default_settings in
                       let uu____2297 = FStar_Options.max_ifuel () in
                       {
                         query_env = (uu___310_2296.query_env);
                         query_decl = (uu___310_2296.query_decl);
                         query_name = (uu___310_2296.query_name);
                         query_index = (uu___310_2296.query_index);
                         query_range = (uu___310_2296.query_range);
                         query_fuel = (uu___310_2296.query_fuel);
                         query_ifuel = uu____2297;
                         query_rlimit = (uu___310_2296.query_rlimit);
                         query_hint = (uu___310_2296.query_hint);
                         query_errors = (uu___310_2296.query_errors);
                         query_all_labels = (uu___310_2296.query_all_labels);
                         query_suffix = (uu___310_2296.query_suffix);
                         query_hash = (uu___310_2296.query_hash)
                       } in
                     [uu____2295]
                   else [] in
                 let half_max_fuel_max_ifuel =
                   ...
                   then
                     let uu____2314 =
                       let uu___311_2315 = default_settings in
                       let uu____2316 =
                         let uu____2317 = FStar_Options.max_fuel () in
                         uu____2317 / (Prims.parse_int "2") in
                       let uu____2324 = FStar_Options.max_ifuel () in
                       {
                         query_env = (uu___311_2315.query_env);
                         query_decl = (uu___311_2315.query_decl);
                         query_name = (uu___311_2315.query_name);
                         query_index = (uu___311_2315.query_index);
                         query_range = (uu___311_2315.query_range);
                         query_fuel = uu____2316;
                         query_ifuel = uu____2324;
                         query_rlimit = (uu___311_2315.query_rlimit);
                         query_hint = (uu___311_2315.query_hint);
                         query_errors = (uu___311_2315.query_errors);
                         query_all_labels = (uu___311_2315.query_all_labels);
                         query_suffix = (uu___311_2315.query_suffix);
                         query_hash = (uu___311_2315.query_hash)
                       } in
                     [uu____2314]
                   else [] in
                 let max_fuel_max_ifuel =
                   ...
                   then
                     let uu____2342 =
                       let uu___312_2343 = default_settings in
                       let uu____2344 = FStar_Options.max_fuel () in
                       let uu____2345 = FStar_Options.max_ifuel () in
                       {
                         query_env = (uu___312_2343.query_env);
                         query_decl = (uu___312_2343.query_decl);
                         query_name = (uu___312_2343.query_name);
                         query_index = (uu___312_2343.query_index);
                         query_range = (uu___312_2343.query_range);
                         query_fuel = uu____2344;
                         query_ifuel = uu____2345;
                         query_rlimit = (uu___312_2343.query_rlimit);
                         query_hint = (uu___312_2343.query_hint);
                         query_errors = (uu___312_2343.query_errors);
                         query_all_labels = (uu___312_2343.query_all_labels);
                         query_suffix = (uu___312_2343.query_suffix);
                         query_hash = (uu___312_2343.query_hash)
                       } in
                     [uu____2342]
                   else [] in
                 let min_fuel1 =
                   ...
                   then
                     let uu____2355 =
                       let uu___313_2356 = default_settings in
                       let uu____2357 = FStar_Options.min_fuel () in
                       {
                         query_env = (uu___313_2356.query_env);
                         query_decl = (uu___313_2356.query_decl);
                         query_name = (uu___313_2356.query_name);
                         query_index = (uu___313_2356.query_index);
                         query_range = (uu___313_2356.query_range);
                         query_fuel = uu____2357;
                         query_ifuel = (Prims.parse_int "1");
                         query_rlimit = (uu___313_2356.query_rlimit);
                         query_hint = (uu___313_2356.query_hint);
                         query_errors = (uu___313_2356.query_errors);
                         query_all_labels = (uu___313_2356.query_all_labels);
                         query_suffix = (uu___313_2356.query_suffix);
                         query_hash = (uu___313_2356.query_hash)
                       } in
                     [uu____2355]
                   else [] in
                 let all_configs =
                 ...
                 let check_all_configs configs =
                   let report1 errs =
                     report_errors
                       (let uu___314_2402 = default_settings in
                        {
                          query_env = (uu___314_2402.query_env);
                          query_decl = (uu___314_2402.query_decl);
                          query_name = (uu___314_2402.query_name);
                          query_index = (uu___314_2402.query_index);
                          query_range = (uu___314_2402.query_range);
                          query_fuel = (uu___314_2402.query_fuel);
                          query_ifuel = (uu___314_2402.query_ifuel);
                          query_rlimit = (uu___314_2402.query_rlimit);
                          query_hint = (uu___314_2402.query_hint);
                          query_errors = errs;
                          query_all_labels = (uu___314_2402.query_all_labels);
                          query_suffix = (uu___314_2402.query_suffix);
                          query_hash = (uu___314_2402.query_hash)
                        }) in
