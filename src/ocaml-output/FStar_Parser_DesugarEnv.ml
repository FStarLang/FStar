...
let qual : FStar_Ident.lident  ->  FStar_Ident.ident  ->  FStar_Ident.lident = (fun lid id -> (let _156_230 = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns ((lid.FStar_Ident.ident)::(id)::[])))
in (FStar_Ident.set_lid_range _156_230 id.FStar_Ident.idRange)))


let qualify : env  ->  FStar_Ident.ident  ->  FStar_Ident.lident = (fun env id -> (let _156_235 = (current_module env)
in (qual _156_235 id)))
...
in (let _156_240 = (FStar_Ident.lid_of_ids (FStar_List.append cur.FStar_Ident.ns (FStar_List.append ((cur.FStar_Ident.ident)::[]) (FStar_List.append lid.FStar_Ident.ns ((lid.FStar_Ident.ident)::[])))))
in (FStar_Ident.set_lid_range _156_240 (FStar_Ident.range_of_lid lid)))))
...
| () -> begin
(let _156_245 = (let _156_244 = (new_sigmap ())
in (_156_244)::[])
in {curmodule = None; modules = []; open_namespaces = []; modul_abbrevs = []; sigaccum = []; localbindings = []; recbindings = []; phase = FStar_Parser_AST.Un; sigmap = _156_245; default_result_effect = FStar_Absyn_Util.ml_comp; iface = false; admitted_iface = false})
end))
...
(let _156_261 = (FStar_Absyn_Util.bvd_to_typ (FStar_Absyn_Util.set_bvd_range bvd id.FStar_Ident.idRange) FStar_Absyn_Syntax.kun)
in Some (_156_261))
end
| _61_128 -> begin
None
...
in (let _156_272 = (let _156_271 = (current_module env)
in (_156_271)::env.open_namespaces)
in (aux _156_272))))
...
let resolve_in_open_namespaces = (fun env lid finder -> (let _156_288 = (expand_module_abbrevs env lid)
in (resolve_in_open_namespaces' env _156_288 finder)))
...
(let _156_292 = (FStar_Ident.lid_of_path (("Prims")::(y)::[]) id.FStar_Ident.idRange)
in Some (_156_292))
end else begin
None
end
...
| Some (l) -> begin
(let _156_298 = (let _156_297 = (FStar_Absyn_Syntax.mk_Exp_fvar (((FStar_Absyn_Util.fv l)), (None)) None id.FStar_Ident.idRange)
in ((l), (_156_297)))
in Some (_156_298))
end
| _61_171 -> begin
...
(let _156_303 = (let _156_302 = (let _156_301 = (FStar_Ident.lid_of_ids ((id')::[]))
in (let _156_300 = (FStar_Absyn_Util.bvd_to_exp (FStar_Absyn_Util.set_bvd_range bvd id.FStar_Ident.idRange) FStar_Absyn_Syntax.tun)
in ((_156_301), (_156_300))))
in FStar_Util.Inr (_156_302))
in Some (_156_303))
end
| _61_185 -> begin
None
...
let find_in_sig = (fun lid -> (match ((let _156_321 = (sigmap env)
in (FStar_Util.smap_try_find _156_321 lid.FStar_Ident.str))) with
...
(let _156_324 = (let _156_323 = (let _156_322 = (FStar_Absyn_Util.ftv lid FStar_Absyn_Syntax.kun)
in ((OSig (se)), (_156_322)))
in Typ_name (_156_323))
in Some (_156_324))
end
...
(let _156_328 = (let _156_327 = (let _156_326 = (let _156_325 = (fv_qual_of_se se)
in (FStar_Absyn_Util.fvar _156_325 lid (FStar_Ident.range_of_lid lid)))
in ((OSig (se)), (_156_326)))
in Exp_name (_156_327))
in Some (_156_328))
end
| FStar_Absyn_Syntax.Sig_let (_61_275) -> begin
(let _156_331 = (let _156_330 = (let _156_329 = (FStar_Absyn_Util.fvar None lid (FStar_Ident.range_of_lid lid))
in ((OSig (se)), (_156_329)))
in Exp_name (_156_330))
in Some (_156_331))
end
...
(let _156_336 = (let _156_335 = (let _156_334 = (let _156_333 = (fv_qual_of_se se)
in (FStar_Absyn_Util.fvar _156_333 lid (FStar_Ident.range_of_lid lid)))
in ((OSig (se)), (_156_334)))
in Exp_name (_156_335))
in Some (_156_336))
end else begin
None
end
...
(let _156_340 = (let _156_339 = (let _156_338 = (FStar_Absyn_Util.fvar None recname (FStar_Ident.range_of_lid recname))
in ((ORec (l)), (_156_338)))
in Exp_name (_156_339))
in Some (_156_340))
end
| Binding_tycon (l) when (FStar_Ident.lid_equals l recname) -> begin
(let _156_343 = (let _156_342 = (let _156_341 = (FStar_Absyn_Util.ftv recname FStar_Absyn_Syntax.kun)
in ((ORec (l)), (_156_341)))
in Typ_name (_156_342))
in Some (_156_343))
end
| _61_305 -> begin
None
...
(let _156_350 = (FStar_Absyn_Util.ftv l FStar_Absyn_Syntax.mk_Kind_unknown)
in Some (_156_350))
end
| _61_330 -> begin
None
...
let find_in_sig = (fun lid -> (match ((let _156_379 = (sigmap env)
in (FStar_Util.smap_try_find _156_379 lid.FStar_Ident.str))) with
| Some (FStar_Absyn_Syntax.Sig_typ_abbrev (lid, tps, k, def, _61_380, _61_382), _61_386) -> begin
(

let t = (let _156_382 = (let _156_381 = (let _156_380 = (FStar_Absyn_Util.close_with_lam tps def)
in ((_156_380), (lid)))
in FStar_Absyn_Syntax.Meta_named (_156_381))
in (FStar_Absyn_Syntax.mk_Typ_meta _156_382))
in Some (t))
end
| _61_391 -> begin
None
...
let find_in_sig = (fun lid -> (match ((let _156_389 = (sigmap env)
in (FStar_Util.smap_try_find _156_389 lid.FStar_Ident.str))) with
...
let find_in_sig = (fun lid -> (match ((let _156_401 = (sigmap env)
in (FStar_Util.smap_try_find _156_401 lid.FStar_Ident.str))) with
| Some (FStar_Absyn_Syntax.Sig_let (_61_430), _61_433) -> begin
(let _156_402 = (FStar_Absyn_Util.fvar None lid (FStar_Ident.range_of_lid lid))
in Some (_156_402))
end
| _61_437 -> begin
None
...
let find_in_sig = (fun lid -> (match ((let _156_421 = (sigmap env)
in (FStar_Util.smap_try_find _156_421 lid.FStar_Ident.str))) with
...
let find_in_sig = (fun lid -> (match ((let _156_429 = (sigmap env)
in (FStar_Util.smap_try_find _156_429 lid.FStar_Ident.str))) with
...
| () -> begin
(let _156_443 = (let _156_442 = (let _156_440 = (FStar_ST.read record_cache)
in (FStar_List.hd _156_440))
in (let _156_441 = (FStar_ST.read record_cache)
in (_156_442)::_156_441))
in (FStar_ST.op_Colon_Equals record_cache _156_443))
end))
in (

let pop = (fun _61_511 -> (match (()) with
| () -> begin
(let _156_447 = (let _156_446 = (FStar_ST.read record_cache)
in (FStar_List.tl _156_446))
in (FStar_ST.op_Colon_Equals record_cache _156_447))
end))
in (

let peek = (fun _61_513 -> (match (()) with
| () -> begin
(let _156_450 = (FStar_ST.read record_cache)
in (FStar_List.hd _156_450))
end))
in (

let insert = (fun r -> (let _156_457 = (let _156_456 = (let _156_453 = (peek ())
in (r)::_156_453)
in (let _156_455 = (let _156_454 = (FStar_ST.read record_cache)
in (FStar_List.tl _156_454))
in (_156_456)::_156_455))
in (FStar_ST.op_Colon_Equals record_cache _156_457)))
...
(match ((let _156_528 = (find_dc dc)
in (FStar_All.pipe_left FStar_Util.must _156_528))) with
...
(let _156_532 = (let _156_531 = (let _156_530 = if is_rec then begin
...
in (qual constrname _156_530))
in ((_156_531), (x.FStar_Absyn_Syntax.sort)))
in (_156_532)::[])
end
end
| _61_634 -> begin
...
| (ns, fieldname) -> begin
(let _156_548 = (peek_record_cache ())
in (FStar_Util.find_map _156_548 (fun record -> (
...
(let _156_597 = (let _156_596 = (let _156_595 = (FStar_Absyn_Util.genident (Some (id.FStar_Ident.idRange)))
in ((id), (_156_595)))
in (FStar_Absyn_Util.mkbvd _156_596))
in FStar_Util.Inl (_156_597))
end
| Binding_var (id) -> begin
(let _156_600 = (let _156_599 = (let _156_598 = (FStar_Absyn_Util.genident (Some (id.FStar_Ident.idRange)))
in ((id), (_156_598)))
in (FStar_Absyn_Util.mkbvd _156_599))
in FStar_Util.Inr (_156_600))
end
| _61_745 -> begin
...
let sopt = (let _156_631 = (sigmap env)
in (FStar_Util.smap_try_find _156_631 l.FStar_Ident.str))
in (

let r = (match (sopt) with
| Some (se, _61_793) -> begin
(match ((let _156_632 = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_Util.find_opt (FStar_Ident.lid_equals l) _156_632))) with
| Some (l) -> begin
...
in (let _156_635 = (let _156_634 = (let _156_633 = (FStar_Util.format2 "Duplicate top-level names [%s]; previously declared at %s" (FStar_Ident.text_of_lid l) r)
in ((_156_633), ((FStar_Ident.range_of_lid l))))
in FStar_Absyn_Syntax.Error (_156_634))
in (Prims.raise _156_635)))))
in (
...
(let _156_639 = (FStar_List.map (fun se -> (let _156_638 = (FStar_Absyn_Util.lids_of_sigelt se)
in ((_156_638), (se)))) ses)
in ((env), (_156_639)))
end
| _61_833 -> begin
(let _156_642 = (let _156_641 = (let _156_640 = (FStar_Absyn_Util.lids_of_sigelt s)
in ((_156_640), (s)))
in (_156_641)::[])
in ((env), (_156_642)))
end)
...
| (lids, se) -> begin
(FStar_All.pipe_right lids (FStar_List.iter (fun lid -> (let _156_645 = (sigmap env)
in (FStar_Util.smap_add _156_645 lid.FStar_Ident.str ((se), ((env.iface && (not (env.admitted_iface))))))))))
end))))
in env)
end)))))
...
(let _156_659 = (let _156_658 = (let _156_657 = (FStar_Util.format1 "Module %s is already defined" x.FStar_Ident.idText)
in ((_156_657), (x.FStar_Ident.idRange)))
in FStar_Absyn_Syntax.Error (_156_658))
...
let _61_880 = (let _156_673 = (let _156_672 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid l))
in (let _156_671 = (FStar_Absyn_Print.sli l)
in (FStar_Util.format2 "%s: Warning: Admitting %s without a definition\n" _156_672 _156_671)))
in (FStar_Util.print_string _156_673))
in (let _156_674 = (sigmap env)
in (FStar_Util.smap_add _156_674 l.FStar_Ident.str ((FStar_Absyn_Syntax.Sig_val_decl (((l), (t), ((FStar_Absyn_Syntax.Assumption)::quals), (r)))), (false)))))
end
| Some (_61_883) -> begin
()
end)
...
(let _156_681 = (sigmap env)
in (FStar_Util.smap_remove _156_681 lid.FStar_Ident.str))
end
| _61_913 -> begin
()
end))))
...
if (FStar_List.contains FStar_Absyn_Syntax.Private quals) then begin
(let _156_682 = (sigmap env)
in (FStar_Util.smap_remove _156_682 lid.FStar_Ident.str))
end else begin
()
end
end
...
let _61_931 = env
in (let _156_687 = (let _156_686 = (let _156_685 = (sigmap env)
in (FStar_Util.smap_copy _156_685))
in (_156_686)::env.sigmap)
in {curmodule = _61_931.curmodule; modules = _61_931.modules; open_namespaces = _61_931.open_namespaces; modul_abbrevs = _61_931.modul_abbrevs; sigaccum = _61_931.sigaccum; localbindings = _61_931.localbindings; recbindings = _61_931.recbindings; phase = _61_931.phase; sigmap = _156_687; default_result_effect = _61_931.default_result_effect; iface = _61_931.iface; admitted_iface = _61_931.admitted_iface}))))
...
(let _156_721 = (let _156_720 = (let _156_719 = (FStar_Util.format1 "Duplicate module or interface name: %s" mname.FStar_Ident.str)
in ((_156_719), ((FStar_Ident.range_of_lid mname))))
in FStar_Absyn_Syntax.Error (_156_720))
in (Prims.raise _156_721))
end)))
...
| Some (r) -> begin
(let _156_736 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "(Possible clash with related name at %s)" _156_736))
end)
in (let _156_739 = (let _156_738 = (let _156_737 = (FStar_Util.format2 "Identifier not found: [%s] %s" (FStar_Ident.text_of_lid lid) msg)
in ((_156_737), ((FStar_Ident.range_of_lid lid))))
in FStar_Absyn_Syntax.Error (_156_738))
in (Prims.raise _156_739))))
end
| Some (r) -> begin
r
end))
