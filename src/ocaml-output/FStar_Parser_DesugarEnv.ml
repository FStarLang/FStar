...
let qual = (fun lid id -> (let _111_111 = (FStar_Absyn_Syntax.lid_of_ids (FStar_List.append lid.FStar_Absyn_Syntax.ns ((lid.FStar_Absyn_Syntax.ident)::(id)::[])))
in (FStar_Absyn_Util.set_lid_range _111_111 id.FStar_Absyn_Syntax.idRange)))

let qualify = (fun env id -> (let _111_116 = (current_module env)
in (qual _111_116 id)))

let qualify_lid = (fun env lid -> (let cur = (current_module env)
in (let _111_122 = (FStar_Absyn_Syntax.lid_of_ids (FStar_List.append (FStar_List.append (FStar_List.append cur.FStar_Absyn_Syntax.ns ((cur.FStar_Absyn_Syntax.ident)::[])) lid.FStar_Absyn_Syntax.ns) ((lid.FStar_Absyn_Syntax.ident)::[])))
in (let _111_121 = (FStar_Absyn_Syntax.range_of_lid lid)
in (FStar_Absyn_Util.set_lid_range _111_122 _111_121)))))
...
| () -> begin
(let _111_127 = (let _111_126 = (new_sigmap ())
in (_111_126)::[])
in {curmodule = None; modules = []; open_namespaces = []; sigaccum = []; localbindings = []; recbindings = []; phase = FStar_Parser_AST.Un; sigmap = _111_127; default_result_effect = FStar_Absyn_Util.ml_comp; iface = false; admitted_iface = false})
end))
...
(let _111_144 = (let _111_143 = (FStar_Absyn_Util.set_bvd_range bvd id.FStar_Absyn_Syntax.idRange)
in (FStar_Absyn_Util.bvd_to_typ _111_143 FStar_Absyn_Syntax.kun))
in Some (_111_144))
end
| _42_91 -> begin
None
...
in (FStar_Util.find_map namespaces (fun ns -> (let full_name = (let _111_159 = (let _111_158 = (FStar_Absyn_Syntax.ids_of_lid ns)
in (FStar_List.append _111_158 ids))
in (FStar_Absyn_Syntax.lid_of_ids _111_159))
in (finder full_name)))))
end))
in (let _111_161 = (let _111_160 = (current_module env)
in (_111_160)::env.open_namespaces)
in (aux _111_161))))
...
| true -> begin
(let _111_165 = (FStar_Absyn_Syntax.lid_of_path (("Prims")::(y)::[]) id.FStar_Absyn_Syntax.idRange)
in Some (_111_165))
end
| false -> begin
None
...
| Some (l) -> begin
(let _111_173 = (let _111_172 = (let _111_171 = (let _111_170 = (FStar_Absyn_Util.fv l)
in (_111_170, None))
in (FStar_Absyn_Syntax.mk_Exp_fvar _111_171 None id.FStar_Absyn_Syntax.idRange))
in (l, _111_172))
in Some (_111_173))
end
| _42_114 -> begin
...
(let _111_179 = (let _111_178 = (let _111_177 = (FStar_Absyn_Syntax.lid_of_ids ((id')::[]))
in (let _111_176 = (let _111_175 = (FStar_Absyn_Util.set_bvd_range bvd id.FStar_Absyn_Syntax.idRange)
in (FStar_Absyn_Util.bvd_to_exp _111_175 FStar_Absyn_Syntax.tun))
in (_111_177, _111_176)))
in FStar_Util.Inr (_111_178))
in Some (_111_179))
end
| _42_128 -> begin
None
...
let try_lookup_name = (fun any_val exclude_interf env lid -> (let find_in_sig = (fun lid -> (match ((let _111_297 = (sigmap env)
in (FStar_Util.smap_try_find _111_297 lid.FStar_Absyn_Syntax.str))) with
...
(let _111_300 = (let _111_299 = (let _111_298 = (FStar_Absyn_Util.ftv lid FStar_Absyn_Syntax.kun)
in (OSig (se), _111_298))
in Typ_name (_111_299))
in Some (_111_300))
end
...
(let _111_304 = (let _111_303 = (let _111_302 = (let _111_301 = (FStar_Absyn_Syntax.range_of_lid lid)
in (FStar_Absyn_Util.set_lid_range ne.FStar_Absyn_Syntax.mname _111_301))
in (OSig (se), _111_302))
in Eff_name (_111_303))
in Some (_111_304))
end
...
(let _111_309 = (let _111_308 = (let _111_307 = (let _111_306 = (fv_qual_of_se se)
in (let _111_305 = (FStar_Absyn_Syntax.range_of_lid lid)
in (FStar_Absyn_Util.fvar _111_306 lid _111_305)))
in (OSig (se), _111_307))
in Exp_name (_111_308))
in Some (_111_309))
end
| FStar_Absyn_Syntax.Sig_let (_42_245) -> begin
(let _111_313 = (let _111_312 = (let _111_311 = (let _111_310 = (FStar_Absyn_Syntax.range_of_lid lid)
in (FStar_Absyn_Util.fvar None lid _111_310))
in (OSig (se), _111_311))
in Exp_name (_111_312))
in Some (_111_313))
end
...
| true -> begin
(let _111_319 = (let _111_318 = (let _111_317 = (let _111_316 = (fv_qual_of_se se)
in (let _111_315 = (FStar_Absyn_Syntax.range_of_lid lid)
in (FStar_Absyn_Util.fvar _111_316 lid _111_315)))
in (OSig (se), _111_317))
in Exp_name (_111_318))
in Some (_111_319))
end
| false -> begin
None
...
(let _111_324 = (let _111_323 = (let _111_322 = (let _111_321 = (FStar_Absyn_Syntax.range_of_lid recname)
in (FStar_Absyn_Util.fvar None recname _111_321))
in (ORec (l), _111_322))
in Exp_name (_111_323))
in Some (_111_324))
end
| Binding_tycon (l) when (FStar_Absyn_Syntax.lid_equals l recname) -> begin
(let _111_327 = (let _111_326 = (let _111_325 = (FStar_Absyn_Util.ftv recname FStar_Absyn_Syntax.kun)
in (ORec (l), _111_325))
in Typ_name (_111_326))
in Some (_111_327))
end
| _42_275 -> begin
None
...
(let _111_334 = (FStar_Absyn_Util.ftv l FStar_Absyn_Syntax.mk_Kind_unknown)
in Some (_111_334))
end
| _42_300 -> begin
None
...
let try_resolve_typ_abbrev = (fun env lid -> (let find_in_sig = (fun lid -> (match ((let _111_363 = (sigmap env)
in (FStar_Util.smap_try_find _111_363 lid.FStar_Absyn_Syntax.str))) with
| Some (FStar_Absyn_Syntax.Sig_typ_abbrev (lid, tps, k, def, _42_350, _42_352), _42_356) -> begin
(let t = (let _111_366 = (let _111_365 = (let _111_364 = (FStar_Absyn_Util.close_with_lam tps def)
in (_111_364, lid))
in FStar_Absyn_Syntax.Meta_named (_111_365))
in (FStar_Absyn_Syntax.mk_Typ_meta _111_366))
in Some (t))
end
| _42_361 -> begin
None
...
let lookup_letbinding_quals = (fun env lid -> (let find_in_sig = (fun lid -> (match ((let _111_373 = (sigmap env)
in (FStar_Util.smap_try_find _111_373 lid.FStar_Absyn_Syntax.str))) with
...
let try_lookup_let = (fun env lid -> (let find_in_sig = (fun lid -> (match ((let _111_385 = (sigmap env)
in (FStar_Util.smap_try_find _111_385 lid.FStar_Absyn_Syntax.str))) with
| Some (FStar_Absyn_Syntax.Sig_let (_42_400), _42_403) -> begin
(let _111_387 = (let _111_386 = (FStar_Absyn_Syntax.range_of_lid lid)
in (FStar_Absyn_Util.fvar None lid _111_386))
in Some (_111_387))
end
| _42_407 -> begin
None
...
let try_lookup_datacon = (fun env lid -> (let find_in_sig = (fun lid -> (match ((let _111_406 = (sigmap env)
in (FStar_Util.smap_try_find _111_406 lid.FStar_Absyn_Syntax.str))) with
...
| true -> begin
(let _111_408 = (FStar_Absyn_Util.fv lid)
in Some (_111_408))
end
| false -> begin
None
...
(let _111_409 = (FStar_Absyn_Util.fv lid)
in Some (_111_409))
end
| _42_451 -> begin
None
...
let find_all_datacons = (fun env lid -> (let find_in_sig = (fun lid -> (match ((let _111_416 = (sigmap env)
in (FStar_Util.smap_try_find _111_416 lid.FStar_Absyn_Syntax.str))) with
...
| true -> begin
(match ((let _111_440 = (find_dc dc)
in (FStar_All.pipe_left FStar_Util.must _111_440))) with
...
| false -> begin
(let _111_444 = (let _111_443 = (let _111_442 = (FStar_Absyn_Util.unmangle_field_name x.FStar_Absyn_Syntax.v.FStar_Absyn_Syntax.ppname)
in (qual constrname _111_442))
in (_111_443, x.FStar_Absyn_Syntax.sort))
in (_111_444)::[])
end)
end
| _42_561 -> begin
...
in (let _111_446 = (let _111_445 = (FStar_ST.read record_cache)
in (record)::_111_445)
in (FStar_ST.op_Colon_Equals record_cache _111_446)))))
end
| _42_565 -> begin
()
end)
...
| (ns, fieldname) -> begin
(let _111_462 = (FStar_ST.read record_cache)
in (FStar_Util.find_map _111_462 (fun record -> (let constrname = record.constrname.FStar_Absyn_Syntax.ident
...
(let _111_503 = (let _111_502 = (let _111_501 = (FStar_Absyn_Util.genident (Some (id.FStar_Absyn_Syntax.idRange)))
in (id, _111_501))
in (FStar_Absyn_Util.mkbvd _111_502))
in FStar_Util.Inl (_111_503))
end
| Binding_var (id) -> begin
(let _111_506 = (let _111_505 = (let _111_504 = (FStar_Absyn_Util.genident (Some (id.FStar_Absyn_Syntax.idRange)))
in (id, _111_504))
in (FStar_Absyn_Util.mkbvd _111_505))
in FStar_Util.Inr (_111_506))
end
| _42_656 -> begin
...
| false -> begin
(let _111_533 = (let _111_532 = (let _111_531 = (FStar_Absyn_Syntax.range_of_lid lid)
in ((Prims.strcat "Duplicate top-level names " lid.FStar_Absyn_Syntax.str), _111_531))
in FStar_Absyn_Syntax.Error (_111_532))
in (Prims.raise _111_533))
end)
end
| _42_696 -> begin
...
let push_sigelt = (fun env s -> (let err = (fun l -> (let sopt = (let _111_540 = (sigmap env)
in (FStar_Util.smap_try_find _111_540 l.FStar_Absyn_Syntax.str))
in (let r = (match (sopt) with
| Some (se, _42_704) -> begin
(match ((let _111_541 = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_Util.find_opt (FStar_Absyn_Syntax.lid_equals l) _111_541))) with
| Some (l) -> begin
(let _111_542 = (FStar_Absyn_Syntax.range_of_lid l)
in (FStar_All.pipe_left FStar_Range.string_of_range _111_542))
end
| None -> begin
"<unknown>"
end)
...
in (let _111_547 = (let _111_546 = (let _111_545 = (let _111_543 = (FStar_Absyn_Syntax.text_of_lid l)
in (FStar_Util.format2 "Duplicate top-level names [%s]; previously declared at %s" _111_543 r))
in (let _111_544 = (FStar_Absyn_Syntax.range_of_lid l)
in (_111_545, _111_544)))
in FStar_Absyn_Syntax.Error (_111_546))
in (Prims.raise _111_547)))))
...
(let _111_551 = (FStar_List.map (fun se -> (let _111_550 = (FStar_Absyn_Util.lids_of_sigelt se)
in (_111_550, se))) ses)
in (env, _111_551))
end
| _42_744 -> begin
(let _111_554 = (let _111_553 = (let _111_552 = (FStar_Absyn_Util.lids_of_sigelt s)
in (_111_552, s))
in (_111_553)::[])
in (env, _111_554))
end)
...
| (lids, se) -> begin
(FStar_All.pipe_right lids (FStar_List.iter (fun lid -> (let _111_557 = (sigmap env)
in (FStar_Util.smap_add _111_557 lid.FStar_Absyn_Syntax.str (se, (env.iface && (not (env.admitted_iface)))))))))
end))))
in env)
end)))))
...
let check_admits = (fun nm env -> (let warn = (not ((let _111_573 = (FStar_ST.read FStar_Options.admit_fsi)
in (FStar_All.pipe_right _111_573 (FStar_Util.for_some (fun l -> (nm.FStar_Absyn_Syntax.str = l)))))))
...
| true -> begin
(let _111_578 = (let _111_577 = (let _111_575 = (FStar_Absyn_Syntax.range_of_lid l)
in (FStar_Range.string_of_range _111_575))
in (let _111_576 = (FStar_Absyn_Print.sli l)
in (FStar_Util.format2 "%s: Warning: Admitting %s without a definition\n" _111_577 _111_576)))
in (FStar_Util.print_string _111_578))
end
| false -> begin
()
end)
in (let _111_579 = (sigmap env)
in (FStar_Util.smap_add _111_579 l.FStar_Absyn_Syntax.str (FStar_Absyn_Syntax.Sig_val_decl ((l, t, (FStar_Absyn_Syntax.Assumption)::quals, r)), false))))
end
| Some (_42_787) -> begin
()
end)
...
(let _111_586 = (sigmap env)
in (FStar_Util.smap_remove _111_586 lid.FStar_Absyn_Syntax.str))
end
| _42_817 -> begin
()
end))))
...
(match ((FStar_List.contains FStar_Absyn_Syntax.Private quals)) with
| true -> begin
(let _111_587 = (sigmap env)
in (FStar_Util.smap_remove _111_587 lid.FStar_Absyn_Syntax.str))
end
| false -> begin
()
end)
...
| true -> begin
(let _111_620 = (let _111_619 = (let _111_618 = (FStar_Util.format1 "Duplicate module or interface name: %s" mname.FStar_Absyn_Syntax.str)
in (let _111_617 = (FStar_Absyn_Syntax.range_of_lid mname)
in (_111_618, _111_617)))
in FStar_Absyn_Syntax.Error (_111_619))
in (Prims.raise _111_620))
end
| false -> begin
()
end)
...
(let _111_635 = (range_of_occurrence o)
in Some (_111_635))
end)
...
| Some (r) -> begin
(let _111_636 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "(Possible clash with related name at %s)" _111_636))
end)
in (let _111_641 = (let _111_640 = (let _111_639 = (let _111_637 = (FStar_Absyn_Syntax.text_of_lid lid)
in (FStar_Util.format2 "Identifier not found: [%s] %s" _111_637 msg))
in (let _111_638 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_111_639, _111_638)))
in FStar_Absyn_Syntax.Error (_111_640))
in (Prims.raise _111_641))))
end
| Some (r) -> begin
r
end))
