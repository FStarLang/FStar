...
# 85 "dsenv.fs"
let try_lookup_typ_var : env  ->  FStar_Ident.ident  ->  (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax Prims.option = (fun env id -> (
# 86 "dsenv.fs"
let fopt = (FStar_List.tryFind (fun _61_77 -> (match (_61_77) with
| (_61_75, b) -> begin
(match (b) with
| (Binding_typ_var (id')) | (Binding_var (id')) -> begin
...
# 180 "dsenv.fs"
let find_in_sig = (fun lid -> (match ((let _163_301 = (sigmap env)
...
# 242 "dsenv.fs"
let try_resolve_typ_abbrev : env  ->  FStar_Ident.lident  ->  (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax Prims.option = (fun env lid -> (
# 243 "dsenv.fs"
let find_in_sig = (fun lid -> (match ((let _163_362 = (sigmap env)
...
# 252 "dsenv.fs"
let find_in_sig = (fun lid -> (match ((let _163_372 = (sigmap env)
...
# 265 "dsenv.fs"
let try_lookup_let : env  ->  FStar_Ident.lident  ->  (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax Prims.option = (fun env lid -> (
# 266 "dsenv.fs"
let find_in_sig = (fun lid -> (match ((let _163_384 = (sigmap env)
...
# 278 "dsenv.fs"
let try_lookup_datacon : env  ->  FStar_Ident.lident  ->  (FStar_Ident.lid, (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.withinfo_t Prims.option = (fun env lid -> (
# 279 "dsenv.fs"
let find_in_sig = (fun lid -> (match ((let _163_404 = (sigmap env)
...
# 289 "dsenv.fs"
let find_all_datacons : env  ->  FStar_Ident.lident  ->  FStar_Absyn_Syntax.lident Prims.list Prims.option = (fun env lid -> (
# 290 "dsenv.fs"
let find_in_sig = (fun lid -> (match ((let _163_412 = (sigmap env)
...
in (
# 307 "dsenv.fs"
let push = (fun _61_506 -> (match (()) with
| () -> begin
...
in (
# 309 "dsenv.fs"
let pop = (fun _61_508 -> (match (()) with
| () -> begin
...
in (
# 311 "dsenv.fs"
let peek = (fun _61_510 -> (match (()) with
| () -> begin
...
in (
# 312 "dsenv.fs"
let insert = (fun r -> (let _163_456 = (let _163_455 = (let _163_452 = (peek ())
in (r)::_163_452)
...
in (FStar_Util.find_map _163_547 (fun record -> (
# 381 "dsenv.fs"
...
# 402 "dsenv.fs"
let _61_689 = (fieldname.FStar_Ident.ns, fieldname.FStar_Ident.ident)
...
# 444 "dsenv.fs"
let push_bvvdef : env  ->  (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax FStar_Absyn_Syntax.bvdef  ->  env = (fun env x -> (
# 445 "dsenv.fs"
...
# 448 "dsenv.fs"
let push_btvdef : env  ->  (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax FStar_Absyn_Syntax.bvdef  ->  env = (fun env x -> (
# 449 "dsenv.fs"
...
# 452 "dsenv.fs"
let push_local_binding : env  ->  binding  ->  (env * ((FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax FStar_Absyn_Syntax.bvdef, (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax FStar_Absyn_Syntax.bvdef) FStar_Util.either) = (fun env b -> (
# 453 "dsenv.fs"
let bvd = (gen_bvd b)
in ((
# 454 "dsenv.fs"
...
let err = (fun l -> (
# 477 "dsenv.fs"
let sopt = (let _163_630 = (sigmap env)
...
# 513 "dsenv.fs"
let aux = (fun _61_856 -> (match (()) with
| () -> begin
...
# 524 "dsenv.fs"
let warn = (not ((let _163_670 = (FStar_ST.read FStar_Options.admit_fsi)
...
# 536 "dsenv.fs"
let _61_923 = (FStar_All.pipe_right modul.FStar_Absyn_Syntax.declarations (FStar_List.iter (fun _61_15 -> (match (_61_15) with
...
in (
# 583 "dsenv.fs"
let _61_990 = (FStar_All.pipe_right keys (FStar_List.iter (fun k -> (match ((FStar_Util.smap_try_find sm' k)) with
...
# 596 "dsenv.fs"
let _61_994 = if (not (modul.FStar_Absyn_Syntax.is_interface)) then begin
