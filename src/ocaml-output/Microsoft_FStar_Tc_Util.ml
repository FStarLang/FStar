...
(let _30_2008 = (match (((Microsoft_FStar_Tc_Env.lookup_typ_abbrev env Microsoft_FStar_Absyn_Const.as_requires), (Microsoft_FStar_Tc_Env.lookup_typ_abbrev env Microsoft_FStar_Absyn_Const.as_ensures))) with
| (Some (x), Some (y)) -> begin
(x, y)
end
| _ -> begin
