...
in (Support.All.pipe_left (fun ( _103_52 ) -> Some (_103_52)) _103_53))
end)
end))
...
| _37_57 -> begin
(let _37_58 = e
in (let _103_63 = (Support.Microsoft.FStar.Util.mk_ref (Some (t2)))
...
in (Support.All.pipe_right _103_73 Support.Prims.fst)))
...
in (Support.All.pipe_right _103_80 Support.Prims.fst)))
...
in (Support.All.pipe_right _103_87 Support.Prims.fst)))
...
| None -> begin
(let _103_106 = (let _103_105 = (Support.Microsoft.FStar.Range.string_of_range s.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Microsoft.FStar.Util.format1 "Impossible: Forced tk not present (%s)" _103_105))
in (Support.All.failwith _103_106))
end
| Some (tk) -> begin
tk
end))
...
in Support.Microsoft.FStar.Util.Inl (_103_110))
in (_103_111, imp))
end
| (Support.Microsoft.FStar.Util.Inr (v), imp) -> begin
(let _103_113 = (let _103_112 = (force_tk v)
in Support.Microsoft.FStar.Util.Inr (_103_112))
in (_103_113, imp))
end)))))
...
in (Support.All.pipe_right _103_124 (Microsoft_FStar_Tc_Normalize.norm_kind ((Microsoft_FStar_Tc_Normalize.WHNF)::(Microsoft_FStar_Tc_Normalize.Beta)::(Microsoft_FStar_Tc_Normalize.Eta)::[]) env)))
...
in (Support.All.pipe_right _103_134 Support.Prims.fst))
in (Support.All.pipe_right _103_137 (fun ( x ) -> (let _103_136 = (Microsoft_FStar_Absyn_Syntax.as_implicit true)
in (Support.Microsoft.FStar.Util.Inl (x), _103_136)))))
end
...
in (Support.All.pipe_right _103_139 Support.Prims.fst))
in (Support.All.pipe_right _103_142 (fun ( x ) -> (let _103_141 = (Microsoft_FStar_Absyn_Syntax.as_implicit true)
in (Support.Microsoft.FStar.Util.Inr (x), _103_141)))))
end)
...
in (Support.All.pipe_right _103_147 Support.Prims.fst))
...
in (Support.All.pipe_left (force_trivial env) _103_149))
in ([], bs, kres)))))))
end
| _37_191 -> begin
...
in (let _103_185 = (Support.All.pipe_right args Support.List.rev)
...
in (let _103_193 = (Support.All.pipe_right (Support.List.rev b) Support.List.flatten)
in (let _103_192 = (Support.All.pipe_right (Support.List.rev a) Support.List.flatten)
in (let _103_191 = (Support.All.pipe_right (Support.List.rev w) Support.List.flatten)
in (_103_193, _103_192, _103_191, env, Support.Microsoft.FStar.Util.Inr (e), (let _37_328 = p
...
in (Support.Microsoft.FStar.Util.format1 "Insufficient pattern arguments (%s)" _103_218))
...
(let _103_241 = (let _103_240 = (let _103_239 = (Microsoft_FStar_Tc_Errors.nonlinear_pattern_variable (Support.Microsoft.FStar.Util.Inr (x)))
...
(let _103_244 = (let _103_243 = (let _103_242 = (Microsoft_FStar_Tc_Errors.nonlinear_pattern_variable (Support.Microsoft.FStar.Util.Inl (x)))
...
in (_103_259)::args)
in ((Support.List.append w' w), _103_260, (p)::pats))
end)
end))
end)) pats ([], [], []))
...
in (_103_261)::args)
in ((Support.List.append b w), _103_262, (let _37_537 = p
...
in (let rec aux = (fun ( p ) ( e ) -> (let pkg = (fun ( q ) ( t ) -> (let _103_283 = (Support.All.pipe_left (fun ( _103_282 ) -> Some (_103_282)) (Support.Microsoft.FStar.Util.Inr (t)))
...
in (Support.Microsoft.FStar.Util.format2 "Expected pattern variable %s; got %s" _103_286 _103_285)))
in (Support.All.failwith _103_287))
end
| false -> begin
()
end)
...
in (Support.Microsoft.FStar.Util.format2 "Expected pattern variable %s; got %s" _103_292 _103_291)))
in (Support.All.failwith _103_293))
end
| false -> begin
()
end)
...
| true -> begin
(let _103_296 = (Support.Microsoft.FStar.Util.format2 "Expected pattern constructor %s; got %s" fv.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.str fv'.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.str)
in (Support.All.failwith _103_296))
end
| false -> begin
()
end)
...
| true -> begin
(let _103_297 = (Support.Microsoft.FStar.Util.format2 "Expected pattern constructor %s; got %s" fv.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.str fv'.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.str)
in (Support.All.failwith _103_297))
end
| false -> begin
()
end)
...
in (pkg (Microsoft_FStar_Absyn_Syntax.Pat_cons ((fv, q, (Support.List.rev matched_pats)))) _103_304))
end
...
in (let q = (let _103_307 = (Support.All.pipe_left (fun ( _103_306 ) -> Some (_103_306)) (Support.Microsoft.FStar.Util.Inl (x.Microsoft_FStar_Absyn_Syntax.sort)))
...
in (let q = (let _103_310 = (Support.All.pipe_left (fun ( _103_309 ) -> Some (_103_309)) (Support.Microsoft.FStar.Util.Inr (x.Microsoft_FStar_Absyn_Syntax.sort)))
...
in (Support.All.failwith _103_314))
end))
in (match_args [] args argpats))))
end
| _37_716 -> begin
(let _103_319 = (let _103_318 = (Support.Microsoft.FStar.Range.string_of_range qq.Microsoft_FStar_Absyn_Syntax.p)
in (let _103_317 = (Microsoft_FStar_Absyn_Print.pat_to_string qq)
in (let _103_316 = (let _103_315 = (Support.All.pipe_right exps (Support.List.map Microsoft_FStar_Absyn_Print.exp_to_string))
in (Support.All.pipe_right _103_315 (Support.String.concat "\n\t")))
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: pattern to decorate is %s; expression is %s\n" _103_318 _103_317 _103_316))))
in (Support.All.failwith _103_319))
end))))
and aux_t = (fun ( p ) ( t0 ) -> (let pkg = (fun ( q ) ( k ) -> (let _103_327 = (Support.All.pipe_left (fun ( _103_326 ) -> Some (_103_326)) (Support.Microsoft.FStar.Util.Inl (k)))
...
in (Support.Microsoft.FStar.Util.format2 "Expected pattern variable %s; got %s" _103_329 _103_328)))
in (Support.All.failwith _103_330))
end
| false -> begin
()
end)
...
in (Support.Microsoft.FStar.Util.format2 "Expected pattern variable %s; got %s" _103_332 _103_331)))
in (Support.All.failwith _103_333))
end
| false -> begin
()
end)
...
| _37_750 -> begin
(let _103_337 = (let _103_336 = (Support.Microsoft.FStar.Range.string_of_range p.Microsoft_FStar_Absyn_Syntax.p)
...
in (Support.All.failwith _103_337))
end))))
...
in (let _103_339 = (Support.All.pipe_left (fun ( _103_338 ) -> Some (_103_338)) (Support.Microsoft.FStar.Util.Inr (Microsoft_FStar_Absyn_Syntax.tun)))
...
| Microsoft_FStar_Absyn_Syntax.Pat_constant (c) -> begin
(let _103_362 = (Support.All.pipe_right (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant c) pkg)
in ([], _103_362))
end
| (Microsoft_FStar_Absyn_Syntax.Pat_wild (x)) | (Microsoft_FStar_Absyn_Syntax.Pat_var (x)) -> begin
(let _103_365 = (Support.All.pipe_right (Microsoft_FStar_Absyn_Syntax.mk_Exp_bvar x) pkg)
in ((Support.Microsoft.FStar.Util.Inr (x))::[], _103_365))
end
| Microsoft_FStar_Absyn_Syntax.Pat_cons ((fv, q, pats)) -> begin
(let _37_796 = (let _103_366 = (Support.All.pipe_right pats (Support.List.map pat_as_arg))
in (Support.All.pipe_right _103_366 Support.List.unzip))
...
in (Support.All.pipe_right _103_371 pkg))
in (vars, _103_372)))
end))
end
...
in ((Support.Microsoft.FStar.Util.Inl (a))::[], _103_374))
end
...
in (Support.All.pipe_right _103_398 Support.Prims.fst))
in ((let _37_897 = a
...
in (Support.All.pipe_right _103_403 Support.Prims.fst))
...
| true -> begin
(let _103_411 = (Support.Microsoft.FStar.Range.string_of_range r)
...
in (Support.All.pipe_right _103_412 Support.Prims.fst))
in (e, _103_413, false))
end))
...
| _37_990 -> begin
(let _103_419 = (let _103_418 = (let _103_417 = (Support.List.map Microsoft_FStar_Absyn_Print.arg_to_string c.Microsoft_FStar_Absyn_Syntax.effect_args)
in (Support.All.pipe_right _103_417 (Support.String.concat ", ")))
in (Support.Microsoft.FStar.Util.format2 "Impossible: Got a computation %s with effect args [%s]" c.Microsoft_FStar_Absyn_Syntax.effect_name.Microsoft_FStar_Absyn_Syntax.str _103_418))
in (Support.All.failwith _103_419))
end)
...
in (Support.All.pipe_left (Microsoft_FStar_Tc_Normalize.norm_typ ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env) _103_517))
in (let wlp = wp
...
| true -> begin
(let _103_520 = (Support.Microsoft.FStar.Range.string_of_range v.Microsoft_FStar_Absyn_Syntax.pos)
...
| true -> begin
(let _103_538 = (Microsoft_FStar_Absyn_Util.subst_comp ((Support.Microsoft.FStar.Util.Inr ((x, e)))::[]) c2)
in (Support.All.pipe_left (fun ( _103_537 ) -> Some (_103_537)) _103_538))
end
| false -> begin
(aux ())
end)
...
in (Support.All.pipe_left Support.Microsoft.FStar.Range.string_of_range _103_600))
...
in (Support.All.pipe_left Microsoft_FStar_Absyn_Print.comp_typ_to_string _103_602))
...
in (Support.All.pipe_left Support.Prims.op_Negation _103_639))) with
| true -> begin
f
end
| false -> begin
...
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _103_700))
...
in (Support.All.pipe_left Support.Prims.op_Negation _103_715)))) with
| true -> begin
flags
end
| false -> begin
...
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _103_732))
in (let _103_734 = (let _103_733 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ yret)
in (_103_733)::[])
...
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _103_743))
in (_103_744)::[])
...
in (let _103_784 = (Support.Microsoft.FStar.Range.union_ranges wp_t.Microsoft_FStar_Absyn_Syntax.pos wp_e.Microsoft_FStar_Absyn_Syntax.pos)
...
in (let _103_827 = (Support.Microsoft.FStar.Range.union_ranges wp_t.Microsoft_FStar_Absyn_Syntax.pos wp_e.Microsoft_FStar_Absyn_Syntax.pos)
...
in (Support.All.pipe_left _103_839 _103_838)))
...
(let bs = (let _103_882 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.v_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_103_882)::[])
...
(let bs = (let _103_890 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.t_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_103_890)::[])
in (let wp = (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam (bs, wp) None wp.Microsoft_FStar_Absyn_Syntax.pos)
...
in (Support.All.pipe_left lcomp_of_comp _103_904))
...
in (Support.All.pipe_right _103_950 (Microsoft_FStar_Absyn_Util.subst_typ subst)))
...
in (Support.All.pipe_left lcomp_of_comp _103_971))
...
in (let _37_1647 = (let _103_982 = (Support.All.pipe_left (fun ( _103_979 ) -> Some (_103_979)) (Microsoft_FStar_Tc_Errors.subtyping_failed env lc.Microsoft_FStar_Absyn_Syntax.res_typ t))
in (let _103_981 = (Microsoft_FStar_Tc_Env.set_range env e.Microsoft_FStar_Absyn_Syntax.pos)
in (let _103_980 = (Support.All.pipe_left Microsoft_FStar_Tc_Rel.guard_of_guard_formula (Microsoft_FStar_Tc_Rel.NonTrivial (guard)))
...
in (Support.All.pipe_left lcomp_of_comp _103_983))
...
| true -> begin
(let ue = (let _103_992 = (Support.Microsoft.FStar.Util.set_elements uvt.Microsoft_FStar_Absyn_Syntax.uvars_e)
in (Support.List.map Microsoft_FStar_Absyn_Print.uvar_e_to_string _103_992))
in (let ut = (let _103_993 = (Support.Microsoft.FStar.Util.set_elements uvt.Microsoft_FStar_Absyn_Syntax.uvars_t)
in (Support.List.map Microsoft_FStar_Absyn_Print.uvar_t_to_string _103_993))
in (let uk = (let _103_994 = (Support.Microsoft.FStar.Util.set_elements uvt.Microsoft_FStar_Absyn_Syntax.uvars_k)
in (Support.List.map Microsoft_FStar_Absyn_Print.uvar_k_to_string _103_994))
...
in (Support.Microsoft.FStar.Util.format2 "Unconstrained unification variables %s in type signature %s; please add an annotation" union _103_995))
...
let gen = (fun ( verify ) ( env ) ( ecs ) -> (match ((let _103_1004 = (Support.Microsoft.FStar.Util.for_all (fun ( _37_1684 ) -> (match (_37_1684) with
| (_37_1682, c) -> begin
(Microsoft_FStar_Absyn_Util.is_pure_comp c)
end)) ecs)
in (Support.All.pipe_left Support.Prims.op_Negation _103_1004))) with
| true -> begin
None
end
| false -> begin
...
in (let gen_uvars = (fun ( uvs ) -> (let _103_1011 = (Support.Microsoft.FStar.Util.set_difference uvs env_uvars.Microsoft_FStar_Absyn_Syntax.uvars_t)
in (Support.All.pipe_right _103_1011 Support.Microsoft.FStar.Util.set_elements)))
...
in (Support.All.pipe_left Support.Prims.op_Negation _103_1016))) with
| true -> begin
([], e, c)
end
| false -> begin
...
in (Support.All.pipe_left Support.Prims.op_Negation _103_1017)))) with
| true -> begin
...
in (Support.All.pipe_left (Microsoft_FStar_Absyn_Syntax.syn wp.Microsoft_FStar_Absyn_Syntax.pos (Some (Microsoft_FStar_Absyn_Syntax.ktype))) _103_1028))
...
in (let _103_1030 = (Support.All.pipe_left Microsoft_FStar_Tc_Rel.guard_of_guard_formula (Microsoft_FStar_Tc_Rel.NonTrivial (vc)))
...
in (Support.All.pipe_left (fun ( _103_1033 ) -> Some (_103_1033)) _103_1034))
...
| true -> begin
(let _103_1046 = (let _103_1045 = (Support.List.map (fun ( _37_1811 ) -> (match (_37_1811) with
| (lb, _37_1808, _37_1810) -> begin
(Microsoft_FStar_Absyn_Print.lbname_to_string lb)
end)) lecs)
in (Support.All.pipe_right _103_1045 (Support.String.concat ", ")))
in (Support.Microsoft.FStar.Util.fprint1 "Generalizing: %s" _103_1046))
end
| false -> begin
()
end)
in (match ((let _103_1048 = (Support.All.pipe_right lecs (Support.List.map (fun ( _37_1818 ) -> (match (_37_1818) with
| (_37_1815, e, c) -> begin
(e, c)
end))))
...
| true -> begin
(let _103_1053 = (Support.Microsoft.FStar.Range.string_of_range e.Microsoft_FStar_Absyn_Syntax.pos)
...
in (Support.Microsoft.FStar.Util.fprint3 "(%s) Generalized %s to %s" _103_1053 _103_1052 _103_1051))))
end
| false -> begin
()
end)
...
in (Support.All.pipe_right _103_1066 Microsoft_FStar_Absyn_Util.comp_to_comp_typ))
...
in (let g = (let _103_1073 = (Support.All.pipe_left Microsoft_FStar_Tc_Rel.guard_of_guard_formula (Microsoft_FStar_Tc_Rel.NonTrivial (vc)))
...
(let _103_1094 = (f fst)
in (Support.All.pipe_right _103_1094 (fun ( _103_1093 ) -> Some (_103_1093))))
end
| _37_1887 -> begin
...
in (Support.All.pipe_right _103_1143 (fun ( _103_1142 ) -> Microsoft_FStar_Tc_Rel.NonTrivial (_103_1142)))))
in (let op_or_t = (fun ( t ) -> (let _103_1148 = (let _103_1146 = (unlabel t)
in (Support.All.pipe_right _103_1146 Microsoft_FStar_Absyn_Util.mk_neg))
in (Support.All.pipe_right _103_1148 (fun ( _103_1147 ) -> Microsoft_FStar_Tc_Rel.NonTrivial (_103_1147)))))
in (let op_imp_t = (fun ( t ) -> (let _103_1152 = (unlabel t)
in (Support.All.pipe_right _103_1152 (fun ( _103_1151 ) -> Microsoft_FStar_Tc_Rel.NonTrivial (_103_1151)))))
...
in (Support.All.pipe_right _103_1156 (fun ( _103_1155 ) -> Microsoft_FStar_Tc_Rel.NonTrivial (_103_1155))))
end
| _37_1943 -> begin
...
in (Support.All.pipe_left norm _103_1201))
...
in (_103_1206)::[])
in ((Support.Microsoft.FStar.Util.Inl (ct.Microsoft_FStar_Absyn_Syntax.result_typ), Some (Microsoft_FStar_Absyn_Syntax.Implicit)))::_103_1207)
in (as_req, _103_1208))
...
in (_103_1210)::[])
in ((Support.Microsoft.FStar.Util.Inl (ct.Microsoft_FStar_Absyn_Syntax.result_typ), Some (Microsoft_FStar_Absyn_Syntax.Implicit)))::_103_1211)
in (as_ens, _103_1212))
