...
let report = (fun ( env ) ( errs ) -> (let _65_14744 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _65_14743 = (Microsoft_FStar_Tc_Errors.failed_to_prove_specification errs)
in (Microsoft_FStar_Tc_Errors.report _65_14744 _65_14743))))
...
let syn' = (fun ( env ) ( k ) -> (let _65_14763 = (Microsoft_FStar_Tc_Env.get_range env)
in (Microsoft_FStar_Absyn_Syntax.syn _65_14763 k)))
...
| Some (f) -> begin
(let _65_14787 = (Microsoft_FStar_Tc_Rel.apply_guard f e)
in (Support.Prims.pipe_left (fun ( _65_14786 ) -> Some (_65_14786)) _65_14787))
end)
end))
...
| None -> begin
(let _65_14791 = (let _65_14790 = (let _65_14789 = (Microsoft_FStar_Tc_Errors.expected_pattern_of_type env t2 e t1)
in (let _65_14788 = (Microsoft_FStar_Tc_Env.get_range env)
in (_65_14789, _65_14788)))
in Microsoft_FStar_Absyn_Syntax.Error (_65_14790))
in (raise (_65_14791)))
end
| Some (g) -> begin
(e, g)
...
| None -> begin
(let _65_14795 = (let _65_14794 = (let _65_14793 = (Microsoft_FStar_Tc_Errors.expected_expression_of_type env t2 e t1)
in (let _65_14792 = (Microsoft_FStar_Tc_Env.get_range env)
in (_65_14793, _65_14792)))
in Microsoft_FStar_Absyn_Syntax.Error (_65_14794))
in (raise (_65_14795)))
end
| Some (g) -> begin
(let _35_49 = (match ((Support.Prims.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Rel")))) with
| true -> begin
(let _65_14796 = (Microsoft_FStar_Tc_Rel.guard_to_string env g)
...
| _ -> begin
(let _35_56 = e
in (let _65_14797 = (Support.Microsoft.FStar.Util.mk_ref (Some (t2)))
in {Microsoft_FStar_Absyn_Syntax.n = _35_56.Microsoft_FStar_Absyn_Syntax.n; Microsoft_FStar_Absyn_Syntax.tk = _65_14797; Microsoft_FStar_Absyn_Syntax.pos = _35_56.Microsoft_FStar_Absyn_Syntax.pos; Microsoft_FStar_Absyn_Syntax.fvs = _35_56.Microsoft_FStar_Absyn_Syntax.fvs; Microsoft_FStar_Absyn_Syntax.uvs = _35_56.Microsoft_FStar_Absyn_Syntax.uvs}))
end)
in (e, g))))
end)
end))))
...
let new_kvar = (fun ( env ) -> (let _65_14807 = (let _65_14806 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _65_14805 = (env_binders env)
in (Microsoft_FStar_Tc_Rel.new_kvar _65_14806 _65_14805)))
in (Support.Prims.pipe_right _65_14807 Support.Prims.fst)))

let new_tvar = (fun ( env ) ( k ) -> (let _65_14814 = (let _65_14813 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _65_14812 = (env_binders env)
in (Microsoft_FStar_Tc_Rel.new_tvar _65_14813 _65_14812 k)))
in (Support.Prims.pipe_right _65_14814 Support.Prims.fst)))

let new_evar = (fun ( env ) ( t ) -> (let _65_14821 = (let _65_14820 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _65_14819 = (env_binders env)
in (Microsoft_FStar_Tc_Rel.new_evar _65_14820 _65_14819 t)))
in (Support.Prims.pipe_right _65_14821 Support.Prims.fst)))

let new_implicit_tvar = (fun ( env ) ( k ) -> (let _35_103 = (let _65_14827 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _65_14826 = (env_binders env)
in (Microsoft_FStar_Tc_Rel.new_tvar _65_14827 _65_14826 k)))
in (match (_35_103) with
| (t, u) -> begin
(let _65_14829 = (let _65_14828 = (as_uvar_t u)
in (_65_14828, u.Microsoft_FStar_Absyn_Syntax.pos))
in (t, _65_14829))
end)))

let new_implicit_evar = (fun ( env ) ( t ) -> (let _35_108 = (let _65_14835 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _65_14834 = (env_binders env)
in (Microsoft_FStar_Tc_Rel.new_evar _65_14835 _65_14834 t)))
in (match (_35_108) with
| (e, u) -> begin
(let _65_14837 = (let _65_14836 = (as_uvar_e u)
in (_65_14836, u.Microsoft_FStar_Absyn_Syntax.pos))
in (e, _65_14837))
end)))

let force_tk = (fun ( s ) -> (match ((Support.ST.read s.Microsoft_FStar_Absyn_Syntax.tk)) with
| None -> begin
(let _65_14840 = (let _65_14839 = (Support.Microsoft.FStar.Range.string_of_range s.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Microsoft.FStar.Util.format1 "Impossible: Forced tk not present (%s)" _65_14839))
in (failwith (_65_14840)))
end
| Some (tk) -> begin
tk
end))
...
(let _65_14845 = (let _65_14844 = (force_tk t)
in Support.Microsoft.FStar.Util.Inl (_65_14844))
in (_65_14845, imp))
end
| (Support.Microsoft.FStar.Util.Inr (v), imp) -> begin
(let _65_14847 = (let _65_14846 = (force_tk v)
in Support.Microsoft.FStar.Util.Inr (_65_14846))
in (_65_14847, imp))
end)))))
...
let destruct_arrow_kind = (fun ( env ) ( tt ) ( k ) ( args ) -> (let ktop = (let _65_14858 = (Microsoft_FStar_Absyn_Util.compress_kind k)
in (Support.Prims.pipe_right _65_14858 (Microsoft_FStar_Tc_Normalize.norm_kind ((Microsoft_FStar_Tc_Normalize.WHNF)::(Microsoft_FStar_Tc_Normalize.Beta)::(Microsoft_FStar_Tc_Normalize.Eta)::[]) env)))
...
(let _65_14871 = (let _65_14868 = (let _65_14867 = (Microsoft_FStar_Absyn_Util.subst_kind subst a.Microsoft_FStar_Absyn_Syntax.sort)
in (Microsoft_FStar_Tc_Rel.new_tvar r vars _65_14867))
...
in (Support.Microsoft.FStar.Util.Inl (x), _65_14870)))))
end
| Support.Microsoft.FStar.Util.Inr (x) -> begin
(let _65_14876 = (let _65_14873 = (let _65_14872 = (Microsoft_FStar_Absyn_Util.subst_typ subst x.Microsoft_FStar_Absyn_Syntax.sort)
in (Microsoft_FStar_Tc_Rel.new_evar r vars _65_14872))
in (Support.Prims.pipe_right _65_14873 Support.Prims.fst))
in (Support.Prims.pipe_right _65_14876 (fun ( x ) -> (let _65_14875 = (Microsoft_FStar_Absyn_Syntax.as_implicit true)
in (Support.Microsoft.FStar.Util.Inr (x), _65_14875)))))
end)
...
| false -> begin
(let _65_14877 = (Microsoft_FStar_Absyn_Util.subst_formal b imp_arg)
in (_65_14877)::subst)
end)
...
| false -> begin
(let _65_14878 = (Microsoft_FStar_Absyn_Util.subst_binders subst bs)
in ([], _65_14878))
end)
end
| _ -> begin
...
| false -> begin
(let _35_172 = (let _65_14880 = (Microsoft_FStar_Tc_Env.binders env)
in (mk_implicits _65_14880 [] bs))
...
in (let kres = (let _65_14881 = (Microsoft_FStar_Tc_Rel.new_kvar r binders)
in (Support.Prims.pipe_right _65_14881 Support.Prims.fst))
in (let bs = (let _65_14882 = (tks_of_args args)
in (Microsoft_FStar_Absyn_Util.null_binders_of_tks _65_14882))
in (let kar = (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (bs, kres) r)
in (let _35_186 = (let _65_14883 = (Microsoft_FStar_Tc_Rel.keq env None k kar)
in (Support.Prims.pipe_left (force_trivial env) _65_14883))
in ([], bs, kres)))))))
end
| _ -> begin
(let _65_14886 = (let _65_14885 = (let _65_14884 = (Microsoft_FStar_Tc_Errors.expected_tcon_kind env tt ktop)
in (_65_14884, r))
in Microsoft_FStar_Absyn_Syntax.Error (_65_14885))
in (raise (_65_14886)))
end))
in (aux ktop)))))
...
in (let _65_14906 = (Microsoft_FStar_Absyn_Syntax.varg e)
in ([], [], [], env, _65_14906, p)))
end)))
end
| Microsoft_FStar_Absyn_Syntax.Pat_dot_typ ((a, _)) -> begin
(let k = (new_kvar env)
in (let _35_259 = (let _65_14907 = (Microsoft_FStar_Tc_Env.binders env)
in (Microsoft_FStar_Tc_Rel.new_tvar p.Microsoft_FStar_Absyn_Syntax.p _65_14907 k))
...
in (let _65_14909 = (let _65_14908 = (Microsoft_FStar_Absyn_Syntax.as_implicit true)
in (Support.Microsoft.FStar.Util.Inl (t), _65_14908))
in ([], [], [], env, _65_14909, p)))
end)))
end
| Microsoft_FStar_Absyn_Syntax.Pat_constant (c) -> begin
(let e = (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant c None p.Microsoft_FStar_Absyn_Syntax.p)
in (let _65_14910 = (Microsoft_FStar_Absyn_Syntax.varg e)
in ([], [], [], env, _65_14910, p)))
end
| Microsoft_FStar_Absyn_Syntax.Pat_wild (x) -> begin
(let w = (let _65_14912 = (let _65_14911 = (new_tvar env Microsoft_FStar_Absyn_Syntax.ktype)
in (x.Microsoft_FStar_Absyn_Syntax.v, _65_14911))
in Microsoft_FStar_Tc_Env.Binding_var (_65_14912))
...
in (let _65_14913 = (Microsoft_FStar_Absyn_Syntax.varg e)
in ((w)::[], [], (w)::[], env, _65_14913, p)))))
end
| Microsoft_FStar_Absyn_Syntax.Pat_var ((x, imp)) -> begin
(let b = (let _65_14915 = (let _65_14914 = (new_tvar env Microsoft_FStar_Absyn_Syntax.ktype)
in (x.Microsoft_FStar_Absyn_Syntax.v, _65_14914))
in Microsoft_FStar_Tc_Env.Binding_var (_65_14915))
in (let env = (Microsoft_FStar_Tc_Env.push_local_binding env b)
in (let e = (Microsoft_FStar_Absyn_Syntax.mk_Exp_bvar x None p.Microsoft_FStar_Absyn_Syntax.p)
in (let _65_14917 = (let _65_14916 = (Microsoft_FStar_Absyn_Syntax.as_implicit imp)
in (Support.Microsoft.FStar.Util.Inr (e), _65_14916))
in ((b)::[], (b)::[], [], env, _65_14917, p)))))
end
| Microsoft_FStar_Absyn_Syntax.Pat_twild (a) -> begin
(let w = (let _65_14919 = (let _65_14918 = (new_kvar env)
in (a.Microsoft_FStar_Absyn_Syntax.v, _65_14918))
in Microsoft_FStar_Tc_Env.Binding_typ (_65_14919))
in (let env = (match (allow_wc_dependence) with
| true -> begin
(Microsoft_FStar_Tc_Env.push_local_binding env w)
end
...
in (let _65_14920 = (Microsoft_FStar_Absyn_Syntax.targ t)
in ((w)::[], [], (w)::[], env, _65_14920, p)))))
end
| Microsoft_FStar_Absyn_Syntax.Pat_tvar (a) -> begin
(let b = (let _65_14922 = (let _65_14921 = (new_kvar env)
in (a.Microsoft_FStar_Absyn_Syntax.v, _65_14921))
in Microsoft_FStar_Tc_Env.Binding_typ (_65_14922))
in (let env = (Microsoft_FStar_Tc_Env.push_local_binding env b)
in (let t = (Microsoft_FStar_Absyn_Syntax.mk_Typ_btvar a None p.Microsoft_FStar_Absyn_Syntax.p)
in (let _65_14923 = (Microsoft_FStar_Absyn_Syntax.targ t)
in ((b)::[], (b)::[], [], env, _65_14923, p)))))
end
...
| (b, a, w, env, args, pats) -> begin
(let e = (let _65_14931 = (let _65_14930 = (let _65_14929 = (let _65_14928 = (let _65_14927 = (Microsoft_FStar_Absyn_Util.fvar (Some (Microsoft_FStar_Absyn_Syntax.Data_ctor)) fv.Microsoft_FStar_Absyn_Syntax.v fv.Microsoft_FStar_Absyn_Syntax.p)
in (let _65_14926 = (Support.Prims.pipe_right args Support.List.rev)
in (_65_14927, _65_14926)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app' _65_14928 None p.Microsoft_FStar_Absyn_Syntax.p))
in (_65_14929, Microsoft_FStar_Absyn_Syntax.Data_app))
in Microsoft_FStar_Absyn_Syntax.Meta_desugared (_65_14930))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta _65_14931))
in (let _65_14935 = (Support.Prims.pipe_right (Support.List.rev b) Support.List.flatten)
in (let _65_14934 = (Support.Prims.pipe_right (Support.List.rev a) Support.List.flatten)
in (let _65_14933 = (Support.Prims.pipe_right (Support.List.rev w) Support.List.flatten)
in (let _65_14932 = (Microsoft_FStar_Absyn_Syntax.varg e)
in (_65_14935, _65_14934, _65_14933, env, _65_14932, (let _35_316 = p
...
| _ -> begin
(let _65_14942 = (let _65_14941 = (let _65_14940 = (Microsoft_FStar_Absyn_Syntax.range_of_lid fv.Microsoft_FStar_Absyn_Syntax.v)
in ("Too many pattern arguments", _65_14940))
in Microsoft_FStar_Absyn_Syntax.Error (_65_14941))
in (raise (_65_14942)))
end)
end
| Some ((f, _)) -> begin
...
| ([], _::_) -> begin
(let _65_14949 = (let _65_14948 = (let _65_14947 = (Microsoft_FStar_Absyn_Syntax.range_of_lid fv.Microsoft_FStar_Absyn_Syntax.v)
in ("Too many pattern arguments", _65_14947))
in Microsoft_FStar_Absyn_Syntax.Error (_65_14948))
in (raise (_65_14949)))
end
| (_::_, []) -> begin
(Support.Prims.pipe_right formals (Support.List.map (fun ( f ) -> (match (f) with
| (Support.Microsoft.FStar.Util.Inl (t), _) -> begin
(let a = (let _65_14951 = (Microsoft_FStar_Absyn_Util.new_bvd None)
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _65_14951 Microsoft_FStar_Absyn_Syntax.kun))
in (match (allow_implicits) with
| true -> begin
(let _65_14952 = (Microsoft_FStar_Absyn_Syntax.range_of_lid fv.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Syntax.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_dot_typ ((a, Microsoft_FStar_Absyn_Syntax.tun))) None _65_14952))
end
| false -> begin
(let _65_14953 = (Microsoft_FStar_Absyn_Syntax.range_of_lid fv.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Syntax.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_tvar (a)) None _65_14953))
end))
end
...
in (let _65_14954 = (Microsoft_FStar_Absyn_Syntax.range_of_lid fv.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Syntax.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_var ((a, true))) None _65_14954)))
end
| _ -> begin
(let _65_14959 = (let _65_14958 = (let _65_14957 = (let _65_14955 = (Microsoft_FStar_Absyn_Print.pat_to_string p)
in (Support.Microsoft.FStar.Util.format1 "Insufficient pattern arguments (%s)" _65_14955))
in (let _65_14956 = (Microsoft_FStar_Absyn_Syntax.range_of_lid fv.Microsoft_FStar_Absyn_Syntax.v)
in (_65_14957, _65_14956)))
in Microsoft_FStar_Absyn_Syntax.Error (_65_14958))
in (raise (_65_14959)))
end))))
end
...
(let _65_14960 = (aux formals' pats')
in (p)::_65_14960)
end
...
(let a = (let _65_14962 = (Microsoft_FStar_Absyn_Util.new_bvd None)
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _65_14962 Microsoft_FStar_Absyn_Syntax.kun))
in (let p1 = (match (allow_implicits) with
| true -> begin
(let _65_14963 = (Microsoft_FStar_Absyn_Syntax.range_of_lid fv.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Syntax.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_dot_typ ((a, Microsoft_FStar_Absyn_Syntax.tun))) None _65_14963))
end
| false -> begin
(let _65_14964 = (Microsoft_FStar_Absyn_Syntax.range_of_lid fv.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Syntax.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_tvar (a)) None _65_14964))
end)
...
in (let _65_14965 = (aux formals' pats')
in (p1)::_65_14965))))
end
...
(let _65_14966 = (aux formals' pats')
in (p)::_65_14966)
end
| ((Support.Microsoft.FStar.Util.Inr (_), Some (Microsoft_FStar_Absyn_Syntax.Implicit)), _) -> begin
(let a = (Microsoft_FStar_Absyn_Util.gen_bvar Microsoft_FStar_Absyn_Syntax.tun)
in (let p = (let _65_14967 = (Microsoft_FStar_Absyn_Syntax.range_of_lid fv.Microsoft_FStar_Absyn_Syntax.v)
in (Microsoft_FStar_Absyn_Syntax.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_var ((a, true))) None _65_14967))
in (let _65_14968 = (aux formals' pats)
in (p)::_65_14968)))
end
| ((Support.Microsoft.FStar.Util.Inr (_), _), _) -> begin
(let _65_14969 = (aux formals' pats')
in (p)::_65_14969)
end)
end))
in (aux f pats))
...
(let _65_14978 = (let _65_14977 = (let _65_14976 = (Microsoft_FStar_Tc_Errors.nonlinear_pattern_variable (Support.Microsoft.FStar.Util.Inr (x)))
in (_65_14976, p.Microsoft_FStar_Absyn_Syntax.p))
in Microsoft_FStar_Absyn_Syntax.Error (_65_14977))
in (raise (_65_14978)))
end
| Some (Microsoft_FStar_Tc_Env.Binding_typ ((x, _))) -> begin
(let _65_14981 = (let _65_14980 = (let _65_14979 = (Microsoft_FStar_Tc_Errors.nonlinear_pattern_variable (Support.Microsoft.FStar.Util.Inl (x)))
in (_65_14979, p.Microsoft_FStar_Absyn_Syntax.p))
in Microsoft_FStar_Absyn_Syntax.Error (_65_14980))
in (raise (_65_14981)))
end
| _ -> begin
(b, a, w, arg, p)
...
| true -> begin
(let _65_14993 = (let _65_14992 = (let _65_14991 = (let _65_14989 = (vars_of_bindings a)
in (let _65_14988 = (vars_of_bindings a')
in (Microsoft_FStar_Tc_Errors.disjunctive_pattern_vars _65_14989 _65_14988)))
in (let _65_14990 = (Microsoft_FStar_Tc_Env.get_range env)
in (_65_14991, _65_14990)))
in Microsoft_FStar_Absyn_Syntax.Error (_65_14992))
in (raise (_65_14993)))
end
| false -> begin
...
in (let rec aux = (fun ( p ) ( e ) -> (let pkg = (fun ( q ) ( t ) -> (let _65_15012 = (Support.Prims.pipe_left (fun ( _65_15011 ) -> Some (_65_15011)) (Support.Microsoft.FStar.Util.Inr (t)))
in (Microsoft_FStar_Absyn_Syntax.withinfo q _65_15012 p.Microsoft_FStar_Absyn_Syntax.p)))
...
(let _65_15013 = (force_tk e)
in (pkg p.Microsoft_FStar_Absyn_Syntax.v _65_15013))
end
...
| true -> begin
(let _65_15016 = (let _65_15015 = (Microsoft_FStar_Absyn_Print.strBvd x.Microsoft_FStar_Absyn_Syntax.v)
in (let _65_15014 = (Microsoft_FStar_Absyn_Print.strBvd y.Microsoft_FStar_Absyn_Syntax.v)
in (Support.Microsoft.FStar.Util.format2 "Expected pattern variable %s; got %s" _65_15015 _65_15014)))
in (failwith (_65_15016)))
end
| false -> begin
()
end)
...
| true -> begin
(let _65_15018 = (Microsoft_FStar_Absyn_Print.strBvd x.Microsoft_FStar_Absyn_Syntax.v)
in (let _65_15017 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env y.Microsoft_FStar_Absyn_Syntax.sort)
...
in (pkg (Microsoft_FStar_Absyn_Syntax.Pat_var ((x, imp))) _65_15019))))))
end
...
| true -> begin
(let _65_15022 = (let _65_15021 = (Microsoft_FStar_Absyn_Print.strBvd x.Microsoft_FStar_Absyn_Syntax.v)
in (let _65_15020 = (Microsoft_FStar_Absyn_Print.strBvd y.Microsoft_FStar_Absyn_Syntax.v)
in (Support.Microsoft.FStar.Util.format2 "Expected pattern variable %s; got %s" _65_15021 _65_15020)))
in (failwith (_65_15022)))
end
| false -> begin
()
end)
in (let x = (let _35_594 = x
in (let _65_15023 = (force_tk e)
in {Microsoft_FStar_Absyn_Syntax.v = _35_594.Microsoft_FStar_Absyn_Syntax.v; Microsoft_FStar_Absyn_Syntax.sort = _65_15023; Microsoft_FStar_Absyn_Syntax.p = _35_594.Microsoft_FStar_Absyn_Syntax.p}))
...
in {Microsoft_FStar_Absyn_Syntax.v = _35_605.Microsoft_FStar_Absyn_Syntax.v; Microsoft_FStar_Absyn_Syntax.sort = _65_15024; Microsoft_FStar_Absyn_Syntax.p = _35_605.Microsoft_FStar_Absyn_Syntax.p}))
...
| true -> begin
(let _65_15025 = (Support.Microsoft.FStar.Util.format2 "Expected pattern constructor %s; got %s" fv.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.str fv'.Microsoft_FStar_Absyn_Syntax.v.Microsoft_FStar_Absyn_Syntax.str)
in (failwith (_65_15025)))
end
| false -> begin
()
end)
...
| ([], []) -> begin
(let _65_15033 = (force_tk e)
in (pkg (Microsoft_FStar_Absyn_Syntax.Pat_cons ((fv, q, (Support.List.rev matched_pats)))) _65_15033))
end
...
(let x = (let _65_15034 = (force_tk t)
in (Microsoft_FStar_Absyn_Util.gen_bvar_p p.Microsoft_FStar_Absyn_Syntax.p _65_15034))
in (let q = (let _65_15036 = (Support.Prims.pipe_left (fun ( _65_15035 ) -> Some (_65_15035)) (Support.Microsoft.FStar.Util.Inl (x.Microsoft_FStar_Absyn_Syntax.sort)))
in (Microsoft_FStar_Absyn_Syntax.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_dot_typ ((x, t))) _65_15036 p.Microsoft_FStar_Absyn_Syntax.p))
...
(let x = (let _65_15037 = (force_tk e)
in (Microsoft_FStar_Absyn_Util.gen_bvar_p p.Microsoft_FStar_Absyn_Syntax.p _65_15037))
in (let q = (let _65_15039 = (Support.Prims.pipe_left (fun ( _65_15038 ) -> Some (_65_15038)) (Support.Microsoft.FStar.Util.Inr (x.Microsoft_FStar_Absyn_Syntax.sort)))
in (Microsoft_FStar_Absyn_Syntax.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_dot_term ((x, e))) _65_15039 p.Microsoft_FStar_Absyn_Syntax.p))
in (match_args ((q)::matched_pats) args argpats)))
end
...
| _ -> begin
(let _65_15042 = (let _65_15041 = (Microsoft_FStar_Absyn_Print.pat_to_string p)
in (let _65_15040 = (Microsoft_FStar_Absyn_Print.exp_to_string e)
...
| _ -> begin
(let _65_15047 = (let _65_15046 = (Support.Microsoft.FStar.Range.string_of_range qq.Microsoft_FStar_Absyn_Syntax.p)
in (let _65_15045 = (Microsoft_FStar_Absyn_Print.pat_to_string qq)
in (let _65_15044 = (let _65_15043 = (Support.Prims.pipe_right exps (Support.List.map Microsoft_FStar_Absyn_Print.exp_to_string))
in (Support.Prims.pipe_right _65_15043 (Support.String.concat "\n\t")))
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: pattern to decorate is %s; expression is %s\n" _65_15046 _65_15045 _65_15044))))
in (failwith (_65_15047)))
end))))
and aux_t = (fun ( p ) ( t0 ) -> (let pkg = (fun ( q ) ( k ) -> (let _65_15055 = (Support.Prims.pipe_left (fun ( _65_15054 ) -> Some (_65_15054)) (Support.Microsoft.FStar.Util.Inl (k)))
in (Microsoft_FStar_Absyn_Syntax.withinfo q _65_15055 p.Microsoft_FStar_Absyn_Syntax.p)))
...
| true -> begin
(let _65_15058 = (let _65_15057 = (Microsoft_FStar_Absyn_Print.strBvd a.Microsoft_FStar_Absyn_Syntax.v)
in (let _65_15056 = (Microsoft_FStar_Absyn_Print.strBvd b.Microsoft_FStar_Absyn_Syntax.v)
in (Support.Microsoft.FStar.Util.format2 "Expected pattern variable %s; got %s" _65_15057 _65_15056)))
in (failwith (_65_15058)))
end
| false -> begin
()
end)
...
| true -> begin
(let _65_15061 = (let _65_15060 = (Microsoft_FStar_Absyn_Print.strBvd a.Microsoft_FStar_Absyn_Syntax.v)
in (let _65_15059 = (Microsoft_FStar_Absyn_Print.strBvd b.Microsoft_FStar_Absyn_Syntax.v)
in (Support.Microsoft.FStar.Util.format2 "Expected pattern variable %s; got %s" _65_15060 _65_15059)))
in (failwith (_65_15061)))
end
| false -> begin
()
end)
...
| _ -> begin
(let _65_15065 = (let _65_15064 = (Support.Microsoft.FStar.Range.string_of_range p.Microsoft_FStar_Absyn_Syntax.p)
in (let _65_15063 = (Microsoft_FStar_Absyn_Print.pat_to_string p)
in (let _65_15062 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.format3 "(%s) Impossible: pattern to decorate is %s; expression is %s\n" _65_15064 _65_15063 _65_15062))))
in (failwith (_65_15065)))
end))))
...
in (let _65_15067 = (Support.Prims.pipe_left (fun ( _65_15066 ) -> Some (_65_15066)) (Support.Microsoft.FStar.Util.Inr (Microsoft_FStar_Absyn_Syntax.tun)))
in (Microsoft_FStar_Absyn_Syntax.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_disj (ps)) _65_15067 p.Microsoft_FStar_Absyn_Syntax.p)))
end
| (_, e::[]) -> begin
(aux p e)
end
...
| (vars, te) -> begin
(let _65_15087 = (let _65_15086 = (Microsoft_FStar_Absyn_Syntax.as_implicit true)
in (te, _65_15086))
in (vars, _65_15087))
end)))
...
| Microsoft_FStar_Absyn_Syntax.Pat_constant (c) -> begin
(let _65_15090 = (Support.Prims.pipe_right (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant c) pkg)
in ([], _65_15090))
end
| (Microsoft_FStar_Absyn_Syntax.Pat_wild (x)) | (Microsoft_FStar_Absyn_Syntax.Pat_var ((x, _))) -> begin
(let _65_15093 = (Support.Prims.pipe_right (Microsoft_FStar_Absyn_Syntax.mk_Exp_bvar x) pkg)
in ((Support.Microsoft.FStar.Util.Inr (x))::[], _65_15093))
end
| Microsoft_FStar_Absyn_Syntax.Pat_cons ((fv, q, pats)) -> begin
(let _35_785 = (let _65_15094 = (Support.Prims.pipe_right pats (Support.List.map pat_as_arg))
in (Support.Prims.pipe_right _65_15094 Support.List.unzip))
in (match (_35_785) with
| (vars, args) -> begin
(let vars = (Support.List.flatten vars)
in (let _65_15100 = (let _65_15099 = (let _65_15098 = (let _65_15097 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_fvar (fv, q) (Some (fv.Microsoft_FStar_Absyn_Syntax.sort)) fv.Microsoft_FStar_Absyn_Syntax.p)
in (_65_15097, args))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app' _65_15098))
in (Support.Prims.pipe_right _65_15099 pkg))
in (vars, _65_15100)))
end))
end
...
(let _65_15102 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_btvar a (Some (a.Microsoft_FStar_Absyn_Syntax.sort)) p.Microsoft_FStar_Absyn_Syntax.p)
in ((Support.Microsoft.FStar.Util.Inl (a))::[], _65_15102))
end
...
(let _65_15110 = (Microsoft_FStar_Tc_Rel.new_tvar r vars Microsoft_FStar_Absyn_Syntax.ktype)
in (Support.Prims.pipe_right _65_15110 Support.Prims.fst))
end
| Microsoft_FStar_Absyn_Syntax.Kind_arrow ((bs, k)) -> begin
(let _65_15113 = (let _65_15112 = (let _65_15111 = (Microsoft_FStar_Tc_Rel.new_tvar r vars Microsoft_FStar_Absyn_Syntax.ktype)
in (Support.Prims.pipe_right _65_15111 Support.Prims.fst))
in (bs, _65_15112))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _65_15113 (Some (k)) r))
end
| _ -> begin
(failwith ("Impossible"))
end)
in (let subst = (Support.Microsoft.FStar.Util.Inl ((a.Microsoft_FStar_Absyn_Syntax.v, arg)))::subst
in (let _65_15115 = (let _65_15114 = (Microsoft_FStar_Absyn_Syntax.targ arg)
in (_65_15114)::out)
in (_65_15115, subst)))))
end)
end)) ([], [])))
...
(let k = (let _65_15126 = (Microsoft_FStar_Tc_Rel.new_kvar e.Microsoft_FStar_Absyn_Syntax.pos scope)
...
| Microsoft_FStar_Absyn_Syntax.Typ_unknown -> begin
(let t = (let _65_15131 = (Microsoft_FStar_Tc_Rel.new_tvar e.Microsoft_FStar_Absyn_Syntax.pos scope Microsoft_FStar_Absyn_Syntax.ktype)
in (Support.Prims.pipe_right _65_15131 Support.Prims.fst))
...
| true -> begin
(let _65_15139 = (Support.Microsoft.FStar.Range.string_of_range r)
in (let _65_15138 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
...
| _ -> begin
(let _65_15141 = (let _65_15140 = (Microsoft_FStar_Tc_Rel.new_tvar r vars Microsoft_FStar_Absyn_Syntax.ktype)
in (Support.Prims.pipe_right _65_15140 Support.Prims.fst))
in (e, _65_15141, false))
end))
in (let _65_15142 = (Microsoft_FStar_Tc_Env.t_binders env)
in (aux _65_15142 e))))))
end
| _ -> begin
(e, t, false)
...
| _ -> begin
(let _65_15147 = (let _65_15146 = (let _65_15145 = (Support.List.map Microsoft_FStar_Absyn_Print.arg_to_string c.Microsoft_FStar_Absyn_Syntax.effect_args)
in (Support.Prims.pipe_right _65_15145 (Support.String.concat ", ")))
in (Support.Microsoft.FStar.Util.format2 "Impossible: Got a computation %s with effect args [%s]" c.Microsoft_FStar_Absyn_Syntax.effect_name.Microsoft_FStar_Absyn_Syntax.str _65_15146))
in (failwith (_65_15147)))
end)
...
| (_, wp, wlp) -> begin
(let _65_15169 = (let _65_15168 = (let _65_15164 = (lift c.Microsoft_FStar_Absyn_Syntax.result_typ wp)
in (Microsoft_FStar_Absyn_Syntax.targ _65_15164))
in (let _65_15167 = (let _65_15166 = (let _65_15165 = (lift c.Microsoft_FStar_Absyn_Syntax.result_typ wlp)
in (Microsoft_FStar_Absyn_Syntax.targ _65_15165))
in (_65_15166)::[])
in (_65_15168)::_65_15167))
in {Microsoft_FStar_Absyn_Syntax.effect_name = m; Microsoft_FStar_Absyn_Syntax.result_typ = c.Microsoft_FStar_Absyn_Syntax.result_typ; Microsoft_FStar_Absyn_Syntax.effect_args = _65_15169; Microsoft_FStar_Absyn_Syntax.flags = []})
end)))
...
let join_effects = (fun ( env ) ( l1 ) ( l2 ) -> (let _35_1023 = (let _65_15183 = (norm_eff_name env l1)
in (let _65_15182 = (norm_eff_name env l2)
in (Microsoft_FStar_Tc_Env.join env _65_15183 _65_15182)))
...
| (a, kwp) -> begin
(let _65_15197 = (destruct_comp m1)
in (let _65_15196 = (destruct_comp m2)
in ((md, a, kwp), _65_15197, _65_15196)))
end)))))
end)))))
...
let mk_comp = (fun ( md ) ( result ) ( wp ) ( wlp ) ( flags ) -> (let _65_15220 = (let _65_15219 = (let _65_15218 = (Microsoft_FStar_Absyn_Syntax.targ wp)
in (let _65_15217 = (let _65_15216 = (Microsoft_FStar_Absyn_Syntax.targ wlp)
in (_65_15216)::[])
in (_65_15218)::_65_15217))
in {Microsoft_FStar_Absyn_Syntax.effect_name = md.Microsoft_FStar_Absyn_Syntax.mname; Microsoft_FStar_Absyn_Syntax.result_typ = result; Microsoft_FStar_Absyn_Syntax.effect_args = _65_15219; Microsoft_FStar_Absyn_Syntax.flags = flags})
in (Microsoft_FStar_Absyn_Syntax.mk_Comp _65_15220)))
...
in (let _65_15230 = (Microsoft_FStar_Absyn_Util.subst_typ subst lc.Microsoft_FStar_Absyn_Syntax.res_typ)
in {Microsoft_FStar_Absyn_Syntax.eff_name = _35_1058.Microsoft_FStar_Absyn_Syntax.eff_name; Microsoft_FStar_Absyn_Syntax.res_typ = _65_15230; Microsoft_FStar_Absyn_Syntax.cflags = _35_1058.Microsoft_FStar_Absyn_Syntax.cflags; Microsoft_FStar_Absyn_Syntax.comp = (fun ( _35_1060 ) -> (match (()) with
| () -> begin
(let _65_15229 = (lc.Microsoft_FStar_Absyn_Syntax.comp ())
in (Microsoft_FStar_Absyn_Util.subst_comp subst _65_15229))
end))})))

let is_function = (fun ( t ) -> (match ((let _65_15233 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _65_15233.Microsoft_FStar_Absyn_Syntax.n)) with
...
in (let wp = (let _65_15245 = (let _65_15244 = (let _65_15243 = (let _65_15242 = (Microsoft_FStar_Absyn_Syntax.targ t)
in (let _65_15241 = (let _65_15240 = (Microsoft_FStar_Absyn_Syntax.varg v)
in (_65_15240)::[])
in (_65_15242)::_65_15241))
in (m.Microsoft_FStar_Absyn_Syntax.ret, _65_15243))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15244 (Some (k)) v.Microsoft_FStar_Absyn_Syntax.pos))
in (Support.Prims.pipe_left (Microsoft_FStar_Tc_Normalize.norm_typ ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env) _65_15245))
in (let wlp = wp
...
| true -> begin
(let _65_15248 = (Support.Microsoft.FStar.Range.string_of_range v.Microsoft_FStar_Absyn_Syntax.pos)
in (let _65_15247 = (Microsoft_FStar_Absyn_Print.exp_to_string v)
in (let _65_15246 = (Microsoft_FStar_Tc_Normalize.comp_typ_norm_to_string env c)
in (Support.Microsoft.FStar.Util.fprint3 "(%s) returning %s at comp type %s\n" _65_15248 _65_15247 _65_15246))))
end
| false -> begin
()
end)
...
in (let _65_15258 = (Microsoft_FStar_Absyn_Print.lcomp_typ_to_string lc1)
in (let _65_15257 = (Microsoft_FStar_Absyn_Print.lcomp_typ_to_string lc2)
in (Support.Microsoft.FStar.Util.fprint3 "Before lift: Making bind c1=%s\nb=%s\t\tc2=%s\n" _65_15258 bstr _65_15257))))
end
| false -> begin
()
end)
...
| true -> begin
(let _65_15266 = (Microsoft_FStar_Absyn_Util.subst_comp ((Support.Microsoft.FStar.Util.Inr ((x, e)))::[]) c2)
in (Support.Prims.pipe_left (fun ( _65_15265 ) -> Some (_65_15265)) _65_15266))
end
| false -> begin
(aux ())
end)
...
in (let _65_15269 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string c1)
in (let _65_15268 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string c2)
in (let _65_15267 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string c)
in (Support.Microsoft.FStar.Util.fprint4 "bind (%s) %s and %s simplified to %s\n" _65_15270 _65_15269 _65_15268 _65_15267)))))
end
| false -> begin
()
end)
...
(let bs = (match (b) with
| None -> begin
(let _65_15271 = (Microsoft_FStar_Absyn_Syntax.null_v_binder t1)
in (_65_15271)::[])
end
| Some (Microsoft_FStar_Tc_Env.Binding_var ((x, t1))) -> begin
(let _65_15272 = (Microsoft_FStar_Absyn_Syntax.v_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t1))
in (_65_15272)::[])
end
| Some (Microsoft_FStar_Tc_Env.Binding_lid ((l, t1))) -> begin
(let _65_15273 = (Microsoft_FStar_Absyn_Syntax.null_v_binder t1)
in (_65_15273)::[])
end
| _ -> begin
...
in (let wp_args = (let _65_15288 = (Microsoft_FStar_Absyn_Syntax.targ t1)
in (let _65_15287 = (let _65_15286 = (Microsoft_FStar_Absyn_Syntax.targ t2)
in (let _65_15285 = (let _65_15284 = (Microsoft_FStar_Absyn_Syntax.targ wp1)
in (let _65_15283 = (let _65_15282 = (Microsoft_FStar_Absyn_Syntax.targ wlp1)
in (let _65_15281 = (let _65_15280 = (let _65_15276 = (mk_lam wp2)
in (Microsoft_FStar_Absyn_Syntax.targ _65_15276))
in (let _65_15279 = (let _65_15278 = (let _65_15277 = (mk_lam wlp2)
in (Microsoft_FStar_Absyn_Syntax.targ _65_15277))
in (_65_15278)::[])
in (_65_15280)::_65_15279))
in (_65_15282)::_65_15281))
in (_65_15284)::_65_15283))
in (_65_15286)::_65_15285))
in (_65_15288)::_65_15287))
in (let wlp_args = (let _65_15296 = (Microsoft_FStar_Absyn_Syntax.targ t1)
in (let _65_15295 = (let _65_15294 = (Microsoft_FStar_Absyn_Syntax.targ t2)
in (let _65_15293 = (let _65_15292 = (Microsoft_FStar_Absyn_Syntax.targ wlp1)
in (let _65_15291 = (let _65_15290 = (let _65_15289 = (mk_lam wlp2)
in (Microsoft_FStar_Absyn_Syntax.targ _65_15289))
in (_65_15290)::[])
in (_65_15292)::_65_15291))
in (_65_15294)::_65_15293))
in (_65_15296)::_65_15295))
...
in (let _65_15297 = (join_lcomp env lc1 lc2)
in {Microsoft_FStar_Absyn_Syntax.eff_name = _65_15297; Microsoft_FStar_Absyn_Syntax.res_typ = lc2.Microsoft_FStar_Absyn_Syntax.res_typ; Microsoft_FStar_Absyn_Syntax.cflags = []; Microsoft_FStar_Absyn_Syntax.comp = bind_it})))
end))
...
| (a, kwp) -> begin
(let k = (Microsoft_FStar_Absyn_Util.subst_kind ((Support.Microsoft.FStar.Util.Inl ((a.Microsoft_FStar_Absyn_Syntax.v, t)))::[]) kwp)
in (let wp = (let _65_15312 = (let _65_15311 = (let _65_15310 = (Microsoft_FStar_Absyn_Syntax.targ t)
...
in (let wlp = (let _65_15317 = (let _65_15316 = (let _65_15315 = (Microsoft_FStar_Absyn_Syntax.targ t)
in (let _65_15314 = (let _65_15313 = (Microsoft_FStar_Absyn_Syntax.targ f)
in (_65_15313)::[])
in (_65_15315)::_65_15314))
in (mk_wlp, _65_15316))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15317 (Some (k)) f.Microsoft_FStar_Absyn_Syntax.pos))
...
| true -> begin
(let _65_15329 = (let _65_15328 = (Microsoft_FStar_Tc_Env.get_range env)
in (Support.Prims.pipe_left Support.Microsoft.FStar.Range.string_of_range _65_15328))
...
| true -> begin
(let _65_15332 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string c)
in (let _65_15331 = (let _65_15330 = (Microsoft_FStar_Absyn_Syntax.mk_Comp c')
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Print.comp_typ_to_string _65_15330))
...
| (t, wp, wlp) -> begin
(let wp = (let _65_15335 = (let _65_15334 = (let _65_15333 = (Microsoft_FStar_Tc_Env.get_range env)
in (wp, Some (b), _65_15333))
in Microsoft_FStar_Absyn_Syntax.Meta_refresh_label (_65_15334))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta _65_15335))
in (let wlp = (let _65_15338 = (let _65_15337 = (let _65_15336 = (Microsoft_FStar_Tc_Env.get_range env)
in (wlp, Some (b), _65_15336))
in Microsoft_FStar_Absyn_Syntax.Meta_refresh_label (_65_15337))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta _65_15338))
in (let _65_15343 = (let _35_1220 = c'
in (let _65_15342 = (let _65_15341 = (Microsoft_FStar_Absyn_Syntax.targ wp)
in (let _65_15340 = (let _65_15339 = (Microsoft_FStar_Absyn_Syntax.targ wlp)
in (_65_15339)::[])
in (_65_15341)::_65_15340))
in {Microsoft_FStar_Absyn_Syntax.effect_name = _35_1220.Microsoft_FStar_Absyn_Syntax.effect_name; Microsoft_FStar_Absyn_Syntax.result_typ = _35_1220.Microsoft_FStar_Absyn_Syntax.result_typ; Microsoft_FStar_Absyn_Syntax.effect_args = _65_15342; Microsoft_FStar_Absyn_Syntax.flags = c'.Microsoft_FStar_Absyn_Syntax.flags}))
in (Microsoft_FStar_Absyn_Syntax.mk_Comp _65_15343))))
end)))))
end)
end))
end))
...
| Some (reason) -> begin
(match ((let _65_15367 = (Microsoft_FStar_Options.should_verify env.Microsoft_FStar_Tc_Env.curmodule.Microsoft_FStar_Absyn_Syntax.str)
in (Support.Prims.pipe_left Support.Prims.op_Negation _65_15367))) with
| true -> begin
f
end
| false -> begin
(let _65_15368 = (reason ())
in (label _65_15368 r f))
end)
end))
...
(let _65_15375 = (label reason r f)
in Microsoft_FStar_Tc_Rel.NonTrivial (_65_15375))
end))
...
in (let wp = (let _65_15394 = (let _65_15393 = (let _65_15392 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15391 = (let _65_15390 = (Microsoft_FStar_Absyn_Syntax.targ f)
in (let _65_15389 = (let _65_15388 = (Microsoft_FStar_Absyn_Syntax.targ wp)
in (_65_15388)::[])
in (_65_15390)::_65_15389))
in (_65_15392)::_65_15391))
in (md.Microsoft_FStar_Absyn_Syntax.assume_p, _65_15393))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15394 None wp.Microsoft_FStar_Absyn_Syntax.pos))
in (let wlp = (let _65_15401 = (let _65_15400 = (let _65_15399 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15398 = (let _65_15397 = (Microsoft_FStar_Absyn_Syntax.targ f)
in (let _65_15396 = (let _65_15395 = (Microsoft_FStar_Absyn_Syntax.targ wlp)
in (_65_15395)::[])
in (_65_15397)::_65_15396))
in (_65_15399)::_65_15398))
in (md.Microsoft_FStar_Absyn_Syntax.assume_p, _65_15400))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15401 None wlp.Microsoft_FStar_Absyn_Syntax.pos))
...
in (let xret = (let _65_15423 = (Microsoft_FStar_Absyn_Util.bvar_to_exp x)
in (return_value env x.Microsoft_FStar_Absyn_Syntax.sort _65_15423))
in (let xbinding = Microsoft_FStar_Tc_Env.Binding_var ((x.Microsoft_FStar_Absyn_Syntax.v, x.Microsoft_FStar_Absyn_Syntax.sort))
in (let lc = (let _65_15426 = (lcomp_of_comp c)
in (let _65_15425 = (let _65_15424 = (lcomp_of_comp xret)
in (Some (xbinding), _65_15424))
in (bind env (Some (e)) _65_15426 _65_15425)))
...
| (res_t, wp, wlp) -> begin
(let md = (Microsoft_FStar_Tc_Env.get_effect_decl env c.Microsoft_FStar_Absyn_Syntax.effect_name)
in (let wp = (let _65_15435 = (let _65_15434 = (let _65_15433 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15432 = (let _65_15431 = (let _65_15428 = (let _65_15427 = (Microsoft_FStar_Tc_Env.get_range env)
in (label_opt env reason _65_15427 f))
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.targ _65_15428))
in (let _65_15430 = (let _65_15429 = (Microsoft_FStar_Absyn_Syntax.targ wp)
in (_65_15429)::[])
in (_65_15431)::_65_15430))
in (_65_15433)::_65_15432))
in (md.Microsoft_FStar_Absyn_Syntax.assert_p, _65_15434))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15435 None wp.Microsoft_FStar_Absyn_Syntax.pos))
in (let wlp = (let _65_15442 = (let _65_15441 = (let _65_15440 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15439 = (let _65_15438 = (Microsoft_FStar_Absyn_Syntax.targ f)
in (let _65_15437 = (let _65_15436 = (Microsoft_FStar_Absyn_Syntax.targ wlp)
in (_65_15436)::[])
in (_65_15438)::_65_15437))
in (_65_15440)::_65_15439))
in (md.Microsoft_FStar_Absyn_Syntax.assume_p, _65_15441))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15442 None wlp.Microsoft_FStar_Absyn_Syntax.pos))
in (let c2 = (mk_comp md res_t wp wlp flags)
in c2))))
end))))
end)))
end))
in (let _65_15446 = (let _35_1301 = lc
in (let _65_15445 = (norm_eff_name env lc.Microsoft_FStar_Absyn_Syntax.eff_name)
in (let _65_15444 = (match (((Microsoft_FStar_Absyn_Util.is_pure_lcomp lc) && (let _65_15443 = (Microsoft_FStar_Absyn_Util.is_function_typ lc.Microsoft_FStar_Absyn_Syntax.res_typ)
in (Support.Prims.pipe_left Support.Prims.op_Negation _65_15443)))) with
| true -> begin
flags
end
| false -> begin
...
in {Microsoft_FStar_Absyn_Syntax.eff_name = _65_15445; Microsoft_FStar_Absyn_Syntax.res_typ = _35_1301.Microsoft_FStar_Absyn_Syntax.res_typ; Microsoft_FStar_Absyn_Syntax.cflags = _65_15444; Microsoft_FStar_Absyn_Syntax.comp = strengthen})))
in (_65_15446, (let _35_1303 = g0
...
in (let _35_1313 = (let _65_15454 = (Microsoft_FStar_Absyn_Util.bvar_to_exp x)
in (let _65_15453 = (Microsoft_FStar_Absyn_Util.bvar_to_exp y)
in (_65_15454, _65_15453)))
in (match (_35_1313) with
| (xexp, yexp) -> begin
(let yret = (let _65_15459 = (let _65_15458 = (let _65_15457 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15456 = (let _65_15455 = (Microsoft_FStar_Absyn_Syntax.varg yexp)
in (_65_15455)::[])
in (_65_15457)::_65_15456))
in (md_pure.Microsoft_FStar_Absyn_Syntax.ret, _65_15458))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15459 None res_t.Microsoft_FStar_Absyn_Syntax.pos))
in (let x_eq_y_yret = (let _65_15467 = (let _65_15466 = (let _65_15465 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15464 = (let _65_15463 = (let _65_15460 = (Microsoft_FStar_Absyn_Util.mk_eq res_t res_t xexp yexp)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.targ _65_15460))
in (let _65_15462 = (let _65_15461 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.targ yret)
in (_65_15461)::[])
in (_65_15463)::_65_15462))
in (_65_15465)::_65_15464))
in (md_pure.Microsoft_FStar_Absyn_Syntax.assume_p, _65_15466))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15467 None res_t.Microsoft_FStar_Absyn_Syntax.pos))
in (let forall_y_x_eq_y_yret = (let _65_15478 = (let _65_15477 = (let _65_15476 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15475 = (let _65_15474 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15473 = (let _65_15472 = (let _65_15471 = (let _65_15470 = (let _65_15469 = (let _65_15468 = (Microsoft_FStar_Absyn_Syntax.v_binder y)
in (_65_15468)::[])
in (_65_15469, x_eq_y_yret))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _65_15470 None res_t.Microsoft_FStar_Absyn_Syntax.pos))
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.targ _65_15471))
in (_65_15472)::[])
in (_65_15474)::_65_15473))
in (_65_15476)::_65_15475))
in (md_pure.Microsoft_FStar_Absyn_Syntax.close_wp, _65_15477))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15478 None res_t.Microsoft_FStar_Absyn_Syntax.pos))
in (let lc2 = (mk_comp md_pure res_t forall_y_x_eq_y_yret forall_y_x_eq_y_yret ((Microsoft_FStar_Absyn_Syntax.RETURN)::[]))
in (let lc = (let _65_15481 = (lcomp_of_comp comp)
in (let _65_15480 = (let _65_15479 = (lcomp_of_comp lc2)
in (Some (Microsoft_FStar_Tc_Env.Binding_var ((x.Microsoft_FStar_Absyn_Syntax.v, x.Microsoft_FStar_Absyn_Syntax.sort))), _65_15479))
in (bind env None _65_15481 _65_15480)))
in (lc.Microsoft_FStar_Absyn_Syntax.comp ()))))))
end))))))

let ite = (fun ( env ) ( guard ) ( lcomp_then ) ( lcomp_else ) -> (let comp = (fun ( _35_1324 ) -> (match (()) with
| () -> begin
(let _35_1340 = (let _65_15493 = (lcomp_then.Microsoft_FStar_Absyn_Syntax.comp ())
in (let _65_15492 = (lcomp_else.Microsoft_FStar_Absyn_Syntax.comp ())
in (lift_and_destruct env _65_15493 _65_15492)))
in (match (_35_1340) with
| ((md, _, _), (res_t, wp_then, wlp_then), (_, wp_else, wlp_else)) -> begin
(let ifthenelse = (fun ( md ) ( res_t ) ( g ) ( wp_t ) ( wp_e ) -> (let _65_15513 = (let _65_15511 = (let _65_15510 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15509 = (let _65_15508 = (Microsoft_FStar_Absyn_Syntax.targ g)
in (let _65_15507 = (let _65_15506 = (Microsoft_FStar_Absyn_Syntax.targ wp_t)
in (let _65_15505 = (let _65_15504 = (Microsoft_FStar_Absyn_Syntax.targ wp_e)
in (_65_15504)::[])
in (_65_15506)::_65_15505))
in (_65_15508)::_65_15507))
in (_65_15510)::_65_15509))
in (md.Microsoft_FStar_Absyn_Syntax.if_then_else, _65_15511))
in (let _65_15512 = (Support.Microsoft.FStar.Range.union_ranges wp_t.Microsoft_FStar_Absyn_Syntax.pos wp_e.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15513 None _65_15512))))
...
| false -> begin
(let wp = (let _65_15520 = (let _65_15519 = (let _65_15518 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15517 = (let _65_15516 = (Microsoft_FStar_Absyn_Syntax.targ wlp)
in (let _65_15515 = (let _65_15514 = (Microsoft_FStar_Absyn_Syntax.targ wp)
in (_65_15514)::[])
in (_65_15516)::_65_15515))
in (_65_15518)::_65_15517))
in (md.Microsoft_FStar_Absyn_Syntax.ite_wp, _65_15519))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15520 None wp.Microsoft_FStar_Absyn_Syntax.pos))
in (let wlp = (let _65_15525 = (let _65_15524 = (let _65_15523 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15522 = (let _65_15521 = (Microsoft_FStar_Absyn_Syntax.targ wlp)
in (_65_15521)::[])
in (_65_15523)::_65_15522))
in (md.Microsoft_FStar_Absyn_Syntax.ite_wlp, _65_15524))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15525 None wlp.Microsoft_FStar_Absyn_Syntax.pos))
in (mk_comp md res_t wp wlp [])))
end))))
end))
end))
in (let _65_15526 = (join_effects env lcomp_then.Microsoft_FStar_Absyn_Syntax.eff_name lcomp_else.Microsoft_FStar_Absyn_Syntax.eff_name)
in {Microsoft_FStar_Absyn_Syntax.eff_name = _65_15526; Microsoft_FStar_Absyn_Syntax.res_typ = lcomp_then.Microsoft_FStar_Absyn_Syntax.res_typ; Microsoft_FStar_Absyn_Syntax.cflags = []; Microsoft_FStar_Absyn_Syntax.comp = comp})))
...
| () -> begin
(let ifthenelse = (fun ( md ) ( res_t ) ( g ) ( wp_t ) ( wp_e ) -> (let _65_15556 = (let _65_15554 = (let _65_15553 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15552 = (let _65_15551 = (Microsoft_FStar_Absyn_Syntax.targ g)
in (let _65_15550 = (let _65_15549 = (Microsoft_FStar_Absyn_Syntax.targ wp_t)
in (let _65_15548 = (let _65_15547 = (Microsoft_FStar_Absyn_Syntax.targ wp_e)
in (_65_15547)::[])
in (_65_15549)::_65_15548))
in (_65_15551)::_65_15550))
in (_65_15553)::_65_15552))
in (md.Microsoft_FStar_Absyn_Syntax.if_then_else, _65_15554))
in (let _65_15555 = (Support.Microsoft.FStar.Range.union_ranges wp_t.Microsoft_FStar_Absyn_Syntax.pos wp_e.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15556 None _65_15555))))
in (let default_case = (let post_k = (let _65_15559 = (let _65_15558 = (let _65_15557 = (Microsoft_FStar_Absyn_Syntax.null_v_binder res_t)
in (_65_15557)::[])
in (_65_15558, Microsoft_FStar_Absyn_Syntax.ktype))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _65_15559 res_t.Microsoft_FStar_Absyn_Syntax.pos))
in (let kwp = (let _65_15562 = (let _65_15561 = (let _65_15560 = (Microsoft_FStar_Absyn_Syntax.null_t_binder post_k)
in (_65_15560)::[])
in (_65_15561, Microsoft_FStar_Absyn_Syntax.ktype))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _65_15562 res_t.Microsoft_FStar_Absyn_Syntax.pos))
in (let post = (let _65_15563 = (Microsoft_FStar_Absyn_Util.new_bvd None)
in (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s _65_15563 post_k))
in (let wp = (let _65_15570 = (let _65_15569 = (let _65_15564 = (Microsoft_FStar_Absyn_Syntax.t_binder post)
in (_65_15564)::[])
in (let _65_15568 = (let _65_15567 = (let _65_15565 = (Microsoft_FStar_Tc_Env.get_range env)
in (label Microsoft_FStar_Tc_Errors.exhaustiveness_check _65_15565))
in (let _65_15566 = (Microsoft_FStar_Absyn_Util.ftv Microsoft_FStar_Absyn_Const.false_lid Microsoft_FStar_Absyn_Syntax.ktype)
in (Support.Prims.pipe_left _65_15567 _65_15566)))
in (_65_15569, _65_15568)))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _65_15570 (Some (kwp)) res_t.Microsoft_FStar_Absyn_Syntax.pos))
in (let wlp = (let _65_15574 = (let _65_15573 = (let _65_15571 = (Microsoft_FStar_Absyn_Syntax.t_binder post)
in (_65_15571)::[])
in (let _65_15572 = (Microsoft_FStar_Absyn_Util.ftv Microsoft_FStar_Absyn_Const.true_lid Microsoft_FStar_Absyn_Syntax.ktype)
in (_65_15573, _65_15572)))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _65_15574 (Some (kwp)) res_t.Microsoft_FStar_Absyn_Syntax.pos))
...
| (g, cthen) -> begin
(let _35_1400 = (let _65_15577 = (cthen.Microsoft_FStar_Absyn_Syntax.comp ())
in (lift_and_destruct env _65_15577 celse))
in (match (_35_1400) with
| ((md, _, _), (_, wp_then, wlp_then), (_, wp_else, wlp_else)) -> begin
(let _65_15579 = (ifthenelse md res_t g wp_then wp_else)
in (let _65_15578 = (ifthenelse md res_t g wlp_then wlp_else)
in (mk_comp md res_t _65_15579 _65_15578 [])))
end))
...
| (_, wp, wlp) -> begin
(let wp = (let _65_15586 = (let _65_15585 = (let _65_15584 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15583 = (let _65_15582 = (Microsoft_FStar_Absyn_Syntax.targ wlp)
in (let _65_15581 = (let _65_15580 = (Microsoft_FStar_Absyn_Syntax.targ wp)
in (_65_15580)::[])
in (_65_15582)::_65_15581))
in (_65_15584)::_65_15583))
in (md.Microsoft_FStar_Absyn_Syntax.ite_wp, _65_15585))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15586 None wp.Microsoft_FStar_Absyn_Syntax.pos))
in (let wlp = (let _65_15591 = (let _65_15590 = (let _65_15589 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15588 = (let _65_15587 = (Microsoft_FStar_Absyn_Syntax.targ wlp)
in (_65_15587)::[])
in (_65_15589)::_65_15588))
in (md.Microsoft_FStar_Absyn_Syntax.ite_wlp, _65_15590))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15591 None wlp.Microsoft_FStar_Absyn_Syntax.pos))
in (mk_comp md res_t wp wlp [])))
end))))
end))))
end))
...
(let bs = (let _65_15610 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.v_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_65_15610)::[])
in (let wp = (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam (bs, wp) None wp.Microsoft_FStar_Absyn_Syntax.pos)
in (let _65_15617 = (let _65_15616 = (let _65_15615 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15614 = (let _65_15613 = (Microsoft_FStar_Absyn_Syntax.targ t)
in (let _65_15612 = (let _65_15611 = (Microsoft_FStar_Absyn_Syntax.targ wp)
in (_65_15611)::[])
in (_65_15613)::_65_15612))
in (_65_15615)::_65_15614))
in (md.Microsoft_FStar_Absyn_Syntax.close_wp, _65_15616))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15617 None wp0.Microsoft_FStar_Absyn_Syntax.pos))))
end
| Microsoft_FStar_Tc_Env.Binding_typ ((a, k)) -> begin
(let bs = (let _65_15618 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.t_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_65_15618)::[])
in (let wp = (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam (bs, wp) None wp.Microsoft_FStar_Absyn_Syntax.pos)
in (let _65_15623 = (let _65_15622 = (let _65_15621 = (Microsoft_FStar_Absyn_Syntax.targ res_t)
in (let _65_15620 = (let _65_15619 = (Microsoft_FStar_Absyn_Syntax.targ wp)
in (_65_15619)::[])
in (_65_15621)::_65_15620))
in (md.Microsoft_FStar_Absyn_Syntax.close_wp_t, _65_15622))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15623 None wp0.Microsoft_FStar_Absyn_Syntax.pos))))
end
...
in (let ret = (let _65_15632 = (return_value env t xexp)
in (Support.Prims.pipe_left lcomp_of_comp _65_15632))
in (let eq_ret = (let _65_15634 = (let _65_15633 = (Microsoft_FStar_Absyn_Util.mk_eq t t xexp e)
in Microsoft_FStar_Tc_Rel.NonTrivial (_65_15633))
in (weaken_precondition env ret _65_15634))
in (let _65_15637 = (let _65_15636 = (let _65_15635 = (lcomp_of_comp c)
in (bind env None _65_15635 (Some (Microsoft_FStar_Tc_Env.Binding_var ((x, t))), eq_ret)))
in (_65_15636.Microsoft_FStar_Absyn_Syntax.comp ()))
in (Microsoft_FStar_Absyn_Util.comp_set_flags _65_15637 ((Microsoft_FStar_Absyn_Syntax.PARTIAL_RETURN)::(Microsoft_FStar_Absyn_Util.comp_flags c)))))))))))
end)
end))
end))
...
| None -> begin
(let _65_15649 = (let _65_15648 = (let _65_15647 = (Microsoft_FStar_Tc_Errors.computed_computation_type_does_not_match_annotation env e c c')
in (let _65_15646 = (Microsoft_FStar_Tc_Env.get_range env)
in (_65_15647, _65_15646)))
in Microsoft_FStar_Absyn_Syntax.Error (_65_15648))
in (raise (_65_15649)))
end
| Some (g) -> begin
(e, c', g)
...
in (let _65_15660 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_app' (t, args) (Some (k)) t.Microsoft_FStar_Absyn_Syntax.pos)
in (_65_15660, k, implicits))))
end)))
end
| _ -> begin
(t, k, [])
...
in (let _65_15677 = (mk_exp_app e args (Some (t)))
in (_65_15677, t, implicits)))
end
| false -> begin
(e, t, [])
end)
...
| _ -> begin
(let t = (let _65_15678 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (bs, c) (Some (Microsoft_FStar_Absyn_Syntax.ktype)) e.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Prims.pipe_right _65_15678 (Microsoft_FStar_Absyn_Util.subst_typ subst)))
in (let _65_15679 = (mk_exp_app e args (Some (t)))
in (_65_15679, t, implicits)))
end))
end)))
end
| _ -> begin
...
| true -> begin
(let _65_15688 = (Microsoft_FStar_Tc_Rel.try_teq env lc.Microsoft_FStar_Absyn_Syntax.res_typ t)
in (_65_15688, false))
end
| false -> begin
(let _65_15689 = (Microsoft_FStar_Tc_Rel.try_subtype env lc.Microsoft_FStar_Absyn_Syntax.res_typ t)
in (_65_15689, true))
end)
in (match (gopt) with
| (None, _) -> begin
...
| true -> begin
(let _65_15693 = (Microsoft_FStar_Tc_Normalize.comp_typ_norm_to_string env c)
in (let _65_15692 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env f)
...
in (let x = (Microsoft_FStar_Absyn_Util.new_bvd None)
in (let xexp = (Microsoft_FStar_Absyn_Util.bvd_to_exp x t)
in (let wp = (let _65_15698 = (let _65_15697 = (let _65_15696 = (Microsoft_FStar_Absyn_Syntax.targ t)
in (let _65_15695 = (let _65_15694 = (Microsoft_FStar_Absyn_Syntax.varg xexp)
in (_65_15694)::[])
in (_65_15696)::_65_15695))
in (md.Microsoft_FStar_Absyn_Syntax.ret, _65_15697))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15698 (Some (k)) xexp.Microsoft_FStar_Absyn_Syntax.pos))
in (let cret = (let _65_15699 = (mk_comp md t wp wp ((Microsoft_FStar_Absyn_Syntax.RETURN)::[]))
in (Support.Prims.pipe_left lcomp_of_comp _65_15699))
in (let guard = (match (apply_guard) with
| true -> begin
(let _65_15702 = (let _65_15701 = (let _65_15700 = (Microsoft_FStar_Absyn_Syntax.varg xexp)
in (_65_15700)::[])
in (f, _65_15701))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15702 (Some (Microsoft_FStar_Absyn_Syntax.ktype)) f.Microsoft_FStar_Absyn_Syntax.pos))
end
| false -> begin
f
end)
in (let _35_1636 = (let _65_15710 = (Support.Prims.pipe_left (fun ( _65_15707 ) -> Some (_65_15707)) (Microsoft_FStar_Tc_Errors.subtyping_failed env lc.Microsoft_FStar_Absyn_Syntax.res_typ t))
in (let _65_15709 = (Microsoft_FStar_Tc_Env.set_range env e.Microsoft_FStar_Absyn_Syntax.pos)
in (let _65_15708 = (Support.Prims.pipe_left Microsoft_FStar_Tc_Rel.guard_of_guard_formula (Microsoft_FStar_Tc_Rel.NonTrivial (guard)))
in (strengthen_precondition _65_15710 _65_15709 e cret _65_15708))))
in (match (_35_1636) with
| (eq_ret, _trivial_so_ok_to_discard) -> begin
(let c = (let _65_15712 = (let _65_15711 = (Microsoft_FStar_Absyn_Syntax.mk_Comp ct)
in (Support.Prims.pipe_left lcomp_of_comp _65_15711))
in (bind env (Some (e)) _65_15712 (Some (Microsoft_FStar_Tc_Env.Binding_var ((x, lc.Microsoft_FStar_Absyn_Syntax.res_typ))), eq_ret)))
...
| true -> begin
(let _65_15713 = (Microsoft_FStar_Tc_Normalize.comp_typ_norm_to_string env c)
...
in (let _65_15715 = (norm_eff_name env lc.Microsoft_FStar_Absyn_Syntax.eff_name)
in {Microsoft_FStar_Absyn_Syntax.eff_name = _65_15715; Microsoft_FStar_Absyn_Syntax.res_typ = t; Microsoft_FStar_Absyn_Syntax.cflags = flags; Microsoft_FStar_Absyn_Syntax.comp = strengthen}))
in (e, lc, g)))))
end))
end)))
...
| true -> begin
(let ue = (let _65_15720 = (Support.Microsoft.FStar.Util.set_elements uvt.Microsoft_FStar_Absyn_Syntax.uvars_e)
in (Support.List.map Microsoft_FStar_Absyn_Print.uvar_e_to_string _65_15720))
in (let ut = (let _65_15721 = (Support.Microsoft.FStar.Util.set_elements uvt.Microsoft_FStar_Absyn_Syntax.uvars_t)
in (Support.List.map Microsoft_FStar_Absyn_Print.uvar_t_to_string _65_15721))
in (let uk = (let _65_15722 = (Support.Microsoft.FStar.Util.set_elements uvt.Microsoft_FStar_Absyn_Syntax.uvars_k)
in (Support.List.map Microsoft_FStar_Absyn_Print.uvar_k_to_string _65_15722))
...
in (let _35_1663 = (let _65_15724 = (let _65_15723 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.format2 "Unconstrained unification variables %s in type signature %s; please add an annotation" union _65_15723))
in (Microsoft_FStar_Tc_Errors.report r _65_15724))
...
let gen = (fun ( verify ) ( env ) ( ecs ) -> (match ((let _65_15732 = (Support.Microsoft.FStar.Util.for_all (fun ( _35_1673 ) -> (match (_35_1673) with
| (_, c) -> begin
(Microsoft_FStar_Absyn_Util.is_pure_comp c)
end)) ecs)
in (Support.Prims.pipe_left Support.Prims.op_Negation _65_15732))) with
| true -> begin
None
end
| false -> begin
...
| true -> begin
(let _65_15735 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string c)
...
in (let gen_uvars = (fun ( uvs ) -> (let _65_15739 = (Support.Microsoft.FStar.Util.set_difference uvs env_uvars.Microsoft_FStar_Absyn_Syntax.uvars_t)
in (Support.Prims.pipe_right _65_15739 Support.Microsoft.FStar.Util.set_elements)))
...
in (match ((let _65_15744 = (should_gen t)
in (Support.Prims.pipe_left Support.Prims.op_Negation _65_15744))) with
| true -> begin
([], e, c)
end
| false -> begin
...
in (let _35_1721 = (match ((((Microsoft_FStar_Options.should_verify env.Microsoft_FStar_Tc_Env.curmodule.Microsoft_FStar_Absyn_Syntax.str) && verify) && (let _65_15745 = (Microsoft_FStar_Absyn_Util.is_total_comp c)
in (Support.Prims.pipe_left Support.Prims.op_Negation _65_15745)))) with
| true -> begin
(let _35_1717 = (destruct_comp ct)
in (match (_35_1717) with
| (_, wp, _) -> begin
(let binder = (let _65_15746 = (Microsoft_FStar_Absyn_Syntax.null_v_binder t)
in (_65_15746)::[])
in (let post = (let _65_15750 = (let _65_15747 = (Microsoft_FStar_Absyn_Util.ftv Microsoft_FStar_Absyn_Const.true_lid Microsoft_FStar_Absyn_Syntax.ktype)
in (binder, _65_15747))
in (let _65_15749 = (let _65_15748 = (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (binder, Microsoft_FStar_Absyn_Syntax.ktype) t.Microsoft_FStar_Absyn_Syntax.pos)
in Some (_65_15748))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _65_15750 _65_15749 t.Microsoft_FStar_Absyn_Syntax.pos)))
in (let vc = (let _65_15757 = (let _65_15756 = (let _65_15755 = (let _65_15754 = (let _65_15753 = (Microsoft_FStar_Absyn_Syntax.targ post)
in (_65_15753)::[])
in (wp, _65_15754))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15755))
in (Support.Prims.pipe_left (Microsoft_FStar_Absyn_Syntax.syn wp.Microsoft_FStar_Absyn_Syntax.pos (Some (Microsoft_FStar_Absyn_Syntax.ktype))) _65_15756))
in (Microsoft_FStar_Tc_Normalize.norm_typ ((Microsoft_FStar_Tc_Normalize.Delta)::(Microsoft_FStar_Tc_Normalize.Beta)::[]) env _65_15757))
in (let _65_15758 = (Support.Prims.pipe_left Microsoft_FStar_Tc_Rel.guard_of_guard_formula (Microsoft_FStar_Tc_Rel.NonTrivial (vc)))
in (discharge_guard env _65_15758)))))
end))
end
| false -> begin
()
...
| _ -> begin
(let a = (let _65_15763 = (let _65_15762 = (Microsoft_FStar_Tc_Env.get_range env)
in (Support.Prims.pipe_left (fun ( _65_15761 ) -> Some (_65_15761)) _65_15762))
in (Microsoft_FStar_Absyn_Util.new_bvd _65_15763))
in (let t = (let _65_15764 = (Microsoft_FStar_Absyn_Util.bvd_to_typ a Microsoft_FStar_Absyn_Syntax.ktype)
in (Microsoft_FStar_Absyn_Util.close_for_kind _65_15764 k))
...
in (let _65_15765 = (Microsoft_FStar_Absyn_Syntax.mk_Total t)
in (e, _65_15765)))))
end))))
in Some (ecs)))))))
end))
...
| true -> begin
(let _65_15774 = (let _65_15773 = (Support.List.map (fun ( _35_1800 ) -> (match (_35_1800) with
| (lb, _, _) -> begin
(Microsoft_FStar_Absyn_Print.lbname_to_string lb)
end)) lecs)
in (Support.Prims.pipe_right _65_15773 (Support.String.concat ", ")))
in (Support.Microsoft.FStar.Util.fprint1 "Generalizing: %s" _65_15774))
end
| false -> begin
()
end)
in (match ((let _65_15776 = (Support.Prims.pipe_right lecs (Support.List.map (fun ( _35_1807 ) -> (match (_35_1807) with
| (_, e, c) -> begin
(e, c)
end))))
in (gen verify env _65_15776))) with
| None -> begin
lecs
end
| Some (ecs) -> begin
...
| true -> begin
(let _65_15781 = (Support.Microsoft.FStar.Range.string_of_range e.Microsoft_FStar_Absyn_Syntax.pos)
in (let _65_15780 = (Microsoft_FStar_Absyn_Print.lbname_to_string l)
in (let _65_15779 = (Microsoft_FStar_Absyn_Print.typ_to_string (Microsoft_FStar_Absyn_Util.comp_result c))
in (Support.Microsoft.FStar.Util.fprint3 "(%s) Generalized %s to %s" _65_15781 _65_15780 _65_15779))))
end
| false -> begin
()
end)
...
| true -> begin
(let _65_15793 = (discharge g)
in (let _65_15792 = (lc.Microsoft_FStar_Absyn_Syntax.comp ())
in (_65_15793, _65_15792)))
end
| false -> begin
(let c = (lc.Microsoft_FStar_Absyn_Syntax.comp ())
...
in (let c = (let _65_15794 = (Microsoft_FStar_Tc_Normalize.norm_comp steps env c)
in (Support.Prims.pipe_right _65_15794 Microsoft_FStar_Absyn_Util.comp_to_comp_typ))
...
| (t, wp, _) -> begin
(let vc = (let _65_15800 = (let _65_15798 = (let _65_15797 = (Microsoft_FStar_Absyn_Syntax.targ t)
in (let _65_15796 = (let _65_15795 = (Microsoft_FStar_Absyn_Syntax.targ wp)
in (_65_15795)::[])
in (_65_15797)::_65_15796))
in (md.Microsoft_FStar_Absyn_Syntax.trivial, _65_15798))
in (let _65_15799 = (Microsoft_FStar_Tc_Env.get_range env)
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15800 (Some (Microsoft_FStar_Absyn_Syntax.ktype)) _65_15799)))
in (let g = (let _65_15801 = (Support.Prims.pipe_left Microsoft_FStar_Tc_Rel.guard_of_guard_formula (Microsoft_FStar_Tc_Rel.NonTrivial (vc)))
in (Microsoft_FStar_Tc_Rel.conj_guard g _65_15801))
in (let _65_15803 = (discharge g)
in (let _65_15802 = (Microsoft_FStar_Absyn_Syntax.mk_Comp c)
in (_65_15803, _65_15802)))))
end))))))
end))))
...
(let _65_15822 = (f fst)
in (Support.Prims.pipe_right _65_15822 (fun ( _65_15821 ) -> Some (_65_15821))))
end
| _ -> begin
(failwith ("Unexpexted args to binary operator"))
end)))
in (let table = (let op_and_e = (fun ( e ) -> (let _65_15828 = (Microsoft_FStar_Absyn_Util.b2t e)
in (_65_15828, Microsoft_FStar_Absyn_Const.exp_false_bool)))
in (let op_or_e = (fun ( e ) -> (let _65_15832 = (let _65_15831 = (Microsoft_FStar_Absyn_Util.b2t e)
in (Microsoft_FStar_Absyn_Util.mk_neg _65_15831))
in (_65_15832, Microsoft_FStar_Absyn_Const.exp_true_bool)))
...
in (let op_and_t = (fun ( t ) -> (let _65_15871 = (unlabel t)
in (Support.Prims.pipe_right _65_15871 (fun ( _65_15870 ) -> Microsoft_FStar_Tc_Rel.NonTrivial (_65_15870)))))
in (let op_or_t = (fun ( t ) -> (let _65_15876 = (let _65_15874 = (unlabel t)
in (Support.Prims.pipe_right _65_15874 Microsoft_FStar_Absyn_Util.mk_neg))
in (Support.Prims.pipe_right _65_15876 (fun ( _65_15875 ) -> Microsoft_FStar_Tc_Rel.NonTrivial (_65_15875)))))
in (let op_imp_t = (fun ( t ) -> (let _65_15880 = (unlabel t)
in (Support.Prims.pipe_right _65_15880 (fun ( _65_15879 ) -> Microsoft_FStar_Tc_Rel.NonTrivial (_65_15879)))))
...
(let _65_15884 = (Microsoft_FStar_Absyn_Util.mk_neg guard)
in (Support.Prims.pipe_right _65_15884 (fun ( _65_15883 ) -> Microsoft_FStar_Tc_Rel.NonTrivial (_65_15883))))
end
| _ -> begin
...
in (let _65_15925 = (let _65_15924 = (let _65_15923 = (let _65_15922 = (let _65_15921 = (let _65_15920 = (Microsoft_FStar_Absyn_Util.bvar_to_exp x)
in (Microsoft_FStar_Absyn_Syntax.varg _65_15920))
in (_65_15921)::[])
in (ens, _65_15922))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15923 (Some (Microsoft_FStar_Absyn_Syntax.mk_Kind_type)) res_t.Microsoft_FStar_Absyn_Syntax.pos))
in (x, _65_15924))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine _65_15925 (Some (Microsoft_FStar_Absyn_Syntax.mk_Kind_type)) res_t.Microsoft_FStar_Absyn_Syntax.pos))))
...
(let _65_15931 = (let _65_15928 = (norm req)
in Some (_65_15928))
in (let _65_15930 = (let _65_15929 = (mk_post_type ct.Microsoft_FStar_Absyn_Syntax.result_typ ens)
in (Support.Prims.pipe_left norm _65_15929))
in (_65_15931, _65_15930)))
end
| _ -> begin
(failwith ("Impossible"))
end)
...
(let _35_2022 = (match ((let _65_15933 = (Microsoft_FStar_Tc_Env.lookup_typ_abbrev env Microsoft_FStar_Absyn_Const.as_requires)
in (let _65_15932 = (Microsoft_FStar_Tc_Env.lookup_typ_abbrev env Microsoft_FStar_Absyn_Const.as_ensures)
in (_65_15933, _65_15932)))) with
| (Some (x), Some (y)) -> begin
(x, y)
end
| _ -> begin
...
| (as_req, as_ens) -> begin
(let req = (let _65_15937 = (let _65_15936 = (let _65_15935 = (let _65_15934 = (Microsoft_FStar_Absyn_Syntax.targ wp)
in (_65_15934)::[])
in ((Support.Microsoft.FStar.Util.Inl (ct.Microsoft_FStar_Absyn_Syntax.result_typ), Some (Microsoft_FStar_Absyn_Syntax.Implicit)))::_65_15935)
in (as_req, _65_15936))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15937 (Some (Microsoft_FStar_Absyn_Syntax.mk_Kind_type)) ct.Microsoft_FStar_Absyn_Syntax.result_typ.Microsoft_FStar_Absyn_Syntax.pos))
in (let ens = (let _65_15941 = (let _65_15940 = (let _65_15939 = (let _65_15938 = (Microsoft_FStar_Absyn_Syntax.targ wlp)
in (_65_15938)::[])
in ((Support.Microsoft.FStar.Util.Inl (ct.Microsoft_FStar_Absyn_Syntax.result_typ), Some (Microsoft_FStar_Absyn_Syntax.Implicit)))::_65_15939)
in (as_ens, _65_15940))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_15941 None ct.Microsoft_FStar_Absyn_Syntax.result_typ.Microsoft_FStar_Absyn_Syntax.pos))
in (let _65_15945 = (let _65_15942 = (norm req)
in Some (_65_15942))
in (let _65_15944 = (let _65_15943 = (mk_post_type ct.Microsoft_FStar_Absyn_Syntax.result_typ ens)
in (norm _65_15943))
in (_65_15945, _65_15944)))))
end))
end
| _ -> begin
(failwith ("Impossible"))
