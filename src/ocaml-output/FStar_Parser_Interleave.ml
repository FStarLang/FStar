...
in (FStar_All.pipe_right uu____91 (FStar_Util.for_some (fun uu___124_110 -> (match (uu___124_110) with
...
| FStar_Parser_AST.Tycon (uu____240, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___125_257 -> (match (uu___125_257) with
