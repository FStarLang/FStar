...
in (FStar_All.pipe_right uu____91 (FStar_Util.for_some (fun uu___142_110 -> (match (uu___142_110) with
...
| FStar_Parser_AST.Tycon (uu____240, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___143_257 -> (match (uu___143_257) with
