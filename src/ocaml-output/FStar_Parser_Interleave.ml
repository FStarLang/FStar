...
in (FStar_All.pipe_right _0_869 (FStar_Util.for_some (fun uu___139_106 -> (match (uu___139_106) with
...
| FStar_Parser_AST.Tycon (uu____234, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___140_251 -> (match (uu___140_251) with
