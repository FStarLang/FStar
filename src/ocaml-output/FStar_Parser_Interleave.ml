...
(let _158_22 = (FStar_Parser_AST.lids_of_let defs)
in (FStar_All.pipe_right _158_22 (FStar_Util.for_some (id_eq_lid x))))
end
| FStar_Parser_AST.Tycon (_64_45, tys) -> begin
(let _158_25 = (FStar_All.pipe_right tys (FStar_List.map (fun _64_52 -> (match (_64_52) with
| (x, _64_51) -> begin
x
end))))
in (FStar_All.pipe_right _158_25 (FStar_Util.for_some (fun _64_1 -> (match (_64_1) with
...
| [] -> begin
(let _158_36 = (FStar_All.pipe_right (FStar_List.rev out) FStar_List.flatten)
in (FStar_List.append _158_36 impl))
end
| (d)::ds -> begin
...
(let _158_42 = (let _158_41 = (let _158_40 = (let _158_39 = (FStar_Parser_AST.decl_to_string d)
in (FStar_Util.format1 "%s is repeated in the implementation" _158_39))
in ((_158_40), (r)))
in FStar_Syntax_Syntax.Error (_158_41))
in (Prims.raise _158_42))
end
| Some (i) -> begin
(let _158_46 = (let _158_45 = (let _158_44 = (let _158_43 = (FStar_Parser_AST.decl_to_string d)
in (FStar_Util.format1 "%s in the interface is implemented with a \'type\'" _158_43))
in ((_158_44), (i.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_158_45))
in (Prims.raise _158_46))
end)
in (match ((prefix_until_let x iface)) with
| Some (_64_112) -> begin
(let _158_49 = (let _158_48 = (let _158_47 = (FStar_Util.format2 "\'val %s\' and \'let %s\' cannot both be provided in an interface" x.FStar_Ident.idText x.FStar_Ident.idText)
in ((_158_47), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_158_48))
in (Prims.raise _158_49))
end
| None -> begin
(
...
if (FStar_All.pipe_right qs (FStar_List.contains FStar_Parser_AST.Assumption)) then begin
(let _158_53 = (let _158_52 = (let _158_51 = (let _158_50 = (FStar_Range.string_of_range let_x.FStar_Parser_AST.drange)
in (FStar_Util.format2 "Assumed declaration %s is defined at %s" x.FStar_Ident.idText _158_50))
in ((_158_51), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_158_52))
in (Prims.raise _158_53))
end else begin
(
...
| Some (d) -> begin
(let _158_61 = (let _158_60 = (let _158_59 = (let _158_58 = (FStar_Parser_AST.decl_to_string d)
in (let _158_57 = (FStar_Parser_AST.decl_to_string let_x)
in (FStar_Util.format2 "%s is out of order with %s" _158_58 _158_57)))
in ((_158_59), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_158_60))
in (Prims.raise _158_61))
end
| _64_138 -> begin
