...
(let _421905 = (Support.Microsoft.FStar.Util.incr ctr)
...
in (let _421901 = (Support.ST.op_ColonEquals queries_dot_smt2 (Some (fh)))
in fh))
end
| Some (fh) -> begin
fh
...
in (let failing_assertions = ((Support.List.collect (fun l -> (match (((Support.List.tryFind (fun _422035 -> (match (_422035) with
| (m, _, _) -> begin
