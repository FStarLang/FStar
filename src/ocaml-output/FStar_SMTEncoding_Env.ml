...
let (varops : varops_t) =
      ...
      let uu____1606 =
        ...
        FStar_Util.find_map uu____1610
          (fun uu____1676 ->
             ...
             | (names1, uu____1690) -> FStar_Util.smap_try_find names1 y1) in
      ...
      | FStar_Pervasives_Native.Some uu____1704 ->
          (FStar_Util.incr ctr;
           (let uu____1708 =
            ...
            Prims.op_Hat y1 uu____1708)) in
    let top_scope =
      let uu____1740 =
        let uu____1750 = FStar_ST.op_Bang scopes in FStar_List.hd uu____1750 in
    ...
    let uu____1943 =
      ...
      FStar_Util.find_map uu____1946
        (fun uu____2011 ->
           ...
           | (uu____2023, strings) -> FStar_Util.smap_try_find strings s) in
  ...
  let push1 uu____2137 =
    let uu____2138 =
      ...
      let uu____2160 = FStar_ST.op_Bang scopes in uu____2150 :: uu____2160 in
    FStar_ST.op_Colon_Equals scopes uu____2138 in
  let pop1 uu____2268 =
    let uu____2269 =
      let uu____2281 = FStar_ST.op_Bang scopes in FStar_List.tl uu____2281 in
                                 ...
                                 let uu____4339 =
                                   FStar_SMTEncoding_Term.mk_fv
                                     ((fvb.smt_id),
                                       FStar_SMTEncoding_Term.Term_sort) in
                                 FStar_All.pipe_left
                                   FStar_SMTEncoding_Util.mkFreeV uu____4339 in
