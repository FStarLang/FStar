...
let (unmangle : FStar_Syntax_Syntax.bv -> FStar_Syntax_Syntax.bv) =
  fun x  ->
    let uu___256_2235 = x  in
    let uu____2236 =
      FStar_Syntax_Util.unmangle_field_name x.FStar_Syntax_Syntax.ppname  in
    {
      FStar_Syntax_Syntax.ppname = uu____2236;
      FStar_Syntax_Syntax.index = (uu___256_2235.FStar_Syntax_Syntax.index);
      FStar_Syntax_Syntax.sort = (uu___256_2235.FStar_Syntax_Syntax.sort)
    }
    ...
    fun x  ->
      ...
      let y =
        FStar_SMTEncoding_Util.mkFreeV
         ...
         in
      let uu____3217 =
        let uu___257_3218 = env  in
        let uu____3219 = add_bvar_binding (x, y) env.bvar_bindings  in
        {
          bvar_bindings = uu____3219;
          fvar_bindings = (uu___257_3218.fvar_bindings);
          depth = (env.depth + (Prims.parse_int "1"));
          tcenv = (uu___257_3218.tcenv);
          warn = (uu___257_3218.warn);
          cache = (uu___257_3218.cache);
          nolabels = (uu___257_3218.nolabels);
          use_zfuel_name = (uu___257_3218.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___257_3218.encode_non_total_function_typ);
          current_module_name = (uu___257_3218.current_module_name);
          encoding_quantifier = (uu___257_3218.encoding_quantifier)
        }  in
      (ysym, y, uu____3217)
...
let (new_term_constant :
  ...
  fun env  ->
    fun x  ->
      ...
      let uu____3248 =
        let uu___258_3249 = env  in
        let uu____3250 = add_bvar_binding (x, y) env.bvar_bindings  in
        {
          bvar_bindings = uu____3250;
          fvar_bindings = (uu___258_3249.fvar_bindings);
          depth = (uu___258_3249.depth);
          tcenv = (uu___258_3249.tcenv);
          warn = (uu___258_3249.warn);
          cache = (uu___258_3249.cache);
          nolabels = (uu___258_3249.nolabels);
          use_zfuel_name = (uu___258_3249.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___258_3249.encode_non_total_function_typ);
          current_module_name = (uu___258_3249.current_module_name);
          encoding_quantifier = (uu___258_3249.encoding_quantifier)
        }  in
      (ysym, y, uu____3248)
  ...
  fun env  ->
    fun x  ->
      fun str  ->
        ...
        let y = FStar_SMTEncoding_Util.mkApp (ysym, [])  in
        let uu____3284 =
          let uu___259_3285 = env  in
          let uu____3286 = add_bvar_binding (x, y) env.bvar_bindings  in
          {
            bvar_bindings = uu____3286;
            fvar_bindings = (uu___259_3285.fvar_bindings);
            depth = (uu___259_3285.depth);
            tcenv = (uu___259_3285.tcenv);
            warn = (uu___259_3285.warn);
            cache = (uu___259_3285.cache);
            nolabels = (uu___259_3285.nolabels);
            use_zfuel_name = (uu___259_3285.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___259_3285.encode_non_total_function_typ);
            current_module_name = (uu___259_3285.current_module_name);
            encoding_quantifier = (uu___259_3285.encoding_quantifier)
          }  in
        (ysym, y, uu____3284)
...
let (push_term_var :
  ...
  fun env  ->
    fun x  ->
      fun t  ->
        let uu___260_3310 = env  in
        let uu____3311 = add_bvar_binding (x, t) env.bvar_bindings  in
        {
          bvar_bindings = uu____3311;
          fvar_bindings = (uu___260_3310.fvar_bindings);
          depth = (uu___260_3310.depth);
          tcenv = (uu___260_3310.tcenv);
          warn = (uu___260_3310.warn);
          cache = (uu___260_3310.cache);
          nolabels = (uu___260_3310.nolabels);
          use_zfuel_name = (uu___260_3310.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___260_3310.encode_non_total_function_typ);
          current_module_name = (uu___260_3310.current_module_name);
          encoding_quantifier = (uu___260_3310.encoding_quantifier)
        }
      ...
      fun arity  ->
        ...
        let fvb =
          mk_fvb x fname arity (FStar_Pervasives_Native.Some ftok)
           ...
           in
        let uu____3428 =
          let uu___261_3429 = env  in
          let uu____3430 = add_fvar_binding fvb env.fvar_bindings  in
          {
            bvar_bindings = (uu___261_3429.bvar_bindings);
            fvar_bindings = uu____3430;
            depth = (uu___261_3429.depth);
            tcenv = (uu___261_3429.tcenv);
            warn = (uu___261_3429.warn);
            cache = (uu___261_3429.cache);
            nolabels = (uu___261_3429.nolabels);
            use_zfuel_name = (uu___261_3429.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___261_3429.encode_non_total_function_typ);
            current_module_name = (uu___261_3429.current_module_name);
            encoding_quantifier = (uu___261_3429.encoding_quantifier)
          }  in
        ...
        fun fname  ->
          fun ftok  ->
            let fvb = mk_fvb x fname arity ftok FStar_Pervasives_Native.None
               in
            let uu___262_3479 = env  in
            let uu____3480 = add_fvar_binding fvb env.fvar_bindings  in
            {
              bvar_bindings = (uu___262_3479.bvar_bindings);
              fvar_bindings = uu____3480;
              depth = (uu___262_3479.depth);
              tcenv = (uu___262_3479.tcenv);
              warn = (uu___262_3479.warn);
              cache = (uu___262_3479.cache);
              nolabels = (uu___262_3479.nolabels);
              use_zfuel_name = (uu___262_3479.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___262_3479.encode_non_total_function_typ);
              current_module_name = (uu___262_3479.current_module_name);
              encoding_quantifier = (uu___262_3479.encoding_quantifier)
            }
      ...
      fun f  ->
        ...
        let fvb1 =
          mk_fvb x fvb.smt_id fvb.smt_arity fvb.smt_token
           ...
           in
        let uu___263_3516 = env  in
        let uu____3517 = add_fvar_binding fvb1 env.fvar_bindings  in
        {
          bvar_bindings = (uu___263_3516.bvar_bindings);
          fvar_bindings = uu____3517;
          depth = (uu___263_3516.depth);
          tcenv = (uu___263_3516.tcenv);
          warn = (uu___263_3516.warn);
          cache = (uu___263_3516.cache);
          nolabels = (uu___263_3516.nolabels);
          use_zfuel_name = (uu___263_3516.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___263_3516.encode_non_total_function_typ);
          current_module_name = (uu___263_3516.current_module_name);
          encoding_quantifier = (uu___263_3516.encoding_quantifier)
        }
