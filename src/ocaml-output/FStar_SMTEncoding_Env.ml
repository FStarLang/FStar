...
let (varops : varops_t) =
      ...
      let uu____1653 =
        ...
        FStar_Util.find_map uu____1657
          (fun uu____1723 ->
             ...
             | (names1, uu____1737) -> FStar_Util.smap_try_find names1 y1) in
      ...
      | FStar_Pervasives_Native.Some uu____1751 ->
          (FStar_Util.incr ctr;
           (let uu____1755 =
            ...
            Prims.op_Hat y1 uu____1755)) in
    let top_scope =
      let uu____1787 =
        let uu____1797 = FStar_ST.op_Bang scopes in FStar_List.hd uu____1797 in
      FStar_All.pipe_left FStar_Pervasives_Native.fst uu____1787 in
    FStar_Util.smap_add top_scope y2 true; y2 in
  let new_var pp rn =
    FStar_All.pipe_left mk_unique
      (Prims.op_Hat pp.FStar_Ident.idText
         (Prims.op_Hat "__" (Prims.string_of_int rn))) in
    ...
    let uu____1990 =
      ...
      FStar_Util.find_map uu____1993
        (fun uu____2058 ->
           ...
           | (uu____2070, strings) -> FStar_Util.smap_try_find strings s) in
  ...
  let push1 uu____2184 =
    let uu____2185 =
      ...
      let uu____2207 = FStar_ST.op_Bang scopes in uu____2197 :: uu____2207 in
    FStar_ST.op_Colon_Equals scopes uu____2185 in
  let pop1 uu____2315 =
    let uu____2316 =
      let uu____2328 = FStar_ST.op_Bang scopes in FStar_List.tl uu____2328 in
  ...
  fun fvb ->
    ...
    then
      (let uu____2675 =
         ...
         FStar_Util.format1 "Unexpected thunked SMT symbol: %s" uu____2677 in
       failwith uu____2675)
    else
...
let (add_fvar_binding :
  ...
  fun fvb ->
    fun uu____3666 ->
      ...
      | (fvb_map, fvb_list) ->
          let uu____3693 =
            FStar_Util.psmap_add fvb_map (fvb.fvar_lid).FStar_Ident.str fvb in
                                  ...
                                  let uu____4461 =
                                    FStar_SMTEncoding_Term.mk_fv
                                      ((fvb.smt_id),
                                        FStar_SMTEncoding_Term.Term_sort) in
                                  FStar_All.pipe_left
                                    FStar_SMTEncoding_Util.mkFreeV uu____4461 in
                 ...
                 FStar_Util.pimap_fold pi
                   (fun uu____4730 ->
                      fun y ->
                        fun res ->
                          match (res, y) with
                          | (FStar_Pervasives_Native.Some uu____4748,
                             uu____4749) -> res
                          | (FStar_Pervasives_Native.None,
                             (uu____4760,
                              {
                                ...
                                FStar_SMTEncoding_Term.freevars = uu____4762;
                                FStar_SMTEncoding_Term.rng = uu____4763;_}))
                              when sym = nm ->
                              FStar_Pervasives_Native.Some
