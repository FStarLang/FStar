    ...
    fun x  ->
      ...
      let uu____3167 =
        ...
        let uu____3169 = add_bvar_binding (x, y) env.bvar_bindings  in
        {
          ...
          fvar_bindings = (uu___264_3168.fvar_bindings);
          depth = (env.depth + (Prims.parse_int "1"));
          tcenv = (uu___264_3168.tcenv);
          warn = (uu___264_3168.warn);
          cache = (uu___264_3168.cache);
          nolabels = (uu___264_3168.nolabels);
          use_zfuel_name = (uu___264_3168.use_zfuel_name);
    ...
    fun x  ->
      ...
      let uu____3198 =
        ...
        let uu____3200 = add_bvar_binding (x, y) env.bvar_bindings  in
        {
          ...
          fvar_bindings = (uu___265_3199.fvar_bindings);
          depth = (uu___265_3199.depth);
          tcenv = (uu___265_3199.tcenv);
          warn = (uu___265_3199.warn);
          cache = (uu___265_3199.cache);
          nolabels = (uu___265_3199.nolabels);
          use_zfuel_name = (uu___265_3199.use_zfuel_name);
          encode_non_total_function_typ =
      ...
      fun str  ->
        ...
        let uu____3234 =
          ...
          let uu____3236 = add_bvar_binding (x, y) env.bvar_bindings  in
          {
            ...
            fvar_bindings = (uu___266_3235.fvar_bindings);
            depth = (uu___266_3235.depth);
            tcenv = (uu___266_3235.tcenv);
            warn = (uu___266_3235.warn);
            cache = (uu___266_3235.cache);
            nolabels = (uu___266_3235.nolabels);
            use_zfuel_name = (uu___266_3235.use_zfuel_name);
            encode_non_total_function_typ =
    ...
    fun x  ->
      fun t  ->
        ...
        let uu____3261 = add_bvar_binding (x, t) env.bvar_bindings  in
        {
          ...
          fvar_bindings = (uu___267_3260.fvar_bindings);
          depth = (uu___267_3260.depth);
          tcenv = (uu___267_3260.tcenv);
          warn = (uu___267_3260.warn);
          cache = (uu___267_3260.cache);
          nolabels = (uu___267_3260.nolabels);
          use_zfuel_name = (uu___267_3260.use_zfuel_name);
          encode_non_total_function_typ =
    ...
    fun x  ->
      fun arity  ->
        ...
        let uu____3377 =
          ...
          {
            bvar_bindings = (uu___268_3378.bvar_bindings);
            fvar_bindings = uu____3379;
            depth = (uu___268_3378.depth);
            tcenv = (uu___268_3378.tcenv);
            warn = (uu___268_3378.warn);
            cache = (uu___268_3378.cache);
            nolabels = (uu___268_3378.nolabels);
            use_zfuel_name = (uu___268_3378.use_zfuel_name);
            encode_non_total_function_typ =
      ...
      fun arity  ->
        fun fname  ->
          fun ftok  ->
            ...
            {
              bvar_bindings = (uu___269_3428.bvar_bindings);
              fvar_bindings = uu____3429;
              depth = (uu___269_3428.depth);
              tcenv = (uu___269_3428.tcenv);
              warn = (uu___269_3428.warn);
              cache = (uu___269_3428.cache);
              nolabels = (uu___269_3428.nolabels);
              use_zfuel_name = (uu___269_3428.use_zfuel_name);
              encode_non_total_function_typ =
  ...
  fun env  ->
    fun x  ->
      fun f  ->
        ...
        {
          bvar_bindings = (uu___270_3465.bvar_bindings);
          fvar_bindings = uu____3466;
          depth = (uu___270_3465.depth);
          tcenv = (uu___270_3465.tcenv);
          warn = (uu___270_3465.warn);
          cache = (uu___270_3465.cache);
          nolabels = (uu___270_3465.nolabels);
          use_zfuel_name = (uu___270_3465.use_zfuel_name);
          encode_non_total_function_typ =
