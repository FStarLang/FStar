  ...
  fun lid ->
    fun a ->
      let uu____263 =
        ...
        let uu____267 = FStar_Ident.string_of_id a.FStar_Syntax_Syntax.ppname in
        ...
        let fail uu____297 =
          let uu____298 =
            ...
            FStar_Util.format2
              ...
              (Prims.string_of_int i) uu____300 in
...
let mk_data_tester :
  ...
  fun env ->
    fun l ->
      fun x ->
        let uu____464 =
          let uu____466 = FStar_Ident.string_of_lid l in escape uu____466 in
...
let (varops : varops_t) =
      ...
      | FStar_Pervasives_Native.Some uu____1519 ->
          (FStar_Util.incr ctr;
           (let uu____1523 =
            ...
            Prims.op_Hat y1 uu____1523)) in
    let top_scope =
      let uu____1555 = FStar_ST.op_Bang scopes in FStar_List.hd uu____1555 in
    FStar_Util.smap_add top_scope y2 true; y2 in
  let new_var pp rn =
    let uu____1610 =
      let uu____1612 = FStar_Ident.string_of_id pp in
      Prims.op_Hat uu____1612 (Prims.op_Hat "__" (Prims.string_of_int rn)) in
    FStar_All.pipe_left mk_unique uu____1610 in
  let new_fvar lid =
    let uu____1624 = FStar_Ident.string_of_lid lid in mk_unique uu____1624 in
  ...
  let push uu____1710 =
    let uu____1711 =
      ...
      let uu____1721 = FStar_ST.op_Bang scopes in uu____1717 :: uu____1721 in
    FStar_ST.op_Colon_Equals scopes uu____1711 in
  let pop uu____1793 =
    let uu____1794 =
      let uu____1800 = FStar_ST.op_Bang scopes in FStar_List.tl uu____1800 in
  ...
  fun fvb ->
    ...
    then
      (let uu____2099 =
         ...
         FStar_Util.format1 "Unexpected thunked SMT symbol: %s" uu____2101 in
       failwith uu____2099)
    else
                                  ...
                                  let uu____3893 =
                                    FStar_SMTEncoding_Term.mk_fv
                                      ((fvb.smt_id),
                                        FStar_SMTEncoding_Term.Term_sort) in
                                  FStar_All.pipe_left
                                    FStar_SMTEncoding_Util.mkFreeV uu____3893 in
