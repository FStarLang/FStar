...
let withenv :
  'Auu____53 'Auu____54 'Auu____55 .
    'Auu____53 ->
      ('Auu____54,'Auu____55) FStar_Pervasives_Native_Tuple2.tuple2 ->
        ('Auu____54,'Auu____55,'Auu____53)
...
type varops_t =
  ...
  push: unit -> unit ;
  pop: unit -> unit ;
  snapshot: unit -> (Prims.int,unit) FStar_Pervasives_Native_Tuple2.tuple2 ;
...
let (__proj__Mkvarops_t__item__snapshot :
  varops_t -> unit -> (Prims.int,unit) FStar_Pervasives_Native_Tuple2.tuple2)
  =
  fun projectee  ->
    match projectee with
    | { push = push1; pop = pop1; snapshot = snapshot1; rollback = rollback1;
...
type env_t =
  ...
  bvar_bindings:
    (FStar_Syntax_Syntax.bv,FStar_SMTEncoding_Term.term)
      FStar_Pervasives_Native_Tuple2.tuple2 FStar_Util.pimap FStar_Util.psmap
    ;
...
let add_bvar_binding :
  'Auu____3595 .
    (FStar_Syntax_Syntax.bv,'Auu____3595)
      FStar_Pervasives_Native_Tuple2.tuple2 ->
      (FStar_Syntax_Syntax.bv,'Auu____3595)
        FStar_Pervasives_Native_Tuple2.tuple2 FStar_Util.pimap
        FStar_Util.psmap ->
        (FStar_Syntax_Syntax.bv,'Auu____3595)
          FStar_Pervasives_Native_Tuple2.tuple2 FStar_Util.pimap
          FStar_Util.psmap
...
let (gen_term_var :
  ...
  fun env  ->
    fun x  ->
      ...
      let uu____3748 =
        let uu___271_3749 = env  in
        let uu____3750 = add_bvar_binding (x, y) env.bvar_bindings  in
        {
          bvar_bindings = uu____3750;
          fvar_bindings = (uu___271_3749.fvar_bindings);
          depth = (env.depth + (Prims.parse_int "1"));
          tcenv = (uu___271_3749.tcenv);
          warn = (uu___271_3749.warn);
          cache = (uu___271_3749.cache);
          nolabels = (uu___271_3749.nolabels);
          use_zfuel_name = (uu___271_3749.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___271_3749.encode_non_total_function_typ);
          current_module_name = (uu___271_3749.current_module_name);
          encoding_quantifier = (uu___271_3749.encoding_quantifier)
        }  in
      (ysym, y, uu____3748)
...
let (new_term_constant :
  ...
  fun env  ->
    fun x  ->
      ...
      let uu____3785 =
        let uu___272_3786 = env  in
        let uu____3787 = add_bvar_binding (x, y) env.bvar_bindings  in
        {
          bvar_bindings = uu____3787;
          fvar_bindings = (uu___272_3786.fvar_bindings);
          depth = (uu___272_3786.depth);
          tcenv = (uu___272_3786.tcenv);
          warn = (uu___272_3786.warn);
          cache = (uu___272_3786.cache);
          nolabels = (uu___272_3786.nolabels);
          use_zfuel_name = (uu___272_3786.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___272_3786.encode_non_total_function_typ);
          current_module_name = (uu___272_3786.current_module_name);
          encoding_quantifier = (uu___272_3786.encoding_quantifier)
        }  in
      (ysym, y, uu____3785)
  ...
  fun env  ->
    fun x  ->
      fun str  ->
        ...
        let y = FStar_SMTEncoding_Util.mkApp (ysym, [])  in
        let uu____3828 =
          let uu___273_3829 = env  in
          let uu____3830 = add_bvar_binding (x, y) env.bvar_bindings  in
          {
            bvar_bindings = uu____3830;
            fvar_bindings = (uu___273_3829.fvar_bindings);
            depth = (uu___273_3829.depth);
            tcenv = (uu___273_3829.tcenv);
            warn = (uu___273_3829.warn);
            cache = (uu___273_3829.cache);
            nolabels = (uu___273_3829.nolabels);
            use_zfuel_name = (uu___273_3829.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___273_3829.encode_non_total_function_typ);
            current_module_name = (uu___273_3829.current_module_name);
...
let (push_term_var :
  ...
  fun env  ->
    fun x  ->
      fun t  ->
        let uu___274_3856 = env  in
        let uu____3857 = add_bvar_binding (x, t) env.bvar_bindings  in
        {
          bvar_bindings = uu____3857;
          fvar_bindings = (uu___274_3856.fvar_bindings);
          depth = (uu___274_3856.depth);
          tcenv = (uu___274_3856.tcenv);
          warn = (uu___274_3856.warn);
          cache = (uu___274_3856.cache);
          nolabels = (uu___274_3856.nolabels);
          use_zfuel_name = (uu___274_3856.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___274_3856.encode_non_total_function_typ);
          current_module_name = (uu___274_3856.current_module_name);
          encoding_quantifier = (uu___274_3856.encoding_quantifier)
        }
          ...
          | (ftok_name,ftok) ->
              let fvb =
                mk_fvb x fname arity ftok FStar_Pervasives_Native.None
                 ...
                 in
              let uu____4066 =
                let uu___275_4067 = env  in
                let uu____4068 = add_fvar_binding fvb env.fvar_bindings  in
                {
                  bvar_bindings = (uu___275_4067.bvar_bindings);
                  fvar_bindings = uu____4068;
                  depth = (uu___275_4067.depth);
                  tcenv = (uu___275_4067.tcenv);
                  warn = (uu___275_4067.warn);
                  cache = (uu___275_4067.cache);
                  nolabels = (uu___275_4067.nolabels);
                  use_zfuel_name = (uu___275_4067.use_zfuel_name);
                  encode_non_total_function_typ =
                    (uu___275_4067.encode_non_total_function_typ);
                  current_module_name = (uu___275_4067.current_module_name);
                  encoding_quantifier = (uu___275_4067.encoding_quantifier)
                }  in
            ...
            fun thunked  ->
              let fvb =
                mk_fvb x fname arity ftok FStar_Pervasives_Native.None
                  thunked
                 in
              let uu___276_4235 = env  in
              let uu____4236 = add_fvar_binding fvb env.fvar_bindings  in
              {
                bvar_bindings = (uu___276_4235.bvar_bindings);
                fvar_bindings = uu____4236;
                depth = (uu___276_4235.depth);
                tcenv = (uu___276_4235.tcenv);
                warn = (uu___276_4235.warn);
                cache = (uu___276_4235.cache);
                nolabels = (uu___276_4235.nolabels);
                use_zfuel_name = (uu___276_4235.use_zfuel_name);
                encode_non_total_function_typ =
                  (uu___276_4235.encode_non_total_function_typ);
                current_module_name = (uu___276_4235.current_module_name);
      ...
      fun f  ->
        ...
        let fvb1 =
          mk_fvb x fvb.smt_id fvb.smt_arity fvb.smt_token
           ...
           in
        let uu___277_4351 = env  in
        let uu____4352 = add_fvar_binding fvb1 env.fvar_bindings  in
        {
          bvar_bindings = (uu___277_4351.bvar_bindings);
          fvar_bindings = uu____4352;
          depth = (uu___277_4351.depth);
          tcenv = (uu___277_4351.tcenv);
          warn = (uu___277_4351.warn);
          cache = (uu___277_4351.cache);
          nolabels = (uu___277_4351.nolabels);
          use_zfuel_name = (uu___277_4351.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___277_4351.encode_non_total_function_typ);
          current_module_name = (uu___277_4351.current_module_name);
          encoding_quantifier = (uu___277_4351.encoding_quantifier)
        }
  ...
  env_t ->
    FStar_Ident.lident FStar_Syntax_Syntax.withinfo_t ->
      ((FStar_SMTEncoding_Term.op,FStar_SMTEncoding_Term.term)
         FStar_Util.either,FStar_SMTEncoding_Term.term Prims.list,Prims.int)
        FStar_Pervasives_Native_Tuple3.tuple3)
  =
  fun env  ->
    fun a  ->
