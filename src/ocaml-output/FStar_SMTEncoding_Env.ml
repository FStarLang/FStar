...
let (mk_term_projector_name :
  ...
  fun lid ->
    fun a ->
      let a1 =
        let uu___263_172 = a in
        let uu____173 =
          FStar_Syntax_Util.unmangle_field_name a.FStar_Syntax_Syntax.ppname in
        {
          FStar_Syntax_Syntax.ppname = uu____173;
          FStar_Syntax_Syntax.index =
            (uu___263_172.FStar_Syntax_Syntax.index);
          FStar_Syntax_Syntax.sort = (uu___263_172.FStar_Syntax_Syntax.sort)
        } in
      let uu____174 =
...
let (varops : varops_t) =
      ...
      let uu____1162 =
        ...
        FStar_Util.find_map uu____1165
          (fun uu____1248 ->
             ...
             | (names1, uu____1260) -> FStar_Util.smap_try_find names1 y1) in
      ...
      | FStar_Pervasives_Native.Some uu____1269 ->
          (FStar_Util.incr ctr;
           (let uu____1304 =
            ...
            Prims.strcat y1 uu____1304)) in
    let top_scope =
      let uu____1351 =
        let uu____1360 = FStar_ST.op_Bang scopes in FStar_List.hd uu____1360 in
    ...
    let uu____1567 =
      ...
      FStar_Util.find_map uu____1570
        (fun uu____1653 ->
           ...
           | (uu____1664, strings) -> FStar_Util.smap_try_find strings s) in
  ...
  let push1 uu____1790 =
    let uu____1791 =
      ...
      let uu____1811 = FStar_ST.op_Bang scopes in uu____1802 :: uu____1811 in
    FStar_ST.op_Colon_Equals scopes uu____1791 in
  let pop1 uu____1957 =
    let uu____1958 =
      let uu____1969 = FStar_ST.op_Bang scopes in FStar_List.tl uu____1969 in
...
let (unmangle : FStar_Syntax_Syntax.bv -> FStar_Syntax_Syntax.bv) =
  fun x ->
    let uu___264_2195 = x in
    let uu____2196 =
      FStar_Syntax_Util.unmangle_field_name x.FStar_Syntax_Syntax.ppname in
    {
      FStar_Syntax_Syntax.ppname = uu____2196;
      FStar_Syntax_Syntax.index = (uu___264_2195.FStar_Syntax_Syntax.index);
      FStar_Syntax_Syntax.sort = (uu___264_2195.FStar_Syntax_Syntax.sort)
    }
type fvar_binding =
  {
...
let (gen_term_var :
  ...
  fun env ->
    fun x ->
      ...
      let uu____3177 =
        let uu___265_3178 = env in
        let uu____3179 = add_bvar_binding (x, y) env.bvar_bindings in
        {
          bvar_bindings = uu____3179;
          fvar_bindings = (uu___265_3178.fvar_bindings);
          depth = (env.depth + (Prims.parse_int "1"));
          tcenv = (uu___265_3178.tcenv);
          warn = (uu___265_3178.warn);
          cache = (uu___265_3178.cache);
          nolabels = (uu___265_3178.nolabels);
          use_zfuel_name = (uu___265_3178.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___265_3178.encode_non_total_function_typ);
          current_module_name = (uu___265_3178.current_module_name);
          encoding_quantifier = (uu___265_3178.encoding_quantifier)
        } in
      (ysym, y, uu____3177)
let (new_term_constant :
  ...
  fun env ->
    fun x ->
      ...
      let uu____3208 =
        let uu___266_3209 = env in
        let uu____3210 = add_bvar_binding (x, y) env.bvar_bindings in
        {
          bvar_bindings = uu____3210;
          fvar_bindings = (uu___266_3209.fvar_bindings);
          depth = (uu___266_3209.depth);
          tcenv = (uu___266_3209.tcenv);
          warn = (uu___266_3209.warn);
          cache = (uu___266_3209.cache);
          nolabels = (uu___266_3209.nolabels);
          use_zfuel_name = (uu___266_3209.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___266_3209.encode_non_total_function_typ);
          current_module_name = (uu___266_3209.current_module_name);
          encoding_quantifier = (uu___266_3209.encoding_quantifier)
        } in
      (ysym, y, uu____3208)
  ...
  fun env ->
    fun x ->
      fun str ->
        ...
        let y = FStar_SMTEncoding_Util.mkApp (ysym, []) in
        let uu____3244 =
          let uu___267_3245 = env in
          let uu____3246 = add_bvar_binding (x, y) env.bvar_bindings in
          {
            bvar_bindings = uu____3246;
            fvar_bindings = (uu___267_3245.fvar_bindings);
            depth = (uu___267_3245.depth);
            tcenv = (uu___267_3245.tcenv);
            warn = (uu___267_3245.warn);
            cache = (uu___267_3245.cache);
            nolabels = (uu___267_3245.nolabels);
            use_zfuel_name = (uu___267_3245.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___267_3245.encode_non_total_function_typ);
            current_module_name = (uu___267_3245.current_module_name);
            encoding_quantifier = (uu___267_3245.encoding_quantifier)
          } in
        (ysym, y, uu____3244)
let (push_term_var :
  ...
  fun env ->
    fun x ->
      fun t ->
        let uu___268_3270 = env in
        let uu____3271 = add_bvar_binding (x, t) env.bvar_bindings in
        {
          bvar_bindings = uu____3271;
          fvar_bindings = (uu___268_3270.fvar_bindings);
          depth = (uu___268_3270.depth);
          tcenv = (uu___268_3270.tcenv);
          warn = (uu___268_3270.warn);
          cache = (uu___268_3270.cache);
          nolabels = (uu___268_3270.nolabels);
          use_zfuel_name = (uu___268_3270.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___268_3270.encode_non_total_function_typ);
          current_module_name = (uu___268_3270.current_module_name);
          encoding_quantifier = (uu___268_3270.encoding_quantifier)
        }
let (lookup_term_var :
  ...
  fun env ->
    fun x ->
      fun arity ->
        ...
        let uu____3388 =
          let uu___269_3389 = env in
          let uu____3390 = add_fvar_binding fvb env.fvar_bindings in
          {
            bvar_bindings = (uu___269_3389.bvar_bindings);
            fvar_bindings = uu____3390;
            depth = (uu___269_3389.depth);
            tcenv = (uu___269_3389.tcenv);
            warn = (uu___269_3389.warn);
            cache = (uu___269_3389.cache);
            nolabels = (uu___269_3389.nolabels);
            use_zfuel_name = (uu___269_3389.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___269_3389.encode_non_total_function_typ);
            current_module_name = (uu___269_3389.current_module_name);
            encoding_quantifier = (uu___269_3389.encoding_quantifier)
          } in
      ...
      fun arity ->
        fun fname ->
          fun ftok ->
            ...
            let uu___270_3439 = env in
            let uu____3440 = add_fvar_binding fvb env.fvar_bindings in
            {
              bvar_bindings = (uu___270_3439.bvar_bindings);
              fvar_bindings = uu____3440;
              depth = (uu___270_3439.depth);
              tcenv = (uu___270_3439.tcenv);
              warn = (uu___270_3439.warn);
              cache = (uu___270_3439.cache);
              nolabels = (uu___270_3439.nolabels);
              use_zfuel_name = (uu___270_3439.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___270_3439.encode_non_total_function_typ);
              current_module_name = (uu___270_3439.current_module_name);
              encoding_quantifier = (uu___270_3439.encoding_quantifier)
            }
  ...
  fun env ->
    fun x ->
      fun f ->
        ...
        let uu___271_3476 = env in
        let uu____3477 = add_fvar_binding fvb1 env.fvar_bindings in
        {
          bvar_bindings = (uu___271_3476.bvar_bindings);
          fvar_bindings = uu____3477;
          depth = (uu___271_3476.depth);
          tcenv = (uu___271_3476.tcenv);
          warn = (uu___271_3476.warn);
          cache = (uu___271_3476.cache);
          nolabels = (uu___271_3476.nolabels);
          use_zfuel_name = (uu___271_3476.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___271_3476.encode_non_total_function_typ);
          current_module_name = (uu___271_3476.current_module_name);
          encoding_quantifier = (uu___271_3476.encoding_quantifier)
        }
