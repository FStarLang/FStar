    ...
    fun x  ->
      ...
      let y =
        FStar_SMTEncoding_Util.mkFreeV
         ...
         in
      let uu____3167 =
        let uu___271_3168 = env  in
        let uu____3169 = add_bvar_binding (x, y) env.bvar_bindings  in
        {
          bvar_bindings = uu____3169;
          fvar_bindings = (uu___271_3168.fvar_bindings);
          depth = (env.depth + (Prims.parse_int "1"));
          tcenv = (uu___271_3168.tcenv);
          warn = (uu___271_3168.warn);
          cache = (uu___271_3168.cache);
          nolabels = (uu___271_3168.nolabels);
          use_zfuel_name = (uu___271_3168.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___271_3168.encode_non_total_function_typ);
          current_module_name = (uu___271_3168.current_module_name);
          encoding_quantifier = (uu___271_3168.encoding_quantifier)
        }  in
      (ysym, y, uu____3167)
...
let (new_term_constant :
  ...
  fun env  ->
    fun x  ->
      ...
      let uu____3198 =
        let uu___272_3199 = env  in
        let uu____3200 = add_bvar_binding (x, y) env.bvar_bindings  in
        {
          bvar_bindings = uu____3200;
          fvar_bindings = (uu___272_3199.fvar_bindings);
          depth = (uu___272_3199.depth);
          tcenv = (uu___272_3199.tcenv);
          warn = (uu___272_3199.warn);
          cache = (uu___272_3199.cache);
          nolabels = (uu___272_3199.nolabels);
          use_zfuel_name = (uu___272_3199.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___272_3199.encode_non_total_function_typ);
          current_module_name = (uu___272_3199.current_module_name);
          encoding_quantifier = (uu___272_3199.encoding_quantifier)
        }  in
      (ysym, y, uu____3198)
  ...
  fun env  ->
    fun x  ->
      fun str  ->
        ...
        let y = FStar_SMTEncoding_Util.mkApp (ysym, [])  in
        let uu____3234 =
          let uu___273_3235 = env  in
          let uu____3236 = add_bvar_binding (x, y) env.bvar_bindings  in
          {
            bvar_bindings = uu____3236;
            fvar_bindings = (uu___273_3235.fvar_bindings);
            depth = (uu___273_3235.depth);
            tcenv = (uu___273_3235.tcenv);
            warn = (uu___273_3235.warn);
            cache = (uu___273_3235.cache);
            nolabels = (uu___273_3235.nolabels);
            use_zfuel_name = (uu___273_3235.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___273_3235.encode_non_total_function_typ);
            current_module_name = (uu___273_3235.current_module_name);
            encoding_quantifier = (uu___273_3235.encoding_quantifier)
          }  in
        (ysym, y, uu____3234)
...
let (push_term_var :
  ...
  fun env  ->
    fun x  ->
      fun t  ->
        let uu___274_3260 = env  in
        let uu____3261 = add_bvar_binding (x, t) env.bvar_bindings  in
        {
          bvar_bindings = uu____3261;
          fvar_bindings = (uu___274_3260.fvar_bindings);
          depth = (uu___274_3260.depth);
          tcenv = (uu___274_3260.tcenv);
          warn = (uu___274_3260.warn);
          cache = (uu___274_3260.cache);
          nolabels = (uu___274_3260.nolabels);
          use_zfuel_name = (uu___274_3260.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___274_3260.encode_non_total_function_typ);
          current_module_name = (uu___274_3260.current_module_name);
          encoding_quantifier = (uu___274_3260.encoding_quantifier)
        }
      ...
      fun arity  ->
        ...
        let fvb =
          mk_fvb x fname arity (FStar_Pervasives_Native.Some ftok)
           ...
           in
        let uu____3377 =
          let uu___275_3378 = env  in
          let uu____3379 = add_fvar_binding fvb env.fvar_bindings  in
          {
            bvar_bindings = (uu___275_3378.bvar_bindings);
            fvar_bindings = uu____3379;
            depth = (uu___275_3378.depth);
            tcenv = (uu___275_3378.tcenv);
            warn = (uu___275_3378.warn);
            cache = (uu___275_3378.cache);
            nolabels = (uu___275_3378.nolabels);
            use_zfuel_name = (uu___275_3378.use_zfuel_name);
            encode_non_total_function_typ =
              (uu___275_3378.encode_non_total_function_typ);
            current_module_name = (uu___275_3378.current_module_name);
            encoding_quantifier = (uu___275_3378.encoding_quantifier)
          }  in
        ...
        fun fname  ->
          fun ftok  ->
            let fvb = mk_fvb x fname arity ftok FStar_Pervasives_Native.None
               in
            let uu___276_3428 = env  in
            let uu____3429 = add_fvar_binding fvb env.fvar_bindings  in
            {
              bvar_bindings = (uu___276_3428.bvar_bindings);
              fvar_bindings = uu____3429;
              depth = (uu___276_3428.depth);
              tcenv = (uu___276_3428.tcenv);
              warn = (uu___276_3428.warn);
              cache = (uu___276_3428.cache);
              nolabels = (uu___276_3428.nolabels);
              use_zfuel_name = (uu___276_3428.use_zfuel_name);
              encode_non_total_function_typ =
                (uu___276_3428.encode_non_total_function_typ);
              current_module_name = (uu___276_3428.current_module_name);
              encoding_quantifier = (uu___276_3428.encoding_quantifier)
            }
      ...
      fun f  ->
        ...
        let fvb1 =
          mk_fvb x fvb.smt_id fvb.smt_arity fvb.smt_token
           ...
           in
        let uu___277_3465 = env  in
        let uu____3466 = add_fvar_binding fvb1 env.fvar_bindings  in
        {
          bvar_bindings = (uu___277_3465.bvar_bindings);
          fvar_bindings = uu____3466;
          depth = (uu___277_3465.depth);
          tcenv = (uu___277_3465.tcenv);
          warn = (uu___277_3465.warn);
          cache = (uu___277_3465.cache);
          nolabels = (uu___277_3465.nolabels);
          use_zfuel_name = (uu___277_3465.use_zfuel_name);
          encode_non_total_function_typ =
            (uu___277_3465.encode_non_total_function_typ);
          current_module_name = (uu___277_3465.current_module_name);
          encoding_quantifier = (uu___277_3465.encoding_quantifier)
        }
