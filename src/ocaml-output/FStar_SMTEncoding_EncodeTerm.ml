    ...
    fun env  ->
      ...
      (match t0.FStar_Syntax_Syntax.n with
                                        ...
                                        let maybe_mkForall pat vars1 body =
                                          ...
                                          | uu____5008 ->
                                              FStar_SMTEncoding_Term.mkForall
                                                ...
                                                (pat, vars1, body)
                                           in
                                        let rec is_tot_fun_axioms ctx head1
                                          vars1 =
                                          match vars1 with
                                          | [] ->
                                          ...
                                          | x::vars2 ->
                                              let is_tot_fun_head =
                                                ...
                                                maybe_mkForall [[head1]] ctx
                                                  uu____5149
                                                 in
                                              let app1 = mk_Apply head1 [x]
                                                 in
                                              let ctx1 =
                                                FStar_List.append ctx [x]  in
                                              let rest =
                                                is_tot_fun_axioms ctx1 app1
                                                  vars2
                                                 in
                                      ...
                                      let tkey_hash =
                                        let uu____5276 =
                                          FStar_SMTEncoding_Term.hash_of_term
                                            tkey
                                           in
                                        Prims.op_Hat prefix1 uu____5276  in
                                      let tsym =
                                        let uu____5280 =
                                          FStar_Util.digest_of_string
                                            tkey_hash
                                           in
                                        Prims.op_Hat prefix1 uu____5280  in
                                      let cvar_sorts =
                                        FStar_List.map
                                        ...
                                        let uu____5476 =
                                          let uu____5479 =
                                            ...
                                            FStar_List.append guard_decls
                                              uu____5482
                                             in
                                          FStar_List.append decls' uu____5479
                                           in
                                        FStar_List.append decls uu____5476
                                         in
                                      (t1, uu____5475)))))
                else
                  (let tsym =
                   ...
                   let t_kinding =
                     ...
                     let uu____5503 =
                       ...
                       (uu____5511,
                        ...
                        in
                     FStar_SMTEncoding_Util.mkAssume uu____5503  in
                   let fsym =
                     FStar_SMTEncoding_Term.mk_fv
                             ...
                             let uu____5545 =
                               let uu____5550 =
                                 ...
                                 FStar_SMTEncoding_Term.mk_tester "Tm_arrow"
                                   uu____5551
                                  in
                               (f_has_t, uu____5550)  in
                             FStar_SMTEncoding_Util.mkImp uu____5545  in
                           ([[f_has_t]], [fsym], uu____5544)  in
                         let uu____5577 =
                           mkForall_fuel module_name
                             t0.FStar_Syntax_Syntax.pos
                            in
                         uu____5577 uu____5533  in
                       (uu____5532, (FStar_Pervasives_Native.Some a_name),
                         a_name)
                        in
                   ...
                   let uu____5594 =
                     FStar_All.pipe_right [tdecl; t_kinding; t_interp]
                      ...
                      in
                   (t1, uu____5594)))
       | FStar_Syntax_Syntax.Tm_refine uu____5597 ->
           let uu____5604 =
             let steps =
               [FStar_TypeChecker_Env.Weak;
               FStar_TypeChecker_Env.HNF;
             ...
             | { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_refine (x,f);
                 ...
                 FStar_Syntax_Syntax.vars = uu____5624;_} ->
                 let uu____5631 =
                 ...
                 (match uu____5631 with
                  | (b,f1) ->
                      let uu____5658 =
                        let uu____5659 = FStar_List.hd b  in
                        FStar_Pervasives_Native.fst uu____5659  in
                      (uu____5658, f1))
             | uu____5676 -> failwith "impossible"  in
           (match uu____5604 with
            | (x,f) ->
                let uu____5694 = encode_term x.FStar_Syntax_Syntax.sort env
                   in
                (match uu____5694 with
                 | (base_t,decls) ->
                     ...
                     (match uu____5705 with
                      | (x1,xtm,env') ->
                          let uu____5722 = encode_formula f env'  in
                                    ...
                                    ((let uu____5874 =
                                      ...
                                      then
                                        ...
                                        FStar_Util.print3
                                          ...
                                          uu____5878 tkey_hash uu____5880
                                      else ());
                                     (let tsym =
                                        let uu____5887 =
                                          FStar_Util.digest_of_string
                                            tkey_hash
                                           in
                                        Prims.op_Hat "Tm_refine_" uu____5887
                                         in
                                      let cvar_sorts =
                                        FStar_List.map
                                          FStar_SMTEncoding_Term.fv_sort
                                        ...
                                        let uu____6044 =
                                          let uu____6047 =
                                            FStar_SMTEncoding_Term.mk_decls
                                             ...
                                             in
                                          FStar_List.append decls' uu____6047
                                           in
                                        FStar_List.append decls uu____6044
                                         in
                                      (t1, uu____6043))))))))
       | FStar_Syntax_Syntax.Tm_uvar (uv,uu____6051) ->
           let ttm =
             let uu____6069 =
               FStar_Syntax_Unionfind.uvar_id
                 uv.FStar_Syntax_Syntax.ctx_uvar_head
                in
             FStar_SMTEncoding_Util.mk_Term_uvar uu____6069  in
           let uu____6071 =
             encode_term_pred FStar_Pervasives_Native.None
                ...
                let d =
                  let uu____6083 =
                        ...
                        let uu____6095 =
                          let uu____6097 =
                            FStar_Syntax_Unionfind.uvar_id
                              uv.FStar_Syntax_Syntax.ctx_uvar_head
                             in
                          FStar_Util.string_of_int uu____6097  in
                        FStar_Util.format1 "uvar_typing_%s" uu____6095  in
                    ...
                    (t_has_k, (FStar_Pervasives_Native.Some "Uvar typing"),
                      uu____6091)
                     in
                  FStar_SMTEncoding_Util.mkAssume uu____6083  in
                let uu____6103 =
                  let uu____6104 =
                    FStar_All.pipe_right [d]
                      FStar_SMTEncoding_Term.mk_decls_trivial
                     in
                  FStar_List.append decls uu____6104  in
                (ttm, uu____6103))
       | FStar_Syntax_Syntax.Tm_app uu____6111 ->
           let uu____6128 = FStar_Syntax_Util.head_and_args t0  in
           (match uu____6128 with
            | (head1,args_e) ->
                let uu____6175 =
                  let uu____6190 =
                    let uu____6191 = FStar_Syntax_Subst.compress head1  in
                    uu____6191.FStar_Syntax_Syntax.n  in
                  (uu____6190, args_e)  in
                (match uu____6175 with
                 | uu____6208 when head_redex env head1 ->
                     let uu____6223 = whnf env t  in
                     encode_term uu____6223 env
                 | uu____6224 when is_arithmetic_primitive head1 args_e ->
                     encode_arith_term env head1 args_e
                 | uu____6247 when is_BitVector_primitive head1 args_e ->
                     encode_BitVector_term env head1 args_e
                 | (FStar_Syntax_Syntax.Tm_fvar fv,uu____6265) when
                     (Prims.op_Negation
                 ...
                 | (FStar_Syntax_Syntax.Tm_uinst
                    ({
                       FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
                       FStar_Syntax_Syntax.pos = uu____6287;
                       FStar_Syntax_Syntax.vars = uu____6288;_},uu____6289),uu____6290)
                     when
                     (Prims.op_Negation
                        env.FStar_SMTEncoding_Env.encoding_quantifier)
                       &&
                 ...
                 | (FStar_Syntax_Syntax.Tm_uinst
                    ({
                       FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
                       FStar_Syntax_Syntax.pos = uu____6316;
                       FStar_Syntax_Syntax.vars = uu____6317;_},uu____6318),
                    (v0,uu____6320)::(v1,uu____6322)::(v2,uu____6324)::[])
                     when
                     FStar_Syntax_Syntax.fv_eq_lid fv
                       FStar_Parser_Const.lexcons_lid
                     ->
                     let uu____6395 = encode_term v0 env  in
                     (match uu____6395 with
                      | (v01,decls0) ->
                          let uu____6406 = encode_term v1 env  in
                          (match uu____6406 with
                           | (v11,decls1) ->
                               let uu____6417 = encode_term v2 env  in
                 ...
                 | (FStar_Syntax_Syntax.Tm_fvar
                    fv,(v0,uu____6431)::(v1,uu____6433)::(v2,uu____6435)::[])
                     when
                     FStar_Syntax_Syntax.fv_eq_lid fv
                       FStar_Parser_Const.lexcons_lid
                     ->
                     let uu____6502 = encode_term v0 env  in
                     (match uu____6502 with
                      | (v01,decls0) ->
                          let uu____6513 = encode_term v1 env  in
                          (match uu____6513 with
                           | (v11,decls1) ->
                               let uu____6524 = encode_term v2 env  in
                 ...
                 | (FStar_Syntax_Syntax.Tm_constant
                    (FStar_Const.Const_range_of ),(arg,uu____6537)::[]) ->
                     encode_const
                       (FStar_Const.Const_range (arg.FStar_Syntax_Syntax.pos))
                       env
                 | (FStar_Syntax_Syntax.Tm_constant
                    (FStar_Const.Const_set_range_of
                    ),(arg,uu____6573)::(rng,uu____6575)::[]) ->
                     encode_term arg env
                 | (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify
                    ),uu____6626) ->
                     let e0 =
                       let uu____6648 = FStar_List.hd args_e  in
                       FStar_TypeChecker_Util.reify_body_with_arg
                         env.FStar_SMTEncoding_Env.tcenv head1 uu____6648
                        in
                     ((let uu____6658 =
                         FStar_All.pipe_left
                           (FStar_TypeChecker_Env.debug
                      ...
                      (let e =
                         let uu____6671 =
                           ...
                           let uu____6677 = FStar_List.tl args_e  in
                           FStar_Syntax_Syntax.mk_Tm_app uu____6676
                             uu____6677
                            in
                         uu____6671 FStar_Pervasives_Native.None
                           t0.FStar_Syntax_Syntax.pos
                          in
                       encode_term e env))
                 | (FStar_Syntax_Syntax.Tm_constant
                    (FStar_Const.Const_reflect
                    uu____6686),(arg,uu____6688)::[]) -> encode_term arg env
                 | uu____6723 ->
                     let uu____6738 = encode_args args_e env  in
                     (match uu____6738 with
                      | (args,decls) ->
                          let encode_partial_app ht_opt =
                            let uu____6807 = encode_term head1 env  in
                                     ...
                                     ((let uu____6893 =
                                       ...
                                       then
                                         ...
                                         FStar_Util.print5
                                           ...
                                           uu____6897 uu____6899 uu____6901
                          ...
                          let head_type =
                            ...
                            | FStar_Syntax_Syntax.Tm_uinst
                                ({
                                   ...
                                   FStar_Syntax_Syntax.vars = uu____7520;_},uu____7521)
                                ->
                                FStar_Pervasives_Native.Some
                            ...
                            | FStar_Syntax_Syntax.Tm_uinst
                                ({
                                   ...
                                   FStar_Syntax_Syntax.vars = uu____7529;_},uu____7530)
                                ->
                                let uu____7535 =
                                  let uu____7536 =
                                    let uu____7541 =
                            ...
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____7606,(FStar_Util.Inl t1,uu____7608),uu____7609)
                                -> FStar_Pervasives_Native.Some t1
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____7656,(FStar_Util.Inr c,uu____7658),uu____7659)
                                ->
                                FStar_Pervasives_Native.Some
                                  (FStar_Syntax_Util.comp_result c)
                            | uu____7706 -> FStar_Pervasives_Native.None  in
                                 ...
                                 let head_type2 =
                                   let uu____7752 =
                                     FStar_TypeChecker_Normalize.normalize_refinement
                                      ...
                                      in
                                   FStar_All.pipe_left
                                     FStar_Syntax_Util.unrefine uu____7752
                                    in
                                 let uu____7755 =
                                    ...
                                    ((let uu____7890 =
                                      ...
                                      then
                                        ...
                                        FStar_Util.print3
                                          ...
                                          uu____7894 uu____7896 uu____7899
                                      else ());
                                     (match head2.FStar_Syntax_Syntax.n with
                                      | FStar_Syntax_Syntax.Tm_uinst
                                          ({
       ...
       | FStar_Syntax_Syntax.Tm_abs (bs,body,lopt) ->
           let uu____8018 = FStar_Syntax_Subst.open_term' bs body  in
           (match uu____8018 with
            | (bs1,body1,opening) ->
                let fallback uu____8041 =
                  let f =
                    FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.fresh
                ...
                let is_impure rc =
                  let uu____8064 =
                    FStar_TypeChecker_Util.is_pure_or_ghost_effect
                     ...
                     in
                  FStar_All.pipe_right uu____8064 Prims.op_Negation  in
                let codomain_eff rc =
                  let res_typ =
                    ...
                    | FStar_Pervasives_Native.None  ->
                        let uu____8079 =
                          ...
                          FStar_TypeChecker_Util.new_implicit_var
                            "SMTEncoding codomain" uu____8092
                            env.FStar_SMTEncoding_Env.tcenv
                            FStar_Syntax_Util.ktype0
                           in
                        (match uu____8079 with
                         | (t1,uu____8095,uu____8096) -> t1)
                  ...
                  if uu____8114
                  then
                    let uu____8119 = FStar_Syntax_Syntax.mk_Total res_typ  in
                    FStar_Pervasives_Native.Some uu____8119
                  else
                    (let uu____8122 =
                       FStar_Ident.lid_equals
                         rc.FStar_Syntax_Syntax.residual_effect
                     ...
                     if uu____8122
                     then
                       let uu____8127 = FStar_Syntax_Syntax.mk_GTotal res_typ
                          in
                 ...
                 | FStar_Pervasives_Native.Some rc ->
                     ...
                     then fallback ()
                       ...
                       (let uu____8160 =
                        ...
                        | (vars,guards,envbody,decls,uu____8185) ->
                            let body2 =
                              let uu____8199 =
                                FStar_TypeChecker_Env.is_reifiable_rc
                                  env.FStar_SMTEncoding_Env.tcenv rc
                            ...
                            let uu____8204 = encode_term body2 envbody  in
                            (match uu____8204 with
                             | (body3,decls') ->
                                 let uu____8215 =
                                   let uu____8224 = codomain_eff rc  in
                                   ...
                                   | FStar_Pervasives_Native.Some c ->
                                       ...
                                       let uu____8243 = encode_term tfun env
                                          in
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((uu____8597,{
                          ...
                          FStar_Syntax_Syntax.lbdef = uu____8602;
                          FStar_Syntax_Syntax.lbattrs = uu____8603;
                          FStar_Syntax_Syntax.lbpos = uu____8604;_}::uu____8605),uu____8606)
           -> failwith "Impossible: already handled by encoding of Sig_let"
       | FStar_Syntax_Syntax.Tm_let
           ((false
             ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                FStar_Syntax_Syntax.lbunivs = uu____8640;
                FStar_Syntax_Syntax.lbtyp = t1;
                FStar_Syntax_Syntax.lbeff = uu____8642;
                FStar_Syntax_Syntax.lbdef = e1;
                FStar_Syntax_Syntax.lbattrs = uu____8644;
                FStar_Syntax_Syntax.lbpos = uu____8645;_}::[]),e2)
           -> encode_let x t1 e1 e2 env encode_term
       | FStar_Syntax_Syntax.Tm_let uu____8672 ->
            ...
            fun encode_body  ->
              ...
              | (ee1,decls1) ->
                  ...
                  (match uu____8774 with
                   | (xs,e21) ->
                       let uu____8799 = FStar_List.hd xs  in
                       (match uu____8799 with
                        | (x1,uu____8817) ->
                            let env' =
                              FStar_SMTEncoding_Env.push_term_var env x1 ee1
                               in
                            let uu____8823 = encode_body e21 env'  in
        ...
        fun env  ->
          fun encode_br  ->
            let uu____8853 =
              ...
              FStar_SMTEncoding_Env.gen_term_var env uu____8861  in
            match uu____8853 with
            | (scrsym,scr',env1) ->
                let uu____8872 = encode_term e env1  in
                (match uu____8872 with
                 | (scr,decls) ->
                     let uu____8883 =
                       let encode_branch b uu____8912 =
                         ...
                         | (else_case,decls1) ->
                             ...
                             (match uu____8931 with
                              | (p,w,br) ->
                                  let uu____8957 = encode_pat env1 p  in
                            ...
                            let uu____9098 =
                              let uu____9109 =
                                let uu____9116 =
                                  ...
                                  (uu____9121, scr)  in
                                [uu____9116]  in
                              (uu____9109, match_tm)  in
                            FStar_SMTEncoding_Term.mkLet' uu____9098
                              FStar_Range.dummyRange
                             in
                          (uu____9097, decls1)))
  ...
  fun env  ->
    fun pat  ->
      (let uu____9144 =
       ...
       if uu____9144
       then
         let uu____9147 = FStar_Syntax_Print.pat_to_string pat  in
         FStar_Util.print1 "Encoding pattern %s\n" uu____9147
       else ());
      (let uu____9152 = FStar_TypeChecker_Util.decorated_pattern_as_term pat
          in
           ...
           (match uu____9169 with
            | (env1,vars1) ->
                let rec mk_guard pat1 scrutinee =
                  ...
                  | FStar_Syntax_Syntax.Pat_var uu____9337 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_wild uu____9338 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_dot_term uu____9339 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_constant c ->
                      let uu____9347 = encode_const c env1  in
                ...
                let rec mk_projections pat1 scrutinee =
                  match pat1.FStar_Syntax_Syntax.v with
                  | FStar_Syntax_Syntax.Pat_dot_term (x,uu____9484) ->
                      [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_var x -> [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_wild x -> [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_constant uu____9515 -> []
                  | FStar_Syntax_Syntax.Pat_cons (f,args) ->
                      let uu____9540 =
                        FStar_All.pipe_right args
                          (FStar_List.mapi
                                  ...
                                  | (arg,uu____9602) ->
                                      ...
                                      let uu____9611 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee])
                                         in
                                      mk_projections arg uu____9611))
                         in
                      FStar_All.pipe_right uu____9540 FStar_List.flatten
                   in
                let pat_term1 uu____9642 = encode_term pat_term env1  in
                let pattern =
                  {
                    pat_vars = vars1;
                    pat_term = pat_term1;
          ...
          (FStar_List.fold_left
             (fun uu____9700  ->
                fun uu____9701  ->
                  ...
                  | ((tms,decls),(t,uu____9741)) ->
                      let uu____9768 = encode_term t env  in
                      (match uu____9768 with
                       | (t1,decls') ->
                           ((t1 :: tms), (FStar_List.append decls decls'))))
             ([], []))
         in
      match uu____9652 with | (l1,decls) -> ((FStar_List.rev l1), decls)
  ...
  fun t  ->
    fun env  ->
      let universe_of_binders binders =
        FStar_List.map (fun uu____9846  -> FStar_Syntax_Syntax.U_zero)
          binders
         in
      let quant = FStar_Syntax_Util.smt_lemma_as_forall t universe_of_binders
         in
      let env1 =
        let uu___1333_9855 = env  in
        {
          FStar_SMTEncoding_Env.bvar_bindings =
            (uu___1333_9855.FStar_SMTEncoding_Env.bvar_bindings);
          FStar_SMTEncoding_Env.fvar_bindings =
            (uu___1333_9855.FStar_SMTEncoding_Env.fvar_bindings);
          FStar_SMTEncoding_Env.depth =
            (uu___1333_9855.FStar_SMTEncoding_Env.depth);
          FStar_SMTEncoding_Env.tcenv =
            (uu___1333_9855.FStar_SMTEncoding_Env.tcenv);
          FStar_SMTEncoding_Env.warn =
            (uu___1333_9855.FStar_SMTEncoding_Env.warn);
          FStar_SMTEncoding_Env.nolabels =
            (uu___1333_9855.FStar_SMTEncoding_Env.nolabels);
          FStar_SMTEncoding_Env.use_zfuel_name = true;
          FStar_SMTEncoding_Env.encode_non_total_function_typ =
            (uu___1333_9855.FStar_SMTEncoding_Env.encode_non_total_function_typ);
          FStar_SMTEncoding_Env.current_module_name =
            (uu___1333_9855.FStar_SMTEncoding_Env.current_module_name);
          FStar_SMTEncoding_Env.encoding_quantifier =
            (uu___1333_9855.FStar_SMTEncoding_Env.encoding_quantifier);
          FStar_SMTEncoding_Env.global_cache =
            (uu___1333_9855.FStar_SMTEncoding_Env.global_cache)
        }  in
...
and (encode_smt_patterns :
  ...
  fun pats_l  ->
    fun env  ->
      let env1 =
        let uu___1338_9872 = env  in
        {
          FStar_SMTEncoding_Env.bvar_bindings =
            (uu___1338_9872.FStar_SMTEncoding_Env.bvar_bindings);
          FStar_SMTEncoding_Env.fvar_bindings =
            (uu___1338_9872.FStar_SMTEncoding_Env.fvar_bindings);
          FStar_SMTEncoding_Env.depth =
            (uu___1338_9872.FStar_SMTEncoding_Env.depth);
          FStar_SMTEncoding_Env.tcenv =
            (uu___1338_9872.FStar_SMTEncoding_Env.tcenv);
          FStar_SMTEncoding_Env.warn =
            (uu___1338_9872.FStar_SMTEncoding_Env.warn);
          FStar_SMTEncoding_Env.nolabels =
            (uu___1338_9872.FStar_SMTEncoding_Env.nolabels);
          FStar_SMTEncoding_Env.use_zfuel_name = true;
          FStar_SMTEncoding_Env.encode_non_total_function_typ =
            (uu___1338_9872.FStar_SMTEncoding_Env.encode_non_total_function_typ);
          FStar_SMTEncoding_Env.current_module_name =
            (uu___1338_9872.FStar_SMTEncoding_Env.current_module_name);
          FStar_SMTEncoding_Env.encoding_quantifier =
            (uu___1338_9872.FStar_SMTEncoding_Env.encoding_quantifier);
          FStar_SMTEncoding_Env.global_cache =
            (uu___1338_9872.FStar_SMTEncoding_Env.global_cache)
        }  in
      let encode_smt_pattern t =
        let uu____9888 = FStar_Syntax_Util.head_and_args t  in
        match uu____9888 with
        | (head1,args) ->
            let head2 = FStar_Syntax_Util.un_uinst head1  in
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,uu____9951::(x,uu____9953)::(t1,uu____9955)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
                 let uu____10022 = encode_term x env1  in
                 (match uu____10022 with
                  | (x1,decls) ->
                      let uu____10033 = encode_term t1 env1  in
                      (match uu____10033 with
                       | (t2,decls') ->
                           let uu____10044 =
                             FStar_SMTEncoding_Term.mk_HasType x1 t2  in
                           (uu____10044, (FStar_List.append decls decls'))))
             | uu____10045 -> encode_term t env1)
         in
             ...
             | (pats_l1,decls) ->
                 let uu____10133 =
                   FStar_List.fold_right
                     (fun uu____10168  ->
                        fun uu____10169  ->
                          match (uu____10168, uu____10169) with
                          | ((p,uu____10211),(pats1,decls1)) ->
                              let uu____10246 = encode_smt_pattern p  in
  ...
  fun phi  ->
    fun env  ->
      let debug1 phi1 =
        ...
        if uu____10348
        then
          let uu____10353 = FStar_Syntax_Print.tag_of_term phi1  in
          let uu____10355 = FStar_Syntax_Print.term_to_string phi1  in
          FStar_Util.print2 "Formula (%s)  %s\n" uu____10353 uu____10355
        else ()  in
      let enc f r l =
        let uu____10397 =
          FStar_Util.fold_map
        ...
        | (decls,args) ->
            let uu____10460 =
              let uu___1402_10461 = f args  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___1402_10461.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___1402_10461.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              }  in
            (uu____10460, decls)
         in
      let const_op f r uu____10496 =
        let uu____10509 = f r  in (uu____10509, [])  in
      let un_op f l =
        let uu____10532 = FStar_List.hd l  in
        FStar_All.pipe_left f uu____10532  in
      let bin_op f uu___2_10552 =
        match uu___2_10552 with
        | t1::t2::[] -> f (t1, t2)
        | uu____10563 -> failwith "Impossible"  in
      let enc_prop_c f r l =
          ...
          FStar_Util.fold_map
            (fun decls  ->
               fun uu____10629  ->
                 ...
                 | (t,uu____10645) ->
                     let uu____10650 = encode_formula t env  in
        ...
        | (decls,phis) ->
            let uu____10679 =
              let uu___1432_10680 = f phis  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___1432_10680.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___1432_10680.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              }  in
            (uu____10679, decls)
         in
          ...
          FStar_List.filter
            (fun uu____10743  ->
               ...
               | (a,q) ->
                   (match q with
                    | FStar_Pervasives_Native.Some
                        (FStar_Syntax_Syntax.Implicit uu____10764) -> false
                    | uu____10767 -> true)) args
           in
        ...
        then
          let uu____10786 =
            FStar_Util.format1
             ...
             in
          failwith uu____10786
        else
          (let uu____10803 = enc (bin_op FStar_SMTEncoding_Util.mkEq)  in
           uu____10803 r rf)
         in
      let eq3_op r args =
          ...
          let uu____10871 =
            enc
              (fun terms  ->
                 ...
                 | t0::t1::v0::v1::[] ->
                     let uu____10903 =
                       let uu____10908 = FStar_SMTEncoding_Util.mkEq (t0, t1)
                          in
                       let uu____10909 = FStar_SMTEncoding_Util.mkEq (v0, v1)
                          in
                       (uu____10908, uu____10909)  in
                     FStar_SMTEncoding_Util.mkAnd uu____10903
                 | uu____10910 -> failwith "Impossible")
             in
          uu____10871 r args
        else
          (let uu____10916 =
          ...
          let uu____10978 =
            enc
              (fun terms  ->
                 ...
                 | t0::v0::t1::v1::[] ->
                     let uu____11010 =
                       let uu____11015 = FStar_SMTEncoding_Util.mkEq (t0, t1)
                          in
                       let uu____11016 = FStar_SMTEncoding_Util.mkEq (v0, v1)
                          in
                       (uu____11015, uu____11016)  in
                     FStar_SMTEncoding_Util.mkAnd uu____11010
                 | uu____11017 -> failwith "Impossible")
             in
          uu____10978 r args
        else
          (let uu____11023 =
             FStar_Util.format1
               ...
               (Prims.string_of_int n1)
              in
           failwith uu____11023)
         in
      let mk_imp1 r uu___3_11052 =
        match uu___3_11052 with
        | (lhs,uu____11058)::(rhs,uu____11060)::[] ->
            let uu____11101 = encode_formula rhs env  in
            (match uu____11101 with
             | (l1,decls1) ->
                 (match l1.FStar_SMTEncoding_Term.tm with
                  | FStar_SMTEncoding_Term.App
                      (FStar_SMTEncoding_Term.TrueOp ,uu____11116) ->
                      (l1, decls1)
                  | uu____11121 ->
                      let uu____11122 = encode_formula lhs env  in
                      (match uu____11122 with
                       | (l2,decls2) ->
                           let uu____11133 =
                             FStar_SMTEncoding_Term.mkImp (l2, l1) r  in
                           (uu____11133, (FStar_List.append decls1 decls2)))))
        | uu____11134 -> failwith "impossible"  in
      let mk_ite r uu___4_11162 =
        match uu___4_11162 with
        | (guard,uu____11168)::(_then,uu____11170)::(_else,uu____11172)::[]
            ->
            let uu____11229 = encode_formula guard env  in
            (match uu____11229 with
             | (g,decls1) ->
                 let uu____11240 = encode_formula _then env  in
                 (match uu____11240 with
                  | (t,decls2) ->
                      let uu____11251 = encode_formula _else env  in
      ...
      let unboxInt_l f l =
        let uu____11293 = FStar_List.map FStar_SMTEncoding_Term.unboxInt l
           in
        f uu____11293  in
      let connectives =
        let uu____11323 =
          let uu____11348 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd)
             in
          (FStar_Parser_Const.and_lid, uu____11348)  in
        let uu____11391 =
          let uu____11418 =
            let uu____11443 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr)
               in
            (FStar_Parser_Const.or_lid, uu____11443)  in
          let uu____11486 =
            let uu____11513 =
              let uu____11540 =
                let uu____11565 =
                  enc_prop_c (bin_op FStar_SMTEncoding_Util.mkIff)  in
                (FStar_Parser_Const.iff_lid, uu____11565)  in
              let uu____11608 =
                let uu____11635 =
                  let uu____11662 =
                    let uu____11687 =
                      enc_prop_c (un_op FStar_SMTEncoding_Util.mkNot)  in
                    (FStar_Parser_Const.not_lid, uu____11687)  in
                  [uu____11662;
                  ...
                  (FStar_Parser_Const.false_lid,
                   ...
                   in
                (FStar_Parser_Const.ite_lid, mk_ite) :: uu____11635  in
              uu____11540 :: uu____11608  in
            (FStar_Parser_Const.imp_lid, mk_imp1) :: uu____11513  in
          uu____11418 :: uu____11486  in
        uu____11323 :: uu____11391  in
      let rec fallback phi1 =
        match phi1.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Tm_meta
            (phi',FStar_Syntax_Syntax.Meta_labeled (msg,r,b)) ->
            let uu____12232 = encode_formula phi' env  in
             ...
             | (phi2,decls) ->
                 let uu____12243 =
                   FStar_SMTEncoding_Term.mk
                    ...
                    in
                 (uu____12243, decls))
        | FStar_Syntax_Syntax.Tm_meta uu____12245 ->
            let uu____12252 = FStar_Syntax_Util.unmeta phi1  in
        ...
        | FStar_Syntax_Syntax.Tm_match (e,pats) ->
            let uu____12291 =
              encode_match e pats FStar_SMTEncoding_Util.mkFalse env
                encode_formula
               in
            (match uu____12291 with | (t,decls) -> (t, decls))
        | FStar_Syntax_Syntax.Tm_let
            ((false
              ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                 FStar_Syntax_Syntax.lbunivs = uu____12303;
                 FStar_Syntax_Syntax.lbtyp = t1;
                 FStar_Syntax_Syntax.lbeff = uu____12305;
                 FStar_Syntax_Syntax.lbdef = e1;
                 FStar_Syntax_Syntax.lbattrs = uu____12307;
                 FStar_Syntax_Syntax.lbpos = uu____12308;_}::[]),e2)
            ->
            let uu____12335 = encode_let x t1 e1 e2 env encode_formula  in
            (match uu____12335 with | (t,decls) -> (t, decls))
        | FStar_Syntax_Syntax.Tm_app (head1,args) ->
            let head2 = FStar_Syntax_Util.un_uinst head1  in
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,uu____12388::(x,uu____12390)::(t,uu____12392)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
                 let uu____12459 = encode_term x env  in
                 (match uu____12459 with
                  | (x1,decls) ->
                      let uu____12470 = encode_term t env  in
                      (match uu____12470 with
                       | (t1,decls') ->
                           let uu____12481 =
                             FStar_SMTEncoding_Term.mk_HasType x1 t1  in
                           (uu____12481, (FStar_List.append decls decls'))))
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(r,uu____12484)::(msg,uu____12486)::(phi2,uu____12488)::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                 ...
                 let uu____12555 =
                   let uu____12560 =
                     let uu____12561 = FStar_Syntax_Subst.compress r  in
                     uu____12561.FStar_Syntax_Syntax.n  in
                   let uu____12564 =
                     let uu____12565 = FStar_Syntax_Subst.compress msg  in
                     uu____12565.FStar_Syntax_Syntax.n  in
                   (uu____12560, uu____12564)  in
                 (match uu____12555 with
                  | (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_range
                     r1),FStar_Syntax_Syntax.Tm_constant
                     (FStar_Const.Const_string (s,uu____12574))) ->
                      let phi3 =
                        FStar_Syntax_Syntax.mk
                         ...
                         in
                      fallback phi3
                  | uu____12585 -> fallback phi2)
             | (FStar_Syntax_Syntax.Tm_fvar fv,(t,uu____12592)::[]) when
                 (FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             | uu____12627 when head_redex env head2 ->
                 let uu____12642 = whnf env phi1  in
                 encode_formula uu____12642 env
             | uu____12643 ->
                 let uu____12658 = encode_term phi1 env  in
                        ...
                        let uu____12670 =
                          ...
                          let uu____12673 =
                            FStar_Range.use_range
                             ...
                             in
                          FStar_Range.rng_included uu____12672 uu____12673
                           in
                        if uu____12670
                        then tt
                        else
                          (let uu___1619_12677 = tt  in
                           {
                             FStar_SMTEncoding_Term.tm =
                               (uu___1619_12677.FStar_SMTEncoding_Term.tm);
                             FStar_SMTEncoding_Term.freevars =
                               (uu___1619_12677.FStar_SMTEncoding_Term.freevars);
                             FStar_SMTEncoding_Term.rng =
                               (phi1.FStar_Syntax_Syntax.pos)
                           })
                         in
                      let uu____12678 = FStar_SMTEncoding_Term.mk_Valid tt1
                         in
                      (uu____12678, decls)))
        | uu____12679 ->
            let uu____12680 = encode_term phi1 env  in
             ...
             | (tt,decls) ->
                 let tt1 =
                   let uu____12692 =
                     ...
                     FStar_Range.rng_included uu____12694 uu____12695  in
                   if uu____12692
                   then tt
                   else
                     (let uu___1627_12699 = tt  in
                      {
                        FStar_SMTEncoding_Term.tm =
                          (uu___1627_12699.FStar_SMTEncoding_Term.tm);
                        FStar_SMTEncoding_Term.freevars =
                          (uu___1627_12699.FStar_SMTEncoding_Term.freevars);
                        FStar_SMTEncoding_Term.rng =
                          (phi1.FStar_Syntax_Syntax.pos)
                      })
                    in
                 let uu____12700 = FStar_SMTEncoding_Term.mk_Valid tt1  in
                 (uu____12700, decls))
         in
      let encode_q_body env1 bs ps body =
        let uu____12744 = encode_binders FStar_Pervasives_Native.None bs env1
           in
        match uu____12744 with
        | (vars,guards,env2,decls,uu____12783) ->
            let uu____12796 = encode_smt_patterns ps env2  in
            (match uu____12796 with
             | (pats,decls') ->
                 let uu____12833 = encode_formula body env2  in
                  ...
                  | (body1,decls'') ->
                      let guards1 =
                        ...
                        | ({
                             ...
                             FStar_SMTEncoding_Term.freevars = uu____12865;
                             FStar_SMTEncoding_Term.rng = uu____12866;_}::[])::[]
                            when
                            let uu____12886 =
                              FStar_Ident.text_of_lid
                               ...
                               in
                            uu____12886 = gf -> []
                        | uu____12889 -> guards  in
                      let uu____12894 =
                        FStar_SMTEncoding_Util.mk_and_l guards1  in
                      (vars, pats, uu____12894, body1,
                        (FStar_List.append decls
                           (FStar_List.append decls' decls'')))))
         in
      debug1 phi;
      (let phi1 = FStar_Syntax_Util.unascribe phi  in
       let uu____12905 = FStar_Syntax_Util.destruct_typ_as_formula phi1  in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____13020  ->
                     ...
                     | (l,uu____13045) -> FStar_Ident.lid_equals op l))
              in
           (match uu____12914 with
            | FStar_Pervasives_Native.None  -> fallback phi1
            | FStar_Pervasives_Native.Some (uu____13114,f) ->
                f phi1.FStar_Syntax_Syntax.pos arms)
       | FStar_Pervasives_Native.Some (FStar_Syntax_Util.QAll
           (vars,pats,body)) ->
           (FStar_All.pipe_right pats
              (FStar_List.iter (check_pattern_vars env vars));
            (let uu____13206 = encode_q_body env vars pats body  in
             ...
             | (vars1,pats1,guard,body1,decls) ->
                 let tm =
                   let uu____13251 =
                     ...
                     (pats1, vars1, uu____13262)  in
                   FStar_SMTEncoding_Term.mkForall
                     phi1.FStar_Syntax_Syntax.pos uu____13251
                    in
                 (tm, decls)))
       | FStar_Pervasives_Native.Some (FStar_Syntax_Util.QEx
           ...
           (FStar_All.pipe_right pats
              (FStar_List.iter (check_pattern_vars env vars));
            (let uu____13293 = encode_q_body env vars pats body  in
             ...
             | (vars1,pats1,guard,body1,decls) ->
                 let uu____13337 =
                   let uu____13338 =
                     ...
                     (pats1, vars1, uu____13349)  in
                   FStar_SMTEncoding_Term.mkExists
                     phi1.FStar_Syntax_Syntax.pos uu____13338
                    in
                 (uu____13337, decls))))
