                     ...
                     | FStar_SMTEncoding_Term.App
                         ...
                         let guard1 =
                           ...
                           | uu____125 ->
                               ...
                               FStar_All.pipe_right uu____126 FStar_List.hd in
                  ...
                  (FStar_List.forall2
                     (fun a ->
                        fun v1 ->
                          ...
                          | uu____668 -> false) args (FStar_List.rev xs)) in
              if uu____657
                ...
                FStar_All.pipe_right fvs
                  (FStar_List.for_all
                     (fun fv ->
                        ...
                        Prims.op_Negation uu____682)) in
              if uu____676
  ...
  'Auu____703 'Auu____704 .
    FStar_SMTEncoding_Env.env_t ->
      (FStar_Syntax_Syntax.bv, 'Auu____703) FStar_Pervasives_Native.tuple2
        Prims.list ->
        (FStar_Syntax_Syntax.term, 'Auu____704)
              ...
              FStar_List.fold_left
                (fun out ->
                   fun x ->
                     ...
                     FStar_Util.set_union out uu____788) uu____776 tl1 in
            let uu____791 =
              FStar_All.pipe_right vars
                (FStar_Util.find_opt
                   (fun uu____818 ->
...
let is_BitVector_primitive :
  ...
  fun head1 ->
    fun args ->
      match ((head1.FStar_Syntax_Syntax.n), args) with
      | (FStar_Syntax_Syntax.Tm_fvar fv,
         (sz_arg, uu____1329)::uu____1330::uu____1331::[]) ->
          (((((((((((FStar_Syntax_Syntax.fv_eq_lid fv
                         ...
                         let uu____1996 =
                           ...
                           | (xxsym, xx, env') ->
                               let uu____2042 =
                                 ...
                                 encode_term_pred fuel_opt uu____2047 env1 xx in
      ...
      fun env ->
        fun e ->
          ...
          | (t1, decls) ->
              (match fuel_opt with
               | FStar_Pervasives_Native.None ->
                   let uu____2245 = FStar_SMTEncoding_Term.mk_HasTypeZ e t1 in
                   (uu____2245, decls)
      ...
      fun args_e ->
        ...
        | (arg_tms, decls) ->
            ...
            let mk_l op mk_args ts =
              let uu____2373 = FStar_Options.smtencoding_l_arith_native () in
              if uu____2373
              then
                let uu____2374 = let uu____2375 = mk_args ts in op uu____2375 in
                FStar_All.pipe_right uu____2374 FStar_SMTEncoding_Term.boxInt
              else mk_default () in
            let mk_nl nm op ts =
              let uu____2410 = FStar_Options.smtencoding_nl_arith_wrapped () in
              if uu____2410
              then
      ...
      fun args_e ->
        ...
        | (tm_sz, uu____2701) ->
            ...
            let uu____2725 =
              ...
              | (FStar_Syntax_Syntax.Tm_fvar fv,
                 uu____2749::(sz_arg, uu____2751)::uu____2752::[]) when
                  (FStar_Syntax_Syntax.fv_eq_lid fv
                     FStar_Parser_Const.bv_uext_lid)
                    && (isInteger sz_arg.FStar_Syntax_Syntax.n)
                  ->
                  ...
                  let uu____2823 =
                    let uu____2826 = getInteger sz_arg.FStar_Syntax_Syntax.n in
                    FStar_Pervasives_Native.Some uu____2826 in
                  (uu____2819, uu____2823)
              | (FStar_Syntax_Syntax.Tm_fvar fv,
                 uu____2830::(sz_arg, uu____2832)::uu____2833::[]) when
                  FStar_Syntax_Syntax.fv_eq_lid fv
                    FStar_Parser_Const.bv_uext_lid
                  ->
                  let uu____2900 =
                    let uu____2901 = FStar_Syntax_Print.term_to_string sz_arg in
                    FStar_Util.format1
                      "Not a constant bitvector extend size: %s" uu____2901 in
                  failwith uu____2900
              | uu____2908 ->
                  let uu____2923 = FStar_List.tail args_e in
                  (uu____2923, FStar_Pervasives_Native.None) in
                  ...
                  | (arg_tms1, decls) ->
                      ...
                      let binary arg_tms2 =
                        let uu____2996 =
                          ...
                          FStar_SMTEncoding_Term.unboxBitVec sz uu____2997 in
                        let uu____2998 =
                          let uu____2999 =
                      ...
                      let binary_arith arg_tms2 =
                        let uu____3017 =
                          ...
                          FStar_SMTEncoding_Term.unboxBitVec sz uu____3018 in
                        let uu____3019 =
                          let uu____3020 =
...
and (encode_deeply_embedded_quantifier :
  ...
  fun t ->
    fun env ->
      let env1 =
        let uu___354_3570 = env in
        {
          FStar_SMTEncoding_Env.bvar_bindings =
            (uu___354_3570.FStar_SMTEncoding_Env.bvar_bindings);
          FStar_SMTEncoding_Env.fvar_bindings =
            (uu___354_3570.FStar_SMTEncoding_Env.fvar_bindings);
          FStar_SMTEncoding_Env.depth =
            (uu___354_3570.FStar_SMTEncoding_Env.depth);
          FStar_SMTEncoding_Env.tcenv =
            (uu___354_3570.FStar_SMTEncoding_Env.tcenv);
          FStar_SMTEncoding_Env.warn =
            (uu___354_3570.FStar_SMTEncoding_Env.warn);
          FStar_SMTEncoding_Env.cache =
            (uu___354_3570.FStar_SMTEncoding_Env.cache);
          FStar_SMTEncoding_Env.nolabels =
            (uu___354_3570.FStar_SMTEncoding_Env.nolabels);
          FStar_SMTEncoding_Env.use_zfuel_name =
            (uu___354_3570.FStar_SMTEncoding_Env.use_zfuel_name);
          FStar_SMTEncoding_Env.encode_non_total_function_typ =
            (uu___354_3570.FStar_SMTEncoding_Env.encode_non_total_function_typ);
          FStar_SMTEncoding_Env.current_module_name =
            (uu___354_3570.FStar_SMTEncoding_Env.current_module_name);
                    ...
                    (uu____3607,
                     {
                       ...
                       FStar_SMTEncoding_Term.freevars = uu____3609;
                                 ...
                                 let uu____3676 =
                                   let uu____3677 =
                                     let uu____3682 =
                                       FStar_SMTEncoding_Term.mk_Valid tm in
                                     (uu____3682, phi) in
                                   FStar_SMTEncoding_Util.mkIff uu____3677 in
                                 ([[valid_tm]], vars, uu____3676) in
                               FStar_SMTEncoding_Term.mkForall
                                 t.FStar_Syntax_Syntax.pos uu____3665 in
                         let ax =
                           let uu____3692 =
                             let uu____3699 =
      ...
      (match t0.FStar_Syntax_Syntax.n with
       | FStar_Syntax_Syntax.Tm_delayed uu____3719 ->
           let uu____3742 =
             ...
             FStar_Util.format4 "(%s) Impossible: %s\n%s\n%s\n" uu____3743
               uu____3744 uu____3745 uu____3746 in
           failwith uu____3742
       | FStar_Syntax_Syntax.Tm_unknown ->
           let uu____3751 =
             ...
             FStar_Util.format4 "(%s) Impossible: %s\n%s\n%s\n" uu____3752
               uu____3753 uu____3754 uu____3755 in
           failwith uu____3751
           ...
           let tv =
             let uu____3855 =
               ...
               FStar_Syntax_Embeddings.embed
                 FStar_Reflection_Embeddings.e_term_view uu____3862 in
            ...
            (let t1 =
               ...
               FStar_Syntax_Util.mk_app
                 (FStar_Reflection_Data.refl_constant_term
                    FStar_Reflection_Data.fstar_refl_pack_ln) uu____3896 in
             encode_term t1 env))
       | FStar_Syntax_Syntax.Tm_meta
           (t1, FStar_Syntax_Syntax.Meta_pattern uu____3933) ->
           encode_term t1
             (let uu___355_3951 = env in
              {
                FStar_SMTEncoding_Env.bvar_bindings =
                  (uu___355_3951.FStar_SMTEncoding_Env.bvar_bindings);
                FStar_SMTEncoding_Env.fvar_bindings =
                  (uu___355_3951.FStar_SMTEncoding_Env.fvar_bindings);
                FStar_SMTEncoding_Env.depth =
                  (uu___355_3951.FStar_SMTEncoding_Env.depth);
                FStar_SMTEncoding_Env.tcenv =
                  (uu___355_3951.FStar_SMTEncoding_Env.tcenv);
                FStar_SMTEncoding_Env.warn =
                  (uu___355_3951.FStar_SMTEncoding_Env.warn);
                FStar_SMTEncoding_Env.cache =
                  (uu___355_3951.FStar_SMTEncoding_Env.cache);
                FStar_SMTEncoding_Env.nolabels =
                  (uu___355_3951.FStar_SMTEncoding_Env.nolabels);
                FStar_SMTEncoding_Env.use_zfuel_name =
                  (uu___355_3951.FStar_SMTEncoding_Env.use_zfuel_name);
                FStar_SMTEncoding_Env.encode_non_total_function_typ =
                  (uu___355_3951.FStar_SMTEncoding_Env.encode_non_total_function_typ);
                FStar_SMTEncoding_Env.current_module_name =
                  (uu___355_3951.FStar_SMTEncoding_Env.current_module_name);
                      ...
                      | FStar_SMTEncoding_Term.FreeV uu____3981 ->
                          let uu____3986 =
                            let uu____3987 =
                              ...
                              (uu____3994,
                                (FStar_Pervasives_Native.Some
                                   "kick_partial_app"), uu____3995) in
                      ...
                      | FStar_SMTEncoding_Term.App (uu____3996, []) ->
                          let uu____3999 =
                            let uu____4000 =
                              ...
                              (uu____4007,
                                (FStar_Pervasives_Native.Some
                                   "kick_partial_app"), uu____4008) in
                           ...
                           (let uu___356_4113 =
                              env.FStar_SMTEncoding_Env.tcenv in
                            {
                              FStar_TypeChecker_Env.solver =
                                (uu___356_4113.FStar_TypeChecker_Env.solver);
                              FStar_TypeChecker_Env.range =
                                (uu___356_4113.FStar_TypeChecker_Env.range);
                              FStar_TypeChecker_Env.curmodule =
                                (uu___356_4113.FStar_TypeChecker_Env.curmodule);
                              FStar_TypeChecker_Env.gamma =
                                (uu___356_4113.FStar_TypeChecker_Env.gamma);
                              FStar_TypeChecker_Env.gamma_sig =
                                (uu___356_4113.FStar_TypeChecker_Env.gamma_sig);
                              FStar_TypeChecker_Env.gamma_cache =
                                (uu___356_4113.FStar_TypeChecker_Env.gamma_cache);
                              FStar_TypeChecker_Env.modules =
                                (uu___356_4113.FStar_TypeChecker_Env.modules);
                              FStar_TypeChecker_Env.expected_typ =
                                (uu___356_4113.FStar_TypeChecker_Env.expected_typ);
                              FStar_TypeChecker_Env.sigtab =
                                (uu___356_4113.FStar_TypeChecker_Env.sigtab);
                              FStar_TypeChecker_Env.attrtab =
                                (uu___356_4113.FStar_TypeChecker_Env.attrtab);
                              FStar_TypeChecker_Env.is_pattern =
                                (uu___356_4113.FStar_TypeChecker_Env.is_pattern);
                              FStar_TypeChecker_Env.instantiate_imp =
                                (uu___356_4113.FStar_TypeChecker_Env.instantiate_imp);
                              FStar_TypeChecker_Env.effects =
                                (uu___356_4113.FStar_TypeChecker_Env.effects);
                              FStar_TypeChecker_Env.generalize =
                                (uu___356_4113.FStar_TypeChecker_Env.generalize);
                              FStar_TypeChecker_Env.letrecs =
                                (uu___356_4113.FStar_TypeChecker_Env.letrecs);
                              FStar_TypeChecker_Env.top_level =
                                (uu___356_4113.FStar_TypeChecker_Env.top_level);
                              FStar_TypeChecker_Env.check_uvars =
                                (uu___356_4113.FStar_TypeChecker_Env.check_uvars);
                              FStar_TypeChecker_Env.use_eq =
                                (uu___356_4113.FStar_TypeChecker_Env.use_eq);
                              FStar_TypeChecker_Env.is_iface =
                                (uu___356_4113.FStar_TypeChecker_Env.is_iface);
                              FStar_TypeChecker_Env.admit =
                                (uu___356_4113.FStar_TypeChecker_Env.admit);
                              FStar_TypeChecker_Env.lax = true;
                              FStar_TypeChecker_Env.lax_universes =
                                (uu___356_4113.FStar_TypeChecker_Env.lax_universes);
                              FStar_TypeChecker_Env.phase1 =
                                (uu___356_4113.FStar_TypeChecker_Env.phase1);
                              FStar_TypeChecker_Env.failhard =
                                (uu___356_4113.FStar_TypeChecker_Env.failhard);
                              FStar_TypeChecker_Env.nosynth =
                                (uu___356_4113.FStar_TypeChecker_Env.nosynth);
                              FStar_TypeChecker_Env.uvar_subtyping =
                                (uu___356_4113.FStar_TypeChecker_Env.uvar_subtyping);
                              FStar_TypeChecker_Env.tc_term =
                                (uu___356_4113.FStar_TypeChecker_Env.tc_term);
                              FStar_TypeChecker_Env.type_of =
                                (uu___356_4113.FStar_TypeChecker_Env.type_of);
                              FStar_TypeChecker_Env.universe_of =
                                (uu___356_4113.FStar_TypeChecker_Env.universe_of);
                              FStar_TypeChecker_Env.check_type_of =
                                (uu___356_4113.FStar_TypeChecker_Env.check_type_of);
                              FStar_TypeChecker_Env.use_bv_sorts =
                                (uu___356_4113.FStar_TypeChecker_Env.use_bv_sorts);
                              FStar_TypeChecker_Env.qtbl_name_and_index =
                                (uu___356_4113.FStar_TypeChecker_Env.qtbl_name_and_index);
                              FStar_TypeChecker_Env.normalized_eff_names =
                                (uu___356_4113.FStar_TypeChecker_Env.normalized_eff_names);
                              FStar_TypeChecker_Env.fv_delta_depths =
                                (uu___356_4113.FStar_TypeChecker_Env.fv_delta_depths);
                              FStar_TypeChecker_Env.proof_ns =
                                (uu___356_4113.FStar_TypeChecker_Env.proof_ns);
                              FStar_TypeChecker_Env.synth_hook =
                                (uu___356_4113.FStar_TypeChecker_Env.synth_hook);
                              FStar_TypeChecker_Env.splice =
                                (uu___356_4113.FStar_TypeChecker_Env.splice);
                              FStar_TypeChecker_Env.is_native_tactic =
                                (uu___356_4113.FStar_TypeChecker_Env.is_native_tactic);
                              FStar_TypeChecker_Env.identifier_info =
                                (uu___356_4113.FStar_TypeChecker_Env.identifier_info);
                              FStar_TypeChecker_Env.tc_hooks =
                                (uu___356_4113.FStar_TypeChecker_Env.tc_hooks);
                              FStar_TypeChecker_Env.dsenv =
                                (uu___356_4113.FStar_TypeChecker_Env.dsenv);
                              FStar_TypeChecker_Env.nbe =
                                (uu___356_4113.FStar_TypeChecker_Env.nbe)
                            }) res in
       ...
       | FStar_Syntax_Syntax.Tm_refine uu____4522 ->
           ...
           (match uu____4529 with
            | (x, f) ->
                let uu____4601 = encode_term x.FStar_Syntax_Syntax.sort env in
                ...
                (match uu____5010 with
                 ...
                 | (FStar_Syntax_Syntax.Tm_uinst
                    ({
                       ...
                       FStar_Syntax_Syntax.vars = uu____5123;_},
                     uu____5124),
                    uu____5125) when
                     (Prims.op_Negation
                        env.FStar_SMTEncoding_Env.encoding_quantifier)
                 ...
                 | (FStar_Syntax_Syntax.Tm_uinst
                    ({
                       ...
                       FStar_Syntax_Syntax.vars = uu____5152;_},
                     uu____5153),
                 ...
                 | (FStar_Syntax_Syntax.Tm_fvar fv,
                    (v0, uu____5266)::(v1, uu____5268)::(v2, uu____5270)::[])
                     when
                     FStar_Syntax_Syntax.fv_eq_lid fv
                       FStar_Parser_Const.lexcons_lid
                     ->
                 ...
                 | (FStar_Syntax_Syntax.Tm_constant
                    ...
                    (arg, uu____5408)::(rng, uu____5410)::[]) ->
                     encode_term arg env
                 | (FStar_Syntax_Syntax.Tm_constant
                    (FStar_Const.Const_reify), uu____5461) ->
                     let e0 =
                       let uu____5483 = FStar_List.hd args_e in
                       FStar_TypeChecker_Util.reify_body_with_arg
                         env.FStar_SMTEncoding_Env.tcenv head1 uu____5483 in
                     ((let uu____5493 =
                         FStar_All.pipe_left
                      ...
                      (let e =
                       ...
                       encode_term e env))
                 | (FStar_Syntax_Syntax.Tm_constant
                    (FStar_Const.Const_reflect uu____5516),
                    (arg, uu____5518)::[]) -> encode_term arg env
                 | uu____5553 ->
                          ...
                          let head_type =
                            ...
                            | FStar_Syntax_Syntax.Tm_uinst
                                ({
                                   ...
                                   FStar_Syntax_Syntax.vars = uu____5952;_},
                                 uu____5953)
                                ->
                                let uu____5958 =
                                  let uu____5959 =
                            ...
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____6029, (FStar_Util.Inl t1, uu____6031),
                                 uu____6032)
                                -> FStar_Pervasives_Native.Some t1
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____6079, (FStar_Util.Inr c, uu____6081),
                                 uu____6082)
                                ->
                                FStar_Pervasives_Native.Some
                               ...
                               let head_type2 =
                                 let uu____6150 =
                                   FStar_TypeChecker_Normalize.normalize_refinement
                                     ...
                                     head_type1 in
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine uu____6150 in
                               let uu____6151 =
                ...
                let codomain_eff rc =
                  ...
                  then
                    ...
                    (let uu____6354 =
                     ...
                     if uu____6354
                     then
                       let uu____6357 = FStar_Syntax_Syntax.mk_GTotal res_typ in
                             ...
                             | (body3, decls') ->
                                 let uu____6433 =
                                   ...
                                   | FStar_Pervasives_Native.Some c ->
                                       ...
                                       let uu____6461 = encode_term tfun env in
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((uu____6694,
             { FStar_Syntax_Syntax.lbname = FStar_Util.Inr uu____6695;
               ...
               FStar_Syntax_Syntax.lbpos = uu____6701;_}::uu____6702),
            uu____6703)
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((false,
             { FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
               ...
               FStar_Syntax_Syntax.lbpos = uu____6738;_}::[]),
            e2)
...
and (encode_pat :
  ...
  fun env ->
    fun pat ->
      ...
      (let uu____7207 = FStar_TypeChecker_Util.decorated_pattern_as_term pat in
                                ...
                                fun uu____7664 ->
                                  ...
                                  | (arg, uu____7678) ->
                                      ...
                                      let uu____7684 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee]) in
                                      mk_projections arg uu____7684)) in
                      FStar_All.pipe_right uu____7620 FStar_List.flatten in
  ...
  fun t ->
    fun env ->
      ...
      let one_pat p =
        ...
        | (head1, args) ->
            ...
            (match uu____7994 with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                (uu____8032, uu____8033)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.smtpat_lid
                 -> arg
             | uu____8085 -> failwith "Unexpected pattern term") in
      let lemma_pats p =
        let elts = list_elements1 p in
        let smt_pat_or t1 =
          let uu____8139 =
            let uu____8156 = FStar_Syntax_Util.unmeta t1 in
            FStar_All.pipe_right uu____8156 FStar_Syntax_Util.head_and_args in
                  ...
                  | FStar_Syntax_Syntax.Comp
                      { FStar_Syntax_Syntax.comp_univs = uu____8580;
                        ...
                        FStar_Syntax_Syntax.effect_args =
                          (pre, uu____8584)::(post, uu____8586)::(pats,
                                                                  uu____8588)::[];
      ...
      | (binders, pre, post, patterns) ->
          let env1 =
            let uu___357_8712 = env in
            {
              FStar_SMTEncoding_Env.bvar_bindings =
                (uu___357_8712.FStar_SMTEncoding_Env.bvar_bindings);
              FStar_SMTEncoding_Env.fvar_bindings =
                (uu___357_8712.FStar_SMTEncoding_Env.fvar_bindings);
              FStar_SMTEncoding_Env.depth =
                (uu___357_8712.FStar_SMTEncoding_Env.depth);
              FStar_SMTEncoding_Env.tcenv =
                (uu___357_8712.FStar_SMTEncoding_Env.tcenv);
              FStar_SMTEncoding_Env.warn =
                (uu___357_8712.FStar_SMTEncoding_Env.warn);
              FStar_SMTEncoding_Env.cache =
                (uu___357_8712.FStar_SMTEncoding_Env.cache);
              FStar_SMTEncoding_Env.nolabels =
                (uu___357_8712.FStar_SMTEncoding_Env.nolabels);
              FStar_SMTEncoding_Env.use_zfuel_name = true;
              FStar_SMTEncoding_Env.encode_non_total_function_typ =
                (uu___357_8712.FStar_SMTEncoding_Env.encode_non_total_function_typ);
              FStar_SMTEncoding_Env.current_module_name =
                (uu___357_8712.FStar_SMTEncoding_Env.current_module_name);
              FStar_SMTEncoding_Env.encoding_quantifier =
                (uu___357_8712.FStar_SMTEncoding_Env.encoding_quantifier)
            } in
          let uu____8713 =
           ...
           | (vars, guards, env2, decls, uu____8738) ->
               ...
               (match uu____8751 with
                | (pats, decls') ->
                    ...
                    let env3 =
                      let uu___358_8784 = env2 in
                      {
                        FStar_SMTEncoding_Env.bvar_bindings =
                          (uu___358_8784.FStar_SMTEncoding_Env.bvar_bindings);
                        FStar_SMTEncoding_Env.fvar_bindings =
                          (uu___358_8784.FStar_SMTEncoding_Env.fvar_bindings);
                        FStar_SMTEncoding_Env.depth =
                          (uu___358_8784.FStar_SMTEncoding_Env.depth);
                        FStar_SMTEncoding_Env.tcenv =
                          (uu___358_8784.FStar_SMTEncoding_Env.tcenv);
                        FStar_SMTEncoding_Env.warn =
                          (uu___358_8784.FStar_SMTEncoding_Env.warn);
                        FStar_SMTEncoding_Env.cache =
                          (uu___358_8784.FStar_SMTEncoding_Env.cache);
                        FStar_SMTEncoding_Env.nolabels = true;
                        FStar_SMTEncoding_Env.use_zfuel_name =
                          (uu___358_8784.FStar_SMTEncoding_Env.use_zfuel_name);
                        FStar_SMTEncoding_Env.encode_non_total_function_typ =
                          (uu___358_8784.FStar_SMTEncoding_Env.encode_non_total_function_typ);
                        FStar_SMTEncoding_Env.current_module_name =
                          (uu___358_8784.FStar_SMTEncoding_Env.current_module_name);
                        FStar_SMTEncoding_Env.encoding_quantifier =
                          (uu___358_8784.FStar_SMTEncoding_Env.encoding_quantifier)
                      } in
                    let uu____8785 =
                    ...
                    (match uu____8785 with
                     | (pre1, decls'') ->
                         let uu____8797 =
                           let uu____8802 = FStar_Syntax_Util.unmeta post1 in
                                    ...
                                    let uu____8825 =
                                      let uu____8830 =
                                        FStar_SMTEncoding_Util.mk_and_l (pre1
                                          :: guards) in
                                      (uu____8830, post2) in
                                    FStar_SMTEncoding_Util.mkImp uu____8825 in
                                  (pats, vars, uu____8824) in
                                FStar_SMTEncoding_Term.mkForall
                                  t.FStar_Syntax_Syntax.pos uu____8813 in
                              (uu____8812, decls1)))))
and (encode_smt_patterns :
  ...
  fun pats_l ->
    fun env ->
      let env1 =
        let uu___359_8852 = env in
        {
          FStar_SMTEncoding_Env.bvar_bindings =
            (uu___359_8852.FStar_SMTEncoding_Env.bvar_bindings);
          FStar_SMTEncoding_Env.fvar_bindings =
            (uu___359_8852.FStar_SMTEncoding_Env.fvar_bindings);
          FStar_SMTEncoding_Env.depth =
            (uu___359_8852.FStar_SMTEncoding_Env.depth);
          FStar_SMTEncoding_Env.tcenv =
            (uu___359_8852.FStar_SMTEncoding_Env.tcenv);
          FStar_SMTEncoding_Env.warn =
            (uu___359_8852.FStar_SMTEncoding_Env.warn);
          FStar_SMTEncoding_Env.cache =
            (uu___359_8852.FStar_SMTEncoding_Env.cache);
          FStar_SMTEncoding_Env.nolabels =
            (uu___359_8852.FStar_SMTEncoding_Env.nolabels);
          FStar_SMTEncoding_Env.use_zfuel_name = true;
          FStar_SMTEncoding_Env.encode_non_total_function_typ =
            (uu___359_8852.FStar_SMTEncoding_Env.encode_non_total_function_typ);
          FStar_SMTEncoding_Env.current_module_name =
            (uu___359_8852.FStar_SMTEncoding_Env.current_module_name);
          FStar_SMTEncoding_Env.encoding_quantifier =
            (uu___359_8852.FStar_SMTEncoding_Env.encoding_quantifier)
        } in
      let encode_smt_pattern t =
        ...
        | (head1, args) ->
            ...
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                uu____8930::(x, uu____8932)::(t1, uu____8934)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             | uu____9024 -> encode_term t env1) in
  ...
  fun phi ->
    fun env ->
      ...
      let enc f r l =
        ...
        | (decls, args) ->
            let uu____9425 =
              let uu___360_9426 = f args in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___360_9426.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___360_9426.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              } in
            (uu____9425, decls) in
      let const_op f r uu____9461 = let uu____9474 = f r in (uu____9474, []) in
      let un_op f l =
        let uu____9497 = FStar_List.hd l in FStar_All.pipe_left f uu____9497 in
      let bin_op f uu___351_9517 =
        match uu___351_9517 with
        | t1::t2::[] -> f (t1, t2)
      ...
      let enc_prop_c f r l =
        ...
        | (decls, phis) ->
            let uu____9643 =
              let uu___361_9644 = f phis in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___361_9644.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___361_9644.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              } in
            (uu____9643, decls) in
      let eq_op r args =
        ...
        then
          ...
          (let uu____9756 = enc (bin_op FStar_SMTEncoding_Util.mkEq) in
           uu____9756 r rf) in
      let mk_imp1 r uu___352_9791 =
        match uu___352_9791 with
      ...
      let mk_ite r uu___353_9900 =
        match uu___353_9900 with
      ...
      let unboxInt_l f l =
        let uu____10030 = FStar_List.map FStar_SMTEncoding_Term.unboxInt l in
        f uu____10030 in
      let connectives =
        let uu____10060 =
          let uu____10085 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd) in
          (FStar_Parser_Const.and_lid, uu____10085) in
        let uu____10128 =
          let uu____10155 =
            let uu____10180 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr) in
      ...
      let rec fallback phi1 =
        ...
        | FStar_Syntax_Syntax.Tm_let
            ((false,
              { FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                ...
                FStar_Syntax_Syntax.lbpos = uu____10952;_}::[]),
             e2)
            ->
        ...
        | FStar_Syntax_Syntax.Tm_app (head1, args) ->
            ...
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                uu____11029::(x, uu____11031)::(t, uu____11033)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
             ...
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                (r, uu____11125)::(msg, uu____11127)::(phi2, uu____11129)::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                  ...
                  | (tt, decls) ->
                      let tt1 =
                        let uu____11306 =
                          ...
                          FStar_Range.rng_included uu____11307 uu____11308 in
                        if uu____11306
                        then tt
                        else
                          (let uu___362_11310 = tt in
                           {
                             FStar_SMTEncoding_Term.tm =
                               (uu___362_11310.FStar_SMTEncoding_Term.tm);
                             FStar_SMTEncoding_Term.freevars =
                               (uu___362_11310.FStar_SMTEncoding_Term.freevars);
                             FStar_SMTEncoding_Term.rng =
                               (phi1.FStar_Syntax_Syntax.pos)
                           }) in
                      let uu____11311 = FStar_SMTEncoding_Term.mk_Valid tt1 in
                      (uu____11311, decls)))
        | uu____11312 ->
             ...
             | (tt, decls) ->
                 let tt1 =
                   ...
                   then tt
                     ...
                     (let uu___363_11329 = tt in
                      {
                        FStar_SMTEncoding_Term.tm =
                          (uu___363_11329.FStar_SMTEncoding_Term.tm);
                        FStar_SMTEncoding_Term.freevars =
                          (uu___363_11329.FStar_SMTEncoding_Term.freevars);
                        FStar_SMTEncoding_Term.rng =
                          (phi1.FStar_Syntax_Syntax.pos)
                      }) in
      ...
      let encode_q_body env1 bs ps body =
        let uu____11374 = encode_binders FStar_Pervasives_Native.None bs env1 in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____11649 ->
                     ...
                     | (l, uu____11673) -> FStar_Ident.lid_equals op l)) in
            ...
            (let uu____11834 = encode_q_body env vars pats body in
             ...
             | (vars1, pats1, guard, body1, decls) ->
                 let tm =
                   ...
                   FStar_SMTEncoding_Term.mkForall
                     phi1.FStar_Syntax_Syntax.pos uu____11879 in
                 (tm, decls)))
             ...
             | (vars1, pats1, guard, body1, decls) ->
                 let uu____11965 =
                   ...
                   FStar_SMTEncoding_Term.mkExists
                     phi1.FStar_Syntax_Syntax.pos uu____11966 in
                 (uu____11965, decls))))