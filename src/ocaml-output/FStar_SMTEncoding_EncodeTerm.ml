                       ...
                       | FStar_SMTEncoding_Term.App
                           ...
                           let guard1 =
                             ...
                             | uu___4 ->
                                 ...
                                 FStar_All.pipe_right uu___5 FStar_List.hd
                              in
...
let (trivial_post : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term) =
  fun t  ->
    let uu___ = let uu___1 = FStar_Syntax_Syntax.null_binder t  in [uu___1]
       in
    let uu___1 =
            ...
            let rec is_tot_fun_axioms ctx ctx_guard head1 vars1 guards1 =
              ...
              | (uu___::[],uu___1) ->
                  ...
                  then
                    let uu___2 =
                      let uu___3 =
                        let uu___4 = FStar_SMTEncoding_Term.mk_IsTotFun head1
                           in
                        (ctx_guard, uu___4)  in
              ...
              | (x::vars2,g_x::guards2) ->
                  let is_tot_fun_head =
                    let uu___ =
                      let uu___1 =
                        let uu___2 = FStar_SMTEncoding_Term.mk_IsTotFun head1
                           in
                        (ctx_guard, uu___2)  in
        ...
        let rec check_partial_applications t xs =
          ...
          | (FStar_SMTEncoding_Term.App
             (app,f::{
                       ...
                       FStar_SMTEncoding_Term.rng = uu___1;_}::[]),x::xs1)
              when (is_app app) && (FStar_SMTEncoding_Term.fv_eq x y) ->
              check_partial_applications f xs1
          | (FStar_SMTEncoding_Term.App
             (FStar_SMTEncoding_Term.Var f,args),uu___) ->
              let uu___1 =
                  ...
                  (FStar_List.forall2
                     (fun a  ->
                        fun v  ->
                          ...
                          | uu___2 -> false) args (FStar_List.rev xs))
                 in
              if uu___1
              then
              ...
              FStar_List.fold_left
                (fun out  ->
                   fun x  ->
                     ...
                     FStar_Util.set_union out uu___1) uu___ tl
               in
            let uu___ =
              FStar_All.pipe_right vars
                (FStar_Util.find_opt
...
let rec (curried_arrow_formals_comp :
  ...
  fun k  ->
    ...
    | FStar_Syntax_Syntax.Tm_refine (bv,uu___) ->
        let uu___1 = curried_arrow_formals_comp bv.FStar_Syntax_Syntax.sort
           in
        (match uu___1 with
         | (args,res) ->
             (match args with
          ...
          | (t1,decls) ->
              (match fuel_opt with
               ...
               | FStar_Pervasives_Native.Some f ->
                   let uu___1 = FStar_SMTEncoding_Term.mk_HasTypeFuel f e t1
                      in
                   (uu___1, decls))
      ...
      fun args_e  ->
        ...
        | (arg_tms,decls) ->
            ...
            let binary unbox arg_tms1 =
              ...
              let uu___2 =
                let uu___3 =
                  let uu___4 = FStar_List.tl arg_tms1  in
            ...
            let mk_nl box unbox nm op ts =
              ...
              then
                ...
                match uu___2 with
                | (t1,t2) ->
                    let uu___3 = FStar_SMTEncoding_Util.mkApp (nm, [t1; t2])
                       in
                    FStar_All.pipe_right uu___3 box
              else
                (let uu___3 = FStar_Options.smtencoding_nl_arith_native ()
                    in
                 if uu___3
                 then
                   let uu___4 = let uu___5 = binary unbox ts  in op uu___5
                      in
        ...
        | (tm_sz,uu___1) ->
            ...
            let uu___3 =
              ...
              | (FStar_Syntax_Syntax.Tm_fvar
                 fv,uu___4::(sz_arg,uu___5)::uu___6::[]) when
                  (FStar_Syntax_Syntax.fv_eq_lid fv
                     FStar_Parser_Const.bv_uext_lid)
                    && (isInteger sz_arg.FStar_Syntax_Syntax.n)
                  ->
              ...
              | (FStar_Syntax_Syntax.Tm_fvar
                 fv,uu___4::(sz_arg,uu___5)::uu___6::[]) when
                  ...
                  let uu___7 =
                    ...
                    FStar_Util.format1
                      "Not a constant bitvector extend size: %s" uu___8
                     in
                  failwith uu___7
              | uu___4 ->
                 ...
                 (match uu___4 with
                  | (arg_tms1,decls) ->
                      ...
                      let mk_bv op mk_args resBox ts =
                        let uu___5 = let uu___6 = mk_args ts  in op uu___6
                           in
      ...
      | (tm,decls) ->
          ...
          (match tm.FStar_SMTEncoding_Term.tm with
           | FStar_SMTEncoding_Term.App
               (uu___1,{
                         FStar_SMTEncoding_Term.tm =
                           FStar_SMTEncoding_Term.FreeV uu___2;
               ...
               (match uu___2 with
                | (phi,decls') ->
                    let interp =
                      ...
                      | [] ->
                          let uu___3 =
                            let uu___4 = FStar_SMTEncoding_Term.mk_Valid tm
                               in
                            (uu___4, phi)  in
                      ...
                      | uu___3 ->
                          ...
                          FStar_SMTEncoding_Term.mkForall
                            t.FStar_Syntax_Syntax.pos uu___4
                       in
                    let ax =
                      let uu___3 =
                        let uu___4 =
                          let uu___5 = FStar_Util.digest_of_string tkey_hash
                             in
      ...
      (match t1.FStar_Syntax_Syntax.n with
       ...
       | FStar_Syntax_Syntax.Tm_bvar x ->
           let uu___1 =
             ...
             FStar_Util.format1 "Impossible: locally nameless; got %s" uu___2
              in
           failwith uu___1
           ...
           let tv =
             let uu___2 =
               ...
               FStar_Syntax_Embeddings.embed
                 FStar_Reflection_Embeddings.e_term_view uu___3
                in
                             ...
                             | (res_pred,decls') ->
                                 let uu___7 =
                                   ...
                                   | FStar_Pervasives_Native.Some pre ->
                                       let uu___8 = encode_formula pre env'
                                          in
                                       (match uu___8 with
                                        | (guard,decls0) ->
                                            let uu___9 =
                                  ...
                                  | (guards,guard_decls) ->
                                      ...
                                      let t_interp =
                                        let uu___8 =
                                          ...
                                          ([[app]], vars, uu___9)  in
                                        FStar_SMTEncoding_Term.mkForall
                                          t1.FStar_Syntax_Syntax.pos uu___8
                                         in
                                      let t_interp1 =
                                        let tot_fun_axioms =
                                          isTotFun_axioms
                                        ...
                                        let uu___8 =
                                          let uu___9 =
                                            FStar_List.map
                                             ...
                                             in
                                          (tsym, uu___9)  in
                                        FStar_SMTEncoding_Util.mkApp uu___8
                                         in
                                      let t_has_kind =
                                        ...
                                        let uu___9 =
                                          let uu___10 =
                                            ...
                                            FStar_List.append guard_decls
                                              uu___11
                                             in
                                          FStar_List.append decls' uu___10
                                           in
                               ...
                               | (effect_args,uu___10) ->
                                   let tkey =
                                     let uu___11 =
                                       ...
                                       ([], vars, uu___12)  in
                                     FStar_SMTEncoding_Term.mkForall
                                       t1.FStar_Syntax_Syntax.pos uu___11
                                      in
                                   let tkey_hash1 =
                                     let uu___11 =
                                       let uu___12 =
                                     ...
                                     Prims.op_Hat "Non_total_Tm_arrow"
                                       uu___11
                                      in
                                   FStar_Util.digest_of_string tkey_hash1))
                      in
       ...
       | FStar_Syntax_Syntax.Tm_refine uu___1 ->
           ...
           (match uu___2 with
            | (x,f) ->
                ...
                (match uu___3 with
                 | (base_t,decls) ->
                     let uu___4 = FStar_SMTEncoding_Env.gen_term_var env x
                        in
                     (match uu___4 with
                      | (x1,xtm,env') ->
                                ...
                                | (fsym,fterm) ->
                                    ...
                                    let cvars =
                                      ...
                                      FStar_Util.remove_dups
                                        FStar_SMTEncoding_Term.fv_eq uu___7
                                       in
                                    let cvars1 =
                     ...
                     (match uu___4 with
                      ...
                      | (FStar_Syntax_Syntax.Tm_uinst
                         ({
                            ...
                            FStar_Syntax_Syntax.vars = uu___6;_},uu___7),uu___8)
                          when
                          (Prims.op_Negation
                             env.FStar_SMTEncoding_Env.encoding_quantifier)
                            &&
                      ...
                      | (FStar_Syntax_Syntax.Tm_uinst
                         ({
                            FStar_Syntax_Syntax.n =
                              FStar_Syntax_Syntax.Tm_fvar fv;
                            FStar_Syntax_Syntax.pos = uu___5;
                            FStar_Syntax_Syntax.vars = uu___6;_},uu___7),
                                         ...
                                         (uu___14,
                                           (FStar_List.append decls0
                                              (FStar_List.append decls1
                                                 decls2))))))
                      | (FStar_Syntax_Syntax.Tm_fvar
                         fv,(v0,uu___5)::(v1,uu___6)::(v2,uu___7)::[]) when
                          FStar_Syntax_Syntax.fv_eq_lid fv
                            FStar_Parser_Const.lexcons_lid
                          ->
                         ...
                         (FStar_Const.Const_reify ),uu___5) ->
                          let e0 =
                            ...
                            FStar_TypeChecker_Util.reify_body_with_arg
                              env.FStar_SMTEncoding_Env.tcenv [] head1 uu___6
                             in
                          ((let uu___7 =
                              FStar_All.pipe_left
                                (FStar_TypeChecker_Env.debug
                           ...
                           (let e =
                            ...
                            encode_term e env))
                      | (FStar_Syntax_Syntax.Tm_constant
                         (FStar_Const.Const_reflect uu___5),(arg,uu___6)::[])
                          -> encode_term arg env
                      | uu___5 ->
                           ...
                           | (args,decls) ->
                               ...
                               let head_type =
                                 ...
                                 | FStar_Syntax_Syntax.Tm_ascribed
                                     (uu___7,(FStar_Util.Inl t2,uu___8),uu___9)
                                     -> FStar_Pervasives_Native.Some t2
                                 | FStar_Syntax_Syntax.Tm_ascribed
                                     (uu___7,(FStar_Util.Inr c,uu___8),uu___9)
                                     ->
                                     FStar_Pervasives_Native.Some
                                      ...
                                      let head_type2 =
                                        let uu___8 =
                                          normalize_refinement
                                           ...
                                           in
                                        FStar_All.pipe_left
                                          FStar_Syntax_Util.unrefine uu___8
                                         in
                                      let uu___8 =
            ...
            | (bs1,body1,opening) ->
                  ...
                  let uu___3 =
                    let uu___4 =
                      FStar_SMTEncoding_Term.mk_fv
                        (f, FStar_SMTEncoding_Term.Term_sort)
                       in
                    FStar_All.pipe_left FStar_SMTEncoding_Util.mkFreeV uu___4
                     in
                  let uu___4 =
                ...
                (match lopt with
                 | FStar_Pervasives_Native.None  ->
                     ((let uu___3 =
                         let uu___4 =
                           let uu___5 = FStar_Syntax_Print.term_to_string t0
                              in
                           FStar_Util.format1
                                  ...
                                  | (arrow_t_opt,decls'') ->
                                      let key_body =
                                        let uu___8 =
                                          ...
                                          ([], vars, uu___9)  in
                                        FStar_SMTEncoding_Term.mkForall
                                          t0.FStar_Syntax_Syntax.pos uu___8
                                         in
                                      let cvars =
                                        FStar_SMTEncoding_Term.free_variables
                                          key_body
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((uu___1,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inr uu___2;
                      ...
                      FStar_Syntax_Syntax.lbpos = uu___8;_}::uu___9),uu___10)
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((false
             ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                ...
                FStar_Syntax_Syntax.lbpos = uu___4;_}::[]),e2)
                 ...
                 | (scr,decls) ->
                     let uu___2 =
                       let encode_branch b uu___3 =
                         match uu___3 with
                         | (else_case,decls1) ->
                             let uu___4 = FStar_Syntax_Subst.open_branch b
                                in
                             (match uu___4 with
                              | (p,w,br) ->
                                   ...
                                   | (env0,pattern1) ->
                                       ...
                                       let uu___6 =
                                         ...
                                         | FStar_Pervasives_Native.Some w1 ->
                                             let uu___7 = encode_term w1 env2
                                                in
                                             (match uu___7 with
                                              | (w2,decls2) ->
                                                  let uu___8 =
                                  ...
                                  | (arg,uu___5) ->
                                      ...
                                      let uu___6 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee])
                                         in
                                      mk_projections arg uu___6))
                         in
                      FStar_All.pipe_right uu___3 FStar_List.flatten
                   in
      ...
      let encode_smt_pattern t =
        ...
        | (head,args) ->
            ...
            (match ((head1.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,uu___1::(x,uu___2)::(t1,uu___3)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    fun env  ->
      ...
      let enc f r l =
        let uu___ =
          FStar_Util.fold_map
            (fun decls  ->
               fun x  ->
                 let uu___1 = encode_term (FStar_Pervasives_Native.fst x) env
                    in
                 match uu___1 with
      ...
      let connectives =
        ...
        let uu___1 =
          ...
          let uu___3 =
            let uu___4 =
              let uu___5 =
                let uu___6 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkIff)
                   in
      ...
      let rec fallback phi1 =
        ...
        | FStar_Syntax_Syntax.Tm_let
            ((false
              ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                 ...
                 FStar_Syntax_Syntax.lbpos = uu___3;_}::[]),e2)
            ->
        ...
        | FStar_Syntax_Syntax.Tm_app (head,args) ->
            ...
            (match ((head1.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,uu___::(x,uu___1)::(t,uu___2)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
             ...
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(r,uu___)::(msg,uu___1)::(phi2,uu___2)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                  ...
                  | (body1,decls'') ->
                      let guards1 =
                        ...
                        | ({
                            ...
                            uu___6 = gf -> []
                        | uu___4 -> guards  in
                      let uu___4 = FStar_SMTEncoding_Util.mk_and_l guards1
                         in
           ...
           let uu___2 =
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu___3  ->
                     match uu___3 with
                     | (l,uu___4) -> FStar_Ident.lid_equals op l))
              in
           (match uu___2 with
            | FStar_Pervasives_Native.None  -> fallback phi1
           ...
           (FStar_All.pipe_right pats
            ...
            (let uu___3 = encode_q_body env vars pats body  in
             ...
             | (vars1,pats1,guard,body1,decls) ->
                 let tm =
                   let uu___4 =
                     let uu___5 = FStar_SMTEncoding_Util.mkImp (guard, body1)
                        in
                     (pats1, vars1, uu___5)  in
                   FStar_SMTEncoding_Term.mkForall
                     phi1.FStar_Syntax_Syntax.pos uu___4
                    in
                 (tm, decls)))
           ...
           (FStar_All.pipe_right pats
            ...
            (let uu___3 = encode_q_body env vars pats body  in
             ...
             | (vars1,pats1,guard,body1,decls) ->
                 let uu___4 =
                   let uu___5 =
                     let uu___6 = FStar_SMTEncoding_Util.mkAnd (guard, body1)
                        in
                     (pats1, vars1, uu___6)  in
                   FStar_SMTEncoding_Term.mkExists
                     phi1.FStar_Syntax_Syntax.pos uu___5
                    in
                 (uu___4, decls))))
