  ...
  fun env ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          ...
          FStar_All.op_Bar_Greater uu___ FStar_Option.isNone
      | FStar_Syntax_Syntax.Tm_app
          ...
          let uu___3 =
            FStar_TypeChecker_Env.lookup_definition
              ...
              env.FStar_SMTEncoding_Env.tcenv
              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
          FStar_All.op_Bar_Greater uu___3 FStar_Option.isNone
      | uu___ -> false
let (head_redex :
  FStar_SMTEncoding_Env.env_t -> FStar_Syntax_Syntax.term -> Prims.bool) =
  fun env ->
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          let uu___1 =
            FStar_TypeChecker_Env.lookup_definition
              ...
              env.FStar_SMTEncoding_Env.tcenv
              (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
          FStar_All.op_Bar_Greater uu___1 FStar_Option.isSome
      | uu___1 -> false
let (norm_with_steps :
          ...
          fun is_pure ->
            ...
            let rec is_tot_fun_axioms ctx ctx_guard head1 vars1 guards1 =
              ...
              | (x::vars2, g_x::guards2) ->
                  ...
                  let ctx1 = FStar_List.op_At ctx [x] in
                  let ctx_guard1 =
    ...
    fun env ->
      ...
      | FStar_Const.Const_string (s, uu___) ->
          let uu___1 =
            ...
            FStar_All.op_Less_Bar FStar_SMTEncoding_Term.boxString uu___2 in
          (uu___1, [])
                ...
                (fun uu___2 ->
                   fun b ->
                     ...
                     | (vars, guards, env1, decls, names) ->
                         ...
                         (match uu___3 with
                          | (v, g, env2, decls', n) ->
                              let uu___4 = FStar_List.op_At decls decls' in
                              ((v :: vars), (g :: guards), env2, uu___4, (n
                                :: names)))) ([], [], env, [], [])) in
         match uu___1 with
         | (vars, guards, env1, decls, names) ->
        ...
        | (arg_tms, decls) ->
            ...
            let mk_default uu___1 =
              ...
              | (fname, fuel_args, arity) ->
                  let args = FStar_List.op_At fuel_args arg_tms in
            ...
            let mk_l box op mk_args ts =
              ...
              then
                ...
                FStar_All.op_Bar_Greater uu___2 box
              else mk_default () in
                 ...
                 (match uu___4 with
                  | (arg_tms1, decls) ->
                      ...
                      let mk_bv op mk_args resBox ts =
                        ...
                        FStar_All.op_Bar_Greater uu___5 resBox in
                      let bv_and =
                      ...
                      (match uu___5 with
                       | (uu___6, op) ->
                           ...
                           let uu___8 = FStar_List.op_At sz_decls decls in
                           (uu___7, uu___8))))
               ...
               (match uu___2 with
                | (phi, decls') ->
                    ...
                    let uu___3 =
                      let uu___4 =
                        let uu___5 =
                          let uu___6 = FStar_List.op_At decls decls' in
                          FStar_SMTEncoding_Term.mk_decls "" tkey_hash 
                            [ax] uu___6 in
                        FStar_List.op_At decls' uu___5 in
                      FStar_List.op_At decls uu___4 in
                    (tm, uu___3)))
and (encode_term :
  FStar_Syntax_Syntax.typ ->
    FStar_SMTEncoding_Env.env_t ->
                                          ...
                                          let uu___10 =
                                            let uu___11 =
                                              ...
                                              FStar_SMTEncoding_Term.mk_decls
                                                ...
                                                uu___12 in
                                            FStar_List.op_At guard_decls
                                              uu___11 in
                                          FStar_List.op_At decls' uu___10 in
                                        FStar_List.op_At decls uu___9 in
                                      (t2, uu___8)))))
                else
                  (let tkey_hash =
                     let uu___4 =
                                       ...
                                       let uu___12 =
                                         let uu___13 =
                                           let uu___14 =
                                             FStar_List.op_At [ct]
                                               effect_args in
                                           FStar_List.op_At guards_l uu___14 in
                                         FStar_SMTEncoding_Util.mk_and_l
                                           uu___13 in
                                       ([], vars, uu___12) in
                                     FStar_SMTEncoding_Term.mkForall
                           ...
                           | (refinement, decls') ->
                               ...
                               (match uu___6 with
                                | (fsym, fterm) ->
                                    ...
                                    let cvars1 =
                                      FStar_All.op_Bar_Greater cvars
                                        (FStar_List.filter
                                           (fun y ->
                                              (let uu___7 =
                                                 FStar_SMTEncoding_Term.fv_name
                                     ...
                                     (let tsym =
                                      ...
                                      let uu___8 =
                                        let uu___9 =
                                          let uu___10 =
                                            let uu___11 =
                                              FStar_List.op_At decls decls' in
                                            FStar_SMTEncoding_Term.mk_decls
                                              tsym tkey_hash t_decls uu___11 in
                                          FStar_List.op_At decls' uu___10 in
                                        FStar_List.op_At decls uu___9 in
                                      (t2, uu___8))))))))
                           ...
                           | (args, decls) ->
                               ...
                               let encode_full_app fv =
                                 ...
                                 | (fname, fuel_args, arity) ->
                                     let tm =
                                       let uu___8 =
                                         FStar_List.op_At fuel_args args in
                                       maybe_curry_app
           ...
           (match uu___1 with
            | (bs1, body1, opening) ->
                ...
                let is_impure rc =
                  ...
                  FStar_All.op_Bar_Greater uu___2 Prims.op_Negation in
                let codomain_eff rc =
                  let res_typ =
                                            ...
                                            (let cvar_sorts =
                                             ...
                                             let uu___10 =
                                               let uu___11 =
                                                 ...
                                                 FStar_List.op_At decls'
                                                   uu___12 in
                                               FStar_List.op_At decls uu___11 in
                                             (f, uu___10)))))))))
              ...
              | (ee1, decls1) ->
                  ...
                  (match uu___1 with
                   | (xs, e21) ->
                       ...
                       (match uu___2 with
                        | (ee2, decls2) ->
                            let uu___3 = FStar_List.op_At decls1 decls2 in
                            (ee2, uu___3)))
and (encode_match :
  FStar_Syntax_Syntax.term ->
                              ...
                              | (p, w, br) ->
                                  ...
                                  (match uu___5 with
                                   | (env0, pattern1) ->
                                       ...
                                       let env2 =
                                         FStar_All.op_Bar_Greater projections
                                           (FStar_List.fold_left
                                              (fun env3 ->
                                                 fun uu___6 ->
                                                   match uu___6 with
                                        ...
                                        | (guard1, decls2) ->
                                            ...
                                            (match uu___7 with
                                             | (br1, decls3) ->
                                                 ...
                                                 let uu___9 =
                                                   let uu___10 =
                                                     FStar_List.op_At decls2
                                                       decls3 in
                                                   FStar_List.op_At decls1
                                                     uu___10 in
                                                 (uu___8, uu___9))))) in
            ...
            | (env1, vars1) ->
                ...
                let rec mk_projections pat1 scrutinee =
                  ...
                  | FStar_Syntax_Syntax.Pat_cons (f, args) ->
                      ...
                      FStar_All.op_Bar_Greater uu___3 FStar_List.flatten in
             ...
             (fun uu___1 ->
                fun uu___2 ->
                  ...
                  | ((tms, decls), (t, uu___3)) ->
                      ...
                      (match uu___4 with
                       | (t1, decls') ->
                           let uu___5 = FStar_List.op_At decls decls' in
                           ((t1 :: tms), uu___5))) ([], [])) in
                  ...
                  | (x1, decls) ->
                      ...
                      (match uu___5 with
                       | (t2, decls') ->
                           ...
                           let uu___7 = FStar_List.op_At decls decls' in
                           (uu___6, uu___7)))
...
and (encode_formula :
  ...
  fun phi ->
    fun env ->
      ...
      let un_op f l =
        let uu___ = FStar_List.hd l in FStar_All.op_Less_Bar f uu___ in
      let bin_op f uu___ =
        match uu___ with
        | t1::t2::[] -> f (t1, t2)
        | uu___1 -> failwith "Impossible" in
                  ...
                  | uu___4 ->
                      ...
                      (match uu___5 with
                       | (l2, decls2) ->
                           ...
                           let uu___7 = FStar_List.op_At decls1 decls2 in
                           (uu___6, uu___7))))
        | uu___1 -> failwith "impossible" in
      let mk_ite r uu___ =
        match uu___ with
                  ...
                  | (t, decls2) ->
                      ...
                      (match uu___6 with
                       | (e, decls3) ->
                           ...
                           let uu___7 =
                             let uu___8 = FStar_List.op_At decls2 decls3 in
                             FStar_List.op_At decls1 uu___8 in
                           (res, uu___7))))
        | uu___1 -> failwith "impossible" in
      let unboxInt_l f l =
             ...
             | (pats, decls') ->
                 ...
                 (match uu___3 with
                  | (body1, decls'') ->
                      ...
                      (vars, pats, uu___4, body1, uu___5))) in
      debug phi;
      (let phi1 = FStar_Syntax_Util.unascribe phi in
       ...
       | FStar_Pervasives_Native.Some (FStar_Syntax_Util.BaseConn (op, arms))
           ->
           let uu___2 =
             FStar_All.op_Bar_Greater connectives
               (FStar_List.tryFind
                  (fun uu___3 ->
                     match uu___3 with
