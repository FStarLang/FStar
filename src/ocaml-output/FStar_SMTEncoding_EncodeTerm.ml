    ...
    fun env  ->
      ...
      (match t0.FStar_Syntax_Syntax.n with
                            ...
                            | (head_tm,decls') ->
                                ...
                                let decls'1 =
                                  let uu____6490 =
                                    ...
                                    (args, uu____6501, decls')  in
                                  match uu____6490 with
                                  | (uu____6511::uu____6512,FStar_Syntax_Syntax.Tm_fvar
                                     uu____6513,{
                          ...
                          let head_type =
                            ...
                            | FStar_Syntax_Syntax.Tm_uinst
                                ({
                                   FStar_Syntax_Syntax.n =
                                     FStar_Syntax_Syntax.Tm_name x;
                                   FStar_Syntax_Syntax.pos = uu____6887;
                                   FStar_Syntax_Syntax.vars = uu____6888;_},uu____6889)
                                ->
                                FStar_Pervasives_Native.Some
                            ...
                            | FStar_Syntax_Syntax.Tm_uinst
                                ({
                                   ...
                                   FStar_Syntax_Syntax.vars = uu____6897;_},uu____6898)
                                ->
                                let uu____6903 =
                                  let uu____6904 =
                                    let uu____6909 =
                                ...
                                let uu____6939 =
                                  let uu____6940 =
                                    ...
                                    FStar_All.pipe_right uu____6945
                                      FStar_Pervasives_Native.fst
                                     in
                                  FStar_All.pipe_right uu____6940
                                    FStar_Pervasives_Native.snd
                                   in
                                FStar_Pervasives_Native.Some uu____6939
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____6974,(FStar_Util.Inl t1,uu____6976),uu____6977)
                                -> FStar_Pervasives_Native.Some t1
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____7024,(FStar_Util.Inr c,uu____7026),uu____7027)
                                ->
                                FStar_Pervasives_Native.Some
                               ...
                               let head_type2 =
                                 let uu____7095 =
                                   FStar_TypeChecker_Normalize.normalize_refinement
                                    ...
                                    in
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine uu____7095
                                  in
                               let uu____7096 =
       ...
       | FStar_Syntax_Syntax.Tm_abs (bs,body,lopt) ->
           let uu____7211 = FStar_Syntax_Subst.open_term' bs body  in
           (match uu____7211 with
            | (bs1,body1,opening) ->
                let fallback uu____7234 =
                  let f =
                    FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.fresh
                ...
                let is_impure rc =
                  let uu____7257 =
                    FStar_TypeChecker_Util.is_pure_or_ghost_effect
                     ...
                     in
                  FStar_All.pipe_right uu____7257 Prims.op_Negation  in
                let codomain_eff rc =
                  let res_typ =
                    ...
                    | FStar_Pervasives_Native.None  ->
                        let uu____7272 =
                          ...
                          FStar_TypeChecker_Util.new_implicit_var
                            "SMTEncoding codomain" uu____7285
                            env.FStar_SMTEncoding_Env.tcenv
                            FStar_Syntax_Util.ktype0
                           in
                        (match uu____7272 with
                         | (t1,uu____7288,uu____7289) -> t1)
                  ...
                  if uu____7307
                  then
                    let uu____7312 = FStar_Syntax_Syntax.mk_Total res_typ  in
                    FStar_Pervasives_Native.Some uu____7312
                  else
                    (let uu____7315 =
                       FStar_Ident.lid_equals
                         rc.FStar_Syntax_Syntax.residual_effect
                     ...
                     if uu____7315
                     then
                       let uu____7320 = FStar_Syntax_Syntax.mk_GTotal res_typ
                          in
                 ...
                 | FStar_Pervasives_Native.Some rc ->
                     ...
                     then fallback ()
                       ...
                       (let uu____7353 =
                        ...
                        | (vars,guards,envbody,decls,uu____7378) ->
                            let body2 =
                              let uu____7392 =
                                FStar_TypeChecker_Env.is_reifiable_rc
                                  env.FStar_SMTEncoding_Env.tcenv rc
                            ...
                            let uu____7397 = encode_term body2 envbody  in
                            (match uu____7397 with
                             | (body3,decls') ->
                                 let uu____7408 =
                                   let uu____7417 = codomain_eff rc  in
                                   ...
                                   | FStar_Pervasives_Native.Some c ->
                                       ...
                                       let uu____7436 = encode_term tfun env
                                          in
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((uu____7692,{
                          FStar_Syntax_Syntax.lbname = FStar_Util.Inr
                            uu____7693;
                          FStar_Syntax_Syntax.lbunivs = uu____7694;
                          FStar_Syntax_Syntax.lbtyp = uu____7695;
                          FStar_Syntax_Syntax.lbeff = uu____7696;
                          FStar_Syntax_Syntax.lbdef = uu____7697;
                          FStar_Syntax_Syntax.lbattrs = uu____7698;
                          FStar_Syntax_Syntax.lbpos = uu____7699;_}::uu____7700),uu____7701)
           -> failwith "Impossible: already handled by encoding of Sig_let"
       | FStar_Syntax_Syntax.Tm_let
           ((false
             ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                FStar_Syntax_Syntax.lbunivs = uu____7735;
                FStar_Syntax_Syntax.lbtyp = t1;
                FStar_Syntax_Syntax.lbeff = uu____7737;
                FStar_Syntax_Syntax.lbdef = e1;
                FStar_Syntax_Syntax.lbattrs = uu____7739;
                FStar_Syntax_Syntax.lbpos = uu____7740;_}::[]),e2)
           -> encode_let x t1 e1 e2 env encode_term
       | FStar_Syntax_Syntax.Tm_let uu____7767 ->
            ...
            fun encode_body  ->
              ...
              | (ee1,decls1) ->
                  ...
                  (match uu____7869 with
                   | (xs,e21) ->
                       let uu____7894 = FStar_List.hd xs  in
                       (match uu____7894 with
                        | (x1,uu____7912) ->
                            let env' =
                              FStar_SMTEncoding_Env.push_term_var env x1 ee1
                               in
                            let uu____7918 = encode_body e21 env'  in
              ...
              let uu____7956 =
                let uu____7957 =
                  FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown
                   ...
                   in
                FStar_Syntax_Syntax.null_bv uu____7957  in
              FStar_SMTEncoding_Env.gen_term_var env uu____7956  in
            match uu____7948 with
            | (scrsym,scr',env1) ->
                let uu____7967 = encode_term e env1  in
                (match uu____7967 with
                 | (scr,decls) ->
                     let uu____7978 =
                       let encode_branch b uu____8007 =
                         ...
                         | (else_case,decls1) ->
                             ...
                             (match uu____8026 with
                              | (p,w,br) ->
                                  let uu____8052 = encode_pat env1 p  in
                            ...
                            let uu____8193 =
                              let uu____8204 =
                                let uu____8211 =
                                  ...
                                  (uu____8216, scr)  in
                                [uu____8211]  in
                              (uu____8204, match_tm)  in
                            FStar_SMTEncoding_Term.mkLet' uu____8193
  ...
  fun env  ->
    fun pat  ->
      (let uu____8239 =
       ...
       if uu____8239
       then
         let uu____8242 = FStar_Syntax_Print.pat_to_string pat  in
         FStar_Util.print1 "Encoding pattern %s\n" uu____8242
       else ());
      (let uu____8247 = FStar_TypeChecker_Util.decorated_pattern_as_term pat
          in
           ...
           (match uu____8264 with
            | (env1,vars1) ->
                let rec mk_guard pat1 scrutinee =
                  ...
                  | FStar_Syntax_Syntax.Pat_var uu____8432 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_wild uu____8433 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_dot_term uu____8434 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_constant c ->
                      let uu____8442 = encode_const c env1  in
                ...
                let rec mk_projections pat1 scrutinee =
                  match pat1.FStar_Syntax_Syntax.v with
                  | FStar_Syntax_Syntax.Pat_dot_term (x,uu____8579) ->
                      [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_var x -> [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_wild x -> [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_constant uu____8610 -> []
                  | FStar_Syntax_Syntax.Pat_cons (f,args) ->
                      let uu____8635 =
                        FStar_All.pipe_right args
                          (FStar_List.mapi
                                  ...
                                  | (arg,uu____8697) ->
                                      ...
                                      let uu____8706 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee])
                                         in
                                      mk_projections arg uu____8706))
                         in
                      FStar_All.pipe_right uu____8635 FStar_List.flatten
                   in
                let pat_term1 uu____8737 = encode_term pat_term env1  in
                let pattern =
                  {
                    pat_vars = vars1;
                    pat_term = pat_term1;
      ...
      let uu____8747 =
        FStar_All.pipe_right l
          (FStar_List.fold_left
             (fun uu____8795  ->
                fun uu____8796  ->
                  match (uu____8795, uu____8796) with
                  | ((tms,decls),(t,uu____8836)) ->
                      let uu____8863 = encode_term t env  in
                      (match uu____8863 with
                       | (t1,decls') ->
                           ((t1 :: tms), (FStar_List.append decls decls'))))
             ([], []))
         in
      match uu____8747 with | (l1,decls) -> ((FStar_List.rev l1), decls)
  ...
  fun t  ->
    fun env  ->
      let universe_of_binders binders =
        FStar_List.map (fun uu____8941  -> FStar_Syntax_Syntax.U_zero)
          binders
         in
      let quant = FStar_Syntax_Util.smt_lemma_as_forall t universe_of_binders
         in
      let env1 =
        let uu___1262_8950 = env  in
        {
          FStar_SMTEncoding_Env.bvar_bindings =
            (uu___1262_8950.FStar_SMTEncoding_Env.bvar_bindings);
          FStar_SMTEncoding_Env.fvar_bindings =
            (uu___1262_8950.FStar_SMTEncoding_Env.fvar_bindings);
          FStar_SMTEncoding_Env.depth =
            (uu___1262_8950.FStar_SMTEncoding_Env.depth);
          FStar_SMTEncoding_Env.tcenv =
            (uu___1262_8950.FStar_SMTEncoding_Env.tcenv);
          FStar_SMTEncoding_Env.warn =
            (uu___1262_8950.FStar_SMTEncoding_Env.warn);
          FStar_SMTEncoding_Env.nolabels =
            (uu___1262_8950.FStar_SMTEncoding_Env.nolabels);
          FStar_SMTEncoding_Env.use_zfuel_name = true;
          FStar_SMTEncoding_Env.encode_non_total_function_typ =
            (uu___1262_8950.FStar_SMTEncoding_Env.encode_non_total_function_typ);
          FStar_SMTEncoding_Env.current_module_name =
            (uu___1262_8950.FStar_SMTEncoding_Env.current_module_name);
          FStar_SMTEncoding_Env.encoding_quantifier =
            (uu___1262_8950.FStar_SMTEncoding_Env.encoding_quantifier);
          FStar_SMTEncoding_Env.global_cache =
            (uu___1262_8950.FStar_SMTEncoding_Env.global_cache)
        }  in
...
and (encode_smt_patterns :
  ...
  fun pats_l  ->
    fun env  ->
      let env1 =
        let uu___1267_8967 = env  in
        {
          FStar_SMTEncoding_Env.bvar_bindings =
            (uu___1267_8967.FStar_SMTEncoding_Env.bvar_bindings);
          FStar_SMTEncoding_Env.fvar_bindings =
            (uu___1267_8967.FStar_SMTEncoding_Env.fvar_bindings);
          FStar_SMTEncoding_Env.depth =
            (uu___1267_8967.FStar_SMTEncoding_Env.depth);
          FStar_SMTEncoding_Env.tcenv =
            (uu___1267_8967.FStar_SMTEncoding_Env.tcenv);
          FStar_SMTEncoding_Env.warn =
            (uu___1267_8967.FStar_SMTEncoding_Env.warn);
          FStar_SMTEncoding_Env.nolabels =
            (uu___1267_8967.FStar_SMTEncoding_Env.nolabels);
          FStar_SMTEncoding_Env.use_zfuel_name = true;
          FStar_SMTEncoding_Env.encode_non_total_function_typ =
            (uu___1267_8967.FStar_SMTEncoding_Env.encode_non_total_function_typ);
          FStar_SMTEncoding_Env.current_module_name =
            (uu___1267_8967.FStar_SMTEncoding_Env.current_module_name);
          FStar_SMTEncoding_Env.encoding_quantifier =
            (uu___1267_8967.FStar_SMTEncoding_Env.encoding_quantifier);
          FStar_SMTEncoding_Env.global_cache =
            (uu___1267_8967.FStar_SMTEncoding_Env.global_cache)
        }  in
      let encode_smt_pattern t =
        let uu____8983 = FStar_Syntax_Util.head_and_args t  in
        match uu____8983 with
        | (head1,args) ->
            let head2 = FStar_Syntax_Util.un_uinst head1  in
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,uu____9046::(x,uu____9048)::(t1,uu____9050)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
                 let uu____9117 = encode_term x env1  in
                 (match uu____9117 with
                  | (x1,decls) ->
                      let uu____9128 = encode_term t1 env1  in
                      (match uu____9128 with
                       | (t2,decls') ->
                           let uu____9139 =
                             FStar_SMTEncoding_Term.mk_HasType x1 t2  in
                           (uu____9139, (FStar_List.append decls decls'))))
             | uu____9140 -> encode_term t env1)
         in
                   ...
                   FStar_List.fold_right
                     (fun uu____9263  ->
                        fun uu____9264  ->
                          ...
                          | ((p,uu____9306),(pats1,decls1)) ->
                              let uu____9341 = encode_smt_pattern p  in
  ...
  fun phi  ->
    fun env  ->
      let debug1 phi1 =
        ...
        if uu____9443
        then
          let uu____9448 = FStar_Syntax_Print.tag_of_term phi1  in
          let uu____9450 = FStar_Syntax_Print.term_to_string phi1  in
          FStar_Util.print2 "Formula (%s)  %s\n" uu____9448 uu____9450
        else ()  in
      let enc f r l =
        let uu____9492 =
          FStar_Util.fold_map
        ...
        | (decls,args) ->
            let uu____9555 =
              let uu___1331_9556 = f args  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___1331_9556.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___1331_9556.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              }  in
            (uu____9555, decls)
         in
      let const_op f r uu____9591 = let uu____9604 = f r  in (uu____9604, [])
         in
      let un_op f l =
        let uu____9627 = FStar_List.hd l  in FStar_All.pipe_left f uu____9627
         in
      let bin_op f uu___2_9647 =
        match uu___2_9647 with
        | t1::t2::[] -> f (t1, t2)
        | uu____9658 -> failwith "Impossible"  in
      let enc_prop_c f r l =
          ...
          FStar_Util.fold_map
            (fun decls  ->
               fun uu____9724  ->
                 ...
                 | (t,uu____9740) ->
                     let uu____9745 = encode_formula t env  in
        ...
        | (decls,phis) ->
            let uu____9774 =
              let uu___1361_9775 = f phis  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___1361_9775.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___1361_9775.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              }  in
            (uu____9774, decls)
         in
      let eq_op r args =
          ...
          FStar_List.filter
            (fun uu____9838  ->
               ...
               | (a,q) ->
                   (match q with
                    | FStar_Pervasives_Native.Some
                        (FStar_Syntax_Syntax.Implicit uu____9859) -> false
                    | uu____9862 -> true)) args
           in
        ...
        then
          ...
          (let uu____9898 = enc (bin_op FStar_SMTEncoding_Util.mkEq)  in
           uu____9898 r rf)
         in
      let eq3_op r args =
          ...
          let uu____9966 =
            enc
              (fun terms  ->
                 ...
                 | t0::t1::v0::v1::[] ->
                     let uu____9998 =
                       let uu____10003 = FStar_SMTEncoding_Util.mkEq (t0, t1)
                          in
                       let uu____10004 = FStar_SMTEncoding_Util.mkEq (v0, v1)
                          in
          ...
          let uu____10073 =
            enc
              (fun terms  ->
                 ...
                 | t0::v0::t1::v1::[] ->
                     let uu____10105 =
                       let uu____10110 = FStar_SMTEncoding_Util.mkEq (t0, t1)
                          in
                       let uu____10111 = FStar_SMTEncoding_Util.mkEq (v0, v1)
                          in
                       (uu____10110, uu____10111)  in
                     FStar_SMTEncoding_Util.mkAnd uu____10105
                 | uu____10112 -> failwith "Impossible")
             in
          uu____10073 r args
        else
          (let uu____10118 =
             FStar_Util.format1
               ...
               (Prims.string_of_int n1)
              in
           failwith uu____10118)
         in
      let mk_imp1 r uu___3_10147 =
        match uu___3_10147 with
        | (lhs,uu____10153)::(rhs,uu____10155)::[] ->
            let uu____10196 = encode_formula rhs env  in
            (match uu____10196 with
             | (l1,decls1) ->
                 (match l1.FStar_SMTEncoding_Term.tm with
                  | FStar_SMTEncoding_Term.App
                      (FStar_SMTEncoding_Term.TrueOp ,uu____10211) ->
                      (l1, decls1)
                  | uu____10216 ->
                      let uu____10217 = encode_formula lhs env  in
                      (match uu____10217 with
                       | (l2,decls2) ->
                           let uu____10228 =
                             FStar_SMTEncoding_Term.mkImp (l2, l1) r  in
                           (uu____10228, (FStar_List.append decls1 decls2)))))
        | uu____10229 -> failwith "impossible"  in
      let mk_ite r uu___4_10257 =
        match uu___4_10257 with
        | (guard,uu____10263)::(_then,uu____10265)::(_else,uu____10267)::[]
            ->
            let uu____10324 = encode_formula guard env  in
            (match uu____10324 with
             | (g,decls1) ->
                 let uu____10335 = encode_formula _then env  in
                 (match uu____10335 with
                  | (t,decls2) ->
                      let uu____10346 = encode_formula _else env  in
        ...
        | uu____10358 -> failwith "impossible"  in
      let unboxInt_l f l =
        let uu____10388 = FStar_List.map FStar_SMTEncoding_Term.unboxInt l
           in
        f uu____10388  in
      let connectives =
        let uu____10418 =
          let uu____10443 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd)
             in
          (FStar_Parser_Const.and_lid, uu____10443)  in
        let uu____10486 =
          let uu____10513 =
            let uu____10538 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr)
               in
            (FStar_Parser_Const.or_lid, uu____10538)  in
          let uu____10581 =
            let uu____10608 =
              let uu____10635 =
                let uu____10660 =
                  enc_prop_c (bin_op FStar_SMTEncoding_Util.mkIff)  in
                (FStar_Parser_Const.iff_lid, uu____10660)  in
              let uu____10703 =
                let uu____10730 =
                  let uu____10757 =
                    let uu____10782 =
                      enc_prop_c (un_op FStar_SMTEncoding_Util.mkNot)  in
                    (FStar_Parser_Const.not_lid, uu____10782)  in
                  [uu____10757;
                  ...
                  (FStar_Parser_Const.false_lid,
                   ...
                   in
                (FStar_Parser_Const.ite_lid, mk_ite) :: uu____10730  in
              uu____10635 :: uu____10703  in
            (FStar_Parser_Const.imp_lid, mk_imp1) :: uu____10608  in
          uu____10513 :: uu____10581  in
        uu____10418 :: uu____10486  in
      let rec fallback phi1 =
        match phi1.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Tm_meta
            (phi',FStar_Syntax_Syntax.Meta_labeled (msg,r,b)) ->
            let uu____11327 = encode_formula phi' env  in
             ...
             | (phi2,decls) ->
                 let uu____11338 =
                   FStar_SMTEncoding_Term.mk
                    ...
                    in
                 (uu____11338, decls))
        | FStar_Syntax_Syntax.Tm_meta uu____11340 ->
            let uu____11347 = FStar_Syntax_Util.unmeta phi1  in
            encode_formula uu____11347 env
        | FStar_Syntax_Syntax.Tm_match (e,pats) ->
            let uu____11386 =
              encode_match e pats FStar_SMTEncoding_Util.mkFalse env
                encode_formula
               in
            (match uu____11386 with | (t,decls) -> (t, decls))
        | FStar_Syntax_Syntax.Tm_let
            ((false
              ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                 FStar_Syntax_Syntax.lbunivs = uu____11398;
                 FStar_Syntax_Syntax.lbtyp = t1;
                 FStar_Syntax_Syntax.lbeff = uu____11400;
                 FStar_Syntax_Syntax.lbdef = e1;
                 FStar_Syntax_Syntax.lbattrs = uu____11402;
                 FStar_Syntax_Syntax.lbpos = uu____11403;_}::[]),e2)
            ->
            let uu____11430 = encode_let x t1 e1 e2 env encode_formula  in
            (match uu____11430 with | (t,decls) -> (t, decls))
        | FStar_Syntax_Syntax.Tm_app (head1,args) ->
            let head2 = FStar_Syntax_Util.un_uinst head1  in
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,uu____11483::(x,uu____11485)::(t,uu____11487)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
                 let uu____11554 = encode_term x env  in
                 (match uu____11554 with
                  | (x1,decls) ->
                      let uu____11565 = encode_term t env  in
                      (match uu____11565 with
                       | (t1,decls') ->
                           let uu____11576 =
                             FStar_SMTEncoding_Term.mk_HasType x1 t1  in
                           (uu____11576, (FStar_List.append decls decls'))))
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(r,uu____11579)::(msg,uu____11581)::(phi2,uu____11583)::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                 ...
                 let uu____11650 =
                   let uu____11655 =
                     let uu____11656 = FStar_Syntax_Subst.compress r  in
                     uu____11656.FStar_Syntax_Syntax.n  in
                   let uu____11659 =
                     let uu____11660 = FStar_Syntax_Subst.compress msg  in
                     uu____11660.FStar_Syntax_Syntax.n  in
                   (uu____11655, uu____11659)  in
                 (match uu____11650 with
                  | (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_range
                     r1),FStar_Syntax_Syntax.Tm_constant
                     (FStar_Const.Const_string (s,uu____11669))) ->
                      let phi3 =
                        FStar_Syntax_Syntax.mk
                         ...
                         in
                      fallback phi3
                  | uu____11680 -> fallback phi2)
             | (FStar_Syntax_Syntax.Tm_fvar fv,(t,uu____11687)::[]) when
                 (FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             | uu____11722 when head_redex env head2 ->
                 let uu____11737 = whnf env phi1  in
                 encode_formula uu____11737 env
             | uu____11738 ->
                 let uu____11753 = encode_term phi1 env  in
                        ...
                        let uu____11765 =
                          ...
                          let uu____11768 =
                            FStar_Range.use_range
                             ...
                             in
                          FStar_Range.rng_included uu____11767 uu____11768
                           in
                        if uu____11765
                        then tt
                        else
                          (let uu___1548_11772 = tt  in
                           {
                             FStar_SMTEncoding_Term.tm =
                               (uu___1548_11772.FStar_SMTEncoding_Term.tm);
                             FStar_SMTEncoding_Term.freevars =
                               (uu___1548_11772.FStar_SMTEncoding_Term.freevars);
                             FStar_SMTEncoding_Term.rng =
                               (phi1.FStar_Syntax_Syntax.pos)
                           })
                         in
                      let uu____11773 = FStar_SMTEncoding_Term.mk_Valid tt1
                         in
                      (uu____11773, decls)))
        | uu____11774 ->
            let uu____11775 = encode_term phi1 env  in
             ...
             | (tt,decls) ->
                 let tt1 =
                   let uu____11787 =
                     ...
                     FStar_Range.rng_included uu____11789 uu____11790  in
                   if uu____11787
                   then tt
                   else
                     (let uu___1556_11794 = tt  in
                      {
                        FStar_SMTEncoding_Term.tm =
                          (uu___1556_11794.FStar_SMTEncoding_Term.tm);
                        FStar_SMTEncoding_Term.freevars =
                          (uu___1556_11794.FStar_SMTEncoding_Term.freevars);
                        FStar_SMTEncoding_Term.rng =
                          (phi1.FStar_Syntax_Syntax.pos)
                      })
                    in
                 let uu____11795 = FStar_SMTEncoding_Term.mk_Valid tt1  in
                 (uu____11795, decls))
         in
      let encode_q_body env1 bs ps body =
        let uu____11839 = encode_binders FStar_Pervasives_Native.None bs env1
           in
        match uu____11839 with
        | (vars,guards,env2,decls,uu____11878) ->
            let uu____11891 = encode_smt_patterns ps env2  in
            (match uu____11891 with
             | (pats,decls') ->
                 let uu____11928 = encode_formula body env2  in
                  ...
                  | (body1,decls'') ->
                      let guards1 =
                        ...
                        | ({
                             ...
                             FStar_SMTEncoding_Term.freevars = uu____11960;
                             FStar_SMTEncoding_Term.rng = uu____11961;_}::[])::[]
                            when
                            let uu____11981 =
                              FStar_Ident.text_of_lid
                               ...
                               in
                            uu____11981 = gf -> []
                        | uu____11984 -> guards  in
                      let uu____11989 =
                        FStar_SMTEncoding_Util.mk_and_l guards1  in
                      (vars, pats, uu____11989, body1,
                        (FStar_List.append decls
                           (FStar_List.append decls' decls'')))))
         in
      debug1 phi;
      (let phi1 = FStar_Syntax_Util.unascribe phi  in
       let uu____12000 = FStar_Syntax_Util.destruct_typ_as_formula phi1  in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____12115  ->
                     ...
                     | (l,uu____12140) -> FStar_Ident.lid_equals op l))
              in
           (match uu____12009 with
            | FStar_Pervasives_Native.None  -> fallback phi1
            | FStar_Pervasives_Native.Some (uu____12209,f) ->
                f phi1.FStar_Syntax_Syntax.pos arms)
       | FStar_Pervasives_Native.Some (FStar_Syntax_Util.QAll
           (vars,pats,body)) ->
           (FStar_All.pipe_right pats
              (FStar_List.iter (check_pattern_vars env vars));
            (let uu____12301 = encode_q_body env vars pats body  in
             ...
             | (vars1,pats1,guard,body1,decls) ->
                 let tm =
                   let uu____12346 =
                     ...
                     (pats1, vars1, uu____12357)  in
                   FStar_SMTEncoding_Term.mkForall
                     phi1.FStar_Syntax_Syntax.pos uu____12346
                    in
                 (tm, decls)))
       | FStar_Pervasives_Native.Some (FStar_Syntax_Util.QEx
           ...
           (FStar_All.pipe_right pats
              (FStar_List.iter (check_pattern_vars env vars));
            (let uu____12388 = encode_q_body env vars pats body  in
             ...
             | (vars1,pats1,guard,body1,decls) ->
                 let uu____12432 =
                   let uu____12433 =
                     ...
                     (pats1, vars1, uu____12444)  in
                   FStar_SMTEncoding_Term.mkExists
                     phi1.FStar_Syntax_Syntax.pos uu____12433
                    in
                 (uu____12432, decls))))
