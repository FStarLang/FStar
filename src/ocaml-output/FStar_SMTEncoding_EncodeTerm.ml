      ...
      (match t0.FStar_Syntax_Syntax.n with
                                      ...
                                      let tsym =
                                        let uu____4980 =
                                          FStar_Util.digest_of_string
                                            tkey_hash in
                                        Prims.op_Hat "Tm_arrow_" uu____4980 in
                                      let cvar_sorts =
                                        FStar_List.map
                                        ...
                                        let uu____5177 =
                                          let uu____5180 =
                                            ...
                                            FStar_List.append guard_decls
                                              uu____5183 in
                                          FStar_List.append decls' uu____5180 in
                                        FStar_List.append decls uu____5177 in
                                      (t1, uu____5176)))))
                else
                  (let tsym =
                     FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.fresh
       ...
       | FStar_Syntax_Syntax.Tm_refine uu____5298 ->
           ...
           (match uu____5305 with
            | (x, f) ->
                let uu____5378 = encode_term x.FStar_Syntax_Syntax.sort env in
                               ...
                               (match uu____5417 with
                                | (fsym, fterm) ->
                                    ...
                                    let tsym =
                                      let uu____5561 =
                                        FStar_Util.digest_of_string tkey_hash in
                                      Prims.op_Hat "Tm_refine_" uu____5561 in
                                    let cvar_sorts =
                                      FStar_List.map
                                      ...
                                      let uu____5581 =
                                        let uu____5589 =
                                          FStar_List.map
                                            ...
                                            cvars1 in
                                        (tsym, uu____5589) in
                                      FStar_SMTEncoding_Util.mkApp uu____5581 in
                                    let x_has_base_t =
                                    ...
                                    let uu____5717 =
                                      let uu____5718 =
                                        ...
                                        FStar_List.append decls' uu____5721 in
                ...
                (match uu____5849 with
                 ...
                 | (FStar_Syntax_Syntax.Tm_uinst
                    ({
                       ...
                       FStar_Syntax_Syntax.vars = uu____5962;_},
                     uu____5963),
                    uu____5964) when
                     (Prims.op_Negation
                        env.FStar_SMTEncoding_Env.encoding_quantifier)
                 ...
                 | (FStar_Syntax_Syntax.Tm_uinst
                    ({
                       ...
                       FStar_Syntax_Syntax.vars = uu____5991;_},
                     uu____5992),
                 ...
                 | (FStar_Syntax_Syntax.Tm_fvar fv,
                    (v0, uu____6105)::(v1, uu____6107)::(v2, uu____6109)::[])
                     when
                     FStar_Syntax_Syntax.fv_eq_lid fv
                       FStar_Parser_Const.lexcons_lid
                     ->
                 ...
                 | (FStar_Syntax_Syntax.Tm_constant
                    ...
                    (arg, uu____6247)::(rng, uu____6249)::[]) ->
                     encode_term arg env
                 | (FStar_Syntax_Syntax.Tm_constant
                    (FStar_Const.Const_reify), uu____6300) ->
                     let e0 =
                       let uu____6322 = FStar_List.hd args_e in
                       FStar_TypeChecker_Util.reify_body_with_arg
                         env.FStar_SMTEncoding_Env.tcenv head1 uu____6322 in
                     ((let uu____6332 =
                         FStar_All.pipe_left
                      ...
                      (let e =
                       ...
                       encode_term e env))
                 | (FStar_Syntax_Syntax.Tm_constant
                    (FStar_Const.Const_reflect uu____6360),
                    (arg, uu____6362)::[]) -> encode_term arg env
                 | uu____6397 ->
                      ...
                      | (args, decls) ->
                          ...
                          let head_type =
                            ...
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____6910, (FStar_Util.Inl t1, uu____6912),
                                 uu____6913)
                                -> FStar_Pervasives_Native.Some t1
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____6960, (FStar_Util.Inr c, uu____6962),
                                 uu____6963)
                                ->
                                FStar_Pervasives_Native.Some
                               ...
                               let head_type2 =
                                 let uu____7031 =
                                   FStar_TypeChecker_Normalize.normalize_refinement
                                     ...
                                     head_type1 in
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine uu____7031 in
                               let uu____7032 =
                ...
                let codomain_eff rc =
                  ...
                  then
                    ...
                    (let uu____7251 =
                     ...
                     if uu____7251
                     then
                       let uu____7256 = FStar_Syntax_Syntax.mk_GTotal res_typ in
                             ...
                             | (body3, decls') ->
                                 let uu____7344 =
                                   ...
                                   | FStar_Pervasives_Native.Some c ->
                                       ...
                                       let uu____7372 = encode_term tfun env in
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((uu____7628,
             { FStar_Syntax_Syntax.lbname = FStar_Util.Inr uu____7629;
               ...
               FStar_Syntax_Syntax.lbpos = uu____7635;_}::uu____7636),
            uu____7637)
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((false,
             { FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
               ...
               FStar_Syntax_Syntax.lbpos = uu____7676;_}::[]),
            e2)
...
and (encode_pat :
  ...
  fun env ->
    fun pat ->
      ...
      (let uu____8183 = FStar_TypeChecker_Util.decorated_pattern_as_term pat in
                                ...
                                fun uu____8617 ->
                                  ...
                                  | (arg, uu____8633) ->
                                      ...
                                      let uu____8642 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee]) in
                                      mk_projections arg uu____8642)) in
                      FStar_All.pipe_right uu____8571 FStar_List.flatten in
  ...
  fun t ->
    fun env ->
      let universe_of_binders binders =
        FStar_List.map (fun uu____8877 -> FStar_Syntax_Syntax.U_zero) binders in
      ...
      let encode_smt_pattern t =
        ...
        | (head1, args) ->
            ...
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                uu____8982::(x, uu____8984)::(t1, uu____8986)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             | uu____9076 -> encode_term t env1) in
    ...
    fun env ->
      ...
      let enc f r l =
        ...
        | (decls, args) ->
            ...
            (uu____9491, decls) in
      let const_op f r uu____9527 = let uu____9540 = f r in (uu____9540, []) in
      let un_op f l =
        let uu____9563 = FStar_List.hd l in FStar_All.pipe_left f uu____9563 in
          ...
          let uu____9902 =
            enc
              (fun terms ->
                 ...
                 | t0::t1::v0::v1::[] ->
                     let uu____9934 =
                       let uu____9939 = FStar_SMTEncoding_Util.mkEq (t0, t1) in
                       let uu____9940 = FStar_SMTEncoding_Util.mkEq (v0, v1) in
                       (uu____9939, uu____9940) in
                     FStar_SMTEncoding_Util.mkAnd uu____9934
                 | uu____9941 -> failwith "Impossible") in
          uu____9902 r args
        else
          (let uu____9947 =
             FStar_Util.format1
          ...
          let uu____10009 =
            enc
              (fun terms ->
                 ...
                 | t0::v0::t1::v1::[] ->
                     let uu____10041 =
                       let uu____10046 = FStar_SMTEncoding_Util.mkEq (t0, t1) in
                       let uu____10047 = FStar_SMTEncoding_Util.mkEq (v0, v1) in
      ...
      let unboxInt_l f l =
        let uu____10324 = FStar_List.map FStar_SMTEncoding_Term.unboxInt l in
        f uu____10324 in
      let connectives =
        let uu____10354 =
          let uu____10379 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd) in
          (FStar_Parser_Const.and_lid, uu____10379) in
        let uu____10422 =
          let uu____10449 =
            let uu____10474 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr) in
      ...
      let rec fallback phi1 =
        ...
        | FStar_Syntax_Syntax.Tm_let
            ((false,
              { FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                ...
                FStar_Syntax_Syntax.lbpos = uu____11339;_}::[]),
             e2)
            ->
        ...
        | FStar_Syntax_Syntax.Tm_app (head1, args) ->
            ...
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                uu____11419::(x, uu____11421)::(t, uu____11423)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
             ...
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                (r, uu____11515)::(msg, uu____11517)::(phi2, uu____11519)::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                  ...
                  | (tt, decls) ->
                      let tt1 =
                        let uu____11701 =
                          ...
                          FStar_Range.rng_included uu____11703 uu____11704 in
                        if uu____11701
                        then tt
                        else
                      ...
                      let uu____11709 = FStar_SMTEncoding_Term.mk_Valid tt1 in
                      (uu____11709, decls)))
        | uu____11710 ->
            ...
            (match uu____11711 with
             | (tt, decls) ->
                 ...
                 (uu____11731, decls)) in
      let encode_q_body env1 bs ps body =
        let uu____11775 = encode_binders FStar_Pervasives_Native.None bs env1 in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____12051 ->
                     ...
                     | (l, uu____12076) -> FStar_Ident.lid_equals op l)) in
            ...
            (let uu____12237 = encode_q_body env vars pats body in
             ...
             | (vars1, pats1, guard, body1, decls) ->
                 let tm =
                   ...
                   FStar_SMTEncoding_Term.mkForall
                     phi1.FStar_Syntax_Syntax.pos uu____12282 in
                 (tm, decls)))
             ...
             | (vars1, pats1, guard, body1, decls) ->
                 let uu____12368 =
                   ...
                   FStar_SMTEncoding_Term.mkExists
                     phi1.FStar_Syntax_Syntax.pos uu____12369 in
                 (uu____12368, decls))))