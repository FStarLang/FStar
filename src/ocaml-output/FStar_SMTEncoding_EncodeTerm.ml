    ...
    fun env  ->
      ...
      (match t0.FStar_Syntax_Syntax.n with
       ...
       | FStar_Syntax_Syntax.Tm_meta
           ...
           encode_term t1
             (let uu___612_4600 = env  in
              {
                FStar_SMTEncoding_Env.bvar_bindings =
                  (uu___612_4600.FStar_SMTEncoding_Env.bvar_bindings);
                FStar_SMTEncoding_Env.fvar_bindings =
                  (uu___612_4600.FStar_SMTEncoding_Env.fvar_bindings);
                FStar_SMTEncoding_Env.depth =
                  (uu___612_4600.FStar_SMTEncoding_Env.depth);
                FStar_SMTEncoding_Env.tcenv =
                  (uu___612_4600.FStar_SMTEncoding_Env.tcenv);
                FStar_SMTEncoding_Env.warn =
                  (uu___612_4600.FStar_SMTEncoding_Env.warn);
                FStar_SMTEncoding_Env.nolabels =
                  (uu___612_4600.FStar_SMTEncoding_Env.nolabels);
                FStar_SMTEncoding_Env.use_zfuel_name =
                  (uu___612_4600.FStar_SMTEncoding_Env.use_zfuel_name);
                FStar_SMTEncoding_Env.encode_non_total_function_typ =
                  (uu___612_4600.FStar_SMTEncoding_Env.encode_non_total_function_typ);
                FStar_SMTEncoding_Env.current_module_name =
                  (uu___612_4600.FStar_SMTEncoding_Env.current_module_name);
                FStar_SMTEncoding_Env.encoding_quantifier = false;
                FStar_SMTEncoding_Env.global_cache =
                  (uu___612_4600.FStar_SMTEncoding_Env.global_cache)
              })
       | FStar_Syntax_Syntax.Tm_meta (t1,uu____4603) -> encode_term t1 env
       | FStar_Syntax_Syntax.Tm_name x ->
           let t1 = FStar_SMTEncoding_Env.lookup_term_var env x  in (t1, [])
       | FStar_Syntax_Syntax.Tm_fvar v1 ->
           let uu____4611 = head_redex env t  in
           if uu____4611
           then let uu____4618 = whnf env t  in encode_term uu____4618 env
           else
             (let fvb =
              ...
              let uu____4625 =
                ...
                then
                  ...
                  | FStar_SMTEncoding_Term.FreeV uu____4649 ->
                      let sym_name =
                        let uu____4660 =
                          FStar_Util.digest_of_string tkey_hash  in
                        Prims.op_Hat "@kick_partial_app_" uu____4660  in
                      let uu____4663 =
                        let uu____4666 =
                          let uu____4667 =
                            let uu____4675 =
                            ...
                            (uu____4675,
                             ...
                             in
                          FStar_SMTEncoding_Util.mkAssume uu____4667  in
                        [uu____4666]  in
                      (uu____4663, sym_name)
                  | FStar_SMTEncoding_Term.App (uu____4682,[]) ->
                      let sym_name =
                        let uu____4687 =
                          FStar_Util.digest_of_string tkey_hash  in
                        Prims.op_Hat "@kick_partial_app_" uu____4687  in
                      let uu____4690 =
                        let uu____4693 =
                          let uu____4694 =
                            let uu____4702 =
                            ...
                            (uu____4702,
                              (FStar_Pervasives_Native.Some
                                 "kick_partial_app"), sym_name)
                             in
                          FStar_SMTEncoding_Util.mkAssume uu____4694  in
                        [uu____4693]  in
                      (uu____4690, sym_name)
                  | uu____4709 -> ([], "")
                else ([], "")  in
              ...
              | (aux_decls,sym_name) ->
                  let uu____4732 =
                    ...
                    then
                     ...
                     in
                  (tok, uu____4732))
       | FStar_Syntax_Syntax.Tm_type uu____4740 ->
           (FStar_SMTEncoding_Term.mk_Term_type, [])
       | FStar_Syntax_Syntax.Tm_uinst (t1,uu____4742) -> encode_term t1 env
       | FStar_Syntax_Syntax.Tm_constant c -> encode_const c env
       | FStar_Syntax_Syntax.Tm_arrow (binders,c) ->
           let module_name = env.FStar_SMTEncoding_Env.current_module_name
              in
           let uu____4772 = FStar_Syntax_Subst.open_comp binders c  in
            ...
            | (binders1,res) ->
                ...
                then
                  ...
                  (match uu____4790 with
                   | (vars,guards,env',decls,uu____4815) ->
                       let fsym =
                         let uu____4829 =
                           let uu____4835 =
                             FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.fresh
                               module_name "f"
                              in
                           (uu____4835, FStar_SMTEncoding_Term.Term_sort)  in
                         FStar_SMTEncoding_Term.mk_fv uu____4829  in
                           ...
                           (let uu___666_4850 =
                              env.FStar_SMTEncoding_Env.tcenv  in
                            {
                              FStar_TypeChecker_Env.solver =
                                (uu___666_4850.FStar_TypeChecker_Env.solver);
                              FStar_TypeChecker_Env.range =
                                (uu___666_4850.FStar_TypeChecker_Env.range);
                              FStar_TypeChecker_Env.curmodule =
                                (uu___666_4850.FStar_TypeChecker_Env.curmodule);
                              FStar_TypeChecker_Env.gamma =
                                (uu___666_4850.FStar_TypeChecker_Env.gamma);
                              FStar_TypeChecker_Env.gamma_sig =
                                (uu___666_4850.FStar_TypeChecker_Env.gamma_sig);
                              FStar_TypeChecker_Env.gamma_cache =
                                (uu___666_4850.FStar_TypeChecker_Env.gamma_cache);
                              FStar_TypeChecker_Env.modules =
                                (uu___666_4850.FStar_TypeChecker_Env.modules);
                              FStar_TypeChecker_Env.expected_typ =
                                (uu___666_4850.FStar_TypeChecker_Env.expected_typ);
                              FStar_TypeChecker_Env.sigtab =
                                (uu___666_4850.FStar_TypeChecker_Env.sigtab);
                              FStar_TypeChecker_Env.attrtab =
                                (uu___666_4850.FStar_TypeChecker_Env.attrtab);
                              FStar_TypeChecker_Env.is_pattern =
                                (uu___666_4850.FStar_TypeChecker_Env.is_pattern);
                              FStar_TypeChecker_Env.instantiate_imp =
                                (uu___666_4850.FStar_TypeChecker_Env.instantiate_imp);
                              FStar_TypeChecker_Env.effects =
                                (uu___666_4850.FStar_TypeChecker_Env.effects);
                              FStar_TypeChecker_Env.generalize =
                                (uu___666_4850.FStar_TypeChecker_Env.generalize);
                              FStar_TypeChecker_Env.letrecs =
                                (uu___666_4850.FStar_TypeChecker_Env.letrecs);
                              FStar_TypeChecker_Env.top_level =
                                (uu___666_4850.FStar_TypeChecker_Env.top_level);
                              FStar_TypeChecker_Env.check_uvars =
                                (uu___666_4850.FStar_TypeChecker_Env.check_uvars);
                              FStar_TypeChecker_Env.use_eq =
                                (uu___666_4850.FStar_TypeChecker_Env.use_eq);
                              FStar_TypeChecker_Env.is_iface =
                                (uu___666_4850.FStar_TypeChecker_Env.is_iface);
                              FStar_TypeChecker_Env.admit =
                                (uu___666_4850.FStar_TypeChecker_Env.admit);
                              FStar_TypeChecker_Env.lax = true;
                              FStar_TypeChecker_Env.lax_universes =
                                (uu___666_4850.FStar_TypeChecker_Env.lax_universes);
                              FStar_TypeChecker_Env.phase1 =
                                (uu___666_4850.FStar_TypeChecker_Env.phase1);
                              FStar_TypeChecker_Env.failhard =
                                (uu___666_4850.FStar_TypeChecker_Env.failhard);
                              FStar_TypeChecker_Env.nosynth =
                                (uu___666_4850.FStar_TypeChecker_Env.nosynth);
                              FStar_TypeChecker_Env.uvar_subtyping =
                                (uu___666_4850.FStar_TypeChecker_Env.uvar_subtyping);
                              FStar_TypeChecker_Env.tc_term =
                                (uu___666_4850.FStar_TypeChecker_Env.tc_term);
                              FStar_TypeChecker_Env.type_of =
                                (uu___666_4850.FStar_TypeChecker_Env.type_of);
                              FStar_TypeChecker_Env.universe_of =
                                (uu___666_4850.FStar_TypeChecker_Env.universe_of);
                              FStar_TypeChecker_Env.check_type_of =
                                (uu___666_4850.FStar_TypeChecker_Env.check_type_of);
                              FStar_TypeChecker_Env.use_bv_sorts =
                                (uu___666_4850.FStar_TypeChecker_Env.use_bv_sorts);
                              FStar_TypeChecker_Env.qtbl_name_and_index =
                                (uu___666_4850.FStar_TypeChecker_Env.qtbl_name_and_index);
                              FStar_TypeChecker_Env.normalized_eff_names =
                                (uu___666_4850.FStar_TypeChecker_Env.normalized_eff_names);
                              FStar_TypeChecker_Env.fv_delta_depths =
                                (uu___666_4850.FStar_TypeChecker_Env.fv_delta_depths);
                              FStar_TypeChecker_Env.proof_ns =
                                (uu___666_4850.FStar_TypeChecker_Env.proof_ns);
                              FStar_TypeChecker_Env.synth_hook =
                                (uu___666_4850.FStar_TypeChecker_Env.synth_hook);
                              FStar_TypeChecker_Env.splice =
                                (uu___666_4850.FStar_TypeChecker_Env.splice);
                              FStar_TypeChecker_Env.postprocess =
                                (uu___666_4850.FStar_TypeChecker_Env.postprocess);
                              FStar_TypeChecker_Env.is_native_tactic =
                                (uu___666_4850.FStar_TypeChecker_Env.is_native_tactic);
                              FStar_TypeChecker_Env.identifier_info =
                                (uu___666_4850.FStar_TypeChecker_Env.identifier_info);
                              FStar_TypeChecker_Env.tc_hooks =
                                (uu___666_4850.FStar_TypeChecker_Env.tc_hooks);
                              FStar_TypeChecker_Env.dsenv =
                                (uu___666_4850.FStar_TypeChecker_Env.dsenv);
                              FStar_TypeChecker_Env.nbe =
                                (uu___666_4850.FStar_TypeChecker_Env.nbe)
                            }) res
                          in
                                      ...
                                      let tsym =
                                        let uu____4991 =
                                          FStar_Util.digest_of_string
                                            tkey_hash
                                           in
                                        Prims.op_Hat "Tm_arrow_" uu____4991
                                         in
                                      let cvar_sorts =
                                        FStar_List.map
                             ...
                             let uu____5257 =
                               let uu____5262 =
                                 ...
                                 FStar_SMTEncoding_Term.mk_tester "Tm_arrow"
                                   uu____5263
                                  in
                               (f_has_t, uu____5262)  in
                             FStar_SMTEncoding_Util.mkImp uu____5257  in
                           ([[f_has_t]], [fsym], uu____5256)  in
                         let uu____5289 =
                           mkForall_fuel module_name
                             t0.FStar_Syntax_Syntax.pos
                            in
                         uu____5289 uu____5245  in
                       (uu____5244, (FStar_Pervasives_Native.Some a_name),
                         a_name)
                        in
                     FStar_SMTEncoding_Util.mkAssume uu____5236  in
                   let uu____5306 =
                     FStar_All.pipe_right [tdecl; t_kinding; t_interp]
                       FStar_SMTEncoding_Term.mk_decls_trivial
                      in
                   (t1, uu____5306)))
       | FStar_Syntax_Syntax.Tm_refine uu____5309 ->
           let uu____5316 =
             let uu____5321 =
             ...
             | { FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_refine (x,f);
                 ...
                 FStar_Syntax_Syntax.vars = uu____5329;_} ->
                 let uu____5336 =
                 ...
                 (match uu____5336 with
                  | (b,f1) ->
                      let uu____5361 =
                        let uu____5362 = FStar_List.hd b  in
                        FStar_Pervasives_Native.fst uu____5362  in
                      (uu____5361, f1))
             | uu____5377 -> failwith "impossible"  in
           (match uu____5316 with
            | (x,f) ->
                let uu____5389 = encode_term x.FStar_Syntax_Syntax.sort env
                   in
                (match uu____5389 with
                 | (base_t,decls) ->
                     ...
                     (match uu____5400 with
                      | (x1,xtm,env') ->
                          let uu____5417 = encode_formula f env'  in
                                    ...
                                    let tsym =
                                      let uu____5572 =
                                        FStar_Util.digest_of_string tkey_hash
                                         in
                                      Prims.op_Hat "Tm_refine_" uu____5572
                                       in
                                    let cvar_sorts =
                                      FStar_List.map
                                      ...
                                      let uu____5592 =
                                        let uu____5600 =
                                          FStar_List.map
                                           ...
                                           in
                                        (tsym, uu____5600)  in
                                      FStar_SMTEncoding_Util.mkApp uu____5592
                                       in
                                    let x_has_base_t =
                                      ...
                                      let uu____5729 =
                                        let uu____5732 =
                                          FStar_SMTEncoding_Term.mk_decls
                                           ...
                                           in
                                        FStar_List.append decls' uu____5732
                                         in
                                      FStar_List.append decls uu____5729  in
                                    (t1, uu____5728))))))
       | FStar_Syntax_Syntax.Tm_uvar (uv,uu____5736) ->
           let ttm =
             let uu____5754 =
               FStar_Syntax_Unionfind.uvar_id
                 uv.FStar_Syntax_Syntax.ctx_uvar_head
                in
             FStar_SMTEncoding_Util.mk_Term_uvar uu____5754  in
           let uu____5756 =
             encode_term_pred FStar_Pervasives_Native.None
                ...
                let d =
                  let uu____5768 =
                        ...
                        let uu____5780 =
                          let uu____5782 =
                            FStar_Syntax_Unionfind.uvar_id
                              uv.FStar_Syntax_Syntax.ctx_uvar_head
                             in
                          FStar_Util.string_of_int uu____5782  in
                        FStar_Util.format1 "uvar_typing_%s" uu____5780  in
                    ...
                    (t_has_k, (FStar_Pervasives_Native.Some "Uvar typing"),
                      uu____5776)
                     in
                  FStar_SMTEncoding_Util.mkAssume uu____5768  in
                let uu____5788 =
                  let uu____5789 =
                    FStar_All.pipe_right [d]
                      FStar_SMTEncoding_Term.mk_decls_trivial
                     in
                  FStar_List.append decls uu____5789  in
                (ttm, uu____5788))
       | FStar_Syntax_Syntax.Tm_app uu____5796 ->
           let uu____5813 = FStar_Syntax_Util.head_and_args t0  in
           (match uu____5813 with
            | (head1,args_e) ->
                let uu____5860 =
                  ...
                  (uu____5875, args_e)  in
                (match uu____5860 with
                 | uu____5893 when head_redex env head1 ->
                     let uu____5908 = whnf env t  in
                     encode_term uu____5908 env
                 | uu____5909 when is_arithmetic_primitive head1 args_e ->
                     encode_arith_term env head1 args_e
                 | uu____5932 when is_BitVector_primitive head1 args_e ->
                     encode_BitVector_term env head1 args_e
                 | (FStar_Syntax_Syntax.Tm_fvar fv,uu____5950) when
                     (Prims.op_Negation
                 ...
                 | (FStar_Syntax_Syntax.Tm_uinst
                    ({
                       ...
                       FStar_Syntax_Syntax.vars = uu____5973;_},uu____5974),uu____5975)
                     when
                     (Prims.op_Negation
                        env.FStar_SMTEncoding_Env.encoding_quantifier)
                       &&
                 ...
                 | (FStar_Syntax_Syntax.Tm_uinst
                    ({
                       FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
                       FStar_Syntax_Syntax.pos = uu____6001;
                       FStar_Syntax_Syntax.vars = uu____6002;_},uu____6003),
                    (v0,uu____6005)::(v1,uu____6007)::(v2,uu____6009)::[])
                     when
                     FStar_Syntax_Syntax.fv_eq_lid fv
                       FStar_Parser_Const.lexcons_lid
                     ->
                     let uu____6080 = encode_term v0 env  in
                     (match uu____6080 with
                      | (v01,decls0) ->
                          let uu____6091 = encode_term v1 env  in
                          (match uu____6091 with
                           | (v11,decls1) ->
                               let uu____6102 = encode_term v2 env  in
                 ...
                 | (FStar_Syntax_Syntax.Tm_fvar
                    fv,(v0,uu____6116)::(v1,uu____6118)::(v2,uu____6120)::[])
                     when
                     FStar_Syntax_Syntax.fv_eq_lid fv
                       FStar_Parser_Const.lexcons_lid
                     ->
                     let uu____6187 = encode_term v0 env  in
                     (match uu____6187 with
                      | (v01,decls0) ->
                          let uu____6198 = encode_term v1 env  in
                          (match uu____6198 with
                           | (v11,decls1) ->
                               let uu____6209 = encode_term v2 env  in
                 ...
                 | (FStar_Syntax_Syntax.Tm_constant
                    (FStar_Const.Const_range_of ),(arg,uu____6222)::[]) ->
                     encode_const
                       (FStar_Const.Const_range (arg.FStar_Syntax_Syntax.pos))
                       env
                 | (FStar_Syntax_Syntax.Tm_constant
                    (FStar_Const.Const_set_range_of
                    ),(arg,uu____6258)::(rng,uu____6260)::[]) ->
                     encode_term arg env
                 | (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify
                    ),uu____6311) ->
                     let e0 =
                       let uu____6333 = FStar_List.hd args_e  in
                       FStar_TypeChecker_Util.reify_body_with_arg
                         env.FStar_SMTEncoding_Env.tcenv head1 uu____6333
                        in
                     ((let uu____6343 =
                         FStar_All.pipe_left
                      ...
                      (let e =
                         let uu____6356 =
                           ...
                           let uu____6362 = FStar_List.tl args_e  in
                           FStar_Syntax_Syntax.mk_Tm_app uu____6361
                             uu____6362
                            in
                 ...
                 | (FStar_Syntax_Syntax.Tm_constant
                    ...
                    uu____6371),(arg,uu____6373)::[]) -> encode_term arg env
                 | uu____6408 ->
                     let uu____6423 = encode_args args_e env  in
                     (match uu____6423 with
                      | (args,decls) ->
                          let encode_partial_app ht_opt =
                            let uu____6484 = encode_term head1 env  in
                          ...
                          let head_type =
                            ...
                            | FStar_Syntax_Syntax.Tm_uinst
                                ({
                                   FStar_Syntax_Syntax.n =
                                     FStar_Syntax_Syntax.Tm_name x;
                                   FStar_Syntax_Syntax.pos = uu____6834;
                                   FStar_Syntax_Syntax.vars = uu____6835;_},uu____6836)
                                ->
                                FStar_Pervasives_Native.Some
                                ...
                                let uu____6850 =
                                  let uu____6851 =
                                    ...
                                    FStar_All.pipe_right uu____6856
                                     ...
                                     in
                                  FStar_All.pipe_right uu____6851
                            ...
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____6921,(FStar_Util.Inl t1,uu____6923),uu____6924)
                                -> FStar_Pervasives_Native.Some t1
                            | FStar_Syntax_Syntax.Tm_ascribed
                                (uu____6971,(FStar_Util.Inr c,uu____6973),uu____6974)
                                ->
                                FStar_Pervasives_Native.Some
                               ...
                               let head_type2 =
                                 let uu____7042 =
                                   FStar_TypeChecker_Normalize.normalize_refinement
                                    ...
                                    in
                                 FStar_All.pipe_left
                                   FStar_Syntax_Util.unrefine uu____7042
                                  in
                               let uu____7043 =
       ...
       | FStar_Syntax_Syntax.Tm_abs (bs,body,lopt) ->
           let uu____7158 = FStar_Syntax_Subst.open_term' bs body  in
           (match uu____7158 with
            | (bs1,body1,opening) ->
                let fallback uu____7181 =
                  let f =
                    FStar_SMTEncoding_Env.varops.FStar_SMTEncoding_Env.fresh
                ...
                let is_impure rc =
                  let uu____7204 =
                    FStar_TypeChecker_Util.is_pure_or_ghost_effect
                     ...
                     in
                  FStar_All.pipe_right uu____7204 Prims.op_Negation  in
                let codomain_eff rc =
                  let res_typ =
                    ...
                    | FStar_Pervasives_Native.None  ->
                        let uu____7219 =
                          ...
                          FStar_TypeChecker_Util.new_implicit_var
                            "SMTEncoding codomain" uu____7232
                            env.FStar_SMTEncoding_Env.tcenv
                            FStar_Syntax_Util.ktype0
                           in
                        (match uu____7219 with
                         | (t1,uu____7235,uu____7236) -> t1)
                  ...
                  if uu____7254
                  then
                    let uu____7259 = FStar_Syntax_Syntax.mk_Total res_typ  in
                    ...
                    (let uu____7262 =
                     ...
                     if uu____7262
                     then
                       let uu____7267 = FStar_Syntax_Syntax.mk_GTotal res_typ
                          in
                 ...
                 | FStar_Pervasives_Native.Some rc ->
                     ...
                     then fallback ()
                       ...
                       (let uu____7300 =
                        ...
                        | (vars,guards,envbody,decls,uu____7325) ->
                            let body2 =
                              let uu____7339 =
                                FStar_TypeChecker_Env.is_reifiable_rc
                                  env.FStar_SMTEncoding_Env.tcenv rc
                            ...
                            let uu____7344 = encode_term body2 envbody  in
                            (match uu____7344 with
                             | (body3,decls') ->
                                 let uu____7355 =
                                   let uu____7364 = codomain_eff rc  in
                                   ...
                                   | FStar_Pervasives_Native.Some c ->
                                       ...
                                       let uu____7383 = encode_term tfun env
                                          in
       ...
       | FStar_Syntax_Syntax.Tm_let
           ((uu____7639,{
                          ...
                          FStar_Syntax_Syntax.lbtyp = uu____7642;
                          FStar_Syntax_Syntax.lbeff = uu____7643;
                          FStar_Syntax_Syntax.lbdef = uu____7644;
                          FStar_Syntax_Syntax.lbattrs = uu____7645;
                          FStar_Syntax_Syntax.lbpos = uu____7646;_}::uu____7647),uu____7648)
           -> failwith "Impossible: already handled by encoding of Sig_let"
       | FStar_Syntax_Syntax.Tm_let
           ((false
             ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                FStar_Syntax_Syntax.lbunivs = uu____7682;
                FStar_Syntax_Syntax.lbtyp = t1;
                FStar_Syntax_Syntax.lbeff = uu____7684;
                FStar_Syntax_Syntax.lbdef = e1;
                FStar_Syntax_Syntax.lbattrs = uu____7686;
                FStar_Syntax_Syntax.lbpos = uu____7687;_}::[]),e2)
           -> encode_let x t1 e1 e2 env encode_term
       | FStar_Syntax_Syntax.Tm_let uu____7714 ->
            ...
            fun encode_body  ->
              ...
              | (ee1,decls1) ->
                  ...
                  (match uu____7816 with
                   | (xs,e21) ->
                       let uu____7841 = FStar_List.hd xs  in
                       (match uu____7841 with
                        | (x1,uu____7859) ->
                            let env' =
                              FStar_SMTEncoding_Env.push_term_var env x1 ee1
                               in
                            let uu____7865 = encode_body e21 env'  in
              ...
              let uu____7903 =
                let uu____7904 =
                  FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown
                   ...
                   in
                FStar_Syntax_Syntax.null_bv uu____7904  in
              FStar_SMTEncoding_Env.gen_term_var env uu____7903  in
            match uu____7895 with
            | (scrsym,scr',env1) ->
                let uu____7914 = encode_term e env1  in
                (match uu____7914 with
                 | (scr,decls) ->
                     let uu____7925 =
                       let encode_branch b uu____7954 =
                         ...
                         | (else_case,decls1) ->
                             ...
                             (match uu____7973 with
                              | (p,w,br) ->
                                  let uu____7999 = encode_pat env1 p  in
                            ...
                            let uu____8140 =
                              let uu____8151 =
                                let uu____8158 =
                                  ...
                                  (uu____8163, scr)  in
                                [uu____8158]  in
                              (uu____8151, match_tm)  in
                            FStar_SMTEncoding_Term.mkLet' uu____8140
  ...
  fun env  ->
    fun pat  ->
      (let uu____8186 =
       ...
       if uu____8186
       then
         let uu____8189 = FStar_Syntax_Print.pat_to_string pat  in
         FStar_Util.print1 "Encoding pattern %s\n" uu____8189
       else ());
      (let uu____8194 = FStar_TypeChecker_Util.decorated_pattern_as_term pat
          in
           ...
           (match uu____8211 with
            | (env1,vars1) ->
                let rec mk_guard pat1 scrutinee =
                  ...
                  | FStar_Syntax_Syntax.Pat_var uu____8379 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_wild uu____8380 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_dot_term uu____8381 ->
                      FStar_SMTEncoding_Util.mkTrue
                  | FStar_Syntax_Syntax.Pat_constant c ->
                      let uu____8389 = encode_const c env1  in
                ...
                let rec mk_projections pat1 scrutinee =
                  match pat1.FStar_Syntax_Syntax.v with
                  | FStar_Syntax_Syntax.Pat_dot_term (x,uu____8526) ->
                      [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_var x -> [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_wild x -> [(x, scrutinee)]
                  | FStar_Syntax_Syntax.Pat_constant uu____8557 -> []
                  | FStar_Syntax_Syntax.Pat_cons (f,args) ->
                      let uu____8582 =
                        FStar_All.pipe_right args
                          (FStar_List.mapi
                                  ...
                                  | (arg,uu____8644) ->
                                      ...
                                      let uu____8653 =
                                        FStar_SMTEncoding_Util.mkApp
                                          (proj, [scrutinee])
                                         in
                                      mk_projections arg uu____8653))
                         in
                      FStar_All.pipe_right uu____8582 FStar_List.flatten
                   in
                let pat_term1 uu____8684 = encode_term pat_term env1  in
                let pattern =
                  {
                    pat_vars = vars1;
                    pat_term = pat_term1;
      ...
      let uu____8694 =
        FStar_All.pipe_right l
          (FStar_List.fold_left
             (fun uu____8742  ->
                fun uu____8743  ->
                  match (uu____8742, uu____8743) with
                  | ((tms,decls),(t,uu____8783)) ->
                      let uu____8810 = encode_term t env  in
                      (match uu____8810 with
                       | (t1,decls') ->
                           ((t1 :: tms), (FStar_List.append decls decls'))))
             ([], []))
         in
      match uu____8694 with | (l1,decls) -> ((FStar_List.rev l1), decls)
  ...
  fun t  ->
    fun env  ->
      let universe_of_binders binders =
        FStar_List.map (fun uu____8888  -> FStar_Syntax_Syntax.U_zero)
          binders
         in
      let quant = FStar_Syntax_Util.smt_lemma_as_forall t universe_of_binders
         in
      let env1 =
        let uu___1241_8897 = env  in
        {
          FStar_SMTEncoding_Env.bvar_bindings =
            (uu___1241_8897.FStar_SMTEncoding_Env.bvar_bindings);
          FStar_SMTEncoding_Env.fvar_bindings =
            (uu___1241_8897.FStar_SMTEncoding_Env.fvar_bindings);
          FStar_SMTEncoding_Env.depth =
            (uu___1241_8897.FStar_SMTEncoding_Env.depth);
          FStar_SMTEncoding_Env.tcenv =
            (uu___1241_8897.FStar_SMTEncoding_Env.tcenv);
          FStar_SMTEncoding_Env.warn =
            (uu___1241_8897.FStar_SMTEncoding_Env.warn);
          FStar_SMTEncoding_Env.nolabels =
            (uu___1241_8897.FStar_SMTEncoding_Env.nolabels);
          FStar_SMTEncoding_Env.use_zfuel_name = true;
          FStar_SMTEncoding_Env.encode_non_total_function_typ =
            (uu___1241_8897.FStar_SMTEncoding_Env.encode_non_total_function_typ);
          FStar_SMTEncoding_Env.current_module_name =
            (uu___1241_8897.FStar_SMTEncoding_Env.current_module_name);
          FStar_SMTEncoding_Env.encoding_quantifier =
            (uu___1241_8897.FStar_SMTEncoding_Env.encoding_quantifier);
          FStar_SMTEncoding_Env.global_cache =
            (uu___1241_8897.FStar_SMTEncoding_Env.global_cache)
        }  in
  ...
  fun phi  ->
    fun env  ->
      let debug1 phi1 =
        ...
        if uu____9390
        then
          let uu____9395 = FStar_Syntax_Print.tag_of_term phi1  in
          let uu____9397 = FStar_Syntax_Print.term_to_string phi1  in
          FStar_Util.print2 "Formula (%s)  %s\n" uu____9395 uu____9397
        else ()  in
      let enc f r l =
        let uu____9439 =
          FStar_Util.fold_map
        ...
        | (decls,args) ->
            let uu____9502 =
              let uu___1310_9503 = f args  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___1310_9503.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___1310_9503.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              }  in
            (uu____9502, decls)
         in
      let const_op f r uu____9538 = let uu____9551 = f r  in (uu____9551, [])
         in
      let un_op f l =
        let uu____9574 = FStar_List.hd l  in FStar_All.pipe_left f uu____9574
         in
      let bin_op f uu___2_9594 =
        match uu___2_9594 with
        | t1::t2::[] -> f (t1, t2)
        | uu____9605 -> failwith "Impossible"  in
      let enc_prop_c f r l =
          ...
          FStar_Util.fold_map
            (fun decls  ->
               fun uu____9671  ->
                 ...
                 | (t,uu____9687) ->
                     let uu____9692 = encode_formula t env  in
        ...
        | (decls,phis) ->
            let uu____9721 =
              let uu___1340_9722 = f phis  in
              {
                FStar_SMTEncoding_Term.tm =
                  (uu___1340_9722.FStar_SMTEncoding_Term.tm);
                FStar_SMTEncoding_Term.freevars =
                  (uu___1340_9722.FStar_SMTEncoding_Term.freevars);
                FStar_SMTEncoding_Term.rng = r
              }  in
            (uu____9721, decls)
         in
      let eq_op r args =
          ...
          FStar_List.filter
            (fun uu____9785  ->
               ...
               | (a,q) ->
                   (match q with
                    | FStar_Pervasives_Native.Some
                        (FStar_Syntax_Syntax.Implicit uu____9806) -> false
                    | uu____9809 -> true)) args
           in
        ...
        then
          ...
          (let uu____9845 = enc (bin_op FStar_SMTEncoding_Util.mkEq)  in
           uu____9845 r rf)
         in
      let eq3_op r args =
          ...
          let uu____9913 =
            enc
              (fun terms  ->
                 ...
                 | t0::t1::v0::v1::[] ->
                     let uu____9945 =
                       let uu____9950 = FStar_SMTEncoding_Util.mkEq (t0, t1)
                          in
                       let uu____9951 = FStar_SMTEncoding_Util.mkEq (v0, v1)
                          in
                       (uu____9950, uu____9951)  in
                     FStar_SMTEncoding_Util.mkAnd uu____9945
                 | uu____9952 -> failwith "Impossible")
             in
          uu____9913 r args
        else
          (let uu____9958 =
      ...
      let h_equals_op r args =
        ...
        then
          let uu____10020 =
            enc
              (fun terms  ->
                 ...
                 | t0::v0::t1::v1::[] ->
                     let uu____10052 =
                       let uu____10057 = FStar_SMTEncoding_Util.mkEq (t0, t1)
                          in
                       let uu____10058 = FStar_SMTEncoding_Util.mkEq (v0, v1)
                          in
                       (uu____10057, uu____10058)  in
                     FStar_SMTEncoding_Util.mkAnd uu____10052
                 | uu____10059 -> failwith "Impossible")
             in
          uu____10020 r args
        else
          (let uu____10065 =
         ...
         in
      let mk_imp1 r uu___3_10094 =
        match uu___3_10094 with
        | (lhs,uu____10100)::(rhs,uu____10102)::[] ->
            let uu____10143 = encode_formula rhs env  in
            (match uu____10143 with
             | (l1,decls1) ->
                 (match l1.FStar_SMTEncoding_Term.tm with
                  | FStar_SMTEncoding_Term.App
                      (FStar_SMTEncoding_Term.TrueOp ,uu____10158) ->
                      (l1, decls1)
                  | uu____10163 ->
                      let uu____10164 = encode_formula lhs env  in
                      (match uu____10164 with
                       | (l2,decls2) ->
                           let uu____10175 =
                             FStar_SMTEncoding_Term.mkImp (l2, l1) r  in
                           (uu____10175, (FStar_List.append decls1 decls2)))))
        | uu____10176 -> failwith "impossible"  in
      let mk_ite r uu___4_10204 =
        match uu___4_10204 with
        | (guard,uu____10210)::(_then,uu____10212)::(_else,uu____10214)::[]
            ->
            let uu____10271 = encode_formula guard env  in
            (match uu____10271 with
             | (g,decls1) ->
                 let uu____10282 = encode_formula _then env  in
                 (match uu____10282 with
                  | (t,decls2) ->
                      let uu____10293 = encode_formula _else env  in
        ...
        | uu____10305 -> failwith "impossible"  in
      let unboxInt_l f l =
        let uu____10335 = FStar_List.map FStar_SMTEncoding_Term.unboxInt l
           in
        f uu____10335  in
      let connectives =
        let uu____10365 =
          let uu____10390 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkAnd)
             in
          (FStar_Parser_Const.and_lid, uu____10390)  in
        let uu____10433 =
          let uu____10460 =
            let uu____10485 = enc_prop_c (bin_op FStar_SMTEncoding_Util.mkOr)
               in
            (FStar_Parser_Const.or_lid, uu____10485)  in
          let uu____10528 =
            let uu____10555 =
              let uu____10582 =
                let uu____10607 =
                  enc_prop_c (bin_op FStar_SMTEncoding_Util.mkIff)  in
                (FStar_Parser_Const.iff_lid, uu____10607)  in
              let uu____10650 =
                let uu____10677 =
                  let uu____10704 =
                    let uu____10729 =
                      enc_prop_c (un_op FStar_SMTEncoding_Util.mkNot)  in
                    (FStar_Parser_Const.not_lid, uu____10729)  in
                  [uu____10704;
                  ...
                  (FStar_Parser_Const.false_lid,
                   ...
                   in
                (FStar_Parser_Const.ite_lid, mk_ite) :: uu____10677  in
              uu____10582 :: uu____10650  in
            (FStar_Parser_Const.imp_lid, mk_imp1) :: uu____10555  in
          uu____10460 :: uu____10528  in
        uu____10365 :: uu____10433  in
      let rec fallback phi1 =
        match phi1.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Tm_meta
            (phi',FStar_Syntax_Syntax.Meta_labeled (msg,r,b)) ->
            let uu____11274 = encode_formula phi' env  in
             ...
             | (phi2,decls) ->
                 let uu____11285 =
                   FStar_SMTEncoding_Term.mk
                    ...
                    in
                 (uu____11285, decls))
        | FStar_Syntax_Syntax.Tm_meta uu____11287 ->
            let uu____11294 = FStar_Syntax_Util.unmeta phi1  in
            encode_formula uu____11294 env
        | FStar_Syntax_Syntax.Tm_match (e,pats) ->
            let uu____11333 =
              encode_match e pats FStar_SMTEncoding_Util.mkFalse env
                encode_formula
               in
            (match uu____11333 with | (t,decls) -> (t, decls))
        | FStar_Syntax_Syntax.Tm_let
            ((false
              ,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inl x;
                 FStar_Syntax_Syntax.lbunivs = uu____11345;
                 FStar_Syntax_Syntax.lbtyp = t1;
                 FStar_Syntax_Syntax.lbeff = uu____11347;
                 FStar_Syntax_Syntax.lbdef = e1;
                 FStar_Syntax_Syntax.lbattrs = uu____11349;
                 FStar_Syntax_Syntax.lbpos = uu____11350;_}::[]),e2)
            ->
            let uu____11377 = encode_let x t1 e1 e2 env encode_formula  in
            (match uu____11377 with | (t,decls) -> (t, decls))
        | FStar_Syntax_Syntax.Tm_app (head1,args) ->
            let head2 = FStar_Syntax_Util.un_uinst head1  in
            (match ((head2.FStar_Syntax_Syntax.n), args) with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,uu____11430::(x,uu____11432)::(t,uu____11434)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.has_type_lid
                 ->
                 let uu____11501 = encode_term x env  in
                 (match uu____11501 with
                  | (x1,decls) ->
                      let uu____11512 = encode_term t env  in
                      (match uu____11512 with
                       | (t1,decls') ->
                           let uu____11523 =
                             FStar_SMTEncoding_Term.mk_HasType x1 t1  in
                           (uu____11523, (FStar_List.append decls decls'))))
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(r,uu____11526)::(msg,uu____11528)::(phi2,uu____11530)::[])
                 when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                 ...
                 let uu____11597 =
                   let uu____11602 =
                     let uu____11603 = FStar_Syntax_Subst.compress r  in
                     uu____11603.FStar_Syntax_Syntax.n  in
                   let uu____11606 =
                     let uu____11607 = FStar_Syntax_Subst.compress msg  in
                     uu____11607.FStar_Syntax_Syntax.n  in
                   (uu____11602, uu____11606)  in
                 (match uu____11597 with
                  | (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_range
                     r1),FStar_Syntax_Syntax.Tm_constant
                     (FStar_Const.Const_string (s,uu____11616))) ->
                      let phi3 =
                        FStar_Syntax_Syntax.mk
                         ...
                         in
                      fallback phi3
                  | uu____11627 -> fallback phi2)
             | (FStar_Syntax_Syntax.Tm_fvar fv,(t,uu____11634)::[]) when
                 (FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             | uu____11669 when head_redex env head2 ->
                 let uu____11684 = whnf env phi1  in
                 encode_formula uu____11684 env
             | uu____11685 ->
                 let uu____11700 = encode_term phi1 env  in
                        ...
                        let uu____11712 =
                          ...
                          let uu____11715 =
                            FStar_Range.use_range
                             ...
                             in
                          FStar_Range.rng_included uu____11714 uu____11715
                           in
                        if uu____11712
                        then tt
                        else
                          (let uu___1527_11719 = tt  in
                           {
                             FStar_SMTEncoding_Term.tm =
                               (uu___1527_11719.FStar_SMTEncoding_Term.tm);
                             FStar_SMTEncoding_Term.freevars =
                               (uu___1527_11719.FStar_SMTEncoding_Term.freevars);
                             FStar_SMTEncoding_Term.rng =
                               (phi1.FStar_Syntax_Syntax.pos)
                           })
                         in
                      let uu____11720 = FStar_SMTEncoding_Term.mk_Valid tt1
                         in
                      (uu____11720, decls)))
        | uu____11721 ->
            let uu____11722 = encode_term phi1 env  in
             ...
             | (tt,decls) ->
                 let tt1 =
                   let uu____11734 =
                     ...
                     FStar_Range.rng_included uu____11736 uu____11737  in
                   if uu____11734
                   then tt
                   else
                     (let uu___1535_11741 = tt  in
                      {
                        FStar_SMTEncoding_Term.tm =
                          (uu___1535_11741.FStar_SMTEncoding_Term.tm);
                        FStar_SMTEncoding_Term.freevars =
                          (uu___1535_11741.FStar_SMTEncoding_Term.freevars);
                        FStar_SMTEncoding_Term.rng =
                          (phi1.FStar_Syntax_Syntax.pos)
                      })
                    in
                 let uu____11742 = FStar_SMTEncoding_Term.mk_Valid tt1  in
                 (uu____11742, decls))
         in
      let encode_q_body env1 bs ps body =
        let uu____11786 = encode_binders FStar_Pervasives_Native.None bs env1
           in
        match uu____11786 with
        | (vars,guards,env2,decls,uu____11825) ->
            let uu____11838 = encode_smt_patterns ps env2  in
            (match uu____11838 with
             | (pats,decls') ->
                 let uu____11875 = encode_formula body env2  in
                  ...
                  | (body1,decls'') ->
                      let guards1 =
                        ...
                        | ({
                             ...
                             FStar_SMTEncoding_Term.freevars = uu____11907;
                             FStar_SMTEncoding_Term.rng = uu____11908;_}::[])::[]
                            when
                            let uu____11928 =
                              FStar_Ident.text_of_lid
                               ...
                               in
                            uu____11928 = gf -> []
                        | uu____11931 -> guards  in
                      let uu____11936 =
                        FStar_SMTEncoding_Util.mk_and_l guards1  in
                      (vars, pats, uu____11936, body1,
                        (FStar_List.append decls
                           (FStar_List.append decls' decls'')))))
         in
      debug1 phi;
      (let phi1 = FStar_Syntax_Util.unascribe phi  in
       let uu____11947 = FStar_Syntax_Util.destruct_typ_as_formula phi1  in
             ...
             FStar_All.pipe_right connectives
               (FStar_List.tryFind
                  (fun uu____12062  ->
                     ...
                     | (l,uu____12087) -> FStar_Ident.lid_equals op l))
              in
           (match uu____11956 with
            | FStar_Pervasives_Native.None  -> fallback phi1
            | FStar_Pervasives_Native.Some (uu____12156,f) ->
                f phi1.FStar_Syntax_Syntax.pos arms)
       | FStar_Pervasives_Native.Some (FStar_Syntax_Util.QAll
           (vars,np,pats,body)) ->
           (FStar_All.pipe_right pats
              (FStar_List.iter (check_pattern_vars env vars));
            (let uu____12251 = encode_q_body env vars pats body  in
             ...
             | (vars1,pats1,guard,body1,decls) ->
                 let tm =
                   let uu____12296 =
                     ...
                     (pats1, vars1, uu____12307)  in
                   FStar_SMTEncoding_Term.mkForall
                     phi1.FStar_Syntax_Syntax.pos uu____12296
                    in
                 (tm, decls)))
       | FStar_Pervasives_Native.Some (FStar_Syntax_Util.QEx
           ...
           (FStar_All.pipe_right pats
              (FStar_List.iter (check_pattern_vars env vars));
            (let uu____12341 = encode_q_body env vars pats body  in
             ...
             | (vars1,pats1,guard,body1,decls) ->
                 let uu____12385 =
                   let uu____12386 =
                     ...
                     (pats1, vars1, uu____12397)  in
                   FStar_SMTEncoding_Term.mkExists
                     phi1.FStar_Syntax_Syntax.pos uu____12386
                    in
                 (uu____12385, decls))))
