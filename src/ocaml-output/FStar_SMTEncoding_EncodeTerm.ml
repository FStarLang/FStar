          ...
          | (pats, vars, body) ->
              ...
              then fallback ()
                ...
                (let uu___3 =
                 ...
                 | (fsym, fterm) ->
                     let add_fuel tms =
                       FStar_Compiler_Effect.pipe_right tms
  ...
  fun env ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          ...
          FStar_Compiler_Effect.pipe_right uu___ FStar_Compiler_Option.isNone
    ...
    fun env ->
      ...
      | FStar_Const.Const_string (s, uu___) ->
          let uu___1 =
            ...
            FStar_Compiler_Effect.pipe_left FStar_SMTEncoding_Term.boxString
              uu___2 in
          (uu___1, [])
        ...
        | (arg_tms, decls) ->
            ...
            let mk_l box op mk_args ts =
              ...
              then
                ...
                FStar_Compiler_Effect.pipe_right uu___2 box
              else mk_default () in
                 ...
                 (match uu___4 with
                  | (arg_tms1, decls) ->
                      ...
                      let mk_bv op mk_args resBox ts =
                        ...
                        FStar_Compiler_Effect.pipe_right uu___5 resBox in
                      let bv_and =
                           ...
                           | (refinement, decls') ->
                               ...
                               (match uu___6 with
                                | (fsym, fterm) ->
                                    ...
                                    let cvars1 =
                                      FStar_Compiler_Effect.pipe_right cvars
                                        (FStar_Compiler_List.filter
                                           (fun y ->
                                              (let uu___7 =
                                                 FStar_SMTEncoding_Term.fv_name
       ...
       | FStar_Syntax_Syntax.Tm_uvar (uv, uu___1) ->
           ...
           (match uu___2 with
            | (t_has_k, decls) ->
                ...
                let uu___3 =
                  let uu___4 =
                    FStar_Compiler_Effect.pipe_right [d]
           ...
           (match uu___1 with
            | (bs1, body1, opening) ->
                ...
                let is_impure rc =
                  ...
                  FStar_Compiler_Effect.pipe_right uu___2 Prims.op_Negation in
                let codomain_eff rc =
                  let res_typ =
  ...
  fun phi ->
    fun env ->
      ...
      let un_op f l =
        ...
        FStar_Compiler_Effect.pipe_left f uu___ in
      let bin_op f uu___ =
        match uu___ with
        | t1::t2::[] -> f (t1, t2)
        | uu___1 -> failwith "Impossible" in
      ...
      (let phi1 = FStar_Syntax_Util.unascribe phi in
       ...
       | FStar_Pervasives_Native.Some (FStar_Syntax_Util.BaseConn (op, arms))
           ->
           let uu___2 =
             FStar_Compiler_Effect.pipe_right connectives
               (FStar_Compiler_List.tryFind
                  (fun uu___3 ->
                     match uu___3 with
