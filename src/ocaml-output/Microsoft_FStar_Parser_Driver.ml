...
let print_error = (fun ( msg ) ( r ) -> (let _65_20190 = (let _65_20189 = (Support.Microsoft.FStar.Range.string_of_range r)
in (Support.Microsoft.FStar.Util.format2 "ERROR %s: %s\n" _65_20189 msg))
in (Support.Microsoft.FStar.Util.print_string _65_20190)))
...
(let _65_20197 = (Microsoft_FStar_Parser_Desugar.desugar_decls env decls)
in (Support.Prims.pipe_left (fun ( _65_20196 ) -> Support.Microsoft.FStar.Util.Inr (_65_20196)) _65_20197))
end
...
| true -> begin
(let full_name = (let _65_20205 = (let _65_20204 = (let _65_20203 = (let _65_20202 = (Microsoft_FStar_Options.get_fstar_home ())
in (Support.String.strcat _65_20202 "/"))
in (Support.String.strcat _65_20203 Microsoft_FStar_Options.cache_dir))
in (Support.String.strcat _65_20204 "/"))
in (Support.String.strcat _65_20205 fn))
in (let m = (let _65_20206 = (Support.Microsoft.FStar.Util.get_oreader full_name)
in (Microsoft_FStar_Absyn_SSyntax.deserialize_modul _65_20206))
in (let _65_20207 = (Microsoft_FStar_Parser_Desugar.add_modul_to_env m env)
in (_65_20207, (m)::[]))))
end
| false -> begin
...
| Support.Microsoft.FStar.Util.Inr ((msg, r)) -> begin
(let _45_42 = (let _65_20208 = (Microsoft_FStar_Absyn_Print.format_error r msg)
in (Support.Prims.pipe_left Support.Microsoft.FStar.Util.print_string _65_20208))
in (exit (1)))
end)
end))
