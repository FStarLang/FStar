      ...
      fun pos_opt ->
        fun requested_info ->
          let info_of_lid_str lid_str =
            ...
            let uu____302 = FStar_TypeChecker_Env.try_lookup_lid tcenv lid1 in
          ...
          let def_of_lid lid =
            ...
            FStar_Util.bind_opt uu____411
              (fun uu___0_456 ->
                 ...
                 | uu____512 -> FStar_Pervasives_Native.None) in
          let info_at_pos_opt =
        ...
        let uu____824 =
          let uu____829 =
            let uu____830 =
              ...
              let uu____832 =
                let uu____834 = FStar_Interactive_CompletionTable.mod_name md in
                   ...
                   then l
                     ...
                     (let uu____1130 =
                        let uu____1134 = FStar_String.get s i in uu____1134
                          :: l in
                      exp (i - Prims.int_one) uu____1130) in
                 exp ((FStar_String.length s) - Prims.int_one) [] in
               let begin_col =
                 let uu____1142 =
                   let uu____1146 = explode str in FStar_List.rev uu____1146 in
