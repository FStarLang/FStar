              ...
              let unfolded_type_abbrevs =
                                ...
                                ((uu____260,
                                  {
                                    FStar_Syntax_Syntax.lbname =
                                      FStar_Util.Inr fv;
                                    FStar_Syntax_Syntax.lbunivs = uu____262;
                                    FStar_Syntax_Syntax.lbtyp = uu____263;
                                    FStar_Syntax_Syntax.lbeff = uu____264;
                                    FStar_Syntax_Syntax.lbdef = uu____265;
                                    FStar_Syntax_Syntax.lbattrs = uu____266;
                                    FStar_Syntax_Syntax.lbpos = uu____267;_}::[]),
                                 uu____268)
                                ->
                                let uu____291 =
                    ...
                    | FStar_Pervasives_Native.Some
                        {
                          FStar_Syntax_Syntax.sigel =
                            FStar_Syntax_Syntax.Sig_let
                            ((uu____400,
                              { FStar_Syntax_Syntax.lbname = uu____401;
                                FStar_Syntax_Syntax.lbunivs = uu____402;
                                FStar_Syntax_Syntax.lbtyp = uu____403;
                                FStar_Syntax_Syntax.lbeff = uu____404;
                                FStar_Syntax_Syntax.lbdef = tm;
                                FStar_Syntax_Syntax.lbattrs = uu____406;
                                FStar_Syntax_Syntax.lbpos = uu____407;_}::[]),
                             uu____408);
                ...
                and unfold_abbrev x =
                  ...
                  | FStar_Syntax_Syntax.Sig_let ((false, lb::[]), uu____575)
                      ...
                      ((let uu____606 =
                          let uu____609 = FStar_ST.op_Bang in_progress in lid
                            :: uu____609 in
              ...
              let filter_out_type_abbrevs l =
                FStar_List.filter
                  (fun lid ->
                     FStar_List.for_all
                       (fun lid' ->
                          let uu____1042 = FStar_Ident.lid_equals lid lid' in
                          Prims.op_Negation uu____1042) type_abbrevs) l in
                           ...
                           ((uu____1071,
                             {
                               FStar_Syntax_Syntax.lbname = FStar_Util.Inr
                                 fv';
                               FStar_Syntax_Syntax.lbunivs = uu____1073;
                               FStar_Syntax_Syntax.lbtyp = uu____1074;
                               FStar_Syntax_Syntax.lbeff = uu____1075;
                               FStar_Syntax_Syntax.lbdef = tm;
                               FStar_Syntax_Syntax.lbattrs = uu____1077;
                               FStar_Syntax_Syntax.lbpos = uu____1078;_}::[]),
                            uu____1079)
                           when
                           FStar_Ident.lid_equals
                             (fv'.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                             (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                           -> FStar_Pervasives_Native.Some tm
                       | uu____1104 -> FStar_Pervasives_Native.None) in
                let unfold_fv t fv =
