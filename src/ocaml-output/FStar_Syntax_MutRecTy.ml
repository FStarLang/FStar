                    ...
                    | FStar_Syntax_Syntax.Sig_let
                        ((false
                          ,{
                             ...
                             FStar_Syntax_Syntax.lbeff = uu____50;
                             FStar_Syntax_Syntax.lbdef = uu____51;_}::[]),uu____52,uu____53)
                        -> [x]
                    | FStar_Syntax_Syntax.Sig_let
                        (uu____80,uu____81,uu____82) ->
                        failwith
                        ...
                        | FStar_Syntax_Syntax.Sig_let
                            ((uu____117,{
                                          ...
                                          FStar_Syntax_Syntax.lbdef =
                                            uu____122;_}::[]),uu____123,uu____124)
                            ->
              ...
              let unfolded_type_abbrevs =
                ...
                let rec unfold_abbrev_fv t fv =
                  let replacee x =
                    ...
                    | uu____302 -> FStar_Pervasives_Native.None in
                  let replacee_term x =
                    ...
                    | FStar_Pervasives_Native.Some
                        {
                          ...
                          FStar_Syntax_Syntax.sigquals = uu____328;
                          FStar_Syntax_Syntax.sigmeta = uu____329;_}
                        -> FStar_Pervasives_Native.Some tm
                    | uu____366 -> FStar_Pervasives_Native.None in
                  let uu____373 =
                    let uu____380 = FStar_ST.read rev_unfolded_type_abbrevs in
                    FStar_Util.find_map uu____380 replacee_term in
                             ...
                             (match () with
                              | () ->
                                  ...
                                  let lb' =
                                    ...
                                    {
                                      FStar_Syntax_Syntax.lbname =
                                        (uu___179_493.FStar_Syntax_Syntax.lbname);
                                      FStar_Syntax_Syntax.lbunivs =
                                        (uu___179_493.FStar_Syntax_Syntax.lbunivs);
                                  ...
                                  ((let uu____508 =
                                      ...
                                      (let uu___180_518 = x in
                                       {
                                         FStar_Syntax_Syntax.sigel = sigelt';
                                         FStar_Syntax_Syntax.sigrng =
                                           (uu___180_518.FStar_Syntax_Syntax.sigrng);
                                         FStar_Syntax_Syntax.sigquals =
                                           quals1;
                                         FStar_Syntax_Syntax.sigmeta =
                                           (uu___180_518.FStar_Syntax_Syntax.sigmeta)
                                       }) :: uu____511 in
                ...
                let rec aux uu____544 =
                  let uu____545 = FStar_ST.read not_unfolded_yet in
                  match uu____545 with
                  | x::uu____555 -> let _unused = unfold_abbrev x in aux ()
                  | uu____559 ->
                      ...
                      [(let uu___182_732 = x in
                        {
                          ...
                          FStar_Syntax_Syntax.sigmeta =
                            (uu___182_732.FStar_Syntax_Syntax.sigmeta)
                        })]
                  | FStar_Syntax_Syntax.Sig_let
