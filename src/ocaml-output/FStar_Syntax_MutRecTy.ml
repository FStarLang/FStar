                            ...
                            ((uu____135,
                              {
                                FStar_Syntax_Syntax.lbname = FStar_Util.Inr
                                  fv;
                                FStar_Syntax_Syntax.lbunivs = uu____137;
                                FStar_Syntax_Syntax.lbtyp = uu____138;
                                FStar_Syntax_Syntax.lbeff = uu____139;
                                FStar_Syntax_Syntax.lbdef = uu____140;
                                FStar_Syntax_Syntax.lbattrs = uu____141;
                                FStar_Syntax_Syntax.lbpos = uu____142;_}::[]),
                             uu____143)
                            ->
              ...
              let unfolded_type_abbrevs =
                                ...
                                ((uu____258,
                                  {
                                    FStar_Syntax_Syntax.lbname =
                                      FStar_Util.Inr fv;
                                    FStar_Syntax_Syntax.lbunivs = uu____260;
                                    FStar_Syntax_Syntax.lbtyp = uu____261;
                                    FStar_Syntax_Syntax.lbeff = uu____262;
                                    FStar_Syntax_Syntax.lbdef = uu____263;
                                    FStar_Syntax_Syntax.lbattrs = uu____264;
                                    FStar_Syntax_Syntax.lbpos = uu____265;_}::[]),
                                 uu____266)
                                ->
                                let uu____283 =
                    ...
                    | FStar_Syntax_Syntax.Sig_let
                        ((uu____356,
                          { FStar_Syntax_Syntax.lbname = FStar_Util.Inr fv';
                            ...
                            FStar_Syntax_Syntax.lbpos = uu____363;_}::[]),
                         uu____364)
                        when
                    ...
                    | FStar_Pervasives_Native.Some
                        {
                          FStar_Syntax_Syntax.sigel =
                            FStar_Syntax_Syntax.Sig_let
                            ((uu____396,
                              { FStar_Syntax_Syntax.lbname = uu____397;
                                FStar_Syntax_Syntax.lbunivs = uu____398;
                                FStar_Syntax_Syntax.lbtyp = uu____399;
                                FStar_Syntax_Syntax.lbeff = uu____400;
                                FStar_Syntax_Syntax.lbdef = tm;
                                FStar_Syntax_Syntax.lbattrs = uu____402;
                                FStar_Syntax_Syntax.lbpos = uu____403;_}::[]),
                             uu____404);
                ...
                and unfold_abbrev x =
                  ...
                  | FStar_Syntax_Syntax.Sig_let ((false, lb::[]), uu____565)
                      ...
                      ((let uu____590 =
                          let uu____593 = FStar_ST.op_Bang in_progress in lid
                            :: uu____593 in
                            ...
                            (remove_not_unfolded lid;
                             (match () with
                              | () ->
                                  ...
                                  let lb' =
                                    let uu___97_690 = lb in
                                    {
                                      FStar_Syntax_Syntax.lbname =
                                        (uu___97_690.FStar_Syntax_Syntax.lbname);
                                      FStar_Syntax_Syntax.lbunivs =
                                        (uu___97_690.FStar_Syntax_Syntax.lbunivs);
                                      FStar_Syntax_Syntax.lbtyp = ty';
                                      FStar_Syntax_Syntax.lbeff =
                                        (uu___97_690.FStar_Syntax_Syntax.lbeff);
                                      FStar_Syntax_Syntax.lbdef = tm';
                                      FStar_Syntax_Syntax.lbattrs =
                                        (uu___97_690.FStar_Syntax_Syntax.lbattrs);
                                      FStar_Syntax_Syntax.lbpos =
                                        (uu___97_690.FStar_Syntax_Syntax.lbpos)
                                    } in
                                  let sigelt' =
                                    FStar_Syntax_Syntax.Sig_let
                                      ((false, [lb']), [lid]) in
                                  ((let uu____697 =
                                      ...
                                      (let uu___98_749 = x in
                                       {
                                         FStar_Syntax_Syntax.sigel = sigelt';
                                         FStar_Syntax_Syntax.sigrng =
                                           (uu___98_749.FStar_Syntax_Syntax.sigrng);
                                         FStar_Syntax_Syntax.sigquals =
                                           quals1;
                                         FStar_Syntax_Syntax.sigmeta =
                                           (uu___98_749.FStar_Syntax_Syntax.sigmeta);
                                         FStar_Syntax_Syntax.sigattrs =
                                           (uu___98_749.FStar_Syntax_Syntax.sigattrs)
                                       }) :: uu____700 in
              ...
              let filter_out_type_abbrevs l =
                FStar_List.filter
                  (fun lid ->
                     FStar_List.for_all
                       (fun lid' ->
                          let uu____1024 = FStar_Ident.lid_equals lid lid' in
                          Prims.op_Negation uu____1024) type_abbrevs) l in
              let inductives_with_abbrevs_unfolded =
                           ...
                           ((uu____1055,
                             {
                               FStar_Syntax_Syntax.lbname = FStar_Util.Inr
                                 fv';
                               FStar_Syntax_Syntax.lbunivs = uu____1057;
                               FStar_Syntax_Syntax.lbtyp = uu____1058;
                               FStar_Syntax_Syntax.lbeff = uu____1059;
                               FStar_Syntax_Syntax.lbdef = tm;
                               FStar_Syntax_Syntax.lbattrs = uu____1061;
                               FStar_Syntax_Syntax.lbpos = uu____1062;_}::[]),
                            uu____1063)
                           when
                           FStar_Ident.lid_equals
                             (fv'.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                             (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                           -> FStar_Pervasives_Native.Some tm
                       | uu____1082 -> FStar_Pervasives_Native.None) in
                let unfold_fv t fv =
                ...
                let unfold_in_sig x =
                  ...
                  | FStar_Syntax_Syntax.Sig_inductive_typ
                      ...
                      [(let uu___99_1141 = x in
                        {
                          FStar_Syntax_Syntax.sigel =
                            (FStar_Syntax_Syntax.Sig_inductive_typ
                               (lid, univs, bnd', ty', mut', dc));
                          FStar_Syntax_Syntax.sigrng =
                            (uu___99_1141.FStar_Syntax_Syntax.sigrng);
                          FStar_Syntax_Syntax.sigquals =
                            (uu___99_1141.FStar_Syntax_Syntax.sigquals);
                          FStar_Syntax_Syntax.sigmeta =
                            (uu___99_1141.FStar_Syntax_Syntax.sigmeta);
                          FStar_Syntax_Syntax.sigattrs =
                            (uu___99_1141.FStar_Syntax_Syntax.sigattrs)
                        })]
                  | FStar_Syntax_Syntax.Sig_datacon
                      (lid, univs, ty, res, npars, mut) ->
                      let ty' = FStar_Syntax_InstFV.inst unfold_fv ty in
                      let mut' = filter_out_type_abbrevs mut in
                      [(let uu___100_1161 = x in
                        {
                          FStar_Syntax_Syntax.sigel =
                            (FStar_Syntax_Syntax.Sig_datacon
                               (lid, univs, ty', res, npars, mut'));
                          FStar_Syntax_Syntax.sigrng =
                            (uu___100_1161.FStar_Syntax_Syntax.sigrng);
                          FStar_Syntax_Syntax.sigquals =
                            (uu___100_1161.FStar_Syntax_Syntax.sigquals);
                          FStar_Syntax_Syntax.sigmeta =
                            (uu___100_1161.FStar_Syntax_Syntax.sigmeta);
                          FStar_Syntax_Syntax.sigattrs =
                            (uu___100_1161.FStar_Syntax_Syntax.sigattrs)
                        })]
