...
let quals2 = (FStar_All.pipe_right quals1 (FStar_List.filter (fun uu___200_327 -> (match (uu___200_327) with
...
let uu___201_353 = lb
in {FStar_Syntax_Syntax.lbname = uu___201_353.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___201_353.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = ty'; FStar_Syntax_Syntax.lbeff = uu___201_353.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = tm'})
in (
...
let uu___202_370 = x
in {FStar_Syntax_Syntax.sigel = sigelt'; FStar_Syntax_Syntax.sigrng = uu___202_370.FStar_Syntax_Syntax.sigrng}))::uu____365)
...
let uu___203_512 = x
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((lid), (univs1), (bnd'), (ty'), (mut'), (dc), (quals1))); FStar_Syntax_Syntax.sigrng = uu___203_512.FStar_Syntax_Syntax.sigrng}))::[])))
end
...
let uu___204_530 = x
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((lid), (univs1), (ty'), (res), (npars), (quals1), (mut'))); FStar_Syntax_Syntax.sigrng = uu___204_530.FStar_Syntax_Syntax.sigrng}))::[]))
end
