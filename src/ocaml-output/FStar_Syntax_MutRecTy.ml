...
let quals1 = (FStar_All.pipe_right x.FStar_Syntax_Syntax.sigquals (FStar_List.filter (fun uu___213_637 -> (match (uu___213_637) with
...
let uu___214_785 = lb
in {FStar_Syntax_Syntax.lbname = uu___214_785.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___214_785.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = ty'; FStar_Syntax_Syntax.lbeff = uu___214_785.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = tm'})
in (
...
let uu___215_869 = x
in {FStar_Syntax_Syntax.sigel = sigelt'; FStar_Syntax_Syntax.sigrng = uu___215_869.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals1; FStar_Syntax_Syntax.sigmeta = uu___215_869.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___215_869.FStar_Syntax_Syntax.sigattrs}))::uu____801)
...
let uu___216_1340 = x
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((lid), (univs1), (bnd'), (ty'), (mut'), (dc))); FStar_Syntax_Syntax.sigrng = uu___216_1340.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___216_1340.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___216_1340.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___216_1340.FStar_Syntax_Syntax.sigattrs}))::[])))
end
...
let uu___217_1360 = x
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((lid), (univs1), (ty'), (res), (npars), (mut'))); FStar_Syntax_Syntax.sigrng = uu___217_1360.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___217_1360.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___217_1360.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___217_1360.FStar_Syntax_Syntax.sigattrs}))::[]))
end
