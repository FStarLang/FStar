...
let quals1 = (FStar_All.pipe_right x.FStar_Syntax_Syntax.sigquals (FStar_List.filter (fun uu___211_509 -> (match (uu___211_509) with
...
let uu___212_593 = lb
in {FStar_Syntax_Syntax.lbname = uu___212_593.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___212_593.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = ty'; FStar_Syntax_Syntax.lbeff = uu___212_593.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = tm'})
in (
...
let uu___213_645 = x
in {FStar_Syntax_Syntax.sigel = sigelt'; FStar_Syntax_Syntax.sigrng = uu___213_645.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals1; FStar_Syntax_Syntax.sigmeta = uu___213_645.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___213_645.FStar_Syntax_Syntax.sigattrs}))::uu____609)
...
let uu___214_956 = x
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((lid), (univs1), (bnd'), (ty'), (mut'), (dc))); FStar_Syntax_Syntax.sigrng = uu___214_956.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___214_956.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___214_956.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___214_956.FStar_Syntax_Syntax.sigattrs}))::[])))
end
...
let uu___215_976 = x
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((lid), (univs1), (ty'), (res), (npars), (mut'))); FStar_Syntax_Syntax.sigrng = uu___215_976.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___215_976.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___215_976.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___215_976.FStar_Syntax_Syntax.sigattrs}))::[]))
end
