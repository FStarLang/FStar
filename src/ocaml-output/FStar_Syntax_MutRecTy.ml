                            ...
                            (remove_not_unfolded lid;
                             (match () with
                              | () ->
                                  ...
                                  let lb' =
                                    let uu___205_353 = lb in
                                    {
                                      FStar_Syntax_Syntax.lbname =
                                        (uu___205_353.FStar_Syntax_Syntax.lbname);
                                      FStar_Syntax_Syntax.lbunivs =
                                        (uu___205_353.FStar_Syntax_Syntax.lbunivs);
                                      FStar_Syntax_Syntax.lbtyp = ty';
                                      FStar_Syntax_Syntax.lbeff =
                                        (uu___205_353.FStar_Syntax_Syntax.lbeff);
                                  ...
                                  ((let uu____363 =
                                      ...
                                      (let uu___206_370 = x in
                                       {
                                         FStar_Syntax_Syntax.sigel = sigelt';
                                         FStar_Syntax_Syntax.sigrng =
                                           (uu___206_370.FStar_Syntax_Syntax.sigrng)
                                       }) :: uu____365 in
              ...
              let inductives_with_abbrevs_unfolded =
                ...
                let unfold_in_sig x =
                  ...
                  | FStar_Syntax_Syntax.Sig_inductive_typ
                      ...
                      [(let uu___207_512 = x in
                        {
                          FStar_Syntax_Syntax.sigel =
                            (FStar_Syntax_Syntax.Sig_inductive_typ
                               (lid, univs1, bnd', ty', mut', dc, quals1));
                          FStar_Syntax_Syntax.sigrng =
                            (uu___207_512.FStar_Syntax_Syntax.sigrng)
                        })]
                  | FStar_Syntax_Syntax.Sig_datacon
                      (lid,univs1,ty,res,npars,quals1,mut) ->
                      let ty' = FStar_Syntax_InstFV.inst unfold_fv ty in
                      let mut' = filter_out_type_abbrevs mut in
                      [(let uu___208_530 = x in
                        {
                          FStar_Syntax_Syntax.sigel =
                            (FStar_Syntax_Syntax.Sig_datacon
                               (lid, univs1, ty', res, npars, quals1, mut'));
                          FStar_Syntax_Syntax.sigrng =
                            (uu___208_530.FStar_Syntax_Syntax.sigrng)
                        })]
                  | FStar_Syntax_Syntax.Sig_let
