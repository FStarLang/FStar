...
let remove_not_unfolded = (fun lid -> (let _0_709 = (let _0_708 = (FStar_ST.read not_unfolded_yet)
in (FStar_All.pipe_right _0_708 (FStar_List.filter (fun uu___200_141 -> (match (uu___200_141) with
...
in (FStar_ST.write not_unfolded_yet _0_709)))
in (
...
let uu____265 = (let _0_710 = (FStar_ST.read rev_unfolded_type_abbrevs)
in (FStar_Util.find_map _0_710 replacee_term))
...
let uu____284 = (let _0_711 = (FStar_ST.read in_progress)
in (FStar_List.existsb (fun x -> (FStar_Ident.lid_equals x fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)) _0_711))
...
in ((let _0_713 = (let _0_712 = (FStar_ST.read in_progress)
in (lid)::_0_712)
in (FStar_ST.write in_progress _0_713));
(match (()) with
| () -> begin
...
in ((let _0_715 = (let _0_714 = (FStar_ST.read rev_unfolded_type_abbrevs)
in (sigelt')::_0_714)
in (FStar_ST.write rev_unfolded_type_abbrevs _0_715));
(match (()) with
| () -> begin
((let _0_716 = (FStar_List.tl (FStar_ST.read in_progress))
in (FStar_ST.write in_progress _0_716));
(match (()) with
| () -> begin
tm'
end);
