...
let remove_not_unfolded = (fun lid -> (let _0_720 = (let _0_719 = (FStar_ST.read not_unfolded_yet)
in (FStar_All.pipe_right _0_719 (FStar_List.filter (fun uu___201_141 -> (match (uu___201_141) with
...
in (FStar_ST.write not_unfolded_yet _0_720)))
in (
...
let uu____265 = (let _0_721 = (FStar_ST.read rev_unfolded_type_abbrevs)
in (FStar_Util.find_map _0_721 replacee_term))
...
let uu____284 = (let _0_722 = (FStar_ST.read in_progress)
in (FStar_List.existsb (fun x -> (FStar_Ident.lid_equals x fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)) _0_722))
...
in ((let _0_724 = (let _0_723 = (FStar_ST.read in_progress)
in (lid)::_0_723)
in (FStar_ST.write in_progress _0_724));
(match (()) with
| () -> begin
...
in ((let _0_726 = (let _0_725 = (FStar_ST.read rev_unfolded_type_abbrevs)
in (sigelt')::_0_725)
in (FStar_ST.write rev_unfolded_type_abbrevs _0_726));
(match (()) with
| () -> begin
((let _0_727 = (FStar_List.tl (FStar_ST.read in_progress))
in (FStar_ST.write in_progress _0_727));
(match (()) with
| () -> begin
tm'
end);
