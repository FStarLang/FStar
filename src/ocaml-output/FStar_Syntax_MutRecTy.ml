...
let quals1 = (FStar_All.pipe_right x.FStar_Syntax_Syntax.sigquals (FStar_List.filter (fun uu___95_580 -> (match (uu___95_580) with
...
let uu___96_690 = lb
in {FStar_Syntax_Syntax.lbname = uu___96_690.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___96_690.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = ty'; FStar_Syntax_Syntax.lbeff = uu___96_690.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = tm'; FStar_Syntax_Syntax.lbattrs = uu___96_690.FStar_Syntax_Syntax.lbattrs; FStar_Syntax_Syntax.lbpos = uu___96_690.FStar_Syntax_Syntax.lbpos})
in (
...
let uu___97_749 = x
in {FStar_Syntax_Syntax.sigel = sigelt'; FStar_Syntax_Syntax.sigrng = uu___97_749.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals1; FStar_Syntax_Syntax.sigmeta = uu___97_749.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___97_749.FStar_Syntax_Syntax.sigattrs}))::uu____700)
...
let uu___98_1141 = x
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((lid), (univs), (bnd'), (ty'), (mut'), (dc))); FStar_Syntax_Syntax.sigrng = uu___98_1141.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___98_1141.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___98_1141.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___98_1141.FStar_Syntax_Syntax.sigattrs}))::[])))
end
...
let uu___99_1161 = x
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((lid), (univs), (ty'), (res), (npars), (mut'))); FStar_Syntax_Syntax.sigrng = uu___99_1161.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___99_1161.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___99_1161.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___99_1161.FStar_Syntax_Syntax.sigattrs}))::[]))
end
