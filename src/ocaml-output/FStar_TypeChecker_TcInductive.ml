...
let uu___87_566 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((c), ([]), (t1), (tc_lid), (ntps), ([]))); FStar_Syntax_Syntax.sigrng = uu___87_566.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___87_566.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___87_566.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___87_566.FStar_Syntax_Syntax.sigattrs})), (g))));
)
end));
)
end))
...
let uu___89_950 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((tc), (uvs1), (tps1), (t3), (mutuals), (datas1))); FStar_Syntax_Syntax.sigrng = uu___89_950.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___89_950.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___89_950.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___89_950.FStar_Syntax_Syntax.sigattrs})
end)))
end
| uu____958 -> begin
(failwith "Impossible")
...
let tc_insts = (FStar_All.pipe_right tcs1 (FStar_List.map (fun uu___82_990 -> (match (uu___82_990) with
| {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (tc, uu____995, uu____996, uu____997, uu____998, uu____999); FStar_Syntax_Syntax.sigrng = uu____1000; FStar_Syntax_Syntax.sigquals = uu____1001; FStar_Syntax_Syntax.sigmeta = uu____1002; FStar_Syntax_Syntax.sigattrs = uu____1003} -> begin
((tc), (uvs_universes))
end
| uu____1011 -> begin
(failwith "Impossible")
end))))
in (FStar_List.map2 (fun uu____1029 d -> (match (uu____1029) with
| (t3, uu____1034) -> begin
(match (d.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (l, uu____1036, uu____1037, tc, ntps, mutuals) -> begin
(

let ty = (

let uu____1044 = (FStar_Syntax_InstFV.instantiate tc_insts t3.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right uu____1044 (FStar_Syntax_Subst.close_univ_vars uvs1)))
in (

let uu___90_1045 = d
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((l), (uvs1), (ty), (tc), (ntps), (mutuals))); FStar_Syntax_Syntax.sigrng = uu___90_1045.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___90_1045.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___90_1045.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___90_1045.FStar_Syntax_Syntax.sigattrs}))
end
| uu____1047 -> begin
(failwith "Impossible")
end)
...
let uu____1058 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Positivity")))
...
let uu____1068 = (FStar_Syntax_Free.fvars t)
in (FStar_Util.set_mem ty_lid uu____1068)))
...
let uu____1079 = (FStar_Syntax_Subst.compress t)
in uu____1079.FStar_Syntax_Syntax.n)
...
let uu____1121 = (FStar_ST.read unfolded)
in (FStar_List.existsML (fun uu____1136 -> (match (uu____1136) with
| (lid, l) -> begin
((FStar_Ident.lid_equals lid ilid) && (

let args = (

let uu____1157 = (FStar_List.splitAt (FStar_List.length l) arrghs)
in (FStar_Pervasives_Native.fst uu____1157))
...
let uu____1258 = (FStar_Syntax_Print.term_to_string btype)
in (Prims.strcat "Checking strict positivity in type: " uu____1258))
in (debug_log env uu____1257));
(
...
let uu____1262 = (FStar_Syntax_Print.term_to_string btype1)
in (Prims.strcat "Checking strict positivity in type, after normalization: " uu____1262))
in (debug_log env uu____1261));
((

let uu____1265 = (ty_occurs_in ty_lid btype1)
in (not (uu____1265))) || ((debug_log env "ty does occur in this type, pressing ahead");
(

let uu____1275 = (

let uu____1276 = (FStar_Syntax_Subst.compress btype1)
in uu____1276.FStar_Syntax_Syntax.n)
in (match (uu____1275) with
| FStar_Syntax_Syntax.Tm_app (t, args) -> begin
(

let uu____1295 = (try_get_fv t)
...
(FStar_List.for_all (fun uu____1307 -> (match (uu____1307) with
| (t1, uu____1311) -> begin
(

let uu____1312 = (ty_occurs_in ty_lid t1)
in (not (uu____1312)))
end)) args);
)
end
...
let uu____1329 = (FStar_Syntax_Util.is_pure_or_ghost_comp c)
in (not (uu____1329)))
...
((FStar_List.for_all (fun uu____1339 -> (match (uu____1339) with
| (b, uu____1343) -> begin
(

let uu____1344 = (ty_occurs_in ty_lid b.FStar_Syntax_Syntax.sort)
in (not (uu____1344)))
end)) sbs) && (

let uu____1349 = (FStar_Syntax_Subst.open_term sbs (FStar_Syntax_Util.comp_result c))
in (match (uu____1349) with
| (uu____1352, return_type) -> begin
(

let uu____1354 = (FStar_TypeChecker_Env.push_binders env sbs)
in (ty_strictly_positive_in_type ty_lid return_type unfolded uu____1354))
end)));
)
end));
)
end
| FStar_Syntax_Syntax.Tm_fvar (uu____1355) -> begin
...
| FStar_Syntax_Syntax.Tm_uinst (t, uu____1360) -> begin
...
| FStar_Syntax_Syntax.Tm_refine (bv, uu____1367) -> begin
...
| FStar_Syntax_Syntax.Tm_match (uu____1373, branches) -> begin
((debug_log env "Checking strict positivity in an Tm_match, recur in the branches)");
(FStar_List.for_all (fun uu____1415 -> (match (uu____1415) with
| (p, uu____1423, t) -> begin
(

let bs = (

let uu____1433 = (FStar_Syntax_Syntax.pat_bvs p)
in (FStar_List.map FStar_Syntax_Syntax.mk_binder uu____1433))
in (

let uu____1435 = (FStar_Syntax_Subst.open_term bs t)
in (match (uu____1435) with
| (bs1, t1) -> begin
(

let uu____1440 = (FStar_TypeChecker_Env.push_binders env bs1)
in (ty_strictly_positive_in_type ty_lid t1 unfolded uu____1440))
end)))
end)) branches);
)
end
| FStar_Syntax_Syntax.Tm_ascribed (t, uu____1442, uu____1443) -> begin
...
let uu____1477 = (FStar_Syntax_Print.tag_of_term btype1)
in (

let uu____1478 = (

let uu____1479 = (FStar_Syntax_Print.term_to_string btype1)
in (Prims.strcat " and term: " uu____1479))
in (Prims.strcat uu____1477 uu____1478)))
in (Prims.strcat "Checking strict positivity, unexpected tag: " uu____1476))
in (debug_log env uu____1475));
false;
)
end));
));
...
let uu____1490 = (FStar_Syntax_Print.args_to_string args)
in (Prims.strcat " applied to arguments: " uu____1490))
in (Prims.strcat ilid.FStar_Ident.str uu____1489))
in (Prims.strcat "Checking nested positivity in the inductive " uu____1488))
in (debug_log env uu____1487));
(

let uu____1491 = (FStar_TypeChecker_Env.datacons_of_typ env ilid)
...
let uu____1501 = (already_unfolded ilid args unfolded env)
...
let uu____1508 = (FStar_Util.string_of_int num_ibs)
in (Prims.strcat uu____1508 ", also adding to the memo table"))
in (Prims.strcat "Checking nested positivity, number of type parameters is " uu____1507))
in (debug_log env uu____1506));
(

let uu____1510 = (

let uu____1511 = (FStar_ST.read unfolded)
in (
...
let uu____1533 = (FStar_List.splitAt num_ibs args)
in (FStar_Pervasives_Native.fst uu____1533))
in ((ilid), (uu____1527)))
in (uu____1519)::[])
in (FStar_List.append uu____1511 uu____1515)))
in (FStar_ST.write unfolded uu____1510));
...
let uu____1592 = (FStar_TypeChecker_Env.lookup_datacon env dlid)
...
let uu____1612 = (FStar_Syntax_Print.term_to_string dt1)
in (Prims.strcat "Checking nested positivity in the data constructor type: " uu____1612))
in (debug_log env uu____1611));
(

let uu____1613 = (

let uu____1614 = (FStar_Syntax_Subst.compress dt1)
in uu____1614.FStar_Syntax_Syntax.n)
...
let uu____1630 = (FStar_List.splitAt num_ibs dbs)
...
in (FStar_Syntax_Subst.subst_binders uu____1657 dbs1))
in (

let c1 = (

let uu____1660 = (FStar_Syntax_Subst.opening_of_binders ibs1)
in (FStar_Syntax_Subst.subst_comp uu____1660 c))
in (

let uu____1662 = (FStar_List.splitAt num_ibs args)
in (match (uu____1662) with
| (args1, uu____1680) -> begin
(
...
let uu____1729 = (FStar_Syntax_Subst.shift_subst (FStar_List.length dbs3) subst1)
in (FStar_Syntax_Subst.subst_comp uu____1729 c1))
in ((
...
let uu____1742 = (FStar_Syntax_Print.binders_to_string "; " dbs3)
in (

let uu____1743 = (

let uu____1744 = (FStar_Syntax_Print.comp_to_string c2)
in (Prims.strcat ", and c: " uu____1744))
in (Prims.strcat uu____1742 uu____1743)))
in (Prims.strcat "Checking nested positivity in the unfolded data constructor binders as: " uu____1741))
...
let uu____1748 = (FStar_Syntax_Subst.compress dt1)
in uu____1748.FStar_Syntax_Syntax.n)
in (ty_nested_positive_in_type ty_lid uu____1747 ilid num_ibs unfolded env));
)
end));
));
)
...
let uu____1794 = (FStar_Syntax_Print.binders_to_string "; " sbs)
in (Prims.strcat "Checking nested positivity in an Tm_arrow node, with binders as: " uu____1794))
...
let uu____1796 = (FStar_List.fold_left (fun uu____1807 b -> (match (uu____1807) with
| (r, env1) -> begin
(match ((not (r))) with
| true -> begin
((r), (env1))
...
let uu____1820 = (ty_strictly_positive_in_type ty_lid (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort unfolded env1)
in (
...
let uu____1853 = (FStar_TypeChecker_Env.lookup_datacon env dlid)
...
let uu____1872 = (FStar_Syntax_Print.term_to_string dt)
in (Prims.strcat "Checking data constructor type: " uu____1872))
in (debug_log env uu____1871));
(

let uu____1873 = (

let uu____1874 = (FStar_Syntax_Subst.compress dt)
in uu____1874.FStar_Syntax_Syntax.n)
in (match (uu____1873) with
| FStar_Syntax_Syntax.Tm_fvar (uu____1877) -> begin
((debug_log env "Data constructor type is simply an fvar, returning true");
true;
)
end
| FStar_Syntax_Syntax.Tm_arrow (dbs, uu____1880) -> begin
(

let dbs1 = (

let uu____1895 = (FStar_List.splitAt (FStar_List.length ty_bs) dbs)
in (FStar_Pervasives_Native.snd uu____1895))
in (

let dbs2 = (

let uu____1919 = (FStar_Syntax_Subst.opening_of_binders ty_bs)
in (FStar_Syntax_Subst.subst_binders uu____1919 dbs1))
in (
...
let uu____1925 = (FStar_Util.string_of_int (FStar_List.length dbs3))
in (Prims.strcat uu____1925 " binders"))
in (Prims.strcat "Data constructor type is an arrow type, so checking strict positivity in " uu____1924))
in (debug_log env uu____1923));
(

let uu____1934 = (FStar_List.fold_left (fun uu____1945 b -> (match (uu____1945) with
| (r, env1) -> begin
(match ((not (r))) with
| true -> begin
((r), (env1))
...
let uu____1958 = (ty_strictly_positive_in_type ty_lid (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort unfolded env1)
in (

let uu____1959 = (FStar_TypeChecker_Env.push_binders env1 ((b)::[]))
in ((uu____1958), (uu____1959))))
end)
end)) ((true), (env)) dbs3)
...
| FStar_Syntax_Syntax.Tm_app (uu____1966, uu____1967) -> begin
...
let uu____2003 = (match (ty.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, us, bs, uu____2013, uu____2014, uu____2015) -> begin
((lid), (us), (bs))
end
| uu____2020 -> begin
(failwith "Impossible!")
...
let uu____2027 = (FStar_Syntax_Subst.univ_var_opening ty_us)
...
let uu____2044 = (FStar_TypeChecker_Env.datacons_of_typ env2 ty_lid)
in (FStar_Pervasives_Native.snd uu____2044))
in (FStar_List.for_all (fun d -> (

let uu____2052 = (FStar_List.map (fun s -> FStar_Syntax_Syntax.U_name (s)) ty_us1)
in (ty_positive_in_datacon ty_lid d ty_bs2 uu____2052 unfolded_inductives env2))) uu____2042))))))
end))
end))))


let datacon_typ : FStar_Syntax_Syntax.sigelt  ->  FStar_Syntax_Syntax.term = (fun data -> (match (data.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (uu____2061, uu____2062, t, uu____2064, uu____2065, uu____2066) -> begin
t
end
| uu____2069 -> begin
(failwith "Impossible!")
...
let uu____2091 = (FStar_Syntax_Subst.compress dt1)
in uu____2091.FStar_Syntax_Syntax.n)
in (match (uu____2090) with
| FStar_Syntax_Syntax.Tm_arrow (dbs, uu____2095) -> begin
(

let dbs1 = (

let uu____2110 = (FStar_List.splitAt (FStar_List.length bs) dbs)
in (FStar_Pervasives_Native.snd uu____2110))
in (

let dbs2 = (

let uu____2134 = (FStar_Syntax_Subst.opening_of_binders bs)
in (FStar_Syntax_Subst.subst_binders uu____2134 dbs1))
in (
...
let uu____2150 = (FStar_Syntax_Syntax.as_arg (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort)
in (uu____2150)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq uu____2149))
in (uu____2148 FStar_Pervasives_Native.None FStar_Range.dummyRange))
in (
...
let uu____2157 = (FStar_Util.format1 "Failed to prove that the type \'%s\' supports decidable equality because of this argument; add either the \'noeq\' or \'unopteq\' qualifier" ty_lid.FStar_Ident.str)
in (FStar_TypeChecker_Util.label uu____2157 sort_range haseq_b))
...
let uu____2169 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((FStar_Pervasives_Native.fst b)), (FStar_Pervasives_Native.None)))::[]) uu____2169 FStar_Pervasives_Native.None))
in (FStar_Syntax_Syntax.as_arg uu____2168))
in (uu____2167)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____2166))
in (uu____2165 FStar_Pervasives_Native.None FStar_Range.dummyRange))) dbs3 cond)))))
end
| uu____2181 -> begin
...
let uu____2247 = (match (ty.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, uu____2259, bs, t, uu____2262, d_lids) -> begin
((lid), (bs), (t), (d_lids))
end
| uu____2269 -> begin
(failwith "Impossible!")
...
let uu____2294 = (FStar_Syntax_Subst.shift_subst (FStar_List.length bs1) usubst)
in (FStar_Syntax_Subst.subst uu____2294 t))
in (

let uu____2304 = (FStar_Syntax_Subst.open_term bs1 t1)
...
let uu____2325 = (FStar_Syntax_Subst.compress t2)
in uu____2325.FStar_Syntax_Syntax.n)
in (match (uu____2324) with
| FStar_Syntax_Syntax.Tm_arrow (ibs, uu____2332) -> begin
ibs
end
| uu____2343 -> begin
[]
...
let uu____2348 = (FStar_Syntax_Syntax.fvar lid FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None)
in (

let uu____2349 = (FStar_List.map (fun u -> FStar_Syntax_Syntax.U_name (u)) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____2348 uu____2349)))
in (
...
let uu____2356 = (FStar_List.map (fun uu____2365 -> (match (uu____2365) with
| (bv, aq) -> begin
(

let uu____2372 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((uu____2372), (aq)))
end)) bs2)
in (FStar_Syntax_Syntax.mk_Tm_app ind uu____2356))
in (uu____2355 FStar_Pervasives_Native.None FStar_Range.dummyRange))
in (
...
let uu____2381 = (FStar_List.map (fun uu____2390 -> (match (uu____2390) with
| (bv, aq) -> begin
(

let uu____2397 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((uu____2397), (aq)))
end)) ibs1)
in (FStar_Syntax_Syntax.mk_Tm_app ind1 uu____2381))
in (uu____2380 FStar_Pervasives_Native.None FStar_Range.dummyRange))
in (
...
let uu____2407 = (FStar_Syntax_Syntax.as_arg ind2)
in (uu____2407)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq uu____2406))
in (uu____2405 FStar_Pervasives_Native.None FStar_Range.dummyRange))
in (
...
| (uu____2436, en, uu____2438, uu____2439) -> begin
(
...
let uu____2449 = (FStar_Syntax_Util.type_u ())
in (FStar_Pervasives_Native.fst uu____2449))
in (FStar_TypeChecker_Rel.try_subtype' en (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort uu____2448 false))
in (match (opt) with
| FStar_Pervasives_Native.None -> begin
false
end
| FStar_Pervasives_Native.Some (uu____2452) -> begin
true
end))
end))) bs2)
in (
...
let uu____2463 = (FStar_Syntax_Syntax.bv_to_name (FStar_Pervasives_Native.fst b))
in (FStar_Syntax_Syntax.as_arg uu____2463))
in (uu____2462)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq uu____2461))
in (uu____2460 FStar_Pervasives_Native.None FStar_Range.dummyRange))
in (FStar_Syntax_Util.mk_conj t3 uu____2459))) FStar_Syntax_Util.t_true bs')
in (
...
let uu____2489 = (FStar_Syntax_Syntax.as_arg haseq_ind)
in (uu____2489)::[])
in (uu____2487)::[])
in FStar_Syntax_Syntax.Meta_pattern (uu____2480))
in ((fml), (uu____2479)))
in FStar_Syntax_Syntax.Tm_meta (uu____2474))
in {FStar_Syntax_Syntax.n = uu____2473; FStar_Syntax_Syntax.tk = uu___91_2472.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___91_2472.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___91_2472.FStar_Syntax_Syntax.vars}))
in (
...
let uu____2508 = (FStar_Syntax_Subst.close ((b)::[]) t3)
in (FStar_Syntax_Util.abs (((((FStar_Pervasives_Native.fst b)), (FStar_Pervasives_Native.None)))::[]) uu____2508 FStar_Pervasives_Native.None))
in (FStar_Syntax_Syntax.as_arg uu____2507))
in (uu____2506)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____2505))
in (uu____2504 FStar_Pervasives_Native.None FStar_Range.dummyRange))) ibs1 fml1)
in (
...
let uu____2532 = (FStar_Syntax_Subst.close ((b)::[]) t3)
in (FStar_Syntax_Util.abs (((((FStar_Pervasives_Native.fst b)), (FStar_Pervasives_Native.None)))::[]) uu____2532 FStar_Pervasives_Native.None))
in (FStar_Syntax_Syntax.as_arg uu____2531))
in (uu____2530)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____2529))
in (uu____2528 FStar_Pervasives_Native.None FStar_Range.dummyRange))) bs2 fml2)
in (
...
| FStar_Syntax_Syntax.Sig_datacon (uu____2588, uu____2589, uu____2590, t_lid, uu____2592, uu____2593) -> begin
(t_lid = lid)
end
| uu____2596 -> begin
(failwith "Impossible")
...
let uu____2603 = (optimized_haseq_soundness_for_data lid d usubst bs2)
in (FStar_Syntax_Util.mk_conj acc1 uu____2603))) FStar_Syntax_Util.t_true t_datas)
in (

let axiom_lid = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns (((FStar_Ident.id_of_text (Prims.strcat lid.FStar_Ident.ident.FStar_Ident.idText "_haseq")))::[])))
in (

let uu____2605 = (FStar_Syntax_Util.mk_conj guard' guard)
in (

let uu____2608 = (FStar_Syntax_Util.mk_conj cond' cond)
in (((FStar_List.append l_axioms ((((axiom_lid), (fml3)))::[]))), (env2), (uu____2605), (uu____2608)))))))))
end)))))))))))))))
end))))
end)))
...
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____2679, us, uu____2681, uu____2682, uu____2683, uu____2684) -> begin
us
end
| uu____2689 -> begin
(failwith "Impossible!")
...
let uu____2690 = (FStar_Syntax_Subst.univ_var_opening us)
...
let uu____2706 = (FStar_List.fold_left (optimized_haseq_ty datas usubst us1) (([]), (env1), (FStar_Syntax_Util.t_true), (FStar_Syntax_Util.t_true)) tcs)
...
let uu____2738 = (FStar_TypeChecker_TcTerm.tc_trivial_guard env2 phi)
in (match (uu____2738) with
| (phi1, uu____2743) -> begin
((

let uu____2745 = (FStar_TypeChecker_Env.should_verify env2)
in (match (uu____2745) with
| true -> begin
(

let uu____2746 = (FStar_TypeChecker_Rel.guard_of_guard_formula (FStar_TypeChecker_Common.NonTrivial (phi1)))
in (FStar_TypeChecker_Rel.force_trivial_guard env2 uu____2746))
end
| uu____2747 -> begin
()
end));
...
let ses = (FStar_List.fold_left (fun l uu____2759 -> (match (uu____2759) with
| (lid, fml) -> begin
(
...
| FStar_Syntax_Syntax.Tm_uinst (t', uu____2816) -> begin
(is_mutual t')
end
...
let uu____2845 = (FStar_List.map FStar_Pervasives_Native.fst args)
in (exists_mutual uu____2845))
end))
end
| FStar_Syntax_Syntax.Tm_meta (t', uu____2858) -> begin
(is_mutual t')
end
| uu____2863 -> begin
false
end)))
and exists_mutual = (fun uu___83_2864 -> (match (uu___83_2864) with
| [] -> begin
false
end
| (hd1)::tl1 -> begin
...
let uu____2882 = (FStar_Syntax_Subst.compress dt1)
in uu____2882.FStar_Syntax_Syntax.n)
in (match (uu____2881) with
| FStar_Syntax_Syntax.Tm_arrow (dbs, uu____2888) -> begin
(

let dbs1 = (

let uu____2903 = (FStar_List.splitAt (FStar_List.length bs) dbs)
in (FStar_Pervasives_Native.snd uu____2903))
in (

let dbs2 = (

let uu____2927 = (FStar_Syntax_Subst.opening_of_binders bs)
in (FStar_Syntax_Subst.subst_binders uu____2927 dbs1))
in (
...
let uu____2946 = (FStar_Syntax_Syntax.as_arg (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort)
in (uu____2946)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq uu____2945))
in (uu____2944 FStar_Pervasives_Native.None FStar_Range.dummyRange))
in (

let haseq_sort1 = (

let uu____2952 = (is_mutual sort)
...
let uu____2966 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((FStar_Pervasives_Native.fst b)), (FStar_Pervasives_Native.None)))::[]) uu____2966 FStar_Pervasives_Native.None))
in (FStar_Syntax_Syntax.as_arg uu____2965))
in (uu____2964)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____2963))
in (uu____2962 FStar_Pervasives_Native.None FStar_Range.dummyRange))) dbs3 cond)
...
let uu____3028 = (match (ty.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, uu____3040, bs, t, uu____3043, d_lids) -> begin
((lid), (bs), (t), (d_lids))
end
| uu____3050 -> begin
(failwith "Impossible!")
...
let uu____3066 = (FStar_Syntax_Subst.shift_subst (FStar_List.length bs1) usubst)
in (FStar_Syntax_Subst.subst uu____3066 t))
in (

let uu____3076 = (FStar_Syntax_Subst.open_term bs1 t1)
...
let uu____3088 = (FStar_Syntax_Subst.compress t2)
in uu____3088.FStar_Syntax_Syntax.n)
in (match (uu____3087) with
| FStar_Syntax_Syntax.Tm_arrow (ibs, uu____3095) -> begin
ibs
end
| uu____3106 -> begin
[]
...
let uu____3111 = (FStar_Syntax_Syntax.fvar lid FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None)
in (

let uu____3112 = (FStar_List.map (fun u -> FStar_Syntax_Syntax.U_name (u)) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____3111 uu____3112)))
in (
...
let uu____3119 = (FStar_List.map (fun uu____3128 -> (match (uu____3128) with
| (bv, aq) -> begin
(

let uu____3135 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((uu____3135), (aq)))
end)) bs2)
in (FStar_Syntax_Syntax.mk_Tm_app ind uu____3119))
in (uu____3118 FStar_Pervasives_Native.None FStar_Range.dummyRange))
in (
...
let uu____3144 = (FStar_List.map (fun uu____3153 -> (match (uu____3153) with
| (bv, aq) -> begin
(

let uu____3160 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((uu____3160), (aq)))
end)) ibs1)
in (FStar_Syntax_Syntax.mk_Tm_app ind1 uu____3144))
in (uu____3143 FStar_Pervasives_Native.None FStar_Range.dummyRange))
in (
...
let uu____3170 = (FStar_Syntax_Syntax.as_arg ind2)
in (uu____3170)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq uu____3169))
in (uu____3168 FStar_Pervasives_Native.None FStar_Range.dummyRange))
in (

let t_datas = (FStar_List.filter (fun s -> (match (s.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (uu____3185, uu____3186, uu____3187, t_lid, uu____3189, uu____3190) -> begin
(t_lid = lid)
end
| uu____3193 -> begin
(failwith "Impossible")
...
let uu____3216 = (FStar_Syntax_Syntax.as_arg haseq_ind)
in (uu____3216)::[])
in (uu____3214)::[])
in FStar_Syntax_Syntax.Meta_pattern (uu____3207))
in ((fml), (uu____3206)))
in FStar_Syntax_Syntax.Tm_meta (uu____3201))
in {FStar_Syntax_Syntax.n = uu____3200; FStar_Syntax_Syntax.tk = uu___92_3199.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___92_3199.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___92_3199.FStar_Syntax_Syntax.vars}))
in (
...
let uu____3235 = (FStar_Syntax_Subst.close ((b)::[]) t3)
in (FStar_Syntax_Util.abs (((((FStar_Pervasives_Native.fst b)), (FStar_Pervasives_Native.None)))::[]) uu____3235 FStar_Pervasives_Native.None))
in (FStar_Syntax_Syntax.as_arg uu____3234))
in (uu____3233)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____3232))
in (uu____3231 FStar_Pervasives_Native.None FStar_Range.dummyRange))) ibs1 fml1)
in (
...
let uu____3259 = (FStar_Syntax_Subst.close ((b)::[]) t3)
in (FStar_Syntax_Util.abs (((((FStar_Pervasives_Native.fst b)), (FStar_Pervasives_Native.None)))::[]) uu____3259 FStar_Pervasives_Native.None))
in (FStar_Syntax_Syntax.as_arg uu____3258))
in (uu____3257)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____3256))
in (uu____3255 FStar_Pervasives_Native.None FStar_Range.dummyRange))) bs2 fml2)
...
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, uu____3335, uu____3336, uu____3337, uu____3338, uu____3339) -> begin
lid
end
| uu____3344 -> begin
(failwith "Impossible!")
...
let ty = (FStar_List.hd tcs)
in (match (ty.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, us, uu____3353, uu____3354, uu____3355, uu____3356) -> begin
((lid), (us))
end
| uu____3361 -> begin
(failwith "Impossible!")
...
let uu____3367 = (FStar_Syntax_Subst.univ_var_opening us)
...
let uu____3385 = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns (((FStar_Ident.id_of_text (Prims.strcat lid.FStar_Ident.ident.FStar_Ident.idText "_haseq")))::[])))
in (tc_assume env1 uu____3385 fml [] FStar_Range.dummyRange))
...
let uu____3419 = (FStar_All.pipe_right ses (FStar_List.partition (fun uu___84_3435 -> (match (uu___84_3435) with
| {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (uu____3436); FStar_Syntax_Syntax.sigrng = uu____3437; FStar_Syntax_Syntax.sigquals = uu____3438; FStar_Syntax_Syntax.sigmeta = uu____3439; FStar_Syntax_Syntax.sigattrs = uu____3440} -> begin
true
end
| uu____3451 -> begin
false
...
let uu____3464 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun uu___85_3472 -> (match (uu___85_3472) with
| {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (uu____3473); FStar_Syntax_Syntax.sigrng = uu____3474; FStar_Syntax_Syntax.sigquals = uu____3475; FStar_Syntax_Syntax.sigmeta = uu____3476; FStar_Syntax_Syntax.sigattrs = uu____3477} -> begin
false
end
| uu____3487 -> begin
true
...
let uu____3492 = (FStar_TypeChecker_Env.get_range env)
in (("Mutually defined type contains a non-inductive element"), (uu____3492)))
in FStar_Errors.Error (uu____3489))
in (FStar_Pervasives.raise uu____3488))
end
| uu____3493 -> begin
()
end));
...
let uu____3495 = (FStar_List.fold_right (fun tc uu____3522 -> (match (uu____3522) with
| (env1, all_tcs, g) -> begin
(

let uu____3544 = (tc_tycon env1 tc)
...
let uu____3561 = (FStar_TypeChecker_Env.debug env2 FStar_Options.Low)
in (match (uu____3561) with
| true -> begin
(

let uu____3562 = (FStar_Syntax_Print.sigelt_to_string tc1)
...
let uu____3565 = (FStar_TypeChecker_Rel.conj_guard guard g')
in (FStar_TypeChecker_Rel.conj_guard g uu____3565))
in ((env2), ((((tc1), (tc_u)))::all_tcs), (uu____3564)));
))
end))
...
let uu____3590 = (FStar_List.fold_right (fun se uu____3606 -> (match (uu____3606) with
| (datas1, g1) -> begin
(

let uu____3617 = (

let uu____3620 = (tc_data env1 tcs)
in (uu____3620 se))
in (match (uu____3617) with
| (data, g') -> begin
(

let uu____3630 = (FStar_TypeChecker_Rel.conj_guard g1 g')
in (((data)::datas1), (uu____3630)))
end))
end)) datas (([]), (g)))
...
let uu____3642 = (generalize_and_inst_within env0 g1 tcs datas1)
...
let uu____3659 = (FStar_TypeChecker_Env.get_range env0)
in (

let uu____3660 = (FStar_List.collect (fun s -> s.FStar_Syntax_Syntax.sigattrs) ses)
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_bundle ((((FStar_List.append tcs1 datas2)), (lids))); FStar_Syntax_Syntax.sigrng = uu____3659; FStar_Syntax_Syntax.sigquals = quals; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = uu____3660}))
