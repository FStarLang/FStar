             ...
             let uu____2263 =
               let uu____2264 =
                 let uu____2269 =
                   let uu____2270 =
                     let uu____2277 =
                       let uu____2279 = FStar_Syntax_Syntax.as_arg haseq_ind
                          in
                       [uu____2279]  in
                     [uu____2277]  in
                  ...
                  fun t3  ->
                    let uu____2293 =
                      let uu____2294 =
                        let uu____2295 =
                          let uu____2296 =
                            let uu____2297 = FStar_Syntax_Subst.close [b] t3
                               in
                            FStar_Syntax_Util.abs [((fst b), None)]
                              uu____2297 None
                             in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2294
                       in
                    uu____2293 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2319 =
                      let uu____2320 =
                        let uu____2321 =
                          let uu____2322 =
                            let uu____2323 = FStar_Syntax_Subst.close [b] t3
                               in
                            FStar_Syntax_Util.abs [((fst b), None)]
                              uu____2323 None
                             in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2320
                       in
                    uu____2319 None FStar_Range.dummyRange) bs2 fml2
              in
            ...
            fun data  ->
              ...
              | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____2663) ->
                  let dbs1 =
                    ...
                    snd uu____2678  in
                  let dbs2 =
                    let uu____2700 = FStar_Syntax_Subst.opening_of_binders bs
                       in
                           ...
                           let haseq_sort =
                             let uu____2712 =
                               let uu____2713 =
                                 ...
                                 [uu____2714]  in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____2713
                                in
                         ...
                         fun t  ->
                           let uu____2731 =
                             let uu____2732 =
                               ...
                               [uu____2733]  in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____2732
                              in
                           uu____2731 None FStar_Range.dummyRange) dbs3 cond
                     in
               ...
               let uu____2882 =
                 FStar_List.map
                   (fun uu____2887  ->
                      ...
                      | (bv,aq) ->
                          let uu____2894 = FStar_Syntax_Syntax.bv_to_name bv
                             in
                          (uu____2894, aq)) bs2
                  in
               ...
               let uu____2903 =
                 FStar_List.map
                   (fun uu____2908  ->
                      ...
                      | (bv,aq) ->
                          let uu____2915 = FStar_Syntax_Syntax.bv_to_name bv
                             in
                          (uu____2915, aq)) ibs1
                  in
             ...
             let uu____2952 =
               let uu____2953 =
                 let uu____2958 =
                   let uu____2959 =
                     let uu____2966 =
                       let uu____2968 = FStar_Syntax_Syntax.as_arg haseq_ind
                          in
                       [uu____2968]  in
                     [uu____2966]  in
                  ...
                  fun t3  ->
                    let uu____2982 =
                      let uu____2983 =
                        let uu____2984 =
                          let uu____2985 =
                            let uu____2986 = FStar_Syntax_Subst.close [b] t3
                               in
                            FStar_Syntax_Util.abs [((fst b), None)]
                              uu____2986 None
                             in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2983
                       in
                    uu____2982 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____3008 =
                      let uu____3009 =
                        let uu____3010 =
                          let uu____3011 =
                            let uu____3012 = FStar_Syntax_Subst.close [b] t3
                               in
                            FStar_Syntax_Util.abs [((fst b), None)]
                              uu____3012 None
                             in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3009
                       in
                    uu____3008 None FStar_Range.dummyRange) bs2 fml2
              in
              ...
              FStar_List.map
                (fun ty  ->
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       -> lid
                   | uu____3090 -> failwith "Impossible!") tcs
               in
            let uu____3091 =
              let ty = FStar_List.hd tcs  in
              match ty.FStar_Syntax_Syntax.sigel with
