               ...
               let uu____2153 =
                 FStar_List.map
                   (fun uu____2158  ->
                      ...
                      | (bv,aq) ->
                          let uu____2165 = FStar_Syntax_Syntax.bv_to_name bv in
                          (uu____2165, aq)) bs2 in
               ...
               let uu____2174 =
                 FStar_List.map
                   (fun uu____2179  ->
                      ...
                      | (bv,aq) ->
                          let uu____2186 = FStar_Syntax_Syntax.bv_to_name bv in
                          (uu____2186, aq)) ibs1 in
                  ...
                  | (uu____2218,en,uu____2220,uu____2221) ->
                      let opt =
                        ...
                        FStar_TypeChecker_Rel.try_subtype' en
                          (fst b).FStar_Syntax_Syntax.sort uu____2230 false in
                      (match opt with
                       | None  -> false
                       | Some uu____2234 -> true)) bs2 in
           let haseq_bs =
             FStar_List.fold_left
               (fun t3  ->
                  fun b  ->
                    let uu____2238 =
                      let uu____2239 =
                        let uu____2240 =
                          ...
                          [uu____2241] in
                        FStar_Syntax_Syntax.mk_Tm_app
                          FStar_Syntax_Util.t_haseq uu____2240 in
             ...
             let uu____2252 =
               let uu____2253 =
                 let uu____2258 =
                   let uu____2259 =
                     let uu____2266 =
                       let uu____2268 = FStar_Syntax_Syntax.as_arg haseq_ind in
                       [uu____2268] in
                     [uu____2266] in
                  ...
                  fun t3  ->
                    let uu____2280 =
                      let uu____2281 =
                        let uu____2282 =
                          let uu____2283 =
                            let uu____2284 = FStar_Syntax_Subst.close [b] t3 in
                            FStar_Syntax_Util.abs [((fst b), None)]
                              uu____2284 None in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2281 in
                    uu____2280 None FStar_Range.dummyRange) ibs1 fml1 in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
            ...
            fun data  ->
              ...
              | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____2638) ->
                  let dbs1 =
                    ...
                    snd uu____2653 in
                  let dbs2 =
                    let uu____2675 = FStar_Syntax_Subst.opening_of_binders bs in
                           ...
                           let haseq_sort =
                             let uu____2687 =
                               let uu____2688 =
                                 ...
                                 [uu____2689] in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____2688 in
                         ...
                         fun t  ->
                           let uu____2702 =
                             let uu____2703 =
                               ...
                               [uu____2704] in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____2703 in
                           uu____2702 None FStar_Range.dummyRange) dbs3 cond in
               ...
               let uu____2848 =
                 FStar_List.map
                   (fun uu____2853  ->
                      ...
                      | (bv,aq) ->
                          let uu____2860 = FStar_Syntax_Syntax.bv_to_name bv in
                          (uu____2860, aq)) bs2 in
               ...
               let uu____2869 =
                 FStar_List.map
                   (fun uu____2874  ->
                      ...
                      | (bv,aq) ->
                          let uu____2881 = FStar_Syntax_Syntax.bv_to_name bv in
                          (uu____2881, aq)) ibs1 in
             ...
             let uu____2914 =
               let uu____2915 =
                 let uu____2920 =
                   let uu____2921 =
                     let uu____2928 =
                       let uu____2930 = FStar_Syntax_Syntax.as_arg haseq_ind in
                       [uu____2930] in
                     [uu____2928] in
                  ...
                  fun t3  ->
                    let uu____2942 =
                      let uu____2943 =
                        let uu____2944 =
                          let uu____2945 =
                            let uu____2946 = FStar_Syntax_Subst.close [b] t3 in
                            FStar_Syntax_Util.abs [((fst b), None)]
                              uu____2946 None in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2943 in
                    uu____2942 None FStar_Range.dummyRange) ibs1 fml1 in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2963 =
                      let uu____2964 =
                        let uu____2965 =
                          let uu____2966 =
                            let uu____2967 = FStar_Syntax_Subst.close [b] t3 in
                            FStar_Syntax_Util.abs [((fst b), None)]
                              uu____2967 None in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2964 in
                    uu____2963 None FStar_Range.dummyRange) bs2 fml2 in
              ...
              FStar_List.map
                (fun ty  ->
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       -> lid
                   | uu____3040 -> failwith "Impossible!") tcs in
            let uu____3041 =
              let ty = FStar_List.hd tcs in
              match ty.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_inductive_typ
          ...
          | (tys,datas) ->
              ((let uu____3148 =
                ...
                then
                  let uu____3164 =
                    let uu____3165 =
                      let uu____3168 = FStar_TypeChecker_Env.get_range env in
