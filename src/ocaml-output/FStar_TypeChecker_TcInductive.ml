      ...
      fun tcs  ->
        fun datas  ->
          ...
          (let binders =
                         ...
                         (match se.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_inductive_typ
                              ...
                              let uu____611 =
                                ...
                                FStar_All.pipe_left
                                  (FStar_Syntax_Util.arrow tps) uu____612
                                 in
                              FStar_Syntax_Syntax.null_binder uu____611
                          | uu____619 -> failwith "Impossible")))
              in
           let binders' =
           ...
           (let uu____644 = FStar_TypeChecker_Util.generalize_universes env t
               in
            ...
            | (uvs,t1) ->
                ((let uu____654 =
                 ...
                 (let uu____664 = FStar_Syntax_Subst.open_univ_vars uvs t1
                     in
                                                    ...
                                                    let uu____771 =
                                                      let uu____772 =
                                                        FStar_Syntax_Subst.compress
                                                          ty
                                                         in
                                                      uu____772.FStar_Syntax_Syntax.n
                                                       in
                                                  ...
                                                  (match uu____763 with
                                                   | (tps1,t3) ->
                                                          ...
                                                          in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.sigquals
                                                           =
                                                           (uu___89_882.FStar_Syntax_Syntax.sigquals);
                                                         FStar_Syntax_Syntax.sigmeta
                                                           =
                                                           (uu___89_882.FStar_Syntax_Syntax.sigmeta)
                                                       })
                                              | uu____890 ->
                                                  failwith "Impossible"))
                                    tc_types tcs
                                                 ...
                                                 (match d.FStar_Syntax_Syntax.sigel
                                                  ...
                                                  | FStar_Syntax_Syntax.Sig_datacon
                                                      ...
                                                      let uu___90_952 = d  in
                                                      {
                                                        ...
                                                        FStar_Syntax_Syntax.sigrng
                                                          =
                                                          (uu___90_952.FStar_Syntax_Syntax.sigrng);
                                                        FStar_Syntax_Syntax.sigquals
                                                          =
                                                          (uu___90_952.FStar_Syntax_Syntax.sigquals);
                                                        FStar_Syntax_Syntax.sigmeta
                                                          =
                                                          (uu___90_952.FStar_Syntax_Syntax.sigmeta)
                                                      }
                                                  | uu____954 ->
                                                      failwith "Impossible"))
                                        data_types datas
      ...
      fun unfolded  ->
        fun env  ->
          (let uu____1146 =
             ...
             Prims.strcat "Checking strict positivity in type: " uu____1147
              in
                           ...
                           (debug_log env
                            ...
                            FStar_List.for_all
                              (fun uu____1186  ->
                                 ...
                                 | (t1,uu____1190) ->
                                     let uu____1191 = ty_occurs_in ty_lid t1
                                        in
          ...
          fun unfolded  ->
            fun env  ->
              (let uu____1355 =
                 let uu____1356 =
                   let uu____1357 =
                     let uu____1358 = FStar_Syntax_Print.args_to_string args
                        in
                   ...
                   | (univ_unif_vars,dt) ->
                       (FStar_List.iter2
                        ...
                        (let dt1 =
                         ...
                         (let uu____1476 =
                            let uu____1477 = FStar_Syntax_Subst.compress dt1
                               in
    ...
    fun dlid  ->
      fun ty_bs  ->
        fun us  ->
          fun unfolded  ->
            fun env  ->
              let uu____1704 = FStar_TypeChecker_Env.lookup_datacon env dlid
                 in
              ...
              | (univ_unif_vars,dt) ->
                  (FStar_List.iter2
                     ...
                     univ_unif_vars us;
                   (let uu____1718 =
                      let uu____1719 = FStar_Syntax_Print.term_to_string dt
                         in
                   ...
                   (let uu____1720 =
                    ...
                    | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____1727) ->
                        ...
                        let dbs2 =
                          ...
                          FStar_Syntax_Subst.subst_binders uu____1764 dbs1
                           in
                       ...
                       let haseq_b =
                         let uu____1969 =
                           ...
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____1970
                            in
                   ...
                   fun t  ->
                     let uu____1983 =
                       let uu____1984 =
                         let uu____1985 =
                           let uu____1986 =
                             let uu____1987 = FStar_Syntax_Subst.close [b] t
                                in
                         ...
                         [uu____1985]  in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____1984
                        in
  ...
  | (lid,bs,t,d_lids) ->
      ...
      (match uu____2117 with
       | (bs2,t2) ->
               ...
               let uu____2168 =
                 FStar_List.map
                   (fun uu____2173  ->
                      ...
                      | (bv,aq) ->
                          let uu____2180 = FStar_Syntax_Syntax.bv_to_name bv
                             in
                          (uu____2180, aq)) bs2
                  in
               ...
               let uu____2189 =
                 FStar_List.map
                   (fun uu____2194  ->
                      ...
                      | (bv,aq) ->
                          let uu____2201 = FStar_Syntax_Syntax.bv_to_name bv
                             in
                          (uu____2201, aq)) ibs1
                  in
                    ...
                    let uu____2253 =
                      let uu____2254 =
                        let uu____2255 =
                          ...
                          [uu____2256]  in
                        FStar_Syntax_Syntax.mk_Tm_app
                          FStar_Syntax_Util.t_haseq uu____2255
                         in
           ...
           let fml1 =
             let uu___91_2268 = fml  in
             let uu____2271 =
               let uu____2272 =
                 let uu____2277 =
                   let uu____2278 =
                     let uu____2285 =
                       let uu____2287 = FStar_Syntax_Syntax.as_arg haseq_ind
                          in
                       [uu____2287]  in
                     [uu____2285]  in
               ...
               FStar_Syntax_Syntax.Tm_meta uu____2272  in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___91_2268.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___91_2268.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___91_2268.FStar_Syntax_Syntax.vars)
             }  in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2301 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2302
                       in
                    uu____2301 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2327 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2328
                       in
                    uu____2327 None FStar_Range.dummyRange) bs2 fml2
              in
        ...
        fun mutuals  ->
          fun acc  ->
            fun data  ->
              ...
              and exists_mutual uu___83_2647 =
                match uu___83_2647 with
                | [] -> false
              ...
              | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____2671) ->
                  ...
                  let dbs2 =
                    let uu____2708 = FStar_Syntax_Subst.opening_of_binders bs
                       in
                           ...
                           let haseq_sort =
                             let uu____2720 =
                               let uu____2721 =
                                 ...
                                 [uu____2722]  in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____2721
                                in
                               ...
                               let uu____2741 =
                                 let uu____2742 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((Prims.fst b), None)] uu____2743 None
                                    in
                                 FStar_Syntax_Syntax.as_arg uu____2742  in
                               [uu____2741]  in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____2740
                              in
                           uu____2739 None FStar_Range.dummyRange) dbs3 cond
                     in
  ...
  | (lid,bs,t,d_lids) ->
      ...
      (match uu____2848 with
       | (bs2,t2) ->
               ...
               let uu____2890 =
                 FStar_List.map
                   (fun uu____2895  ->
                      ...
                      | (bv,aq) ->
                          let uu____2902 = FStar_Syntax_Syntax.bv_to_name bv
                             in
                          (uu____2902, aq)) bs2
                  in
               ...
               let uu____2911 =
                 FStar_List.map
                   (fun uu____2916  ->
                      ...
                      | (bv,aq) ->
                          let uu____2923 = FStar_Syntax_Syntax.bv_to_name bv
                             in
                          (uu____2923, aq)) ibs1
                  in
           ...
           let fml1 =
             let uu___92_2957 = fml  in
             let uu____2960 =
               let uu____2961 =
                 let uu____2966 =
                   let uu____2967 =
                     let uu____2974 =
                       let uu____2976 = FStar_Syntax_Syntax.as_arg haseq_ind
                          in
                       [uu____2976]  in
                     [uu____2974]  in
               ...
               FStar_Syntax_Syntax.Tm_meta uu____2961  in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___92_2957.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___92_2957.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___92_2957.FStar_Syntax_Syntax.vars)
             }  in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2990 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2991
                       in
                    uu____2990 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____3016 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3017
                       in
                    uu____3016 None FStar_Range.dummyRange) bs2 fml2
              in
              ...
              FStar_List.map
                (fun ty  ->
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       -> lid
                   | uu____3098 -> failwith "Impossible!") tcs
               in
            let uu____3099 =
              let ty = FStar_List.hd tcs  in
              match ty.FStar_Syntax_Syntax.sigel with
          ...
          | (tys,datas) ->
              ((let uu____3206 =
                ...
                then
                  let uu____3222 =
                    let uu____3223 =
                      let uu____3226 = FStar_TypeChecker_Env.get_range env
                         in
