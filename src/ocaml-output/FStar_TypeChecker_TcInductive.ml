                  ...
                  fun t3  ->
                    let uu____2329 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2330
                       in
                    uu____2329 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2355 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2356
                       in
                    uu____2355 None FStar_Range.dummyRange) bs2 fml2
              in
                           ...
                           let haseq_sort =
                             let uu____2752 =
                               let uu____2753 =
                                 ...
                                 [uu____2754]  in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____2753
                                in
                               ...
                               let uu____2769 =
                                 let uu____2770 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((Prims.fst b), None)] uu____2771 None
                                    in
                                 FStar_Syntax_Syntax.as_arg uu____2770  in
                               [uu____2769]  in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____2768
                              in
                           uu____2767 None FStar_Range.dummyRange) dbs3 cond
                     in
                  ...
                  fun t3  ->
                    let uu____3018 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3019
                       in
                    uu____3018 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
              ...
              FStar_List.map
                (fun ty  ->
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       -> lid
                   | uu____3129 -> failwith "Impossible!") tcs
               in
            let uu____3130 =
              let ty = FStar_List.hd tcs  in
              match ty.FStar_Syntax_Syntax.sigel with
