                                            ...
                                            (let uu___282_211 = s in
                                             {
                                               ...
                                               FStar_Syntax_Syntax.sigrng =
                                                 (uu___282_211.FStar_Syntax_Syntax.sigrng);
                                               FStar_Syntax_Syntax.sigquals =
                                                 (uu___282_211.FStar_Syntax_Syntax.sigquals);
                                               FStar_Syntax_Syntax.sigmeta =
                                                 (uu___282_211.FStar_Syntax_Syntax.sigmeta);
                                               FStar_Syntax_Syntax.sigattrs =
                                                 (uu___282_211.FStar_Syntax_Syntax.sigattrs)
                                             }), u, guard)))))))))
                                             ...
                                             FStar_Syntax_Syntax.sigel =
                                               (FStar_Syntax_Syntax.Sig_datacon
                                                  (c, [], t1, tc_lid, ntps,
                                                    []));
                                             FStar_Syntax_Syntax.sigrng =
                                               (uu___283_856.FStar_Syntax_Syntax.sigrng);
                                             FStar_Syntax_Syntax.sigquals =
                                               (uu___283_856.FStar_Syntax_Syntax.sigquals);
                                             FStar_Syntax_Syntax.sigmeta =
                                               (uu___283_856.FStar_Syntax_Syntax.sigmeta);
                                             FStar_Syntax_Syntax.sigattrs =
                                               (uu___283_856.FStar_Syntax_Syntax.sigattrs)
                                           }), g))))))))))
    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g1 =
            let uu___284_920 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___284_920.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___284_920.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (FStar_Pervasives_Native.snd
                     g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___284_920.FStar_TypeChecker_Env.implicits)
            } in
          (let uu____930 =
                                                  ...
                                                  (match uu____1238 with
                                                   | (tps1,t3) ->
                                                       let uu___285_1409 = se in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.sigrng
                                                           =
                                                           (uu___285_1409.FStar_Syntax_Syntax.sigrng);
                                                         FStar_Syntax_Syntax.sigquals
                                                           =
                                                           (uu___285_1409.FStar_Syntax_Syntax.sigquals);
                                                         FStar_Syntax_Syntax.sigmeta
                                                           =
                                                           (uu___285_1409.FStar_Syntax_Syntax.sigmeta);
                                                         FStar_Syntax_Syntax.sigattrs
                                                           =
                                                           (uu___285_1409.FStar_Syntax_Syntax.sigattrs)
                                                       })
                                              | uu____1422 ->
                                                  failwith "Impossible"))
                                    tc_types tcs in
                                                 ...
                                                 (match d.FStar_Syntax_Syntax.sigel
                                                  ...
                                                  | FStar_Syntax_Syntax.Sig_datacon
                                                      ...
                                                      let uu___286_1544 = d in
                                                      {
                                                        ...
                                                        FStar_Syntax_Syntax.sigrng
                                                          =
                                                          (uu___286_1544.FStar_Syntax_Syntax.sigrng);
                                                        FStar_Syntax_Syntax.sigquals
                                                          =
                                                          (uu___286_1544.FStar_Syntax_Syntax.sigquals);
                                                        FStar_Syntax_Syntax.sigmeta
                                                          =
                                                          (uu___286_1544.FStar_Syntax_Syntax.sigmeta);
                                                        FStar_Syntax_Syntax.sigattrs
                                                          =
                                                          (uu___286_1544.FStar_Syntax_Syntax.sigattrs)
                                                      }
                                                  | uu____1547 ->
                                                      failwith "Impossible"))
                                        data_types datas in
                   ...
                   | (univ_unif_vars,dt) ->
                       (FStar_List.iter2
                        ...
                        (let dt1 =
                         ...
                         (let uu____2619 =
                            let uu____2620 = FStar_Syntax_Subst.compress dt1 in
    ...
    fun dlid  ->
      fun ty_bs  ->
        fun us  ->
          fun unfolded  ->
            fun env  ->
              let uu____2999 = FStar_TypeChecker_Env.lookup_datacon env dlid in
              ...
              | (univ_unif_vars,dt) ->
                  (FStar_List.iter2
                     ...
                     univ_unif_vars us;
                   (let uu____3023 =
                      let uu____3024 = FStar_Syntax_Print.term_to_string dt in
                   ...
                   (let uu____3025 =
                    ...
                    | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____3032) ->
                        ...
                        let dbs2 =
                          ...
                          FStar_Syntax_Subst.subst_binders uu____3094 dbs1 in
                       ...
                       let haseq_b =
                         let uu____3442 =
                           ...
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____3443 in
                   ...
                   fun t  ->
                     let uu____3457 =
                       let uu____3458 =
                         let uu____3459 =
                           let uu____3460 =
                             let uu____3461 = FStar_Syntax_Subst.close [b] t in
                         ...
                         [uu____3459] in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____3458 in
                ...
                (match uu____3631 with
                 | (bs2,t2) ->
                     ...
                     let ind =
                       ...
                       FStar_Syntax_Syntax.mk_Tm_uinst uu____3698 uu____3699 in
                     let ind1 =
                       let uu____3705 =
                         let uu____3706 =
                           FStar_List.map
                     ...
                     let haseq_ind =
                       let uu____3767 =
                         let uu____3768 =
                           let uu____3769 = FStar_Syntax_Syntax.as_arg ind2 in
                           [uu____3769] in
                         FStar_Syntax_Syntax.mk_Tm_app
                           FStar_Syntax_Util.t_haseq uu____3768 in
                     ...
                     let fml1 =
                         ...
                         FStar_Syntax_Syntax.Tm_meta uu____3851 in
                       {
                         ...
                         FStar_Syntax_Syntax.pos =
                           (uu___287_3849.FStar_Syntax_Syntax.pos);
                         FStar_Syntax_Syntax.vars =
                           (uu___287_3849.FStar_Syntax_Syntax.vars)
                       } in
                     let fml2 =
                       FStar_List.fold_right
                         (fun b  ->
          ...
          fun acc  ->
            fun data  ->
              let rec is_mutual t =
                ...
                | uu____4348 -> false
              and exists_mutual uu___279_4349 =
                match uu___279_4349 with
                | [] -> false
                   ...
                   | (bs2,t2) ->
                       ...
                       let fml1 =
                           ...
                           FStar_Syntax_Syntax.Tm_meta uu____4750 in
                         {
                           ...
                           FStar_Syntax_Syntax.pos =
                             (uu___288_4748.FStar_Syntax_Syntax.pos);
                           FStar_Syntax_Syntax.vars =
                             (uu___288_4748.FStar_Syntax_Syntax.vars)
                         } in
                       let fml2 =
                         FStar_List.fold_right
                           (fun b  ->
