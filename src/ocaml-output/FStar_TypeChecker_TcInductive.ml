    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g1 =
            let uu___84_588 = g  in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___84_588.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___84_588.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (Prims.snd g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___84_588.FStar_TypeChecker_Env.implicits)
            }  in
          (let uu____594 =
                                                    ...
                                                    let uu____793 =
                                                      let uu____794 =
                                                        FStar_Syntax_Subst.compress
                                                          ty
                                                         in
                                                      uu____794.FStar_Syntax_Syntax.n
                                                       in
            ...
            fun env  ->
              ...
              | FStar_Syntax_Syntax.Tm_app (t1,args) ->
                  (debug_log env
                   ...
                   (let uu____1647 = try_get_fv t1  in
                   ...
                   (let uu____1735 =
                    ...
                    | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____1742) ->
                        ...
                        let dbs2 =
                          ...
                          FStar_Syntax_Subst.subst_binders uu____1779 dbs1
                           in
                 ...
                 (fun d  ->
                    let uu____1905 =
                      FStar_List.map (fun s  -> FStar_Syntax_Syntax.U_name s)
                        ty_us1
                       in
                    ty_positive_in_datacon ty_lid d ty_bs2 uu____1905
                      unfolded_inductives env2) uu____1897)
    ...
    fun data  ->
      fun usubst  ->
        fun bs  ->
          ...
          let uu____1941 =
            let uu____1942 = FStar_Syntax_Subst.compress dt1  in
          ...
          | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____1946) ->
              ...
              let dbs2 =
                ...
                FStar_Syntax_Subst.subst_binders uu____1983 dbs1  in
              let dbs3 = FStar_Syntax_Subst.open_binders dbs2  in
              let cond =
                FStar_List.fold_left
                  (fun t  ->
                       ...
                       let haseq_b =
                         let uu____1992 =
                           ...
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____1993
                            in
                   ...
                   fun t  ->
                     let uu____2006 =
                       let uu____2007 =
                         ...
                         [uu____2008]  in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____2007
                        in
                     uu____2006 None FStar_Range.dummyRange) dbs3 cond
...
let optimized_haseq_ty all_datas_in_the_bundle usubst us acc ty =
  ...
  | (lid,bs,t,d_lids) ->
      ...
      let uu____2144 = FStar_Syntax_Subst.open_term bs1 t1  in
      (match uu____2144 with
       | (bs2,t2) ->
           let ibs =
             let uu____2164 =
               let uu____2165 = FStar_Syntax_Subst.compress t2  in
                 ...
                 FStar_List.map
                   (fun uu____2221  ->
                      ...
                      | (bv,aq) ->
                          ...
                          (uu____2228, aq)) ibs1
                  in
               FStar_Syntax_Syntax.mk_Tm_app ind1 uu____2216  in
             uu____2215 None FStar_Range.dummyRange  in
           let haseq_ind =
             let uu____2236 =
               let uu____2237 =
                 let uu____2238 = FStar_Syntax_Syntax.as_arg ind2  in
                 [uu____2238]  in
                    ...
                    let uu____2280 =
                      let uu____2281 =
                        let uu____2282 =
                          ...
                          [uu____2283]  in
                        FStar_Syntax_Syntax.mk_Tm_app
                          FStar_Syntax_Util.t_haseq uu____2282
                         in
                      uu____2281 None FStar_Range.dummyRange  in
                    FStar_Syntax_Util.mk_conj t3 uu____2280)
               FStar_Syntax_Util.t_true bs'
              in
           let fml = FStar_Syntax_Util.mk_imp haseq_bs haseq_ind  in
           let fml1 =
             let uu___85_2293 = fml  in
             let uu____2294 =
               let uu____2295 =
                 let uu____2300 =
                   let uu____2301 =
               ...
               FStar_Syntax_Syntax.Tm_meta uu____2295  in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___85_2293.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___85_2293.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___85_2293.FStar_Syntax_Syntax.vars)
             }  in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2322 =
                      let uu____2323 =
                        let uu____2324 =
                          let uu____2325 =
                            let uu____2326 = FStar_Syntax_Subst.close [b] t3
                               in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              uu____2326 None
                             in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2323
                       in
                    uu____2322 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2348 =
                      let uu____2349 =
                        let uu____2350 =
                          let uu____2351 =
                            let uu____2352 = FStar_Syntax_Subst.close [b] t3
                               in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              uu____2352 None
                             in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2349
                       in
                    uu____2348 None FStar_Range.dummyRange) bs2 fml2
              in
        ...
        fun mutuals  ->
          fun acc  ->
            fun data  ->
              ...
              and exists_mutual uu___81_2674 =
                match uu___81_2674 with
                | [] -> false
              ...
              let dt1 = FStar_Syntax_Subst.subst usubst dt  in
              let uu____2691 =
                let uu____2692 = FStar_Syntax_Subst.compress dt1  in
                           ...
                           let haseq_sort =
                             let uu____2747 =
                               let uu____2748 =
                                 ...
                                 [uu____2749]  in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____2748
                                in
                               ...
                               let uu____2764 =
                                 let uu____2765 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((Prims.fst b), None)] uu____2766 None
                                    in
                                 FStar_Syntax_Syntax.as_arg uu____2765  in
                               [uu____2764]  in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____2763
                              in
                           uu____2762 None FStar_Range.dummyRange) dbs3 cond
                     in
...
let unoptimized_haseq_ty all_datas_in_the_bundle mutuals usubst us acc ty =
  ...
  | (lid,bs,t,d_lids) ->
      ...
      let uu____2875 = FStar_Syntax_Subst.open_term bs1 t1  in
      (match uu____2875 with
       | (bs2,t2) ->
           let ibs =
             let uu____2886 =
               let uu____2887 = FStar_Syntax_Subst.compress t2  in
                 ...
                 FStar_List.map
                   (fun uu____2943  ->
                      ...
                      | (bv,aq) ->
                          ...
                          (uu____2950, aq)) ibs1
                  in
               FStar_Syntax_Syntax.mk_Tm_app ind1 uu____2938  in
             uu____2937 None FStar_Range.dummyRange  in
           let haseq_ind =
             let uu____2958 =
               let uu____2959 =
                 let uu____2960 = FStar_Syntax_Syntax.as_arg ind2  in
                 [uu____2960]  in
               FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq
                 uu____2959
                in
           ...
           let fml1 =
               ...
               FStar_Syntax_Syntax.Tm_meta uu____2988  in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___86_2986.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___86_2986.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___86_2986.FStar_Syntax_Syntax.vars)
             }  in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
                  ...
                  FStar_List.fold_right
                    (fun tc  ->
                       fun uu____3274  ->
                         ...
                         | (env1,all_tcs,g) ->
                             let uu____3296 = tc_tycon env1 tc  in
                      ...
                      FStar_List.fold_right
                        (fun se  ->
                           fun uu____3350  ->
                             ...
                             | (datas1,g1) ->
                                 let uu____3361 =
                                   let uu____3364 = tc_data env1 tcs  in
                                   uu____3364 se  in
