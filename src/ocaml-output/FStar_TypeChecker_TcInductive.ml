                       ...
                       | (env2, tps, u_tc) ->
                           let uu___3 =
                             let t2 =
                               ...
                               FStar_TypeChecker_Normalize.normalize uu___4
                                 env2 t1 in
                             let uu___4 =
  ...
  fun env ->
    fun tcs ->
      fun datas ->
        ...
        let binders' =
          FStar_All.op_Bar_Greater datas
            (FStar_List.map
               (fun se ->
                  match se.FStar_Syntax_Syntax.sigel with
                  | FStar_Syntax_Syntax.Sig_datacon
        ...
        let t =
          let uu___ = FStar_List.op_At binders binders' in
          let uu___1 =
             ...
             ((let uu___3 =
               ...
               then
                 let uu___4 =
                   ...
                   FStar_All.op_Bar_Greater uu___5 (FStar_String.concat ", ") in
             ...
             ((debug_log env
               ...
               (let uu___3 =
                ...
                | FStar_Syntax_Syntax.Tm_app (t, args) ->
                    ...
                    let uu___4 =
                      FStar_All.op_Bar_Greater fv_us_opt FStar_Util.is_none in
                    if uu___4
                    then true
                    else
                      (let uu___6 =
                         FStar_All.op_Bar_Greater fv_us_opt FStar_Util.must in
                       match uu___6 with
                       | (fv, us) ->
                           let uu___7 =
                 ...
                 | (axiom_lid, fml, bs, ibs, haseq_bs) ->
                     ...
                     (match uu___5 with
                      | (l_axioms, env, guard', cond') ->
                          ...
                          let uu___6 =
                            FStar_List.op_At l_axioms [(axiom_lid, fml)] in
                          let uu___7 = FStar_Syntax_Util.mk_conj guard' guard in
                          let uu___8 = FStar_Syntax_Util.mk_conj cond' cond in
                          (uu___6, env2, uu___7, uu___8)))
                         ...
                         (match uu___4 with
                          | (tcs1, datas2) ->
                              let sig_bndle =
                                let uu___5 =
                                  let uu___6 =
                                    let uu___7 = FStar_List.op_At tcs1 datas2 in
                                    (uu___7, lids) in
                                  FStar_Syntax_Syntax.Sig_bundle uu___6 in
                                let uu___6 =
                      ...
                      fun fields ->
                        fun erasable ->
                          ...
                          let arg_typ =
                            ...
                            let args =
                              let uu___ = FStar_List.op_At tps indices in
                          ...
                          let all_params =
                            ...
                            FStar_List.op_At uu___ fields in
                          let imp_binders =
                            let uu___ = FStar_List.op_At tps indices in
                            FStar_All.op_Bar_Greater uu___
                              (FStar_List.map
                               ...
                               then [decl]
                                 ...
                                 (let body =
                                    ...
                                    then FStar_Syntax_Util.exp_true_bool
                                      ...
                                      (let arg_pats =
                                         FStar_All.op_Bar_Greater all_params
                                           (FStar_List.mapi
                                              (fun j ->
                                                 fun uu___4 ->
                                                   match uu___4 with
                          ...
                          let binders =
                            FStar_List.op_At imp_binders [arg_binder] in
                          let arg =
                          ...
                          let projectors_ses =
                            ...
                            FStar_All.op_Bar_Greater uu___ FStar_List.flatten in
                          FStar_List.op_At discriminator_ses projectors_ses
