                              ...
                              (match uu____93 with
                               | (t,guard) ->
                                   let k =
                                     ...
                                     FStar_Syntax_Util.arrow indices _0_173 in
                                   let uu____114 =
                 ...
                 (match uu____292 with
                  | (arguments,result) ->
                      ((let uu____400 =
                        ...
                        if uu____400
                        then
                          let _0_181 = FStar_Syntax_Print.lid_to_string c in
                          let _0_180 =
        ...
        fun datas  ->
          ...
          (let binders =
                         ...
                         (match se with
                          | FStar_Syntax_Syntax.Sig_inductive_typ
                              ...
                              FStar_Syntax_Syntax.null_binder
                                (let _0_193 = FStar_Syntax_Syntax.mk_Total k in
                                 FStar_All.pipe_left
           ...
           (let uu____592 =
            ...
            if uu____592
            then
              let _0_195 = FStar_TypeChecker_Normalize.term_to_string env t in
              FStar_Util.print1
                ...
                ((let uu____604 =
                  ...
                  then
                    let _0_198 =
                      ...
                      FStar_All.pipe_right _0_196 (FStar_String.concat ", ") in
             ...
             ((debug_log env "ty does occur in this type, pressing ahead";
               (let uu____1072 =
                    ...
                    (debug_log env
                     ...
                     FStar_List.for_all
                       (fun uu____1194  ->
                          ...
                          | (p,uu____1202,t) ->
                              let bs =
                                let _0_209 = FStar_Syntax_Syntax.pat_bvs p in
                ...
                | uu____1239 ->
                    ((let _0_215 =
                        let _0_214 =
                          let _0_213 = FStar_Syntax_Print.tag_of_term btype in
                          let _0_212 =
                            let _0_211 =
                     ...
                     (let uu____1258 =
                      ...
                      then
                        ...
                        (let num_ibs =
                         ...
                         (let _0_222 =
                            let _0_221 =
                              let _0_220 = FStar_Util.string_of_int num_ibs in
                              Prims.strcat _0_220
                       ...
                       (FStar_List.iter2
                        ...
                        (let dt =
                           FStar_TypeChecker_Normalize.normalize
                             ...
                             env dt in
                         (let _0_229 =
                            let _0_228 = FStar_Syntax_Print.term_to_string dt in
                            Prims.strcat
                                ...
                                | (ibs,dbs) ->
                                    ...
                                    let c =
                                      let _0_231 =
                                        FStar_Syntax_Subst.opening_of_binders
                                          ibs in
                                      FStar_Syntax_Subst.subst_comp _0_231 c in
                                    let uu____1366 =
              ...
              | (univ_unif_vars,dt) ->
                  (FStar_List.iter2
                   ...
                   (let _0_244 =
                      ...
                      Prims.strcat "Checking data constructor type: " _0_243 in
             ...
             FStar_List.filter
               (fun b  ->
                  ...
                  | (uu____2003,en,uu____2005,uu____2006) ->
                      let opt =
                        let _0_269 = Prims.fst (FStar_Syntax_Util.type_u ()) in
                        FStar_TypeChecker_Rel.try_subtype' en
                          (Prims.fst b).FStar_Syntax_Syntax.sort _0_269 false in
                      (match opt with
                       | None  -> false
               ...
               FStar_Syntax_Syntax.Tm_meta
                 (let _0_275 =
                    FStar_Syntax_Syntax.Meta_pattern
                      (let _0_274 =
                         let _0_273 = FStar_Syntax_Syntax.as_arg haseq_ind in
                         [_0_273] in
                       [_0_274]) in
                  (fml, _0_275)) in
             {
               ...
               (fun b  ->
                  fun t  ->
                    (let _0_279 =
                       ...
                       [_0_278] in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_279) None FStar_Range.dummyRange) ibs fml in
           let fml =
             FStar_List.fold_right
               (fun b  ->
                  fun t  ->
                    (let _0_282 =
                       ...
                       [_0_281] in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_282) None FStar_Range.dummyRange) bs fml in
                                ...
                                FStar_Syntax_Syntax.as_arg
                                  (let _0_290 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((Prims.fst b), None)] _0_290 None) in
                              [_0_291] in
                            FStar_Syntax_Syntax.mk_Tm_app
             ...
             let _0_305 =
               FStar_Syntax_Syntax.Tm_meta
                 (let _0_304 =
                    FStar_Syntax_Syntax.Meta_pattern
                      (let _0_303 =
                         let _0_302 = FStar_Syntax_Syntax.as_arg haseq_ind in
                         [_0_302] in
                       [_0_303]) in
                  (fml, _0_304)) in
             {
               ...
               (fun b  ->
                  fun t  ->
                    (let _0_308 =
                       ...
                       [_0_307] in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_308) None FStar_Range.dummyRange) ibs fml in
           let fml =
             FStar_List.fold_right
               (fun b  ->
                  fun t  ->
                    (let _0_311 =
                       ...
                       [_0_310] in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_311) None FStar_Range.dummyRange) bs fml in
                             ...
                             (FStar_List.append lid.FStar_Ident.ns
                                [FStar_Ident.id_of_text
                                   (Prims.strcat
                                      (lid.FStar_Ident.ident).FStar_Ident.idText
                                      "_haseq")]) in
                         tc_assume env _0_312 fml [] FStar_Range.dummyRange in
                       (env.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.pop
                         "haseq";
                       [se])))
