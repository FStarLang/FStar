                                ...
                                let uu____4641 =
                                  let uu____4650 =
                                    ...
                                    FStar_Syntax_Util.abs
                                      [((FStar_Pervasives_Native.fst b),
                                         FStar_Pervasives_Native.None)]
                                      uu____4651 FStar_Pervasives_Native.None
                                     in
                                  FStar_Syntax_Syntax.as_arg uu____4650  in
                                [uu____4641]  in
                              FStar_Syntax_Syntax.mk_Tm_app
                                FStar_Syntax_Util.tforall uu____4640
                               in
                          ...
                          fun t3  ->
                            let uu____4704 =
                              let uu____4709 =
                                ...
                                [uu____4710]  in
                              FStar_Syntax_Syntax.mk_Tm_app
                                FStar_Syntax_Util.tforall uu____4709
                               in
                       ...
                       let haseq_b =
                         let uu____4895 =
                           let uu____4900 =
                             ...
                             [uu____4901]  in
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____4900
                            in
                   ...
                   fun t  ->
                     let uu____4940 =
                       let uu____4945 =
                         let uu____4946 =
                           let uu____4955 =
                             let uu____4956 = FStar_Syntax_Subst.close [b] t
                                in
                             FStar_Syntax_Util.abs
                               [((FStar_Pervasives_Native.fst b),
                         ...
                         [uu____4946]  in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____4945
                        in
        ...
        fun acc  ->
          fun ty  ->
            let lid =
              match ty.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_inductive_typ
                  (lid,uu____5094,uu____5095,uu____5096,uu____5097,uu____5098)
                  -> lid
              | uu____5107 -> failwith "Impossible!"  in
            let uu____5109 = acc  in
            match uu____5109 with
            | (uu____5146,en,uu____5148,uu____5149) ->
                let uu____5170 = get_optimized_haseq_axiom en ty usubst us
                   in
                          ...
                          let t_datas =
                            FStar_List.filter
                              (fun s  ->
                                 match s.FStar_Syntax_Syntax.sigel with
                                 | FStar_Syntax_Syntax.Sig_datacon
                                     (uu____5282,uu____5283,uu____5284,t_lid,uu____5286,uu____5287)
                                     -> t_lid = lid
                   ...
                   ((env.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.push
                    ...
                    (let env1 = FStar_TypeChecker_Env.push_univ_vars env us1
                     ...
                     | (axioms,env2,guard,cond) ->
                         let phi =
                           let uu____5511 = FStar_Syntax_Util.arrow_formals t
                              in
          ...
          fun acc  ->
            fun data  ->
              let rec is_mutual t =
                ...
                | FStar_Syntax_Syntax.Tm_meta (t',uu____5729) -> is_mutual t'
                | uu____5734 -> false
              ...
              | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____5764) ->
                  ...
                  let dbs2 =
                    let uu____5844 = FStar_Syntax_Subst.opening_of_binders bs
                       in
                           ...
                           let haseq_sort =
                             let uu____5864 =
                               let uu____5869 =
                                 ...
                                 [uu____5870]  in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____5869
                                in
                         ...
                         fun t  ->
                           let uu____5913 =
                             let uu____5918 =
                               ...
                               [uu____5919]  in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____5918
                              in
              ...
              | (lid,bs,t,d_lids) ->
                  ...
                  (match uu____6096 with
                   | (bs2,t2) ->
                       let ibs =
                         let uu____6106 =
                           let uu____6107 = FStar_Syntax_Subst.compress t2
                              in
                       ...
                       let haseq_ind =
                         let uu____6242 =
                           let uu____6247 =
                             let uu____6248 = FStar_Syntax_Syntax.as_arg ind2
                                in
                             [uu____6248]  in
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____6247
                            in
                       ...
                       let t_datas =
                         FStar_List.filter
                           (fun s  ->
                              match s.FStar_Syntax_Syntax.sigel with
                              | FStar_Syntax_Syntax.Sig_datacon
                                  (uu____6285,uu____6286,uu____6287,t_lid,uu____6289,uu____6290)
                                  -> t_lid = lid
                             ...
                             let uu____6318 =
                               let uu____6319 =
                                 let uu____6332 =
                                   ...
                                   [uu____6343]  in
                                 [uu____6332]  in
                               FStar_Syntax_Syntax.Meta_pattern uu____6319
                                in
                             (fml, uu____6318)  in
                                    ...
                                    let uu____6402 =
                                      let uu____6411 =
                                        ...
                                        FStar_Syntax_Util.abs
                                          ...
                                          FStar_Pervasives_Native.None
                                         in
                                      FStar_Syntax_Syntax.as_arg uu____6411
                                       in
                                    [uu____6402]  in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.tforall uu____6401
                                   in
                              ...
                              fun t3  ->
                                let uu____6465 =
                                  let uu____6470 =
                                    ...
                                    [uu____6471]  in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.tforall uu____6470
                                   in
          ...
          let mutuals =
            FStar_List.map
              (fun ty  ->
                 match ty.FStar_Syntax_Syntax.sigel with
                 | FStar_Syntax_Syntax.Sig_inductive_typ
                     (lid,uu____6573,uu____6574,uu____6575,uu____6576,uu____6577)
                     -> lid
                 | uu____6586 -> failwith "Impossible!") tcs
             in
          let uu____6588 =
            let ty = FStar_List.hd tcs  in
            match ty.FStar_Syntax_Syntax.sigel with
               ...
               (let univs1 =
                  ...
                  then []
                    ...
                    (let uu____6843 =
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         (uu____6847,uvs,uu____6849,uu____6850,uu____6851,uu____6852)
                         -> uvs
                     | uu____6861 -> failwith "Impossible, can't happen!")
                   in
                let env0 = env  in
                let uu____6866 =
                                   ...
                                   (FStar_All.pipe_right tcs1
                                      (FStar_List.iter
                                         (fun se  ->
                                            ...
                                            with
                                            | FStar_Syntax_Syntax.Sig_inductive_typ
                                                (l,univs2,binders,typ,uu____7377,uu____7378)
                                                ->
                      ...
                      let arg_binder =
                        ...
                        then unrefined_arg_binder
                          ...
                          (let disc_name =
                               ...
                               let uu____7740 =
                                 let uu____7743 =
                                   ...
                                   FStar_Syntax_Syntax.mk_Tm_app uu____7748
                                     uu____7749
                                    in
                                 uu____7743 FStar_Pervasives_Native.None p
                                  in
                           ...
                           FStar_Syntax_Syntax.mk_binder uu____7784)
                         in
                           ...
                           let only_decl =
                             early_prims_inductive ||
                               (let uu____7945 =
                                ...
                                FStar_Options.dont_gen_projectors uu____7945)
                              in
                           let quals =
                             let uu____7951 =
                               FStar_List.filter
                             ...
                             (let body =
                                ...
                                then FStar_Syntax_Util.exp_true_bool
                                  ...
                                  (let arg_pats =
                                   ...
                                   uu____8209 FStar_Pervasives_Native.None p)
                                 in
                              let dd =
                                let uu____8365 =
                              ...
                              let lb =
                                ...
                                FStar_Syntax_Util.mk_letbinding uu____8387
                                  ...
                                  uu____8393 [] FStar_Range.dummyRange
                                 in
                              let impl =
                                let uu____8399 =
                                  let uu____8400 =
                      ...
                      let projectors_ses =
                        let uu____8551 =
                          FStar_All.pipe_right fields
                           ...
                           in
                        FStar_All.pipe_right uu____8551 FStar_List.flatten
                         in
                            ...
                            FStar_Util.find_map tcs
                              (fun se1  ->
                                 let uu____9213 =
                                   ...
                                   FStar_Ident.lid_equals typ_lid uu____9215
                                    in
                                 if uu____9213
                                 then
                                   match se1.FStar_Syntax_Syntax.sigel with
                                   | FStar_Syntax_Syntax.Sig_inductive_typ
                                       (uu____9238,uvs',tps,typ0,uu____9242,constrs)
                                       ->
                                       FStar_Pervasives_Native.Some
                                         (tps, typ0,
