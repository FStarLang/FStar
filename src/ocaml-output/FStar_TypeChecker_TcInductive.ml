                                       ...
                                       ((let uu____496 =
                                           let uu____497 =
                                             FStar_Syntax_Subst.compress
                                               head1
                                              in
                                           uu____497.FStar_Syntax_Syntax.n
                                            in
                         ...
                         (match se.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_inductive_typ
                              ...
                              let uu____654 =
                                ...
                                FStar_All.pipe_left
                                  (FStar_Syntax_Util.arrow tps) uu____655
                                 in
                              FStar_Syntax_Syntax.null_binder uu____654
                          | uu____662 -> failwith "Impossible")))
              in
           let binders' =
                                                    ...
                                                    let uu____841 =
                                                      let uu____842 =
                                                        FStar_Syntax_Subst.compress
                                                          ty
                                                         in
                                                      uu____842.FStar_Syntax_Syntax.n
                                                       in
      ...
      fun unfolded  ->
        fun env  ->
          (let uu____1257 =
             ...
             Prims.strcat "Checking strict positivity in type: " uu____1258
              in
                   ...
                   (let uu____1873 =
                    ...
                    | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____1880) ->
                        ...
                        let dbs2 =
                          ...
                          FStar_Syntax_Subst.subst_binders uu____1919 dbs1
                           in
                       ...
                       let haseq_b =
                         let uu____2148 =
                           ...
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____2149
                            in
                   ...
                   fun t  ->
                     let uu____2165 =
                       let uu____2166 =
                         ...
                         [uu____2167]  in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____2166
                        in
      ...
      (match uu____2304 with
       | (bs2,t2) ->
           ...
           let ind1 =
             ...
             uu____2355 FStar_Pervasives_Native.None FStar_Range.dummyRange
              in
           let ind2 =
             let uu____2380 =
               let uu____2381 =
             ...
             uu____2380 FStar_Pervasives_Native.None FStar_Range.dummyRange
              in
           let haseq_ind =
             let uu____2405 =
               let uu____2406 =
               ...
               FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq
                 uu____2406
                in
             uu____2405 FStar_Pervasives_Native.None FStar_Range.dummyRange
              in
           let bs' =
             FStar_List.filter
               (fun b  ->
                    ...
                    let uu____2459 =
                      let uu____2460 =
                        let uu____2461 =
                          ...
                          [uu____2462]  in
                        FStar_Syntax_Syntax.mk_Tm_app
                          FStar_Syntax_Util.t_haseq uu____2461
                         in
                           ...
                           let haseq_sort =
                             let uu____2944 =
                               let uu____2945 =
                                 ...
                                 [uu____2946]  in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____2945
                                in
                               ...
                               let uu____2964 =
                                 let uu____2965 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((FStar_Pervasives_Native.fst b),
                                        FStar_Pervasives_Native.None)]
                                     uu____2966 FStar_Pervasives_Native.None
                                    in
                                 FStar_Syntax_Syntax.as_arg uu____2965  in
                               [uu____2964]  in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____2963
                              in
      ...
      (match uu____3076 with
       | (bs2,t2) ->
           ...
           let ind1 =
             ...
             uu____3118 FStar_Pervasives_Native.None FStar_Range.dummyRange
              in
           let ind2 =
             let uu____3143 =
               let uu____3144 =
             ...
             uu____3143 FStar_Pervasives_Native.None FStar_Range.dummyRange
              in
           let haseq_ind =
             let uu____3168 =
               let uu____3169 =
               ...
               FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq
                 uu____3169
                in
             uu____3168 FStar_Pervasives_Native.None FStar_Range.dummyRange
              in
           let t_datas =
             FStar_List.filter
               (fun s  ->
              ...
              FStar_List.map
                (fun ty  ->
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       -> lid
                   | uu____3344 -> failwith "Impossible!") tcs
               in
            let uu____3345 =
              let ty = FStar_List.hd tcs  in
              match ty.FStar_Syntax_Syntax.sigel with
