...
in {FStar_Syntax_Syntax.n = uu____3866; FStar_Syntax_Syntax.pos = uu___122_3865.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___122_3865.FStar_Syntax_Syntax.vars}))
in (
...
and exists_mutual = (fun uu___114_4376 -> (match (uu___114_4376) with
| [] -> begin
false
end
| (hd1)::tl1 -> begin
...
in {FStar_Syntax_Syntax.n = uu____4782; FStar_Syntax_Syntax.pos = uu___123_4781.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___123_4781.FStar_Syntax_Syntax.vars}))
in (
...
let uu____5065 = (FStar_All.pipe_right ses (FStar_List.partition (fun uu___115_5090 -> (match (uu___115_5090) with
...
let uu____5138 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun uu___116_5147 -> (match (uu___116_5147) with
