                           ...
                           let uu____800 =
                             let t2 =
                               FStar_TypeChecker_Normalize.normalize
                                 ...
                                 env2 t1 in
                             let uu____816 =
                               let uu____817 = FStar_Syntax_Subst.compress t2 in
                               uu____817.FStar_Syntax_Syntax.n in
                             match uu____816 with
                             | FStar_Syntax_Syntax.Tm_arrow (bs, res) ->
                                 let uu____856 = FStar_Util.first_N ntps bs in
                                                  ...
                                                  (let g_uvs =
                                                   ...
                                                   let t2 =
                                                     ...
                                                     FStar_Syntax_Util.arrow
                                                       uu____1390 uu____1467 in
                                                   let t3 =
                                                     FStar_Syntax_Subst.close_univ_vars
                                                       _uvs1 t2 in
                                                   ((let uu___183_1472 = se in
                                                     {
                                                       FStar_Syntax_Syntax.sigel
                                                         =
                                                         (FStar_Syntax_Syntax.Sig_datacon
    ...
    fun tcs ->
      fun datas ->
            ...
            (FStar_List.map
               (fun uu____1567 ->
                  ...
                  | (se, uu____1573) ->
                      (match se.FStar_Syntax_Syntax.sigel with
                       | FStar_Syntax_Syntax.Sig_inductive_typ
                           (uu____1574, uu____1575, tps, k, uu____1578,
                            uu____1579)
                           ->
                           let uu____1588 =
                             let uu____1589 = FStar_Syntax_Syntax.mk_Total k in
                             FStar_All.pipe_left
                               (FStar_Syntax_Util.arrow tps) uu____1589 in
                           FStar_Syntax_Syntax.null_binder uu____1588
                       | uu____1594 -> failwith "Impossible"))) in
        let binders' =
          FStar_All.pipe_right datas
            (FStar_List.map
               (fun se ->
                  match se.FStar_Syntax_Syntax.sigel with
                  | FStar_Syntax_Syntax.Sig_datacon
                      (uu____1623, uu____1624, t, uu____1626, uu____1627,
                       uu____1628)
                      -> FStar_Syntax_Syntax.null_binder t
                  | uu____1635 -> failwith "Impossible")) in
        let t =
          let uu____1640 =
        ...
        (let uu____1650 =
         ...
         if uu____1650
         then
           let uu____1655 = FStar_TypeChecker_Normalize.term_to_string env t in
           FStar_Util.print1 "@@@@@@Trying to generalize universes in %s\n"
             uu____1655
         else ());
        (let uu____1660 = FStar_TypeChecker_Util.generalize_universes env t in
                               ...
                               | uu____2082 ->
                                   let uvs_universes =
                                     FStar_All.pipe_right uvs1
                                       (FStar_List.map
                                          (fun _2086 ->
                                             FStar_Syntax_Syntax.U_name _2086)) in
                                   let tc_insts =
      ...
      fun unfolded ->
        fun env ->
          (let uu____2611 =
             ...
             Prims.op_Hat "Checking strict positivity in type: " uu____2613 in
                           ...
                           (debug_log env
                            ...
                            FStar_List.for_all
                              (fun uu____2693 ->
                                 ...
                                 | (t1, uu____2702) ->
                                     let uu____2707 = ty_occurs_in ty_lid t1 in
          ...
          fun unfolded ->
            fun env ->
              (let uu____3003 =
                 let uu____3005 =
                   let uu____3007 =
                     let uu____3009 = FStar_Syntax_Print.args_to_string args in
               ...
               | (b, idatas) ->
                   ...
                   then
                     ...
                     (if uu____3032
                      then
                        ((let uu____3038 =
                            let uu____3040 = FStar_Ident.string_of_lid ilid in
                            FStar_Util.format1
                   ...
                   | (univ_unif_vars, dt) ->
                       (FStar_List.iter2
                        ...
                        (let dt1 =
                         ...
                         (let uu____3248 =
                            let uu____3249 = FStar_Syntax_Subst.compress dt1 in
    ...
    fun dlid ->
      fun ty_bs ->
        fun us ->
          fun unfolded ->
            fun env ->
              let uu____3711 = FStar_TypeChecker_Env.lookup_datacon env dlid in
              ...
              | (univ_unif_vars, dt) ->
                  (FStar_List.iter2
                     ...
                     univ_unif_vars us;
                   (let uu____3737 =
                      let uu____3739 = FStar_Syntax_Print.term_to_string dt in
                   ...
                   (let uu____3742 =
                    ...
                    | FStar_Syntax_Syntax.Tm_arrow (dbs, uu____3752) ->
                        ...
                        let dbs2 =
                          ...
                          FStar_Syntax_Subst.subst_binders uu____3832 dbs1 in
  ...
  fun ty ->
    fun env ->
      ...
      let uu____3988 =
        ...
        | FStar_Syntax_Syntax.Sig_inductive_typ
            (lid, us, bs, uu____4004, uu____4005, uu____4006) ->
            (lid, us, bs)
      ...
      fun usubst ->
        fun us ->
          let uu____4196 =
            match ty.FStar_Syntax_Syntax.sigel with
            | FStar_Syntax_Syntax.Sig_inductive_typ
                (lid, uu____4210, bs, t, uu____4213, uu____4214) ->
                (lid, bs, t)
                   ...
                   let ind =
                     ...
                     let uu____4309 =
                       FStar_List.map (fun u -> FStar_Syntax_Syntax.U_name u)
                         us in
                     FStar_Syntax_Syntax.mk_Tm_uinst uu____4308 uu____4309 in
                   let ind1 =
                     let uu____4315 =
                       let uu____4320 =
                         FStar_List.map
                   ...
                   let haseq_ind =
                     let uu____4409 =
                       ...
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.t_haseq uu____4414 in
                            ...
                            let uu____4478 =
                              let uu____4481 =
                                let uu____4486 =
                                  ...
                                  [uu____4487] in
                                FStar_Syntax_Syntax.mk_Tm_app
                                  FStar_Syntax_Util.t_haseq uu____4486 in
                                  ...
                                  let uu____4663 =
                                    ...
                                    FStar_Syntax_Util.abs
                                      [((FStar_Pervasives_Native.fst b),
                                         FStar_Pervasives_Native.None)]
                                      uu____4664 FStar_Pervasives_Native.None in
                                  FStar_Syntax_Syntax.as_arg uu____4663 in
                                [uu____4654] in
                              FStar_Syntax_Syntax.mk_Tm_app
                                FStar_Syntax_Util.tforall uu____4653 in
                          ...
                          fun t3 ->
                            let uu____4717 =
                              let uu____4722 =
                                ...
                                [uu____4723] in
                              FStar_Syntax_Syntax.mk_Tm_app
                                FStar_Syntax_Util.tforall uu____4722 in
                       ...
                       let haseq_b =
                         let uu____4908 =
                           let uu____4913 =
                             ...
                             [uu____4914] in
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____4913 in
                   ...
                   fun t ->
                     let uu____4953 =
                       let uu____4958 =
                         let uu____4959 =
                           let uu____4968 =
                             let uu____4969 = FStar_Syntax_Subst.close [b] t in
                             FStar_Syntax_Util.abs
                               [((FStar_Pervasives_Native.fst b),
                         ...
                         [uu____4959] in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____4958 in
        ...
        fun acc ->
          fun ty ->
            let lid =
              match ty.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_inductive_typ
                  (lid, uu____5107, uu____5108, uu____5109, uu____5110,
                   uu____5111)
                  -> lid
            ...
            | (uu____5159, en, uu____5161, uu____5162) ->
                let uu____5183 = get_optimized_haseq_axiom en ty usubst us in
                          ...
                          let t_datas =
                            FStar_List.filter
                              (fun s ->
                                 match s.FStar_Syntax_Syntax.sigel with
                                 | FStar_Syntax_Syntax.Sig_datacon
                                     (uu____5295, uu____5296, uu____5297,
                                      t_lid, uu____5299, uu____5300)
                                     -> t_lid = lid
                   ...
                   ((env.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.push
                    ...
                    (let env1 = FStar_TypeChecker_Env.push_univ_vars env us1 in
                     ...
                     | (axioms, env2, guard, cond) ->
                         let phi =
                           let uu____5524 = FStar_Syntax_Util.arrow_formals t in
          ...
          fun acc ->
            fun data ->
              let rec is_mutual t =
                ...
                | FStar_Syntax_Syntax.Tm_meta (t', uu____5742) ->
                    is_mutual t'
                | uu____5747 -> false
              ...
              | FStar_Syntax_Syntax.Tm_arrow (dbs, uu____5777) ->
                  ...
                  let dbs2 =
                    let uu____5857 = FStar_Syntax_Subst.opening_of_binders bs in
                           ...
                           let haseq_sort =
                             let uu____5877 =
                               let uu____5882 =
                                 ...
                                 [uu____5883] in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____5882 in
                               ...
                               let uu____5932 =
                                 let uu____5941 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((FStar_Pervasives_Native.fst b),
                                        FStar_Pervasives_Native.None)]
                                     uu____5942 FStar_Pervasives_Native.None in
                                 FStar_Syntax_Syntax.as_arg uu____5941 in
                               [uu____5932] in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____5931 in
              ...
              | (lid, bs, t, d_lids) ->
                  ...
                  (match uu____6109 with
                   | (bs2, t2) ->
                       let ibs =
                         let uu____6119 =
                           let uu____6120 = FStar_Syntax_Subst.compress t2 in
                       ...
                       let haseq_ind =
                         let uu____6255 =
                           let uu____6260 =
                             let uu____6261 = FStar_Syntax_Syntax.as_arg ind2 in
                             [uu____6261] in
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____6260 in
                       ...
                       let t_datas =
                         FStar_List.filter
                           (fun s ->
                              match s.FStar_Syntax_Syntax.sigel with
                              | FStar_Syntax_Syntax.Sig_datacon
                                  (uu____6298, uu____6299, uu____6300, t_lid,
                                   uu____6302, uu____6303)
                                  -> t_lid = lid
                         ...
                         let uu____6323 =
                           let uu____6324 =
                             let uu____6331 =
                               ...
                               FStar_Syntax_Syntax.Meta_pattern uu____6332 in
                             (fml, uu____6331) in
                                    ...
                                    let uu____6457 =
                                      let uu____6466 =
                                        ...
                                        FStar_Syntax_Util.abs
                                          ...
                                          uu____6467
                                          FStar_Pervasives_Native.None in
                                      FStar_Syntax_Syntax.as_arg uu____6466 in
                                    [uu____6457] in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.tforall uu____6456 in
                                    ...
                                    let uu____6526 =
                                      let uu____6535 =
                                        ...
                                        FStar_Syntax_Util.abs
                                          ...
                                          uu____6536
                                          FStar_Pervasives_Native.None in
                                      FStar_Syntax_Syntax.as_arg uu____6535 in
                                    [uu____6526] in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.tforall uu____6525 in
          ...
          let mutuals =
            FStar_List.map
              (fun ty ->
                 match ty.FStar_Syntax_Syntax.sigel with
                 | FStar_Syntax_Syntax.Sig_inductive_typ
                     (lid, uu____6628, uu____6629, uu____6630, uu____6631,
                      uu____6632)
                     -> lid
                 | uu____6641 -> failwith "Impossible!") tcs in
          let uu____6643 =
            let ty = FStar_List.hd tcs in
            match ty.FStar_Syntax_Syntax.sigel with
            | FStar_Syntax_Syntax.Sig_inductive_typ
               ...
               (let univs1 =
                  ...
                  then []
                    ...
                    (let uu____6906 =
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         (uu____6910, uvs, uu____6912, uu____6913,
                          uu____6914, uu____6915)
                         -> uvs
                     | uu____6924 -> failwith "Impossible, can't happen!") in
                let env0 = env in
                let uu____6929 =
                  FStar_List.fold_right
                    (fun tc ->
                    ...
                    fun fields ->
                      fun erasable1 ->
                                  ...
                                  let uu____7566 =
                                    let uu____7569 =
                                      FStar_Syntax_Syntax.lid_as_fv tc
                                        FStar_Syntax_Syntax.delta_constant
                                        FStar_Pervasives_Native.None in
                                    FStar_Syntax_Syntax.fv_to_tm uu____7569 in
                                 ...
                                 let uu____7654 =
                                   let uu____7657 =
                                     ...
                                     FStar_Syntax_Syntax.mk_Tm_app uu____7662
                                       uu____7663 in
                                   uu____7657 FStar_Pervasives_Native.None p in
                               ...
                               (let body =
                                ...
                                let lb =
                                  ...
                                  FStar_Syntax_Util.mk_letbinding uu____8306
                                    ...
                                    uu____8312 [] FStar_Range.dummyRange in
                                let impl =
                                  let uu____8318 =
                                    let uu____8319 =
                                      let uu____8326 =
                                    ...
                                    FStar_Syntax_Syntax.Sig_let uu____8319 in
                                  {
                        ...
                        let projectors_ses =
                          ...
                          FStar_All.pipe_right uu____8470 FStar_List.flatten in
                            ...
                            FStar_Util.find_map tcs
                              (fun se1 ->
                                 let uu____9137 =
                                   ...
                                   FStar_Ident.lid_equals typ_lid uu____9139 in
                                 if uu____9137
                                 then
                                   match se1.FStar_Syntax_Syntax.sigel with
                                   | FStar_Syntax_Syntax.Sig_inductive_typ
                                       (uu____9162, uvs', tps, typ0,
                                        uu____9166, constrs)
                                       ->
                                       FStar_Pervasives_Native.Some
                                         (tps, typ0,
