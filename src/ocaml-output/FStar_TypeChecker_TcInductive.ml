                                            ...
                                            (let uu___117_211 = s in
                                             {
                                               ...
                                               FStar_Syntax_Syntax.sigrng =
                                                 (uu___117_211.FStar_Syntax_Syntax.sigrng);
                                               FStar_Syntax_Syntax.sigquals =
                                                 (uu___117_211.FStar_Syntax_Syntax.sigquals);
                                               FStar_Syntax_Syntax.sigmeta =
                                                 (uu___117_211.FStar_Syntax_Syntax.sigmeta);
                                               FStar_Syntax_Syntax.sigattrs =
                                                 (uu___117_211.FStar_Syntax_Syntax.sigattrs)
                                             }), u, guard)))))))))
                                             ...
                                             FStar_Syntax_Syntax.sigel =
                                               (FStar_Syntax_Syntax.Sig_datacon
                                                  (c, [], t1, tc_lid, ntps,
                                                    []));
                                             FStar_Syntax_Syntax.sigrng =
                                               (uu___118_858.FStar_Syntax_Syntax.sigrng);
                                             FStar_Syntax_Syntax.sigquals =
                                               (uu___118_858.FStar_Syntax_Syntax.sigquals);
                                             FStar_Syntax_Syntax.sigmeta =
                                               (uu___118_858.FStar_Syntax_Syntax.sigmeta);
                                             FStar_Syntax_Syntax.sigattrs =
                                               (uu___118_858.FStar_Syntax_Syntax.sigattrs)
                                           }), g))))))))))
    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g1 =
            let uu___119_922 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___119_922.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___119_922.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (FStar_Pervasives_Native.snd
                     g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___119_922.FStar_TypeChecker_Env.implicits)
            } in
          (let uu____932 =
                                                  ...
                                                  (match uu____1240 with
                                                   | (tps1,t3) ->
                                                       let uu___120_1411 = se in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.sigrng
                                                           =
                                                           (uu___120_1411.FStar_Syntax_Syntax.sigrng);
                                                         FStar_Syntax_Syntax.sigquals
                                                           =
                                                           (uu___120_1411.FStar_Syntax_Syntax.sigquals);
                                                         FStar_Syntax_Syntax.sigmeta
                                                           =
                                                           (uu___120_1411.FStar_Syntax_Syntax.sigmeta);
                                                         FStar_Syntax_Syntax.sigattrs
                                                           =
                                                           (uu___120_1411.FStar_Syntax_Syntax.sigattrs)
                                                       })
                                              | uu____1424 ->
                                                  failwith "Impossible"))
                                    tc_types tcs in
                                                 ...
                                                 (match d.FStar_Syntax_Syntax.sigel
                                                  ...
                                                  | FStar_Syntax_Syntax.Sig_datacon
                                                      ...
                                                      let uu___121_1546 = d in
                                                      {
                                                        ...
                                                        FStar_Syntax_Syntax.sigrng
                                                          =
                                                          (uu___121_1546.FStar_Syntax_Syntax.sigrng);
                                                        FStar_Syntax_Syntax.sigquals
                                                          =
                                                          (uu___121_1546.FStar_Syntax_Syntax.sigquals);
                                                        FStar_Syntax_Syntax.sigmeta
                                                          =
                                                          (uu___121_1546.FStar_Syntax_Syntax.sigmeta);
                                                        FStar_Syntax_Syntax.sigattrs
                                                          =
                                                          (uu___121_1546.FStar_Syntax_Syntax.sigattrs)
                                                      }
                                                  | uu____1549 ->
                                                      failwith "Impossible"))
                                        data_types datas in
                     ...
                     let fml1 =
                         ...
                         FStar_Syntax_Syntax.Tm_meta uu____3851 in
                       {
                         ...
                         FStar_Syntax_Syntax.pos =
                           (uu___122_3849.FStar_Syntax_Syntax.pos);
                         FStar_Syntax_Syntax.vars =
                           (uu___122_3849.FStar_Syntax_Syntax.vars)
                       } in
                     let fml2 =
                       FStar_List.fold_right
                         (fun b  ->
          ...
          fun acc  ->
            fun data  ->
              let rec is_mutual t =
                ...
                | uu____4348 -> false
              and exists_mutual uu___114_4349 =
                   ...
                   | (bs2,t2) ->
                       ...
                       let fml1 =
                           ...
                           FStar_Syntax_Syntax.Tm_meta uu____4750 in
                         {
                           ...
                           FStar_Syntax_Syntax.pos =
                             (uu___123_4748.FStar_Syntax_Syntax.pos);
                           FStar_Syntax_Syntax.vars =
                             (uu___123_4748.FStar_Syntax_Syntax.vars)
                         } in
                       let fml2 =
                         FStar_List.fold_right
                           (fun b  ->
