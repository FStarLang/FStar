       ...
       | (bs2,t2) ->
           ...
           let fml1 =
               ...
               FStar_Syntax_Syntax.Tm_meta uu____2264 in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___90_2260.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___90_2260.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___90_2260.FStar_Syntax_Syntax.vars)
             } in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
          ...
          fun acc  ->
            fun data  ->
              let rec is_mutual t =
                ...
                | uu____2638 -> false
              and exists_mutual uu___82_2639 =
                match uu___82_2639 with
                | [] -> false
       ...
       | (bs2,t2) ->
           ...
           let fml1 =
               ...
               FStar_Syntax_Syntax.Tm_meta uu____2953 in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___91_2949.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___91_2949.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___91_2949.FStar_Syntax_Syntax.vars)
             } in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
