                          ...
                          fun t3 ->
                            let uu____4677 =
                              let uu____4682 =
                                ...
                                [uu____4683] in
                              FStar_Syntax_Syntax.mk_Tm_app
                                FStar_Syntax_Util.tforall uu____4682 in
                                ...
                                let uu____4752 =
                                  let uu____4761 =
                                    ...
                                    FStar_Syntax_Util.abs
                                      [((FStar_Pervasives_Native.fst b),
                                         FStar_Pervasives_Native.None)]
                                      uu____4762 FStar_Pervasives_Native.None in
                                  FStar_Syntax_Syntax.as_arg uu____4761 in
                                [uu____4752] in
                              FStar_Syntax_Syntax.mk_Tm_app
                                FStar_Syntax_Util.tforall uu____4751 in
                       ...
                       let haseq_b =
                         let uu____4937 =
                           let uu____4942 =
                             ...
                             [uu____4943] in
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____4942 in
                   ...
                   fun t ->
                     let uu____4982 =
                       let uu____4987 =
                         let uu____4988 =
                           let uu____4997 =
                             let uu____4998 = FStar_Syntax_Subst.close [b] t in
                             FStar_Syntax_Util.abs
                               [((FStar_Pervasives_Native.fst b),
                         ...
                         [uu____4988] in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____4987 in
        ...
        fun acc ->
          fun ty ->
            let lid =
              match ty.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_inductive_typ
                  (lid, uu____5136, uu____5137, uu____5138, uu____5139,
                   uu____5140)
                  -> lid
            ...
            | (uu____5188, en, uu____5190, uu____5191) ->
                let uu____5212 = get_optimized_haseq_axiom en ty usubst us in
                          ...
                          let t_datas =
                            FStar_List.filter
                              (fun s ->
                                 match s.FStar_Syntax_Syntax.sigel with
                                 | FStar_Syntax_Syntax.Sig_datacon
                                     (uu____5324, uu____5325, uu____5326,
                                      t_lid, uu____5328, uu____5329)
                                     -> t_lid = lid
                   ...
                   ((env.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.push
                    ...
                    (let env1 = FStar_TypeChecker_Env.push_univ_vars env us1 in
                     ...
                     | (axioms, env2, guard, cond) ->
                         let phi =
                           let uu____5553 = FStar_Syntax_Util.arrow_formals t in
          ...
          fun acc ->
            fun data ->
              let rec is_mutual t =
                ...
                | FStar_Syntax_Syntax.Tm_meta (t', uu____5771) ->
                    is_mutual t'
                | uu____5776 -> false
              ...
              | FStar_Syntax_Syntax.Tm_arrow (dbs, uu____5806) ->
                  ...
                  let dbs2 =
                    let uu____5886 = FStar_Syntax_Subst.opening_of_binders bs in
                           ...
                           let haseq_sort =
                             let uu____5906 =
                               let uu____5911 =
                                 ...
                                 [uu____5912] in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____5911 in
                               ...
                               let uu____5961 =
                                 let uu____5970 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((FStar_Pervasives_Native.fst b),
                                        FStar_Pervasives_Native.None)]
                                     uu____5971 FStar_Pervasives_Native.None in
                                 FStar_Syntax_Syntax.as_arg uu____5970 in
                               [uu____5961] in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____5960 in
              ...
              | (lid, bs, t, d_lids) ->
                  ...
                  (match uu____6138 with
                   | (bs2, t2) ->
                       let ibs =
                         let uu____6148 =
                           let uu____6149 = FStar_Syntax_Subst.compress t2 in
                       ...
                       let haseq_ind =
                         let uu____6284 =
                           let uu____6289 =
                             let uu____6290 = FStar_Syntax_Syntax.as_arg ind2 in
                             [uu____6290] in
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____6289 in
                       ...
                       let t_datas =
                         FStar_List.filter
                           (fun s ->
                              match s.FStar_Syntax_Syntax.sigel with
                              | FStar_Syntax_Syntax.Sig_datacon
                                  (uu____6327, uu____6328, uu____6329, t_lid,
                                   uu____6331, uu____6332)
                                  -> t_lid = lid
                         ...
                         let uu____6352 =
                           let uu____6353 =
                             let uu____6360 =
                               ...
                               FStar_Syntax_Syntax.Meta_pattern uu____6361 in
                             (fml, uu____6360) in
                              ...
                              fun t3 ->
                                let uu____6480 =
                                  let uu____6485 =
                                    ...
                                    [uu____6486] in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.tforall uu____6485 in
                                    ...
                                    let uu____6555 =
                                      let uu____6564 =
                                        ...
                                        FStar_Syntax_Util.abs
                                          ...
                                          uu____6565
                                          FStar_Pervasives_Native.None in
                                      FStar_Syntax_Syntax.as_arg uu____6564 in
                                    [uu____6555] in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.tforall uu____6554 in
          ...
          let mutuals =
            FStar_List.map
              (fun ty ->
                 match ty.FStar_Syntax_Syntax.sigel with
                 | FStar_Syntax_Syntax.Sig_inductive_typ
                     (lid, uu____6657, uu____6658, uu____6659, uu____6660,
                      uu____6661)
                     -> lid
                 | uu____6670 -> failwith "Impossible!") tcs in
          let uu____6672 =
            let ty = FStar_List.hd tcs in
            match ty.FStar_Syntax_Syntax.sigel with
            | FStar_Syntax_Syntax.Sig_inductive_typ
               ...
               (let univs1 =
                  ...
                  then []
                    ...
                    (let uu____6927 =
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         (uu____6931, uvs, uu____6933, uu____6934,
                          uu____6935, uu____6936)
                         -> uvs
                     | uu____6945 -> failwith "Impossible, can't happen!") in
                let env0 = env in
                let uu____6950 =
                  ...
                  fun indices ->
                    fun fields ->
                      ...
                      let arg_binder =
                        ...
                        then unrefined_arg_binder
                          ...
                          (let disc_name =
                           ...
                           FStar_Syntax_Syntax.mk_binder uu____7868) in
                           ...
                           let only_decl =
                             early_prims_inductive ||
                               (let uu____8029 =
                                ...
                                FStar_Options.dont_gen_projectors uu____8029) in
                           let quals =
                             let uu____8035 =
                               FStar_List.filter
                                 (fun uu___4_8039 ->
                             ...
                             (let body =
                                ...
                                then FStar_Syntax_Util.exp_true_bool
                                  ...
                                  (let arg_pats =
                                   ...
                                   uu____8293 FStar_Pervasives_Native.None p) in
                              let dd =
                                let uu____8449 =
                              ...
                              let lb =
                                ...
                                FStar_Syntax_Util.mk_letbinding uu____8471
                                  ...
                                  uu____8477 [] FStar_Range.dummyRange in
                              let impl =
                                let uu____8483 =
                                  let uu____8484 =
                                    let uu____8491 =
                      ...
                      let projectors_ses =
                        ...
                        FStar_All.pipe_right uu____8635 FStar_List.flatten in
                            ...
                            FStar_Util.find_map tcs
                              (fun se1 ->
                                 let uu____9297 =
                                   ...
                                   FStar_Ident.lid_equals typ_lid uu____9299 in
                                 if uu____9297
                                 then
                                   match se1.FStar_Syntax_Syntax.sigel with
                                   | FStar_Syntax_Syntax.Sig_inductive_typ
                                       (uu____9322, uvs', tps, typ0,
                                        uu____9326, constrs)
                                       ->
                                       FStar_Pervasives_Native.Some
                                         (tps, typ0,
