                  ...
                  fun t  ->
                    let uu____2322 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2323
                       in
                    uu____2322 None FStar_Range.dummyRange) ibs fml
              in
           let fml =
             FStar_List.fold_right
               (fun b  ->
                  fun t  ->
                    let uu____2348 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2349
                       in
                    uu____2348 None FStar_Range.dummyRange) bs fml
              in
                         ...
                         fun t  ->
                           let uu____2762 =
                             ...
                             FStar_Syntax_Syntax.mk_Tm_app
                              ...
                              in
                           uu____2762 None FStar_Range.dummyRange) dbs cond
                     in
                  ...
                  fun t  ->
                    let uu____3015 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3016
                       in
                    uu____3015 None FStar_Range.dummyRange) ibs fml
              in
           let fml =
             FStar_List.fold_right
               (fun b  ->
                  fun t  ->
                    let uu____3041 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3042
                       in
                    uu____3041 None FStar_Range.dummyRange) bs fml
              in
