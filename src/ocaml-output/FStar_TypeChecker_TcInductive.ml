...
in {FStar_Syntax_Syntax.n = uu____3758; FStar_Syntax_Syntax.pos = uu___115_3757.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___115_3757.FStar_Syntax_Syntax.vars}))
in (
...
and exists_mutual = (fun uu___107_4268 -> (match (uu___107_4268) with
| [] -> begin
false
end
| (hd1)::tl1 -> begin
...
in {FStar_Syntax_Syntax.n = uu____4674; FStar_Syntax_Syntax.pos = uu___116_4673.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___116_4673.FStar_Syntax_Syntax.vars}))
in (
...
let uu____4957 = (FStar_All.pipe_right ses (FStar_List.partition (fun uu___108_4982 -> (match (uu___108_4982) with
...
let uu____5030 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun uu___109_5039 -> (match (uu___109_5039) with
