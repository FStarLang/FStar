                    ...
                    let k2 =
                      FStar_TypeChecker_Normalize.normalize
                        ...
                        FStar_TypeChecker_Normalize.UnfoldUntil
                          FStar_Syntax_Syntax.Delta_constant] env k1
                       in
                                       ...
                                       ((let uu____490 =
                                           let uu____491 =
                                             FStar_Syntax_Subst.compress
                                               head1
                                              in
                                           uu____491.FStar_Syntax_Syntax.n
                                            in
                                             ...
                                             FStar_Syntax_Syntax.sigel =
                                               (FStar_Syntax_Syntax.Sig_datacon
                                                  (c, [], t1, tc_lid, ntps,
                                                    quals, []));
                                             FStar_Syntax_Syntax.sigrng =
                                               (uu___84_550.FStar_Syntax_Syntax.sigrng)
                                           }), g))))))))))
    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g1 =
            let uu___85_592 = g  in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___85_592.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___85_592.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (Prims.snd g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___85_592.FStar_TypeChecker_Env.implicits)
            }  in
          (let uu____598 =
                         ...
                         (match se.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_inductive_typ
                              ...
                              let uu____628 =
                                ...
                                FStar_All.pipe_left
                                  (FStar_Syntax_Util.arrow tps) uu____629
                                 in
                                                    ...
                                                    let uu____794 =
                                                      let uu____795 =
                                                        FStar_Syntax_Subst.compress
                                                          ty
                                                         in
                                                      uu____795.FStar_Syntax_Syntax.n
                                                       in
                                                  ...
                                                  (match uu____786 with
                                                   | (tps1,t3) ->
                                                          ...
                                                          in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.sigrng
                                                           =
                                                           (uu___86_905.FStar_Syntax_Syntax.sigrng)
                                                       })
                                              | uu____914 ->
                                                  failwith "Impossible"))
                                    tc_types tcs
                                                 ...
                                                 (match d.FStar_Syntax_Syntax.sigel
                                                  ...
                                                  | FStar_Syntax_Syntax.Sig_datacon
                                                      ...
                                                      let uu___87_979 = d  in
                                                      {
                                                        ...
                                                        FStar_Syntax_Syntax.sigrng
                                                          =
                                                          (uu___87_979.FStar_Syntax_Syntax.sigrng)
                                                      }
                                                  | uu____982 ->
                                                      failwith "Impossible"))
                                        data_types datas
      ...
      fun unfolded  ->
        fun env  ->
          (let uu____1174 =
             ...
             Prims.strcat "Checking strict positivity in type: " uu____1175
              in
                   ...
                   (let uu____1748 =
                    ...
                    | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____1755) ->
                        ...
                        let dbs2 =
                          ...
                          FStar_Syntax_Subst.subst_binders uu____1792 dbs1
                           in
                       ...
                       let haseq_b =
                         let uu____2003 =
                           ...
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____2004
                            in
                   ...
                   fun t  ->
                     let uu____2017 =
                       let uu____2018 =
                         ...
                         [uu____2019]  in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____2018
                        in
       ...
       | (bs2,t2) ->
                    ...
                    let uu____2290 =
                      let uu____2291 =
                        let uu____2292 =
                          ...
                          [uu____2293]  in
                        FStar_Syntax_Syntax.mk_Tm_app
                          FStar_Syntax_Util.t_haseq uu____2292
                         in
           ...
           let fml1 =
               ...
               FStar_Syntax_Syntax.Tm_meta uu____2305  in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___88_2303.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___88_2303.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___88_2303.FStar_Syntax_Syntax.vars)
             }  in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2332 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2333
                       in
                    uu____2332 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2358 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2359
                       in
                    uu____2358 None FStar_Range.dummyRange) bs2 fml2
              in
        ...
        fun mutuals  ->
          fun acc  ->
            fun data  ->
              ...
              and exists_mutual uu___80_2682 =
                match uu___80_2682 with
                | [] -> false
                           ...
                           let haseq_sort =
                             let uu____2755 =
                               let uu____2756 =
                                 ...
                                 [uu____2757]  in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____2756
                                in
                               ...
                               let uu____2772 =
                                 let uu____2773 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((Prims.fst b), None)] uu____2774 None
                                    in
                                 FStar_Syntax_Syntax.as_arg uu____2773  in
                               [uu____2772]  in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____2771
                              in
                           uu____2770 None FStar_Range.dummyRange) dbs3 cond
                     in
       ...
       | (bs2,t2) ->
           ...
           let fml1 =
               ...
               FStar_Syntax_Syntax.Tm_meta uu____2994  in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___89_2992.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___89_2992.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___89_2992.FStar_Syntax_Syntax.vars)
             }  in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____3021 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3022
                       in
                    uu____3021 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____3047 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3048
                       in
                    uu____3047 None FStar_Range.dummyRange) bs2 fml2
              in
              ...
              FStar_List.map
                (fun ty  ->
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       -> lid
                   | uu____3132 -> failwith "Impossible!") tcs
               in
            let uu____3133 =
              let ty = FStar_List.hd tcs  in
              match ty.FStar_Syntax_Syntax.sigel with
