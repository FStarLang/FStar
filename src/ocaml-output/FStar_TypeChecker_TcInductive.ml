...
let uu___109_213 = s
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((tc), ([]), (tps3), (k4), (mutuals), (data))); FStar_Syntax_Syntax.sigrng = uu___109_213.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___109_213.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___109_213.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___109_213.FStar_Syntax_Syntax.sigattrs})), (u), (guard)))))));
)
end)))
end))
end))
...
let uu___110_862 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((c), ([]), (t1), (tc_lid), (ntps), ([]))); FStar_Syntax_Syntax.sigrng = uu___110_862.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___110_862.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___110_862.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___110_862.FStar_Syntax_Syntax.sigattrs})), (g))));
)
end));
)
end))
...
let uu___111_930 = g
in {FStar_TypeChecker_Env.guard_f = uu___111_930.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___111_930.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = ((tc_universe_vars), ((FStar_Pervasives_Native.snd g.FStar_TypeChecker_Env.univ_ineqs))); FStar_TypeChecker_Env.implicits = uu___111_930.FStar_TypeChecker_Env.implicits})
in ((
...
let uu___112_1419 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((tc), (uvs1), (tps1), (t3), (mutuals), (datas1))); FStar_Syntax_Syntax.sigrng = uu___112_1419.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___112_1419.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___112_1419.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___112_1419.FStar_Syntax_Syntax.sigattrs})
end)))
end
| uu____1432 -> begin
(failwith "Impossible")
...
let tc_insts = (FStar_All.pipe_right tcs1 (FStar_List.map (fun uu___105_1480 -> (match (uu___105_1480) with
...
let uu___113_1554 = d
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((l), (uvs1), (ty), (tc), (ntps), (mutuals))); FStar_Syntax_Syntax.sigrng = uu___113_1554.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___113_1554.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___113_1554.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___113_1554.FStar_Syntax_Syntax.sigattrs}))
end
| uu____1557 -> begin
(failwith "Impossible")
end)
...
in {FStar_Syntax_Syntax.n = uu____3866; FStar_Syntax_Syntax.pos = uu___114_3865.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___114_3865.FStar_Syntax_Syntax.vars}))
in (
...
and exists_mutual = (fun uu___106_4376 -> (match (uu___106_4376) with
| [] -> begin
false
end
| (hd1)::tl1 -> begin
...
in {FStar_Syntax_Syntax.n = uu____4782; FStar_Syntax_Syntax.pos = uu___115_4781.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___115_4781.FStar_Syntax_Syntax.vars}))
in (
...
let uu____5065 = (FStar_All.pipe_right ses (FStar_List.partition (fun uu___107_5090 -> (match (uu___107_5090) with
...
let uu____5138 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun uu___108_5147 -> (match (uu___108_5147) with
