                              ...
                              (match uu____93 with
                               | (t,guard) ->
                                   let k =
                                     ...
                                     FStar_Syntax_Util.arrow indices _0_194 in
                                   let uu____114 =
                  ...
                  (fun uu____194  ->
                     ...
                     | (se,u_tc) ->
                         let uu____203 =
                           ...
                           FStar_Ident.lid_equals tc_lid _0_198 in
                         if uu____203
                         then
                           (match se with
                            | FStar_Syntax_Syntax.Sig_inductive_typ
                 ...
                 (match uu____292 with
                  | (arguments,result) ->
                      ((let uu____400 =
                        ...
                        if uu____400
                        then
                          let _0_202 = FStar_Syntax_Print.lid_to_string c in
                          let _0_201 =
                             ...
                             | (result,res_lcomp) ->
                                 ((let uu____419 =
                                     (FStar_Syntax_Subst.compress
                                        res_lcomp.FStar_Syntax_Syntax.res_typ).FStar_Syntax_Syntax.n in
                                                           ...
                                                           (x,
                                                             (Some
                                                                (FStar_Syntax_Syntax.Implicit
                                                                   true))))) in
                                             FStar_List.append _0_210
                                               arguments in
                                           let _0_211 =
                                             FStar_Syntax_Syntax.mk_Total
                                               result in
                                           FStar_Syntax_Util.arrow _0_212
                                             _0_211 in
                                         ((FStar_Syntax_Syntax.Sig_datacon
    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g =
            let uu___84_529 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___84_529.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___84_529.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (Prims.snd g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___84_529.FStar_TypeChecker_Env.implicits)
            } in
          (let uu____535 =
           ...
           if uu____535
           then
             let _0_213 = FStar_TypeChecker_Rel.guard_to_string env g in
          ...
          (let binders =
                         ...
                         (match se with
                          | FStar_Syntax_Syntax.Sig_inductive_typ
                              ...
                              FStar_Syntax_Syntax.null_binder
                                (let _0_214 = FStar_Syntax_Syntax.mk_Total k in
                                 FStar_All.pipe_left
                                   (FStar_Syntax_Util.arrow tps) _0_214)
                          | uu____569 -> failwith "Impossible"))) in
           let binders' =
             FStar_All.pipe_right datas
               (FStar_List.map
                  (fun uu___79_574  ->
                     match uu___79_574 with
                     | FStar_Syntax_Syntax.Sig_datacon
                         (uu____575,uu____576,t,uu____578,uu____579,uu____580,uu____581,uu____582)
                         -> FStar_Syntax_Syntax.null_binder t
                     | uu____587 -> failwith "Impossible")) in
           let t =
             let _0_215 =
           ...
           (let uu____592 =
            ...
            if uu____592
            then
              let _0_216 = FStar_TypeChecker_Normalize.term_to_string env t in
              FStar_Util.print1
                "@@@@@@Trying to generalize universes in %s\n" _0_216
            else ());
           (let uu____594 = FStar_TypeChecker_Util.generalize_universes env t in
                ...
                ((let uu____604 =
                  ...
                  then
                    let _0_219 =
                      ...
                      FStar_All.pipe_right _0_217 (FStar_String.concat ", ") in
                    let _0_218 = FStar_Syntax_Print.term_to_string t in
...
let ty_occurs_in:
  ...
  fun ty_lid  ->
    fun t  ->
      let _0_223 = FStar_Syntax_Free.fvars t in
      FStar_Util.set_mem ty_lid _0_223
let try_get_fv:
...
let already_unfolded:
  ...
  fun ilid  ->
    fun arrghs  ->
      fun unfolded  ->
        fun env  ->
          let _0_224 = FStar_ST.read unfolded in
          FStar_List.existsML
            (fun uu____967  ->
  ...
  fun ty_lid  ->
    fun btype  ->
      fun unfolded  ->
        fun env  ->
          (let _0_226 =
             let _0_225 = FStar_Syntax_Print.term_to_string btype in
             Prims.strcat "Checking strict positivity in type: " _0_225 in
           debug_log env _0_226);
          (let btype =
           ...
           (let _0_228 =
              let _0_227 = FStar_Syntax_Print.term_to_string btype in
              Prims.strcat
                "Checking strict positivity in type, after normalization: "
                _0_227 in
            debug_log env _0_228);
           (Prims.op_Negation (ty_occurs_in ty_lid btype)) ||
             ((debug_log env "ty does occur in this type, pressing ahead";
               (let uu____1072 =
                  (FStar_Syntax_Subst.compress btype).FStar_Syntax_Syntax.n in
                    ...
                    (debug_log env
                     ...
                     FStar_List.for_all
                       (fun uu____1194  ->
                          ...
                          | (p,uu____1202,t) ->
                              let bs =
                                let _0_230 = FStar_Syntax_Syntax.pat_bvs p in
                ...
                | uu____1239 ->
                    ((let _0_236 =
                        let _0_235 =
                          let _0_234 = FStar_Syntax_Print.tag_of_term btype in
                          let _0_233 =
                            let _0_232 =
                              FStar_Syntax_Print.term_to_string btype in
                            Prims.strcat " and term: " _0_232 in
                          Prims.strcat _0_234 _0_233 in
                        Prims.strcat
                          "Checking strict positivity, unexpected tag: "
                          _0_235 in
                      debug_log env _0_236);
                     false)))))
          ...
          fun unfolded  ->
            fun env  ->
              (let _0_240 =
                 let _0_239 =
                   let _0_238 =
                     let _0_237 = FStar_Syntax_Print.args_to_string args in
                     Prims.strcat " applied to arguments: " _0_237 in
                   Prims.strcat ilid.FStar_Ident.str _0_238 in
                     ...
                     (let uu____1258 =
                      ...
                      then
                        ...
                        (let num_ibs =
                         ...
                         (let _0_243 =
                            let _0_242 =
                              let _0_241 = FStar_Util.string_of_int num_ibs in
                              Prims.strcat _0_241
                         ...
                         (let _0_248 =
                            let _0_247 = FStar_ST.read unfolded in
                            let _0_246 =
                              let _0_245 =
                                let _0_244 =
                                  Prims.fst (FStar_List.splitAt num_ibs args) in
                                (ilid, _0_244) in
                              [_0_245] in
                            FStar_List.append _0_247 _0_246 in
                          FStar_ST.write unfolded _0_248);
                         FStar_List.for_all
                           (fun d  ->
                       ...
                       (FStar_List.iter2
                        ...
                        (let dt =
                           FStar_TypeChecker_Normalize.normalize
                             ...
                             env dt in
                         (let _0_250 =
                            let _0_249 = FStar_Syntax_Print.term_to_string dt in
                            Prims.strcat
                         ...
                         (let uu____1324 =
                                    ...
                                    let dbs =
                                      let _0_251 =
                                        FStar_Syntax_Subst.opening_of_binders
                                          ibs in
                                      FStar_Syntax_Subst.subst_binders _0_251
                                        dbs in
                                    let c =
                                      let _0_252 =
                                        FStar_Syntax_Subst.opening_of_binders
                                          ibs in
                                      FStar_Syntax_Subst.subst_comp _0_252 c in
                                    let uu____1366 =
                                         ...
                                         ((let _0_258 =
                                             let _0_257 =
                                               ...
                                               let _0_255 =
                                                 ...
                                                 Prims.strcat ", and c: "
                                                   _0_254 in
                                               Prims.strcat _0_256 _0_255 in
                                             Prims.strcat
                                               "Checking nested positivity in the unfolded data constructor binders as: "
                                               _0_257 in
                                           debug_log env _0_258);
                          ...
                          | uu____1436 ->
                              (debug_log env
                               ...
                               (let _0_259 =
                                  (FStar_Syntax_Subst.compress dt).FStar_Syntax_Syntax.n in
                                ty_nested_positive_in_type ty_lid _0_259 ilid
    ...
    fun dlid  ->
      fun ty_bs  ->
        fun us  ->
          fun unfolded  ->
            fun env  ->
              let uu____1529 = FStar_TypeChecker_Env.lookup_datacon env dlid in
              ...
              | (univ_unif_vars,dt) ->
                  (FStar_List.iter2
                     ...
                     univ_unif_vars us;
                   (let _0_265 =
                      let _0_264 = FStar_Syntax_Print.term_to_string dt in
                      Prims.strcat "Checking data constructor type: " _0_264 in
                   ...
                   (let uu____1543 =
                    ...
                    | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____1547) ->
                        ...
                        let dbs =
                          ...
                          FStar_Syntax_Subst.subst_binders _0_266 dbs in
                        ...
                        ((let _0_269 =
                            let _0_268 =
                              ...
                              Prims.strcat _0_267 " binders" in
                            Prims.strcat
                              "Data constructor type is an arrow type, so checking strict positivity in "
                              _0_268 in
                          debug_log env _0_269);
                         (let uu____1582 =
                            FStar_List.fold_left
                              (fun uu____1589  ->
                                 fun b  ->
      ...
      | (ty_lid,ty_us,ty_bs) ->
          ...
          (match uu____1671 with
           | (ty_usubst,ty_us) ->
               ...
               let _0_273 =
                 Prims.snd (FStar_TypeChecker_Env.datacons_of_typ env ty_lid) in
               FStar_List.for_all
                 (fun d  ->
                    let _0_272 =
                      FStar_List.map (fun s  -> FStar_Syntax_Syntax.U_name s)
                        ty_us in
                    ty_positive_in_datacon ty_lid d ty_bs _0_272
                      unfolded_inductives env) _0_273)
      ...
      fun usubst  ->
        fun bs  ->
          ...
          | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____1725) ->
              ...
              let dbs =
                let _0_274 = FStar_Syntax_Subst.opening_of_binders bs in
                FStar_Syntax_Subst.subst_binders _0_274 dbs in
              let dbs = FStar_Syntax_Subst.open_binders dbs in
              let cond =
                FStar_List.fold_left
                  (fun t  ->
                     fun b  ->
                       let haseq_b =
                         (let _0_276 =
                          ...
                          FStar_Syntax_Syntax.mk_Tm_app
                            FStar_Syntax_Util.t_haseq _0_276) None
                       ...
                       let haseq_b =
                         ...
                         FStar_TypeChecker_Util.label _0_277 sort_range
                           haseq_b in
...
let optimized_haseq_ty all_datas_in_the_bundle usubst us acc ty =
  ...
  | (lid,bs,t,d_lids) ->
      ...
      let t =
        ...
        FStar_Syntax_Subst.subst _0_281 t in
      ...
      (match uu____1901 with
       | (bs,t) ->
           ...
           let ind =
             ...
             FStar_Syntax_Syntax.mk_Tm_uinst _0_283 _0_282 in
           let ind =
             (let _0_285 =
                FStar_List.map
                  (fun uu____1954  ->
                     ...
                     | (bv,aq) ->
                         let _0_284 = FStar_Syntax_Syntax.bv_to_name bv in
                         (_0_284, aq)) bs in
              FStar_Syntax_Syntax.mk_Tm_app ind _0_285) None
               FStar_Range.dummyRange in
           let ind =
             (let _0_287 =
                FStar_List.map
                  (fun uu____1972  ->
                     ...
                     | (bv,aq) ->
                         let _0_286 = FStar_Syntax_Syntax.bv_to_name bv in
                         (_0_286, aq)) ibs in
              FStar_Syntax_Syntax.mk_Tm_app ind _0_287) None
               FStar_Range.dummyRange in
           let haseq_ind =
             (let _0_289 =
                let _0_288 = FStar_Syntax_Syntax.as_arg ind in [_0_288] in
              FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _0_289)
             ...
             FStar_List.filter
               (fun b  ->
                  ...
                  | (uu____2003,en,uu____2005,uu____2006) ->
                      let opt =
                        let _0_290 = Prims.fst (FStar_Syntax_Util.type_u ()) in
                        FStar_TypeChecker_Rel.try_subtype' en
                          (Prims.fst b).FStar_Syntax_Syntax.sort _0_290 false in
                      (match opt with
                       | None  -> false
                       | Some uu____2015 -> true)) bs in
           let haseq_bs =
             FStar_List.fold_left
               (fun t  ->
                  fun b  ->
                    let _0_293 =
                      (let _0_292 =
                         ...
                         [_0_291] in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.t_haseq _0_292) None
                        FStar_Range.dummyRange in
                    FStar_Syntax_Util.mk_conj t _0_293)
               FStar_Syntax_Util.t_true bs' in
           let fml = FStar_Syntax_Util.mk_imp haseq_bs haseq_ind in
           let fml =
             let uu___85_2029 = fml in
             let _0_297 =
               FStar_Syntax_Syntax.Tm_meta
                 (let _0_296 =
                    FStar_Syntax_Syntax.Meta_pattern
                      (let _0_295 =
                         let _0_294 = FStar_Syntax_Syntax.as_arg haseq_ind in
                         [_0_294] in
                       [_0_295]) in
                  (fml, _0_296)) in
             {
               FStar_Syntax_Syntax.n = _0_297;
               FStar_Syntax_Syntax.tk = (uu___85_2029.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___85_2029.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___85_2029.FStar_Syntax_Syntax.vars)
             } in
           let fml =
             FStar_List.fold_right
               (fun b  ->
                  fun t  ->
                    (let _0_300 =
                       let _0_299 =
                         FStar_Syntax_Syntax.as_arg
                           (let _0_298 = FStar_Syntax_Subst.close [b] t in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              _0_298 None) in
                       [_0_299] in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_300) None FStar_Range.dummyRange) ibs fml in
           let fml =
             FStar_List.fold_right
               (fun b  ->
                  fun t  ->
                    (let _0_303 =
                       let _0_302 =
                         FStar_Syntax_Syntax.as_arg
                           (let _0_301 = FStar_Syntax_Subst.close [b] t in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              _0_301 None) in
                       [_0_302] in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_303) None FStar_Range.dummyRange) bs fml in
                  ...
                  FStar_List.fold_left
                    (fun acc  ->
                       fun d  ->
                         ...
                         FStar_Syntax_Util.mk_conj acc _0_304)
                    ...
                    (FStar_List.append lid.FStar_Ident.ns
                       [FStar_Ident.id_of_text
                          (Prims.strcat
                             ...
                             "_haseq")]) in
                let _0_306 = FStar_Syntax_Util.mk_conj guard' guard in
                let _0_305 = FStar_Syntax_Util.mk_conj cond' cond in
          ...
          fun acc  ->
            fun data  ->
              let rec is_mutual t =
                ...
                | uu____2367 -> false
              and exists_mutual uu___81_2368 =
                match uu___81_2368 with
                | [] -> false
              ...
              | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____2389) ->
                  let dbs =
                    Prims.snd (FStar_List.splitAt (FStar_List.length bs) dbs) in
                  let dbs =
                    let _0_308 = FStar_Syntax_Subst.opening_of_binders bs in
                    FStar_Syntax_Subst.subst_binders _0_308 dbs in
                  let dbs = FStar_Syntax_Subst.open_binders dbs in
                  let cond =
                    FStar_List.fold_left
                      (fun t  ->
                         fun b  ->
                           ...
                           let haseq_sort =
                             (let _0_310 =
                                ...
                                [_0_309] in
                              FStar_Syntax_Syntax.mk_Tm_app
                                FStar_Syntax_Util.t_haseq _0_310) None
                               FStar_Range.dummyRange in
                           let haseq_sort =
                                ...
                                FStar_Syntax_Syntax.as_arg
                                  (let _0_311 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((Prims.fst b), None)] _0_311 None) in
                              [_0_312] in
                            FStar_Syntax_Syntax.mk_Tm_app
                              FStar_Syntax_Util.tforall _0_313) None
                             FStar_Range.dummyRange) dbs cond in
...
let unoptimized_haseq_ty all_datas_in_the_bundle mutuals usubst us acc ty =
  ...
  | (lid,bs,t,d_lids) ->
      ...
      let t =
        let _0_314 =
          FStar_Syntax_Subst.shift_subst (FStar_List.length bs) usubst in
        FStar_Syntax_Subst.subst _0_314 t in
      ...
      (match uu____2545 with
       | (bs,t) ->
           ...
           let ind =
             ...
             let _0_315 =
               FStar_List.map (fun u  -> FStar_Syntax_Syntax.U_name u) us in
             FStar_Syntax_Syntax.mk_Tm_uinst _0_316 _0_315 in
           let ind =
             (let _0_318 =
                FStar_List.map
                  (fun uu____2589  ->
                     ...
                     | (bv,aq) ->
                         let _0_317 = FStar_Syntax_Syntax.bv_to_name bv in
                         (_0_317, aq)) bs in
              FStar_Syntax_Syntax.mk_Tm_app ind _0_318) None
               FStar_Range.dummyRange in
           let ind =
             (let _0_320 =
                FStar_List.map
                  (fun uu____2607  ->
                     ...
                     | (bv,aq) ->
                         let _0_319 = FStar_Syntax_Syntax.bv_to_name bv in
                         (_0_319, aq)) ibs in
              FStar_Syntax_Syntax.mk_Tm_app ind _0_320) None
               FStar_Range.dummyRange in
           let haseq_ind =
             (let _0_322 =
                let _0_321 = FStar_Syntax_Syntax.as_arg ind in [_0_321] in
              FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _0_322)
               None FStar_Range.dummyRange in
           let t_datas =
             FStar_List.filter
               (fun s  ->
           ...
           let fml =
             let uu___86_2642 = fml in
             let _0_326 =
               FStar_Syntax_Syntax.Tm_meta
                 (let _0_325 =
                    FStar_Syntax_Syntax.Meta_pattern
                      (let _0_324 =
                         let _0_323 = FStar_Syntax_Syntax.as_arg haseq_ind in
                         [_0_323] in
                       [_0_324]) in
                  (fml, _0_325)) in
             {
               FStar_Syntax_Syntax.n = _0_326;
               FStar_Syntax_Syntax.tk = (uu___86_2642.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___86_2642.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___86_2642.FStar_Syntax_Syntax.vars)
             } in
           let fml =
             FStar_List.fold_right
               (fun b  ->
                  fun t  ->
                    (let _0_329 =
                       let _0_328 =
                         FStar_Syntax_Syntax.as_arg
                           (let _0_327 = FStar_Syntax_Subst.close [b] t in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              _0_327 None) in
                       [_0_328] in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_329) None FStar_Range.dummyRange) ibs fml in
           let fml =
             FStar_List.fold_right
               (fun b  ->
                  fun t  ->
                    (let _0_332 =
                       let _0_331 =
                         FStar_Syntax_Syntax.as_arg
                           (let _0_330 = FStar_Syntax_Subst.close [b] t in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              _0_330 None) in
                       [_0_331] in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_332) None FStar_Range.dummyRange) bs fml in
              ...
              FStar_List.map
                (fun ty  ->
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       -> lid
                   | uu____2756 -> failwith "Impossible!") tcs in
            let uu____2757 =
              let ty = FStar_List.hd tcs in
              match ty with
              | FStar_Syntax_Syntax.Sig_inductive_typ
                             ...
                             (FStar_List.append lid.FStar_Ident.ns
                                [FStar_Ident.id_of_text
                                   (Prims.strcat
                                      (lid.FStar_Ident.ident).FStar_Ident.idText
                                      "_haseq")]) in
                         tc_assume env _0_333 fml [] FStar_Range.dummyRange in
                       (env.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.pop
                         "haseq";
                       [se])))
          ...
          | (tys,datas) ->
              ((let uu____2866 =
                ...
                then
                  Prims.raise
                    (FStar_Errors.Error
                       (let _0_334 = FStar_TypeChecker_Env.get_range env in
                                  ...
                                  ((let uu____2936 =
                                   ...
                                   (let _0_337 =
                                      ...
                                      FStar_TypeChecker_Rel.conj_guard g
                                        _0_336 in
                                    (env, ((tc, tc_u) :: all_tcs), _0_337)))))
                    tys (env, [], FStar_TypeChecker_Rel.trivial_guard) in
