    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g1 =
            let uu___87_578 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___87_578.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___87_578.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (Prims.snd g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___87_578.FStar_TypeChecker_Env.implicits)
            } in
          (let uu____584 =
                                                  ...
                                                  (match uu____763 with
                                                   | (tps1,t3) ->
                                                       let uu___88_882 = se in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.sigrng
                                                           =
                                                           (uu___88_882.FStar_Syntax_Syntax.sigrng);
                                                         FStar_Syntax_Syntax.sigquals
                                                           =
                                                           (uu___88_882.FStar_Syntax_Syntax.sigquals);
                                                         FStar_Syntax_Syntax.sigmeta
                                                           =
                                                           (uu___88_882.FStar_Syntax_Syntax.sigmeta)
                                                       })
                                              | uu____890 ->
                                                  failwith "Impossible"))
                                    tc_types tcs in
                                                 ...
                                                 (match d.FStar_Syntax_Syntax.sigel
                                                  ...
                                                  | FStar_Syntax_Syntax.Sig_datacon
                                                      ...
                                                      let uu___89_952 = d in
                                                      {
                                                        ...
                                                        FStar_Syntax_Syntax.sigrng
                                                          =
                                                          (uu___89_952.FStar_Syntax_Syntax.sigrng);
                                                        FStar_Syntax_Syntax.sigquals
                                                          =
                                                          (uu___89_952.FStar_Syntax_Syntax.sigquals);
                                                        FStar_Syntax_Syntax.sigmeta
                                                          =
                                                          (uu___89_952.FStar_Syntax_Syntax.sigmeta)
                                                      }
                                                  | uu____954 ->
                                                      failwith "Impossible"))
                                        data_types datas in
       ...
       | (bs2,t2) ->
           ...
           let fml1 =
               ...
               FStar_Syntax_Syntax.Tm_meta uu____2272 in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___90_2268.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___90_2268.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___90_2268.FStar_Syntax_Syntax.vars)
             } in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
          ...
          fun acc  ->
            fun data  ->
              let rec is_mutual t =
                ...
                | uu____2646 -> false
              and exists_mutual uu___82_2647 =
                match uu___82_2647 with
                | [] -> false
