                                         ...
                                         | uu____493 ->
                                             let uu____494 =
                                               let uu____495 =
                                                 ...
                                                 (uu____498,
                                                   (se.FStar_Syntax_Syntax.sigrng)) in
                                               FStar_Errors.Error uu____495 in
                         ...
                         (match se.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_inductive_typ
                              ...
                              let uu____626 =
                                ...
                                FStar_All.pipe_left
                                  (FStar_Syntax_Util.arrow tps) uu____627 in
                              FStar_Syntax_Syntax.null_binder uu____626
                          | uu____634 -> failwith "Impossible"))) in
           let binders' =
    ...
    fun dlid  ->
      fun ty_bs  ->
        fun us  ->
          fun unfolded  ->
            fun env  ->
              let uu____1730 = FStar_TypeChecker_Env.lookup_datacon env dlid in
              ...
              | (univ_unif_vars,dt) ->
                  (FStar_List.iter2
                     ...
                     univ_unif_vars us;
                   (let uu____1744 =
                      let uu____1745 = FStar_Syntax_Print.term_to_string dt in
                       ...
                       let haseq_b =
                         let uu____2001 =
                           ...
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____2002 in
                   ...
                   fun t  ->
                     let uu____2015 =
                       let uu____2016 =
                         let uu____2017 =
                           let uu____2018 =
                             let uu____2019 = FStar_Syntax_Subst.close [b] t in
                             FStar_Syntax_Util.abs [((Prims.fst b), None)]
                               uu____2019 None in
                           FStar_Syntax_Syntax.as_arg uu____2018 in
                         [uu____2017] in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____2016 in
               ...
               let uu____2203 =
                 FStar_List.map
                   (fun uu____2208  ->
                      ...
                      | (bv,aq) ->
                          let uu____2215 = FStar_Syntax_Syntax.bv_to_name bv in
                          (uu____2215, aq)) bs2 in
               ...
               let uu____2224 =
                 FStar_List.map
                   (fun uu____2229  ->
                      ...
                      | (bv,aq) ->
                          let uu____2236 = FStar_Syntax_Syntax.bv_to_name bv in
                          (uu____2236, aq)) ibs1 in
                    ...
                    let uu____2288 =
                      let uu____2289 =
                        let uu____2290 =
                          ...
                          [uu____2291] in
                        FStar_Syntax_Syntax.mk_Tm_app
                          FStar_Syntax_Util.t_haseq uu____2290 in
             ...
             let uu____2302 =
               let uu____2303 =
                 let uu____2308 =
                   let uu____2309 =
                     let uu____2316 =
                       let uu____2318 = FStar_Syntax_Syntax.as_arg haseq_ind in
                       [uu____2318] in
                     [uu____2316] in
                  ...
                  fun t3  ->
                    let uu____2330 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2331 in
                    uu____2330 None FStar_Range.dummyRange) ibs1 fml1 in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2356 =
                      let uu____2357 =
                        let uu____2358 =
                          let uu____2359 =
                            let uu____2360 = FStar_Syntax_Subst.close [b] t3 in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              uu____2360 None in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2357 in
                    uu____2356 None FStar_Range.dummyRange) bs2 fml2 in
          ...
          fun acc  ->
            fun data  ->
              ...
              | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____2704) ->
                  ...
                  let dbs2 =
                    let uu____2741 = FStar_Syntax_Subst.opening_of_binders bs in
                           ...
                           let haseq_sort =
                             let uu____2753 =
                               let uu____2754 =
                                 ...
                                 [uu____2755] in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____2754 in
                               ...
                               let uu____2770 =
                                 let uu____2771 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((Prims.fst b), None)] uu____2772 None in
                                 FStar_Syntax_Syntax.as_arg uu____2771 in
                               [uu____2770] in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____2769 in
                           uu____2768 None FStar_Range.dummyRange) dbs3 cond in
               ...
               let uu____2922 =
                 FStar_List.map
                   (fun uu____2927  ->
                      ...
                      | (bv,aq) ->
                          let uu____2934 = FStar_Syntax_Syntax.bv_to_name bv in
                          (uu____2934, aq)) bs2 in
               ...
               let uu____2943 =
                 FStar_List.map
                   (fun uu____2948  ->
                      ...
                      | (bv,aq) ->
                          let uu____2955 = FStar_Syntax_Syntax.bv_to_name bv in
                          (uu____2955, aq)) ibs1 in
             ...
             let uu____2991 =
               let uu____2992 =
                 let uu____2997 =
                   let uu____2998 =
                     let uu____3005 =
                       let uu____3007 = FStar_Syntax_Syntax.as_arg haseq_ind in
                       [uu____3007] in
                     [uu____3005] in
                  ...
                  fun t3  ->
                    let uu____3019 =
                      let uu____3020 =
                        let uu____3021 =
                          let uu____3022 =
                            let uu____3023 = FStar_Syntax_Subst.close [b] t3 in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              uu____3023 None in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3020 in
                    uu____3019 None FStar_Range.dummyRange) ibs1 fml1 in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____3045 =
                      let uu____3046 =
                        let uu____3047 =
                          let uu____3048 =
                            let uu____3049 = FStar_Syntax_Subst.close [b] t3 in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              uu____3049 None in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3046 in
                    uu____3045 None FStar_Range.dummyRange) bs2 fml2 in
              ...
              FStar_List.map
                (fun ty  ->
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       -> lid
                   | uu____3130 -> failwith "Impossible!") tcs in
            let uu____3131 =
              let ty = FStar_List.hd tcs in
              match ty.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_inductive_typ
          ...
          | (tys,datas) ->
              ((let uu____3240 =
                ...
                then
                  let uu____3255 =
                    let uu____3256 =
                      let uu____3259 = FStar_TypeChecker_Env.get_range env in
