...
let uu___92_213 = s
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((tc), ([]), (tps3), (k4), (mutuals), (data))); FStar_Syntax_Syntax.sigrng = uu___92_213.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___92_213.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___92_213.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___92_213.FStar_Syntax_Syntax.sigattrs})), (u), (guard)))))));
)
end)))
end))
end))
...
let uu___93_862 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((c), ([]), (t1), (tc_lid), (ntps), ([]))); FStar_Syntax_Syntax.sigrng = uu___93_862.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___93_862.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___93_862.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___93_862.FStar_Syntax_Syntax.sigattrs})), (g))));
)
end));
)
end))
...
let uu___94_930 = g
in {FStar_TypeChecker_Env.guard_f = uu___94_930.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___94_930.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = ((tc_universe_vars), ((FStar_Pervasives_Native.snd g.FStar_TypeChecker_Env.univ_ineqs))); FStar_TypeChecker_Env.implicits = uu___94_930.FStar_TypeChecker_Env.implicits})
in ((
...
let uu___95_1419 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((tc), (uvs1), (tps1), (t3), (mutuals), (datas1))); FStar_Syntax_Syntax.sigrng = uu___95_1419.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___95_1419.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___95_1419.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___95_1419.FStar_Syntax_Syntax.sigattrs})
end)))
end
| uu____1432 -> begin
(failwith "Impossible")
...
let tc_insts = (FStar_All.pipe_right tcs1 (FStar_List.map (fun uu___88_1480 -> (match (uu___88_1480) with
...
let uu___96_1554 = d
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((l), (uvs1), (ty), (tc), (ntps), (mutuals))); FStar_Syntax_Syntax.sigrng = uu___96_1554.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___96_1554.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___96_1554.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___96_1554.FStar_Syntax_Syntax.sigattrs}))
end
| uu____1557 -> begin
(failwith "Impossible")
end)
...
in {FStar_Syntax_Syntax.n = uu____3758; FStar_Syntax_Syntax.pos = uu___97_3757.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___97_3757.FStar_Syntax_Syntax.vars}))
in (
...
and exists_mutual = (fun uu___89_4268 -> (match (uu___89_4268) with
| [] -> begin
false
end
| (hd1)::tl1 -> begin
...
in {FStar_Syntax_Syntax.n = uu____4674; FStar_Syntax_Syntax.pos = uu___98_4673.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___98_4673.FStar_Syntax_Syntax.vars}))
in (
...
let uu____4957 = (FStar_All.pipe_right ses (FStar_List.partition (fun uu___90_4982 -> (match (uu___90_4982) with
...
let uu____5030 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun uu___91_5039 -> (match (uu___91_5039) with
