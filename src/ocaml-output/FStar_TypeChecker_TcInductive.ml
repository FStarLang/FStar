                   ...
                   | (univ_unif_vars,dt) ->
                       (FStar_List.iter2
                        ...
                        (let dt1 =
                         ...
                         (let uu____2615 =
                            let uu____2616 = FStar_Syntax_Subst.compress dt1
                               in
    ...
    fun dlid  ->
      fun ty_bs  ->
        fun us  ->
          fun unfolded  ->
            fun env  ->
              let uu____2995 = FStar_TypeChecker_Env.lookup_datacon env dlid
                 in
              ...
              | (univ_unif_vars,dt) ->
                  (FStar_List.iter2
                     ...
                     univ_unif_vars us;
                   (let uu____3019 =
                      let uu____3020 = FStar_Syntax_Print.term_to_string dt
                         in
                   ...
                   (let uu____3021 =
                    ...
                    | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____3028) ->
                        ...
                        let dbs2 =
                          ...
                          FStar_Syntax_Subst.subst_binders uu____3090 dbs1
                           in
                       ...
                       let haseq_b =
                         let uu____3438 =
                           ...
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____3439
                            in
                   ...
                   fun t  ->
                     let uu____3453 =
                       let uu____3454 =
                         let uu____3455 =
                           let uu____3456 =
                             let uu____3457 = FStar_Syntax_Subst.close [b] t
                                in
                         ...
                         [uu____3455]  in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____3454
                        in
                ...
                (match uu____3627 with
                 | (bs2,t2) ->
                     ...
                     let ind =
                       ...
                       let uu____3695 =
                         FStar_List.map
                          ...
                          in
                       FStar_Syntax_Syntax.mk_Tm_uinst uu____3694 uu____3695
                        in
                     let ind1 =
                       let uu____3701 =
                         let uu____3702 =
                     ...
                     let haseq_ind =
                       let uu____3763 =
                         let uu____3764 =
                           let uu____3765 = FStar_Syntax_Syntax.as_arg ind2
                              in
                           [uu____3765]  in
                         FStar_Syntax_Syntax.mk_Tm_app
                           FStar_Syntax_Util.t_haseq uu____3764
                          in
                            ...
                            | (uu____3806,en,uu____3808,uu____3809) ->
                                let opt =
                                  let uu____3825 =
                                    let uu____3826 =
                                      FStar_Syntax_Util.type_u ()  in
                                    FStar_Pervasives_Native.fst uu____3826
                                     in
          ...
          | (tys,datas) ->
              ((let uu____5096 =
                ...
                then
                  let uu____5130 =
                    let uu____5131 =
                      let uu____5136 = FStar_TypeChecker_Env.get_range env
                         in
                                               ...
                                               let uu____5452 =
                                                 let uu____5457 =
                                                   ...
                                                   FStar_Util.format2
                                                     ...
                                                     uu____5458 uu____5459
                                                    in
                                                 (uu____5457,
                                                   (se.FStar_Syntax_Syntax.sigrng))
                                                  in
                                               FStar_Errors.Error uu____5452
                                                in
