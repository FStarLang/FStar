                                                ...
                                                (let uu___354_437 = s  in
                                                 {
                                                   ...
                                                   FStar_Syntax_Syntax.sigrng
                                                     =
                                                     (uu___354_437.FStar_Syntax_Syntax.sigrng);
                                                   FStar_Syntax_Syntax.sigquals
                                                     =
                                                     (uu___354_437.FStar_Syntax_Syntax.sigquals);
                                                   FStar_Syntax_Syntax.sigmeta
                                                     =
                                                     (uu___354_437.FStar_Syntax_Syntax.sigmeta);
                                                   FStar_Syntax_Syntax.sigattrs
                                                     =
                                                     (uu___354_437.FStar_Syntax_Syntax.sigattrs)
                                                 }), u, guard1)))))))))
                            ...
                            (fun uu____577  ->
                               ...
                               | (se1,u_tc) ->
                                   let uu____592 =
                                     ...
                                     FStar_Ident.lid_equals tc_lid uu____593
                                      in
                                   if uu____592
                                   then
                                     (match se1.FStar_Syntax_Syntax.sigel
                                      with
                                      | FStar_Syntax_Syntax.Sig_inductive_typ
                                          (uu____613,uu____614,tps,uu____616,uu____617,uu____618)
                                          ->
                                          let tps1 =
                                            let uu____628 =
                       ...
                       | (env2,tps,u_tc) ->
                           let uu____772 =
                             ...
                             | FStar_Syntax_Syntax.Tm_arrow (bs,res) ->
                                 let uu____828 = FStar_Util.first_N ntps bs
                                    in
                                           ...
                                           ((let uu____1031 =
                                               let uu____1032 =
                                                 FStar_Syntax_Subst.compress
                                                   ty
                                                  in
                                               uu____1032.FStar_Syntax_Syntax.n
                                                in
                                             ...
                                             | (head1,uu____1067) ->
                                                   ...
                                                   let uu____1093 =
                                                     let uu____1094 =
                                                       FStar_Syntax_Subst.compress
                                                         head1
                                                        in
                                                     uu____1094.FStar_Syntax_Syntax.n
                                                      in
                                                 ...
                                                 let t2 =
                                                   ...
                                                   FStar_Syntax_Util.arrow
                                                     uu____1158 uu____1234
                                                    in
                                                 let t3 =
                                                   FStar_Syntax_Subst.close_univ_vars
                                                     _uvs1 t2
                                                    in
                                                 ((let uu___355_1239 = se  in
                                                   {
                                                     FStar_Syntax_Syntax.sigel
                                                       =
                                                     ...
                                                     FStar_Syntax_Syntax.sigrng
                                                       =
                                                       (uu___355_1239.FStar_Syntax_Syntax.sigrng);
                                                     FStar_Syntax_Syntax.sigquals
                                                       =
                                                       (uu___355_1239.FStar_Syntax_Syntax.sigquals);
                                                     FStar_Syntax_Syntax.sigmeta
                                                       =
                                                       (uu___355_1239.FStar_Syntax_Syntax.sigmeta);
                                                     FStar_Syntax_Syntax.sigattrs
                                                       =
                                                       (uu___355_1239.FStar_Syntax_Syntax.sigattrs)
                                                   }), g))))))))))
    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g1 =
            let uu___356_1307 = g  in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___356_1307.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___356_1307.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (FStar_Pervasives_Native.snd
                     g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___356_1307.FStar_TypeChecker_Env.implicits)
            }  in
          (let uu____1317 =
           ...
           if uu____1317
           then
             let uu____1318 = FStar_TypeChecker_Rel.guard_to_string env g1
                in
               ...
               (FStar_List.map
                  (fun uu____1358  ->
                     ...
                     | (se,uu____1364) ->
                         (match se.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_inductive_typ
                              (uu____1365,uu____1366,tps,k,uu____1369,uu____1370)
                              ->
                              let uu____1379 =
                                let uu____1380 =
                                  FStar_Syntax_Syntax.mk_Total k  in
                                FStar_All.pipe_left
                                  (FStar_Syntax_Util.arrow tps) uu____1380
                                 in
                              FStar_Syntax_Syntax.null_binder uu____1379
                          | uu____1385 -> failwith "Impossible")))
              in
           let binders' =
             FStar_All.pipe_right datas
               (FStar_List.map
                  (fun se  ->
                     match se.FStar_Syntax_Syntax.sigel with
                     | FStar_Syntax_Syntax.Sig_datacon
                         (uu____1413,uu____1414,t,uu____1416,uu____1417,uu____1418)
           ...
           (let uu____1440 =
            ...
            | (uvs,t1) ->
                ((let uu____1460 =
                 ...
                 (let uu____1475 = FStar_Syntax_Subst.open_univ_vars uvs t1
                     in
                                  ...
                                  FStar_List.map2
                                    (fun uu____1640  ->
                                       fun uu____1641  ->
                                         ...
                                         | ((x,uu____1663),(se,uu____1665))
                                             ->
                                             (match se.FStar_Syntax_Syntax.sigel
                                              with
                                              | FStar_Syntax_Syntax.Sig_inductive_typ
                                                  (tc,uu____1681,tps,uu____1683,mutuals,datas1)
                                                  ->
                                                  let ty =
                                                    FStar_Syntax_Subst.close_univ_vars
                                                      uvs1
                                                    ...
                                                    let uu____1700 =
                                                      let uu____1701 =
                                                        FStar_Syntax_Subst.compress
                                                          ty
                                                         in
                                                      uu____1701.FStar_Syntax_Syntax.n
                                                       in
                                                  ...
                                                  (match uu____1695 with
                                                   | (tps1,t3) ->
                                                          ...
                                                          in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.sigrng
                                                           =
                                                           (uu___357_1836.FStar_Syntax_Syntax.sigrng);
                                                         FStar_Syntax_Syntax.sigquals
                                                           =
                                                           (uu___357_1836.FStar_Syntax_Syntax.sigquals);
                                                         FStar_Syntax_Syntax.sigmeta
                                                           =
                                                           (uu___357_1836.FStar_Syntax_Syntax.sigmeta);
                                                         FStar_Syntax_Syntax.sigattrs
                                                           =
                                                           (uu___357_1836.FStar_Syntax_Syntax.sigattrs)
                                                       })
                                              | uu____1841 ->
                                                  failwith "Impossible"))
                                    tc_types tcs
                                  ...
                                  | uu____1847 ->
                                      ...
                                      let tc_insts =
                                        FStar_All.pipe_right tcs1
                                          (FStar_List.map
                                             (fun uu___345_1869  ->
                                                match uu___345_1869 with
                                                | {
                                                    FStar_Syntax_Syntax.sigel
                                                      =
                                                      FStar_Syntax_Syntax.Sig_inductive_typ
                                                      (tc,uu____1875,uu____1876,uu____1877,uu____1878,uu____1879);
                                                    FStar_Syntax_Syntax.sigrng
                                                      = uu____1880;
                                                    FStar_Syntax_Syntax.sigquals
                                                      = uu____1881;
                                           ...
                                           fun d  ->
                                             ...
                                             | (t3,uu____1928) ->
                                                 (match d.FStar_Syntax_Syntax.sigel
                                                  with
                                                  | FStar_Syntax_Syntax.Sig_datacon
                                                      (l,uu____1934,uu____1935,tc,ntps,mutuals)
                                                      ->
                                                      let ty =
                                                        let uu____1944 =
                                                         ...
                                                         in
                                                      {
                                                        ...
                                                        FStar_Syntax_Syntax.sigrng
                                                          =
                                                          (uu___358_1945.FStar_Syntax_Syntax.sigrng);
                                                        FStar_Syntax_Syntax.sigquals
                                                          =
                                                          (uu___358_1945.FStar_Syntax_Syntax.sigquals);
                                                        FStar_Syntax_Syntax.sigmeta
                                                          =
                                                          (uu___358_1945.FStar_Syntax_Syntax.sigmeta);
                                                        FStar_Syntax_Syntax.sigattrs
                                                          =
                                                          (uu___358_1945.FStar_Syntax_Syntax.sigattrs)
                                                      }
                                                  | uu____1948 ->
                                                      failwith "Impossible"))
                                        data_types datas
      ...
      fun unfolded  ->
        fun env  ->
          (let uu____2425 =
             ...
             Prims.strcat "Checking strict positivity in type: " uu____2426
              in
                           ...
                           (debug_log env
                            ...
                            FStar_List.for_all
                              (fun uu____2493  ->
                                 ...
                                 | (t1,uu____2501) ->
                                     let uu____2506 = ty_occurs_in ty_lid t1
                                        in
          ...
          fun unfolded  ->
            fun env  ->
              (let uu____2898 =
                 let uu____2899 =
                   let uu____2900 =
                     let uu____2901 = FStar_Syntax_Print.args_to_string args
                        in
                   ...
                   | (univ_unif_vars,dt) ->
                       (FStar_List.iter2
                        ...
                        (let dt1 =
                         ...
                         (let uu____3214 =
                            let uu____3215 = FStar_Syntax_Subst.compress dt1
                               in
    ...
    fun dlid  ->
      fun ty_bs  ->
        fun us  ->
          fun unfolded  ->
            fun env  ->
              let uu____3717 = FStar_TypeChecker_Env.lookup_datacon env dlid
                 in
              ...
              | (univ_unif_vars,dt) ->
                  (FStar_List.iter2
                     ...
                     univ_unif_vars us;
                   (let uu____3741 =
                      let uu____3742 = FStar_Syntax_Print.term_to_string dt
                         in
                   ...
                   (let uu____3743 =
                    ...
                    | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____3750) ->
                        ...
                        let dbs2 =
                          ...
                          FStar_Syntax_Subst.subst_binders uu____3830 dbs1
                           in
  ...
  fun ty  ->
    fun env  ->
      ...
      let uu____3996 =
        ...
        | FStar_Syntax_Syntax.Sig_inductive_typ
            (lid,us,bs,uu____4012,uu____4013,uu____4014) -> (lid, us, bs)
      ...
      fun usubst  ->
        fun us  ->
          let uu____4203 =
            match ty.FStar_Syntax_Syntax.sigel with
            | FStar_Syntax_Syntax.Sig_inductive_typ
                (lid,uu____4217,bs,t,uu____4220,uu____4221) -> (lid, bs, t)
               ...
               | (bs2,t2) ->
                   ...
                   let ind =
                     ...
                     let uu____4315 =
                       FStar_List.map
                        ...
                        in
                     FStar_Syntax_Syntax.mk_Tm_uinst uu____4314 uu____4315
                      in
                   let ind1 =
                     let uu____4321 =
                       let uu____4326 =
                   ...
                   let haseq_ind =
                     let uu____4419 =
                       ...
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.t_haseq uu____4424
                        in
                            ...
                            let uu____4490 =
                              let uu____4493 =
                                let uu____4498 =
                                  ...
                                  [uu____4499]  in
                                FStar_Syntax_Syntax.mk_Tm_app
                                  FStar_Syntax_Util.t_haseq uu____4498
                                 in
                   ...
                   let fml1 =
                       ...
                       FStar_Syntax_Syntax.Tm_meta uu____4535  in
                     {
                       ...
                       FStar_Syntax_Syntax.pos =
                         (uu___359_4533.FStar_Syntax_Syntax.pos);
                       FStar_Syntax_Syntax.vars =
                         (uu___359_4533.FStar_Syntax_Syntax.vars)
                     }  in
                   let fml2 =
                          ...
                          fun t3  ->
                            let uu____4695 =
                              let uu____4700 =
                                ...
                                [uu____4701]  in
                              FStar_Syntax_Syntax.mk_Tm_app
                                FStar_Syntax_Util.tforall uu____4700
                               in
                       ...
                       let haseq_b =
                         let uu____4887 =
                           let uu____4892 =
                             ...
                             [uu____4893]  in
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____4892
                            in
                   ...
                   fun t  ->
                     let uu____4934 =
                       let uu____4939 =
                         let uu____4940 =
                           let uu____4949 =
                             let uu____4950 = FStar_Syntax_Subst.close [b] t
                                in
                             FStar_Syntax_Util.abs
                               [((FStar_Pervasives_Native.fst b),
                         ...
                         [uu____4940]  in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____4939
                        in
        ...
        fun acc  ->
          fun ty  ->
            let lid =
              match ty.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_inductive_typ
                  (lid,uu____5089,uu____5090,uu____5091,uu____5092,uu____5093)
                  -> lid
              | uu____5102 -> failwith "Impossible!"  in
            let uu____5103 = acc  in
            match uu____5103 with
            | (uu____5140,en,uu____5142,uu____5143) ->
                let uu____5164 = get_optimized_haseq_axiom en ty usubst us
                   in
                          ...
                          let t_datas =
                            FStar_List.filter
                              (fun s  ->
                                 match s.FStar_Syntax_Syntax.sigel with
                                 | FStar_Syntax_Syntax.Sig_datacon
                                     (uu____5275,uu____5276,uu____5277,t_lid,uu____5279,uu____5280)
                                     -> t_lid = lid
      ...
      fun datas  ->
        fun env0  ->
          let us =
            ...
            match ty.FStar_Syntax_Syntax.sigel with
            | FStar_Syntax_Syntax.Sig_inductive_typ
                (uu____5363,us,uu____5365,uu____5366,uu____5367,uu____5368)
                -> us
          ...
          fun acc  ->
            fun data  ->
              let rec is_mutual t =
                ...
                | FStar_Syntax_Syntax.Tm_meta (t',uu____5644) -> is_mutual t'
                | uu____5649 -> false
              
              and exists_mutual uu___346_5650 =
                match uu___346_5650 with
                | [] -> false
              ...
              | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____5676) ->
                  ...
                  let dbs2 =
                    let uu____5756 = FStar_Syntax_Subst.opening_of_binders bs
                       in
                           ...
                           let haseq_sort =
                             let uu____5776 =
                               let uu____5781 =
                                 ...
                                 [uu____5782]  in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____5781
                                in
                         ...
                         fun t  ->
                           let uu____5826 =
                             let uu____5831 =
                               ...
                               [uu____5832]  in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____5831
                              in
              ...
              | (lid,bs,t,d_lids) ->
                  ...
                  (match uu____6009 with
                   | (bs2,t2) ->
                       let ibs =
                         let uu____6019 =
                           let uu____6020 = FStar_Syntax_Subst.compress t2
                              in
                       ...
                       let haseq_ind =
                         let uu____6159 =
                           let uu____6164 =
                             let uu____6165 = FStar_Syntax_Syntax.as_arg ind2
                                in
                             [uu____6165]  in
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____6164
                            in
                       ...
                       let t_datas =
                         FStar_List.filter
                           (fun s  ->
                              match s.FStar_Syntax_Syntax.sigel with
                              | FStar_Syntax_Syntax.Sig_datacon
                                  (uu____6203,uu____6204,uu____6205,t_lid,uu____6207,uu____6208)
                                  -> t_lid = lid
                       ...
                       let fml1 =
                             ...
                             let uu____6232 =
                               let uu____6233 =
                                 let uu____6246 =
                                   ...
                                   [uu____6257]  in
                                 [uu____6246]  in
                               FStar_Syntax_Syntax.Meta_pattern uu____6233
                                in
                             (fml, uu____6232)  in
                           FStar_Syntax_Syntax.Tm_meta uu____6225  in
                         {
                           ...
                           FStar_Syntax_Syntax.pos =
                             (uu___360_6223.FStar_Syntax_Syntax.pos);
                           FStar_Syntax_Syntax.vars =
                             (uu___360_6223.FStar_Syntax_Syntax.vars)
                         }  in
                       let fml2 =
                         FStar_List.fold_right
                           (fun b  ->
                                    ...
                                    let uu____6318 =
                                      let uu____6327 =
                                        ...
                                        FStar_Syntax_Util.abs
                                          ...
                                          FStar_Pervasives_Native.None
                                         in
                                      FStar_Syntax_Syntax.as_arg uu____6327
                                       in
                                    [uu____6318]  in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.tforall uu____6317
                                   in
                                    ...
                                    let uu____6391 =
                                      let uu____6400 =
                                        ...
                                        FStar_Syntax_Util.abs
                                          ...
                                          FStar_Pervasives_Native.None
                                         in
                                      FStar_Syntax_Syntax.as_arg uu____6400
                                       in
                                    [uu____6391]  in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.tforall uu____6390
                                   in
          ...
          let mutuals =
            FStar_List.map
              (fun ty  ->
                 match ty.FStar_Syntax_Syntax.sigel with
                 | FStar_Syntax_Syntax.Sig_inductive_typ
                     (lid,uu____6494,uu____6495,uu____6496,uu____6497,uu____6498)
                     -> lid
                 | uu____6507 -> failwith "Impossible!") tcs
             in
          let uu____6508 =
            let ty = FStar_List.hd tcs  in
            match ty.FStar_Syntax_Syntax.sigel with
               ...
               (let univs1 =
                  ...
                  then []
                    ...
                    (let uu____6744 =
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         (uu____6748,uvs,uu____6750,uu____6751,uu____6752,uu____6753)
                         -> uvs
                     | uu____6762 -> failwith "Impossible, can't happen!")
                   in
                let env0 = env  in
                let uu____6766 =
                             ...
                             (fun se  ->
                                let sigel =
                                  ...
                                  | uu____6875 ->
                                   ...
                                   in
                                let uu___361_6876 = se  in
                                {
                                  FStar_Syntax_Syntax.sigel = sigel;
                                  FStar_Syntax_Syntax.sigrng =
                                    (uu___361_6876.FStar_Syntax_Syntax.sigrng);
                                  FStar_Syntax_Syntax.sigquals =
                                    (uu___361_6876.FStar_Syntax_Syntax.sigquals);
                                  FStar_Syntax_Syntax.sigmeta =
                                    (uu___361_6876.FStar_Syntax_Syntax.sigmeta);
                                  FStar_Syntax_Syntax.sigattrs =
                                    (uu___361_6876.FStar_Syntax_Syntax.sigattrs)
                                }) tys
                            in
                         let datas1 =
                           FStar_List.map
                             (fun se  ->
                                let sigel =
                                  ...
                                  | uu____6913 ->
                                      failwith "Impossible, can't happen"
                                   in
                                let uu___362_6914 = se  in
                                {
                                  FStar_Syntax_Syntax.sigel = sigel;
                                  FStar_Syntax_Syntax.sigrng =
                                    (uu___362_6914.FStar_Syntax_Syntax.sigrng);
                                  FStar_Syntax_Syntax.sigquals =
                                    (uu___362_6914.FStar_Syntax_Syntax.sigquals);
                                  FStar_Syntax_Syntax.sigmeta =
                                    (uu___362_6914.FStar_Syntax_Syntax.sigmeta);
                                  FStar_Syntax_Syntax.sigattrs =
                                    (uu___362_6914.FStar_Syntax_Syntax.sigattrs)
                                }) datas
                            in
                         let uu____6915 =
                           FStar_TypeChecker_Env.push_univ_vars env univs2
                            in
                         (uu____6915, tys1, datas1))
                   in
                                   ...
                                   (FStar_All.pipe_right tcs1
                                      (FStar_List.iter
                                         (fun se  ->
                                            ...
                                            with
                                            | FStar_Syntax_Syntax.Sig_inductive_typ
                                                (l,univs2,binders,typ,uu____7258,uu____7259)
                                                ->
                               ...
                               let uu____7594 =
                                 let uu____7597 =
                                   ...
                                   FStar_Syntax_Syntax.mk_Tm_app uu____7602
                                     uu____7603
                                    in
                                 uu____7597 FStar_Pervasives_Native.None p
                                  in
                               FStar_Syntax_Util.b2t uu____7594  in
                             FStar_Syntax_Util.refine x uu____7591  in
                           let uu____7640 =
                             let uu___363_7641 = projectee arg_typ  in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___363_7641.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___363_7641.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort = sort
                             }  in
                           FStar_Syntax_Syntax.mk_binder uu____7640)
                         in
                           ...
                           let only_decl =
                             early_prims_inductive ||
                               (let uu____7792 =
                                ...
                                FStar_Options.dont_gen_projectors uu____7792)
                              in
                           let quals =
                             let uu____7797 =
                               FStar_List.filter
                                 (fun uu___349_7801  ->
                                    match uu___349_7801 with
                                    | FStar_Syntax_Syntax.Abstract  ->
                                        Prims.op_Negation only_decl
                                    | FStar_Syntax_Syntax.NoExtract  -> true
                                    | FStar_Syntax_Syntax.Private  -> true
                                    | uu____7802 -> false) iquals
                                in
                             FStar_List.append
                             ...
                             (let body =
                                ...
                                then FStar_Syntax_Util.exp_true_bool
                                  ...
                                  (let arg_pats =
                                   ...
                                   uu____8029 FStar_Pervasives_Native.None p)
                                 in
                              let dd =
                                let uu____8188 =
                              ...
                              let lb =
                                ...
                                FStar_Syntax_Util.mk_letbinding uu____8202
                                  ...
                                  uu____8208 [] FStar_Range.dummyRange
                                 in
                              let impl =
                                let uu____8214 =
                                  let uu____8215 =
                      ...
                      let projectors_ses =
                        let uu____8356 =
                          FStar_All.pipe_right fields
                           ...
                           in
                        FStar_All.pipe_right uu____8356 FStar_List.flatten
                         in
                            ...
                            FStar_Util.find_map tcs
                              (fun se1  ->
                                 let uu____8960 =
                                   ...
                                   FStar_Ident.lid_equals typ_lid uu____8961
                                    in
                                 if uu____8960
                                 then
                                   match se1.FStar_Syntax_Syntax.sigel with
                                   | FStar_Syntax_Syntax.Sig_inductive_typ
                                       (uu____8981,uvs',tps,typ0,uu____8985,constrs)
                                       ->
                                       FStar_Pervasives_Native.Some
                                         (tps, typ0,
                         ...
                         | (inductive_tps,typ0,should_refine) ->
                             ...
                             (match uu____9070 with
                              | (indices,uu____9088) ->
                                  ...
                                  let fv_qual =
                                    let filter_records uu___353_9135 =
                                      match uu___353_9135 with
                                      | FStar_Syntax_Syntax.RecordConstructor
                                          (uu____9138,fns) ->
                                          FStar_Pervasives_Native.Some
