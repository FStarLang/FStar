                                            ...
                                            (let uu___92_213 = s  in
                                             {
                                               ...
                                               FStar_Syntax_Syntax.sigrng =
                                                 (uu___92_213.FStar_Syntax_Syntax.sigrng);
                                               FStar_Syntax_Syntax.sigquals =
                                                 (uu___92_213.FStar_Syntax_Syntax.sigquals);
                                               FStar_Syntax_Syntax.sigmeta =
                                                 (uu___92_213.FStar_Syntax_Syntax.sigmeta);
                                               FStar_Syntax_Syntax.sigattrs =
                                                 (uu___92_213.FStar_Syntax_Syntax.sigattrs)
                                             }), u, guard)))))))))
                                       ...
                                       ((let uu____761 =
                                           let uu____762 =
                                             FStar_Syntax_Subst.compress
                                               head1
                                              in
                                           uu____762.FStar_Syntax_Syntax.n
                                            in
                                             ...
                                             FStar_Syntax_Syntax.sigel =
                                               (FStar_Syntax_Syntax.Sig_datacon
                                                  (c, [], t1, tc_lid, ntps,
                                                    []));
                                             FStar_Syntax_Syntax.sigrng =
                                               (uu___93_862.FStar_Syntax_Syntax.sigrng);
                                             FStar_Syntax_Syntax.sigquals =
                                               (uu___93_862.FStar_Syntax_Syntax.sigquals);
                                             FStar_Syntax_Syntax.sigmeta =
                                               (uu___93_862.FStar_Syntax_Syntax.sigmeta);
                                             FStar_Syntax_Syntax.sigattrs =
                                               (uu___93_862.FStar_Syntax_Syntax.sigattrs)
                                           }), g))))))))))
    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g1 =
            let uu___94_930 = g  in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___94_930.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___94_930.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (FStar_Pervasives_Native.snd
                     g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___94_930.FStar_TypeChecker_Env.implicits)
            }  in
          (let uu____940 =
                         ...
                         (match se.FStar_Syntax_Syntax.sigel with
                          | FStar_Syntax_Syntax.Sig_inductive_typ
                              ...
                              let uu____990 =
                                ...
                                FStar_All.pipe_left
                                  (FStar_Syntax_Util.arrow tps) uu____991
                                 in
                              FStar_Syntax_Syntax.null_binder uu____990
                          | uu____998 -> failwith "Impossible")))
              in
           let binders' =
             FStar_All.pipe_right datas
               (FStar_List.map
                  (fun se  ->
                     ...
                     | uu____1024 -> failwith "Impossible"))
              in
           let t =
             let uu____1028 =
                                                    ...
                                                    let uu____1261 =
                                                      let uu____1262 =
                                                        FStar_Syntax_Subst.compress
                                                          ty
                                                         in
                                                      uu____1262.FStar_Syntax_Syntax.n
                                                       in
                                                  ...
                                                  (match uu____1248 with
                                                   | (tps1,t3) ->
                                                          ...
                                                          in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.sigrng
                                                           =
                                                           (uu___95_1419.FStar_Syntax_Syntax.sigrng);
                                                         FStar_Syntax_Syntax.sigquals
                                                           =
                                                           (uu___95_1419.FStar_Syntax_Syntax.sigquals);
                                                         FStar_Syntax_Syntax.sigmeta
                                                           =
                                                           (uu___95_1419.FStar_Syntax_Syntax.sigmeta);
                                                         FStar_Syntax_Syntax.sigattrs
                                                           =
                                                           (uu___95_1419.FStar_Syntax_Syntax.sigattrs)
                                                       })
                                              | uu____1432 ->
                                                  failwith "Impossible"))
                                    tc_types tcs
                                                 ...
                                                 (match d.FStar_Syntax_Syntax.sigel
                                                  ...
                                                  | FStar_Syntax_Syntax.Sig_datacon
                                                         ...
                                                         in
                                                      {
                                                        ...
                                                        FStar_Syntax_Syntax.sigrng
                                                          =
                                                          (uu___96_1554.FStar_Syntax_Syntax.sigrng);
                                                        FStar_Syntax_Syntax.sigquals
                                                          =
                                                          (uu___96_1554.FStar_Syntax_Syntax.sigquals);
                                                        FStar_Syntax_Syntax.sigmeta
                                                          =
                                                          (uu___96_1554.FStar_Syntax_Syntax.sigmeta);
                                                        FStar_Syntax_Syntax.sigattrs
                                                          =
                                                          (uu___96_1554.FStar_Syntax_Syntax.sigattrs)
                                                      }
                                                  | uu____1557 ->
                                                      failwith "Impossible"))
                                        data_types datas
      ...
      fun unfolded  ->
        fun env  ->
          (let uu____1898 =
             ...
             Prims.strcat "Checking strict positivity in type: " uu____1899
              in
                   ...
                   (let uu____2936 =
                    ...
                    | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____2943) ->
                        ...
                        let dbs2 =
                          ...
                          FStar_Syntax_Subst.subst_binders uu____3005 dbs1
                           in
                       ...
                       let haseq_b =
                         let uu____3341 =
                           ...
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____3342
                            in
                   ...
                   fun t  ->
                     let uu____3356 =
                       let uu____3357 =
                         ...
                         [uu____3358]  in
                       FStar_Syntax_Syntax.mk_Tm_app
                         FStar_Syntax_Util.tforall uu____3357
                        in
                     ...
                     let ind =
                       ...
                       let uu____3603 =
                         FStar_List.map
                          ...
                          in
                       FStar_Syntax_Syntax.mk_Tm_uinst uu____3602 uu____3603
                        in
                     let ind1 =
                       let uu____3609 =
                         let uu____3610 =
                     ...
                     let haseq_ind =
                       let uu____3671 =
                         let uu____3672 =
                           ...
                           [uu____3673]  in
                         FStar_Syntax_Syntax.mk_Tm_app
                           FStar_Syntax_Util.t_haseq uu____3672
                          in
                            ...
                            | (uu____3714,en,uu____3716,uu____3717) ->
                                let opt =
                                  let uu____3733 =
                                    let uu____3734 =
                                      FStar_Syntax_Util.type_u ()  in
                                    FStar_Pervasives_Native.fst uu____3734
                                     in
                              ...
                              let uu____3746 =
                                let uu____3747 =
                                  let uu____3748 =
                                    ...
                                    [uu____3749]  in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.t_haseq uu____3748
                                   in
                     ...
                     let fml1 =
                         ...
                         FStar_Syntax_Syntax.Tm_meta uu____3759  in
                       {
                         ...
                         FStar_Syntax_Syntax.pos =
                           (uu___97_3757.FStar_Syntax_Syntax.pos);
                         FStar_Syntax_Syntax.vars =
                           (uu___97_3757.FStar_Syntax_Syntax.vars)
                       }  in
                     let fml2 =
                       FStar_List.fold_right
                         (fun b  ->
                            fun t3  ->
                              let uu____3794 =
                                let uu____3795 =
                                  ...
                                  [uu____3796]  in
                                FStar_Syntax_Syntax.mk_Tm_app
                                  FStar_Syntax_Util.tforall uu____3795
                                 in
                            ...
                            fun t3  ->
                              let uu____3823 =
                                let uu____3824 =
                                  ...
                                  [uu____3825]  in
                                FStar_Syntax_Syntax.mk_Tm_app
                                  FStar_Syntax_Util.tforall uu____3824
                                 in
        ...
        fun mutuals  ->
          fun acc  ->
            fun data  ->
              ...
              and exists_mutual uu___89_4268 =
                match uu___89_4268 with
                | [] -> false
                         ...
                         fun t  ->
                           let uu____4390 =
                             let uu____4391 =
                               ...
                               [uu____4392]  in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____4391
                              in
                   ...
                   | (bs2,t2) ->
                       ...
                       let haseq_ind =
                         let uu____4641 =
                           let uu____4642 =
                             ...
                             [uu____4643]  in
                           FStar_Syntax_Syntax.mk_Tm_app
                             FStar_Syntax_Util.t_haseq uu____4642
                            in
                       ...
                       let fml1 =
                             ...
                             let uu____4682 =
                               let uu____4683 =
                                 let uu____4694 =
                                   ...
                                   [uu____4697]  in
                                 [uu____4694]  in
                               FStar_Syntax_Syntax.Meta_pattern uu____4683
                                in
                             (fml, uu____4682)  in
                           FStar_Syntax_Syntax.Tm_meta uu____4675  in
                         {
                           ...
                           FStar_Syntax_Syntax.pos =
                             (uu___98_4673.FStar_Syntax_Syntax.pos);
                           FStar_Syntax_Syntax.vars =
                             (uu___98_4673.FStar_Syntax_Syntax.vars)
                         }  in
                       let fml2 =
                         FStar_List.fold_right
                           (fun b  ->
                                    ...
                                    let uu____4712 =
                                      let uu____4713 =
                                        ...
                                        FStar_Syntax_Util.abs
                                          ...
                                          FStar_Pervasives_Native.None
                                         in
                                      FStar_Syntax_Syntax.as_arg uu____4713
                                       in
                                    [uu____4712]  in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.tforall uu____4711
                                   in
                                    ...
                                    let uu____4741 =
                                      let uu____4742 =
                                        ...
                                        FStar_Syntax_Util.abs
                                          ...
                                          FStar_Pervasives_Native.None
                                         in
                                      FStar_Syntax_Syntax.as_arg uu____4742
                                       in
                                    [uu____4741]  in
                                  FStar_Syntax_Syntax.mk_Tm_app
                                    FStar_Syntax_Util.tforall uu____4740
                                   in
              ...
              FStar_List.map
                (fun ty  ->
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       -> lid
                   | uu____4846 -> failwith "Impossible!") tcs
               in
            let uu____4847 =
              let ty = FStar_List.hd tcs  in
              match ty.FStar_Syntax_Syntax.sigel with
