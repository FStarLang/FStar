                                            ...
                                            (let uu___87_146 = s in
                                             {
                                               ...
                                               FStar_Syntax_Syntax.sigrng =
                                                 (uu___87_146.FStar_Syntax_Syntax.sigrng)
                                             }), u, guard)))))))))
                                             ...
                                             FStar_Syntax_Syntax.sigel =
                                               (FStar_Syntax_Syntax.Sig_datacon
                                                  (c, [], t1, tc_lid, ntps,
                                                    quals, []));
                                             FStar_Syntax_Syntax.sigrng =
                                               (uu___88_547.FStar_Syntax_Syntax.sigrng)
                                           }), g))))))))))
    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g1 =
            let uu___89_589 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___89_589.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___89_589.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (Prims.snd g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___89_589.FStar_TypeChecker_Env.implicits)
            } in
          (let uu____595 =
                                                  ...
                                                  (match uu____783 with
                                                   | (tps1,t3) ->
                                                       let uu___90_902 = se in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.sigrng
                                                           =
                                                           (uu___90_902.FStar_Syntax_Syntax.sigrng)
                                                       })
                                              | uu____911 ->
                                                  failwith "Impossible"))
                                    tc_types tcs in
                                                 ...
                                                 (match d.FStar_Syntax_Syntax.sigel
                                                  ...
                                                  | FStar_Syntax_Syntax.Sig_datacon
                                                      ...
                                                      let uu___91_976 = d in
                                                      {
                                                        ...
                                                        FStar_Syntax_Syntax.sigrng
                                                          =
                                                          (uu___91_976.FStar_Syntax_Syntax.sigrng)
                                                      }
                                                  | uu____979 ->
                                                      failwith "Impossible"))
                                        data_types datas in
  ...
  | (lid,bs,t,d_lids) ->
      ...
      (match uu____2151 with
       | (bs2,t2) ->
           ...
           let fml1 =
             let uu___92_2302 = fml in
             let uu____2305 =
               let uu____2306 =
                 let uu____2311 =
                   let uu____2312 =
                     let uu____2319 =
                       let uu____2321 = FStar_Syntax_Syntax.as_arg haseq_ind in
                       [uu____2321] in
                     [uu____2319] in
               ...
               FStar_Syntax_Syntax.Tm_meta uu____2306 in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___92_2302.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___92_2302.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___92_2302.FStar_Syntax_Syntax.vars)
             } in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2335 =
                      let uu____2336 =
                        let uu____2337 =
                          let uu____2338 =
                            let uu____2339 = FStar_Syntax_Subst.close [b] t3 in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              uu____2339 None in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2336 in
                    uu____2335 None FStar_Range.dummyRange) ibs1 fml1 in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2361 =
                      let uu____2362 =
                        let uu____2363 =
                          let uu____2364 =
                            let uu____2365 = FStar_Syntax_Subst.close [b] t3 in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              uu____2365 None in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2362 in
                    uu____2361 None FStar_Range.dummyRange) bs2 fml2 in
          ...
          fun acc  ->
            fun data  ->
              let rec is_mutual t =
                ...
                | uu____2686 -> false
              and exists_mutual uu___84_2687 =
                match uu___84_2687 with
                | [] -> false
              ...
              | FStar_Syntax_Syntax.Tm_arrow (dbs,uu____2711) ->
                  ...
                  let dbs2 =
                    let uu____2748 = FStar_Syntax_Subst.opening_of_binders bs in
                           ...
                           let haseq_sort =
                             let uu____2760 =
                               let uu____2761 =
                                 ...
                                 [uu____2762] in
                               FStar_Syntax_Syntax.mk_Tm_app
                                 FStar_Syntax_Util.t_haseq uu____2761 in
                               ...
                               let uu____2781 =
                                 let uu____2782 =
                                   ...
                                   FStar_Syntax_Util.abs
                                     [((Prims.fst b), None)] uu____2783 None in
                                 FStar_Syntax_Syntax.as_arg uu____2782 in
                               [uu____2781] in
                             FStar_Syntax_Syntax.mk_Tm_app
                               FStar_Syntax_Util.tforall uu____2780 in
                           uu____2779 None FStar_Range.dummyRange) dbs3 cond in
  ...
  | (lid,bs,t,d_lids) ->
      ...
      (match uu____2891 with
       | (bs2,t2) ->
               ...
               let uu____2933 =
                 FStar_List.map
                   (fun uu____2938  ->
                      ...
                      | (bv,aq) ->
                          let uu____2945 = FStar_Syntax_Syntax.bv_to_name bv in
                          (uu____2945, aq)) bs2 in
               ...
               let uu____2954 =
                 FStar_List.map
                   (fun uu____2959  ->
                      ...
                      | (bv,aq) ->
                          let uu____2966 = FStar_Syntax_Syntax.bv_to_name bv in
                          (uu____2966, aq)) ibs1 in
           ...
           let fml1 =
             let uu___93_3003 = fml in
             let uu____3006 =
               let uu____3007 =
                 let uu____3012 =
                   let uu____3013 =
                     let uu____3020 =
                       let uu____3022 = FStar_Syntax_Syntax.as_arg haseq_ind in
                       [uu____3022] in
                     [uu____3020] in
               ...
               FStar_Syntax_Syntax.Tm_meta uu____3007 in
             {
               ...
               FStar_Syntax_Syntax.tk = (uu___93_3003.FStar_Syntax_Syntax.tk);
               FStar_Syntax_Syntax.pos =
                 (uu___93_3003.FStar_Syntax_Syntax.pos);
               FStar_Syntax_Syntax.vars =
                 (uu___93_3003.FStar_Syntax_Syntax.vars)
             } in
           let fml2 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____3036 =
                      let uu____3037 =
                        let uu____3038 =
                          let uu____3039 =
                            let uu____3040 = FStar_Syntax_Subst.close [b] t3 in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              uu____3040 None in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3037 in
                    uu____3036 None FStar_Range.dummyRange) ibs1 fml1 in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____3062 =
                      let uu____3063 =
                        let uu____3064 =
                          let uu____3065 =
                            let uu____3066 = FStar_Syntax_Subst.close [b] t3 in
                            FStar_Syntax_Util.abs [((Prims.fst b), None)]
                              uu____3066 None in
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____3063 in
                    uu____3062 None FStar_Range.dummyRange) bs2 fml2 in
              ...
              FStar_List.map
                (fun ty  ->
                   ...
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       ...
                       -> lid
                   | uu____3147 -> failwith "Impossible!") tcs in
            let uu____3148 =
              let ty = FStar_List.hd tcs in
              match ty.FStar_Syntax_Syntax.sigel with
              | FStar_Syntax_Syntax.Sig_inductive_typ
          ...
          | (tys,datas) ->
              ((let uu____3257 =
                ...
                then
                  let uu____3272 =
                    let uu____3273 =
                      let uu____3276 = FStar_TypeChecker_Env.get_range env in
