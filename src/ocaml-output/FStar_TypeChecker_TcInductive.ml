                              ...
                              (match uu____93 with
                               | (t,guard) ->
                                   let k =
                                     ...
                                     FStar_Syntax_Util.arrow indices _0_194
                                      in
                                   let uu____114 =
        ...
        fun datas  ->
          ...
          (let binders =
                         ...
                         (match se with
                          | FStar_Syntax_Syntax.Sig_inductive_typ
                              ...
                              FStar_Syntax_Syntax.null_binder
                                (let _0_214 = FStar_Syntax_Syntax.mk_Total k
                                    in
                                 FStar_All.pipe_left
           ...
           (let uu____592 =
            ...
            if uu____592
            then
              let _0_216 = FStar_TypeChecker_Normalize.term_to_string env t
                 in
              FStar_Util.print1
                    ...
                    let _0_219 =
                      let _0_217 =
                        FStar_All.pipe_right uvs
                         ...
                         in
                      FStar_All.pipe_right _0_217 (FStar_String.concat ", ")
                       in
             ...
             ((debug_log env "ty does occur in this type, pressing ahead";
               (let uu____1072 =
                    ...
                    (debug_log env
                     ...
                     FStar_List.for_all
                       (fun uu____1194  ->
                          ...
                          | (p,uu____1202,t) ->
                              let bs =
                                let _0_230 = FStar_Syntax_Syntax.pat_bvs p
                                   in
                ...
                | uu____1239 ->
                    ((let _0_236 =
                        let _0_235 =
                          let _0_234 = FStar_Syntax_Print.tag_of_term btype
                             in
                          let _0_233 =
                            let _0_232 =
                     ...
                     (let uu____1258 =
                      ...
                      then
                        ...
                        (let num_ibs =
                         ...
                         (let _0_243 =
                            let _0_242 =
                              let _0_241 = FStar_Util.string_of_int num_ibs
                                 in
                              Prims.strcat _0_241
                       ...
                       (FStar_List.iter2
                        ...
                        (let dt =
                           FStar_TypeChecker_Normalize.normalize
                            ...
                            in
                         (let _0_250 =
                            let _0_249 = FStar_Syntax_Print.term_to_string dt
                               in
                            Prims.strcat
                                    ...
                                    let c =
                                      let _0_252 =
                                        FStar_Syntax_Subst.opening_of_binders
                                          ibs
                                         in
                                      FStar_Syntax_Subst.subst_comp _0_252 c
                                       in
                                    let uu____1366 =
              ...
              | (univ_unif_vars,dt) ->
                  (FStar_List.iter2
                   ...
                   (let _0_265 =
                      ...
                      Prims.strcat "Checking data constructor type: " _0_264
                       in
             ...
             FStar_List.filter
               (fun b  ->
                  ...
                  | (uu____2003,en,uu____2005,uu____2006) ->
                      let opt =
                        let _0_290 = Prims.fst (FStar_Syntax_Util.type_u ())
                           in
                        FStar_TypeChecker_Rel.try_subtype' en
                          (Prims.fst b).FStar_Syntax_Syntax.sort _0_290 false
                         in
                      (match opt with
                       | None  -> false
               ...
               FStar_Syntax_Syntax.Tm_meta
                 (let _0_296 =
                    FStar_Syntax_Syntax.Meta_pattern
                      (let _0_295 =
                         let _0_294 = FStar_Syntax_Syntax.as_arg haseq_ind
                            in
                         [_0_294]  in
                       [_0_295])
                     in
               ...
               (fun b  ->
                  fun t  ->
                    (let _0_300 =
                       ...
                       [_0_299]  in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_300) None FStar_Range.dummyRange) ibs fml
              in
           let fml =
             FStar_List.fold_right
               (fun b  ->
                  fun t  ->
                    (let _0_303 =
                       ...
                       [_0_302]  in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_303) None FStar_Range.dummyRange) bs fml
              in
             ...
             let _0_326 =
               FStar_Syntax_Syntax.Tm_meta
                 (let _0_325 =
                    FStar_Syntax_Syntax.Meta_pattern
                      (let _0_324 =
                         let _0_323 = FStar_Syntax_Syntax.as_arg haseq_ind
                            in
                         [_0_323]  in
                       [_0_324])
                     in
               ...
               (fun b  ->
                  fun t  ->
                    (let _0_329 =
                       ...
                       [_0_328]  in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_329) None FStar_Range.dummyRange) ibs fml
              in
           let fml =
             FStar_List.fold_right
               (fun b  ->
                  fun t  ->
                    (let _0_332 =
                       ...
                       [_0_331]  in
                     FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                       _0_332) None FStar_Range.dummyRange) bs fml
              in
                             ...
                             (FStar_List.append lid.FStar_Ident.ns
                                [FStar_Ident.id_of_text
                                   (Prims.strcat
                                      ...
                                      "_haseq")])
                            in
                         tc_assume env _0_333 fml [] FStar_Range.dummyRange
                          in
                       (env.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.pop
                         "haseq";
                       [se])))
