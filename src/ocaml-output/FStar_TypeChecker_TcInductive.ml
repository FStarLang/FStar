...
let uu___84_547 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((c), ([]), (t1), (tc_lid), (ntps), (quals), ([]))); FStar_Syntax_Syntax.sigrng = uu___84_547.FStar_Syntax_Syntax.sigrng})), (g))));
)
end));
)
end))
...
let uu___85_589 = g
in {FStar_TypeChecker_Env.guard_f = uu___85_589.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = uu___85_589.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = ((tc_universe_vars), ((Prims.snd g.FStar_TypeChecker_Env.univ_ineqs))); FStar_TypeChecker_Env.implicits = uu___85_589.FStar_TypeChecker_Env.implicits})
in ((
...
let uu___86_902 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (((tc), (uvs1), (tps1), (t3), (mutuals), (datas1), (quals))); FStar_Syntax_Syntax.sigrng = uu___86_902.FStar_Syntax_Syntax.sigrng})
end)))
end
| uu____911 -> begin
(failwith "Impossible")
...
let tc_insts = (FStar_All.pipe_right tcs1 (FStar_List.map (fun uu___79_932 -> (match (uu___79_932) with
...
let uu___87_976 = d
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (((l), (uvs1), (ty), (tc), (ntps), (quals), (mutuals))); FStar_Syntax_Syntax.sigrng = uu___87_976.FStar_Syntax_Syntax.sigrng}))
end
| uu____979 -> begin
(failwith "Impossible")
end)
...
let uu____2317 = (FStar_Syntax_Syntax.as_arg haseq_ind)
in (uu____2317)::[])
in (uu____2315)::[])
in FStar_Syntax_Syntax.Meta_pattern (uu____2308))
in ((fml), (uu____2307)))
in FStar_Syntax_Syntax.Tm_meta (uu____2302))
in {FStar_Syntax_Syntax.n = uu____2301; FStar_Syntax_Syntax.tk = uu___88_2300.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___88_2300.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___88_2300.FStar_Syntax_Syntax.vars}))
in (
...
let uu____2333 = (FStar_Syntax_Subst.close ((b)::[]) t3)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) uu____2333 None))
in (FStar_Syntax_Syntax.as_arg uu____2332))
in (uu____2331)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____2330))
in (uu____2329 None FStar_Range.dummyRange))) ibs1 fml1)
in (
...
let uu____2359 = (FStar_Syntax_Subst.close ((b)::[]) t3)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) uu____2359 None))
in (FStar_Syntax_Syntax.as_arg uu____2358))
in (uu____2357)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____2356))
in (uu____2355 None FStar_Range.dummyRange))) bs2 fml2)
in (
...
| FStar_Syntax_Syntax.Sig_datacon (uu____2413, uu____2414, uu____2415, t_lid, uu____2417, uu____2418, uu____2419) -> begin
(t_lid = lid)
end
| uu____2424 -> begin
(failwith "Impossible")
...
let uu____2428 = (optimized_haseq_soundness_for_data lid d usubst bs2)
in (FStar_Syntax_Util.mk_conj acc1 uu____2428))) FStar_Syntax_Util.t_true t_datas)
in (

let axiom_lid = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns (((FStar_Ident.id_of_text (Prims.strcat lid.FStar_Ident.ident.FStar_Ident.idText "_haseq")))::[])))
in (

let uu____2430 = (FStar_Syntax_Util.mk_conj guard' guard)
in (

let uu____2433 = (FStar_Syntax_Util.mk_conj cond' cond)
in (((FStar_List.append l_axioms ((((axiom_lid), (fml3)))::[]))), (env2), (uu____2430), (uu____2433)))))))))
end)))))))))))))))
end))))
end)))
...
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____2499, us, uu____2501, uu____2502, uu____2503, uu____2504, uu____2505) -> begin
us
end
| uu____2512 -> begin
(failwith "Impossible!")
...
let uu____2513 = (FStar_Syntax_Subst.univ_var_opening us)
...
let uu____2529 = (FStar_List.fold_left (optimized_haseq_ty datas usubst us1) (([]), (env1), (FStar_Syntax_Util.t_true), (FStar_Syntax_Util.t_true)) tcs)
...
let uu____2561 = (FStar_TypeChecker_TcTerm.tc_trivial_guard env2 phi)
in (match (uu____2561) with
| (phi1, uu____2566) -> begin
((

let uu____2568 = (FStar_TypeChecker_Env.should_verify env2)
in (match (uu____2568) with
| true -> begin
(

let uu____2569 = (FStar_TypeChecker_Rel.guard_of_guard_formula (FStar_TypeChecker_Common.NonTrivial (phi1)))
in (FStar_TypeChecker_Rel.force_trivial_guard env2 uu____2569))
end
| uu____2570 -> begin
()
end));
...
let ses = (FStar_List.fold_left (fun l uu____2577 -> (match (uu____2577) with
| (lid, fml) -> begin
(
...
let uu____2621 = (FStar_Syntax_Subst.compress t)
...
| FStar_Syntax_Syntax.Tm_uinst (t', uu____2631) -> begin
(is_mutual t')
end
...
let uu____2660 = (FStar_List.map Prims.fst args)
in (exists_mutual uu____2660))
end))
end
| FStar_Syntax_Syntax.Tm_meta (t', uu____2673) -> begin
(is_mutual t')
end
| uu____2678 -> begin
false
end)))
and exists_mutual = (fun uu___80_2679 -> (match (uu___80_2679) with
| [] -> begin
false
end
| (hd1)::tl1 -> begin
...
let uu____2697 = (FStar_Syntax_Subst.compress dt1)
in uu____2697.FStar_Syntax_Syntax.n)
in (match (uu____2696) with
| FStar_Syntax_Syntax.Tm_arrow (dbs, uu____2703) -> begin
(

let dbs1 = (

let uu____2718 = (FStar_List.splitAt (FStar_List.length bs) dbs)
in (Prims.snd uu____2718))
in (

let dbs2 = (

let uu____2740 = (FStar_Syntax_Subst.opening_of_binders bs)
in (FStar_Syntax_Subst.subst_binders uu____2740 dbs1))
in (
...
let uu____2754 = (FStar_Syntax_Syntax.as_arg (Prims.fst b).FStar_Syntax_Syntax.sort)
in (uu____2754)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq uu____2753))
in (uu____2752 None FStar_Range.dummyRange))
in (

let haseq_sort1 = (

let uu____2760 = (is_mutual sort)
...
let uu____2771 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) uu____2771 None))
in (FStar_Syntax_Syntax.as_arg uu____2770))
in (uu____2769)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____2768))
in (uu____2767 None FStar_Range.dummyRange))) dbs3 cond)
...
let uu____2831 = (match (ty.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, uu____2843, bs, t, uu____2846, d_lids, uu____2848) -> begin
((lid), (bs), (t), (d_lids))
end
| uu____2856 -> begin
(failwith "Impossible!")
...
let uu____2872 = (FStar_Syntax_Subst.shift_subst (FStar_List.length bs1) usubst)
in (FStar_Syntax_Subst.subst uu____2872 t))
in (

let uu____2879 = (FStar_Syntax_Subst.open_term bs1 t1)
...
let uu____2891 = (FStar_Syntax_Subst.compress t2)
in uu____2891.FStar_Syntax_Syntax.n)
in (match (uu____2890) with
| FStar_Syntax_Syntax.Tm_arrow (ibs, uu____2898) -> begin
ibs
end
| uu____2909 -> begin
[]
...
let uu____2914 = (FStar_Syntax_Syntax.fvar lid FStar_Syntax_Syntax.Delta_constant None)
in (

let uu____2915 = (FStar_List.map (fun u -> FStar_Syntax_Syntax.U_name (u)) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____2914 uu____2915)))
in (
...
let uu____2921 = (FStar_List.map (fun uu____2926 -> (match (uu____2926) with
| (bv, aq) -> begin
(

let uu____2933 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((uu____2933), (aq)))
end)) bs2)
in (FStar_Syntax_Syntax.mk_Tm_app ind uu____2921))
in (uu____2920 None FStar_Range.dummyRange))
in (
...
let uu____2942 = (FStar_List.map (fun uu____2947 -> (match (uu____2947) with
| (bv, aq) -> begin
(

let uu____2954 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((uu____2954), (aq)))
end)) ibs1)
in (FStar_Syntax_Syntax.mk_Tm_app ind1 uu____2942))
in (uu____2941 None FStar_Range.dummyRange))
in (
...
let uu____2964 = (FStar_Syntax_Syntax.as_arg ind2)
in (uu____2964)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq uu____2963))
in (uu____2962 None FStar_Range.dummyRange))
in (

let t_datas = (FStar_List.filter (fun s -> (match (s.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_datacon (uu____2972, uu____2973, uu____2974, t_lid, uu____2976, uu____2977, uu____2978) -> begin
(t_lid = lid)
end
| uu____2983 -> begin
(failwith "Impossible")
...
let uu____3006 = (FStar_Syntax_Syntax.as_arg haseq_ind)
in (uu____3006)::[])
in (uu____3004)::[])
in FStar_Syntax_Syntax.Meta_pattern (uu____2997))
in ((fml), (uu____2996)))
in FStar_Syntax_Syntax.Tm_meta (uu____2991))
in {FStar_Syntax_Syntax.n = uu____2990; FStar_Syntax_Syntax.tk = uu___89_2989.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___89_2989.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___89_2989.FStar_Syntax_Syntax.vars}))
in (
...
let uu____3022 = (FStar_Syntax_Subst.close ((b)::[]) t3)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) uu____3022 None))
in (FStar_Syntax_Syntax.as_arg uu____3021))
in (uu____3020)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____3019))
in (uu____3018 None FStar_Range.dummyRange))) ibs1 fml1)
in (
...
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) uu____3048 None))
in (FStar_Syntax_Syntax.as_arg uu____3047))
in (uu____3046)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall uu____3045))
in (uu____3044 None FStar_Range.dummyRange))) bs2 fml2)
...
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, uu____3117, uu____3118, uu____3119, uu____3120, uu____3121, uu____3122) -> begin
lid
end
| uu____3129 -> begin
(failwith "Impossible!")
...
let ty = (FStar_List.hd tcs)
in (match (ty.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, us, uu____3138, uu____3139, uu____3140, uu____3141, uu____3142) -> begin
((lid), (us))
end
| uu____3149 -> begin
(failwith "Impossible!")
...
let uu____3155 = (FStar_Syntax_Subst.univ_var_opening us)
...
let uu____3173 = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns (((FStar_Ident.id_of_text (Prims.strcat lid.FStar_Ident.ident.FStar_Ident.idText "_haseq")))::[])))
in (tc_assume env1 uu____3173 fml [] FStar_Range.dummyRange))
...
let uu____3203 = (FStar_All.pipe_right ses (FStar_List.partition (fun uu___81_3213 -> (match (uu___81_3213) with
| {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (uu____3214); FStar_Syntax_Syntax.sigrng = uu____3215} -> begin
true
end
| uu____3226 -> begin
false
...
let uu____3239 = (FStar_All.pipe_right datas (FStar_Util.for_some (fun uu___82_3241 -> (match (uu___82_3241) with
| {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (uu____3242); FStar_Syntax_Syntax.sigrng = uu____3243} -> begin
false
end
| uu____3253 -> begin
true
...
let uu____3258 = (FStar_TypeChecker_Env.get_range env)
in (("Mutually defined type contains a non-inductive element"), (uu____3258)))
...
let uu____3261 = (FStar_List.fold_right (fun tc uu____3275 -> (match (uu____3275) with
| (env1, all_tcs, g) -> begin
(

let uu____3297 = (tc_tycon env1 tc)
...
let uu____3314 = (FStar_TypeChecker_Env.debug env2 FStar_Options.Low)
in (match (uu____3314) with
| true -> begin
(

let uu____3315 = (FStar_Syntax_Print.sigelt_to_string tc1)
...
let uu____3318 = (FStar_TypeChecker_Rel.conj_guard guard g')
in (FStar_TypeChecker_Rel.conj_guard g uu____3318))
in ((env2), ((((tc1), (tc_u)))::all_tcs), (uu____3317)));
))
end))
...
let uu____3343 = (FStar_List.fold_right (fun se uu____3351 -> (match (uu____3351) with
| (datas1, g1) -> begin
(

let uu____3362 = (

let uu____3365 = (tc_data env1 tcs)
in (uu____3365 se))
in (match (uu____3362) with
| (data, g') -> begin
(

let uu____3375 = (FStar_TypeChecker_Rel.conj_guard g1 g')
in (((data)::datas1), (uu____3375)))
end))
end)) datas (([]), (g)))
...
let uu____3387 = (generalize_and_inst_within env0 g1 tcs datas1)
...
let uu____3404 = (FStar_TypeChecker_Env.get_range env0)
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_bundle ((((FStar_List.append tcs1 datas2)), (quals), (lids))); FStar_Syntax_Syntax.sigrng = uu____3404})
