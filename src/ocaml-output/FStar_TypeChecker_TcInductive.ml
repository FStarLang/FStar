                                                ...
                                                (let uu___362_440 = s  in
                                                 {
                                                   ...
                                                   FStar_Syntax_Syntax.sigrng
                                                     =
                                                     (uu___362_440.FStar_Syntax_Syntax.sigrng);
                                                   FStar_Syntax_Syntax.sigquals
                                                     =
                                                     (uu___362_440.FStar_Syntax_Syntax.sigquals);
                                                   FStar_Syntax_Syntax.sigmeta
                                                     =
                                                     (uu___362_440.FStar_Syntax_Syntax.sigmeta);
                                                   FStar_Syntax_Syntax.sigattrs
                                                     =
                                                     (uu___362_440.FStar_Syntax_Syntax.sigattrs)
                                                 }), u, guard1)))))))))
                                                  ...
                                                  (let g_uvs =
                                                   ...
                                                   ((let uu___363_1409 = se
                                                        in
                                                     {
                                                       ...
                                                       FStar_Syntax_Syntax.sigrng
                                                         =
                                                         (uu___363_1409.FStar_Syntax_Syntax.sigrng);
                                                       FStar_Syntax_Syntax.sigquals
                                                         =
                                                         (uu___363_1409.FStar_Syntax_Syntax.sigquals);
                                                       FStar_Syntax_Syntax.sigmeta
                                                         =
                                                         (uu___363_1409.FStar_Syntax_Syntax.sigmeta);
                                                       FStar_Syntax_Syntax.sigattrs
                                                         =
                                                         (uu___363_1409.FStar_Syntax_Syntax.sigattrs)
                                                     }), g))))))))))))
    ...
    fun g  ->
      fun tcs  ->
        fun datas  ->
          ...
          let g1 =
            let uu___364_1477 = g  in
            {
              FStar_TypeChecker_Env.guard_f =
                (uu___364_1477.FStar_TypeChecker_Env.guard_f);
              FStar_TypeChecker_Env.deferred =
                (uu___364_1477.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (tc_universe_vars,
                  (FStar_Pervasives_Native.snd
                     g.FStar_TypeChecker_Env.univ_ineqs));
              FStar_TypeChecker_Env.implicits =
                (uu___364_1477.FStar_TypeChecker_Env.implicits)
            }  in
          (let uu____1487 =
                                                  ...
                                                  (match uu____1865 with
                                                   | (tps1,t3) ->
                                                          ...
                                                          in
                                                       {
                                                         ...
                                                         FStar_Syntax_Syntax.sigrng
                                                           =
                                                           (uu___365_2006.FStar_Syntax_Syntax.sigrng);
                                                         FStar_Syntax_Syntax.sigquals
                                                           =
                                                           (uu___365_2006.FStar_Syntax_Syntax.sigquals);
                                                         FStar_Syntax_Syntax.sigmeta
                                                           =
                                                           (uu___365_2006.FStar_Syntax_Syntax.sigmeta);
                                                         FStar_Syntax_Syntax.sigattrs
                                                           =
                                                           (uu___365_2006.FStar_Syntax_Syntax.sigattrs)
                                                       })
                                              | uu____2011 ->
                                                  failwith "Impossible"))
                                    tc_types tcs
                                                 ...
                                                 (match d.FStar_Syntax_Syntax.sigel
                                                  ...
                                                  | FStar_Syntax_Syntax.Sig_datacon
                                                         ...
                                                         in
                                                      {
                                                        ...
                                                        FStar_Syntax_Syntax.sigrng
                                                          =
                                                          (uu___366_2115.FStar_Syntax_Syntax.sigrng);
                                                        FStar_Syntax_Syntax.sigquals
                                                          =
                                                          (uu___366_2115.FStar_Syntax_Syntax.sigquals);
                                                        FStar_Syntax_Syntax.sigmeta
                                                          =
                                                          (uu___366_2115.FStar_Syntax_Syntax.sigmeta);
                                                        FStar_Syntax_Syntax.sigattrs
                                                          =
                                                          (uu___366_2115.FStar_Syntax_Syntax.sigattrs)
                                                      }
                                                  | uu____2118 ->
                                                      failwith "Impossible"))
                                        data_types datas
               ...
               | (bs2,t2) ->
                   ...
                   let fml1 =
                       ...
                       FStar_Syntax_Syntax.Tm_meta uu____4723  in
                     {
                       ...
                       FStar_Syntax_Syntax.pos =
                         (uu___367_4721.FStar_Syntax_Syntax.pos);
                       FStar_Syntax_Syntax.vars =
                         (uu___367_4721.FStar_Syntax_Syntax.vars)
                     }  in
                   let fml2 =
        ...
        fun mutuals  ->
          fun acc  ->
            fun data  ->
              ...
              and exists_mutual uu___354_5893 =
                match uu___354_5893 with
                | [] -> false
                   ...
                   | (bs2,t2) ->
                       ...
                       let fml1 =
                           ...
                           FStar_Syntax_Syntax.Tm_meta uu____6468  in
                         {
                           ...
                           FStar_Syntax_Syntax.pos =
                             (uu___368_6466.FStar_Syntax_Syntax.pos);
                           FStar_Syntax_Syntax.vars =
                             (uu___368_6466.FStar_Syntax_Syntax.vars)
                         }  in
                       let fml2 =
                         FStar_List.fold_right
                           (fun b  ->
                             ...
                             (fun se  ->
                                let sigel =
                                  ...
                                  | uu____7118 ->
                                   ...
                                   in
                                let uu___369_7119 = se  in
                                {
                                  FStar_Syntax_Syntax.sigel = sigel;
                                  FStar_Syntax_Syntax.sigrng =
                                    (uu___369_7119.FStar_Syntax_Syntax.sigrng);
                                  FStar_Syntax_Syntax.sigquals =
                                    (uu___369_7119.FStar_Syntax_Syntax.sigquals);
                                  FStar_Syntax_Syntax.sigmeta =
                                    (uu___369_7119.FStar_Syntax_Syntax.sigmeta);
                                  FStar_Syntax_Syntax.sigattrs =
                                    (uu___369_7119.FStar_Syntax_Syntax.sigattrs)
                                }) tys
                            in
                         let datas1 =
                           FStar_List.map
                             (fun se  ->
                                let sigel =
                                  ...
                                  | uu____7156 ->
                                      failwith "Impossible, can't happen"
                                   in
                                let uu___370_7157 = se  in
                                {
                                  FStar_Syntax_Syntax.sigel = sigel;
                                  FStar_Syntax_Syntax.sigrng =
                                    (uu___370_7157.FStar_Syntax_Syntax.sigrng);
                                  FStar_Syntax_Syntax.sigquals =
                                    (uu___370_7157.FStar_Syntax_Syntax.sigquals);
                                  FStar_Syntax_Syntax.sigmeta =
                                    (uu___370_7157.FStar_Syntax_Syntax.sigmeta);
                                  FStar_Syntax_Syntax.sigattrs =
                                    (uu___370_7157.FStar_Syntax_Syntax.sigattrs)
                                }) datas
                            in
                         let uu____7158 =
                      ...
                      let arg_binder =
                        ...
                        then unrefined_arg_binder
                          ...
                          (let disc_name =
                           ...
                           let uu____7883 =
                             let uu___371_7884 = projectee arg_typ  in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___371_7884.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___371_7884.FStar_Syntax_Syntax.index);
                         ...
                         | (inductive_tps,typ0,should_refine) ->
                             ...
                             (match uu____9313 with
                              | (indices,uu____9331) ->
                                  ...
                                  let fv_qual =
                                    let filter_records uu___361_9378 =
                                      match uu___361_9378 with
                                      | FStar_Syntax_Syntax.RecordConstructor
                                          (uu____9381,fns) ->
                                          FStar_Pervasives_Native.Some
