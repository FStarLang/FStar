                  ...
                  | (uu____2225,en,uu____2227,uu____2228) ->
                      let opt =
                        ...
                        FStar_TypeChecker_Rel.try_subtype' en
                          (fst b).FStar_Syntax_Syntax.sort uu____2237 false
                         in
                      (match opt with
                       | None  -> false
                       | Some uu____2241 -> true)) bs2
              in
           let haseq_bs =
             FStar_List.fold_left
               (fun t3  ->
                  ...
                  fun t3  ->
                    let uu____2287 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2288
                       in
                    uu____2287 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2313 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2314
                       in
                    uu____2313 None FStar_Range.dummyRange) bs2 fml2
              in
                         ...
                         fun t  ->
                           let uu____2719 =
                             ...
                             FStar_Syntax_Syntax.mk_Tm_app
                              ...
                              in
                           uu____2719 None FStar_Range.dummyRange) dbs3 cond
                     in
                  ...
                  fun t3  ->
                    let uu____2964 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2965
                       in
                    uu____2964 None FStar_Range.dummyRange) ibs1 fml1
              in
           let fml3 =
             FStar_List.fold_right
               (fun b  ->
                  fun t3  ->
                    let uu____2990 =
                      ...
                      FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall
                        uu____2991
                       in
                    uu____2990 None FStar_Range.dummyRange) bs2 fml2
              in
