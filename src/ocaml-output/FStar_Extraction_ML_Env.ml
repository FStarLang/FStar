...
let tyscheme_of_td = (fun _72_62 -> (match (_72_62) with
| (_72_59, vars, body_opt) -> begin
(match (body_opt) with
...
let lookup_ty_const : env  ->  FStar_Extraction_ML_Syntax.mlpath  ->  FStar_Extraction_ML_Syntax.mltyscheme Prims.option = (fun env _72_71 -> (match (_72_71) with
| (module_name, ty_name) -> begin
(FStar_Util.find_map env.tydefs (fun _72_74 -> (match (_72_74) with
| (m, tds) -> begin
...
let _72_233 = (FStar_Extraction_ML_Syntax.mlpath_of_lident f)
