      ...
      fun tactic  ->
        fun env  ->
          fun typ  ->
            ...
            let uu___ = FStar_Tactics_Basic.proofstate_of_goal_ty rng env typ
               in
            match uu___ with
            | (ps,w) ->
                let uu___1 =
...
let comb1 : 'a 'b . ('a -> 'b) -> 'a tres_m -> 'b tres_m =
  fun f  ->
    fun uu___  ->
      ...
      | Simplified (t,gs) ->
          let uu___1 = let uu___2 = f t  in (uu___2, gs)  in
          Simplified uu___1
      | Dual (tn,tp,gs) ->
          let uu___1 =
            let uu___2 = f tn  in let uu___3 = f tp  in (uu___2, uu___3, gs)
             in
          Dual uu___1
    ...
    fun x  ->
      fun y  ->
        ...
        | (Simplified (t1,gs1),Simplified (t2,gs2)) ->
            let uu___ =
              let uu___1 = f t1 t2  in (uu___1, (FStar_List.append gs1 gs2))
               in
            Simplified uu___
        | uu___ ->
...
let emit : 'a . FStar_Tactics_Types.goal Prims.list -> 'a tres_m -> 'a tres_m
  =
  fun gs  ->
    fun m  -> comb2 (fun uu___  -> fun x  -> x) (Simplified ((), gs)) m
          ...
          let r =
            ...
            | FStar_Syntax_Syntax.Tm_app
                ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
                   ...
                   FStar_Syntax_Syntax.vars = uu___2;_},(p,uu___3)::(q,uu___4)::[])
                when
                     ...
                     (match uu___6 with
                      | (pn,pp,gs1) ->
                          ...
                          (match uu___7 with
                           | (qn,qp,gs2) ->
                               let t1 =
                                 let uu___8 = FStar_Syntax_Util.mk_imp pn qp
                                    in
                                 let uu___9 = FStar_Syntax_Util.mk_imp qn pp
                                    in
  ...
  fun env  ->
    fun goal  ->
      ...
      (let initial = (Prims.int_one, [])  in
       ...
       match uu___2 with
       | (t',gs) ->
           ((let uu___4 = FStar_ST.op_Bang FStar_Tactics_Interpreter.tacdbg
                in
             if uu___4
             then
               let uu___5 =
                      ...
                      | (n,gs1) ->
                          let phi =
                            let uu___5 =
                              ...
                              let uu___7 = FStar_Tactics_Types.goal_type g
                                 in
                          ...
                          ((let uu___6 =
                            ...
                            then
                              ...
                              let uu___8 =
                                let uu___9 = FStar_Tactics_Types.goal_type g
                                   in
                           ...
                           (let label =
                              let uu___6 =
                                let uu___7 = FStar_Tactics_Types.get_label g
                                   in
                                uu___7 = ""  in
                              if uu___6
                              then
                                ...
                                (let uu___8 =
                                   let uu___9 = FStar_Util.string_of_int n
                                      in
                                   let uu___10 =
                                     let uu___11 =
                                       let uu___12 =
                                 ...
                                 Prims.op_Hat "Could not prove goal #" uu___8)
                               in
                            let gt' =
                            ...
                            let uu___6 =
                              let uu___7 =
                                let uu___8 = FStar_Tactics_Types.goal_env g
                                   in
                                (uu___8, gt', (g.FStar_Tactics_Types.opts))
                                 in
                              uu___7 :: gs1  in
                            ((n + Prims.int_one), uu___6)))) s gs
                in
             let uu___4 = s1  in
             match uu___4 with
             | (uu___5,gs1) ->
                 ...
                 let uu___6 =
                   let uu___7 = FStar_Options.peek ()  in (env, t', uu___7)
                    in
                 uu___6 :: gs2)))
                 ...
                 (fun g  ->
                    ...
                    | FStar_Pervasives_Native.Some vc ->
                        ((let uu___5 =
                          ...
                          if uu___5
                          then
                            let uu___6 = FStar_Syntax_Print.term_to_string vc
                               in
                            FStar_Util.print1 "Synthesis left a goal: %s\n"
                              uu___6
                          else ());
           ...
           (let typ = FStar_Syntax_Syntax.t_decls  in
            ...
            let uu___2 =
              ...
              FStar_Tactics_Interpreter.run_tactic_on_ps
                ...
                FStar_Syntax_Embeddings.e_unit () uu___3 tau ps
               in
            match uu___2 with
            | (gs,sigelts) ->
                ((let uu___4 =
                  ...
                  (match uu___4 with
                   | (gs,w) ->
                       (FStar_List.iter
                          (fun g  ->
                             let uu___6 =
                               let uu___7 = FStar_Tactics_Types.goal_env g
                                  in
                               let uu___8 = FStar_Tactics_Types.goal_type g
                                  in
                               getprop uu___7 uu___8  in
                             match uu___6 with
                             | FStar_Pervasives_Native.Some vc ->
