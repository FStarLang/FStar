...
let uu___is_Const_effect: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_effect  -> true | uu____86 -> false
let uu___is_Const_unit: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_unit  -> true | uu____90 -> false
let uu___is_Const_bool: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_bool _0 -> true | uu____95 -> false
...
let uu___is_Const_int: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_int _0 -> true | uu____117 -> false
...
let uu___is_Const_char: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_char _0 -> true | uu____159 -> false
...
let uu___is_Const_bytearray: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_bytearray _0 -> true | uu____198 -> false
...
let uu___is_Const_string: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_string _0 -> true | uu____232 -> false
...
let uu___is_Const_range_of: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_range_of  -> true | uu____255 -> false
let uu___is_Const_set_range_of: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_set_range_of  -> true | uu____259 -> false
let uu___is_Const_range: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_range _0 -> true | uu____264 -> false
...
let uu___is_Const_reflect: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_reflect _0 -> true | uu____280 -> false
  ...
  fun c1  ->
    fun c2  ->
      ...
      | (Const_int (s1,o1),Const_int (s2,o2)) ->
          (let uu____326 = FStar_Util.ensure_decimal s1 in
           let uu____327 = FStar_Util.ensure_decimal s2 in
           uu____326 = uu____327) && (o1 = o2)
      | (Const_bytearray (a,uu____335),Const_bytearray (b,uu____337)) ->
          a = b
      | (Const_string (a,uu____349),Const_string (b,uu____351)) -> a = b
      | (Const_reflect l1,Const_reflect l2) -> FStar_Ident.lid_equals l1 l2
      | uu____354 -> c1 = c2
let rec pow2: FStar_BigInt.bigint -> FStar_BigInt.bigint =
  fun x  ->
    let uu____362 = FStar_BigInt.eq_big_int x FStar_BigInt.zero in
    if uu____362
    then FStar_BigInt.one
    else
      (let uu____364 =
         let uu____365 = FStar_BigInt.pred_big_int x in pow2 uu____365 in
       FStar_BigInt.mult_big_int FStar_BigInt.two uu____364)
let bounds:
  signedness ->
    width ->
  ...
  fun signedness  ->
    fun width  ->
      ...
      let uu____377 =
        ...
        | Unsigned  ->
            let uu____386 =
              let uu____387 = pow2 n1 in FStar_BigInt.pred_big_int uu____387 in
            (FStar_BigInt.zero, uu____386)
        | Signed  ->
            let upper =
              let uu____389 = FStar_BigInt.pred_big_int n1 in pow2 uu____389 in
            let uu____390 = FStar_BigInt.minus_big_int upper in
            let uu____391 = FStar_BigInt.pred_big_int upper in
            (uu____390, uu____391) in
      match uu____377 with | (lower,upper) -> (lower, upper)
let within_bounds: Prims.string -> signedness -> width -> Prims.bool =
  fun repr  ->
    fun signedness  ->
      fun width  ->
        let uu____407 = bounds signedness width in
        match uu____407 with
        | (lower,upper) ->
            let value =
              let uu____415 = FStar_Util.ensure_decimal repr in
              FStar_BigInt.big_int_of_string uu____415 in
