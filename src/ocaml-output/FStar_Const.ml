...
let uu___is_Const_effect: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_effect  -> true | uu____95 -> false
...
let uu___is_Const_bool: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_bool _0 -> true | uu____106 -> false
...
let uu___is_Const_int: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_int _0 -> true | uu____130 -> false
...
let uu___is_Const_char: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_char _0 -> true | uu____174 -> false
...
let uu___is_Const_float: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_float _0 -> true | uu____200 -> false
...
let uu___is_Const_bytearray: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_bytearray _0 -> true | uu____220 -> false
...
let uu___is_Const_string: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_string _0 -> true | uu____256 -> false
...
let uu___is_Const_range: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_range _0 -> true | uu____282 -> false
...
let uu___is_Const_reify: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_reify  -> true | uu____295 -> false
let uu___is_Const_reflect: sconst -> Prims.bool =
  fun projectee  ->
    match projectee with | Const_reflect _0 -> true | uu____301 -> false
  ...
  fun c1  ->
    fun c2  ->
      ...
      | (Const_int (s1,o1),Const_int (s2,o2)) ->
          (let uu____350 = FStar_Util.ensure_decimal s1 in
           let uu____351 = FStar_Util.ensure_decimal s2 in
           uu____350 = uu____351) && (o1 = o2)
      | (Const_bytearray (a,uu____359),Const_bytearray (b,uu____361)) ->
          a = b
      | (Const_string (a,uu____373),Const_string (b,uu____375)) -> a = b
