...
let (uu___is_Const_int : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_int _0 -> true | uu____202 -> false
...
let (uu___is_Const_char : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_char _0 -> true | uu____255 -> false
...
let (uu___is_Const_float : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_float _0 -> true | uu____277 -> false
...
let (uu___is_Const_real : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_real _0 -> true | uu____297 -> false
...
let (uu___is_Const_bytearray : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_bytearray _0 -> true | uu____326 -> false
...
let (uu___is_Const_string : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_string _0 -> true | uu____371 -> false
...
let (uu___is_Const_range_of : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_range_of -> true | uu____404 -> false
let (uu___is_Const_set_range_of : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_set_range_of -> true | uu____415 -> false
let (uu___is_Const_range : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_range _0 -> true | uu____427 -> false
...
let (uu___is_Const_reify : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_reify -> true | uu____445 -> false
let (uu___is_Const_reflect : sconst -> Prims.bool) =
  fun projectee ->
    match projectee with | Const_reflect _0 -> true | uu____457 -> false
  ...
  fun c1 ->
    fun c2 ->
      ...
      | (Const_int (s1, o1), Const_int (s2, o2)) ->
          (let uu____515 = FStar_Util.ensure_decimal s1 in
           let uu____517 = FStar_Util.ensure_decimal s2 in
           uu____515 = uu____517) && (o1 = o2)
      | (Const_bytearray (a, uu____527), Const_bytearray (b, uu____529)) ->
          a = b
  ...
  fun signedness1 ->
    fun width1 ->
      ...
      let uu____594 =
        ...
        | Unsigned ->
            let uu____603 =
              let uu____604 = pow2 n in FStar_BigInt.pred_big_int uu____604 in
            (FStar_BigInt.zero, uu____603)
        | Signed ->
            let upper =
              let uu____606 = FStar_BigInt.pred_big_int n in pow2 uu____606 in
