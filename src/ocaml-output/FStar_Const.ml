...
let uu____340 = (FStar_Util.ensure_decimal s1)
in (

let uu____341 = (FStar_Util.ensure_decimal s2)
in (uu____340 = uu____341))) && (o1 = o2))
end
| (Const_bytearray (a, uu____349), Const_bytearray (b, uu____351)) -> begin
(a = b)
end
| (Const_string (a, uu____363), Const_string (b, uu____365)) -> begin
(a = b)
end
...
let uu____388 = (pow2 (x - (Prims.parse_int "1")))
in ((Prims.parse_int "2") * uu____388))
end))
...
let uu____402 = (match (signedness) with
| Unsigned -> begin
(

let uu____411 = (

let uu____412 = (pow2 n1)
in (uu____412 - (Prims.parse_int "1")))
in (((Prims.parse_int "0")), (uu____411)))
end
| Signed -> begin
(
