...
let (uu___is_Unsigned : signedness -> Prims.bool) =
  fun projectee -> match projectee with | Unsigned -> true | uu____6 -> false
let (uu___is_Signed : signedness -> Prims.bool) =
  fun projectee -> match projectee with | Signed -> true | uu____12 -> false
type width =
  | Int8 
  | Int16 
  | Int32 
  ...
  fun signedness ->
    fun width ->
      ...
      let uu____433 =
        ...
        | Unsigned ->
            let uu____442 =
              let uu____443 = pow2 n1 in FStar_BigInt.pred_big_int uu____443 in
            (FStar_BigInt.zero, uu____442)
        | Signed ->
            let upper =
              let uu____445 = FStar_BigInt.pred_big_int n1 in pow2 uu____445 in
