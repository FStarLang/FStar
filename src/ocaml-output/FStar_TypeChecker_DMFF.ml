            ...
            let a1 =
                 ...
                 in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___100_123.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___100_123.FStar_Syntax_Syntax.index);
                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____2126  in
                          {
                            ...
                            FStar_Syntax_Syntax.pos =
                              (uu___101_2124.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___101_2124.FStar_Syntax_Syntax.vars)
                          }  in
                        mk_rel1 t2 x y
                    ...
                    let uu____2855 =
                         ...
                         in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___102_2856.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___102_2856.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___102_2856.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___102_2856.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___102_2856.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___102_2856.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___102_2856.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___102_2856.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___102_2856.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___102_2856.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___102_2856.FStar_Syntax_Syntax.actions);
                        FStar_Syntax_Syntax.eff_attrs =
                          (uu___102_2856.FStar_Syntax_Syntax.eff_attrs)
                      }  in
...
let (set_env : env -> FStar_TypeChecker_Env.env -> env) =
  fun dmff_env  ->
    fun env'  ->
      let uu___103_2906 = dmff_env  in
      {
        env = env';
        subst = (uu___103_2906.subst);
        tc_const = (uu___103_2906.tc_const)
      }
    ...
    fun t  ->
          ...
          let binders1 =
            FStar_List.map
              (fun uu____3209  ->
                 ...
                 | (bv,aqual) ->
                     let uu____3220 =
                       let uu___104_3221 = bv  in
                       let uu____3222 =
                         star_type' env bv.FStar_Syntax_Syntax.sort  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___104_3221.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___104_3221.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,repr,something) ->
          ...
          (match uu____3746 with
           | (binders1,repr1) ->
               let env1 =
                 let uu___107_3754 = env  in
                 let uu____3755 =
                   FStar_TypeChecker_Env.push_binders env.env binders1  in
                 {
                   env = uu____3755;
                   subst = (uu___107_3754.subst);
                   tc_const = (uu___107_3754.tc_const)
                 }  in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___108_3775 = x1  in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___108_3775.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___108_3775.FStar_Syntax_Syntax.index);
...
let (is_monadic :
  ...
  =
  fun uu___92_4274  ->
    match uu___92_4274 with
    | FStar_Pervasives_Native.None  -> failwith "un-annotated lambda?!"
    | FStar_Pervasives_Native.Some rc ->
        FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
          (FStar_Util.for_some
             (fun uu___91_4281  ->
                match uu___91_4281 with
                | FStar_Syntax_Syntax.CPS  -> true
                | uu____4282 -> false))
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___94_4882 =
            match uu___94_4882 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,rc_opt) ->
                ...
                let uu____5378 =
                    ...
                    FStar_Pervasives_Native.Some uu____5385  in
                  {
                    FStar_Syntax_Syntax.residual_effect =
                      (uu___109_5379.FStar_Syntax_Syntax.residual_effect);
                    FStar_Syntax_Syntax.residual_typ = uu____5380;
                    FStar_Syntax_Syntax.residual_flags =
                      (uu___109_5379.FStar_Syntax_Syntax.residual_flags)
                  }  in
          ...
          let env1 =
            let uu___110_5396 = env  in
            let uu____5397 =
              FStar_TypeChecker_Env.push_binders env.env binders1  in
            {
              env = uu____5397;
              subst = (uu___110_5396.subst);
              tc_const = (uu___110_5396.tc_const)
            }  in
          let s_binders =
            FStar_List.map
              (fun uu____5417  ->
                 ...
                 | (bv,qual) ->
                     let sort = star_type' env1 bv.FStar_Syntax_Syntax.sort
                        in
                     ((let uu___111_5430 = bv  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___111_5430.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___111_5430.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1
             in
          let uu____5431 =
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___112_5519.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___112_5519.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____5520
                           }  in
                         let env3 =
                           let uu___113_5525 = env2  in
                           let uu____5526 =
                             let uu____5529 =
                               let uu____5530 =
                                 let uu____5537 =
                           ...
                           {
                             env = (uu___113_5525.env);
                             subst = uu____5526;
                             tc_const = (uu___113_5525.tc_const)
                           }  in
                         let uu____5538 =
                         ...
                         (let x =
                            let uu___114_5550 = bv  in
                            let uu____5551 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___114_5550.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___114_5550.FStar_Syntax_Syntax.index);
                           ...
                           | FStar_Pervasives_Native.Some rt ->
                               ...
                               then
                                 ...
                                 (let uu____5698 =
                                    ...
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___115_5699.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ =
                                        uu____5700;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___115_5699.FStar_Syntax_Syntax.residual_flags)
                                    }  in
                    ...
                    (fun b  ->
                       ...
                       | (pat,FStar_Pervasives_Native.None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____8096;
                               subst = (uu___116_8095.subst);
                               tc_const = (uu___116_8095.tc_const)
                             }  in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____9166 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____9188  in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___117_9184.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___117_9184.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____9185;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___117_9184.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___117_9184.FStar_Syntax_Syntax.lbdef);
                           FStar_Syntax_Syntax.lbattrs =
                             (uu___117_9184.FStar_Syntax_Syntax.lbattrs);
                           FStar_Syntax_Syntax.lbpos =
                             (uu___117_9184.FStar_Syntax_Syntax.lbpos)
                         }
                       else binding  in
                     let env1 =
                       let uu___118_9191 = env  in
                       let uu____9192 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___119_9194 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___119_9194.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___119_9194.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         env = uu____9192;
                         subst = (uu___118_9191.subst);
                         tc_const = (uu___118_9191.tc_const)
                       }  in
                     let uu____9195 = proceed env1 e21  in
                     (match uu____9195 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___120_9212 = binding  in
                            let uu____9213 =
                              star_type' env1
                            ...
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___120_9212.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___120_9212.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____9213;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___120_9212.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___120_9212.FStar_Syntax_Syntax.lbdef);
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___120_9212.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___120_9212.FStar_Syntax_Syntax.lbpos)
                            }  in
                          let uu____9216 =
                            let uu____9219 =
                              let uu____9220 =
                                let uu____9233 =
                                  FStar_Syntax_Subst.close x_binders1 s_e2
                                   in
                                ((false,
                                   [(let uu___121_9243 = s_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___121_9243.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___121_9243.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___121_9243.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___121_9243.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = s_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___121_9243.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___121_9243.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____9233)
                                 in
                              ...
                              let uu____9248 =
                                let uu____9261 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___122_9271 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___122_9271.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___122_9271.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___122_9271.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___122_9271.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___122_9271.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___122_9271.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____9261)
                                 in
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___123_9280 = binding  in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___123_9280.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___123_9280.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Parser_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___123_9280.FStar_Syntax_Syntax.lbdef);
                         FStar_Syntax_Syntax.lbattrs =
                           (uu___123_9280.FStar_Syntax_Syntax.lbattrs);
                         FStar_Syntax_Syntax.lbpos =
                           (uu___123_9280.FStar_Syntax_Syntax.lbpos)
                       }  in
                     let env1 =
                       let uu___124_9282 = env  in
                       let uu____9283 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___125_9285 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___125_9285.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___125_9285.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         env = uu____9283;
                         subst = (uu___124_9282.subst);
                         tc_const = (uu___124_9282.tc_const)
                       }  in
                              ...
                              let uu____9407 =
                                let uu____9420 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___126_9430 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___126_9430.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___126_9430.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___126_9430.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___126_9430.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___126_9430.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___126_9430.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____9420)
                                 in
