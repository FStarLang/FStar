                    ...
                    let uu____2736 =
                         ...
                         in
                      {
                        ...
                        FStar_Syntax_Syntax.mname =
                          (uu___77_2737.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___77_2737.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___77_2737.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___77_2737.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___77_2737.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___77_2737.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___77_2737.FStar_Syntax_Syntax.repr);
...
let (is_monadic :
  ...
  =
  fun uu___67_4094  ->
    match uu___67_4094 with
    | FStar_Pervasives_Native.None  -> failwith "un-annotated lambda?!"
    | FStar_Pervasives_Native.Some rc ->
        FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
          (FStar_Util.for_some
             (fun uu___66_4101  ->
                match uu___66_4101 with
                | FStar_Syntax_Syntax.CPS  -> true
                | uu____4102 -> false))
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___69_4622 =
            match uu___69_4622 with
        ...
        | FStar_Syntax_Syntax.Tm_quoted uu____4759 ->
            let uu____4766 = infer env e  in return_if uu____4766
        | FStar_Syntax_Syntax.Tm_app uu____4773 ->
            let uu____4788 = infer env e  in return_if uu____4788
        | FStar_Syntax_Syntax.Tm_lazy i ->
            let uu____4796 = FStar_Syntax_Util.unfold_lazy i  in
            check env uu____4796 context_nm
        ...
        | FStar_Syntax_Syntax.Tm_meta (e1,uu____4858) ->
            check env e1 context_nm
        | FStar_Syntax_Syntax.Tm_uinst (e1,uu____4864) ->
            check env e1 context_nm
        | FStar_Syntax_Syntax.Tm_ascribed (e1,uu____4870,uu____4871) ->
            check env e1 context_nm
        | FStar_Syntax_Syntax.Tm_let uu____4912 ->
            let uu____4925 =
              let uu____4926 = FStar_Syntax_Print.term_to_string e  in
              FStar_Util.format1 "[check]: Tm_let %s" uu____4926  in
            failwith uu____4925
        | FStar_Syntax_Syntax.Tm_type uu____4933 ->
            failwith "impossible (DM stratification)"
        | FStar_Syntax_Syntax.Tm_arrow uu____4940 ->
            failwith "impossible (DM stratification)"
        | FStar_Syntax_Syntax.Tm_refine uu____4959 ->
            let uu____4966 =
              let uu____4967 = FStar_Syntax_Print.term_to_string e  in
              FStar_Util.format1 "[check]: Tm_refine %s" uu____4967  in
            failwith uu____4966
        | FStar_Syntax_Syntax.Tm_uvar uu____4974 ->
            let uu____4991 =
              let uu____4992 = FStar_Syntax_Print.term_to_string e  in
              FStar_Util.format1 "[check]: Tm_uvar %s" uu____4992  in
            failwith uu____4991
        | FStar_Syntax_Syntax.Tm_delayed uu____4999 ->
            failwith "impossible (compressed)"
        | FStar_Syntax_Syntax.Tm_unknown  ->
            let uu____5030 =
              let uu____5031 = FStar_Syntax_Print.term_to_string e  in
              FStar_Util.format1 "[check]: Tm_unknown %s" uu____5031  in
            failwith uu____5030
...
and (infer :
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_lazy i ->
          let uu____5074 = FStar_Syntax_Util.unfold_lazy i  in
          infer env uu____5074
      | FStar_Syntax_Syntax.Tm_abs (binders,body,rc_opt) ->
          let subst_rc_opt subst1 rc_opt1 =
            match rc_opt1 with
            | FStar_Pervasives_Native.Some
                { FStar_Syntax_Syntax.residual_effect = uu____5117;
                  FStar_Syntax_Syntax.residual_typ =
                    FStar_Pervasives_Native.None ;
                  FStar_Syntax_Syntax.residual_flags = uu____5118;_}
                -> rc_opt1
            | FStar_Pervasives_Native.None  -> rc_opt1
            | FStar_Pervasives_Native.Some rc ->
                let uu____5124 =
                  let uu___84_5125 = rc  in
                  let uu____5126 =
                    let uu____5131 =
                      let uu____5132 =
                        FStar_Util.must rc.FStar_Syntax_Syntax.residual_typ
                         in
                      FStar_Syntax_Subst.subst subst1 uu____5132  in
                    FStar_Pervasives_Native.Some uu____5131  in
                  {
                    FStar_Syntax_Syntax.residual_effect =
                      (uu___84_5125.FStar_Syntax_Syntax.residual_effect);
                    FStar_Syntax_Syntax.residual_typ = uu____5126;
                    FStar_Syntax_Syntax.residual_flags =
                      (uu___84_5125.FStar_Syntax_Syntax.residual_flags)
                  }  in
          ...
          let env1 =
            let uu___85_5142 = env  in
            let uu____5143 =
              FStar_TypeChecker_Env.push_binders env.env binders1  in
            {
              env = uu____5143;
              subst = (uu___85_5142.subst);
              tc_const = (uu___85_5142.tc_const)
            }  in
          let s_binders =
            FStar_List.map
              (fun uu____5163  ->
                 ...
                 | (bv,qual) ->
                     let sort = star_type' env1 bv.FStar_Syntax_Syntax.sort
                        in
                     ((let uu___86_5176 = bv  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___86_5176.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___86_5176.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1
             in
          let uu____5177 =
            FStar_List.fold_left
              (fun uu____5206  ->
                 fun uu____5207  ->
                   match (uu____5206, uu____5207) with
                   | ((env2,acc),(bv,qual)) ->
                       let c = bv.FStar_Syntax_Syntax.sort  in
                       let uu____5255 = is_C c  in
                       if uu____5255
                       then
                         let xw =
                           let uu____5263 = star_type' env2 c  in
                           FStar_Syntax_Syntax.gen_bv
                            ...
                            in
                         let x =
                           let uu___87_5265 = bv  in
                           let uu____5266 =
                             let uu____5269 =
                               FStar_Syntax_Syntax.bv_to_name xw  in
                             trans_F_ env2 c uu____5269  in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___87_5265.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___87_5265.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____5266
                           }  in
                         let env3 =
                           let uu___88_5271 = env2  in
                           let uu____5272 =
                             let uu____5275 =
                               let uu____5276 =
                                 let uu____5283 =
                                   FStar_Syntax_Syntax.bv_to_name xw  in
                                 (bv, uu____5283)  in
                               FStar_Syntax_Syntax.NT uu____5276  in
                             uu____5275 :: (env2.subst)  in
                           {
                             env = (uu___88_5271.env);
                             subst = uu____5272;
                             tc_const = (uu___88_5271.tc_const)
                           }  in
                         let uu____5284 =
                           let uu____5287 = FStar_Syntax_Syntax.mk_binder x
                              in
                           let uu____5288 =
                             let uu____5291 =
                         ...
                         (let x =
                            let uu___89_5296 = bv  in
                            let uu____5297 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___89_5296.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___89_5296.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = uu____5297
                            }  in
                          let uu____5300 =
                            let uu____5303 = FStar_Syntax_Syntax.mk_binder x
                               in
                            uu____5303 :: acc  in
                          (env2, uu____5300))) (env1, []) binders1
             in
          (match uu____5177 with
           | (env2,u_binders) ->
               ...
               let uu____5323 =
                 let check_what =
                   let uu____5341 = is_monadic rc_opt1  in
                   if uu____5341 then check_m else check_n  in
                 let uu____5353 = check_what env2 body1  in
                 match uu____5353 with
                 | (t,s_body,u_body) ->
                     let uu____5369 =
                       let uu____5370 =
                         let uu____5371 = is_monadic rc_opt1  in
                         if uu____5371 then M t else N t  in
                       comp_of_nm uu____5370  in
                     (uu____5369, s_body, u_body)
                  in
                          ...
                          (match rc.FStar_Syntax_Syntax.residual_typ with
                           ...
                           | FStar_Pervasives_Native.Some rt ->
                               ...
                               then
                                 ...
                                 let uu____5430 =
                                   let uu____5431 =
                                     let uu____5436 = double_star rt  in
                                 ...
                                 (let uu____5438 =
                                    let uu___90_5439 = rc  in
                                    let uu____5440 =
                                      let uu____5445 = star_type' env2 rt  in
                                      FStar_Pervasives_Native.Some uu____5445
                                       in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___90_5439.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ =
                                        uu____5440;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___90_5439.FStar_Syntax_Syntax.residual_flags)
                                    }  in
                                  FStar_Pervasives_Native.Some uu____5438))
                       in
                    let uu____5446 =
                      let comp1 =
                        let uu____5456 = is_monadic rc_opt1  in
                        let uu____5457 =
                               ...
                               let uu____5518 =
                                 let uu____5521 =
                                   FStar_Syntax_Subst.closing_of_binders
                                     s_binders1
                                    in
                                 subst_rc_opt uu____5521 s_rc_opt  in
                               (s_binders1, s_body1, uu____5518)  in
                             FStar_Syntax_Syntax.Tm_abs uu____5501  in
                           mk1 uu____5500  in
                         let u_body2 =
                               ...
                               let uu____5549 =
                                 let uu____5552 =
                                   FStar_Syntax_Subst.closing_of_binders
                                     u_binders2
                                    in
                                 subst_rc_opt uu____5552 u_rc_opt  in
                               (u_binders2, u_body2, uu____5549)  in
                             FStar_Syntax_Syntax.Tm_abs uu____5532  in
                           mk1 uu____5531  in
                         ((N t), s_term, u_term))))
      | FStar_Syntax_Syntax.Tm_fvar
          {
            FStar_Syntax_Syntax.fv_name =
              { FStar_Syntax_Syntax.v = lid;
                FStar_Syntax_Syntax.p = uu____5562;_};
            FStar_Syntax_Syntax.fv_delta = uu____5563;
            FStar_Syntax_Syntax.fv_qual = uu____5564;_}
          ->
          let uu____5567 =
            let uu____5572 = FStar_TypeChecker_Env.lookup_lid env.env lid  in
            FStar_All.pipe_left FStar_Pervasives_Native.fst uu____5572  in
          (match uu____5567 with
           | (uu____5603,t) ->
               let uu____5605 =
                 let uu____5606 = normalize1 t  in N uu____5606  in
               (uu____5605, e, e))
      | FStar_Syntax_Syntax.Tm_app
          ({
             FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_range_of );
             FStar_Syntax_Syntax.pos = uu____5607;
             FStar_Syntax_Syntax.vars = uu____5608;_},a::hd1::rest)
          ->
          let rest1 = hd1 :: rest  in
          let uu____5671 = FStar_Syntax_Util.head_and_args e  in
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.pos = uu____5752;
             FStar_Syntax_Syntax.vars = uu____5753;_},a1::a2::hd1::rest)
          ->
          let rest1 = hd1 :: rest  in
          let uu____5829 = FStar_Syntax_Util.head_and_args e  in
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_range_of );
             FStar_Syntax_Syntax.pos = uu____5916;
             FStar_Syntax_Syntax.vars = uu____5917;_},(a,FStar_Pervasives_Native.None
                                                       )::[])
          ->
          let uu____5955 = infer env a  in
          (match uu____5955 with
           | (t,s,u) ->
               let uu____5971 = FStar_Syntax_Util.head_and_args e  in
                ...
                | (head1,uu____5993) ->
                    ...
                    let uu____6016 =
                      let uu____6019 =
                        let uu____6020 =
                          let uu____6035 =
                            let uu____6038 = FStar_Syntax_Syntax.as_arg s  in
                            [uu____6038]  in
                          (head1, uu____6035)  in
                        FStar_Syntax_Syntax.Tm_app uu____6020  in
                      mk1 uu____6019  in
                    let uu____6043 =
                      let uu____6046 =
                        let uu____6047 =
                          let uu____6062 =
                            let uu____6065 = FStar_Syntax_Syntax.as_arg u  in
                            [uu____6065]  in
                          (head1, uu____6062)  in
                        FStar_Syntax_Syntax.Tm_app uu____6047  in
                      mk1 uu____6046  in
                    (uu____6014, uu____6016, uu____6043)))
      | FStar_Syntax_Syntax.Tm_app
          ({
             FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_set_range_of );
             FStar_Syntax_Syntax.pos = uu____6074;
             FStar_Syntax_Syntax.vars = uu____6075;_},(a1,uu____6077)::a2::[])
          ->
          let uu____6119 = infer env a1  in
          (match uu____6119 with
           | (t,s,u) ->
               let uu____6135 = FStar_Syntax_Util.head_and_args e  in
                ...
                | (head1,uu____6157) ->
                    let uu____6178 =
                      let uu____6181 =
                        let uu____6182 =
                          let uu____6197 =
                            let uu____6200 = FStar_Syntax_Syntax.as_arg s  in
                            [uu____6200; a2]  in
                          (head1, uu____6197)  in
                        FStar_Syntax_Syntax.Tm_app uu____6182  in
                      mk1 uu____6181  in
                    let uu____6217 =
                      let uu____6220 =
                        let uu____6221 =
                          let uu____6236 =
                            let uu____6239 = FStar_Syntax_Syntax.as_arg u  in
                            [uu____6239; a2]  in
                          (head1, uu____6236)  in
                        FStar_Syntax_Syntax.Tm_app uu____6221  in
                      mk1 uu____6220  in
                    (t, uu____6178, uu____6217)))
      | FStar_Syntax_Syntax.Tm_app
          ({
             FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_range_of );
          ...
          let uu____6283 =
            let uu____6288 =
              let uu____6289 = FStar_Syntax_Print.term_to_string e  in
              FStar_Util.format1 "DMFF: Ill-applied constant %s" uu____6289
               in
            (FStar_Errors.Fatal_IllAppliedConstant, uu____6288)  in
          FStar_Errors.raise_error uu____6283 e.FStar_Syntax_Syntax.pos
      | FStar_Syntax_Syntax.Tm_app
          ({
             FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_set_range_of );
             FStar_Syntax_Syntax.pos = uu____6296;
             FStar_Syntax_Syntax.vars = uu____6297;_},uu____6298)
          ->
          let uu____6319 =
            let uu____6324 =
              let uu____6325 = FStar_Syntax_Print.term_to_string e  in
              FStar_Util.format1 "DMFF: Ill-applied constant %s" uu____6325
               in
            (FStar_Errors.Fatal_IllAppliedConstant, uu____6324)  in
          FStar_Errors.raise_error uu____6319 e.FStar_Syntax_Syntax.pos
      | FStar_Syntax_Syntax.Tm_app (head1,args) ->
          let uu____6354 = check_n env head1  in
          (match uu____6354 with
           | (t_head,s_head,u_head) ->
               let is_arrow t =
                 let uu____6374 =
                   let uu____6375 = FStar_Syntax_Subst.compress t  in
                   uu____6375.FStar_Syntax_Syntax.n  in
                 match uu____6374 with
                 | FStar_Syntax_Syntax.Tm_arrow uu____6378 -> true
                 | uu____6391 -> false  in
               let rec flatten1 t =
                 let uu____6408 =
                   let uu____6409 = FStar_Syntax_Subst.compress t  in
                   uu____6409.FStar_Syntax_Syntax.n  in
                 match uu____6408 with
                 | FStar_Syntax_Syntax.Tm_arrow
                     (binders,{
                                FStar_Syntax_Syntax.n =
                                  FStar_Syntax_Syntax.Total (t1,uu____6426);
                                FStar_Syntax_Syntax.pos = uu____6427;
                                FStar_Syntax_Syntax.vars = uu____6428;_})
                     when is_arrow t1 ->
                     let uu____6453 = flatten1 t1  in
                     (match uu____6453 with
                      | (binders',comp) ->
                          ((FStar_List.append binders binders'), comp))
                 | FStar_Syntax_Syntax.Tm_arrow (binders,comp) ->
                     (binders, comp)
                 | FStar_Syntax_Syntax.Tm_ascribed (e1,uu____6535,uu____6536)
                     -> flatten1 e1
                 | uu____6577 ->
                     let uu____6578 =
                       let uu____6583 =
                         ...
                         FStar_Util.format1 "%s: not a function type"
                           uu____6584
                          in
                       (FStar_Errors.Fatal_NotFunctionType, uu____6583)  in
                     FStar_Errors.raise_err uu____6578
                  in
               let uu____6597 = flatten1 t_head  in
                ...
                | (binders,comp) ->
                    ...
                    (if
                     ...
                     then
                       (let uu____6657 =
                          let uu____6662 =
                            let uu____6663 = FStar_Util.string_of_int n1  in
                            let uu____6670 =
                              FStar_Util.string_of_int (n' - n1)  in
                            let uu____6681 = FStar_Util.string_of_int n1  in
                            FStar_Util.format3
                              "The head of this application, after being applied to %s arguments, is an effectful computation (leaving %s arguments to be applied). Please let-bind the head applied to the %s first arguments."
                              uu____6663 uu____6670 uu____6681
                             in
                          (FStar_Errors.Fatal_BinderAndArgsLengthMismatch,
                            uu____6662)
                           in
                        FStar_Errors.raise_err uu____6657)
                     else ();
                     (let uu____6689 =
                        FStar_Syntax_Subst.open_comp binders comp  in
                      match uu____6689 with
                      | (binders1,comp1) ->
                          let rec final_type subst1 uu____6730 args1 =
                                     ...
                                     let uu____6804 =
                                       let uu____6805 =
                                         FStar_Syntax_Subst.subst_comp subst1
                                           comp2
                                          in
                                       uu____6805.FStar_Syntax_Syntax.n  in
                                     nm_of_comp uu____6804
                                 | (binders3,[]) ->
                                     let uu____6835 =
                                       let uu____6836 =
                                         let uu____6839 =
                                              ...
                                              let uu____6867 =
                                                let uu____6880 =
                                                  FStar_Syntax_Subst.close_comp
                                                    binders4 comp3
                                                   in
                                                (binders4, uu____6880)  in
                                              FStar_Syntax_Syntax.Tm_arrow
                                                uu____6867
                                               in
                                            mk1 uu____6866  in
                                          N uu____6865
                                      | uu____6887 -> failwith "wat?")
                                 | ([],uu____6888::uu____6889) ->
                                     failwith "just checked that?!"
                                 | ((bv,uu____6929)::binders3,(arg,uu____6932)::args2)
                                     ->
                                     final_type
                          ...
                          let uu____6985 = FStar_List.splitAt n' binders1  in
                               ...
                               let uu____7042 =
                                 let uu____7063 =
                                   FStar_List.map2
                                     (fun uu____7117  ->
                                        fun uu____7118  ->
                                          match (uu____7117, uu____7118) with
                                          | ((bv,uu____7156),(arg,q)) ->
                                              let uu____7173 =
                                                let uu____7174 =
                                                  FStar_Syntax_Subst.compress
                                     ...
                                     binders2 args
                                    in
                                 FStar_List.split uu____7063  in
                                    ...
                                    let uu____7380 =
                                      mk1
                                        (FStar_Syntax_Syntax.Tm_app
                                           (u_head, u_args1))
                                       in
                                    (final_type1, uu____7371, uu____7380)))))))
      | FStar_Syntax_Syntax.Tm_let ((false ,binding::[]),e2) ->
          mk_let env binding e2 infer check_m
      | FStar_Syntax_Syntax.Tm_match (e0,branches) ->
          mk_match env e0 branches infer
      | FStar_Syntax_Syntax.Tm_uinst (e1,uu____7448) -> infer env e1
      | FStar_Syntax_Syntax.Tm_meta (e1,uu____7454) -> infer env e1
      | FStar_Syntax_Syntax.Tm_ascribed (e1,uu____7460,uu____7461) ->
          infer env e1
      | FStar_Syntax_Syntax.Tm_constant c ->
          let uu____7503 = let uu____7504 = env.tc_const c  in N uu____7504
             in
          (uu____7503, e, e)
      | FStar_Syntax_Syntax.Tm_quoted (tm,qt) ->
          ((N FStar_Syntax_Syntax.t_term), e, e)
      | FStar_Syntax_Syntax.Tm_let uu____7511 ->
          let uu____7524 =
            let uu____7525 = FStar_Syntax_Print.term_to_string e  in
            FStar_Util.format1 "[infer]: Tm_let %s" uu____7525  in
          failwith uu____7524
      | FStar_Syntax_Syntax.Tm_type uu____7532 ->
          failwith "impossible (DM stratification)"
      | FStar_Syntax_Syntax.Tm_arrow uu____7539 ->
          failwith "impossible (DM stratification)"
      | FStar_Syntax_Syntax.Tm_refine uu____7558 ->
          let uu____7565 =
            let uu____7566 = FStar_Syntax_Print.term_to_string e  in
            FStar_Util.format1 "[infer]: Tm_refine %s" uu____7566  in
          failwith uu____7565
      | FStar_Syntax_Syntax.Tm_uvar uu____7573 ->
          let uu____7590 =
            let uu____7591 = FStar_Syntax_Print.term_to_string e  in
            FStar_Util.format1 "[infer]: Tm_uvar %s" uu____7591  in
          failwith uu____7590
      | FStar_Syntax_Syntax.Tm_delayed uu____7598 ->
          failwith "impossible (compressed)"
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____7629 =
            let uu____7630 = FStar_Syntax_Print.term_to_string e  in
            FStar_Util.format1 "[infer]: Tm_unknown %s" uu____7630  in
          failwith uu____7629
        ...
        fun f  ->
          let mk1 x =
            FStar_Syntax_Syntax.mk x FStar_Pervasives_Native.None
             ...
             in
          let uu____7675 = check_n env e0  in
          match uu____7675 with
          | (uu____7688,s_e0,u_e0) ->
              let uu____7691 =
                let uu____7720 =
                  FStar_List.map
                    (fun b  ->
                       let uu____7781 = FStar_Syntax_Subst.open_branch b  in
                       match uu____7781 with
                       | (pat,FStar_Pervasives_Native.None ,body) ->
                           let env1 =
                             let uu___91_7823 = env  in
                             let uu____7824 =
                               let uu____7825 =
                             ...
                             {
                               env = uu____7824;
                               subst = (uu___91_7823.subst);
                               tc_const = (uu___91_7823.tc_const)
                             }  in
                           let uu____7828 = f env1 body  in
                    ...
                    branches
                   in
                FStar_List.split uu____7720  in
              (match uu____7691 with
               | (nms,branches1) ->
                   let t1 =
                     let uu____8002 = FStar_List.hd nms  in
                     match uu____8002 with | M t1 -> t1 | N t1 -> t1  in
                   let has_m =
                     FStar_List.existsb
                       (fun uu___74_8008  ->
                          match uu___74_8008 with
                          | M uu____8009 -> true
                          | uu____8010 -> false) nms
                      in
                   let uu____8011 =
                     let uu____8048 =
                       FStar_List.map2
                                  ...
                                  (match (nm, has_m) with
                                   ...
                                   | (N t2,true ) ->
                                       ...
                                       (match uu____8315 with
                                        | (uu____8352,s_body1,u_body1) ->
                                            ((M t2), (pat, guard, s_body1),
                                              (pat, guard, u_body1)))
                                   | (M uu____8391,false ) ->
                                       failwith "impossible")) nms branches1
                        in
                     FStar_List.unzip3 uu____8048  in
                            ...
                            let uu____8689 =
                              mk1
                                (FStar_Syntax_Syntax.Tm_match
                                   (s_e0, s_branches2))
                               in
                            FStar_Syntax_Util.abs uu____8687 uu____8689
                              (FStar_Pervasives_Native.Some
                              ...
                              let uu____8702 =
                                let uu____8703 =
                                  FStar_Syntax_Syntax.new_bv
                                   ...
                                   in
                                FStar_All.pipe_left
                                  FStar_Syntax_Syntax.mk_binder uu____8703
                                 in
                              [uu____8702]  in
                            let uu____8704 =
                              FStar_Syntax_Syntax.mk_Total
                                FStar_Syntax_Util.ktype0
                               in
                            FStar_Syntax_Util.arrow uu____8695 uu____8704  in
                          let uu____8707 =
                            mk1
                              (FStar_Syntax_Syntax.Tm_ascribed
                                 (s_e,
                             ...
                             let uu____8766 =
                               let uu____8767 =
                                 ...
                                 (uu____8794,
                                   ...
                                   FStar_Pervasives_Native.None)
                                  in
                               FStar_Syntax_Syntax.Tm_ascribed uu____8767  in
                             mk1 uu____8766  in
                           let uu____8831 =
                             mk1
                               (FStar_Syntax_Syntax.Tm_match
      ...
      fun e2  ->
        fun proceed  ->
          fun ensure_m  ->
            ...
            let x_binders =
              let uu____8878 = FStar_Syntax_Syntax.mk_binder x  in
              [uu____8878]  in
            let uu____8879 = FStar_Syntax_Subst.open_term x_binders e2  in
            match uu____8879 with
            | (x_binders1,e21) ->
                let uu____8892 = infer env e1  in
                (match uu____8892 with
                 | (N t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu____8909 = is_C t1  in
                       if uu____8909
                       then
                         let uu___92_8910 = binding  in
                         let uu____8911 =
                           let uu____8914 =
                             FStar_Syntax_Subst.subst env.subst s_e1  in
                           trans_F_ env t1 uu____8914  in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___92_8910.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___92_8910.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____8911;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___92_8910.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___92_8910.FStar_Syntax_Syntax.lbdef);
                           FStar_Syntax_Syntax.lbattrs =
                             (uu___92_8910.FStar_Syntax_Syntax.lbattrs);
                           FStar_Syntax_Syntax.lbpos =
                             (uu___92_8910.FStar_Syntax_Syntax.lbpos)
                         }
                       else binding  in
                     let env1 =
                       let uu___93_8917 = env  in
                       let uu____8918 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___94_8920 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___94_8920.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___94_8920.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         env = uu____8918;
                         subst = (uu___93_8917.subst);
                         tc_const = (uu___93_8917.tc_const)
                       }  in
                     let uu____8921 = proceed env1 e21  in
                     (match uu____8921 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___95_8938 = binding  in
                            let uu____8939 =
                              star_type' env1
                            ...
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___95_8938.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___95_8938.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____8939;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___95_8938.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___95_8938.FStar_Syntax_Syntax.lbdef);
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___95_8938.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___95_8938.FStar_Syntax_Syntax.lbpos)
                            }  in
                          let uu____8942 =
                            let uu____8945 =
                              let uu____8946 =
                                let uu____8959 =
                                  FStar_Syntax_Subst.close x_binders1 s_e2
                                   in
                                ((false,
                                   [(let uu___96_8969 = s_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___96_8969.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___96_8969.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___96_8969.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___96_8969.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = s_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___96_8969.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___96_8969.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____8959)
                                 in
                              FStar_Syntax_Syntax.Tm_let uu____8946  in
                            mk1 uu____8945  in
                          let uu____8970 =
                            let uu____8973 =
                              let uu____8974 =
                                let uu____8987 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___97_8997 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___97_8997.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___97_8997.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___97_8997.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___97_8997.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___97_8997.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___97_8997.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____8987)
                                 in
                              FStar_Syntax_Syntax.Tm_let uu____8974  in
                            mk1 uu____8973  in
                          (nm_rec, uu____8942, uu____8970))
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___98_9006 = binding  in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___98_9006.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___98_9006.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Parser_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___98_9006.FStar_Syntax_Syntax.lbdef);
                         FStar_Syntax_Syntax.lbattrs =
                           (uu___98_9006.FStar_Syntax_Syntax.lbattrs);
                         FStar_Syntax_Syntax.lbpos =
                           (uu___98_9006.FStar_Syntax_Syntax.lbpos)
                       }  in
                     let env1 =
                       let uu___99_9008 = env  in
                       let uu____9009 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___100_9011 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___100_9011.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___100_9011.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         env = uu____9009;
                         subst = (uu___99_9008.subst);
                         tc_const = (uu___99_9008.tc_const)
                       }  in
                     let uu____9012 = ensure_m env1 e21  in
                            ...
                            let uu____9035 =
                              let uu____9036 =
                                let uu____9051 =
                                  ...
                                  [uu____9058]  in
                                (s_e2, uu____9051)  in
                              FStar_Syntax_Syntax.Tm_app uu____9036  in
                            mk1 uu____9035  in
                          let s_e22 =
                            ...
                            let uu____9083 =
                              let uu____9084 =
                                let uu____9099 =
                                  ...
                                  [uu____9106]  in
                                (s_e1, uu____9099)  in
                              FStar_Syntax_Syntax.Tm_app uu____9084  in
                            mk1 uu____9083  in
                          let uu____9126 =
                            let uu____9127 =
                              let uu____9128 =
                                FStar_Syntax_Syntax.mk_binder p  in
                              [uu____9128]  in
                            FStar_Syntax_Util.abs uu____9127 body
                              (FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Util.residual_tot
                                    FStar_Syntax_Util.ktype0))
                             in
                              ...
                              let uu____9133 =
                                let uu____9146 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___101_9156 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___101_9156.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___101_9156.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___101_9156.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___101_9156.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___101_9156.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___101_9156.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____9146)
                                 in
                              FStar_Syntax_Syntax.Tm_let uu____9133  in
                            mk1 uu____9132  in
                          ((M t2), uu____9126, uu____9129)))
      ...
      let mn =
        let uu____9168 =
          FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown
           ...
           in
        N uu____9168  in
      let uu____9169 = check env e mn  in
      match uu____9169 with
      | (N t,s_e,u_e) -> (t, s_e, u_e)
      | uu____9185 -> failwith "[check_n]: impossible"
      ...
      let mn =
        let uu____9207 =
          FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown
           ...
           in
        M uu____9207  in
      let uu____9208 = check env e mn  in
      match uu____9208 with
      | (M t,s_e,u_e) -> (t, s_e, u_e)
      | uu____9224 -> failwith "[check_m]: impossible"
...
and (trans_F_ :
  ...
  fun env  ->
    fun c  ->
      fun wp  ->
        (let uu____9254 =
           let uu____9255 = is_C c  in Prims.op_Negation uu____9255  in
         if uu____9254 then failwith "not a C" else ());
        (let mk1 x =
           FStar_Syntax_Syntax.mk x FStar_Pervasives_Native.None
             c.FStar_Syntax_Syntax.pos
            in
         let uu____9263 =
           let uu____9264 = FStar_Syntax_Subst.compress c  in
           uu____9264.FStar_Syntax_Syntax.n  in
         match uu____9263 with
         | FStar_Syntax_Syntax.Tm_app (head1,args) ->
             let uu____9289 = FStar_Syntax_Util.head_and_args wp  in
                      ...
                      (Prims.op_Negation
                        ...
                        (let uu____9341 =
                           ...
                           FStar_Syntax_Util.is_constructor wp_head
                             uu____9342
                            in
                         Prims.op_Negation uu____9341)
                       in
                    if uu____9327 then failwith "mismatch" else ());
                   (let uu____9350 =
                      let uu____9351 =
                        let uu____9366 =
                          FStar_List.map2
                            (fun uu____9394  ->
                               fun uu____9395  ->
                                 match (uu____9394, uu____9395) with
                                 | ((arg,q),(wp_arg,q')) ->
                                     ...
                                     (if q <> q'
                                      ...
                                      (let uu____9444 =
                                       ...
                                       (uu____9444, q)))) args wp_args
                           in
                        (head1, uu____9366)  in
                      FStar_Syntax_Syntax.Tm_app uu____9351  in
                    mk1 uu____9350)))
         | FStar_Syntax_Syntax.Tm_arrow (binders,comp) ->
             let binders1 = FStar_Syntax_Util.name_binders binders  in
             let uu____9478 = FStar_Syntax_Subst.open_comp binders1 comp  in
                      ...
                      FStar_List.map
                        (fun uu____9534  ->
                           ...
                           | (bv,q) ->
                               ...
                               let uu____9554 = is_C h  in
                               if uu____9554
                               then
                                 let w' =
                                   let uu____9566 = star_type' env h  in
                                   FStar_Syntax_Syntax.gen_bv
                                     (Prims.strcat
                                        (bv.FStar_Syntax_Syntax.ppname).FStar_Ident.idText
                                        "__w'") FStar_Pervasives_Native.None
                                 ...
                                 (let x =
                                    let uu____9609 = star_type' env h  in
                                    FStar_Syntax_Syntax.gen_bv
                                      (Prims.strcat
                                         (bv.FStar_Syntax_Syntax.ppname).FStar_Ident.idText
                                  ...
                                  (x, [(x, q)]))) binders_orig
                       in
                    FStar_List.split uu____9500  in
                       ...
                       let comp2 =
                         let uu____9664 =
                           ...
                           FStar_Syntax_Util.rename_binders binders_orig
                             uu____9667
                            in
                         FStar_Syntax_Subst.subst_comp uu____9664 comp1  in
                       let app =
                         let uu____9671 =
                           let uu____9672 =
                             let uu____9687 =
                               FStar_List.map
                                 (fun bv  ->
                                    ...
                                    let uu____9703 =
                                      FStar_Syntax_Syntax.as_implicit false
                                       in
                                    (uu____9702, uu____9703)) bvs
                                in
                             (wp, uu____9687)  in
                           FStar_Syntax_Syntax.Tm_app uu____9672  in
                         mk1 uu____9671  in
                       let comp3 =
                         let uu____9711 = type_of_comp comp2  in
                         let uu____9712 = is_monadic_comp comp2  in
                         trans_G env uu____9711 uu____9712 app  in
                       FStar_Syntax_Util.arrow binders3 comp3))
         | FStar_Syntax_Syntax.Tm_ascribed (e,uu____9714,uu____9715) ->
             trans_F_ env e wp
         | uu____9756 -> failwith "impossible trans_F_")
    ...
    fun h  ->
      fun is_monadic1  ->
        fun wp  ->
          ...
          then
            let uu____9761 =
              let uu____9762 = star_type' env h  in
              let uu____9765 =
                let uu____9774 =
                  let uu____9779 = FStar_Syntax_Syntax.as_implicit false  in
                  (wp, uu____9779)  in
                [uu____9774]  in
              {
                ...
                FStar_Syntax_Syntax.effect_name =
                  FStar_Parser_Const.effect_PURE_lid;
                FStar_Syntax_Syntax.result_typ = uu____9762;
                FStar_Syntax_Syntax.effect_args = uu____9765;
                FStar_Syntax_Syntax.flags = []
              }  in
            FStar_Syntax_Syntax.mk_Comp uu____9761
          else
            (let uu____9789 = trans_F_ env h wp  in
             FStar_Syntax_Syntax.mk_Total uu____9789)
...
let (star_type : env -> FStar_Syntax_Syntax.typ -> FStar_Syntax_Syntax.typ) =
  fun env  ->
    fun t  -> let uu____9800 = n env.env t  in star_type' env uu____9800
...
let (star_expr :
  ...
  =
  fun env  ->
    fun t  -> let uu____9815 = n env.env t  in check_n env uu____9815
...
let (trans_F :
  ...
  fun env  ->
    fun c  ->
      fun wp  ->
        let uu____9825 = n env.env c  in
        let uu____9826 = n env.env wp  in trans_F_ env uu____9825 uu____9826
