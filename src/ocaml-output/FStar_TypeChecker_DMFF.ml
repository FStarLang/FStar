          ...
          | (rec_nm,s_e,u_e) ->
                ...
                let uu____3224 =
                  (Prims.op_Negation (is_unknown t2.FStar_Syntax_Syntax.n))
                    ...
                    (let uu____3225 =
                     ...
                     Prims.op_Negation uu____3225) in
                match uu____3224 with
                | true  ->
                    let uu____3227 =
                      let uu____3228 =
                        let uu____3229 = FStar_Syntax_Print.term_to_string e in
                        let uu____3230 = FStar_Syntax_Print.term_to_string t1 in
                        let uu____3231 = FStar_Syntax_Print.term_to_string t2 in
                        FStar_Util.format3
                          "[check]: the expression [%s] has type [%s] but should have type [%s]"
                          uu____3229 uu____3230 uu____3231 in
              ...
              (match (rec_nm, context_nm) with
               ...
               | (M t1,N t2) ->
                   let uu____3245 =
                     let uu____3246 =
                       let uu____3247 = FStar_Syntax_Print.term_to_string e in
                       let uu____3248 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____3249 = FStar_Syntax_Print.term_to_string t2 in
                       FStar_Util.format3
                         "[check %s]: got an effectful computation [%s] in lieu of a pure computation [%s]"
                         uu____3247 uu____3248 uu____3249 in
                     FStar_Errors.Err uu____3246 in
                   Prims.raise uu____3245) in
        let ensure_m env e2 =
          ...
          | M uu____3305 ->
              let uu____3306 = check env e2 context_nm in strip_m uu____3306 in
        let uu____3310 =
  ...
  fun env  ->
    fun e  ->
                           ...
                           | true  ->
                               let double_starred_comp =
                                 let uu____3727 =
                                   let uu____3728 =
                                     ...
                                     FStar_Syntax_Util.comp_result uu____3729 in
                                   FStar_All.pipe_left double_star uu____3728 in
                               ...
                               let uu____3736 =
                                 let uu____3742 =
                                   ...
                                   FStar_Syntax_Util.lcomp_of_comp uu____3743 in
      ...
      | FStar_Syntax_Syntax.Tm_fvar
          ...
          (match uu____3905 with
           | (uu____3911,t) ->
               ...
               let uu____3914 = let uu____3915 = normalize t in N uu____3915 in
               (uu____3914, e, e))
      | FStar_Syntax_Syntax.Tm_app (head,args) ->
                          ...
                          let uu____4131 =
                            let uu____4132 =
                              ...
                              FStar_Util.format3
                                ...
                                uu____4133 uu____4137 uu____4143 in
      ...
      | FStar_Syntax_Syntax.Tm_constant c ->
          let uu____4598 = let uu____4599 = env.tc_const c in N uu____4599 in
          (uu____4598, e, e)
                             ...
                             let t1_star =
                               let uu____5371 =
                                 let uu____5375 =
                                   ...
                                   FStar_All.pipe_left
                                     FStar_Syntax_Syntax.mk_binder uu____5376 in
                                 [uu____5375] in
                               let uu____5377 =
                                 FStar_Syntax_Syntax.mk_Total
                                   FStar_Syntax_Util.ktype0 in
                               FStar_Syntax_Util.arrow uu____5371 uu____5377 in
                             let uu____5380 =
                               mk
                               ...
                               let uu____5411 =
                                 let uu____5412 =
                                   ...
                                   (uu____5425, (FStar_Util.Inl t1_star),
                                     None) in
                                 FStar_Syntax_Syntax.Tm_ascribed uu____5412 in
                               mk uu____5411 in
                             let uu____5438 =
                               mk
                                 (FStar_Syntax_Syntax.Tm_match
                      ...
                      (Prims.op_Negation
                        ...
                        (let uu____5830 =
                           ...
                           FStar_Syntax_Util.is_constructor wp_head
                             uu____5831 in
                         Prims.op_Negation uu____5830) in
                            ...
                            (fun uu____5861  ->
                               fun uu____5862  ->
                                 ...
                                 | ((arg,q),(wp_arg,q')) ->
                                     ...
                                     ((match q <> q' with
                                       | true  ->
                                           let uu____5888 = print_implicit q in
                                           let uu____5889 = print_implicit q' in
        ...
        fun wp  ->
          ...
          | true  ->
              let uu____6084 =
                ...
                let uu____6088 =
                  let uu____6094 =
                    let uu____6097 = FStar_Syntax_Syntax.as_implicit false in
                    (wp, uu____6097) in
                  [uu____6094] in
                {
