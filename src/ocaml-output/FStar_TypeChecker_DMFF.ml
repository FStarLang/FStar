        ...
        then
          ((let uu____4136 =
              let uu____4137 =
                FStar_List.for_all
                  (fun uu____4145 ->
                     match uu____4145 with | (h, uu____4151) -> is_C h) args in
                ...
                FStar_List.for_all
                  (fun uu____4165 ->
                     ...
                     | (h, uu____4171) ->
                         ...
                         Prims.op_Negation uu____4172) args in
    ...
    fun t ->
      fun e ->
        ...
        let body =
          ...
          mk1 uu____4276 in
        let uu____4320 =
          let uu____4321 = FStar_Syntax_Syntax.mk_binder p in [uu____4321] in
    ...
    fun e ->
      fun context_nm ->
          ...
          | (rec_nm, s_e, u_e) ->
                ...
                let uu____4527 =
                  (Prims.op_Negation (is_unknown t2.FStar_Syntax_Syntax.n))
                    ...
                    (let uu____4529 =
                     ...
                     Prims.op_Negation uu____4529) in
                if uu____4527
                then
                  let uu____4531 =
                    let uu____4536 =
                      let uu____4537 = FStar_Syntax_Print.term_to_string e in
                      let uu____4538 = FStar_Syntax_Print.term_to_string t1 in
                      let uu____4539 = FStar_Syntax_Print.term_to_string t2 in
                      FStar_Util.format3
                        "[check]: the expression [%s] has type [%s] but should have type [%s]"
                        uu____4537 uu____4538 uu____4539 in
              ...
              (match (rec_nm, context_nm) with
               ...
               | (M t1, N t2) ->
                   let uu____4559 =
                     let uu____4564 =
                       let uu____4565 = FStar_Syntax_Print.term_to_string e in
                       let uu____4566 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____4567 = FStar_Syntax_Print.term_to_string t2 in
                       FStar_Util.format3
                         "[check %s]: got an effectful computation [%s] in lieu of a pure computation [%s]"
                         uu____4565 uu____4566 uu____4567 in
                     (FStar_Errors.Fatal_EffectfulAndPureComputationMismatch,
                       uu____4564) in
                   FStar_Errors.raise_err uu____4559) in
        let ensure_m env1 e2 =
          ...
          | M uu____4657 ->
              let uu____4658 = check env1 e2 context_nm in strip_m uu____4658 in
        let uu____4665 =
    ...
    fun e ->
                 ...
                 fun uu____5165 ->
                   ...
                   | ((env2, acc), (bv, qual)) ->
                       ...
                       then
                         ...
                         let uu____5242 =
                           let uu____5245 = FStar_Syntax_Syntax.mk_binder x in
                           let uu____5246 =
                             let uu____5249 =
                         ...
                         (let x =
                          ...
                          let uu____5258 =
                            ...
                            uu____5261 :: acc in
                          (env2, uu____5258))) (env1, []) binders1 in
                               ...
                               then
                                 ...
                                 (let uu____5396 =
                                    ...
                                    let uu____5398 =
                                      ...
                                      FStar_Pervasives_Native.Some uu____5403 in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
      ...
      | FStar_Syntax_Syntax.Tm_fvar
          ...
          (match uu____5525 with
           | (uu____5561, t) ->
               let uu____5563 = let uu____5564 = normalize1 t in N uu____5564 in
               (uu____5563, e, e))
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____5566;_},
           a::hd1::rest)
          ->
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____5711;_},
           a1::a2::hd1::rest)
          ->
          let rest1 = hd1 :: rest in
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____5875;_},
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____6033;_},
           (a1, uu____6035)::a2::[])
          ->
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____6219;_},
           uu____6220)
          ->
          let uu____6241 =
            let uu____6246 =
      ...
      | FStar_Syntax_Syntax.Tm_app
          ...
          let uu____6277 =
            let uu____6282 =
              ...
              FStar_Util.format1 "DMFF: Ill-applied constant %s" uu____6283 in
           ...
           | (t_head, s_head, u_head) ->
               ...
               let rec flatten1 t =
                 ...
                 | FStar_Syntax_Syntax.Tm_arrow (binders, comp) ->
                     (binders, comp)
                 | FStar_Syntax_Syntax.Tm_ascribed
                     (e1, uu____6493, uu____6494) -> flatten1 e1
                 | uu____6535 ->
                     let uu____6536 =
                       let uu____6541 =
                         let uu____6542 =
                     ...
                     FStar_Errors.raise_err uu____6536 in
                       ...
                       (let uu____6615 =
                          let uu____6620 =
                            ...
                            FStar_Util.format3
                              ...
                              uu____6621 uu____6628 uu____6639 in
                          ...
                          let rec final_type subst1 uu____6688 args1 =
                            ...
                            | (binders2, comp2) ->
                                (match (binders2, args1) with
                                 ...
                                 | ((bv, uu____6887)::binders3,
                                    (arg, uu____6890)::args2) ->
                                     final_type
      ...
      | FStar_Syntax_Syntax.Tm_constant c ->
          let uu____7461 = let uu____7462 = env.tc_const c in N uu____7462 in
          (uu____7461, e, e)
                              ...
                              let uu____8654 =
                                let uu____8655 =
                                  FStar_Syntax_Syntax.new_bv
                                    FStar_Pervasives_Native.None p_type in
                                FStar_All.pipe_left
                                  FStar_Syntax_Syntax.mk_binder uu____8655 in
                              [uu____8654] in
                            let uu____8656 =
                              FStar_Syntax_Syntax.mk_Total
                                FStar_Syntax_Util.ktype0 in
  ...
  env ->
    FStar_Syntax_Syntax.term ->
      (FStar_Syntax_Syntax.typ, FStar_Syntax_Syntax.term,
        FStar_Syntax_Syntax.term) FStar_Pervasives_Native.tuple3)
  =
  fun env -> fun t -> let uu____9767 = n env.env t in check_n env uu____9767
let (trans_F :
  env ->
    FStar_Syntax_Syntax.typ ->
      FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term)
