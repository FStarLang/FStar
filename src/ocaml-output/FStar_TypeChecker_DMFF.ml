...
let _57_980 = (let _152_825 = (FStar_List.map2 (fun _57_963 _57_966 -> (match (((_57_963), (_57_966))) with
...
(let _152_824 = if (is_C bv.FStar_Syntax_Syntax.sort) then begin
(let _152_823 = (let _152_822 = (FStar_Syntax_Subst.subst env.subst s_arg)
in ((_152_822), (q)))
in (_152_823)::(((u_arg), (q)))::[])
end else begin
(((u_arg), (q)))::[]
...
in (FStar_List.split _152_825))
in (match (_57_980) with
| (s_args, u_args) -> begin
(

let u_args = (FStar_List.flatten u_args)
in (let _152_827 = (mk (FStar_Syntax_Syntax.Tm_app (((s_head), (s_args)))))
in (let _152_826 = (mk (FStar_Syntax_Syntax.Tm_app (((u_head), (u_args)))))
in ((final_type), (_152_827), (_152_826)))))
end))
end))))
end)))))
end))))
...
(let _152_829 = (let _152_828 = (env.tc_const c)
in N (_152_828))
in ((_152_829), (e), (e)))
end
| FStar_Syntax_Syntax.Tm_let (_57_1011) -> begin
(let _152_831 = (let _152_830 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "[infer]: Tm_let %s" _152_830))
in (FStar_All.failwith _152_831))
end
...
(let _152_833 = (let _152_832 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "[infer]: Tm_refine %s" _152_832))
in (FStar_All.failwith _152_833))
end
| FStar_Syntax_Syntax.Tm_uvar (_57_1023) -> begin
(let _152_835 = (let _152_834 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "[infer]: Tm_uvar %s" _152_834))
in (FStar_All.failwith _152_835))
end
...
in (FStar_Util.format1 "[infer]: Tm_unknown %s" _152_839))
...
let _57_1056 = (let _152_856 = (FStar_List.map (fun b -> (match ((FStar_Syntax_Subst.open_branch b)) with
| (pat, None, body) -> begin
(
...
let _57_1045 = env
in (let _152_855 = (let _152_854 = (FStar_Syntax_Syntax.pat_bvs pat)
in (FStar_List.fold_left FStar_TypeChecker_Env.push_bv env.env _152_854))
in {env = _152_855; subst = _57_1045.subst; tc_const = _57_1045.tc_const}))
in (
...
let _57_1100 = (let _152_860 = (FStar_List.map2 (fun nm _57_1075 -> (match (_57_1075) with
...
let s_body = (let _152_867 = (let _152_866 = (let _152_865 = (let _152_864 = (let _152_863 = (FStar_Syntax_Syntax.bv_to_name p)
in (let _152_862 = (FStar_Syntax_Syntax.as_implicit false)
in ((_152_863), (_152_862))))
in (_152_864)::[])
in ((s_body), (_152_865)))
in FStar_Syntax_Syntax.Tm_app (_152_866))
in (mk _152_867))
in ((pat), (guard), (s_body)))
end)) s_branches)
in (
...
let s_e = (let _152_870 = (let _152_868 = (FStar_Syntax_Syntax.mk_binder p)
in (_152_868)::[])
in (let _152_869 = (mk (FStar_Syntax_Syntax.Tm_match (((s_e0), (s_branches)))))
in (FStar_Syntax_Util.abs _152_870 _152_869 None)))
in (

let t1_star = (let _152_874 = (let _152_872 = (let _152_871 = (FStar_Syntax_Syntax.new_bv None p_type)
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder _152_871))
in (_152_872)::[])
in (let _152_873 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Util.ktype0)
in (FStar_Syntax_Util.arrow _152_874 _152_873)))
in (let _152_876 = (mk (FStar_Syntax_Syntax.Tm_ascribed (((s_e), (FStar_Util.Inl (t1_star)), (None)))))
in (let _152_875 = (mk (FStar_Syntax_Syntax.Tm_match (((u_e0), (u_branches)))))
in ((M (t1)), (_152_876), (_152_875)))))))))))
end else begin
(
...
let t1_star = t1
in (let _152_881 = (let _152_879 = (let _152_878 = (let _152_877 = (mk (FStar_Syntax_Syntax.Tm_match (((s_e0), (s_branches)))))
in ((_152_877), (FStar_Util.Inl (t1_star)), (None)))
in FStar_Syntax_Syntax.Tm_ascribed (_152_878))
in (mk _152_879))
in (let _152_880 = (mk (FStar_Syntax_Syntax.Tm_match (((u_e0), (u_branches)))))
in ((N (t1)), (_152_881), (_152_880)))))))
end
end))))
end))
end))))
...
let x_binders = (let _152_901 = (FStar_Syntax_Syntax.mk_binder x)
in (_152_901)::[])
in (
...
in (let _152_902 = (double_star binding.FStar_Syntax_Syntax.lbtyp)
in {FStar_Syntax_Syntax.lbname = _57_1129.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _57_1129.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _152_902; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = _57_1129.FStar_Syntax_Syntax.lbdef}))
end else begin
(

let _57_1131 = binding
in (let _152_903 = (star_type' env binding.FStar_Syntax_Syntax.lbtyp)
in {FStar_Syntax_Syntax.lbname = _57_1131.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _57_1131.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _152_903; FStar_Syntax_Syntax.lbeff = _57_1131.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _57_1131.FStar_Syntax_Syntax.lbdef}))
end
...
in (let _152_905 = (let _152_904 = (FStar_Syntax_Subst.subst env.subst s_e1)
in (trans_F_ env t1 _152_904))
in {FStar_Syntax_Syntax.lbname = _57_1139.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _57_1139.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _152_905; FStar_Syntax_Syntax.lbeff = _57_1139.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _57_1139.FStar_Syntax_Syntax.lbdef}))
end else begin
binding
end
in (
...
let _57_1142 = env
in (let _152_906 = (FStar_TypeChecker_Env.push_bv env.env (
...
in {env = _152_906; subst = _57_1142.subst; tc_const = _57_1142.tc_const}))
in (

let _57_1150 = (proceed env e2)
in (match (_57_1150) with
| (nm_rec, s_e2, u_e2) -> begin
(let _152_914 = (let _152_909 = (let _152_908 = (let _152_907 = (FStar_Syntax_Subst.close x_binders s_e2)
in ((((false), (((

let _57_1151 = s_binding
in {FStar_Syntax_Syntax.lbname = _57_1151.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _57_1151.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _57_1151.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _57_1151.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = s_e1}))::[]))), (_152_907)))
in FStar_Syntax_Syntax.Tm_let (_152_908))
in (mk _152_909))
in (let _152_913 = (let _152_912 = (let _152_911 = (let _152_910 = (FStar_Syntax_Subst.close x_binders u_e2)
in ((((false), (((

let _57_1153 = u_binding
in {FStar_Syntax_Syntax.lbname = _57_1153.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _57_1153.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _57_1153.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _57_1153.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = u_e1}))::[]))), (_152_910)))
in FStar_Syntax_Syntax.Tm_let (_152_911))
in (mk _152_912))
in ((nm_rec), (_152_914), (_152_913))))
end))))
end
...
in {env = _152_915; subst = _57_1163.subst; tc_const = _57_1163.tc_const}))
in (
...
let s_e2 = (let _152_921 = (let _152_920 = (let _152_919 = (let _152_918 = (let _152_917 = (FStar_Syntax_Syntax.bv_to_name p)
in (let _152_916 = (FStar_Syntax_Syntax.as_implicit false)
in ((_152_917), (_152_916))))
in (_152_918)::[])
in ((s_e2), (_152_919)))
in FStar_Syntax_Syntax.Tm_app (_152_920))
in (mk _152_921))
in (
...
let body = (let _152_926 = (let _152_925 = (let _152_924 = (let _152_923 = (let _152_922 = (FStar_Syntax_Syntax.as_implicit false)
in ((s_e2), (_152_922)))
in (_152_923)::[])
in ((s_e1), (_152_924)))
in FStar_Syntax_Syntax.Tm_app (_152_925))
in (mk _152_926))
in (let _152_933 = (let _152_928 = (let _152_927 = (FStar_Syntax_Syntax.mk_binder p)
in (_152_927)::[])
in (FStar_Syntax_Util.abs _152_928 body None))
in (let _152_932 = (let _152_931 = (let _152_930 = (let _152_929 = (FStar_Syntax_Subst.close x_binders u_e2)
in ((((false), (((

let _57_1177 = u_binding
in {FStar_Syntax_Syntax.lbname = _57_1177.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _57_1177.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _57_1177.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _57_1177.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = u_e1}))::[]))), (_152_929)))
in FStar_Syntax_Syntax.Tm_let (_152_930))
in (mk _152_931))
in ((M (t2)), (_152_933), (_152_932)))))))))
end))))
end))
end)))))))
...
let mn = (let _152_936 = (FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown None e.FStar_Syntax_Syntax.pos)
in N (_152_936))
...
let mn = (let _152_939 = (FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown None e.FStar_Syntax_Syntax.pos)
in M (_152_939))
in (match ((check env e mn)) with
| (M (t), s_e, u_e) -> begin
((t), (s_e), (u_e))
...
in (match ((let _152_948 = (FStar_Syntax_Subst.compress c)
in _152_948.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_app (head, args) -> begin
(
...
let _57_1220 = if ((not (((FStar_List.length wp_args) = (FStar_List.length args)))) || (not ((let _152_949 = (FStar_Syntax_Util.mk_tuple_data_lid (FStar_List.length wp_args) FStar_Range.dummyRange)
in (FStar_Syntax_Util.is_constructor wp_head _152_949))))) then begin
(FStar_All.failwith "mismatch")
end else begin
()
end
in (let _152_959 = (let _152_958 = (let _152_957 = (FStar_List.map2 (fun _57_1224 _57_1227 -> (match (((_57_1224), (_57_1227))) with
...
let _57_1230 = if (q <> q') then begin
(let _152_955 = (print_implicit q)
in (let _152_954 = (print_implicit q')
in (FStar_Util.print2_warning "Incoherent implicit qualifiers %b %b" _152_955 _152_954)))
end else begin
()
end
in (let _152_956 = (trans_F_ env arg wp_arg)
in ((_152_956), (q)))))
end)) args wp_args)
in ((head), (_152_957)))
...
let _57_1239 = (FStar_Syntax_Subst.open_comp binders comp)
in (match (_57_1239) with
| (binders_orig, comp) -> begin
(

let _57_1248 = (let _152_969 = (FStar_List.map (fun _57_1242 -> (match (_57_1242) with
| (bv, q) -> begin
(
...
let w' = (let _152_961 = (star_type' env h)
in (FStar_Syntax_Syntax.gen_bv (Prims.strcat bv.FStar_Syntax_Syntax.ppname.FStar_Ident.idText "-w\'") None _152_961))
in (let _152_967 = (let _152_966 = (let _152_965 = (let _152_964 = (let _152_963 = (let _152_962 = (FStar_Syntax_Syntax.bv_to_name w')
in (trans_F_ env h _152_962))
in (FStar_Syntax_Syntax.null_bv _152_963))
in ((_152_964), (q)))
in (_152_965)::[])
in (((w'), (q)))::_152_966)
in ((w'), (_152_967))))
...
let x = (let _152_968 = (star_type' env h)
in (FStar_Syntax_Syntax.gen_bv (Prims.strcat bv.FStar_Syntax_Syntax.ppname.FStar_Ident.idText "-x") None _152_968))
in ((x), ((((x), (q)))::[])))
end)
end)) binders_orig)
in (FStar_List.split _152_969))
...
let comp = (let _152_971 = (let _152_970 = (FStar_Syntax_Syntax.binders_of_list bvs)
in (FStar_Syntax_Util.rename_binders binders_orig _152_970))
in (FStar_Syntax_Subst.subst_comp _152_971 comp))
in (

let app = (let _152_977 = (let _152_976 = (let _152_975 = (FStar_List.map (fun bv -> (let _152_974 = (FStar_Syntax_Syntax.bv_to_name bv)
in (let _152_973 = (FStar_Syntax_Syntax.as_implicit false)
in ((_152_974), (_152_973))))) bvs)
in ((wp), (_152_975)))
in FStar_Syntax_Syntax.Tm_app (_152_976))
in (mk _152_977))
in (

let comp = (let _152_979 = (type_of_comp comp)
in (let _152_978 = (is_monadic_comp comp)
in (trans_G env _152_979 _152_978 app)))
in (FStar_Syntax_Util.arrow binders comp)))))
end))
end)))
end
| FStar_Syntax_Syntax.Tm_ascribed (e, _57_1256, _57_1258) -> begin
(trans_F_ env e wp)
end
| _57_1262 -> begin
...
(let _152_990 = (let _152_989 = (star_type' env h)
in (let _152_988 = (let _152_987 = (let _152_986 = (FStar_Syntax_Syntax.as_implicit false)
in ((wp), (_152_986)))
in (_152_987)::[])
in {FStar_Syntax_Syntax.comp_univs = (FStar_Syntax_Syntax.U_unknown)::[]; FStar_Syntax_Syntax.effect_name = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.result_typ = _152_989; FStar_Syntax_Syntax.effect_args = _152_988; FStar_Syntax_Syntax.flags = []}))
in (FStar_Syntax_Syntax.mk_Comp _152_990))
end else begin
(let _152_991 = (trans_F_ env h wp)
in (FStar_Syntax_Syntax.mk_Total _152_991))
end))
...
let star_type : env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun env t -> (let _152_998 = (n env.env t)
in (star_type' env _152_998)))


let star_expr : env_  ->  FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.typ * FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.term) = (fun env t -> (let _152_1003 = (n env.env t)
in (check_n env _152_1003)))


let trans_F : env_  ->  FStar_Syntax_Syntax.typ  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun env c wp -> (let _152_1011 = (n env.env c)
in (let _152_1010 = (n env.env wp)
in (trans_F_ env _152_1011 _152_1010))))
