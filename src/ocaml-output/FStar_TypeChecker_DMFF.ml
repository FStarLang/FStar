...
in {FStar_Syntax_Syntax.n = uu____2007; FStar_Syntax_Syntax.pos = uu___127_2006.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___127_2006.FStar_Syntax_Syntax.vars}))
in (mk_rel1 t2 x y))
end
...
in (([]), (uu____2739)))
in {FStar_Syntax_Syntax.cattributes = uu___128_2709.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___128_2709.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = uu___128_2709.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = uu___128_2709.FStar_Syntax_Syntax.binders; FStar_Syntax_Syntax.signature = uu___128_2709.FStar_Syntax_Syntax.signature; FStar_Syntax_Syntax.ret_wp = uu___128_2709.FStar_Syntax_Syntax.ret_wp; FStar_Syntax_Syntax.bind_wp = uu___128_2709.FStar_Syntax_Syntax.bind_wp; FStar_Syntax_Syntax.if_then_else = uu____2710; FStar_Syntax_Syntax.ite_wp = uu____2714; FStar_Syntax_Syntax.stronger = uu____2718; FStar_Syntax_Syntax.close_wp = uu____2722; FStar_Syntax_Syntax.assert_p = uu____2726; FStar_Syntax_Syntax.assume_p = uu____2730; FStar_Syntax_Syntax.null_wp = uu____2734; FStar_Syntax_Syntax.trivial = uu____2738; FStar_Syntax_Syntax.repr = uu___128_2709.FStar_Syntax_Syntax.repr; FStar_Syntax_Syntax.return_repr = uu___128_2709.FStar_Syntax_Syntax.return_repr; FStar_Syntax_Syntax.bind_repr = uu___128_2709.FStar_Syntax_Syntax.bind_repr; FStar_Syntax_Syntax.actions = uu___128_2709.FStar_Syntax_Syntax.actions})))))))))
...
let uu___129_2756 = dmff_env
in {env = env'; subst = uu___129_2756.subst; tc_const = uu___129_2756.tc_const}))
...
let nm_of_comp : FStar_Syntax_Syntax.comp'  ->  nm = (fun uu___115_2796 -> (match (uu___115_2796) with
| FStar_Syntax_Syntax.Total (t, uu____2798) -> begin
N (t)
end
| FStar_Syntax_Syntax.Comp (c) when (FStar_All.pipe_right c.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___114_2811 -> (match (uu___114_2811) with
...
let string_of_nm : nm  ->  Prims.string = (fun uu___116_2829 -> (match (uu___116_2829) with
| N (t) -> begin
(
...
let uu___130_3046 = bv
in (

let uu____3047 = (star_type' env bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___130_3046.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___130_3046.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3047}))
in ((uu____3045), (aqual)))
end)) binders)
in (match (t1.FStar_Syntax_Syntax.n) with
...
| uu____3283 -> begin
(FStar_All.try_with (fun uu___132_3293 -> (match (()) with
| () -> begin
(
...
end)) (fun uu___131_3360 -> (match (uu___131_3360) with
| Not_found -> begin
false
end)))
end))
...
let uu___133_3531 = env
in (

let uu____3532 = (FStar_TypeChecker_Env.push_binders env.env binders1)
in {env = uu____3532; subst = uu___133_3531.subst; tc_const = uu___133_3531.tc_const}))
in (
...
let uu___134_3552 = x1
in {FStar_Syntax_Syntax.ppname = uu___134_3552.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___134_3552.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})), (t5))))))))))))
end
...
let is_monadic : FStar_Syntax_Syntax.residual_comp FStar_Pervasives_Native.option  ->  Prims.bool = (fun uu___118_3846 -> (match (uu___118_3846) with
| FStar_Pervasives_Native.None -> begin
(failwith "un-annotated lambda?!")
end
| FStar_Pervasives_Native.Some (rc) -> begin
(FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags (FStar_Util.for_some (fun uu___117_3853 -> (match (uu___117_3853) with
| FStar_Syntax_Syntax.CPS -> begin
true
end
| uu____3854 -> begin
...
let is_unknown : FStar_Syntax_Syntax.term'  ->  Prims.bool = (fun uu___119_4095 -> (match (uu___119_4095) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
true
end
| uu____4096 -> begin
...
let strip_m = (fun uu___120_4371 -> (match (uu___120_4371) with
| (M (t), s_e, u_e) -> begin
((t), (s_e), (u_e))
end
| uu____4387 -> begin
...
in {FStar_Syntax_Syntax.residual_effect = uu___135_4843.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____4844; FStar_Syntax_Syntax.residual_flags = uu___135_4843.FStar_Syntax_Syntax.residual_flags}))
...
let uu___136_4860 = env
in (

let uu____4861 = (FStar_TypeChecker_Env.push_binders env.env binders1)
in {env = uu____4861; subst = uu___136_4860.subst; tc_const = uu___136_4860.tc_const}))
in (
...
let uu___137_4894 = bv
in {FStar_Syntax_Syntax.ppname = uu___137_4894.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___137_4894.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})), (qual)))
end)) binders1)
in (
...
in {FStar_Syntax_Syntax.ppname = uu___138_4983.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___138_4983.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4984}))
in (

let env3 = (

let uu___139_4989 = env2
in (
...
in {env = uu___139_4989.env; subst = uu____4990; tc_const = uu___139_4989.tc_const}))
in (
...
let uu___140_5014 = bv
in (

let uu____5015 = (star_type' env2 bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___140_5014.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___140_5014.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____5015}))
in (
...
let uu____5114 = (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags (FStar_Util.for_some (fun uu___121_5118 -> (match (uu___121_5118) with
| FStar_Syntax_Syntax.CPS -> begin
true
end
| uu____5119 -> begin
...
let uu____5120 = (FStar_List.filter (fun uu___122_5124 -> (match (uu___122_5124) with
| FStar_Syntax_Syntax.CPS -> begin
false
end
| uu____5125 -> begin
...
let uu____5134 = (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags (FStar_Util.for_some (fun uu___123_5138 -> (match (uu___123_5138) with
| FStar_Syntax_Syntax.CPS -> begin
true
end
| uu____5139 -> begin
...
let flags = (FStar_List.filter (fun uu___124_5146 -> (match (uu___124_5146) with
| FStar_Syntax_Syntax.CPS -> begin
false
end
| uu____5147 -> begin
...
in {FStar_Syntax_Syntax.residual_effect = uu___141_5157.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____5158; FStar_Syntax_Syntax.residual_flags = uu___141_5157.FStar_Syntax_Syntax.residual_flags}))
...
in {env = uu____6758; subst = uu___142_6757.subst; tc_const = uu___142_6757.tc_const}))
in (
...
let has_m = (FStar_List.existsb (fun uu___125_6942 -> (match (uu___125_6942) with
| M (uu____6943) -> begin
true
end
| uu____6944 -> begin
...
in {FStar_Syntax_Syntax.lbname = uu___143_7844.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___143_7844.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu____7845; FStar_Syntax_Syntax.lbeff = uu___143_7844.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___143_7844.FStar_Syntax_Syntax.lbdef}))
end
| uu____7849 -> begin
binding
end))
...
let uu___144_7851 = env
in (

let uu____7852 = (FStar_TypeChecker_Env.push_bv env.env (

let uu___145_7854 = x
in {FStar_Syntax_Syntax.ppname = uu___145_7854.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___145_7854.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in {env = uu____7852; subst = uu___144_7851.subst; tc_const = uu___144_7851.tc_const}))
in (
...
let uu___146_7872 = binding
in (

let uu____7873 = (star_type' env1 binding.FStar_Syntax_Syntax.lbtyp)
in {FStar_Syntax_Syntax.lbname = uu___146_7872.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___146_7872.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu____7873; FStar_Syntax_Syntax.lbeff = uu___146_7872.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___146_7872.FStar_Syntax_Syntax.lbdef}))
in (
...
let uu___147_7903 = s_binding
in {FStar_Syntax_Syntax.lbname = uu___147_7903.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___147_7903.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___147_7903.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___147_7903.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = s_e1}))::[]))), (uu____7893)))
...
let uu___148_7931 = u_binding
in {FStar_Syntax_Syntax.lbname = uu___148_7931.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___148_7931.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___148_7931.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___148_7931.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = u_e1}))::[]))), (uu____7921)))
...
let uu___149_7940 = binding
in {FStar_Syntax_Syntax.lbname = uu___149_7940.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___149_7940.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = t1; FStar_Syntax_Syntax.lbeff = FStar_Parser_Const.effect_PURE_lid; FStar_Syntax_Syntax.lbdef = uu___149_7940.FStar_Syntax_Syntax.lbdef})
in (

let env1 = (

let uu___150_7942 = env
in (

let uu____7943 = (FStar_TypeChecker_Env.push_bv env.env (

let uu___151_7945 = x
in {FStar_Syntax_Syntax.ppname = uu___151_7945.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___151_7945.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in {env = uu____7943; subst = uu___150_7942.subst; tc_const = uu___150_7942.tc_const}))
in (
...
let uu___152_8090 = u_binding
in {FStar_Syntax_Syntax.lbname = uu___152_8090.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___152_8090.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___152_8090.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___152_8090.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = u_e1}))::[]))), (uu____8080)))
...
let uu____8261 = ((not ((Prims.op_Equality (FStar_List.length wp_args) (FStar_List.length args)))) || (
