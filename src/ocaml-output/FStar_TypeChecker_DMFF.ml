                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____1636 in
                          {
                            ...
                            FStar_Syntax_Syntax.tk =
                              (uu___102_1634.FStar_Syntax_Syntax.tk);
                            FStar_Syntax_Syntax.pos =
                              (uu___102_1634.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___102_1634.FStar_Syntax_Syntax.vars)
                          } in
                        mk_rel1 t2 x y
                    ...
                    let uu____2158 =
                        ...
                        let uu____2182 = c wp_trivial2 in ([], uu____2182) in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___103_2159.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___103_2159.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___103_2159.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___103_2159.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___103_2159.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___103_2159.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___103_2159.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___103_2159.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___103_2159.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___103_2159.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___103_2159.FStar_Syntax_Syntax.actions)
                      } in
...
let set_env: env -> FStar_TypeChecker_Env.env -> env =
  fun dmff_env  ->
    fun env'  ->
      let uu___104_2194 = dmff_env in
      {
        env = env';
        subst = (uu___104_2194.subst);
        tc_const = (uu___104_2194.tc_const)
      }
type nm =
          ...
          let binders1 =
            FStar_List.map
              (fun uu____2417  ->
                 ...
                 | (bv,aqual) ->
                     let uu____2424 =
                       let uu___105_2425 = bv in
                       let uu____2426 =
                         star_type' env bv.FStar_Syntax_Syntax.sort in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___105_2425.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___105_2425.FStar_Syntax_Syntax.index);
...
let is_monadic uu___93_3017 =
  match uu___93_3017 with
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___95_3490 =
            match uu___95_3490 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,what) ->
          ...
          let env1 =
            let uu___110_3810 = env in
            let uu____3811 =
              FStar_TypeChecker_Env.push_binders env.env binders1 in
            {
              env = uu____3811;
              subst = (uu___110_3810.subst);
              tc_const = (uu___110_3810.tc_const)
            } in
          let s_binders =
            FStar_List.map
              (fun uu____3820  ->
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___112_3874.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___112_3874.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____3875
                           } in
                         let env3 =
                           let uu___113_3880 = env2 in
                           let uu____3881 =
                             let uu____3883 =
                               let uu____3884 =
                                 let uu____3889 =
                           ...
                           {
                             env = (uu___113_3880.env);
                             subst = uu____3881;
                             tc_const = (uu___113_3880.tc_const)
                           } in
                         let uu____3890 =
                         ...
                         (let x =
                            let uu___114_3899 = bv in
                            let uu____3900 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___114_3899.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___114_3899.FStar_Syntax_Syntax.index);
                    ...
                    let s_what =
                      ...
                      | Some (FStar_Util.Inl lc) ->
                          ...
                          then
                            ...
                            Some
                              (FStar_Util.Inl
                                 ((let uu___115_4040 = lc in
                                   {
                                     FStar_Syntax_Syntax.eff_name =
                                       (uu___115_4040.FStar_Syntax_Syntax.eff_name);
                                     FStar_Syntax_Syntax.res_typ =
                                       (uu___115_4040.FStar_Syntax_Syntax.res_typ);
                                     FStar_Syntax_Syntax.cflags =
                                       (uu___115_4040.FStar_Syntax_Syntax.cflags);
                    ...
                    (fun b  ->
                       ...
                       | (pat,None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____5136;
                               subst = (uu___116_5135.subst);
                               tc_const = (uu___116_5135.tc_const)
                             } in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____5897 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____5913 in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___117_5909.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___117_5909.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____5910;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___117_5909.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___117_5909.FStar_Syntax_Syntax.lbdef)
                         }
                       else binding in
                     let env1 =
                       let uu___118_5916 = env in
                       let uu____5917 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___119_5918 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___119_5918.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___119_5918.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____5917;
                         subst = (uu___118_5916.subst);
                         tc_const = (uu___118_5916.tc_const)
                       } in
                     let uu____5919 = proceed env1 e21 in
                     (match uu____5919 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___120_5930 = binding in
                            let uu____5931 =
                              star_type' env1
                                binding.FStar_Syntax_Syntax.lbtyp in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___120_5930.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___120_5930.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____5931;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___120_5930.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___120_5930.FStar_Syntax_Syntax.lbdef)
                            } in
                          let uu____5934 =
                            let uu____5937 =
                              let uu____5938 =
                                ...
                                ((false,
                                   [(let uu___121_5951 = s_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___121_5951.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___121_5951.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___121_5951.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___121_5951.FStar_Syntax_Syntax.lbeff);
                          ...
                          let uu____5952 =
                            let uu____5955 =
                              let uu____5956 =
                                ...
                                ((false,
                                   [(let uu___122_5969 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___122_5969.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___122_5969.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___122_5969.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___122_5969.FStar_Syntax_Syntax.lbeff);
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___123_5978 = binding in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___123_5978.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___123_5978.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Syntax_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___123_5978.FStar_Syntax_Syntax.lbdef)
                       } in
                     let env1 =
                       let uu___124_5980 = env in
                       let uu____5981 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___125_5982 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___125_5982.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___125_5982.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____5981;
                         subst = (uu___124_5980.subst);
                         tc_const = (uu___124_5980.tc_const)
                       } in
                            ...
                            let uu____6113 =
                              let uu____6114 =
                                let uu____6122 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2 in
                                ((false,
                                   [(let uu___126_6127 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___126_6127.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___126_6127.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___126_6127.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___126_6127.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1
                                     })]), uu____6122) in
