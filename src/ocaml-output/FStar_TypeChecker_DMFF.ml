                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____2061 in
                          {
                            ...
                            FStar_Syntax_Syntax.pos =
                              (uu___293_2059.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___293_2059.FStar_Syntax_Syntax.vars)
                          } in
                        mk_rel1 t2 x y
                    ...
                    let uu____2793 =
                        ...
                        let uu____2824 = c wp_trivial2 in ([], uu____2824) in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___294_2794.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___294_2794.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___294_2794.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___294_2794.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___294_2794.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___294_2794.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___294_2794.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___294_2794.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___294_2794.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___294_2794.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___294_2794.FStar_Syntax_Syntax.actions)
                      } in
...
let set_env: env -> FStar_TypeChecker_Env.env -> env =
  fun dmff_env  ->
    fun env'  ->
      let uu___295_2838 = dmff_env in
      {
        env = env';
        subst = (uu___295_2838.subst);
        tc_const = (uu___295_2838.tc_const)
      }
type nm =
    ...
    fun t  ->
          ...
          let binders1 =
            FStar_List.map
              (fun uu____3106  ->
                 ...
                 | (bv,aqual) ->
                     let uu____3117 =
                       let uu___296_3118 = bv in
                       let uu____3119 =
                         star_type' env bv.FStar_Syntax_Syntax.sort in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___296_3118.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___296_3118.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,repr,something) ->
          ...
          (match uu____3595 with
           | (binders1,repr1) ->
               let env1 =
                 let uu___299_3603 = env in
                 let uu____3604 =
                   FStar_TypeChecker_Env.push_binders env.env binders1 in
                 {
                   env = uu____3604;
                   subst = (uu___299_3603.subst);
                   tc_const = (uu___299_3603.tc_const)
                 } in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___300_3624 = x1 in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___300_3624.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___300_3624.FStar_Syntax_Syntax.index);
...
let is_monadic:
  ...
  =
  fun uu___284_4016  ->
    match uu___284_4016 with
    | FStar_Pervasives_Native.None  -> failwith "un-annotated lambda?!"
    | FStar_Pervasives_Native.Some rc ->
        FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
          (FStar_Util.for_some
             (fun uu___283_4023  ->
                match uu___283_4023 with
                | FStar_Syntax_Syntax.CPS  -> true
                | uu____4024 -> false))
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___286_4536 =
            match uu___286_4536 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,rc_opt) ->
                ...
                let uu____5007 =
                    ...
                    FStar_Pervasives_Native.Some uu____5014 in
                  {
                    FStar_Syntax_Syntax.residual_effect =
                      (uu___301_5008.FStar_Syntax_Syntax.residual_effect);
                    FStar_Syntax_Syntax.residual_typ = uu____5009;
                    FStar_Syntax_Syntax.residual_flags =
                      (uu___301_5008.FStar_Syntax_Syntax.residual_flags)
                  } in
          ...
          let env1 =
            let uu___302_5025 = env in
            let uu____5026 =
              FStar_TypeChecker_Env.push_binders env.env binders1 in
            {
              env = uu____5026;
              subst = (uu___302_5025.subst);
              tc_const = (uu___302_5025.tc_const)
            } in
          let s_binders =
            FStar_List.map
              (fun uu____5046  ->
                 ...
                 | (bv,qual) ->
                     ...
                     ((let uu___303_5059 = bv in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___303_5059.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___303_5059.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1 in
          let uu____5060 =
            FStar_List.fold_left
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___304_5148.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___304_5148.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____5149
                           } in
                         let env3 =
                           let uu___305_5154 = env2 in
                           let uu____5155 =
                             let uu____5158 =
                               let uu____5159 =
                                 let uu____5166 =
                           ...
                           {
                             env = (uu___305_5154.env);
                             subst = uu____5155;
                             tc_const = (uu___305_5154.tc_const)
                           } in
                         let uu____5167 =
                         ...
                         (let x =
                            let uu___306_5179 = bv in
                            let uu____5180 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___306_5179.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___306_5179.FStar_Syntax_Syntax.index);
                          ...
                          (match rc.FStar_Syntax_Syntax.residual_typ with
                           ...
                           | FStar_Pervasives_Native.Some rt ->
                               ...
                               then
                                 ...
                                 (let uu____5321 =
                                    let uu___307_5322 = rc in
                                    let uu____5323 =
                                      let uu____5328 = star_type' env2 rt in
                                      FStar_Pervasives_Native.Some uu____5328 in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___307_5322.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ =
                                        uu____5323;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___307_5322.FStar_Syntax_Syntax.residual_flags)
                                    } in
                    ...
                    (fun b  ->
                       ...
                       | (pat,FStar_Pervasives_Native.None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____7650;
                               subst = (uu___308_7649.subst);
                               tc_const = (uu___308_7649.tc_const)
                             } in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____8718 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____8740 in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___309_8736.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___309_8736.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____8737;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___309_8736.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___309_8736.FStar_Syntax_Syntax.lbdef)
                         }
                       else binding in
                     let env1 =
                       let uu___310_8743 = env in
                       let uu____8744 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___311_8746 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___311_8746.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___311_8746.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____8744;
                         subst = (uu___310_8743.subst);
                         tc_const = (uu___310_8743.tc_const)
                       } in
                     let uu____8747 = proceed env1 e21 in
                     (match uu____8747 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___312_8764 = binding in
                            let uu____8765 =
                              star_type' env1
                                binding.FStar_Syntax_Syntax.lbtyp in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___312_8764.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___312_8764.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____8765;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___312_8764.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___312_8764.FStar_Syntax_Syntax.lbdef)
                            } in
                          let uu____8768 =
                            let uu____8771 =
                              let uu____8772 =
                                ...
                                ((false,
                                   [(let uu___313_8795 = s_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___313_8795.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___313_8795.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___313_8795.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___313_8795.FStar_Syntax_Syntax.lbeff);
                          ...
                          let uu____8796 =
                            let uu____8799 =
                              let uu____8800 =
                                ...
                                ((false,
                                   [(let uu___314_8823 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___314_8823.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___314_8823.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___314_8823.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___314_8823.FStar_Syntax_Syntax.lbeff);
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___315_8832 = binding in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___315_8832.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___315_8832.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Parser_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___315_8832.FStar_Syntax_Syntax.lbdef)
                       } in
                     let env1 =
                       let uu___316_8834 = env in
                       let uu____8835 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___317_8837 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___317_8837.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___317_8837.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____8835;
                         subst = (uu___316_8834.subst);
                         tc_const = (uu___316_8834.tc_const)
                       } in
                            ...
                            let uu____8958 =
                              let uu____8959 =
                                let uu____8972 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2 in
                                ((false,
                                   [(let uu___318_8982 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___318_8982.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___318_8982.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___318_8982.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___318_8982.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1
                                     })]), uu____8972) in
