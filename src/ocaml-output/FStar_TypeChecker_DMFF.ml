                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____1563 in
                          {
                            ...
                            FStar_Syntax_Syntax.tk =
                              (uu___102_1561.FStar_Syntax_Syntax.tk);
                            FStar_Syntax_Syntax.pos =
                              (uu___102_1561.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___102_1561.FStar_Syntax_Syntax.vars)
                          } in
                        mk_rel1 t2 x y
                    ...
                    let uu____2054 =
                        ...
                        let uu____2078 = c wp_trivial2 in ([], uu____2078) in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___103_2055.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___103_2055.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___103_2055.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___103_2055.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___103_2055.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___103_2055.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___103_2055.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___103_2055.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___103_2055.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___103_2055.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___103_2055.FStar_Syntax_Syntax.actions)
                      } in
...
let set_env: env -> FStar_TypeChecker_Env.env -> env =
  fun dmff_env  ->
    fun env'  ->
      let uu___104_2090 = dmff_env in
      {
        env = env';
        subst = (uu___104_2090.subst);
        tc_const = (uu___104_2090.tc_const)
      }
type nm =
    ...
    fun t  ->
          ...
          let binders1 =
            FStar_List.map
              (fun uu____2313  ->
                 ...
                 | (bv,aqual) ->
                     let uu____2320 =
                       let uu___105_2321 = bv in
                       let uu____2322 =
                         star_type' env bv.FStar_Syntax_Syntax.sort in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___105_2321.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___105_2321.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,repr,something) ->
          ...
          (match uu____2662 with
           | (binders1,repr1) ->
               let env1 =
                 let uu___108_2668 = env in
                 let uu____2669 =
                   FStar_TypeChecker_Env.push_binders env.env binders1 in
                 {
                   env = uu____2669;
                   subst = (uu___108_2668.subst);
                   tc_const = (uu___108_2668.tc_const)
                 } in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___109_2686 = x1 in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___109_2686.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___109_2686.FStar_Syntax_Syntax.index);
...
let is_monadic uu___93_2913 =
  match uu___93_2913 with
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___95_3359 =
            match uu___95_3359 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,what) ->
          ...
          let env1 =
            let uu___110_3622 = env in
            let uu____3623 =
              FStar_TypeChecker_Env.push_binders env.env binders1 in
            {
              env = uu____3623;
              subst = (uu___110_3622.subst);
              tc_const = (uu___110_3622.tc_const)
            } in
          let s_binders =
            FStar_List.map
              (fun uu____3632  ->
                 ...
                 | (bv,qual) ->
                     ...
                     ((let uu___111_3640 = bv in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___111_3640.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___111_3640.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1 in
          let uu____3641 =
            FStar_List.fold_left
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___112_3686.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___112_3686.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____3687
                           } in
                         let env3 =
                           let uu___113_3692 = env2 in
                           let uu____3693 =
                             let uu____3695 =
                               let uu____3696 =
                                 let uu____3701 =
                           ...
                           {
                             env = (uu___113_3692.env);
                             subst = uu____3693;
                             tc_const = (uu___113_3692.tc_const)
                           } in
                         let uu____3702 =
                         ...
                         (let x =
                            let uu___114_3711 = bv in
                            let uu____3712 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___114_3711.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___114_3711.FStar_Syntax_Syntax.index);
                    ...
                    let s_what =
                      ...
                      | Some (FStar_Util.Inl lc) ->
                          ...
                          then
                            ...
                            Some
                              (FStar_Util.Inl
                                 ((let uu___115_3852 = lc in
                                   {
                                     FStar_Syntax_Syntax.eff_name =
                                       (uu___115_3852.FStar_Syntax_Syntax.eff_name);
                                     FStar_Syntax_Syntax.res_typ =
                                       (uu___115_3852.FStar_Syntax_Syntax.res_typ);
                                     FStar_Syntax_Syntax.cflags =
                                       (uu___115_3852.FStar_Syntax_Syntax.cflags);
                    ...
                    (fun b  ->
                       ...
                       | (pat,None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____4934;
                               subst = (uu___116_4933.subst);
                               tc_const = (uu___116_4933.tc_const)
                             } in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____5667 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____5683 in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___117_5679.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___117_5679.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____5680;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___117_5679.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___117_5679.FStar_Syntax_Syntax.lbdef)
                         }
                       else binding in
                     let env1 =
                       let uu___118_5686 = env in
                       let uu____5687 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___119_5688 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___119_5688.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___119_5688.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____5687;
                         subst = (uu___118_5686.subst);
                         tc_const = (uu___118_5686.tc_const)
                       } in
                     let uu____5689 = proceed env1 e21 in
                     (match uu____5689 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___120_5700 = binding in
                            let uu____5701 =
                              star_type' env1
                                binding.FStar_Syntax_Syntax.lbtyp in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___120_5700.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___120_5700.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____5701;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___120_5700.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___120_5700.FStar_Syntax_Syntax.lbdef)
                            } in
                          let uu____5704 =
                            let uu____5707 =
                              let uu____5708 =
                                ...
                                ((false,
                                   [(let uu___121_5721 = s_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___121_5721.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___121_5721.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___121_5721.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___121_5721.FStar_Syntax_Syntax.lbeff);
                          ...
                          let uu____5722 =
                            let uu____5725 =
                              let uu____5726 =
                                ...
                                ((false,
                                   [(let uu___122_5739 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___122_5739.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___122_5739.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___122_5739.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___122_5739.FStar_Syntax_Syntax.lbeff);
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___123_5748 = binding in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___123_5748.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___123_5748.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Syntax_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___123_5748.FStar_Syntax_Syntax.lbdef)
                       } in
                     let env1 =
                       let uu___124_5750 = env in
                       let uu____5751 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___125_5752 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___125_5752.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___125_5752.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____5751;
                         subst = (uu___124_5750.subst);
                         tc_const = (uu___124_5750.tc_const)
                       } in
                            ...
                            let uu____5883 =
                              let uu____5884 =
                                let uu____5892 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2 in
                                ((false,
                                   [(let uu___126_5897 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___126_5897.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___126_5897.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___126_5897.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___126_5897.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1
                                     })]), uu____5892) in
