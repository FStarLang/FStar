...
(let _151_748 = (let _151_747 = (let _151_746 = (FStar_Util.string_of_int n)
in (let _151_745 = (FStar_Util.string_of_int (n' - n))
in (let _151_744 = (FStar_Util.string_of_int n)
in (FStar_Util.format3 "The head of this application, after being applied to %s arguments, is an effectful computation (leaving %s arguments to be applied). Please let-bind the head applied to the %s first arguments." _151_746 _151_745 _151_744))))
in FStar_Syntax_Syntax.Err (_151_747))
in (Prims.raise _151_748))
end else begin
()
end
in (
...
| ([], []) -> begin
(let _151_756 = (let _151_755 = (FStar_Syntax_Subst.subst_comp subst comp)
in _151_755.FStar_Syntax_Syntax.n)
in (nm_of_comp _151_756))
end
| (binders, []) -> begin
(match ((let _151_759 = (let _151_758 = (let _151_757 = (mk (FStar_Syntax_Syntax.Tm_arrow (((binders), (comp)))))
in (FStar_Syntax_Subst.subst subst _151_757))
in (FStar_Syntax_Subst.compress _151_758))
in _151_759.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, comp) -> begin
(let _151_763 = (let _151_762 = (let _151_761 = (let _151_760 = (FStar_Syntax_Subst.close_comp binders comp)
in ((binders), (_151_760)))
in FStar_Syntax_Syntax.Tm_arrow (_151_761))
in (mk _151_762))
in N (_151_763))
end
| _57_822 -> begin
...
let _57_864 = (let _151_778 = (FStar_List.map2 (fun _57_847 _57_850 -> (match (((_57_847), (_57_850))) with
| ((bv, _57_846), (arg, q)) -> begin
(match ((let _151_766 = (FStar_Syntax_Subst.compress bv.FStar_Syntax_Syntax.sort)
in _151_766.FStar_Syntax_Syntax.n)) with
...
let _57_861 = (check_n env arg)
in (match (_57_861) with
| (_57_858, s_arg, u_arg) -> begin
(let _151_777 = (let _151_767 = (FStar_Syntax_Syntax.as_implicit false)
in ((s_arg), (_151_767)))
in (let _151_776 = if (is_C bv.FStar_Syntax_Syntax.sort) then begin
(let _151_773 = (let _151_769 = (FStar_Syntax_Subst.subst env.subst s_arg)
in (let _151_768 = (FStar_Syntax_Syntax.as_implicit false)
in ((_151_769), (_151_768))))
in (let _151_772 = (let _151_771 = (let _151_770 = (FStar_Syntax_Syntax.as_implicit false)
in ((u_arg), (_151_770)))
in (_151_771)::[])
in (_151_773)::_151_772))
end else begin
(let _151_775 = (let _151_774 = (FStar_Syntax_Syntax.as_implicit false)
in ((u_arg), (_151_774)))
in (_151_775)::[])
end
...
in (FStar_List.split _151_778))
in (match (_57_864) with
| (s_args, u_args) -> begin
(

let u_args = (FStar_List.flatten u_args)
in (let _151_780 = (mk (FStar_Syntax_Syntax.Tm_app (((s_head), (s_args)))))
in (let _151_779 = (mk (FStar_Syntax_Syntax.Tm_app (((u_head), (u_args)))))
in ((final_type), (_151_780), (_151_779)))))
end))))
end)))))
end))))
end))
...
(let _151_782 = (let _151_781 = (env.tc_const c)
in N (_151_781))
in ((_151_782), (e), (e)))
end
| FStar_Syntax_Syntax.Tm_let (_57_895) -> begin
(let _151_784 = (let _151_783 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "[infer]: Tm_let %s" _151_783))
in (FStar_All.failwith _151_784))
end
| FStar_Syntax_Syntax.Tm_type (_57_898) -> begin
(FStar_All.failwith "impossible (stratified)")
end
| FStar_Syntax_Syntax.Tm_arrow (_57_901) -> begin
(FStar_All.failwith "impossible (stratified)")
end
| FStar_Syntax_Syntax.Tm_refine (_57_904) -> begin
(let _151_786 = (let _151_785 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "[infer]: Tm_refine %s" _151_785))
in (FStar_All.failwith _151_786))
end
| FStar_Syntax_Syntax.Tm_uvar (_57_907) -> begin
(let _151_788 = (let _151_787 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "[infer]: Tm_uvar %s" _151_787))
in (FStar_All.failwith _151_788))
end
| FStar_Syntax_Syntax.Tm_delayed (_57_910) -> begin
(FStar_All.failwith "impossible (compressed)")
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
(let _151_793 = (let _151_792 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "[infer]: Tm_unknown %s" _151_792))
...
let _57_923 = (check_n env e0)
in (match (_57_923) with
| (_57_920, s_e0, u_e0) -> begin
(

let _57_940 = (let _151_809 = (FStar_List.map (fun b -> (match ((FStar_Syntax_Subst.open_branch b)) with
| (pat, None, body) -> begin
(
...
let _57_929 = env
in (let _151_808 = (let _151_807 = (FStar_Syntax_Syntax.pat_bvs pat)
in (FStar_List.fold_left FStar_TypeChecker_Env.push_bv env.env _151_807))
in {env = _151_808; subst = _57_929.subst; tc_const = _57_929.tc_const}))
in (

let _57_935 = (f env body)
...
let _57_984 = (let _151_813 = (FStar_List.map2 (fun nm _57_959 -> (match (_57_959) with
...
let _57_975 = (check env original_body (M (t2)))
in (match (_57_975) with
| (_57_972, s_body, u_body) -> begin
((M (t2)), (((pat), (guard), (s_body))), (((pat), (guard), (u_body))))
end))
end
| (M (_57_977), false) -> begin
(FStar_All.failwith "impossible")
end)
end)) nms branches)
in (FStar_List.unzip3 _151_813))
...
(let _151_818 = (let _151_816 = (let _151_815 = (let _151_814 = (mk_star_to_type mk env t1)
in (FStar_Syntax_Syntax.new_bv None _151_814))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder _151_815))
in (_151_816)::[])
in (let _151_817 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Util.ktype0)
in (FStar_Syntax_Util.arrow _151_818 _151_817)))
end else begin
t1
end
in (let _151_823 = (let _151_821 = (let _151_820 = (let _151_819 = (mk (FStar_Syntax_Syntax.Tm_match (((s_e0), (s_branches)))))
in ((_151_819), (FStar_Util.Inl (t1_star)), (None)))
in FStar_Syntax_Syntax.Tm_ascribed (_151_820))
in (mk _151_821))
in (let _151_822 = (mk (FStar_Syntax_Syntax.Tm_match (((u_e0), (u_branches)))))
in ((if has_m then begin
M (t1)
end else begin
N (t1)
end), (_151_823), (_151_822)))))))
end))))
end))
end))))
...
let x_binders = (let _151_843 = (FStar_Syntax_Syntax.mk_binder x)
in (_151_843)::[])
in (

let _57_1000 = (FStar_Syntax_Subst.open_term x_binders e2)
in (match (_57_1000) with
| (x_binders, e2) -> begin
...
let _57_1006 = env
in (let _151_844 = (FStar_TypeChecker_Env.push_bv env.env (

let _57_1008 = x
in {FStar_Syntax_Syntax.ppname = _57_1008.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _57_1008.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in {env = _151_844; subst = _57_1006.subst; tc_const = _57_1006.tc_const}))
in (

let _57_1014 = (proceed env e2)
in (match (_57_1014) with
| (nm_rec, s_e2, u_e2) -> begin
(let _151_852 = (let _151_847 = (let _151_846 = (let _151_845 = (FStar_Syntax_Subst.close x_binders s_e2)
in ((((false), (((

let _57_1015 = binding
in {FStar_Syntax_Syntax.lbname = _57_1015.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _57_1015.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _57_1015.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _57_1015.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = s_e1}))::[]))), (_151_845)))
in FStar_Syntax_Syntax.Tm_let (_151_846))
in (mk _151_847))
in (let _151_851 = (let _151_850 = (let _151_849 = (let _151_848 = (FStar_Syntax_Subst.close x_binders u_e2)
in ((((false), (((

let _57_1017 = binding
in {FStar_Syntax_Syntax.lbname = _57_1017.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _57_1017.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _57_1017.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _57_1017.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = u_e1}))::[]))), (_151_848)))
in FStar_Syntax_Syntax.Tm_let (_151_849))
in (mk _151_850))
in ((nm_rec), (_151_852), (_151_851))))
end)))
end
...
let _57_1024 = env
in (let _151_853 = (FStar_TypeChecker_Env.push_bv env.env (

let _57_1026 = x
in {FStar_Syntax_Syntax.ppname = _57_1026.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _57_1026.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in {env = _151_853; subst = _57_1024.subst; tc_const = _57_1024.tc_const}))
in (

let _57_1032 = (ensure_m env e2)
...
let s_e2 = (let _151_859 = (let _151_858 = (let _151_857 = (let _151_856 = (let _151_855 = (FStar_Syntax_Syntax.bv_to_name p)
in (let _151_854 = (FStar_Syntax_Syntax.as_implicit false)
in ((_151_855), (_151_854))))
in (_151_856)::[])
in ((s_e2), (_151_857)))
...
let body = (let _151_864 = (let _151_863 = (let _151_862 = (let _151_861 = (let _151_860 = (FStar_Syntax_Syntax.as_implicit false)
in ((s_e2), (_151_860)))
in (_151_861)::[])
in ((s_e1), (_151_862)))
in FStar_Syntax_Syntax.Tm_app (_151_863))
in (mk _151_864))
in (let _151_871 = (let _151_866 = (let _151_865 = (FStar_Syntax_Syntax.mk_binder p)
in (_151_865)::[])
in (FStar_Syntax_Util.abs _151_866 body None))
in (let _151_870 = (let _151_869 = (let _151_868 = (let _151_867 = (FStar_Syntax_Subst.close x_binders u_e2)
in ((((false), (((

let _57_1038 = binding
in {FStar_Syntax_Syntax.lbname = _57_1038.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _57_1038.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _57_1038.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _57_1038.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = u_e1}))::[]))), (_151_867)))
in FStar_Syntax_Syntax.Tm_let (_151_868))
in (mk _151_869))
in ((M (t2)), (_151_871), (_151_870)))))))))
end)))
end)
end)))))))
...
let mn = (let _151_874 = (FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown None e.FStar_Syntax_Syntax.pos)
in N (_151_874))
...
let mn = (let _151_877 = (FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown None e.FStar_Syntax_Syntax.pos)
in M (_151_877))
in (match ((check env e mn)) with
| (M (t), s_e, u_e) -> begin
((t), (s_e), (u_e))
...
let _57_1070 = if (not ((is_C c))) then begin
...
in (match ((let _151_886 = (FStar_Syntax_Subst.compress c)
in _151_886.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_app (head, args) -> begin
(

let _57_1080 = (FStar_Syntax_Util.head_and_args wp)
in (match (_57_1080) with
| (wp_head, wp_args) -> begin
(

let _57_1081 = if ((not (((FStar_List.length wp_args) = (FStar_List.length args)))) || (not ((let _151_887 = (FStar_Syntax_Util.mk_tuple_data_lid (FStar_List.length wp_args) FStar_Range.dummyRange)
in (FStar_Syntax_Util.is_constructor wp_head _151_887))))) then begin
(FStar_All.failwith "mismatch")
end else begin
()
end
in (let _151_894 = (let _151_893 = (let _151_892 = (FStar_List.map2 (fun _57_1086 _57_1090 -> (match (((_57_1086), (_57_1090))) with
| ((arg, _57_1085), (wp_arg, _57_1089)) -> begin
(let _151_891 = (trans_F_ env arg wp_arg)
in (let _151_890 = (FStar_Syntax_Syntax.as_implicit false)
in ((_151_891), (_151_890))))
end)) args wp_args)
in ((head), (_151_892)))
in FStar_Syntax_Syntax.Tm_app (_151_893))
in (mk _151_894)))
end))
end
| FStar_Syntax_Syntax.Tm_arrow (binders, comp) -> begin
...
let _57_1099 = (FStar_Syntax_Subst.open_comp binders comp)
in (match (_57_1099) with
| (binders, comp) -> begin
(

let _57_1108 = (let _151_906 = (FStar_List.map (fun _57_1102 -> (match (_57_1102) with
| (bv, q) -> begin
(
...
let w' = (let _151_896 = (star_type' env h)
in (FStar_Syntax_Syntax.gen_bv (Prims.strcat bv.FStar_Syntax_Syntax.ppname.FStar_Ident.idText "-w\'") None _151_896))
in (let _151_902 = (let _151_901 = (FStar_Syntax_Syntax.mk_binder w')
in (let _151_900 = (let _151_899 = (let _151_898 = (let _151_897 = (FStar_Syntax_Syntax.bv_to_name bv)
in (trans_F_ env h _151_897))
in (FStar_Syntax_Syntax.null_binder _151_898))
in (_151_899)::[])
in (_151_901)::_151_900))
in ((w'), (_151_902))))
end else begin
(

let x = (let _151_903 = (star_type' env h)
in (FStar_Syntax_Syntax.gen_bv (Prims.strcat bv.FStar_Syntax_Syntax.ppname.FStar_Ident.idText "-x") None _151_903))
in (let _151_905 = (let _151_904 = (FStar_Syntax_Syntax.mk_binder x)
in (_151_904)::[])
in ((x), (_151_905))))
end)
end)) binders)
in (FStar_List.split _151_906))
