                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____1563 in
                          {
                            ...
                            FStar_Syntax_Syntax.tk =
                              (uu___99_1561.FStar_Syntax_Syntax.tk);
                            FStar_Syntax_Syntax.pos =
                              (uu___99_1561.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___99_1561.FStar_Syntax_Syntax.vars)
                          } in
                        mk_rel1 t2 x y
                    ...
                    let uu____2054 =
                        ...
                        let uu____2078 = c wp_trivial2 in ([], uu____2078) in
                      {
                        FStar_Syntax_Syntax.qualifiers =
                          (uu___100_2055.FStar_Syntax_Syntax.qualifiers);
                        FStar_Syntax_Syntax.cattributes =
                          (uu___100_2055.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___100_2055.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___100_2055.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___100_2055.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___100_2055.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___100_2055.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___100_2055.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___100_2055.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___100_2055.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___100_2055.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___100_2055.FStar_Syntax_Syntax.actions)
                      } in
...
let set_env: env -> FStar_TypeChecker_Env.env -> env =
  fun dmff_env  ->
    fun env'  ->
      let uu___101_2090 = dmff_env in
      {
        env = env';
        subst = (uu___101_2090.subst);
        tc_const = (uu___101_2090.tc_const)
      }
type nm =
          ...
          let binders1 =
            FStar_List.map
              (fun uu____2317  ->
                 ...
                 | (bv,aqual) ->
                     let uu____2324 =
                       let uu___102_2325 = bv in
                       let uu____2326 =
                         star_type' env bv.FStar_Syntax_Syntax.sort in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___102_2325.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___102_2325.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___106_2690 = x1 in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___106_2690.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___106_2690.FStar_Syntax_Syntax.index);
...
let is_monadic uu___90_2917 =
  match uu___90_2917 with
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___92_3367 =
            match uu___92_3367 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,what) ->
          ...
          let env1 =
            let uu___107_3630 = env in
            let uu____3631 =
              FStar_TypeChecker_Env.push_binders env.env binders1 in
            {
              env = uu____3631;
              subst = (uu___107_3630.subst);
              tc_const = (uu___107_3630.tc_const)
            } in
          let s_binders =
            FStar_List.map
              (fun uu____3640  ->
                 ...
                 | (bv,qual) ->
                     ...
                     ((let uu___108_3648 = bv in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___108_3648.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___108_3648.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1 in
          let uu____3649 =
            FStar_List.fold_left
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___109_3694.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___109_3694.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____3695
                           } in
                         let env3 =
                           let uu___110_3700 = env2 in
                           let uu____3701 =
                             let uu____3703 =
                               let uu____3704 =
                                 let uu____3709 =
                           ...
                           {
                             env = (uu___110_3700.env);
                             subst = uu____3701;
                             tc_const = (uu___110_3700.tc_const)
                           } in
                         let uu____3710 =
                         ...
                         (let x =
                            let uu___111_3719 = bv in
                            let uu____3720 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___111_3719.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___111_3719.FStar_Syntax_Syntax.index);
                    ...
                    let s_what =
                      ...
                      | Some (FStar_Util.Inl lc) ->
                          ...
                          then
                            ...
                            Some
                              (FStar_Util.Inl
                                 ((let uu___112_3860 = lc in
                                   {
                                     FStar_Syntax_Syntax.eff_name =
                                       (uu___112_3860.FStar_Syntax_Syntax.eff_name);
                                     FStar_Syntax_Syntax.res_typ =
                                       (uu___112_3860.FStar_Syntax_Syntax.res_typ);
                                     FStar_Syntax_Syntax.cflags =
                                       (uu___112_3860.FStar_Syntax_Syntax.cflags);
                    ...
                    (fun b  ->
                       ...
                       | (pat,None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____4942;
                               subst = (uu___113_4941.subst);
                               tc_const = (uu___113_4941.tc_const)
                             } in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____5675 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____5691 in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___114_5687.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___114_5687.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____5688;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___114_5687.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___114_5687.FStar_Syntax_Syntax.lbdef)
                         }
                       else binding in
                     let env1 =
                       let uu___115_5694 = env in
                       let uu____5695 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___116_5696 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___116_5696.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___116_5696.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____5695;
                         subst = (uu___115_5694.subst);
                         tc_const = (uu___115_5694.tc_const)
                       } in
                     let uu____5697 = proceed env1 e21 in
                     (match uu____5697 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___117_5708 = binding in
                            let uu____5709 =
                              star_type' env1
                                binding.FStar_Syntax_Syntax.lbtyp in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___117_5708.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___117_5708.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____5709;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___117_5708.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___117_5708.FStar_Syntax_Syntax.lbdef)
                            } in
                          let uu____5712 =
                            let uu____5715 =
                              let uu____5716 =
                                ...
                                ((false,
                                   [(let uu___118_5729 = s_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___118_5729.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___118_5729.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___118_5729.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___118_5729.FStar_Syntax_Syntax.lbeff);
                          ...
                          let uu____5730 =
                            let uu____5733 =
                              let uu____5734 =
                                ...
                                ((false,
                                   [(let uu___119_5747 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___119_5747.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___119_5747.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___119_5747.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___119_5747.FStar_Syntax_Syntax.lbeff);
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___120_5756 = binding in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___120_5756.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___120_5756.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Syntax_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___120_5756.FStar_Syntax_Syntax.lbdef)
                       } in
                     let env1 =
                       let uu___121_5758 = env in
                       let uu____5759 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___122_5760 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___122_5760.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___122_5760.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____5759;
                         subst = (uu___121_5758.subst);
                         tc_const = (uu___121_5758.tc_const)
                       } in
                            ...
                            let uu____5891 =
                              let uu____5892 =
                                let uu____5900 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2 in
                                ((false,
                                   [(let uu___123_5905 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___123_5905.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___123_5905.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___123_5905.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___123_5905.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1
                                     })]), uu____5900) in
