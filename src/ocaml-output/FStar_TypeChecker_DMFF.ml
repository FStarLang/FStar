                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____2996  in
                          {
                            ...
                            FStar_Syntax_Syntax.pos =
                              (uu___345_2994.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___345_2994.FStar_Syntax_Syntax.vars)
                          }  in
                        mk_rel1 t2 x y
                    ...
                    let uu____4053 =
                         ...
                         in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___346_4054.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___346_4054.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___346_4054.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___346_4054.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___346_4054.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___346_4054.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___346_4054.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___346_4054.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___346_4054.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___346_4054.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___346_4054.FStar_Syntax_Syntax.actions);
                        FStar_Syntax_Syntax.eff_attrs =
                          (uu___346_4054.FStar_Syntax_Syntax.eff_attrs)
                      }  in
...
let (set_env : env -> FStar_TypeChecker_Env.env -> env) =
  fun dmff_env  ->
    fun env'  ->
      let uu___347_4134 = dmff_env  in
      {
        env = env';
        subst = (uu___347_4134.subst);
        tc_const = (uu___347_4134.tc_const)
      }
    ...
    fun t  ->
          ...
          let binders1 =
            FStar_List.map
              (fun uu____4493  ->
                 ...
                 | (bv,aqual) ->
                     let uu____4512 =
                       let uu___348_4513 = bv  in
                       let uu____4514 =
                         star_type' env bv.FStar_Syntax_Syntax.sort  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___348_4513.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___348_4513.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,repr,something) ->
          ...
          (match uu____5146 with
           | (binders1,repr1) ->
               let env1 =
                 let uu___351_5154 = env  in
                 let uu____5155 =
                   FStar_TypeChecker_Env.push_binders env.env binders1  in
                 {
                   env = uu____5155;
                   subst = (uu___351_5154.subst);
                   tc_const = (uu___351_5154.tc_const)
                 }  in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___352_5177 = x1  in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___352_5177.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___352_5177.FStar_Syntax_Syntax.index);
...
let (is_monadic :
  ...
  =
  fun uu___336_5706  ->
    match uu___336_5706 with
    | FStar_Pervasives_Native.None  -> failwith "un-annotated lambda?!"
    | FStar_Pervasives_Native.Some rc ->
        FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
          (FStar_Util.for_some
             (fun uu___335_5713  ->
                match uu___335_5713 with
                | FStar_Syntax_Syntax.CPS  -> true
                | uu____5714 -> false))
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___338_6414 =
            match uu___338_6414 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,rc_opt) ->
                ...
                let uu____6914 =
                    ...
                    FStar_Pervasives_Native.Some uu____6921  in
                  {
                    FStar_Syntax_Syntax.residual_effect =
                      (uu___353_6915.FStar_Syntax_Syntax.residual_effect);
                    FStar_Syntax_Syntax.residual_typ = uu____6916;
                    FStar_Syntax_Syntax.residual_flags =
                      (uu___353_6915.FStar_Syntax_Syntax.residual_flags)
                  }  in
          ...
          let env1 =
            let uu___354_6936 = env  in
            let uu____6937 =
              FStar_TypeChecker_Env.push_binders env.env binders1  in
            {
              env = uu____6937;
              subst = (uu___354_6936.subst);
              tc_const = (uu___354_6936.tc_const)
            }  in
          let s_binders =
            FStar_List.map
              (fun uu____6963  ->
                 ...
                 | (bv,qual) ->
                     let sort = star_type' env1 bv.FStar_Syntax_Syntax.sort
                        in
                     ((let uu___355_6986 = bv  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___355_6986.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___355_6986.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1
             in
          let uu____6987 =
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___356_7087.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___356_7087.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____7088
                           }  in
                         let env3 =
                           let uu___357_7093 = env2  in
                           let uu____7094 =
                             let uu____7097 =
                               let uu____7098 =
                                 let uu____7105 =
                           ...
                           {
                             env = (uu___357_7093.env);
                             subst = uu____7094;
                             tc_const = (uu___357_7093.tc_const)
                           }  in
                         let uu____7110 =
                         ...
                         (let x =
                            let uu___358_7122 = bv  in
                            let uu____7123 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___358_7122.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___358_7122.FStar_Syntax_Syntax.index);
                           ...
                           | FStar_Pervasives_Native.Some rt ->
                               ...
                               then
                                 ...
                                 (let uu____7296 =
                                    ...
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___359_7297.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ =
                                        uu____7298;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___359_7297.FStar_Syntax_Syntax.residual_flags)
                                    }  in
                    ...
                    (fun b  ->
                       ...
                       | (pat,FStar_Pervasives_Native.None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____10200;
                               subst = (uu___360_10199.subst);
                               tc_const = (uu___360_10199.tc_const)
                             }  in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____11596 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____11618  in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___361_11614.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___361_11614.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____11615;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___361_11614.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___361_11614.FStar_Syntax_Syntax.lbdef);
                           FStar_Syntax_Syntax.lbattrs =
                             (uu___361_11614.FStar_Syntax_Syntax.lbattrs);
                           FStar_Syntax_Syntax.lbpos =
                             (uu___361_11614.FStar_Syntax_Syntax.lbpos)
                         }
                       else binding  in
                     let env1 =
                       let uu___362_11621 = env  in
                       let uu____11622 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___363_11624 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___363_11624.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___363_11624.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         env = uu____11622;
                         subst = (uu___362_11621.subst);
                         tc_const = (uu___362_11621.tc_const)
                       }  in
                     let uu____11625 = proceed env1 e21  in
                     (match uu____11625 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___364_11642 = binding  in
                            let uu____11643 =
                              star_type' env1
                            ...
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___364_11642.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___364_11642.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____11643;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___364_11642.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___364_11642.FStar_Syntax_Syntax.lbdef);
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___364_11642.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___364_11642.FStar_Syntax_Syntax.lbpos)
                            }  in
                          let uu____11646 =
                            let uu____11647 =
                              let uu____11648 =
                                let uu____11661 =
                                  FStar_Syntax_Subst.close x_binders1 s_e2
                                   in
                                ((false,
                                   [(let uu___365_11675 = s_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___365_11675.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___365_11675.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___365_11675.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___365_11675.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = s_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___365_11675.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___365_11675.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11661)
                                 in
                              ...
                              let uu____11678 =
                                let uu____11691 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___366_11705 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___366_11705.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___366_11705.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___366_11705.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___366_11705.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___366_11705.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___366_11705.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11691)
                                 in
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___367_11710 = binding  in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___367_11710.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___367_11710.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Parser_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___367_11710.FStar_Syntax_Syntax.lbdef);
                         FStar_Syntax_Syntax.lbattrs =
                           (uu___367_11710.FStar_Syntax_Syntax.lbattrs);
                         FStar_Syntax_Syntax.lbpos =
                           (uu___367_11710.FStar_Syntax_Syntax.lbpos)
                       }  in
                     let env1 =
                       let uu___368_11712 = env  in
                       let uu____11713 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___369_11715 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___369_11715.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___369_11715.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         env = uu____11713;
                         subst = (uu___368_11712.subst);
                         tc_const = (uu___368_11712.tc_const)
                       }  in
                              ...
                              let uu____11917 =
                                let uu____11930 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___370_11944 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___370_11944.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___370_11944.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___370_11944.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___370_11944.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___370_11944.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___370_11944.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11930)
                                 in
      ...
      fun wp  ->
        ...
        (let mk1 x =
         ...
         | FStar_Syntax_Syntax.Tm_arrow (binders,comp) ->
             ...
             let uu____12302 = FStar_Syntax_Subst.open_comp binders1 comp  in
                      ...
                      FStar_List.map
                        (fun uu____12366  ->
                           ...
                           | (bv,q) ->
                               ...
                               let uu____12394 = is_C h  in
                               if uu____12394
                               then
                                 let w' =
                                   let uu____12408 = star_type' env h  in
                                   FStar_Syntax_Syntax.gen_bv
                                     (Prims.strcat
                                        (bv.FStar_Syntax_Syntax.ppname).FStar_Ident.idText
                                        "__w'") FStar_Pervasives_Native.None
                                 ...
                                 (let x =
                                    let uu____12469 = star_type' env h  in
                                    FStar_Syntax_Syntax.gen_bv
                                      (Prims.strcat
                                         (bv.FStar_Syntax_Syntax.ppname).FStar_Ident.idText
                                  ...
                                  (x, [(x, q)]))) binders_orig
                       in
                    FStar_List.split uu____12326  in
                       ...
                       let comp2 =
                         let uu____12542 =
                           ...
                           FStar_Syntax_Util.rename_binders binders_orig
                             uu____12545
                            in
                         FStar_Syntax_Subst.subst_comp uu____12542 comp1  in
                       let app =
                         let uu____12549 =
                           let uu____12550 =
                             let uu____12567 =
                               FStar_List.map
                                 (fun bv  ->
                                    ...
                                    let uu____12587 =
                                      FStar_Syntax_Syntax.as_implicit false
                                       in
                                    (uu____12586, uu____12587)) bvs
                                in
                             (wp, uu____12567)  in
                           FStar_Syntax_Syntax.Tm_app uu____12550  in
                         mk1 uu____12549  in
                       let comp3 =
                         let uu____12601 = type_of_comp comp2  in
                         let uu____12602 = is_monadic_comp comp2  in
                         trans_G env uu____12601 uu____12602 app  in
                       FStar_Syntax_Util.arrow binders3 comp3))
         | FStar_Syntax_Syntax.Tm_ascribed (e,uu____12604,uu____12605) ->
             trans_F_ env e wp
         | uu____12646 -> failwith "impossible trans_F_")
    ...
    fun h  ->
      fun is_monadic1  ->
        fun wp  ->
          ...
          then
            let uu____12651 =
              let uu____12652 = star_type' env h  in
              let uu____12655 =
                let uu____12666 =
                  let uu____12675 = FStar_Syntax_Syntax.as_implicit false  in
                  (wp, uu____12675)  in
                [uu____12666]  in
              {
                ...
                FStar_Syntax_Syntax.effect_name =
                  FStar_Parser_Const.effect_PURE_lid;
                FStar_Syntax_Syntax.result_typ = uu____12652;
                FStar_Syntax_Syntax.effect_args = uu____12655;
                FStar_Syntax_Syntax.flags = []
              }  in
            FStar_Syntax_Syntax.mk_Comp uu____12651
          else
            (let uu____12699 = trans_F_ env h wp  in
             FStar_Syntax_Syntax.mk_Total uu____12699)
...
let (star_type : env -> FStar_Syntax_Syntax.typ -> FStar_Syntax_Syntax.typ) =
  fun env  ->
    fun t  -> let uu____12718 = n env.env t  in star_type' env uu____12718
...
let (star_expr :
  ...
  =
  fun env  ->
    fun t  -> let uu____12737 = n env.env t  in check_n env uu____12737
...
let (trans_F :
  ...
  fun env  ->
    fun c  ->
      fun wp  ->
        let uu____12753 = n env.env c  in
        let uu____12754 = n env.env wp  in
        trans_F_ env uu____12753 uu____12754
