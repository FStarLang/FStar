            ...
            let a1 =
                  ...
                  a.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___98_64.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___98_64.FStar_Syntax_Syntax.index);
                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____1561 in
                          {
                            ...
                            FStar_Syntax_Syntax.tk =
                              (uu___99_1559.FStar_Syntax_Syntax.tk);
                            FStar_Syntax_Syntax.pos =
                              (uu___99_1559.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___99_1559.FStar_Syntax_Syntax.vars)
                          } in
                        mk_rel1 t2 x y
                    ...
                    let uu____2002 =
                        ...
                        let uu____2026 = c wp_trivial2 in ([], uu____2026) in
                      {
                        FStar_Syntax_Syntax.qualifiers =
                          (uu___100_2003.FStar_Syntax_Syntax.qualifiers);
                        FStar_Syntax_Syntax.cattributes =
                          (uu___100_2003.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___100_2003.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___100_2003.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___100_2003.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___100_2003.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___100_2003.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___100_2003.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___100_2003.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___100_2003.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___100_2003.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___100_2003.FStar_Syntax_Syntax.actions)
                      } in
...
let set_env: env -> FStar_TypeChecker_Env.env -> env =
  fun dmff_env  ->
    fun env'  ->
      let uu___101_2038 = dmff_env in
      {
        env = env';
        subst = (uu___101_2038.subst);
        tc_const = (uu___101_2038.tc_const)
      }
type nm =
    ...
    fun t  ->
          ...
          let binders1 =
            FStar_List.map
              (fun uu____2265  ->
                 ...
                 | (bv,aqual) ->
                     let uu____2272 =
                       let uu___102_2273 = bv in
                       let uu____2274 =
                         star_type' env bv.FStar_Syntax_Syntax.sort in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___102_2273.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___102_2273.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,repr,something) ->
          ...
          (match uu____2614 with
           | (binders1,repr1) ->
               let env1 =
                 let uu___105_2620 = env in
                 let uu____2621 =
                   FStar_TypeChecker_Env.push_binders env.env binders1 in
                 {
                   env = uu____2621;
                   subst = (uu___105_2620.subst);
                   tc_const = (uu___105_2620.tc_const)
                 } in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___106_2638 = x1 in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___106_2638.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___106_2638.FStar_Syntax_Syntax.index);
...
let is_monadic uu___90_2865 =
  match uu___90_2865 with
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___92_3315 =
            match uu___92_3315 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,what) ->
          ...
          let env1 =
            let uu___107_3578 = env in
            let uu____3579 =
              FStar_TypeChecker_Env.push_binders env.env binders1 in
            {
              env = uu____3579;
              subst = (uu___107_3578.subst);
              tc_const = (uu___107_3578.tc_const)
            } in
          let s_binders =
            FStar_List.map
              (fun uu____3588  ->
                 ...
                 | (bv,qual) ->
                     ...
                     ((let uu___108_3596 = bv in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___108_3596.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___108_3596.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1 in
          let uu____3597 =
            FStar_List.fold_left
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let env3 =
                           ...
                           {
                             env = (uu___110_3648.env);
                             subst = uu____3649;
                             tc_const = (uu___110_3648.tc_const)
                           } in
                         let uu____3658 =
                         ...
                         (let x =
                            let uu___111_3667 = bv in
                            let uu____3668 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___111_3667.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___111_3667.FStar_Syntax_Syntax.index);
                    ...
                    let s_what =
                      ...
                      | Some (FStar_Util.Inl lc) ->
                          ...
                          then
                            ...
                            Some
                              (FStar_Util.Inl
                                 ((let uu___112_3808 = lc in
                                   {
                                     FStar_Syntax_Syntax.eff_name =
                                       (uu___112_3808.FStar_Syntax_Syntax.eff_name);
                                     FStar_Syntax_Syntax.res_typ =
                                       (uu___112_3808.FStar_Syntax_Syntax.res_typ);
                                     FStar_Syntax_Syntax.cflags =
                                       (uu___112_3808.FStar_Syntax_Syntax.cflags);
                    ...
                    (fun b  ->
                       ...
                       | (pat,None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____4890;
                               subst = (uu___113_4889.subst);
                               tc_const = (uu___113_4889.tc_const)
                             } in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____5623 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____5639 in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___114_5635.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___114_5635.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____5636;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___114_5635.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___114_5635.FStar_Syntax_Syntax.lbdef)
                         }
                       else binding in
                     let env1 =
                       let uu___115_5642 = env in
                       let uu____5643 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___116_5644 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___116_5644.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___116_5644.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____5643;
                         subst = (uu___115_5642.subst);
                         tc_const = (uu___115_5642.tc_const)
                       } in
                     let uu____5645 = proceed env1 e21 in
                     (match uu____5645 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___117_5656 = binding in
                            let uu____5657 =
                              star_type' env1
                                binding.FStar_Syntax_Syntax.lbtyp in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___117_5656.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___117_5656.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____5657;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___117_5656.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___117_5656.FStar_Syntax_Syntax.lbdef)
                            } in
                          let uu____5660 =
                            let uu____5663 =
                              let uu____5664 =
                                ...
                                ((false,
                                   [(let uu___118_5677 = s_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___118_5677.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___118_5677.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___118_5677.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___118_5677.FStar_Syntax_Syntax.lbeff);
                          ...
                          let uu____5678 =
                            let uu____5681 =
                              let uu____5682 =
                                ...
                                ((false,
                                   [(let uu___119_5695 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___119_5695.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___119_5695.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___119_5695.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___119_5695.FStar_Syntax_Syntax.lbeff);
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___120_5704 = binding in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___120_5704.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___120_5704.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Syntax_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___120_5704.FStar_Syntax_Syntax.lbdef)
                       } in
                     let env1 =
                       let uu___121_5706 = env in
                       let uu____5707 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___122_5708 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___122_5708.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___122_5708.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____5707;
                         subst = (uu___121_5706.subst);
                         tc_const = (uu___121_5706.tc_const)
                       } in
                            ...
                            let uu____5839 =
                              let uu____5840 =
                                let uu____5848 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2 in
                                ((false,
                                   [(let uu___123_5853 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___123_5853.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___123_5853.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___123_5853.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___123_5853.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1
                                     })]), uu____5848) in
