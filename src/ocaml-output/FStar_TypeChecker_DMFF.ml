            ...
            let a1 =
                 ...
                 in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___391_123.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___391_123.FStar_Syntax_Syntax.index);
                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____2988  in
                          {
                            ...
                            FStar_Syntax_Syntax.pos =
                              (uu___392_2986.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___392_2986.FStar_Syntax_Syntax.vars)
                          }  in
                        mk_rel1 t2 x y
                    ...
                    let uu____4041 =
                         ...
                         in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___393_4042.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___393_4042.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___393_4042.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___393_4042.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___393_4042.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___393_4042.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___393_4042.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___393_4042.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___393_4042.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___393_4042.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___393_4042.FStar_Syntax_Syntax.actions);
                        FStar_Syntax_Syntax.eff_attrs =
                          (uu___393_4042.FStar_Syntax_Syntax.eff_attrs)
                      }  in
...
let (set_env : env -> FStar_TypeChecker_Env.env -> env) =
  fun dmff_env  ->
    fun env'  ->
      let uu___394_4122 = dmff_env  in
      {
        env = env';
        subst = (uu___394_4122.subst);
        tc_const = (uu___394_4122.tc_const)
      }
    ...
    fun t  ->
          ...
          let binders1 =
            FStar_List.map
              (fun uu____4481  ->
                 ...
                 | (bv,aqual) ->
                     let uu____4500 =
                       let uu___395_4501 = bv  in
                       let uu____4502 =
                         star_type' env bv.FStar_Syntax_Syntax.sort  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___395_4501.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___395_4501.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,repr,something) ->
          ...
          (match uu____5134 with
           | (binders1,repr1) ->
               let env1 =
                 let uu___398_5142 = env  in
                 let uu____5143 =
                   FStar_TypeChecker_Env.push_binders env.env binders1  in
                 {
                   env = uu____5143;
                   subst = (uu___398_5142.subst);
                   tc_const = (uu___398_5142.tc_const)
                 }  in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___399_5165 = x1  in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___399_5165.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___399_5165.FStar_Syntax_Syntax.index);
...
let (is_monadic :
  ...
  =
  fun uu___383_5694  ->
    match uu___383_5694 with
    | FStar_Pervasives_Native.None  -> failwith "un-annotated lambda?!"
    | FStar_Pervasives_Native.Some rc ->
        FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
          (FStar_Util.for_some
             (fun uu___382_5701  ->
                match uu___382_5701 with
                | FStar_Syntax_Syntax.CPS  -> true
                | uu____5702 -> false))
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___385_6402 =
            match uu___385_6402 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,rc_opt) ->
                ...
                let uu____6902 =
                    ...
                    FStar_Pervasives_Native.Some uu____6909  in
                  {
                    FStar_Syntax_Syntax.residual_effect =
                      (uu___400_6903.FStar_Syntax_Syntax.residual_effect);
                    FStar_Syntax_Syntax.residual_typ = uu____6904;
                    FStar_Syntax_Syntax.residual_flags =
                      (uu___400_6903.FStar_Syntax_Syntax.residual_flags)
                  }  in
          ...
          let env1 =
            let uu___401_6924 = env  in
            let uu____6925 =
              FStar_TypeChecker_Env.push_binders env.env binders1  in
            {
              env = uu____6925;
              subst = (uu___401_6924.subst);
              tc_const = (uu___401_6924.tc_const)
            }  in
          let s_binders =
            FStar_List.map
              (fun uu____6951  ->
                 ...
                 | (bv,qual) ->
                     let sort = star_type' env1 bv.FStar_Syntax_Syntax.sort
                        in
                     ((let uu___402_6974 = bv  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___402_6974.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___402_6974.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1
             in
          let uu____6975 =
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___403_7075.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___403_7075.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____7076
                           }  in
                         let env3 =
                           let uu___404_7081 = env2  in
                           let uu____7082 =
                             let uu____7085 =
                               let uu____7086 =
                                 let uu____7093 =
                           ...
                           {
                             env = (uu___404_7081.env);
                             subst = uu____7082;
                             tc_const = (uu___404_7081.tc_const)
                           }  in
                         let uu____7098 =
                         ...
                         (let x =
                            let uu___405_7110 = bv  in
                            let uu____7111 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___405_7110.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___405_7110.FStar_Syntax_Syntax.index);
                           ...
                           | FStar_Pervasives_Native.Some rt ->
                               ...
                               then
                                 ...
                                 (let uu____7284 =
                                    ...
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___406_7285.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ =
                                        uu____7286;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___406_7285.FStar_Syntax_Syntax.residual_flags)
                                    }  in
                    ...
                    (fun b  ->
                       ...
                       | (pat,FStar_Pervasives_Native.None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____10188;
                               subst = (uu___407_10187.subst);
                               tc_const = (uu___407_10187.tc_const)
                             }  in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____11584 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____11606  in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___408_11602.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___408_11602.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____11603;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___408_11602.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___408_11602.FStar_Syntax_Syntax.lbdef);
                           FStar_Syntax_Syntax.lbattrs =
                             (uu___408_11602.FStar_Syntax_Syntax.lbattrs);
                           FStar_Syntax_Syntax.lbpos =
                             (uu___408_11602.FStar_Syntax_Syntax.lbpos)
                         }
                       else binding  in
                     let env1 =
                       let uu___409_11609 = env  in
                       let uu____11610 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___410_11612 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___410_11612.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___410_11612.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         env = uu____11610;
                         subst = (uu___409_11609.subst);
                         tc_const = (uu___409_11609.tc_const)
                       }  in
                     let uu____11613 = proceed env1 e21  in
                     (match uu____11613 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___411_11630 = binding  in
                            let uu____11631 =
                              star_type' env1
                            ...
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___411_11630.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___411_11630.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____11631;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___411_11630.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___411_11630.FStar_Syntax_Syntax.lbdef);
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___411_11630.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___411_11630.FStar_Syntax_Syntax.lbpos)
                            }  in
                          let uu____11634 =
                            let uu____11635 =
                              let uu____11636 =
                                let uu____11649 =
                                  FStar_Syntax_Subst.close x_binders1 s_e2
                                   in
                                ((false,
                                   [(let uu___412_11663 = s_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___412_11663.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___412_11663.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___412_11663.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___412_11663.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = s_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___412_11663.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___412_11663.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11649)
                                 in
                              ...
                              let uu____11666 =
                                let uu____11679 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___413_11693 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___413_11693.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___413_11693.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___413_11693.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___413_11693.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___413_11693.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___413_11693.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11679)
                                 in
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___414_11698 = binding  in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___414_11698.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___414_11698.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Parser_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___414_11698.FStar_Syntax_Syntax.lbdef);
                         FStar_Syntax_Syntax.lbattrs =
                           (uu___414_11698.FStar_Syntax_Syntax.lbattrs);
                         FStar_Syntax_Syntax.lbpos =
                           (uu___414_11698.FStar_Syntax_Syntax.lbpos)
                       }  in
                     let env1 =
                       let uu___415_11700 = env  in
                       let uu____11701 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___416_11703 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___416_11703.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___416_11703.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         env = uu____11701;
                         subst = (uu___415_11700.subst);
                         tc_const = (uu___415_11700.tc_const)
                       }  in
                              ...
                              let uu____11905 =
                                let uu____11918 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___417_11932 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___417_11932.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___417_11932.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___417_11932.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___417_11932.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___417_11932.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___417_11932.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11918)
                                 in
