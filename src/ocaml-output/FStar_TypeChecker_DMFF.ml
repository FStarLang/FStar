                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____2023 in
                          {
                            ...
                            FStar_Syntax_Syntax.pos =
                              (uu___78_2021.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___78_2021.FStar_Syntax_Syntax.vars)
                          } in
                        mk_rel1 t2 x y
                    ...
                    let uu____2736 =
                        ...
                        let uu____2767 = c wp_trivial2 in ([], uu____2767) in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___79_2737.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___79_2737.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___79_2737.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___79_2737.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___79_2737.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___79_2737.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___79_2737.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___79_2737.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___79_2737.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___79_2737.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___79_2737.FStar_Syntax_Syntax.actions);
                        FStar_Syntax_Syntax.eff_attrs =
                          (uu___79_2737.FStar_Syntax_Syntax.eff_attrs)
                      } in
...
let (set_env : env -> FStar_TypeChecker_Env.env -> env) =
  fun dmff_env ->
    fun env' ->
      ...
      {
        env = env';
        subst = (uu___80_2781.subst);
        tc_const = (uu___80_2781.tc_const)
      }
type nm =
...
let (is_monadic_arrow : FStar_Syntax_Syntax.term' -> nm) =
  fun n1 ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow
        (uu____2856,
         { FStar_Syntax_Syntax.n = n2; FStar_Syntax_Syntax.pos = uu____2858;
  ...
  fun env ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_ascribed
          ...
          mk1 uu____3789
      | FStar_Syntax_Syntax.Tm_ascribed
          (uu____3871, (uu____3872, FStar_Pervasives_Native.Some uu____3873),
           uu____3874)
          ->
          let uu____3923 =
            let uu____3928 =
      ...
      | FStar_Syntax_Syntax.Tm_let uu____4010 ->
          let uu____4023 =
            let uu____4028 =
              ...
              FStar_Util.format1
                "Tm_let is outside of the definition language: %s" uu____4029 in
        ...
        then
          ((let uu____4150 =
              let uu____4151 =
                FStar_List.for_all
                  (fun uu____4159 ->
                     match uu____4159 with | (h, uu____4165) -> is_C h) args in
                ...
                FStar_List.for_all
                  (fun uu____4179 ->
                     ...
                     | (h, uu____4185) ->
                         ...
                         Prims.op_Negation uu____4186) args in
    ...
    fun t ->
      fun e ->
        ...
        let body =
          ...
          mk1 uu____4290 in
        let uu____4334 =
          let uu____4335 = FStar_Syntax_Syntax.mk_binder p in [uu____4335] in
    ...
    fun e ->
      fun context_nm ->
          ...
          | (rec_nm, s_e, u_e) ->
                ...
                let uu____4541 =
                  (Prims.op_Negation (is_unknown t2.FStar_Syntax_Syntax.n))
                    ...
                    (let uu____4543 =
                     ...
                     Prims.op_Negation uu____4543) in
                if uu____4541
                then
                  let uu____4545 =
                    let uu____4550 =
                      let uu____4551 = FStar_Syntax_Print.term_to_string e in
                      let uu____4552 = FStar_Syntax_Print.term_to_string t1 in
                      let uu____4553 = FStar_Syntax_Print.term_to_string t2 in
                      FStar_Util.format3
                        "[check]: the expression [%s] has type [%s] but should have type [%s]"
                        uu____4551 uu____4552 uu____4553 in
              ...
              (match (rec_nm, context_nm) with
               ...
               | (M t1, N t2) ->
                   let uu____4573 =
                     let uu____4578 =
                       let uu____4579 = FStar_Syntax_Print.term_to_string e in
                       let uu____4580 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____4581 = FStar_Syntax_Print.term_to_string t2 in
                       FStar_Util.format3
                         "[check %s]: got an effectful computation [%s] in lieu of a pure computation [%s]"
                         uu____4579 uu____4580 uu____4581 in
                     (FStar_Errors.Fatal_EffectfulAndPureComputationMismatch,
                       uu____4578) in
                   FStar_Errors.raise_err uu____4573) in
        let ensure_m env1 e2 =
          ...
          | M uu____4671 ->
              let uu____4672 = check env1 e2 context_nm in strip_m uu____4672 in
        let uu____4679 =
    ...
    fun e ->
                 ...
                 fun uu____5193 ->
                   ...
                   | ((env2, acc), (bv, qual)) ->
                       ...
                       then
                         ...
                         let uu____5270 =
                           let uu____5273 = FStar_Syntax_Syntax.mk_binder x in
                           let uu____5274 =
                             let uu____5277 =
                         ...
                         (let x =
                          ...
                          let uu____5286 =
                            let uu____5289 = FStar_Syntax_Syntax.mk_binder x in
                            uu____5289 :: acc in
                          (env2, uu____5286))) (env1, []) binders1 in
                               ...
                               then
                                 ...
                                 let uu____5416 =
                                   let uu____5417 =
                                     ...
                                     FStar_Pervasives_Native.Some uu____5422 in
                                   FStar_Syntax_Util.mk_residual_comp
                                     FStar_Parser_Const.effect_Tot_lid
                                     uu____5417 flags1 in
                                 ...
                                 (let uu____5424 =
                                    ...
                                    let uu____5426 =
                                      ...
                                      FStar_Pervasives_Native.Some uu____5431 in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                  ...
                                  FStar_Pervasives_Native.Some uu____5424)) in
                    let uu____5432 =
                      let comp1 =
      ...
      | FStar_Syntax_Syntax.Tm_fvar
          ...
          (match uu____5553 with
           | (uu____5589, t) ->
               let uu____5591 = let uu____5592 = normalize1 t in N uu____5592 in
               (uu____5591, e, e))
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____5594;_},
           a::hd1::rest)
          ->
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____5739;_},
           a1::a2::hd1::rest)
          ->
          let rest1 = hd1 :: rest in
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____5903;_},
      ...
      | FStar_Syntax_Syntax.Tm_app
          ({
             ...
             FStar_Syntax_Syntax.vars = uu____6061;_},
           (a1, uu____6063)::a2::[])
          ->
      ...
      | FStar_Syntax_Syntax.Tm_app
          ...
          let uu____6305 =
            let uu____6310 =
              ...
              FStar_Util.format1 "DMFF: Ill-applied constant %s" uu____6311 in
           ...
           | (t_head, s_head, u_head) ->
               ...
               let rec flatten1 t =
                 ...
                 | FStar_Syntax_Syntax.Tm_arrow (binders, comp) ->
                     (binders, comp)
                 | FStar_Syntax_Syntax.Tm_ascribed
                     (e1, uu____6521, uu____6522) -> flatten1 e1
                 | uu____6563 ->
                     let uu____6564 =
                       let uu____6569 =
                         let uu____6570 =
                     ...
                     FStar_Errors.raise_err uu____6564 in
                       ...
                       (let uu____6643 =
                          let uu____6648 =
                            ...
                            FStar_Util.format3
                              ...
                              uu____6649 uu____6656 uu____6667 in
                          ...
                          let rec final_type subst1 uu____6716 args1 =
                            ...
                            | (binders2, comp2) ->
                                (match (binders2, args1) with
                                 ...
                                 | ((bv, uu____6915)::binders3,
                                    (arg, uu____6918)::args2) ->
                                     final_type
      ...
      | FStar_Syntax_Syntax.Tm_constant c ->
          let uu____7489 = let uu____7490 = env.tc_const c in N uu____7490 in
          (uu____7489, e, e)
                              ...
                              let uu____8688 =
                                let uu____8689 =
                                  FStar_Syntax_Syntax.new_bv
                                    FStar_Pervasives_Native.None p_type in
                                FStar_All.pipe_left
                                  FStar_Syntax_Syntax.mk_binder uu____8689 in
                              [uu____8688] in
                            let uu____8690 =
                              FStar_Syntax_Syntax.mk_Total
                                FStar_Syntax_Util.ktype0 in
  ...
  env ->
    FStar_Syntax_Syntax.term ->
      (FStar_Syntax_Syntax.typ, FStar_Syntax_Syntax.term,
        FStar_Syntax_Syntax.term) FStar_Pervasives_Native.tuple3)
  =
  fun env -> fun t -> let uu____9801 = n env.env t in check_n env uu____9801
let (trans_F :
  env ->
    FStar_Syntax_Syntax.typ ->
      FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term)
