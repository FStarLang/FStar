...
in {FStar_Syntax_Syntax.n = uu____2007; FStar_Syntax_Syntax.pos = uu___109_2006.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___109_2006.FStar_Syntax_Syntax.vars}))
in (mk_rel1 t2 x y))
end
...
in (([]), (uu____2739)))
in {FStar_Syntax_Syntax.cattributes = uu___110_2709.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___110_2709.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = uu___110_2709.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = uu___110_2709.FStar_Syntax_Syntax.binders; FStar_Syntax_Syntax.signature = uu___110_2709.FStar_Syntax_Syntax.signature; FStar_Syntax_Syntax.ret_wp = uu___110_2709.FStar_Syntax_Syntax.ret_wp; FStar_Syntax_Syntax.bind_wp = uu___110_2709.FStar_Syntax_Syntax.bind_wp; FStar_Syntax_Syntax.if_then_else = uu____2710; FStar_Syntax_Syntax.ite_wp = uu____2714; FStar_Syntax_Syntax.stronger = uu____2718; FStar_Syntax_Syntax.close_wp = uu____2722; FStar_Syntax_Syntax.assert_p = uu____2726; FStar_Syntax_Syntax.assume_p = uu____2730; FStar_Syntax_Syntax.null_wp = uu____2734; FStar_Syntax_Syntax.trivial = uu____2738; FStar_Syntax_Syntax.repr = uu___110_2709.FStar_Syntax_Syntax.repr; FStar_Syntax_Syntax.return_repr = uu___110_2709.FStar_Syntax_Syntax.return_repr; FStar_Syntax_Syntax.bind_repr = uu___110_2709.FStar_Syntax_Syntax.bind_repr; FStar_Syntax_Syntax.actions = uu___110_2709.FStar_Syntax_Syntax.actions})))))))))
...
let uu___111_2756 = dmff_env
in {env = env'; subst = uu___111_2756.subst; tc_const = uu___111_2756.tc_const}))
...
let nm_of_comp : FStar_Syntax_Syntax.comp'  ->  nm = (fun uu___97_2796 -> (match (uu___97_2796) with
| FStar_Syntax_Syntax.Total (t, uu____2798) -> begin
N (t)
end
| FStar_Syntax_Syntax.Comp (c) when (FStar_All.pipe_right c.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___96_2811 -> (match (uu___96_2811) with
...
let string_of_nm : nm  ->  Prims.string = (fun uu___98_2829 -> (match (uu___98_2829) with
| N (t) -> begin
(
...
let uu___112_3046 = bv
in (

let uu____3047 = (star_type' env bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___112_3046.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___112_3046.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3047}))
in ((uu____3045), (aqual)))
end)) binders)
in (match (t1.FStar_Syntax_Syntax.n) with
...
| uu____3283 -> begin
(FStar_All.try_with (fun uu___114_3293 -> (match (()) with
| () -> begin
(
...
end)) (fun uu___113_3360 -> (match (uu___113_3360) with
| Not_found -> begin
false
end)))
end))
...
let uu___115_3531 = env
in (

let uu____3532 = (FStar_TypeChecker_Env.push_binders env.env binders1)
in {env = uu____3532; subst = uu___115_3531.subst; tc_const = uu___115_3531.tc_const}))
in (
...
let uu___116_3552 = x1
in {FStar_Syntax_Syntax.ppname = uu___116_3552.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___116_3552.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})), (t5))))))))))))
end
...
let is_monadic : FStar_Syntax_Syntax.residual_comp FStar_Pervasives_Native.option  ->  Prims.bool = (fun uu___100_3846 -> (match (uu___100_3846) with
| FStar_Pervasives_Native.None -> begin
(failwith "un-annotated lambda?!")
end
| FStar_Pervasives_Native.Some (rc) -> begin
(FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags (FStar_Util.for_some (fun uu___99_3853 -> (match (uu___99_3853) with
| FStar_Syntax_Syntax.CPS -> begin
true
end
| uu____3854 -> begin
...
let is_unknown : FStar_Syntax_Syntax.term'  ->  Prims.bool = (fun uu___101_4095 -> (match (uu___101_4095) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
true
end
| uu____4096 -> begin
...
let strip_m = (fun uu___102_4371 -> (match (uu___102_4371) with
| (M (t), s_e, u_e) -> begin
((t), (s_e), (u_e))
end
| uu____4387 -> begin
...
in {FStar_Syntax_Syntax.residual_effect = uu___117_4843.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____4844; FStar_Syntax_Syntax.residual_flags = uu___117_4843.FStar_Syntax_Syntax.residual_flags}))
...
let uu___118_4860 = env
in (

let uu____4861 = (FStar_TypeChecker_Env.push_binders env.env binders1)
in {env = uu____4861; subst = uu___118_4860.subst; tc_const = uu___118_4860.tc_const}))
in (
...
let uu___119_4894 = bv
in {FStar_Syntax_Syntax.ppname = uu___119_4894.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___119_4894.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})), (qual)))
end)) binders1)
in (
...
in {FStar_Syntax_Syntax.ppname = uu___120_4983.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___120_4983.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4984}))
in (

let env3 = (

let uu___121_4989 = env2
in (
...
in {env = uu___121_4989.env; subst = uu____4990; tc_const = uu___121_4989.tc_const}))
in (
...
let uu___122_5014 = bv
in (

let uu____5015 = (star_type' env2 bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___122_5014.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___122_5014.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____5015}))
in (
...
let uu____5114 = (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags (FStar_Util.for_some (fun uu___103_5118 -> (match (uu___103_5118) with
| FStar_Syntax_Syntax.CPS -> begin
true
end
| uu____5119 -> begin
...
let uu____5120 = (FStar_List.filter (fun uu___104_5124 -> (match (uu___104_5124) with
| FStar_Syntax_Syntax.CPS -> begin
false
end
| uu____5125 -> begin
...
let uu____5134 = (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags (FStar_Util.for_some (fun uu___105_5138 -> (match (uu___105_5138) with
| FStar_Syntax_Syntax.CPS -> begin
true
end
| uu____5139 -> begin
...
let flags = (FStar_List.filter (fun uu___106_5146 -> (match (uu___106_5146) with
| FStar_Syntax_Syntax.CPS -> begin
false
end
| uu____5147 -> begin
...
in {FStar_Syntax_Syntax.residual_effect = uu___123_5157.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____5158; FStar_Syntax_Syntax.residual_flags = uu___123_5157.FStar_Syntax_Syntax.residual_flags}))
...
in {env = uu____6758; subst = uu___124_6757.subst; tc_const = uu___124_6757.tc_const}))
in (
...
let has_m = (FStar_List.existsb (fun uu___107_6942 -> (match (uu___107_6942) with
| M (uu____6943) -> begin
true
end
| uu____6944 -> begin
...
in {FStar_Syntax_Syntax.lbname = uu___125_7844.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___125_7844.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu____7845; FStar_Syntax_Syntax.lbeff = uu___125_7844.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___125_7844.FStar_Syntax_Syntax.lbdef}))
end
| uu____7849 -> begin
binding
end))
...
let uu___126_7851 = env
in (

let uu____7852 = (FStar_TypeChecker_Env.push_bv env.env (

let uu___127_7854 = x
in {FStar_Syntax_Syntax.ppname = uu___127_7854.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___127_7854.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in {env = uu____7852; subst = uu___126_7851.subst; tc_const = uu___126_7851.tc_const}))
in (
...
let uu___128_7872 = binding
in (

let uu____7873 = (star_type' env1 binding.FStar_Syntax_Syntax.lbtyp)
in {FStar_Syntax_Syntax.lbname = uu___128_7872.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___128_7872.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu____7873; FStar_Syntax_Syntax.lbeff = uu___128_7872.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___128_7872.FStar_Syntax_Syntax.lbdef}))
in (
...
let uu___129_7903 = s_binding
in {FStar_Syntax_Syntax.lbname = uu___129_7903.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___129_7903.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___129_7903.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___129_7903.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = s_e1}))::[]))), (uu____7893)))
...
let uu___130_7931 = u_binding
in {FStar_Syntax_Syntax.lbname = uu___130_7931.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___130_7931.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___130_7931.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___130_7931.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = u_e1}))::[]))), (uu____7921)))
...
let uu___131_7940 = binding
in {FStar_Syntax_Syntax.lbname = uu___131_7940.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___131_7940.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = t1; FStar_Syntax_Syntax.lbeff = FStar_Parser_Const.effect_PURE_lid; FStar_Syntax_Syntax.lbdef = uu___131_7940.FStar_Syntax_Syntax.lbdef})
in (

let env1 = (

let uu___132_7942 = env
in (

let uu____7943 = (FStar_TypeChecker_Env.push_bv env.env (

let uu___133_7945 = x
in {FStar_Syntax_Syntax.ppname = uu___133_7945.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___133_7945.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in {env = uu____7943; subst = uu___132_7942.subst; tc_const = uu___132_7942.tc_const}))
in (
...
let uu___134_8090 = u_binding
in {FStar_Syntax_Syntax.lbname = uu___134_8090.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___134_8090.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___134_8090.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___134_8090.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = u_e1}))::[]))), (uu____8080)))
