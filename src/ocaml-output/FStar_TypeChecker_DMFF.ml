                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____2996  in
                          {
                            ...
                            FStar_Syntax_Syntax.pos =
                              (uu___346_2994.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___346_2994.FStar_Syntax_Syntax.vars)
                          }  in
                        mk_rel1 t2 x y
                    ...
                    let uu____4053 =
                         ...
                         in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___347_4054.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___347_4054.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___347_4054.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___347_4054.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___347_4054.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___347_4054.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___347_4054.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___347_4054.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___347_4054.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___347_4054.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___347_4054.FStar_Syntax_Syntax.actions);
                        FStar_Syntax_Syntax.eff_attrs =
                          (uu___347_4054.FStar_Syntax_Syntax.eff_attrs)
                      }  in
...
let (set_env : env -> FStar_TypeChecker_Env.env -> env) =
  fun dmff_env  ->
    fun env'  ->
      let uu___348_4134 = dmff_env  in
      {
        env = env';
        subst = (uu___348_4134.subst);
        tc_const = (uu___348_4134.tc_const)
      }
    ...
    fun t  ->
          ...
          let binders1 =
            FStar_List.map
              (fun uu____4493  ->
                 ...
                 | (bv,aqual) ->
                     let uu____4512 =
                       let uu___349_4513 = bv  in
                       let uu____4514 =
                         star_type' env bv.FStar_Syntax_Syntax.sort  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___349_4513.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___349_4513.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,repr,something) ->
          ...
          (match uu____5146 with
           | (binders1,repr1) ->
               let env1 =
                 let uu___352_5154 = env  in
                 let uu____5155 =
                   FStar_TypeChecker_Env.push_binders env.env binders1  in
                 {
                   env = uu____5155;
                   subst = (uu___352_5154.subst);
                   tc_const = (uu___352_5154.tc_const)
                 }  in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___353_5177 = x1  in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___353_5177.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___353_5177.FStar_Syntax_Syntax.index);
...
let (is_monadic :
  ...
  =
  fun uu___337_5706  ->
    match uu___337_5706 with
    | FStar_Pervasives_Native.None  -> failwith "un-annotated lambda?!"
    | FStar_Pervasives_Native.Some rc ->
        FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
          (FStar_Util.for_some
             (fun uu___336_5713  ->
                match uu___336_5713 with
                | FStar_Syntax_Syntax.CPS  -> true
                | uu____5714 -> false))
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___339_6414 =
            match uu___339_6414 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,rc_opt) ->
                ...
                let uu____6914 =
                    ...
                    FStar_Pervasives_Native.Some uu____6921  in
                  {
                    FStar_Syntax_Syntax.residual_effect =
                      (uu___354_6915.FStar_Syntax_Syntax.residual_effect);
                    FStar_Syntax_Syntax.residual_typ = uu____6916;
                    FStar_Syntax_Syntax.residual_flags =
                      (uu___354_6915.FStar_Syntax_Syntax.residual_flags)
                  }  in
          ...
          let env1 =
            let uu___355_6936 = env  in
            let uu____6937 =
              FStar_TypeChecker_Env.push_binders env.env binders1  in
            {
              env = uu____6937;
              subst = (uu___355_6936.subst);
              tc_const = (uu___355_6936.tc_const)
            }  in
          let s_binders =
            FStar_List.map
              (fun uu____6963  ->
                 ...
                 | (bv,qual) ->
                     let sort = star_type' env1 bv.FStar_Syntax_Syntax.sort
                        in
                     ((let uu___356_6986 = bv  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___356_6986.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___356_6986.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1
             in
          let uu____6987 =
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___357_7087.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___357_7087.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____7088
                           }  in
                         let env3 =
                           let uu___358_7093 = env2  in
                           let uu____7094 =
                             let uu____7097 =
                               let uu____7098 =
                                 let uu____7105 =
                           ...
                           {
                             env = (uu___358_7093.env);
                             subst = uu____7094;
                             tc_const = (uu___358_7093.tc_const)
                           }  in
                         let uu____7110 =
                         ...
                         (let x =
                            let uu___359_7122 = bv  in
                            let uu____7123 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___359_7122.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___359_7122.FStar_Syntax_Syntax.index);
                           ...
                           | FStar_Pervasives_Native.Some rt ->
                               ...
                               then
                                 ...
                                 (let uu____7296 =
                                    ...
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___360_7297.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ =
                                        uu____7298;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___360_7297.FStar_Syntax_Syntax.residual_flags)
                                    }  in
                    ...
                    (fun b  ->
                       ...
                       | (pat,FStar_Pervasives_Native.None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____10200;
                               subst = (uu___361_10199.subst);
                               tc_const = (uu___361_10199.tc_const)
                             }  in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____11596 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____11618  in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___362_11614.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___362_11614.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____11615;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___362_11614.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___362_11614.FStar_Syntax_Syntax.lbdef);
                           FStar_Syntax_Syntax.lbattrs =
                             (uu___362_11614.FStar_Syntax_Syntax.lbattrs);
                           FStar_Syntax_Syntax.lbpos =
                             (uu___362_11614.FStar_Syntax_Syntax.lbpos)
                         }
                       else binding  in
                     let env1 =
                       let uu___363_11621 = env  in
                       let uu____11622 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___364_11624 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___364_11624.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___364_11624.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         env = uu____11622;
                         subst = (uu___363_11621.subst);
                         tc_const = (uu___363_11621.tc_const)
                       }  in
                     let uu____11625 = proceed env1 e21  in
                     (match uu____11625 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___365_11642 = binding  in
                            let uu____11643 =
                              star_type' env1
                            ...
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___365_11642.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___365_11642.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____11643;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___365_11642.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___365_11642.FStar_Syntax_Syntax.lbdef);
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___365_11642.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___365_11642.FStar_Syntax_Syntax.lbpos)
                            }  in
                          let uu____11646 =
                            let uu____11647 =
                              let uu____11648 =
                                let uu____11661 =
                                  FStar_Syntax_Subst.close x_binders1 s_e2
                                   in
                                ((false,
                                   [(let uu___366_11675 = s_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___366_11675.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___366_11675.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___366_11675.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___366_11675.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = s_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___366_11675.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___366_11675.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11661)
                                 in
                              ...
                              let uu____11678 =
                                let uu____11691 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___367_11705 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___367_11705.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___367_11705.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___367_11705.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___367_11705.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___367_11705.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___367_11705.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11691)
                                 in
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___368_11710 = binding  in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___368_11710.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___368_11710.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Parser_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___368_11710.FStar_Syntax_Syntax.lbdef);
                         FStar_Syntax_Syntax.lbattrs =
                           (uu___368_11710.FStar_Syntax_Syntax.lbattrs);
                         FStar_Syntax_Syntax.lbpos =
                           (uu___368_11710.FStar_Syntax_Syntax.lbpos)
                       }  in
                     let env1 =
                       let uu___369_11712 = env  in
                       let uu____11713 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___370_11715 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___370_11715.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___370_11715.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         env = uu____11713;
                         subst = (uu___369_11712.subst);
                         tc_const = (uu___369_11712.tc_const)
                       }  in
                              ...
                              let uu____11917 =
                                let uu____11930 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___371_11944 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___371_11944.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___371_11944.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___371_11944.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___371_11944.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___371_11944.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___371_11944.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11930)
                                 in
