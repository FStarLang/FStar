            ...
            let a1 =
                 ...
                 in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___363_123.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___363_123.FStar_Syntax_Syntax.index);
                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____2988  in
                          {
                            ...
                            FStar_Syntax_Syntax.pos =
                              (uu___364_2986.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___364_2986.FStar_Syntax_Syntax.vars)
                          }  in
                        mk_rel1 t2 x y
                    ...
                    let uu____4041 =
                         ...
                         in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___365_4042.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___365_4042.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___365_4042.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___365_4042.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___365_4042.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___365_4042.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___365_4042.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___365_4042.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___365_4042.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___365_4042.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___365_4042.FStar_Syntax_Syntax.actions);
                        FStar_Syntax_Syntax.eff_attrs =
                          (uu___365_4042.FStar_Syntax_Syntax.eff_attrs)
                      }  in
...
let (set_env : env -> FStar_TypeChecker_Env.env -> env) =
  fun dmff_env  ->
    fun env'  ->
      let uu___366_4122 = dmff_env  in
      {
        tcenv = env';
        subst = (uu___366_4122.subst);
        tc_const = (uu___366_4122.tc_const)
      }
    ...
    fun t  ->
          ...
          let binders1 =
            FStar_List.map
              (fun uu____4478  ->
                 ...
                 | (bv,aqual) ->
                     let uu____4497 =
                       let uu___367_4498 = bv  in
                       let uu____4499 =
                         star_type' env bv.FStar_Syntax_Syntax.sort  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___367_4498.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___367_4498.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,repr,something) ->
          ...
          (match uu____5131 with
           | (binders1,repr1) ->
               let env1 =
                 let uu___370_5139 = env  in
                 let uu____5140 =
                   FStar_TypeChecker_Env.push_binders env.tcenv binders1  in
                 {
                   tcenv = uu____5140;
                   subst = (uu___370_5139.subst);
                   tc_const = (uu___370_5139.tc_const)
                 }  in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___371_5162 = x1  in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___371_5162.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___371_5162.FStar_Syntax_Syntax.index);
...
let (is_monadic :
  ...
  =
  fun uu___355_5691  ->
    match uu___355_5691 with
    | FStar_Pervasives_Native.None  -> failwith "un-annotated lambda?!"
    | FStar_Pervasives_Native.Some rc ->
        FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
          (FStar_Util.for_some
             (fun uu___354_5698  ->
                match uu___354_5698 with
                | FStar_Syntax_Syntax.CPS  -> true
                | uu____5699 -> false))
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___357_6399 =
            match uu___357_6399 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,rc_opt) ->
                ...
                let uu____6899 =
                    ...
                    FStar_Pervasives_Native.Some uu____6906  in
                  {
                    FStar_Syntax_Syntax.residual_effect =
                      (uu___372_6900.FStar_Syntax_Syntax.residual_effect);
                    FStar_Syntax_Syntax.residual_typ = uu____6901;
                    FStar_Syntax_Syntax.residual_flags =
                      (uu___372_6900.FStar_Syntax_Syntax.residual_flags)
                  }  in
          ...
          let env1 =
            let uu___373_6921 = env  in
            let uu____6922 =
              FStar_TypeChecker_Env.push_binders env.tcenv binders1  in
            {
              tcenv = uu____6922;
              subst = (uu___373_6921.subst);
              tc_const = (uu___373_6921.tc_const)
            }  in
          let s_binders =
            FStar_List.map
              (fun uu____6948  ->
                 ...
                 | (bv,qual) ->
                     let sort = star_type' env1 bv.FStar_Syntax_Syntax.sort
                        in
                     ((let uu___374_6971 = bv  in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___374_6971.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___374_6971.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1
             in
          let uu____6972 =
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___375_7072.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___375_7072.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____7073
                           }  in
                         let env3 =
                           let uu___376_7078 = env2  in
                           let uu____7079 =
                             let uu____7082 =
                               let uu____7083 =
                                 let uu____7090 =
                           ...
                           {
                             tcenv = (uu___376_7078.tcenv);
                             subst = uu____7079;
                             tc_const = (uu___376_7078.tc_const)
                           }  in
                         let uu____7095 =
                         ...
                         (let x =
                            let uu___377_7107 = bv  in
                            let uu____7108 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___377_7107.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___377_7107.FStar_Syntax_Syntax.index);
                           ...
                           | FStar_Pervasives_Native.Some rt ->
                               ...
                               then
                                 ...
                                 (let uu____7281 =
                                    ...
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___378_7282.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ =
                                        uu____7283;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___378_7282.FStar_Syntax_Syntax.residual_flags)
                                    }  in
                    ...
                    (fun b  ->
                       ...
                       | (pat,FStar_Pervasives_Native.None ,body) ->
                           let env1 =
                             ...
                             {
                               tcenv = uu____10184;
                               subst = (uu___379_10183.subst);
                               tc_const = (uu___379_10183.tc_const)
                             }  in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____11580 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____11602  in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___380_11598.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___380_11598.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____11599;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___380_11598.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___380_11598.FStar_Syntax_Syntax.lbdef);
                           FStar_Syntax_Syntax.lbattrs =
                             (uu___380_11598.FStar_Syntax_Syntax.lbattrs);
                           FStar_Syntax_Syntax.lbpos =
                             (uu___380_11598.FStar_Syntax_Syntax.lbpos)
                         }
                       else binding  in
                     let env1 =
                       let uu___381_11605 = env  in
                       let uu____11606 =
                         FStar_TypeChecker_Env.push_bv env.tcenv
                           (let uu___382_11608 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___382_11608.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___382_11608.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         tcenv = uu____11606;
                         subst = (uu___381_11605.subst);
                         tc_const = (uu___381_11605.tc_const)
                       }  in
                     let uu____11609 = proceed env1 e21  in
                     (match uu____11609 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___383_11626 = binding  in
                            let uu____11627 =
                              star_type' env1
                            ...
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___383_11626.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___383_11626.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____11627;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___383_11626.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___383_11626.FStar_Syntax_Syntax.lbdef);
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___383_11626.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___383_11626.FStar_Syntax_Syntax.lbpos)
                            }  in
                          let uu____11630 =
                            let uu____11631 =
                              let uu____11632 =
                                let uu____11645 =
                                  FStar_Syntax_Subst.close x_binders1 s_e2
                                   in
                                ((false,
                                   [(let uu___384_11659 = s_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___384_11659.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___384_11659.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___384_11659.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___384_11659.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = s_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___384_11659.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___384_11659.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11645)
                                 in
                              ...
                              let uu____11662 =
                                let uu____11675 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___385_11689 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___385_11689.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___385_11689.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___385_11689.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___385_11689.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___385_11689.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___385_11689.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11675)
                                 in
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___386_11694 = binding  in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___386_11694.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___386_11694.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Parser_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___386_11694.FStar_Syntax_Syntax.lbdef);
                         FStar_Syntax_Syntax.lbattrs =
                           (uu___386_11694.FStar_Syntax_Syntax.lbattrs);
                         FStar_Syntax_Syntax.lbpos =
                           (uu___386_11694.FStar_Syntax_Syntax.lbpos)
                       }  in
                     let env1 =
                       let uu___387_11696 = env  in
                       let uu____11697 =
                         FStar_TypeChecker_Env.push_bv env.tcenv
                           (let uu___388_11699 = x  in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___388_11699.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___388_11699.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            })
                          in
                       {
                         tcenv = uu____11697;
                         subst = (uu___387_11696.subst);
                         tc_const = (uu___387_11696.tc_const)
                       }  in
                              ...
                              let uu____11901 =
                                let uu____11914 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2
                                   in
                                ((false,
                                   [(let uu___389_11928 = u_binding  in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___389_11928.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___389_11928.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___389_11928.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___389_11928.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1;
                                       FStar_Syntax_Syntax.lbattrs =
                                         (uu___389_11928.FStar_Syntax_Syntax.lbattrs);
                                       FStar_Syntax_Syntax.lbpos =
                                         (uu___389_11928.FStar_Syntax_Syntax.lbpos)
                                     })]), uu____11914)
                                 in
