  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs uu____3479 ->
          let uu____3489 = FStar_Syntax_Util.abs_formals e in
          (match uu____3489 with
           | (binders,body,rc_opt) ->
               let env1 =
                 let uu___111_3503 = env in
                 let uu____3504 =
                   FStar_TypeChecker_Env.push_binders env.env binders in
                 {
                   env = uu____3504;
                   subst = (uu___111_3503.subst);
                   tc_const = (uu___111_3503.tc_const)
                 } in
               let s_binders =
                 FStar_List.map
                   (fun uu____3513  ->
                      ...
                      | (bv,qual) ->
                          ...
                          ((let uu___112_3521 = bv in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___112_3521.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___112_3521.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = sort
                            }), qual)) binders in
               let uu____3522 =
                 FStar_List.fold_left
                   (fun uu____3531  ->
                      fun uu____3532  ->
                        ...
                        | ((env2,acc),(bv,qual)) ->
                            ...
                            let uu____3560 = is_C c in
                            if uu____3560
                            then
                              let xw =
                                let uu____3565 = star_type' env2 c in
                                FStar_Syntax_Syntax.gen_bv
                                  (Prims.strcat
                                     (bv.FStar_Syntax_Syntax.ppname).FStar_Ident.idText
                                     "__w") None uu____3565 in
                              let x =
                                let uu___113_3567 = bv in
                                let uu____3568 =
                                  let uu____3571 =
                                    FStar_Syntax_Syntax.bv_to_name xw in
                                  trans_F_ env2 c uu____3571 in
                                {
                                  FStar_Syntax_Syntax.ppname =
                                    (uu___113_3567.FStar_Syntax_Syntax.ppname);
                                  FStar_Syntax_Syntax.index =
                                    (uu___113_3567.FStar_Syntax_Syntax.index);
                                  FStar_Syntax_Syntax.sort = uu____3568
                                } in
                              let env3 =
                                let uu___114_3573 = env2 in
                                let uu____3574 =
                                  let uu____3576 =
                                    let uu____3577 =
                                      let uu____3582 =
                                        FStar_Syntax_Syntax.bv_to_name xw in
                                      (bv, uu____3582) in
                                    FStar_Syntax_Syntax.NT uu____3577 in
                                  uu____3576 :: (env2.subst) in
                                {
                                  env = (uu___114_3573.env);
                                  subst = uu____3574;
                                  tc_const = (uu___114_3573.tc_const)
                                } in
                              let uu____3583 =
                                let uu____3585 =
                                  FStar_Syntax_Syntax.mk_binder x in
                              ...
                              (let x =
                                 let uu___115_3592 = bv in
                                 let uu____3593 =
                                   star_type' env2
                                     bv.FStar_Syntax_Syntax.sort in
                                 {
                                   FStar_Syntax_Syntax.ppname =
                                     (uu___115_3592.FStar_Syntax_Syntax.ppname);
                                   FStar_Syntax_Syntax.index =
                                     (uu___115_3592.FStar_Syntax_Syntax.index);
                                   FStar_Syntax_Syntax.sort = uu____3593
                                 } in
                               let uu____3596 =
                                 let uu____3598 =
                                   FStar_Syntax_Syntax.mk_binder x in
                                 uu____3598 :: acc in
                               (env2, uu____3596))) (env1, []) binders in
               (match uu____3522 with
                | (env2,u_binders) ->
                    let u_binders1 = FStar_List.rev u_binders in
                    let uu____3610 =
                      let check_what =
                        let uu____3622 = is_monadic rc_opt in
                        if uu____3622 then check_m else check_n in
                      let uu____3631 = check_what env2 body in
                      match uu____3631 with
                      | (t,s_body,u_body) ->
                          let uu____3641 =
                            let uu____3642 =
                              let uu____3643 = is_monadic rc_opt in
                              if uu____3643 then M t else N t in
                            comp_of_nm uu____3642 in
                          (uu____3641, s_body, u_body) in
                    (match uu____3610 with
                     | (comp,s_body,u_body) ->
                         ...
                         let s_rc_opt =
                           ...
                           | None  -> None
                           | Some rc ->
                               (match rc.FStar_Syntax_Syntax.residual_typ
                                with
                                | None  ->
                                    let rc1 =
                                      let uu____3662 =
                                ...
                                | Some rt ->
                                    ...
                                    then
                                      ...
                                      let uu____3687 =
                                        let uu____3688 =
                                          let uu____3692 = double_star rt in
                                          Some uu____3692 in
                                        FStar_Syntax_Util.mk_residual_comp
                                          FStar_Syntax_Const.effect_Tot_lid
                                          uu____3688 flags in
                                      ...
                                      (let uu____3694 =
                                         let uu___116_3695 = rc in
                                         let uu____3696 =
                                           let uu____3700 =
                                             star_type' env2 rt in
                                           Some uu____3700 in
                                         {
                                           FStar_Syntax_Syntax.residual_effect
                                             =
                                             (uu___116_3695.FStar_Syntax_Syntax.residual_effect);
                                           FStar_Syntax_Syntax.residual_typ =
                                             uu____3696;
                                           FStar_Syntax_Syntax.residual_flags
                                             =
                                             (uu___116_3695.FStar_Syntax_Syntax.residual_flags)
                                         } in
                                       Some uu____3694)) in
                         let uu____3701 =
                           let comp1 =
                             let uu____3708 = is_monadic rc_opt in
                             let uu____3709 =
                         ...
                         (match uu____3701 with
                          | (u_body1,u_rc_opt) ->
                              let s_term =
                                FStar_Syntax_Util.abs s_binders s_body
                                  s_rc_opt in
                              let u_term =
                                FStar_Syntax_Util.abs u_binders1 u_body1
                                  u_rc_opt in
                              ((N t), s_term, u_term)))))
      | FStar_Syntax_Syntax.Tm_fvar
          {
            FStar_Syntax_Syntax.fv_name =
              { FStar_Syntax_Syntax.v = lid;
                FStar_Syntax_Syntax.ty = uu____3741;
                FStar_Syntax_Syntax.p = uu____3742;_};
            FStar_Syntax_Syntax.fv_delta = uu____3743;
            FStar_Syntax_Syntax.fv_qual = uu____3744;_}
          ->
          let uu____3750 =
            let uu____3753 = FStar_TypeChecker_Env.lookup_lid env.env lid in
            FStar_All.pipe_left FStar_Pervasives.fst uu____3753 in
          (match uu____3750 with
           | (uu____3769,t) ->
               let uu____3771 = let uu____3772 = normalize1 t in N uu____3772 in
               (uu____3771, e, e))
      | FStar_Syntax_Syntax.Tm_app (head1,args) ->
          let uu____3789 = check_n env head1 in
          (match uu____3789 with
           | (t_head,s_head,u_head) ->
               let is_arrow t =
                 let uu____3803 =
                   let uu____3804 = FStar_Syntax_Subst.compress t in
                   uu____3804.FStar_Syntax_Syntax.n in
                 match uu____3803 with
                 | FStar_Syntax_Syntax.Tm_arrow uu____3807 -> true
                 | uu____3815 -> false in
               let rec flatten1 t =
                 let uu____3827 =
                   let uu____3828 = FStar_Syntax_Subst.compress t in
                   uu____3828.FStar_Syntax_Syntax.n in
                 match uu____3827 with
                 | FStar_Syntax_Syntax.Tm_arrow
                     (binders,{
                                FStar_Syntax_Syntax.n =
                                  FStar_Syntax_Syntax.Total (t1,uu____3840);
                                FStar_Syntax_Syntax.tk = uu____3841;
                                FStar_Syntax_Syntax.pos = uu____3842;
                                FStar_Syntax_Syntax.vars = uu____3843;_})
                     when is_arrow t1 ->
                     let uu____3860 = flatten1 t1 in
                     (match uu____3860 with
                      | (binders',comp) ->
                          ((FStar_List.append binders binders'), comp))
                 | FStar_Syntax_Syntax.Tm_arrow (binders,comp) ->
                     (binders, comp)
                 | FStar_Syntax_Syntax.Tm_ascribed (e1,uu____3912,uu____3913)
                     -> flatten1 e1
                 | uu____3942 ->
                     let uu____3943 =
                       let uu____3944 =
                         ...
                         FStar_Util.format1 "%s: not a function type"
                           uu____3945 in
                       FStar_Errors.Err uu____3944 in
                     raise uu____3943 in
               let uu____3953 = flatten1 t_head in
                ...
                | (binders,comp) ->
                    ...
                    (if
                     ...
                     then
                       (let uu____4005 =
                          let uu____4006 =
                            let uu____4007 = FStar_Util.string_of_int n1 in
                            let uu____4014 =
                              FStar_Util.string_of_int (n' - n1) in
                            let uu____4025 = FStar_Util.string_of_int n1 in
                            FStar_Util.format3
                              "The head of this application, after being applied to %s arguments, is an effectful computation (leaving %s arguments to be applied). Please let-bind the head applied to the %s first arguments."
                              uu____4007 uu____4014 uu____4025 in
                          FStar_Errors.Err uu____4006 in
                        raise uu____4005)
                     else ();
                     (let uu____4033 =
                      ...
                      | (binders1,comp1) ->
                          let rec final_type subst1 uu____4060 args1 =
                                              ...
                                              let uu____4146 =
                                                let uu____4154 =
                                                  FStar_Syntax_Subst.close_comp
                                                    binders4 comp3 in
                                                (binders4, uu____4154) in
                                              FStar_Syntax_Syntax.Tm_arrow
                                                uu____4146 in
                                            mk1 uu____4145 in
                                          N uu____4144
                                      | uu____4158 -> failwith "wat?")
                                 | ([],uu____4159::uu____4160) ->
                                     failwith "just checked that?!"
                                 | ((bv,uu____4185)::binders3,(arg,uu____4188)::args2)
                                     ->
                                     final_type
                          ...
                          let uu____4222 = FStar_List.splitAt n' binders1 in
                               ...
                               let uu____4254 =
                                 let uu____4264 =
                                   FStar_List.map2
                                     (fun uu____4284  ->
                                        fun uu____4285  ->
                                          match (uu____4284, uu____4285) with
                                          | ((bv,uu____4302),(arg,q)) ->
                                              let uu____4309 =
                                                let uu____4310 =
                                                  FStar_Syntax_Subst.compress
                                                   ...
                                                   (match uu____4334 with
                                                    | (uu____4345,s_arg,u_arg)
                                                        ...
                                                        ((s_arg, q),
                                                          uu____4348))))
                                     binders2 args in
                                 FStar_List.split uu____4264 in
                                ...
                                | (s_args,u_args) ->
                                    ...
                                    let uu____4412 =
                                      mk1
                                        (FStar_Syntax_Syntax.Tm_app
                                           (u_head, u_args1)) in
                                    (final_type1, uu____4406, uu____4412)))))))
      | FStar_Syntax_Syntax.Tm_let ((false ,binding::[]),e2) ->
          mk_let env binding e2 infer check_m
      | FStar_Syntax_Syntax.Tm_match (e0,branches) ->
          mk_match env e0 branches infer
      | FStar_Syntax_Syntax.Tm_uinst (e1,uu____4461) -> infer env e1
      | FStar_Syntax_Syntax.Tm_meta (e1,uu____4467) -> infer env e1
      | FStar_Syntax_Syntax.Tm_ascribed (e1,uu____4473,uu____4474) ->
          infer env e1
      | FStar_Syntax_Syntax.Tm_constant c ->
          let uu____4504 = let uu____4505 = env.tc_const c in N uu____4505 in
          (uu____4504, e, e)
      | FStar_Syntax_Syntax.Tm_let uu____4506 ->
          let uu____4514 =
            let uu____4515 = FStar_Syntax_Print.term_to_string e in
            FStar_Util.format1 "[infer]: Tm_let %s" uu____4515 in
          failwith uu____4514
      | FStar_Syntax_Syntax.Tm_type uu____4519 ->
          failwith "impossible (DM stratification)"
      | FStar_Syntax_Syntax.Tm_arrow uu____4523 ->
          failwith "impossible (DM stratification)"
      | FStar_Syntax_Syntax.Tm_refine uu____4534 ->
          let uu____4539 =
            let uu____4540 = FStar_Syntax_Print.term_to_string e in
            FStar_Util.format1 "[infer]: Tm_refine %s" uu____4540 in
          failwith uu____4539
      | FStar_Syntax_Syntax.Tm_uvar uu____4544 ->
          let uu____4553 =
            let uu____4554 = FStar_Syntax_Print.term_to_string e in
            FStar_Util.format1 "[infer]: Tm_uvar %s" uu____4554 in
          failwith uu____4553
      | FStar_Syntax_Syntax.Tm_delayed uu____4558 ->
          failwith "impossible (compressed)"
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____4576 =
            let uu____4577 = FStar_Syntax_Print.term_to_string e in
            FStar_Util.format1 "[infer]: Tm_unknown %s" uu____4577 in
          failwith uu____4576
and mk_match:
  env ->
    (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
    ...
    fun e0  ->
      fun branches  ->
        fun f  ->
          ...
          let uu____4615 = check_n env e0 in
          match uu____4615 with
          | (uu____4622,s_e0,u_e0) ->
              let uu____4625 =
                let uu____4643 =
                  FStar_List.map
                    (fun b  ->
                       let uu____4676 = FStar_Syntax_Subst.open_branch b in
                       match uu____4676 with
                       | (pat,None ,body) ->
                           let env1 =
                             let uu___117_4708 = env in
                             let uu____4709 =
                               let uu____4710 =
                             ...
                             {
                               env = uu____4709;
                               subst = (uu___117_4708.subst);
                               tc_const = (uu___117_4708.tc_const)
                             } in
                           let uu____4712 = f env1 body in
                    ...
                    branches in
                FStar_List.split uu____4643 in
              (match uu____4625 with
               | (nms,branches1) ->
                   let t1 =
                     let uu____4826 = FStar_List.hd nms in
                     match uu____4826 with | M t1 -> t1 | N t1 -> t1 in
                   let has_m =
                     FStar_List.existsb
                       (fun uu___101_4830  ->
                          match uu___101_4830 with
                          | M uu____4831 -> true
                          | uu____4832 -> false) nms in
                   let uu____4833 =
                     let uu____4856 =
                       FStar_List.map2
                         (fun nm  ->
                                  ...
                                  (match (nm, has_m) with
                                   ...
                                   | (N t2,true ) ->
                                       ...
                                       (match uu____5031 with
                                        | (uu____5054,s_body1,u_body1) ->
                                            ((M t2), (pat, guard, s_body1),
                                              (pat, guard, u_body1)))
                                   | (M uu____5083,false ) ->
                                       failwith "impossible")) nms branches1 in
                     FStar_List.unzip3 uu____4856 in
                            ...
                            let uu____5286 =
                              mk1
                                (FStar_Syntax_Syntax.Tm_match
                                   (s_e0, s_branches2)) in
                            FStar_Syntax_Util.abs uu____5284 uu____5286
                              (Some
                          ...
                          let t1_star =
                            let uu____5291 =
                              let uu____5295 =
                                ...
                                FStar_All.pipe_left
                                  FStar_Syntax_Syntax.mk_binder uu____5296 in
                              [uu____5295] in
                            let uu____5297 =
                              FStar_Syntax_Syntax.mk_Total
                                FStar_Syntax_Util.ktype0 in
                            FStar_Syntax_Util.arrow uu____5291 uu____5297 in
                          let uu____5300 =
                            mk1
                              (FStar_Syntax_Syntax.Tm_ascribed
                          ...
                          (let s_branches1 =
                           ...
                           let uu____5344 =
                             let uu____5347 =
                               ...
                               FStar_Syntax_Syntax.Tm_ascribed uu____5348 in
                             mk1 uu____5347 in
                           let uu____5393 =
                             mk1
                               (FStar_Syntax_Syntax.Tm_match
                                  (u_e0, u_branches1)) in
                           ((N t1), uu____5344, uu____5393))))
and mk_let:
  env_ ->
      ...
      fun e2  ->
        fun proceed  ->
          fun ensure_m  ->
            ...
            let x_binders =
              let uu____5436 = FStar_Syntax_Syntax.mk_binder x in
              [uu____5436] in
            let uu____5437 = FStar_Syntax_Subst.open_term x_binders e2 in
            match uu____5437 with
            | (x_binders1,e21) ->
                let uu____5445 = infer env e1 in
                (match uu____5445 with
                 | (N t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu____5456 = is_C t1 in
                       if uu____5456
                       then
                         let uu___118_5457 = binding in
                         let uu____5458 =
                           let uu____5461 =
                             FStar_Syntax_Subst.subst env.subst s_e1 in
                           trans_F_ env t1 uu____5461 in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___118_5457.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___118_5457.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____5458;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___118_5457.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___118_5457.FStar_Syntax_Syntax.lbdef)
                         }
                       else binding in
                     let env1 =
                       let uu___119_5464 = env in
                       let uu____5465 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___120_5466 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___120_5466.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___120_5466.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____5465;
                         subst = (uu___119_5464.subst);
                         tc_const = (uu___119_5464.tc_const)
                       } in
                     let uu____5467 = proceed env1 e21 in
                     (match uu____5467 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___121_5478 = binding in
                            let uu____5479 =
                              star_type' env1
                                binding.FStar_Syntax_Syntax.lbtyp in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___121_5478.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___121_5478.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____5479;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___121_5478.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___121_5478.FStar_Syntax_Syntax.lbdef)
                            } in
                          let uu____5482 =
                            let uu____5485 =
                              let uu____5486 =
                                ...
                                ((false,
                                   [(let uu___122_5499 = s_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___122_5499.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___122_5499.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___122_5499.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___122_5499.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = s_e1
                                     })]), uu____5494) in
                              FStar_Syntax_Syntax.Tm_let uu____5486 in
                            mk1 uu____5485 in
                          let uu____5500 =
                            let uu____5503 =
                              let uu____5504 =
                                ...
                                ((false,
                                   [(let uu___123_5517 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___123_5517.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___123_5517.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___123_5517.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___123_5517.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1
                                     })]), uu____5512) in
                              FStar_Syntax_Syntax.Tm_let uu____5504 in
                            mk1 uu____5503 in
                          (nm_rec, uu____5482, uu____5500))
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___124_5526 = binding in
                       {
                         FStar_Syntax_Syntax.lbname =
                         ...
                         FStar_Syntax_Syntax.lbdef =
                           (uu___124_5526.FStar_Syntax_Syntax.lbdef)
                       } in
                     let env1 =
                       let uu___125_5528 = env in
                       let uu____5529 =
                         FStar_TypeChecker_Env.push_bv env.env
                       ...
                       {
                         env = uu____5529;
                         subst = (uu___125_5528.subst);
                         tc_const = (uu___125_5528.tc_const)
                       } in
                     let uu____5531 = ensure_m env1 e21 in
                          ...
                          let uu____5605 =
                            let uu____5606 =
                              let uu____5607 =
                                FStar_Syntax_Syntax.mk_binder p in
                              [uu____5607] in
                            FStar_Syntax_Util.abs uu____5606 body
                              (Some
                                 (FStar_Syntax_Util.residual_tot
                                    FStar_Syntax_Util.ktype0)) in
                          let uu____5608 =
                            let uu____5611 =
                              let uu____5612 =
                                let uu____5620 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2 in
                                ((false,
                                   [(let uu___127_5625 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___127_5625.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___127_5625.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___127_5625.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___127_5625.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1
                                     })]), uu____5620) in
                              FStar_Syntax_Syntax.Tm_let uu____5612 in
                            mk1 uu____5611 in
                          ((M t2), uu____5605, uu____5608)))
and check_n:
  env_ ->
    FStar_Syntax_Syntax.term ->
  ...
  fun env  ->
    fun e  ->
      let mn =
        ...
        N uu____5634 in
      let uu____5639 = check env e mn in
      match uu____5639 with
      | (N t,s_e,u_e) -> (t, s_e, u_e)
      | uu____5649 -> failwith "[check_n]: impossible"
and check_m:
  env_ ->
    FStar_Syntax_Syntax.term ->
      (FStar_Syntax_Syntax.typ* FStar_Syntax_Syntax.term*
      ...
      let mn =
        let uu____5662 =
          FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown None
            e.FStar_Syntax_Syntax.pos in
        M uu____5662 in
      let uu____5667 = check env e mn in
      match uu____5667 with
      | (M t,s_e,u_e) -> (t, s_e, u_e)
      | uu____5677 -> failwith "[check_m]: impossible"
...
and trans_F_:
  ...
  fun env  ->
    fun c  ->
      fun wp  ->
        (let uu____5699 =
           let uu____5700 = is_C c in Prims.op_Negation uu____5700 in
         if uu____5699 then failwith "not a C" else ());
        (let mk1 x = FStar_Syntax_Syntax.mk x None c.FStar_Syntax_Syntax.pos in
         let uu____5712 =
           let uu____5713 = FStar_Syntax_Subst.compress c in
           uu____5713.FStar_Syntax_Syntax.n in
         match uu____5712 with
         | FStar_Syntax_Syntax.Tm_app (head1,args) ->
             let uu____5732 = FStar_Syntax_Util.head_and_args wp in
             (match uu____5732 with
              | (wp_head,wp_args) ->
                  ((let uu____5759 =
                    ...
                    if uu____5759 then failwith "mismatch" else ());
                   (let uu____5789 =
                      let uu____5790 =
                        let uu____5800 =
                          FStar_List.map2
                            (fun uu____5810  ->
                               fun uu____5811  ->
                                 ...
                                 | ((arg,q),(wp_arg,q')) ->
                                     ...
                                     (if q <> q'
                                      then
                                        (let uu____5837 = print_implicit q in
                                         let uu____5838 = print_implicit q' in
                                         FStar_Util.print2_warning
                                           "Incoherent implicit qualifiers %b %b"
                                           uu____5837 uu____5838)
                                      else ();
                                      (let uu____5840 =
                                         trans_F_ env arg wp_arg in
                                       (uu____5840, q)))) args wp_args in
                        (head1, uu____5800) in
                      FStar_Syntax_Syntax.Tm_app uu____5790 in
                    mk1 uu____5789)))
         | FStar_Syntax_Syntax.Tm_arrow (binders,comp) ->
             let binders1 = FStar_Syntax_Util.name_binders binders in
             let uu____5862 = FStar_Syntax_Subst.open_comp binders1 comp in
                      ...
                      FStar_List.map
                        (fun uu____5889  ->
                           ...
                           | (bv,q) ->
                               ...
                               let uu____5902 = is_C h in
                               if uu____5902
                               then
                                 let w' =
                                   let uu____5909 = star_type' env h in
                                   FStar_Syntax_Syntax.gen_bv
                                     (Prims.strcat
                                        (bv.FStar_Syntax_Syntax.ppname).FStar_Ident.idText
                                        "__w'") None uu____5909 in
                                 let uu____5910 =
                                   let uu____5914 =
                                     let uu____5918 =
                                       let uu____5921 =
                                 ...
                                 (let x =
                                    let uu____5935 = star_type' env h in
                                    FStar_Syntax_Syntax.gen_bv
                                      (Prims.strcat
                                         (bv.FStar_Syntax_Syntax.ppname).FStar_Ident.idText
                                         "__x") None uu____5935 in
                                  (x, [(x, q)]))) binders_orig in
                    FStar_List.split uu____5875 in
                       ...
                       let comp2 =
                         let uu____5965 =
                           ...
                           FStar_Syntax_Util.rename_binders binders_orig
                             uu____5967 in
                         FStar_Syntax_Subst.subst_comp uu____5965 comp1 in
                       let app =
                         let uu____5971 =
                           let uu____5972 =
                             let uu____5982 =
                               FStar_List.map
                                 (fun bv  ->
                                    ...
                                    let uu____5990 =
                                      FStar_Syntax_Syntax.as_implicit false in
                                    (uu____5989, uu____5990)) bvs in
                             (wp, uu____5982) in
                           FStar_Syntax_Syntax.Tm_app uu____5972 in
                         mk1 uu____5971 in
                       let comp3 =
                         let uu____5995 = type_of_comp comp2 in
                         let uu____5996 = is_monadic_comp comp2 in
                         trans_G env uu____5995 uu____5996 app in
                       FStar_Syntax_Util.arrow binders3 comp3))
         | FStar_Syntax_Syntax.Tm_ascribed (e,uu____5998,uu____5999) ->
             trans_F_ env e wp
         | uu____6028 -> failwith "impossible trans_F_")
and trans_G:
  env_ ->
    FStar_Syntax_Syntax.typ ->
    ...
    fun h  ->
      fun is_monadic1  ->
        fun wp  ->
          ...
          then
            let uu____6033 =
              let uu____6034 = star_type' env h in
              let uu____6037 =
                let uu____6043 =
                  let uu____6046 = FStar_Syntax_Syntax.as_implicit false in
                  (wp, uu____6046) in
                [uu____6043] in
              {
                ...
                FStar_Syntax_Syntax.effect_name =
                  FStar_Syntax_Const.effect_PURE_lid;
                FStar_Syntax_Syntax.result_typ = uu____6034;
                FStar_Syntax_Syntax.effect_args = uu____6037;
                FStar_Syntax_Syntax.flags = []
              } in
            FStar_Syntax_Syntax.mk_Comp uu____6033
          else
            (let uu____6052 = trans_F_ env h wp in
             FStar_Syntax_Syntax.mk_Total uu____6052)
let n:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
  =
...
let star_type: env -> FStar_Syntax_Syntax.typ -> FStar_Syntax_Syntax.term =
  fun env  ->
    fun t  -> let uu____6067 = n env.env t in star_type' env uu____6067
let star_expr:
  env ->
    FStar_Syntax_Syntax.term ->
      (FStar_Syntax_Syntax.typ* FStar_Syntax_Syntax.term*
  ...
  =
  fun env  ->
    fun t  -> let uu____6081 = n env.env t in check_n env uu____6081
let trans_F:
  env_ ->
    FStar_Syntax_Syntax.typ ->
      FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
  ...
  fun env  ->
    fun c  ->
      fun wp  ->
        let uu____6094 = n env.env c in
        let uu____6095 = n env.env wp in trans_F_ env uu____6094 uu____6095