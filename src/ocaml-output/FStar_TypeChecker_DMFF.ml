                        ...
                        let t2 =
                            ...
                            FStar_Syntax_Syntax.Tm_arrow uu____2072 in
                          {
                            ...
                            FStar_Syntax_Syntax.pos =
                              (uu___109_2070.FStar_Syntax_Syntax.pos);
                            FStar_Syntax_Syntax.vars =
                              (uu___109_2070.FStar_Syntax_Syntax.vars)
                          } in
                        mk_rel1 t2 x y
                    ...
                    let uu____2804 =
                        ...
                        let uu____2835 = c wp_trivial2 in ([], uu____2835) in
                      {
                        FStar_Syntax_Syntax.cattributes =
                          (uu___110_2805.FStar_Syntax_Syntax.cattributes);
                        FStar_Syntax_Syntax.mname =
                          (uu___110_2805.FStar_Syntax_Syntax.mname);
                        FStar_Syntax_Syntax.univs =
                          (uu___110_2805.FStar_Syntax_Syntax.univs);
                        FStar_Syntax_Syntax.binders =
                          (uu___110_2805.FStar_Syntax_Syntax.binders);
                        FStar_Syntax_Syntax.signature =
                          (uu___110_2805.FStar_Syntax_Syntax.signature);
                        FStar_Syntax_Syntax.ret_wp =
                          (uu___110_2805.FStar_Syntax_Syntax.ret_wp);
                        FStar_Syntax_Syntax.bind_wp =
                          (uu___110_2805.FStar_Syntax_Syntax.bind_wp);
                        ...
                        FStar_Syntax_Syntax.repr =
                          (uu___110_2805.FStar_Syntax_Syntax.repr);
                        FStar_Syntax_Syntax.return_repr =
                          (uu___110_2805.FStar_Syntax_Syntax.return_repr);
                        FStar_Syntax_Syntax.bind_repr =
                          (uu___110_2805.FStar_Syntax_Syntax.bind_repr);
                        FStar_Syntax_Syntax.actions =
                          (uu___110_2805.FStar_Syntax_Syntax.actions)
                      } in
...
let set_env: env -> FStar_TypeChecker_Env.env -> env =
  fun dmff_env  ->
    fun env'  ->
      let uu___111_2852 = dmff_env in
      {
        env = env';
        subst = (uu___111_2852.subst);
        tc_const = (uu___111_2852.tc_const)
      }
type nm =
    ...
    fun t  ->
          ...
          let binders1 =
            FStar_List.map
              (fun uu____3130  ->
                 ...
                 | (bv,aqual) ->
                     let uu____3141 =
                       let uu___112_3142 = bv in
                       let uu____3143 =
                         star_type' env bv.FStar_Syntax_Syntax.sort in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___112_3142.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___112_3142.FStar_Syntax_Syntax.index);
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,repr,something) ->
          ...
          (match uu____3619 with
           | (binders1,repr1) ->
               let env1 =
                 let uu___115_3627 = env in
                 let uu____3628 =
                   FStar_TypeChecker_Env.push_binders env.env binders1 in
                 {
                   env = uu____3628;
                   subst = (uu___115_3627.subst);
                   tc_const = (uu___115_3627.tc_const)
                 } in
      ...
      | FStar_Syntax_Syntax.Tm_refine (x,t2) when false ->
          ...
          mk1
            (FStar_Syntax_Syntax.Tm_refine
               ((let uu___116_3648 = x1 in
                 {
                   FStar_Syntax_Syntax.ppname =
                     (uu___116_3648.FStar_Syntax_Syntax.ppname);
                   FStar_Syntax_Syntax.index =
                     (uu___116_3648.FStar_Syntax_Syntax.index);
    ...
    fun e  ->
      fun context_nm  ->
        ...
        let ensure_m env1 e2 =
          let strip_m uu___102_4467 =
            match uu___102_4467 with
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,rc_opt) ->
                ...
                let uu____4938 =
                    ...
                    FStar_Pervasives_Native.Some uu____4945 in
                  {
                    FStar_Syntax_Syntax.residual_effect =
                      (uu___117_4939.FStar_Syntax_Syntax.residual_effect);
                    FStar_Syntax_Syntax.residual_typ = uu____4940;
                    FStar_Syntax_Syntax.residual_flags =
                      (uu___117_4939.FStar_Syntax_Syntax.residual_flags)
                  } in
          ...
          let env1 =
            let uu___118_4956 = env in
            let uu____4957 =
              FStar_TypeChecker_Env.push_binders env.env binders1 in
            {
              env = uu____4957;
              subst = (uu___118_4956.subst);
              tc_const = (uu___118_4956.tc_const)
            } in
          let s_binders =
            FStar_List.map
              (fun uu____4977  ->
                 ...
                 | (bv,qual) ->
                     ...
                     ((let uu___119_4990 = bv in
                       {
                         FStar_Syntax_Syntax.ppname =
                           (uu___119_4990.FStar_Syntax_Syntax.ppname);
                         FStar_Syntax_Syntax.index =
                           (uu___119_4990.FStar_Syntax_Syntax.index);
                         FStar_Syntax_Syntax.sort = sort
                       }), qual)) binders1 in
          let uu____4991 =
            FStar_List.fold_left
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         let x =
                           ...
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___120_5079.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___120_5079.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____5080
                           } in
                         let env3 =
                           let uu___121_5085 = env2 in
                           let uu____5086 =
                             let uu____5089 =
                               let uu____5090 =
                                 let uu____5097 =
                           ...
                           {
                             env = (uu___121_5085.env);
                             subst = uu____5086;
                             tc_const = (uu___121_5085.tc_const)
                           } in
                         let uu____5098 =
                         ...
                         (let x =
                            let uu___122_5110 = bv in
                            let uu____5111 =
                              star_type' env2 bv.FStar_Syntax_Syntax.sort in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___122_5110.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___122_5110.FStar_Syntax_Syntax.index);
                          ...
                          (match rc.FStar_Syntax_Syntax.residual_typ with
                           ...
                           | FStar_Pervasives_Native.Some rt ->
                               ...
                               then
                                 ...
                                 (let uu____5252 =
                                    let uu___123_5253 = rc in
                                    let uu____5254 =
                                      let uu____5259 = star_type' env2 rt in
                                      FStar_Pervasives_Native.Some uu____5259 in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___123_5253.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ =
                                        uu____5254;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___123_5253.FStar_Syntax_Syntax.residual_flags)
                                    } in
                    ...
                    (fun b  ->
                       ...
                       | (pat,FStar_Pervasives_Native.None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____6854;
                               subst = (uu___124_6853.subst);
                               tc_const = (uu___124_6853.tc_const)
                             } in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____7922 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____7944 in
                         {
                           ...
                           FStar_Syntax_Syntax.lbeff =
                             (uu___125_7940.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___125_7940.FStar_Syntax_Syntax.lbdef)
                         }
                       else binding in
                     let env1 =
                       let uu___126_7947 = env in
                       let uu____7948 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___127_7950 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___127_7950.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___127_7950.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____7948;
                         subst = (uu___126_7947.subst);
                         tc_const = (uu___126_7947.tc_const)
                       } in
                     let uu____7951 = proceed env1 e21 in
                     (match uu____7951 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___128_7968 = binding in
                            let uu____7969 =
                              star_type' env1
                                binding.FStar_Syntax_Syntax.lbtyp in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___128_7968.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___128_7968.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____7969;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___128_7968.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___128_7968.FStar_Syntax_Syntax.lbdef)
                            } in
                          let uu____7972 =
                            let uu____7975 =
                              let uu____7976 =
                                ...
                                ((false,
                                   [(let uu___129_7999 = s_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___129_7999.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___129_7999.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___129_7999.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___129_7999.FStar_Syntax_Syntax.lbeff);
                          ...
                          let uu____8000 =
                            let uu____8003 =
                              let uu____8004 =
                                ...
                                ((false,
                                   [(let uu___130_8027 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___130_8027.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___130_8027.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___130_8027.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___130_8027.FStar_Syntax_Syntax.lbeff);
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___131_8036 = binding in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___131_8036.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___131_8036.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Parser_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___131_8036.FStar_Syntax_Syntax.lbdef)
                       } in
                     let env1 =
                       let uu___132_8038 = env in
                       let uu____8039 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___133_8041 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___133_8041.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___133_8041.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____8039;
                         subst = (uu___132_8038.subst);
                         tc_const = (uu___132_8038.tc_const)
                       } in
                            ...
                            let uu____8162 =
                              let uu____8163 =
                                let uu____8176 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2 in
                                ((false,
                                   [(let uu___134_8186 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___134_8186.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___134_8186.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___134_8186.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___134_8186.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1
                                     })]), uu____8176) in
