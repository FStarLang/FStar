...
in (((binder)::[]), (_0_359))))
in {FStar_Syntax_Syntax.n = _0_360; FStar_Syntax_Syntax.tk = uu___94_894.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___94_894.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___94_894.FStar_Syntax_Syntax.vars}))
in (mk_rel t x y))
end
...
in (([]), (_0_420)))
in {FStar_Syntax_Syntax.qualifiers = uu___95_1188.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.cattributes = uu___95_1188.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___95_1188.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = uu___95_1188.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = uu___95_1188.FStar_Syntax_Syntax.binders; FStar_Syntax_Syntax.signature = uu___95_1188.FStar_Syntax_Syntax.signature; FStar_Syntax_Syntax.ret_wp = uu___95_1188.FStar_Syntax_Syntax.ret_wp; FStar_Syntax_Syntax.bind_wp = uu___95_1188.FStar_Syntax_Syntax.bind_wp; FStar_Syntax_Syntax.if_then_else = _0_428; FStar_Syntax_Syntax.ite_wp = _0_427; FStar_Syntax_Syntax.stronger = _0_426; FStar_Syntax_Syntax.close_wp = _0_425; FStar_Syntax_Syntax.assert_p = _0_424; FStar_Syntax_Syntax.assume_p = _0_423; FStar_Syntax_Syntax.null_wp = _0_422; FStar_Syntax_Syntax.trivial = _0_421; FStar_Syntax_Syntax.repr = uu___95_1188.FStar_Syntax_Syntax.repr; FStar_Syntax_Syntax.return_repr = uu___95_1188.FStar_Syntax_Syntax.return_repr; FStar_Syntax_Syntax.bind_repr = uu___95_1188.FStar_Syntax_Syntax.bind_repr; FStar_Syntax_Syntax.actions = uu___95_1188.FStar_Syntax_Syntax.actions})))))))))
in ((_0_430), (_0_429)))));
)))))))))))))))))))))))))))))))))))))))))))
end)))))))));
))));
...
let nm_of_comp : FStar_Syntax_Syntax.comp'  ->  nm = (fun uu___82_1232 -> (match (uu___82_1232) with
| FStar_Syntax_Syntax.Total (t, uu____1234) -> begin
N (t)
end
| FStar_Syntax_Syntax.Comp (c) when (FStar_All.pipe_right c.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___81_1243 -> (match (uu___81_1243) with
...
let string_of_nm : nm  ->  Prims.string = (fun uu___83_1254 -> (match (uu___83_1254) with
| N (t) -> begin
...
in {FStar_Syntax_Syntax.ppname = uu___96_1399.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___96_1399.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_445}))
in ((_0_446), (aqual)))
end)) binders)
in (match (t.FStar_Syntax_Syntax.n) with
...
| true -> begin
(mk (FStar_Syntax_Syntax.Tm_app ((let _0_463 = (FStar_List.map (fun uu____1612 -> (match (uu____1612) with
| (t, qual) -> begin
...
let uu___99_1661 = env
in (let _0_465 = (FStar_TypeChecker_Env.push_binders env.env binders)
in {env = _0_465; subst = uu___99_1661.subst; tc_const = uu___99_1661.tc_const}))
in (
...
let uu___100_1678 = x
in {FStar_Syntax_Syntax.ppname = uu___100_1678.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___100_1678.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})), (t))))))))))))
end
...
let is_monadic = (fun uu___85_1803 -> (match (uu___85_1803) with
| None -> begin
...
(FStar_All.pipe_right flags (FStar_Util.for_some (fun uu___84_1840 -> (match (uu___84_1840) with
| FStar_Syntax_Syntax.CPS -> begin
true
end
| uu____1841 -> begin
...
let is_unknown : FStar_Syntax_Syntax.term'  ->  Prims.bool = (fun uu___86_1977 -> (match (uu___86_1977) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
true
end
| uu____1978 -> begin
...
let strip_m = (fun uu___87_2181 -> (match (uu___87_2181) with
| (M (t), s_e, u_e) -> begin
((t), (s_e), (u_e))
end
| uu____2191 -> begin
...
let uu___101_2411 = env
in (let _0_496 = (FStar_TypeChecker_Env.push_binders env.env binders)
in {env = _0_496; subst = uu___101_2411.subst; tc_const = uu___101_2411.tc_const}))
in (
...
let uu___102_2428 = bv
in {FStar_Syntax_Syntax.ppname = uu___102_2428.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___102_2428.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort})), (qual)))
end)) binders)
in (
...
let uu___103_2473 = bv
in (let _0_499 = (let _0_498 = (FStar_Syntax_Syntax.bv_to_name xw)
in (trans_F_ env c _0_498))
in {FStar_Syntax_Syntax.ppname = uu___103_2473.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___103_2473.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_499}))
in (

let env = (

let uu___104_2475 = env
in (let _0_502 = (let _0_501 = FStar_Syntax_Syntax.NT ((let _0_500 = (FStar_Syntax_Syntax.bv_to_name xw)
in ((bv), (_0_500))))
in (_0_501)::env.subst)
in {env = uu___104_2475.env; subst = _0_502; tc_const = uu___104_2475.tc_const}))
...
let uu___105_2479 = bv
in (let _0_507 = (star_type' env bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___105_2479.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___105_2479.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_507}))
...
let uu____2565 = (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___88_2567 -> (match (uu___88_2567) with
| FStar_Syntax_Syntax.CPS -> begin
true
end
| uu____2568 -> begin
...
let flags = (FStar_List.filter (fun uu___89_2578 -> (match (uu___89_2578) with
| FStar_Syntax_Syntax.CPS -> begin
false
end
| uu____2579 -> begin
...
let uu___106_2597 = lc
in {FStar_Syntax_Syntax.eff_name = uu___106_2597.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu___106_2597.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___106_2597.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____2598 -> (
...
let uu____2623 = (FStar_All.pipe_right flags (FStar_Util.for_some (fun uu___90_2625 -> (match (uu___90_2625) with
| FStar_Syntax_Syntax.CPS -> begin
true
end
| uu____2626 -> begin
...
| true -> begin
(let _0_512 = (FStar_List.filter (fun uu___91_2631 -> (match (uu___91_2631) with
| FStar_Syntax_Syntax.CPS -> begin
false
end
| uu____2632 -> begin
...
let uu____3035 = (FStar_Syntax_Subst.compress (let _0_521 = (mk (FStar_Syntax_Syntax.Tm_arrow (((binders), (comp)))))
...
in {env = _0_534; subst = uu___107_3549.subst; tc_const = uu___107_3549.tc_const}))
in (
...
let has_m = (FStar_List.existsb (fun uu___92_3654 -> (match (uu___92_3654) with
| M (uu____3655) -> begin
true
end
| uu____3656 -> begin
...
let uu___108_4141 = binding
in (let _0_553 = (let _0_552 = (FStar_Syntax_Subst.subst env.subst s_e1)
in (trans_F_ env t1 _0_552))
in {FStar_Syntax_Syntax.lbname = uu___108_4141.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___108_4141.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _0_553; FStar_Syntax_Syntax.lbeff = uu___108_4141.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___108_4141.FStar_Syntax_Syntax.lbdef}))
end
| uu____4142 -> begin
binding
end))
...
let uu___109_4144 = env
in (let _0_554 = (FStar_TypeChecker_Env.push_bv env.env (

let uu___110_4145 = x
in {FStar_Syntax_Syntax.ppname = uu___110_4145.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___110_4145.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in {env = _0_554; subst = uu___109_4144.subst; tc_const = uu___109_4144.tc_const}))
in (
...
let uu___111_4157 = binding
in (let _0_555 = (star_type' env binding.FStar_Syntax_Syntax.lbtyp)
in {FStar_Syntax_Syntax.lbname = uu___111_4157.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___111_4157.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _0_555; FStar_Syntax_Syntax.lbeff = uu___111_4157.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___111_4157.FStar_Syntax_Syntax.lbdef}))
in (let _0_559 = (mk (FStar_Syntax_Syntax.Tm_let ((let _0_556 = (FStar_Syntax_Subst.close x_binders s_e2)
in ((((false), (((

let uu___112_4166 = s_binding
in {FStar_Syntax_Syntax.lbname = uu___112_4166.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___112_4166.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___112_4166.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___112_4166.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = s_e1}))::[]))), (_0_556))))))
in (let _0_558 = (mk (FStar_Syntax_Syntax.Tm_let ((let _0_557 = (FStar_Syntax_Subst.close x_binders u_e2)
in ((((false), (((

let uu___113_4171 = u_binding
in {FStar_Syntax_Syntax.lbname = uu___113_4171.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___113_4171.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___113_4171.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___113_4171.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = u_e1}))::[]))), (_0_557))))))
...
let uu___114_4176 = binding
in {FStar_Syntax_Syntax.lbname = uu___114_4176.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___114_4176.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = t1; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.lbdef = uu___114_4176.FStar_Syntax_Syntax.lbdef})
in (

let env = (

let uu___115_4178 = env
in (let _0_560 = (FStar_TypeChecker_Env.push_bv env.env (

let uu___116_4179 = x
in {FStar_Syntax_Syntax.ppname = uu___116_4179.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___116_4179.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t1}))
in {env = _0_560; subst = uu___115_4178.subst; tc_const = uu___115_4178.tc_const}))
in (
...
let uu___117_4231 = u_binding
in {FStar_Syntax_Syntax.lbname = uu___117_4231.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___117_4231.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___117_4231.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___117_4231.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = u_e1}))::[]))), (_0_570))))))
...
let uu____4373 = ((not (((FStar_List.length wp_args) = (FStar_List.length args)))) || (not ((let _0_573 = (FStar_Syntax_Util.mk_tuple_data_lid (FStar_List.length wp_args) FStar_Range.dummyRange)
...
(mk (FStar_Syntax_Syntax.Tm_app ((let _0_577 = (FStar_List.map2 (fun uu____4405 uu____4406 -> (match (((uu____4405), (uu____4406))) with
