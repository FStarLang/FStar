        ...
        then
          ((let uu____4156 =
              let uu____4157 =
                FStar_List.for_all
                  (fun uu____4165  ->
                     match uu____4165 with | (h,uu____4171) -> is_C h) args
                 in
                ...
                FStar_List.for_all
                  (fun uu____4185  ->
                     ...
                     | (h,uu____4191) ->
                         ...
                         Prims.op_Negation uu____4192) args
                 in
    ...
    fun t  ->
      fun e  ->
        ...
        let body =
          ...
          mk1 uu____4296  in
        let uu____4340 =
          let uu____4341 = FStar_Syntax_Syntax.mk_binder p  in [uu____4341]
           in
    ...
    fun e  ->
      fun context_nm  ->
          ...
          | (rec_nm,s_e,u_e) ->
                ...
                let uu____4547 =
                  (Prims.op_Negation (is_unknown t2.FStar_Syntax_Syntax.n))
                    ...
                    (let uu____4549 =
                     ...
                     Prims.op_Negation uu____4549)
                   in
                if uu____4547
                then
                  let uu____4551 =
                    let uu____4556 =
                      let uu____4557 = FStar_Syntax_Print.term_to_string e
                         in
                      let uu____4558 = FStar_Syntax_Print.term_to_string t1
                         in
                      let uu____4559 = FStar_Syntax_Print.term_to_string t2
                         in
                      FStar_Util.format3
                        "[check]: the expression [%s] has type [%s] but should have type [%s]"
                        uu____4557 uu____4558 uu____4559
                       in
              ...
              (match (rec_nm, context_nm) with
               ...
               | (M t1,N t2) ->
                   let uu____4579 =
                     let uu____4584 =
                       let uu____4585 = FStar_Syntax_Print.term_to_string e
                          in
                       let uu____4586 = FStar_Syntax_Print.term_to_string t1
                          in
                       let uu____4587 = FStar_Syntax_Print.term_to_string t2
                          in
                       FStar_Util.format3
                     ...
                     (FStar_Errors.Fatal_EffectfulAndPureComputationMismatch,
                       uu____4584)
                      in
                   FStar_Errors.raise_err uu____4579)
           in
        let ensure_m env1 e2 =
          ...
          | M uu____4677 ->
              let uu____4678 = check env1 e2 context_nm  in
              strip_m uu____4678
           in
        let uu____4685 =
    ...
    fun e  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (binders,body,rc_opt) ->
          let subst_rc_opt subst1 rc_opt1 =
            ...
            | FStar_Pervasives_Native.Some rc ->
                ...
                FStar_Pervasives_Native.Some uu____5098
             in
                   ...
                   | ((env2,acc),(bv,qual)) ->
                       ...
                       then
                         ...
                         (let x =
                          ...
                          let uu____5274 =
                            let uu____5277 = FStar_Syntax_Syntax.mk_binder x
                               in
                            uu____5277 :: acc  in
                          (env2, uu____5274))) (env1, []) binders1
             in
      ...
      | FStar_Syntax_Syntax.Tm_fvar
          ...
          (match uu____5541 with
           | (uu____5577,t) ->
               let uu____5579 =
                 let uu____5580 = normalize1 t  in N uu____5580  in
               (uu____5579, e, e))
      ...
      | FStar_Syntax_Syntax.Tm_app
          ...
          let uu____6257 =
            let uu____6262 =
              ...
              FStar_Util.format1 "DMFF: Ill-applied constant %s" uu____6263
               in
      ...
      | FStar_Syntax_Syntax.Tm_app
          ...
          let uu____6293 =
            let uu____6298 =
              ...
              FStar_Util.format1 "DMFF: Ill-applied constant %s" uu____6299
               in
           ...
           | (t_head,s_head,u_head) ->
               ...
               let rec flatten1 t =
                 ...
                 | uu____6551 ->
                     ...
                     FStar_Errors.raise_err uu____6552
                  in
                       ...
                       (let uu____6631 =
                          let uu____6636 =
                            ...
                            FStar_Util.format3
                              ...
                              uu____6637 uu____6644 uu____6655
                             in
      ...
      | FStar_Syntax_Syntax.Tm_constant c ->
          let uu____7432 = let uu____7433 = env.tc_const c  in N uu____7433
             in
          (uu____7432, e, e)
                              ...
                              let uu____8625 =
                                let uu____8626 =
                                  FStar_Syntax_Syntax.new_bv
                                   ...
                                   in
                                FStar_All.pipe_left
                                  FStar_Syntax_Syntax.mk_binder uu____8626
                                 in
                              [uu____8625]  in
                            let uu____8627 =
                              FStar_Syntax_Syntax.mk_Total
