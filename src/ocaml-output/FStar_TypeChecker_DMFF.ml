                    ...
                    (fun b  ->
                       ...
                       | (pat,FStar_Pervasives_Native.None ,body) ->
                           let env1 =
                             ...
                             {
                               env = uu____6854;
                               subst = (uu___364_6853.subst);
                               tc_const = (uu___364_6853.tc_const)
                             } in
          ...
          fun ensure_m  ->
            ...
            | (x_binders1,e21) ->
                ...
                (match uu____7922 with
                       ...
                       then
                           ...
                           trans_F_ env t1 uu____7944 in
                         {
                           FStar_Syntax_Syntax.lbname =
                             (uu___365_7940.FStar_Syntax_Syntax.lbname);
                           FStar_Syntax_Syntax.lbunivs =
                             (uu___365_7940.FStar_Syntax_Syntax.lbunivs);
                           FStar_Syntax_Syntax.lbtyp = uu____7941;
                           FStar_Syntax_Syntax.lbeff =
                             (uu___365_7940.FStar_Syntax_Syntax.lbeff);
                           FStar_Syntax_Syntax.lbdef =
                             (uu___365_7940.FStar_Syntax_Syntax.lbdef)
                         }
                       else binding in
                     let env1 =
                       let uu___366_7947 = env in
                       let uu____7948 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___367_7950 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___367_7950.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___367_7950.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____7948;
                         subst = (uu___366_7947.subst);
                         tc_const = (uu___366_7947.tc_const)
                       } in
                     let uu____7951 = proceed env1 e21 in
                     (match uu____7951 with
                      | (nm_rec,s_e2,u_e2) ->
                          let s_binding =
                            let uu___368_7968 = binding in
                            let uu____7969 =
                              star_type' env1
                                binding.FStar_Syntax_Syntax.lbtyp in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___368_7968.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___368_7968.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp = uu____7969;
                              FStar_Syntax_Syntax.lbeff =
                                (uu___368_7968.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef =
                                (uu___368_7968.FStar_Syntax_Syntax.lbdef)
                            } in
                          let uu____7972 =
                            let uu____7975 =
                              let uu____7976 =
                                ...
                                ((false,
                                   [(let uu___369_7999 = s_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___369_7999.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___369_7999.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___369_7999.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___369_7999.FStar_Syntax_Syntax.lbeff);
                          ...
                          let uu____8000 =
                            let uu____8003 =
                              let uu____8004 =
                                ...
                                ((false,
                                   [(let uu___370_8027 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___370_8027.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___370_8027.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___370_8027.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___370_8027.FStar_Syntax_Syntax.lbeff);
                 ...
                 | (M t1,s_e1,u_e1) ->
                     let u_binding =
                       let uu___371_8036 = binding in
                       {
                         FStar_Syntax_Syntax.lbname =
                           (uu___371_8036.FStar_Syntax_Syntax.lbname);
                         FStar_Syntax_Syntax.lbunivs =
                           (uu___371_8036.FStar_Syntax_Syntax.lbunivs);
                         FStar_Syntax_Syntax.lbtyp = t1;
                         FStar_Syntax_Syntax.lbeff =
                           FStar_Parser_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.lbdef =
                           (uu___371_8036.FStar_Syntax_Syntax.lbdef)
                       } in
                     let env1 =
                       let uu___372_8038 = env in
                       let uu____8039 =
                         FStar_TypeChecker_Env.push_bv env.env
                           (let uu___373_8041 = x in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___373_8041.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___373_8041.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = t1
                            }) in
                       {
                         env = uu____8039;
                         subst = (uu___372_8038.subst);
                         tc_const = (uu___372_8038.tc_const)
                       } in
                            ...
                            let uu____8162 =
                              let uu____8163 =
                                let uu____8176 =
                                  FStar_Syntax_Subst.close x_binders1 u_e2 in
                                ((false,
                                   [(let uu___374_8186 = u_binding in
                                     {
                                       FStar_Syntax_Syntax.lbname =
                                         (uu___374_8186.FStar_Syntax_Syntax.lbname);
                                       FStar_Syntax_Syntax.lbunivs =
                                         (uu___374_8186.FStar_Syntax_Syntax.lbunivs);
                                       FStar_Syntax_Syntax.lbtyp =
                                         (uu___374_8186.FStar_Syntax_Syntax.lbtyp);
                                       FStar_Syntax_Syntax.lbeff =
                                         (uu___374_8186.FStar_Syntax_Syntax.lbeff);
                                       FStar_Syntax_Syntax.lbdef = u_e1
                                     })]), uu____8176) in
