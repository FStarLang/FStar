            ...
            (let rec collect_binders t =
             ...
             (let unknown = FStar_Syntax_Syntax.tun  in
              ...
              let args_of_binders1 =
                FStar_List.map
                  (fun bv  ->
                     let uu____252 = FStar_Syntax_Syntax.bv_to_name (fst bv)
                        in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_app (head1,args) ->
          let debug1 t2 s =
            ...
            let uu____2466 = string_of_set FStar_Syntax_Print.bv_to_string s
               in
          ...
          let rec is_non_dependent_arrow ty n1 =
            ...
            | FStar_Syntax_Syntax.Tm_arrow (binders,c) ->
                let uu____2490 =
                  let uu____2491 = FStar_Syntax_Util.is_tot_or_gtot_comp c
                     in
                ...
                then false
                  ...
                  (try
                     ...
                     let uu____2511 = FStar_Syntax_Subst.open_comp binders c
                        in
      ...
      | FStar_Syntax_Syntax.Tm_let uu____2854 ->
          let uu____2862 =
            let uu____2863 =
              ...
              FStar_Util.format1
                "Tm_let is outside of the definition language: %s" uu____2864
               in
        ...
        then
          ((let uu____2989 =
              let uu____2990 =
                FStar_List.for_all
                  (fun uu____2993  ->
                     match uu____2993 with | (h,uu____2997) -> is_C h) args
                 in
                ...
                FStar_List.for_all
                  (fun uu____3005  ->
                     ...
                     | (h,uu____3009) ->
                         ...
                         Prims.op_Negation uu____3010) args
                 in
                                ...
                                let uu____5498 =
                                  let uu____5499 =
                                    FStar_Syntax_Syntax.mk_Total
                                      FStar_Syntax_Util.ktype0
                                     in
                                  FStar_Syntax_Util.lcomp_of_comp uu____5499
                                   in
                          ...
                          let t1_star =
                            let uu____5513 =
                              let uu____5517 =
                                ...
                                FStar_All.pipe_left
                                  FStar_Syntax_Syntax.mk_binder uu____5518
                                 in
                              [uu____5517]  in
                            let uu____5519 =
                              FStar_Syntax_Syntax.mk_Total
                                ...
                                let uu____5811 =
                                  let uu____5812 =
                                    FStar_Syntax_Syntax.mk_Total
                                      FStar_Syntax_Util.ktype0
                                     in
                                  FStar_Syntax_Util.lcomp_of_comp uu____5812
                                   in
                                FStar_Util.Inl uu____5811  in
                              Some uu____5805  in
                            FStar_Syntax_Util.abs x_binders1 s_e21 uu____5798
                             in
                          let body =
                            let uu____5826 =
                              let uu____5827 =
                                ...
                                let uu____5868 =
                                  let uu____5869 =
                                    FStar_Syntax_Syntax.mk_Total
                                      FStar_Syntax_Util.ktype0
                                     in
                                  FStar_Syntax_Util.lcomp_of_comp uu____5869
                                   in
                                FStar_Util.Inl uu____5868  in
                              Some uu____5862  in
                            FStar_Syntax_Util.abs uu____5853 body uu____5855
                             in
                          let uu____5880 =
                            let uu____5883 =
                              let uu____5884 =
                            ...
                            (fun uu____6075  ->
                               fun uu____6076  ->
                                 ...
                                 | ((arg,q),(wp_arg,q')) ->
                                     ...
                                     (if q <> q'
                                      then
                                        (let uu____6102 = print_implicit q
                                            in
                                         let uu____6103 = print_implicit q'
                                            in
