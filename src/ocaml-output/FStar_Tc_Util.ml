...
let report : FStar_Tc_Env.env  ->  Prims.string Prims.list  ->  Prims.unit = (fun env errs -> (let _144_10 = (FStar_Tc_Env.get_range env)
in (let _144_9 = (FStar_Tc_Errors.failed_to_prove_specification errs)
in (FStar_Tc_Errors.report _144_10 _144_9))))
...
let syn' = (fun env k -> (let _144_29 = (FStar_Tc_Env.get_range env)
in (FStar_Absyn_Syntax.syn _144_29 k)))
...
| Some (f) -> begin
(let _144_53 = (FStar_Tc_Rel.apply_guard f e)
in (FStar_All.pipe_left (fun _144_52 -> Some (_144_52)) _144_53))
end)
end)
in if (env.FStar_Tc_Env.is_pattern && false) then begin
(match ((FStar_Tc_Rel.try_teq env t1 t2)) with
| None -> begin
(let _144_57 = (let _144_56 = (let _144_55 = (FStar_Tc_Errors.expected_pattern_of_type env t2 e t1)
in (let _144_54 = (FStar_Tc_Env.get_range env)
in ((_144_55), (_144_54))))
in FStar_Absyn_Syntax.Error (_144_56))
in (Prims.raise _144_57))
end
| Some (g) -> begin
((e), (g))
end)
...
| None -> begin
(let _144_61 = (let _144_60 = (let _144_59 = (FStar_Tc_Errors.expected_expression_of_type env t2 e t1)
in (let _144_58 = (FStar_Tc_Env.get_range env)
in ((_144_59), (_144_58))))
in FStar_Absyn_Syntax.Error (_144_60))
in (Prims.raise _144_61))
end
| Some (g) -> begin
(

let _46_53 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _144_62 = (FStar_Tc_Rel.guard_to_string env g)
...
let _46_60 = e
in (let _144_63 = (FStar_Util.mk_ref (Some (t2)))
in {FStar_Absyn_Syntax.n = _46_60.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _144_63; FStar_Absyn_Syntax.pos = _46_60.FStar_Absyn_Syntax.pos; FStar_Absyn_Syntax.fvs = _46_60.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _46_60.FStar_Absyn_Syntax.uvs}))
end)
in ((e), (g)))))
end)
end)))
...
let new_kvar : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.knd = (fun env -> (let _144_73 = (let _144_72 = (FStar_Tc_Env.get_range env)
in (let _144_71 = (env_binders env)
in (FStar_Tc_Rel.new_kvar _144_72 _144_71)))
in (FStar_All.pipe_right _144_73 Prims.fst)))


let new_tvar : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.typ = (fun env k -> (let _144_80 = (let _144_79 = (FStar_Tc_Env.get_range env)
in (let _144_78 = (env_binders env)
in (FStar_Tc_Rel.new_tvar _144_79 _144_78 k)))
in (FStar_All.pipe_right _144_80 Prims.fst)))


let new_evar : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.exp = (fun env t -> (let _144_87 = (let _144_86 = (FStar_Tc_Env.get_range env)
in (let _144_85 = (env_binders env)
in (FStar_Tc_Rel.new_evar _144_86 _144_85 t)))
in (FStar_All.pipe_right _144_87 Prims.fst)))
...
let _46_107 = (let _144_93 = (FStar_Tc_Env.get_range env)
in (let _144_92 = (env_binders env)
in (FStar_Tc_Rel.new_tvar _144_93 _144_92 k)))
in (match (_46_107) with
| (t, u) -> begin
(let _144_95 = (let _144_94 = (as_uvar_t u)
in ((_144_94), (u.FStar_Absyn_Syntax.pos)))
in ((t), (_144_95)))
end)))
...
let _46_112 = (let _144_101 = (FStar_Tc_Env.get_range env)
in (let _144_100 = (env_binders env)
in (FStar_Tc_Rel.new_evar _144_101 _144_100 t)))
in (match (_46_112) with
| (e, u) -> begin
(let _144_103 = (let _144_102 = (as_uvar_e u)
in ((_144_102), (u.FStar_Absyn_Syntax.pos)))
in ((e), (_144_103)))
end)))
...
| None -> begin
(let _144_106 = (let _144_105 = (FStar_Range.string_of_range s.FStar_Absyn_Syntax.pos)
in (FStar_Util.format1 "Impossible: Forced tk not present (%s)" _144_105))
in (FStar_All.failwith _144_106))
end
| Some (tk) -> begin
tk
end))
...
(let _144_111 = (let _144_110 = (force_tk t)
in FStar_Util.Inl (_144_110))
in ((_144_111), (imp)))
end
| (FStar_Util.Inr (v), imp) -> begin
(let _144_113 = (let _144_112 = (force_tk v)
in FStar_Util.Inr (_144_112))
in ((_144_113), (imp)))
end)))))
...
let ktop = (let _144_124 = (FStar_Absyn_Util.compress_kind k)
in (FStar_All.pipe_right _144_124 (FStar_Tc_Normalize.norm_kind ((FStar_Tc_Normalize.WHNF)::(FStar_Tc_Normalize.Beta)::(FStar_Tc_Normalize.Eta)::[]) env)))
in (
...
(let _144_137 = (let _144_134 = (let _144_133 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Rel.new_tvar r vars _144_133))
in (FStar_All.pipe_right _144_134 Prims.fst))
in (FStar_All.pipe_right _144_137 (fun x -> (let _144_136 = (FStar_Absyn_Syntax.as_implicit true)
in ((FStar_Util.Inl (x)), (_144_136))))))
end
| FStar_Util.Inr (x) -> begin
(let _144_142 = (let _144_139 = (let _144_138 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Rel.new_evar r vars _144_138))
in (FStar_All.pipe_right _144_139 Prims.fst))
in (FStar_All.pipe_right _144_142 (fun x -> (let _144_141 = (FStar_Absyn_Syntax.as_implicit true)
in ((FStar_Util.Inr (x)), (_144_141))))))
end)
in (
...
(let _144_143 = (FStar_Absyn_Util.subst_formal b imp_arg)
in (_144_143)::subst)
end
in (
...
(let _144_144 = (FStar_Absyn_Util.subst_binders subst bs)
in (([]), (_144_144)))
end
end
| _46_175 -> begin
(let _144_145 = (FStar_Absyn_Util.subst_binders subst bs)
in (([]), (_144_145)))
end))
...
let _46_178 = (let _144_146 = (FStar_Tc_Env.binders env)
in (mk_implicits _144_146 [] bs))
...
let kres = (let _144_147 = (FStar_Tc_Rel.new_kvar r binders)
in (FStar_All.pipe_right _144_147 Prims.fst))
in (

let bs = (let _144_148 = (tks_of_args args)
in (FStar_Absyn_Util.null_binders_of_tks _144_148))
in (

let kar = (FStar_Absyn_Syntax.mk_Kind_arrow ((bs), (kres)) r)
in (

let _46_192 = (let _144_149 = (FStar_Tc_Rel.keq env None k kar)
in (FStar_All.pipe_left (force_trivial env) _144_149))
in (([]), (bs), (kres))))))))
end
| _46_195 -> begin
(let _144_152 = (let _144_151 = (let _144_150 = (FStar_Tc_Errors.expected_tcon_kind env tt ktop)
in ((_144_150), (r)))
in FStar_Absyn_Syntax.Error (_144_151))
in (Prims.raise _144_152))
end))
in (aux ktop)))))
...
let _46_260 = (let _144_174 = (FStar_Tc_Env.binders env)
in (FStar_Tc_Rel.new_evar p.FStar_Absyn_Syntax.p _144_174 t))
...
let _46_272 = (let _144_175 = (FStar_Tc_Env.binders env)
in (FStar_Tc_Rel.new_tvar p.FStar_Absyn_Syntax.p _144_175 k))
...
let w = (let _144_177 = (let _144_176 = (new_tvar env FStar_Absyn_Syntax.ktype)
in ((x.FStar_Absyn_Syntax.v), (_144_176)))
in FStar_Tc_Env.Binding_var (_144_177))
in (
...
let b = (let _144_179 = (let _144_178 = (new_tvar env FStar_Absyn_Syntax.ktype)
in ((x.FStar_Absyn_Syntax.v), (_144_178)))
in FStar_Tc_Env.Binding_var (_144_179))
in (
...
let w = (let _144_181 = (let _144_180 = (new_kvar env)
in ((a.FStar_Absyn_Syntax.v), (_144_180)))
in FStar_Tc_Env.Binding_typ (_144_181))
in (
...
let b = (let _144_183 = (let _144_182 = (new_kvar env)
in ((a.FStar_Absyn_Syntax.v), (_144_182)))
in FStar_Tc_Env.Binding_typ (_144_183))
in (
...
let e = (let _144_191 = (let _144_190 = (let _144_189 = (let _144_188 = (let _144_187 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) fv.FStar_Absyn_Syntax.v fv.FStar_Absyn_Syntax.p)
in (let _144_186 = (FStar_All.pipe_right args FStar_List.rev)
in ((_144_187), (_144_186))))
in (FStar_Absyn_Syntax.mk_Exp_app' _144_188 None p.FStar_Absyn_Syntax.p))
in ((_144_189), (FStar_Absyn_Syntax.Data_app)))
in FStar_Absyn_Syntax.Meta_desugared (_144_190))
in (FStar_Absyn_Syntax.mk_Exp_meta _144_191))
in (let _144_194 = (FStar_All.pipe_right (FStar_List.rev b) FStar_List.flatten)
in (let _144_193 = (FStar_All.pipe_right (FStar_List.rev a) FStar_List.flatten)
in (let _144_192 = (FStar_All.pipe_right (FStar_List.rev w) FStar_List.flatten)
in ((_144_194), (_144_193), (_144_192), (env), (FStar_Util.Inr (e)), ((
...
| (p, imp) -> begin
(let _144_200 = (elaborate_pat env p)
in ((_144_200), (imp)))
end)) pats)
in (
...
let a = (let _144_206 = (FStar_Absyn_Util.new_bvd None)
in (FStar_Absyn_Util.bvd_to_bvar_s _144_206 FStar_Absyn_Syntax.kun))
in if allow_implicits then begin
(let _144_208 = (let _144_207 = (FStar_Absyn_Syntax.range_of_lid fv.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Syntax.withinfo (FStar_Absyn_Syntax.Pat_dot_typ (((a), (FStar_Absyn_Syntax.tun)))) None _144_207))
in ((_144_208), ((as_imp imp))))
end else begin
(let _144_210 = (let _144_209 = (FStar_Absyn_Syntax.range_of_lid fv.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Syntax.withinfo (FStar_Absyn_Syntax.Pat_tvar (a)) None _144_209))
in ((_144_210), ((as_imp imp))))
end)
end
...
(let _144_215 = (let _144_214 = (let _144_212 = (let _144_211 = (FStar_Absyn_Util.bvar_to_exp a)
in ((a), (_144_211)))
in FStar_Absyn_Syntax.Pat_dot_term (_144_212))
in (let _144_213 = (FStar_Absyn_Syntax.range_of_lid fv.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Syntax.withinfo _144_214 None _144_213)))
in ((_144_215), (true)))
end else begin
(let _144_217 = (let _144_216 = (FStar_Absyn_Syntax.range_of_lid fv.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Syntax.withinfo (FStar_Absyn_Syntax.Pat_var (a)) None _144_216))
in ((_144_217), (true)))
end)
end
| _46_396 -> begin
(let _144_221 = (let _144_220 = (let _144_219 = (let _144_218 = (FStar_Absyn_Print.pat_to_string p)
in (FStar_Util.format1 "Insufficient pattern arguments (%s)" _144_218))
in ((_144_219), ((FStar_Ident.range_of_lid fv.FStar_Absyn_Syntax.v))))
in FStar_Absyn_Syntax.Error (_144_220))
in (Prims.raise _144_221))
end))))
end
...
(let _144_222 = (aux formals' pats')
in (((p), ((as_imp imp))))::_144_222)
end
| ((FStar_Util.Inl (_46_424), imp), FStar_Absyn_Syntax.Pat_dot_typ (_46_429)) when allow_implicits -> begin
(let _144_223 = (aux formals' pats')
in (((p), ((as_imp imp))))::_144_223)
end
| ((FStar_Util.Inl (_46_433), imp), _46_438) -> begin
(

let a = (let _144_224 = (FStar_Absyn_Util.new_bvd None)
in (FStar_Absyn_Util.bvd_to_bvar_s _144_224 FStar_Absyn_Syntax.kun))
in (

let p1 = if allow_implicits then begin
(let _144_225 = (FStar_Absyn_Syntax.range_of_lid fv.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Syntax.withinfo (FStar_Absyn_Syntax.Pat_dot_typ (((a), (FStar_Absyn_Syntax.tun)))) None _144_225))
end else begin
(let _144_226 = (FStar_Absyn_Syntax.range_of_lid fv.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Syntax.withinfo (FStar_Absyn_Syntax.Pat_tvar (a)) None _144_226))
end
in (
...
in (let _144_227 = (aux formals' pats')
in (((p1), ((as_imp imp))))::_144_227))))
end
| ((FStar_Util.Inr (_46_449), Some (FStar_Absyn_Syntax.Implicit (false))), _46_456) when p_imp -> begin
(let _144_228 = (aux formals' pats')
in (((p), (true)))::_144_228)
end
...
(let _144_232 = (let _144_230 = (let _144_229 = (FStar_Absyn_Util.bvar_to_exp a)
in ((a), (_144_229)))
in FStar_Absyn_Syntax.Pat_dot_term (_144_230))
in (let _144_231 = (FStar_Absyn_Syntax.range_of_lid fv.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Syntax.withinfo _144_232 None _144_231)))
end else begin
(let _144_233 = (FStar_Absyn_Syntax.range_of_lid fv.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Syntax.withinfo (FStar_Absyn_Syntax.Pat_var (a)) None _144_233))
end
in (let _144_234 = (aux formals' pats)
in (((p), (true)))::_144_234)))
end
| ((FStar_Util.Inr (_46_471), imp), _46_476) -> begin
(let _144_235 = (aux formals' pats')
in (((p), ((as_imp imp))))::_144_235)
end)
end))
in (aux f pats))
end)
...
(let _144_244 = (let _144_243 = (let _144_242 = (FStar_Tc_Errors.nonlinear_pattern_variable (FStar_Util.Inr (x)))
in ((_144_242), (p.FStar_Absyn_Syntax.p)))
in FStar_Absyn_Syntax.Error (_144_243))
in (Prims.raise _144_244))
end
| Some (FStar_Tc_Env.Binding_typ (x, _46_503)) -> begin
(let _144_247 = (let _144_246 = (let _144_245 = (FStar_Tc_Errors.nonlinear_pattern_variable (FStar_Util.Inl (x)))
in ((_144_245), (p.FStar_Absyn_Syntax.p)))
in FStar_Absyn_Syntax.Error (_144_246))
in (Prims.raise _144_247))
end
| _46_508 -> begin
((b), (a), (w), (arg), (p))
end)
...
(let _144_261 = (let _144_260 = (let _144_259 = (let _144_257 = (vars_of_bindings a)
in (let _144_256 = (vars_of_bindings a')
in (FStar_Tc_Errors.disjunctive_pattern_vars _144_257 _144_256)))
in (let _144_258 = (FStar_Tc_Env.get_range env)
in ((_144_259), (_144_258))))
in FStar_Absyn_Syntax.Error (_144_260))
in (Prims.raise _144_261))
end else begin
(let _144_263 = (let _144_262 = (as_arg arg)
in (_144_262)::args)
in (((FStar_List.append w' w)), (_144_263), ((p)::pats)))
end
end))
end)) pats (([]), ([]), ([])))
in (match (_46_545) with
| (w, args, pats) -> begin
(let _144_265 = (let _144_264 = (as_arg te)
in (_144_264)::args)
in (((FStar_List.append b w)), (_144_265), ((
...
(let _144_267 = (let _144_266 = (as_arg arg)
in (_144_266)::[])
in ((b), (_144_267), (p)))
end))
end))
...
let pkg = (fun q t -> (let _144_286 = (FStar_All.pipe_left (fun _144_285 -> Some (_144_285)) (FStar_Util.Inr (t)))
in (FStar_Absyn_Syntax.withinfo q _144_286 p.FStar_Absyn_Syntax.p)))
in (
...
(let _144_287 = (force_tk e)
in (pkg p.FStar_Absyn_Syntax.v _144_287))
end
...
(let _144_290 = (let _144_289 = (FStar_Absyn_Print.strBvd x.FStar_Absyn_Syntax.v)
in (let _144_288 = (FStar_Absyn_Print.strBvd y.FStar_Absyn_Syntax.v)
in (FStar_Util.format2 "Expected pattern variable %s; got %s" _144_289 _144_288)))
...
(let _144_292 = (FStar_Absyn_Print.strBvd x.FStar_Absyn_Syntax.v)
in (let _144_291 = (FStar_Tc_Normalize.typ_norm_to_string env y.FStar_Absyn_Syntax.sort)
...
in (let _144_293 = (force_tk e)
in (pkg (FStar_Absyn_Syntax.Pat_var (x)) _144_293))))))
end
...
(let _144_296 = (let _144_295 = (FStar_Absyn_Print.strBvd x.FStar_Absyn_Syntax.v)
in (let _144_294 = (FStar_Absyn_Print.strBvd y.FStar_Absyn_Syntax.v)
in (FStar_Util.format2 "Expected pattern variable %s; got %s" _144_295 _144_294)))
...
let _46_614 = x
in (let _144_297 = (force_tk e)
in {FStar_Absyn_Syntax.v = _46_614.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _144_297; FStar_Absyn_Syntax.p = _46_614.FStar_Absyn_Syntax.p}))
...
let _46_625 = x
in (let _144_298 = (force_tk e)
in {FStar_Absyn_Syntax.v = _46_625.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _144_298; FStar_Absyn_Syntax.p = _46_625.FStar_Absyn_Syntax.p}))
...
(let _144_299 = (FStar_Util.format2 "Expected pattern constructor %s; got %s" fv.FStar_Absyn_Syntax.v.FStar_Ident.str fv'.FStar_Absyn_Syntax.v.FStar_Ident.str)
in (FStar_All.failwith _144_299))
end else begin
()
end
...
(let _144_300 = (FStar_Util.format2 "Expected pattern constructor %s; got %s" fv.FStar_Absyn_Syntax.v.FStar_Ident.str fv'.FStar_Absyn_Syntax.v.FStar_Ident.str)
in (FStar_All.failwith _144_300))
end else begin
()
end
in (
...
| ([], []) -> begin
(let _144_307 = (force_tk e)
in (pkg (FStar_Absyn_Syntax.Pat_cons (((fv), (q), ((FStar_List.rev matched_pats))))) _144_307))
end
...
let x = (let _144_308 = (force_tk t)
in (FStar_Absyn_Util.gen_bvar_p p.FStar_Absyn_Syntax.p _144_308))
in (

let q = (let _144_310 = (FStar_All.pipe_left (fun _144_309 -> Some (_144_309)) (FStar_Util.Inl (x.FStar_Absyn_Syntax.sort)))
in (FStar_Absyn_Syntax.withinfo (FStar_Absyn_Syntax.Pat_dot_typ (((x), (t)))) _144_310 p.FStar_Absyn_Syntax.p))
in (match_args ((((q), (true)))::matched_pats) args argpats)))
end
| ((FStar_Util.Inr (e), Some (FStar_Absyn_Syntax.Implicit (_46_700))), FStar_Absyn_Syntax.Pat_dot_term (_46_705)) -> begin
(

let x = (let _144_311 = (force_tk e)
in (FStar_Absyn_Util.gen_bvar_p p.FStar_Absyn_Syntax.p _144_311))
in (

let q = (let _144_313 = (FStar_All.pipe_left (fun _144_312 -> Some (_144_312)) (FStar_Util.Inr (x.FStar_Absyn_Syntax.sort)))
in (FStar_Absyn_Syntax.withinfo (FStar_Absyn_Syntax.Pat_dot_term (((x), (e)))) _144_313 p.FStar_Absyn_Syntax.p))
in (match_args ((((q), (true)))::matched_pats) args argpats)))
end
...
let pat = (let _144_314 = (aux argpat e)
in ((_144_314), ((as_imp imp))))
in (match_args ((pat)::matched_pats) args argpats))
end)
end
| _46_727 -> begin
(let _144_317 = (let _144_316 = (FStar_Absyn_Print.pat_to_string p)
in (let _144_315 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format2 "Unexpected number of pattern arguments: \n\t%s\n\t%s\n" _144_316 _144_315)))
in (FStar_All.failwith _144_317))
end))
in (match_args [] args argpats))))
end
| _46_729 -> begin
(let _144_322 = (let _144_321 = (FStar_Range.string_of_range qq.FStar_Absyn_Syntax.p)
in (let _144_320 = (FStar_Absyn_Print.pat_to_string qq)
in (let _144_319 = (let _144_318 = (FStar_All.pipe_right exps (FStar_List.map FStar_Absyn_Print.exp_to_string))
in (FStar_All.pipe_right _144_318 (FStar_String.concat "\n\t")))
in (FStar_Util.format3 "(%s) Impossible: pattern to decorate is %s; expression is %s\n" _144_321 _144_320 _144_319))))
in (FStar_All.failwith _144_322))
end))))
and aux_t = (fun p t0 -> (

let pkg = (fun q k -> (let _144_330 = (FStar_All.pipe_left (fun _144_329 -> Some (_144_329)) (FStar_Util.Inl (k)))
in (FStar_Absyn_Syntax.withinfo q _144_330 p.FStar_Absyn_Syntax.p)))
in (
...
(let _144_333 = (let _144_332 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (let _144_331 = (FStar_Absyn_Print.strBvd b.FStar_Absyn_Syntax.v)
in (FStar_Util.format2 "Expected pattern variable %s; got %s" _144_332 _144_331)))
in (FStar_All.failwith _144_333))
end else begin
()
end
...
(let _144_336 = (let _144_335 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (let _144_334 = (FStar_Absyn_Print.strBvd b.FStar_Absyn_Syntax.v)
in (FStar_Util.format2 "Expected pattern variable %s; got %s" _144_335 _144_334)))
in (FStar_All.failwith _144_336))
end else begin
()
end
...
| _46_763 -> begin
(let _144_340 = (let _144_339 = (FStar_Range.string_of_range p.FStar_Absyn_Syntax.p)
in (let _144_338 = (FStar_Absyn_Print.pat_to_string p)
in (let _144_337 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format3 "(%s) Impossible: pattern to decorate is %s; expression is %s\n" _144_339 _144_338 _144_337))))
in (FStar_All.failwith _144_340))
end))))
...
in (let _144_342 = (FStar_All.pipe_left (fun _144_341 -> Some (_144_341)) (FStar_Util.Inr (FStar_Absyn_Syntax.tun)))
in (FStar_Absyn_Syntax.withinfo (FStar_Absyn_Syntax.Pat_disj (ps)) _144_342 p.FStar_Absyn_Syntax.p)))
end
| (_46_771, (e)::[]) -> begin
(aux p e)
end
...
| (vars, te) -> begin
(let _144_362 = (let _144_361 = (FStar_Absyn_Syntax.as_implicit i)
in ((te), (_144_361)))
in ((vars), (_144_362)))
end))
end))
...
| FStar_Absyn_Syntax.Pat_constant (c) -> begin
(let _144_365 = (FStar_All.pipe_right (FStar_Absyn_Syntax.mk_Exp_constant c) pkg)
in (([]), (_144_365)))
end
| (FStar_Absyn_Syntax.Pat_wild (x)) | (FStar_Absyn_Syntax.Pat_var (x)) -> begin
(let _144_368 = (FStar_All.pipe_right (FStar_Absyn_Syntax.mk_Exp_bvar x) pkg)
in (((FStar_Util.Inr (x))::[]), (_144_368)))
end
| FStar_Absyn_Syntax.Pat_cons (fv, q, pats) -> begin
(

let _46_809 = (let _144_369 = (FStar_All.pipe_right pats (FStar_List.map pat_as_arg))
in (FStar_All.pipe_right _144_369 FStar_List.unzip))
in (match (_46_809) with
| (vars, args) -> begin
(

let vars = (FStar_List.flatten vars)
in (let _144_375 = (let _144_374 = (let _144_373 = (let _144_372 = (FStar_Absyn_Syntax.mk_Exp_fvar ((fv), (q)) (Some (fv.FStar_Absyn_Syntax.sort)) fv.FStar_Absyn_Syntax.p)
in ((_144_372), (args)))
in (FStar_Absyn_Syntax.mk_Exp_app' _144_373))
in (FStar_All.pipe_right _144_374 pkg))
in ((vars), (_144_375))))
end))
end
...
(let _144_377 = (FStar_Absyn_Syntax.mk_Typ_btvar a (Some (a.FStar_Absyn_Syntax.sort)) p.FStar_Absyn_Syntax.p)
in (((FStar_Util.Inl (a))::[]), (_144_377)))
end
...
(let _144_385 = (FStar_Tc_Rel.new_tvar r vars FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _144_385 Prims.fst))
end
| FStar_Absyn_Syntax.Kind_arrow (bs, k) -> begin
(let _144_388 = (let _144_387 = (let _144_386 = (FStar_Tc_Rel.new_tvar r vars FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _144_386 Prims.fst))
in ((bs), (_144_387)))
in (FStar_Absyn_Syntax.mk_Typ_lam _144_388 (Some (k)) r))
end
| _46_891 -> begin
(FStar_All.failwith "Impossible")
end)
...
in (let _144_390 = (let _144_389 = (FStar_Absyn_Syntax.targ arg)
in (_144_389)::out)
in ((_144_390), (subst))))))
end)
end)) (([]), ([]))))
...
let k = (let _144_401 = (FStar_Tc_Rel.new_kvar e.FStar_Absyn_Syntax.pos scope)
in (FStar_All.pipe_right _144_401 Prims.fst))
in (((
...
let t = (let _144_406 = (FStar_Tc_Rel.new_tvar e.FStar_Absyn_Syntax.pos scope FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _144_406 Prims.fst))
...
(let _144_414 = (FStar_Range.string_of_range r)
in (let _144_413 = (FStar_Absyn_Print.typ_to_string t)
...
| _46_987 -> begin
(let _144_416 = (let _144_415 = (FStar_Tc_Rel.new_tvar r vars FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _144_415 Prims.fst))
in ((e), (_144_416), (false)))
end))
in (let _144_417 = (FStar_Tc_Env.t_binders env)
in (aux _144_417 e))))))
end
| _46_989 -> begin
((e), (t), (false))
...
| _46_1003 -> begin
(let _144_422 = (let _144_421 = (let _144_420 = (FStar_List.map FStar_Absyn_Print.arg_to_string c.FStar_Absyn_Syntax.effect_args)
in (FStar_All.pipe_right _144_420 (FStar_String.concat ", ")))
in (FStar_Util.format2 "Impossible: Got a computation %s with effect args [%s]" c.FStar_Absyn_Syntax.effect_name.FStar_Ident.str _144_421))
in (FStar_All.failwith _144_422))
end)
...
(let _144_444 = (let _144_443 = (let _144_439 = (lift c.FStar_Absyn_Syntax.result_typ wp)
in (FStar_Absyn_Syntax.targ _144_439))
in (let _144_442 = (let _144_441 = (let _144_440 = (lift c.FStar_Absyn_Syntax.result_typ wlp)
in (FStar_Absyn_Syntax.targ _144_440))
in (_144_441)::[])
in (_144_443)::_144_442))
in {FStar_Absyn_Syntax.effect_name = m; FStar_Absyn_Syntax.result_typ = c.FStar_Absyn_Syntax.result_typ; FStar_Absyn_Syntax.effect_args = _144_444; FStar_Absyn_Syntax.flags = []})
end)))
...
let _46_1047 = (let _144_458 = (norm_eff_name env l1)
in (let _144_457 = (norm_eff_name env l2)
in (FStar_Tc_Env.join env _144_458 _144_457)))
...
| (a, kwp) -> begin
(let _144_472 = (destruct_comp m1)
in (let _144_471 = (destruct_comp m2)
in ((((md), (a), (kwp))), (_144_472), (_144_471))))
end)))))
end)))))
...
let mk_comp : FStar_Absyn_Syntax.eff_decl  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.cflags Prims.list  ->  FStar_Absyn_Syntax.comp = (fun md result wp wlp flags -> (let _144_495 = (let _144_494 = (let _144_493 = (FStar_Absyn_Syntax.targ wp)
in (let _144_492 = (let _144_491 = (FStar_Absyn_Syntax.targ wlp)
in (_144_491)::[])
in (_144_493)::_144_492))
in {FStar_Absyn_Syntax.effect_name = md.FStar_Absyn_Syntax.mname; FStar_Absyn_Syntax.result_typ = result; FStar_Absyn_Syntax.effect_args = _144_494; FStar_Absyn_Syntax.flags = flags})
in (FStar_Absyn_Syntax.mk_Comp _144_495)))
...
let _46_1082 = lc
in (let _144_505 = (FStar_Absyn_Util.subst_typ subst lc.FStar_Absyn_Syntax.res_typ)
in {FStar_Absyn_Syntax.eff_name = _46_1082.FStar_Absyn_Syntax.eff_name; FStar_Absyn_Syntax.res_typ = _144_505; FStar_Absyn_Syntax.cflags = _46_1082.FStar_Absyn_Syntax.cflags; FStar_Absyn_Syntax.comp = (fun _46_1084 -> (match (()) with
| () -> begin
(let _144_504 = (lc.FStar_Absyn_Syntax.comp ())
in (FStar_Absyn_Util.subst_comp subst _144_504))
end))})))


let is_function : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  Prims.bool = (fun t -> (match ((let _144_508 = (FStar_Absyn_Util.compress_typ t)
in _144_508.FStar_Absyn_Syntax.n)) with
...
let wp = (let _144_520 = (let _144_519 = (let _144_518 = (let _144_517 = (FStar_Absyn_Syntax.targ t)
in (let _144_516 = (let _144_515 = (FStar_Absyn_Syntax.varg v)
in (_144_515)::[])
in (_144_517)::_144_516))
in ((m.FStar_Absyn_Syntax.ret), (_144_518)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_519 (Some (k)) v.FStar_Absyn_Syntax.pos))
in (FStar_All.pipe_left (FStar_Tc_Normalize.norm_typ ((FStar_Tc_Normalize.Beta)::[]) env) _144_520))
in (
...
(let _144_523 = (FStar_Range.string_of_range v.FStar_Absyn_Syntax.pos)
in (let _144_522 = (FStar_Absyn_Print.exp_to_string v)
in (let _144_521 = (FStar_Tc_Normalize.comp_typ_norm_to_string env c)
in (FStar_Util.print3 "(%s) returning %s at comp type %s\n" _144_523 _144_522 _144_521))))
end else begin
()
end
in c)))
...
in (let _144_533 = (FStar_Absyn_Print.lcomp_typ_to_string lc1)
in (let _144_532 = (FStar_Absyn_Print.lcomp_typ_to_string lc2)
in (FStar_Util.print3 "Before lift: Making bind c1=%s\nb=%s\t\tc2=%s\n" _144_533 bstr _144_532))))
end else begin
()
end
in (
...
(let _144_541 = (FStar_Absyn_Util.subst_comp ((FStar_Util.Inr (((x), (e))))::[]) c2)
in (FStar_All.pipe_left (fun _144_540 -> Some (_144_540)) _144_541))
end else begin
(aux ())
end
end
...
in (let _144_544 = (FStar_Absyn_Print.comp_typ_to_string c1)
in (let _144_543 = (FStar_Absyn_Print.comp_typ_to_string c2)
in (let _144_542 = (FStar_Absyn_Print.comp_typ_to_string c)
...
let bs = (match (b) with
| None -> begin
(let _144_546 = (FStar_Absyn_Syntax.null_v_binder t1)
in (_144_546)::[])
end
| Some (FStar_Tc_Env.Binding_var (x, t1)) -> begin
(let _144_547 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t1))
in (_144_547)::[])
end
| Some (FStar_Tc_Env.Binding_lid (l, t1)) -> begin
(let _144_548 = (FStar_Absyn_Syntax.null_v_binder t1)
in (_144_548)::[])
end
| _46_1199 -> begin
...
let wp_args = (let _144_563 = (FStar_Absyn_Syntax.targ t1)
in (let _144_562 = (let _144_561 = (FStar_Absyn_Syntax.targ t2)
in (let _144_560 = (let _144_559 = (FStar_Absyn_Syntax.targ wp1)
in (let _144_558 = (let _144_557 = (FStar_Absyn_Syntax.targ wlp1)
in (let _144_556 = (let _144_555 = (let _144_551 = (mk_lam wp2)
in (FStar_Absyn_Syntax.targ _144_551))
in (let _144_554 = (let _144_553 = (let _144_552 = (mk_lam wlp2)
in (FStar_Absyn_Syntax.targ _144_552))
in (_144_553)::[])
in (_144_555)::_144_554))
in (_144_557)::_144_556))
in (_144_559)::_144_558))
in (_144_561)::_144_560))
in (_144_563)::_144_562))
in (

let wlp_args = (let _144_571 = (FStar_Absyn_Syntax.targ t1)
in (let _144_570 = (let _144_569 = (FStar_Absyn_Syntax.targ t2)
in (let _144_568 = (let _144_567 = (FStar_Absyn_Syntax.targ wlp1)
in (let _144_566 = (let _144_565 = (let _144_564 = (mk_lam wlp2)
in (FStar_Absyn_Syntax.targ _144_564))
in (_144_565)::[])
in (_144_567)::_144_566))
in (_144_569)::_144_568))
in (_144_571)::_144_570))
in (
...
in (let _144_572 = (join_lcomp env lc1 lc2)
in {FStar_Absyn_Syntax.eff_name = _144_572; FStar_Absyn_Syntax.res_typ = lc2.FStar_Absyn_Syntax.res_typ; FStar_Absyn_Syntax.cflags = []; FStar_Absyn_Syntax.comp = bind_it})))
end))
...
let wp = (let _144_587 = (let _144_586 = (let _144_585 = (FStar_Absyn_Syntax.targ t)
in (let _144_584 = (let _144_583 = (FStar_Absyn_Syntax.targ f)
in (_144_583)::[])
in (_144_585)::_144_584))
in ((mk_wp), (_144_586)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_587 (Some (k)) f.FStar_Absyn_Syntax.pos))
in (

let wlp = (let _144_592 = (let _144_591 = (let _144_590 = (FStar_Absyn_Syntax.targ t)
in (let _144_589 = (let _144_588 = (FStar_Absyn_Syntax.targ f)
in (_144_588)::[])
in (_144_590)::_144_589))
in ((mk_wlp), (_144_591)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_592 (Some (k)) f.FStar_Absyn_Syntax.pos))
...
(let _144_604 = (let _144_603 = (FStar_Tc_Env.get_range env)
in (FStar_All.pipe_left FStar_Range.string_of_range _144_603))
...
(let _144_607 = (FStar_Absyn_Print.comp_typ_to_string c)
in (let _144_606 = (let _144_605 = (FStar_Absyn_Syntax.mk_Comp c')
in (FStar_All.pipe_left FStar_Absyn_Print.comp_typ_to_string _144_605))
...
let wp = (let _144_610 = (let _144_609 = (let _144_608 = (FStar_Tc_Env.get_range env)
in ((wp), (Some (b)), (_144_608)))
in FStar_Absyn_Syntax.Meta_refresh_label (_144_609))
in (FStar_Absyn_Syntax.mk_Typ_meta _144_610))
in (

let wlp = (let _144_613 = (let _144_612 = (let _144_611 = (FStar_Tc_Env.get_range env)
in ((wlp), (Some (b)), (_144_611)))
in FStar_Absyn_Syntax.Meta_refresh_label (_144_612))
in (FStar_Absyn_Syntax.mk_Typ_meta _144_613))
in (let _144_618 = (

let _46_1244 = c'
in (let _144_617 = (let _144_616 = (FStar_Absyn_Syntax.targ wp)
in (let _144_615 = (let _144_614 = (FStar_Absyn_Syntax.targ wlp)
in (_144_614)::[])
in (_144_616)::_144_615))
in {FStar_Absyn_Syntax.effect_name = _46_1244.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = _46_1244.FStar_Absyn_Syntax.result_typ; FStar_Absyn_Syntax.effect_args = _144_617; FStar_Absyn_Syntax.flags = c'.FStar_Absyn_Syntax.flags}))
in (FStar_Absyn_Syntax.mk_Comp _144_618))))
end)))))
end)
end)
end))
...
| Some (reason) -> begin
if (let _144_642 = (FStar_Options.should_verify env.FStar_Tc_Env.curmodule.FStar_Ident.str)
in (FStar_All.pipe_left Prims.op_Negation _144_642)) then begin
f
end else begin
(let _144_643 = (reason ())
in (label _144_643 r f))
end
end))
...
(let _144_650 = (label reason r f)
in FStar_Tc_Rel.NonTrivial (_144_650))
end))
...
let wp = (let _144_669 = (let _144_668 = (let _144_667 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_666 = (let _144_665 = (FStar_Absyn_Syntax.targ f)
in (let _144_664 = (let _144_663 = (FStar_Absyn_Syntax.targ wp)
in (_144_663)::[])
in (_144_665)::_144_664))
in (_144_667)::_144_666))
in ((md.FStar_Absyn_Syntax.assume_p), (_144_668)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_669 None wp.FStar_Absyn_Syntax.pos))
in (

let wlp = (let _144_676 = (let _144_675 = (let _144_674 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_673 = (let _144_672 = (FStar_Absyn_Syntax.targ f)
in (let _144_671 = (let _144_670 = (FStar_Absyn_Syntax.targ wlp)
in (_144_670)::[])
in (_144_672)::_144_671))
in (_144_674)::_144_673))
in ((md.FStar_Absyn_Syntax.assume_p), (_144_675)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_676 None wlp.FStar_Absyn_Syntax.pos))
...
let xret = (let _144_698 = (FStar_Absyn_Util.bvar_to_exp x)
in (return_value env x.FStar_Absyn_Syntax.sort _144_698))
in (

let xbinding = FStar_Tc_Env.Binding_var (((x.FStar_Absyn_Syntax.v), (x.FStar_Absyn_Syntax.sort)))
in (

let lc = (let _144_701 = (lcomp_of_comp c)
in (let _144_700 = (let _144_699 = (lcomp_of_comp xret)
in ((Some (xbinding)), (_144_699)))
in (bind env (Some (e)) _144_701 _144_700)))
...
let wp = (let _144_710 = (let _144_709 = (let _144_708 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_707 = (let _144_706 = (let _144_703 = (let _144_702 = (FStar_Tc_Env.get_range env)
in (label_opt env reason _144_702 f))
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _144_703))
in (let _144_705 = (let _144_704 = (FStar_Absyn_Syntax.targ wp)
in (_144_704)::[])
in (_144_706)::_144_705))
in (_144_708)::_144_707))
in ((md.FStar_Absyn_Syntax.assert_p), (_144_709)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_710 None wp.FStar_Absyn_Syntax.pos))
in (

let wlp = (let _144_717 = (let _144_716 = (let _144_715 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_714 = (let _144_713 = (FStar_Absyn_Syntax.targ f)
in (let _144_712 = (let _144_711 = (FStar_Absyn_Syntax.targ wlp)
in (_144_711)::[])
in (_144_713)::_144_712))
in (_144_715)::_144_714))
in ((md.FStar_Absyn_Syntax.assume_p), (_144_716)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_717 None wlp.FStar_Absyn_Syntax.pos))
in (
...
let _46_1325 = lc
in (let _144_720 = (norm_eff_name env lc.FStar_Absyn_Syntax.eff_name)
in (let _144_719 = if ((FStar_Absyn_Util.is_pure_lcomp lc) && (let _144_718 = (FStar_Absyn_Util.is_function_typ lc.FStar_Absyn_Syntax.res_typ)
in (FStar_All.pipe_left Prims.op_Negation _144_718))) then begin
flags
end else begin
[]
end
in {FStar_Absyn_Syntax.eff_name = _144_720; FStar_Absyn_Syntax.res_typ = _46_1325.FStar_Absyn_Syntax.res_typ; FStar_Absyn_Syntax.cflags = _144_719; FStar_Absyn_Syntax.comp = strengthen})))
in ((_144_721), ((
...
let _46_1337 = (let _144_729 = (FStar_Absyn_Util.bvar_to_exp x)
in (let _144_728 = (FStar_Absyn_Util.bvar_to_exp y)
in ((_144_729), (_144_728))))
in (match (_46_1337) with
| (xexp, yexp) -> begin
(

let yret = (let _144_734 = (let _144_733 = (let _144_732 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_731 = (let _144_730 = (FStar_Absyn_Syntax.varg yexp)
in (_144_730)::[])
in (_144_732)::_144_731))
in ((md_pure.FStar_Absyn_Syntax.ret), (_144_733)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_734 None res_t.FStar_Absyn_Syntax.pos))
in (

let x_eq_y_yret = (let _144_742 = (let _144_741 = (let _144_740 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_739 = (let _144_738 = (let _144_735 = (FStar_Absyn_Util.mk_eq res_t res_t xexp yexp)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _144_735))
in (let _144_737 = (let _144_736 = (FStar_All.pipe_left FStar_Absyn_Syntax.targ yret)
in (_144_736)::[])
in (_144_738)::_144_737))
in (_144_740)::_144_739))
in ((md_pure.FStar_Absyn_Syntax.assume_p), (_144_741)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_742 None res_t.FStar_Absyn_Syntax.pos))
in (

let forall_y_x_eq_y_yret = (let _144_753 = (let _144_752 = (let _144_751 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_750 = (let _144_749 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_748 = (let _144_747 = (let _144_746 = (let _144_745 = (let _144_744 = (let _144_743 = (FStar_Absyn_Syntax.v_binder y)
in (_144_743)::[])
in ((_144_744), (x_eq_y_yret)))
in (FStar_Absyn_Syntax.mk_Typ_lam _144_745 None res_t.FStar_Absyn_Syntax.pos))
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _144_746))
in (_144_747)::[])
in (_144_749)::_144_748))
in (_144_751)::_144_750))
in ((md_pure.FStar_Absyn_Syntax.close_wp), (_144_752)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_753 None res_t.FStar_Absyn_Syntax.pos))
in (

let lc2 = (mk_comp md_pure res_t forall_y_x_eq_y_yret forall_y_x_eq_y_yret ((FStar_Absyn_Syntax.RETURN)::[]))
in (

let lc = (let _144_756 = (lcomp_of_comp comp)
in (let _144_755 = (let _144_754 = (lcomp_of_comp lc2)
in ((Some (FStar_Tc_Env.Binding_var (((x.FStar_Absyn_Syntax.v), (x.FStar_Absyn_Syntax.sort))))), (_144_754)))
in (bind env None _144_756 _144_755)))
in (lc.FStar_Absyn_Syntax.comp ()))))))
end))))))
...
let _46_1364 = (let _144_768 = (lcomp_then.FStar_Absyn_Syntax.comp ())
in (let _144_767 = (lcomp_else.FStar_Absyn_Syntax.comp ())
in (lift_and_destruct env _144_768 _144_767)))
in (match (_46_1364) with
| ((md, _46_1351, _46_1353), (res_t, wp_then, wlp_then), (_46_1360, wp_else, wlp_else)) -> begin
(

let ifthenelse = (fun md res_t g wp_t wp_e -> (let _144_788 = (let _144_786 = (let _144_785 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_784 = (let _144_783 = (FStar_Absyn_Syntax.targ g)
in (let _144_782 = (let _144_781 = (FStar_Absyn_Syntax.targ wp_t)
in (let _144_780 = (let _144_779 = (FStar_Absyn_Syntax.targ wp_e)
in (_144_779)::[])
in (_144_781)::_144_780))
in (_144_783)::_144_782))
in (_144_785)::_144_784))
in ((md.FStar_Absyn_Syntax.if_then_else), (_144_786)))
in (let _144_787 = (FStar_Range.union_ranges wp_t.FStar_Absyn_Syntax.pos wp_e.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _144_788 None _144_787))))
in (
...
let wp = (let _144_795 = (let _144_794 = (let _144_793 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_792 = (let _144_791 = (FStar_Absyn_Syntax.targ wlp)
in (let _144_790 = (let _144_789 = (FStar_Absyn_Syntax.targ wp)
in (_144_789)::[])
in (_144_791)::_144_790))
in (_144_793)::_144_792))
in ((md.FStar_Absyn_Syntax.ite_wp), (_144_794)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_795 None wp.FStar_Absyn_Syntax.pos))
in (

let wlp = (let _144_800 = (let _144_799 = (let _144_798 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_797 = (let _144_796 = (FStar_Absyn_Syntax.targ wlp)
in (_144_796)::[])
in (_144_798)::_144_797))
in ((md.FStar_Absyn_Syntax.ite_wlp), (_144_799)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_800 None wlp.FStar_Absyn_Syntax.pos))
in (mk_comp md res_t wp wlp [])))
end)))
end))
end))
in (let _144_801 = (join_effects env lcomp_then.FStar_Absyn_Syntax.eff_name lcomp_else.FStar_Absyn_Syntax.eff_name)
in {FStar_Absyn_Syntax.eff_name = _144_801; FStar_Absyn_Syntax.res_typ = lcomp_then.FStar_Absyn_Syntax.res_typ; FStar_Absyn_Syntax.cflags = []; FStar_Absyn_Syntax.comp = comp})))
...
let ifthenelse = (fun md res_t g wp_t wp_e -> (let _144_831 = (let _144_829 = (let _144_828 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_827 = (let _144_826 = (FStar_Absyn_Syntax.targ g)
in (let _144_825 = (let _144_824 = (FStar_Absyn_Syntax.targ wp_t)
in (let _144_823 = (let _144_822 = (FStar_Absyn_Syntax.targ wp_e)
in (_144_822)::[])
in (_144_824)::_144_823))
in (_144_826)::_144_825))
in (_144_828)::_144_827))
in ((md.FStar_Absyn_Syntax.if_then_else), (_144_829)))
in (let _144_830 = (FStar_Range.union_ranges wp_t.FStar_Absyn_Syntax.pos wp_e.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _144_831 None _144_830))))
in (

let default_case = (

let post_k = (let _144_834 = (let _144_833 = (let _144_832 = (FStar_Absyn_Syntax.null_v_binder res_t)
in (_144_832)::[])
in ((_144_833), (FStar_Absyn_Syntax.ktype)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _144_834 res_t.FStar_Absyn_Syntax.pos))
in (

let kwp = (let _144_837 = (let _144_836 = (let _144_835 = (FStar_Absyn_Syntax.null_t_binder post_k)
in (_144_835)::[])
in ((_144_836), (FStar_Absyn_Syntax.ktype)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _144_837 res_t.FStar_Absyn_Syntax.pos))
in (

let post = (let _144_838 = (FStar_Absyn_Util.new_bvd None)
in (FStar_Absyn_Util.bvd_to_bvar_s _144_838 post_k))
in (

let wp = (let _144_845 = (let _144_844 = (let _144_839 = (FStar_Absyn_Syntax.t_binder post)
in (_144_839)::[])
in (let _144_843 = (let _144_842 = (let _144_840 = (FStar_Tc_Env.get_range env)
in (label FStar_Tc_Errors.exhaustiveness_check _144_840))
in (let _144_841 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.false_lid FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_left _144_842 _144_841)))
in ((_144_844), (_144_843))))
in (FStar_Absyn_Syntax.mk_Typ_lam _144_845 (Some (kwp)) res_t.FStar_Absyn_Syntax.pos))
in (

let wlp = (let _144_849 = (let _144_848 = (let _144_846 = (FStar_Absyn_Syntax.t_binder post)
in (_144_846)::[])
in (let _144_847 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.true_lid FStar_Absyn_Syntax.ktype)
in ((_144_848), (_144_847))))
in (FStar_Absyn_Syntax.mk_Typ_lam _144_849 (Some (kwp)) res_t.FStar_Absyn_Syntax.pos))
in (
...
let _46_1424 = (let _144_852 = (cthen.FStar_Absyn_Syntax.comp ())
in (lift_and_destruct env _144_852 celse))
in (match (_46_1424) with
| ((md, _46_1410, _46_1412), (_46_1415, wp_then, wlp_then), (_46_1420, wp_else, wlp_else)) -> begin
(let _144_854 = (ifthenelse md res_t g wp_then wp_else)
in (let _144_853 = (ifthenelse md res_t g wlp_then wlp_else)
in (mk_comp md res_t _144_854 _144_853 [])))
end))
...
let wp = (let _144_861 = (let _144_860 = (let _144_859 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_858 = (let _144_857 = (FStar_Absyn_Syntax.targ wlp)
in (let _144_856 = (let _144_855 = (FStar_Absyn_Syntax.targ wp)
in (_144_855)::[])
in (_144_857)::_144_856))
in (_144_859)::_144_858))
in ((md.FStar_Absyn_Syntax.ite_wp), (_144_860)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_861 None wp.FStar_Absyn_Syntax.pos))
in (

let wlp = (let _144_866 = (let _144_865 = (let _144_864 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_863 = (let _144_862 = (FStar_Absyn_Syntax.targ wlp)
in (_144_862)::[])
in (_144_864)::_144_863))
in ((md.FStar_Absyn_Syntax.ite_wlp), (_144_865)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_866 None wlp.FStar_Absyn_Syntax.pos))
in (mk_comp md res_t wp wlp [])))
end))))
end)))
end))
...
let bs = (let _144_885 = (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_144_885)::[])
in (

let wp = (FStar_Absyn_Syntax.mk_Typ_lam ((bs), (wp)) None wp.FStar_Absyn_Syntax.pos)
in (let _144_892 = (let _144_891 = (let _144_890 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_889 = (let _144_888 = (FStar_Absyn_Syntax.targ t)
in (let _144_887 = (let _144_886 = (FStar_Absyn_Syntax.targ wp)
in (_144_886)::[])
in (_144_888)::_144_887))
in (_144_890)::_144_889))
in ((md.FStar_Absyn_Syntax.close_wp), (_144_891)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_892 None wp0.FStar_Absyn_Syntax.pos))))
end
| FStar_Tc_Env.Binding_typ (a, k) -> begin
(

let bs = (let _144_893 = (FStar_All.pipe_left FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_144_893)::[])
in (

let wp = (FStar_Absyn_Syntax.mk_Typ_lam ((bs), (wp)) None wp.FStar_Absyn_Syntax.pos)
in (let _144_898 = (let _144_897 = (let _144_896 = (FStar_Absyn_Syntax.targ res_t)
in (let _144_895 = (let _144_894 = (FStar_Absyn_Syntax.targ wp)
in (_144_894)::[])
in (_144_896)::_144_895))
in ((md.FStar_Absyn_Syntax.close_wp_t), (_144_897)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_898 None wp0.FStar_Absyn_Syntax.pos))))
end
...
let ret = (let _144_907 = (return_value env t xexp)
in (FStar_All.pipe_left lcomp_of_comp _144_907))
in (

let eq_ret = (let _144_909 = (let _144_908 = (FStar_Absyn_Util.mk_eq t t xexp e)
in FStar_Tc_Rel.NonTrivial (_144_908))
in (weaken_precondition env ret _144_909))
in (let _144_912 = (let _144_911 = (let _144_910 = (lcomp_of_comp c)
in (bind env None _144_910 ((Some (FStar_Tc_Env.Binding_var (((x), (t))))), (eq_ret))))
in (_144_911.FStar_Absyn_Syntax.comp ()))
in (FStar_Absyn_Util.comp_set_flags _144_912 ((FStar_Absyn_Syntax.PARTIAL_RETURN)::(FStar_Absyn_Util.comp_flags c)))))))))))
end
end)
end))
in (
...
| None -> begin
(let _144_924 = (let _144_923 = (let _144_922 = (FStar_Tc_Errors.computed_computation_type_does_not_match_annotation env e c c')
in (let _144_921 = (FStar_Tc_Env.get_range env)
in ((_144_922), (_144_921))))
in FStar_Absyn_Syntax.Error (_144_923))
in (Prims.raise _144_924))
end
| Some (g) -> begin
((e), (c'), (g))
end))
...
(let _144_938 = (let _144_937 = (let _144_936 = (FStar_All.pipe_left (fun _144_935 -> Some (_144_935)) (FStar_Absyn_Syntax.Implicit (false)))
in ((FStar_Util.Inl (t)), (_144_936)))
in (_144_937)::args)
in ((_144_938), (bs), (subst), ((FStar_Util.Inl (u))::us)))
end)))
end)))
end
...
| (args, bs, subst, us) -> begin
(let _144_942 = (let _144_941 = (let _144_940 = (FStar_All.pipe_left (fun _144_939 -> Some (_144_939)) (FStar_Absyn_Syntax.Implicit (false)))
in ((FStar_Util.Inr (v)), (_144_940)))
in (_144_941)::args)
in ((_144_942), (bs), (subst), ((FStar_Util.Inr (u))::us)))
end)))
end)))
end
| bs -> begin
...
in (let _144_943 = (FStar_Absyn_Syntax.mk_Typ_app' ((t), (args)) (Some (k)) t.FStar_Absyn_Syntax.pos)
in ((_144_943), (k), (implicits)))))
end)))
end
| _46_1557 -> begin
((t), (k), ([]))
...
| (args, bs, subst, us) -> begin
(let _144_957 = (let _144_956 = (let _144_955 = (FStar_All.pipe_left (fun _144_954 -> Some (_144_954)) (FStar_Absyn_Syntax.Implicit (false)))
in ((FStar_Util.Inl (t)), (_144_955)))
in (_144_956)::args)
in ((_144_957), (bs), (subst), ((FStar_Util.Inl (u))::us)))
end)))
end)))
end
...
| (args, bs, subst, us) -> begin
(let _144_961 = (let _144_960 = (let _144_959 = (FStar_All.pipe_left (fun _144_958 -> Some (_144_958)) (FStar_Absyn_Syntax.Implicit (false)))
in ((FStar_Util.Inr (v)), (_144_959)))
in (_144_960)::args)
in ((_144_961), (bs), (subst), ((FStar_Util.Inr (u))::us)))
end)))
end)))
end
| bs -> begin
...
in (let _144_968 = (mk_exp_app e args (Some (t)))
in ((_144_968), (t), (implicits))))
end else begin
((e), (t), ([]))
end
end
...
let t = (let _144_969 = (FStar_Absyn_Syntax.mk_Typ_fun ((bs), (c)) (Some (FStar_Absyn_Syntax.ktype)) e.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _144_969 (FStar_Absyn_Util.subst_typ subst)))
in (let _144_970 = (mk_exp_app e args (Some (t)))
in ((_144_970), (t), (implicits))))
end))
end)))
end
| _46_1624 -> begin
...
(let _144_979 = (FStar_Tc_Rel.try_teq env lc.FStar_Absyn_Syntax.res_typ t)
in ((_144_979), (false)))
end else begin
(let _144_980 = (FStar_Tc_Rel.try_subtype env lc.FStar_Absyn_Syntax.res_typ t)
in ((_144_980), (true)))
end
in (match (gopt) with
| (None, _46_1632) -> begin
...
(let _144_984 = (FStar_Tc_Normalize.comp_typ_norm_to_string env c)
in (let _144_983 = (FStar_Tc_Normalize.typ_norm_to_string env f)
...
let wp = (let _144_989 = (let _144_988 = (let _144_987 = (FStar_Absyn_Syntax.targ t)
in (let _144_986 = (let _144_985 = (FStar_Absyn_Syntax.varg xexp)
in (_144_985)::[])
in (_144_987)::_144_986))
in ((md.FStar_Absyn_Syntax.ret), (_144_988)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_989 (Some (k)) xexp.FStar_Absyn_Syntax.pos))
in (

let cret = (let _144_990 = (mk_comp md t wp wp ((FStar_Absyn_Syntax.RETURN)::[]))
in (FStar_All.pipe_left lcomp_of_comp _144_990))
in (

let guard = if apply_guard then begin
(let _144_993 = (let _144_992 = (let _144_991 = (FStar_Absyn_Syntax.varg xexp)
in (_144_991)::[])
in ((f), (_144_992)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_993 (Some (FStar_Absyn_Syntax.ktype)) f.FStar_Absyn_Syntax.pos))
end else begin
f
end
in (

let _46_1666 = (let _144_1001 = (FStar_All.pipe_left (fun _144_998 -> Some (_144_998)) (FStar_Tc_Errors.subtyping_failed env lc.FStar_Absyn_Syntax.res_typ t))
in (let _144_1000 = (FStar_Tc_Env.set_range env e.FStar_Absyn_Syntax.pos)
in (let _144_999 = (FStar_All.pipe_left FStar_Tc_Rel.guard_of_guard_formula (FStar_Tc_Rel.NonTrivial (guard)))
in (strengthen_precondition _144_1001 _144_1000 e cret _144_999))))
in (match (_46_1666) with
| (eq_ret, _trivial_so_ok_to_discard) -> begin
(

let c = (let _144_1003 = (let _144_1002 = (FStar_Absyn_Syntax.mk_Comp ct)
in (FStar_All.pipe_left lcomp_of_comp _144_1002))
in (bind env (Some (e)) _144_1003 ((Some (FStar_Tc_Env.Binding_var (((x), (lc.FStar_Absyn_Syntax.res_typ))))), (eq_ret))))
in (
...
(let _144_1004 = (FStar_Tc_Normalize.comp_typ_norm_to_string env c)
...
let _46_1677 = lc
in (let _144_1006 = (norm_eff_name env lc.FStar_Absyn_Syntax.eff_name)
in {FStar_Absyn_Syntax.eff_name = _144_1006; FStar_Absyn_Syntax.res_typ = t; FStar_Absyn_Syntax.cflags = flags; FStar_Absyn_Syntax.comp = strengthen}))
in ((e), (lc), (g))))))
end))
end)))
...
let ue = (let _144_1011 = (FStar_Util.set_elements uvt.FStar_Absyn_Syntax.uvars_e)
in (FStar_List.map FStar_Absyn_Print.uvar_e_to_string _144_1011))
in (

let ut = (let _144_1012 = (FStar_Util.set_elements uvt.FStar_Absyn_Syntax.uvars_t)
in (FStar_List.map FStar_Absyn_Print.uvar_t_to_string _144_1012))
in (

let uk = (let _144_1013 = (FStar_Util.set_elements uvt.FStar_Absyn_Syntax.uvars_k)
in (FStar_List.map FStar_Absyn_Print.uvar_k_to_string _144_1013))
in (
...
let _46_1695 = (let _144_1015 = (let _144_1014 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format2 "Unconstrained unification variables %s in type signature %s; please add an annotation" union _144_1014))
in (FStar_Tc_Errors.report r _144_1015))
...
let gen : Prims.bool  ->  FStar_Tc_Env.env  ->  (FStar_Absyn_Syntax.exp * FStar_Absyn_Syntax.comp) Prims.list  ->  (FStar_Absyn_Syntax.exp * FStar_Absyn_Syntax.comp) Prims.list Prims.option = (fun verify env ecs -> if (let _144_1023 = (FStar_Util.for_all (fun _46_1703 -> (match (_46_1703) with
| (_46_1701, c) -> begin
(FStar_Absyn_Util.is_pure_comp c)
end)) ecs)
in (FStar_All.pipe_left Prims.op_Negation _144_1023)) then begin
None
end else begin
(
...
(let _144_1026 = (FStar_Absyn_Print.comp_typ_to_string c)
...
(let _144_1027 = (FStar_Absyn_Print.comp_typ_to_string c)
...
let gen_uvars = (fun uvs -> (let _144_1030 = (FStar_Util.set_difference uvs env_uvars.FStar_Absyn_Syntax.uvars_t)
in (FStar_All.pipe_right _144_1030 FStar_Util.set_elements)))
in (
...
in if (let _144_1035 = (should_gen t)
in (FStar_All.pipe_left Prims.op_Negation _144_1035)) then begin
(([]), (e), (c))
end else begin
(
...
let _46_1751 = if (((FStar_Options.should_verify env.FStar_Tc_Env.curmodule.FStar_Ident.str) && verify) && (let _144_1036 = (FStar_Absyn_Util.is_total_comp c)
in (FStar_All.pipe_left Prims.op_Negation _144_1036))) then begin
(
...
let binder = (let _144_1037 = (FStar_Absyn_Syntax.null_v_binder t)
in (_144_1037)::[])
in (

let post = (let _144_1041 = (let _144_1038 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.true_lid FStar_Absyn_Syntax.ktype)
in ((binder), (_144_1038)))
in (let _144_1040 = (let _144_1039 = (FStar_Absyn_Syntax.mk_Kind_arrow ((binder), (FStar_Absyn_Syntax.ktype)) t.FStar_Absyn_Syntax.pos)
in Some (_144_1039))
in (FStar_Absyn_Syntax.mk_Typ_lam _144_1041 _144_1040 t.FStar_Absyn_Syntax.pos)))
in (

let vc = (let _144_1048 = (let _144_1047 = (let _144_1046 = (let _144_1045 = (let _144_1044 = (FStar_Absyn_Syntax.targ post)
in (_144_1044)::[])
in ((wp), (_144_1045)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_1046))
in (FStar_All.pipe_left (FStar_Absyn_Syntax.syn wp.FStar_Absyn_Syntax.pos (Some (FStar_Absyn_Syntax.ktype))) _144_1047))
in (FStar_Tc_Normalize.norm_typ ((FStar_Tc_Normalize.Delta)::(FStar_Tc_Normalize.Beta)::[]) env _144_1048))
in (let _144_1049 = (FStar_All.pipe_left FStar_Tc_Rel.guard_of_guard_formula (FStar_Tc_Rel.NonTrivial (vc)))
in (discharge_guard env _144_1049)))))
end))
end else begin
()
end
...
let a = (let _144_1054 = (let _144_1053 = (FStar_Tc_Env.get_range env)
in (FStar_All.pipe_left (fun _144_1052 -> Some (_144_1052)) _144_1053))
in (FStar_Absyn_Util.new_bvd _144_1054))
in (

let t = (let _144_1055 = (FStar_Absyn_Util.bvd_to_typ a FStar_Absyn_Syntax.ktype)
in (FStar_Absyn_Util.close_for_kind _144_1055 k))
in (

let _46_1804 = (FStar_Absyn_Util.unchecked_unify u t)
in (FStar_Absyn_Util.bvd_to_bvar_s a FStar_Absyn_Syntax.ktype))))
end)
in (let _144_1057 = (FStar_All.pipe_left (fun _144_1056 -> Some (_144_1056)) (FStar_Absyn_Syntax.Implicit (false)))
in ((FStar_Util.Inl (a)), (_144_1057))))
end))))
in (
...
in (let _144_1058 = (FStar_Absyn_Syntax.mk_Total t)
in ((e), (_144_1058))))))
end))))
in Some (ecs)))))))
end)
...
(let _144_1067 = (let _144_1066 = (FStar_List.map (fun _46_1830 -> (match (_46_1830) with
| (lb, _46_1827, _46_1829) -> begin
(FStar_Absyn_Print.lbname_to_string lb)
end)) lecs)
in (FStar_All.pipe_right _144_1066 (FStar_String.concat ", ")))
in (FStar_Util.print1 "Generalizing: %s" _144_1067))
end else begin
()
end
in (match ((let _144_1069 = (FStar_All.pipe_right lecs (FStar_List.map (fun _46_1837 -> (match (_46_1837) with
| (_46_1834, e, c) -> begin
((e), (c))
end))))
in (gen verify env _144_1069))) with
| None -> begin
lecs
end
| Some (ecs) -> begin
...
(let _144_1074 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _144_1073 = (FStar_Absyn_Print.lbname_to_string l)
in (let _144_1072 = (FStar_Absyn_Print.typ_to_string (FStar_Absyn_Util.comp_result c))
in (FStar_Util.print3 "(%s) Generalized %s to %s" _144_1074 _144_1073 _144_1072))))
end else begin
()
end
in ((l), (e), (c)))
...
(let _144_1089 = (discharge g)
in (let _144_1088 = (lc.FStar_Absyn_Syntax.comp ())
in ((_144_1089), (_144_1088))))
end else begin
(
...
let c = (let _144_1090 = (FStar_Tc_Normalize.norm_comp steps env c)
in (FStar_All.pipe_right _144_1090 FStar_Absyn_Util.comp_to_comp_typ))
in (
...
let vc = (let _144_1096 = (let _144_1094 = (let _144_1093 = (FStar_Absyn_Syntax.targ t)
in (let _144_1092 = (let _144_1091 = (FStar_Absyn_Syntax.targ wp)
in (_144_1091)::[])
in (_144_1093)::_144_1092))
in ((md.FStar_Absyn_Syntax.trivial), (_144_1094)))
in (let _144_1095 = (FStar_Tc_Env.get_range env)
in (FStar_Absyn_Syntax.mk_Typ_app _144_1096 (Some (FStar_Absyn_Syntax.ktype)) _144_1095)))
in (

let g = (let _144_1097 = (FStar_All.pipe_left FStar_Tc_Rel.guard_of_guard_formula (FStar_Tc_Rel.NonTrivial (vc)))
in (FStar_Tc_Rel.conj_guard g _144_1097))
in (let _144_1099 = (discharge g)
in (let _144_1098 = (FStar_Absyn_Syntax.mk_Comp c)
in ((_144_1099), (_144_1098))))))
end))))))
end)))
...
(let _144_1118 = (f fst)
in (FStar_All.pipe_right _144_1118 (fun _144_1117 -> Some (_144_1117))))
end
| _46_1908 -> begin
...
let op_and_e = (fun e -> (let _144_1124 = (FStar_Absyn_Util.b2t e)
in ((_144_1124), (FStar_Absyn_Const.exp_false_bool))))
in (

let op_or_e = (fun e -> (let _144_1128 = (let _144_1127 = (FStar_Absyn_Util.b2t e)
in (FStar_Absyn_Util.mk_neg _144_1127))
in ((_144_1128), (FStar_Absyn_Const.exp_true_bool))))
...
let op_and_t = (fun t -> (let _144_1167 = (unlabel t)
in (FStar_All.pipe_right _144_1167 (fun _144_1166 -> FStar_Tc_Rel.NonTrivial (_144_1166)))))
in (

let op_or_t = (fun t -> (let _144_1172 = (let _144_1170 = (unlabel t)
in (FStar_All.pipe_right _144_1170 FStar_Absyn_Util.mk_neg))
in (FStar_All.pipe_right _144_1172 (fun _144_1171 -> FStar_Tc_Rel.NonTrivial (_144_1171)))))
in (

let op_imp_t = (fun t -> (let _144_1176 = (unlabel t)
in (FStar_All.pipe_right _144_1176 (fun _144_1175 -> FStar_Tc_Rel.NonTrivial (_144_1175)))))
in (
...
(let _144_1180 = (FStar_Absyn_Util.mk_neg guard)
in (FStar_All.pipe_right _144_1180 (fun _144_1179 -> FStar_Tc_Rel.NonTrivial (_144_1179))))
end
| _46_1964 -> begin
...
let x = (FStar_Absyn_Util.gen_bvar res_t)
in (let _144_1221 = (let _144_1220 = (let _144_1219 = (let _144_1218 = (let _144_1217 = (let _144_1216 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_Absyn_Syntax.varg _144_1216))
in (_144_1217)::[])
in ((ens), (_144_1218)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_1219 (Some (FStar_Absyn_Syntax.mk_Kind_type)) res_t.FStar_Absyn_Syntax.pos))
in ((x), (_144_1220)))
in (FStar_Absyn_Syntax.mk_Typ_refine _144_1221 (Some (FStar_Absyn_Syntax.mk_Kind_type)) res_t.FStar_Absyn_Syntax.pos))))
in (
...
(let _144_1227 = (let _144_1224 = (norm req)
in Some (_144_1224))
in (let _144_1226 = (let _144_1225 = (mk_post_type ct.FStar_Absyn_Syntax.result_typ ens)
in (FStar_All.pipe_left norm _144_1225))
in ((_144_1227), (_144_1226))))
end
| _46_2024 -> begin
(FStar_All.failwith "Impossible")
end)
...
let _46_2054 = (match ((let _144_1229 = (FStar_Tc_Env.lookup_typ_abbrev env FStar_Absyn_Const.as_requires)
in (let _144_1228 = (FStar_Tc_Env.lookup_typ_abbrev env FStar_Absyn_Const.as_ensures)
in ((_144_1229), (_144_1228))))) with
| (Some (x), Some (y)) -> begin
((x), (y))
end
| _46_2051 -> begin
...
let req = (let _144_1236 = (let _144_1235 = (let _144_1234 = (let _144_1231 = (FStar_All.pipe_left (fun _144_1230 -> Some (_144_1230)) (FStar_Absyn_Syntax.Implicit (false)))
in ((FStar_Util.Inl (ct.FStar_Absyn_Syntax.result_typ)), (_144_1231)))
in (let _144_1233 = (let _144_1232 = (FStar_Absyn_Syntax.targ wp)
in (_144_1232)::[])
in (_144_1234)::_144_1233))
in ((as_req), (_144_1235)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_1236 (Some (FStar_Absyn_Syntax.mk_Kind_type)) ct.FStar_Absyn_Syntax.result_typ.FStar_Absyn_Syntax.pos))
in (

let ens = (let _144_1243 = (let _144_1242 = (let _144_1241 = (let _144_1238 = (FStar_All.pipe_left (fun _144_1237 -> Some (_144_1237)) (FStar_Absyn_Syntax.Implicit (false)))
in ((FStar_Util.Inl (ct.FStar_Absyn_Syntax.result_typ)), (_144_1238)))
in (let _144_1240 = (let _144_1239 = (FStar_Absyn_Syntax.targ wlp)
in (_144_1239)::[])
in (_144_1241)::_144_1240))
in ((as_ens), (_144_1242)))
in (FStar_Absyn_Syntax.mk_Typ_app _144_1243 None ct.FStar_Absyn_Syntax.result_typ.FStar_Absyn_Syntax.pos))
in (let _144_1247 = (let _144_1244 = (norm req)
in Some (_144_1244))
in (let _144_1246 = (let _144_1245 = (mk_post_type ct.FStar_Absyn_Syntax.result_typ ens)
in (norm _144_1245))
in ((_144_1247), (_144_1246))))))
end))
end
| _46_2058 -> begin
(FStar_All.failwith "Impossible")
