...
let (goal_env : goal -> FStar_TypeChecker_Env.env) =
  fun g  ->
    let uu___244_62 = g.goal_main_env  in
    {
      ...
      FStar_TypeChecker_Env.nbe = (uu___244_62.FStar_TypeChecker_Env.nbe)
    }
  ...
  fun subst1  ->
    fun ps  ->
      ...
      then ps
        ...
        (let uu___251_692 = ps  in
         let uu____693 = subst_goal subst1 ps.main_goal  in
         let uu____694 = FStar_List.map (subst_goal subst1) ps.goals  in
         {
           main_context = (uu___251_692.main_context);
           main_goal = uu____693;
           all_implicits = (uu___251_692.all_implicits);
           goals = uu____694;
           smt_goals = (uu___251_692.smt_goals);
           depth = (uu___251_692.depth);
           __dump = (uu___251_692.__dump);
           psc = (uu___251_692.psc);
           entry_range = (uu___251_692.entry_range);
           guard_policy = (uu___251_692.guard_policy);
           freshness = (uu___251_692.freshness);
           tac_verb_dbg = (uu___251_692.tac_verb_dbg);
           local_state = (uu___251_692.local_state)
         })
  
let (decr_depth : proofstate -> proofstate) =
  fun ps  ->
    let uu___252_702 = ps  in
    {
      main_context = (uu___252_702.main_context);
      main_goal = (uu___252_702.main_goal);
      all_implicits = (uu___252_702.all_implicits);
      goals = (uu___252_702.goals);
      smt_goals = (uu___252_702.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___252_702.__dump);
      psc = (uu___252_702.psc);
      entry_range = (uu___252_702.entry_range);
      guard_policy = (uu___252_702.guard_policy);
      freshness = (uu___252_702.freshness);
      tac_verb_dbg = (uu___252_702.tac_verb_dbg);
      local_state = (uu___252_702.local_state)
    }
  
let (incr_depth : proofstate -> proofstate) =
  fun ps  ->
    let uu___253_708 = ps  in
    {
      main_context = (uu___253_708.main_context);
      main_goal = (uu___253_708.main_goal);
      all_implicits = (uu___253_708.all_implicits);
      goals = (uu___253_708.goals);
      smt_goals = (uu___253_708.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___253_708.__dump);
      psc = (uu___253_708.psc);
      entry_range = (uu___253_708.entry_range);
      guard_policy = (uu___253_708.guard_policy);
      freshness = (uu___253_708.freshness);
      tac_verb_dbg = (uu___253_708.tac_verb_dbg);
      local_state = (uu___253_708.local_state)
    }
...
let (set_ps_psc : FStar_TypeChecker_Cfg.psc -> proofstate -> proofstate) =
  fun psc  ->
    fun ps  ->
      let uu___254_730 = ps  in
      {
        main_context = (uu___254_730.main_context);
        main_goal = (uu___254_730.main_goal);
        all_implicits = (uu___254_730.all_implicits);
        goals = (uu___254_730.goals);
        smt_goals = (uu___254_730.smt_goals);
        depth = (uu___254_730.depth);
        __dump = (uu___254_730.__dump);
        psc;
        entry_range = (uu___254_730.entry_range);
        guard_policy = (uu___254_730.guard_policy);
        freshness = (uu___254_730.freshness);
        tac_verb_dbg = (uu___254_730.tac_verb_dbg);
        local_state = (uu___254_730.local_state)
      }
  
let (set_proofstate_range : proofstate -> FStar_Range.range -> proofstate) =
  fun ps  ->
    fun r  ->
      let uu___255_741 = ps  in
      let uu____742 =
        let uu____743 = FStar_Range.def_range r  in
        FStar_Range.set_def_range ps.entry_range uu____743  in
      {
        main_context = (uu___255_741.main_context);
        main_goal = (uu___255_741.main_goal);
        all_implicits = (uu___255_741.all_implicits);
        goals = (uu___255_741.goals);
        smt_goals = (uu___255_741.smt_goals);
        depth = (uu___255_741.depth);
        __dump = (uu___255_741.__dump);
        psc = (uu___255_741.psc);
        entry_range = uu____742;
        guard_policy = (uu___255_741.guard_policy);
        freshness = (uu___255_741.freshness);
        tac_verb_dbg = (uu___255_741.tac_verb_dbg);
        local_state = (uu___255_741.local_state)
      }
