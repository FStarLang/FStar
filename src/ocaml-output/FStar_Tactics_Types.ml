...
let decr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___88_261 = ps in
    {
      main_context = (uu___88_261.main_context);
      main_goal = (uu___88_261.main_goal);
      all_implicits = (uu___88_261.all_implicits);
      goals = (uu___88_261.goals);
      smt_goals = (uu___88_261.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___88_261.__dump)
    }
let incr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___89_266 = ps in
    {
      main_context = (uu___89_266.main_context);
      main_goal = (uu___89_266.main_goal);
      all_implicits = (uu___89_266.all_implicits);
      goals = (uu___89_266.goals);
      smt_goals = (uu___89_266.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___89_266.__dump)
    }
