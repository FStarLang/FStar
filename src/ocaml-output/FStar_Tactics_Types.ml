...
let (goal_env : goal -> FStar_TypeChecker_Env.env) =
  fun g  ->
    let uu___257_102 = g.goal_main_env  in
    {
      FStar_TypeChecker_Env.solver =
        (uu___257_102.FStar_TypeChecker_Env.solver);
      FStar_TypeChecker_Env.range =
        (uu___257_102.FStar_TypeChecker_Env.range);
      FStar_TypeChecker_Env.curmodule =
        (uu___257_102.FStar_TypeChecker_Env.curmodule);
      FStar_TypeChecker_Env.gamma =
        ((g.goal_ctx_uvar).FStar_Syntax_Syntax.ctx_uvar_gamma);
      FStar_TypeChecker_Env.gamma_sig =
        (uu___257_102.FStar_TypeChecker_Env.gamma_sig);
      FStar_TypeChecker_Env.gamma_cache =
        (uu___257_102.FStar_TypeChecker_Env.gamma_cache);
      FStar_TypeChecker_Env.modules =
        (uu___257_102.FStar_TypeChecker_Env.modules);
      FStar_TypeChecker_Env.expected_typ =
        (uu___257_102.FStar_TypeChecker_Env.expected_typ);
      FStar_TypeChecker_Env.sigtab =
        (uu___257_102.FStar_TypeChecker_Env.sigtab);
      FStar_TypeChecker_Env.attrtab =
        (uu___257_102.FStar_TypeChecker_Env.attrtab);
      FStar_TypeChecker_Env.is_pattern =
        (uu___257_102.FStar_TypeChecker_Env.is_pattern);
      FStar_TypeChecker_Env.instantiate_imp =
        (uu___257_102.FStar_TypeChecker_Env.instantiate_imp);
      FStar_TypeChecker_Env.effects =
        (uu___257_102.FStar_TypeChecker_Env.effects);
      FStar_TypeChecker_Env.generalize =
        (uu___257_102.FStar_TypeChecker_Env.generalize);
      FStar_TypeChecker_Env.letrecs =
        (uu___257_102.FStar_TypeChecker_Env.letrecs);
      FStar_TypeChecker_Env.top_level =
        (uu___257_102.FStar_TypeChecker_Env.top_level);
      FStar_TypeChecker_Env.check_uvars =
        (uu___257_102.FStar_TypeChecker_Env.check_uvars);
      FStar_TypeChecker_Env.use_eq =
        (uu___257_102.FStar_TypeChecker_Env.use_eq);
      FStar_TypeChecker_Env.is_iface =
        (uu___257_102.FStar_TypeChecker_Env.is_iface);
      FStar_TypeChecker_Env.admit =
        (uu___257_102.FStar_TypeChecker_Env.admit);
      FStar_TypeChecker_Env.lax = (uu___257_102.FStar_TypeChecker_Env.lax);
      FStar_TypeChecker_Env.lax_universes =
        (uu___257_102.FStar_TypeChecker_Env.lax_universes);
      FStar_TypeChecker_Env.phase1 =
        (uu___257_102.FStar_TypeChecker_Env.phase1);
      FStar_TypeChecker_Env.failhard =
        (uu___257_102.FStar_TypeChecker_Env.failhard);
      FStar_TypeChecker_Env.nosynth =
        (uu___257_102.FStar_TypeChecker_Env.nosynth);
      FStar_TypeChecker_Env.uvar_subtyping =
        (uu___257_102.FStar_TypeChecker_Env.uvar_subtyping);
      FStar_TypeChecker_Env.tc_term =
        (uu___257_102.FStar_TypeChecker_Env.tc_term);
      FStar_TypeChecker_Env.type_of =
        (uu___257_102.FStar_TypeChecker_Env.type_of);
      FStar_TypeChecker_Env.universe_of =
        (uu___257_102.FStar_TypeChecker_Env.universe_of);
      FStar_TypeChecker_Env.check_type_of =
        (uu___257_102.FStar_TypeChecker_Env.check_type_of);
      FStar_TypeChecker_Env.use_bv_sorts =
        (uu___257_102.FStar_TypeChecker_Env.use_bv_sorts);
      FStar_TypeChecker_Env.qtbl_name_and_index =
        (uu___257_102.FStar_TypeChecker_Env.qtbl_name_and_index);
      FStar_TypeChecker_Env.normalized_eff_names =
        (uu___257_102.FStar_TypeChecker_Env.normalized_eff_names);
      FStar_TypeChecker_Env.fv_delta_depths =
        (uu___257_102.FStar_TypeChecker_Env.fv_delta_depths);
      FStar_TypeChecker_Env.proof_ns =
        (uu___257_102.FStar_TypeChecker_Env.proof_ns);
      FStar_TypeChecker_Env.synth_hook =
        (uu___257_102.FStar_TypeChecker_Env.synth_hook);
      FStar_TypeChecker_Env.splice =
        (uu___257_102.FStar_TypeChecker_Env.splice);
      FStar_TypeChecker_Env.postprocess =
        (uu___257_102.FStar_TypeChecker_Env.postprocess);
      FStar_TypeChecker_Env.is_native_tactic =
        (uu___257_102.FStar_TypeChecker_Env.is_native_tactic);
      FStar_TypeChecker_Env.identifier_info =
        (uu___257_102.FStar_TypeChecker_Env.identifier_info);
      FStar_TypeChecker_Env.tc_hooks =
        (uu___257_102.FStar_TypeChecker_Env.tc_hooks);
      FStar_TypeChecker_Env.dsenv =
        (uu___257_102.FStar_TypeChecker_Env.dsenv);
      FStar_TypeChecker_Env.nbe = (uu___257_102.FStar_TypeChecker_Env.nbe)
    }
...
let (goal_with_type : goal -> FStar_Syntax_Syntax.term -> goal) =
  fun g  ->
    fun t  ->
      ...
      let c' =
        let uu___258_142 = c  in
        {
          FStar_Syntax_Syntax.ctx_uvar_head =
            (uu___258_142.FStar_Syntax_Syntax.ctx_uvar_head);
          FStar_Syntax_Syntax.ctx_uvar_gamma =
            (uu___258_142.FStar_Syntax_Syntax.ctx_uvar_gamma);
          FStar_Syntax_Syntax.ctx_uvar_binders =
            (uu___258_142.FStar_Syntax_Syntax.ctx_uvar_binders);
          FStar_Syntax_Syntax.ctx_uvar_typ = t;
          FStar_Syntax_Syntax.ctx_uvar_reason =
            (uu___258_142.FStar_Syntax_Syntax.ctx_uvar_reason);
      ...
      {
        goal_main_env = (uu___259_143.goal_main_env);
        goal_ctx_uvar = c';
        opts = (uu___259_143.opts);
        is_guard = (uu___259_143.is_guard);
        label = (uu___259_143.label)
      }
...
let (goal_with_env : goal -> FStar_TypeChecker_Env.env -> goal) =
  fun g  ->
    fun env  ->
      let c = g.goal_ctx_uvar  in
      let c' =
        let uu___260_157 = c  in
        let uu____158 = FStar_TypeChecker_Env.all_binders env  in
        {
          FStar_Syntax_Syntax.ctx_uvar_head =
            (uu___260_157.FStar_Syntax_Syntax.ctx_uvar_head);
          FStar_Syntax_Syntax.ctx_uvar_gamma =
            (env.FStar_TypeChecker_Env.gamma);
          FStar_Syntax_Syntax.ctx_uvar_binders = uu____158;
          FStar_Syntax_Syntax.ctx_uvar_typ =
            (uu___260_157.FStar_Syntax_Syntax.ctx_uvar_typ);
          FStar_Syntax_Syntax.ctx_uvar_reason =
            (uu___260_157.FStar_Syntax_Syntax.ctx_uvar_reason);
          FStar_Syntax_Syntax.ctx_uvar_should_check =
      ...
      let uu___261_167 = g  in
      {
        goal_main_env = env;
        goal_ctx_uvar = c';
        opts = (uu___261_167.opts);
        is_guard = (uu___261_167.is_guard);
        label = (uu___261_167.label)
      }
  ...
  fun subst1  ->
    fun goal  ->
      ...
      let ctx_uvar =
        ...
        {
          FStar_Syntax_Syntax.ctx_uvar_head =
            (uu___262_215.FStar_Syntax_Syntax.ctx_uvar_head);
          FStar_Syntax_Syntax.ctx_uvar_gamma = uu____216;
          FStar_Syntax_Syntax.ctx_uvar_binders =
            (uu___262_215.FStar_Syntax_Syntax.ctx_uvar_binders);
          FStar_Syntax_Syntax.ctx_uvar_typ = uu____219;
          FStar_Syntax_Syntax.ctx_uvar_reason =
            (uu___262_215.FStar_Syntax_Syntax.ctx_uvar_reason);
          FStar_Syntax_Syntax.ctx_uvar_should_check =
      ...
      {
        goal_main_env = (uu___263_222.goal_main_env);
        goal_ctx_uvar = ctx_uvar;
        opts = (uu___263_222.opts);
        is_guard = (uu___263_222.is_guard);
        label = (uu___263_222.label)
      }
  ...
  fun subst1  ->
    fun ps  ->
      ...
      then ps
        ...
        (let uu___264_857 = ps  in
         let uu____858 = subst_goal subst1 ps.main_goal  in
         let uu____859 = FStar_List.map (subst_goal subst1) ps.goals  in
         {
           main_context = (uu___264_857.main_context);
           main_goal = uu____858;
           all_implicits = (uu___264_857.all_implicits);
           goals = uu____859;
           smt_goals = (uu___264_857.smt_goals);
           depth = (uu___264_857.depth);
           __dump = (uu___264_857.__dump);
           psc = (uu___264_857.psc);
           entry_range = (uu___264_857.entry_range);
           guard_policy = (uu___264_857.guard_policy);
           freshness = (uu___264_857.freshness);
           tac_verb_dbg = (uu___264_857.tac_verb_dbg);
           local_state = (uu___264_857.local_state)
         })
  
let (decr_depth : proofstate -> proofstate) =
  fun ps  ->
    let uu___265_868 = ps  in
    {
      main_context = (uu___265_868.main_context);
      main_goal = (uu___265_868.main_goal);
      all_implicits = (uu___265_868.all_implicits);
      goals = (uu___265_868.goals);
      smt_goals = (uu___265_868.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___265_868.__dump);
      psc = (uu___265_868.psc);
      entry_range = (uu___265_868.entry_range);
      guard_policy = (uu___265_868.guard_policy);
      freshness = (uu___265_868.freshness);
      tac_verb_dbg = (uu___265_868.tac_verb_dbg);
      local_state = (uu___265_868.local_state)
    }
  
let (incr_depth : proofstate -> proofstate) =
  fun ps  ->
    let uu___266_876 = ps  in
    {
      main_context = (uu___266_876.main_context);
      main_goal = (uu___266_876.main_goal);
      all_implicits = (uu___266_876.all_implicits);
      goals = (uu___266_876.goals);
      smt_goals = (uu___266_876.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___266_876.__dump);
      psc = (uu___266_876.psc);
      entry_range = (uu___266_876.entry_range);
      guard_policy = (uu___266_876.guard_policy);
      freshness = (uu___266_876.freshness);
      tac_verb_dbg = (uu___266_876.tac_verb_dbg);
      local_state = (uu___266_876.local_state)
    }
...
let (set_ps_psc : FStar_TypeChecker_Cfg.psc -> proofstate -> proofstate) =
  fun psc  ->
    fun ps  ->
      let uu___267_906 = ps  in
      {
        main_context = (uu___267_906.main_context);
        main_goal = (uu___267_906.main_goal);
        all_implicits = (uu___267_906.all_implicits);
        goals = (uu___267_906.goals);
        smt_goals = (uu___267_906.smt_goals);
        depth = (uu___267_906.depth);
        __dump = (uu___267_906.__dump);
        psc;
        entry_range = (uu___267_906.entry_range);
        guard_policy = (uu___267_906.guard_policy);
        freshness = (uu___267_906.freshness);
        tac_verb_dbg = (uu___267_906.tac_verb_dbg);
        local_state = (uu___267_906.local_state)
      }
  
let (set_proofstate_range : proofstate -> FStar_Range.range -> proofstate) =
  fun ps  ->
    fun r  ->
      let uu___268_918 = ps  in
      let uu____919 =
        let uu____920 = FStar_Range.def_range r  in
        FStar_Range.set_def_range ps.entry_range uu____920  in
      {
        main_context = (uu___268_918.main_context);
        main_goal = (uu___268_918.main_goal);
        all_implicits = (uu___268_918.all_implicits);
        goals = (uu___268_918.goals);
        smt_goals = (uu___268_918.smt_goals);
        depth = (uu___268_918.depth);
        __dump = (uu___268_918.__dump);
        psc = (uu___268_918.psc);
        entry_range = uu____919;
        guard_policy = (uu___268_918.guard_policy);
        freshness = (uu___268_918.freshness);
        tac_verb_dbg = (uu___268_918.tac_verb_dbg);
        local_state = (uu___268_918.local_state)
      }
...
let (set_label : Prims.string -> goal -> goal) =
  fun l  ->
    fun g  ->
      let uu___269_968 = g  in
      {
        goal_main_env = (uu___269_968.goal_main_env);
        goal_ctx_uvar = (uu___269_968.goal_ctx_uvar);
        opts = (uu___269_968.opts);
        is_guard = (uu___269_968.is_guard);
        label = l
      }
