  ...
  fun subst1  ->
    fun ps  ->
      ...
      then ps
        ...
        (let uu___189_323 = ps in
         let uu____324 = subst_goal subst1 ps.main_goal in
         let uu____325 = FStar_List.map (subst_goal subst1) ps.goals in
         {
           main_context = (uu___189_323.main_context);
           main_goal = uu____324;
           all_implicits = (uu___189_323.all_implicits);
           goals = uu____325;
           smt_goals = (uu___189_323.smt_goals);
           depth = (uu___189_323.depth);
           __dump = (uu___189_323.__dump);
           psc = (uu___189_323.psc);
           entry_range = (uu___189_323.entry_range)
         })
let decr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___190_331 = ps in
    {
      main_context = (uu___190_331.main_context);
      main_goal = (uu___190_331.main_goal);
      all_implicits = (uu___190_331.all_implicits);
      goals = (uu___190_331.goals);
      smt_goals = (uu___190_331.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___190_331.__dump);
      psc = (uu___190_331.psc);
      entry_range = (uu___190_331.entry_range)
    }
let incr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___191_335 = ps in
    {
      main_context = (uu___191_335.main_context);
      main_goal = (uu___191_335.main_goal);
      all_implicits = (uu___191_335.all_implicits);
      goals = (uu___191_335.goals);
      smt_goals = (uu___191_335.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___191_335.__dump);
      psc = (uu___191_335.psc);
      entry_range = (uu___191_335.entry_range)
    }
...
let set_ps_psc: FStar_TypeChecker_Normalize.psc -> proofstate -> proofstate =
  fun psc  ->
    fun ps  ->
      let uu___192_351 = ps in
      {
        main_context = (uu___192_351.main_context);
        main_goal = (uu___192_351.main_goal);
        all_implicits = (uu___192_351.all_implicits);
        goals = (uu___192_351.goals);
        smt_goals = (uu___192_351.smt_goals);
        depth = (uu___192_351.depth);
        __dump = (uu___192_351.__dump);
        psc;
        entry_range = (uu___192_351.entry_range)
      }
let set_proofstate_range: proofstate -> FStar_Range.range -> proofstate =
  fun ps  ->
    fun r  ->
      let uu___193_358 = ps in
      {
        main_context = (uu___193_358.main_context);
        main_goal = (uu___193_358.main_goal);
        all_implicits = (uu___193_358.all_implicits);
        goals = (uu___193_358.goals);
        smt_goals = (uu___193_358.smt_goals);
        depth = (uu___193_358.depth);
        __dump = (uu___193_358.__dump);
        psc = (uu___193_358.psc);
        entry_range = r
      }
type direction =
  | TopDown
