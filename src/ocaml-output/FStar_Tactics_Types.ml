  ...
  fun subst1  ->
    fun goal  ->
      ...
      let uu____70 = FStar_Syntax_Subst.subst subst1 goal.goal_ty in
      {
        ...
        witness = uu____69;
        goal_ty = uu____70;
        opts = (uu___339_67.opts);
        is_guard = (uu___339_67.is_guard)
      }
type proofstate =
  {
...
let subst_proof_state:
  ...
  fun subst1  ->
    fun ps  ->
      let uu___340_321 = ps in
      let uu____322 = subst_goal subst1 ps.main_goal in
      let uu____323 = FStar_List.map (subst_goal subst1) ps.goals in
      {
        main_context = (uu___340_321.main_context);
        main_goal = uu____322;
        all_implicits = (uu___340_321.all_implicits);
        goals = uu____323;
        smt_goals = (uu___340_321.smt_goals);
        depth = (uu___340_321.depth);
        __dump = (uu___340_321.__dump);
        psc = (uu___340_321.psc);
        entry_range = (uu___340_321.entry_range)
      }
let decr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___341_329 = ps in
    {
      main_context = (uu___341_329.main_context);
      main_goal = (uu___341_329.main_goal);
      all_implicits = (uu___341_329.all_implicits);
      goals = (uu___341_329.goals);
      smt_goals = (uu___341_329.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___341_329.__dump);
      psc = (uu___341_329.psc);
      entry_range = (uu___341_329.entry_range)
    }
let incr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___342_333 = ps in
    {
      main_context = (uu___342_333.main_context);
      main_goal = (uu___342_333.main_goal);
      all_implicits = (uu___342_333.all_implicits);
      goals = (uu___342_333.goals);
      smt_goals = (uu___342_333.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___342_333.__dump);
      psc = (uu___342_333.psc);
      entry_range = (uu___342_333.entry_range)
    }
...
let set_ps_psc: FStar_TypeChecker_Normalize.psc -> proofstate -> proofstate =
  fun psc  ->
    fun ps  ->
      let uu___343_349 = ps in
      {
        main_context = (uu___343_349.main_context);
        main_goal = (uu___343_349.main_goal);
        all_implicits = (uu___343_349.all_implicits);
        goals = (uu___343_349.goals);
        smt_goals = (uu___343_349.smt_goals);
        depth = (uu___343_349.depth);
        __dump = (uu___343_349.__dump);
        psc;
        entry_range = (uu___343_349.entry_range)
      }
let set_proofstate_range: proofstate -> FStar_Range.range -> proofstate =
  fun ps  ->
    fun r  ->
      let uu___344_356 = ps in
      {
        main_context = (uu___344_356.main_context);
        main_goal = (uu___344_356.main_goal);
        all_implicits = (uu___344_356.all_implicits);
        goals = (uu___344_356.goals);
        smt_goals = (uu___344_356.smt_goals);
        depth = (uu___344_356.depth);
        __dump = (uu___344_356.__dump);
        psc = (uu___344_356.psc);
        entry_range = r
      }
type direction =
  | TopDown
