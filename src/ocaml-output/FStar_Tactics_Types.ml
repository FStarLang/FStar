...
let subst_proof_state :
  ...
  fun subst1  ->
    fun ps  ->
      let uu___194_321 = ps  in
      let uu____322 = subst_goal subst1 ps.main_goal  in
      let uu____323 = FStar_List.map (subst_goal subst1) ps.goals  in
      {
        main_context = (uu___194_321.main_context);
        main_goal = uu____322;
        all_implicits = (uu___194_321.all_implicits);
        goals = uu____323;
        smt_goals = (uu___194_321.smt_goals);
        depth = (uu___194_321.depth);
        __dump = (uu___194_321.__dump);
        psc = (uu___194_321.psc);
        entry_range = (uu___194_321.entry_range)
      }
  
let decr_depth : proofstate -> proofstate =
  fun ps  ->
    let uu___195_329 = ps  in
    {
      main_context = (uu___195_329.main_context);
      main_goal = (uu___195_329.main_goal);
      all_implicits = (uu___195_329.all_implicits);
      goals = (uu___195_329.goals);
      smt_goals = (uu___195_329.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___195_329.__dump);
      psc = (uu___195_329.psc);
      entry_range = (uu___195_329.entry_range)
    }
  
let incr_depth : proofstate -> proofstate =
  fun ps  ->
    let uu___196_333 = ps  in
    {
      main_context = (uu___196_333.main_context);
      main_goal = (uu___196_333.main_goal);
      all_implicits = (uu___196_333.all_implicits);
      goals = (uu___196_333.goals);
      smt_goals = (uu___196_333.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___196_333.__dump);
      psc = (uu___196_333.psc);
      entry_range = (uu___196_333.entry_range)
    }
...
let set_ps_psc : FStar_TypeChecker_Normalize.psc -> proofstate -> proofstate
  ...
  fun psc  ->
    fun ps  ->
      let uu___197_349 = ps  in
      {
        main_context = (uu___197_349.main_context);
        main_goal = (uu___197_349.main_goal);
        all_implicits = (uu___197_349.all_implicits);
        goals = (uu___197_349.goals);
        smt_goals = (uu___197_349.smt_goals);
        depth = (uu___197_349.depth);
        __dump = (uu___197_349.__dump);
        psc;
        entry_range = (uu___197_349.entry_range)
      }
  
let set_proofstate_range : proofstate -> FStar_Range.range -> proofstate =
  fun ps  ->
    fun r  ->
      let uu___198_356 = ps  in
      {
        main_context = (uu___198_356.main_context);
        main_goal = (uu___198_356.main_goal);
        all_implicits = (uu___198_356.all_implicits);
        goals = (uu___198_356.goals);
        smt_goals = (uu___198_356.smt_goals);
        depth = (uu___198_356.depth);
        __dump = (uu___198_356.__dump);
        psc = (uu___198_356.psc);
        entry_range = r
      }
