...
let decr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___120_261 = ps in
    {
      main_context = (uu___120_261.main_context);
      main_goal = (uu___120_261.main_goal);
      all_implicits = (uu___120_261.all_implicits);
      goals = (uu___120_261.goals);
      smt_goals = (uu___120_261.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___120_261.__dump)
    }
let incr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___121_266 = ps in
    {
      main_context = (uu___121_266.main_context);
      main_goal = (uu___121_266.main_goal);
      all_implicits = (uu___121_266.all_implicits);
      goals = (uu___121_266.goals);
      smt_goals = (uu___121_266.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___121_266.__dump)
    }
