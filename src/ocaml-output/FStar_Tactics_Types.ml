  ...
  fun subst1  ->
    fun goal  ->
      ...
      let uu____77 = FStar_Syntax_Subst.subst subst1 goal.goal_ty in
      {
        ...
        witness = uu____76;
        goal_ty = uu____77;
        opts = (uu___331_74.opts);
        is_guard = (uu___331_74.is_guard)
      }
type proofstate =
  {
...
let subst_proof_state:
  ...
  fun subst1  ->
    fun ps  ->
      let uu___332_341 = ps in
      let uu____342 = subst_goal subst1 ps.main_goal in
      let uu____343 = FStar_List.map (subst_goal subst1) ps.goals in
      {
        main_context = (uu___332_341.main_context);
        main_goal = uu____342;
        all_implicits = (uu___332_341.all_implicits);
        goals = uu____343;
        smt_goals = (uu___332_341.smt_goals);
        depth = (uu___332_341.depth);
        __dump = (uu___332_341.__dump);
        psc = (uu___332_341.psc);
        entry_range = (uu___332_341.entry_range)
      }
let decr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___333_350 = ps in
    {
      main_context = (uu___333_350.main_context);
      main_goal = (uu___333_350.main_goal);
      all_implicits = (uu___333_350.all_implicits);
      goals = (uu___333_350.goals);
      smt_goals = (uu___333_350.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___333_350.__dump);
      psc = (uu___333_350.psc);
      entry_range = (uu___333_350.entry_range)
    }
let incr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___334_355 = ps in
    {
      main_context = (uu___334_355.main_context);
      main_goal = (uu___334_355.main_goal);
      all_implicits = (uu___334_355.all_implicits);
      goals = (uu___334_355.goals);
      smt_goals = (uu___334_355.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___334_355.__dump);
      psc = (uu___334_355.psc);
      entry_range = (uu___334_355.entry_range)
    }
...
let set_ps_psc: FStar_TypeChecker_Normalize.psc -> proofstate -> proofstate =
  fun psc  ->
    fun ps  ->
      let uu___335_374 = ps in
      {
        main_context = (uu___335_374.main_context);
        main_goal = (uu___335_374.main_goal);
        all_implicits = (uu___335_374.all_implicits);
        goals = (uu___335_374.goals);
        smt_goals = (uu___335_374.smt_goals);
        depth = (uu___335_374.depth);
        __dump = (uu___335_374.__dump);
        psc;
        entry_range = (uu___335_374.entry_range)
      }
let set_proofstate_range: proofstate -> FStar_Range.range -> proofstate =
  fun ps  ->
    fun r  ->
      let uu___336_383 = ps in
      {
        main_context = (uu___336_383.main_context);
        main_goal = (uu___336_383.main_goal);
        all_implicits = (uu___336_383.all_implicits);
        goals = (uu___336_383.goals);
        smt_goals = (uu___336_383.smt_goals);
        depth = (uu___336_383.depth);
        __dump = (uu___336_383.__dump);
        psc = (uu___336_383.psc);
        entry_range = r
      }
type direction =
  | TopDown
