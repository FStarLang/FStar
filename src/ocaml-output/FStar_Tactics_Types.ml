  ...
  fun subst1  ->
    fun goal  ->
      ...
      let uu____77 = FStar_Syntax_Subst.subst subst1 goal.goal_ty in
      {
        ...
        witness = uu____76;
        goal_ty = uu____77;
        opts = (uu___120_74.opts);
        is_guard = (uu___120_74.is_guard)
      }
type proofstate =
  {
...
let subst_proof_state:
  ...
  fun subst1  ->
    fun ps  ->
      let uu___121_308 = ps in
      let uu____309 = subst_goal subst1 ps.main_goal in
      let uu____310 = FStar_List.map (subst_goal subst1) ps.goals in
      {
        main_context = (uu___121_308.main_context);
        main_goal = uu____309;
        all_implicits = (uu___121_308.all_implicits);
        goals = uu____310;
        smt_goals = (uu___121_308.smt_goals);
        depth = (uu___121_308.depth);
        __dump = (uu___121_308.__dump);
        psc = (uu___121_308.psc)
      }
let decr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___122_317 = ps in
    {
      main_context = (uu___122_317.main_context);
      main_goal = (uu___122_317.main_goal);
      all_implicits = (uu___122_317.all_implicits);
      goals = (uu___122_317.goals);
      smt_goals = (uu___122_317.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___122_317.__dump);
      psc = (uu___122_317.psc)
    }
let incr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___123_322 = ps in
    {
      main_context = (uu___123_322.main_context);
      main_goal = (uu___123_322.main_goal);
      all_implicits = (uu___123_322.all_implicits);
      goals = (uu___123_322.goals);
      smt_goals = (uu___123_322.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___123_322.__dump);
      psc = (uu___123_322.psc)
    }
...
let set_ps_psc: FStar_TypeChecker_Normalize.psc -> proofstate -> proofstate =
  fun psc  ->
    fun ps  ->
      let uu___124_339 = ps in
      {
        main_context = (uu___124_339.main_context);
        main_goal = (uu___124_339.main_goal);
        all_implicits = (uu___124_339.all_implicits);
        goals = (uu___124_339.goals);
        smt_goals = (uu___124_339.smt_goals);
        depth = (uu___124_339.depth);
        __dump = (uu___124_339.__dump);
        psc
      }
type direction =
  | TopDown
