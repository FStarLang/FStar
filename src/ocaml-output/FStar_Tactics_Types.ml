  ...
  fun subst1  ->
    fun goal  ->
      ...
      let uu____77 = FStar_Syntax_Subst.subst subst1 goal.goal_ty in
      {
        ...
        witness = uu____76;
        goal_ty = uu____77;
        opts = (uu___121_74.opts);
        is_guard = (uu___121_74.is_guard)
      }
type proofstate =
  {
...
let subst_proof_state:
  ...
  fun subst1  ->
    fun ps  ->
      let uu___122_277 = ps in
      let uu____278 = subst_goal subst1 ps.main_goal in
      let uu____279 = FStar_List.map (subst_goal subst1) ps.goals in
      {
        main_context = (uu___122_277.main_context);
        main_goal = uu____278;
        all_implicits = (uu___122_277.all_implicits);
        goals = uu____279;
        smt_goals = (uu___122_277.smt_goals);
        depth = (uu___122_277.depth);
        __dump = (uu___122_277.__dump)
      }
let decr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___123_286 = ps in
    {
      main_context = (uu___123_286.main_context);
      main_goal = (uu___123_286.main_goal);
      all_implicits = (uu___123_286.all_implicits);
      goals = (uu___123_286.goals);
      smt_goals = (uu___123_286.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___123_286.__dump)
    }
let incr_depth: proofstate -> proofstate =
  fun ps  ->
    let uu___124_291 = ps in
    {
      main_context = (uu___124_291.main_context);
      main_goal = (uu___124_291.main_goal);
      all_implicits = (uu___124_291.all_implicits);
      goals = (uu___124_291.goals);
      smt_goals = (uu___124_291.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___124_291.__dump)
    }
