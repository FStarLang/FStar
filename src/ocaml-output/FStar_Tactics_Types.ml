  ...
  fun subst1  ->
    fun ps  ->
      ...
      then ps
        ...
        (let uu___245_576 = ps  in
         let uu____577 = subst_goal subst1 ps.main_goal  in
         let uu____578 = FStar_List.map (subst_goal subst1) ps.goals  in
         {
           main_context = (uu___245_576.main_context);
           main_goal = uu____577;
           all_implicits = (uu___245_576.all_implicits);
           goals = uu____578;
           smt_goals = (uu___245_576.smt_goals);
           depth = (uu___245_576.depth);
           __dump = (uu___245_576.__dump);
           psc = (uu___245_576.psc);
           entry_range = (uu___245_576.entry_range);
           guard_policy = (uu___245_576.guard_policy);
           freshness = (uu___245_576.freshness)
         })
  
let (decr_depth : proofstate -> proofstate) =
  fun ps  ->
    let uu___246_586 = ps  in
    {
      main_context = (uu___246_586.main_context);
      main_goal = (uu___246_586.main_goal);
      all_implicits = (uu___246_586.all_implicits);
      goals = (uu___246_586.goals);
      smt_goals = (uu___246_586.smt_goals);
      depth = (ps.depth - (Prims.parse_int "1"));
      __dump = (uu___246_586.__dump);
      psc = (uu___246_586.psc);
      entry_range = (uu___246_586.entry_range);
      guard_policy = (uu___246_586.guard_policy);
      freshness = (uu___246_586.freshness)
    }
  
let (incr_depth : proofstate -> proofstate) =
  fun ps  ->
    let uu___247_592 = ps  in
    {
      main_context = (uu___247_592.main_context);
      main_goal = (uu___247_592.main_goal);
      all_implicits = (uu___247_592.all_implicits);
      goals = (uu___247_592.goals);
      smt_goals = (uu___247_592.smt_goals);
      depth = (ps.depth + (Prims.parse_int "1"));
      __dump = (uu___247_592.__dump);
      psc = (uu___247_592.psc);
      entry_range = (uu___247_592.entry_range);
      guard_policy = (uu___247_592.guard_policy);
      freshness = (uu___247_592.freshness)
    }
...
let (set_ps_psc :
  ...
  fun psc  ->
    fun ps  ->
      let uu___248_614 = ps  in
      {
        main_context = (uu___248_614.main_context);
        main_goal = (uu___248_614.main_goal);
        all_implicits = (uu___248_614.all_implicits);
        goals = (uu___248_614.goals);
        smt_goals = (uu___248_614.smt_goals);
        depth = (uu___248_614.depth);
        __dump = (uu___248_614.__dump);
        psc;
        entry_range = (uu___248_614.entry_range);
        guard_policy = (uu___248_614.guard_policy);
        freshness = (uu___248_614.freshness)
      }
