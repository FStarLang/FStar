...
let (set_option' :
  (Prims.string,option_val) FStar_Pervasives_Native_Tuple2.tuple2 -> unit) =
...
let (defaults :
  (Prims.string,option_val) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list)
  =
  [("__temp_no_proj", (List []));
...
let display_usage_aux :
  'Auu____3770 'Auu____3771 .
    ('Auu____3770,Prims.string,'Auu____3771 FStar_Getopt.opt_variant,
      Prims.string) FStar_Pervasives_Native_Tuple4.tuple4 Prims.list -> 
      unit
  =
  fun specs  ->
...
let (mk_spec :
  (FStar_BaseTypes.char,Prims.string,option_val FStar_Getopt.opt_variant,
    Prims.string) FStar_Pervasives_Native_Tuple4.tuple4 -> FStar_Getopt.opt)
  =
  fun o  ->
    let uu____3933 = o  in
...
let (__proj__PostProcessed__item___0 :
  opt_type ->
    (option_val -> option_val,opt_type) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__WithSideEffect__item___0 :
  opt_type -> (unit -> unit,opt_type) FStar_Pervasives_Native_Tuple2.tuple2)
