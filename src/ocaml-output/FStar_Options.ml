...
let display_version : Prims.unit -> Prims.unit =
  fun uu____821  ->
    let uu____822 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____823
        uu____826 uu____829 uu____832 uu____835
       in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____932 =
                let uu____933 = let uu____936 = f ()  in (name, uu____936)
                   in
  ...
  fun uu____1006  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1045 = parse_codegen s  in String uu____1045)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1055 =
                  let uu____1057 =
                    let uu____1059 = get_codegen_lib ()  in s :: uu____1059
                     in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1089 =
                  let uu____1091 =
                    let uu____1093 = get_debug_level ()  in x :: uu____1093
                     in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1130 =
                  let uu____1132 =
                    let uu____1134 = get_dump_module ()  in x :: uu____1134
                     in
           ...
           (((fun s  ->
                let uu____1228 =
                  let uu____1230 =
                    ...
                    FStar_List.map (fun _0_34  -> String _0_34) uu____1232
                     in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1250 = FStar_Util.int_of_string x  in
                Int uu____1250)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1298 = FStar_Util.int_of_string x  in
                Int uu____1298)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1308 = FStar_Util.int_of_string x  in
                Int uu____1308)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1318 = FStar_Util.int_of_string x  in
                Int uu____1318)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1335 = FStar_Util.int_of_string x  in
                Int uu____1335)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1352 =
                  let uu____1354 =
                    let uu____1356 = get_no_extract ()  in x :: uu____1356
                     in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1569 =
                  let uu____1571 =
                    let uu____1573 = get___temp_no_proj ()  in x ::
                      uu____1573
                     in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1625 = FStar_Util.int_of_string s  in
                Int uu____1625)), "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1635 = FStar_Util.int_of_string s  in
                Int uu____1635)), "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1645 = FStar_Util.int_of_string s  in
                Int uu____1645)), "[positive integer]")),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____1830
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____1833)
       in
    let uu____1843 =
      let uu____1845 = FStar_ST.read file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1845
       in
    (res, uu____1843)
