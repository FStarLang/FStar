...
let get_codegen: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1065  -> lookup_opt "codegen" (as_option as_string)
let get_codegen_lib: Prims.unit -> Prims.string Prims.list =
  fun uu____1073  -> lookup_opt "codegen-lib" (as_list as_string)
let get_debug: Prims.unit -> Prims.string Prims.list =
  fun uu____1081  -> lookup_opt "debug" (as_list as_string)
let get_debug_level: Prims.unit -> Prims.string Prims.list =
  fun uu____1089  -> lookup_opt "debug_level" (as_list as_string)
let get_dep: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1097  -> lookup_opt "dep" (as_option as_string)
let get_detail_errors: Prims.unit -> Prims.bool =
  fun uu____1103  -> lookup_opt "detail_errors" as_bool
let get_detail_hint_replay: Prims.unit -> Prims.bool =
  fun uu____1107  -> lookup_opt "detail_hint_replay" as_bool
let get_doc: Prims.unit -> Prims.bool =
  fun uu____1111  -> lookup_opt "doc" as_bool
let get_dump_module: Prims.unit -> Prims.string Prims.list =
  fun uu____1117  -> lookup_opt "dump_module" (as_list as_string)
let get_eager_inference: Prims.unit -> Prims.bool =
  fun uu____1123  -> lookup_opt "eager_inference" as_bool
let get_explicit_deps: Prims.unit -> Prims.bool =
  fun uu____1127  -> lookup_opt "explicit_deps" as_bool
let get_extract_all: Prims.unit -> Prims.bool =
  fun uu____1131  -> lookup_opt "extract_all" as_bool
let get_extract_module: Prims.unit -> Prims.string Prims.list =
  fun uu____1137  -> lookup_opt "extract_module" (as_list as_string)
let get_extract_namespace: Prims.unit -> Prims.string Prims.list =
  fun uu____1145  -> lookup_opt "extract_namespace" (as_list as_string)
let get_fs_typ_app: Prims.unit -> Prims.bool =
  fun uu____1151  -> lookup_opt "fs_typ_app" as_bool
let get_fstar_home: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____1157  -> lookup_opt "fstar_home" (as_option as_string)
let get_gen_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1165  -> lookup_opt "gen_native_tactics" (as_option as_string)
let get_hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____1171  -> lookup_opt "hide_genident_nums" as_bool
let get_hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____1175  -> lookup_opt "hide_uvar_nums" as_bool
let get_hint_info: Prims.unit -> Prims.bool =
  fun uu____1179  -> lookup_opt "hint_info" as_bool
let get_hint_file: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____1185  -> lookup_opt "hint_file" (as_option as_string)
let get_in: Prims.unit -> Prims.bool =
  fun uu____1191  -> lookup_opt "in" as_bool
let get_ide: Prims.unit -> Prims.bool =
  fun uu____1195  -> lookup_opt "ide" as_bool
let get_include: Prims.unit -> Prims.string Prims.list =
  fun uu____1201  -> lookup_opt "include" (as_list as_string)
let get_indent: Prims.unit -> Prims.bool =
  fun uu____1207  -> lookup_opt "indent" as_bool
let get_initial_fuel: Prims.unit -> Prims.int =
  fun uu____1211  -> lookup_opt "initial_fuel" as_int
let get_initial_ifuel: Prims.unit -> Prims.int =
  fun uu____1215  -> lookup_opt "initial_ifuel" as_int
let get_lax: Prims.unit -> Prims.bool =
  fun uu____1219  -> lookup_opt "lax" as_bool
let get_load: Prims.unit -> Prims.string Prims.list =
  fun uu____1225  -> lookup_opt "load" (as_list as_string)
let get_log_queries: Prims.unit -> Prims.bool =
  fun uu____1231  -> lookup_opt "log_queries" as_bool
let get_log_types: Prims.unit -> Prims.bool =
  fun uu____1235  -> lookup_opt "log_types" as_bool
let get_max_fuel: Prims.unit -> Prims.int =
  fun uu____1239  -> lookup_opt "max_fuel" as_int
let get_max_ifuel: Prims.unit -> Prims.int =
  fun uu____1243  -> lookup_opt "max_ifuel" as_int
let get_min_fuel: Prims.unit -> Prims.int =
  fun uu____1247  -> lookup_opt "min_fuel" as_int
let get_MLish: Prims.unit -> Prims.bool =
  fun uu____1251  -> lookup_opt "MLish" as_bool
let get_n_cores: Prims.unit -> Prims.int =
  fun uu____1255  -> lookup_opt "n_cores" as_int
let get_no_default_includes: Prims.unit -> Prims.bool =
  fun uu____1259  -> lookup_opt "no_default_includes" as_bool
let get_no_extract: Prims.unit -> Prims.string Prims.list =
  fun uu____1265  -> lookup_opt "no_extract" (as_list as_string)
let get_no_location_info: Prims.unit -> Prims.bool =
  fun uu____1271  -> lookup_opt "no_location_info" as_bool
let get_odir: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1277  -> lookup_opt "odir" (as_option as_string)
let get_ugly: Prims.unit -> Prims.bool =
  fun uu____1283  -> lookup_opt "ugly" as_bool
let get_prims: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1289  -> lookup_opt "prims" (as_option as_string)
let get_print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____1295  -> lookup_opt "print_bound_var_types" as_bool
let get_print_effect_args: Prims.unit -> Prims.bool =
  fun uu____1299  -> lookup_opt "print_effect_args" as_bool
let get_print_full_names: Prims.unit -> Prims.bool =
  fun uu____1303  -> lookup_opt "print_full_names" as_bool
let get_print_implicits: Prims.unit -> Prims.bool =
  fun uu____1307  -> lookup_opt "print_implicits" as_bool
let get_print_universes: Prims.unit -> Prims.bool =
  fun uu____1311  -> lookup_opt "print_universes" as_bool
let get_print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____1315  -> lookup_opt "print_z3_statistics" as_bool
let get_prn: Prims.unit -> Prims.bool =
  fun uu____1319  -> lookup_opt "prn" as_bool
let get_query_stats: Prims.unit -> Prims.bool =
  fun uu____1323  -> lookup_opt "query_stats" as_bool
let get_record_hints: Prims.unit -> Prims.bool =
  fun uu____1327  -> lookup_opt "record_hints" as_bool
let get_reuse_hint_for:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1333  -> lookup_opt "reuse_hint_for" (as_option as_string)
let get_show_signatures: Prims.unit -> Prims.string Prims.list =
  fun uu____1341  -> lookup_opt "show_signatures" (as_list as_string)
let get_silent: Prims.unit -> Prims.bool =
  fun uu____1347  -> lookup_opt "silent" as_bool
let get_smt: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1353  -> lookup_opt "smt" (as_option as_string)
let get_smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____1359  -> lookup_opt "smtencoding.elim_box" as_bool
let get_smtencoding_nl_arith_repr: Prims.unit -> Prims.string =
  fun uu____1363  -> lookup_opt "smtencoding.nl_arith_repr" as_string
let get_smtencoding_l_arith_repr: Prims.unit -> Prims.string =
  fun uu____1367  -> lookup_opt "smtencoding.l_arith_repr" as_string
let get_split_cases: Prims.unit -> Prims.int =
  fun uu____1371  -> lookup_opt "split_cases" as_int
let get_timing: Prims.unit -> Prims.bool =
  fun uu____1375  -> lookup_opt "timing" as_bool
let get_trace_error: Prims.unit -> Prims.bool =
  fun uu____1379  -> lookup_opt "trace_error" as_bool
let get_unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____1383  -> lookup_opt "unthrottle_inductives" as_bool
let get_unsafe_tactic_exec: Prims.unit -> Prims.bool =
  fun uu____1387  -> lookup_opt "unsafe_tactic_exec" as_bool
  ...
  fun uu____1923  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "hint_info",
        (FStar_Getopt.ZeroArgs ((fun uu____2323  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "show_signatures",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2851 =
                  let uu____2854 =
                    let uu____2857 = get_show_signatures () in x ::
                      uu____2857 in
                  FStar_All.pipe_right uu____2854 (FStar_List.map mk_string) in
                mk_list uu____2851)), "[module name]")),
        "Show the checked signatures for all top-level symbols in the module");
      (FStar_Getopt.noshort, "silent",
        (FStar_Getopt.ZeroArgs ((fun uu____2877  -> mk_bool true))), " ");
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n1  ->
                let uu____2951 = FStar_Util.int_of_string n1 in
                mk_int uu____2951)), "[positive integer]")),
        "Partition VC of a match into groups of [n] cases");
      (FStar_Getopt.noshort, "timing",
        (FStar_Getopt.ZeroArgs ((fun uu____2965  -> mk_bool true))),
...
let codegen: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4013  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____4021  ->
    let uu____4022 = get_codegen_lib () in
    FStar_All.pipe_right uu____4022
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____4038  -> let uu____4039 = get_debug () in uu____4039 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      (let uu____4054 = get_debug () in
       FStar_All.pipe_right uu____4054 (FStar_List.contains modul)) &&
        (debug_level_geq level)
let dep: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4064  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____4068  -> get_detail_errors ()
let detail_hint_replay: Prims.unit -> Prims.bool =
  fun uu____4072  -> get_detail_hint_replay ()
let doc: Prims.unit -> Prims.bool = fun uu____4076  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____4081 = get_dump_module () in
    FStar_All.pipe_right uu____4081 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____4089  -> get_eager_inference ()
let explicit_deps: Prims.unit -> Prims.bool =
  fun uu____4093  -> get_explicit_deps ()
let extract_all: Prims.unit -> Prims.bool =
  fun uu____4097  -> get_extract_all ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____4102 = FStar_ST.op_Bang light_off_files in
    FStar_List.contains filename uu____4102
let gen_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4128  -> get_gen_native_tactics ()
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____4132  -> true
let hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____4136  -> get_hide_genident_nums ()
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____4140  -> get_hide_uvar_nums ()
let hint_info: Prims.unit -> Prims.bool =
  fun uu____4144  -> (get_hint_info ()) || (get_query_stats ())
let hint_file: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4150  -> get_hint_file ()
let ide: Prims.unit -> Prims.bool = fun uu____4154  -> get_ide ()
let indent: Prims.unit -> Prims.bool = fun uu____4158  -> get_indent ()
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____4162  ->
    let uu____4163 = get_initial_fuel () in
    let uu____4164 = get_max_fuel () in Prims.min uu____4163 uu____4164
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____4168  ->
    let uu____4169 = get_initial_ifuel () in
    let uu____4170 = get_max_ifuel () in Prims.min uu____4169 uu____4170
let interactive: Prims.unit -> Prims.bool =
  fun uu____4174  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____4178  -> get_lax ()
let load: Prims.unit -> Prims.string Prims.list =
  fun uu____4184  -> get_load ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____4188  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____4192  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____4196  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____4200  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____4204  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____4208  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____4212  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____4216  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____4220  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____4224  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____4229 = get_no_extract () in
    FStar_All.pipe_right uu____4229 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____4237  -> get_no_location_info ()
let output_dir: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4243  -> get_odir ()
let ugly: Prims.unit -> Prims.bool = fun uu____4247  -> get_ugly ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____4251  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____4255  -> get_print_effect_args ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____4259  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____4263  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____4267  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____4271  -> (get_print_z3_statistics ()) || (get_query_stats ())
let query_stats: Prims.unit -> Prims.bool =
  fun uu____4275  -> get_query_stats ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____4279  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____4285  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____4289  -> get_silent ()
let smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____4293  -> get_smtencoding_elim_box ()
let smtencoding_nl_arith_native: Prims.unit -> Prims.bool =
  fun uu____4297  ->
    let uu____4298 = get_smtencoding_nl_arith_repr () in
    uu____4298 = "native"
let smtencoding_nl_arith_wrapped: Prims.unit -> Prims.bool =
  fun uu____4302  ->
    let uu____4303 = get_smtencoding_nl_arith_repr () in
    uu____4303 = "wrapped"
let smtencoding_nl_arith_default: Prims.unit -> Prims.bool =
  fun uu____4307  ->
    let uu____4308 = get_smtencoding_nl_arith_repr () in
    uu____4308 = "boxwrap"
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____4312  ->
    let uu____4313 = get_smtencoding_l_arith_repr () in uu____4313 = "native"
let smtencoding_l_arith_default: Prims.unit -> Prims.bool =
  fun uu____4317  ->
    let uu____4318 = get_smtencoding_l_arith_repr () in
    uu____4318 = "boxwrap"
let split_cases: Prims.unit -> Prims.int =
  fun uu____4322  -> get_split_cases ()
let timing: Prims.unit -> Prims.bool = fun uu____4326  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____4330  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____4334  -> get_unthrottle_inductives ()
let unsafe_tactic_exec: Prims.unit -> Prims.bool =
  fun uu____4338  -> get_unsafe_tactic_exec ()
