  ...
  fun uu____768  ->
    let uu____769 =
      FStar_Util.format5
       ...
       in
    FStar_Util.print_string uu____769
...
let display_usage_aux specs =
  ...
  FStar_List.iter
    (fun uu____797  ->
       ...
       | (uu____803,flag,p,doc) ->
           (match p with
            | FStar_Getopt.ZeroArgs ig ->
                (match doc = "" with
                 | true  ->
                     let uu____812 =
                       let uu____813 = FStar_Util.colorize_bold flag  in
                       FStar_Util.format1 "  --%s\n" uu____813  in
                     FStar_Util.print_string uu____812
                 | uu____814 ->
                     let uu____815 =
                       let uu____816 = FStar_Util.colorize_bold flag  in
                       FStar_Util.format2 "  --%s  %s\n" uu____816 doc  in
                     FStar_Util.print_string uu____815)
            | FStar_Getopt.OneArg (uu____817,argname) ->
                (match doc = "" with
                 | true  ->
                     let uu____823 =
                       let uu____824 = FStar_Util.colorize_bold flag  in
                       let uu____825 = FStar_Util.colorize_bold argname  in
                       FStar_Util.format2 "  --%s %s\n" uu____824 uu____825
                        in
                     FStar_Util.print_string uu____823
                 | uu____826 ->
                     let uu____827 =
                       let uu____828 = FStar_Util.colorize_bold flag  in
                       let uu____829 = FStar_Util.colorize_bold argname  in
                       FStar_Util.format3 "  --%s %s  %s\n" uu____828
                         uu____829 doc
                        in
                     FStar_Util.print_string uu____827))) specs
    ...
    | (ns,name,arg,desc) ->
        let arg =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____864 =
                let uu____865 = let uu____868 = f ()  in (name, uu____868)
                   in
                set_option' uu____865  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x =
                let uu____879 = let uu____882 = f x  in (name, uu____882)  in
                set_option' uu____879  in
...
let cons_extract_module : Prims.string -> option_val =
  fun s  ->
    let uu____889 =
      let uu____891 =
        let uu____893 = get_extract_module ()  in (FStar_String.lowercase s)
          :: uu____893
         in
...
let cons_extract_namespace : Prims.string -> option_val =
  fun s  ->
    let uu____900 =
      let uu____902 =
        let uu____904 = get_extract_namespace ()  in
        (FStar_String.lowercase s) :: uu____904  in
      FStar_All.pipe_right uu____902
...
let add_extract_module : Prims.string -> Prims.unit =
  fun s  ->
    let uu____911 = cons_extract_module s  in
    set_option "extract_module" uu____911
  
let add_extract_namespace : Prims.string -> Prims.unit =
  fun s  ->
    let uu____915 = cons_extract_namespace s  in
    set_option "extract_namespace" uu____915
  
let cons_verify_module : Prims.string -> option_val =
  fun s  ->
    let uu____919 =
      let uu____921 =
        let uu____923 = get_verify_module ()  in (FStar_String.lowercase s)
          :: uu____923
         in
...
let add_verify_module : Prims.string -> Prims.unit =
  fun s  ->
    let uu____930 = cons_verify_module s  in
    set_option "verify_module" uu____930
  ...
  fun uu____938  ->
    let specs =
      ...
      (FStar_Getopt.noshort, "cardinality",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____967 = validate_cardinality x  in String uu____967)),
             "[off|warn|check]")),
        "Check cardinality constraints on inductive data types (default 'off')");
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  -> let uu____977 = parse_codegen s  in String uu____977)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____987 =
                  let uu____989 =
                    let uu____991 = get_codegen_lib ()  in s :: uu____991  in
                  FStar_All.pipe_right uu____989
                    (FStar_List.map (fun _0_28  -> String _0_28))
                   in
                List uu____987)), "[namespace]")),
      ...
      (FStar_Getopt.noshort, "debug",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1004 =
                  let uu____1006 =
                    let uu____1008 = get_debug ()  in x :: uu____1008  in
                  FStar_All.pipe_right uu____1006
                    (FStar_List.map (fun _0_29  -> String _0_29))
                   in
                List uu____1004)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1021 =
                  let uu____1023 =
                    let uu____1025 = get_debug_level ()  in x :: uu____1025
                     in
                  FStar_All.pipe_right uu____1023
                    (FStar_List.map (fun _0_30  -> String _0_30))
                   in
                List uu____1021)), "[Low|Medium|High|Extreme|...]")),
      ...
      (FStar_Getopt.noshort, "dep",
        (FStar_Getopt.OneArg
           (((fun x  ->
                ...
                | true  -> String x
                | uu____1038 -> failwith "invalid argument to 'dep'")),
             "[make|graph]")),
        "Output the transitive closure of the dependency graph in a format suitable for the given tool");
      (FStar_Getopt.noshort, "detail_errors",
        (FStar_Getopt.ZeroArgs ((fun uu____1045  -> Bool true))),
        "Emit a detailed error report by asking the SMT solver many queries; will take longer;\n         implies n_cores=1");
      (FStar_Getopt.noshort, "doc",
        (FStar_Getopt.ZeroArgs ((fun uu____1052  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "include",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1153 =
                  let uu____1155 =
                    let uu____1157 = get_include ()  in
                    FStar_List.append uu____1157 [s]  in
                  FStar_All.pipe_right uu____1155
                    (FStar_List.map (fun _0_34  -> String _0_34))
                   in
                List uu____1153)), "[path]")),
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1177 = FStar_Util.int_of_string x  in
                Int uu____1177)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try initially (default 2)");
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1187 = FStar_Util.int_of_string x  in
                Int uu____1187)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "log_types",
        (FStar_Getopt.ZeroArgs ((fun uu____1208  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1225 = FStar_Util.int_of_string x  in
                Int uu____1225)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1235 = FStar_Util.int_of_string x  in
                Int uu____1235)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1245 = FStar_Util.int_of_string x  in
                Int uu____1245)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1262 = FStar_Util.int_of_string x  in
                Int uu____1262)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1279 =
                  let uu____1281 =
                    let uu____1283 = get_no_extract ()  in x :: uu____1283
                     in
                  FStar_All.pipe_right uu____1281
                    (FStar_List.map (fun _0_35  -> String _0_35))
                   in
                List uu____1279)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "print_fuels",
        (FStar_Getopt.ZeroArgs ((fun uu____1337  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n  ->
                let uu____1422 = FStar_Util.int_of_string n  in
                Int uu____1422)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1482 =
                  let uu____1484 =
                    let uu____1486 = get___temp_no_proj ()  in x ::
                      uu____1486
                     in
                  FStar_All.pipe_right uu____1484
                    (FStar_List.map (fun _0_41  -> String _0_41))
                   in
                List uu____1482)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "z3cliopt",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1514 =
                  let uu____1516 =
                    let uu____1518 = get_z3cliopt ()  in
                    FStar_List.append uu____1518 [s]  in
                  FStar_All.pipe_right uu____1516
                    (FStar_List.map (fun _0_42  -> String _0_42))
                   in
                List uu____1514)), "[option]")), "Z3 command line options");
      (FStar_Getopt.noshort, "z3refresh",
        (FStar_Getopt.ZeroArgs ((fun uu____1528  -> Bool false))),
        "Restart Z3 after each query; useful for ensuring proof robustness");
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1538 = FStar_Util.int_of_string s  in
                Int uu____1538)), "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1548 = FStar_Util.int_of_string s  in
                Int uu____1548)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "z3timeout",
        (FStar_Getopt.OneArg
           (((fun s  ->
                ...
                (let uu____1559 = FStar_Util.int_of_string s  in
                 Int uu____1559))), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "__no_positivity",
       ...
       in
    let uu____1572 = FStar_List.map mk_spec specs  in
    ('h', "help",
      (FStar_Getopt.ZeroArgs
         (fun x  ->
  ...
  fun s  ->
    ...
    | uu____1593 ->
        (FStar_Util.print_string "Wrong argument to codegen flag\n";
         (let uu____1596 = specs ()  in display_usage_aux uu____1596);
  ...
  fun x  ->
    ...
    | uu____1604 ->
        (FStar_Util.print_string "Wrong argument to cardinality flag\n";
         (let uu____1607 = specs ()  in display_usage_aux uu____1607);
         FStar_All.exit (Prims.parse_int "1"))

let settable : Prims.string -> Prims.bool =
  fun uu___49_1616  ->
    match uu___49_1616 with
    | "admit_smt_queries"
      |"cardinality"
       |"debug"
        |"debug_level"
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1640  ->
          ...
          | (uu____1646,x,uu____1648,uu____1649) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1670  ->
          ...
          | (uu____1676,x,uu____1678,uu____1679) -> resettable x))
  
let display_usage : Prims.unit -> Prims.unit =
  fun uu____1684  ->
    let uu____1685 = specs ()  in display_usage_aux uu____1685
  
let fstar_home : Prims.unit -> Prims.string =
  fun uu____1694  ->
    let uu____1695 = get_fstar_home ()  in
...
let set_options : options -> Prims.string -> FStar_Getopt.parse_cmdline_res =
  fun o  ->
    fun s  ->
      ...
      FStar_Getopt.parse_string specs (fun uu____1720  -> ()) s
...
let parse_cmd_line :
  ...
  fun uu____1731  ->
    let res =
      let uu____1733 = specs ()  in
      FStar_Getopt.parse_cmdline uu____1733
        (fun i  ->
           let uu____1736 =
             let uu____1738 = FStar_ST.read file_list_  in
             FStar_List.append uu____1738 [i]  in
           FStar_ST.write file_list_ uu____1736)
       in
    let uu____1746 = FStar_ST.read file_list_  in (res, uu____1746)
  
let file_list : Prims.unit -> Prims.string Prims.list =
  fun uu____1755  -> FStar_ST.read file_list_ 
let restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module ()  in
    (match should_clear with | true  -> clear () | uu____1765 -> init ());
    (let r =
       let uu____1767 = specs ()  in
       FStar_Getopt.parse_cmdline uu____1767 (fun x  -> ())  in
     (let uu____1771 =
        let uu____1774 =
          let uu____1775 =
            FStar_List.map (fun _0_43  -> String _0_43) old_verify_module  in
          List uu____1775  in
        ("verify_module", uu____1774)  in
      set_option' uu____1771);
     r)
  
let should_verify : Prims.string -> Prims.bool =
  fun m  ->
    let uu____1780 = get_lax ()  in
    match uu____1780 with
    | true  -> false
    | uu____1781 ->
        let uu____1782 = get_verify_all ()  in
        (match uu____1782 with
         | true  -> true
         | uu____1783 ->
             let uu____1784 = get_verify_module ()  in
             (match uu____1784 with
              | [] ->
                  let uu____1786 = file_list ()  in
                  FStar_List.existsML
                    (fun f  ->
                         ...
                         let uu____1791 =
                           let uu____1792 =
                             let uu____1793 =
                               ...
                               FStar_String.length uu____1794  in
                             (FStar_String.length f) - uu____1793  in
                           uu____1792 - (Prims.parse_int "1")  in
                         FStar_String.substring f (Prims.parse_int "0")
                           uu____1791
                          in
                       (FStar_String.lowercase f) = m) uu____1786
              | l -> FStar_List.contains (FStar_String.lowercase m) l))
  
let dont_gen_projectors : Prims.string -> Prims.bool =
  fun m  ->
    let uu____1804 = get___temp_no_proj ()  in
    FStar_List.contains m uu____1804
  
let should_print_message : Prims.string -> Prims.bool =
  fun m  ->
    let uu____1809 = should_verify m  in
    match uu____1809 with | true  -> m <> "Prims" | uu____1810 -> false
  
let include_path : Prims.unit -> Prims.string Prims.list =
  fun uu____1814  ->
    let uu____1815 = get_no_default_includes ()  in
    ...
    | uu____1817 ->
        ...
        let uu____1821 =
          ...
          FStar_All.pipe_right uu____1823
           ...
           in
        let uu____1830 =
          let uu____1832 = get_include ()  in
          FStar_List.append uu____1832 ["."]  in
        FStar_List.append uu____1821 uu____1830
  
let find_file : Prims.string -> Prims.string Prims.option =
  fun filename  ->
    let uu____1838 = FStar_Util.is_path_absolute filename  in
    ...
    | uu____1842 ->
        let uu____1843 =
          let uu____1845 = include_path ()  in FStar_List.rev uu____1845  in
        FStar_Util.find_map uu____1843
          (fun p  ->
...
let prims : Prims.unit -> Prims.string =
  fun uu____1853  ->
    let uu____1854 = get_prims ()  in
    match uu____1854 with
    | None  ->
        let filename = "prims.fst"  in
        let uu____1857 = find_file filename  in
             ...
             let uu____1860 =
               let uu____1861 =
                 FStar_Util.format1
                   ...
                   filename
                  in
               FStar_Util.Failure uu____1861  in
             Prims.raise uu____1860)
    | Some x -> x
  
let prepend_output_dir : Prims.string -> Prims.string =
  fun fname  ->
    let uu____1866 = get_odir ()  in
...
let __temp_no_proj : Prims.string -> Prims.bool =
  fun s  ->
    let uu____1872 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____1872 (FStar_List.contains s)
  
let admit_smt_queries : Prims.unit -> Prims.bool =
  fun uu____1877  -> get_admit_smt_queries () 
let check_cardinality : Prims.unit -> Prims.bool =
  fun uu____1880  ->
    let uu____1881 = get_cardinality ()  in uu____1881 = "check"
  
let codegen : Prims.unit -> Prims.string Prims.option =
  fun uu____1885  -> get_codegen () 
let codegen_libs : Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____1890  ->
    let uu____1891 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____1891
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let debug_any : Prims.unit -> Prims.bool =
  fun uu____1900  -> let uu____1901 = get_debug ()  in uu____1901 <> [] 
let debug_at_level : Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____1910 = get_debug ()  in
          FStar_All.pipe_right uu____1910 (FStar_List.contains modul)))
        && (debug_level_geq level)
  
let dep : Prims.unit -> Prims.string Prims.option =
  fun uu____1916  -> get_dep () 
let detail_errors : Prims.unit -> Prims.bool =
  fun uu____1919  -> get_detail_errors () 
let doc : Prims.unit -> Prims.bool = fun uu____1922  -> get_doc () 
let dump_module : Prims.string -> Prims.bool =
  fun s  ->
    let uu____1926 = get_dump_module ()  in
    FStar_All.pipe_right uu____1926 (FStar_List.contains s)
  
let eager_inference : Prims.unit -> Prims.bool =
  fun uu____1931  -> get_eager_inference () 
let explicit_deps : Prims.unit -> Prims.bool =
  fun uu____1934  -> get_explicit_deps () 
let extract_all : Prims.unit -> Prims.bool =
  fun uu____1937  -> get_extract_all () 
let fs_typ_app : Prims.string -> Prims.bool =
  fun filename  ->
    let uu____1941 = FStar_ST.read light_off_files  in
    FStar_List.contains filename uu____1941
  
let full_context_dependency : Prims.unit -> Prims.bool =
  fun uu____1948  -> true 
let hide_genident_nums : Prims.unit -> Prims.bool =
  fun uu____1951  -> get_hide_genident_nums () 
let hide_uvar_nums : Prims.unit -> Prims.bool =
  fun uu____1954  -> get_hide_uvar_nums () 
let hint_info : Prims.unit -> Prims.bool =
  fun uu____1957  -> get_hint_info () 
let indent : Prims.unit -> Prims.bool = fun uu____1960  -> get_indent () 
let initial_fuel : Prims.unit -> Prims.int =
  fun uu____1963  -> get_initial_fuel () 
let initial_ifuel : Prims.unit -> Prims.int =
  fun uu____1966  -> get_initial_ifuel () 
let inline_arith : Prims.unit -> Prims.bool =
  fun uu____1969  -> get_inline_arith () 
let interactive : Prims.unit -> Prims.bool = fun uu____1972  -> get_in () 
let lax : Prims.unit -> Prims.bool = fun uu____1975  -> get_lax () 
let log_queries : Prims.unit -> Prims.bool =
  fun uu____1978  -> get_log_queries () 
let log_types : Prims.unit -> Prims.bool =
  fun uu____1981  -> get_log_types () 
...
let set_ml_ish : Prims.unit -> Prims.unit =
  fun uu____1996  -> set_option "MLish" (Bool true) 
let n_cores : Prims.unit -> Prims.int = fun uu____1999  -> get_n_cores () 
let no_default_includes : Prims.unit -> Prims.bool =
  fun uu____2002  -> get_no_default_includes () 
let no_extract : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2006 = get_no_extract ()  in
    FStar_All.pipe_right uu____2006 (FStar_List.contains s)
  
let no_location_info : Prims.unit -> Prims.bool =
  fun uu____2011  -> get_no_location_info () 
let norm_then_print : Prims.unit -> Prims.bool =
  fun uu____2014  ->
    let uu____2015 = get_print_before_norm ()  in uu____2015 = false
  
let output_dir : Prims.unit -> Prims.string Prims.option =
  fun uu____2019  -> get_odir () 
let print_bound_var_types : Prims.unit -> Prims.bool =
  fun uu____2022  -> get_print_bound_var_types () 
let print_effect_args : Prims.unit -> Prims.bool =
  fun uu____2025  -> get_print_effect_args () 
let print_fuels : Prims.unit -> Prims.bool =
  fun uu____2028  -> get_print_fuels () 
let print_implicits : Prims.unit -> Prims.bool =
  fun uu____2031  -> get_print_implicits () 
let print_real_names : Prims.unit -> Prims.bool =
  fun uu____2034  -> get_prn () 
let print_universes : Prims.unit -> Prims.bool =
  fun uu____2037  -> get_print_universes () 
let print_z3_statistics : Prims.unit -> Prims.bool =
  fun uu____2040  -> get_print_z3_statistics () 
let record_hints : Prims.unit -> Prims.bool =
  fun uu____2043  -> get_record_hints () 
let reuse_hint_for : Prims.unit -> Prims.string Prims.option =
  fun uu____2047  -> get_reuse_hint_for () 
let silent : Prims.unit -> Prims.bool = fun uu____2050  -> get_silent () 
let split_cases : Prims.unit -> Prims.int =
  fun uu____2053  -> get_split_cases () 
let timing : Prims.unit -> Prims.bool = fun uu____2056  -> get_timing () 
let trace_error : Prims.unit -> Prims.bool =
  fun uu____2059  -> get_trace_error () 
let unthrottle_inductives : Prims.unit -> Prims.bool =
  fun uu____2062  -> get_unthrottle_inductives () 
let use_eq_at_higher_order : Prims.unit -> Prims.bool =
  fun uu____2065  -> get_use_eq_at_higher_order () 
let use_hints : Prims.unit -> Prims.bool =
  fun uu____2068  -> get_use_hints () 
let verify_all : Prims.unit -> Prims.bool =
  fun uu____2071  -> get_verify_all () 
let verify_module : Prims.unit -> Prims.string Prims.list =
  fun uu____2075  -> get_verify_module () 
let warn_cardinality : Prims.unit -> Prims.bool =
  fun uu____2078  ->
    let uu____2079 = get_cardinality ()  in uu____2079 = "warn"
  
let warn_default_effects : Prims.unit -> Prims.bool =
  fun uu____2082  -> get_warn_default_effects () 
let warn_top_level_effects : Prims.unit -> Prims.bool =
  fun uu____2085  -> get_warn_top_level_effects () 
let z3_exe : Prims.unit -> Prims.string =
  fun uu____2088  ->
    let uu____2089 = get_smt ()  in
    match uu____2089 with | None  -> FStar_Platform.exe "z3" | Some s -> s
  
let z3_cliopt : Prims.unit -> Prims.string Prims.list =
  fun uu____2095  -> get_z3cliopt () 
let z3_refresh : Prims.unit -> Prims.bool =
  fun uu____2098  -> get_z3refresh () 
...
let z3_timeout : Prims.unit -> Prims.int =
  fun uu____2107  -> get_z3timeout () 
let no_positivity : Prims.unit -> Prims.bool =
  fun uu____2110  -> get_no_positivity () 
let should_extract : Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2114 = no_extract m  in Prims.op_Negation uu____2114) &&
      ((extract_all ()) ||
         (let uu____2115 = get_extract_module ()  in
          match uu____2115 with
          | [] ->
              let uu____2117 = get_extract_namespace ()  in
