...
let display_version : Prims.unit -> Prims.unit =
  fun uu____985  ->
    let uu____986 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____987
        uu____990 uu____993 uu____996 uu____999
       in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____1100 =
                let uu____1101 = let uu____1104 = f ()  in (name, uu____1104)
                   in
                set_option' uu____1101  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x =
                let uu____1115 = let uu____1118 = f x  in (name, uu____1118)
                   in
  ...
  fun uu____1198  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1227 = parse_codegen s  in String uu____1227)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1237 =
                  let uu____1239 =
                    let uu____1241 = get_codegen_lib ()  in s :: uu____1241
                     in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1271 =
                  let uu____1273 =
                    let uu____1275 = get_debug_level ()  in x :: uu____1275
                     in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1312 =
                  let uu____1314 =
                    let uu____1316 = get_dump_module ()  in x :: uu____1316
                     in
           ...
           (((fun s  ->
                let uu____1410 =
                  let uu____1412 =
                    ...
                    FStar_List.map (fun _0_36  -> String _0_36) uu____1414
                     in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1432 = FStar_Util.int_of_string x  in
                Int uu____1432)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try initially (default 2)");
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1442 = FStar_Util.int_of_string x  in
                Int uu____1442)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1489 = FStar_Util.int_of_string x  in
                Int uu____1489)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1499 = FStar_Util.int_of_string x  in
                Int uu____1499)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1509 = FStar_Util.int_of_string x  in
                Int uu____1509)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1526 = FStar_Util.int_of_string x  in
                Int uu____1526)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1543 =
                  let uu____1545 =
                    let uu____1547 = get_no_extract ()  in x :: uu____1547
                     in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1801 =
                  let uu____1803 =
                    let uu____1805 = get___temp_no_proj ()  in x ::
                      uu____1805
                     in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1857 = FStar_Util.int_of_string s  in
                Int uu____1857)), "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1867 = FStar_Util.int_of_string s  in
                Int uu____1867)), "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1877 = FStar_Util.int_of_string s  in
                Int uu____1877)), "[positive integer]")),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____2119
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____2122)
       in
    let uu____2132 =
      let uu____2134 = FStar_ST.read file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____2134
       in
    (res, uu____2132)
                ...
                (fun f  ->
                   ...
                   let f2 =
                     let uu____2182 =
                       let uu____2183 =
                         let uu____2184 =
                           let uu____2185 = FStar_Util.get_file_extension f1
                              in
...
let smtencoding_l_arith_native : Prims.unit -> Prims.bool =
  fun uu____2554  ->
    let uu____2555 = get_smtencoding_l_arith_repr ()  in
    uu____2555 = "native"
