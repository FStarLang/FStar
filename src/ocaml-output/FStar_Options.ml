...
let hint_info: Prims.unit -> Prims.bool = fun uu____2230  -> get_hint_info ()
...
let log_types: Prims.unit -> Prims.bool = fun uu____2261  -> get_log_types ()
...
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____2351  ->
    let uu____2352 = get_smtencoding_l_arith_repr () in uu____2352 = "native"
...
let use_hints: Prims.unit -> Prims.bool = fun uu____2374  -> get_use_hints ()
...
let z3_timeout: Prims.unit -> Prims.int = fun uu____2417  -> get_z3timeout ()
