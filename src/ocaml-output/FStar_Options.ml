...
let display_version: Prims.unit -> Prims.unit =
  fun uu____853  ->
    let uu____854 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____855
        uu____858 uu____861 uu____864 uu____867 in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____964 =
                let uu____965 = let uu____968 = f () in (name, uu____968) in
  ...
  fun uu____1053  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1633 =
                  let uu____1635 =
                    let uu____1637 = get___temp_no_proj () in x :: uu____1637 in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1689 = FStar_Util.int_of_string s in Int uu____1689)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1699 = FStar_Util.int_of_string s in Int uu____1699)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1709 = FStar_Util.int_of_string s in Int uu____1709)),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____1930
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____1933) in
    let uu____1943 =
      let uu____1945 = FStar_ST.read file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1945 in
    (res, uu____1943)
                ...
                (fun f  ->
                   ...
                   let f2 =
                     let uu____1990 =
                       let uu____1991 =
                         let uu____1992 =
                           let uu____1993 = FStar_Util.get_file_extension f1 in
...
let hint_info: Prims.unit -> Prims.bool = fun uu____2163  -> get_hint_info ()
...
let log_types: Prims.unit -> Prims.bool = fun uu____2197  -> get_log_types ()
...
let use_hints: Prims.unit -> Prims.bool = fun uu____2284  -> get_use_hints ()
...
let z3_timeout: Prims.unit -> Prims.int = fun uu____2334  -> get_z3timeout ()
