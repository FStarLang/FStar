...
let get_prims: Prims.unit -> Prims.string Prims.option =
  fun uu____681  -> lookup_opt "prims" (as_option as_string)
let get_print_before_norm: Prims.unit -> Prims.bool =
  fun uu____685  -> lookup_opt "print_before_norm" as_bool
...
let get_split_cases: Prims.unit -> Prims.int =
  fun uu____733  -> lookup_opt "split_cases" as_int
let get_timing: Prims.unit -> Prims.bool =
  fun uu____736  -> lookup_opt "timing" as_bool
let get_trace_error: Prims.unit -> Prims.bool =
  fun uu____739  -> lookup_opt "trace_error" as_bool
let get_unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____742  -> lookup_opt "unthrottle_inductives" as_bool
let get_use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____745  -> lookup_opt "use_eq_at_higher_order" as_bool
let get_use_hints: Prims.unit -> Prims.bool =
  fun uu____748  -> lookup_opt "use_hints" as_bool
let get_use_tactics: Prims.unit -> Prims.bool =
  fun uu____751  -> lookup_opt "use_tactics" as_bool
...
let cons_using_facts_from: Prims.string -> option_val =
  fun s  ->
    ...
    (let uu____1021 = get_using_facts_from () in
...
let add_verify_module: Prims.string -> Prims.unit =
  fun s  ->
    let uu____1033 = cons_verify_module s in
    set_option "verify_module" uu____1033
let rec specs:
  Prims.unit ->
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                ...
                FStar_All.pipe_right uu____1155 (fun _0_33  -> List _0_33))),
             "[module name]")), "");
           ...
           (((fun s  ->
                let uu____1253 =
                  let uu____1255 =
                    ...
                    FStar_List.map (fun _0_35  -> String _0_35) uu____1257 in
      ...
      (FStar_Getopt.noshort, "z3timeout",
        (FStar_Getopt.OneArg
           (((fun s  ->
                ...
                (let uu____1698 = FStar_Util.int_of_string s in
                 Int uu____1698))), "[positive integer]")),
        "Set the Z3 per-query (soft) timeout to [t] seconds (default 5)");
      (FStar_Getopt.noshort, "__no_positivity",
        (FStar_Getopt.ZeroArgs ((fun uu____1705  -> Bool true))),
        "Don't check positivity of inductive types")] in
    let uu____1711 = FStar_List.map mk_spec specs1 in
    ('h', "help",
      (FStar_Getopt.ZeroArgs
         (fun x  ->
            display_usage_aux specs1; FStar_All.exit (Prims.parse_int "0"))),
      "Display this information") :: uu____1711
  ...
  fun s  ->
    ...
    | uu____1732 ->
        (FStar_Util.print_string "Wrong argument to codegen flag\n";
         (let uu____1735 = specs () in display_usage_aux uu____1735);
...
let docs: Prims.unit -> (Prims.string* Prims.string) Prims.list =
  fun uu____1749  ->
    let uu____1750 = specs () in
    FStar_List.map
      (fun uu____1764  ->
         match uu____1764 with
         | (uu____1772,name,uu____1774,doc) -> (name, doc)) uu____1750
let settable: Prims.string -> Prims.bool =
  fun uu___57_1780  ->
    match uu___57_1780 with
    | "admit_smt_queries"
      |"debug"
       |"debug_level"
        |"detail_errors"
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1804  ->
          ...
          | (uu____1810,x,uu____1812,uu____1813) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1834  ->
          ...
          | (uu____1840,x,uu____1842,uu____1843) -> resettable x))
let display_usage: Prims.unit -> Prims.unit =
  fun uu____1848  ->
    let uu____1849 = specs () in display_usage_aux uu____1849
let fstar_home: Prims.unit -> Prims.string =
  fun uu____1858  ->
    let uu____1859 = get_fstar_home () in
...
let set_options: options -> Prims.string -> FStar_Getopt.parse_cmdline_res =
  fun o  ->
    fun s  ->
      ...
      FStar_Getopt.parse_string specs1 (fun uu____1884  -> ()) s
let file_list_: Prims.string Prims.list FStar_ST.ref = FStar_Util.mk_ref []
let parse_cmd_line:
  Prims.unit -> (FStar_Getopt.parse_cmdline_res* Prims.string Prims.list) =
  fun uu____1895  ->
    let res =
      let uu____1897 = specs () in
      FStar_Getopt.parse_cmdline uu____1897
        (fun i  ->
           let uu____1900 =
             let uu____1902 = FStar_ST.read file_list_ in
             FStar_List.append uu____1902 [i] in
           FStar_ST.write file_list_ uu____1900) in
    let uu____1910 =
      let uu____1912 = FStar_ST.read file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1912 in
    (res, uu____1910)
let file_list: Prims.unit -> Prims.string Prims.list =
  fun uu____1921  -> FStar_ST.read file_list_
let restore_cmd_line_options: Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module () in
    if should_clear then clear () else init ();
    (let r =
       let uu____1933 = specs () in
       FStar_Getopt.parse_cmdline uu____1933 (fun x  -> ()) in
     (let uu____1937 =
        let uu____1940 =
          let uu____1941 =
            FStar_List.map (fun _0_43  -> String _0_43) old_verify_module in
          List uu____1941 in
        ("verify_module", uu____1940) in
      set_option' uu____1937);
     r)
let should_verify: Prims.string -> Prims.bool =
  fun m  ->
    let uu____1946 = get_lax () in
    if uu____1946
    then false
    else
      (let uu____1948 = get_verify_all () in
       if uu____1948
       then true
       else
         (let uu____1950 = get_verify_module () in
          match uu____1950 with
          | [] ->
              let uu____1952 = file_list () in
              FStar_List.existsML
                (fun f  ->
                   ...
                   let f2 =
                     let uu____1957 =
                       let uu____1958 =
                         let uu____1959 =
                           let uu____1960 = FStar_Util.get_file_extension f1 in
                           FStar_String.length uu____1960 in
                         (FStar_String.length f1) - uu____1959 in
                       uu____1958 - (Prims.parse_int "1") in
                     FStar_String.substring f1 (Prims.parse_int "0")
                       uu____1957 in
                   (FStar_String.lowercase f2) = m) uu____1952
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
let dont_gen_projectors: Prims.string -> Prims.bool =
  fun m  ->
    let uu____1970 = get___temp_no_proj () in
    FStar_List.contains m uu____1970
let should_print_message: Prims.string -> Prims.bool =
  fun m  ->
    let uu____1975 = should_verify m in
    if uu____1975 then m <> "Prims" else false
let include_path: Prims.unit -> Prims.string Prims.list =
  fun uu____1980  ->
    let uu____1981 = get_no_default_includes () in
    if uu____1981
    then get_include ()
    else
      (let h = fstar_home () in
       ...
       let uu____1996 =
         let uu____1998 = get_include () in
         FStar_List.append uu____1998 ["."] in
       FStar_List.append uu____1987 uu____1996)
let find_file: Prims.string -> Prims.string Prims.option =
  fun filename  ->
    let uu____2004 = FStar_Util.is_path_absolute filename in
    if uu____2004
    then (if FStar_Util.file_exists filename then Some filename else None)
    else
      (let uu____2009 =
         let uu____2011 = include_path () in FStar_List.rev uu____2011 in
       FStar_Util.find_map uu____2009
         (fun p  ->
            let path = FStar_Util.join_paths p filename in
            if FStar_Util.file_exists path then Some path else None))
let prims: Prims.unit -> Prims.string =
  fun uu____2019  ->
    let uu____2020 = get_prims () in
    match uu____2020 with
    | None  ->
        let filename = "prims.fst" in
        let uu____2023 = find_file filename in
             ...
             let uu____2026 =
               let uu____2027 =
                 FStar_Util.format1
                   ...
                   filename in
               FStar_Util.Failure uu____2027 in
             Prims.raise uu____2026)
    | Some x -> x
let prims_basename: Prims.unit -> Prims.string =
  fun uu____2031  ->
    let uu____2032 = prims () in FStar_Util.basename uu____2032
let prepend_output_dir: Prims.string -> Prims.string =
  fun fname  ->
    let uu____2036 = get_odir () in
    match uu____2036 with
    | None  -> fname
    | Some x -> Prims.strcat x (Prims.strcat "/" fname)
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2042 = get___temp_no_proj () in
    FStar_All.pipe_right uu____2042 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____2047  -> get_admit_smt_queries ()
let check_hints: Prims.unit -> Prims.bool =
  fun uu____2050  -> get_check_hints ()
let codegen: Prims.unit -> Prims.string Prims.option =
  fun uu____2054  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____2059  ->
    let uu____2060 = get_codegen_lib () in
    FStar_All.pipe_right uu____2060
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____2069  -> let uu____2070 = get_debug () in uu____2070 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____2079 = get_debug () in
          FStar_All.pipe_right uu____2079 (FStar_List.contains modul)))
        && (debug_level_geq level)
let dep: Prims.unit -> Prims.string Prims.option =
  fun uu____2085  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____2088  -> get_detail_errors ()
let doc: Prims.unit -> Prims.bool = fun uu____2091  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2095 = get_dump_module () in
    FStar_All.pipe_right uu____2095 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____2100  -> get_eager_inference ()
let explicit_deps: Prims.unit -> Prims.bool =
  fun uu____2103  -> get_explicit_deps ()
let extract_all: Prims.unit -> Prims.bool =
  fun uu____2106  -> get_extract_all ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____2110 = FStar_ST.read light_off_files in
    FStar_List.contains filename uu____2110
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____2117  -> true
let hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____2120  -> get_hide_genident_nums ()
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____2123  -> get_hide_uvar_nums ()
let hint_info: Prims.unit -> Prims.bool = fun uu____2126  -> get_hint_info ()
let ide: Prims.unit -> Prims.bool = fun uu____2129  -> get_ide ()
let indent: Prims.unit -> Prims.bool = fun uu____2132  -> get_indent ()
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____2135  ->
    let uu____2136 = get_initial_fuel () in
    let uu____2137 = get_max_fuel () in Prims.min uu____2136 uu____2137
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____2140  ->
    let uu____2141 = get_initial_ifuel () in
    let uu____2142 = get_max_ifuel () in Prims.min uu____2141 uu____2142
let inline_arith: Prims.unit -> Prims.bool =
  fun uu____2145  -> get_inline_arith ()
let interactive: Prims.unit -> Prims.bool =
  fun uu____2148  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____2151  -> get_lax ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____2154  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____2157  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____2160  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____2163  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____2166  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____2169  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____2172  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____2175  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____2178  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____2181  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2185 = get_no_extract () in
    FStar_All.pipe_right uu____2185 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____2190  -> get_no_location_info ()
let norm_then_print: Prims.unit -> Prims.bool =
  fun uu____2193  ->
    let uu____2194 = get_print_before_norm () in uu____2194 = false
let output_dir: Prims.unit -> Prims.string Prims.option =
  fun uu____2198  -> get_odir ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____2201  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____2204  -> get_print_effect_args ()
let print_fuels: Prims.unit -> Prims.bool =
  fun uu____2207  -> get_print_fuels ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____2210  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____2213  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____2216  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____2219  -> get_print_z3_statistics ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____2222  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string Prims.option =
  fun uu____2226  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____2229  -> get_silent ()
let split_cases: Prims.unit -> Prims.int =
  fun uu____2232  -> get_split_cases ()
let timing: Prims.unit -> Prims.bool = fun uu____2235  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____2238  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____2241  -> get_unthrottle_inductives ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____2244  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____2247  -> get_use_hints ()
let use_tactics: Prims.unit -> Prims.bool =
  fun uu____2250  -> get_use_tactics ()
let using_facts_from: Prims.unit -> Prims.string Prims.list Prims.option =
  fun uu____2255  -> get_using_facts_from ()
let verify_all: Prims.unit -> Prims.bool =
  fun uu____2258  -> get_verify_all ()
let verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____2262  -> get_verify_module ()
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____2265  -> get_warn_default_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____2268  ->
    let uu____2269 = get_smt () in
    match uu____2269 with | None  -> FStar_Platform.exe "z3" | Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____2275  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____2278  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____2281  -> get_z3rlimit ()
let z3_rlimit_factor: Prims.unit -> Prims.int =
  fun uu____2284  -> get_z3rlimit_factor ()
let z3_seed: Prims.unit -> Prims.int = fun uu____2287  -> get_z3seed ()
let z3_timeout: Prims.unit -> Prims.int = fun uu____2290  -> get_z3timeout ()
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____2293  -> get_no_positivity ()
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2297 = no_extract m in Prims.op_Negation uu____2297) &&
      ((extract_all ()) ||
         (let uu____2298 = get_extract_module () in
          match uu____2298 with
          | [] ->
              let uu____2300 = get_extract_namespace () in
