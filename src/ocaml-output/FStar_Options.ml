    ...
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____5567)
       in
    let uu____5673 =
      let uu____5676 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____5676
       in
    (res, uu____5673)
...
let smtencoding_l_arith_native : Prims.unit -> Prims.bool =
  fun uu____6334  ->
    let uu____6335 = get_smtencoding_l_arith_repr ()  in
    uu____6335 = "native"
