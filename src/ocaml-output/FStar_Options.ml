...
let debug_level_geq : debug_level_t  ->  Prims.bool = (fun l2 -> (let _126_273 = (get_debug_level ())
in (FStar_All.pipe_right _126_273 (FStar_Util.for_some (fun l1 -> (one_debug_level_geq (dlevel l1) l2))))))
...
if (doc = "") then begin
(let _126_281 = (let _126_280 = (FStar_Util.colorize_bold flag)
in (FStar_Util.format1 "  --%s\n" _126_280))
in (FStar_Util.print_string _126_281))
end else begin
...
if (doc = "") then begin
(let _126_287 = (let _126_286 = (FStar_Util.colorize_bold flag)
in (let _126_285 = (FStar_Util.colorize_bold argname)
in (FStar_Util.format2 "  --%s %s\n" _126_286 _126_285)))
in (FStar_Util.print_string _126_287))
end else begin
(let _126_290 = (let _126_289 = (FStar_Util.colorize_bold flag)
in (let _126_288 = (FStar_Util.colorize_bold argname)
in (FStar_Util.format3 "  --%s %s  %s\n" _126_289 _126_288 doc)))
in (FStar_Util.print_string _126_290))
end
end)
end)) specs)))
...
| () -> begin
(let _126_297 = (let _126_296 = (f ())
in ((name), (_126_296)))
in (set_option' _126_297))
end))
...
let g = (fun x -> (let _126_302 = (let _126_301 = (f x)
in ((name), (_126_301)))
in (set_option' _126_302)))
...
let cons_extract_module : Prims.string  ->  option_val = (fun s -> (let _126_309 = (let _126_308 = (let _126_306 = (get_extract_module ())
in ((FStar_String.lowercase s))::_126_306)
in (FStar_All.pipe_right _126_308 (FStar_List.map (fun _126_307 -> String (_126_307)))))
in List (_126_309)))


let add_extract_module : Prims.string  ->  Prims.unit = (fun s -> (let _126_312 = (cons_extract_module s)
in (set_option "extract_module" _126_312)))


let cons_verify_module : Prims.string  ->  option_val = (fun s -> (let _126_318 = (let _126_317 = (let _126_315 = (get_verify_module ())
in ((FStar_String.lowercase s))::_126_315)
in (FStar_All.pipe_right _126_317 (FStar_List.map (fun _126_316 -> String (_126_316)))))
in List (_126_318)))


let add_verify_module : Prims.string  ->  Prims.unit = (fun s -> (let _126_321 = (cons_verify_module s)
in (set_option "verify_module" _126_321)))
...
end)), ("[true|false]")))), ("Admit SMT queries, unsafe! (default \'false\')")))::(((FStar_Getopt.noshort), ("cardinality"), (FStar_Getopt.OneArg ((((fun x -> (let _126_332 = (validate_cardinality x)
in String (_126_332)))), ("[off|warn|check]")))), ("Check cardinality constraints on inductive data types (default \'off\')")))::(((FStar_Getopt.noshort), ("codegen"), (FStar_Getopt.OneArg ((((fun s -> (let _126_336 = (parse_codegen s)
in String (_126_336)))), ("[OCaml|FSharp|Kremlin]")))), ("Generate code for execution")))::(((FStar_Getopt.noshort), ("codegen-lib"), (FStar_Getopt.OneArg ((((fun s -> (let _126_343 = (let _126_342 = (let _126_340 = (get_codegen_lib ())
in (s)::_126_340)
in (FStar_All.pipe_right _126_342 (FStar_List.map (fun _126_341 -> String (_126_341)))))
in List (_126_343)))), ("[namespace]")))), ("External runtime library (i.e. M.N.x extracts to M.N.X instead of M_N.x)")))::(((FStar_Getopt.noshort), ("debug"), (FStar_Getopt.OneArg ((((fun x -> (let _126_350 = (let _126_349 = (let _126_347 = (get_debug ())
in (x)::_126_347)
in (FStar_All.pipe_right _126_349 (FStar_List.map (fun _126_348 -> String (_126_348)))))
in List (_126_350)))), ("[module name]")))), ("Print lots of debugging information while checking module")))::(((FStar_Getopt.noshort), ("debug_level"), (FStar_Getopt.OneArg ((((fun x -> (let _126_357 = (let _126_356 = (let _126_354 = (get_debug_level ())
in (x)::_126_354)
in (FStar_All.pipe_right _126_356 (FStar_List.map (fun _126_355 -> String (_126_355)))))
in List (_126_357)))), ("[Low|Medium|High|Extreme|...]")))), ("Control the verbosity of debugging info")))::(((FStar_Getopt.noshort), ("dep"), (FStar_Getopt.OneArg ((((fun x -> if ((x = "make") || (x = "graph")) then begin
String (x)
end else begin
...
| () -> begin
Bool (true)
end)))), ("Extract Markdown documentation files for the input modules, as well as an index. Output is written to --odir directory.")))::(((FStar_Getopt.noshort), ("dump_module"), (FStar_Getopt.OneArg ((((fun x -> (let _126_370 = (let _126_368 = (let _126_366 = (get_dump_module ())
in (x)::_126_366)
in (FStar_All.pipe_right _126_368 (FStar_List.map (fun _126_367 -> String (_126_367)))))
in (FStar_All.pipe_right _126_370 (fun _126_369 -> List (_126_369)))))), ("[module name]")))), ("")))::(((FStar_Getopt.noshort), ("eager_inference"), (FStar_Getopt.ZeroArgs ((fun _25_214 -> (match (()) with
| () -> begin
Bool (true)
...
| () -> begin
Bool (true)
end)))), ("Allow the use of t<t1,...,tn> syntax for type applications;\n        brittle since it clashes with the integer less-than operator")))::(((FStar_Getopt.noshort), ("fstar_home"), (FStar_Getopt.OneArg ((((fun _126_377 -> String (_126_377))), ("[dir]")))), ("Set the FSTAR_HOME variable to [dir]")))::(((FStar_Getopt.noshort), ("hide_genident_nums"), (FStar_Getopt.ZeroArgs ((fun _25_218 -> (match (()) with
| () -> begin
Bool (true)
...
| () -> begin
Bool (true)
end)))), ("Interactive mode; reads input from stdin")))::(((FStar_Getopt.noshort), ("include"), (FStar_Getopt.OneArg ((((fun s -> (let _126_388 = (let _126_387 = (let _126_385 = (get_include ())
in (FStar_List.append _126_385 ((s)::[])))
in (FStar_All.pipe_right _126_387 (FStar_List.map (fun _126_386 -> String (_126_386)))))
in List (_126_388)))), ("[path]")))), ("A directory in which to search for files included on the command line")))::(((FStar_Getopt.noshort), ("indent"), (FStar_Getopt.ZeroArgs ((fun _25_223 -> (match (()) with
| () -> begin
Bool (true)
end)))), ("Parses and outputs the files on the command line")))::(((FStar_Getopt.noshort), ("initial_fuel"), (FStar_Getopt.OneArg ((((fun x -> (let _126_393 = (FStar_Util.int_of_string x)
in Int (_126_393)))), ("[non-negative integer]")))), ("Number of unrolling of recursive functions to try initially (default 2)")))::(((FStar_Getopt.noshort), ("initial_ifuel"), (FStar_Getopt.OneArg ((((fun x -> (let _126_397 = (FStar_Util.int_of_string x)
in Int (_126_397)))), ("[non-negative integer]")))), ("Number of unrolling of inductive datatypes to try at first (default 1)")))::(((FStar_Getopt.noshort), ("inline_arith"), (FStar_Getopt.ZeroArgs ((fun _25_226 -> (match (()) with
| () -> begin
Bool (true)
...
| () -> begin
Bool (true)
end)))), ("Log the Z3 queries in several queries-*.smt2 files, as we go")))::(((FStar_Getopt.noshort), ("max_fuel"), (FStar_Getopt.OneArg ((((fun x -> (let _126_405 = (FStar_Util.int_of_string x)
in Int (_126_405)))), ("[non-negative integer]")))), ("Number of unrolling of recursive functions to try at most (default 8)")))::(((FStar_Getopt.noshort), ("max_ifuel"), (FStar_Getopt.OneArg ((((fun x -> (let _126_409 = (FStar_Util.int_of_string x)
in Int (_126_409)))), ("[non-negative integer]")))), ("Number of unrolling of inductive datatypes to try at most (default 2)")))::(((FStar_Getopt.noshort), ("min_fuel"), (FStar_Getopt.OneArg ((((fun x -> (let _126_413 = (FStar_Util.int_of_string x)
in Int (_126_413)))), ("[non-negative integer]")))), ("Minimum number of unrolling of recursive functions to try (default 1)")))::(((FStar_Getopt.noshort), ("MLish"), (FStar_Getopt.ZeroArgs ((fun _25_233 -> (match (()) with
| () -> begin
Bool (true)
end)))), ("Introduce unification variables that are only dependent on the type variables in the context")))::(((FStar_Getopt.noshort), ("n_cores"), (FStar_Getopt.OneArg ((((fun x -> (let _126_418 = (FStar_Util.int_of_string x)
in Int (_126_418)))), ("[positive integer]")))), ("Maximum number of cores to use for the solver (implies detail_errors = false) (default 1)")))::(((FStar_Getopt.noshort), ("no_default_includes"), (FStar_Getopt.ZeroArgs ((fun _25_235 -> (match (()) with
| () -> begin
Bool (true)
end)))), ("Ignore the default module search paths")))::(((FStar_Getopt.noshort), ("no_extract"), (FStar_Getopt.OneArg ((((fun x -> (let _126_426 = (let _126_425 = (let _126_423 = (get_no_extract ())
in (x)::_126_423)
in (FStar_All.pipe_right _126_425 (FStar_List.map (fun _126_424 -> String (_126_424)))))
in List (_126_426)))), ("[module name]")))), ("Do not extract code from this module")))::(((FStar_Getopt.noshort), ("no_location_info"), (FStar_Getopt.ZeroArgs ((fun _25_237 -> (match (()) with
| () -> begin
Bool (true)
end)))), ("Suppress location information in the generated OCaml output (only relevant with --codegen OCaml)")))::(((FStar_Getopt.noshort), ("odir"), (FStar_Getopt.OneArg ((((fun _126_429 -> String (_126_429))), ("[dir]")))), ("Place output in directory [dir]")))::(((FStar_Getopt.noshort), ("prims"), (FStar_Getopt.OneArg ((((fun _126_431 -> String (_126_431))), ("file")))), ("")))::(((FStar_Getopt.noshort), ("print_before_norm"), (FStar_Getopt.ZeroArgs ((fun _25_238 -> (match (()) with
| () -> begin
Bool (true)
...
| () -> begin
Bool (true)
end)))), ("Record a database of hints for efficient proof replay")))::(((FStar_Getopt.noshort), ("reuse_hint_for"), (FStar_Getopt.OneArg ((((fun _126_442 -> String (_126_442))), ("top-level name in the current module")))), ("Optimistically, attempt using the recorded hint for \'f\' when trying to verify some other term \'g\'")))::(((FStar_Getopt.noshort), ("show_signatures"), (FStar_Getopt.OneArg ((((fun x -> (let _126_449 = (let _126_448 = (let _126_446 = (get_show_signatures ())
in (x)::_126_446)
in (FStar_All.pipe_right _126_448 (FStar_List.map (fun _126_447 -> String (_126_447)))))
in List (_126_449)))), ("[module name]")))), ("Show the checked signatures for all top-level symbols in the module")))::(((FStar_Getopt.noshort), ("silent"), (FStar_Getopt.ZeroArgs ((fun _25_248 -> (match (()) with
| () -> begin
Bool (true)
end)))), (" ")))::(((FStar_Getopt.noshort), ("smt"), (FStar_Getopt.OneArg ((((fun _126_452 -> String (_126_452))), ("[path]")))), ("Path to the SMT solver (usually Z3, but could be any SMT2-compatible solver)")))::(((FStar_Getopt.noshort), ("split_cases"), (FStar_Getopt.OneArg ((((fun n -> (let _126_456 = (FStar_Util.int_of_string n)
in Int (_126_456)))), ("[positive integer]")))), ("Partition VC of a match into groups of [n] cases")))::(((FStar_Getopt.noshort), ("stratified"), (FStar_Getopt.ZeroArgs ((fun _25_250 -> (match (()) with
| () -> begin
Bool (true)
...
| () -> begin
Bool (true)
end)))), ("With automatic dependencies, verify all the dependencies, not just the files passed on the command-line.")))::(((FStar_Getopt.noshort), ("verify_module"), (FStar_Getopt.OneArg (((cons_verify_module), ("[module name]")))), ("Name of the module to verify")))::(((FStar_Getopt.noshort), ("__temp_no_proj"), (FStar_Getopt.OneArg ((((fun x -> (let _126_471 = (let _126_470 = (let _126_468 = (get___temp_no_proj ())
in (x)::_126_468)
in (FStar_All.pipe_right _126_470 (FStar_List.map (fun _126_469 -> String (_126_469)))))
in List (_126_471)))), ("[module name]")))), ("Don\'t generate projectors for this module")))::((('v'), ("version"), (FStar_Getopt.ZeroArgs ((fun _25_258 -> (
...
| () -> begin
Bool (false)
end)))), ("Restart Z3 after each query; useful for ensuring proof robustness")))::(((FStar_Getopt.noshort), ("z3rlimit"), (FStar_Getopt.OneArg ((((fun s -> (let _126_478 = (FStar_Util.int_of_string s)
in Int (_126_478)))), ("[positive integer]")))), ("Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)")))::(((FStar_Getopt.noshort), ("z3seed"), (FStar_Getopt.OneArg ((((fun s -> (let _126_482 = (FStar_Util.int_of_string s)
in Int (_126_482)))), ("[positive integer]")))), ("Set the Z3 random seed (default 0)")))::(((FStar_Getopt.noshort), ("z3timeout"), (FStar_Getopt.OneArg ((((fun s -> (

let _25_267 = (FStar_Util.print_string "Warning: z3timeout ignored with universes; use z3rlimit instead\n")
in (let _126_486 = (FStar_Util.int_of_string s)
in Int (_126_486))))), ("[positive integer]")))), ("Set the Z3 per-query (soft) timeout to [t] seconds (default 5)")))::[]
in (let _126_488 = (FStar_List.map mk_spec specs)
in ((('h'), ("help"), (FStar_Getopt.ZeroArgs ((fun x -> (

let _25_271 = (display_usage_aux specs)
in (FStar_All.exit (Prims.parse_int "0")))))), ("Display this information")))::_126_488))
end))
...
let _25_281 = (let _126_490 = (specs ())
in (display_usage_aux _126_490))
...
let _25_291 = (let _126_492 = (specs ())
in (display_usage_aux _126_492))
in (FStar_All.exit (Prims.parse_int "1"))))
end))
...
let res = (let _126_514 = (specs ())
in (FStar_Getopt.parse_cmdline _126_514 (fun i -> (let _126_513 = (let _126_512 = (FStar_ST.read file_list_)
in (FStar_List.append _126_512 ((i)::[])))
in (FStar_ST.op_Colon_Equals file_list_ _126_513)))))
in (let _126_515 = (FStar_ST.read file_list_)
in ((res), (_126_515))))
end))
...
let r = (let _126_521 = (specs ())
in (FStar_Getopt.parse_cmdline _126_521 (fun x -> ())))
in (

let _25_377 = (let _126_525 = (let _126_524 = (let _126_523 = (FStar_List.map (fun _126_522 -> String (_126_522)) old_verify_module)
in List (_126_523))
in (("verify_module"), (_126_524)))
in (set_option' _126_525))
in r)))))
...
| [] -> begin
(let _126_531 = (file_list ())
in (FStar_List.existsML (fun f -> (

let f = (FStar_Util.basename f)
in (

let f = (let _126_530 = (((FStar_String.length f) - (let _126_529 = (FStar_Util.get_file_extension f)
in (FStar_String.length _126_529))) - (Prims.parse_int "1"))
in (FStar_String.substring f (Prims.parse_int "0") _126_530))
in ((FStar_String.lowercase f) = m)))) _126_531))
end
| l -> begin
...
let dont_gen_projectors : Prims.string  ->  Prims.bool = (fun m -> (let _126_534 = (get___temp_no_proj ())
in (FStar_List.contains m _126_534)))
...
in (let _126_543 = (let _126_540 = (FStar_All.pipe_right defs (FStar_List.map (fun x -> (Prims.strcat h x))))
in (FStar_All.pipe_right _126_540 (FStar_List.filter FStar_Util.file_exists)))
in (let _126_542 = (let _126_541 = (get_include ())
in (FStar_List.append _126_541 ((".")::[])))
in (FStar_List.append _126_543 _126_542)))))
end
end))
...
(let _126_548 = (let _126_546 = (include_path ())
in (FStar_List.rev _126_546))
in (FStar_Util.find_map _126_548 (fun p -> (
...
| None -> begin
(let _126_552 = (let _126_551 = (FStar_Util.format1 "unable to find required file \"%s\" in the module search path.\n" filename)
in FStar_Util.Failure (_126_551))
in (Prims.raise _126_552))
end))
end
| Some (x) -> begin
x
...
let __temp_no_proj : Prims.string  ->  Prims.bool = (fun s -> (let _126_557 = (get___temp_no_proj ())
in (FStar_All.pipe_right _126_557 (FStar_List.contains s))))
...
| () -> begin
(let _126_567 = (get_codegen_lib ())
in (FStar_All.pipe_right _126_567 (FStar_List.map (fun x -> (FStar_Util.split x ".")))))
end))
...
let debug_at_level : Prims.string  ->  debug_level_t  ->  Prims.bool = (fun modul level -> (((modul = "") || (let _126_574 = (get_debug ())
in (FStar_All.pipe_right _126_574 (FStar_List.contains modul)))) && (debug_level_geq level)))
...
let dump_module : Prims.string  ->  Prims.bool = (fun s -> (let _126_583 = (get_dump_module ())
in (FStar_All.pipe_right _126_583 (FStar_List.contains s))))
...
let no_extract : Prims.string  ->  Prims.bool = (fun s -> (let _126_630 = (get_no_extract ())
in (FStar_All.pipe_right _126_630 (FStar_List.contains s))))
