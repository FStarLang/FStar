...
let display_version : Prims.unit -> Prims.unit =
  fun uu____859  ->
    let uu____860 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____861
        uu____864 uu____867 uu____870 uu____873
       in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____970 =
                let uu____971 = let uu____974 = f ()  in (name, uu____974)
                   in
  ...
  fun uu____1061  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1090 = parse_codegen s  in String uu____1090)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1100 =
                  let uu____1102 =
                    let uu____1104 = get_codegen_lib ()  in s :: uu____1104
                     in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1134 =
                  let uu____1136 =
                    let uu____1138 = get_debug_level ()  in x :: uu____1138
                     in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1175 =
                  let uu____1177 =
                    let uu____1179 = get_dump_module ()  in x :: uu____1179
                     in
           ...
           (((fun s  ->
                let uu____1273 =
                  let uu____1275 =
                    ...
                    FStar_List.map (fun _0_36  -> String _0_36) uu____1277
                     in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1295 = FStar_Util.int_of_string x  in
                Int uu____1295)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try initially (default 2)");
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1305 = FStar_Util.int_of_string x  in
                Int uu____1305)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1343 = FStar_Util.int_of_string x  in
                Int uu____1343)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1353 = FStar_Util.int_of_string x  in
                Int uu____1353)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1363 = FStar_Util.int_of_string x  in
                Int uu____1363)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1380 = FStar_Util.int_of_string x  in
                Int uu____1380)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1397 =
                  let uu____1399 =
                    let uu____1401 = get_no_extract ()  in x :: uu____1401
                     in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1662 =
                  let uu____1664 =
                    let uu____1666 = get___temp_no_proj ()  in x ::
                      uu____1666
                     in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1718 = FStar_Util.int_of_string s  in
                Int uu____1718)), "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1728 = FStar_Util.int_of_string s  in
                Int uu____1728)), "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1738 = FStar_Util.int_of_string s  in
                Int uu____1738)), "[positive integer]")),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____1980
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____1983)
       in
    let uu____1993 =
      let uu____1995 = FStar_ST.read file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1995
       in
    (res, uu____1993)
                ...
                (fun f  ->
                   ...
                   let f2 =
                     let uu____2040 =
                       let uu____2041 =
                         let uu____2042 =
                           let uu____2043 = FStar_Util.get_file_extension f1
                              in
