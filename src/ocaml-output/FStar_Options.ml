...
let peek : Prims.unit -> optionstate =
  fun uu____303  ->
    let uu____304 = FStar_ST.op_Bang fstar_options  in
    FStar_List.hd uu____304
...
let display_version : Prims.unit -> Prims.unit =
  fun uu____1552  ->
    let uu____1553 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____1554
        uu____1565 uu____1576 uu____1587 uu____1598
       in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____1757 =
                let uu____1758 = let uu____1763 = f ()  in (name, uu____1763)
                   in
                set_option' uu____1758  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x =
                let uu____1774 = let uu____1779 = f x  in (name, uu____1779)
                   in
  ...
  fun uu____1882  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1947 = parse_codegen s  in String uu____1947)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1965 =
                  let uu____1968 =
                    let uu____1971 = get_codegen_lib ()  in s :: uu____1971
                     in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2025 =
                  let uu____2028 =
                    let uu____2031 = get_debug_level ()  in x :: uu____2031
                     in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2114 =
                  let uu____2117 =
                    let uu____2120 = get_dump_module ()  in x :: uu____2120
                     in
           ...
           (((fun s  ->
                let uu____2314 =
                  let uu____2317 =
                    ...
                    FStar_List.map (fun _0_38  -> String _0_38) uu____2320
                     in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2354 = FStar_Util.int_of_string x  in
                Int uu____2354)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try initially (default 2)");
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2372 = FStar_Util.int_of_string x  in
                Int uu____2372)), "[non-negative integer]")),
           ...
           (((fun s  ->
                let uu____2418 =
                  let uu____2421 =
                    ...
                    FStar_List.map (fun _0_39  -> String _0_39) uu____2424
                     in
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2472 = FStar_Util.int_of_string x  in
                Int uu____2472)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2490 = FStar_Util.int_of_string x  in
                Int uu____2490)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2508 = FStar_Util.int_of_string x  in
                Int uu____2508)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2540 = FStar_Util.int_of_string x  in
                Int uu____2540)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2572 =
                  let uu____2575 =
                    let uu____2578 = get_no_extract ()  in x :: uu____2578
                     in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____3060 =
                  let uu____3063 =
                    let uu____3066 = get___temp_no_proj ()  in x ::
                      uu____3066
                     in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____3164 = FStar_Util.int_of_string s  in
                Int uu____3164)), "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____3182 = FStar_Util.int_of_string s  in
                Int uu____3182)), "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____3200 = FStar_Util.int_of_string s  in
                Int uu____3200)), "[positive integer]")),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____3626
        (fun i  ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____3632)
       in
    let uu____3674 =
      let uu____3677 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____3677
       in
    (res, uu____3674)
                ...
                (fun f  ->
                   ...
                   let f2 =
                     let uu____3769 =
                       let uu____3770 =
                         let uu____3771 =
                           let uu____3772 = FStar_Util.get_file_extension f1
                              in
...
let smtencoding_l_arith_native : Prims.unit -> Prims.bool =
  fun uu____4226  ->
    let uu____4227 = get_smtencoding_l_arith_repr ()  in
    uu____4227 = "native"
