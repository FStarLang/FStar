...
let (get_eager_embedding : unit -> Prims.bool) =
  fun uu____1398  -> lookup_opt "eager_embedding" as_bool 
let (get_eager_subtyping : unit -> Prims.bool) =
  fun uu____1403  -> lookup_opt "eager_subtyping" as_bool 
let (get_expose_interfaces : unit -> Prims.bool) =
  fun uu____1408  -> lookup_opt "expose_interfaces" as_bool 
let (get_extract :
  unit -> Prims.string Prims.list FStar_Pervasives_Native.option) =
  fun uu____1417  -> lookup_opt "extract" (as_option (as_list as_string)) 
let (get_extract_module : unit -> Prims.string Prims.list) =
  fun uu____1430  -> lookup_opt "extract_module" (as_list as_string) 
let (get_extract_namespace : unit -> Prims.string Prims.list) =
  fun uu____1439  -> lookup_opt "extract_namespace" (as_list as_string) 
let (get_fs_typ_app : unit -> Prims.bool) =
  fun uu____1446  -> lookup_opt "fs_typ_app" as_bool 
let (get_hide_uvar_nums : unit -> Prims.bool) =
  fun uu____1451  -> lookup_opt "hide_uvar_nums" as_bool 
let (get_hint_info : unit -> Prims.bool) =
  fun uu____1456  -> lookup_opt "hint_info" as_bool 
let (get_hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____1463  -> lookup_opt "hint_file" (as_option as_string) 
let (get_in : unit -> Prims.bool) =
  fun uu____1470  -> lookup_opt "in" as_bool 
let (get_ide : unit -> Prims.bool) =
  fun uu____1475  -> lookup_opt "ide" as_bool 
let (get_include : unit -> Prims.string Prims.list) =
  fun uu____1482  -> lookup_opt "include" (as_list as_string) 
let (get_indent : unit -> Prims.bool) =
  fun uu____1489  -> lookup_opt "indent" as_bool 
let (get_initial_fuel : unit -> Prims.int) =
  fun uu____1494  -> lookup_opt "initial_fuel" as_int 
let (get_initial_ifuel : unit -> Prims.int) =
  fun uu____1499  -> lookup_opt "initial_ifuel" as_int 
let (get_lax : unit -> Prims.bool) =
  fun uu____1504  -> lookup_opt "lax" as_bool 
let (get_load : unit -> Prims.string Prims.list) =
  fun uu____1511  -> lookup_opt "load" (as_list as_string) 
let (get_log_queries : unit -> Prims.bool) =
  fun uu____1518  -> lookup_opt "log_queries" as_bool 
let (get_log_types : unit -> Prims.bool) =
  fun uu____1523  -> lookup_opt "log_types" as_bool 
let (get_max_fuel : unit -> Prims.int) =
  fun uu____1528  -> lookup_opt "max_fuel" as_int 
let (get_max_ifuel : unit -> Prims.int) =
  fun uu____1533  -> lookup_opt "max_ifuel" as_int 
let (get_min_fuel : unit -> Prims.int) =
  fun uu____1538  -> lookup_opt "min_fuel" as_int 
let (get_MLish : unit -> Prims.bool) =
  fun uu____1543  -> lookup_opt "MLish" as_bool 
let (get_n_cores : unit -> Prims.int) =
  fun uu____1548  -> lookup_opt "n_cores" as_int 
let (get_no_default_includes : unit -> Prims.bool) =
  fun uu____1553  -> lookup_opt "no_default_includes" as_bool 
let (get_no_extract : unit -> Prims.string Prims.list) =
  fun uu____1560  -> lookup_opt "no_extract" (as_list as_string) 
let (get_no_location_info : unit -> Prims.bool) =
  fun uu____1567  -> lookup_opt "no_location_info" as_bool 
let (get_no_smt : unit -> Prims.bool) =
  fun uu____1572  -> lookup_opt "no_smt" as_bool 
let (get_normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____1577  -> lookup_opt "normalize_pure_terms_for_extraction" as_bool 
let (get_odir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____1584  -> lookup_opt "odir" (as_option as_string) 
let (get_ugly : unit -> Prims.bool) =
  fun uu____1591  -> lookup_opt "ugly" as_bool 
let (get_prims : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____1598  -> lookup_opt "prims" (as_option as_string) 
let (get_print_bound_var_types : unit -> Prims.bool) =
  fun uu____1605  -> lookup_opt "print_bound_var_types" as_bool 
let (get_print_effect_args : unit -> Prims.bool) =
  fun uu____1610  -> lookup_opt "print_effect_args" as_bool 
let (get_print_full_names : unit -> Prims.bool) =
  fun uu____1615  -> lookup_opt "print_full_names" as_bool 
let (get_print_implicits : unit -> Prims.bool) =
  fun uu____1620  -> lookup_opt "print_implicits" as_bool 
let (get_print_universes : unit -> Prims.bool) =
  fun uu____1625  -> lookup_opt "print_universes" as_bool 
let (get_print_z3_statistics : unit -> Prims.bool) =
  fun uu____1630  -> lookup_opt "print_z3_statistics" as_bool 
let (get_prn : unit -> Prims.bool) =
  fun uu____1635  -> lookup_opt "prn" as_bool 
let (get_query_stats : unit -> Prims.bool) =
  fun uu____1640  -> lookup_opt "query_stats" as_bool 
let (get_record_hints : unit -> Prims.bool) =
  fun uu____1645  -> lookup_opt "record_hints" as_bool 
let (get_reuse_hint_for :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____1652  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let (get_silent : unit -> Prims.bool) =
  fun uu____1659  -> lookup_opt "silent" as_bool 
let (get_smt : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____1666  -> lookup_opt "smt" (as_option as_string) 
let (get_smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____1673  -> lookup_opt "smtencoding.elim_box" as_bool 
let (get_smtencoding_nl_arith_repr : unit -> Prims.string) =
  fun uu____1678  -> lookup_opt "smtencoding.nl_arith_repr" as_string 
let (get_smtencoding_l_arith_repr : unit -> Prims.string) =
  fun uu____1683  -> lookup_opt "smtencoding.l_arith_repr" as_string 
let (get_tactic_raw_binders : unit -> Prims.bool) =
  fun uu____1688  -> lookup_opt "tactic_raw_binders" as_bool 
let (get_tactic_trace : unit -> Prims.bool) =
  fun uu____1693  -> lookup_opt "tactic_trace" as_bool 
let (get_tactic_trace_d : unit -> Prims.int) =
  fun uu____1698  -> lookup_opt "tactic_trace_d" as_int 
let (get_tactics_nbe : unit -> Prims.bool) =
  fun uu____1703  -> lookup_opt "__tactics_nbe" as_bool 
    ...
    fun typ  ->
      fun str_val  ->
        try
          ...
          | Const c -> c
          | IntStr uu____2737 ->
              let uu____2738 = FStar_Util.safe_int_of_string str_val  in
          ...
          | PostProcessed (pp,elem_spec) ->
              let uu____2766 = parse_opt_val opt_name elem_spec str_val  in
              pp uu____2766
...
and (specs : unit -> FStar_Getopt.opt Prims.list) =
  fun uu____5712  ->
    let uu____5715 = specs_with_types ()  in
    FStar_List.map
      (fun uu____5742  ->
         match uu____5742 with
         | (short,long,typ,doc) ->
             let uu____5758 =
               let uu____5770 = arg_spec_of_opt_type long typ  in
               (short, long, uu____5770, doc)  in
             mk_spec uu____5758) uu____5715

let (settable : Prims.string -> Prims.bool) =
  fun uu___83_5780  ->
    match uu___83_5780 with
    | "abort_on" -> true
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____5855  ->
          ...
          | (uu____5867,x,uu____5869,uu____5870) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____5932  ->
          ...
          | (uu____5944,x,uu____5946,uu____5947) -> resettable x))
  
let (display_usage : unit -> unit) =
  fun uu____5958  ->
    let uu____5959 = specs ()  in display_usage_aux uu____5959
...
let (uu___is_File_argument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | File_argument uu____5983 -> true
    | uu____5984 -> false
  
let (__proj__File_argument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | File_argument uu____5991 -> uu____5991
  ...
  fun uu____6047  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____6052 =
             let uu____6055 = FStar_ST.op_Bang file_list_  in
             FStar_List.append uu____6055 [i]  in
           FStar_ST.op_Colon_Equals file_list_ uu____6052)
       in
    let uu____6104 =
      let uu____6107 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____6107
       in
    (res, uu____6104)
  
let (file_list : unit -> Prims.string Prims.list) =
  fun uu____6141  -> FStar_ST.op_Bang file_list_ 
let (restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res)
  ...
  fun should_clear  ->
    ...
    (let r =
       let uu____6176 = specs ()  in
       FStar_Getopt.parse_cmdline uu____6176 (fun x  -> ())  in
     (let uu____6182 =
        let uu____6187 =
          let uu____6188 = FStar_List.map mk_string old_verify_module  in
          List uu____6188  in
        ("verify_module", uu____6187)  in
      set_option' uu____6182);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____6198 =
        let uu____6199 =
          let uu____6200 =
            let uu____6201 = FStar_Util.get_file_extension f1  in
            FStar_String.length uu____6201  in
          (FStar_String.length f1) - uu____6200  in
        uu____6199 - (Prims.parse_int "1")  in
      FStar_String.substring f1 (Prims.parse_int "0") uu____6198  in
    FStar_String.lowercase f2
  
let (should_verify : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____6207 = get_lax ()  in
    if uu____6207
    then false
    else
...
let (should_verify_file : Prims.string -> Prims.bool) =
  fun fn  ->
    let uu____6217 = module_name_of_file_name fn  in should_verify uu____6217
  
let (dont_gen_projectors : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____6223 = get___temp_no_proj ()  in
    FStar_List.contains m uu____6223
  
let (should_print_message : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____6231 = should_verify m  in
    if uu____6231 then m <> "Prims" else false
  
let (include_path : unit -> Prims.string Prims.list) =
  fun uu____6239  ->
    let uu____6240 = get_no_default_includes ()  in
    if uu____6240
    then get_include ()
    else
      (let lib_paths =
         ...
         | FStar_Pervasives_Native.None  ->
             ...
             let uu____6256 =
               FStar_All.pipe_right defs
                ...
                in
             FStar_All.pipe_right uu____6256
               (FStar_List.filter FStar_Util.file_exists)
         | FStar_Pervasives_Native.Some s -> [s]  in
       let uu____6270 =
         let uu____6273 = get_include ()  in
         FStar_List.append uu____6273 ["."]  in
       FStar_List.append lib_paths uu____6270)
  
let (find_file : Prims.string -> Prims.string FStar_Pervasives_Native.option)
  =
  let file_map = FStar_Util.smap_create (Prims.parse_int "100")  in
  fun filename  ->
    let uu____6286 = FStar_Util.smap_try_find file_map filename  in
    match uu____6286 with
    | FStar_Pervasives_Native.Some f -> FStar_Pervasives_Native.Some f
    | FStar_Pervasives_Native.None  ->
        let result =
          try
            let uu____6302 = FStar_Util.is_path_absolute filename  in
            if uu____6302
            then
              ...
              (let uu____6309 =
                 let uu____6312 = include_path ()  in
                 FStar_List.rev uu____6312  in
               FStar_Util.find_map uu____6309
                 (fun p  ->
                    let path =
                      if p = "."
                      then filename
          ...
          with | uu____6328 -> FStar_Pervasives_Native.None  in
        (match result with
...
let (prims : unit -> Prims.string) =
  fun uu____6337  ->
    let uu____6338 = get_prims ()  in
    match uu____6338 with
    | FStar_Pervasives_Native.None  ->
        let filename = "prims.fst"  in
        let uu____6342 = find_file filename  in
...
let (prims_basename : unit -> Prims.string) =
  fun uu____6352  ->
    let uu____6353 = prims ()  in FStar_Util.basename uu____6353
  
let (pervasives : unit -> Prims.string) =
  fun uu____6358  ->
    let filename = "FStar.Pervasives.fst"  in
    let uu____6360 = find_file filename  in
...
let (pervasives_basename : unit -> Prims.string) =
  fun uu____6369  ->
    let uu____6370 = pervasives ()  in FStar_Util.basename uu____6370
  
let (pervasives_native_basename : unit -> Prims.string) =
  fun uu____6375  ->
    let filename = "FStar.Pervasives.Native.fst"  in
    let uu____6377 = find_file filename  in
...
let (prepend_cache_dir : Prims.string -> Prims.string) =
  fun fpath  ->
    let uu____6396 = get_cache_dir ()  in
    match uu____6396 with
    | FStar_Pervasives_Native.None  -> fpath
    | FStar_Pervasives_Native.Some x ->
        let uu____6400 = FStar_Util.basename fpath  in
        FStar_Util.join_paths x uu____6400
  ...
  fun ns  ->
    ...
    let uu____6474 =
      FStar_All.pipe_right ns
       ...
       in
    FStar_All.pipe_right uu____6474 FStar_List.rev
  
let (__temp_no_proj : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____6544 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____6544 (FStar_List.contains s)
  
let (__temp_fast_implicits : unit -> Prims.bool) =
  fun uu____6553  -> lookup_opt "__temp_fast_implicits" as_bool 
let (admit_smt_queries : unit -> Prims.bool) =
  fun uu____6558  -> get_admit_smt_queries () 
let (admit_except : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____6565  -> get_admit_except () 
let (cache_checked_modules : unit -> Prims.bool) =
  fun uu____6570  -> get_cache_checked_modules () 
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | OCaml  -> true | uu____6581 -> false
  
let (uu___is_FSharp : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | FSharp  -> true | uu____6587 -> false
  
let (uu___is_Kremlin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Kremlin  -> true | uu____6593 -> false
  
let (uu___is_Plugin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Plugin  -> true | uu____6599 -> false
  
let (codegen : unit -> codegen_t FStar_Pervasives_Native.option) =
  fun uu____6606  ->
    let uu____6607 = get_codegen ()  in
    FStar_Util.map_opt uu____6607
      (fun uu___84_6611  ->
         match uu___84_6611 with
         | "OCaml" -> OCaml
         | "FSharp" -> FSharp
         | "Kremlin" -> Kremlin
         | "Plugin" -> Plugin
         | uu____6612 -> failwith "Impossible")
  
let (codegen_libs : unit -> Prims.string Prims.list Prims.list) =
  fun uu____6621  ->
    let uu____6622 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____6622
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let (debug_any : unit -> Prims.bool) =
  fun uu____6639  -> let uu____6640 = get_debug ()  in uu____6640 <> [] 
let (debug_module : Prims.string -> Prims.bool) =
  fun modul  ->
    let uu____6650 = get_debug ()  in
    FStar_All.pipe_right uu____6650 (FStar_List.contains modul)
  
let (debug_at_level : Prims.string -> debug_level_t -> Prims.bool) =
  fun modul  ->
    fun level  ->
      (let uu____6667 = get_debug ()  in
       FStar_All.pipe_right uu____6667 (FStar_List.contains modul)) &&
        (debug_level_geq level)
  
let (defensive : unit -> Prims.bool) =
  fun uu____6676  -> let uu____6677 = get_defensive ()  in uu____6677 <> "no" 
let (defensive_fail : unit -> Prims.bool) =
  fun uu____6682  ->
    let uu____6683 = get_defensive ()  in uu____6683 = "fail"
  
let (dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____6690  -> get_dep () 
let (detail_errors : unit -> Prims.bool) =
  fun uu____6695  -> get_detail_errors () 
let (detail_hint_replay : unit -> Prims.bool) =
  fun uu____6700  -> get_detail_hint_replay () 
let (doc : unit -> Prims.bool) = fun uu____6705  -> get_doc () 
let (dump_module : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____6711 = get_dump_module ()  in
    FStar_All.pipe_right uu____6711 (FStar_List.contains s)
  
let (eager_embedding : unit -> Prims.bool) =
  fun uu____6720  -> get_eager_embedding () 
let (eager_subtyping : unit -> Prims.bool) =
  fun uu____6725  -> get_eager_subtyping () 
let (expose_interfaces : unit -> Prims.bool) =
  fun uu____6730  -> get_expose_interfaces () 
let (fs_typ_app : Prims.string -> Prims.bool) =
  fun filename  ->
    let uu____6736 = FStar_ST.op_Bang light_off_files  in
    FStar_List.contains filename uu____6736
  
let (full_context_dependency : unit -> Prims.bool) = fun uu____6766  -> true 
let (hide_uvar_nums : unit -> Prims.bool) =
  fun uu____6771  -> get_hide_uvar_nums () 
let (hint_info : unit -> Prims.bool) =
  fun uu____6776  -> (get_hint_info ()) || (get_query_stats ()) 
let (hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____6783  -> get_hint_file () 
let (ide : unit -> Prims.bool) = fun uu____6788  -> get_ide () 
let (indent : unit -> Prims.bool) = fun uu____6793  -> get_indent () 
let (initial_fuel : unit -> Prims.int) =
  fun uu____6798  ->
    let uu____6799 = get_initial_fuel ()  in
    let uu____6800 = get_max_fuel ()  in Prims.min uu____6799 uu____6800
  
let (initial_ifuel : unit -> Prims.int) =
  fun uu____6805  ->
    let uu____6806 = get_initial_ifuel ()  in
    let uu____6807 = get_max_ifuel ()  in Prims.min uu____6806 uu____6807
  
let (interactive : unit -> Prims.bool) =
  fun uu____6812  -> (get_in ()) || (get_ide ()) 
...
let (log_queries : unit -> Prims.bool) =
  fun uu____6834  -> get_log_queries () 
...
let (set_ml_ish : unit -> unit) =
  fun uu____6864  -> set_option "MLish" (Bool true) 
let (n_cores : unit -> Prims.int) = fun uu____6869  -> get_n_cores () 
let (no_default_includes : unit -> Prims.bool) =
  fun uu____6874  -> get_no_default_includes () 
let (no_extract : Prims.string -> Prims.bool) =
  fun s  ->
    let s1 = FStar_String.lowercase s  in
    let uu____6881 = get_no_extract ()  in
    FStar_All.pipe_right uu____6881
      (FStar_Util.for_some (fun f  -> (FStar_String.lowercase f) = s1))
  
let (normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____6892  -> get_normalize_pure_terms_for_extraction () 
let (no_location_info : unit -> Prims.bool) =
  fun uu____6897  -> get_no_location_info () 
let (no_smt : unit -> Prims.bool) = fun uu____6902  -> get_no_smt () 
let (output_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____6909  -> get_odir () 
let (ugly : unit -> Prims.bool) = fun uu____6914  -> get_ugly () 
let (print_bound_var_types : unit -> Prims.bool) =
  fun uu____6919  -> get_print_bound_var_types () 
let (print_effect_args : unit -> Prims.bool) =
  fun uu____6924  -> get_print_effect_args () 
let (print_implicits : unit -> Prims.bool) =
  fun uu____6929  -> get_print_implicits () 
let (print_real_names : unit -> Prims.bool) =
  fun uu____6934  -> (get_prn ()) || (get_print_full_names ()) 
let (print_universes : unit -> Prims.bool) =
  fun uu____6939  -> get_print_universes () 
let (print_z3_statistics : unit -> Prims.bool) =
  fun uu____6944  -> (get_print_z3_statistics ()) || (get_query_stats ()) 
let (query_stats : unit -> Prims.bool) =
  fun uu____6949  -> get_query_stats () 
let (record_hints : unit -> Prims.bool) =
  fun uu____6954  -> get_record_hints () 
let (reuse_hint_for : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____6961  -> get_reuse_hint_for () 
let (silent : unit -> Prims.bool) = fun uu____6966  -> get_silent () 
let (smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____6971  -> get_smtencoding_elim_box () 
let (smtencoding_nl_arith_native : unit -> Prims.bool) =
  fun uu____6976  ->
    let uu____6977 = get_smtencoding_nl_arith_repr ()  in
    uu____6977 = "native"
  
let (smtencoding_nl_arith_wrapped : unit -> Prims.bool) =
  fun uu____6982  ->
    let uu____6983 = get_smtencoding_nl_arith_repr ()  in
    uu____6983 = "wrapped"
  
let (smtencoding_nl_arith_default : unit -> Prims.bool) =
  fun uu____6988  ->
    let uu____6989 = get_smtencoding_nl_arith_repr ()  in
    uu____6989 = "boxwrap"
  
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____6994  ->
    let uu____6995 = get_smtencoding_l_arith_repr ()  in
    uu____6995 = "native"
  
let (smtencoding_l_arith_default : unit -> Prims.bool) =
  fun uu____7000  ->
    let uu____7001 = get_smtencoding_l_arith_repr ()  in
    uu____7001 = "boxwrap"
  
let (tactic_raw_binders : unit -> Prims.bool) =
  fun uu____7006  -> get_tactic_raw_binders () 
let (tactic_trace : unit -> Prims.bool) =
  fun uu____7011  -> get_tactic_trace () 
let (tactic_trace_d : unit -> Prims.int) =
  fun uu____7016  -> get_tactic_trace_d () 
let (tactics_nbe : unit -> Prims.bool) =
  fun uu____7021  -> get_tactics_nbe () 
let (timing : unit -> Prims.bool) = fun uu____7026  -> get_timing () 
let (trace_error : unit -> Prims.bool) =
  fun uu____7031  -> get_trace_error () 
let (unthrottle_inductives : unit -> Prims.bool) =
  fun uu____7036  -> get_unthrottle_inductives () 
let (unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____7041  -> get_unsafe_tactic_exec () 
let (use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____7046  -> get_use_eq_at_higher_order () 
let (use_hints : unit -> Prims.bool) = fun uu____7051  -> get_use_hints () 
let (use_hint_hashes : unit -> Prims.bool) =
  fun uu____7056  -> get_use_hint_hashes () 
let (use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____7063  -> get_use_native_tactics () 
let (use_tactics : unit -> Prims.bool) =
  fun uu____7068  -> get_use_tactics () 
let (using_facts_from :
  ...
  =
  fun uu____7081  ->
    let uu____7082 = get_using_facts_from ()  in
...
let (vcgen_optimize_bind_as_seq : unit -> Prims.bool) =
  fun uu____7120  ->
    let uu____7121 = get_vcgen_optimize_bind_as_seq ()  in
    FStar_Option.isSome uu____7121
  
let (vcgen_decorate_with_type : unit -> Prims.bool) =
  fun uu____7128  ->
    let uu____7129 = get_vcgen_optimize_bind_as_seq ()  in
    match uu____7129 with
    | FStar_Pervasives_Native.Some "with_type" -> true
    | uu____7132 -> false
  
let (warn_default_effects : unit -> Prims.bool) =
  fun uu____7139  -> get_warn_default_effects () 
let (z3_exe : unit -> Prims.string) =
  fun uu____7144  ->
    let uu____7145 = get_smt ()  in
    match uu____7145 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
  
let (z3_cliopt : unit -> Prims.string Prims.list) =
  fun uu____7155  -> get_z3cliopt () 
...
let (z3_rlimit_factor : unit -> Prims.int) =
  fun uu____7170  -> get_z3rlimit_factor () 
let (z3_seed : unit -> Prims.int) = fun uu____7175  -> get_z3seed () 
let (use_two_phase_tc : unit -> Prims.bool) =
  fun uu____7180  ->
    (get_use_two_phase_tc ()) &&
      (let uu____7182 = lax ()  in Prims.op_Negation uu____7182)
  
let (no_positivity : unit -> Prims.bool) =
  fun uu____7187  -> get_no_positivity () 
let (ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____7192  -> get_ml_no_eta_expand_coertions () 
let (warn_error : unit -> Prims.string) =
  fun uu____7197  -> get_warn_error () 
let (use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____7202  -> get_use_extracted_interfaces () 
let (should_extract : Prims.string -> Prims.bool) =
  fun m  ->
    let m1 = FStar_String.lowercase m  in
    let uu____7209 = get_extract ()  in
    match uu____7209 with
    | FStar_Pervasives_Native.Some extract_setting ->
        ((let uu____7220 =
            let uu____7233 = get_no_extract ()  in
            let uu____7236 = get_extract_namespace ()  in
            let uu____7239 = get_extract_module ()  in
            (uu____7233, uu____7236, uu____7239)  in
            ...
            FStar_All.pipe_right setting
              (FStar_Util.try_find
                 (fun uu____7364  ->
                    ...
                    | (path,uu____7372) -> matches_path m_components path))
             in
          match uu____7330 with
          | FStar_Pervasives_Native.None  -> false
          | FStar_Pervasives_Native.Some (uu____7383,flag) -> flag))
    | FStar_Pervasives_Native.None  ->
        let should_extract_namespace m2 =
          let uu____7403 = get_extract_namespace ()  in
        ...
        let should_extract_module m2 =
          let uu____7419 = get_extract_module ()  in
          ...
          | l ->
           ...
           in
        (let uu____7431 = no_extract m1  in Prims.op_Negation uu____7431) &&
          (let uu____7433 =
             let uu____7442 = get_extract_namespace ()  in
             let uu____7445 = get_extract_module ()  in
             (uu____7442, uu____7445)  in
