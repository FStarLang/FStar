...
let load: Prims.unit -> Prims.string option = fun uu____2248  -> get_load ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____2251  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____2254  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____2257  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____2260  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____2263  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____2266  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____2269  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____2272  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____2275  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____2278  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2282 = get_no_extract () in
    FStar_All.pipe_right uu____2282 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____2287  -> get_no_location_info ()
...
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____2409  -> get_no_positivity ()
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2413 = no_extract m in Prims.op_Negation uu____2413) &&
      ((extract_all ()) ||
         (let uu____2414 = get_extract_module () in
          match uu____2414 with
          | [] ->
              let uu____2416 = get_extract_namespace () in
