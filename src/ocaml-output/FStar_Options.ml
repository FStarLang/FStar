...
end), "[true|false]")), "Admit SMT queries, unsafe! (default \'false\')"))::((FStar_Getopt.noshort, "cardinality", FStar_Getopt.OneArg (((fun x -> (let _113_302 = (validate_cardinality x)
...
in List (_113_313))), "[namespace]")), "External runtime library"))::((FStar_Getopt.noshort, "debug", FStar_Getopt.OneArg (((fun x -> (let _113_320 = (let _113_319 = (let _113_317 = (get_debug ())
in (x)::_113_317)
in (FStar_All.pipe_right _113_319 (FStar_List.map (fun _113_318 -> String (_113_318)))))
in List (_113_320))), "[module name]")), "Print lots of debugging information while checking module"))::((FStar_Getopt.noshort, "debug_level", FStar_Getopt.OneArg (((fun x -> (let _113_327 = (let _113_326 = (let _113_324 = (get_debug_level ())
in (x)::_113_324)
...
in Int (_113_384))), "[positive integer]")), "Maximum number of cores to use for the solver (implies detail_errors = false) (default 1)"))::((FStar_Getopt.noshort, "no_default_includes", FStar_Getopt.ZeroArgs ((fun _24_219 -> (match (()) with
| () -> begin
Bool (true)
...
in Int (_113_418))), "[positive integer]")), "Partition VC of a match into groups of [n] cases"))::((FStar_Getopt.noshort, "timing", FStar_Getopt.ZeroArgs ((fun _24_232 -> (match (()) with
| () -> begin
Bool (true)
...
in Int (_113_438))), "[positive integer]")), "Set the Z3 per-query (soft) timeout to [t] seconds (default 5)"))::[]
