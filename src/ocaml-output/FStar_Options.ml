...
let display_version : Prims.unit -> Prims.unit =
  fun uu____868  ->
    let uu____869 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____870
        uu____873 uu____876 uu____879 uu____882
       in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____979 =
                let uu____980 = let uu____983 = f ()  in (name, uu____983)
                   in
  ...
  fun uu____1070  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1099 = parse_codegen s  in String uu____1099)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1109 =
                  let uu____1111 =
                    let uu____1113 = get_codegen_lib ()  in s :: uu____1113
                     in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1143 =
                  let uu____1145 =
                    let uu____1147 = get_debug_level ()  in x :: uu____1147
                     in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1184 =
                  let uu____1186 =
                    let uu____1188 = get_dump_module ()  in x :: uu____1188
                     in
           ...
           (((fun s  ->
                let uu____1290 =
                  let uu____1292 =
                    ...
                    FStar_List.map (fun _0_37  -> String _0_37) uu____1294
                     in
      ...
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1322 = FStar_Util.int_of_string x  in
                Int uu____1322)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                ...
                Int uu____1380)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1397 = FStar_Util.int_of_string x  in
                Int uu____1397)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1414 =
                  let uu____1416 =
                    let uu____1418 = get_no_extract ()  in x :: uu____1418
                     in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1672 =
                  let uu____1674 =
                    let uu____1676 = get___temp_no_proj ()  in x ::
                      uu____1676
                     in
      ...
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1748 = FStar_Util.int_of_string s  in
                Int uu____1748)), "[positive integer]")),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____1991
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____1994)
       in
    let uu____2004 =
      let uu____2006 = FStar_ST.read file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____2006
       in
    (res, uu____2004)
                ...
                (fun f  ->
                   ...
                   let f2 =
                     let uu____2051 =
                       let uu____2052 =
                         let uu____2053 =
                           let uu____2054 = FStar_Util.get_file_extension f1
                              in
...
let smtencoding_l_arith_native : Prims.unit -> Prims.bool =
  fun uu____2363  ->
    let uu____2364 = get_smtencoding_l_arith_repr ()  in
    uu____2364 = "native"
