...
let (parse_warn_error_set_get :
  ...
  let set1 f =
    let uu____2342 = FStar_ST.op_Bang r  in
    match uu____2342 with
    | FStar_Pervasives_Native.None  ->
        FStar_ST.op_Colon_Equals r (FStar_Pervasives_Native.Some f)
    | uu____2433 -> failwith "Multiple initialization of FStar.Options"  in
  let get uu____2454 =
...
let (parse_warn_error : Prims.string -> error_flag Prims.list) =
  fun s  ->
    let uu____2594 = FStar_Pervasives_Native.snd parse_warn_error_set_get ()
       in
    uu____2594 s
...
let (get_option : Prims.string -> option_val) =
  fun s  ->
    let uu____2718 =
      let uu____2721 = internal_peek ()  in
      FStar_Util.smap_try_find uu____2721 s  in
    match uu____2718 with
    | FStar_Pervasives_Native.None  ->
        let uu____2724 =
          let uu____2726 = FStar_String.op_Hat s " not found"  in
          FStar_String.op_Hat "Impossible: option " uu____2726  in
        failwith uu____2724
    | FStar_Pervasives_Native.Some s1 -> s1
  
let lookup_opt :
  'uuuuuu2738 . Prims.string -> (option_val -> 'uuuuuu2738) -> 'uuuuuu2738 =
  fun s  -> fun c  -> let uu____2756 = get_option s  in c uu____2756 
let (get_abort_on : unit -> Prims.int) =
  fun uu____2763  -> lookup_opt "abort_on" as_int 
let (get_admit_smt_queries : unit -> Prims.bool) =
  fun uu____2772  -> lookup_opt "admit_smt_queries" as_bool 
let (get_admit_except : unit -> Prims.string FStar_Pervasives_Native.option)
  = fun uu____2783  -> lookup_opt "admit_except" (as_option as_string) 
...
let (get_cache_checked_modules : unit -> Prims.bool) =
  fun uu____2816  -> lookup_opt "cache_checked_modules" as_bool 
let (get_cache_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____2827  -> lookup_opt "cache_dir" (as_option as_string) 
let (get_cache_off : unit -> Prims.bool) =
  fun uu____2839  -> lookup_opt "cache_off" as_bool 
let (get_print_cache_version : unit -> Prims.bool) =
  fun uu____2848  -> lookup_opt "print_cache_version" as_bool 
...
let (get_debug : unit -> Prims.string Prims.list) =
  fun uu____2896  -> lookup_opt "debug" as_comma_string_list 
let (get_debug_level : unit -> Prims.string Prims.list) =
  fun uu____2909  -> lookup_opt "debug_level" as_comma_string_list 
let (get_defensive : unit -> Prims.string) =
  fun uu____2920  -> lookup_opt "defensive" as_string 
let (get_dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____2931  -> lookup_opt "dep" (as_option as_string) 
let (get_detail_errors : unit -> Prims.bool) =
  fun uu____2943  -> lookup_opt "detail_errors" as_bool 
let (get_detail_hint_replay : unit -> Prims.bool) =
  fun uu____2952  -> lookup_opt "detail_hint_replay" as_bool 
let (get_dump_module : unit -> Prims.string Prims.list) =
  fun uu____2963  -> lookup_opt "dump_module" (as_list as_string) 
let (get_eager_subtyping : unit -> Prims.bool) =
  fun uu____2975  -> lookup_opt "eager_subtyping" as_bool 
let (get_expose_interfaces : unit -> Prims.bool) =
  fun uu____2984  -> lookup_opt "expose_interfaces" as_bool 
let (get_extract :
  unit -> Prims.string Prims.list FStar_Pervasives_Native.option) =
  fun uu____2997  -> lookup_opt "extract" (as_option (as_list as_string)) 
let (get_extract_module : unit -> Prims.string Prims.list) =
  fun uu____3016  -> lookup_opt "extract_module" (as_list as_string) 
let (get_extract_namespace : unit -> Prims.string Prims.list) =
  fun uu____3030  -> lookup_opt "extract_namespace" (as_list as_string) 
let (get_force : unit -> Prims.bool) =
  fun uu____3042  -> lookup_opt "force" as_bool 
let (get_fs_typ_app : unit -> Prims.bool) =
  fun uu____3051  -> lookup_opt "fs_typ_app" as_bool 
let (get_hide_uvar_nums : unit -> Prims.bool) =
  fun uu____3060  -> lookup_opt "hide_uvar_nums" as_bool 
let (get_hint_info : unit -> Prims.bool) =
  fun uu____3069  -> lookup_opt "hint_info" as_bool 
let (get_hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3080  -> lookup_opt "hint_dir" (as_option as_string) 
let (get_hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3094  -> lookup_opt "hint_file" (as_option as_string) 
let (get_in : unit -> Prims.bool) =
  fun uu____3106  -> lookup_opt "in" as_bool 
let (get_ide : unit -> Prims.bool) =
  fun uu____3115  -> lookup_opt "ide" as_bool 
let (get_lsp : unit -> Prims.bool) =
  fun uu____3124  -> lookup_opt "lsp" as_bool 
let (get_include : unit -> Prims.string Prims.list) =
  fun uu____3135  -> lookup_opt "include" (as_list as_string) 
let (get_print : unit -> Prims.bool) =
  fun uu____3147  -> lookup_opt "print" as_bool 
let (get_print_in_place : unit -> Prims.bool) =
  fun uu____3156  -> lookup_opt "print_in_place" as_bool 
let (get_initial_fuel : unit -> Prims.int) =
  fun uu____3165  -> lookup_opt "initial_fuel" as_int 
let (get_initial_ifuel : unit -> Prims.int) =
  fun uu____3174  -> lookup_opt "initial_ifuel" as_int 
let (get_keep_query_captions : unit -> Prims.bool) =
  fun uu____3183  -> lookup_opt "keep_query_captions" as_bool 
let (get_lax : unit -> Prims.bool) =
  fun uu____3192  -> lookup_opt "lax" as_bool 
let (get_load : unit -> Prims.string Prims.list) =
  fun uu____3203  -> lookup_opt "load" (as_list as_string) 
let (get_log_queries : unit -> Prims.bool) =
  fun uu____3215  -> lookup_opt "log_queries" as_bool 
let (get_log_types : unit -> Prims.bool) =
  fun uu____3224  -> lookup_opt "log_types" as_bool 
let (get_max_fuel : unit -> Prims.int) =
  fun uu____3233  -> lookup_opt "max_fuel" as_int 
let (get_max_ifuel : unit -> Prims.int) =
  fun uu____3242  -> lookup_opt "max_ifuel" as_int 
let (get_min_fuel : unit -> Prims.int) =
  fun uu____3251  -> lookup_opt "min_fuel" as_int 
let (get_MLish : unit -> Prims.bool) =
  fun uu____3260  -> lookup_opt "MLish" as_bool 
let (get_no_default_includes : unit -> Prims.bool) =
  fun uu____3269  -> lookup_opt "no_default_includes" as_bool 
let (get_no_extract : unit -> Prims.string Prims.list) =
  fun uu____3280  -> lookup_opt "no_extract" (as_list as_string) 
let (get_no_load_fstartaclib : unit -> Prims.bool) =
  fun uu____3292  -> lookup_opt "no_load_fstartaclib" as_bool 
let (get_no_location_info : unit -> Prims.bool) =
  fun uu____3301  -> lookup_opt "no_location_info" as_bool 
let (get_no_plugins : unit -> Prims.bool) =
  fun uu____3310  -> lookup_opt "no_plugins" as_bool 
let (get_no_smt : unit -> Prims.bool) =
  fun uu____3319  -> lookup_opt "no_smt" as_bool 
let (get_normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____3328  -> lookup_opt "normalize_pure_terms_for_extraction" as_bool 
let (get_odir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3339  -> lookup_opt "odir" (as_option as_string) 
let (get_ugly : unit -> Prims.bool) =
  fun uu____3351  -> lookup_opt "ugly" as_bool 
let (get_prims : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3362  -> lookup_opt "prims" (as_option as_string) 
let (get_print_bound_var_types : unit -> Prims.bool) =
  fun uu____3374  -> lookup_opt "print_bound_var_types" as_bool 
let (get_print_effect_args : unit -> Prims.bool) =
  fun uu____3383  -> lookup_opt "print_effect_args" as_bool 
let (get_print_expected_failures : unit -> Prims.bool) =
  fun uu____3392  -> lookup_opt "print_expected_failures" as_bool 
let (get_print_full_names : unit -> Prims.bool) =
  fun uu____3401  -> lookup_opt "print_full_names" as_bool 
let (get_print_implicits : unit -> Prims.bool) =
  fun uu____3410  -> lookup_opt "print_implicits" as_bool 
let (get_print_universes : unit -> Prims.bool) =
  fun uu____3419  -> lookup_opt "print_universes" as_bool 
let (get_print_z3_statistics : unit -> Prims.bool) =
  fun uu____3428  -> lookup_opt "print_z3_statistics" as_bool 
let (get_prn : unit -> Prims.bool) =
  fun uu____3437  -> lookup_opt "prn" as_bool 
let (get_quake_lo : unit -> Prims.int) =
  fun uu____3446  -> lookup_opt "quake_lo" as_int 
let (get_quake_hi : unit -> Prims.int) =
  fun uu____3455  -> lookup_opt "quake_hi" as_int 
let (get_quake_keep : unit -> Prims.bool) =
  fun uu____3464  -> lookup_opt "quake_keep" as_bool 
let (get_query_stats : unit -> Prims.bool) =
  fun uu____3473  -> lookup_opt "query_stats" as_bool 
let (get_record_hints : unit -> Prims.bool) =
  fun uu____3482  -> lookup_opt "record_hints" as_bool 
let (get_record_options : unit -> Prims.bool) =
  fun uu____3491  -> lookup_opt "record_options" as_bool 
let (get_retry : unit -> Prims.bool) =
  fun uu____3500  -> lookup_opt "retry" as_bool 
let (get_reuse_hint_for :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3511  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let (get_silent : unit -> Prims.bool) =
  fun uu____3523  -> lookup_opt "silent" as_bool 
let (get_smt : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3534  -> lookup_opt "smt" (as_option as_string) 
let (get_smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____3546  -> lookup_opt "smtencoding.elim_box" as_bool 
let (get_smtencoding_nl_arith_repr : unit -> Prims.string) =
  fun uu____3555  -> lookup_opt "smtencoding.nl_arith_repr" as_string 
let (get_smtencoding_l_arith_repr : unit -> Prims.string) =
  fun uu____3564  -> lookup_opt "smtencoding.l_arith_repr" as_string 
let (get_smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____3573  -> lookup_opt "smtencoding.valid_intro" as_bool 
let (get_smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____3582  -> lookup_opt "smtencoding.valid_elim" as_bool 
let (get_tactic_raw_binders : unit -> Prims.bool) =
  fun uu____3591  -> lookup_opt "tactic_raw_binders" as_bool 
let (get_tactics_failhard : unit -> Prims.bool) =
  fun uu____3600  -> lookup_opt "tactics_failhard" as_bool 
let (get_tactics_info : unit -> Prims.bool) =
  fun uu____3609  -> lookup_opt "tactics_info" as_bool 
let (get_tactic_trace : unit -> Prims.bool) =
  fun uu____3618  -> lookup_opt "tactic_trace" as_bool 
let (get_tactic_trace_d : unit -> Prims.int) =
  fun uu____3627  -> lookup_opt "tactic_trace_d" as_int 
let (get_tactics_nbe : unit -> Prims.bool) =
  fun uu____3636  -> lookup_opt "__tactics_nbe" as_bool 
let (get_tcnorm : unit -> Prims.bool) =
  fun uu____3645  -> lookup_opt "tcnorm" as_bool 
let (get_timing : unit -> Prims.bool) =
  fun uu____3654  -> lookup_opt "timing" as_bool 
let (get_trace_error : unit -> Prims.bool) =
  fun uu____3663  -> lookup_opt "trace_error" as_bool 
let (get_unthrottle_inductives : unit -> Prims.bool) =
  fun uu____3672  -> lookup_opt "unthrottle_inductives" as_bool 
let (get_unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____3681  -> lookup_opt "unsafe_tactic_exec" as_bool 
let (get_use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____3690  -> lookup_opt "use_eq_at_higher_order" as_bool 
let (get_use_hints : unit -> Prims.bool) =
  fun uu____3699  -> lookup_opt "use_hints" as_bool 
let (get_use_hint_hashes : unit -> Prims.bool) =
  fun uu____3708  -> lookup_opt "use_hint_hashes" as_bool 
let (get_use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3719  -> lookup_opt "use_native_tactics" (as_option as_string) 
let (get_use_tactics : unit -> Prims.bool) =
  fun uu____3731  ->
    let uu____3732 = lookup_opt "no_tactics" as_bool  in
...
let (get_verify_module : unit -> Prims.string Prims.list) =
  fun uu____3779  -> lookup_opt "verify_module" (as_list as_string) 
let (get___temp_no_proj : unit -> Prims.string Prims.list) =
  fun uu____3793  -> lookup_opt "__temp_no_proj" (as_list as_string) 
let (get_version : unit -> Prims.bool) =
  fun uu____3805  -> lookup_opt "version" as_bool 
let (get_warn_default_effects : unit -> Prims.bool) =
  fun uu____3814  -> lookup_opt "warn_default_effects" as_bool 
let (get_z3cliopt : unit -> Prims.string Prims.list) =
  fun uu____3825  -> lookup_opt "z3cliopt" (as_list as_string) 
let (get_z3refresh : unit -> Prims.bool) =
  fun uu____3837  -> lookup_opt "z3refresh" as_bool 
let (get_z3rlimit : unit -> Prims.int) =
  fun uu____3846  -> lookup_opt "z3rlimit" as_int 
let (get_z3rlimit_factor : unit -> Prims.int) =
  fun uu____3855  -> lookup_opt "z3rlimit_factor" as_int 
let (get_z3seed : unit -> Prims.int) =
  fun uu____3864  -> lookup_opt "z3seed" as_int 
let (get_use_two_phase_tc : unit -> Prims.bool) =
  fun uu____3873  -> lookup_opt "use_two_phase_tc" as_bool 
let (get_no_positivity : unit -> Prims.bool) =
  fun uu____3882  -> lookup_opt "__no_positivity" as_bool 
let (get_ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____3891  -> lookup_opt "__ml_no_eta_expand_coertions" as_bool 
let (get_warn_error : unit -> Prims.string Prims.list) =
  fun uu____3902  -> lookup_opt "warn_error" (as_list as_string) 
let (get_use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____3914  -> lookup_opt "use_extracted_interfaces" as_bool 
let (get_use_nbe : unit -> Prims.bool) =
  fun uu____3923  -> lookup_opt "use_nbe" as_bool 
let (get_use_nbe_for_extraction : unit -> Prims.bool) =
  fun uu____3932  -> lookup_opt "use_nbe_for_extraction" as_bool 
...
let (get_profile :
  unit -> Prims.string Prims.list FStar_Pervasives_Native.option) =
  fun uu____3954  -> lookup_opt "profile" (as_option (as_list as_string)) 
let (get_profile_group_by_decl : unit -> Prims.bool) =
  fun uu____3971  -> lookup_opt "profile_group_by_decl" as_bool 
...
let (debug_level_geq : debug_level_t -> Prims.bool) =
  fun l2  ->
    let uu____4031 = get_debug_level ()  in
       ...
       (fun d  ->
          let uu____4075 =
            FStar_All.pipe_right sub_dirs
              (FStar_List.map
                 (fun s  ->
                    let uu____4091 = FStar_String.op_Hat "/" s  in
                    FStar_String.op_Hat d uu____4091))
             in
          d :: uu____4075))
...
let (display_version : unit -> unit) =
  fun uu____4130  ->
    let uu____4131 =
      let uu____4133 = FStar_ST.op_Bang _version  in
      let uu____4156 = FStar_ST.op_Bang _platform  in
      let uu____4179 = FStar_ST.op_Bang _compiler  in
      let uu____4202 = FStar_ST.op_Bang _date  in
      let uu____4225 = FStar_ST.op_Bang _commit  in
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____4133
        uu____4156 uu____4179 uu____4202 uu____4225
       in
    FStar_Util.print_string uu____4131
  
let display_usage_aux :
  'uuuuuu4256 'uuuuuu4257 .
    ('uuuuuu4256 * Prims.string * 'uuuuuu4257 FStar_Getopt.opt_variant *
  ...
  fun specs  ->
    ...
    FStar_List.iter
      (fun uu____4312  ->
         ...
         | (uu____4325,flag,p,doc) ->
             (match p with
              | FStar_Getopt.ZeroArgs ig ->
                  if doc = ""
                  then
                    let uu____4344 =
                      let uu____4346 = FStar_Util.colorize_bold flag  in
                      FStar_Util.format1 "  --%s\n" uu____4346  in
                    FStar_Util.print_string uu____4344
                  else
                    (let uu____4351 =
                       let uu____4353 = FStar_Util.colorize_bold flag  in
                       FStar_Util.format2 "  --%s  %s\n" uu____4353 doc  in
                     FStar_Util.print_string uu____4351)
              | FStar_Getopt.OneArg (uu____4356,argname) ->
                  if doc = ""
                  then
                    let uu____4371 =
                      let uu____4373 = FStar_Util.colorize_bold flag  in
                      let uu____4375 = FStar_Util.colorize_bold argname  in
                      FStar_Util.format2 "  --%s %s\n" uu____4373 uu____4375
                       in
                    FStar_Util.print_string uu____4371
                  else
                    (let uu____4380 =
                       let uu____4382 = FStar_Util.colorize_bold flag  in
                       let uu____4384 = FStar_Util.colorize_bold argname  in
                       FStar_Util.format3 "  --%s %s  %s\n" uu____4382
                         uu____4384 doc
                        in
                     FStar_Util.print_string uu____4380))) specs
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____4461 =
                let uu____4462 = f ()  in set_option name uu____4462  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x = let uu____4483 = f x  in set_option name uu____4483
                 in
...
let (accumulated_option : Prims.string -> option_val -> option_val) =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____4510 = lookup_opt name (as_option as_list')  in
        FStar_Util.dflt [] uu____4510  in
...
let (reverse_accumulated_option : Prims.string -> option_val -> option_val) =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____4539 = lookup_opt name (as_option as_list')  in
        FStar_Util.dflt [] uu____4539  in
      List (FStar_List.append prev_values [value])
  
let accumulate_string :
  'uuuuuu4561 .
    Prims.string -> ('uuuuuu4561 -> Prims.string) -> 'uuuuuu4561 -> unit
  =
  fun name  ->
    fun post_processor  ->
      fun value  ->
        let uu____4586 =
          let uu____4587 =
            let uu____4588 = post_processor value  in String uu____4588  in
          accumulated_option name uu____4587  in
        set_option name uu____4586
...
let (uu___is_Const : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | Const _0 -> true | uu____4710 -> false
  
let (__proj__Const__item___0 : opt_type -> option_val) =
  fun projectee  -> match projectee with | Const _0 -> _0 
let (uu___is_IntStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | IntStr _0 -> true | uu____4730 -> false
  
let (__proj__IntStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | IntStr _0 -> _0 
let (uu___is_BoolStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | BoolStr  -> true | uu____4751 -> false
  
let (uu___is_PathStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | PathStr _0 -> true | uu____4764 -> false
...
let (uu___is_EnumStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | EnumStr _0 -> true | uu____4812 -> false
  
let (__proj__EnumStr__item___0 : opt_type -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | EnumStr _0 -> _0 
let (uu___is_OpenEnumStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | OpenEnumStr _0 -> true | uu____4848 -> false
...
let (uu___is_PostProcessed : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | PostProcessed _0 -> true | uu____4898 -> false
...
let (uu___is_Accumulated : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | Accumulated _0 -> true | uu____4938 -> false
...
let (uu___is_WithSideEffect : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | WithSideEffect _0 -> true | uu____4983 -> false
...
let (uu___is_InvalidArgument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | InvalidArgument uu____5026 -> true
    | uu____5029 -> false
  
let (__proj__InvalidArgument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | InvalidArgument uu____5039 -> uu____5039
          ...
          (fun uu___315_5063  ->
             ...
             | () ->
                 (match typ with
                  | Const c -> c
                  | IntStr uu____5065 ->
                      let uu____5067 = FStar_Util.safe_int_of_string str_val
                         in
                  ...
                  | BoolStr  ->
                      let uu____5075 =
                        ...
                        then true
                         ...
                         in
                      Bool uu____5075
                  | PathStr uu____5092 -> Path str_val
                  | SimpleStr uu____5094 -> String str_val
                  | EnumStr strs ->
                      if FStar_List.mem str_val strs
                      then String str_val
                      else FStar_Exn.raise (InvalidArgument opt_name)
                  | OpenEnumStr uu____5104 -> String str_val
  ...
  fun typ  ->
    let desc_of_enum cases =
      let uu____5171 =
        ...
        FStar_String.op_Hat "[" uu____5173  in
    ...
    | PostProcessed (uu____5215,elem_spec) -> desc_of_opt_type elem_spec
    | Accumulated elem_spec -> desc_of_opt_type elem_spec
    | ReverseAccumulated elem_spec -> desc_of_opt_type elem_spec
    | WithSideEffect (uu____5225,elem_spec) -> desc_of_opt_type elem_spec
...
let (arg_spec_of_opt_type :
  ...
  fun opt_name  ->
    fun typ  ->
      ...
      let uu____5256 = desc_of_opt_type typ  in
      match uu____5256 with
      | FStar_Pervasives_Native.None  ->
          FStar_Getopt.ZeroArgs ((fun uu____5264  -> parser ""))
...
let (pp_lowercase : option_val -> option_val) =
  fun s  ->
    let uu____5290 =
      let uu____5292 = as_string s  in FStar_String.lowercase uu____5292  in
    String uu____5290
...
let (interp_quake_arg : Prims.string -> (Prims.int * Prims.int * Prims.bool))
  ...
  fun s  ->
    ...
    | f::[] ->
        let uu____5350 = ios f  in
        let uu____5352 = ios f  in (uu____5350, uu____5352, false)
    | f1::f2::[] ->
        if f2 = "k"
        then
          let uu____5377 = ios f1  in
          let uu____5379 = ios f1  in (uu____5377, uu____5379, true)
        else
          (let uu____5387 = ios f1  in
           let uu____5389 = ios f2  in (uu____5387, uu____5389, false))
    | f1::f2::k::[] ->
        if k = "k"
        then
          let uu____5417 = ios f1  in
          let uu____5419 = ios f2  in (uu____5417, uu____5419, true)
        else failwith "unexpected value for --quake"
    | uu____5437 -> failwith "unexpected value for --quake"
...
let rec (specs_with_types :
  ...
  fun uu____5475  ->
    ...
    (FStar_Getopt.noshort, "fuel",
      (PostProcessed
         (((fun uu___8_6170  ->
              match uu___8_6170 with
              | String s ->
                  let p f =
                    let uu____6181 = FStar_Util.int_of_string f  in
                    Int uu____6181  in
                  let uu____6183 =
                    match FStar_Util.split s "," with
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____6212 -> failwith "unexpected value for --fuel"
                     in
                  (match uu____6183 with
                   | (min,max) ->
                       ((let uu____6230 = p min  in
                         set_option "initial_fuel" uu____6230);
                        (let uu____6233 = p max  in
                         set_option "max_fuel" uu____6233);
                        String s))
              | uu____6235 -> failwith "impos")),
    ...
    (FStar_Getopt.noshort, "ifuel",
      (PostProcessed
         (((fun uu___9_6265  ->
              ...
              | String s ->
                  let p f =
                    let uu____6276 = FStar_Util.int_of_string f  in
                    Int uu____6276  in
                  let uu____6278 =
                    match FStar_Util.split s "," with
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____6307 -> failwith "unexpected value for --ifuel"
                     in
                  (match uu____6278 with
                   | (min,max) ->
                       ((let uu____6325 = p min  in
                         set_option "initial_ifuel" uu____6325);
                        (let uu____6328 = p max  in
                         set_option "max_ifuel" uu____6328);
                        String s))
              | uu____6330 -> failwith "impos")),
           (SimpleStr "non-negative integer or pair of non-negative integers"))),
    ...
    (FStar_Getopt.noshort, "quake",
      (PostProcessed
         (((fun uu___10_6823  ->
              match uu___10_6823 with
              | String s ->
                  let uu____6826 = interp_quake_arg s  in
    ...
    (FStar_Getopt.noshort, "__debug_embedding",
      (WithSideEffect
         (((fun uu____7752  -> FStar_ST.op_Colon_Equals debug_embedding true)),
           (Const (Bool true)))),
      "Debug messages for embeddings/unembeddings of natively compiled terms");
    (FStar_Getopt.noshort, "eager_embedding",
      (WithSideEffect
         (((fun uu____7796  -> FStar_ST.op_Colon_Equals eager_embedding true)),
           (Const (Bool true)))),
    ...
    (104, "help",
      (WithSideEffect
         (((fun uu____7893  ->
              (let uu____7895 = specs ()  in display_usage_aux uu____7895);
              FStar_All.exit Prims.int_zero)), (Const (Bool true)))),
      "Display this information")]

and (specs : unit -> FStar_Getopt.opt Prims.list) =
  fun uu____7926  ->
    let uu____7929 = specs_with_types ()  in
    FStar_List.map
      (fun uu____7960  ->
         match uu____7960 with
         | (short,long,typ,doc) ->
             let uu____7982 =
               let uu____7996 = arg_spec_of_opt_type long typ  in
               (short, long, uu____7996, doc)  in
             mk_spec uu____7982) uu____7929

let (settable : Prims.string -> Prims.bool) =
  fun uu___12_8011  ->
    match uu___12_8011 with
    | "abort_on" -> true
    | "admit_except" -> true
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____8254  ->
          ...
          | (uu____8269,x,uu____8271,uu____8272) -> settable x))
  
let (display_usage : unit -> unit) =
  fun uu____8288  ->
    let uu____8289 = specs ()  in display_usage_aux uu____8289
...
let (uu___is_File_argument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | File_argument uu____8321 -> true
    | uu____8324 -> false
  
let (__proj__File_argument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | File_argument uu____8334 -> uu____8334
  ...
  fun uu____8387  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____8393 =
             let uu____8397 = FStar_ST.op_Bang file_list_  in
             FStar_List.append uu____8397 [i]  in
           FStar_ST.op_Colon_Equals file_list_ uu____8393)
       in
    let uu____8454 =
      let uu____8458 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____8458
       in
    (res, uu____8454)
  
let (file_list : unit -> Prims.string Prims.list) =
  fun uu____8500  -> FStar_ST.op_Bang file_list_ 
let (restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res)
  ...
  fun should_clear  ->
    ...
    (let r =
       let uu____8543 = specs ()  in
       FStar_Getopt.parse_cmdline uu____8543 (fun x  -> ())  in
     (let uu____8550 =
        let uu____8556 =
          let uu____8557 =
            FStar_List.map (fun uu____8561  -> String uu____8561)
              old_verify_module
             in
          List uu____8557  in
        ("verify_module", uu____8556)  in
      set_option' uu____8550);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____8577 =
        let uu____8579 =
          let uu____8581 =
            let uu____8583 = FStar_Util.get_file_extension f1  in
            FStar_String.length uu____8583  in
          (FStar_String.length f1) - uu____8581  in
        uu____8579 - Prims.int_one  in
      FStar_String.substring f1 Prims.int_zero uu____8577  in
...
let (should_verify : Prims.string -> Prims.bool) =
  fun m  ->
    (let uu____8612 = get_lax ()  in Prims.op_Negation uu____8612) &&
      (should_check m)
  
let (should_check_file : Prims.string -> Prims.bool) =
  fun fn  ->
    let uu____8623 = module_name_of_file_name fn  in should_check uu____8623
  
let (should_verify_file : Prims.string -> Prims.bool) =
  fun fn  ->
    let uu____8634 = module_name_of_file_name fn  in should_verify uu____8634
...
let (dont_gen_projectors : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8662 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____8662 (FStar_List.existsb (module_name_eq m))
  
let (should_print_message : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8680 = should_verify m  in
    if uu____8680 then m <> "Prims" else false
  
let (include_path : unit -> Prims.string Prims.list) =
  fun uu____8697  ->
    let cache_dir =
      let uu____8702 = get_cache_dir ()  in
      match uu____8702 with
      | FStar_Pervasives_Native.None  -> []
      | FStar_Pervasives_Native.Some c -> [c]  in
    let uu____8716 = get_no_default_includes ()  in
    if uu____8716
    then
      let uu____8722 = get_include ()  in
      FStar_List.append cache_dir uu____8722
    else
      (let lib_paths =
         let uu____8733 = FStar_Util.expand_environment_variable "FSTAR_LIB"
            in
       ...
       let uu____8776 =
         let uu____8780 =
           let uu____8784 = get_include ()  in
           FStar_List.append uu____8784 ["."]  in
         FStar_List.append lib_paths uu____8780  in
       FStar_List.append cache_dir uu____8776)
  
let (find_file : Prims.string -> Prims.string FStar_Pervasives_Native.option)
  =
  let file_map = FStar_Util.smap_create (Prims.of_int (100))  in
  fun filename  ->
    let uu____8815 = FStar_Util.smap_try_find file_map filename  in
        ...
        let result =
          try
            (fun uu___620_8846  ->
               match () with
               | () ->
                   let uu____8850 = FStar_Util.is_path_absolute filename  in
                   if uu____8850
                   then
                     ...
                     (let uu____8866 =
                        let uu____8870 = include_path ()  in
                        FStar_List.rev uu____8870  in
                      FStar_Util.find_map uu____8866
                        (fun p  ->
                           let path =
                             if p = "."
                             then filename
          ...
          with | uu___619_8898 -> FStar_Pervasives_Native.None  in
...
let (prims : unit -> Prims.string) =
  fun uu____8917  ->
    let uu____8918 = get_prims ()  in
    match uu____8918 with
    | FStar_Pervasives_Native.None  ->
        let filename = "prims.fst"  in
        let uu____8927 = find_file filename  in
...
let (prims_basename : unit -> Prims.string) =
  fun uu____8949  ->
    let uu____8950 = prims ()  in FStar_Util.basename uu____8950
  
let (pervasives : unit -> Prims.string) =
  fun uu____8958  ->
    let filename = "FStar.Pervasives.fsti"  in
    let uu____8962 = find_file filename  in
...
let (pervasives_basename : unit -> Prims.string) =
  fun uu____8981  ->
    let uu____8982 = pervasives ()  in FStar_Util.basename uu____8982
  
let (pervasives_native_basename : unit -> Prims.string) =
  fun uu____8990  ->
    let filename = "FStar.Pervasives.Native.fst"  in
    let uu____8994 = find_file filename  in
...
let (prepend_cache_dir : Prims.string -> Prims.string) =
  fun fpath  ->
    let uu____9034 = get_cache_dir ()  in
    match uu____9034 with
    | FStar_Pervasives_Native.None  -> fpath
    | FStar_Pervasives_Native.Some x ->
        let uu____9043 = FStar_Util.basename fpath  in
        FStar_Util.join_paths x uu____9043
...
let (parse_settings :
  ...
  fun ns  ->
    ...
    let with_cache f s =
      let uu____9165 = FStar_Util.smap_try_find cache s  in
    ...
    let parse_one_setting s =
      ...
      then ([], true)
        ...
        then ([], false)
          ...
          then
            (let path =
               let uu____9319 = FStar_Util.substring_from s Prims.int_one  in
               path_of_text uu____9319  in
             (path, false))
          else
            (let s1 =
               if FStar_Util.starts_with s "+"
    ...
    let uu____9342 =
      FStar_All.pipe_right ns
       ...
       in
    FStar_All.pipe_right uu____9342 FStar_List.rev
  
let (__temp_no_proj : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9507 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____9507 (FStar_List.contains s)
  
let (__temp_fast_implicits : unit -> Prims.bool) =
  fun uu____9522  -> lookup_opt "__temp_fast_implicits" as_bool 
let (admit_smt_queries : unit -> Prims.bool) =
  fun uu____9531  -> get_admit_smt_queries () 
let (admit_except : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9540  -> get_admit_except () 
let (cache_checked_modules : unit -> Prims.bool) =
  fun uu____9547  -> get_cache_checked_modules () 
let (cache_off : unit -> Prims.bool) = fun uu____9554  -> get_cache_off () 
let (print_cache_version : unit -> Prims.bool) =
  fun uu____9561  -> get_print_cache_version () 
let (cmi : unit -> Prims.bool) = fun uu____9568  -> get_cmi () 
type codegen_t =
  | OCaml 
  | FSharp 
  | Kremlin 
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | OCaml  -> true | uu____9578 -> false
  
let (uu___is_FSharp : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | FSharp  -> true | uu____9589 -> false
  
let (uu___is_Kremlin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Kremlin  -> true | uu____9600 -> false
  
let (uu___is_Plugin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Plugin  -> true | uu____9611 -> false
  
let (codegen : unit -> codegen_t FStar_Pervasives_Native.option) =
  fun uu____9620  ->
    let uu____9621 = get_codegen ()  in
    FStar_Util.map_opt uu____9621
      (fun uu___13_9627  ->
         match uu___13_9627 with
         | "OCaml" -> OCaml
         | "FSharp" -> FSharp
         | "Kremlin" -> Kremlin
         | "Plugin" -> Plugin
         | uu____9633 -> failwith "Impossible")
  
let (codegen_libs : unit -> Prims.string Prims.list Prims.list) =
  fun uu____9646  ->
    let uu____9647 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____9647
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let (debug_any : unit -> Prims.bool) =
  fun uu____9673  -> let uu____9674 = get_debug ()  in uu____9674 <> [] 
let (debug_module : Prims.string -> Prims.bool) =
  fun modul  ->
    let uu____9691 = get_debug ()  in
    FStar_All.pipe_right uu____9691
...
let (profile_group_by_decls : unit -> Prims.bool) =
  fun uu____9727  -> get_profile_group_by_decl () 
let (defensive : unit -> Prims.bool) =
  fun uu____9734  -> let uu____9735 = get_defensive ()  in uu____9735 <> "no" 
let (defensive_fail : unit -> Prims.bool) =
  fun uu____9745  ->
    let uu____9746 = get_defensive ()  in uu____9746 = "fail"
  
let (dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9758  -> get_dep () 
let (detail_errors : unit -> Prims.bool) =
  fun uu____9765  -> get_detail_errors () 
let (detail_hint_replay : unit -> Prims.bool) =
  fun uu____9772  -> get_detail_hint_replay () 
let (dump_module : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9782 = get_dump_module ()  in
    FStar_All.pipe_right uu____9782 (FStar_List.existsb (module_name_eq s))
  
let (eager_subtyping : unit -> Prims.bool) =
  fun uu____9797  -> get_eager_subtyping () 
let (expose_interfaces : unit -> Prims.bool) =
  fun uu____9804  -> get_expose_interfaces () 
let (force : unit -> Prims.bool) = fun uu____9811  -> get_force () 
let (fs_typ_app : Prims.string -> Prims.bool) =
  fun filename  ->
    let uu____9821 = FStar_ST.op_Bang light_off_files  in
    FStar_List.contains filename uu____9821
  
let (full_context_dependency : unit -> Prims.bool) = fun uu____9857  -> true 
let (hide_uvar_nums : unit -> Prims.bool) =
  fun uu____9865  -> get_hide_uvar_nums () 
let (hint_info : unit -> Prims.bool) =
  fun uu____9872  -> (get_hint_info ()) || (get_query_stats ()) 
let (hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9881  -> get_hint_dir () 
let (hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9890  -> get_hint_file () 
let (hint_file_for_src : Prims.string -> Prims.string) =
  fun src_filename  ->
    let uu____9900 = hint_file ()  in
    match uu____9900 with
    | FStar_Pervasives_Native.Some fn -> fn
    | FStar_Pervasives_Native.None  ->
        let file_name =
          let uu____9911 = hint_dir ()  in
          match uu____9911 with
          | FStar_Pervasives_Native.Some dir ->
              let uu____9919 = FStar_Util.basename src_filename  in
              FStar_Util.concat_dir_filename dir uu____9919
          | uu____9921 -> src_filename  in
        FStar_Util.format1 "%s.hints" file_name
  
let (ide : unit -> Prims.bool) = fun uu____9932  -> get_ide () 
let (print : unit -> Prims.bool) = fun uu____9939  -> get_print () 
let (print_in_place : unit -> Prims.bool) =
  fun uu____9946  -> get_print_in_place () 
let (initial_fuel : unit -> Prims.int) =
  fun uu____9953  ->
    let uu____9954 = get_initial_fuel ()  in
    let uu____9956 = get_max_fuel ()  in Prims.min uu____9954 uu____9956
  
let (initial_ifuel : unit -> Prims.int) =
  fun uu____9964  ->
    let uu____9965 = get_initial_ifuel ()  in
    let uu____9967 = get_max_ifuel ()  in Prims.min uu____9965 uu____9967
  
let (interactive : unit -> Prims.bool) =
  fun uu____9975  -> (get_in ()) || (get_ide ()) 
let (lax : unit -> Prims.bool) = fun uu____9982  -> get_lax () 
let (load : unit -> Prims.string Prims.list) = fun uu____9991  -> get_load () 
let (legacy_interactive : unit -> Prims.bool) = fun uu____9998  -> get_in () 
let (lsp_server : unit -> Prims.bool) = fun uu____10005  -> get_lsp () 
let (log_queries : unit -> Prims.bool) =
  fun uu____10012  -> get_log_queries () 
let (keep_query_captions : unit -> Prims.bool) =
  fun uu____10019  -> (log_queries ()) && (get_keep_query_captions ()) 
let (log_types : unit -> Prims.bool) = fun uu____10026  -> get_log_types () 
let (max_fuel : unit -> Prims.int) = fun uu____10033  -> get_max_fuel () 
let (max_ifuel : unit -> Prims.int) = fun uu____10040  -> get_max_ifuel () 
let (min_fuel : unit -> Prims.int) = fun uu____10047  -> get_min_fuel () 
let (ml_ish : unit -> Prims.bool) = fun uu____10054  -> get_MLish () 
let (set_ml_ish : unit -> unit) =
  fun uu____10060  -> set_option "MLish" (Bool true) 
let (no_default_includes : unit -> Prims.bool) =
  fun uu____10069  -> get_no_default_includes () 
let (no_extract : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____10079 = get_no_extract ()  in
    FStar_All.pipe_right uu____10079 (FStar_List.existsb (module_name_eq s))
  
let (normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____10094  -> get_normalize_pure_terms_for_extraction () 
let (no_load_fstartaclib : unit -> Prims.bool) =
  fun uu____10101  -> get_no_load_fstartaclib () 
let (no_location_info : unit -> Prims.bool) =
  fun uu____10108  -> get_no_location_info () 
let (no_plugins : unit -> Prims.bool) = fun uu____10115  -> get_no_plugins () 
let (no_smt : unit -> Prims.bool) = fun uu____10122  -> get_no_smt () 
let (output_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____10131  -> get_odir () 
let (ugly : unit -> Prims.bool) = fun uu____10138  -> get_ugly () 
let (print_bound_var_types : unit -> Prims.bool) =
  fun uu____10145  -> get_print_bound_var_types () 
let (print_effect_args : unit -> Prims.bool) =
  fun uu____10152  -> get_print_effect_args () 
let (print_expected_failures : unit -> Prims.bool) =
  fun uu____10159  -> get_print_expected_failures () 
let (print_implicits : unit -> Prims.bool) =
  fun uu____10166  -> get_print_implicits () 
let (print_real_names : unit -> Prims.bool) =
  fun uu____10173  -> (get_prn ()) || (get_print_full_names ()) 
let (print_universes : unit -> Prims.bool) =
  fun uu____10180  -> get_print_universes () 
let (print_z3_statistics : unit -> Prims.bool) =
  fun uu____10187  -> get_print_z3_statistics () 
let (quake_lo : unit -> Prims.int) = fun uu____10194  -> get_quake_lo () 
let (quake_hi : unit -> Prims.int) = fun uu____10201  -> get_quake_hi () 
let (quake_keep : unit -> Prims.bool) = fun uu____10208  -> get_quake_keep () 
let (query_stats : unit -> Prims.bool) =
  fun uu____10215  -> get_query_stats () 
let (record_hints : unit -> Prims.bool) =
  fun uu____10222  -> get_record_hints () 
let (record_options : unit -> Prims.bool) =
  fun uu____10229  -> get_record_options () 
let (retry : unit -> Prims.bool) = fun uu____10236  -> get_retry () 
let (reuse_hint_for : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____10245  -> get_reuse_hint_for () 
let (silent : unit -> Prims.bool) = fun uu____10252  -> get_silent () 
let (smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____10259  -> get_smtencoding_elim_box () 
let (smtencoding_nl_arith_native : unit -> Prims.bool) =
  fun uu____10266  ->
    let uu____10267 = get_smtencoding_nl_arith_repr ()  in
    uu____10267 = "native"
  
let (smtencoding_nl_arith_wrapped : unit -> Prims.bool) =
  fun uu____10277  ->
    let uu____10278 = get_smtencoding_nl_arith_repr ()  in
    uu____10278 = "wrapped"
  
let (smtencoding_nl_arith_default : unit -> Prims.bool) =
  fun uu____10288  ->
    let uu____10289 = get_smtencoding_nl_arith_repr ()  in
    uu____10289 = "boxwrap"
  
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____10299  ->
    let uu____10300 = get_smtencoding_l_arith_repr ()  in
    uu____10300 = "native"
  
let (smtencoding_l_arith_default : unit -> Prims.bool) =
  fun uu____10310  ->
    let uu____10311 = get_smtencoding_l_arith_repr ()  in
    uu____10311 = "boxwrap"
  
let (smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____10321  -> get_smtencoding_valid_intro () 
let (smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____10328  -> get_smtencoding_valid_elim () 
let (tactic_raw_binders : unit -> Prims.bool) =
  fun uu____10335  -> get_tactic_raw_binders () 
let (tactics_failhard : unit -> Prims.bool) =
  fun uu____10342  -> get_tactics_failhard () 
let (tactics_info : unit -> Prims.bool) =
  fun uu____10349  -> get_tactics_info () 
let (tactic_trace : unit -> Prims.bool) =
  fun uu____10356  -> get_tactic_trace () 
let (tactic_trace_d : unit -> Prims.int) =
  fun uu____10363  -> get_tactic_trace_d () 
let (tactics_nbe : unit -> Prims.bool) =
  fun uu____10370  -> get_tactics_nbe () 
let (tcnorm : unit -> Prims.bool) = fun uu____10377  -> get_tcnorm () 
let (timing : unit -> Prims.bool) = fun uu____10384  -> get_timing () 
let (trace_error : unit -> Prims.bool) =
  fun uu____10391  -> get_trace_error () 
let (unthrottle_inductives : unit -> Prims.bool) =
  fun uu____10398  -> get_unthrottle_inductives () 
let (unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____10405  -> get_unsafe_tactic_exec () 
let (use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____10412  -> get_use_eq_at_higher_order () 
let (use_hints : unit -> Prims.bool) = fun uu____10419  -> get_use_hints () 
let (use_hint_hashes : unit -> Prims.bool) =
  fun uu____10426  -> get_use_hint_hashes () 
let (use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____10435  -> get_use_native_tactics () 
let (use_tactics : unit -> Prims.bool) =
  fun uu____10442  -> get_use_tactics () 
let (using_facts_from :
  unit -> (Prims.string Prims.list * Prims.bool) Prims.list) =
  fun uu____10458  ->
    let uu____10459 = get_using_facts_from ()  in
...
let (vcgen_optimize_bind_as_seq : unit -> Prims.bool) =
  fun uu____10513  ->
    let uu____10514 = get_vcgen_optimize_bind_as_seq ()  in
    FStar_Option.isSome uu____10514
  
let (vcgen_decorate_with_type : unit -> Prims.bool) =
  fun uu____10525  ->
    let uu____10526 = get_vcgen_optimize_bind_as_seq ()  in
    match uu____10526 with
    | FStar_Pervasives_Native.Some "with_type" -> true
    | uu____10534 -> false
  
let (warn_default_effects : unit -> Prims.bool) =
  fun uu____10545  -> get_warn_default_effects () 
let (z3_exe : unit -> Prims.string) =
  fun uu____10552  ->
    let uu____10553 = get_smt ()  in
    match uu____10553 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
  
let (z3_cliopt : unit -> Prims.string Prims.list) =
  fun uu____10571  -> get_z3cliopt () 
let (z3_refresh : unit -> Prims.bool) = fun uu____10578  -> get_z3refresh () 
let (z3_rlimit : unit -> Prims.int) = fun uu____10585  -> get_z3rlimit () 
let (z3_rlimit_factor : unit -> Prims.int) =
  fun uu____10592  -> get_z3rlimit_factor () 
let (z3_seed : unit -> Prims.int) = fun uu____10599  -> get_z3seed () 
let (use_two_phase_tc : unit -> Prims.bool) =
  fun uu____10606  ->
    (get_use_two_phase_tc ()) &&
      (let uu____10608 = lax ()  in Prims.op_Negation uu____10608)
  
let (no_positivity : unit -> Prims.bool) =
  fun uu____10616  -> get_no_positivity () 
let (ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____10623  -> get_ml_no_eta_expand_coertions () 
let (warn_error : unit -> Prims.string) =
  fun uu____10630  ->
    let uu____10631 = get_warn_error ()  in
    FStar_String.concat "" uu____10631
  
let (use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____10642  -> get_use_extracted_interfaces () 
let (use_nbe : unit -> Prims.bool) = fun uu____10649  -> get_use_nbe () 
let (use_nbe_for_extraction : unit -> Prims.bool) =
  fun uu____10656  -> get_use_nbe_for_extraction () 
let (trivial_pre_for_unannotated_effectful_fns : unit -> Prims.bool) =
  fun uu____10663  -> get_trivial_pre_for_unannotated_effectful_fns () 
let with_saved_options : 'a . (unit -> 'a) -> 'a =
  fun f  ->
    let uu____10680 =
      let uu____10682 = trace_error ()  in Prims.op_Negation uu____10682  in
    if uu____10680
    then
      (push ();
       (let r =
          try
            (fun uu___833_10697  ->
               match () with
               | () -> let uu____10702 = f ()  in FStar_Util.Inr uu____10702)
              ()
          with | uu___832_10704 -> FStar_Util.Inl uu___832_10704  in
        pop ();
        (match r with
         | FStar_Util.Inr v -> v
  ...
  fun m  ->
    fun filter  ->
      ...
      let rec matches_path m_components1 path =
        ...
        | uu____10818 -> false  in
      let uu____10830 =
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____10872  ->
                match uu____10872 with
                | (path,uu____10883) -> matches_path m_components path))
         in
      match uu____10830 with
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some (uu____10902,flag) -> flag
...
let (should_extract : Prims.string -> Prims.bool) =
  fun m  ->
    let m1 = FStar_String.lowercase m  in
    let uu____10967 = get_extract ()  in
    match uu____10967 with
    | FStar_Pervasives_Native.Some extract_setting ->
        ((let uu____10982 =
            let uu____10998 = get_no_extract ()  in
            let uu____11002 = get_extract_namespace ()  in
            let uu____11006 = get_extract_module ()  in
            (uu____10998, uu____11002, uu____11006)  in
    ...
    | FStar_Pervasives_Native.None  ->
        let should_extract_namespace m2 =
          let uu____11060 = get_extract_namespace ()  in
        ...
        let should_extract_module m2 =
          let uu____11088 = get_extract_module ()  in
          ...
          | l ->
           ...
           in
        (let uu____11110 = no_extract m1  in Prims.op_Negation uu____11110)
          &&
          (let uu____11113 =
             let uu____11124 = get_extract_namespace ()  in
             let uu____11128 = get_extract_module ()  in
             (uu____11124, uu____11128)  in
...
let (should_be_already_cached : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____11168 = get_already_cached ()  in
...
let (error_flags : unit -> error_flag Prims.list) =
  ...
  fun uu____11201  ->
    ...
    let uu____11204 = FStar_Util.smap_try_find cache we  in
...
let (profile_enabled :
  ...
  fun modul_opt  ->
    fun phase  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____11248 = get_profile_component ()  in
          matches_namespace_filter_opt phase uu____11248
      | FStar_Pervasives_Native.Some modul ->
          (let uu____11259 = get_profile ()  in
           matches_namespace_filter_opt modul uu____11259) &&
            (let uu____11266 = get_profile_component ()  in
             matches_namespace_filter_opt phase uu____11266)
