...
let get_record_unsat_core : Prims.unit  ->  Prims.bool = (fun _24_123 -> (match (()) with
| () -> begin
(lookup_opt "record_unsat_core" as_bool)
end))
...
| () -> begin
Bool (true)
end))), "Record a database of hints for efficient proof replay"))::((FStar_Getopt.noshort, "record_unsat_core", FStar_Getopt.ZeroArgs ((fun _24_233 -> (match (()) with
| () -> begin
Bool (true)
end))), "Add the unsat core (if any) to the database of hints"))::((FStar_Getopt.noshort, "show_signatures", FStar_Getopt.OneArg (((fun x -> (let _114_419 = (let _114_418 = (let _114_416 = (get_show_signatures ())
in (x)::_114_416)
...
let record_unsat_core : Prims.unit  ->  Prims.bool = (fun _24_438 -> (match (()) with
| () -> begin
(get_record_unsat_core ())
end))
