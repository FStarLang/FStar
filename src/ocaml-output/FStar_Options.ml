...
let lookup_opt s c =
  let uu____473 = let _0_31 = peek ()  in FStar_Util.smap_try_find _0_31 s
     in
    ...
    let specs =
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                List
                  (let _0_55 = let _0_53 = get_codegen_lib ()  in s :: _0_53
                      in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                List
                  (let _0_61 = let _0_59 = get_debug_level ()  in x :: _0_59
                      in
      ...
      (FStar_Getopt.noshort, "dep",
        (FStar_Getopt.OneArg
           (((fun x  ->
                ...
                | true  -> String x
                | uu____954 -> failwith "invalid argument to 'dep'")),
             "[make|graph]")),
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let _0_66 =
                  let _0_64 = let _0_62 = get_dump_module ()  in x :: _0_62
                     in
                  FStar_All.pipe_right _0_64
                    (FStar_List.map (fun _0_63  -> String _0_63))
                   in
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                List
                  (let _0_73 = let _0_71 = get_no_extract ()  in x :: _0_71
                      in
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline _0_90
        (fun i  ->
           ...
           FStar_ST.write file_list_ _0_89)
       in
...
let restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    ...
    (match should_clear with | true  -> clear () | uu____1599 -> init ());
    (let r =
       let _0_92 = specs ()  in
     ...
     set_option'
       (let _0_94 =
          List
            (FStar_List.map (fun _0_93  -> String _0_93) old_verify_module)
           in
        ("verify_module", _0_94));
     r)
                  ...
                  FStar_List.existsML
                    (fun f  ->
                       ...
                       let f =
                         ...
                         FStar_String.substring f (Prims.parse_int "0") _0_97
                          in
...
let should_print_message : Prims.string -> Prims.bool =
  fun m  ->
    ...
    match uu____1628 with | true  -> m <> "Prims" | uu____1629 -> false
...
let check_cardinality : Prims.unit -> Prims.bool =
  fun uu____1683  -> let _0_106 = get_cardinality ()  in _0_106 = "check" 
...
let debug_any : Prims.unit -> Prims.bool =
  fun uu____1700  -> let _0_108 = get_debug ()  in _0_108 <> [] 
...
let norm_then_print : Prims.unit -> Prims.bool =
  fun uu____1804  -> let _0_113 = get_print_before_norm ()  in _0_113 = false 
...
let warn_cardinality : Prims.unit -> Prims.bool =
  fun uu____1867  -> let _0_114 = get_cardinality ()  in _0_114 = "warn" 
