...
let get_lax: Prims.unit -> Prims.bool =
  fun uu____639  -> lookup_opt "lax" as_bool
let get_log_queries: Prims.unit -> Prims.bool =
  fun uu____642  -> lookup_opt "log_queries" as_bool
let get_log_types: Prims.unit -> Prims.bool =
  fun uu____645  -> lookup_opt "log_types" as_bool
let get_max_fuel: Prims.unit -> Prims.int =
  fun uu____648  -> lookup_opt "max_fuel" as_int
let get_max_ifuel: Prims.unit -> Prims.int =
  fun uu____651  -> lookup_opt "max_ifuel" as_int
let get_min_fuel: Prims.unit -> Prims.int =
  fun uu____654  -> lookup_opt "min_fuel" as_int
let get_MLish: Prims.unit -> Prims.bool =
  fun uu____657  -> lookup_opt "MLish" as_bool
let get_n_cores: Prims.unit -> Prims.int =
  fun uu____660  -> lookup_opt "n_cores" as_int
let get_no_default_includes: Prims.unit -> Prims.bool =
  fun uu____663  -> lookup_opt "no_default_includes" as_bool
let get_no_extract: Prims.unit -> Prims.string Prims.list =
  fun uu____667  -> lookup_opt "no_extract" (as_list as_string)
let get_no_location_info: Prims.unit -> Prims.bool =
  fun uu____671  -> lookup_opt "no_location_info" as_bool
let get_odir: Prims.unit -> Prims.string option =
  fun uu____675  -> lookup_opt "odir" (as_option as_string)
let get_ugly: Prims.unit -> Prims.bool =
  fun uu____679  -> lookup_opt "ugly" as_bool
let get_prims: Prims.unit -> Prims.string option =
  fun uu____683  -> lookup_opt "prims" (as_option as_string)
let get_print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____687  -> lookup_opt "print_bound_var_types" as_bool
let get_print_effect_args: Prims.unit -> Prims.bool =
  fun uu____690  -> lookup_opt "print_effect_args" as_bool
let get_print_fuels: Prims.unit -> Prims.bool =
  fun uu____693  -> lookup_opt "print_fuels" as_bool
let get_print_full_names: Prims.unit -> Prims.bool =
  fun uu____696  -> lookup_opt "print_full_names" as_bool
let get_print_implicits: Prims.unit -> Prims.bool =
  fun uu____699  -> lookup_opt "print_implicits" as_bool
let get_print_universes: Prims.unit -> Prims.bool =
  fun uu____702  -> lookup_opt "print_universes" as_bool
let get_print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____705  -> lookup_opt "print_z3_statistics" as_bool
let get_prn: Prims.unit -> Prims.bool =
  fun uu____708  -> lookup_opt "prn" as_bool
let get_record_hints: Prims.unit -> Prims.bool =
  fun uu____711  -> lookup_opt "record_hints" as_bool
let get_reuse_hint_for: Prims.unit -> Prims.string option =
  fun uu____715  -> lookup_opt "reuse_hint_for" (as_option as_string)
let get_show_signatures: Prims.unit -> Prims.string Prims.list =
  fun uu____720  -> lookup_opt "show_signatures" (as_list as_string)
let get_silent: Prims.unit -> Prims.bool =
  fun uu____724  -> lookup_opt "silent" as_bool
let get_smt: Prims.unit -> Prims.string option =
  fun uu____728  -> lookup_opt "smt" (as_option as_string)
let get_smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____732  -> lookup_opt "smtencoding.elim_box" as_bool
let get_smtencoding_nl_arith_repr: Prims.unit -> Prims.string =
  fun uu____735  -> lookup_opt "smtencoding.nl_arith_repr" as_string
let get_smtencoding_l_arith_repr: Prims.unit -> Prims.string =
  fun uu____738  -> lookup_opt "smtencoding.l_arith_repr" as_string
...
let get_verify_all: Prims.unit -> Prims.bool =
  fun uu____771  -> lookup_opt "verify_all" as_bool
let get_verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____775  -> lookup_opt "verify_module" (as_list as_string)
let get___temp_no_proj: Prims.unit -> Prims.string Prims.list =
  fun uu____780  -> lookup_opt "__temp_no_proj" (as_list as_string)
let get_version: Prims.unit -> Prims.bool =
  fun uu____784  -> lookup_opt "version" as_bool
let get_warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____787  -> lookup_opt "warn_default_effects" as_bool
let get_z3cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____791  -> lookup_opt "z3cliopt" (as_list as_string)
let get_z3refresh: Prims.unit -> Prims.bool =
  fun uu____795  -> lookup_opt "z3refresh" as_bool
let get_z3rlimit: Prims.unit -> Prims.int =
  fun uu____798  -> lookup_opt "z3rlimit" as_int
let get_z3rlimit_factor: Prims.unit -> Prims.int =
  fun uu____801  -> lookup_opt "z3rlimit_factor" as_int
let get_z3seed: Prims.unit -> Prims.int =
  fun uu____804  -> lookup_opt "z3seed" as_int
  ...
  fun uu____1051  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n1  ->
                let uu____1563 = FStar_Util.int_of_string n1 in
                Int uu____1563)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "verify_all",
        (FStar_Getopt.ZeroArgs ((fun uu____1627  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1645 =
                  let uu____1647 =
                    let uu____1649 = get___temp_no_proj () in x :: uu____1649 in
      ...
      (FStar_Getopt.noshort, "z3cliopt",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1677 =
                  let uu____1679 =
                    let uu____1681 = get_z3cliopt () in
                    FStar_List.append uu____1681 [s] in
                  FStar_All.pipe_right uu____1679
                    (FStar_List.map (fun _0_45  -> String _0_45)) in
                List uu____1677)), "[option]")), "Z3 command line options");
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1701 = FStar_Util.int_of_string s in Int uu____1701)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1711 = FStar_Util.int_of_string s in Int uu____1711)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1721 = FStar_Util.int_of_string s in Int uu____1721)),
             "[positive integer]")), "Set the Z3 random seed (default 0)");
      (FStar_Getopt.noshort, "__no_positivity",
        (FStar_Getopt.ZeroArgs ((fun uu____1728  -> Bool true))),
        "Don't check positivity of inductive types")] in
    let uu____1734 = FStar_List.map mk_spec specs1 in
    ('h', "help",
      (FStar_Getopt.ZeroArgs
         (fun x  ->
            display_usage_aux specs1; FStar_All.exit (Prims.parse_int "0"))),
      "Display this information") :: uu____1734
  ...
  fun s  ->
    ...
    | uu____1755 ->
        (FStar_Util.print_string "Wrong argument to codegen flag\n";
         (let uu____1758 = specs () in display_usage_aux uu____1758);
         FStar_All.exit (Prims.parse_int "1"))
and string_as_bool: Prims.string -> Prims.string -> option_val =
  fun option_name  ->
    fun uu___55_1766  ->
      match uu___55_1766 with
      | "true" -> Bool true
      | "false" -> Bool false
      | uu____1767 ->
...
let docs: Prims.unit -> (Prims.string* Prims.string) Prims.list =
  fun uu____1784  ->
    let uu____1785 = specs () in
    FStar_List.map
      (fun uu____1799  ->
         match uu____1799 with
         | (uu____1807,name,uu____1809,doc) -> (name, doc)) uu____1785
let settable: Prims.string -> Prims.bool =
  fun uu___56_1815  ->
    match uu___56_1815 with
    | "admit_smt_queries"
      |"debug"
       |"debug_level"
        |"detail_errors"
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1839  ->
          ...
          | (uu____1845,x,uu____1847,uu____1848) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1869  ->
          ...
          | (uu____1875,x,uu____1877,uu____1878) -> resettable x))
let display_usage: Prims.unit -> Prims.unit =
  fun uu____1883  ->
    let uu____1884 = specs () in display_usage_aux uu____1884
let fstar_home: Prims.unit -> Prims.string =
  fun uu____1893  ->
    let uu____1894 = get_fstar_home () in
...
let uu___is_File_argument: Prims.exn -> Prims.bool =
  fun projectee  ->
    ...
    | File_argument uu____1905 -> true
    | uu____1906 -> false
let __proj__File_argument__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | File_argument uu____1913 -> uu____1913
  ...
  fun o  ->
    fun s  ->
      ...
      | File_argument s1 ->
          ...
          FStar_Getopt.Error uu____1939
let file_list_: Prims.string Prims.list FStar_ST.ref = FStar_Util.mk_ref []
let parse_cmd_line:
  Prims.unit -> (FStar_Getopt.parse_cmdline_res* Prims.string Prims.list) =
  fun uu____1950  ->
    let res =
      let uu____1952 = specs () in
      FStar_Getopt.parse_cmdline uu____1952
        (fun i  ->
           let uu____1955 =
             let uu____1957 = FStar_ST.read file_list_ in
             FStar_List.append uu____1957 [i] in
           FStar_ST.write file_list_ uu____1955) in
    let uu____1965 =
      let uu____1967 = FStar_ST.read file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1967 in
    (res, uu____1965)
let file_list: Prims.unit -> Prims.string Prims.list =
  fun uu____1976  -> FStar_ST.read file_list_
let restore_cmd_line_options: Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    ...
    (let r =
       ...
       FStar_Getopt.parse_cmdline uu____1988 (fun x  -> ()) in
     (let uu____1992 =
        let uu____1995 =
          let uu____1996 =
            FStar_List.map (fun _0_46  -> String _0_46) old_verify_module in
          List uu____1996 in
        ("verify_module", uu____1995) in
      set_option' uu____1992);
     r)
let should_verify: Prims.string -> Prims.bool =
  fun m  ->
    let uu____2001 = get_lax () in
    if uu____2001
    then false
    else
      (let uu____2003 = get_verify_all () in
       if uu____2003
       then true
       else
         (let uu____2005 = get_verify_module () in
          match uu____2005 with
          | [] ->
              let uu____2007 = file_list () in
              FStar_List.existsML
                (fun f  ->
                   ...
                   let f2 =
                     let uu____2012 =
                       let uu____2013 =
                         let uu____2014 =
                           let uu____2015 = FStar_Util.get_file_extension f1 in
                           FStar_String.length uu____2015 in
                         (FStar_String.length f1) - uu____2014 in
                       uu____2013 - (Prims.parse_int "1") in
                     FStar_String.substring f1 (Prims.parse_int "0")
                       uu____2012 in
                   (FStar_String.lowercase f2) = m) uu____2007
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
let dont_gen_projectors: Prims.string -> Prims.bool =
  fun m  ->
    let uu____2025 = get___temp_no_proj () in
    FStar_List.contains m uu____2025
let should_print_message: Prims.string -> Prims.bool =
  fun m  ->
    let uu____2030 = should_verify m in
    if uu____2030 then m <> "Prims" else false
let include_path: Prims.unit -> Prims.string Prims.list =
  fun uu____2035  ->
    let uu____2036 = get_no_default_includes () in
    if uu____2036
    then get_include ()
    else
      (let h = fstar_home () in
       ...
       let uu____2051 =
         let uu____2053 = get_include () in
         FStar_List.append uu____2053 ["."] in
       FStar_List.append uu____2042 uu____2051)
let find_file: Prims.string -> Prims.string option =
  fun filename  ->
    let uu____2059 = FStar_Util.is_path_absolute filename in
    if uu____2059
    then (if FStar_Util.file_exists filename then Some filename else None)
    else
      (let uu____2064 =
         let uu____2066 = include_path () in FStar_List.rev uu____2066 in
       FStar_Util.find_map uu____2064
         (fun p  ->
            let path = FStar_Util.join_paths p filename in
            if FStar_Util.file_exists path then Some path else None))
let prims: Prims.unit -> Prims.string =
  fun uu____2074  ->
    let uu____2075 = get_prims () in
    match uu____2075 with
    | None  ->
        let filename = "prims.fst" in
        let uu____2078 = find_file filename in
             ...
             let uu____2081 =
               let uu____2082 =
                 FStar_Util.format1
                   ...
                   filename in
               FStar_Util.Failure uu____2082 in
             raise uu____2081)
    | Some x -> x
let prims_basename: Prims.unit -> Prims.string =
  fun uu____2086  ->
    let uu____2087 = prims () in FStar_Util.basename uu____2087
let pervasives: Prims.unit -> Prims.string =
  fun uu____2090  ->
    let filename = "FStar.Pervasives.fst" in
    let uu____2092 = find_file filename in
        ...
        let uu____2095 =
          let uu____2096 =
            FStar_Util.format1
              "unable to find required file \"%s\" in the module search path.\n"
              filename in
          FStar_Util.Failure uu____2096 in
        raise uu____2095
let pervasives_basename: Prims.unit -> Prims.string =
  fun uu____2099  ->
    let uu____2100 = pervasives () in FStar_Util.basename uu____2100
let prepend_output_dir: Prims.string -> Prims.string =
  fun fname  ->
    let uu____2104 = get_odir () in
    match uu____2104 with
    | None  -> fname
    | Some x -> Prims.strcat x (Prims.strcat "/" fname)
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2110 = get___temp_no_proj () in
    FStar_All.pipe_right uu____2110 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____2115  -> get_admit_smt_queries ()
let check_hints: Prims.unit -> Prims.bool =
  fun uu____2118  -> get_check_hints ()
let codegen: Prims.unit -> Prims.string option =
  fun uu____2122  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____2127  ->
    let uu____2128 = get_codegen_lib () in
    FStar_All.pipe_right uu____2128
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____2137  -> let uu____2138 = get_debug () in uu____2138 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____2147 = get_debug () in
          FStar_All.pipe_right uu____2147 (FStar_List.contains modul)))
        && (debug_level_geq level)
let dep: Prims.unit -> Prims.string option = fun uu____2153  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____2156  -> get_detail_errors ()
let doc: Prims.unit -> Prims.bool = fun uu____2159  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2163 = get_dump_module () in
    FStar_All.pipe_right uu____2163 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____2168  -> get_eager_inference ()
let explicit_deps: Prims.unit -> Prims.bool =
  fun uu____2171  -> get_explicit_deps ()
let extract_all: Prims.unit -> Prims.bool =
  fun uu____2174  -> get_extract_all ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____2178 = FStar_ST.read light_off_files in
    FStar_List.contains filename uu____2178
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____2185  -> true
let hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____2188  -> get_hide_genident_nums ()
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____2191  -> get_hide_uvar_nums ()
let hint_info: Prims.unit -> Prims.bool = fun uu____2194  -> get_hint_info ()
let ide: Prims.unit -> Prims.bool = fun uu____2197  -> get_ide ()
let indent: Prims.unit -> Prims.bool = fun uu____2200  -> get_indent ()
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____2203  ->
    let uu____2204 = get_initial_fuel () in
    let uu____2205 = get_max_fuel () in Prims.min uu____2204 uu____2205
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____2208  ->
    let uu____2209 = get_initial_ifuel () in
    let uu____2210 = get_max_ifuel () in Prims.min uu____2209 uu____2210
let interactive: Prims.unit -> Prims.bool =
  fun uu____2213  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____2216  -> get_lax ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____2219  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____2222  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____2225  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____2228  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____2231  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____2234  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____2237  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____2240  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____2243  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____2246  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2250 = get_no_extract () in
    FStar_All.pipe_right uu____2250 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____2255  -> get_no_location_info ()
let output_dir: Prims.unit -> Prims.string option =
  fun uu____2259  -> get_odir ()
let ugly: Prims.unit -> Prims.bool = fun uu____2262  -> get_ugly ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____2265  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____2268  -> get_print_effect_args ()
let print_fuels: Prims.unit -> Prims.bool =
  fun uu____2271  -> get_print_fuels ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____2274  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____2277  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____2280  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____2283  -> get_print_z3_statistics ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____2286  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string option =
  fun uu____2290  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____2293  -> get_silent ()
let smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____2296  -> get_smtencoding_elim_box ()
let smtencoding_nl_arith_native: Prims.unit -> Prims.bool =
  fun uu____2299  ->
    let uu____2300 = get_smtencoding_nl_arith_repr () in
    uu____2300 = "native"
let smtencoding_nl_arith_wrapped: Prims.unit -> Prims.bool =
  fun uu____2303  ->
    let uu____2304 = get_smtencoding_nl_arith_repr () in
    uu____2304 = "wrapped"
...
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____2311  ->
    let uu____2312 = get_smtencoding_l_arith_repr () in uu____2312 = "native"
let smtencoding_l_arith_default: Prims.unit -> Prims.bool =
  fun uu____2315  ->
    let uu____2316 = get_smtencoding_l_arith_repr () in
    uu____2316 = "boxwrap"
let split_cases: Prims.unit -> Prims.int =
  fun uu____2319  -> get_split_cases ()
let timing: Prims.unit -> Prims.bool = fun uu____2322  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____2325  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____2328  -> get_unthrottle_inductives ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____2331  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____2334  -> get_use_hints ()
let use_tactics: Prims.unit -> Prims.bool =
  fun uu____2337  -> get_use_tactics ()
let using_facts_from: Prims.unit -> Prims.string Prims.list option =
  fun uu____2342  -> get_using_facts_from ()
let verify_all: Prims.unit -> Prims.bool =
  fun uu____2345  -> get_verify_all ()
let verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____2349  -> get_verify_module ()
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____2352  -> get_warn_default_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____2355  ->
    let uu____2356 = get_smt () in
    match uu____2356 with | None  -> FStar_Platform.exe "z3" | Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____2362  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____2365  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____2368  -> get_z3rlimit ()
let z3_rlimit_factor: Prims.unit -> Prims.int =
  fun uu____2371  -> get_z3rlimit_factor ()
let z3_seed: Prims.unit -> Prims.int = fun uu____2374  -> get_z3seed ()
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____2377  -> get_no_positivity ()
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2381 = no_extract m in Prims.op_Negation uu____2381) &&
      ((extract_all ()) ||
         (let uu____2382 = get_extract_module () in
          match uu____2382 with
          | [] ->
              let uu____2384 = get_extract_namespace () in
