...
let (get_report_qi : unit -> Prims.bool) =
  fun uu____3356 -> lookup_opt "report_qi" as_bool
...
let rec (specs_with_types :
  ...
  fun uu____5071 ->
    ...
    (FStar_Getopt.noshort, "report_qi", (Const (Bool true)),
...
let (keep_query_captions : unit -> Prims.bool) =
  fun uu____9235 -> (log_queries ()) && (get_keep_query_captions ())
...
let (set_ml_ish : unit -> unit) =
  fun uu____9276 -> set_option "MLish" (Bool true)
let (n_cores : unit -> Prims.int) = fun uu____9285 -> get_n_cores ()
let (no_default_includes : unit -> Prims.bool) =
  fun uu____9292 -> get_no_default_includes ()
let (no_extract : Prims.string -> Prims.bool) =
  fun s ->
    let uu____9302 = get_no_extract () in
    FStar_All.pipe_right uu____9302 (FStar_List.existsb (module_name_eq s))
let (normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____9317 -> get_normalize_pure_terms_for_extraction ()
let (no_location_info : unit -> Prims.bool) =
  fun uu____9324 -> get_no_location_info ()
...
let (output_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9347 -> get_odir ()
let (ugly : unit -> Prims.bool) = fun uu____9354 -> get_ugly ()
let (print_bound_var_types : unit -> Prims.bool) =
  fun uu____9361 -> get_print_bound_var_types ()
let (print_effect_args : unit -> Prims.bool) =
  fun uu____9368 -> get_print_effect_args ()
let (print_implicits : unit -> Prims.bool) =
  fun uu____9375 -> get_print_implicits ()
let (print_real_names : unit -> Prims.bool) =
  fun uu____9382 -> (get_prn ()) || (get_print_full_names ())
let (print_universes : unit -> Prims.bool) =
  fun uu____9389 -> get_print_universes ()
let (print_z3_statistics : unit -> Prims.bool) =
  fun uu____9396 -> get_print_z3_statistics ()
let (query_stats : unit -> Prims.bool) = fun uu____9403 -> get_query_stats ()
let (record_hints : unit -> Prims.bool) =
  fun uu____9410 -> get_record_hints ()
