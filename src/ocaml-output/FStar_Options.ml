...
let push : Prims.unit -> Prims.unit =
  fun uu____243  ->
    let uu____244 =
      ...
      let uu____250 = FStar_ST.read fstar_options  in uu____246 :: uu____250
       in
...
let add_light_off_file : Prims.string -> Prims.unit =
  fun filename  ->
    let uu____314 =
      let uu____316 = FStar_ST.read light_off_files  in filename :: uu____316
       in
...
let get_lax : Prims.unit -> Prims.bool =
  fun uu____641  -> lookup_opt "lax" as_bool 
let get_load : Prims.unit -> Prims.string option =
  fun uu____645  -> lookup_opt "load" (as_option as_string) 
...
let display_version : Prims.unit -> Prims.unit =
  fun uu____856  ->
    let uu____857 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____858
        uu____861 uu____864 uu____867 uu____870
       in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____967 =
                let uu____968 = let uu____971 = f ()  in (name, uu____971)
                   in
  ...
  fun uu____1058  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1087 = parse_codegen s  in String uu____1087)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1097 =
                  let uu____1099 =
                    let uu____1101 = get_codegen_lib ()  in s :: uu____1101
                     in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1131 =
                  let uu____1133 =
                    let uu____1135 = get_debug_level ()  in x :: uu____1135
                     in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1172 =
                  let uu____1174 =
                    let uu____1176 = get_dump_module ()  in x :: uu____1176
                     in
           ...
           (((fun s  ->
                let uu____1270 =
                  let uu____1272 =
                    ...
                    FStar_List.map (fun _0_36  -> String _0_36) uu____1274
                     in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1292 = FStar_Util.int_of_string x  in
                Int uu____1292)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1349 = FStar_Util.int_of_string x  in
                Int uu____1349)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1359 = FStar_Util.int_of_string x  in
                Int uu____1359)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1369 = FStar_Util.int_of_string x  in
                Int uu____1369)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1386 = FStar_Util.int_of_string x  in
                Int uu____1386)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1403 =
                  let uu____1405 =
                    let uu____1407 = get_no_extract ()  in x :: uu____1407
                     in
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n1  ->
                let uu____1579 = FStar_Util.int_of_string n1  in
                Int uu____1579)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "unthrottle_inductives",
        (FStar_Getopt.ZeroArgs ((fun uu____1607  -> Bool true))),
        "Let the SMT solver unfold inductive types to arbitrary depths (may affect verifier performance)");
      (FStar_Getopt.noshort, "use_eq_at_higher_order",
        (FStar_Getopt.ZeroArgs ((fun uu____1614  -> Bool true))),
        "Use equality constraints when comparing higher-order types (Temporary)");
      (FStar_Getopt.noshort, "use_hints",
        (FStar_Getopt.ZeroArgs ((fun uu____1621  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "verify_all",
        (FStar_Getopt.ZeroArgs ((fun uu____1643  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1661 =
                  let uu____1663 =
                    let uu____1665 = get___temp_no_proj ()  in x ::
                      uu____1665
                     in
      ...
      (FStar_Getopt.noshort, "z3cliopt",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1693 =
                  let uu____1695 =
                    let uu____1697 = get_z3cliopt ()  in
                    FStar_List.append uu____1697 [s]  in
                  FStar_All.pipe_right uu____1695
                    (FStar_List.map (fun _0_45  -> String _0_45))
                   in
                List uu____1693)), "[option]")), "Z3 command line options");
      (FStar_Getopt.noshort, "z3refresh",
        (FStar_Getopt.ZeroArgs ((fun uu____1707  -> Bool true))),
        "Restart Z3 after each query; useful for ensuring proof robustness");
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1717 = FStar_Util.int_of_string s  in
                Int uu____1717)), "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1727 = FStar_Util.int_of_string s  in
                Int uu____1727)), "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1737 = FStar_Util.int_of_string s  in
                Int uu____1737)), "[positive integer]")),
        "Set the Z3 random seed (default 0)");
      (FStar_Getopt.noshort, "__no_positivity",
        (FStar_Getopt.ZeroArgs ((fun uu____1744  -> Bool true))),
        "Don't check positivity of inductive types")]
       in
    let uu____1750 = FStar_List.map mk_spec specs1  in
    ('h', "help",
      (FStar_Getopt.ZeroArgs
         (fun x  ->
            display_usage_aux specs1; FStar_All.exit (Prims.parse_int "0"))),
      "Display this information") :: uu____1750
  ...
  fun s  ->
    ...
    | uu____1771 ->
        (FStar_Util.print_string "Wrong argument to codegen flag\n";
         (let uu____1774 = specs ()  in display_usage_aux uu____1774);
         FStar_All.exit (Prims.parse_int "1"))

and string_as_bool : Prims.string -> Prims.string -> option_val =
  fun option_name  ->
    fun uu___55_1782  ->
      match uu___55_1782 with
      | "true" -> Bool true
      | "false" -> Bool false
      | uu____1783 ->
...
let docs : Prims.unit -> (Prims.string * Prims.string) Prims.list =
  fun uu____1800  ->
    let uu____1801 = specs ()  in
    FStar_List.map
      (fun uu____1815  ->
         match uu____1815 with
         | (uu____1823,name,uu____1825,doc) -> (name, doc)) uu____1801
  
let settable : Prims.string -> Prims.bool =
  fun uu___56_1831  ->
    match uu___56_1831 with
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1855  ->
          ...
          | (uu____1861,x,uu____1863,uu____1864) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1885  ->
          ...
          | (uu____1891,x,uu____1893,uu____1894) -> resettable x))
  
let display_usage : Prims.unit -> Prims.unit =
  fun uu____1899  ->
    let uu____1900 = specs ()  in display_usage_aux uu____1900
  
let fstar_home : Prims.unit -> Prims.string =
  fun uu____1909  ->
    let uu____1910 = get_fstar_home ()  in
...
let uu___is_File_argument : Prims.exn -> Prims.bool =
  fun projectee  ->
    ...
    | File_argument uu____1922 -> true
    | uu____1923 -> false
  
let __proj__File_argument__item__uu___ : Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | File_argument uu____1930 -> uu____1930
...
let parse_cmd_line :
  ...
  fun uu____1967  ->
    let res =
      let uu____1969 = specs ()  in
      FStar_Getopt.parse_cmdline uu____1969
        (fun i  ->
           let uu____1972 =
             let uu____1974 = FStar_ST.read file_list_  in
             FStar_List.append uu____1974 [i]  in
           FStar_ST.write file_list_ uu____1972)
       in
    let uu____1982 =
      let uu____1984 = FStar_ST.read file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1984
       in
    (res, uu____1982)
  
let file_list : Prims.unit -> Prims.string Prims.list =
  fun uu____1993  -> FStar_ST.read file_list_ 
let restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module ()  in
    if should_clear then clear () else init ();
    (let r =
       let uu____2005 = specs ()  in
       FStar_Getopt.parse_cmdline uu____2005 (fun x  -> ())  in
     (let uu____2009 =
        let uu____2012 =
          let uu____2013 =
            FStar_List.map (fun _0_46  -> String _0_46) old_verify_module  in
          List uu____2013  in
        ("verify_module", uu____2012)  in
      set_option' uu____2009);
     r)
  
let should_verify : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2018 = get_lax ()  in
    if uu____2018
    then false
    else
      (let uu____2020 = get_verify_all ()  in
       if uu____2020
       then true
       else
         (let uu____2022 = get_verify_module ()  in
          match uu____2022 with
          | [] ->
              let uu____2024 = file_list ()  in
              FStar_List.existsML
                (fun f  ->
                   ...
                   let f2 =
                     let uu____2029 =
                       let uu____2030 =
                         let uu____2031 =
                           let uu____2032 = FStar_Util.get_file_extension f1
                              in
                           FStar_String.length uu____2032  in
                         (FStar_String.length f1) - uu____2031  in
                       uu____2030 - (Prims.parse_int "1")  in
                     FStar_String.substring f1 (Prims.parse_int "0")
                       uu____2029
                      in
                   (FStar_String.lowercase f2) = m) uu____2024
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
  
let dont_gen_projectors : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2042 = get___temp_no_proj ()  in
    FStar_List.contains m uu____2042
  
let should_print_message : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2047 = should_verify m  in
    if uu____2047 then m <> "Prims" else false
  
let include_path : Prims.unit -> Prims.string Prims.list =
  fun uu____2052  ->
    let uu____2053 = get_no_default_includes ()  in
    if uu____2053
    then get_include ()
    else
      (let h = fstar_home ()  in
       ...
       let uu____2059 =
         ...
         FStar_All.pipe_right uu____2061
          ...
          in
       let uu____2068 =
         let uu____2070 = get_include ()  in
         FStar_List.append uu____2070 ["."]  in
       FStar_List.append uu____2059 uu____2068)
  
let find_file : Prims.string -> Prims.string option =
  fun filename  ->
    let uu____2076 = FStar_Util.is_path_absolute filename  in
    if uu____2076
    then (if FStar_Util.file_exists filename then Some filename else None)
    else
      (let uu____2081 =
         let uu____2083 = include_path ()  in FStar_List.rev uu____2083  in
       FStar_Util.find_map uu____2081
         (fun p  ->
...
let prims : Prims.unit -> Prims.string =
  fun uu____2091  ->
    let uu____2092 = get_prims ()  in
    match uu____2092 with
    | None  ->
        let filename = "prims.fst"  in
        let uu____2095 = find_file filename  in
             ...
             let uu____2098 =
               let uu____2099 =
                 FStar_Util.format1
                   ...
                   filename
                  in
               FStar_Util.Failure uu____2099  in
             raise uu____2098)
    | Some x -> x
  
let prims_basename : Prims.unit -> Prims.string =
  fun uu____2103  ->
    let uu____2104 = prims ()  in FStar_Util.basename uu____2104
  
let pervasives : Prims.unit -> Prims.string =
  fun uu____2107  ->
    let filename = "FStar.Pervasives.fst"  in
    let uu____2109 = find_file filename  in
        ...
        let uu____2112 =
          let uu____2113 =
            FStar_Util.format1
              ...
              filename
             in
          FStar_Util.Failure uu____2113  in
        raise uu____2112
  
let pervasives_basename : Prims.unit -> Prims.string =
  fun uu____2116  ->
    let uu____2117 = pervasives ()  in FStar_Util.basename uu____2117
  
let prepend_output_dir : Prims.string -> Prims.string =
  fun fname  ->
    let uu____2121 = get_odir ()  in
...
let __temp_no_proj : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2127 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____2127 (FStar_List.contains s)
  
let admit_smt_queries : Prims.unit -> Prims.bool =
  fun uu____2132  -> get_admit_smt_queries () 
let check_hints : Prims.unit -> Prims.bool =
  fun uu____2135  -> get_check_hints () 
let codegen : Prims.unit -> Prims.string option =
  fun uu____2139  -> get_codegen () 
let codegen_libs : Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____2144  ->
    let uu____2145 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____2145
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let debug_any : Prims.unit -> Prims.bool =
  fun uu____2154  -> let uu____2155 = get_debug ()  in uu____2155 <> [] 
let debug_at_level : Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____2164 = get_debug ()  in
          FStar_All.pipe_right uu____2164 (FStar_List.contains modul)))
        && (debug_level_geq level)
  
let dep : Prims.unit -> Prims.string option = fun uu____2170  -> get_dep () 
let detail_errors : Prims.unit -> Prims.bool =
  fun uu____2173  -> get_detail_errors () 
let doc : Prims.unit -> Prims.bool = fun uu____2176  -> get_doc () 
let dump_module : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2180 = get_dump_module ()  in
    FStar_All.pipe_right uu____2180 (FStar_List.contains s)
  
let eager_inference : Prims.unit -> Prims.bool =
  fun uu____2185  -> get_eager_inference () 
let explicit_deps : Prims.unit -> Prims.bool =
  fun uu____2188  -> get_explicit_deps () 
let extract_all : Prims.unit -> Prims.bool =
  fun uu____2191  -> get_extract_all () 
let fs_typ_app : Prims.string -> Prims.bool =
  fun filename  ->
    let uu____2195 = FStar_ST.read light_off_files  in
    FStar_List.contains filename uu____2195
  
let full_context_dependency : Prims.unit -> Prims.bool =
  fun uu____2202  -> true 
let hide_genident_nums : Prims.unit -> Prims.bool =
  fun uu____2205  -> get_hide_genident_nums () 
let hide_uvar_nums : Prims.unit -> Prims.bool =
  fun uu____2208  -> get_hide_uvar_nums () 
let hint_info : Prims.unit -> Prims.bool =
  fun uu____2211  -> get_hint_info () 
let ide : Prims.unit -> Prims.bool = fun uu____2214  -> get_ide () 
let indent : Prims.unit -> Prims.bool = fun uu____2217  -> get_indent () 
let initial_fuel : Prims.unit -> Prims.int =
  fun uu____2220  ->
    let uu____2221 = get_initial_fuel ()  in
    let uu____2222 = get_max_fuel ()  in Prims.min uu____2221 uu____2222
  
let initial_ifuel : Prims.unit -> Prims.int =
  fun uu____2225  ->
    let uu____2226 = get_initial_ifuel ()  in
    let uu____2227 = get_max_ifuel ()  in Prims.min uu____2226 uu____2227
  
let interactive : Prims.unit -> Prims.bool =
  fun uu____2230  -> (get_in ()) || (get_ide ()) 
let lax : Prims.unit -> Prims.bool = fun uu____2233  -> get_lax () 
let load : Prims.unit -> Prims.string option = fun uu____2237  -> get_load () 
let legacy_interactive : Prims.unit -> Prims.bool =
  fun uu____2240  -> get_in () 
let log_queries : Prims.unit -> Prims.bool =
  fun uu____2243  -> get_log_queries () 
let log_types : Prims.unit -> Prims.bool =
  fun uu____2246  -> get_log_types () 
let max_fuel : Prims.unit -> Prims.int = fun uu____2249  -> get_max_fuel () 
let max_ifuel : Prims.unit -> Prims.int = fun uu____2252  -> get_max_ifuel () 
let min_fuel : Prims.unit -> Prims.int = fun uu____2255  -> get_min_fuel () 
let ml_ish : Prims.unit -> Prims.bool = fun uu____2258  -> get_MLish () 
let set_ml_ish : Prims.unit -> Prims.unit =
  fun uu____2261  -> set_option "MLish" (Bool true) 
let n_cores : Prims.unit -> Prims.int = fun uu____2264  -> get_n_cores () 
let no_default_includes : Prims.unit -> Prims.bool =
  fun uu____2267  -> get_no_default_includes () 
let no_extract : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2271 = get_no_extract ()  in
    FStar_All.pipe_right uu____2271 (FStar_List.contains s)
  
let no_location_info : Prims.unit -> Prims.bool =
  fun uu____2276  -> get_no_location_info () 
...
let smtencoding_elim_box : Prims.unit -> Prims.bool =
  fun uu____2317  -> get_smtencoding_elim_box () 
let smtencoding_nl_arith_native : Prims.unit -> Prims.bool =
  fun uu____2320  ->
    let uu____2321 = get_smtencoding_nl_arith_repr ()  in
    uu____2321 = "native"
  
let smtencoding_nl_arith_wrapped : Prims.unit -> Prims.bool =
  fun uu____2324  ->
    let uu____2325 = get_smtencoding_nl_arith_repr ()  in
    uu____2325 = "wrapped"
  
let smtencoding_nl_arith_default : Prims.unit -> Prims.bool =
  fun uu____2328  ->
    let uu____2329 = get_smtencoding_nl_arith_repr ()  in
    uu____2329 = "boxwrap"
  
let smtencoding_l_arith_native : Prims.unit -> Prims.bool =
  fun uu____2332  ->
    let uu____2333 = get_smtencoding_l_arith_repr ()  in
    uu____2333 = "native"
  
let smtencoding_l_arith_default : Prims.unit -> Prims.bool =
  fun uu____2336  ->
    let uu____2337 = get_smtencoding_l_arith_repr ()  in
    uu____2337 = "boxwrap"
  
let split_cases : Prims.unit -> Prims.int =
  fun uu____2340  -> get_split_cases () 
let timing : Prims.unit -> Prims.bool = fun uu____2343  -> get_timing () 
let trace_error : Prims.unit -> Prims.bool =
  fun uu____2346  -> get_trace_error () 
let unthrottle_inductives : Prims.unit -> Prims.bool =
  fun uu____2349  -> get_unthrottle_inductives () 
let use_eq_at_higher_order : Prims.unit -> Prims.bool =
  fun uu____2352  -> get_use_eq_at_higher_order () 
let use_hints : Prims.unit -> Prims.bool =
  fun uu____2355  -> get_use_hints () 
let use_tactics : Prims.unit -> Prims.bool =
  fun uu____2358  -> get_use_tactics () 
let using_facts_from : Prims.unit -> Prims.string Prims.list option =
  fun uu____2363  -> get_using_facts_from () 
let verify_all : Prims.unit -> Prims.bool =
  fun uu____2366  -> get_verify_all () 
let verify_module : Prims.unit -> Prims.string Prims.list =
  fun uu____2370  -> get_verify_module () 
let warn_default_effects : Prims.unit -> Prims.bool =
  fun uu____2373  -> get_warn_default_effects () 
let z3_exe : Prims.unit -> Prims.string =
  fun uu____2376  ->
    let uu____2377 = get_smt ()  in
    match uu____2377 with | None  -> FStar_Platform.exe "z3" | Some s -> s
  
let z3_cliopt : Prims.unit -> Prims.string Prims.list =
  fun uu____2383  -> get_z3cliopt () 
let z3_refresh : Prims.unit -> Prims.bool =
  fun uu____2386  -> get_z3refresh () 
let z3_rlimit : Prims.unit -> Prims.int = fun uu____2389  -> get_z3rlimit () 
let z3_rlimit_factor : Prims.unit -> Prims.int =
  fun uu____2392  -> get_z3rlimit_factor () 
let z3_seed : Prims.unit -> Prims.int = fun uu____2395  -> get_z3seed () 
let no_positivity : Prims.unit -> Prims.bool =
  fun uu____2398  -> get_no_positivity () 
let should_extract : Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2402 = no_extract m  in Prims.op_Negation uu____2402) &&
      ((extract_all ()) ||
         (let uu____2403 = get_extract_module ()  in
          match uu____2403 with
          | [] ->
              let uu____2405 = get_extract_namespace ()  in
