...
let hint_info: Prims.unit -> Prims.bool = fun uu____2020  -> get_hint_info ()
...
let log_types: Prims.unit -> Prims.bool = fun uu____2048  -> get_log_types ()
...
let use_hints: Prims.unit -> Prims.bool = fun uu____2135  -> get_use_hints ()
...
let z3_timeout: Prims.unit -> Prims.int = fun uu____2177  -> get_z3timeout ()
