...
let display_version: Prims.unit -> Prims.unit =
  fun uu____994  ->
    let uu____995 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____996
        uu____999 uu____1002 uu____1005 uu____1008 in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____1116 =
                let uu____1117 = let uu____1120 = f () in (name, uu____1120) in
                set_option' uu____1117 in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x =
                let uu____1131 = let uu____1134 = f x in (name, uu____1134) in
  ...
  fun uu____1214  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  -> let uu____1246 = parse_codegen s in String uu____1246)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1258 =
                  let uu____1260 =
                    let uu____1262 = get_codegen_lib () in s :: uu____1262 in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1296 =
                  let uu____1298 =
                    let uu____1300 = get_debug_level () in x :: uu____1300 in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1342 =
                  let uu____1344 =
                    let uu____1346 = get_dump_module () in x :: uu____1346 in
           ...
           (((fun s  ->
                let uu____1458 =
                  let uu____1460 =
                    ...
                    FStar_List.map (fun _0_37  -> String _0_37) uu____1462 in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1483 = FStar_Util.int_of_string x in Int uu____1483)),
           ...
           (((fun s  ->
                let uu____1523 =
                  let uu____1525 =
                    ...
                    FStar_List.map (fun _0_38  -> String _0_38) uu____1527 in
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1556 = FStar_Util.int_of_string x in Int uu____1556)),
             "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1568 = FStar_Util.int_of_string x in Int uu____1568)),
             "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1580 = FStar_Util.int_of_string x in Int uu____1580)),
             "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1600 = FStar_Util.int_of_string x in Int uu____1600)),
             "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1620 =
                  let uu____1622 =
                    let uu____1624 = get_no_extract () in x :: uu____1624 in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1906 =
                  let uu____1908 =
                    let uu____1910 = get___temp_no_proj () in x :: uu____1910 in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1970 = FStar_Util.int_of_string s in Int uu____1970)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1982 = FStar_Util.int_of_string s in Int uu____1982)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1994 = FStar_Util.int_of_string s in Int uu____1994)),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____2260
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____2265) in
    let uu____2275 =
      let uu____2277 = FStar_ST.read file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____2277 in
    (res, uu____2275)
                ...
                (fun f  ->
                   ...
                   let f2 =
                     let uu____2329 =
                       let uu____2330 =
                         let uu____2331 =
                           let uu____2332 = FStar_Util.get_file_extension f1 in
...
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____2721  ->
    let uu____2722 = get_smtencoding_l_arith_repr () in uu____2722 = "native"
