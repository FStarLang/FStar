...
let get_print_ml : Prims.unit  ->  Prims.bool = (fun uu____632 -> (lookup_opt "print_ml" as_bool))


let get_print_universes : Prims.unit  ->  Prims.bool = (fun uu____635 -> (lookup_opt "print_universes" as_bool))


let get_print_z3_statistics : Prims.unit  ->  Prims.bool = (fun uu____638 -> (lookup_opt "print_z3_statistics" as_bool))


let get_prn : Prims.unit  ->  Prims.bool = (fun uu____641 -> (lookup_opt "prn" as_bool))


let get_record_hints : Prims.unit  ->  Prims.bool = (fun uu____644 -> (lookup_opt "record_hints" as_bool))


let get_reuse_hint_for : Prims.unit  ->  Prims.string Prims.option = (fun uu____648 -> (lookup_opt "reuse_hint_for" (as_option as_string)))


let get_show_signatures : Prims.unit  ->  Prims.string Prims.list = (fun uu____653 -> (lookup_opt "show_signatures" (as_list as_string)))


let get_silent : Prims.unit  ->  Prims.bool = (fun uu____657 -> (lookup_opt "silent" as_bool))


let get_smt : Prims.unit  ->  Prims.string Prims.option = (fun uu____661 -> (lookup_opt "smt" (as_option as_string)))


let get_split_cases : Prims.unit  ->  Prims.int = (fun uu____665 -> (lookup_opt "split_cases" as_int))
...
in (FStar_Getopt.parse_string specs (fun uu____1546 -> ()) s)))


let file_list_ : Prims.string Prims.list FStar_ST.ref = (FStar_Util.mk_ref [])


let parse_cmd_line : Prims.unit  ->  (FStar_Getopt.parse_cmdline_res * Prims.string Prims.list) = (fun uu____1557 -> (
...
let file_list : Prims.unit  ->  Prims.string Prims.list = (fun uu____1573 -> (FStar_ST.read file_list_))
...
let uu____1594 = (get_verify_module ())
...
let uu____1612 = (should_verify m)
...
let include_path : Prims.unit  ->  Prims.string Prims.list = (fun uu____1617 -> (

let uu____1618 = (get_no_default_includes ())
...
let uu____1633 = (FStar_Util.is_path_absolute filename)
...
let prims : Prims.unit  ->  Prims.string = (fun uu____1644 -> (

let uu____1645 = (get_prims ())
...
let uu____1648 = (find_file filename)
...
let admit_smt_queries : Prims.unit  ->  Prims.bool = (fun uu____1664 -> (get_admit_smt_queries ()))


let check_cardinality : Prims.unit  ->  Prims.bool = (fun uu____1667 -> (let _0_94 = (get_cardinality ())
in (_0_94 = "check")))


let codegen : Prims.unit  ->  Prims.string Prims.option = (fun uu____1671 -> (get_codegen ()))


let codegen_libs : Prims.unit  ->  Prims.string Prims.list Prims.list = (fun uu____1676 -> (let _0_95 = (get_codegen_lib ())
in (FStar_All.pipe_right _0_95 (FStar_List.map (fun x -> (FStar_Util.split x "."))))))


let debug_any : Prims.unit  ->  Prims.bool = (fun uu____1684 -> (let _0_96 = (get_debug ())
in (_0_96 <> [])))
...
let dep : Prims.unit  ->  Prims.string Prims.option = (fun uu____1696 -> (get_dep ()))


let detail_errors : Prims.unit  ->  Prims.bool = (fun uu____1699 -> (get_detail_errors ()))


let doc : Prims.unit  ->  Prims.bool = (fun uu____1702 -> (get_doc ()))
...
let eager_inference : Prims.unit  ->  Prims.bool = (fun uu____1709 -> (get_eager_inference ()))


let explicit_deps : Prims.unit  ->  Prims.bool = (fun uu____1712 -> (get_explicit_deps ()))


let extract_all : Prims.unit  ->  Prims.bool = (fun uu____1715 -> (get_extract_all ()))
...
let full_context_dependency : Prims.unit  ->  Prims.bool = (fun uu____1724 -> true)


let hide_genident_nums : Prims.unit  ->  Prims.bool = (fun uu____1727 -> (get_hide_genident_nums ()))


let hide_uvar_nums : Prims.unit  ->  Prims.bool = (fun uu____1730 -> (get_hide_uvar_nums ()))


let hint_info : Prims.unit  ->  Prims.bool = (fun uu____1733 -> (get_hint_info ()))


let indent : Prims.unit  ->  Prims.bool = (fun uu____1736 -> (get_indent ()))


let initial_fuel : Prims.unit  ->  Prims.int = (fun uu____1739 -> (get_initial_fuel ()))


let initial_ifuel : Prims.unit  ->  Prims.int = (fun uu____1742 -> (get_initial_ifuel ()))


let inline_arith : Prims.unit  ->  Prims.bool = (fun uu____1745 -> (get_inline_arith ()))


let interactive : Prims.unit  ->  Prims.bool = (fun uu____1748 -> (get_in ()))


let lax : Prims.unit  ->  Prims.bool = (fun uu____1751 -> (get_lax ()))


let log_queries : Prims.unit  ->  Prims.bool = (fun uu____1754 -> (get_log_queries ()))


let log_types : Prims.unit  ->  Prims.bool = (fun uu____1757 -> (get_log_types ()))


let max_fuel : Prims.unit  ->  Prims.int = (fun uu____1760 -> (get_max_fuel ()))


let max_ifuel : Prims.unit  ->  Prims.int = (fun uu____1763 -> (get_max_ifuel ()))


let min_fuel : Prims.unit  ->  Prims.int = (fun uu____1766 -> (get_min_fuel ()))


let ml_ish : Prims.unit  ->  Prims.bool = (fun uu____1769 -> (get_MLish ()))


let n_cores : Prims.unit  ->  Prims.int = (fun uu____1772 -> (get_n_cores ()))


let no_default_includes : Prims.unit  ->  Prims.bool = (fun uu____1775 -> (get_no_default_includes ()))
...
let no_location_info : Prims.unit  ->  Prims.bool = (fun uu____1782 -> (get_no_location_info ()))


let norm_then_print : Prims.unit  ->  Prims.bool = (fun uu____1785 -> (let _0_101 = (get_print_before_norm ())
in (_0_101 = false)))


let output_dir : Prims.unit  ->  Prims.string Prims.option = (fun uu____1789 -> (get_odir ()))


let print_bound_var_types : Prims.unit  ->  Prims.bool = (fun uu____1792 -> (get_print_bound_var_types ()))


let print_effect_args : Prims.unit  ->  Prims.bool = (fun uu____1795 -> (get_print_effect_args ()))


let print_fuels : Prims.unit  ->  Prims.bool = (fun uu____1798 -> (get_print_fuels ()))


let print_implicits : Prims.unit  ->  Prims.bool = (fun uu____1801 -> (get_print_implicits ()))


let print_ml : Prims.unit  ->  Prims.bool = (fun uu____1804 -> (get_print_ml ()))


let print_real_names : Prims.unit  ->  Prims.bool = (fun uu____1807 -> (get_prn ()))


let print_universes : Prims.unit  ->  Prims.bool = (fun uu____1810 -> (get_print_universes ()))


let print_z3_statistics : Prims.unit  ->  Prims.bool = (fun uu____1813 -> (get_print_z3_statistics ()))


let record_hints : Prims.unit  ->  Prims.bool = (fun uu____1816 -> (get_record_hints ()))


let reuse_hint_for : Prims.unit  ->  Prims.string Prims.option = (fun uu____1820 -> (get_reuse_hint_for ()))


let silent : Prims.unit  ->  Prims.bool = (fun uu____1823 -> (get_silent ()))


let split_cases : Prims.unit  ->  Prims.int = (fun uu____1826 -> (get_split_cases ()))


let timing : Prims.unit  ->  Prims.bool = (fun uu____1829 -> (get_timing ()))


let trace_error : Prims.unit  ->  Prims.bool = (fun uu____1832 -> (get_trace_error ()))


let unthrottle_inductives : Prims.unit  ->  Prims.bool = (fun uu____1835 -> (get_unthrottle_inductives ()))


let use_eq_at_higher_order : Prims.unit  ->  Prims.bool = (fun uu____1838 -> (get_use_eq_at_higher_order ()))


let use_hints : Prims.unit  ->  Prims.bool = (fun uu____1841 -> (get_use_hints ()))


let verify_all : Prims.unit  ->  Prims.bool = (fun uu____1844 -> (get_verify_all ()))


let verify_module : Prims.unit  ->  Prims.string Prims.list = (fun uu____1848 -> (get_verify_module ()))


let warn_cardinality : Prims.unit  ->  Prims.bool = (fun uu____1851 -> (let _0_102 = (get_cardinality ())
in (_0_102 = "warn")))


let warn_top_level_effects : Prims.unit  ->  Prims.bool = (fun uu____1854 -> (get_warn_top_level_effects ()))


let z3_exe : Prims.unit  ->  Prims.string = (fun uu____1857 -> (

let uu____1858 = (get_smt ())
...
let z3_refresh : Prims.unit  ->  Prims.bool = (fun uu____1863 -> (get_z3refresh ()))


let z3_rlimit : Prims.unit  ->  Prims.int = (fun uu____1866 -> (get_z3rlimit ()))


let z3_seed : Prims.unit  ->  Prims.int = (fun uu____1869 -> (get_z3seed ()))


let z3_timeout : Prims.unit  ->  Prims.int = (fun uu____1872 -> (get_z3timeout ()))


let should_extract : Prims.string  ->  Prims.bool = (fun m -> ((not ((no_extract m))) && ((extract_all ()) || (

let uu____1876 = (get_extract_module ())
in (match (uu____1876) with
| [] -> begin
(

let uu____1878 = (get_extract_namespace ())
