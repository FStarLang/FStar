...
let (get_print_cache_version : unit -> Prims.bool) =
  fun uu____2824  -> lookup_opt "print_cache_version" as_bool 
let (get_cmi : unit -> Prims.bool) =
  fun uu____2833  -> lookup_opt "cmi" as_bool 
let (get_codegen : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____2844  -> lookup_opt "codegen" (as_option as_string) 
let (get_codegen_lib : unit -> Prims.string Prims.list) =
  fun uu____2858  -> lookup_opt "codegen-lib" (as_list as_string) 
let (get_debug : unit -> Prims.string Prims.list) =
  fun uu____2872  -> lookup_opt "debug" (as_list as_string) 
let (get_debug_level : unit -> Prims.string Prims.list) =
  fun uu____2886  -> lookup_opt "debug_level" as_comma_string_list 
let (get_defensive : unit -> Prims.string) =
  fun uu____2897  -> lookup_opt "defensive" as_string 
let (get_dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____2908  -> lookup_opt "dep" (as_option as_string) 
...
let (get_dump_module : unit -> Prims.string Prims.list) =
  fun uu____2940  -> lookup_opt "dump_module" (as_list as_string) 
let (get_eager_subtyping : unit -> Prims.bool) =
  fun uu____2952  -> lookup_opt "eager_subtyping" as_bool 
let (get_expose_interfaces : unit -> Prims.bool) =
  fun uu____2961  -> lookup_opt "expose_interfaces" as_bool 
let (get_extract :
  unit -> Prims.string Prims.list FStar_Pervasives_Native.option) =
  fun uu____2974  -> lookup_opt "extract" (as_option (as_list as_string)) 
let (get_extract_module : unit -> Prims.string Prims.list) =
  fun uu____2993  -> lookup_opt "extract_module" (as_list as_string) 
let (get_extract_namespace : unit -> Prims.string Prims.list) =
  fun uu____3007  -> lookup_opt "extract_namespace" (as_list as_string) 
let (get_fs_typ_app : unit -> Prims.bool) =
  fun uu____3019  -> lookup_opt "fs_typ_app" as_bool 
let (get_hide_uvar_nums : unit -> Prims.bool) =
  fun uu____3028  -> lookup_opt "hide_uvar_nums" as_bool 
let (get_hint_info : unit -> Prims.bool) =
  fun uu____3037  -> lookup_opt "hint_info" as_bool 
let (get_hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3048  -> lookup_opt "hint_dir" (as_option as_string) 
let (get_hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3062  -> lookup_opt "hint_file" (as_option as_string) 
let (get_in : unit -> Prims.bool) =
  fun uu____3074  -> lookup_opt "in" as_bool 
let (get_ide : unit -> Prims.bool) =
  fun uu____3083  -> lookup_opt "ide" as_bool 
let (get_lsp : unit -> Prims.bool) =
  fun uu____3092  -> lookup_opt "lsp" as_bool 
let (get_include : unit -> Prims.string Prims.list) =
  fun uu____3103  -> lookup_opt "include" (as_list as_string) 
let (get_print : unit -> Prims.bool) =
  fun uu____3115  -> lookup_opt "print" as_bool 
let (get_print_in_place : unit -> Prims.bool) =
  fun uu____3124  -> lookup_opt "print_in_place" as_bool 
let (get_initial_fuel : unit -> Prims.int) =
  fun uu____3133  -> lookup_opt "initial_fuel" as_int 
let (get_initial_ifuel : unit -> Prims.int) =
  fun uu____3142  -> lookup_opt "initial_ifuel" as_int 
let (get_keep_query_captions : unit -> Prims.bool) =
  fun uu____3151  -> lookup_opt "keep_query_captions" as_bool 
let (get_lax : unit -> Prims.bool) =
  fun uu____3160  -> lookup_opt "lax" as_bool 
let (get_load : unit -> Prims.string Prims.list) =
  fun uu____3171  -> lookup_opt "load" (as_list as_string) 
let (get_log_queries : unit -> Prims.bool) =
  fun uu____3183  -> lookup_opt "log_queries" as_bool 
let (get_log_types : unit -> Prims.bool) =
  fun uu____3192  -> lookup_opt "log_types" as_bool 
let (get_max_fuel : unit -> Prims.int) =
  fun uu____3201  -> lookup_opt "max_fuel" as_int 
let (get_max_ifuel : unit -> Prims.int) =
  fun uu____3210  -> lookup_opt "max_ifuel" as_int 
let (get_min_fuel : unit -> Prims.int) =
  fun uu____3219  -> lookup_opt "min_fuel" as_int 
let (get_MLish : unit -> Prims.bool) =
  fun uu____3228  -> lookup_opt "MLish" as_bool 
let (get_no_default_includes : unit -> Prims.bool) =
  fun uu____3237  -> lookup_opt "no_default_includes" as_bool 
let (get_no_extract : unit -> Prims.string Prims.list) =
  fun uu____3248  -> lookup_opt "no_extract" (as_list as_string) 
let (get_no_location_info : unit -> Prims.bool) =
  fun uu____3260  -> lookup_opt "no_location_info" as_bool 
let (get_no_plugins : unit -> Prims.bool) =
  fun uu____3269  -> lookup_opt "no_plugins" as_bool 
let (get_no_smt : unit -> Prims.bool) =
  fun uu____3278  -> lookup_opt "no_smt" as_bool 
let (get_normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____3287  -> lookup_opt "normalize_pure_terms_for_extraction" as_bool 
let (get_odir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3298  -> lookup_opt "odir" (as_option as_string) 
let (get_ugly : unit -> Prims.bool) =
  fun uu____3310  -> lookup_opt "ugly" as_bool 
let (get_prims : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3321  -> lookup_opt "prims" (as_option as_string) 
let (get_print_bound_var_types : unit -> Prims.bool) =
  fun uu____3333  -> lookup_opt "print_bound_var_types" as_bool 
let (get_print_effect_args : unit -> Prims.bool) =
  fun uu____3342  -> lookup_opt "print_effect_args" as_bool 
let (get_print_full_names : unit -> Prims.bool) =
  fun uu____3351  -> lookup_opt "print_full_names" as_bool 
let (get_print_implicits : unit -> Prims.bool) =
  fun uu____3360  -> lookup_opt "print_implicits" as_bool 
let (get_print_universes : unit -> Prims.bool) =
  fun uu____3369  -> lookup_opt "print_universes" as_bool 
let (get_print_z3_statistics : unit -> Prims.bool) =
  fun uu____3378  -> lookup_opt "print_z3_statistics" as_bool 
let (get_prn : unit -> Prims.bool) =
  fun uu____3387  -> lookup_opt "prn" as_bool 
let (get_quake_lo : unit -> Prims.int) =
  fun uu____3396  -> lookup_opt "quake_lo" as_int 
let (get_quake_hi : unit -> Prims.int) =
  fun uu____3405  -> lookup_opt "quake_hi" as_int 
let (get_quake_keep : unit -> Prims.bool) =
  fun uu____3414  -> lookup_opt "quake_keep" as_bool 
...
let (get_retry : unit -> Prims.bool) =
  fun uu____3450  -> lookup_opt "retry" as_bool 
let (get_reuse_hint_for :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3461  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let (get_silent : unit -> Prims.bool) =
  fun uu____3473  -> lookup_opt "silent" as_bool 
let (get_smt : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3484  -> lookup_opt "smt" (as_option as_string) 
let (get_smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____3496  -> lookup_opt "smtencoding.elim_box" as_bool 
let (get_smtencoding_nl_arith_repr : unit -> Prims.string) =
  fun uu____3505  -> lookup_opt "smtencoding.nl_arith_repr" as_string 
let (get_smtencoding_l_arith_repr : unit -> Prims.string) =
  fun uu____3514  -> lookup_opt "smtencoding.l_arith_repr" as_string 
let (get_smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____3523  -> lookup_opt "smtencoding.valid_intro" as_bool 
let (get_smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____3532  -> lookup_opt "smtencoding.valid_elim" as_bool 
let (get_tactic_raw_binders : unit -> Prims.bool) =
  fun uu____3541  -> lookup_opt "tactic_raw_binders" as_bool 
let (get_tactics_failhard : unit -> Prims.bool) =
  fun uu____3550  -> lookup_opt "tactics_failhard" as_bool 
let (get_tactics_info : unit -> Prims.bool) =
  fun uu____3559  -> lookup_opt "tactics_info" as_bool 
let (get_tactic_trace : unit -> Prims.bool) =
  fun uu____3568  -> lookup_opt "tactic_trace" as_bool 
let (get_tactic_trace_d : unit -> Prims.int) =
  fun uu____3577  -> lookup_opt "tactic_trace_d" as_int 
let (get_tactics_nbe : unit -> Prims.bool) =
  fun uu____3586  -> lookup_opt "__tactics_nbe" as_bool 
let (get_tcnorm : unit -> Prims.bool) =
  fun uu____3595  -> lookup_opt "tcnorm" as_bool 
let (get_timing : unit -> Prims.bool) =
  fun uu____3604  -> lookup_opt "timing" as_bool 
let (get_trace_error : unit -> Prims.bool) =
  fun uu____3613  -> lookup_opt "trace_error" as_bool 
let (get_unthrottle_inductives : unit -> Prims.bool) =
  fun uu____3622  -> lookup_opt "unthrottle_inductives" as_bool 
let (get_unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____3631  -> lookup_opt "unsafe_tactic_exec" as_bool 
let (get_use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____3640  -> lookup_opt "use_eq_at_higher_order" as_bool 
let (get_use_hints : unit -> Prims.bool) =
  fun uu____3649  -> lookup_opt "use_hints" as_bool 
let (get_use_hint_hashes : unit -> Prims.bool) =
  fun uu____3658  -> lookup_opt "use_hint_hashes" as_bool 
let (get_use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3669  -> lookup_opt "use_native_tactics" (as_option as_string) 
let (get_use_tactics : unit -> Prims.bool) =
  fun uu____3681  ->
    let uu____3682 = lookup_opt "no_tactics" as_bool  in
    Prims.op_Negation uu____3682
...
let (get_verify_module : unit -> Prims.string Prims.list) =
  fun uu____3729  -> lookup_opt "verify_module" (as_list as_string) 
let (get___temp_no_proj : unit -> Prims.string Prims.list) =
  fun uu____3743  -> lookup_opt "__temp_no_proj" (as_list as_string) 
let (get_version : unit -> Prims.bool) =
  fun uu____3755  -> lookup_opt "version" as_bool 
let (get_warn_default_effects : unit -> Prims.bool) =
  fun uu____3764  -> lookup_opt "warn_default_effects" as_bool 
let (get_z3cliopt : unit -> Prims.string Prims.list) =
  fun uu____3775  -> lookup_opt "z3cliopt" (as_list as_string) 
let (get_z3refresh : unit -> Prims.bool) =
  fun uu____3787  -> lookup_opt "z3refresh" as_bool 
let (get_z3rlimit : unit -> Prims.int) =
  fun uu____3796  -> lookup_opt "z3rlimit" as_int 
let (get_z3rlimit_factor : unit -> Prims.int) =
  fun uu____3805  -> lookup_opt "z3rlimit_factor" as_int 
let (get_z3seed : unit -> Prims.int) =
  fun uu____3814  -> lookup_opt "z3seed" as_int 
let (get_use_two_phase_tc : unit -> Prims.bool) =
  fun uu____3823  -> lookup_opt "use_two_phase_tc" as_bool 
let (get_no_positivity : unit -> Prims.bool) =
  fun uu____3832  -> lookup_opt "__no_positivity" as_bool 
let (get_ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____3841  -> lookup_opt "__ml_no_eta_expand_coertions" as_bool 
let (get_warn_error : unit -> Prims.string Prims.list) =
  fun uu____3852  -> lookup_opt "warn_error" (as_list as_string) 
let (get_use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____3864  -> lookup_opt "use_extracted_interfaces" as_bool 
let (get_use_nbe : unit -> Prims.bool) =
  fun uu____3873  -> lookup_opt "use_nbe" as_bool 
let (get_use_nbe_for_extraction : unit -> Prims.bool) =
  fun uu____3882  -> lookup_opt "use_nbe_for_extraction" as_bool 
...
let (get_profile :
  unit -> Prims.string Prims.list FStar_Pervasives_Native.option) =
  fun uu____3904  -> lookup_opt "profile" (as_option (as_list as_string)) 
let (get_profile_group_by_decl : unit -> Prims.bool) =
  fun uu____3921  -> lookup_opt "profile_group_by_decl" as_bool 
...
let (debug_level_geq : debug_level_t -> Prims.bool) =
  fun l2  ->
    let uu____3981 = get_debug_level ()  in
       ...
       (fun d  ->
          let uu____4025 =
            FStar_All.pipe_right sub_dirs
              (FStar_List.map
                 (fun s  ->
                    let uu____4041 = FStar_String.op_Hat "/" s  in
                    FStar_String.op_Hat d uu____4041))
             in
          d :: uu____4025))
...
let (display_version : unit -> unit) =
  fun uu____4080  ->
    let uu____4081 =
      let uu____4083 = FStar_ST.op_Bang _version  in
      let uu____4106 = FStar_ST.op_Bang _platform  in
      let uu____4129 = FStar_ST.op_Bang _compiler  in
      let uu____4152 = FStar_ST.op_Bang _date  in
      let uu____4175 = FStar_ST.op_Bang _commit  in
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____4083
        uu____4106 uu____4129 uu____4152 uu____4175
       in
    FStar_Util.print_string uu____4081
  
let display_usage_aux :
  'Auu____4206 'Auu____4207 .
    ('Auu____4206 * Prims.string * 'Auu____4207 FStar_Getopt.opt_variant *
  ...
  fun specs  ->
    ...
    FStar_List.iter
      (fun uu____4262  ->
         ...
         | (uu____4275,flag,p,doc) ->
             (match p with
              | FStar_Getopt.ZeroArgs ig ->
                  if doc = ""
                  then
                    let uu____4294 =
                      let uu____4296 = FStar_Util.colorize_bold flag  in
                      FStar_Util.format1 "  --%s\n" uu____4296  in
                    FStar_Util.print_string uu____4294
                  else
                    (let uu____4301 =
                       let uu____4303 = FStar_Util.colorize_bold flag  in
                       FStar_Util.format2 "  --%s  %s\n" uu____4303 doc  in
                     FStar_Util.print_string uu____4301)
              | FStar_Getopt.OneArg (uu____4306,argname) ->
                  if doc = ""
                  then
                    let uu____4321 =
                      let uu____4323 = FStar_Util.colorize_bold flag  in
                      let uu____4325 = FStar_Util.colorize_bold argname  in
                      FStar_Util.format2 "  --%s %s\n" uu____4323 uu____4325
                       in
                    FStar_Util.print_string uu____4321
                  else
                    (let uu____4330 =
                       let uu____4332 = FStar_Util.colorize_bold flag  in
                       let uu____4334 = FStar_Util.colorize_bold argname  in
                       FStar_Util.format3 "  --%s %s  %s\n" uu____4332
                         uu____4334 doc
                        in
                     FStar_Util.print_string uu____4330))) specs
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____4411 =
                let uu____4412 = f ()  in set_option name uu____4412  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x = let uu____4433 = f x  in set_option name uu____4433
                 in
...
let (accumulated_option : Prims.string -> option_val -> option_val) =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____4460 = lookup_opt name (as_option as_list')  in
        FStar_Util.dflt [] uu____4460  in
...
let (reverse_accumulated_option : Prims.string -> option_val -> option_val) =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____4489 = lookup_opt name (as_option as_list')  in
        FStar_Util.dflt [] uu____4489  in
      List (FStar_List.append prev_values [value])
  
let accumulate_string :
  'Auu____4511 .
    Prims.string -> ('Auu____4511 -> Prims.string) -> 'Auu____4511 -> unit
  =
  fun name  ->
    fun post_processor  ->
      fun value  ->
        let uu____4536 =
          let uu____4537 =
            let uu____4538 = post_processor value  in String uu____4538  in
          accumulated_option name uu____4537  in
        set_option name uu____4536
...
let (uu___is_Const : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | Const _0 -> true | uu____4660 -> false
  
let (__proj__Const__item___0 : opt_type -> option_val) =
  fun projectee  -> match projectee with | Const _0 -> _0 
let (uu___is_IntStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | IntStr _0 -> true | uu____4680 -> false
  
let (__proj__IntStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | IntStr _0 -> _0 
let (uu___is_BoolStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | BoolStr  -> true | uu____4701 -> false
  
let (uu___is_PathStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | PathStr _0 -> true | uu____4714 -> false
  
let (__proj__PathStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | PathStr _0 -> _0 
let (uu___is_SimpleStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | SimpleStr _0 -> true | uu____4737 -> false
  
let (__proj__SimpleStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | SimpleStr _0 -> _0 
let (uu___is_EnumStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | EnumStr _0 -> true | uu____4762 -> false
  
let (__proj__EnumStr__item___0 : opt_type -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | EnumStr _0 -> _0 
let (uu___is_OpenEnumStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | OpenEnumStr _0 -> true | uu____4798 -> false
...
let (uu___is_PostProcessed : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | PostProcessed _0 -> true | uu____4848 -> false
...
let (uu___is_Accumulated : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | Accumulated _0 -> true | uu____4888 -> false
...
let (uu___is_WithSideEffect : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | WithSideEffect _0 -> true | uu____4933 -> false
...
let (uu___is_InvalidArgument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | InvalidArgument uu____4976 -> true
    | uu____4979 -> false
  
let (__proj__InvalidArgument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | InvalidArgument uu____4989 -> uu____4989
          ...
          (fun uu___312_5013  ->
             ...
             | () ->
                 (match typ with
                  | Const c -> c
                  | IntStr uu____5015 ->
                      let uu____5017 = FStar_Util.safe_int_of_string str_val
                         in
                  ...
                  | BoolStr  ->
                      let uu____5025 =
                        ...
                        then true
                         ...
                         in
                      Bool uu____5025
                  | PathStr uu____5042 -> Path str_val
                  | SimpleStr uu____5044 -> String str_val
                  | EnumStr strs ->
                      if FStar_List.mem str_val strs
                      then String str_val
                      else FStar_Exn.raise (InvalidArgument opt_name)
                  | OpenEnumStr uu____5054 -> String str_val
  ...
  fun typ  ->
    let desc_of_enum cases =
      let uu____5121 =
        ...
        FStar_String.op_Hat "[" uu____5123  in
      FStar_Pervasives_Native.Some uu____5121  in
    match typ with
    ...
    | PostProcessed (uu____5165,elem_spec) -> desc_of_opt_type elem_spec
    | Accumulated elem_spec -> desc_of_opt_type elem_spec
    | ReverseAccumulated elem_spec -> desc_of_opt_type elem_spec
    | WithSideEffect (uu____5175,elem_spec) -> desc_of_opt_type elem_spec
...
let (arg_spec_of_opt_type :
  ...
  fun opt_name  ->
    fun typ  ->
      ...
      let uu____5206 = desc_of_opt_type typ  in
      match uu____5206 with
      | FStar_Pervasives_Native.None  ->
          FStar_Getopt.ZeroArgs ((fun uu____5214  -> parser ""))
...
let (pp_lowercase : option_val -> option_val) =
  fun s  ->
    let uu____5240 =
      let uu____5242 = as_string s  in FStar_String.lowercase uu____5242  in
    String uu____5240
...
let (interp_quake_arg : Prims.string -> (Prims.int * Prims.int * Prims.bool))
  ...
  fun s  ->
    ...
    | f::[] ->
        let uu____5300 = ios f  in
        let uu____5302 = ios f  in (uu____5300, uu____5302, false)
    | f1::f2::[] ->
        if f2 = "k"
        then
          let uu____5327 = ios f1  in
          let uu____5329 = ios f1  in (uu____5327, uu____5329, true)
        else
          (let uu____5337 = ios f1  in
           let uu____5339 = ios f2  in (uu____5337, uu____5339, false))
    | f1::f2::k::[] ->
        if k = "k"
        then
          let uu____5367 = ios f1  in
          let uu____5369 = ios f2  in (uu____5367, uu____5369, true)
        else failwith "unexpected value for --quake"
    | uu____5387 -> failwith "unexpected value for --quake"
...
let rec (specs_with_types :
  ...
  fun uu____5425  ->
    ...
    (FStar_Getopt.noshort, "fuel",
      (PostProcessed
         (((fun uu___8_6102  ->
              match uu___8_6102 with
              | String s ->
                  let p f =
                    let uu____6113 = FStar_Util.int_of_string f  in
                    Int uu____6113  in
                  let uu____6115 =
                    match FStar_Util.split s "," with
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____6144 -> failwith "unexpected value for --fuel"
                     in
                  (match uu____6115 with
                   | (min1,max1) ->
                       ((let uu____6162 = p min1  in
                         set_option "initial_fuel" uu____6162);
                        (let uu____6165 = p max1  in
                         set_option "max_fuel" uu____6165);
                        String s))
              | uu____6167 -> failwith "impos")),
    ...
    (FStar_Getopt.noshort, "ifuel",
      (PostProcessed
         (((fun uu___9_6197  ->
              match uu___9_6197 with
              | String s ->
                  let p f =
                    let uu____6208 = FStar_Util.int_of_string f  in
                    Int uu____6208  in
                  let uu____6210 =
                    match FStar_Util.split s "," with
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____6239 -> failwith "unexpected value for --ifuel"
                     in
                  (match uu____6210 with
                   | (min1,max1) ->
                       ((let uu____6257 = p min1  in
                         set_option "initial_ifuel" uu____6257);
                        (let uu____6260 = p max1  in
                         set_option "max_ifuel" uu____6260);
                        String s))
              | uu____6262 -> failwith "impos")),
           (SimpleStr "non-negative integer or pair of non-negative integers"))),
    ...
    (FStar_Getopt.noshort, "quake",
      (PostProcessed
         (((fun uu___10_6721  ->
              match uu___10_6721 with
              | String s ->
                  let uu____6724 = interp_quake_arg s  in
    ...
    (104, "help",
      (WithSideEffect
         (((fun uu____7791  ->
              (let uu____7793 = specs ()  in display_usage_aux uu____7793);
              FStar_All.exit Prims.int_zero)), (Const (Bool true)))),
      "Display this information")]

and (specs : unit -> FStar_Getopt.opt Prims.list) =
  fun uu____7824  ->
    let uu____7827 = specs_with_types ()  in
    FStar_List.map
      (fun uu____7858  ->
         match uu____7858 with
         | (short,long,typ,doc) ->
             let uu____7880 =
               let uu____7894 = arg_spec_of_opt_type long typ  in
               (short, long, uu____7894, doc)  in
             mk_spec uu____7880) uu____7827

let (settable : Prims.string -> Prims.bool) =
  fun uu___12_7909  ->
    match uu___12_7909 with
    | "abort_on" -> true
    | "admit_except" -> true
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____8150  ->
          ...
          | (uu____8165,x,uu____8167,uu____8168) -> settable x))
  
let (display_usage : unit -> unit) =
  fun uu____8184  ->
    let uu____8185 = specs ()  in display_usage_aux uu____8185
...
let (uu___is_File_argument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | File_argument uu____8217 -> true
    | uu____8220 -> false
  
let (__proj__File_argument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | File_argument uu____8230 -> uu____8230
  ...
  fun uu____8283  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____8289 =
             let uu____8293 = FStar_ST.op_Bang file_list_  in
             FStar_List.append uu____8293 [i]  in
           FStar_ST.op_Colon_Equals file_list_ uu____8289)
       in
    let uu____8350 =
      let uu____8354 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____8354
       in
    (res, uu____8350)
  
let (file_list : unit -> Prims.string Prims.list) =
  fun uu____8396  -> FStar_ST.op_Bang file_list_ 
let (restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res)
  ...
  fun should_clear  ->
    ...
    (let r =
       let uu____8439 = specs ()  in
       FStar_Getopt.parse_cmdline uu____8439 (fun x  -> ())  in
     (let uu____8446 =
        let uu____8452 =
          let uu____8453 =
            FStar_List.map (fun _8457  -> String _8457) old_verify_module  in
          List uu____8453  in
        ("verify_module", uu____8452)  in
      set_option' uu____8446);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____8473 =
        let uu____8475 =
          let uu____8477 =
            let uu____8479 = FStar_Util.get_file_extension f1  in
            FStar_String.length uu____8479  in
          (FStar_String.length f1) - uu____8477  in
        uu____8475 - Prims.int_one  in
      FStar_String.substring f1 Prims.int_zero uu____8473  in
    FStar_String.lowercase f2
  
let (should_verify : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8492 = get_lax ()  in
    if uu____8492
    then false
    else
...
let (should_verify_file : Prims.string -> Prims.bool) =
  fun fn  ->
    let uu____8513 = module_name_of_file_name fn  in should_verify uu____8513
...
let (dont_gen_projectors : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8541 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____8541 (FStar_List.existsb (module_name_eq m))
  
let (should_print_message : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8559 = should_verify m  in
    if uu____8559 then m <> "Prims" else false
  
let (include_path : unit -> Prims.string Prims.list) =
  fun uu____8576  ->
    let cache_dir =
      let uu____8581 = get_cache_dir ()  in
      match uu____8581 with
      | FStar_Pervasives_Native.None  -> []
      | FStar_Pervasives_Native.Some c -> [c]  in
    let uu____8595 = get_no_default_includes ()  in
    if uu____8595
    then
      let uu____8601 = get_include ()  in
      FStar_List.append cache_dir uu____8601
    else
      (let lib_paths =
         let uu____8612 = FStar_Util.expand_environment_variable "FSTAR_LIB"
            in
       ...
       let uu____8655 =
         let uu____8659 =
           let uu____8663 = get_include ()  in
           FStar_List.append uu____8663 ["."]  in
         FStar_List.append lib_paths uu____8659  in
       FStar_List.append cache_dir uu____8655)
  
let (find_file : Prims.string -> Prims.string FStar_Pervasives_Native.option)
  =
  let file_map = FStar_Util.smap_create (Prims.of_int (100))  in
  fun filename  ->
    let uu____8694 = FStar_Util.smap_try_find file_map filename  in
        ...
        let result =
          try
            (fun uu___615_8725  ->
               match () with
               | () ->
                   let uu____8729 = FStar_Util.is_path_absolute filename  in
                   if uu____8729
                   then
                     ...
                     (let uu____8745 =
                        let uu____8749 = include_path ()  in
                        FStar_List.rev uu____8749  in
                      FStar_Util.find_map uu____8745
                        (fun p  ->
                           let path =
                             if p = "."
                             then filename
          ...
          with | uu___614_8777 -> FStar_Pervasives_Native.None  in
...
let (prims : unit -> Prims.string) =
  fun uu____8796  ->
    let uu____8797 = get_prims ()  in
    match uu____8797 with
    | FStar_Pervasives_Native.None  ->
        let filename = "prims.fst"  in
        let uu____8806 = find_file filename  in
...
let (prims_basename : unit -> Prims.string) =
  fun uu____8828  ->
    let uu____8829 = prims ()  in FStar_Util.basename uu____8829
  
let (pervasives : unit -> Prims.string) =
  fun uu____8837  ->
    let filename = "FStar.Pervasives.fsti"  in
    let uu____8841 = find_file filename  in
...
let (pervasives_basename : unit -> Prims.string) =
  fun uu____8860  ->
    let uu____8861 = pervasives ()  in FStar_Util.basename uu____8861
  
let (pervasives_native_basename : unit -> Prims.string) =
  fun uu____8869  ->
    let filename = "FStar.Pervasives.Native.fst"  in
    let uu____8873 = find_file filename  in
...
let (prepend_cache_dir : Prims.string -> Prims.string) =
  fun fpath  ->
    let uu____8913 = get_cache_dir ()  in
    match uu____8913 with
    | FStar_Pervasives_Native.None  -> fpath
    | FStar_Pervasives_Native.Some x ->
        let uu____8922 = FStar_Util.basename fpath  in
        FStar_Util.join_paths x uu____8922
...
let (parse_settings :
  ...
  fun ns  ->
    ...
    let with_cache f s =
      let uu____9044 = FStar_Util.smap_try_find cache s  in
    ...
    let parse_one_setting s =
      ...
      then ([], true)
        ...
        then ([], false)
          ...
          then
            (let path =
               let uu____9198 = FStar_Util.substring_from s Prims.int_one  in
               path_of_text uu____9198  in
             (path, false))
          else
            (let s1 =
               if FStar_Util.starts_with s "+"
    ...
    let uu____9221 =
      FStar_All.pipe_right ns
       ...
       in
    FStar_All.pipe_right uu____9221 FStar_List.rev
  
let (__temp_no_proj : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9386 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____9386 (FStar_List.contains s)
  
let (__temp_fast_implicits : unit -> Prims.bool) =
  fun uu____9401  -> lookup_opt "__temp_fast_implicits" as_bool 
let (admit_smt_queries : unit -> Prims.bool) =
  fun uu____9410  -> get_admit_smt_queries () 
let (admit_except : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9419  -> get_admit_except () 
let (cache_checked_modules : unit -> Prims.bool) =
  fun uu____9426  -> get_cache_checked_modules () 
let (cache_off : unit -> Prims.bool) = fun uu____9433  -> get_cache_off () 
let (print_cache_version : unit -> Prims.bool) =
  fun uu____9440  -> get_print_cache_version () 
let (cmi : unit -> Prims.bool) = fun uu____9447  -> get_cmi () 
type codegen_t =
  | OCaml 
  | FSharp 
  | Kremlin 
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | OCaml  -> true | uu____9457 -> false
  
let (uu___is_FSharp : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | FSharp  -> true | uu____9468 -> false
  
let (uu___is_Kremlin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Kremlin  -> true | uu____9479 -> false
  
let (uu___is_Plugin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Plugin  -> true | uu____9490 -> false
  
let (codegen : unit -> codegen_t FStar_Pervasives_Native.option) =
  fun uu____9499  ->
    let uu____9500 = get_codegen ()  in
    FStar_Util.map_opt uu____9500
      (fun uu___13_9506  ->
         match uu___13_9506 with
         | "OCaml" -> OCaml
         | "FSharp" -> FSharp
         | "Kremlin" -> Kremlin
         | "Plugin" -> Plugin
         | uu____9512 -> failwith "Impossible")
  
let (codegen_libs : unit -> Prims.string Prims.list Prims.list) =
  fun uu____9525  ->
    let uu____9526 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____9526
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let (debug_any : unit -> Prims.bool) =
  fun uu____9552  -> let uu____9553 = get_debug ()  in uu____9553 <> [] 
let (debug_module : Prims.string -> Prims.bool) =
  fun modul  ->
    let uu____9570 = get_debug ()  in
...
let (debug_at_level : Prims.string -> debug_level_t -> Prims.bool) =
  fun modul  ->
    fun level  ->
      (let uu____9595 = get_debug ()  in
       FStar_All.pipe_right uu____9595
         (FStar_List.existsb (module_name_eq modul)))
        && (debug_level_geq level)
  
let (profile_group_by_decls : unit -> Prims.bool) =
  fun uu____9610  -> get_profile_group_by_decl () 
let (defensive : unit -> Prims.bool) =
  fun uu____9617  -> let uu____9618 = get_defensive ()  in uu____9618 <> "no" 
let (defensive_fail : unit -> Prims.bool) =
  fun uu____9628  ->
    let uu____9629 = get_defensive ()  in uu____9629 = "fail"
  
let (dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9641  -> get_dep () 
let (detail_errors : unit -> Prims.bool) =
  fun uu____9648  -> get_detail_errors () 
let (detail_hint_replay : unit -> Prims.bool) =
  fun uu____9655  -> get_detail_hint_replay () 
let (dump_module : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9665 = get_dump_module ()  in
    FStar_All.pipe_right uu____9665 (FStar_List.existsb (module_name_eq s))
  
let (eager_subtyping : unit -> Prims.bool) =
  fun uu____9680  -> get_eager_subtyping () 
let (expose_interfaces : unit -> Prims.bool) =
  fun uu____9687  -> get_expose_interfaces () 
let (fs_typ_app : Prims.string -> Prims.bool) =
  fun filename  ->
    let uu____9697 = FStar_ST.op_Bang light_off_files  in
    FStar_List.contains filename uu____9697
  
let (full_context_dependency : unit -> Prims.bool) = fun uu____9733  -> true 
let (hide_uvar_nums : unit -> Prims.bool) =
  fun uu____9741  -> get_hide_uvar_nums () 
let (hint_info : unit -> Prims.bool) =
  fun uu____9748  -> (get_hint_info ()) || (get_query_stats ()) 
let (hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9757  -> get_hint_dir () 
let (hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9766  -> get_hint_file () 
let (hint_file_for_src : Prims.string -> Prims.string) =
  fun src_filename  ->
    let uu____9776 = hint_file ()  in
    match uu____9776 with
    | FStar_Pervasives_Native.Some fn -> fn
    | FStar_Pervasives_Native.None  ->
        let file_name =
          let uu____9787 = hint_dir ()  in
          match uu____9787 with
          | FStar_Pervasives_Native.Some dir ->
              let uu____9795 = FStar_Util.basename src_filename  in
              FStar_Util.concat_dir_filename dir uu____9795
          | uu____9797 -> src_filename  in
        FStar_Util.format1 "%s.hints" file_name
  
let (ide : unit -> Prims.bool) = fun uu____9808  -> get_ide () 
let (print : unit -> Prims.bool) = fun uu____9815  -> get_print () 
let (print_in_place : unit -> Prims.bool) =
  fun uu____9822  -> get_print_in_place () 
let (initial_fuel : unit -> Prims.int) =
  fun uu____9829  ->
    let uu____9830 = get_initial_fuel ()  in
    let uu____9832 = get_max_fuel ()  in Prims.min uu____9830 uu____9832
  
let (initial_ifuel : unit -> Prims.int) =
  fun uu____9840  ->
    let uu____9841 = get_initial_ifuel ()  in
    let uu____9843 = get_max_ifuel ()  in Prims.min uu____9841 uu____9843
  
let (interactive : unit -> Prims.bool) =
  fun uu____9851  -> (get_in ()) || (get_ide ()) 
let (lax : unit -> Prims.bool) = fun uu____9858  -> get_lax () 
let (load : unit -> Prims.string Prims.list) = fun uu____9867  -> get_load () 
let (legacy_interactive : unit -> Prims.bool) = fun uu____9874  -> get_in () 
let (lsp_server : unit -> Prims.bool) = fun uu____9881  -> get_lsp () 
let (log_queries : unit -> Prims.bool) =
  fun uu____9888  -> get_log_queries () 
let (keep_query_captions : unit -> Prims.bool) =
  fun uu____9895  -> (log_queries ()) && (get_keep_query_captions ()) 
let (log_types : unit -> Prims.bool) = fun uu____9902  -> get_log_types () 
let (max_fuel : unit -> Prims.int) = fun uu____9909  -> get_max_fuel () 
let (max_ifuel : unit -> Prims.int) = fun uu____9916  -> get_max_ifuel () 
let (min_fuel : unit -> Prims.int) = fun uu____9923  -> get_min_fuel () 
let (ml_ish : unit -> Prims.bool) = fun uu____9930  -> get_MLish () 
let (set_ml_ish : unit -> unit) =
  fun uu____9936  -> set_option "MLish" (Bool true) 
let (no_default_includes : unit -> Prims.bool) =
  fun uu____9945  -> get_no_default_includes () 
let (no_extract : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9955 = get_no_extract ()  in
    FStar_All.pipe_right uu____9955 (FStar_List.existsb (module_name_eq s))
  
let (normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____9970  -> get_normalize_pure_terms_for_extraction () 
let (no_location_info : unit -> Prims.bool) =
  fun uu____9977  -> get_no_location_info () 
let (no_plugins : unit -> Prims.bool) = fun uu____9984  -> get_no_plugins () 
let (no_smt : unit -> Prims.bool) = fun uu____9991  -> get_no_smt () 
let (output_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____10000  -> get_odir () 
let (ugly : unit -> Prims.bool) = fun uu____10007  -> get_ugly () 
let (print_bound_var_types : unit -> Prims.bool) =
  fun uu____10014  -> get_print_bound_var_types () 
let (print_effect_args : unit -> Prims.bool) =
  fun uu____10021  -> get_print_effect_args () 
let (print_implicits : unit -> Prims.bool) =
  fun uu____10028  -> get_print_implicits () 
let (print_real_names : unit -> Prims.bool) =
  fun uu____10035  -> (get_prn ()) || (get_print_full_names ()) 
let (print_universes : unit -> Prims.bool) =
  fun uu____10042  -> get_print_universes () 
let (print_z3_statistics : unit -> Prims.bool) =
  fun uu____10049  -> get_print_z3_statistics () 
let (quake_lo : unit -> Prims.int) = fun uu____10056  -> get_quake_lo () 
let (quake_hi : unit -> Prims.int) = fun uu____10063  -> get_quake_hi () 
let (quake_keep : unit -> Prims.bool) = fun uu____10070  -> get_quake_keep () 
let (query_stats : unit -> Prims.bool) =
  fun uu____10077  -> get_query_stats () 
let (record_hints : unit -> Prims.bool) =
  fun uu____10084  -> get_record_hints () 
let (record_options : unit -> Prims.bool) =
  fun uu____10091  -> get_record_options () 
let (retry : unit -> Prims.bool) = fun uu____10098  -> get_retry () 
let (reuse_hint_for : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____10107  -> get_reuse_hint_for () 
let (silent : unit -> Prims.bool) = fun uu____10114  -> get_silent () 
let (smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____10121  -> get_smtencoding_elim_box () 
let (smtencoding_nl_arith_native : unit -> Prims.bool) =
  fun uu____10128  ->
    let uu____10129 = get_smtencoding_nl_arith_repr ()  in
    uu____10129 = "native"
  
let (smtencoding_nl_arith_wrapped : unit -> Prims.bool) =
  fun uu____10139  ->
    let uu____10140 = get_smtencoding_nl_arith_repr ()  in
    uu____10140 = "wrapped"
  
let (smtencoding_nl_arith_default : unit -> Prims.bool) =
  fun uu____10150  ->
    let uu____10151 = get_smtencoding_nl_arith_repr ()  in
    uu____10151 = "boxwrap"
  
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____10161  ->
    let uu____10162 = get_smtencoding_l_arith_repr ()  in
    uu____10162 = "native"
  
let (smtencoding_l_arith_default : unit -> Prims.bool) =
  fun uu____10172  ->
    let uu____10173 = get_smtencoding_l_arith_repr ()  in
    uu____10173 = "boxwrap"
  
let (smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____10183  -> get_smtencoding_valid_intro () 
let (smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____10190  -> get_smtencoding_valid_elim () 
let (tactic_raw_binders : unit -> Prims.bool) =
  fun uu____10197  -> get_tactic_raw_binders () 
let (tactics_failhard : unit -> Prims.bool) =
  fun uu____10204  -> get_tactics_failhard () 
let (tactics_info : unit -> Prims.bool) =
  fun uu____10211  -> get_tactics_info () 
let (tactic_trace : unit -> Prims.bool) =
  fun uu____10218  -> get_tactic_trace () 
let (tactic_trace_d : unit -> Prims.int) =
  fun uu____10225  -> get_tactic_trace_d () 
let (tactics_nbe : unit -> Prims.bool) =
  fun uu____10232  -> get_tactics_nbe () 
let (tcnorm : unit -> Prims.bool) = fun uu____10239  -> get_tcnorm () 
let (timing : unit -> Prims.bool) = fun uu____10246  -> get_timing () 
let (trace_error : unit -> Prims.bool) =
  fun uu____10253  -> get_trace_error () 
let (unthrottle_inductives : unit -> Prims.bool) =
  fun uu____10260  -> get_unthrottle_inductives () 
let (unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____10267  -> get_unsafe_tactic_exec () 
let (use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____10274  -> get_use_eq_at_higher_order () 
let (use_hints : unit -> Prims.bool) = fun uu____10281  -> get_use_hints () 
let (use_hint_hashes : unit -> Prims.bool) =
  fun uu____10288  -> get_use_hint_hashes () 
let (use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____10297  -> get_use_native_tactics () 
let (use_tactics : unit -> Prims.bool) =
  fun uu____10304  -> get_use_tactics () 
let (using_facts_from :
  unit -> (Prims.string Prims.list * Prims.bool) Prims.list) =
  fun uu____10320  ->
    let uu____10321 = get_using_facts_from ()  in
...
let (vcgen_optimize_bind_as_seq : unit -> Prims.bool) =
  fun uu____10375  ->
    let uu____10376 = get_vcgen_optimize_bind_as_seq ()  in
    FStar_Option.isSome uu____10376
  
let (vcgen_decorate_with_type : unit -> Prims.bool) =
  fun uu____10387  ->
    let uu____10388 = get_vcgen_optimize_bind_as_seq ()  in
    match uu____10388 with
    | FStar_Pervasives_Native.Some "with_type" -> true
    | uu____10396 -> false
  
let (warn_default_effects : unit -> Prims.bool) =
  fun uu____10407  -> get_warn_default_effects () 
let (z3_exe : unit -> Prims.string) =
  fun uu____10414  ->
    let uu____10415 = get_smt ()  in
    match uu____10415 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
  
let (z3_cliopt : unit -> Prims.string Prims.list) =
  fun uu____10433  -> get_z3cliopt () 
let (z3_refresh : unit -> Prims.bool) = fun uu____10440  -> get_z3refresh () 
let (z3_rlimit : unit -> Prims.int) = fun uu____10447  -> get_z3rlimit () 
let (z3_rlimit_factor : unit -> Prims.int) =
  fun uu____10454  -> get_z3rlimit_factor () 
let (z3_seed : unit -> Prims.int) = fun uu____10461  -> get_z3seed () 
let (use_two_phase_tc : unit -> Prims.bool) =
  fun uu____10468  ->
    (get_use_two_phase_tc ()) &&
      (let uu____10470 = lax ()  in Prims.op_Negation uu____10470)
  
let (no_positivity : unit -> Prims.bool) =
  fun uu____10478  -> get_no_positivity () 
let (ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____10485  -> get_ml_no_eta_expand_coertions () 
let (warn_error : unit -> Prims.string) =
  fun uu____10492  ->
    let uu____10493 = get_warn_error ()  in
    FStar_String.concat "" uu____10493
  
let (use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____10504  -> get_use_extracted_interfaces () 
let (use_nbe : unit -> Prims.bool) = fun uu____10511  -> get_use_nbe () 
let (use_nbe_for_extraction : unit -> Prims.bool) =
  fun uu____10518  -> get_use_nbe_for_extraction () 
let (trivial_pre_for_unannotated_effectful_fns : unit -> Prims.bool) =
  fun uu____10525  -> get_trivial_pre_for_unannotated_effectful_fns () 
let with_saved_options : 'a . (unit -> 'a) -> 'a =
  fun f  ->
    let uu____10542 =
      let uu____10544 = trace_error ()  in Prims.op_Negation uu____10544  in
    if uu____10542
    then
      (push ();
       (let r =
          try
            (fun uu___824_10559  ->
               match () with
               | () -> let uu____10564 = f ()  in FStar_Util.Inr uu____10564)
              ()
          with | uu___823_10566 -> FStar_Util.Inl uu___823_10566  in
        pop ();
        (match r with
  ...
  fun m  ->
    fun filter1  ->
      ...
      let rec matches_path m_components1 path =
        ...
        | uu____10680 -> false  in
      let uu____10692 =
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____10734  ->
                match uu____10734 with
                | (path,uu____10745) -> matches_path m_components path))
         in
      match uu____10692 with
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some (uu____10764,flag) -> flag
...
let (should_extract : Prims.string -> Prims.bool) =
  fun m  ->
    let m1 = FStar_String.lowercase m  in
    let uu____10829 = get_extract ()  in
    match uu____10829 with
    | FStar_Pervasives_Native.Some extract_setting ->
        ((let uu____10844 =
            let uu____10860 = get_no_extract ()  in
            let uu____10864 = get_extract_namespace ()  in
            let uu____10868 = get_extract_module ()  in
            (uu____10860, uu____10864, uu____10868)  in
    ...
    | FStar_Pervasives_Native.None  ->
        let should_extract_namespace m2 =
          let uu____10922 = get_extract_namespace ()  in
        ...
        let should_extract_module m2 =
          let uu____10950 = get_extract_module ()  in
          ...
          | l ->
           ...
           in
        (let uu____10972 = no_extract m1  in Prims.op_Negation uu____10972)
          &&
          (let uu____10975 =
             let uu____10986 = get_extract_namespace ()  in
             let uu____10990 = get_extract_module ()  in
             (uu____10986, uu____10990)  in
...
let (should_be_already_cached : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____11030 = get_already_cached ()  in
...
let (error_flags : unit -> error_flag Prims.list) =
  ...
  fun uu____11063  ->
    ...
    let uu____11066 = FStar_Util.smap_try_find cache we  in
...
let (profile_enabled :
  ...
  fun modul_opt  ->
    fun phase  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____11110 = get_profile_component ()  in
          matches_namespace_filter_opt phase uu____11110
      | FStar_Pervasives_Native.Some modul ->
          (let uu____11121 = get_profile ()  in
           matches_namespace_filter_opt modul uu____11121) &&
            (let uu____11128 = get_profile_component ()  in
             matches_namespace_filter_opt phase uu____11128)
