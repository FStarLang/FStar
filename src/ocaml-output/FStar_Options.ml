...
let push : Prims.unit -> Prims.unit =
  fun uu____278  ->
    let uu____279 =
      ...
      let uu____285 = FStar_ST.read fstar_options  in uu____281 :: uu____285
       in
...
let add_light_off_file : Prims.string -> Prims.unit =
  fun filename  ->
    let uu____356 =
      let uu____358 = FStar_ST.read light_off_files  in filename :: uu____358
       in
...
let get_option : Prims.string -> option_val =
  fun s  ->
    let uu____566 =
      let uu____568 = peek ()  in FStar_Util.smap_try_find uu____568 s  in
...
let get_admit_smt_queries : Prims.unit -> Prims.bool =
  fun uu____594  -> lookup_opt "admit_smt_queries" as_bool 
let get_check_hints : Prims.unit -> Prims.bool =
  fun uu____598  -> lookup_opt "check_hints" as_bool 
let get_codegen : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____603  -> lookup_opt "codegen" (as_option as_string) 
let get_codegen_lib : Prims.unit -> Prims.string Prims.list =
  fun uu____609  -> lookup_opt "codegen-lib" (as_list as_string) 
let get_debug : Prims.unit -> Prims.string Prims.list =
  fun uu____615  -> lookup_opt "debug" (as_list as_string) 
let get_debug_level : Prims.unit -> Prims.string Prims.list =
  fun uu____621  -> lookup_opt "debug_level" (as_list as_string) 
let get_dep : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____627  -> lookup_opt "dep" (as_option as_string) 
let get_detail_errors : Prims.unit -> Prims.bool =
  fun uu____632  -> lookup_opt "detail_errors" as_bool 
let get_doc : Prims.unit -> Prims.bool =
  fun uu____636  -> lookup_opt "doc" as_bool 
let get_dump_module : Prims.unit -> Prims.string Prims.list =
  fun uu____641  -> lookup_opt "dump_module" (as_list as_string) 
let get_eager_inference : Prims.unit -> Prims.bool =
  fun uu____646  -> lookup_opt "eager_inference" as_bool 
let get_explicit_deps : Prims.unit -> Prims.bool =
  fun uu____650  -> lookup_opt "explicit_deps" as_bool 
let get_extract_all : Prims.unit -> Prims.bool =
  fun uu____654  -> lookup_opt "extract_all" as_bool 
let get_extract_module : Prims.unit -> Prims.string Prims.list =
  fun uu____659  -> lookup_opt "extract_module" (as_list as_string) 
let get_extract_namespace : Prims.unit -> Prims.string Prims.list =
  fun uu____665  -> lookup_opt "extract_namespace" (as_list as_string) 
let get_fs_typ_app : Prims.unit -> Prims.bool =
  fun uu____670  -> lookup_opt "fs_typ_app" as_bool 
let get_fstar_home :
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____675  -> lookup_opt "fstar_home" (as_option as_string) 
let get_hide_genident_nums : Prims.unit -> Prims.bool =
  fun uu____680  -> lookup_opt "hide_genident_nums" as_bool 
let get_hide_uvar_nums : Prims.unit -> Prims.bool =
  fun uu____684  -> lookup_opt "hide_uvar_nums" as_bool 
let get_hint_info : Prims.unit -> Prims.bool =
  fun uu____688  -> lookup_opt "hint_info" as_bool 
let get_hint_file : Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____693  -> lookup_opt "hint_file" (as_option as_string) 
let get_in : Prims.unit -> Prims.bool =
  fun uu____698  -> lookup_opt "in" as_bool 
let get_ide : Prims.unit -> Prims.bool =
  fun uu____702  -> lookup_opt "ide" as_bool 
let get_include : Prims.unit -> Prims.string Prims.list =
  fun uu____707  -> lookup_opt "include" (as_list as_string) 
let get_indent : Prims.unit -> Prims.bool =
  fun uu____712  -> lookup_opt "indent" as_bool 
let get_initial_fuel : Prims.unit -> Prims.int =
  fun uu____716  -> lookup_opt "initial_fuel" as_int 
let get_initial_ifuel : Prims.unit -> Prims.int =
  fun uu____720  -> lookup_opt "initial_ifuel" as_int 
let get_lax : Prims.unit -> Prims.bool =
  fun uu____724  -> lookup_opt "lax" as_bool 
let get_load : Prims.unit -> Prims.string Prims.list =
  fun uu____729  -> lookup_opt "load" (as_list as_string) 
let get_log_queries : Prims.unit -> Prims.bool =
  fun uu____734  -> lookup_opt "log_queries" as_bool 
let get_log_types : Prims.unit -> Prims.bool =
  fun uu____738  -> lookup_opt "log_types" as_bool 
let get_max_fuel : Prims.unit -> Prims.int =
  fun uu____742  -> lookup_opt "max_fuel" as_int 
let get_max_ifuel : Prims.unit -> Prims.int =
  fun uu____746  -> lookup_opt "max_ifuel" as_int 
let get_min_fuel : Prims.unit -> Prims.int =
  fun uu____750  -> lookup_opt "min_fuel" as_int 
let get_MLish : Prims.unit -> Prims.bool =
  fun uu____754  -> lookup_opt "MLish" as_bool 
let get_n_cores : Prims.unit -> Prims.int =
  fun uu____758  -> lookup_opt "n_cores" as_int 
let get_no_default_includes : Prims.unit -> Prims.bool =
  fun uu____762  -> lookup_opt "no_default_includes" as_bool 
let get_no_extract : Prims.unit -> Prims.string Prims.list =
  fun uu____767  -> lookup_opt "no_extract" (as_list as_string) 
let get_no_location_info : Prims.unit -> Prims.bool =
  fun uu____772  -> lookup_opt "no_location_info" as_bool 
let get_odir : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____777  -> lookup_opt "odir" (as_option as_string) 
let get_ugly : Prims.unit -> Prims.bool =
  fun uu____782  -> lookup_opt "ugly" as_bool 
let get_prims : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____787  -> lookup_opt "prims" (as_option as_string) 
let get_print_bound_var_types : Prims.unit -> Prims.bool =
  fun uu____792  -> lookup_opt "print_bound_var_types" as_bool 
let get_print_effect_args : Prims.unit -> Prims.bool =
  fun uu____796  -> lookup_opt "print_effect_args" as_bool 
let get_print_fuels : Prims.unit -> Prims.bool =
  fun uu____800  -> lookup_opt "print_fuels" as_bool 
let get_print_full_names : Prims.unit -> Prims.bool =
  fun uu____804  -> lookup_opt "print_full_names" as_bool 
let get_print_implicits : Prims.unit -> Prims.bool =
  fun uu____808  -> lookup_opt "print_implicits" as_bool 
let get_print_universes : Prims.unit -> Prims.bool =
  fun uu____812  -> lookup_opt "print_universes" as_bool 
let get_print_z3_statistics : Prims.unit -> Prims.bool =
  fun uu____816  -> lookup_opt "print_z3_statistics" as_bool 
let get_prn : Prims.unit -> Prims.bool =
  fun uu____820  -> lookup_opt "prn" as_bool 
let get_record_hints : Prims.unit -> Prims.bool =
  fun uu____824  -> lookup_opt "record_hints" as_bool 
let get_reuse_hint_for :
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____829  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let get_show_signatures : Prims.unit -> Prims.string Prims.list =
  fun uu____835  -> lookup_opt "show_signatures" (as_list as_string) 
let get_silent : Prims.unit -> Prims.bool =
  fun uu____840  -> lookup_opt "silent" as_bool 
let get_smt : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____845  -> lookup_opt "smt" (as_option as_string) 
let get_smtencoding_elim_box : Prims.unit -> Prims.bool =
  fun uu____850  -> lookup_opt "smtencoding.elim_box" as_bool 
let get_smtencoding_nl_arith_repr : Prims.unit -> Prims.string =
  fun uu____854  -> lookup_opt "smtencoding.nl_arith_repr" as_string 
let get_smtencoding_l_arith_repr : Prims.unit -> Prims.string =
  fun uu____858  -> lookup_opt "smtencoding.l_arith_repr" as_string 
let get_split_cases : Prims.unit -> Prims.int =
  fun uu____862  -> lookup_opt "split_cases" as_int 
let get_timing : Prims.unit -> Prims.bool =
  fun uu____866  -> lookup_opt "timing" as_bool 
let get_trace_error : Prims.unit -> Prims.bool =
  fun uu____870  -> lookup_opt "trace_error" as_bool 
let get_unthrottle_inductives : Prims.unit -> Prims.bool =
  fun uu____874  -> lookup_opt "unthrottle_inductives" as_bool 
let get_use_eq_at_higher_order : Prims.unit -> Prims.bool =
  fun uu____878  -> lookup_opt "use_eq_at_higher_order" as_bool 
let get_use_hints : Prims.unit -> Prims.bool =
  fun uu____882  -> lookup_opt "use_hints" as_bool 
let get_use_tactics : Prims.unit -> Prims.bool =
  fun uu____886  ->
    let uu____887 = lookup_opt "no_tactics" as_bool  in
...
let get_verify_all : Prims.unit -> Prims.bool =
  fun uu____900  -> lookup_opt "verify_all" as_bool 
let get_verify_module : Prims.unit -> Prims.string Prims.list =
  fun uu____905  -> lookup_opt "verify_module" (as_list as_string) 
let get___temp_no_proj : Prims.unit -> Prims.string Prims.list =
  fun uu____911  -> lookup_opt "__temp_no_proj" (as_list as_string) 
let get_version : Prims.unit -> Prims.bool =
  fun uu____916  -> lookup_opt "version" as_bool 
let get_warn_default_effects : Prims.unit -> Prims.bool =
  fun uu____920  -> lookup_opt "warn_default_effects" as_bool 
let get_z3cliopt : Prims.unit -> Prims.string Prims.list =
  fun uu____925  -> lookup_opt "z3cliopt" (as_list as_string) 
let get_z3refresh : Prims.unit -> Prims.bool =
  fun uu____930  -> lookup_opt "z3refresh" as_bool 
let get_z3rlimit : Prims.unit -> Prims.int =
  fun uu____934  -> lookup_opt "z3rlimit" as_int 
let get_z3rlimit_factor : Prims.unit -> Prims.int =
  fun uu____938  -> lookup_opt "z3rlimit_factor" as_int 
let get_z3seed : Prims.unit -> Prims.int =
  fun uu____942  -> lookup_opt "z3seed" as_int 
let get_no_positivity : Prims.unit -> Prims.bool =
  fun uu____946  -> lookup_opt "__no_positivity" as_bool 
let dlevel : Prims.string -> debug_level_t =
  fun uu___54_950  ->
    match uu___54_950 with
    | "Low" -> Low
    | "Medium" -> Medium
    | "High" -> High
    | "Extreme" -> Extreme
...
let debug_level_geq : debug_level_t -> Prims.bool =
  fun l2  ->
    let uu____965 = get_debug_level ()  in
...
let display_version : Prims.unit -> Prims.unit =
  fun uu____994  ->
    let uu____995 =
      let uu____996 = FStar_ST.read _version  in
      let uu____999 = FStar_ST.read _platform  in
      let uu____1002 = FStar_ST.read _compiler  in
      let uu____1005 = FStar_ST.read _date  in
      let uu____1008 = FStar_ST.read _commit  in
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____996
        uu____999 uu____1002 uu____1005 uu____1008
       in
    FStar_Util.print_string uu____995
...
let display_usage_aux specs =
  ...
  FStar_List.iter
    (fun uu____1048  ->
       ...
       | (uu____1054,flag,p,doc) ->
           (match p with
            | FStar_Getopt.ZeroArgs ig ->
                if doc = ""
                then
                  let uu____1063 =
                    let uu____1064 = FStar_Util.colorize_bold flag  in
                    FStar_Util.format1 "  --%s\n" uu____1064  in
                  FStar_Util.print_string uu____1063
                else
                  (let uu____1066 =
                     let uu____1067 = FStar_Util.colorize_bold flag  in
                     FStar_Util.format2 "  --%s  %s\n" uu____1067 doc  in
                   FStar_Util.print_string uu____1066)
            | FStar_Getopt.OneArg (uu____1068,argname) ->
                if doc = ""
                then
                  let uu____1074 =
                    let uu____1075 = FStar_Util.colorize_bold flag  in
                    let uu____1076 = FStar_Util.colorize_bold argname  in
                    FStar_Util.format2 "  --%s %s\n" uu____1075 uu____1076
                     in
                  FStar_Util.print_string uu____1074
                else
                  (let uu____1078 =
                     let uu____1079 = FStar_Util.colorize_bold flag  in
                     let uu____1080 = FStar_Util.colorize_bold argname  in
                     FStar_Util.format3 "  --%s %s  %s\n" uu____1079
                       uu____1080 doc
                      in
                   FStar_Util.print_string uu____1078))) specs
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____1116 =
                let uu____1117 = let uu____1120 = f ()  in (name, uu____1120)
                   in
                set_option' uu____1117  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x =
                let uu____1131 = let uu____1134 = f x  in (name, uu____1134)
                   in
                set_option' uu____1131  in
...
let cons_extract_module : Prims.string -> option_val =
  fun s  ->
    let uu____1142 =
      let uu____1144 =
        let uu____1146 = get_extract_module ()  in (FStar_String.lowercase s)
          :: uu____1146
         in
...
let cons_extract_namespace : Prims.string -> option_val =
  fun s  ->
    let uu____1154 =
      let uu____1156 =
        let uu____1158 = get_extract_namespace ()  in
        (FStar_String.lowercase s) :: uu____1158  in
...
let add_extract_module : Prims.string -> Prims.unit =
  fun s  ->
    let uu____1166 = cons_extract_module s  in
    set_option "extract_module" uu____1166
  
let add_extract_namespace : Prims.string -> Prims.unit =
  fun s  ->
    let uu____1171 = cons_extract_namespace s  in
    set_option "extract_namespace" uu____1171
  
let cons_verify_module : Prims.string -> option_val =
  fun s  ->
    let uu____1176 =
      let uu____1178 =
        let uu____1180 = get_verify_module ()  in (FStar_String.lowercase s)
          :: uu____1180
         in
...
let cons_using_facts_from : Prims.string -> option_val =
  fun s  ->
    ...
    (let uu____1189 = get_using_facts_from ()  in
...
let add_verify_module : Prims.string -> Prims.unit =
  fun s  ->
    let uu____1202 = cons_verify_module s  in
    set_option "verify_module" uu____1202
  ...
  fun uu____1214  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1246 = parse_codegen s  in String uu____1246)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1258 =
                  let uu____1260 =
                    let uu____1262 = get_codegen_lib ()  in s :: uu____1262
                     in
                  FStar_All.pipe_right uu____1260
                    (FStar_List.map (fun _0_30  -> String _0_30))
                   in
                List uu____1258)), "[namespace]")),
      ...
      (FStar_Getopt.noshort, "debug",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1277 =
                  let uu____1279 =
                    let uu____1281 = get_debug ()  in x :: uu____1281  in
                  FStar_All.pipe_right uu____1279
                    (FStar_List.map (fun _0_31  -> String _0_31))
                   in
                List uu____1277)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1296 =
                  let uu____1298 =
                    let uu____1300 = get_debug_level ()  in x :: uu____1300
                     in
                  FStar_All.pipe_right uu____1298
                    (FStar_List.map (fun _0_32  -> String _0_32))
                   in
                List uu____1296)), "[Low|Medium|High|Extreme|...]")),
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1342 =
                  let uu____1344 =
                    let uu____1346 = get_dump_module ()  in x :: uu____1346
                     in
                  FStar_All.pipe_right uu____1344
                    (FStar_List.map (fun _0_33  -> String _0_33))
                   in
                FStar_All.pipe_right uu____1342 (fun _0_34  -> List _0_34))),
             "[module name]")), "");
      ...
      (FStar_Getopt.noshort, "include",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1458 =
                  let uu____1460 =
                    let uu____1462 = get_include ()  in
                    FStar_List.map (fun _0_37  -> String _0_37) uu____1462
                     in
                  FStar_List.append uu____1460 [Path s]  in
                List uu____1458)), "[path]")),
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1483 = FStar_Util.int_of_string x  in
                Int uu____1483)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try initially (default 2)");
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1495 = FStar_Util.int_of_string x  in
                Int uu____1495)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "load",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1523 =
                  let uu____1525 =
                    let uu____1527 = get_load ()  in
                    FStar_List.map (fun _0_38  -> String _0_38) uu____1527
                     in
                  FStar_List.append uu____1525 [Path s]  in
                List uu____1523)), "[module]")), "Load compiled module");
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1556 = FStar_Util.int_of_string x  in
                Int uu____1556)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1568 = FStar_Util.int_of_string x  in
                Int uu____1568)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1580 = FStar_Util.int_of_string x  in
                Int uu____1580)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1600 = FStar_Util.int_of_string x  in
                Int uu____1600)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1620 =
                  let uu____1622 =
                    let uu____1624 = get_no_extract ()  in x :: uu____1624
                     in
                  FStar_All.pipe_right uu____1622
                    (FStar_List.map (fun _0_39  -> String _0_39))
                   in
                List uu____1620)), "[module name]")),
        "Do not extract code from this module");
      (FStar_Getopt.noshort, "no_location_info",
        (FStar_Getopt.ZeroArgs ((fun uu____1635  -> Bool true))),
        "Suppress location information in the generated OCaml output (only relevant with --codegen OCaml)");
      (FStar_Getopt.noshort, "odir",
        (FStar_Getopt.OneArg
           (((fun p  -> let uu____1647 = validate_dir p  in Path uu____1647)),
      ...
      (FStar_Getopt.noshort, "show_signatures",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1755 =
                  let uu____1757 =
                    let uu____1759 = get_show_signatures ()  in x ::
                      uu____1759
                     in
                  FStar_All.pipe_right uu____1757
                    (FStar_List.map (fun _0_42  -> String _0_42))
                   in
                List uu____1755)), "[module name]")),
        "Show the checked signatures for all top-level symbols in the module");
      (FStar_Getopt.noshort, "silent",
        (FStar_Getopt.ZeroArgs ((fun uu____1770  -> Bool true))), " ");
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n1  ->
                let uu____1814 = FStar_Util.int_of_string n1  in
                Int uu____1814)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "warn_default_effects",
        (FStar_Getopt.ZeroArgs ((fun uu____1931  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "z3cliopt",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1943 =
                  let uu____1945 =
                    let uu____1947 = get_z3cliopt ()  in
                    FStar_List.append uu____1947 [s]  in
                  FStar_All.pipe_right uu____1945
                    (FStar_List.map (fun _0_47  -> String _0_47))
                   in
                List uu____1943)), "[option]")), "Z3 command line options");
      (FStar_Getopt.noshort, "z3refresh",
        (FStar_Getopt.ZeroArgs ((fun uu____1958  -> Bool true))),
        "Restart Z3 after each query; useful for ensuring proof robustness");
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1970 = FStar_Util.int_of_string s  in
                Int uu____1970)), "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1982 = FStar_Util.int_of_string s  in
                Int uu____1982)), "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1994 = FStar_Util.int_of_string s  in
                Int uu____1994)), "[positive integer]")),
        "Set the Z3 random seed (default 0)");
      (FStar_Getopt.noshort, "__no_positivity",
        (FStar_Getopt.ZeroArgs ((fun uu____2002  -> Bool true))),
        "Don't check positivity of inductive types")]
       in
    let uu____2008 = FStar_List.map mk_spec specs1  in
    ('h', "help",
      (FStar_Getopt.ZeroArgs
         (fun x  ->
  ...
  fun s  ->
    ...
    | uu____2031 ->
        (FStar_Util.print_string "Wrong argument to codegen flag\n";
         (let uu____2034 = specs ()  in display_usage_aux uu____2034);
         FStar_All.exit (Prims.parse_int "1"))

and string_as_bool : Prims.string -> Prims.string -> option_val =
  fun option_name  ->
    fun uu___55_2042  ->
      match uu___55_2042 with
      | "true" -> Bool true
      | "false" -> Bool false
      | uu____2043 ->
          (FStar_Util.print1 "Wrong argument to %s\n" option_name;
           (let uu____2046 = specs ()  in display_usage_aux uu____2046);
           FStar_All.exit (Prims.parse_int "1"))
...
let docs :
  ...
  =
  fun uu____2061  ->
    let uu____2062 = specs ()  in
    FStar_List.map
      (fun uu____2081  ->
         match uu____2081 with
         | (uu____2089,name,uu____2091,doc) -> (name, doc)) uu____2062
  
let settable : Prims.string -> Prims.bool =
  fun uu___56_2098  ->
    match uu___56_2098 with
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____2128  ->
          ...
          | (uu____2134,x,uu____2136,uu____2137) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____2163  ->
          ...
          | (uu____2169,x,uu____2171,uu____2172) -> resettable x))
  
let display_usage : Prims.unit -> Prims.unit =
  fun uu____2178  ->
    let uu____2179 = specs ()  in display_usage_aux uu____2179
  
let fstar_home : Prims.unit -> Prims.string =
  fun uu____2189  ->
    let uu____2190 = get_fstar_home ()  in
...
let uu___is_File_argument : Prims.exn -> Prims.bool =
  fun projectee  ->
    ...
    | File_argument uu____2203 -> true
    | uu____2204 -> false
  
let __proj__File_argument__item__uu___ : Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | File_argument uu____2212 -> uu____2212
...
let parse_cmd_line :
  ...
  fun uu____2258  ->
    let res =
      let uu____2260 = specs ()  in
      FStar_Getopt.parse_cmdline uu____2260
        (fun i  ->
           let uu____2265 =
             let uu____2267 = FStar_ST.read file_list_  in
             FStar_List.append uu____2267 [i]  in
           FStar_ST.write file_list_ uu____2265)
       in
    let uu____2275 =
      let uu____2277 = FStar_ST.read file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____2277
       in
    (res, uu____2275)
  
let file_list : Prims.unit -> Prims.string Prims.list =
  fun uu____2287  -> FStar_ST.read file_list_ 
let restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module ()  in
    if should_clear then clear () else init ();
    (let r =
       let uu____2300 = specs ()  in
       FStar_Getopt.parse_cmdline uu____2300 (fun x  -> ())  in
     (let uu____2305 =
        let uu____2308 =
          let uu____2309 =
            FStar_List.map (fun _0_48  -> String _0_48) old_verify_module  in
          List uu____2309  in
        ("verify_module", uu____2308)  in
      set_option' uu____2305);
     r)
  
let should_verify : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2315 = get_lax ()  in
    if uu____2315
    then false
    else
      (let uu____2317 = get_verify_all ()  in
       if uu____2317
       then true
       else
         (let uu____2319 = get_verify_module ()  in
          match uu____2319 with
          | [] ->
              let uu____2321 = file_list ()  in
              FStar_List.existsML
                (fun f  ->
                       ...
                       let uu____2330 =
                         let uu____2331 =
                           let uu____2332 = FStar_Util.get_file_extension f1
                              in
                           FStar_String.length uu____2332  in
                         (FStar_String.length f1) - uu____2331  in
                       uu____2330 - (Prims.parse_int "1")  in
                     FStar_String.substring f1 (Prims.parse_int "0")
                       uu____2329
                      in
                   (FStar_String.lowercase f2) = m) uu____2321
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
  
let dont_gen_projectors : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2347 = get___temp_no_proj ()  in
    FStar_List.contains m uu____2347
  
let should_print_message : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2353 = should_verify m  in
    if uu____2353 then m <> "Prims" else false
  
let include_path : Prims.unit -> Prims.string Prims.list =
  fun uu____2359  ->
    let uu____2360 = get_no_default_includes ()  in
    if uu____2360
    then get_include ()
    else
      (let h = fstar_home ()  in
       ...
       let uu____2366 =
         let uu____2368 =
           FStar_All.pipe_right defs
            ...
            in
         FStar_All.pipe_right uu____2368
           (FStar_List.filter FStar_Util.file_exists)
          in
       let uu____2376 =
         let uu____2378 = get_include ()  in
         FStar_List.append uu____2378 ["."]  in
       FStar_List.append uu____2366 uu____2376)
  
let find_file : Prims.string -> Prims.string FStar_Pervasives_Native.option =
  fun filename  ->
    let uu____2385 = FStar_Util.is_path_absolute filename  in
    if uu____2385
    then
      ...
      (let uu____2390 =
         let uu____2392 = include_path ()  in FStar_List.rev uu____2392  in
       FStar_Util.find_map uu____2390
         (fun p  ->
...
let prims_basename : Prims.unit -> Prims.string =
  fun uu____2416  ->
    let uu____2417 = prims ()  in FStar_Util.basename uu____2417
...
let pervasives_basename : Prims.unit -> Prims.string =
  fun uu____2431  ->
    let uu____2432 = pervasives ()  in FStar_Util.basename uu____2432
  
let pervasives_native_basename : Prims.unit -> Prims.string =
  fun uu____2436  ->
    let filename = "FStar.Pervasives.Native.fst"  in
    let uu____2438 = find_file filename  in
        ...
        let uu____2441 =
          let uu____2442 =
            FStar_Util.format1
              ...
              filename
             in
          FStar_Util.Failure uu____2442  in
        raise uu____2441
  
let prepend_output_dir : Prims.string -> Prims.string =
  fun fname  ->
    let uu____2447 = get_odir ()  in
...
let __temp_no_proj : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2454 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____2454 (FStar_List.contains s)
  
let admit_smt_queries : Prims.unit -> Prims.bool =
  fun uu____2460  -> get_admit_smt_queries () 
let check_hints : Prims.unit -> Prims.bool =
  fun uu____2464  -> get_check_hints () 
let codegen : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2469  -> get_codegen () 
let codegen_libs : Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____2475  ->
    let uu____2476 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____2476
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let debug_any : Prims.unit -> Prims.bool =
  fun uu____2487  -> let uu____2488 = get_debug ()  in uu____2488 <> [] 
let debug_at_level : Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____2500 = get_debug ()  in
          FStar_All.pipe_right uu____2500 (FStar_List.contains modul)))
        && (debug_level_geq level)
  
let dep : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2507  -> get_dep () 
let detail_errors : Prims.unit -> Prims.bool =
  fun uu____2511  -> get_detail_errors () 
let doc : Prims.unit -> Prims.bool = fun uu____2515  -> get_doc () 
let dump_module : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2520 = get_dump_module ()  in
    FStar_All.pipe_right uu____2520 (FStar_List.contains s)
  
let eager_inference : Prims.unit -> Prims.bool =
  fun uu____2526  -> get_eager_inference () 
let explicit_deps : Prims.unit -> Prims.bool =
  fun uu____2530  -> get_explicit_deps () 
let extract_all : Prims.unit -> Prims.bool =
  fun uu____2534  -> get_extract_all () 
let fs_typ_app : Prims.string -> Prims.bool =
  fun filename  ->
    let uu____2539 = FStar_ST.read light_off_files  in
    FStar_List.contains filename uu____2539
  
let full_context_dependency : Prims.unit -> Prims.bool =
  fun uu____2547  -> true 
let hide_genident_nums : Prims.unit -> Prims.bool =
  fun uu____2551  -> get_hide_genident_nums () 
let hide_uvar_nums : Prims.unit -> Prims.bool =
  fun uu____2555  -> get_hide_uvar_nums () 
let hint_info : Prims.unit -> Prims.bool =
  fun uu____2559  -> get_hint_info () 
let hint_file : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2564  -> get_hint_file () 
let ide : Prims.unit -> Prims.bool = fun uu____2568  -> get_ide () 
let indent : Prims.unit -> Prims.bool = fun uu____2572  -> get_indent () 
let initial_fuel : Prims.unit -> Prims.int =
  fun uu____2576  ->
    let uu____2577 = get_initial_fuel ()  in
    let uu____2578 = get_max_fuel ()  in Prims.min uu____2577 uu____2578
  
let initial_ifuel : Prims.unit -> Prims.int =
  fun uu____2582  ->
    let uu____2583 = get_initial_ifuel ()  in
    let uu____2584 = get_max_ifuel ()  in Prims.min uu____2583 uu____2584
  
let interactive : Prims.unit -> Prims.bool =
  fun uu____2588  -> (get_in ()) || (get_ide ()) 
let lax : Prims.unit -> Prims.bool = fun uu____2592  -> get_lax () 
let load : Prims.unit -> Prims.string Prims.list =
  fun uu____2597  -> get_load () 
let legacy_interactive : Prims.unit -> Prims.bool =
  fun uu____2601  -> get_in () 
let log_queries : Prims.unit -> Prims.bool =
  fun uu____2605  -> get_log_queries () 
let log_types : Prims.unit -> Prims.bool =
  fun uu____2609  -> get_log_types () 
...
let set_ml_ish : Prims.unit -> Prims.unit =
  fun uu____2629  -> set_option "MLish" (Bool true) 
let n_cores : Prims.unit -> Prims.int = fun uu____2633  -> get_n_cores () 
let no_default_includes : Prims.unit -> Prims.bool =
  fun uu____2637  -> get_no_default_includes () 
let no_extract : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2642 = get_no_extract ()  in
    FStar_All.pipe_right uu____2642 (FStar_List.contains s)
  
let no_location_info : Prims.unit -> Prims.bool =
  fun uu____2648  -> get_no_location_info () 
let output_dir : Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2653  -> get_odir () 
let ugly : Prims.unit -> Prims.bool = fun uu____2657  -> get_ugly () 
let print_bound_var_types : Prims.unit -> Prims.bool =
  fun uu____2661  -> get_print_bound_var_types () 
let print_effect_args : Prims.unit -> Prims.bool =
  fun uu____2665  -> get_print_effect_args () 
let print_fuels : Prims.unit -> Prims.bool =
  fun uu____2669  -> get_print_fuels () 
let print_implicits : Prims.unit -> Prims.bool =
  fun uu____2673  -> get_print_implicits () 
let print_real_names : Prims.unit -> Prims.bool =
  fun uu____2677  -> (get_prn ()) || (get_print_full_names ()) 
let print_universes : Prims.unit -> Prims.bool =
  fun uu____2681  -> get_print_universes () 
let print_z3_statistics : Prims.unit -> Prims.bool =
  fun uu____2685  -> get_print_z3_statistics () 
let record_hints : Prims.unit -> Prims.bool =
  fun uu____2689  -> get_record_hints () 
let reuse_hint_for :
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2694  -> get_reuse_hint_for () 
let silent : Prims.unit -> Prims.bool = fun uu____2698  -> get_silent () 
let smtencoding_elim_box : Prims.unit -> Prims.bool =
  fun uu____2702  -> get_smtencoding_elim_box () 
let smtencoding_nl_arith_native : Prims.unit -> Prims.bool =
  fun uu____2706  ->
    let uu____2707 = get_smtencoding_nl_arith_repr ()  in
    uu____2707 = "native"
  
let smtencoding_nl_arith_wrapped : Prims.unit -> Prims.bool =
  fun uu____2711  ->
    let uu____2712 = get_smtencoding_nl_arith_repr ()  in
    uu____2712 = "wrapped"
  
let smtencoding_nl_arith_default : Prims.unit -> Prims.bool =
  fun uu____2716  ->
    let uu____2717 = get_smtencoding_nl_arith_repr ()  in
    uu____2717 = "boxwrap"
  
let smtencoding_l_arith_native : Prims.unit -> Prims.bool =
  fun uu____2721  ->
    let uu____2722 = get_smtencoding_l_arith_repr ()  in
    uu____2722 = "native"
  
let smtencoding_l_arith_default : Prims.unit -> Prims.bool =
  fun uu____2726  ->
    let uu____2727 = get_smtencoding_l_arith_repr ()  in
    uu____2727 = "boxwrap"
  
let split_cases : Prims.unit -> Prims.int =
  fun uu____2731  -> get_split_cases () 
let timing : Prims.unit -> Prims.bool = fun uu____2735  -> get_timing () 
let trace_error : Prims.unit -> Prims.bool =
  fun uu____2739  -> get_trace_error () 
let unthrottle_inductives : Prims.unit -> Prims.bool =
  fun uu____2743  -> get_unthrottle_inductives () 
let use_eq_at_higher_order : Prims.unit -> Prims.bool =
  fun uu____2747  -> get_use_eq_at_higher_order () 
let use_hints : Prims.unit -> Prims.bool =
  fun uu____2751  -> get_use_hints () 
let use_tactics : Prims.unit -> Prims.bool =
  fun uu____2755  -> get_use_tactics () 
let using_facts_from :
  Prims.unit -> Prims.string Prims.list FStar_Pervasives_Native.option =
  fun uu____2761  -> get_using_facts_from () 
let verify_all : Prims.unit -> Prims.bool =
  fun uu____2765  -> get_verify_all () 
let verify_module : Prims.unit -> Prims.string Prims.list =
  fun uu____2770  -> get_verify_module () 
let warn_default_effects : Prims.unit -> Prims.bool =
  fun uu____2774  -> get_warn_default_effects () 
let z3_exe : Prims.unit -> Prims.string =
  fun uu____2778  ->
    let uu____2779 = get_smt ()  in
    match uu____2779 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
  
let z3_cliopt : Prims.unit -> Prims.string Prims.list =
  fun uu____2786  -> get_z3cliopt () 
let z3_refresh : Prims.unit -> Prims.bool =
  fun uu____2790  -> get_z3refresh () 
let z3_rlimit : Prims.unit -> Prims.int = fun uu____2794  -> get_z3rlimit () 
let z3_rlimit_factor : Prims.unit -> Prims.int =
  fun uu____2798  -> get_z3rlimit_factor () 
let z3_seed : Prims.unit -> Prims.int = fun uu____2802  -> get_z3seed () 
let no_positivity : Prims.unit -> Prims.bool =
  fun uu____2806  -> get_no_positivity () 
let should_extract : Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2813 = no_extract m  in Prims.op_Negation uu____2813) &&
      ((extract_all ()) ||
         (let uu____2816 = get_extract_module ()  in
          match uu____2816 with
          | [] ->
              let uu____2818 = get_extract_namespace ()  in
