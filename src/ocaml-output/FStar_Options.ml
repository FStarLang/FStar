...
let get_use_tactics: Prims.unit -> Prims.bool =
  fun uu____754  ->
    let uu____755 = lookup_opt "no_tactics" as_bool in
    Prims.op_Negation uu____755
let get_verify_all: Prims.unit -> Prims.bool =
  fun uu____758  -> lookup_opt "verify_all" as_bool
let get_verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____762  -> lookup_opt "verify_module" (as_list as_string)
let get___temp_no_proj: Prims.unit -> Prims.string Prims.list =
  fun uu____767  -> lookup_opt "__temp_no_proj" (as_list as_string)
let get_version: Prims.unit -> Prims.bool =
  fun uu____771  -> lookup_opt "version" as_bool
let get_warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____774  -> lookup_opt "warn_default_effects" as_bool
let get_z3cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____778  -> lookup_opt "z3cliopt" (as_list as_string)
let get_z3refresh: Prims.unit -> Prims.bool =
  fun uu____782  -> lookup_opt "z3refresh" as_bool
let get_z3rlimit: Prims.unit -> Prims.int =
  fun uu____785  -> lookup_opt "z3rlimit" as_int
let get_z3rlimit_factor: Prims.unit -> Prims.int =
  fun uu____788  -> lookup_opt "z3rlimit_factor" as_int
let get_z3seed: Prims.unit -> Prims.int =
  fun uu____791  -> lookup_opt "z3seed" as_int
let get_z3timeout: Prims.unit -> Prims.int =
  fun uu____794  -> lookup_opt "z3timeout" as_int
let get_no_positivity: Prims.unit -> Prims.bool =
  fun uu____797  -> lookup_opt "__no_positivity" as_bool
let dlevel: Prims.string -> debug_level_t =
  fun uu___56_800  ->
    match uu___56_800 with
    | "Low" -> Low
    | "Medium" -> Medium
    | "High" -> High
    | "Extreme" -> Extreme
...
let add_verify_module: Prims.string -> Prims.unit =
  fun s  ->
    let uu____1016 = cons_verify_module s in
    set_option "verify_module" uu____1016
let rec specs:
  Prims.unit ->
  ...
  fun uu____1026  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "cardinality",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1055 = validate_cardinality x in String uu____1055)),
             "[off|warn|check]")),
        "Check cardinality constraints on inductive data types (default 'off')");
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  -> let uu____1065 = parse_codegen s in String uu____1065)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1075 =
                  let uu____1077 =
                    let uu____1079 = get_codegen_lib () in s :: uu____1079 in
                  FStar_All.pipe_right uu____1077
                    (FStar_List.map (fun _0_28  -> String _0_28)) in
                List uu____1075)), "[namespace]")),
      ...
      (FStar_Getopt.noshort, "debug",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1092 =
                  let uu____1094 =
                    let uu____1096 = get_debug () in x :: uu____1096 in
                  FStar_All.pipe_right uu____1094
                    (FStar_List.map (fun _0_29  -> String _0_29)) in
                List uu____1092)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1109 =
                  let uu____1111 =
                    let uu____1113 = get_debug_level () in x :: uu____1113 in
                  FStar_All.pipe_right uu____1111
                    (FStar_List.map (fun _0_30  -> String _0_30)) in
                List uu____1109)), "[Low|Medium|High|Extreme|...]")),
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1150 =
                  let uu____1152 =
                    let uu____1154 = get_dump_module () in x :: uu____1154 in
                  FStar_All.pipe_right uu____1152
                    (FStar_List.map (fun _0_31  -> String _0_31)) in
                FStar_All.pipe_right uu____1150 (fun _0_32  -> List _0_32))),
             "[module name]")), "");
      ...
      (FStar_Getopt.noshort, "hide_genident_nums",
        (FStar_Getopt.ZeroArgs ((fun uu____1210  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "include",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1248 =
                  let uu____1250 =
                    let uu____1252 = get_include () in
                    FStar_List.map (fun _0_34  -> String _0_34) uu____1252 in
                  FStar_List.append uu____1250 [Path s] in
                List uu____1248)), "[path]")),
      ...
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1328 = FStar_Util.int_of_string x in Int uu____1328)),
             "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1338 = FStar_Util.int_of_string x in Int uu____1338)),
             "[non-negative integer]")),
        "Minimum number of unrolling of recursive functions to try (default 1)");
      (FStar_Getopt.noshort, "MLish",
        (FStar_Getopt.ZeroArgs ((fun uu____1345  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "no_default_includes",
        (FStar_Getopt.ZeroArgs ((fun uu____1362  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1372 =
                  let uu____1374 =
                    let uu____1376 = get_no_extract () in x :: uu____1376 in
                  FStar_All.pipe_right uu____1374
                    (FStar_List.map (fun _0_35  -> String _0_35)) in
                List uu____1372)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "odir",
        (FStar_Getopt.OneArg
           (((fun p  -> let uu____1396 = validate_dir p in Path uu____1396)),
      ...
      (FStar_Getopt.noshort, "show_signatures",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1492 =
                  let uu____1494 =
                    let uu____1496 = get_show_signatures () in x ::
                      uu____1496 in
                  FStar_All.pipe_right uu____1494
                    (FStar_List.map (fun _0_38  -> String _0_38)) in
                List uu____1492)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n1  ->
                let uu____1524 = FStar_Util.int_of_string n1 in
                Int uu____1524)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1591 =
                  let uu____1593 =
                    let uu____1595 = get___temp_no_proj () in x :: uu____1595 in
                  FStar_All.pipe_right uu____1593
                    (FStar_List.map (fun _0_40  -> String _0_40)) in
                List uu____1591)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "z3cliopt",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1623 =
                  let uu____1625 =
                    let uu____1627 = get_z3cliopt () in
                    FStar_List.append uu____1627 [s] in
                  FStar_All.pipe_right uu____1625
                    (FStar_List.map (fun _0_41  -> String _0_41)) in
                List uu____1623)), "[option]")), "Z3 command line options");
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1647 = FStar_Util.int_of_string s in Int uu____1647)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1657 = FStar_Util.int_of_string s in Int uu____1657)),
             "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "z3timeout",
        (FStar_Getopt.OneArg
           (((fun s  ->
                ...
                (let uu____1678 = FStar_Util.int_of_string s in
                 Int uu____1678))), "[positive integer]")),
    ...
    let uu____1691 = FStar_List.map mk_spec specs1 in
    ('h', "help",
      (FStar_Getopt.ZeroArgs
         (fun x  ->
  ...
  fun s  ->
    ...
    | uu____1712 ->
        (FStar_Util.print_string "Wrong argument to codegen flag\n";
         (let uu____1715 = specs () in display_usage_aux uu____1715);
...
let docs: Prims.unit -> (Prims.string* Prims.string) Prims.list =
  fun uu____1740  ->
    let uu____1741 = specs () in
    FStar_List.map
      (fun uu____1755  ->
         match uu____1755 with
         | (uu____1763,name,uu____1765,doc) -> (name, doc)) uu____1741
let settable: Prims.string -> Prims.bool =
  fun uu___57_1771  ->
    match uu___57_1771 with
    | "admit_smt_queries"
      |"cardinality"
       |"debug"
        |"debug_level"
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1795  ->
          ...
          | (uu____1801,x,uu____1803,uu____1804) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1825  ->
          ...
          | (uu____1831,x,uu____1833,uu____1834) -> resettable x))
let display_usage: Prims.unit -> Prims.unit =
  fun uu____1839  ->
    let uu____1840 = specs () in display_usage_aux uu____1840
let fstar_home: Prims.unit -> Prims.string =
  fun uu____1849  ->
    let uu____1850 = get_fstar_home () in
...
let set_options: options -> Prims.string -> FStar_Getopt.parse_cmdline_res =
  fun o  ->
    fun s  ->
      ...
      FStar_Getopt.parse_string specs1 (fun uu____1875  -> ()) s
let file_list_: Prims.string Prims.list FStar_ST.ref = FStar_Util.mk_ref []
let parse_cmd_line:
  Prims.unit -> (FStar_Getopt.parse_cmdline_res* Prims.string Prims.list) =
  fun uu____1886  ->
    let res =
      let uu____1888 = specs () in
      FStar_Getopt.parse_cmdline uu____1888
        (fun i  ->
           let uu____1891 =
             let uu____1893 = FStar_ST.read file_list_ in
             FStar_List.append uu____1893 [i] in
           FStar_ST.write file_list_ uu____1891) in
    let uu____1901 =
      let uu____1903 = FStar_ST.read file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1903 in
    (res, uu____1901)
let file_list: Prims.unit -> Prims.string Prims.list =
  fun uu____1912  -> FStar_ST.read file_list_
let restore_cmd_line_options: Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module () in
    if should_clear then clear () else init ();
    (let r =
       let uu____1924 = specs () in
       FStar_Getopt.parse_cmdline uu____1924 (fun x  -> ()) in
     (let uu____1928 =
        let uu____1931 =
          let uu____1932 =
            FStar_List.map (fun _0_42  -> String _0_42) old_verify_module in
          List uu____1932 in
        ("verify_module", uu____1931) in
      set_option' uu____1928);
     r)
let should_verify: Prims.string -> Prims.bool =
  fun m  ->
    let uu____1937 = get_lax () in
    if uu____1937
    then false
    else
      (let uu____1939 = get_verify_all () in
       if uu____1939
       then true
       else
         (let uu____1941 = get_verify_module () in
          match uu____1941 with
          | [] ->
              let uu____1943 = file_list () in
              FStar_List.existsML
                (fun f  ->
                   ...
                   let f2 =
                     let uu____1948 =
                       let uu____1949 =
                         let uu____1950 =
                           let uu____1951 = FStar_Util.get_file_extension f1 in
                           FStar_String.length uu____1951 in
                         (FStar_String.length f1) - uu____1950 in
                       uu____1949 - (Prims.parse_int "1") in
                     FStar_String.substring f1 (Prims.parse_int "0")
                       uu____1948 in
                   (FStar_String.lowercase f2) = m) uu____1943
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
let dont_gen_projectors: Prims.string -> Prims.bool =
  fun m  ->
    let uu____1961 = get___temp_no_proj () in
    FStar_List.contains m uu____1961
let should_print_message: Prims.string -> Prims.bool =
  fun m  ->
    let uu____1966 = should_verify m in
    if uu____1966 then m <> "Prims" else false
let include_path: Prims.unit -> Prims.string Prims.list =
  fun uu____1971  ->
    let uu____1972 = get_no_default_includes () in
    if uu____1972
    then get_include ()
    else
      (let h = fstar_home () in
       ...
       let uu____1978 =
         ...
         FStar_All.pipe_right uu____1980
           (FStar_List.filter FStar_Util.file_exists) in
       let uu____1987 =
         let uu____1989 = get_include () in
         FStar_List.append uu____1989 ["."] in
       FStar_List.append uu____1978 uu____1987)
let find_file: Prims.string -> Prims.string Prims.option =
  fun filename  ->
    let uu____1995 = FStar_Util.is_path_absolute filename in
    if uu____1995
    then (if FStar_Util.file_exists filename then Some filename else None)
    else
      (let uu____2000 =
         let uu____2002 = include_path () in FStar_List.rev uu____2002 in
       FStar_Util.find_map uu____2000
         (fun p  ->
            let path = FStar_Util.join_paths p filename in
            if FStar_Util.file_exists path then Some path else None))
let prims: Prims.unit -> Prims.string =
  fun uu____2010  ->
    let uu____2011 = get_prims () in
    match uu____2011 with
    | None  ->
        let filename = "prims.fst" in
        let uu____2014 = find_file filename in
             ...
             let uu____2017 =
               let uu____2018 =
                 FStar_Util.format1
                   ...
                   filename in
               FStar_Util.Failure uu____2018 in
             Prims.raise uu____2017)
    | Some x -> x
let prims_basename: Prims.unit -> Prims.string =
  fun uu____2022  ->
    let uu____2023 = prims () in FStar_Util.basename uu____2023
let prepend_output_dir: Prims.string -> Prims.string =
  fun fname  ->
    let uu____2027 = get_odir () in
...
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    ...
    FStar_All.pipe_right uu____2033 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____2038  -> get_admit_smt_queries ()
let check_cardinality: Prims.unit -> Prims.bool =
  fun uu____2041  ->
    let uu____2042 = get_cardinality () in uu____2042 = "check"
let codegen: Prims.unit -> Prims.string Prims.option =
  fun uu____2046  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____2051  ->
    let uu____2052 = get_codegen_lib () in
    FStar_All.pipe_right uu____2052
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____2061  -> let uu____2062 = get_debug () in uu____2062 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____2071 = get_debug () in
          FStar_All.pipe_right uu____2071 (FStar_List.contains modul)))
        && (debug_level_geq level)
let dep: Prims.unit -> Prims.string Prims.option =
  fun uu____2077  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____2080  -> get_detail_errors ()
let doc: Prims.unit -> Prims.bool = fun uu____2083  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2087 = get_dump_module () in
    FStar_All.pipe_right uu____2087 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____2092  -> get_eager_inference ()
let explicit_deps: Prims.unit -> Prims.bool =
  fun uu____2095  -> get_explicit_deps ()
let extract_all: Prims.unit -> Prims.bool =
  fun uu____2098  -> get_extract_all ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____2102 = FStar_ST.read light_off_files in
    FStar_List.contains filename uu____2102
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____2109  -> true
let hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____2112  -> get_hide_genident_nums ()
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____2115  -> get_hide_uvar_nums ()
...
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____2127  ->
    let uu____2128 = get_initial_fuel () in
    let uu____2129 = get_max_fuel () in Prims.min uu____2128 uu____2129
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____2132  ->
    let uu____2133 = get_initial_ifuel () in
    let uu____2134 = get_max_ifuel () in Prims.min uu____2133 uu____2134
let inline_arith: Prims.unit -> Prims.bool =
  fun uu____2137  -> get_inline_arith ()
let interactive: Prims.unit -> Prims.bool =
  fun uu____2140  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____2143  -> get_lax ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____2146  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____2149  -> get_log_queries ()
...
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____2167  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____2170  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____2173  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2177 = get_no_extract () in
    FStar_All.pipe_right uu____2177 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____2182  -> get_no_location_info ()
let norm_then_print: Prims.unit -> Prims.bool =
  fun uu____2185  ->
    let uu____2186 = get_print_before_norm () in uu____2186 = false
let output_dir: Prims.unit -> Prims.string Prims.option =
  fun uu____2190  -> get_odir ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____2193  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____2196  -> get_print_effect_args ()
let print_fuels: Prims.unit -> Prims.bool =
  fun uu____2199  -> get_print_fuels ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____2202  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____2205  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____2208  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____2211  -> get_print_z3_statistics ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____2214  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string Prims.option =
  fun uu____2218  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____2221  -> get_silent ()
let split_cases: Prims.unit -> Prims.int =
  fun uu____2224  -> get_split_cases ()
let timing: Prims.unit -> Prims.bool = fun uu____2227  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____2230  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____2233  -> get_unthrottle_inductives ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____2236  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____2239  -> get_use_hints ()
let use_tactics: Prims.unit -> Prims.bool =
  fun uu____2242  -> get_use_tactics ()
let verify_all: Prims.unit -> Prims.bool =
  fun uu____2245  -> get_verify_all ()
let verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____2249  -> get_verify_module ()
let warn_cardinality: Prims.unit -> Prims.bool =
  fun uu____2252  ->
    let uu____2253 = get_cardinality () in uu____2253 = "warn"
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____2256  -> get_warn_default_effects ()
let warn_top_level_effects: Prims.unit -> Prims.bool =
  fun uu____2259  -> get_warn_top_level_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____2262  ->
    let uu____2263 = get_smt () in
    match uu____2263 with | None  -> FStar_Platform.exe "z3" | Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____2269  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____2272  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____2275  -> get_z3rlimit ()
let z3_rlimit_factor: Prims.unit -> Prims.int =
  fun uu____2278  -> get_z3rlimit_factor ()
...
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____2287  -> get_no_positivity ()
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2291 = no_extract m in Prims.op_Negation uu____2291) &&
      ((extract_all ()) ||
         (let uu____2292 = get_extract_module () in
          match uu____2292 with
          | [] ->
              let uu____2294 = get_extract_namespace () in
