  ...
  fun filename  ->
    ...
    | FStar_Pervasives_Native.None  ->
        let result =
          ...
          with | uu___90_6312 -> FStar_Pervasives_Native.None  in
        (match result with
