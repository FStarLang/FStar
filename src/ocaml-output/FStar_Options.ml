...
let (display_usage : unit -> unit) =
  fun uu____7527  ->
    let uu____7528 = specs ()  in display_usage_aux uu____7528
    ...
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____7642)
       in
    let uu____7703 =
      let uu____7707 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____7707
       in
    (res, uu____7703)
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | OCaml  -> true | uu____8797 -> false
...
let (defensive_fail : unit -> Prims.bool) =
  fun uu____8961  ->
    let uu____8962 = get_defensive ()  in uu____8962 = "fail"
...
let (log_queries : unit -> Prims.bool) =
  fun uu____9228  -> get_log_queries () 
...
let (query_stats : unit -> Prims.bool) =
  fun uu____9403  -> get_query_stats () 
...
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____9480  ->
    let uu____9481 = get_smtencoding_l_arith_repr ()  in
    uu____9481 = "native"
...
let (use_tactics : unit -> Prims.bool) =
  fun uu____9623  -> get_use_tactics () 
        ...
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____10039  ->
                ...
                | (path,uu____10050) -> matches_path m_components path))
         in
