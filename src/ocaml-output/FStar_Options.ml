    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____1810 =
                let uu____1811 = let uu____1816 = f () in (name, uu____1816) in
                set_option' uu____1811 in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x =
                let uu____1827 = let uu____1832 = f x in (name, uu____1832) in
                set_option' uu____1827 in
...
let cons_extract_module: Prims.string -> option_val =
  fun s  ->
    let uu____1849 =
      let uu____1852 =
        let uu____1855 = get_extract_module () in (FStar_String.lowercase s)
          :: uu____1855 in
...
let cons_extract_namespace: Prims.string -> option_val =
  fun s  ->
    let uu____1866 =
      let uu____1869 =
        let uu____1872 = get_extract_namespace () in
        (FStar_String.lowercase s) :: uu____1872 in
      FStar_All.pipe_right uu____1869
        (FStar_List.map (fun _0_34  -> String _0_34)) in
    List uu____1866
let add_extract_module: Prims.string -> Prims.unit =
  fun s  ->
    let uu____1883 = cons_extract_module s in
    set_option "extract_module" uu____1883
let add_extract_namespace: Prims.string -> Prims.unit =
  fun s  ->
    let uu____1888 = cons_extract_namespace s in
    set_option "extract_namespace" uu____1888
let cons_verify_module: Prims.string -> option_val =
  fun s  ->
    let uu____1893 =
      let uu____1896 =
        let uu____1899 = get_verify_module () in (FStar_String.lowercase s)
          :: uu____1899 in
      FStar_All.pipe_right uu____1896
        (FStar_List.map (fun _0_35  -> String _0_35)) in
    List uu____1893
let cons_using_facts_from: Prims.string -> option_val =
  fun s  ->
    set_option "z3refresh" (Bool true);
    (let uu____1911 = get_using_facts_from () in
...
let add_verify_module: Prims.string -> Prims.unit =
  fun s  ->
    let uu____1930 = cons_verify_module s in
    set_option "verify_module" uu____1930
  ...
  fun uu____1943  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "cache_checked_modules",
        (FStar_Getopt.ZeroArgs ((fun uu____2004  -> mk_bool true))),
        "Write a '.checked' file for each module after verification and read from it if present, instead of re-verifying");
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____2022 = parse_codegen s in mk_string uu____2022)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____2040 =
                  let uu____2043 =
                    let uu____2046 = get_codegen_lib () in s :: uu____2046 in
                  FStar_All.pipe_right uu____2043 (FStar_List.map mk_string) in
                List uu____2040)), "[namespace]")),
      ...
      (FStar_Getopt.noshort, "debug",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2070 =
                  let uu____2073 =
                    let uu____2076 = get_debug () in x :: uu____2076 in
                  FStar_All.pipe_right uu____2073 (FStar_List.map mk_string) in
                List uu____2070)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2100 =
                  let uu____2103 =
                    let uu____2106 = get_debug_level () in x :: uu____2106 in
                  FStar_All.pipe_right uu____2103 (FStar_List.map mk_string) in
                List uu____2100)), "[Low|Medium|High|Extreme|...]")),
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2189 =
                  let uu____2192 =
                    let uu____2195 = get_dump_module () in x :: uu____2195 in
                  FStar_All.pipe_right uu____2192 (FStar_List.map mk_string) in
                FStar_All.pipe_right uu____2189 mk_list)), "[module name]")),
        "");
      (FStar_Getopt.noshort, "eager_inference",
        (FStar_Getopt.ZeroArgs ((fun uu____2217  -> mk_bool true))),
        "Solve all type-inference constraints eagerly; more efficient but at the cost of generality");
      (FStar_Getopt.noshort, "explicit_deps",
        (FStar_Getopt.ZeroArgs ((fun uu____2231  -> mk_bool true))),
        "Do not find dependencies automatically, the user provides them on the command-line");
      (FStar_Getopt.noshort, "extract_all",
        (FStar_Getopt.ZeroArgs ((fun uu____2245  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "hide_genident_nums",
        (FStar_Getopt.ZeroArgs ((fun uu____2315  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "in",
        (FStar_Getopt.ZeroArgs ((fun uu____2371  -> mk_bool true))),
        "Legacy interactive mode; reads input from stdin");
      (FStar_Getopt.noshort, "ide",
        (FStar_Getopt.ZeroArgs ((fun uu____2385  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "include",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____2403 =
                  let uu____2406 =
                    let uu____2409 = get_include () in
                    FStar_List.map mk_string uu____2409 in
                  let uu____2412 = let uu____2415 = mk_path s in [uu____2415] in
                  FStar_List.append uu____2406 uu____2412 in
                mk_list uu____2403)), "[path]")),
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2447 = FStar_Util.int_of_string x in
                mk_int uu____2447)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try initially (default 2)");
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2465 = FStar_Util.int_of_string x in
                mk_int uu____2465)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "lax",
        (FStar_Getopt.ZeroArgs ((fun uu____2493  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "load",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____2511 =
                  let uu____2514 =
                    let uu____2517 = get_load () in
                    FStar_List.map mk_string uu____2517 in
                  let uu____2520 = let uu____2523 = mk_path s in [uu____2523] in
                  FStar_List.append uu____2514 uu____2520 in
                mk_list uu____2511)), "[module]")), "Load compiled module");
      (FStar_Getopt.noshort, "log_types",
        (FStar_Getopt.ZeroArgs ((fun uu____2537  -> mk_bool true))),
        "Print types computed for data/val/let-bindings");
      (FStar_Getopt.noshort, "log_queries",
        (FStar_Getopt.ZeroArgs ((fun uu____2551  -> mk_bool true))),
        "Log the Z3 queries in several queries-*.smt2 files, as we go");
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2569 = FStar_Util.int_of_string x in
                mk_int uu____2569)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2587 = FStar_Util.int_of_string x in
                mk_int uu____2587)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2605 = FStar_Util.int_of_string x in
                mk_int uu____2605)), "[non-negative integer]")),
        "Minimum number of unrolling of recursive functions to try (default 1)");
      (FStar_Getopt.noshort, "MLish",
        (FStar_Getopt.ZeroArgs ((fun uu____2619  -> mk_bool true))),
        "Trigger various specializations for compiling the F* compiler itself (not meant for user code)");
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2637 = FStar_Util.int_of_string x in
                mk_int uu____2637)), "[positive integer]")),
        "Maximum number of cores to use for the solver (implies detail_errors = false) (default 1)");
      (FStar_Getopt.noshort, "no_default_includes",
        (FStar_Getopt.ZeroArgs ((fun uu____2651  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2669 =
                  let uu____2672 =
                    let uu____2675 = get_no_extract () in x :: uu____2675 in
                  FStar_All.pipe_right uu____2672 (FStar_List.map mk_string) in
                mk_list uu____2669)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "odir",
        (FStar_Getopt.OneArg
           (((fun p  -> let uu____2713 = validate_dir p in mk_path uu____2713)),
      ...
      (FStar_Getopt.noshort, "print_z3_statistics",
        (FStar_Getopt.ZeroArgs ((fun uu____2811  -> mk_bool true))),
        "Print Z3 statistics for each SMT query (deprecated; use --query_stats instead)");
      (FStar_Getopt.noshort, "prn",
        (FStar_Getopt.ZeroArgs ((fun uu____2825  -> mk_bool true))),
        "Print full names (deprecated; use --print_full_names instead)");
      (FStar_Getopt.noshort, "query_stats",
        (FStar_Getopt.ZeroArgs ((fun uu____2839  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "show_signatures",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2885 =
                  let uu____2888 =
                    let uu____2891 = get_show_signatures () in x ::
                      uu____2891 in
                  FStar_All.pipe_right uu____2888 (FStar_List.map mk_string) in
                mk_list uu____2885)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n1  ->
                let uu____2985 = FStar_Util.int_of_string n1 in
                mk_int uu____2985)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_tactics",
        (FStar_Getopt.ZeroArgs ((fun uu____3111  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "verify_all",
        (FStar_Getopt.ZeroArgs ((fun uu____3139  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____3171 =
                  let uu____3174 =
                    let uu____3177 = get___temp_no_proj () in x :: uu____3177 in
                  FStar_All.pipe_right uu____3174 (FStar_List.map mk_string) in
                mk_list uu____3171)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "warn_default_effects",
        (FStar_Getopt.ZeroArgs ((fun uu____3213  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "z3cliopt",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____3231 =
                  let uu____3234 =
                    let uu____3237 = get_z3cliopt () in
                    FStar_List.append uu____3237 [s] in
                  FStar_All.pipe_right uu____3234 (FStar_List.map mk_string) in
                mk_list uu____3231)), "[option]")),
        "Z3 command line options");
      (FStar_Getopt.noshort, "z3refresh",
        (FStar_Getopt.ZeroArgs ((fun uu____3257  -> mk_bool true))),
        "Restart Z3 after each query; useful for ensuring proof robustness");
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____3275 = FStar_Util.int_of_string s in
                mk_int uu____3275)), "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____3293 = FStar_Util.int_of_string s in
                mk_int uu____3293)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "__no_positivity",
        (FStar_Getopt.ZeroArgs ((fun uu____3325  -> mk_bool true))),
    ...
    let uu____3350 = FStar_List.map mk_spec specs1 in
    (104, "help",
      (FStar_Getopt.ZeroArgs
         (fun x  ->
            display_usage_aux specs1; FStar_All.exit (Prims.parse_int "0"))),
      "Display this information") :: uu____3350
  ...
  fun s  ->
    ...
    | uu____3390 ->
        (FStar_Util.print_string "Wrong argument to codegen flag\n";
         (let uu____3393 = specs () in display_usage_aux uu____3393);
         FStar_All.exit (Prims.parse_int "1"))
and string_as_bool: Prims.string -> Prims.string -> option_val =
  fun option_name  ->
    fun uu___55_3407  ->
      match uu___55_3407 with
      | "true" -> mk_bool true
      | "false" -> mk_bool false
      | uu____3408 ->
          (FStar_Util.print1 "Wrong argument to %s\n" option_name;
           (let uu____3411 = specs () in display_usage_aux uu____3411);
           FStar_All.exit (Prims.parse_int "1"))
...
let docs:
  ...
  =
  fun uu____3435  ->
    let uu____3436 = specs () in
    FStar_List.map
      (fun uu____3468  ->
         match uu____3468 with
         | (uu____3483,name,uu____3485,doc) -> (name, doc)) uu____3436
let settable: Prims.string -> Prims.bool =
  fun uu___56_3494  ->
    match uu___56_3494 with
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____3543  ->
          ...
          | (uu____3554,x,uu____3556,uu____3557) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____3603  ->
          ...
          | (uu____3614,x,uu____3616,uu____3617) -> resettable x))
let display_usage: Prims.unit -> Prims.unit =
  fun uu____3625  ->
    let uu____3626 = specs () in display_usage_aux uu____3626
let fstar_home: Prims.unit -> Prims.string =
  fun uu____3642  ->
    let uu____3643 = get_fstar_home () in
    match uu____3643 with
    | FStar_Pervasives_Native.None  ->
        let x = FStar_Util.get_exec_dir () in
        let x1 = Prims.strcat x "/.." in
        ((let uu____3649 =
            let uu____3654 = mk_string x1 in ("fstar_home", uu____3654) in
          set_option' uu____3649);
         x1)
...
let uu___is_File_argument: Prims.exn -> Prims.bool =
  fun projectee  ->
    ...
    | File_argument uu____3663 -> true
    | uu____3664 -> false
let __proj__File_argument__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | File_argument uu____3672 -> uu____3672
...
let parse_cmd_line:
  ...
  fun uu____3741  ->
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____3743
        (fun i  ->
           let uu____3749 =
             let uu____3752 = FStar_ST.op_Bang file_list_ in
             FStar_List.append uu____3752 [i] in
           FStar_ST.op_Colon_Equals file_list_ uu____3749) in
    let uu____3791 =
      let uu____3794 = FStar_ST.op_Bang file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____3794 in
    (res, uu____3791)
let file_list: Prims.unit -> Prims.string Prims.list =
  fun uu____3822  -> FStar_ST.op_Bang file_list_
let restore_cmd_line_options: Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module () in
    if should_clear then clear () else init ();
    (let r =
       let uu____3851 = specs () in
       FStar_Getopt.parse_cmdline uu____3851 (fun x  -> ()) in
     (let uu____3857 =
        let uu____3862 =
          let uu____3863 = FStar_List.map mk_string old_verify_module in
          List uu____3863 in
        ("verify_module", uu____3862) in
      set_option' uu____3857);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____3872 =
        let uu____3873 =
          let uu____3874 =
            let uu____3875 = FStar_Util.get_file_extension f1 in
            FStar_String.length uu____3875 in
          (FStar_String.length f1) - uu____3874 in
        uu____3873 - (Prims.parse_int "1") in
      FStar_String.substring f1 (Prims.parse_int "0") uu____3872 in
    FStar_String.lowercase f2
let should_verify: Prims.string -> Prims.bool =
  fun m  ->
    let uu____3880 = get_lax () in
    if uu____3880
    then false
    else
      (let uu____3882 = get_verify_all () in
       if uu____3882
       then true
       else
         (let uu____3884 = get_verify_module () in
          match uu____3884 with
          | [] ->
              let uu____3887 = file_list () in
              FStar_List.existsML
                (fun f  ->
                   let uu____3893 = module_name_of_file_name f in
                   uu____3893 = m) uu____3887
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
let should_verify_file: Prims.string -> Prims.bool =
  fun fn  ->
    let uu____3901 = module_name_of_file_name fn in should_verify uu____3901
let dont_gen_projectors: Prims.string -> Prims.bool =
  fun m  ->
    let uu____3906 = get___temp_no_proj () in
    FStar_List.contains m uu____3906
let should_print_message: Prims.string -> Prims.bool =
  fun m  ->
    let uu____3913 = should_verify m in
    if uu____3913 then m <> "Prims" else false
let include_path: Prims.unit -> Prims.string Prims.list =
  fun uu____3920  ->
    let uu____3921 = get_no_default_includes () in
    if uu____3921
    then get_include ()
    else
      (let h = fstar_home () in
       ...
       let uu____3945 =
         let uu____3948 = get_include () in
         FStar_List.append uu____3948 ["."] in
       FStar_List.append uu____3929 uu____3945)
let find_file: Prims.string -> Prims.string FStar_Pervasives_Native.option =
  fun filename  ->
    let uu____3957 = FStar_Util.is_path_absolute filename in
    if uu____3957
    then
      ...
      (let uu____3964 =
         let uu____3967 = include_path () in FStar_List.rev uu____3967 in
       FStar_Util.find_map uu____3964
         (fun p  ->
...
let prims: Prims.unit -> Prims.string =
  fun uu____3980  ->
    let uu____3981 = get_prims () in
    match uu____3981 with
    | FStar_Pervasives_Native.None  ->
        let filename = "prims.fst" in
        let uu____3985 = find_file filename in
             ...
             let uu____3989 =
               let uu____3990 =
                 FStar_Util.format1
                   ...
                   filename in
               FStar_Util.Failure uu____3990 in
             FStar_Exn.raise uu____3989)
    | FStar_Pervasives_Native.Some x -> x
let prims_basename: Prims.unit -> Prims.string =
  fun uu____3995  ->
    let uu____3996 = prims () in FStar_Util.basename uu____3996
let pervasives: Prims.unit -> Prims.string =
  fun uu____4000  ->
    let filename = "FStar.Pervasives.fst" in
    let uu____4002 = find_file filename in
        ...
        let uu____4006 =
          let uu____4007 =
            FStar_Util.format1
              "unable to find required file \"%s\" in the module search path.\n"
              filename in
          FStar_Util.Failure uu____4007 in
        FStar_Exn.raise uu____4006
let pervasives_basename: Prims.unit -> Prims.string =
  fun uu____4011  ->
    let uu____4012 = pervasives () in FStar_Util.basename uu____4012
let pervasives_native_basename: Prims.unit -> Prims.string =
  fun uu____4016  ->
    let filename = "FStar.Pervasives.Native.fst" in
    let uu____4018 = find_file filename in
        ...
        let uu____4022 =
          let uu____4023 =
            FStar_Util.format1
              "unable to find required file \"%s\" in the module search path.\n"
              filename in
          FStar_Util.Failure uu____4023 in
        FStar_Exn.raise uu____4022
let prepend_output_dir: Prims.string -> Prims.string =
  fun fname  ->
    let uu____4028 = get_odir () in
...
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    let uu____4036 = get___temp_no_proj () in
    FStar_All.pipe_right uu____4036 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____4044  -> get_admit_smt_queries ()
let admit_except: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4050  -> get_admit_except ()
let cache_checked_modules: Prims.unit -> Prims.bool =
  fun uu____4054  -> get_cache_checked_modules ()
let codegen: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4060  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____4068  ->
    let uu____4069 = get_codegen_lib () in
    FStar_All.pipe_right uu____4069
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____4085  -> let uu____4086 = get_debug () in uu____4086 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      (let uu____4101 = get_debug () in
       FStar_All.pipe_right uu____4101 (FStar_List.contains modul)) &&
        (debug_level_geq level)
let dep: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4111  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____4115  -> get_detail_errors ()
let detail_hint_replay: Prims.unit -> Prims.bool =
  fun uu____4119  -> get_detail_hint_replay ()
let doc: Prims.unit -> Prims.bool = fun uu____4123  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____4128 = get_dump_module () in
    FStar_All.pipe_right uu____4128 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____4136  -> get_eager_inference ()
let explicit_deps: Prims.unit -> Prims.bool =
  fun uu____4140  -> get_explicit_deps ()
let extract_all: Prims.unit -> Prims.bool =
  fun uu____4144  -> get_extract_all ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____4149 = FStar_ST.op_Bang light_off_files in
    FStar_List.contains filename uu____4149
let gen_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4175  -> get_gen_native_tactics ()
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____4179  -> true
let hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____4183  -> get_hide_genident_nums ()
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____4187  -> get_hide_uvar_nums ()
let hint_info: Prims.unit -> Prims.bool =
  fun uu____4191  -> (get_hint_info ()) || (get_query_stats ())
let hint_file: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4197  -> get_hint_file ()
let ide: Prims.unit -> Prims.bool = fun uu____4201  -> get_ide ()
let indent: Prims.unit -> Prims.bool = fun uu____4205  -> get_indent ()
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____4209  ->
    let uu____4210 = get_initial_fuel () in
    let uu____4211 = get_max_fuel () in Prims.min uu____4210 uu____4211
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____4215  ->
    let uu____4216 = get_initial_ifuel () in
    let uu____4217 = get_max_ifuel () in Prims.min uu____4216 uu____4217
let interactive: Prims.unit -> Prims.bool =
  fun uu____4221  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____4225  -> get_lax ()
let load: Prims.unit -> Prims.string Prims.list =
  fun uu____4231  -> get_load ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____4235  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____4239  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____4243  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____4247  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____4251  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____4255  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____4259  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____4263  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____4267  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____4271  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____4276 = get_no_extract () in
    FStar_All.pipe_right uu____4276 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____4284  -> get_no_location_info ()
let output_dir: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4290  -> get_odir ()
let ugly: Prims.unit -> Prims.bool = fun uu____4294  -> get_ugly ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____4298  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____4302  -> get_print_effect_args ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____4306  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____4310  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____4314  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____4318  -> (get_print_z3_statistics ()) || (get_query_stats ())
let query_stats: Prims.unit -> Prims.bool =
  fun uu____4322  -> get_query_stats ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____4326  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____4332  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____4336  -> get_silent ()
let smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____4340  -> get_smtencoding_elim_box ()
let smtencoding_nl_arith_native: Prims.unit -> Prims.bool =
  fun uu____4344  ->
    let uu____4345 = get_smtencoding_nl_arith_repr () in
    uu____4345 = "native"
let smtencoding_nl_arith_wrapped: Prims.unit -> Prims.bool =
  fun uu____4349  ->
    let uu____4350 = get_smtencoding_nl_arith_repr () in
    uu____4350 = "wrapped"
let smtencoding_nl_arith_default: Prims.unit -> Prims.bool =
  fun uu____4354  ->
    let uu____4355 = get_smtencoding_nl_arith_repr () in
    uu____4355 = "boxwrap"
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____4359  ->
    let uu____4360 = get_smtencoding_l_arith_repr () in uu____4360 = "native"
let smtencoding_l_arith_default: Prims.unit -> Prims.bool =
  fun uu____4364  ->
    let uu____4365 = get_smtencoding_l_arith_repr () in
    uu____4365 = "boxwrap"
let split_cases: Prims.unit -> Prims.int =
  fun uu____4369  -> get_split_cases ()
let timing: Prims.unit -> Prims.bool = fun uu____4373  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____4377  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____4381  -> get_unthrottle_inductives ()
let unsafe_tactic_exec: Prims.unit -> Prims.bool =
  fun uu____4385  -> get_unsafe_tactic_exec ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____4389  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____4393  -> get_use_hints ()
let use_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____4399  -> get_use_native_tactics ()
let use_tactics: Prims.unit -> Prims.bool =
  fun uu____4403  -> get_use_tactics ()
let using_facts_from:
  Prims.unit -> Prims.string Prims.list FStar_Pervasives_Native.option =
  fun uu____4411  -> get_using_facts_from ()
let verify_all: Prims.unit -> Prims.bool =
  fun uu____4415  -> get_verify_all ()
let verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____4421  -> get_verify_module ()
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____4425  -> get_warn_default_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____4429  ->
    let uu____4430 = get_smt () in
    match uu____4430 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____4439  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____4443  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____4447  -> get_z3rlimit ()
let z3_rlimit_factor: Prims.unit -> Prims.int =
  fun uu____4451  -> get_z3rlimit_factor ()
let z3_seed: Prims.unit -> Prims.int = fun uu____4455  -> get_z3seed ()
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____4459  -> get_no_positivity ()
let ml_no_eta_expand_coertions: Prims.unit -> Prims.bool =
  fun uu____4463  -> get_ml_no_eta_expand_coertions ()
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    (let uu____4470 = no_extract m in Prims.op_Negation uu____4470) &&
      ((extract_all ()) ||
         (let uu____4473 = get_extract_module () in
          match uu____4473 with
          | [] ->
              let uu____4476 = get_extract_namespace () in
