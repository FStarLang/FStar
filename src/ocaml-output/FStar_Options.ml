...
let (parse_warn_error : Prims.string -> error_flag Prims.list) =
  fun s ->
    let uu____2562 = FStar_Pervasives_Native.snd parse_warn_error_set_get () in
    uu____2562 s
let (init : unit -> unit) =
  fun uu____2593 ->
...
let (get_report_qi : unit -> Prims.bool) =
  fun uu____3424 -> lookup_opt "report_qi" as_bool
            ...
            FStar_All.pipe_right sub_dirs
              (FStar_List.map
                 (fun s ->
                    ...
                    FStar_String.op_Hat d uu____4015)) in
          d :: uu____3999))
...
let (display_version : unit -> unit) =
  fun uu____4054 ->
    let uu____4055 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____4057
        uu____4080 uu____4103 uu____4126 uu____4149 in
    ...
    | (ns, name, arg, desc) ->
        let arg1 =
          ...
          | FStar_Getopt.OneArg (f, d) ->
              let g x = let uu____4407 = f x in set_option name uu____4407 in
          ...
          (fun uu___309_4987 ->
             ...
             | () ->
                 (match typ with
                  | Const c -> c
                  | IntStr uu____4989 ->
                      let uu____4991 = FStar_Util.safe_int_of_string str_val in
...
let rec (specs_with_types :
  ...
  fun uu____5251 ->
         ...
         (((fun uu___8_5928 ->
              ...
              | String s ->
                  ...
                  let uu____5941 =
                    ...
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____5970 -> failwith "unexpected value for --fuel" in
         ...
         (((fun uu___9_6023 ->
              ...
              | String s ->
                  ...
                  let uu____6036 =
                    ...
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____6065 -> failwith "unexpected value for --ifuel" in
         ...
         (((fun uu___10_6545 ->
              ...
              | String s ->
                  ...
                  let uu____6558 =
                    ...
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____6587 -> failwith "unexpected value for --quake" in
    ...
    (FStar_Getopt.noshort, "__debug_embedding",
      (WithSideEffect
         (((fun uu____7466 -> FStar_ST.op_Colon_Equals debug_embedding true)),
           (Const (Bool true)))),
      "Debug messages for embeddings/unembeddings of natively compiled terms");
    (FStar_Getopt.noshort, "eager_embedding",
      (WithSideEffect
         (((fun uu____7510 -> FStar_ST.op_Colon_Equals eager_embedding true)),
           (Const (Bool true)))),
    ...
    (104, "help",
      (WithSideEffect
         (((fun uu____7607 ->
              (let uu____7609 = specs () in display_usage_aux uu____7609);
              FStar_All.exit Prims.int_zero)), (Const (Bool true)))),
      "Display this information")]
and (specs : unit -> FStar_Getopt.opt Prims.list) =
  fun uu____7640 ->
    let uu____7643 = specs_with_types () in
    FStar_List.map
      (fun uu____7674 ->
         match uu____7674 with
         | (short, long, typ, doc) ->
             let uu____7696 =
               let uu____7710 = arg_spec_of_opt_type long typ in
               (short, long, uu____7710, doc) in
             mk_spec uu____7696) uu____7643
let (settable : Prims.string -> Prims.bool) =
  fun uu___11_7725 ->
    match uu___11_7725 with
    | "abort_on" -> true
    | "admit_except" -> true
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____7962 ->
          ...
          | (uu____7977, x, uu____7979, uu____7980) -> settable x))
let (display_usage : unit -> unit) =
  fun uu____7996 -> let uu____7997 = specs () in display_usage_aux uu____7997
let (fstar_bin_directory : Prims.string) = FStar_Util.get_exec_dir ()
exception File_argument of Prims.string 
let (uu___is_File_argument : Prims.exn -> Prims.bool) =
  fun projectee ->
    match projectee with
    | File_argument uu____8029 -> true
    | uu____8032 -> false
let (__proj__File_argument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee ->
    match projectee with | File_argument uu____8042 -> uu____8042
  ...
  fun uu____8095 ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i ->
           let uu____8101 =
             let uu____8105 = FStar_ST.op_Bang file_list_ in
             FStar_List.append uu____8105 [i] in
           FStar_ST.op_Colon_Equals file_list_ uu____8101) in
    let uu____8162 =
      let uu____8166 = FStar_ST.op_Bang file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____8166 in
    (res, uu____8162)
let (file_list : unit -> Prims.string Prims.list) =
  fun uu____8208 -> FStar_ST.op_Bang file_list_
let (restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res)
  ...
  fun should_clear ->
    ...
    (let r =
       let uu____8251 = specs () in
       FStar_Getopt.parse_cmdline uu____8251 (fun x -> ()) in
     (let uu____8258 =
        let uu____8264 =
          let uu____8265 =
            FStar_List.map (fun _8269 -> String _8269) old_verify_module in
          List uu____8265 in
        ("verify_module", uu____8264) in
      set_option' uu____8258);
     r)
  ...
  fun f ->
    ...
    let f2 =
      let uu____8285 =
        let uu____8287 =
          let uu____8289 =
            let uu____8291 = FStar_Util.get_file_extension f1 in
            FStar_String.length uu____8291 in
          (FStar_String.length f1) - uu____8289 in
        uu____8287 - Prims.int_one in
      FStar_String.substring f1 Prims.int_zero uu____8285 in
    FStar_String.lowercase f2
let (should_verify : Prims.string -> Prims.bool) =
  fun m ->
    let uu____8304 = get_lax () in
    if uu____8304
    then false
    else
...
let (should_verify_file : Prims.string -> Prims.bool) =
  fun fn ->
    let uu____8325 = module_name_of_file_name fn in should_verify uu____8325
...
let (dont_gen_projectors : Prims.string -> Prims.bool) =
  fun m ->
    let uu____8353 = get___temp_no_proj () in
    FStar_All.pipe_right uu____8353 (FStar_List.existsb (module_name_eq m))
let (should_print_message : Prims.string -> Prims.bool) =
  fun m ->
    let uu____8371 = should_verify m in
    if uu____8371 then m <> "Prims" else false
let (include_path : unit -> Prims.string Prims.list) =
  fun uu____8388 ->
    let cache_dir =
      let uu____8393 = get_cache_dir () in
      match uu____8393 with
      | FStar_Pervasives_Native.None -> []
      | FStar_Pervasives_Native.Some c -> [c] in
    let uu____8407 = get_no_default_includes () in
    if uu____8407
    then
      let uu____8413 = get_include () in
      FStar_List.append cache_dir uu____8413
    else
      (let lib_paths =
         let uu____8424 = FStar_Util.expand_environment_variable "FSTAR_LIB" in
       ...
       let uu____8467 =
         let uu____8471 =
           let uu____8475 = get_include () in
           FStar_List.append uu____8475 ["."] in
         FStar_List.append lib_paths uu____8471 in
       FStar_List.append cache_dir uu____8467)
let (find_file : Prims.string -> Prims.string FStar_Pervasives_Native.option)
  =
  let file_map = FStar_Util.smap_create (Prims.of_int (100)) in
  fun filename ->
    let uu____8506 = FStar_Util.smap_try_find file_map filename in
        ...
        let result =
          try
            (fun uu___593_8537 ->
               match () with
               | () ->
                   let uu____8541 = FStar_Util.is_path_absolute filename in
                   if uu____8541
                   then
                     ...
                     (let uu____8557 =
                        let uu____8561 = include_path () in
                        FStar_List.rev uu____8561 in
                      FStar_Util.find_map uu____8557
                        (fun p ->
                           let path =
                             if p = "."
                             then filename
          ...
          with | uu___592_8589 -> FStar_Pervasives_Native.None in
...
let (prims_basename : unit -> Prims.string) =
  fun uu____8640 ->
    let uu____8641 = prims () in FStar_Util.basename uu____8641
let (pervasives : unit -> Prims.string) =
  fun uu____8649 ->
    let filename = "FStar.Pervasives.fst" in
    let uu____8653 = find_file filename in
...
let (pervasives_basename : unit -> Prims.string) =
  fun uu____8672 ->
    let uu____8673 = pervasives () in FStar_Util.basename uu____8673
let (pervasives_native_basename : unit -> Prims.string) =
  fun uu____8681 ->
    let filename = "FStar.Pervasives.Native.fst" in
    let uu____8685 = find_file filename in
...
let (prepend_output_dir : Prims.string -> Prims.string) =
  fun fname ->
    let uu____8707 = get_odir () in
    match uu____8707 with
    | FStar_Pervasives_Native.None -> fname
    | FStar_Pervasives_Native.Some x -> FStar_Util.join_paths x fname
let (prepend_cache_dir : Prims.string -> Prims.string) =
  fun fpath ->
    let uu____8725 = get_cache_dir () in
    match uu____8725 with
    | FStar_Pervasives_Native.None -> fpath
    | FStar_Pervasives_Native.Some x ->
        let uu____8734 = FStar_Util.basename fpath in
        FStar_Util.join_paths x uu____8734
...
let (parse_settings :
  ...
  fun ns ->
    ...
    let with_cache f s =
      let uu____8856 = FStar_Util.smap_try_find cache s in
    ...
    let parse_one_setting s =
      ...
      then ([], true)
        ...
        then ([], false)
          ...
          then
            (let path =
               let uu____9010 = FStar_Util.substring_from s Prims.int_one in
               path_of_text uu____9010 in
             (path, false))
          else
            (let s1 =
               if FStar_Util.starts_with s "+"
              ...
              then []
                ...
                with_cache
                  (fun s2 ->
                     ...
                     FStar_All.pipe_right uu____9107
                       (FStar_List.map parse_one_setting)) s1)) in
    FStar_All.pipe_right uu____9033 FStar_List.rev
let (__temp_no_proj : Prims.string -> Prims.bool) =
  fun s ->
    let uu____9198 = get___temp_no_proj () in
    FStar_All.pipe_right uu____9198 (FStar_List.contains s)
let (__temp_fast_implicits : unit -> Prims.bool) =
  fun uu____9213 -> lookup_opt "__temp_fast_implicits" as_bool
let (admit_smt_queries : unit -> Prims.bool) =
  fun uu____9222 -> get_admit_smt_queries ()
let (admit_except : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9231 -> get_admit_except ()
let (cache_checked_modules : unit -> Prims.bool) =
  fun uu____9238 -> get_cache_checked_modules ()
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee -> match projectee with | OCaml -> true | uu____9262 -> false
let (uu___is_FSharp : codegen_t -> Prims.bool) =
  fun projectee ->
    match projectee with | FSharp -> true | uu____9273 -> false
let (uu___is_Kremlin : codegen_t -> Prims.bool) =
  fun projectee ->
    match projectee with | Kremlin -> true | uu____9284 -> false
let (uu___is_Plugin : codegen_t -> Prims.bool) =
  fun projectee ->
    match projectee with | Plugin -> true | uu____9295 -> false
let (codegen : unit -> codegen_t FStar_Pervasives_Native.option) =
  fun uu____9304 ->
    let uu____9305 = get_codegen () in
    FStar_Util.map_opt uu____9305
      (fun uu___12_9311 ->
         match uu___12_9311 with
         | "OCaml" -> OCaml
         | "FSharp" -> FSharp
         | "Kremlin" -> Kremlin
         | "Plugin" -> Plugin
...
let (codegen_libs : unit -> Prims.string Prims.list Prims.list) =
  fun uu____9330 ->
    let uu____9331 = get_codegen_lib () in
    FStar_All.pipe_right uu____9331
      (FStar_List.map (fun x -> FStar_Util.split x "."))
let (debug_any : unit -> Prims.bool) =
  fun uu____9357 -> let uu____9358 = get_debug () in uu____9358 <> []
let (debug_module : Prims.string -> Prims.bool) =
  fun modul ->
    let uu____9375 = get_debug () in
    FStar_All.pipe_right uu____9375
      (FStar_List.existsb (module_name_eq modul))
let (debug_at_level : Prims.string -> debug_level_t -> Prims.bool) =
  fun modul ->
    fun level ->
      (let uu____9400 = get_debug () in
       FStar_All.pipe_right uu____9400
         (FStar_List.existsb (module_name_eq modul)))
        && (debug_level_geq level)
let (profile_group_by_decls : unit -> Prims.bool) =
  fun uu____9415 -> get_profile_group_by_decl ()
let (defensive : unit -> Prims.bool) =
  fun uu____9422 -> let uu____9423 = get_defensive () in uu____9423 <> "no"
let (defensive_fail : unit -> Prims.bool) =
  fun uu____9433 -> let uu____9434 = get_defensive () in uu____9434 = "fail"
let (dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9446 -> get_dep ()
let (detail_errors : unit -> Prims.bool) =
  fun uu____9453 -> get_detail_errors ()
let (detail_hint_replay : unit -> Prims.bool) =
  fun uu____9460 -> get_detail_hint_replay ()
let (doc : unit -> Prims.bool) = fun uu____9467 -> get_doc ()
let (dump_module : Prims.string -> Prims.bool) =
  fun s ->
    let uu____9477 = get_dump_module () in
    FStar_All.pipe_right uu____9477 (FStar_List.existsb (module_name_eq s))
let (eager_subtyping : unit -> Prims.bool) =
  fun uu____9492 -> get_eager_subtyping ()
let (expose_interfaces : unit -> Prims.bool) =
  fun uu____9499 -> get_expose_interfaces ()
let (fs_typ_app : Prims.string -> Prims.bool) =
  fun filename ->
    let uu____9509 = FStar_ST.op_Bang light_off_files in
    FStar_List.contains filename uu____9509
let (full_context_dependency : unit -> Prims.bool) = fun uu____9545 -> true
let (hide_uvar_nums : unit -> Prims.bool) =
  fun uu____9553 -> get_hide_uvar_nums ()
let (hint_info : unit -> Prims.bool) =
  fun uu____9560 -> (get_hint_info ()) || (get_query_stats ())
let (hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9569 -> get_hint_dir ()
let (hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9578 -> get_hint_file ()
let (hint_file_for_src : Prims.string -> Prims.string) =
  fun src_filename ->
    let uu____9588 = hint_file () in
    match uu____9588 with
    | FStar_Pervasives_Native.Some fn -> fn
    | FStar_Pervasives_Native.None ->
        let file_name =
          let uu____9599 = hint_dir () in
          match uu____9599 with
          | FStar_Pervasives_Native.Some dir ->
              let uu____9607 = FStar_Util.basename src_filename in
              FStar_Util.concat_dir_filename dir uu____9607
          | uu____9609 -> src_filename in
...
let (print_in_place : unit -> Prims.bool) =
  fun uu____9634 -> get_print_in_place ()
let (initial_fuel : unit -> Prims.int) =
  fun uu____9641 ->
    let uu____9642 = get_initial_fuel () in
    let uu____9644 = get_max_fuel () in Prims.min uu____9642 uu____9644
let (initial_ifuel : unit -> Prims.int) =
  fun uu____9652 ->
    let uu____9653 = get_initial_ifuel () in
    let uu____9655 = get_max_ifuel () in Prims.min uu____9653 uu____9655
let (interactive : unit -> Prims.bool) =
  fun uu____9663 -> (get_in ()) || (get_ide ())
...
let (keep_query_captions : unit -> Prims.bool) =
  fun uu____9707 -> (log_queries ()) && (get_keep_query_captions ())
...
let (set_ml_ish : unit -> unit) =
  fun uu____9748 -> set_option "MLish" (Bool true)
let (no_default_includes : unit -> Prims.bool) =
  fun uu____9757 -> get_no_default_includes ()
let (no_extract : Prims.string -> Prims.bool) =
  fun s ->
    let uu____9767 = get_no_extract () in
    FStar_All.pipe_right uu____9767 (FStar_List.existsb (module_name_eq s))
let (normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____9782 -> get_normalize_pure_terms_for_extraction ()
let (no_location_info : unit -> Prims.bool) =
  fun uu____9789 -> get_no_location_info ()
...
let (output_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9812 -> get_odir ()
let (ugly : unit -> Prims.bool) = fun uu____9819 -> get_ugly ()
let (print_bound_var_types : unit -> Prims.bool) =
  fun uu____9826 -> get_print_bound_var_types ()
let (print_effect_args : unit -> Prims.bool) =
  fun uu____9833 -> get_print_effect_args ()
let (print_implicits : unit -> Prims.bool) =
  fun uu____9840 -> get_print_implicits ()
let (print_real_names : unit -> Prims.bool) =
  fun uu____9847 -> (get_prn ()) || (get_print_full_names ())
let (print_universes : unit -> Prims.bool) =
  fun uu____9854 -> get_print_universes ()
let (print_z3_statistics : unit -> Prims.bool) =
  fun uu____9861 -> get_print_z3_statistics ()
...
let (record_hints : unit -> Prims.bool) =
  fun uu____9889 -> get_record_hints ()
let (record_options : unit -> Prims.bool) =
  fun uu____9896 -> get_record_options ()
let (report_qi : unit -> Prims.bool) = fun uu____9903 -> get_report_qi ()
let (reuse_hint_for : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9912 -> get_reuse_hint_for ()
let (silent : unit -> Prims.bool) = fun uu____9919 -> get_silent ()
let (smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____9926 -> get_smtencoding_elim_box ()
let (smtencoding_nl_arith_native : unit -> Prims.bool) =
  fun uu____9933 ->
    let uu____9934 = get_smtencoding_nl_arith_repr () in
    uu____9934 = "native"
let (smtencoding_nl_arith_wrapped : unit -> Prims.bool) =
  fun uu____9944 ->
    let uu____9945 = get_smtencoding_nl_arith_repr () in
    uu____9945 = "wrapped"
let (smtencoding_nl_arith_default : unit -> Prims.bool) =
  fun uu____9955 ->
    let uu____9956 = get_smtencoding_nl_arith_repr () in
    uu____9956 = "boxwrap"
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____9966 ->
    let uu____9967 = get_smtencoding_l_arith_repr () in uu____9967 = "native"
let (smtencoding_l_arith_default : unit -> Prims.bool) =
  fun uu____9977 ->
    let uu____9978 = get_smtencoding_l_arith_repr () in
    uu____9978 = "boxwrap"
let (smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____9988 -> get_smtencoding_valid_intro ()
let (smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____9995 -> get_smtencoding_valid_elim ()
let (tactic_raw_binders : unit -> Prims.bool) =
  fun uu____10002 -> get_tactic_raw_binders ()
let (tactics_failhard : unit -> Prims.bool) =
  fun uu____10009 -> get_tactics_failhard ()
let (tactics_info : unit -> Prims.bool) =
  fun uu____10016 -> get_tactics_info ()
let (tactic_trace : unit -> Prims.bool) =
  fun uu____10023 -> get_tactic_trace ()
let (tactic_trace_d : unit -> Prims.int) =
  fun uu____10030 -> get_tactic_trace_d ()
let (tactics_nbe : unit -> Prims.bool) =
  fun uu____10037 -> get_tactics_nbe ()
let (tcnorm : unit -> Prims.bool) = fun uu____10044 -> get_tcnorm ()
let (timing : unit -> Prims.bool) = fun uu____10051 -> get_timing ()
let (trace_error : unit -> Prims.bool) =
  fun uu____10058 -> get_trace_error ()
let (unthrottle_inductives : unit -> Prims.bool) =
  fun uu____10065 -> get_unthrottle_inductives ()
let (unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____10072 -> get_unsafe_tactic_exec ()
let (use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____10079 -> get_use_eq_at_higher_order ()
let (use_hints : unit -> Prims.bool) = fun uu____10086 -> get_use_hints ()
let (use_hint_hashes : unit -> Prims.bool) =
  fun uu____10093 -> get_use_hint_hashes ()
let (use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____10102 -> get_use_native_tactics ()
let (use_tactics : unit -> Prims.bool) =
  fun uu____10109 -> get_use_tactics ()
let (using_facts_from :
  unit -> (Prims.string Prims.list * Prims.bool) Prims.list) =
  fun uu____10125 ->
    let uu____10126 = get_using_facts_from () in
    match uu____10126 with
    | FStar_Pervasives_Native.None -> [([], true)]
    | FStar_Pervasives_Native.Some ns -> parse_settings ns
let (vcgen_optimize_bind_as_seq : unit -> Prims.bool) =
  fun uu____10180 ->
    let uu____10181 = get_vcgen_optimize_bind_as_seq () in
    FStar_Option.isSome uu____10181
let (vcgen_decorate_with_type : unit -> Prims.bool) =
  fun uu____10192 ->
    let uu____10193 = get_vcgen_optimize_bind_as_seq () in
    match uu____10193 with
    | FStar_Pervasives_Native.Some "with_type" -> true
    | uu____10201 -> false
let (warn_default_effects : unit -> Prims.bool) =
  fun uu____10212 -> get_warn_default_effects ()
let (z3_exe : unit -> Prims.string) =
  fun uu____10219 ->
    let uu____10220 = get_smt () in
    match uu____10220 with
    | FStar_Pervasives_Native.None -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
let (z3_cliopt : unit -> Prims.string Prims.list) =
  fun uu____10238 -> get_z3cliopt ()
...
let (z3_rlimit_factor : unit -> Prims.int) =
  fun uu____10259 -> get_z3rlimit_factor ()
let (z3_seed : unit -> Prims.int) = fun uu____10266 -> get_z3seed ()
let (use_two_phase_tc : unit -> Prims.bool) =
  fun uu____10273 ->
    (get_use_two_phase_tc ()) &&
      (let uu____10275 = lax () in Prims.op_Negation uu____10275)
let (no_positivity : unit -> Prims.bool) =
  fun uu____10283 -> get_no_positivity ()
let (ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____10290 -> get_ml_no_eta_expand_coertions ()
let (warn_error : unit -> Prims.string) =
  fun uu____10297 ->
    let uu____10298 = get_warn_error () in FStar_String.concat "" uu____10298
let (use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____10309 -> get_use_extracted_interfaces ()
let (use_nbe : unit -> Prims.bool) = fun uu____10316 -> get_use_nbe ()
let (trivial_pre_for_unannotated_effectful_fns : unit -> Prims.bool) =
  fun uu____10323 -> get_trivial_pre_for_unannotated_effectful_fns ()
let with_saved_options : 'a . (unit -> 'a) -> 'a =
  fun f ->
    let uu____10340 =
      let uu____10342 = trace_error () in Prims.op_Negation uu____10342 in
    if uu____10340
    then
      (push ();
       (let r =
          try
            (fun uu___800_10357 ->
               match () with
               | () -> let uu____10362 = f () in FStar_Util.Inr uu____10362)
              ()
          with | uu___799_10364 -> FStar_Util.Inl uu___799_10364 in
        pop ();
        (match r with
  ...
  fun m ->
    fun filter1 ->
      ...
      let rec matches_path m_components1 path =
        ...
        | uu____10478 -> false in
      let uu____10490 =
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____10532 ->
                match uu____10532 with
                | (path, uu____10543) -> matches_path m_components path)) in
      match uu____10490 with
      | FStar_Pervasives_Native.None -> false
      | FStar_Pervasives_Native.Some (uu____10562, flag) -> flag
...
let (should_extract : Prims.string -> Prims.bool) =
  fun m ->
    let m1 = FStar_String.lowercase m in
    let uu____10627 = get_extract () in
    match uu____10627 with
    | FStar_Pervasives_Native.Some extract_setting ->
        ((let uu____10642 =
            let uu____10658 = get_no_extract () in
            let uu____10662 = get_extract_namespace () in
            let uu____10666 = get_extract_module () in
            (uu____10658, uu____10662, uu____10666) in
    ...
    | FStar_Pervasives_Native.None ->
        let should_extract_namespace m2 =
          let uu____10720 = get_extract_namespace () in
        ...
        let should_extract_module m2 =
          let uu____10748 = get_extract_module () in
        ...
        (let uu____10770 = no_extract m1 in Prims.op_Negation uu____10770) &&
          (let uu____10773 =
             let uu____10784 = get_extract_namespace () in
             let uu____10788 = get_extract_module () in
             (uu____10784, uu____10788) in
...
let (should_be_already_cached : Prims.string -> Prims.bool) =
  fun m ->
    let uu____10828 = get_already_cached () in
...
let (error_flags : unit -> error_flag Prims.list) =
  ...
  fun uu____10861 ->
    ...
    let uu____10864 = FStar_Util.smap_try_find cache we in
...
let (profile_enabled :
  ...
  fun modul_opt ->
    fun phase ->
      ...
      | FStar_Pervasives_Native.None ->
          let uu____10908 = get_profile_component () in
          matches_namespace_filter_opt phase uu____10908
      | FStar_Pervasives_Native.Some modul ->
          (let uu____10919 = get_profile () in
           matches_namespace_filter_opt modul uu____10919) &&
            (let uu____10926 = get_profile_component () in
             matches_namespace_filter_opt phase uu____10926)