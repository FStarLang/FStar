...
and specs: Prims.unit -> FStar_Getopt.opt Prims.list =
  fun uu____4947  ->
    let uu____4950 = specs_with_types () in
    FStar_List.map
      (fun uu____4975  ->
         match uu____4975 with
         | (short,long,typ,doc) ->
             let uu____4988 =
               let uu____4999 = arg_spec_of_opt_type long typ in
               (short, long, uu____4999, doc) in
             mk_spec uu____4988) uu____4950
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____5064  ->
          ...
          | (uu____5075,x,uu____5077,uu____5078) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____5124  ->
          ...
          | (uu____5135,x,uu____5137,uu____5138) -> resettable x))
let display_usage: Prims.unit -> Prims.unit =
  fun uu____5145  ->
    let uu____5146 = specs () in display_usage_aux uu____5146
let fstar_home: Prims.unit -> Prims.string =
  fun uu____5161  ->
    let uu____5162 = get_fstar_home () in
    match uu____5162 with
    | FStar_Pervasives_Native.None  ->
        let x = FStar_Util.get_exec_dir () in
        let x1 = Prims.strcat x "/.." in
        ((let uu____5168 =
            let uu____5173 = mk_string x1 in ("fstar_home", uu____5173) in
          set_option' uu____5168);
         x1)
...
let uu___is_File_argument: Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with
    | File_argument uu____5181 -> true
    | uu____5182 -> false
let __proj__File_argument__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | File_argument uu____5189 -> uu____5189
  ...
  fun uu____5255  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____5260 =
             let uu____5263 = FStar_ST.op_Bang file_list_ in
             FStar_List.append uu____5263 [i] in
           FStar_ST.op_Colon_Equals file_list_ uu____5260) in
    let uu____5366 =
      let uu____5369 = FStar_ST.op_Bang file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____5369 in
    (res, uu____5366)
let file_list: Prims.unit -> Prims.string Prims.list =
  fun uu____5428  -> FStar_ST.op_Bang file_list_
let restore_cmd_line_options: Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module () in
    if should_clear then clear () else init ();
    (let r =
       let uu____5488 = specs () in
       FStar_Getopt.parse_cmdline uu____5488 (fun x  -> ()) in
     (let uu____5494 =
        let uu____5499 =
          let uu____5500 = FStar_List.map mk_string old_verify_module in
          List uu____5500 in
        ("verify_module", uu____5499) in
  ...
  fun f  ->
    ...
    let f2 =
      let uu____5508 =
        let uu____5509 =
          let uu____5510 =
            let uu____5511 = FStar_Util.get_file_extension f1 in
            FStar_String.length uu____5511 in
          (FStar_String.length f1) - uu____5510 in
        uu____5509 - (Prims.parse_int "1") in
      FStar_String.substring f1 (Prims.parse_int "0") uu____5508 in
    FStar_String.lowercase f2
let should_verify: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5515 = get_lax () in
    if uu____5515
    then false
    else
...
let should_verify_file: Prims.string -> Prims.bool =
  fun fn  ->
    let uu____5523 = module_name_of_file_name fn in should_verify uu____5523
let dont_gen_projectors: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5527 = get___temp_no_proj () in
    FStar_List.contains m uu____5527
let should_print_message: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5533 = should_verify m in
    if uu____5533 then m <> "Prims" else false
let include_path: Prims.unit -> Prims.string Prims.list =
  fun uu____5539  ->
    let uu____5540 = get_no_default_includes () in
    if uu____5540
    then get_include ()
    else
      (let h = fstar_home () in
       ...
       let uu____5564 =
         let uu____5567 = get_include () in
         FStar_List.append uu____5567 ["."] in
       FStar_List.append uu____5548 uu____5564)
let find_file: Prims.string -> Prims.string FStar_Pervasives_Native.option =
  fun filename  ->
    let uu____5575 = FStar_Util.is_path_absolute filename in
    if uu____5575
    then
      ...
      (let uu____5582 =
         let uu____5585 = include_path () in FStar_List.rev uu____5585 in
       FStar_Util.find_map uu____5582
         (fun p  ->
...
let prims_basename: Prims.unit -> Prims.string =
  fun uu____5610  ->
    let uu____5611 = prims () in FStar_Util.basename uu____5611
let pervasives: Prims.unit -> Prims.string =
  fun uu____5614  ->
    let filename = "FStar.Pervasives.fst" in
    let uu____5616 = find_file filename in
...
let pervasives_basename: Prims.unit -> Prims.string =
  fun uu____5623  ->
    let uu____5624 = pervasives () in FStar_Util.basename uu____5624
let pervasives_native_basename: Prims.unit -> Prims.string =
  fun uu____5627  ->
    let filename = "FStar.Pervasives.Native.fst" in
    let uu____5629 = find_file filename in
...
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    let uu____5644 = get___temp_no_proj () in
    FStar_All.pipe_right uu____5644 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____5651  -> get_admit_smt_queries ()
let admit_except: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5656  -> get_admit_except ()
let cache_checked_modules: Prims.unit -> Prims.bool =
  fun uu____5659  -> get_cache_checked_modules ()
let codegen: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5664  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____5671  ->
    let uu____5672 = get_codegen_lib () in
    FStar_All.pipe_right uu____5672
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____5687  -> let uu____5688 = get_debug () in uu____5688 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      (let uu____5701 = get_debug () in
       FStar_All.pipe_right uu____5701 (FStar_List.contains modul)) &&
        (debug_level_geq level)
let dep: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5710  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____5713  -> get_detail_errors ()
let detail_hint_replay: Prims.unit -> Prims.bool =
  fun uu____5716  -> get_detail_hint_replay ()
let doc: Prims.unit -> Prims.bool = fun uu____5719  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____5723 = get_dump_module () in
    FStar_All.pipe_right uu____5723 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____5730  -> get_eager_inference ()
let expose_interfaces: Prims.unit -> Prims.bool =
  fun uu____5733  -> get_expose_interfaces ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____5737 = FStar_ST.op_Bang light_off_files in
    FStar_List.contains filename uu____5737
let gen_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5794  -> get_gen_native_tactics ()
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____5797  -> true
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____5800  -> get_hide_uvar_nums ()
let hint_info: Prims.unit -> Prims.bool =
  fun uu____5803  -> (get_hint_info ()) || (get_query_stats ())
let hint_file: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5808  -> get_hint_file ()
let ide: Prims.unit -> Prims.bool = fun uu____5811  -> get_ide ()
let indent: Prims.unit -> Prims.bool = fun uu____5814  -> get_indent ()
...
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____5822  ->
    let uu____5823 = get_initial_ifuel () in
    let uu____5824 = get_max_ifuel () in Prims.min uu____5823 uu____5824
let interactive: Prims.unit -> Prims.bool =
  fun uu____5827  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____5830  -> get_lax ()
let load: Prims.unit -> Prims.string Prims.list =
  fun uu____5835  -> get_load ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____5838  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____5841  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____5844  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____5847  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____5850  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____5853  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____5856  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____5859  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____5862  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____5865  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let s1 = FStar_String.lowercase s in
    let uu____5870 = get_no_extract () in
    FStar_All.pipe_right uu____5870
      (FStar_Util.for_some (fun f  -> (FStar_String.lowercase f) = s1))
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____5879  -> get_no_location_info ()
let output_dir: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5884  -> get_odir ()
let ugly: Prims.unit -> Prims.bool = fun uu____5887  -> get_ugly ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____5890  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____5893  -> get_print_effect_args ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____5896  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____5899  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____5902  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____5905  -> (get_print_z3_statistics ()) || (get_query_stats ())
let query_stats: Prims.unit -> Prims.bool =
  fun uu____5908  -> get_query_stats ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____5911  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____5916  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____5919  -> get_silent ()
let smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____5922  -> get_smtencoding_elim_box ()
let smtencoding_nl_arith_native: Prims.unit -> Prims.bool =
  fun uu____5925  ->
    let uu____5926 = get_smtencoding_nl_arith_repr () in
    uu____5926 = "native"
let smtencoding_nl_arith_wrapped: Prims.unit -> Prims.bool =
  fun uu____5929  ->
    let uu____5930 = get_smtencoding_nl_arith_repr () in
    uu____5930 = "wrapped"
let smtencoding_nl_arith_default: Prims.unit -> Prims.bool =
  fun uu____5933  ->
    let uu____5934 = get_smtencoding_nl_arith_repr () in
    uu____5934 = "boxwrap"
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____5937  ->
    let uu____5938 = get_smtencoding_l_arith_repr () in uu____5938 = "native"
let smtencoding_l_arith_default: Prims.unit -> Prims.bool =
  fun uu____5941  ->
    let uu____5942 = get_smtencoding_l_arith_repr () in
    uu____5942 = "boxwrap"
let split_cases: Prims.unit -> Prims.int =
  fun uu____5945  -> get_split_cases ()
let tactic_trace: Prims.unit -> Prims.bool =
  fun uu____5948  -> get_tactic_trace ()
let tactic_trace_d: Prims.unit -> Prims.int =
  fun uu____5951  -> get_tactic_trace_d ()
let timing: Prims.unit -> Prims.bool = fun uu____5954  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____5957  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____5960  -> get_unthrottle_inductives ()
let unsafe_tactic_exec: Prims.unit -> Prims.bool =
  fun uu____5963  -> get_unsafe_tactic_exec ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____5966  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____5969  -> get_use_hints ()
let use_hint_hashes: Prims.unit -> Prims.bool =
  fun uu____5972  -> get_use_hint_hashes ()
let use_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5977  -> get_use_native_tactics ()
let use_tactics: Prims.unit -> Prims.bool =
  fun uu____5980  -> get_use_tactics ()
let using_facts_from:
  ...
  fun uu____5989  ->
      ...
      then ([], true)
        ...
        then
          (let path =
             ...
             FStar_Ident.path_of_text uu____6018 in
           (path, false))
        else
          (let s1 =
             if FStar_Util.starts_with s "+"
    ...
    let uu____6054 = get_using_facts_from () in
    match uu____6054 with
    | FStar_Pervasives_Native.None  -> [([], true)]
    | FStar_Pervasives_Native.Some ns ->
        let uu____6086 = FStar_List.collect parse_setting ns in
        FStar_All.pipe_right uu____6086 FStar_List.rev
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____6125  -> get_warn_default_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____6128  ->
    let uu____6129 = get_smt () in
    match uu____6129 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____6137  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____6140  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____6143  -> get_z3rlimit ()
let z3_rlimit_factor: Prims.unit -> Prims.int =
  fun uu____6146  -> get_z3rlimit_factor ()
let z3_seed: Prims.unit -> Prims.int = fun uu____6149  -> get_z3seed ()
let use_two_phase_tc: Prims.unit -> Prims.bool =
  fun uu____6152  -> get_use_two_phase_tc ()
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____6155  -> get_no_positivity ()
let ml_no_eta_expand_coertions: Prims.unit -> Prims.bool =
  fun uu____6158  -> get_ml_no_eta_expand_coertions ()
let warn_error: Prims.unit -> Prims.string =
  fun uu____6161  -> get_warn_error ()
let default_warn_error: Prims.unit -> Prims.string =
  fun uu____6164  ->
    let d = FStar_Util.smap_of_list defaults in
    let uu____6168 = FStar_Util.smap_try_find d "warn_error" in
