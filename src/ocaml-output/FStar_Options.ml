  ...
  fun uu____768  ->
    let uu____769 =
      FStar_Util.format5
        ...
        FStar_Version.date FStar_Version.commit in
    ...
    | (ns,name,arg,desc) ->
        let arg =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____864 =
                let uu____865 = let uu____868 = f () in (name, uu____868) in
  ...
  fun uu____938  ->
    let specs =
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1021 =
                  let uu____1023 =
                    let uu____1025 = get_debug_level () in x :: uu____1025 in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1062 =
                  let uu____1064 =
                    let uu____1066 = get_dump_module () in x :: uu____1066 in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1177 = FStar_Util.int_of_string x in Int uu____1177)),
             "[non-negative integer]")),
        "Number of unrolling of recursive functions to try initially (default 2)");
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1187 = FStar_Util.int_of_string x in Int uu____1187)),
             "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1225 = FStar_Util.int_of_string x in Int uu____1225)),
             "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1235 = FStar_Util.int_of_string x in Int uu____1235)),
             "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1245 = FStar_Util.int_of_string x in Int uu____1245)),
             "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1279 =
                  let uu____1281 =
                    let uu____1283 = get_no_extract () in x :: uu____1283 in
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n  ->
                let uu____1422 = FStar_Util.int_of_string n in Int uu____1422)),
             "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1482 =
                  let uu____1484 =
                    let uu____1486 = get___temp_no_proj () in x :: uu____1486 in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1538 = FStar_Util.int_of_string s in Int uu____1538)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1548 = FStar_Util.int_of_string s in Int uu____1548)),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____1733
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____1736) in
