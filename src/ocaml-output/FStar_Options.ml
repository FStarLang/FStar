...
| () -> begin
Bool (true)
end)))), ("Use a previously recorded hints database for proof replay")))::(((FStar_Getopt.noshort), ("verify_all"), (FStar_Getopt.ZeroArgs ((fun _24_247 -> (match (()) with
| () -> begin
Bool (true)
end)))), ("With automatic dependencies, verify all the dependencies, not just the files passed on the command-line.")))::(((FStar_Getopt.noshort), ("verify_module"), (FStar_Getopt.OneArg (((cons_verify_module), ("[module name]")))), ("Name of the module to verify")))::(((FStar_Getopt.noshort), ("__temp_no_proj"), (FStar_Getopt.OneArg ((((fun x -> (let _117_450 = (let _117_449 = (let _117_447 = (get___temp_no_proj ())
in (x)::_117_447)
in (FStar_All.pipe_right _117_449 (FStar_List.map (fun _117_448 -> String (_117_448)))))
in List (_117_450)))), ("[module name]")))), ("Don\'t generate projectors for this module")))::((('v'), ("version"), (FStar_Getopt.ZeroArgs ((fun _24_249 -> (

let _24_251 = (display_version ())
in (FStar_All.exit (Prims.parse_int "0")))))), ("Display version number")))::(((FStar_Getopt.noshort), ("warn_top_level_effects"), (FStar_Getopt.ZeroArgs ((fun _24_253 -> (match (()) with
| () -> begin
Bool (true)
end)))), ("Top-level effects are ignored by default; turn this flag on to be warned when this happens")))::(((FStar_Getopt.noshort), ("z3timeout"), (FStar_Getopt.OneArg ((((fun s -> (let _117_456 = (FStar_Util.int_of_string s)
in Int (_117_456)))), ("[positive integer]")))), ("Set the Z3 per-query (soft) timeout to [t] seconds (default 5)")))::[]
in (let _117_458 = (FStar_List.map mk_spec specs)
in ((('h'), ("help"), (FStar_Getopt.ZeroArgs ((fun x -> (

let _24_257 = (display_usage_aux specs)
in (FStar_All.exit (Prims.parse_int "0")))))), ("Display this information")))::_117_458))
end))
...
let _24_267 = (let _117_460 = (specs ())
...
let _24_277 = (let _117_462 = (specs ())
in (display_usage_aux _117_462))
in (FStar_All.exit (Prims.parse_int "1"))))
end))
...
let _24_283 = (let _117_463 = (specs ())
...
let settable_specs : (FStar_Char.char * Prims.string * Prims.unit FStar_Getopt.opt_variant * Prims.string) Prims.list = (FStar_All.pipe_right all_specs (FStar_List.filter (fun _24_331 -> (match (_24_331) with
| (_24_325, x, _24_328, _24_330) -> begin
(settable x)
end))))


let resettable_specs : (FStar_Char.char * Prims.string * Prims.unit FStar_Getopt.opt_variant * Prims.string) Prims.list = (FStar_All.pipe_right all_specs (FStar_List.filter (fun _24_339 -> (match (_24_339) with
| (_24_333, x, _24_336, _24_338) -> begin
(resettable x)
end))))


let display_usage : Prims.unit  ->  Prims.unit = (fun _24_340 -> (match (()) with
| () -> begin
(let _117_472 = (specs ())
in (display_usage_aux _117_472))
end))


let fstar_home : Prims.unit  ->  Prims.string = (fun _24_341 -> (match (()) with
| () -> begin
...
let _24_345 = (set_option' (("fstar_home"), (String (x))))
in x)))
end
| Some (x) -> begin
x
...
in (FStar_Getopt.parse_string specs (fun _24_355 -> ()) s)))


let parse_cmd_line : Prims.unit  ->  (FStar_Getopt.parse_cmdline_res * Prims.string Prims.list) = (fun _24_357 -> (match (()) with
| () -> begin
(
...
let res = (let _117_485 = (specs ())
in (FStar_Getopt.parse_cmdline _117_485 (fun i -> (let _117_484 = (let _117_483 = (FStar_ST.read file_list)
in (FStar_List.append _117_483 ((i)::[])))
in (FStar_ST.op_Colon_Equals file_list _117_484)))))
in (let _117_486 = (FStar_ST.read file_list)
in ((res), (_117_486)))))
end))
...
let _24_363 = if should_clear then begin
(clear ())
end else begin
(init ())
end
...
let r = (let _117_490 = (specs ())
in (FStar_Getopt.parse_cmdline _117_490 (fun x -> ())))
in (

let _24_367 = (let _117_494 = (let _117_493 = (let _117_492 = (FStar_List.map (fun _117_491 -> String (_117_491)) old_verify_module)
in List (_117_492))
in (("verify_module"), (_117_493)))
in (set_option' _117_494))
in r)))))
...
let dont_gen_projectors : Prims.string  ->  Prims.bool = (fun m -> (let _117_499 = (get___temp_no_proj ())
in (FStar_List.contains m _117_499)))
...
let include_path : Prims.unit  ->  Prims.string Prims.list = (fun _24_374 -> (match (()) with
| () -> begin
...
in (let _117_508 = (let _117_505 = (FStar_All.pipe_right defs (FStar_List.map (fun x -> (Prims.strcat h x))))
in (FStar_All.pipe_right _117_505 (FStar_List.filter FStar_Util.file_exists)))
in (let _117_507 = (let _117_506 = (get_include ())
in (FStar_List.append _117_506 ((".")::[])))
in (FStar_List.append _117_508 _117_507)))))
end
end))
...
(let _117_513 = (let _117_511 = (include_path ())
in (FStar_List.rev _117_511))
in (FStar_Util.find_map _117_513 (fun p -> (
...
let prims : Prims.unit  ->  Prims.string = (fun _24_381 -> (match (()) with
| () -> begin
...
| None -> begin
(let _117_517 = (let _117_516 = (FStar_Util.format1 "unable to find required file \"%s\" in the module search path.\n" filename)
in FStar_Util.Failure (_117_516))
in (Prims.raise _117_517))
end))
end
| Some (x) -> begin
x
...
let __temp_no_proj : Prims.string  ->  Prims.bool = (fun s -> (let _117_522 = (get___temp_no_proj ())
in (FStar_All.pipe_right _117_522 (FStar_List.contains s))))


let admit_smt_queries : Prims.unit  ->  Prims.bool = (fun _24_394 -> (match (()) with
| () -> begin
(get_admit_smt_queries ())
end))


let check_cardinality : Prims.unit  ->  Prims.bool = (fun _24_395 -> (match (()) with
| () -> begin
((get_cardinality ()) = "check")
end))


let codegen : Prims.unit  ->  Prims.string Prims.option = (fun _24_396 -> (match (()) with
| () -> begin
(get_codegen ())
end))


let codegen_libs : Prims.unit  ->  Prims.string Prims.list Prims.list = (fun _24_397 -> (match (()) with
| () -> begin
(let _117_532 = (get_codegen_lib ())
in (FStar_All.pipe_right _117_532 (FStar_List.map (fun x -> (FStar_Util.split x ".")))))
end))


let debug_any : Prims.unit  ->  Prims.bool = (fun _24_399 -> (match (()) with
| () -> begin
((get_debug ()) <> [])
end))


let debug_at_level : Prims.string  ->  debug_level_t  ->  Prims.bool = (fun modul level -> (((modul = "") || (let _117_539 = (get_debug ())
in (FStar_All.pipe_right _117_539 (FStar_List.contains modul)))) && (debug_level_geq level)))


let dep : Prims.unit  ->  Prims.string Prims.option = (fun _24_402 -> (match (()) with
| () -> begin
(get_dep ())
end))


let detail_errors : Prims.unit  ->  Prims.bool = (fun _24_403 -> (match (()) with
| () -> begin
(get_detail_errors ())
end))


let doc : Prims.unit  ->  Prims.bool = (fun _24_404 -> (match (()) with
| () -> begin
(get_doc ())
end))


let dump_module : Prims.string  ->  Prims.bool = (fun s -> (let _117_548 = (get_dump_module ())
in (FStar_All.pipe_right _117_548 (FStar_List.contains s))))
...
let hint_info : Prims.unit  ->  Prims.bool = (fun _24_412 -> (match (()) with
| () -> begin
(get_hint_info ())
end))


let initial_fuel : Prims.unit  ->  Prims.int = (fun _24_413 -> (match (()) with
| () -> begin
(get_initial_fuel ())
end))


let initial_ifuel : Prims.unit  ->  Prims.int = (fun _24_414 -> (match (()) with
| () -> begin
(get_initial_ifuel ())
end))


let inline_arith : Prims.unit  ->  Prims.bool = (fun _24_415 -> (match (()) with
| () -> begin
(get_inline_arith ())
end))


let interactive : Prims.unit  ->  Prims.bool = (fun _24_416 -> (match (()) with
| () -> begin
(get_in ())
end))


let interactive_fsi : Prims.unit  ->  Prims.bool = (fun _24_417 -> (match (()) with
| () -> begin
(get_fsi ())
end))


let lax : Prims.unit  ->  Prims.bool = (fun _24_418 -> (match (()) with
| () -> begin
(get_lax ())
end))


let log_queries : Prims.unit  ->  Prims.bool = (fun _24_419 -> (match (()) with
| () -> begin
(get_log_queries ())
end))


let log_types : Prims.unit  ->  Prims.bool = (fun _24_420 -> (match (()) with
| () -> begin
(get_log_types ())
end))


let max_fuel : Prims.unit  ->  Prims.int = (fun _24_421 -> (match (()) with
| () -> begin
(get_max_fuel ())
end))


let max_ifuel : Prims.unit  ->  Prims.int = (fun _24_422 -> (match (()) with
| () -> begin
(get_max_ifuel ())
end))


let min_fuel : Prims.unit  ->  Prims.int = (fun _24_423 -> (match (()) with
| () -> begin
(get_min_fuel ())
end))


let ml_ish : Prims.unit  ->  Prims.bool = (fun _24_424 -> (match (()) with
| () -> begin
(get_MLish ())
end))


let n_cores : Prims.unit  ->  Prims.int = (fun _24_425 -> (match (()) with
| () -> begin
(get_n_cores ())
end))


let no_default_includes : Prims.unit  ->  Prims.bool = (fun _24_426 -> (match (()) with
| () -> begin
(get_no_default_includes ())
end))


let no_extract : Prims.string  ->  Prims.bool = (fun s -> (let _117_593 = (get_no_extract ())
in (FStar_All.pipe_right _117_593 (FStar_List.contains s))))


let no_location_info : Prims.unit  ->  Prims.bool = (fun _24_428 -> (match (()) with
| () -> begin
(get_no_location_info ())
end))


let norm_then_print : Prims.unit  ->  Prims.bool = (fun _24_429 -> (match (()) with
| () -> begin
((get_print_before_norm ()) = false)
end))


let output_dir : Prims.unit  ->  Prims.string Prims.option = (fun _24_430 -> (match (()) with
| () -> begin
(get_odir ())
end))


let print_bound_var_types : Prims.unit  ->  Prims.bool = (fun _24_431 -> (match (()) with
| () -> begin
(get_print_bound_var_types ())
end))


let print_effect_args : Prims.unit  ->  Prims.bool = (fun _24_432 -> (match (()) with
| () -> begin
(get_print_effect_args ())
end))


let print_fuels : Prims.unit  ->  Prims.bool = (fun _24_433 -> (match (()) with
| () -> begin
(get_print_fuels ())
end))


let print_implicits : Prims.unit  ->  Prims.bool = (fun _24_434 -> (match (()) with
| () -> begin
(get_print_implicits ())
end))


let print_real_names : Prims.unit  ->  Prims.bool = (fun _24_435 -> (match (()) with
| () -> begin
(get_prn ())
end))


let print_universes : Prims.unit  ->  Prims.bool = (fun _24_436 -> (match (()) with
| () -> begin
(get_print_universes ())
end))


let record_hints : Prims.unit  ->  Prims.bool = (fun _24_437 -> (match (()) with
| () -> begin
(get_record_hints ())
end))


let reuse_hint_for : Prims.unit  ->  Prims.string Prims.option = (fun _24_438 -> (match (()) with
| () -> begin
(get_reuse_hint_for ())
end))
...
let use_light : Prims.unit  ->  Prims.bool = (fun _24_447 -> (match (()) with
| () -> begin
(get_use_light ())
end))


let verify_all : Prims.unit  ->  Prims.bool = (fun _24_448 -> (match (()) with
| () -> begin
(get_verify_all ())
end))
