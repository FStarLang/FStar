...
let display_version : Prims.unit -> Prims.unit =
  fun uu____849  ->
    let uu____850 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____851
        uu____854 uu____857 uu____860 uu____863
       in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____960 =
                let uu____961 = let uu____964 = f ()  in (name, uu____964)
                   in
  ...
  fun uu____1051  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1080 = parse_codegen s  in String uu____1080)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1090 =
                  let uu____1092 =
                    let uu____1094 = get_codegen_lib ()  in s :: uu____1094
                     in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1124 =
                  let uu____1126 =
                    let uu____1128 = get_debug_level ()  in x :: uu____1128
                     in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1165 =
                  let uu____1167 =
                    let uu____1169 = get_dump_module ()  in x :: uu____1169
                     in
           ...
           (((fun s  ->
                let uu____1263 =
                  let uu____1265 =
                    ...
                    FStar_List.map (fun _0_35  -> String _0_35) uu____1267
                     in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1285 = FStar_Util.int_of_string x  in
                Int uu____1285)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1333 = FStar_Util.int_of_string x  in
                Int uu____1333)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                ...
                Int uu____1370)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1387 =
                  let uu____1389 =
                    let uu____1391 = get_no_extract ()  in x :: uu____1391
                     in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1628 =
                  let uu____1630 =
                    let uu____1632 = get___temp_no_proj ()  in x ::
                      uu____1632
                     in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1684 = FStar_Util.int_of_string s  in
                Int uu____1684)), "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1694 = FStar_Util.int_of_string s  in
                Int uu____1694)), "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1704 = FStar_Util.int_of_string s  in
                Int uu____1704)), "[positive integer]")),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____1926
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____1929)
       in
    let uu____1939 =
      let uu____1941 = FStar_ST.read file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1941
       in
    (res, uu____1939)
                ...
                (fun f  ->
                   ...
                   let f2 =
                     let uu____1986 =
                       let uu____1987 =
                         let uu____1988 =
                           let uu____1989 = FStar_Util.get_file_extension f1
                              in
