...
let display_version: Prims.unit -> Prims.unit =
  fun uu____816  ->
    let uu____817 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____818
        uu____821 uu____824 uu____827 uu____830 in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____927 =
                let uu____928 = let uu____931 = f () in (name, uu____931) in
  ...
  fun uu____1001  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  -> let uu____1040 = parse_codegen s in String uu____1040)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1050 =
                  let uu____1052 =
                    let uu____1054 = get_codegen_lib () in s :: uu____1054 in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1084 =
                  let uu____1086 =
                    let uu____1088 = get_debug_level () in x :: uu____1088 in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1125 =
                  let uu____1127 =
                    let uu____1129 = get_dump_module () in x :: uu____1129 in
           ...
           (((fun s  ->
                let uu____1216 =
                  let uu____1218 =
                    ...
                    FStar_List.map (fun _0_34  -> String _0_34) uu____1220 in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1238 = FStar_Util.int_of_string x in Int uu____1238)),
             "[non-negative integer]")),
        "Number of unrolling of recursive functions to try initially (default 2)");
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1248 = FStar_Util.int_of_string x in Int uu____1248)),
             "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1340 =
                  let uu____1342 =
                    let uu____1344 = get_no_extract () in x :: uu____1344 in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1557 =
                  let uu____1559 =
                    let uu____1561 = get___temp_no_proj () in x :: uu____1561 in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1613 = FStar_Util.int_of_string s in Int uu____1613)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1623 = FStar_Util.int_of_string s in Int uu____1623)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1633 = FStar_Util.int_of_string s in Int uu____1633)),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____1818
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____1821) in
    let uu____1831 =
      let uu____1833 = FStar_ST.read file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1833 in
    (res, uu____1831)
                ...
                (fun f  ->
                   ...
                   let f2 =
                     let uu____1878 =
                       let uu____1879 =
                         let uu____1880 =
                           let uu____1881 = FStar_Util.get_file_extension f1 in
...
let hint_info: Prims.unit -> Prims.bool = fun uu____2048  -> get_hint_info ()
...
let log_types: Prims.unit -> Prims.bool = fun uu____2076  -> get_log_types ()
...
let use_hints: Prims.unit -> Prims.bool = fun uu____2163  -> get_use_hints ()
...
let z3_timeout: Prims.unit -> Prims.int = fun uu____2208  -> get_z3timeout ()
