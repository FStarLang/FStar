...
let (display_version : Prims.unit -> Prims.unit) =
  fun uu____1638  ->
    let uu____1639 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____1640
        uu____1660 uu____1680 uu____1700 uu____1720
       in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.OneArg (f,d) ->
              let g x = let uu____1896 = f x  in set_option name uu____1896
                 in
  ...
  fun name  ->
    fun post_processor  ->
      fun value  ->
        let uu____1959 =
          let uu____1960 =
            let uu____1961 = post_processor value  in mk_string uu____1961
             in
...
let rec (specs_with_types :
  ...
  fun uu____2407  ->
    let uu____2418 =
      let uu____2429 =
        let uu____2440 =
          let uu____2449 = let uu____2450 = mk_bool true  in Const uu____2450
             in
        ...
        let uu____2451 =
          let uu____2462 =
              ...
              let uu____2484 =
                let uu____2495 =
                  ...
                  (FStar_Getopt.noshort, "debug_level",
                    ...
                    "Control the verbosity of debugging info") :: uu____2506
                   in
            ...
            (FStar_Getopt.noshort, "codegen",
              ...
              "Generate code for execution") :: uu____2473
             in
    ...
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____4911)
       in
    let uu____4963 =
      let uu____4966 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____4966
       in
    (res, uu____4963)
...
let (smtencoding_l_arith_native : Prims.unit -> Prims.bool) =
  fun uu____5586  ->
    let uu____5587 = get_smtencoding_l_arith_repr ()  in
    uu____5587 = "native"
            ...
            FStar_All.pipe_right setting
              (FStar_Util.try_find
                 (fun uu____5880  ->
                    ...
                    | (path,uu____5888) -> matches_path m_components path))
             in
