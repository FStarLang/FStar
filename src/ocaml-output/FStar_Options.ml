...
let dlevel : Prims.string  ->  debug_level_t = (fun uu___48_721 -> (match (uu___48_721) with
| "Low" -> begin
Low
end
| "Medium" -> begin
...
let g = (fun uu____824 -> (set_option' (let _0_30 = (f ())
in ((name), (_0_30)))))
...
in (x)::_0_72)
in (FStar_All.pipe_right _0_74 (FStar_List.map (fun _0_73 -> String (_0_73)))))))), ("[module name]")))), ("Don\'t generate projectors for this module")))::((('v'), ("version"), (FStar_Getopt.ZeroArgs ((fun uu____1370 -> ((display_version ());
...
let settable : Prims.string  ->  Prims.bool = (fun uu___49_1460 -> (match (uu___49_1460) with
...
let check_cardinality : Prims.unit  ->  Prims.bool = (fun uu____1678 -> (let _0_97 = (get_cardinality ())
in (_0_97 = "check")))
...
let codegen_libs : Prims.unit  ->  Prims.string Prims.list Prims.list = (fun uu____1687 -> (let _0_98 = (get_codegen_lib ())
in (FStar_All.pipe_right _0_98 (FStar_List.map (fun x -> (FStar_Util.split x "."))))))


let debug_any : Prims.unit  ->  Prims.bool = (fun uu____1695 -> (let _0_99 = (get_debug ())
in (_0_99 <> [])))
...
let fs_typ_app : Prims.string  ->  Prims.bool = (fun filename -> (let _0_102 = (FStar_ST.read light_off_files)
...
let norm_then_print : Prims.unit  ->  Prims.bool = (fun uu____1799 -> (let _0_104 = (get_print_before_norm ())
in (_0_104 = false)))
...
let warn_cardinality : Prims.unit  ->  Prims.bool = (fun uu____1862 -> (let _0_105 = (get_cardinality ())
in (_0_105 = "warn")))
