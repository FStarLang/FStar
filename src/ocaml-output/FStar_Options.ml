  ...
  fun uu____1899  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1996 =
                  let uu____1999 =
                    let uu____2002 = get_codegen_lib ()  in s :: uu____2002
                     in
                  FStar_All.pipe_right uu____1999 (FStar_List.map mk_string)
                   in
        ...
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2026 =
                  ...
                  FStar_All.pipe_right uu____2029 (FStar_List.map mk_string)
                   in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2056 =
                  let uu____2059 =
                    let uu____2062 = get_debug_level ()  in x :: uu____2062
                     in
                  FStar_All.pipe_right uu____2059 (FStar_List.map mk_string)
                   in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2145 =
                  let uu____2148 =
                    let uu____2151 = get_dump_module ()  in x :: uu____2151
                     in
                  FStar_All.pipe_right uu____2148 (FStar_List.map mk_string)
                   in
        ...
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____2345 =
                  ...
                  let uu____2354 =
                    let uu____2357 = mk_path s  in [uu____2357]  in
        ...
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____2453 =
                  ...
                  let uu____2462 =
                    let uu____2465 = mk_path s  in [uu____2465]  in
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____2611 =
                  let uu____2614 =
                    let uu____2617 = get_no_extract ()  in x :: uu____2617
                     in
                  FStar_All.pipe_right uu____2614 (FStar_List.map mk_string)
                   in
      ...
      (FStar_Getopt.noshort, "odir",
        (FStar_Getopt.OneArg
           (((fun p  ->
                let uu____2655 = validate_dir p  in mk_path uu____2655)),
...
let smtencoding_l_arith_native : Prims.unit -> Prims.bool =
  fun uu____4267  ->
    let uu____4268 = get_smtencoding_l_arith_repr ()  in
    uu____4268 = "native"
