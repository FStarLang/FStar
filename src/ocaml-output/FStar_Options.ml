...
let (display_version : Prims.unit -> Prims.unit) =
  fun uu____1652 ->
    let uu____1653 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____1654
        uu____1674 uu____1694 uu____1714 uu____1734 in
    ...
    | (ns, name, arg, desc) ->
        let arg1 =
          ...
          | FStar_Getopt.OneArg (f, d) ->
              let g x = let uu____1910 = f x in set_option name uu____1910 in
  ...
  fun name ->
    fun post_processor ->
      fun value ->
        let uu____1973 =
          let uu____1974 =
            let uu____1975 = post_processor value in mk_string uu____1975 in
...
let rec (specs_with_types :
  ...
  fun uu____2421 ->
    let uu____2432 =
      let uu____2443 =
        let uu____2454 =
          let uu____2463 = let uu____2464 = mk_bool true in Const uu____2464 in
              ...
              let uu____2498 =
                let uu____2509 =
                                      ...
                                      let uu____2674 =
                                        ...
                                        let uu____2696 =
                                          let uu____2707 =
                                            let uu____2718 =
                                              let uu____2727 =
                                                let uu____2728 = mk_bool true in
                                                Const uu____2728 in
                                              (FStar_Getopt.noshort,
                                                  ...
                                                  let uu____2784 =
                                                    ...
                                                    let uu____2806 =
                                                      ...
                                                      (FStar_Getopt.noshort,
                                                        ...
                                                        :: uu____2817 in
                                                    uu____2795 :: uu____2806 in
                                                  uu____2773 :: uu____2784 in
                  ...
                  (FStar_Getopt.noshort, "debug_level",
                    ...
                    "Control the verbosity of debugging info") :: uu____2520 in
...
let (display_usage : Prims.unit -> Prims.unit) =
  fun uu____4896 -> let uu____4897 = specs () in display_usage_aux uu____4897
    ...
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____5015) in
    let uu____5067 =
      let uu____5070 = FStar_ST.op_Bang file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____5070 in
    (res, uu____5067)
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee -> match projectee with | OCaml -> true | uu____5446 -> false
...
let (defensive_fail : Prims.unit -> Prims.bool) =
  fun uu____5517 -> let uu____5518 = get_defensive () in uu____5518 = "fail"
...
let (smtencoding_l_arith_native : Prims.unit -> Prims.bool) =
  fun uu____5721 ->
    let uu____5722 = get_smtencoding_l_arith_repr () in uu____5722 = "native"
...
let (z3_rlimit : Prims.unit -> Prims.int) = fun uu____5841 -> get_z3rlimit ()
            ...
            FStar_All.pipe_right setting
              (FStar_Util.try_find
                 (fun uu____6018 ->
                    ...
                    | (path, uu____6026) -> matches_path m_components path)) in
