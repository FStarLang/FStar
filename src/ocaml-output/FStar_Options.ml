...
let get_no_positivity: Prims.unit -> Prims.bool =
  fun uu____1806  -> lookup_opt "__no_positivity" as_bool
let get_ml_no_eta_expand_coertions: Prims.unit -> Prims.bool =
  fun uu____1809  -> lookup_opt "__ml_no_eta_expand_coertions" as_bool
let get_warn_error: Prims.unit -> Prims.string =
  fun uu____1812  -> lookup_opt "warn_error" as_string
let dlevel: Prims.string -> debug_level_t =
  fun uu___71_1815  ->
    match uu___71_1815 with
    | "Low" -> Low
    | "Medium" -> Medium
    | "High" -> High
    | "Extreme" -> Extreme
...
and specs: Prims.unit -> FStar_Getopt.opt Prims.list =
  fun uu____4910  ->
    let uu____4913 = specs_with_types () in
    FStar_List.map
      (fun uu____4938  ->
         match uu____4938 with
         | (short,long,typ,doc) ->
             let uu____4951 =
               let uu____4962 = arg_spec_of_opt_type long typ in
               (short, long, uu____4962, doc) in
             mk_spec uu____4951) uu____4913
let settable: Prims.string -> Prims.bool =
  fun uu___72_4969  ->
    match uu___72_4969 with
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____5027  ->
          ...
          | (uu____5038,x,uu____5040,uu____5041) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____5087  ->
          ...
          | (uu____5098,x,uu____5100,uu____5101) -> resettable x))
let display_usage: Prims.unit -> Prims.unit =
  fun uu____5108  ->
    let uu____5109 = specs () in display_usage_aux uu____5109
let fstar_home: Prims.unit -> Prims.string =
  fun uu____5124  ->
    let uu____5125 = get_fstar_home () in
    match uu____5125 with
    | FStar_Pervasives_Native.None  ->
        let x = FStar_Util.get_exec_dir () in
        let x1 = Prims.strcat x "/.." in
        ((let uu____5131 =
            let uu____5136 = mk_string x1 in ("fstar_home", uu____5136) in
          set_option' uu____5131);
         x1)
...
let uu___is_File_argument: Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with
    | File_argument uu____5144 -> true
    | uu____5145 -> false
let __proj__File_argument__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | File_argument uu____5152 -> uu____5152
  ...
  fun uu____5218  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____5223 =
             let uu____5226 = FStar_ST.op_Bang file_list_ in
             FStar_List.append uu____5226 [i] in
           FStar_ST.op_Colon_Equals file_list_ uu____5223) in
    let uu____5329 =
      let uu____5332 = FStar_ST.op_Bang file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____5332 in
    (res, uu____5329)
let file_list: Prims.unit -> Prims.string Prims.list =
  fun uu____5391  -> FStar_ST.op_Bang file_list_
let restore_cmd_line_options: Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module () in
    if should_clear then clear () else init ();
    (let r =
       let uu____5451 = specs () in
       FStar_Getopt.parse_cmdline uu____5451 (fun x  -> ()) in
     (let uu____5457 =
        let uu____5462 =
          let uu____5463 = FStar_List.map mk_string old_verify_module in
          List uu____5463 in
        ("verify_module", uu____5462) in
      set_option' uu____5457);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____5471 =
        let uu____5472 =
          let uu____5473 =
            let uu____5474 = FStar_Util.get_file_extension f1 in
            FStar_String.length uu____5474 in
          (FStar_String.length f1) - uu____5473 in
        uu____5472 - (Prims.parse_int "1") in
      FStar_String.substring f1 (Prims.parse_int "0") uu____5471 in
    FStar_String.lowercase f2
let should_verify: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5478 = get_lax () in
    if uu____5478
    then false
    else
...
let should_verify_file: Prims.string -> Prims.bool =
  fun fn  ->
    let uu____5486 = module_name_of_file_name fn in should_verify uu____5486
let dont_gen_projectors: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5490 = get___temp_no_proj () in
    FStar_List.contains m uu____5490
let should_print_message: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5496 = should_verify m in
    if uu____5496 then m <> "Prims" else false
let include_path: Prims.unit -> Prims.string Prims.list =
  fun uu____5502  ->
    let uu____5503 = get_no_default_includes () in
    if uu____5503
    then get_include ()
    else
      (let h = fstar_home () in
       ...
       let uu____5527 =
         let uu____5530 = get_include () in
         FStar_List.append uu____5530 ["."] in
       FStar_List.append uu____5511 uu____5527)
let find_file: Prims.string -> Prims.string FStar_Pervasives_Native.option =
  fun filename  ->
    let uu____5538 = FStar_Util.is_path_absolute filename in
    if uu____5538
    then
      ...
      (let uu____5545 =
         let uu____5548 = include_path () in FStar_List.rev uu____5548 in
       FStar_Util.find_map uu____5545
         (fun p  ->
...
let prims: Prims.unit -> Prims.string =
  fun uu____5560  ->
    let uu____5561 = get_prims () in
    match uu____5561 with
    | FStar_Pervasives_Native.None  ->
        let filename = "prims.fst" in
        let uu____5565 = find_file filename in
...
let prims_basename: Prims.unit -> Prims.string =
  fun uu____5573  ->
    let uu____5574 = prims () in FStar_Util.basename uu____5574
let pervasives: Prims.unit -> Prims.string =
  fun uu____5577  ->
    let filename = "FStar.Pervasives.fst" in
    let uu____5579 = find_file filename in
...
let pervasives_basename: Prims.unit -> Prims.string =
  fun uu____5586  ->
    let uu____5587 = pervasives () in FStar_Util.basename uu____5587
let pervasives_native_basename: Prims.unit -> Prims.string =
  fun uu____5590  ->
    let filename = "FStar.Pervasives.Native.fst" in
    let uu____5592 = find_file filename in
...
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    let uu____5607 = get___temp_no_proj () in
    FStar_All.pipe_right uu____5607 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____5614  -> get_admit_smt_queries ()
let admit_except: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5619  -> get_admit_except ()
let cache_checked_modules: Prims.unit -> Prims.bool =
  fun uu____5622  -> get_cache_checked_modules ()
let codegen: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5627  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____5634  ->
    let uu____5635 = get_codegen_lib () in
    FStar_All.pipe_right uu____5635
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____5650  -> let uu____5651 = get_debug () in uu____5651 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      (let uu____5664 = get_debug () in
       FStar_All.pipe_right uu____5664 (FStar_List.contains modul)) &&
        (debug_level_geq level)
let dep: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5673  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____5676  -> get_detail_errors ()
let detail_hint_replay: Prims.unit -> Prims.bool =
  fun uu____5679  -> get_detail_hint_replay ()
let doc: Prims.unit -> Prims.bool = fun uu____5682  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____5686 = get_dump_module () in
    FStar_All.pipe_right uu____5686 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____5693  -> get_eager_inference ()
let expose_interfaces: Prims.unit -> Prims.bool =
  fun uu____5696  -> get_expose_interfaces ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____5700 = FStar_ST.op_Bang light_off_files in
    FStar_List.contains filename uu____5700
let gen_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5757  -> get_gen_native_tactics ()
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____5760  -> true
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____5763  -> get_hide_uvar_nums ()
let hint_info: Prims.unit -> Prims.bool =
  fun uu____5766  -> (get_hint_info ()) || (get_query_stats ())
let hint_file: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5771  -> get_hint_file ()
let ide: Prims.unit -> Prims.bool = fun uu____5774  -> get_ide ()
let indent: Prims.unit -> Prims.bool = fun uu____5777  -> get_indent ()
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____5780  ->
    let uu____5781 = get_initial_fuel () in
    let uu____5782 = get_max_fuel () in Prims.min uu____5781 uu____5782
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____5785  ->
    let uu____5786 = get_initial_ifuel () in
    let uu____5787 = get_max_ifuel () in Prims.min uu____5786 uu____5787
let interactive: Prims.unit -> Prims.bool =
  fun uu____5790  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____5793  -> get_lax ()
let load: Prims.unit -> Prims.string Prims.list =
  fun uu____5798  -> get_load ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____5801  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____5804  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____5807  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____5810  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____5813  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____5816  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____5819  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____5822  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____5825  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____5828  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____5832 = get_no_extract () in
    FStar_All.pipe_right uu____5832 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____5839  -> get_no_location_info ()
let output_dir: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5844  -> get_odir ()
let ugly: Prims.unit -> Prims.bool = fun uu____5847  -> get_ugly ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____5850  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____5853  -> get_print_effect_args ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____5856  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____5859  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____5862  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____5865  -> (get_print_z3_statistics ()) || (get_query_stats ())
let query_stats: Prims.unit -> Prims.bool =
  fun uu____5868  -> get_query_stats ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____5871  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____5876  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____5879  -> get_silent ()
let smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____5882  -> get_smtencoding_elim_box ()
let smtencoding_nl_arith_native: Prims.unit -> Prims.bool =
  fun uu____5885  ->
    let uu____5886 = get_smtencoding_nl_arith_repr () in
    uu____5886 = "native"
let smtencoding_nl_arith_wrapped: Prims.unit -> Prims.bool =
  fun uu____5889  ->
    let uu____5890 = get_smtencoding_nl_arith_repr () in
    uu____5890 = "wrapped"
let smtencoding_nl_arith_default: Prims.unit -> Prims.bool =
  fun uu____5893  ->
    let uu____5894 = get_smtencoding_nl_arith_repr () in
    uu____5894 = "boxwrap"
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____5897  ->
    let uu____5898 = get_smtencoding_l_arith_repr () in uu____5898 = "native"
let smtencoding_l_arith_default: Prims.unit -> Prims.bool =
  fun uu____5901  ->
    let uu____5902 = get_smtencoding_l_arith_repr () in
    uu____5902 = "boxwrap"
let split_cases: Prims.unit -> Prims.int =
  fun uu____5905  -> get_split_cases ()
let tactic_trace: Prims.unit -> Prims.bool =
  fun uu____5908  -> get_tactic_trace ()
let tactic_trace_d: Prims.unit -> Prims.int =
  fun uu____5911  -> get_tactic_trace_d ()
let timing: Prims.unit -> Prims.bool = fun uu____5914  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____5917  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____5920  -> get_unthrottle_inductives ()
let unsafe_tactic_exec: Prims.unit -> Prims.bool =
  fun uu____5923  -> get_unsafe_tactic_exec ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____5926  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____5929  -> get_use_hints ()
let use_hint_hashes: Prims.unit -> Prims.bool =
  fun uu____5932  -> get_use_hint_hashes ()
let use_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5937  -> get_use_native_tactics ()
let use_tactics: Prims.unit -> Prims.bool =
  fun uu____5940  -> get_use_tactics ()
let using_facts_from:
  ...
  fun uu____5949  ->
      ...
      then ([], true)
        ...
        then
          (let path =
             ...
             FStar_Ident.path_of_text uu____5978 in
           (path, false))
        else
          (let s1 =
             if FStar_Util.starts_with s "+"
    ...
    let uu____6014 = get_using_facts_from () in
    match uu____6014 with
    | FStar_Pervasives_Native.None  -> [([], true)]
    | FStar_Pervasives_Native.Some ns ->
        let uu____6046 = FStar_List.collect parse_setting ns in
        FStar_All.pipe_right uu____6046 FStar_List.rev
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____6085  -> get_warn_default_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____6088  ->
    let uu____6089 = get_smt () in
    match uu____6089 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____6097  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____6100  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____6103  -> get_z3rlimit ()
let z3_rlimit_factor: Prims.unit -> Prims.int =
  fun uu____6106  -> get_z3rlimit_factor ()
let z3_seed: Prims.unit -> Prims.int = fun uu____6109  -> get_z3seed ()
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____6112  -> get_no_positivity ()
let ml_no_eta_expand_coertions: Prims.unit -> Prims.bool =
  fun uu____6115  -> get_ml_no_eta_expand_coertions ()
let warn_error: Prims.unit -> Prims.string =
  fun uu____6118  -> get_warn_error ()
let default_warn_error: Prims.unit -> Prims.string =
  fun uu____6121  ->
    let d = FStar_Util.smap_of_list defaults in
    let uu____6125 = FStar_Util.smap_try_find d "warn_error" in
...
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    (let uu____6134 = no_extract m in Prims.op_Negation uu____6134) &&
      (let uu____6137 = get_extract_module () in
       match uu____6137 with
       | [] ->
           let uu____6140 = get_extract_namespace () in
...
let codegen_fsharp: Prims.unit -> Prims.bool =
  fun uu____6151  ->
    let uu____6152 = codegen () in
    uu____6152 = (FStar_Pervasives_Native.Some "FSharp")