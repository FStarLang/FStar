...
let (get_cache_checked_modules :Prims.unit -> Prims.bool)=
  fun uu____1055  -> lookup_opt "cache_checked_modules" as_bool
let (get_codegen :Prims.unit -> Prims.string FStar_Pervasives_Native.option)=
  fun uu____1061  -> lookup_opt "codegen" (as_option as_string)
let (get_codegen_lib :Prims.unit -> Prims.string Prims.list)=
  fun uu____1069  -> lookup_opt "codegen-lib" (as_list as_string)
...
let (get_print_effect_args :Prims.unit -> Prims.bool)=
  fun uu____1287  -> lookup_opt "print_effect_args" as_bool
let (get_print_full_names :Prims.unit -> Prims.bool)=
  fun uu____1291  -> lookup_opt "print_full_names" as_bool
let (get_print_implicits :Prims.unit -> Prims.bool)=
  fun uu____1295  -> lookup_opt "print_implicits" as_bool
let (get_print_universes :Prims.unit -> Prims.bool)=
  fun uu____1299  -> lookup_opt "print_universes" as_bool
let (get_print_z3_statistics :Prims.unit -> Prims.bool)=
  fun uu____1303  -> lookup_opt "print_z3_statistics" as_bool
let (get_prn :Prims.unit -> Prims.bool)=
  fun uu____1307  -> lookup_opt "prn" as_bool
let (get_query_stats :Prims.unit -> Prims.bool)=
  fun uu____1311  -> lookup_opt "query_stats" as_bool
let (get_record_hints :Prims.unit -> Prims.bool)=
  fun uu____1315  -> lookup_opt "record_hints" as_bool
let (get_reuse_hint_for
  :Prims.unit -> Prims.string FStar_Pervasives_Native.option)=
...
>>>>>>> taramana_pointers_with_codes_modifies
  fun uu____1569  ->
    let uu____1570 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____1571
        uu____1582 uu____1593 uu____1604 uu____1615
       in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____1774 =
                let uu____1775 = let uu____1780 = f ()  in (name, uu____1780)
                   in
                set_option' uu____1775  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x =
                let uu____1791 = let uu____1796 = f x  in (name, uu____1796)
                   in
  ...
  fun uu____1899  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "cache_checked_modules",
        (FStar_Getopt.ZeroArgs ((fun uu____1960  -> mk_bool true))),
...
=======
                let uu____1978 = parse_codegen s in mk_string uu____1978)),
>>>>>>> taramana_pointers_with_codes_modifies
...
<<<<<<< HEAD
                let uu____1982 =
                  let uu____1985 =
                    let uu____1988 = get_codegen_lib ()  in s :: uu____1988
                     in
                  FStar_All.pipe_right uu____1985 (FStar_List.map mk_string)
                   in
                List uu____1982)), "[namespace]")),
=======
                let uu____1996 =
                  let uu____1999 =
                    let uu____2002 = get_codegen_lib () in s :: uu____2002 in
                  FStar_All.pipe_right uu____1999 (FStar_List.map mk_string) in
                List uu____1996)), "[namespace]")),
>>>>>>> taramana_pointers_with_codes_modifies
...
<<<<<<< HEAD
                let uu____2012 =
                  ...
                  FStar_All.pipe_right uu____2015 (FStar_List.map mk_string)
                   in
                List uu____2012)), "[module name]")),
=======
                let uu____2026 =
                  let uu____2029 =
                    let uu____2032 = get_debug () in x :: uu____2032 in
                  FStar_All.pipe_right uu____2029 (FStar_List.map mk_string) in
                List uu____2026)), "[module name]")),
>>>>>>> taramana_pointers_with_codes_modifies
...
<<<<<<< HEAD
                let uu____2042 =
                  let uu____2045 =
                    let uu____2048 = get_debug_level ()  in x :: uu____2048
                     in
                  FStar_All.pipe_right uu____2045 (FStar_List.map mk_string)
                   in
                List uu____2042)), "[Low|Medium|High|Extreme|...]")),
=======
                let uu____2056 =
                  let uu____2059 =
                    let uu____2062 = get_debug_level () in x :: uu____2062 in
                  FStar_All.pipe_right uu____2059 (FStar_List.map mk_string) in
                List uu____2056)), "[Low|Medium|High|Extreme|...]")),
>>>>>>> taramana_pointers_with_codes_modifies
      ...
      (FStar_Getopt.noshort, "doc",
        (FStar_Getopt.ZeroArgs ((fun uu____2127  -> mk_bool true))),
...
<<<<<<< HEAD
                let uu____2131 =
                  let uu____2134 =
                    let uu____2137 = get_dump_module ()  in x :: uu____2137
                     in
                  FStar_All.pipe_right uu____2134 (FStar_List.map mk_string)
                   in
                FStar_All.pipe_right uu____2131 mk_list)), "[module name]")),
=======
                let uu____2145 =
                  let uu____2148 =
                    let uu____2151 = get_dump_module () in x :: uu____2151 in
                  FStar_All.pipe_right uu____2148 (FStar_List.map mk_string) in
                FStar_All.pipe_right uu____2145 mk_list)), "[module name]")),
>>>>>>> taramana_pointers_with_codes_modifies
        "");
      ...
      (FStar_Getopt.noshort, "extract_all",
        (FStar_Getopt.ZeroArgs ((fun uu____2201  -> mk_bool true))),
      ...
      (FStar_Getopt.noshort, "ide",
        (FStar_Getopt.ZeroArgs ((fun uu____2327  -> mk_bool true))),
...
<<<<<<< HEAD
                let uu____2331 =
                  ...
                  let uu____2340 =
                    let uu____2343 = mk_path s  in [uu____2343]  in
                  FStar_List.append uu____2334 uu____2340  in
                mk_list uu____2331)), "[path]")),
=======
                let uu____2345 =
                  let uu____2348 =
                    let uu____2351 = get_include () in
                    FStar_List.map mk_string uu____2351 in
                  let uu____2354 = let uu____2357 = mk_path s in [uu____2357] in
                  FStar_List.append uu____2348 uu____2354 in
                mk_list uu____2345)), "[path]")),
>>>>>>> taramana_pointers_with_codes_modifies
...
=======
                let uu____2389 = FStar_Util.int_of_string x in
                mk_int uu____2389)), "[non-negative integer]")),
>>>>>>> taramana_pointers_with_codes_modifies
...
=======
                let uu____2407 = FStar_Util.int_of_string x in
                mk_int uu____2407)), "[non-negative integer]")),
>>>>>>> taramana_pointers_with_codes_modifies
      ...
      (FStar_Getopt.noshort, "lax",
        (FStar_Getopt.ZeroArgs ((fun uu____2435  -> mk_bool true))),
...
<<<<<<< HEAD
                let uu____2439 =
                  ...
                  let uu____2448 =
                    let uu____2451 = mk_path s  in [uu____2451]  in
                  FStar_List.append uu____2442 uu____2448  in
                mk_list uu____2439)), "[module]")), "Load compiled module");
=======
                let uu____2453 =
                  let uu____2456 =
                    let uu____2459 = get_load () in
                    FStar_List.map mk_string uu____2459 in
                  let uu____2462 = let uu____2465 = mk_path s in [uu____2465] in
                  FStar_List.append uu____2456 uu____2462 in
                mk_list uu____2453)), "[module]")), "Load compiled module");
>>>>>>> taramana_pointers_with_codes_modifies
...
=======
                let uu____2511 = FStar_Util.int_of_string x in
                mk_int uu____2511)), "[non-negative integer]")),
>>>>>>> taramana_pointers_with_codes_modifies
...
=======
                let uu____2529 = FStar_Util.int_of_string x in
                mk_int uu____2529)), "[non-negative integer]")),
>>>>>>> taramana_pointers_with_codes_modifies
...
=======
                let uu____2547 = FStar_Util.int_of_string x in
                mk_int uu____2547)), "[non-negative integer]")),
>>>>>>> taramana_pointers_with_codes_modifies
        "Minimum number of unrolling of recursive functions to try (default 1)");
      (FStar_Getopt.noshort, "MLish",
        (FStar_Getopt.ZeroArgs ((fun uu____2561  -> mk_bool true))),
...
=======
                let uu____2579 = FStar_Util.int_of_string x in
                mk_int uu____2579)), "[positive integer]")),
>>>>>>> taramana_pointers_with_codes_modifies
        "Maximum number of cores to use for the solver (implies detail_errors = false) (default 1)");
      (FStar_Getopt.noshort, "no_default_includes",
        (FStar_Getopt.ZeroArgs ((fun uu____2593  -> mk_bool true))),
...
<<<<<<< HEAD
                let uu____2597 =
                  let uu____2600 =
                    let uu____2603 = get_no_extract ()  in x :: uu____2603
                     in
                  FStar_All.pipe_right uu____2600 (FStar_List.map mk_string)
                   in
                mk_list uu____2597)), "[module name]")),
=======
                let uu____2611 =
                  let uu____2614 =
                    let uu____2617 = get_no_extract () in x :: uu____2617 in
                  FStar_All.pipe_right uu____2614 (FStar_List.map mk_string) in
                mk_list uu____2611)), "[module name]")),
>>>>>>> taramana_pointers_with_codes_modifies
        "Do not extract code from this module");
      (FStar_Getopt.noshort, "no_location_info",
        (FStar_Getopt.ZeroArgs ((fun uu____2637  -> mk_bool true))),
        "Suppress location information in the generated OCaml output (only relevant with --codegen OCaml)");
      (FStar_Getopt.noshort, "odir",
        (FStar_Getopt.OneArg
<<<<<<< HEAD
           (((fun p  ->
                let uu____2641 = validate_dir p  in mk_path uu____2641)),
=======
           (((fun p  -> let uu____2655 = validate_dir p in mk_path uu____2655)),
>>>>>>> taramana_pointers_with_codes_modifies
                ...
                let uu____2827 =
                  let uu____2830 =
                    let uu____2833 = get_show_signatures ()  in x ::
                      uu____2833
                     in
                  FStar_All.pipe_right uu____2830 (FStar_List.map mk_string)
                   in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____3085 =
                  let uu____3088 =
                    let uu____3091 = get___temp_no_proj ()  in x ::
                      uu____3091
                     in
                  FStar_All.pipe_right uu____3088 (FStar_List.map mk_string)
                   in
        ...
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____3145 =
                  ...
                  FStar_All.pipe_right uu____3148 (FStar_List.map mk_string)
                   in
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____3657
        (fun i  ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____3663)
       in
    let uu____3705 =
      let uu____3708 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____3708
       in
    (res, uu____3705)
<<<<<<< HEAD
  ...
  fun f  ->
    ...
    let f2 =
      let uu____3786 =
        let uu____3787 =
          let uu____3788 =
            let uu____3789 = FStar_Util.get_file_extension f1 in
            FStar_String.length uu____3789 in
          (FStar_String.length f1) - uu____3788 in
        uu____3787 - (Prims.parse_int "1") in
      FStar_String.substring f1 (Prims.parse_int "0") uu____3786 in
    FStar_String.lowercase f2
let (should_verify :Prims.string -> Prims.bool)=
  fun m  ->
    let uu____3794 = get_lax () in
    if uu____3794
    then false
    else
      (let uu____3796 = get_verify_all () in
       if uu____3796
       then true
       else
         (let uu____3798 = get_verify_module () in
          match uu____3798 with
          | [] ->
              let uu____3801 = file_list () in
              FStar_List.existsML
                (fun f  ->
                   let uu____3807 = module_name_of_file_name f in
                   uu____3807 = m) uu____3801
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
let (should_verify_file :Prims.string -> Prims.bool)=
  fun fn  ->
    let uu____3815 = module_name_of_file_name fn in should_verify uu____3815
let (dont_gen_projectors :Prims.string -> Prims.bool)=
  fun m  ->
    let uu____3820 = get___temp_no_proj () in
    FStar_List.contains m uu____3820
let (should_print_message :Prims.string -> Prims.bool)=
  fun m  ->
    let uu____3827 = should_verify m in
    if uu____3827 then m <> "Prims" else false
let (include_path :Prims.unit -> Prims.string Prims.list)=
  fun uu____3834  ->
    let uu____3835 = get_no_default_includes () in
    if uu____3835
    then get_include ()
    else
      (let h = fstar_home () in
       ...
       let uu____3859 =
         let uu____3862 = get_include () in
         FStar_List.append uu____3862 ["."] in
       FStar_List.append uu____3843 uu____3859)
let (find_file :Prims.string -> Prims.string FStar_Pervasives_Native.option)=
  fun filename  ->
    let uu____3871 = FStar_Util.is_path_absolute filename in
    if uu____3871
>>>>>>> taramana_pointers_with_codes_modifies
    then
...
=======
      (let uu____3878 =
         let uu____3881 = include_path () in FStar_List.rev uu____3881 in
       FStar_Util.find_map uu____3878
>>>>>>> taramana_pointers_with_codes_modifies
         (fun p  ->
...
let (prims :Prims.unit -> Prims.string)=
  fun uu____3894  ->
    let uu____3895 = get_prims () in
    match uu____3895 with
    | FStar_Pervasives_Native.None  ->
        let filename = "prims.fst" in
        let uu____3899 = find_file filename in
...
=======
                   filename in
               FStar_Util.Failure uu____3904 in
             FStar_Exn.raise uu____3903)
    | FStar_Pervasives_Native.Some x -> x
let (prims_basename :Prims.unit -> Prims.string)=
  fun uu____3909  ->
    let uu____3910 = prims () in FStar_Util.basename uu____3910
let (pervasives :Prims.unit -> Prims.string)=
  fun uu____3914  ->
    let filename = "FStar.Pervasives.fst" in
    let uu____3916 = find_file filename in
...
=======
              filename in
          FStar_Util.Failure uu____3921 in
        FStar_Exn.raise uu____3920
let (pervasives_basename :Prims.unit -> Prims.string)=
  fun uu____3925  ->
    let uu____3926 = pervasives () in FStar_Util.basename uu____3926
let (pervasives_native_basename :Prims.unit -> Prims.string)=
  fun uu____3930  ->
    let filename = "FStar.Pervasives.Native.fst" in
    let uu____3932 = find_file filename in
...
let smtencoding_l_arith_native : Prims.unit -> Prims.bool =
  fun uu____4258  ->
    let uu____4259 = get_smtencoding_l_arith_repr ()  in
    uu____4259 = "native"
...
=======
              filename in
          FStar_Util.Failure uu____3937 in
        FStar_Exn.raise uu____3936
let (prepend_output_dir :Prims.string -> Prims.string)=
  fun fname  ->
    let uu____3942 = get_odir () in
...
let (__temp_no_proj :Prims.string -> Prims.bool)=
  fun s  ->
    let uu____3950 = get___temp_no_proj () in
    FStar_All.pipe_right uu____3950 (FStar_List.contains s)
let (admit_smt_queries :Prims.unit -> Prims.bool)=
  fun uu____3958  -> get_admit_smt_queries ()
let (admit_except
  :Prims.unit -> Prims.string FStar_Pervasives_Native.option)=
  fun uu____3964  -> get_admit_except ()
let (cache_checked_modules :Prims.unit -> Prims.bool)=
  fun uu____3968  -> get_cache_checked_modules ()
let (codegen :Prims.unit -> Prims.string FStar_Pervasives_Native.option)=
  fun uu____3974  -> get_codegen ()
let (codegen_libs :Prims.unit -> Prims.string Prims.list Prims.list)=
  fun uu____3982  ->
    let uu____3983 = get_codegen_lib () in
    FStar_All.pipe_right uu____3983
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let (debug_any :Prims.unit -> Prims.bool)=
  fun uu____3999  -> let uu____4000 = get_debug () in uu____4000 <> []
let (debug_at_level :Prims.string -> debug_level_t -> Prims.bool)=
  fun modul  ->
    fun level  ->
      (let uu____4015 = get_debug () in
       FStar_All.pipe_right uu____4015 (FStar_List.contains modul)) &&
        (debug_level_geq level)
let (dep :Prims.unit -> Prims.string FStar_Pervasives_Native.option)=
  fun uu____4025  -> get_dep ()
let (detail_errors :Prims.unit -> Prims.bool)=
  fun uu____4029  -> get_detail_errors ()
let (detail_hint_replay :Prims.unit -> Prims.bool)=
  fun uu____4033  -> get_detail_hint_replay ()
let (doc :Prims.unit -> Prims.bool)= fun uu____4037  -> get_doc ()
let (dump_module :Prims.string -> Prims.bool)=
  fun s  ->
    let uu____4042 = get_dump_module () in
    FStar_All.pipe_right uu____4042 (FStar_List.contains s)
let (eager_inference :Prims.unit -> Prims.bool)=
  fun uu____4050  -> get_eager_inference ()
let (explicit_deps :Prims.unit -> Prims.bool)=
  fun uu____4054  -> get_explicit_deps ()
let (extract_all :Prims.unit -> Prims.bool)=
  fun uu____4058  -> get_extract_all ()
let (fs_typ_app :Prims.string -> Prims.bool)=
  fun filename  ->
    let uu____4063 = FStar_ST.op_Bang light_off_files in
    FStar_List.contains filename uu____4063
let (full_context_dependency :Prims.unit -> Prims.bool)=
  fun uu____4087  -> true
let (hide_genident_nums :Prims.unit -> Prims.bool)=
  fun uu____4091  -> get_hide_genident_nums ()
let (hide_uvar_nums :Prims.unit -> Prims.bool)=
  fun uu____4095  -> get_hide_uvar_nums ()
let (hint_info :Prims.unit -> Prims.bool)=
  fun uu____4099  -> (get_hint_info ()) || (get_query_stats ())
let (hint_file :Prims.unit -> Prims.string FStar_Pervasives_Native.option)=
  fun uu____4105  -> get_hint_file ()
let (ide :Prims.unit -> Prims.bool)= fun uu____4109  -> get_ide ()
let (indent :Prims.unit -> Prims.bool)= fun uu____4113  -> get_indent ()
let (initial_fuel :Prims.unit -> Prims.int)=
  fun uu____4117  ->
    let uu____4118 = get_initial_fuel () in
    let uu____4119 = get_max_fuel () in Prims.min uu____4118 uu____4119
let (initial_ifuel :Prims.unit -> Prims.int)=
  fun uu____4123  ->
    let uu____4124 = get_initial_ifuel () in
    let uu____4125 = get_max_ifuel () in Prims.min uu____4124 uu____4125
let (interactive :Prims.unit -> Prims.bool)=
  fun uu____4129  -> (get_in ()) || (get_ide ())
let (lax :Prims.unit -> Prims.bool)= fun uu____4133  -> get_lax ()
let (load :Prims.unit -> Prims.string Prims.list)=
  fun uu____4139  -> get_load ()
let (legacy_interactive :Prims.unit -> Prims.bool)=
  fun uu____4143  -> get_in ()
let (log_queries :Prims.unit -> Prims.bool)=
  fun uu____4147  -> get_log_queries ()
let (log_types :Prims.unit -> Prims.bool)=
  fun uu____4151  -> get_log_types ()
...
let (set_ml_ish :Prims.unit -> Prims.unit)=
  fun uu____4171  -> set_option "MLish" (Bool true)
let (n_cores :Prims.unit -> Prims.int)= fun uu____4175  -> get_n_cores ()
let (no_default_includes :Prims.unit -> Prims.bool)=
  fun uu____4179  -> get_no_default_includes ()
let (no_extract :Prims.string -> Prims.bool)=
  fun s  ->
    let uu____4184 = get_no_extract () in
    FStar_All.pipe_right uu____4184 (FStar_List.contains s)
let (no_location_info :Prims.unit -> Prims.bool)=
  fun uu____4192  -> get_no_location_info ()
let (output_dir :Prims.unit -> Prims.string FStar_Pervasives_Native.option)=
  fun uu____4198  -> get_odir ()
let (ugly :Prims.unit -> Prims.bool)= fun uu____4202  -> get_ugly ()
let (print_bound_var_types :Prims.unit -> Prims.bool)=
  fun uu____4206  -> get_print_bound_var_types ()
let (print_effect_args :Prims.unit -> Prims.bool)=
  fun uu____4210  -> get_print_effect_args ()
let (print_implicits :Prims.unit -> Prims.bool)=
  fun uu____4214  -> get_print_implicits ()
let (print_real_names :Prims.unit -> Prims.bool)=
  fun uu____4218  -> (get_prn ()) || (get_print_full_names ())
let (print_universes :Prims.unit -> Prims.bool)=
  fun uu____4222  -> get_print_universes ()
let (print_z3_statistics :Prims.unit -> Prims.bool)=
  fun uu____4226  -> (get_print_z3_statistics ()) || (get_query_stats ())
let (query_stats :Prims.unit -> Prims.bool)=
  fun uu____4230  -> get_query_stats ()
let (record_hints :Prims.unit -> Prims.bool)=
  fun uu____4234  -> get_record_hints ()
let (reuse_hint_for
  :Prims.unit -> Prims.string FStar_Pervasives_Native.option)=
  fun uu____4240  -> get_reuse_hint_for ()
let (silent :Prims.unit -> Prims.bool)= fun uu____4244  -> get_silent ()
let (smtencoding_elim_box :Prims.unit -> Prims.bool)=
  fun uu____4248  -> get_smtencoding_elim_box ()
let (smtencoding_nl_arith_native :Prims.unit -> Prims.bool)=
  fun uu____4252  ->
    let uu____4253 = get_smtencoding_nl_arith_repr () in
    uu____4253 = "native"
let (smtencoding_nl_arith_wrapped :Prims.unit -> Prims.bool)=
  fun uu____4257  ->
    let uu____4258 = get_smtencoding_nl_arith_repr () in
    uu____4258 = "wrapped"
let (smtencoding_nl_arith_default :Prims.unit -> Prims.bool)=
  fun uu____4262  ->
    let uu____4263 = get_smtencoding_nl_arith_repr () in
    uu____4263 = "boxwrap"
let (smtencoding_l_arith_native :Prims.unit -> Prims.bool)=
  fun uu____4267  ->
    let uu____4268 = get_smtencoding_l_arith_repr () in uu____4268 = "native"
let (smtencoding_l_arith_default :Prims.unit -> Prims.bool)=
  fun uu____4272  ->
    let uu____4273 = get_smtencoding_l_arith_repr () in
    uu____4273 = "boxwrap"
let (split_cases :Prims.unit -> Prims.int)=
  fun uu____4277  -> get_split_cases ()
let (timing :Prims.unit -> Prims.bool)= fun uu____4281  -> get_timing ()
let (trace_error :Prims.unit -> Prims.bool)=
  fun uu____4285  -> get_trace_error ()
let (unthrottle_inductives :Prims.unit -> Prims.bool)=
  fun uu____4289  -> get_unthrottle_inductives ()
let (use_eq_at_higher_order :Prims.unit -> Prims.bool)=
  fun uu____4293  -> get_use_eq_at_higher_order ()
let (use_hints :Prims.unit -> Prims.bool)=
  fun uu____4297  -> get_use_hints ()
let (use_tactics :Prims.unit -> Prims.bool)=
  fun uu____4301  -> get_use_tactics ()
let (using_facts_from
  :Prims.unit -> Prims.string Prims.list FStar_Pervasives_Native.option)=
  fun uu____4309  -> get_using_facts_from ()
let (verify_all :Prims.unit -> Prims.bool)=
  fun uu____4313  -> get_verify_all ()
let (verify_module :Prims.unit -> Prims.string Prims.list)=
  fun uu____4319  -> get_verify_module ()
let (warn_default_effects :Prims.unit -> Prims.bool)=
  fun uu____4323  -> get_warn_default_effects ()
let (z3_exe :Prims.unit -> Prims.string)=
  fun uu____4327  ->
    let uu____4328 = get_smt () in
    match uu____4328 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
let (z3_cliopt :Prims.unit -> Prims.string Prims.list)=
  fun uu____4337  -> get_z3cliopt ()
let (z3_refresh :Prims.unit -> Prims.bool)=
  fun uu____4341  -> get_z3refresh ()
let (z3_rlimit :Prims.unit -> Prims.int)= fun uu____4345  -> get_z3rlimit ()
let (z3_rlimit_factor :Prims.unit -> Prims.int)=
  fun uu____4349  -> get_z3rlimit_factor ()
let (z3_seed :Prims.unit -> Prims.int)= fun uu____4353  -> get_z3seed ()
let (no_positivity :Prims.unit -> Prims.bool)=
  fun uu____4357  -> get_no_positivity ()
let (ml_no_eta_expand_coertions :Prims.unit -> Prims.bool)=
  fun uu____4361  -> get_ml_no_eta_expand_coertions ()
let (should_extract :Prims.string -> Prims.bool)=
  fun m  ->
    (let uu____4368 = no_extract m in Prims.op_Negation uu____4368) &&
      ((extract_all ()) ||
         (let uu____4371 = get_extract_module () in
          match uu____4371 with
          | [] ->
              let uu____4374 = get_extract_namespace () in
