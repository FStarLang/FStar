  ...
  fun filename  ->
    ...
    | FStar_Pervasives_Native.None  ->
        let result =
          ...
          with | uu___35_10198 -> FStar_Pervasives_Native.None  in
        (match result with
       ...
       (let r =
          try
            (fun uu___38_11868  ->
              ...
              ()
          with | uu___37_11875 -> FStar_Util.Inl uu___37_11875  in
        pop ();
        (match r with
