...
(let _116_507 = (let _116_505 = (include_path ())
in (FStar_List.rev _116_505))
in (FStar_Util.find_map _116_507 (fun p -> (
...
let __temp_no_proj : Prims.string  ->  Prims.bool = (fun s -> (let _116_516 = (get___temp_no_proj ())
in (FStar_All.pipe_right _116_516 (FStar_List.contains s))))
...
| () -> begin
(let _116_526 = (get_codegen_lib ())
in (FStar_All.pipe_right _116_526 (FStar_List.map (fun x -> (FStar_Util.split x ".")))))
end))
...
let dump_module : Prims.string  ->  Prims.bool = (fun s -> (let _116_540 = (get_dump_module ())
in (FStar_All.pipe_right _116_540 (FStar_List.contains s))))
...
let no_extract : Prims.string  ->  Prims.bool = (fun s -> (let _116_585 = (get_no_extract ())
in (FStar_All.pipe_right _116_585 (FStar_List.contains s))))
