...
let (parse_warn_error_set_get :
  ...
  let set1 f =
    let uu____2288 = FStar_ST.op_Bang r  in
    match uu____2288 with
    | FStar_Pervasives_Native.None  ->
        FStar_ST.op_Colon_Equals r (FStar_Pervasives_Native.Some f)
    | uu____2379 -> failwith "Multiple initialization of FStar.Options"  in
  let get1 uu____2400 =
    let uu____2401 = FStar_ST.op_Bang r  in
...
let (parse_warn_error : Prims.string -> error_flag Prims.list) =
  fun s  ->
    let uu____2540 = FStar_Pervasives_Native.snd parse_warn_error_set_get ()
       in
    uu____2540 s
...
let (get_option : Prims.string -> option_val) =
  fun s  ->
    let uu____2664 =
      let uu____2667 = internal_peek ()  in
      FStar_Util.smap_try_find uu____2667 s  in
    match uu____2664 with
    | FStar_Pervasives_Native.None  ->
        let uu____2670 =
          let uu____2672 = FStar_String.op_Hat s " not found"  in
          FStar_String.op_Hat "Impossible: option " uu____2672  in
        failwith uu____2670
    | FStar_Pervasives_Native.Some s1 -> s1
  
let lookup_opt :
  'Auu____2684 . Prims.string -> (option_val -> 'Auu____2684) -> 'Auu____2684
  = fun s  -> fun c  -> let uu____2702 = get_option s  in c uu____2702 
let (get_abort_on : unit -> Prims.int) =
  fun uu____2709  -> lookup_opt "abort_on" as_int 
let (get_admit_smt_queries : unit -> Prims.bool) =
  fun uu____2718  -> lookup_opt "admit_smt_queries" as_bool 
let (get_admit_except : unit -> Prims.string FStar_Pervasives_Native.option)
  = fun uu____2729  -> lookup_opt "admit_except" (as_option as_string) 
...
let (get_cache_checked_modules : unit -> Prims.bool) =
  fun uu____2762  -> lookup_opt "cache_checked_modules" as_bool 
let (get_cache_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____2773  -> lookup_opt "cache_dir" (as_option as_string) 
let (get_cache_off : unit -> Prims.bool) =
  fun uu____2785  -> lookup_opt "cache_off" as_bool 
let (get_cmi : unit -> Prims.bool) =
  fun uu____2794  -> lookup_opt "cmi" as_bool 
let (get_codegen : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____2805  -> lookup_opt "codegen" (as_option as_string) 
let (get_codegen_lib : unit -> Prims.string Prims.list) =
  fun uu____2819  -> lookup_opt "codegen-lib" (as_list as_string) 
let (get_debug : unit -> Prims.string Prims.list) =
  fun uu____2833  -> lookup_opt "debug" (as_list as_string) 
let (get_debug_level : unit -> Prims.string Prims.list) =
  fun uu____2847  -> lookup_opt "debug_level" as_comma_string_list 
let (get_defensive : unit -> Prims.string) =
  fun uu____2858  -> lookup_opt "defensive" as_string 
let (get_dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____2869  -> lookup_opt "dep" (as_option as_string) 
let (get_detail_errors : unit -> Prims.bool) =
  fun uu____2881  -> lookup_opt "detail_errors" as_bool 
let (get_detail_hint_replay : unit -> Prims.bool) =
  fun uu____2890  -> lookup_opt "detail_hint_replay" as_bool 
let (get_doc : unit -> Prims.bool) =
  fun uu____2899  -> lookup_opt "doc" as_bool 
let (get_dump_module : unit -> Prims.string Prims.list) =
  fun uu____2910  -> lookup_opt "dump_module" (as_list as_string) 
let (get_eager_subtyping : unit -> Prims.bool) =
  fun uu____2922  -> lookup_opt "eager_subtyping" as_bool 
let (get_expose_interfaces : unit -> Prims.bool) =
  fun uu____2931  -> lookup_opt "expose_interfaces" as_bool 
let (get_extract :
  unit -> Prims.string Prims.list FStar_Pervasives_Native.option) =
  fun uu____2944  -> lookup_opt "extract" (as_option (as_list as_string)) 
let (get_extract_module : unit -> Prims.string Prims.list) =
  fun uu____2963  -> lookup_opt "extract_module" (as_list as_string) 
let (get_extract_namespace : unit -> Prims.string Prims.list) =
  fun uu____2977  -> lookup_opt "extract_namespace" (as_list as_string) 
let (get_fs_typ_app : unit -> Prims.bool) =
  fun uu____2989  -> lookup_opt "fs_typ_app" as_bool 
let (get_hide_uvar_nums : unit -> Prims.bool) =
  fun uu____2998  -> lookup_opt "hide_uvar_nums" as_bool 
let (get_hint_info : unit -> Prims.bool) =
  fun uu____3007  -> lookup_opt "hint_info" as_bool 
let (get_hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3018  -> lookup_opt "hint_dir" (as_option as_string) 
...
let (get_lsp : unit -> Prims.bool) =
  fun uu____3062  -> lookup_opt "lsp" as_bool 
let (get_include : unit -> Prims.string Prims.list) =
  fun uu____3073  -> lookup_opt "include" (as_list as_string) 
let (get_print : unit -> Prims.bool) =
  fun uu____3085  -> lookup_opt "print" as_bool 
let (get_print_in_place : unit -> Prims.bool) =
  fun uu____3094  -> lookup_opt "print_in_place" as_bool 
...
let (get_no_default_includes : unit -> Prims.bool) =
  fun uu____3207  -> lookup_opt "no_default_includes" as_bool 
let (get_no_extract : unit -> Prims.string Prims.list) =
  fun uu____3218  -> lookup_opt "no_extract" (as_list as_string) 
let (get_no_location_info : unit -> Prims.bool) =
  fun uu____3230  -> lookup_opt "no_location_info" as_bool 
let (get_no_plugins : unit -> Prims.bool) =
  fun uu____3239  -> lookup_opt "no_plugins" as_bool 
let (get_no_smt : unit -> Prims.bool) =
  fun uu____3248  -> lookup_opt "no_smt" as_bool 
let (get_normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____3257  -> lookup_opt "normalize_pure_terms_for_extraction" as_bool 
let (get_odir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3268  -> lookup_opt "odir" (as_option as_string) 
let (get_ugly : unit -> Prims.bool) =
  fun uu____3280  -> lookup_opt "ugly" as_bool 
let (get_prims : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3291  -> lookup_opt "prims" (as_option as_string) 
let (get_print_bound_var_types : unit -> Prims.bool) =
  fun uu____3303  -> lookup_opt "print_bound_var_types" as_bool 
let (get_print_effect_args : unit -> Prims.bool) =
  fun uu____3312  -> lookup_opt "print_effect_args" as_bool 
let (get_print_full_names : unit -> Prims.bool) =
  fun uu____3321  -> lookup_opt "print_full_names" as_bool 
let (get_print_implicits : unit -> Prims.bool) =
  fun uu____3330  -> lookup_opt "print_implicits" as_bool 
let (get_print_universes : unit -> Prims.bool) =
  fun uu____3339  -> lookup_opt "print_universes" as_bool 
let (get_print_z3_statistics : unit -> Prims.bool) =
  fun uu____3348  -> lookup_opt "print_z3_statistics" as_bool 
let (get_prn : unit -> Prims.bool) =
  fun uu____3357  -> lookup_opt "prn" as_bool 
let (get_quake_lo : unit -> Prims.int) =
  fun uu____3366  -> lookup_opt "quake_lo" as_int 
let (get_quake_hi : unit -> Prims.int) =
  fun uu____3375  -> lookup_opt "quake_hi" as_int 
let (get_query_stats : unit -> Prims.bool) =
  fun uu____3384  -> lookup_opt "query_stats" as_bool 
let (get_record_hints : unit -> Prims.bool) =
  fun uu____3393  -> lookup_opt "record_hints" as_bool 
let (get_record_options : unit -> Prims.bool) =
  fun uu____3402  -> lookup_opt "record_options" as_bool 
let (get_reuse_hint_for :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3413  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let (get_silent : unit -> Prims.bool) =
  fun uu____3425  -> lookup_opt "silent" as_bool 
let (get_smt : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3436  -> lookup_opt "smt" (as_option as_string) 
let (get_smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____3448  -> lookup_opt "smtencoding.elim_box" as_bool 
let (get_smtencoding_nl_arith_repr : unit -> Prims.string) =
  fun uu____3457  -> lookup_opt "smtencoding.nl_arith_repr" as_string 
let (get_smtencoding_l_arith_repr : unit -> Prims.string) =
  fun uu____3466  -> lookup_opt "smtencoding.l_arith_repr" as_string 
let (get_smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____3475  -> lookup_opt "smtencoding.valid_intro" as_bool 
let (get_smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____3484  -> lookup_opt "smtencoding.valid_elim" as_bool 
let (get_tactic_raw_binders : unit -> Prims.bool) =
  fun uu____3493  -> lookup_opt "tactic_raw_binders" as_bool 
let (get_tactics_failhard : unit -> Prims.bool) =
  fun uu____3502  -> lookup_opt "tactics_failhard" as_bool 
let (get_tactics_info : unit -> Prims.bool) =
  fun uu____3511  -> lookup_opt "tactics_info" as_bool 
let (get_tactic_trace : unit -> Prims.bool) =
  fun uu____3520  -> lookup_opt "tactic_trace" as_bool 
let (get_tactic_trace_d : unit -> Prims.int) =
  fun uu____3529  -> lookup_opt "tactic_trace_d" as_int 
let (get_tactics_nbe : unit -> Prims.bool) =
  fun uu____3538  -> lookup_opt "__tactics_nbe" as_bool 
let (get_tcnorm : unit -> Prims.bool) =
  fun uu____3547  -> lookup_opt "tcnorm" as_bool 
let (get_timing : unit -> Prims.bool) =
  fun uu____3556  -> lookup_opt "timing" as_bool 
let (get_trace_error : unit -> Prims.bool) =
  fun uu____3565  -> lookup_opt "trace_error" as_bool 
let (get_unthrottle_inductives : unit -> Prims.bool) =
  fun uu____3574  -> lookup_opt "unthrottle_inductives" as_bool 
let (get_unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____3583  -> lookup_opt "unsafe_tactic_exec" as_bool 
let (get_use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____3592  -> lookup_opt "use_eq_at_higher_order" as_bool 
let (get_use_hints : unit -> Prims.bool) =
  fun uu____3601  -> lookup_opt "use_hints" as_bool 
let (get_use_hint_hashes : unit -> Prims.bool) =
  fun uu____3610  -> lookup_opt "use_hint_hashes" as_bool 
let (get_use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3621  -> lookup_opt "use_native_tactics" (as_option as_string) 
let (get_use_tactics : unit -> Prims.bool) =
  fun uu____3633  ->
    let uu____3634 = lookup_opt "no_tactics" as_bool  in
...
let (get_verify_module : unit -> Prims.string Prims.list) =
  fun uu____3681  -> lookup_opt "verify_module" (as_list as_string) 
let (get___temp_no_proj : unit -> Prims.string Prims.list) =
  fun uu____3695  -> lookup_opt "__temp_no_proj" (as_list as_string) 
let (get_version : unit -> Prims.bool) =
  fun uu____3707  -> lookup_opt "version" as_bool 
let (get_warn_default_effects : unit -> Prims.bool) =
  fun uu____3716  -> lookup_opt "warn_default_effects" as_bool 
let (get_z3cliopt : unit -> Prims.string Prims.list) =
  fun uu____3727  -> lookup_opt "z3cliopt" (as_list as_string) 
let (get_z3refresh : unit -> Prims.bool) =
  fun uu____3739  -> lookup_opt "z3refresh" as_bool 
let (get_z3rlimit : unit -> Prims.int) =
  fun uu____3748  -> lookup_opt "z3rlimit" as_int 
let (get_z3rlimit_factor : unit -> Prims.int) =
  fun uu____3757  -> lookup_opt "z3rlimit_factor" as_int 
let (get_z3seed : unit -> Prims.int) =
  fun uu____3766  -> lookup_opt "z3seed" as_int 
let (get_use_two_phase_tc : unit -> Prims.bool) =
  fun uu____3775  -> lookup_opt "use_two_phase_tc" as_bool 
let (get_no_positivity : unit -> Prims.bool) =
  fun uu____3784  -> lookup_opt "__no_positivity" as_bool 
let (get_ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____3793  -> lookup_opt "__ml_no_eta_expand_coertions" as_bool 
let (get_warn_error : unit -> Prims.string Prims.list) =
  fun uu____3804  -> lookup_opt "warn_error" (as_list as_string) 
let (get_use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____3816  -> lookup_opt "use_extracted_interfaces" as_bool 
let (get_use_nbe : unit -> Prims.bool) =
  fun uu____3825  -> lookup_opt "use_nbe" as_bool 
...
let (get_profile :
  unit -> Prims.string Prims.list FStar_Pervasives_Native.option) =
  fun uu____3847  -> lookup_opt "profile" (as_option (as_list as_string)) 
let (get_profile_group_by_decl : unit -> Prims.bool) =
  fun uu____3864  -> lookup_opt "profile_group_by_decl" as_bool 
...
let (debug_level_geq : debug_level_t -> Prims.bool) =
  fun l2  ->
    let uu____3924 = get_debug_level ()  in
       ...
       (fun d  ->
          let uu____3968 =
            FStar_All.pipe_right sub_dirs
              (FStar_List.map
                 (fun s  ->
                    let uu____3984 = FStar_String.op_Hat "/" s  in
                    FStar_String.op_Hat d uu____3984))
             in
          d :: uu____3968))
...
let (display_version : unit -> unit) =
  fun uu____4023  ->
    let uu____4024 =
      let uu____4026 = FStar_ST.op_Bang _version  in
      let uu____4049 = FStar_ST.op_Bang _platform  in
      let uu____4072 = FStar_ST.op_Bang _compiler  in
      let uu____4095 = FStar_ST.op_Bang _date  in
      let uu____4118 = FStar_ST.op_Bang _commit  in
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____4026
        uu____4049 uu____4072 uu____4095 uu____4118
       in
    FStar_Util.print_string uu____4024
  
let display_usage_aux :
  'Auu____4149 'Auu____4150 .
    ('Auu____4149 * Prims.string * 'Auu____4150 FStar_Getopt.opt_variant *
  ...
  fun specs  ->
    ...
    FStar_List.iter
      (fun uu____4205  ->
         ...
         | (uu____4218,flag,p,doc) ->
             (match p with
              | FStar_Getopt.ZeroArgs ig ->
                  if doc = ""
                  then
                    let uu____4237 =
                      let uu____4239 = FStar_Util.colorize_bold flag  in
                      FStar_Util.format1 "  --%s\n" uu____4239  in
                    FStar_Util.print_string uu____4237
                  else
                    (let uu____4244 =
                       let uu____4246 = FStar_Util.colorize_bold flag  in
                       FStar_Util.format2 "  --%s  %s\n" uu____4246 doc  in
                     FStar_Util.print_string uu____4244)
              | FStar_Getopt.OneArg (uu____4249,argname) ->
                  if doc = ""
                  then
                    let uu____4264 =
                      let uu____4266 = FStar_Util.colorize_bold flag  in
                      let uu____4268 = FStar_Util.colorize_bold argname  in
                      FStar_Util.format2 "  --%s %s\n" uu____4266 uu____4268
                       in
                    FStar_Util.print_string uu____4264
                  else
                    (let uu____4273 =
                       let uu____4275 = FStar_Util.colorize_bold flag  in
                       let uu____4277 = FStar_Util.colorize_bold argname  in
                       FStar_Util.format3 "  --%s %s  %s\n" uu____4275
                         uu____4277 doc
                        in
                     FStar_Util.print_string uu____4273))) specs
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____4354 =
                let uu____4355 = f ()  in set_option name uu____4355  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x = let uu____4376 = f x  in set_option name uu____4376
                 in
...
let (accumulated_option : Prims.string -> option_val -> option_val) =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____4403 = lookup_opt name (as_option as_list')  in
        FStar_Util.dflt [] uu____4403  in
...
let (reverse_accumulated_option : Prims.string -> option_val -> option_val) =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____4432 = lookup_opt name (as_option as_list')  in
        FStar_Util.dflt [] uu____4432  in
      List (FStar_List.append prev_values [value])
  
let accumulate_string :
  'Auu____4454 .
    Prims.string -> ('Auu____4454 -> Prims.string) -> 'Auu____4454 -> unit
  =
  fun name  ->
    fun post_processor  ->
      fun value  ->
        let uu____4479 =
          let uu____4480 =
            let uu____4481 = post_processor value  in String uu____4481  in
          accumulated_option name uu____4480  in
        set_option name uu____4479
...
let (uu___is_Const : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | Const _0 -> true | uu____4603 -> false
  
let (__proj__Const__item___0 : opt_type -> option_val) =
  fun projectee  -> match projectee with | Const _0 -> _0 
let (uu___is_IntStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | IntStr _0 -> true | uu____4623 -> false
  
let (__proj__IntStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | IntStr _0 -> _0 
let (uu___is_BoolStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | BoolStr  -> true | uu____4644 -> false
  
let (uu___is_PathStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | PathStr _0 -> true | uu____4657 -> false
  
let (__proj__PathStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | PathStr _0 -> _0 
let (uu___is_SimpleStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | SimpleStr _0 -> true | uu____4680 -> false
  
let (__proj__SimpleStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | SimpleStr _0 -> _0 
let (uu___is_EnumStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | EnumStr _0 -> true | uu____4705 -> false
  
let (__proj__EnumStr__item___0 : opt_type -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | EnumStr _0 -> _0 
let (uu___is_OpenEnumStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | OpenEnumStr _0 -> true | uu____4741 -> false
...
let (uu___is_PostProcessed : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | PostProcessed _0 -> true | uu____4791 -> false
...
let (uu___is_Accumulated : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | Accumulated _0 -> true | uu____4831 -> false
...
let (uu___is_WithSideEffect : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | WithSideEffect _0 -> true | uu____4876 -> false
...
let (uu___is_InvalidArgument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | InvalidArgument uu____4919 -> true
    | uu____4922 -> false
  
let (__proj__InvalidArgument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | InvalidArgument uu____4932 -> uu____4932
          ...
          (fun uu___306_4956  ->
             ...
             | () ->
                 (match typ with
                  | Const c -> c
                  | IntStr uu____4958 ->
                      let uu____4960 = FStar_Util.safe_int_of_string str_val
                         in
                  ...
                  | BoolStr  ->
                      let uu____4968 =
                        ...
                        then true
                         ...
                         in
                      Bool uu____4968
                  | PathStr uu____4985 -> Path str_val
                  | SimpleStr uu____4987 -> String str_val
                  | EnumStr strs ->
                      if FStar_List.mem str_val strs
                      then String str_val
                      else FStar_Exn.raise (InvalidArgument opt_name)
                  | OpenEnumStr uu____4997 -> String str_val
  ...
  fun typ  ->
    let desc_of_enum cases =
      let uu____5064 =
        ...
        FStar_String.op_Hat "[" uu____5066  in
      FStar_Pervasives_Native.Some uu____5064  in
    match typ with
    ...
    | PostProcessed (uu____5108,elem_spec) -> desc_of_opt_type elem_spec
    | Accumulated elem_spec -> desc_of_opt_type elem_spec
    | ReverseAccumulated elem_spec -> desc_of_opt_type elem_spec
    | WithSideEffect (uu____5118,elem_spec) -> desc_of_opt_type elem_spec
...
let rec (arg_spec_of_opt_type :
  ...
  fun opt_name  ->
    fun typ  ->
      ...
      let uu____5149 = desc_of_opt_type typ  in
      match uu____5149 with
      | FStar_Pervasives_Native.None  ->
          FStar_Getopt.ZeroArgs ((fun uu____5157  -> parser ""))
...
let (pp_lowercase : option_val -> option_val) =
  fun s  ->
    let uu____5183 =
      let uu____5185 = as_string s  in FStar_String.lowercase uu____5185  in
    String uu____5183
...
let rec (specs_with_types :
  ...
  fun uu____5220  ->
    ...
    (FStar_Getopt.noshort, "quake",
      (PostProcessed
         (((fun uu___8_6324  ->
              match uu___8_6324 with
              | String s ->
                  let p f =
                    let uu____6335 = FStar_Util.int_of_string f  in
                    Int uu____6335  in
                  let uu____6337 =
                    match FStar_Util.split s "/" with
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____6366 -> failwith "unexpected value for --quake"
                     in
                  (match uu____6337 with
                   | (min1,max1) ->
                       ((let uu____6384 = p min1  in
                         set_option "quake_lo" uu____6384);
                        (let uu____6387 = p max1  in
                         set_option "quake_hi" uu____6387);
                        String s))
    ...
    (FStar_Getopt.noshort, "__debug_embedding",
      (WithSideEffect
         (((fun uu____7228  -> FStar_ST.op_Colon_Equals debug_embedding true)),
           (Const (Bool true)))),
      "Debug messages for embeddings/unembeddings of natively compiled terms");
    (FStar_Getopt.noshort, "eager_embedding",
      (WithSideEffect
         (((fun uu____7272  -> FStar_ST.op_Colon_Equals eager_embedding true)),
           (Const (Bool true)))),
    ...
    (104, "help",
      (WithSideEffect
         (((fun uu____7369  ->
              (let uu____7371 = specs ()  in display_usage_aux uu____7371);
              FStar_All.exit Prims.int_zero)), (Const (Bool true)))),
      "Display this information")]

and (specs : unit -> FStar_Getopt.opt Prims.list) =
  fun uu____7402  ->
    let uu____7405 = specs_with_types ()  in
    FStar_List.map
      (fun uu____7436  ->
         match uu____7436 with
         | (short,long,typ,doc) ->
             let uu____7458 =
               let uu____7472 = arg_spec_of_opt_type long typ  in
               (short, long, uu____7472, doc)  in
             mk_spec uu____7458) uu____7405
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____7720  ->
          ...
          | (uu____7735,x,uu____7737,uu____7738) -> settable x))
  
let (display_usage : unit -> unit) =
  fun uu____7754  ->
    let uu____7755 = specs ()  in display_usage_aux uu____7755
...
let (uu___is_File_argument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | File_argument uu____7787 -> true
    | uu____7790 -> false
  
let (__proj__File_argument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | File_argument uu____7800 -> uu____7800
  ...
  fun uu____7853  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____7859 =
             let uu____7863 = FStar_ST.op_Bang file_list_  in
             FStar_List.append uu____7863 [i]  in
           FStar_ST.op_Colon_Equals file_list_ uu____7859)
       in
    let uu____7920 =
      let uu____7924 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____7924
       in
    (res, uu____7920)
  
let (file_list : unit -> Prims.string Prims.list) =
  fun uu____7966  -> FStar_ST.op_Bang file_list_ 
let (restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res)
  ...
  fun should_clear  ->
    ...
    (let r =
       let uu____8009 = specs ()  in
       FStar_Getopt.parse_cmdline uu____8009 (fun x  -> ())  in
     (let uu____8016 =
        let uu____8022 =
          let uu____8023 =
            FStar_List.map (fun _8027  -> String _8027) old_verify_module  in
          List uu____8023  in
        ("verify_module", uu____8022)  in
      set_option' uu____8016);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____8043 =
        let uu____8045 =
          let uu____8047 =
            let uu____8049 = FStar_Util.get_file_extension f1  in
            FStar_String.length uu____8049  in
          (FStar_String.length f1) - uu____8047  in
        uu____8045 - Prims.int_one  in
      FStar_String.substring f1 Prims.int_zero uu____8043  in
    FStar_String.lowercase f2
  
let (should_verify : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8062 = get_lax ()  in
    if uu____8062
    then false
    else
...
let (should_verify_file : Prims.string -> Prims.bool) =
  fun fn  ->
    let uu____8083 = module_name_of_file_name fn  in should_verify uu____8083
...
let (dont_gen_projectors : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8111 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____8111 (FStar_List.existsb (module_name_eq m))
  
let (should_print_message : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8129 = should_verify m  in
    if uu____8129 then m <> "Prims" else false
  
let (include_path : unit -> Prims.string Prims.list) =
  fun uu____8146  ->
    let cache_dir =
      let uu____8151 = get_cache_dir ()  in
      match uu____8151 with
      | FStar_Pervasives_Native.None  -> []
      | FStar_Pervasives_Native.Some c -> [c]  in
    let uu____8165 = get_no_default_includes ()  in
    if uu____8165
    then
      let uu____8171 = get_include ()  in
      FStar_List.append cache_dir uu____8171
    else
      (let lib_paths =
         let uu____8182 = FStar_Util.expand_environment_variable "FSTAR_LIB"
            in
       ...
       let uu____8225 =
         let uu____8229 =
           let uu____8233 = get_include ()  in
           FStar_List.append uu____8233 ["."]  in
         FStar_List.append lib_paths uu____8229  in
       FStar_List.append cache_dir uu____8225)
  
let (find_file : Prims.string -> Prims.string FStar_Pervasives_Native.option)
  =
  let file_map = FStar_Util.smap_create (Prims.of_int (100))  in
  fun filename  ->
    let uu____8264 = FStar_Util.smap_try_find file_map filename  in
        ...
        let result =
          try
            (fun uu___554_8295  ->
               match () with
               | () ->
                   let uu____8299 = FStar_Util.is_path_absolute filename  in
                   if uu____8299
                   then
                     ...
                     (let uu____8315 =
                        let uu____8319 = include_path ()  in
                        FStar_List.rev uu____8319  in
                      FStar_Util.find_map uu____8315
                        (fun p  ->
                           let path =
                             if p = "."
                             then filename
          ...
          with | uu___553_8347 -> FStar_Pervasives_Native.None  in
...
let (prims : unit -> Prims.string) =
  fun uu____8366  ->
    let uu____8367 = get_prims ()  in
    match uu____8367 with
    | FStar_Pervasives_Native.None  ->
        let filename = "prims.fst"  in
        let uu____8376 = find_file filename  in
...
let (prims_basename : unit -> Prims.string) =
  fun uu____8398  ->
    let uu____8399 = prims ()  in FStar_Util.basename uu____8399
  
let (pervasives : unit -> Prims.string) =
  fun uu____8407  ->
    let filename = "FStar.Pervasives.fst"  in
    let uu____8411 = find_file filename  in
...
let (pervasives_basename : unit -> Prims.string) =
  fun uu____8430  ->
    let uu____8431 = pervasives ()  in FStar_Util.basename uu____8431
  
let (pervasives_native_basename : unit -> Prims.string) =
  fun uu____8439  ->
    let filename = "FStar.Pervasives.Native.fst"  in
    let uu____8443 = find_file filename  in
...
let (prepend_cache_dir : Prims.string -> Prims.string) =
  fun fpath  ->
    let uu____8483 = get_cache_dir ()  in
    match uu____8483 with
    | FStar_Pervasives_Native.None  -> fpath
    | FStar_Pervasives_Native.Some x ->
        let uu____8492 = FStar_Util.basename fpath  in
        FStar_Util.join_paths x uu____8492
...
let (parse_settings :
  ...
  fun ns  ->
    ...
    let with_cache f s =
      let uu____8614 = FStar_Util.smap_try_find cache s  in
    ...
    let parse_one_setting s =
      ...
      then ([], true)
        ...
        then ([], false)
          ...
          then
            (let path =
               let uu____8768 = FStar_Util.substring_from s Prims.int_one  in
               path_of_text uu____8768  in
             (path, false))
          else
            (let s1 =
               if FStar_Util.starts_with s "+"
                  ...
                  (fun s2  ->
                     ...
                     let uu____8865 =
                       ...
                       FStar_All.pipe_right uu____8869
                        ...
                        in
                     FStar_All.pipe_right uu____8865
                       (FStar_List.map parse_one_setting)) s1))
       in
    FStar_All.pipe_right uu____8791 FStar_List.rev
  
let (__temp_no_proj : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____8956 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____8956 (FStar_List.contains s)
  
let (__temp_fast_implicits : unit -> Prims.bool) =
  fun uu____8971  -> lookup_opt "__temp_fast_implicits" as_bool 
let (admit_smt_queries : unit -> Prims.bool) =
  fun uu____8980  -> get_admit_smt_queries () 
let (admit_except : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____8989  -> get_admit_except () 
let (cache_checked_modules : unit -> Prims.bool) =
  fun uu____8996  -> get_cache_checked_modules () 
let (cache_off : unit -> Prims.bool) = fun uu____9003  -> get_cache_off () 
let (cmi : unit -> Prims.bool) = fun uu____9010  -> get_cmi () 
type codegen_t =
  | OCaml 
  | FSharp 
  | Kremlin 
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | OCaml  -> true | uu____9020 -> false
  
let (uu___is_FSharp : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | FSharp  -> true | uu____9031 -> false
  
let (uu___is_Kremlin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Kremlin  -> true | uu____9042 -> false
  
let (uu___is_Plugin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Plugin  -> true | uu____9053 -> false
  
let (codegen : unit -> codegen_t FStar_Pervasives_Native.option) =
  fun uu____9062  ->
    let uu____9063 = get_codegen ()  in
    FStar_Util.map_opt uu____9063
      (fun uu___10_9069  ->
         match uu___10_9069 with
         | "OCaml" -> OCaml
         | "FSharp" -> FSharp
         | "Kremlin" -> Kremlin
         | "Plugin" -> Plugin
         | uu____9075 -> failwith "Impossible")
  
let (codegen_libs : unit -> Prims.string Prims.list Prims.list) =
  fun uu____9088  ->
    let uu____9089 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____9089
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let (debug_any : unit -> Prims.bool) =
  fun uu____9115  -> let uu____9116 = get_debug ()  in uu____9116 <> [] 
let (debug_module : Prims.string -> Prims.bool) =
  fun modul  ->
    let uu____9133 = get_debug ()  in
...
let (debug_at_level : Prims.string -> debug_level_t -> Prims.bool) =
  fun modul  ->
    fun level  ->
      (let uu____9158 = get_debug ()  in
       FStar_All.pipe_right uu____9158
         (FStar_List.existsb (module_name_eq modul)))
        && (debug_level_geq level)
  
let (profile_group_by_decls : unit -> Prims.bool) =
  fun uu____9173  -> get_profile_group_by_decl () 
let (defensive : unit -> Prims.bool) =
  fun uu____9180  -> let uu____9181 = get_defensive ()  in uu____9181 <> "no" 
let (defensive_fail : unit -> Prims.bool) =
  fun uu____9191  ->
    let uu____9192 = get_defensive ()  in uu____9192 = "fail"
  
let (dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9204  -> get_dep () 
let (detail_errors : unit -> Prims.bool) =
  fun uu____9211  -> get_detail_errors () 
let (detail_hint_replay : unit -> Prims.bool) =
  fun uu____9218  -> get_detail_hint_replay () 
let (doc : unit -> Prims.bool) = fun uu____9225  -> get_doc () 
let (dump_module : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9235 = get_dump_module ()  in
    FStar_All.pipe_right uu____9235 (FStar_List.existsb (module_name_eq s))
  
let (eager_subtyping : unit -> Prims.bool) =
  fun uu____9250  -> get_eager_subtyping () 
let (expose_interfaces : unit -> Prims.bool) =
  fun uu____9257  -> get_expose_interfaces () 
let (fs_typ_app : Prims.string -> Prims.bool) =
  fun filename  ->
    let uu____9267 = FStar_ST.op_Bang light_off_files  in
    FStar_List.contains filename uu____9267
  
let (full_context_dependency : unit -> Prims.bool) = fun uu____9303  -> true 
let (hide_uvar_nums : unit -> Prims.bool) =
  fun uu____9311  -> get_hide_uvar_nums () 
let (hint_info : unit -> Prims.bool) =
  fun uu____9318  -> (get_hint_info ()) || (get_query_stats ()) 
let (hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9327  -> get_hint_dir () 
let (hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9336  -> get_hint_file () 
let (hint_file_for_src : Prims.string -> Prims.string) =
  fun src_filename  ->
    let uu____9346 = hint_file ()  in
    match uu____9346 with
    | FStar_Pervasives_Native.Some fn -> fn
    | FStar_Pervasives_Native.None  ->
        let file_name =
          let uu____9357 = hint_dir ()  in
          match uu____9357 with
          | FStar_Pervasives_Native.Some dir ->
              let uu____9365 = FStar_Util.basename src_filename  in
              FStar_Util.concat_dir_filename dir uu____9365
          | uu____9367 -> src_filename  in
        FStar_Util.format1 "%s.hints" file_name
  
let (ide : unit -> Prims.bool) = fun uu____9378  -> get_ide () 
let (print : unit -> Prims.bool) = fun uu____9385  -> get_print () 
let (print_in_place : unit -> Prims.bool) =
  fun uu____9392  -> get_print_in_place () 
let (initial_fuel : unit -> Prims.int) =
  fun uu____9399  ->
    let uu____9400 = get_initial_fuel ()  in
    let uu____9402 = get_max_fuel ()  in Prims.min uu____9400 uu____9402
  
let (initial_ifuel : unit -> Prims.int) =
  fun uu____9410  ->
    let uu____9411 = get_initial_ifuel ()  in
    let uu____9413 = get_max_ifuel ()  in Prims.min uu____9411 uu____9413
  
let (interactive : unit -> Prims.bool) =
  fun uu____9421  -> (get_in ()) || (get_ide ()) 
let (lax : unit -> Prims.bool) = fun uu____9428  -> get_lax () 
let (load : unit -> Prims.string Prims.list) = fun uu____9437  -> get_load () 
let (legacy_interactive : unit -> Prims.bool) = fun uu____9444  -> get_in () 
let (lsp_server : unit -> Prims.bool) = fun uu____9451  -> get_lsp () 
let (log_queries : unit -> Prims.bool) =
  fun uu____9458  -> get_log_queries () 
let (keep_query_captions : unit -> Prims.bool) =
  fun uu____9465  -> (log_queries ()) && (get_keep_query_captions ()) 
let (log_types : unit -> Prims.bool) = fun uu____9472  -> get_log_types () 
let (max_fuel : unit -> Prims.int) = fun uu____9479  -> get_max_fuel () 
let (max_ifuel : unit -> Prims.int) = fun uu____9486  -> get_max_ifuel () 
let (min_fuel : unit -> Prims.int) = fun uu____9493  -> get_min_fuel () 
let (ml_ish : unit -> Prims.bool) = fun uu____9500  -> get_MLish () 
let (set_ml_ish : unit -> unit) =
  fun uu____9506  -> set_option "MLish" (Bool true) 
let (no_default_includes : unit -> Prims.bool) =
  fun uu____9515  -> get_no_default_includes () 
let (no_extract : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9525 = get_no_extract ()  in
    FStar_All.pipe_right uu____9525 (FStar_List.existsb (module_name_eq s))
  
let (normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____9540  -> get_normalize_pure_terms_for_extraction () 
let (no_location_info : unit -> Prims.bool) =
  fun uu____9547  -> get_no_location_info () 
let (no_plugins : unit -> Prims.bool) = fun uu____9554  -> get_no_plugins () 
let (no_smt : unit -> Prims.bool) = fun uu____9561  -> get_no_smt () 
let (output_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9570  -> get_odir () 
let (ugly : unit -> Prims.bool) = fun uu____9577  -> get_ugly () 
let (print_bound_var_types : unit -> Prims.bool) =
  fun uu____9584  -> get_print_bound_var_types () 
let (print_effect_args : unit -> Prims.bool) =
  fun uu____9591  -> get_print_effect_args () 
let (print_implicits : unit -> Prims.bool) =
  fun uu____9598  -> get_print_implicits () 
let (print_real_names : unit -> Prims.bool) =
  fun uu____9605  -> (get_prn ()) || (get_print_full_names ()) 
let (print_universes : unit -> Prims.bool) =
  fun uu____9612  -> get_print_universes () 
let (print_z3_statistics : unit -> Prims.bool) =
  fun uu____9619  -> get_print_z3_statistics () 
let (quake_lo : unit -> Prims.int) = fun uu____9626  -> get_quake_lo () 
let (quake_hi : unit -> Prims.int) = fun uu____9633  -> get_quake_hi () 
let (query_stats : unit -> Prims.bool) =
  fun uu____9640  -> get_query_stats () 
let (record_hints : unit -> Prims.bool) =
  fun uu____9647  -> get_record_hints () 
let (record_options : unit -> Prims.bool) =
  fun uu____9654  -> get_record_options () 
let (reuse_hint_for : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9663  -> get_reuse_hint_for () 
let (silent : unit -> Prims.bool) = fun uu____9670  -> get_silent () 
let (smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____9677  -> get_smtencoding_elim_box () 
let (smtencoding_nl_arith_native : unit -> Prims.bool) =
  fun uu____9684  ->
    let uu____9685 = get_smtencoding_nl_arith_repr ()  in
    uu____9685 = "native"
  
let (smtencoding_nl_arith_wrapped : unit -> Prims.bool) =
  fun uu____9695  ->
    let uu____9696 = get_smtencoding_nl_arith_repr ()  in
    uu____9696 = "wrapped"
  
let (smtencoding_nl_arith_default : unit -> Prims.bool) =
  fun uu____9706  ->
    let uu____9707 = get_smtencoding_nl_arith_repr ()  in
    uu____9707 = "boxwrap"
  
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____9717  ->
    let uu____9718 = get_smtencoding_l_arith_repr ()  in
    uu____9718 = "native"
  
let (smtencoding_l_arith_default : unit -> Prims.bool) =
  fun uu____9728  ->
    let uu____9729 = get_smtencoding_l_arith_repr ()  in
    uu____9729 = "boxwrap"
  
let (smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____9739  -> get_smtencoding_valid_intro () 
let (smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____9746  -> get_smtencoding_valid_elim () 
let (tactic_raw_binders : unit -> Prims.bool) =
  fun uu____9753  -> get_tactic_raw_binders () 
let (tactics_failhard : unit -> Prims.bool) =
  fun uu____9760  -> get_tactics_failhard () 
let (tactics_info : unit -> Prims.bool) =
  fun uu____9767  -> get_tactics_info () 
let (tactic_trace : unit -> Prims.bool) =
  fun uu____9774  -> get_tactic_trace () 
let (tactic_trace_d : unit -> Prims.int) =
  fun uu____9781  -> get_tactic_trace_d () 
let (tactics_nbe : unit -> Prims.bool) =
  fun uu____9788  -> get_tactics_nbe () 
let (tcnorm : unit -> Prims.bool) = fun uu____9795  -> get_tcnorm () 
let (timing : unit -> Prims.bool) = fun uu____9802  -> get_timing () 
let (trace_error : unit -> Prims.bool) =
  fun uu____9809  -> get_trace_error () 
let (unthrottle_inductives : unit -> Prims.bool) =
  fun uu____9816  -> get_unthrottle_inductives () 
let (unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____9823  -> get_unsafe_tactic_exec () 
let (use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____9830  -> get_use_eq_at_higher_order () 
let (use_hints : unit -> Prims.bool) = fun uu____9837  -> get_use_hints () 
let (use_hint_hashes : unit -> Prims.bool) =
  fun uu____9844  -> get_use_hint_hashes () 
let (use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9853  -> get_use_native_tactics () 
let (use_tactics : unit -> Prims.bool) =
  fun uu____9860  -> get_use_tactics () 
let (using_facts_from :
  unit -> (Prims.string Prims.list * Prims.bool) Prims.list) =
  fun uu____9876  ->
    let uu____9877 = get_using_facts_from ()  in
...
let (vcgen_optimize_bind_as_seq : unit -> Prims.bool) =
  fun uu____9931  ->
    let uu____9932 = get_vcgen_optimize_bind_as_seq ()  in
    FStar_Option.isSome uu____9932
  
let (vcgen_decorate_with_type : unit -> Prims.bool) =
  fun uu____9943  ->
    let uu____9944 = get_vcgen_optimize_bind_as_seq ()  in
    match uu____9944 with
    | FStar_Pervasives_Native.Some "with_type" -> true
    | uu____9952 -> false
  
let (warn_default_effects : unit -> Prims.bool) =
  fun uu____9963  -> get_warn_default_effects () 
let (z3_exe : unit -> Prims.string) =
  fun uu____9970  ->
    let uu____9971 = get_smt ()  in
    match uu____9971 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
  
let (z3_cliopt : unit -> Prims.string Prims.list) =
  fun uu____9989  -> get_z3cliopt () 
let (z3_refresh : unit -> Prims.bool) = fun uu____9996  -> get_z3refresh () 
let (z3_rlimit : unit -> Prims.int) = fun uu____10003  -> get_z3rlimit () 
let (z3_rlimit_factor : unit -> Prims.int) =
  fun uu____10010  -> get_z3rlimit_factor () 
let (z3_seed : unit -> Prims.int) = fun uu____10017  -> get_z3seed () 
let (use_two_phase_tc : unit -> Prims.bool) =
  fun uu____10024  ->
    (get_use_two_phase_tc ()) &&
      (let uu____10026 = lax ()  in Prims.op_Negation uu____10026)
  
let (no_positivity : unit -> Prims.bool) =
  fun uu____10034  -> get_no_positivity () 
let (ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____10041  -> get_ml_no_eta_expand_coertions () 
let (warn_error : unit -> Prims.string) =
  fun uu____10048  ->
    let uu____10049 = get_warn_error ()  in
    FStar_String.concat "" uu____10049
  
let (use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____10060  -> get_use_extracted_interfaces () 
let (use_nbe : unit -> Prims.bool) = fun uu____10067  -> get_use_nbe () 
let (trivial_pre_for_unannotated_effectful_fns : unit -> Prims.bool) =
  fun uu____10074  -> get_trivial_pre_for_unannotated_effectful_fns () 
let with_saved_options : 'a . (unit -> 'a) -> 'a =
  fun f  ->
    let uu____10091 =
      let uu____10093 = trace_error ()  in Prims.op_Negation uu____10093  in
    if uu____10091
    then
      (push ();
       (let r =
          try
            (fun uu___760_10108  ->
               match () with
               | () -> let uu____10113 = f ()  in FStar_Util.Inr uu____10113)
              ()
          with | uu___759_10115 -> FStar_Util.Inl uu___759_10115  in
        pop ();
        (match r with
  ...
  fun m  ->
    fun filter1  ->
      ...
      let rec matches_path m_components1 path =
        ...
        | uu____10229 -> false  in
      let uu____10241 =
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____10283  ->
                match uu____10283 with
                | (path,uu____10294) -> matches_path m_components path))
         in
      match uu____10241 with
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some (uu____10313,flag) -> flag
...
let (should_extract : Prims.string -> Prims.bool) =
  fun m  ->
    let m1 = FStar_String.lowercase m  in
    let uu____10378 = get_extract ()  in
    match uu____10378 with
    | FStar_Pervasives_Native.Some extract_setting ->
        ((let uu____10393 =
            let uu____10409 = get_no_extract ()  in
            let uu____10413 = get_extract_namespace ()  in
            let uu____10417 = get_extract_module ()  in
            (uu____10409, uu____10413, uu____10417)  in
    ...
    | FStar_Pervasives_Native.None  ->
        let should_extract_namespace m2 =
          let uu____10471 = get_extract_namespace ()  in
        ...
        let should_extract_module m2 =
          let uu____10499 = get_extract_module ()  in
          ...
          | l ->
           ...
           in
        (let uu____10521 = no_extract m1  in Prims.op_Negation uu____10521)
          &&
          (let uu____10524 =
             let uu____10535 = get_extract_namespace ()  in
             let uu____10539 = get_extract_module ()  in
...
let (should_be_already_cached : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____10579 = get_already_cached ()  in
...
let (error_flags : unit -> error_flag Prims.list) =
  ...
  fun uu____10612  ->
    ...
    let uu____10615 = FStar_Util.smap_try_find cache we  in
...
let (profile_enabled :
  ...
  fun modul_opt  ->
    fun phase  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____10659 = get_profile_component ()  in
          matches_namespace_filter_opt phase uu____10659
      | FStar_Pervasives_Native.Some modul ->
          (let uu____10670 = get_profile ()  in
           matches_namespace_filter_opt modul uu____10670) &&
            (let uu____10677 = get_profile_component ()  in
             matches_namespace_filter_opt phase uu____10677)
