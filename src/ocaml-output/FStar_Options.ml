...
let (parse_warn_error : Prims.string -> error_flag Prims.list) =
  fun s ->
    let uu____2509 = FStar_Pervasives_Native.snd parse_warn_error_set_get () in
    uu____2509 s
let (init : unit -> unit) =
  fun uu____2540 ->
    let o = peek () in
...
let (get_in : unit -> Prims.bool) = fun uu____2999 -> lookup_opt "in" as_bool
...
let (display_version : unit -> unit) =
  fun uu____3857 ->
    let uu____3858 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____3860
        uu____3883 uu____3906 uu____3929 uu____3952 in
    ...
    | (ns, name, arg, desc) ->
        let arg1 =
          ...
          | FStar_Getopt.OneArg (f, d) ->
              let g x = let uu____4210 = f x in set_option name uu____4210 in
          ...
          (fun uu___294_4790 ->
             ...
             | () ->
                 (match typ with
                  | Const c -> c
                  | IntStr uu____4792 ->
                      let uu____4794 = FStar_Util.safe_int_of_string str_val in
...
let (display_usage : unit -> unit) =
  fun uu____7493 -> let uu____7494 = specs () in display_usage_aux uu____7494
    ...
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____7608) in
    let uu____7669 =
      let uu____7673 = FStar_ST.op_Bang file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____7673 in
    (res, uu____7669)
...
let (include_path : unit -> Prims.string Prims.list) =
  fun uu____7895 ->
    ...
    then
      ...
      (let lib_paths =
         let uu____7931 = FStar_Util.expand_environment_variable "FSTAR_LIB" in
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee -> match projectee with | OCaml -> true | uu____8763 -> false
...
let (defensive_fail : unit -> Prims.bool) =
  fun uu____8927 -> let uu____8928 = get_defensive () in uu____8928 = "fail"
...
let (log_queries : unit -> Prims.bool) = fun uu____9194 -> get_log_queries ()
...
let (query_stats : unit -> Prims.bool) = fun uu____9369 -> get_query_stats ()
...
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____9439 ->
    let uu____9440 = get_smtencoding_l_arith_repr () in uu____9440 = "native"
...
let (tactics_nbe : unit -> Prims.bool) = fun uu____9510 -> get_tactics_nbe ()
let (tcnorm : unit -> Prims.bool) = fun uu____9517 -> get_tcnorm ()
let (timing : unit -> Prims.bool) = fun uu____9524 -> get_timing ()
let (trace_error : unit -> Prims.bool) = fun uu____9531 -> get_trace_error ()
...
let (use_tactics : unit -> Prims.bool) = fun uu____9582 -> get_use_tactics ()
        ...
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____9998 ->
                ...
                | (path, uu____10009) -> matches_path m_components path)) in
