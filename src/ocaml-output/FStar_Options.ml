...
let (display_usage : unit -> unit) =
  fun uu____7996  ->
    let uu____7997 = specs ()  in display_usage_aux uu____7997
    ...
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____8101)
       in
    let uu____8162 =
      let uu____8166 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____8166
       in
    (res, uu____8162)
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | OCaml  -> true | uu____9262 -> false
...
let (defensive_fail : unit -> Prims.bool) =
  fun uu____9433  ->
    let uu____9434 = get_defensive ()  in uu____9434 = "fail"
...
let (log_queries : unit -> Prims.bool) =
  fun uu____9700  -> get_log_queries () 
...
let (query_stats : unit -> Prims.bool) =
  fun uu____9882  -> get_query_stats () 
...
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____9966  ->
    let uu____9967 = get_smtencoding_l_arith_repr ()  in
    uu____9967 = "native"
...
let (warn_error : unit -> Prims.string) =
  fun uu____10297  ->
    let uu____10298 = get_warn_error ()  in
    FStar_String.concat "" uu____10298
        ...
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____10532  ->
                ...
                | (path,uu____10543) -> matches_path m_components path))
         in
