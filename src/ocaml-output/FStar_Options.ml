...
let prepend_output_dir: Prims.string -> Prims.string =
  fun fname  ->
    let uu____2133 = get_odir () in
    match uu____2133 with
    | None  -> fname
    | Some x -> Prims.strcat x (Prims.strcat "/" fname)
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2139 = get___temp_no_proj () in
    FStar_All.pipe_right uu____2139 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____2144  -> get_admit_smt_queries ()
let check_hints: Prims.unit -> Prims.bool =
  fun uu____2147  -> get_check_hints ()
let codegen: Prims.unit -> Prims.string option =
  fun uu____2151  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____2156  ->
    let uu____2157 = get_codegen_lib () in
    FStar_All.pipe_right uu____2157
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____2166  -> let uu____2167 = get_debug () in uu____2167 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____2176 = get_debug () in
          FStar_All.pipe_right uu____2176 (FStar_List.contains modul)))
        && (debug_level_geq level)
let dep: Prims.unit -> Prims.string option = fun uu____2182  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____2185  -> get_detail_errors ()
let doc: Prims.unit -> Prims.bool = fun uu____2188  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2192 = get_dump_module () in
    FStar_All.pipe_right uu____2192 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____2197  -> get_eager_inference ()
let explicit_deps: Prims.unit -> Prims.bool =
  fun uu____2200  -> get_explicit_deps ()
let extract_all: Prims.unit -> Prims.bool =
  fun uu____2203  -> get_extract_all ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____2207 = FStar_ST.read light_off_files in
    FStar_List.contains filename uu____2207
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____2214  -> true
let hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____2217  -> get_hide_genident_nums ()
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____2220  -> get_hide_uvar_nums ()
let hint_info: Prims.unit -> Prims.bool = fun uu____2223  -> get_hint_info ()
let ide: Prims.unit -> Prims.bool = fun uu____2226  -> get_ide ()
let indent: Prims.unit -> Prims.bool = fun uu____2229  -> get_indent ()
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____2232  ->
    let uu____2233 = get_initial_fuel () in
    let uu____2234 = get_max_fuel () in Prims.min uu____2233 uu____2234
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____2237  ->
    let uu____2238 = get_initial_ifuel () in
    let uu____2239 = get_max_ifuel () in Prims.min uu____2238 uu____2239
let interactive: Prims.unit -> Prims.bool =
  fun uu____2242  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____2245  -> get_lax ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____2248  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____2251  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____2254  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____2257  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____2260  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____2263  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____2266  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____2269  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____2272  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____2275  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2279 = get_no_extract () in
    FStar_All.pipe_right uu____2279 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____2284  -> get_no_location_info ()
let norm_then_print: Prims.unit -> Prims.bool =
  fun uu____2287  ->
    let uu____2288 = get_print_before_norm () in uu____2288 = false
...
let z3_exe: Prims.unit -> Prims.string =
  fun uu____2388  ->
    ...
    match uu____2389 with | None  -> FStar_Platform.exe "z3" | Some s -> s
