...
in (x)::_0_62)
in (FStar_All.pipe_right _0_64 (FStar_List.map (fun _0_63 -> String (_0_63)))))))), ("[module name]")))), ("Do not extract code from this module")))::(((FStar_Getopt.noshort), ("no_location_info"), (FStar_Getopt.ZeroArgs ((fun uu____1185 -> Bool (true)))), ("Suppress location information in the generated OCaml output (only relevant with --codegen OCaml)")))::(((FStar_Getopt.noshort), ("odir"), (FStar_Getopt.OneArg ((((fun _0_65 -> String (_0_65))), ("[dir]")))), ("Place output in directory [dir]")))::(((FStar_Getopt.noshort), ("prims"), (FStar_Getopt.OneArg ((((fun _0_66 -> String (_0_66))), ("file")))), ("")))::(((FStar_Getopt.noshort), ("print_before_norm"), (FStar_Getopt.ZeroArgs ((fun uu____1208 -> Bool (true)))), ("Do not normalize types before printing (for debugging)")))::(((FStar_Getopt.noshort), ("print_bound_var_types"), (FStar_Getopt.ZeroArgs ((fun uu____1215 -> Bool (true)))), ("Print the types of bound variables")))::(((FStar_Getopt.noshort), ("print_effect_args"), (FStar_Getopt.ZeroArgs ((fun uu____1222 -> Bool (true)))), ("Print inferred predicate transformers for all computation types")))::(((FStar_Getopt.noshort), ("print_fuels"), (FStar_Getopt.ZeroArgs ((fun uu____1229 -> Bool (true)))), ("Print the fuel amounts used for each successful query")))::(((FStar_Getopt.noshort), ("print_implicits"), (FStar_Getopt.ZeroArgs ((fun uu____1236 -> Bool (true)))), ("Print implicit arguments")))::(((FStar_Getopt.noshort), ("print_ml"), (FStar_Getopt.ZeroArgs ((fun uu____1243 -> Bool (true)))), ("Print OCaml AST")))::(((FStar_Getopt.noshort), ("print_universes"), (FStar_Getopt.ZeroArgs ((fun uu____1250 -> Bool (true)))), ("Print universes")))::(((FStar_Getopt.noshort), ("print_z3_statistics"), (FStar_Getopt.ZeroArgs ((fun uu____1257 -> Bool (true)))), ("Print Z3 statistics for each SMT query")))::(((FStar_Getopt.noshort), ("prn"), (FStar_Getopt.ZeroArgs ((fun uu____1264 -> Bool (true)))), ("Print real names (you may want to use this in conjunction with log_queries)")))::(((FStar_Getopt.noshort), ("record_hints"), (FStar_Getopt.ZeroArgs ((fun uu____1271 -> Bool (true)))), ("Record a database of hints for efficient proof replay")))::(((FStar_Getopt.noshort), ("reuse_hint_for"), (FStar_Getopt.OneArg ((((fun _0_67 -> String (_0_67))), ("top-level name in the current module")))), ("Optimistically, attempt using the recorded hint for \'f\' when trying to verify some other term \'g\'")))::(((FStar_Getopt.noshort), ("show_signatures"), (FStar_Getopt.OneArg ((((fun x -> List ((let _0_70 = (let _0_68 = (get_show_signatures ())
in (x)::_0_68)
in (FStar_All.pipe_right _0_70 (FStar_List.map (fun _0_69 -> String (_0_69)))))))), ("[module name]")))), ("Show the checked signatures for all top-level symbols in the module")))::(((FStar_Getopt.noshort), ("silent"), (FStar_Getopt.ZeroArgs ((fun uu____1297 -> Bool (true)))), (" ")))::(((FStar_Getopt.noshort), ("smt"), (FStar_Getopt.OneArg ((((fun _0_71 -> String (_0_71))), ("[path]")))), ("Path to the SMT solver (usually Z3, but could be any SMT2-compatible solver)")))::(((FStar_Getopt.noshort), ("split_cases"), (FStar_Getopt.OneArg ((((fun n -> Int ((FStar_Util.int_of_string n)))), ("[positive integer]")))), ("Partition VC of a match into groups of [n] cases")))::(((FStar_Getopt.noshort), ("stratified"), (FStar_Getopt.ZeroArgs ((fun uu____1321 -> Bool (true)))), ("Remove the support for universes")))::(((FStar_Getopt.noshort), ("timing"), (FStar_Getopt.ZeroArgs ((fun uu____1328 -> Bool (true)))), ("Print the time it takes to verify each top-level definition")))::(((FStar_Getopt.noshort), ("trace_error"), (FStar_Getopt.ZeroArgs ((fun uu____1335 -> Bool (true)))), ("Don\'t print an error message; show an exception trace instead")))::(((FStar_Getopt.noshort), ("unthrottle_inductives"), (FStar_Getopt.ZeroArgs ((fun uu____1342 -> Bool (true)))), ("Let the SMT solver unfold inductive types to arbitrary depths (may affect verifier performance)")))::(((FStar_Getopt.noshort), ("use_eq_at_higher_order"), (FStar_Getopt.ZeroArgs ((fun uu____1349 -> Bool (true)))), ("Use equality constraints when comparing higher-order types (Temporary)")))::(((FStar_Getopt.noshort), ("use_hints"), (FStar_Getopt.ZeroArgs ((fun uu____1356 -> Bool (true)))), ("Use a previously recorded hints database for proof replay")))::(((FStar_Getopt.noshort), ("verify_all"), (FStar_Getopt.ZeroArgs ((fun uu____1363 -> Bool (true)))), ("With automatic dependencies, verify all the dependencies, not just the files passed on the command-line.")))::(((FStar_Getopt.noshort), ("verify_module"), (FStar_Getopt.OneArg (((cons_verify_module), ("[module name]")))), ("Name of the module to verify")))::(((FStar_Getopt.noshort), ("__temp_no_proj"), (FStar_Getopt.OneArg ((((fun x -> List ((let _0_74 = (let _0_72 = (get___temp_no_proj ())
in (x)::_0_72)
in (FStar_All.pipe_right _0_74 (FStar_List.map (fun _0_73 -> String (_0_73)))))))), ("[module name]")))), ("Don\'t generate projectors for this module")))::((('v'), ("version"), (FStar_Getopt.ZeroArgs ((fun uu____1389 -> ((display_version ());
(FStar_All.exit (Prims.parse_int "0"));
)))), ("Display version number")))::(((FStar_Getopt.noshort), ("no_warn_top_level_effects"), (FStar_Getopt.ZeroArgs ((fun uu____1397 -> Bool (false)))), ("Top-level effects are checked by default; turn this flag on to prevent warning when this happens")))::(((FStar_Getopt.noshort), ("z3refresh"), (FStar_Getopt.ZeroArgs ((fun uu____1404 -> Bool (false)))), ("Restart Z3 after each query; useful for ensuring proof robustness")))::(((FStar_Getopt.noshort), ("z3rlimit"), (FStar_Getopt.OneArg ((((fun s -> Int ((FStar_Util.int_of_string s)))), ("[positive integer]")))), ("Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)")))::(((FStar_Getopt.noshort), ("z3seed"), (FStar_Getopt.OneArg ((((fun s -> Int ((FStar_Util.int_of_string s)))), ("[positive integer]")))), ("Set the Z3 random seed (default 0)")))::(((FStar_Getopt.noshort), ("z3timeout"), (FStar_Getopt.OneArg ((((fun s -> ((FStar_Util.print_string "Warning: z3timeout ignored with universes; use z3rlimit instead\n");
...
let settable : Prims.string  ->  Prims.bool = (fun uu___49_1461 -> (match (uu___49_1461) with
...
let settable_specs : (FStar_BaseTypes.char * Prims.string * Prims.unit FStar_Getopt.opt_variant * Prims.string) Prims.list = (FStar_All.pipe_right all_specs (FStar_List.filter (fun uu____1485 -> (match (uu____1485) with
| (uu____1491, x, uu____1493, uu____1494) -> begin
(settable x)
end))))


let resettable_specs : (FStar_BaseTypes.char * Prims.string * Prims.unit FStar_Getopt.opt_variant * Prims.string) Prims.list = (FStar_All.pipe_right all_specs (FStar_List.filter (fun uu____1515 -> (match (uu____1515) with
| (uu____1521, x, uu____1523, uu____1524) -> begin
(resettable x)
end))))


let display_usage : Prims.unit  ->  Prims.unit = (fun uu____1529 -> (display_usage_aux (specs ())))


let fstar_home : Prims.unit  ->  Prims.string = (fun uu____1532 -> (

let uu____1533 = (get_fstar_home ())
...
let uu____1558 = (not ((get_stratified ())))
...
in (FStar_Getopt.parse_string specs (fun uu____1566 -> ()) s)))


let file_list_ : Prims.string Prims.list FStar_ST.ref = (FStar_Util.mk_ref [])


let parse_cmd_line : Prims.unit  ->  (FStar_Getopt.parse_cmdline_res * Prims.string Prims.list) = (fun uu____1577 -> (
...
let file_list : Prims.unit  ->  Prims.string Prims.list = (fun uu____1593 -> (FStar_ST.read file_list_))
...
let uu____1614 = (get_verify_module ())
...
let uu____1632 = (should_verify m)
...
let include_path : Prims.unit  ->  Prims.string Prims.list = (fun uu____1637 -> (

let uu____1638 = (get_no_default_includes ())
...
let uu____1644 = (not ((get_stratified ())))
...
let uu____1656 = (FStar_Util.is_path_absolute filename)
...
let prims : Prims.unit  ->  Prims.string = (fun uu____1667 -> (

let uu____1668 = (get_prims ())
...
let uu____1671 = (find_file filename)
...
let admit_smt_queries : Prims.unit  ->  Prims.bool = (fun uu____1687 -> (get_admit_smt_queries ()))


let check_cardinality : Prims.unit  ->  Prims.bool = (fun uu____1690 -> (let _0_94 = (get_cardinality ())
in (_0_94 = "check")))


let codegen : Prims.unit  ->  Prims.string Prims.option = (fun uu____1694 -> (get_codegen ()))


let codegen_libs : Prims.unit  ->  Prims.string Prims.list Prims.list = (fun uu____1699 -> (let _0_95 = (get_codegen_lib ())
in (FStar_All.pipe_right _0_95 (FStar_List.map (fun x -> (FStar_Util.split x "."))))))


let debug_any : Prims.unit  ->  Prims.bool = (fun uu____1707 -> (let _0_96 = (get_debug ())
in (_0_96 <> [])))
...
let dep : Prims.unit  ->  Prims.string Prims.option = (fun uu____1719 -> (get_dep ()))


let detail_errors : Prims.unit  ->  Prims.bool = (fun uu____1722 -> (get_detail_errors ()))


let doc : Prims.unit  ->  Prims.bool = (fun uu____1725 -> (get_doc ()))
...
let eager_inference : Prims.unit  ->  Prims.bool = (fun uu____1732 -> (get_eager_inference ()))


let explicit_deps : Prims.unit  ->  Prims.bool = (fun uu____1735 -> (get_explicit_deps ()))


let extract_all : Prims.unit  ->  Prims.bool = (fun uu____1738 -> (get_extract_all ()))
...
let full_context_dependency : Prims.unit  ->  Prims.bool = (fun uu____1747 -> (

let uu____1748 = (get_stratified ())
...
let hide_genident_nums : Prims.unit  ->  Prims.bool = (fun uu____1752 -> (get_hide_genident_nums ()))


let hide_uvar_nums : Prims.unit  ->  Prims.bool = (fun uu____1755 -> (get_hide_uvar_nums ()))


let hint_info : Prims.unit  ->  Prims.bool = (fun uu____1758 -> (get_hint_info ()))


let indent : Prims.unit  ->  Prims.bool = (fun uu____1761 -> (get_indent ()))


let initial_fuel : Prims.unit  ->  Prims.int = (fun uu____1764 -> (get_initial_fuel ()))


let initial_ifuel : Prims.unit  ->  Prims.int = (fun uu____1767 -> (get_initial_ifuel ()))


let inline_arith : Prims.unit  ->  Prims.bool = (fun uu____1770 -> (get_inline_arith ()))


let interactive : Prims.unit  ->  Prims.bool = (fun uu____1773 -> (get_in ()))


let lax : Prims.unit  ->  Prims.bool = (fun uu____1776 -> (get_lax ()))


let log_queries : Prims.unit  ->  Prims.bool = (fun uu____1779 -> (get_log_queries ()))


let log_types : Prims.unit  ->  Prims.bool = (fun uu____1782 -> (get_log_types ()))


let max_fuel : Prims.unit  ->  Prims.int = (fun uu____1785 -> (get_max_fuel ()))


let max_ifuel : Prims.unit  ->  Prims.int = (fun uu____1788 -> (get_max_ifuel ()))


let min_fuel : Prims.unit  ->  Prims.int = (fun uu____1791 -> (get_min_fuel ()))


let ml_ish : Prims.unit  ->  Prims.bool = (fun uu____1794 -> (get_MLish ()))


let n_cores : Prims.unit  ->  Prims.int = (fun uu____1797 -> (get_n_cores ()))


let no_default_includes : Prims.unit  ->  Prims.bool = (fun uu____1800 -> (get_no_default_includes ()))
...
let no_location_info : Prims.unit  ->  Prims.bool = (fun uu____1807 -> (get_no_location_info ()))


let norm_then_print : Prims.unit  ->  Prims.bool = (fun uu____1810 -> (let _0_102 = (get_print_before_norm ())
in (_0_102 = false)))


let output_dir : Prims.unit  ->  Prims.string Prims.option = (fun uu____1814 -> (get_odir ()))


let print_bound_var_types : Prims.unit  ->  Prims.bool = (fun uu____1817 -> (get_print_bound_var_types ()))


let print_effect_args : Prims.unit  ->  Prims.bool = (fun uu____1820 -> (get_print_effect_args ()))


let print_fuels : Prims.unit  ->  Prims.bool = (fun uu____1823 -> (get_print_fuels ()))


let print_implicits : Prims.unit  ->  Prims.bool = (fun uu____1826 -> (get_print_implicits ()))


let print_ml : Prims.unit  ->  Prims.bool = (fun uu____1829 -> (get_print_ml ()))


let print_real_names : Prims.unit  ->  Prims.bool = (fun uu____1832 -> (get_prn ()))


let print_universes : Prims.unit  ->  Prims.bool = (fun uu____1835 -> (get_print_universes ()))


let print_z3_statistics : Prims.unit  ->  Prims.bool = (fun uu____1838 -> (get_print_z3_statistics ()))


let record_hints : Prims.unit  ->  Prims.bool = (fun uu____1841 -> (get_record_hints ()))


let reuse_hint_for : Prims.unit  ->  Prims.string Prims.option = (fun uu____1845 -> (get_reuse_hint_for ()))


let silent : Prims.unit  ->  Prims.bool = (fun uu____1848 -> (get_silent ()))


let split_cases : Prims.unit  ->  Prims.int = (fun uu____1851 -> (get_split_cases ()))


let timing : Prims.unit  ->  Prims.bool = (fun uu____1854 -> (get_timing ()))


let trace_error : Prims.unit  ->  Prims.bool = (fun uu____1857 -> (get_trace_error ()))


let universes : Prims.unit  ->  Prims.bool = (fun uu____1860 -> (not ((get_stratified ()))))


let unthrottle_inductives : Prims.unit  ->  Prims.bool = (fun uu____1863 -> (get_unthrottle_inductives ()))


let use_eq_at_higher_order : Prims.unit  ->  Prims.bool = (fun uu____1866 -> (get_use_eq_at_higher_order ()))


let use_hints : Prims.unit  ->  Prims.bool = (fun uu____1869 -> (get_use_hints ()))


let verify_all : Prims.unit  ->  Prims.bool = (fun uu____1872 -> (get_verify_all ()))


let verify_module : Prims.unit  ->  Prims.string Prims.list = (fun uu____1876 -> (get_verify_module ()))


let warn_cardinality : Prims.unit  ->  Prims.bool = (fun uu____1879 -> (let _0_103 = (get_cardinality ())
in (_0_103 = "warn")))


let warn_top_level_effects : Prims.unit  ->  Prims.bool = (fun uu____1882 -> (get_warn_top_level_effects ()))


let z3_exe : Prims.unit  ->  Prims.string = (fun uu____1885 -> (

let uu____1886 = (get_smt ())
...
let z3_refresh : Prims.unit  ->  Prims.bool = (fun uu____1891 -> (get_z3refresh ()))


let z3_rlimit : Prims.unit  ->  Prims.int = (fun uu____1894 -> (get_z3rlimit ()))


let z3_seed : Prims.unit  ->  Prims.int = (fun uu____1897 -> (get_z3seed ()))


let z3_timeout : Prims.unit  ->  Prims.int = (fun uu____1900 -> (get_z3timeout ()))


let should_extract : Prims.string  ->  Prims.bool = (fun m -> ((not ((no_extract m))) && ((extract_all ()) || (

let uu____1904 = (get_extract_module ())
in (match (uu____1904) with
| [] -> begin
(

let uu____1906 = (get_extract_namespace ())
