...
let get_admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____537  -> lookup_opt "admit_smt_queries" as_bool
let get_check_hints: Prims.unit -> Prims.bool =
  fun uu____540  -> lookup_opt "check_hints" as_bool
let get_codegen: Prims.unit -> Prims.string Prims.option =
  fun uu____544  -> lookup_opt "codegen" (as_option as_string)
let get_codegen_lib: Prims.unit -> Prims.string Prims.list =
  fun uu____549  -> lookup_opt "codegen-lib" (as_list as_string)
let get_debug: Prims.unit -> Prims.string Prims.list =
  fun uu____554  -> lookup_opt "debug" (as_list as_string)
let get_debug_level: Prims.unit -> Prims.string Prims.list =
  fun uu____559  -> lookup_opt "debug_level" (as_list as_string)
let get_dep: Prims.unit -> Prims.string Prims.option =
  fun uu____564  -> lookup_opt "dep" (as_option as_string)
let get_detail_errors: Prims.unit -> Prims.bool =
  fun uu____568  -> lookup_opt "detail_errors" as_bool
let get_doc: Prims.unit -> Prims.bool =
  fun uu____571  -> lookup_opt "doc" as_bool
let get_dump_module: Prims.unit -> Prims.string Prims.list =
  fun uu____575  -> lookup_opt "dump_module" (as_list as_string)
let get_eager_inference: Prims.unit -> Prims.bool =
  fun uu____579  -> lookup_opt "eager_inference" as_bool
let get_explicit_deps: Prims.unit -> Prims.bool =
  fun uu____582  -> lookup_opt "explicit_deps" as_bool
let get_extract_all: Prims.unit -> Prims.bool =
  fun uu____585  -> lookup_opt "extract_all" as_bool
let get_extract_module: Prims.unit -> Prims.string Prims.list =
  fun uu____589  -> lookup_opt "extract_module" (as_list as_string)
let get_extract_namespace: Prims.unit -> Prims.string Prims.list =
  fun uu____594  -> lookup_opt "extract_namespace" (as_list as_string)
let get_fs_typ_app: Prims.unit -> Prims.bool =
  fun uu____598  -> lookup_opt "fs_typ_app" as_bool
let get_fstar_home: Prims.unit -> Prims.string Prims.option =
  fun uu____602  -> lookup_opt "fstar_home" (as_option as_string)
let get_hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____606  -> lookup_opt "hide_genident_nums" as_bool
let get_hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____609  -> lookup_opt "hide_uvar_nums" as_bool
let get_hint_info: Prims.unit -> Prims.bool =
  fun uu____612  -> lookup_opt "hint_info" as_bool
let get_in: Prims.unit -> Prims.bool =
  fun uu____615  -> lookup_opt "in" as_bool
let get_ide: Prims.unit -> Prims.bool =
  fun uu____618  -> lookup_opt "ide" as_bool
let get_include: Prims.unit -> Prims.string Prims.list =
  fun uu____622  -> lookup_opt "include" (as_list as_string)
let get_indent: Prims.unit -> Prims.bool =
  fun uu____626  -> lookup_opt "indent" as_bool
let get_initial_fuel: Prims.unit -> Prims.int =
  fun uu____629  -> lookup_opt "initial_fuel" as_int
let get_initial_ifuel: Prims.unit -> Prims.int =
  fun uu____632  -> lookup_opt "initial_ifuel" as_int
let get_inline_arith: Prims.unit -> Prims.bool =
  fun uu____635  -> lookup_opt "inline_arith" as_bool
let get_lax: Prims.unit -> Prims.bool =
  fun uu____638  -> lookup_opt "lax" as_bool
let get_log_queries: Prims.unit -> Prims.bool =
  fun uu____641  -> lookup_opt "log_queries" as_bool
let get_log_types: Prims.unit -> Prims.bool =
  fun uu____644  -> lookup_opt "log_types" as_bool
let get_max_fuel: Prims.unit -> Prims.int =
  fun uu____647  -> lookup_opt "max_fuel" as_int
let get_max_ifuel: Prims.unit -> Prims.int =
  fun uu____650  -> lookup_opt "max_ifuel" as_int
let get_min_fuel: Prims.unit -> Prims.int =
  fun uu____653  -> lookup_opt "min_fuel" as_int
let get_MLish: Prims.unit -> Prims.bool =
  fun uu____656  -> lookup_opt "MLish" as_bool
let get_n_cores: Prims.unit -> Prims.int =
  fun uu____659  -> lookup_opt "n_cores" as_int
let get_no_default_includes: Prims.unit -> Prims.bool =
  fun uu____662  -> lookup_opt "no_default_includes" as_bool
let get_no_extract: Prims.unit -> Prims.string Prims.list =
  fun uu____666  -> lookup_opt "no_extract" (as_list as_string)
let get_no_location_info: Prims.unit -> Prims.bool =
  fun uu____670  -> lookup_opt "no_location_info" as_bool
let get_odir: Prims.unit -> Prims.string Prims.option =
  fun uu____674  -> lookup_opt "odir" (as_option as_string)
let get_ugly: Prims.unit -> Prims.bool =
  fun uu____678  -> lookup_opt "ugly" as_bool
let get_prims: Prims.unit -> Prims.string Prims.option =
  fun uu____682  -> lookup_opt "prims" (as_option as_string)
let get_print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____686  -> lookup_opt "print_bound_var_types" as_bool
let get_print_effect_args: Prims.unit -> Prims.bool =
  fun uu____689  -> lookup_opt "print_effect_args" as_bool
let get_print_fuels: Prims.unit -> Prims.bool =
  fun uu____692  -> lookup_opt "print_fuels" as_bool
let get_print_full_names: Prims.unit -> Prims.bool =
  fun uu____695  -> lookup_opt "print_full_names" as_bool
let get_print_implicits: Prims.unit -> Prims.bool =
  fun uu____698  -> lookup_opt "print_implicits" as_bool
let get_print_universes: Prims.unit -> Prims.bool =
  fun uu____701  -> lookup_opt "print_universes" as_bool
let get_print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____704  -> lookup_opt "print_z3_statistics" as_bool
let get_prn: Prims.unit -> Prims.bool =
  fun uu____707  -> lookup_opt "prn" as_bool
let get_record_hints: Prims.unit -> Prims.bool =
  fun uu____710  -> lookup_opt "record_hints" as_bool
let get_reuse_hint_for: Prims.unit -> Prims.string Prims.option =
  fun uu____714  -> lookup_opt "reuse_hint_for" (as_option as_string)
let get_show_signatures: Prims.unit -> Prims.string Prims.list =
  fun uu____719  -> lookup_opt "show_signatures" (as_list as_string)
let get_silent: Prims.unit -> Prims.bool =
  fun uu____723  -> lookup_opt "silent" as_bool
let get_smt: Prims.unit -> Prims.string Prims.option =
  fun uu____727  -> lookup_opt "smt" (as_option as_string)
let get_split_cases: Prims.unit -> Prims.int =
  fun uu____731  -> lookup_opt "split_cases" as_int
let get_timing: Prims.unit -> Prims.bool =
  fun uu____734  -> lookup_opt "timing" as_bool
let get_trace_error: Prims.unit -> Prims.bool =
  fun uu____737  -> lookup_opt "trace_error" as_bool
let get_unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____740  -> lookup_opt "unthrottle_inductives" as_bool
let get_use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____743  -> lookup_opt "use_eq_at_higher_order" as_bool
let get_use_hints: Prims.unit -> Prims.bool =
  fun uu____746  -> lookup_opt "use_hints" as_bool
let get_use_tactics: Prims.unit -> Prims.bool =
  fun uu____749  ->
    let uu____750 = lookup_opt "no_tactics" as_bool in
    Prims.op_Negation uu____750
...
let get_verify_all: Prims.unit -> Prims.bool =
  fun uu____761  -> lookup_opt "verify_all" as_bool
let get_verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____765  -> lookup_opt "verify_module" (as_list as_string)
let get___temp_no_proj: Prims.unit -> Prims.string Prims.list =
  fun uu____770  -> lookup_opt "__temp_no_proj" (as_list as_string)
let get_version: Prims.unit -> Prims.bool =
  fun uu____774  -> lookup_opt "version" as_bool
let get_warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____777  -> lookup_opt "warn_default_effects" as_bool
let get_z3cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____781  -> lookup_opt "z3cliopt" (as_list as_string)
let get_z3refresh: Prims.unit -> Prims.bool =
  fun uu____785  -> lookup_opt "z3refresh" as_bool
let get_z3rlimit: Prims.unit -> Prims.int =
  fun uu____788  -> lookup_opt "z3rlimit" as_int
let get_z3rlimit_factor: Prims.unit -> Prims.int =
  fun uu____791  -> lookup_opt "z3rlimit_factor" as_int
let get_z3seed: Prims.unit -> Prims.int =
  fun uu____794  -> lookup_opt "z3seed" as_int
let get_no_positivity: Prims.unit -> Prims.bool =
  fun uu____797  -> lookup_opt "__no_positivity" as_bool
let dlevel: Prims.string -> debug_level_t =
  fun uu___54_800  ->
    match uu___54_800 with
    | "Low" -> Low
    | "Medium" -> Medium
    | "High" -> High
    | "Extreme" -> Extreme
...
let debug_level_geq: debug_level_t -> Prims.bool =
  fun l2  ->
    let uu____812 = get_debug_level () in
    FStar_All.pipe_right uu____812
...
let display_version: Prims.unit -> Prims.unit =
  fun uu____839  ->
    let uu____840 =
      let uu____841 = FStar_ST.read _version in
      let uu____844 = FStar_ST.read _platform in
      let uu____847 = FStar_ST.read _compiler in
      let uu____850 = FStar_ST.read _date in
      let uu____853 = FStar_ST.read _commit in
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____841
        uu____844 uu____847 uu____850 uu____853 in
    FStar_Util.print_string uu____840
let display_usage_aux specs =
  FStar_Util.print_string "fstar.exe [options] file[s]\n";
  FStar_List.iter
    (fun uu____883  ->
       match uu____883 with
       | (uu____889,flag,p,doc) ->
           (match p with
            | FStar_Getopt.ZeroArgs ig ->
                if doc = ""
                then
                  let uu____898 =
                    let uu____899 = FStar_Util.colorize_bold flag in
                    FStar_Util.format1 "  --%s\n" uu____899 in
                  FStar_Util.print_string uu____898
                else
                  (let uu____901 =
                     let uu____902 = FStar_Util.colorize_bold flag in
                     FStar_Util.format2 "  --%s  %s\n" uu____902 doc in
                   FStar_Util.print_string uu____901)
            | FStar_Getopt.OneArg (uu____903,argname) ->
                if doc = ""
                then
                  let uu____909 =
                    let uu____910 = FStar_Util.colorize_bold flag in
                    let uu____911 = FStar_Util.colorize_bold argname in
                    FStar_Util.format2 "  --%s %s\n" uu____910 uu____911 in
                  FStar_Util.print_string uu____909
                else
                  (let uu____913 =
                     let uu____914 = FStar_Util.colorize_bold flag in
                     let uu____915 = FStar_Util.colorize_bold argname in
                     FStar_Util.format3 "  --%s %s  %s\n" uu____914 uu____915
                       doc in
                   FStar_Util.print_string uu____913))) specs
let mk_spec:
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____950 =
                let uu____951 = let uu____954 = f () in (name, uu____954) in
                set_option' uu____951 in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x =
                let uu____965 = let uu____968 = f x in (name, uu____968) in
                set_option' uu____965 in
...
let cons_extract_module: Prims.string -> option_val =
  fun s  ->
    let uu____975 =
      let uu____977 =
        let uu____979 = get_extract_module () in (FStar_String.lowercase s)
          :: uu____979 in
...
let cons_extract_namespace: Prims.string -> option_val =
  fun s  ->
    let uu____986 =
      let uu____988 =
        let uu____990 = get_extract_namespace () in
        (FStar_String.lowercase s) :: uu____990 in
      FStar_All.pipe_right uu____988
        (FStar_List.map (fun _0_27  -> String _0_27)) in
    List uu____986
let add_extract_module: Prims.string -> Prims.unit =
  fun s  ->
    let uu____997 = cons_extract_module s in
    set_option "extract_module" uu____997
let add_extract_namespace: Prims.string -> Prims.unit =
  fun s  ->
    let uu____1001 = cons_extract_namespace s in
    set_option "extract_namespace" uu____1001
let cons_verify_module: Prims.string -> option_val =
  fun s  ->
    let uu____1005 =
      let uu____1007 =
        let uu____1009 = get_verify_module () in (FStar_String.lowercase s)
          :: uu____1009 in
...
let cons_using_facts_from: Prims.string -> option_val =
  fun s  ->
    ...
    (let uu____1017 = get_using_facts_from () in
...
let add_verify_module: Prims.string -> Prims.unit =
  fun s  ->
    let uu____1029 = cons_verify_module s in
    set_option "verify_module" uu____1029
let rec specs:
  Prims.unit ->
  ...
  fun uu____1041  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  -> let uu____1070 = parse_codegen s in String uu____1070)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1080 =
                  let uu____1082 =
                    let uu____1084 = get_codegen_lib () in s :: uu____1084 in
                  FStar_All.pipe_right uu____1082
                    (FStar_List.map (fun _0_30  -> String _0_30)) in
                List uu____1080)), "[namespace]")),
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1114 =
                  let uu____1116 =
                    let uu____1118 = get_debug_level () in x :: uu____1118 in
                  FStar_All.pipe_right uu____1116
                    (FStar_List.map (fun _0_32  -> String _0_32)) in
                List uu____1114)), "[Low|Medium|High|Extreme|...]")),
      ...
      (FStar_Getopt.noshort, "detail_errors",
        (FStar_Getopt.ZeroArgs ((fun uu____1138  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1155 =
                  let uu____1157 =
                    let uu____1159 = get_dump_module () in x :: uu____1159 in
                  FStar_All.pipe_right uu____1157
                    (FStar_List.map (fun _0_33  -> String _0_33)) in
                FStar_All.pipe_right uu____1155 (fun _0_34  -> List _0_34))),
             "[module name]")), "");
      (FStar_Getopt.noshort, "eager_inference",
        (FStar_Getopt.ZeroArgs ((fun uu____1170  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "include",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1253 =
                  let uu____1255 =
                    let uu____1257 = get_include () in
                    FStar_List.map (fun _0_36  -> String _0_36) uu____1257 in
                  FStar_List.append uu____1255 [Path s] in
                List uu____1253)), "[path]")),
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1323 = FStar_Util.int_of_string x in Int uu____1323)),
             "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1377 =
                  let uu____1379 =
                    let uu____1381 = get_no_extract () in x :: uu____1381 in
                  FStar_All.pipe_right uu____1379
                    (FStar_List.map (fun _0_37  -> String _0_37)) in
                List uu____1377)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "odir",
        (FStar_Getopt.OneArg
           (((fun p  -> let uu____1401 = validate_dir p in Path uu____1401)),
      ...
      (FStar_Getopt.noshort, "print_bound_var_types",
        (FStar_Getopt.ZeroArgs ((fun uu____1416  -> Bool true))),
        "Print the types of bound variables");
      (FStar_Getopt.noshort, "print_effect_args",
        (FStar_Getopt.ZeroArgs ((fun uu____1423  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n1  ->
                let uu____1529 = FStar_Util.int_of_string n1 in
                Int uu____1529)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "ugly",
        (FStar_Getopt.ZeroArgs ((fun uu____1550  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "use_eq_at_higher_order",
        (FStar_Getopt.ZeroArgs ((fun uu____1564  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "verify_all",
        (FStar_Getopt.ZeroArgs ((fun uu____1593  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1611 =
                  let uu____1613 =
                    let uu____1615 = get___temp_no_proj () in x :: uu____1615 in
                  FStar_All.pipe_right uu____1613
                    (FStar_List.map (fun _0_42  -> String _0_42)) in
                List uu____1611)), "[module name]")),
      ...
      (FStar_Getopt.noshort, "z3cliopt",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1643 =
                  let uu____1645 =
                    let uu____1647 = get_z3cliopt () in
                    FStar_List.append uu____1647 [s] in
                  FStar_All.pipe_right uu____1645
                    (FStar_List.map (fun _0_43  -> String _0_43)) in
                List uu____1643)), "[option]")), "Z3 command line options");
      (FStar_Getopt.noshort, "z3refresh",
        (FStar_Getopt.ZeroArgs ((fun uu____1657  -> Bool true))),
        "Restart Z3 after each query; useful for ensuring proof robustness");
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1667 = FStar_Util.int_of_string s in Int uu____1667)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1677 = FStar_Util.int_of_string s in Int uu____1677)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1687 = FStar_Util.int_of_string s in Int uu____1687)),
    ...
    let uu____1700 = FStar_List.map mk_spec specs1 in
    ('h', "help",
      (FStar_Getopt.ZeroArgs
         (fun x  ->
            display_usage_aux specs1; FStar_All.exit (Prims.parse_int "0"))),
      "Display this information") :: uu____1700
  ...
  fun s  ->
    ...
    | uu____1721 ->
        (FStar_Util.print_string "Wrong argument to codegen flag\n";
         (let uu____1724 = specs () in display_usage_aux uu____1724);
         FStar_All.exit (Prims.parse_int "1"))
and string_as_bool: Prims.string -> Prims.string -> option_val =
  fun option_name  ->
    fun uu___55_1732  ->
      match uu___55_1732 with
      | "true" -> Bool true
      | "false" -> Bool false
      | uu____1733 ->
          (FStar_Util.print1 "Wrong argument to %s\n" option_name;
           (let uu____1736 = specs () in display_usage_aux uu____1736);
           FStar_All.exit (Prims.parse_int "1"))
...
let docs: Prims.unit -> (Prims.string* Prims.string) Prims.list =
  fun uu____1750  ->
    let uu____1751 = specs () in
    FStar_List.map
      (fun uu____1765  ->
         match uu____1765 with
         | (uu____1773,name,uu____1775,doc) -> (name, doc)) uu____1751
let settable: Prims.string -> Prims.bool =
  fun uu___56_1781  ->
    match uu___56_1781 with
    | "admit_smt_queries"
      |"debug"
       |"debug_level"
        |"detail_errors"
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1805  ->
          ...
          | (uu____1811,x,uu____1813,uu____1814) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1835  ->
          ...
          | (uu____1841,x,uu____1843,uu____1844) -> resettable x))
let display_usage: Prims.unit -> Prims.unit =
  fun uu____1849  ->
    let uu____1850 = specs () in display_usage_aux uu____1850
let fstar_home: Prims.unit -> Prims.string =
  fun uu____1859  ->
    let uu____1860 = get_fstar_home () in
...
let uu___is_File_argument: Prims.exn -> Prims.bool =
  fun projectee  ->
    ...
    | File_argument uu____1871 -> true
    | uu____1872 -> false
let __proj__File_argument__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | File_argument uu____1879 -> uu____1879
  ...
  fun o  ->
    fun s  ->
      ...
      | File_argument s1 ->
          ...
          FStar_Getopt.Error uu____1905
let file_list_: Prims.string Prims.list FStar_ST.ref = FStar_Util.mk_ref []
let parse_cmd_line:
  Prims.unit -> (FStar_Getopt.parse_cmdline_res* Prims.string Prims.list) =
  fun uu____1916  ->
    let res =
      let uu____1918 = specs () in
      FStar_Getopt.parse_cmdline uu____1918
        (fun i  ->
           let uu____1921 =
             let uu____1923 = FStar_ST.read file_list_ in
             FStar_List.append uu____1923 [i] in
           FStar_ST.write file_list_ uu____1921) in
    let uu____1931 =
      let uu____1933 = FStar_ST.read file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1933 in
    (res, uu____1931)
let file_list: Prims.unit -> Prims.string Prims.list =
  fun uu____1942  -> FStar_ST.read file_list_
let restore_cmd_line_options: Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module () in
    if should_clear then clear () else init ();
    (let r =
       let uu____1954 = specs () in
       FStar_Getopt.parse_cmdline uu____1954 (fun x  -> ()) in
     (let uu____1958 =
        let uu____1961 =
          let uu____1962 =
            FStar_List.map (fun _0_44  -> String _0_44) old_verify_module in
          List uu____1962 in
        ("verify_module", uu____1961) in
      set_option' uu____1958);
     r)
let should_verify: Prims.string -> Prims.bool =
  fun m  ->
    let uu____1967 = get_lax () in
    if uu____1967
    then false
    else
      (let uu____1969 = get_verify_all () in
       if uu____1969
       then true
       else
         (let uu____1971 = get_verify_module () in
          match uu____1971 with
          | [] ->
              let uu____1973 = file_list () in
              FStar_List.existsML
                (fun f  ->
                   ...
                   let f2 =
                     let uu____1978 =
                       let uu____1979 =
                         let uu____1980 =
                           let uu____1981 = FStar_Util.get_file_extension f1 in
                           FStar_String.length uu____1981 in
                         (FStar_String.length f1) - uu____1980 in
                       uu____1979 - (Prims.parse_int "1") in
                     FStar_String.substring f1 (Prims.parse_int "0")
                       uu____1978 in
                   (FStar_String.lowercase f2) = m) uu____1973
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
let dont_gen_projectors: Prims.string -> Prims.bool =
  fun m  ->
    let uu____1991 = get___temp_no_proj () in
    FStar_List.contains m uu____1991
let should_print_message: Prims.string -> Prims.bool =
  fun m  ->
    let uu____1996 = should_verify m in
    if uu____1996 then m <> "Prims" else false
let include_path: Prims.unit -> Prims.string Prims.list =
  fun uu____2001  ->
    let uu____2002 = get_no_default_includes () in
    if uu____2002
    then get_include ()
    else
      (let h = fstar_home () in
       ...
       let uu____2017 =
         let uu____2019 = get_include () in
         FStar_List.append uu____2019 ["."] in
       FStar_List.append uu____2008 uu____2017)
let find_file: Prims.string -> Prims.string Prims.option =
  fun filename  ->
    let uu____2025 = FStar_Util.is_path_absolute filename in
    if uu____2025
    then (if FStar_Util.file_exists filename then Some filename else None)
    else
      (let uu____2030 =
         let uu____2032 = include_path () in FStar_List.rev uu____2032 in
       FStar_Util.find_map uu____2030
         (fun p  ->
            let path = FStar_Util.join_paths p filename in
            if FStar_Util.file_exists path then Some path else None))
let prims: Prims.unit -> Prims.string =
  fun uu____2040  ->
    let uu____2041 = get_prims () in
    match uu____2041 with
    | None  ->
        let filename = "prims.fst" in
        let uu____2044 = find_file filename in
             ...
             let uu____2047 =
               let uu____2048 =
                 FStar_Util.format1
                   ...
                   filename in
               FStar_Util.Failure uu____2048 in
             raise uu____2047)
    | Some x -> x
let prims_basename: Prims.unit -> Prims.string =
  fun uu____2052  ->
    let uu____2053 = prims () in FStar_Util.basename uu____2053
let pervasives: Prims.unit -> Prims.string =
  fun uu____2056  ->
    let filename = "FStar.Pervasives.fst" in
    let uu____2058 = find_file filename in
        ...
        let uu____2061 =
          let uu____2062 =
            FStar_Util.format1
              "unable to find required file \"%s\" in the module search path.\n"
              filename in
          FStar_Util.Failure uu____2062 in
        raise uu____2061
let pervasives_basename: Prims.unit -> Prims.string =
  fun uu____2065  ->
    let uu____2066 = pervasives () in FStar_Util.basename uu____2066
let prepend_output_dir: Prims.string -> Prims.string =
  fun fname  ->
    let uu____2070 = get_odir () in
    match uu____2070 with
    | None  -> fname
    | Some x -> Prims.strcat x (Prims.strcat "/" fname)
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2076 = get___temp_no_proj () in
    FStar_All.pipe_right uu____2076 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____2081  -> get_admit_smt_queries ()
let check_hints: Prims.unit -> Prims.bool =
  fun uu____2084  -> get_check_hints ()
let codegen: Prims.unit -> Prims.string Prims.option =
  fun uu____2088  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____2093  ->
    let uu____2094 = get_codegen_lib () in
    FStar_All.pipe_right uu____2094
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____2103  -> let uu____2104 = get_debug () in uu____2104 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____2113 = get_debug () in
          FStar_All.pipe_right uu____2113 (FStar_List.contains modul)))
        && (debug_level_geq level)
let dep: Prims.unit -> Prims.string Prims.option =
  fun uu____2119  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____2122  -> get_detail_errors ()
let doc: Prims.unit -> Prims.bool = fun uu____2125  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2129 = get_dump_module () in
    FStar_All.pipe_right uu____2129 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____2134  -> get_eager_inference ()
let explicit_deps: Prims.unit -> Prims.bool =
  fun uu____2137  -> get_explicit_deps ()
let extract_all: Prims.unit -> Prims.bool =
  fun uu____2140  -> get_extract_all ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____2144 = FStar_ST.read light_off_files in
    FStar_List.contains filename uu____2144
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____2151  -> true
let hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____2154  -> get_hide_genident_nums ()
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____2157  -> get_hide_uvar_nums ()
let hint_info: Prims.unit -> Prims.bool = fun uu____2160  -> get_hint_info ()
let ide: Prims.unit -> Prims.bool = fun uu____2163  -> get_ide ()
let indent: Prims.unit -> Prims.bool = fun uu____2166  -> get_indent ()
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____2169  ->
    let uu____2170 = get_initial_fuel () in
    let uu____2171 = get_max_fuel () in Prims.min uu____2170 uu____2171
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____2174  ->
    let uu____2175 = get_initial_ifuel () in
    let uu____2176 = get_max_ifuel () in Prims.min uu____2175 uu____2176
let inline_arith: Prims.unit -> Prims.bool =
  fun uu____2179  -> get_inline_arith ()
let interactive: Prims.unit -> Prims.bool =
  fun uu____2182  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____2185  -> get_lax ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____2188  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____2191  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____2194  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____2197  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____2200  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____2203  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____2206  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____2209  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____2212  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____2215  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2219 = get_no_extract () in
    FStar_All.pipe_right uu____2219 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____2224  -> get_no_location_info ()
let output_dir: Prims.unit -> Prims.string Prims.option =
  fun uu____2228  -> get_odir ()
let ugly: Prims.unit -> Prims.bool = fun uu____2231  -> get_ugly ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____2234  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____2237  -> get_print_effect_args ()
let print_fuels: Prims.unit -> Prims.bool =
  fun uu____2240  -> get_print_fuels ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____2243  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____2246  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____2249  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____2252  -> get_print_z3_statistics ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____2255  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string Prims.option =
  fun uu____2259  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____2262  -> get_silent ()
let split_cases: Prims.unit -> Prims.int =
  fun uu____2265  -> get_split_cases ()
let timing: Prims.unit -> Prims.bool = fun uu____2268  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____2271  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____2274  -> get_unthrottle_inductives ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____2277  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____2280  -> get_use_hints ()
let use_tactics: Prims.unit -> Prims.bool =
  fun uu____2283  -> get_use_tactics ()
let using_facts_from: Prims.unit -> Prims.string Prims.list Prims.option =
  fun uu____2288  -> get_using_facts_from ()
let verify_all: Prims.unit -> Prims.bool =
  fun uu____2291  -> get_verify_all ()
let verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____2295  -> get_verify_module ()
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____2298  -> get_warn_default_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____2301  ->
    let uu____2302 = get_smt () in
    match uu____2302 with | None  -> FStar_Platform.exe "z3" | Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____2308  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____2311  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____2314  -> get_z3rlimit ()
let z3_rlimit_factor: Prims.unit -> Prims.int =
  fun uu____2317  -> get_z3rlimit_factor ()
let z3_seed: Prims.unit -> Prims.int = fun uu____2320  -> get_z3seed ()
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____2323  -> get_no_positivity ()
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2327 = no_extract m in Prims.op_Negation uu____2327) &&
      ((extract_all ()) ||
         (let uu____2328 = get_extract_module () in
          match uu____2328 with
          | [] ->
              let uu____2330 = get_extract_namespace () in
