...
let (uu___is_Reset : options -> Prims.bool) =
  fun projectee -> match projectee with | Reset -> true | uu____301 -> false
...
let (uu___is_CFatal : error_flag -> Prims.bool) =
  fun projectee -> match projectee with | CFatal -> true | uu____323 -> false
...
let (uu___is_CError : error_flag -> Prims.bool) =
  fun projectee -> match projectee with | CError -> true | uu____345 -> false
...
let (set_option : Prims.string -> option_val -> unit) =
  fun k ->
    fun v1 -> let uu____1279 = peek () in FStar_Util.smap_add uu____1279 k v1
let (set_option' : (Prims.string * option_val) -> unit) =
...
let (parse_warn_error : Prims.string -> error_flag Prims.list) =
  fun s ->
    let uu____2553 = FStar_Pervasives_Native.snd parse_warn_error_set_get () in
    uu____2553 s
let (init : unit -> unit) =
  fun uu____2584 ->
    let o = peek () in
...
let (get_in : unit -> Prims.bool) = fun uu____3043 -> lookup_opt "in" as_bool
...
let (display_version : unit -> unit) =
  fun uu____3901 ->
    let uu____3902 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____3904
        uu____3927 uu____3950 uu____3973 uu____3996 in
    ...
    | (ns, name, arg, desc) ->
        let arg1 =
          ...
          | FStar_Getopt.OneArg (f, d) ->
              let g x = let uu____4254 = f x in set_option name uu____4254 in
  ...
  fun name ->
    fun post_processor ->
      fun value ->
        let uu____4349 =
          let uu____4350 =
            let uu____4351 = post_processor value in mk_string uu____4351 in
          ...
          (fun uu___293_4826 ->
             ...
             | () ->
                 (match typ with
                  | Const c -> c
                  | IntStr uu____4828 ->
                      let uu____4830 = FStar_Util.safe_int_of_string str_val in
  ...
  fun uu____5090 ->
    let uu____5104 =
                                    ...
                                    let uu____5448 =
                                      let uu____5462 =
                                        ...
                                        let uu____5496 =
                                          let uu____5510 =
                                            let uu____5522 =
                                              let uu____5523 = mk_bool true in
                                              Const uu____5523 in
                                            (FStar_Getopt.noshort,
                                                  ...
                                                  let uu____5606 =
                                                    ...
                                                    let uu____5640 =
                                                              ...
                                                              let uu____5770
                                                                ...
                                                                let uu____5804
                                                                  ...
                                                                  let uu____5838
                                                                    ...
                                                                    "profile",
                                                                    uu____5864,
                                                                    "Prints timing information for various operations in the compiler") in
                                                                    let uu____5872
                                                                    =
                                                                    let uu____5886
                                                                    =
                                                      ...
                                                      (FStar_Getopt.noshort,
                                                        ...
                                                        :: uu____5654 in
                                                    uu____5620 :: uu____5640 in
                                                  uu____5586 :: uu____5606 in
                                                (FStar_Getopt.noshort,
                                                  "extract_namespace",
                                                  (Accumulated
                                                     (PostProcessed
      ...
      (FStar_Getopt.noshort, "admit_smt_queries", BoolStr,
        "Admit SMT queries, unsafe! (default 'false')") :: uu____5118 in
...
let (display_usage : unit -> unit) =
  fun uu____9880 -> let uu____9881 = specs () in display_usage_aux uu____9881
    ...
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____9995) in
    let uu____10056 =
      let uu____10060 = FStar_ST.op_Bang file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____10060 in
    (res, uu____10056)
...
let (include_path : unit -> Prims.string Prims.list) =
  fun uu____10281 ->
    ...
    then
      ...
      (let lib_paths =
         let uu____10317 = FStar_Util.expand_environment_variable "FSTAR_LIB" in
...
let (load : unit -> Prims.string Prims.list) = fun uu____11531 -> get_load ()
...
let (warn_error : unit -> Prims.string) =
  fun uu____12121 ->
    let uu____12122 = get_warn_error () in FStar_String.concat "" uu____12122
        ...
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____12349 ->
                ...
                | (path, uu____12360) -> matches_path m_components path)) in
