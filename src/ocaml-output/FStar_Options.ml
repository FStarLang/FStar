...
let get_option: Prims.string -> option_val =
  fun s  ->
    let uu____1504 =
      let uu____1507 = peek () in FStar_Util.smap_try_find uu____1507 s in
...
let lookup_opt:
  'Auu____1517 . Prims.string -> (option_val -> 'Auu____1517) -> 'Auu____1517
  = fun s  -> fun c  -> c (get_option s)
let get_admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____1534  -> lookup_opt "admit_smt_queries" as_bool
let get_admit_except:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1540  -> lookup_opt "admit_except" (as_option as_string)
let get_cache_checked_modules: Prims.unit -> Prims.bool =
  fun uu____1546  -> lookup_opt "cache_checked_modules" as_bool
let get_codegen: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1552  -> lookup_opt "codegen" (as_option as_string)
let get_codegen_lib: Prims.unit -> Prims.string Prims.list =
  fun uu____1560  -> lookup_opt "codegen-lib" (as_list as_string)
let get_debug: Prims.unit -> Prims.string Prims.list =
  fun uu____1568  -> lookup_opt "debug" (as_list as_string)
let get_debug_level: Prims.unit -> Prims.string Prims.list =
  fun uu____1576  -> lookup_opt "debug_level" (as_list as_string)
let get_dep: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1584  -> lookup_opt "dep" (as_option as_string)
let get_detail_errors: Prims.unit -> Prims.bool =
  fun uu____1590  -> lookup_opt "detail_errors" as_bool
let get_detail_hint_replay: Prims.unit -> Prims.bool =
  fun uu____1594  -> lookup_opt "detail_hint_replay" as_bool
let get_doc: Prims.unit -> Prims.bool =
  fun uu____1598  -> lookup_opt "doc" as_bool
let get_dump_module: Prims.unit -> Prims.string Prims.list =
  fun uu____1604  -> lookup_opt "dump_module" (as_list as_string)
let get_eager_inference: Prims.unit -> Prims.bool =
  fun uu____1610  -> lookup_opt "eager_inference" as_bool
let get_explicit_deps: Prims.unit -> Prims.bool =
  fun uu____1614  -> lookup_opt "explicit_deps" as_bool
let get_extract_all: Prims.unit -> Prims.bool =
  fun uu____1618  -> lookup_opt "extract_all" as_bool
let get_extract_module: Prims.unit -> Prims.string Prims.list =
  fun uu____1624  -> lookup_opt "extract_module" (as_list as_string)
let get_extract_namespace: Prims.unit -> Prims.string Prims.list =
  fun uu____1632  -> lookup_opt "extract_namespace" (as_list as_string)
let get_fs_typ_app: Prims.unit -> Prims.bool =
  fun uu____1638  -> lookup_opt "fs_typ_app" as_bool
let get_fstar_home: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____1644  -> lookup_opt "fstar_home" (as_option as_string)
let get_gen_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1652  -> lookup_opt "gen_native_tactics" (as_option as_string)
let get_hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____1658  -> lookup_opt "hide_genident_nums" as_bool
let get_hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____1662  -> lookup_opt "hide_uvar_nums" as_bool
let get_hint_info: Prims.unit -> Prims.bool =
  fun uu____1666  -> lookup_opt "hint_info" as_bool
let get_hint_file: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____1672  -> lookup_opt "hint_file" (as_option as_string)
let get_in: Prims.unit -> Prims.bool =
  fun uu____1678  -> lookup_opt "in" as_bool
let get_ide: Prims.unit -> Prims.bool =
  fun uu____1682  -> lookup_opt "ide" as_bool
let get_include: Prims.unit -> Prims.string Prims.list =
  fun uu____1688  -> lookup_opt "include" (as_list as_string)
let get_indent: Prims.unit -> Prims.bool =
  fun uu____1694  -> lookup_opt "indent" as_bool
let get_initial_fuel: Prims.unit -> Prims.int =
  fun uu____1698  -> lookup_opt "initial_fuel" as_int
let get_initial_ifuel: Prims.unit -> Prims.int =
  fun uu____1702  -> lookup_opt "initial_ifuel" as_int
let get_lax: Prims.unit -> Prims.bool =
  fun uu____1706  -> lookup_opt "lax" as_bool
let get_load: Prims.unit -> Prims.string Prims.list =
  fun uu____1712  -> lookup_opt "load" (as_list as_string)
let get_log_queries: Prims.unit -> Prims.bool =
  fun uu____1718  -> lookup_opt "log_queries" as_bool
let get_log_types: Prims.unit -> Prims.bool =
  fun uu____1722  -> lookup_opt "log_types" as_bool
let get_max_fuel: Prims.unit -> Prims.int =
  fun uu____1726  -> lookup_opt "max_fuel" as_int
let get_max_ifuel: Prims.unit -> Prims.int =
  fun uu____1730  -> lookup_opt "max_ifuel" as_int
let get_min_fuel: Prims.unit -> Prims.int =
  fun uu____1734  -> lookup_opt "min_fuel" as_int
let get_MLish: Prims.unit -> Prims.bool =
  fun uu____1738  -> lookup_opt "MLish" as_bool
let get_n_cores: Prims.unit -> Prims.int =
  fun uu____1742  -> lookup_opt "n_cores" as_int
let get_no_default_includes: Prims.unit -> Prims.bool =
  fun uu____1746  -> lookup_opt "no_default_includes" as_bool
let get_no_extract: Prims.unit -> Prims.string Prims.list =
  fun uu____1752  -> lookup_opt "no_extract" (as_list as_string)
...
let get_odir: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1764  -> lookup_opt "odir" (as_option as_string)
let get_ugly: Prims.unit -> Prims.bool =
  fun uu____1770  -> lookup_opt "ugly" as_bool
let get_prims: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1776  -> lookup_opt "prims" (as_option as_string)
let get_print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____1782  -> lookup_opt "print_bound_var_types" as_bool
let get_print_effect_args: Prims.unit -> Prims.bool =
  fun uu____1786  -> lookup_opt "print_effect_args" as_bool
let get_print_full_names: Prims.unit -> Prims.bool =
  fun uu____1790  -> lookup_opt "print_full_names" as_bool
let get_print_implicits: Prims.unit -> Prims.bool =
  fun uu____1794  -> lookup_opt "print_implicits" as_bool
let get_print_universes: Prims.unit -> Prims.bool =
  fun uu____1798  -> lookup_opt "print_universes" as_bool
let get_print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____1802  -> lookup_opt "print_z3_statistics" as_bool
let get_prn: Prims.unit -> Prims.bool =
  fun uu____1806  -> lookup_opt "prn" as_bool
let get_query_stats: Prims.unit -> Prims.bool =
  fun uu____1810  -> lookup_opt "query_stats" as_bool
let get_record_hints: Prims.unit -> Prims.bool =
  fun uu____1814  -> lookup_opt "record_hints" as_bool
let get_reuse_hint_for:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1820  -> lookup_opt "reuse_hint_for" (as_option as_string)
let get_show_signatures: Prims.unit -> Prims.string Prims.list =
  fun uu____1828  -> lookup_opt "show_signatures" (as_list as_string)
let get_silent: Prims.unit -> Prims.bool =
  fun uu____1834  -> lookup_opt "silent" as_bool
let get_smt: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1840  -> lookup_opt "smt" (as_option as_string)
let get_smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____1846  -> lookup_opt "smtencoding.elim_box" as_bool
let get_smtencoding_nl_arith_repr: Prims.unit -> Prims.string =
  fun uu____1850  -> lookup_opt "smtencoding.nl_arith_repr" as_string
let get_smtencoding_l_arith_repr: Prims.unit -> Prims.string =
  fun uu____1854  -> lookup_opt "smtencoding.l_arith_repr" as_string
let get_split_cases: Prims.unit -> Prims.int =
  fun uu____1858  -> lookup_opt "split_cases" as_int
let get_tactic_trace: Prims.unit -> Prims.bool =
  fun uu____1862  -> lookup_opt "tactic_trace" as_bool
let get_tactic_trace_d: Prims.unit -> Prims.int =
  fun uu____1866  -> lookup_opt "tactic_trace_d" as_int
let get_timing: Prims.unit -> Prims.bool =
  fun uu____1870  -> lookup_opt "timing" as_bool
let get_trace_error: Prims.unit -> Prims.bool =
  fun uu____1874  -> lookup_opt "trace_error" as_bool
let get_unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____1878  -> lookup_opt "unthrottle_inductives" as_bool
let get_unsafe_tactic_exec: Prims.unit -> Prims.bool =
  fun uu____1882  -> lookup_opt "unsafe_tactic_exec" as_bool
let get_use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____1886  -> lookup_opt "use_eq_at_higher_order" as_bool
let get_use_hints: Prims.unit -> Prims.bool =
  fun uu____1890  -> lookup_opt "use_hints" as_bool
let get_use_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1896  -> lookup_opt "use_native_tactics" (as_option as_string)
let get_use_tactics: Prims.unit -> Prims.bool =
  fun uu____1902  ->
    let uu____1903 = lookup_opt "no_tactics" as_bool in
    Prims.op_Negation uu____1903
let get_using_facts_from:
  Prims.unit -> Prims.string Prims.list FStar_Pervasives_Native.option =
  fun uu____1911  ->
    lookup_opt "using_facts_from" (as_option (as_list as_string))
let get_verify_all: Prims.unit -> Prims.bool =
  fun uu____1921  -> lookup_opt "verify_all" as_bool
let get_verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____1927  -> lookup_opt "verify_module" (as_list as_string)
let get___temp_no_proj: Prims.unit -> Prims.string Prims.list =
  fun uu____1935  -> lookup_opt "__temp_no_proj" (as_list as_string)
let get_version: Prims.unit -> Prims.bool =
  fun uu____1941  -> lookup_opt "version" as_bool
let get_warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____1945  -> lookup_opt "warn_default_effects" as_bool
let get_z3cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____1951  -> lookup_opt "z3cliopt" (as_list as_string)
let get_z3refresh: Prims.unit -> Prims.bool =
  fun uu____1957  -> lookup_opt "z3refresh" as_bool
let get_z3rlimit: Prims.unit -> Prims.int =
  fun uu____1961  -> lookup_opt "z3rlimit" as_int
let get_z3rlimit_factor: Prims.unit -> Prims.int =
  fun uu____1965  -> lookup_opt "z3rlimit_factor" as_int
let get_z3seed: Prims.unit -> Prims.int =
  fun uu____1969  -> lookup_opt "z3seed" as_int
let get_no_positivity: Prims.unit -> Prims.bool =
  fun uu____1973  -> lookup_opt "__no_positivity" as_bool
let get_ml_no_eta_expand_coertions: Prims.unit -> Prims.bool =
  fun uu____1977  -> lookup_opt "__ml_no_eta_expand_coertions" as_bool
let dlevel: Prims.string -> debug_level_t =
  fun uu___53_1981  ->
    match uu___53_1981 with
    | "Low" -> Low
    | "Medium" -> Medium
    | "High" -> High
    | "Extreme" -> Extreme
...
let debug_level_geq: debug_level_t -> Prims.bool =
  fun l2  ->
    let uu____1996 = get_debug_level () in
...
let display_version: Prims.unit -> Prims.unit =
  fun uu____2088  ->
    let uu____2089 =
      let uu____2090 = FStar_ST.op_Bang _version in
      let uu____2137 = FStar_ST.op_Bang _platform in
      let uu____2184 = FStar_ST.op_Bang _compiler in
      let uu____2231 = FStar_ST.op_Bang _date in
      let uu____2278 = FStar_ST.op_Bang _commit in
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____2090
        uu____2137 uu____2184 uu____2231 uu____2278 in
    FStar_Util.print_string uu____2089
let display_usage_aux:
  'Auu____2331 'Auu____2332 .
    ('Auu____2332,Prims.string,'Auu____2331 FStar_Getopt.opt_variant,
             ...
             (match p with
              | FStar_Getopt.ZeroArgs ig ->
                  ...
                  then
                    ...
                    (let uu____2404 =
                       let uu____2405 = FStar_Util.colorize_bold flag in
                       FStar_Util.format2 "  --%s  %s\n" uu____2405 doc in
                     FStar_Util.print_string uu____2404)
              | FStar_Getopt.OneArg (uu____2406,argname) ->
                  if doc = ""
                  then
                    let uu____2412 =
                      let uu____2413 = FStar_Util.colorize_bold flag in
                      let uu____2414 = FStar_Util.colorize_bold argname in
                      FStar_Util.format2 "  --%s %s\n" uu____2413 uu____2414 in
                    FStar_Util.print_string uu____2412
                  else
                    (let uu____2416 =
                       let uu____2417 = FStar_Util.colorize_bold flag in
                       let uu____2418 = FStar_Util.colorize_bold argname in
                       FStar_Util.format3 "  --%s %s  %s\n" uu____2417
                         uu____2418 doc in
                     FStar_Util.print_string uu____2416))) specs
let mk_spec:
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____2473 =
                let uu____2474 = f () in set_option name uu____2474 in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x = let uu____2485 = f x in set_option name uu____2485 in
...
let accumulated_option: Prims.string -> option_val -> option_val =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____2501 = lookup_opt name (as_option as_list') in
        FStar_Util.dflt [] uu____2501 in
      mk_list (value :: prev_values)
let reverse_accumulated_option: Prims.string -> option_val -> option_val =
  fun name  ->
    fun value  ->
      let uu____2522 =
        let uu____2525 = lookup_opt name as_list' in
        FStar_List.append uu____2525 [value] in
      mk_list uu____2522
let accumulate_string:
  'Auu____2538 .
    Prims.string ->
      ('Auu____2538 -> Prims.string) -> 'Auu____2538 -> Prims.unit
  =
  fun name  ->
    fun post_processor  ->
      fun value  ->
        let uu____2556 =
          let uu____2557 =
            let uu____2558 = post_processor value in mk_string uu____2558 in
          accumulated_option name uu____2557 in
        set_option name uu____2556
...
let uu___is_Const: opt_type -> Prims.bool =
  fun projectee  ->
    match projectee with | Const _0 -> true | uu____2640 -> false
let __proj__Const__item___0: opt_type -> option_val =
  fun projectee  -> match projectee with | Const _0 -> _0
let uu___is_IntStr: opt_type -> Prims.bool =
  fun projectee  ->
    match projectee with | IntStr _0 -> true | uu____2654 -> false
let __proj__IntStr__item___0: opt_type -> Prims.string =
  fun projectee  -> match projectee with | IntStr _0 -> _0
let uu___is_BoolStr: opt_type -> Prims.bool =
  fun projectee  ->
    match projectee with | BoolStr  -> true | uu____2667 -> false
let uu___is_PathStr: opt_type -> Prims.bool =
  fun projectee  ->
    match projectee with | PathStr _0 -> true | uu____2673 -> false
let __proj__PathStr__item___0: opt_type -> Prims.string =
  fun projectee  -> match projectee with | PathStr _0 -> _0
let uu___is_SimpleStr: opt_type -> Prims.bool =
  fun projectee  ->
    match projectee with | SimpleStr _0 -> true | uu____2687 -> false
let __proj__SimpleStr__item___0: opt_type -> Prims.string =
  fun projectee  -> match projectee with | SimpleStr _0 -> _0
let uu___is_EnumStr: opt_type -> Prims.bool =
  fun projectee  ->
    match projectee with | EnumStr _0 -> true | uu____2703 -> false
let __proj__EnumStr__item___0: opt_type -> Prims.string Prims.list =
  fun projectee  -> match projectee with | EnumStr _0 -> _0
let uu___is_OpenEnumStr: opt_type -> Prims.bool =
  fun projectee  ->
    match projectee with | OpenEnumStr _0 -> true | uu____2729 -> false
...
let uu___is_PostProcessed: opt_type -> Prims.bool =
  fun projectee  ->
    match projectee with | PostProcessed _0 -> true | uu____2767 -> false
...
let uu___is_Accumulated: opt_type -> Prims.bool =
  fun projectee  ->
    match projectee with | Accumulated _0 -> true | uu____2799 -> false
...
let uu___is_WithSideEffect: opt_type -> Prims.bool =
  fun projectee  ->
    match projectee with | WithSideEffect _0 -> true | uu____2833 -> false
...
let uu___is_InvalidArgument: Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with
    | InvalidArgument uu____2867 -> true
    | uu____2868 -> false
let __proj__InvalidArgument__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | InvalidArgument uu____2876 -> uu____2876
    ...
    fun typ  ->
      fun str_val  ->
        try
          ...
          | Const c -> c
          | IntStr uu____2893 ->
              let uu____2894 = FStar_Util.safe_int_of_string str_val in
          ...
          | BoolStr  ->
              ...
              mk_bool uu____2898
          | PathStr uu____2901 -> mk_path str_val
          | SimpleStr uu____2902 -> mk_string str_val
          | EnumStr strs ->
              if FStar_List.mem str_val strs
              then mk_string str_val
              else FStar_Exn.raise (InvalidArgument opt_name)
          | OpenEnumStr uu____2907 -> mk_string str_val
          | PostProcessed (pp,elem_spec) ->
              let uu____2920 = parse_opt_val opt_name elem_spec str_val in
              pp uu____2920
...
let rec desc_of_opt_type:
  ...
  fun typ  ->
    ...
    | PostProcessed (uu____2971,elem_spec) -> desc_of_opt_type elem_spec
    | Accumulated elem_spec -> desc_of_opt_type elem_spec
    | ReverseAccumulated elem_spec -> desc_of_opt_type elem_spec
    | WithSideEffect (uu____2979,elem_spec) -> desc_of_opt_type elem_spec
let rec arg_spec_of_opt_type:
  Prims.string -> opt_type -> option_val FStar_Getopt.opt_variant =
  fun opt_name  ->
    fun typ  ->
      let parser = parse_opt_val opt_name typ in
      let uu____3000 = desc_of_opt_type typ in
...
let pp_lowercase: option_val -> option_val =
  fun s  ->
    let uu____3020 =
      let uu____3021 = as_string s in FStar_String.lowercase uu____3021 in
    mk_string uu____3020
let rec specs_with_types:
  ...
  fun uu____3038  ->
    let uu____3049 =
      let uu____3060 =
        let uu____3071 =
          let uu____3080 = let uu____3081 = mk_bool true in Const uu____3081 in
          (FStar_Getopt.noshort, "cache_checked_modules", uu____3080,
        ...
        let uu____3082 =
            ...
            let uu____3104 =
              let uu____3115 =
                let uu____3126 =
                  let uu____3137 =
                    let uu____3148 =
                      ...
                      (FStar_Getopt.noshort, "detail_errors", uu____3157,
                        "Emit a detailed error report by asking the SMT solver many queries; will take longer;\n         implies n_cores=1") in
                    let uu____3159 =
                      let uu____3170 =
                        let uu____3179 =
                          let uu____3180 = mk_bool true in Const uu____3180 in
                      ...
                      let uu____3181 =
                        let uu____3192 =
                          let uu____3201 =
                            let uu____3202 = mk_bool true in Const uu____3202 in
                          (FStar_Getopt.noshort, "doc", uu____3201,
                          ...
                          let uu____3214 =
                            ...
                            let uu____3236 =
                              ...
                              let uu____3258 =
                                let uu____3269 =
                                  let uu____3278 =
                                    let uu____3279 = mk_bool true in
                                    Const uu____3279 in
                                    ...
                                    let uu____3302 =
                                      let uu____3313 =
                                        let uu____3324 =
                                          let uu____3335 =
                                            let uu____3344 =
                                              let uu____3345 = mk_bool true in
                                              Const uu____3345 in
                                          ...
                                          let uu____3346 =
                                            let uu____3357 =
                                              let uu____3366 =
                                                let uu____3367 = mk_bool true in
                                                Const uu____3367 in
                                              (FStar_Getopt.noshort,
                                                "hide_uvar_nums", uu____3366,
                                                  ...
                                                  let uu____3423 =
                                                    ...
                                                    let uu____3445 =
                                                      ...
                                                      (FStar_Getopt.noshort,
                                                        ...
                                                        :: uu____3456 in
                                                    uu____3434 :: uu____3445 in
                                                  uu____3412 :: uu____3423 in
                                                uu____3390 :: uu____3401 in
                                              (FStar_Getopt.noshort,
                                                "hint_file",
                                                (PathStr "path"),
                            ...
                            uu____3225 :: uu____3236 in
                          (FStar_Getopt.noshort, "dump_module",
                            (Accumulated (SimpleStr "module_name")), "") ::
                            uu____3214 in
                        uu____3192 :: uu____3203 in
                      uu____3170 :: uu____3181 in
                ...
                (FStar_Getopt.noshort, "debug_level",
                  ...
                  "Control the verbosity of debugging info") :: uu____3126 in
          ...
          (FStar_Getopt.noshort, "codegen",
            ...
            "Generate code for execution") :: uu____3093 in
        uu____3071 :: uu____3082 in
    ...
    (FStar_Getopt.noshort, "admit_smt_queries", BoolStr,
      "Admit SMT queries, unsafe! (default 'false')") :: uu____3049
and specs: Prims.unit -> FStar_Getopt.opt Prims.list =
  fun uu____5213  ->
    let uu____5216 = specs_with_types () in
    FStar_List.map
      (fun uu____5241  ->
         match uu____5241 with
         | (short,long,typ,doc) ->
             let uu____5254 =
               let uu____5265 = arg_spec_of_opt_type long typ in
               (short, long, uu____5265, doc) in
             mk_spec uu____5254) uu____5216
let settable: Prims.string -> Prims.bool =
  fun uu___54_5273  ->
    match uu___54_5273 with
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____5332  ->
          ...
          | (uu____5343,x,uu____5345,uu____5346) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____5392  ->
          ...
          | (uu____5403,x,uu____5405,uu____5406) -> resettable x))
let display_usage: Prims.unit -> Prims.unit =
  fun uu____5414  ->
    let uu____5415 = specs () in display_usage_aux uu____5415
let fstar_home: Prims.unit -> Prims.string =
  fun uu____5431  ->
    let uu____5432 = get_fstar_home () in
    match uu____5432 with
    | FStar_Pervasives_Native.None  ->
        let x = FStar_Util.get_exec_dir () in
        let x1 = Prims.strcat x "/.." in
        ((let uu____5438 =
            let uu____5443 = mk_string x1 in ("fstar_home", uu____5443) in
          set_option' uu____5438);
         x1)
...
let uu___is_File_argument: Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with
    | File_argument uu____5452 -> true
    | uu____5453 -> false
let __proj__File_argument__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | File_argument uu____5461 -> uu____5461
    ...
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____5535) in
    let uu____5641 =
      let uu____5644 = FStar_ST.op_Bang file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____5644 in
    (res, uu____5641)
let file_list: Prims.unit -> Prims.string Prims.list =
  fun uu____5704  -> FStar_ST.op_Bang file_list_
let restore_cmd_line_options: Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module () in
    if should_clear then clear () else init ();
    (let r =
       let uu____5765 = specs () in
       FStar_Getopt.parse_cmdline uu____5765 (fun x  -> ()) in
     (let uu____5771 =
        let uu____5776 =
          let uu____5777 = FStar_List.map mk_string old_verify_module in
          List uu____5777 in
        ("verify_module", uu____5776) in
      set_option' uu____5771);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____5786 =
        let uu____5787 =
          let uu____5788 =
            let uu____5789 = FStar_Util.get_file_extension f1 in
            FStar_String.length uu____5789 in
          (FStar_String.length f1) - uu____5788 in
        uu____5787 - (Prims.parse_int "1") in
      FStar_String.substring f1 (Prims.parse_int "0") uu____5786 in
    FStar_String.lowercase f2
let should_verify: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5794 = get_lax () in
    if uu____5794
    then false
    else
      (let uu____5796 = get_verify_all () in
       if uu____5796
       then true
       else
         (let uu____5798 = get_verify_module () in
          match uu____5798 with
          | [] ->
              let uu____5801 = file_list () in
              FStar_List.existsML
                (fun f  ->
                   let uu____5807 = module_name_of_file_name f in
                   uu____5807 = m) uu____5801
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
let should_verify_file: Prims.string -> Prims.bool =
  fun fn  ->
    let uu____5815 = module_name_of_file_name fn in should_verify uu____5815
let dont_gen_projectors: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5820 = get___temp_no_proj () in
    FStar_List.contains m uu____5820
let should_print_message: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5827 = should_verify m in
    if uu____5827 then m <> "Prims" else false
let include_path: Prims.unit -> Prims.string Prims.list =
  fun uu____5834  ->
    let uu____5835 = get_no_default_includes () in
    if uu____5835
    then get_include ()
    else
      (let h = fstar_home () in
       ...
       let uu____5859 =
         let uu____5862 = get_include () in
         FStar_List.append uu____5862 ["."] in
       FStar_List.append uu____5843 uu____5859)
let find_file: Prims.string -> Prims.string FStar_Pervasives_Native.option =
  fun filename  ->
    let uu____5871 = FStar_Util.is_path_absolute filename in
    if uu____5871
    then
      ...
      (let uu____5878 =
         let uu____5881 = include_path () in FStar_List.rev uu____5881 in
       FStar_Util.find_map uu____5878
         (fun p  ->
...
let prims: Prims.unit -> Prims.string =
  fun uu____5894  ->
    let uu____5895 = get_prims () in
    match uu____5895 with
    | FStar_Pervasives_Native.None  ->
        let filename = "prims.fst" in
        let uu____5899 = find_file filename in
...
let prims_basename: Prims.unit -> Prims.string =
  fun uu____5908  ->
    let uu____5909 = prims () in FStar_Util.basename uu____5909
let pervasives: Prims.unit -> Prims.string =
  fun uu____5913  ->
    let filename = "FStar.Pervasives.fst" in
    let uu____5915 = find_file filename in
...
let pervasives_basename: Prims.unit -> Prims.string =
  fun uu____5923  ->
    let uu____5924 = pervasives () in FStar_Util.basename uu____5924
let pervasives_native_basename: Prims.unit -> Prims.string =
  fun uu____5928  ->
    let filename = "FStar.Pervasives.Native.fst" in
    let uu____5930 = find_file filename in
...
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    let uu____5947 = get___temp_no_proj () in
    FStar_All.pipe_right uu____5947 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____5955  -> get_admit_smt_queries ()
let admit_except: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5961  -> get_admit_except ()
let cache_checked_modules: Prims.unit -> Prims.bool =
  fun uu____5965  -> get_cache_checked_modules ()
let codegen: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5971  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____5979  ->
    let uu____5980 = get_codegen_lib () in
    FStar_All.pipe_right uu____5980
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____5996  -> let uu____5997 = get_debug () in uu____5997 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      (let uu____6012 = get_debug () in
       FStar_All.pipe_right uu____6012 (FStar_List.contains modul)) &&
        (debug_level_geq level)
let dep: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____6022  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____6026  -> get_detail_errors ()
let detail_hint_replay: Prims.unit -> Prims.bool =
  fun uu____6030  -> get_detail_hint_replay ()
let doc: Prims.unit -> Prims.bool = fun uu____6034  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____6039 = get_dump_module () in
    FStar_All.pipe_right uu____6039 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____6047  -> get_eager_inference ()
let explicit_deps: Prims.unit -> Prims.bool =
  fun uu____6051  -> get_explicit_deps ()
let extract_all: Prims.unit -> Prims.bool =
  fun uu____6055  -> get_extract_all ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____6060 = FStar_ST.op_Bang light_off_files in
    FStar_List.contains filename uu____6060
let gen_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____6118  -> get_gen_native_tactics ()
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____6122  -> true
let hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____6126  -> get_hide_genident_nums ()
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____6130  -> get_hide_uvar_nums ()
let hint_info: Prims.unit -> Prims.bool =
  fun uu____6134  -> (get_hint_info ()) || (get_query_stats ())
let hint_file: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____6140  -> get_hint_file ()
let ide: Prims.unit -> Prims.bool = fun uu____6144  -> get_ide ()
let indent: Prims.unit -> Prims.bool = fun uu____6148  -> get_indent ()
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____6152  ->
    let uu____6153 = get_initial_fuel () in
    let uu____6154 = get_max_fuel () in Prims.min uu____6153 uu____6154
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____6158  ->
    let uu____6159 = get_initial_ifuel () in
    let uu____6160 = get_max_ifuel () in Prims.min uu____6159 uu____6160
let interactive: Prims.unit -> Prims.bool =
  fun uu____6164  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____6168  -> get_lax ()
let load: Prims.unit -> Prims.string Prims.list =
  fun uu____6174  -> get_load ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____6178  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____6182  -> get_log_queries ()
...
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____6206  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____6210  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____6214  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____6219 = get_no_extract () in
    FStar_All.pipe_right uu____6219 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____6227  -> get_no_location_info ()
let output_dir: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____6233  -> get_odir ()
let ugly: Prims.unit -> Prims.bool = fun uu____6237  -> get_ugly ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____6241  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____6245  -> get_print_effect_args ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____6249  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____6253  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____6257  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____6261  -> (get_print_z3_statistics ()) || (get_query_stats ())
let query_stats: Prims.unit -> Prims.bool =
  fun uu____6265  -> get_query_stats ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____6269  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____6275  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____6279  -> get_silent ()
let smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____6283  -> get_smtencoding_elim_box ()
let smtencoding_nl_arith_native: Prims.unit -> Prims.bool =
  fun uu____6287  ->
    let uu____6288 = get_smtencoding_nl_arith_repr () in
    uu____6288 = "native"
let smtencoding_nl_arith_wrapped: Prims.unit -> Prims.bool =
  fun uu____6292  ->
    let uu____6293 = get_smtencoding_nl_arith_repr () in
    uu____6293 = "wrapped"
let smtencoding_nl_arith_default: Prims.unit -> Prims.bool =
  fun uu____6297  ->
    let uu____6298 = get_smtencoding_nl_arith_repr () in
    uu____6298 = "boxwrap"
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____6302  ->
    let uu____6303 = get_smtencoding_l_arith_repr () in uu____6303 = "native"
let smtencoding_l_arith_default: Prims.unit -> Prims.bool =
  fun uu____6307  ->
    let uu____6308 = get_smtencoding_l_arith_repr () in
    uu____6308 = "boxwrap"
let split_cases: Prims.unit -> Prims.int =
  fun uu____6312  -> get_split_cases ()
let tactic_trace: Prims.unit -> Prims.bool =
  fun uu____6316  -> get_tactic_trace ()
let tactic_trace_d: Prims.unit -> Prims.int =
  fun uu____6320  -> get_tactic_trace_d ()
let timing: Prims.unit -> Prims.bool = fun uu____6324  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____6328  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____6332  -> get_unthrottle_inductives ()
let unsafe_tactic_exec: Prims.unit -> Prims.bool =
  fun uu____6336  -> get_unsafe_tactic_exec ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____6340  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____6344  -> get_use_hints ()
let use_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____6350  -> get_use_native_tactics ()
let use_tactics: Prims.unit -> Prims.bool =
  fun uu____6354  -> get_use_tactics ()
let using_facts_from:
  Prims.unit -> Prims.string Prims.list FStar_Pervasives_Native.option =
  fun uu____6362  -> get_using_facts_from ()
let verify_all: Prims.unit -> Prims.bool =
  fun uu____6366  -> get_verify_all ()
let verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____6372  -> get_verify_module ()
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____6376  -> get_warn_default_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____6380  ->
    let uu____6381 = get_smt () in
    match uu____6381 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____6390  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____6394  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____6398  -> get_z3rlimit ()
let z3_rlimit_factor: Prims.unit -> Prims.int =
  fun uu____6402  -> get_z3rlimit_factor ()
let z3_seed: Prims.unit -> Prims.int = fun uu____6406  -> get_z3seed ()
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____6410  -> get_no_positivity ()
let ml_no_eta_expand_coertions: Prims.unit -> Prims.bool =
  fun uu____6414  -> get_ml_no_eta_expand_coertions ()
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    (let uu____6421 = no_extract m in Prims.op_Negation uu____6421) &&
      ((extract_all ()) ||
         (let uu____6424 = get_extract_module () in
          match uu____6424 with
          | [] ->
              let uu____6427 = get_extract_namespace () in
