...
| None -> begin
(let _87_56 = (let _87_55 = (FStar_Util.format1 "unable to find required file %s in search path." filen)
...
let display_usage = (fun specs -> (let _21_181 = (FStar_Util.print_string "fstar [option] infile...")
