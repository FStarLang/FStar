...
let lookup_opt s c =
  let uu____475 = let _0_38 = peek ()  in FStar_Util.smap_try_find _0_38 s
     in
...
let get_print_universes : Prims.unit -> Prims.bool =
  fun uu____641  -> lookup_opt "print_universes" as_bool 
let get_print_z3_statistics : Prims.unit -> Prims.bool =
  fun uu____644  -> lookup_opt "print_z3_statistics" as_bool 
let get_prn : Prims.unit -> Prims.bool =
  fun uu____647  -> lookup_opt "prn" as_bool 
let get_record_hints : Prims.unit -> Prims.bool =
  fun uu____650  -> lookup_opt "record_hints" as_bool 
let get_reuse_hint_for : Prims.unit -> Prims.string Prims.option =
  fun uu____654  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let get_show_signatures : Prims.unit -> Prims.string Prims.list =
  fun uu____659  -> lookup_opt "show_signatures" (as_list as_string) 
let get_silent : Prims.unit -> Prims.bool =
  fun uu____663  -> lookup_opt "silent" as_bool 
let get_smt : Prims.unit -> Prims.string Prims.option =
  fun uu____667  -> lookup_opt "smt" (as_option as_string) 
let get_lean : Prims.unit -> Prims.bool =
  fun uu____671  -> lookup_opt "lean" as_bool 
    ...
    (fun uu____807  ->
       ...
       | (uu____813,flag,p,doc) ->
           (match p with
            ...
            | FStar_Getopt.OneArg (uu____823,argname) ->
                if doc = ""
                then
                  FStar_Util.print_string
  ...
  fun uu____909  ->
    let specs =
      ...
      (FStar_Getopt.noshort, "detail_errors",
        (FStar_Getopt.ZeroArgs ((fun uu____996  -> Bool true))),
        "Emit a detailed error report by asking the SMT solver many queries; will take longer;\n         implies n_cores=1");
      (FStar_Getopt.noshort, "doc",
        (FStar_Getopt.ZeroArgs ((fun uu____1003  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "hide_genident_nums",
        (FStar_Getopt.ZeroArgs ((fun uu____1067  -> Bool true))),
        "Don't print generated identifier numbers");
      (FStar_Getopt.noshort, "hide_uvar_nums",
        (FStar_Getopt.ZeroArgs ((fun uu____1074  -> Bool true))),
        "Don't print unification variable numbers");
      (FStar_Getopt.noshort, "hint_info",
        (FStar_Getopt.ZeroArgs ((fun uu____1081  -> Bool true))),
        "Print information regarding hints");
      (FStar_Getopt.noshort, "in",
        (FStar_Getopt.ZeroArgs ((fun uu____1088  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "indent",
        (FStar_Getopt.ZeroArgs ((fun uu____1106  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "z3refresh",
        (FStar_Getopt.ZeroArgs ((fun uu____1443  -> Bool false))),
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1531  ->
          ...
          | (uu____1537,x,uu____1539,uu____1540) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1561  ->
          ...
          | (uu____1567,x,uu____1569,uu____1570) -> resettable x))
  
let display_usage : Prims.unit -> Prims.unit =
  fun uu____1575  -> display_usage_aux (specs ()) 
let fstar_home : Prims.unit -> Prims.string =
  fun uu____1578  ->
    let uu____1579 = get_fstar_home ()  in
...
let set_options : options -> Prims.string -> FStar_Getopt.parse_cmdline_res =
  fun o  ->
    fun s  ->
      ...
      FStar_Getopt.parse_string specs (fun uu____1604  -> ()) s
...
let file_list : Prims.unit -> Prims.string Prims.list =
  fun uu____1631  -> FStar_ST.read file_list_ 
...
let should_verify : Prims.string -> Prims.bool =
  fun m  ->
    let uu____1648 = get_lax ()  in
    if uu____1648
    then false
    else
      (let uu____1650 = get_verify_all ()  in
       if uu____1650
       then true
       else
         (let uu____1652 = get_verify_module ()  in
...
let should_print_message : Prims.string -> Prims.bool =
  fun m  ->
    let uu____1670 = should_verify m  in
    if uu____1670 then m <> "Prims" else false
  
let include_path : Prims.unit -> Prims.string Prims.list =
  fun uu____1675  ->
    let uu____1676 = get_no_default_includes ()  in
    if uu____1676
    then get_include ()
    else
      (let h = fstar_home ()  in
...
let find_file : Prims.string -> Prims.string Prims.option =
  fun filename  ->
    let uu____1691 = FStar_Util.is_path_absolute filename  in
    if uu____1691
...
let prims : Prims.unit -> Prims.string =
  fun uu____1702  ->
    let uu____1703 = get_prims ()  in
    match uu____1703 with
    | None  ->
        let filename = "prims.fst"  in
        let uu____1706 = find_file filename  in
...
let admit_smt_queries : Prims.unit -> Prims.bool =
  fun uu____1722  -> get_admit_smt_queries () 
let check_cardinality : Prims.unit -> Prims.bool =
  fun uu____1725  -> let _0_118 = get_cardinality ()  in _0_118 = "check" 
let codegen : Prims.unit -> Prims.string Prims.option =
  fun uu____1729  -> get_codegen () 
...
let debug_any : Prims.unit -> Prims.bool =
  fun uu____1742  -> let _0_120 = get_debug ()  in _0_120 <> [] 
...
let dep : Prims.unit -> Prims.string Prims.option =
  fun uu____1754  -> get_dep () 
let detail_errors : Prims.unit -> Prims.bool =
  fun uu____1757  -> get_detail_errors () 
let doc : Prims.unit -> Prims.bool = fun uu____1760  -> get_doc () 
...
let eager_inference : Prims.unit -> Prims.bool =
  fun uu____1767  -> get_eager_inference () 
let explicit_deps : Prims.unit -> Prims.bool =
  fun uu____1770  -> get_explicit_deps () 
let extract_all : Prims.unit -> Prims.bool =
  fun uu____1773  -> get_extract_all () 
...
let hide_genident_nums : Prims.unit -> Prims.bool =
  fun uu____1785  -> get_hide_genident_nums () 
let hide_uvar_nums : Prims.unit -> Prims.bool =
  fun uu____1788  -> get_hide_uvar_nums () 
let hint_info : Prims.unit -> Prims.bool =
  fun uu____1791  -> get_hint_info () 
let indent : Prims.unit -> Prims.bool = fun uu____1794  -> get_indent () 
...
let inline_arith : Prims.unit -> Prims.bool =
  fun uu____1803  -> get_inline_arith () 
let interactive : Prims.unit -> Prims.bool = fun uu____1806  -> get_in () 
let lax : Prims.unit -> Prims.bool = fun uu____1809  -> get_lax () 
let lean : Prims.unit -> Prims.bool = fun uu____1812  -> get_lean () 
let log_queries : Prims.unit -> Prims.bool =
  fun uu____1815  -> get_log_queries () 
let log_types : Prims.unit -> Prims.bool =
  fun uu____1818  -> get_log_types () 
let max_fuel : Prims.unit -> Prims.int = fun uu____1821  -> get_max_fuel () 
let max_ifuel : Prims.unit -> Prims.int = fun uu____1824  -> get_max_ifuel () 
let min_fuel : Prims.unit -> Prims.int = fun uu____1827  -> get_min_fuel () 
let ml_ish : Prims.unit -> Prims.bool = fun uu____1830  -> get_MLish () 
let set_ml_ish : Prims.unit -> Prims.unit =
  fun uu____1833  -> set_option "MLish" (Bool true) 
let n_cores : Prims.unit -> Prims.int = fun uu____1836  -> get_n_cores () 
let no_default_includes : Prims.unit -> Prims.bool =
  fun uu____1839  -> get_no_default_includes () 
...
let no_location_info : Prims.unit -> Prims.bool =
  fun uu____1846  -> get_no_location_info () 
let norm_then_print : Prims.unit -> Prims.bool =
  fun uu____1849  -> let _0_129 = get_print_before_norm ()  in _0_129 = false 
let output_dir : Prims.unit -> Prims.string Prims.option =
  fun uu____1853  -> get_odir () 
let print_bound_var_types : Prims.unit -> Prims.bool =
  fun uu____1856  -> get_print_bound_var_types () 
let print_effect_args : Prims.unit -> Prims.bool =
  fun uu____1859  -> get_print_effect_args () 
let print_fuels : Prims.unit -> Prims.bool =
  fun uu____1862  -> get_print_fuels () 
let print_implicits : Prims.unit -> Prims.bool =
  fun uu____1865  -> get_print_implicits () 
let print_real_names : Prims.unit -> Prims.bool =
  fun uu____1868  -> get_prn () 
let print_universes : Prims.unit -> Prims.bool =
  fun uu____1871  -> get_print_universes () 
let print_z3_statistics : Prims.unit -> Prims.bool =
  fun uu____1874  -> get_print_z3_statistics () 
let record_hints : Prims.unit -> Prims.bool =
  fun uu____1877  -> get_record_hints () 
let reuse_hint_for : Prims.unit -> Prims.string Prims.option =
  fun uu____1881  -> get_reuse_hint_for () 
let silent : Prims.unit -> Prims.bool = fun uu____1884  -> get_silent () 
let split_cases : Prims.unit -> Prims.int =
  fun uu____1887  -> get_split_cases () 
let timing : Prims.unit -> Prims.bool = fun uu____1890  -> get_timing () 
let trace_error : Prims.unit -> Prims.bool =
  fun uu____1893  -> get_trace_error () 
let unthrottle_inductives : Prims.unit -> Prims.bool =
  fun uu____1896  -> get_unthrottle_inductives () 
let use_eq_at_higher_order : Prims.unit -> Prims.bool =
  fun uu____1899  -> get_use_eq_at_higher_order () 
let use_hints : Prims.unit -> Prims.bool =
  fun uu____1902  -> get_use_hints () 
let verify_all : Prims.unit -> Prims.bool =
  fun uu____1905  -> get_verify_all () 
let verify_module : Prims.unit -> Prims.string Prims.list =
  fun uu____1909  -> get_verify_module () 
let warn_cardinality : Prims.unit -> Prims.bool =
  fun uu____1912  -> let _0_130 = get_cardinality ()  in _0_130 = "warn" 
let warn_default_effects : Prims.unit -> Prims.bool =
  fun uu____1915  -> get_warn_default_effects () 
let warn_top_level_effects : Prims.unit -> Prims.bool =
  fun uu____1918  -> get_warn_top_level_effects () 
let z3_exe : Prims.unit -> Prims.string =
  fun uu____1921  ->
    let uu____1922 = get_smt ()  in
    match uu____1922 with | None  -> FStar_Platform.exe "z3" | Some s -> s
  
let z3_cliopt : Prims.unit -> Prims.string Prims.list =
  fun uu____1928  -> get_z3cliopt () 
let z3_refresh : Prims.unit -> Prims.bool =
  fun uu____1931  -> get_z3refresh () 
let z3_rlimit : Prims.unit -> Prims.int = fun uu____1934  -> get_z3rlimit () 
let z3_seed : Prims.unit -> Prims.int = fun uu____1937  -> get_z3seed () 
let z3_timeout : Prims.unit -> Prims.int =
  fun uu____1940  -> get_z3timeout () 
let no_positivity : Prims.unit -> Prims.bool =
  fun uu____1943  -> get_no_positivity () 
let should_extract : Prims.string -> Prims.bool =
  fun m  ->
    (Prims.op_Negation (no_extract m)) &&
      ((extract_all ()) ||
         (let uu____1947 = get_extract_module ()  in
          match uu____1947 with
          | [] ->
              let uu____1949 = get_extract_namespace ()  in
