...
let smtencoding_l_arith_native : Prims.unit -> Prims.bool =
  fun uu____2335  ->
    let uu____2336 = get_smtencoding_l_arith_repr ()  in
    uu____2336 = "native"
