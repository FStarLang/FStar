...
let display_version: Prims.unit -> Prims.unit =
  fun uu____866  ->
    let uu____867 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____868
        uu____871 uu____874 uu____877 uu____880 in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____977 =
                let uu____978 = let uu____981 = f () in (name, uu____981) in
  ...
  fun uu____1068  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  -> let uu____1097 = parse_codegen s in String uu____1097)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1107 =
                  let uu____1109 =
                    let uu____1111 = get_codegen_lib () in s :: uu____1111 in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1141 =
                  let uu____1143 =
                    let uu____1145 = get_debug_level () in x :: uu____1145 in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1182 =
                  let uu____1184 =
                    let uu____1186 = get_dump_module () in x :: uu____1186 in
           ...
           (((fun s  ->
                let uu____1280 =
                  let uu____1282 =
                    ...
                    FStar_List.map (fun _0_36  -> String _0_36) uu____1284 in
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1404 =
                  let uu____1406 =
                    let uu____1408 = get_no_extract () in x :: uu____1408 in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1669 =
                  let uu____1671 =
                    let uu____1673 = get___temp_no_proj () in x :: uu____1673 in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1725 = FStar_Util.int_of_string s in Int uu____1725)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1735 = FStar_Util.int_of_string s in Int uu____1735)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1745 = FStar_Util.int_of_string s in Int uu____1745)),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____1988
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____1991) in
    let uu____2001 =
      let uu____2003 = FStar_ST.read file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____2003 in
    (res, uu____2001)
                ...
                (fun f  ->
                   ...
                   let f2 =
                     let uu____2048 =
                       let uu____2049 =
                         let uu____2050 =
                           let uu____2051 = FStar_Util.get_file_extension f1 in
...
let pervasives_native_basename: Prims.unit -> Prims.string =
  fun uu____2139  ->
    ...
    let uu____2141 = find_file filename in
        ...
        let uu____2144 =
          let uu____2145 =
            FStar_Util.format1
              "unable to find required file \"%s\" in the module search path.\n"
              filename in
          FStar_Util.Failure uu____2145 in
        raise uu____2144
let prepend_output_dir: Prims.string -> Prims.string =
  fun fname  ->
    let uu____2149 = get_odir () in
...
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2155 = get___temp_no_proj () in
    FStar_All.pipe_right uu____2155 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____2160  -> get_admit_smt_queries ()
let check_hints: Prims.unit -> Prims.bool =
  fun uu____2163  -> get_check_hints ()
let codegen: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2167  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____2172  ->
    let uu____2173 = get_codegen_lib () in
    FStar_All.pipe_right uu____2173
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____2182  -> let uu____2183 = get_debug () in uu____2183 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____2192 = get_debug () in
          FStar_All.pipe_right uu____2192 (FStar_List.contains modul)))
        && (debug_level_geq level)
let dep: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2198  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____2201  -> get_detail_errors ()
let doc: Prims.unit -> Prims.bool = fun uu____2204  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2208 = get_dump_module () in
    FStar_All.pipe_right uu____2208 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____2213  -> get_eager_inference ()
let explicit_deps: Prims.unit -> Prims.bool =
  fun uu____2216  -> get_explicit_deps ()
let extract_all: Prims.unit -> Prims.bool =
  fun uu____2219  -> get_extract_all ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____2223 = FStar_ST.read light_off_files in
    FStar_List.contains filename uu____2223
let full_context_dependency: Prims.unit -> Prims.bool =
  fun uu____2230  -> true
let hide_genident_nums: Prims.unit -> Prims.bool =
  fun uu____2233  -> get_hide_genident_nums ()
let hide_uvar_nums: Prims.unit -> Prims.bool =
  fun uu____2236  -> get_hide_uvar_nums ()
let hint_info: Prims.unit -> Prims.bool = fun uu____2239  -> get_hint_info ()
let ide: Prims.unit -> Prims.bool = fun uu____2242  -> get_ide ()
let indent: Prims.unit -> Prims.bool = fun uu____2245  -> get_indent ()
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____2248  ->
    let uu____2249 = get_initial_fuel () in
    let uu____2250 = get_max_fuel () in Prims.min uu____2249 uu____2250
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____2253  ->
    let uu____2254 = get_initial_ifuel () in
    let uu____2255 = get_max_ifuel () in Prims.min uu____2254 uu____2255
let interactive: Prims.unit -> Prims.bool =
  fun uu____2258  -> (get_in ()) || (get_ide ())
let lax: Prims.unit -> Prims.bool = fun uu____2261  -> get_lax ()
let legacy_interactive: Prims.unit -> Prims.bool =
  fun uu____2264  -> get_in ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____2267  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____2270  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____2273  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____2276  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____2279  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____2282  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____2285  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____2288  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____2291  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2295 = get_no_extract () in
    FStar_All.pipe_right uu____2295 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____2300  -> get_no_location_info ()
let norm_then_print: Prims.unit -> Prims.bool =
  fun uu____2303  ->
    let uu____2304 = get_print_before_norm () in uu____2304 = false
let output_dir: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____2308  -> get_odir ()
let ugly: Prims.unit -> Prims.bool = fun uu____2311  -> get_ugly ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____2314  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____2317  -> get_print_effect_args ()
let print_fuels: Prims.unit -> Prims.bool =
  fun uu____2320  -> get_print_fuels ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____2323  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____2326  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____2329  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____2332  -> get_print_z3_statistics ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____2335  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____2339  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____2342  -> get_silent ()
let smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____2345  -> get_smtencoding_elim_box ()
let smtencoding_nl_arith_native: Prims.unit -> Prims.bool =
  fun uu____2348  ->
    let uu____2349 = get_smtencoding_nl_arith_repr () in
    uu____2349 = "native"
let smtencoding_nl_arith_wrapped: Prims.unit -> Prims.bool =
  fun uu____2352  ->
    let uu____2353 = get_smtencoding_nl_arith_repr () in
    uu____2353 = "wrapped"
let smtencoding_nl_arith_default: Prims.unit -> Prims.bool =
  fun uu____2356  ->
    let uu____2357 = get_smtencoding_nl_arith_repr () in
    uu____2357 = "boxwrap"
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____2360  ->
    let uu____2361 = get_smtencoding_l_arith_repr () in uu____2361 = "native"
let smtencoding_l_arith_default: Prims.unit -> Prims.bool =
  fun uu____2364  ->
    let uu____2365 = get_smtencoding_l_arith_repr () in
    uu____2365 = "boxwrap"
let split_cases: Prims.unit -> Prims.int =
  fun uu____2368  -> get_split_cases ()
let timing: Prims.unit -> Prims.bool = fun uu____2371  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____2374  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____2377  -> get_unthrottle_inductives ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____2380  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____2383  -> get_use_hints ()
let use_tactics: Prims.unit -> Prims.bool =
  fun uu____2386  -> get_use_tactics ()
let using_facts_from:
  Prims.unit -> Prims.string Prims.list FStar_Pervasives_Native.option =
  fun uu____2391  -> get_using_facts_from ()
let verify_all: Prims.unit -> Prims.bool =
  fun uu____2394  -> get_verify_all ()
let verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____2398  -> get_verify_module ()
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____2401  -> get_warn_default_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____2404  ->
    let uu____2405 = get_smt () in
    match uu____2405 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____2411  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____2414  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____2417  -> get_z3rlimit ()
let z3_rlimit_factor: Prims.unit -> Prims.int =
  fun uu____2420  -> get_z3rlimit_factor ()
let z3_seed: Prims.unit -> Prims.int = fun uu____2423  -> get_z3seed ()
let z3_timeout: Prims.unit -> Prims.int = fun uu____2426  -> get_z3timeout ()
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____2429  -> get_no_positivity ()
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2433 = no_extract m in Prims.op_Negation uu____2433) &&
      ((extract_all ()) ||
         (let uu____2434 = get_extract_module () in
          match uu____2434 with
          | [] ->
              let uu____2436 = get_extract_namespace () in
