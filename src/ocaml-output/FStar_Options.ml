...
let display_version: Prims.unit -> Prims.unit =
  fun uu____838  ->
    let uu____839 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____840
        uu____843 uu____846 uu____849 uu____852 in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____949 =
                let uu____950 = let uu____953 = f () in (name, uu____953) in
  ...
  fun uu____1025  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  -> let uu____1064 = parse_codegen s in String uu____1064)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1074 =
                  let uu____1076 =
                    let uu____1078 = get_codegen_lib () in s :: uu____1078 in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1108 =
                  let uu____1110 =
                    let uu____1112 = get_debug_level () in x :: uu____1112 in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1149 =
                  let uu____1151 =
                    let uu____1153 = get_dump_module () in x :: uu____1153 in
           ...
           (((fun s  ->
                let uu____1247 =
                  let uu____1249 =
                    ...
                    FStar_List.map (fun _0_34  -> String _0_34) uu____1251 in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1269 = FStar_Util.int_of_string x in Int uu____1269)),
             "[non-negative integer]")),
        "Number of unrolling of recursive functions to try initially (default 2)");
      (FStar_Getopt.noshort, "initial_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1279 = FStar_Util.int_of_string x in Int uu____1279)),
             "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1317 = FStar_Util.int_of_string x in Int uu____1317)),
             "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1327 = FStar_Util.int_of_string x in Int uu____1327)),
             "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1337 = FStar_Util.int_of_string x in Int uu____1337)),
             "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1371 =
                  let uu____1373 =
                    let uu____1375 = get_no_extract () in x :: uu____1375 in
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1590 =
                  let uu____1592 =
                    let uu____1594 = get___temp_no_proj () in x :: uu____1594 in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1646 = FStar_Util.int_of_string s in Int uu____1646)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1656 = FStar_Util.int_of_string s in Int uu____1656)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1666 = FStar_Util.int_of_string s in Int uu____1666)),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____1887
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____1890) in
    let uu____1900 =
      let uu____1902 = FStar_ST.read file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1902 in
    (res, uu____1900)
                ...
                (fun f  ->
                   ...
                   let f2 =
                     let uu____1947 =
                       let uu____1948 =
                         let uu____1949 =
                           let uu____1950 = FStar_Util.get_file_extension f1 in
