...
let display_version: Prims.unit -> Prims.unit =
  fun uu____1627  ->
    let uu____1628 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____1629
        uu____1649 uu____1669 uu____1689 uu____1709 in
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.OneArg (f,d) ->
              let g x = let uu____1885 = f x in set_option name uu____1885 in
  ...
  fun name  ->
    fun post_processor  ->
      fun value  ->
        let uu____1948 =
          let uu____1949 =
            let uu____1950 = post_processor value in mk_string uu____1950 in
...
let rec specs_with_types:
  ...
  fun uu____2396  ->
    let uu____2407 =
      let uu____2418 =
        let uu____2429 =
          let uu____2438 = let uu____2439 = mk_bool true in Const uu____2439 in
        ...
        let uu____2440 =
              ...
              let uu____2473 =
                let uu____2484 =
                  let uu____2495 =
                    let uu____2506 =
                      let uu____2515 =
                        let uu____2516 = mk_bool true in Const uu____2516 in
                                    ...
                                    let uu____2649 =
                                      let uu____2660 =
                                        let uu____2671 =
                                          let uu____2682 =
                                            let uu____2691 =
                                              let uu____2692 = mk_bool true in
                                              Const uu____2692 in
                                            (FStar_Getopt.noshort,
                ...
                (FStar_Getopt.noshort, "debug_level",
                  ...
                  "Control the verbosity of debugging info") :: uu____2484 in
          ...
          (FStar_Getopt.noshort, "codegen",
            ...
            "Generate code for execution") :: uu____2451 in
    ...
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           ...
           FStar_ST.op_Colon_Equals file_list_ uu____4879) in
    let uu____4931 =
      let uu____4934 = FStar_ST.op_Bang file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____4934 in
    (res, uu____4931)
...
let log_types: Prims.unit -> Prims.bool = fun uu____5452  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____5455  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____5458  -> get_max_ifuel ()
...
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____5545  ->
    let uu____5546 = get_smtencoding_l_arith_repr () in uu____5546 = "native"
...
let use_hints: Prims.unit -> Prims.bool = fun uu____5577  -> get_use_hints ()
...
let z3_rlimit: Prims.unit -> Prims.int = fun uu____5665  -> get_z3rlimit ()
            ...
            FStar_All.pipe_right setting
              (FStar_Util.try_find
                 (fun uu____5839  ->
                    ...
                    | (path,uu____5847) -> matches_path m_components path)) in
