...
let get_cardinality : Prims.unit -> Prims.string =
  fun uu____546  -> lookup_opt "cardinality" as_string 
...
let get_inline_arith : Prims.unit -> Prims.bool =
  fun uu____644  -> lookup_opt "inline_arith" as_bool 
let get_lax : Prims.unit -> Prims.bool =
  fun uu____647  -> lookup_opt "lax" as_bool 
let get_log_queries : Prims.unit -> Prims.bool =
  fun uu____650  -> lookup_opt "log_queries" as_bool 
let get_log_types : Prims.unit -> Prims.bool =
  fun uu____653  -> lookup_opt "log_types" as_bool 
let get_max_fuel : Prims.unit -> Prims.int =
  fun uu____656  -> lookup_opt "max_fuel" as_int 
let get_max_ifuel : Prims.unit -> Prims.int =
  fun uu____659  -> lookup_opt "max_ifuel" as_int 
let get_min_fuel : Prims.unit -> Prims.int =
  fun uu____662  -> lookup_opt "min_fuel" as_int 
let get_MLish : Prims.unit -> Prims.bool =
  fun uu____665  -> lookup_opt "MLish" as_bool 
let get_n_cores : Prims.unit -> Prims.int =
  fun uu____668  -> lookup_opt "n_cores" as_int 
let get_no_default_includes : Prims.unit -> Prims.bool =
  fun uu____671  -> lookup_opt "no_default_includes" as_bool 
let get_no_extract : Prims.unit -> Prims.string Prims.list =
  fun uu____675  -> lookup_opt "no_extract" (as_list as_string) 
let get_no_location_info : Prims.unit -> Prims.bool =
  fun uu____679  -> lookup_opt "no_location_info" as_bool 
let get_warn_top_level_effects : Prims.unit -> Prims.bool =
  fun uu____682  -> lookup_opt "no_warn_top_level_effects" as_bool 
...
let get_prims : Prims.unit -> Prims.string Prims.option =
  fun uu____691  -> lookup_opt "prims" (as_option as_string) 
let get_print_before_norm : Prims.unit -> Prims.bool =
  fun uu____695  -> lookup_opt "print_before_norm" as_bool 
let get_print_bound_var_types : Prims.unit -> Prims.bool =
  fun uu____698  -> lookup_opt "print_bound_var_types" as_bool 
let get_print_effect_args : Prims.unit -> Prims.bool =
  fun uu____701  -> lookup_opt "print_effect_args" as_bool 
let get_print_fuels : Prims.unit -> Prims.bool =
  fun uu____704  -> lookup_opt "print_fuels" as_bool 
let get_print_full_names : Prims.unit -> Prims.bool =
  fun uu____707  -> lookup_opt "print_full_names" as_bool 
let get_print_implicits : Prims.unit -> Prims.bool =
  fun uu____710  -> lookup_opt "print_implicits" as_bool 
let get_print_universes : Prims.unit -> Prims.bool =
  fun uu____713  -> lookup_opt "print_universes" as_bool 
let get_print_z3_statistics : Prims.unit -> Prims.bool =
  fun uu____716  -> lookup_opt "print_z3_statistics" as_bool 
let get_prn : Prims.unit -> Prims.bool =
  fun uu____719  -> lookup_opt "prn" as_bool 
let get_record_hints : Prims.unit -> Prims.bool =
  fun uu____722  -> lookup_opt "record_hints" as_bool 
let get_reuse_hint_for : Prims.unit -> Prims.string Prims.option =
  fun uu____726  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let get_show_signatures : Prims.unit -> Prims.string Prims.list =
  fun uu____731  -> lookup_opt "show_signatures" (as_list as_string) 
let get_silent : Prims.unit -> Prims.bool =
  fun uu____735  -> lookup_opt "silent" as_bool 
let get_smt : Prims.unit -> Prims.string Prims.option =
  fun uu____739  -> lookup_opt "smt" (as_option as_string) 
let get_split_cases : Prims.unit -> Prims.int =
  fun uu____743  -> lookup_opt "split_cases" as_int 
let get_timing : Prims.unit -> Prims.bool =
  fun uu____746  -> lookup_opt "timing" as_bool 
let get_trace_error : Prims.unit -> Prims.bool =
  fun uu____749  -> lookup_opt "trace_error" as_bool 
let get_unthrottle_inductives : Prims.unit -> Prims.bool =
  fun uu____752  -> lookup_opt "unthrottle_inductives" as_bool 
let get_use_eq_at_higher_order : Prims.unit -> Prims.bool =
  fun uu____755  -> lookup_opt "use_eq_at_higher_order" as_bool 
let get_use_hints : Prims.unit -> Prims.bool =
  fun uu____758  -> lookup_opt "use_hints" as_bool 
let get_use_tactics : Prims.unit -> Prims.bool =
  fun uu____761  -> lookup_opt "use_tactics" as_bool 
...
let get_z3timeout : Prims.unit -> Prims.int =
  fun uu____808  -> lookup_opt "z3timeout" as_int 
let get_no_positivity : Prims.unit -> Prims.bool =
  fun uu____811  -> lookup_opt "__no_positivity" as_bool 
let dlevel : Prims.string -> debug_level_t =
  fun uu___56_814  ->
    match uu___56_814 with
    | "Low" -> Low
    | "Medium" -> Medium
    | "High" -> High
    | "Extreme" -> Extreme
...
let debug_level_geq : debug_level_t -> Prims.bool =
  fun l2  ->
    let uu____826 = get_debug_level ()  in
...
let display_version : Prims.unit -> Prims.unit =
  fun uu____853  ->
    let uu____854 =
      let uu____855 = FStar_ST.read _version  in
      let uu____858 = FStar_ST.read _platform  in
      let uu____861 = FStar_ST.read _compiler  in
      let uu____864 = FStar_ST.read _date  in
      let uu____867 = FStar_ST.read _commit  in
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____855
        uu____858 uu____861 uu____864 uu____867
       in
    FStar_Util.print_string uu____854
    ...
    (fun uu____897  ->
       ...
       | (uu____903,flag,p,doc) ->
           (match p with
            ...
            | FStar_Getopt.OneArg (uu____917,argname) ->
                if doc = ""
                then
                  let uu____923 =
                  ...
                  (let uu____927 =
                     ...
                     let uu____929 = FStar_Util.colorize_bold argname  in
                     FStar_Util.format3 "  --%s %s  %s\n" uu____928 uu____929
                       doc
                      in
                   FStar_Util.print_string uu____927))) specs
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____964 =
                let uu____965 = let uu____968 = f ()  in (name, uu____968)
                   in
                set_option' uu____965  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x =
                let uu____979 = let uu____982 = f x  in (name, uu____982)  in
                set_option' uu____979  in
...
let cons_extract_module : Prims.string -> option_val =
  fun s  ->
    let uu____989 =
      let uu____991 =
        let uu____993 = get_extract_module ()  in (FStar_String.lowercase s)
          :: uu____993
         in
...
let cons_extract_namespace : Prims.string -> option_val =
  fun s  ->
    let uu____1000 =
      let uu____1002 =
        let uu____1004 = get_extract_namespace ()  in
        (FStar_String.lowercase s) :: uu____1004  in
...
let add_extract_module : Prims.string -> Prims.unit =
  fun s  ->
    let uu____1011 = cons_extract_module s  in
    set_option "extract_module" uu____1011
  
let add_extract_namespace : Prims.string -> Prims.unit =
  fun s  ->
    let uu____1015 = cons_extract_namespace s  in
    set_option "extract_namespace" uu____1015
  
let cons_verify_module : Prims.string -> option_val =
  fun s  ->
    let uu____1019 =
      let uu____1021 =
        let uu____1023 = get_verify_module ()  in (FStar_String.lowercase s)
          :: uu____1023
         in
...
let cons_using_facts_from : Prims.string -> option_val =
  fun s  ->
    ...
    (let uu____1031 = get_using_facts_from ()  in
...
let add_verify_module : Prims.string -> Prims.unit =
  fun s  ->
    let uu____1043 = cons_verify_module s  in
    set_option "verify_module" uu____1043
  ...
  fun uu____1053  ->
    let specs1 =
      ...
      (FStar_Getopt.noshort, "cardinality",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1082 = validate_cardinality x  in String uu____1082)),
             "[off|warn|check]")),
        "Check cardinality constraints on inductive data types (default 'off')");
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1092 = parse_codegen s  in String uu____1092)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1102 =
                  let uu____1104 =
                    let uu____1106 = get_codegen_lib ()  in s :: uu____1106
                     in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1136 =
                  let uu____1138 =
                    let uu____1140 = get_debug_level ()  in x :: uu____1140
                     in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1177 =
                  let uu____1179 =
                    let uu____1181 = get_dump_module ()  in x :: uu____1181
                     in
           ...
           (((fun s  ->
                let uu____1275 =
                  let uu____1277 =
                    ...
                    FStar_List.map (fun _0_35  -> String _0_35) uu____1279
                     in
      ...
      (FStar_Getopt.noshort, "max_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1345 = FStar_Util.int_of_string x  in
                Int uu____1345)), "[non-negative integer]")),
        "Number of unrolling of recursive functions to try at most (default 8)");
      (FStar_Getopt.noshort, "max_ifuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1355 = FStar_Util.int_of_string x  in
                Int uu____1355)), "[non-negative integer]")),
        "Number of unrolling of inductive datatypes to try at most (default 2)");
      (FStar_Getopt.noshort, "min_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1365 = FStar_Util.int_of_string x  in
                Int uu____1365)), "[non-negative integer]")),
      ...
      (FStar_Getopt.noshort, "n_cores",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1382 = FStar_Util.int_of_string x  in
                Int uu____1382)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1399 =
                  let uu____1401 =
                    let uu____1403 = get_no_extract ()  in x :: uu____1403
                     in
                  FStar_All.pipe_right uu____1401
                    (FStar_List.map (fun _0_36  -> String _0_36))
                   in
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n1  ->
                let uu____1558 = FStar_Util.int_of_string n1  in
                Int uu____1558)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "use_eq_at_higher_order",
        (FStar_Getopt.ZeroArgs ((fun uu____1586  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "use_tactics",
        (FStar_Getopt.ZeroArgs ((fun uu____1600  -> Bool true))),
      ...
      (FStar_Getopt.noshort, "z3cliopt",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1665 =
                  let uu____1667 =
                    let uu____1669 = get_z3cliopt ()  in
                    FStar_List.append uu____1669 [s]  in
                  FStar_All.pipe_right uu____1667
                    (FStar_List.map (fun _0_42  -> String _0_42))
                   in
                List uu____1665)), "[option]")), "Z3 command line options");
      ...
      (FStar_Getopt.noshort, "z3rlimit_factor",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1699 = FStar_Util.int_of_string s  in
                Int uu____1699)), "[positive integer]")),
        "Set the Z3 per-query resource limit multiplier. This is useful when, say, regenerating hints and you want to be more lax. (default 1)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1709 = FStar_Util.int_of_string s  in
                Int uu____1709)), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "z3timeout",
        (FStar_Getopt.OneArg
           (((fun s  ->
                ...
                (let uu____1720 = FStar_Util.int_of_string s  in
                 Int uu____1720))), "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "__no_positivity",
       ...
       in
    let uu____1733 = FStar_List.map mk_spec specs1  in
    ('h', "help",
      (FStar_Getopt.ZeroArgs
         (fun x  ->
            display_usage_aux specs1; FStar_All.exit (Prims.parse_int "0"))),
      "Display this information") :: uu____1733
  ...
  fun s  ->
    ...
    | uu____1754 ->
        (FStar_Util.print_string "Wrong argument to codegen flag\n";
         (let uu____1757 = specs ()  in display_usage_aux uu____1757);
...
let docs : Prims.unit -> (Prims.string * Prims.string) Prims.list =
  fun uu____1782  ->
    let uu____1783 = specs ()  in
    FStar_List.map
      (fun uu____1797  ->
         match uu____1797 with
         | (uu____1805,name,uu____1807,doc) -> (name, doc)) uu____1783
  
let settable : Prims.string -> Prims.bool =
  fun uu___57_1813  ->
    match uu___57_1813 with
    | "admit_smt_queries"
      |"cardinality"
       |"debug"
        |"debug_level"
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1837  ->
          ...
          | (uu____1843,x,uu____1845,uu____1846) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____1867  ->
          ...
          | (uu____1873,x,uu____1875,uu____1876) -> resettable x))
  
let display_usage : Prims.unit -> Prims.unit =
  fun uu____1881  ->
    let uu____1882 = specs ()  in display_usage_aux uu____1882
  
let fstar_home : Prims.unit -> Prims.string =
  fun uu____1891  ->
    let uu____1892 = get_fstar_home ()  in
...
let set_options : options -> Prims.string -> FStar_Getopt.parse_cmdline_res =
  fun o  ->
    fun s  ->
      ...
      FStar_Getopt.parse_string specs1 (fun uu____1917  -> ()) s
...
let parse_cmd_line :
  ...
  fun uu____1928  ->
    let res =
      let uu____1930 = specs ()  in
      FStar_Getopt.parse_cmdline uu____1930
        (fun i  ->
           let uu____1933 =
             let uu____1935 = FStar_ST.read file_list_  in
             FStar_List.append uu____1935 [i]  in
           FStar_ST.write file_list_ uu____1933)
       in
    let uu____1943 =
      let uu____1945 = FStar_ST.read file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____1945
       in
    (res, uu____1943)
  
let file_list : Prims.unit -> Prims.string Prims.list =
  fun uu____1954  -> FStar_ST.read file_list_ 
let restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module ()  in
    if should_clear then clear () else init ();
    (let r =
       let uu____1966 = specs ()  in
       FStar_Getopt.parse_cmdline uu____1966 (fun x  -> ())  in
     (let uu____1970 =
        let uu____1973 =
          let uu____1974 =
            FStar_List.map (fun _0_43  -> String _0_43) old_verify_module  in
          List uu____1974  in
        ("verify_module", uu____1973)  in
      set_option' uu____1970);
     r)
  
let should_verify : Prims.string -> Prims.bool =
  fun m  ->
    let uu____1979 = get_lax ()  in
    if uu____1979
    then false
    else
      (let uu____1981 = get_verify_all ()  in
       if uu____1981
       then true
       else
         (let uu____1983 = get_verify_module ()  in
          match uu____1983 with
          | [] ->
              let uu____1985 = file_list ()  in
              FStar_List.existsML
                (fun f  ->
                   ...
                   let f2 =
                     let uu____1990 =
                       let uu____1991 =
                         let uu____1992 =
                           let uu____1993 = FStar_Util.get_file_extension f1
                              in
                           FStar_String.length uu____1993  in
                         (FStar_String.length f1) - uu____1992  in
                       uu____1991 - (Prims.parse_int "1")  in
                     FStar_String.substring f1 (Prims.parse_int "0")
                       uu____1990
                      in
                   (FStar_String.lowercase f2) = m) uu____1985
          | l -> FStar_List.contains (FStar_String.lowercase m) l))
  
let dont_gen_projectors : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2003 = get___temp_no_proj ()  in
    FStar_List.contains m uu____2003
  
let should_print_message : Prims.string -> Prims.bool =
  fun m  ->
    let uu____2008 = should_verify m  in
    if uu____2008 then m <> "Prims" else false
  
let include_path : Prims.unit -> Prims.string Prims.list =
  fun uu____2013  ->
    let uu____2014 = get_no_default_includes ()  in
    if uu____2014
    then get_include ()
    else
      (let h = fstar_home ()  in
       ...
       let uu____2020 =
         ...
         FStar_All.pipe_right uu____2022
          ...
          in
       let uu____2029 =
         let uu____2031 = get_include ()  in
         FStar_List.append uu____2031 ["."]  in
       FStar_List.append uu____2020 uu____2029)
  
let find_file : Prims.string -> Prims.string Prims.option =
  fun filename  ->
    let uu____2037 = FStar_Util.is_path_absolute filename  in
    if uu____2037
    then (if FStar_Util.file_exists filename then Some filename else None)
    else
      (let uu____2042 =
         let uu____2044 = include_path ()  in FStar_List.rev uu____2044  in
       FStar_Util.find_map uu____2042
         (fun p  ->
...
let prims : Prims.unit -> Prims.string =
  fun uu____2052  ->
    let uu____2053 = get_prims ()  in
    match uu____2053 with
    | None  ->
        let filename = "prims.fst"  in
        let uu____2056 = find_file filename  in
             ...
             let uu____2059 =
               let uu____2060 =
                 FStar_Util.format1
                   ...
                   filename
                  in
               FStar_Util.Failure uu____2060  in
             Prims.raise uu____2059)
    | Some x -> x
  
let prims_basename : Prims.unit -> Prims.string =
  fun uu____2064  ->
    let uu____2065 = prims ()  in FStar_Util.basename uu____2065
  
let prepend_output_dir : Prims.string -> Prims.string =
  fun fname  ->
    let uu____2069 = get_odir ()  in
...
let __temp_no_proj : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2075 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____2075 (FStar_List.contains s)
  
let admit_smt_queries : Prims.unit -> Prims.bool =
  fun uu____2080  -> get_admit_smt_queries () 
let check_cardinality : Prims.unit -> Prims.bool =
  fun uu____2083  ->
    let uu____2084 = get_cardinality ()  in uu____2084 = "check"
  
let check_hints : Prims.unit -> Prims.bool =
  fun uu____2087  -> get_check_hints () 
let codegen : Prims.unit -> Prims.string Prims.option =
  fun uu____2091  -> get_codegen () 
let codegen_libs : Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____2096  ->
    let uu____2097 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____2097
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let debug_any : Prims.unit -> Prims.bool =
  fun uu____2106  -> let uu____2107 = get_debug ()  in uu____2107 <> [] 
let debug_at_level : Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      ((modul = "") ||
         (let uu____2116 = get_debug ()  in
          FStar_All.pipe_right uu____2116 (FStar_List.contains modul)))
        && (debug_level_geq level)
  
let dep : Prims.unit -> Prims.string Prims.option =
  fun uu____2122  -> get_dep () 
let detail_errors : Prims.unit -> Prims.bool =
  fun uu____2125  -> get_detail_errors () 
let doc : Prims.unit -> Prims.bool = fun uu____2128  -> get_doc () 
let dump_module : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2132 = get_dump_module ()  in
    FStar_All.pipe_right uu____2132 (FStar_List.contains s)
  
let eager_inference : Prims.unit -> Prims.bool =
  fun uu____2137  -> get_eager_inference () 
let explicit_deps : Prims.unit -> Prims.bool =
  fun uu____2140  -> get_explicit_deps () 
let extract_all : Prims.unit -> Prims.bool =
  fun uu____2143  -> get_extract_all () 
let fs_typ_app : Prims.string -> Prims.bool =
  fun filename  ->
    let uu____2147 = FStar_ST.read light_off_files  in
    FStar_List.contains filename uu____2147
  
let full_context_dependency : Prims.unit -> Prims.bool =
  fun uu____2154  -> true 
let hide_genident_nums : Prims.unit -> Prims.bool =
  fun uu____2157  -> get_hide_genident_nums () 
let hide_uvar_nums : Prims.unit -> Prims.bool =
  fun uu____2160  -> get_hide_uvar_nums () 
let hint_info : Prims.unit -> Prims.bool =
  fun uu____2163  -> get_hint_info () 
let ide : Prims.unit -> Prims.bool = fun uu____2166  -> get_ide () 
let indent : Prims.unit -> Prims.bool = fun uu____2169  -> get_indent () 
let initial_fuel : Prims.unit -> Prims.int =
  fun uu____2172  ->
    let uu____2173 = get_initial_fuel ()  in
    let uu____2174 = get_max_fuel ()  in Prims.min uu____2173 uu____2174
  
let initial_ifuel : Prims.unit -> Prims.int =
  fun uu____2177  ->
    let uu____2178 = get_initial_ifuel ()  in
    let uu____2179 = get_max_ifuel ()  in Prims.min uu____2178 uu____2179
  
let inline_arith : Prims.unit -> Prims.bool =
  fun uu____2182  -> get_inline_arith () 
let interactive : Prims.unit -> Prims.bool =
  fun uu____2185  -> (get_in ()) || (get_ide ()) 
let lax : Prims.unit -> Prims.bool = fun uu____2188  -> get_lax () 
let legacy_interactive : Prims.unit -> Prims.bool =
  fun uu____2191  -> get_in () 
let log_queries : Prims.unit -> Prims.bool =
  fun uu____2194  -> get_log_queries () 
let log_types : Prims.unit -> Prims.bool =
  fun uu____2197  -> get_log_types () 
let max_fuel : Prims.unit -> Prims.int = fun uu____2200  -> get_max_fuel () 
let max_ifuel : Prims.unit -> Prims.int = fun uu____2203  -> get_max_ifuel () 
let min_fuel : Prims.unit -> Prims.int = fun uu____2206  -> get_min_fuel () 
let ml_ish : Prims.unit -> Prims.bool = fun uu____2209  -> get_MLish () 
let set_ml_ish : Prims.unit -> Prims.unit =
  fun uu____2212  -> set_option "MLish" (Bool true) 
let n_cores : Prims.unit -> Prims.int = fun uu____2215  -> get_n_cores () 
let no_default_includes : Prims.unit -> Prims.bool =
  fun uu____2218  -> get_no_default_includes () 
let no_extract : Prims.string -> Prims.bool =
  fun s  ->
    let uu____2222 = get_no_extract ()  in
    FStar_All.pipe_right uu____2222 (FStar_List.contains s)
  
let no_location_info : Prims.unit -> Prims.bool =
  fun uu____2227  -> get_no_location_info () 
let norm_then_print : Prims.unit -> Prims.bool =
  fun uu____2230  ->
    let uu____2231 = get_print_before_norm ()  in uu____2231 = false
  
let output_dir : Prims.unit -> Prims.string Prims.option =
  fun uu____2235  -> get_odir () 
let print_bound_var_types : Prims.unit -> Prims.bool =
  fun uu____2238  -> get_print_bound_var_types () 
let print_effect_args : Prims.unit -> Prims.bool =
  fun uu____2241  -> get_print_effect_args () 
let print_fuels : Prims.unit -> Prims.bool =
  fun uu____2244  -> get_print_fuels () 
let print_implicits : Prims.unit -> Prims.bool =
  fun uu____2247  -> get_print_implicits () 
let print_real_names : Prims.unit -> Prims.bool =
  fun uu____2250  -> (get_prn ()) || (get_print_full_names ()) 
let print_universes : Prims.unit -> Prims.bool =
  fun uu____2253  -> get_print_universes () 
let print_z3_statistics : Prims.unit -> Prims.bool =
  fun uu____2256  -> get_print_z3_statistics () 
let record_hints : Prims.unit -> Prims.bool =
  fun uu____2259  -> get_record_hints () 
let reuse_hint_for : Prims.unit -> Prims.string Prims.option =
  fun uu____2263  -> get_reuse_hint_for () 
let silent : Prims.unit -> Prims.bool = fun uu____2266  -> get_silent () 
let split_cases : Prims.unit -> Prims.int =
  fun uu____2269  -> get_split_cases () 
let timing : Prims.unit -> Prims.bool = fun uu____2272  -> get_timing () 
let trace_error : Prims.unit -> Prims.bool =
  fun uu____2275  -> get_trace_error () 
let unthrottle_inductives : Prims.unit -> Prims.bool =
  fun uu____2278  -> get_unthrottle_inductives () 
let use_eq_at_higher_order : Prims.unit -> Prims.bool =
  fun uu____2281  -> get_use_eq_at_higher_order () 
let use_hints : Prims.unit -> Prims.bool =
  fun uu____2284  -> get_use_hints () 
let use_tactics : Prims.unit -> Prims.bool =
  fun uu____2287  -> get_use_tactics () 
let using_facts_from : Prims.unit -> Prims.string Prims.list Prims.option =
  fun uu____2292  -> get_using_facts_from () 
let verify_all : Prims.unit -> Prims.bool =
  fun uu____2295  -> get_verify_all () 
let verify_module : Prims.unit -> Prims.string Prims.list =
  fun uu____2299  -> get_verify_module () 
let warn_cardinality : Prims.unit -> Prims.bool =
  fun uu____2302  ->
    let uu____2303 = get_cardinality ()  in uu____2303 = "warn"
  
let warn_default_effects : Prims.unit -> Prims.bool =
  fun uu____2306  -> get_warn_default_effects () 
let warn_top_level_effects : Prims.unit -> Prims.bool =
  fun uu____2309  -> get_warn_top_level_effects () 
let z3_exe : Prims.unit -> Prims.string =
  fun uu____2312  ->
    let uu____2313 = get_smt ()  in
    match uu____2313 with | None  -> FStar_Platform.exe "z3" | Some s -> s
  
let z3_cliopt : Prims.unit -> Prims.string Prims.list =
  fun uu____2319  -> get_z3cliopt () 
let z3_refresh : Prims.unit -> Prims.bool =
  fun uu____2322  -> get_z3refresh () 
let z3_rlimit : Prims.unit -> Prims.int = fun uu____2325  -> get_z3rlimit () 
let z3_rlimit_factor : Prims.unit -> Prims.int =
  fun uu____2328  -> get_z3rlimit_factor () 
let z3_seed : Prims.unit -> Prims.int = fun uu____2331  -> get_z3seed () 
let z3_timeout : Prims.unit -> Prims.int =
  fun uu____2334  -> get_z3timeout () 
let no_positivity : Prims.unit -> Prims.bool =
  fun uu____2337  -> get_no_positivity () 
let should_extract : Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2341 = no_extract m  in Prims.op_Negation uu____2341) &&
      ((extract_all ()) ||
         (let uu____2342 = get_extract_module ()  in
          match uu____2342 with
          | [] ->
              let uu____2344 = get_extract_namespace ()  in
