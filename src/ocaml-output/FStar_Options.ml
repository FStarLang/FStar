  ...
  fun filename  ->
    ...
    | FStar_Pervasives_Native.None  ->
        let result =
          ...
          with | uu___35_10714 -> FStar_Pervasives_Native.None  in
        (match result with
       ...
       (let r =
          try
            (fun uu___38_12395  ->
              ...
              ()
          with | uu___37_12402 -> FStar_Util.Inl uu___37_12402  in
        pop ();
        (match r with
