...
let (get_detail_errors : unit -> Prims.bool) =
  fun uu____2833  -> lookup_opt "detail_errors" as_bool 
let (get_detail_hint_replay : unit -> Prims.bool) =
  fun uu____2842  -> lookup_opt "detail_hint_replay" as_bool 
let (get_doc : unit -> Prims.bool) =
  fun uu____2851  -> lookup_opt "doc" as_bool 
let (get_dump_module : unit -> Prims.string Prims.list) =
  fun uu____2862  -> lookup_opt "dump_module" (as_list as_string) 
let (get_eager_subtyping : unit -> Prims.bool) =
  fun uu____2874  -> lookup_opt "eager_subtyping" as_bool 
let (get_expose_interfaces : unit -> Prims.bool) =
  fun uu____2883  -> lookup_opt "expose_interfaces" as_bool 
let (get_extract :
  unit -> Prims.string Prims.list FStar_Pervasives_Native.option) =
  fun uu____2896  -> lookup_opt "extract" (as_option (as_list as_string)) 
let (get_extract_module : unit -> Prims.string Prims.list) =
  fun uu____2915  -> lookup_opt "extract_module" (as_list as_string) 
let (get_extract_namespace : unit -> Prims.string Prims.list) =
  fun uu____2929  -> lookup_opt "extract_namespace" (as_list as_string) 
let (get_fs_typ_app : unit -> Prims.bool) =
  fun uu____2941  -> lookup_opt "fs_typ_app" as_bool 
let (get_hide_uvar_nums : unit -> Prims.bool) =
  fun uu____2950  -> lookup_opt "hide_uvar_nums" as_bool 
let (get_hint_info : unit -> Prims.bool) =
  fun uu____2959  -> lookup_opt "hint_info" as_bool 
let (get_hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____2970  -> lookup_opt "hint_file" (as_option as_string) 
let (get_in : unit -> Prims.bool) =
  fun uu____2982  -> lookup_opt "in" as_bool 
let (get_ide : unit -> Prims.bool) =
  fun uu____2991  -> lookup_opt "ide" as_bool 
let (get_lsp : unit -> Prims.bool) =
  fun uu____3000  -> lookup_opt "lsp" as_bool 
let (get_include : unit -> Prims.string Prims.list) =
  fun uu____3011  -> lookup_opt "include" (as_list as_string) 
let (get_print : unit -> Prims.bool) =
  fun uu____3023  -> lookup_opt "print" as_bool 
let (get_print_in_place : unit -> Prims.bool) =
  fun uu____3032  -> lookup_opt "print_in_place" as_bool 
let (get_profile : unit -> Prims.bool) =
  fun uu____3041  -> lookup_opt "profile" as_bool 
let (get_initial_fuel : unit -> Prims.int) =
  fun uu____3050  -> lookup_opt "initial_fuel" as_int 
let (get_initial_ifuel : unit -> Prims.int) =
  fun uu____3059  -> lookup_opt "initial_ifuel" as_int 
let (get_keep_query_captions : unit -> Prims.bool) =
  fun uu____3068  -> lookup_opt "keep_query_captions" as_bool 
let (get_lax : unit -> Prims.bool) =
  fun uu____3077  -> lookup_opt "lax" as_bool 
let (get_load : unit -> Prims.string Prims.list) =
  fun uu____3088  -> lookup_opt "load" (as_list as_string) 
let (get_log_queries : unit -> Prims.bool) =
  fun uu____3100  -> lookup_opt "log_queries" as_bool 
let (get_log_types : unit -> Prims.bool) =
  fun uu____3109  -> lookup_opt "log_types" as_bool 
let (get_max_fuel : unit -> Prims.int) =
  fun uu____3118  -> lookup_opt "max_fuel" as_int 
let (get_max_ifuel : unit -> Prims.int) =
  fun uu____3127  -> lookup_opt "max_ifuel" as_int 
let (get_min_fuel : unit -> Prims.int) =
  fun uu____3136  -> lookup_opt "min_fuel" as_int 
let (get_MLish : unit -> Prims.bool) =
  fun uu____3145  -> lookup_opt "MLish" as_bool 
let (get_n_cores : unit -> Prims.int) =
  fun uu____3154  -> lookup_opt "n_cores" as_int 
let (get_no_default_includes : unit -> Prims.bool) =
  fun uu____3163  -> lookup_opt "no_default_includes" as_bool 
let (get_no_extract : unit -> Prims.string Prims.list) =
  fun uu____3174  -> lookup_opt "no_extract" (as_list as_string) 
let (get_no_location_info : unit -> Prims.bool) =
  fun uu____3186  -> lookup_opt "no_location_info" as_bool 
let (get_no_plugins : unit -> Prims.bool) =
  fun uu____3195  -> lookup_opt "no_plugins" as_bool 
let (get_no_smt : unit -> Prims.bool) =
  fun uu____3204  -> lookup_opt "no_smt" as_bool 
let (get_normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____3213  -> lookup_opt "normalize_pure_terms_for_extraction" as_bool 
let (get_odir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3224  -> lookup_opt "odir" (as_option as_string) 
let (get_ugly : unit -> Prims.bool) =
  fun uu____3236  -> lookup_opt "ugly" as_bool 
let (get_prims : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3247  -> lookup_opt "prims" (as_option as_string) 
let (get_print_bound_var_types : unit -> Prims.bool) =
  fun uu____3259  -> lookup_opt "print_bound_var_types" as_bool 
let (get_print_effect_args : unit -> Prims.bool) =
  fun uu____3268  -> lookup_opt "print_effect_args" as_bool 
let (get_print_full_names : unit -> Prims.bool) =
  fun uu____3277  -> lookup_opt "print_full_names" as_bool 
let (get_print_implicits : unit -> Prims.bool) =
  fun uu____3286  -> lookup_opt "print_implicits" as_bool 
let (get_print_universes : unit -> Prims.bool) =
  fun uu____3295  -> lookup_opt "print_universes" as_bool 
let (get_print_z3_statistics : unit -> Prims.bool) =
  fun uu____3304  -> lookup_opt "print_z3_statistics" as_bool 
let (get_prn : unit -> Prims.bool) =
  fun uu____3313  -> lookup_opt "prn" as_bool 
let (get_query_stats : unit -> Prims.bool) =
  fun uu____3322  -> lookup_opt "query_stats" as_bool 
let (get_record_hints : unit -> Prims.bool) =
  fun uu____3331  -> lookup_opt "record_hints" as_bool 
let (get_reuse_hint_for :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3342  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let (get_silent : unit -> Prims.bool) =
  fun uu____3354  -> lookup_opt "silent" as_bool 
let (get_smt : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3365  -> lookup_opt "smt" (as_option as_string) 
let (get_smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____3377  -> lookup_opt "smtencoding.elim_box" as_bool 
let (get_smtencoding_nl_arith_repr : unit -> Prims.string) =
  fun uu____3386  -> lookup_opt "smtencoding.nl_arith_repr" as_string 
let (get_smtencoding_l_arith_repr : unit -> Prims.string) =
  fun uu____3395  -> lookup_opt "smtencoding.l_arith_repr" as_string 
let (get_smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____3404  -> lookup_opt "smtencoding.valid_intro" as_bool 
let (get_smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____3413  -> lookup_opt "smtencoding.valid_elim" as_bool 
let (get_tactic_raw_binders : unit -> Prims.bool) =
  fun uu____3422  -> lookup_opt "tactic_raw_binders" as_bool 
let (get_tactics_failhard : unit -> Prims.bool) =
  fun uu____3431  -> lookup_opt "tactics_failhard" as_bool 
let (get_tactics_info : unit -> Prims.bool) =
  fun uu____3440  -> lookup_opt "tactics_info" as_bool 
let (get_tactic_trace : unit -> Prims.bool) =
  fun uu____3449  -> lookup_opt "tactic_trace" as_bool 
let (get_tactic_trace_d : unit -> Prims.int) =
  fun uu____3458  -> lookup_opt "tactic_trace_d" as_int 
let (get_tactics_nbe : unit -> Prims.bool) =
  fun uu____3467  -> lookup_opt "__tactics_nbe" as_bool 
let (get_tcnorm : unit -> Prims.bool) =
  fun uu____3476  -> lookup_opt "tcnorm" as_bool 
let (get_timing : unit -> Prims.bool) =
  fun uu____3485  -> lookup_opt "timing" as_bool 
let (get_trace_error : unit -> Prims.bool) =
  fun uu____3494  -> lookup_opt "trace_error" as_bool 
let (get_unthrottle_inductives : unit -> Prims.bool) =
  fun uu____3503  -> lookup_opt "unthrottle_inductives" as_bool 
let (get_unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____3512  -> lookup_opt "unsafe_tactic_exec" as_bool 
let (get_use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____3521  -> lookup_opt "use_eq_at_higher_order" as_bool 
let (get_use_hints : unit -> Prims.bool) =
  fun uu____3530  -> lookup_opt "use_hints" as_bool 
let (get_use_hint_hashes : unit -> Prims.bool) =
  fun uu____3539  -> lookup_opt "use_hint_hashes" as_bool 
let (get_use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3550  -> lookup_opt "use_native_tactics" (as_option as_string) 
let (get_use_tactics : unit -> Prims.bool) =
  fun uu____3562  ->
    let uu____3563 = lookup_opt "no_tactics" as_bool  in
...
let (get_verify_module : unit -> Prims.string Prims.list) =
  fun uu____3610  -> lookup_opt "verify_module" (as_list as_string) 
let (get___temp_no_proj : unit -> Prims.string Prims.list) =
  fun uu____3624  -> lookup_opt "__temp_no_proj" (as_list as_string) 
let (get_version : unit -> Prims.bool) =
  fun uu____3636  -> lookup_opt "version" as_bool 
let (get_warn_default_effects : unit -> Prims.bool) =
  fun uu____3645  -> lookup_opt "warn_default_effects" as_bool 
let (get_z3cliopt : unit -> Prims.string Prims.list) =
  fun uu____3656  -> lookup_opt "z3cliopt" (as_list as_string) 
let (get_z3refresh : unit -> Prims.bool) =
  fun uu____3668  -> lookup_opt "z3refresh" as_bool 
let (get_z3rlimit : unit -> Prims.int) =
  fun uu____3677  -> lookup_opt "z3rlimit" as_int 
let (get_z3rlimit_factor : unit -> Prims.int) =
  fun uu____3686  -> lookup_opt "z3rlimit_factor" as_int 
let (get_z3seed : unit -> Prims.int) =
  fun uu____3695  -> lookup_opt "z3seed" as_int 
let (get_use_two_phase_tc : unit -> Prims.bool) =
  fun uu____3704  -> lookup_opt "use_two_phase_tc" as_bool 
let (get_no_positivity : unit -> Prims.bool) =
  fun uu____3713  -> lookup_opt "__no_positivity" as_bool 
let (get_ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____3722  -> lookup_opt "__ml_no_eta_expand_coertions" as_bool 
let (get_warn_error : unit -> Prims.string Prims.list) =
  fun uu____3733  -> lookup_opt "warn_error" (as_list as_string) 
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____7393  ->
          ...
          | (uu____7408,x,uu____7410,uu____7411) -> settable x))
  
let (display_usage : unit -> unit) =
  fun uu____7427  ->
    let uu____7428 = specs ()  in display_usage_aux uu____7428
...
let (uu___is_File_argument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | File_argument uu____7460 -> true
    | uu____7463 -> false
  
let (__proj__File_argument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | File_argument uu____7473 -> uu____7473
  ...
  fun uu____7526  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____7532 =
             let uu____7536 = FStar_ST.op_Bang file_list_  in
             FStar_List.append uu____7536 [i]  in
           FStar_ST.op_Colon_Equals file_list_ uu____7532)
       in
    let uu____7593 =
      let uu____7597 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____7597
       in
    (res, uu____7593)
  
let (file_list : unit -> Prims.string Prims.list) =
  fun uu____7639  -> FStar_ST.op_Bang file_list_ 
let (restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res)
  ...
  fun should_clear  ->
    ...
    (let r =
       let uu____7682 = specs ()  in
       FStar_Getopt.parse_cmdline uu____7682 (fun x  -> ())  in
     (let uu____7689 =
        let uu____7695 =
          let uu____7696 =
            FStar_List.map (fun _7700  -> String _7700) old_verify_module  in
          List uu____7696  in
        ("verify_module", uu____7695)  in
      set_option' uu____7689);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____7716 =
        let uu____7718 =
          let uu____7720 =
            let uu____7722 = FStar_Util.get_file_extension f1  in
            FStar_String.length uu____7722  in
          (FStar_String.length f1) - uu____7720  in
        uu____7718 - (Prims.parse_int "1")  in
      FStar_String.substring f1 (Prims.parse_int "0") uu____7716  in
    FStar_String.lowercase f2
  
let (should_verify : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____7735 = get_lax ()  in
    if uu____7735
    then false
    else
...
let (should_verify_file : Prims.string -> Prims.bool) =
  fun fn  ->
    let uu____7756 = module_name_of_file_name fn  in should_verify uu____7756
...
let (dont_gen_projectors : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____7784 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____7784 (FStar_List.existsb (module_name_eq m))
  
let (should_print_message : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____7802 = should_verify m  in
    if uu____7802 then m <> "Prims" else false
  
let (include_path : unit -> Prims.string Prims.list) =
  fun uu____7819  ->
    let cache_dir =
      let uu____7824 = get_cache_dir ()  in
      match uu____7824 with
      | FStar_Pervasives_Native.None  -> []
      | FStar_Pervasives_Native.Some c -> [c]  in
    let uu____7838 = get_no_default_includes ()  in
    if uu____7838
    then
      let uu____7844 = get_include ()  in
      FStar_List.append cache_dir uu____7844
    else
      (let lib_paths =
         let uu____7855 = FStar_Util.expand_environment_variable "FSTAR_LIB"
            in
       ...
       let uu____7898 =
         let uu____7902 =
           ...
           FStar_List.append uu____7906 ["."]  in
         FStar_List.append lib_paths uu____7902  in
       FStar_List.append cache_dir uu____7898)
  
let (find_file : Prims.string -> Prims.string FStar_Pervasives_Native.option)
  =
  let file_map = FStar_Util.smap_create (Prims.parse_int "100")  in
  fun filename  ->
    let uu____7937 = FStar_Util.smap_try_find file_map filename  in
        ...
        let result =
          try
            (fun uu___519_7968  ->
               match () with
               | () ->
                   let uu____7972 = FStar_Util.is_path_absolute filename  in
                   if uu____7972
                   then
                     ...
                     (let uu____7988 =
                        let uu____7992 = include_path ()  in
                        FStar_List.rev uu____7992  in
                      FStar_Util.find_map uu____7988
                        (fun p  ->
                           let path =
                             if p = "."
                             then filename
          ...
          with | uu___518_8020 -> FStar_Pervasives_Native.None  in
...
let (prims : unit -> Prims.string) =
  fun uu____8039  ->
    let uu____8040 = get_prims ()  in
    match uu____8040 with
    | FStar_Pervasives_Native.None  ->
        let filename = "prims.fst"  in
        let uu____8049 = find_file filename  in
...
let (prims_basename : unit -> Prims.string) =
  fun uu____8071  ->
    let uu____8072 = prims ()  in FStar_Util.basename uu____8072
  
let (pervasives : unit -> Prims.string) =
  fun uu____8080  ->
    let filename = "FStar.Pervasives.fst"  in
    let uu____8084 = find_file filename  in
...
let (pervasives_basename : unit -> Prims.string) =
  fun uu____8103  ->
    let uu____8104 = pervasives ()  in FStar_Util.basename uu____8104
  
let (pervasives_native_basename : unit -> Prims.string) =
  fun uu____8112  ->
    let filename = "FStar.Pervasives.Native.fst"  in
    let uu____8116 = find_file filename  in
...
let (prepend_cache_dir : Prims.string -> Prims.string) =
  fun fpath  ->
    let uu____8156 = get_cache_dir ()  in
    match uu____8156 with
    | FStar_Pervasives_Native.None  -> fpath
    | FStar_Pervasives_Native.Some x ->
        let uu____8165 = FStar_Util.basename fpath  in
        FStar_Util.join_paths x uu____8165
...
let (parse_settings :
  ...
  fun ns  ->
    ...
    let with_cache f s =
      let uu____8287 = FStar_Util.smap_try_find cache s  in
    ...
    let uu____8464 =
      FStar_All.pipe_right ns
       ...
       in
    FStar_All.pipe_right uu____8464 FStar_List.rev
  
let (__temp_no_proj : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____8629 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____8629 (FStar_List.contains s)
  
let (__temp_fast_implicits : unit -> Prims.bool) =
  fun uu____8644  -> lookup_opt "__temp_fast_implicits" as_bool 
let (admit_smt_queries : unit -> Prims.bool) =
  fun uu____8653  -> get_admit_smt_queries () 
let (admit_except : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____8662  -> get_admit_except () 
let (cache_checked_modules : unit -> Prims.bool) =
  fun uu____8669  -> get_cache_checked_modules () 
let (cache_off : unit -> Prims.bool) = fun uu____8676  -> get_cache_off () 
let (cmi : unit -> Prims.bool) = fun uu____8683  -> get_cmi () 
type codegen_t =
  | OCaml 
  | FSharp 
  | Kremlin 
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | OCaml  -> true | uu____8693 -> false
  
let (uu___is_FSharp : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | FSharp  -> true | uu____8704 -> false
  
let (uu___is_Kremlin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Kremlin  -> true | uu____8715 -> false
  
let (uu___is_Plugin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Plugin  -> true | uu____8726 -> false
  
let (codegen : unit -> codegen_t FStar_Pervasives_Native.option) =
  fun uu____8735  ->
    let uu____8736 = get_codegen ()  in
    FStar_Util.map_opt uu____8736
      (fun uu___9_8742  ->
         match uu___9_8742 with
         | "OCaml" -> OCaml
         | "FSharp" -> FSharp
         | "Kremlin" -> Kremlin
         | "Plugin" -> Plugin
...
let (codegen_libs : unit -> Prims.string Prims.list Prims.list) =
  fun uu____8761  ->
    let uu____8762 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____8762
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let (debug_any : unit -> Prims.bool) =
  fun uu____8788  -> let uu____8789 = get_debug ()  in uu____8789 <> [] 
let (debug_module : Prims.string -> Prims.bool) =
  fun modul  ->
    let uu____8806 = get_debug ()  in
...
let (debug_at_level : Prims.string -> debug_level_t -> Prims.bool) =
  fun modul  ->
    fun level  ->
      (let uu____8831 = get_debug ()  in
       FStar_All.pipe_right uu____8831
         (FStar_List.existsb (module_name_eq modul)))
        && (debug_level_geq level)
  
let (defensive : unit -> Prims.bool) =
  fun uu____8846  -> let uu____8847 = get_defensive ()  in uu____8847 <> "no" 
let (defensive_fail : unit -> Prims.bool) =
  fun uu____8857  ->
    let uu____8858 = get_defensive ()  in uu____8858 = "fail"
  
let (dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____8870  -> get_dep () 
let (detail_errors : unit -> Prims.bool) =
  fun uu____8877  -> get_detail_errors () 
let (detail_hint_replay : unit -> Prims.bool) =
  fun uu____8884  -> get_detail_hint_replay () 
let (doc : unit -> Prims.bool) = fun uu____8891  -> get_doc () 
let (dump_module : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____8901 = get_dump_module ()  in
    FStar_All.pipe_right uu____8901 (FStar_List.existsb (module_name_eq s))
  
let (eager_subtyping : unit -> Prims.bool) =
  fun uu____8916  -> get_eager_subtyping () 
let (expose_interfaces : unit -> Prims.bool) =
  fun uu____8923  -> get_expose_interfaces () 
let (fs_typ_app : Prims.string -> Prims.bool) =
  fun filename  ->
    let uu____8933 = FStar_ST.op_Bang light_off_files  in
    FStar_List.contains filename uu____8933
  
let (full_context_dependency : unit -> Prims.bool) = fun uu____8969  -> true 
let (hide_uvar_nums : unit -> Prims.bool) =
  fun uu____8977  -> get_hide_uvar_nums () 
let (hint_info : unit -> Prims.bool) =
  fun uu____8984  -> (get_hint_info ()) || (get_query_stats ()) 
let (hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____8993  -> get_hint_file () 
let (ide : unit -> Prims.bool) = fun uu____9000  -> get_ide () 
let (print : unit -> Prims.bool) = fun uu____9007  -> get_print () 
let (print_in_place : unit -> Prims.bool) =
  fun uu____9014  -> get_print_in_place () 
let profile : 'a . (unit -> 'a) -> ('a -> Prims.string) -> 'a =
  fun f  ->
    fun msg  ->
      let uu____9045 = get_profile ()  in
      if uu____9045
      then
        let uu____9048 = FStar_Util.record_time f  in
        match uu____9048 with
        | (a,time) ->
            ((let uu____9059 = FStar_Util.string_of_int time  in
              let uu____9061 = msg a  in
...
let (initial_fuel : unit -> Prims.int) =
  fun uu____9072  ->
    let uu____9073 = get_initial_fuel ()  in
    let uu____9075 = get_max_fuel ()  in Prims.min uu____9073 uu____9075
  
let (initial_ifuel : unit -> Prims.int) =
  fun uu____9083  ->
    let uu____9084 = get_initial_ifuel ()  in
    let uu____9086 = get_max_ifuel ()  in Prims.min uu____9084 uu____9086
  
let (interactive : unit -> Prims.bool) =
  fun uu____9094  -> (get_in ()) || (get_ide ()) 
let (lax : unit -> Prims.bool) = fun uu____9101  -> get_lax () 
let (load : unit -> Prims.string Prims.list) = fun uu____9110  -> get_load () 
let (legacy_interactive : unit -> Prims.bool) = fun uu____9117  -> get_in () 
let (lsp_server : unit -> Prims.bool) = fun uu____9124  -> get_lsp () 
let (log_queries : unit -> Prims.bool) =
  fun uu____9131  -> get_log_queries () 
let (keep_query_captions : unit -> Prims.bool) =
  fun uu____9138  -> (log_queries ()) && (get_keep_query_captions ()) 
let (log_types : unit -> Prims.bool) = fun uu____9145  -> get_log_types () 
let (max_fuel : unit -> Prims.int) = fun uu____9152  -> get_max_fuel () 
let (max_ifuel : unit -> Prims.int) = fun uu____9159  -> get_max_ifuel () 
let (min_fuel : unit -> Prims.int) = fun uu____9166  -> get_min_fuel () 
let (ml_ish : unit -> Prims.bool) = fun uu____9173  -> get_MLish () 
let (set_ml_ish : unit -> unit) =
  fun uu____9179  -> set_option "MLish" (Bool true) 
let (n_cores : unit -> Prims.int) = fun uu____9188  -> get_n_cores () 
let (no_default_includes : unit -> Prims.bool) =
  fun uu____9195  -> get_no_default_includes () 
let (no_extract : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9205 = get_no_extract ()  in
    FStar_All.pipe_right uu____9205 (FStar_List.existsb (module_name_eq s))
  
let (normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____9220  -> get_normalize_pure_terms_for_extraction () 
let (no_location_info : unit -> Prims.bool) =
  fun uu____9227  -> get_no_location_info () 
let (no_plugins : unit -> Prims.bool) = fun uu____9234  -> get_no_plugins () 
let (no_smt : unit -> Prims.bool) = fun uu____9241  -> get_no_smt () 
let (output_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9250  -> get_odir () 
let (ugly : unit -> Prims.bool) = fun uu____9257  -> get_ugly () 
let (print_bound_var_types : unit -> Prims.bool) =
  fun uu____9264  -> get_print_bound_var_types () 
let (print_effect_args : unit -> Prims.bool) =
  fun uu____9271  -> get_print_effect_args () 
let (print_implicits : unit -> Prims.bool) =
  fun uu____9278  -> get_print_implicits () 
let (print_real_names : unit -> Prims.bool) =
  fun uu____9285  -> (get_prn ()) || (get_print_full_names ()) 
let (print_universes : unit -> Prims.bool) =
  fun uu____9292  -> get_print_universes () 
let (print_z3_statistics : unit -> Prims.bool) =
  fun uu____9299  -> get_print_z3_statistics () 
let (query_stats : unit -> Prims.bool) =
  fun uu____9306  -> get_query_stats () 
let (record_hints : unit -> Prims.bool) =
  fun uu____9313  -> get_record_hints () 
let (reuse_hint_for : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9322  -> get_reuse_hint_for () 
let (silent : unit -> Prims.bool) = fun uu____9329  -> get_silent () 
let (smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____9336  -> get_smtencoding_elim_box () 
let (smtencoding_nl_arith_native : unit -> Prims.bool) =
  fun uu____9343  ->
    let uu____9344 = get_smtencoding_nl_arith_repr ()  in
    uu____9344 = "native"
...
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____9376  ->
    let uu____9377 = get_smtencoding_l_arith_repr ()  in
    uu____9377 = "native"
...
let (smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____9398  -> get_smtencoding_valid_intro () 
let (smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____9405  -> get_smtencoding_valid_elim () 
let (tactic_raw_binders : unit -> Prims.bool) =
  fun uu____9412  -> get_tactic_raw_binders () 
let (tactics_failhard : unit -> Prims.bool) =
  fun uu____9419  -> get_tactics_failhard () 
let (tactics_info : unit -> Prims.bool) =
  fun uu____9426  -> get_tactics_info () 
let (tactic_trace : unit -> Prims.bool) =
  fun uu____9433  -> get_tactic_trace () 
let (tactic_trace_d : unit -> Prims.int) =
  fun uu____9440  -> get_tactic_trace_d () 
let (tactics_nbe : unit -> Prims.bool) =
  fun uu____9447  -> get_tactics_nbe () 
let (tcnorm : unit -> Prims.bool) = fun uu____9454  -> get_tcnorm () 
let (timing : unit -> Prims.bool) = fun uu____9461  -> get_timing () 
let (trace_error : unit -> Prims.bool) =
  fun uu____9468  -> get_trace_error () 
let (unthrottle_inductives : unit -> Prims.bool) =
  fun uu____9475  -> get_unthrottle_inductives () 
let (unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____9482  -> get_unsafe_tactic_exec () 
let (use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____9489  -> get_use_eq_at_higher_order () 
let (use_hints : unit -> Prims.bool) = fun uu____9496  -> get_use_hints () 
let (use_hint_hashes : unit -> Prims.bool) =
  fun uu____9503  -> get_use_hint_hashes () 
let (use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9512  -> get_use_native_tactics () 
let (use_tactics : unit -> Prims.bool) =
  fun uu____9519  -> get_use_tactics () 
let (using_facts_from :
  unit -> (Prims.string Prims.list * Prims.bool) Prims.list) =
  fun uu____9535  ->
    let uu____9536 = get_using_facts_from ()  in
...
let (vcgen_optimize_bind_as_seq : unit -> Prims.bool) =
  fun uu____9590  ->
    let uu____9591 = get_vcgen_optimize_bind_as_seq ()  in
    FStar_Option.isSome uu____9591
  
let (vcgen_decorate_with_type : unit -> Prims.bool) =
  fun uu____9602  ->
    let uu____9603 = get_vcgen_optimize_bind_as_seq ()  in
    match uu____9603 with
    | FStar_Pervasives_Native.Some "with_type" -> true
    | uu____9611 -> false
  
let (warn_default_effects : unit -> Prims.bool) =
  fun uu____9622  -> get_warn_default_effects () 
let (z3_exe : unit -> Prims.string) =
  fun uu____9629  ->
    let uu____9630 = get_smt ()  in
    match uu____9630 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
  
let (z3_cliopt : unit -> Prims.string Prims.list) =
  fun uu____9648  -> get_z3cliopt () 
let (z3_refresh : unit -> Prims.bool) = fun uu____9655  -> get_z3refresh () 
let (z3_rlimit : unit -> Prims.int) = fun uu____9662  -> get_z3rlimit () 
let (z3_rlimit_factor : unit -> Prims.int) =
  fun uu____9669  -> get_z3rlimit_factor () 
let (z3_seed : unit -> Prims.int) = fun uu____9676  -> get_z3seed () 
let (use_two_phase_tc : unit -> Prims.bool) =
  fun uu____9683  ->
    (get_use_two_phase_tc ()) &&
      (let uu____9685 = lax ()  in Prims.op_Negation uu____9685)
  
let (no_positivity : unit -> Prims.bool) =
  fun uu____9693  -> get_no_positivity () 
let (ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____9700  -> get_ml_no_eta_expand_coertions () 
let (warn_error : unit -> Prims.string) =
  fun uu____9707  ->
    let uu____9708 = get_warn_error ()  in FStar_String.concat "" uu____9708
...
let with_saved_options : 'a . (unit -> 'a) -> 'a =
  fun f  ->
    let uu____9750 =
      let uu____9752 = trace_error ()  in Prims.op_Negation uu____9752  in
    if uu____9750
    then
      (push ();
       (let r =
          try
            (fun uu___722_9767  ->
               match () with
               | () -> let uu____9772 = f ()  in FStar_Util.Inr uu____9772)
              ()
          with | uu___721_9774 -> FStar_Util.Inl uu___721_9774  in
        pop ();
        (match r with
        ...
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____9942  ->
                ...
                | (path,uu____9953) -> matches_path m_components path))
         in
      match uu____9900 with
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some (uu____9972,flag) -> flag
  
let (should_extract : Prims.string -> Prims.bool) =
  fun m  ->
    let m1 = FStar_String.lowercase m  in
    let uu____10001 = get_extract ()  in
    match uu____10001 with
    | FStar_Pervasives_Native.Some extract_setting ->
        ((let uu____10016 =
            let uu____10032 = get_no_extract ()  in
            let uu____10036 = get_extract_namespace ()  in
            let uu____10040 = get_extract_module ()  in
            (uu____10032, uu____10036, uu____10040)  in
    ...
    | FStar_Pervasives_Native.None  ->
        let should_extract_namespace m2 =
          let uu____10094 = get_extract_namespace ()  in
        ...
        let should_extract_module m2 =
          let uu____10122 = get_extract_module ()  in
          ...
          | l ->
           ...
           in
        (let uu____10144 = no_extract m1  in Prims.op_Negation uu____10144)
          &&
          (let uu____10147 =
             let uu____10158 = get_extract_namespace ()  in
             let uu____10162 = get_extract_module ()  in
             (uu____10158, uu____10162)  in
...
let (should_be_already_cached : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____10202 = get_already_cached ()  in
...
let (error_flags : unit -> error_flag Prims.list) =
  ...
  fun uu____10235  ->
    ...
    let uu____10238 = FStar_Util.smap_try_find cache we  in
