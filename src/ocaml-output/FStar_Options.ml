...
let (get_option : Prims.string -> option_val) =
  fun s  ->
    let uu____2702 =
      let uu____2705 = internal_peek ()  in
      FStar_Util.smap_try_find uu____2705 s  in
...
let (get_print_cache_version : unit -> Prims.bool) =
  fun uu____2832  -> lookup_opt "print_cache_version" as_bool 
let (get_cmi : unit -> Prims.bool) =
  fun uu____2841  -> lookup_opt "cmi" as_bool 
let (get_codegen : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____2852  -> lookup_opt "codegen" (as_option as_string) 
let (get_codegen_lib : unit -> Prims.string Prims.list) =
  fun uu____2866  -> lookup_opt "codegen-lib" (as_list as_string) 
let (get_debug : unit -> Prims.string Prims.list) =
  fun uu____2880  -> lookup_opt "debug" (as_list as_string) 
let (get_debug_level : unit -> Prims.string Prims.list) =
  fun uu____2894  -> lookup_opt "debug_level" as_comma_string_list 
let (get_defensive : unit -> Prims.string) =
  fun uu____2905  -> lookup_opt "defensive" as_string 
let (get_dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____2916  -> lookup_opt "dep" (as_option as_string) 
let (get_detail_errors : unit -> Prims.bool) =
  fun uu____2928  -> lookup_opt "detail_errors" as_bool 
let (get_detail_hint_replay : unit -> Prims.bool) =
  fun uu____2937  -> lookup_opt "detail_hint_replay" as_bool 
...
let (get_hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3056  -> lookup_opt "hint_dir" (as_option as_string) 
let (get_hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3070  -> lookup_opt "hint_file" (as_option as_string) 
let (get_in : unit -> Prims.bool) =
  fun uu____3082  -> lookup_opt "in" as_bool 
let (get_ide : unit -> Prims.bool) =
  fun uu____3091  -> lookup_opt "ide" as_bool 
let (get_lsp : unit -> Prims.bool) =
  fun uu____3100  -> lookup_opt "lsp" as_bool 
let (get_include : unit -> Prims.string Prims.list) =
  fun uu____3111  -> lookup_opt "include" (as_list as_string) 
let (get_print : unit -> Prims.bool) =
  fun uu____3123  -> lookup_opt "print" as_bool 
let (get_print_in_place : unit -> Prims.bool) =
  fun uu____3132  -> lookup_opt "print_in_place" as_bool 
let (get_initial_fuel : unit -> Prims.int) =
  fun uu____3141  -> lookup_opt "initial_fuel" as_int 
let (get_initial_ifuel : unit -> Prims.int) =
  fun uu____3150  -> lookup_opt "initial_ifuel" as_int 
let (get_keep_query_captions : unit -> Prims.bool) =
  fun uu____3159  -> lookup_opt "keep_query_captions" as_bool 
let (get_lax : unit -> Prims.bool) =
  fun uu____3168  -> lookup_opt "lax" as_bool 
let (get_load : unit -> Prims.string Prims.list) =
  fun uu____3179  -> lookup_opt "load" (as_list as_string) 
let (get_log_queries : unit -> Prims.bool) =
  fun uu____3191  -> lookup_opt "log_queries" as_bool 
let (get_log_types : unit -> Prims.bool) =
  fun uu____3200  -> lookup_opt "log_types" as_bool 
let (get_max_fuel : unit -> Prims.int) =
  fun uu____3209  -> lookup_opt "max_fuel" as_int 
let (get_max_ifuel : unit -> Prims.int) =
  fun uu____3218  -> lookup_opt "max_ifuel" as_int 
let (get_min_fuel : unit -> Prims.int) =
  fun uu____3227  -> lookup_opt "min_fuel" as_int 
let (get_MLish : unit -> Prims.bool) =
  fun uu____3236  -> lookup_opt "MLish" as_bool 
let (get_no_default_includes : unit -> Prims.bool) =
  fun uu____3245  -> lookup_opt "no_default_includes" as_bool 
let (get_no_extract : unit -> Prims.string Prims.list) =
  fun uu____3256  -> lookup_opt "no_extract" (as_list as_string) 
let (get_no_load_fstartaclib : unit -> Prims.bool) =
  fun uu____3268  -> lookup_opt "no_load_fstartaclib" as_bool 
let (get_no_location_info : unit -> Prims.bool) =
  fun uu____3277  -> lookup_opt "no_location_info" as_bool 
let (get_no_plugins : unit -> Prims.bool) =
  fun uu____3286  -> lookup_opt "no_plugins" as_bool 
let (get_no_smt : unit -> Prims.bool) =
  fun uu____3295  -> lookup_opt "no_smt" as_bool 
let (get_normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____3304  -> lookup_opt "normalize_pure_terms_for_extraction" as_bool 
let (get_odir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3315  -> lookup_opt "odir" (as_option as_string) 
let (get_ugly : unit -> Prims.bool) =
  fun uu____3327  -> lookup_opt "ugly" as_bool 
let (get_prims : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3338  -> lookup_opt "prims" (as_option as_string) 
let (get_print_bound_var_types : unit -> Prims.bool) =
  fun uu____3350  -> lookup_opt "print_bound_var_types" as_bool 
let (get_print_effect_args : unit -> Prims.bool) =
  fun uu____3359  -> lookup_opt "print_effect_args" as_bool 
let (get_print_full_names : unit -> Prims.bool) =
  fun uu____3368  -> lookup_opt "print_full_names" as_bool 
let (get_print_implicits : unit -> Prims.bool) =
  fun uu____3377  -> lookup_opt "print_implicits" as_bool 
let (get_print_universes : unit -> Prims.bool) =
  fun uu____3386  -> lookup_opt "print_universes" as_bool 
let (get_print_z3_statistics : unit -> Prims.bool) =
  fun uu____3395  -> lookup_opt "print_z3_statistics" as_bool 
let (get_prn : unit -> Prims.bool) =
  fun uu____3404  -> lookup_opt "prn" as_bool 
let (get_quake_lo : unit -> Prims.int) =
  fun uu____3413  -> lookup_opt "quake_lo" as_int 
let (get_quake_hi : unit -> Prims.int) =
  fun uu____3422  -> lookup_opt "quake_hi" as_int 
let (get_quake_keep : unit -> Prims.bool) =
  fun uu____3431  -> lookup_opt "quake_keep" as_bool 
let (get_query_stats : unit -> Prims.bool) =
  fun uu____3440  -> lookup_opt "query_stats" as_bool 
let (get_record_hints : unit -> Prims.bool) =
  fun uu____3449  -> lookup_opt "record_hints" as_bool 
let (get_record_options : unit -> Prims.bool) =
  fun uu____3458  -> lookup_opt "record_options" as_bool 
let (get_retry : unit -> Prims.bool) =
  fun uu____3467  -> lookup_opt "retry" as_bool 
let (get_reuse_hint_for :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3478  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let (get_silent : unit -> Prims.bool) =
  fun uu____3490  -> lookup_opt "silent" as_bool 
let (get_smt : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3501  -> lookup_opt "smt" (as_option as_string) 
let (get_smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____3513  -> lookup_opt "smtencoding.elim_box" as_bool 
let (get_smtencoding_nl_arith_repr : unit -> Prims.string) =
  fun uu____3522  -> lookup_opt "smtencoding.nl_arith_repr" as_string 
let (get_smtencoding_l_arith_repr : unit -> Prims.string) =
  fun uu____3531  -> lookup_opt "smtencoding.l_arith_repr" as_string 
let (get_smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____3540  -> lookup_opt "smtencoding.valid_intro" as_bool 
let (get_smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____3549  -> lookup_opt "smtencoding.valid_elim" as_bool 
let (get_tactic_raw_binders : unit -> Prims.bool) =
  fun uu____3558  -> lookup_opt "tactic_raw_binders" as_bool 
let (get_tactics_failhard : unit -> Prims.bool) =
  fun uu____3567  -> lookup_opt "tactics_failhard" as_bool 
let (get_tactics_info : unit -> Prims.bool) =
  fun uu____3576  -> lookup_opt "tactics_info" as_bool 
let (get_tactic_trace : unit -> Prims.bool) =
  fun uu____3585  -> lookup_opt "tactic_trace" as_bool 
let (get_tactic_trace_d : unit -> Prims.int) =
  fun uu____3594  -> lookup_opt "tactic_trace_d" as_int 
let (get_tactics_nbe : unit -> Prims.bool) =
  fun uu____3603  -> lookup_opt "__tactics_nbe" as_bool 
let (get_tcnorm : unit -> Prims.bool) =
  fun uu____3612  -> lookup_opt "tcnorm" as_bool 
let (get_timing : unit -> Prims.bool) =
  fun uu____3621  -> lookup_opt "timing" as_bool 
let (get_trace_error : unit -> Prims.bool) =
  fun uu____3630  -> lookup_opt "trace_error" as_bool 
let (get_unthrottle_inductives : unit -> Prims.bool) =
  fun uu____3639  -> lookup_opt "unthrottle_inductives" as_bool 
let (get_unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____3648  -> lookup_opt "unsafe_tactic_exec" as_bool 
let (get_use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____3657  -> lookup_opt "use_eq_at_higher_order" as_bool 
let (get_use_hints : unit -> Prims.bool) =
  fun uu____3666  -> lookup_opt "use_hints" as_bool 
let (get_use_hint_hashes : unit -> Prims.bool) =
  fun uu____3675  -> lookup_opt "use_hint_hashes" as_bool 
let (get_use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3686  -> lookup_opt "use_native_tactics" (as_option as_string) 
let (get_use_tactics : unit -> Prims.bool) =
  fun uu____3698  ->
    let uu____3699 = lookup_opt "no_tactics" as_bool  in
    Prims.op_Negation uu____3699
...
let (get_verify_module : unit -> Prims.string Prims.list) =
  fun uu____3746  -> lookup_opt "verify_module" (as_list as_string) 
let (get___temp_no_proj : unit -> Prims.string Prims.list) =
  fun uu____3760  -> lookup_opt "__temp_no_proj" (as_list as_string) 
let (get_version : unit -> Prims.bool) =
  fun uu____3772  -> lookup_opt "version" as_bool 
let (get_warn_default_effects : unit -> Prims.bool) =
  fun uu____3781  -> lookup_opt "warn_default_effects" as_bool 
let (get_z3cliopt : unit -> Prims.string Prims.list) =
  fun uu____3792  -> lookup_opt "z3cliopt" (as_list as_string) 
let (get_z3refresh : unit -> Prims.bool) =
  fun uu____3804  -> lookup_opt "z3refresh" as_bool 
let (get_z3rlimit : unit -> Prims.int) =
  fun uu____3813  -> lookup_opt "z3rlimit" as_int 
let (get_z3rlimit_factor : unit -> Prims.int) =
  fun uu____3822  -> lookup_opt "z3rlimit_factor" as_int 
let (get_z3seed : unit -> Prims.int) =
  fun uu____3831  -> lookup_opt "z3seed" as_int 
let (get_use_two_phase_tc : unit -> Prims.bool) =
  fun uu____3840  -> lookup_opt "use_two_phase_tc" as_bool 
let (get_no_positivity : unit -> Prims.bool) =
  fun uu____3849  -> lookup_opt "__no_positivity" as_bool 
let (get_ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____3858  -> lookup_opt "__ml_no_eta_expand_coertions" as_bool 
let (get_warn_error : unit -> Prims.string Prims.list) =
  fun uu____3869  -> lookup_opt "warn_error" (as_list as_string) 
let (get_use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____3881  -> lookup_opt "use_extracted_interfaces" as_bool 
let (get_use_nbe : unit -> Prims.bool) =
  fun uu____3890  -> lookup_opt "use_nbe" as_bool 
let (get_use_nbe_for_extraction : unit -> Prims.bool) =
  fun uu____3899  -> lookup_opt "use_nbe_for_extraction" as_bool 
...
let (get_profile :
  unit -> Prims.string Prims.list FStar_Pervasives_Native.option) =
  fun uu____3921  -> lookup_opt "profile" (as_option (as_list as_string)) 
let (get_profile_group_by_decl : unit -> Prims.bool) =
  fun uu____3938  -> lookup_opt "profile_group_by_decl" as_bool 
...
let (debug_level_geq : debug_level_t -> Prims.bool) =
  fun l2  ->
    let uu____3998 = get_debug_level ()  in
       ...
       (fun d  ->
          let uu____4042 =
            FStar_All.pipe_right sub_dirs
              (FStar_List.map
                 (fun s  ->
                    let uu____4058 = FStar_String.op_Hat "/" s  in
                    FStar_String.op_Hat d uu____4058))
             in
          d :: uu____4042))
...
let (display_version : unit -> unit) =
  fun uu____4097  ->
    let uu____4098 =
      let uu____4100 = FStar_ST.op_Bang _version  in
      let uu____4123 = FStar_ST.op_Bang _platform  in
      let uu____4146 = FStar_ST.op_Bang _compiler  in
      let uu____4169 = FStar_ST.op_Bang _date  in
      let uu____4192 = FStar_ST.op_Bang _commit  in
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____4100
        uu____4123 uu____4146 uu____4169 uu____4192
       in
  ...
  fun specs  ->
    ...
    FStar_List.iter
      (fun uu____4279  ->
         ...
         | (uu____4292,flag,p,doc) ->
             (match p with
              | FStar_Getopt.ZeroArgs ig ->
                  if doc = ""
                  then
                    let uu____4311 =
                      let uu____4313 = FStar_Util.colorize_bold flag  in
                      FStar_Util.format1 "  --%s\n" uu____4313  in
                    FStar_Util.print_string uu____4311
                  else
                    (let uu____4318 =
                       let uu____4320 = FStar_Util.colorize_bold flag  in
                       FStar_Util.format2 "  --%s  %s\n" uu____4320 doc  in
                     FStar_Util.print_string uu____4318)
              | FStar_Getopt.OneArg (uu____4323,argname) ->
                  if doc = ""
                  then
                    let uu____4338 =
                      let uu____4340 = FStar_Util.colorize_bold flag  in
                      let uu____4342 = FStar_Util.colorize_bold argname  in
                      FStar_Util.format2 "  --%s %s\n" uu____4340 uu____4342
                       in
                    FStar_Util.print_string uu____4338
                  else
                    (let uu____4347 =
                       let uu____4349 = FStar_Util.colorize_bold flag  in
                       let uu____4351 = FStar_Util.colorize_bold argname  in
                       FStar_Util.format3 "  --%s %s  %s\n" uu____4349
                         uu____4351 doc
                        in
                     FStar_Util.print_string uu____4347))) specs
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____4428 =
                let uu____4429 = f ()  in set_option name uu____4429  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x = let uu____4450 = f x  in set_option name uu____4450
                 in
...
let (accumulated_option : Prims.string -> option_val -> option_val) =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____4477 = lookup_opt name (as_option as_list')  in
        FStar_Util.dflt [] uu____4477  in
...
let (reverse_accumulated_option : Prims.string -> option_val -> option_val) =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____4506 = lookup_opt name (as_option as_list')  in
        FStar_Util.dflt [] uu____4506  in
  ...
  fun name  ->
    fun post_processor  ->
      fun value  ->
        let uu____4553 =
          let uu____4554 =
            let uu____4555 = post_processor value  in String uu____4555  in
          accumulated_option name uu____4554  in
        set_option name uu____4553
...
let (uu___is_Const : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | Const _0 -> true | uu____4677 -> false
  
let (__proj__Const__item___0 : opt_type -> option_val) =
  fun projectee  -> match projectee with | Const _0 -> _0 
let (uu___is_IntStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | IntStr _0 -> true | uu____4697 -> false
  
let (__proj__IntStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | IntStr _0 -> _0 
let (uu___is_BoolStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | BoolStr  -> true | uu____4718 -> false
  
let (uu___is_PathStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | PathStr _0 -> true | uu____4731 -> false
  
let (__proj__PathStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | PathStr _0 -> _0 
let (uu___is_SimpleStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | SimpleStr _0 -> true | uu____4754 -> false
  
let (__proj__SimpleStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | SimpleStr _0 -> _0 
let (uu___is_EnumStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | EnumStr _0 -> true | uu____4779 -> false
  
let (__proj__EnumStr__item___0 : opt_type -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | EnumStr _0 -> _0 
let (uu___is_OpenEnumStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | OpenEnumStr _0 -> true | uu____4815 -> false
...
let (uu___is_PostProcessed : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | PostProcessed _0 -> true | uu____4865 -> false
...
let (uu___is_Accumulated : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | Accumulated _0 -> true | uu____4905 -> false
...
let (uu___is_WithSideEffect : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | WithSideEffect _0 -> true | uu____4950 -> false
...
let (uu___is_InvalidArgument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | InvalidArgument uu____4993 -> true
    | uu____4996 -> false
  
let (__proj__InvalidArgument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | InvalidArgument uu____5006 -> uu____5006
                  ...
                  | BoolStr  ->
                      let uu____5042 =
                        ...
                        then true
                         ...
                         in
                      Bool uu____5042
                  | PathStr uu____5059 -> Path str_val
                  | SimpleStr uu____5061 -> String str_val
                  | EnumStr strs ->
                      if FStar_List.mem str_val strs
                      then String str_val
                      else FStar_Exn.raise (InvalidArgument opt_name)
                  | OpenEnumStr uu____5071 -> String str_val
  ...
  fun typ  ->
    let desc_of_enum cases =
      let uu____5138 =
        ...
        FStar_String.op_Hat "[" uu____5140  in
      FStar_Pervasives_Native.Some uu____5138  in
    match typ with
    ...
    | PostProcessed (uu____5182,elem_spec) -> desc_of_opt_type elem_spec
    | Accumulated elem_spec -> desc_of_opt_type elem_spec
    | ReverseAccumulated elem_spec -> desc_of_opt_type elem_spec
    | WithSideEffect (uu____5192,elem_spec) -> desc_of_opt_type elem_spec
...
let (arg_spec_of_opt_type :
  ...
  fun opt_name  ->
    fun typ  ->
      ...
      let uu____5223 = desc_of_opt_type typ  in
      match uu____5223 with
      | FStar_Pervasives_Native.None  ->
          FStar_Getopt.ZeroArgs ((fun uu____5231  -> parser ""))
...
let (pp_lowercase : option_val -> option_val) =
  fun s  ->
    let uu____5257 =
      let uu____5259 = as_string s  in FStar_String.lowercase uu____5259  in
    String uu____5257
...
let (interp_quake_arg : Prims.string -> (Prims.int * Prims.int * Prims.bool))
  ...
  fun s  ->
    ...
    | f::[] ->
        let uu____5317 = ios f  in
        let uu____5319 = ios f  in (uu____5317, uu____5319, false)
    | f1::f2::[] ->
        if f2 = "k"
        then
          let uu____5344 = ios f1  in
          let uu____5346 = ios f1  in (uu____5344, uu____5346, true)
        else
          (let uu____5354 = ios f1  in
           let uu____5356 = ios f2  in (uu____5354, uu____5356, false))
    | f1::f2::k::[] ->
        if k = "k"
        then
          let uu____5384 = ios f1  in
          let uu____5386 = ios f2  in (uu____5384, uu____5386, true)
        else failwith "unexpected value for --quake"
    | uu____5404 -> failwith "unexpected value for --quake"
...
let rec (specs_with_types :
  ...
  fun uu____5442  ->
    ...
    (FStar_Getopt.noshort, "fuel",
      (PostProcessed
         (((fun uu___8_6119  ->
              match uu___8_6119 with
              | String s ->
                  let p f =
                    let uu____6130 = FStar_Util.int_of_string f  in
                    Int uu____6130  in
                  let uu____6132 =
                    match FStar_Util.split s "," with
                    | f::[] -> (f, f)
    ...
    (FStar_Getopt.noshort, "ifuel",
      (PostProcessed
         (((fun uu___9_6214  ->
              match uu___9_6214 with
              | String s ->
                  let p f =
                    let uu____6225 = FStar_Util.int_of_string f  in
                    Int uu____6225  in
                  let uu____6227 =
                    match FStar_Util.split s "," with
                    | f::[] -> (f, f)
    ...
    (FStar_Getopt.noshort, "__debug_embedding",
      (WithSideEffect
         (((fun uu____7684  -> FStar_ST.op_Colon_Equals debug_embedding true)),
           (Const (Bool true)))),
      "Debug messages for embeddings/unembeddings of natively compiled terms");
    (FStar_Getopt.noshort, "eager_embedding",
      (WithSideEffect
         (((fun uu____7728  -> FStar_ST.op_Colon_Equals eager_embedding true)),
           (Const (Bool true)))),
    ...
    (104, "help",
      (WithSideEffect
         (((fun uu____7825  ->
              (let uu____7827 = specs ()  in display_usage_aux uu____7827);
              FStar_All.exit Prims.int_zero)), (Const (Bool true)))),
      "Display this information")]

and (specs : unit -> FStar_Getopt.opt Prims.list) =
  fun uu____7858  ->
    let uu____7861 = specs_with_types ()  in
    FStar_List.map
      (fun uu____7892  ->
         match uu____7892 with
         | (short,long,typ,doc) ->
             let uu____7914 =
               let uu____7928 = arg_spec_of_opt_type long typ  in
               (short, long, uu____7928, doc)  in
             mk_spec uu____7914) uu____7861

let (settable : Prims.string -> Prims.bool) =
  fun uu___12_7943  ->
    match uu___12_7943 with
    | "abort_on" -> true
    | "admit_except" -> true
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____8184  ->
          ...
          | (uu____8199,x,uu____8201,uu____8202) -> settable x))
  
let (display_usage : unit -> unit) =
  fun uu____8218  ->
    let uu____8219 = specs ()  in display_usage_aux uu____8219
...
let (uu___is_File_argument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | File_argument uu____8251 -> true
    | uu____8254 -> false
  
let (__proj__File_argument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | File_argument uu____8264 -> uu____8264
  ...
  fun uu____8317  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____8323 =
             let uu____8327 = FStar_ST.op_Bang file_list_  in
             FStar_List.append uu____8327 [i]  in
           FStar_ST.op_Colon_Equals file_list_ uu____8323)
       in
    let uu____8384 =
      let uu____8388 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____8388
       in
    (res, uu____8384)
  
let (file_list : unit -> Prims.string Prims.list) =
  fun uu____8430  -> FStar_ST.op_Bang file_list_ 
let (restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res)
  ...
  fun should_clear  ->
    ...
    (let r =
       let uu____8473 = specs ()  in
       FStar_Getopt.parse_cmdline uu____8473 (fun x  -> ())  in
     (let uu____8480 =
        let uu____8486 =
          let uu____8487 =
  ...
  fun f  ->
    ...
    let f2 =
      let uu____8507 =
        let uu____8509 =
          let uu____8511 =
            let uu____8513 = FStar_Util.get_file_extension f1  in
            FStar_String.length uu____8513  in
          (FStar_String.length f1) - uu____8511  in
        uu____8509 - Prims.int_one  in
