...
let (get_option : Prims.string -> option_val) =
  fun s  ->
    let uu____2662 =
      let uu____2665 = internal_peek ()  in
      FStar_Util.smap_try_find uu____2665 s  in
...
let (get_force : unit -> Prims.bool) =
  fun uu____2987  -> lookup_opt "force" as_bool 
let (get_fs_typ_app : unit -> Prims.bool) =
  fun uu____2996  -> lookup_opt "fs_typ_app" as_bool 
let (get_hide_uvar_nums : unit -> Prims.bool) =
  fun uu____3005  -> lookup_opt "hide_uvar_nums" as_bool 
let (get_hint_info : unit -> Prims.bool) =
  fun uu____3014  -> lookup_opt "hint_info" as_bool 
let (get_hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3025  -> lookup_opt "hint_dir" (as_option as_string) 
let (get_hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3039  -> lookup_opt "hint_file" (as_option as_string) 
let (get_in : unit -> Prims.bool) =
  fun uu____3051  -> lookup_opt "in" as_bool 
let (get_ide : unit -> Prims.bool) =
  fun uu____3060  -> lookup_opt "ide" as_bool 
let (get_lsp : unit -> Prims.bool) =
  fun uu____3069  -> lookup_opt "lsp" as_bool 
let (get_include : unit -> Prims.string Prims.list) =
  fun uu____3080  -> lookup_opt "include" (as_list as_string) 
let (get_print : unit -> Prims.bool) =
  fun uu____3092  -> lookup_opt "print" as_bool 
let (get_print_in_place : unit -> Prims.bool) =
  fun uu____3101  -> lookup_opt "print_in_place" as_bool 
let (get_initial_fuel : unit -> Prims.int) =
  fun uu____3110  -> lookup_opt "initial_fuel" as_int 
let (get_initial_ifuel : unit -> Prims.int) =
  fun uu____3119  -> lookup_opt "initial_ifuel" as_int 
let (get_keep_query_captions : unit -> Prims.bool) =
  fun uu____3128  -> lookup_opt "keep_query_captions" as_bool 
let (get_lax : unit -> Prims.bool) =
  fun uu____3137  -> lookup_opt "lax" as_bool 
let (get_load : unit -> Prims.string Prims.list) =
  fun uu____3148  -> lookup_opt "load" (as_list as_string) 
let (get_log_queries : unit -> Prims.bool) =
  fun uu____3160  -> lookup_opt "log_queries" as_bool 
let (get_log_types : unit -> Prims.bool) =
  fun uu____3169  -> lookup_opt "log_types" as_bool 
let (get_max_fuel : unit -> Prims.int) =
  fun uu____3178  -> lookup_opt "max_fuel" as_int 
let (get_max_ifuel : unit -> Prims.int) =
  fun uu____3187  -> lookup_opt "max_ifuel" as_int 
let (get_min_fuel : unit -> Prims.int) =
  fun uu____3196  -> lookup_opt "min_fuel" as_int 
let (get_MLish : unit -> Prims.bool) =
  fun uu____3205  -> lookup_opt "MLish" as_bool 
let (get_no_default_includes : unit -> Prims.bool) =
  fun uu____3214  -> lookup_opt "no_default_includes" as_bool 
let (get_no_extract : unit -> Prims.string Prims.list) =
  fun uu____3225  -> lookup_opt "no_extract" (as_list as_string) 
let (get_no_location_info : unit -> Prims.bool) =
  fun uu____3237  -> lookup_opt "no_location_info" as_bool 
let (get_no_plugins : unit -> Prims.bool) =
  fun uu____3246  -> lookup_opt "no_plugins" as_bool 
let (get_no_smt : unit -> Prims.bool) =
  fun uu____3255  -> lookup_opt "no_smt" as_bool 
let (get_normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____3264  -> lookup_opt "normalize_pure_terms_for_extraction" as_bool 
let (get_odir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3275  -> lookup_opt "odir" (as_option as_string) 
let (get_ugly : unit -> Prims.bool) =
  fun uu____3287  -> lookup_opt "ugly" as_bool 
let (get_prims : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3298  -> lookup_opt "prims" (as_option as_string) 
let (get_print_bound_var_types : unit -> Prims.bool) =
  fun uu____3310  -> lookup_opt "print_bound_var_types" as_bool 
let (get_print_effect_args : unit -> Prims.bool) =
  fun uu____3319  -> lookup_opt "print_effect_args" as_bool 
let (get_print_full_names : unit -> Prims.bool) =
  fun uu____3328  -> lookup_opt "print_full_names" as_bool 
let (get_print_implicits : unit -> Prims.bool) =
  fun uu____3337  -> lookup_opt "print_implicits" as_bool 
let (get_print_universes : unit -> Prims.bool) =
  fun uu____3346  -> lookup_opt "print_universes" as_bool 
let (get_print_z3_statistics : unit -> Prims.bool) =
  fun uu____3355  -> lookup_opt "print_z3_statistics" as_bool 
let (get_prn : unit -> Prims.bool) =
  fun uu____3364  -> lookup_opt "prn" as_bool 
let (get_query_stats : unit -> Prims.bool) =
  fun uu____3373  -> lookup_opt "query_stats" as_bool 
let (get_record_hints : unit -> Prims.bool) =
  fun uu____3382  -> lookup_opt "record_hints" as_bool 
let (get_record_options : unit -> Prims.bool) =
  fun uu____3391  -> lookup_opt "record_options" as_bool 
let (get_reuse_hint_for :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3402  -> lookup_opt "reuse_hint_for" (as_option as_string) 
let (get_silent : unit -> Prims.bool) =
  fun uu____3414  -> lookup_opt "silent" as_bool 
let (get_smt : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3425  -> lookup_opt "smt" (as_option as_string) 
let (get_smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____3437  -> lookup_opt "smtencoding.elim_box" as_bool 
let (get_smtencoding_nl_arith_repr : unit -> Prims.string) =
  fun uu____3446  -> lookup_opt "smtencoding.nl_arith_repr" as_string 
let (get_smtencoding_l_arith_repr : unit -> Prims.string) =
  fun uu____3455  -> lookup_opt "smtencoding.l_arith_repr" as_string 
let (get_smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____3464  -> lookup_opt "smtencoding.valid_intro" as_bool 
let (get_smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____3473  -> lookup_opt "smtencoding.valid_elim" as_bool 
let (get_tactic_raw_binders : unit -> Prims.bool) =
  fun uu____3482  -> lookup_opt "tactic_raw_binders" as_bool 
let (get_tactics_failhard : unit -> Prims.bool) =
  fun uu____3491  -> lookup_opt "tactics_failhard" as_bool 
let (get_tactics_info : unit -> Prims.bool) =
  fun uu____3500  -> lookup_opt "tactics_info" as_bool 
let (get_tactic_trace : unit -> Prims.bool) =
  fun uu____3509  -> lookup_opt "tactic_trace" as_bool 
let (get_tactic_trace_d : unit -> Prims.int) =
  fun uu____3518  -> lookup_opt "tactic_trace_d" as_int 
let (get_tactics_nbe : unit -> Prims.bool) =
  fun uu____3527  -> lookup_opt "__tactics_nbe" as_bool 
let (get_tcnorm : unit -> Prims.bool) =
  fun uu____3536  -> lookup_opt "tcnorm" as_bool 
let (get_timing : unit -> Prims.bool) =
  fun uu____3545  -> lookup_opt "timing" as_bool 
let (get_trace_error : unit -> Prims.bool) =
  fun uu____3554  -> lookup_opt "trace_error" as_bool 
let (get_unthrottle_inductives : unit -> Prims.bool) =
  fun uu____3563  -> lookup_opt "unthrottle_inductives" as_bool 
let (get_unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____3572  -> lookup_opt "unsafe_tactic_exec" as_bool 
let (get_use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____3581  -> lookup_opt "use_eq_at_higher_order" as_bool 
let (get_use_hints : unit -> Prims.bool) =
  fun uu____3590  -> lookup_opt "use_hints" as_bool 
let (get_use_hint_hashes : unit -> Prims.bool) =
  fun uu____3599  -> lookup_opt "use_hint_hashes" as_bool 
let (get_use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____3610  -> lookup_opt "use_native_tactics" (as_option as_string) 
let (get_use_tactics : unit -> Prims.bool) =
  fun uu____3622  ->
    let uu____3623 = lookup_opt "no_tactics" as_bool  in
    Prims.op_Negation uu____3623
...
let (get_verify_module : unit -> Prims.string Prims.list) =
  fun uu____3670  -> lookup_opt "verify_module" (as_list as_string) 
let (get___temp_no_proj : unit -> Prims.string Prims.list) =
  fun uu____3684  -> lookup_opt "__temp_no_proj" (as_list as_string) 
let (get_version : unit -> Prims.bool) =
  fun uu____3696  -> lookup_opt "version" as_bool 
let (get_warn_default_effects : unit -> Prims.bool) =
  fun uu____3705  -> lookup_opt "warn_default_effects" as_bool 
let (get_z3cliopt : unit -> Prims.string Prims.list) =
  fun uu____3716  -> lookup_opt "z3cliopt" (as_list as_string) 
let (get_z3refresh : unit -> Prims.bool) =
  fun uu____3728  -> lookup_opt "z3refresh" as_bool 
let (get_z3rlimit : unit -> Prims.int) =
  fun uu____3737  -> lookup_opt "z3rlimit" as_int 
let (get_z3rlimit_factor : unit -> Prims.int) =
  fun uu____3746  -> lookup_opt "z3rlimit_factor" as_int 
let (get_z3seed : unit -> Prims.int) =
  fun uu____3755  -> lookup_opt "z3seed" as_int 
let (get_use_two_phase_tc : unit -> Prims.bool) =
  fun uu____3764  -> lookup_opt "use_two_phase_tc" as_bool 
let (get_no_positivity : unit -> Prims.bool) =
  fun uu____3773  -> lookup_opt "__no_positivity" as_bool 
let (get_ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____3782  -> lookup_opt "__ml_no_eta_expand_coertions" as_bool 
let (get_warn_error : unit -> Prims.string Prims.list) =
  fun uu____3793  -> lookup_opt "warn_error" (as_list as_string) 
let (get_use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____3805  -> lookup_opt "use_extracted_interfaces" as_bool 
let (get_use_nbe : unit -> Prims.bool) =
  fun uu____3814  -> lookup_opt "use_nbe" as_bool 
...
let (get_profile :
  unit -> Prims.string Prims.list FStar_Pervasives_Native.option) =
  fun uu____3836  -> lookup_opt "profile" (as_option (as_list as_string)) 
let (get_profile_group_by_decl : unit -> Prims.bool) =
  fun uu____3853  -> lookup_opt "profile_group_by_decl" as_bool 
...
let (debug_level_geq : debug_level_t -> Prims.bool) =
  fun l2  ->
    let uu____3913 = get_debug_level ()  in
       ...
       (fun d  ->
          let uu____3957 =
            FStar_All.pipe_right sub_dirs
              (FStar_List.map
                 (fun s  ->
                    let uu____3973 = FStar_String.op_Hat "/" s  in
                    FStar_String.op_Hat d uu____3973))
             in
          d :: uu____3957))
...
let (display_version : unit -> unit) =
  fun uu____4012  ->
    let uu____4013 =
      let uu____4015 = FStar_ST.op_Bang _version  in
      let uu____4038 = FStar_ST.op_Bang _platform  in
      let uu____4061 = FStar_ST.op_Bang _compiler  in
      let uu____4084 = FStar_ST.op_Bang _date  in
      let uu____4107 = FStar_ST.op_Bang _commit  in
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____4015
        uu____4038 uu____4061 uu____4084 uu____4107
       in
    FStar_Util.print_string uu____4013
  
let display_usage_aux :
  'Auu____4138 'Auu____4139 .
    ('Auu____4138 * Prims.string * 'Auu____4139 FStar_Getopt.opt_variant *
  ...
  fun specs  ->
    ...
    FStar_List.iter
      (fun uu____4194  ->
         ...
         | (uu____4207,flag,p,doc) ->
             (match p with
              | FStar_Getopt.ZeroArgs ig ->
                  if doc = ""
                  then
                    let uu____4226 =
                      let uu____4228 = FStar_Util.colorize_bold flag  in
                      FStar_Util.format1 "  --%s\n" uu____4228  in
                    FStar_Util.print_string uu____4226
                  else
                    (let uu____4233 =
                       let uu____4235 = FStar_Util.colorize_bold flag  in
                       FStar_Util.format2 "  --%s  %s\n" uu____4235 doc  in
                     FStar_Util.print_string uu____4233)
              | FStar_Getopt.OneArg (uu____4238,argname) ->
                  if doc = ""
                  then
                    let uu____4253 =
                      let uu____4255 = FStar_Util.colorize_bold flag  in
                      let uu____4257 = FStar_Util.colorize_bold argname  in
                      FStar_Util.format2 "  --%s %s\n" uu____4255 uu____4257
                       in
                    FStar_Util.print_string uu____4253
                  else
                    (let uu____4262 =
                       let uu____4264 = FStar_Util.colorize_bold flag  in
                       let uu____4266 = FStar_Util.colorize_bold argname  in
                       FStar_Util.format3 "  --%s %s  %s\n" uu____4264
                         uu____4266 doc
                        in
                     FStar_Util.print_string uu____4262))) specs
    ...
    | (ns,name,arg,desc) ->
        let arg1 =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____4343 =
                let uu____4344 = f ()  in set_option name uu____4344  in
              FStar_Getopt.ZeroArgs g
          | FStar_Getopt.OneArg (f,d) ->
              let g x = let uu____4365 = f x  in set_option name uu____4365
                 in
...
let (accumulated_option : Prims.string -> option_val -> option_val) =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____4392 = lookup_opt name (as_option as_list')  in
        FStar_Util.dflt [] uu____4392  in
...
let (reverse_accumulated_option : Prims.string -> option_val -> option_val) =
  fun name  ->
    fun value  ->
      let prev_values =
        let uu____4421 = lookup_opt name (as_option as_list')  in
        FStar_Util.dflt [] uu____4421  in
      List (FStar_List.append prev_values [value])
  
let accumulate_string :
  'Auu____4443 .
    Prims.string -> ('Auu____4443 -> Prims.string) -> 'Auu____4443 -> unit
  =
  fun name  ->
    fun post_processor  ->
      fun value  ->
        let uu____4468 =
          let uu____4469 =
            let uu____4470 = post_processor value  in String uu____4470  in
          accumulated_option name uu____4469  in
        set_option name uu____4468
...
let (uu___is_Const : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | Const _0 -> true | uu____4592 -> false
  
let (__proj__Const__item___0 : opt_type -> option_val) =
  fun projectee  -> match projectee with | Const _0 -> _0 
let (uu___is_IntStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | IntStr _0 -> true | uu____4612 -> false
  
let (__proj__IntStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | IntStr _0 -> _0 
let (uu___is_BoolStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | BoolStr  -> true | uu____4633 -> false
  
let (uu___is_PathStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | PathStr _0 -> true | uu____4646 -> false
  
let (__proj__PathStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | PathStr _0 -> _0 
let (uu___is_SimpleStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | SimpleStr _0 -> true | uu____4669 -> false
  
let (__proj__SimpleStr__item___0 : opt_type -> Prims.string) =
  fun projectee  -> match projectee with | SimpleStr _0 -> _0 
let (uu___is_EnumStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | EnumStr _0 -> true | uu____4694 -> false
  
let (__proj__EnumStr__item___0 : opt_type -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | EnumStr _0 -> _0 
let (uu___is_OpenEnumStr : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | OpenEnumStr _0 -> true | uu____4730 -> false
...
let (uu___is_PostProcessed : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | PostProcessed _0 -> true | uu____4780 -> false
...
let (uu___is_Accumulated : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | Accumulated _0 -> true | uu____4820 -> false
...
let (uu___is_WithSideEffect : opt_type -> Prims.bool) =
  fun projectee  ->
    match projectee with | WithSideEffect _0 -> true | uu____4865 -> false
...
let (uu___is_InvalidArgument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | InvalidArgument uu____4908 -> true
    | uu____4911 -> false
  
let (__proj__InvalidArgument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | InvalidArgument uu____4921 -> uu____4921
          ...
          (fun uu___306_4945  ->
             ...
             | () ->
                 (match typ with
                  | Const c -> c
                  | IntStr uu____4947 ->
                      let uu____4949 = FStar_Util.safe_int_of_string str_val
                         in
                  ...
                  | BoolStr  ->
                      let uu____4957 =
                        ...
                        then true
                         ...
                         in
                      Bool uu____4957
                  | PathStr uu____4974 -> Path str_val
                  | SimpleStr uu____4976 -> String str_val
                  | EnumStr strs ->
                      if FStar_List.mem str_val strs
                      then String str_val
                      else FStar_Exn.raise (InvalidArgument opt_name)
                  | OpenEnumStr uu____4986 -> String str_val
  ...
  fun typ  ->
    let desc_of_enum cases =
      let uu____5053 =
        ...
        FStar_String.op_Hat "[" uu____5055  in
    ...
    | PostProcessed (uu____5097,elem_spec) -> desc_of_opt_type elem_spec
    | Accumulated elem_spec -> desc_of_opt_type elem_spec
    | ReverseAccumulated elem_spec -> desc_of_opt_type elem_spec
    | WithSideEffect (uu____5107,elem_spec) -> desc_of_opt_type elem_spec
...
let rec (arg_spec_of_opt_type :
  ...
  fun opt_name  ->
    fun typ  ->
      ...
      let uu____5138 = desc_of_opt_type typ  in
      match uu____5138 with
      | FStar_Pervasives_Native.None  ->
          FStar_Getopt.ZeroArgs ((fun uu____5146  -> parser ""))
...
let (pp_lowercase : option_val -> option_val) =
  fun s  ->
    let uu____5172 =
      let uu____5174 = as_string s  in FStar_String.lowercase uu____5174  in
    String uu____5172
...
let rec (specs_with_types :
  ...
  fun uu____5209  ->
    ...
    (FStar_Getopt.noshort, "fuel",
      (PostProcessed
         (((fun uu___8_5904  ->
              match uu___8_5904 with
              | String s ->
                  let p f =
                    let uu____5915 = FStar_Util.int_of_string f  in
                    Int uu____5915  in
                  let uu____5917 =
                    match FStar_Util.split s "," with
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____5946 -> failwith "unexpected value for --fuel"
                     in
                  (match uu____5917 with
                   | (min1,max1) ->
                       ((let uu____5964 = p min1  in
                         set_option "initial_fuel" uu____5964);
                        (let uu____5967 = p max1  in
                         set_option "max_fuel" uu____5967);
                        String s))
    ...
    (FStar_Getopt.noshort, "ifuel",
      (PostProcessed
         (((fun uu___9_5999  ->
              match uu___9_5999 with
              | String s ->
                  let p f =
                    let uu____6010 = FStar_Util.int_of_string f  in
                    Int uu____6010  in
                  let uu____6012 =
                    match FStar_Util.split s "," with
                    | f::[] -> (f, f)
                    | f1::f2::[] -> (f1, f2)
                    | uu____6041 -> failwith "unexpected value for --ifuel"
                     in
                  (match uu____6012 with
                   | (min1,max1) ->
                       ((let uu____6059 = p min1  in
                         set_option "initial_ifuel" uu____6059);
                        (let uu____6062 = p max1  in
                         set_option "max_ifuel" uu____6062);
                        String s))
              | uu____6064 -> failwith "impos")),
           (SimpleStr "non-negative integer or pair of non-negative integers"))),
    ...
    (FStar_Getopt.noshort, "__debug_embedding",
      (WithSideEffect
         (((fun uu____7330  -> FStar_ST.op_Colon_Equals debug_embedding true)),
           (Const (Bool true)))),
      "Debug messages for embeddings/unembeddings of natively compiled terms");
    (FStar_Getopt.noshort, "eager_embedding",
      (WithSideEffect
         (((fun uu____7374  -> FStar_ST.op_Colon_Equals eager_embedding true)),
           (Const (Bool true)))),
    ...
    (104, "help",
      (WithSideEffect
         (((fun uu____7471  ->
              (let uu____7473 = specs ()  in display_usage_aux uu____7473);
              FStar_All.exit Prims.int_zero)), (Const (Bool true)))),
      "Display this information")]

and (specs : unit -> FStar_Getopt.opt Prims.list) =
  fun uu____7504  ->
    let uu____7507 = specs_with_types ()  in
    FStar_List.map
      (fun uu____7538  ->
         match uu____7538 with
         | (short,long,typ,doc) ->
             let uu____7560 =
               let uu____7574 = arg_spec_of_opt_type long typ  in
               (short, long, uu____7574, doc)  in
             mk_spec uu____7560) uu____7507

let (settable : Prims.string -> Prims.bool) =
  fun uu___10_7589  ->
    match uu___10_7589 with
    | "abort_on" -> true
    | "admit_except" -> true
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____7820  ->
          ...
          | (uu____7835,x,uu____7837,uu____7838) -> settable x))
  
let (display_usage : unit -> unit) =
  fun uu____7854  ->
    let uu____7855 = specs ()  in display_usage_aux uu____7855
...
let (uu___is_File_argument : Prims.exn -> Prims.bool) =
  fun projectee  ->
    match projectee with
    | File_argument uu____7887 -> true
    | uu____7890 -> false
  
let (__proj__File_argument__item__uu___ : Prims.exn -> Prims.string) =
  fun projectee  ->
    match projectee with | File_argument uu____7900 -> uu____7900
  ...
  fun uu____7953  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____7959 =
             let uu____7963 = FStar_ST.op_Bang file_list_  in
             FStar_List.append uu____7963 [i]  in
           FStar_ST.op_Colon_Equals file_list_ uu____7959)
       in
    let uu____8020 =
      let uu____8024 = FStar_ST.op_Bang file_list_  in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____8024
       in
    (res, uu____8020)
  
let (file_list : unit -> Prims.string Prims.list) =
  fun uu____8066  -> FStar_ST.op_Bang file_list_ 
let (restore_cmd_line_options : Prims.bool -> FStar_Getopt.parse_cmdline_res)
  ...
  fun should_clear  ->
    ...
    (let r =
       let uu____8109 = specs ()  in
       FStar_Getopt.parse_cmdline uu____8109 (fun x  -> ())  in
     (let uu____8116 =
        let uu____8122 =
          let uu____8123 =
            FStar_List.map (fun _8127  -> String _8127) old_verify_module  in
          List uu____8123  in
        ("verify_module", uu____8122)  in
      set_option' uu____8116);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____8143 =
        let uu____8145 =
          let uu____8147 =
            let uu____8149 = FStar_Util.get_file_extension f1  in
            FStar_String.length uu____8149  in
          (FStar_String.length f1) - uu____8147  in
        uu____8145 - Prims.int_one  in
      FStar_String.substring f1 Prims.int_zero uu____8143  in
    FStar_String.lowercase f2
  
let (should_verify : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8162 = get_lax ()  in
    if uu____8162
    then false
    else
...
let (should_verify_file : Prims.string -> Prims.bool) =
  fun fn  ->
    let uu____8183 = module_name_of_file_name fn  in should_verify uu____8183
...
let (dont_gen_projectors : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8211 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____8211 (FStar_List.existsb (module_name_eq m))
  
let (should_print_message : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____8229 = should_verify m  in
    if uu____8229 then m <> "Prims" else false
  
let (include_path : unit -> Prims.string Prims.list) =
  fun uu____8246  ->
    let cache_dir =
      let uu____8251 = get_cache_dir ()  in
      match uu____8251 with
      | FStar_Pervasives_Native.None  -> []
      | FStar_Pervasives_Native.Some c -> [c]  in
    let uu____8265 = get_no_default_includes ()  in
    if uu____8265
    then
      let uu____8271 = get_include ()  in
      FStar_List.append cache_dir uu____8271
    else
      (let lib_paths =
         let uu____8282 = FStar_Util.expand_environment_variable "FSTAR_LIB"
            in
       ...
       let uu____8325 =
         let uu____8329 =
           let uu____8333 = get_include ()  in
           FStar_List.append uu____8333 ["."]  in
         FStar_List.append lib_paths uu____8329  in
       FStar_List.append cache_dir uu____8325)
  
let (find_file : Prims.string -> Prims.string FStar_Pervasives_Native.option)
  =
  let file_map = FStar_Util.smap_create (Prims.of_int (100))  in
  fun filename  ->
    let uu____8364 = FStar_Util.smap_try_find file_map filename  in
        ...
        let result =
          try
            (fun uu___570_8395  ->
               match () with
               | () ->
                   let uu____8399 = FStar_Util.is_path_absolute filename  in
                   if uu____8399
                   then
                     ...
                     (let uu____8415 =
                        let uu____8419 = include_path ()  in
                        FStar_List.rev uu____8419  in
                      FStar_Util.find_map uu____8415
                        (fun p  ->
                           let path =
                             if p = "."
                             then filename
          ...
          with | uu___569_8447 -> FStar_Pervasives_Native.None  in
...
let (prims_basename : unit -> Prims.string) =
  fun uu____8498  ->
    let uu____8499 = prims ()  in FStar_Util.basename uu____8499
  
let (pervasives : unit -> Prims.string) =
  fun uu____8507  ->
    let filename = "FStar.Pervasives.fst"  in
    let uu____8511 = find_file filename  in
...
let (pervasives_basename : unit -> Prims.string) =
  fun uu____8530  ->
    let uu____8531 = pervasives ()  in FStar_Util.basename uu____8531
  
let (pervasives_native_basename : unit -> Prims.string) =
  fun uu____8539  ->
    let filename = "FStar.Pervasives.Native.fst"  in
    let uu____8543 = find_file filename  in
...
let (prepend_cache_dir : Prims.string -> Prims.string) =
  fun fpath  ->
    let uu____8583 = get_cache_dir ()  in
    match uu____8583 with
    | FStar_Pervasives_Native.None  -> fpath
    | FStar_Pervasives_Native.Some x ->
        let uu____8592 = FStar_Util.basename fpath  in
        FStar_Util.join_paths x uu____8592
...
let (parse_settings :
  ...
  fun ns  ->
    ...
    let with_cache f s =
      let uu____8714 = FStar_Util.smap_try_find cache s  in
    ...
    let parse_one_setting s =
      ...
      then ([], true)
        ...
        then ([], false)
          ...
          then
            (let path =
               let uu____8868 = FStar_Util.substring_from s Prims.int_one  in
               path_of_text uu____8868  in
             (path, false))
          else
            (let s1 =
               if FStar_Util.starts_with s "+"
    ...
    let uu____8891 =
      FStar_All.pipe_right ns
       ...
       in
    FStar_All.pipe_right uu____8891 FStar_List.rev
  
let (__temp_no_proj : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9056 = get___temp_no_proj ()  in
    FStar_All.pipe_right uu____9056 (FStar_List.contains s)
  
let (__temp_fast_implicits : unit -> Prims.bool) =
  fun uu____9071  -> lookup_opt "__temp_fast_implicits" as_bool 
let (admit_smt_queries : unit -> Prims.bool) =
  fun uu____9080  -> get_admit_smt_queries () 
let (admit_except : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9089  -> get_admit_except () 
let (cache_checked_modules : unit -> Prims.bool) =
  fun uu____9096  -> get_cache_checked_modules () 
let (cache_off : unit -> Prims.bool) = fun uu____9103  -> get_cache_off () 
let (cmi : unit -> Prims.bool) = fun uu____9110  -> get_cmi () 
type codegen_t =
  | OCaml 
  | FSharp 
  | Kremlin 
...
let (uu___is_OCaml : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | OCaml  -> true | uu____9120 -> false
  
let (uu___is_FSharp : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | FSharp  -> true | uu____9131 -> false
  
let (uu___is_Kremlin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Kremlin  -> true | uu____9142 -> false
  
let (uu___is_Plugin : codegen_t -> Prims.bool) =
  fun projectee  ->
    match projectee with | Plugin  -> true | uu____9153 -> false
  
let (codegen : unit -> codegen_t FStar_Pervasives_Native.option) =
  fun uu____9162  ->
    let uu____9163 = get_codegen ()  in
    FStar_Util.map_opt uu____9163
      (fun uu___11_9169  ->
         match uu___11_9169 with
         | "OCaml" -> OCaml
         | "FSharp" -> FSharp
         | "Kremlin" -> Kremlin
         | "Plugin" -> Plugin
         | uu____9175 -> failwith "Impossible")
  
let (codegen_libs : unit -> Prims.string Prims.list Prims.list) =
  fun uu____9188  ->
    let uu____9189 = get_codegen_lib ()  in
    FStar_All.pipe_right uu____9189
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
  
let (debug_any : unit -> Prims.bool) =
  fun uu____9215  -> let uu____9216 = get_debug ()  in uu____9216 <> [] 
let (debug_module : Prims.string -> Prims.bool) =
  fun modul  ->
    let uu____9233 = get_debug ()  in
...
let (debug_at_level : Prims.string -> debug_level_t -> Prims.bool) =
  fun modul  ->
    fun level  ->
      (let uu____9258 = get_debug ()  in
       FStar_All.pipe_right uu____9258
         (FStar_List.existsb (module_name_eq modul)))
        && (debug_level_geq level)
  
let (profile_group_by_decls : unit -> Prims.bool) =
  fun uu____9273  -> get_profile_group_by_decl () 
let (defensive : unit -> Prims.bool) =
  fun uu____9280  -> let uu____9281 = get_defensive ()  in uu____9281 <> "no" 
let (defensive_fail : unit -> Prims.bool) =
  fun uu____9291  ->
    let uu____9292 = get_defensive ()  in uu____9292 = "fail"
  
let (dep : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9304  -> get_dep () 
let (detail_errors : unit -> Prims.bool) =
  fun uu____9311  -> get_detail_errors () 
let (detail_hint_replay : unit -> Prims.bool) =
  fun uu____9318  -> get_detail_hint_replay () 
let (doc : unit -> Prims.bool) = fun uu____9325  -> get_doc () 
let (dump_module : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9335 = get_dump_module ()  in
    FStar_All.pipe_right uu____9335 (FStar_List.existsb (module_name_eq s))
  
let (eager_subtyping : unit -> Prims.bool) =
  fun uu____9350  -> get_eager_subtyping () 
let (expose_interfaces : unit -> Prims.bool) =
  fun uu____9357  -> get_expose_interfaces () 
let (force : unit -> Prims.bool) = fun uu____9364  -> get_force () 
let (fs_typ_app : Prims.string -> Prims.bool) =
  fun filename  ->
    let uu____9374 = FStar_ST.op_Bang light_off_files  in
    FStar_List.contains filename uu____9374
  
let (full_context_dependency : unit -> Prims.bool) = fun uu____9410  -> true 
let (hide_uvar_nums : unit -> Prims.bool) =
  fun uu____9418  -> get_hide_uvar_nums () 
let (hint_info : unit -> Prims.bool) =
  fun uu____9425  -> (get_hint_info ()) || (get_query_stats ()) 
let (hint_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9434  -> get_hint_dir () 
let (hint_file : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9443  -> get_hint_file () 
let (hint_file_for_src : Prims.string -> Prims.string) =
  fun src_filename  ->
    let uu____9453 = hint_file ()  in
    match uu____9453 with
    | FStar_Pervasives_Native.Some fn -> fn
    | FStar_Pervasives_Native.None  ->
        let file_name =
          let uu____9464 = hint_dir ()  in
          match uu____9464 with
          | FStar_Pervasives_Native.Some dir ->
              let uu____9472 = FStar_Util.basename src_filename  in
              FStar_Util.concat_dir_filename dir uu____9472
          | uu____9474 -> src_filename  in
        FStar_Util.format1 "%s.hints" file_name
  
let (ide : unit -> Prims.bool) = fun uu____9485  -> get_ide () 
let (print : unit -> Prims.bool) = fun uu____9492  -> get_print () 
let (print_in_place : unit -> Prims.bool) =
  fun uu____9499  -> get_print_in_place () 
let (initial_fuel : unit -> Prims.int) =
  fun uu____9506  ->
    let uu____9507 = get_initial_fuel ()  in
    let uu____9509 = get_max_fuel ()  in Prims.min uu____9507 uu____9509
  
let (initial_ifuel : unit -> Prims.int) =
  fun uu____9517  ->
    let uu____9518 = get_initial_ifuel ()  in
    let uu____9520 = get_max_ifuel ()  in Prims.min uu____9518 uu____9520
  
let (interactive : unit -> Prims.bool) =
  fun uu____9528  -> (get_in ()) || (get_ide ()) 
let (lax : unit -> Prims.bool) = fun uu____9535  -> get_lax () 
let (load : unit -> Prims.string Prims.list) = fun uu____9544  -> get_load () 
let (legacy_interactive : unit -> Prims.bool) = fun uu____9551  -> get_in () 
let (lsp_server : unit -> Prims.bool) = fun uu____9558  -> get_lsp () 
let (log_queries : unit -> Prims.bool) =
  fun uu____9565  -> get_log_queries () 
let (keep_query_captions : unit -> Prims.bool) =
  fun uu____9572  -> (log_queries ()) && (get_keep_query_captions ()) 
let (log_types : unit -> Prims.bool) = fun uu____9579  -> get_log_types () 
let (max_fuel : unit -> Prims.int) = fun uu____9586  -> get_max_fuel () 
let (max_ifuel : unit -> Prims.int) = fun uu____9593  -> get_max_ifuel () 
let (min_fuel : unit -> Prims.int) = fun uu____9600  -> get_min_fuel () 
let (ml_ish : unit -> Prims.bool) = fun uu____9607  -> get_MLish () 
let (set_ml_ish : unit -> unit) =
  fun uu____9613  -> set_option "MLish" (Bool true) 
let (no_default_includes : unit -> Prims.bool) =
  fun uu____9622  -> get_no_default_includes () 
let (no_extract : Prims.string -> Prims.bool) =
  fun s  ->
    let uu____9632 = get_no_extract ()  in
    FStar_All.pipe_right uu____9632 (FStar_List.existsb (module_name_eq s))
  
let (normalize_pure_terms_for_extraction : unit -> Prims.bool) =
  fun uu____9647  -> get_normalize_pure_terms_for_extraction () 
let (no_location_info : unit -> Prims.bool) =
  fun uu____9654  -> get_no_location_info () 
let (no_plugins : unit -> Prims.bool) = fun uu____9661  -> get_no_plugins () 
let (no_smt : unit -> Prims.bool) = fun uu____9668  -> get_no_smt () 
let (output_dir : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9677  -> get_odir () 
let (ugly : unit -> Prims.bool) = fun uu____9684  -> get_ugly () 
let (print_bound_var_types : unit -> Prims.bool) =
  fun uu____9691  -> get_print_bound_var_types () 
let (print_effect_args : unit -> Prims.bool) =
  fun uu____9698  -> get_print_effect_args () 
let (print_implicits : unit -> Prims.bool) =
  fun uu____9705  -> get_print_implicits () 
let (print_real_names : unit -> Prims.bool) =
  fun uu____9712  -> (get_prn ()) || (get_print_full_names ()) 
let (print_universes : unit -> Prims.bool) =
  fun uu____9719  -> get_print_universes () 
let (print_z3_statistics : unit -> Prims.bool) =
  fun uu____9726  -> get_print_z3_statistics () 
let (query_stats : unit -> Prims.bool) =
  fun uu____9733  -> get_query_stats () 
let (record_hints : unit -> Prims.bool) =
  fun uu____9740  -> get_record_hints () 
let (record_options : unit -> Prims.bool) =
  fun uu____9747  -> get_record_options () 
let (reuse_hint_for : unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9756  -> get_reuse_hint_for () 
let (silent : unit -> Prims.bool) = fun uu____9763  -> get_silent () 
let (smtencoding_elim_box : unit -> Prims.bool) =
  fun uu____9770  -> get_smtencoding_elim_box () 
let (smtencoding_nl_arith_native : unit -> Prims.bool) =
  fun uu____9777  ->
    let uu____9778 = get_smtencoding_nl_arith_repr ()  in
    uu____9778 = "native"
  
let (smtencoding_nl_arith_wrapped : unit -> Prims.bool) =
  fun uu____9788  ->
    let uu____9789 = get_smtencoding_nl_arith_repr ()  in
    uu____9789 = "wrapped"
  
let (smtencoding_nl_arith_default : unit -> Prims.bool) =
  fun uu____9799  ->
    let uu____9800 = get_smtencoding_nl_arith_repr ()  in
    uu____9800 = "boxwrap"
  
let (smtencoding_l_arith_native : unit -> Prims.bool) =
  fun uu____9810  ->
    let uu____9811 = get_smtencoding_l_arith_repr ()  in
    uu____9811 = "native"
  
let (smtencoding_l_arith_default : unit -> Prims.bool) =
  fun uu____9821  ->
    let uu____9822 = get_smtencoding_l_arith_repr ()  in
    uu____9822 = "boxwrap"
  
let (smtencoding_valid_intro : unit -> Prims.bool) =
  fun uu____9832  -> get_smtencoding_valid_intro () 
let (smtencoding_valid_elim : unit -> Prims.bool) =
  fun uu____9839  -> get_smtencoding_valid_elim () 
let (tactic_raw_binders : unit -> Prims.bool) =
  fun uu____9846  -> get_tactic_raw_binders () 
let (tactics_failhard : unit -> Prims.bool) =
  fun uu____9853  -> get_tactics_failhard () 
let (tactics_info : unit -> Prims.bool) =
  fun uu____9860  -> get_tactics_info () 
let (tactic_trace : unit -> Prims.bool) =
  fun uu____9867  -> get_tactic_trace () 
let (tactic_trace_d : unit -> Prims.int) =
  fun uu____9874  -> get_tactic_trace_d () 
let (tactics_nbe : unit -> Prims.bool) =
  fun uu____9881  -> get_tactics_nbe () 
let (tcnorm : unit -> Prims.bool) = fun uu____9888  -> get_tcnorm () 
let (timing : unit -> Prims.bool) = fun uu____9895  -> get_timing () 
let (trace_error : unit -> Prims.bool) =
  fun uu____9902  -> get_trace_error () 
let (unthrottle_inductives : unit -> Prims.bool) =
  fun uu____9909  -> get_unthrottle_inductives () 
let (unsafe_tactic_exec : unit -> Prims.bool) =
  fun uu____9916  -> get_unsafe_tactic_exec () 
let (use_eq_at_higher_order : unit -> Prims.bool) =
  fun uu____9923  -> get_use_eq_at_higher_order () 
let (use_hints : unit -> Prims.bool) = fun uu____9930  -> get_use_hints () 
let (use_hint_hashes : unit -> Prims.bool) =
  fun uu____9937  -> get_use_hint_hashes () 
let (use_native_tactics :
  unit -> Prims.string FStar_Pervasives_Native.option) =
  fun uu____9946  -> get_use_native_tactics () 
let (use_tactics : unit -> Prims.bool) =
  fun uu____9953  -> get_use_tactics () 
let (using_facts_from :
  unit -> (Prims.string Prims.list * Prims.bool) Prims.list) =
  fun uu____9969  ->
    let uu____9970 = get_using_facts_from ()  in
...
let (vcgen_optimize_bind_as_seq : unit -> Prims.bool) =
  fun uu____10024  ->
    let uu____10025 = get_vcgen_optimize_bind_as_seq ()  in
    FStar_Option.isSome uu____10025
  
let (vcgen_decorate_with_type : unit -> Prims.bool) =
  fun uu____10036  ->
    let uu____10037 = get_vcgen_optimize_bind_as_seq ()  in
    match uu____10037 with
    | FStar_Pervasives_Native.Some "with_type" -> true
    | uu____10045 -> false
  
let (warn_default_effects : unit -> Prims.bool) =
  fun uu____10056  -> get_warn_default_effects () 
let (z3_exe : unit -> Prims.string) =
  fun uu____10063  ->
    let uu____10064 = get_smt ()  in
    match uu____10064 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
  
let (z3_cliopt : unit -> Prims.string Prims.list) =
  fun uu____10082  -> get_z3cliopt () 
let (z3_refresh : unit -> Prims.bool) = fun uu____10089  -> get_z3refresh () 
let (z3_rlimit : unit -> Prims.int) = fun uu____10096  -> get_z3rlimit () 
let (z3_rlimit_factor : unit -> Prims.int) =
  fun uu____10103  -> get_z3rlimit_factor () 
let (z3_seed : unit -> Prims.int) = fun uu____10110  -> get_z3seed () 
let (use_two_phase_tc : unit -> Prims.bool) =
  fun uu____10117  ->
    (get_use_two_phase_tc ()) &&
      (let uu____10119 = lax ()  in Prims.op_Negation uu____10119)
  
let (no_positivity : unit -> Prims.bool) =
  fun uu____10127  -> get_no_positivity () 
let (ml_no_eta_expand_coertions : unit -> Prims.bool) =
  fun uu____10134  -> get_ml_no_eta_expand_coertions () 
let (warn_error : unit -> Prims.string) =
  fun uu____10141  ->
    let uu____10142 = get_warn_error ()  in
    FStar_String.concat "" uu____10142
  
let (use_extracted_interfaces : unit -> Prims.bool) =
  fun uu____10153  -> get_use_extracted_interfaces () 
let (use_nbe : unit -> Prims.bool) = fun uu____10160  -> get_use_nbe () 
let (trivial_pre_for_unannotated_effectful_fns : unit -> Prims.bool) =
  fun uu____10167  -> get_trivial_pre_for_unannotated_effectful_fns () 
let with_saved_options : 'a . (unit -> 'a) -> 'a =
  fun f  ->
    let uu____10184 =
      let uu____10186 = trace_error ()  in Prims.op_Negation uu____10186  in
    if uu____10184
    then
      (push ();
       (let r =
          try
            (fun uu___775_10201  ->
               match () with
               | () -> let uu____10206 = f ()  in FStar_Util.Inr uu____10206)
              ()
          with | uu___774_10208 -> FStar_Util.Inl uu___774_10208  in
        pop ();
        (match r with
        ...
        FStar_All.pipe_right setting
          (FStar_Util.try_find
             (fun uu____10376  ->
                ...
                | (path,uu____10387) -> matches_path m_components path))
         in
      match uu____10334 with
      | FStar_Pervasives_Native.None  -> false
      | FStar_Pervasives_Native.Some (uu____10406,flag) -> flag
...
let (should_extract : Prims.string -> Prims.bool) =
  fun m  ->
    let m1 = FStar_String.lowercase m  in
    let uu____10471 = get_extract ()  in
    match uu____10471 with
    | FStar_Pervasives_Native.Some extract_setting ->
        ((let uu____10486 =
            let uu____10502 = get_no_extract ()  in
            let uu____10506 = get_extract_namespace ()  in
            let uu____10510 = get_extract_module ()  in
            (uu____10502, uu____10506, uu____10510)  in
    ...
    | FStar_Pervasives_Native.None  ->
        let should_extract_namespace m2 =
          let uu____10564 = get_extract_namespace ()  in
        ...
        let should_extract_module m2 =
          let uu____10592 = get_extract_module ()  in
          ...
          | l ->
           ...
           in
        (let uu____10614 = no_extract m1  in Prims.op_Negation uu____10614)
          &&
          (let uu____10617 =
             let uu____10628 = get_extract_namespace ()  in
             let uu____10632 = get_extract_module ()  in
             (uu____10628, uu____10632)  in
...
let (should_be_already_cached : Prims.string -> Prims.bool) =
  fun m  ->
    let uu____10672 = get_already_cached ()  in
...
let (error_flags : unit -> error_flag Prims.list) =
  ...
  fun uu____10705  ->
    ...
    let uu____10708 = FStar_Util.smap_try_find cache we  in
...
let (profile_enabled :
  ...
  fun modul_opt  ->
    fun phase  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____10752 = get_profile_component ()  in
          matches_namespace_filter_opt phase uu____10752
      | FStar_Pervasives_Native.Some modul ->
          (let uu____10763 = get_profile ()  in
           matches_namespace_filter_opt modul uu____10763) &&
            (let uu____10770 = get_profile_component ()  in
             matches_namespace_filter_opt phase uu____10770)
