...
let g = (fun uu____824 -> (set_option' (let _0_39 = (f ())
in ((name), (_0_39)))))
...
let check_cardinality : Prims.unit  ->  Prims.bool = (fun uu____1678 -> (let _0_106 = (get_cardinality ())
in (_0_106 = "check")))
...
let codegen_libs : Prims.unit  ->  Prims.string Prims.list Prims.list = (fun uu____1687 -> (let _0_107 = (get_codegen_lib ())
in (FStar_All.pipe_right _0_107 (FStar_List.map (fun x -> (FStar_Util.split x "."))))))


let debug_any : Prims.unit  ->  Prims.bool = (fun uu____1695 -> (let _0_108 = (get_debug ())
in (_0_108 <> [])))
...
let norm_then_print : Prims.unit  ->  Prims.bool = (fun uu____1799 -> (let _0_113 = (get_print_before_norm ())
in (_0_113 = false)))
...
let warn_cardinality : Prims.unit  ->  Prims.bool = (fun uu____1862 -> (let _0_114 = (get_cardinality ())
in (_0_114 = "warn")))
