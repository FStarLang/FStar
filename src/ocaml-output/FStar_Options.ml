...
let get_tactic_trace: Prims.unit -> Prims.bool =
  fun uu____1748  -> lookup_opt "tactic_trace" as_bool
let get_tactic_trace_d: Prims.unit -> Prims.int =
  fun uu____1751  -> lookup_opt "tactic_trace_d" as_int
let get_timing: Prims.unit -> Prims.bool =
  fun uu____1754  -> lookup_opt "timing" as_bool
let get_trace_error: Prims.unit -> Prims.bool =
  fun uu____1757  -> lookup_opt "trace_error" as_bool
let get_unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____1760  -> lookup_opt "unthrottle_inductives" as_bool
let get_unsafe_tactic_exec: Prims.unit -> Prims.bool =
  fun uu____1763  -> lookup_opt "unsafe_tactic_exec" as_bool
let get_use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____1766  -> lookup_opt "use_eq_at_higher_order" as_bool
let get_use_hints: Prims.unit -> Prims.bool =
  fun uu____1769  -> lookup_opt "use_hints" as_bool
let get_use_hint_hashes: Prims.unit -> Prims.bool =
  fun uu____1772  -> lookup_opt "use_hint_hashes" as_bool
let get_use_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____1777  -> lookup_opt "use_native_tactics" (as_option as_string)
let get_use_tactics: Prims.unit -> Prims.bool =
  fun uu____1782  ->
    let uu____1783 = lookup_opt "no_tactics" as_bool in
...
let get_verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____1801  -> lookup_opt "verify_module" (as_list as_string)
let get___temp_no_proj: Prims.unit -> Prims.string Prims.list =
  fun uu____1808  -> lookup_opt "__temp_no_proj" (as_list as_string)
let get_version: Prims.unit -> Prims.bool =
  fun uu____1813  -> lookup_opt "version" as_bool
let get_warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____1816  -> lookup_opt "warn_default_effects" as_bool
let get_z3cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____1821  -> lookup_opt "z3cliopt" (as_list as_string)
let get_z3refresh: Prims.unit -> Prims.bool =
  fun uu____1826  -> lookup_opt "z3refresh" as_bool
let get_z3rlimit: Prims.unit -> Prims.int =
  fun uu____1829  -> lookup_opt "z3rlimit" as_int
let get_z3rlimit_factor: Prims.unit -> Prims.int =
  fun uu____1832  -> lookup_opt "z3rlimit_factor" as_int
let get_z3seed: Prims.unit -> Prims.int =
  fun uu____1835  -> lookup_opt "z3seed" as_int
let get_use_two_phase_tc: Prims.unit -> Prims.bool =
  fun uu____1838  -> lookup_opt "use_two_phase_tc" as_bool
let get_no_positivity: Prims.unit -> Prims.bool =
  fun uu____1841  -> lookup_opt "__no_positivity" as_bool
let get_ml_no_eta_expand_coertions: Prims.unit -> Prims.bool =
  fun uu____1844  -> lookup_opt "__ml_no_eta_expand_coertions" as_bool
let get_warn_error: Prims.unit -> Prims.string =
  fun uu____1847  -> lookup_opt "warn_error" as_string
...
and specs: Prims.unit -> FStar_Getopt.opt Prims.list =
  fun uu____4984  ->
    let uu____4987 = specs_with_types () in
    FStar_List.map
      (fun uu____5012  ->
         match uu____5012 with
         | (short,long,typ,doc) ->
             let uu____5025 =
               let uu____5036 = arg_spec_of_opt_type long typ in
               (short, long, uu____5036, doc) in
             mk_spec uu____5025) uu____4987
let settable: Prims.string -> Prims.bool =
  fun uu___41_5043  ->
    match uu___41_5043 with
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____5101  ->
          ...
          | (uu____5112,x,uu____5114,uu____5115) -> settable x))
  ...
  FStar_All.pipe_right all_specs
    (FStar_List.filter
       (fun uu____5161  ->
          ...
          | (uu____5172,x,uu____5174,uu____5175) -> resettable x))
let display_usage: Prims.unit -> Prims.unit =
  fun uu____5182  ->
    let uu____5183 = specs () in display_usage_aux uu____5183
let fstar_home: Prims.unit -> Prims.string =
  fun uu____5198  ->
    let uu____5199 = get_fstar_home () in
    match uu____5199 with
    | FStar_Pervasives_Native.None  ->
        let x = FStar_Util.get_exec_dir () in
        let x1 = Prims.strcat x "/.." in
        ((let uu____5205 =
            let uu____5210 = mk_string x1 in ("fstar_home", uu____5210) in
          set_option' uu____5205);
         x1)
...
let uu___is_File_argument: Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with
    | File_argument uu____5218 -> true
    | uu____5219 -> false
let __proj__File_argument__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | File_argument uu____5226 -> uu____5226
  ...
  fun uu____5292  ->
    let res =
      FStar_Getopt.parse_cmdline all_specs
        (fun i  ->
           let uu____5297 =
             let uu____5300 = FStar_ST.op_Bang file_list_ in
             FStar_List.append uu____5300 [i] in
           FStar_ST.op_Colon_Equals file_list_ uu____5297) in
    let uu____5407 =
      let uu____5410 = FStar_ST.op_Bang file_list_ in
      FStar_List.map FStar_Common.try_convert_file_name_to_mixed uu____5410 in
    (res, uu____5407)
let file_list: Prims.unit -> Prims.string Prims.list =
  fun uu____5471  -> FStar_ST.op_Bang file_list_
let restore_cmd_line_options: Prims.bool -> FStar_Getopt.parse_cmdline_res =
  fun should_clear  ->
    let old_verify_module = get_verify_module () in
    if should_clear then clear () else init ();
    (let r =
       let uu____5533 = specs () in
       FStar_Getopt.parse_cmdline uu____5533 (fun x  -> ()) in
     (let uu____5539 =
        let uu____5544 =
          let uu____5545 = FStar_List.map mk_string old_verify_module in
          List uu____5545 in
        ("verify_module", uu____5544) in
      set_option' uu____5539);
     r)
  ...
  fun f  ->
    ...
    let f2 =
      let uu____5553 =
        let uu____5554 =
          let uu____5555 =
            let uu____5556 = FStar_Util.get_file_extension f1 in
            FStar_String.length uu____5556 in
          (FStar_String.length f1) - uu____5555 in
        uu____5554 - (Prims.parse_int "1") in
      FStar_String.substring f1 (Prims.parse_int "0") uu____5553 in
    FStar_String.lowercase f2
let should_verify: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5560 = get_lax () in
    if uu____5560
    then false
    else
...
let should_verify_file: Prims.string -> Prims.bool =
  fun fn  ->
    let uu____5568 = module_name_of_file_name fn in should_verify uu____5568
let dont_gen_projectors: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5572 = get___temp_no_proj () in
    FStar_List.contains m uu____5572
let should_print_message: Prims.string -> Prims.bool =
  fun m  ->
    let uu____5578 = should_verify m in
    if uu____5578 then m <> "Prims" else false
let include_path: Prims.unit -> Prims.string Prims.list =
  fun uu____5584  ->
    let uu____5585 = get_no_default_includes () in
    if uu____5585
    then get_include ()
    else
      (let h = fstar_home () in
       ...
       let uu____5609 =
         let uu____5612 = get_include () in
         FStar_List.append uu____5612 ["."] in
       FStar_List.append uu____5593 uu____5609)
let find_file: Prims.string -> Prims.string FStar_Pervasives_Native.option =
  fun filename  ->
    let uu____5620 = FStar_Util.is_path_absolute filename in
    if uu____5620
    then
      ...
      (let uu____5627 =
         let uu____5630 = include_path () in FStar_List.rev uu____5630 in
       FStar_Util.find_map uu____5627
         (fun p  ->
...
let prims_basename: Prims.unit -> Prims.string =
  fun uu____5655  ->
    let uu____5656 = prims () in FStar_Util.basename uu____5656
let pervasives: Prims.unit -> Prims.string =
  fun uu____5659  ->
    let filename = "FStar.Pervasives.fst" in
    let uu____5661 = find_file filename in
...
let pervasives_basename: Prims.unit -> Prims.string =
  fun uu____5668  ->
    let uu____5669 = pervasives () in FStar_Util.basename uu____5669
let pervasives_native_basename: Prims.unit -> Prims.string =
  fun uu____5672  ->
    let filename = "FStar.Pervasives.Native.fst" in
    let uu____5674 = find_file filename in
...
let __temp_no_proj: Prims.string -> Prims.bool =
  fun s  ->
    let uu____5689 = get___temp_no_proj () in
    FStar_All.pipe_right uu____5689 (FStar_List.contains s)
let admit_smt_queries: Prims.unit -> Prims.bool =
  fun uu____5696  -> get_admit_smt_queries ()
let admit_except: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5701  -> get_admit_except ()
let cache_checked_modules: Prims.unit -> Prims.bool =
  fun uu____5704  -> get_cache_checked_modules ()
let codegen: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5709  -> get_codegen ()
let codegen_libs: Prims.unit -> Prims.string Prims.list Prims.list =
  fun uu____5716  ->
    let uu____5717 = get_codegen_lib () in
    FStar_All.pipe_right uu____5717
      (FStar_List.map (fun x  -> FStar_Util.split x "."))
let debug_any: Prims.unit -> Prims.bool =
  fun uu____5732  -> let uu____5733 = get_debug () in uu____5733 <> []
let debug_at_level: Prims.string -> debug_level_t -> Prims.bool =
  fun modul  ->
    fun level  ->
      (let uu____5746 = get_debug () in
       FStar_All.pipe_right uu____5746 (FStar_List.contains modul)) &&
        (debug_level_geq level)
let dep: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5755  -> get_dep ()
let detail_errors: Prims.unit -> Prims.bool =
  fun uu____5758  -> get_detail_errors ()
let detail_hint_replay: Prims.unit -> Prims.bool =
  fun uu____5761  -> get_detail_hint_replay ()
let doc: Prims.unit -> Prims.bool = fun uu____5764  -> get_doc ()
let dump_module: Prims.string -> Prims.bool =
  fun s  ->
    let uu____5768 = get_dump_module () in
    FStar_All.pipe_right uu____5768 (FStar_List.contains s)
let eager_inference: Prims.unit -> Prims.bool =
  fun uu____5775  -> get_eager_inference ()
let expose_interfaces: Prims.unit -> Prims.bool =
  fun uu____5778  -> get_expose_interfaces ()
let fs_typ_app: Prims.string -> Prims.bool =
  fun filename  ->
    let uu____5782 = FStar_ST.op_Bang light_off_files in
    FStar_List.contains filename uu____5782
...
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    ...
    let uu____5917 = get_no_extract () in
    FStar_All.pipe_right uu____5917
      (FStar_Util.for_some (fun f  -> (FStar_String.lowercase f) = s1))
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____5926  -> get_no_location_info ()
let output_dir: Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____5931  -> get_odir ()
let ugly: Prims.unit -> Prims.bool = fun uu____5934  -> get_ugly ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____5937  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____5940  -> get_print_effect_args ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____5943  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____5946  -> (get_prn ()) || (get_print_full_names ())
let print_universes: Prims.unit -> Prims.bool =
  fun uu____5949  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____5952  -> (get_print_z3_statistics ()) || (get_query_stats ())
let query_stats: Prims.unit -> Prims.bool =
  fun uu____5955  -> get_query_stats ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____5958  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string FStar_Pervasives_Native.option
  = fun uu____5963  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____5966  -> get_silent ()
let smtencoding_elim_box: Prims.unit -> Prims.bool =
  fun uu____5969  -> get_smtencoding_elim_box ()
let smtencoding_nl_arith_native: Prims.unit -> Prims.bool =
  fun uu____5972  ->
    let uu____5973 = get_smtencoding_nl_arith_repr () in
    uu____5973 = "native"
let smtencoding_nl_arith_wrapped: Prims.unit -> Prims.bool =
  fun uu____5976  ->
    let uu____5977 = get_smtencoding_nl_arith_repr () in
    uu____5977 = "wrapped"
let smtencoding_nl_arith_default: Prims.unit -> Prims.bool =
  fun uu____5980  ->
    let uu____5981 = get_smtencoding_nl_arith_repr () in
    uu____5981 = "boxwrap"
let smtencoding_l_arith_native: Prims.unit -> Prims.bool =
  fun uu____5984  ->
    let uu____5985 = get_smtencoding_l_arith_repr () in uu____5985 = "native"
let smtencoding_l_arith_default: Prims.unit -> Prims.bool =
  fun uu____5988  ->
    let uu____5989 = get_smtencoding_l_arith_repr () in
    uu____5989 = "boxwrap"
let split_cases: Prims.unit -> Prims.int =
  fun uu____5992  -> get_split_cases ()
let tactic_trace: Prims.unit -> Prims.bool =
  fun uu____5995  -> get_tactic_trace ()
let tactic_trace_d: Prims.unit -> Prims.int =
  fun uu____5998  -> get_tactic_trace_d ()
let timing: Prims.unit -> Prims.bool = fun uu____6001  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____6004  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____6007  -> get_unthrottle_inductives ()
let unsafe_tactic_exec: Prims.unit -> Prims.bool =
  fun uu____6010  -> get_unsafe_tactic_exec ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____6013  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____6016  -> get_use_hints ()
let use_hint_hashes: Prims.unit -> Prims.bool =
  fun uu____6019  -> get_use_hint_hashes ()
let use_native_tactics:
  Prims.unit -> Prims.string FStar_Pervasives_Native.option =
  fun uu____6024  -> get_use_native_tactics ()
let use_tactics: Prims.unit -> Prims.bool =
  fun uu____6027  -> get_use_tactics ()
let using_facts_from:
  ...
  fun uu____6036  ->
      ...
      then ([], true)
        ...
        then
          (let path =
             ...
             FStar_Ident.path_of_text uu____6065 in
           (path, false))
        else
          (let s1 =
             if FStar_Util.starts_with s "+"
    ...
    let uu____6101 = get_using_facts_from () in
    match uu____6101 with
    | FStar_Pervasives_Native.None  -> [([], true)]
    | FStar_Pervasives_Native.Some ns ->
        let uu____6133 = FStar_List.collect parse_setting ns in
        FStar_All.pipe_right uu____6133 FStar_List.rev
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____6172  -> get_warn_default_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____6175  ->
    let uu____6176 = get_smt () in
    match uu____6176 with
    | FStar_Pervasives_Native.None  -> FStar_Platform.exe "z3"
    | FStar_Pervasives_Native.Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____6184  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____6187  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____6190  -> get_z3rlimit ()
let z3_rlimit_factor: Prims.unit -> Prims.int =
  fun uu____6193  -> get_z3rlimit_factor ()
let z3_seed: Prims.unit -> Prims.int = fun uu____6196  -> get_z3seed ()
let use_two_phase_tc: Prims.unit -> Prims.bool =
  fun uu____6199  -> get_use_two_phase_tc ()
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____6202  -> get_no_positivity ()
let ml_no_eta_expand_coertions: Prims.unit -> Prims.bool =
  fun uu____6205  -> get_ml_no_eta_expand_coertions ()
let warn_error: Prims.unit -> Prims.string =
  fun uu____6208  -> get_warn_error ()
let should_extract_namespace: Prims.string -> Prims.bool =
  fun m  ->
    let uu____6212 = get_extract_namespace () in
...
let should_extract_module: Prims.string -> Prims.bool =
  fun m  ->
    let uu____6225 = get_extract_module () in
...
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    ...
    (let uu____6241 = no_extract m1 in Prims.op_Negation uu____6241) &&
      (let uu____6243 =
         let uu____6252 = get_extract_namespace () in
         let uu____6255 = get_extract_module () in (uu____6252, uu____6255) in
...
let codegen_fsharp: Prims.unit -> Prims.bool =
  fun uu____6277  ->
    let uu____6278 = codegen () in
    uu____6278 = (FStar_Pervasives_Native.Some "FSharp")