...
end))), "Interactive mode; reads input from stdin"))::((FStar_Getopt.noshort, "include", FStar_Getopt.OneArg (((fun s -> (let _113_133 = (let _113_132 = (FStar_ST.read _include_path)
in (FStar_List.append _113_132 ((s)::[])))
in (FStar_ST.op_Colon_Equals _include_path _113_133))), "path")), "A directory in which to search for files included on the command line"))::((FStar_Getopt.noshort, "initial_fuel", FStar_Getopt.OneArg (((fun x -> (let _113_137 = (FStar_Util.int_of_string x)
in (FStar_ST.op_Colon_Equals initial_fuel _113_137))), "non-negative integer")), "Number of unrolling of recursive functions to try initially (default 2)"))::((FStar_Getopt.noshort, "initial_ifuel", FStar_Getopt.OneArg (((fun x -> (let _113_141 = (FStar_Util.int_of_string x)
in (FStar_ST.op_Colon_Equals initial_ifuel _113_141))), "non-negative integer")), "Number of unrolling of inductive datatypes to try at first (default 1)"))::((FStar_Getopt.noshort, "inline_arith", FStar_Getopt.ZeroArgs ((fun _24_232 -> (match (()) with
| () -> begin
(FStar_ST.op_Colon_Equals inline_arith true)
end))), "Inline definitions of arithmetic functions in the SMT encoding"))::((FStar_Getopt.noshort, "lax", FStar_Getopt.ZeroArgs ((fun _24_233 -> (match (()) with
| () -> begin
(
...
end))), "Print types computed for data/val/let-bindings"))::((FStar_Getopt.noshort, "log_queries", FStar_Getopt.ZeroArgs ((fun _24_237 -> (match (()) with
| () -> begin
(FStar_ST.op_Colon_Equals logQueries true)
end))), "Log the Z3 queries in queries.smt2"))::((FStar_Getopt.noshort, "max_fuel", FStar_Getopt.OneArg (((fun x -> (let _113_149 = (FStar_Util.int_of_string x)
in (FStar_ST.op_Colon_Equals max_fuel _113_149))), "non-negative integer")), "Number of unrolling of recursive functions to try at most (default 8)"))::((FStar_Getopt.noshort, "max_ifuel", FStar_Getopt.OneArg (((fun x -> (let _113_153 = (FStar_Util.int_of_string x)
in (FStar_ST.op_Colon_Equals max_ifuel _113_153))), "non-negative integer")), "Number of unrolling of inductive datatypes to try at most (default 2)"))::((FStar_Getopt.noshort, "min_fuel", FStar_Getopt.OneArg (((fun x -> (let _113_157 = (FStar_Util.int_of_string x)
in (FStar_ST.op_Colon_Equals min_fuel _113_157))), "non-negative integer")), "Minimum number of unrolling of recursive functions to try (default 1)"))::((FStar_Getopt.noshort, "MLish", FStar_Getopt.ZeroArgs ((fun _24_241 -> (match (()) with
| () -> begin
(
...
in (FStar_Getopt.parse_string specs (fun _24_375 -> ()) s))))))))
