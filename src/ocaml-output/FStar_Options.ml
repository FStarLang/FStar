...
let _20_276 = (let _102_220 = (specs ())
...
let _20_286 = (let _102_222 = (specs ())
...
let _20_292 = (let _102_224 = (specs ())
...
in (FStar_All.pipe_right _102_234 (FStar_List.filter (fun _20_306 -> (match (_20_306) with
