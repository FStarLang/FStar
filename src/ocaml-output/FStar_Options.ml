...
let lookup_opt s c =
  let uu____473 = let _0_38 = peek () in FStar_Util.smap_try_find _0_38 s in
    ...
    let specs =
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                List
                  (let _0_67 = let _0_65 = get_codegen_lib () in s :: _0_65 in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                List
                  (let _0_73 = let _0_71 = get_debug_level () in x :: _0_71 in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let _0_78 =
                  let _0_76 = let _0_74 = get_dump_module () in x :: _0_74 in
                  FStar_All.pipe_right _0_76
                    (FStar_List.map (fun _0_75  -> String _0_75)) in
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                List
                  (let _0_85 = let _0_83 = get_no_extract () in x :: _0_83 in
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline _0_102
        (fun i  ->
           ...
           FStar_ST.write file_list_ _0_101) in
  ...
  fun should_clear  ->
    ...
    (let r =
     ...
     set_option'
       (let _0_106 =
          List
            (FStar_List.map (fun _0_105  -> String _0_105) old_verify_module) in
              ...
              FStar_List.existsML
                (fun f  ->
                   ...
                   let f =
                     ...
                     FStar_String.substring f (Prims.parse_int "0") _0_109 in
...
let hint_info: Prims.unit -> Prims.bool = fun uu____1779  -> get_hint_info ()
...
let log_types: Prims.unit -> Prims.bool = fun uu____1803  -> get_log_types ()
...
let use_hints: Prims.unit -> Prims.bool = fun uu____1887  -> get_use_hints ()
