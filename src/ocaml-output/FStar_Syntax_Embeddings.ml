...
let (e_int : FStar_BigInt.t embedding) =
  let em rng i =
    ...
    let uu___79_568 = t  in
    {
      FStar_Syntax_Syntax.n = (uu___79_568.FStar_Syntax_Syntax.n);
      FStar_Syntax_Syntax.pos = rng;
      FStar_Syntax_Syntax.vars = (uu___79_568.FStar_Syntax_Syntax.vars)
    }  in
  let un w t0 =
    let t = FStar_Syntax_Util.unmeta_safe t0  in
    match t.FStar_Syntax_Syntax.n with
          ...
          (match uu____1494 with
           ...
           | (FStar_Syntax_Syntax.Tm_fvar
              fv,(uu____1544,FStar_Pervasives_Native.Some
               ...
               ->
               let uu____1586 = unembed ea hd2  in
           ...
           | (FStar_Syntax_Syntax.Tm_fvar
              fv,(hd2,FStar_Pervasives_Native.None )::(tl1,FStar_Pervasives_Native.None
               ...
               FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid
               ->
               let uu____1642 = unembed ea hd2  in
    ...
    | (hd1,args) ->
        ...
        (match uu____1988 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,(l,uu____2122)::[]) when
             ...
             ->
             let uu____2147 =
               let uu____2152 = e_list e_string  in unembed uu____2152 l  in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,(l,uu____2169)::[]) when
             ...
             ->
             let uu____2194 =
               let uu____2199 = e_list e_string  in unembed uu____2199 l  in
