...
let (uu___is_Simpl : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Simpl -> true | uu____1323 -> false
let (uu___is_Weak : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Weak -> true | uu____1327 -> false
...
let (uu___is_Delta : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Delta -> true | uu____1339 -> false
let (uu___is_Zeta : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Zeta -> true | uu____1343 -> false
let (uu___is_Iota : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Iota -> true | uu____1347 -> false
...
let (e_norm_step : norm_step embedding) =
  let em rng n1 =
    ...
    | UnfoldOnly l ->
        let uu____1412 =
          let uu____1413 =
            let uu____1414 =
              let uu____1415 =
                let uu____1416 = e_list e_string in embed uu____1416 rng l in
    ...
    | UnfoldFully l ->
        let uu____1428 =
          let uu____1429 =
            let uu____1430 =
              let uu____1431 =
                let uu____1432 = e_list e_string in embed uu____1432 rng l in
    ...
    | UnfoldAttr a ->
        let uu____1442 =
          let uu____1443 =
            let uu____1444 = FStar_Syntax_Syntax.as_arg a in [uu____1444] in
          FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldAttr uu____1443 in
        uu____1442 FStar_Pervasives_Native.None rng in
  let un w t0 =
    let t = FStar_Syntax_Util.unmeta_safe t0 in
         ...
         | uu____1764 ->
             (if w
              then
                (let uu____1778 =
                   let uu____1783 =
                     let uu____1784 = FStar_Syntax_Print.term_to_string t0 in
              ...
              FStar_Util.bind_opt uu____1889
                (fun a ->
                   let uu____1895 =
                     let uu____1896 =
                       let uu____1897 =
                         let uu____1898 = ua x in FStar_Util.must uu____1898 in
                       f uu____1897 in
