...
let embed_int : FStar_Range.range  ->  Prims.int  ->  FStar_Syntax_Syntax.term = (fun rng i -> (

let t = (

let uu____186 = (FStar_Util.string_of_int i)
...
let __unembed_int : Prims.bool  ->  FStar_Syntax_Syntax.term  ->  Prims.int FStar_Pervasives_Native.option = (fun w t0 -> (
...
let uu____217 = (FStar_Util.int_of_string s)
...
let unembed_int : FStar_Syntax_Syntax.term  ->  Prims.int FStar_Pervasives_Native.option = (fun t -> (__unembed_int true t))


let unembed_int_safe : FStar_Syntax_Syntax.term  ->  Prims.int FStar_Pervasives_Native.option = (fun t -> (__unembed_int false t))
...
in (uu____1807 l))
in (FStar_Util.bind_opt uu____1802 (fun ss -> (FStar_All.pipe_left (fun _0_45 -> FStar_Pervasives_Native.Some (_0_45)) (UnfoldOnly (ss))))))
end
| uu____1822 -> begin
((match (w) with
| true -> begin
