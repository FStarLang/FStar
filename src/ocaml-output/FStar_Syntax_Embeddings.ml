      ...
      | (hd1,args) ->
          ...
          (match uu____1148 with
           | (FStar_Syntax_Syntax.Tm_fvar fv,uu____1178) when
               ...
               FStar_Pervasives_Native.Some []
           | (FStar_Syntax_Syntax.Tm_fvar
              fv,(uu____1198,FStar_Pervasives_Native.Some
                  (FStar_Syntax_Syntax.Implicit uu____1199))::(hd2,FStar_Pervasives_Native.None
                                                               )::(tl1,FStar_Pervasives_Native.None
                                                                   )::[])
               when
               FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid
               ->
               let uu____1262 = unembed ea hd2  in
               FStar_Util.bind_opt uu____1262
                 (fun hd3  ->
                    let uu____1270 = un w tl1  in
                    FStar_Util.bind_opt uu____1270
           ...
           | (FStar_Syntax_Syntax.Tm_fvar
              fv,(hd2,FStar_Pervasives_Native.None )::(tl1,FStar_Pervasives_Native.None
               ...
               FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid
               ->
               let uu____1334 = unembed ea hd2  in
               FStar_Util.bind_opt uu____1334
                 (fun hd3  ->
                    let uu____1342 = un w tl1  in
                    FStar_Util.bind_opt uu____1342
                      (fun tl2  -> FStar_Pervasives_Native.Some (hd3 :: tl2)))
           | uu____1357 ->
               (if w
                then
                  (let uu____1371 =
                     let uu____1376 =
                       let uu____1377 = FStar_Syntax_Print.term_to_string t0
                          in
                       FStar_Util.format1 "Not an embedded list: %s"
                         uu____1377
                        in
                     (FStar_Errors.Warning_NotEmbedded, uu____1376)  in
                   FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos
                     uu____1371)
                else ();
                FStar_Pervasives_Native.None))
       in
    let uu____1381 =
      let uu____1382 = type_of ea  in
      FStar_Syntax_Syntax.t_list_of uu____1382  in
    mk_emb em un uu____1381
...
let (uu___is_Simpl : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Simpl  -> true | uu____1408 -> false
  
let (uu___is_Weak : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Weak  -> true | uu____1412 -> false
  
let (uu___is_HNF : norm_step -> Prims.bool) =
  fun projectee  -> match projectee with | HNF  -> true | uu____1416 -> false 
let (uu___is_Primops : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primops  -> true | uu____1420 -> false
  
let (uu___is_Delta : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Delta  -> true | uu____1424 -> false
  
let (uu___is_Zeta : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Zeta  -> true | uu____1428 -> false
  
let (uu___is_Iota : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | Iota  -> true | uu____1432 -> false
  
let (uu___is_UnfoldOnly : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | UnfoldOnly _0 -> true | uu____1439 -> false
  
let (__proj__UnfoldOnly__item___0 : norm_step -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | UnfoldOnly _0 -> _0 
let (uu___is_UnfoldFully : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | UnfoldFully _0 -> true | uu____1459 -> false
  
let (__proj__UnfoldFully__item___0 : norm_step -> Prims.string Prims.list) =
  fun projectee  -> match projectee with | UnfoldFully _0 -> _0 
let (uu___is_UnfoldAttr : norm_step -> Prims.bool) =
  fun projectee  ->
    match projectee with | UnfoldAttr _0 -> true | uu____1477 -> false
    ...
    | UnfoldOnly l ->
        let uu____1497 =
          let uu____1498 =
            let uu____1499 =
              let uu____1500 =
                let uu____1501 = e_list e_string  in embed uu____1501 rng l
                 in
              FStar_Syntax_Syntax.as_arg uu____1500  in
            [uu____1499]  in
          FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldOnly uu____1498  in
    ...
    | UnfoldFully l ->
        let uu____1513 =
          let uu____1514 =
            let uu____1515 =
              let uu____1516 =
                let uu____1517 = e_list e_string  in embed uu____1517 rng l
                 in
              FStar_Syntax_Syntax.as_arg uu____1516  in
            [uu____1515]  in
          FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldFully uu____1514  in
        uu____1513 FStar_Pervasives_Native.None rng
    | UnfoldAttr a ->
        let uu____1527 =
          let uu____1528 =
            let uu____1529 = FStar_Syntax_Syntax.as_arg a  in [uu____1529]
             in
          FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldAttr uu____1528  in
        uu____1527 FStar_Pervasives_Native.None rng
     in
  let un w t0 =
    let t = FStar_Syntax_Util.unmeta_safe t0  in
    let uu____1544 = FStar_Syntax_Util.head_and_args t  in
    match uu____1544 with
    | (hd1,args) ->
        let uu____1583 =
          let uu____1596 =
            let uu____1597 = FStar_Syntax_Util.un_uinst hd1  in
        ...
        (match uu____1583 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,(l,uu____1717)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Parser_Const.steps_unfoldonly
             ->
             let uu____1742 =
               let uu____1747 = e_list e_string  in unembed uu____1747 l  in
             FStar_Util.bind_opt uu____1742
               (fun ss  ->
                  FStar_All.pipe_left
                    (fun _0_39  -> FStar_Pervasives_Native.Some _0_39)
                    (UnfoldOnly ss))
         | (FStar_Syntax_Syntax.Tm_fvar fv,(l,uu____1764)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Parser_Const.steps_unfoldfully
             ->
             let uu____1789 =
               let uu____1794 = e_list e_string  in unembed uu____1794 l  in
             FStar_Util.bind_opt uu____1789
               (fun ss  ->
                  FStar_All.pipe_left
                    (fun _0_40  -> FStar_Pervasives_Native.Some _0_40)
                    (UnfoldFully ss))
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____1810::(a,uu____1812)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | uu____1849 ->
             (if w
              then
                (let uu____1863 =
                   let uu____1868 =
                     let uu____1869 = FStar_Syntax_Print.term_to_string t0
                        in
                     FStar_Util.format1 "Not an embedded norm_step: %s"
                       uu____1869
                      in
                   (FStar_Errors.Warning_NotEmbedded, uu____1868)  in
                 FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____1863)
              else ();
              FStar_Pervasives_Native.None))
     in
    ...
    | uu____1895 ->
        (if w
         then
           (let uu____1897 =
              let uu____1902 =
                let uu____1903 = FStar_Syntax_Print.term_to_string t0  in
                FStar_Util.format1 "Not an embedded range: %s" uu____1903  in
              (FStar_Errors.Warning_NotEmbedded, uu____1902)  in
            FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____1897)
         else ();
         FStar_Pervasives_Native.None)
     in
    ...
    fun eb  ->
      fun f  ->
        fun args  ->
          ...
          match args with
          | (x,uu____1957)::[] ->
              let uu____1974 = ua x  in
              FStar_Util.bind_opt uu____1974
                (fun a  ->
                   let uu____1980 =
                     let uu____1981 =
                       let uu____1982 =
                         let uu____1983 = ua x  in FStar_Util.must uu____1983
                          in
                       f uu____1982  in
                     eb1 FStar_Range.dummyRange uu____1981  in
                   FStar_Pervasives_Native.Some uu____1980)
          | uu____1986 -> FStar_Pervasives_Native.None
      ...
      fun ec  ->
        fun f  ->
          fun args  ->
            ...
            let ec1 = embed ec  in
            match args with
            | (x,uu____2060)::(y,uu____2062)::[] ->
                let uu____2089 = ua x  in
                FStar_Util.bind_opt uu____2089
                  (fun a  ->
                     let uu____2095 = ub y  in
                     FStar_Util.bind_opt uu____2095
                       (fun b  ->
                          let uu____2101 =
                            let uu____2102 = f a b  in
                            ec1 FStar_Range.dummyRange uu____2102  in
                          FStar_Pervasives_Native.Some uu____2101))
            | uu____2103 -> FStar_Pervasives_Native.None
        ...
        fun ed  ->
          fun f  ->
            fun args  ->
              ...
              let ed1 = embed ed  in
              match args with
              | (x,uu____2198)::(y,uu____2200)::(z,uu____2202)::[] ->
                  let uu____2239 = ua x  in
                  FStar_Util.bind_opt uu____2239
                    (fun a  ->
                       let uu____2245 = ub y  in
                       FStar_Util.bind_opt uu____2245
                         (fun b  ->
                            let uu____2251 = uc z  in
                            FStar_Util.bind_opt uu____2251
                              (fun c  ->
                                 let uu____2257 =
                                   let uu____2258 = f a b c  in
                                   ed1 FStar_Range.dummyRange uu____2258  in
                                 FStar_Pervasives_Native.Some uu____2257)))
              | uu____2259 -> FStar_Pervasives_Native.None
