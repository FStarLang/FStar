  ...
  fun ea ->
    let em rng o =
      ...
      | FStar_Pervasives_Native.Some a ->
          ...
          uu____556 FStar_Pervasives_Native.None rng in
    let un w t0 =
      let t = FStar_Syntax_Util.unmeta_safe t0 in
           ...
           | uu____724 ->
               (if w
                then
                  (let uu____738 =
                     let uu____743 =
                       let uu____744 = FStar_Syntax_Print.term_to_string t0 in
                ...
                FStar_Pervasives_Native.None)) in
    let uu____748 =
      let uu____749 = type_of ea in FStar_Syntax_Syntax.t_option_of uu____749 in
    ...
    fun eb ->
      let em rng x =
        let uu____795 =
          let uu____796 =
            let uu____797 =
              FStar_Syntax_Syntax.tdataconstr FStar_Parser_Const.lid_Mktuple2 in
        ...
        | (hd1, args) ->
            ...
            (match uu____881 with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                uu____913::uu____914::(a, uu____916)::(b, uu____918)::[])
                 when
...
let e_list : 'a . 'a embedding -> 'a Prims.list embedding =
  fun ea ->
    let em rng l =
      let t =
        let uu____1060 = type_of ea in FStar_Syntax_Syntax.iarg uu____1060 in
      let nil =
        let uu____1064 =
          let uu____1065 =
            let uu____1066 =
      ...
      FStar_List.fold_right
        (fun hd1 ->
           fun tail1 ->
             ...
             uu____1078 FStar_Pervasives_Native.None rng) l nil in
    let rec un w t0 =
      let t = FStar_Syntax_Util.unmeta_safe t0 in
      ...
      | (hd1, args) ->
          ...
          (match uu____1148 with
           | (FStar_Syntax_Syntax.Tm_fvar fv, uu____1178) when
               ...
               FStar_Pervasives_Native.Some []
           | (FStar_Syntax_Syntax.Tm_fvar fv,
              _t::(hd2, uu____1200)::(tl1, uu____1202)::[]) when
           ...
           | uu____1272 ->
               (if w
                then
                  (let uu____1286 =
                     let uu____1291 =
                       let uu____1292 = FStar_Syntax_Print.term_to_string t0 in
                ...
                FStar_Pervasives_Native.None)) in
    let uu____1296 =
      let uu____1297 = type_of ea in FStar_Syntax_Syntax.t_list_of uu____1297 in
...
let (uu___is_Simpl : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Simpl -> true | uu____1317 -> false
let (uu___is_Weak : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Weak -> true | uu____1321 -> false
let (uu___is_HNF : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | HNF -> true | uu____1325 -> false
let (uu___is_Primops : norm_step -> Prims.bool) =
  fun projectee ->
    match projectee with | Primops -> true | uu____1329 -> false
let (uu___is_Delta : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Delta -> true | uu____1333 -> false
let (uu___is_Zeta : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Zeta -> true | uu____1337 -> false
let (uu___is_Iota : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Iota -> true | uu____1341 -> false
let (uu___is_UnfoldOnly : norm_step -> Prims.bool) =
  fun projectee ->
    match projectee with | UnfoldOnly _0 -> true | uu____1348 -> false
let (__proj__UnfoldOnly__item___0 : norm_step -> Prims.string Prims.list) =
  fun projectee -> match projectee with | UnfoldOnly _0 -> _0
let (uu___is_UnfoldAttr : norm_step -> Prims.bool) =
  fun projectee ->
    match projectee with | UnfoldAttr _0 -> true | uu____1366 -> false
    ...
    | UnfoldOnly l ->
        let uu____1386 =
          let uu____1387 =
            let uu____1388 =
              let uu____1389 =
                let uu____1390 = e_list e_string in embed uu____1390 rng l in
              FStar_Syntax_Syntax.as_arg uu____1389 in
            [uu____1388] in
          FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldOnly uu____1387 in
        uu____1386 FStar_Pervasives_Native.None rng
    | UnfoldAttr a ->
        let uu____1400 =
          let uu____1401 =
            let uu____1402 = FStar_Syntax_Syntax.as_arg a in [uu____1402] in
          FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldAttr uu____1401 in
        uu____1400 FStar_Pervasives_Native.None rng in
  let un w t0 =
    let t = FStar_Syntax_Util.unmeta_safe t0 in
    let uu____1417 = FStar_Syntax_Util.head_and_args t in
    match uu____1417 with
    | (hd1, args) ->
        let uu____1456 =
          let uu____1469 =
            let uu____1470 = FStar_Syntax_Util.un_uinst hd1 in
        ...
        (match uu____1456 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv, (l, uu____1590)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Parser_Const.steps_unfoldonly
             ->
             let uu____1615 =
               let uu____1620 = e_list e_string in unembed uu____1620 l in
             FStar_Util.bind_opt uu____1615
               (fun ss ->
                  FStar_All.pipe_left
                    (fun _0_39 -> FStar_Pervasives_Native.Some _0_39)
                    (UnfoldOnly ss))
         | (FStar_Syntax_Syntax.Tm_fvar fv, uu____1636::(a, uu____1638)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | uu____1675 ->
             (if w
              then
                (let uu____1689 =
                   let uu____1694 =
                     let uu____1695 = FStar_Syntax_Print.term_to_string t0 in
                     FStar_Util.format1 "Not an embedded norm_step: %s"
                       uu____1695 in
                   (FStar_Errors.Warning_NotEmbedded, uu____1694) in
                 FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____1689)
              else ();
              FStar_Pervasives_Native.None)) in
    ...
    | uu____1721 ->
        (if w
         then
           (let uu____1723 =
              let uu____1728 =
                let uu____1729 = FStar_Syntax_Print.term_to_string t0 in
                FStar_Util.format1 "Not an embedded range: %s" uu____1729 in
              (FStar_Errors.Warning_NotEmbedded, uu____1728) in
            FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____1723)
         else ();
         FStar_Pervasives_Native.None) in
    ...
    fun eb ->
      fun f ->
        fun args ->
          ...
          match args with
          | (x, uu____1783)::[] ->
              let uu____1800 = ua x in
              FStar_Util.bind_opt uu____1800
                (fun a ->
                   let uu____1806 =
                     let uu____1807 =
                       let uu____1808 =
                         let uu____1809 = ua x in FStar_Util.must uu____1809 in
                       f uu____1808 in
                     eb1 FStar_Range.dummyRange uu____1807 in
                   FStar_Pervasives_Native.Some uu____1806)
      ...
      fun ec ->
        fun f ->
          fun args ->
            ...
            let ec1 = embed ec in
            match args with
            | (x, uu____1886)::(y, uu____1888)::[] ->
                let uu____1915 = ua x in
                FStar_Util.bind_opt uu____1915
                  (fun a ->
                     let uu____1921 = ub y in
                     FStar_Util.bind_opt uu____1921
                       (fun b ->
                          let uu____1927 =
                            let uu____1928 = f a b in
                            ec1 FStar_Range.dummyRange uu____1928 in
                          FStar_Pervasives_Native.Some uu____1927))
            | uu____1929 -> FStar_Pervasives_Native.None
let embed_arrow_3 :
  'a 'b 'c 'd .
    'a embedding ->
      'b embedding ->
        ...
        fun ed ->
          fun f ->
            fun args ->
              ...
              let ed1 = embed ed in
              match args with
              | (x, uu____2024)::(y, uu____2026)::(z, uu____2028)::[] ->
                  let uu____2065 = ua x in
                  FStar_Util.bind_opt uu____2065
                    (fun a ->
                       let uu____2071 = ub y in
                       FStar_Util.bind_opt uu____2071
                         (fun b ->
                            let uu____2077 = uc z in
                            FStar_Util.bind_opt uu____2077
                              (fun c ->
                                 let uu____2083 =
                                   let uu____2084 = f a b c in
                                   ed1 FStar_Range.dummyRange uu____2084 in
                                 FStar_Pervasives_Native.Some uu____2083)))
              | uu____2085 -> FStar_Pervasives_Native.None