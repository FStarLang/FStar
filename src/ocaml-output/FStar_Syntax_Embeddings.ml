...
let (embed_unit :
  ...
  fun rng ->
    fun u ->
      let uu___51_46 = FStar_Syntax_Util.exp_unit in
      {
        FStar_Syntax_Syntax.n = (uu___51_46.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___51_46.FStar_Syntax_Syntax.vars)
      }
let (__unembed_unit :
  Prims.bool ->
...
let (embed_bool :
  ...
  fun rng ->
    fun b ->
      ...
      let uu___52_101 = t in
      {
        FStar_Syntax_Syntax.n = (uu___52_101.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___52_101.FStar_Syntax_Syntax.vars)
      }
let (__unembed_bool :
  Prims.bool ->
...
let (embed_char :
  ...
  fun rng ->
    fun c ->
      ...
      let uu___53_154 = t in
      {
        FStar_Syntax_Syntax.n = (uu___53_154.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___53_154.FStar_Syntax_Syntax.vars)
      }
let (__unembed_char :
  Prims.bool ->
    FStar_Syntax_Syntax.term ->
...
let (embed_int :
  ...
  fun rng ->
    fun i ->
      ...
      let uu___54_210 = t in
      {
        FStar_Syntax_Syntax.n = (uu___54_210.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___54_210.FStar_Syntax_Syntax.vars)
      }
let (__unembed_int :
  Prims.bool ->
