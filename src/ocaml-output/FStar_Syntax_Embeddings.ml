...
let (e_unit : unit embedding) =
  let em rng u =
    let uu___53_418 = FStar_Syntax_Util.exp_unit in
    {
      FStar_Syntax_Syntax.n = (uu___53_418.FStar_Syntax_Syntax.n);
      FStar_Syntax_Syntax.pos = rng;
      FStar_Syntax_Syntax.vars = (uu___53_418.FStar_Syntax_Syntax.vars)
    } in
  let un w t0 =
...
let (e_bool : Prims.bool embedding) =
  let em rng b =
    ...
    let uu___54_468 = t in
    {
      FStar_Syntax_Syntax.n = (uu___54_468.FStar_Syntax_Syntax.n);
      FStar_Syntax_Syntax.pos = rng;
      FStar_Syntax_Syntax.vars = (uu___54_468.FStar_Syntax_Syntax.vars)
    } in
  let un w t0 =
...
let (e_char : FStar_Char.char embedding) =
  let em rng c =
    ...
    let uu___55_517 = t in
    {
      FStar_Syntax_Syntax.n = (uu___55_517.FStar_Syntax_Syntax.n);
      FStar_Syntax_Syntax.pos = rng;
      FStar_Syntax_Syntax.vars = (uu___55_517.FStar_Syntax_Syntax.vars)
    } in
  let un w t0 =
    let t = FStar_Syntax_Util.unmeta_safe t0 in
    match t.FStar_Syntax_Syntax.n with
...
let (e_int : FStar_BigInt.t embedding) =
  let em rng i =
    ...
    let uu___56_567 = t in
    {
      FStar_Syntax_Syntax.n = (uu___56_567.FStar_Syntax_Syntax.n);
      FStar_Syntax_Syntax.pos = rng;
      FStar_Syntax_Syntax.vars = (uu___56_567.FStar_Syntax_Syntax.vars)
    } in
  let un w t0 =
    let t = FStar_Syntax_Util.unmeta_safe t0 in
    match t.FStar_Syntax_Syntax.n with
  ...
  fun ea ->
    let em rng o =
      ...
      | FStar_Pervasives_Native.Some a ->
          ...
          uu____700 FStar_Pervasives_Native.None rng in
    let un w t0 =
      let t = FStar_Syntax_Util.unmeta_safe t0 in
           ...
           | uu____876 ->
               (if w
                then
                  (let uu____890 =
                     let uu____895 =
                       let uu____896 = FStar_Syntax_Print.term_to_string t0 in
                ...
                FStar_Pervasives_Native.None)) in
    let uu____900 =
      let uu____901 = type_of ea in FStar_Syntax_Syntax.t_option_of uu____901 in
        ...
        | (hd1, args) ->
            ...
            (match uu____1051 with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                uu____1083::uu____1084::(a, uu____1086)::(b, uu____1088)::[])
                 when
...
let e_list : 'a . 'a embedding -> 'a Prims.list embedding =
  fun ea ->
    let em rng l =
      let t =
        let uu____1237 = type_of ea in FStar_Syntax_Syntax.iarg uu____1237 in
      let nil =
        let uu____1241 =
          let uu____1246 =
            let uu____1247 =
      ...
      FStar_List.fold_right
        (fun hd1 ->
           fun tail1 ->
             ...
             uu____1259 FStar_Pervasives_Native.None rng) l nil in
    let rec un w t0 =
      let t = FStar_Syntax_Util.unmeta_safe t0 in
      ...
      | (hd1, args) ->
          ...
          (match uu____1337 with
           | (FStar_Syntax_Syntax.Tm_fvar fv, uu____1367) when
               ...
               FStar_Pervasives_Native.Some []
           | (FStar_Syntax_Syntax.Tm_fvar fv,
              (uu____1387, FStar_Pervasives_Native.Some
               (FStar_Syntax_Syntax.Implicit uu____1388))::(hd2,
                                                            FStar_Pervasives_Native.None)::
           ...
           | uu____1546 ->
               (if w
                ...
                FStar_Pervasives_Native.None)) in
    let uu____1570 =
      let uu____1571 = type_of ea in FStar_Syntax_Syntax.t_list_of uu____1571 in
...
let (uu___is_Simpl : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Simpl -> true | uu____1602 -> false
let (uu___is_Weak : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Weak -> true | uu____1608 -> false
...
let (uu___is_Delta : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Delta -> true | uu____1626 -> false
let (uu___is_Zeta : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Zeta -> true | uu____1632 -> false
let (uu___is_Iota : norm_step -> Prims.bool) =
  fun projectee -> match projectee with | Iota -> true | uu____1638 -> false
...
let (e_norm_step : norm_step embedding) =
  let em rng n1 =
    ...
    | UnfoldOnly l ->
        let uu____1713 =
          let uu____1718 =
            let uu____1719 =
              let uu____1720 =
                let uu____1721 = e_list e_string in embed uu____1721 rng l in
    ...
    | UnfoldFully l ->
        let uu____1733 =
          let uu____1738 =
            let uu____1739 =
              let uu____1740 =
                let uu____1741 = e_list e_string in embed uu____1741 rng l in
    ...
    | UnfoldAttr a ->
        let uu____1751 =
          let uu____1756 =
            let uu____1757 = FStar_Syntax_Syntax.as_arg a in [uu____1757] in
         ...
         | uu____2081 ->
             (if w
              then
                (let uu____2095 =
                   let uu____2100 =
                     let uu____2101 = FStar_Syntax_Print.term_to_string t0 in
              ...
              FStar_Util.bind_opt uu____2230
                (fun a ->
                   let uu____2236 =
                     let uu____2237 =
                       let uu____2238 =
                         let uu____2239 = ua x in FStar_Util.must uu____2239 in
                       f uu____2238 in
