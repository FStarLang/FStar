...
let embed_unit : FStar_Range.range -> Prims.unit -> FStar_Syntax_Syntax.term
  ...
  fun rng  ->
    fun u  ->
      let uu___117_26 = FStar_Syntax_Util.exp_unit  in
      {
        FStar_Syntax_Syntax.n = (uu___117_26.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___117_26.FStar_Syntax_Syntax.vars)
      }
...
let embed_bool : FStar_Range.range -> Prims.bool -> FStar_Syntax_Syntax.term
  ...
  fun rng  ->
    fun b  ->
      ...
      let uu___118_81 = t  in
      {
        FStar_Syntax_Syntax.n = (uu___118_81.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___118_81.FStar_Syntax_Syntax.vars)
      }
...
let embed_char :
  ...
  fun rng  ->
    fun c  ->
      ...
      let uu___119_134 = t  in
      {
        FStar_Syntax_Syntax.n = (uu___119_134.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___119_134.FStar_Syntax_Syntax.vars)
      }
...
let embed_int :
  ...
  fun rng  ->
    fun i  ->
      ...
      let uu___120_190 = t  in
      {
        FStar_Syntax_Syntax.n = (uu___120_190.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___120_190.FStar_Syntax_Syntax.vars)
      }
      ...
      | (hd1,args) ->
          ...
          (match uu____1604 with
           ...
           | (FStar_Syntax_Syntax.Tm_fvar fv,(l,uu____1738)::[]) when
               ...
               ->
               let uu____1763 =
                 let uu____1768 = unembed_list unembed_string  in
                 uu____1768 l  in
           ...
           then
             (let uu____1844 =
                let uu____1849 =
                  ...
                  FStar_Util.format1 "Not an embedded range: %s" uu____1850
                   in
