...
let embed_unit: FStar_Range.range -> Prims.unit -> FStar_Syntax_Syntax.term =
  fun rng  ->
    fun u  ->
      let uu___221_26 = FStar_Syntax_Util.exp_unit in
      {
        FStar_Syntax_Syntax.n = (uu___221_26.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___221_26.FStar_Syntax_Syntax.vars)
      }
let __unembed_unit:
  Prims.bool ->
...
let embed_bool: FStar_Range.range -> Prims.bool -> FStar_Syntax_Syntax.term =
  fun rng  ->
    fun b  ->
      ...
      let uu___222_76 = t in
      {
        FStar_Syntax_Syntax.n = (uu___222_76.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___222_76.FStar_Syntax_Syntax.vars)
      }
let __unembed_bool:
  Prims.bool ->
...
let embed_char:
  ...
  fun rng  ->
    fun c  ->
      ...
      let uu___223_122 = t in
      {
        FStar_Syntax_Syntax.n = (uu___223_122.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___223_122.FStar_Syntax_Syntax.vars)
      }
let __unembed_char:
  Prims.bool ->
...
let embed_int:
  ...
  fun rng  ->
    fun i  ->
      ...
      let uu___224_167 = t in
      {
        FStar_Syntax_Syntax.n = (uu___224_167.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___224_167.FStar_Syntax_Syntax.vars)
      }
let __unembed_int:
  Prims.bool ->
