        ...
        if w then
          let uu____44 =
            let uu____49 =
              ...
              FStar_Util.format1 "Not an embedded unit: %s" uu____50
            in
            (FStar_Errors.Warning_NotEmbedded, uu____49)
          in
...
let embed_bool : FStar_Range.range -> Prims.bool -> FStar_Syntax_Syntax.term =
  fun rng b ->
    let t =
      if b then FStar_Syntax_Util.exp_true_bool
        ...
        if w then
          let uu____100 =
            let uu____105 =
              ...
              FStar_Util.format1 "Not an embedded bool: %s" uu____106
            in
            (FStar_Errors.Warning_NotEmbedded, uu____105)
          in
        ...
        if w then
          let uu____154 =
            let uu____159 =
              ...
              FStar_Util.format1 "Not an embedded char: %s" uu____160
            in
            (FStar_Errors.Warning_NotEmbedded, uu____159)
          in
...
let embed_int : FStar_Range.range -> FStar_BigInt.t -> FStar_Syntax_Syntax.term =
  fun rng i ->
    let t =
      let uu____189 = FStar_BigInt.string_of_big_int i in
      FStar_Syntax_Util.exp_int uu____189
    in
...
let __unembed_int
    : Prims.bool -> FStar_Syntax_Syntax.term
      -> FStar_BigInt.t FStar_Pervasives_Native.option =
  fun w t0 ->
    let t = FStar_Syntax_Util.unmeta_safe t0 in
    match t.FStar_Syntax_Syntax.n with
        ...
        if w then
          let uu____221 =
            let uu____226 =
              ...
              FStar_Util.format1 "Not an embedded int: %s" uu____227
            in
            (FStar_Errors.Warning_NotEmbedded, uu____226)
          in
...
let __unembed_string
  ...
  fun w t0 ->
    let t = FStar_Syntax_Util.unmeta_safe t0 in
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_constant FStar_Const.Const_string (s, uu____266) ->
    ...
    | uu____267 ->
        if w then
          let uu____269 =
            ...
            in
            (FStar_Errors.Warning_NotEmbedded, uu____274)
          in
...
let embed_pair:
      'a 'b. 'a embedder -> FStar_Syntax_Syntax.typ -> 'b embedder
      -> FStar_Syntax_Syntax.typ
      -> ('a, 'b) FStar_Pervasives_Native.tuple2 embedder =
  fun embed_a t_a embed_b t_b rng x ->
    let uu____358 =
      let uu____359 =
        let uu____360 =
      ...
      let uu____361 =
        ...
        let uu____363 =
          ...
          let uu____367 =
            let uu____370 =
              let uu____371 = embed_a rng (FStar_Pervasives_Native.fst x) in
              FStar_Syntax_Syntax.as_arg uu____371
            in
            let uu____375 =
              let uu____378 =
                let uu____379 = embed_b rng (FStar_Pervasives_Native.snd x) in
                FStar_Syntax_Syntax.as_arg uu____379
              in
              [uu____378]
            in
            uu____370 :: uu____375
        ...
        uu____362 :: uu____363
      in
      FStar_Syntax_Syntax.mk_Tm_app uu____359 uu____361
    in
    uu____358 FStar_Pervasives_Native.None rng


let __unembed_pair:
      'a 'b. Prims.bool -> 'a unembedder -> 'b unembedder
      -> FStar_Syntax_Syntax.term
      -> ('a, 'b) FStar_Pervasives_Native.tuple2 FStar_Pervasives_Native.option =
  fun w unembed_a unembed_b t0 ->
    let t = FStar_Syntax_Util.unmeta_safe t0 in
    let uu____432 = FStar_Syntax_Util.head_and_args t in
    match uu____432 with hd1, args ->
      let uu____475 =
        let uu____488 =
      ...
      | ( FStar_Syntax_Syntax.Tm_fvar fv
        , [uu____507; uu____508; (a, uu____510); (b, uu____512)] )
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.lid_Mktuple2 ->
          let uu____571 = unembed_a a in
          FStar_Util.bind_opt uu____571 (fun a1 ->
              let uu____583 = unembed_b b in
              FStar_Util.bind_opt uu____583 (fun b1 ->
                  FStar_Pervasives_Native.Some (a1, b1) ) )
      | uu____598 ->
          if w then
            let uu____612 =
              let uu____617 =
                let uu____618 = FStar_Syntax_Print.term_to_string t0 in
                FStar_Util.format1 "Not an embedded pair: %s" uu____618
              in
              (FStar_Errors.Warning_NotEmbedded, uu____617)
            in
            FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____612
          else () ;
          FStar_Pervasives_Native.None


let unembed_pair:
      'a 'b. 'a unembedder -> 'b unembedder
      -> ('a, 'b) FStar_Pervasives_Native.tuple2 unembedder =
  fun ul ur t -> __unembed_pair true ul ur t


let unembed_pair_safe:
      'a 'b. 'a unembedder -> 'b unembedder
      -> ('a, 'b) FStar_Pervasives_Native.tuple2 unembedder =
  fun ul ur t -> __unembed_pair false ul ur t


let embed_option:
      'a. 'a embedder -> FStar_Syntax_Syntax.typ
      -> 'a FStar_Pervasives_Native.option embedder =
  fun embed_a typ rng o ->
    match o with
    | FStar_Pervasives_Native.None ->
        let uu____769 =
          let uu____770 =
          ...
          let uu____772 =
            ...
            [uu____773]
          in
          FStar_Syntax_Syntax.mk_Tm_app uu____770 uu____772
        in
          ...
          let uu____780 =
            ...
            let uu____782 =
              let uu____785 =
                ...
                FStar_Syntax_Syntax.as_arg uu____786
              in
              [uu____785]
            in
            uu____781 :: uu____782
          in
          FStar_Syntax_Syntax.mk_Tm_app uu____778 uu____780
        in
        uu____777 FStar_Pervasives_Native.None rng


let __unembed_option:
      'a. Prims.bool -> 'a unembedder -> FStar_Syntax_Syntax.term
      -> 'a FStar_Pervasives_Native.option FStar_Pervasives_Native.option =
  fun w unembed_a t0 ->
    let t = FStar_Syntax_Util.unmeta_safe t0 in
    let uu____822 = FStar_Syntax_Util.head_and_args t in
    match uu____822 with hd1, args ->
      let uu____863 =
        let uu____876 =
          let uu____877 = FStar_Syntax_Util.un_uinst hd1 in
          uu____877.FStar_Syntax_Syntax.n
        in
        (uu____876, args)
      in
      match uu____863 with
      | FStar_Syntax_Syntax.Tm_fvar fv, uu____893
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.none_lid ->
          FStar_Pervasives_Native.Some FStar_Pervasives_Native.None
      | FStar_Syntax_Syntax.Tm_fvar fv, [uu____913; (a, uu____915)]
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.some_lid ->
          let uu____952 = unembed_a a in
          FStar_Util.bind_opt uu____952 (fun a1 ->
          ...
          if w then
            let uu____977 =
              let uu____982 =
                ...
                FStar_Util.format1 "Not an embedded option: %s" uu____983
              in
              (FStar_Errors.Warning_NotEmbedded, uu____982)
            in
            FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____977
          else () ;
          FStar_Pervasives_Native.None
...
let unembed_option:
  ...
  fun ua t -> __unembed_option true ua t


let unembed_option_safe:
      'a. 'a unembedder -> 'a FStar_Pervasives_Native.option unembedder =
  fun ua t -> __unembed_option false ua t


let rec embed_list:
          'a. 'a embedder -> FStar_Syntax_Syntax.typ -> 'a Prims.list embedder =
  fun embed_a typ rng l ->
    match l with
    | [] ->
        let uu____1088 =
          let uu____1089 =
          ...
          let uu____1091 =
            ...
            [uu____1092]
          in
          FStar_Syntax_Syntax.mk_Tm_app uu____1089 uu____1091
        in
          ...
          let uu____1102 =
            ...
            let uu____1104 =
              let uu____1107 =
                ...
                FStar_Syntax_Syntax.as_arg uu____1108
              in
              let uu____1112 =
                let uu____1115 =
                  let uu____1116 =
                ...
                [uu____1115]
              in
              uu____1107 :: uu____1112
            in
            uu____1103 :: uu____1104
          in
          FStar_Syntax_Syntax.mk_Tm_app uu____1100 uu____1102
        in
...
let rec __unembed_list:
  ...
  fun w unembed_a t0 ->
    ...
    match uu____1164 with hd1, args ->
      let uu____1205 =
        let uu____1218 =
          let uu____1219 = FStar_Syntax_Util.un_uinst hd1 in
          uu____1219.FStar_Syntax_Syntax.n
        in
        (uu____1218, args)
      in
      match uu____1205 with
      | FStar_Syntax_Syntax.Tm_fvar fv, uu____1235
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid ->
          FStar_Pervasives_Native.Some []
      | ( FStar_Syntax_Syntax.Tm_fvar fv
        , [_t; (hd2, uu____1257); (tl1, uu____1259)] )
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid ->
          let uu____1306 = unembed_a hd2 in
          FStar_Util.bind_opt uu____1306 (fun hd3 ->
              let uu____1316 = __unembed_list w unembed_a tl1 in
              FStar_Util.bind_opt uu____1316 (fun tl2 ->
                  FStar_Pervasives_Native.Some (hd3 :: tl2) ) )
      | uu____1335 ->
          if w then
            let uu____1349 =
              let uu____1354 =
                let uu____1355 = FStar_Syntax_Print.term_to_string t0 in
                FStar_Util.format1 "Not an embedded list: %s" uu____1355
              in
              (FStar_Errors.Warning_NotEmbedded, uu____1354)
            in
            FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____1349
          else () ;
          FStar_Pervasives_Native.None


let unembed_list: 'a. 'a unembedder -> 'a Prims.list unembedder =
  fun ua t -> __unembed_list true ua t


let unembed_list_safe: 'a. 'a unembedder -> 'a Prims.list unembedder =
  fun ua t -> __unembed_list false ua t
...
let unembed_string_list
  ...
  fun t ->
    let uu____1451 = unembed_list unembed_string in
    uu____1451 t
...
let unembed_string_list_safe
    : FStar_Syntax_Syntax.term
      -> Prims.string Prims.list FStar_Pervasives_Native.option =
  fun t ->
    let uu____1467 = unembed_list_safe unembed_string_safe in
    uu____1467 t
...
let uu___is_Simpl : norm_step -> Prims.bool =
  fun projectee -> match projectee with Simpl -> true | uu____1487 -> false


let uu___is_Weak : norm_step -> Prims.bool =
  fun projectee -> match projectee with Weak -> true | uu____1491 -> false
...
let uu___is_Primops : norm_step -> Prims.bool =
  fun projectee -> match projectee with Primops -> true | uu____1499 -> false


let uu___is_Delta : norm_step -> Prims.bool =
  fun projectee -> match projectee with Delta -> true | uu____1503 -> false


let uu___is_Zeta : norm_step -> Prims.bool =
  fun projectee -> match projectee with Zeta -> true | uu____1507 -> false


let uu___is_Iota : norm_step -> Prims.bool =
  fun projectee -> match projectee with Iota -> true | uu____1511 -> false
        ...
        let uu____1556 =
          let uu____1557 =
            let uu____1558 =
              let uu____1559 =
                let uu____1560 =
                  embed_list embed_string FStar_Syntax_Syntax.t_string
                in
                uu____1560 rng l
              in
              FStar_Syntax_Syntax.as_arg uu____1559
            in
            [uu____1558]
          in
          FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldOnly uu____1557
        in
        uu____1556 FStar_Pervasives_Native.None rng
    | UnfoldAttr a ->
        let uu____1571 =
          let uu____1572 =
            let uu____1573 = FStar_Syntax_Syntax.as_arg a in
            [uu____1573]
          in
          FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldAttr uu____1572
        in
...
let __unembed_norm_step
    : Prims.bool -> FStar_Syntax_Syntax.term
      -> norm_step FStar_Pervasives_Native.option =
  fun w t0 ->
    let t = FStar_Syntax_Util.unmeta_safe t0 in
    let uu____1587 = FStar_Syntax_Util.head_and_args t in
    match uu____1587 with hd1, args ->
      let uu____1626 =
        let uu____1639 =
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv, []
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.steps_simpl ->
          FStar_Pervasives_Native.Some Simpl
      | FStar_Syntax_Syntax.Tm_fvar fv, []
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.steps_weak ->
          FStar_Pervasives_Native.Some Weak
      | FStar_Syntax_Syntax.Tm_fvar fv, []
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.steps_hnf ->
          FStar_Pervasives_Native.Some HNF
      | FStar_Syntax_Syntax.Tm_fvar fv, []
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.steps_primops ->
          FStar_Pervasives_Native.Some Primops
      | FStar_Syntax_Syntax.Tm_fvar fv, []
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.steps_delta ->
          FStar_Pervasives_Native.Some Delta
      | FStar_Syntax_Syntax.Tm_fvar fv, []
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.steps_zeta ->
          FStar_Pervasives_Native.Some Zeta
      | FStar_Syntax_Syntax.Tm_fvar fv, []
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.steps_iota ->
          FStar_Pervasives_Native.Some Iota
      | FStar_Syntax_Syntax.Tm_fvar fv, [(l, uu____1760)]
        when FStar_Syntax_Syntax.fv_eq_lid fv
          ...
          let uu____1785 =
            ...
            uu____1790 l
          in
          FStar_Util.bind_opt uu____1785 (fun ss ->
              FStar_All.pipe_left
                (fun _0_39 -> FStar_Pervasives_Native.Some _0_39)
                (UnfoldOnly ss) )
      | FStar_Syntax_Syntax.Tm_fvar fv, [uu____1806; (a, uu____1808)]
        when FStar_Syntax_Syntax.fv_eq_lid fv
          ...
          if w then
            let uu____1859 =
              let uu____1864 =
                ...
                FStar_Util.format1 "Not an embedded norm_step: %s" uu____1865
              in
              (FStar_Errors.Warning_NotEmbedded, uu____1864)
            in
            FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____1859
          else () ;
          FStar_Pervasives_Native.None
    ...
    | uu____1904 ->
        if w then
          let uu____1906 =
            ...
            in
            (FStar_Errors.Warning_NotEmbedded, uu____1911)
          in
