...
let embed_unit: FStar_Range.range -> Prims.unit -> FStar_Syntax_Syntax.term =
  fun rng  ->
    fun u  ->
      let uu___235_28 = FStar_Syntax_Util.exp_unit in
      {
        FStar_Syntax_Syntax.n = (uu___235_28.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___235_28.FStar_Syntax_Syntax.vars)
      }
let __unembed_unit:
  Prims.bool ->
...
let embed_bool: FStar_Range.range -> Prims.bool -> FStar_Syntax_Syntax.term =
  fun rng  ->
    fun b  ->
      ...
      let uu___236_84 = t in
      {
        FStar_Syntax_Syntax.n = (uu___236_84.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___236_84.FStar_Syntax_Syntax.vars)
      }
let __unembed_bool:
  Prims.bool ->
...
let embed_char:
  ...
  fun rng  ->
    fun c  ->
      ...
      let uu___237_136 = t in
      {
        FStar_Syntax_Syntax.n = (uu___237_136.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___237_136.FStar_Syntax_Syntax.vars)
      }
let __unembed_char:
  Prims.bool ->
...
let embed_int:
  ...
  fun rng  ->
    fun i  ->
      ...
      let uu___238_187 = t in
      {
        FStar_Syntax_Syntax.n = (uu___238_187.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___238_187.FStar_Syntax_Syntax.vars)
      }
let __unembed_int:
  Prims.bool ->
