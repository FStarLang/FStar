...
let set_type : 'a . FStar_Syntax_Syntax.typ -> 'a embedding -> 'a embedding =
  fun ty  ->
    fun e  ->
      let uu___219_1522 = e  in
      {
        em = (uu___219_1522.em);
        un = (uu___219_1522.un);
        typ = ty;
        print = (uu___219_1522.print);
        emb_typ = (uu___219_1522.emb_typ)
      }
...
let (e_unit : unit embedding) =
  let em u rng _topt _norm =
    let uu___220_2321 = FStar_Syntax_Util.exp_unit  in
    {
      FStar_Syntax_Syntax.n = (uu___220_2321.FStar_Syntax_Syntax.n);
      FStar_Syntax_Syntax.pos = rng;
      FStar_Syntax_Syntax.vars = (uu___220_2321.FStar_Syntax_Syntax.vars)
    }  in
  let un t0 w _norm =
...
let (e_bool : Prims.bool embedding) =
  let em b rng _topt _norm =
    ...
    let uu___221_2463 = t  in
    {
      FStar_Syntax_Syntax.n = (uu___221_2463.FStar_Syntax_Syntax.n);
      FStar_Syntax_Syntax.pos = rng;
      FStar_Syntax_Syntax.vars = (uu___221_2463.FStar_Syntax_Syntax.vars)
    }  in
  let un t0 w _norm =
...
let (e_char : FStar_Char.char embedding) =
  let em c rng _topt _norm =
    ...
    let uu___222_2605 = t  in
    {
      FStar_Syntax_Syntax.n = (uu___222_2605.FStar_Syntax_Syntax.n);
      FStar_Syntax_Syntax.pos = rng;
      FStar_Syntax_Syntax.vars = (uu___222_2605.FStar_Syntax_Syntax.vars)
    }  in
  let un t0 w _norm =
    let t = FStar_Syntax_Util.unmeta_safe t0  in
    match t.FStar_Syntax_Syntax.n with
...
let e_option :
  ...
  fun ea  ->
    ...
    let printer uu___218_3055 =
      match uu___218_3055 with
      | FStar_Pervasives_Native.None  -> "None"
