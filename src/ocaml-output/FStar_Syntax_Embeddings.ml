...
let embed_char:
  ...
  fun rng  ->
    fun c  ->
      ...
      let uu___215_136 = t in
      {
        FStar_Syntax_Syntax.n = (uu___215_136.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___215_136.FStar_Syntax_Syntax.vars)
      }
let __unembed_char:
  Prims.bool ->
...
let embed_int: FStar_Range.range -> Prims.int -> FStar_Syntax_Syntax.term =
  fun rng  ->
    fun i  ->
      ...
      let uu___216_187 = t in
      {
        FStar_Syntax_Syntax.n = (uu___216_187.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___216_187.FStar_Syntax_Syntax.vars)
      }
let __unembed_int:
  Prims.bool ->
