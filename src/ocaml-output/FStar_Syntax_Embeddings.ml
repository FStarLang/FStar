...
let embed_unit: FStar_Range.range -> Prims.unit -> FStar_Syntax_Syntax.term =
  fun rng  ->
    fun u  ->
      let uu___261_26 = FStar_Syntax_Util.exp_unit in
      {
        FStar_Syntax_Syntax.n = (uu___261_26.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___261_26.FStar_Syntax_Syntax.vars)
      }
let __unembed_unit:
  Prims.bool ->
...
let embed_bool: FStar_Range.range -> Prims.bool -> FStar_Syntax_Syntax.term =
  fun rng  ->
    fun b  ->
      ...
      let uu___262_76 = t in
      {
        FStar_Syntax_Syntax.n = (uu___262_76.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___262_76.FStar_Syntax_Syntax.vars)
      }
let __unembed_bool:
  Prims.bool ->
...
let embed_char:
  ...
  fun rng  ->
    fun c  ->
      ...
      let uu___263_122 = t in
      {
        FStar_Syntax_Syntax.n = (uu___263_122.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___263_122.FStar_Syntax_Syntax.vars)
      }
let __unembed_char:
  Prims.bool ->
...
let embed_int:
  ...
  fun rng  ->
    fun i  ->
      ...
      let uu___264_167 = t in
      {
        FStar_Syntax_Syntax.n = (uu___264_167.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___264_167.FStar_Syntax_Syntax.vars)
      }
let __unembed_int:
  Prims.bool ->
          ...
          | [] ->
              let uu____1045 =
                let uu____1046 =
                  ...
                  FStar_Syntax_Syntax.mk_Tm_uinst uu____1047
                    [FStar_Syntax_Syntax.U_zero] in
                let uu____1048 =
                  let uu____1049 = FStar_Syntax_Syntax.iarg typ in
                  [uu____1049] in
                FStar_Syntax_Syntax.mk_Tm_app uu____1046 uu____1048 in
              uu____1045 FStar_Pervasives_Native.None rng
          | hd1::tl1 ->
              let uu____1056 =
                let uu____1057 =
                  let uu____1058 =
                  ...
                  FStar_Syntax_Syntax.mk_Tm_uinst uu____1058
                    [FStar_Syntax_Syntax.U_zero] in
                let uu____1059 =
                  let uu____1060 = FStar_Syntax_Syntax.iarg typ in
                  let uu____1061 =
                    let uu____1064 =
                      let uu____1065 = embed_a rng hd1 in
                      FStar_Syntax_Syntax.as_arg uu____1065 in
                    let uu____1069 =
                      let uu____1072 =
                        let uu____1073 =
                          let uu____1074 = embed_list embed_a typ in
                          uu____1074 rng tl1 in
                        FStar_Syntax_Syntax.as_arg uu____1073 in
                      [uu____1072] in
                    uu____1064 :: uu____1069 in
                  uu____1060 :: uu____1061 in
                FStar_Syntax_Syntax.mk_Tm_app uu____1057 uu____1059 in
              uu____1056 FStar_Pervasives_Native.None rng
let rec __unembed_list:
  ...
  fun w  ->
    fun unembed_a  ->
      fun t0  ->
        let t = FStar_Syntax_Util.unmeta_safe t0 in
        let uu____1121 = FStar_Syntax_Util.head_and_args t in
        match uu____1121 with
        | (hd1,args) ->
            let uu____1162 =
              let uu____1175 =
                let uu____1176 = FStar_Syntax_Util.un_uinst hd1 in
                uu____1176.FStar_Syntax_Syntax.n in
              (uu____1175, args) in
            (match uu____1162 with
             | (FStar_Syntax_Syntax.Tm_fvar fv,uu____1192) when
                 FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid
                 -> FStar_Pervasives_Native.Some []
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,_t::(hd2,uu____1214)::(tl1,uu____1216)::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid
                 ->
                 let uu____1263 = unembed_a hd2 in
                 FStar_Util.bind_opt uu____1263
                   (fun hd3  ->
                      let uu____1273 = __unembed_list w unembed_a tl1 in
             ...
             | uu____1292 ->
                 (if w
                  then
                    (let uu____1306 =
                       let uu____1307 = FStar_Syntax_Print.term_to_string t0 in
                       FStar_Util.format1 "Not an embedded list: %s"
                         uu____1307 in
                     FStar_Errors.warn t0.FStar_Syntax_Syntax.pos uu____1306)
                  else ();
                  FStar_Pervasives_Native.None))
...
let embed_string_list:
  ...
  fun rng  ->
    fun ss  ->
      let uu____1386 = embed_list embed_string FStar_Syntax_Syntax.t_string in
      uu____1386 rng ss
let unembed_string_list:
  FStar_Syntax_Syntax.term ->
    Prims.string Prims.list FStar_Pervasives_Native.option
  = fun t  -> let uu____1403 = unembed_list unembed_string in uu____1403 t
let unembed_string_list_safe:
  FStar_Syntax_Syntax.term ->
    Prims.string Prims.list FStar_Pervasives_Native.option
  =
  fun t  ->
    let uu____1419 = unembed_list_safe unembed_string_safe in uu____1419 t
type norm_step =
  | Simpl
  | Weak
  | HNF
...
let uu___is_Simpl: norm_step -> Prims.bool =
  fun projectee  ->
    match projectee with | Simpl  -> true | uu____1435 -> false
let uu___is_Weak: norm_step -> Prims.bool =
  fun projectee  ->
    match projectee with | Weak  -> true | uu____1439 -> false
let uu___is_HNF: norm_step -> Prims.bool =
  fun projectee  -> match projectee with | HNF  -> true | uu____1443 -> false
let uu___is_Primops: norm_step -> Prims.bool =
  fun projectee  ->
    match projectee with | Primops  -> true | uu____1447 -> false
let uu___is_Delta: norm_step -> Prims.bool =
  fun projectee  ->
    match projectee with | Delta  -> true | uu____1451 -> false
let uu___is_Zeta: norm_step -> Prims.bool =
  fun projectee  ->
    match projectee with | Zeta  -> true | uu____1455 -> false
let uu___is_Iota: norm_step -> Prims.bool =
  fun projectee  ->
    match projectee with | Iota  -> true | uu____1459 -> false
let uu___is_UnfoldOnly: norm_step -> Prims.bool =
  fun projectee  ->
    match projectee with | UnfoldOnly _0 -> true | uu____1466 -> false
            ...
            let uu____1493 =
              let uu____1494 =
                let uu____1495 =
                  ...
                  uu____1496 rng l in
                FStar_Syntax_Syntax.as_arg uu____1495 in
              [uu____1494] in
            FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldOnly uu____1493 in
          uu____1492 FStar_Pervasives_Native.None rng
let __unembed_norm_step:
  ...
  fun w  ->
    fun t0  ->
      let t = FStar_Syntax_Util.unmeta_safe t0 in
      let uu____1517 = FStar_Syntax_Util.head_and_args t in
      match uu____1517 with
      | (hd1,args) ->
          let uu____1556 =
            let uu____1569 =
              let uu____1570 = FStar_Syntax_Util.un_uinst hd1 in
          ...
          (match uu____1556 with
           ...
           | (FStar_Syntax_Syntax.Tm_fvar fv,(l,uu____1690)::[]) when
               FStar_Syntax_Syntax.fv_eq_lid fv
                 FStar_Parser_Const.steps_unfoldonly
               ->
               let uu____1715 =
                 let uu____1720 = unembed_list unembed_string in uu____1720 l in
           ...
           | uu____1735 ->
               (if w
                then
                  (let uu____1749 =
                     let uu____1750 = FStar_Syntax_Print.term_to_string t0 in
                     FStar_Util.format1 "Not an embedded norm_step: %s"
                       uu____1750 in
                   FStar_Errors.warn t0.FStar_Syntax_Syntax.pos uu____1749)
                else ();
                FStar_Pervasives_Native.None))
    ...
    fun t0  ->
      ...
      | uu____1789 ->
          (if w
           then
             (let uu____1791 =
                let uu____1792 = FStar_Syntax_Print.term_to_string t0 in
                FStar_Util.format1 "Not an embedded range: %s" uu____1792 in
              FStar_Errors.warn t0.FStar_Syntax_Syntax.pos uu____1791)
           else ();
           FStar_Pervasives_Native.None)
let unembed_range:
  FStar_Syntax_Syntax.term ->
