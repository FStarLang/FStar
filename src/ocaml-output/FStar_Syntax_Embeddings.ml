...
let uu____845 = (FStar_Syntax_Util.un_uinst hd1)
in uu____845.FStar_Syntax_Syntax.n)
in ((uu____844), (args)))
in (match (uu____833) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____859) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.none_lid) -> begin
FStar_Pervasives_Native.Some (FStar_Pervasives_Native.None)
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____875)::((a, uu____877))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.some_lid) -> begin
(

let uu____900 = (unembed ea a)
in (FStar_Util.bind_opt uu____900 (fun a1 -> FStar_Pervasives_Native.Some (FStar_Pervasives_Native.Some (a1)))))
end
| uu____909 -> begin
((match (w) with
| true -> begin
...
in (FStar_Util.format1 "Not an embedded option: %s" uu____927))
in ((FStar_Errors.Warning_NotEmbedded), (uu____926)))
in (FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____921))
end
| uu____928 -> begin
()
end);
...
let uu____932 = (type_of ea)
in (FStar_Syntax_Syntax.t_option_of uu____932))
in (mk_emb em un uu____931)))))
...
let uu____994 = (FStar_Syntax_Syntax.tdataconstr FStar_Parser_Const.lid_Mktuple2)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____994 ((FStar_Syntax_Syntax.U_zero)::(FStar_Syntax_Syntax.U_zero)::[])))
in (
...
let uu____1003 = (type_of ea)
in (FStar_Syntax_Syntax.iarg uu____1003))
in (
...
let uu____1020 = (type_of eb)
in (FStar_Syntax_Syntax.iarg uu____1020))
in (
...
let uu____1037 = (embed ea rng (FStar_Pervasives_Native.fst x))
in (FStar_Syntax_Syntax.as_arg uu____1037))
in (
...
let uu____1054 = (embed eb rng (FStar_Pervasives_Native.snd x))
in (FStar_Syntax_Syntax.as_arg uu____1054))
in (uu____1047)::[])
in (uu____1030)::uu____1038))
in (uu____1013)::uu____1021))
in (uu____996)::uu____1004))
in (FStar_Syntax_Syntax.mk_Tm_app uu____993 uu____995)))
in (uu____988 FStar_Pervasives_Native.None rng)))
in (
...
let uu____1111 = (FStar_Syntax_Util.head_and_args t)
...
let uu____1166 = (FStar_Syntax_Util.un_uinst hd1)
in uu____1166.FStar_Syntax_Syntax.n)
in ((uu____1165), (args)))
in (match (uu____1154) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____1182)::(uu____1183)::((a, uu____1185))::((b, uu____1187))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.lid_Mktuple2) -> begin
(

let uu____1222 = (unembed ea a)
in (FStar_Util.bind_opt uu____1222 (fun a1 -> (

let uu____1232 = (unembed eb b)
in (FStar_Util.bind_opt uu____1232 (fun b1 -> FStar_Pervasives_Native.Some (((a1), (b1)))))))))
end
| uu____1245 -> begin
((match (w) with
| true -> begin
...
let uu____1263 = (FStar_Syntax_Print.term_to_string t0)
in (FStar_Util.format1 "Not an embedded pair: %s" uu____1263))
in ((FStar_Errors.Warning_NotEmbedded), (uu____1262)))
in (FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____1257))
end
| uu____1264 -> begin
()
end);
...
let uu____1270 = (type_of ea)
in (

let uu____1271 = (type_of eb)
in (FStar_Syntax_Syntax.t_tuple2_of uu____1270 uu____1271)))
in (mk_emb em un uu____1269)))))
...
let uu____1310 = (type_of ea)
in (FStar_Syntax_Syntax.iarg uu____1310))
in (
...
let uu____1320 = (FStar_Syntax_Syntax.tdataconstr FStar_Parser_Const.nil_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____1320 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____1319 ((t)::[])))
in (uu____1314 FStar_Pervasives_Native.None rng))
in (

let cons1 = (

let uu____1336 = (FStar_Syntax_Syntax.tdataconstr FStar_Parser_Const.cons_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____1336 ((FStar_Syntax_Syntax.U_zero)::[])))
...
let uu____1366 = (embed ea rng hd1)
in (FStar_Syntax_Syntax.as_arg uu____1366))
in (

let uu____1367 = (

let uu____1376 = (FStar_Syntax_Syntax.as_arg tail1)
in (uu____1376)::[])
in (uu____1359)::uu____1367))
in (t)::uu____1350)
in (FStar_Syntax_Syntax.mk_Tm_app cons1 uu____1349))
in (uu____1344 FStar_Pervasives_Native.None rng))) l nil)))))
in (
...
let uu____1429 = (FStar_Syntax_Util.head_and_args t)
...
let uu____1482 = (FStar_Syntax_Util.un_uinst hd1)
in uu____1482.FStar_Syntax_Syntax.n)
in ((uu____1481), (args)))
in (match (uu____1470) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____1496) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid) -> begin
FStar_Pervasives_Native.Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_t)::((hd2, uu____1514))::((tl1, uu____1516))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid) -> begin
(

let uu____1543 = (unembed ea hd2)
in (FStar_Util.bind_opt uu____1543 (fun hd3 -> (

let uu____1551 = (un w tl1)
in (FStar_Util.bind_opt uu____1551 (fun tl2 -> FStar_Pervasives_Native.Some ((hd3)::tl2)))))))
end
| uu____1566 -> begin
((match (w) with
| true -> begin
...
in (FStar_Util.format1 "Not an embedded list: %s" uu____1584))
in ((FStar_Errors.Warning_NotEmbedded), (uu____1583)))
in (FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____1578))
end
| uu____1585 -> begin
()
end);
...
let uu____1589 = (type_of ea)
in (FStar_Syntax_Syntax.t_list_of uu____1589))
in (mk_emb em un uu____1588)))))
...
let uu____1745 = (e_list e_string)
in (embed uu____1745 rng l))
in (FStar_Syntax_Syntax.as_arg uu____1744))
in (uu____1737)::[])
in (FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldOnly uu____1736))
in (uu____1731 FStar_Pervasives_Native.None rng))
end
| UnfoldFully (l) -> begin
(
...
let uu____1783 = (e_list e_string)
in (embed uu____1783 rng l))
in (FStar_Syntax_Syntax.as_arg uu____1782))
in (uu____1775)::[])
in (FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldFully uu____1774))
in (uu____1769 FStar_Pervasives_Native.None rng))
end
| UnfoldAttr (a) -> begin
(
...
let uu____1811 = (FStar_Syntax_Syntax.as_arg a)
in (uu____1811)::[])
in (FStar_Syntax_Syntax.mk_Tm_app steps_UnfoldAttr uu____1810))
in (uu____1805 FStar_Pervasives_Native.None rng))
end))
in (
...
let uu____1848 = (FStar_Syntax_Util.head_and_args t)
...
let uu____1899 = (FStar_Syntax_Util.un_uinst hd1)
in uu____1899.FStar_Syntax_Syntax.n)
in ((uu____1898), (args)))
...
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((l, uu____1989))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.steps_unfoldonly) -> begin
(

let uu____2004 = (

let uu____2009 = (e_list e_string)
in (unembed uu____2009 l))
in (FStar_Util.bind_opt uu____2004 (fun ss -> (FStar_All.pipe_left (fun _0_16 -> FStar_Pervasives_Native.Some (_0_16)) (UnfoldOnly (ss))))))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((l, uu____2026))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.steps_unfoldfully) -> begin
(

let uu____2041 = (

let uu____2046 = (e_list e_string)
in (unembed uu____2046 l))
in (FStar_Util.bind_opt uu____2041 (fun ss -> (FStar_All.pipe_left (fun _0_17 -> FStar_Pervasives_Native.Some (_0_17)) (UnfoldFully (ss))))))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____2062)::((a, uu____2064))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.steps_unfoldattr) -> begin
...
in (FStar_Util.format1 "Not an embedded norm_step: %s" uu____2105))
in ((FStar_Errors.Warning_NotEmbedded), (uu____2104)))
in (FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____2099))
end
| uu____2106 -> begin
()
end);
...
let uu____2147 = (FStar_Syntax_Print.term_to_string t0)
in (FStar_Util.format1 "Not an embedded range: %s" uu____2147))
in ((FStar_Errors.Warning_NotEmbedded), (uu____2146)))
in (FStar_Errors.log_issue t0.FStar_Syntax_Syntax.pos uu____2141))
end
| uu____2148 -> begin
()
end);
...
let uu____2234 = (ua x)
in (FStar_Util.bind_opt uu____2234 (fun a -> (
...
let uu____2243 = (ua x)
in (FStar_Util.must uu____2243))
in (f uu____2242))
in (eb1 FStar_Range.dummyRange uu____2241))
in FStar_Pervasives_Native.Some (uu____2240)))))
end
| uu____2246 -> begin
FStar_Pervasives_Native.None
end))))
...
let ec1 = (embed ec)
in (match (args) with
| ((x, uu____2341))::((y, uu____2343))::[] -> begin
(

let uu____2370 = (ua x)
in (FStar_Util.bind_opt uu____2370 (fun a -> (

let uu____2376 = (ub y)
in (FStar_Util.bind_opt uu____2376 (fun b -> (

let uu____2382 = (

let uu____2383 = (f a b)
in (ec1 FStar_Range.dummyRange uu____2383))
...
let ed1 = (embed ed)
in (match (args) with
| ((x, uu____2505))::((y, uu____2507))::((z, uu____2509))::[] -> begin
(

let uu____2546 = (ua x)
in (FStar_Util.bind_opt uu____2546 (fun a -> (

let uu____2552 = (ub y)
in (FStar_Util.bind_opt uu____2552 (fun b -> (

let uu____2558 = (uc z)
in (FStar_Util.bind_opt uu____2558 (fun c -> (

let uu____2564 = (

let uu____2565 = (f a b c)
in (ed1 FStar_Range.dummyRange uu____2565))
