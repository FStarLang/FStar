    ...
    fun et  ->
      fun rng  ->
        fun ta  ->
          fun x  ->
            fun f  ->
              (let uu___1 = FStar_ST.op_Bang FStar_Options.debug_embedding
                  in
               if uu___1
               then
              ...
              (let uu___1 = FStar_ST.op_Bang FStar_Options.eager_embedding
                  in
               if uu___1
               then f ()
               else
            ...
            | FStar_Syntax_Syntax.Tm_lazy
                ...
                then
                  ...
                  ((let uu___4 =
                    ...
                    if uu___4
                    then
                      let uu___5 = FStar_Syntax_Print.emb_typ_to_string et
                         in
                      let uu___6 = FStar_Syntax_Print.emb_typ_to_string et'
                         in
                      let uu___7 =
                        match res with
                ...
                ((let uu___2 = FStar_ST.op_Bang FStar_Options.debug_embedding
                  ...
                  then
                    ...
                    let uu___5 =
                      ...
                      | FStar_Pervasives_Native.None  -> "None"
                      | FStar_Pervasives_Native.Some a1 ->
                          let uu___6 = pa a1  in Prims.op_Hat "Some " uu___6
                       in
                    FStar_Util.print3
                      "Unembedding:\n\temb_typ=%s\n\tterm is %s\n\tvalue is %s\n"
  ...
  let em i rng _topt _norm =
    lazy_embed FStar_BigInt.string_of_big_int emb_t_int rng t_int i
      (fun uu___  ->
         ...
         FStar_Syntax_Util.exp_int uu___1)
     in
  let un t0 w _norm =
    let t = FStar_Syntax_Util.unmeta_safe t0  in
  ...
  fun ea  ->
    let t_option_a =
      let t_opt = FStar_Syntax_Util.fvar_const FStar_Parser_Const.option_lid
         in
      let uu___ = let uu___1 = FStar_Syntax_Syntax.as_arg ea.typ  in [uu___1]
         in
    ...
    let printer1 uu___ =
      ...
      | FStar_Pervasives_Native.Some x ->
          let uu___1 = let uu___2 = ea.print x  in Prims.op_Hat uu___2 ")"
             in
          Prims.op_Hat "(Some " uu___1
       in
           ...
           | FStar_Pervasives_Native.Some a1 ->
               ...
               let uu___2 =
                 ...
                 let uu___4 =
                   let uu___5 =
                     let uu___6 =
                       let uu___7 = embed ea a1  in uu___7 rng shadow_a norm
                        in
               ...
               (match uu___1 with
                ...
                | (FStar_Syntax_Syntax.Tm_fvar fv,uu___2::(a1,uu___3)::[])
                    ...
                    FStar_Syntax_Syntax.fv_eq_lid fv
                      FStar_Parser_Const.some_lid
                    ->
                    let uu___4 = let uu___5 = unembed ea a1  in uu___5 w norm
                       in
                ...
                | uu___2 ->
                    (if w
                     then
                       (let uu___4 =
                          let uu___5 =
                            let uu___6 = FStar_Syntax_Print.term_to_string t0
                               in
          ...
          (fun uu___  ->
             let proj i ab =
               let proj_1 =
                 ...
                 FStar_Syntax_Util.mk_field_projector_name uu___1 uu___2 i
                  in
               let proj_1_tm =
                 let uu___1 =
               ...
               let uu___2 =
                 ...
                 let uu___4 =
                   ...
                   let uu___6 =
                     let uu___7 = FStar_Syntax_Syntax.as_arg ab  in [uu___7]
                      in
                   uu___5 :: uu___6  in
                 uu___3 :: uu___4  in
             ...
             let uu___2 =
               let uu___3 =
                 let uu___4 = type_of ea  in FStar_Syntax_Syntax.iarg uu___4
                  in
               let uu___4 =
                 let uu___5 =
                   let uu___6 = type_of eb  in
                 ...
                 let uu___6 =
                   let uu___7 =
                     let uu___8 =
                       let uu___9 = embed ea (FStar_Pervasives_Native.fst x)
                          in
             ...
             | (hd,args) ->
                 ...
                 (match uu___1 with
                  | (FStar_Syntax_Syntax.Tm_fvar
                     fv,uu___2::uu___3::(a1,uu___4)::(b1,uu___5)::[]) when
                      FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.lid_Mktuple2
                      ->
                      let uu___6 =
  ...
  fun ea  ->
    fun eb  ->
      let t_sum_a_b =
        ...
        let uu___ =
          ...
          let uu___2 =
            let uu___3 = FStar_Syntax_Syntax.as_arg eb.typ  in [uu___3]  in
          uu___1 :: uu___2  in
        FStar_Syntax_Syntax.mk_Tm_app t_either uu___ FStar_Range.dummyRange
         in
      let emb_t_sum_a_b =
        let uu___ =
          let uu___1 =
      ...
      let printer1 s =
        ...
        | FStar_Util.Inr b1 ->
            let uu___ = eb.print b1  in FStar_Util.format1 "Inr %s" uu___
         in
        ...
        lazy_unembed printer1 emb_t_sum_a_b t t_sum_a_b
          (fun t1  ->
             ...
             | (hd,args) ->
                 ...
                 (match uu___1 with
                  | (FStar_Syntax_Syntax.Tm_fvar
                     fv,uu___2::uu___3::(a1,uu___4)::[]) when
                      FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.inl_lid
                      ->
                      let uu___5 =
                  ...
                  | (FStar_Syntax_Syntax.Tm_fvar
                     fv,uu___2::uu___3::(b1,uu___4)::[]) when
                      FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.inr_lid
                      ->
                      let uu___5 =
  ...
  fun ea  ->
    ...
    let rec em l rng shadow_l norm =
      lazy_embed printer1 emb_t_list_a rng t_list_a l
        (fun uu___  ->
           let t =
             let uu___1 = type_of ea  in FStar_Syntax_Syntax.iarg uu___1  in
           match l with
           | [] ->
               let uu___1 =
                 let uu___2 =
           ...
           | hd::tl ->
               ...
               let uu___1 =
                 let uu___2 =
                   let uu___3 =
                     let uu___4 =
                       let uu___5 = embed ea hd  in uu___5 rng shadow_hd norm
                        in
                   ...
                   uu___3 :: uu___4  in
                 t :: uu___2  in
               FStar_Syntax_Syntax.mk_Tm_app cons uu___1 rng)
       in
               ...
               (match uu___1 with
                ...
                | (FStar_Syntax_Syntax.Tm_fvar
                   fv,(uu___2,FStar_Pervasives_Native.Some
                       (FStar_Syntax_Syntax.Implicit uu___3))::(hd1,FStar_Pervasives_Native.None
                    ...
                    ->
                    let uu___4 =
                      let uu___5 = unembed ea hd1  in uu___5 w norm  in
                    FStar_Util.bind_opt uu___4
                      (fun hd2  ->
                ...
                | (FStar_Syntax_Syntax.Tm_fvar
                   fv,(hd1,FStar_Pervasives_Native.None )::(tl,FStar_Pervasives_Native.None
                    ...
                    ->
                    let uu___2 =
                      let uu___3 = unembed ea hd1  in uu___3 w norm  in
...
let (e_norm_step : norm_step embedding) =
  let t_norm_step =
    let uu___ = FStar_Ident.lid_of_str "FStar.Syntax.Embeddings.norm_step"
       in
          ...
          (fun uu___  ->
             ...
             | FStar_Pervasives_Native.Some repr_f ->
                 ((let uu___3 =
                   ...
                   if uu___3
                   then
                     let uu___4 = FStar_Syntax_Print.term_to_string repr_f
                        in
                  ...
                  (let res = norm (FStar_Util.Inr repr_f)  in
                   (let uu___4 =
                    ...
                    if uu___4
                    then
                      let uu___5 = FStar_Syntax_Print.term_to_string repr_f
                         in
             ...
             let f_wrapped a1 =
               ...
               (let a_tm =
                ...
                let b_tm =
                  ...
                  norm uu___1  in
                let uu___1 = let uu___2 = unembed eb b_tm  in uu___2 w norm
                   in
                match uu___1 with
                | FStar_Pervasives_Native.None  ->
                     ...
                     | (x,uu___2) ->
                         let shadow_app =
                           let uu___3 =
                             FStar_Thunk.mk
                               (fun uu___4  ->
                                  let uu___5 = norm (FStar_Util.Inl fv_lid)
                                     in
                         ...
                         let uu___3 =
                           let uu___4 =
                             let uu___5 = unembed ea x  in uu___5 true norm
                              in
                           FStar_Util.map_opt uu___4
                             (fun x1  ->
                                let uu___5 =
                                  let uu___6 = f x1  in embed eb uu___6  in
                                uu___5 rng shadow_app norm)
                            in
                         (match uu___3 with
