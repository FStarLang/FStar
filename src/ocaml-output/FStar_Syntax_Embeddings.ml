...
let embed_unit: FStar_Range.range -> Prims.unit -> FStar_Syntax_Syntax.term =
  fun rng  ->
    fun u  ->
      let uu___118_26 = FStar_Syntax_Util.exp_unit in
      {
        FStar_Syntax_Syntax.n = (uu___118_26.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___118_26.FStar_Syntax_Syntax.vars)
      }
let __unembed_unit:
  Prims.bool ->
...
let embed_bool: FStar_Range.range -> Prims.bool -> FStar_Syntax_Syntax.term =
  fun rng  ->
    fun b  ->
      ...
      let uu___119_81 = t in
      {
        FStar_Syntax_Syntax.n = (uu___119_81.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___119_81.FStar_Syntax_Syntax.vars)
      }
let __unembed_bool:
  Prims.bool ->
...
let embed_char:
  ...
  fun rng  ->
    fun c  ->
      ...
      let uu___120_134 = t in
      {
        FStar_Syntax_Syntax.n = (uu___120_134.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___120_134.FStar_Syntax_Syntax.vars)
      }
let __unembed_char:
  Prims.bool ->
...
let embed_int:
  ...
  fun rng  ->
    fun i  ->
      ...
      let uu___121_190 = t in
      {
        FStar_Syntax_Syntax.n = (uu___121_190.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___121_190.FStar_Syntax_Syntax.vars)
      }
let __unembed_int:
  Prims.bool ->
