...
let embed_unit : FStar_Range.range -> Prims.unit -> FStar_Syntax_Syntax.term
  ...
  fun rng  ->
    fun u  ->
      let uu___116_26 = FStar_Syntax_Util.exp_unit  in
      {
        FStar_Syntax_Syntax.n = (uu___116_26.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___116_26.FStar_Syntax_Syntax.vars)
      }
...
let embed_bool : FStar_Range.range -> Prims.bool -> FStar_Syntax_Syntax.term
  ...
  fun rng  ->
    fun b  ->
      ...
      let uu___117_76 = t  in
      {
        FStar_Syntax_Syntax.n = (uu___117_76.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___117_76.FStar_Syntax_Syntax.vars)
      }
...
let embed_char :
  ...
  fun rng  ->
    fun c  ->
      ...
      let uu___118_124 = t  in
      {
        FStar_Syntax_Syntax.n = (uu___118_124.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___118_124.FStar_Syntax_Syntax.vars)
      }
...
let embed_int :
  ...
  fun rng  ->
    fun i  ->
      ...
      let uu___119_175 = t  in
      {
        FStar_Syntax_Syntax.n = (uu___119_175.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___119_175.FStar_Syntax_Syntax.vars)
      }
              ...
              (match uu____450 with
               ...
               | uu____573 ->
                   (if w
                    then
                      (let uu____587 =
                         let uu____588 = FStar_Syntax_Print.term_to_string t0
                            in
            ...
            (match uu____833 with
             ...
             | uu____933 ->
                 (if w
                  then
                    (let uu____947 =
                       let uu____948 = FStar_Syntax_Print.term_to_string t0
                          in
            ...
            (match uu____1170 with
             ...
             | uu____1300 ->
                 (if w
                  then
                    (let uu____1314 =
                       let uu____1315 = FStar_Syntax_Print.term_to_string t0
                          in
...
let embed_string_list :
  ...
  fun rng  ->
    fun ss  ->
      let uu____1394 = embed_list embed_string FStar_Syntax_Syntax.t_string
         in
      uu____1394 rng ss
      ...
      | (hd1,args) ->
          ...
          (match uu____1564 with
           ...
           | (FStar_Syntax_Syntax.Tm_fvar fv,(l,uu____1698)::[]) when
               ...
               ->
               let uu____1723 =
                 let uu____1728 = unembed_list unembed_string  in
                 uu____1728 l  in
           ...
           | uu____1743 ->
               (if w
                then
                  (let uu____1757 =
                     let uu____1758 = FStar_Syntax_Print.term_to_string t0
                        in
