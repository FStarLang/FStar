          ...
          let thunk =
            FStar_Common.mk_thunk
              (fun uu____184 ->
                 ...
                 FStar_TypeChecker_NBETerm.translate_cb cb uu____185) in
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.rng = uu____270;_},
         uu____271)
        ->
        let uu____290 = FStar_Dyn.undyn b in
        FStar_All.pipe_left (fun _0_16 -> FStar_Pervasives_Native.Some _0_16)
          uu____290
    | uu____293 ->
        ((let uu____295 =
            let uu____300 =
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.rng = uu____332;_},
         uu____333)
        ->
...
let (e_term_aq :
  ...
  fun aq ->
    ...
    let uu____490 = fv_as_emb_typ FStar_Reflection_Data.fstar_refl_term_fv in
    {
...
let (e_aqualv :
  ...
  let uu____621 = fv_as_emb_typ FStar_Reflection_Data.fstar_refl_aqualv_fv in
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.rng = uu____654;_},
         uu____655)
        ->
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.rng = uu____714;_},
         uu____715)
        ->
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.rng = uu____774;_},
         uu____775)
        ->
...
let (e_const :
  ...
  let unembed_const cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, [], (i, uu____950)::[]) when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, [], (s, uu____976)::[]) when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, [], (r, uu____1002)::[]) when
        FStar_Syntax_Syntax.fv_eq_lid fv
        ...
        let uu____1019 =
          FStar_TypeChecker_NBETerm.unembed FStar_TypeChecker_NBETerm.e_range
            cb r in
        FStar_Util.bind_opt uu____1019
          (fun r1 ->
             FStar_All.pipe_left
    ...
    | uu____1026 ->
        ((let uu____1028 =
            let uu____1033 =
              ...
              FStar_Util.format1 "Not an embedded vconst: %s" uu____1034 in
            (FStar_Errors.Warning_NotEmbedded, uu____1033) in
          FStar_Errors.log_issue FStar_Range.dummyRange uu____1028);
         FStar_Pervasives_Native.None) in
  ...
  fun uu____1041 ->
    let embed_pattern cb p =
      ...
      | FStar_Reflection_Data.Pat_Constant c ->
          let uu____1054 =
            let uu____1061 =
              let uu____1066 = FStar_TypeChecker_NBETerm.embed e_const cb c in
      ...
      | FStar_Reflection_Data.Pat_Cons (fv, ps) ->
          let uu____1081 =
            let uu____1088 =
              let uu____1093 = FStar_TypeChecker_NBETerm.embed e_fv cb fv in
              FStar_TypeChecker_NBETerm.as_arg uu____1093 in
            let uu____1094 =
              let uu____1101 =
                let uu____1106 =
                  let uu____1107 =
                    let uu____1112 = e_pattern' () in
                    FStar_TypeChecker_NBETerm.e_list uu____1112 in
                  FStar_TypeChecker_NBETerm.embed uu____1107 cb ps in
      ...
      | FStar_Reflection_Data.Pat_Var bv ->
          let uu____1130 =
            let uu____1137 =
              let uu____1142 = FStar_TypeChecker_NBETerm.embed e_bv cb bv in
      ...
      | FStar_Reflection_Data.Pat_Wild bv ->
          let uu____1152 =
            let uu____1159 =
              let uu____1164 = FStar_TypeChecker_NBETerm.embed e_bv cb bv in
              FStar_TypeChecker_NBETerm.as_arg uu____1164 in
            [uu____1159] in
          mkConstruct
      ...
      | FStar_Reflection_Data.Pat_Dot_Term (bv, t) ->
          let uu____1175 =
            let uu____1182 =
              let uu____1187 = FStar_TypeChecker_NBETerm.embed e_bv cb bv in
              FStar_TypeChecker_NBETerm.as_arg uu____1187 in
            let uu____1188 =
              let uu____1195 =
                let uu____1200 = FStar_TypeChecker_NBETerm.embed e_term cb t in
    ...
    let unembed_pattern cb t =
      match t with
      | FStar_TypeChecker_NBETerm.Construct (fv, [], (c, uu____1230)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Pat_Constant.FStar_Reflection_Data.lid
          ->
          let uu____1247 = FStar_TypeChecker_NBETerm.unembed e_const cb c in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, [], (ps, uu____1256)::(f, uu____1258)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Pat_Cons.FStar_Reflection_Data.lid
          ->
          let uu____1279 = FStar_TypeChecker_NBETerm.unembed e_fv cb f in
          FStar_Util.bind_opt uu____1279
            (fun f1 ->
               let uu____1285 =
                 let uu____1290 =
                   let uu____1295 = e_pattern' () in
                   FStar_TypeChecker_NBETerm.e_list uu____1295 in
                 FStar_TypeChecker_NBETerm.unembed uu____1290 cb ps in
               FStar_Util.bind_opt uu____1285
                 (fun ps1 ->
                    FStar_All.pipe_left
                      (fun _0_21 -> FStar_Pervasives_Native.Some _0_21)
                      (FStar_Reflection_Data.Pat_Cons (f1, ps1))))
      | FStar_TypeChecker_NBETerm.Construct (fv, [], (bv, uu____1312)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Pat_Var.FStar_Reflection_Data.lid
          ->
          let uu____1329 = FStar_TypeChecker_NBETerm.unembed e_bv cb bv in
          FStar_Util.bind_opt uu____1329
            (fun bv1 ->
               FStar_All.pipe_left
                 (fun _0_22 -> FStar_Pervasives_Native.Some _0_22)
                 (FStar_Reflection_Data.Pat_Var bv1))
      | FStar_TypeChecker_NBETerm.Construct (fv, [], (bv, uu____1338)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, [], (t1, uu____1364)::(bv, uu____1366)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Pat_Dot_Term.FStar_Reflection_Data.lid
          ->
          let uu____1387 = FStar_TypeChecker_NBETerm.unembed e_bv cb bv in
          FStar_Util.bind_opt uu____1387
            (fun bv1 ->
               let uu____1393 =
                 FStar_TypeChecker_NBETerm.unembed e_term cb t1 in
               FStar_Util.bind_opt uu____1393
                 (fun t2 ->
                    FStar_All.pipe_left
      ...
      | uu____1400 ->
          ((let uu____1402 =
              let uu____1407 =
                let uu____1408 = FStar_TypeChecker_NBETerm.t_to_string t in
                FStar_Util.format1 "Not an embedded pattern: %s" uu____1408 in
              (FStar_Errors.Warning_NotEmbedded, uu____1407) in
            FStar_Errors.log_issue FStar_Range.dummyRange uu____1402);
           FStar_Pervasives_Native.None) in
...
let (e_branch_aq :
  ...
  fun aq ->
    ...
    FStar_TypeChecker_NBETerm.e_tuple2 e_pattern uu____1442
let (e_argv_aq :
  (FStar_Syntax_Syntax.bv,
    FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax)
    FStar_Pervasives_Native.tuple2 Prims.list ->
  ...
  fun aq ->
    ...
    FStar_TypeChecker_NBETerm.e_tuple2 uu____1472 e_aqualv
let rec unlazy_as_t :
  'Auu____1481 .
    FStar_Syntax_Syntax.lazy_kind ->
      FStar_TypeChecker_NBETerm.t -> 'Auu____1481
  =
  fun k ->
    fun t ->
      match t with
      | FStar_TypeChecker_NBETerm.Lazy
          (FStar_Util.Inl
           { FStar_Syntax_Syntax.blob = v1; FStar_Syntax_Syntax.lkind = k';
             FStar_Syntax_Syntax.ltyp = uu____1494;
             FStar_Syntax_Syntax.rng = uu____1495;_},
           uu____1496)
  ...
  fun aq ->
    let embed_term_view cb tv =
      ...
      | FStar_Reflection_Data.Tv_FVar fv ->
          let uu____1551 =
            let uu____1558 =
              let uu____1563 = FStar_TypeChecker_NBETerm.embed e_fv cb fv in
              FStar_TypeChecker_NBETerm.as_arg uu____1563 in
            [uu____1558] in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_BVar bv ->
          let uu____1573 =
            let uu____1580 =
              let uu____1585 = FStar_TypeChecker_NBETerm.embed e_bv cb bv in
              FStar_TypeChecker_NBETerm.as_arg uu____1585 in
            [uu____1580] in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_Var bv ->
          let uu____1595 =
            let uu____1602 =
              let uu____1607 = FStar_TypeChecker_NBETerm.embed e_bv cb bv in
              FStar_TypeChecker_NBETerm.as_arg uu____1607 in
            [uu____1602] in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_App (hd1, a) ->
          let uu____1618 =
            let uu____1625 =
              let uu____1630 =
                let uu____1631 = e_term_aq aq in
                FStar_TypeChecker_NBETerm.embed uu____1631 cb hd1 in
              FStar_TypeChecker_NBETerm.as_arg uu____1630 in
            let uu____1634 =
              let uu____1641 =
                let uu____1646 =
                  let uu____1647 = e_argv_aq aq in
                  FStar_TypeChecker_NBETerm.embed uu____1647 cb a in
                FStar_TypeChecker_NBETerm.as_arg uu____1646 in
              [uu____1641] in
            uu____1625 :: uu____1634 in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_Abs (b, t) ->
          let uu____1672 =
            let uu____1679 =
              let uu____1684 = FStar_TypeChecker_NBETerm.embed e_binder cb b in
              FStar_TypeChecker_NBETerm.as_arg uu____1684 in
            let uu____1685 =
              let uu____1692 =
                let uu____1697 =
                  let uu____1698 = e_term_aq aq in
                  FStar_TypeChecker_NBETerm.embed uu____1698 cb t in
                FStar_TypeChecker_NBETerm.as_arg uu____1697 in
              [uu____1692] in
            uu____1679 :: uu____1685 in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_Arrow (b, c) ->
          let uu____1715 =
            let uu____1722 =
              let uu____1727 = FStar_TypeChecker_NBETerm.embed e_binder cb b in
              FStar_TypeChecker_NBETerm.as_arg uu____1727 in
            let uu____1728 =
              let uu____1735 =
                let uu____1740 = FStar_TypeChecker_NBETerm.embed e_comp cb c in
                FStar_TypeChecker_NBETerm.as_arg uu____1740 in
              [uu____1735] in
            uu____1722 :: uu____1728 in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_Type u ->
          let uu____1754 =
            let uu____1761 =
              ...
              FStar_TypeChecker_NBETerm.as_arg uu____1766 in
            [uu____1761] in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_Refine (bv, t) ->
          let uu____1777 =
            let uu____1784 =
              let uu____1789 = FStar_TypeChecker_NBETerm.embed e_bv cb bv in
              FStar_TypeChecker_NBETerm.as_arg uu____1789 in
            let uu____1790 =
              let uu____1797 =
                let uu____1802 =
                  let uu____1803 = e_term_aq aq in
                  FStar_TypeChecker_NBETerm.embed uu____1803 cb t in
                FStar_TypeChecker_NBETerm.as_arg uu____1802 in
              [uu____1797] in
            uu____1784 :: uu____1790 in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_Const c ->
          let uu____1819 =
            let uu____1826 =
              let uu____1831 = FStar_TypeChecker_NBETerm.embed e_const cb c in
              FStar_TypeChecker_NBETerm.as_arg uu____1831 in
            [uu____1826] in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_Uvar (u, d) ->
          let uu____1842 =
            let uu____1849 =
              ...
              FStar_TypeChecker_NBETerm.as_arg uu____1854 in
            let uu____1855 =
              let uu____1862 =
                let uu____1867 =
                  mk_lazy cb (u, d) FStar_Syntax_Util.t_ctx_uvar_and_sust
                    FStar_Syntax_Syntax.Lazy_uvar in
                FStar_TypeChecker_NBETerm.as_arg uu____1867 in
              [uu____1862] in
            uu____1849 :: uu____1855 in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_Let (r, b, t1, t2) ->
          let uu____1888 =
            let uu____1895 =
              ...
              FStar_TypeChecker_NBETerm.as_arg uu____1900 in
            let uu____1901 =
              let uu____1908 =
                let uu____1913 = FStar_TypeChecker_NBETerm.embed e_bv cb b in
                FStar_TypeChecker_NBETerm.as_arg uu____1913 in
              let uu____1914 =
                let uu____1921 =
                  let uu____1926 =
                    let uu____1927 = e_term_aq aq in
                    FStar_TypeChecker_NBETerm.embed uu____1927 cb t1 in
                  FStar_TypeChecker_NBETerm.as_arg uu____1926 in
                let uu____1930 =
                  let uu____1937 =
                    let uu____1942 =
                      let uu____1943 = e_term_aq aq in
                      FStar_TypeChecker_NBETerm.embed uu____1943 cb t2 in
                    FStar_TypeChecker_NBETerm.as_arg uu____1942 in
                  [uu____1937] in
                uu____1921 :: uu____1930 in
              uu____1908 :: uu____1914 in
            uu____1895 :: uu____1901 in
          mkConstruct
          ...
          let uu____1972 =
            ...
            let uu____1988 =
              let uu____1995 =
                let uu____2000 =
                  let uu____2001 =
                    let uu____2010 = e_branch_aq aq in
                    FStar_TypeChecker_NBETerm.e_list uu____2010 in
                  FStar_TypeChecker_NBETerm.embed uu____2001 cb brs in
                FStar_TypeChecker_NBETerm.as_arg uu____2000 in
              [uu____1995] in
            uu____1979 :: uu____1988 in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_AscribedT (e, t, tacopt) ->
          let uu____2046 =
            let uu____2053 =
              let uu____2058 =
                let uu____2059 = e_term_aq aq in
                FStar_TypeChecker_NBETerm.embed uu____2059 cb e in
              FStar_TypeChecker_NBETerm.as_arg uu____2058 in
            let uu____2062 =
              let uu____2069 =
                let uu____2074 =
                  let uu____2075 = e_term_aq aq in
                  FStar_TypeChecker_NBETerm.embed uu____2075 cb t in
                FStar_TypeChecker_NBETerm.as_arg uu____2074 in
              let uu____2078 =
                let uu____2085 =
                  let uu____2090 =
                    let uu____2091 =
                      let uu____2096 = e_term_aq aq in
                      FStar_TypeChecker_NBETerm.e_option uu____2096 in
                    FStar_TypeChecker_NBETerm.embed uu____2091 cb tacopt in
                  FStar_TypeChecker_NBETerm.as_arg uu____2090 in
                [uu____2085] in
              uu____2069 :: uu____2078 in
            uu____2053 :: uu____2062 in
          mkConstruct
      ...
      | FStar_Reflection_Data.Tv_AscribedC (e, c, tacopt) ->
          let uu____2124 =
            let uu____2131 =
              let uu____2136 =
                let uu____2137 = e_term_aq aq in
                FStar_TypeChecker_NBETerm.embed uu____2137 cb e in
              FStar_TypeChecker_NBETerm.as_arg uu____2136 in
            let uu____2140 =
              let uu____2147 =
                let uu____2152 = FStar_TypeChecker_NBETerm.embed e_comp cb c in
                FStar_TypeChecker_NBETerm.as_arg uu____2152 in
              let uu____2153 =
                let uu____2160 =
                  let uu____2165 =
                    let uu____2166 =
                      let uu____2171 = e_term_aq aq in
                      FStar_TypeChecker_NBETerm.e_option uu____2171 in
                    FStar_TypeChecker_NBETerm.embed uu____2166 cb tacopt in
                  FStar_TypeChecker_NBETerm.as_arg uu____2165 in
                [uu____2160] in
              uu____2147 :: uu____2153 in
    ...
    let unembed_term_view cb t =
      match t with
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2212, (b, uu____2214)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_Var.FStar_Reflection_Data.lid
          ->
          let uu____2233 = FStar_TypeChecker_NBETerm.unembed e_bv cb b in
          FStar_Util.bind_opt uu____2233
            (fun b1 ->
               FStar_All.pipe_left
                 (fun _0_25 -> FStar_Pervasives_Native.Some _0_25)
                 (FStar_Reflection_Data.Tv_Var b1))
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2241, (b, uu____2243)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_BVar.FStar_Reflection_Data.lid
          ->
          let uu____2262 = FStar_TypeChecker_NBETerm.unembed e_bv cb b in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2270, (f, uu____2272)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_FVar.FStar_Reflection_Data.lid
          ->
          let uu____2291 = FStar_TypeChecker_NBETerm.unembed e_fv cb f in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2299, (r, uu____2301)::(l, uu____2303)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_App.FStar_Reflection_Data.lid
          ->
          let uu____2326 = FStar_TypeChecker_NBETerm.unembed e_term cb l in
          FStar_Util.bind_opt uu____2326
            (fun l1 ->
               let uu____2332 = FStar_TypeChecker_NBETerm.unembed e_argv cb r in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2340, (t1, uu____2342)::(b, uu____2344)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_Abs.FStar_Reflection_Data.lid
          ->
          let uu____2367 = FStar_TypeChecker_NBETerm.unembed e_binder cb b in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2381, (t1, uu____2383)::(b, uu____2385)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_Arrow.FStar_Reflection_Data.lid
          ->
          let uu____2408 = FStar_TypeChecker_NBETerm.unembed e_binder cb b in
          FStar_Util.bind_opt uu____2408
            (fun b1 ->
               let uu____2414 =
                 FStar_TypeChecker_NBETerm.unembed e_comp cb t1 in
               FStar_Util.bind_opt uu____2414
                 (fun c ->
                    FStar_All.pipe_left
                      (fun _0_30 -> FStar_Pervasives_Native.Some _0_30)
                      (FStar_Reflection_Data.Tv_Arrow (b1, c))))
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2422, (u, uu____2424)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2451, (t1, uu____2453)::(b, uu____2455)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_Refine.FStar_Reflection_Data.lid
          ->
          let uu____2478 = FStar_TypeChecker_NBETerm.unembed e_bv cb b in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2492, (c, uu____2494)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_Const.FStar_Reflection_Data.lid
          ->
          let uu____2513 = FStar_TypeChecker_NBETerm.unembed e_const cb c in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2521, (l, uu____2523)::(u, uu____2525)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2558,
           (t2, uu____2560)::(t1, uu____2562)::(b, uu____2564)::(r,
                                                                 uu____2566)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
          ...
          FStar_Util.bind_opt uu____2597
            (fun r1 ->
               let uu____2603 = FStar_TypeChecker_NBETerm.unembed e_bv cb b in
                           ...
                           (fun t21 ->
                              FStar_All.pipe_left
                                ...
                                (FStar_Reflection_Data.Tv_Let
                                   (r1, b1, t11, t21))))))
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2623, (brs, uu____2625)::(t1, uu____2627)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_Match.FStar_Reflection_Data.lid
          ->
          let uu____2650 = FStar_TypeChecker_NBETerm.unembed e_term cb t1 in
          FStar_Util.bind_opt uu____2650
            (fun t2 ->
               let uu____2656 =
                 let uu____2661 = FStar_TypeChecker_NBETerm.e_list e_branch in
                 FStar_TypeChecker_NBETerm.unembed uu____2661 cb brs in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2679,
           (tacopt, uu____2681)::(t1, uu____2683)::(e, uu____2685)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_AscT.FStar_Reflection_Data.lid
          ->
          let uu____2712 = FStar_TypeChecker_NBETerm.unembed e_term cb e in
               ...
               FStar_Util.bind_opt uu____2718
                 (fun t2 ->
                    let uu____2724 =
                      ...
                      FStar_TypeChecker_NBETerm.unembed uu____2729 cb tacopt in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2747,
           (tacopt, uu____2749)::(c, uu____2751)::(e, uu____2753)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
            FStar_Reflection_Data.ref_Tv_AscC.FStar_Reflection_Data.lid
          ->
          let uu____2780 = FStar_TypeChecker_NBETerm.unembed e_term cb e in
          FStar_Util.bind_opt uu____2780
            (fun e1 ->
               let uu____2786 = FStar_TypeChecker_NBETerm.unembed e_comp cb c in
               FStar_Util.bind_opt uu____2786
                 (fun c1 ->
                    let uu____2792 =
                      let uu____2797 =
                        FStar_TypeChecker_NBETerm.e_option e_term in
                      FStar_TypeChecker_NBETerm.unembed uu____2797 cb tacopt in
                      ...
                      (fun tacopt1 ->
                         FStar_All.pipe_left
                           ...
                           (FStar_Reflection_Data.Tv_AscribedC
                              (e1, c1, tacopt1)))))
      | FStar_TypeChecker_NBETerm.Construct (fv, uu____2815, []) when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | uu____2832 ->
          ((let uu____2834 =
              let uu____2839 =
                let uu____2840 = FStar_TypeChecker_NBETerm.t_to_string t in
                FStar_Util.format1 "Not an embedded term_view: %s" uu____2840 in
              (FStar_Errors.Warning_NotEmbedded, uu____2839) in
            FStar_Errors.log_issue FStar_Range.dummyRange uu____2834);
           FStar_Pervasives_Native.None) in
...
let (e_bv_view :
    ...
    let uu____2862 =
      ...
      let uu____2875 =
        ...
        let uu____2888 =
          ...
          [uu____2895] in
        uu____2882 :: uu____2888 in
      uu____2869 :: uu____2875 in
  ...
  let unembed_bv_view cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____2933,
         (s, uu____2935)::(idx, uu____2937)::(nm, uu____2939)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | uu____2985 ->
        ((let uu____2987 =
            let uu____2992 =
              let uu____2993 = FStar_TypeChecker_NBETerm.t_to_string t in
              FStar_Util.format1 "Not an embedded bv_view: %s" uu____2993 in
            (FStar_Errors.Warning_NotEmbedded, uu____2992) in
          FStar_Errors.log_issue FStar_Range.dummyRange uu____2987);
         FStar_Pervasives_Native.None) in
...
let (e_comp_view :
  ...
  let embed_comp_view cb cv =
    ...
    | FStar_Reflection_Data.C_Total (t, md) ->
        let uu____3013 =
          let uu____3020 =
            let uu____3025 = FStar_TypeChecker_NBETerm.embed e_term cb t in
            FStar_TypeChecker_NBETerm.as_arg uu____3025 in
          let uu____3026 =
            let uu____3033 =
              let uu____3038 =
                let uu____3039 = FStar_TypeChecker_NBETerm.e_option e_term in
                FStar_TypeChecker_NBETerm.embed uu____3039 cb md in
              FStar_TypeChecker_NBETerm.as_arg uu____3038 in
            [uu____3033] in
          uu____3020 :: uu____3026 in
        mkConstruct
    ...
    | FStar_Reflection_Data.C_Lemma (pre, post) ->
        ...
        let uu____3063 =
          let uu____3070 =
            let uu____3075 = FStar_TypeChecker_NBETerm.embed e_term cb pre in
            FStar_TypeChecker_NBETerm.as_arg uu____3075 in
          let uu____3076 =
            let uu____3083 =
              let uu____3088 =
                FStar_TypeChecker_NBETerm.embed e_term cb post1 in
              FStar_TypeChecker_NBETerm.as_arg uu____3088 in
            [uu____3083] in
          uu____3070 :: uu____3076 in
        mkConstruct
  ...
  let unembed_comp_view cb t =
    match t with
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____3121, (md, uu____3123)::(t1, uu____3125)::[]) when
        FStar_Syntax_Syntax.fv_eq_lid fv
          FStar_Reflection_Data.ref_C_Total.FStar_Reflection_Data.lid
        ->
        let uu____3148 = FStar_TypeChecker_NBETerm.unembed e_term cb t1 in
        FStar_Util.bind_opt uu____3148
          (fun t2 ->
             let uu____3154 =
               let uu____3159 = FStar_TypeChecker_NBETerm.e_option e_term in
               FStar_TypeChecker_NBETerm.unembed uu____3159 cb md in
    ...
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____3177, (post, uu____3179)::(pre, uu____3181)::[]) when
        FStar_Syntax_Syntax.fv_eq_lid fv
          FStar_Reflection_Data.ref_C_Lemma.FStar_Reflection_Data.lid
        ->
        let uu____3204 = FStar_TypeChecker_NBETerm.unembed e_term cb pre in
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, uu____3218, []) when
        FStar_Syntax_Syntax.fv_eq_lid fv
          FStar_Reflection_Data.ref_C_Unknown.FStar_Reflection_Data.lid
        ->
        FStar_All.pipe_left (fun _0_43 -> FStar_Pervasives_Native.Some _0_43)
          FStar_Reflection_Data.C_Unknown
    | uu____3235 ->
        ((let uu____3237 =
            let uu____3242 =
              let uu____3243 = FStar_TypeChecker_NBETerm.t_to_string t in
              FStar_Util.format1 "Not an embedded comp_view: %s" uu____3243 in
            (FStar_Errors.Warning_NotEmbedded, uu____3242) in
          FStar_Errors.log_issue FStar_Range.dummyRange uu____3237);
         FStar_Pervasives_Native.None) in
...
let (e_order : FStar_Order.order FStar_TypeChecker_NBETerm.embedding) =
  ...
  let unembed_order cb t =
    match t with
    | FStar_TypeChecker_NBETerm.Construct (fv, uu____3285, []) when
        FStar_Syntax_Syntax.fv_eq_lid fv FStar_Reflection_Data.ord_Lt_lid ->
        FStar_Pervasives_Native.Some FStar_Order.Lt
    | FStar_TypeChecker_NBETerm.Construct (fv, uu____3301, []) when
    ...
    | uu____3332 ->
        ((let uu____3334 =
            let uu____3339 =
              let uu____3340 = FStar_TypeChecker_NBETerm.t_to_string t in
              FStar_Util.format1 "Not an embedded order: %s" uu____3340 in
            (FStar_Errors.Warning_NotEmbedded, uu____3339) in
          FStar_Errors.log_issue FStar_Range.dummyRange uu____3334);
         FStar_Pervasives_Native.None) in
  let uu____3341 =
    FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.order_lid
      FStar_Syntax_Syntax.delta_constant FStar_Pervasives_Native.None in
  mk_emb' embed_order unembed_order uu____3341
let (e_sigelt :
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.ltyp = uu____3371;
           FStar_Syntax_Syntax.rng = uu____3372;_},
         uu____3373)
        ->
        let uu____3392 = FStar_Dyn.undyn b in
        FStar_Pervasives_Native.Some uu____3392
    | uu____3393 ->
        ((let uu____3395 =
            let uu____3400 =
              let uu____3401 = FStar_TypeChecker_NBETerm.t_to_string t in
              FStar_Util.format1 "Not an embedded sigelt: %s" uu____3401 in
            (FStar_Errors.Warning_NotEmbedded, uu____3400) in
          FStar_Errors.log_issue FStar_Range.dummyRange uu____3395);
         FStar_Pervasives_Native.None) in
...
let (e_ident : FStar_Ident.ident FStar_TypeChecker_NBETerm.embedding) =
  ...
  let embed_ident cb i =
    let uu____3424 =
      let uu____3429 = FStar_Ident.range_of_id i in
      let uu____3430 = FStar_Ident.text_of_id i in (uu____3429, uu____3430) in
    FStar_TypeChecker_NBETerm.embed repr cb uu____3424 in
  let unembed_ident cb t =
    let uu____3450 = FStar_TypeChecker_NBETerm.unembed repr cb t in
    match uu____3450 with
    | FStar_Pervasives_Native.Some (rng, s) ->
        let uu____3469 = FStar_Ident.mk_ident (s, rng) in
        FStar_Pervasives_Native.Some uu____3469
  ...
  let et =
    let uu____3477 =
      ...
      let uu____3485 =
        let uu____3488 = fv_as_emb_typ range_fv in
        let uu____3489 =
          let uu____3492 = fv_as_emb_typ string_fv in [uu____3492] in
        uu____3488 :: uu____3489 in
      (uu____3484, uu____3485) in
    FStar_Syntax_Syntax.ET_app uu____3477 in
  let uu____3495 =
    let uu____3496 =
    ...
    let uu____3497 =
      let uu____3504 =
        let uu____3509 = mkFV range_fv [] [] in
        FStar_TypeChecker_NBETerm.as_arg uu____3509 in
      let uu____3514 =
        let uu____3521 =
          let uu____3526 = mkFV string_fv [] [] in
          FStar_TypeChecker_NBETerm.as_arg uu____3526 in
        [uu____3521] in
      uu____3504 :: uu____3514 in
    mkFV uu____3496 [FStar_Syntax_Syntax.U_zero; FStar_Syntax_Syntax.U_zero]
      uu____3497 in
  FStar_TypeChecker_NBETerm.mk_emb embed_ident unembed_ident uu____3495 et
let (e_univ_name :
...
let (e_sigelt_view :
        ...
        let uu____3575 =
          let uu____3582 =
            let uu____3587 =
              FStar_TypeChecker_NBETerm.embed
                FStar_TypeChecker_NBETerm.e_bool cb r in
            FStar_TypeChecker_NBETerm.as_arg uu____3587 in
          let uu____3588 =
            let uu____3595 =
              let uu____3600 = FStar_TypeChecker_NBETerm.embed e_fv cb fv in
              FStar_TypeChecker_NBETerm.as_arg uu____3600 in
            let uu____3601 =
              let uu____3608 =
                let uu____3613 =
                  FStar_TypeChecker_NBETerm.embed e_univ_names cb univs1 in
                FStar_TypeChecker_NBETerm.as_arg uu____3613 in
              let uu____3616 =
                let uu____3623 =
                  let uu____3628 =
                    FStar_TypeChecker_NBETerm.embed e_term cb ty in
                  FStar_TypeChecker_NBETerm.as_arg uu____3628 in
                let uu____3629 =
                  let uu____3636 =
                    let uu____3641 =
                      FStar_TypeChecker_NBETerm.embed e_term cb t in
                    FStar_TypeChecker_NBETerm.as_arg uu____3641 in
                  [uu____3636] in
                uu____3623 :: uu____3629 in
              uu____3608 :: uu____3616 in
    ...
    | FStar_Reflection_Data.Sg_Constructor (nm, ty) ->
        let uu____3668 =
          let uu____3675 =
            ...
            FStar_TypeChecker_NBETerm.as_arg uu____3680 in
          let uu____3683 =
            let uu____3690 =
              let uu____3695 = FStar_TypeChecker_NBETerm.embed e_term cb ty in
              FStar_TypeChecker_NBETerm.as_arg uu____3695 in
            [uu____3690] in
          uu____3675 :: uu____3683 in
        mkConstruct
    ...
    | FStar_Reflection_Data.Sg_Inductive (nm, univs1, bs, t, dcs) ->
        let uu____3725 =
          let uu____3732 =
            let uu____3737 =
              FStar_TypeChecker_NBETerm.embed e_string_list cb nm in
            FStar_TypeChecker_NBETerm.as_arg uu____3737 in
          let uu____3740 =
            let uu____3747 =
              let uu____3752 =
                FStar_TypeChecker_NBETerm.embed e_univ_names cb univs1 in
              FStar_TypeChecker_NBETerm.as_arg uu____3752 in
            let uu____3755 =
              let uu____3762 =
                let uu____3767 =
                  FStar_TypeChecker_NBETerm.embed e_binders cb bs in
                FStar_TypeChecker_NBETerm.as_arg uu____3767 in
              let uu____3768 =
                let uu____3775 =
                  let uu____3780 =
                    FStar_TypeChecker_NBETerm.embed e_term cb t in
                  FStar_TypeChecker_NBETerm.as_arg uu____3780 in
                let uu____3781 =
                  let uu____3788 =
                    let uu____3793 =
                      let uu____3794 =
                        FStar_TypeChecker_NBETerm.e_list e_string_list in
                      FStar_TypeChecker_NBETerm.embed uu____3794 cb dcs in
                    FStar_TypeChecker_NBETerm.as_arg uu____3793 in
                  [uu____3788] in
                uu____3775 :: uu____3781 in
              uu____3762 :: uu____3768 in
            uu____3747 :: uu____3755 in
          uu____3732 :: uu____3740 in
        mkConstruct
  ...
  let unembed_sigelt_view cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____3851,
         (dcs, uu____3853)::(t1, uu____3855)::(bs, uu____3857)::(us,
                                                                 uu____3859)::
         (nm, uu____3861)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
        ...
        FStar_Util.bind_opt uu____3896
          (fun nm1 ->
             let uu____3910 =
             ...
             FStar_Util.bind_opt uu____3910
               (fun us1 ->
                  ...
                  FStar_Util.bind_opt uu____3924
                    (fun bs1 ->
                       let uu____3930 =
                         FStar_TypeChecker_NBETerm.unembed e_term cb t1 in
                            ...
                            let uu____3936 =
                              let uu____3943 =
                                FStar_TypeChecker_NBETerm.e_list
                                  e_string_list in
                              FStar_TypeChecker_NBETerm.unembed uu____3943 cb
                                dcs in
                            FStar_Util.bind_opt uu____3936
                              (fun dcs1 ->
                                 FStar_All.pipe_left
                                   (fun _0_44 ->
    ...
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____3975,
         (t1, uu____3977)::(ty, uu____3979)::(univs1, uu____3981)::(fvar1,
                                                                    uu____3983)::
         (r, uu____3985)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
        ...
        FStar_Util.bind_opt uu____4020
          (fun r1 ->
             let uu____4026 = FStar_TypeChecker_NBETerm.unembed e_fv cb fvar1 in
               ...
               (fun fvar2 ->
                  ...
                  FStar_Util.bind_opt uu____4032
                    (fun univs2 ->
                       ...
                       FStar_Util.bind_opt uu____4046
                         (fun ty1 ->
                            let uu____4052 =
                              FStar_TypeChecker_NBETerm.unembed e_term cb t1 in
                            FStar_Util.bind_opt uu____4052
                              (fun t2 ->
                                 FStar_All.pipe_left
                                   (fun _0_45 ->
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, uu____4062, []) when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | uu____4077 ->
        ((let uu____4079 =
            let uu____4084 =
              let uu____4085 = FStar_TypeChecker_NBETerm.t_to_string t in
              FStar_Util.format1 "Not an embedded sigelt_view: %s" uu____4085 in
            (FStar_Errors.Warning_NotEmbedded, uu____4084) in
          FStar_Errors.log_issue FStar_Range.dummyRange uu____4079);
         FStar_Pervasives_Native.None) in
...
let (e_exp : FStar_Reflection_Data.exp FStar_TypeChecker_NBETerm.embedding) =
  let rec embed_exp cb e =
    ...
    | FStar_Reflection_Data.Mult (e1, e2) ->
        let uu____4126 =
          let uu____4133 =
            let uu____4138 = embed_exp cb e1 in
            FStar_TypeChecker_NBETerm.as_arg uu____4138 in
          let uu____4139 =
            let uu____4146 =
              let uu____4151 = embed_exp cb e2 in
              FStar_TypeChecker_NBETerm.as_arg uu____4151 in
            [uu____4146] in
          uu____4133 :: uu____4139 in
        mkConstruct FStar_Reflection_Data.ref_E_Mult.FStar_Reflection_Data.fv
          [] uu____4126 in
  let rec unembed_exp cb t =
    match t with
    | FStar_TypeChecker_NBETerm.Construct (fv, uu____4180, []) when
        FStar_Syntax_Syntax.fv_eq_lid fv
          FStar_Reflection_Data.ref_E_Unit.FStar_Reflection_Data.lid
        -> FStar_Pervasives_Native.Some FStar_Reflection_Data.Unit
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____4196, (i, uu____4198)::[]) when
        FStar_Syntax_Syntax.fv_eq_lid fv
        ...
        let uu____4217 =
          FStar_TypeChecker_NBETerm.unembed FStar_TypeChecker_NBETerm.e_int
            cb i in
        FStar_Util.bind_opt uu____4217
          (fun i1 ->
             FStar_All.pipe_left
               (fun _0_46 -> FStar_Pervasives_Native.Some _0_46)
               (FStar_Reflection_Data.Var i1))
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____4225, (e2, uu____4227)::(e1, uu____4229)::[]) when
        FStar_Syntax_Syntax.fv_eq_lid fv
          FStar_Reflection_Data.ref_E_Mult.FStar_Reflection_Data.lid
        ->
        let uu____4252 = unembed_exp cb e1 in
        FStar_Util.bind_opt uu____4252
          (fun e11 ->
             let uu____4258 = unembed_exp cb e2 in
             FStar_Util.bind_opt uu____4258
               (fun e21 ->
                  FStar_All.pipe_left
    ...
    | uu____4265 ->
        ((let uu____4267 =
            let uu____4272 =
              let uu____4273 = FStar_TypeChecker_NBETerm.t_to_string t in
              FStar_Util.format1 "Not an embedded exp: %s" uu____4273 in
            (FStar_Errors.Warning_NotEmbedded, uu____4272) in
          FStar_Errors.log_issue FStar_Range.dummyRange uu____4267);
         FStar_Pervasives_Native.None) in
