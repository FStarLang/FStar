  ...
  fun uu____1211 ->
    let embed_pattern cb p =
      ...
      | FStar_Reflection_Data.Pat_Constant c ->
          let uu____1224 =
            let uu____1231 =
              let uu____1236 = FStar_TypeChecker_NBETerm.embed e_const cb c in
      ...
      | FStar_Reflection_Data.Pat_Dot_Term (bv, t) ->
          let uu____1379 =
            ...
            let uu____1392 =
              let uu____1399 =
                let uu____1404 = FStar_TypeChecker_NBETerm.embed e_term cb t in
    ...
    let unembed_pattern cb t =
      match t with
      | FStar_TypeChecker_NBETerm.Construct (fv, [], (c, uu____1434)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | FStar_TypeChecker_NBETerm.Construct (fv, [], (bv, uu____1562)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | FStar_TypeChecker_NBETerm.Construct (fv, [], (bv, uu____1589)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | uu____1653 ->
          ((let uu____1655 =
              let uu____1661 =
                ...
                FStar_Util.format1 "Not an embedded pattern: %s" uu____1663 in
      ...
      | FStar_TypeChecker_NBETerm.Lazy
          (FStar_Util.Inl
           { FStar_Syntax_Syntax.blob = v1; FStar_Syntax_Syntax.lkind = k';
             ...
             FStar_Syntax_Syntax.rng = uu____1759;_},
           uu____1760)
  ...
  fun aq ->
    let embed_term_view cb tv =
      ...
      | FStar_Reflection_Data.Tv_Abs (b, t) ->
          let uu____1938 =
            let uu____1945 =
              let uu____1950 = FStar_TypeChecker_NBETerm.embed e_binder cb b in
      ...
      | FStar_Reflection_Data.Tv_Arrow (b, c) ->
          let uu____1981 =
            let uu____1988 =
              let uu____1993 = FStar_TypeChecker_NBETerm.embed e_binder cb b in
              FStar_TypeChecker_NBETerm.as_arg uu____1993 in
            let uu____1994 =
              let uu____2001 =
                let uu____2006 = FStar_TypeChecker_NBETerm.embed e_comp cb c in
      ...
      | FStar_Reflection_Data.Tv_Const c ->
          let uu____2085 =
            let uu____2092 =
              let uu____2097 = FStar_TypeChecker_NBETerm.embed e_const cb c in
      ...
      | FStar_Reflection_Data.Tv_Let (r, attrs, b, t1, t2) ->
          let uu____2161 =
            ...
            let uu____2175 =
              let uu____2182 =
                let uu____2187 =
                  let uu____2188 = FStar_TypeChecker_NBETerm.e_list e_term in
                  FStar_TypeChecker_NBETerm.embed uu____2188 cb attrs in
                FStar_TypeChecker_NBETerm.as_arg uu____2187 in
              let uu____2195 =
                let uu____2202 =
                  let uu____2207 = FStar_TypeChecker_NBETerm.embed e_bv cb b in
      ...
      | FStar_Reflection_Data.Tv_AscribedC (e, c, tacopt) ->
          let uu____2422 =
            ...
            let uu____2438 =
              let uu____2445 =
                let uu____2450 = FStar_TypeChecker_NBETerm.embed e_comp cb c in
    ...
    let unembed_term_view cb t =
      ...
      | FStar_TypeChecker_NBETerm.Construct
          ...
          FStar_Util.bind_opt uu____2627
            (fun l1 ->
               let uu____2633 = FStar_TypeChecker_NBETerm.unembed e_argv cb r in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          ...
          ->
          let uu____2669 = FStar_TypeChecker_NBETerm.unembed e_binder cb b in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          ...
          ->
          let uu____2711 = FStar_TypeChecker_NBETerm.unembed e_binder cb b in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____2866,
           (t2, uu____2868)::(t1, uu____2870)::(b, uu____2872)::(attrs,
                                                                 uu____2874)::
           (r, uu____2876)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | FStar_TypeChecker_NBETerm.Construct
          ...
          FStar_Util.bind_opt uu____2991
            (fun t2 ->
               let uu____2997 =
                 let uu____3002 = FStar_TypeChecker_NBETerm.e_list e_branch in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____3021,
           (tacopt, uu____3023)::(t1, uu____3025)::(e, uu____3027)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
               ...
               FStar_Util.bind_opt uu____3060
                 (fun t2 ->
                    let uu____3066 =
                      ...
                      FStar_TypeChecker_NBETerm.unembed uu____3071 cb tacopt in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv, uu____3090,
           (tacopt, uu____3092)::(c, uu____3094)::(e, uu____3096)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
          ...
          FStar_Util.bind_opt uu____3123
            (fun e1 ->
               let uu____3129 = FStar_TypeChecker_NBETerm.unembed e_comp cb c in
               FStar_Util.bind_opt uu____3129
                 (fun c1 ->
                    let uu____3135 =
                      let uu____3140 =
                        FStar_TypeChecker_NBETerm.e_option e_term in
                      FStar_TypeChecker_NBETerm.unembed uu____3140 cb tacopt in
      ...
      | uu____3177 ->
          ((let uu____3179 =
              let uu____3185 =
                ...
                FStar_Util.format1 "Not an embedded term_view: %s" uu____3187 in
...
let (e_bv_view :
  ...
  let unembed_bv_view cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____3286,
         (s, uu____3288)::(idx, uu____3290)::(nm, uu____3292)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
...
let (e_comp_view :
  ...
  let embed_comp_view cb cv =
    ...
    | FStar_Reflection_Data.C_Total (t, md) ->
        let uu____3377 =
          ...
          let uu____3390 =
            let uu____3397 =
              let uu____3402 =
                let uu____3403 = FStar_TypeChecker_NBETerm.e_option e_term in
    ...
    | FStar_Reflection_Data.C_Lemma (pre, post) ->
        ...
        let uu____3427 =
          let uu____3434 =
            let uu____3439 = FStar_TypeChecker_NBETerm.embed e_term cb pre in
  ...
  let unembed_comp_view cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv, uu____3584, []) when
        ...
        ->
        FStar_All.pipe_left (fun _3601 -> FStar_Pervasives_Native.Some _3601)
          FStar_Reflection_Data.C_Unknown
    | uu____3602 ->
        ((let uu____3604 =
            let uu____3610 =
              let uu____3612 = FStar_TypeChecker_NBETerm.t_to_string t in
              FStar_Util.format1 "Not an embedded comp_view: %s" uu____3612 in
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.rng = uu____3751;_},
         uu____3752)
        ->
...
let (e_ident : FStar_Ident.ident FStar_TypeChecker_NBETerm.embedding) =
  ...
  let embed_ident cb i =
    let uu____3811 =
      ...
      let uu____3818 = FStar_Ident.text_of_id i in (uu____3817, uu____3818) in
...
let (e_sigelt_view :
  ...
  let embed_sigelt_view cb sev =
    ...
    | FStar_Reflection_Data.Sg_Constructor (nm, ty) ->
        let uu____4078 =
          ...
          let uu____4094 =
            let uu____4101 =
              let uu____4106 = FStar_TypeChecker_NBETerm.embed e_term cb ty in
  ...
  let unembed_sigelt_view cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____4266,
         (dcs, uu____4268)::(t1, uu____4270)::(bs, uu____4272)::(us,
                                                                 uu____4274)::
         (nm, uu____4276)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____4401,
         (t1, uu____4403)::(ty, uu____4405)::(univs1, uu____4407)::(fvar1,
                                                                    uu____4409)::
         (r, uu____4411)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
        ...
        FStar_Util.bind_opt uu____4446
          (fun r1 ->
             let uu____4456 = FStar_TypeChecker_NBETerm.unembed e_fv cb fvar1 in
    ...
    | uu____4509 ->
        ((let uu____4511 =
            let uu____4517 =
              ...
              FStar_Util.format1 "Not an embedded sigelt_view: %s" uu____4519 in
...
let (e_exp : FStar_Reflection_Data.exp FStar_TypeChecker_NBETerm.embedding) =
  ...
  let rec unembed_exp cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        (fv, uu____4634, (i, uu____4636)::[]) when
        FStar_Syntax_Syntax.fv_eq_lid fv
...
let (e_lid : FStar_Ident.lid FStar_TypeChecker_NBETerm.embedding) =
  ...
  let uu____4783 =
    mkConstruct FStar_Reflection_Data.fstar_refl_aqualv_fv [] [] in
  let uu____4788 = fv_as_emb_typ FStar_Reflection_Data.fstar_refl_aqualv_fv in
  ...
  let embed1 cb q =
    ...
    | FStar_Reflection_Data.Projector (l, i) ->
        let uu____4943 =
          ...
          let uu____4956 =
            let uu____4963 =
              let uu____4968 = FStar_TypeChecker_NBETerm.embed e_ident cb i in
  ...
  let unembed1 cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        ...
        FStar_Util.bind_opt uu____5451
          (fun i1 ->
             let uu____5457 = FStar_TypeChecker_NBETerm.unembed e_lid cb l in
    ...
    | uu____5594 ->
        ((let uu____5596 =
            let uu____5602 =
              ...
              FStar_Util.format1 "Not an embedded qualifier: %s" uu____5604 in
