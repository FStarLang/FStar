          ...
          let thunk =
            FStar_Thunk.mk
              (fun uu___  ->
                 ...
                 FStar_TypeChecker_NBETerm.translate_cb cb uu___1)
             in
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.rng = uu___1;_},uu___2)
        ->
  ...
  let unembed_aqualv cb t =
    ...
    | uu___ ->
        ((let uu___2 =
         ...
         FStar_Pervasives_Native.None)
     in
  let uu___ = mkConstruct FStar_Reflection_Data.fstar_refl_aqualv_fv [] []
     in
  ...
  fun uu___  ->
    ...
    let unembed_pattern cb t =
      ...
      | FStar_TypeChecker_NBETerm.Construct
          ...
          FStar_Util.bind_opt uu___3
            (fun bv1  ->
               let uu___4 = FStar_TypeChecker_NBETerm.unembed e_term cb t1
                  in
               FStar_Util.bind_opt uu___4
                 (fun t2  ->
                    FStar_All.pipe_left
  ...
  fun aq  ->
    ...
    let unembed_term_view cb t =
      ...
      | FStar_TypeChecker_NBETerm.Construct
          ...
          FStar_Util.bind_opt uu___3
            (fun b1  ->
               let uu___4 = FStar_TypeChecker_NBETerm.unembed e_comp cb t1
                  in
               FStar_Util.bind_opt uu___4
                 (fun c  ->
                    FStar_All.pipe_left
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv,uu___,(t2,uu___1)::(t1,uu___2)::(b,uu___3)::(attrs,uu___4)::
           (r,uu___5)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
          ...
          FStar_Util.bind_opt uu___6
            (fun r1  ->
               ...
               FStar_Util.bind_opt uu___7
                 (fun attrs1  ->
                    let uu___8 = FStar_TypeChecker_NBETerm.unembed e_bv cb b
                       in
      ...
      | FStar_TypeChecker_NBETerm.Construct
          ...
          FStar_Util.bind_opt uu___4
            (fun e1  ->
               let uu___5 = FStar_TypeChecker_NBETerm.unembed e_term cb t1
                  in
               FStar_Util.bind_opt uu___5
                 (fun t2  ->
                    let uu___6 =
                      let uu___7 = FStar_TypeChecker_NBETerm.e_option e_term
                         in
    ...
    | FStar_TypeChecker_NBETerm.Construct
        ...
        FStar_Util.bind_opt uu___4
          (fun nm1  ->
             ...
             FStar_Util.bind_opt uu___5
               (fun idx1  ->
                  let uu___6 = FStar_TypeChecker_NBETerm.unembed e_term cb s
                     in
                  FStar_Util.bind_opt uu___6
                    (fun s1  ->
                       FStar_All.pipe_left
...
let (e_comp_view :
    ...
    | FStar_Reflection_Data.C_Lemma (pre,post,pats) ->
        let uu___ =
          ...
          let uu___2 =
            ...
            let uu___4 =
              let uu___5 =
                let uu___6 = FStar_TypeChecker_NBETerm.embed e_term cb pats
                   in
                FStar_TypeChecker_NBETerm.as_arg uu___6  in
              [uu___5]  in
            uu___3 :: uu___4  in
    ...
    | FStar_Reflection_Data.C_Eff (us,eff,res,args) ->
        let uu___ =
          ...
          let uu___2 =
            ...
            let uu___4 =
              let uu___5 =
                let uu___6 = FStar_TypeChecker_NBETerm.embed e_term cb res
                   in
                FStar_TypeChecker_NBETerm.as_arg uu___6  in
              let uu___6 =
                let uu___7 =
  ...
  let unembed_comp_view cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        ...
        FStar_Util.bind_opt uu___4
          (fun pre1  ->
             let uu___5 = FStar_TypeChecker_NBETerm.unembed e_term cb post
                in
             FStar_Util.bind_opt uu___5
               (fun post1  ->
                  let uu___6 =
    ...
    | FStar_TypeChecker_NBETerm.Construct
        (fv,uu___,(args,uu___1)::(res,uu___2)::(eff,uu___3)::(us,uu___4)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             FStar_Util.bind_opt uu___6
               (fun eff1  ->
                  ...
                  FStar_Util.bind_opt uu___7
                    (fun res1  ->
                       let uu___8 =
                         let uu___9 = FStar_TypeChecker_NBETerm.e_list e_argv
                            in
...
let (e_ident : FStar_Ident.ident FStar_TypeChecker_NBETerm.embedding) =
  ...
  let et =
    let uu___ =
      let uu___1 = FStar_Ident.string_of_lid FStar_Parser_Const.lid_tuple2
         in
      let uu___2 =
...
let (e_sigelt_view :
  ...
  let embed_sigelt_view cb sev =
        ...
        let uu___ =
          ...
          let uu___2 =
            ...
            let uu___4 =
              ...
              let uu___6 =
                let uu___7 =
                  let uu___8 = FStar_TypeChecker_NBETerm.embed e_term cb ty
                     in
                  FStar_TypeChecker_NBETerm.as_arg uu___8  in
                let uu___8 =
                  let uu___9 =
                    let uu___10 = FStar_TypeChecker_NBETerm.embed e_term cb t
                       in
                    FStar_TypeChecker_NBETerm.as_arg uu___10  in
                  [uu___9]  in
                uu___7 :: uu___8  in
    ...
    | FStar_Reflection_Data.Sg_Inductive (nm,univs,bs,t,dcs) ->
        let uu___ =
          let uu___1 =
            let uu___2 = FStar_TypeChecker_NBETerm.embed e_string_list cb nm
               in
            FStar_TypeChecker_NBETerm.as_arg uu___2  in
          let uu___2 =
            let uu___3 =
            ...
            let uu___4 =
              let uu___5 =
                let uu___6 = FStar_TypeChecker_NBETerm.embed e_binders cb bs
                   in
                FStar_TypeChecker_NBETerm.as_arg uu___6  in
              let uu___6 =
                let uu___7 =
                  let uu___8 = FStar_TypeChecker_NBETerm.embed e_term cb t
                     in
                  FStar_TypeChecker_NBETerm.as_arg uu___8  in
                let uu___8 =
                  let uu___9 =
                    let uu___10 =
                      let uu___11 = FStar_TypeChecker_NBETerm.e_list e_ctor
                         in
  ...
  let unembed_sigelt_view cb t =
    match t.FStar_TypeChecker_NBETerm.nbe_t with
    | FStar_TypeChecker_NBETerm.Construct
        (fv,uu___,(dcs,uu___1)::(t1,uu___2)::(bs,uu___3)::(us,uu___4)::
         (nm,uu___5)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
          FStar_Reflection_Data.ref_Sg_Inductive.FStar_Reflection_Data.lid
        ->
        let uu___6 = FStar_TypeChecker_NBETerm.unembed e_string_list cb nm
           in
        FStar_Util.bind_opt uu___6
          (fun nm1  ->
             let uu___7 =
                              ...
                              (fun dcs1  ->
                                 FStar_All.pipe_left
                                   ...
                                   (FStar_Reflection_Data.Sg_Inductive
                                      (nm1, us1, bs1, t2, dcs1)))))))
    | FStar_TypeChecker_NBETerm.Construct
        (fv,uu___,(t1,uu___1)::(ty,uu___2)::(univs,uu___3)::(fvar,uu___4)::
         (r,uu___5)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
...
let (e_qualifier :
  ...
  let unembed cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv,[],(i,uu___)::(l,uu___1)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | uu___ ->
        ((let uu___2 =
         ...
         FStar_Pervasives_Native.None)
     in
  let uu___ = mkConstruct FStar_Reflection_Data.fstar_refl_qualifier_fv [] []
     in
  let uu___1 = fv_as_emb_typ FStar_Reflection_Data.fstar_refl_qualifier_fv
     in
  FStar_TypeChecker_NBETerm.mk_emb embed unembed uu___ uu___1 
let (e_qualifiers :
