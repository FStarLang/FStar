...
let rec (e_pattern' :
  ...
  fun uu____1041  ->
    ...
    let unembed_pattern cb t =
      match t with
      | FStar_TypeChecker_NBETerm.Construct (fv,[],(c,uu____1230)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | FStar_TypeChecker_NBETerm.Construct (fv,[],(bv,uu____1312)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | uu____1400 ->
          ((let uu____1402 =
              let uu____1407 =
                ...
                FStar_Util.format1 "Not an embedded pattern: %s" uu____1408
                 in
      ...
      | FStar_TypeChecker_NBETerm.Lazy
          (FStar_Util.Inl
           { FStar_Syntax_Syntax.blob = v1; FStar_Syntax_Syntax.lkind = k';
             ...
             FStar_Syntax_Syntax.rng = uu____1495;_},uu____1496)
...
let (e_term_view_aq :
  ...
  fun aq  ->
    ...
    let unembed_term_view cb t =
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv,uu____2558,(t2,uu____2560)::(t1,uu____2562)::(b,uu____2564)::
           (r,uu____2566)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      | FStar_TypeChecker_NBETerm.Construct
          (fv,uu____2679,(tacopt,uu____2681)::(t1,uu____2683)::(e,uu____2685)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
               ...
               FStar_Util.bind_opt uu____2718
                 (fun t2  ->
                    let uu____2724 =
                      ...
                      FStar_TypeChecker_NBETerm.unembed uu____2729 cb tacopt
                       in
                      ...
                      (fun tacopt1  ->
                         FStar_All.pipe_left
                           ...
                           (FStar_Reflection_Data.Tv_AscribedT
                              (e1, t2, tacopt1)))))
      | FStar_TypeChecker_NBETerm.Construct
          (fv,uu____2747,(tacopt,uu____2749)::(c,uu____2751)::(e,uu____2753)::[])
          when
          FStar_Syntax_Syntax.fv_eq_lid fv
               ...
               FStar_Util.bind_opt uu____2786
                 (fun c1  ->
                    let uu____2792 =
                      let uu____2797 =
                        FStar_TypeChecker_NBETerm.e_option e_term  in
                      FStar_TypeChecker_NBETerm.unembed uu____2797 cb tacopt
                       in
      ...
      | uu____2832 ->
          ((let uu____2834 =
              let uu____2839 =
                ...
                FStar_Util.format1 "Not an embedded term_view: %s" uu____2840
                 in
...
let (e_bv_view :
  ...
  let unembed_bv_view cb t =
    match t with
    | FStar_TypeChecker_NBETerm.Construct
        (fv,uu____2933,(s,uu____2935)::(idx,uu____2937)::(nm,uu____2939)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | uu____3235 ->
        ((let uu____3237 =
            let uu____3242 =
              ...
              FStar_Util.format1 "Not an embedded comp_view: %s" uu____3243
               in
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.rng = uu____3372;_},uu____3373)
        ->
...
let (e_ident : FStar_Ident.ident FStar_TypeChecker_NBETerm.embedding) =
  ...
  let embed_ident cb i =
    let uu____3424 =
      ...
      let uu____3430 = FStar_Ident.text_of_id i  in (uu____3429, uu____3430)
       in
...
let (e_sigelt_view :
  ...
  let unembed_sigelt_view cb t =
    match t with
    | FStar_TypeChecker_NBETerm.Construct
        (fv,uu____3851,(dcs,uu____3853)::(t1,uu____3855)::(bs,uu____3857)::
         (us,uu____3859)::(nm,uu____3861)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
                              ...
                              (fun dcs1  ->
                                 FStar_All.pipe_left
                                   ...
                                   (FStar_Reflection_Data.Sg_Inductive
                                      (nm1, us1, bs1, t2, dcs1)))))))
    | FStar_TypeChecker_NBETerm.Construct
        (fv,uu____3975,(t1,uu____3977)::(ty,uu____3979)::(univs1,uu____3981)::
         (fvar1,uu____3983)::(r,uu____3985)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | uu____4077 ->
        ((let uu____4079 =
            let uu____4084 =
              ...
              FStar_Util.format1 "Not an embedded sigelt_view: %s" uu____4085
               in
...
let (e_exp : FStar_Reflection_Data.exp FStar_TypeChecker_NBETerm.embedding) =
  ...
  let rec unembed_exp cb t =
    ...
    | FStar_TypeChecker_NBETerm.Construct (fv,uu____4196,(i,uu____4198)::[])
        when
        FStar_Syntax_Syntax.fv_eq_lid fv
