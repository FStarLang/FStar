...
let uu____1571 = (FStar_List.splitAt n1 p.FStar_Tactics_Types.goals)
in (ret uu____1571))
end)) (fun uu___150_1590 -> (match (uu___150_1590) with
| uu____1601 -> begin
(fail "divide: not enough goals")
end)))
in (bind uu____1537 (fun uu____1628 -> (match (uu____1628) with
| (lgs, rgs) -> begin
(
...
let uu___147_1654 = p
in {FStar_Tactics_Types.main_context = uu___147_1654.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___147_1654.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___147_1654.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = lgs; FStar_Tactics_Types.smt_goals = []; FStar_Tactics_Types.depth = uu___147_1654.FStar_Tactics_Types.depth; FStar_Tactics_Types.__dump = uu___147_1654.FStar_Tactics_Types.__dump; FStar_Tactics_Types.psc = uu___147_1654.FStar_Tactics_Types.psc})
in (

let rp = (

let uu___148_1656 = p
in {FStar_Tactics_Types.main_context = uu___148_1656.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___148_1656.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___148_1656.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = rgs; FStar_Tactics_Types.smt_goals = []; FStar_Tactics_Types.depth = uu___148_1656.FStar_Tactics_Types.depth; FStar_Tactics_Types.__dump = uu___148_1656.FStar_Tactics_Types.__dump; FStar_Tactics_Types.psc = uu___148_1656.FStar_Tactics_Types.psc})
in (

let uu____1657 = (set lp)
in (bind uu____1657 (fun uu____1665 -> (bind l (fun a -> (bind get (fun lp' -> (

let uu____1679 = (set rp)
in (bind uu____1679 (fun uu____1687 -> (bind r (fun b -> (bind get (fun rp' -> (

let p' = (

let uu___149_1703 = p
in {FStar_Tactics_Types.main_context = uu___149_1703.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___149_1703.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___149_1703.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = (FStar_List.append lp'.FStar_Tactics_Types.goals rp'.FStar_Tactics_Types.goals); FStar_Tactics_Types.smt_goals = (FStar_List.append lp'.FStar_Tactics_Types.smt_goals (FStar_List.append rp'.FStar_Tactics_Types.smt_goals p.FStar_Tactics_Types.smt_goals)); FStar_Tactics_Types.depth = uu___149_1703.FStar_Tactics_Types.depth; FStar_Tactics_Types.__dump = uu___149_1703.FStar_Tactics_Types.__dump; FStar_Tactics_Types.psc = uu___149_1703.FStar_Tactics_Types.psc})
in (

let uu____1704 = (set p')
in (bind uu____1704 (fun uu____1712 -> (ret ((a), (b)))))))))))))))))))))))
end)))))))


let focus : 'a . 'a tac  ->  'a tac = (fun f -> (

let uu____1732 = (divide (Prims.parse_int "1") f idtac)
in (bind uu____1732 (fun uu____1745 -> (match (uu____1745) with
| (a, ()) -> begin
(ret a)
end)))))
...
| (uu____1780)::uu____1781 -> begin
(

let uu____1784 = (

let uu____1793 = (map tau)
in (divide (Prims.parse_int "1") tau uu____1793))
in (bind uu____1784 (fun uu____1811 -> (match (uu____1811) with
| (h, t) -> begin
(ret ((h)::t))
end))))
end))))
...
let uu____1850 = (bind t1 (fun uu____1855 -> (

let uu____1856 = (map t2)
in (bind uu____1856 (fun uu____1864 -> (ret ()))))))
in (focus uu____1850)))


let intro : FStar_Syntax_Syntax.binder tac = (bind cur_goal (fun goal -> (

let uu____1875 = (FStar_Syntax_Util.arrow_one goal.FStar_Tactics_Types.goal_ty)
...
let uu____1891 = (FStar_Syntax_Util.is_total_comp c)
in (not (uu____1891)))
...
let uu____1897 = (new_uvar "intro" env' typ')
in (bind uu____1897 (fun u -> (

let uu____1904 = (

let uu____1905 = (FStar_Syntax_Util.abs ((b)::[]) u FStar_Pervasives_Native.None)
in (trysolve goal uu____1905))
...
let uu___152_1912 = goal
in (

let uu____1913 = (bnorm env' u)
in (

let uu____1914 = (bnorm env' typ')
in {FStar_Tactics_Types.context = env'; FStar_Tactics_Types.witness = uu____1913; FStar_Tactics_Types.goal_ty = uu____1914; FStar_Tactics_Types.opts = uu___152_1912.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___152_1912.FStar_Tactics_Types.is_guard})))
in (replace_cur uu____1911))
in (bind uu____1908 (fun uu____1916 -> (ret b))))
end
| uu____1917 -> begin
...
let uu____1922 = (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context goal.FStar_Tactics_Types.goal_ty)
in (fail1 "intro: goal is not an arrow (%s)" uu____1922))
end))))
...
let uu____1943 = (FStar_Syntax_Util.arrow_one goal.FStar_Tactics_Types.goal_ty)
...
let uu____1963 = (FStar_Syntax_Util.is_total_comp c)
in (not (uu____1963)))
...
let uu____1979 = (FStar_Syntax_Syntax.mk_binder bv)
in (uu____1979)::(b)::[])
in (
...
let uu____1984 = (comp_to_typ c)
in (new_uvar "intro_rec" env' uu____1984))
in (bind uu____1981 (fun u -> (

let lb = (

let uu____2000 = (FStar_Syntax_Util.abs ((b)::[]) u FStar_Pervasives_Native.None)
in (FStar_Syntax_Util.mk_letbinding (FStar_Util.Inl (bv)) [] goal.FStar_Tactics_Types.goal_ty FStar_Parser_Const.effect_Tot_lid uu____2000))
in (

let body = (FStar_Syntax_Syntax.bv_to_name bv)
in (

let uu____2004 = (FStar_Syntax_Subst.close_let_rec ((lb)::[]) body)
...
let uu___153_2045 = goal
in (

let uu____2046 = (bnorm env' u)
in (

let uu____2047 = (

let uu____2048 = (comp_to_typ c)
in (bnorm env' uu____2048))
in {FStar_Tactics_Types.context = env'; FStar_Tactics_Types.witness = uu____2046; FStar_Tactics_Types.goal_ty = uu____2047; FStar_Tactics_Types.opts = uu___153_2045.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___153_2045.FStar_Tactics_Types.is_guard})))
in (replace_cur uu____2044))
in (bind uu____2041 (fun uu____2055 -> (

let uu____2056 = (

let uu____2061 = (FStar_Syntax_Syntax.mk_binder bv)
in ((uu____2061), (b)))
in (ret uu____2056)))))
end
| uu____2066 -> begin
...
let uu____2075 = (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context goal.FStar_Tactics_Types.goal_ty)
in (fail1 "intro_rec: goal is not an arrow (%s)" uu____2075))
end));
)))
...
let uu____2100 = (FStar_TypeChecker_Normalize.tr_norm_steps s)
in (FStar_List.append ((FStar_TypeChecker_Normalize.Reify)::(FStar_TypeChecker_Normalize.UnfoldTac)::[]) uu____2100))
in (
...
let uu___154_2107 = goal
in {FStar_Tactics_Types.context = uu___154_2107.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = w; FStar_Tactics_Types.goal_ty = t; FStar_Tactics_Types.opts = uu___154_2107.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___154_2107.FStar_Tactics_Types.is_guard}))))))))
...
let uu____2128 = (bind get (fun ps -> (

let uu____2134 = (__tc e t)
in (bind uu____2134 (fun uu____2156 -> (match (uu____2156) with
| (t1, uu____2166, guard) -> begin
((FStar_TypeChecker_Rel.force_trivial_guard e guard);
(

let steps = (

let uu____2172 = (FStar_TypeChecker_Normalize.tr_norm_steps s)
in (FStar_List.append ((FStar_TypeChecker_Normalize.Reify)::(FStar_TypeChecker_Normalize.UnfoldTac)::[]) uu____2172))
in (
...
in (FStar_All.pipe_left (wrap_err "norm_term") uu____2128)))


let __exact : Prims.bool  ->  FStar_Syntax_Syntax.term  ->  Prims.unit tac = (fun force_guard t -> (bind cur_goal (fun goal -> (

let uu____2195 = (__tc goal.FStar_Tactics_Types.context t)
in (bind uu____2195 (fun uu____2215 -> (match (uu____2215) with
| (t1, typ, guard) -> begin
(

let uu____2227 = (match (force_guard) with
| true -> begin
...
in (bind uu____2227 (fun uu____2235 -> (

let uu____2236 = (do_unify goal.FStar_Tactics_Types.context typ goal.FStar_Tactics_Types.goal_ty)
...
let uu____2240 = (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context t1)
in (

let uu____2241 = (

let uu____2242 = (bnorm goal.FStar_Tactics_Types.context typ)
in (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context uu____2242))
in (

let uu____2243 = (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context goal.FStar_Tactics_Types.goal_ty)
in (fail3 "%s : %s does not exactly solve the goal %s" uu____2240 uu____2241 uu____2243))))
end)))))
end)))))))
...
let uu____2252 = (mlog (fun uu____2257 -> (

let uu____2258 = (FStar_Syntax_Print.term_to_string tm)
in (FStar_Util.print1 "exact: tm = %s\n" uu____2258))) (fun uu____2261 -> (

let uu____2262 = (__exact true tm)
in (focus uu____2262))))
in (FStar_All.pipe_left (wrap_err "exact") uu____2252)))


let exact_guard : FStar_Syntax_Syntax.term  ->  Prims.unit tac = (fun tm -> (

let uu____2277 = (mlog (fun uu____2282 -> (

let uu____2283 = (FStar_Syntax_Print.term_to_string tm)
in (FStar_Util.print1 "exact_guard: tm = %s\n" uu____2283))) (fun uu____2286 -> (

let uu____2287 = (__exact false tm)
in (focus uu____2287))))
in (FStar_All.pipe_left (wrap_err "exact_guard") uu____2277)))
...
let uu____2313 = (FStar_Syntax_Free.uvars g.FStar_Tactics_Types.goal_ty)
in (FStar_Util.set_elements uu____2313))
in (FStar_List.map FStar_Pervasives_Native.fst uu____2306))
...
let uu____2365 = (__exact true tm)
in (trytac uu____2365))
in (bind uu____2360 (fun r -> (match (r) with
...
let uu____2378 = (FStar_Syntax_Util.arrow_one typ)
...
let uu____2411 = (FStar_Syntax_Print.binder_to_string ((bv), (aq)))
in (FStar_Util.print1 "__apply: pushing binder %s\n" uu____2411))) (fun uu____2414 -> (

let uu____2415 = (

let uu____2416 = (FStar_Syntax_Util.is_total_comp c)
in (not (uu____2416)))
...
let uu____2420 = (new_uvar "apply" goal.FStar_Tactics_Types.context bv.FStar_Syntax_Syntax.sort)
in (bind uu____2420 (fun u -> (
...
let uu____2440 = (comp_to_typ c)
in (FStar_All.pipe_left (FStar_Syntax_Subst.subst ((FStar_Syntax_Syntax.NT (((bv), (u))))::[])) uu____2440))
in (

let uu____2441 = (__apply uopt tm' typ')
in (bind uu____2441 (fun uu____2449 -> (
...
let uu____2456 = (FStar_Syntax_Util.head_and_args u1)
in (FStar_Pervasives_Native.fst uu____2456))
in (FStar_Syntax_Subst.compress uu____2455))
in uu____2452.FStar_Syntax_Syntax.n)
in (match (uu____2451) with
| FStar_Syntax_Syntax.Tm_uvar (uvar, uu____2484) -> begin
(bind get (fun ps -> (

let uu____2512 = (uopt && (uvar_free uvar ps))
...
let uu___155_2520 = goal
in (

let uu____2521 = (bnorm goal.FStar_Tactics_Types.context u1)
in (

let uu____2522 = (bnorm goal.FStar_Tactics_Types.context bv.FStar_Syntax_Syntax.sort)
in {FStar_Tactics_Types.context = uu___155_2520.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu____2521; FStar_Tactics_Types.goal_ty = uu____2522; FStar_Tactics_Types.opts = uu___155_2520.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = false})))
in (uu____2519)::[])
in (add_goals uu____2516))
end))))
end
| t -> begin
(ret ())
...
let try_unif : 'a . 'a tac  ->  'a tac  ->  'a tac = (fun t t' -> (mk_tac (fun ps -> (FStar_All.try_with (fun uu___157_2554 -> (match (()) with
| () -> begin
(run t ps)
end)) (fun uu___156_2558 -> (match (uu___156_2558) with
| NoUnif -> begin
(run t' ps)
end))))))
...
let uu____2573 = (mlog (fun uu____2578 -> (

let uu____2579 = (FStar_Syntax_Print.term_to_string tm)
in (FStar_Util.print1 "apply: tm = %s\n" uu____2579))) (fun uu____2581 -> (bind cur_goal (fun goal -> (

let uu____2585 = (__tc goal.FStar_Tactics_Types.context tm)
in (bind uu____2585 (fun uu____2606 -> (match (uu____2606) with
| (tm1, typ, guard) -> begin
(
...
let uu____2624 = (__apply uopt tm1 typ)
in (bind uu____2624 (fun uu____2628 -> (add_goal_from_guard "apply guard" goal.FStar_Tactics_Types.context guard goal.FStar_Tactics_Types.opts))))
in (focus uu____2621))
in (

let uu____2629 = (

let uu____2632 = (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context tm1)
in (

let uu____2633 = (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context typ)
in (

let uu____2634 = (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context goal.FStar_Tactics_Types.goal_ty)
in (fail3 "Cannot instantiate %s (of type %s) to match goal (%s)" uu____2632 uu____2633 uu____2634))))
in (try_unif uu____2618 uu____2629)))
end))))))))
in (FStar_All.pipe_left (wrap_err "apply") uu____2573)))
...
let uu____2650 = (mlog (fun uu____2655 -> (

let uu____2656 = (FStar_Syntax_Print.term_to_string tm)
in (FStar_Util.print1 "apply_lemma: tm = %s\n" uu____2656))) (fun uu____2659 -> (

let is_unit_t = (fun t -> (

let uu____2664 = (

let uu____2665 = (FStar_Syntax_Subst.compress t)
in uu____2665.FStar_Syntax_Syntax.n)
...
let uu____2673 = (__tc goal.FStar_Tactics_Types.context tm)
in (bind uu____2673 (fun uu____2695 -> (match (uu____2695) with
| (tm1, t, guard) -> begin
(

let uu____2707 = (FStar_Syntax_Util.arrow_formals_comp t)
...
let uu____2737 = (FStar_List.fold_left (fun uu____2783 uu____2784 -> (match (((uu____2783), (uu____2784))) with
...
let uu____2925 = (FStar_TypeChecker_Util.new_implicit_var "apply_lemma" goal.FStar_Tactics_Types.goal_ty.FStar_Syntax_Syntax.pos goal.FStar_Tactics_Types.context b_t)
in (match (uu____2925) with
| (u, uu____2955, g_u) -> begin
(

let uu____2969 = (FStar_TypeChecker_Rel.conj_guard guard1 g_u)
in (((((u), (aq)))::uvs), (uu____2969), ((FStar_Syntax_Syntax.NT (((b), (u))))::subst1)))
end))
end)))
end)) (([]), (guard), ([])) bs)
...
let uu____3057 = (FStar_Syntax_Util.comp_to_comp_typ comp1)
in uu____3057.FStar_Syntax_Syntax.effect_args)
in (match (uu____3048) with
| (pre)::(post)::uu____3068 -> begin
...
let uu____3150 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Util.exp_unit)
in (uu____3150)::[])
in (FStar_Syntax_Util.mk_app post uu____3141))
in (
...
let uu____3153 = (FStar_Syntax_Util.mk_squash post1)
in (do_unify goal.FStar_Tactics_Types.context uu____3153 goal.FStar_Tactics_Types.goal_ty))
in (not (uu____3152)))
in (match (uu____3151) with
| true -> begin
(

let uu____3156 = (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context tm1)
in (

let uu____3157 = (

let uu____3158 = (FStar_Syntax_Util.mk_squash post1)
in (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context uu____3158))
in (

let uu____3159 = (FStar_TypeChecker_Normalize.term_to_string goal.FStar_Tactics_Types.context goal.FStar_Tactics_Types.goal_ty)
in (fail3 "Cannot instantiate lemma %s (with postcondition: %s) to match goal (%s)" uu____3156 uu____3157 uu____3159))))
end
| uu____3160 -> begin
(
...
let uu____3162 = (FStar_Syntax_Syntax.mk_Tm_app tm1 uvs1 FStar_Pervasives_Native.None goal.FStar_Tactics_Types.context.FStar_TypeChecker_Env.range)
in (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) goal.FStar_Tactics_Types.context uu____3162))
in (

let uu____3163 = (add_implicits implicits.FStar_TypeChecker_Env.implicits)
in (bind uu____3163 (fun uu____3169 -> (

let implicits1 = (FStar_All.pipe_right implicits.FStar_TypeChecker_Env.implicits (FStar_List.filter (fun uu____3237 -> (match (uu____3237) with
| (uu____3250, uu____3251, uu____3252, tm2, uu____3254, uu____3255) -> begin
(

let uu____3256 = (FStar_Syntax_Util.head_and_args tm2)
in (match (uu____3256) with
| (hd1, uu____3272) -> begin
(

let uu____3293 = (

let uu____3294 = (FStar_Syntax_Subst.compress hd1)
in uu____3294.FStar_Syntax_Syntax.n)
in (match (uu____3293) with
| FStar_Syntax_Syntax.Tm_uvar (uu____3297) -> begin
true
end
| uu____3314 -> begin
false
...
let uu____3315 = (solve goal solution)
in (bind uu____3315 (fun uu____3326 -> (
...
let uu____3344 = (FStar_Syntax_Free.uvars t1)
in (FStar_Util.set_elements uu____3344))
in (FStar_List.map FStar_Pervasives_Native.fst uu____3337))
...
let uu____3385 = (FStar_Syntax_Util.head_and_args t1)
in (match (uu____3385) with
| (hd1, uu____3401) -> begin
(match (hd1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_uvar (uv, uu____3423) -> begin
(appears uv goals)
end
| uu____3448 -> begin
false
...
let sub_goals = (FStar_All.pipe_right implicits1 (FStar_List.map (fun uu____3490 -> (match (uu____3490) with
| (_msg, _env, _uvar, term, typ, uu____3508) -> begin
(

let uu___158_3509 = goal
in (

let uu____3510 = (bnorm goal.FStar_Tactics_Types.context term)
in (

let uu____3511 = (bnorm goal.FStar_Tactics_Types.context typ)
in {FStar_Tactics_Types.context = uu___158_3509.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu____3510; FStar_Tactics_Types.goal_ty = uu____3511; FStar_Tactics_Types.opts = uu___158_3509.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___158_3509.FStar_Tactics_Types.is_guard})))
end))))
in (
...
let uu____3549 = (f x xs1)
in (match (uu____3549) with
| true -> begin
(

let uu____3552 = (filter' f xs1)
in (x)::uu____3552)
end
| uu____3555 -> begin
(filter' f xs1)
...
let uu____3566 = (checkone g.FStar_Tactics_Types.witness goals)
in (not (uu____3566)))) sub_goals)
in (

let uu____3567 = (add_goal_from_guard "apply_lemma guard" goal.FStar_Tactics_Types.context guard goal.FStar_Tactics_Types.opts)
in (bind uu____3567 (fun uu____3572 -> (
...
let uu____3578 = (FStar_Syntax_Util.mk_squash pre)
in (istrivial goal.FStar_Tactics_Types.context uu____3578))
in (not (uu____3577)))
...
in (bind uu____3573 (fun uu____3583 -> (add_goals sub_goals1)))))))))))))))))))))
end)))
end))))
end))
end)
...
in (focus uu____2650))
in (FStar_All.pipe_left (wrap_err "apply_lemma") uu____2647)))
...
let uu____3604 = (FStar_Syntax_Util.destruct_typ_as_formula typ)
in (match (uu____3604) with
| FStar_Pervasives_Native.Some (FStar_Syntax_Util.BaseConn (l, (uu____3614)::((e1, uu____3616))::((e2, uu____3618))::[])) when (FStar_Ident.lid_equals l FStar_Parser_Const.eq2_lid) -> begin
...
let uu____3700 = (destruct_eq' typ)
...
let uu____3730 = (FStar_Syntax_Util.un_squash typ)
...
let uu____3788 = (FStar_TypeChecker_Env.pop_bv e1)
...
let uu____3836 = (aux e')
in (FStar_Util.map_opt uu____3836 (fun uu____3860 -> (match (uu____3860) with
| (e'', bvs) -> begin
((e''), ((bv')::bvs))
end))))
end)
...
let uu____3881 = (aux e)
in (FStar_Util.map_opt uu____3881 (fun uu____3905 -> (match (uu____3905) with
| (e', bvs) -> begin
...
let uu____3966 = (split_env b1 g.FStar_Tactics_Types.context)
in (FStar_Util.map_opt uu____3966 (fun uu____3990 -> (match (uu____3990) with
| (e0, bvs) -> begin
(

let s1 = (fun bv -> (

let uu___159_4007 = bv
in (

let uu____4008 = (FStar_Syntax_Subst.subst s bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___159_4007.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___159_4007.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4008})))
in (
...
let uu___160_4017 = g
in {FStar_Tactics_Types.context = c; FStar_Tactics_Types.witness = w; FStar_Tactics_Types.goal_ty = t; FStar_Tactics_Types.opts = uu___160_4017.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___160_4017.FStar_Tactics_Types.is_guard}))))))
end)))))
...
let uu____4040 = (FStar_Syntax_Print.bv_to_string bv)
in (

let uu____4041 = (FStar_Syntax_Print.term_to_string bv.FStar_Syntax_Syntax.sort)
in (FStar_Util.print2 "+++Rewrite %s : %s\n" uu____4040 uu____4041)))) (fun uu____4044 -> (

let uu____4045 = (split_env bv goal.FStar_Tactics_Types.context)
...
let uu____4074 = (destruct_eq bv.FStar_Syntax_Syntax.sort)
...
let uu____4090 = (FStar_Syntax_Subst.compress x)
in uu____4090.FStar_Syntax_Syntax.n)
...
let uu___161_4103 = bv1
in (

let uu____4104 = (FStar_Syntax_Subst.subst s bv1.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___161_4103.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___161_4103.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4104})))
in (
...
let uu___162_4111 = goal
in (

let uu____4112 = (push_bvs e0 ((bv)::bvs1))
in (

let uu____4113 = (FStar_Syntax_Subst.subst s goal.FStar_Tactics_Types.witness)
in (

let uu____4114 = (FStar_Syntax_Subst.subst s goal.FStar_Tactics_Types.goal_ty)
in {FStar_Tactics_Types.context = uu____4112; FStar_Tactics_Types.witness = uu____4113; FStar_Tactics_Types.goal_ty = uu____4114; FStar_Tactics_Types.opts = uu___162_4111.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___162_4111.FStar_Tactics_Types.is_guard}))))
in (replace_cur uu____4110)))))
end
| uu____4115 -> begin
...
let uu___163_4151 = bv
in {FStar_Syntax_Syntax.ppname = (FStar_Ident.mk_ident ((s), (bv.FStar_Syntax_Syntax.ppname.FStar_Ident.idRange))); FStar_Syntax_Syntax.index = uu___163_4151.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___163_4151.FStar_Syntax_Syntax.sort}))
in (
...
let uu____4163 = (FStar_Syntax_Syntax.bv_to_name bv')
in ((bv), (uu____4163)))
in FStar_Syntax_Syntax.NT (uu____4156))
in (uu____4155)::[])
in (

let uu____4164 = (subst_goal bv bv' s1 goal)
...
let uu____4189 = (split_env bv goal.FStar_Tactics_Types.context)
...
let uu____4218 = (FStar_Syntax_Util.type_u ())
in (match (uu____4218) with
| (ty, u) -> begin
(

let uu____4227 = (new_uvar "binder_retype" e0 ty)
in (bind uu____4227 (fun t' -> (

let bv'' = (

let uu___164_4237 = bv
in {FStar_Syntax_Syntax.ppname = uu___164_4237.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___164_4237.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t'})
in (
...
let uu____4249 = (FStar_Syntax_Syntax.bv_to_name bv'')
in ((bv), (uu____4249)))
in FStar_Syntax_Syntax.NT (uu____4242))
in (uu____4241)::[])
in (

let bvs1 = (FStar_List.map (fun b1 -> (

let uu___165_4257 = b1
in (

let uu____4258 = (FStar_Syntax_Subst.subst s b1.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___165_4257.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___165_4257.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____4258}))) bvs)
in (

let env' = (push_bvs e0 ((bv'')::bvs1))
in (bind dismiss (fun uu____4264 -> (
...
let uu___166_4272 = goal
in (

let uu____4273 = (FStar_Syntax_Subst.subst s goal.FStar_Tactics_Types.witness)
in (

let uu____4274 = (FStar_Syntax_Subst.subst s goal.FStar_Tactics_Types.goal_ty)
in {FStar_Tactics_Types.context = env'; FStar_Tactics_Types.witness = uu____4273; FStar_Tactics_Types.goal_ty = uu____4274; FStar_Tactics_Types.opts = uu___166_4272.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___166_4272.FStar_Tactics_Types.is_guard})))
in (uu____4271)::[])
in (add_goals uu____4268))
in (bind uu____4265 (fun uu____4277 -> (

let uu____4278 = (FStar_Syntax_Util.mk_eq2 (FStar_Syntax_Syntax.U_succ (u)) ty bv.FStar_Syntax_Syntax.sort t')
in (add_irrelevant_goal "binder_retype equation" e0 uu____4278 goal.FStar_Tactics_Types.opts))))))))))))))
end))
end))
end)))))
...
let uu____4306 = (split_env bv goal.FStar_Tactics_Types.context)
...
let uu____4338 = (FStar_TypeChecker_Normalize.tr_norm_steps s)
in (FStar_List.append ((FStar_TypeChecker_Normalize.Reify)::(FStar_TypeChecker_Normalize.UnfoldTac)::[]) uu____4338))
in (
...
let uu___167_4343 = bv
in {FStar_Syntax_Syntax.ppname = uu___167_4343.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___167_4343.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = sort'})
in (

let env' = (push_bvs e0 ((bv')::bvs))
in (replace_cur (

let uu___168_4347 = goal
in {FStar_Tactics_Types.context = env'; FStar_Tactics_Types.witness = uu___168_4347.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___168_4347.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___168_4347.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___168_4347.FStar_Tactics_Types.is_guard}))))))
end))
end)))))
...
let uu____4353 = (FStar_TypeChecker_Env.pop_bv goal.FStar_Tactics_Types.context)
...
let uu____4375 = (FStar_Syntax_Syntax.mk_Total goal.FStar_Tactics_Types.goal_ty)
in (FStar_Syntax_Util.arrow ((((x), (FStar_Pervasives_Native.None)))::[]) uu____4375))
in (

let w' = (FStar_Syntax_Util.abs ((((x), (FStar_Pervasives_Native.None)))::[]) goal.FStar_Tactics_Types.witness FStar_Pervasives_Native.None)
in (replace_cur (

let uu___169_4409 = goal
in {FStar_Tactics_Types.context = env'; FStar_Tactics_Types.witness = w'; FStar_Tactics_Types.goal_ty = typ'; FStar_Tactics_Types.opts = uu___169_4409.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___169_4409.FStar_Tactics_Types.is_guard}))))
end))))


let revert_hd : name  ->  Prims.unit tac = (fun x -> (bind cur_goal (fun goal -> (

let uu____4421 = (FStar_TypeChecker_Env.pop_bv goal.FStar_Tactics_Types.context)
...
let uu____4442 = (FStar_Syntax_Print.bv_to_string x)
in (

let uu____4443 = (FStar_Syntax_Print.bv_to_string y)
in (fail2 "Cannot revert_hd %s; head variable mismatch ... egot %s" uu____4442 uu____4443)))
end
| uu____4444 -> begin
revert
end)
...
let uu____4450 = (FStar_TypeChecker_Env.pop_bv goal.FStar_Tactics_Types.context)
...
let uu____4472 = (FStar_Util.set_mem x fns_ty)
...
let uu____4476 = (new_uvar "clear_top" env' goal.FStar_Tactics_Types.goal_ty)
in (bind uu____4476 (fun u -> (

let uu____4482 = (

let uu____4483 = (trysolve goal u)
in (not (uu____4483)))
...
let uu___170_4488 = goal
in (

let uu____4489 = (bnorm env' u)
in {FStar_Tactics_Types.context = env'; FStar_Tactics_Types.witness = uu____4489; FStar_Tactics_Types.goal_ty = uu___170_4488.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___170_4488.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___170_4488.FStar_Tactics_Types.is_guard}))
in (bind dismiss (fun uu____4491 -> (add_goals ((new_goal)::[])))))
end)))))
end)))
end))))
...
let uu____4503 = (FStar_TypeChecker_Env.pop_bv goal.FStar_Tactics_Types.context)
...
| uu____4524 -> begin
(bind revert (fun uu____4527 -> (

let uu____4528 = (clear b)
in (bind uu____4528 (fun uu____4532 -> (bind intro (fun uu____4534 -> (ret ()))))))))
end)
end)))))
...
let uu___171_4551 = g
in {FStar_Tactics_Types.context = ctx'; FStar_Tactics_Types.witness = uu___171_4551.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___171_4551.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___171_4551.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___171_4551.FStar_Tactics_Types.is_guard})
in (bind dismiss (fun uu____4553 -> (add_goals ((g')::[]))))))))))
...
let uu___172_4570 = g
in {FStar_Tactics_Types.context = ctx'; FStar_Tactics_Types.witness = uu___172_4570.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___172_4570.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___172_4570.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___172_4570.FStar_Tactics_Types.is_guard})
in (bind dismiss (fun uu____4572 -> (add_goals ((g')::[]))))))))))
...
let uu____4614 = (f x)
in (bind uu____4614 (fun y -> (

let uu____4622 = (mapM f xs)
in (bind uu____4622 (fun ys -> (ret ((y)::ys))))))))
end))
...
let uu____4672 = (FStar_Syntax_Subst.compress t)
in uu____4672.FStar_Syntax_Syntax.n)
in (

let uu____4675 = (match ((Prims.op_Equality d FStar_Tactics_Types.TopDown)) with
| true -> begin
(f env (

let uu___174_4681 = t
in {FStar_Syntax_Syntax.n = tn; FStar_Syntax_Syntax.pos = uu___174_4681.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___174_4681.FStar_Syntax_Syntax.vars}))
end
| uu____4682 -> begin
(ret t)
end)
in (bind uu____4675 (fun t1 -> (

let tn1 = (

let uu____4689 = (

let uu____4690 = (FStar_Syntax_Subst.compress t1)
in uu____4690.FStar_Syntax_Syntax.n)
...
let uu____4722 = (ff hd1)
in (bind uu____4722 (fun hd2 -> (

let fa = (fun uu____4742 -> (match (uu____4742) with
| (a, q) -> begin
(

let uu____4755 = (ff a)
in (bind uu____4755 (fun a1 -> (ret ((a1), (q))))))
end))
in (

let uu____4768 = (mapM fa args)
in (bind uu____4768 (fun args1 -> (ret (FStar_Syntax_Syntax.Tm_app (((hd2), (args1)))))))))))))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t2, k) -> begin
(

let uu____4828 = (FStar_Syntax_Subst.open_term bs t2)
...
let uu____4840 = (FStar_TypeChecker_Env.push_binders env bs1)
in (tac_fold_env d f uu____4840 t'))
in (bind uu____4837 (fun t'' -> (

let uu____4844 = (

let uu____4845 = (

let uu____4862 = (FStar_Syntax_Subst.close_binders bs1)
in (

let uu____4863 = (FStar_Syntax_Subst.close bs1 t'')
in ((uu____4862), (uu____4863), (k))))
in FStar_Syntax_Syntax.Tm_abs (uu____4845))
in (ret uu____4844)))))
end))
end
...
let uu___173_4891 = t1
in {FStar_Syntax_Syntax.n = tn2; FStar_Syntax_Syntax.pos = uu___173_4891.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___173_4891.FStar_Syntax_Syntax.vars})
...
let uu____4925 = (FStar_TypeChecker_TcTerm.tc_term env t)
...
let uu____4940 = (FStar_Syntax_Util.is_pure_or_ghost_lcomp lcomp)
in (not (uu____4940))) || (

let uu____4942 = (FStar_TypeChecker_Rel.is_trivial g)
in (not (uu____4942))))
...
let uu____4952 = (new_uvar "pointwise_rec" env typ)
in (bind uu____4952 (fun ut -> ((log ps (fun uu____4963 -> (

let uu____4964 = (FStar_Syntax_Print.term_to_string t1)
in (

let uu____4965 = (FStar_Syntax_Print.term_to_string ut)
...
let uu____4970 = (FStar_TypeChecker_TcTerm.universe_of env typ)
in (FStar_Syntax_Util.mk_eq2 uu____4970 typ t1 ut))
in (add_irrelevant_goal "pointwise_rec equation" env uu____4969 opts))
in (bind uu____4966 (fun uu____4973 -> (

let uu____4974 = (bind tau (fun uu____4980 -> (

let ut1 = (FStar_TypeChecker_Normalize.reduce_uvar_solutions env ut)
in ((log ps (fun uu____4986 -> (

let uu____4987 = (FStar_Syntax_Print.term_to_string t1)
in (

let uu____4988 = (FStar_Syntax_Print.term_to_string ut1)
...
let uu____4989 = (trytac rewrite_eq)
in (bind uu____4989 (fun x -> (match (x) with
| FStar_Pervasives_Native.None -> begin
(ret t1)
end
...
let uu____5026 = (match (ps.FStar_Tactics_Types.goals) with
| (g)::gs -> begin
((g), (gs))
end
| [] -> begin
...
in ((log ps (fun uu____5063 -> (

let uu____5064 = (FStar_Syntax_Print.term_to_string gt1)
in (FStar_Util.print1 "Pointwise starting with %s\n" uu____5064))));
(bind dismiss_all (fun uu____5067 -> (

let uu____5068 = (tac_fold_env d (pointwise_rec ps tau g.FStar_Tactics_Types.opts) g.FStar_Tactics_Types.context gt1)
in (bind uu____5068 (fun gt' -> ((log ps (fun uu____5078 -> (

let uu____5079 = (FStar_Syntax_Print.term_to_string gt')
in (FStar_Util.print1 "Pointwise seems to have succeded with %s\n" uu____5079))));
(

let uu____5080 = (push_goals gs)
in (bind uu____5080 (fun uu____5084 -> (add_goals (((

let uu___175_5086 = g
in {FStar_Tactics_Types.context = uu___175_5086.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu___175_5086.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = gt'; FStar_Tactics_Types.opts = uu___175_5086.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___175_5086.FStar_Tactics_Types.is_guard}))::[])))));
))))));
))
end)))))
...
let uu____5106 = (FStar_Syntax_Util.un_squash g.FStar_Tactics_Types.goal_ty)
in (match (uu____5106) with
| FStar_Pervasives_Native.Some (t) -> begin
(

let uu____5118 = (FStar_Syntax_Util.head_and_args' t)
...
let uu____5165 = (FStar_Syntax_Util.un_uinst hd1)
in uu____5165.FStar_Syntax_Syntax.n)
in ((uu____5164), (args)))
in (match (uu____5151) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____5179)::((l, uu____5181))::((r, uu____5183))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.eq2_lid) -> begin
(

let uu____5230 = (

let uu____5231 = (do_unify g.FStar_Tactics_Types.context l r)
in (not (uu____5231)))
in (match (uu____5230) with
| true -> begin
(

let uu____5234 = (FStar_TypeChecker_Normalize.term_to_string g.FStar_Tactics_Types.context l)
in (

let uu____5235 = (FStar_TypeChecker_Normalize.term_to_string g.FStar_Tactics_Types.context r)
in (fail2 "trefl: not a trivial equality (%s vs %s)" uu____5234 uu____5235)))
end
| uu____5236 -> begin
(solve g FStar_Syntax_Util.exp_unit)
end))
end
| (hd2, uu____5238) -> begin
(

let uu____5255 = (FStar_TypeChecker_Normalize.term_to_string g.FStar_Tactics_Types.context t)
in (fail1 "trefl: not an equality (%s)" uu____5255))
end))
end))
end
| FStar_Pervasives_Native.None -> begin
...
let uu____5263 = (new_uvar "dup" g.FStar_Tactics_Types.context g.FStar_Tactics_Types.goal_ty)
in (bind uu____5263 (fun u -> (

let g' = (

let uu___176_5270 = g
in {FStar_Tactics_Types.context = uu___176_5270.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = u; FStar_Tactics_Types.goal_ty = uu___176_5270.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___176_5270.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___176_5270.FStar_Tactics_Types.is_guard})
in (bind dismiss (fun uu____5273 -> (

let uu____5274 = (

let uu____5277 = (

let uu____5278 = (FStar_TypeChecker_TcTerm.universe_of g.FStar_Tactics_Types.context g.FStar_Tactics_Types.goal_ty)
in (FStar_Syntax_Util.mk_eq2 uu____5278 g.FStar_Tactics_Types.goal_ty u g.FStar_Tactics_Types.witness))
in (add_irrelevant_goal "dup equation" g.FStar_Tactics_Types.context uu____5277 g.FStar_Tactics_Types.opts))
in (bind uu____5274 (fun uu____5281 -> (

let uu____5282 = (add_goals ((g')::[]))
in (bind uu____5282 (fun uu____5286 -> (ret ())))))))))))))))
...
let uu___177_5303 = ps
in {FStar_Tactics_Types.main_context = uu___177_5303.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___177_5303.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___177_5303.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = (g2)::(g1)::gs; FStar_Tactics_Types.smt_goals = uu___177_5303.FStar_Tactics_Types.smt_goals; FStar_Tactics_Types.depth = uu___177_5303.FStar_Tactics_Types.depth; FStar_Tactics_Types.__dump = uu___177_5303.FStar_Tactics_Types.__dump; FStar_Tactics_Types.psc = uu___177_5303.FStar_Tactics_Types.psc}))
end
| uu____5304 -> begin
...
let uu___178_5319 = ps
in {FStar_Tactics_Types.main_context = uu___178_5319.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___178_5319.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___178_5319.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = (FStar_List.append gs ((g)::[])); FStar_Tactics_Types.smt_goals = uu___178_5319.FStar_Tactics_Types.smt_goals; FStar_Tactics_Types.depth = uu___178_5319.FStar_Tactics_Types.depth; FStar_Tactics_Types.__dump = uu___178_5319.FStar_Tactics_Types.__dump; FStar_Tactics_Types.psc = uu___178_5319.FStar_Tactics_Types.psc}))
end)))
...
let uu____5345 = (bind cur_goal (fun g -> (

let uu____5359 = (__tc g.FStar_Tactics_Types.context t)
in (bind uu____5359 (fun uu____5395 -> (match (uu____5395) with
| (t1, typ, guard) -> begin
(

let uu____5411 = (FStar_Syntax_Util.head_and_args typ)
...
let uu____5468 = (FStar_Syntax_Util.un_uinst hd1)
in uu____5468.FStar_Syntax_Syntax.n)
in ((uu____5467), (args)))
in (match (uu____5454) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((p, uu____5487))::((q, uu____5489))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.or_lid) -> begin
(
...
let uu____5528 = (FStar_TypeChecker_Env.push_bv g.FStar_Tactics_Types.context v_p)
in {FStar_Tactics_Types.context = uu____5528; FStar_Tactics_Types.witness = uu___179_5527.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___179_5527.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___179_5527.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___179_5527.FStar_Tactics_Types.is_guard}))
in (
...
let uu____5531 = (FStar_TypeChecker_Env.push_bv g.FStar_Tactics_Types.context v_q)
in {FStar_Tactics_Types.context = uu____5531; FStar_Tactics_Types.witness = uu___180_5530.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___180_5530.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___180_5530.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___180_5530.FStar_Tactics_Types.is_guard}))
in (bind dismiss (fun uu____5538 -> (

let uu____5539 = (add_goals ((g1)::(g2)::[]))
in (bind uu____5539 (fun uu____5548 -> (

let uu____5549 = (

let uu____5554 = (FStar_Syntax_Syntax.bv_to_name v_p)
in (

let uu____5555 = (FStar_Syntax_Syntax.bv_to_name v_q)
in ((uu____5554), (uu____5555))))
in (ret uu____5549)))))))))))
end
| uu____5560 -> begin
(

let uu____5573 = (FStar_TypeChecker_Normalize.term_to_string g.FStar_Tactics_Types.context typ)
in (fail1 "Not a disjunction: %s" uu____5573))
end))
end))
end))))))
in (FStar_All.pipe_left (wrap_err "cases") uu____5345)))


let set_options : Prims.string  ->  Prims.unit tac = (fun s -> (bind cur_goal (fun g -> ((FStar_Options.push ());
(

let uu____5612 = (FStar_Util.smap_copy g.FStar_Tactics_Types.opts)
in (FStar_Options.set uu____5612));
(
...
let uu___181_5619 = g
in {FStar_Tactics_Types.context = uu___181_5619.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu___181_5619.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___181_5619.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = opts'; FStar_Tactics_Types.is_guard = uu___181_5619.FStar_Tactics_Types.is_guard})
in (replace_cur g'))
end
...
let uu____5725 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_left FStar_Pervasives_Native.fst uu____5725))
in (new_uvar "uvar_env.2" env uu____5724))
end)
in (bind uu____5718 (fun typ -> (

let uu____5737 = (new_uvar "uvar_env" env typ)
in (bind uu____5737 (fun t -> (ret t))))))))


let unshelve : FStar_Syntax_Syntax.term  ->  Prims.unit tac = (fun t -> (

let uu____5750 = (bind cur_goal (fun goal -> (

let uu____5756 = (__tc goal.FStar_Tactics_Types.context t)
in (bind uu____5756 (fun uu____5776 -> (match (uu____5776) with
| (t1, typ, guard) -> begin
(

let uu____5788 = (must_trivial goal.FStar_Tactics_Types.context guard)
in (bind uu____5788 (fun uu____5793 -> (

let uu____5794 = (

let uu____5797 = (

let uu___182_5798 = goal
in (

let uu____5799 = (bnorm goal.FStar_Tactics_Types.context t1)
in (

let uu____5800 = (bnorm goal.FStar_Tactics_Types.context typ)
in {FStar_Tactics_Types.context = uu___182_5798.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu____5799; FStar_Tactics_Types.goal_ty = uu____5800; FStar_Tactics_Types.opts = uu___182_5798.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = false})))
in (uu____5797)::[])
in (add_goals uu____5794)))))
end))))))
in (FStar_All.pipe_left (wrap_err "unshelve") uu____5750)))


let unify : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  Prims.bool tac = (fun t1 t2 -> (bind get (fun ps -> (

let uu____5820 = (do_unify ps.FStar_Tactics_Types.main_context t1 t2)
in (ret uu____5820)))))


let launch_process : Prims.string  ->  Prims.string  ->  Prims.string  ->  Prims.string tac = (fun prog args input -> (bind idtac (fun uu____5840 -> (

let uu____5841 = (FStar_Options.unsafe_tactic_exec ())
in (match (uu____5841) with
| true -> begin
(

let s = (FStar_Util.launch_process true "tactic_launch" prog args input (fun uu____5847 uu____5848 -> false))
in (ret s))
end
| uu____5849 -> begin
...
let uu____5870 = (FStar_TypeChecker_Util.new_implicit_var "proofstate_of_goal_ty" typ.FStar_Syntax_Syntax.pos env typ)
in (match (uu____5870) with
| (u, uu____5888, g_u) -> begin
(

let g = (

let uu____5903 = (FStar_Options.peek ())
in {FStar_Tactics_Types.context = env; FStar_Tactics_Types.witness = u; FStar_Tactics_Types.goal_ty = typ; FStar_Tactics_Types.opts = uu____5903; FStar_Tactics_Types.is_guard = false})
in ((g), (g_u)))
end)))
...
let uu____5920 = (goal_of_goal_ty env typ)
