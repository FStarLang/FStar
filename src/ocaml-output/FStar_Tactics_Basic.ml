      ...
      (fun goal  ->
         ...
         let steps =
           ...
           FStar_List.append
             ...
             FStar_TypeChecker_Normalize.UnfoldTac] uu____2222
            in
         let w =
                  ...
                  then fail "exact: got non-trivial guard"
                    ...
                    (let uu____2364 =
                     ...
                     then (solve goal t1; dismiss)
                       ...
                       (let uu____2369 = FStar_Syntax_Print.term_to_string t1
                           in
                        let uu____2370 =
  ...
  fun t  ->
    bind cur_goal
      (fun goal  ->
         let uu____2384 =
           try
             let uu____2412 = FStar_TypeChecker_TcTerm.tc_term goal.context t
                in
             ret uu____2412
           with
           | e ->
...
let rec __apply : Prims.bool -> FStar_Syntax_Syntax.term -> Prims.unit tac =
  fun uopt  ->
    fun tm  ->
      bind cur_goal
        (fun goal  ->
           let uu____2646 = let uu____2651 = exact tm  in trytac uu____2651
              in
           bind uu____2646
             (fun r  ->
                match r with
                           ...
                           let uu____2677 =
                             let uu____2678 =
                               FStar_TypeChecker_Rel.discharge_guard
                                ...
                                in
                             FStar_All.pipe_left
                               FStar_TypeChecker_Rel.is_trivial uu____2678
                              in
                           Prims.op_Negation uu____2677  in
                         if uu____2676
                         then fail "apply: got non-trivial guard"
                         else
                           (let uu____2682 = FStar_Syntax_Util.arrow_one typ
                               in
                                        ...
                                        | (u,g_u) ->
                                            let tm' =
                                              FStar_Syntax_Syntax.mk_Tm_app
                                               ...
                                               in
                                            let uu____2752 = __apply uopt tm'
                                               in
                                            bind uu____2752
                                              (fun uu____2759  ->
                                                 let uu____2760 =
                                                   let uu____2761 =
                                                     ...
                                                     FStar_Syntax_Subst.compress
                                                       uu____2764
                                                      in
                                                   uu____2761.FStar_Syntax_Syntax.n
                                                    in
                            ...
                            | (pre,post) ->
                                let uu____3317 =
                                  ...
                                  FStar_TypeChecker_Rel.try_teq false
                                    goal.context uu____3320 goal.goal_ty
                                   in
                                                        ...
                                                        let uu____3454 =
                                                          let uu____3455 =
                                                            FStar_Syntax_Subst.compress
                                                              hd1
                                                             in
                                                          uu____3455.FStar_Syntax_Syntax.n
                                                           in
                                                        (match uu____3454
                                                         with
                                                         | FStar_Syntax_Syntax.Tm_uvar
                ...
                let uu____3950 =
                  let uu____3951 =
                    FStar_TypeChecker_Env.lookup_bv goal.context
                      (FStar_Pervasives_Native.fst h)
                     in
                  FStar_All.pipe_left FStar_Pervasives_Native.fst uu____3951
                   in
                ...
                (fun hd2  ->
                   let fa uu____4391 =
                     ...
                     | (a,q) ->
                         ...
                         bind uu____4404 (fun a1  -> ret (a1, q))
                      in
                     ...
                     (fun t''  ->
                        let uu____4493 =
                          let uu____4494 =
                            ...
                            let uu____4512 = FStar_Syntax_Subst.close bs1 t''
                               in
      ...
      fun opts  ->
        fun env  ->
          fun t  ->
            ...
            | (t1,lcomp,g) ->
                let uu____4578 =
                  (let uu____4581 = FStar_Syntax_Util.is_total_lcomp lcomp
                      in
                ...
                (match uu____4783 with
                 | (FStar_Syntax_Syntax.Tm_fvar
                    fv,uu____4811::(l,uu____4813)::(r,uu____4815)::[]) when
                     ...
                     if uu____4862
                     then
                       let uu____4866 = FStar_Syntax_Print.term_to_string l
                          in
                       let uu____4867 = FStar_Syntax_Print.term_to_string r
                          in
                         ...
                         (fun uu____5162  ->
                            ...
                            bind uu____5163
                              (fun uu____5172  ->
                                 ...
                                 ret uu____5173))
                   | uu____5184 ->
                       let uu____5197 = FStar_Syntax_Print.term_to_string typ
                          in
    ...
    fun typ  ->
      ...
      | (u,uu____5281,g_u) ->
          let g =
            ...
            { context = env; witness = u; goal_ty = typ; opts = uu____5296 }
             in
          let ps =
            {
              main_context = env;
