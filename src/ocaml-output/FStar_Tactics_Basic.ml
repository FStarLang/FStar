    ...
    bind cur_goal
      (fun goal  ->
         mlog
           ...
           (fun uu____2190  ->
              let steps =
                let uu____2194 = FStar_TypeChecker_Normalize.tr_norm_steps s
                   in
                FStar_List.append
                  [FStar_TypeChecker_Normalize.Reify;
    ...
    fun tm  ->
      fun typ  ->
        bind cur_goal
          (fun goal  ->
             let uu____2650 =
               let uu____2655 = t_exact false true tm  in trytac uu____2655
                in
             bind uu____2650
               (fun uu___59_2662  ->
      ...
      let uu____2858 =
        mlog
          ...
          (fun uu____2866  ->
             bind cur_goal
               (fun goal  ->
                  let uu____2870 = __tc goal.FStar_Tactics_Types.context tm
                     in
                  bind uu____2870
                    (fun uu____2891  ->
      ...
      let uu____2934 =
        mlog
          ...
          (fun uu____2943  ->
             ...
             bind cur_goal
               (fun goal  ->
                  let uu____2957 = __tc goal.FStar_Tactics_Types.context tm
                     in
                  bind uu____2957
                    (fun uu____2979  ->
                                                             ...
                                                             (mapM
                                                                (fun
                                                                   ...
                                                                   (_msg,env,_uvar,term,typ,uu____3682)
                                                                    ...
                                                                    FStar_Syntax_Subst.compress
                                                                    hd1  in
                                                                    uu____3731.FStar_Syntax_Syntax.n
                                                                     in
                                                                    (match uu____3730
                                                                    with
                                                                    | 
                  ...
                  | FStar_Pervasives_Native.Some (e0,bvs) ->
                      ...
                      (match uu____4486 with
                       | FStar_Pervasives_Native.Some (x,e) ->
                           let uu____4501 =
                             let uu____4502 = FStar_Syntax_Subst.compress x
                                in
                           ...
                           (match uu____4501 with
                            | FStar_Syntax_Syntax.Tm_name x1 ->
                                ...
                                let uu____4522 =
                                  ...
                                  let uu____4524 = push_bvs e0 (bv :: bvs1)
                                     in
                                  let uu____4525 =
                                    FStar_Syntax_Subst.subst s
                                      goal.FStar_Tactics_Types.witness
  ...
  fun b  ->
    bind cur_goal
      (fun goal  ->
         ...
         | (bv,uu____4597) ->
             let uu____4598 = split_env bv goal.FStar_Tactics_Types.context
                in
    ...
    bind cur_goal
      (fun goal  ->
         mlog
           ...
           (fun uu____4856  ->
              let uu____4857 = split_env bv goal.FStar_Tactics_Types.context
                 in
      ...
      bind get
        (fun ps  ->
           ...
           | (g,gs) ->
               ...
               (log ps
                  (fun uu____5418  ->
                     let uu____5419 = FStar_Syntax_Print.term_to_string gt1
                        in
                ...
                (match uu____5508 with
                 | (FStar_Syntax_Syntax.Tm_fvar
                    fv,uu____5536::(l,uu____5538)::(r,uu____5540)::[]) when
                     ...
                     if uu____5587
                     then
                       let uu____5591 = tts g.FStar_Tactics_Types.context l
                          in
                       let uu____5592 = tts g.FStar_Tactics_Types.context r
                          in
                ...
                | (t1,typ,guard) ->
                    ...
                    (match uu____5775 with
                     | (hd1,args) ->
                         let uu____5818 =
                           let uu____5831 =
                             let uu____5832 = FStar_Syntax_Util.un_uinst hd1
                                in
...
let set_options : Prims.string -> Prims.unit tac =
  fun s  ->
    bind cur_goal
      (fun g  ->
         FStar_Options.push ();
         (let uu____5975 = FStar_Util.smap_copy g.FStar_Tactics_Types.opts
             in
             ...
             then
               let s =
                 FStar_Util.launch_process true "tactic_launch" prog args
                   input (fun uu____6208  -> fun uu____6209  -> false)
                  in
               ret s
             else
               fail
