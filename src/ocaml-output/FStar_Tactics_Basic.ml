  ...
  fun reason  ->
    fun env  ->
      fun phi  ->
        fun opts  ->
          let typ =
            let uu____1399 = env.FStar_TypeChecker_Env.universe_of env phi
               in
  ...
  fun e  ->
    fun g  ->
      try
        let uu____1504 =
          let uu____1505 =
            let uu____1506 = FStar_TypeChecker_Rel.discharge_guard_no_smt e g
               in
            FStar_All.pipe_left FStar_TypeChecker_Rel.is_trivial uu____1506
             in
           ...
           bind uu____1529
             (fun uu____1549  ->
                ...
                | (t1,typ,guard) ->
                    ...
                    bind uu____1561 (fun uu____1565  -> ret typ)))
       in
             ...
             let uu____1744 =
               try
                 let uu____1778 =
                   ...
                   FStar_List.splitAt uu____1787 p.FStar_Tactics_Types.goals
                    in
                 ret uu____1778
      ...
      let uu____2053 =
        bind t1
          (fun uu____2058  ->
             ...
             bind uu____2059 (fun uu____2067  -> ret ()))
         in
      focus uu____2053
                 ...
                 (fun u  ->
                    let lb =
                      ...
                      FStar_Syntax_Util.mk_letbinding (FStar_Util.Inl bv) []
                        goal.FStar_Tactics_Types.goal_ty
                        FStar_Parser_Const.effect_Tot_lid uu____2203
                       in
    ...
    bind cur_goal
      (fun goal  ->
         let steps =
           ...
           FStar_List.append
             [FStar_TypeChecker_Normalize.Reify;
             FStar_TypeChecker_Normalize.UnfoldTac] uu____2302
            in
         let w =
         ...
         | (t,FStar_Pervasives_Native.Some (bv,phi)) ->
             ...
             (match uu____2427 with
              | (bv1,phi1) ->
                  ...
                  bind uu____2459
                    (fun g2  ->
                       bind dismiss (fun uu____2466  -> add_goals [g1; g2]))))
     in
                    ...
                    | FStar_Util.Inl e ->
                        ...
                        bind uu____2594
                          (fun uu___284_2617  ->
                             ...
                             | FStar_Util.Inr r -> ret ()
                             | FStar_Util.Inl uu____2625 -> fail e)))
           in
    ...
    fun tm  ->
      fun typ  ->
        bind cur_goal
          (fun goal  ->
             let uu____2750 =
               let uu____2755 = t_exact false true tm  in trytac uu____2755
                in
             bind uu____2750
               (fun uu___286_2762  ->
                                             ...
                                             let uu____2841 =
                                               let uu____2842 =
                                                 ...
                                                 FStar_Syntax_Subst.compress
                                                   uu____2845
                                                  in
                                               uu____2842.FStar_Syntax_Syntax.n
                                                in
      ...
      let uu____2958 =
        mlog
          ...
          (fun uu____2966  ->
             bind cur_goal
               (fun goal  ->
                  let uu____2970 = __tc goal.FStar_Tactics_Types.context tm
                     in
                  bind uu____2970
                    (fun uu____2991  ->
                       ...
                       | (tm1,typ,guard) ->
                           ...
                           let uu____3014 =
                             ...
                             fail3
                              ...
                              in
                           try_unif uu____3003 uu____3014)))
         in
                                         ...
                                         let uu____3432 =
                                           let uu____3441 =
                                             FStar_Syntax_Util.comp_to_comp_typ
                                               comp1
                                              in
                                           uu____3441.FStar_Syntax_Syntax.effect_args
                                            in
            ...
            then FStar_Pervasives_Native.Some (e', [])
              ...
              (let uu____4365 = aux e'  in
               FStar_Util.map_opt uu____4365
                 (fun uu____4389  ->
                    match uu____4389 with | (e'',bvs) -> (e'', (bv' :: bvs))))
         in
                  ...
                  | FStar_Pervasives_Native.Some (e0,bvs) ->
                      ...
                      (match uu____4596 with
                       | FStar_Pervasives_Native.Some (x,e) ->
                           let uu____4611 =
                             let uu____4612 = FStar_Syntax_Subst.compress x
                                in
                           ...
                           (match uu____4611 with
                            | FStar_Syntax_Syntax.Tm_name x1 ->
                                ...
                                let uu____4632 =
                                  ...
                                  let uu____4634 = push_bvs e0 (bv :: bvs1)
                                     in
                                  let uu____4635 =
                                    FStar_Syntax_Subst.subst s
                                      goal.FStar_Tactics_Types.witness
    ...
    fun b  ->
      bind cur_goal
        (fun goal  ->
           ...
           | (bv,uu____4822) ->
               let uu____4823 = split_env bv goal.FStar_Tactics_Types.context
                  in
               (match uu____4823 with
                ...
                | FStar_Pervasives_Native.Some (e0,bvs) ->
                    let steps =
                      ...
                      FStar_List.append
                        [FStar_TypeChecker_Normalize.Reify;
                        FStar_TypeChecker_Normalize.UnfoldTac] uu____4855
                       in
                    let sort' =
                       ...
                       (fun hd2  ->
                          let fa uu____5187 =
                            ...
                            | (a,q) ->
                                ...
                                bind uu____5200 (fun a1  -> ret (a1, q))
                             in
                             ...
                             let uu____5409 =
                               let uu____5410 =
                                 FStar_TypeChecker_TcTerm.universe_of env typ
                                  in
                               FStar_Syntax_Util.mk_eq2 uu____5410 typ t1 ut
                                in
      ...
      bind get
        (fun ps  ->
           ...
           | (g,gs) ->
               ...
               (log ps
                  (fun uu____5508  ->
                     let uu____5509 = FStar_Syntax_Print.term_to_string gt1
                        in
                ...
                (match uu____5596 with
                 | (FStar_Syntax_Syntax.Tm_fvar
                    fv,uu____5624::(l,uu____5626)::(r,uu____5628)::[]) when
                     ...
                     if uu____5675
                     then
                       let uu____5679 = tts g.FStar_Tactics_Types.context l
                          in
                       let uu____5680 = tts g.FStar_Tactics_Types.context r
                          in
                ...
                | (t1,typ,guard) ->
                    ...
                    (match uu____5855 with
                     | (hd1,args) ->
                         let uu____5898 =
                           let uu____5911 =
                             let uu____5912 = FStar_Syntax_Util.un_uinst hd1
                                in
                         ...
                         (match uu____5898 with
                          ...
                          | uu____6004 ->
                              ...
                              fail1 "Not a disjunction: %s" uu____6017))))
       in
...
let set_options : Prims.string -> Prims.unit tac =
  fun s  ->
    bind cur_goal
      (fun g  ->
         FStar_Options.push ();
         (let uu____6055 = FStar_Util.smap_copy g.FStar_Tactics_Types.opts
             in
    ...
    fun ty  ->
      let uu____6157 =
        ...
        | FStar_Pervasives_Native.None  ->
            ...
            new_uvar "uvar_env.2" env uu____6163
         in
      bind uu____6157
        (fun typ  ->
             ...
             then
               let s =
                 FStar_Util.launch_process true "tactic_launch" prog args
                   input (fun uu____6280  -> fun uu____6281  -> false)
                  in
               ret s
             else
               fail
