...
let (bnorm_goal : FStar_Tactics_Types.goal -> FStar_Tactics_Types.goal) =
  fun g  ->
    let uu___ =
      ...
      let uu___2 = FStar_Tactics_Types.goal_type g  in bnorm uu___1 uu___2
       in
...
let (destruct_eq' :
  ...
  fun typ  ->
    ...
    | FStar_Pervasives_Native.Some (FStar_Syntax_Util.BaseConn
        (l,uu___1::(e1,FStar_Pervasives_Native.None )::(e2,FStar_Pervasives_Native.None
                                                        )::[]))
        when
              ...
              | (hd,args) ->
                  ...
                  (match uu___4 with
                   | (FStar_Syntax_Syntax.Tm_fvar
                      fv,(uu___5,FStar_Pervasives_Native.Some
                          (FStar_Syntax_Syntax.Implicit uu___6))::(e1,FStar_Pervasives_Native.None
                                                                   )::
      ...
      fun t2  ->
        let uu___ =
          FStar_Tactics_Monad.mk_tac
            (fun ps  ->
               let tx = FStar_Syntax_Unionfind.new_transaction ()  in
               FStar_Tactics_Result.Success (tx, ps))
           in
        FStar_Tactics_Monad.bind uu___
          (fun tx  ->
  ...
  fun goal  ->
    fun solution  ->
      ...
      | FStar_Pervasives_Native.Some uu___1 ->
          let uu___2 =
            let uu___3 = FStar_Tactics_Printing.goal_to_string_verbose goal
               in
             ...
             (fun uu___  ->
                ...
                try
                  (fun uu___1  ->
                     match () with
                     | () ->
                         let uu___2 = FStar_TypeChecker_TcTerm.tc_term e2 t
                            in
                         FStar_Tactics_Monad.ret uu___2) ()
                with
                | FStar_Errors.Err (uu___2,msg) ->
          ...
          (fun uu___2  ->
             ...
             | (uu___3,lc,uu___4) ->
                 let uu___5 =
                   ...
                   FStar_All.pipe_right uu___6 FStar_Pervasives_Native.fst
                    in
                             ...
                             (fun a1  ->
                                FStar_Tactics_Monad.bind
                                  ...
                                  (fun lp'  ->
                                     ...
                                     let uu___4 = FStar_Tactics_Monad.set rp
                                        in
  ...
  fun tau  ->
    FStar_Tactics_Monad.bind FStar_Tactics_Monad.get
      (fun p  ->
         ...
         | uu___::uu___1 ->
             let uu___2 =
               let uu___3 = map tau  in divide FStar_BigInt.one tau uu___3
                in
             FStar_Tactics_Monad.bind uu___2
               (fun uu___3  ->
                  match uu___3 with
        ...
        (fun goal  ->
           ...
           | FStar_Pervasives_Native.Some (b,c) ->
               ...
               then FStar_Tactics_Monad.fail "Codomain is effectful"
                 ...
                 (let env' =
                  ...
                  let uu___5 = FStar_Tactics_Monad.new_uvar "intro" env' typ'
                     in
           ...
           | FStar_Pervasives_Native.None  ->
               let uu___3 =
                 ...
                 let uu___5 = FStar_Tactics_Types.goal_type goal  in
                 tts uu___4 uu___5  in
               fail1 "goal is not an arrow (%s)" uu___3)
       in
                ...
                (let bv =
                 ...
                 FStar_Tactics_Monad.bind uu___6
                   (fun uu___7  ->
                      ...
                      | (u,ctx_uvar_u) ->
                          let lb =
                            let uu___8 = FStar_Tactics_Types.goal_type goal
                               in
                            let uu___9 =
                                    ...
                                    let uu___11 =
                                      let uu___12 =
                                        bnorm_goal
                                         ...
                                         in
                                      FStar_Tactics_Monad.replace_cur uu___12
                                       in
         ...
         FStar_Tactics_Monad.mlog
           ...
           (fun uu___  ->
              let steps =
                ...
                FStar_List.append
                  [FStar_TypeChecker_Env.Reify;
                  FStar_TypeChecker_Env.UnfoldTac] uu___1
                 in
              let t =
                      ...
                      (fun uu___3  ->
                         ...
                         | (t1,uu___4,uu___5) ->
                             let steps =
                               ...
                               FStar_List.append
                                 [FStar_TypeChecker_Env.Reify;
                                 FStar_TypeChecker_Env.UnfoldTac] uu___6
                                in
                             let t2 =
                               normalize steps
                             ...
                             FStar_Tactics_Monad.mlog
                               (fun uu___6  ->
                                  ...
                                  FStar_Util.print1
                                    "norm_term_env: t' = %s\n" uu___7)
                               (fun uu___6  -> FStar_Tactics_Monad.ret t2))))
           in
           ...
           FStar_Tactics_Monad.bind uu___
             (fun uu___1  ->
                ...
                | (t1,typ,guard) ->
                    FStar_Tactics_Monad.mlog
                      (fun uu___2  ->
                         let uu___3 = FStar_Syntax_Print.term_to_string typ
                            in
                         let uu___4 =
                           let uu___5 = FStar_Tactics_Types.goal_env goal  in
                           FStar_TypeChecker_Rel.guard_to_string uu___5 guard
                            in
                         FStar_Util.print2
                              ...
                              FStar_Tactics_Monad.mlog
                                (fun uu___5  ->
                                   ...
                                   let uu___7 =
                                     ...
                                     FStar_Syntax_Print.term_to_string uu___8
                                      in
                                   FStar_Util.print2
            ...
            (fun uu___1  ->
               FStar_Tactics_Monad.bind FStar_Tactics_Monad.cur_goal
                 (fun goal  ->
                    ...
                    FStar_Tactics_Monad.mlog
                      (fun uu___2  ->
                         let uu___3 = FStar_Syntax_Print.term_to_string tm
                            in
                         let uu___4 =
                           FStar_Tactics_Printing.goal_to_string_verbose goal
                            in
                         let uu___5 =
  ...
  fun bvar  ->
    fun e  ->
      ...
      FStar_Util.map_opt uu___
        (fun uu___1  ->
           match uu___1 with | (e',bv,bvs) -> (e', bv, (FStar_List.rev bvs)))
...
let (subst_goal :
  ...
  fun b1  ->
    fun b2  ->
      fun g  ->
        let uu___ =
          let uu___1 = FStar_Tactics_Types.goal_env g  in split_env b1 uu___1
           in
        match uu___ with
        | FStar_Pervasives_Native.Some (e0,b11,bvs) ->
            ...
            let uu___1 =
              ...
              let uu___3 = FStar_Syntax_Subst.close bs t  in (uu___2, uu___3)
               in
            (match uu___1 with
             | (bs',t') ->
                 let bs'1 =
               ...
               FStar_Tactics_Monad.mlog
                 ...
                 (fun uu___3  ->
                    ...
                    | FStar_Pervasives_Native.Some (e0,bv1,bvs) ->
                        let uu___5 =
                          let uu___6 = whnf e0 bv1.FStar_Syntax_Syntax.sort
                             in
                 ...
                 FStar_Tactics_Monad.bind uu___2
                   (fun uu___3  ->
                      ...
                      | FStar_Pervasives_Native.Some (bv'1,goal1) ->
                          let uu___4 = FStar_Tactics_Monad.replace_cur goal1
                             in
                          FStar_Tactics_Monad.bind uu___4
                            (fun uu___5  -> FStar_Tactics_Monad.ret (bv'1, q))))
         in
                                         ...
                                         let uu___9 =
                                           let uu___10 =
                                             FStar_Tactics_Types.goal_type
                                               goal
                                              in
                                           FStar_Syntax_Subst.subst s uu___10
                                            in
                 ...
                 (match uu___3 with
                  ...
                  | FStar_Pervasives_Native.Some (e0,bv1,bvs) ->
                      let steps =
                        ...
                        FStar_List.append
                          [FStar_TypeChecker_Env.Reify;
                          FStar_TypeChecker_Env.UnfoldTac] uu___4
                         in
                      let sort' =
                      ...
                      FStar_Tactics_Monad.replace_cur uu___4))
         in
           ...
           (fun uu___  ->
              ...
              | FStar_Pervasives_Native.Some (e',bv1,bvs) ->
                  let rec check bvs1 =
                    ...
                    | [] -> FStar_Tactics_Monad.ret ()
                    | bv'::bvs2 ->
                        let uu___2 = free_in bv1 bv'.FStar_Syntax_Syntax.sort
                           in
                        if uu___2
                        then
                          let uu___3 =
                            let uu___4 = FStar_Syntax_Print.bv_to_string bv'
                               in
                            FStar_Util.format1
                    ...
                    (let uu___4 = check bvs  in
                     FStar_Tactics_Monad.bind uu___4
                       (fun uu___5  ->
                          ...
                          let uu___6 =
                            let uu___7 = FStar_Tactics_Types.goal_type goal
                               in
                ...
                then solve' g FStar_Syntax_Util.exp_unit
                  ...
                  (let l1 =
                     ...
                     FStar_TypeChecker_Normalize.normalize
                       ...
                       FStar_TypeChecker_Env.Primops;
                       FStar_TypeChecker_Env.UnfoldTac] uu___2 l
                      in
                   let r1 =
                     let uu___2 = FStar_Tactics_Types.goal_env g  in
                     FStar_TypeChecker_Normalize.normalize
                       [FStar_TypeChecker_Env.UnfoldUntil
                          FStar_Syntax_Syntax.delta_constant;
                       FStar_TypeChecker_Env.Primops;
                       FStar_TypeChecker_Env.UnfoldTac] uu___2 r
                      in
                   let uu___2 =
                     let uu___3 = FStar_Tactics_Types.goal_env g  in
                   ...
                   FStar_Tactics_Monad.bind uu___2
                     (fun b1  ->
                        ...
                        then solve' g FStar_Syntax_Util.exp_unit
                          ...
                          (let uu___4 =
                             let uu___5 =
                               let uu___6 = FStar_Tactics_Types.goal_env g
                                  in
                               tts uu___6  in
        ...
        (fun g  ->
           ...
           | FStar_Pervasives_Native.None  ->
               let uu___3 =
                 ...
                 let uu___5 = FStar_Tactics_Types.goal_type g  in
                 tts uu___4 uu___5  in
               fail1 "not an equality (%s)" uu___3)
       in
                  ...
                  FStar_Tactics_Monad.bind FStar_Tactics_Monad.dismiss
                    (fun uu___3  ->
                       let t_eq =
                         let uu___4 =
                           let uu___5 = FStar_Tactics_Types.goal_type g  in
                           env1.FStar_TypeChecker_Env.universe_of env1 uu___5
                            in
                         let uu___5 = FStar_Tactics_Types.goal_type g  in
                       ...
                       FStar_Tactics_Monad.bind uu___4
                         (fun uu___5  ->
                            let uu___6 = FStar_Tactics_Monad.add_goals [g']
                               in
                            FStar_Tactics_Monad.bind uu___6
           ...
           | FStar_Pervasives_Native.Some phi2 ->
               ...
               (match uu___2 with
                | (gamma,r1,r2) ->
                    ...
                    let uu___3 = set_solution g1 FStar_Syntax_Util.exp_unit
                       in
                    FStar_Tactics_Monad.bind uu___3
                      (fun uu___4  ->
                         let uu___5 =
                         ...
                         FStar_Tactics_Monad.bind uu___5
                           (fun uu___6  ->
                              ...
                              let nenv =
                                let uu___7 = FStar_Tactics_Types.goal_env g1
                                   in
                                let uu___8 =
    ...
    let uu___ =
      FStar_Tactics_Monad.bind FStar_Tactics_Monad.get
        (fun ps  ->
           ...
           | uu___2 -> FStar_Tactics_Monad.fail "not a uvar")
       in
                    ...
                    | (t11,ty1,g1) ->
                        ...
                        FStar_Tactics_Monad.bind uu___3
                          (fun uu___4  ->
                             match uu___4 with
                             | (t21,ty2,g2) ->
                                 let uu___5 = proc_guard "match_env g1" e g1
                                    in
                                 FStar_Tactics_Monad.bind uu___5
                                   (fun uu___6  ->
                                      let uu___7 =
                                      ...
                                      FStar_Tactics_Monad.bind uu___7
                                        (fun uu___8  ->
                                           let uu___9 = do_match e ty1 ty2
                                              in
                                           let uu___10 = do_match e t11 t21
                                              in
                                           tac_and uu___9 uu___10)))))
           in
                    ...
                    | (t11,ty1,g1) ->
                        ...
                        FStar_Tactics_Monad.bind uu___3
                          (fun uu___4  ->
                             match uu___4 with
                             | (t21,ty2,g2) ->
                                 let uu___5 = proc_guard "unify_env g1" e g1
                                    in
                                 FStar_Tactics_Monad.bind uu___5
                                   (fun uu___6  ->
                                      let uu___7 =
                                      ...
                                      FStar_Tactics_Monad.bind uu___7
                                        (fun uu___8  ->
                                           let uu___9 = do_unify e ty1 ty2
                                              in
                                           let uu___10 = do_unify e t11 t21
                                              in
                                           tac_and uu___9 uu___10)))))
           in
  ...
  fun s_tm  ->
    let uu___ =
      FStar_Tactics_Monad.bind FStar_Tactics_Monad.cur_goal
        (fun g  ->
           let uu___1 =
             let uu___2 = FStar_Tactics_Types.goal_env g  in __tc uu___2 s_tm
              in
           FStar_Tactics_Monad.bind uu___1
             (fun uu___2  ->
                match uu___2 with
                    ...
                    FStar_Tactics_Monad.bind uu___3
                      (fun uu___4  ->
                         ...
                         | (h,args) ->
                             let uu___6 =
                               let uu___7 =
                                 let uu___8 = FStar_Syntax_Subst.compress h
                                    in
                               ...
                               | FStar_Syntax_Syntax.Tm_uinst
                                   ({
                                      ...
                                      FStar_Syntax_Syntax.vars = uu___9;_},us)
                                                              ...
                                                              let uu___13 =
                                                                FStar_Tactics_Monad.mapM
                                                                  (fun c_lid 
                                                                    ...
                                                                    with
                                                                    | 
                                                                    (uu___25,uu___26,uu___27,uu___28,pat_t,uu___29,_guard_pat,_erasable)
                                                                    ->
                                                                    let eq_b
                                                                    =
                                                                    let uu___30
                 ...
                 (match lb.FStar_Syntax_Syntax.lbname with
                  | FStar_Util.Inr uu___3 ->
                      FStar_All.pipe_left FStar_Tactics_Monad.ret
                        FStar_Reflection_Data.Tv_Unknown
                  | FStar_Util.Inl bv ->
                      let uu___3 = FStar_Syntax_Subst.open_let_rec [lb] t21
                         in
                      (match uu___3 with
                       | (lbs,t22) ->
                           (match lbs with
               ...
               let brs2 =
                 FStar_List.map
                   (fun uu___2  ->
                      match uu___2 with
                      | (pat,uu___3,t5) ->
                          let uu___4 = inspect_pat pat  in (uu___4, t5)) brs1
                  in
               FStar_All.pipe_left FStar_Tactics_Monad.ret
...
let (pack :
  ...
  fun tv  ->
    ...
    | FStar_Reflection_Data.Tv_Abs (b,t) ->
        let uu___ = FStar_Syntax_Util.abs [b] t FStar_Pervasives_Native.None
           in
        FStar_All.pipe_left FStar_Tactics_Monad.ret uu___
    | FStar_Reflection_Data.Tv_Arrow (b,c) ->
        ...
        let uu___ =
          let uu___1 =
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  let uu___5 = FStar_Syntax_Syntax.mk_binder bv  in [uu___5]
                   in
          ...
          (match uu___1 with
           | (ctx_uvar,uu___2) ->
               let g =
                 ...
                 FStar_Tactics_Types.mk_goal env1 ctx_uvar uu___3 false ""
                  in
               (g, g_u))
        ...
        let ps =
          ...
          let uu___1 = FStar_Util.psmap_empty ()  in
          {
            ...
            FStar_Tactics_Types.__dump =
              (fun ps1  ->
                 fun msg  ->
                   FStar_Tactics_Printing.do_dump_proofstate ps1 msg);
            FStar_Tactics_Types.psc = FStar_TypeChecker_Cfg.null_psc;
            FStar_Tactics_Types.entry_range = rng;
            FStar_Tactics_Types.guard_policy = FStar_Tactics_Types.SMT;
            FStar_Tactics_Types.freshness = Prims.int_zero;
