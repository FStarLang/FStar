...
in {FStar_Tactics_Types.main_context = uu___88_793.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___88_793.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___88_793.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = uu____794; FStar_Tactics_Types.smt_goals = uu___88_793.FStar_Tactics_Types.smt_goals}))
in (set uu____792))))
...
let uu___89_803 = p
in {FStar_Tactics_Types.main_context = uu___89_803.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___89_803.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___89_803.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = []; FStar_Tactics_Types.smt_goals = uu___89_803.FStar_Tactics_Types.smt_goals}))))


let add_goals : FStar_Tactics_Types.goal Prims.list  ->  Prims.unit tac = (fun gs -> (bind get (fun p -> (set (

let uu___90_820 = p
in {FStar_Tactics_Types.main_context = uu___90_820.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___90_820.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___90_820.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = (FStar_List.append gs p.FStar_Tactics_Types.goals); FStar_Tactics_Types.smt_goals = uu___90_820.FStar_Tactics_Types.smt_goals})))))


let add_smt_goals : FStar_Tactics_Types.goal Prims.list  ->  Prims.unit tac = (fun gs -> (bind get (fun p -> (set (

let uu___91_837 = p
in {FStar_Tactics_Types.main_context = uu___91_837.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___91_837.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___91_837.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = uu___91_837.FStar_Tactics_Types.goals; FStar_Tactics_Types.smt_goals = (FStar_List.append gs p.FStar_Tactics_Types.smt_goals)})))))


let push_goals : FStar_Tactics_Types.goal Prims.list  ->  Prims.unit tac = (fun gs -> (bind get (fun p -> (set (

let uu___92_854 = p
in {FStar_Tactics_Types.main_context = uu___92_854.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___92_854.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___92_854.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = (FStar_List.append p.FStar_Tactics_Types.goals gs); FStar_Tactics_Types.smt_goals = uu___92_854.FStar_Tactics_Types.smt_goals})))))


let push_smt_goals : FStar_Tactics_Types.goal Prims.list  ->  Prims.unit tac = (fun gs -> (bind get (fun p -> (set (

let uu___93_871 = p
in {FStar_Tactics_Types.main_context = uu___93_871.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___93_871.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___93_871.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = uu___93_871.FStar_Tactics_Types.goals; FStar_Tactics_Types.smt_goals = (FStar_List.append p.FStar_Tactics_Types.smt_goals gs)})))))
...
let uu___94_894 = p
in {FStar_Tactics_Types.main_context = uu___94_894.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___94_894.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = (FStar_List.append i p.FStar_Tactics_Types.all_implicits); FStar_Tactics_Types.goals = uu___94_894.FStar_Tactics_Types.goals; FStar_Tactics_Types.smt_goals = uu___94_894.FStar_Tactics_Types.smt_goals})))))
...
let uu___95_1117 = goal
in {FStar_Tactics_Types.context = uu___95_1117.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu___95_1117.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___95_1117.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___95_1117.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = true})
in (push_goals ((goal1)::[]))))))
end))
end)))
...
let uu____1175 = (FStar_All.try_with (fun uu___100_1198 -> (match (()) with
| () -> begin
(

let uu____1209 = (FStar_List.splitAt n1 p.FStar_Tactics_Types.goals)
in (ret uu____1209))
end)) (fun uu___99_1228 -> (match (uu___99_1228) with
| uu____1239 -> begin
...
let uu___96_1292 = p
in {FStar_Tactics_Types.main_context = uu___96_1292.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___96_1292.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___96_1292.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = lgs; FStar_Tactics_Types.smt_goals = []})
in (

let rp = (

let uu___97_1294 = p
in {FStar_Tactics_Types.main_context = uu___97_1294.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___97_1294.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___97_1294.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = rgs; FStar_Tactics_Types.smt_goals = []})
in (
...
let uu___98_1341 = p
in {FStar_Tactics_Types.main_context = uu___98_1341.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___98_1341.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___98_1341.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = (FStar_List.append lp'.FStar_Tactics_Types.goals rp'.FStar_Tactics_Types.goals); FStar_Tactics_Types.smt_goals = (FStar_List.append lp'.FStar_Tactics_Types.smt_goals (FStar_List.append rp'.FStar_Tactics_Types.smt_goals p.FStar_Tactics_Types.smt_goals))})
in (
...
in {FStar_Tactics_Types.context = env'; FStar_Tactics_Types.witness = uu____1551; FStar_Tactics_Types.goal_ty = uu____1552; FStar_Tactics_Types.opts = uu___101_1550.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___101_1550.FStar_Tactics_Types.is_guard})))
...
in {FStar_Tactics_Types.context = env'; FStar_Tactics_Types.witness = uu____1686; FStar_Tactics_Types.goal_ty = uu____1687; FStar_Tactics_Types.opts = uu___102_1685.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___102_1685.FStar_Tactics_Types.is_guard})))
...
let uu___103_1747 = goal
in {FStar_Tactics_Types.context = uu___103_1747.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = w; FStar_Tactics_Types.goal_ty = t; FStar_Tactics_Types.opts = uu___103_1747.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___103_1747.FStar_Tactics_Types.is_guard}))))))))
...
let uu____1909 = (FStar_All.try_with (fun uu___107_1928 -> (match (()) with
| () -> begin
(

let uu____1937 = (FStar_TypeChecker_TcTerm.tc_term goal.FStar_Tactics_Types.context t)
in (ret uu____1937))
end)) (fun uu___106_1954 -> (match (uu___106_1954) with
| e -> begin
(
...
in {FStar_Tactics_Types.context = uu___108_2332.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu____2333; FStar_Tactics_Types.goal_ty = uu____2334; FStar_Tactics_Types.opts = uu___108_2332.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = false})))
in (uu____2331)::[])
...
let try_unif : 'a . 'a tac  ->  'a tac  ->  'a tac = (fun t t' -> (mk_tac (fun ps -> (FStar_All.try_with (fun uu___110_2366 -> (match (()) with
| () -> begin
(run t ps)
end)) (fun uu___109_2370 -> (match (uu___109_2370) with
| NoUnif -> begin
(run t' ps)
end))))))
...
in {FStar_Tactics_Types.context = uu___111_3249.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu____3250; FStar_Tactics_Types.goal_ty = uu____3251; FStar_Tactics_Types.opts = uu___111_3249.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___111_3249.FStar_Tactics_Types.is_guard})))
end))))
in (
...
in {FStar_Tactics_Types.context = uu___112_3559.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu____3560; FStar_Tactics_Types.goal_ty = uu____3561; FStar_Tactics_Types.opts = uu___112_3559.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___112_3559.FStar_Tactics_Types.is_guard})))
...
let uu___113_3614 = bv
in (

let uu____3615 = (FStar_Syntax_Subst.subst s bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___113_3614.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___113_3614.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3615}))
...
let uu___114_3621 = g
in {FStar_Tactics_Types.context = c; FStar_Tactics_Types.witness = w; FStar_Tactics_Types.goal_ty = t; FStar_Tactics_Types.opts = uu___114_3621.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___114_3621.FStar_Tactics_Types.is_guard}))))))
...
let uu___115_3650 = bv
in {FStar_Syntax_Syntax.ppname = (FStar_Ident.mk_ident ((s), (bv.FStar_Syntax_Syntax.ppname.FStar_Ident.idRange))); FStar_Syntax_Syntax.index = uu___115_3650.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___115_3650.FStar_Syntax_Syntax.sort}))
in (
...
let uu___116_3725 = goal
in {FStar_Tactics_Types.context = env'; FStar_Tactics_Types.witness = w'; FStar_Tactics_Types.goal_ty = typ'; FStar_Tactics_Types.opts = uu___116_3725.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___116_3725.FStar_Tactics_Types.is_guard}))))
end))))
...
let uu___117_3804 = goal
in (

let uu____3805 = (bnorm env' u)
in {FStar_Tactics_Types.context = env'; FStar_Tactics_Types.witness = uu____3805; FStar_Tactics_Types.goal_ty = uu___117_3804.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___117_3804.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___117_3804.FStar_Tactics_Types.is_guard}))
...
let uu___118_3867 = g
in {FStar_Tactics_Types.context = ctx'; FStar_Tactics_Types.witness = uu___118_3867.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___118_3867.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___118_3867.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___118_3867.FStar_Tactics_Types.is_guard})
...
let uu___119_3886 = g
in {FStar_Tactics_Types.context = ctx'; FStar_Tactics_Types.witness = uu___119_3886.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___119_3886.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___119_3886.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___119_3886.FStar_Tactics_Types.is_guard})
...
let uu___120_4185 = t
in {FStar_Syntax_Syntax.n = tn2; FStar_Syntax_Syntax.pos = uu___120_4185.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___120_4185.FStar_Syntax_Syntax.vars})))))))
...
let uu____4229 = (FStar_Syntax_Util.is_total_lcomp lcomp)
in (not (uu____4229))) || (

let uu____4231 = (FStar_TypeChecker_Rel.is_trivial g)
in (not (uu____4231))))
...
let uu____4238 = (new_uvar env typ)
in (bind uu____4238 (fun ut -> ((log ps (fun uu____4249 -> (

let uu____4250 = (FStar_Syntax_Print.term_to_string t1)
in (

let uu____4251 = (FStar_Syntax_Print.term_to_string ut)
...
let uu____4256 = (FStar_TypeChecker_TcTerm.universe_of env typ)
in (FStar_Syntax_Util.mk_eq2 uu____4256 typ t1 ut))
in (add_irrelevant_goal env uu____4255 opts))
in (bind uu____4252 (fun uu____4259 -> (

let uu____4260 = (bind tau (fun uu____4265 -> (
...
let uu____4286 = (match (ps.FStar_Tactics_Types.goals) with
| (g)::gs -> begin
((g), (gs))
end
| [] -> begin
...
in ((log ps (fun uu____4323 -> (

let uu____4324 = (FStar_Syntax_Print.term_to_string gt1)
in (FStar_Util.print1 "Pointwise starting with %s\n" uu____4324))));
(bind dismiss_all (fun uu____4327 -> (

let uu____4328 = (tac_bottom_fold_env (pointwise_rec ps tau g.FStar_Tactics_Types.opts) g.FStar_Tactics_Types.context gt1)
in (bind uu____4328 (fun gt' -> ((log ps (fun uu____4338 -> (

let uu____4339 = (FStar_Syntax_Print.term_to_string gt')
in (FStar_Util.print1 "Pointwise seems to have succeded with %s\n" uu____4339))));
(

let uu____4340 = (push_goals gs)
in (bind uu____4340 (fun uu____4344 -> (add_goals (((

let uu___121_4346 = g
in {FStar_Tactics_Types.context = uu___121_4346.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu___121_4346.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = gt'; FStar_Tactics_Types.opts = uu___121_4346.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___121_4346.FStar_Tactics_Types.is_guard}))::[])))));
))))));
))
end)))))
...
let uu____4366 = (FStar_Syntax_Util.un_squash g.FStar_Tactics_Types.goal_ty)
in (match (uu____4366) with
| FStar_Pervasives_Native.Some (t) -> begin
(

let uu____4378 = (FStar_Syntax_Util.head_and_args' t)
...
let uu____4425 = (FStar_Syntax_Util.un_uinst hd1)
in uu____4425.FStar_Syntax_Syntax.n)
in ((uu____4424), (args)))
in (match (uu____4411) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____4439)::((l, uu____4441))::((r, uu____4443))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.eq2_lid) -> begin
(

let uu____4490 = (

let uu____4491 = (FStar_TypeChecker_Rel.teq_nosmt g.FStar_Tactics_Types.context l r)
in (not (uu____4491)))
in (match (uu____4490) with
| true -> begin
(

let uu____4494 = (FStar_Syntax_Print.term_to_string l)
in (

let uu____4495 = (FStar_Syntax_Print.term_to_string r)
in (fail2 "trefl: not a trivial equality (%s vs %s)" uu____4494 uu____4495)))
end
| uu____4496 -> begin
...
| (hd2, uu____4499) -> begin
(

let uu____4516 = (FStar_Syntax_Print.term_to_string t)
in (fail1 "trefl: not an equality (%s)" uu____4516))
end))
end))
end
| FStar_Pervasives_Native.None -> begin
...
let uu____4524 = (new_uvar g.FStar_Tactics_Types.context g.FStar_Tactics_Types.goal_ty)
in (bind uu____4524 (fun u -> (

let g' = (

let uu___122_4531 = g
in {FStar_Tactics_Types.context = uu___122_4531.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = u; FStar_Tactics_Types.goal_ty = uu___122_4531.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___122_4531.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___122_4531.FStar_Tactics_Types.is_guard})
in (bind dismiss (fun uu____4534 -> (

let uu____4535 = (

let uu____4538 = (

let uu____4539 = (FStar_TypeChecker_TcTerm.universe_of g.FStar_Tactics_Types.context g.FStar_Tactics_Types.goal_ty)
in (FStar_Syntax_Util.mk_eq2 uu____4539 g.FStar_Tactics_Types.goal_ty u g.FStar_Tactics_Types.witness))
in (add_irrelevant_goal g.FStar_Tactics_Types.context uu____4538 g.FStar_Tactics_Types.opts))
in (bind uu____4535 (fun uu____4542 -> (

let uu____4543 = (add_goals ((g')::[]))
in (bind uu____4543 (fun uu____4547 -> (ret ())))))))))))))))
...
let uu___123_4564 = ps
in {FStar_Tactics_Types.main_context = uu___123_4564.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___123_4564.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___123_4564.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = (g2)::(g1)::gs; FStar_Tactics_Types.smt_goals = uu___123_4564.FStar_Tactics_Types.smt_goals}))
end
| uu____4565 -> begin
...
let uu___124_4580 = ps
in {FStar_Tactics_Types.main_context = uu___124_4580.FStar_Tactics_Types.main_context; FStar_Tactics_Types.main_goal = uu___124_4580.FStar_Tactics_Types.main_goal; FStar_Tactics_Types.all_implicits = uu___124_4580.FStar_Tactics_Types.all_implicits; FStar_Tactics_Types.goals = (FStar_List.append gs ((g)::[])); FStar_Tactics_Types.smt_goals = uu___124_4580.FStar_Tactics_Types.smt_goals}))
end)))
...
let uu____4629 = (g.FStar_Tactics_Types.context.FStar_TypeChecker_Env.type_of g.FStar_Tactics_Types.context t)
in (match (uu____4629) with
| (t1, typ, guard) -> begin
(

let uu____4645 = (FStar_Syntax_Util.head_and_args typ)
...
let uu____4702 = (FStar_Syntax_Util.un_uinst hd1)
in uu____4702.FStar_Syntax_Syntax.n)
in ((uu____4701), (args)))
in (match (uu____4688) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((p, uu____4721))::((q, uu____4723))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.or_lid) -> begin
(
...
let uu____4762 = (FStar_TypeChecker_Env.push_bv g.FStar_Tactics_Types.context v_p)
in {FStar_Tactics_Types.context = uu____4762; FStar_Tactics_Types.witness = uu___125_4761.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___125_4761.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___125_4761.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___125_4761.FStar_Tactics_Types.is_guard}))
in (
...
let uu____4765 = (FStar_TypeChecker_Env.push_bv g.FStar_Tactics_Types.context v_q)
in {FStar_Tactics_Types.context = uu____4765; FStar_Tactics_Types.witness = uu___126_4764.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___126_4764.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = uu___126_4764.FStar_Tactics_Types.opts; FStar_Tactics_Types.is_guard = uu___126_4764.FStar_Tactics_Types.is_guard}))
in (bind dismiss (fun uu____4772 -> (

let uu____4773 = (add_goals ((g1)::(g2)::[]))
in (bind uu____4773 (fun uu____4782 -> (

let uu____4783 = (

let uu____4788 = (FStar_Syntax_Syntax.bv_to_name v_p)
in (

let uu____4789 = (FStar_Syntax_Syntax.bv_to_name v_q)
...
let uu____4807 = (FStar_Syntax_Print.term_to_string typ)
in (fail1 "Not a disjunction: %s" uu____4807))
end))
end))
end)))))
...
let uu____4830 = (FStar_Util.smap_copy g.FStar_Tactics_Types.opts)
in (FStar_Options.set uu____4830));
(
...
let uu___127_4837 = g
in {FStar_Tactics_Types.context = uu___127_4837.FStar_Tactics_Types.context; FStar_Tactics_Types.witness = uu___127_4837.FStar_Tactics_Types.witness; FStar_Tactics_Types.goal_ty = uu___127_4837.FStar_Tactics_Types.goal_ty; FStar_Tactics_Types.opts = opts'; FStar_Tactics_Types.is_guard = uu___127_4837.FStar_Tactics_Types.is_guard})
in (replace_cur g'))
end
...
let uu____4878 = (goal.FStar_Tactics_Types.context.FStar_TypeChecker_Env.type_of env tm)
...
let uu____4914 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_left FStar_Pervasives_Native.fst uu____4914))
in (new_uvar env uu____4913))
end)
in (bind uu____4907 (fun typ -> (

let uu____4926 = (new_uvar env typ)
in (bind uu____4926 (fun t -> (ret t))))))))


let unify : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  Prims.bool tac = (fun t1 t2 -> (bind get (fun ps -> (

let uu____4946 = (FStar_TypeChecker_Rel.teq_nosmt ps.FStar_Tactics_Types.main_context t1 t2)
in (ret uu____4946)))))


let launch_process : Prims.string  ->  Prims.string  ->  Prims.string  ->  Prims.string tac = (fun prog args input -> (bind idtac (fun uu____4966 -> (

let uu____4967 = (FStar_Options.unsafe_tactic_exec ())
in (match (uu____4967) with
| true -> begin
(

let s = (FStar_Util.launch_process true "tactic_launch" prog args input (fun uu____4973 uu____4974 -> false))
in (ret s))
end
| uu____4975 -> begin
...
let uu____4996 = (FStar_TypeChecker_Util.new_implicit_var "proofstate_of_goal_ty" typ.FStar_Syntax_Syntax.pos env typ)
in (match (uu____4996) with
| (u, uu____5014, g_u) -> begin
(

let g = (

let uu____5029 = (FStar_Options.peek ())
in {FStar_Tactics_Types.context = env; FStar_Tactics_Types.witness = u; FStar_Tactics_Types.goal_ty = typ; FStar_Tactics_Types.opts = uu____5029; FStar_Tactics_Types.is_guard = false})
in ((g), (g_u)))
end)))
...
let uu____5046 = (goal_of_goal_ty env typ)
