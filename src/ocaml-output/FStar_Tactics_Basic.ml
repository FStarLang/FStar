    ...
    fun t1 ->
      fun t2 ->
        ...
        let debug_off uu____1014 =
          let uu____1015 = FStar_Options.set_options FStar_Options.Reset "" in
          () in
        (let uu____1017 =
      ...
      let uu____1194 =
        (let uu____1197 = aux b2 env in Prims.op_Negation uu____1197) &&
          (let uu____1199 = FStar_ST.op_Bang nwarn in
           uu____1199 < (Prims.parse_int "5")) in
      (if uu____1194
       then
         ((let uu____1220 =
             let uu____1225 =
  ...
  fun reason ->
    fun env ->
      fun phi ->
        fun opts ->
          let typ =
            let uu____1578 = env.FStar_TypeChecker_Env.universe_of env phi in
           ...
           mlog
             ...
             (fun uu____1627 ->
                ...
                | FStar_Errors.Err (uu____1674, msg) ->
                    ...
                    let uu____1677 =
                      let uu____1678 = FStar_TypeChecker_Env.all_binders e in
                ...
                | FStar_Errors.Error (uu____1685, msg, uu____1687) ->
                    ...
                    let uu____1689 =
                      let uu____1690 = FStar_TypeChecker_Env.all_binders e in
                ...
                bind get
                  (fun ps ->
                     ...
                     | FStar_Tactics_Types.Goal ->
                         let uu____1788 = mk_irrelevant_goal reason e f opts in
                         bind uu____1788
                           (fun goal ->
                              let goal1 =
                     ...
                     | FStar_Tactics_Types.SMT ->
                         let uu____1796 = mk_irrelevant_goal reason e f opts in
                         bind uu____1796
                           (fun goal ->
                              let goal1 =
                              ...
                              let uu____1812 =
                                let uu____1813 =
                                  FStar_TypeChecker_Rel.discharge_guard_no_smt
                                    e g in
                                FStar_All.pipe_left
                                  FStar_TypeChecker_Rel.is_trivial uu____1813 in
           ...
           bind uu____1848
             (fun uu____1868 ->
                ...
                | (t1, typ, guard) ->
                    ...
                    bind uu____1880 (fun uu____1884 -> ret typ))) in
             ...
             let uu____2024 =
               try
                 let uu____2058 =
                   ...
                   FStar_List.splitAt uu____2067 p.FStar_Tactics_Types.goals in
                 ret uu____2058
      ...
      let uu____2333 =
        bind t1
          (fun uu____2338 ->
             ...
             bind uu____2339 (fun uu____2347 -> ret ())) in
      focus uu____2333
      ...
      (fun goal ->
         ...
         | FStar_Pervasives_Native.None ->
             let uu____2414 =
               tts goal.FStar_Tactics_Types.context
                 goal.FStar_Tactics_Types.goal_ty in
             fail1 "goal is not an arrow (%s)" uu____2414) in
    ...
    bind cur_goal
      (fun goal ->
         mlog
           ...
           (fun uu____2613 ->
              let steps =
                let uu____2617 = FStar_TypeChecker_Normalize.tr_norm_steps s in
                FStar_List.append
                  [FStar_TypeChecker_Normalize.Reify;
                  FStar_TypeChecker_Normalize.UnfoldTac] uu____2617 in
              let w =
         ...
         | (t, FStar_Pervasives_Native.Some (bv, phi)) ->
             ...
             (match uu____2763 with
              | (bv1, phi1) ->
                  ...
                  bind uu____2795
                    (fun g2 ->
                       bind __dismiss (fun uu____2802 -> add_goals [g1; g2])))) in
                  ...
                  | FStar_Util.Inl e ->
                      ...
                      bind uu____2934
                        (fun uu___57_2957 ->
                           ...
                           | FStar_Util.Inr r -> ret ()
                           | FStar_Util.Inl uu____2965 -> fail e))) in
      ...
      let uu____3314 =
        mlog
          ...
          (fun uu____3322 ->
             bind cur_goal
               (fun goal ->
                  let uu____3326 = __tc goal.FStar_Tactics_Types.context tm in
                  bind uu____3326
                    (fun uu____3348 ->
                       ...
                       | (tm1, typ, guard) ->
                           ...
                           try_unif uu____3361 uu____3372))) in
      ...
      let uu____3563 =
        mlog
          ...
          (fun uu____3572 ->
             ...
             bind cur_goal
               (fun goal ->
                  let uu____3586 = __tc goal.FStar_Tactics_Types.context tm in
                  bind uu____3586
                    (fun uu____3609 ->
            ...
            then FStar_Pervasives_Native.Some (e', [])
              ...
              (let uu____4796 = aux e' in
               FStar_Util.map_opt uu____4796
                 (fun uu____4820 ->
                    match uu____4820 with | (e'', bvs) -> (e'', (bv' :: bvs)))) in
                  ...
                  | FStar_Pervasives_Native.Some (e0, bvs) ->
                      ...
                      (match uu____5027 with
                       | FStar_Pervasives_Native.Some (x, e) ->
                           let uu____5042 =
                             let uu____5043 = FStar_Syntax_Subst.compress x in
                           ...
                           (match uu____5042 with
                            | FStar_Syntax_Syntax.Tm_name x1 ->
                                ...
                                let uu____5063 =
                                  ...
                                  let uu____5065 = push_bvs e0 (bv :: bvs1) in
                                  let uu____5066 =
                                    FStar_Syntax_Subst.subst s
                                      goal.FStar_Tactics_Types.witness in
                                  let uu____5067 =
  ...
  fun b ->
    bind cur_goal
      (fun goal ->
         ...
         | (bv, uu____5138) ->
             let uu____5139 = split_env bv goal.FStar_Tactics_Types.context in
    ...
    fun b ->
      bind cur_goal
        (fun goal ->
           ...
           | (bv, uu____5253) ->
               let uu____5254 = split_env bv goal.FStar_Tactics_Types.context in
               (match uu____5254 with
                ...
                | FStar_Pervasives_Native.Some (e0, bvs) ->
                    let steps =
                      ...
                      FStar_List.append
                        [FStar_TypeChecker_Normalize.Reify;
                        FStar_TypeChecker_Normalize.UnfoldTac] uu____5286 in
                    let sort' =
    ...
    bind cur_goal
      (fun goal ->
         mlog
           ...
           (fun uu____5397 ->
              let uu____5398 = split_env bv goal.FStar_Tactics_Types.context in
            ...
            (fun t1 ->
               ...
               let tn1 =
                       ...
                       (fun hd2 ->
                          let fa uu____5643 =
                            ...
                            | (a, q) ->
                                ...
                                bind uu____5656 (fun a1 -> ret (a1, q)) in
                 ...
                 | FStar_Syntax_Syntax.Tm_let
                     ((false,
                       { FStar_Syntax_Syntax.lbname = FStar_Util.Inl bv;
                         ...
                         FStar_Syntax_Syntax.lbpos = uu____5890;_}::[]),
                      e)
                     ->
                     let lb =
                       let uu____5915 =
                 ...
                 | FStar_Syntax_Syntax.Tm_let ((true, lbs), e) ->
                     ...
                     let uu____6011 = FStar_Syntax_Subst.open_let_rec lbs e in
                  ...
                  (let uu____6197 =
                   ...
                   Prims.op_Negation uu____6197) ||
                    (let uu____6199 = FStar_TypeChecker_Rel.is_trivial g in
                     Prims.op_Negation uu____6199) in
                if uu____6194
                then ret t1
                else
                  (let rewrite_eq =
                       ...
                       (fun ut ->
                          ...
                          (let uu____6223 =
                             let uu____6226 =
                               ...
                               FStar_Syntax_Util.mk_eq2 uu____6227 typ t1 ut in
                                  ...
                                  | (bs1, t') ->
                                      let uu____6611 =
                                        let uu____6618 =
                                          FStar_TypeChecker_Env.push_binders
                                            env bs1 in
                                        ctrl_tac_fold f uu____6618 ctrl1 t' in
                                      bind uu____6611
                                        (fun uu____6636 ->
          ...
          | (t, q)::ts1 ->
              ...
              bind uu____6767
                (fun uu____6795 ->
                   ...
                   | (t1, ctrl1) ->
                       let uu____6814 = ctrl_tac_fold_args f env ctrl1 ts1 in
                       bind uu____6814
                         (fun uu____6845 ->
              ...
              let uu____6929 =
                ...
                bind uu____6936
                  (fun uu____6945 ->
                     ...
                     bind uu____6946
                       (fun res -> bind trivial (fun uu____6973 -> ret res))) in
              bind uu____6929
                (fun uu____6989 ->
                                ...
                                (let uu____7032 =
                                 ...
                                 Prims.op_Negation uu____7032) ||
                                  (let uu____7034 =
                                   ...
                                   Prims.op_Negation uu____7034) in
                              if uu____7029
      ...
      bind get
        (fun ps ->
           ...
           | (g, gs) ->
               ...
               (log ps
                  (fun uu____7182 ->
                     let uu____7183 = FStar_Syntax_Print.term_to_string gt1 in
      ...
      bind get
        (fun ps ->
           ...
           | (g, gs) ->
               ...
               (log ps
                  (fun uu____7284 ->
                     let uu____7285 = FStar_Syntax_Print.term_to_string gt1 in
                     FStar_Util.print1 "Pointwise starting with %s\n"
                       uu____7285);
                bind dismiss_all
                  (fun uu____7288 ->
           ...
           (match uu____7339 with
            | (hd1, args) ->
                ...
                (match uu____7372 with
                 | (FStar_Syntax_Syntax.Tm_fvar fv,
                    uu____7400::(l, uu____7402)::(r, uu____7404)::[]) when
                     FStar_Syntax_Syntax.fv_eq_lid fv
                ...
                | (t1, typ, guard) ->
                    ...
                    (match uu____7644 with
                     | (hd1, args) ->
                         let uu____7687 =
                           let uu____7700 =
                             let uu____7701 = FStar_Syntax_Util.un_uinst hd1 in
                             uu____7701.FStar_Syntax_Syntax.n in
                           (uu____7700, args) in
                         (match uu____7687 with
                          | (FStar_Syntax_Syntax.Tm_fvar fv,
                             (p, uu____7720)::(q, uu____7722)::[]) when
                              FStar_Syntax_Syntax.fv_eq_lid fv
                          ...
                          | uu____7793 ->
                              ...
                              fail1 "Not a disjunction: %s" uu____7806)))) in
...
let (set_options : Prims.string -> Prims.unit tac) =
  fun s ->
    bind cur_goal
      (fun g ->
         FStar_Options.push ();
         (let uu____7844 = FStar_Util.smap_copy g.FStar_Tactics_Types.opts in
                  ...
                  | (tm1, typ, guard) ->
                      let uu____7935 =
                        proc_guard "unquote" env guard
                          goal.FStar_Tactics_Types.opts in
                      bind uu____7935 (fun uu____7939 -> ret tm1))) in
    ...
    fun ty ->
      let uu____7958 =
        ...
        | FStar_Pervasives_Native.None ->
            ...
            new_uvar "uvar_env.2" env uu____7964 in
      bind uu____7958
        (fun typ ->
             ...
             then
               let s =
                 FStar_Util.launch_process true "tactic_launch" prog args
                   input (fun uu____8089 -> fun uu____8090 -> false) in
               ret s
             else
               fail
                ...
                let uu____8791 =
                  FStar_List.map
                    (fun uu____8803 ->
                       ...
                       | (p1, uu____8811) -> inspect_pat p1) ps in
                (fv, uu____8791) in
        ...
        let brs2 =
          FStar_List.map
            (fun uu___61_8865 ->
               ...
               | (pat, uu____8887, t4) ->
                   let uu____8905 = inspect_pat pat in (uu____8905, t4)) brs1 in
  ...
  fun tv ->
    ...
    | FStar_Reflection_Data.Tv_Match (t, brs) ->
        ...
        let brs1 =
          FStar_List.map
            (fun uu___62_9246 ->
               match uu___62_9246 with
               | (pat, t1) ->
                   let uu____9263 = pack_pat pat in
                   (uu____9263, FStar_Pervasives_Native.None, t1)) brs in
