    ...
    fun t1  ->
      fun t2  ->
        ...
        let debug_off uu____911 =
          let uu____912 = FStar_Options.set_options FStar_Options.Reset ""
             in
          ()  in
        (let uu____914 =
  ...
  fun reason  ->
    fun env  ->
      fun phi  ->
        fun opts  ->
          let typ =
            let uu____1412 = env.FStar_TypeChecker_Env.universe_of env phi
               in
  ...
  fun e  ->
    fun g  ->
      try
        let uu____1517 =
          let uu____1518 =
            let uu____1519 = FStar_TypeChecker_Rel.discharge_guard_no_smt e g
               in
            FStar_All.pipe_left FStar_TypeChecker_Rel.is_trivial uu____1519
             in
           ...
           bind uu____1542
             (fun uu____1562  ->
                ...
                | (t1,typ,guard) ->
                    ...
                    bind uu____1574 (fun uu____1578  -> ret typ)))
       in
             ...
             let uu____1757 =
               try
                 let uu____1791 =
                   ...
                   FStar_List.splitAt uu____1800 p.FStar_Tactics_Types.goals
                    in
                 ret uu____1791
      ...
      let uu____2066 =
        bind t1
          (fun uu____2071  ->
             ...
             bind uu____2072 (fun uu____2080  -> ret ()))
         in
      focus uu____2066
                 ...
                 (fun u  ->
                    let lb =
                      ...
                      FStar_Syntax_Util.mk_letbinding (FStar_Util.Inl bv) []
                        goal.FStar_Tactics_Types.goal_ty
                        FStar_Parser_Const.effect_Tot_lid uu____2216
                       in
    ...
    bind cur_goal
      (fun goal  ->
         let steps =
           ...
           FStar_List.append
             [FStar_TypeChecker_Normalize.Reify;
             FStar_TypeChecker_Normalize.UnfoldTac] uu____2315
            in
         let w =
         ...
         | (t,FStar_Pervasives_Native.Some (bv,phi)) ->
             ...
             (match uu____2440 with
              | (bv1,phi1) ->
                  ...
                  bind uu____2472
                    (fun g2  ->
                       bind dismiss (fun uu____2479  -> add_goals [g1; g2]))))
     in
                    ...
                    | FStar_Util.Inl e ->
                        ...
                        bind uu____2607
                          (fun uu___55_2630  ->
                             ...
                             | FStar_Util.Inr r -> ret ()
                             | FStar_Util.Inl uu____2638 -> fail e)))
           in
    ...
    fun tm  ->
      fun typ  ->
        bind cur_goal
          (fun goal  ->
             let uu____2763 =
               let uu____2768 = t_exact false true tm  in trytac uu____2768
                in
             bind uu____2763
               (fun uu___57_2775  ->
      ...
      let uu____2971 =
        mlog
          ...
          (fun uu____2979  ->
             bind cur_goal
               (fun goal  ->
                  let uu____2983 = __tc goal.FStar_Tactics_Types.context tm
                     in
                  bind uu____2983
                    (fun uu____3004  ->
                       ...
                       | (tm1,typ,guard) ->
                           ...
                           let uu____3027 =
                             ...
                             fail3
                              ...
                              in
                           try_unif uu____3016 uu____3027)))
         in
      ...
      let uu____3047 =
        mlog
          ...
          (fun uu____3056  ->
             ...
             bind cur_goal
               (fun goal  ->
                  let uu____3070 = __tc goal.FStar_Tactics_Types.context tm
                     in
                  bind uu____3070
                    (fun uu____3092  ->
                                         ...
                                         let uu____3445 =
                                           let uu____3454 =
                                             FStar_Syntax_Util.comp_to_comp_typ
                                               comp1
                                              in
                                           uu____3454.FStar_Syntax_Syntax.effect_args
                                            in
                                                             ...
                                                             (mapM
                                                                (fun
                                                                   ...
                                                                   (_msg,env,_uvar,term,typ,uu____3797)
                                                                    ...
                                                                    FStar_Syntax_Subst.compress
                                                                    hd1  in
                                                                    uu____3846.FStar_Syntax_Syntax.n
                                                                     in
                                                                    (match uu____3845
                                                                    with
                                                                    | 
            ...
            then FStar_Pervasives_Native.Some (e', [])
              ...
              (let uu____4378 = aux e'  in
               FStar_Util.map_opt uu____4378
                 (fun uu____4402  ->
                    match uu____4402 with | (e'',bvs) -> (e'', (bv' :: bvs))))
         in
                  ...
                  | FStar_Pervasives_Native.Some (e0,bvs) ->
                      ...
                      (match uu____4609 with
                       | FStar_Pervasives_Native.Some (x,e) ->
                           let uu____4624 =
                             let uu____4625 = FStar_Syntax_Subst.compress x
                                in
                           ...
                           (match uu____4624 with
                            | FStar_Syntax_Syntax.Tm_name x1 ->
                                ...
                                let uu____4645 =
                                  ...
                                  let uu____4647 = push_bvs e0 (bv :: bvs1)
                                     in
                                  let uu____4648 =
                                    FStar_Syntax_Subst.subst s
                                      goal.FStar_Tactics_Types.witness
  ...
  fun b  ->
    bind cur_goal
      (fun goal  ->
         ...
         | (bv,uu____4720) ->
             let uu____4721 = split_env bv goal.FStar_Tactics_Types.context
                in
    ...
    fun b  ->
      bind cur_goal
        (fun goal  ->
           ...
           | (bv,uu____4835) ->
               let uu____4836 = split_env bv goal.FStar_Tactics_Types.context
                  in
               (match uu____4836 with
                ...
                | FStar_Pervasives_Native.Some (e0,bvs) ->
                    let steps =
                      ...
                      FStar_List.append
                        [FStar_TypeChecker_Normalize.Reify;
                        FStar_TypeChecker_Normalize.UnfoldTac] uu____4868
                       in
                    let sort' =
                       ...
                       (fun hd2  ->
                          let fa uu____5200 =
                            ...
                            | (a,q) ->
                                ...
                                bind uu____5213 (fun a1  -> ret (a1, q))
                             in
                             ...
                             let uu____5422 =
                               let uu____5423 =
                                 FStar_TypeChecker_TcTerm.universe_of env typ
                                  in
                               FStar_Syntax_Util.mk_eq2 uu____5423 typ t1 ut
                                in
      ...
      bind get
        (fun ps  ->
           ...
           | (g,gs) ->
               ...
               (log ps
                  (fun uu____5521  ->
                     let uu____5522 = FStar_Syntax_Print.term_to_string gt1
                        in
                ...
                (match uu____5609 with
                 | (FStar_Syntax_Syntax.Tm_fvar
                    fv,uu____5637::(l,uu____5639)::(r,uu____5641)::[]) when
                     ...
                     if uu____5688
                     then
                       let uu____5692 = tts g.FStar_Tactics_Types.context l
                          in
                       let uu____5693 = tts g.FStar_Tactics_Types.context r
                          in
                ...
                | (t1,typ,guard) ->
                    ...
                    (match uu____5868 with
                     | (hd1,args) ->
                         let uu____5911 =
                           let uu____5924 =
                             let uu____5925 = FStar_Syntax_Util.un_uinst hd1
                                in
                         ...
                         (match uu____5911 with
                          ...
                          | uu____6017 ->
                              ...
                              fail1 "Not a disjunction: %s" uu____6030))))
       in
...
let set_options : Prims.string -> Prims.unit tac =
  fun s  ->
    bind cur_goal
      (fun g  ->
         FStar_Options.push ();
         (let uu____6068 = FStar_Util.smap_copy g.FStar_Tactics_Types.opts
             in
