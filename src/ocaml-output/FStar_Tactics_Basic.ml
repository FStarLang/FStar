...
let dump_proofstate : proofstate -> Prims.string -> Prims.unit =
  fun ps  ->
    fun msg  ->
      ...
      (let uu____329 = FStar_Util.string_of_int (FStar_List.length ps.goals)
          in
    ...
    fun solution  ->
      ...
      | Some w ->
          ...
          then ()
            ...
            (let uu____406 =
               let uu____407 =
                 let uu____408 = FStar_Syntax_Print.term_to_string solution
                    in
        ...
        fun e2  ->
          bind cur_goal
            (fun g  ->
               ...
               let ok =
                 let uu____601 = FStar_TypeChecker_Rel.try_teq true env t1 t2
                    in
                        ...
                        let uu____612 =
                          let uu____613 =
                            FStar_Syntax_Util.mk_eq2
                              FStar_Syntax_Syntax.U_zero t1 e1 e2
                             in
                          {
                            context = (g.context);
                            witness = None;
      ...
      let uu____907 =
        bind t1
          (fun uu____909  ->
             ...
             bind uu____910 (fun uu____914  -> ret ()))
         in
...
let intros : FStar_Syntax_Syntax.binders tac =
  with_cur_goal "intros"
    (fun goal  ->
       let uu____918 = FStar_Syntax_Util.destruct_typ_as_formula goal.goal_ty
          in
                  ...
                  (fun uu____929  ->
                     let uu____930 =
                       FStar_All.pipe_left mlog
                         (fun uu____935  ->
                            let uu____936 =
                              FStar_Syntax_Print.binders_to_string ", " bs
                               in
...
let mk_squash p =
  ...
  let uu____952 =
    let uu____958 = FStar_Syntax_Syntax.as_arg p  in [uu____958]  in
  ...
  with_cur_goal "imp_intro"
    (fun goal  ->
       ...
       | Some (FStar_Syntax_Util.BaseConn
           ...
           let new_goal =
             let uu____1107 = FStar_TypeChecker_Env.push_bv goal.context name
                in
             ...
             (fun uu____1108  ->
                ...
                bind uu____1109
                  (fun uu____1111  ->
                     ...
                     bind uu____1112
                       (fun uu____1119  ->
                          let uu____1120 = FStar_Syntax_Syntax.mk_binder name
                             in
                          ret uu____1120)))
                                                        ...
                                                        let uu____1473 =
                                                          let uu____1474 =
                                                            FStar_Syntax_Subst.compress
                                                              hd1
                                                             in
                                                          uu____1474.FStar_Syntax_Syntax.n
                                                           in
                                                        (match uu____1473
                                                         with
    ...
    (fun p  ->
       ...
       | g1::g2::rest ->
           ...
           then
             ...
             (let g1_binders =
                let uu____1946 = FStar_TypeChecker_Env.all_binders g1.context
                   in
                FStar_All.pipe_right uu____1946
                  (FStar_Syntax_Print.binders_to_string ", ")
                 in
              let g2_binders =
                let uu____1948 = FStar_TypeChecker_Env.all_binders g2.context
                   in
              ...
              let uu____1949 =
                ...
                let uu____1952 =
                  ...
                  FStar_All.pipe_right uu____1953 FStar_Util.string_of_bool
                   in
                FStar_Util.format3
      ...
      let uu____1973 =
        with_cur_goal "visit_strengthen_else"
          (fun goal  ->
             ...
             | None  ->
                 let uu____1979 =
                   let uu____1980 = FStar_Syntax_Subst.compress goal.goal_ty
                      in
                  ...
                  | uu____1991 ->
                      let uu____1992 =
                        FStar_All.pipe_left mlog
                          (fun uu____1997  ->
                             let uu____1998 =
                               FStar_Syntax_Print.term_to_string goal.goal_ty
                                in
                             FStar_Util.print1
             ...
             | Some (FStar_Syntax_Util.QAll (xs,uu____2013,uu____2014)) ->
                 bind intros
                   (fun binders  ->
                      ...
                      let uu____2018 =
                        let uu____2020 =
                          let uu____2022 = FStar_List.map Prims.fst binders
                             in
                                    ...
                                    FStar_All.pipe_left mlog
                                      (fun uu____2033  ->
                                         ...
                                         FStar_Util.print1
                                           ...
                                           uu____2034)
                                     in
                                  bind uu____2028 (fun uu____2035  -> ret ())))
                         in
                      seq uu____2016 uu____2018)
             | Some (FStar_Syntax_Util.BaseConn (l,uu____2037)) when
                 FStar_Ident.lid_equals l FStar_Syntax_Const.and_lid ->
                 let uu____2038 =
                   let uu____2040 = visit callback  in seq split uu____2040
                    in
