      ...
      let uu____1747 =
        bind t1
          (fun uu____1752  ->
             ...
             bind uu____1753 (fun uu____1761  -> ret ()))
         in
      focus uu____1747
            ...
            then fail "Codomain is effectful"
              ...
              (let bv =
               ...
               let env' = FStar_TypeChecker_Env.push_binders goal.context bs
                  in
               let uu____1878 =
                 let uu____1881 = comp_to_typ c  in new_uvar env' uu____1881
                  in
               bind uu____1878
                 (fun u  ->
                    let lb =
    ...
    bind cur_goal
      (fun goal  ->
         let steps =
           ...
           FStar_List.append
             [FStar_TypeChecker_Normalize.Reify;
             FStar_TypeChecker_Normalize.UnfoldTac] uu____1999
            in
      ...
      bind get
        (fun ps  ->
           let steps =
             ...
             FStar_List.append
               [FStar_TypeChecker_Normalize.Reify;
               FStar_TypeChecker_Normalize.UnfoldTac] uu____2030
              in
                                        ...
                                        let uu____2521 =
                                          let uu____2522 =
                                            ...
                                            FStar_Syntax_Subst.compress
                                              uu____2525
                                             in
                                          uu____2522.FStar_Syntax_Syntax.n
                                           in
           ...
           | (tm1,typ,guard) ->
               let uu____2662 =
                 let uu____2665 =
                   ...
                   bind uu____2668
                     (fun uu____2672  ->
                        add_goal_from_guard goal.context guard goal.opts)
                    in
                 focus uu____2665  in
               let uu____2673 =
                 ...
                 fail3
                   ...
                   uu____2676 uu____2677 uu____2678
                  in
                            ...
                            | (pre,post) ->
                                let uu____3152 =
                                  ...
                                  FStar_TypeChecker_Rel.try_teq false
                                    goal.context uu____3155 goal.goal_ty
                                   in
                                                        ...
                                                        let uu____3288 =
                                                          let uu____3289 =
                                                            FStar_Syntax_Subst.compress
                                                              hd1
                                                             in
                                                          uu____3289.FStar_Syntax_Syntax.n
                                                           in
                                                        (match uu____3288
                                                         with
                                                         | FStar_Syntax_Syntax.Tm_uvar
                ...
                let uu____3795 =
                  let uu____3796 =
                    FStar_TypeChecker_Env.lookup_bv goal.context
                      (FStar_Pervasives_Native.fst h)
                     in
                  FStar_All.pipe_left FStar_Pervasives_Native.fst uu____3796
                   in
                ...
                (fun hd2  ->
                   let fa uu____4218 =
                     ...
                     | (a,q) ->
                         ...
                         bind uu____4231 (fun a1  -> ret (a1, q))
                      in
                           ...
                           let uu____4434 =
                             let uu____4435 =
                               FStar_TypeChecker_TcTerm.universe_of env typ
                                in
                             FStar_Syntax_Util.mk_eq2 uu____4435 typ t1 ut
                              in
             ...
             then
               let s =
                 FStar_Util.launch_process true "tactic_launch" prog args
                   input (fun uu____5152  -> fun uu____5153  -> false)
                  in
               ret s
             else
               fail
    ...
    fun typ  ->
      ...
      | (u,uu____5193,g_u) ->
          let g =
            ...
            { context = env; witness = u; goal_ty = typ; opts = uu____5208 }
             in
          (g, g_u)
