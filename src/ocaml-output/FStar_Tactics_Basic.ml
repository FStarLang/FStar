      ...
      then ()
        ...
        (let uu____845 =
           let uu____846 =
             ...
             let uu____848 = FStar_Syntax_Print.term_to_string goal.witness
                in
             let uu____849 = FStar_Syntax_Print.term_to_string goal.goal_ty
                in
...
let new_uvar :
  ...
  fun env  ->
    fun typ  ->
      ...
      | (u,uu____1010,g_u) ->
          let uu____1024 = add_implicits g_u.FStar_TypeChecker_Env.implicits
             in
      ...
      let uu____1511 =
        bind t1
          (fun uu____1516  ->
             ...
             bind uu____1517 (fun uu____1525  -> ret ()))
         in
      focus uu____1511
...
let intro :
  ...
  bind cur_goal
    (fun goal  ->
       ...
       | FStar_Pervasives_Native.None  ->
           let uu____1705 = FStar_Syntax_Print.term_to_string goal.goal_ty
              in
  ...
  bind cur_goal
    (fun goal  ->
       ...
       (let uu____1742 = FStar_Syntax_Util.arrow_one goal.goal_ty  in
                         ...
                         | (u,g) ->
                             let lb =
                               ...
                               FStar_Syntax_Util.mk_letbinding
                                 ...
                                 FStar_Parser_Const.effect_Tot_lid uu____1894
                                in
        ...
        | FStar_Pervasives_Native.None  ->
            let uu____2006 = FStar_Syntax_Print.term_to_string goal.goal_ty
               in
      ...
      (fun goal  ->
         ...
         let steps =
           ...
           FStar_List.append
             ...
             FStar_TypeChecker_Normalize.UnfoldTac] uu____2044
            in
         let w =
                  ...
                  then fail "exact: got non-trivial guard"
                    ...
                    (let uu____2186 =
                     ...
                     then (solve goal t1; dismiss)
                       ...
                       (let uu____2191 = FStar_Syntax_Print.term_to_string t1
                           in
                        let uu____2192 =
  ...
  fun t  ->
    bind cur_goal
      (fun goal  ->
         let uu____2206 =
           try
             let uu____2234 = FStar_TypeChecker_TcTerm.tc_term goal.context t
                in
             ret uu____2234
           with
           | e ->
...
let rec __apply : Prims.bool -> FStar_Syntax_Syntax.term -> Prims.unit tac =
  fun uopt  ->
    fun tm  ->
      bind cur_goal
        (fun goal  ->
           let uu____2468 = let uu____2473 = exact tm  in trytac uu____2473
              in
           bind uu____2468
             (fun r  ->
                match r with
                           ...
                           let uu____2499 =
                             let uu____2500 =
                               FStar_TypeChecker_Rel.discharge_guard
                                ...
                                in
                             FStar_All.pipe_left
                               FStar_TypeChecker_Rel.is_trivial uu____2500
                              in
                           Prims.op_Negation uu____2499  in
                         if uu____2498
                         then fail "apply: got non-trivial guard"
                         else
                           (let uu____2504 = FStar_Syntax_Util.arrow_one typ
                               in
                                        ...
                                        | (u,g_u) ->
                                            let tm' =
                                              FStar_Syntax_Syntax.mk_Tm_app
                                               ...
                                               in
                                            let uu____2574 = __apply uopt tm'
                                               in
                                            bind uu____2574
                                              (fun uu____2581  ->
                                                 let uu____2582 =
                                                   let uu____2583 =
                                                     ...
                                                     FStar_Syntax_Subst.compress
                                                       uu____2586
                                                      in
                                                   uu____2583.FStar_Syntax_Syntax.n
                                                    in
                            ...
                            | (pre,post) ->
                                let uu____3139 =
                                  ...
                                  FStar_TypeChecker_Rel.try_teq false
                                    goal.context uu____3142 goal.goal_ty
                                   in
                                                        ...
                                                        let uu____3276 =
                                                          let uu____3277 =
                                                            FStar_Syntax_Subst.compress
                                                              hd1
                                                             in
                                                          uu____3277.FStar_Syntax_Syntax.n
                                                           in
                                                        (match uu____3276
                                                         with
                                                         | FStar_Syntax_Syntax.Tm_uvar
                ...
                let uu____3772 =
                  let uu____3773 =
                    FStar_TypeChecker_Env.lookup_bv goal.context
                      (FStar_Pervasives_Native.fst h)
                     in
                  FStar_All.pipe_left FStar_Pervasives_Native.fst uu____3773
                   in
                ...
                (fun hd2  ->
                   let fa uu____4213 =
                     ...
                     | (a,q) ->
                         ...
                         bind uu____4226 (fun a1  -> ret (a1, q))
                      in
                     ...
                     (fun t''  ->
                        let uu____4315 =
                          let uu____4316 =
                            ...
                            let uu____4334 = FStar_Syntax_Subst.close bs1 t''
                               in
      ...
      fun opts  ->
        fun env  ->
          fun t  ->
            ...
            | (t1,lcomp,g) ->
                let uu____4400 =
                  (let uu____4403 = FStar_Syntax_Util.is_total_lcomp lcomp
                      in
                   Prims.op_Negation uu____4403) ||
                    (let uu____4405 = FStar_TypeChecker_Rel.is_trivial g  in
                     Prims.op_Negation uu____4405)
                   in
                if uu____4400
                then ret t1
                else
                ...
                (match uu____4605 with
                 | (FStar_Syntax_Syntax.Tm_fvar
                    fv,uu____4633::(l,uu____4635)::(r,uu____4637)::[]) when
                     ...
                     if uu____4684
                     then
                       let uu____4688 = FStar_Syntax_Print.term_to_string l
                          in
                       let uu____4689 = FStar_Syntax_Print.term_to_string r
                          in
                         ...
                         (fun uu____4984  ->
                            ...
                            bind uu____4985
                              (fun uu____4994  ->
                                 ...
                                 ret uu____4995))
                   | uu____5006 ->
                       let uu____5019 = FStar_Syntax_Print.term_to_string typ
                          in
    ...
    fun typ  ->
      ...
      | (u,uu____5103,g_u) ->
          let g =
            ...
            { context = env; witness = u; goal_ty = typ; opts = uu____5118 }
             in
          let ps =
            {
              main_context = env;
