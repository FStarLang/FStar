       ...
       let uu____811 =
         ...
         bind uu____814
           (fun uu___78_829  ->
              ...
              | (hd1,FStar_Pervasives_Native.Some tl1) -> ret (hd1 :: tl1))
          in
       run uu____811 ps)
      ...
      let uu____921 =
        bind t1
          (fun uu____923  ->
             ...
             bind uu____924 (fun uu____928  -> ret ()))
         in
                                                        ...
                                                        let uu____1485 =
                                                          let uu____1486 =
                                                            FStar_Syntax_Subst.compress
                                                              hd1
                                                             in
                                                          uu____1486.FStar_Syntax_Syntax.n
                                                           in
                                                        (match uu____1485
                                                         with
                ...
                let uu____1587 =
                  let uu____1588 =
                    FStar_TypeChecker_Env.lookup_bv goal.context
                      (FStar_Pervasives_Native.fst h)
                     in
                  FStar_All.pipe_left FStar_Pervasives_Native.fst uu____1588
                   in
             ...
             (let g1_binders =
              ...
              let uu____1988 =
                ...
                let uu____1991 =
                  ...
                  FStar_All.pipe_right uu____1992 FStar_Util.string_of_bool
                   in
                FStar_Util.format3
        ...
        with_cur_goal "visit_strengthen_else"
          (fun goal  ->
                                    ...
                                    FStar_All.pipe_left mlog
                                      (fun uu____2072  ->
                                         ...
                                         FStar_Util.print1
                                           ...
                                           uu____2073)
                                     in
                                  bind uu____2067 (fun uu____2074  -> ret ())))
                         in
             ...
             | FStar_Pervasives_Native.Some (FStar_Syntax_Util.BaseConn
                 ...
                 let uu____2077 =
                   let uu____2079 = visit callback  in seq split uu____2079
                    in
             ...
             | FStar_Pervasives_Native.Some (FStar_Syntax_Util.BaseConn
                 (l,uu____2088)) -> or_else trivial smt)
         in
