            ...
            then FStar_Pervasives_Native.Some (e', [])
              ...
              (let uu____4233 = aux e' in
               FStar_Util.map_opt uu____4233
                 (fun uu____4257  ->
                    match uu____4257 with | (e'',bvs) -> (e'', (bv' :: bvs)))) in
                  ...
                  | FStar_Pervasives_Native.Some (e0,bvs) ->
                      ...
                      (match uu____4464 with
                       | FStar_Pervasives_Native.Some (x,e) ->
                           let uu____4479 =
                             let uu____4480 = FStar_Syntax_Subst.compress x in
                           ...
                           (match uu____4479 with
                            | FStar_Syntax_Syntax.Tm_name x1 ->
                                ...
                                let uu____4500 =
                                  ...
                                  let uu____4502 = push_bvs e0 (bv :: bvs1) in
                                  let uu____4503 =
                                    FStar_Syntax_Subst.subst s
                                      goal.FStar_Tactics_Types.witness in
                                  let uu____4504 =
  ...
  fun b  ->
    bind cur_goal
      (fun goal  ->
         ...
         | (bv,uu____4575) ->
             let uu____4576 = split_env bv goal.FStar_Tactics_Types.context in
    ...
    fun b  ->
      bind cur_goal
        (fun goal  ->
           ...
           | (bv,uu____4690) ->
               let uu____4691 = split_env bv goal.FStar_Tactics_Types.context in
                       ...
                       (fun hd2  ->
                          let fa uu____5055 =
                            ...
                            | (a,q) ->
                                ...
                                bind uu____5068 (fun a1  -> ret (a1, q)) in
                       ...
                       (fun ut  ->
                          ...
                          (let uu____5274 =
                             let uu____5277 =
                               ...
                               FStar_Syntax_Util.mk_eq2 uu____5278 typ t1 ut in
      ...
      bind get
        (fun ps  ->
           ...
           | (g,gs) ->
               ...
               (log ps
                  (fun uu____5376  ->
                     let uu____5377 = FStar_Syntax_Print.term_to_string gt1 in
                ...
                (match uu____5464 with
                 | (FStar_Syntax_Syntax.Tm_fvar
                    fv,uu____5492::(l,uu____5494)::(r,uu____5496)::[]) when
                     ...
                     if uu____5543
                     then
                       let uu____5547 = tts g.FStar_Tactics_Types.context l in
                       let uu____5548 = tts g.FStar_Tactics_Types.context r in
                ...
                | (t1,typ,guard) ->
                    ...
                    (match uu____5723 with
                     | (hd1,args) ->
                         let uu____5766 =
                           let uu____5779 =
                             let uu____5780 = FStar_Syntax_Util.un_uinst hd1 in
                         ...
                         (match uu____5766 with
                          ...
                          | uu____5872 ->
                              ...
                              fail1 "Not a disjunction: %s" uu____5885)))) in
...
let set_options: Prims.string -> Prims.unit tac =
  fun s  ->
    bind cur_goal
      (fun g  ->
         FStar_Options.push ();
         (let uu____5923 = FStar_Util.smap_copy g.FStar_Tactics_Types.opts in
    ...
    fun ty  ->
      let uu____6025 =
        ...
        | FStar_Pervasives_Native.None  ->
            ...
            new_uvar "uvar_env.2" env uu____6031 in
      bind uu____6025
        (fun typ  ->
             ...
             then
               let s =
                 FStar_Util.launch_process true "tactic_launch" prog args
                   input (fun uu____6148  -> fun uu____6149  -> false) in
               ret s
             else
               fail
