  ...
  fun env  ->
    fun phi  ->
      fun opts  ->
        ...
        bind uu____1283
          (fun u  ->
             let goal = { context = env; witness = u; goal_ty = typ; opts }
                in
             add_goals [goal])
      ...
      let uu____1660 =
        bind t1
          (fun uu____1665  ->
             ...
             bind uu____1666 (fun uu____1674  -> ret ()))
         in
      focus uu____1660
...
let intro : FStar_Syntax_Syntax.binder tac =
  bind cur_goal
    (fun goal  ->
       ...
       | FStar_Pervasives_Native.None  ->
           let uu____1732 = FStar_Syntax_Print.term_to_string goal.goal_ty
              in
  ...
  bind cur_goal
    (fun goal  ->
       ...
       (let uu____1753 = FStar_Syntax_Util.arrow_one goal.goal_ty  in
            ...
            then fail "Codomain is effectful"
              ...
              (let bv =
               ...
               let env' = FStar_TypeChecker_Env.push_binders goal.context bs
                  in
               let uu____1791 =
                 let uu____1794 = comp_to_typ c  in new_uvar env' uu____1794
                  in
               bind uu____1791
                 (fun u  ->
                    let lb =
        ...
        | FStar_Pervasives_Native.None  ->
            let uu____1887 = FStar_Syntax_Print.term_to_string goal.goal_ty
               in
      ...
      (fun goal  ->
         let steps =
           ...
           FStar_List.append
             ...
             FStar_TypeChecker_Normalize.UnfoldTac] uu____1912
            in
      ...
      bind get
        (fun ps  ->
           let steps =
             ...
             FStar_List.append
               [FStar_TypeChecker_Normalize.Reify;
               FStar_TypeChecker_Normalize.UnfoldTac] uu____1943
              in
                  ...
                  then fail "exact: got non-trivial guard"
                    ...
                    (let uu____2074 =
                     ...
                     then (solve goal t1; dismiss)
                       ...
                       (let uu____2079 = FStar_Syntax_Print.term_to_string t1
                           in
                        let uu____2080 =
  ...
  fun t  ->
    bind cur_goal
      (fun goal  ->
         let uu____2094 =
           try
             let uu____2122 = FStar_TypeChecker_TcTerm.tc_term goal.context t
                in
             ret uu____2122
           with
           | e ->
  ...
  fun uopt  ->
    fun tm  ->
      fun typ  ->
        bind cur_goal
          (fun goal  ->
             let uu____2365 = let uu____2370 = exact tm  in trytac uu____2370
                in
             bind uu____2365
               (fun r  ->
                  match r with
                                        ...
                                        let uu____2447 =
                                          let uu____2448 =
                                            ...
                                            FStar_Syntax_Subst.compress
                                              uu____2451
                                             in
                                          uu____2448.FStar_Syntax_Syntax.n
                                           in
      ...
      (fun goal  ->
         ...
         | (tm1,typ,guard) ->
             ...
             then fail "apply: got non-trivial guard"
               ...
               (let uu____2589 =
                  let uu____2592 = __apply true tm1 typ  in focus uu____2592
                   in
                let uu____2595 =
                  ...
                  fail3
                    ...
                    uu____2598 uu____2599 uu____2600
                   in
                            ...
                            | (pre,post) ->
                                let uu____3075 =
                                  ...
                                  FStar_TypeChecker_Rel.try_teq false
                                    goal.context uu____3078 goal.goal_ty
                                   in
                                                        ...
                                                        let uu____3212 =
                                                          let uu____3213 =
                                                            FStar_Syntax_Subst.compress
                                                              hd1
                                                             in
                                                          uu____3213.FStar_Syntax_Syntax.n
                                                           in
                                                        (match uu____3212
                                                         with
                                                         | FStar_Syntax_Syntax.Tm_uvar
                ...
                let uu____3707 =
                  let uu____3708 =
                    FStar_TypeChecker_Env.lookup_bv goal.context
                      (FStar_Pervasives_Native.fst h)
                     in
                  FStar_All.pipe_left FStar_Pervasives_Native.fst uu____3708
                   in
                ...
                (fun hd2  ->
                   let fa uu____4130 =
                     ...
                     | (a,q) ->
                         ...
                         bind uu____4143 (fun a1  -> ret (a1, q))
                      in
                     ...
                     (fun t''  ->
                        let uu____4232 =
                          let uu____4233 =
                            ...
                            let uu____4251 = FStar_Syntax_Subst.close bs1 t''
                               in
      ...
      fun opts  ->
        fun env  ->
          fun t  ->
            ...
            | (t1,lcomp,g) ->
                let uu____4317 =
                  (let uu____4320 = FStar_Syntax_Util.is_total_lcomp lcomp
                      in
                   Prims.op_Negation uu____4320) ||
                    (let uu____4322 = FStar_TypeChecker_Rel.is_trivial g  in
                     Prims.op_Negation uu____4322)
                   in
                if uu____4317
                then ret t1
                else
                           ...
                           let uu____4346 =
                             let uu____4347 =
                               FStar_TypeChecker_TcTerm.universe_of env typ
                                in
                             FStar_Syntax_Util.mk_eq2 uu____4347 typ t1 ut
                              in
                ...
                (match uu____4502 with
                 | (FStar_Syntax_Syntax.Tm_fvar
                    fv,uu____4530::(l,uu____4532)::(r,uu____4534)::[]) when
                     ...
                     if uu____4581
                     then
                       let uu____4585 = FStar_Syntax_Print.term_to_string l
                          in
                       let uu____4586 = FStar_Syntax_Print.term_to_string r
                          in
                         ...
                         (fun uu____4863  ->
                            ...
                            bind uu____4864
                              (fun uu____4873  ->
                                 ...
                                 ret uu____4874))
                   | uu____4885 ->
                       let uu____4898 = FStar_Syntax_Print.term_to_string typ
                          in
             ...
             then
               let s =
                 FStar_Util.launch_process true "tactic_launch" prog args
                   input (fun uu____5064  -> fun uu____5065  -> false)
                  in
               ret s
             else
               fail
    ...
    fun typ  ->
      ...
      | (u,uu____5105,g_u) ->
          let g =
            ...
            { context = env; witness = u; goal_ty = typ; opts = uu____5120 }
             in
          (g, g_u)
