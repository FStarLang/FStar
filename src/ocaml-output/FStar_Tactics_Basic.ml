        ...
        (fun ps ->
           FStar_Tactics_Monad.bind FStar_Tactics_Monad.cur_goal
             (fun g ->
                ...
                solve' g t)) in
    FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "tadmit_t") uu___
...
let (curms : unit -> FStar_BigInt.t FStar_Tactics_Monad.tac) =
  fun uu___ ->
    let uu___1 =
      ...
      FStar_All.op_Bar_Greater uu___2 FStar_BigInt.of_int_fs in
    FStar_Tactics_Monad.ret uu___1
let (__tc :
  env ->
    FStar_Syntax_Syntax.term ->
...
let (tcc :
  ...
  fun e ->
    fun t ->
      ...
      FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "tcc") uu___
let (tc :
  env ->
    FStar_Syntax_Syntax.term ->
  ...
  fun e ->
    fun t ->
      ...
      FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "tc") uu___
                                                    ...
                                                    let p' =
                                                      ...
                                                      let uu___7 =
                                                        FStar_List.op_At
                                                          ...
                                                          rp'.FStar_Tactics_Types.goals in
                                                      let uu___8 =
                                                        let uu___9 =
                                                          FStar_List.op_At
                                                            rp'.FStar_Tactics_Types.smt_goals
                                                            p.FStar_Tactics_Types.smt_goals in
                                                        FStar_List.op_At
...
let (intro : unit -> FStar_Syntax_Syntax.binder FStar_Tactics_Monad.tac) =
  fun uu___ ->
    ...
    FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "intro") uu___1
let (intro_rec :
  unit ->
  ...
  fun e ->
    fun s ->
      fun t ->
        ...
        FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "norm_term")
          uu___
let (refine_intro : unit -> unit FStar_Tactics_Monad.tac) =
  fun uu___ ->
    ...
    FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "refine_intro")
      uu___1
let (__exact_now :
  ...
  fun try_refine ->
    fun set_expected_typ ->
      fun tm ->
        ...
        FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "exact") uu___
                                                 ...
                                                 FStar_Tactics_Monad.bind
                                                   ...
                                                   (fun uu___10 ->
                                                      proc_guard
                                                        "apply guard" e guard
                                                        (rangeof goal))))))))) in
        FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "apply") uu___
let (lemma_or_sq :
                                                              ...
                                                              (let uu___11 =
                                                               ...
                                                               FStar_Tactics_Monad.bind
                                                                 ...
                                                                 (fun uu___12
                                                                    ...
                                                                    sub_goals2))))))))))))) in
          focus uu___1 in
        FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "apply_lemma")
          uu___
let (split_env :
...
let (rewrite : FStar_Syntax_Syntax.binder -> unit FStar_Tactics_Monad.tac) =
  fun h ->
    ...
    FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "rewrite") uu___
let (rename_to :
  ...
  fun b ->
    fun s ->
      ...
      FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "rename_to") uu___
let (binder_retype :
                                  ...
                                  FStar_Tactics_Monad.bind uu___6
                                    (fun uu___7 ->
                                       ...
                                       FStar_Tactics_Monad.add_irrelevant_goal
                                         ...
                                         uu___8))))) in
    FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "binder_retype")
      uu___
let (norm_binder_type :
  ...
  fun s ->
    fun b ->
      ...
      FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "norm_binder_type")
        uu___
           ...
           (fun uu___ ->
              ...
              let uu___2 =
                let uu___3 =
                  ...
                  FStar_All.op_Bar_Greater uu___4 FStar_List.length in
...
let (t_trefl : Prims.bool -> unit FStar_Tactics_Monad.tac) =
  fun allow_guards ->
    ...
    FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "t_trefl") uu___
...
let (set_options : Prims.string -> unit FStar_Tactics_Monad.tac) =
  fun s ->
    ...
    FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "set_options") uu___
let (top_env : unit -> env FStar_Tactics_Monad.tac) =
  fun uu___ ->
    FStar_Tactics_Monad.bind FStar_Tactics_Monad.get
      (fun ps ->
         FStar_All.op_Less_Bar FStar_Tactics_Monad.ret
...
let (unquote :
  ...
  fun ty ->
    fun tm ->
      ...
      FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "unquote") uu___
let (uvar_env :
  env ->
...
let (unshelve : FStar_Syntax_Syntax.term -> unit FStar_Tactics_Monad.tac) =
  fun t ->
    ...
    FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "unshelve") uu___
let (tac_and :
  ...
  fun e ->
    fun t1 ->
      fun t2 ->
        ...
        FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "match_env")
          uu___
let (unify_env :
  env ->
    FStar_Syntax_Syntax.term ->
                                   ...
                                   (fun uu___6 ->
                                      ...
                                      FStar_Tactics_Monad.bind uu___7
                                        (fun uu___8 ->
                                           ...
                                           tac_and uu___9 uu___10))))) in
        FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "unify_env")
          uu___
let (unify_guard_env :
  env ->
    FStar_Syntax_Syntax.term ->
                                      ...
                                      FStar_Tactics_Monad.bind uu___9
                                        (fun b ->
                                           ...
                                           then
                                             ...
                                             FStar_Tactics_Monad.fail
                                               "not convertible"))))))) in
    FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "change") uu___
let failwhen :
  'a .
    Prims.bool ->
      Prims.string ->
...
let (t_destruct :
  ...
  fun s_tm ->
    ...
    FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "destruct") uu___
      ...
      FStar_Tactics_Monad.bind uu___1
        (fun e ->
           ...
           | FStar_Syntax_Syntax.Tm_app (hd, args) ->
               ...
               (match uu___2 with
                | (a, q) ->
                    ...
                    FStar_All.op_Less_Bar FStar_Tactics_Monad.ret uu___3)
           ...
           | FStar_Syntax_Syntax.Tm_constant c ->
               ...
               FStar_All.op_Less_Bar FStar_Tactics_Monad.ret uu___2
...
let (pack :
  ...
  fun tv ->
    ...
    | FStar_Reflection_Data.Tv_Var bv ->
        ...
        FStar_All.op_Less_Bar FStar_Tactics_Monad.ret uu___
    | FStar_Reflection_Data.Tv_BVar bv ->
    ...
    | FStar_Reflection_Data.Tv_Arrow (b, c) ->
        ...
        FStar_All.op_Less_Bar FStar_Tactics_Monad.ret uu___
    | FStar_Reflection_Data.Tv_Type () ->
        FStar_All.op_Less_Bar FStar_Tactics_Monad.ret FStar_Syntax_Util.ktype
         ...
         | (lbs, body) ->
             let uu___1 =
               FStar_Syntax_Syntax.mk
                 ...
                 FStar_Range.dummyRange in
             FStar_All.op_Less_Bar FStar_Tactics_Monad.ret uu___1)
...
let (lget :
  ...
  fun ty ->
    fun k ->
      ...
      FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "lget") uu___
let (lset :
  FStar_Reflection_Data.typ ->
  ...
  fun _ty ->
    fun k ->
      fun t ->
        ...
        FStar_All.op_Less_Bar (FStar_Tactics_Monad.wrap_err "lset") uu___
