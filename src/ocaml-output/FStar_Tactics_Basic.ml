                                                        ...
                                                        let uu____1471 =
                                                          let uu____1472 =
                                                            FStar_Syntax_Subst.compress
                                                              hd1
                                                             in
                                                          uu____1472.FStar_Syntax_Syntax.n
                                                           in
                                                        (match uu____1471
                                                         with
    ...
    (fun p  ->
       ...
       | g1::g2::rest ->
           ...
           then
             ...
             (let g1_binders =
                let uu____1944 = FStar_TypeChecker_Env.all_binders g1.context
                   in
                FStar_All.pipe_right uu____1944
                  (FStar_Syntax_Print.binders_to_string ", ")
                 in
              let g2_binders =
                let uu____1946 = FStar_TypeChecker_Env.all_binders g2.context
                   in
              ...
              let uu____1947 =
                ...
                let uu____1950 =
                  ...
                  FStar_All.pipe_right uu____1951 FStar_Util.string_of_bool
                   in
                FStar_Util.format3
                  "Cannot merge sub-goals: incompatible contexts:\ng1=%s\ng2=%s\neq_gamma=%s\n"
                  uu____1948 uu____1949 uu____1950
                 in
              fail uu____1947)
       | uu____1952 ->
           let goals =
      ...
      let uu____1971 =
        with_cur_goal "visit_strengthen_else"
          (fun goal  ->
             ...
             | None  ->
                 let uu____1977 =
                   let uu____1978 = FStar_Syntax_Subst.compress goal.goal_ty
                      in
                                    ...
                                    FStar_All.pipe_left mlog
                                      (fun uu____2031  ->
                                         ...
                                         FStar_Util.print1
                                           ...
                                           uu____2032)
                                     in
                                  bind uu____2026 (fun uu____2033  -> ret ())))
                         in
                      seq uu____2014 uu____2016)
             | Some (FStar_Syntax_Util.BaseConn (l,uu____2035)) when
                 FStar_Ident.lid_equals l FStar_Syntax_Const.and_lid ->
                 let uu____2036 =
                   let uu____2038 = visit callback  in seq split uu____2038
                    in
