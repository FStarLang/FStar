                                                             ...
                                                             (fun uu____5013 
                                                                ...
                                                                let uu____5164
                                                                  ...
                                                                  FStar_All.pipe_right
                                                                    ...
                                                                    hd  in
                                                                    uu____5264.FStar_Syntax_Syntax.n
                                                                     in
                                                                    (match uu____5263
                                                                    with
                                                                    | 
                                                                    FStar_Syntax_Syntax.Tm_uvar
                                                                    (ctx_uvar1,uu____5272)
                                                                    ->
                                                                    let goal1
                                                                    =
                                                                    bnorm_goal
...
let (destruct_eq' :
  ...
  fun typ  ->
    ...
    | FStar_Pervasives_Native.Some (FStar_Syntax_Util.BaseConn
        (l,uu____5476::(e1,FStar_Pervasives_Native.None )::(e2,FStar_Pervasives_Native.None
                                                            )::[]))
        when
              ...
              | (hd,args) ->
                  ...
                  (match uu____5684 with
                   | (FStar_Syntax_Syntax.Tm_fvar
                      fv,(uu____5720,FStar_Pervasives_Native.Some
                          (FStar_Syntax_Syntax.Implicit uu____5721))::
                 ...
                 (match uu____7061 with
                  ...
                  | FStar_Pervasives_Native.Some (e0,bv1,bvs) ->
                      let steps =
                        ...
                        FStar_List.append
                          [FStar_TypeChecker_Env.Reify;
                          FStar_TypeChecker_Env.UnfoldTac] uu____7102
                         in
                      let sort' =
                      ...
                      FStar_Tactics_Monad.replace_cur uu____7109))
         in
         ...
         | FStar_Pervasives_Native.Some (x,env') ->
             let typ' =
               ...
               FStar_Syntax_Util.arrow [(x, FStar_Pervasives_Native.None)]
                 uu____7152
                in
             let uu____7170 = FStar_Tactics_Monad.new_uvar "revert" env' typ'
                in
                ...
                then solve' g FStar_Syntax_Util.exp_unit
                  ...
                  (let l1 =
                     ...
                     FStar_TypeChecker_Normalize.normalize
                       ...
                       FStar_TypeChecker_Env.Primops;
                       FStar_TypeChecker_Env.UnfoldTac] uu____7533 l
                      in
                   let r1 =
                     ...
                     FStar_TypeChecker_Normalize.normalize
                       [FStar_TypeChecker_Env.UnfoldUntil
                          FStar_Syntax_Syntax.delta_constant;
                       FStar_TypeChecker_Env.Primops;
                       FStar_TypeChecker_Env.UnfoldTac] uu____7535 r
                      in
                   let uu____7536 =
      ...
      FStar_Tactics_Monad.bind FStar_Tactics_Monad.cur_goal
        (fun g  ->
           ...
           | FStar_Pervasives_Native.None  ->
               ...
               fail1 "not an equality (%s)" uu____7613)
       in
              ...
              | (u,u_uvar) ->
                  ...
                  FStar_Tactics_Monad.bind FStar_Tactics_Monad.dismiss
                    (fun uu____7669  ->
                       let t_eq =
                         let uu____7671 =
                           let uu____7672 = FStar_Tactics_Types.goal_type g
                              in
                           env1.FStar_TypeChecker_Env.universe_of env1
                             uu____7672
                            in
                         let uu____7673 = FStar_Tactics_Types.goal_type g  in
                         let uu____7674 = FStar_Tactics_Types.goal_witness g
                            in
  ...
  fun s  ->
    let uu____8122 =
      FStar_Tactics_Monad.bind FStar_Tactics_Monad.cur_goal
        (fun g  ->
           FStar_Options.push ();
           (let uu____8135 = FStar_Util.smap_copy g.FStar_Tactics_Types.opts
               in
         ...
         let uu____8182 =
           (FStar_Options.lax ()) ||
             (let uu____8185 = FStar_Tactics_Types.goal_env g  in
              uu____8185.FStar_TypeChecker_Env.lax)
            in
  ...
  fun env1  ->
    fun ty  ->
        ...
        | FStar_Pervasives_Native.None  ->
            let uu____8303 =
              let uu____8310 =
                ...
                FStar_All.pipe_left FStar_Pervasives_Native.fst uu____8311
                 in
      ...
      FStar_Tactics_Monad.bind uu____8297
        (fun typ  ->
           let uu____8340 = FStar_Tactics_Monad.new_uvar "uvar_env" env1 typ
              in
      ...
      FStar_Tactics_Monad.bind FStar_Tactics_Monad.get
        (fun ps  ->
           ...
           | ({
                ...
                FStar_Syntax_Syntax.vars = uu____8421;_},uu____8422)
               ->
               let env2 =
               ...
               let uu____8468 =
                 let uu____8471 = bnorm_goal g  in [uu____8471]  in
               FStar_Tactics_Monad.add_goals uu____8468
           | uu____8472 -> FStar_Tactics_Monad.fail "not a uvar")
       in
  ...
  fun t1  ->
    fun t2  ->
      let comp =
        FStar_Tactics_Monad.bind t1
          (fun b  ->
             let uu____8534 = if b then t2 else FStar_Tactics_Monad.ret false
                in
                ...
                FStar_Tactics_Monad.bind uu____8820
                  (fun uu____8841  ->
                     ...
                     | (ty1,uu____8851,guard) ->
                         let uu____8853 =
                           let uu____8856 = FStar_Tactics_Types.goal_env g
                              in
                                   ...
                                   then
                                     ...
                                     (let steps =
                                      ...
                                      let ng =
                                        ...
                                        let uu____8883 =
                                          FStar_Tactics_Types.goal_type g  in
                                        normalize steps uu____8882 uu____8883
                                         in
                                      let nty =
                                        let uu____8885 =
                                          FStar_Tactics_Types.goal_env g  in
             ...
             (fun uu____9018  ->
                ...
                | (s_tm1,s_ty,guard) ->
                    ...
                    FStar_Tactics_Monad.bind uu____9036
                      (fun uu____9053  ->
                         let s_ty1 =
                           let uu____9055 = FStar_Tactics_Types.goal_env g
                              in
                           FStar_TypeChecker_Normalize.normalize
                             [FStar_TypeChecker_Env.UnfoldTac;
                            ...
                            in
                         let uu____9056 =
                           let uu____9071 = FStar_Syntax_Util.unrefine s_ty1
                              in
                             ...
                             let uu____9102 =
                               ...
                               | FStar_Syntax_Syntax.Tm_uinst
                                   ({
                                      ...
                                      FStar_Syntax_Syntax.vars = uu____9126;_},us)
                                                              ...
                                                              let uu____9259
                                                                ...
                                                                FStar_Tactics_Monad.mapM
                                                                  (fun c_lid 
                                                                    ...
                                                                    with
                                                                    | 
                                                                    (uu____10233,uu____10234,uu____10235,uu____10236,pat_t,uu____10238,_guard_pat,_erasable)
                                                                    ->
                                                                    let eq_b
                                                                    =
                                                                    let uu____10252
                ...
                | (bs1,t5) ->
                    (match bs1 with
                     ...
                     | b::bs2 ->
                         let uu____10909 =
                           let uu____10910 =
                             let uu____10915 = FStar_Syntax_Util.abs bs2 t5 k
                                in
                             (b, uu____10915)  in
           ...
           | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),t21) ->
               ...
               then
                 ...
                 (match lb.FStar_Syntax_Syntax.lbname with
                  ...
                  | FStar_Util.Inl bv ->
                      let b = FStar_Syntax_Syntax.mk_binder bv  in
                      let uu____11129 = FStar_Syntax_Subst.open_term [b] t21
                         in
           ...
           | FStar_Syntax_Syntax.Tm_match (t4,brs) ->
               let rec inspect_pat p =
                 ...
                 | FStar_Syntax_Syntax.Pat_constant c ->
                     let uu____11313 = FStar_Reflection_Basic.inspect_const c
                        in
          ...
          FStar_List.map
            (fun uu___8_11904  ->
               ...
               | (pat,t1) ->
                   ...
                   (uu____11921, FStar_Pervasives_Native.None, t1)) brs
           in
  ...
  fun rng  ->
    fun env1  ->
      fun imps  ->
        ...
        let w =
          let uu____12367 = FStar_List.hd goals  in
          FStar_Tactics_Types.goal_witness uu____12367  in
        let ps =
          let uu____12369 =
            FStar_TypeChecker_Env.debug env1
              (FStar_Options.Other "TacVerbose")
             in
          let uu____12372 = FStar_Util.psmap_empty ()  in
          {
            ...
            FStar_Tactics_Types.guard_policy = FStar_Tactics_Types.SMT;
            FStar_Tactics_Types.freshness = Prims.int_zero;
            FStar_Tactics_Types.tac_verb_dbg = uu____12369;
            FStar_Tactics_Types.local_state = uu____12372
          }  in
        (ps, w)
