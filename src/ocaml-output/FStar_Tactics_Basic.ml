                                                             ...
                                                             (fun uu____6985 
                                                                ...
                                                                let uu____7132
                                                                  ...
                                                                  FStar_All.pipe_right
                                                                    ...
                                                                    FStar_TypeChecker_Env.try_solve_implicits_hook
                                                                    =
                                                                    (uu___1011_7283.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                                                    FStar_TypeChecker_Env.splice
                                                                    =
                  ...
                  (let uu___1409_9935 = env  in
                   {
                     ...
                     FStar_TypeChecker_Env.try_solve_implicits_hook =
                       (uu___1409_9935.FStar_TypeChecker_Env.try_solve_implicits_hook);
                     FStar_TypeChecker_Env.splice =
                                ...
                                (let uu___1516_10917 = env  in
                                 {
                                   ...
                                   FStar_TypeChecker_Env.try_solve_implicits_hook
                                     =
                                     (uu___1516_10917.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                   FStar_TypeChecker_Env.splice =
                           ...
                           (fun uu____11813  ->
                              ...
                              let nenv =
                                   ...
                                   in
                                {
                                  ...
                                  FStar_TypeChecker_Env.try_solve_implicits_hook
                                    =
                                    (uu___1647_11818.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                  FStar_TypeChecker_Env.splice =
           ...
           | ({
               ...
               let env1 =
                 let uu___1727_12248 = env  in
                 {
                   ...
                   FStar_TypeChecker_Env.try_solve_implicits_hook =
                     (uu___1727_12248.FStar_TypeChecker_Env.try_solve_implicits_hook);
                   FStar_TypeChecker_Env.splice =
                                                              ...
                                                              let uu____13049
                                                                ...
                                                                mapM
                                                                  (fun c_lid 
                                                                    ...
                                                                    FStar_TypeChecker_Env.try_solve_implicits_hook
                                                                    =
                                                                    (uu___1894_13799.FStar_TypeChecker_Env.try_solve_implicits_hook);
                                                                    FStar_TypeChecker_Env.splice
                                                                    =
...
let (goal_of_implicit :
  ...
  fun env  ->
    fun i  ->
      let uu____15855 = FStar_Options.peek ()  in
      FStar_Tactics_Types.mk_goal env i.FStar_TypeChecker_Env.imp_uvar
        uu____15855 false ""
  ...
  fun rng  ->
    fun env  ->
      fun imps  ->
        ...
        let w =
          let uu____15882 = FStar_List.hd goals  in
          FStar_Tactics_Types.goal_witness uu____15882  in
        let ps =
          let uu____15884 = FStar_List.hd goals  in
          let uu____15885 =
            FStar_TypeChecker_Env.debug env
              (FStar_Options.Other "TacVerbose")
             in
          let uu____15888 = FStar_Util.psmap_empty ()  in
          {
            FStar_Tactics_Types.main_context = env;
            FStar_Tactics_Types.main_goal = uu____15884;
            ...
            FStar_Tactics_Types.guard_policy = FStar_Tactics_Types.SMT;
            FStar_Tactics_Types.freshness = Prims.int_zero;
            FStar_Tactics_Types.tac_verb_dbg = uu____15885;
            FStar_Tactics_Types.local_state = uu____15888
          }  in
        (ps, w)
