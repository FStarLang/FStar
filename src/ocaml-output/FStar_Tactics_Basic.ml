...
let divide n1 l r =
  bind get
    (fun p  ->
       let uu____989 =
         try
           let uu____1008 = FStar_List.splitAt n1 p.goals  in ret uu____1008
      ...
      let uu____1189 =
        bind t1
          (fun uu____1193  ->
             ...
             bind uu____1194 (fun uu____1199  -> ret ()))
         in
      focus uu____1189
      ...
      (fun goal  ->
         ...
         let steps =
           ...
           FStar_List.append
             ...
             FStar_TypeChecker_Normalize.UnfoldTac] uu____1336
            in
         let w =
...
let rec __apply : Prims.bool -> FStar_Syntax_Syntax.term -> Prims.unit tac =
  fun uopt  ->
    fun tm  ->
      bind cur_goal
        (fun goal  ->
           let uu____1643 = let uu____1646 = exact tm  in trytac uu____1646
              in
           bind uu____1643
             (fun r  ->
                match r with
                           ...
                           let uu____1664 =
                             let uu____1665 =
                               FStar_TypeChecker_Rel.discharge_guard
                                ...
                                in
                             FStar_All.pipe_left
                               FStar_TypeChecker_Rel.is_trivial uu____1665
                              in
                                                 ...
                                                 let uu____1722 =
                                                   let uu____1723 =
                                                     ...
                                                     FStar_Syntax_Subst.compress
                                                       uu____1726
                                                      in
                                                   uu____1723.FStar_Syntax_Syntax.n
                                                    in
                            ...
                            | (pre,post) ->
                                let uu____2036 =
                                  ...
                                  FStar_TypeChecker_Rel.try_teq false
                                    goal.context uu____2038 goal.goal_ty
                                   in
                                                        ...
                                                        let uu____2128 =
                                                          let uu____2129 =
                                                            FStar_Syntax_Subst.compress
                                                              hd1
                                                             in
                                                          uu____2129.FStar_Syntax_Syntax.n
                                                           in
                                                        (match uu____2128
                                                         with
                                                         | FStar_Syntax_Syntax.Tm_uvar
                ...
                let uu____2378 =
                  let uu____2379 =
                    FStar_TypeChecker_Env.lookup_bv goal.context
                      (FStar_Pervasives_Native.fst h)
                     in
                  FStar_All.pipe_left FStar_Pervasives_Native.fst uu____2379
                   in
                ...
                (fun hd2  ->
                   let fa uu____2737 =
                     ...
                     | (a,q) ->
                         ...
                         bind uu____2745 (fun a1  -> ret (a1, q))
                      in
...
let flip : Prims.unit tac =
  bind get
    (fun ps  ->
       ...
       | g1::g2::gs ->
           set
             (let uu___107_3122 = ps  in
              {
                main_context = (uu___107_3122.main_context);
                main_goal = (uu___107_3122.main_goal);
                all_implicits = (uu___107_3122.all_implicits);
                goals = (g2 :: g1 :: gs);
                smt_goals = (uu___107_3122.smt_goals)
              })
...
let later : Prims.unit tac =
  bind get
    (fun ps  ->
       ...
       | g::gs ->
           set
             (let uu___108_3134 = ps  in
              {
                main_context = (uu___108_3134.main_context);
                main_goal = (uu___108_3134.main_goal);
                all_implicits = (uu___108_3134.all_implicits);
                goals = (FStar_List.append gs [g]);
                smt_goals = (uu___108_3134.smt_goals)
              }))
                      ...
                      fv,(p,uu____3233)::(q,uu____3235)::[]) when
                       ...
                       let v_q =
                         FStar_Syntax_Syntax.new_bv
                          ...
                          in
                       let g1 =
                         let uu___109_3264 = g  in
                         let uu____3265 =
                           FStar_TypeChecker_Env.push_bv g.context v_p  in
                         {
                           context = uu____3265;
                           witness = (uu___109_3264.witness);
                           goal_ty = (uu___109_3264.goal_ty);
                           opts = (uu___109_3264.opts)
                         }  in
                       let g2 =
                         let uu___110_3267 = g  in
                         let uu____3268 =
                           FStar_TypeChecker_Env.push_bv g.context v_q  in
                         {
                           context = uu____3268;
                           witness = (uu___110_3267.witness);
                           goal_ty = (uu___110_3267.goal_ty);
                           opts = (uu___110_3267.opts)
                         }  in
                       bind dismiss
                         (fun uu____3273  ->
         ...
         (let res = FStar_Options.set_options FStar_Options.Set s  in
          ...
          (match res with
           | FStar_Getopt.Success  ->
               let g' =
                 let uu___111_3321 = g  in
                 {
                   context = (uu___111_3321.context);
                   witness = (uu___111_3321.witness);
                   goal_ty = (uu___111_3321.goal_ty);
                   opts = opts'
                 }  in
               replace_cur g'
    ...
    fun typ  ->
      ...
      | (u,uu____3359,g_u) ->
          let g =
            ...
            { context = env; witness = u; goal_ty = typ; opts = uu____3368 }
             in
          let ps =
            {
              main_context = env;
