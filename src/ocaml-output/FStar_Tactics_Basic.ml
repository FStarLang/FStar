      ...
      let uu____1998 =
        with_cur_goal "visit_strengthen_else"
          (fun goal  ->
             ...
             | Some (FStar_Syntax_Util.QEx uu____2025) ->
                 let uu____2029 =
                   FStar_All.pipe_left mlog
                     (fun uu____2034  ->
                        let uu____2035 =
             ...
             | Some (FStar_Syntax_Util.QAll (xs,uu____2038,uu____2039)) ->
                 bind intros
                   (fun binders  ->
