...
let dump_proofstate : proofstate -> Prims.string -> Prims.unit =
  fun ps  ->
    fun msg  ->
      ...
      (let uu____489 = FStar_Util.string_of_int (FStar_List.length ps.goals)
          in
      ...
      then ()
        ...
        (let uu____697 =
           let uu____698 =
             ...
             let uu____700 = FStar_Syntax_Print.term_to_string goal.witness
                in
             let uu____701 = FStar_Syntax_Print.term_to_string goal.goal_ty
                in
...
let new_uvar :
  ...
  fun env  ->
    fun typ  ->
      ...
      | (u,uu____797,g_u) ->
          let uu____805 = add_implicits g_u.FStar_TypeChecker_Env.implicits
             in
      ...
      let uu____1109 =
        bind t1
          (fun uu____1111  ->
             ...
             bind uu____1112 (fun uu____1116  -> ret ()))
         in
      focus uu____1109
...
let intro : (FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.aqual) tac =
  bind cur_goal
    (fun goal  ->
       ...
       | None  ->
           let uu____1213 = FStar_Syntax_Print.term_to_string goal.goal_ty
              in
      ...
      (fun goal  ->
         ...
         let steps =
           ...
           FStar_List.append
             ...
             FStar_TypeChecker_Normalize.UnfoldTac] uu____1233
            in
         let w =
  ...
  fun t  ->
    bind cur_goal
      (fun goal  ->
         let uu____1330 =
           try
             let uu____1344 = FStar_TypeChecker_TcTerm.tc_term goal.context t
                in
             ret uu____1344
           with
           | e ->
...
let rec __apply : Prims.bool -> FStar_Syntax_Syntax.term -> Prims.unit tac =
  fun uopt  ->
    fun tm  ->
      bind cur_goal
        (fun goal  ->
           let uu____1506 = let uu____1509 = exact tm  in trytac uu____1509
              in
           bind uu____1506
             (fun r  ->
                match r with
                           ...
                           let uu____1525 =
                             let uu____1526 =
                               FStar_TypeChecker_Rel.discharge_guard
                                ...
                                in
                             FStar_All.pipe_left
                               FStar_TypeChecker_Rel.is_trivial uu____1526
                              in
                           Prims.op_Negation uu____1525  in
                         if uu____1524
                         then fail "apply: got non-trivial guard"
                         else
                           (let uu____1529 = FStar_Syntax_Util.arrow_one typ
                               in
                                        ...
                                        | (u,g_u) ->
                                            let tm' =
                                              FStar_Syntax_Syntax.mk_Tm_app
                                               ...
                                               in
                                            let uu____1571 = __apply uopt tm'
                                               in
                                            bind uu____1571
                                              (fun uu____1573  ->
                                                 let uu____1574 =
                                                   let uu____1575 =
                                                     ...
                                                     FStar_Syntax_Subst.compress
                                                       uu____1578
                                                      in
                                                   uu____1575.FStar_Syntax_Syntax.n
                                                    in
                            ...
                            | (pre,post) ->
                                let uu____1863 =
                                  ...
                                  FStar_TypeChecker_Rel.try_teq false
                                    goal.context uu____1865 goal.goal_ty
                                   in
                ...
                (fun hd2  ->
                   let fa uu____2472 =
                     ...
                     | (a,q) ->
                         ...
                         bind uu____2480 (fun a1  -> ret (a1, q))
                      in
                     ...
                     (fun t''  ->
                        let uu____2531 =
                          let uu____2532 =
                            ...
                            let uu____2543 = FStar_Syntax_Subst.close bs1 t''
                               in
      ...
      fun opts  ->
        fun env  ->
          fun t  ->
            ...
            | (t1,lcomp,g) ->
                let uu____2596 =
                  (let uu____2597 = FStar_Syntax_Util.is_total_lcomp lcomp
                      in
                ...
                (match uu____2706 with
                 | (FStar_Syntax_Syntax.Tm_fvar
                    fv,uu____2725::(l,uu____2727)::(r,uu____2729)::[]) when
                     ...
                     if uu____2765
                     then
                       let uu____2768 = FStar_Syntax_Print.term_to_string l1
                          in
                       let uu____2769 = FStar_Syntax_Print.term_to_string r1
                          in
                         ...
                         (fun uu____2921  ->
                            ...
                            bind uu____2922
                              (fun uu____2926  ->
                                 ...
                                 ret uu____2927))
                   | uu____2934 ->
                       let uu____2942 = FStar_Syntax_Print.term_to_string typ
                          in
    ...
    fun typ  ->
      ...
      | (u,uu____2995,g_u) ->
          let g =
            ...
            { context = env; witness = u; goal_ty = typ; opts = uu____3004 }
             in
          let ps =
            {
              main_context = env;
