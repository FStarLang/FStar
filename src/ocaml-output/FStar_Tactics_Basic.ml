                      ...
                      (fun u  ->
                         let lb =
                           ...
                           FStar_Syntax_Util.mk_letbinding
                             ...
                             FStar_Parser_Const.effect_Tot_lid uu____1995
                            in
      ...
      (fun goal  ->
         ...
         let steps =
           ...
           FStar_List.append
             ...
             FStar_TypeChecker_Normalize.UnfoldTac] uu____2152
            in
...
>>>>>>> taramana_pointers_with_codes_modifies
  fun uopt  ->
    fun tm  ->
      bind cur_goal
        (fun goal  ->
           let uu____2576 = let uu____2581 = exact tm  in trytac uu____2581
              in
           bind uu____2576
             (fun r  ->
                match r with
                           ...
                           let uu____2607 =
                             let uu____2608 =
                               FStar_TypeChecker_Rel.discharge_guard
                                ...
                                in
                             FStar_All.pipe_left
                               FStar_TypeChecker_Rel.is_trivial uu____2608
                              in
                                             ...
                                             let uu____2672 =
                                               let uu____2673 =
                                                 ...
                                                 FStar_Syntax_Subst.compress
                                                   uu____2676
                                                  in
                                               uu____2673.FStar_Syntax_Syntax.n
                                                in
                            ...
                            | (pre,post) ->
                                let uu____3229 =
                                  ...
                                  FStar_TypeChecker_Rel.try_teq false
                                    goal.context uu____3232 goal.goal_ty
                                   in
                                                        ...
                                                        let uu____3366 =
                                                          let uu____3367 =
                                                            FStar_Syntax_Subst.compress
                                                              hd1
                                                             in
                                                          uu____3367.FStar_Syntax_Syntax.n
                                                           in
                                                        (match uu____3366
                                                         with
                                                         | FStar_Syntax_Syntax.Tm_uvar
                ...
                let uu____3861 =
                  let uu____3862 =
                    FStar_TypeChecker_Env.lookup_bv goal.context
                      (FStar_Pervasives_Native.fst h)
                     in
                  FStar_All.pipe_left FStar_Pervasives_Native.fst uu____3862
                   in
                ...
                (fun hd2  ->
                   let fa uu____4284 =
                     ...
                     | (a,q) ->
                         ...
                         bind uu____4297 (fun a1  -> ret (a1, q))
                      in
                           ...
                           let uu____4500 =
                             let uu____4501 =
                               FStar_TypeChecker_TcTerm.universe_of env typ
                                in
                             FStar_Syntax_Util.mk_eq2 uu____4501 typ t1 ut
                              in
    ...
    fun typ  ->
      ...
      | (u,uu____5230,g_u) ->
          let g =
            ...
            { context = env; witness = u; goal_ty = typ; opts = uu____5245 }
             in
          (g, g_u)
<<<<<<< HEAD
