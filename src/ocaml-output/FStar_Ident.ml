...
let uu____220 = (FStar_ST.op_Bang x)
in (Prims.string_of_int uu____220))
in (Prims.strcat reserved_prefix uu____219))
in ((uu____218), (r)))
in (mk_ident uu____213));
)))
...
let uu____330 = (FStar_List.map text_of_id ns)
in (FStar_All.pipe_right uu____330 text_of_path))
...
let uu____341 = (FStar_Util.prefix ids)
...
let uu____359 = (FStar_List.map id_of_text (FStar_Util.split str "."))
in (lid_of_ids uu____359)))
...
let uu___25_417 = l
in {ns = uu___25_417.ns; ident = (

let uu___26_419 = l.ident
in {idText = uu___26_419.idText; idRange = r}); nsstr = uu___25_417.nsstr; str = uu___25_417.str}))
...
let uu____431 = (range_of_lid l)
in (lid_of_path (FStar_List.append path ((s)::[])) uu____431))))
...
let uu____440 = (path_of_ns lid.ns)
in (

let uu____443 = (

let uu____446 = (text_of_id lid.ident)
in (uu____446)::[])
in (FStar_List.append uu____440 uu____443)))
in (FStar_All.pipe_left (FStar_String.concat "_") uu____437)))
...
let uu____459 = (path_of_lid lid)
in (text_of_path uu____459)))
