...
let uu____212 = (FStar_ST.op_Bang x)
in (Prims.string_of_int uu____212))
in (Prims.strcat reserved_prefix uu____211))
in ((uu____210), (r)))
in (mk_ident uu____205));
)))
...
let uu____323 = (FStar_List.map text_of_id ns)
in (FStar_All.pipe_right uu____323 text_of_path))
...
let uu____334 = (FStar_Util.prefix ids)
...
let uu____352 = (FStar_List.map id_of_text (FStar_Util.split str "."))
in (lid_of_ids uu____352)))
...
let uu___80_410 = l
in {ns = uu___80_410.ns; ident = (

let uu___81_412 = l.ident
in {idText = uu___81_412.idText; idRange = r}); nsstr = uu___80_410.nsstr; str = uu___80_410.str}))
...
let uu____424 = (range_of_lid l)
in (lid_of_path (FStar_List.append path ((s)::[])) uu____424))))
...
let uu____433 = (path_of_ns lid.ns)
in (

let uu____436 = (

let uu____439 = (text_of_id lid.ident)
in (uu____439)::[])
in (FStar_List.append uu____433 uu____436)))
in (FStar_All.pipe_left (FStar_String.concat "_") uu____430)))
...
let uu____452 = (path_of_lid lid)
in (text_of_path uu____452)))
