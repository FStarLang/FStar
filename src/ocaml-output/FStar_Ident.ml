...
let uu____106 = (FStar_ST.read x)
in (uu____106 + (Prims.parse_int "1")))
in (FStar_ST.write x uu____105));
(
...
let uu____118 = (FStar_ST.read x)
in (Prims.string_of_int uu____118))
in (Prims.strcat reserved_prefix uu____117))
in ((uu____116), (r)))
in (mk_ident uu____111));
)))
...
let uu____178 = (FStar_List.map text_of_id ns)
in (FStar_All.pipe_right uu____178 text_of_path))
...
let uu____192 = (FStar_Util.prefix ids)
...
let uu____209 = (FStar_List.map id_of_text (FStar_Util.split str "."))
in (lid_of_ids uu____209)))
...
let uu___47_261 = l
in {ns = uu___47_261.ns; ident = (

let uu___48_263 = l.ident
in {idText = uu___48_263.idText; idRange = r}); nsstr = uu___47_261.nsstr; str = uu___47_261.str}))
...
let uu____279 = (path_of_lid lid)
in (text_of_path uu____279)))
