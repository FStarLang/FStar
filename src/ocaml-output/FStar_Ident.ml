...
let uu____134 = (FStar_List.map id_of_text (FStar_Util.split str "."))
in (lid_of_ids uu____134)))
...
let uu___46_171 = l
in {ns = uu___46_171.ns; ident = (

let uu___47_172 = l.ident
in {idText = uu___47_172.idText; idRange = r}); nsstr = uu___46_171.nsstr; str = uu___46_171.str}))
...
let uu____184 = (path_of_lid lid)
in (text_of_path uu____184)))
