...
let gen : FStar_Range.range -> ident =
  ...
  fun r  ->
    (let uu____62 =
       let uu____63 = FStar_ST.read x  in uu____63 + (Prims.parse_int "1")
        in
     FStar_ST.write x uu____62);
    (let uu____68 =
       let uu____71 =
         let uu____72 =
           let uu____73 = FStar_ST.read x  in Prims.string_of_int uu____73
            in
...
let set_lid_range : lident -> FStar_Range.range -> lident =
  fun l  ->
    fun r  ->
      let uu___46_166 = l  in
      {
        ns = (uu___46_166.ns);
        ident =
          (let uu___47_167 = l.ident  in
           { idText = (uu___47_167.idText); idRange = r });
        nsstr = (uu___46_166.nsstr);
        str = (uu___46_166.str)
      }
