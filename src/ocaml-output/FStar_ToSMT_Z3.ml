...
| () -> begin
(let _126_27 = (FStar_ST.read FStar_Options.z3_exe)
in (FStar_Util.run_proc _126_27 "-version" ""))
...
let x = (let _126_29 = (FStar_Util.substring_from x (FStar_String.length prefix))
in (FStar_Util.trim_string _126_29))
in (
...
let t = if (let _126_34 = (get_z3version ())
in (z3v_le _126_34 (4, 3, 1))) then begin
...
let timeout = (let _126_35 = (FStar_Util.string_of_int t)
in (FStar_Util.format1 "-t:%s" _126_35))
in (
# 74 "FStar.ToSMT.Z3.fst"
let relevancy = if (let _126_36 = (get_z3version ())
in (z3v_le _126_36 (4, 3, 1))) then begin
"RELEVANCY"
end else begin
"SMT.RELEVANCY"
end
...
| () -> begin
(let _126_45 = (FStar_Util.current_tid ())
in (FStar_All.pipe_right _126_45 FStar_Util.string_of_int))
end))
...
in x))
in (let _126_53 = (FStar_ST.read FStar_Options.z3_exe)
in (let _126_52 = (ini_params ())
in (FStar_Util.start_process id _126_53 _126_52 cond)))))
...
in (let _126_86 = (let _126_85 = (let _126_84 = (FStar_ST.read ctr)
in (FStar_Util.string_of_int _126_84))
in (FStar_Util.format1 "queries-%s.smt2" _126_85))
in (FStar_Util.open_file_for_writing _126_86)))
end else begin
...
| () -> begin
(let _126_95 = (let _126_94 = (
# 131 "FStar.ToSMT.Z3.fst"
let _44_102 = (FStar_Util.incr ctr)
in (let _126_93 = (FStar_ST.read ctr)
in (FStar_All.pipe_right _126_93 FStar_Util.string_of_int)))
in (FStar_Util.format1 "bg-%s" _126_94))
in (new_z3proc _126_95))
end))
in (
# 132 "FStar.ToSMT.Z3.fst"
let z3proc = (let _126_96 = (new_proc ())
in (FStar_Util.mk_ref _126_96))
in (
...
let _44_117 = (let _126_103 = (new_proc ())
in (FStar_ST.op_Colon_Equals z3proc _126_103))
in (
...
let fh = (let _126_106 = (let _126_105 = (let _126_104 = (FStar_ST.read ctr)
in (FStar_All.pipe_right _126_104 FStar_Util.string_of_int))
in (FStar_Util.format1 "queries-bg-%s.smt2" _126_105))
in (FStar_Util.open_file_for_writing _126_106))
...
| "unknown"::tl -> begin
(let _126_118 = (lblnegs tl)
in (UNKNOWN, _126_118))
end
| "sat"::tl -> begin
(let _126_119 = (lblnegs tl)
in (SAT, _126_119))
end
| "unsat"::tl -> begin
(UNSAT, [])
...
| _44_166 -> begin
(let _126_123 = (let _126_122 = (let _126_121 = (FStar_List.map (fun l -> (FStar_Util.format1 "<%s>" (FStar_Util.trim_string l))) lines)
in (FStar_String.concat "\n" _126_121))
in (FStar_Util.format1 "Got output lines: %s\n" _126_122))
in (FStar_All.pipe_left FStar_All.failwith _126_123))
end))
in (result lines)))))
in (
...
in (let _126_129 = (let _126_128 = (FStar_ST.read ctr)
in (FStar_Util.string_of_int _126_128))
in (new_z3proc _126_129)))
end else begin
(bg_z3_proc.grab ())
end
in (
...
let mbqi = if (let _126_132 = (get_z3version ())
in (z3v_le _126_132 (4, 3, 1))) then begin
"mbqi"
end else begin
"smt.mbqi"
end
...
let model_on_timeout = if (let _126_133 = (get_z3version ())
in (z3v_le _126_133 (4, 3, 1))) then begin
...
| () -> begin
(let _126_157 = (let _126_156 = (let _126_155 = (FStar_Range.mk_range "" 0 0)
in ("", _126_155))
in (_126_156)::[])
in (false, _126_157))
end)); callback = (fun a -> ())})::[]))
...
(let _126_168 = (FStar_Util.format1 "Z3 says: %s\n" (status_to_string status))
in (FStar_All.pipe_left FStar_Util.print_string _126_168))
end else begin
()
end
in (
...
and run_job : z3job  ->  Prims.unit = (fun j -> (let _126_180 = (j.job ())
in (FStar_All.pipe_left j.callback _126_180)))
...
let _44_265 = (let _126_190 = (let _126_189 = (FStar_ST.read job_queue)
in (FStar_List.append _126_189 ((j)::[])))
in (FStar_ST.op_Colon_Equals job_queue _126_190))
in (
...
| () -> begin
(let _126_198 = (FStar_ST.read pending_jobs)
in (let _126_197 = (let _126_196 = (FStar_ST.read job_queue)
in (FStar_List.length _126_196))
in (_126_198, _126_197)))
end)))
in (match (_44_280) with
| (n, m) -> begin
if ((n + m) = 0) then begin
(let _126_199 = (FStar_Tc_Errors.report_all ())
in (FStar_All.pipe_right _126_199 Prims.ignore))
end else begin
(
...
let _44_284 = (let _126_203 = (let _126_202 = (FStar_ST.read fresh_scope)
in ((FStar_ToSMT_Term.Caption (msg))::[])::_126_202)
in (FStar_ST.op_Colon_Equals fresh_scope _126_203))
in (let _126_205 = (let _126_204 = (FStar_ST.read bg_scope)
in (FStar_List.append ((FStar_ToSMT_Term.Caption (msg))::(FStar_ToSMT_Term.Push)::[]) _126_204))
in (FStar_ST.op_Colon_Equals bg_scope _126_205))))

# 283 "FStar.ToSMT.Z3.fst"
let pop : Prims.string  ->  Prims.unit = (fun msg -> (
# 284 "FStar.ToSMT.Z3.fst"
let _44_287 = (let _126_209 = (let _126_208 = (FStar_ST.read fresh_scope)
in (FStar_List.tl _126_208))
in (FStar_ST.op_Colon_Equals fresh_scope _126_209))
in (let _126_211 = (let _126_210 = (FStar_ST.read bg_scope)
in (FStar_List.append ((FStar_ToSMT_Term.Caption (msg))::(FStar_ToSMT_Term.Pop)::[]) _126_210))
in (FStar_ST.op_Colon_Equals bg_scope _126_211))))
...
in (let _126_215 = (let _126_214 = (FStar_ST.read bg_scope)
in (FStar_List.append (FStar_List.rev decls) _126_214))
in (FStar_ST.op_Colon_Equals bg_scope _126_215))))

# 291 "FStar.ToSMT.Z3.fst"
let bgtheory : Prims.bool  ->  FStar_ToSMT_Term.decl Prims.list = (fun fresh -> if fresh then begin
(let _126_219 = (let _126_218 = (FStar_ST.read fresh_scope)
in (FStar_List.rev _126_218))
in (FStar_All.pipe_right _126_219 FStar_List.flatten))
end else begin
(
...
let input = (let _126_236 = (let _126_235 = (let _126_234 = (z3_options ())
in (FStar_ToSMT_Term.declToSmt _126_234))
in (FStar_List.map _126_235 theory))
in (FStar_All.pipe_right _126_236 (FStar_String.concat "\n")))
in (
