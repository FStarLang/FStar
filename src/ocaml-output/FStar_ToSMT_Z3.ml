...
| None -> begin
(let _51_31 = (let _120_26 = (FStar_ST.read FStar_Options.z3_exe)
in (FStar_Util.run_proc _120_26 "-version" ""))
in (match (_51_31) with
| (_51_27, out, _51_30) -> begin
(let out = (match ((FStar_Util.splitlines out)) with
| x::_51_33 when (FStar_Util.starts_with x prefix) -> begin
(let x = (let _120_27 = (FStar_Util.substring_from x (FStar_String.length prefix))
in (FStar_Util.trim_string _120_27))
...
| () -> begin
(let t = (match ((let _120_32 = (get_z3version ())
in (z3v_le _120_32 (4, 3, 1)))) with
| true -> begin
...
in (let timeout = (let _120_33 = (FStar_Util.string_of_int t)
in (FStar_Util.format1 "-t:%s" _120_33))
in (let relevancy = (match ((let _120_34 = (get_z3version ())
in (z3v_le _120_34 (4, 3, 1)))) with
| true -> begin
"RELEVANCY"
end
| false -> begin
...
| () -> begin
(let _120_43 = (FStar_Util.current_tid ())
in (FStar_All.pipe_right _120_43 FStar_Util.string_of_int))
end))

let new_z3proc = (fun id -> (let cond = (fun pid s -> (let x = ((FStar_Util.trim_string s) = "Done!")
in x))
in (let _120_51 = (FStar_ST.read FStar_Options.z3_exe)
in (let _120_50 = (ini_params ())
in (FStar_Util.start_process id _120_51 _120_50 cond)))))
...
in (let _120_84 = (let _120_83 = (let _120_82 = (FStar_ST.read ctr)
in (FStar_Util.string_of_int _120_82))
in (FStar_Util.format1 "queries-%s.smt2" _120_83))
in (FStar_Util.open_file_for_writing _120_84)))
end
| false -> begin
...
| () -> begin
(let _120_93 = (let _120_92 = (let _51_93 = (FStar_Util.incr ctr)
in (let _120_91 = (FStar_ST.read ctr)
in (FStar_All.pipe_right _120_91 FStar_Util.string_of_int)))
in (FStar_Util.format1 "bg-%s" _120_92))
in (new_z3proc _120_93))
end))
in (let z3proc = (let _120_94 = (new_proc ())
in (FStar_Util.mk_ref _120_94))
in (let x = []
...
in (let _51_108 = (let _120_101 = (new_proc ())
in (FStar_ST.op_Colon_Equals z3proc _120_101))
...
in (let fh = (let _120_104 = (let _120_103 = (let _120_102 = (FStar_ST.read ctr)
in (FStar_All.pipe_right _120_102 FStar_Util.string_of_int))
in (FStar_Util.format1 "queries-bg-%s.smt2" _120_103))
in (FStar_Util.open_file_for_writing _120_104))
...
| "unknown"::tl -> begin
(let _120_116 = (lblnegs tl)
in (UNKNOWN, _120_116))
end
| "sat"::tl -> begin
(let _120_117 = (lblnegs tl)
in (SAT, _120_117))
end
| "unsat"::tl -> begin
(UNSAT, [])
...
| _51_157 -> begin
(let _120_121 = (let _120_120 = (let _120_119 = (FStar_List.map (fun l -> (FStar_Util.format1 "<%s>" (FStar_Util.trim_string l))) lines)
in (FStar_String.concat "\n" _120_119))
in (FStar_Util.format1 "Got output lines: %s\n" _120_120))
in (FStar_All.pipe_left FStar_All.failwith _120_121))
end))
in (result lines)))))
...
in (let _120_127 = (let _120_126 = (FStar_ST.read ctr)
in (FStar_Util.string_of_int _120_126))
in (new_z3proc _120_127)))
end
| false -> begin
(bg_z3_proc.grab ())
end)
...
| () -> begin
(let mbqi = (match ((let _120_130 = (get_z3version ())
in (z3v_le _120_130 (4, 3, 1)))) with
| true -> begin
"mbqi"
end
| false -> begin
...
in (let model_on_timeout = (match ((let _120_131 = (get_z3version ())
in (z3v_le _120_131 (4, 3, 1)))) with
| true -> begin
...
| () -> begin
(let _120_155 = (let _120_154 = (let _120_153 = (FStar_Range.mk_range "" 0 0)
in ("", _120_153))
in (_120_154)::[])
in (false, _120_155))
end)); callback = (fun a -> ())})::[]))
...
| true -> begin
(let _120_166 = (FStar_Util.format1 "Z3 says: %s\n" (status_to_string status))
in (FStar_All.pipe_left FStar_Util.print_string _120_166))
end
| false -> begin
()
end)
...
and run_job = (fun j -> (let _120_178 = (j.job ())
in (FStar_All.pipe_left j.callback _120_178)))
...
in (let _51_256 = (let _120_188 = (let _120_187 = (FStar_ST.read job_queue)
in (FStar_List.append _120_187 ((j)::[])))
in (FStar_ST.op_Colon_Equals job_queue _120_188))
...
| () -> begin
(let _120_196 = (FStar_ST.read pending_jobs)
in (let _120_195 = (let _120_194 = (FStar_ST.read job_queue)
in (FStar_List.length _120_194))
in (_120_196, _120_195)))
end)))
in (match (_51_271) with
| (n, m) -> begin
(match (((n + m) = 0)) with
| true -> begin
(let _120_197 = (FStar_Tc_Errors.report_all ())
in (FStar_All.pipe_right _120_197 Prims.ignore))
end
| false -> begin
...
let push = (fun msg -> (let _51_275 = (let _120_201 = (let _120_200 = (FStar_ST.read fresh_scope)
in ((FStar_ToSMT_Term.Caption (msg))::[])::_120_200)
in (FStar_ST.op_Colon_Equals fresh_scope _120_201))
in (let _120_203 = (let _120_202 = (FStar_ST.read bg_scope)
in (FStar_List.append ((FStar_ToSMT_Term.Caption (msg))::(FStar_ToSMT_Term.Push)::[]) _120_202))
in (FStar_ST.op_Colon_Equals bg_scope _120_203))))

let pop = (fun msg -> (let _51_278 = (let _120_207 = (let _120_206 = (FStar_ST.read fresh_scope)
in (FStar_List.tl _120_206))
in (FStar_ST.op_Colon_Equals fresh_scope _120_207))
in (let _120_209 = (let _120_208 = (FStar_ST.read bg_scope)
in (FStar_List.append ((FStar_ToSMT_Term.Caption (msg))::(FStar_ToSMT_Term.Pop)::[]) _120_208))
in (FStar_ST.op_Colon_Equals bg_scope _120_209))))
...
in (let _120_213 = (let _120_212 = (FStar_ST.read bg_scope)
in (FStar_List.append (FStar_List.rev decls) _120_212))
in (FStar_ST.op_Colon_Equals bg_scope _120_213))))

let bgtheory = (fun fresh -> (match (fresh) with
| true -> begin
(let _120_217 = (let _120_216 = (FStar_ST.read fresh_scope)
in (FStar_List.rev _120_216))
in (FStar_All.pipe_right _120_217 FStar_List.flatten))
end
| false -> begin
...
in (let input = (let _120_234 = (let _120_233 = (let _120_232 = (z3_options ())
in (FStar_ToSMT_Term.declToSmt _120_232))
in (FStar_List.map _120_233 theory))
in (FStar_All.pipe_right _120_234 (FStar_String.concat "\n")))
