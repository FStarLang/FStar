...
let _45_19 = (let _144_32 = (let _144_31 = (FStar_ST.read verification_errs)
...
let vars = (fun v -> (let _144_195 = (FStar_All.pipe_right v (FStar_List.map (fun _45_1 -> (match (_45_1) with
