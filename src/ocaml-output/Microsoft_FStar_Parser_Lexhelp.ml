...
let call_string_finish = (fun ( fin ) ( buf ) ( endm ) ( b ) -> (let _111_19 = (Support.Microsoft.FStar.Bytes.close buf)
in (fin endm b _111_19)))

let add_string = (fun ( buf ) ( x ) -> (let _111_24 = (Support.Microsoft.FStar.Bytes.string_as_unicode_bytes x)
in (Support.Microsoft.FStar.Bytes.emit_bytes buf _111_24)))
...
in (let _111_40 = ((Support.Microsoft.FStar.Bytes.length bytes) / 2)
in (Support.Microsoft.FStar.Bytes.make (fun ( i ) -> (Support.Microsoft.FStar.Bytes.get bytes (i * 2))) _111_40))))
...
in (let _45_32 = (let _111_44 = (((Support.Microsoft.FStar.Bytes.length bytes) / 2) - 1)
in (Support.Microsoft.FStar.Util.for_range 0 _111_44 (fun ( i ) -> (match (((Support.Microsoft.FStar.Bytes.get bytes ((i * 2) + 1)) <> 0)) with
| true -> begin
...
| false -> begin
(let _111_63 = (((let _111_59 = (Support.Microsoft.FStar.Util.char_at s 0)
in (hexdigit _111_59)) * 4096) + (((let _111_60 = (Support.Microsoft.FStar.Util.char_at s 1)
in (hexdigit _111_60)) * 256) + (((let _111_61 = (Support.Microsoft.FStar.Util.char_at s 2)
in (hexdigit _111_61)) * 16) + (let _111_62 = (Support.Microsoft.FStar.Util.char_at s 3)
in (hexdigit _111_62)))))
in (Support.Microsoft.FStar.Util.uint16_of_int _111_63))
end))
...
| false -> begin
(let _111_68 = (((let _111_66 = (Support.Microsoft.FStar.Util.char_at s 0)
in (hexdigit _111_66)) * 16) + (let _111_67 = (Support.Microsoft.FStar.Util.char_at s 1)
in (hexdigit _111_67)))
in (Support.Microsoft.FStar.Util.uint16_of_int _111_68))
end))
...
| false -> begin
(let high = (((let _111_71 = (Support.Microsoft.FStar.Util.char_at s 0)
in (hexdigit _111_71)) * 4096) + (((let _111_72 = (Support.Microsoft.FStar.Util.char_at s 1)
in (hexdigit _111_72)) * 256) + (((let _111_73 = (Support.Microsoft.FStar.Util.char_at s 2)
in (hexdigit _111_73)) * 16) + (let _111_74 = (Support.Microsoft.FStar.Util.char_at s 3)
in (hexdigit _111_74)))))
in (let low = (((let _111_75 = (Support.Microsoft.FStar.Util.char_at s 4)
in (hexdigit _111_75)) * 4096) + (((let _111_76 = (Support.Microsoft.FStar.Util.char_at s 5)
in (hexdigit _111_76)) * 256) + (((let _111_77 = (Support.Microsoft.FStar.Util.char_at s 6)
in (hexdigit _111_77)) * 16) + (let _111_78 = (Support.Microsoft.FStar.Util.char_at s 7)
in (hexdigit _111_78)))))
...
let keywords = (let _111_84 = (Support.List.map (fun ( s ) -> (FSHARP, s, Microsoft_FStar_Parser_Parse.RESERVED)) (("atomic")::("break")::("checked")::("component")::("constraint")::("constructor")::("continue")::("eager")::("fixed")::("functor")::("global")::("include")::("mixin")::("parallel")::("process")::("protected")::("pure")::("sealed")::("trait")::("tailcall")::("volatile")::[]))
...
| true -> begin
(let _45_92 = (let _111_127 = (let _111_126 = (Support.Microsoft.FStar.Range.string_of_range r)
in (Support.Microsoft.FStar.Util.format2 "The keyword \'%s\' is reserved for future use by F#. (%s)" s _111_126))
in (Support.Microsoft.FStar.Util.print_string _111_127))
...
in (Support.Microsoft.FStar.Bytes.string_as_unicode_bytes _111_129))
in Microsoft_FStar_Parser_Parse.STRING (_111_130))
end
| "__SOURCE_FILE__" -> begin
(let _111_132 = (let _111_131 = (Support.Microsoft.FStar.Range.file_of_range r)
in (Support.Microsoft.FStar.Bytes.string_as_unicode_bytes _111_131))
in Microsoft_FStar_Parser_Parse.STRING (_111_132))
end
| "__LINE__" -> begin
(let _111_136 = (let _111_135 = (let _111_134 = (let _111_133 = (Support.Microsoft.FStar.Range.start_of_range r)
in (Support.Microsoft.FStar.Range.line_of_pos _111_133))
in (Support.All.pipe_left Support.Microsoft.FStar.Util.string_of_int _111_134))
in (_111_135, false))
