...
let call_string_finish = (fun ( fin ) ( buf ) ( endm ) ( b ) -> (let _70_20219 = (Support.Microsoft.FStar.Bytes.close buf)
in (fin endm b _70_20219)))

let add_string = (fun ( buf ) ( x ) -> (let _70_20224 = (Support.Microsoft.FStar.Bytes.string_as_unicode_bytes x)
in (Support.Microsoft.FStar.Bytes.emit_bytes buf _70_20224)))
...
in (let _70_20240 = ((Support.Microsoft.FStar.Bytes.length bytes) / 2)
in (Support.Microsoft.FStar.Bytes.make (fun ( i ) -> (Support.Microsoft.FStar.Bytes.get bytes (i * 2))) _70_20240))))
...
in (let _45_32 = (let _70_20244 = (((Support.Microsoft.FStar.Bytes.length bytes) / 2) - 1)
in (Support.Microsoft.FStar.Util.for_range 0 _70_20244 (fun ( i ) -> (match (((Support.Microsoft.FStar.Bytes.get bytes ((i * 2) + 1)) <> 0)) with
| true -> begin
...
| false -> begin
(let _70_20263 = (((let _70_20259 = (Support.Microsoft.FStar.Util.char_at s 0)
in (hexdigit _70_20259)) * 4096) + (((let _70_20260 = (Support.Microsoft.FStar.Util.char_at s 1)
in (hexdigit _70_20260)) * 256) + (((let _70_20261 = (Support.Microsoft.FStar.Util.char_at s 2)
in (hexdigit _70_20261)) * 16) + (let _70_20262 = (Support.Microsoft.FStar.Util.char_at s 3)
in (hexdigit _70_20262)))))
in (Support.Microsoft.FStar.Util.uint16_of_int _70_20263))
end))
...
| false -> begin
(let _70_20268 = (((let _70_20266 = (Support.Microsoft.FStar.Util.char_at s 0)
in (hexdigit _70_20266)) * 16) + (let _70_20267 = (Support.Microsoft.FStar.Util.char_at s 1)
in (hexdigit _70_20267)))
in (Support.Microsoft.FStar.Util.uint16_of_int _70_20268))
end))
...
| false -> begin
(let high = (((let _70_20271 = (Support.Microsoft.FStar.Util.char_at s 0)
in (hexdigit _70_20271)) * 4096) + (((let _70_20272 = (Support.Microsoft.FStar.Util.char_at s 1)
in (hexdigit _70_20272)) * 256) + (((let _70_20273 = (Support.Microsoft.FStar.Util.char_at s 2)
in (hexdigit _70_20273)) * 16) + (let _70_20274 = (Support.Microsoft.FStar.Util.char_at s 3)
in (hexdigit _70_20274)))))
in (let low = (((let _70_20275 = (Support.Microsoft.FStar.Util.char_at s 4)
in (hexdigit _70_20275)) * 4096) + (((let _70_20276 = (Support.Microsoft.FStar.Util.char_at s 5)
in (hexdigit _70_20276)) * 256) + (((let _70_20277 = (Support.Microsoft.FStar.Util.char_at s 6)
in (hexdigit _70_20277)) * 16) + (let _70_20278 = (Support.Microsoft.FStar.Util.char_at s 7)
in (hexdigit _70_20278)))))
...
let mkLexargs = (fun ( _45_84 ) -> (match (_45_84) with
...
| true -> begin
(let _45_90 = (let _70_20323 = (let _70_20322 = (Support.Microsoft.FStar.Range.string_of_range r)
in (Support.Microsoft.FStar.Util.format2 "The keyword \'%s\' is reserved for future use by F#. (%s)" s _70_20322))
in (Support.Microsoft.FStar.Util.print_string _70_20323))
in (let _70_20324 = (intern_string s)
in Microsoft_FStar_Parser_Parse.IDENT (_70_20324)))
end
| false -> begin
v
end)
...
(let _70_20326 = (let _70_20325 = (args.getSourceDirectory ())
in (Support.Microsoft.FStar.Bytes.string_as_unicode_bytes _70_20325))
in Microsoft_FStar_Parser_Parse.STRING (_70_20326))
end
| "__SOURCE_FILE__" -> begin
(let _70_20328 = (let _70_20327 = (Support.Microsoft.FStar.Range.file_of_range r)
in (Support.Microsoft.FStar.Bytes.string_as_unicode_bytes _70_20327))
in Microsoft_FStar_Parser_Parse.STRING (_70_20328))
end
| "__LINE__" -> begin
(let _70_20332 = (let _70_20331 = (let _70_20330 = (let _70_20329 = (Support.Microsoft.FStar.Range.start_of_range r)
in (Support.Microsoft.FStar.Range.line_of_pos _70_20329))
in (Support.All.pipe_left Support.Microsoft.FStar.Util.string_of_int _70_20330))
in (_70_20331, false))
in Microsoft_FStar_Parser_Parse.INT (_70_20332))
end
| _45_97 -> begin
(let _70_20333 = (intern_string s)
in Microsoft_FStar_Parser_Parse.IDENT (_70_20333))
end)
end))
