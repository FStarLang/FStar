          ...
          let def_of_lid lid =
            ...
            FStar_Util.bind_opt uu____469
              (fun uu___0_514  ->
                 ...
                 | uu____570 -> FStar_Pervasives_Native.None)
             in
          let info_at_pos_opt =
    ...
    fun search_term  ->
      ...
      let mods_and_nss =
        FStar_Interactive_CompletionTable.autocomplete_mod_or_ns
          st.FStar_JsonHelper.repl_names needle mod_filter
         in
      let lids =
                   ...
                   then l
                     ...
                     (let uu____1188 =
                        let uu____1192 = FStar_String.get s i  in uu____1192
                          :: l
                         in
                      exp (i - (Prims.parse_int "1")) uu____1188)
                    in
                 exp ((FStar_String.length s) - (Prims.parse_int "1")) []  in
               let begin_col =
                 let uu____1200 =
                   let uu____1204 = explode str  in FStar_List.rev uu____1204
                    in
