...
open Prims
# 37 "FStar.Extraction.ML.Term.fst"
...
# 54 "FStar.Extraction.ML.Term.fst"
...
# 65 "FStar.Extraction.ML.Term.fst"
...
# 82 "FStar.Extraction.ML.Term.fst"
...
# 88 "FStar.Extraction.ML.Term.fst"
...
in (
# 90 "FStar.Extraction.ML.Term.fst"
...
# 112 "FStar.Extraction.ML.Term.fst"
...
# 116 "FStar.Extraction.ML.Term.fst"
...
(
# 140 "FStar.Extraction.ML.Term.fst"
...
in (
# 141 "FStar.Extraction.ML.Term.fst"
...
# 195 "FStar.Extraction.ML.Term.fst"
...
# 199 "FStar.Extraction.ML.Term.fst"
...
# 212 "FStar.Extraction.ML.Term.fst"
...
# 237 "FStar.Extraction.ML.Term.fst"
...
# 250 "FStar.Extraction.ML.Term.fst"
...
| _78_280 -> begin
(
# 256 "FStar.Extraction.ML.Term.fst"
...
(
# 272 "FStar.Extraction.ML.Term.fst"
let _78_287 = (FStar_List.hd l)
in (match (_78_287) with
| (p1, w1, e1) -> begin
(
# 273 "FStar.Extraction.ML.Term.fst"
...
# 323 "FStar.Extraction.ML.Term.fst"
...
# 336 "FStar.Extraction.ML.Term.fst"
...
# 356 "FStar.Extraction.ML.Term.fst"
...
# 360 "FStar.Extraction.ML.Term.fst"
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
...
| (mlbs, env) -> begin
(
# 385 "FStar.Extraction.ML.Term.fst"
let t_ret = (
...
in (
# 397 "FStar.Extraction.ML.Term.fst"
...
let b = (Prims.fst b)
in (
# 449 "FStar.Extraction.ML.Term.fst"
...
let b = (Prims.fst b)
in (
# 454 "FStar.Extraction.ML.Term.fst"
...
# 516 "FStar.Extraction.ML.Term.fst"
...
(
# 540 "FStar.Extraction.ML.Term.fst"
let mlty = (term_as_mlty g x.FStar_Syntax_Syntax.sort)
in (
# 541 "FStar.Extraction.ML.Term.fst"
...
# 631 "FStar.Extraction.ML.Term.fst"
...
# 632 "FStar.Extraction.ML.Term.fst"
...
# 648 "FStar.Extraction.ML.Term.fst"
...
| _78_795 -> begin
(
# 652 "FStar.Extraction.ML.Term.fst"
...
(
# 655 "FStar.Extraction.ML.Term.fst"
...
# 680 "FStar.Extraction.ML.Term.fst"
...
# 702 "FStar.Extraction.ML.Term.fst"
...
(
# 767 "FStar.Extraction.ML.Term.fst"
...
in (
# 891 "FStar.Extraction.ML.Term.fst"
...
# 984 "FStar.Extraction.ML.Term.fst"
...
in (
# 1017 "FStar.Extraction.ML.Term.fst"
...
in (
# 1020 "FStar.Extraction.ML.Term.fst"
...
in (
# 1021 "FStar.Extraction.ML.Term.fst"
...
| _78_1448 -> begin
(
# 1041 "FStar.Extraction.ML.Term.fst"
...
(
# 1049 "FStar.Extraction.ML.Term.fst"
...
in (
# 1051 "FStar.Extraction.ML.Term.fst"
...
| (env_body, lbs) -> begin
(
# 1062 "FStar.Extraction.ML.Term.fst"
...
in (
# 1066 "FStar.Extraction.ML.Term.fst"
...
in (
# 1070 "FStar.Extraction.ML.Term.fst"
...
| Some (w) -> begin
(
# 1100 "FStar.Extraction.ML.Term.fst"
let _78_1556 = (term_as_mlexpr env w)
in (match (_78_1556) with
| (w, f_w, t_w) -> begin
(
# 1101 "FStar.Extraction.ML.Term.fst"
...
(
# 1103 "FStar.Extraction.ML.Term.fst"
...
| (p, wopt) -> begin
(
# 1107 "FStar.Extraction.ML.Term.fst"
...
(
# 1110 "FStar.Extraction.ML.Term.fst"
let mlbranches = (FStar_List.flatten mlbranches)
in (
# 1113 "FStar.Extraction.ML.Term.fst"
...
| [] -> begin
(
# 1116 "FStar.Extraction.ML.Term.fst"
...
(
# 1123 "FStar.Extraction.ML.Term.fst"
...
(
# 1127 "FStar.Extraction.ML.Term.fst"
let f = (FStar_Extraction_ML_Util.join f f_branch)
in (
# 1128 "FStar.Extraction.ML.Term.fst"
...
| (topt, f_match) -> begin
(
# 1141 "FStar.Extraction.ML.Term.fst"
...
(
# 1142 "FStar.Extraction.ML.Term.fst"
...
in (
# 1148 "FStar.Extraction.ML.Term.fst"
...
# 1156 "FStar.Extraction.ML.Term.fst"
let fresh : Prims.string  ->  (Prims.string * Prims.int) = (
# 1156 "FStar.Extraction.ML.Term.fst"
let c = (FStar_Util.mk_ref 0)
in (fun x -> (
# 1157 "FStar.Extraction.ML.Term.fst"
let _78_1637 = (FStar_Util.incr c)
in (let _171_490 = (FStar_ST.read c)
in ((x), (_171_490))))))

# 1159 "FStar.Extraction.ML.Term.fst"
...
# 1161 "FStar.Extraction.ML.Term.fst"
...
(
# 1162 "FStar.Extraction.ML.Term.fst"
...
in (
# 1173 "FStar.Extraction.ML.Term.fst"
let mlid = (fresh "_discr_")
in (
# 1174 "FStar.Extraction.ML.Term.fst"
let targ = FStar_Extraction_ML_Syntax.MLTY_Top
in (
# 1177 "FStar.Extraction.ML.Term.fst"
let disc_ty = FStar_Extraction_ML_Syntax.MLTY_Top
in (
# 1178 "FStar.Extraction.ML.Term.fst"
