              ...
              let when_clause =
                let uu____1995 =
                  let uu____1996 =
                    ...
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____2000) in
                  FStar_Extraction_ML_Syntax.MLE_App uu____1996 in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____1995 in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          ...
          | uu____2767 -> failwith "Impossible: Unable to translate pattern" in
        let mk_when_clause whens =
          ...
          | hd1::tl1 ->
              ...
              FStar_Pervasives_Native.Some uu____2792 in
        let uu____2793 =
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____2909 -> failwith "Impossible: Head type is not an arrow" in
              ...
              let e =
                ...
                | uu____3048 ->
                    let uu____3050 =
                      ...
                      (uu____3054, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____3050 in
              FStar_Extraction_ML_Syntax.with_ty
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then let uu____3201 = maybe_coerce g e t ty in (uu____3201, ty)
        ...
        (fun u  ->
           let uu____3212 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____3213 uu____3214 uu____3215 in
      ...
      (let t = FStar_Syntax_Subst.compress top in
       ...
       | FStar_Syntax_Syntax.Tm_uvar uu____3251 ->
           let uu____3260 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____3261 in
           failwith uu____3260
       | FStar_Syntax_Syntax.Tm_bvar uu____3265 ->
           let uu____3266 =
             let uu____3267 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____3267 in
           failwith uu____3266
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,args) ->
           let is_total uu___140_3717 =
             match uu___140_3717 with
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____3791 in
                let tm =
                  let uu____3799 =
                    let uu____3800 = FStar_TypeChecker_Util.remove_reify e in
                                    ...
                                    (match uu____4452 with
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                               uu____4512 ->
                                               let uu___144_4513 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4513.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4513.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____4514 ->
                                               let uu___144_4515 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4515.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4515.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_4521 =
                                                        head3 in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_4521.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_4521.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                    ...
                                    (match uu____4705 with
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                               uu____4765 ->
                                               let uu___144_4766 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4766.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4766.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____4767 ->
                                               let uu___144_4768 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4768.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4768.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_4774 =
                                                        head3 in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_4774.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_4774.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
               ...
               (let uu____4916 = FStar_Syntax_Syntax.is_top_level lbs in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs in
                   ...
                   let lb1 =
                     let uu___146_4928 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___146_4928.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___146_4928.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___146_4928.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___146_4928.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e'1 =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____4945 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4949  ->
                            ...
                            (let lbdef =
                             ...
                             let uu___147_4957 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___147_4957.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___147_4957.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___147_4957.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___147_4957.FStar_Syntax_Syntax.lbeff);
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____5032 = FStar_Syntax_Subst.open_comp bs c in
                                ...
                                let uu____5046 =
                                  let uu____5051 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____5069 = is_type_binder g x in
                                         Prims.op_Negation uu____5069) bs1 in
                            ...
                            let uu____6106 =
                              let uu____6108 =
                                FStar_List.map FStar_Pervasives_Native.fst
                                  lbs5 in
                              f' :: uu____6108 in
                            FStar_Extraction_ML_Util.join_l e'_rng uu____6106 in
                          let is_rec1 =
                            if is_rec = true
                           ...
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____6197 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____6207 = term_as_mlexpr g else_e1 in
                                             ...
                                             let uu____6266 =
                                               let uu____6267 =
                                                 ...
                                                 let uu____6273 =
                                                   ...
                                                   FStar_Pervasives_Native.Some
                                                     uu____6275 in
                                                 (e, uu____6272, uu____6273) in
                                               FStar_Extraction_ML_Syntax.MLE_If
                                                 uu____6267 in
                                             FStar_All.pipe_left
                                               (FStar_Extraction_ML_Syntax.with_ty
                                                  t_branch) uu____6266 in
                                           let uu____6277 =
                                             FStar_Extraction_ML_Util.join
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____6890,fstar_disc_type) ->
            let wildcards =
              let uu____6898 =
                let uu____6899 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              let uu____6982 =
                let uu____6983 =
                  let uu____6989 =
                        ...
                        let uu____6999 =
                          let uu____7000 =
                            let uu____7001 =
                              ...
                              ([], uu____7002) in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____7001 in
                          FStar_All.pipe_left
                        ...
                        let uu____7004 =
                          let uu____7010 =
                            let uu____7015 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____7016 in
                            let uu____7022 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                          ...
                          let uu____7024 =
                            let uu____7030 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____7035) in
                            [uu____7030] in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____6990 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____6989) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____6983 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____6982 in
            let uu____7073 =
              let uu____7074 =
                let uu____7076 =
                  let uu____7077 =
