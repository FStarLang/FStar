              ...
              let when_clause =
                let uu____1993 =
                  let uu____1994 =
                    ...
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____1998)
                     in
                  FStar_Extraction_ML_Syntax.MLE_App uu____1994  in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____1993
                 in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          ...
          | uu____2765 -> failwith "Impossible: Unable to translate pattern"
           in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____2907 -> failwith "Impossible: Head type is not an arrow"
             in
                    ...
                    let uu____3048 =
                      let uu____3052 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____3052, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____3048
                 in
              FStar_Extraction_ML_Syntax.with_ty
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then
                let uu____3199 = maybe_coerce g e t ty  in (uu____3199, ty)
  ...
  fun g  ->
    fun top  ->
      ...
      (let t = FStar_Syntax_Subst.compress top  in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,args) ->
           let is_total uu___140_3715 =
             match uu___140_3715 with
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____3789
                   in
                let tm =
                  let uu____3797 =
                    let uu____3798 = FStar_TypeChecker_Util.remove_reify e
                       in
                                     ...
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                               uu____4510 ->
                                               let uu___144_4511 = head_ml
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4511.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4511.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____4512 ->
                                               let uu___144_4513 = head_ml
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_4519 =
                                                        head3  in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_4519.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_4519.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                    ...
                                    (match uu____4703 with
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                               uu____4763 ->
                                               let uu___144_4764 = head_ml
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4764.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4764.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____4765 ->
                                               let uu___144_4766 = head_ml
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_4772 =
                                                        head3  in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_4772.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_4772.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
               ...
               (let uu____4914 = FStar_Syntax_Syntax.is_top_level lbs  in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs  in
                   ...
                   let lb1 =
                     let uu___146_4926 = lb  in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___146_4926.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___146_4926.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___146_4926.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___146_4926.FStar_Syntax_Syntax.lbdef)
                     }  in
                   let e'1 =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____4943
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4947  ->
                            ...
                            (let lbdef =
                               ...
                               then lb.FStar_Syntax_Syntax.lbdef
                                ...
                                in
                             let uu___147_4955 = lb  in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___147_4955.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___147_4955.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___147_4955.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___147_4955.FStar_Syntax_Syntax.lbeff);
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____5030 = FStar_Syntax_Subst.open_comp bs c
                              in
                                ...
                                let uu____5044 =
                                  let uu____5049 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____5067 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____5067) bs1
                                     in
                      ...
                      | (e'2,f',t') ->
                          let f =
                            let uu____6104 =
                              ...
                              f' :: uu____6106  in
                            FStar_Extraction_ML_Util.join_l e'_rng uu____6104
                             in
                          let is_rec1 =
                            if is_rec = true
                        ...
                        | (Some then_e1,Some else_e1) ->
                            ...
                            (match uu____6195 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____6205 = term_as_mlexpr g else_e1
                                    in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____6888,fstar_disc_type) ->
            let wildcards =
              let uu____6896 =
                let uu____6897 = FStar_Syntax_Subst.compress fstar_disc_type
                   in
              ...
              let uu____6980 =
                let uu____6981 =
                  let uu____6987 =
                        ...
                        let uu____6997 =
                          let uu____6998 =
                            let uu____6999 =
                              ...
                              ([], uu____7000)  in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____6999
                             in
                          FStar_All.pipe_left
                            ...
                            let uu____7013 =
                              let uu____7014 =
                                ...
                                (uu____7018,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____7014
                               in
                            let uu____7020 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____6988
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____6987)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____6981  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____6980
               in
            let uu____7071 =
              let uu____7072 =
                let uu____7074 =
