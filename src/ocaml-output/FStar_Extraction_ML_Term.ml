      ...
      let uu____1131 =
        (fun t1  ->
           ...
           | FStar_Extraction_ML_Syntax.MLTY_Named uu____1133 ->
               let uu____1137 = FStar_Extraction_ML_Util.udelta_unfold g t1
                  in
      ...
      | FStar_Syntax_Syntax.Tm_bvar _
        |FStar_Syntax_Syntax.Tm_delayed _|FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1160 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1161
             in
          failwith uu____1160
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____1577, FStar_Extraction_ML_Syntax.ml_unit_ty)
                           in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = Prims.fst b  in
          ...
          fun expected_topt  ->
            ...
            | FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_int
                ...
                let when_clause =
                  ...
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_bool_ty) uu____1810
                   in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 disj g1 p1 expected_t1 =
          ...
          | uu____2566 -> failwith "Impossible: Unable to translate pattern"
           in
                   ...
                   FStar_Util.fold_map
                     (fun b1  ->
                        fun p3  ->
                          ...
                          | (uu____2664,p4,b') -> ((b1 && b'), p4)) b pats
                    in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____2969 -> failwith "Impossible: Head type is not an arrow"
             in
                    ...
                    let uu____3110 =
                      let uu____3114 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____3114, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____3110
                 in
              FStar_Extraction_ML_Syntax.with_ty
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then
                let uu____3248 = maybe_coerce g e t ty  in (uu____3248, ty)
        ...
        (fun u  ->
           let uu____3259 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____3260 uu____3261 uu____3262
              in
         ...
         |FStar_Syntax_Syntax.Tm_delayed _
          |FStar_Syntax_Syntax.Tm_uvar _|FStar_Syntax_Syntax.Tm_bvar _ ->
           let uu____3270 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____3271
              in
           failwith uu____3270
       | FStar_Syntax_Syntax.Tm_type _
         |FStar_Syntax_Syntax.Tm_refine _|FStar_Syntax_Syntax.Tm_arrow _ ->
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____3718
                   in
                let tm =
                  let uu____3726 =
                    let uu____3727 = FStar_TypeChecker_Util.remove_reify e
                       in
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____4619
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4623  ->
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____4706 = FStar_Syntax_Subst.open_comp bs c
                              in
                                ...
                                let uu____4720 =
                                  let uu____4725 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____4743 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____4743) bs1
                                     in
                 ...
                 | (env_body,lbs4) ->
                     ...
                     (match uu____5607 with
                      | (e'2,f',t') ->
                          let f =
                            let uu____5618 =
                              let uu____5620 = FStar_List.map Prims.fst lbs5
                                 in
                              f' :: uu____5620  in
                            FStar_Extraction_ML_Util.join_l e'_rng uu____5618
                             in
                          let is_rec1 =
                            if is_rec = true
                        ...
                        | (Some then_e1,Some else_e1) ->
                            ...
                            (match uu____5709 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____5719 = term_as_mlexpr g else_e1
                                    in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____6402,fstar_disc_type) ->
            let wildcards =
              let uu____6410 =
                let uu____6411 = FStar_Syntax_Subst.compress fstar_disc_type
                   in
              ...
              let uu____6494 =
                let uu____6495 =
                  let uu____6501 =
                        ...
                        let uu____6511 =
                          let uu____6512 =
                            let uu____6513 =
                              ...
                              ([], uu____6514)  in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____6513
                             in
                          FStar_All.pipe_left
                            ...
                            let uu____6527 =
                              let uu____6528 =
                                ...
                                (uu____6532,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____6528
                               in
                            let uu____6534 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____6502
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____6501)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____6495  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____6494
               in
            let uu____6585 =
              let uu____6586 =
                let uu____6588 =
