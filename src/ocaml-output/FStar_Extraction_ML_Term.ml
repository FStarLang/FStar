    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____1931 ->
          let uu____1932 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1933 in
          failwith uu____1932
      | FStar_Syntax_Syntax.Tm_delayed uu____1934 ->
          let uu____1959 =
            let uu____1960 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1960 in
          failwith uu____1959
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1961 =
            let uu____1962 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1962 in
          failwith uu____1961
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2680, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b in
              ...
              let when_clause =
                let uu____3050 =
                  let uu____3051 =
                    ...
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____3058) in
                  FStar_Extraction_ML_Syntax.MLE_App uu____3051 in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____3050 in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          ...
          | uu____4462 -> failwith "Impossible: Unable to translate pattern" in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____4708 -> failwith "Impossible: Head type is not an arrow" in
              ...
              let e =
                ...
                | uu____4938 ->
                    let uu____4941 =
                      ...
                      (uu____4948, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4941 in
              FStar_Extraction_ML_Syntax.with_ty
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then let uu____5161 = maybe_coerce g e t ty in (uu____5161, ty)
        ...
        (fun u  ->
           let uu____5179 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____5180 uu____5181 uu____5182 in
      ...
      (let t = FStar_Syntax_Subst.compress top in
       ...
       | FStar_Syntax_Syntax.Tm_unknown  ->
           let uu____5190 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5191 in
           failwith uu____5190
       | FStar_Syntax_Syntax.Tm_delayed uu____5198 ->
           let uu____5223 =
             let uu____5224 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5224 in
           failwith uu____5223
       ...
       | FStar_Syntax_Syntax.Tm_bvar uu____5256 ->
           let uu____5257 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5258 in
           failwith uu____5257
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____5892::(v1,uu____5894)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____5940 in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_int_ty
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6058 in
                let tm =
                  let uu____6068 =
                    let uu____6069 = FStar_TypeChecker_Util.remove_reify e in
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8004 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8011  ->
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____8145 = FStar_Syntax_Subst.open_comp bs c in
                                ...
                                let uu____8170 =
                                  let uu____8177 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8213 = is_type_binder g x in
                                         Prims.op_Negation uu____8213) bs1 in
                           ...
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____10253 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____10269 = term_as_mlexpr g else_e1 in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____11477,fstar_disc_type) ->
            let wildcards =
              let uu____11490 =
                let uu____11491 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              | uu____11622 -> failwith "Discriminator must be a function" in
              ...
              let uu____11641 =
                let uu____11642 =
                  let uu____11653 =
                        ...
                        let uu____11670 =
                          let uu____11671 =
                            let uu____11672 =
                              ...
                              ([], uu____11673) in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____11672 in
                          FStar_All.pipe_left
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11654 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11653) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11642 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11641 in
            let uu____11805 =
              let uu____11806 =
                let uu____11809 =
                  let uu____11810 =
