            ...
            | uu____3909 ->
                ...
                then
                  ...
                  (let head2 = FStar_Syntax_Util.un_uinst head1 in
                   ...
                   | FStar_Syntax_Syntax.Tm_name uu____4415 ->
                       let uu____4416 =
                         let uu____4423 =
                           FStar_Extraction_ML_UEnv.lookup_term g head2 in
                         match uu____4423 with
                         | (FStar_Util.Inr (uu____4433,x1,x2,x3),q) ->
                             ((x1, x2, x3), q)
                         | uu____4458 -> failwith "FIXME Ty" in
                       (match uu____4416 with
                        | ((head_ml,(vars,t1),inst_ok),qual) ->
                            let has_typ_apps =
                              match args with
                              | (a,uu____4487)::uu____4488 -> is_type g a
                              | uu____4502 -> false in
                            let uu____4508 =
                              match vars with
                              | uu____4525::uu____4526 when
                                     ...
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                               uu____4621 ->
                                               let uu___144_4622 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4622.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4622.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____4623 ->
                                               let uu___144_4624 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4624.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4624.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_4630 =
                                                        head3 in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_4630.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_4630.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                 ...
                                 (match args1 with
                                  ...
                                  | uu____4670 ->
                                      extract_app_maybe_projector qual
                                        ...
                                        (FStar_Extraction_ML_Syntax.E_PURE,
                                          head_t) args1)))
                   | FStar_Syntax_Syntax.Tm_fvar uu____4676 ->
                       let uu____4677 =
                         let uu____4684 =
                           FStar_Extraction_ML_UEnv.lookup_term g head2 in
                         match uu____4684 with
                         | (FStar_Util.Inr (uu____4694,x1,x2,x3),q) ->
                             ((x1, x2, x3), q)
                         | uu____4719 -> failwith "FIXME Ty" in
                       (match uu____4677 with
                        | ((head_ml,(vars,t1),inst_ok),qual) ->
                            let has_typ_apps =
                              match args with
                              | (a,uu____4748)::uu____4749 -> is_type g a
                              | uu____4763 -> false in
                            let uu____4769 =
                              match vars with
                              | uu____4786::uu____4787 when
                                  (Prims.op_Negation has_typ_apps) && inst_ok
                                  -> (head_ml, t1, args)
                              | uu____4794 ->
                                  let n1 = FStar_List.length vars in
                                    ...
                                    (match uu____4820 with
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                               uu____4882 ->
                                               let uu___144_4883 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4883.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4883.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____4884 ->
                                               let uu___144_4885 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4885.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4885.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_4891 =
                                                        head3 in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_4891.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_4891.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                  ...
                                  | uu____4931 ->
                                      extract_app_maybe_projector qual
                                        ...
                                        (FStar_Extraction_ML_Syntax.E_PURE,
                                          head_t) args1)))
                   | uu____4937 ->
                       let uu____4938 = term_as_mlexpr g head2 in
                       (match uu____4938 with
                        | (head3,f,t1) ->
                            extract_app_maybe_projector None head3 (f, t1)
                              args)))
       | FStar_Syntax_Syntax.Tm_ascribed (e0,(tc,uu____4950),f) ->
           let t1 =
             match tc with
           ...
           let uu____5004 = check_term_as_mlexpr g e0 f1 t1 in
           (match uu____5004 with | (e,t2) -> (e, f1, t2))
       | FStar_Syntax_Syntax.Tm_let ((is_rec,lbs),e') ->
           ...
           let uu____5025 =
             ...
             then FStar_Syntax_Subst.open_let_rec lbs e'
               ...
               (let uu____5033 = FStar_Syntax_Syntax.is_top_level lbs in
                if uu____5033
                then (lbs, e')
                else
                  (let lb = FStar_List.hd lbs in
                   let x =
                     ...
                     FStar_Syntax_Syntax.freshen_bv uu____5043 in
                   let lb1 =
                     let uu___146_5045 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___146_5045.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___146_5045.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___146_5045.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___146_5045.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e'1 =
            ...
            | (lbs1,e'1) ->
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____5062 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____5066  ->
                            ...
                            (let lbdef =
                               let uu____5070 = FStar_Options.ml_ish () in
                               if uu____5070
                             ...
                             let uu___147_5074 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___147_5074.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___147_5074.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___147_5074.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___147_5074.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = lbdef
                             })))
                  else lbs1 in
                let maybe_generalize uu____5088 =
                  match uu____5088 with
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      FStar_Syntax_Syntax.lbunivs = uu____5099;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           let uu____5142 = FStar_List.hd bs in
                           FStar_All.pipe_right uu____5142 (is_type_binder g)
                           ->
                           let uu____5149 = FStar_Syntax_Subst.open_comp bs c in
                            ...
                            | (bs1,c1) ->
                                let uu____5163 =
                                  let uu____5168 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____5186 = is_type_binder g x in
                                         Prims.op_Negation uu____5186) bs1 in
                                ...
                                (match uu____5163 with
                                 | (tbinders,tbody) ->
                                     ...
                                     let e1 =
                                       let uu____5265 = normalize_abs e in
                  ...
                  FStar_List.fold_right
                    (fun lb  ->
                       fun uu____5976  ->
                         ...
                         | (env,lbs4) ->
                             let uu____6040 = lb in
                             (match uu____6040 with
                              | (lbname,uu____6065,(t1,(uu____6067,polytype)),add_unit,uu____6070)
                                  ->
                                  let uu____6077 =
                ...
                (match uu____5937 with
                 | (env_body,lbs4) ->
                     ...
                     let uu____6220 = term_as_mlexpr env_body e'1 in
                      ...
                      | (e'2,f',t') ->
                          let f =
                            let uu____6231 =
                              ...
                              f' :: uu____6233 in
                            FStar_Extraction_ML_Util.join_l e'_rng uu____6231 in
                          let is_rec1 =
                            if is_rec = true
                          ...
                          let uu____6239 =
                            let uu____6240 =
                              let uu____6241 =
                                ...
                                (is_rec1, [], uu____6242) in
                              mk_MLE_Let top_level uu____6241 e'2 in
                            let uu____6248 =
                              FStar_Extraction_ML_Util.mlloc_of_range
                                t.FStar_Syntax_Syntax.pos in
                            FStar_Extraction_ML_Syntax.with_ty_loc t'
                              uu____6240 uu____6248 in
                          (uu____6239, f, t'))))
       | FStar_Syntax_Syntax.Tm_match (scrutinee,pats) ->
           let uu____6277 = term_as_mlexpr g scrutinee in
           (match uu____6277 with
            | (e,f_e,t_e) ->
                let uu____6287 = check_pats_for_ite pats in
                     ...
                     then
                       (match (then_e, else_e) with
                        | (Some then_e1,Some else_e1) ->
                            let uu____6322 = term_as_mlexpr g then_e1 in
                            (match uu____6322 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____6332 = term_as_mlexpr g else_e1 in
                                                 ...
                                                 let uu____6398 =
                                                   let uu____6400 =
                                                     maybe_lift1 else_mle
                                                       t_else in
                                                   Some uu____6400 in
                                                 (e, uu____6397, uu____6398) in
                                               FStar_Extraction_ML_Syntax.MLE_If
                                                 uu____6392 in
                                             FStar_All.pipe_left
                                               (FStar_Extraction_ML_Syntax.with_ty
                                                  t_branch) uu____6391 in
                                           let uu____6402 =
                                             FStar_Extraction_ML_Util.join
                                               then_e1.FStar_Syntax_Syntax.pos
                                               f_then f_else in
                                           (uu____6390, uu____6402, t_branch))))
                        | uu____6403 ->
                            failwith
                            ...
                            (match mlbranches1 with
                             | [] ->
                                 ...
                                 (match uu____6723 with
                                  | (uu____6759,fw,uu____6761,uu____6762) ->
                                      let uu____6763 =
                                        let uu____6764 =
                                          let uu____6765 =
                                            let uu____6769 =
                                      ...
                                      (uu____6763,
                                        FStar_Extraction_ML_Syntax.E_PURE,
                                        FStar_Extraction_ML_Syntax.ml_unit_ty))
                             | (uu____6773,uu____6774,(uu____6775,f_first,t_first))::rest
                                 ->
                                 let uu____6807 =
                                   FStar_List.fold_left
                                     (fun uu____6823  ->
                                        fun uu____6824  ->
                                          match (uu____6823, uu____6824) with
                                          | ((topt,f),(uu____6854,uu____6855,
                                                       (uu____6856,f_branch,t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
                                      ...
                                      let uu____6969 =
                                        FStar_All.pipe_left
                                          ...
                                          (FStar_Extraction_ML_Syntax.MLE_Match
                                             (e1, mlbranches2)) in
                                      (uu____6969, f_match, t_match)))))))
let fresh: Prims.string -> (Prims.string* Prims.int) =
  let c = FStar_Util.mk_ref (Prims.parse_int "0") in
  fun x  ->
    FStar_Util.incr c; (let uu____6988 = FStar_ST.read c in (x, uu____6988))
    ...
    fun discName  ->
      fun constrName  ->
        let uu____7003 =
          ...
          FStar_All.pipe_left FStar_Pervasives.fst uu____7006 in
        match uu____7003 with
        | (uu____7019,fstar_disc_type) ->
            let wildcards =
              let uu____7027 =
                let uu____7028 = FStar_Syntax_Subst.compress fstar_disc_type in
                uu____7028.FStar_Syntax_Syntax.n in
              match uu____7027 with
              | FStar_Syntax_Syntax.Tm_arrow (binders,uu____7037) ->
                  let uu____7048 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___141_7063  ->
                            match uu___141_7063 with
                            | (uu____7067,Some (FStar_Syntax_Syntax.Implicit
                               uu____7068)) -> true
                            | uu____7070 -> false)) in
                  FStar_All.pipe_right uu____7048
                    (FStar_List.map
                       (fun uu____7090  ->
                          let uu____7094 = fresh "_" in
                          (uu____7094, FStar_Extraction_ML_Syntax.MLTY_Top)))
              | uu____7099 -> failwith "Discriminator must be a function" in
                        ...
                        let uu____7128 =
                          let uu____7129 =
                            let uu____7130 =
                              ...
                              ([], uu____7131) in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____7130 in
                          FStar_All.pipe_left
                        ...
                        let uu____7133 =
                          let uu____7139 =
                            let uu____7144 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____7145 in
                            let uu____7151 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                          ...
                          let uu____7153 =
                            let uu____7159 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild, None,
                                uu____7164) in
                            [uu____7159] in
                          uu____7139 :: uu____7153 in
                        (uu____7128, uu____7133) in
                      FStar_Extraction_ML_Syntax.MLE_Match uu____7120 in
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____7119 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____7118) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____7112 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____7111 in
            let uu____7202 =
              let uu____7203 =
                let uu____7205 =
                  let uu____7206 =
                  ...
                  {
                    FStar_Extraction_ML_Syntax.mllb_name = uu____7206;
                ...
                [uu____7205] in
              (FStar_Extraction_ML_Syntax.NonRec, [], uu____7203) in
            FStar_Extraction_ML_Syntax.MLM_Let uu____7202