  ...
  fun env ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), body) ->
          ...
          let uu____868 =
            let uu____873 =
              let uu____874 = FStar_Syntax_Syntax.mk_binder x in [uu____874] in
  ...
  fun l ->
    ...
    then def
      ...
      (let uu____1545 = FStar_List.hd l in
       ...
       | (p1, w1, e1) ->
           let uu____1579 =
             let uu____1588 = FStar_List.tl l in FStar_List.hd uu____1588 in
                 ...
                 (fun uu____1774 ->
                    ...
                    | (v1, t1) ->
                        FStar_Extraction_ML_Syntax.with_ty t1
                          (FStar_Extraction_ML_Syntax.MLE_Var v1)) uu____1760 in
             let body =
      ...
      let uu____1796 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____1798 = FStar_Options.codegen () in
           uu____1798 = (FStar_Pervasives_Native.Some FStar_Options.Kremlin)) in
    ...
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____1928 ->
          let uu____1929 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1930 in
          failwith uu____1929
      | FStar_Syntax_Syntax.Tm_delayed uu____1931 ->
          let uu____1956 =
            let uu____1957 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1957 in
          failwith uu____1956
      | FStar_Syntax_Syntax.Tm_unknown ->
          let uu____1958 =
            let uu____1959 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1959 in
          failwith uu____1958
      | FStar_Syntax_Syntax.Tm_lazy i ->
                  ...
                  | (ml_bs, env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2643, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b in
                ...
                let uu____2957 =
                      ...
                      let uu____2970 =
                        ...
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.ml_int_ty) uu____2971 in
                  ...
                  | FStar_Pervasives_Native.Some sw ->
                      ...
                      (match uu____2993 with
                       | (mlterm, uu____3005, mlty) -> (mlterm, mlty)) in
                (match uu____2957 with
                 | (mlc, ml_ty) ->
                     ...
                     let when_clause =
                       ...
                       FStar_All.pipe_left
                         (FStar_Extraction_ML_Syntax.with_ty
                            FStar_Extraction_ML_Syntax.ml_bool_ty) uu____3025 in
                      ...
                      (uu____3257,
                       {
                         ...
                         FStar_Extraction_ML_Syntax.loc = uu____3260;_},
                       ttys, uu____3262)
                      -> (n1, ttys)
      ...
      fun residualType ->
        fun mlAppExpr ->
          let rec eta_args more_args t =
            ...
            | uu____4695 -> failwith "Impossible: Head type is not an arrow" in
          let as_record qual1 e =
            match ((e.FStar_Extraction_ML_Syntax.expr), qual1) with
            | (FStar_Extraction_ML_Syntax.MLE_CTor (uu____4723, args),
              ...
              let e =
                ...
                | uu____4925 ->
                    let uu____4928 =
                      ...
                      (uu____4935, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4928 in
              FStar_Extraction_ML_Syntax.with_ty
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____4940;_},
                   uu____4941);
                FStar_Extraction_ML_Syntax.mlty = uu____4942;
                FStar_Extraction_ML_Syntax.loc = uu____4943;_},
              mle::args),
             FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_projector (constrname, f))) ->
              let f1 =
                      ...
                      let uu____4984 =
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top) proj in
                      (uu____4984, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4977 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____4989;_},
              mlargs),
          ...
          | (FStar_Extraction_ML_Syntax.MLE_TApp
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____5101;_},
              uu____5102),
             FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Record_ctor
             uu____5103)) ->
              let uu____5116 =
             ...
             (fun u ->
                let uu____5221 =
                  ...
                  FStar_Util.format4
                    ...
                    uu____5222 uu____5223 uu____5224 uu____5225 in
      ...
      fun f ->
        fun ty ->
          ...
          | (e, tag, t) ->
              ...
              if uu____5282
              then let uu____5287 = maybe_coerce g e t ty in (uu____5287, ty)
        ...
        (fun u ->
           let uu____5305 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____5306 uu____5307 uu____5308 in
      ...
      (let t = FStar_Syntax_Subst.compress top in
       ...
       | FStar_Syntax_Syntax.Tm_delayed uu____5324 ->
           let uu____5349 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5350 in
           failwith uu____5349
       | FStar_Syntax_Syntax.Tm_uvar uu____5357 ->
           let uu____5374 =
             let uu____5375 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5375 in
           failwith uu____5374
       | FStar_Syntax_Syntax.Tm_bvar uu____5382 ->
           let uu____5383 =
             let uu____5384 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5384 in
           failwith uu____5383
       | FStar_Syntax_Syntax.Tm_lazy i ->
       ...
       | FStar_Syntax_Syntax.Tm_meta
           ({ FStar_Syntax_Syntax.n = uu____5414;
              ...
              FStar_Syntax_Syntax.vars = uu____5416;_},
       ...
       | FStar_Syntax_Syntax.Tm_meta
           ...
           let tv =
             ...
             FStar_Reflection_Embeddings.embed_term_view
               t.FStar_Syntax_Syntax.pos uu____5527 in
           let t1 =
             let uu____5531 =
               let uu____5540 = FStar_Syntax_Syntax.as_arg tv in [uu____5540] in
             FStar_Syntax_Util.mk_app
               (FStar_Reflection_Data.refl_constant_term
                  FStar_Reflection_Data.fstar_refl_pack_ln) uu____5531 in
           term_as_mlexpr' g t1
       | FStar_Syntax_Syntax.Tm_meta
       ...
       | FStar_Syntax_Syntax.Tm_uinst (t1, uu____5643) ->
           term_as_mlexpr' g t1
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____6144;_},
            uu____6145)
               ...
               (FStar_Const.Const_reify)) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6262 in
                let tm =
                  let uu____6272 =
                    let uu____6273 = FStar_TypeChecker_Util.remove_reify e in
                       ...
                       | FStar_Pervasives_Native.Some
                           ...
                           let rec remove_implicits args2 f1 t2 =
                             ...
                             | ((a0, FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____7002))::args3,
                                FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____7004, f', t3)) ->
                                 let uu____7041 =
                                   FStar_Extraction_ML_Util.join
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7485 ->
                                               let uu___63_7488 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___63_7488.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___63_7488.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___64_7493.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___64_7493.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7494 ->
                                               let uu___64_7495 =
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___64_7495.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___64_7495.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,
                                                {
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___65_7504 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___65_7504.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___65_7504.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7910 ->
                                               let uu___63_7913 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___63_7913.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___63_7913.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           match head_ml.FStar_Extraction_ML_Syntax.expr
                                           with
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___64_7918.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___64_7918.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7919 ->
                                               let uu___64_7920 =
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___64_7920.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___64_7920.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,
                                                {
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___65_7929 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___65_7929.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___65_7929.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
               ...
               (let uu____8132 = FStar_Syntax_Syntax.is_top_level lbs in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs in
                   ...
                   let lb1 =
                     let uu___66_8148 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___66_8148.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___66_8148.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___66_8148.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___66_8148.FStar_Syntax_Syntax.lbdef);
                       FStar_Syntax_Syntax.lbattrs =
                         (uu___66_8148.FStar_Syntax_Syntax.lbattrs);
                       FStar_Syntax_Syntax.lbpos =
                         (uu___66_8148.FStar_Syntax_Syntax.lbpos)
                     } in
                   let e'1 =
                         ...
                         (fun lb ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8180 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8187 ->
                            ...
                            (let lbdef =
                             ...
                             let uu___67_8195 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___67_8195.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___67_8195.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___67_8195.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___67_8195.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = lbdef;
                               FStar_Syntax_Syntax.lbattrs =
                                 (uu___67_8195.FStar_Syntax_Syntax.lbattrs);
                               FStar_Syntax_Syntax.lbpos =
                                 (uu___67_8195.FStar_Syntax_Syntax.lbpos)
                             })))
                  else lbs1 in
                                    ...
                                    let uu____8479 =
                                      FStar_Util.prefix_until
                                        (fun x ->
                                           ...
                                           Prims.op_Negation uu____8515) bs1 in
                       ...
                       fun uu____9702 ->
                         ...
                         | (env, lbs4) ->
                             ...
                             (match uu____9827 with
                              | (lbname, uu____9875,
                                 (t1, (uu____9877, polytype)), add_unit,
                                 uu____9880) ->
                                  let uu____9893 =
                           ...
                           FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____10323 with
                             | (then_mle, f_then, t_then) ->
                                 let uu____10339 = term_as_mlexpr g else_e1 in
                        ...
                        | (pat_t_compat, mlbranches) ->
                            ...
                            (match mlbranches1 with
                             ...
                             | (uu____11120, uu____11121,
                                (uu____11122, f_first, t_first))::rest ->
                                 let uu____11182 =
                                   FStar_List.fold_left
                                     (fun uu____11224 ->
                                        fun uu____11225 ->
    ...
    fun discName ->
      fun constrName ->
        ...
        | (uu____11544, fstar_disc_type) ->
            let wildcards =
              let uu____11553 =
                let uu____11554 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              | uu____11665 -> failwith "Discriminator must be a function" in
              ...
              let uu____11676 =
                let uu____11677 =
                  let uu____11688 =
                        ...
                        let uu____11708 =
                          let uu____11719 =
                            let uu____11728 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11729 in
                            let uu____11739 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                          ...
                          let uu____11742 =
                            let uu____11753 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11762) in
                            [uu____11753] in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11689 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11688) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11677 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11676 in
            let uu____11817 =
              let uu____11818 =
                let uu____11821 =
                  let uu____11822 =
