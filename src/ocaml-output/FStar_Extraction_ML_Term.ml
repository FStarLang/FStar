...
let _79_28 = (let _174_32 = (let _174_31 = (FStar_Range.string_of_range r)
in (FStar_Util.format2 "%s: %s\n" _174_31 msg))
in (FStar_All.pipe_left FStar_Util.print_string _174_32))
in (FStar_All.failwith msg)))


let err_uninst = (fun env t _79_34 -> (match (_79_34) with
| (vars, ty) -> begin
...
in (let _174_48 = (let _174_46 = (FStar_All.pipe_right args (FStar_List.map (fun _79_42 -> (match (_79_42) with
| (x, _79_41) -> begin
...
let _79_61 = (FStar_Util.smap_add cache l.FStar_Ident.str res)
in res))
end))
in (fun g l -> (
...
let _79_78 = (FStar_Extraction_ML_UEnv.debug env (fun _79_76 -> (let _174_81 = (FStar_Syntax_Print.term_to_string t)
in (let _174_80 = (FStar_Syntax_Print.tag_of_term t)
in (FStar_Util.print2 "level %s (%s)\n" _174_81 _174_80)))))
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (_79_81) -> begin
...
| FStar_Syntax_Syntax.Tm_constant (_79_85) -> begin
Term_level
end
| FStar_Syntax_Syntax.Tm_fvar ({FStar_Syntax_Syntax.fv_name = _79_93; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_defined_at_level (_79_90); FStar_Syntax_Syntax.fv_qual = _79_88}) -> begin
(
...
let _79_98 = (FStar_Extraction_ML_UEnv.debug env (fun _79_97 -> (match (()) with
| () -> begin
...
| FStar_Syntax_Syntax.Tm_ascribed (t, _79_121, _79_123) -> begin
(level env t)
end
| FStar_Syntax_Syntax.Tm_type (_79_127) -> begin
Kind_level
end
| FStar_Syntax_Syntax.Tm_uinst (t, _79_131) -> begin
(level env t)
end
| FStar_Syntax_Syntax.Tm_refine (x, _79_136) -> begin
...
| FStar_Syntax_Syntax.Tm_abs (bs, body, _79_150) -> begin
(level env body)
end
| FStar_Syntax_Syntax.Tm_let (_79_154, body) -> begin
(level env body)
end
| FStar_Syntax_Syntax.Tm_match (_79_159, branches) -> begin
(match (branches) with
| ((_79_166, _79_168, e))::_79_164 -> begin
(level env e)
end
| _79_173 -> begin
...
| FStar_Syntax_Syntax.Tm_meta (t, _79_176) -> begin
(level env t)
end
| FStar_Syntax_Syntax.Tm_app (head, _79_181) -> begin
(level env head)
end)))))
...
(FStar_All.pipe_right args (FStar_List.for_all (fun _79_235 -> (match (_79_235) with
| (te, _79_234) -> begin
(is_fstar_value te)
end))))
end else begin
...
| FStar_Extraction_ML_Syntax.MLE_Record (_79_269, fields) -> begin
(FStar_Util.for_all (fun _79_276 -> (match (_79_276) with
| (_79_274, e) -> begin
(is_ml_value e)
end)) fields)
end
...
let _79_298 = (FStar_List.hd l)
in (match (_79_298) with
| (p1, w1, e1) -> begin
(

let _79_302 = (let _174_119 = (FStar_List.tl l)
...
let _79_345 = (FStar_Extraction_ML_UEnv.debug g (fun _79_344 -> (match (()) with
| () -> begin
...
| FStar_Util.Inl (_79_350, t) -> begin
t
end
| _79_355 -> begin
...
| FStar_Extraction_ML_Syntax.MLTY_Named (_79_362) -> begin
...
| FStar_Syntax_Syntax.Tm_constant (_79_383) -> begin
FStar_Extraction_ML_UEnv.unknownType
end
| FStar_Syntax_Syntax.Tm_uvar (_79_386) -> begin
FStar_Extraction_ML_UEnv.unknownType
end
...
let _79_422 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_79_422) with
| (bs, c) -> begin
(

let _79_425 = (binders_as_ml_binders env bs)
...
let _79_442 = (FStar_List.fold_right (fun _79_435 _79_438 -> (match (((_79_435), (_79_438))) with
| ((_79_433, t), (tag, t')) -> begin
...
| FStar_Syntax_Syntax.Tm_abs (bs, ty, _79_461) -> begin
(

let _79_466 = (FStar_Syntax_Subst.open_term bs ty)
in (match (_79_466) with
| (bs, ty) -> begin
(

let _79_469 = (binders_as_ml_binders env bs)
...
and arg_as_mlty : FStar_Extraction_ML_UEnv.env  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier Prims.option)  ->  FStar_Extraction_ML_Syntax.mlty = (fun g _79_483 -> (match (_79_483) with
| (a, _79_482) -> begin
...
let _79_489 = (FStar_Syntax_Util.arrow_formals fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.ty)
in (match (_79_489) with
| (formals, t) -> begin
(
...
let _79_495 = (FStar_Util.first_N n_args formals)
in (match (_79_495) with
| (_79_493, rest) -> begin
(let _174_183 = (FStar_List.map (fun _79_496 -> FStar_Extraction_ML_UEnv.erasedContent) rest)
...
let _79_518 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun _79_507 b -> (match (_79_507) with
| (ml_bs, env) -> begin
...
| (FStar_Extraction_ML_Syntax.MLE_Seq (es1), _79_529) -> begin
FStar_Extraction_ML_Syntax.MLE_Seq ((FStar_List.append es1 ((e2)::[])))
end
| (_79_532, FStar_Extraction_ML_Syntax.MLE_Seq (es2)) -> begin
...
| _79_553 when (lb.FStar_Extraction_ML_Syntax.mllb_def.FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.ml_unit.FStar_Extraction_ML_Syntax.expr) -> begin
...
| _79_569 -> begin
(match (q) with
| Some (FStar_Syntax_Syntax.Record_ctor (_79_571, fns)) -> begin
(
...
let _79_599 = if (not (ok)) then begin
(FStar_Extraction_ML_UEnv.debug g (fun _79_597 -> (let _174_224 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t')
...
| FStar_Syntax_Syntax.Pat_disj (_79_602) -> begin
...
| FStar_Syntax_Syntax.Pat_dot_term (_79_627) -> begin
((g), (None), (true))
end
| FStar_Syntax_Syntax.Pat_cons (f, pats) -> begin
(

let _79_649 = (match ((FStar_Extraction_ML_UEnv.lookup_fv g f)) with
| FStar_Util.Inr ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (n); FStar_Extraction_ML_Syntax.mlty = _79_636; FStar_Extraction_ML_Syntax.loc = _79_634}, ttys, _79_642) -> begin
((n), (ttys))
end
| _79_646 -> begin
...
let _79_653 = (FStar_Util.first_N nTyVars pats)
in (match (_79_653) with
...
let mlty_args = (FStar_All.pipe_right tysVarPats (FStar_List.map (fun _79_663 -> (match (_79_663) with
| (p, _79_662) -> begin
(match (p.FStar_Syntax_Syntax.v) with
| FStar_Syntax_Syntax.Pat_dot_term (_79_665, t) -> begin
(term_as_mlty g t)
end
| _79_670 -> begin
(

let _79_673 = (FStar_Extraction_ML_UEnv.debug g (fun _79_671 -> (let _174_253 = (FStar_Syntax_Print.pat_to_string p)
...
let _79_689 = (FStar_Util.fold_map (fun g _79_681 -> (match (_79_681) with
| (p, imp) -> begin
(

let _79_686 = (extract_one_pat disjunctive_pat true g p None)
...
let _79_716 = (FStar_Util.fold_map (fun _79_692 _79_695 -> (match (((_79_692), (_79_695))) with
| ((g, f_ty_opt), (p, imp)) -> begin
(

let _79_706 = (match (f_ty_opt) with
...
let _79_711 = (extract_one_pat disjunctive_pat false g p expected_ty)
...
in (match (_79_716) with
| ((g, f_ty_opt), restMLPats) -> begin
(

let _79_724 = (let _174_261 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun _79_3 -> (match (_79_3) with
| Some (x) -> begin
(x)::[]
end
| _79_721 -> begin
...
let _79_761 = (extract_one_pat true g p (Some (expected_t)))
in (match (_79_761) with
| (g, p, b) -> begin
(

let _79_771 = (FStar_Util.fold_map (fun b p -> (

let _79_768 = (extract_one_pat true g p (Some (expected_t)))
in (match (_79_768) with
| (_79_765, p, b') -> begin
(((b && b')), (p))
end))) b pats)
in (match (_79_771) with
| (b, ps) -> begin
(
...
let _79_786 = (FStar_All.pipe_right ps (FStar_List.partition (fun _79_4 -> (match (_79_4) with
| (_79_775, (_79_779)::_79_777) -> begin
true
end
| _79_783 -> begin
false
...
let ps = (FStar_All.pipe_right ps_when (FStar_List.map (fun _79_789 -> (match (_79_789) with
| (x, whens) -> begin
...
let _79_801 = (extract_one_pat false g p (Some (expected_t)))
in (match (_79_801) with
| (g, (p, whens), b) -> begin
(
...
| FStar_Extraction_ML_Syntax.MLTY_Fun (t0, _79_812, t1) -> begin
(
...
| FStar_Extraction_ML_Syntax.MLTY_Named (_79_818, _79_820) -> begin
...
| (FStar_Extraction_ML_Syntax.MLE_CTor (_79_829, args), Some (FStar_Syntax_Syntax.Record_ctor (_79_834, fields))) -> begin
(
...
let _79_849 = (eta_args [] residualType)
in (match (_79_849) with
| (eargs, tres) -> begin
(match (eargs) with
| [] -> begin
...
let _79_855 = (FStar_List.unzip eargs)
...
| (FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (mlp); FStar_Extraction_ML_Syntax.mlty = _79_870; FStar_Extraction_ML_Syntax.loc = _79_868}, (mle)::args), Some (FStar_Syntax_Syntax.Record_projector (f))) -> begin
(
...
let _79_936 = (term_as_mlexpr' g t)
in (match (_79_936) with
| (e, tag, ty) -> begin
(
...
let _79_939 = (FStar_Extraction_ML_UEnv.debug g (fun u -> (let _174_340 = (let _174_339 = (FStar_Syntax_Print.tag_of_term t)
...
let _79_947 = (check_term_as_mlexpr' g t f ty)
in (match (_79_947) with
| (e, t) -> begin
(

let _79_952 = (erase g e t f)
in (match (_79_952) with
| (r, _79_950, t) -> begin
((r), (t))
end))
end)))
...
let _79_960 = (term_as_mlexpr g e0)
in (match (_79_960) with
| (e, tag, t) -> begin
(
...
let _79_965 = (FStar_Extraction_ML_UEnv.debug g (fun u -> (let _174_356 = (let _174_355 = (FStar_Range.string_of_range top.FStar_Syntax_Syntax.pos)
...
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic (m, _79_1010)) -> begin
(
...
let _79_1030 = (term_as_mlexpr g lb.FStar_Syntax_Syntax.lbdef)
in (match (_79_1030) with
| (comp_1, _79_1027, _79_1029) -> begin
(
...
let _79_1036 = (term_as_mlexpr g k)
in (match (_79_1036) with
| (ml_k, _79_1034, t_k) -> begin
(

let m_2 = (match (t_k) with
| FStar_Extraction_ML_Syntax.MLTY_Fun (_79_1038, _79_1040, m_2) -> begin
m_2
end
| _79_1045 -> begin
(FStar_All.failwith "Impossible")
...
let _79_1069 = (FStar_TypeChecker_TcTerm.type_of_tot_term g.FStar_Extraction_ML_UEnv.tcenv t)
in (match (_79_1069) with
| (_79_1065, ty, _79_1068) -> begin
(
...
| (FStar_Util.Inl (_79_1078), _79_1081) -> begin
((FStar_Extraction_ML_Syntax.ml_unit), (FStar_Extraction_ML_Syntax.E_PURE), (FStar_Extraction_ML_Syntax.ml_unit_ty))
end
| (FStar_Util.Inr (x, mltys, _79_1086), qual) -> begin
(match (mltys) with
...
let _79_1106 = (FStar_Syntax_Subst.open_term bs body)
in (match (_79_1106) with
| (bs, body) -> begin
(

let _79_1109 = (binders_as_ml_binders g bs)
in (match (_79_1109) with
| (ml_bs, env) -> begin
(

let _79_1113 = (term_as_mlexpr env body)
in (match (_79_1113) with
| (ml_body, f, t) -> begin
(

let _79_1123 = (FStar_List.fold_right (fun _79_1117 _79_1120 -> (match (((_79_1117), (_79_1120))) with
| ((_79_1115, targ), (f, t)) -> begin
((FStar_Extraction_ML_Syntax.E_PURE), (FStar_Extraction_ML_Syntax.MLTY_Fun (((targ), (f), (t)))))
end)) ml_bs ((f), (t)))
in (match (_79_1123) with
| (f, tfun) -> begin
...
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = _79_1129; FStar_Syntax_Syntax.pos = _79_1127; FStar_Syntax_Syntax.vars = _79_1125}, (t)::[]) -> begin
(

let _79_1140 = (term_as_mlexpr' g (Prims.fst t))
in (match (_79_1140) with
| (ml, e_tag, mlty) -> begin
((ml), (FStar_Extraction_ML_Syntax.E_PURE), (mlty))
end))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reflect (_79_1148)); FStar_Syntax_Syntax.tk = _79_1146; FStar_Syntax_Syntax.pos = _79_1144; FStar_Syntax_Syntax.vars = _79_1142}, (t)::[]) -> begin
(

let _79_1159 = (term_as_mlexpr' g (Prims.fst t))
in (match (_79_1159) with
| (ml, e_tag, mlty) -> begin
...
in (match ((let _174_378 = (let _174_377 = (FStar_Syntax_Subst.compress head)
in _174_377.FStar_Syntax_Syntax.n)
in ((head.FStar_Syntax_Syntax.n), (_174_378)))) with
| (FStar_Syntax_Syntax.Tm_uvar (_79_1171), _79_1174) -> begin
(
...
| (_79_1178, FStar_Syntax_Syntax.Tm_abs (bs, _79_1181, Some (lc))) when (is_total lc) -> begin
(
...
let rec extract_app = (fun is_data _79_1194 _79_1197 restArgs -> (match (((_79_1194), (_79_1197))) with
...
| FStar_Syntax_Syntax.Tm_fvar ({FStar_Syntax_Syntax.fv_name = {FStar_Syntax_Syntax.v = v; FStar_Syntax_Syntax.ty = _79_1210; FStar_Syntax_Syntax.p = _79_1208}; FStar_Syntax_Syntax.fv_delta = _79_1206; FStar_Syntax_Syntax.fv_qual = _79_1204}) -> begin
...
let _79_1227 = if evaluation_order_guaranteed then begin
(let _174_387 = (FStar_All.pipe_right (FStar_List.rev mlargs_f) (FStar_List.map Prims.fst))
in (([]), (_174_387)))
end else begin
(FStar_List.fold_left (fun _79_1220 _79_1223 -> (match (((_79_1220), (_79_1223))) with
...
let x = (FStar_Extraction_ML_Syntax.gensym ())
in (let _174_391 = (let _174_390 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty arg.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (_174_390)::out_args)
in (((((x), (arg)))::lbs), (_174_391))))
end
end)) (([]), ([])) mlargs_f)
end
in (match (_79_1227) with
| (lbs, mlargs) -> begin
(

let app = (let _174_392 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t) (FStar_Extraction_ML_Syntax.MLE_App (((mlhead), (mlargs)))))
in (FStar_All.pipe_left (maybe_eta_data_and_project_record g is_data t) _174_392))
in (

let l_app = (FStar_List.fold_right (fun _79_1231 out -> (match (_79_1231) with
| (x, arg) -> begin
...
| (((arg, _79_1237))::rest, FStar_Extraction_ML_Syntax.MLTY_Fun (formal_t, f', t)) when (is_type g arg) -> begin
if (type_leq g formal_t FStar_Extraction_ML_Syntax.ml_unit_ty) then begin
(let _174_396 = (let _174_395 = (FStar_Extraction_ML_Util.join arg.FStar_Syntax_Syntax.pos f f')
in ((_174_395), (t)))
in (extract_app is_data ((mlhead), ((((FStar_Extraction_ML_Syntax.ml_unit), (FStar_Extraction_ML_Syntax.E_PURE)))::mlargs_f)) _174_396 rest))
end else begin
(let _174_401 = (let _174_400 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule mlhead)
in (let _174_399 = (FStar_Syntax_Print.term_to_string arg)
in (let _174_398 = (FStar_Syntax_Print.tag_of_term arg)
in (let _174_397 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule formal_t)
in (FStar_Util.format4 "Impossible: ill-typed application:\n\thead=%s, arg=%s, tag=%s\n\texpected type unit, got %s" _174_400 _174_399 _174_398 _174_397)))))
in (FStar_All.failwith _174_401))
end
end
| (((e0, _79_1249))::rest, FStar_Extraction_ML_Syntax.MLTY_Fun (tExpected, f', t)) -> begin
(

let r = e0.FStar_Syntax_Syntax.pos
in (

let _79_1262 = (term_as_mlexpr g e0)
in (match (_79_1262) with
| (e0, f0, tInferred) -> begin
(

let e0 = (maybe_coerce g e0 tInferred tExpected)
in (let _174_403 = (let _174_402 = (FStar_Extraction_ML_Util.join_l r ((f)::(f')::(f0)::[]))
in ((_174_402), (t)))
in (extract_app is_data ((mlhead), ((((e0), (f0)))::mlargs_f)) _174_403 rest)))
end)))
end
| _79_1265 -> begin
(match ((FStar_Extraction_ML_Util.udelta_unfold g t)) with
...
let extract_app_maybe_projector = (fun is_data mlhead _79_1274 args -> (match (_79_1274) with
| (f, t) -> begin
(match (is_data) with
| Some (FStar_Syntax_Syntax.Record_projector (_79_1277)) -> begin
(

let rec remove_implicits = (fun args f t -> (match (((args), (t))) with
| (((a0, Some (FStar_Syntax_Syntax.Implicit (_79_1287))))::args, FStar_Extraction_ML_Syntax.MLTY_Fun (_79_1293, f', t)) -> begin
(let _174_418 = (FStar_Extraction_ML_Util.join a0.FStar_Syntax_Syntax.pos f f')
in (remove_implicits args _174_418 t))
end
| _79_1300 -> begin
((args), (f), (t))
end))
...
let _79_1304 = (remove_implicits args f t)
...
let _79_1327 = (match ((FStar_Extraction_ML_UEnv.lookup_term g head)) with
...
let _79_1382 = (match (vars) with
| (_79_1341)::_79_1339 when ((not (has_typ_apps)) && inst_ok) -> begin
((head_ml), (t), (args))
end
| _79_1344 -> begin
(
...
let _79_1348 = (FStar_Util.first_N n args)
in (match (_79_1348) with
| (prefix, rest) -> begin
(

let prefixAsMLTypes = (FStar_List.map (fun _79_1352 -> (match (_79_1352) with
| (x, _79_1351) -> begin
(term_as_mlty g x)
end)) prefix)
in (
...
let _79_1361 = head_ml
in {FStar_Extraction_ML_Syntax.expr = _79_1361.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t; FStar_Extraction_ML_Syntax.loc = _79_1361.FStar_Extraction_ML_Syntax.loc})
end
| FStar_Extraction_ML_Syntax.MLE_App (head, ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Unit); FStar_Extraction_ML_Syntax.mlty = _79_1367; FStar_Extraction_ML_Syntax.loc = _79_1365})::[]) -> begin
(FStar_All.pipe_right (FStar_Extraction_ML_Syntax.MLE_App ((((

let _79_1374 = head
in {FStar_Extraction_ML_Syntax.expr = _79_1374.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t))); FStar_Extraction_ML_Syntax.loc = _79_1374.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t))
end
| _79_1377 -> begin
...
(match (args) with
| [] -> begin
(let _174_420 = (maybe_eta_data_and_project_record g qual head_t head_ml)
in ((_174_420), (FStar_Extraction_ML_Syntax.E_PURE), (head_t)))
end
| _79_1385 -> begin
...
let _79_1391 = (term_as_mlexpr g head)
in (match (_79_1391) with
| (head, f, t) -> begin
...
let _79_1408 = (check_term_as_mlexpr g e0 f t)
in (match (_79_1408) with
| (e, t) -> begin
((e), (f), (t))
end))))
end
...
let _79_1424 = if is_rec then begin
...
let x = (let _174_421 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in (FStar_Syntax_Syntax.freshen_bv _174_421))
in (

let lb = (

let _79_1418 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = _79_1418.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _79_1418.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _79_1418.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _79_1418.FStar_Syntax_Syntax.lbdef})
in (
...
let tcenv = (let _174_423 = (FStar_Ident.lid_of_path (FStar_List.append (Prims.fst g.FStar_Extraction_ML_UEnv.currentModule) (((Prims.snd g.FStar_Extraction_ML_UEnv.currentModule))::[])) FStar_Range.dummyRange)
in (FStar_TypeChecker_Env.set_current_module g.FStar_Extraction_ML_UEnv.tcenv _174_423))
in (
...
let _79_1428 = lb
in {FStar_Syntax_Syntax.lbname = _79_1428.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _79_1428.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _79_1428.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _79_1428.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbdef}))))))
end else begin
lbs
end
in (

let maybe_generalize = (fun _79_1438 -> (match (_79_1438) with
| {FStar_Syntax_Syntax.lbname = lbname_; FStar_Syntax_Syntax.lbunivs = _79_1436; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = lbeff; FStar_Syntax_Syntax.lbdef = e} -> begin
(
...
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) when (let _174_426 = (FStar_List.hd bs)
in (FStar_All.pipe_right _174_426 (is_type_binder g))) -> begin
(

let _79_1447 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_79_1447) with
| (bs, c) -> begin
(

let _79_1457 = (match ((FStar_Util.prefix_until (fun x -> (not ((is_type_binder g x)))) bs)) with
| None -> begin
((bs), ((FStar_Syntax_Util.comp_result c)))
end
| Some (bs, b, rest) -> begin
(let _174_428 = (FStar_Syntax_Util.arrow ((b)::rest) c)
in ((bs), (_174_428)))
end)
...
| FStar_Syntax_Syntax.Tm_abs (bs, body, _79_1463) -> begin
(

let _79_1468 = (FStar_Syntax_Subst.open_term bs body)
in (match (_79_1468) with
| (bs, body) -> begin
if (n_tbinders <= (FStar_List.length bs)) then begin
(

let _79_1471 = (FStar_Util.first_N n_tbinders bs)
in (match (_79_1471) with
| (targs, rest_args) -> begin
(

let expected_source_ty = (

let s = (FStar_List.map2 (fun _79_1475 _79_1479 -> (match (((_79_1475), (_79_1479))) with
| ((x, _79_1474), (y, _79_1478)) -> begin
(let _174_432 = (let _174_431 = (FStar_Syntax_Syntax.bv_to_name y)
in ((x), (_174_431)))
in FStar_Syntax_Syntax.NT (_174_432))
end)) tbinders targs)
in (FStar_Syntax_Subst.subst s tbody))
in (

let env = (FStar_List.fold_left (fun env _79_1486 -> (match (_79_1486) with
| (a, _79_1485) -> begin
...
let polytype = (let _174_436 = (FStar_All.pipe_right targs (FStar_List.map (fun _79_1492 -> (match (_79_1492) with
| (x, _79_1491) -> begin
(FStar_Extraction_ML_UEnv.bv_as_ml_tyvar x)
end))))
in ((_174_436), (expected_t)))
in (
...
let env = (FStar_List.fold_left (fun env _79_1516 -> (match (_79_1516) with
| (a, _79_1515) -> begin
(FStar_Extraction_ML_UEnv.extend_ty env a None)
end)) g tbinders)
in (
...
let polytype = (let _174_440 = (FStar_All.pipe_right tbinders (FStar_List.map (fun _79_1522 -> (match (_79_1522) with
| (x, _79_1521) -> begin
(FStar_Extraction_ML_UEnv.bv_as_ml_tyvar x)
end))))
in ((_174_440), (expected_t)))
in (

let args = (FStar_All.pipe_right tbinders (FStar_List.map (fun _79_1527 -> (match (_79_1527) with
| (bv, _79_1526) -> begin
(let _174_442 = (FStar_Syntax_Syntax.bv_to_name bv)
in (FStar_All.pipe_right _174_442 FStar_Syntax_Syntax.as_arg))
end))))
in (
...
let check_lb = (fun env _79_1548 -> (match (_79_1548) with
| (nm, (lbname, f, (t, (targs, polytype)), add_unit, e)) -> begin
(

let env = (FStar_List.fold_left (fun env _79_1553 -> (match (_79_1553) with
| (a, _79_1552) -> begin
(FStar_Extraction_ML_UEnv.extend_ty env a None)
end)) env targs)
in (
...
let _79_1559 = (check_term_as_mlexpr env e f expected_t)
...
let _79_1584 = (FStar_List.fold_right (fun lb _79_1565 -> (match (_79_1565) with
| (env, lbs) -> begin
(

let _79_1578 = lb
in (match (_79_1578) with
| (lbname, _79_1568, (t, (_79_1571, polytype)), add_unit, _79_1577) -> begin
(

let _79_1581 = (FStar_Extraction_ML_UEnv.extend_lb env lbname t polytype add_unit true)
...
let _79_1591 = (term_as_mlexpr env_body e')
in (match (_79_1591) with
| (e', f', t') -> begin
(

let f = (let _174_452 = (let _174_451 = (FStar_List.map Prims.fst lbs)
in (f')::_174_451)
in (FStar_Extraction_ML_Util.join_l e'_rng _174_452))
in (
...
in (let _174_457 = (let _174_456 = (let _174_454 = (let _174_453 = (FStar_List.map Prims.snd lbs)
in ((is_rec), ([]), (_174_453)))
in (mk_MLE_Let top_level _174_454 e'))
in (let _174_455 = (FStar_Extraction_ML_Util.mlloc_of_range t.FStar_Syntax_Syntax.pos)
in (FStar_Extraction_ML_Syntax.with_ty_loc t' _174_456 _174_455)))
in ((_174_457), (f), (t')))))
end)))))
end))))))
end)))
...
let _79_1601 = (term_as_mlexpr g scrutinee)
in (match (_79_1601) with
| (e, f_e, t_e) -> begin
(

let _79_1605 = (check_pats_for_ite pats)
in (match (_79_1605) with
...
let _79_1617 = (term_as_mlexpr g then_e)
in (match (_79_1617) with
| (then_mle, f_then, t_then) -> begin
(

let _79_1621 = (term_as_mlexpr g else_e)
in (match (_79_1621) with
| (else_mle, f_else, t_else) -> begin
(

let _79_1624 = if (type_leq g t_then t_else) then begin
((t_else), (no_lift))
end else begin
...
(let _174_488 = (let _174_486 = (let _174_485 = (let _174_484 = (maybe_lift then_mle t_then)
in (let _174_483 = (let _174_482 = (maybe_lift else_mle t_else)
in Some (_174_482))
in ((e), (_174_484), (_174_483))))
in FStar_Extraction_ML_Syntax.MLE_If (_174_485))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_branch) _174_486))
in (let _174_487 = (FStar_Extraction_ML_Util.join then_e.FStar_Syntax_Syntax.pos f_then f_else)
in ((_174_488), (_174_487), (t_branch))))
end))
end))
end))
end
...
let _79_1658 = (FStar_All.pipe_right pats (FStar_Util.fold_map (fun compat br -> (

let _79_1632 = (FStar_Syntax_Subst.open_branch br)
in (match (_79_1632) with
| (pat, when_opt, branch) -> begin
(

let _79_1636 = (extract_pat g pat t_e)
in (match (_79_1636) with
| (env, p, pat_t_compat) -> begin
(

let _79_1647 = (match (when_opt) with
| None -> begin
...
let _79_1643 = (term_as_mlexpr env w)
...
let _79_1651 = (term_as_mlexpr env branch)
in (match (_79_1651) with
| (mlbranch, f_branch, t_branch) -> begin
(let _174_492 = (FStar_All.pipe_right p (FStar_List.map (fun _79_1654 -> (match (_79_1654) with
| (p, wopt) -> begin
(
...
in (((compat && pat_t_compat)), (_174_492)))
end))
end))
end))
end))) true))
...
let _79_1662 = (FStar_Extraction_ML_UEnv.debug g (fun _79_1660 -> (let _174_495 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule e)
in (let _174_494 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t_e)
...
let _79_1671 = (let _174_497 = (let _174_496 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.failwith_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Extraction_ML_UEnv.lookup_fv g _174_496))
in (FStar_All.pipe_left FStar_Util.right _174_497))
in (match (_79_1671) with
| (fw, _79_1668, _79_1670) -> begin
(let _174_502 = (let _174_501 = (let _174_500 = (let _174_499 = (let _174_498 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_string_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_String ("unreachable"))))
in (_174_498)::[])
in ((fw), (_174_499)))
in FStar_Extraction_ML_Syntax.MLE_App (_174_500))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_unit_ty) _174_501))
in ((_174_502), (FStar_Extraction_ML_Syntax.E_PURE), (FStar_Extraction_ML_Syntax.ml_unit_ty)))
end))
end
| ((_79_1674, _79_1676, (_79_1678, f_first, t_first)))::rest -> begin
(

let _79_1704 = (FStar_List.fold_left (fun _79_1686 _79_1696 -> (match (((_79_1686), (_79_1696))) with
| ((topt, f), (_79_1688, _79_1690, (_79_1692, f_branch, t_branch))) -> begin
(
...
in (match (_79_1704) with
| (topt, f_match) -> begin
(

let mlbranches = (FStar_All.pipe_right mlbranches (FStar_List.map (fun _79_1715 -> (match (_79_1715) with
| (p, (wopt, _79_1708), (b, _79_1712, t)) -> begin
(
...
in (let _174_506 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_match) (FStar_Extraction_ML_Syntax.MLE_Match (((e), (mlbranches)))))
in ((_174_506), (f_match), (t_match)))))
end))
end)))
end))
end)
...
let _79_1728 = (FStar_Util.incr c)
in (let _174_509 = (FStar_ST.read c)
in ((x), (_174_509))))))
...
let _79_1736 = (FStar_TypeChecker_Env.lookup_lid env.FStar_Extraction_ML_UEnv.tcenv discName)
in (match (_79_1736) with
| (_79_1734, fstar_disc_type) -> begin
(

let wildcards = (match ((let _174_516 = (FStar_Syntax_Subst.compress fstar_disc_type)
in _174_516.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, _79_1739) -> begin
(let _174_520 = (FStar_All.pipe_right binders (FStar_List.filter (fun _79_6 -> (match (_79_6) with
| (_79_1744, Some (FStar_Syntax_Syntax.Implicit (_79_1746))) -> begin
true
end
| _79_1751 -> begin
false
end))))
in (FStar_All.pipe_right _174_520 (FStar_List.map (fun _79_1752 -> (let _174_519 = (fresh "_")
in ((_174_519), (FStar_Extraction_ML_Syntax.MLTY_Top)))))))
end
| _79_1755 -> begin
...
let discrBody = (let _174_535 = (let _174_534 = (let _174_533 = (let _174_532 = (let _174_531 = (let _174_530 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty targ) (FStar_Extraction_ML_Syntax.MLE_Name ((([]), ((FStar_Extraction_ML_Syntax.idsym mlid))))))
in (let _174_529 = (let _174_528 = (let _174_524 = (let _174_522 = (let _174_521 = (FStar_Extraction_ML_Syntax.mlpath_of_lident constrName)
in ((_174_521), ((FStar_Extraction_ML_Syntax.MLP_Wild)::[])))
in FStar_Extraction_ML_Syntax.MLP_CTor (_174_522))
in (let _174_523 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (true))))
in ((_174_524), (None), (_174_523))))
in (let _174_527 = (let _174_526 = (let _174_525 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (false))))
in ((FStar_Extraction_ML_Syntax.MLP_Wild), (None), (_174_525)))
in (_174_526)::[])
in (_174_528)::_174_527))
in ((_174_530), (_174_529))))
in FStar_Extraction_ML_Syntax.MLE_Match (_174_531))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _174_532))
in (((FStar_List.append wildcards ((((mlid), (targ)))::[]))), (_174_533)))
in FStar_Extraction_ML_Syntax.MLE_Fun (_174_534))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty disc_ty) _174_535))
