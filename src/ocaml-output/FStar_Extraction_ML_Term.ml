  ...
  fun l  ->
    ...
    then def
      ...
      (let uu____1536 = FStar_List.hd l in
       ...
       | (p1,w1,e1) ->
           let uu____1570 =
             let uu____1579 = FStar_List.tl l in FStar_List.hd uu____1579 in
      ...
      let uu____1787 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____1789 = FStar_Options.codegen () in
           uu____1789 = (FStar_Pervasives_Native.Some "Kremlin")) in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1949 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1950 in
          failwith uu____1949
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2632, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b in
                ...
                let uu____2947 =
                      ...
                      let uu____2960 =
                        ...
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.ml_int_ty) uu____2961 in
                  ...
                  | FStar_Pervasives_Native.Some sw ->
                      ...
                      (match uu____2983 with
                       | (mlterm,uu____2995,mlty) -> (mlterm, mlty)) in
                (match uu____2947 with
                 | (mlc,ml_ty) ->
                     ...
                     let when_clause =
                       ...
                       FStar_All.pipe_left
                         (FStar_Extraction_ML_Syntax.with_ty
                            FStar_Extraction_ML_Syntax.ml_bool_ty) uu____3015 in
            ...
            | hd1::tl1 ->
                let uu____4486 =
                  FStar_List.fold_left FStar_Extraction_ML_Util.conjoin hd1
                    tl1 in
                FStar_Pervasives_Native.Some uu____4486 in
          let uu____4487 =
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____4685 -> failwith "Impossible: Head type is not an arrow" in
              ...
              let e =
                ...
                | uu____4915 ->
                    let uu____4918 =
                      ...
                      (uu____4925, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4918 in
              FStar_Extraction_ML_Syntax.with_ty
                      ...
                      let uu____4974 =
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top) proj in
                      (uu____4974, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4967 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then let uu____5264 = maybe_coerce g e t ty in (uu____5264, ty)
      ...
      (let t = FStar_Syntax_Subst.compress top in
       ...
       | FStar_Syntax_Syntax.Tm_unknown  ->
           let uu____5293 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5294 in
           failwith uu____5293
       ...
       | FStar_Syntax_Syntax.Tm_bvar uu____5359 ->
           let uu____5360 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5361 in
           failwith uu____5360
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____6000;_},(t1,uu____6002)::
            (r,uu____6004)::[])
           -> term_as_mlexpr' g t1
       | FStar_Syntax_Syntax.Tm_app
           ({
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____6074::(v1,uu____6076)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____6122 in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6240 in
                let tm =
                  let uu____6250 =
                    let uu____6251 = FStar_TypeChecker_Util.remove_reify e in
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7525 ->
                                               let uu___297_7528 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___297_7528.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___297_7528.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___298_7533.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___298_7533.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7534 ->
                                               let uu___298_7535 =
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___298_7535.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___298_7535.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___299_7544 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___299_7544.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___299_7544.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7950 ->
                                               let uu___297_7953 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___297_7953.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___297_7953.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           match head_ml.FStar_Extraction_ML_Syntax.expr
                                           with
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___298_7958.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___298_7958.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7959 ->
                                               let uu___298_7960 =
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___298_7960.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___298_7960.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___299_7969 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___299_7969.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___299_7969.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
               ...
               (let uu____8172 = FStar_Syntax_Syntax.is_top_level lbs in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs in
                   ...
                   let lb1 =
                     let uu___300_8188 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___300_8188.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___300_8188.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___300_8188.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___300_8188.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e'1 =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8220 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8227  ->
                            ...
                            (let lbdef =
                             ...
                             let uu___301_8235 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___301_8235.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___301_8235.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___301_8235.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___301_8235.FStar_Syntax_Syntax.lbeff);
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____8361 = FStar_Syntax_Subst.open_comp bs c in
                                ...
                                let uu____8386 =
                                  let uu____8393 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8429 = is_type_binder g x in
                                         Prims.op_Negation uu____8429) bs1 in
                           ...
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____10300 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____10316 = term_as_mlexpr g else_e1 in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____11521,fstar_disc_type) ->
            let wildcards =
              let uu____11530 =
                let uu____11531 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              | uu____11642 -> failwith "Discriminator must be a function" in
              ...
              let uu____11653 =
                let uu____11654 =
                  let uu____11665 =
                        ...
                        let uu____11685 =
                          let uu____11696 =
                            let uu____11705 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11706 in
                            let uu____11716 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                          ...
                          let uu____11719 =
                            let uu____11730 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11739) in
                            [uu____11730] in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11666 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11665) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11654 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11653 in
            let uu____11794 =
              let uu____11795 =
                let uu____11798 =
                  let uu____11799 =
