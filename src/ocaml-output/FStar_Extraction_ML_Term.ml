...
let err_uninst env t uu____131 app =
  ...
  | (vars,ty) ->
      let uu____146 =
        ...
        let uu____148 =
          let uu____149 =
            FStar_All.pipe_right vars (FStar_List.map FStar_Pervasives.fst)
             in
        ...
        FStar_Util.format4
          ...
          uu____147 uu____148 uu____158 uu____159
         in
        ...
        FStar_All.pipe_right args
          (FStar_List.map
             (fun uu____207  ->
                ...
                | (x,uu____211) -> FStar_Syntax_Print.term_to_string x))
         in
  ...
  fun l  ->
    ...
    then def
      ...
      (let uu____1079 = FStar_List.hd l  in
       ...
       | (p1,w1,e1) ->
           let uu____1098 =
             let uu____1103 = FStar_List.tl l  in FStar_List.hd uu____1103
              in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____1299 ->
          let uu____1300 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1301
             in
          failwith uu____1300
      | FStar_Syntax_Syntax.Tm_delayed uu____1302 ->
          let uu____1317 =
            let uu____1318 = FStar_Syntax_Print.term_to_string t1  in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1318
             in
          failwith uu____1317
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1319 =
            let uu____1320 = FStar_Syntax_Print.term_to_string t1  in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1320
             in
          failwith uu____1319
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____1773, FStar_Extraction_ML_Syntax.ml_unit_ty)
                           in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = fst b  in
              ...
              let when_clause =
                let uu____2003 =
                  let uu____2004 =
                    ...
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____2008)
                     in
                  FStar_Extraction_ML_Syntax.MLE_App uu____2004  in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____2003
                 in
    ...
    FStar_Syntax_Syntax.pat ->
      FStar_Extraction_ML_Syntax.mlty ->
        (FStar_Extraction_ML_UEnv.env * (FStar_Extraction_ML_Syntax.mlpattern
          * FStar_Extraction_ML_Syntax.mlexpr option) Prims.list *
          Prims.bool)
  =
  fun g  ->
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          ...
          | uu____2781 -> failwith "Impossible: Unable to translate pattern"
           in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____2927 -> failwith "Impossible: Head type is not an arrow"
             in
                    ...
                    let uu____3068 =
                      let uu____3072 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____3072, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____3068
                 in
              FStar_Extraction_ML_Syntax.with_ty
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then
                let uu____3222 = maybe_coerce g e t ty  in (uu____3222, ty)
        ...
        (fun u  ->
           let uu____3233 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____3234 uu____3235 uu____3236
              in
      ...
      (let t = FStar_Syntax_Subst.compress top  in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____3669::(v1,uu____3671)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____3706
              in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_int_ty
               (FStar_Extraction_ML_Syntax.MLE_Const
                  (FStar_Extraction_ML_Syntax.MLC_Int ("0", None)))
              in
           let term_ty =
             let uu____3720 =
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____3788
                   in
                let tm =
                  let uu____3796 =
                    let uu____3797 = FStar_TypeChecker_Util.remove_reify e
                       in
                                    ...
                                    (match uu____4497 with
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                               uu____4559 ->
                                               let uu___144_4560 = head_ml
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4560.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4560.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____4561 ->
                                               let uu___144_4562 = head_ml
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4562.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4562.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_4568 =
                                                        head3  in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_4568.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_4568.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                    ...
                                    (match uu____4758 with
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                               uu____4820 ->
                                               let uu___144_4821 = head_ml
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4821.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4821.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____4822 ->
                                               let uu___144_4823 = head_ml
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_4823.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_4823.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_4829 =
                                                        head3  in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_4829.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_4829.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
               ...
               (let uu____4971 = FStar_Syntax_Syntax.is_top_level lbs  in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs  in
                   ...
                   let lb1 =
                     let uu___146_4983 = lb  in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___146_4983.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___146_4983.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___146_4983.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___146_4983.FStar_Syntax_Syntax.lbdef)
                     }  in
                   let e'1 =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____5000
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____5004  ->
                            ...
                            (let lbdef =
                               ...
                               then lb.FStar_Syntax_Syntax.lbdef
                                ...
                                in
                             let uu___147_5012 = lb  in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___147_5012.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___147_5012.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___147_5012.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___147_5012.FStar_Syntax_Syntax.lbeff);
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____5087 = FStar_Syntax_Subst.open_comp bs c
                              in
                                ...
                                let uu____5101 =
                                  let uu____5106 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____5124 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____5124) bs1
                                     in
                      ...
                      | (e'2,f',t') ->
                          let f =
                            let uu____6159 =
                              ...
                              f' :: uu____6161  in
                            FStar_Extraction_ML_Util.join_l e'_rng uu____6159
                             in
                          let is_rec1 =
                            if is_rec = true
                          ...
                          let uu____6167 =
                            let uu____6168 =
                              let uu____6169 =
                                let uu____6170 =
                                  FStar_List.map FStar_Pervasives.snd lbs5
                                   in
                        ...
                        | (Some then_e1,Some else_e1) ->
                            ...
                            (match uu____6250 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____6260 = term_as_mlexpr g else_e1
                                    in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____6947,fstar_disc_type) ->
            let wildcards =
              let uu____6955 =
                let uu____6956 = FStar_Syntax_Subst.compress fstar_disc_type
                   in
              ...
              let uu____7039 =
                let uu____7040 =
                  let uu____7046 =
                        ...
                        let uu____7056 =
                          let uu____7057 =
                            let uu____7058 =
                              ...
                              ([], uu____7059)  in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____7058
                             in
                          FStar_All.pipe_left
                            ...
                            let uu____7072 =
                              let uu____7073 =
                                ...
                                (uu____7077,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____7073
                               in
                            let uu____7079 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____7047
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____7046)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____7040  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____7039
               in
            let uu____7130 =
              let uu____7131 =
                let uu____7133 =
