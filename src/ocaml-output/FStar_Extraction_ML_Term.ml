...
let _81_22 = (let _181_33 = (let _181_32 = (FStar_Range.string_of_range r)
...
in (let _181_49 = (let _181_47 = (FStar_All.pipe_right args (FStar_List.map (fun _81_36 -> (match (_81_36) with
| (x, _81_35) -> begin
...
let _81_357 = (let _181_113 = (FStar_List.tl l)
...
| (_81_548, rest) -> begin
(let _181_177 = (FStar_List.map (fun _81_551 -> FStar_Extraction_ML_UEnv.erasedContent) rest)
...
(FStar_Extraction_ML_UEnv.debug g (fun _81_651 -> (let _181_218 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t')
...
let _81_727 = (FStar_Extraction_ML_UEnv.debug g (fun _81_725 -> (let _181_247 = (FStar_Syntax_Print.pat_to_string p)
...
let _81_778 = (let _181_255 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun _81_1 -> (match (_81_1) with
| Some (x) -> begin
(x)::[]
end
| _81_775 -> begin
...
let _81_995 = (FStar_Extraction_ML_UEnv.debug g (fun u -> (let _181_334 = (let _181_333 = (FStar_Syntax_Print.tag_of_term t)
...
let _81_1021 = (FStar_Extraction_ML_UEnv.debug g (fun u -> (let _181_350 = (let _181_349 = (FStar_Range.string_of_range top.FStar_Syntax_Syntax.pos)
...
let polytype = (let _181_431 = (FStar_All.pipe_right targs (FStar_List.map (fun _81_1551 -> (match (_81_1551) with
| (x, _81_1550) -> begin
...
let polytype = (let _181_435 = (FStar_All.pipe_right tbinders (FStar_List.map (fun _81_1581 -> (match (_81_1581) with
| (x, _81_1580) -> begin
(FStar_Extraction_ML_UEnv.bv_as_ml_tyvar x)
end))))
...
(let _181_487 = (FStar_All.pipe_right p (FStar_List.map (fun _81_1713 -> (match (_81_1713) with
| (p, wopt) -> begin
(
...
let _81_1721 = (FStar_Extraction_ML_UEnv.debug g (fun _81_1719 -> (let _181_490 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule e)
...
let _81_1730 = (let _181_492 = (let _181_491 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.failwith_lid FStar_Syntax_Syntax.Delta_constant None)
...
(let _181_515 = (FStar_All.pipe_right binders (FStar_List.filter (fun _81_5 -> (match (_81_5) with
...
in (FStar_All.pipe_right _181_515 (FStar_List.map (fun _81_1811 -> (let _181_514 = (fresh "_")
