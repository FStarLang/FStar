  ...
  fun l  ->
    ...
    then def
      ...
      (let uu____1583 = FStar_List.hd l  in
       ...
       | (p1,w1,e1) ->
           let uu____1617 =
             let uu____1626 = FStar_List.tl l  in FStar_List.hd uu____1626
              in
                 ...
                 (fun uu____1843  ->
                    ...
                    | (v1,t1) ->
                        FStar_Extraction_ML_Syntax.with_ty t1
                          (FStar_Extraction_ML_Syntax.MLE_Var v1)) uu____1825
                in
             let body =
      ...
      let uu____1871 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____1873 = FStar_Options.codegen ()  in
           uu____1873 = (FStar_Pervasives_Native.Some "Kremlin"))
         in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____2009 ->
          let uu____2010 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____2011
             in
          failwith uu____2010
      | FStar_Syntax_Syntax.Tm_delayed uu____2012 ->
          let uu____2037 =
            let uu____2038 = FStar_Syntax_Print.term_to_string t1  in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____2038
             in
          failwith uu____2037
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____2039 =
            let uu____2040 = FStar_Syntax_Print.term_to_string t1  in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____2040
             in
          failwith uu____2039
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2758, FStar_Extraction_ML_Syntax.ml_unit_ty)
                           in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b  in
              ...
              let when_clause =
                let uu____3128 =
                  let uu____3129 =
                    ...
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____3136)
                     in
                  FStar_Extraction_ML_Syntax.MLE_App uu____3129  in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____3128
                 in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          ...
          | uu____4540 -> failwith "Impossible: Unable to translate pattern"
           in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____4786 -> failwith "Impossible: Head type is not an arrow"
             in
                    ...
                    let uu____5019 =
                      let uu____5026 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____5026, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____5019
                 in
              FStar_Extraction_ML_Syntax.with_ty
      ...
      (let t = FStar_Syntax_Subst.compress top  in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____5970::(v1,uu____5972)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____6018
              in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_int_ty
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6136
                   in
                let tm =
                  let uu____6146 =
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                  ...
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_7412.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_7412.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7413 ->
                                                  ...
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_7414.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_7414.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_7423 =
                                                        head3  in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_7423.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_7423.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                  ...
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_7820.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_7820.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7821 ->
                                                  ...
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_7822.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_7822.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_7831 =
                                                        head3  in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_7831.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_7831.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                   ...
                   let lb1 =
                     let uu___146_8050 = lb  in
                     {
                       ...
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___146_8050.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___146_8050.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___146_8050.FStar_Syntax_Syntax.lbeff);
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8082
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8089  ->
                            ...
                            (let lbdef =
                             ...
                             let uu___147_8097 = lb  in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___147_8097.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___147_8097.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___147_8097.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___147_8097.FStar_Syntax_Syntax.lbeff);
                                    ...
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8291 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____8291) bs1
                                     in
                                 ...
                                 (match uu____11040 with
                                  | (uu____11109,fw,uu____11111,uu____11112)
                                      ...
                                      (uu____11113,
                                        FStar_Extraction_ML_Syntax.E_PURE,
                                        FStar_Extraction_ML_Syntax.ml_unit_ty))
                             | (uu____11128,uu____11129,(uu____11130,f_first,t_first))::rest
                                 ->
                                 let uu____11190 =
                                   FStar_List.fold_left
                                     (fun uu____11232  ->
                                        fun uu____11233  ->
                                          match (uu____11232, uu____11233)
                                          with
                                          | ((topt,f),(uu____11290,uu____11291,
                                                       (uu____11292,f_branch,t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
              ...
              | FStar_Syntax_Syntax.Tm_arrow (binders,uu____11583) ->
                  let uu____11600 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___141_11632  ->
                            match uu___141_11632 with
                            | (uu____11639,FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____11640)) ->
                                true
                            | uu____11643 -> false))
                     in
                ...
                let uu____11887 =
                  let uu____11888 =
                    FStar_Extraction_ML_UEnv.convIdent
                     ...
                     in
                  {
                    FStar_Extraction_ML_Syntax.mllb_name = uu____11888;
                    FStar_Extraction_ML_Syntax.mllb_tysc =
                      FStar_Pervasives_Native.None;
