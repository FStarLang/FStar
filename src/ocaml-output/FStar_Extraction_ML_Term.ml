...
let type_leq
    : FStar_Extraction_ML_UEnv.env -> FStar_Extraction_ML_Syntax.mlty
      -> FStar_Extraction_ML_Syntax.mlty -> Prims.bool =
  fun g t1 t2 ->
    FStar_Extraction_ML_Util.type_leq
      (FStar_Extraction_ML_Util.udelta_unfold g)
      t1 t2
...
let record_fields:
      'Auu____50. FStar_Ident.ident Prims.list -> 'Auu____50 Prims.list
      -> (Prims.string, 'Auu____50) FStar_Pervasives_Native.tuple2 Prims.list =
  fun fs vs -> FStar_List.map2 (fun f e -> (f.FStar_Ident.idText, e)) fs vs


let fail:
      'Auu____84. FStar_Range.range
      -> (FStar_Errors.raw_error, Prims.string) FStar_Pervasives_Native.tuple2
      -> 'Auu____84 =
  fun r err -> FStar_Errors.raise_error err r


let err_uninst:
      'Auu____106. FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.term
      -> ( Prims.string Prims.list
         , FStar_Extraction_ML_Syntax.mlty )
         FStar_Pervasives_Native.tuple2 -> FStar_Syntax_Syntax.term
      -> 'Auu____106 =
  fun env t uu____127 app ->
    match uu____127 with vars, ty ->
      let uu____141 =
        let uu____146 =
          let uu____147 = FStar_Syntax_Print.term_to_string t in
          let uu____148 =
            FStar_All.pipe_right vars (FStar_String.concat ", ")
          in
          let uu____151 =
        ...
        in
        (FStar_Errors.Fatal_Uninstantiated, uu____146)
      in
      fail t.FStar_Syntax_Syntax.pos uu____141


let err_ill_typed_application:
      'Auu____159 'Auu____160. FStar_Extraction_ML_UEnv.env
  ...
  fun env t args ty ->
    let uu____189 =
        ...
        let uu____196 =
          let uu____197 =
            FStar_All.pipe_right args
              (FStar_List.map (fun uu____215 ->
                   match uu____215 with x, uu____221 ->
                     FStar_Syntax_Print.term_to_string x ))
          in
          FStar_All.pipe_right uu____197 (FStar_String.concat " ")
        in
        let uu____224 =
          FStar_Extraction_ML_Code.string_of_mlty
            env.FStar_Extraction_ML_UEnv.currentModule ty
      ...
      in
      (FStar_Errors.Fatal_IllTyped, uu____194)
    in
    fail t.FStar_Syntax_Syntax.pos uu____189


let err_value_restriction:
      'Auu____227. FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax
      -> 'Auu____227 =
  fun t ->
    let uu____236 =
      let uu____241 =
        ...
        FStar_Util.format2
          ...
          uu____242 uu____243
      in
      (FStar_Errors.Fatal_ValueRestriction, uu____241)
    in
    fail t.FStar_Syntax_Syntax.pos uu____236


let err_unexpected_eff:
      'Auu____248. FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax
  ...
  fun t f0 f1 ->
    let uu____265 =
      let uu____270 =
        ...
        FStar_Util.format3
          "for expression %s, Expected effect %s; got effect %s" uu____271
          (FStar_Extraction_ML_Util.eff_to_string f0)
          (FStar_Extraction_ML_Util.eff_to_string f1)
      in
      (FStar_Errors.Fatal_UnexpectedEffect, uu____270)
    in
    fail t.FStar_Syntax_Syntax.pos uu____265


let effect_as_etag
    : FStar_Extraction_ML_UEnv.env -> FStar_Ident.lident
  ...
  let rec delta_norm_eff g l =
    ...
    | FStar_Pervasives_Native.None ->
        ...
        in
        FStar_Util.smap_add cache l.FStar_Ident.str res ;
        res
  in
  fun g l ->
    let l1 = delta_norm_eff g l in
    if FStar_Ident.lid_equals l1 FStar_Parser_Const.effect_PURE_lid then
      FStar_Extraction_ML_Syntax.E_PURE
    else if FStar_Ident.lid_equals l1 FStar_Parser_Const.effect_GHOST_lid then
      FStar_Extraction_ML_Syntax.E_GHOST
    else
      let ed_opt =
        FStar_TypeChecker_Env.effect_decl_opt g.FStar_Extraction_ML_UEnv.tcenv
          l1
      in
      match ed_opt with
      | FStar_Pervasives_Native.Some (ed, qualifiers) ->
          ...
          in
          if uu____335 then FStar_Extraction_ML_Syntax.E_PURE
          else FStar_Extraction_ML_Syntax.E_IMPURE
      | FStar_Pervasives_Native.None -> FStar_Extraction_ML_Syntax.E_IMPURE
...
let rec is_arity
  ...
  fun env t ->
    ...
    let uu____352 =
      ...
      uu____353.FStar_Syntax_Syntax.n
    in
    ...
    | FStar_Syntax_Syntax.Tm_fvar uu____454 -> (
        ...
        let uu____456 =
          ...
          uu____457.FStar_Syntax_Syntax.n
        in
  ...
  fun env t ->
    ...
    | FStar_Syntax_Syntax.Tm_delayed uu____679 ->
        let uu____704 =
          ...
          FStar_Util.format1 "Impossible: %s" uu____705
        in
        failwith uu____704
    | FStar_Syntax_Syntax.Tm_unknown ->
        let uu____706 =
          let uu____707 = FStar_Syntax_Print.tag_of_term t1 in
          FStar_Util.format1 "Impossible: %s" uu____707
        in
        failwith uu____706
    ...
    | FStar_Syntax_Syntax.Tm_fvar fv
      when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.failwith_lid ->
        false
    | FStar_Syntax_Syntax.Tm_fvar fv ->
    ...
    | FStar_Syntax_Syntax.Tm_let ((false, [lb]), body) -> (
        ...
        let uu____862 =
          let uu____867 =
            let uu____868 = FStar_Syntax_Syntax.mk_binder x in
            [uu____868]
          in
          FStar_Syntax_Subst.open_term uu____867 body
        in
    ...
    | FStar_Syntax_Syntax.Tm_match (uu____901, branches) -> (
      ...
      | b :: uu____940 -> (
          ...
          match uu____985 with uu____986, uu____987, e -> is_type_aux env e )
      | uu____1005 -> false )
    | FStar_Syntax_Syntax.Tm_meta (t2, uu____1023) -> is_type_aux env t2
    | FStar_Syntax_Syntax.Tm_app (head1, uu____1029) -> is_type_aux env head1


let is_type
    : FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.term -> Prims.bool =
  fun env t ->
    FStar_Extraction_ML_UEnv.debug env (fun uu____1060 ->
    ...
    FStar_Extraction_ML_UEnv.debug env (fun uu____1068 ->
        if b then
...
let is_type_binder:
      'Auu____1077. FStar_Extraction_ML_UEnv.env
  ...
  fun t ->
    ...
    | FStar_Syntax_Syntax.Tm_fvar
        ...
        ; FStar_Syntax_Syntax.fv_qual=
            FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor; _ } ->
        true
    | FStar_Syntax_Syntax.Tm_fvar
...
let rec is_fstar_value : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t ->
    let uu____1116 =
      ...
      uu____1117.FStar_Syntax_Syntax.n
    in
    ...
    | FStar_Syntax_Syntax.Tm_app (head1, args) ->
        ...
        if uu____1162 then
          FStar_All.pipe_right args
            (FStar_List.for_all (fun uu____1178 ->
                 match uu____1178 with te, uu____1184 -> is_fstar_value te ))
        else false
...
let fresh : Prims.string -> Prims.string =
  ...
  fun x ->
    ...
    let uu____1341 =
      ...
      FStar_Util.string_of_int uu____1342
    in
  ...
  fun t0 ->
    let rec aux bs t copt =
      ...
      | uu____1441 ->
          ...
          if uu____1443 then aux bs e' copt
...
let check_pats_for_ite
  ...
  fun l ->
    let def =
      (false, FStar_Pervasives_Native.None, FStar_Pervasives_Native.None)
    in
    if FStar_List.length l <> Prims.parse_int "2" then def
    else
      let uu____1527 = FStar_List.hd l in
      match uu____1527 with p1, w1, e1 ->
        let uu____1561 =
          let uu____1570 = FStar_List.tl l in
          FStar_List.hd uu____1570
        in
        match uu____1561 with p2, w2, e2 ->
          match
            (w1, w2, p1.FStar_Syntax_Syntax.v, p2.FStar_Syntax_Syntax.v)
          with
          | ( FStar_Pervasives_Native.None
            , FStar_Pervasives_Native.None
...
let instantiate
    : FStar_Extraction_ML_Syntax.mltyscheme
      ...
      -> FStar_Extraction_ML_Syntax.mlty =
  fun s args -> FStar_Extraction_ML_Util.subst s args


let erasable
    : FStar_Extraction_ML_UEnv.env -> FStar_Extraction_ML_Syntax.e_tag
      -> FStar_Extraction_ML_Syntax.mlty -> Prims.bool =
  fun g f t ->
...
let erase
    : FStar_Extraction_ML_UEnv.env -> FStar_Extraction_ML_Syntax.mlexpr
  ...
  fun g e ty f ->
    let e1 =
      ...
      if uu____1701 then
        let uu____1702 = type_leq g ty FStar_Extraction_ML_Syntax.ml_unit_ty in
        if uu____1702 then FStar_Extraction_ML_Syntax.ml_unit
        else
          FStar_All.pipe_left
...
let maybe_coerce
  ...
  fun g e ty expect ->
    ...
    let uu____1799 =
      type_leq_c g (FStar_Pervasives_Native.Some e) ty1 expect
    in
    match uu____1799 with
    | true, FStar_Pervasives_Native.Some e' -> e'
    | uu____1809 ->
        FStar_Extraction_ML_UEnv.debug g (fun uu____1821 ->
            let uu____1822 =
...
let bv_as_mlty
    : FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.bv
      -> FStar_Extraction_ML_Syntax.mlty =
  fun g bv ->
...
let rec term_as_mlty
    : FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.term
      -> FStar_Extraction_ML_Syntax.mlty =
  fun g t0 ->
    let rec is_top_ty t =
      match t with
...
and term_as_mlty'
  ...
  fun env t ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (bs, c) -> (
        ...
        match uu____2051 with bs1, c1 ->
          let uu____2058 = binders_as_ml_binders env bs1 in
          match uu____2058 with mlbs, env1 ->
            let t_ret =
              let eff =
              ...
              let uu____2085 =
                ...
                in
                FStar_Util.must uu____2092
              in
              match uu____2085 with ed, qualifiers ->
                let uu____2113 =
                  FStar_All.pipe_right qualifiers
                    (FStar_List.contains FStar_Syntax_Syntax.Reifiable)
                in
                if uu____2113 then
                  ...
                  in
                  let res = term_as_mlty' env1 t2 in
                  res
                else term_as_mlty' env1 (FStar_Syntax_Util.comp_result c1)
            in
            let erase1 =
              effect_as_etag env1 (FStar_Syntax_Util.comp_effect_name c1)
            in
            let uu____2120 =
              FStar_List.fold_right
                (fun uu____2139 uu____2140 ->
                  match (uu____2139, uu____2140)
                  with (uu____2161, t2), (tag, t') ->
                    ( FStar_Extraction_ML_Syntax.E_PURE
                    , FStar_Extraction_ML_Syntax.MLTY_Fun (t2, tag, t') ) )
                mlbs (erase1, t_ret)
            in
    ...
    | FStar_Syntax_Syntax.Tm_app (head1, args) ->
        let res =
          let uu____2198 =
            ...
            uu____2199.FStar_Syntax_Syntax.n
          in
...
and arg_as_mlty
  ...
  fun g uu____2337 ->
    match uu____2337 with a, uu____2343 ->
      let uu____2344 = is_type g a in
      if uu____2344 then term_as_mlty' g a
      else FStar_Extraction_ML_UEnv.erasedContent


and fv_app_as_mlty
    : FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.fv
  ...
  fun g fv args ->
    let uu____2349 =
      ...
      in
      match uu____2362 with (uu____2383, fvty), uu____2385 ->
        let fvty1 =
          FStar_TypeChecker_Normalize.normalize
            [ FStar_TypeChecker_Normalize.UnfoldUntil
                FStar_Syntax_Syntax.Delta_constant ]
    ...
    in
    match uu____2349 with formals, uu____2392 ->
      let mlargs = FStar_List.map (arg_as_mlty g) args in
      let mlargs1 =
        let n_args = FStar_List.length args in
        if FStar_List.length formals > n_args then
          let uu____2436 = FStar_Util.first_N n_args formals in
          match uu____2436 with uu____2463, rest ->
            let uu____2489 =
              FStar_List.map
                (fun uu____2497 -> FStar_Extraction_ML_UEnv.erasedContent)
                rest
            in
      ...
      let nm =
        let uu____2504 =
          FStar_Extraction_ML_UEnv.maybe_mangle_type_projector g fv
        in
...
and binders_as_ml_binders
    : FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.binders
    ...
    let uu____2522 =
      FStar_All.pipe_right bs
        (FStar_List.fold_left
           (fun uu____2565 b ->
             match uu____2565 with ml_bs, env ->
               ...
               if uu____2605 then
                 ...
                 let ml_b =
                   let uu____2623 =
                     FStar_Extraction_ML_UEnv.bv_as_ml_termvar b1
                   in
                 ...
                 let uu____2637 =
                   FStar_Extraction_ML_UEnv.extend_bv env b1 ([], t) false
                     false false
                 in
                 match uu____2637 with env1, b2 ->
                   let ml_b =
                     let uu____2661 = FStar_Extraction_ML_UEnv.removeTick b2 in
                     (uu____2661, t)
                   in
                   (ml_b :: ml_bs, env1) )
           ([], g))
...
let mk_MLE_Seq
  ...
  fun e1 e2 ->
    match
      (e1.FStar_Extraction_ML_Syntax.expr, e2.FStar_Extraction_ML_Syntax.expr)
    with
...
let mk_MLE_Let
    : Prims.bool -> FStar_Extraction_ML_Syntax.mlletbinding
      -> FStar_Extraction_ML_Syntax.mlexpr
      -> FStar_Extraction_ML_Syntax.mlexpr' =
  fun top_level lbs body ->
    match lbs with
    | FStar_Extraction_ML_Syntax.NonRec, [lb] when Prims.op_Negation top_level
      -> (
      match lb.FStar_Extraction_ML_Syntax.mllb_tysc with
      | FStar_Pervasives_Native.Some ([], t)
        when t = FStar_Extraction_ML_Syntax.ml_unit_ty
        -> (
          if body.FStar_Extraction_ML_Syntax.expr
             = FStar_Extraction_ML_Syntax.ml_unit
                 .FStar_Extraction_ML_Syntax.expr
          then
            lb.FStar_Extraction_ML_Syntax.mllb_def
              .FStar_Extraction_ML_Syntax.expr
          else
            match body.FStar_Extraction_ML_Syntax.expr with
            | FStar_Extraction_ML_Syntax.MLE_Var x
              when x = lb.FStar_Extraction_ML_Syntax.mllb_name ->
                lb.FStar_Extraction_ML_Syntax.mllb_def
                  .FStar_Extraction_ML_Syntax.expr
            | uu____2764
              when lb.FStar_Extraction_ML_Syntax.mllb_def
                     .FStar_Extraction_ML_Syntax.expr
                   = FStar_Extraction_ML_Syntax.ml_unit
                       .FStar_Extraction_ML_Syntax.expr ->
...
let rec extract_one_pat
    : Prims.bool -> FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.pat
      ...
      -> ( FStar_Extraction_ML_UEnv.env
         ...
         , Prims.bool )
         FStar_Pervasives_Native.tuple3 =
  fun imp g p expected_topt term_as_mlexpr ->
    let ok t =
      match expected_topt with
      | FStar_Pervasives_Native.None -> true
      | FStar_Pervasives_Native.Some t' ->
          let ok = type_leq g t t' in
          if Prims.op_Negation ok then
            FStar_Extraction_ML_UEnv.debug g (fun uu____2900 ->
                let uu____2901 =
                  FStar_Extraction_ML_Code.string_of_mlty
    ...
    | FStar_Syntax_Syntax.Pat_constant FStar_Const.Const_int (c, swopt)
      when let uu____2932 = FStar_Options.codegen () in
      ...
      -> (
        let uu____2937 =
                ...
                let uu____2951 =
                  let uu____2952 =
                    FStar_Extraction_ML_Util.mlconst_of_const
                      ...
                      (FStar_Const.Const_int (c, FStar_Pervasives_Native.None))
                  in
                  FStar_Extraction_ML_Syntax.MLE_Const uu____2952
                in
                FStar_All.pipe_left
          ...
          | FStar_Pervasives_Native.Some sw ->
              ...
              match uu____2973 with mlterm, uu____2985, mlty -> (mlterm, mlty)
        in
        match uu____2937 with mlc, ml_ty ->
            ...
            let uu____3005 =
              let uu____3006 =
                let uu____3013 =
                  ...
                  [uu____3016; mlc]
                in
                (FStar_Extraction_ML_Util.prims_op_equality, uu____3013)
              in
              FStar_Extraction_ML_Syntax.MLE_App uu____3006
            in
            FStar_All.pipe_left
              (FStar_Extraction_ML_Syntax.with_ty
    ...
    | FStar_Syntax_Syntax.Pat_constant s ->
        let t =
          FStar_TypeChecker_TcTerm.tc_constant g.FStar_Extraction_ML_UEnv.tcenv
        ...
        let uu____3039 =
          let uu____3048 =
            let uu____3055 =
              ...
              in
              FStar_Extraction_ML_Syntax.MLP_Const uu____3056
            in
            (uu____3055, [])
          in
          FStar_Pervasives_Native.Some uu____3048
        in
        let uu____3065 = ok mlty in
        (g, uu____3039, uu____3065)
    | FStar_Syntax_Syntax.Pat_var x -> (
        let mlty = term_as_mlty g x.FStar_Syntax_Syntax.sort in
        let uu____3076 =
          FStar_Extraction_ML_UEnv.extend_bv g x ([], mlty) false false imp
        in
        match uu____3076 with g1, x1 ->
          let uu____3099 = ok mlty in
          ( g1
          , ( if imp then FStar_Pervasives_Native.None
            else
              FStar_Pervasives_Native.Some
        ...
        let uu____3227 =
          ...
          | FStar_Util.Inr
              ...
              , { FStar_Extraction_ML_Syntax.expr=
                ...
                ; FStar_Extraction_ML_Syntax.loc= uu____3240; _ }
              , ttys
              , uu____3242 ) ->
              (n1, ttys)
          | uu____3255 -> failwith "Expected a constructor"
        in
        match uu____3227 with d, tys ->
          let nTyVars = FStar_List.length (FStar_Pervasives_Native.fst tys) in
          let uu____3277 = FStar_Util.first_N nTyVars pats in
          match uu____3277 with tysVarPats, restPats ->
            let f_ty_opt =
              try
                let mlty_args =
                  FStar_All.pipe_right tysVarPats
                    (FStar_List.map (fun uu____3410 ->
                         match uu____3410 with p1, uu____3418 ->
                           match p1.FStar_Syntax_Syntax.v with
                           | FStar_Syntax_Syntax.Pat_dot_term (uu____3423, t) ->
                               term_as_mlty g t
                           | uu____3429 ->
                               FStar_Extraction_ML_UEnv.debug g
                                 (fun uu____3433 ->
                                   ...
                                   in
                                   FStar_Util.print1
                                     "Pattern %s is not extractable" uu____3434
                               ) ;
                               FStar_Exn.raise Un_extractable ))
                in
                let f_ty = FStar_Extraction_ML_Util.subst tys mlty_args in
                let uu____3436 =
                  FStar_Extraction_ML_Util.uncurry_mlty_fun f_ty
                in
                FStar_Pervasives_Native.Some uu____3436
              with Un_extractable -> FStar_Pervasives_Native.None
            in
            let uu____3465 =
              FStar_Util.fold_map
                (fun g1 uu____3501 ->
                  match uu____3501 with p1, imp1 ->
                    let uu____3520 =
                      extract_one_pat true g1 p1 FStar_Pervasives_Native.None
                        term_as_mlexpr
                    in
                    match uu____3520 with g2, p2, uu____3549 -> (g2, p2) )
                g tysVarPats
            in
            match uu____3465 with g1, tyMLPats ->
              let uu____3610 =
                FStar_Util.fold_map
                  (fun uu____3674 uu____3675 ->
                    match (uu____3674, uu____3675)
                    with (g2, f_ty_opt1), (p1, imp1) ->
                      let uu____3768 =
                        match f_ty_opt1 with
                        | FStar_Pervasives_Native.Some (hd1 :: rest, res) ->
                            ( FStar_Pervasives_Native.Some (rest, res)
                            , FStar_Pervasives_Native.Some hd1 )
                        | uu____3828 ->
                            ( FStar_Pervasives_Native.None
                            , FStar_Pervasives_Native.None )
                      in
                      match uu____3768 with f_ty_opt2, expected_ty ->
                        let uu____3899 =
                          extract_one_pat false g2 p1 expected_ty
                            term_as_mlexpr
                        in
                        match uu____3899 with g3, p2, uu____3940 ->
                          ((g3, f_ty_opt2), p2) )
                  (g1, f_ty_opt) restPats
              in
              match uu____3610 with (g2, f_ty_opt1), restMLPats ->
                let uu____4058 =
                  let uu____4069 =
                    FStar_All.pipe_right
                      (FStar_List.append tyMLPats restMLPats)
                      (FStar_List.collect (fun uu___62_4120 ->
                           match uu___62_4120 with
                           | FStar_Pervasives_Native.Some x -> [x]
                           | uu____4162 -> [] ))
                  in
                  FStar_All.pipe_right uu____4069 FStar_List.split
                in
                match uu____4058 with mlPats, when_clauses ->
                  let pat_ty_compat =
                    match f_ty_opt1 with
                    | FStar_Pervasives_Native.Some ([], t) -> ok t
                    | uu____4235 -> false
                  in
                  let uu____4244 =
                    let uu____4253 =
                      let uu____4260 =
                        resugar_pat f.FStar_Syntax_Syntax.fv_qual
                          (FStar_Extraction_ML_Syntax.MLP_CTor (d, mlPats))
                      in
                      let uu____4263 =
                        FStar_All.pipe_right when_clauses FStar_List.flatten
                      in
                      (uu____4260, uu____4263)
                    in
...
let extract_pat
    : FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.pat
      -> FStar_Extraction_ML_Syntax.mlty
      -> (FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.term
          -> ( FStar_Extraction_ML_Syntax.mlexpr
             , FStar_Extraction_ML_Syntax.e_tag
      ...
      -> ( FStar_Extraction_ML_UEnv.env
         ...
         , Prims.bool )
         FStar_Pervasives_Native.tuple3 =
  fun g p expected_t term_as_mlexpr ->
    let extract_one_pat1 g1 p1 expected_t1 =
      let uu____4376 =
        extract_one_pat false g1 p1 expected_t1 term_as_mlexpr
      in
      match uu____4376 with
      | g2, FStar_Pervasives_Native.Some (x, v1), b -> (g2, (x, v1), b)
      | uu____4433 -> failwith "Impossible: Unable to translate pattern"
    in
    ...
    in
    match uu____4477 with g1, (p1, whens), b ->
...
let maybe_eta_data_and_project_record
    : FStar_Extraction_ML_UEnv.env
      ...
      -> FStar_Extraction_ML_Syntax.mlty -> FStar_Extraction_ML_Syntax.mlexpr
      -> FStar_Extraction_ML_Syntax.mlexpr =
  fun g qual residualType mlAppExpr ->
    ...
    let as_record qual1 e =
      ...
      | ( FStar_Extraction_ML_Syntax.MLE_CTor (uu____4703, args)
        , FStar_Pervasives_Native.Some
    ...
    let resugar_and_maybe_eta qual1 e =
      ...
      match uu____4753 with eargs, tres ->
        match eargs with
        | [] ->
        ...
        | uu____4807 ->
            ...
            match uu____4818 with binders, eargs1 ->
              match e.FStar_Extraction_ML_Syntax.expr with
                      ...
                      let uu____4861 =
                        FStar_All.pipe_left
                          ...
                          (FStar_Extraction_ML_Syntax.MLE_CTor
                             (head1, FStar_List.append args eargs1))
                      in
                      FStar_All.pipe_left (as_record qual1) uu____4861
                    in
                    FStar_All.pipe_left FStar_Extraction_ML_Util.resugar_exp
                      uu____4860
                  in
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       e.FStar_Extraction_ML_Syntax.mlty)
                    (FStar_Extraction_ML_Syntax.MLE_Fun (binders, body))
              | uu____4870 -> failwith "Impossible: Not a constructor"
    in
    ...
    | ( FStar_Extraction_ML_Syntax.MLE_App
          ( { FStar_Extraction_ML_Syntax.expr=
            ...
            ; FStar_Extraction_ML_Syntax.loc= uu____4878; _ }
          , mle :: args )
      , FStar_Pervasives_Native.Some
          ...
          ( { FStar_Extraction_ML_Syntax.expr=
                FStar_Extraction_ML_Syntax.MLE_TApp
                  ( { FStar_Extraction_ML_Syntax.expr=
                    ...
                    ; FStar_Extraction_ML_Syntax.loc= uu____4920; _ }
                  , uu____4921 )
            ; FStar_Extraction_ML_Syntax.mlty= uu____4922
            ; FStar_Extraction_ML_Syntax.loc= uu____4923; _ }
          , mle :: args )
      , FStar_Pervasives_Native.Some
          FStar_Syntax_Syntax.Record_projector (constrname, f) ) ->
        let f1 =
    ...
    | ( FStar_Extraction_ML_Syntax.MLE_App
          ( { FStar_Extraction_ML_Syntax.expr=
            ...
            ; FStar_Extraction_ML_Syntax.loc= uu____4969; _ }
          , mlargs )
    ...
    | ( FStar_Extraction_ML_Syntax.MLE_App
          ( { FStar_Extraction_ML_Syntax.expr=
            ...
            ; FStar_Extraction_ML_Syntax.loc= uu____4982; _ }
          , mlargs )
      , FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Record_ctor uu____4984
      ) ->
        let uu____4997 =
          FStar_All.pipe_left
            (FStar_Extraction_ML_Syntax.with_ty
          ...
          ( { FStar_Extraction_ML_Syntax.expr=
                FStar_Extraction_ML_Syntax.MLE_TApp
                  ( { FStar_Extraction_ML_Syntax.expr=
                    ...
                    ; FStar_Extraction_ML_Syntax.loc= uu____5002; _ }
                  , uu____5003 )
          ...
          ( { FStar_Extraction_ML_Syntax.expr=
                FStar_Extraction_ML_Syntax.MLE_TApp
                  ( { FStar_Extraction_ML_Syntax.expr=
                    ...
                    ; FStar_Extraction_ML_Syntax.loc= uu____5022; _ }
                  , uu____5023 )
            ; FStar_Extraction_ML_Syntax.mlty= uu____5024
            ; FStar_Extraction_ML_Syntax.loc= uu____5025; _ }
          , mlargs )
      , FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Record_ctor uu____5027
      ) ->
        let uu____5044 =
          FStar_All.pipe_left
            (FStar_Extraction_ML_Syntax.with_ty
    ...
    | ( FStar_Extraction_ML_Syntax.MLE_Name mlp
      , FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Record_ctor uu____5054
      ) ->
        let uu____5063 =
          FStar_All.pipe_left
            (FStar_Extraction_ML_Syntax.with_ty
    ...
    | ( FStar_Extraction_ML_Syntax.MLE_TApp
          ...
          , uu____5082 )
      , FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Record_ctor uu____5083
      ) ->
        let uu____5096 =
          FStar_All.pipe_left
            (FStar_Extraction_ML_Syntax.with_ty
...
let rec term_as_mlexpr
  ...
  fun g t ->
    ...
    match uu____5180 with e, tag, ty ->
      let tag1 = maybe_downgrade_eff g tag ty in
      FStar_Extraction_ML_UEnv.debug g (fun u ->
          let uu____5201 =
...
and check_term_as_mlexpr
    : FStar_Extraction_ML_UEnv.env -> FStar_Syntax_Syntax.term
      -> FStar_Extraction_ML_Syntax.e_tag -> FStar_Extraction_ML_Syntax.mlty
      -> ( FStar_Extraction_ML_Syntax.mlexpr
         , FStar_Extraction_ML_Syntax.mlty )
         FStar_Pervasives_Native.tuple2 =
  fun g t f ty ->
    let uu____5213 = check_term_as_mlexpr' g t f ty in
    match uu____5213 with e, t1 ->
...
and check_term_as_mlexpr'
  ...
  fun g e0 f ty ->
    ...
    match uu____5246 with e, tag, t ->
      let tag1 = maybe_downgrade_eff g tag t in
      if FStar_Extraction_ML_Util.eff_leq tag1 f then
        let uu____5265 = maybe_coerce g e t ty in
        (uu____5265, ty)
...
and term_as_mlexpr'
  ...
  fun g top ->
    ...
    | FStar_Syntax_Syntax.Tm_meta
        ( t1
        , FStar_Syntax_Syntax.Meta_desugared FStar_Syntax_Syntax.Mutable_alloc
        ) ->
        FStar_Errors.raise_err
          (FStar_Errors.Error_NoLetMutable, "let-mutable no longer supported")
    | FStar_Syntax_Syntax.Tm_meta
      ...
      -> (
        ...
        | FStar_Syntax_Syntax.Tm_let ((false, [lb]), body)
          when FStar_Util.is_left lb.FStar_Syntax_Syntax.lbname
          -> (
            let uu____5433 =
              let uu____5440 =
                FStar_TypeChecker_Env.effect_decl_opt
              ...
              in
              FStar_Util.must uu____5440
            in
            match uu____5433 with ed, qualifiers ->
              let uu____5467 =
                let uu____5468 =
                  FStar_All.pipe_right qualifiers
                    (FStar_List.contains FStar_Syntax_Syntax.Reifiable)
                in
                FStar_All.pipe_right uu____5468 Prims.op_Negation
              in
              if uu____5467 then term_as_mlexpr' g t2
              else
                failwith
    ...
    | FStar_Syntax_Syntax.Tm_constant c -> (
        ...
        in
        match uu____5498 with uu____5511, ty, uu____5513 ->
          ...
          let uu____5515 =
            ...
            in
            FStar_Extraction_ML_Syntax.with_ty ml_ty uu____5516
          in
    ...
    | FStar_Syntax_Syntax.Tm_name uu____5517 -> (
        ...
        if uu____5518 then
          ...
          | FStar_Util.Inr (uu____5577, x, mltys, uu____5580), qual ->
            ...
            | [], t1 ->
                let uu____5626 =
                  maybe_eta_data_and_project_record g qual t1 x
                in
    ...
    | FStar_Syntax_Syntax.Tm_abs (bs, body, copt) -> (
        ...
        match uu____5774 with bs1, body1 ->
          let uu____5787 = binders_as_ml_binders g bs1 in
          match uu____5787 with ml_bs, env ->
            let body2 =
              match copt with
              ...
              | FStar_Pervasives_Native.None ->
                  FStar_Extraction_ML_UEnv.debug g (fun uu____5825 ->
                      let uu____5826 =
                        FStar_Syntax_Print.term_to_string body1
                      in
                      FStar_Util.print1 "No computation type for: %s\n"
                        uu____5826 ) ;
                  body1
            in
            let uu____5827 = term_as_mlexpr env body2 in
            match uu____5827 with ml_body, f, t1 ->
              let uu____5843 =
                FStar_List.fold_right
                  (fun uu____5862 uu____5863 ->
                    match (uu____5862, uu____5863)
                    with (uu____5884, targ), (f1, t2) ->
                      ( FStar_Extraction_ML_Syntax.E_PURE
                      , FStar_Extraction_ML_Syntax.MLTY_Fun (targ, f1, t2) ) )
                  ml_bs (f, t1)
              in
              match uu____5843 with f1, tfun ->
                let uu____5904 =
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty tfun)
                    (FStar_Extraction_ML_Syntax.MLE_Fun (ml_bs, ml_body))
                in
                (uu____5904, f1, tfun) )
    | FStar_Syntax_Syntax.Tm_app
        ( { FStar_Syntax_Syntax.n=
          ...
          ; FStar_Syntax_Syntax.vars= uu____5912; _ }
        , [(a1, uu____5914)] ) ->
        let ty =
          let uu____5944 =
            FStar_Syntax_Syntax.tabbrev FStar_Parser_Const.range_lid
          in
          term_as_mlty g uu____5944
        in
        let uu____5945 =
          let uu____5946 =
            FStar_Extraction_ML_Util.mlexpr_of_range a1.FStar_Syntax_Syntax.pos
          in
          FStar_All.pipe_left
            (FStar_Extraction_ML_Syntax.with_ty ty)
            uu____5946
    ...
    | FStar_Syntax_Syntax.Tm_app
        ( { FStar_Syntax_Syntax.n=
          ...
          ; FStar_Syntax_Syntax.vars= uu____5948; _ }
        , [(t1, uu____5950); (r, uu____5952)] ) ->
        term_as_mlexpr' g t1
    | FStar_Syntax_Syntax.Tm_app
        ( { FStar_Syntax_Syntax.n=
          ...
          ; FStar_Syntax_Syntax.vars= uu____5993; _ }
        , uu____5994 ) ->
    ...
    | FStar_Syntax_Syntax.Tm_app (head1, [uu____6022; (v1, uu____6024)])
      when FStar_Syntax_Util.is_fstar_tactics_embed head1 && false ->
        let uu____6065 =
          ...
          FStar_Util.format2 "Trying to extract a quotation of %s" uu____6068
        in
        let s =
          let uu____6070 =
            let uu____6071 =
              let uu____6072 =
                ...
                FStar_Util.bytes_of_string uu____6075
              in
              FStar_Extraction_ML_Syntax.MLC_Bytes uu____6072
            in
            FStar_Extraction_ML_Syntax.MLE_Const uu____6071
          in
          FStar_Extraction_ML_Syntax.with_ty
        ...
        let marshal_from_string =
          ...
          FStar_Extraction_ML_Syntax.with_ty string_to_term_ty
            (FStar_Extraction_ML_Syntax.MLE_Name (["Marshal"], "from_string"))
        in
        let uu____6095 =
          FStar_All.pipe_left
            (FStar_Extraction_ML_Syntax.with_ty term_ty)
            (FStar_Extraction_ML_Syntax.MLE_App
               (marshal_from_string, [s; zero1]))
        in
        (uu____6095, FStar_Extraction_ML_Syntax.E_PURE, term_ty)
    | FStar_Syntax_Syntax.Tm_app (head1, uu____6099)
      when ( FStar_Syntax_Util.is_fstar_tactics_embed head1
           ...
           let uu____6127 =
             let uu____6128 =
               let uu____6129 =
                 FStar_All.pipe_right g.FStar_Extraction_ML_UEnv.currentModule
                   FStar_Extraction_ML_Syntax.string_of_mlpath
               in
               FStar_All.pipe_right uu____6129 FStar_Ident.lid_of_str
             in
             FStar_Syntax_Util.is_builtin_tactic uu____6128
           in
    ...
    | FStar_Syntax_Syntax.Tm_app (head1, args) -> (
        let is_total rc =
          ...
          || FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
               (FStar_List.existsb (fun uu___63_6165 ->
        ...
        let uu____6167 =
          ...
          in
          (head1.FStar_Syntax_Syntax.n, uu____6172)
        in
        ...
        | ( uu____6201
          , FStar_Syntax_Syntax.Tm_abs
              (bs, uu____6203, FStar_Pervasives_Native.Some rc) )
          when is_total rc ->
            let t1 =
              FStar_TypeChecker_Normalize.normalize
                [ FStar_TypeChecker_Normalize.Beta
            ...
            in
            term_as_mlexpr' g t1
        | uu____6224, FStar_Syntax_Syntax.Tm_constant FStar_Const.Const_reify ->
            let e =
            ...
            let tm =
              ...
              in
              uu____6236 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos
            in
            term_as_mlexpr' g tm
        | uu____6247 ->
            let rec extract_app is_data uu____6292 uu____6293 restArgs =
              match (uu____6292, uu____6293)
              with (mlhead, mlargs_f), (f, t1) ->
                match (restArgs, t1) with
                | [], uu____6383 -> (
                    let evaluation_order_guaranteed =
                      ( FStar_List.length mlargs_f = Prims.parse_int "1"
                    ...
                    in
                    let uu____6406 =
                      if evaluation_order_guaranteed then
                        let uu____6431 =
                        ...
                        FStar_List.fold_left
                          (fun uu____6485 uu____6486 ->
                            match (uu____6485, uu____6486)
                            with (lbs, out_args), (arg, f1) ->
                              if f1 = FStar_Extraction_ML_Syntax.E_PURE
                                 || f1 = FStar_Extraction_ML_Syntax.E_GHOST
                          ...
                          ([], []) mlargs_f
                    in
                    match uu____6406 with lbs, mlargs ->
                      let app =
                        let uu____6642 =
                          FStar_All.pipe_left
                            (FStar_Extraction_ML_Syntax.with_ty t1)
                            (FStar_Extraction_ML_Syntax.MLE_App (mlhead, mlargs))
                        in
                        FStar_All.pipe_left
                      ...
                      let l_app =
                        FStar_List.fold_right
                          (fun uu____6654 out ->
                            match uu____6654 with x, arg ->
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                                   out.FStar_Extraction_ML_Syntax.mlty)
                                (mk_MLE_Let false
                                   ( FStar_Extraction_ML_Syntax.NonRec
                                   , [ { FStar_Extraction_ML_Syntax.mllb_name= x
                      ...
                      (l_app, f, t1) )
                | ( (arg, uu____6673) :: rest
                  , FStar_Extraction_ML_Syntax.MLTY_Fun (formal_t, f', t2) )
                  when is_type g arg
                       && type_leq g formal_t
                            FStar_Extraction_ML_Syntax.ml_unit_ty ->
                    let uu____6704 =
                ...
                | ( (e0, uu____6721) :: rest
                  , FStar_Extraction_ML_Syntax.MLTY_Fun (tExpected, f', t2) )
                  -> (
                    let r = e0.FStar_Syntax_Syntax.pos in
                    let uu____6753 = term_as_mlexpr g e0 in
                    match uu____6753 with e01, f0, tInferred ->
                      let e02 = maybe_coerce g e01 tInferred tExpected in
                      let uu____6770 =
                        let uu____6775 =
                          FStar_Extraction_ML_Util.join_l r [f; f'; f0]
                        in
                        (uu____6775, t2)
                      in
                      extract_app is_data (mlhead, (e02, f0) :: mlargs_f)
                        uu____6770 rest )
                | uu____6786 ->
                    let uu____6799 =
                      FStar_Extraction_ML_Util.udelta_unfold g t1
                    in
            ...
            in
            let extract_app_maybe_projector is_data mlhead uu____6856 args1 =
              match uu____6856 with f, t1 ->
                match is_data with
                | FStar_Pervasives_Native.Some
                    FStar_Syntax_Syntax.Record_projector uu____6888
                  -> (
                    let rec remove_implicits args2 f1 t2 =
                      match (args2, t2) with
                      | ( ( a0
                          , FStar_Pervasives_Native.Some
                              FStar_Syntax_Syntax.Implicit uu____6966 )
                          :: args3
                        , FStar_Extraction_ML_Syntax.MLTY_Fun
                            (uu____6968, f', t3) ) ->
                          let uu____7005 =
                      ...
                      | uu____7006 -> (args2, f1, t2)
                    in
                    let uu____7031 = remove_implicits args1 f t1 in
                    match uu____7031 with args2, f1, t2 ->
                      extract_app is_data (mlhead, []) (f1, t2) args2 )
                | uu____7087 -> extract_app is_data (mlhead, []) (f, t1) args1
            in
            ...
            if uu____7100 then
              ...
              | FStar_Syntax_Syntax.Tm_fvar fv
                when FStar_Syntax_Syntax.fv_eq_lid fv
                     ...
                     let uu____7117 =
                       ...
                       in
                       uu____7118 = "FStar.Tactics.Builtins"
                     in
                     Prims.op_Negation uu____7117 -> (
                match args with
                | [a; b] -> term_as_mlexpr g (FStar_Pervasives_Native.fst a)
                | uu____7159 ->
                    let uu____7168 = FStar_Syntax_Print.args_to_string args in
                    failwith uu____7168 )
              | FStar_Syntax_Syntax.Tm_name uu____7175 -> (
                  let uu____7176 =
                    let uu____7189 =
                      FStar_Extraction_ML_UEnv.lookup_term g head2
                    in
                    match uu____7189 with
                    | FStar_Util.Inr (uu____7208, x1, x2, x3), q ->
                        ((x1, x2, x3), q)
                    | uu____7253 -> failwith "FIXME Ty"
                  in
                  match uu____7176
                  with (head_ml, (vars, t1), inst_ok), qual ->
                    let has_typ_apps =
                      match args with
                    ...
                    let uu____7332 =
                      ...
                      | uu____7361 :: uu____7362
                        when Prims.op_Negation has_typ_apps && inst_ok ->
                          (head_ml, t1, args)
                      | uu____7373 ->
                          let n1 = FStar_List.length vars in
                          if n1 <= FStar_List.length args then
                            let uu____7401 = FStar_Util.first_N n1 args in
                            match uu____7401 with prefix1, rest ->
                              let prefixAsMLTypes =
                                FStar_List.map
                                  (fun uu____7490 ->
                                    match uu____7490 with x, uu____7496 ->
                                      term_as_mlty g x )
                                  prefix1
                              in
                              let t2 =
                                instantiate (vars, t1) prefixAsMLTypes
                              in
                              ...
                              let head3 =
                                match
                                  head_ml.FStar_Extraction_ML_Syntax.expr
                                with
                                | FStar_Extraction_ML_Syntax.MLE_Name
                                    uu____7516 ->
                                    let uu___68_7517 =
                                      mk_tapp head_ml prefixAsMLTypes
                                    in
                                    { FStar_Extraction_ML_Syntax.expr=
                                        uu___68_7517
                                          .FStar_Extraction_ML_Syntax.expr
                                    ; FStar_Extraction_ML_Syntax.mlty= t2
                                    ; FStar_Extraction_ML_Syntax.loc=
                                        uu___68_7517
                                          .FStar_Extraction_ML_Syntax.loc }
                                | FStar_Extraction_ML_Syntax.MLE_Var uu____7518 ->
                                    let uu___68_7519 =
                                      mk_tapp head_ml prefixAsMLTypes
                                    in
                                    { FStar_Extraction_ML_Syntax.expr=
                    ...
                    in
                    match uu____7332 with head_ml1, head_t, args1 ->
                      match args1 with
                      | [] ->
                          let uu____7590 =
                            maybe_eta_data_and_project_record g qual head_t
                              head_ml1
                          in
                          ( uu____7590
                          , FStar_Extraction_ML_Syntax.E_PURE
                      ...
                      | uu____7591 ->
                          extract_app_maybe_projector qual head_ml1
                            (FStar_Extraction_ML_Syntax.E_PURE, head_t) args1 )
              | FStar_Syntax_Syntax.Tm_fvar uu____7600 -> (
                  ...
                  with (head_ml, (vars, t1), inst_ok), qual ->
                    ...
                    let uu____7757 =
                      match vars with
                      | uu____7786 :: uu____7787
                        when Prims.op_Negation has_typ_apps && inst_ok ->
                          (head_ml, t1, args)
                      | uu____7798 ->
                          let n1 = FStar_List.length vars in
                          if n1 <= FStar_List.length args then
                            let uu____7826 = FStar_Util.first_N n1 args in
                            match uu____7826 with prefix1, rest ->
                              let prefixAsMLTypes =
                                FStar_List.map
                                  (fun uu____7915 ->
                                    match uu____7915 with x, uu____7921 ->
                                      term_as_mlty g x )
                                  prefix1
                              in
                              let t2 =
                              ...
                              let head3 =
                                ...
                                | FStar_Extraction_ML_Syntax.MLE_Name
                                    ...
                                    ; FStar_Extraction_ML_Syntax.loc=
                                        uu___68_7942
                                          .FStar_Extraction_ML_Syntax.loc }
                                | FStar_Extraction_ML_Syntax.MLE_Var uu____7943 ->
                                    let uu___68_7944 =
                                      mk_tapp head_ml prefixAsMLTypes
                                    in
                                    { FStar_Extraction_ML_Syntax.expr=
                    ...
                    in
                    match uu____7757 with head_ml1, head_t, args1 ->
                      match args1 with
                      | [] ->
                          let uu____8015 =
                            maybe_eta_data_and_project_record g qual head_t
              ...
              | uu____8025 ->
                  ...
                  match uu____8026 with head3, f, t1 ->
                    extract_app_maybe_projector FStar_Pervasives_Native.None
                      head3 (f, t1) args )
    | FStar_Syntax_Syntax.Tm_ascribed (e0, (tc, uu____8044), f) -> (
        ...
        let f1 =
          ...
          | FStar_Pervasives_Native.Some l -> effect_as_etag g l
        in
    ...
    | FStar_Syntax_Syntax.Tm_let ((is_rec, lbs), e') -> (
        ...
        let uu____8142 =
          if is_rec then FStar_Syntax_Subst.open_let_rec lbs e'
          else
            let uu____8156 = FStar_Syntax_Syntax.is_top_level lbs in
            if uu____8156 then (lbs, e')
            else
              ...
              let x =
                ...
                in
                FStar_Syntax_Syntax.freshen_bv uu____8170
              in
              let lb1 =
                let uu___70_8172 = lb in
                { FStar_Syntax_Syntax.lbname= FStar_Util.Inl x
                ; FStar_Syntax_Syntax.lbunivs=
                    uu___70_8172.FStar_Syntax_Syntax.lbunivs
                ; FStar_Syntax_Syntax.lbtyp=
                    uu___70_8172.FStar_Syntax_Syntax.lbtyp
                ; FStar_Syntax_Syntax.lbeff=
                    uu___70_8172.FStar_Syntax_Syntax.lbeff
              ...
              ([lb1], e'1)
        in
        match uu____8142 with lbs1, e'1 ->
          let lbs2 =
            if top_level then
              FStar_All.pipe_right lbs1
                (FStar_List.map (fun lb ->
                     ...
                     in
                     FStar_Extraction_ML_UEnv.debug g (fun uu____8211 ->
                     ...
                     let lbdef =
                       ...
                       if uu____8215 then lb.FStar_Syntax_Syntax.lbdef
                       else
                         FStar_TypeChecker_Normalize.normalize
                           [ FStar_TypeChecker_Normalize.AllowUnboundUniverses
                           ; FStar_TypeChecker_Normalize.EraseUniverses
                     ...
                     ; FStar_Syntax_Syntax.lbunivs=
                         uu___71_8219.FStar_Syntax_Syntax.lbunivs
                     ; FStar_Syntax_Syntax.lbtyp=
                         uu___71_8219.FStar_Syntax_Syntax.lbtyp
                     ; FStar_Syntax_Syntax.lbeff=
                         uu___71_8219.FStar_Syntax_Syntax.lbeff
                     ; FStar_Syntax_Syntax.lbdef
                     ; FStar_Syntax_Syntax.lbattrs=
          ...
          let maybe_generalize uu____8242 =
            ...
            ->
              ...
              in
              if Prims.op_Negation top_level then no_gen ()
              else
                match t2.FStar_Syntax_Syntax.n with
                | FStar_Syntax_Syntax.Tm_arrow (bs, c)
                  when let uu____8457 = FStar_List.hd bs in
                       FStar_All.pipe_right uu____8457 (is_type_binder g)
                  -> (
                    let uu____8470 = FStar_Syntax_Subst.open_comp bs c in
                    match uu____8470 with bs1, c1 ->
                      let uu____8495 =
                        let uu____8502 =
                          FStar_Util.prefix_until
                            (fun x ->
                              let uu____8538 = is_type_binder g x in
                              Prims.op_Negation uu____8538 )
                            bs1
                        in
                        ...
                        | FStar_Pervasives_Native.Some (bs2, b, rest) ->
                            let uu____8626 =
                              FStar_Syntax_Util.arrow (b :: rest) c1
                            in
                            (bs2, uu____8626)
                      in
                      match uu____8495 with tbinders, tbody ->
                        ...
                        | FStar_Syntax_Syntax.Tm_abs (bs2, body, copt) -> (
                            ...
                            in
                            match uu____8713 with bs3, body1 ->
                              if n_tbinders <= FStar_List.length bs3 then
                                let uu____8766 =
                                  FStar_Util.first_N n_tbinders bs3
                                in
                                match uu____8766 with targs, rest_args ->
                                  let expected_source_ty =
                                    let s =
                                      FStar_List.map2
                                        (fun uu____8854 uu____8855 ->
                                          match (uu____8854, uu____8855)
                                          with
                                          | (x, uu____8873), (y, uu____8875)
                                          ->
                                            let uu____8884 =
                                              let uu____8891 =
                                              ...
                                              (x, uu____8891)
                                            in
                                            FStar_Syntax_Syntax.NT uu____8884
                                          )
                                        tbinders targs
                                    in
                                    FStar_Syntax_Subst.subst s tbody
                                  in
                                  let env =
                                    FStar_List.fold_left
                                      (fun env uu____8902 ->
                                        ...
                                        with a, uu____8908 ->
                                          FStar_Extraction_ML_UEnv.extend_ty
                                            env a FStar_Pervasives_Native.None
                                        )
                                      g targs
                                  in
                                  let expected_t =
                                    term_as_mlty env expected_source_ty
                                  in
                                  let polytype =
                                    let uu____8917 =
                                      FStar_All.pipe_right targs
                                        (FStar_List.map (fun uu____8935 ->
                                             match uu____8935
                                             with x, uu____8941 ->
                                               FStar_Extraction_ML_UEnv.
                                               bv_as_ml_tyvar x ))
                                    in
                                    (uu____8917, expected_t)
                                  in
                                  let add_unit =
                                  ...
                                  in
                                  let rest_args1 =
                                    if add_unit then unit_binder :: rest_args
                                    else rest_args
                                  in
                                  let polytype1 =
                                    if add_unit then
                        ...
                        | FStar_Syntax_Syntax.Tm_uinst uu____9019 ->
                            let env =
                              FStar_List.fold_left
                                (fun env uu____9036 ->
                                  match uu____9036 with a, uu____9042 ->
                            ...
                            let polytype =
                              let uu____9051 =
                                FStar_All.pipe_right tbinders
                                  (FStar_List.map (fun uu____9063 ->
                                       match uu____9063 with x, uu____9069 ->
                                         FStar_Extraction_ML_UEnv.
                                         bv_as_ml_tyvar x ))
                              in
                              (uu____9051, expected_t)
                            in
                            let args =
                              FStar_All.pipe_right tbinders
                                (FStar_List.map (fun uu____9085 ->
                                     match uu____9085 with bv, uu____9091 ->
                                       let uu____9092 =
                                         FStar_Syntax_Syntax.bv_to_name bv
                                       in
                                       FStar_All.pipe_right uu____9092
                                         FStar_Syntax_Syntax.as_arg ))
                            in
                            let e2 =
                              FStar_Syntax_Syntax.mk
                                (FStar_Syntax_Syntax.Tm_app (e1, args))
                                FStar_Pervasives_Native.None
                            ...
                            , false
                            , e2 )
                        | FStar_Syntax_Syntax.Tm_fvar uu____9134 ->
                            let env =
                              FStar_List.fold_left
                                (fun env uu____9145 ->
                                  match uu____9145 with a, uu____9151 ->
                                    FStar_Extraction_ML_UEnv.extend_ty env a
                                      FStar_Pervasives_Native.None )
                                g tbinders
                            in
                            ...
                            let polytype =
                              let uu____9160 =
                                FStar_All.pipe_right tbinders
                                  (FStar_List.map (fun uu____9172 ->
                                       match uu____9172 with x, uu____9178 ->
                                         FStar_Extraction_ML_UEnv.
                                         bv_as_ml_tyvar x ))
                              in
                              (uu____9160, expected_t)
                            in
                            let args =
                              FStar_All.pipe_right tbinders
                                (FStar_List.map (fun uu____9194 ->
                                     match uu____9194 with bv, uu____9200 ->
                                       let uu____9201 =
                                         FStar_Syntax_Syntax.bv_to_name bv
                                       in
                                       FStar_All.pipe_right uu____9201
                                         FStar_Syntax_Syntax.as_arg ))
                            in
                            let e2 =
                              FStar_Syntax_Syntax.mk
                            ...
                            , false
                            , e2 )
                        | FStar_Syntax_Syntax.Tm_name uu____9243 ->
                            let env =
                              FStar_List.fold_left
                                (fun env uu____9254 ->
                                  match uu____9254 with a, uu____9260 ->
                                    FStar_Extraction_ML_UEnv.extend_ty env a
                                      FStar_Pervasives_Native.None )
                                g tbinders
                            in
                            ...
                            let polytype =
                              let uu____9269 =
                                FStar_All.pipe_right tbinders
                                  (FStar_List.map (fun uu____9281 ->
                                       match uu____9281 with x, uu____9287 ->
                                         FStar_Extraction_ML_UEnv.
                                         bv_as_ml_tyvar x ))
                              in
                              (uu____9269, expected_t)
                            in
                            let args =
                              FStar_All.pipe_right tbinders
                                (FStar_List.map (fun uu____9303 ->
                                     match uu____9303 with bv, uu____9309 ->
                                       let uu____9310 =
                                         FStar_Syntax_Syntax.bv_to_name bv
                                       in
                                       FStar_All.pipe_right uu____9310
                                         FStar_Syntax_Syntax.as_arg ))
                            in
                            let e2 =
                              FStar_Syntax_Syntax.mk
                            ...
                            , false
                            , e2 )
                        | uu____9352 -> err_value_restriction e1 )
                | uu____9371 -> no_gen ()
          in
          let check_lb env uu____9414 =
            match uu____9414
            with nm, (lbname, f, (t1, (targs, polytype)), add_unit, e) ->
              let env1 =
                FStar_List.fold_left
                  (fun env1 uu____9549 ->
                    match uu____9549 with a, uu____9555 ->
                      FStar_Extraction_ML_UEnv.extend_ty env1 a
                        FStar_Pervasives_Native.None )
                  env targs
              in
              let expected_t = FStar_Pervasives_Native.snd polytype in
              let uu____9557 = check_term_as_mlexpr env1 e f expected_t in
              match uu____9557 with e1, uu____9567 ->
          ...
          let uu____9634 =
            FStar_List.fold_right
              (fun lb uu____9725 ->
                match uu____9725 with env, lbs4 ->
                  let uu____9850 = lb in
                  match uu____9850
                  with
                  | ( lbname
                    , uu____9898
                    , (t1, (uu____9900, polytype))
                    , add_unit
                    , uu____9903 )
                  ->
                    let uu____9916 =
                      FStar_Extraction_ML_UEnv.extend_lb env lbname t1 polytype
                        add_unit true
                    in
                    match uu____9916 with env1, nm -> (env1, (nm, lb) :: lbs4)
                )
              lbs3 (g, [])
          in
          match uu____9634 with env_body, lbs4 ->
            let env_def = if is_rec then env_body else g in
            let lbs5 =
              FStar_All.pipe_right lbs4 (FStar_List.map (check_lb env_def))
            in
            let e'_rng = e'1.FStar_Syntax_Syntax.pos in
            let uu____10193 = term_as_mlexpr env_body e'1 in
            match uu____10193 with e'2, f', t' ->
              let f =
                let uu____10210 =
                  let uu____10213 =
                    FStar_List.map FStar_Pervasives_Native.fst lbs5
                  in
                  f' :: uu____10213
                in
                FStar_Extraction_ML_Util.join_l e'_rng uu____10210
              in
              let is_rec1 =
                if is_rec = true then FStar_Extraction_ML_Syntax.Rec
                else FStar_Extraction_ML_Syntax.NonRec
              in
              let uu____10222 =
                let uu____10223 =
                  let uu____10224 =
                    let uu____10225 =
                      FStar_List.map FStar_Pervasives_Native.snd lbs5
                    in
                    (is_rec1, uu____10225)
                  in
                  mk_MLE_Let top_level uu____10224 e'2
                in
                let uu____10234 =
                  FStar_Extraction_ML_Util.mlloc_of_range
                    t.FStar_Syntax_Syntax.pos
                in
                FStar_Extraction_ML_Syntax.with_ty_loc t' uu____10223
                  uu____10234
              in
              (uu____10222, f, t') )
    | FStar_Syntax_Syntax.Tm_match (scrutinee, pats) ->
        let uu____10273 = term_as_mlexpr g scrutinee in
        match uu____10273 with e, f_e, t_e ->
          let uu____10289 = check_pats_for_ite pats in
          match uu____10289 with b, then_e, else_e ->
            ...
            if b then
              ...
              | ( FStar_Pervasives_Native.Some then_e1
                ...
                -> (
                  ...
                  match uu____10346 with then_mle, f_then, t_then ->
                    let uu____10362 = term_as_mlexpr g else_e1 in
                    match uu____10362 with else_mle, f_else, t_else ->
                      let uu____10378 =
                        let uu____10387 = type_leq g t_then t_else in
                        if uu____10387 then (t_else, no_lift)
                        else
                          let uu____10401 = type_leq g t_else t_then in
                          if uu____10401 then (t_then, no_lift)
                          else
                            ( FStar_Extraction_ML_Syntax.MLTY_Top
                            , FStar_Extraction_ML_Syntax.apply_obj_repr )
                      in
                      match uu____10378 with t_branch, maybe_lift1 ->
                        let uu____10435 =
                          let uu____10436 =
                            let uu____10437 =
                              let uu____10446 = maybe_lift1 then_mle t_then in
                              let uu____10447 =
                                let uu____10450 =
                                  maybe_lift1 else_mle t_else
                                in
                                FStar_Pervasives_Native.Some uu____10450
                              in
                              (e, uu____10446, uu____10447)
                            in
                            FStar_Extraction_ML_Syntax.MLE_If uu____10437
                          in
                          FStar_All.pipe_left
                            (FStar_Extraction_ML_Syntax.with_ty t_branch)
                            uu____10436
                        in
                        let uu____10453 =
                          FStar_Extraction_ML_Util.join
                            then_e1.FStar_Syntax_Syntax.pos f_then f_else
                        in
                        (uu____10435, uu____10453, t_branch) )
              | uu____10454 ->
                  failwith
              ...
              let uu____10470 =
                FStar_All.pipe_right pats
                  (FStar_Util.fold_map
                     (fun compat br ->
                       let uu____10579 = FStar_Syntax_Subst.open_branch br in
                       match uu____10579 with pat, when_opt, branch1 ->
                         let uu____10623 =
                           extract_pat g pat t_e term_as_mlexpr
                         in
                         match uu____10623 with env, p, pat_t_compat ->
                           let uu____10681 =
                             match when_opt with
                             | FStar_Pervasives_Native.None ->
                                 ( FStar_Pervasives_Native.None
                             ...
                             | FStar_Pervasives_Native.Some w ->
                                 let uu____10703 = term_as_mlexpr env w in
                                 match uu____10703 with w1, f_w, t_w ->
                                   let w2 =
                                     maybe_coerce env w1 t_w
                                       FStar_Extraction_ML_Syntax.ml_bool_ty
                                   in
                                   (FStar_Pervasives_Native.Some w2, f_w)
                           in
                           match uu____10681 with when_opt1, f_when ->
                             let uu____10752 = term_as_mlexpr env branch1 in
                             match uu____10752
                             with mlbranch, f_branch, t_branch ->
                               let uu____10786 =
                                 FStar_All.pipe_right p
                                   (FStar_List.map (fun uu____10863 ->
                                        match uu____10863 with p1, wopt ->
                                          let when_clause =
                                            FStar_Extraction_ML_Util.
                                            conjoin_opt wopt when_opt1
                                          in
                                          ( p1
                                          , (when_clause, f_when)
                                          , (mlbranch, f_branch, t_branch) ) ))
                               in
                               (compat && pat_t_compat, uu____10786) )
                     true)
              in
              match uu____10470 with pat_t_compat, mlbranches ->
                let mlbranches1 = FStar_List.flatten mlbranches in
                let e1 =
                  if pat_t_compat then e
                  else (
                    FStar_Extraction_ML_UEnv.debug g (fun uu____11028 ->
                        let uu____11029 =
                          FStar_Extraction_ML_Code.string_of_mlexpr
                            g.FStar_Extraction_ML_UEnv.currentModule e
                        in
                        let uu____11030 =
                          FStar_Extraction_ML_Code.string_of_mlty
                            g.FStar_Extraction_ML_UEnv.currentModule t_e
                        in
                        FStar_Util.print2
                    ...
                    FStar_All.pipe_left
                      ...
                      (FStar_Extraction_ML_Syntax.MLE_Coerce
                         (e, t_e, FStar_Extraction_ML_Syntax.MLTY_Top)) )
                in
                      ...
                      let uu____11064 =
                        let uu____11081 =
                          FStar_Syntax_Syntax.lid_as_fv
                            ...
                            FStar_Pervasives_Native.None
                        in
                        FStar_Extraction_ML_UEnv.lookup_fv g uu____11081
                      in
                      FStar_All.pipe_left FStar_Util.right uu____11064
                    in
                    match uu____11055
                    with uu____11124, fw, uu____11126, uu____11127 ->
                      let uu____11128 =
                        let uu____11129 =
                          let uu____11130 =
                            let uu____11137 =
                            ...
                            (fw, uu____11137)
                          in
                          FStar_Extraction_ML_Syntax.MLE_App uu____11130
                        in
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.ml_unit_ty)
                      ...
                      , FStar_Extraction_ML_Syntax.E_PURE
                      , FStar_Extraction_ML_Syntax.ml_unit_ty ) )
                | (uu____11143, uu____11144, (uu____11145, f_first, t_first))
                  :: rest ->
                    let uu____11205 =
                      FStar_List.fold_left
                        (fun uu____11247 uu____11248 ->
                          match (uu____11247, uu____11248)
                          with
                          | ( (topt, f)
                            , ( uu____11305
                              , uu____11306
                              , (uu____11307, f_branch, t_branch) ) )
                          ->
                            let f1 =
                              FStar_Extraction_ML_Util.join
                                top.FStar_Syntax_Syntax.pos f f_branch
                            in
                            let topt1 =
                              match topt with
                              | FStar_Pervasives_Native.None ->
                              ...
                              | FStar_Pervasives_Native.Some t1 ->
                                  let uu____11363 = type_leq g t1 t_branch in
                                  if uu____11363 then
                                    FStar_Pervasives_Native.Some t_branch
                                  else
                                    let uu____11367 = type_leq g t_branch t1 in
                                    if uu____11367 then
                                      FStar_Pervasives_Native.Some t1
                                    else FStar_Pervasives_Native.None
                            in
                            (topt1, f1) )
                        (FStar_Pervasives_Native.Some t_first, f_first) rest
                    in
                    match uu____11205 with topt, f_match ->
                      let mlbranches2 =
                        FStar_All.pipe_right mlbranches1
                          (FStar_List.map (fun uu____11462 ->
                               match uu____11462
                               with
                               | p, (wopt, uu____11491), (b1, uu____11493, t1)
                               ->
                                 let b2 =
                                   match topt with
                                   | FStar_Pervasives_Native.None ->
                                       FStar_Extraction_ML_Syntax.
                                       apply_obj_repr b1 t1
                      ...
                      let uu____11517 =
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty t_match)
...
let ind_discriminator_body
    : FStar_Extraction_ML_UEnv.env -> FStar_Ident.lident -> FStar_Ident.lident
      -> FStar_Extraction_ML_Syntax.mlmodule1 =
  fun env discName constrName ->
    let uu____11537 =
      let uu____11542 =
        FStar_TypeChecker_Env.lookup_lid env.FStar_Extraction_ML_UEnv.tcenv
          discName
      in
      FStar_All.pipe_left FStar_Pervasives_Native.fst uu____11542
    in
    match uu____11537 with uu____11567, fstar_disc_type ->
      let wildcards =
        let uu____11576 =
          let uu____11577 = FStar_Syntax_Subst.compress fstar_disc_type in
          uu____11577.FStar_Syntax_Syntax.n
        in
        match uu____11576 with
        | FStar_Syntax_Syntax.Tm_arrow (binders, uu____11587) ->
            let uu____11604 =
              FStar_All.pipe_right binders
                (FStar_List.filter (fun uu___64_11636 ->
                     match uu___64_11636 with
                     | ( uu____11643
                       , FStar_Pervasives_Native.Some
            ...
            FStar_All.pipe_right uu____11604
              (FStar_List.map (fun uu____11680 ->
      ...
      let discrBody =
        let uu____11699 =
                ...
                let uu____11713 =
                  ...
                  let uu____11731 =
                    let uu____11742 =
                        ...
                        let uu____11752 =
                          let uu____11759 =
                            FStar_Extraction_ML_Syntax.mlpath_of_lident
                              constrName
                          in
                          (uu____11759, [FStar_Extraction_ML_Syntax.MLP_Wild])
                        in
                      ...
                      in
                      (uu____11751, FStar_Pervasives_Native.None, uu____11762)
                    in
                    let uu____11765 =
                      let uu____11776 =
                        let uu____11785 =
                          FStar_All.pipe_left
                            (FStar_Extraction_ML_Syntax.with_ty
                               FStar_Extraction_ML_Syntax.ml_bool_ty)
                            (FStar_Extraction_ML_Syntax.MLE_Const
                               (FStar_Extraction_ML_Syntax.MLC_Bool false))
                        in
                      ...
                      [uu____11776]
                    in
                    uu____11742 :: uu____11765
                  in
                  (uu____11728, uu____11731)
                in
                FStar_Extraction_ML_Syntax.MLE_Match uu____11713
              in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.ml_bool_ty)
          ...
          in
          FStar_Extraction_ML_Syntax.MLE_Fun uu____11700
        in
        FStar_All.pipe_left
      ...
      let uu____11840 =
        let uu____11841 =
          let uu____11844 =
            let uu____11845 =
              FStar_Extraction_ML_UEnv.convIdent discName.FStar_Ident.ident
            in
          ...
          [uu____11844]
        in
        (FStar_Extraction_ML_Syntax.NonRec, uu____11841)
      in
