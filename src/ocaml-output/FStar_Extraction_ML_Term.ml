    ...
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_uvar
          ({ FStar_Syntax_Syntax.ctx_uvar_head = uu____858;
             ...
             FStar_Syntax_Syntax.ctx_uvar_range = uu____864;_},
           s)
          ->
  ...
  fun l ->
    ...
    then def
      ...
      (let uu____1766 = FStar_List.hd l in
       ...
       | (p1, w1, e1) ->
           let uu____1800 =
             let uu____1809 = FStar_List.tl l in FStar_List.hd uu____1809 in
                 ...
                 (fun uu____1965 ->
                    ...
                    | (v1, t1) ->
                        FStar_Extraction_ML_Syntax.with_ty t1
                          (FStar_Extraction_ML_Syntax.MLE_Var v1)) uu____1951 in
             let body =
  ...
  fun g ->
    fun t ->
      ...
      | (ts, r) ->
          let body r1 =
            let r2 =
              let uu____2011 = FStar_Extraction_ML_Util.udelta_unfold g r1 in
      ...
      let uu____2060 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____2062 = FStar_Options.codegen () in
           uu____2062 = (FStar_Pervasives_Native.Some FStar_Options.Kremlin)) in
...
let (comp_no_args :
  ...
  fun c ->
    ...
    | FStar_Syntax_Syntax.Comp ct ->
        ...
        let ct1 =
          let uu___359_2249 = ct in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___359_2249.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___359_2249.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___359_2249.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args = effect_args;
            FStar_Syntax_Syntax.flags =
              (uu___359_2249.FStar_Syntax_Syntax.flags)
          } in
        let c1 =
          let uu___360_2253 = c in
          {
            FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
            FStar_Syntax_Syntax.pos = (uu___360_2253.FStar_Syntax_Syntax.pos);
            FStar_Syntax_Syntax.vars =
              (uu___360_2253.FStar_Syntax_Syntax.vars)
          } in
        c1
      ...
      let aux env t =
        ...
        | FStar_Syntax_Syntax.Tm_bvar uu____2542 ->
            let uu____2543 =
              ...
              FStar_Util.format1 "Impossible: Unexpected term %s" uu____2544 in
            failwith uu____2543
        | FStar_Syntax_Syntax.Tm_delayed uu____2545 ->
            let uu____2568 =
              let uu____2569 = FStar_Syntax_Print.term_to_string t1 in
              FStar_Util.format1 "Impossible: Unexpected term %s" uu____2569 in
            failwith uu____2568
        | FStar_Syntax_Syntax.Tm_unknown ->
            let uu____2570 =
              let uu____2571 = FStar_Syntax_Print.term_to_string t1 in
              FStar_Util.format1 "Impossible: Unexpected term %s" uu____2571 in
            failwith uu____2570
        | FStar_Syntax_Syntax.Tm_lazy i ->
                  ...
                  | (ml_bs, env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____3162, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b in
                         let t =
                ...
                let uu____3517 =
                      ...
                      let uu____3530 =
                        ...
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.ml_int_ty) uu____3531 in
                  ...
                  | FStar_Pervasives_Native.Some sw ->
                      ...
                      (match uu____3553 with
                       | (mlterm, uu____3565, mlty) -> (mlterm, mlty)) in
                (match uu____3517 with
                 | (mlc, ml_ty) ->
                     ...
                     let when_clause =
                       ...
                       FStar_All.pipe_left
                         (FStar_Extraction_ML_Syntax.with_ty
                            FStar_Extraction_ML_Syntax.ml_bool_ty) uu____3585 in
                      ...
                      (uu____3821,
                       {
                         ...
                         FStar_Extraction_ML_Syntax.mlty = uu____3823;
                         FStar_Extraction_ML_Syntax.loc = uu____3824;_},
                       ttys, uu____3826)
                      -> (n1, ttys)
            ...
            | hd1::tl1 ->
                let uu____5082 =
                  FStar_List.fold_left FStar_Extraction_ML_Util.conjoin hd1
                    tl1 in
                FStar_Pervasives_Native.Some uu____5082 in
          let uu____5083 =
        ...
        fun mlAppExpr ->
          let rec eta_args more_args t =
            ...
            | uu____5293 ->
                ...
                failwith uu____5294 in
          let as_record qual1 e =
            match ((e.FStar_Extraction_ML_Syntax.expr), qual1) with
            | (FStar_Extraction_ML_Syntax.MLE_CTor (uu____5328, args),
              ...
              let e =
                ...
                | uu____5528 ->
                    let uu____5531 =
                      ...
                      (uu____5538, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____5531 in
              FStar_Extraction_ML_Syntax.with_ty
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____5543;_},
                   uu____5544);
                FStar_Extraction_ML_Syntax.mlty = uu____5545;
                FStar_Extraction_ML_Syntax.loc = uu____5546;_},
              mle::args),
             FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_projector (constrname, f))) ->
              let f1 =
                      ...
                      let uu____5581 =
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top) proj in
                      (uu____5581, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____5574 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____5586;_},
              mlargs),
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____5619;_},
                   uu____5620);
                FStar_Extraction_ML_Syntax.mlty = uu____5621;
                FStar_Extraction_ML_Syntax.loc = uu____5622;_},
              mlargs),
             FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)) ->
              let uu____5634 =
                FStar_All.pipe_left
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____5639;_},
                   uu____5640);
                FStar_Extraction_ML_Syntax.mlty = uu____5641;
                FStar_Extraction_ML_Syntax.loc = uu____5642;_},
              mlargs),
             FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Record_ctor
             uu____5644)) ->
              let uu____5661 =
          ...
          | (FStar_Extraction_ML_Syntax.MLE_TApp
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____5685;_},
              uu____5686),
             FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)) ->
              let uu____5693 =
                FStar_All.pipe_left
      ...
      (let t = FStar_Syntax_Subst.compress top in
           ...
           (match uu____6032 with
            | (uu____6101, fw, uu____6103, uu____6104) ->
                let uu____6105 =
                  ...
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_int_ty) uu____6106 in
           ...
           (match uu____6134 with
            ...
            | tv ->
                ...
                let t1 =
                  ...
                  FStar_Syntax_Util.mk_app
                    (FStar_Reflection_Data.refl_constant_term
                       FStar_Reflection_Data.fstar_refl_pack_ln) uu____6267 in
                term_as_mlexpr g t1)
       ...
       | FStar_Syntax_Syntax.Tm_fvar fv ->
           ...
           then
             ...
             (let uu____6518 = FStar_Extraction_ML_UEnv.try_lookup_fv g fv in
                       ...
                       | FStar_Pervasives_Native.Some rc ->
                           let uu____6649 =
                             FStar_TypeChecker_Env.is_reifiable_rc
                               env.FStar_Extraction_ML_UEnv.tcenv rc in
                           if uu____6649
                           then
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____6741;_},
            (a1, uu____6743)::[])
           ->
           let ty =
             let uu____6783 =
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____6787;_},
            (t1, uu____6789)::(r, uu____6791)::[])
           -> term_as_mlexpr g t1
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
              ...
              FStar_Syntax_Syntax.vars = uu____6848;_},
            uu____6849)
               ...
               (FStar_Const.Const_reify)) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6976 in
                let tm =
                  let uu____6988 =
                    let uu____6993 = FStar_TypeChecker_Util.remove_reify e in
                       ...
                       | FStar_Pervasives_Native.Some
                           ...
                           let rec remove_implicits args2 f1 t2 =
                             ...
                             | ((a0, FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____7497))::args3,
                                FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____7499, f', t3)) ->
                                 let uu____7536 =
                                   FStar_Extraction_ML_Util.join
                                        ...
                                        let mk_tapp e ty_args =
                                          ...
                                          | uu____8046 ->
                                              let uu___363_8049 = e in
                                              {
                                                ...
                                                FStar_Extraction_ML_Syntax.mlty
                                                  =
                                                  (uu___363_8049.FStar_Extraction_ML_Syntax.mlty);
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___363_8049.FStar_Extraction_ML_Syntax.loc)
                                              } in
                                        let head3 =
                                          ...
                                          | FStar_Extraction_ML_Syntax.MLE_Name
                                                  ...
                                                  prefixAsMLTypes in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___364_8054.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___364_8054.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_Var
                                                  ...
                                                  prefixAsMLTypes in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___364_8056.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___364_8056.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_App
                                              (head3,
                                               {
                                                ...
                                                (FStar_Extraction_ML_Syntax.MLE_App
                                                   ((let uu___365_8065 =
                                                         ...
                                                         prefixAsMLTypes in
                                                     {
                                                       FStar_Extraction_ML_Syntax.expr
                                                         =
                                                         (uu___365_8065.FStar_Extraction_ML_Syntax.expr);
                                                       FStar_Extraction_ML_Syntax.mlty
                                                         =
                                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                            (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                       ...
                                                       FStar_Extraction_ML_Syntax.loc
                                                         =
                                                         (uu___365_8065.FStar_Extraction_ML_Syntax.loc)
                                                     }),
                                                     [FStar_Extraction_ML_Syntax.ml_unit]))
                                                (FStar_Extraction_ML_Syntax.with_ty
                                                   t2)
                                        ...
                                        let mk_tapp e ty_args =
                                          ...
                                          | uu____8535 ->
                                              let uu___363_8538 = e in
                                              {
                                                ...
                                                FStar_Extraction_ML_Syntax.mlty
                                                  =
                                                  (uu___363_8538.FStar_Extraction_ML_Syntax.mlty);
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___363_8538.FStar_Extraction_ML_Syntax.loc)
                                              } in
                                        let head3 =
                                          match head_ml.FStar_Extraction_ML_Syntax.expr
                                          with
                                          | FStar_Extraction_ML_Syntax.MLE_Name
                                                  ...
                                                  prefixAsMLTypes in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___364_8543.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___364_8543.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_Var
                                              uu____8544 ->
                                              let uu___364_8545 =
                                                  ...
                                                  prefixAsMLTypes in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___364_8545.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___364_8545.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_App
                                              (head3,
                                               {
                                                ...
                                                (FStar_Extraction_ML_Syntax.MLE_App
                                                   ((let uu___365_8554 =
                                                         ...
                                                         prefixAsMLTypes in
                                                     {
                                                       FStar_Extraction_ML_Syntax.expr
                                                         =
                                                         (uu___365_8554.FStar_Extraction_ML_Syntax.expr);
                                                       FStar_Extraction_ML_Syntax.mlty
                                                         =
                                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                            (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                       ...
                                                       FStar_Extraction_ML_Syntax.loc
                                                         =
                                                         (uu___365_8554.FStar_Extraction_ML_Syntax.loc)
                                                     }),
                                                     [FStar_Extraction_ML_Syntax.ml_unit]))
                                                (FStar_Extraction_ML_Syntax.with_ty
                                                   t2)
               ...
               (let uu____8791 = FStar_Syntax_Syntax.is_top_level lbs in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs in
                   ...
                   let lb1 =
                     let uu___366_8805 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___366_8805.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___366_8805.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___366_8805.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___366_8805.FStar_Syntax_Syntax.lbdef);
                       FStar_Syntax_Syntax.lbattrs =
                         (uu___366_8805.FStar_Syntax_Syntax.lbattrs);
                       FStar_Syntax_Syntax.lbpos =
                         (uu___366_8805.FStar_Syntax_Syntax.lbpos)
                     } in
                   let e'1 =
                         ...
                         (fun lb ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8836 in
                            let lbdef =
                            ...
                            let uu___367_8848 = lb in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___367_8848.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___367_8848.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp =
                                (uu___367_8848.FStar_Syntax_Syntax.lbtyp);
                              FStar_Syntax_Syntax.lbeff =
                                (uu___367_8848.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef = lbdef;
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___367_8848.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___367_8848.FStar_Syntax_Syntax.lbpos)
                            }))
                  else lbs1 in
                                    ...
                                    let uu____9183 =
                                      FStar_Util.prefix_until
                                        (fun x ->
                                           ...
                                           Prims.op_Negation uu____9229) bs1 in
                       ...
                       fun uu____10700 ->
                         ...
                         | (env, lbs4) ->
                             ...
                             (match uu____10865 with
                              | (lbname, uu____10929,
                                 (t1, (uu____10931, polytype)), add_unit,
                                 uu____10934) ->
                                  let uu____10979 =
                           ...
                           FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____11491 with
                             | (then_mle, f_then, t_then) ->
                                 let uu____11507 = term_as_mlexpr g else_e1 in
                        ...
                        | (pat_t_compat, mlbranches) ->
                            ...
                            (match mlbranches1 with
                             ...
                             | (uu____12291, uu____12292,
                                (uu____12293, f_first, t_first))::rest ->
                                 let uu____12353 =
                                   FStar_List.fold_left
                                     (fun uu____12395 ->
                                        fun uu____12396 ->
                                          ...
                                          with
                                          | ((topt, f),
                                             (uu____12453, uu____12454,
                                              (uu____12455, f_branch,
                                               t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
    ...
    fun discName ->
      fun constrName ->
        ...
        | (uu____12721, fstar_disc_type) ->
            let wildcards =
              let uu____12730 =
                let uu____12731 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              | uu____12848 -> failwith "Discriminator must be a function" in
              ...
              let uu____12859 =
                let uu____12860 =
                  let uu____12871 =
                        ...
                        let uu____12891 =
                          let uu____12902 =
                            let uu____12911 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____12912 in
                            let uu____12922 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                          ...
                          let uu____12925 =
                            let uu____12936 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____12945) in
                            [uu____12936] in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____12872 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____12871) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____12860 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____12859 in
            let uu____13000 =
              let uu____13001 =
                let uu____13004 =
                  let uu____13005 =
