           ...
           (match uu____6637 with
            ...
            | (uu____6678,FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_reify )) ->
                ...
                term_as_mlexpr g tm
            | uu____6705 ->
                let rec extract_app is_data uu____6758 uu____6759 restArgs =
                  match (uu____6758, uu____6759) with
                       ...
                       | ([],uu____6851) ->
                           ...
                           let app =
                             ...
                             FStar_All.pipe_left
                              ...
                              in
                           (app, f, t1)
                       | ((arg,uu____6894)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                          (formal_t,f',t2)) when
                           (is_type g arg) &&
                             (type_leq g formal_t
                                FStar_Extraction_ML_Syntax.ml_unit_ty)
                           ...
                           extract_app is_data
                             (mlhead,
                               ((FStar_Extraction_ML_Syntax.ml_unit,
                                  FStar_Extraction_ML_Syntax.E_PURE) ::
                               mlargs_f)) uu____6935 rest
                       | ((e0,uu____6952)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                          (tExpected,f',t2)) ->
                                ...
                                (match t1 with
                                 ...
                                 | uu____7063 ->
                                     err_ill_typed_application g top restArgs
                                       t1)))
                   in
                let extract_app_maybe_projector is_data mlhead uu____7113
                  args1 =
                  match uu____7113 with
                  | (f,t1) ->
                      (match is_data with
                       | FStar_Pervasives_Native.Some
                           (FStar_Syntax_Syntax.Record_projector uu____7145)
                           ->
                           let rec remove_implicits args2 f1 t2 =
                             match (args2, t2) with
                             | ((a0,FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____7229))::args3,FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____7231,f',t3)) ->
                                 let uu____7268 =
                                   FStar_Extraction_ML_Util.join
                                     a0.FStar_Syntax_Syntax.pos f1 f'
                                    in
                                 remove_implicits args3 uu____7268 t3
                             | uu____7269 -> (args2, f1, t2)  in
                           let uu____7294 = remove_implicits args1 f t1  in
                   ...
                   in
                let extract_app_with_instantiations uu____7374 =
                  let head2 = FStar_Syntax_Util.un_uinst head1  in
                  match head2.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Tm_name uu____7382 ->
                      let uu____7383 =
                        let uu____7402 =
                          FStar_Extraction_ML_UEnv.lookup_term g head2  in
                        match uu____7402 with
                        | (FStar_Util.Inr (uu____7427,x1,x2,x3),q) ->
                            ((x1, x2, x3), q)
                        | uu____7456 -> failwith "FIXME Ty"  in
                      (match uu____7383 with
                       | ((head_ml,(vars,t1),inst_ok),qual) ->
                           let has_typ_apps =
                             match args with
                             | (a,uu____7520)::uu____7521 -> is_type g a
                             | uu____7540 -> false  in
                           let uu____7549 =
                             match vars with
                             | uu____7582::uu____7583 when
                                        ...
                                        let mk_tapp e ty_args =
                                          ...
                                          | uu____7740 ->
                                              let uu___93_7743 = e  in
                                              {
                                                ...
                                                FStar_Extraction_ML_Syntax.mlty
                                                  =
                                                  (uu___93_7743.FStar_Extraction_ML_Syntax.mlty);
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___93_7743.FStar_Extraction_ML_Syntax.loc)
                                              }
                                           in
                                        let head3 =
                                          ...
                                          | FStar_Extraction_ML_Syntax.MLE_Name
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___94_7748.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___94_7748.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_Var
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___94_7750.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___94_7750.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_App
                                              (head3,{
                                                       FStar_Extraction_ML_Syntax.expr
                                                ...
                                                (FStar_Extraction_ML_Syntax.MLE_App
                                                   ((let uu___95_7759 =
                                                        ...
                                                        in
                                                     {
                                                       FStar_Extraction_ML_Syntax.expr
                                                         =
                                                         (uu___95_7759.FStar_Extraction_ML_Syntax.expr);
                                                       FStar_Extraction_ML_Syntax.mlty
                                                         =
                                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                            (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                       ...
                                                       FStar_Extraction_ML_Syntax.loc
                                                         =
                                                         (uu___95_7759.FStar_Extraction_ML_Syntax.loc)
                                                     }),
                                                     [FStar_Extraction_ML_Syntax.ml_unit]))
                                                (FStar_Extraction_ML_Syntax.with_ty
                                                   t2)
                  ...
                  | FStar_Syntax_Syntax.Tm_fvar uu____7843 ->
                      let uu____7844 =
                        ...
                        | (FStar_Util.Inr (uu____7888,x1,x2,x3),q) ->
                            ((x1, x2, x3), q)
                        | uu____7917 -> failwith "FIXME Ty"  in
                      (match uu____7844 with
                       | ((head_ml,(vars,t1),inst_ok),qual) ->
                           let has_typ_apps =
                             match args with
                             | (a,uu____7981)::uu____7982 -> is_type g a
                             | uu____8001 -> false  in
                           let uu____8010 =
                             match vars with
                             | uu____8043::uu____8044 when
                                 (Prims.op_Negation has_typ_apps) && inst_ok
                                 -> (head_ml, t1, args)
                             | uu____8055 ->
                                 let n1 = FStar_List.length vars  in
                                        ...
                                        let mk_tapp e ty_args =
                                          ...
                                          | uu____8201 ->
                                              let uu___93_8204 = e  in
                                              {
                                                ...
                                                FStar_Extraction_ML_Syntax.mlty
                                                  =
                                                  (uu___93_8204.FStar_Extraction_ML_Syntax.mlty);
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___93_8204.FStar_Extraction_ML_Syntax.loc)
                                              }
                                           in
                                        let head3 =
                                          match head_ml.FStar_Extraction_ML_Syntax.expr
                                          ...
                                          | FStar_Extraction_ML_Syntax.MLE_Name
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___94_8209.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___94_8209.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_Var
                                              uu____8210 ->
                                              let uu___94_8211 =
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___94_8211.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___94_8211.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_App
                                              (head3,{
                                                       FStar_Extraction_ML_Syntax.expr
                                                ...
                                                (FStar_Extraction_ML_Syntax.MLE_App
                                                   ((let uu___95_8220 =
                                                        ...
                                                        in
                                                     {
                                                       FStar_Extraction_ML_Syntax.expr
                                                         =
                                                         (uu___95_8220.FStar_Extraction_ML_Syntax.expr);
                                                       FStar_Extraction_ML_Syntax.mlty
                                                         =
                                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                            (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                       ...
                                                       FStar_Extraction_ML_Syntax.loc
                                                         =
                                                         (uu___95_8220.FStar_Extraction_ML_Syntax.loc)
                                                     }),
                                                     [FStar_Extraction_ML_Syntax.ml_unit]))
                                                (FStar_Extraction_ML_Syntax.with_ty
                                                   t2)
                                 ...
                                 | uu____8293 ->
                                     extract_app_maybe_projector qual
                                       ...
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         head_t) args1)))
                  | uu____8304 ->
                      let uu____8305 = term_as_mlexpr g head2  in
                      (match uu____8305 with
                       | (head3,f,t1) ->
                           extract_app_maybe_projector
                             FStar_Pervasives_Native.None head3 (f, t1) args)
                   in
                let uu____8321 = is_type g t  in
                if uu____8321
                then
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                  ...
                  (let uu____8329 =
                     let uu____8330 = FStar_Syntax_Util.un_uinst head1  in
                       ...
                       (match uu____8340 with
                        | FStar_Pervasives_Native.None  ->
                            (FStar_Extraction_ML_Syntax.ml_unit,
                              FStar_Extraction_ML_Syntax.E_PURE,
                              FStar_Extraction_ML_Syntax.MLTY_Erased)
                        | uu____8349 -> extract_app_with_instantiations ())
                   | uu____8352 -> extract_app_with_instantiations ()))
       | FStar_Syntax_Syntax.Tm_ascribed (e0,(tc,uu____8355),f) ->
           let t1 =
             match tc with
           ...
           let uu____8422 = check_term_as_mlexpr g e0 f1 t1  in
           (match uu____8422 with | (e,t2) -> (e, f1, t2))
       | FStar_Syntax_Syntax.Tm_let ((is_rec,lbs),e') ->
           ...
           let uu____8453 =
             ...
             then FStar_Syntax_Subst.open_let_rec lbs e'
               ...
               (let uu____8467 = FStar_Syntax_Syntax.is_top_level lbs  in
                if uu____8467
                then (lbs, e')
                else
                  (let lb = FStar_List.hd lbs  in
                   let x =
                     ...
                     FStar_Syntax_Syntax.freshen_bv uu____8481  in
                   let lb1 =
                     let uu___96_8483 = lb  in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___96_8483.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___96_8483.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___96_8483.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___96_8483.FStar_Syntax_Syntax.lbdef);
                       FStar_Syntax_Syntax.lbattrs =
                         (uu___96_8483.FStar_Syntax_Syntax.lbattrs);
                       FStar_Syntax_Syntax.lbpos =
                         (uu___96_8483.FStar_Syntax_Syntax.lbpos)
                     }  in
                   let e'1 =
            ...
            | (lbs1,e'1) ->
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8514
                               in
                            let lbdef =
                              let uu____8522 = FStar_Options.ml_ish ()  in
                              if uu____8522
                              then lb.FStar_Syntax_Syntax.lbdef
                               ...
                               in
                            let uu___97_8526 = lb  in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___97_8526.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___97_8526.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp =
                                (uu___97_8526.FStar_Syntax_Syntax.lbtyp);
                              FStar_Syntax_Syntax.lbeff =
                                (uu___97_8526.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef = lbdef;
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___97_8526.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___97_8526.FStar_Syntax_Syntax.lbpos)
                            }))
                  else lbs1  in
                let maybe_generalize uu____8533 =
                  match uu____8533 with
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      FStar_Syntax_Syntax.lbunivs = uu____8535;
                      FStar_Syntax_Syntax.lbtyp = t1;
                      FStar_Syntax_Syntax.lbeff = lbeff;
                      FStar_Syntax_Syntax.lbdef = e;
                      FStar_Syntax_Syntax.lbattrs = uu____8539;
                      FStar_Syntax_Syntax.lbpos = uu____8540;_} ->
                      let f_e = effect_as_etag g lbeff  in
                      let t2 = FStar_Syntax_Subst.compress t1  in
                      let no_gen uu____8598 =
                      ...
                      then
                        ...
                        (match t2.FStar_Syntax_Syntax.n with
                         | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                             let uu____8696 = FStar_List.hd bs  in
                              ...
                              | (bs1,c1) ->
                                    ...
                                    let uu____8729 =
                                      FStar_Util.prefix_until
                                        (fun x  ->
                                           ...
                                           Prims.op_Negation uu____8765) bs1
                                       in
                                  ...
                                  (match uu____8716 with
                                   | (tbinders,tbody) ->
                                       ...
                                       let e1 =
                                         let uu____8906 = normalize_abs e  in
                ...
                (match uu____9617 with
                 | (env_body,lbs4) ->
                     ...
                     let uu____10130 = term_as_mlexpr env_body e'1  in
                              ...
                              let uu____10161 =
                                let uu____10162 =
                                  FStar_List.map FStar_Pervasives_Native.snd
                                    lbs5
                                   in
                                (is_rec1, uu____10162)  in
                              mk_MLE_Let top_level uu____10161 e'2  in
                            let uu____10171 =
                              FStar_Extraction_ML_Util.mlloc_of_range
                                t.FStar_Syntax_Syntax.pos
                               in
                            FStar_Extraction_ML_Syntax.with_ty_loc t'
                              uu____10160 uu____10171
                             in
                          (uu____10159, f, t'))))
       | FStar_Syntax_Syntax.Tm_match (scrutinee,pats) ->
           let uu____10210 = term_as_mlexpr g scrutinee  in
           (match uu____10210 with
            | (e,f_e,t_e) ->
                let uu____10226 = check_pats_for_ite pats  in
                       ...
                       (match (then_e, else_e) with
                        | (FStar_Pervasives_Native.Some
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            let uu____10287 = term_as_mlexpr g then_e1  in
                            (match uu____10287 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____10303 = term_as_mlexpr g else_e1
                                    in
                            ...
                            (match mlbranches1 with
                             | [] ->
                                 ...
                                 (match uu____10999 with
                                  | (uu____11068,fw,uu____11070,uu____11071)
                                      ->
                                      let uu____11072 =
                                        let uu____11073 =
                                          let uu____11074 =
                                      ...
                                      (uu____11072,
                                        FStar_Extraction_ML_Syntax.E_PURE,
                                        FStar_Extraction_ML_Syntax.ml_int_ty))
                             | (uu____11087,uu____11088,(uu____11089,f_first,t_first))::rest
                                 ->
                                 let uu____11149 =
                                   FStar_List.fold_left
                                     (fun uu____11191  ->
                                        fun uu____11192  ->
                                          match (uu____11191, uu____11192)
                                          with
                                          | ((topt,f),(uu____11249,uu____11250,
                                                       (uu____11251,f_branch,t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
        ...
        let uu____11487 =
          let uu____11492 =
            FStar_TypeChecker_Env.lookup_lid
             ...
             in
          FStar_All.pipe_left FStar_Pervasives_Native.fst uu____11492  in
        match uu____11487 with
        | (uu____11517,fstar_disc_type) ->
            let wildcards =
              let uu____11526 =
                let uu____11527 = FStar_Syntax_Subst.compress fstar_disc_type
                   in
                uu____11527.FStar_Syntax_Syntax.n  in
              match uu____11526 with
              | FStar_Syntax_Syntax.Tm_arrow (binders,uu____11537) ->
                  let uu____11554 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___90_11588  ->
                            match uu___90_11588 with
                            | (uu____11595,FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____11596)) ->
                                true
                            | uu____11599 -> false))
                     in
                  FStar_All.pipe_right uu____11554
                    (FStar_List.map
                       (fun uu____11632  ->
                          let uu____11639 = fresh "_"  in
                          (uu____11639, FStar_Extraction_ML_Syntax.MLTY_Top)))
              | uu____11640 -> failwith "Discriminator must be a function"
               in
                            ...
                            let uu____11703 =
                              let uu____11704 =
                                ...
                                (uu____11711,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11704
                               in
                            let uu____11714 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                            ...
                            let uu____11728 =
                              let uu____11737 =
                                FStar_All.pipe_left
                                 ...
                                 in
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11737)
                               in
                            [uu____11728]  in
                          uu____11694 :: uu____11717  in
                        (uu____11680, uu____11683)  in
                      FStar_Extraction_ML_Syntax.MLE_Match uu____11665  in
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11664
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11663)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11652  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11651
               in
            let uu____11792 =
              let uu____11793 =
                let uu____11796 =
                  let uu____11797 =
                    FStar_Extraction_ML_UEnv.convIdent
                     ...
                     in
                  {
                    FStar_Extraction_ML_Syntax.mllb_name = uu____11797;
                    FStar_Extraction_ML_Syntax.mllb_tysc =
                      FStar_Pervasives_Native.None;
                ...
                [uu____11796]  in
              (FStar_Extraction_ML_Syntax.NonRec, uu____11793)  in
            FStar_Extraction_ML_Syntax.MLM_Let uu____11792
