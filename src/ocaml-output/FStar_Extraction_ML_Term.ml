      ...
      let uu____1119 =
        (fun t1  ->
           ...
           | FStar_Extraction_ML_Syntax.MLTY_Named uu____1121 ->
               let uu____1125 = FStar_Extraction_ML_Util.udelta_unfold g t1 in
      ...
      | FStar_Syntax_Syntax.Tm_bvar _
        |FStar_Syntax_Syntax.Tm_delayed _|FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1148 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1149 in
          failwith uu____1148
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____1550, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = Prims.fst b in
          ...
          fun expected_topt  ->
            ...
            | FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_int
                ...
                let when_clause =
                  ...
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_bool_ty) uu____1783 in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 disj g1 p1 expected_t1 =
          ...
          | uu____2539 -> failwith "Impossible: Unable to translate pattern" in
                   ...
                   FStar_Util.fold_map
                     (fun b1  ->
                        fun p3  ->
                          ...
                          | (uu____2637,p4,b') -> ((b1 && b'), p4)) b pats in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____2942 -> failwith "Impossible: Head type is not an arrow" in
              ...
              let e =
                ...
                | uu____3081 ->
                    let uu____3083 =
                      ...
                      (uu____3087, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____3083 in
              FStar_Extraction_ML_Syntax.with_ty
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then let uu____3221 = maybe_coerce g e t ty in (uu____3221, ty)
        ...
        (fun u  ->
           let uu____3232 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____3233 uu____3234 uu____3235 in
         ...
         |FStar_Syntax_Syntax.Tm_delayed _
          |FStar_Syntax_Syntax.Tm_uvar _|FStar_Syntax_Syntax.Tm_bvar _ ->
           let uu____3243 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____3244 in
           failwith uu____3243
       | FStar_Syntax_Syntax.Tm_type _
         |FStar_Syntax_Syntax.Tm_refine _|FStar_Syntax_Syntax.Tm_arrow _ ->
           (FStar_Extraction_ML_Syntax.ml_unit,
                                ...
                                let uu____3367 =
                                  let uu____3368 =
                                    FStar_Extraction_ML_UEnv.monad_op_name ed
                                      "bind" in
                                  FStar_All.pipe_right uu____3368 Prims.fst in
                  ...
                  | Some c ->
                      let uu____3514 =
                        FStar_TypeChecker_Env.is_reifiable
                          g.FStar_Extraction_ML_UEnv.tcenv c in
                      if uu____3514
                      then
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____4637 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4641  ->
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____4724 = FStar_Syntax_Subst.open_comp bs c in
                                ...
                                let uu____4738 =
                                  let uu____4743 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____4761 = is_type_binder g x in
                                         Prims.op_Negation uu____4761) bs1 in
                 ...
                 | (env_body,lbs4) ->
                     ...
                     (match uu____5630 with
                      | (e'2,f',t') ->
                          let f =
                            let uu____5641 =
                              let uu____5643 = FStar_List.map Prims.fst lbs5 in
                              f' :: uu____5643 in
                            FStar_Extraction_ML_Util.join_l e'_rng uu____5641 in
                          let is_rec1 =
                            if is_rec = true
                        ...
                        | (Some then_e1,Some else_e1) ->
                            ...
                            (match uu____5732 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____5742 = term_as_mlexpr g else_e1 in
                                                 ...
                                                 let uu____5808 =
                                                   let uu____5810 =
                                                     maybe_lift1 else_mle
                                                       t_else in
                                                   Some uu____5810 in
                                                 (e, uu____5807, uu____5808) in
                                               FStar_Extraction_ML_Syntax.MLE_If
                                                 uu____5802 in
                                             FStar_All.pipe_left
                                               (FStar_Extraction_ML_Syntax.with_ty
                                                  t_branch) uu____5801 in
                                           let uu____5812 =
                                             FStar_Extraction_ML_Util.join
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____6425,fstar_disc_type) ->
            let wildcards =
              let uu____6433 =
                let uu____6434 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              let uu____6517 =
                let uu____6518 =
                  let uu____6524 =
                        ...
                        let uu____6534 =
                          let uu____6535 =
                            let uu____6536 =
                              ...
                              ([], uu____6537) in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____6536 in
                          FStar_All.pipe_left
                        ...
                        let uu____6539 =
                          let uu____6545 =
                            let uu____6550 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____6551 in
                            let uu____6557 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____6525 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____6524) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____6518 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____6517 in
            let uu____6608 =
              let uu____6609 =
                let uu____6611 =
                  let uu____6612 =
