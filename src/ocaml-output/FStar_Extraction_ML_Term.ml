...
in (let _178_49 = (let _178_47 = (FStar_All.pipe_right args (FStar_List.map (fun _81_36 -> (match (_81_36) with
| (x, _81_35) -> begin
...
in (match ((let _178_74 = (FStar_Syntax_Subst.compress t)
in _178_74.FStar_Syntax_Syntax.n)) with
...
(let _178_87 = (FStar_Syntax_Print.term_to_string t)
in (let _178_86 = (FStar_Syntax_Print.tag_of_term t)
in (FStar_Util.print2 "is_type %s (%s)\n" _178_87 _178_86)))
end else begin
(let _178_89 = (FStar_Syntax_Print.term_to_string t)
in (let _178_88 = (FStar_Syntax_Print.tag_of_term t)
...
let is_constructor : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _178_94 = (FStar_Syntax_Subst.compress t)
in _178_94.FStar_Syntax_Syntax.n)) with
...
let rec is_fstar_value : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _178_97 = (FStar_Syntax_Subst.compress t)
...
let unit_binder : FStar_Syntax_Syntax.binder = (let _178_110 = (FStar_Syntax_Syntax.new_bv None FStar_TypeChecker_Common.t_unit)
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder _178_110))
...
let _81_357 = (let _178_113 = (FStar_List.tl l)
in (FStar_List.hd _178_113))
...
| () -> begin
(let _178_143 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule e)
in (let _178_142 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule ty)
in (let _178_141 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule expect)
in (FStar_Util.print3 "\n (*needed to coerce expression \n %s \n of type \n %s \n to type \n %s *) \n" _178_143 _178_142 _178_141))))
end)))
...
let res = (match ((let _178_169 = (FStar_Syntax_Util.un_uinst head)
in _178_169.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
(bv_as_mlty env bv)
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
| FStar_Syntax_Syntax.Tm_app (head, args') -> begin
(let _178_170 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app (((head), ((FStar_List.append args' args))))) None t.FStar_Syntax_Syntax.pos)
in (term_as_mlty' env _178_170))
end
| _81_511 -> begin
FStar_Extraction_ML_UEnv.unknownType
end)
...
| (_81_548, rest) -> begin
(let _178_177 = (FStar_List.map (fun _81_551 -> FStar_Extraction_ML_UEnv.erasedContent) rest)
in (FStar_List.append mlargs _178_177))
end))
end else begin
mlargs
end)
...
let ml_b = (let _178_182 = (FStar_Extraction_ML_UEnv.bv_as_ml_termvar b)
in ((_178_182), (FStar_Extraction_ML_Syntax.ml_unit_ty)))
in (((ml_b)::ml_bs), (env)))))
end else begin
(
...
let ml_b = (let _178_183 = (FStar_Extraction_ML_UEnv.bv_as_ml_termvar b)
in ((_178_183), (t)))
in (((ml_b)::ml_bs), (env))))))
end
end)) (([]), (g))))
...
(FStar_Extraction_ML_UEnv.debug g (fun _81_651 -> (let _178_218 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t')
in (let _178_217 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t)
...
let when_clause = (let _178_227 = (let _178_226 = (let _178_225 = (let _178_224 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_int_ty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (let _178_223 = (let _178_222 = (let _178_221 = (let _178_220 = (FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Syntax_Syntax.p i)
in (FStar_All.pipe_left (fun _178_219 -> FStar_Extraction_ML_Syntax.MLE_Const (_178_219)) _178_220))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_int_ty) _178_221))
in (_178_222)::[])
in (_178_224)::_178_223))
in ((FStar_Extraction_ML_Util.prims_op_equality), (_178_225)))
in FStar_Extraction_ML_Syntax.MLE_App (_178_226))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _178_227))
in (let _178_228 = (ok FStar_Extraction_ML_Syntax.ml_int_ty)
in ((g), (Some (((FStar_Extraction_ML_Syntax.MLP_Var (x)), ((when_clause)::[])))), (_178_228))))))
end
...
in (let _178_233 = (let _178_231 = (let _178_230 = (let _178_229 = (FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Syntax_Syntax.p s)
in FStar_Extraction_ML_Syntax.MLP_Const (_178_229))
in ((_178_230), ([])))
in Some (_178_231))
in (let _178_232 = (ok mlty)
in ((g), (_178_233), (_178_232))))))
end
...
in (let _178_238 = if imp then begin
None
end else begin
(let _178_236 = (let _178_235 = (let _178_234 = (FStar_Extraction_ML_Syntax.bv_as_mlident x)
in FStar_Extraction_ML_Syntax.MLP_Var (_178_234))
in ((_178_235), ([])))
in Some (_178_236))
end
in (let _178_237 = (ok mlty)
in ((g), (_178_238), (_178_237))))))
end
...
let g = (FStar_Extraction_ML_UEnv.extend_bv g x (([]), (mlty)) false false imp)
in (let _178_243 = if imp then begin
None
end else begin
(let _178_241 = (let _178_240 = (let _178_239 = (FStar_Extraction_ML_Syntax.bv_as_mlident x)
in FStar_Extraction_ML_Syntax.MLP_Var (_178_239))
in ((_178_240), ([])))
in Some (_178_241))
end
in (let _178_242 = (ok mlty)
in ((g), (_178_243), (_178_242))))))
end
...
let _81_727 = (FStar_Extraction_ML_UEnv.debug g (fun _81_725 -> (let _178_247 = (FStar_Syntax_Print.pat_to_string p)
in (FStar_Util.print1 "Pattern %s is not extractable" _178_247))))
...
in (let _178_248 = (FStar_Extraction_ML_Util.uncurry_mlty_fun f_ty)
in Some (_178_248))))
end)
with
...
let _81_778 = (let _178_255 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun _81_1 -> (match (_81_1) with
| Some (x) -> begin
(x)::[]
end
| _81_775 -> begin
...
in (FStar_All.pipe_right _178_255 FStar_List.split))
...
in (let _178_259 = (let _178_258 = (let _178_257 = (resugar_pat f.FStar_Syntax_Syntax.fv_qual (FStar_Extraction_ML_Syntax.MLP_CTor (((d), (mlPats)))))
in (let _178_256 = (FStar_All.pipe_right when_clauses FStar_List.flatten)
in ((_178_257), (_178_256))))
in Some (_178_258))
in ((g), (_178_259), (pat_ty_compat))))
end))
end))
end)))
end)))
...
| (hd)::tl -> begin
(let _178_270 = (FStar_List.fold_left FStar_Extraction_ML_Util.conjoin hd tl)
in Some (_178_270))
end))
in (match (p.FStar_Syntax_Syntax.v) with
...
| (x, whens) -> begin
(let _178_275 = (mk_when_clause whens)
in ((x), (_178_275)))
end))))
in (
...
| rest -> begin
(let _178_279 = (let _178_278 = (let _178_277 = (let _178_276 = (FStar_List.map Prims.fst rest)
in FStar_Extraction_ML_Syntax.MLP_Branch (_178_276))
in ((_178_277), (None)))
in (_178_278)::ps)
in ((g), (_178_279), (b)))
end)
...
let x = (FStar_Extraction_ML_Syntax.gensym ())
in (let _178_294 = (let _178_293 = (let _178_292 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t0) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in ((((x), (t0))), (_178_292)))
in (_178_293)::more_args)
in (eta_args _178_294 t1)))
end
...
(match (eargs) with
| [] -> begin
(let _178_303 = (as_record qual e)
in (FStar_Extraction_ML_Util.resugar_exp _178_303))
end
| _81_905 -> begin
(
...
let body = (let _178_305 = (let _178_304 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tres) (FStar_Extraction_ML_Syntax.MLE_CTor (((head), ((FStar_List.append args eargs))))))
in (FStar_All.pipe_left (as_record qual) _178_304))
in (FStar_All.pipe_left FStar_Extraction_ML_Util.resugar_exp _178_305))
...
| _81_943 -> begin
(let _178_307 = (let _178_306 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) proj)
in ((_178_306), (args)))
in FStar_Extraction_ML_Syntax.MLE_App (_178_307))
end)
...
(let _178_308 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty mlAppExpr.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_CTor (((mlp), (mlargs)))))
in (FStar_All.pipe_left (resugar_and_maybe_eta qual) _178_308))
end
...
(let _178_309 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty mlAppExpr.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_CTor (((mlp), ([])))))
in (FStar_All.pipe_left (resugar_and_maybe_eta qual) _178_309))
end
| _81_983 -> begin
mlAppExpr
end)))))
...
let _81_995 = (FStar_Extraction_ML_UEnv.debug g (fun u -> (let _178_334 = (let _178_333 = (FStar_Syntax_Print.tag_of_term t)
in (let _178_332 = (FStar_Syntax_Print.term_to_string t)
in (let _178_331 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule ty)
in (FStar_Util.format4 "term_as_mlexpr (%s) :  %s has ML type %s and effect %s\n" _178_333 _178_332 _178_331 (FStar_Extraction_ML_Util.eff_to_string tag)))))
in (FStar_Util.print_string _178_334))))
in (erase g e ty tag)))
end)))
...
(let _178_343 = (maybe_coerce g e t ty)
in ((_178_343), (ty)))
end else begin
...
let _81_1021 = (FStar_Extraction_ML_UEnv.debug g (fun u -> (let _178_350 = (let _178_349 = (FStar_Range.string_of_range top.FStar_Syntax_Syntax.pos)
in (let _178_348 = (FStar_Syntax_Print.tag_of_term top)
in (let _178_347 = (FStar_Syntax_Print.term_to_string top)
in (FStar_Util.format3 "%s: term_as_mlexpr\' (%s) :  %s \n" _178_349 _178_348 _178_347))))
in (FStar_Util.print_string _178_350))))
in (
...
in if (let _178_353 = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reifiable))
in (FStar_All.pipe_right _178_353 Prims.op_Negation)) then begin
(term_as_mlexpr' g t)
end else begin
(
...
let k = (let _178_356 = (let _178_355 = (let _178_354 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in (FStar_All.pipe_right _178_354 FStar_Syntax_Syntax.mk_binder))
in (_178_355)::[])
in (FStar_Syntax_Util.abs _178_356 body None))
in (
...
let bind = (let _178_359 = (let _178_358 = (let _178_357 = (FStar_Extraction_ML_UEnv.monad_op_name ed "bind")
in (FStar_All.pipe_right _178_357 Prims.fst))
in FStar_Extraction_ML_Syntax.MLE_Name (_178_358))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) _178_359))
in (let _178_360 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty ty) (FStar_Extraction_ML_Syntax.MLE_App (((bind), ((comp_1)::(ml_k)::[])))))
in ((_178_360), (FStar_Extraction_ML_Syntax.E_IMPURE), (ty))))
end))
end)))
end)
end
...
in (let _178_364 = (let _178_363 = (let _178_362 = (FStar_Extraction_ML_Util.mlconst_of_const' t.FStar_Syntax_Syntax.pos c)
in (FStar_All.pipe_left (fun _178_361 -> FStar_Extraction_ML_Syntax.MLE_Const (_178_361)) _178_362))
in (FStar_Extraction_ML_Syntax.with_ty ml_ty _178_363))
in ((_178_364), (FStar_Extraction_ML_Syntax.E_PURE), (ml_ty))))
end))
end
...
| ([], t) -> begin
(let _178_365 = (maybe_eta_data_and_project_record g qual t x)
in ((_178_365), (FStar_Extraction_ML_Syntax.E_PURE), (t)))
end
| _81_1154 -> begin
...
| (f, tfun) -> begin
(let _178_368 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tfun) (FStar_Extraction_ML_Syntax.MLE_Fun (((ml_bs), (ml_body)))))
in ((_178_368), (f), (tfun)))
end))
end))
end))
...
in (match ((let _178_373 = (let _178_372 = (FStar_Syntax_Subst.compress head)
in _178_372.FStar_Syntax_Syntax.n)
in ((head.FStar_Syntax_Syntax.n), (_178_373)))) with
...
(let _178_382 = (FStar_All.pipe_right (FStar_List.rev mlargs_f) (FStar_List.map Prims.fst))
in (([]), (_178_382)))
end else begin
...
let x = (FStar_Extraction_ML_Syntax.gensym ())
in (let _178_386 = (let _178_385 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty arg.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (_178_385)::out_args)
in (((((x), (arg)))::lbs), (_178_386))))
end
end)) (([]), ([])) mlargs_f)
end
...
let app = (let _178_387 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t) (FStar_Extraction_ML_Syntax.MLE_App (((mlhead), (mlargs)))))
in (FStar_All.pipe_left (maybe_eta_data_and_project_record g is_data t) _178_387))
in (
...
(let _178_391 = (let _178_390 = (FStar_Extraction_ML_Util.join arg.FStar_Syntax_Syntax.pos f f')
in ((_178_390), (t)))
in (extract_app is_data ((mlhead), ((((FStar_Extraction_ML_Syntax.ml_unit), (FStar_Extraction_ML_Syntax.E_PURE)))::mlargs_f)) _178_391 rest))
end else begin
(let _178_396 = (let _178_395 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule mlhead)
in (let _178_394 = (FStar_Syntax_Print.term_to_string arg)
...
in (let _178_398 = (let _178_397 = (FStar_Extraction_ML_Util.join_l r ((f)::(f')::(f0)::[]))
in ((_178_397), (t)))
in (extract_app is_data ((mlhead), ((((e0), (f0)))::mlargs_f)) _178_398 rest)))
end)))
end
| _81_1327 -> begin
(match ((FStar_Extraction_ML_Util.udelta_unfold g t)) with
...
(let _178_413 = (FStar_Extraction_ML_Util.join a0.FStar_Syntax_Syntax.pos f f')
in (remove_implicits args _178_413 t))
end
| _81_1362 -> begin
((args), (f), (t))
end))
...
(match (args) with
| [] -> begin
(let _178_415 = (maybe_eta_data_and_project_record g qual head_t head_ml)
in ((_178_415), (FStar_Extraction_ML_Syntax.E_PURE), (head_t)))
end
| _81_1444 -> begin
...
let x = (let _178_416 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in (FStar_Syntax_Syntax.freshen_bv _178_416))
in (
...
let tcenv = (let _178_418 = (FStar_Ident.lid_of_path (FStar_List.append (Prims.fst g.FStar_Extraction_ML_UEnv.currentModule) (((Prims.snd g.FStar_Extraction_ML_UEnv.currentModule))::[])) FStar_Range.dummyRange)
in (FStar_TypeChecker_Env.set_current_module g.FStar_Extraction_ML_UEnv.tcenv _178_418))
in (
...
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) when (let _178_421 = (FStar_List.hd bs)
in (FStar_All.pipe_right _178_421 (is_type_binder g))) -> begin
(
...
(let _178_423 = (FStar_Syntax_Util.arrow ((b)::rest) c)
in ((bs), (_178_423)))
end)
...
(let _178_427 = (let _178_426 = (FStar_Syntax_Syntax.bv_to_name y)
in ((x), (_178_426)))
in FStar_Syntax_Syntax.NT (_178_427))
end)) tbinders targs)
...
let polytype = (let _178_431 = (FStar_All.pipe_right targs (FStar_List.map (fun _81_1551 -> (match (_81_1551) with
| (x, _81_1550) -> begin
(FStar_Extraction_ML_UEnv.bv_as_ml_tyvar x)
end))))
in ((_178_431), (expected_t)))
in (
...
let polytype = (let _178_435 = (FStar_All.pipe_right tbinders (FStar_List.map (fun _81_1581 -> (match (_81_1581) with
| (x, _81_1580) -> begin
(FStar_Extraction_ML_UEnv.bv_as_ml_tyvar x)
end))))
in ((_178_435), (expected_t)))
in (

let args = (FStar_All.pipe_right tbinders (FStar_List.map (fun _81_1586 -> (match (_81_1586) with
| (bv, _81_1585) -> begin
(let _178_437 = (FStar_Syntax_Syntax.bv_to_name bv)
in (FStar_All.pipe_right _178_437 FStar_Syntax_Syntax.as_arg))
end))))
in (
...
let f = (let _178_447 = (let _178_446 = (FStar_List.map Prims.fst lbs)
in (f')::_178_446)
in (FStar_Extraction_ML_Util.join_l e'_rng _178_447))
in (
...
in (let _178_452 = (let _178_451 = (let _178_449 = (let _178_448 = (FStar_List.map Prims.snd lbs)
in ((is_rec), ([]), (_178_448)))
in (mk_MLE_Let top_level _178_449 e'))
in (let _178_450 = (FStar_Extraction_ML_Util.mlloc_of_range t.FStar_Syntax_Syntax.pos)
in (FStar_Extraction_ML_Syntax.with_ty_loc t' _178_451 _178_450)))
in ((_178_452), (f), (t')))))
end)))))
end))))))
end)))
...
(let _178_483 = (let _178_481 = (let _178_480 = (let _178_479 = (maybe_lift then_mle t_then)
in (let _178_478 = (let _178_477 = (maybe_lift else_mle t_else)
in Some (_178_477))
in ((e), (_178_479), (_178_478))))
in FStar_Extraction_ML_Syntax.MLE_If (_178_480))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_branch) _178_481))
in (let _178_482 = (FStar_Extraction_ML_Util.join then_e.FStar_Syntax_Syntax.pos f_then f_else)
in ((_178_483), (_178_482), (t_branch))))
end))
end))
end))
end
...
(let _178_487 = (FStar_All.pipe_right p (FStar_List.map (fun _81_1713 -> (match (_81_1713) with
| (p, wopt) -> begin
(
...
in (((compat && pat_t_compat)), (_178_487)))
end))
end))
end))
end))) true))
...
let _81_1721 = (FStar_Extraction_ML_UEnv.debug g (fun _81_1719 -> (let _178_490 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule e)
in (let _178_489 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t_e)
...
let _81_1730 = (let _178_492 = (let _178_491 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.failwith_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Extraction_ML_UEnv.lookup_fv g _178_491))
in (FStar_All.pipe_left FStar_Util.right _178_492))
in (match (_81_1730) with
| (fw, _81_1727, _81_1729) -> begin
(let _178_497 = (let _178_496 = (let _178_495 = (let _178_494 = (let _178_493 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_string_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_String ("unreachable"))))
in (_178_493)::[])
in ((fw), (_178_494)))
in FStar_Extraction_ML_Syntax.MLE_App (_178_495))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_unit_ty) _178_496))
in ((_178_497), (FStar_Extraction_ML_Syntax.E_PURE), (FStar_Extraction_ML_Syntax.ml_unit_ty)))
end))
end
...
in (let _178_501 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_match) (FStar_Extraction_ML_Syntax.MLE_Match (((e), (mlbranches)))))
in ((_178_501), (f_match), (t_match)))))
end))
end)))
end))
end)
...
in (let _178_504 = (FStar_ST.read c)
in ((x), (_178_504))))))
...
let wildcards = (match ((let _178_511 = (FStar_Syntax_Subst.compress fstar_disc_type)
in _178_511.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, _81_1798) -> begin
(let _178_515 = (FStar_All.pipe_right binders (FStar_List.filter (fun _81_5 -> (match (_81_5) with
...
in (FStar_All.pipe_right _178_515 (FStar_List.map (fun _81_1811 -> (let _178_514 = (fresh "_")
...
let discrBody = (let _178_530 = (let _178_529 = (let _178_528 = (let _178_527 = (let _178_526 = (let _178_525 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty targ) (FStar_Extraction_ML_Syntax.MLE_Name ((([]), ((FStar_Extraction_ML_Syntax.idsym mlid))))))
in (let _178_524 = (let _178_523 = (let _178_519 = (let _178_517 = (let _178_516 = (FStar_Extraction_ML_Syntax.mlpath_of_lident constrName)
in ((_178_516), ((FStar_Extraction_ML_Syntax.MLP_Wild)::[])))
in FStar_Extraction_ML_Syntax.MLP_CTor (_178_517))
in (let _178_518 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (true))))
in ((_178_519), (None), (_178_518))))
in (let _178_522 = (let _178_521 = (let _178_520 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (false))))
in ((FStar_Extraction_ML_Syntax.MLP_Wild), (None), (_178_520)))
in (_178_521)::[])
in (_178_523)::_178_522))
in ((_178_525), (_178_524))))
in FStar_Extraction_ML_Syntax.MLE_Match (_178_526))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _178_527))
in (((FStar_List.append wildcards ((((mlid), (targ)))::[]))), (_178_528)))
in FStar_Extraction_ML_Syntax.MLE_Fun (_178_529))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty disc_ty) _178_530))
