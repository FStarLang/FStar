...
let fail = (fun r msg -> ((let _0_331 = (let _0_330 = (FStar_Range.string_of_range r)
in (FStar_Util.format2 "%s: %s\n" _0_330 msg))
in (FStar_All.pipe_left FStar_Util.print_string _0_331));
(failwith msg);
))
...
| (vars, ty) -> begin
(let _0_337 = (let _0_336 = (FStar_Syntax_Print.term_to_string t)
in (let _0_335 = (let _0_332 = (FStar_All.pipe_right vars (FStar_List.map Prims.fst))
in (FStar_All.pipe_right _0_332 (FStar_String.concat ", ")))
in (let _0_334 = (FStar_Extraction_ML_Code.string_of_mlty env.FStar_Extraction_ML_UEnv.currentModule ty)
in (let _0_333 = (FStar_Syntax_Print.term_to_string app)
in (FStar_Util.format4 "Variable %s has a polymorphic type (forall %s. %s); expected it to be fully instantiated, but got %s" _0_336 _0_335 _0_334 _0_333)))))
in (fail t.FStar_Syntax_Syntax.pos _0_337))
end))


let err_ill_typed_application = (fun env t args ty -> (let _0_342 = (let _0_341 = (FStar_Syntax_Print.term_to_string t)
in (let _0_340 = (let _0_338 = (FStar_All.pipe_right args (FStar_List.map (fun uu____164 -> (match (uu____164) with
| (x, uu____168) -> begin
(FStar_Syntax_Print.term_to_string x)
end))))
in (FStar_All.pipe_right _0_338 (FStar_String.concat " ")))
...
let err_value_restriction = (fun t -> (let _0_345 = (let _0_344 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_343 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format2 "Refusing to generalize because of the value restriction: (%s) %s" _0_344 _0_343)))
in (fail t.FStar_Syntax_Syntax.pos _0_345)))


let err_unexpected_eff = (fun t f0 f1 -> (let _0_347 = (let _0_346 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format3 "for expression %s, Expected effect %s; got effect %s" _0_346 (FStar_Extraction_ML_Util.eff_to_string f0) (FStar_Extraction_ML_Util.eff_to_string f1)))
...
(failwith (let _0_348 = (FStar_Syntax_Print.tag_of_term t)
in (FStar_Util.format1 "Impossible: %s" _0_348)))
end
...
| true -> begin
(let _0_350 = (FStar_Syntax_Print.term_to_string t)
in (let _0_349 = (FStar_Syntax_Print.tag_of_term t)
in (FStar_Util.print2 "is_type %s (%s)\n" _0_350 _0_349)))
end
| uu____639 -> begin
(let _0_352 = (FStar_Syntax_Print.term_to_string t)
in (let _0_351 = (FStar_Syntax_Print.tag_of_term t)
...
let unit_binder : FStar_Syntax_Syntax.binder = (let _0_353 = (FStar_Syntax_Syntax.new_bv None FStar_TypeChecker_Common.t_unit)
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder _0_353))
...
| uu____990 -> begin
((FStar_Extraction_ML_UEnv.debug g (fun uu____995 -> (let _0_356 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule e)
in (let _0_355 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule ty)
in (let _0_354 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule expect)
in (FStar_Util.print3 "\n (*needed to coerce expression \n %s \n of type \n %s \n to type \n %s *) \n" _0_356 _0_355 _0_354))))));
...
(failwith (let _0_357 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format1 "Impossible: Unexpected term %s" _0_357)))
end
...
| FStar_Syntax_Syntax.Tm_app (head, args') -> begin
(let _0_358 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app (((head), ((FStar_List.append args' args))))) None t.FStar_Syntax_Syntax.pos)
in (term_as_mlty' env _0_358))
end
| uu____1244 -> begin
FStar_Extraction_ML_UEnv.unknownType
end))
...
(let _0_359 = (FStar_List.map (fun uu____1377 -> FStar_Extraction_ML_UEnv.erasedContent) rest)
in (FStar_List.append mlargs _0_359))
end))
end
| uu____1380 -> begin
mlargs
...
let ml_b = (let _0_360 = (FStar_Extraction_ML_UEnv.bv_as_ml_termvar b)
in ((_0_360), (FStar_Extraction_ML_Syntax.ml_unit_ty)))
in (((ml_b)::ml_bs), (env)))))
end
| uu____1477 -> begin
(
...
let ml_b = (let _0_361 = (FStar_Extraction_ML_UEnv.bv_as_ml_termvar b)
in ((_0_361), (t)))
in (((ml_b)::ml_bs), (env))))))
end))
end)) (([]), (g))))
...
| true -> begin
(FStar_Extraction_ML_UEnv.debug g (fun uu____1646 -> (let _0_363 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t')
in (let _0_362 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t)
...
let when_clause = (let _0_371 = FStar_Extraction_ML_Syntax.MLE_App ((let _0_370 = (let _0_369 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_int_ty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (let _0_368 = (let _0_367 = (let _0_366 = (let _0_365 = (FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Syntax_Syntax.p i)
in (FStar_All.pipe_left (fun _0_364 -> FStar_Extraction_ML_Syntax.MLE_Const (_0_364)) _0_365))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_int_ty) _0_366))
in (_0_367)::[])
in (_0_369)::_0_368))
in ((FStar_Extraction_ML_Util.prims_op_equality), (_0_370))))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _0_371))
in (let _0_372 = (ok FStar_Extraction_ML_Syntax.ml_int_ty)
in ((g), (Some (((FStar_Extraction_ML_Syntax.MLP_Var (x)), ((when_clause)::[])))), (_0_372))))))
end
...
in (let _0_375 = Some ((let _0_373 = FStar_Extraction_ML_Syntax.MLP_Const ((FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Syntax_Syntax.p s))
in ((_0_373), ([]))))
in (let _0_374 = (ok mlty)
in ((g), (_0_375), (_0_374))))))
end
...
in (let _0_378 = (match (imp) with
| true -> begin
None
end
| uu____1715 -> begin
Some ((let _0_376 = FStar_Extraction_ML_Syntax.MLP_Var ((FStar_Extraction_ML_Syntax.bv_as_mlident x))
in ((_0_376), ([]))))
end)
in (let _0_377 = (ok mlty)
in ((g), (_0_378), (_0_377))))))
end
...
let g = (FStar_Extraction_ML_UEnv.extend_bv g x (([]), (mlty)) false false imp)
in (let _0_381 = (match (imp) with
| true -> begin
None
end
| uu____1744 -> begin
Some ((let _0_379 = FStar_Extraction_ML_Syntax.MLP_Var ((FStar_Extraction_ML_Syntax.bv_as_mlident x))
in ((_0_379), ([]))))
end)
in (let _0_380 = (ok mlty)
in ((g), (_0_381), (_0_380))))))
end
...
| uu____1894 -> begin
((FStar_Extraction_ML_UEnv.debug g (fun uu____1896 -> (let _0_382 = (FStar_Syntax_Print.pat_to_string p)
in (FStar_Util.print1 "Pattern %s is not extractable" _0_382))));
...
let uu____2211 = (let _0_383 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun uu___113_2246 -> (match (uu___113_2246) with
| Some (x) -> begin
(x)::[]
end
| uu____2268 -> begin
...
in (FStar_All.pipe_right _0_383 FStar_List.split))
...
in (let _0_386 = Some ((let _0_385 = (resugar_pat f.FStar_Syntax_Syntax.fv_qual (FStar_Extraction_ML_Syntax.MLP_CTor (((d), (mlPats)))))
in (let _0_384 = (FStar_All.pipe_right when_clauses FStar_List.flatten)
in ((_0_385), (_0_384)))))
in ((g), (_0_386), (pat_ty_compat))))
end))
end))
end)))
end)))
...
| (x, whens) -> begin
(let _0_387 = (mk_when_clause whens)
in ((x), (_0_387)))
end))))
in (
...
| rest -> begin
(let _0_390 = (let _0_389 = (let _0_388 = FStar_Extraction_ML_Syntax.MLP_Branch ((FStar_List.map Prims.fst rest))
in ((_0_388), (None)))
in (_0_389)::ps)
in ((g), (_0_390), (b)))
end)
...
let x = (FStar_Extraction_ML_Syntax.gensym ())
in (let _0_393 = (let _0_392 = (let _0_391 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t0) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in ((((x), (t0))), (_0_391)))
in (_0_392)::more_args)
in (eta_args _0_393 t1)))
end
...
let body = (let _0_395 = (let _0_394 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tres) (FStar_Extraction_ML_Syntax.MLE_CTor (((head), ((FStar_List.append args eargs))))))
in (FStar_All.pipe_left (as_record qual) _0_394))
in (FStar_All.pipe_left FStar_Extraction_ML_Util.resugar_exp _0_395))
...
| uu____2905 -> begin
FStar_Extraction_ML_Syntax.MLE_App ((let _0_396 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) proj)
in ((_0_396), (args))))
end)
...
(let _0_397 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty mlAppExpr.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_CTor (((mlp), (mlargs)))))
in (FStar_All.pipe_left (resugar_and_maybe_eta qual) _0_397))
end
...
(let _0_398 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty mlAppExpr.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_CTor (((mlp), ([])))))
in (FStar_All.pipe_left (resugar_and_maybe_eta qual) _0_398))
end
| uu____2927 -> begin
mlAppExpr
end)))))
...
in ((FStar_Extraction_ML_UEnv.debug g (fun u -> (FStar_Util.print_string (let _0_401 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_400 = (FStar_Syntax_Print.term_to_string t)
in (let _0_399 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule ty)
in (FStar_Util.format4 "term_as_mlexpr (%s) :  %s has ML type %s and effect %s\n" _0_401 _0_400 _0_399 (FStar_Extraction_ML_Util.eff_to_string tag))))))));
(erase g e ty tag);
))
end)))
...
| true -> begin
(let _0_402 = (maybe_coerce g e t ty)
in ((_0_402), (ty)))
end
| uu____3034 -> begin
...
(failwith (let _0_406 = (FStar_Syntax_Print.tag_of_term t)
in (FStar_Util.format1 "Impossible: Unexpected term: %s" _0_406)))
end
| (FStar_Syntax_Syntax.Tm_type (_)) | (FStar_Syntax_Syntax.Tm_refine (_)) | (FStar_Syntax_Syntax.Tm_arrow (_)) -> begin
...
let uu____3122 = (let _0_407 = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reifiable))
in (FStar_All.pipe_right _0_407 Prims.op_Negation))
...
let k = (let _0_410 = (let _0_409 = (let _0_408 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in (FStar_All.pipe_right _0_408 FStar_Syntax_Syntax.mk_binder))
in (_0_409)::[])
in (FStar_Syntax_Util.abs _0_410 body None))
in (
...
let bind = (let _0_412 = FStar_Extraction_ML_Syntax.MLE_Name ((let _0_411 = (FStar_Extraction_ML_UEnv.monad_op_name ed "bind")
in (FStar_All.pipe_right _0_411 Prims.fst)))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) _0_412))
in (let _0_413 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty ty) (FStar_Extraction_ML_Syntax.MLE_App (((bind), ((comp_1)::(ml_k)::[])))))
in ((_0_413), (FStar_Extraction_ML_Syntax.E_IMPURE), (ty))))
end))
end)))
end)))
end
...
in (let _0_417 = (let _0_416 = (let _0_415 = (FStar_Extraction_ML_Util.mlconst_of_const' t.FStar_Syntax_Syntax.pos c)
in (FStar_All.pipe_left (fun _0_414 -> FStar_Extraction_ML_Syntax.MLE_Const (_0_414)) _0_415))
in (FStar_Extraction_ML_Syntax.with_ty ml_ty _0_416))
in ((_0_417), (FStar_Extraction_ML_Syntax.E_PURE), (ml_ty))))
end))
end
...
| ([], t) -> begin
(let _0_418 = (maybe_eta_data_and_project_record g qual t x)
in ((_0_418), (FStar_Extraction_ML_Syntax.E_PURE), (t)))
end
| uu____3252 -> begin
...
| (f, tfun) -> begin
(let _0_419 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tfun) (FStar_Extraction_ML_Syntax.MLE_Fun (((ml_bs), (ml_body)))))
in ((_0_419), (f), (tfun)))
end))
end))
end))
...
let uu____3470 = (let _0_420 = (FStar_Syntax_Subst.compress head).FStar_Syntax_Syntax.n
in ((head.FStar_Syntax_Syntax.n), (_0_420)))
...
| true -> begin
(let _0_421 = (FStar_All.pipe_right (FStar_List.rev mlargs_f) (FStar_List.map Prims.fst))
in (([]), (_0_421)))
end
| uu____3637 -> begin
...
let x = (FStar_Extraction_ML_Syntax.gensym ())
in (let _0_423 = (let _0_422 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty arg.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (_0_422)::out_args)
in (((((x), (arg)))::lbs), (_0_423))))
end)
end)) (([]), ([])) mlargs_f)
...
let app = (let _0_424 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t) (FStar_Extraction_ML_Syntax.MLE_App (((mlhead), (mlargs)))))
in (FStar_All.pipe_left (maybe_eta_data_and_project_record g is_data t) _0_424))
in (
...
| true -> begin
(let _0_426 = (let _0_425 = (FStar_Extraction_ML_Util.join arg.FStar_Syntax_Syntax.pos f f')
in ((_0_425), (t)))
in (extract_app is_data ((mlhead), ((((FStar_Extraction_ML_Syntax.ml_unit), (FStar_Extraction_ML_Syntax.E_PURE)))::mlargs_f)) _0_426 rest))
end
| uu____3772 -> begin
(failwith (let _0_430 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule mlhead)
in (let _0_429 = (FStar_Syntax_Print.term_to_string arg)
in (let _0_428 = (FStar_Syntax_Print.tag_of_term arg)
in (let _0_427 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule formal_t)
in (FStar_Util.format4 "Impossible: ill-typed application:\n\thead=%s, arg=%s, tag=%s\n\texpected type unit, got %s" _0_430 _0_429 _0_428 _0_427))))))
end))
end
...
in (let _0_432 = (let _0_431 = (FStar_Extraction_ML_Util.join_l r ((f)::(f')::(f0)::[]))
in ((_0_431), (t)))
in (extract_app is_data ((mlhead), ((((e0), (f0)))::mlargs_f)) _0_432 rest)))
end)))
end
| uu____3812 -> begin
(
...
(let _0_433 = (FStar_Extraction_ML_Util.join a0.FStar_Syntax_Syntax.pos f f')
in (remove_implicits args _0_433 t))
end
| uu____3951 -> begin
((args), (f), (t))
end))
...
(match (args) with
| [] -> begin
(let _0_434 = (maybe_eta_data_and_project_record g qual head_t head_ml)
in ((_0_434), (FStar_Extraction_ML_Syntax.E_PURE), (head_t)))
end
| uu____4259 -> begin
...
let tcenv = (let _0_435 = (FStar_Ident.lid_of_path (FStar_List.append (Prims.fst g.FStar_Extraction_ML_UEnv.currentModule) (((Prims.snd g.FStar_Extraction_ML_UEnv.currentModule))::[])) FStar_Range.dummyRange)
in (FStar_TypeChecker_Env.set_current_module g.FStar_Extraction_ML_UEnv.tcenv _0_435))
...
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) when (let _0_436 = (FStar_List.hd bs)
in (FStar_All.pipe_right _0_436 (is_type_binder g))) -> begin
(
...
(let _0_437 = (FStar_Syntax_Util.arrow ((b)::rest) c)
in ((bs), (_0_437)))
end))
...
let e = (let _0_438 = (normalize_abs e)
in (FStar_All.pipe_right _0_438 FStar_Syntax_Util.unmeta))
...
FStar_Syntax_Syntax.NT ((let _0_439 = (FStar_Syntax_Syntax.bv_to_name y)
in ((x), (_0_439))))
end)) tbinders targs)
...
let polytype = (let _0_440 = (FStar_All.pipe_right targs (FStar_List.map (fun uu____4719 -> (match (uu____4719) with
| (x, uu____4725) -> begin
(FStar_Extraction_ML_UEnv.bv_as_ml_tyvar x)
end))))
in ((_0_440), (expected_t)))
in (
...
let polytype = (let _0_441 = (FStar_All.pipe_right tbinders (FStar_List.map (fun uu____4816 -> (match (uu____4816) with
| (x, uu____4822) -> begin
(FStar_Extraction_ML_UEnv.bv_as_ml_tyvar x)
end))))
in ((_0_441), (expected_t)))
in (

let args = (FStar_All.pipe_right tbinders (FStar_List.map (fun uu____4828 -> (match (uu____4828) with
| (bv, uu____4832) -> begin
(let _0_442 = (FStar_Syntax_Syntax.bv_to_name bv)
in (FStar_All.pipe_right _0_442 FStar_Syntax_Syntax.as_arg))
end))))
in (
...
let f = (let _0_444 = (let _0_443 = (FStar_List.map Prims.fst lbs)
in (f')::_0_443)
in (FStar_Extraction_ML_Util.join_l e'_rng _0_444))
in (
...
in (let _0_449 = (let _0_448 = (let _0_446 = (let _0_445 = (FStar_List.map Prims.snd lbs)
in ((is_rec), ([]), (_0_445)))
in (mk_MLE_Let top_level _0_446 e'))
in (let _0_447 = (FStar_Extraction_ML_Util.mlloc_of_range t.FStar_Syntax_Syntax.pos)
in (FStar_Extraction_ML_Syntax.with_ty_loc t' _0_448 _0_447)))
in ((_0_449), (f), (t')))))
end)))))
end))))))
end)))
...
(let _0_454 = (let _0_452 = FStar_Extraction_ML_Syntax.MLE_If ((let _0_451 = (maybe_lift then_mle t_then)
in (let _0_450 = Some ((maybe_lift else_mle t_else))
in ((e), (_0_451), (_0_450)))))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_branch) _0_452))
in (let _0_453 = (FStar_Extraction_ML_Util.join then_e.FStar_Syntax_Syntax.pos f_then f_else)
in ((_0_454), (_0_453), (t_branch))))
end))
end))
end))
end
...
(let _0_455 = (FStar_All.pipe_right p (FStar_List.map (fun uu____5718 -> (match (uu____5718) with
| (p, wopt) -> begin
(
...
| uu____5792 -> begin
((FStar_Extraction_ML_UEnv.debug g (fun uu____5794 -> (let _0_457 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule e)
in (let _0_456 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t_e)
...
let uu____5807 = (let _0_459 = (let _0_458 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.failwith_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Extraction_ML_UEnv.lookup_fv g _0_458))
in (FStar_All.pipe_left FStar_Util.right _0_459))
in (match (uu____5807) with
| (fw, uu____5830, uu____5831) -> begin
(let _0_463 = (let _0_462 = FStar_Extraction_ML_Syntax.MLE_App ((let _0_461 = (let _0_460 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_string_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_String ("unreachable"))))
in (_0_460)::[])
in ((fw), (_0_461))))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_unit_ty) _0_462))
in ((_0_463), (FStar_Extraction_ML_Syntax.E_PURE), (FStar_Extraction_ML_Syntax.ml_unit_ty)))
end))
end
...
in (let _0_464 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_match) (FStar_Extraction_ML_Syntax.MLE_Match (((e), (mlbranches)))))
in ((_0_464), (f_match), (t_match)))))
end))
end)))
end))
end))
...
(let _0_467 = (FStar_All.pipe_right binders (FStar_List.filter (fun uu___117_6105 -> (match (uu___117_6105) with
...
in (FStar_All.pipe_right _0_467 (FStar_List.map (fun uu____6123 -> (let _0_466 = (fresh "_")
in ((_0_466), (FStar_Extraction_ML_Syntax.MLTY_Top)))))))
end
| uu____6129 -> begin
...
let discrBody = (let _0_479 = FStar_Extraction_ML_Syntax.MLE_Fun ((let _0_478 = (let _0_477 = FStar_Extraction_ML_Syntax.MLE_Match ((let _0_476 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty targ) (FStar_Extraction_ML_Syntax.MLE_Name ((([]), ((FStar_Extraction_ML_Syntax.idsym mlid))))))
in (let _0_475 = (let _0_474 = (let _0_470 = FStar_Extraction_ML_Syntax.MLP_CTor ((let _0_468 = (FStar_Extraction_ML_Syntax.mlpath_of_lident constrName)
in ((_0_468), ((FStar_Extraction_ML_Syntax.MLP_Wild)::[]))))
in (let _0_469 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (true))))
in ((_0_470), (None), (_0_469))))
in (let _0_473 = (let _0_472 = (let _0_471 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (false))))
in ((FStar_Extraction_ML_Syntax.MLP_Wild), (None), (_0_471)))
in (_0_472)::[])
in (_0_474)::_0_473))
in ((_0_476), (_0_475)))))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _0_477))
in (((FStar_List.append wildcards ((((mlid), (targ)))::[]))), (_0_478))))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty disc_ty) _0_479))
