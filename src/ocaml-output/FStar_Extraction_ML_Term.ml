      ...
      let uu____1809 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____1811 = FStar_Options.codegen ()  in
           uu____1811 = (FStar_Pervasives_Native.Some "Kremlin"))
         in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____1947 ->
          let uu____1948 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1949
             in
          failwith uu____1948
      | FStar_Syntax_Syntax.Tm_delayed uu____1950 ->
          let uu____1975 =
            let uu____1976 = FStar_Syntax_Print.term_to_string t1  in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1976
             in
          failwith uu____1975
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1977 =
            let uu____1978 = FStar_Syntax_Print.term_to_string t1  in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1978
             in
          failwith uu____1977
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2696, FStar_Extraction_ML_Syntax.ml_unit_ty)
                           in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b  in
              ...
              let when_clause =
                let uu____3066 =
                  let uu____3067 =
                    ...
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____3074)
                     in
                  FStar_Extraction_ML_Syntax.MLE_App uu____3067  in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____3066
                 in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          ...
          | uu____4478 -> failwith "Impossible: Unable to translate pattern"
           in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____4724 -> failwith "Impossible: Head type is not an arrow"
             in
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then
                let uu____5177 = maybe_coerce g e t ty  in (uu____5177, ty)
      ...
      (let t = FStar_Syntax_Subst.compress top  in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____5908::(v1,uu____5910)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____5956
              in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_int_ty
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6074
                   in
                let tm =
                  let uu____6084 =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8020
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8027  ->
                                    ...
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8229 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____8229) bs1
                                     in
      ...
      fun constrName  ->
        ...
        | (uu____11493,fstar_disc_type) ->
            let wildcards =
              ...
              | uu____11638 -> failwith "Discriminator must be a function"
               in
              ...
              let uu____11657 =
                let uu____11658 =
                  let uu____11669 =
                        ...
                        let uu____11686 =
                          let uu____11687 =
                            let uu____11688 =
                              ...
                              ([], uu____11689)  in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____11688
                             in
                          FStar_All.pipe_left
                            ...
                            let uu____11712 =
                              let uu____11713 =
                                ...
                                (uu____11720,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11713
                               in
                            let uu____11723 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11670
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11669)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11658  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11657
               in
            let uu____11821 =
              let uu____11822 =
                let uu____11825 =
