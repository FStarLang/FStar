    ...
    fun top  ->
      ...
      (let t = FStar_Syntax_Subst.compress top  in
       ...
       | FStar_Syntax_Syntax.Tm_meta
           (t1,FStar_Syntax_Syntax.Meta_monadic (m,uu____7900)) ->
           ...
           (match t2.FStar_Syntax_Syntax.n with
            ...
            | uu____7979 -> term_as_mlexpr g t2)
       | FStar_Syntax_Syntax.Tm_meta (t1,uu____7981) -> term_as_mlexpr g t1
       | FStar_Syntax_Syntax.Tm_uinst (t1,uu____7987) -> term_as_mlexpr g t1
                ...
                let uu____8010 =
                  let uu____8011 =
                    FStar_Extraction_ML_Util.mlexpr_of_const
                     ...
                     in
                  FStar_Extraction_ML_Syntax.with_ty ml_ty uu____8011  in
                (uu____8010, FStar_Extraction_ML_Syntax.E_PURE, ml_ty))
       | FStar_Syntax_Syntax.Tm_name uu____8012 ->
           let uu____8013 = is_type g t  in
           if uu____8013
           then
             (FStar_Extraction_ML_Syntax.ml_unit,
               FStar_Extraction_ML_Syntax.E_PURE,
             ...
             (let uu____8021 = FStar_Extraction_ML_UEnv.lookup_term g t  in
              match uu____8021 with
              | (FStar_Util.Inl uu____8034,uu____8035) ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                    FStar_Extraction_ML_Syntax.ml_unit_ty)
              | (FStar_Util.Inr
                 { FStar_Extraction_ML_UEnv.exp_b_name = uu____8040;
                   FStar_Extraction_ML_UEnv.exp_b_expr = x;
                   FStar_Extraction_ML_UEnv.exp_b_tscheme = mltys;
                   FStar_Extraction_ML_UEnv.exp_b_isrec = uu____8043;_},qual)
                  ->
                  (match mltys with
                   ...
                   | ([],t1) ->
                       ...
                       (uu____8057, FStar_Extraction_ML_Syntax.E_PURE, t1)
                   | uu____8058 -> err_uninst g t mltys t))
       | FStar_Syntax_Syntax.Tm_fvar fv ->
           let uu____8066 = is_type g t  in
           if uu____8066
           then
             (FStar_Extraction_ML_Syntax.ml_unit,
               FStar_Extraction_ML_Syntax.E_PURE,
             ...
             (let uu____8074 = FStar_Extraction_ML_UEnv.try_lookup_fv g fv
                 in
              ...
              | FStar_Pervasives_Native.None  ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    ...
                    FStar_Extraction_ML_Syntax.MLTY_Erased)
              | FStar_Pervasives_Native.Some
                  { FStar_Extraction_ML_UEnv.exp_b_name = uu____8083;
                    FStar_Extraction_ML_UEnv.exp_b_expr = x;
                    FStar_Extraction_ML_UEnv.exp_b_tscheme = mltys;
                    FStar_Extraction_ML_UEnv.exp_b_isrec = uu____8086;_}
                  ->
                  (match mltys with
                   | ([],t1) when t1 = FStar_Extraction_ML_Syntax.ml_unit_ty
                       ->
                   ...
                   | ([],t1) ->
                       let uu____8095 =
                         maybe_eta_data_and_project_record g
                          ...
                          in
                       (uu____8095, FStar_Extraction_ML_Syntax.E_PURE, t1)
                   | uu____8096 -> err_uninst g t mltys t))
       | FStar_Syntax_Syntax.Tm_abs (bs,body,rcopt) ->
           let uu____8130 = FStar_Syntax_Subst.open_term bs body  in
           (match uu____8130 with
            | (bs1,body1) ->
                let uu____8143 = binders_as_ml_binders g bs1  in
                     ...
                     let body2 =
                       ...
                       | FStar_Pervasives_Native.None  ->
                           (FStar_Extraction_ML_UEnv.debug g
                            ...
                            body1)
                        in
                     let uu____8183 = term_as_mlexpr env body2  in
                      ...
                      | (ml_body,f,t1) ->
                          let uu____8199 =
                            FStar_List.fold_right
                              (fun uu____8218  ->
                                 fun uu____8219  ->
                                   match (uu____8218, uu____8219) with
                                   | ((uu____8240,targ),(f1,t2)) ->
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.pos = uu____8267;
              FStar_Syntax_Syntax.vars = uu____8268;_},(a1,uu____8270)::[])
           ->
           let ty =
             let uu____8310 =
               FStar_Syntax_Syntax.tabbrev FStar_Parser_Const.range_lid  in
             term_as_mlty g uu____8310  in
           let uu____8311 =
             let uu____8312 =
             ...
             FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty ty)
               uu____8312
              in
           (uu____8311, FStar_Extraction_ML_Syntax.E_PURE, ty)
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_set_range_of );
              FStar_Syntax_Syntax.pos = uu____8313;
              FStar_Syntax_Syntax.vars = uu____8314;_},(t1,uu____8316)::
            (r,uu____8318)::[])
           -> term_as_mlexpr g t1
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_reflect uu____8373);
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,args) ->
           ...
           let uu____8444 =
             ...
             ((head1.FStar_Syntax_Syntax.n), uu____8449)  in
            ...
            | (FStar_Syntax_Syntax.Tm_uvar uu____8459,uu____8460) ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                   ...
                   in
                term_as_mlexpr g t1
            | (uu____8474,FStar_Syntax_Syntax.Tm_abs
               (bs,uu____8476,FStar_Pervasives_Native.Some rc)) when
                is_total rc ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Env.Beta;
                   ...
                   in
                term_as_mlexpr g t1
            | (uu____8501,FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_reify )) ->
                let e =
                  let uu____8503 = FStar_List.hd args  in
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____8503
                   in
                let tm =
                  let uu____8515 =
                    let uu____8520 = FStar_TypeChecker_Util.remove_reify e
                       in
                    let uu____8521 = FStar_List.tl args  in
                    FStar_Syntax_Syntax.mk_Tm_app uu____8520 uu____8521  in
                  uu____8515 FStar_Pervasives_Native.None
                    t.FStar_Syntax_Syntax.pos
                   in
                term_as_mlexpr g tm
            | uu____8532 ->
                let rec extract_app is_data uu____8585 uu____8586 restArgs =
                  match (uu____8585, uu____8586) with
                       ...
                       | ([],uu____8676) ->
                           ...
                           let app =
                             ...
                             FStar_All.pipe_left
                              ...
                              in
                           (app, f, t1)
                       | ((arg,uu____8715)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                          (formal_t,f',t2)) when
                           (is_type g arg) &&
                             (type_leq g formal_t
                                FStar_Extraction_ML_Syntax.ml_unit_ty)
                           ...
                           extract_app is_data
                             (mlhead,
                               ((FStar_Extraction_ML_Syntax.ml_unit,
                                  FStar_Extraction_ML_Syntax.E_PURE) ::
                               mlargs_f)) uu____8746 rest
                       | ((e0,uu____8763)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                          (tExpected,f',t2)) ->
                                ...
                                (match t1 with
                                 ...
                                 | uu____8912 ->
                                     err_ill_typed_application g top restArgs
                                       t1)))
                   in
                let extract_app_maybe_projector is_data mlhead uu____8960
                  args1 =
                  match uu____8960 with
                  | (f,t1) ->
                      (match is_data with
                       | FStar_Pervasives_Native.Some
                           (FStar_Syntax_Syntax.Record_projector uu____8990)
                           ->
                           let rec remove_implicits args2 f1 t2 =
                             match (args2, t2) with
                             | ((a0,FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____9074))::args3,FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____9076,f',t3)) ->
                                 let uu____9113 =
                                   FStar_Extraction_ML_Util.join
                                     a0.FStar_Syntax_Syntax.pos f1 f'
                                    in
                                 remove_implicits args3 uu____9113 t3
                             | uu____9114 -> (args2, f1, t2)  in
                           let uu____9139 = remove_implicits args1 f t1  in
                   ...
                   in
                let extract_app_with_instantiations uu____9219 =
                  let head2 = FStar_Syntax_Util.un_uinst head1  in
                  match head2.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Tm_name uu____9227 ->
                      let uu____9228 =
                        let uu____9247 =
                        ...
                        | (FStar_Util.Inr exp_b,q) ->
                            (((exp_b.FStar_Extraction_ML_UEnv.exp_b_expr),
                              ...
                              q)
                        | uu____9298 -> failwith "FIXME Ty"  in
                      (match uu____9228 with
                       | ((head_ml,(vars,t1),inst_ok),qual) ->
                           let has_typ_apps =
                             match args with
                             | (a,uu____9362)::uu____9363 -> is_type g a
                             | uu____9390 -> false  in
                           let uu____9401 =
                             match vars with
                             | uu____9430::uu____9431 when
                                        ...
                                        let mk_tapp e ty_args =
                                          ...
                                          | uu____9608 ->
                                              let uu___364_9611 = e  in
                                              {
                                                ...
                                                FStar_Extraction_ML_Syntax.mlty
                                                  =
                                                  (uu___364_9611.FStar_Extraction_ML_Syntax.mlty);
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___364_9611.FStar_Extraction_ML_Syntax.loc)
                                              }
                                           in
                                        let head3 =
                                          ...
                                          | FStar_Extraction_ML_Syntax.MLE_Name
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___365_9616.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___365_9616.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_Var
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___365_9618.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___365_9618.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_App
                                              (head3,{
                                                       FStar_Extraction_ML_Syntax.expr
                                                ...
                                                (FStar_Extraction_ML_Syntax.MLE_App
                                                   ((let uu___366_9627 =
                                                        ...
                                                        in
                                                     {
                                                       FStar_Extraction_ML_Syntax.expr
                                                         =
                                                         (uu___366_9627.FStar_Extraction_ML_Syntax.expr);
                                                       FStar_Extraction_ML_Syntax.mlty
                                                         =
                                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                            (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                       ...
                                                       FStar_Extraction_ML_Syntax.loc
                                                         =
                                                         (uu___366_9627.FStar_Extraction_ML_Syntax.loc)
                                                     }),
                                                     [FStar_Extraction_ML_Syntax.ml_unit]))
                                                (FStar_Extraction_ML_Syntax.with_ty
                                                   t2)
                                ...
                                (match args1 with
                                 ...
                                 | uu____9692 ->
                                     extract_app_maybe_projector qual
                                       ...
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         head_t) args1)))
                  | FStar_Syntax_Syntax.Tm_fvar uu____9701 ->
                      let uu____9702 =
                        let uu____9721 =
                          FStar_Extraction_ML_UEnv.lookup_term g head2  in
                        ...
                        | (FStar_Util.Inr exp_b,q) ->
                            (((exp_b.FStar_Extraction_ML_UEnv.exp_b_expr),
                               ...
                               (exp_b.FStar_Extraction_ML_UEnv.exp_b_isrec)),
                              q)
                        | uu____9772 -> failwith "FIXME Ty"  in
                      (match uu____9702 with
                       | ((head_ml,(vars,t1),inst_ok),qual) ->
                           let has_typ_apps =
                             match args with
                             | (a,uu____9836)::uu____9837 -> is_type g a
                             | uu____9864 -> false  in
                           let uu____9875 =
                             match vars with
                             | uu____9904::uu____9905 when
                                 (Prims.op_Negation has_typ_apps) && inst_ok
                                 -> (head_ml, t1, args)
                             | uu____9916 ->
                                 let n1 = FStar_List.length vars  in
                                        ...
                                        let mk_tapp e ty_args =
                                          ...
                                          | uu____10082 ->
                                              let uu___364_10085 = e  in
                                              {
                                                ...
                                                FStar_Extraction_ML_Syntax.mlty
                                                  =
                                                  (uu___364_10085.FStar_Extraction_ML_Syntax.mlty);
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___364_10085.FStar_Extraction_ML_Syntax.loc)
                                              }
                                           in
                                        let head3 =
                                          match head_ml.FStar_Extraction_ML_Syntax.expr
                                          ...
                                          | FStar_Extraction_ML_Syntax.MLE_Name
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___365_10090.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___365_10090.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_Var
                                              uu____10091 ->
                                              let uu___365_10092 =
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___365_10092.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___365_10092.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_App
                                              (head3,{
                                                       FStar_Extraction_ML_Syntax.expr
                                                ...
                                                (FStar_Extraction_ML_Syntax.MLE_App
                                                   ((let uu___366_10101 =
                                                        ...
                                                        in
                                                     {
                                                       FStar_Extraction_ML_Syntax.expr
                                                         =
                                                         (uu___366_10101.FStar_Extraction_ML_Syntax.expr);
                                                       FStar_Extraction_ML_Syntax.mlty
                                                         =
                                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                            (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                       ...
                                                       FStar_Extraction_ML_Syntax.loc
                                                         =
                                                         (uu___366_10101.FStar_Extraction_ML_Syntax.loc)
                                                     }),
                                                     [FStar_Extraction_ML_Syntax.ml_unit]))
                                                (FStar_Extraction_ML_Syntax.with_ty
                                                   t2)
                                 ...
                                 | uu____10166 ->
                                     extract_app_maybe_projector qual
                                       ...
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         head_t) args1)))
                  | uu____10175 ->
                      let uu____10176 = term_as_mlexpr g head2  in
                      (match uu____10176 with
                       | (head3,f,t1) ->
                           extract_app_maybe_projector
                             FStar_Pervasives_Native.None head3 (f, t1) args)
                   in
                let uu____10192 = is_type g t  in
                if uu____10192
                then
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                  ...
                  (let uu____10200 =
                     let uu____10201 = FStar_Syntax_Util.un_uinst head1  in
                     uu____10201.FStar_Syntax_Syntax.n  in
                       ...
                       (match uu____10211 with
                        | FStar_Pervasives_Native.None  ->
                            (FStar_Extraction_ML_Syntax.ml_unit,
                              FStar_Extraction_ML_Syntax.E_PURE,
                              FStar_Extraction_ML_Syntax.MLTY_Erased)
                        | uu____10220 -> extract_app_with_instantiations ())
                   | uu____10223 -> extract_app_with_instantiations ()))
       | FStar_Syntax_Syntax.Tm_ascribed (e0,(tc,uu____10226),f) ->
           let t1 =
             match tc with
           ...
           let uu____10293 = check_term_as_mlexpr g e0 f1 t1  in
           (match uu____10293 with | (e,t2) -> (e, f1, t2))
       | FStar_Syntax_Syntax.Tm_let ((is_rec,lbs),e') ->
           ...
           let uu____10324 =
             ...
             then FStar_Syntax_Subst.open_let_rec lbs e'
               ...
               (let uu____10338 = FStar_Syntax_Syntax.is_top_level lbs  in
                if uu____10338
                then (lbs, e')
                else
                  (let lb = FStar_List.hd lbs  in
                   let x =
                     ...
                     FStar_Syntax_Syntax.freshen_bv uu____10350  in
                   let lb1 =
                     let uu___367_10352 = lb  in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___367_10352.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___367_10352.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___367_10352.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___367_10352.FStar_Syntax_Syntax.lbdef);
                       FStar_Syntax_Syntax.lbattrs =
                         (uu___367_10352.FStar_Syntax_Syntax.lbattrs);
                       FStar_Syntax_Syntax.lbpos =
                         (uu___367_10352.FStar_Syntax_Syntax.lbpos)
                     }  in
                   let e'1 =
            ...
            | (lbs1,e'1) ->
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____10383
                               in
                            let lbdef =
                              let uu____10391 = FStar_Options.ml_ish ()  in
                              if uu____10391
                              then lb.FStar_Syntax_Syntax.lbdef
                               ...
                               in
                            let uu___368_10395 = lb  in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___368_10395.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___368_10395.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp =
                                (uu___368_10395.FStar_Syntax_Syntax.lbtyp);
                              FStar_Syntax_Syntax.lbeff =
                                (uu___368_10395.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef = lbdef;
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___368_10395.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___368_10395.FStar_Syntax_Syntax.lbpos)
                            }))
                  else lbs1  in
                let check_lb env uu____10445 =
                  ...
                  FStar_List.fold_right
                    (fun lb  ->
                       fun uu____10751  ->
                         ...
                         | (env,lbs4) ->
                             let uu____10876 = lb  in
                             (match uu____10876 with
                              | (lbname,uu____10924,(t1,(uu____10926,polytype)),add_unit,uu____10929)
                                  ->
                                  let uu____10942 =
                ...
                (match uu____10659 with
                 | (env_body,lbs4) ->
                     ...
                     let uu____11236 = term_as_mlexpr env_body e'1  in
                              ...
                              let uu____11267 =
                                let uu____11268 =
                                  FStar_List.map FStar_Pervasives_Native.snd
                                    lbs5
                                   in
                                (is_rec1, uu____11268)  in
                              mk_MLE_Let top_level uu____11267 e'2  in
                            let uu____11277 =
                              FStar_Extraction_ML_Util.mlloc_of_range
                                t.FStar_Syntax_Syntax.pos
                               in
                            FStar_Extraction_ML_Syntax.with_ty_loc t'
                              uu____11266 uu____11277
                             in
                          (uu____11265, f, t'))))
       | FStar_Syntax_Syntax.Tm_match (scrutinee,pats) ->
           let uu____11316 = term_as_mlexpr g scrutinee  in
           (match uu____11316 with
            | (e,f_e,t_e) ->
                let uu____11332 = check_pats_for_ite pats  in
                       ...
                       (match (then_e, else_e) with
                        | (FStar_Pervasives_Native.Some
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            let uu____11393 = term_as_mlexpr g then_e1  in
                            (match uu____11393 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____11409 = term_as_mlexpr g else_e1
                                    in
                                 ...
                                 (match uu____12105 with
                                  | {
                                      ...
                                      (uu____12117,
                                        FStar_Extraction_ML_Syntax.E_PURE,
                                        FStar_Extraction_ML_Syntax.ml_int_ty))
                             | (uu____12132,uu____12133,(uu____12134,f_first,t_first))::rest
                                 ->
                                 let uu____12194 =
                                   FStar_List.fold_left
                                     (fun uu____12236  ->
                                        fun uu____12237  ->
                                          match (uu____12236, uu____12237)
                                          with
                                          | ((topt,f),(uu____12294,uu____12295,
                                                       (uu____12296,f_branch,t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
        ...
        let uu____12532 =
          let uu____12537 =
            FStar_TypeChecker_Env.lookup_lid
             ...
             in
          FStar_All.pipe_left FStar_Pervasives_Native.fst uu____12537  in
        match uu____12532 with
        | (uu____12562,fstar_disc_type) ->
            let wildcards =
              let uu____12571 =
                let uu____12572 = FStar_Syntax_Subst.compress fstar_disc_type
                   in
                uu____12572.FStar_Syntax_Syntax.n  in
              match uu____12571 with
              | FStar_Syntax_Syntax.Tm_arrow (binders,uu____12582) ->
                  let uu____12603 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___359_12637  ->
                            match uu___359_12637 with
                            | (uu____12644,FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____12645)) ->
                                true
                            | uu____12648 -> false))
                     in
                  FStar_All.pipe_right uu____12603
                    (FStar_List.map
                       (fun uu____12681  ->
                          let uu____12688 = fresh "_"  in
                          (uu____12688, FStar_Extraction_ML_Syntax.MLTY_Top)))
              | uu____12689 -> failwith "Discriminator must be a function"
               in
                            ...
                            let uu____12752 =
                              let uu____12753 =
                                ...
                                (uu____12760,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____12753
                               in
                            let uu____12763 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                               ...
                               in
                            (uu____12752, FStar_Pervasives_Native.None,
                              uu____12763)
                             in
                          let uu____12766 =
                            let uu____12777 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                               ...
                               in
                            [uu____12777]  in
                          uu____12743 :: uu____12766  in
                        (uu____12729, uu____12732)  in
                      FStar_Extraction_ML_Syntax.MLE_Match uu____12714  in
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____12713
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____12712)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____12701  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____12700
               in
            let uu____12841 =
              let uu____12842 =
                let uu____12845 =
                  let uu____12846 =
                    FStar_Extraction_ML_UEnv.convIdent
                     ...
                     in
                  {
                    FStar_Extraction_ML_Syntax.mllb_name = uu____12846;
                    FStar_Extraction_ML_Syntax.mllb_tysc =
                      FStar_Pervasives_Native.None;
                ...
                [uu____12845]  in
              (FStar_Extraction_ML_Syntax.NonRec, uu____12842)  in
            FStar_Extraction_ML_Syntax.MLM_Let uu____12841
