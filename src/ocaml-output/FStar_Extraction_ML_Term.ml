                 ...
                 let fvty1 =
                   ...
                   FStar_TypeChecker_Normalize.normalize
                     [FStar_TypeChecker_Env.UnfoldUntil
                        FStar_Syntax_Syntax.delta_constant] uu____3065 fvty in
                ...
                let uu____9575 =
                  let uu____9576 =
                    ...
                    FStar_TypeChecker_Normalize.normalize
                      ...
                      FStar_TypeChecker_Env.EraseUniverses;
                      FStar_TypeChecker_Env.AllowUnboundUniverses] uu____9581 in
            ...
            | (lbs1, e'1) ->
                                   ...
                                   ((let uu____11937 =
                                    ...
                                    (let a =
                                       ...
                                       FStar_Util.measure_execution_time
                                         uu____11941 norm_call in
                                     a))
                                 else norm_call ()) in
                            let uu___1816_11946 = lb in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___1816_11946.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___1816_11946.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp =
                                (uu___1816_11946.FStar_Syntax_Syntax.lbtyp);
                              FStar_Syntax_Syntax.lbeff =
                                (uu___1816_11946.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef = lbdef;
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___1816_11946.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___1816_11946.FStar_Syntax_Syntax.lbpos)
                            }))
                  else lbs1 in
                let check_lb env uu____11996 =
                  ...
                  FStar_List.fold_right
                    (fun lb ->
                       fun uu____12302 ->
                         ...
                         | (env, lbs4) ->
                             let uu____12427 = lb in
                             (match uu____12427 with
                              | (lbname, uu____12475,
                                 (t1, (uu____12477, polytype)), add_unit,
                                 uu____12480) ->
                                  let uu____12493 =
                ...
                (match uu____12210 with
                 | (env_body, lbs4) ->
                     ...
                     let uu____12787 = term_as_mlexpr env_body e'1 in
                              ...
                              let uu____12818 =
                                let uu____12819 =
                                  FStar_List.map FStar_Pervasives_Native.snd
                                    lbs5 in
                                (is_rec1, uu____12819) in
                              mk_MLE_Let top_level uu____12818 e'2 in
                            let uu____12828 =
                              FStar_Extraction_ML_Util.mlloc_of_range
                                t.FStar_Syntax_Syntax.pos in
                            FStar_Extraction_ML_Syntax.with_ty_loc t'
                              uu____12817 uu____12828 in
                          (uu____12816, f, t'))))
       | FStar_Syntax_Syntax.Tm_match (scrutinee, pats) ->
           let uu____12867 = term_as_mlexpr g scrutinee in
           (match uu____12867 with
            | (e, f_e, t_e) ->
                let uu____12883 = check_pats_for_ite pats in
                       ...
                       (match (then_e, else_e) with
                        | (FStar_Pervasives_Native.Some then_e1,
                           FStar_Pervasives_Native.Some else_e1) ->
                            let uu____12944 = term_as_mlexpr g then_e1 in
                            (match uu____12944 with
                             | (then_mle, f_then, t_then) ->
                                 let uu____12960 = term_as_mlexpr g else_e1 in
                                      ...
                                      (match uu____12976 with
                                       | (t_branch, maybe_lift) ->
                                           let uu____13049 =
                                             ...
                                             FStar_All.pipe_left
                                               (FStar_Extraction_ML_Syntax.with_ty
                                                  t_branch) uu____13050 in
                                           let uu____13067 =
                                             FStar_Extraction_ML_Util.join
                                               then_e1.FStar_Syntax_Syntax.pos
                                               f_then f_else in
                                           (uu____13049, uu____13067,
                                             t_branch))))
                        | uu____13068 ->
                            failwith
                                 ...
                                 (match uu____13658 with
                                  | {
                                      ...
                                      (uu____13669,
                                        FStar_Extraction_ML_Syntax.E_PURE,
                                        FStar_Extraction_ML_Syntax.ml_int_ty))
                             | (uu____13684, uu____13685,
                                (uu____13686, f_first, t_first))::rest ->
                                 let uu____13746 =
                                   FStar_List.fold_left
                                     (fun uu____13788 ->
                                        fun uu____13789 ->
                                          match (uu____13788, uu____13789)
                                          with
                                          | ((topt, f),
                                             (uu____13846, uu____13847,
                                              (uu____13848, f_branch,
                                               t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
  ...
  fun env ->
    fun discName ->
      fun constrName ->
        let uu____14084 =
          let uu____14089 =
            let uu____14098 = FStar_Extraction_ML_UEnv.tcenv_of_uenv env in
            FStar_TypeChecker_Env.lookup_lid uu____14098 discName in
          FStar_All.pipe_left FStar_Pervasives_Native.fst uu____14089 in
        match uu____14084 with
        | (uu____14115, fstar_disc_type) ->
            let uu____14117 =
              let uu____14128 =
                let uu____14129 = FStar_Syntax_Subst.compress fstar_disc_type in
                uu____14129.FStar_Syntax_Syntax.n in
              match uu____14128 with
              | FStar_Syntax_Syntax.Tm_arrow (binders, uu____14143) ->
                  let binders1 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___2_14198 ->
                            match uu___2_14198 with
                            | (uu____14205, FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____14206)) ->
                                true
                            | uu____14209 -> false)) in
                  FStar_List.fold_right
                    (fun uu____14239 ->
                       fun uu____14240 ->
                             ...
                             (match uu____14281 with
                              | (g1, v) ->
                                  (g1,
                                    ...
                                    :: vs)))) binders1 (env, [])
              | uu____14318 -> failwith "Discriminator must be a function" in
            (match uu____14117 with
             | (g, wildcards) ->
                 let uu____14343 = FStar_Extraction_ML_UEnv.new_mlident g in
                        ...
                        let uu____14353 =
                          let uu____14354 =
                                    ...
                                    let uu____14419 =
                                      let uu____14430 =
                                        ...
                                        (FStar_Extraction_ML_Syntax.MLP_Wild,
                                          ...
                                          uu____14439) in
                                      [uu____14430] in
                                    uu____14396 :: uu____14419 in
                                  (uu____14382, uu____14385) in
                                FStar_Extraction_ML_Syntax.MLE_Match
                                  uu____14367 in
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                            ...
                            ((FStar_List.append wildcards [(mlid, targ)]),
                              uu____14365) in
                          FStar_Extraction_ML_Syntax.MLE_Fun uu____14354 in
                        FStar_All.pipe_left
