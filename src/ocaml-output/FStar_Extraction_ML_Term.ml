      ...
      let aux env t =
        ...
        | FStar_Syntax_Syntax.Tm_bvar uu____3408 ->
            let uu____3409 =
              ...
              FStar_Util.format1 "Impossible: Unexpected term %s" uu____3411 in
            failwith uu____3409
        | FStar_Syntax_Syntax.Tm_delayed uu____3414 ->
            let uu____3437 =
              let uu____3439 = FStar_Syntax_Print.term_to_string t1 in
              FStar_Util.format1 "Impossible: Unexpected term %s" uu____3439 in
            failwith uu____3437
        | FStar_Syntax_Syntax.Tm_unknown ->
            let uu____3442 =
              let uu____3444 = FStar_Syntax_Print.term_to_string t1 in
              FStar_Util.format1 "Impossible: Unexpected term %s" uu____3444 in
            failwith uu____3442
        | FStar_Syntax_Syntax.Tm_lazy i ->
                      ...
                      let t_ret =
                        let uu____3604 =
                          maybe_reify_comp env1
                            env1.FStar_Extraction_ML_UEnv.env_tcenv c1 in
                  ...
                  | (ml_bs, env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____4023, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b in
                         let t =
                ...
                let uu____4443 =
                      ...
                      let uu____4456 =
                        ...
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.ml_int_ty) uu____4457 in
                  ...
                  | FStar_Pervasives_Native.Some sw ->
                      ...
                      (match uu____4480 with
                       | (mlterm, uu____4492, mlty) -> (mlterm, mlty)) in
                (match uu____4443 with
                 | (mlc, ml_ty) ->
                     ...
                     let when_clause =
                       ...
                       FStar_All.pipe_left
                         (FStar_Extraction_ML_Syntax.with_ty
                            FStar_Extraction_ML_Syntax.ml_bool_ty) uu____4514 in
        ...
        fun mlAppExpr ->
            ...
            | uu____6318 ->
                let uu____6319 =
                  ...
                  FStar_Util.format2
                    ...
                    uu____6321 uu____6323 in
                failwith uu____6319 in
          let as_record qual1 e =
            match ((e.FStar_Extraction_ML_Syntax.expr), qual1) with
            | (FStar_Extraction_ML_Syntax.MLE_CTor (uu____6358, args),
          ...
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____6554;_},
              mle::args),
             FStar_Pervasives_Native.Some
              ...
              let e =
                ...
                | uu____6577 ->
                    let uu____6580 =
                      ...
                      (uu____6587, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____6580 in
              FStar_Extraction_ML_Syntax.with_ty
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____6592;_},
                   uu____6593);
                FStar_Extraction_ML_Syntax.mlty = uu____6594;
                FStar_Extraction_ML_Syntax.loc = uu____6595;_},
              mle::args),
             FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_projector (constrname, f))) ->
              let f1 =
                      ...
                      let uu____6632 =
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top) proj in
                      (uu____6632, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____6625 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____6637;_},
              mlargs),
          ...
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____6650;_},
              mlargs),
             FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Record_ctor
             uu____6652)) ->
              let uu____6665 =
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____6670;_},
                   uu____6671);
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____6690;_},
                   uu____6691);
          ...
          | (FStar_Extraction_ML_Syntax.MLE_TApp
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____6736;_},
              uu____6737),
             FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)) ->
              let uu____6744 =
                FStar_All.pipe_left
          ...
          | (FStar_Extraction_ML_Syntax.MLE_TApp
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____6749;_},
              uu____6750),
             FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Record_ctor
             uu____6751)) ->
              let uu____6764 =
                          ...
                          let uu____7190 =
                            FStar_Util.prefix_until
                              (fun x ->
                                 ...
                                 Prims.op_Negation uu____7236) bs1 in
        ...
        (fun u ->
           let uu____8712 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____8714 uu____8716 uu____8718 in
      ...
      (let is_match t =
           ...
           (match uu____9197 with
            | { FStar_Extraction_ML_UEnv.exp_b_name = uu____9205;
                ...
                let uu____9211 =
                  ...
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_int_ty) uu____9212 in
           ...
           (match uu____9241 with
            ...
            | tv ->
                ...
                let t1 =
                  ...
                  FStar_Syntax_Util.mk_app
                    (FStar_Reflection_Data.refl_constant_term
                       FStar_Reflection_Data.fstar_refl_pack_ln) uu____9328 in
                term_as_mlexpr g t1)
             ...
             (let uu____9498 = FStar_Extraction_ML_UEnv.lookup_term g t in
              ...
              | (FStar_Util.Inr
                 { FStar_Extraction_ML_UEnv.exp_b_name = uu____9517;
                   ...
                   FStar_Extraction_ML_UEnv.exp_b_inst_ok = uu____9520;_},
                 qual) ->
                  (match mltys with
       ...
       | FStar_Syntax_Syntax.Tm_fvar fv ->
           ...
           then
             ...
             (let uu____9552 = FStar_Extraction_ML_UEnv.try_lookup_fv g fv in
              ...
              | FStar_Pervasives_Native.Some
                  ...
                  (FStar_Extraction_ML_UEnv.debug g
                     (fun uu____9572 ->
                        let uu____9573 = FStar_Syntax_Print.fv_to_string fv in
                        let uu____9575 =
                          FStar_Extraction_ML_Code.string_of_mlexpr
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____9772;_},
            (a1, uu____9774)::[])
           ->
           let ty =
             let uu____9814 =
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____9818;_},
            (t1, uu____9820)::(r, uu____9822)::[])
           -> term_as_mlexpr g t1
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
              ...
              FStar_Syntax_Syntax.vars = uu____9879;_},
            uu____9880)
           ...
           let uu____9998 =
             let uu____10003 =
               let uu____10004 =
                 let uu____10007 =
                   FStar_All.pipe_right head1 FStar_Syntax_Subst.compress in
                 FStar_All.pipe_right uu____10007 FStar_Syntax_Util.unascribe in
            ...
            | (FStar_Syntax_Syntax.Tm_uvar uu____10016, uu____10017) ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    ...
                    g.FStar_Extraction_ML_UEnv.env_tcenv t in
                term_as_mlexpr g t1
            | (uu____10031, FStar_Syntax_Syntax.Tm_abs
               (bs, uu____10033, _rc)) ->
                let uu____10059 =
                  FStar_All.pipe_right t
                    (FStar_TypeChecker_Normalize.normalize
                       ...
                       FStar_TypeChecker_Env.EraseUniverses;
                       FStar_TypeChecker_Env.AllowUnboundUniverses]
                       g.FStar_Extraction_ML_UEnv.env_tcenv) in
               ...
               (FStar_Const.Const_reify)) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.env_tcenv
                    [FStar_TypeChecker_Env.Inlining] head1 uu____10068 in
                let tm =
                  let uu____10080 =
                    let uu____10085 = FStar_TypeChecker_Util.remove_reify e in
                       ...
                       | FStar_Pervasives_Native.Some
                           ...
                           let rec remove_implicits args2 f1 t2 =
                             ...
                             | ((a0, FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____10712))::args3,
                                FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____10714, f', t3)) ->
                                 let uu____10752 =
                                   FStar_Extraction_ML_Util.join
       ...
       | FStar_Syntax_Syntax.Tm_ascribed (e0, (tc, uu____12202), f) ->
           let t1 =
             ...
             | FStar_Util.Inr c ->
                 let uu____12267 =
                   maybe_reify_comp g g.FStar_Extraction_ML_UEnv.env_tcenv c in
                 term_as_mlty g uu____12267 in
           let f1 =
             match f with
             | FStar_Pervasives_Native.None ->
                       ...
                       fun uu____12806 ->
                         ...
                         | (env, lbs4) ->
                             ...
                             (match uu____12940 with
                              | (lbname, uu____12991,
                                 (t1, (uu____12993, polytype)), add_unit,
                                 uu____12996) ->
                                  let uu____13011 =
                           ...
                           FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____13496 with
                             | (then_mle, f_then, t_then) ->
                                 let uu____13512 = term_as_mlexpr g else_e1 in
                        ...
                        | (pat_t_compat, mlbranches) ->
                            ...
                            (match mlbranches1 with
                             ...
                             | (uu____14266, uu____14267,
                                (uu____14268, f_first, t_first))::rest ->
                                 let uu____14328 =
                                   FStar_List.fold_left
                                     (fun uu____14370 ->
                                        fun uu____14371 ->
    ...
    fun discName ->
      fun constrName ->
        ...
        | (uu____14703, fstar_disc_type) ->
            let wildcards =
              let uu____14713 =
                let uu____14714 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              | uu____14841 -> failwith "Discriminator must be a function" in
              ...
              let uu____14856 =
                let uu____14857 =
                  let uu____14869 =
                        ...
                        let uu____14892 =
                          let uu____14903 =
                            let uu____14912 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____14913 in
                            let uu____14923 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                          ...
                          let uu____14927 =
                            let uu____14938 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____14947) in
                            [uu____14938] in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____14870 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____14869) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____14857 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____14856 in
            let uu____15008 =
              let uu____15009 =
                let uu____15012 =
                  let uu____15013 =
