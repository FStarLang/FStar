...
in (FStar_All.pipe_left (fun _0_44 -> FStar_Extraction_ML_Syntax.MLE_Const (_0_44)) uu____3145))
...
let uu____4198 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun uu___143_4249 -> (match (uu___143_4249) with
...
in (FStar_All.pipe_left (fun _0_45 -> FStar_Extraction_ML_Syntax.MLE_Const (_0_45)) uu____5544))
...
let is_total = (fun rc -> ((FStar_Ident.lid_equals rc.FStar_Syntax_Syntax.residual_effect FStar_Parser_Const.effect_Tot_lid) || (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags (FStar_List.existsb (fun uu___144_6075 -> (match (uu___144_6075) with
...
in {FStar_Extraction_ML_Syntax.expr = uu___148_7412.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___148_7412.FStar_Extraction_ML_Syntax.loc})
end
| FStar_Extraction_ML_Syntax.MLE_Var (uu____7413) -> begin
(

let uu___148_7414 = head_ml
in {FStar_Extraction_ML_Syntax.expr = uu___148_7414.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___148_7414.FStar_Extraction_ML_Syntax.loc})
end
...
let uu___149_7423 = head3
in {FStar_Extraction_ML_Syntax.expr = uu___149_7423.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t2))); FStar_Extraction_ML_Syntax.loc = uu___149_7423.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t2))
end
| uu____7424 -> begin
...
in {FStar_Extraction_ML_Syntax.expr = uu___148_7820.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___148_7820.FStar_Extraction_ML_Syntax.loc})
end
| FStar_Extraction_ML_Syntax.MLE_Var (uu____7821) -> begin
(

let uu___148_7822 = head_ml
in {FStar_Extraction_ML_Syntax.expr = uu___148_7822.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___148_7822.FStar_Extraction_ML_Syntax.loc})
end
...
let uu___149_7831 = head3
in {FStar_Extraction_ML_Syntax.expr = uu___149_7831.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t2))); FStar_Extraction_ML_Syntax.loc = uu___149_7831.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t2))
end
| uu____7832 -> begin
(failwith "Impossible: Unexpected head term")
end)
...
let uu___150_8050 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___150_8050.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___150_8050.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___150_8050.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___150_8050.FStar_Syntax_Syntax.lbdef})
in (
...
let uu___151_8097 = lb
in {FStar_Syntax_Syntax.lbname = uu___151_8097.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___151_8097.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___151_8097.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___151_8097.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbdef}));
)))))
end
| uu____8098 -> begin
lbs1
...
let uu____11563 = (FStar_All.pipe_right binders (FStar_List.filter (fun uu___145_11595 -> (match (uu___145_11595) with
