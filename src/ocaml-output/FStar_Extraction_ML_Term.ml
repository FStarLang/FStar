      ...
      | FStar_Syntax_Syntax.Tm_bvar _
        |FStar_Syntax_Syntax.Tm_delayed _|FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1151 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1152
             in
          failwith uu____1151
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____1568, FStar_Extraction_ML_Syntax.ml_unit_ty)
                           in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = fst b  in
          ...
          fun expected_topt  ->
            ...
            | FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_int
                ...
                let when_clause =
                  ...
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_bool_ty) uu____1801
                   in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 disj g1 p1 expected_t1 =
          ...
          | uu____2557 -> failwith "Impossible: Unable to translate pattern"
           in
                   ...
                   FStar_Util.fold_map
                     (fun b1  ->
                        fun p3  ->
                          ...
                          | (uu____2655,p4,b') -> ((b1 && b'), p4)) b pats
                    in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____2960 -> failwith "Impossible: Head type is not an arrow"
             in
                    ...
                    let uu____3101 =
                      let uu____3105 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____3105, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____3101
                 in
              FStar_Extraction_ML_Syntax.with_ty
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then
                let uu____3239 = maybe_coerce g e t ty  in (uu____3239, ty)
        ...
        (fun u  ->
           let uu____3250 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____3251 uu____3252 uu____3253
              in
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____3709
                   in
                let tm =
                  let uu____3717 =
                    let uu____3718 = FStar_TypeChecker_Util.remove_reify e
                       in
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____4610
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4614  ->
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____4697 = FStar_Syntax_Subst.open_comp bs c
                              in
                                ...
                                let uu____4711 =
                                  let uu____4716 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____4734 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____4734) bs1
                                     in
                      ...
                      | (e'2,f',t') ->
                          let f =
                            let uu____5605 =
                              ...
                              f' :: uu____5607  in
                            FStar_Extraction_ML_Util.join_l e'_rng uu____5605
                             in
                          let is_rec1 =
                            if is_rec = true
                        ...
                        | (Some then_e1,Some else_e1) ->
                            ...
                            (match uu____5696 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____5706 = term_as_mlexpr g else_e1
                                    in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____6389,fstar_disc_type) ->
            let wildcards =
              let uu____6397 =
                let uu____6398 = FStar_Syntax_Subst.compress fstar_disc_type
                   in
              ...
              let uu____6481 =
                let uu____6482 =
                  let uu____6488 =
                        ...
                        let uu____6498 =
                          let uu____6499 =
                            let uu____6500 =
                              ...
                              ([], uu____6501)  in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____6500
                             in
                          FStar_All.pipe_left
                            ...
                            let uu____6514 =
                              let uu____6515 =
                                ...
                                (uu____6519,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____6515
                               in
                            let uu____6521 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____6489
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____6488)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____6482  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____6481
               in
            let uu____6572 =
              let uu____6573 =
                let uu____6575 =
