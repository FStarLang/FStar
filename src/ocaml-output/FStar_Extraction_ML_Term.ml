...
let err_ill_typed_erasure :
  'uuuuuu261 .
    FStar_Extraction_ML_UEnv.uenv ->
      FStar_Range.range -> FStar_Extraction_ML_Syntax.mlty -> 'uuuuuu261
  =
  fun env  ->
    fun pos  ->
      fun ty  ->
...
let err_value_restriction :
  'uuuuuu295 .
    FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax -> 'uuuuuu295
  =
  fun t  ->
    let uu____305 =
      let uu____311 =
...
let is_type_binder :
  'uuuuuu1376 .
    FStar_Extraction_ML_UEnv.uenv ->
      (FStar_Syntax_Syntax.bv * 'uuuuuu1376) -> Prims.bool
  =
  fun env  ->
    fun x  ->
