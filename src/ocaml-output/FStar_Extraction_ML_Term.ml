...
let err_uninst env t uu____105 app =
  ...
  | (vars,ty) ->
      let _0_344 =
        ...
        let _0_342 =
          let _0_339 = FStar_All.pipe_right vars (FStar_List.map Prims.fst) in
        ...
        FStar_Util.format4
          ...
          _0_343 _0_342 _0_341 _0_340 in
    ...
    let rec aux bs t copt =
      ...
      | uu____813 ->
          ...
          (match uu____815 with
           | true  -> aux bs e' copt
           | uu____816 -> FStar_Syntax_Util.abs bs e' copt) in
    aux [] t0 None
                      ...
                      (match uu____1451 with
                       | true  ->
                           ...
                           let ml_b =
                             ...
                             (_0_367, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                           ((ml_b :: ml_bs), env)
                       | uu____1477 ->
                           let b = Prims.fst b in
                           let t =
                    ...
                    FStar_Extraction_ML_Syntax.MLE_App
                      (let _0_377 =
                         ...
                         let _0_375 =
                           ...
                           [_0_374] in
                         _0_376 :: _0_375 in
                       (FStar_Extraction_ML_Util.prims_op_equality, _0_377)) in
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_bool_ty) _0_378 in
                                 ...
                                 | () ->
                                     ...
                                     Some
                                       (FStar_Extraction_ML_Util.uncurry_mlty_fun
                                          f_ty))
                              (fun uu___119_1901  ->
                                 match uu___119_1901 with
                                 | Un_extractable  -> None) in
                          let uu____1909 =
                            FStar_Util.fold_map
                              (fun g  ->
                                 fun uu____1924  ->
                             ...
                             FStar_All.pipe_right ps_when
                               (FStar_List.map
                                  (fun uu____2613  ->
                                     ...
                                     | (x,whens) ->
                                         let _0_394 = mk_when_clause whens in
                                         (x, _0_394))) in
                           let res =
                             match rest with
                             | [] -> (g, ps, b)
  ...
  fun g  ->
    fun top  ->
      ...
      (let t = FStar_Syntax_Subst.compress top in
            ...
            | (uu____3191,ty,uu____3193) ->
                ...
                let _0_424 =
                  let _0_423 =
                    ...
                    FStar_All.pipe_left
                      (fun _0_421  ->
                         FStar_Extraction_ML_Syntax.MLE_Const _0_421) _0_422 in
       ...
       | FStar_Syntax_Syntax.Tm_app (head,args) ->
           let is_total uu___117_3450 =
             match uu___117_3450 with
                           ...
                           (fun lb  ->
                              let tcenv =
                                ...
                                FStar_TypeChecker_Env.set_current_module
                                  g.FStar_Extraction_ML_UEnv.tcenv _0_442 in
                              FStar_Extraction_ML_UEnv.debug g
                                (fun uu____4374  ->
              ...
              let _0_488 =
                FStar_Extraction_ML_Syntax.MLE_Fun
                  (let _0_487 =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.ml_bool_ty) _0_486 in
                   ((FStar_List.append wildcards [(mlid, targ)]), _0_487)) in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) _0_488 in
