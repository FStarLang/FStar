  ...
  fun l  ->
    ...
    then def
      ...
      (let uu____1589 = FStar_List.hd l in
       ...
       | (p1,w1,e1) ->
           let uu____1623 =
             let uu____1632 = FStar_List.tl l in FStar_List.hd uu____1632 in
                 ...
                 (fun uu____1849  ->
                    ...
                    | (v1,t1) ->
                        FStar_Extraction_ML_Syntax.with_ty t1
                          (FStar_Extraction_ML_Syntax.MLE_Var v1)) uu____1831 in
             let body =
      ...
      let uu____1877 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____1879 = FStar_Options.codegen () in
           uu____1879 = (FStar_Pervasives_Native.Some "Kremlin")) in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____2015 ->
          let uu____2016 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____2017 in
          failwith uu____2016
      | FStar_Syntax_Syntax.Tm_delayed uu____2018 ->
          let uu____2043 =
            let uu____2044 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____2044 in
          failwith uu____2043
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____2045 =
            let uu____2046 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____2046 in
          failwith uu____2045
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2764, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b in
              ...
              let when_clause =
                let uu____3134 =
                  let uu____3135 =
                    ...
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____3142) in
                  FStar_Extraction_ML_Syntax.MLE_App uu____3135 in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____3134 in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          ...
          | uu____4546 -> failwith "Impossible: Unable to translate pattern" in
        let mk_when_clause whens =
          ...
          | hd1::tl1 ->
              ...
              FStar_Pervasives_Native.Some uu____4589 in
        let uu____4590 =
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____4792 -> failwith "Impossible: Head type is not an arrow" in
              ...
              let e =
                ...
                | uu____5022 ->
                    let uu____5025 =
                      ...
                      (uu____5032, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____5025 in
              FStar_Extraction_ML_Syntax.with_ty
                      ...
                      let uu____5081 =
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top) proj in
                      (uu____5081, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____5074 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then let uu____5374 = maybe_coerce g e t ty in (uu____5374, ty)
        ...
        (fun u  ->
           let uu____5392 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____5393 uu____5394 uu____5395 in
      ...
      (let t = FStar_Syntax_Subst.compress top in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____6105::(v1,uu____6107)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____6153 in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_int_ty
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6271 in
                let tm =
                  let uu____6281 =
                    let uu____6282 = FStar_TypeChecker_Util.remove_reify e in
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7556 ->
                                               let uu___149_7559 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___149_7559.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___149_7559.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___150_7564.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___150_7564.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7565 ->
                                               let uu___150_7566 =
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___150_7566.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___150_7566.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___151_7575 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___151_7575.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___151_7575.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7981 ->
                                               let uu___149_7984 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___149_7984.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___149_7984.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           match head_ml.FStar_Extraction_ML_Syntax.expr
                                           with
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___150_7989.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___150_7989.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7990 ->
                                               let uu___150_7991 =
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___150_7991.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___150_7991.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___151_8000 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___151_8000.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___151_8000.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
               ...
               (let uu____8203 = FStar_Syntax_Syntax.is_top_level lbs in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs in
                   ...
                   let lb1 =
                     let uu___152_8219 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___152_8219.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___152_8219.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___152_8219.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___152_8219.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e'1 =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8251 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8258  ->
                            ...
                            (let lbdef =
                             ...
                             let uu___153_8266 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___153_8266.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___153_8266.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___153_8266.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___153_8266.FStar_Syntax_Syntax.lbeff);
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____8392 = FStar_Syntax_Subst.open_comp bs c in
                                ...
                                let uu____8417 =
                                  let uu____8424 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8460 = is_type_binder g x in
                                         Prims.op_Negation uu____8460) bs1 in
                           ...
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____10463 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____10479 = term_as_mlexpr g else_e1 in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____11687,fstar_disc_type) ->
            let wildcards =
              let uu____11700 =
                let uu____11701 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              | uu____11832 -> failwith "Discriminator must be a function" in
              ...
              let uu____11851 =
                let uu____11852 =
                  let uu____11863 =
                        ...
                        let uu____11880 =
                          let uu____11881 =
                            let uu____11882 =
                              ...
                              ([], uu____11883) in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____11882 in
                          FStar_All.pipe_left
                        ...
                        let uu____11886 =
                          let uu____11897 =
                            let uu____11906 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11907 in
                            let uu____11917 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                          ...
                          let uu____11920 =
                            let uu____11931 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11940) in
                            [uu____11931] in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11864 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11863) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11852 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11851 in
            let uu____12015 =
              let uu____12016 =
                let uu____12019 =
                  let uu____12020 =
