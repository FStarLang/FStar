...
let uu____2339 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun uu___138_2364 -> (match (uu___138_2364) with
| Some (x) -> begin
(x)::[]
end
| uu____2386 -> begin
...
let uu____2669 = (FStar_All.pipe_right ps1 (FStar_List.partition (fun uu___139_2697 -> (match (uu___139_2697) with
...
let is_total = (fun uu___141_3661 -> (match (uu___141_3661) with
| FStar_Util.Inl (l) -> begin
(FStar_Syntax_Util.is_total_lcomp l)
end
| FStar_Util.Inr (l, flags) -> begin
((FStar_Ident.lid_equals l FStar_Syntax_Const.effect_Tot_lid) || (FStar_All.pipe_right flags (FStar_List.existsb (fun uu___140_3679 -> (match (uu___140_3679) with
...
let uu___145_4451 = head_ml
in {FStar_Extraction_ML_Syntax.expr = uu___145_4451.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___145_4451.FStar_Extraction_ML_Syntax.loc})
end
...
let uu___146_4457 = head3
in {FStar_Extraction_ML_Syntax.expr = uu___146_4457.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t2))); FStar_Extraction_ML_Syntax.loc = uu___146_4457.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t2))
end
| uu____4458 -> begin
...
let uu___147_4611 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___147_4611.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___147_4611.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___147_4611.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___147_4611.FStar_Syntax_Syntax.lbdef})
in (
...
let uu___148_4640 = lb
in {FStar_Syntax_Syntax.lbname = uu___148_4640.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___148_4640.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___148_4640.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___148_4640.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbdef}));
)))))
end
| uu____4641 -> begin
lbs1
...
let uu____6445 = (FStar_All.pipe_right binders (FStar_List.filter (fun uu___142_6460 -> (match (uu___142_6460) with
