...
let fail r msg =
  (let _0_460 =
     let _0_459 = FStar_Range.string_of_range r in
     FStar_Util.format2 "%s: %s\n" _0_459 msg in
   FStar_All.pipe_left FStar_Util.print_string _0_460);
  failwith msg
let err_uninst env t uu____105 app =
  ...
  | (vars,ty) ->
      let _0_466 =
        ...
        let _0_464 =
          let _0_461 = FStar_All.pipe_right vars (FStar_List.map Prims.fst) in
          FStar_All.pipe_right _0_461 (FStar_String.concat ", ") in
        let _0_463 =
          FStar_Extraction_ML_Code.string_of_mlty
            env.FStar_Extraction_ML_UEnv.currentModule ty in
        let _0_462 = FStar_Syntax_Print.term_to_string app in
        FStar_Util.format4
          "Variable %s has a polymorphic type (forall %s. %s); expected it to be fully instantiated, but got %s"
          _0_465 _0_464 _0_463 _0_462 in
...
let err_ill_typed_application env t args ty =
  let _0_471 =
    ...
    let _0_469 =
      ...
      FStar_All.pipe_right _0_467 (FStar_String.concat " ") in
    let _0_468 =
      FStar_Extraction_ML_Code.string_of_mlty
        env.FStar_Extraction_ML_UEnv.currentModule ty in
    FStar_Util.format3
      "Ill-typed application: application is %s \n remaining args are %s\nml type of head is %s\n"
      _0_470 _0_469 _0_468 in
  fail t.FStar_Syntax_Syntax.pos _0_471
let err_value_restriction t =
  let _0_474 =
    let _0_473 = FStar_Syntax_Print.tag_of_term t in
...
let err_unexpected_eff t f0 f1 =
  let _0_476 =
    ...
    FStar_Util.format3 "for expression %s, Expected effect %s; got effect %s"
      _0_475 (FStar_Extraction_ML_Util.eff_to_string f0)
      (FStar_Extraction_ML_Util.eff_to_string f1) in
  fail t.FStar_Syntax_Syntax.pos _0_476
let effect_as_etag:
  FStar_Extraction_ML_UEnv.env ->
      ...
      | FStar_Syntax_Syntax.Tm_delayed _|FStar_Syntax_Syntax.Tm_unknown  ->
          failwith
            (let _0_477 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: %s" _0_477)
        ...
        (fun uu____638  ->
           ...
           then
             ...
             (let _0_481 = FStar_Syntax_Print.term_to_string t in
              let _0_480 = FStar_Syntax_Print.tag_of_term t in
                    ...
                    FStar_Extraction_ML_Syntax.MLE_App
                      (let _0_499 =
                         ...
                         let _0_497 =
                           ...
                           [_0_496] in
                         _0_498 :: _0_497 in
                       (FStar_Extraction_ML_Util.prims_op_equality, _0_499)) in
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_bool_ty) _0_500 in
                             ...
                             FStar_All.pipe_right ps_when
                               (FStar_List.map
                                  (fun uu____2613  ->
                                     ...
                                     | (x,whens) ->
                                         let _0_516 = mk_when_clause whens in
                                         (x, _0_516))) in
                           let res =
                             match rest with
                             | [] -> (g, ps, b)
                                ...
                                FStar_Extraction_ML_Syntax.MLE_Name
                                  (let _0_540 =
                                     FStar_Extraction_ML_UEnv.monad_op_name
                                       ed "bind" in
                                   FStar_All.pipe_right _0_540 Prims.fst) in
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
            ...
            | (uu____3191,ty,uu____3193) ->
                ...
                let _0_546 =
                  let _0_545 =
                    ...
                    FStar_All.pipe_left
                      (fun _0_543  ->
                         FStar_Extraction_ML_Syntax.MLE_Const _0_543) _0_544 in
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv _0_564 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4374  ->
                 ...
                 | (env_body,lbs) ->
                     ...
                     (match uu____5339 with
                      | (e',f',t') ->
                          let f =
                            let _0_573 =
                              let _0_572 = FStar_List.map Prims.fst lbs in f'
                                :: _0_572 in
              ...
              let _0_610 =
                FStar_Extraction_ML_Syntax.MLE_Fun
                  (let _0_609 =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.ml_bool_ty) _0_608 in
                   ((FStar_List.append wildcards [(mlid, targ)]), _0_609)) in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) _0_610 in
