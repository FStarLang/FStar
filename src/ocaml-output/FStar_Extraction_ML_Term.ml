  ...
  fun env ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), body) ->
          ...
          let uu____877 =
            let uu____882 =
              let uu____883 = FStar_Syntax_Syntax.mk_binder x in [uu____883] in
                 ...
                 (fun uu____1778 ->
                    ...
                    | (v1, t1) ->
                        FStar_Extraction_ML_Syntax.with_ty t1
                          (FStar_Extraction_ML_Syntax.MLE_Var v1)) uu____1764 in
             let body =
      ...
      let uu____1800 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____1802 = FStar_Options.codegen () in
           uu____1802 = (FStar_Pervasives_Native.Some FStar_Options.Kremlin)) in
    ...
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____1932 ->
          let uu____1933 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1934 in
          failwith uu____1933
      | FStar_Syntax_Syntax.Tm_delayed uu____1935 ->
          let uu____1960 =
            let uu____1961 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1961 in
          failwith uu____1960
      | FStar_Syntax_Syntax.Tm_unknown ->
          let uu____1962 =
            let uu____1963 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1963 in
          failwith uu____1962
      | FStar_Syntax_Syntax.Tm_lazy i ->
                  ...
                  | (ml_bs, env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2654, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b in
                ...
                let uu____2968 =
                      ...
                      let uu____2981 =
                        ...
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.ml_int_ty) uu____2982 in
                  ...
                  | FStar_Pervasives_Native.Some sw ->
                      ...
                      (match uu____3004 with
                       | (mlterm, uu____3016, mlty) -> (mlterm, mlty)) in
                (match uu____2968 with
                 | (mlc, ml_ty) ->
                     ...
                     let when_clause =
                       ...
                       FStar_All.pipe_left
                         (FStar_Extraction_ML_Syntax.with_ty
                            FStar_Extraction_ML_Syntax.ml_bool_ty) uu____3036 in
                      ...
                      (uu____3268,
                       {
                         ...
                         FStar_Extraction_ML_Syntax.mlty = uu____3270;
                         FStar_Extraction_ML_Syntax.loc = uu____3271;_},
                       ttys, uu____3273)
                      -> (n1, ttys)
            ...
            | hd1::tl1 ->
                let uu____4507 =
                  FStar_List.fold_left FStar_Extraction_ML_Util.conjoin hd1
                    tl1 in
                FStar_Pervasives_Native.Some uu____4507 in
          let uu____4508 =
      ...
      fun residualType ->
        fun mlAppExpr ->
          let rec eta_args more_args t =
            ...
            | uu____4706 -> failwith "Impossible: Head type is not an arrow" in
          let as_record qual1 e =
            match ((e.FStar_Extraction_ML_Syntax.expr), qual1) with
            | (FStar_Extraction_ML_Syntax.MLE_CTor (uu____4734, args),
          ...
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____4909;_},
              mle::args),
             FStar_Pervasives_Native.Some
              ...
              let e =
                ...
                | uu____4936 ->
                    let uu____4939 =
                      ...
                      (uu____4946, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4939 in
              FStar_Extraction_ML_Syntax.with_ty
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____4951;_},
                   uu____4952);
                FStar_Extraction_ML_Syntax.mlty = uu____4953;
                FStar_Extraction_ML_Syntax.loc = uu____4954;_},
              mle::args),
             FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_projector (constrname, f))) ->
              let f1 =
                      ...
                      let uu____4995 =
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top) proj in
                      (uu____4995, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4988 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____5000;_},
              mlargs),
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____5053;_},
                   uu____5054);
             ...
             (fun u ->
                let uu____5232 =
                  ...
                  FStar_Util.format4
                    ...
                    uu____5233 uu____5234 uu____5235 uu____5236 in
      ...
      fun f ->
        fun ty ->
          ...
          | (e, tag, t) ->
              ...
              if uu____5293
              then let uu____5298 = maybe_coerce g e t ty in (uu____5298, ty)
      ...
      (let t = FStar_Syntax_Subst.compress top in
       ...
       | FStar_Syntax_Syntax.Tm_uvar uu____5368 ->
           let uu____5385 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5386 in
           failwith uu____5385
       | FStar_Syntax_Syntax.Tm_bvar uu____5393 ->
           let uu____5394 =
             let uu____5395 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5395 in
           failwith uu____5394
       | FStar_Syntax_Syntax.Tm_lazy i ->
           ...
           (match uu____5441 with
            | (uu____5510, fw, uu____5512, uu____5513) ->
                let uu____5514 =
                  ...
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_int_ty) uu____5515 in
           ...
           (match uu____5545 with
                            ...
                            let uu____5650 =
                              let uu____5651 =
                                let uu____5658 =
                                  ...
                                  [uu____5661] in
                                (fw, uu____5658) in
                              FStar_Extraction_ML_Syntax.MLE_App uu____5651 in
                            FStar_All.pipe_left
                              (FStar_Extraction_ML_Syntax.with_ty
                                 FStar_Extraction_ML_Syntax.ml_int_ty)
                              uu____5650 in
            ...
            | tv ->
                ...
                let t1 =
                  ...
                  FStar_Syntax_Util.mk_app
                    (FStar_Reflection_Data.refl_constant_term
                       FStar_Reflection_Data.fstar_refl_pack_ln) uu____5693 in
                term_as_mlexpr' g t1)
       ...
       | FStar_Syntax_Syntax.Tm_uinst (t1, uu____5805) ->
           term_as_mlexpr' g t1
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____6225;_},
            (a1, uu____6227)::[])
           ->
           let ty =
             let uu____6257 =
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____6306;_},
            uu____6307)
               ...
               (FStar_Const.Const_reify)) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6424 in
                let tm =
                  let uu____6434 =
                    let uu____6435 = FStar_TypeChecker_Util.remove_reify e in
                       ...
                       | FStar_Pervasives_Native.Some
                           ...
                           let rec remove_implicits args2 f1 t2 =
                             ...
                             | ((a0, FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____7164))::args3,
                                FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____7166, f', t3)) ->
                                 let uu____7203 =
                                   FStar_Extraction_ML_Util.join
                         ...
                         (fun lb ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8342 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8349 ->
                                    ...
                                    let uu____8641 =
                                      FStar_Util.prefix_until
                                        (fun x ->
                                           ...
                                           Prims.op_Negation uu____8677) bs1 in
                       ...
                       fun uu____9864 ->
                         ...
                         | (env, lbs4) ->
                             ...
                             (match uu____9989 with
                              | (lbname, uu____10037,
                                 (t1, (uu____10039, polytype)), add_unit,
                                 uu____10042) ->
                                  let uu____10055 =
                           ...
                           FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____10485 with
                             | (then_mle, f_then, t_then) ->
                                 let uu____10501 = term_as_mlexpr g else_e1 in
                        ...
                        | (pat_t_compat, mlbranches) ->
                            ...
                            (match mlbranches1 with
                             ...
                             | (uu____11282, uu____11283,
                                (uu____11284, f_first, t_first))::rest ->
                                 let uu____11344 =
                                   FStar_List.fold_left
                                     (fun uu____11386 ->
                                        fun uu____11387 ->
                                          ...
                                          with
                                          | ((topt, f),
                                             (uu____11444, uu____11445,
                                              (uu____11446, f_branch,
                                               t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
    ...
    fun discName ->
      fun constrName ->
        ...
        | (uu____11706, fstar_disc_type) ->
            let wildcards =
              let uu____11715 =
                let uu____11716 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              let uu____11838 =
                let uu____11839 =
                  let uu____11850 =
                        ...
                        let uu____11870 =
                          let uu____11881 =
                            let uu____11890 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11891 in
                            let uu____11901 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                          ...
                          let uu____11904 =
                            let uu____11915 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11924) in
                            [uu____11915] in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11851 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11850) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11839 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11838 in
            let uu____11979 =
              let uu____11980 =
                let uu____11983 =
                  let uu____11984 =
