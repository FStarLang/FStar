...
let _79_18 = (let _176_29 = (let _176_28 = (FStar_Range.string_of_range r)
...
in (let _176_45 = (let _176_43 = (FStar_All.pipe_right args (FStar_List.map (fun _79_32 -> (match (_79_32) with
| (x, _79_31) -> begin
...
let _79_68 = (FStar_Extraction_ML_UEnv.debug env (fun _79_66 -> (let _176_78 = (FStar_Syntax_Print.term_to_string t)
...
let _79_292 = (let _176_116 = (FStar_List.tl l)
...
| (_79_483, rest) -> begin
(let _176_180 = (FStar_List.map (fun _79_486 -> FStar_Extraction_ML_UEnv.erasedContent) rest)
in (FStar_List.append mlargs _176_180))
end))
end else begin
mlargs
end)
in (let _176_182 = (let _176_181 = (FStar_Extraction_ML_Syntax.mlpath_of_lident fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in ((mlargs), (_176_181)))
in FStar_Extraction_ML_Syntax.MLTY_Named (_176_182))))
end)))
...
let ml_b = (let _176_187 = (FStar_Extraction_ML_UEnv.bv_as_ml_termvar b)
in ((_176_187), (FStar_Extraction_ML_Syntax.ml_unit_ty)))
in (((ml_b)::ml_bs), (env)))))
end else begin
(
...
let ml_b = (let _176_188 = (FStar_Extraction_ML_UEnv.bv_as_ml_termvar b)
in ((_176_188), (t)))
in (((ml_b)::ml_bs), (env))))))
end
end)) (([]), (g))))
...
(FStar_Extraction_ML_UEnv.debug g (fun _79_583 -> (let _176_223 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t')
in (let _176_222 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t)
...
let when_clause = (let _176_232 = (let _176_231 = (let _176_230 = (let _176_229 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_int_ty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (let _176_228 = (let _176_227 = (let _176_226 = (let _176_225 = (FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Syntax_Syntax.p i)
in (FStar_All.pipe_left (fun _176_224 -> FStar_Extraction_ML_Syntax.MLE_Const (_176_224)) _176_225))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_int_ty) _176_226))
in (_176_227)::[])
in (_176_229)::_176_228))
in ((FStar_Extraction_ML_Util.prims_op_equality), (_176_230)))
in FStar_Extraction_ML_Syntax.MLE_App (_176_231))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _176_232))
in (let _176_233 = (ok FStar_Extraction_ML_Syntax.ml_int_ty)
in ((g), (Some (((FStar_Extraction_ML_Syntax.MLP_Var (x)), ((when_clause)::[])))), (_176_233))))))
end
...
in (let _176_238 = (let _176_236 = (let _176_235 = (let _176_234 = (FStar_Extraction_ML_Util.mlconst_of_const' p.FStar_Syntax_Syntax.p s)
in FStar_Extraction_ML_Syntax.MLP_Const (_176_234))
in ((_176_235), ([])))
in Some (_176_236))
...
let g = (FStar_Extraction_ML_UEnv.extend_bv g x (([]), (mlty)) false false imp)
in (let _176_248 = if imp then begin
None
end else begin
(let _176_246 = (let _176_245 = (let _176_244 = (FStar_Extraction_ML_Syntax.bv_as_mlident x)
in FStar_Extraction_ML_Syntax.MLP_Var (_176_244))
in ((_176_245), ([])))
in Some (_176_246))
end
in (let _176_247 = (ok mlty)
in ((g), (_176_248), (_176_247))))))
end
...
let _79_659 = (FStar_Extraction_ML_UEnv.debug g (fun _79_657 -> (let _176_252 = (FStar_Syntax_Print.pat_to_string p)
in (FStar_Util.print1 "Pattern %s is not extractable" _176_252))))
...
in (let _176_253 = (FStar_Extraction_ML_Util.uncurry_mlty_fun f_ty)
in Some (_176_253))))
end)
with
...
let _79_710 = (let _176_260 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun _79_2 -> (match (_79_2) with
| Some (x) -> begin
(x)::[]
end
| _79_707 -> begin
...
in (FStar_All.pipe_right _176_260 FStar_List.split))
...
in (let _176_264 = (let _176_263 = (let _176_262 = (resugar_pat f.FStar_Syntax_Syntax.fv_qual (FStar_Extraction_ML_Syntax.MLP_CTor (((d), (mlPats)))))
in (let _176_261 = (FStar_All.pipe_right when_clauses FStar_List.flatten)
in ((_176_262), (_176_261))))
in Some (_176_263))
in ((g), (_176_264), (pat_ty_compat))))
end))
end))
end)))
end)))
...
| (hd)::tl -> begin
(let _176_275 = (FStar_List.fold_left FStar_Extraction_ML_Util.conjoin hd tl)
in Some (_176_275))
end))
in (match (p.FStar_Syntax_Syntax.v) with
...
| (x, whens) -> begin
(let _176_280 = (mk_when_clause whens)
in ((x), (_176_280)))
end))))
in (
...
| rest -> begin
(let _176_284 = (let _176_283 = (let _176_282 = (let _176_281 = (FStar_List.map Prims.fst rest)
in FStar_Extraction_ML_Syntax.MLP_Branch (_176_281))
in ((_176_282), (None)))
in (_176_283)::ps)
in ((g), (_176_284), (b)))
end)
...
let x = (FStar_Extraction_ML_Syntax.gensym ())
in (let _176_299 = (let _176_298 = (let _176_297 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t0) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in ((((x), (t0))), (_176_297)))
in (_176_298)::more_args)
in (eta_args _176_299 t1)))
end
...
(match (eargs) with
| [] -> begin
(let _176_308 = (as_record qual e)
in (FStar_Extraction_ML_Util.resugar_exp _176_308))
end
| _79_838 -> begin
(
...
let body = (let _176_310 = (let _176_309 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tres) (FStar_Extraction_ML_Syntax.MLE_CTor (((head), ((FStar_List.append args eargs))))))
in (FStar_All.pipe_left (as_record qual) _176_309))
in (FStar_All.pipe_left FStar_Extraction_ML_Util.resugar_exp _176_310))
...
| _79_873 -> begin
(let _176_312 = (let _176_311 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) proj)
in ((_176_311), (args)))
in FStar_Extraction_ML_Syntax.MLE_App (_176_312))
end)
...
(let _176_313 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty mlAppExpr.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_CTor (((mlp), (mlargs)))))
in (FStar_All.pipe_left (resugar_and_maybe_eta qual) _176_313))
end
...
(let _176_314 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty mlAppExpr.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_CTor (((mlp), ([])))))
in (FStar_All.pipe_left (resugar_and_maybe_eta qual) _176_314))
end
| _79_913 -> begin
mlAppExpr
end)))))
...
let _79_925 = (FStar_Extraction_ML_UEnv.debug g (fun u -> (let _176_339 = (let _176_338 = (FStar_Syntax_Print.tag_of_term t)
in (let _176_337 = (FStar_Syntax_Print.term_to_string t)
in (let _176_336 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule ty)
in (FStar_Util.format4 "term_as_mlexpr (%s) :  %s has ML type %s and effect %s\n" _176_338 _176_337 _176_336 (FStar_Extraction_ML_Util.eff_to_string tag)))))
in (FStar_Util.print_string _176_339))))
in (erase g e ty tag)))
end)))
...
(let _176_348 = (maybe_coerce g e t ty)
in ((_176_348), (ty)))
end else begin
...
let _79_951 = (FStar_Extraction_ML_UEnv.debug g (fun u -> (let _176_355 = (let _176_354 = (FStar_Range.string_of_range top.FStar_Syntax_Syntax.pos)
in (let _176_353 = (FStar_Syntax_Print.tag_of_term top)
in (let _176_352 = (FStar_Syntax_Print.term_to_string top)
in (FStar_Util.format3 "%s: term_as_mlexpr\' (%s) :  %s \n" _176_354 _176_353 _176_352))))
in (FStar_Util.print_string _176_355))))
in (
...
(let _176_357 = (let _176_356 = (FStar_Syntax_Print.tag_of_term t)
in (FStar_Util.format1 "Impossible: Unexpected term: %s" _176_356))
in (FStar_All.failwith _176_357))
end
...
in if (let _176_358 = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reifiable))
in (FStar_All.pipe_right _176_358 Prims.op_Negation)) then begin
(term_as_mlexpr' g t)
end else begin
(
...
let k = (let _176_361 = (let _176_360 = (let _176_359 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in (FStar_All.pipe_right _176_359 FStar_Syntax_Syntax.mk_binder))
in (_176_360)::[])
in (FStar_Syntax_Util.abs _176_361 body None))
in (
...
let bind = (let _176_364 = (let _176_363 = (let _176_362 = (FStar_Extraction_ML_UEnv.monad_op_name ed "bind")
in (FStar_All.pipe_right _176_362 Prims.fst))
in FStar_Extraction_ML_Syntax.MLE_Name (_176_363))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.MLTY_Top) _176_364))
in (let _176_365 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty ty) (FStar_Extraction_ML_Syntax.MLE_App (((bind), ((comp_1)::(ml_k)::[])))))
in ((_176_365), (FStar_Extraction_ML_Syntax.E_IMPURE), (ty))))
end))
end)))
end)
end
...
in (let _176_369 = (let _176_368 = (let _176_367 = (FStar_Extraction_ML_Util.mlconst_of_const' t.FStar_Syntax_Syntax.pos c)
in (FStar_All.pipe_left (fun _176_366 -> FStar_Extraction_ML_Syntax.MLE_Const (_176_366)) _176_367))
in (FStar_Extraction_ML_Syntax.with_ty ml_ty _176_368))
in ((_176_369), (FStar_Extraction_ML_Syntax.E_PURE), (ml_ty))))
end))
end
...
| ([], t) -> begin
(let _176_370 = (maybe_eta_data_and_project_record g qual t x)
in ((_176_370), (FStar_Extraction_ML_Syntax.E_PURE), (t)))
end
| _79_1084 -> begin
...
| (f, tfun) -> begin
(let _176_373 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty tfun) (FStar_Extraction_ML_Syntax.MLE_Fun (((ml_bs), (ml_body)))))
in ((_176_373), (f), (tfun)))
end))
end))
end))
...
in (match ((let _176_377 = (let _176_376 = (FStar_Syntax_Subst.compress head)
in _176_376.FStar_Syntax_Syntax.n)
in ((head.FStar_Syntax_Syntax.n), (_176_377)))) with
...
(let _176_386 = (FStar_All.pipe_right (FStar_List.rev mlargs_f) (FStar_List.map Prims.fst))
in (([]), (_176_386)))
end else begin
...
let x = (FStar_Extraction_ML_Syntax.gensym ())
in (let _176_390 = (let _176_389 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty arg.FStar_Extraction_ML_Syntax.mlty) (FStar_Extraction_ML_Syntax.MLE_Var (x)))
in (_176_389)::out_args)
in (((((x), (arg)))::lbs), (_176_390))))
end
end)) (([]), ([])) mlargs_f)
end
...
let app = (let _176_391 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t) (FStar_Extraction_ML_Syntax.MLE_App (((mlhead), (mlargs)))))
in (FStar_All.pipe_left (maybe_eta_data_and_project_record g is_data t) _176_391))
in (
...
(let _176_395 = (let _176_394 = (FStar_Extraction_ML_Util.join arg.FStar_Syntax_Syntax.pos f f')
in ((_176_394), (t)))
in (extract_app is_data ((mlhead), ((((FStar_Extraction_ML_Syntax.ml_unit), (FStar_Extraction_ML_Syntax.E_PURE)))::mlargs_f)) _176_395 rest))
end else begin
(let _176_400 = (let _176_399 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule mlhead)
in (let _176_398 = (FStar_Syntax_Print.term_to_string arg)
in (let _176_397 = (FStar_Syntax_Print.tag_of_term arg)
in (let _176_396 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule formal_t)
in (FStar_Util.format4 "Impossible: ill-typed application:\n\thead=%s, arg=%s, tag=%s\n\texpected type unit, got %s" _176_399 _176_398 _176_397 _176_396)))))
in (FStar_All.failwith _176_400))
end
end
...
in (let _176_402 = (let _176_401 = (FStar_Extraction_ML_Util.join_l r ((f)::(f')::(f0)::[]))
in ((_176_401), (t)))
in (extract_app is_data ((mlhead), ((((e0), (f0)))::mlargs_f)) _176_402 rest)))
end)))
end
| _79_1251 -> begin
(match ((FStar_Extraction_ML_Util.udelta_unfold g t)) with
...
(let _176_417 = (FStar_Extraction_ML_Util.join a0.FStar_Syntax_Syntax.pos f f')
in (remove_implicits args _176_417 t))
end
| _79_1286 -> begin
((args), (f), (t))
end))
...
(match (args) with
| [] -> begin
(let _176_419 = (maybe_eta_data_and_project_record g qual head_t head_ml)
in ((_176_419), (FStar_Extraction_ML_Syntax.E_PURE), (head_t)))
end
| _79_1371 -> begin
...
let x = (let _176_420 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in (FStar_Syntax_Syntax.freshen_bv _176_420))
in (
...
let tcenv = (let _176_422 = (FStar_Ident.lid_of_path (FStar_List.append (Prims.fst g.FStar_Extraction_ML_UEnv.currentModule) (((Prims.snd g.FStar_Extraction_ML_UEnv.currentModule))::[])) FStar_Range.dummyRange)
in (FStar_TypeChecker_Env.set_current_module g.FStar_Extraction_ML_UEnv.tcenv _176_422))
in (
...
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) when (let _176_425 = (FStar_List.hd bs)
in (FStar_All.pipe_right _176_425 (is_type_binder g))) -> begin
(
...
(let _176_427 = (FStar_Syntax_Util.arrow ((b)::rest) c)
in ((bs), (_176_427)))
end)
...
(let _176_431 = (let _176_430 = (FStar_Syntax_Syntax.bv_to_name y)
in ((x), (_176_430)))
in FStar_Syntax_Syntax.NT (_176_431))
end)) tbinders targs)
...
let polytype = (let _176_435 = (FStar_All.pipe_right targs (FStar_List.map (fun _79_1478 -> (match (_79_1478) with
| (x, _79_1477) -> begin
(FStar_Extraction_ML_UEnv.bv_as_ml_tyvar x)
end))))
in ((_176_435), (expected_t)))
in (
...
let polytype = (let _176_439 = (FStar_All.pipe_right tbinders (FStar_List.map (fun _79_1508 -> (match (_79_1508) with
| (x, _79_1507) -> begin
(FStar_Extraction_ML_UEnv.bv_as_ml_tyvar x)
end))))
in ((_176_439), (expected_t)))
in (

let args = (FStar_All.pipe_right tbinders (FStar_List.map (fun _79_1513 -> (match (_79_1513) with
| (bv, _79_1512) -> begin
(let _176_441 = (FStar_Syntax_Syntax.bv_to_name bv)
in (FStar_All.pipe_right _176_441 FStar_Syntax_Syntax.as_arg))
end))))
in (
...
let f = (let _176_451 = (let _176_450 = (FStar_List.map Prims.fst lbs)
in (f')::_176_450)
in (FStar_Extraction_ML_Util.join_l e'_rng _176_451))
in (
...
in (let _176_456 = (let _176_455 = (let _176_453 = (let _176_452 = (FStar_List.map Prims.snd lbs)
in ((is_rec), ([]), (_176_452)))
in (mk_MLE_Let top_level _176_453 e'))
in (let _176_454 = (FStar_Extraction_ML_Util.mlloc_of_range t.FStar_Syntax_Syntax.pos)
in (FStar_Extraction_ML_Syntax.with_ty_loc t' _176_455 _176_454)))
in ((_176_456), (f), (t')))))
end)))))
end))))))
end)))
...
(let _176_487 = (let _176_485 = (let _176_484 = (let _176_483 = (maybe_lift then_mle t_then)
in (let _176_482 = (let _176_481 = (maybe_lift else_mle t_else)
in Some (_176_481))
in ((e), (_176_483), (_176_482))))
in FStar_Extraction_ML_Syntax.MLE_If (_176_484))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_branch) _176_485))
in (let _176_486 = (FStar_Extraction_ML_Util.join then_e.FStar_Syntax_Syntax.pos f_then f_else)
in ((_176_487), (_176_486), (t_branch))))
end))
end))
end))
end
...
(let _176_491 = (FStar_All.pipe_right p (FStar_List.map (fun _79_1640 -> (match (_79_1640) with
| (p, wopt) -> begin
(
...
in (((compat && pat_t_compat)), (_176_491)))
end))
end))
end))
end))) true))
...
let _79_1648 = (FStar_Extraction_ML_UEnv.debug g (fun _79_1646 -> (let _176_494 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule e)
in (let _176_493 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t_e)
...
let _79_1657 = (let _176_496 = (let _176_495 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.failwith_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Extraction_ML_UEnv.lookup_fv g _176_495))
in (FStar_All.pipe_left FStar_Util.right _176_496))
in (match (_79_1657) with
| (fw, _79_1654, _79_1656) -> begin
(let _176_501 = (let _176_500 = (let _176_499 = (let _176_498 = (let _176_497 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_string_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_String ("unreachable"))))
in (_176_497)::[])
in ((fw), (_176_498)))
in FStar_Extraction_ML_Syntax.MLE_App (_176_499))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_unit_ty) _176_500))
in ((_176_501), (FStar_Extraction_ML_Syntax.E_PURE), (FStar_Extraction_ML_Syntax.ml_unit_ty)))
end))
end
...
in (let _176_505 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty t_match) (FStar_Extraction_ML_Syntax.MLE_Match (((e), (mlbranches)))))
in ((_176_505), (f_match), (t_match)))))
end))
end)))
end))
end)
...
in (let _176_508 = (FStar_ST.read c)
in ((x), (_176_508))))))
...
let wildcards = (match ((let _176_515 = (FStar_Syntax_Subst.compress fstar_disc_type)
in _176_515.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, _79_1725) -> begin
(let _176_519 = (FStar_All.pipe_right binders (FStar_List.filter (fun _79_5 -> (match (_79_5) with
...
in (FStar_All.pipe_right _176_519 (FStar_List.map (fun _79_1738 -> (let _176_518 = (fresh "_")
in ((_176_518), (FStar_Extraction_ML_Syntax.MLTY_Top)))))))
end
| _79_1741 -> begin
...
let discrBody = (let _176_534 = (let _176_533 = (let _176_532 = (let _176_531 = (let _176_530 = (let _176_529 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty targ) (FStar_Extraction_ML_Syntax.MLE_Name ((([]), ((FStar_Extraction_ML_Syntax.idsym mlid))))))
in (let _176_528 = (let _176_527 = (let _176_523 = (let _176_521 = (let _176_520 = (FStar_Extraction_ML_Syntax.mlpath_of_lident constrName)
in ((_176_520), ((FStar_Extraction_ML_Syntax.MLP_Wild)::[])))
in FStar_Extraction_ML_Syntax.MLP_CTor (_176_521))
in (let _176_522 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (true))))
in ((_176_523), (None), (_176_522))))
in (let _176_526 = (let _176_525 = (let _176_524 = (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) (FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Bool (false))))
in ((FStar_Extraction_ML_Syntax.MLP_Wild), (None), (_176_524)))
in (_176_525)::[])
in (_176_527)::_176_526))
in ((_176_529), (_176_528))))
in FStar_Extraction_ML_Syntax.MLE_Match (_176_530))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty FStar_Extraction_ML_Syntax.ml_bool_ty) _176_531))
in (((FStar_List.append wildcards ((((mlid), (targ)))::[]))), (_176_532)))
in FStar_Extraction_ML_Syntax.MLE_Fun (_176_533))
in (FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty disc_ty) _176_534))
