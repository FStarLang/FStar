  ...
  fun l  ->
    ...
    then def
      ...
      (let uu____1511 = FStar_List.hd l in
       ...
       | (p1,w1,e1) ->
           let uu____1545 =
             let uu____1554 = FStar_List.tl l in FStar_List.hd uu____1554 in
                 ...
                 (fun uu____1740  ->
                    ...
                    | (v1,t1) ->
                        FStar_Extraction_ML_Syntax.with_ty t1
                          (FStar_Extraction_ML_Syntax.MLE_Var v1)) uu____1726 in
             let body =
      ...
      let uu____1762 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____1764 = FStar_Options.codegen () in
           uu____1764 = (FStar_Pervasives_Native.Some "Kremlin")) in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____1894 ->
          let uu____1895 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1896 in
          failwith uu____1895
      ...
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1924 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1925 in
          failwith uu____1924
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2607, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b in
                ...
                let uu____2922 =
                      ...
                      let uu____2935 =
                        ...
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.ml_int_ty) uu____2936 in
                  ...
                  | FStar_Pervasives_Native.Some sw ->
                      ...
                      (match uu____2958 with
                       | (mlterm,uu____2970,mlty) -> (mlterm, mlty)) in
                (match uu____2922 with
                 | (mlc,ml_ty) ->
                     ...
                     let when_clause =
                       ...
                       FStar_All.pipe_left
                         (FStar_Extraction_ML_Syntax.with_ty
                            FStar_Extraction_ML_Syntax.ml_bool_ty) uu____2990 in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____4660 -> failwith "Impossible: Head type is not an arrow" in
              ...
              let e =
                ...
                | uu____4890 ->
                    let uu____4893 =
                      ...
                      (uu____4900, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4893 in
              FStar_Extraction_ML_Syntax.with_ty
                      ...
                      let uu____4949 =
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top) proj in
                      (uu____4949, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4942 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
      ...
      (let t = FStar_Syntax_Subst.compress top in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____6049::(v1,uu____6051)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____6097 in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6215 in
                let tm =
                  let uu____6225 =
                    let uu____6226 = FStar_TypeChecker_Util.remove_reify e in
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7500 ->
                                               let uu___290_7503 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___290_7503.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___290_7503.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___291_7510.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___291_7510.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___292_7519 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___292_7519.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___292_7519.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7925 ->
                                               let uu___290_7928 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___290_7928.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___290_7928.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           match head_ml.FStar_Extraction_ML_Syntax.expr
                                           with
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___291_7935.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___291_7935.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___292_7944 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___292_7944.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___292_7944.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
               ...
               (let uu____8147 = FStar_Syntax_Syntax.is_top_level lbs in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs in
                   ...
                   let lb1 =
                     let uu___293_8163 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___293_8163.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___293_8163.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___293_8163.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___293_8163.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e'1 =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8195 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8202  ->
                            ...
                            (let lbdef =
                             ...
                             let uu___294_8210 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___294_8210.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___294_8210.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___294_8210.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___294_8210.FStar_Syntax_Syntax.lbeff);
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____8336 = FStar_Syntax_Subst.open_comp bs c in
                                ...
                                let uu____8361 =
                                  let uu____8368 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8404 = is_type_binder g x in
                                         Prims.op_Negation uu____8404) bs1 in
                           ...
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____10275 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____10291 = term_as_mlexpr g else_e1 in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____11496,fstar_disc_type) ->
            let wildcards =
              let uu____11505 =
                let uu____11506 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              | uu____11617 -> failwith "Discriminator must be a function" in
              ...
              let uu____11628 =
                let uu____11629 =
                  let uu____11640 =
                        ...
                        let uu____11660 =
                          let uu____11671 =
                            let uu____11680 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11681 in
                            let uu____11691 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                          ...
                          let uu____11694 =
                            let uu____11705 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11714) in
                            [uu____11705] in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11641 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11640) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11629 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11628 in
            let uu____11769 =
              let uu____11770 =
                let uu____11773 =
                  let uu____11774 =
