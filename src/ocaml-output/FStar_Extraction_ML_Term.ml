  ...
  fun l  ->
    ...
    then def
      ...
      (let uu____1521 = FStar_List.hd l in
       ...
       | (p1,w1,e1) ->
           let uu____1555 =
             let uu____1564 = FStar_List.tl l in FStar_List.hd uu____1564 in
                 ...
                 (fun uu____1781  ->
                    ...
                    | (v1,t1) ->
                        FStar_Extraction_ML_Syntax.with_ty t1
                          (FStar_Extraction_ML_Syntax.MLE_Var v1)) uu____1763 in
             let body =
    ...
    fun e  ->
      let uu____1809 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____1811 = FStar_Options.codegen () in
           uu____1811 = (FStar_Pervasives_Native.Some "Kremlin")) in
      if uu____1809 then e else eta_expand expect e
let maybe_coerce:
  FStar_Extraction_ML_UEnv.env ->
    FStar_Extraction_ML_Syntax.mlexpr ->
      FStar_Extraction_ML_Syntax.mlty ->
          ...
          | uu____1844 ->
              (FStar_Extraction_ML_UEnv.debug g
               ...
               (let uu____1860 =
                ...
                maybe_eta_expand expect uu____1860))
let bv_as_mlty:
  FStar_Extraction_ML_UEnv.env ->
  ...
  fun g  ->
    fun bv  ->
      let uu____1869 = FStar_Extraction_ML_UEnv.lookup_bv g bv in
      match uu____1869 with
      | FStar_Util.Inl (uu____1870,t) -> t
      | uu____1884 -> FStar_Extraction_ML_Syntax.MLTY_Top
  ...
  fun g  ->
    fun t0  ->
      let rec is_top_ty t =
        ...
        | FStar_Extraction_ML_Syntax.MLTY_Named uu____1927 ->
            let uu____1934 = FStar_Extraction_ML_Util.udelta_unfold g t in
      ...
      let uu____1941 = is_top_ty mlt in
      if uu____1941
      then
        let t1 =
          FStar_TypeChecker_Normalize.normalize
...
and term_as_mlty':
  ...
  fun env  ->
    fun t  ->
      let t1 = FStar_Syntax_Subst.compress t in
      match t1.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Tm_bvar uu____1947 ->
          let uu____1948 =
            let uu____1949 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1949 in
          failwith uu____1948
      | FStar_Syntax_Syntax.Tm_delayed uu____1950 ->
          let uu____1975 =
            let uu____1976 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1976 in
          failwith uu____1975
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1977 =
            let uu____1978 = FStar_Syntax_Print.term_to_string t1 in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1978 in
          failwith uu____1977
      | FStar_Syntax_Syntax.Tm_constant uu____1979 ->
          FStar_Extraction_ML_UEnv.unknownType
      | FStar_Syntax_Syntax.Tm_uvar uu____1980 ->
          FStar_Extraction_ML_UEnv.unknownType
      | FStar_Syntax_Syntax.Tm_meta (t2,uu____1998) -> term_as_mlty' env t2
      | FStar_Syntax_Syntax.Tm_refine
          ({ FStar_Syntax_Syntax.ppname = uu____2003;
             FStar_Syntax_Syntax.index = uu____2004;
             FStar_Syntax_Syntax.sort = t2;_},uu____2006)
          -> term_as_mlty' env t2
      | FStar_Syntax_Syntax.Tm_uinst (t2,uu____2014) -> term_as_mlty' env t2
      | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____2020,uu____2021) ->
          term_as_mlty' env t2
      | FStar_Syntax_Syntax.Tm_name bv -> bv_as_mlty env bv
      | FStar_Syntax_Syntax.Tm_fvar fv -> fv_app_as_mlty env fv []
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
          let uu____2088 = FStar_Syntax_Subst.open_comp bs c in
          (match uu____2088 with
           | (bs1,c1) ->
               let uu____2095 = binders_as_ml_binders env bs1 in
                ...
                | (mlbs,env1) ->
                    ...
                    let uu____2157 =
                      FStar_List.fold_right
                        (fun uu____2176  ->
                           fun uu____2177  ->
                             match (uu____2176, uu____2177) with
                             | ((uu____2198,t2),(tag,t')) ->
                                 (FStar_Extraction_ML_Syntax.E_PURE,
                                   (FStar_Extraction_ML_Syntax.MLTY_Fun
                                      (t2, tag, t')))) mlbs (erase1, t_ret) in
                    (match uu____2157 with | (uu____2210,t2) -> t2)))
      | FStar_Syntax_Syntax.Tm_app (head1,args) ->
          let res =
            let uu____2235 =
              let uu____2236 = FStar_Syntax_Util.un_uinst head1 in
              uu____2236.FStar_Syntax_Syntax.n in
            ...
            | FStar_Syntax_Syntax.Tm_app (head2,args') ->
                ...
                term_as_mlty' env uu____2263
            | uu____2280 -> FStar_Extraction_ML_UEnv.unknownType in
          res
      | FStar_Syntax_Syntax.Tm_abs (bs,ty,uu____2283) ->
          let uu____2304 = FStar_Syntax_Subst.open_term bs ty in
          (match uu____2304 with
           | (bs1,ty1) ->
               let uu____2311 = binders_as_ml_binders env bs1 in
               (match uu____2311 with | (bts,env1) -> term_as_mlty' env1 ty1))
      | FStar_Syntax_Syntax.Tm_type uu____2336 ->
          FStar_Extraction_ML_UEnv.unknownType
      | FStar_Syntax_Syntax.Tm_let uu____2337 ->
          FStar_Extraction_ML_UEnv.unknownType
      | FStar_Syntax_Syntax.Tm_match uu____2350 ->
          FStar_Extraction_ML_UEnv.unknownType
and arg_as_mlty:
  FStar_Extraction_ML_UEnv.env ->
      ...
      fun args  ->
        ...
        | (formals,uu____2429) ->
            ...
            let mlargs1 =
              ...
              then
                let uu____2473 = FStar_Util.first_N n_args formals in
                ...
                | (uu____2500,rest) ->
                    ...
                    FStar_List.append mlargs uu____2526
              else mlargs in
            let nm =
              let uu____2541 =
...
and binders_as_ml_binders:
  ...
  fun g  ->
    fun bs  ->
          ...
          (FStar_List.fold_left
             (fun uu____2614  ->
                fun b  ->
                  ...
                  | (ml_bs,env) ->
                      let uu____2670 = is_type_binder g b in
                      if uu____2670
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2696, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b in
      ...
      match uu____2559 with | (ml_bs,env) -> ((FStar_List.rev ml_bs), env)
let mk_MLE_Seq:
  FStar_Extraction_ML_Syntax.mlexpr ->
    FStar_Extraction_ML_Syntax.mlexpr -> FStar_Extraction_ML_Syntax.mlexpr'
  =
  fun e1  ->
    fun e2  ->
      ...
      | (FStar_Extraction_ML_Syntax.MLE_Seq es1,uu____2868) ->
          FStar_Extraction_ML_Syntax.MLE_Seq (FStar_List.append es1 [e2])
      | (uu____2871,FStar_Extraction_ML_Syntax.MLE_Seq es2) ->
          FStar_Extraction_ML_Syntax.MLE_Seq (e1 :: es2)
      | uu____2875 -> FStar_Extraction_ML_Syntax.MLE_Seq [e1; e2]
let mk_MLE_Let:
  Prims.bool ->
                   ...
                   (match body.FStar_Extraction_ML_Syntax.expr with
                    ...
                    | uu____2908 ->
                        mk_MLE_Seq lb.FStar_Extraction_ML_Syntax.mllb_def
                          body)
             | uu____2909 -> FStar_Extraction_ML_Syntax.MLE_Let (lbs, body))
        | uu____2912 -> FStar_Extraction_ML_Syntax.MLE_Let (lbs, body)
let resugar_pat:
  ...
  fun q  ->
    fun p  ->
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (d,pats) ->
          let uu____2931 = FStar_Extraction_ML_Util.is_xtuple d in
                      ...
                      let uu____3078 =
                        let uu____3081 =
                          ...
                          FStar_All.pipe_left
                            ...
                            uu____3082 in
                        [uu____3081] in
                      uu____3077 :: uu____3078 in
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____3074) in
                  FStar_Extraction_ML_Syntax.MLE_App uu____3067 in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____3066 in
              let uu____3086 = ok FStar_Extraction_ML_Syntax.ml_int_ty in
              (g,
                (FStar_Pervasives_Native.Some
              ...
              let uu____3106 =
                let uu____3115 =
                  let uu____3122 =
                    ...
                    FStar_Extraction_ML_Syntax.MLP_Const uu____3123 in
                  (uu____3122, []) in
                FStar_Pervasives_Native.Some uu____3115 in
              let uu____3132 = ok mlty in (g, uu____3106, uu____3132)
                     ...
                     (if imp
                      then FStar_Pervasives_Native.None
                        ...
                        FStar_Pervasives_Native.Some
                          ((FStar_Extraction_ML_Syntax.MLP_Var x1), [])),
                     uu____3223))
          | FStar_Syntax_Syntax.Pat_dot_term uu____3255 ->
              (g, FStar_Pervasives_Native.None, true)
          | FStar_Syntax_Syntax.Pat_cons (f,pats) ->
              let uu____3294 =
                let uu____3299 = FStar_Extraction_ML_UEnv.lookup_fv g f in
                ...
                | FStar_Util.Inr
                    (uu____3304,{
                                  ...
                                  FStar_Extraction_ML_Syntax.mlty =
                                    uu____3306;
                                  FStar_Extraction_ML_Syntax.loc = uu____3307;_},ttys,uu____3309)
                    -> (n1, ttys)
                | uu____3322 -> failwith "Expected a constructor" in
              (match uu____3294 with
               | (d,tys) ->
                   let nTyVars =
                     FStar_List.length (FStar_Pervasives_Native.fst tys) in
                   let uu____3344 = FStar_Util.first_N nTyVars pats in
                                   ...
                                   | (mlPats,when_clauses) ->
                                       ...
                                       let uu____4311 =
                                         let uu____4320 =
                                           ...
                                           (uu____4327, uu____4330) in
                                         FStar_Pervasives_Native.Some
                                           uu____4320 in
                                       (g2, uu____4311, pat_ty_compat))))))
let extract_pat:
  FStar_Extraction_ML_UEnv.env ->
    FStar_Syntax_Syntax.pat ->
      FStar_Extraction_ML_Syntax.mlty ->
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          let uu____4421 = extract_one_pat false g1 p1 expected_t1 in
          match uu____4421 with
          | (g2,FStar_Pervasives_Native.Some (x,v1),b) -> (g2, (x, v1), b)
          | uu____4478 -> failwith "Impossible: Unable to translate pattern" in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            match t with
            | FStar_Extraction_ML_Syntax.MLTY_Fun (t0,uu____4664,t1) ->
                let x = FStar_Extraction_ML_Syntax.gensym () in
                let uu____4667 =
                  let uu____4678 =
                    let uu____4687 =
                      FStar_All.pipe_left
                        ...
                        (FStar_Extraction_ML_Syntax.MLE_Var x) in
                    ((x, t0), uu____4687) in
                  uu____4678 :: more_args in
                eta_args uu____4667 t1
            | FStar_Extraction_ML_Syntax.MLTY_Named (uu____4700,uu____4701)
                -> ((FStar_List.rev more_args), t)
            | uu____4724 -> failwith "Impossible: Head type is not an arrow" in
          let as_record qual1 e =
            match ((e.FStar_Extraction_ML_Syntax.expr), qual1) with
            | (FStar_Extraction_ML_Syntax.MLE_CTor
               (uu____4752,args),FStar_Pervasives_Native.Some
          ...
          let resugar_and_maybe_eta qual1 e =
            let uu____4802 = eta_args [] residualType in
            match uu____4802 with
            | (eargs,tres) ->
                (match eargs with
                 | [] ->
                     let uu____4855 = as_record qual1 e in
                     FStar_Extraction_ML_Util.resugar_exp uu____4855
                 | uu____4856 ->
                     let uu____4867 = FStar_List.unzip eargs in
          ...
          | (uu____4922,FStar_Pervasives_Native.None ) -> mlAppExpr
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                FStar_Extraction_ML_Syntax.expr =
                  FStar_Extraction_ML_Syntax.MLE_Name mlp;
                FStar_Extraction_ML_Syntax.mlty = uu____4926;
                FStar_Extraction_ML_Syntax.loc = uu____4927;_},mle::args),FStar_Pervasives_Native.Some
          ...
          | (FStar_Extraction_ML_Syntax.MLE_Name
             mlp,FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor
              ...
              FStar_All.pipe_left (resugar_and_maybe_eta qual) uu____5003
          | (FStar_Extraction_ML_Syntax.MLE_Name
             mlp,FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_ctor uu____5007)) ->
              let uu____5016 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     mlAppExpr.FStar_Extraction_ML_Syntax.mlty)
                  (FStar_Extraction_ML_Syntax.MLE_CTor (mlp, [])) in
              FStar_All.pipe_left (resugar_and_maybe_eta qual) uu____5016
          | uu____5019 -> mlAppExpr
  ...
  fun g  ->
    fun f  ->
      fun t  ->
        ...
        if uu____5038 then FStar_Extraction_ML_Syntax.E_PURE else f
let rec term_as_mlexpr:
  ...
  fun g  ->
    fun t  ->
      let uu____5092 = term_as_mlexpr' g t in
      ...
      | (e,tag,ty) ->
          ...
          (FStar_Extraction_ML_UEnv.debug g
             (fun u  ->
                let uu____5113 =
                  let uu____5114 = FStar_Syntax_Print.tag_of_term t in
                  let uu____5115 = FStar_Syntax_Print.term_to_string t in
                  let uu____5116 =
                    FStar_Extraction_ML_Code.string_of_mlty
                      g.FStar_Extraction_ML_UEnv.currentModule ty in
                  FStar_Util.format4
                    "term_as_mlexpr (%s) :  %s has ML type %s and effect %s\n"
                    uu____5114 uu____5115 uu____5116
                    (FStar_Extraction_ML_Util.eff_to_string tag1) in
                FStar_Util.print_string uu____5113);
           erase g e ty tag1)
and check_term_as_mlexpr:
  ...
  fun g  ->
    fun t  ->
      fun f  ->
        fun ty  ->
          let uu____5125 = check_term_as_mlexpr' g t f ty in
          match uu____5125 with
          | (e,t1) ->
              let uu____5136 = erase g e t1 f in
              (match uu____5136 with | (r,uu____5148,t2) -> (r, t2))
and check_term_as_mlexpr':
  FStar_Extraction_ML_UEnv.env ->
    FStar_Syntax_Syntax.term ->
      FStar_Extraction_ML_Syntax.e_tag ->
      ...
      FStar_Extraction_ML_UEnv.debug g
        (fun u  ->
           let uu____5195 =
             ...
             let uu____5197 = FStar_Syntax_Print.tag_of_term top in
             let uu____5198 = FStar_Syntax_Print.term_to_string top in
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____5196 uu____5197 uu____5198 in
           FStar_Util.print_string uu____5195);
      (let t = FStar_Syntax_Subst.compress top in
       match t.FStar_Syntax_Syntax.n with
       | FStar_Syntax_Syntax.Tm_unknown  ->
           let uu____5206 =
             let uu____5207 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5207 in
           failwith uu____5206
       | FStar_Syntax_Syntax.Tm_delayed uu____5214 ->
           let uu____5239 =
             let uu____5240 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5240 in
           failwith uu____5239
       | FStar_Syntax_Syntax.Tm_uvar uu____5247 ->
           let uu____5264 =
             let uu____5265 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5265 in
           failwith uu____5264
       | FStar_Syntax_Syntax.Tm_bvar uu____5272 ->
           let uu____5273 =
             let uu____5274 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5274 in
           failwith uu____5273
       | FStar_Syntax_Syntax.Tm_type uu____5281 ->
           (FStar_Extraction_ML_Syntax.ml_unit,
             FStar_Extraction_ML_Syntax.E_PURE,
             FStar_Extraction_ML_Syntax.ml_unit_ty)
       | FStar_Syntax_Syntax.Tm_refine uu____5282 ->
           (FStar_Extraction_ML_Syntax.ml_unit,
             FStar_Extraction_ML_Syntax.E_PURE,
             FStar_Extraction_ML_Syntax.ml_unit_ty)
       ...
       | FStar_Syntax_Syntax.Tm_meta
           ...
           ->
           let uu____5307 = term_as_mlexpr' g t1 in
       ...
       | FStar_Syntax_Syntax.Tm_meta
           (t1,FStar_Syntax_Syntax.Meta_monadic (m,uu____5368)) ->
                 ...
                 | (ed,qualifiers) ->
                     let uu____5432 =
                       let uu____5433 =
                         FStar_All.pipe_right qualifiers
                           (FStar_List.contains FStar_Syntax_Syntax.Reifiable) in
                       FStar_All.pipe_right uu____5433 Prims.op_Negation in
                     if uu____5432
                     then term_as_mlexpr' g t2
                     else
                       failwith
                         "This should not happen (should have been handled at Tm_abs level)")
            | uu____5449 -> term_as_mlexpr' g t2)
       | FStar_Syntax_Syntax.Tm_meta (t1,uu____5451) -> term_as_mlexpr' g t1
       | FStar_Syntax_Syntax.Tm_uinst (t1,uu____5457) -> term_as_mlexpr' g t1
       | FStar_Syntax_Syntax.Tm_constant c ->
           let uu____5463 =
             FStar_TypeChecker_TcTerm.type_of_tot_term
               g.FStar_Extraction_ML_UEnv.tcenv t in
           (match uu____5463 with
            | (uu____5476,ty,uu____5478) ->
                ...
                let uu____5480 =
                  let uu____5481 =
                    ...
                    FStar_All.pipe_left
                      ...
                      uu____5482 in
                  FStar_Extraction_ML_Syntax.with_ty ml_ty uu____5481 in
                (uu____5480, FStar_Extraction_ML_Syntax.E_PURE, ml_ty))
       | FStar_Syntax_Syntax.Tm_name uu____5483 ->
           let uu____5484 = is_type g t in
           if uu____5484
           then
             (FStar_Extraction_ML_Syntax.ml_unit,
               FStar_Extraction_ML_Syntax.E_PURE,
             ...
             (let uu____5492 = FStar_Extraction_ML_UEnv.lookup_term g t in
              match uu____5492 with
              | (FStar_Util.Inl uu____5505,uu____5506) ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                    FStar_Extraction_ML_Syntax.ml_unit_ty)
              | (FStar_Util.Inr (uu____5543,x,mltys,uu____5546),qual) ->
                  (match mltys with
                   ...
                   | ([],t1) ->
                       ...
                       (uu____5592, FStar_Extraction_ML_Syntax.E_PURE, t1)
                   | uu____5593 -> err_uninst g t mltys t))
       | FStar_Syntax_Syntax.Tm_fvar uu____5600 ->
           let uu____5601 = is_type g t in
           if uu____5601
           then
             (FStar_Extraction_ML_Syntax.ml_unit,
               FStar_Extraction_ML_Syntax.E_PURE,
             ...
             (let uu____5609 = FStar_Extraction_ML_UEnv.lookup_term g t in
              match uu____5609 with
              | (FStar_Util.Inl uu____5622,uu____5623) ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                    FStar_Extraction_ML_Syntax.ml_unit_ty)
              | (FStar_Util.Inr (uu____5660,x,mltys,uu____5663),qual) ->
                  (match mltys with
                   | ([],t1) when t1 = FStar_Extraction_ML_Syntax.ml_unit_ty
                       ->
                       (FStar_Extraction_ML_Syntax.ml_unit,
                   ...
                   | ([],t1) ->
                       let uu____5709 =
                         maybe_eta_data_and_project_record g qual t1 x in
                       (uu____5709, FStar_Extraction_ML_Syntax.E_PURE, t1)
                   | uu____5710 -> err_uninst g t mltys t))
       | FStar_Syntax_Syntax.Tm_abs (bs,body,copt) ->
           let uu____5740 = FStar_Syntax_Subst.open_term bs body in
           (match uu____5740 with
            | (bs1,body1) ->
                let uu____5753 = binders_as_ml_binders g bs1 in
                     ...
                     let body2 =
                       ...
                       | FStar_Pervasives_Native.None  ->
                           (FStar_Extraction_ML_UEnv.debug g
                            ...
                            body1) in
                     let uu____5793 = term_as_mlexpr env body2 in
                      ...
                      | (ml_body,f,t1) ->
                          let uu____5809 =
                            FStar_List.fold_right
                              (fun uu____5828  ->
                                 fun uu____5829  ->
                                   match (uu____5828, uu____5829) with
                                   | ((uu____5850,targ),(f1,t2)) ->
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_reflect uu____5877);
              FStar_Syntax_Syntax.pos = uu____5878;
              FStar_Syntax_Syntax.vars = uu____5879;_},uu____5880)
           -> failwith "Unreachable? Tm_app Const_reflect"
       | FStar_Syntax_Syntax.Tm_app (head1,uu____5908::(v1,uu____5910)::[])
           when (FStar_Syntax_Util.is_fstar_tactics_embed head1) && false ->
           let uu____5951 =
             let uu____5954 = FStar_Syntax_Print.term_to_string v1 in
           ...
           let s =
             let uu____5956 =
               let uu____5957 =
                 let uu____5958 =
                   let uu____5961 = FStar_Util.marshal v1 in
                   FStar_Util.bytes_of_string uu____5961 in
                 FStar_Extraction_ML_Syntax.MLC_Bytes uu____5958 in
               FStar_Extraction_ML_Syntax.MLE_Const uu____5957 in
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____5956 in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_int_ty
           ...
           (uu____5981, FStar_Extraction_ML_Syntax.E_PURE, term_ty)
       | FStar_Syntax_Syntax.Tm_app (head1,args) ->
           let is_total rc =
             (FStar_Ident.lid_equals rc.FStar_Syntax_Syntax.residual_effect
               ...
               (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
                  (FStar_List.existsb
                     (fun uu___140_6013  ->
                        match uu___140_6013 with
                        | FStar_Syntax_Syntax.TOTAL  -> true
                        | uu____6014 -> false))) in
           let uu____6015 =
             let uu____6020 =
               let uu____6021 = FStar_Syntax_Subst.compress head1 in
               uu____6021.FStar_Syntax_Syntax.n in
             ((head1.FStar_Syntax_Syntax.n), uu____6020) in
           (match uu____6015 with
            | (FStar_Syntax_Syntax.Tm_uvar uu____6030,uu____6031) ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Normalize.Beta;
                    FStar_TypeChecker_Normalize.Iota;
                    ...
                    g.FStar_Extraction_ML_UEnv.tcenv t in
                term_as_mlexpr' g t1
            | (uu____6049,FStar_Syntax_Syntax.Tm_abs
               (bs,uu____6051,FStar_Pervasives_Native.Some rc)) when
                is_total rc ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Normalize.Beta;
                    ...
                    g.FStar_Extraction_ML_UEnv.tcenv t in
                term_as_mlexpr' g t1
            | (uu____6072,FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_reify )) ->
                let e =
                  let uu____6074 = FStar_List.hd args in
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6074 in
                let tm =
                  let uu____6084 =
                    let uu____6085 = FStar_TypeChecker_Util.remove_reify e in
                    let uu____6086 = FStar_List.tl args in
                    FStar_Syntax_Syntax.mk_Tm_app uu____6085 uu____6086 in
                  uu____6084 FStar_Pervasives_Native.None
                    t.FStar_Syntax_Syntax.pos in
                term_as_mlexpr' g tm
            | uu____6095 ->
                let rec extract_app is_data uu____6140 uu____6141 restArgs =
                  match (uu____6140, uu____6141) with
                       ...
                       | ([],uu____6231) ->
                           ...
                           let uu____6254 =
                             ...
                             then
                               ...
                               FStar_List.fold_left
                                 (fun uu____6333  ->
                                    fun uu____6334  ->
                                      match (uu____6333, uu____6334) with
                                      | ((lbs,out_args),(arg,f1)) ->
                                          if
                                            (f1 =
                                               FStar_Extraction_ML_Syntax.E_PURE)
                                               ...
                                               let uu____6440 =
                                                 FStar_All.pipe_left
                                                   ...
                                                   (FStar_Extraction_ML_Syntax.MLE_Var
                                                      x) in
                                               uu____6440 :: out_args in
                                             (((x, arg) :: lbs), uu____6437)))
                                 ([], []) mlargs_f in
                           (match uu____6254 with
                            | (lbs,mlargs) ->
                                ...
                                (l_app, f, t1))
                       | ((arg,uu____6523)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                          (formal_t,f',t2)) when
                           (is_type g arg) &&
                             (type_leq g formal_t
                                FStar_Extraction_ML_Syntax.ml_unit_ty)
                           ...
                           extract_app is_data
                             (mlhead,
                               ((FStar_Extraction_ML_Syntax.ml_unit,
                                  FStar_Extraction_ML_Syntax.E_PURE) ::
                               mlargs_f)) uu____6554 rest
                       | ((e0,uu____6571)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                          (tExpected,f',t2)) ->
                           let r = e0.FStar_Syntax_Syntax.pos in
                           let uu____6603 = term_as_mlexpr g e0 in
                ...
                let extract_app_maybe_projector is_data mlhead uu____6706
                  args1 =
                  match uu____6706 with
                  | (f,t1) ->
                      (match is_data with
                       | FStar_Pervasives_Native.Some
                           (FStar_Syntax_Syntax.Record_projector uu____6738)
                           ->
                           let rec remove_implicits args2 f1 t2 =
                             match (args2, t2) with
                             | ((a0,FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____6816))::args3,FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____6818,f',t3)) ->
                                 let uu____6855 =
                                   FStar_Extraction_ML_Util.join
                                     a0.FStar_Syntax_Syntax.pos f1 f' in
                                 remove_implicits args3 uu____6855 t3
                             | uu____6856 -> (args2, f1, t2) in
                           let uu____6881 = remove_implicits args1 f t1 in
                   ...
                   | FStar_Syntax_Syntax.Tm_fvar fv when
                       (FStar_Syntax_Syntax.fv_eq_lid fv
                         ...
                         (let uu____6967 =
                            ...
                            uu____6968 = "FStar.Tactics.Builtins" in
                          Prims.op_Negation uu____6967)
                       ->
                       (match args with
                        | a::b::[] ->
                        ...
                        | uu____7009 ->
                            ...
                            failwith uu____7018)
                   | FStar_Syntax_Syntax.Tm_name uu____7025 ->
                       let uu____7026 =
                         let uu____7039 =
                           FStar_Extraction_ML_UEnv.lookup_term g head2 in
                         match uu____7039 with
                         | (FStar_Util.Inr (uu____7058,x1,x2,x3),q) ->
                             ((x1, x2, x3), q)
                         | uu____7103 -> failwith "FIXME Ty" in
                       (match uu____7026 with
                        | ((head_ml,(vars,t1),inst_ok),qual) ->
                            let has_typ_apps =
                              match args with
                              | (a,uu____7153)::uu____7154 -> is_type g a
                              | uu____7173 -> false in
                            let uu____7182 =
                              match vars with
                              | uu____7211::uu____7212 when
                                    ...
                                    (match uu____7251 with
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                               uu____7349 ->
                                               let uu___144_7350 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_7350.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_7350.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7351 ->
                                               let uu___144_7352 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_7352.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_7352.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_7361 =
                                                        head3 in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_7361.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_7361.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                 ...
                                 (match args1 with
                                  ...
                                  | uu____7424 ->
                                      extract_app_maybe_projector qual
                                        ...
                                        (FStar_Extraction_ML_Syntax.E_PURE,
                                          head_t) args1)))
                   | FStar_Syntax_Syntax.Tm_fvar uu____7433 ->
                       let uu____7434 =
                         let uu____7447 =
                           FStar_Extraction_ML_UEnv.lookup_term g head2 in
                         match uu____7447 with
                         | (FStar_Util.Inr (uu____7466,x1,x2,x3),q) ->
                             ((x1, x2, x3), q)
                         | uu____7511 -> failwith "FIXME Ty" in
                       (match uu____7434 with
                        | ((head_ml,(vars,t1),inst_ok),qual) ->
                            let has_typ_apps =
                              match args with
                              | (a,uu____7561)::uu____7562 -> is_type g a
                              | uu____7581 -> false in
                            let uu____7590 =
                              match vars with
                              | uu____7619::uu____7620 when
                                  (Prims.op_Negation has_typ_apps) && inst_ok
                                  -> (head_ml, t1, args)
                              | uu____7631 ->
                                  let n1 = FStar_List.length vars in
                                    ...
                                    (match uu____7659 with
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                               uu____7757 ->
                                               let uu___144_7758 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_7758.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_7758.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7759 ->
                                               let uu___144_7760 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___144_7760.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___144_7760.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___145_7769 =
                                                        head3 in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___145_7769.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___145_7769.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                  ...
                                  | uu____7832 ->
                                      extract_app_maybe_projector qual
                                        ...
                                        (FStar_Extraction_ML_Syntax.E_PURE,
                                          head_t) args1)))
                   | uu____7841 ->
                       let uu____7842 = term_as_mlexpr g head2 in
                       (match uu____7842 with
                        | (head3,f,t1) ->
                            extract_app_maybe_projector
                              FStar_Pervasives_Native.None head3 (f, t1) args)))
       | FStar_Syntax_Syntax.Tm_ascribed (e0,(tc,uu____7860),f) ->
           let t1 =
             match tc with
           ...
           let uu____7927 = check_term_as_mlexpr g e0 f1 t1 in
           (match uu____7927 with | (e,t2) -> (e, f1, t2))
       | FStar_Syntax_Syntax.Tm_let ((is_rec,lbs),e') ->
           ...
           let uu____7958 =
             ...
             then FStar_Syntax_Subst.open_let_rec lbs e'
               ...
               (let uu____7972 = FStar_Syntax_Syntax.is_top_level lbs in
                if uu____7972
                then (lbs, e')
                else
                  (let lb = FStar_List.hd lbs in
                   let x =
                     ...
                     FStar_Syntax_Syntax.freshen_bv uu____7986 in
                   let lb1 =
                     let uu___146_7988 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___146_7988.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___146_7988.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___146_7988.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___146_7988.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e'1 =
            ...
            | (lbs1,e'1) ->
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8020 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8027  ->
                            ...
                            (let lbdef =
                               let uu____8031 = FStar_Options.ml_ish () in
                               if uu____8031
                             ...
                             let uu___147_8035 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___147_8035.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___147_8035.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___147_8035.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___147_8035.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = lbdef
                             })))
                  else lbs1 in
                let maybe_generalize uu____8058 =
                  match uu____8058 with
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      FStar_Syntax_Syntax.lbunivs = uu____8078;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           let uu____8148 = FStar_List.hd bs in
                           FStar_All.pipe_right uu____8148 (is_type_binder g)
                           ->
                           let uu____8161 = FStar_Syntax_Subst.open_comp bs c in
                            ...
                            | (bs1,c1) ->
                                let uu____8186 =
                                  let uu____8193 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8229 = is_type_binder g x in
                                         Prims.op_Negation uu____8229) bs1 in
                                ...
                                (match uu____8186 with
                                 | (tbinders,tbody) ->
                                     ...
                                     let e1 =
                                       let uu____8362 = normalize_abs e in
                  ...
                  FStar_List.fold_right
                    (fun lb  ->
                       fun uu____9646  ->
                         ...
                         | (env,lbs4) ->
                             let uu____9771 = lb in
                             (match uu____9771 with
                              | (lbname,uu____9819,(t1,(uu____9821,polytype)),add_unit,uu____9824)
                                  ->
                                  let uu____9837 =
                ...
                (match uu____9555 with
                 | (env_body,lbs4) ->
                     ...
                     let uu____10114 = term_as_mlexpr env_body e'1 in
                              ...
                              let uu____10145 =
                                let uu____10146 =
                                  FStar_List.map FStar_Pervasives_Native.snd
                                    lbs5 in
                                (is_rec1, [], uu____10146) in
                              mk_MLE_Let top_level uu____10145 e'2 in
                            let uu____10157 =
                              FStar_Extraction_ML_Util.mlloc_of_range
                                t.FStar_Syntax_Syntax.pos in
                            FStar_Extraction_ML_Syntax.with_ty_loc t'
                              uu____10144 uu____10157 in
                          (uu____10143, f, t'))))
       | FStar_Syntax_Syntax.Tm_match (scrutinee,pats) ->
           let uu____10196 = term_as_mlexpr g scrutinee in
           (match uu____10196 with
            | (e,f_e,t_e) ->
                let uu____10212 = check_pats_for_ite pats in
                       ...
                       (match (then_e, else_e) with
                        | (FStar_Pervasives_Native.Some
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            let uu____10269 = term_as_mlexpr g then_e1 in
                            (match uu____10269 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____10285 = term_as_mlexpr g else_e1 in
                                      ...
                                      (match uu____10301 with
                                       | (t_branch,maybe_lift1) ->
                                           let uu____10358 =
                                             ...
                                             FStar_All.pipe_left
                                               (FStar_Extraction_ML_Syntax.with_ty
                                                  t_branch) uu____10359 in
                                           let uu____10376 =
                                             FStar_Extraction_ML_Util.join
                                               then_e1.FStar_Syntax_Syntax.pos
                                               f_then f_else in
                                           (uu____10358, uu____10376,
                                             t_branch))))
                        | uu____10377 ->
                            failwith
                            ...
                            (match mlbranches1 with
                             | [] ->
                                 ...
                                 (match uu____10978 with
                                  | (uu____11047,fw,uu____11049,uu____11050)
                                      ->
                                      let uu____11051 =
                                        let uu____11052 =
                                          let uu____11053 =
                                      ...
                                      (uu____11051,
                                        FStar_Extraction_ML_Syntax.E_PURE,
                                        FStar_Extraction_ML_Syntax.ml_unit_ty))
                             | (uu____11066,uu____11067,(uu____11068,f_first,t_first))::rest
                                 ->
                                 let uu____11128 =
                                   FStar_List.fold_left
                                     (fun uu____11170  ->
                                        fun uu____11171  ->
                                          match (uu____11170, uu____11171)
                                          with
                                          | ((topt,f),(uu____11228,uu____11229,
                                                       (uu____11230,f_branch,t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
    ...
    fun discName  ->
      fun constrName  ->
        let uu____11463 =
          ...
          FStar_All.pipe_left FStar_Pervasives_Native.fst uu____11468 in
        match uu____11463 with
        | (uu____11493,fstar_disc_type) ->
            let wildcards =
              let uu____11506 =
                let uu____11507 = FStar_Syntax_Subst.compress fstar_disc_type in
                uu____11507.FStar_Syntax_Syntax.n in
              match uu____11506 with
              | FStar_Syntax_Syntax.Tm_arrow (binders,uu____11521) ->
                  let uu____11538 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___141_11570  ->
                            match uu___141_11570 with
                            | (uu____11577,FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____11578)) ->
                                true
                            | uu____11581 -> false)) in
                  FStar_All.pipe_right uu____11538
                    (FStar_List.map
                       (fun uu____11622  ->
                          let uu____11629 = fresh "_" in
                          (uu____11629, FStar_Extraction_ML_Syntax.MLTY_Top)))
              | uu____11638 -> failwith "Discriminator must be a function" in
                        ...
                        let uu____11686 =
                          let uu____11687 =
                            let uu____11688 =
                              ...
                              ([], uu____11689) in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____11688 in
                          FStar_All.pipe_left
                        ...
                        let uu____11692 =
                          let uu____11703 =
                            let uu____11712 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11713 in
                            let uu____11723 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                            ...
                            (uu____11712, FStar_Pervasives_Native.None,
                              uu____11723) in
                          let uu____11726 =
                            let uu____11737 =
                              let uu____11746 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11746) in
                            [uu____11737] in
                          uu____11703 :: uu____11726 in
                        (uu____11686, uu____11692) in
                      FStar_Extraction_ML_Syntax.MLE_Match uu____11671 in
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11670 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11669) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11658 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11657 in
            let uu____11821 =
              let uu____11822 =
                let uu____11825 =
                  let uu____11826 =
                  ...
                  {
                    FStar_Extraction_ML_Syntax.mllb_name = uu____11826;
                    FStar_Extraction_ML_Syntax.mllb_tysc =
                      FStar_Pervasives_Native.None;
                ...
                [uu____11825] in
              (FStar_Extraction_ML_Syntax.NonRec, [], uu____11822) in
            FStar_Extraction_ML_Syntax.MLM_Let uu____11821