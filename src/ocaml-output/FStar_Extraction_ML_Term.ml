...
let fail r msg =
  (let _0_450 =
     let _0_449 = FStar_Range.string_of_range r in
     FStar_Util.format2 "%s: %s\n" _0_449 msg in
   FStar_All.pipe_left FStar_Util.print_string _0_450);
  failwith msg
let err_uninst env t uu____105 app =
  match uu____105 with
  | (vars,ty) ->
      let _0_456 =
        let _0_455 = FStar_Syntax_Print.term_to_string t in
        let _0_454 =
          let _0_451 = FStar_All.pipe_right vars (FStar_List.map Prims.fst) in
          FStar_All.pipe_right _0_451 (FStar_String.concat ", ") in
        let _0_453 =
          FStar_Extraction_ML_Code.string_of_mlty
            env.FStar_Extraction_ML_UEnv.currentModule ty in
        let _0_452 = FStar_Syntax_Print.term_to_string app in
        FStar_Util.format4
          "Variable %s has a polymorphic type (forall %s. %s); expected it to be fully instantiated, but got %s"
          _0_455 _0_454 _0_453 _0_452 in
      fail t.FStar_Syntax_Syntax.pos _0_456
let err_ill_typed_application env t args ty =
  let _0_461 =
    ...
    let _0_459 =
      ...
      FStar_All.pipe_right _0_457 (FStar_String.concat " ") in
    let _0_458 =
      FStar_Extraction_ML_Code.string_of_mlty
        env.FStar_Extraction_ML_UEnv.currentModule ty in
    FStar_Util.format3
      "Ill-typed application: application is %s \n remaining args are %s\nml type of head is %s\n"
      _0_460 _0_459 _0_458 in
  fail t.FStar_Syntax_Syntax.pos _0_461
let err_value_restriction t =
  let _0_464 =
    let _0_463 = FStar_Syntax_Print.tag_of_term t in
    let _0_462 = FStar_Syntax_Print.term_to_string t in
    FStar_Util.format2
...
let err_unexpected_eff t f0 f1 =
  let _0_466 =
    let _0_465 = FStar_Syntax_Print.term_to_string t in
    FStar_Util.format3 "for expression %s, Expected effect %s; got effect %s"
      _0_465 (FStar_Extraction_ML_Util.eff_to_string f0)
      (FStar_Extraction_ML_Util.eff_to_string f1) in
  fail t.FStar_Syntax_Syntax.pos _0_466
let effect_as_etag:
  FStar_Extraction_ML_UEnv.env ->
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_delayed _|FStar_Syntax_Syntax.Tm_unknown  ->
          failwith
            (let _0_467 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: %s" _0_467)
    ...
    fun t  ->
      ...
      FStar_Extraction_ML_UEnv.debug env
        (fun uu____638  ->
           if b
           then
             let _0_469 = FStar_Syntax_Print.term_to_string t in
             let _0_468 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.print2 "is_type %s (%s)\n" _0_469 _0_468
           else
             (let _0_471 = FStar_Syntax_Print.term_to_string t in
              let _0_470 = FStar_Syntax_Print.tag_of_term t in
...
let unit_binder: FStar_Syntax_Syntax.binder =
  ...
  FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder _0_472
        ...
        |FStar_Syntax_Syntax.Tm_delayed _|FStar_Syntax_Syntax.Tm_unknown  ->
          failwith
            (let _0_476 = FStar_Syntax_Print.term_to_string t in
             FStar_Util.format1 "Impossible: Unexpected term %s" _0_476)
            ...
            let mlargs =
              ...
              then
                ...
                | (uu____1361,rest) ->
                    ...
                    FStar_List.append mlargs _0_478
              else mlargs in
            let nm =
              let uu____1382 =
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (_0_479, FStar_Extraction_ML_Syntax.ml_unit_ty) in
                        ((ml_b :: ml_bs), env)
                      else
                        (let b = Prims.fst b in
                    ...
                    FStar_Extraction_ML_Syntax.MLE_App
                      (let _0_489 =
                         ...
                         let _0_487 =
                           ...
                           [_0_486] in
                         _0_488 :: _0_487 in
                       (FStar_Extraction_ML_Util.prims_op_equality, _0_489)) in
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_bool_ty) _0_490 in
                let _0_491 = ok FStar_Extraction_ML_Syntax.ml_int_ty in
                (g,
                  (Some
                ...
                let _0_494 =
                  Some
                    (let _0_492 =
                     ...
                     (_0_492, [])) in
                let _0_493 = ok mlty in (g, _0_494, _0_493)
                  ...
                  then None
                    ...
                    Some
                      ((let _0_495 =
                        ...
                        (_0_495, []))) in
                let _0_496 = ok mlty in (g, _0_497, _0_496)
                    ...
                    Some
                      ((let _0_498 =
                          FStar_Extraction_ML_Syntax.MLP_Var
                            (FStar_Extraction_ML_Syntax.bv_as_mlident x) in
                        (_0_498, []))) in
                let _0_499 = ok mlty in (g, _0_500, _0_499)
                             ...
                             FStar_All.pipe_right ps_when
                               (FStar_List.map
                                  (fun uu____2613  ->
                                     ...
                                     | (x,whens) ->
                                         let _0_506 = mk_when_clause whens in
                                         (x, _0_506))) in
                           let res =
                             match rest with
                             | [] -> (g, ps, b)
        ...
        fun mlAppExpr  ->
          ...
          | (FStar_Extraction_ML_Syntax.MLE_App
            ...
            |(FStar_Extraction_ML_Syntax.MLE_App
              ...
              FStar_All.pipe_left (resugar_and_maybe_eta qual) _0_516
          | (FStar_Extraction_ML_Syntax.MLE_Name mlp,Some
            ...
            |(FStar_Extraction_ML_Syntax.MLE_Name mlp,Some
              ...
              FStar_All.pipe_left (resugar_and_maybe_eta qual) _0_517
          ...
          (FStar_Extraction_ML_UEnv.debug g
             (fun u  ->
                FStar_Util.print_string
                  (let _0_520 = FStar_Syntax_Print.tag_of_term t in
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then let _0_521 = maybe_coerce g e t ty in (_0_521, ty)
  ...
  fun g  ->
    fun top  ->
        ...
        (fun u  ->
           FStar_Util.print_string
             (let _0_524 =
              ...
              let _0_523 = FStar_Syntax_Print.tag_of_term top in
              let _0_522 = FStar_Syntax_Print.term_to_string top in
      ...
      (let t = FStar_Syntax_Subst.compress top in
       ...
       | FStar_Syntax_Syntax.Tm_unknown 
         |FStar_Syntax_Syntax.Tm_delayed _
          |FStar_Syntax_Syntax.Tm_uvar _|FStar_Syntax_Syntax.Tm_bvar _ ->
           failwith
             (let _0_525 = FStar_Syntax_Print.tag_of_term t in
              FStar_Util.format1 "Impossible: Unexpected term: %s" _0_525)
       | FStar_Syntax_Syntax.Tm_type _
         |FStar_Syntax_Syntax.Tm_refine _|FStar_Syntax_Syntax.Tm_arrow _ ->
           (FStar_Extraction_ML_Syntax.ml_unit,
             FStar_Extraction_ML_Syntax.E_PURE,
                ...
                let uu____3122 =
                  let _0_526 =
                    FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers
                      (FStar_List.contains FStar_Syntax_Syntax.Reifiable) in
                  FStar_All.pipe_right _0_526 Prims.op_Negation in
                if uu____3122
                         ...
                         let k =
                           let _0_529 =
                             let _0_528 =
                               ...
                               FStar_All.pipe_right _0_527
                                 FStar_Syntax_Syntax.mk_binder in
                             [_0_528] in
                           FStar_Syntax_Util.abs _0_529 body None in
                        ...
                        | (ml_k,ty) ->
                            ...
                            let _0_532 =
                              FStar_All.pipe_left
                                ...
                                (FStar_Extraction_ML_Syntax.MLE_App
                                   (bind, [comp_1; ml_k])) in
                            (_0_532, FStar_Extraction_ML_Syntax.E_IMPURE, ty)))
            ...
            | (uu____3191,ty,uu____3193) ->
                ...
                let _0_536 =
                  let _0_535 =
                    ...
                    FStar_All.pipe_left
                      (fun _0_533  ->
                         FStar_Extraction_ML_Syntax.MLE_Const _0_533) _0_534 in
                  FStar_Extraction_ML_Syntax.with_ty ml_ty _0_535 in
                (_0_536, FStar_Extraction_ML_Syntax.E_PURE, ml_ty))
              ...
              | (FStar_Util.Inr (x,mltys,uu____3229),qual) ->
                  (match mltys with
                   ...
                   | ([],t) ->
                       ...
                       (_0_537, FStar_Extraction_ML_Syntax.E_PURE, t)
       ...
       | FStar_Syntax_Syntax.Tm_app (head,args) ->
           let is_total uu___136_3450 =
             match uu___136_3450 with
                           ...
                           let rec remove_implicits args f t =
                             ...
                             | ((a0,Some (FStar_Syntax_Syntax.Implicit
                                ...
                                (uu____3926,f',t)) ->
                                 ...
                                 remove_implicits args _0_552 t
                                     ...
                                     | (prefix,rest) ->
                                         ...
                                         let head =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                             ...
                                             |FStar_Extraction_ML_Syntax.MLE_Var
                                             _ ->
                                               let uu___140_4214 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___140_4214.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___140_4214.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head,{
                                                       FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___141_4220 =
                                                        head in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___141_4220.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___141_4220.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t)
               ...
               (let uu____4343 = FStar_Syntax_Syntax.is_top_level lbs in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs in
                   ...
                   let lb =
                     let uu___142_4354 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___142_4354.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___142_4354.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___142_4354.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___142_4354.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e' =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv _0_554 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4374  ->
                            ...
                            (let lbdef =
                             ...
                             let uu___143_4382 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___143_4382.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___143_4382.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___143_4382.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___143_4382.FStar_Syntax_Syntax.lbeff);
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           let _0_555 = FStar_List.hd bs in
                           FStar_All.pipe_right _0_555 (is_type_binder g) ->
                 ...
                 | (env_body,lbs) ->
                     ...
                     (match uu____5339 with
                      | (e',f',t') ->
                          let f =
                            let _0_563 =
                              let _0_562 = FStar_List.map Prims.fst lbs in f'
                                :: _0_562 in
                            FStar_Extraction_ML_Util.join_l e'_rng _0_563 in
                          let is_rec =
                            if is_rec = true
                          ...
                          let _0_568 =
                            let _0_567 =
                              let _0_565 =
                                let _0_564 = FStar_List.map Prims.snd lbs in
                                (is_rec, [], _0_564) in
                              mk_MLE_Let top_level _0_565 e' in
                            let _0_566 =
                              FStar_Extraction_ML_Util.mlloc_of_range
                                t.FStar_Syntax_Syntax.pos in
                            FStar_Extraction_ML_Syntax.with_ty_loc t' _0_567
                              _0_566 in
                          (_0_568, f, t'))))
                                      ...
                                      let _0_583 =
                                        FStar_All.pipe_left
                                          ...
                                          (FStar_Extraction_ML_Syntax.MLE_Match
                                             (e, mlbranches)) in
                                      (_0_583, f_match, t_match)))))))
let fresh: Prims.string -> (Prims.string* Prims.int) =
  let c = FStar_Util.mk_ref (Prims.parse_int "0") in
  fun x  -> FStar_Util.incr c; (let _0_584 = FStar_ST.read c in (x, _0_584))
              ...
              | FStar_Syntax_Syntax.Tm_arrow (binders,uu____6075) ->
                  let _0_586 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___137_6105  ->
                            match uu___137_6105 with
                            | (uu____6109,Some (FStar_Syntax_Syntax.Implicit
                               uu____6110)) -> true
                            | uu____6112 -> false)) in
                  FStar_All.pipe_right _0_586
                    (FStar_List.map
                       (fun uu____6123  ->
                          let _0_585 = fresh "_" in
                          (_0_585, FStar_Extraction_ML_Syntax.MLTY_Top)))
              ...
              let _0_600 =
                FStar_Extraction_ML_Syntax.MLE_Fun
                  (let _0_599 =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.ml_bool_ty) _0_598 in
                   ((FStar_List.append wildcards [(mlid, targ)]), _0_599)) in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) _0_600 in
            FStar_Extraction_ML_Syntax.MLM_Let
              (let _0_603 =
                 let _0_602 =
                   ...
                   {
                     FStar_Extraction_ML_Syntax.mllb_name = _0_601;
                 ...
                 [_0_602] in
               (FStar_Extraction_ML_Syntax.NonRec, [], _0_603))