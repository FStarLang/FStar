    ...
    let rec aux bs t copt =
      ...
      | uu____851 ->
          ...
          (match uu____853 with
           | true  -> aux bs e' copt
           | uu____854 -> FStar_Syntax_Util.abs bs e' copt)
       in
    aux [] t0 None
  ...
  fun l  ->
    ...
    | uu____905 ->
        ...
        (match uu____906 with
         | (p1,w1,e1) ->
             let uu____925 =
               let uu____930 = FStar_List.tl l  in FStar_List.hd uu____930
                in
        ...
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              (match FStar_Extraction_ML_Util.eff_leq tag f with
               | true  ->
                   let uu____3207 = maybe_coerce g e t ty  in
                   (uu____3207, ty)
                     ...
                     (match uu____5588 with
                      | (e',f',t') ->
                          ...
                          let is_rec =
                            ...
                            | uu____5606 -> FStar_Extraction_ML_Syntax.NonRec
                             in
                          let uu____5607 =
                            let uu____5608 =
                              let uu____5609 =
