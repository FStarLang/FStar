      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then
                let uu____5254 = maybe_coerce g e t ty  in (uu____5254, ty)
        ...
        (fun u  ->
           let uu____5272 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____5273 uu____5274 uu____5275
              in
      ...
      (let t = FStar_Syntax_Subst.compress top  in
       ...
       | FStar_Syntax_Syntax.Tm_unknown  ->
           let uu____5283 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5284
              in
           failwith uu____5283
       ...
       | FStar_Syntax_Syntax.Tm_uvar uu____5324 ->
           let uu____5341 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5342
              in
           failwith uu____5341
       | FStar_Syntax_Syntax.Tm_bvar uu____5349 ->
           let uu____5350 =
             let uu____5351 = FStar_Syntax_Print.tag_of_term t  in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5351
              in
           failwith uu____5350
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____6011::(v1,uu____6013)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____6059
              in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6177
                   in
                let tm =
                  let uu____6187 =
                    let uu____6188 = FStar_TypeChecker_Util.remove_reify e
                       in
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8155
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8162  ->
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____8296 = FStar_Syntax_Subst.open_comp bs c
                              in
                                ...
                                let uu____8321 =
                                  let uu____8328 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8364 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____8364) bs1
                                     in
                           ...
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____10233 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____10249 = term_as_mlexpr g else_e1
                                    in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____11454,fstar_disc_type) ->
            let wildcards =
              let uu____11463 =
                let uu____11464 = FStar_Syntax_Subst.compress fstar_disc_type
                   in
              ...
              | uu____11575 -> failwith "Discriminator must be a function"
               in
              ...
              let uu____11586 =
                let uu____11587 =
                  let uu____11598 =
                            ...
                            let uu____11638 =
                              let uu____11639 =
                                ...
                                (uu____11646,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11639
                               in
                            let uu____11649 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                            ...
                            let uu____11663 =
                              let uu____11672 =
                                FStar_All.pipe_left
                                 ...
                                 in
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11672)
                               in
                            [uu____11663]  in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11599
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11598)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11587  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11586
               in
            let uu____11727 =
              let uu____11728 =
                let uu____11731 =
