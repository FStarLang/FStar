...
let t = (FStar_TypeChecker_Env.reify_comp env.FStar_Extraction_ML_UEnv.tcenv c FStar_Syntax_Syntax.U_unknown)
in (
...
let uu____2332 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun uu___133_2357 -> (match (uu___133_2357) with
| Some (x) -> begin
(x)::[]
end
| uu____2379 -> begin
...
let uu____2661 = (FStar_All.pipe_right ps (FStar_List.partition (fun uu___134_2689 -> (match (uu___134_2689) with
...
let is_total = (fun uu___136_3648 -> (match (uu___136_3648) with
| FStar_Util.Inl (l) -> begin
(FStar_Syntax_Util.is_total_lcomp l)
end
| FStar_Util.Inr (l, flags) -> begin
((FStar_Ident.lid_equals l FStar_Syntax_Const.effect_Tot_lid) || (FStar_All.pipe_right flags (FStar_List.existsb (fun uu___135_3666 -> (match (uu___135_3666) with
...
let uu___140_4436 = head_ml
in {FStar_Extraction_ML_Syntax.expr = uu___140_4436.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t; FStar_Extraction_ML_Syntax.loc = uu___140_4436.FStar_Extraction_ML_Syntax.loc})
end
...
let uu___141_4442 = head
in {FStar_Extraction_ML_Syntax.expr = uu___141_4442.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t))); FStar_Extraction_ML_Syntax.loc = uu___141_4442.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t))
end
| uu____4443 -> begin
...
let uu___142_4578 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___142_4578.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___142_4578.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___142_4578.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___142_4578.FStar_Syntax_Syntax.lbdef})
in (
...
let uu___143_4607 = lb
in {FStar_Syntax_Syntax.lbname = uu___143_4607.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___143_4607.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___143_4607.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___143_4607.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbdef}));
)))))
end
| uu____4608 -> begin
lbs
...
let uu____6393 = (FStar_All.pipe_right binders (FStar_List.filter (fun uu___137_6408 -> (match (uu___137_6408) with
