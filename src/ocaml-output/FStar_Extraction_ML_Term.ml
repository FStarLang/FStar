    ...
    | FStar_Syntax_Syntax.Comp ct ->
        let effect_args =
          FStar_List.map
           ...
           in
        let ct1 =
          let uu___363_2244 = ct  in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___363_2244.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___363_2244.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___363_2244.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args = effect_args;
            FStar_Syntax_Syntax.flags =
              (uu___363_2244.FStar_Syntax_Syntax.flags)
          }  in
        let c1 =
          let uu___364_2248 = c  in
          {
            FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
            FStar_Syntax_Syntax.pos = (uu___364_2248.FStar_Syntax_Syntax.pos);
            FStar_Syntax_Syntax.vars =
              (uu___364_2248.FStar_Syntax_Syntax.vars)
          }  in
        c1
                                        ...
                                        let mk_tapp e ty_args =
                                          ...
                                          | uu____9707 ->
                                              let uu___367_9710 = e  in
                                              {
                                                ...
                                                FStar_Extraction_ML_Syntax.mlty
                                                  =
                                                  (uu___367_9710.FStar_Extraction_ML_Syntax.mlty);
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___367_9710.FStar_Extraction_ML_Syntax.loc)
                                              }
                                           in
                                        let head3 =
                                          ...
                                          | FStar_Extraction_ML_Syntax.MLE_Name
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___368_9715.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___368_9715.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_Var
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___368_9717.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___368_9717.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_App
                                              (head3,{
                                                       FStar_Extraction_ML_Syntax.expr
                                                ...
                                                (FStar_Extraction_ML_Syntax.MLE_App
                                                   ((let uu___369_9726 =
                                                        ...
                                                        in
                                                     {
                                                       FStar_Extraction_ML_Syntax.expr
                                                         =
                                                         (uu___369_9726.FStar_Extraction_ML_Syntax.expr);
                                                       FStar_Extraction_ML_Syntax.mlty
                                                         =
                                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                            (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                       ...
                                                       FStar_Extraction_ML_Syntax.loc
                                                         =
                                                         (uu___369_9726.FStar_Extraction_ML_Syntax.loc)
                                                     }),
                                                     [FStar_Extraction_ML_Syntax.ml_unit]))
                                                (FStar_Extraction_ML_Syntax.with_ty
                                                   t2)
                                        ...
                                        let mk_tapp e ty_args =
                                          ...
                                          | uu____10181 ->
                                              let uu___367_10184 = e  in
                                              {
                                                ...
                                                FStar_Extraction_ML_Syntax.mlty
                                                  =
                                                  (uu___367_10184.FStar_Extraction_ML_Syntax.mlty);
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___367_10184.FStar_Extraction_ML_Syntax.loc)
                                              }
                                           in
                                        let head3 =
                                          match head_ml.FStar_Extraction_ML_Syntax.expr
                                          ...
                                          | FStar_Extraction_ML_Syntax.MLE_Name
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___368_10189.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___368_10189.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_Var
                                              uu____10190 ->
                                              let uu___368_10191 =
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___368_10191.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___368_10191.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_App
                                              (head3,{
                                                       FStar_Extraction_ML_Syntax.expr
                                                ...
                                                (FStar_Extraction_ML_Syntax.MLE_App
                                                   ((let uu___369_10200 =
                                                        ...
                                                        in
                                                     {
                                                       FStar_Extraction_ML_Syntax.expr
                                                         =
                                                         (uu___369_10200.FStar_Extraction_ML_Syntax.expr);
                                                       FStar_Extraction_ML_Syntax.mlty
                                                         =
                                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                            (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                       ...
                                                       FStar_Extraction_ML_Syntax.loc
                                                         =
                                                         (uu___369_10200.FStar_Extraction_ML_Syntax.loc)
                                                     }),
                                                     [FStar_Extraction_ML_Syntax.ml_unit]))
                                                (FStar_Extraction_ML_Syntax.with_ty
                                                   t2)
               ...
               (let uu____10437 = FStar_Syntax_Syntax.is_top_level lbs  in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs  in
                   ...
                   let lb1 =
                     let uu___370_10451 = lb  in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___370_10451.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___370_10451.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___370_10451.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___370_10451.FStar_Syntax_Syntax.lbdef);
                       FStar_Syntax_Syntax.lbattrs =
                         (uu___370_10451.FStar_Syntax_Syntax.lbattrs);
                       FStar_Syntax_Syntax.lbpos =
                         (uu___370_10451.FStar_Syntax_Syntax.lbpos)
                     }  in
                   let e'1 =
                         ...
                         (fun lb  ->
                            ...
                            let lbdef =
                              ...
                              then lb.FStar_Syntax_Syntax.lbdef
                               ...
                               in
                            let uu___371_10494 = lb  in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___371_10494.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___371_10494.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp =
                                (uu___371_10494.FStar_Syntax_Syntax.lbtyp);
                              FStar_Syntax_Syntax.lbeff =
                                (uu___371_10494.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef = lbdef;
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___371_10494.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___371_10494.FStar_Syntax_Syntax.lbpos)
                            }))
                  else lbs1  in
