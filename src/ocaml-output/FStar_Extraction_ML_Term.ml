...
let _79_22 = (let _174_33 = (let _174_32 = (FStar_Range.string_of_range r)
in (FStar_Util.format2 "%s: %s\n" _174_32 msg))
in (FStar_All.pipe_left FStar_Util.print_string _174_33))
in (FStar_All.failwith msg)))


let err_uninst = (fun env t _79_28 -> (match (_79_28) with
| (vars, ty) -> begin
...
in (let _174_49 = (let _174_47 = (FStar_All.pipe_right args (FStar_List.map (fun _79_36 -> (match (_79_36) with
| (x, _79_35) -> begin
...
let _79_55 = (FStar_Util.smap_add cache l.FStar_Ident.str res)
in res))
end))
in (fun g l -> (
...
let _79_72 = (FStar_Extraction_ML_UEnv.debug env (fun _79_70 -> (let _174_82 = (FStar_Syntax_Print.term_to_string t)
in (let _174_81 = (FStar_Syntax_Print.tag_of_term t)
in (FStar_Util.print2 "level %s (%s)\n" _174_82 _174_81)))))
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (_79_75) -> begin
...
| FStar_Syntax_Syntax.Tm_constant (_79_79) -> begin
Term_level
end
| FStar_Syntax_Syntax.Tm_fvar ({FStar_Syntax_Syntax.fv_name = _79_87; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_defined_at_level (_79_84); FStar_Syntax_Syntax.fv_qual = _79_82}) -> begin
(
...
let _79_92 = (FStar_Extraction_ML_UEnv.debug env (fun _79_91 -> (match (()) with
| () -> begin
...
| FStar_Syntax_Syntax.Tm_ascribed (t, _79_115, _79_117) -> begin
(level env t)
end
| FStar_Syntax_Syntax.Tm_type (_79_121) -> begin
Kind_level
end
| FStar_Syntax_Syntax.Tm_uinst (t, _79_125) -> begin
(level env t)
end
| FStar_Syntax_Syntax.Tm_refine (x, _79_130) -> begin
...
| FStar_Syntax_Syntax.Tm_abs (bs, body, _79_144) -> begin
(level env body)
end
| FStar_Syntax_Syntax.Tm_let (_79_148, body) -> begin
(level env body)
end
| FStar_Syntax_Syntax.Tm_match (_79_153, branches) -> begin
(match (branches) with
| ((_79_160, _79_162, e))::_79_158 -> begin
(level env e)
end
| _79_167 -> begin
...
| FStar_Syntax_Syntax.Tm_meta (t, _79_170) -> begin
(level env t)
end
| FStar_Syntax_Syntax.Tm_app (head, _79_175) -> begin
(level env head)
end)))))
...
(FStar_All.pipe_right args (FStar_List.for_all (fun _79_229 -> (match (_79_229) with
| (te, _79_228) -> begin
(is_fstar_value te)
end))))
end else begin
...
| FStar_Extraction_ML_Syntax.MLE_Record (_79_263, fields) -> begin
(FStar_Util.for_all (fun _79_270 -> (match (_79_270) with
| (_79_268, e) -> begin
(is_ml_value e)
end)) fields)
end
...
let _79_292 = (FStar_List.hd l)
in (match (_79_292) with
| (p1, w1, e1) -> begin
(

let _79_296 = (let _174_120 = (FStar_List.tl l)
...
let _79_339 = (FStar_Extraction_ML_UEnv.debug g (fun _79_338 -> (match (()) with
| () -> begin
...
| FStar_Util.Inl (_79_344, t) -> begin
t
end
| _79_349 -> begin
...
| FStar_Extraction_ML_Syntax.MLTY_Named (_79_356) -> begin
...
| FStar_Syntax_Syntax.Tm_constant (_79_377) -> begin
FStar_Extraction_ML_UEnv.unknownType
end
| FStar_Syntax_Syntax.Tm_uvar (_79_380) -> begin
FStar_Extraction_ML_UEnv.unknownType
end
...
let _79_416 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_79_416) with
| (bs, c) -> begin
(

let _79_419 = (binders_as_ml_binders env bs)
in (match (_79_419) with
| (mlbs, env) -> begin
(
...
let _79_436 = (FStar_List.fold_right (fun _79_429 _79_432 -> (match (((_79_429), (_79_432))) with
| ((_79_427, t), (tag, t')) -> begin
((FStar_Extraction_ML_Syntax.E_PURE), (FStar_Extraction_ML_Syntax.MLTY_Fun (((t), (tag), (t')))))
end)) mlbs ((erase), (t_ret)))
in (match (_79_436) with
| (_79_434, t) -> begin
t
end))))
end))
...
| FStar_Syntax_Syntax.Tm_abs (bs, ty, _79_455) -> begin
(

let _79_460 = (FStar_Syntax_Subst.open_term bs ty)
in (match (_79_460) with
| (bs, ty) -> begin
(

let _79_463 = (binders_as_ml_binders env bs)
...
and arg_as_mlty : FStar_Extraction_ML_UEnv.env  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier Prims.option)  ->  FStar_Extraction_ML_Syntax.mlty = (fun g _79_477 -> (match (_79_477) with
| (a, _79_476) -> begin
...
let _79_483 = (FStar_Syntax_Util.arrow_formals fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.ty)
in (match (_79_483) with
| (formals, t) -> begin
(
...
let _79_489 = (FStar_Util.first_N n_args formals)
in (match (_79_489) with
| (_79_487, rest) -> begin
(let _174_184 = (FStar_List.map (fun _79_490 -> FStar_Extraction_ML_UEnv.erasedContent) rest)
...
let _79_512 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun _79_501 b -> (match (_79_501) with
| (ml_bs, env) -> begin
...
| (FStar_Extraction_ML_Syntax.MLE_Seq (es1), _79_523) -> begin
FStar_Extraction_ML_Syntax.MLE_Seq ((FStar_List.append es1 ((e2)::[])))
end
| (_79_526, FStar_Extraction_ML_Syntax.MLE_Seq (es2)) -> begin
...
| _79_547 when (lb.FStar_Extraction_ML_Syntax.mllb_def.FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.ml_unit.FStar_Extraction_ML_Syntax.expr) -> begin
...
let _79_592 = if (not (ok)) then begin
(FStar_Extraction_ML_UEnv.debug g (fun _79_590 -> (let _174_225 = (FStar_Extraction_ML_Code.string_of_mlty g.FStar_Extraction_ML_UEnv.currentModule t')
...
| FStar_Syntax_Syntax.Pat_disj (_79_595) -> begin
...
| FStar_Syntax_Syntax.Pat_dot_term (_79_620) -> begin
((g), (None), (true))
end
| FStar_Syntax_Syntax.Pat_cons (f, pats) -> begin
(

let _79_642 = (match ((FStar_Extraction_ML_UEnv.lookup_fv g f)) with
| FStar_Util.Inr ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (n); FStar_Extraction_ML_Syntax.mlty = _79_629; FStar_Extraction_ML_Syntax.loc = _79_627}, ttys, _79_635) -> begin
((n), (ttys))
end
| _79_639 -> begin
(FStar_All.failwith "Expected a constructor")
end)
in (match (_79_642) with
| (d, tys) -> begin
(
...
let _79_646 = (FStar_Util.first_N nTyVars pats)
...
let mlty_args = (FStar_All.pipe_right tysVarPats (FStar_List.map (fun _79_656 -> (match (_79_656) with
| (p, _79_655) -> begin
(match (p.FStar_Syntax_Syntax.v) with
| FStar_Syntax_Syntax.Pat_dot_term (_79_658, t) -> begin
(term_as_mlty g t)
end
| _79_663 -> begin
(

let _79_666 = (FStar_Extraction_ML_UEnv.debug g (fun _79_664 -> (let _174_254 = (FStar_Syntax_Print.pat_to_string p)
...
let _79_682 = (FStar_Util.fold_map (fun g _79_674 -> (match (_79_674) with
| (p, imp) -> begin
(

let _79_679 = (extract_one_pat disjunctive_pat true g p None)
in (match (_79_679) with
| (g, p, _79_678) -> begin
((g), (p))
end))
end)) g tysVarPats)
in (match (_79_682) with
| (g, tyMLPats) -> begin
(

let _79_709 = (FStar_Util.fold_map (fun _79_685 _79_688 -> (match (((_79_685), (_79_688))) with
| ((g, f_ty_opt), (p, imp)) -> begin
(

let _79_699 = (match (f_ty_opt) with
...
let _79_704 = (extract_one_pat disjunctive_pat false g p expected_ty)
...
in (match (_79_709) with
| ((g, f_ty_opt), restMLPats) -> begin
(

let _79_717 = (let _174_262 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun _79_2 -> (match (_79_2) with
| Some (x) -> begin
(x)::[]
end
| _79_714 -> begin
...
let _79_764 = (FStar_Util.fold_map (fun b p -> (
...
let _79_779 = (FStar_All.pipe_right ps (FStar_List.partition (fun _79_3 -> (match (_79_3) with
| (_79_768, (_79_772)::_79_770) -> begin
true
end
| _79_776 -> begin
false
...
let ps = (FStar_All.pipe_right ps_when (FStar_List.map (fun _79_782 -> (match (_79_782) with
| (x, whens) -> begin
...
let _79_794 = (extract_one_pat false g p (Some (expected_t)))
in (match (_79_794) with
| (g, (p, whens), b) -> begin
(
...
| FStar_Extraction_ML_Syntax.MLTY_Fun (t0, _79_805, t1) -> begin
(
...
| FStar_Extraction_ML_Syntax.MLTY_Named (_79_811, _79_813) -> begin
...
| (FStar_Extraction_ML_Syntax.MLE_CTor (_79_822, args), Some (FStar_Syntax_Syntax.Record_ctor (tyname, fields))) -> begin
(
...
let _79_841 = (eta_args [] residualType)
...
let _79_847 = (FStar_List.unzip eargs)
in (match (_79_847) with
| (binders, eargs) -> begin
...
| (FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (mlp); FStar_Extraction_ML_Syntax.mlty = _79_862; FStar_Extraction_ML_Syntax.loc = _79_860}, (mle)::args), Some (FStar_Syntax_Syntax.Record_projector (constrname, f))) -> begin
(
...
let _79_931 = (term_as_mlexpr' g t)
in (match (_79_931) with
| (e, tag, ty) -> begin
(
...
let _79_934 = (FStar_Extraction_ML_UEnv.debug g (fun u -> (let _174_341 = (let _174_340 = (FStar_Syntax_Print.tag_of_term t)
...
let _79_942 = (check_term_as_mlexpr' g t f ty)
in (match (_79_942) with
| (e, t) -> begin
(

let _79_947 = (erase g e t f)
...
let _79_955 = (term_as_mlexpr g e0)
in (match (_79_955) with
| (e, tag, t) -> begin
(
...
let _79_960 = (FStar_Extraction_ML_UEnv.debug g (fun u -> (let _174_357 = (let _174_356 = (FStar_Range.string_of_range top.FStar_Syntax_Syntax.pos)
...
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic (m, _79_1005)) -> begin
(
...
let _79_1025 = (term_as_mlexpr g lb.FStar_Syntax_Syntax.lbdef)
in (match (_79_1025) with
| (comp_1, _79_1022, _79_1024) -> begin
(
...
let _79_1031 = (term_as_mlexpr g k)
in (match (_79_1031) with
| (ml_k, _79_1029, t_k) -> begin
(

let m_2 = (match (t_k) with
| FStar_Extraction_ML_Syntax.MLTY_Fun (_79_1033, _79_1035, m_2) -> begin
m_2
end
| _79_1040 -> begin
(FStar_All.failwith "Impossible")
...
let _79_1064 = (FStar_TypeChecker_TcTerm.type_of_tot_term g.FStar_Extraction_ML_UEnv.tcenv t)
in (match (_79_1064) with
| (_79_1060, ty, _79_1063) -> begin
(
...
| (FStar_Util.Inl (_79_1073), _79_1076) -> begin
((FStar_Extraction_ML_Syntax.ml_unit), (FStar_Extraction_ML_Syntax.E_PURE), (FStar_Extraction_ML_Syntax.ml_unit_ty))
end
| (FStar_Util.Inr (x, mltys, _79_1081), qual) -> begin
(match (mltys) with
...
let _79_1101 = (FStar_Syntax_Subst.open_term bs body)
in (match (_79_1101) with
| (bs, body) -> begin
(

let _79_1104 = (binders_as_ml_binders g bs)
in (match (_79_1104) with
| (ml_bs, env) -> begin
(

let _79_1108 = (term_as_mlexpr env body)
in (match (_79_1108) with
| (ml_body, f, t) -> begin
(

let _79_1118 = (FStar_List.fold_right (fun _79_1112 _79_1115 -> (match (((_79_1112), (_79_1115))) with
| ((_79_1110, targ), (f, t)) -> begin
...
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = _79_1124; FStar_Syntax_Syntax.pos = _79_1122; FStar_Syntax_Syntax.vars = _79_1120}, (t)::[]) -> begin
(

let _79_1135 = (term_as_mlexpr' g (Prims.fst t))
in (match (_79_1135) with
| (ml, e_tag, mlty) -> begin
((ml), (FStar_Extraction_ML_Syntax.E_PURE), (mlty))
end))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reflect (_79_1143)); FStar_Syntax_Syntax.tk = _79_1141; FStar_Syntax_Syntax.pos = _79_1139; FStar_Syntax_Syntax.vars = _79_1137}, (t)::[]) -> begin
(

let _79_1154 = (term_as_mlexpr' g (Prims.fst t))
in (match (_79_1154) with
| (ml, e_tag, mlty) -> begin
...
| (FStar_Syntax_Syntax.Tm_uvar (_79_1166), _79_1169) -> begin
(
...
| (_79_1173, FStar_Syntax_Syntax.Tm_abs (bs, _79_1176, Some (lc))) when (is_total lc) -> begin
(
...
let rec extract_app = (fun is_data _79_1189 _79_1192 restArgs -> (match (((_79_1189), (_79_1192))) with
...
| FStar_Syntax_Syntax.Tm_fvar ({FStar_Syntax_Syntax.fv_name = {FStar_Syntax_Syntax.v = v; FStar_Syntax_Syntax.ty = _79_1205; FStar_Syntax_Syntax.p = _79_1203}; FStar_Syntax_Syntax.fv_delta = _79_1201; FStar_Syntax_Syntax.fv_qual = _79_1199}) -> begin
...
let _79_1222 = if evaluation_order_guaranteed then begin
(let _174_388 = (FStar_All.pipe_right (FStar_List.rev mlargs_f) (FStar_List.map Prims.fst))
in (([]), (_174_388)))
end else begin
(FStar_List.fold_left (fun _79_1215 _79_1218 -> (match (((_79_1215), (_79_1218))) with
...
let l_app = (FStar_List.fold_right (fun _79_1226 out -> (match (_79_1226) with
| (x, arg) -> begin
...
| (((arg, _79_1232))::rest, FStar_Extraction_ML_Syntax.MLTY_Fun (formal_t, f', t)) when (is_type g arg) -> begin
...
| (((e0, _79_1244))::rest, FStar_Extraction_ML_Syntax.MLTY_Fun (tExpected, f', t)) -> begin
(

let r = e0.FStar_Syntax_Syntax.pos
in (

let _79_1257 = (term_as_mlexpr g e0)
in (match (_79_1257) with
...
let extract_app_maybe_projector = (fun is_data mlhead _79_1269 args -> (match (_79_1269) with
| (f, t) -> begin
(match (is_data) with
| Some (FStar_Syntax_Syntax.Record_projector (_79_1272)) -> begin
(

let rec remove_implicits = (fun args f t -> (match (((args), (t))) with
| (((a0, Some (FStar_Syntax_Syntax.Implicit (_79_1282))))::args, FStar_Extraction_ML_Syntax.MLTY_Fun (_79_1288, f', t)) -> begin
...
let _79_1299 = (remove_implicits args f t)
in (match (_79_1299) with
| (args, f, t) -> begin
...
let _79_1322 = (match ((FStar_Extraction_ML_UEnv.lookup_term g head)) with
...
in (match (_79_1322) with
| ((head_ml, (vars, t), inst_ok), qual) -> begin
(

let has_typ_apps = (match (args) with
| ((a, _79_1327))::_79_1324 -> begin
(is_type g a)
end
| _79_1331 -> begin
false
...
let _79_1377 = (match (vars) with
| (_79_1336)::_79_1334 when ((not (has_typ_apps)) && inst_ok) -> begin
((head_ml), (t), (args))
end
| _79_1339 -> begin
(
...
let _79_1343 = (FStar_Util.first_N n args)
in (match (_79_1343) with
| (prefix, rest) -> begin
(

let prefixAsMLTypes = (FStar_List.map (fun _79_1347 -> (match (_79_1347) with
| (x, _79_1346) -> begin
(term_as_mlty g x)
end)) prefix)
in (
...
let _79_1356 = head_ml
in {FStar_Extraction_ML_Syntax.expr = _79_1356.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t; FStar_Extraction_ML_Syntax.loc = _79_1356.FStar_Extraction_ML_Syntax.loc})
end
| FStar_Extraction_ML_Syntax.MLE_App (head, ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Unit); FStar_Extraction_ML_Syntax.mlty = _79_1362; FStar_Extraction_ML_Syntax.loc = _79_1360})::[]) -> begin
(FStar_All.pipe_right (FStar_Extraction_ML_Syntax.MLE_App ((((

let _79_1369 = head
in {FStar_Extraction_ML_Syntax.expr = _79_1369.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t))); FStar_Extraction_ML_Syntax.loc = _79_1369.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t))
end
| _79_1372 -> begin
...
let _79_1386 = (term_as_mlexpr g head)
...
let _79_1403 = (check_term_as_mlexpr g e0 f t)
in (match (_79_1403) with
| (e, t) -> begin
((e), (f), (t))
end))))
end
...
let _79_1419 = if is_rec then begin
...
let _79_1413 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = _79_1413.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _79_1413.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _79_1413.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _79_1413.FStar_Syntax_Syntax.lbdef})
in (
...
let _79_1423 = lb
in {FStar_Syntax_Syntax.lbname = _79_1423.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _79_1423.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _79_1423.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _79_1423.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbdef}))))))
end else begin
lbs
end
in (

let maybe_generalize = (fun _79_1433 -> (match (_79_1433) with
| {FStar_Syntax_Syntax.lbname = lbname_; FStar_Syntax_Syntax.lbunivs = _79_1431; FStar_Syntax_Syntax.lbtyp = t; FStar_Syntax_Syntax.lbeff = lbeff; FStar_Syntax_Syntax.lbdef = e} -> begin
(
...
let _79_1442 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_79_1442) with
| (bs, c) -> begin
(

let _79_1452 = (match ((FStar_Util.prefix_until (fun x -> (not ((is_type_binder g x)))) bs)) with
| None -> begin
...
| FStar_Syntax_Syntax.Tm_abs (bs, body, _79_1458) -> begin
(

let _79_1463 = (FStar_Syntax_Subst.open_term bs body)
in (match (_79_1463) with
| (bs, body) -> begin
if (n_tbinders <= (FStar_List.length bs)) then begin
(

let _79_1466 = (FStar_Util.first_N n_tbinders bs)
in (match (_79_1466) with
| (targs, rest_args) -> begin
(

let expected_source_ty = (

let s = (FStar_List.map2 (fun _79_1470 _79_1474 -> (match (((_79_1470), (_79_1474))) with
| ((x, _79_1469), (y, _79_1473)) -> begin
...
let env = (FStar_List.fold_left (fun env _79_1481 -> (match (_79_1481) with
| (a, _79_1480) -> begin
...
let polytype = (let _174_437 = (FStar_All.pipe_right targs (FStar_List.map (fun _79_1487 -> (match (_79_1487) with
| (x, _79_1486) -> begin
...
let env = (FStar_List.fold_left (fun env _79_1511 -> (match (_79_1511) with
| (a, _79_1510) -> begin
(FStar_Extraction_ML_UEnv.extend_ty env a None)
end)) g tbinders)
in (
...
let polytype = (let _174_441 = (FStar_All.pipe_right tbinders (FStar_List.map (fun _79_1517 -> (match (_79_1517) with
| (x, _79_1516) -> begin
(FStar_Extraction_ML_UEnv.bv_as_ml_tyvar x)
end))))
...
let args = (FStar_All.pipe_right tbinders (FStar_List.map (fun _79_1522 -> (match (_79_1522) with
| (bv, _79_1521) -> begin
...
let check_lb = (fun env _79_1543 -> (match (_79_1543) with
| (nm, (lbname, f, (t, (targs, polytype)), add_unit, e)) -> begin
(

let env = (FStar_List.fold_left (fun env _79_1548 -> (match (_79_1548) with
| (a, _79_1547) -> begin
(FStar_Extraction_ML_UEnv.extend_ty env a None)
end)) env targs)
in (
...
let _79_1554 = (check_term_as_mlexpr env e f expected_t)
...
let _79_1579 = (FStar_List.fold_right (fun lb _79_1560 -> (match (_79_1560) with
| (env, lbs) -> begin
(

let _79_1573 = lb
in (match (_79_1573) with
| (lbname, _79_1563, (t, (_79_1566, polytype)), add_unit, _79_1572) -> begin
(

let _79_1576 = (FStar_Extraction_ML_UEnv.extend_lb env lbname t polytype add_unit true)
...
let _79_1586 = (term_as_mlexpr env_body e')
...
let _79_1596 = (term_as_mlexpr g scrutinee)
in (match (_79_1596) with
| (e, f_e, t_e) -> begin
(

let _79_1600 = (check_pats_for_ite pats)
...
let _79_1612 = (term_as_mlexpr g then_e)
in (match (_79_1612) with
| (then_mle, f_then, t_then) -> begin
(

let _79_1616 = (term_as_mlexpr g else_e)
in (match (_79_1616) with
| (else_mle, f_else, t_else) -> begin
(

let _79_1619 = if (type_leq g t_then t_else) then begin
((t_else), (no_lift))
end else begin
...
let _79_1653 = (FStar_All.pipe_right pats (FStar_Util.fold_map (fun compat br -> (

let _79_1627 = (FStar_Syntax_Subst.open_branch br)
in (match (_79_1627) with
| (pat, when_opt, branch) -> begin
(

let _79_1631 = (extract_pat g pat t_e)
in (match (_79_1631) with
| (env, p, pat_t_compat) -> begin
(

let _79_1642 = (match (when_opt) with
| None -> begin
...
let _79_1638 = (term_as_mlexpr env w)
...
in (match (_79_1642) with
| (when_opt, f_when) -> begin
(

let _79_1646 = (term_as_mlexpr env branch)
in (match (_79_1646) with
| (mlbranch, f_branch, t_branch) -> begin
(let _174_493 = (FStar_All.pipe_right p (FStar_List.map (fun _79_1649 -> (match (_79_1649) with
| (p, wopt) -> begin
(
...
let _79_1657 = (FStar_Extraction_ML_UEnv.debug g (fun _79_1655 -> (let _174_496 = (FStar_Extraction_ML_Code.string_of_mlexpr g.FStar_Extraction_ML_UEnv.currentModule e)
...
let _79_1666 = (let _174_498 = (let _174_497 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.failwith_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Extraction_ML_UEnv.lookup_fv g _174_497))
in (FStar_All.pipe_left FStar_Util.right _174_498))
in (match (_79_1666) with
| (fw, _79_1663, _79_1665) -> begin
...
| ((_79_1669, _79_1671, (_79_1673, f_first, t_first)))::rest -> begin
(

let _79_1699 = (FStar_List.fold_left (fun _79_1681 _79_1691 -> (match (((_79_1681), (_79_1691))) with
| ((topt, f), (_79_1683, _79_1685, (_79_1687, f_branch, t_branch))) -> begin
(
...
let mlbranches = (FStar_All.pipe_right mlbranches (FStar_List.map (fun _79_1710 -> (match (_79_1710) with
| (p, (wopt, _79_1703), (b, _79_1707, t)) -> begin
(
...
let _79_1723 = (FStar_Util.incr c)
...
let _79_1731 = (FStar_TypeChecker_Env.lookup_lid env.FStar_Extraction_ML_UEnv.tcenv discName)
in (match (_79_1731) with
| (_79_1729, fstar_disc_type) -> begin
(

let wildcards = (match ((let _174_517 = (FStar_Syntax_Subst.compress fstar_disc_type)
in _174_517.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, _79_1734) -> begin
(let _174_521 = (FStar_All.pipe_right binders (FStar_List.filter (fun _79_5 -> (match (_79_5) with
| (_79_1739, Some (FStar_Syntax_Syntax.Implicit (_79_1741))) -> begin
true
end
| _79_1746 -> begin
false
end))))
in (FStar_All.pipe_right _174_521 (FStar_List.map (fun _79_1747 -> (let _174_520 = (fresh "_")
