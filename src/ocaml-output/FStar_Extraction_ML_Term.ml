  ...
  fun l  ->
    ...
    then def
      ...
      (let uu____1561 = FStar_List.hd l  in
       ...
       | (p1,w1,e1) ->
           let uu____1595 =
             let uu____1604 = FStar_List.tl l  in FStar_List.hd uu____1604
              in
                 ...
                 (fun uu____1801  ->
                    ...
                    | (v1,t1) ->
                        FStar_Extraction_ML_Syntax.with_ty t1
                          (FStar_Extraction_ML_Syntax.MLE_Var v1)) uu____1787
                in
             let body =
      ...
      let uu____1825 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____1827 = FStar_Options.codegen ()  in
           uu____1827 = (FStar_Pervasives_Native.Some "Kremlin"))
         in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____1963 ->
          let uu____1964 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1965
             in
          failwith uu____1964
      | FStar_Syntax_Syntax.Tm_delayed uu____1966 ->
          let uu____1991 =
            let uu____1992 = FStar_Syntax_Print.term_to_string t1  in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1992
             in
          failwith uu____1991
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1993 =
            let uu____1994 = FStar_Syntax_Print.term_to_string t1  in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1994
             in
          failwith uu____1993
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2676, FStar_Extraction_ML_Syntax.ml_unit_ty)
                           in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b  in
              ...
              let when_clause =
                let uu____2982 =
                  let uu____2983 =
                    ...
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____2990)
                     in
                  FStar_Extraction_ML_Syntax.MLE_App uu____2983  in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____2982
                 in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          ...
          | uu____4394 -> failwith "Impossible: Unable to translate pattern"
           in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____4640 -> failwith "Impossible: Head type is not an arrow"
             in
                    ...
                    let uu____4873 =
                      let uu____4880 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____4880, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4873
                 in
              FStar_Extraction_ML_Syntax.with_ty
                    ...
                    let uu____4922 =
                      let uu____4929 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____4929, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4922
                 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then
                let uu____5222 = maybe_coerce g e t ty  in (uu____5222, ty)
      ...
      (let t = FStar_Syntax_Subst.compress top  in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____5953::(v1,uu____5955)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____6001
              in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_int_ty
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6119
                   in
                let tm =
                  let uu____6129 =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8099
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8106  ->
                                    ...
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8308 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____8308) bs1
                                     in
      ...
      fun constrName  ->
        ...
        | (uu____11403,fstar_disc_type) ->
            let wildcards =
              ...
              | uu____11524 -> failwith "Discriminator must be a function"
               in
              ...
              let uu____11535 =
                let uu____11536 =
                  let uu____11547 =
                            ...
                            let uu____11587 =
                              let uu____11588 =
                                ...
                                (uu____11595,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11588
                               in
                            let uu____11598 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                            ...
                            let uu____11612 =
                              let uu____11621 =
                                FStar_All.pipe_left
                                 ...
                                 in
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11621)
                               in
                            [uu____11612]  in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11548
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11547)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11536  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11535
               in
            let uu____11676 =
              let uu____11677 =
                let uu____11680 =
