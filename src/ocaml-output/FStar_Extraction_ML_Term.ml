...
let f_ty_opt = (FStar_All.try_with (fun uu___172_3324 -> (match (()) with
| () -> begin
(
...
end)) (fun uu___171_3397 -> (match (uu___171_3397) with
| Un_extractable -> begin
FStar_Pervasives_Native.None
end)))
in (
...
let uu____4016 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun uu___168_4067 -> (match (uu___168_4067) with
...
let is_total = (fun rc -> ((FStar_Ident.lid_equals rc.FStar_Syntax_Syntax.residual_effect FStar_Parser_Const.effect_Tot_lid) || (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags (FStar_List.existsb (fun uu___169_6022 -> (match (uu___169_6022) with
...
let uu___173_7371 = e
in {FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_TApp (((e), (ty_args))); FStar_Extraction_ML_Syntax.mlty = uu___173_7371.FStar_Extraction_ML_Syntax.mlty; FStar_Extraction_ML_Syntax.loc = uu___173_7371.FStar_Extraction_ML_Syntax.loc})
end))
in (
...
let uu___174_7376 = (mk_tapp head_ml prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___174_7376.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___174_7376.FStar_Extraction_ML_Syntax.loc})
end
| FStar_Extraction_ML_Syntax.MLE_Var (uu____7377) -> begin
(

let uu___174_7378 = (mk_tapp head_ml prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___174_7378.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___174_7378.FStar_Extraction_ML_Syntax.loc})
end
...
let uu___175_7387 = (mk_tapp head3 prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___175_7387.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t2))); FStar_Extraction_ML_Syntax.loc = uu___175_7387.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t2))
end
| uu____7388 -> begin
...
let uu___173_7796 = e
in {FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_TApp (((e), (ty_args))); FStar_Extraction_ML_Syntax.mlty = uu___173_7796.FStar_Extraction_ML_Syntax.mlty; FStar_Extraction_ML_Syntax.loc = uu___173_7796.FStar_Extraction_ML_Syntax.loc})
end))
in (
...
let uu___174_7801 = (mk_tapp head_ml prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___174_7801.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___174_7801.FStar_Extraction_ML_Syntax.loc})
end
| FStar_Extraction_ML_Syntax.MLE_Var (uu____7802) -> begin
(

let uu___174_7803 = (mk_tapp head_ml prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___174_7803.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___174_7803.FStar_Extraction_ML_Syntax.loc})
end
...
let uu___175_7812 = (mk_tapp head3 prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___175_7812.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t2))); FStar_Extraction_ML_Syntax.loc = uu___175_7812.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t2))
end
| uu____7813 -> begin
(failwith "Impossible: Unexpected head term")
end)
...
let uu___176_8031 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___176_8031.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___176_8031.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___176_8031.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___176_8031.FStar_Syntax_Syntax.lbdef})
in (
...
let uu___177_8078 = lb
in {FStar_Syntax_Syntax.lbname = uu___177_8078.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___177_8078.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___177_8078.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___177_8078.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbdef}));
)))))
end
| uu____8079 -> begin
lbs1
...
let uu____11404 = (FStar_All.pipe_right binders (FStar_List.filter (fun uu___170_11436 -> (match (uu___170_11436) with
