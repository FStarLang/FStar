  ...
  fun l  ->
    ...
    then def
      ...
      (let uu____1025 = FStar_List.hd l  in
       ...
       | (p1,w1,e1) ->
           let uu____1044 =
             let uu____1049 = FStar_List.tl l  in FStar_List.hd uu____1049
              in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____1230 ->
          let uu____1231 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1232
             in
          failwith uu____1231
      | FStar_Syntax_Syntax.Tm_delayed uu____1233 ->
          let uu____1248 =
            let uu____1249 = FStar_Syntax_Print.term_to_string t1  in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1249
             in
          failwith uu____1248
      | FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1250 =
            let uu____1251 = FStar_Syntax_Print.term_to_string t1  in
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1251
             in
          failwith uu____1250
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____1696, FStar_Extraction_ML_Syntax.ml_unit_ty)
                           in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = fst b  in
              ...
              let when_clause =
                let uu____1915 =
                  let uu____1916 =
                    ...
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____1920)
                     in
                  FStar_Extraction_ML_Syntax.MLE_App uu____1916  in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____1915
                 in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          ...
          | uu____2687 -> failwith "Impossible: Unable to translate pattern"
           in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____2829 -> failwith "Impossible: Head type is not an arrow"
             in
                    ...
                    let uu____2970 =
                      let uu____2974 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____2974, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____2970
                 in
              FStar_Extraction_ML_Syntax.with_ty
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then
                let uu____3121 = maybe_coerce g e t ty  in (uu____3121, ty)
        ...
        (fun u  ->
           let uu____3132 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____3133 uu____3134 uu____3135
              in
      ...
      (let t = FStar_Syntax_Subst.compress top  in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____3568::(v1,uu____3570)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____3605
              in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_int_ty
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____3687
                   in
                let tm =
                  let uu____3695 =
                    let uu____3696 = FStar_TypeChecker_Util.remove_reify e
                       in
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____4881
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4885  ->
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____4968 = FStar_Syntax_Subst.open_comp bs c
                              in
                                ...
                                let uu____4982 =
                                  let uu____4987 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____5005 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____5005) bs1
                                     in
                      ...
                      | (e'2,f',t') ->
                          let f =
                            let uu____6032 =
                              ...
                              f' :: uu____6034  in
                            FStar_Extraction_ML_Util.join_l e'_rng uu____6032
                             in
                          let is_rec1 =
                            if is_rec = true
                        ...
                        | (Some then_e1,Some else_e1) ->
                            ...
                            (match uu____6123 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____6133 = term_as_mlexpr g else_e1
                                    in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____6816,fstar_disc_type) ->
            let wildcards =
              let uu____6824 =
                let uu____6825 = FStar_Syntax_Subst.compress fstar_disc_type
                   in
              ...
              let uu____6908 =
                let uu____6909 =
                  let uu____6915 =
                        ...
                        let uu____6925 =
                          let uu____6926 =
                            let uu____6927 =
                              ...
                              ([], uu____6928)  in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____6927
                             in
                          FStar_All.pipe_left
                            ...
                            let uu____6941 =
                              let uu____6942 =
                                ...
                                (uu____6946,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____6942
                               in
                            let uu____6948 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____6916
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____6915)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____6909  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____6908
               in
            let uu____6999 =
              let uu____7000 =
                let uu____7002 =
