  ...
  fun l  ->
    ...
    then def
      ...
      (let uu____1509 = FStar_List.hd l  in
       ...
       | (p1,w1,e1) ->
           let uu____1543 =
             let uu____1552 = FStar_List.tl l  in FStar_List.hd uu____1552
              in
                 ...
                 (fun uu____1738  ->
                    ...
                    | (v1,t1) ->
                        FStar_Extraction_ML_Syntax.with_ty t1
                          (FStar_Extraction_ML_Syntax.MLE_Var v1)) uu____1724
                in
             let body =
      ...
      let uu____1760 =
        (FStar_Options.ml_no_eta_expand_coertions ()) ||
          (let uu____1762 = FStar_Options.codegen ()  in
           uu____1762 = (FStar_Pervasives_Native.Some "Kremlin"))
         in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_bvar uu____1892 ->
          let uu____1893 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1894
             in
          failwith uu____1893
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____2605, FStar_Extraction_ML_Syntax.ml_unit_ty)
                           in
                        ((ml_b :: ml_bs), env1)
                      else
                        (let b1 = FStar_Pervasives_Native.fst b  in
              ...
              let when_clause =
                let uu____2900 =
                  let uu____2901 =
                    ...
                    (FStar_Extraction_ML_Util.prims_op_equality, uu____2908)
                     in
                  FStar_Extraction_ML_Syntax.MLE_App uu____2901  in
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     FStar_Extraction_ML_Syntax.ml_bool_ty) uu____2900
                 in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat1 g1 p1 expected_t1 =
          ...
          | uu____4309 -> failwith "Impossible: Unable to translate pattern"
           in
          ...
          | hd1::tl1 ->
              let uu____4352 =
                FStar_List.fold_left FStar_Extraction_ML_Util.conjoin hd1 tl1
                 in
              FStar_Pervasives_Native.Some uu____4352
           in
        let uu____4353 =
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____4551 -> failwith "Impossible: Head type is not an arrow"
             in
                    ...
                    let uu____4784 =
                      let uu____4791 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____4791, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4784
                 in
              FStar_Extraction_ML_Syntax.with_ty
                    ...
                    let uu____4833 =
                      let uu____4840 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____4840, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4833
                 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
      ...
      fun f  ->
        fun ty  ->
          ...
          | (e,tag,t) ->
              ...
              then
                let uu____5130 = maybe_coerce g e t ty  in (uu____5130, ty)
        ...
        (fun u  ->
           let uu____5148 =
             ...
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____5149 uu____5150 uu____5151
              in
      ...
      (let t = FStar_Syntax_Subst.compress top  in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,uu____5940::(v1,uu____5942)::[])
           ...
           let s =
             ...
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____5988
              in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_int_ty
               ...
               (FStar_Const.Const_reify )) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6106
                   in
                let tm =
                  let uu____6116 =
                    let uu____6117 = FStar_TypeChecker_Util.remove_reify e
                       in
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7391 ->
                                               let uu___384_7394 = e  in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___384_7394.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___384_7394.FStar_Extraction_ML_Syntax.loc)
                                               }
                                            in
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                  ...
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___385_7399.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___385_7399.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7400 ->
                                               let uu___385_7401 =
                                                  ...
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___385_7401.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___385_7401.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___386_7410 =
                                                         ...
                                                         in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___386_7410.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___386_7410.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7816 ->
                                               let uu___384_7819 = e  in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___384_7819.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___384_7819.FStar_Extraction_ML_Syntax.loc)
                                               }
                                            in
                                         let head3 =
                                           match head_ml.FStar_Extraction_ML_Syntax.expr
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                  ...
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___385_7824.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___385_7824.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7825 ->
                                               let uu___385_7826 =
                                                  ...
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___385_7826.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___385_7826.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___386_7835 =
                                                         ...
                                                         in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___386_7835.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___386_7835.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
               ...
               (let uu____8038 = FStar_Syntax_Syntax.is_top_level lbs  in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs  in
                   ...
                   let lb1 =
                     let uu___387_8054 = lb  in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___387_8054.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___387_8054.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___387_8054.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___387_8054.FStar_Syntax_Syntax.lbdef)
                     }  in
                   let e'1 =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8086
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8093  ->
                            ...
                            (let lbdef =
                               ...
                               then lb.FStar_Syntax_Syntax.lbdef
                                ...
                                in
                             let uu___388_8101 = lb  in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___388_8101.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___388_8101.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___388_8101.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___388_8101.FStar_Syntax_Syntax.lbeff);
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____8227 = FStar_Syntax_Subst.open_comp bs c
                              in
                                ...
                                let uu____8252 =
                                  let uu____8259 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8295 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____8295) bs1
                                     in
                           ...
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            ...
                            (match uu____10166 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____10182 = term_as_mlexpr g else_e1
                                    in
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____11387,fstar_disc_type) ->
            let wildcards =
              let uu____11396 =
                let uu____11397 = FStar_Syntax_Subst.compress fstar_disc_type
                   in
              ...
              | uu____11508 -> failwith "Discriminator must be a function"
               in
              ...
              let uu____11519 =
                let uu____11520 =
                  let uu____11531 =
                            ...
                            let uu____11571 =
                              let uu____11572 =
                                ...
                                (uu____11579,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11572
                               in
                            let uu____11582 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                            ...
                            let uu____11596 =
                              let uu____11605 =
                                FStar_All.pipe_left
                                 ...
                                 in
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11605)
                               in
                            [uu____11596]  in
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11532
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11531)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11520  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11519
               in
            let uu____11660 =
              let uu____11661 =
                let uu____11664 =
