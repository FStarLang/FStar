...
# 189 "FStar.Extraction.ML.Term.fst"
...
# 193 "FStar.Extraction.ML.Term.fst"
...
# 206 "FStar.Extraction.ML.Term.fst"
...
# 297 "FStar.Extraction.ML.Term.fst"
...
# 330 "FStar.Extraction.ML.Term.fst"
...
# 354 "FStar.Extraction.ML.Term.fst"
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
...
let mlty = (term_as_mlty g x.FStar_Syntax_Syntax.sort)
in (
# 507 "FStar.Extraction.ML.Term.fst"
let g = (FStar_Extraction_ML_UEnv.extend_bv g x ([], mlty) false false imp)
...
# 575 "FStar.Extraction.ML.Term.fst"
...
| (e, t) -> begin
(
# 615 "FStar.Extraction.ML.Term.fst"
...
in (
# 626 "FStar.Extraction.ML.Term.fst"
...
| (ty, _77_829) -> begin
(
# 644 "FStar.Extraction.ML.Term.fst"
...
in (
# 843 "FStar.Extraction.ML.Term.fst"
...
in (
# 893 "FStar.Extraction.ML.Term.fst"
...
(
# 964 "FStar.Extraction.ML.Term.fst"
...
in (
# 1000 "FStar.Extraction.ML.Term.fst"
