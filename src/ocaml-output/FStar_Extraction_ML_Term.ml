...
let rec (is_arity :
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_abs (uu___1,body,uu___2) -> is_arity env body
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Tm_uvar
          ({ FStar_Syntax_Syntax.ctx_uvar_head = uu___;
             ...
             FStar_Syntax_Syntax.ctx_uvar_meta = uu___6;_},s)
          ->
...
let rec (is_fstar_value : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (t1,uu___1,uu___2) -> is_fstar_value t1
    | uu___1 -> false
  ...
  fun t0  ->
    let rec aux bs t copt =
      ...
      | uu___ ->
          ...
          if uu___1 then aux bs e' copt else FStar_Syntax_Util.abs bs e' copt
       in
  ...
  fun l  ->
    ...
    then def
      ...
      (let uu___1 = FStar_List.hd l  in
       match uu___1 with
       | (p1,w1,e1) ->
           let uu___2 = let uu___3 = FStar_List.tl l  in FStar_List.hd uu___3
              in
           (match uu___2 with
            | (p2,w2,e2) ->
          ...
          let rec aux e1 ty1 expect1 =
            ...
            | (FStar_Extraction_ML_Syntax.MLE_Match
               (s,branches),uu___,uu___1) ->
                ...
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty expect1) uu___2
            | (FStar_Extraction_ML_Syntax.MLE_If (s,b1,b2_opt),uu___,uu___1)
                ->
                let uu___2 =
                  let uu___3 =
            ...
            | (FStar_Extraction_ML_Syntax.MLE_Try (s,branches),uu___,uu___1)
                ->
                let uu___2 =
                  let uu___3 =
                    let uu___4 = FStar_List.map coerce_branch branches  in
    ...
    fun t0  ->
             ...
             | ((uu___4,fvty),uu___5) ->
                 let fvty1 =
                   ...
                   FStar_TypeChecker_Normalize.normalize
                     ...
                     FStar_TypeChecker_Env.ForExtraction] uu___6 fvty
                    in
      ...
      let aux env t =
        ...
        | FStar_Syntax_Syntax.Tm_refine
            ({ FStar_Syntax_Syntax.ppname = uu___;
               FStar_Syntax_Syntax.index = uu___1;
               FStar_Syntax_Syntax.sort = t2;_},uu___2)
            -> translate_term_to_mlty env t2
  ...
  fun g  ->
    fun t0  ->
      let t =
        ...
        FStar_TypeChecker_Normalize.normalize extraction_norm_steps uu___ t0
         in
                          ...
                          let uu___2 =
                            let uu___3 =
                              FStar_Extraction_ML_UEnv.current_module_of_uenv
                                g
                               in
                            FStar_Extraction_ML_Code.string_of_mlty uu___3 t'
                             in
                          let uu___3 =
                            let uu___4 =
                              FStar_Extraction_ML_UEnv.current_module_of_uenv
                                g
                               in
                            FStar_Extraction_ML_Code.string_of_mlty uu___4 t
                             in
                          FStar_Util.print2
                      ...
                      let uu___1 =
                        ...
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.ml_int_ty) uu___2
                         in
                  ...
                  | FStar_Pervasives_Native.Some sw ->
                      let source_term =
                        ...
                        FStar_ToSyntax_ToSyntax.desugar_machine_integer
                          uu___1 c sw FStar_Range.dummyRange
                         in
                      let uu___1 = term_as_mlexpr g source_term  in
                      (match uu___1 with
                       | (mlterm,uu___2,mlty) -> (mlterm, mlty))
                   in
                (match uu___ with
                 | (mlc,ml_ty) ->
      ...
      fun expected_t  ->
        fun term_as_mlexpr  ->
          let extract_one_pat1 g1 p1 expected_t1 =
            ...
            | uu___1 -> failwith "Impossible: Unable to translate pattern"
             in
        ...
        fun mlAppExpr  ->
          ...
          let as_record qual1 e =
            ...
            | (FStar_Extraction_ML_Syntax.MLE_CTor
               (uu___,args),FStar_Pervasives_Native.Some
          ...
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu___1;_},mle::args),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_projector (constrname,f))) ->
              let fn =
                let uu___2 =
                  let uu___3 =
                    let uu___4 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g  in
                    FStar_TypeChecker_Env.typ_of_datacon uu___4 constrname
                     in
                  (uu___3, f)  in
                FStar_Extraction_ML_UEnv.lookup_record_field_name g uu___2
                 in
                    ...
                    let uu___3 =
                      let uu___4 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu___4, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu___3
                 in
              FStar_Extraction_ML_Syntax.with_ty
                ...
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     FStar_Extraction_ML_Syntax.expr =
                       FStar_Extraction_ML_Syntax.MLE_Name mlp;
                     FStar_Extraction_ML_Syntax.mlty = uu___;
                     FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
                FStar_Extraction_ML_Syntax.mlty = uu___3;
                FStar_Extraction_ML_Syntax.loc = uu___4;_},mle::args),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_projector (constrname,f))) ->
              let fn =
                let uu___5 =
                  let uu___6 =
                    let uu___7 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g  in
                    FStar_TypeChecker_Env.typ_of_datacon uu___7 constrname
                     in
                  (uu___6, f)  in
                FStar_Extraction_ML_UEnv.lookup_record_field_name g uu___5
                 in
              let proj = FStar_Extraction_ML_Syntax.MLE_Proj (mle, fn)  in
              let e =
                match args with
                    ...
                    let uu___6 =
                      let uu___7 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu___7, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu___6
                 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                FStar_Extraction_ML_Syntax.expr =
                  FStar_Extraction_ML_Syntax.MLE_Name mlp;
                FStar_Extraction_ML_Syntax.mlty = uu___;
                FStar_Extraction_ML_Syntax.loc = uu___1;_},mlargs),FStar_Pervasives_Native.Some
          ...
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.mlty = uu___;
                FStar_Extraction_ML_Syntax.loc = uu___1;_},mlargs),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_ctor uu___2)) ->
              let uu___3 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     mlAppExpr.FStar_Extraction_ML_Syntax.mlty)
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
                FStar_Extraction_ML_Syntax.mlty = uu___3;
                FStar_Extraction_ML_Syntax.loc = uu___4;_},mlargs),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Data_ctor )) ->
              let uu___5 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
          ...
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.mlty = uu___3;
                FStar_Extraction_ML_Syntax.loc = uu___4;_},mlargs),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_ctor uu___5)) ->
              let uu___6 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     mlAppExpr.FStar_Extraction_ML_Syntax.mlty)
          ...
          | (FStar_Extraction_ML_Syntax.MLE_Name
             ...
             (FStar_Syntax_Syntax.Record_ctor uu___)) ->
              let uu___1 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     mlAppExpr.FStar_Extraction_ML_Syntax.mlty)
          ...
          | (FStar_Extraction_ML_Syntax.MLE_TApp
             ({
                FStar_Extraction_ML_Syntax.expr =
                  FStar_Extraction_ML_Syntax.MLE_Name mlp;
                FStar_Extraction_ML_Syntax.mlty = uu___;
                FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Data_ctor )) ->
              let uu___3 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
          ...
          | (FStar_Extraction_ML_Syntax.MLE_TApp
             ({
                ...
                FStar_Extraction_ML_Syntax.mlty = uu___;
                FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_ctor uu___3)) ->
              let uu___4 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     mlAppExpr.FStar_Extraction_ML_Syntax.mlty)
    ...
    fun lbs  ->
      let maybe_generalize uu___ =
        ...
        | { FStar_Syntax_Syntax.lbname = lbname_;
            ...
            let uu___3 =
              let uu___4 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g  in
              FStar_TypeChecker_Util.must_erase_for_extraction uu___4 lbtyp1
               in
            if uu___3
            then
              (lbname_, f_e,
                                                          ...
                                                          | (x,uu___11) ->
                                                              let uu___12 =
                                                                FStar_Extraction_ML_UEnv.lookup_ty
                                                                  env x
                                                                 in
                                                              uu___12.FStar_Extraction_ML_UEnv.ty_b_name))
                                                   in
                                              ...
                                              | (x,uu___10) ->
                                                  let uu___11 =
                                                    FStar_Extraction_ML_UEnv.lookup_ty
                                                      env x
                                                     in
                                                  uu___11.FStar_Extraction_ML_UEnv.ty_b_name))
                                       in
  ...
  fun g  ->
    fun top  ->
      ...
      (let is_match t =
         let uu___1 =
           let uu___2 =
             let uu___3 = FStar_All.pipe_right t FStar_Syntax_Subst.compress
                in
           ...
           (match uu___2 with
            | { FStar_Extraction_ML_UEnv.exp_b_name = uu___3;
                ...
                let uu___5 =
                  ...
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_int_ty) uu___6
                   in
                     ...
                     let t1 =
                       ...
                       FStar_Syntax_Util.mk_app
                         (FStar_Reflection_Data.refl_constant_term
                            FStar_Reflection_Data.fstar_refl_pack_ln) uu___3
                        in
                     term_as_mlexpr g t1)
            | tv ->
                let tv1 =
                ...
                let t1 =
                  let uu___2 =
                    let uu___3 = FStar_Syntax_Syntax.as_arg tv1  in [uu___3]
                     in
                  FStar_Syntax_Util.mk_app
                    (FStar_Reflection_Data.refl_constant_term
                       FStar_Reflection_Data.fstar_refl_pack_ln) uu___2
                   in
                term_as_mlexpr g t1)
                        ...
                        let uu___8 =
                          let uu___9 =
                            FStar_Extraction_ML_UEnv.current_module_of_uenv g
                             in
                          FStar_Extraction_ML_Code.string_of_mlexpr uu___9 x
                           in
                        let uu___9 =
                          let uu___10 =
                            FStar_Extraction_ML_UEnv.current_module_of_uenv g
                     ...
                     let body2 =
                       ...
                       | FStar_Pervasives_Native.Some rc ->
                           let uu___3 =
                             ...
                             FStar_TypeChecker_Env.is_reifiable_rc uu___4 rc
                              in
                           if uu___3
                           then
                             let uu___4 =
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu___2;_},(a1,uu___3)::[])
           ->
           let ty =
             let uu___4 =
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.pos = uu___1;
              FStar_Syntax_Syntax.vars = uu___2;_},(t1,uu___3)::(r,uu___4)::[])
           -> term_as_mlexpr g t1
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
              ...
              FStar_Syntax_Syntax.vars = uu___3;_},uu___4)
                ...
                let uu___3 =
                  let uu___4 =
                    ...
                    FStar_TypeChecker_Normalize.normalize
                      ...
                      FStar_TypeChecker_Env.EraseUniverses;
                      FStar_TypeChecker_Env.AllowUnboundUniverses;
                      FStar_TypeChecker_Env.ForExtraction] uu___5
                     in
            ...
            | FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify ) ->
                let e =
                  ...
                  FStar_TypeChecker_Util.reify_body_with_arg uu___2
                    [FStar_TypeChecker_Env.Inlining;
                    FStar_TypeChecker_Env.ForExtraction;
                    FStar_TypeChecker_Env.Unascribe] head uu___3
                   in
                let tm =
                  ...
                  | ((mlhead,mlargs_f),(f,t1)) ->
                      ...
                      (FStar_Extraction_ML_UEnv.debug g
                       ...
                       (match (restArgs, t1) with
                        | ([],uu___6) ->
                            let app =
                              ...
                              maybe_eta_data_and_project_record g is_data t1
                               ...
                               in
                            (app, f, t1)
                        | ((arg,uu___6)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                           (formal_t,f',t2)) when
                            (is_type g arg) &&
                              (type_leq g formal_t
                                 FStar_Extraction_ML_Syntax.ml_unit_ty)
                        ...
                        | ((e0,uu___6)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                           (tExpected,f',t2)) ->
                       ...
                       | FStar_Pervasives_Native.Some
                           ...
                           let rec remove_implicits args2 f1 t2 =
                             ...
                             | ((a0,FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu___5))::args3,FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu___6,f',t3)) ->
                                 let uu___7 =
                                   FStar_Extraction_ML_Util.join
                  ...
                  | FStar_Pervasives_Native.Some ((str,uu___3)::[]) ->
                      ...
                      (match uu___4 with
                       | FStar_Syntax_Syntax.Tm_constant
                           ...
                           let id =
                             let uu___6 =
                               let uu___7 = FStar_Syntax_Syntax.range_of_bv x
                                  in
                               (s, uu___7)  in
                  ...
                  | FStar_Pervasives_Native.Some y ->
                      ...
                      let body1 =
                        ...
                        FStar_Syntax_Subst.close
                          [(y, FStar_Pervasives_Native.None)] uu___3
                         in
                      let lb1 =
                        let uu___3 = lb  in
                        {
           ...
           (match uu___1 with
            | (lbs1,e'1) ->
                let lbs2 =
                  ...
                  then
                    let tcenv =
                      let uu___2 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g
                         in
                      let uu___3 =
                        let uu___4 =
                          let uu___5 =
                        ...
                        FStar_Ident.lid_of_path uu___4 FStar_Range.dummyRange
                         in
                      FStar_TypeChecker_Env.set_current_module uu___2 uu___3
                       in
                ...
                let check_lb env uu___2 =
                  ...
                  | (nm,(_lbname,f,(_t,(targs,polytype)),add_unit,e)) ->
                      ...
                      let expected_t = FStar_Pervasives_Native.snd polytype
                         in
                      let uu___3 = check_term_as_mlexpr env1 e f expected_t
                         in
                      (match uu___3 with
                       | (e1,ty) ->
                           let uu___4 = maybe_promote_effect e1 f expected_t
                              in
                           (match uu___4 with
                            | (e2,f1) ->
                                let meta =
                    ...
                    (fun lb  ->
                       fun uu___3  ->
                         ...
                         | (env,lbs4,env_burn) ->
                             let uu___4 = lb  in
                             (match uu___4 with
                              | (lbname,uu___5,(t1,(uu___6,polytype)),add_unit,uu___7)
                                  ->
                                  let uu___8 =
                             ...
                             | (then_mle,f_then,t_then) ->
                                 ...
                                 (match uu___4 with
                                  | (else_mle,f_else,t_else) ->
                                      let uu___5 =
                                        let uu___6 = type_leq g t_then t_else
                                           in
                                        if uu___6
                                        then (t_else, no_lift)
                                        else
                 ...
                 (match uu___3 with
                  | (g1,mlid) ->
                      ...
                      let discrBody =
                              ...
                              let uu___7 =
                                let uu___8 =
                                  ...
                                  let uu___10 =
                                    ...
                                    uu___11 :: uu___12  in
                                  (uu___9, uu___10)  in
                                FStar_Extraction_ML_Syntax.MLE_Match uu___8
                                 in
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                                   FStar_Extraction_ML_Syntax.ml_bool_ty)
                        ...
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu___4
                         in
                      let uu___4 =
