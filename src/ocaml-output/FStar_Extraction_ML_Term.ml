  ...
  'Auu____78 .
    FStar_Ident.ident Prims.list ->
      'Auu____78 Prims.list ->
        (Prims.string,'Auu____78) FStar_Pervasives_Native_Tuple2.tuple2
          Prims.list
  =
  fun fs  ->
    fun vs  ->
  ...
  'Auu____121 .
    FStar_Range.range ->
      (FStar_Errors.raw_error,Prims.string)
        FStar_Pervasives_Native_Tuple2.tuple2 -> 'Auu____121
...
let is_type_binder :
  'Auu____1433 .
    FStar_Extraction_ML_UEnv.uenv ->
      (FStar_Syntax_Syntax.bv,'Auu____1433)
        FStar_Pervasives_Native_Tuple2.tuple2 -> Prims.bool
  =
  fun env  ->
    fun x  ->
...
let (check_pats_for_ite :
  (FStar_Syntax_Syntax.pat,FStar_Syntax_Syntax.term
    ...
    FStar_Pervasives_Native_Tuple3.tuple3 Prims.list ->
    ...
    | FStar_Syntax_Syntax.Comp ct ->
        let effect_args =
          FStar_List.map
           ...
           in
        let ct1 =
          let uu___371_3031 = ct  in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___371_3031.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___371_3031.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___371_3031.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args = effect_args;
            FStar_Syntax_Syntax.flags =
              (uu___371_3031.FStar_Syntax_Syntax.flags)
          }  in
        let c1 =
          let uu___372_3035 = c  in
          {
            FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
            FStar_Syntax_Syntax.pos = (uu___372_3035.FStar_Syntax_Syntax.pos);
            FStar_Syntax_Syntax.vars =
              (uu___372_3035.FStar_Syntax_Syntax.vars)
          }  in
        c1
  ...
  FStar_Extraction_ML_UEnv.uenv ->
    FStar_Syntax_Syntax.binders ->
      ((FStar_Extraction_ML_Syntax.mlident,FStar_Extraction_ML_Syntax.mlty)
         FStar_Pervasives_Native_Tuple2.tuple2 Prims.list,FStar_Extraction_ML_UEnv.uenv)
        FStar_Pervasives_Native_Tuple2.tuple2)
  =
  fun g  ->
    fun bs  ->
  ...
  fun q  ->
    fun p  ->
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor (d,pats) ->
          ...
          if uu____4243
          then FStar_Extraction_ML_Syntax.MLP_Tuple pats
          else
            (match q with
        ...
        FStar_Extraction_ML_Syntax.mlty FStar_Pervasives_Native.option ->
          (FStar_Extraction_ML_UEnv.uenv ->
            ...
            (FStar_Extraction_ML_UEnv.uenv,(FStar_Extraction_ML_Syntax.mlpattern,
                                             ...
                                             FStar_Pervasives_Native_Tuple2.tuple2
                                             FStar_Pervasives_Native.option,
              Prims.bool) FStar_Pervasives_Native_Tuple3.tuple3)
  =
  fun imp  ->
    fun g  ->
      fun p  ->
        fun expected_topt  ->
          fun term_as_mlexpr  ->
            ...
            | FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_int
                (c,swopt)) when
                let uu____4421 = FStar_Options.codegen ()  in
                uu____4421 <>
                        ...
                        let uu____4440 =
                          let uu____4441 =
                            FStar_Extraction_ML_Util.mlconst_of_const
                             ...
                             in
                          FStar_Extraction_ML_Syntax.MLE_Const uu____4441  in
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.ml_int_ty) uu____4440
                         in
                      (uu____4439, FStar_Extraction_ML_Syntax.ml_int_ty)
                  | FStar_Pervasives_Native.Some sw ->
                      let source_term =
                        FStar_ToSyntax_ToSyntax.desugar_machine_integer
                         ...
                         in
                      let uu____4463 = term_as_mlexpr g source_term  in
                      (match uu____4463 with
                       | (mlterm,uu____4475,mlty) -> (mlterm, mlty))
                   in
                       ...
                       let uu____4497 =
                         let uu____4498 =
                           ...
                           (FStar_Extraction_ML_Util.prims_op_equality,
                             uu____4505)
                            in
                         FStar_Extraction_ML_Syntax.MLE_App uu____4498  in
                       FStar_All.pipe_left
                         (FStar_Extraction_ML_Syntax.with_ty
                            FStar_Extraction_ML_Syntax.ml_bool_ty) uu____4497
                        in
                     let uu____4511 = ok ml_ty  in
                     (g,
                       (FStar_Pervasives_Native.Some
                          ((FStar_Extraction_ML_Syntax.MLP_Var x),
                            [when_clause])), uu____4511))
                    ...
                    let uu____4549 =
                      let uu____4550 =
                        FStar_Extraction_ML_Util.mlconst_of_const
                         ...
                         in
                      FStar_Extraction_ML_Syntax.MLP_Const uu____4550  in
                    (uu____4549, [])  in
                  FStar_Pervasives_Native.Some uu____4542  in
                let uu____4559 = ok mlty  in (g, uu____4533, uu____4559)
                       ...
                       (if imp
                        then FStar_Pervasives_Native.None
                          ...
                          FStar_Pervasives_Native.Some
                            ((FStar_Extraction_ML_Syntax.MLP_Var x1), [])),
                       uu____4672))
            | FStar_Syntax_Syntax.Pat_dot_term uu____4708 ->
                (g, FStar_Pervasives_Native.None, true)
            | FStar_Syntax_Syntax.Pat_cons (f,pats) ->
                let uu____4751 =
                  let uu____4760 = FStar_Extraction_ML_UEnv.lookup_fv g f  in
                  match uu____4760 with
                  | { FStar_Extraction_ML_UEnv.exp_b_name = uu____4769;
                      FStar_Extraction_ML_UEnv.exp_b_expr =
                        {
                          FStar_Extraction_ML_Syntax.expr =
                            FStar_Extraction_ML_Syntax.MLE_Name n1;
                          FStar_Extraction_ML_Syntax.mlty = uu____4771;
                          FStar_Extraction_ML_Syntax.loc = uu____4772;_};
                      FStar_Extraction_ML_UEnv.exp_b_tscheme = ttys;
                      FStar_Extraction_ML_UEnv.exp_b_inst_ok = uu____4774;_}
                      -> (n1, ttys)
                  | uu____4781 -> failwith "Expected a constructor"  in
                (match uu____4751 with
                 | (d,tys) ->
                     let nTyVars =
                       FStar_List.length (FStar_Pervasives_Native.fst tys)
                        in
                     let uu____4818 = FStar_Util.first_N nTyVars pats  in
                                 ...
                                 | () ->
                                     ...
                                     let uu____4982 =
                                       FStar_Extraction_ML_Util.uncurry_mlty_fun
                                         f_ty
                                        in
                                     FStar_Pervasives_Native.Some uu____4982)
                                ()
                            with
                                           ...
                                           let uu____5823 =
                                             ...
                                             let uu____5833 =
                                               FStar_All.pipe_right
                                                 ...
                                                 FStar_List.flatten
                                                in
                                             (uu____5830, uu____5833)  in
                                           FStar_Pervasives_Native.Some
                                             uu____5823
                                            in
                                         (g2, uu____5814, pat_ty_compat))))))
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            match t with
            | FStar_Extraction_ML_Syntax.MLTY_Fun (t0,uu____6237,t1) ->
                let x = FStar_Extraction_ML_Syntax.gensym ()  in
                let uu____6241 =
                  let uu____6253 =
                    let uu____6263 =
                      FStar_All.pipe_left
                       ...
                       in
                    ((x, t0), uu____6263)  in
                  uu____6253 :: more_args  in
                eta_args uu____6241 t1
            | FStar_Extraction_ML_Syntax.MLTY_Named (uu____6279,uu____6280)
          ...
          let as_record qual1 e =
            ...
            | (FStar_Extraction_ML_Syntax.MLE_CTor
               (uu____6345,args),FStar_Pervasives_Native.Some
          ...
          let resugar_and_maybe_eta qual1 e =
            let uu____6404 = eta_args [] residualType  in
            match uu____6404 with
            | (eargs,tres) ->
                (match eargs with
                 | [] ->
                     let uu____6462 = as_record qual1 e  in
                     FStar_Extraction_ML_Util.resugar_exp uu____6462
                 | uu____6463 ->
                     let uu____6475 = FStar_List.unzip eargs  in
          ...
          | (uu____6536,FStar_Pervasives_Native.None ) -> mlAppExpr
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                FStar_Extraction_ML_Syntax.expr =
                  FStar_Extraction_ML_Syntax.MLE_Name mlp;
                FStar_Extraction_ML_Syntax.mlty = uu____6540;
                FStar_Extraction_ML_Syntax.loc = uu____6541;_},mle::args),FStar_Pervasives_Native.Some
                    ...
                    let uu____6567 =
                      let uu____6574 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____6574, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____6567
                 in
              FStar_Extraction_ML_Syntax.with_ty
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____6579;_},uu____6580);
                FStar_Extraction_ML_Syntax.mlty = uu____6581;
                FStar_Extraction_ML_Syntax.loc = uu____6582;_},mle::args),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_projector (constrname,f))) ->
              let f1 =
                FStar_Ident.lid_of_ids
                  (FStar_List.append constrname.FStar_Ident.ns [f])
             ...
             (FStar_Syntax_Syntax.Data_ctor )) ->
              let uu____6632 =
                FStar_All.pipe_left
                 ...
                 in
              FStar_All.pipe_left (resugar_and_maybe_eta qual) uu____6632
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                FStar_Extraction_ML_Syntax.expr =
                  FStar_Extraction_ML_Syntax.MLE_Name mlp;
             ...
             (FStar_Syntax_Syntax.Record_ctor uu____6639)) ->
              let uu____6652 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     mlAppExpr.FStar_Extraction_ML_Syntax.mlty)
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____6657;_},uu____6658);
             ...
             ({
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____6677;_},uu____6678);
                FStar_Extraction_ML_Syntax.mlty = uu____6679;
                FStar_Extraction_ML_Syntax.loc = uu____6680;_},mlargs),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_ctor uu____6682)) ->
              let uu____6699 =
                FStar_All.pipe_left
                  ...
                  (FStar_Extraction_ML_Syntax.MLE_CTor (mlp, mlargs))
                 in
              FStar_All.pipe_left (resugar_and_maybe_eta qual) uu____6699
          ...
          | (FStar_Extraction_ML_Syntax.MLE_TApp
             ({
                FStar_Extraction_ML_Syntax.expr =
                  FStar_Extraction_ML_Syntax.MLE_Name mlp;
                FStar_Extraction_ML_Syntax.mlty = uu____6722;
                FStar_Extraction_ML_Syntax.loc = uu____6723;_},uu____6724),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Data_ctor )) ->
              let uu____6731 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
             ...
             (FStar_Syntax_Syntax.Record_ctor uu____6738)) ->
              let uu____6751 =
                FStar_All.pipe_left
                  ...
                  (FStar_Extraction_ML_Syntax.MLE_CTor (mlp, []))
                 in
              FStar_All.pipe_left (resugar_and_maybe_eta qual) uu____6751
          | uu____6754 -> mlAppExpr
  ...
  FStar_Extraction_ML_UEnv.uenv ->
    FStar_Syntax_Syntax.letbindings ->
      (FStar_Syntax_Syntax.lbname,FStar_Extraction_ML_Syntax.e_tag,(FStar_Syntax_Syntax.typ,
                                                                    ...
                                                                    FStar_Pervasives_Native_Tuple2.tuple2)
                                                                    FStar_Pervasives_Native_Tuple2.tuple2,
        Prims.bool,FStar_Syntax_Syntax.term)
        FStar_Pervasives_Native_Tuple5.tuple5 Prims.list)
  =
  fun g  ->
    fun lbs  ->
      let maybe_generalize uu____6846 =
        match uu____6846 with
        | { FStar_Syntax_Syntax.lbname = lbname_;
            FStar_Syntax_Syntax.lbunivs = uu____6867;
            FStar_Syntax_Syntax.lbtyp = lbtyp;
            FStar_Syntax_Syntax.lbeff = lbeff;
            FStar_Syntax_Syntax.lbdef = lbdef;
            FStar_Syntax_Syntax.lbattrs = uu____6871;
            FStar_Syntax_Syntax.lbpos = uu____6872;_} ->
            let f_e = effect_as_etag g lbeff  in
            let lbtyp1 = FStar_Syntax_Subst.compress lbtyp  in
            let no_gen uu____6953 =
            ...
            then
              ...
              (match lbtyp1.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                   let uu____7116 = FStar_List.hd bs  in
                   FStar_All.pipe_right uu____7116 (is_type_binder g) ->
                    ...
                    | (bs1,c1) ->
                        let uu____7164 =
                          let uu____7177 =
                            FStar_Util.prefix_until
                              (fun x  ->
                                 let uu____7223 = is_type_binder g x  in
                                 Prims.op_Negation uu____7223) bs1
                             in
                        ...
                        (match uu____7164 with
                         | (tbinders,tbody) ->
                             ...
                             let lbdef1 =
                               let uu____7412 = normalize_abs lbdef  in
                             ...
                             (match lbdef1.FStar_Syntax_Syntax.n with
                              ...
                              | FStar_Syntax_Syntax.Tm_uinst uu____7830 ->
                                  let env =
                                    FStar_List.fold_left
                                      (fun env  ->
                                         fun uu____7849  ->
                              ...
                              | FStar_Syntax_Syntax.Tm_fvar uu____7983 ->
                                  let env =
                                    FStar_List.fold_left
                                      (fun env  ->
                                         fun uu____7996  ->
                                  ...
                                  (lbname_, f_e,
                                    (lbtyp1, (tbinders, polytype)), false, e)
                              | FStar_Syntax_Syntax.Tm_name uu____8130 ->
                                  let env =
                                    FStar_List.fold_left
                                      (fun env  ->
                                         fun uu____8143  ->
                                  ...
                                  (lbname_, f_e,
                                    (lbtyp1, (tbinders, polytype)), false, e)
                              | uu____8277 -> err_value_restriction lbdef1)))
               | uu____8297 -> no_gen ())
         in
           ...
           fun uu____8448  ->
             ...
             | (lbname,e_tag,(typ,(binders,mltyscheme)),add_unit,_body) ->
                 ...
                 (match uu____8509 with
                  | (env1,uu____8526,exp_binding) ->
                      let uu____8530 =
                        let uu____8535 = FStar_Util.right lbname  in
                        (uu____8535, exp_binding)  in
                      (env1, uu____8530))) g lbs1
    ...
    fun e  ->
      fun f  ->
        fun ty  ->
          FStar_Extraction_ML_UEnv.debug g
            (fun uu____8601  ->
               let uu____8602 = FStar_Syntax_Print.term_to_string e  in
               let uu____8604 =
                 FStar_Extraction_ML_Code.string_of_mlty
               ...
               FStar_Util.print2 "Checking %s at type %s\n" uu____8602
                 uu____8604);
          (match (f, ty) with
           | (FStar_Extraction_ML_Syntax.E_GHOST ,uu____8611) ->
               (FStar_Extraction_ML_Syntax.ml_unit,
                 FStar_Extraction_ML_Syntax.MLTY_Erased)
           | (FStar_Extraction_ML_Syntax.E_PURE
              ,FStar_Extraction_ML_Syntax.MLTY_Erased ) ->
               (FStar_Extraction_ML_Syntax.ml_unit,
                 FStar_Extraction_ML_Syntax.MLTY_Erased)
           | uu____8612 ->
               let uu____8617 = term_as_mlexpr g e  in
               (match uu____8617 with
                | (ml_e,tag,t) ->
                    let uu____8631 = maybe_promote_effect ml_e tag t  in
...
and (term_as_mlexpr :
  ...
  fun g  ->
    fun e  ->
      let uu____8668 = term_as_mlexpr' g e  in
      match uu____8668 with
      | (e1,f,t) ->
          let uu____8684 = maybe_promote_effect e1 f t  in
          (match uu____8684 with | (e2,f1) -> (e2, f1, t))
      ...
      FStar_Extraction_ML_UEnv.debug g
        (fun u  ->
           let uu____8709 =
             ...
             let uu____8713 = FStar_Syntax_Print.tag_of_term top  in
             let uu____8715 = FStar_Syntax_Print.term_to_string top  in
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____8711 uu____8713 uu____8715
              in
           FStar_Util.print_string uu____8709);
      (let t = FStar_Syntax_Subst.compress top  in
       match t.FStar_Syntax_Syntax.n with
       | FStar_Syntax_Syntax.Tm_unknown  ->
           let uu____8725 =
             let uu____8727 = FStar_Syntax_Print.tag_of_term t  in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____8727
              in
           failwith uu____8725
       | FStar_Syntax_Syntax.Tm_delayed uu____8736 ->
           let uu____8759 =
             let uu____8761 = FStar_Syntax_Print.tag_of_term t  in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____8761
              in
           failwith uu____8759
       | FStar_Syntax_Syntax.Tm_uvar uu____8770 ->
           let uu____8783 =
             let uu____8785 = FStar_Syntax_Print.tag_of_term t  in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____8785
              in
           failwith uu____8783
       | FStar_Syntax_Syntax.Tm_bvar uu____8794 ->
           let uu____8795 =
             let uu____8797 = FStar_Syntax_Print.tag_of_term t  in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____8797
              in
           failwith uu____8795
       | FStar_Syntax_Syntax.Tm_lazy i ->
           let uu____8807 = FStar_Syntax_Util.unfold_lazy i  in
           term_as_mlexpr g uu____8807
       | FStar_Syntax_Syntax.Tm_type uu____8808 ->
           (FStar_Extraction_ML_Syntax.ml_unit,
             FStar_Extraction_ML_Syntax.E_PURE,
             FStar_Extraction_ML_Syntax.ml_unit_ty)
       | FStar_Syntax_Syntax.Tm_refine uu____8809 ->
           (FStar_Extraction_ML_Syntax.ml_unit,
             FStar_Extraction_ML_Syntax.E_PURE,
             FStar_Extraction_ML_Syntax.ml_unit_ty)
       | FStar_Syntax_Syntax.Tm_arrow uu____8816 ->
           (FStar_Extraction_ML_Syntax.ml_unit,
             FStar_Extraction_ML_Syntax.E_PURE,
             FStar_Extraction_ML_Syntax.ml_unit_ty)
       | FStar_Syntax_Syntax.Tm_quoted
           (qt,{
                 ...
                 FStar_Syntax_Syntax.antiquotes = uu____8832;_})
           ->
           let uu____8845 =
             let uu____8846 =
               FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.failwith_lid
                 ...
                 FStar_Pervasives_Native.None
                in
             FStar_Extraction_ML_UEnv.lookup_fv g uu____8846  in
           (match uu____8845 with
            | { FStar_Extraction_ML_UEnv.exp_b_name = uu____8853;
                FStar_Extraction_ML_UEnv.exp_b_expr = fw;
                FStar_Extraction_ML_UEnv.exp_b_tscheme = uu____8855;
                FStar_Extraction_ML_UEnv.exp_b_inst_ok = uu____8856;_} ->
                let uu____8859 =
                  let uu____8860 =
                    let uu____8861 =
                      let uu____8868 =
                        ...
                        [uu____8871]  in
                      (fw, uu____8868)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____8861  in
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_int_ty) uu____8860
                   in
                (uu____8859, FStar_Extraction_ML_Syntax.E_PURE,
       ...
       | FStar_Syntax_Syntax.Tm_quoted
           ...
           ->
           let uu____8889 = FStar_Reflection_Basic.inspect_ln qt  in
           (match uu____8889 with
            | FStar_Reflection_Data.Tv_Var bv ->
                let uu____8897 = FStar_Syntax_Syntax.lookup_aq bv aqs  in
                 ...
                 | FStar_Pervasives_Native.None  ->
                     let tv =
                       let uu____8908 =
                         ...
                         FStar_Syntax_Embeddings.embed uu____8915
                           (FStar_Reflection_Data.Tv_Var bv)
                          in
                       uu____8908 t.FStar_Syntax_Syntax.pos
                         FStar_Pervasives_Native.None
                         FStar_Syntax_Embeddings.id_norm_cb
                        in
                     let t1 =
                       let uu____8946 =
                         let uu____8957 = FStar_Syntax_Syntax.as_arg tv  in
                         [uu____8957]  in
            ...
            | tv ->
                let tv1 =
                  let uu____8984 =
                    let uu____8991 =
                      FStar_Reflection_Embeddings.e_term_view_aq aqs  in
                    FStar_Syntax_Embeddings.embed uu____8991 tv  in
                  uu____8984 t.FStar_Syntax_Syntax.pos
                    FStar_Pervasives_Native.None
                    FStar_Syntax_Embeddings.id_norm_cb
                   in
                let t1 =
                  let uu____9022 =
                    let uu____9033 = FStar_Syntax_Syntax.as_arg tv1  in
                    [uu____9033]  in
                  FStar_Syntax_Util.mk_app
                    (FStar_Reflection_Data.refl_constant_term
                       FStar_Reflection_Data.fstar_refl_pack_ln) uu____9022
                   in
                term_as_mlexpr g t1)
       | FStar_Syntax_Syntax.Tm_meta
           (t1,FStar_Syntax_Syntax.Meta_monadic (m,uu____9060)) ->
           ...
           (match t2.FStar_Syntax_Syntax.n with
            ...
            | uu____9147 -> term_as_mlexpr g t2)
       | FStar_Syntax_Syntax.Tm_meta (t1,uu____9149) -> term_as_mlexpr g t1
       | FStar_Syntax_Syntax.Tm_uinst (t1,uu____9155) -> term_as_mlexpr g t1
                ...
                let uu____9178 =
                  let uu____9179 =
                    FStar_Extraction_ML_Util.mlexpr_of_const
                     ...
                     in
                  FStar_Extraction_ML_Syntax.with_ty ml_ty uu____9179  in
                (uu____9178, FStar_Extraction_ML_Syntax.E_PURE, ml_ty))
       | FStar_Syntax_Syntax.Tm_name uu____9180 ->
           let uu____9181 = is_type g t  in
           if uu____9181
           then
             (FStar_Extraction_ML_Syntax.ml_unit,
               FStar_Extraction_ML_Syntax.E_PURE,
             ...
             (let uu____9192 = FStar_Extraction_ML_UEnv.lookup_term g t  in
              match uu____9192 with
              | (FStar_Util.Inl uu____9205,uu____9206) ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                    FStar_Extraction_ML_Syntax.ml_unit_ty)
              | (FStar_Util.Inr
                 { FStar_Extraction_ML_UEnv.exp_b_name = uu____9211;
                   ...
                   FStar_Extraction_ML_UEnv.exp_b_inst_ok = uu____9214;_},qual)
                  ->
                  (match mltys with
                   ...
                   | ([],t1) ->
                       ...
                       (uu____9232, FStar_Extraction_ML_Syntax.E_PURE, t1)
                   | uu____9233 -> err_uninst g t mltys t))
       | FStar_Syntax_Syntax.Tm_fvar fv ->
           let uu____9241 = is_type g t  in
           if uu____9241
           then
             (FStar_Extraction_ML_Syntax.ml_unit,
               FStar_Extraction_ML_Syntax.E_PURE,
             ...
             (let uu____9252 = FStar_Extraction_ML_UEnv.try_lookup_fv g fv
              ...
              | FStar_Pervasives_Native.None  ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    ...
                    FStar_Extraction_ML_Syntax.MLTY_Erased)
              | FStar_Pervasives_Native.Some
                  { FStar_Extraction_ML_UEnv.exp_b_name = uu____9261;
                    FStar_Extraction_ML_UEnv.exp_b_expr = x;
                    FStar_Extraction_ML_UEnv.exp_b_tscheme = mltys;
                    FStar_Extraction_ML_UEnv.exp_b_inst_ok = uu____9264;_}
                  ->
                  (FStar_Extraction_ML_UEnv.debug g
                     (fun uu____9272  ->
                    ...
                    | ([],t1) ->
                        let uu____9290 =
                          maybe_eta_data_and_project_record g
                           ...
                           in
                        (uu____9290, FStar_Extraction_ML_Syntax.E_PURE, t1)
                    | uu____9291 -> err_uninst g t mltys t)))
       | FStar_Syntax_Syntax.Tm_abs (bs,body,rcopt) ->
           let uu____9325 = FStar_Syntax_Subst.open_term bs body  in
           (match uu____9325 with
            | (bs1,body1) ->
                let uu____9338 = binders_as_ml_binders g bs1  in
                     ...
                     let body2 =
                       ...
                       | FStar_Pervasives_Native.None  ->
                           (FStar_Extraction_ML_UEnv.debug g
                            ...
                            body1)
                        in
                     let uu____9386 = term_as_mlexpr env body2  in
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.pos = uu____9477;
              FStar_Syntax_Syntax.vars = uu____9478;_},(a1,uu____9480)::[])
           ->
           let ty =
             let uu____9520 =
               FStar_Syntax_Syntax.tabbrev FStar_Parser_Const.range_lid  in
             term_as_mlty g uu____9520  in
           let uu____9521 =
             let uu____9522 =
             ...
             FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty ty)
               uu____9522
              in
           (uu____9521, FStar_Extraction_ML_Syntax.E_PURE, ty)
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_set_range_of );
              FStar_Syntax_Syntax.pos = uu____9523;
              FStar_Syntax_Syntax.vars = uu____9524;_},(t1,uu____9526)::
            (r,uu____9528)::[])
           -> term_as_mlexpr g t1
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_reflect uu____9583);
              FStar_Syntax_Syntax.pos = uu____9584;
              FStar_Syntax_Syntax.vars = uu____9585;_},uu____9586)
           ...
           let is_total rc =
             (FStar_Ident.lid_equals rc.FStar_Syntax_Syntax.residual_effect
               ...
               (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
                  (FStar_List.existsb
                     (fun uu___369_9655  ->
                        match uu___369_9655 with
                        | FStar_Syntax_Syntax.TOTAL  -> true
                        | uu____9658 -> false)))
              in
           let uu____9660 =
             let uu____9665 =
               let uu____9666 = FStar_Syntax_Subst.compress head1  in
               uu____9666.FStar_Syntax_Syntax.n  in
             ((head1.FStar_Syntax_Syntax.n), uu____9665)  in
           (match uu____9660 with
            | (FStar_Syntax_Syntax.Tm_uvar uu____9675,uu____9676) ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Env.Beta;
                    FStar_TypeChecker_Env.Iota;
                   ...
                   in
                term_as_mlexpr g t1
            | (uu____9690,FStar_Syntax_Syntax.Tm_abs
               (bs,uu____9692,FStar_Pervasives_Native.Some rc)) when
                is_total rc ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Env.Beta;
                   ...
                   in
                term_as_mlexpr g t1
            | (uu____9717,FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_reify )) ->
                let e =
                  let uu____9719 = FStar_List.hd args  in
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.env_tcenv head1 uu____9719
                   in
                let tm =
                  let uu____9731 =
                    let uu____9736 = FStar_TypeChecker_Util.remove_reify e
                       in
                    let uu____9737 = FStar_List.tl args  in
                    FStar_Syntax_Syntax.mk_Tm_app uu____9736 uu____9737  in
                  uu____9731 FStar_Pervasives_Native.None
                    t.FStar_Syntax_Syntax.pos
                   in
                term_as_mlexpr g tm
            | uu____9748 ->
                let rec extract_app is_data uu____9801 uu____9802 restArgs =
                  match (uu____9801, uu____9802) with
                  | ((mlhead,mlargs_f),(f,t1)) ->
                      let mk_head uu____9883 =
                        let mlargs =
                      ...
                      (FStar_Extraction_ML_UEnv.debug g
                       ...
                       (match (restArgs, t1) with
                        | ([],uu____9962) ->
                            let app =
                              let uu____9978 = mk_head ()  in
                              maybe_eta_data_and_project_record g is_data t1
                                uu____9978
                               in
                            (app, f, t1)
                        | ((arg,uu____9980)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                           (formal_t,f',t2)) when
                            (is_type g arg) &&
                              (type_leq g formal_t
                                 FStar_Extraction_ML_Syntax.ml_unit_ty)
                            ...
                            extract_app is_data
                              (mlhead,
                                ((FStar_Extraction_ML_Syntax.ml_unit,
                                   FStar_Extraction_ML_Syntax.E_PURE) ::
                                mlargs_f)) uu____10011 rest
                        | ((e0,uu____10028)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                           (tExpected,f',t2)) ->
                                 ...
                                 (match t1 with
                                  ...
                                  | uu____10180 ->
                                      ...
                                      err_ill_typed_application g top mlhead1
                                        restArgs t1))))
                   in
                let extract_app_maybe_projector is_data mlhead uu____10251
                  args1 =
                  match uu____10251 with
                  | (f,t1) ->
                      (match is_data with
                       | FStar_Pervasives_Native.Some
                           (FStar_Syntax_Syntax.Record_projector uu____10281)
                           ->
                           let rec remove_implicits args2 f1 t2 =
                             match (args2, t2) with
                             | ((a0,FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____10365))::args3,FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____10367,f',t3)) ->
                                 let uu____10405 =
                                   FStar_Extraction_ML_Util.join
                                     a0.FStar_Syntax_Syntax.pos f1 f'
                                    in
                                 remove_implicits args3 uu____10405 t3
                             | uu____10406 -> (args2, f1, t2)  in
                           let uu____10431 = remove_implicits args1 f t1  in
                   ...
                   in
                let extract_app_with_instantiations uu____10511 =
                  let head2 = FStar_Syntax_Util.un_uinst head1  in
                  match head2.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Tm_name uu____10519 ->
                      let uu____10520 =
                        let uu____10541 =
                            ...
                            (FStar_Extraction_ML_UEnv.debug g
                               (fun uu____10580  ->
                                  ...
                                  FStar_Util.print4
                                    ...
                                    uu____10581 uu____10583 uu____10585
                                    uu____10587);
                             (((exp_b.FStar_Extraction_ML_UEnv.exp_b_expr),
                                (exp_b.FStar_Extraction_ML_UEnv.exp_b_tscheme),
                                (exp_b.FStar_Extraction_ML_UEnv.exp_b_inst_ok)),
                               q))
                        | uu____10614 -> failwith "FIXME Ty"  in
                      (match uu____10520 with
                       | ((head_ml,(vars,t1),inst_ok),qual) ->
                           let has_typ_apps =
                             match args with
                             | (a,uu____10690)::uu____10691 -> is_type g a
                             | uu____10718 -> false  in
                           let uu____10730 =
                             match vars with
                             | uu____10759::uu____10760 when
                                        ...
                                        (FStar_Extraction_ML_UEnv.debug g
                                           (fun uu____10934  ->
                                              ...
                                              FStar_Util.print4
                                                ...
                                                uu____10935 uu____10937
                                                uu____10939 uu____10951);
                                         (let mk_tapp e ty_args =
                                            match ty_args with
                                            | [] -> e
                                            | uu____10969 ->
                                                let uu___375_10972 = e  in
                                                {
                                                  FStar_Extraction_ML_Syntax.expr
                                                    =
                                                    (FStar_Extraction_ML_Syntax.MLE_TApp
                                                  ...
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    =
                                                    (uu___375_10972.FStar_Extraction_ML_Syntax.mlty);
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___375_10972.FStar_Extraction_ML_Syntax.loc)
                                                }
                                             in
                                          let head3 =
                                            ...
                                            | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   in
                                                {
                                                  FStar_Extraction_ML_Syntax.expr
                                                    =
                                                    (uu___376_10977.FStar_Extraction_ML_Syntax.expr);
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    = t2;
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___376_10977.FStar_Extraction_ML_Syntax.loc)
                                                }
                                            | FStar_Extraction_ML_Syntax.MLE_Var
                                                uu____10978 ->
                                                let uu___376_10980 =
                                                   ...
                                                   in
                                                {
                                                  FStar_Extraction_ML_Syntax.expr
                                                    =
                                                    (uu___376_10980.FStar_Extraction_ML_Syntax.expr);
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    = t2;
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___376_10980.FStar_Extraction_ML_Syntax.loc)
                                                }
                                            | FStar_Extraction_ML_Syntax.MLE_App
                                                (head3,{
                                                         FStar_Extraction_ML_Syntax.expr
                                                  ...
                                                  (FStar_Extraction_ML_Syntax.MLE_App
                                                     ((let uu___377_10989 =
                                                          ...
                                                          in
                                                       {
                                                         FStar_Extraction_ML_Syntax.expr
                                                           =
                                                           (uu___377_10989.FStar_Extraction_ML_Syntax.expr);
                                                         FStar_Extraction_ML_Syntax.mlty
                                                           =
                                                           (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                              (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                         ...
                                                         FStar_Extraction_ML_Syntax.loc
                                                           =
                                                           (uu___377_10989.FStar_Extraction_ML_Syntax.loc)
                                                       }),
                                                       [FStar_Extraction_ML_Syntax.ml_unit]))
                                                  (FStar_Extraction_ML_Syntax.with_ty
                                                     t2)
                                ...
                                (match args1 with
                                 ...
                                 | uu____11057 ->
                                     extract_app_maybe_projector qual
                                       ...
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         head_t) args1)))
                  | FStar_Syntax_Syntax.Tm_fvar uu____11066 ->
                      let uu____11067 =
                        let uu____11088 =
                          FStar_Extraction_ML_UEnv.lookup_term g head2  in
                        ...
                        | (FStar_Util.Inr exp_b,q) ->
                            (FStar_Extraction_ML_UEnv.debug g
                             ...
                             (((exp_b.FStar_Extraction_ML_UEnv.exp_b_expr),
                                ...
                                (exp_b.FStar_Extraction_ML_UEnv.exp_b_inst_ok)),
                               q))
                        | uu____11161 -> failwith "FIXME Ty"  in
                      (match uu____11067 with
                       | ((head_ml,(vars,t1),inst_ok),qual) ->
                           let has_typ_apps =
                             match args with
                             | (a,uu____11237)::uu____11238 -> is_type g a
                             | uu____11265 -> false  in
                           let uu____11277 =
                             match vars with
                             | uu____11306::uu____11307 when
                                 (Prims.op_Negation has_typ_apps) && inst_ok
                                 -> (head_ml, t1, args)
                             | uu____11321 ->
                                 let n1 = FStar_List.length vars  in
                                    ...
                                    | (prefix1,rest) ->
                                        ...
                                        (FStar_Extraction_ML_UEnv.debug g
                                           (fun uu____11481  ->
                                              ...
                                              FStar_Util.print4
                                                "@@@looked up %s, instantiated with [%s] translated to [%s], got %s\n"
                                                uu____11482 uu____11484
                                                uu____11486 uu____11498);
                                         (let mk_tapp e ty_args =
                                            match ty_args with
                                            | [] -> e
                                            | uu____11516 ->
                                                let uu___375_11519 = e  in
                                                {
                                                  FStar_Extraction_ML_Syntax.expr
                                                    =
                                                    (FStar_Extraction_ML_Syntax.MLE_TApp
                                                  ...
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    =
                                                    (uu___375_11519.FStar_Extraction_ML_Syntax.mlty);
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___375_11519.FStar_Extraction_ML_Syntax.loc)
                                                }
                                             in
                                          let head3 =
                                            match head_ml.FStar_Extraction_ML_Syntax.expr
                                            ...
                                            | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   in
                                                {
                                                  FStar_Extraction_ML_Syntax.expr
                                                    =
                                                    (uu___376_11524.FStar_Extraction_ML_Syntax.expr);
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    = t2;
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___376_11524.FStar_Extraction_ML_Syntax.loc)
                                                }
                                            | FStar_Extraction_ML_Syntax.MLE_Var
                                                uu____11525 ->
                                                let uu___376_11527 =
                                                   ...
                                                   in
                                                {
                                                  FStar_Extraction_ML_Syntax.expr
                                                    =
                                                    (uu___376_11527.FStar_Extraction_ML_Syntax.expr);
                                                  FStar_Extraction_ML_Syntax.mlty
                                                    = t2;
                                                  FStar_Extraction_ML_Syntax.loc
                                                    =
                                                    (uu___376_11527.FStar_Extraction_ML_Syntax.loc)
                                                }
                                            | FStar_Extraction_ML_Syntax.MLE_App
                                                (head3,{
                                                         FStar_Extraction_ML_Syntax.expr
                                                  ...
                                                  (FStar_Extraction_ML_Syntax.MLE_App
                                                     ((let uu___377_11536 =
                                                          ...
                                                          in
                                                       {
                                                         FStar_Extraction_ML_Syntax.expr
                                                           =
                                                           (uu___377_11536.FStar_Extraction_ML_Syntax.expr);
                                                         FStar_Extraction_ML_Syntax.mlty
                                                           =
                                                           (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                              (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                         ...
                                                         FStar_Extraction_ML_Syntax.loc
                                                           =
                                                           (uu___377_11536.FStar_Extraction_ML_Syntax.loc)
                                                       }),
                                                       [FStar_Extraction_ML_Syntax.ml_unit]))
                                                  (FStar_Extraction_ML_Syntax.with_ty
                                                     t2)
                                 ...
                                 | uu____11604 ->
                                     extract_app_maybe_projector qual
                                       ...
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         head_t) args1)))
                  | uu____11613 ->
                      let uu____11614 = term_as_mlexpr g head2  in
                      (match uu____11614 with
                       | (head3,f,t1) ->
                           extract_app_maybe_projector
                             FStar_Pervasives_Native.None head3 (f, t1) args)
                   in
                let uu____11630 = is_type g t  in
                if uu____11630
                then
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                  ...
                  (let uu____11641 =
                     let uu____11642 = FStar_Syntax_Util.un_uinst head1  in
                     uu____11642.FStar_Syntax_Syntax.n  in
                   ...
                   | uu____11664 -> extract_app_with_instantiations ()))
       | FStar_Syntax_Syntax.Tm_ascribed (e0,(tc,uu____11667),f) ->
           let t1 =
             match tc with
           ...
           let uu____11735 = check_term_as_mlexpr g e0 f1 t1  in
           (match uu____11735 with | (e,t2) -> (e, f1, t2))
       | FStar_Syntax_Syntax.Tm_let ((is_rec,lbs),e') ->
           ...
           let uu____11770 =
             ...
             then FStar_Syntax_Subst.open_let_rec lbs e'
               ...
               (let uu____11786 = FStar_Syntax_Syntax.is_top_level lbs  in
                if uu____11786
                then (lbs, e')
                else
                  (let lb = FStar_List.hd lbs  in
                   let x =
                     ...
                     FStar_Syntax_Syntax.freshen_bv uu____11801  in
                   let lb1 =
                     let uu___378_11803 = lb  in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___378_11803.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___378_11803.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___378_11803.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___378_11803.FStar_Syntax_Syntax.lbdef);
                       FStar_Syntax_Syntax.lbattrs =
                         (uu___378_11803.FStar_Syntax_Syntax.lbattrs);
                       FStar_Syntax_Syntax.lbpos =
                         (uu___378_11803.FStar_Syntax_Syntax.lbpos)
                     }  in
                   let e'1 =
            ...
            | (lbs1,e'1) ->
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                               ...
                               in
                            let lbdef =
                              let uu____11852 = FStar_Options.ml_ish ()  in
                              if uu____11852
                              then lb.FStar_Syntax_Syntax.lbdef
                              else
                                (let norm_call uu____11864 =
                                   FStar_TypeChecker_Normalize.normalize
                                     [FStar_TypeChecker_Env.AllowUnboundUniverses;
                                     FStar_TypeChecker_Env.EraseUniverses;
                                     FStar_TypeChecker_Env.Inlining;
                               ...
                               in
                            let uu___379_11896 = lb  in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___379_11896.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___379_11896.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp =
                                (uu___379_11896.FStar_Syntax_Syntax.lbtyp);
                              FStar_Syntax_Syntax.lbeff =
                                (uu___379_11896.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef = lbdef;
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___379_11896.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___379_11896.FStar_Syntax_Syntax.lbpos)
                            }))
                  else lbs1  in
                let check_lb env uu____11949 =
                  ...
                  FStar_List.fold_right
                    (fun lb  ->
                       fun uu____12270  ->
                         ...
                         | (env,lbs4) ->
                             let uu____12404 = lb  in
                             (match uu____12404 with
                              | (lbname,uu____12455,(t1,(uu____12457,polytype)),add_unit,uu____12460)
                                  ->
                                  let uu____12475 =
                ...
                (match uu____12173 with
                 | (env_body,lbs4) ->
                     ...
                     let uu____12795 = term_as_mlexpr env_body e'1  in
                              ...
                              let uu____12830 =
                                let uu____12831 =
                                  FStar_List.map FStar_Pervasives_Native.snd
                                    lbs5
                                   in
                                (is_rec1, uu____12831)  in
                              mk_MLE_Let top_level uu____12830 e'2  in
                            let uu____12840 =
                              FStar_Extraction_ML_Util.mlloc_of_range
                                t.FStar_Syntax_Syntax.pos
                               in
                            FStar_Extraction_ML_Syntax.with_ty_loc t'
                              uu____12829 uu____12840
                             in
                          (uu____12828, f, t'))))
       | FStar_Syntax_Syntax.Tm_match (scrutinee,pats) ->
           let uu____12879 = term_as_mlexpr g scrutinee  in
           (match uu____12879 with
            | (e,f_e,t_e) ->
                let uu____12895 = check_pats_for_ite pats  in
                       ...
                       (match (then_e, else_e) with
                        | (FStar_Pervasives_Native.Some
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            let uu____12960 = term_as_mlexpr g then_e1  in
                                 ...
                                 (match uu____13700 with
                                  | {
                                      ...
                                      (uu____13714,
                                        FStar_Extraction_ML_Syntax.E_PURE,
                                        FStar_Extraction_ML_Syntax.ml_int_ty))
                             | (uu____13730,uu____13731,(uu____13732,f_first,t_first))::rest
                                 ->
                                 let uu____13792 =
                                   FStar_List.fold_left
                                     (fun uu____13834  ->
                                        fun uu____13835  ->
                                          match (uu____13834, uu____13835)
                                          with
                                          | ((topt,f),(uu____13892,uu____13893,
                                                       (uu____13894,f_branch,t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
        ...
        let uu____14137 =
          let uu____14142 =
            FStar_TypeChecker_Env.lookup_lid
             ...
             in
          FStar_All.pipe_left FStar_Pervasives_Native.fst uu____14142  in
        match uu____14137 with
        | (uu____14167,fstar_disc_type) ->
            let wildcards =
              let uu____14177 =
              ...
              | FStar_Syntax_Syntax.Tm_arrow (binders,uu____14189) ->
                  let uu____14210 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___370_14244  ->
                            match uu___370_14244 with
                            | (uu____14252,FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____14253)) ->
                                true
                            | uu____14258 -> false))
                     in
                  FStar_All.pipe_right uu____14210
                    (FStar_List.map
                       (fun uu____14294  ->
                          let uu____14301 = fresh "_"  in
                          (uu____14301, FStar_Extraction_ML_Syntax.MLTY_Top)))
              | uu____14305 -> failwith "Discriminator must be a function"
               in
                            ...
                            let uu____14376 =
                              let uu____14377 =
                                ...
                                (uu____14384,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____14377
                               in
                            let uu____14387 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                            ...
                            let uu____14402 =
                              let uu____14411 =
                                FStar_All.pipe_left
                                 ...
                                 in
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____14411)
                               in
                            [uu____14402]  in
                          uu____14367 :: uu____14391  in
                        (uu____14350, uu____14356)  in
                      FStar_Extraction_ML_Syntax.MLE_Match uu____14335  in
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____14334
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____14333)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____14321  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____14320
               in
            let uu____14472 =
              let uu____14473 =
                let uu____14476 =
                  let uu____14477 =
                    FStar_Extraction_ML_UEnv.convIdent
                     ...
                     in
                  {
                    FStar_Extraction_ML_Syntax.mllb_name = uu____14477;
                    FStar_Extraction_ML_Syntax.mllb_tysc =
                      FStar_Pervasives_Native.None;
                    FStar_Extraction_ML_Syntax.mllb_add_unit = false;
                ...
                [uu____14476]  in
              (FStar_Extraction_ML_Syntax.NonRec, uu____14473)  in
            FStar_Extraction_ML_Syntax.MLM_Let uu____14472
