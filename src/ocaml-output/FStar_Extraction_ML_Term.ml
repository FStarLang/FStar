  ...
  fun env ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_match (uu___1, uu___2, branches, uu___3) ->
          (match branches with
           | (uu___4, uu___5, e)::uu___6 -> is_arity env e
           | uu___4 -> false)
let rec (is_type_aux :
  FStar_Extraction_ML_UEnv.uenv -> FStar_Syntax_Syntax.term -> Prims.bool) =
  fun env ->
    fun t ->
      ...
      | FStar_Syntax_Syntax.Tm_let ((uu___, lbs), body) ->
          ...
          (match uu___1 with | (uu___2, body1) -> is_type_aux env body1)
      | FStar_Syntax_Syntax.Tm_match (uu___, uu___1, branches, uu___2) ->
          (match branches with
           | b::uu___3 ->
               let uu___4 = FStar_Syntax_Subst.open_branch b in
               (match uu___4 with | (uu___5, uu___6, e) -> is_type_aux env e)
           | uu___3 -> false)
          ...
          (let uu___2 =
           ...
           | (formals, uu___3) ->
               ...
               let mlargs1 =
                 ...
                 then
                   let uu___4 = FStar_Compiler_Util.first_N n_args formals in
                   match uu___4 with
                   | (uu___5, rest) ->
                       let uu___6 =
                         FStar_Compiler_List.map
                       ...
                       FStar_Compiler_List.op_At mlargs uu___6
                 else mlargs in
               let nm =
          ...
          fun term_as_mlexpr ->
            ...
            FStar_Extraction_ML_UEnv.debug g
              (fun uu___1 ->
                 ...
                 let uu___3 =
                   let uu___4 =
                     FStar_Extraction_ML_UEnv.current_module_of_uenv g in
                   FStar_Extraction_ML_Code.string_of_mlty uu___4 expected_ty in
                 FStar_Compiler_Util.print2
                   "@@@@@extract_one_pat %s with expected type = %s\n" uu___2
                   uu___3);
            (match p.FStar_Syntax_Syntax.v with
                       ...
                       let uu___2 =
                         ...
                         FStar_Compiler_Effect.op_Less_Bar
                           (FStar_Extraction_ML_Syntax.with_ty
                              FStar_Extraction_ML_Syntax.ml_int_ty) uu___3 in
                       (uu___2, FStar_Extraction_ML_Syntax.ml_int_ty)
                   | FStar_Pervasives_Native.Some sw ->
                       let source_term =
                         let uu___2 =
                           let uu___3 =
                             FStar_Extraction_ML_UEnv.tcenv_of_uenv g in
                           uu___3.FStar_TypeChecker_Env.dsenv in
                         FStar_ToSyntax_ToSyntax.desugar_machine_integer
                           uu___2 c sw FStar_Compiler_Range.dummyRange in
                       let uu___2 = term_as_mlexpr g source_term in
                       (match uu___2 with
                        | (mlterm, uu___3, mlty) -> (mlterm, mlty)) in
                 (match uu___1 with
                  | (mlc, ml_ty) ->
                      let uu___2 = FStar_Extraction_ML_UEnv.new_mlident g in
                      (match uu___2 with
                       | (g1, x) ->
                           let when_clause =
                             let uu___3 =
             ...
             | FStar_Syntax_Syntax.Pat_constant s ->
                 ...
                 let uu___2 = ok mlty in (g, uu___1, uu___2)
             | FStar_Syntax_Syntax.Pat_var x ->
                 let computed_mlty =
                   term_as_mlty g x.FStar_Syntax_Syntax.sort in
                 let uu___1 =
                   FStar_Extraction_ML_UEnv.extend_bv g x ([], expected_ty)
                     false imp in
                 (match uu___1 with
                  | (g1, x1, uu___2) ->
                      let uu___3 = ok computed_mlty in
                      (g1,
                        (if imp
                                       ...
                                       let args1 =
                                         let uu___8 =
                                           let uu___9 =
                                             ...
                                             FStar_Extraction_ML_Code.string_of_mlty
                                               uu___10 in
                                           FStar_Compiler_List.map uu___9
                                             args in
                                         FStar_Compiler_Effect.op_Bar_Greater
                                           uu___8
                                           (FStar_String.concat " -> ") in
      ...
      (let is_match t =
       ...
       let apply_to_match_branches head args =
         let uu___1 =
           ...
           uu___2.FStar_Syntax_Syntax.n in
         match uu___1 with
         | FStar_Syntax_Syntax.Tm_match (scrutinee, uu___2, branches, uu___3)
             ->
             let branches1 =
       ...
       | FStar_Syntax_Syntax.Tm_app (head, args) ->
           ...
           (match uu___1 with
            ...
            | FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify) ->
                let e =
                  let uu___2 = FStar_Extraction_ML_UEnv.tcenv_of_uenv g in
                  let uu___3 = FStar_Compiler_List.hd args in
                      ...
                      | (e'2, f', t') ->
                          ...
                          let uu___4 =
                            ...
                            FStar_Extraction_ML_Syntax.with_ty_loc t' uu___5
                              uu___6 in
                          (uu___4, f, t'))))
       | FStar_Syntax_Syntax.Tm_match (scrutinee, uu___1, pats, uu___2) ->
