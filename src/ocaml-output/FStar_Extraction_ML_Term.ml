  ...
  fun g  ->
    fun top  ->
      ...
      (let t = FStar_Syntax_Subst.compress top in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,args) ->
           let is_total uu___144_3658 =
             match uu___144_3658 with
                                     ...
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                             ...
                                             |FStar_Extraction_ML_Syntax.MLE_Var
                                             _ ->
                                               let uu___148_4435 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___148_4435.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___148_4435.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___149_4441 =
                                                        head3 in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___149_4441.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___149_4441.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
               ...
               (let uu____4583 = FStar_Syntax_Syntax.is_top_level lbs in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs in
                   ...
                   let lb1 =
                     let uu___150_4595 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___150_4595.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___150_4595.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___150_4595.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___150_4595.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e'1 =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____4612 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4616  ->
                            ...
                            (let lbdef =
                             ...
                             let uu___151_4624 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___151_4624.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___151_4624.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___151_4624.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___151_4624.FStar_Syntax_Syntax.lbeff);
                  ...
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           ...
                           ->
                           let uu____4699 = FStar_Syntax_Subst.open_comp bs c in
                                ...
                                let uu____4713 =
                                  let uu____4718 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____4736 = is_type_binder g x in
                                         Prims.op_Negation uu____4736) bs1 in
                 ...
                 | (env_body,lbs4) ->
                     ...
                     (match uu____5605 with
                      | (e'2,f',t') ->
                          let f =
                            let uu____5616 =
                              let uu____5618 = FStar_List.map Prims.fst lbs5 in
                              f' :: uu____5618 in
                            FStar_Extraction_ML_Util.join_l e'_rng uu____5616 in
                          let is_rec1 =
                            if is_rec = true
                        ...
                        | (Some then_e1,Some else_e1) ->
                            ...
                            (match uu____5707 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____5717 = term_as_mlexpr g else_e1 in
                                                 ...
                                                 let uu____5783 =
                                                   let uu____5785 =
                                                     maybe_lift else_mle
                                                       t_else in
                                                   Some uu____5785 in
                                                 (e, uu____5782, uu____5783) in
                                               FStar_Extraction_ML_Syntax.MLE_If
                                                 uu____5777 in
                                             FStar_All.pipe_left
                                               (FStar_Extraction_ML_Syntax.with_ty
                                                  t_branch) uu____5776 in
                                           let uu____5787 =
                                             FStar_Extraction_ML_Util.join
    ...
    fun discName  ->
      fun constrName  ->
        ...
        | (uu____6400,fstar_disc_type) ->
            let wildcards =
              let uu____6408 =
                let uu____6409 = FStar_Syntax_Subst.compress fstar_disc_type in
              ...
              let uu____6492 =
                let uu____6493 =
                  let uu____6499 =
                        ...
                        let uu____6509 =
                          let uu____6510 =
                            let uu____6511 =
                              ...
                              ([], uu____6512) in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____6511 in
                          FStar_All.pipe_left
                        ...
                        let uu____6514 =
                          let uu____6520 =
                            let uu____6525 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____6526 in
                            let uu____6532 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____6500 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____6499) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____6493 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____6492 in
            let uu____6583 =
              let uu____6584 =
                let uu____6586 =
                  let uu____6587 =
