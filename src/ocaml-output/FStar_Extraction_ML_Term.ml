...
let err_uninst env t uu____105 app =
  ...
  | (vars,ty) ->
      let _0_456 =
        ...
        let _0_454 =
          let _0_451 = FStar_All.pipe_right vars (FStar_List.map Prims.fst)
             in
                    ...
                    FStar_Extraction_ML_Syntax.MLE_App
                      (let _0_489 =
                         ...
                         let _0_487 =
                           ...
                           [_0_486]  in
                         _0_488 :: _0_487  in
                       (FStar_Extraction_ML_Util.prims_op_equality, _0_489))
                     in
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_bool_ty) _0_490
                   in
                                ...
                                FStar_Extraction_ML_Syntax.MLE_Name
                                  (let _0_530 =
                                     FStar_Extraction_ML_UEnv.monad_op_name
                                       ed "bind"
                                      in
                                   FStar_All.pipe_right _0_530 Prims.fst)
                                 in
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
            ...
            | (uu____3191,ty,uu____3193) ->
                ...
                let _0_536 =
                  let _0_535 =
                    ...
                    FStar_All.pipe_left
                      (fun _0_533  ->
                         FStar_Extraction_ML_Syntax.MLE_Const _0_533) _0_534
                     in
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv _0_554
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4374  ->
                 ...
                 | (env_body,lbs) ->
                     ...
                     (match uu____5339 with
                      | (e',f',t') ->
                          let f =
                            let _0_563 =
                              let _0_562 = FStar_List.map Prims.fst lbs  in
                              f' :: _0_562  in
              ...
              let _0_600 =
                FStar_Extraction_ML_Syntax.MLE_Fun
                  (let _0_599 =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.ml_bool_ty) _0_598
                      in
                   ((FStar_List.append wildcards [(mlid, targ)]), _0_599))
                 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) _0_600
               in
