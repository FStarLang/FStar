...
let f_ty_opt = (FStar_All.try_with (fun uu___171_3360 -> (match (()) with
| () -> begin
(
...
end)) (fun uu___170_3433 -> (match (uu___170_3433) with
| Un_extractable -> begin
FStar_Pervasives_Native.None
end)))
in (
...
let uu____4052 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun uu___167_4103 -> (match (uu___167_4103) with
...
let is_total = (fun rc -> ((FStar_Ident.lid_equals rc.FStar_Syntax_Syntax.residual_effect FStar_Parser_Const.effect_Tot_lid) || (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags (FStar_List.existsb (fun uu___168_6058 -> (match (uu___168_6058) with
...
let uu___172_7407 = e
in {FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_TApp (((e), (ty_args))); FStar_Extraction_ML_Syntax.mlty = uu___172_7407.FStar_Extraction_ML_Syntax.mlty; FStar_Extraction_ML_Syntax.loc = uu___172_7407.FStar_Extraction_ML_Syntax.loc})
end))
in (
...
let uu___173_7412 = (mk_tapp head_ml prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___173_7412.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___173_7412.FStar_Extraction_ML_Syntax.loc})
end
| FStar_Extraction_ML_Syntax.MLE_Var (uu____7413) -> begin
(

let uu___173_7414 = (mk_tapp head_ml prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___173_7414.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___173_7414.FStar_Extraction_ML_Syntax.loc})
end
...
let uu___174_7423 = (mk_tapp head3 prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___174_7423.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t2))); FStar_Extraction_ML_Syntax.loc = uu___174_7423.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t2))
end
| uu____7424 -> begin
...
let uu___172_7832 = e
in {FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_TApp (((e), (ty_args))); FStar_Extraction_ML_Syntax.mlty = uu___172_7832.FStar_Extraction_ML_Syntax.mlty; FStar_Extraction_ML_Syntax.loc = uu___172_7832.FStar_Extraction_ML_Syntax.loc})
end))
in (
...
let uu___173_7837 = (mk_tapp head_ml prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___173_7837.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___173_7837.FStar_Extraction_ML_Syntax.loc})
end
| FStar_Extraction_ML_Syntax.MLE_Var (uu____7838) -> begin
(

let uu___173_7839 = (mk_tapp head_ml prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___173_7839.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t2; FStar_Extraction_ML_Syntax.loc = uu___173_7839.FStar_Extraction_ML_Syntax.loc})
end
...
let uu___174_7848 = (mk_tapp head3 prefixAsMLTypes)
in {FStar_Extraction_ML_Syntax.expr = uu___174_7848.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t2))); FStar_Extraction_ML_Syntax.loc = uu___174_7848.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t2))
end
| uu____7849 -> begin
(failwith "Impossible: Unexpected head term")
end)
...
let uu___175_8067 = lb
in {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (x); FStar_Syntax_Syntax.lbunivs = uu___175_8067.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___175_8067.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___175_8067.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___175_8067.FStar_Syntax_Syntax.lbdef})
in (
...
let uu___176_8114 = lb
in {FStar_Syntax_Syntax.lbname = uu___176_8114.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___176_8114.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___176_8114.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___176_8114.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = lbdef}));
)))))
end
| uu____8115 -> begin
lbs1
...
let uu____11440 = (FStar_All.pipe_right binders (FStar_List.filter (fun uu___169_11472 -> (match (uu___169_11472) with
