                  ...
                  | FStar_Pervasives_Native.None  ->
                      let uu____2928 =
                        let uu____2929 =
                          ...
                          FStar_Extraction_ML_Syntax.MLE_Const uu____2930 in
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.ml_int_ty) uu____2929 in
                      (uu____2928, FStar_Extraction_ML_Syntax.ml_int_ty)
                  | FStar_Pervasives_Native.Some sw ->
                      let source_term =
                        FStar_ToSyntax_ToSyntax.desugar_machine_integer
                          (g.FStar_Extraction_ML_UEnv.tcenv).FStar_TypeChecker_Env.dsenv
                          c sw FStar_Range.dummyRange in
                      let uu____2951 = term_as_mlexpr g source_term in
                      (match uu____2951 with
                       | (mlterm,uu____2963,mlty) -> (mlterm, mlty)) in
                       ...
                       let uu____2983 =
                         let uu____2984 =
                           ...
                           (FStar_Extraction_ML_Util.prims_op_equality,
                             uu____2991) in
                         FStar_Extraction_ML_Syntax.MLE_App uu____2984 in
                       FStar_All.pipe_left
                         (FStar_Extraction_ML_Syntax.with_ty
                            FStar_Extraction_ML_Syntax.ml_bool_ty) uu____2983 in
                     let uu____2997 = ok ml_ty in
                     (g,
                       (FStar_Pervasives_Native.Some
                          ((FStar_Extraction_ML_Syntax.MLP_Var x),
                            [when_clause])), uu____2997))
                ...
                let uu____3017 =
                  let uu____3026 =
                    let uu____3033 =
                      ...
                      FStar_Extraction_ML_Syntax.MLP_Const uu____3034 in
                    (uu____3033, []) in
                  FStar_Pervasives_Native.Some uu____3026 in
                let uu____3043 = ok mlty in (g, uu____3017, uu____3043)
                       ...
                       (if imp
                        then FStar_Pervasives_Native.None
                          ...
                          FStar_Pervasives_Native.Some
                            ((FStar_Extraction_ML_Syntax.MLP_Var x1), [])),
                       uu____3134))
            | FStar_Syntax_Syntax.Pat_dot_term uu____3166 ->
                (g, FStar_Pervasives_Native.None, true)
            | FStar_Syntax_Syntax.Pat_cons (f,pats) ->
                let uu____3205 =
                  let uu____3210 = FStar_Extraction_ML_UEnv.lookup_fv g f in
                  ...
                  | FStar_Util.Inr
                      (uu____3215,{
                                    ...
                                    FStar_Extraction_ML_Syntax.loc =
                                      uu____3218;_},ttys,uu____3220)
                      -> (n1, ttys)
                  | uu____3233 -> failwith "Expected a constructor" in
                (match uu____3205 with
                 | (d,tys) ->
                     let nTyVars =
                       FStar_List.length (FStar_Pervasives_Native.fst tys) in
                     let uu____3255 = FStar_Util.first_N nTyVars pats in
                                     ...
                                     | (mlPats,when_clauses) ->
                                         ...
                                         let uu____4222 =
                                           let uu____4231 =
                                             ...
                                             (uu____4238, uu____4241) in
                                           FStar_Pervasives_Native.Some
                                             uu____4231 in
                                         (g2, uu____4222, pat_ty_compat))))))
let extract_pat:
  FStar_Extraction_ML_UEnv.env ->
    FStar_Syntax_Syntax.pat ->
      FStar_Extraction_ML_Syntax.mlty ->
            ...
            | hd1::tl1 ->
                let uu____4454 =
                  FStar_List.fold_left FStar_Extraction_ML_Util.conjoin hd1
                    tl1 in
                FStar_Pervasives_Native.Some uu____4454 in
          let uu____4455 =
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            match t with
            | FStar_Extraction_ML_Syntax.MLTY_Fun (t0,uu____4593,t1) ->
                let x = FStar_Extraction_ML_Syntax.gensym () in
                let uu____4596 =
                  let uu____4607 =
                    let uu____4616 =
                      FStar_All.pipe_left
                        ...
                        (FStar_Extraction_ML_Syntax.MLE_Var x) in
                    ((x, t0), uu____4616) in
                  uu____4607 :: more_args in
                eta_args uu____4596 t1
            | FStar_Extraction_ML_Syntax.MLTY_Named (uu____4629,uu____4630)
                -> ((FStar_List.rev more_args), t)
            | uu____4653 -> failwith "Impossible: Head type is not an arrow" in
          let as_record qual1 e =
            match ((e.FStar_Extraction_ML_Syntax.expr), qual1) with
            | (FStar_Extraction_ML_Syntax.MLE_CTor
               (uu____4681,args),FStar_Pervasives_Native.Some
          ...
          let resugar_and_maybe_eta qual1 e =
            let uu____4731 = eta_args [] residualType in
            match uu____4731 with
            | (eargs,tres) ->
                (match eargs with
                 | [] ->
                     let uu____4784 = as_record qual1 e in
                     FStar_Extraction_ML_Util.resugar_exp uu____4784
                 | uu____4785 ->
                     let uu____4796 = FStar_List.unzip eargs in
          ...
          | (uu____4851,FStar_Pervasives_Native.None ) -> mlAppExpr
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                FStar_Extraction_ML_Syntax.expr =
                  FStar_Extraction_ML_Syntax.MLE_Name mlp;
                FStar_Extraction_ML_Syntax.mlty = uu____4855;
                FStar_Extraction_ML_Syntax.loc = uu____4856;_},mle::args),FStar_Pervasives_Native.Some
          ...
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____4901;_},mle::args),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_projector (constrname,f))) ->
              let f1 =
                FStar_Ident.lid_of_ids
                  (FStar_List.append constrname.FStar_Ident.ns [f]) in
                      ...
                      let uu____4942 =
                        FStar_All.pipe_left
                          (FStar_Extraction_ML_Syntax.with_ty
                             FStar_Extraction_ML_Syntax.MLTY_Top) proj in
                      (uu____4942, args) in
                    FStar_Extraction_ML_Syntax.MLE_App uu____4935 in
              FStar_Extraction_ML_Syntax.with_ty
                mlAppExpr.FStar_Extraction_ML_Syntax.mlty e
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
             ...
             (FStar_Syntax_Syntax.Data_ctor )) ->
              ...
              FStar_All.pipe_left (resugar_and_maybe_eta qual) uu____4955
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                FStar_Extraction_ML_Syntax.expr =
                  FStar_Extraction_ML_Syntax.MLE_Name mlp;
                FStar_Extraction_ML_Syntax.mlty = uu____4959;
                FStar_Extraction_ML_Syntax.loc = uu____4960;_},mlargs),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_ctor uu____4962)) ->
              let uu____4975 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     mlAppExpr.FStar_Extraction_ML_Syntax.mlty)
                  (FStar_Extraction_ML_Syntax.MLE_CTor (mlp, mlargs)) in
              FStar_All.pipe_left (resugar_and_maybe_eta qual) uu____4975
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                FStar_Extraction_ML_Syntax.expr =
                  FStar_Extraction_ML_Syntax.MLE_TApp
          ...
          | (FStar_Extraction_ML_Syntax.MLE_App
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____5003;_},mlargs),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_ctor uu____5005)) ->
              let uu____5022 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     mlAppExpr.FStar_Extraction_ML_Syntax.mlty)
                  (FStar_Extraction_ML_Syntax.MLE_CTor (mlp, mlargs)) in
              FStar_All.pipe_left (resugar_and_maybe_eta qual) uu____5022
          ...
          | (FStar_Extraction_ML_Syntax.MLE_Name
             ...
             (FStar_Syntax_Syntax.Record_ctor uu____5032)) ->
              let uu____5041 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     mlAppExpr.FStar_Extraction_ML_Syntax.mlty)
          ...
          | (FStar_Extraction_ML_Syntax.MLE_TApp
             ({
                ...
                FStar_Extraction_ML_Syntax.loc = uu____5059;_},uu____5060),FStar_Pervasives_Native.Some
             (FStar_Syntax_Syntax.Record_ctor uu____5061)) ->
              let uu____5074 =
                FStar_All.pipe_left
                  (FStar_Extraction_ML_Syntax.with_ty
                     mlAppExpr.FStar_Extraction_ML_Syntax.mlty)
  ...
  fun g  ->
    fun f  ->
      fun t  ->
        ...
        if uu____5093 then FStar_Extraction_ML_Syntax.E_PURE else f
let rec term_as_mlexpr:
  ...
  fun g  ->
    fun t  ->
      let uu____5147 = term_as_mlexpr' g t in
             ...
             (fun u  ->
                let uu____5168 =
                  ...
                  FStar_Util.format4
                    ...
                    uu____5169 uu____5170 uu____5171
                    (FStar_Extraction_ML_Util.eff_to_string tag1) in
                FStar_Util.print_string uu____5168);
           erase g e ty tag1)
and check_term_as_mlexpr:
  ...
  fun g  ->
    fun t  ->
      fun f  ->
        fun ty  ->
          let uu____5180 = check_term_as_mlexpr' g t f ty in
          match uu____5180 with
          | (e,t1) ->
              let uu____5191 = erase g e t1 f in
              (match uu____5191 with | (r,uu____5203,t2) -> (r, t2))
and check_term_as_mlexpr':
  FStar_Extraction_ML_UEnv.env ->
    FStar_Syntax_Syntax.term ->
      FStar_Extraction_ML_Syntax.e_tag ->
      ...
      FStar_Extraction_ML_UEnv.debug g
        (fun u  ->
           let uu____5250 =
             ...
             let uu____5252 = FStar_Syntax_Print.tag_of_term top in
             let uu____5253 = FStar_Syntax_Print.term_to_string top in
             FStar_Util.format3 "%s: term_as_mlexpr' (%s) :  %s \n"
               uu____5251 uu____5252 uu____5253 in
           FStar_Util.print_string uu____5250);
      (let t = FStar_Syntax_Subst.compress top in
       match t.FStar_Syntax_Syntax.n with
       | FStar_Syntax_Syntax.Tm_unknown  ->
           let uu____5261 =
             let uu____5262 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5262 in
           failwith uu____5261
       | FStar_Syntax_Syntax.Tm_delayed uu____5269 ->
           let uu____5294 =
             let uu____5295 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5295 in
           failwith uu____5294
       | FStar_Syntax_Syntax.Tm_uvar uu____5302 ->
           let uu____5319 =
             let uu____5320 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5320 in
           failwith uu____5319
       | FStar_Syntax_Syntax.Tm_bvar uu____5327 ->
           let uu____5328 =
             let uu____5329 = FStar_Syntax_Print.tag_of_term t in
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____5329 in
           failwith uu____5328
       | FStar_Syntax_Syntax.Tm_type uu____5336 ->
           (FStar_Extraction_ML_Syntax.ml_unit,
             FStar_Extraction_ML_Syntax.E_PURE,
             FStar_Extraction_ML_Syntax.ml_unit_ty)
       | FStar_Syntax_Syntax.Tm_refine uu____5337 ->
           (FStar_Extraction_ML_Syntax.ml_unit,
             FStar_Extraction_ML_Syntax.E_PURE,
             FStar_Extraction_ML_Syntax.ml_unit_ty)
       | FStar_Syntax_Syntax.Tm_arrow uu____5344 ->
           (FStar_Extraction_ML_Syntax.ml_unit,
             FStar_Extraction_ML_Syntax.E_PURE,
             FStar_Extraction_ML_Syntax.ml_unit_ty)
       | FStar_Syntax_Syntax.Tm_meta
           ...
           ->
           let uu____5362 = term_as_mlexpr' g t1 in
           (match uu____5362 with
            ...
            | uu____5408 -> failwith "impossible")
       | FStar_Syntax_Syntax.Tm_meta
           (t1,FStar_Syntax_Syntax.Meta_monadic (m,uu____5423)) ->
                 ...
                 | (ed,qualifiers) ->
                     let uu____5487 =
                       let uu____5488 =
                         FStar_All.pipe_right qualifiers
                           (FStar_List.contains FStar_Syntax_Syntax.Reifiable) in
                       FStar_All.pipe_right uu____5488 Prims.op_Negation in
                     if uu____5487
                     then term_as_mlexpr' g t2
                     else
                       failwith
                         "This should not happen (should have been handled at Tm_abs level)")
            | uu____5504 -> term_as_mlexpr' g t2)
       | FStar_Syntax_Syntax.Tm_meta (t1,uu____5506) -> term_as_mlexpr' g t1
       | FStar_Syntax_Syntax.Tm_uinst (t1,uu____5512) -> term_as_mlexpr' g t1
       | FStar_Syntax_Syntax.Tm_constant c ->
           let uu____5518 =
             FStar_TypeChecker_TcTerm.type_of_tot_term
               g.FStar_Extraction_ML_UEnv.tcenv t in
           (match uu____5518 with
            | (uu____5531,ty,uu____5533) ->
                let ml_ty = term_as_mlty g ty in
                let uu____5535 =
                  let uu____5536 =
                    FStar_Extraction_ML_Util.mlexpr_of_const
                      t.FStar_Syntax_Syntax.pos c in
                  FStar_Extraction_ML_Syntax.with_ty ml_ty uu____5536 in
                (uu____5535, FStar_Extraction_ML_Syntax.E_PURE, ml_ty))
       | FStar_Syntax_Syntax.Tm_name uu____5537 ->
           let uu____5538 = is_type g t in
           if uu____5538
           then
             (FStar_Extraction_ML_Syntax.ml_unit,
               FStar_Extraction_ML_Syntax.E_PURE,
             ...
             (let uu____5546 = FStar_Extraction_ML_UEnv.lookup_term g t in
              match uu____5546 with
              | (FStar_Util.Inl uu____5559,uu____5560) ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                    FStar_Extraction_ML_Syntax.ml_unit_ty)
              | (FStar_Util.Inr (uu____5597,x,mltys,uu____5600),qual) ->
                  (match mltys with
                   ...
                   | ([],t1) ->
                       ...
                       (uu____5646, FStar_Extraction_ML_Syntax.E_PURE, t1)
                   | uu____5647 -> err_uninst g t mltys t))
       | FStar_Syntax_Syntax.Tm_fvar uu____5654 ->
           let uu____5655 = is_type g t in
           if uu____5655
           then
             (FStar_Extraction_ML_Syntax.ml_unit,
               FStar_Extraction_ML_Syntax.E_PURE,
             ...
             (let uu____5663 = FStar_Extraction_ML_UEnv.lookup_term g t in
              match uu____5663 with
              | (FStar_Util.Inl uu____5676,uu____5677) ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                    FStar_Extraction_ML_Syntax.ml_unit_ty)
              | (FStar_Util.Inr (uu____5714,x,mltys,uu____5717),qual) ->
                  (match mltys with
                   | ([],t1) when t1 = FStar_Extraction_ML_Syntax.ml_unit_ty
                       ->
                       (FStar_Extraction_ML_Syntax.ml_unit,
                   ...
                   | ([],t1) ->
                       let uu____5763 =
                         maybe_eta_data_and_project_record g qual t1 x in
                       (uu____5763, FStar_Extraction_ML_Syntax.E_PURE, t1)
                   | uu____5764 -> err_uninst g t mltys t))
       | FStar_Syntax_Syntax.Tm_abs (bs,body,copt) ->
           let uu____5794 = FStar_Syntax_Subst.open_term bs body in
           (match uu____5794 with
            | (bs1,body1) ->
                let uu____5807 = binders_as_ml_binders g bs1 in
                     ...
                     let body2 =
                       ...
                       | FStar_Pervasives_Native.None  ->
                           (FStar_Extraction_ML_UEnv.debug g
                            ...
                            body1) in
                     let uu____5847 = term_as_mlexpr env body2 in
                      ...
                      | (ml_body,f,t1) ->
                          let uu____5863 =
                            FStar_List.fold_right
                              (fun uu____5882  ->
                                 fun uu____5883  ->
                                   match (uu____5882, uu____5883) with
                                   | ((uu____5904,targ),(f1,t2)) ->
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____5932;_},(a1,uu____5934)::[])
           ->
           let ty =
             let uu____5964 =
               FStar_Syntax_Syntax.tabbrev FStar_Parser_Const.range_lid in
             term_as_mlty g uu____5964 in
           let uu____5965 =
             let uu____5966 =
             ...
             FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty ty)
               uu____5966 in
           (uu____5965, FStar_Extraction_ML_Syntax.E_PURE, ty)
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_set_range_of );
              FStar_Syntax_Syntax.pos = uu____5967;
              FStar_Syntax_Syntax.vars = uu____5968;_},(a1,uu____5970)::
            (a2,uu____5972)::[])
           -> term_as_mlexpr' g a1
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_reflect uu____6011);
              FStar_Syntax_Syntax.pos = uu____6012;
              FStar_Syntax_Syntax.vars = uu____6013;_},uu____6014)
           -> failwith "Unreachable? Tm_app Const_reflect"
       | FStar_Syntax_Syntax.Tm_app (head1,uu____6042::(v1,uu____6044)::[])
           when (FStar_Syntax_Util.is_fstar_tactics_embed head1) && false ->
           let uu____6085 =
             let uu____6088 = FStar_Syntax_Print.term_to_string v1 in
           ...
           let s =
             let uu____6090 =
               let uu____6091 =
                 let uu____6092 =
                   let uu____6095 = FStar_Util.marshal v1 in
                   FStar_Util.bytes_of_string uu____6095 in
                 FStar_Extraction_ML_Syntax.MLC_Bytes uu____6092 in
               FStar_Extraction_ML_Syntax.MLE_Const uu____6091 in
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____6090 in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
           ...
           (uu____6115, FStar_Extraction_ML_Syntax.E_PURE, term_ty)
       | FStar_Syntax_Syntax.Tm_app (head1,args) ->
           let is_total rc =
             (FStar_Ident.lid_equals rc.FStar_Syntax_Syntax.residual_effect
               ...
               (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
                  (FStar_List.existsb
                     (fun uu___284_6147  ->
                        match uu___284_6147 with
                        | FStar_Syntax_Syntax.TOTAL  -> true
                        | uu____6148 -> false))) in
           let uu____6149 =
             let uu____6154 =
               let uu____6155 = FStar_Syntax_Subst.compress head1 in
               uu____6155.FStar_Syntax_Syntax.n in
             ((head1.FStar_Syntax_Syntax.n), uu____6154) in
           (match uu____6149 with
            | (FStar_Syntax_Syntax.Tm_uvar uu____6164,uu____6165) ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Normalize.Beta;
                    FStar_TypeChecker_Normalize.Iota;
                    ...
                    g.FStar_Extraction_ML_UEnv.tcenv t in
                term_as_mlexpr' g t1
            | (uu____6183,FStar_Syntax_Syntax.Tm_abs
               (bs,uu____6185,FStar_Pervasives_Native.Some rc)) when
                is_total rc ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Normalize.Beta;
                    ...
                    g.FStar_Extraction_ML_UEnv.tcenv t in
                term_as_mlexpr' g t1
            | (uu____6206,FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_reify )) ->
                let e =
                  let uu____6208 = FStar_List.hd args in
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6208 in
                let tm =
                  let uu____6218 =
                    let uu____6219 = FStar_TypeChecker_Util.remove_reify e in
                    let uu____6220 = FStar_List.tl args in
                    FStar_Syntax_Syntax.mk_Tm_app uu____6219 uu____6220 in
                  uu____6218 FStar_Pervasives_Native.None
                    t.FStar_Syntax_Syntax.pos in
                term_as_mlexpr' g tm
            | uu____6229 ->
                let rec extract_app is_data uu____6274 uu____6275 restArgs =
                       ...
                       | ([],uu____6365) ->
                           ...
                           let uu____6388 =
                             ...
                             then
                               ...
                               FStar_List.fold_left
                                 (fun uu____6467  ->
                                    fun uu____6468  ->
                                      match (uu____6467, uu____6468) with
                                      | ((lbs,out_args),(arg,f1)) ->
                                          if
                                            (f1 =
                                               FStar_Extraction_ML_Syntax.E_PURE)
                                               ...
                                               let uu____6574 =
                                                 FStar_All.pipe_left
                                                   ...
                                                   (FStar_Extraction_ML_Syntax.MLE_Var
                                                      x) in
                                               uu____6574 :: out_args in
                                             (((x, arg) :: lbs), uu____6571)))
                                 ([], []) mlargs_f in
                           (match uu____6388 with
                            | (lbs,mlargs) ->
                                ...
                                (l_app, f, t1))
                       | ((arg,uu____6657)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                          (formal_t,f',t2)) when
                           (is_type g arg) &&
                             (type_leq g formal_t
                                FStar_Extraction_ML_Syntax.ml_unit_ty)
                           ...
                           extract_app is_data
                             (mlhead,
                               ((FStar_Extraction_ML_Syntax.ml_unit,
                                  FStar_Extraction_ML_Syntax.E_PURE) ::
                               mlargs_f)) uu____6688 rest
                       | ((e0,uu____6705)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                          (tExpected,f',t2)) ->
                           let r = e0.FStar_Syntax_Syntax.pos in
                           let uu____6737 = term_as_mlexpr g e0 in
                ...
                let extract_app_maybe_projector is_data mlhead uu____6840
                  args1 =
                  match uu____6840 with
                  | (f,t1) ->
                      (match is_data with
                       | FStar_Pervasives_Native.Some
                           (FStar_Syntax_Syntax.Record_projector uu____6872)
                           ->
                           let rec remove_implicits args2 f1 t2 =
                             match (args2, t2) with
                             | ((a0,FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____6950))::args3,FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____6952,f',t3)) ->
                                 let uu____6989 =
                                   FStar_Extraction_ML_Util.join
                                     a0.FStar_Syntax_Syntax.pos f1 f' in
                                 remove_implicits args3 uu____6989 t3
                             | uu____6990 -> (args2, f1, t2) in
                           let uu____7015 = remove_implicits args1 f t1 in
                   ...
                   | FStar_Syntax_Syntax.Tm_fvar fv when
                       (FStar_Syntax_Syntax.fv_eq_lid fv
                         ...
                         (let uu____7101 =
                            ...
                            uu____7102 = "FStar.Tactics.Builtins" in
                          Prims.op_Negation uu____7101)
                       ->
                       (match args with
                        | a::b::[] ->
                        ...
                        | uu____7143 ->
                            ...
                            failwith uu____7152)
                   | FStar_Syntax_Syntax.Tm_name uu____7159 ->
                       let uu____7160 =
                         let uu____7173 =
                           FStar_Extraction_ML_UEnv.lookup_term g head2 in
                         match uu____7173 with
                         | (FStar_Util.Inr (uu____7192,x1,x2,x3),q) ->
                             ((x1, x2, x3), q)
                         | uu____7237 -> failwith "FIXME Ty" in
                       (match uu____7160 with
                        | ((head_ml,(vars,t1),inst_ok),qual) ->
                            let has_typ_apps =
                              match args with
                              | (a,uu____7287)::uu____7288 -> is_type g a
                              | uu____7307 -> false in
                            let uu____7316 =
                              match vars with
                              | uu____7345::uu____7346 when
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7493 ->
                                               let uu___288_7496 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___288_7496.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___288_7496.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___289_7501.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___289_7501.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7502 ->
                                               let uu___289_7503 =
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___289_7503.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___289_7503.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___290_7512 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___290_7512.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___290_7512.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                 ...
                                 (match args1 with
                                  ...
                                  | uu____7575 ->
                                      extract_app_maybe_projector qual
                                        ...
                                        (FStar_Extraction_ML_Syntax.E_PURE,
                                          head_t) args1)))
                   | FStar_Syntax_Syntax.Tm_fvar uu____7584 ->
                       let uu____7585 =
                         let uu____7598 =
                           FStar_Extraction_ML_UEnv.lookup_term g head2 in
                         match uu____7598 with
                         | (FStar_Util.Inr (uu____7617,x1,x2,x3),q) ->
                             ((x1, x2, x3), q)
                         | uu____7662 -> failwith "FIXME Ty" in
                       (match uu____7585 with
                        | ((head_ml,(vars,t1),inst_ok),qual) ->
                            let has_typ_apps =
                              match args with
                              | (a,uu____7712)::uu____7713 -> is_type g a
                              | uu____7732 -> false in
                            let uu____7741 =
                              match vars with
                              | uu____7770::uu____7771 when
                                  (Prims.op_Negation has_typ_apps) && inst_ok
                                  -> (head_ml, t1, args)
                              | uu____7782 ->
                                  let n1 = FStar_List.length vars in
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7918 ->
                                               let uu___288_7921 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___288_7921.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___288_7921.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           match head_ml.FStar_Extraction_ML_Syntax.expr
                                           with
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___289_7926.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___289_7926.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7927 ->
                                               let uu___289_7928 =
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___289_7928.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___289_7928.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___290_7937 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___290_7937.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___290_7937.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                  ...
                                  | uu____8000 ->
                                      extract_app_maybe_projector qual
                                        ...
                                        (FStar_Extraction_ML_Syntax.E_PURE,
                                          head_t) args1)))
                   | uu____8009 ->
                       let uu____8010 = term_as_mlexpr g head2 in
                       (match uu____8010 with
                        | (head3,f,t1) ->
                            extract_app_maybe_projector
                              FStar_Pervasives_Native.None head3 (f, t1) args)))
       | FStar_Syntax_Syntax.Tm_ascribed (e0,(tc,uu____8028),f) ->
           let t1 =
             match tc with
           ...
           let uu____8095 = check_term_as_mlexpr g e0 f1 t1 in
           (match uu____8095 with | (e,t2) -> (e, f1, t2))
       | FStar_Syntax_Syntax.Tm_let ((is_rec,lbs),e') ->
           ...
           let uu____8126 =
             ...
             then FStar_Syntax_Subst.open_let_rec lbs e'
               ...
               (let uu____8140 = FStar_Syntax_Syntax.is_top_level lbs in
                if uu____8140
                then (lbs, e')
                else
                  (let lb = FStar_List.hd lbs in
                   let x =
                     ...
                     FStar_Syntax_Syntax.freshen_bv uu____8154 in
                   let lb1 =
                     let uu___291_8156 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___291_8156.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___291_8156.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___291_8156.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___291_8156.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e'1 =
            ...
            | (lbs1,e'1) ->
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8188 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8195  ->
                            ...
                            (let lbdef =
                               let uu____8199 = FStar_Options.ml_ish () in
                               if uu____8199
                             ...
                             let uu___292_8203 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___292_8203.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___292_8203.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___292_8203.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___292_8203.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = lbdef
                             })))
                  else lbs1 in
                let maybe_generalize uu____8226 =
                  match uu____8226 with
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      FStar_Syntax_Syntax.lbunivs = uu____8246;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           let uu____8316 = FStar_List.hd bs in
                           FStar_All.pipe_right uu____8316 (is_type_binder g)
                           ->
                           let uu____8329 = FStar_Syntax_Subst.open_comp bs c in
                            ...
                            | (bs1,c1) ->
                                let uu____8354 =
                                  let uu____8361 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8397 = is_type_binder g x in
                                         Prims.op_Negation uu____8397) bs1 in
                                ...
                                (match uu____8354 with
                                 | (tbinders,tbody) ->
                                     ...
                                     let e1 =
                                       let uu____8530 = normalize_abs e in
                  ...
                  FStar_List.fold_right
                    (fun lb  ->
                       fun uu____9645  ->
                         ...
                         | (env,lbs4) ->
                             let uu____9770 = lb in
                             (match uu____9770 with
                              | (lbname,uu____9818,(t1,(uu____9820,polytype)),add_unit,uu____9823)
                                  ->
                                  let uu____9836 =
                ...
                (match uu____9554 with
                 | (env_body,lbs4) ->
                     ...
                     let uu____10113 = term_as_mlexpr env_body e'1 in
                              ...
                              let uu____10144 =
                                let uu____10145 =
                                  FStar_List.map FStar_Pervasives_Native.snd
                                    lbs5 in
                                (is_rec1, [], uu____10145) in
                              mk_MLE_Let top_level uu____10144 e'2 in
                            let uu____10156 =
                              FStar_Extraction_ML_Util.mlloc_of_range
                                t.FStar_Syntax_Syntax.pos in
                            FStar_Extraction_ML_Syntax.with_ty_loc t'
                              uu____10143 uu____10156 in
                          (uu____10142, f, t'))))
       | FStar_Syntax_Syntax.Tm_match (scrutinee,pats) ->
           let uu____10195 = term_as_mlexpr g scrutinee in
           (match uu____10195 with
            | (e,f_e,t_e) ->
                let uu____10211 = check_pats_for_ite pats in
                       ...
                       (match (then_e, else_e) with
                        | (FStar_Pervasives_Native.Some
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            let uu____10268 = term_as_mlexpr g then_e1 in
                            (match uu____10268 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____10284 = term_as_mlexpr g else_e1 in
                                      ...
                                      (match uu____10300 with
                                       | (t_branch,maybe_lift1) ->
                                           let uu____10357 =
                                             ...
                                             FStar_All.pipe_left
                                               (FStar_Extraction_ML_Syntax.with_ty
                                                  t_branch) uu____10358 in
                                           let uu____10375 =
                                             FStar_Extraction_ML_Util.join
                                               then_e1.FStar_Syntax_Syntax.pos
                                               f_then f_else in
                                           (uu____10357, uu____10375,
                                             t_branch))))
                        | uu____10376 ->
                            failwith
                            ...
                            (match mlbranches1 with
                             | [] ->
                                 ...
                                 (match uu____10977 with
                                  | (uu____11046,fw,uu____11048,uu____11049)
                                      ->
                                      let uu____11050 =
                                        let uu____11051 =
                                          let uu____11052 =
                                      ...
                                      (uu____11050,
                                        FStar_Extraction_ML_Syntax.E_PURE,
                                        FStar_Extraction_ML_Syntax.ml_unit_ty))
                             | (uu____11065,uu____11066,(uu____11067,f_first,t_first))::rest
                                 ->
                                 let uu____11127 =
                                   FStar_List.fold_left
                                     (fun uu____11169  ->
                                        fun uu____11170  ->
                                          ...
                                          with
                                          | ((topt,f),(uu____11227,uu____11228,
                                                       (uu____11229,f_branch,t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
    ...
    fun discName  ->
      fun constrName  ->
        let uu____11459 =
          ...
          FStar_All.pipe_left FStar_Pervasives_Native.fst uu____11464 in
        match uu____11459 with
        | (uu____11489,fstar_disc_type) ->
            let wildcards =
              let uu____11498 =
                let uu____11499 = FStar_Syntax_Subst.compress fstar_disc_type in
                uu____11499.FStar_Syntax_Syntax.n in
              match uu____11498 with
              | FStar_Syntax_Syntax.Tm_arrow (binders,uu____11509) ->
                  let uu____11526 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___285_11558  ->
                            match uu___285_11558 with
                            | (uu____11565,FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____11566)) ->
                                true
                            | uu____11569 -> false)) in
                  FStar_All.pipe_right uu____11526
                    (FStar_List.map
                       (fun uu____11602  ->
                          let uu____11609 = fresh "_" in
                          (uu____11609, FStar_Extraction_ML_Syntax.MLTY_Top)))
              | uu____11610 -> failwith "Discriminator must be a function" in
                        ...
                        let uu____11653 =
                          let uu____11664 =
                            let uu____11673 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11674 in
                            let uu____11684 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                            ...
                            (uu____11673, FStar_Pervasives_Native.None,
                              uu____11684) in
                          let uu____11687 =
                            let uu____11698 =
                              let uu____11707 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11707) in
                            [uu____11698] in
                          uu____11664 :: uu____11687 in
                        (uu____11650, uu____11653) in
                      FStar_Extraction_ML_Syntax.MLE_Match uu____11635 in
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11634 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11633) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11622 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11621 in
            let uu____11762 =
              let uu____11763 =
                let uu____11766 =
                  let uu____11767 =
                  ...
                  {
                    FStar_Extraction_ML_Syntax.mllb_name = uu____11767;
                    FStar_Extraction_ML_Syntax.mllb_tysc =
                      FStar_Pervasives_Native.None;
                ...
                [uu____11766] in
              (FStar_Extraction_ML_Syntax.NonRec, [], uu____11763) in
            FStar_Extraction_ML_Syntax.MLM_Let uu____11762