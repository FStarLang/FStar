  ...
  fun g  ->
    fun top  ->
      ...
      (let t = FStar_Syntax_Subst.compress top in
       ...
       | FStar_Syntax_Syntax.Tm_app (head1,args) ->
           let is_total uu___142_3644 =
             match uu___142_3644 with
                                     ...
                                     | (prefix1,rest) ->
                                         ...
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                             ...
                                             |FStar_Extraction_ML_Syntax.MLE_Var
                                             _ ->
                                               let uu___146_4442 = head_ml in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___146_4442.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___146_4442.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___147_4448 =
                                                        head3 in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___147_4448.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___147_4448.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                   ...
                   let lb1 =
                     let uu___148_4602 = lb in
                     {
                       ...
                       FStar_Syntax_Syntax.lbdef =
                         (uu___148_4602.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e'1 =
                      ...
                      (FStar_List.map
                         (fun lb  ->
                            ...
                            (let lbdef =
                             ...
                             let uu___149_4631 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___149_4631.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___149_4631.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___149_4631.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___149_4631.FStar_Syntax_Syntax.lbeff);
