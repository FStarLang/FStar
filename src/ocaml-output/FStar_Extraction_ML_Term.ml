      ...
      | FStar_Syntax_Syntax.Tm_bvar _
        |FStar_Syntax_Syntax.Tm_delayed _|FStar_Syntax_Syntax.Tm_unknown  ->
          let uu____1121 =
            ...
            FStar_Util.format1 "Impossible: Unexpected term %s" uu____1122
             in
          failwith uu____1121
                  ...
                  | (ml_bs,env) ->
                      ...
                      then
                        ...
                        let ml_b =
                          ...
                          (uu____1518, FStar_Extraction_ML_Syntax.ml_unit_ty)
                           in
                        ((ml_b :: ml_bs), env)
                      else
                        (let b = Prims.fst b  in
          ...
          fun expected_topt  ->
            ...
            | FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_int
                ...
                let when_clause =
                  ...
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_bool_ty) uu____1740
                   in
    ...
    fun p  ->
      fun expected_t  ->
        let extract_one_pat disj g p expected_t =
          ...
          | uu____2526 -> failwith "Impossible: Unable to translate pattern"
           in
      ...
      fun residualType  ->
        fun mlAppExpr  ->
          let rec eta_args more_args t =
            ...
            | uu____2928 -> failwith "Impossible: Head type is not an arrow"
             in
                    ...
                    let uu____3069 =
                      let uu____3073 =
                        FStar_All.pipe_left
                         ...
                         in
                      (uu____3073, args)  in
                    FStar_Extraction_ML_Syntax.MLE_App uu____3069
                 in
              FStar_Extraction_ML_Syntax.with_ty
  ...
  fun g  ->
    fun top  ->
      ...
      (let t = FStar_Syntax_Subst.compress top  in
         ...
         |FStar_Syntax_Syntax.Tm_delayed _
          |FStar_Syntax_Syntax.Tm_uvar _|FStar_Syntax_Syntax.Tm_bvar _ ->
           let uu____3229 =
             ...
             FStar_Util.format1 "Impossible: Unexpected term: %s" uu____3230
              in
           failwith uu____3229
       | FStar_Syntax_Syntax.Tm_type _
         |FStar_Syntax_Syntax.Tm_refine _|FStar_Syntax_Syntax.Tm_arrow _ ->
                                ...
                                let uu____3356 =
                                  let uu____3357 =
                                    FStar_Extraction_ML_UEnv.monad_op_name ed
                                      "bind"
                                     in
                                  FStar_All.pipe_right uu____3357 Prims.fst
                                   in
                            ...
                            let uu____3362 =
                              FStar_All.pipe_left
                                ...
                                (FStar_Extraction_ML_Syntax.MLE_App
                                   (bind, [comp_1; ml_k]))
                               in
                            (uu____3362, FStar_Extraction_ML_Syntax.E_IMPURE,
                              ty)))
       ...
       | FStar_Syntax_Syntax.Tm_app (head,args) ->
           let is_total uu___138_3648 =
             match uu___138_3648 with
                           ...
                           then
                             ...
                             (let uu____3985 =
                                ...
                                FStar_Util.format4
                                  ...
                                  uu____3986 uu____3987 uu____3988 uu____3989
                                 in
                              failwith uu____3985)
                                     ...
                                     | (prefix,rest) ->
                                         ...
                                         let head =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                             ...
                                             |FStar_Extraction_ML_Syntax.MLE_Var
                                             _ ->
                                               let uu___142_4436 = head_ml
                                                  in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___142_4436.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___142_4436.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head,{
                                                       FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___143_4442 =
                                                        head  in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___143_4442.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___143_4442.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t)
               ...
               (let uu____4566 = FStar_Syntax_Syntax.is_top_level lbs  in
                ...
                then (lbs, e')
                  ...
                  (let lb = FStar_List.hd lbs  in
                   ...
                   let lb =
                     let uu___144_4578 = lb  in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___144_4578.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___144_4578.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___144_4578.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___144_4578.FStar_Syntax_Syntax.lbdef)
                     }  in
                   let e' =
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____4595
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4599  ->
                            ...
                            (let lbdef =
                               ...
                               then lb.FStar_Syntax_Syntax.lbdef
                                ...
                                in
                             let uu___145_4607 = lb  in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___145_4607.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___145_4607.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___145_4607.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___145_4607.FStar_Syntax_Syntax.lbeff);
                                    ...
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____4719 = is_type_binder g x
                                            in
                                         Prims.op_Negation uu____4719) bs
                                     in
                          ...
                          let f =
                            let uu____5599 =
                              let uu____5601 = FStar_List.map Prims.fst lbs
                                 in
                              f' :: uu____5601  in
                            FStar_Extraction_ML_Util.join_l e'_rng uu____5599
                             in
                          let is_rec =
                            if is_rec = true
                                       ...
                                       | (t_branch,maybe_lift) ->
                                           ...
                                           let uu____5770 =
                                             FStar_Extraction_ML_Util.join
                                               ...
                                               f_then f_else
                                              in
                                           (uu____5758, uu____5770, t_branch))))
                        | uu____5771 ->
                            failwith
              ...
              let uu____6456 =
                let uu____6457 =
                  let uu____6463 =
                        ...
                        let uu____6473 =
                          let uu____6474 =
                            let uu____6475 =
                              ...
                              ([], uu____6476)  in
                            FStar_Extraction_ML_Syntax.MLE_Name uu____6475
                             in
                          FStar_All.pipe_left
                            ...
                            let uu____6489 =
                              let uu____6490 =
                                ...
                                (uu____6494,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____6490
                               in
                            let uu____6496 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                    ...
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____6464
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____6463)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____6457  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____6456
               in
            let uu____6547 =
              let uu____6548 =
                let uu____6550 =
