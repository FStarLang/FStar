...
let err_uninst env t uu____105 app =
  ...
  | (vars,ty) ->
      let _0_480 =
        ...
        let _0_478 =
          let _0_475 = FStar_All.pipe_right vars (FStar_List.map Prims.fst)
             in
                    ...
                    FStar_Extraction_ML_Syntax.MLE_App
                      (let _0_513 =
                         ...
                         let _0_511 =
                           ...
                           [_0_510]  in
                         _0_512 :: _0_511  in
                       (FStar_Extraction_ML_Util.prims_op_equality, _0_513))
                     in
                  FStar_All.pipe_left
                    (FStar_Extraction_ML_Syntax.with_ty
                       FStar_Extraction_ML_Syntax.ml_bool_ty) _0_514
                   in
                             ...
                             FStar_All.pipe_right ps_when
                               (FStar_List.map
                                  (fun uu____2613  ->
                                     ...
                                     | (x,whens) ->
                                         let _0_530 = mk_when_clause whens
                                            in
                                         (x, _0_530)))
                              in
                           let res =
                                ...
                                FStar_Extraction_ML_Syntax.MLE_Name
                                  (let _0_554 =
                                     FStar_Extraction_ML_UEnv.monad_op_name
                                       ed "bind"
                                      in
                                   FStar_All.pipe_right _0_554 Prims.fst)
                                 in
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
            ...
            | (uu____3191,ty,uu____3193) ->
                ...
                let _0_560 =
                  let _0_559 =
                    ...
                    FStar_All.pipe_left
                      (fun _0_557  ->
                         FStar_Extraction_ML_Syntax.MLE_Const _0_557) _0_558
                     in
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv _0_578
                               in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____4374  ->
                 ...
                 | (env_body,lbs) ->
                     ...
                     (match uu____5339 with
                      | (e',f',t') ->
                          let f =
                            let _0_587 =
                              let _0_586 = FStar_List.map Prims.fst lbs  in
                              f' :: _0_586  in
              ...
              let _0_624 =
                FStar_Extraction_ML_Syntax.MLE_Fun
                  (let _0_623 =
                     ...
                     FStar_All.pipe_left
                       (FStar_Extraction_ML_Syntax.with_ty
                          FStar_Extraction_ML_Syntax.ml_bool_ty) _0_622
                      in
                   ((FStar_List.append wildcards [(mlid, targ)]), _0_623))
                 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) _0_624
               in
