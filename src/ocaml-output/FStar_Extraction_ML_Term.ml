  ...
  fun g  ->
    fun top  ->
      ...
      (let t = FStar_Syntax_Subst.compress top  in
           ...
           (match uu____6034 with
                ...
                (match uu____6042 with
                 ...
                 | FStar_Pervasives_Native.None  ->
                     let tv =
                       ...
                       FStar_Syntax_Embeddings.embed uu____6158
                         t.FStar_Syntax_Syntax.pos
                         (FStar_Reflection_Data.Tv_Var bv)
                        in
                     let t1 =
                       let uu____6164 =
                         let uu____6175 = FStar_Syntax_Syntax.as_arg tv  in
                         [uu____6175]  in
            ...
            | tv ->
                let tv1 =
                  let uu____6202 =
                    FStar_Reflection_Embeddings.e_term_view_aq aqs  in
                  FStar_Syntax_Embeddings.embed uu____6202
                    t.FStar_Syntax_Syntax.pos tv
                   in
                let t1 =
                  let uu____6208 =
                    let uu____6219 = FStar_Syntax_Syntax.as_arg tv1  in
                    [uu____6219]  in
                  FStar_Syntax_Util.mk_app
                    (FStar_Reflection_Data.refl_constant_term
                       FStar_Reflection_Data.fstar_refl_pack_ln) uu____6208
                   in
                term_as_mlexpr g t1)
       ...
       | FStar_Syntax_Syntax.Tm_meta
           (t1,FStar_Syntax_Syntax.Meta_monadic (m,uu____6257)) ->
                     ...
                     let uu____6321 =
                       let uu____6322 =
                         FStar_All.pipe_right qualifiers
                           (FStar_List.contains FStar_Syntax_Syntax.Reifiable)
                          in
                       FStar_All.pipe_right uu____6322 Prims.op_Negation  in
                     if uu____6321
                     then term_as_mlexpr g t2
                     else
                       failwith
                         "This should not happen (should have been handled at Tm_abs level)")
            | uu____6338 -> term_as_mlexpr g t2)
       | FStar_Syntax_Syntax.Tm_meta (t1,uu____6340) -> term_as_mlexpr g t1
       | FStar_Syntax_Syntax.Tm_uinst (t1,uu____6346) -> term_as_mlexpr g t1
                ...
                let uu____6369 =
                  let uu____6370 =
                    FStar_Extraction_ML_Util.mlexpr_of_const
                     ...
                     in
                  FStar_Extraction_ML_Syntax.with_ty ml_ty uu____6370  in
                (uu____6369, FStar_Extraction_ML_Syntax.E_PURE, ml_ty))
       | FStar_Syntax_Syntax.Tm_name uu____6371 ->
           let uu____6372 = is_type g t  in
           if uu____6372
           then
             (FStar_Extraction_ML_Syntax.ml_unit,
               FStar_Extraction_ML_Syntax.E_PURE,
             ...
             (let uu____6380 = FStar_Extraction_ML_UEnv.lookup_term g t  in
              match uu____6380 with
              | (FStar_Util.Inl uu____6393,uu____6394) ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                    FStar_Extraction_ML_Syntax.ml_unit_ty)
              | (FStar_Util.Inr (uu____6415,x,mltys,uu____6418),qual) ->
                  (match mltys with
                   ...
                   | ([],t1) ->
                       ...
                       (uu____6444, FStar_Extraction_ML_Syntax.E_PURE, t1)
                   | uu____6445 -> err_uninst g t mltys t))
       | FStar_Syntax_Syntax.Tm_fvar fv ->
           let uu____6453 = is_type g t  in
           if uu____6453
           then
             (FStar_Extraction_ML_Syntax.ml_unit,
               FStar_Extraction_ML_Syntax.E_PURE,
             ...
             (let uu____6461 = FStar_Extraction_ML_UEnv.try_lookup_fv g fv
                 in
              ...
              | FStar_Pervasives_Native.None  ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                    FStar_Extraction_ML_Syntax.MLTY_Erased)
              | FStar_Pervasives_Native.Some (FStar_Util.Inl uu____6470) ->
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                    FStar_Extraction_ML_Syntax.ml_unit_ty)
              | FStar_Pervasives_Native.Some (FStar_Util.Inr
                  (uu____6487,x,mltys,uu____6490)) ->
                  (match mltys with
                   | ([],t1) when t1 = FStar_Extraction_ML_Syntax.ml_unit_ty
                       ->
                       (FStar_Extraction_ML_Syntax.ml_unit,
                   ...
                   | ([],t1) ->
                       let uu____6511 =
                         maybe_eta_data_and_project_record g
                          ...
                          in
                       (uu____6511, FStar_Extraction_ML_Syntax.E_PURE, t1)
                   | uu____6512 -> err_uninst g t mltys t))
       | FStar_Syntax_Syntax.Tm_abs (bs,body,copt) ->
           let uu____6546 = FStar_Syntax_Subst.open_term bs body  in
           (match uu____6546 with
            | (bs1,body1) ->
                let uu____6559 = binders_as_ml_binders g bs1  in
                     ...
                     let body2 =
                       ...
                       | FStar_Pervasives_Native.None  ->
                           (FStar_Extraction_ML_UEnv.debug g
                            ...
                            body1)
                        in
                     let uu____6599 = term_as_mlexpr env body2  in
                      ...
                      | (ml_body,f,t1) ->
                          let uu____6615 =
                            FStar_List.fold_right
                              (fun uu____6634  ->
                                 fun uu____6635  ->
                                   match (uu____6634, uu____6635) with
                                   | ((uu____6656,targ),(f1,t2)) ->
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              ...
              FStar_Syntax_Syntax.vars = uu____6684;_},(a1,uu____6686)::[])
           ->
           let ty =
             let uu____6726 =
               FStar_Syntax_Syntax.tabbrev FStar_Parser_Const.range_lid  in
             term_as_mlty g uu____6726  in
           let uu____6727 =
             let uu____6728 =
             ...
             FStar_All.pipe_left (FStar_Extraction_ML_Syntax.with_ty ty)
               uu____6728
              in
           (uu____6727, FStar_Extraction_ML_Syntax.E_PURE, ty)
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_set_range_of );
              FStar_Syntax_Syntax.pos = uu____6729;
              FStar_Syntax_Syntax.vars = uu____6730;_},(t1,uu____6732)::
            (r,uu____6734)::[])
           -> term_as_mlexpr g t1
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_reflect uu____6789);
              FStar_Syntax_Syntax.pos = uu____6790;
              FStar_Syntax_Syntax.vars = uu____6791;_},uu____6792)
           ...
           let is_total rc =
             (FStar_Ident.lid_equals rc.FStar_Syntax_Syntax.residual_effect
               ...
               (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
                  (FStar_List.existsb
                     (fun uu___343_6858  ->
                        match uu___343_6858 with
                        | FStar_Syntax_Syntax.TOTAL  -> true
                        | uu____6859 -> false)))
              in
           let uu____6860 =
             let uu____6865 =
               let uu____6866 = FStar_Syntax_Subst.compress head1  in
               uu____6866.FStar_Syntax_Syntax.n  in
             ((head1.FStar_Syntax_Syntax.n), uu____6865)  in
           (match uu____6860 with
            | (FStar_Syntax_Syntax.Tm_uvar uu____6875,uu____6876) ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Normalize.Beta;
                    FStar_TypeChecker_Normalize.Iota;
                   ...
                   in
                term_as_mlexpr g t1
            | (uu____6890,FStar_Syntax_Syntax.Tm_abs
               (bs,uu____6892,FStar_Pervasives_Native.Some rc)) when
                is_total rc ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Normalize.Beta;
                   ...
                   in
                term_as_mlexpr g t1
            | (uu____6917,FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_reify )) ->
                let e =
                  let uu____6919 = FStar_List.hd args  in
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6919
                   in
                let tm =
                  let uu____6931 =
                    let uu____6936 = FStar_TypeChecker_Util.remove_reify e
                       in
                    let uu____6937 = FStar_List.tl args  in
                    FStar_Syntax_Syntax.mk_Tm_app uu____6936 uu____6937  in
                                ...
                                (match t1 with
                                 ...
                                 | uu____7278 ->
                                     err_ill_typed_application g top restArgs
                                       t1)))
                   in
                let extract_app_maybe_projector is_data mlhead uu____7326
                  args1 =
                  match uu____7326 with
                  | (f,t1) ->
                      (match is_data with
                       | FStar_Pervasives_Native.Some
                           (FStar_Syntax_Syntax.Record_projector uu____7356)
                           ->
                           let rec remove_implicits args2 f1 t2 =
                             match (args2, t2) with
                             | ((a0,FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____7440))::args3,FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____7442,f',t3)) ->
                                 let uu____7479 =
                                   FStar_Extraction_ML_Util.join
                                     a0.FStar_Syntax_Syntax.pos f1 f'
                                    in
                                 remove_implicits args3 uu____7479 t3
                             | uu____7480 -> (args2, f1, t2)  in
                           let uu____7505 = remove_implicits args1 f t1  in
                   ...
                   in
                let extract_app_with_instantiations uu____7585 =
                  let head2 = FStar_Syntax_Util.un_uinst head1  in
                  match head2.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Tm_name uu____7593 ->
                      let uu____7594 =
                        let uu____7613 =
                          FStar_Extraction_ML_UEnv.lookup_term g head2  in
                        match uu____7613 with
                        | (FStar_Util.Inr (uu____7638,x1,x2,x3),q) ->
                            ((x1, x2, x3), q)
                        | uu____7679 -> failwith "FIXME Ty"  in
                      (match uu____7594 with
                       | ((head_ml,(vars,t1),inst_ok),qual) ->
                           let has_typ_apps =
                             match args with
                             | (a,uu____7743)::uu____7744 -> is_type g a
                             | uu____7771 -> false  in
                           let uu____7782 =
                             match vars with
                             | uu____7811::uu____7812 when
                                        ...
                                        let mk_tapp e ty_args =
                                          ...
                                          | uu____7989 ->
                                              let uu___347_7992 = e  in
                                              {
                                                ...
                                                FStar_Extraction_ML_Syntax.mlty
                                                  =
                                                  (uu___347_7992.FStar_Extraction_ML_Syntax.mlty);
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___347_7992.FStar_Extraction_ML_Syntax.loc)
                                              }
                                           in
                                        let head3 =
                                          ...
                                          | FStar_Extraction_ML_Syntax.MLE_Name
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___348_7997.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___348_7997.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_Var
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___348_7999.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___348_7999.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_App
                                              (head3,{
                                                       FStar_Extraction_ML_Syntax.expr
                                                ...
                                                (FStar_Extraction_ML_Syntax.MLE_App
                                                   ((let uu___349_8008 =
                                                        ...
                                                        in
                                                     {
                                                       FStar_Extraction_ML_Syntax.expr
                                                         =
                                                         (uu___349_8008.FStar_Extraction_ML_Syntax.expr);
                                                       FStar_Extraction_ML_Syntax.mlty
                                                         =
                                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                            (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                       ...
                                                       FStar_Extraction_ML_Syntax.loc
                                                         =
                                                         (uu___349_8008.FStar_Extraction_ML_Syntax.loc)
                                                     }),
                                                     [FStar_Extraction_ML_Syntax.ml_unit]))
                                                (FStar_Extraction_ML_Syntax.with_ty
                                                   t2)
                                ...
                                (match args1 with
                                 ...
                                 | uu____8073 ->
                                     extract_app_maybe_projector qual
                                       ...
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         head_t) args1)))
                  | FStar_Syntax_Syntax.Tm_fvar uu____8082 ->
                      let uu____8083 =
                        let uu____8102 =
                          FStar_Extraction_ML_UEnv.lookup_term g head2  in
                        match uu____8102 with
                        | (FStar_Util.Inr (uu____8127,x1,x2,x3),q) ->
                            ((x1, x2, x3), q)
                        | uu____8168 -> failwith "FIXME Ty"  in
                      (match uu____8083 with
                       | ((head_ml,(vars,t1),inst_ok),qual) ->
                           let has_typ_apps =
                             match args with
                             | (a,uu____8232)::uu____8233 -> is_type g a
                             | uu____8260 -> false  in
                           let uu____8271 =
                             match vars with
                             | uu____8300::uu____8301 when
                                 (Prims.op_Negation has_typ_apps) && inst_ok
                                 -> (head_ml, t1, args)
                             | uu____8312 ->
                                 let n1 = FStar_List.length vars  in
                                        ...
                                        let mk_tapp e ty_args =
                                          ...
                                          | uu____8478 ->
                                              let uu___347_8481 = e  in
                                              {
                                                ...
                                                FStar_Extraction_ML_Syntax.mlty
                                                  =
                                                  (uu___347_8481.FStar_Extraction_ML_Syntax.mlty);
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___347_8481.FStar_Extraction_ML_Syntax.loc)
                                              }
                                           in
                                        let head3 =
                                          match head_ml.FStar_Extraction_ML_Syntax.expr
                                          ...
                                          | FStar_Extraction_ML_Syntax.MLE_Name
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___348_8486.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___348_8486.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_Var
                                              uu____8487 ->
                                              let uu___348_8488 =
                                                 ...
                                                 in
                                              {
                                                FStar_Extraction_ML_Syntax.expr
                                                  =
                                                  (uu___348_8488.FStar_Extraction_ML_Syntax.expr);
                                                FStar_Extraction_ML_Syntax.mlty
                                                  = t2;
                                                FStar_Extraction_ML_Syntax.loc
                                                  =
                                                  (uu___348_8488.FStar_Extraction_ML_Syntax.loc)
                                              }
                                          | FStar_Extraction_ML_Syntax.MLE_App
                                              (head3,{
                                                       FStar_Extraction_ML_Syntax.expr
                                                ...
                                                (FStar_Extraction_ML_Syntax.MLE_App
                                                   ((let uu___349_8497 =
                                                        ...
                                                        in
                                                     {
                                                       FStar_Extraction_ML_Syntax.expr
                                                         =
                                                         (uu___349_8497.FStar_Extraction_ML_Syntax.expr);
                                                       FStar_Extraction_ML_Syntax.mlty
                                                         =
                                                         (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                            (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                       ...
                                                       FStar_Extraction_ML_Syntax.loc
                                                         =
                                                         (uu___349_8497.FStar_Extraction_ML_Syntax.loc)
                                                     }),
                                                     [FStar_Extraction_ML_Syntax.ml_unit]))
                                                (FStar_Extraction_ML_Syntax.with_ty
                                                   t2)
                                 ...
                                 | uu____8562 ->
                                     extract_app_maybe_projector qual
                                       ...
                                       (FStar_Extraction_ML_Syntax.E_PURE,
                                         head_t) args1)))
                  | uu____8571 ->
                      let uu____8572 = term_as_mlexpr g head2  in
                      (match uu____8572 with
                       | (head3,f,t1) ->
                           extract_app_maybe_projector
                             FStar_Pervasives_Native.None head3 (f, t1) args)
                   in
                let uu____8588 = is_type g t  in
                if uu____8588
                then
                  (FStar_Extraction_ML_Syntax.ml_unit,
                    FStar_Extraction_ML_Syntax.E_PURE,
                  ...
                  (let uu____8596 =
                     let uu____8597 = FStar_Syntax_Util.un_uinst head1  in
                     uu____8597.FStar_Syntax_Syntax.n  in
                       ...
                       (match uu____8607 with
                        | FStar_Pervasives_Native.None  ->
                            (FStar_Extraction_ML_Syntax.ml_unit,
                              FStar_Extraction_ML_Syntax.E_PURE,
                              FStar_Extraction_ML_Syntax.MLTY_Erased)
                        | uu____8616 -> extract_app_with_instantiations ())
                   | uu____8619 -> extract_app_with_instantiations ()))
       | FStar_Syntax_Syntax.Tm_ascribed (e0,(tc,uu____8622),f) ->
           let t1 =
             match tc with
           ...
           let uu____8689 = check_term_as_mlexpr g e0 f1 t1  in
           (match uu____8689 with | (e,t2) -> (e, f1, t2))
       | FStar_Syntax_Syntax.Tm_let ((is_rec,lbs),e') ->
           ...
           let uu____8720 =
             ...
             then FStar_Syntax_Subst.open_let_rec lbs e'
               ...
               (let uu____8734 = FStar_Syntax_Syntax.is_top_level lbs  in
                if uu____8734
                then (lbs, e')
                else
                  (let lb = FStar_List.hd lbs  in
                   let x =
                     ...
                     FStar_Syntax_Syntax.freshen_bv uu____8746  in
                   let lb1 =
                     let uu___350_8748 = lb  in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___350_8748.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___350_8748.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___350_8748.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___350_8748.FStar_Syntax_Syntax.lbdef);
                       FStar_Syntax_Syntax.lbattrs =
                         (uu___350_8748.FStar_Syntax_Syntax.lbattrs);
                       FStar_Syntax_Syntax.lbpos =
                         (uu___350_8748.FStar_Syntax_Syntax.lbpos)
                     }  in
                   let e'1 =
            ...
            | (lbs1,e'1) ->
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8779
                               in
                            let lbdef =
                              let uu____8787 = FStar_Options.ml_ish ()  in
                              if uu____8787
                              then lb.FStar_Syntax_Syntax.lbdef
                               ...
                               in
                            let uu___351_8791 = lb  in
                            {
                              FStar_Syntax_Syntax.lbname =
                                (uu___351_8791.FStar_Syntax_Syntax.lbname);
                              FStar_Syntax_Syntax.lbunivs =
                                (uu___351_8791.FStar_Syntax_Syntax.lbunivs);
                              FStar_Syntax_Syntax.lbtyp =
                                (uu___351_8791.FStar_Syntax_Syntax.lbtyp);
                              FStar_Syntax_Syntax.lbeff =
                                (uu___351_8791.FStar_Syntax_Syntax.lbeff);
                              FStar_Syntax_Syntax.lbdef = lbdef;
                              FStar_Syntax_Syntax.lbattrs =
                                (uu___351_8791.FStar_Syntax_Syntax.lbattrs);
                              FStar_Syntax_Syntax.lbpos =
                                (uu___351_8791.FStar_Syntax_Syntax.lbpos)
                            }))
                  else lbs1  in
                let maybe_generalize uu____8816 =
                  match uu____8816 with
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      FStar_Syntax_Syntax.lbunivs = uu____8836;
                      FStar_Syntax_Syntax.lbtyp = t1;
                      FStar_Syntax_Syntax.lbeff = lbeff;
                      FStar_Syntax_Syntax.lbdef = e;
                      FStar_Syntax_Syntax.lbattrs = uu____8840;
                      FStar_Syntax_Syntax.lbpos = uu____8841;_} ->
                      let f_e = effect_as_etag g lbeff  in
                      let t2 = FStar_Syntax_Subst.compress t1  in
                      let no_gen uu____8919 =
                      ...
                      then
                        ...
                        (match t2.FStar_Syntax_Syntax.n with
                         | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                             let uu____9067 = FStar_List.hd bs  in
                             FStar_All.pipe_right uu____9067
                               (is_type_binder g)
                             ->
                             let uu____9088 =
                              ...
                              | (bs1,c1) ->
                                    ...
                                    let uu____9126 =
                                      FStar_Util.prefix_until
                                        (fun x  ->
                                           ...
                                           Prims.op_Negation uu____9172) bs1
                                       in
                                  ...
                                  (match uu____9113 with
                                   | (tbinders,tbody) ->
                                       ...
                                       let e1 =
                                         let uu____9359 = normalize_abs e  in
                                         FStar_All.pipe_right uu____9359
                  ...
                  FStar_List.fold_right
                    (fun lb  ->
                       fun uu____10643  ->
                         ...
                         | (env,lbs4) ->
                             let uu____10808 = lb  in
                             (match uu____10808 with
                              | (lbname,uu____10872,(t1,(uu____10874,polytype)),add_unit,uu____10877)
                                  ->
                                  let uu____10922 =
                ...
                (match uu____10528 with
                 | (env_body,lbs4) ->
                     ...
                     let uu____11277 = term_as_mlexpr env_body e'1  in
                              ...
                              let uu____11308 =
                                let uu____11309 =
                                  FStar_List.map FStar_Pervasives_Native.snd
                                    lbs5
                                   in
                                (is_rec1, uu____11309)  in
                              mk_MLE_Let top_level uu____11308 e'2  in
                            let uu____11318 =
                              FStar_Extraction_ML_Util.mlloc_of_range
                                t.FStar_Syntax_Syntax.pos
                               in
                            FStar_Extraction_ML_Syntax.with_ty_loc t'
                              uu____11307 uu____11318
                             in
                          (uu____11306, f, t'))))
       | FStar_Syntax_Syntax.Tm_match (scrutinee,pats) ->
           let uu____11357 = term_as_mlexpr g scrutinee  in
           (match uu____11357 with
            | (e,f_e,t_e) ->
                let uu____11373 = check_pats_for_ite pats  in
                       ...
                       (match (then_e, else_e) with
                        | (FStar_Pervasives_Native.Some
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            let uu____11434 = term_as_mlexpr g then_e1  in
                            (match uu____11434 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____11450 = term_as_mlexpr g else_e1
                                    in
                            ...
                            (match mlbranches1 with
                             | [] ->
                                 ...
                                 (match uu____12146 with
                                  | (uu____12215,fw,uu____12217,uu____12218)
                                      ->
                                      let uu____12219 =
                                        let uu____12220 =
                                          let uu____12221 =
                                      ...
                                      (uu____12219,
                                        FStar_Extraction_ML_Syntax.E_PURE,
                                        FStar_Extraction_ML_Syntax.ml_int_ty))
                             | (uu____12234,uu____12235,(uu____12236,f_first,t_first))::rest
                                 ->
                                 let uu____12296 =
                                   FStar_List.fold_left
                                     (fun uu____12338  ->
                                        fun uu____12339  ->
                                          match (uu____12338, uu____12339)
                                          with
                                          | ((topt,f),(uu____12396,uu____12397,
                                                       (uu____12398,f_branch,t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
        ...
        let uu____12634 =
          let uu____12639 =
            FStar_TypeChecker_Env.lookup_lid
             ...
             in
          FStar_All.pipe_left FStar_Pervasives_Native.fst uu____12639  in
        match uu____12634 with
        | (uu____12664,fstar_disc_type) ->
            let wildcards =
              let uu____12673 =
                let uu____12674 = FStar_Syntax_Subst.compress fstar_disc_type
                   in
                uu____12674.FStar_Syntax_Syntax.n  in
              match uu____12673 with
              | FStar_Syntax_Syntax.Tm_arrow (binders,uu____12684) ->
                  let uu____12705 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___344_12739  ->
                            match uu___344_12739 with
                            | (uu____12746,FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____12747)) ->
                                true
                            | uu____12750 -> false))
                     in
                  FStar_All.pipe_right uu____12705
                    (FStar_List.map
                       (fun uu____12783  ->
                          let uu____12790 = fresh "_"  in
                          (uu____12790, FStar_Extraction_ML_Syntax.MLTY_Top)))
              | uu____12791 -> failwith "Discriminator must be a function"
               in
                            ...
                            let uu____12854 =
                              let uu____12855 =
                                ...
                                (uu____12862,
                                 ...
                                 in
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____12855
                               in
                            let uu____12865 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                            ...
                            let uu____12879 =
                              let uu____12888 =
                                FStar_All.pipe_left
                                 ...
                                 in
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____12888)
                               in
                            [uu____12879]  in
                          uu____12845 :: uu____12868  in
                        (uu____12831, uu____12834)  in
                      FStar_Extraction_ML_Syntax.MLE_Match uu____12816  in
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____12815
                     in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____12814)
                   in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____12803  in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____12802
               in
            let uu____12943 =
              let uu____12944 =
                let uu____12947 =
                  let uu____12948 =
                    FStar_Extraction_ML_UEnv.convIdent
                     ...
                     in
                  {
                    FStar_Extraction_ML_Syntax.mllb_name = uu____12948;
                    FStar_Extraction_ML_Syntax.mllb_tysc =
                      FStar_Pervasives_Native.None;
                ...
                [uu____12947]  in
              (FStar_Extraction_ML_Syntax.NonRec, uu____12944)  in
            FStar_Extraction_ML_Syntax.MLM_Let uu____12943
