...
let kind_star = (fun ( r ) -> (let _65_18667 = (let _65_18666 = (Microsoft_FStar_Absyn_Syntax.lid_of_path (("Type")::[]) r)
in Microsoft_FStar_Parser_AST.Name (_65_18666))
in (Microsoft_FStar_Parser_AST.mk_term _65_18667 r Microsoft_FStar_Parser_AST.Kind)))
...
| false -> begin
(let _65_18678 = (let _65_18676 = (Support.Microsoft.FStar.Util.char_at s i)
in (name_of_char _65_18676))
in (let _65_18677 = (aux (i + 1))
in (_65_18678)::_65_18677))
end))
in (let _65_18680 = (let _65_18679 = (aux 0)
in (Support.String.concat "_" _65_18679))
in (Support.String.strcat "op_" _65_18680)))))

let compile_op_lid = (fun ( n ) ( s ) ( r ) -> (let _65_18690 = (let _65_18689 = (let _65_18688 = (let _65_18687 = (compile_op n s)
in (_65_18687, r))
in (Microsoft_FStar_Absyn_Syntax.mk_ident _65_18688))
in (_65_18689)::[])
in (Support.Prims.pipe_right _65_18690 Microsoft_FStar_Absyn_Syntax.lid_of_ids)))

let op_as_vlid = (fun ( env ) ( arity ) ( rng ) ( s ) -> (let r = (fun ( l ) -> (let _65_18701 = (Microsoft_FStar_Absyn_Util.set_lid_range l rng)
in Some (_65_18701)))
...
in (match ((let _65_18704 = (compile_op_lid arity s rng)
in (Microsoft_FStar_Parser_DesugarEnv.try_lookup_lid env _65_18704))) with
...
let op_as_tylid = (fun ( env ) ( arity ) ( rng ) ( s ) -> (let r = (fun ( l ) -> (let _65_18715 = (Microsoft_FStar_Absyn_Util.set_lid_range l rng)
in Some (_65_18715)))
in (match (s) with
| "~" -> begin
...
| s -> begin
(match ((let _65_18716 = (compile_op_lid arity s rng)
in (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env _65_18716))) with
...
| false -> begin
(match ((let _65_18723 = (unparen t)
in _65_18723.Microsoft_FStar_Parser_AST.tm)) with
...
(let _65_18728 = (Microsoft_FStar_Parser_DesugarEnv.push_local_tbinding env id)
in (Support.Prims.pipe_right _65_18728 Support.Prims.fst))
end
| _ -> begin
env
end)
...
| false -> begin
(match ((let _65_18731 = (unparen t)
in _65_18731.Microsoft_FStar_Parser_AST.tm)) with
...
let sort_ftv = (fun ( ftv ) -> (let _65_18742 = (Support.Microsoft.FStar.Util.remove_dups (fun ( x ) ( y ) -> (x.Microsoft_FStar_Absyn_Syntax.idText = y.Microsoft_FStar_Absyn_Syntax.idText)) ftv)
in (Support.Prims.pipe_left (Support.Microsoft.FStar.Util.sort_with (fun ( x ) ( y ) -> (Support.String.compare x.Microsoft_FStar_Absyn_Syntax.idText y.Microsoft_FStar_Absyn_Syntax.idText))) _65_18742)))
...
(let _65_18749 = (free_type_vars env term)
in (env, _65_18749))
end
...
(let _65_18750 = (free_type_vars env t)
in (env, _65_18750))
end))
and free_type_vars = (fun ( env ) ( t ) -> (match ((let _65_18753 = (unparen t)
in _65_18753.Microsoft_FStar_Parser_AST.tm)) with
...
(let _65_18756 = (free_type_vars env t1)
in (let _65_18755 = (free_type_vars env t2)
in (Support.List.append _65_18756 _65_18755)))
end
| Microsoft_FStar_Parser_AST.Refine ((b, t)) -> begin
(let _41_505 = (free_type_vars_b env b)
in (match (_41_505) with
| (env, f) -> begin
(let _65_18757 = (free_type_vars env t)
in (Support.List.append f _65_18757))
end))
end
...
| (env, free) -> begin
(let _65_18760 = (free_type_vars env body)
in (Support.List.append free _65_18760))
end))
end
...
let head_and_args = (fun ( t ) -> (let rec aux = (fun ( args ) ( t ) -> (match ((let _65_18767 = (unparen t)
in _65_18767.Microsoft_FStar_Parser_AST.tm)) with
...
let close = (fun ( env ) ( t ) -> (let ftv = (let _65_18772 = (free_type_vars env t)
in (Support.Prims.pipe_left sort_ftv _65_18772))
in (match (((Support.List.length ftv) = 0)) with
| true -> begin
t
end
| false -> begin
(let binders = (Support.Prims.pipe_right ftv (Support.List.map (fun ( x ) -> (let _65_18776 = (let _65_18775 = (let _65_18774 = (kind_star x.Microsoft_FStar_Absyn_Syntax.idRange)
in (x, _65_18774))
in Microsoft_FStar_Parser_AST.TAnnotated (_65_18775))
in (Microsoft_FStar_Parser_AST.mk_binder _65_18776 x.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Type (Some (Microsoft_FStar_Absyn_Syntax.Implicit)))))))
...
let close_fun = (fun ( env ) ( t ) -> (let ftv = (let _65_18781 = (free_type_vars env t)
in (Support.Prims.pipe_left sort_ftv _65_18781))
in (match (((Support.List.length ftv) = 0)) with
| true -> begin
t
end
| false -> begin
(let binders = (Support.Prims.pipe_right ftv (Support.List.map (fun ( x ) -> (let _65_18785 = (let _65_18784 = (let _65_18783 = (kind_star x.Microsoft_FStar_Absyn_Syntax.idRange)
in (x, _65_18783))
in Microsoft_FStar_Parser_AST.TAnnotated (_65_18784))
in (Microsoft_FStar_Parser_AST.mk_binder _65_18785 x.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Type (Some (Microsoft_FStar_Absyn_Syntax.Implicit)))))))
in (let t = (match ((let _65_18786 = (unlabel t)
in _65_18786.Microsoft_FStar_Parser_AST.tm)) with
...
(let _65_18800 = (let _65_18799 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in Support.Microsoft.FStar.Util.Inr (_65_18799))
in (_65_18800, args, None))
end
...
(let _65_18830 = (Microsoft_FStar_Absyn_Syntax.null_t_binder k)
in (_65_18830, env))
end
| Support.Microsoft.FStar.Util.Inr ((None, t)) -> begin
(let _65_18831 = (Microsoft_FStar_Absyn_Syntax.null_v_binder t)
in (_65_18831, env))
end
...
| _ -> begin
(let _65_18842 = (Support.Microsoft.FStar.Range.string_of_range f.Microsoft_FStar_Parser_AST.range)
in (Support.Microsoft.FStar.Util.format2 "%s at %s" tag _65_18842))
end)
...
(let _65_18846 = (let _65_18845 = (aux g)
in Microsoft_FStar_Parser_AST.Paren (_65_18845))
...
(let _65_18852 = (let _65_18851 = (let _65_18850 = (let _65_18849 = (aux f1)
in (let _65_18848 = (let _65_18847 = (aux f2)
in (_65_18847)::[])
in (_65_18849)::_65_18848))
in ("/\\", _65_18850))
in Microsoft_FStar_Parser_AST.Op (_65_18851))
in (Microsoft_FStar_Parser_AST.mk_term _65_18852 f.Microsoft_FStar_Parser_AST.range f.Microsoft_FStar_Parser_AST.level))
end
| Microsoft_FStar_Parser_AST.If ((f1, f2, f3)) -> begin
(let _65_18856 = (let _65_18855 = (let _65_18854 = (aux f2)
in (let _65_18853 = (aux f3)
in (f1, _65_18854, _65_18853)))
in Microsoft_FStar_Parser_AST.If (_65_18855))
in (Microsoft_FStar_Parser_AST.mk_term _65_18856 f.Microsoft_FStar_Parser_AST.range f.Microsoft_FStar_Parser_AST.level))
end
| Microsoft_FStar_Parser_AST.Abs ((binders, g)) -> begin
(let _65_18859 = (let _65_18858 = (let _65_18857 = (aux g)
in (binders, _65_18857))
in Microsoft_FStar_Parser_AST.Abs (_65_18858))
in (Microsoft_FStar_Parser_AST.mk_term _65_18859 f.Microsoft_FStar_Parser_AST.range f.Microsoft_FStar_Parser_AST.level))
end
| _ -> begin
(label f)
end))
...
in (let _41_803 = (let _65_18931 = (Microsoft_FStar_Absyn_Syntax.pat_vars pat)
in (Support.Prims.ignore _65_18931))
in (loc, env, var, pat)))
end))
end))
end
...
(let _65_18933 = (let _65_18932 = (desugar_kind env t)
in (x, _65_18932, aq))
in TBinder (_65_18933))
end
| VBinder ((x, _, aq)) -> begin
(let t = (close_fun env t)
in (let _65_18935 = (let _65_18934 = (desugar_typ env t)
in (x, _65_18934, aq))
in VBinder (_65_18935)))
end)
in (loc, env', binder, p))
end)))
end
...
in (let _65_18936 = (Support.Prims.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_twild ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a Microsoft_FStar_Absyn_Syntax.kun))))
in (loc, env, TBinder ((a, Microsoft_FStar_Absyn_Syntax.kun, aq)), _65_18936)))
end
| false -> begin
(let _41_852 = (resolvea loc env a)
in (match (_41_852) with
| (loc, env, abvd) -> begin
(let _65_18937 = (Support.Prims.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_tvar ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s abvd Microsoft_FStar_Absyn_Syntax.kun))))
in (loc, env, TBinder ((abvd, Microsoft_FStar_Absyn_Syntax.kun, aq)), _65_18937))
end))
end))
end
...
in (let _65_18938 = (Support.Prims.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_wild ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s y Microsoft_FStar_Absyn_Syntax.tun))))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), _65_18938))))
end
| Microsoft_FStar_Parser_AST.PatConst (c) -> begin
(let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (let _65_18939 = (Support.Prims.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_constant (c)))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), _65_18939)))
end
| Microsoft_FStar_Parser_AST.PatVar ((x, imp)) -> begin
(let aq = (match (imp) with
| true -> begin
...
| (loc, env, xbvd) -> begin
(let _65_18940 = (Support.Prims.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_var (((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s xbvd Microsoft_FStar_Absyn_Syntax.tun), imp))))
in (loc, env, VBinder ((xbvd, Microsoft_FStar_Absyn_Syntax.tun, aq)), _65_18940))
end)))
end
...
in (let _65_18941 = (Support.Prims.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_cons ((l, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), []))))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), _65_18941))))
end
...
(let l = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_datacon env) l)
in (let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (let _65_18944 = (Support.Prims.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_cons ((l, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), args))))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), _65_18944))))
end))
end
...
| (loc, env, pats) -> begin
(let pat = (let _65_18957 = (let _65_18956 = (let _65_18952 = (Support.Microsoft.FStar.Range.end_range p.Microsoft_FStar_Parser_AST.prange)
in (pos_r _65_18952))
in (let _65_18955 = (let _65_18954 = (let _65_18953 = (Microsoft_FStar_Absyn_Util.fv Microsoft_FStar_Absyn_Const.nil_lid)
in (_65_18953, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), []))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_65_18954))
in (Support.Prims.pipe_left _65_18956 _65_18955)))
...
in (let _65_18951 = (let _65_18950 = (let _65_18949 = (Microsoft_FStar_Absyn_Util.fv Microsoft_FStar_Absyn_Const.cons_lid)
in (_65_18949, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), (hd)::(tl)::[]))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_65_18950))
in (Support.Prims.pipe_left (pos_r r) _65_18951)))) pats _65_18957))
in (let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
...
in (let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (let _65_18960 = (Support.Prims.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_cons ((l, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), args))))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), _65_18960)))))))
end))
end
...
| (f, p) -> begin
(let _65_18962 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.qualify_field_to_record env record) f)
in (_65_18962, p))
end))))
...
(let _65_18970 = (let _65_18969 = (let _65_18968 = (let _65_18967 = (let _65_18966 = (let _65_18965 = (Support.Prims.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Support.List.map Support.Prims.fst))
in (record.Microsoft_FStar_Parser_DesugarEnv.typename, _65_18965))
in Microsoft_FStar_Absyn_Syntax.Record_ctor (_65_18966))
in Some (_65_18967))
in (fv, _65_18968, args))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_65_18969))
in (Support.Prims.pipe_left pos _65_18970))
end
| _ -> begin
p
end)
...
(let _65_18976 = (let _65_18975 = (let _65_18974 = (Microsoft_FStar_Parser_DesugarEnv.qualify env x)
in (_65_18974, Microsoft_FStar_Absyn_Syntax.tun))
in LetBinder (_65_18975))
in (env, _65_18976, None))
end
...
(let _65_18980 = (let _65_18979 = (let _65_18978 = (Microsoft_FStar_Parser_DesugarEnv.qualify env x)
in (let _65_18977 = (desugar_typ env t)
in (_65_18978, _65_18977)))
in LetBinder (_65_18979))
in (env, _65_18980, None))
end
| _ -> begin
...
| true -> begin
(let _65_18990 = (desugar_typ env t)
in Support.Microsoft.FStar.Util.Inl (_65_18990))
end
| false -> begin
(let _65_18991 = (desugar_exp env t)
in Support.Microsoft.FStar.Util.Inr (_65_18991))
end))
...
in (match ((let _65_19011 = (unparen top)
in _65_19011.Microsoft_FStar_Parser_AST.tm)) with
...
| Some (l) -> begin
(let op = (let _65_19014 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (Microsoft_FStar_Absyn_Util.fvar None l _65_19014))
in (let args = (Support.Prims.pipe_right args (Support.List.map (fun ( t ) -> (let _65_19016 = (desugar_typ_or_exp env t)
in (_65_19016, None)))))
in (let _65_19017 = (Microsoft_FStar_Absyn_Util.mk_exp_app op args)
in (Support.Prims.pipe_left setpos _65_19017))))
end)
end
...
| None -> begin
(let _65_19020 = (let _65_19019 = (let _65_19018 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in ("Identifier \'ref\' not found; include lib/st.fst in your path", _65_19018))
in Microsoft_FStar_Absyn_Syntax.Error (_65_19019))
in (raise (_65_19020)))
end
| Some (e) -> begin
(setpos e)
...
| false -> begin
(let _65_19021 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_lid env) l)
in (Support.Prims.pipe_left setpos _65_19021))
end)
end
| Microsoft_FStar_Parser_AST.Construct ((l, args)) -> begin
(let dt = (let _65_19026 = (let _65_19025 = (let _65_19024 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_datacon env) l)
in (_65_19024, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_fvar _65_19025))
in (Support.Prims.pipe_left pos _65_19026))
in (match (args) with
| [] -> begin
dt
end
...
in (let _65_19031 = (let _65_19030 = (let _65_19029 = (let _65_19028 = (Microsoft_FStar_Absyn_Util.mk_exp_app dt args)
in (_65_19028, Microsoft_FStar_Absyn_Syntax.Data_app))
in Microsoft_FStar_Absyn_Syntax.Meta_desugared (_65_19029))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta _65_19030))
in (Support.Prims.pipe_left setpos _65_19031)))
end))
end
...
(let ftvs = (let _65_19034 = (free_type_vars env t)
in (Support.List.append _65_19034 ftvs))
in (let _65_19036 = (let _65_19035 = (Microsoft_FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (Support.Prims.pipe_left Support.Prims.fst _65_19035))
in (_65_19036, ftvs)))
end
| Microsoft_FStar_Parser_AST.PatTvar ((a, _)) -> begin
(let _65_19038 = (let _65_19037 = (Microsoft_FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (Support.Prims.pipe_left Support.Prims.fst _65_19037))
in (_65_19038, ftvs))
end
| Microsoft_FStar_Parser_AST.PatAscribed ((_, t)) -> begin
(let _65_19040 = (let _65_19039 = (free_type_vars env t)
in (Support.List.append _65_19039 ftvs))
in (env, _65_19040))
end
| _ -> begin
(env, ftvs)
...
in (let binders = (let _65_19042 = (Support.Prims.pipe_right ftv (Support.List.map (fun ( a ) -> (Microsoft_FStar_Parser_AST.mk_pattern (Microsoft_FStar_Parser_AST.PatTvar ((a, true))) top.Microsoft_FStar_Parser_AST.range))))
in (Support.List.append _65_19042 binders))
...
| TBinder ((a, k, aq)) -> begin
(let _65_19051 = (binder_of_bnd b)
in (_65_19051, sc_pat_opt))
end
| VBinder ((x, t, aq)) -> begin
...
| (Some (p), None) -> begin
(let _65_19053 = (let _65_19052 = (Microsoft_FStar_Absyn_Util.bvar_to_exp b)
in (_65_19052, p))
in Some (_65_19053))
end
...
in (let sc = (let _65_19060 = (let _65_19059 = (Microsoft_FStar_Absyn_Util.fvar (Some (Microsoft_FStar_Absyn_Syntax.Data_ctor)) tup top.Microsoft_FStar_Parser_AST.range)
in (let _65_19058 = (let _65_19057 = (Microsoft_FStar_Absyn_Syntax.varg sc)
in (let _65_19056 = (let _65_19055 = (let _65_19054 = (Microsoft_FStar_Absyn_Util.bvar_to_exp b)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.varg _65_19054))
in (_65_19055)::[])
in (_65_19057)::_65_19056))
in (_65_19059, _65_19058)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _65_19060 None top.Microsoft_FStar_Parser_AST.range))
in (let p = (let _65_19064 = (let _65_19062 = (let _65_19061 = (Microsoft_FStar_Absyn_Util.fv tup)
in (_65_19061, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), (p')::(p)::[]))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_65_19062))
in (let _65_19063 = (Support.Microsoft.FStar.Range.union_ranges p'.Microsoft_FStar_Absyn_Syntax.p p.Microsoft_FStar_Absyn_Syntax.p)
in (Microsoft_FStar_Absyn_Util.withinfo _65_19064 None _65_19063)))
in Some ((sc, p)))))
end
...
in (let sc = (let _65_19070 = (let _65_19069 = (Microsoft_FStar_Absyn_Util.fvar (Some (Microsoft_FStar_Absyn_Syntax.Data_ctor)) tup top.Microsoft_FStar_Parser_AST.range)
in (let _65_19068 = (let _65_19067 = (let _65_19066 = (let _65_19065 = (Microsoft_FStar_Absyn_Util.bvar_to_exp b)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.varg _65_19065))
in (_65_19066)::[])
in (Support.List.append args _65_19067))
in (_65_19069, _65_19068)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _65_19070 None top.Microsoft_FStar_Parser_AST.range))
in (let p = (let _65_19074 = (let _65_19072 = (let _65_19071 = (Microsoft_FStar_Absyn_Util.fv tup)
in (_65_19071, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), (Support.List.append pats ((p)::[]))))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_65_19072))
in (let _65_19073 = (Support.Microsoft.FStar.Range.union_ranges p'.Microsoft_FStar_Absyn_Syntax.p p.Microsoft_FStar_Absyn_Syntax.p)
in (Microsoft_FStar_Absyn_Util.withinfo _65_19074 None _65_19073)))
in Some ((sc, p)))))
end
| _ -> begin
(failwith ("Impossible"))
...
in (let _65_19085 = (let _65_19084 = (let _65_19083 = (let _65_19077 = (Microsoft_FStar_Absyn_Syntax.range_of_lid a)
in (Microsoft_FStar_Absyn_Util.fvar None a _65_19077))
in (let _65_19082 = (let _65_19081 = (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.targ phi)
in (let _65_19080 = (let _65_19079 = (let _65_19078 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant Microsoft_FStar_Absyn_Syntax.Const_unit None top.Microsoft_FStar_Parser_AST.range)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.varg _65_19078))
in (_65_19079)::[])
in (_65_19081)::_65_19080))
in (_65_19083, _65_19082)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _65_19084))
in (Support.Prims.pipe_left pos _65_19085)))
end
| Microsoft_FStar_Parser_AST.App (_) -> begin
(let rec aux = (fun ( args ) ( e ) -> (match ((let _65_19090 = (unparen e)
in _65_19090.Microsoft_FStar_Parser_AST.tm)) with
| Microsoft_FStar_Parser_AST.App ((e, t, imp)) -> begin
(let arg = (let _65_19091 = (desugar_typ_or_exp env t)
in (Support.Prims.pipe_left (arg_withimp_e imp) _65_19091))
in (aux ((arg)::args) e))
end
| _ -> begin
...
(let _65_19097 = (let _65_19096 = (let _65_19095 = (let _65_19094 = (desugar_exp env (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Let ((false, (((Microsoft_FStar_Parser_AST.mk_pattern Microsoft_FStar_Parser_AST.PatWild t1.Microsoft_FStar_Parser_AST.range), t1))::[], t2))) top.Microsoft_FStar_Parser_AST.range Microsoft_FStar_Parser_AST.Expr))
in (_65_19094, Microsoft_FStar_Absyn_Syntax.Sequence))
in Microsoft_FStar_Absyn_Syntax.Meta_desugared (_65_19095))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta _65_19096))
in (Support.Prims.pipe_left setpos _65_19097))
end
...
| Some ((p, def)) -> begin
(let _65_19102 = (destruct_app_pattern env top_level p)
in (_65_19102, def))
end
| _ -> begin
(match (p.Microsoft_FStar_Parser_AST.pat) with
...
| true -> begin
(let _65_19105 = (let _65_19104 = (let _65_19103 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in Support.Microsoft.FStar.Util.Inr (_65_19103))
in (_65_19104, [], Some (t)))
in (_65_19105, def))
end
| false -> begin
...
(match (top_level) with
| true -> begin
(let _65_19108 = (let _65_19107 = (let _65_19106 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in Support.Microsoft.FStar.Util.Inr (_65_19106))
in (_65_19107, [], None))
in (_65_19108, def))
end
| false -> begin
...
(let _65_19111 = (Microsoft_FStar_Parser_DesugarEnv.push_rec_binding env (Microsoft_FStar_Parser_DesugarEnv.Binding_let (l)))
in (_65_19111, Support.Microsoft.FStar.Util.Inr (l)))
end)
...
| Some (t) -> begin
(let _65_19118 = (Support.Microsoft.FStar.Range.union_ranges t.Microsoft_FStar_Parser_AST.range def.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Ascribed ((def, t))) _65_19118 Microsoft_FStar_Parser_AST.Expr))
end)
...
| Some (pat) -> begin
(let _65_19130 = (let _65_19129 = (Microsoft_FStar_Absyn_Util.bvd_to_exp x t)
in (_65_19129, ((pat, None, body))::[]))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_match _65_19130 None body.Microsoft_FStar_Absyn_Syntax.pos))
end)
...
(let _65_19143 = (let _65_19142 = (let _65_19141 = (desugar_exp env t1)
in (let _65_19140 = (let _65_19139 = (let _65_19135 = (desugar_exp env t2)
in ((Microsoft_FStar_Absyn_Util.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_constant (Microsoft_FStar_Absyn_Syntax.Const_bool (true))) None t2.Microsoft_FStar_Parser_AST.range), None, _65_19135))
in (let _65_19138 = (let _65_19137 = (let _65_19136 = (desugar_exp env t3)
in ((Microsoft_FStar_Absyn_Util.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_constant (Microsoft_FStar_Absyn_Syntax.Const_bool (false))) None t3.Microsoft_FStar_Parser_AST.range), None, _65_19136))
in (_65_19137)::[])
in (_65_19139)::_65_19138))
in (_65_19141, _65_19140)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_match _65_19142))
in (Support.Prims.pipe_left pos _65_19143))
end
...
| Some (e) -> begin
(let _65_19146 = (desugar_exp env e)
in Some (_65_19146))
end)
...
in (let _65_19152 = (let _65_19151 = (let _65_19150 = (desugar_exp env e)
in (let _65_19149 = (Support.List.map desugar_branch branches)
in (_65_19150, _65_19149)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_match _65_19151))
in (Support.Prims.pipe_left pos _65_19152)))
end
| Microsoft_FStar_Parser_AST.Ascribed ((e, t)) -> begin
(let _65_19158 = (let _65_19157 = (let _65_19156 = (desugar_exp env e)
in (let _65_19155 = (desugar_typ env t)
in (_65_19156, _65_19155, None)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed _65_19157))
in (Support.Prims.pipe_left pos _65_19158))
end
...
in (match (found) with
| Some ((_, e)) -> begin
(let _65_19166 = (qfn fn)
in (_65_19166, e))
end
| None -> begin
(match (xopt) with
| None -> begin
(let _65_19170 = (let _65_19169 = (let _65_19168 = (let _65_19167 = (Microsoft_FStar_Absyn_Syntax.text_of_lid f)
in (Support.Microsoft.FStar.Util.format1 "Field %s is missing" _65_19167))
in (_65_19168, top.Microsoft_FStar_Parser_AST.range))
in Microsoft_FStar_Absyn_Syntax.Error (_65_19169))
in (raise (_65_19170)))
end
| Some (x) -> begin
(let _65_19171 = (qfn fn)
in (_65_19171, (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Project ((x, f))) x.Microsoft_FStar_Parser_AST.range x.Microsoft_FStar_Parser_AST.level)))
end)
end))))
in (let recterm = (match (eopt) with
| None -> begin
(let _65_19176 = (let _65_19175 = (Support.Prims.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Support.List.map (fun ( _41_1450 ) -> (match (_41_1450) with
| (f, _) -> begin
(let _65_19174 = (let _65_19173 = (get_field None f)
in (Support.Prims.pipe_left Support.Prims.snd _65_19173))
in (_65_19174, Microsoft_FStar_Parser_AST.Nothing))
end))))
in (record.Microsoft_FStar_Parser_DesugarEnv.constrname, _65_19175))
in Microsoft_FStar_Parser_AST.Construct (_65_19176))
end
| Some (e) -> begin
(let x = (Microsoft_FStar_Absyn_Util.genident (Some (e.Microsoft_FStar_Parser_AST.range)))
in (let xterm = (let _65_19178 = (let _65_19177 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((x)::[]))
in Microsoft_FStar_Parser_AST.Var (_65_19177))
in (Microsoft_FStar_Parser_AST.mk_term _65_19178 x.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Expr))
in (let record = (let _65_19181 = (let _65_19180 = (Support.Prims.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Support.List.map (fun ( _41_1458 ) -> (match (_41_1458) with
| (f, _) -> begin
(get_field (Some (xterm)) f)
end))))
in (None, _65_19180))
in Microsoft_FStar_Parser_AST.Record (_65_19181))
...
(let e = (let _65_19191 = (let _65_19190 = (let _65_19189 = (let _65_19188 = (let _65_19187 = (let _65_19186 = (let _65_19185 = (let _65_19184 = (Support.Prims.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Support.List.map Support.Prims.fst))
in (record.Microsoft_FStar_Parser_DesugarEnv.typename, _65_19184))
in Microsoft_FStar_Absyn_Syntax.Record_ctor (_65_19185))
in Some (_65_19186))
in (fv, _65_19187))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_fvar _65_19188 None e.Microsoft_FStar_Absyn_Syntax.pos))
in (_65_19189, args))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _65_19190))
in (Support.Prims.pipe_left pos _65_19191))
...
in (let _65_19199 = (let _65_19198 = (let _65_19197 = (let _65_19194 = (Microsoft_FStar_Absyn_Syntax.range_of_lid f)
in (Microsoft_FStar_Absyn_Util.fvar (Some (Microsoft_FStar_Absyn_Syntax.Record_projector (fn))) fieldname _65_19194))
in (let _65_19196 = (let _65_19195 = (Microsoft_FStar_Absyn_Syntax.varg e)
in (_65_19195)::[])
in (_65_19197, _65_19196)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _65_19198))
in (Support.Prims.pipe_left pos _65_19199))))
end))
end
...
in (let head_and_args = (fun ( t ) -> (let rec aux = (fun ( args ) ( t ) -> (match ((let _65_19222 = (unparen t)
in _65_19222.Microsoft_FStar_Parser_AST.tm)) with
| Microsoft_FStar_Parser_AST.App ((t, arg, imp)) -> begin
(aux (((arg, imp))::args) t)
end
| Microsoft_FStar_Parser_AST.Construct ((l, args')) -> begin
...
| false -> begin
(let _65_19224 = (desugar_exp env t)
in (Support.Prims.pipe_right _65_19224 Microsoft_FStar_Absyn_Util.b2t))
end))
end
...
in (let targs = (let _65_19229 = (flatten top)
in (Support.Prims.pipe_right _65_19229 (Support.List.map (fun ( t ) -> (let _65_19228 = (desugar_typ env t)
in (Microsoft_FStar_Absyn_Syntax.targ _65_19228))))))
in (let tup = (let _65_19230 = (Microsoft_FStar_Absyn_Util.mk_tuple_lid (Support.List.length targs) top.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) _65_19230))
in (Support.Prims.pipe_left wpos (Microsoft_FStar_Absyn_Syntax.mk_Typ_app (tup, targs))))))
end
| false -> begin
(let _65_19236 = (let _65_19235 = (let _65_19234 = (let _65_19233 = (Microsoft_FStar_Parser_AST.term_to_string t1)
in (Support.Microsoft.FStar.Util.format1 "The operator \"*\" is resolved here as multiplication since \"%s\" is a term, although a type was expected" _65_19233))
in (_65_19234, top.Microsoft_FStar_Parser_AST.range))
in Microsoft_FStar_Absyn_Syntax.Error (_65_19235))
in (raise (_65_19236)))
end)
end
...
| None -> begin
(let _65_19237 = (desugar_exp env top)
in (Support.Prims.pipe_right _65_19237 Microsoft_FStar_Absyn_Util.b2t))
end
| Some (l) -> begin
(let args = (Support.List.map (fun ( t ) -> (let _65_19239 = (desugar_typ_or_exp env t)
in (Support.Prims.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _65_19239))) args)
in (let _65_19240 = (Microsoft_FStar_Absyn_Util.ftv l Microsoft_FStar_Absyn_Syntax.kun)
in (Microsoft_FStar_Absyn_Util.mk_typ_app _65_19240 args)))
end)
end
| Microsoft_FStar_Parser_AST.Tvar (a) -> begin
(let _65_19241 = (Microsoft_FStar_Parser_DesugarEnv.fail_or2 (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_var env) a)
...
| None -> begin
(let _65_19242 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
...
in (let _65_19243 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
in (Support.Prims.pipe_left setpos _65_19243)))
end
| Microsoft_FStar_Parser_AST.Construct ((l, args)) -> begin
(let t = (let _65_19244 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
in (Support.Prims.pipe_left setpos _65_19244))
in (let args = (Support.List.map (fun ( _41_1603 ) -> (match (_41_1603) with
| (t, imp) -> begin
(let _65_19246 = (desugar_typ_or_exp env t)
in (Support.Prims.pipe_left (arg_withimp_t imp) _65_19246))
end)) args)
...
(match (pat) with
| Some (q) -> begin
(let _65_19258 = (let _65_19257 = (let _65_19256 = (let _65_19255 = (Microsoft_FStar_Absyn_Print.pat_to_string q)
in (Support.Microsoft.FStar.Util.format1 "Pattern matching at the type level is not supported; got %s\n" _65_19255))
in (_65_19256, hd.Microsoft_FStar_Parser_AST.prange))
in Microsoft_FStar_Absyn_Syntax.Error (_65_19257))
in (raise (_65_19258)))
end
| None -> begin
...
| Microsoft_FStar_Parser_AST.App (_) -> begin
(let rec aux = (fun ( args ) ( e ) -> (match ((let _65_19263 = (unparen e)
in _65_19263.Microsoft_FStar_Parser_AST.tm)) with
| Microsoft_FStar_Parser_AST.App ((e, arg, imp)) -> begin
(let arg = (let _65_19264 = (desugar_typ_or_exp env arg)
in (Support.Prims.pipe_left (arg_withimp_t imp) _65_19264))
in (aux ((arg)::args) e))
end
| _ -> begin
...
| false -> begin
(let _65_19275 = (desugar_exp env f)
in (Support.Prims.pipe_right _65_19275 Microsoft_FStar_Absyn_Util.b2t))
end)
...
(let _65_19283 = (let _65_19282 = (let _65_19281 = (desugar_typ env t)
in (let _65_19280 = (desugar_kind env k)
in (_65_19281, _65_19280)))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_ascribed' _65_19282))
in (Support.Prims.pipe_left wpos _65_19283))
end
...
| None -> begin
(let _65_19286 = (Microsoft_FStar_Absyn_Util.new_bvd (Some (top.Microsoft_FStar_Parser_AST.range)))
in (env, _65_19286))
end
| Some (x) -> begin
...
| (env, x) -> begin
(let _65_19290 = (let _65_19289 = (let _65_19288 = (let _65_19287 = (Microsoft_FStar_Absyn_Util.close_with_lam tparams t)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.targ _65_19287))
in (_65_19288)::[])
in (Support.List.append typs _65_19289))
in (env, (Support.List.append tparams (((Support.Microsoft.FStar.Util.Inr ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t)), None))::[])), _65_19290))
end))
end))
...
| (env, _, targs) -> begin
(let tup = (let _65_19291 = (Microsoft_FStar_Absyn_Util.mk_dtuple_lid (Support.List.length targs) top.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) _65_19291))
in (Support.Prims.pipe_left wpos (Microsoft_FStar_Absyn_Syntax.mk_Typ_app (tup, targs))))
end))
end
| Microsoft_FStar_Parser_AST.Record (_) -> begin
...
| (arg, _) -> begin
(match ((let _65_19303 = (unparen arg)
in _65_19303.Microsoft_FStar_Parser_AST.tm)) with
...
| Microsoft_FStar_Parser_AST.Name (tot) when (((tot.Microsoft_FStar_Absyn_Syntax.ident.Microsoft_FStar_Absyn_Syntax.idText = "Tot") && (not ((Microsoft_FStar_Parser_DesugarEnv.is_effect_name env Microsoft_FStar_Absyn_Const.effect_Tot_lid)))) && (let _65_19304 = (Microsoft_FStar_Parser_DesugarEnv.current_module env)
in (Microsoft_FStar_Absyn_Syntax.lid_equals _65_19304 Microsoft_FStar_Absyn_Const.prims_lid))) -> begin
(let args = (Support.List.map (fun ( _41_1786 ) -> (match (_41_1786) with
| (t, imp) -> begin
(let _65_19306 = (desugar_typ_or_exp env t)
in (Support.Prims.pipe_left (arg_withimp_t imp) _65_19306))
end)) args)
in (let _65_19307 = (Microsoft_FStar_Absyn_Util.ftv Microsoft_FStar_Absyn_Const.effect_Tot_lid Microsoft_FStar_Absyn_Syntax.kun)
in (Microsoft_FStar_Absyn_Util.mk_typ_app _65_19307 args)))
end
| _ -> begin
(desugar_typ env t)
end)
...
| (head, args) -> begin
(match ((let _65_19309 = (let _65_19308 = (Microsoft_FStar_Absyn_Util.compress_typ head)
in _65_19308.Microsoft_FStar_Absyn_Syntax.n)
in (_65_19309, args))) with
...
| false -> begin
(let _65_19313 = (let _65_19312 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.format1 "%s is not an effect" _65_19312))
in (fail _65_19313))
end)
end))
end))
...
| false -> begin
(let _65_19315 = (let _65_19314 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.format1 "%s is not an effect" _65_19314))
in (fail _65_19315))
end)
end)
end))))))
...
(match ((let _65_19327 = (Microsoft_FStar_Parser_DesugarEnv.qualify_lid env l)
in (Microsoft_FStar_Parser_DesugarEnv.find_kind_abbrev env _65_19327))) with
| Some (l) -> begin
...
| [] -> begin
(let _65_19338 = (let _65_19337 = (let _65_19336 = (desugar_kind env k)
in ((Support.List.rev bs), _65_19336))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _65_19337))
in (Support.Prims.pipe_left pos _65_19338))
end
| hd::tl -> begin
(let _41_1916 = (let _65_19340 = (let _65_19339 = (Microsoft_FStar_Parser_DesugarEnv.default_ml env)
in (desugar_binder _65_19339 hd))
in (Support.Prims.pipe_right _65_19340 (as_binder env hd.Microsoft_FStar_Parser_AST.aqual)))
...
in (let _65_19342 = (desugar_typ_or_exp env t)
in (_65_19342, qual)))
end)) args)
...
| (env, a) -> begin
(let pats = (Support.List.map (fun ( e ) -> (let _65_19373 = (desugar_typ_or_exp env e)
in (Support.Prims.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _65_19373))) pats)
...
| _ -> begin
(let _65_19374 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta (Microsoft_FStar_Absyn_Syntax.Meta_pattern ((body, pats))))
in (Support.Prims.pipe_left setpos _65_19374))
end)
in (let body = (let _65_19380 = (let _65_19379 = (let _65_19378 = (let _65_19377 = (Microsoft_FStar_Absyn_Syntax.t_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_65_19377)::[])
in (_65_19378, body))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _65_19379))
in (Support.Prims.pipe_left pos _65_19380))
in (let _65_19385 = (let _65_19384 = (let _65_19381 = (Microsoft_FStar_Absyn_Util.set_lid_range qt b.Microsoft_FStar_Parser_AST.brange)
in (Microsoft_FStar_Absyn_Util.ftv _65_19381 Microsoft_FStar_Absyn_Syntax.kun))
in (let _65_19383 = (let _65_19382 = (Microsoft_FStar_Absyn_Syntax.targ body)
in (_65_19382)::[])
in (Microsoft_FStar_Absyn_Util.mk_typ_app _65_19384 _65_19383)))
in (Support.Prims.pipe_left setpos _65_19385))))))
end))
end
| Support.Microsoft.FStar.Util.Inr ((Some (x), t)) -> begin
...
| (env, x) -> begin
(let pats = (Support.List.map (fun ( e ) -> (let _65_19387 = (desugar_typ_or_exp env e)
in (Support.Prims.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _65_19387))) pats)
in (let body = (desugar_formula env body)
in (let body = (match (pats) with
| [] -> begin
body
...
in (let body = (let _65_19393 = (let _65_19392 = (let _65_19391 = (let _65_19390 = (Microsoft_FStar_Absyn_Syntax.v_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_65_19390)::[])
in (_65_19391, body))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _65_19392))
in (Support.Prims.pipe_left pos _65_19393))
in (let _65_19398 = (let _65_19397 = (let _65_19394 = (Microsoft_FStar_Absyn_Util.set_lid_range q b.Microsoft_FStar_Parser_AST.brange)
in (Microsoft_FStar_Absyn_Util.ftv _65_19394 Microsoft_FStar_Absyn_Syntax.kun))
in (let _65_19396 = (let _65_19395 = (Microsoft_FStar_Absyn_Syntax.targ body)
in (_65_19395)::[])
in (Microsoft_FStar_Absyn_Util.mk_typ_app _65_19397 _65_19396)))
in (Support.Prims.pipe_left setpos _65_19398))))))
end))
end
| _ -> begin
(failwith ("impossible"))
...
| b::b'::_rest -> begin
(let rest = (b')::_rest
in (let body = (let _65_19413 = (q (rest, pats, body))
in (let _65_19412 = (Support.Microsoft.FStar.Range.union_ranges b'.Microsoft_FStar_Parser_AST.brange body.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Parser_AST.mk_term _65_19413 _65_19412 Microsoft_FStar_Parser_AST.Formula)))
in (let _65_19414 = (q ((b)::[], [], body))
in (Microsoft_FStar_Parser_AST.mk_term _65_19414 f.Microsoft_FStar_Parser_AST.range Microsoft_FStar_Parser_AST.Formula))))
end
| _ -> begin
(failwith ("impossible"))
end))
in (match ((let _65_19415 = (unparen f)
in _65_19415.Microsoft_FStar_Parser_AST.tm)) with
...
(let args = (hd)::_args
in (let args = (Support.List.map (fun ( t ) -> (let _65_19417 = (desugar_typ_or_exp env t)
in (Support.Prims.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _65_19417))) args)
in (let eq = (match ((is_type env hd)) with
| true -> begin
(let _65_19418 = (Microsoft_FStar_Absyn_Util.set_lid_range Microsoft_FStar_Absyn_Const.eqT_lid f.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Absyn_Util.ftv _65_19418 Microsoft_FStar_Absyn_Syntax.kun))
end
| false -> begin
(let _65_19419 = (Microsoft_FStar_Absyn_Util.set_lid_range Microsoft_FStar_Absyn_Const.eq2_lid f.Microsoft_FStar_Parser_AST.range)
...
| (Some (conn), _::_::[]) -> begin
(let _65_19424 = (let _65_19420 = (Microsoft_FStar_Absyn_Util.set_lid_range conn f.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Absyn_Util.ftv _65_19420 Microsoft_FStar_Absyn_Syntax.kun))
in (let _65_19423 = (Support.List.map (fun ( x ) -> (let _65_19422 = (desugar_formula env x)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.targ _65_19422))) args)
...
| false -> begin
(let _65_19425 = (desugar_exp env f)
in (Support.Prims.pipe_right _65_19425 Microsoft_FStar_Absyn_Util.b2t))
end)
end)
end
| Microsoft_FStar_Parser_AST.If ((f1, f2, f3)) -> begin
(let _65_19430 = (let _65_19426 = (Microsoft_FStar_Absyn_Util.set_lid_range Microsoft_FStar_Absyn_Const.ite_lid f.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Absyn_Util.ftv _65_19426 Microsoft_FStar_Absyn_Syntax.kun))
in (let _65_19429 = (Support.List.map (fun ( x ) -> (match ((desugar_typ_or_exp env x)) with
| Support.Microsoft.FStar.Util.Inl (t) -> begin
(Microsoft_FStar_Absyn_Syntax.targ t)
end
| Support.Microsoft.FStar.Util.Inr (v) -> begin
(let _65_19428 = (Microsoft_FStar_Absyn_Util.b2t v)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.targ _65_19428))
end)) ((f1)::(f2)::(f3)::[]))
in (Microsoft_FStar_Absyn_Util.mk_typ_app _65_19430 _65_19429)))
end
| Microsoft_FStar_Parser_AST.QForall ((_1::_2::_3, pats, body)) -> begin
(let binders = (_1)::(_2)::_3
in (let _65_19432 = (push_quant (fun ( x ) -> Microsoft_FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env _65_19432)))
end
| Microsoft_FStar_Parser_AST.QExists ((_1::_2::_3, pats, body)) -> begin
(let binders = (_1)::(_2)::_3
in (let _65_19434 = (push_quant (fun ( x ) -> Microsoft_FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env _65_19434)))
end
...
| false -> begin
(let _65_19435 = (desugar_exp env f)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Util.b2t _65_19435))
end)
end)))))))
...
| true -> begin
(let _65_19440 = (desugar_type_binder env b)
in Support.Microsoft.FStar.Util.Inl (_65_19440))
end
| false -> begin
(let _65_19441 = (desugar_exp_binder env b)
in Support.Microsoft.FStar.Util.Inr (_65_19441))
end))
...
(let _65_19448 = (desugar_typ env t)
in (Some (x), _65_19448))
end
| Microsoft_FStar_Parser_AST.TVariable (t) -> begin
(let _65_19449 = (Microsoft_FStar_Parser_DesugarEnv.fail_or2 (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_var env) t)
in (None, _65_19449))
end
| Microsoft_FStar_Parser_AST.NoName (t) -> begin
(let _65_19450 = (desugar_typ env t)
in (None, _65_19450))
end
...
| Microsoft_FStar_Parser_AST.NoName (t) -> begin
(let _65_19456 = (desugar_kind env t)
in (None, _65_19456))
end
| Microsoft_FStar_Parser_AST.TVariable (x) -> begin
...
in (let _65_19465 = (aux tps k)
in (Support.Prims.pipe_right _65_19465 Microsoft_FStar_Absyn_Util.name_binders))))
...
in (let binders = (let _65_19486 = (let _65_19485 = (let _65_19484 = (let _65_19483 = (let _65_19482 = (Microsoft_FStar_Absyn_Util.ftv t Microsoft_FStar_Absyn_Syntax.kun)
in (let _65_19481 = (Microsoft_FStar_Absyn_Util.args_of_non_null_binders binders)
in (_65_19482, _65_19481)))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app' _65_19483 None p))
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.null_v_binder _65_19484))
in (_65_19485)::[])
in (Support.List.append imp_binders _65_19486))
in (let disc_type = (let _65_19489 = (let _65_19488 = (let _65_19487 = (Microsoft_FStar_Absyn_Util.ftv Microsoft_FStar_Absyn_Const.bool_lid Microsoft_FStar_Absyn_Syntax.ktype)
in (Microsoft_FStar_Absyn_Util.total_comp _65_19487 p))
in (binders, _65_19488))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun _65_19489 None p))
in (Support.Prims.pipe_right datas (Support.List.map (fun ( d ) -> (let disc_name = (Microsoft_FStar_Absyn_Util.mk_discriminator d)
in (let _65_19493 = (let _65_19492 = (quals ((Microsoft_FStar_Absyn_Syntax.Logic)::(Microsoft_FStar_Absyn_Syntax.Discriminator (d))::[]))
in (let _65_19491 = (Microsoft_FStar_Absyn_Syntax.range_of_lid disc_name)
in (disc_name, disc_type, _65_19492, _65_19491)))
in Microsoft_FStar_Absyn_Syntax.Sig_val_decl (_65_19493)))))))))))))
...
in (let arg_binder = (let arg_typ = (let _65_19502 = (let _65_19501 = (Microsoft_FStar_Absyn_Util.ftv tc Microsoft_FStar_Absyn_Syntax.kun)
in (let _65_19500 = (Microsoft_FStar_Absyn_Util.args_of_non_null_binders binders)
in (_65_19501, _65_19500)))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app' _65_19502 None p))
in (let projectee = (let _65_19504 = (Microsoft_FStar_Absyn_Syntax.mk_ident ("projectee", p))
in (let _65_19503 = (Microsoft_FStar_Absyn_Util.genident (Some (p)))
in {Microsoft_FStar_Absyn_Syntax.ppname = _65_19504; Microsoft_FStar_Absyn_Syntax.realname = _65_19503}))
...
in (let _65_19514 = (let _65_19513 = (let _65_19512 = (let _65_19511 = (let _65_19510 = (let _65_19509 = (let _65_19508 = (Microsoft_FStar_Absyn_Util.fvar None disc_name p)
in (let _65_19507 = (let _65_19506 = (let _65_19505 = (Microsoft_FStar_Absyn_Util.bvar_to_exp x)
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.varg _65_19505))
in (_65_19506)::[])
in (_65_19508, _65_19507)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _65_19509 None p))
in (Microsoft_FStar_Absyn_Util.b2t _65_19510))
in (x, _65_19511))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine _65_19512 None p))
in (Support.Prims.pipe_left (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s projectee) _65_19513))
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Syntax.v_binder _65_19514))))
end)))
...
in (let subst = (let _65_19524 = (Support.Prims.pipe_right formals (Support.List.mapi (fun ( i ) ( f ) -> (match ((Support.Prims.fst f)) with
...
| (field_name, _) -> begin
(let proj = (let _65_19520 = (let _65_19519 = (Microsoft_FStar_Absyn_Util.ftv field_name Microsoft_FStar_Absyn_Syntax.kun)
in (_65_19519, (arg)::[]))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _65_19520 None p))
...
| (field_name, _) -> begin
(let proj = (let _65_19523 = (let _65_19522 = (Microsoft_FStar_Absyn_Util.fvar None field_name p)
in (_65_19522, (arg)::[]))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _65_19523 None p))
in (Support.Microsoft.FStar.Util.Inr ((x.Microsoft_FStar_Absyn_Syntax.v, proj)))::[])
end))
end)
end))))
in (Support.Prims.pipe_right _65_19524 Support.List.flatten))
...
| (field_name, _) -> begin
(let kk = (let _65_19528 = (let _65_19527 = (Microsoft_FStar_Absyn_Util.subst_kind subst a.Microsoft_FStar_Absyn_Syntax.sort)
in (binders, _65_19527))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _65_19528 p))
in (let _65_19530 = (let _65_19529 = (Microsoft_FStar_Absyn_Syntax.range_of_lid field_name)
in (field_name, [], kk, [], [], (Microsoft_FStar_Absyn_Syntax.Logic)::(Microsoft_FStar_Absyn_Syntax.Projector ((lid, Support.Microsoft.FStar.Util.Inl (a.Microsoft_FStar_Absyn_Syntax.v))))::[], _65_19529))
in Microsoft_FStar_Absyn_Syntax.Sig_tycon (_65_19530)))
end))
end
| Support.Microsoft.FStar.Util.Inr (x) -> begin
...
| (field_name, _) -> begin
(let t = (let _65_19533 = (let _65_19532 = (let _65_19531 = (Microsoft_FStar_Absyn_Util.subst_typ subst x.Microsoft_FStar_Absyn_Syntax.sort)
in (Microsoft_FStar_Absyn_Util.total_comp _65_19531 p))
in (binders, _65_19532))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun _65_19533 None p))
...
in (let _65_19537 = (let _65_19536 = (Microsoft_FStar_Absyn_Syntax.range_of_lid field_name)
in (field_name, t, (quals ((Microsoft_FStar_Absyn_Syntax.Logic)::(Microsoft_FStar_Absyn_Syntax.Projector ((lid, Support.Microsoft.FStar.Util.Inr (x.Microsoft_FStar_Absyn_Syntax.v))))::[])), _65_19536))
in Microsoft_FStar_Absyn_Syntax.Sig_val_decl (_65_19537))))
end))
end)))))))))))
end))
...
(let _65_19556 = (let _65_19555 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((x)::[]))
in Microsoft_FStar_Parser_AST.Var (_65_19555))
in (Microsoft_FStar_Parser_AST.mk_term _65_19556 x.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Expr))
end
...
in (let apply_binders = (fun ( t ) ( binders ) -> (Support.List.fold_left (fun ( out ) ( b ) -> (let _65_19567 = (let _65_19566 = (let _65_19565 = (binder_to_term b)
in (out, _65_19565, Microsoft_FStar_Parser_AST.Nothing))
in Microsoft_FStar_Parser_AST.App (_65_19566))
in (Microsoft_FStar_Parser_AST.mk_term _65_19567 out.Microsoft_FStar_Parser_AST.range out.Microsoft_FStar_Parser_AST.level))) t binders))
...
| (x, t) -> begin
(let _65_19573 = (let _65_19572 = (let _65_19571 = (Microsoft_FStar_Absyn_Util.mangle_field_name x)
in (_65_19571, t))
in Microsoft_FStar_Parser_AST.Annotated (_65_19572))
in (Microsoft_FStar_Parser_AST.mk_binder _65_19573 x.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Expr None))
end)) fields)
in (let result = (let _65_19576 = (let _65_19575 = (let _65_19574 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((id)::[]))
in Microsoft_FStar_Parser_AST.Var (_65_19574))
in (Microsoft_FStar_Parser_AST.mk_term _65_19575 id.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Type))
in (apply_binders _65_19576 parms))
...
in (let _65_19578 = (Support.Prims.pipe_right fields (Support.List.map (fun ( _41_2377 ) -> (match (_41_2377) with
| (x, _) -> begin
(Microsoft_FStar_Parser_DesugarEnv.qualify env x)
end))))
in (Microsoft_FStar_Parser_AST.TyconVariant ((id, parms, kopt, ((constrName, Some (constrTyp), false))::[])), _65_19578))))))
end
| _ -> begin
(failwith ("impossible"))
end))
...
in (let tconstr = (let _65_19589 = (let _65_19588 = (let _65_19587 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((id)::[]))
in Microsoft_FStar_Parser_AST.Var (_65_19587))
in (Microsoft_FStar_Parser_AST.mk_term _65_19588 id.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Type))
in (apply_binders _65_19589 binders))
...
in (let _65_19601 = (let _65_19600 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in (let _65_19599 = (Support.Prims.pipe_right quals (Support.List.filter (fun ( _41_23 ) -> (match (_41_23) with
| Microsoft_FStar_Absyn_Syntax.Effect -> begin
false
end
| _ -> begin
...
in (_65_19600, typars, c, _65_19599, rng)))
in Microsoft_FStar_Absyn_Syntax.Sig_effect_abbrev (_65_19601)))
end
| false -> begin
(let t = (desugar_typ env' t)
in (let _65_19603 = (let _65_19602 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in (_65_19602, typars, k, t, quals, rng))
in Microsoft_FStar_Absyn_Syntax.Sig_typ_abbrev (_65_19603)))
end)
...
in (let _41_2594 = (let _65_19622 = (Support.Prims.pipe_right constrs (Support.List.map (fun ( _41_2572 ) -> (match (_41_2572) with
...
in (let t = (let _65_19614 = (Microsoft_FStar_Parser_DesugarEnv.default_total env_tps)
in (let _65_19613 = (close env_tps t)
in (desugar_typ _65_19614 _65_19613)))
...
in (let _65_19621 = (let _65_19620 = (let _65_19619 = (let _65_19618 = (let _65_19617 = (Support.List.map (fun ( _41_2591 ) -> (match (_41_2591) with
| (x, _) -> begin
(x, Some (Microsoft_FStar_Absyn_Syntax.Implicit))
end)) tps)
in (Microsoft_FStar_Absyn_Util.close_typ _65_19617 t))
in (Support.Prims.pipe_right _65_19618 Microsoft_FStar_Absyn_Util.name_function_binders))
in (name, _65_19619, tycon, quals, mutuals, rng))
in Microsoft_FStar_Absyn_Syntax.Sig_datacon (_65_19620))
in (name, _65_19621))))))
end))))
in (Support.Prims.pipe_left Support.List.split _65_19622))
...
in (let bundle = (let _65_19624 = (let _65_19623 = (Support.List.collect Microsoft_FStar_Absyn_Util.lids_of_sigelt sigelts)
in (sigelts, quals, _65_19623, rng))
in Microsoft_FStar_Absyn_Syntax.Sig_bundle (_65_19624))
...
| (env, a) -> begin
(let _65_19633 = (let _65_19632 = (Microsoft_FStar_Absyn_Syntax.t_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_65_19632)::binders)
in (env, _65_19633))
end))
end
| Support.Microsoft.FStar.Util.Inr ((Some (x), t)) -> begin
...
| (env, x) -> begin
(let _65_19635 = (let _65_19634 = (Microsoft_FStar_Absyn_Syntax.v_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_65_19634)::binders)
in (env, _65_19635))
end))
end
| _ -> begin
...
(match ((let _65_19641 = (let _65_19640 = (desugar_exp_maybe_top true env (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Let ((isrec, lets, (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Const (Microsoft_FStar_Absyn_Syntax.Const_unit)) d.Microsoft_FStar_Parser_AST.drange Microsoft_FStar_Parser_AST.Expr)))) d.Microsoft_FStar_Parser_AST.drange Microsoft_FStar_Parser_AST.Expr))
in (Support.Prims.pipe_left Microsoft_FStar_Absyn_Util.compress_exp _65_19640))
in _65_19641.Microsoft_FStar_Absyn_Syntax.n)) with
...
in (let _65_19647 = (let _65_19646 = (let _65_19645 = (let _65_19644 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in (_65_19644, f, (Microsoft_FStar_Absyn_Syntax.Assumption)::[], d.Microsoft_FStar_Parser_AST.drange))
in Microsoft_FStar_Absyn_Syntax.Sig_assume (_65_19645))
in (_65_19646)::[])
in (env, _65_19647)))
end
| Microsoft_FStar_Parser_AST.Val ((quals, id, t)) -> begin
(let t = (let _65_19648 = (close_fun env t)
in (desugar_typ env _65_19648))
...
in (let se = (let _65_19650 = (let _65_19649 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in (_65_19649, t, quals, d.Microsoft_FStar_Parser_AST.drange))
in Microsoft_FStar_Absyn_Syntax.Sig_val_decl (_65_19650))
in (let env = (Microsoft_FStar_Parser_DesugarEnv.push_sigelt env se)
in (env, (se)::[])))))
end
...
in (let t = (let _65_19655 = (let _65_19654 = (let _65_19651 = (Microsoft_FStar_Absyn_Syntax.null_v_binder t)
in (_65_19651)::[])
in (let _65_19653 = (let _65_19652 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) Microsoft_FStar_Absyn_Const.exn_lid)
in (Microsoft_FStar_Absyn_Syntax.mk_Total _65_19652))
in (_65_19654, _65_19653)))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun _65_19655 None d.Microsoft_FStar_Parser_AST.drange))
in (let l = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in (let se = Microsoft_FStar_Absyn_Syntax.Sig_datacon ((l, t, (Microsoft_FStar_Absyn_Const.exn_lid, [], Microsoft_FStar_Absyn_Syntax.ktype), (Microsoft_FStar_Absyn_Syntax.ExceptionConstructor)::[], (Microsoft_FStar_Absyn_Const.exn_lid)::[], d.Microsoft_FStar_Parser_AST.drange))
in (let se' = Microsoft_FStar_Absyn_Syntax.Sig_bundle (((se)::[], (Microsoft_FStar_Absyn_Syntax.ExceptionConstructor)::[], (l)::[], d.Microsoft_FStar_Parser_AST.drange))
in (let env = (Microsoft_FStar_Parser_DesugarEnv.push_sigelt env se')
...
| None -> begin
(let _65_19660 = (let _65_19659 = (let _65_19658 = (let _65_19657 = (let _65_19656 = (Microsoft_FStar_Absyn_Print.sli eff.Microsoft_FStar_Absyn_Syntax.v)
in (Support.String.strcat "Effect " _65_19656))
in (Support.String.strcat _65_19657 " not found"))
in (_65_19658, d.Microsoft_FStar_Parser_AST.drange))
in Microsoft_FStar_Absyn_Syntax.Error (_65_19659))
in (raise (_65_19660)))
end
| Some (ed) -> begin
...
in (let ed = (let _65_19677 = (Microsoft_FStar_Parser_DesugarEnv.qualify env0 eff_name)
in (let _65_19676 = (Microsoft_FStar_Absyn_Util.subst_kind subst ed.Microsoft_FStar_Absyn_Syntax.signature)
in (let _65_19675 = (sub ed.Microsoft_FStar_Absyn_Syntax.ret)
in (let _65_19674 = (sub ed.Microsoft_FStar_Absyn_Syntax.bind_wp)
in (let _65_19673 = (sub ed.Microsoft_FStar_Absyn_Syntax.bind_wlp)
in (let _65_19672 = (sub ed.Microsoft_FStar_Absyn_Syntax.if_then_else)
in (let _65_19671 = (sub ed.Microsoft_FStar_Absyn_Syntax.ite_wp)
in (let _65_19670 = (sub ed.Microsoft_FStar_Absyn_Syntax.ite_wlp)
in (let _65_19669 = (sub ed.Microsoft_FStar_Absyn_Syntax.wp_binop)
in (let _65_19668 = (sub ed.Microsoft_FStar_Absyn_Syntax.wp_as_type)
in (let _65_19667 = (sub ed.Microsoft_FStar_Absyn_Syntax.close_wp)
in (let _65_19666 = (sub ed.Microsoft_FStar_Absyn_Syntax.close_wp_t)
in (let _65_19665 = (sub ed.Microsoft_FStar_Absyn_Syntax.assert_p)
in (let _65_19664 = (sub ed.Microsoft_FStar_Absyn_Syntax.assume_p)
in (let _65_19663 = (sub ed.Microsoft_FStar_Absyn_Syntax.null_wp)
in (let _65_19662 = (sub ed.Microsoft_FStar_Absyn_Syntax.trivial)
in {Microsoft_FStar_Absyn_Syntax.mname = _65_19677; Microsoft_FStar_Absyn_Syntax.binders = binders; Microsoft_FStar_Absyn_Syntax.qualifiers = quals; Microsoft_FStar_Absyn_Syntax.signature = _65_19676; Microsoft_FStar_Absyn_Syntax.ret = _65_19675; Microsoft_FStar_Absyn_Syntax.bind_wp = _65_19674; Microsoft_FStar_Absyn_Syntax.bind_wlp = _65_19673; Microsoft_FStar_Absyn_Syntax.if_then_else = _65_19672; Microsoft_FStar_Absyn_Syntax.ite_wp = _65_19671; Microsoft_FStar_Absyn_Syntax.ite_wlp = _65_19670; Microsoft_FStar_Absyn_Syntax.wp_binop = _65_19669; Microsoft_FStar_Absyn_Syntax.wp_as_type = _65_19668; Microsoft_FStar_Absyn_Syntax.close_wp = _65_19667; Microsoft_FStar_Absyn_Syntax.close_wp_t = _65_19666; Microsoft_FStar_Absyn_Syntax.assert_p = _65_19665; Microsoft_FStar_Absyn_Syntax.assume_p = _65_19664; Microsoft_FStar_Absyn_Syntax.null_wp = _65_19663; Microsoft_FStar_Absyn_Syntax.trivial = _65_19662}))))))))))))))))
...
| _ -> begin
(let _65_19681 = (let _65_19680 = (let _65_19679 = (let _65_19678 = (Microsoft_FStar_Absyn_Print.typ_to_string head)
in (Support.String.strcat _65_19678 " is not an effect"))
in (_65_19679, d.Microsoft_FStar_Parser_AST.drange))
in Microsoft_FStar_Absyn_Syntax.Error (_65_19680))
in (raise (_65_19681)))
end)
end)))
end)))
...
| (env, ses) -> begin
(let _65_19685 = (let _65_19684 = (Support.List.hd ses)
in (_65_19684)::out)
in (env, _65_19685))
end))
end)) (env, [])))
...
in (let lookup = (fun ( s ) -> (match ((let _65_19689 = (let _65_19688 = (Microsoft_FStar_Absyn_Syntax.mk_ident (s, d.Microsoft_FStar_Parser_AST.drange))
in (Microsoft_FStar_Parser_DesugarEnv.qualify env _65_19688))
in (Microsoft_FStar_Parser_DesugarEnv.try_resolve_typ_abbrev env _65_19689))) with
| None -> begin
...
in (let ed = (let _65_19704 = (Microsoft_FStar_Parser_DesugarEnv.qualify env0 eff_name)
in (let _65_19703 = (lookup "return")
in (let _65_19702 = (lookup "bind_wp")
in (let _65_19701 = (lookup "bind_wlp")
in (let _65_19700 = (lookup "if_then_else")
in (let _65_19699 = (lookup "ite_wp")
in (let _65_19698 = (lookup "ite_wlp")
in (let _65_19697 = (lookup "wp_binop")
in (let _65_19696 = (lookup "wp_as_type")
in (let _65_19695 = (lookup "close_wp")
in (let _65_19694 = (lookup "close_wp_t")
in (let _65_19693 = (lookup "assert_p")
in (let _65_19692 = (lookup "assume_p")
in (let _65_19691 = (lookup "null_wp")
in (let _65_19690 = (lookup "trivial")
in {Microsoft_FStar_Absyn_Syntax.mname = _65_19704; Microsoft_FStar_Absyn_Syntax.binders = binders; Microsoft_FStar_Absyn_Syntax.qualifiers = quals; Microsoft_FStar_Absyn_Syntax.signature = eff_k; Microsoft_FStar_Absyn_Syntax.ret = _65_19703; Microsoft_FStar_Absyn_Syntax.bind_wp = _65_19702; Microsoft_FStar_Absyn_Syntax.bind_wlp = _65_19701; Microsoft_FStar_Absyn_Syntax.if_then_else = _65_19700; Microsoft_FStar_Absyn_Syntax.ite_wp = _65_19699; Microsoft_FStar_Absyn_Syntax.ite_wlp = _65_19698; Microsoft_FStar_Absyn_Syntax.wp_binop = _65_19697; Microsoft_FStar_Absyn_Syntax.wp_as_type = _65_19696; Microsoft_FStar_Absyn_Syntax.close_wp = _65_19695; Microsoft_FStar_Absyn_Syntax.close_wp_t = _65_19694; Microsoft_FStar_Absyn_Syntax.assert_p = _65_19693; Microsoft_FStar_Absyn_Syntax.assume_p = _65_19692; Microsoft_FStar_Absyn_Syntax.null_wp = _65_19691; Microsoft_FStar_Absyn_Syntax.trivial = _65_19690})))))))))))))))
in (let se = Microsoft_FStar_Absyn_Syntax.Sig_new_effect ((ed, d.Microsoft_FStar_Parser_AST.drange))
in (let env = (Microsoft_FStar_Parser_DesugarEnv.push_sigelt env0 se)
in (env, (se)::[]))))))
end)))
...
| None -> begin
(let _65_19711 = (let _65_19710 = (let _65_19709 = (let _65_19708 = (let _65_19707 = (Microsoft_FStar_Absyn_Print.sli l)
in (Support.String.strcat "Effect name " _65_19707))
in (Support.String.strcat _65_19708 " not found"))
in (_65_19709, d.Microsoft_FStar_Parser_AST.drange))
in Microsoft_FStar_Absyn_Syntax.Error (_65_19710))
in (raise (_65_19711)))
end
| Some (l) -> begin
l
...
| true -> begin
(let _65_19728 = (let _65_19727 = (let _65_19725 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids mname.Microsoft_FStar_Absyn_Syntax.ns)
in Microsoft_FStar_Parser_AST.Open (_65_19725))
in (let _65_19726 = (Microsoft_FStar_Absyn_Syntax.range_of_lid mname)
in (Microsoft_FStar_Parser_AST.mk_decl _65_19727 _65_19726)))
in (_65_19728)::d)
end
| false -> begin
d
...
(let _65_19730 = (Microsoft_FStar_Parser_DesugarEnv.prepare_module_or_interface true admitted env mname)
in (let _65_19729 = (open_ns mname decls)
in (_65_19730, mname, _65_19729, true)))
end
| Microsoft_FStar_Parser_AST.Module ((mname, decls)) -> begin
(let _65_19732 = (Microsoft_FStar_Parser_DesugarEnv.prepare_module_or_interface false false env mname)
in (let _65_19731 = (open_ns mname decls)
in (_65_19732, mname, _65_19731, false)))
end)
...
| true -> begin
(let _65_19737 = (Microsoft_FStar_Absyn_Print.modul_to_string modul)
