...
let kind_star = (fun ( r ) -> (let _70_20920 = (let _70_20919 = (Microsoft_FStar_Absyn_Syntax.lid_of_path (("Type")::[]) r)
in Microsoft_FStar_Parser_AST.Name (_70_20919))
in (Microsoft_FStar_Parser_AST.mk_term _70_20920 r Microsoft_FStar_Parser_AST.Kind)))
...
| false -> begin
(let _70_20931 = (let _70_20929 = (Support.Microsoft.FStar.Util.char_at s i)
in (name_of_char _70_20929))
in (let _70_20930 = (aux (i + 1))
in (_70_20931)::_70_20930))
end))
in (let _70_20933 = (let _70_20932 = (aux 0)
in (Support.String.concat "_" _70_20932))
in (Support.String.strcat "op_" _70_20933)))))

let compile_op_lid = (fun ( n ) ( s ) ( r ) -> (let _70_20943 = (let _70_20942 = (let _70_20941 = (let _70_20940 = (compile_op n s)
in (_70_20940, r))
in (Microsoft_FStar_Absyn_Syntax.mk_ident _70_20941))
in (_70_20942)::[])
in (Support.All.pipe_right _70_20943 Microsoft_FStar_Absyn_Syntax.lid_of_ids)))

let op_as_vlid = (fun ( env ) ( arity ) ( rng ) ( s ) -> (let r = (fun ( l ) -> (let _70_20954 = (Microsoft_FStar_Absyn_Util.set_lid_range l rng)
in Some (_70_20954)))
...
in (match ((let _70_20957 = (compile_op_lid arity s rng)
in (Microsoft_FStar_Parser_DesugarEnv.try_lookup_lid env _70_20957))) with
...
let op_as_tylid = (fun ( env ) ( arity ) ( rng ) ( s ) -> (let r = (fun ( l ) -> (let _70_20968 = (Microsoft_FStar_Absyn_Util.set_lid_range l rng)
in Some (_70_20968)))
in (match (s) with
| "~" -> begin
...
| s -> begin
(match ((let _70_20969 = (compile_op_lid arity s rng)
in (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env _70_20969))) with
...
| false -> begin
(match ((let _70_20976 = (unparen t)
in _70_20976.Microsoft_FStar_Parser_AST.tm)) with
...
(let _70_20981 = (Microsoft_FStar_Parser_DesugarEnv.push_local_tbinding env id)
in (Support.All.pipe_right _70_20981 Support.Prims.fst))
end
| _43_344 -> begin
env
end)
...
| false -> begin
(match ((let _70_20984 = (unparen t)
in _70_20984.Microsoft_FStar_Parser_AST.tm)) with
...
let sort_ftv = (fun ( ftv ) -> (let _70_20995 = (Support.Microsoft.FStar.Util.remove_dups (fun ( x ) ( y ) -> (x.Microsoft_FStar_Absyn_Syntax.idText = y.Microsoft_FStar_Absyn_Syntax.idText)) ftv)
in (Support.All.pipe_left (Support.Microsoft.FStar.Util.sort_with (fun ( x ) ( y ) -> (Support.String.compare x.Microsoft_FStar_Absyn_Syntax.idText y.Microsoft_FStar_Absyn_Syntax.idText))) _70_20995)))
...
(let _70_21002 = (free_type_vars env term)
in (env, _70_21002))
end
...
(let _70_21003 = (free_type_vars env t)
in (env, _70_21003))
end))
and free_type_vars = (fun ( env ) ( t ) -> (match ((let _70_21006 = (unparen t)
in _70_21006.Microsoft_FStar_Parser_AST.tm)) with
...
(let _70_21009 = (free_type_vars env t1)
in (let _70_21008 = (free_type_vars env t2)
in (Support.List.append _70_21009 _70_21008)))
end
| Microsoft_FStar_Parser_AST.Refine ((b, t)) -> begin
(let _43_507 = (free_type_vars_b env b)
in (match (_43_507) with
| (env, f) -> begin
(let _70_21010 = (free_type_vars env t)
in (Support.List.append f _70_21010))
end))
end
...
| (env, free) -> begin
(let _70_21013 = (free_type_vars env body)
in (Support.List.append free _70_21013))
end))
end
...
let head_and_args = (fun ( t ) -> (let rec aux = (fun ( args ) ( t ) -> (match ((let _70_21020 = (unparen t)
in _70_21020.Microsoft_FStar_Parser_AST.tm)) with
...
let close = (fun ( env ) ( t ) -> (let ftv = (let _70_21025 = (free_type_vars env t)
in (Support.All.pipe_left sort_ftv _70_21025))
in (match (((Support.List.length ftv) = 0)) with
| true -> begin
t
end
| false -> begin
(let binders = (Support.All.pipe_right ftv (Support.List.map (fun ( x ) -> (let _70_21029 = (let _70_21028 = (let _70_21027 = (kind_star x.Microsoft_FStar_Absyn_Syntax.idRange)
in (x, _70_21027))
in Microsoft_FStar_Parser_AST.TAnnotated (_70_21028))
in (Microsoft_FStar_Parser_AST.mk_binder _70_21029 x.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Type (Some (Microsoft_FStar_Absyn_Syntax.Implicit)))))))
...
let close_fun = (fun ( env ) ( t ) -> (let ftv = (let _70_21034 = (free_type_vars env t)
in (Support.All.pipe_left sort_ftv _70_21034))
in (match (((Support.List.length ftv) = 0)) with
| true -> begin
t
end
| false -> begin
(let binders = (Support.All.pipe_right ftv (Support.List.map (fun ( x ) -> (let _70_21038 = (let _70_21037 = (let _70_21036 = (kind_star x.Microsoft_FStar_Absyn_Syntax.idRange)
in (x, _70_21036))
in Microsoft_FStar_Parser_AST.TAnnotated (_70_21037))
in (Microsoft_FStar_Parser_AST.mk_binder _70_21038 x.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Type (Some (Microsoft_FStar_Absyn_Syntax.Implicit)))))))
in (let t = (match ((let _70_21039 = (unlabel t)
in _70_21039.Microsoft_FStar_Parser_AST.tm)) with
...
(let _70_21053 = (let _70_21052 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in Support.Microsoft.FStar.Util.Inr (_70_21052))
in (_70_21053, args, None))
end
...
(let _70_21104 = (Microsoft_FStar_Absyn_Syntax.null_t_binder k)
in (_70_21104, env))
end
| Support.Microsoft.FStar.Util.Inr ((None, t)) -> begin
(let _70_21105 = (Microsoft_FStar_Absyn_Syntax.null_v_binder t)
in (_70_21105, env))
end
...
| _43_709 -> begin
(let _70_21116 = (Support.Microsoft.FStar.Range.string_of_range f.Microsoft_FStar_Parser_AST.range)
in (Support.Microsoft.FStar.Util.format2 "%s at %s" tag _70_21116))
end)
...
(let _70_21120 = (let _70_21119 = (aux g)
in Microsoft_FStar_Parser_AST.Paren (_70_21119))
in (Microsoft_FStar_Parser_AST.mk_term _70_21120 f.Microsoft_FStar_Parser_AST.range f.Microsoft_FStar_Parser_AST.level))
end
| Microsoft_FStar_Parser_AST.Op (("/\\", f1::f2::[])) -> begin
(let _70_21126 = (let _70_21125 = (let _70_21124 = (let _70_21123 = (aux f1)
in (let _70_21122 = (let _70_21121 = (aux f2)
in (_70_21121)::[])
in (_70_21123)::_70_21122))
in ("/\\", _70_21124))
in Microsoft_FStar_Parser_AST.Op (_70_21125))
in (Microsoft_FStar_Parser_AST.mk_term _70_21126 f.Microsoft_FStar_Parser_AST.range f.Microsoft_FStar_Parser_AST.level))
end
| Microsoft_FStar_Parser_AST.If ((f1, f2, f3)) -> begin
(let _70_21130 = (let _70_21129 = (let _70_21128 = (aux f2)
in (let _70_21127 = (aux f3)
in (f1, _70_21128, _70_21127)))
in Microsoft_FStar_Parser_AST.If (_70_21129))
in (Microsoft_FStar_Parser_AST.mk_term _70_21130 f.Microsoft_FStar_Parser_AST.range f.Microsoft_FStar_Parser_AST.level))
end
| Microsoft_FStar_Parser_AST.Abs ((binders, g)) -> begin
(let _70_21133 = (let _70_21132 = (let _70_21131 = (aux g)
in (binders, _70_21131))
in Microsoft_FStar_Parser_AST.Abs (_70_21132))
in (Microsoft_FStar_Parser_AST.mk_term _70_21133 f.Microsoft_FStar_Parser_AST.range f.Microsoft_FStar_Parser_AST.level))
end
| _43_731 -> begin
(label f)
end))
...
in (let _43_812 = (let _70_21205 = (Microsoft_FStar_Absyn_Syntax.pat_vars pat)
in (Support.Prims.ignore _70_21205))
...
(let _70_21207 = (let _70_21206 = (desugar_kind env t)
in (x, _70_21206, aq))
in TBinder (_70_21207))
end
| VBinder ((x, _43_847, aq)) -> begin
(let t = (close_fun env t)
in (let _70_21209 = (let _70_21208 = (desugar_typ env t)
in (x, _70_21208, aq))
in VBinder (_70_21209)))
end)
...
in (let _70_21210 = (Support.All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_twild ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a Microsoft_FStar_Absyn_Syntax.kun))))
in (loc, env, TBinder ((a, Microsoft_FStar_Absyn_Syntax.kun, aq)), _70_21210, imp)))
end
| false -> begin
(let _43_862 = (resolvea loc env a)
in (match (_43_862) with
| (loc, env, abvd) -> begin
(let _70_21211 = (Support.All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_tvar ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s abvd Microsoft_FStar_Absyn_Syntax.kun))))
in (loc, env, TBinder ((abvd, Microsoft_FStar_Absyn_Syntax.kun, aq)), _70_21211, imp))
end))
end))
end
...
in (let _70_21212 = (Support.All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_wild ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s y Microsoft_FStar_Absyn_Syntax.tun))))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), _70_21212, false))))
end
| Microsoft_FStar_Parser_AST.PatConst (c) -> begin
(let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (let _70_21213 = (Support.All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_constant (c)))
...
| (loc, env, xbvd) -> begin
(let _70_21214 = (Support.All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_var ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s xbvd Microsoft_FStar_Absyn_Syntax.tun))))
in (loc, env, VBinder ((xbvd, Microsoft_FStar_Absyn_Syntax.tun, aq)), _70_21214, imp))
end)))
end
...
in (let _70_21215 = (Support.All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_cons ((l, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), []))))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), _70_21215, false))))
end
...
(let l = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_datacon env) l)
in (let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (let _70_21218 = (Support.All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_cons ((l, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), args))))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), _70_21218, false))))
end))
end
...
| (loc, env, pats) -> begin
(let pat = (let _70_21231 = (let _70_21230 = (let _70_21226 = (Support.Microsoft.FStar.Range.end_range p.Microsoft_FStar_Parser_AST.prange)
in (pos_r _70_21226))
in (let _70_21229 = (let _70_21228 = (let _70_21227 = (Microsoft_FStar_Absyn_Util.fv Microsoft_FStar_Absyn_Const.nil_lid)
in (_70_21227, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), []))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_70_21228))
in (Support.All.pipe_left _70_21230 _70_21229)))
...
in (let _70_21225 = (let _70_21224 = (let _70_21223 = (Microsoft_FStar_Absyn_Util.fv Microsoft_FStar_Absyn_Const.cons_lid)
in (_70_21223, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), ((hd, false))::((tl, false))::[]))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_70_21224))
in (Support.All.pipe_left (pos_r r) _70_21225)))) pats _70_21231))
in (let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
...
in (let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (let _70_21234 = (Support.All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_cons ((l, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), args))))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), _70_21234, false)))))))
end))
end
...
| (f, p) -> begin
(let _70_21236 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.qualify_field_to_record env record) f)
in (_70_21236, p))
end))))
...
(let _70_21244 = (let _70_21243 = (let _70_21242 = (let _70_21241 = (let _70_21240 = (let _70_21239 = (Support.All.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Support.List.map Support.Prims.fst))
in (record.Microsoft_FStar_Parser_DesugarEnv.typename, _70_21239))
in Microsoft_FStar_Absyn_Syntax.Record_ctor (_70_21240))
in Some (_70_21241))
in (fv, _70_21242, args))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_70_21243))
in (Support.All.pipe_left pos _70_21244))
end
| _43_1014 -> begin
p
end)
...
(let _70_21250 = (let _70_21249 = (let _70_21248 = (Microsoft_FStar_Parser_DesugarEnv.qualify env x)
in (_70_21248, Microsoft_FStar_Absyn_Syntax.tun))
in LetBinder (_70_21249))
in (env, _70_21250, None))
end
...
(let _70_21254 = (let _70_21253 = (let _70_21252 = (Microsoft_FStar_Parser_DesugarEnv.qualify env x)
in (let _70_21251 = (desugar_typ env t)
in (_70_21252, _70_21251)))
in LetBinder (_70_21253))
in (env, _70_21254, None))
end
| _43_1044 -> begin
...
| true -> begin
(let _70_21264 = (desugar_typ env t)
in Support.Microsoft.FStar.Util.Inl (_70_21264))
end
| false -> begin
(let _70_21265 = (desugar_exp env t)
in Support.Microsoft.FStar.Util.Inr (_70_21265))
end))
...
in (match ((let _70_21285 = (unparen top)
in _70_21285.Microsoft_FStar_Parser_AST.tm)) with
...
| Some (l) -> begin
(let op = (let _70_21288 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (Microsoft_FStar_Absyn_Util.fvar None l _70_21288))
in (let args = (Support.All.pipe_right args (Support.List.map (fun ( t ) -> (let _70_21290 = (desugar_typ_or_exp env t)
in (_70_21290, None)))))
in (let _70_21291 = (Microsoft_FStar_Absyn_Util.mk_exp_app op args)
in (Support.All.pipe_left setpos _70_21291))))
end)
end
...
| None -> begin
(let _70_21294 = (let _70_21293 = (let _70_21292 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in ("Identifier \'ref\' not found; include lib/st.fst in your path", _70_21292))
in Microsoft_FStar_Absyn_Syntax.Error (_70_21293))
in (raise (_70_21294)))
end
| Some (e) -> begin
(setpos e)
...
| false -> begin
(let _70_21295 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_lid env) l)
in (Support.All.pipe_left setpos _70_21295))
end)
end
| Microsoft_FStar_Parser_AST.Construct ((l, args)) -> begin
(let dt = (let _70_21300 = (let _70_21299 = (let _70_21298 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_datacon env) l)
in (_70_21298, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_fvar _70_21299))
in (Support.All.pipe_left pos _70_21300))
in (match (args) with
| [] -> begin
dt
end
...
in (let _70_21305 = (let _70_21304 = (let _70_21303 = (let _70_21302 = (Microsoft_FStar_Absyn_Util.mk_exp_app dt args)
in (_70_21302, Microsoft_FStar_Absyn_Syntax.Data_app))
in Microsoft_FStar_Absyn_Syntax.Meta_desugared (_70_21303))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta _70_21304))
in (Support.All.pipe_left setpos _70_21305)))
end))
end
...
(let ftvs = (let _70_21308 = (free_type_vars env t)
in (Support.List.append _70_21308 ftvs))
in (let _70_21310 = (let _70_21309 = (Microsoft_FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (Support.All.pipe_left Support.Prims.fst _70_21309))
in (_70_21310, ftvs)))
end
| Microsoft_FStar_Parser_AST.PatTvar ((a, _43_1139)) -> begin
(let _70_21312 = (let _70_21311 = (Microsoft_FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (Support.All.pipe_left Support.Prims.fst _70_21311))
in (_70_21312, ftvs))
end
| Microsoft_FStar_Parser_AST.PatAscribed ((_43_1143, t)) -> begin
(let _70_21314 = (let _70_21313 = (free_type_vars env t)
in (Support.List.append _70_21313 ftvs))
in (env, _70_21314))
end
| _43_1148 -> begin
(env, ftvs)
...
in (let binders = (let _70_21316 = (Support.All.pipe_right ftv (Support.List.map (fun ( a ) -> (Microsoft_FStar_Parser_AST.mk_pattern (Microsoft_FStar_Parser_AST.PatTvar ((a, true))) top.Microsoft_FStar_Parser_AST.range))))
in (Support.List.append _70_21316 binders))
...
| TBinder ((a, k, aq)) -> begin
(let _70_21325 = (binder_of_bnd b)
in (_70_21325, sc_pat_opt))
end
| VBinder ((x, t, aq)) -> begin
...
| (Some (p), None) -> begin
(let _70_21327 = (let _70_21326 = (Microsoft_FStar_Absyn_Util.bvar_to_exp b)
in (_70_21326, p))
in Some (_70_21327))
end
...
in (let sc = (let _70_21334 = (let _70_21333 = (Microsoft_FStar_Absyn_Util.fvar (Some (Microsoft_FStar_Absyn_Syntax.Data_ctor)) tup top.Microsoft_FStar_Parser_AST.range)
in (let _70_21332 = (let _70_21331 = (Microsoft_FStar_Absyn_Syntax.varg sc)
in (let _70_21330 = (let _70_21329 = (let _70_21328 = (Microsoft_FStar_Absyn_Util.bvar_to_exp b)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.varg _70_21328))
in (_70_21329)::[])
in (_70_21331)::_70_21330))
in (_70_21333, _70_21332)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _70_21334 None top.Microsoft_FStar_Parser_AST.range))
in (let p = (let _70_21338 = (let _70_21336 = (let _70_21335 = (Microsoft_FStar_Absyn_Util.fv tup)
in (_70_21335, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), ((p', false))::((p, false))::[]))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_70_21336))
in (let _70_21337 = (Support.Microsoft.FStar.Range.union_ranges p'.Microsoft_FStar_Absyn_Syntax.p p.Microsoft_FStar_Absyn_Syntax.p)
in (Microsoft_FStar_Absyn_Util.withinfo _70_21338 None _70_21337)))
in Some ((sc, p)))))
end
...
in (let sc = (let _70_21344 = (let _70_21343 = (Microsoft_FStar_Absyn_Util.fvar (Some (Microsoft_FStar_Absyn_Syntax.Data_ctor)) tup top.Microsoft_FStar_Parser_AST.range)
in (let _70_21342 = (let _70_21341 = (let _70_21340 = (let _70_21339 = (Microsoft_FStar_Absyn_Util.bvar_to_exp b)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.varg _70_21339))
in (_70_21340)::[])
in (Support.List.append args _70_21341))
in (_70_21343, _70_21342)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _70_21344 None top.Microsoft_FStar_Parser_AST.range))
in (let p = (let _70_21348 = (let _70_21346 = (let _70_21345 = (Microsoft_FStar_Absyn_Util.fv tup)
in (_70_21345, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), (Support.List.append pats (((p, false))::[]))))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_70_21346))
in (let _70_21347 = (Support.Microsoft.FStar.Range.union_ranges p'.Microsoft_FStar_Absyn_Syntax.p p.Microsoft_FStar_Absyn_Syntax.p)
in (Microsoft_FStar_Absyn_Util.withinfo _70_21348 None _70_21347)))
in Some ((sc, p)))))
end
| _43_1231 -> begin
(Support.All.failwith "Impossible")
...
in (let _70_21359 = (let _70_21358 = (let _70_21357 = (let _70_21351 = (Microsoft_FStar_Absyn_Syntax.range_of_lid a)
in (Microsoft_FStar_Absyn_Util.fvar None a _70_21351))
in (let _70_21356 = (let _70_21355 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ phi)
in (let _70_21354 = (let _70_21353 = (let _70_21352 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant Microsoft_FStar_Absyn_Syntax.Const_unit None top.Microsoft_FStar_Parser_AST.range)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.varg _70_21352))
in (_70_21353)::[])
in (_70_21355)::_70_21354))
in (_70_21357, _70_21356)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _70_21358))
in (Support.All.pipe_left pos _70_21359)))
end
| Microsoft_FStar_Parser_AST.App (_43_1250) -> begin
(let rec aux = (fun ( args ) ( e ) -> (match ((let _70_21364 = (unparen e)
in _70_21364.Microsoft_FStar_Parser_AST.tm)) with
| Microsoft_FStar_Parser_AST.App ((e, t, imp)) -> begin
(let arg = (let _70_21365 = (desugar_typ_or_exp env t)
in (Support.All.pipe_left (arg_withimp_e imp) _70_21365))
in (aux ((arg)::args) e))
end
| _43_1262 -> begin
...
(let _70_21371 = (let _70_21370 = (let _70_21369 = (let _70_21368 = (desugar_exp env (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Let ((false, (((Microsoft_FStar_Parser_AST.mk_pattern Microsoft_FStar_Parser_AST.PatWild t1.Microsoft_FStar_Parser_AST.range), t1))::[], t2))) top.Microsoft_FStar_Parser_AST.range Microsoft_FStar_Parser_AST.Expr))
in (_70_21368, Microsoft_FStar_Absyn_Syntax.Sequence))
in Microsoft_FStar_Absyn_Syntax.Meta_desugared (_70_21369))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_meta _70_21370))
in (Support.All.pipe_left setpos _70_21371))
end
...
| true -> begin
(let _70_21375 = (destruct_app_pattern env top_level p)
in (_70_21375, def))
end
| false -> begin
(match ((Microsoft_FStar_Parser_AST.un_function p def)) with
| Some ((p, def)) -> begin
(let _70_21376 = (destruct_app_pattern env top_level p)
in (_70_21376, def))
end
| _43_1288 -> begin
(match (p.Microsoft_FStar_Parser_AST.pat) with
...
| true -> begin
(let _70_21379 = (let _70_21378 = (let _70_21377 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in Support.Microsoft.FStar.Util.Inr (_70_21377))
in (_70_21378, [], Some (t)))
in (_70_21379, def))
end
| false -> begin
...
(match (top_level) with
| true -> begin
(let _70_21382 = (let _70_21381 = (let _70_21380 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in Support.Microsoft.FStar.Util.Inr (_70_21380))
in (_70_21381, [], None))
in (_70_21382, def))
end
| false -> begin
...
(let _70_21385 = (Microsoft_FStar_Parser_DesugarEnv.push_rec_binding env (Microsoft_FStar_Parser_DesugarEnv.Binding_let (l)))
in (_70_21385, Support.Microsoft.FStar.Util.Inr (l)))
end)
...
| Some (t) -> begin
(let _70_21392 = (Support.Microsoft.FStar.Range.union_ranges t.Microsoft_FStar_Parser_AST.range def.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Ascribed ((def, t))) _70_21392 Microsoft_FStar_Parser_AST.Expr))
end)
...
| Some (pat) -> begin
(let _70_21404 = (let _70_21403 = (Microsoft_FStar_Absyn_Util.bvd_to_exp x t)
in (_70_21403, ((pat, None, body))::[]))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_match _70_21404 None body.Microsoft_FStar_Absyn_Syntax.pos))
end)
...
(let _70_21417 = (let _70_21416 = (let _70_21415 = (desugar_exp env t1)
in (let _70_21414 = (let _70_21413 = (let _70_21409 = (desugar_exp env t2)
in ((Microsoft_FStar_Absyn_Util.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_constant (Microsoft_FStar_Absyn_Syntax.Const_bool (true))) None t2.Microsoft_FStar_Parser_AST.range), None, _70_21409))
in (let _70_21412 = (let _70_21411 = (let _70_21410 = (desugar_exp env t3)
in ((Microsoft_FStar_Absyn_Util.withinfo (Microsoft_FStar_Absyn_Syntax.Pat_constant (Microsoft_FStar_Absyn_Syntax.Const_bool (false))) None t3.Microsoft_FStar_Parser_AST.range), None, _70_21410))
in (_70_21411)::[])
in (_70_21413)::_70_21412))
in (_70_21415, _70_21414)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_match _70_21416))
in (Support.All.pipe_left pos _70_21417))
end
...
| Some (e) -> begin
(let _70_21420 = (desugar_exp env e)
in Some (_70_21420))
end)
...
in (let _70_21426 = (let _70_21425 = (let _70_21424 = (desugar_exp env e)
in (let _70_21423 = (Support.List.map desugar_branch branches)
in (_70_21424, _70_21423)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_match _70_21425))
in (Support.All.pipe_left pos _70_21426)))
end
| Microsoft_FStar_Parser_AST.Ascribed ((e, t)) -> begin
(let _70_21432 = (let _70_21431 = (let _70_21430 = (desugar_exp env e)
in (let _70_21429 = (desugar_typ env t)
in (_70_21430, _70_21429, None)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_ascribed _70_21431))
in (Support.All.pipe_left pos _70_21432))
end
...
(let _70_21440 = (qfn fn)
in (_70_21440, e))
end
| None -> begin
(match (xopt) with
| None -> begin
(let _70_21444 = (let _70_21443 = (let _70_21442 = (let _70_21441 = (Microsoft_FStar_Absyn_Syntax.text_of_lid f)
in (Support.Microsoft.FStar.Util.format1 "Field %s is missing" _70_21441))
in (_70_21442, top.Microsoft_FStar_Parser_AST.range))
in Microsoft_FStar_Absyn_Syntax.Error (_70_21443))
in (raise (_70_21444)))
end
| Some (x) -> begin
(let _70_21445 = (qfn fn)
in (_70_21445, (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Project ((x, f))) x.Microsoft_FStar_Parser_AST.range x.Microsoft_FStar_Parser_AST.level)))
end)
end))))
in (let recterm = (match (eopt) with
| None -> begin
(let _70_21450 = (let _70_21449 = (Support.All.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Support.List.map (fun ( _43_1469 ) -> (match (_43_1469) with
| (f, _43_1468) -> begin
(let _70_21448 = (let _70_21447 = (get_field None f)
in (Support.All.pipe_left Support.Prims.snd _70_21447))
in (_70_21448, Microsoft_FStar_Parser_AST.Nothing))
end))))
in (record.Microsoft_FStar_Parser_DesugarEnv.constrname, _70_21449))
in Microsoft_FStar_Parser_AST.Construct (_70_21450))
end
| Some (e) -> begin
(let x = (Microsoft_FStar_Absyn_Util.genident (Some (e.Microsoft_FStar_Parser_AST.range)))
in (let xterm = (let _70_21452 = (let _70_21451 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((x)::[]))
in Microsoft_FStar_Parser_AST.Var (_70_21451))
in (Microsoft_FStar_Parser_AST.mk_term _70_21452 x.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Expr))
in (let record = (let _70_21455 = (let _70_21454 = (Support.All.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Support.List.map (fun ( _43_1477 ) -> (match (_43_1477) with
| (f, _43_1476) -> begin
(get_field (Some (xterm)) f)
end))))
in (None, _70_21454))
in Microsoft_FStar_Parser_AST.Record (_70_21455))
...
(let e = (let _70_21465 = (let _70_21464 = (let _70_21463 = (let _70_21462 = (let _70_21461 = (let _70_21460 = (let _70_21459 = (let _70_21458 = (Support.All.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Support.List.map Support.Prims.fst))
in (record.Microsoft_FStar_Parser_DesugarEnv.typename, _70_21458))
in Microsoft_FStar_Absyn_Syntax.Record_ctor (_70_21459))
in Some (_70_21460))
in (fv, _70_21461))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_fvar _70_21462 None e.Microsoft_FStar_Absyn_Syntax.pos))
in (_70_21463, args))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _70_21464))
in (Support.All.pipe_left pos _70_21465))
...
in (let _70_21473 = (let _70_21472 = (let _70_21471 = (let _70_21468 = (Microsoft_FStar_Absyn_Syntax.range_of_lid f)
in (Microsoft_FStar_Absyn_Util.fvar (Some (Microsoft_FStar_Absyn_Syntax.Record_projector (fn))) fieldname _70_21468))
in (let _70_21470 = (let _70_21469 = (Microsoft_FStar_Absyn_Syntax.varg e)
in (_70_21469)::[])
in (_70_21471, _70_21470)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _70_21472))
in (Support.All.pipe_left pos _70_21473))))
end))
end
...
in (let head_and_args = (fun ( t ) -> (let rec aux = (fun ( args ) ( t ) -> (match ((let _70_21496 = (unparen t)
in _70_21496.Microsoft_FStar_Parser_AST.tm)) with
| Microsoft_FStar_Parser_AST.App ((t, arg, imp)) -> begin
(aux (((arg, imp))::args) t)
end
| Microsoft_FStar_Parser_AST.Construct ((l, args')) -> begin
...
| false -> begin
(let _70_21497 = (desugar_exp env t)
in (Support.All.pipe_right _70_21497 Microsoft_FStar_Absyn_Util.b2t))
end))
end
...
| false -> begin
(let _70_21498 = (desugar_exp env t)
in (Support.All.pipe_right _70_21498 Microsoft_FStar_Absyn_Util.b2t))
end))
end
...
in (let targs = (let _70_21503 = (flatten top)
in (Support.All.pipe_right _70_21503 (Support.List.map (fun ( t ) -> (let _70_21502 = (desugar_typ env t)
in (Microsoft_FStar_Absyn_Syntax.targ _70_21502))))))
in (let tup = (let _70_21504 = (Microsoft_FStar_Absyn_Util.mk_tuple_lid (Support.List.length targs) top.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) _70_21504))
in (Support.All.pipe_left wpos (Microsoft_FStar_Absyn_Syntax.mk_Typ_app (tup, targs))))))
end
| false -> begin
(let _70_21510 = (let _70_21509 = (let _70_21508 = (let _70_21507 = (Microsoft_FStar_Parser_AST.term_to_string t1)
in (Support.Microsoft.FStar.Util.format1 "The operator \"*\" is resolved here as multiplication since \"%s\" is a term, although a type was expected" _70_21507))
in (_70_21508, top.Microsoft_FStar_Parser_AST.range))
in Microsoft_FStar_Absyn_Syntax.Error (_70_21509))
in (raise (_70_21510)))
end)
end
...
| None -> begin
(let _70_21511 = (desugar_exp env top)
in (Support.All.pipe_right _70_21511 Microsoft_FStar_Absyn_Util.b2t))
end
| Some (l) -> begin
(let args = (Support.List.map (fun ( t ) -> (let _70_21513 = (desugar_typ_or_exp env t)
in (Support.All.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _70_21513))) args)
in (let _70_21514 = (Microsoft_FStar_Absyn_Util.ftv l Microsoft_FStar_Absyn_Syntax.kun)
in (Microsoft_FStar_Absyn_Util.mk_typ_app _70_21514 args)))
end)
end
| Microsoft_FStar_Parser_AST.Tvar (a) -> begin
(let _70_21515 = (Microsoft_FStar_Parser_DesugarEnv.fail_or2 (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_var env) a)
...
| None -> begin
(let _70_21516 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
...
in (let _70_21517 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
in (Support.All.pipe_left setpos _70_21517)))
end
| Microsoft_FStar_Parser_AST.Construct ((l, args)) -> begin
(let t = (let _70_21518 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
in (Support.All.pipe_left setpos _70_21518))
in (let args = (Support.List.map (fun ( _43_1622 ) -> (match (_43_1622) with
| (t, imp) -> begin
(let _70_21520 = (desugar_typ_or_exp env t)
in (Support.All.pipe_left (arg_withimp_t imp) _70_21520))
end)) args)
...
(match (pat) with
| Some (q) -> begin
(let _70_21532 = (let _70_21531 = (let _70_21530 = (let _70_21529 = (Microsoft_FStar_Absyn_Print.pat_to_string q)
in (Support.Microsoft.FStar.Util.format1 "Pattern matching at the type level is not supported; got %s\n" _70_21529))
in (_70_21530, hd.Microsoft_FStar_Parser_AST.prange))
in Microsoft_FStar_Absyn_Syntax.Error (_70_21531))
in (raise (_70_21532)))
end
| None -> begin
...
(let rec aux = (fun ( args ) ( e ) -> (match ((let _70_21537 = (unparen e)
in _70_21537.Microsoft_FStar_Parser_AST.tm)) with
| Microsoft_FStar_Parser_AST.App ((e, arg, imp)) -> begin
(let arg = (let _70_21538 = (desugar_typ_or_exp env arg)
in (Support.All.pipe_left (arg_withimp_t imp) _70_21538))
in (aux ((arg)::args) e))
end
| _43_1658 -> begin
...
| false -> begin
(let _70_21549 = (desugar_exp env f)
in (Support.All.pipe_right _70_21549 Microsoft_FStar_Absyn_Util.b2t))
end)
...
(let _70_21557 = (let _70_21556 = (let _70_21555 = (desugar_typ env t)
in (let _70_21554 = (desugar_kind env k)
in (_70_21555, _70_21554)))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_ascribed' _70_21556))
in (Support.All.pipe_left wpos _70_21557))
end
...
| None -> begin
(let _70_21560 = (Microsoft_FStar_Absyn_Util.new_bvd (Some (top.Microsoft_FStar_Parser_AST.range)))
in (env, _70_21560))
end
| Some (x) -> begin
...
| (env, x) -> begin
(let _70_21564 = (let _70_21563 = (let _70_21562 = (let _70_21561 = (Microsoft_FStar_Absyn_Util.close_with_lam tparams t)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _70_21561))
in (_70_21562)::[])
in (Support.List.append typs _70_21563))
in (env, (Support.List.append tparams (((Support.Microsoft.FStar.Util.Inr ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t)), None))::[])), _70_21564))
end))
end))
...
(let tup = (let _70_21565 = (Microsoft_FStar_Absyn_Util.mk_dtuple_lid (Support.List.length targs) top.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) _70_21565))
in (Support.All.pipe_left wpos (Microsoft_FStar_Absyn_Syntax.mk_Typ_app (tup, targs))))
end))
end
...
| (arg, _43_1771) -> begin
(match ((let _70_21577 = (unparen arg)
in _70_21577.Microsoft_FStar_Parser_AST.tm)) with
...
| Microsoft_FStar_Parser_AST.Name (tot) when (((tot.Microsoft_FStar_Absyn_Syntax.ident.Microsoft_FStar_Absyn_Syntax.idText = "Tot") && (not ((Microsoft_FStar_Parser_DesugarEnv.is_effect_name env Microsoft_FStar_Absyn_Const.effect_Tot_lid)))) && (let _70_21578 = (Microsoft_FStar_Parser_DesugarEnv.current_module env)
in (Microsoft_FStar_Absyn_Syntax.lid_equals _70_21578 Microsoft_FStar_Absyn_Const.prims_lid))) -> begin
(let args = (Support.List.map (fun ( _43_1805 ) -> (match (_43_1805) with
| (t, imp) -> begin
(let _70_21580 = (desugar_typ_or_exp env t)
in (Support.All.pipe_left (arg_withimp_t imp) _70_21580))
end)) args)
in (let _70_21581 = (Microsoft_FStar_Absyn_Util.ftv Microsoft_FStar_Absyn_Const.effect_Tot_lid Microsoft_FStar_Absyn_Syntax.kun)
in (Microsoft_FStar_Absyn_Util.mk_typ_app _70_21581 args)))
end
| _43_1808 -> begin
(desugar_typ env t)
end)
...
| (head, args) -> begin
(match ((let _70_21583 = (let _70_21582 = (Microsoft_FStar_Absyn_Util.compress_typ head)
in _70_21582.Microsoft_FStar_Absyn_Syntax.n)
in (_70_21583, args))) with
...
| false -> begin
(let _70_21589 = (let _70_21588 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (Support.Microsoft.FStar.Util.format1 "%s is not an effect" _70_21588))
in (fail _70_21589))
end)
end)
end))))))
...
(match ((let _70_21601 = (Microsoft_FStar_Parser_DesugarEnv.qualify_lid env l)
in (Microsoft_FStar_Parser_DesugarEnv.find_kind_abbrev env _70_21601))) with
| Some (l) -> begin
...
| [] -> begin
(let _70_21612 = (let _70_21611 = (let _70_21610 = (desugar_kind env k)
in ((Support.List.rev bs), _70_21610))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _70_21611))
in (Support.All.pipe_left pos _70_21612))
end
| hd::tl -> begin
(let _43_1935 = (let _70_21614 = (let _70_21613 = (Microsoft_FStar_Parser_DesugarEnv.default_ml env)
in (desugar_binder _70_21613 hd))
in (Support.All.pipe_right _70_21614 (as_binder env hd.Microsoft_FStar_Parser_AST.aqual)))
...
in (let _70_21616 = (desugar_typ_or_exp env t)
in (_70_21616, qual)))
end)) args)
...
| (env, a) -> begin
(let pats = (Support.List.map (fun ( e ) -> (let _70_21647 = (desugar_typ_or_exp env e)
in (Support.All.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _70_21647))) pats)
...
| _43_1989 -> begin
(let _70_21648 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta (Microsoft_FStar_Absyn_Syntax.Meta_pattern ((body, pats))))
in (Support.All.pipe_left setpos _70_21648))
end)
in (let body = (let _70_21654 = (let _70_21653 = (let _70_21652 = (let _70_21651 = (Microsoft_FStar_Absyn_Syntax.t_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_70_21651)::[])
in (_70_21652, body))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _70_21653))
in (Support.All.pipe_left pos _70_21654))
in (let _70_21659 = (let _70_21658 = (let _70_21655 = (Microsoft_FStar_Absyn_Util.set_lid_range qt b.Microsoft_FStar_Parser_AST.brange)
in (Microsoft_FStar_Absyn_Util.ftv _70_21655 Microsoft_FStar_Absyn_Syntax.kun))
in (let _70_21657 = (let _70_21656 = (Microsoft_FStar_Absyn_Syntax.targ body)
in (_70_21656)::[])
in (Microsoft_FStar_Absyn_Util.mk_typ_app _70_21658 _70_21657)))
in (Support.All.pipe_left setpos _70_21659))))))
end))
end
| Support.Microsoft.FStar.Util.Inr ((Some (x), t)) -> begin
...
| (env, x) -> begin
(let pats = (Support.List.map (fun ( e ) -> (let _70_21661 = (desugar_typ_or_exp env e)
in (Support.All.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _70_21661))) pats)
in (let body = (desugar_formula env body)
in (let body = (match (pats) with
| [] -> begin
body
...
in (let body = (let _70_21667 = (let _70_21666 = (let _70_21665 = (let _70_21664 = (Microsoft_FStar_Absyn_Syntax.v_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_70_21664)::[])
in (_70_21665, body))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _70_21666))
in (Support.All.pipe_left pos _70_21667))
in (let _70_21672 = (let _70_21671 = (let _70_21668 = (Microsoft_FStar_Absyn_Util.set_lid_range q b.Microsoft_FStar_Parser_AST.brange)
in (Microsoft_FStar_Absyn_Util.ftv _70_21668 Microsoft_FStar_Absyn_Syntax.kun))
in (let _70_21670 = (let _70_21669 = (Microsoft_FStar_Absyn_Syntax.targ body)
in (_70_21669)::[])
in (Microsoft_FStar_Absyn_Util.mk_typ_app _70_21671 _70_21670)))
in (Support.All.pipe_left setpos _70_21672))))))
end))
end
| _43_2009 -> begin
(Support.All.failwith "impossible")
...
| b::b'::_rest -> begin
(let rest = (b')::_rest
in (let body = (let _70_21687 = (q (rest, pats, body))
in (let _70_21686 = (Support.Microsoft.FStar.Range.union_ranges b'.Microsoft_FStar_Parser_AST.brange body.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Parser_AST.mk_term _70_21687 _70_21686 Microsoft_FStar_Parser_AST.Formula)))
in (let _70_21688 = (q ((b)::[], [], body))
in (Microsoft_FStar_Parser_AST.mk_term _70_21688 f.Microsoft_FStar_Parser_AST.range Microsoft_FStar_Parser_AST.Formula))))
end
| _43_2023 -> begin
(Support.All.failwith "impossible")
end))
in (match ((let _70_21689 = (unparen f)
in _70_21689.Microsoft_FStar_Parser_AST.tm)) with
...
(let args = (hd)::_args
in (let args = (Support.List.map (fun ( t ) -> (let _70_21691 = (desugar_typ_or_exp env t)
in (Support.All.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _70_21691))) args)
in (let eq = (match ((is_type env hd)) with
| true -> begin
(let _70_21692 = (Microsoft_FStar_Absyn_Util.set_lid_range Microsoft_FStar_Absyn_Const.eqT_lid f.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Absyn_Util.ftv _70_21692 Microsoft_FStar_Absyn_Syntax.kun))
end
| false -> begin
(let _70_21693 = (Microsoft_FStar_Absyn_Util.set_lid_range Microsoft_FStar_Absyn_Const.eq2_lid f.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Absyn_Util.ftv _70_21693 Microsoft_FStar_Absyn_Syntax.kun))
end)
...
(let _70_21698 = (let _70_21694 = (Microsoft_FStar_Absyn_Util.set_lid_range conn f.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Absyn_Util.ftv _70_21694 Microsoft_FStar_Absyn_Syntax.kun))
in (let _70_21697 = (Support.List.map (fun ( x ) -> (let _70_21696 = (desugar_formula env x)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _70_21696))) args)
in (Microsoft_FStar_Absyn_Util.mk_typ_app _70_21698 _70_21697)))
end
| _43_2054 -> begin
...
| false -> begin
(let _70_21699 = (desugar_exp env f)
in (Support.All.pipe_right _70_21699 Microsoft_FStar_Absyn_Util.b2t))
end)
end)
end
| Microsoft_FStar_Parser_AST.If ((f1, f2, f3)) -> begin
(let _70_21704 = (let _70_21700 = (Microsoft_FStar_Absyn_Util.set_lid_range Microsoft_FStar_Absyn_Const.ite_lid f.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Absyn_Util.ftv _70_21700 Microsoft_FStar_Absyn_Syntax.kun))
in (let _70_21703 = (Support.List.map (fun ( x ) -> (match ((desugar_typ_or_exp env x)) with
| Support.Microsoft.FStar.Util.Inl (t) -> begin
(Microsoft_FStar_Absyn_Syntax.targ t)
end
| Support.Microsoft.FStar.Util.Inr (v) -> begin
(let _70_21702 = (Microsoft_FStar_Absyn_Util.b2t v)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _70_21702))
end)) ((f1)::(f2)::(f3)::[]))
in (Microsoft_FStar_Absyn_Util.mk_typ_app _70_21704 _70_21703)))
end
| Microsoft_FStar_Parser_AST.QForall ((_1::_2::_3, pats, body)) -> begin
(let binders = (_1)::(_2)::_3
in (let _70_21706 = (push_quant (fun ( x ) -> Microsoft_FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env _70_21706)))
end
| Microsoft_FStar_Parser_AST.QExists ((_1::_2::_3, pats, body)) -> begin
(let binders = (_1)::(_2)::_3
in (let _70_21708 = (push_quant (fun ( x ) -> Microsoft_FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env _70_21708)))
end
...
| false -> begin
(let _70_21709 = (desugar_exp env f)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Util.b2t _70_21709))
end)
end)))))))
...
| true -> begin
(let _70_21714 = (desugar_type_binder env b)
in Support.Microsoft.FStar.Util.Inl (_70_21714))
end
| false -> begin
(let _70_21715 = (desugar_exp_binder env b)
in Support.Microsoft.FStar.Util.Inr (_70_21715))
end))
...
(let _70_21723 = (Microsoft_FStar_Parser_DesugarEnv.fail_or2 (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_var env) t)
in (None, _70_21723))
end
| Microsoft_FStar_Parser_AST.NoName (t) -> begin
(let _70_21724 = (desugar_typ env t)
in (None, _70_21724))
end
...
(let _70_21729 = (desugar_kind env t)
in (Some (x), _70_21729))
end
| Microsoft_FStar_Parser_AST.NoName (t) -> begin
(let _70_21730 = (desugar_kind env t)
in (None, _70_21730))
end
| Microsoft_FStar_Parser_AST.TVariable (x) -> begin
...
in (let _70_21739 = (aux tps k)
in (Support.All.pipe_right _70_21739 Microsoft_FStar_Absyn_Util.name_binders))))
...
in (let binders = (let _70_21760 = (let _70_21759 = (let _70_21758 = (let _70_21757 = (let _70_21756 = (Microsoft_FStar_Absyn_Util.ftv t Microsoft_FStar_Absyn_Syntax.kun)
in (let _70_21755 = (Microsoft_FStar_Absyn_Util.args_of_non_null_binders binders)
in (_70_21756, _70_21755)))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app' _70_21757 None p))
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.null_v_binder _70_21758))
in (_70_21759)::[])
in (Support.List.append imp_binders _70_21760))
in (let disc_type = (let _70_21763 = (let _70_21762 = (let _70_21761 = (Microsoft_FStar_Absyn_Util.ftv Microsoft_FStar_Absyn_Const.bool_lid Microsoft_FStar_Absyn_Syntax.ktype)
in (Microsoft_FStar_Absyn_Util.total_comp _70_21761 p))
in (binders, _70_21762))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun _70_21763 None p))
in (Support.All.pipe_right datas (Support.List.map (fun ( d ) -> (let disc_name = (Microsoft_FStar_Absyn_Util.mk_discriminator d)
in (let _70_21767 = (let _70_21766 = (quals ((Microsoft_FStar_Absyn_Syntax.Logic)::(Microsoft_FStar_Absyn_Syntax.Discriminator (d))::[]))
in (let _70_21765 = (Microsoft_FStar_Absyn_Syntax.range_of_lid disc_name)
in (disc_name, disc_type, _70_21766, _70_21765)))
in Microsoft_FStar_Absyn_Syntax.Sig_val_decl (_70_21767)))))))))))))
...
in (let projectee = (let _70_21778 = (Microsoft_FStar_Absyn_Syntax.mk_ident ("projectee", p))
in (let _70_21777 = (Microsoft_FStar_Absyn_Util.genident (Some (p)))
in {Microsoft_FStar_Absyn_Syntax.ppname = _70_21778; Microsoft_FStar_Absyn_Syntax.realname = _70_21777}))
in (let arg_exp = (Microsoft_FStar_Absyn_Util.bvd_to_exp projectee Microsoft_FStar_Absyn_Syntax.tun)
in (let arg_binder = (let arg_typ = (let _70_21781 = (let _70_21780 = (Microsoft_FStar_Absyn_Util.ftv tc Microsoft_FStar_Absyn_Syntax.kun)
in (let _70_21779 = (Microsoft_FStar_Absyn_Util.args_of_non_null_binders binders)
in (_70_21780, _70_21779)))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app' _70_21781 None p))
...
in (let _70_21791 = (let _70_21790 = (let _70_21789 = (let _70_21788 = (let _70_21787 = (let _70_21786 = (let _70_21785 = (Microsoft_FStar_Absyn_Util.fvar None disc_name p)
in (let _70_21784 = (let _70_21783 = (let _70_21782 = (Microsoft_FStar_Absyn_Util.bvar_to_exp x)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.varg _70_21782))
in (_70_21783)::[])
in (_70_21785, _70_21784)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _70_21786 None p))
in (Microsoft_FStar_Absyn_Util.b2t _70_21787))
in (x, _70_21788))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine _70_21789 None p))
in (Support.All.pipe_left (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s projectee) _70_21790))
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.v_binder _70_21791))))
end))
...
in (let subst = (let _70_21801 = (Support.All.pipe_right formals (Support.List.mapi (fun ( i ) ( f ) -> (match ((Support.Prims.fst f)) with
...
(let proj = (let _70_21797 = (let _70_21796 = (Microsoft_FStar_Absyn_Util.ftv field_name Microsoft_FStar_Absyn_Syntax.kun)
in (_70_21796, (arg)::[]))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _70_21797 None p))
...
(let proj = (let _70_21800 = (let _70_21799 = (Microsoft_FStar_Absyn_Util.fvar None field_name p)
in (_70_21799, (arg)::[]))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app _70_21800 None p))
in (Support.Microsoft.FStar.Util.Inr ((x.Microsoft_FStar_Absyn_Syntax.v, proj)))::[])
end))
end)
end))))
in (Support.All.pipe_right _70_21801 Support.List.flatten))
in (let ntps = (Support.List.length tps)
in (let _70_21839 = (Support.All.pipe_right formals (Support.List.mapi (fun ( i ) ( ax ) -> (match ((Support.Prims.fst ax)) with
| Support.Microsoft.FStar.Util.Inl (a) -> begin
(let _43_2274 = (Microsoft_FStar_Absyn_Util.mk_field_projector_name lid a i)
in (match (_43_2274) with
| (field_name, _43_2273) -> begin
(let kk = (let _70_21805 = (let _70_21804 = (Microsoft_FStar_Absyn_Util.subst_kind subst a.Microsoft_FStar_Absyn_Syntax.sort)
in (binders, _70_21804))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _70_21805 p))
in (let _70_21808 = (let _70_21807 = (let _70_21806 = (Microsoft_FStar_Absyn_Syntax.range_of_lid field_name)
in (field_name, [], kk, [], [], (Microsoft_FStar_Absyn_Syntax.Logic)::(Microsoft_FStar_Absyn_Syntax.Projector ((lid, Support.Microsoft.FStar.Util.Inl (a.Microsoft_FStar_Absyn_Syntax.v))))::[], _70_21806))
in Microsoft_FStar_Absyn_Syntax.Sig_tycon (_70_21807))
in (_70_21808)::[]))
end))
end
| Support.Microsoft.FStar.Util.Inr (x) -> begin
...
(let t = (let _70_21811 = (let _70_21810 = (let _70_21809 = (Microsoft_FStar_Absyn_Util.subst_typ subst x.Microsoft_FStar_Absyn_Syntax.sort)
in (Microsoft_FStar_Absyn_Util.total_comp _70_21809 p))
in (binders, _70_21810))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun _70_21811 None p))
...
in (let impl = (match ((((let _70_21814 = (Microsoft_FStar_Parser_DesugarEnv.current_module env)
in (Microsoft_FStar_Absyn_Syntax.lid_equals Microsoft_FStar_Absyn_Const.prims_lid _70_21814)) || (fvq <> Microsoft_FStar_Absyn_Syntax.Data_ctor)) || (Support.ST.read Microsoft_FStar_Options.__temp_no_proj))) with
| true -> begin
[]
end
| false -> begin
...
in (let arg_pats = (let _70_21829 = (Support.All.pipe_right formals (Support.List.mapi (fun ( j ) ( by ) -> (match (by) with
...
| false -> begin
(let _70_21822 = (let _70_21821 = (let _70_21820 = (let _70_21819 = (Microsoft_FStar_Absyn_Util.gen_bvar Microsoft_FStar_Absyn_Syntax.kun)
in Microsoft_FStar_Absyn_Syntax.Pat_tvar (_70_21819))
in (pos _70_21820))
...
(match ((i = j)) with
| true -> begin
(let _70_21824 = (let _70_21823 = (pos (Microsoft_FStar_Absyn_Syntax.Pat_var (projection)))
in (_70_21823, (as_imp imp)))
in (_70_21824)::[])
end
| false -> begin
(let _70_21828 = (let _70_21827 = (let _70_21826 = (let _70_21825 = (Microsoft_FStar_Absyn_Util.gen_bvar Microsoft_FStar_Absyn_Syntax.tun)
in Microsoft_FStar_Absyn_Syntax.Pat_wild (_70_21825))
in (pos _70_21826))
in (_70_21827, (as_imp imp)))
in (_70_21828)::[])
end)
end))))
in (Support.All.pipe_right _70_21829 Support.List.flatten))
in (let pat = (let _70_21834 = (let _70_21832 = (let _70_21831 = (let _70_21830 = (Microsoft_FStar_Absyn_Util.fv lid)
in (_70_21830, Some (fvq), arg_pats))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_70_21831))
in (Support.All.pipe_right _70_21832 pos))
in (let _70_21833 = (Microsoft_FStar_Absyn_Util.bvar_to_exp projection)
in (_70_21834, None, _70_21833)))
in (let body = (Microsoft_FStar_Absyn_Syntax.mk_Exp_match (arg_exp, (pat)::[]) None p)
in (let imp = (let _70_21835 = (Microsoft_FStar_Absyn_Syntax.range_of_lid field_name)
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_abs (binders, body) None _70_21835))
...
in (let _70_21838 = (let _70_21837 = (let _70_21836 = (Microsoft_FStar_Absyn_Syntax.range_of_lid field_name)
in (field_name, t, quals, _70_21836))
in Microsoft_FStar_Absyn_Syntax.Sig_val_decl (_70_21837))
in (_70_21838)::impl)))))
end))
end))))
in (Support.All.pipe_right _70_21839 Support.List.flatten)))))))))))))
end))
...
(let _70_21859 = (let _70_21858 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((x)::[]))
in Microsoft_FStar_Parser_AST.Var (_70_21858))
in (Microsoft_FStar_Parser_AST.mk_term _70_21859 x.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Expr))
end
...
in (let apply_binders = (fun ( t ) ( binders ) -> (Support.List.fold_left (fun ( out ) ( b ) -> (let _70_21870 = (let _70_21869 = (let _70_21868 = (binder_to_term b)
in (out, _70_21868, Microsoft_FStar_Parser_AST.Nothing))
in Microsoft_FStar_Parser_AST.App (_70_21869))
in (Microsoft_FStar_Parser_AST.mk_term _70_21870 out.Microsoft_FStar_Parser_AST.range out.Microsoft_FStar_Parser_AST.level))) t binders))
...
| (x, t) -> begin
(let _70_21876 = (let _70_21875 = (let _70_21874 = (Microsoft_FStar_Absyn_Util.mangle_field_name x)
in (_70_21874, t))
in Microsoft_FStar_Parser_AST.Annotated (_70_21875))
in (Microsoft_FStar_Parser_AST.mk_binder _70_21876 x.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Expr None))
end)) fields)
in (let result = (let _70_21879 = (let _70_21878 = (let _70_21877 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((id)::[]))
in Microsoft_FStar_Parser_AST.Var (_70_21877))
in (Microsoft_FStar_Parser_AST.mk_term _70_21878 id.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Type))
in (apply_binders _70_21879 parms))
...
in (let _70_21881 = (Support.All.pipe_right fields (Support.List.map (fun ( _43_2436 ) -> (match (_43_2436) with
| (x, _43_2435) -> begin
(Microsoft_FStar_Parser_DesugarEnv.qualify env x)
end))))
in (Microsoft_FStar_Parser_AST.TyconVariant ((id, parms, kopt, ((constrName, Some (constrTyp), false))::[])), _70_21881))))))
end
| _43_2438 -> begin
(Support.All.failwith "impossible")
end))
...
in (let tconstr = (let _70_21892 = (let _70_21891 = (let _70_21890 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids ((id)::[]))
in Microsoft_FStar_Parser_AST.Var (_70_21890))
in (Microsoft_FStar_Parser_AST.mk_term _70_21891 id.Microsoft_FStar_Absyn_Syntax.idRange Microsoft_FStar_Parser_AST.Type))
in (apply_binders _70_21892 binders))
...
in (let _70_21902 = (Support.All.pipe_right quals (Support.List.filter (fun ( _43_25 ) -> (match (_43_25) with
| Microsoft_FStar_Absyn_Syntax.Effect -> begin
false
end
| _43_2520 -> begin
...
in (_70_21903, typars, c, _70_21902, rng)))
in Microsoft_FStar_Absyn_Syntax.Sig_effect_abbrev (_70_21904)))
end
| false -> begin
(let t = (desugar_typ env' t)
in (let _70_21906 = (let _70_21905 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in (_70_21905, typars, k, t, quals, rng))
in Microsoft_FStar_Absyn_Syntax.Sig_typ_abbrev (_70_21906)))
end)
...
in (let _43_2653 = (let _70_21925 = (Support.All.pipe_right constrs (Support.List.map (fun ( _43_2631 ) -> (match (_43_2631) with
...
in (let t = (let _70_21917 = (Microsoft_FStar_Parser_DesugarEnv.default_total env_tps)
in (let _70_21916 = (close env_tps t)
in (desugar_typ _70_21917 _70_21916)))
...
in (let _70_21924 = (let _70_21923 = (let _70_21922 = (let _70_21921 = (let _70_21920 = (Support.List.map (fun ( _43_2650 ) -> (match (_43_2650) with
| (x, _43_2649) -> begin
(x, Some (Microsoft_FStar_Absyn_Syntax.Implicit))
end)) tps)
in (Microsoft_FStar_Absyn_Util.close_typ _70_21920 t))
in (Support.All.pipe_right _70_21921 Microsoft_FStar_Absyn_Util.name_function_binders))
in (name, _70_21922, tycon, quals, mutuals, rng))
in Microsoft_FStar_Absyn_Syntax.Sig_datacon (_70_21923))
in (name, _70_21924))))))
end))))
in (Support.All.pipe_left Support.List.split _70_21925))
...
in (let bundle = (let _70_21927 = (let _70_21926 = (Support.List.collect Microsoft_FStar_Absyn_Util.lids_of_sigelt sigelts)
in (sigelts, quals, _70_21926, rng))
in Microsoft_FStar_Absyn_Syntax.Sig_bundle (_70_21927))
...
| (env, a) -> begin
(let _70_21936 = (let _70_21935 = (Microsoft_FStar_Absyn_Syntax.t_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a k))
...
| (env, x) -> begin
(let _70_21938 = (let _70_21937 = (Microsoft_FStar_Absyn_Syntax.v_binder (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_70_21937)::binders)
in (env, _70_21938))
end))
end
| _43_2701 -> begin
...
(match ((let _70_21944 = (let _70_21943 = (desugar_exp_maybe_top true env (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Let ((isrec, lets, (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Const (Microsoft_FStar_Absyn_Syntax.Const_unit)) d.Microsoft_FStar_Parser_AST.drange Microsoft_FStar_Parser_AST.Expr)))) d.Microsoft_FStar_Parser_AST.drange Microsoft_FStar_Parser_AST.Expr))
in (Support.All.pipe_left Microsoft_FStar_Absyn_Util.compress_exp _70_21943))
in _70_21944.Microsoft_FStar_Absyn_Syntax.n)) with
...
in (let _70_21950 = (let _70_21949 = (let _70_21948 = (let _70_21947 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in (_70_21947, f, (Microsoft_FStar_Absyn_Syntax.Assumption)::[], d.Microsoft_FStar_Parser_AST.drange))
in Microsoft_FStar_Absyn_Syntax.Sig_assume (_70_21948))
in (_70_21949)::[])
in (env, _70_21950)))
end
| Microsoft_FStar_Parser_AST.Val ((quals, id, t)) -> begin
(let t = (let _70_21951 = (close_fun env t)
in (desugar_typ env _70_21951))
...
in (let se = (let _70_21953 = (let _70_21952 = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in (_70_21952, t, quals, d.Microsoft_FStar_Parser_AST.drange))
in Microsoft_FStar_Absyn_Syntax.Sig_val_decl (_70_21953))
in (let env = (Microsoft_FStar_Parser_DesugarEnv.push_sigelt env se)
in (env, (se)::[])))))
end
...
in (let t = (let _70_21958 = (let _70_21957 = (let _70_21954 = (Microsoft_FStar_Absyn_Syntax.null_v_binder t)
in (_70_21954)::[])
in (let _70_21956 = (let _70_21955 = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) Microsoft_FStar_Absyn_Const.exn_lid)
in (Microsoft_FStar_Absyn_Syntax.mk_Total _70_21955))
in (_70_21957, _70_21956)))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun _70_21958 None d.Microsoft_FStar_Parser_AST.drange))
in (let l = (Microsoft_FStar_Parser_DesugarEnv.qualify env id)
in (let se = Microsoft_FStar_Absyn_Syntax.Sig_datacon ((l, t, (Microsoft_FStar_Absyn_Const.exn_lid, [], Microsoft_FStar_Absyn_Syntax.ktype), (Microsoft_FStar_Absyn_Syntax.ExceptionConstructor)::[], (Microsoft_FStar_Absyn_Const.exn_lid)::[], d.Microsoft_FStar_Parser_AST.drange))
in (let se' = Microsoft_FStar_Absyn_Syntax.Sig_bundle (((se)::[], (Microsoft_FStar_Absyn_Syntax.ExceptionConstructor)::[], (l)::[], d.Microsoft_FStar_Parser_AST.drange))
in (let env = (Microsoft_FStar_Parser_DesugarEnv.push_sigelt env se')
...
| None -> begin
(let _70_21963 = (let _70_21962 = (let _70_21961 = (let _70_21960 = (let _70_21959 = (Microsoft_FStar_Absyn_Print.sli eff.Microsoft_FStar_Absyn_Syntax.v)
in (Support.String.strcat "Effect " _70_21959))
in (Support.String.strcat _70_21960 " not found"))
in (_70_21961, d.Microsoft_FStar_Parser_AST.drange))
in Microsoft_FStar_Absyn_Syntax.Error (_70_21962))
in (raise (_70_21963)))
end
| Some (ed) -> begin
...
in (let ed = (let _70_21980 = (Microsoft_FStar_Parser_DesugarEnv.qualify env0 eff_name)
in (let _70_21979 = (Microsoft_FStar_Absyn_Util.subst_kind subst ed.Microsoft_FStar_Absyn_Syntax.signature)
in (let _70_21978 = (sub ed.Microsoft_FStar_Absyn_Syntax.ret)
in (let _70_21977 = (sub ed.Microsoft_FStar_Absyn_Syntax.bind_wp)
in (let _70_21976 = (sub ed.Microsoft_FStar_Absyn_Syntax.bind_wlp)
in (let _70_21975 = (sub ed.Microsoft_FStar_Absyn_Syntax.if_then_else)
in (let _70_21974 = (sub ed.Microsoft_FStar_Absyn_Syntax.ite_wp)
in (let _70_21973 = (sub ed.Microsoft_FStar_Absyn_Syntax.ite_wlp)
in (let _70_21972 = (sub ed.Microsoft_FStar_Absyn_Syntax.wp_binop)
in (let _70_21971 = (sub ed.Microsoft_FStar_Absyn_Syntax.wp_as_type)
in (let _70_21970 = (sub ed.Microsoft_FStar_Absyn_Syntax.close_wp)
in (let _70_21969 = (sub ed.Microsoft_FStar_Absyn_Syntax.close_wp_t)
in (let _70_21968 = (sub ed.Microsoft_FStar_Absyn_Syntax.assert_p)
in (let _70_21967 = (sub ed.Microsoft_FStar_Absyn_Syntax.assume_p)
in (let _70_21966 = (sub ed.Microsoft_FStar_Absyn_Syntax.null_wp)
in (let _70_21965 = (sub ed.Microsoft_FStar_Absyn_Syntax.trivial)
in {Microsoft_FStar_Absyn_Syntax.mname = _70_21980; Microsoft_FStar_Absyn_Syntax.binders = binders; Microsoft_FStar_Absyn_Syntax.qualifiers = quals; Microsoft_FStar_Absyn_Syntax.signature = _70_21979; Microsoft_FStar_Absyn_Syntax.ret = _70_21978; Microsoft_FStar_Absyn_Syntax.bind_wp = _70_21977; Microsoft_FStar_Absyn_Syntax.bind_wlp = _70_21976; Microsoft_FStar_Absyn_Syntax.if_then_else = _70_21975; Microsoft_FStar_Absyn_Syntax.ite_wp = _70_21974; Microsoft_FStar_Absyn_Syntax.ite_wlp = _70_21973; Microsoft_FStar_Absyn_Syntax.wp_binop = _70_21972; Microsoft_FStar_Absyn_Syntax.wp_as_type = _70_21971; Microsoft_FStar_Absyn_Syntax.close_wp = _70_21970; Microsoft_FStar_Absyn_Syntax.close_wp_t = _70_21969; Microsoft_FStar_Absyn_Syntax.assert_p = _70_21968; Microsoft_FStar_Absyn_Syntax.assume_p = _70_21967; Microsoft_FStar_Absyn_Syntax.null_wp = _70_21966; Microsoft_FStar_Absyn_Syntax.trivial = _70_21965}))))))))))))))))
...
| _43_2841 -> begin
(let _70_21984 = (let _70_21983 = (let _70_21982 = (let _70_21981 = (Microsoft_FStar_Absyn_Print.typ_to_string head)
in (Support.String.strcat _70_21981 " is not an effect"))
in (_70_21982, d.Microsoft_FStar_Parser_AST.drange))
in Microsoft_FStar_Absyn_Syntax.Error (_70_21983))
in (raise (_70_21984)))
end)
end)))
end)))
...
| (env, ses) -> begin
(let _70_21988 = (let _70_21987 = (Support.List.hd ses)
in (_70_21987)::out)
in (env, _70_21988))
end))
end)) (env, [])))
...
in (let lookup = (fun ( s ) -> (match ((let _70_21992 = (let _70_21991 = (Microsoft_FStar_Absyn_Syntax.mk_ident (s, d.Microsoft_FStar_Parser_AST.drange))
in (Microsoft_FStar_Parser_DesugarEnv.qualify env _70_21991))
in (Microsoft_FStar_Parser_DesugarEnv.try_resolve_typ_abbrev env _70_21992))) with
| None -> begin
...
in (let ed = (let _70_22007 = (Microsoft_FStar_Parser_DesugarEnv.qualify env0 eff_name)
in (let _70_22006 = (lookup "return")
in (let _70_22005 = (lookup "bind_wp")
in (let _70_22004 = (lookup "bind_wlp")
in (let _70_22003 = (lookup "if_then_else")
in (let _70_22002 = (lookup "ite_wp")
in (let _70_22001 = (lookup "ite_wlp")
in (let _70_22000 = (lookup "wp_binop")
in (let _70_21999 = (lookup "wp_as_type")
in (let _70_21998 = (lookup "close_wp")
in (let _70_21997 = (lookup "close_wp_t")
in (let _70_21996 = (lookup "assert_p")
in (let _70_21995 = (lookup "assume_p")
in (let _70_21994 = (lookup "null_wp")
in (let _70_21993 = (lookup "trivial")
in {Microsoft_FStar_Absyn_Syntax.mname = _70_22007; Microsoft_FStar_Absyn_Syntax.binders = binders; Microsoft_FStar_Absyn_Syntax.qualifiers = quals; Microsoft_FStar_Absyn_Syntax.signature = eff_k; Microsoft_FStar_Absyn_Syntax.ret = _70_22006; Microsoft_FStar_Absyn_Syntax.bind_wp = _70_22005; Microsoft_FStar_Absyn_Syntax.bind_wlp = _70_22004; Microsoft_FStar_Absyn_Syntax.if_then_else = _70_22003; Microsoft_FStar_Absyn_Syntax.ite_wp = _70_22002; Microsoft_FStar_Absyn_Syntax.ite_wlp = _70_22001; Microsoft_FStar_Absyn_Syntax.wp_binop = _70_22000; Microsoft_FStar_Absyn_Syntax.wp_as_type = _70_21999; Microsoft_FStar_Absyn_Syntax.close_wp = _70_21998; Microsoft_FStar_Absyn_Syntax.close_wp_t = _70_21997; Microsoft_FStar_Absyn_Syntax.assert_p = _70_21996; Microsoft_FStar_Absyn_Syntax.assume_p = _70_21995; Microsoft_FStar_Absyn_Syntax.null_wp = _70_21994; Microsoft_FStar_Absyn_Syntax.trivial = _70_21993})))))))))))))))
in (let se = Microsoft_FStar_Absyn_Syntax.Sig_new_effect ((ed, d.Microsoft_FStar_Parser_AST.drange))
in (let env = (Microsoft_FStar_Parser_DesugarEnv.push_sigelt env0 se)
in (env, (se)::[]))))))
end)))
...
| None -> begin
(let _70_22014 = (let _70_22013 = (let _70_22012 = (let _70_22011 = (let _70_22010 = (Microsoft_FStar_Absyn_Print.sli l)
in (Support.String.strcat "Effect name " _70_22010))
in (Support.String.strcat _70_22011 " not found"))
in (_70_22012, d.Microsoft_FStar_Parser_AST.drange))
in Microsoft_FStar_Absyn_Syntax.Error (_70_22013))
in (raise (_70_22014)))
end
| Some (l) -> begin
l
...
| true -> begin
(let _70_22031 = (let _70_22030 = (let _70_22028 = (Microsoft_FStar_Absyn_Syntax.lid_of_ids mname.Microsoft_FStar_Absyn_Syntax.ns)
in Microsoft_FStar_Parser_AST.Open (_70_22028))
in (let _70_22029 = (Microsoft_FStar_Absyn_Syntax.range_of_lid mname)
in (Microsoft_FStar_Parser_AST.mk_decl _70_22030 _70_22029)))
in (_70_22031)::d)
end
| false -> begin
d
...
(let _70_22033 = (Microsoft_FStar_Parser_DesugarEnv.prepare_module_or_interface true admitted env mname)
in (let _70_22032 = (open_ns mname decls)
in (_70_22033, mname, _70_22032, true)))
end
| Microsoft_FStar_Parser_AST.Module ((mname, decls)) -> begin
(let _70_22035 = (Microsoft_FStar_Parser_DesugarEnv.prepare_module_or_interface false false env mname)
in (let _70_22034 = (open_ns mname decls)
in (_70_22035, mname, _70_22034, false)))
end)
...
(match (m) with
| Microsoft_FStar_Parser_AST.Module ((mname, decls)) -> begin
(let _70_22042 = (let _70_22041 = (let _70_22040 = (Support.ST.read Microsoft_FStar_Options.admit_fsi)
in (Support.Microsoft.FStar.Util.for_some (fun ( m ) -> (m = mname.Microsoft_FStar_Absyn_Syntax.str)) _70_22040))
in (mname, decls, _70_22041))
in Microsoft_FStar_Parser_AST.Interface (_70_22042))
end
...
| true -> begin
(let _70_22047 = (Microsoft_FStar_Absyn_Print.modul_to_string modul)
