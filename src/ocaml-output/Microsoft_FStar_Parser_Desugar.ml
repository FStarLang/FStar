...
let contains_binder = (fun binders -> (All.pipe_right binders (Microsoft_FStar_Util.for_some (fun b -> (match (b.Microsoft_FStar_Parser_AST.b) with
...
in (let rec aux = (fun i -> (match ((i = (Microsoft_FStar_String.length s))) with
| true -> begin
[]
end
| false -> begin
(let _109_28 = (let _109_26 = (Microsoft_FStar_Util.char_at s i)
in (name_of_char _109_26))
in (let _109_27 = (aux (i + 1))
in (_109_28)::_109_27))
end))
in (let _109_30 = (let _109_29 = (aux 0)
in (Microsoft_FStar_String.concat "_" _109_29))
...
in (_109_39)::[])
in (All.pipe_right _109_40 Microsoft_FStar_Absyn_Syntax.lid_of_ids)))
...
(match ((op_as_tylid env (Microsoft_FStar_List.length args) t.Microsoft_FStar_Parser_AST.range s)) with
| None -> begin
false
end
| _43_230 -> begin
...
| (Microsoft_FStar_Parser_AST.Var (l)) | (Microsoft_FStar_Parser_AST.Name (l)) when ((Microsoft_FStar_List.length l.Microsoft_FStar_Absyn_Syntax.ns) = 0) -> begin
...
in (All.pipe_right _109_78 Prims.fst))
end
| _43_344 -> begin
env
end)
...
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Unexpected binder without annotation", b.Microsoft_FStar_Parser_AST.brange))))
end
...
let sort_ftv = (fun ftv -> (let _109_92 = (Microsoft_FStar_Util.remove_dups (fun x y -> (x.Microsoft_FStar_Absyn_Syntax.idText = y.Microsoft_FStar_Absyn_Syntax.idText)) ftv)
in (All.pipe_left (Microsoft_FStar_Util.sort_with (fun x y -> (Microsoft_FStar_String.compare x.Microsoft_FStar_Absyn_Syntax.idText y.Microsoft_FStar_Absyn_Syntax.idText))) _109_92)))
...
(Microsoft_FStar_List.collect (fun _43_489 -> (match (_43_489) with
| (t, _43_488) -> begin
(free_type_vars env t)
end)) ts)
end
| Microsoft_FStar_Parser_AST.Op (_43_491, ts) -> begin
(Microsoft_FStar_List.collect (free_type_vars env) ts)
end
...
in (Microsoft_FStar_List.append _109_106 _109_105)))
end
...
({Microsoft_FStar_Parser_AST.tm = Microsoft_FStar_Parser_AST.Name (l); Microsoft_FStar_Parser_AST.range = t.Microsoft_FStar_Parser_AST.range; Microsoft_FStar_Parser_AST.level = t.Microsoft_FStar_Parser_AST.level}, (Microsoft_FStar_List.append args' args))
end
| _43_570 -> begin
(t, args)
end))
...
in (All.pipe_left sort_ftv _109_122))
in (match (((Microsoft_FStar_List.length ftv) = 0)) with
| true -> begin
t
end
| false -> begin
(let binders = (All.pipe_right ftv (Microsoft_FStar_List.map (fun x -> (let _109_126 = (let _109_125 = (let _109_124 = (kind_star x.Microsoft_FStar_Absyn_Syntax.idRange)
in (x, _109_124))
...
in (All.pipe_left sort_ftv _109_131))
in (match (((Microsoft_FStar_List.length ftv) = 0)) with
| true -> begin
t
end
| false -> begin
(let binders = (All.pipe_right ftv (Microsoft_FStar_List.map (fun x -> (let _109_135 = (let _109_134 = (let _109_133 = (kind_star x.Microsoft_FStar_Absyn_Syntax.idRange)
in (x, _109_133))
...
(uncurry (Microsoft_FStar_List.append bs binders) t)
end
| _43_596 -> begin
(bs, t)
end))
...
in Microsoft_FStar_Util.Inr (_109_149))
...
(Microsoft_FStar_Util.Inl (id), args, None)
end
| _43_650 -> begin
(All.failwith "Not an app pattern")
end))
...
(Microsoft_FStar_Util.Inl ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a k)), aq)
end
| VBinder (x, t, aq) -> begin
(Microsoft_FStar_Util.Inr ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t)), aq)
end
| _43_672 -> begin
...
| Microsoft_FStar_Util.Inl (None, k) -> begin
(let _109_201 = (Microsoft_FStar_Absyn_Syntax.null_t_binder k)
in (_109_201, env))
end
| Microsoft_FStar_Util.Inr (None, t) -> begin
(let _109_202 = (Microsoft_FStar_Absyn_Syntax.null_v_binder t)
in (_109_202, env))
end
| Microsoft_FStar_Util.Inl (Some (a), k) -> begin
(let _43_691 = (Microsoft_FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (match (_43_691) with
| (env, a) -> begin
((Microsoft_FStar_Util.Inl ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a k)), imp), env)
end))
end
| Microsoft_FStar_Util.Inr (Some (x), t) -> begin
(let _43_699 = (Microsoft_FStar_Parser_DesugarEnv.push_local_vbinding env x)
in (match (_43_699) with
| (env, x) -> begin
((Microsoft_FStar_Util.Inr ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t)), imp), env)
end))
end))
...
type lenv_t =
(Microsoft_FStar_Absyn_Syntax.btvdef, Microsoft_FStar_Absyn_Syntax.bvvdef) Microsoft_FStar_Util.either Prims.list
...
| _43_709 -> begin
(let _109_213 = (Microsoft_FStar_Range.string_of_range f.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Util.format2 "%s at %s" tag _109_213))
end)
...
let rec desugar_data_pat = (fun env p -> (let resolvex = (fun l e x -> (match ((All.pipe_right l (Microsoft_FStar_Util.find_opt (fun _43_5 -> (match (_43_5) with
...
| Some (Microsoft_FStar_Util.Inr (y)) -> begin
(l, e, y)
end
| _43_751 -> begin
...
| (e, x) -> begin
((Microsoft_FStar_Util.Inr (x))::l, e, x)
end))
end))
in (let resolvea = (fun l e a -> (match ((All.pipe_right l (Microsoft_FStar_Util.find_opt (fun _43_6 -> (match (_43_6) with
| Microsoft_FStar_Util.Inl (b) -> begin
(b.Microsoft_FStar_Absyn_Syntax.ppname.Microsoft_FStar_Absyn_Syntax.idText = a.Microsoft_FStar_Absyn_Syntax.idText)
end
| _43_763 -> begin
false
end))))) with
| Some (Microsoft_FStar_Util.Inl (b)) -> begin
(l, e, b)
end
| _43_768 -> begin
...
| (e, a) -> begin
((Microsoft_FStar_Util.Inl (a))::l, e, a)
end))
end))
...
(let _43_810 = (Microsoft_FStar_List.fold_left (fun _43_797 p -> (match (_43_797) with
| (loc, env, ps) -> begin
...
| (loc, env, ps) -> begin
(let pat = (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_disj ((p)::(Microsoft_FStar_List.rev ps))))
...
| _43_828 -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Unexpected pattern", p.Microsoft_FStar_Parser_AST.prange))))
end)
end
| false -> begin
p
...
| true -> begin
(let a = (All.pipe_left Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (let _109_307 = (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_twild ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a Microsoft_FStar_Absyn_Syntax.kun))))
...
| (loc, env, abvd) -> begin
(let _109_308 = (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_tvar ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s abvd Microsoft_FStar_Absyn_Syntax.kun))))
...
in (let _109_309 = (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_wild ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s y Microsoft_FStar_Absyn_Syntax.tun))))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), _109_309, false))))
end
| Microsoft_FStar_Parser_AST.PatConst (c) -> begin
(let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (let _109_310 = (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_constant (c)))
...
| (loc, env, xbvd) -> begin
(let _109_311 = (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_var ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s xbvd Microsoft_FStar_Absyn_Syntax.tun))))
...
in (let _109_312 = (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_cons ((l, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), []))))
...
(let _43_905 = (Microsoft_FStar_List.fold_right (fun arg _43_894 -> (match (_43_894) with
| (loc, env, args) -> begin
...
(let l = (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_datacon env) l)
in (let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (let _109_315 = (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_cons ((l, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), args))))
...
(let _43_929 = (Microsoft_FStar_List.fold_right (fun pat _43_917 -> (match (_43_917) with
| (loc, env, pats) -> begin
...
| (loc, env, pats) -> begin
(let pat = (let _109_328 = (let _109_327 = (let _109_323 = (Microsoft_FStar_Range.end_range p.Microsoft_FStar_Parser_AST.prange)
in (pos_r _109_323))
...
in (All.pipe_left _109_327 _109_326)))
in (Microsoft_FStar_List.fold_right (fun hd tl -> (let r = (Microsoft_FStar_Range.union_ranges hd.Microsoft_FStar_Absyn_Syntax.p tl.Microsoft_FStar_Absyn_Syntax.p)
...
in (All.pipe_left (pos_r r) _109_322)))) pats _109_328))
in (let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (loc, env, VBinder ((x, Microsoft_FStar_Absyn_Syntax.tun, None)), pat, false)))
end))
end
| Microsoft_FStar_Parser_AST.PatTuple (args, dep) -> begin
(let _43_955 = (Microsoft_FStar_List.fold_left (fun _43_942 p -> (match (_43_942) with
| (loc, env, pats) -> begin
...
| true -> begin
(Microsoft_FStar_Absyn_Util.mk_dtuple_data_lid (Microsoft_FStar_List.length args) p.Microsoft_FStar_Parser_AST.prange)
end
| false -> begin
(Microsoft_FStar_Absyn_Util.mk_tuple_data_lid (Microsoft_FStar_List.length args) p.Microsoft_FStar_Parser_AST.prange)
end)
...
in (let x = (Microsoft_FStar_Absyn_Util.new_bvd (Some (p.Microsoft_FStar_Parser_AST.prange)))
in (let _109_331 = (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.Pat_cons ((l, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), args))))
...
(let _43_975 = (Microsoft_FStar_List.hd fields)
...
(let fields = (All.pipe_right fields (Microsoft_FStar_List.map (fun _43_982 -> (match (_43_982) with
| (f, p) -> begin
...
in (let args = (All.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Microsoft_FStar_List.map (fun _43_987 -> (match (_43_987) with
| (f, _43_986) -> begin
(match ((All.pipe_right fields (Microsoft_FStar_List.tryFind (fun _43_991 -> (match (_43_991) with
| (g, _43_990) -> begin
...
(let _109_341 = (let _109_340 = (let _109_339 = (let _109_338 = (let _109_337 = (let _109_336 = (All.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Microsoft_FStar_List.map Prims.fst))
...
| _43_1044 -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Unexpected pattern at the top-level", p.Microsoft_FStar_Parser_AST.prange))))
end)
end
| false -> begin
...
in Microsoft_FStar_Util.Inl (_109_361))
end
| false -> begin
(let _109_362 = (desugar_exp env t)
in Microsoft_FStar_Util.Inr (_109_362))
end))
...
(All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.mk_Exp_constant c))
end
| Microsoft_FStar_Parser_AST.Op (s, args) -> begin
(match ((op_as_vlid env (Microsoft_FStar_List.length args) top.Microsoft_FStar_Parser_AST.range s)) with
| None -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (((Prims.strcat "Unexpected operator: " s), top.Microsoft_FStar_Parser_AST.range))))
end
| Some (l) -> begin
(let op = (let _109_385 = (Microsoft_FStar_Absyn_Syntax.range_of_lid l)
in (Microsoft_FStar_Absyn_Util.fvar None l _109_385))
in (let args = (All.pipe_right args (Microsoft_FStar_List.map (fun t -> (let _109_387 = (desugar_typ_or_exp env t)
in (_109_387, None)))))
in (let _109_388 = (Microsoft_FStar_Absyn_Util.mk_exp_app op args)
in (All.pipe_left setpos _109_388))))
end)
end
...
in (All.pipe_left setpos _109_392))
end)
end
| Microsoft_FStar_Parser_AST.Construct (l, args) -> begin
...
in (All.pipe_left pos _109_397))
in (match (args) with
| [] -> begin
dt
end
| _43_1112 -> begin
(let args = (Microsoft_FStar_List.map (fun _43_1115 -> (match (_43_1115) with
| (t, imp) -> begin
...
in (All.pipe_left setpos _109_402)))
end))
end
| Microsoft_FStar_Parser_AST.Abs (binders, body) -> begin
(let _43_1152 = (Microsoft_FStar_List.fold_left (fun _43_1124 pat -> (match (_43_1124) with
| (env, ftvs) -> begin
...
in (let binders = (let _109_413 = (All.pipe_right ftv (Microsoft_FStar_List.map (fun a -> (Microsoft_FStar_Parser_AST.mk_pattern (Microsoft_FStar_Parser_AST.PatTvar ((a, true))) top.Microsoft_FStar_Parser_AST.range))))
in (Microsoft_FStar_List.append _109_413 binders))
...
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_abs' ((Microsoft_FStar_List.rev bs), body) None top.Microsoft_FStar_Parser_AST.range)))
end
| p::rest -> begin
...
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.varg _109_425))
in (_109_426)::[])
...
in (let _109_434 = (Microsoft_FStar_Range.union_ranges p'.Microsoft_FStar_Absyn_Syntax.p p.Microsoft_FStar_Absyn_Syntax.p)
...
(let tup = (Microsoft_FStar_Absyn_Util.mk_tuple_data_lid (1 + (Microsoft_FStar_List.length args)) top.Microsoft_FStar_Parser_AST.range)
...
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.varg _109_436))
in (_109_437)::[])
in (Microsoft_FStar_List.append args _109_438))
...
in (_109_442, Some (Microsoft_FStar_Absyn_Syntax.Data_ctor), (Microsoft_FStar_List.append pats (((p, false))::[]))))
in Microsoft_FStar_Absyn_Syntax.Pat_cons (_109_443))
in (let _109_444 = (Microsoft_FStar_Range.union_ranges p'.Microsoft_FStar_Absyn_Syntax.p p.Microsoft_FStar_Absyn_Syntax.p)
...
in ((Microsoft_FStar_Util.Inr (b), aq), sc_pat_opt)))
end)
...
in (let _109_453 = (let _109_452 = (All.pipe_left Microsoft_FStar_Absyn_Syntax.targ phi)
...
in (All.pipe_left (arg_withimp_e imp) _109_462))
in (aux ((arg)::args) e))
end
| _43_1262 -> begin
(let head = (desugar_exp env e)
in (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.mk_Exp_app (head, args))))
end))
in (aux [] top))
end
...
in (All.pipe_left setpos _109_468))
end
| Microsoft_FStar_Parser_AST.Let (is_rec, (pat, _snd)::_tl, body) -> begin
(let ds_let_rec = (fun _43_1278 -> (match (()) with
| () -> begin
(let bindings = ((pat, _snd))::_tl
in (let funs = (All.pipe_right bindings (Microsoft_FStar_List.map (fun _43_1282 -> (match (_43_1282) with
| (p, def) -> begin
...
in Microsoft_FStar_Util.Inr (_109_474))
in (_109_475, [], Some (t)))
in (_109_476, def))
end
| false -> begin
((Microsoft_FStar_Util.Inl (id), [], Some (t)), def)
end)
end
...
in Microsoft_FStar_Util.Inr (_109_477))
in (_109_478, [], None))
in (_109_479, def))
end
| false -> begin
((Microsoft_FStar_Util.Inl (id), [], None), def)
end)
end
| _43_1306 -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Unexpected let binding", p.Microsoft_FStar_Parser_AST.prange))))
end)
end)
end)
end))))
in (let _43_1332 = (Microsoft_FStar_List.fold_left (fun _43_1310 _43_1319 -> (match ((_43_1310, _43_1319)) with
...
| (env, xx) -> begin
(env, Microsoft_FStar_Util.Inl (xx))
end))
end
...
in (_109_482, Microsoft_FStar_Util.Inr (l)))
end)
...
| (env', fnames) -> begin
(let fnames = (Microsoft_FStar_List.rev fnames)
...
| Some (t) -> begin
(let _109_489 = (Microsoft_FStar_Range.union_ranges t.Microsoft_FStar_Parser_AST.range def.Microsoft_FStar_Parser_AST.range)
...
in (let lbs = (Microsoft_FStar_List.map2 (desugar_one_def (match (is_rec) with
| true -> begin
env'
end
| false -> begin
...
in (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.mk_Exp_let ((is_rec, lbs), body)))))))
end))))
end))
...
(All.failwith "Unexpected type binder in let")
end
| LetBinder (l, t) -> begin
(let body = (desugar_exp env t2)
in (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.mk_Exp_let ((false, ({Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inr (l); Microsoft_FStar_Absyn_Syntax.lbtyp = t; Microsoft_FStar_Absyn_Syntax.lbeff = Microsoft_FStar_Absyn_Const.effect_ALL_lid; Microsoft_FStar_Absyn_Syntax.lbdef = t1})::[]), body))))
end
...
in (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.mk_Exp_let ((false, ((mk_lb (Microsoft_FStar_Util.Inl (x), t, t1)))::[]), body)))))
end)
end))))
...
in (let _109_520 = (Microsoft_FStar_List.map desugar_branch branches)
in (_109_521, _109_520)))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_match _109_522))
in (All.pipe_left pos _109_523)))
end
...
in (All.pipe_left pos _109_529))
end
| Microsoft_FStar_Parser_AST.Record (_43_1428, []) -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Unexpected empty record", top.Microsoft_FStar_Parser_AST.range))))
end
| Microsoft_FStar_Parser_AST.Record (eopt, fields) -> begin
(let _43_1439 = (Microsoft_FStar_List.hd fields)
in (match (_43_1439) with
| (f, _43_1438) -> begin
(let qfn = (fun g -> (Microsoft_FStar_Absyn_Syntax.lid_of_ids (Microsoft_FStar_List.append f.Microsoft_FStar_Absyn_Syntax.ns ((g)::[]))))
...
in (let found = (All.pipe_right fields (Microsoft_FStar_Util.find_opt (fun _43_1453 -> (match (_43_1453) with
| (g, _43_1452) -> begin
...
in (Microsoft_FStar_Util.format1 "Field %s is missing" _109_538))
...
| None -> begin
(let _109_547 = (let _109_546 = (All.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Microsoft_FStar_List.map (fun _43_1469 -> (match (_43_1469) with
| (f, _43_1468) -> begin
(let _109_545 = (let _109_544 = (get_field None f)
in (All.pipe_left Prims.snd _109_544))
...
in (let record = (let _109_552 = (let _109_551 = (All.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Microsoft_FStar_List.map (fun _43_1477 -> (match (_43_1477) with
| (f, _43_1476) -> begin
...
(let e = (let _109_562 = (let _109_561 = (let _109_560 = (let _109_559 = (let _109_558 = (let _109_557 = (let _109_556 = (let _109_555 = (All.pipe_right record.Microsoft_FStar_Parser_DesugarEnv.fields (Microsoft_FStar_List.map Prims.fst))
...
in (let fn = (let _43_1527 = (Microsoft_FStar_Util.prefix fieldname.Microsoft_FStar_Absyn_Syntax.ns)
in (match (_43_1527) with
| (ns, _43_1526) -> begin
(Microsoft_FStar_Absyn_Syntax.lid_of_ids (Microsoft_FStar_List.append ns ((f.Microsoft_FStar_Absyn_Syntax.ident)::[])))
end))
...
in (All.pipe_right _109_594 Microsoft_FStar_Absyn_Util.b2t))
end))
end
...
in (All.pipe_right _109_595 Microsoft_FStar_Absyn_Util.b2t))
end))
end
...
in (All.pipe_right _109_600 (Microsoft_FStar_List.map (fun t -> (let _109_599 = (desugar_typ env t)
in (Microsoft_FStar_Absyn_Syntax.targ _109_599))))))
in (let tup = (let _109_601 = (Microsoft_FStar_Absyn_Util.mk_tuple_lid (Microsoft_FStar_List.length targs) top.Microsoft_FStar_Parser_AST.range)
in (Microsoft_FStar_Parser_DesugarEnv.fail_or env (Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_name env) _109_601))
in (All.pipe_left wpos (Microsoft_FStar_Absyn_Syntax.mk_Typ_app (tup, targs))))))
end
| false -> begin
(let _109_607 = (let _109_606 = (let _109_605 = (let _109_604 = (Microsoft_FStar_Parser_AST.term_to_string t1)
in (Microsoft_FStar_Util.format1 "The operator \"*\" is resolved here as multiplication since \"%s\" is a term, although a type was expected" _109_604))
...
| Microsoft_FStar_Parser_AST.Op (s, args) -> begin
(match ((op_as_tylid env (Microsoft_FStar_List.length args) top.Microsoft_FStar_Parser_AST.range s)) with
| None -> begin
(let _109_608 = (desugar_exp env top)
in (All.pipe_right _109_608 Microsoft_FStar_Absyn_Util.b2t))
end
| Some (l) -> begin
(let args = (Microsoft_FStar_List.map (fun t -> (let _109_610 = (desugar_typ_or_exp env t)
in (All.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _109_610))) args)
...
in (All.pipe_left setpos _109_612))
end
| (Microsoft_FStar_Parser_AST.Var (l)) | (Microsoft_FStar_Parser_AST.Name (l)) when ((Microsoft_FStar_List.length l.Microsoft_FStar_Absyn_Syntax.ns) = 0) -> begin
(match ((Microsoft_FStar_Parser_DesugarEnv.try_lookup_typ_var env l.Microsoft_FStar_Absyn_Syntax.ident)) with
| Some (t) -> begin
...
in (All.pipe_left setpos _109_613))
end)
end
| (Microsoft_FStar_Parser_AST.Var (l)) | (Microsoft_FStar_Parser_AST.Name (l)) -> begin
...
in (All.pipe_left setpos _109_614)))
end
| Microsoft_FStar_Parser_AST.Construct (l, args) -> begin
...
in (All.pipe_left setpos _109_615))
in (let args = (Microsoft_FStar_List.map (fun _43_1622 -> (match (_43_1622) with
| (t, imp) -> begin
(let _109_617 = (desugar_typ_or_exp env t)
in (All.pipe_left (arg_withimp_t imp) _109_617))
end)) args)
...
in (All.pipe_left wpos (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam ((Microsoft_FStar_List.rev bs), body))))
end
| hd::tl -> begin
...
in (Microsoft_FStar_Util.format1 "Pattern matching at the type level is not supported; got %s\n" _109_626))
...
in (All.pipe_left (arg_withimp_t imp) _109_635))
in (aux ((arg)::args) e))
end
| _43_1658 -> begin
(let head = (desugar_typ env e)
in (All.pipe_left wpos (Microsoft_FStar_Absyn_Syntax.mk_Typ_app (head, args))))
end))
in (aux [] top))
end
| Microsoft_FStar_Parser_AST.Product ([], t) -> begin
(All.failwith "Impossible: product with no binders")
end
| Microsoft_FStar_Parser_AST.Product (binders, t) -> begin
...
in (All.pipe_left wpos (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun ((Microsoft_FStar_List.rev bs), cod))))
end
| hd::tl -> begin
...
| (None, _43_1691) -> begin
(All.failwith "Missing binder in refinement")
end
| b -> begin
(let _43_1705 = (match ((as_binder env None (Microsoft_FStar_Util.Inr (b)))) with
| ((Microsoft_FStar_Util.Inr (x), _43_1697), env) -> begin
(x, env)
end
| _43_1702 -> begin
(All.failwith "impossible")
...
in (All.pipe_right _109_646 Microsoft_FStar_Absyn_Util.b2t))
end)
in (All.pipe_left wpos (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine (b, f))))
end))
end)
end
...
in (All.pipe_left wpos _109_654))
end
| Microsoft_FStar_Parser_AST.Sum (binders, t) -> begin
(let _43_1739 = (Microsoft_FStar_List.fold_left (fun _43_1724 b -> (match (_43_1724) with
...
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _109_658))
in (_109_659)::[])
in (Microsoft_FStar_List.append typs _109_660))
in (env, (Microsoft_FStar_List.append tparams (((Microsoft_FStar_Util.Inr ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t)), None))::[])), _109_661))
end))
end))
end)) (env, [], []) (Microsoft_FStar_List.append binders (((Microsoft_FStar_Parser_AST.mk_binder (Microsoft_FStar_Parser_AST.NoName (t)) t.Microsoft_FStar_Parser_AST.range Microsoft_FStar_Parser_AST.Type None))::[])))
in (match (_43_1739) with
| (env, _43_1737, targs) -> begin
(let tup = (let _109_662 = (Microsoft_FStar_Absyn_Util.mk_dtuple_lid (Microsoft_FStar_List.length targs) top.Microsoft_FStar_Parser_AST.range)
...
(All.failwith "Unexpected record type")
end
...
and desugar_comp = (fun r default_ok env t -> (let fail = (fun msg -> (Prims.raise (Microsoft_FStar_Absyn_Syntax.Error ((msg, r)))))
...
in (let _43_1790 = (All.pipe_right args (Microsoft_FStar_List.partition (fun _43_1772 -> (match (_43_1772) with
| (arg, _43_1771) -> begin
...
| [] -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Not enough arguments to \'Lemma\'", t.Microsoft_FStar_Parser_AST.range))))
end
| ens::[] -> begin
...
in (let t = (Microsoft_FStar_Parser_AST.mk_term (Microsoft_FStar_Parser_AST.Construct ((lemma, (Microsoft_FStar_List.append args decreases_clause)))) t.Microsoft_FStar_Parser_AST.range t.Microsoft_FStar_Parser_AST.level)
...
(let args = (Microsoft_FStar_List.map (fun _43_1805 -> (match (_43_1805) with
| (t, imp) -> begin
(let _109_677 = (desugar_typ_or_exp env t)
in (All.pipe_left (arg_withimp_t imp) _109_677))
end)) args)
...
| (Microsoft_FStar_Absyn_Syntax.Typ_const (eff), (Microsoft_FStar_Util.Inl (result_typ), _43_1819)::rest) -> begin
(let _43_1859 = (All.pipe_right rest (Microsoft_FStar_List.partition (fun _43_10 -> (match (_43_10) with
| (Microsoft_FStar_Util.Inr (_43_1825), _43_1828) -> begin
false
end
| (Microsoft_FStar_Util.Inl (t), _43_1833) -> begin
(match (t.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_app ({Microsoft_FStar_Absyn_Syntax.n = Microsoft_FStar_Absyn_Syntax.Typ_const (fv); Microsoft_FStar_Absyn_Syntax.tk = _43_1842; Microsoft_FStar_Absyn_Syntax.pos = _43_1840; Microsoft_FStar_Absyn_Syntax.fvs = _43_1838; Microsoft_FStar_Absyn_Syntax.uvs = _43_1836}, (Microsoft_FStar_Util.Inr (_43_1847), _43_1850)::[]) -> begin
...
| (dec, rest) -> begin
(let decreases_clause = (All.pipe_right dec (Microsoft_FStar_List.map (fun _43_11 -> (match (_43_11) with
| (Microsoft_FStar_Util.Inl (t), _43_1864) -> begin
(match (t.Microsoft_FStar_Absyn_Syntax.n) with
| Microsoft_FStar_Absyn_Syntax.Typ_app (_43_1867, (Microsoft_FStar_Util.Inr (arg), _43_1871)::[]) -> begin
...
| true -> begin
(match (((Microsoft_FStar_Absyn_Syntax.lid_equals eff.Microsoft_FStar_Absyn_Syntax.v Microsoft_FStar_Absyn_Const.effect_Tot_lid) && ((Microsoft_FStar_List.length decreases_clause) = 0))) with
| true -> begin
...
in (Microsoft_FStar_Absyn_Syntax.mk_Comp {Microsoft_FStar_Absyn_Syntax.effect_name = eff.Microsoft_FStar_Absyn_Syntax.v; Microsoft_FStar_Absyn_Syntax.result_typ = result_typ; Microsoft_FStar_Absyn_Syntax.effect_args = rest; Microsoft_FStar_Absyn_Syntax.flags = (Microsoft_FStar_List.append flags decreases_clause)}))
end)
end
| false -> begin
...
in (Microsoft_FStar_Util.format1 "%s is not an effect" _109_683))
in (fail _109_684))
end)
end))
end))
...
in (Microsoft_FStar_Util.format1 "%s is not an effect" _109_685))
in (fail _109_686))
end)
end)
end))))))
...
| Some (l) -> begin
(All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.mk_Kind_abbrev ((l, []), Microsoft_FStar_Absyn_Syntax.mk_Kind_unknown)))
end
| _43_1916 -> begin
...
| Some (l) -> begin
(let args = (Microsoft_FStar_List.map (fun _43_1945 -> (match (_43_1945) with
| (t, b) -> begin
...
in (All.pipe_left pos (Microsoft_FStar_Absyn_Syntax.mk_Kind_abbrev ((l, args), Microsoft_FStar_Absyn_Syntax.mk_Kind_unknown))))
end)
end
| _43_1949 -> begin
(Microsoft_FStar_Parser_AST.error "Unexpected term where kind was expected" k k.Microsoft_FStar_Parser_AST.range)
...
| (env, a) -> begin
(let pats = (Microsoft_FStar_List.map (fun e -> (let _109_744 = (desugar_typ_or_exp env e)
in (All.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _109_744))) pats)
...
in (All.pipe_left setpos _109_745))
end)
...
in (All.pipe_left setpos _109_756))))))
end))
end
| Microsoft_FStar_Util.Inr (Some (x), t) -> begin
...
| (env, x) -> begin
(let pats = (Microsoft_FStar_List.map (fun e -> (let _109_758 = (desugar_typ_or_exp env e)
in (All.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _109_758))) pats)
in (let body = (desugar_formula env body)
in (let body = (match (pats) with
| [] -> begin
body
...
in (All.pipe_left setpos _109_769))))))
end))
end
| _43_2009 -> begin
(All.failwith "impossible")
...
in (let _109_783 = (Microsoft_FStar_Range.union_ranges b'.Microsoft_FStar_Parser_AST.brange body.Microsoft_FStar_Parser_AST.range)
...
(let args = (hd)::_args
in (let args = (Microsoft_FStar_List.map (fun t -> (let _109_788 = (desugar_typ_or_exp env t)
in (All.pipe_left (arg_withimp_t Microsoft_FStar_Parser_AST.Nothing) _109_788))) args)
...
in (let _109_794 = (Microsoft_FStar_List.map (fun x -> (let _109_793 = (desugar_formula env x)
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _109_793))) args)
...
in (All.pipe_right _109_796 Microsoft_FStar_Absyn_Util.b2t))
end)
end)
end
| Microsoft_FStar_Parser_AST.If (f1, f2, f3) -> begin
...
in (let _109_800 = (Microsoft_FStar_List.map (fun x -> (match ((desugar_typ_or_exp env x)) with
...
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _109_799))
end)) ((f1)::(f2)::(f3)::[]))
...
in (All.pipe_left Microsoft_FStar_Absyn_Util.b2t _109_806))
end)
end)))))))
...
in Microsoft_FStar_Util.Inl (_109_811))
end
| false -> begin
(let _109_812 = (desugar_exp_binder env b)
in Microsoft_FStar_Util.Inr (_109_812))
end))
and typars_of_binders = (fun env bs -> (let _43_2138 = (Microsoft_FStar_List.fold_left (fun _43_2113 b -> (match (_43_2113) with
| (env, out) -> begin
...
| (env, a) -> begin
(env, ((Microsoft_FStar_Util.Inl ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s a k)), b.Microsoft_FStar_Parser_AST.aqual))::out)
end))
end
| Microsoft_FStar_Util.Inr (Some (x), t) -> begin
...
| (env, x) -> begin
(env, ((Microsoft_FStar_Util.Inr ((Microsoft_FStar_Absyn_Util.bvd_to_bvar_s x t)), b.Microsoft_FStar_Parser_AST.aqual))::out)
end))
end
| _43_2135 -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Unexpected binder", b.Microsoft_FStar_Parser_AST.brange))))
end))
end)) (env, []) bs)
in (match (_43_2138) with
| (env, tpars) -> begin
(env, (Microsoft_FStar_List.rev tpars))
end)))
...
| _43_2152 -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Unexpected domain of an arrow or sum (expected a type)", b.Microsoft_FStar_Parser_AST.brange))))
end))
and desugar_type_binder = (fun env b -> (let fail = (fun _43_2156 -> (match (()) with
| () -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Unexpected domain of an arrow or sum (expected a kind)", b.Microsoft_FStar_Parser_AST.brange))))
end))
...
(aux (Microsoft_FStar_List.append bs binders) k)
end
...
in (All.pipe_right _109_836 Microsoft_FStar_Absyn_Util.name_binders))))

let mk_data_discriminators = (fun quals env t tps k datas -> (let quals = (fun q -> (match (((All.pipe_left Prims.op_Negation env.Microsoft_FStar_Parser_DesugarEnv.iface) || env.Microsoft_FStar_Parser_DesugarEnv.admitted_iface)) with
| true -> begin
(Microsoft_FStar_List.append ((Microsoft_FStar_Absyn_Syntax.Assumption)::q) quals)
end
| false -> begin
(Microsoft_FStar_List.append q quals)
end))
in (let binders = (gather_tc_binders tps k)
in (let p = (Microsoft_FStar_Absyn_Syntax.range_of_lid t)
in (let imp_binders = (All.pipe_right binders (Microsoft_FStar_List.map (fun _43_2200 -> (match (_43_2200) with
| (x, _43_2199) -> begin
...
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.null_v_binder _109_855))
in (_109_856)::[])
in (Microsoft_FStar_List.append imp_binders _109_857))
...
in (All.pipe_right datas (Microsoft_FStar_List.map (fun d -> (let disc_name = (Microsoft_FStar_Absyn_Util.mk_discriminator d)
...
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.varg _109_879))
in (_109_880)::[])
...
in (All.pipe_left (Microsoft_FStar_Absyn_Util.bvd_to_bvar_s projectee) _109_887))
in (All.pipe_left Microsoft_FStar_Absyn_Syntax.v_binder _109_888))))
end))
in (let imp_binders = (All.pipe_right binders (Microsoft_FStar_List.map (fun _43_2229 -> (match (_43_2229) with
| (x, _43_2228) -> begin
(x, Some (Microsoft_FStar_Absyn_Syntax.Implicit))
end))))
in (let binders = (Microsoft_FStar_List.append imp_binders ((arg_binder)::[]))
in (let arg = (Microsoft_FStar_Absyn_Util.arg_of_non_null_binder arg_binder)
in (let subst = (let _109_898 = (All.pipe_right formals (Microsoft_FStar_List.mapi (fun i f -> (match ((Prims.fst f)) with
| Microsoft_FStar_Util.Inl (a) -> begin
(match ((All.pipe_right binders (Microsoft_FStar_Util.for_some (fun _43_13 -> (match (_43_13) with
| (Microsoft_FStar_Util.Inl (b), _43_2241) -> begin
...
in (Microsoft_FStar_Util.Inl ((a.Microsoft_FStar_Absyn_Syntax.v, proj)))::[])
end))
end)
end
| Microsoft_FStar_Util.Inr (x) -> begin
(match ((All.pipe_right binders (Microsoft_FStar_Util.for_some (fun _43_14 -> (match (_43_14) with
| (Microsoft_FStar_Util.Inr (y), _43_2256) -> begin
...
in (Microsoft_FStar_Util.Inr ((x.Microsoft_FStar_Absyn_Syntax.v, proj)))::[])
end))
end)
end))))
in (All.pipe_right _109_898 Microsoft_FStar_List.flatten))
in (let ntps = (Microsoft_FStar_List.length tps)
in (let _109_936 = (All.pipe_right formals (Microsoft_FStar_List.mapi (fun i ax -> (match ((Prims.fst ax)) with
| Microsoft_FStar_Util.Inl (a) -> begin
...
in (field_name, [], kk, [], [], (Microsoft_FStar_Absyn_Syntax.Logic)::(Microsoft_FStar_Absyn_Syntax.Projector ((lid, Microsoft_FStar_Util.Inl (a.Microsoft_FStar_Absyn_Syntax.v))))::[], _109_903))
...
in (let quals = (quals ((Microsoft_FStar_Absyn_Syntax.Logic)::(Microsoft_FStar_Absyn_Syntax.Projector ((lid, Microsoft_FStar_Util.Inr (x.Microsoft_FStar_Absyn_Syntax.v))))::[]))
in (let impl = (match ((((let _109_911 = (Microsoft_FStar_Parser_DesugarEnv.current_module env)
in (Microsoft_FStar_Absyn_Syntax.lid_equals Microsoft_FStar_Absyn_Const.prims_lid _109_911)) || (fvq <> Microsoft_FStar_Absyn_Syntax.Data_ctor)) || (ST.read Microsoft_FStar_Options.__temp_no_proj))) with
| true -> begin
[]
end
| false -> begin
...
in (let arg_pats = (let _109_926 = (All.pipe_right formals (Microsoft_FStar_List.mapi (fun j by -> (match (by) with
| (Microsoft_FStar_Util.Inl (_43_2296), imp) -> begin
(match ((j < ntps)) with
| true -> begin
[]
end
...
| (Microsoft_FStar_Util.Inr (_43_2301), imp) -> begin
(match ((i = j)) with
| true -> begin
...
in (All.pipe_right _109_926 Microsoft_FStar_List.flatten))
...
in (All.pipe_right _109_929 pos))
...
in (let lb = {Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inr (field_name); Microsoft_FStar_Absyn_Syntax.lbtyp = Microsoft_FStar_Absyn_Syntax.tun; Microsoft_FStar_Absyn_Syntax.lbeff = Microsoft_FStar_Absyn_Const.effect_Tot_lid; Microsoft_FStar_Absyn_Syntax.lbdef = imp}
...
in (All.pipe_right _109_936 Microsoft_FStar_List.flatten)))))))))))))
end))
...
(let refine_domain = (match ((All.pipe_right quals (Microsoft_FStar_Util.for_some (fun _43_16 -> (match (_43_16) with
...
| Some (l) -> begin
((Microsoft_FStar_List.length l) > 1)
end
| _43_2338 -> begin
true
end)
...
in (let qual = (match ((Microsoft_FStar_Util.find_map quals (fun _43_17 -> (match (_43_17) with
...
in (let apply_binders = (fun t binders -> (Microsoft_FStar_List.fold_left (fun out b -> (let _109_967 = (let _109_966 = (let _109_965 = (binder_to_term b)
...
(let constrName = (Microsoft_FStar_Absyn_Syntax.mk_ident ((Prims.strcat "Mk" id.Microsoft_FStar_Absyn_Syntax.idText), id.Microsoft_FStar_Absyn_Syntax.idRange))
in (let mfields = (Microsoft_FStar_List.map (fun _43_2429 -> (match (_43_2429) with
| (x, t) -> begin
...
in (let _109_978 = (All.pipe_right fields (Microsoft_FStar_List.map (fun _43_2436 -> (match (_43_2436) with
| (x, _43_2435) -> begin
...
(let k = (match (kopt) with
| None -> begin
(match ((Microsoft_FStar_Util.for_some (fun _43_23 -> (match (_43_23) with
...
in (let t0 = t
in (let quals = (match ((All.pipe_right quals (Microsoft_FStar_Util.for_some (fun _43_24 -> (match (_43_24) with
...
in (let se = (match ((All.pipe_right quals (Microsoft_FStar_List.contains Microsoft_FStar_Absyn_Syntax.Effect))) with
| true -> begin
...
in (let _109_999 = (All.pipe_right quals (Microsoft_FStar_List.filter (fun _43_25 -> (match (_43_25) with
| Microsoft_FStar_Absyn_Syntax.Effect -> begin
false
end
| _43_2520 -> begin
...
(let trec = (Microsoft_FStar_List.hd tcs)
...
(let env0 = env
in (let mutuals = (Microsoft_FStar_List.map (fun x -> (All.pipe_left (Microsoft_FStar_Parser_DesugarEnv.qualify env) (tycon_id x))) tcs)
...
(env, (Microsoft_FStar_Util.Inl ((se, tps, constructors, tconstr, quals)))::tcs)
end))
end
| Microsoft_FStar_Parser_AST.TyconAbbrev (id, binders, kopt, t) -> begin
...
(env, (Microsoft_FStar_Util.Inr ((se, tps, t, quals)))::tcs)
end))
end
| _43_2583 -> begin
(All.failwith "Unrecognized mutual type definition")
end)
end)))
in (let _43_2586 = (Microsoft_FStar_List.fold_left (collect_tcs quals) (env, []) tcs)
in (match (_43_2586) with
| (env, tcs) -> begin
(let tcs = (Microsoft_FStar_List.rev tcs)
in (let sigelts = (All.pipe_right tcs (Microsoft_FStar_List.collect (fun _43_27 -> (match (_43_27) with
| Microsoft_FStar_Util.Inr (Microsoft_FStar_Absyn_Syntax.Sig_tycon (id, tpars, k, _43_2593, _43_2595, _43_2597, _43_2599), tps, t, quals) -> begin
...
| Microsoft_FStar_Util.Inl (Microsoft_FStar_Absyn_Syntax.Sig_tycon (tname, tpars, k, mutuals, _43_2614, tags, _43_2617), tps, constrs, tconstr, quals) -> begin
(let tycon = (tname, tpars, k)
in (let env_tps = (push_tparams env tps)
in (let _43_2653 = (let _109_1022 = (All.pipe_right constrs (Microsoft_FStar_List.map (fun _43_2631 -> (match (_43_2631) with
...
in (let quals = (All.pipe_right tags (Microsoft_FStar_List.collect (fun _43_26 -> (match (_43_26) with
...
in (let _109_1021 = (let _109_1020 = (let _109_1019 = (let _109_1018 = (let _109_1017 = (Microsoft_FStar_List.map (fun _43_2650 -> (match (_43_2650) with
| (x, _43_2649) -> begin
(x, Some (Microsoft_FStar_Absyn_Syntax.Implicit))
end)) tps)
in (Microsoft_FStar_Absyn_Util.close_typ _109_1017 t))
in (All.pipe_right _109_1018 Microsoft_FStar_Absyn_Util.name_function_binders))
in (name, _109_1019, tycon, quals, mutuals, rng))
in Microsoft_FStar_Absyn_Syntax.Sig_datacon (_109_1020))
in (name, _109_1021))))))
end))))
in (All.pipe_left Microsoft_FStar_List.split _109_1022))
...
in (let bundle = (let _109_1024 = (let _109_1023 = (Microsoft_FStar_List.collect Microsoft_FStar_Absyn_Util.lids_of_sigelt sigelts)
...
in (let data_ops = (All.pipe_right sigelts (Microsoft_FStar_List.collect (mk_data_projectors env)))
in (let discs = (All.pipe_right sigelts (Microsoft_FStar_List.collect (fun _43_28 -> (match (_43_28) with
...
in (let ops = (Microsoft_FStar_List.append discs data_ops)
in (let env = (Microsoft_FStar_List.fold_left Microsoft_FStar_Parser_DesugarEnv.push_sigelt env ops)
in (env, (Microsoft_FStar_List.append ((bundle)::[]) ops))))))))))
end)))))
end
| [] -> begin
(All.failwith "impossible")
...
let desugar_binders = (fun env binders -> (let _43_2704 = (Microsoft_FStar_List.fold_left (fun _43_2682 b -> (match (_43_2682) with
| (env, binders) -> begin
...
| _43_2701 -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (("Missing name in binder", b.Microsoft_FStar_Parser_AST.brange))))
end)
end)) (env, []) binders)
in (match (_43_2704) with
| (env, binders) -> begin
(env, (Microsoft_FStar_List.rev binders))
end)))
...
in (All.pipe_left Microsoft_FStar_Absyn_Util.compress_exp _109_1040))
in _109_1041.Microsoft_FStar_Absyn_Syntax.n)) with
| Microsoft_FStar_Absyn_Syntax.Exp_let (lbs, _43_2723) -> begin
(let lids = (All.pipe_right (Prims.snd lbs) (Microsoft_FStar_List.map (fun lb -> (match (lb.Microsoft_FStar_Absyn_Syntax.lbname) with
| Microsoft_FStar_Util.Inr (l) -> begin
l
end
| _43_2730 -> begin
...
in (let quals = (All.pipe_right (Prims.snd lbs) (Microsoft_FStar_List.collect (fun _43_29 -> (match (_43_29) with
| {Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inl (_43_2740); Microsoft_FStar_Absyn_Syntax.lbtyp = _43_2738; Microsoft_FStar_Absyn_Syntax.lbeff = _43_2736; Microsoft_FStar_Absyn_Syntax.lbdef = _43_2734} -> begin
[]
end
| {Microsoft_FStar_Absyn_Syntax.lbname = Microsoft_FStar_Util.Inr (l); Microsoft_FStar_Absyn_Syntax.lbtyp = _43_2748; Microsoft_FStar_Absyn_Syntax.lbeff = _43_2746; Microsoft_FStar_Absyn_Syntax.lbdef = _43_2744} -> begin
...
| _43_2756 -> begin
(All.failwith "Desugaring a let did not produce a let")
end)
end
...
in (let env = (Microsoft_FStar_List.fold_left Microsoft_FStar_Parser_DesugarEnv.push_sigelt env (Microsoft_FStar_List.append discs data_ops))
in (env, (Microsoft_FStar_List.append ((se')::discs) data_ops))))))))))
end
...
in (let _43_2866 = (All.pipe_right eff_decls (Microsoft_FStar_List.fold_left (fun _43_2859 decl -> (match (_43_2859) with
| (env, out) -> begin
(let _43_2863 = (desugar_decl env decl)
in (match (_43_2863) with
| (env, ses) -> begin
(let _109_1085 = (let _109_1084 = (Microsoft_FStar_List.hd ses)
in (_109_1084)::out)
in (env, _109_1085))
end))
end)) (env, [])))
...
| (env, decls) -> begin
(let decls = (Microsoft_FStar_List.rev decls)
...
| None -> begin
(Prims.raise (Microsoft_FStar_Absyn_Syntax.Error (((Prims.strcat (Prims.strcat (Prims.strcat "Monad " eff_name.Microsoft_FStar_Absyn_Syntax.idText) " expects definition of ") s), d.Microsoft_FStar_Parser_AST.drange))))
end
| Some (t) -> begin
t
end))
...
let desugar_decls = (fun env decls -> (Microsoft_FStar_List.fold_left (fun _43_2891 d -> (match (_43_2891) with
| (env, sigelts) -> begin
(let _43_2895 = (desugar_decl env d)
in (match (_43_2895) with
| (env, se) -> begin
(env, (Microsoft_FStar_List.append sigelts se))
end))
end)) (env, []) decls))
...
let desugar_modul_common = (fun curmod env m -> (let open_ns = (fun mname d -> (let d = (match (((Microsoft_FStar_List.length mname.Microsoft_FStar_Absyn_Syntax.ns) <> 0)) with
| true -> begin
...
let desugar_partial_modul = (fun curmod env m -> (let m = (match ((ST.read Microsoft_FStar_Options.interactive_fsi)) with
| true -> begin
(match (m) with
| Microsoft_FStar_Parser_AST.Module (mname, decls) -> begin
(let _109_1139 = (let _109_1138 = (let _109_1137 = (ST.read Microsoft_FStar_Options.admit_fsi)
in (Microsoft_FStar_Util.for_some (fun m -> (m = mname.Microsoft_FStar_Absyn_Syntax.str)) _109_1137))
...
(All.failwith (Prims.strcat "Impossible: " mname.Microsoft_FStar_Absyn_Syntax.ident.Microsoft_FStar_Absyn_Syntax.idText))
end)
end
| false -> begin
m
...
let desugar_file = (fun env f -> (let _43_2963 = (Microsoft_FStar_List.fold_left (fun _43_2956 m -> (match (_43_2956) with
| (env, mods) -> begin
...
| (env, mods) -> begin
(env, (Microsoft_FStar_List.rev mods))
end)))
...
in (let en = (Microsoft_FStar_List.fold_left Microsoft_FStar_Parser_DesugarEnv.push_sigelt (let _43_2967 = en
