      ...
      let qualify_kremlin_private impl1 =
        let krem_private =
          FStar_Parser_AST.mk_term
           ...
           in
        let uu___179_348 = impl1  in
        {
          FStar_Parser_AST.d = (uu___179_348.FStar_Parser_AST.d);
          FStar_Parser_AST.drange = (uu___179_348.FStar_Parser_AST.drange);
          FStar_Parser_AST.doc = (uu___179_348.FStar_Parser_AST.doc);
          FStar_Parser_AST.quals = (uu___179_348.FStar_Parser_AST.quals);
                            ...
                            | uu____1494::uu____1495 when
                                ...
                                let uu____1510 =
                                  ...
                                  (FStar_Errors.Fatal_InterfaceNotImplementedByModule,
                                    uu____1516)
                                   in
                                let uu____1522 = FStar_Ident.range_of_lid l
                                   in
                                FStar_Errors.raise_error uu____1510
                                  uu____1522
                            | uu____1527 -> (a1, env1)))))
