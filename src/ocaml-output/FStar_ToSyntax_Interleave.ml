...
(FStar_All.pipe_right tys (FStar_List.collect (fun uu___191_79 -> (match (uu___191_79) with
...
| FStar_Parser_AST.Tycon (uu____138, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___192_155 -> (match (uu___192_155) with
...
| FStar_Parser_AST.Tycon (uu____351, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___193_368 -> (match (uu___193_368) with
