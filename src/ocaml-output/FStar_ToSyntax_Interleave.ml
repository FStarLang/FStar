                   ...
                   FStar_All.pipe_right def_ids
                     (FStar_Util.for_some
                        (fun y  ->
                           ...
                           FStar_All.pipe_right iface_tl uu___1))
                    in
                 (if uu___
                  then
                    let uu___1 =
                    ...
                    | (y::ys,iface_hd1::iface_tl1) ->
                        ...
                        then
                          ...
                          (let uu___3 =
                             ...
                             FStar_All.pipe_left FStar_Option.isSome uu___4
                              in
                           if uu___3
                           then
                             let uu___4 =
    ...
    fun l  ->
      fun env  ->
        ...
        | FStar_Pervasives_Native.None  ->
            let uu___1 = FStar_Syntax_DsEnv.set_iface_decls env mname decls
               in
            ((), uu___1)
                       ...
                       | (iface_lets,remaining_iface_vals) ->
                           ...
                           (match remaining_iface_vals with
                            | uu___3::uu___4 when expect_complete_modul ->
                                ...
                                let uu___5 =
                                  let uu___6 =
                                    let uu___7 = FStar_Ident.string_of_lid l
                                       in
                                    FStar_Util.format2
