                      ...
                      let uu____205 =
                        let uu____208 =
                          ...
                          FStar_Util.format2
                            ...
                            x.FStar_Ident.idText uu____209
                           in
    ...
    let rec aux iface2 =
      ...
      | hd1::tl1 ->
          (match hd1.FStar_Parser_AST.d with
           ...
           | FStar_Parser_AST.Val (x,t) ->
               let uu____399 = FStar_Util.for_some (is_definition_of x) tl1
                  in
               if uu____399
               then
                 let uu____400 =
            ...
            let uu____537 =
              let uu____538 =
                let uu____541 =
                  ...
                  FStar_Util.format1
                    "Interface %s has already been processed" uu____542
                   in
                      ...
                      (match iface2 with
                       | uu____680::uu____681 when expect_complete_modul ->
                           ...
                           let uu____687 =
                             let uu____688 =
                               let uu____691 =
                                 let uu____692 = FStar_Ident.string_of_lid l
                                    in
                                 FStar_Util.format2
