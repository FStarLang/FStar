...
(FStar_All.pipe_right tys (FStar_List.collect (fun uu___216_140 -> (match (uu___216_140) with
...
| FStar_Parser_AST.Tycon (uu____230, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___217_265 -> (match (uu___217_265) with
...
| FStar_Parser_AST.Tycon (uu____599, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___218_634 -> (match (uu___218_634) with
