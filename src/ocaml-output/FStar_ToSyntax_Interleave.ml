...
(FStar_All.pipe_right tys (FStar_List.collect (fun uu___203_140 -> (match (uu___203_140) with
...
| FStar_Parser_AST.Tycon (uu____230, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___204_265 -> (match (uu___204_265) with
...
| FStar_Parser_AST.Tycon (uu____599, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___205_634 -> (match (uu___205_634) with
