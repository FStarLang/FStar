               ...
               FStar_All.pipe_right tys
                 (FStar_Util.for_some
                    (fun uu___1_413 ->
                       ...
                       | (FStar_Parser_AST.TyconAbstract uu____421,
                          uu____422) -> true
                       | uu____438 -> false))
               ->
                    ...
                    let uu____491 =
                      let uu____497 =
                        ...
                        FStar_Util.format2
                          ...
                          x.FStar_Ident.idText uu____499 in
                      (FStar_Errors.Fatal_WrongDefinitionOrder, uu____497) in
                           ...
                           then
                             let uu____676 =
                               let uu____682 =
                                 ...
                                 let uu____686 = FStar_Ident.string_of_lid y in
                                 FStar_Util.format2
    ...
    let rec aux iface2 =
      ...
      | hd1::tl1 ->
          (match hd1.FStar_Parser_AST.d with
               ...
               FStar_All.pipe_right tys
                 (FStar_Util.for_some
                    (fun uu___2_830 ->
                       ...
                       | (FStar_Parser_AST.TyconAbstract uu____838,
                          uu____839) -> true
                       | uu____855 -> false))
               ->
               FStar_Errors.raise_error
           ...
           | FStar_Parser_AST.Val (x, t) ->
               let uu____867 = FStar_Util.for_some (is_definition_of x) tl1 in
               if uu____867
               then
                 let uu____870 =
                   let uu____876 =
                   ...
                   (FStar_Errors.Fatal_BothValAndLetInInterface, uu____876) in
                   ...
                   FStar_List.fold_left
                     (fun uu____1288 ->
                        fun impl ->
                          ...
                          | (iface2, impls1) ->
                              let uu____1316 = prefix_one_decl iface2 impl in
                  ...
                  | (iface2, impls1) ->
                      ...
                      (match uu____1365 with
                       | (iface_lets, remaining_iface_vals) ->
                           ...
                           let env1 =
                             let uu____1474 = FStar_Options.interactive () in
                             if uu____1474
                             then
                            ...
                            | uu____1486::uu____1487 when
                                ...
                                let uu____1502 =
                                  ...
                                  (FStar_Errors.Fatal_InterfaceNotImplementedByModule,
                                    uu____1508) in
                                let uu____1514 = FStar_Ident.range_of_lid l in
