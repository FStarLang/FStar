...
(FStar_All.pipe_right tys (FStar_List.collect (fun uu___196_79 -> (match (uu___196_79) with
...
| FStar_Parser_AST.Tycon (uu____138, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___197_155 -> (match (uu___197_155) with
...
| FStar_Parser_AST.Tycon (uu____351, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___198_368 -> (match (uu___198_368) with
