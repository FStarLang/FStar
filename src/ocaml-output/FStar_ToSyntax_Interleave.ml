      ...
      let qualify_kremlin_private impl1 =
        let krem_private =
          FStar_Parser_AST.mk_term
           ...
           in
        let uu___167_292 = impl1  in
        {
          FStar_Parser_AST.d = (uu___167_292.FStar_Parser_AST.d);
          FStar_Parser_AST.drange = (uu___167_292.FStar_Parser_AST.drange);
          FStar_Parser_AST.doc = (uu___167_292.FStar_Parser_AST.doc);
          FStar_Parser_AST.quals = (uu___167_292.FStar_Parser_AST.quals);
                      ...
                      let uu____420 =
                        let uu____425 =
                          ...
                          FStar_Util.format2
                            ...
                            x.FStar_Ident.idText uu____426
                           in
    ...
    let rec aux iface2 =
      ...
      | hd1::tl1 ->
          (match hd1.FStar_Parser_AST.d with
           ...
           | FStar_Parser_AST.Val (x,t) ->
               let uu____752 = FStar_Util.for_some (is_definition_of x) tl1
                  in
               if uu____752
               then
                 let uu____753 =
            ...
            let uu____963 =
              let uu____964 =
                let uu____969 =
                  ...
                  FStar_Util.format1
                    "Interface %s has already been processed" uu____970
                   in
                   ...
                   FStar_List.fold_left
                     (fun uu____1118  ->
                        fun impl  ->
                          ...
                          | (iface2,impls1) ->
                              let uu____1146 = prefix_one_decl iface2 impl
                                 in
