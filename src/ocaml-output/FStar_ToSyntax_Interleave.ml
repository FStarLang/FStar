...
(FStar_All.pipe_right tys (FStar_List.collect (fun uu___197_140 -> (match (uu___197_140) with
...
| FStar_Parser_AST.Tycon (uu____230, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___198_265 -> (match (uu___198_265) with
...
in (FStar_Pervasives.raise uu____332))
end
| uu____357 -> begin
((iface1), ((impl)::[]))
end))
...
in (FStar_Pervasives.raise uu____496))
end
| uu____513 -> begin
(aux ys iface2)
end))
...
| FStar_Parser_AST.Tycon (uu____599, tys) when (FStar_All.pipe_right tys (FStar_Util.for_some (fun uu___199_634 -> (match (uu___199_634) with
...
in (FStar_Pervasives.raise uu____667))
end
| uu____674 -> begin
(
...
in (FStar_Pervasives.raise uu____875))
end
...
in (FStar_Pervasives.raise uu____1125)))
end
| uu____1137 -> begin
((env1), (a1))
end)))
