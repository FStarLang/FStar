  ...
  fun iface1  ->
    fun impl  ->
      let qualify_kremlin_private impl1 =
        ...
        let uu___169_292 = impl1 in
        {
          FStar_Parser_AST.d = (uu___169_292.FStar_Parser_AST.d);
          FStar_Parser_AST.drange = (uu___169_292.FStar_Parser_AST.drange);
          FStar_Parser_AST.doc = (uu___169_292.FStar_Parser_AST.doc);
          FStar_Parser_AST.quals = (uu___169_292.FStar_Parser_AST.quals);
