  ...
  fun iface1 ->
    fun impl ->
      let qualify_kremlin_private impl1 =
        ...
        let uu___173_318 = impl1 in
        {
          FStar_Parser_AST.d = (uu___173_318.FStar_Parser_AST.d);
          FStar_Parser_AST.drange = (uu___173_318.FStar_Parser_AST.drange);
          FStar_Parser_AST.doc = (uu___173_318.FStar_Parser_AST.doc);
          FStar_Parser_AST.quals = (uu___173_318.FStar_Parser_AST.quals);
          ...
          (match iface_hd.FStar_Parser_AST.d with
           | FStar_Parser_AST.Tycon (uu____343, uu____344, tys) when
               FStar_All.pipe_right tys
                 (FStar_Util.for_some
                    (fun uu___170_379 ->
                       match uu___170_379 with
                       | (FStar_Parser_AST.TyconAbstract uu____386,
                          uu____387) -> true
                       | uu____402 -> false))
               ->
                    ...
                    let uu____446 =
                      let uu____451 =
                        ...
                        FStar_Util.format2
                          ...
                          x.FStar_Ident.idText uu____452 in
                      (FStar_Errors.Fatal_WrongDefinitionOrder, uu____451) in
                           ...
                           then
                             let uu____613 =
                               let uu____618 =
                                 ...
                                 let uu____620 = FStar_Ident.string_of_lid y in
                                 FStar_Util.format2
          ...
          (match hd1.FStar_Parser_AST.d with
           | FStar_Parser_AST.Tycon (uu____718, uu____719, tys) when
               FStar_All.pipe_right tys
                 (FStar_Util.for_some
                    (fun uu___171_754 ->
                       match uu___171_754 with
                       | (FStar_Parser_AST.TyconAbstract uu____761,
                          uu____762) -> true
                       | uu____777 -> false))
               ->
               FStar_Errors.raise_error
           ...
           | FStar_Parser_AST.Val (x, t) ->
               let uu____786 = FStar_Util.for_some (is_definition_of x) tl1 in
               if uu____786
               then
                 let uu____787 =
                   let uu____792 =
                   ...
                   (FStar_Errors.Fatal_BothValAndLetInInterface, uu____792) in
                   ...
                   FStar_List.fold_left
                     (fun uu____1179 ->
                        fun impl ->
                          ...
                          | (iface2, impls1) ->
                              let uu____1207 = prefix_one_decl iface2 impl in
                            ...
                            | uu____1369::uu____1370 when
                                ...
                                let uu____1379 =
                                  ...
                                  (FStar_Errors.Fatal_InterfaceNotImplementedByModule,
                                    uu____1384) in
                                let uu____1386 = FStar_Ident.range_of_lid l in
