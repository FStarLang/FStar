      ...
      let qualify_kremlin_private impl1 =
        let krem_private =
          FStar_Parser_AST.mk_term
           ...
           in
        let uu___9_348 = impl1  in
        {
          FStar_Parser_AST.d = (uu___9_348.FStar_Parser_AST.d);
          FStar_Parser_AST.drange = (uu___9_348.FStar_Parser_AST.drange);
          FStar_Parser_AST.doc = (uu___9_348.FStar_Parser_AST.doc);
          FStar_Parser_AST.quals = (uu___9_348.FStar_Parser_AST.quals);
