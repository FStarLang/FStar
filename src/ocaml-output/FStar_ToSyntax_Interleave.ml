    ...
    let rec aux iface2 =
      ...
      | hd1::tl1 ->
          (match hd1.FStar_Parser_AST.d with
               ...
               FStar_All.pipe_right tys
                 (FStar_Util.for_some
                    (fun uu___2_831 ->
                       ...
                       | (FStar_Parser_AST.TyconAbstract uu____839,
                          uu____840) -> true
                       | uu____856 -> false))
               ->
               FStar_Errors.raise_error
           ...
           | FStar_Parser_AST.Val (x, t) ->
               let uu____868 = FStar_Util.for_some (is_definition_of x) tl1 in
               if uu____868
               then
                 let uu____871 =
                   let uu____877 =
                   ...
                   (FStar_Errors.Fatal_BothValAndLetInInterface, uu____877) in
                   ...
                   FStar_List.fold_left
                     (fun uu____1289 ->
                        fun impl ->
                          ...
                          | (iface2, impls1) ->
                              let uu____1317 = prefix_one_decl iface2 impl in
                  ...
                  | (iface2, impls1) ->
                      ...
                      (match uu____1366 with
                       | (iface_lets, remaining_iface_vals) ->
                           ...
                           let env1 =
                             let uu____1475 = FStar_Options.interactive () in
                             if uu____1475
                             then
                            ...
                            | uu____1487::uu____1488 when
                                ...
                                let uu____1503 =
                                  ...
                                  (FStar_Errors.Fatal_InterfaceNotImplementedByModule,
                                    uu____1509) in
                                let uu____1515 = FStar_Ident.range_of_lid l in
