...
let compile_op:
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___109_5036 =
          match uu___109_5036 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let imp_to_string: imp -> Prims.string =
  fun uu___111_5141  ->
    match uu___111_5141 with | Hash  -> "#" | uu____5142 -> ""
