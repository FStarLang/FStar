...
type tycon =
  ...
  (FStar_Ident.ident* term* FStar_Syntax_Syntax.fsdoc Prims.option)
  Prims.list)
  | TyconVariant of (FStar_Ident.ident* binder Prims.list* knd Prims.option*
  (FStar_Ident.ident* term Prims.option* FStar_Syntax_Syntax.fsdoc
  Prims.option* Prims.bool) Prims.list)
let uu___is_TyconAbstract: tycon -> Prims.bool =
  fun projectee  ->
    match projectee with | TyconAbstract _0 -> true | uu____1505 -> false
let __proj__TyconAbstract__item___0:
  tycon -> (FStar_Ident.ident* binder Prims.list* knd Prims.option) =
  fun projectee  -> match projectee with | TyconAbstract _0 -> _0
let uu___is_TyconAbbrev: tycon -> Prims.bool =
  fun projectee  ->
    match projectee with | TyconAbbrev _0 -> true | uu____1538 -> false
let __proj__TyconAbbrev__item___0:
  tycon -> (FStar_Ident.ident* binder Prims.list* knd Prims.option* term) =
  fun projectee  -> match projectee with | TyconAbbrev _0 -> _0
let uu___is_TyconRecord: tycon -> Prims.bool =
  fun projectee  ->
    match projectee with | TyconRecord _0 -> true | uu____1579 -> false
...
let uu___is_TyconVariant: tycon -> Prims.bool =
  fun projectee  ->
    match projectee with | TyconVariant _0 -> true | uu____1637 -> false
...
let uu___is_Private: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Private  -> true | uu____1687 -> false
let uu___is_Abstract: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Abstract  -> true | uu____1691 -> false
let uu___is_Noeq: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Noeq  -> true | uu____1695 -> false
let uu___is_Unopteq: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Unopteq  -> true | uu____1699 -> false
let uu___is_Assumption: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Assumption  -> true | uu____1703 -> false
let uu___is_DefaultEffect: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | DefaultEffect  -> true | uu____1707 -> false
let uu___is_TotalEffect: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | TotalEffect  -> true | uu____1711 -> false
let uu___is_Effect_qual: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Effect_qual  -> true | uu____1715 -> false
let uu___is_New: qualifier -> Prims.bool =
  fun projectee  -> match projectee with | New  -> true | uu____1719 -> false
let uu___is_Inline: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Inline  -> true | uu____1723 -> false
let uu___is_Visible: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Visible  -> true | uu____1727 -> false
...
let uu___is_Irreducible: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Irreducible  -> true | uu____1739 -> false
let uu___is_NoExtract: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | NoExtract  -> true | uu____1743 -> false
let uu___is_Reifiable: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Reifiable  -> true | uu____1747 -> false
let uu___is_Reflectable: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Reflectable  -> true | uu____1751 -> false
let uu___is_Opaque: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Opaque  -> true | uu____1755 -> false
let uu___is_Logic: qualifier -> Prims.bool =
  fun projectee  ->
    match projectee with | Logic  -> true | uu____1759 -> false
...
let uu___is_Qualifier: decoration -> Prims.bool =
  fun projectee  ->
    match projectee with | Qualifier _0 -> true | uu____1776 -> false
let __proj__Qualifier__item___0: decoration -> qualifier =
  fun projectee  -> match projectee with | Qualifier _0 -> _0
let uu___is_DeclAttributes: decoration -> Prims.bool =
  fun projectee  ->
    match projectee with | DeclAttributes _0 -> true | uu____1789 -> false
let __proj__DeclAttributes__item___0: decoration -> term Prims.list =
  fun projectee  -> match projectee with | DeclAttributes _0 -> _0
let uu___is_Doc: decoration -> Prims.bool =
  fun projectee  ->
    match projectee with | Doc _0 -> true | uu____1804 -> false
let __proj__Doc__item___0: decoration -> FStar_Syntax_Syntax.fsdoc =
...
let uu___is_NonReifiableLift: lift_op -> Prims.bool =
  fun projectee  ->
    match projectee with | NonReifiableLift _0 -> true | uu____1827 -> false
let __proj__NonReifiableLift__item___0: lift_op -> term =
  fun projectee  -> match projectee with | NonReifiableLift _0 -> _0
let uu___is_ReifiableLift: lift_op -> Prims.bool =
  fun projectee  ->
    match projectee with | ReifiableLift _0 -> true | uu____1841 -> false
let __proj__ReifiableLift__item___0: lift_op -> (term* term) =
  fun projectee  -> match projectee with | ReifiableLift _0 -> _0
let uu___is_LiftForFree: lift_op -> Prims.bool =
  fun projectee  ->
    match projectee with | LiftForFree _0 -> true | uu____1859 -> false
...
let uu___is_SetOptions: pragma -> Prims.bool =
  fun projectee  ->
    match projectee with | SetOptions _0 -> true | uu____1899 -> false
let __proj__SetOptions__item___0: pragma -> Prims.string =
  fun projectee  -> match projectee with | SetOptions _0 -> _0
let uu___is_ResetOptions: pragma -> Prims.bool =
  fun projectee  ->
    match projectee with | ResetOptions _0 -> true | uu____1912 -> false
let __proj__ResetOptions__item___0: pragma -> Prims.string Prims.option =
  fun projectee  -> match projectee with | ResetOptions _0 -> _0
let uu___is_LightOff: pragma -> Prims.bool =
  fun projectee  ->
    match projectee with | LightOff  -> true | uu____1926 -> false
type decl' =
  ...
  | Main of term
  | Tycon of (Prims.bool* (tycon* FStar_Syntax_Syntax.fsdoc Prims.option)
  Prims.list)
...
and decl =
  ...
  doc: FStar_Syntax_Syntax.fsdoc Prims.option;
  quals: qualifiers;
  attrs: attributes_;}
and effect_decl =
...
let __proj__Tycon__item___0:
  decl' ->
    (Prims.bool* (tycon* FStar_Syntax_Syntax.fsdoc Prims.option) Prims.list)
...
let uu___is_SubEffect: decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | SubEffect _0 -> true | uu____2217 -> false
let __proj__SubEffect__item___0: decl' -> lift =
  fun projectee  -> match projectee with | SubEffect _0 -> _0
let uu___is_Pragma: decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | Pragma _0 -> true | uu____2229 -> false
let __proj__Pragma__item___0: decl' -> pragma =
  fun projectee  -> match projectee with | Pragma _0 -> _0
let uu___is_Fsdoc: decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | Fsdoc _0 -> true | uu____2241 -> false
let __proj__Fsdoc__item___0: decl' -> FStar_Syntax_Syntax.fsdoc =
  fun projectee  -> match projectee with | Fsdoc _0 -> _0
let uu___is_Assume: decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | Assume _0 -> true | uu____2255 -> false
let __proj__Assume__item___0: decl' -> (FStar_Ident.ident* term) =
  fun projectee  -> match projectee with | Assume _0 -> _0
let uu___is_DefineEffect: effect_decl -> Prims.bool =
  fun projectee  ->
    match projectee with | DefineEffect _0 -> true | uu____2301 -> false
...
let uu___is_RedefineEffect: effect_decl -> Prims.bool =
  fun projectee  ->
    match projectee with | RedefineEffect _0 -> true | uu____2335 -> false
...
let uu___is_Module: modul -> Prims.bool =
  fun projectee  ->
    match projectee with | Module _0 -> true | uu____2375 -> false
let __proj__Module__item___0: modul -> (FStar_Ident.lid* decl Prims.list) =
  fun projectee  -> match projectee with | Module _0 -> _0
let uu___is_Interface: modul -> Prims.bool =
  fun projectee  ->
    match projectee with | Interface _0 -> true | uu____2400 -> false
    ...
    then ()
      ...
      (let uu____2429 =
         let uu____2430 =
           ...
           (uu____2433, (id.FStar_Ident.idRange)) in
         FStar_Errors.Error uu____2430 in
       Prims.raise uu____2429)
  ...
  | uu____2455 ->
      let uu____2457 =
        let uu____2458 =
          ...
          (uu____2461, r) in
        FStar_Errors.Error uu____2458 in
      Prims.raise uu____2457
      ...
      fun decorations  ->
        let doc1 =
          let uu____2476 =
            FStar_List.choose
              (fun uu___106_2478  ->
                 match uu___106_2478 with
                 | Doc d1 -> Some d1
                 | uu____2481 -> None) decorations in
          at_most_one "fsdoc" r uu____2476 in
        let attributes_ =
          let uu____2485 =
            FStar_List.choose
              (fun uu___107_2489  ->
                 match uu___107_2489 with
                 | DeclAttributes a -> Some a
                 | uu____2495 -> None) decorations in
          at_most_one "attribute set" r uu____2485 in
        let attributes_1 = FStar_Util.dflt [] attributes_ in
        let qualifiers =
          FStar_List.choose
            (fun uu___108_2503  ->
               match uu___108_2503 with
               | Qualifier q -> Some q
               | uu____2506 -> None) decorations in
        { d; drange = r; doc = doc1; quals = qualifiers; attrs = attributes_1
        }
let sigelt_of_decl:
  decl -> FStar_Syntax_Syntax.sigelt' -> FStar_Syntax_Syntax.sigelt =
  fun d  ->
    fun e  ->
      {
        FStar_Syntax_Syntax.sigel = e;
        FStar_Syntax_Syntax.sigdoc = (d.doc);
        FStar_Syntax_Syntax.sigrng = (d.drange)
      }
            ...
            let uu____2605 =
              let uu____2606 =
                let uu____2607 =
                  let uu____2615 =
                    let uu____2616 =
                      let uu____2617 = FStar_Ident.lid_of_ids [x] in
                      Var uu____2617 in
                    mk_term uu____2616 r1 Expr in
                  (uu____2615, branches) in
                Match uu____2607 in
              mk_term uu____2606 r2 Expr in
            ([mk_pattern (PatVar (x, None)) r1], uu____2605) in
          Abs uu____2601 in
        mk_term uu____2600 r2 Expr
let un_function: pattern -> term -> (pattern* term) Prims.option =
  fun p  ->
    fun tm  ->
      match ((p.pat), (tm.tm)) with
      | (PatVar uu____2637,Abs (pats,body)) ->
...
let lid_with_range:
  ...
  fun lid  ->
    fun r  ->
      let uu____2659 = FStar_Ident.path_of_lid lid in
      FStar_Ident.lid_of_path uu____2659 r
             ...
             | Name s ->
                 let uu____2834 =
                   let uu____2835 =
                     ...
                     (s, uu____2841) in
                   Construct uu____2835 in
                 mk_term uu____2834 r Un
             | uu____2851 ->
                 FStar_List.fold_left
...
let mkWildAdmitMagic r =
  let uu____2874 = mkAdmitMagic r in
  ((mk_pattern PatWild r), None, uu____2874)
let focusBranches branches r =
  ...
  then
    (FStar_Errors.warn r "Focusing on only some cases";
     (let focussed =
        let uu____2930 = FStar_List.filter Prims.fst branches in
        FStar_All.pipe_right uu____2930 (FStar_List.map Prims.snd) in
      let uu____2974 = let uu____2980 = mkWildAdmitMagic r in [uu____2980] in
      FStar_List.append focussed uu____2974))
       ...
       (fun uu____3066  ->
          ...
          | (f,lb) ->
              ...
              then lb
                ...
                (let uu____3082 = mkAdmitMagic r in
                 ((Prims.fst lb), uu____3082))) lbs)
  else FStar_All.pipe_right lbs (FStar_List.map Prims.snd)
let mkFsTypApp: term -> term Prims.list -> FStar_Range.range -> term =
  fun t  ->
    fun args  ->
      fun r  ->
        let uu____3111 = FStar_List.map (fun a  -> (a, FsTypApp)) args in
        mkApp t uu____3111 r
let mkTuple: term Prims.list -> FStar_Range.range -> term =
  fun args  ->
    fun r  ->
      let cons1 =
        FStar_Syntax_Util.mk_tuple_data_lid (FStar_List.length args) r in
      let uu____3130 = FStar_List.map (fun x  -> (x, Nothing)) args in
      mkApp (mk_term (Name cons1) r Expr) uu____3130 r
let mkDTuple: term Prims.list -> FStar_Range.range -> term =
  fun args  ->
    fun r  ->
      let cons1 =
        FStar_Syntax_Util.mk_dtuple_data_lid (FStar_List.length args) r in
      let uu____3149 = FStar_List.map (fun x  -> (x, Nothing)) args in
      mkApp (mk_term (Name cons1) r Expr) uu____3149 r
let mkRefinedBinder:
  FStar_Ident.ident ->
    term ->
                      ...
                      (match pat.pat with
                       ...
                       | uu____3207 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____3211 =
                                 let uu____3212 = FStar_Ident.lid_of_ids [x] in
                                 Var uu____3212 in
                               mk_term uu____3211 phi.range Formula in
...
let rec extract_named_refinement:
  ...
  fun t1  ->
    ...
    | Refine
        ({ b = Annotated (x,t); brange = uu____3269; blevel = uu____3270;
           aqual = uu____3271;_},t')
        -> Some (x, t, (Some t'))
        ...
        fun ds  ->
          ...
          | TopLevelModule m ->
              let ds1 =
                if is_light
                then
                  let uu____3368 = mk_decl (Pragma LightOff) light_range [] in
                  uu____3368 :: ds
                else ds in
              let ms = as_mlist [] ((m, d), []) ds1 in
              ((let uu____3376 = FStar_List.tl ms in
                match uu____3376 with
                | (Module (m',uu____3379))::uu____3380 ->
                    let msg =
          ...
          | uu____3390 ->
              ...
              (FStar_List.iter
                 (fun uu___109_3394  ->
                    match uu___109_3394 with
                    | { d = TopLevelModule uu____3395; drange = r;
                        doc = uu____3397; quals = uu____3398;
                        attrs = uu____3399;_} ->
                        Prims.raise
                          (FStar_Errors.Error
...
let compile_op: Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___110_3413 =
        match uu___110_3413 with
        | '&' -> "Amp"
        | '@' -> "At"
        | '+' -> "Plus"
      ...
      | uu____3415 ->
          let uu____3416 =
            let uu____3417 =
              let uu____3419 = FStar_String.list_of_string s in
              FStar_List.map name_of_char uu____3419 in
            FStar_String.concat "_" uu____3417 in
          Prims.strcat "op_" uu____3416
let compile_op': Prims.string -> Prims.string =
  fun s  -> compile_op (- (Prims.parse_int "1")) s
let string_of_let_qualifier: let_qualifier -> Prims.string =
  fun uu___111_3426  ->
    match uu___111_3426 with
    | NoLetQualifier  -> ""
    | Rec  -> "rec"
    | Mutable  -> "mutable"
let to_string_l sep f l =
  let uu____3451 = FStar_List.map f l in FStar_String.concat sep uu____3451
let imp_to_string: imp -> Prims.string =
  fun uu___112_3455  ->
    match uu___112_3455 with | Hash  -> "#" | uu____3456 -> ""
let rec term_to_string: term -> Prims.string =
  fun x  ->
    match x.tm with
    | Wild  -> "_"
    | Requires (t,uu____3467) ->
        let uu____3470 = term_to_string t in
        FStar_Util.format1 "(requires %s)" uu____3470
    | Ensures (t,uu____3472) ->
        let uu____3475 = term_to_string t in
        FStar_Util.format1 "(ensures %s)" uu____3475
    | Labeled (t,l,uu____3478) ->
        let uu____3479 = term_to_string t in
        FStar_Util.format2 "(labeled %s %s)" l uu____3479
    ...
    | Op (s,xs) ->
        let uu____3485 =
          ...
          FStar_String.concat ", " uu____3486 in
        FStar_Util.format2 "%s(%s)" s uu____3485
        ...
        let uu____3499 =
          to_string_l " "
            (fun uu____3502  ->
               ...
               | (a,imp) ->
                   let uu____3507 = term_to_string a in
                   FStar_Util.format2 "%s%s" (imp_to_string imp) uu____3507)
            args in
        FStar_Util.format2 "(%s %s)" l.FStar_Ident.str uu____3499
    | Abs (pats,t) ->
        let uu____3512 = to_string_l " " pat_to_string pats in
        let uu____3513 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "(fun %s -> %s)" uu____3512 uu____3513
    | App (t1,t2,imp) ->
        let uu____3517 = FStar_All.pipe_right t1 term_to_string in
        let uu____3518 = FStar_All.pipe_right t2 term_to_string in
        FStar_Util.format3 "%s %s%s" uu____3517 (imp_to_string imp)
          uu____3518
    | Let (Rec ,lbs,body) ->
        let uu____3527 =
          to_string_l " and "
            (fun uu____3530  ->
               ...
               | (p,b) ->
                   let uu____3535 = FStar_All.pipe_right p pat_to_string in
                   let uu____3536 = FStar_All.pipe_right b term_to_string in
                   FStar_Util.format2 "%s=%s" uu____3535 uu____3536) lbs in
        let uu____3537 = FStar_All.pipe_right body term_to_string in
        FStar_Util.format2 "let rec %s in %s" uu____3527 uu____3537
    | Let (q,(pat,tm)::[],body) ->
        let uu____3549 = FStar_All.pipe_right pat pat_to_string in
        let uu____3550 = FStar_All.pipe_right tm term_to_string in
        let uu____3551 = FStar_All.pipe_right body term_to_string in
        FStar_Util.format4 "let %s %s = %s in %s" (string_of_let_qualifier q)
          uu____3549 uu____3550 uu____3551
    | Seq (t1,t2) ->
        let uu____3554 = FStar_All.pipe_right t1 term_to_string in
        let uu____3555 = FStar_All.pipe_right t2 term_to_string in
        FStar_Util.format2 "%s; %s" uu____3554 uu____3555
    | If (t1,t2,t3) ->
        let uu____3559 = FStar_All.pipe_right t1 term_to_string in
        let uu____3560 = FStar_All.pipe_right t2 term_to_string in
        let uu____3561 = FStar_All.pipe_right t3 term_to_string in
        FStar_Util.format3 "if %s then %s else %s" uu____3559 uu____3560
          uu____3561
    | Match (t,branches) ->
        let uu____3574 = FStar_All.pipe_right t term_to_string in
        let uu____3575 =
          to_string_l " | "
            (fun uu____3580  ->
               match uu____3580 with
               | (p,w,e) ->
                   let uu____3590 = FStar_All.pipe_right p pat_to_string in
                   let uu____3591 =
                     match w with
                     | None  -> ""
                     | Some e1 ->
                         let uu____3593 = term_to_string e1 in
                         FStar_Util.format1 "when %s" uu____3593 in
                   let uu____3594 = FStar_All.pipe_right e term_to_string in
                   FStar_Util.format3 "%s %s -> %s" uu____3590 uu____3591
                     uu____3594) branches in
        FStar_Util.format2 "match %s with %s" uu____3574 uu____3575
    | Ascribed (t1,t2,None ) ->
        let uu____3598 = FStar_All.pipe_right t1 term_to_string in
        let uu____3599 = FStar_All.pipe_right t2 term_to_string in
        FStar_Util.format2 "(%s : %s)" uu____3598 uu____3599
    | Ascribed (t1,t2,Some tac) ->
        ...
        let uu____3606 = FStar_All.pipe_right tac term_to_string in
        FStar_Util.format3 "(%s : %s by %s)" uu____3604 uu____3605 uu____3606
    | Record (Some e,fields) ->
        let uu____3616 = FStar_All.pipe_right e term_to_string in
        let uu____3617 =
          to_string_l " "
            (fun uu____3620  ->
               match uu____3620 with
               | (l,e1) ->
                   let uu____3625 = FStar_All.pipe_right e1 term_to_string in
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____3625)
            fields in
        FStar_Util.format2 "{%s with %s}" uu____3616 uu____3617
    | Record (None ,fields) ->
        let uu____3634 =
          to_string_l " "
            (fun uu____3637  ->
               ...
               | (l,e) ->
                   let uu____3642 = FStar_All.pipe_right e term_to_string in
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____3642)
            fields in
        FStar_Util.format1 "{%s}" uu____3634
    | Project (e,l) ->
        let uu____3645 = FStar_All.pipe_right e term_to_string in
        FStar_Util.format2 "%s.%s" uu____3645 l.FStar_Ident.str
    ...
    | Product (b::[],t) when x.level = Type_level ->
        let uu____3659 = FStar_All.pipe_right b binder_to_string in
        let uu____3660 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s -> %s" uu____3659 uu____3660
    | Product (b::[],t) when x.level = Kind ->
        let uu____3664 = FStar_All.pipe_right b binder_to_string in
        let uu____3665 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s => %s" uu____3664 uu____3665
    | Sum (binders,t) ->
        let uu____3670 =
          let uu____3671 =
            FStar_All.pipe_right binders (FStar_List.map binder_to_string) in
          FStar_All.pipe_right uu____3671 (FStar_String.concat " * ") in
        let uu____3676 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s * %s" uu____3670 uu____3676
    | QForall (bs,pats,t) ->
        let uu____3686 = to_string_l " " binder_to_string bs in
        let uu____3687 =
          to_string_l " \\/ " (to_string_l "; " term_to_string) pats in
        let uu____3689 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format3 "forall %s.{:pattern %s} %s" uu____3686 uu____3687
          uu____3689
    | QExists (bs,pats,t) ->
        let uu____3699 = to_string_l " " binder_to_string bs in
        let uu____3700 =
          to_string_l " \\/ " (to_string_l "; " term_to_string) pats in
        let uu____3702 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format3 "exists %s.{:pattern %s} %s" uu____3699 uu____3700
          uu____3702
    | Refine (b,t) ->
    ...
    | NamedTyp (x1,t) ->
        let uu____3709 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s:%s" x1.FStar_Ident.idText uu____3709
    | Paren t ->
        let uu____3711 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format1 "(%s)" uu____3711
    | Product (bs,t) ->
        let uu____3716 =
          let uu____3717 =
        ...
        FStar_Util.format2 "Unidentified product: [%s] %s" uu____3716
          uu____3722
    | t -> "_"
  ...
  fun x  ->
    let s =
      ...
      | TAnnotated (i,t)|Annotated (i,t) ->
          ...
          FStar_Util.format2 "%s:%s" i.FStar_Ident.idText uu____3730
      | NoName t -> FStar_All.pipe_right t term_to_string in
    let uu____3732 = aqual_to_string x.aqual in
    FStar_Util.format2 "%s%s" uu____3732 s
and aqual_to_string: aqual -> Prims.string =
  fun uu___113_3733  ->
    match uu___113_3733 with
    | Some (Equality ) -> "$"
    | Some (Implicit ) -> "#"
    | uu____3734 -> ""
and pat_to_string: pattern -> Prims.string =
  fun x  ->
    ...
    | PatApp (p,ps) ->
        let uu____3741 = FStar_All.pipe_right p pat_to_string in
        let uu____3742 = to_string_l " " pat_to_string ps in
        FStar_Util.format2 "(%s %s)" uu____3741 uu____3742
    | PatTvar (i,aq)|PatVar (i,aq) ->
        let uu____3749 = aqual_to_string aq in
        FStar_Util.format2 "%s%s" uu____3749 i.FStar_Ident.idText
    | PatName l -> l.FStar_Ident.str
    | PatList l ->
        let uu____3753 = to_string_l "; " pat_to_string l in
        FStar_Util.format1 "[%s]" uu____3753
    | PatTuple (l,false ) ->
        let uu____3757 = to_string_l ", " pat_to_string l in
        FStar_Util.format1 "(%s)" uu____3757
    | PatTuple (l,true ) ->
        let uu____3761 = to_string_l ", " pat_to_string l in
        FStar_Util.format1 "(|%s|)" uu____3761
    | PatRecord l ->
        let uu____3766 =
          to_string_l "; "
            (fun uu____3769  ->
               ...
               | (f,e) ->
                   let uu____3774 = FStar_All.pipe_right e pat_to_string in
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____3774) l in
        FStar_Util.format1 "{%s}" uu____3766
    | PatOr l -> to_string_l "|\n " pat_to_string l
    | PatOp op -> FStar_Util.format1 "(%s)" op
    | PatAscribed (p,t) ->
        let uu____3780 = FStar_All.pipe_right p pat_to_string in
        let uu____3781 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "(%s:%s)" uu____3780 uu____3781
let rec head_id_of_pat: pattern -> FStar_Ident.lid Prims.list =
  fun p  ->
    match p.pat with
    | PatName l -> [l]
    | PatVar (i,uu____3789) ->
        let uu____3792 = FStar_Ident.lid_of_ids [i] in [uu____3792]
    | PatApp (p1,uu____3794) -> head_id_of_pat p1
    | PatAscribed (p1,uu____3798) -> head_id_of_pat p1
    | uu____3799 -> []
let lids_of_let defs =
  FStar_All.pipe_right defs
    (FStar_List.collect
       (fun uu____3820  ->
          match uu____3820 with | (p,uu____3825) -> head_id_of_pat p))
let id_of_tycon: tycon -> Prims.string =
  fun uu___114_3828  ->
    match uu___114_3828 with
    | TyconAbstract (i,_,_)
  ...
  fun d  ->
    ...
    | ModuleAbbrev (i,l) ->
        FStar_Util.format2 "module %s = %s" i.FStar_Ident.idText
          l.FStar_Ident.str
    | TopLevelLet (uu____3869,pats) ->
        let uu____3877 =
          let uu____3878 =
            let uu____3880 = lids_of_let pats in
            FStar_All.pipe_right uu____3880
              (FStar_List.map (fun l  -> l.FStar_Ident.str)) in
          FStar_All.pipe_right uu____3878 (FStar_String.concat ", ") in
        Prims.strcat "let " uu____3877
    | Main uu____3886 -> "main ..."
    | Assume (i,uu____3888) -> Prims.strcat "assume " i.FStar_Ident.idText
    | Tycon (uu____3889,tys) ->
        let uu____3899 =
          let uu____3900 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3910  ->
                    match uu____3910 with | (x,uu____3915) -> id_of_tycon x)) in
          FStar_All.pipe_right uu____3900 (FStar_String.concat ", ") in
        Prims.strcat "type " uu____3899
    | Val (i,uu____3920) -> Prims.strcat "val " i.FStar_Ident.idText
    | Exception (i,uu____3922) ->
        Prims.strcat "exception " i.FStar_Ident.idText
    | NewEffect (DefineEffect (i,_,_,_))|NewEffect (RedefineEffect (i,_,_))
        -> Prims.strcat "new_effect " i.FStar_Ident.idText
    | SubEffect uu____3934 -> "sub_effect"
    | Pragma uu____3935 -> "pragma"
    | Fsdoc uu____3936 -> "fsdoc"
let modul_to_string: modul -> Prims.string =
  fun m  ->
    ...
    | Module (_,decls)|Interface (_,decls,_) ->
        ...
        FStar_All.pipe_right uu____3948 (FStar_String.concat "\n")
let error msg tm r =
