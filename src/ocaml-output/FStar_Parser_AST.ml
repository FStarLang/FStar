          ...
          let uu____3834 =
            FStar_List.choose
              (fun uu___81_3839  ->
                 ...
                 | uu____3843 -> FStar_Pervasives_Native.None) decorations
             in
          ...
          let uu____3849 =
            FStar_List.choose
              (fun uu___82_3858  ->
                 ...
                 | uu____3868 -> FStar_Pervasives_Native.None) decorations
             in
        ...
        let qualifiers =
          FStar_List.choose
            (fun uu___83_3883  ->
               ...
               | uu____3887 -> FStar_Pervasives_Native.None) decorations
           in
      ...
      fun r  ->
        fun l  ->
          let t1 =
            ...
            | uu____3955 -> Op ((FStar_Ident.mk_ident ("-", rminus)), [t])
             in
          mk_term t1 r l
                           ...
                           let phi1 =
                             ...
                             let otherwise_branch =
                               ...
                               ((mk_pattern PatWild phi.range),
                                 FStar_Pervasives_Native.None, uu____5068)
                                in
                             mk_term
          ...
          to_string_l " and "
            (fun uu____5568  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____5575 uu____5576) lbs
           in
               ...
               | (p,w,e) ->
                   ...
                   let uu____5665 =
                     ...
                     | FStar_Pervasives_Native.Some e1 ->
                         ...
                         FStar_Util.format1 "when %s" uu____5667
                      in
          ...
          to_string_l "; "
            (fun uu____5934  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____5941) l
           in
        ...
        let uu____6180 =
          let uu____6181 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____6203  ->
                    match uu____6203 with | (x,uu____6211) -> id_of_tycon x))
             in
