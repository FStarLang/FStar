...
let (imp_to_string : imp -> Prims.string) =
  fun uu___5_7532 -> match uu___5_7532 with | Hash -> "#" | uu____7535 -> ""
          ...
          to_string_l " "
            (fun uu____8260 ->
               ...
               | (l, e1) ->
                   ...
                   let uu____8270 = FStar_All.pipe_right e1 term_to_string in
                   FStar_Util.format2 "%s=%s" uu____8268 uu____8270) fields in
          ...
          to_string_l " "
            (fun uu____8302 ->
               ...
               | (l, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____8310 uu____8312) fields in
          ...
          to_string_l "; "
            (fun uu____8760 ->
               ...
               | (f, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____8768 uu____8770) l in
