...
let compile_op:
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___107_5044 =
          match uu___107_5044 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let imp_to_string: imp -> Prims.string =
  fun uu___109_5164  ->
    match uu___109_5164 with | Hash  -> "#" | uu____5165 -> ""
