          ...
          let uu____5271 =
            FStar_List.choose
              (fun uu___0_5276 ->
                 ...
                 | uu____5280 -> FStar_Pervasives_Native.None) decorations in
          ...
          let uu____5287 =
            FStar_List.choose
              (fun uu___1_5296 ->
                 ...
                 | uu____5306 -> FStar_Pervasives_Native.None) decorations in
        ...
        let qualifiers =
          FStar_List.choose
            (fun uu___2_5322 ->
               ...
               | uu____5326 -> FStar_Pervasives_Native.None) decorations in
  ...
  fun lbs ->
    fun r ->
      let should_filter =
        FStar_Util.for_some
          (fun uu____6552 ->
             match uu____6552 with | (attr, (focus, uu____6569)) -> focus)
          lbs in
      if should_filter
      then
        (FStar_Errors.log_issue r
                      ...
                      (match pat.pat with
                       ...
                       | uu____6982 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____6986 =
                                 let uu____6987 = FStar_Ident.lid_of_ids [x] in
                                 Var uu____6987 in
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___6_7571 -> match uu___6_7571 with | Hash -> "#" | uu____7574 -> ""
          ...
          to_string_l " "
            (fun uu____7828 ->
               ...
               | (a1, (p1, b1)) ->
                   ...
                   let uu____7862 = FStar_All.pipe_right b1 term_to_string in
        ...
        let uu____8281 =
          to_string_l " "
            (fun uu____8292 ->
               ...
               | (l, e1) ->
                   let uu____8300 = FStar_All.pipe_right e1 term_to_string in
          ...
          to_string_l "; "
            (fun uu____8772 ->
               ...
               | (f, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____8780) l in
        ...
        let uu____9135 =
          let uu____9137 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____9162 ->
                    match uu____9162 with | (x, uu____9171) -> id_of_tycon x)) in
