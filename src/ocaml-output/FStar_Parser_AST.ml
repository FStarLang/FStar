          ...
          let uu____5247 =
            FStar_List.choose
              (fun uu___0_5252 ->
                 ...
                 | uu____5256 -> FStar_Pervasives_Native.None) decorations in
          ...
          let uu____5263 =
            FStar_List.choose
              (fun uu___1_5272 ->
                 ...
                 | uu____5282 -> FStar_Pervasives_Native.None) decorations in
        ...
        let qualifiers =
          FStar_List.choose
            (fun uu___2_5298 ->
               ...
               | uu____5302 -> FStar_Pervasives_Native.None) decorations in
  ...
  fun lbs ->
    fun r ->
      let should_filter =
        FStar_Util.for_some
          (fun uu____6528 ->
             match uu____6528 with | (attr, (focus, uu____6545)) -> focus)
          lbs in
      if should_filter
      then
        (FStar_Errors.log_issue r
                      ...
                      (match pat.pat with
                       ...
                       | uu____6958 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____6962 =
                                 let uu____6963 = FStar_Ident.lid_of_ids [x] in
                                 Var uu____6963 in
          ...
          to_string_l " "
            (fun uu____7804 ->
               ...
               | (a1, (p1, b1)) ->
                   ...
                   let uu____7838 = FStar_All.pipe_right b1 term_to_string in
        ...
        let uu____8257 =
          to_string_l " "
            (fun uu____8268 ->
               ...
               | (l, e1) ->
                   let uu____8276 = FStar_All.pipe_right e1 term_to_string in
          ...
          to_string_l "; "
            (fun uu____8748 ->
               ...
               | (f, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____8756) l in
        ...
        let uu____9111 =
          let uu____9113 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____9138 ->
                    match uu____9138 with | (x, uu____9147) -> id_of_tycon x)) in
