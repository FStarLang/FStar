...
let (uu___is_Var : term' -> Prims.bool) =
  fun projectee -> match projectee with | Var _0 -> true | uu____833 -> false
...
let (uu___is_Abs : term' -> Prims.bool) =
  fun projectee -> match projectee with | Abs _0 -> true | uu____971 -> false
...
let (uu___is_If : term' -> Prims.bool) =
  fun projectee -> match projectee with | If _0 -> true | uu____1269 -> false
...
let (uu___is_Hash : imp -> Prims.bool) =
  fun projectee -> match projectee with | Hash -> true | uu____2971 -> false
...
let (uu___is_Infix : imp -> Prims.bool) =
  fun projectee -> match projectee with | Infix -> true | uu____3012 -> false
...
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Noeq -> true | uu____3532 -> false
...
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Logic -> true | uu____3708 -> false
          ...
          let uu____5166 =
            FStar_List.choose
              (fun uu___0_5171 ->
                 ...
                 | uu____5175 -> FStar_Pervasives_Native.None) decorations in
          ...
          let uu____5182 =
            FStar_List.choose
              (fun uu___1_5191 ->
                 ...
                 | uu____5201 -> FStar_Pervasives_Native.None) decorations in
        ...
        let qualifiers =
          FStar_List.choose
            (fun uu___2_5217 ->
               ...
               | uu____5221 -> FStar_Pervasives_Native.None) decorations in
  ...
  fun lbs ->
    fun r ->
      let should_filter =
        FStar_Util.for_some
          (fun uu____6447 ->
             match uu____6447 with | (attr, (focus, uu____6464)) -> focus)
          lbs in
      if should_filter
      then
        (FStar_Errors.log_issue r
                      ...
                      (match pat.pat with
                       ...
                       | uu____6877 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____6881 =
                                 let uu____6882 = FStar_Ident.lid_of_ids [x] in
                                 Var uu____6882 in
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___6_7466 -> match uu___6_7466 with | Hash -> "#" | uu____7469 -> ""
          ...
          to_string_l " "
            (fun uu____7723 ->
               ...
               | (a1, (p1, b1)) ->
                   ...
                   let uu____7757 = FStar_All.pipe_right b1 term_to_string in
        ...
        let uu____8176 =
          to_string_l " "
            (fun uu____8187 ->
               ...
               | (l, e1) ->
                   let uu____8195 = FStar_All.pipe_right e1 term_to_string in
          ...
          to_string_l "; "
            (fun uu____8637 ->
               ...
               | (f, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____8645) l in
        ...
        let uu____9000 =
          let uu____9002 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____9027 ->
                    match uu____9027 with | (x, uu____9036) -> id_of_tycon x)) in
