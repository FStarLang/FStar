...
let compile_op: Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___108_3464 =
...
let imp_to_string: imp -> Prims.string =
  fun uu___110_3537  ->
    match uu___110_3537 with | Hash  -> "#" | uu____3538 -> ""
