      ...
      fun decorations  ->
        ...
        let attributes_ =
          let _0_187 =
            FStar_List.choose
              (fun uu___106_2487  ->
                 match uu___106_2487 with
                 | DeclAttributes a -> Some a
                 | uu____2493 -> None) decorations in
          at_most_one "attribute set" r _0_187 in
        let attributes_ = FStar_Util.dflt [] attributes_ in
        let qualifiers =
          FStar_List.choose
            (fun uu___107_2500  ->
               match uu___107_2500 with
               | Qualifier q -> Some q
               | uu____2503 -> None) decorations in
                    ...
                    then
                      (match pat.pat with
                       ...
                       | uu____3134 ->
                           ...
                           let phi =
                             let x_var =
                               let _0_204 = Var (FStar_Ident.lid_of_ids [x]) in
                             ...
                             let otherwise_branch =
                               ...
                               ((mk_pattern PatWild phi.range), None, _0_206) in
                             mk_term
...
let rec extract_named_refinement:
  ...
  fun t1  ->
    ...
    | Refine
        ({ b = Annotated (x,t); brange = uu____3191; blevel = uu____3192;
           aqual = uu____3193;_},t')
        -> Some (x, t, (Some t'))
      ...
      fun d  ->
        fun ds  ->
          ...
          | uu____3310 ->
              ...
              (FStar_List.iter
                 (fun uu___108_3314  ->
                    match uu___108_3314 with
                    | { d = TopLevelModule uu____3315; drange = r;
                        doc = uu____3317; quals = uu____3318;
                        attrs = uu____3319;_} ->
                        Prims.raise
                          (FStar_Errors.Error
...
let compile_op: Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___109_3333 =
        match uu___109_3333 with
        | '&' -> "Amp"
        | '@' -> "At"
        | '+' -> "Plus"
          ...
          to_string_l " "
            (fun uu____3436  ->
               ...
               | (a,imp) ->
                   ...
                   FStar_Util.format2 "%s%s" (imp_to_string imp) _0_220) args in
          ...
          to_string_l " and "
            (fun uu____3458  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" _0_227 _0_226) lbs in
               ...
               | (p,w,e) ->
                   ...
                   let _0_240 =
                     ...
                     | Some e ->
                         ...
                         FStar_Util.format1 "when %s" _0_238 in
          ...
          to_string_l "; "
            (fun uu____3633  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str _0_280) l in
        ...
        let _0_289 =
          let _0_288 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3763  ->
                    match uu____3763 with | (x,uu____3768) -> id_of_tycon x)) in
