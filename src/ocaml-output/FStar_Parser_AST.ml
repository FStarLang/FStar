...
let uu____3834 = (FStar_List.choose (fun uu___73_3839 -> (match (uu___73_3839) with
| Doc (d1) -> begin
...
let uu____3849 = (FStar_List.choose (fun uu___74_3858 -> (match (uu___74_3858) with
...
let qualifiers = (FStar_List.choose (fun uu___75_3883 -> (match (uu___75_3883) with
| Qualifier (q) -> begin
...
let ds2 = (d)::ds1
in ((FStar_List.iter (fun uu___76_5314 -> (match (uu___76_5314) with
...
let name_of_char = (fun uu___77_5340 -> (match (uu___77_5340) with
| 38 (*&*) -> begin
"Amp"
end
| 64 (*@*) -> begin
...
let string_of_let_qualifier : let_qualifier  ->  Prims.string = (fun uu___78_5417 -> (match (uu___78_5417) with
| NoLetQualifier -> begin
""
end
| Rec -> begin
...
let imp_to_string : imp  ->  Prims.string = (fun uu___79_5454 -> (match (uu___79_5454) with
| Hash -> begin
"#"
end
| uu____5455 -> begin
...
and aqual_to_string : aqual  ->  Prims.string = (fun uu___80_5875 -> (match (uu___80_5875) with
...
let id_of_tycon : tycon  ->  Prims.string = (fun uu___81_6025 -> (match (uu___81_6025) with
