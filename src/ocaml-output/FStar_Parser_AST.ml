          ...
          let uu____2841 =
            FStar_List.choose
              (fun uu___74_2845  ->
                 ...
                 | uu____2848 -> FStar_Pervasives_Native.None) decorations
             in
          ...
          let uu____2852 =
            FStar_List.choose
              (fun uu___75_2858  ->
                 ...
                 | uu____2864 -> FStar_Pervasives_Native.None) decorations
             in
        ...
        let qualifiers =
          FStar_List.choose
            (fun uu___76_2874  ->
               ...
               | uu____2877 -> FStar_Pervasives_Native.None) decorations
           in
      ...
      fun r  ->
        fun l  ->
          let t1 =
            ...
            | uu____2935 -> Op ((FStar_Ident.mk_ident ("-", rminus)), [t])
             in
          mk_term t1 r l
    ...
    (FStar_Errors.warn r "Focusing on only some cases";
     (let focussed =
        ...
        FStar_All.pipe_right uu____3364
         ...
         in
      let uu____3408 = let uu____3414 = mkWildAdmitMagic r  in [uu____3414]
         in
                           ...
                           let phi1 =
                             ...
                             let otherwise_branch =
                               ...
                               ((mk_pattern PatWild phi.range),
                                 FStar_Pervasives_Native.None, uu____3692)
                                in
                             mk_term
          ...
          to_string_l " and "
            (fun uu____4086  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____4091 uu____4092) lbs
           in
               ...
               | (p,w,e) ->
                   ...
                   let uu____4154 =
                     ...
                     | FStar_Pervasives_Native.Some e1 ->
                         ...
                         FStar_Util.format1 "when %s" uu____4156
                      in
          ...
          to_string_l "; "
            (fun uu____4350  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____4355) l
           in
        ...
        let uu____4512 =
          let uu____4513 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____4526  ->
                    match uu____4526 with | (x,uu____4531) -> id_of_tycon x))
             in
