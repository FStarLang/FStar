        ...
        let _0_185 =
          Abs
            (let _0_184 =
             ...
             ([mk_pattern (PatVar (x, None)) r1], _0_184)) in
     ...
     FStar_List.map
       (fun uu____3006  ->
          ...
          | (f,lb) ->
              if f
              then lb
              else (let _0_193 = mkAdmitMagic r in ((Prims.fst lb), _0_193)))
       lbs)
                    ...
                    then
                      (match pat.pat with
                       ...
                       | uu____3134 ->
                           ...
                           let phi =
                             let x_var =
                               let _0_197 = Var (FStar_Ident.lid_of_ids [x]) in
                             ...
                             let otherwise_branch =
                               ...
                               ((mk_pattern PatWild phi.range), None, _0_199) in
                             mk_term
          ...
          to_string_l " "
            (fun uu____3436  ->
               ...
               | (a,imp) ->
                   ...
                   FStar_Util.format2 "%s%s" (imp_to_string imp) _0_213) args in
          ...
          to_string_l " and "
            (fun uu____3458  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" _0_220 _0_219) lbs in
               ...
               | (p,w,e) ->
                   ...
                   let _0_233 =
                     ...
                     | Some e ->
                         ...
                         FStar_Util.format1 "when %s" _0_231 in
          ...
          to_string_l "; "
            (fun uu____3633  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str _0_273) l in
