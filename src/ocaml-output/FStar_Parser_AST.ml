...
let uu____2481 = (FStar_List.choose (fun uu___106_2483 -> (match (uu___106_2483) with
| Doc (d1) -> begin
Some (d1)
end
| uu____2486 -> begin
...
let uu____2490 = (FStar_List.choose (fun uu___107_2494 -> (match (uu___107_2494) with
...
let qualifiers = (FStar_List.choose (fun uu___108_2508 -> (match (uu___108_2508) with
| Qualifier (q) -> begin
Some (q)
end
| uu____2511 -> begin
...
let ds1 = (d)::ds
in ((FStar_List.iter (fun uu___109_3393 -> (match (uu___109_3393) with
...
let name_of_char = (fun uu___110_3412 -> (match (uu___110_3412) with
| '&' -> begin
"Amp"
end
| '@' -> begin
...
let string_of_let_qualifier : let_qualifier  ->  Prims.string = (fun uu___111_3456 -> (match (uu___111_3456) with
| NoLetQualifier -> begin
""
end
| Rec -> begin
...
let imp_to_string : imp  ->  Prims.string = (fun uu___112_3485 -> (match (uu___112_3485) with
| Hash -> begin
"#"
end
| uu____3486 -> begin
...
and aqual_to_string : aqual  ->  Prims.string = (fun uu___113_3763 -> (match (uu___113_3763) with
| Some (Equality) -> begin
"$"
end
| Some (Implicit) -> begin
...
let id_of_tycon : tycon  ->  Prims.string = (fun uu___114_3858 -> (match (uu___114_3858) with
