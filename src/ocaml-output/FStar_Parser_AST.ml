...
let (uu___is_PatTvar : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatTvar _0 -> true | uu___ -> false
          ...
          let uu___ =
            FStar_List.choose
              (fun uu___1  ->
                 ...
                 | uu___2 -> FStar_Pervasives_Native.None) decorations
             in
        ...
        let qualifiers1 =
          FStar_List.choose
            (fun uu___  ->
               ...
               | uu___1 -> FStar_Pervasives_Native.None) decorations
           in
            ...
            let uu___2 =
              let uu___3 =
                let uu___4 =
                  let uu___5 =
                    let uu___6 =
                      let uu___7 = FStar_Ident.lid_of_ids [x]  in Var uu___7
                       in
            ...
            (match d.d with
             | TopLevelModule m ->
                 let ds2 =
                   if is_light
                   then
                     let uu___1 = mk_decl (Pragma LightOff) light_range []
                        in
                     uu___1 :: ds1
                   else ds1  in
...
let rec (term_to_string : term -> Prims.string) =
  fun x  ->
          ...
          to_string_l " "
            (fun uu___3  ->
               ...
               | (a1,(p1,b1)) ->
                   ...
                   FStar_Util.format3 "%sand %s=%s" uu___4 uu___5 uu___6) lbs
           in
               ...
               | (p,w,e) ->
                   ...
                   let uu___4 =
                     ...
                     | FStar_Pervasives_Native.Some e1 ->
                         ...
                         FStar_Util.format1 "when %s" uu___5
                      in
          ...
          to_string_l " "
            (fun uu___2  ->
               ...
               | (l,e1) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu___3 uu___4) fields
           in
          ...
          to_string_l " "
            (fun uu___1  ->
               ...
               | (l,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu___2 uu___3) fields
           in
    ...
    | Quote (t,Dynamic ) ->
        ...
        FStar_Util.format1 "quote (%s)" uu___
    | VQuote t ->
        let uu___ = term_to_string t  in FStar_Util.format1 "`%%%s" uu___
...
and (aqual_to_string :
  ...
  fun uu___  ->
    ...
    | FStar_Pervasives_Native.Some (Meta (Arg_qualifier_meta_tac t)) ->
        let uu___1 =
          let uu___2 = term_to_string t  in Prims.op_Hat uu___2 "]"  in
        Prims.op_Hat "#[" uu___1
          ...
          to_string_l "; "
            (fun uu___1  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu___2 uu___3) l
           in
        FStar_Util.format1 "{%s}" uu___
    | PatOr l -> to_string_l "|\n " pat_to_string l
    | PatOp op ->
...
let (decl_to_string : decl -> Prims.string) =
  fun d  ->
    ...
    | Tycon (uu___,uu___1,tys) ->
        let uu___2 =
          let uu___3 = FStar_All.pipe_right tys (FStar_List.map id_of_tycon)
             in
          FStar_All.pipe_right uu___3 (FStar_String.concat ", ")  in
        Prims.op_Hat "type " uu___2
    | Val (i,uu___) ->
        let uu___1 = FStar_Ident.string_of_id i  in
        Prims.op_Hat "val " uu___1
    | Exception (i,uu___) ->
        let uu___1 = FStar_Ident.string_of_id i  in
