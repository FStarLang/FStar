...
let compile_op: Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___111_3412 =
        match uu___111_3412 with
        | '&' -> "Amp"
        | '@' -> "At"
        | '+' -> "Plus"
...
let imp_to_string: imp -> Prims.string =
  fun uu___113_3485  ->
    match uu___113_3485 with | Hash  -> "#" | uu____3486 -> ""
