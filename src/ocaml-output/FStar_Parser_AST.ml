...
in (let _109_937 = (let _109_936 = (let _109_935 = (let _109_934 = (let _109_933 = (let _109_932 = (let _109_931 = (let _109_930 = (FStar_Absyn_Syntax.lid_of_ids ((x)::[]))
in Var (_109_930))
in (mk_term _109_931 r1 Expr))
in (_109_932, branches))
in Match (_109_933))
in (mk_term _109_934 r2 Expr))
in (((mk_pattern (PatVar ((x, false))) r1))::[], _109_935))
in Abs (_109_936))
in (mk_term _109_937 r2 Expr))))
...
let lid_with_range = (fun lid r -> (let _109_946 = (FStar_Absyn_Syntax.path_of_lid lid)
in (FStar_Absyn_Syntax.lid_of_path _109_946 r)))

let to_string_l = (fun sep f l -> (let _109_953 = (FStar_List.map f l)
in (FStar_String.concat sep _109_953)))
...
(let _109_960 = (term_to_string t)
in (FStar_Util.format1 "(requires %s)" _109_960))
end
| Ensures (t, _40_254) -> begin
(let _109_961 = (term_to_string t)
in (FStar_Util.format1 "(ensures %s)" _109_961))
end
| Labeled (t, l, _40_260) -> begin
(let _109_962 = (term_to_string t)
in (FStar_Util.format2 "(labeled %s %s)" l _109_962))
end
| Const (c) -> begin
(FStar_Absyn_Print.const_to_string c)
end
| Op (s, xs) -> begin
(let _109_965 = (let _109_964 = (FStar_List.map (fun x -> (FStar_All.pipe_right x term_to_string)) xs)
in (FStar_String.concat ", " _109_964))
in (FStar_Util.format2 "%s(%s)" s _109_965))
end
| Tvar (id) -> begin
...
(let _109_969 = (FStar_Absyn_Print.sli l)
in (let _109_968 = (to_string_l " " (fun _40_281 -> (match (_40_281) with
| (a, imp) -> begin
(let _109_967 = (term_to_string a)
in (FStar_Util.format2 "%s%s" (imp_to_string imp) _109_967))
end)) args)
in (FStar_Util.format2 "(%s %s)" _109_969 _109_968)))
end
| Abs (pats, t) when (x.level = Expr) -> begin
(let _109_971 = (to_string_l " " pat_to_string pats)
in (let _109_970 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "(fun %s -> %s)" _109_971 _109_970)))
end
| Abs (pats, t) when (x.level = Type) -> begin
(let _109_973 = (to_string_l " " pat_to_string pats)
in (let _109_972 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "(fun %s => %s)" _109_973 _109_972)))
end
| App (t1, t2, imp) -> begin
(let _109_975 = (FStar_All.pipe_right t1 term_to_string)
in (let _109_974 = (FStar_All.pipe_right t2 term_to_string)
in (FStar_Util.format3 "%s %s%s" _109_975 (imp_to_string imp) _109_974)))
end
| Let (false, (pat, tm)::[], body) -> begin
(let _109_978 = (FStar_All.pipe_right pat pat_to_string)
in (let _109_977 = (FStar_All.pipe_right tm term_to_string)
in (let _109_976 = (FStar_All.pipe_right body term_to_string)
in (FStar_Util.format3 "let %s = %s in %s" _109_978 _109_977 _109_976))))
end
| Let (_40_304, lbs, body) -> begin
(let _109_983 = (to_string_l " and " (fun _40_311 -> (match (_40_311) with
| (p, b) -> begin
(let _109_981 = (FStar_All.pipe_right p pat_to_string)
in (let _109_980 = (FStar_All.pipe_right b term_to_string)
in (FStar_Util.format2 "%s=%s" _109_981 _109_980)))
end)) lbs)
in (let _109_982 = (FStar_All.pipe_right body term_to_string)
in (FStar_Util.format2 "let rec %s in %s" _109_983 _109_982)))
end
| Seq (t1, t2) -> begin
(let _109_985 = (FStar_All.pipe_right t1 term_to_string)
in (let _109_984 = (FStar_All.pipe_right t2 term_to_string)
in (FStar_Util.format2 "%s; %s" _109_985 _109_984)))
end
| If (t1, t2, t3) -> begin
(let _109_988 = (FStar_All.pipe_right t1 term_to_string)
in (let _109_987 = (FStar_All.pipe_right t2 term_to_string)
in (let _109_986 = (FStar_All.pipe_right t3 term_to_string)
in (FStar_Util.format3 "if %s then %s else %s" _109_988 _109_987 _109_986))))
end
| Match (t, branches) -> begin
(let _109_995 = (FStar_All.pipe_right t term_to_string)
in (let _109_994 = (to_string_l " | " (fun _40_328 -> (match (_40_328) with
| (p, w, e) -> begin
(let _109_993 = (FStar_All.pipe_right p pat_to_string)
in (let _109_992 = (match (w) with
| None -> begin
""
end
| Some (e) -> begin
(let _109_990 = (term_to_string e)
in (FStar_Util.format1 "when %s" _109_990))
end)
in (let _109_991 = (FStar_All.pipe_right e term_to_string)
in (FStar_Util.format3 "%s %s -> %s" _109_993 _109_992 _109_991))))
end)) branches)
in (FStar_Util.format2 "match %s with %s" _109_995 _109_994)))
end
| Ascribed (t1, t2) -> begin
(let _109_997 = (FStar_All.pipe_right t1 term_to_string)
in (let _109_996 = (FStar_All.pipe_right t2 term_to_string)
in (FStar_Util.format2 "(%s : %s)" _109_997 _109_996)))
end
| Record (Some (e), fields) -> begin
(let _109_1002 = (FStar_All.pipe_right e term_to_string)
in (let _109_1001 = (to_string_l " " (fun _40_343 -> (match (_40_343) with
| (l, e) -> begin
(let _109_1000 = (FStar_Absyn_Print.sli l)
in (let _109_999 = (FStar_All.pipe_right e term_to_string)
in (FStar_Util.format2 "%s=%s" _109_1000 _109_999)))
end)) fields)
in (FStar_Util.format2 "{%s with %s}" _109_1002 _109_1001)))
end
| Record (None, fields) -> begin
(let _109_1006 = (to_string_l " " (fun _40_350 -> (match (_40_350) with
| (l, e) -> begin
(let _109_1005 = (FStar_Absyn_Print.sli l)
in (let _109_1004 = (FStar_All.pipe_right e term_to_string)
in (FStar_Util.format2 "%s=%s" _109_1005 _109_1004)))
end)) fields)
in (FStar_Util.format1 "{%s}" _109_1006))
end
| Project (e, l) -> begin
(let _109_1008 = (FStar_All.pipe_right e term_to_string)
in (let _109_1007 = (FStar_Absyn_Print.sli l)
in (FStar_Util.format2 "%s.%s" _109_1008 _109_1007)))
end
| Product ([], t) -> begin
(term_to_string t)
end
...
(let _109_1010 = (FStar_All.pipe_right b binder_to_string)
in (let _109_1009 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s -> %s" _109_1010 _109_1009)))
end
| Product (b::[], t) when (x.level = Kind) -> begin
(let _109_1012 = (FStar_All.pipe_right b binder_to_string)
in (let _109_1011 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s => %s" _109_1012 _109_1011)))
end
| Sum (binders, t) -> begin
(let _109_1015 = (let _109_1013 = (FStar_All.pipe_right binders (FStar_List.map binder_to_string))
in (FStar_All.pipe_right _109_1013 (FStar_String.concat " * ")))
in (let _109_1014 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s * %s" _109_1015 _109_1014)))
end
| QForall (bs, pats, t) -> begin
(let _109_1018 = (to_string_l " " binder_to_string bs)
in (let _109_1017 = (to_string_l "; " term_to_string pats)
in (let _109_1016 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format3 "forall %s.{:pattern %s} %s" _109_1018 _109_1017 _109_1016))))
end
| QExists (bs, pats, t) -> begin
(let _109_1021 = (to_string_l " " binder_to_string bs)
in (let _109_1020 = (to_string_l "; " term_to_string pats)
in (let _109_1019 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format3 "exists %s.{:pattern %s} %s" _109_1021 _109_1020 _109_1019))))
end
| Refine (b, t) -> begin
(let _109_1023 = (FStar_All.pipe_right b binder_to_string)
in (let _109_1022 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s:{%s}" _109_1023 _109_1022)))
end
| NamedTyp (x, t) -> begin
(let _109_1024 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s:%s" x.FStar_Absyn_Syntax.idText _109_1024))
end
| Paren (t) -> begin
(let _109_1025 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format1 "(%s)" _109_1025))
end
| Product (bs, t) -> begin
(let _109_1028 = (let _109_1026 = (FStar_All.pipe_right bs (FStar_List.map binder_to_string))
in (FStar_All.pipe_right _109_1026 (FStar_String.concat ",")))
in (let _109_1027 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "Unidentified product: [%s] %s" _109_1028 _109_1027)))
end
| t -> begin
...
(let _109_1030 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s:%s" i.FStar_Absyn_Syntax.idText _109_1030))
end
| NoName (t) -> begin
...
| PatApp (p, ps) -> begin
(let _109_1033 = (FStar_All.pipe_right p pat_to_string)
in (let _109_1032 = (to_string_l " " pat_to_string ps)
in (FStar_Util.format2 "(%s %s)" _109_1033 _109_1032)))
end
...
| PatList (l) -> begin
(let _109_1034 = (to_string_l "; " pat_to_string l)
in (FStar_Util.format1 "[%s]" _109_1034))
end
| PatTuple (l, false) -> begin
(let _109_1035 = (to_string_l ", " pat_to_string l)
in (FStar_Util.format1 "(%s)" _109_1035))
end
| PatTuple (l, true) -> begin
(let _109_1036 = (to_string_l ", " pat_to_string l)
in (FStar_Util.format1 "(|%s|)" _109_1036))
end
| PatRecord (l) -> begin
(let _109_1040 = (to_string_l "; " (fun _40_464 -> (match (_40_464) with
| (f, e) -> begin
(let _109_1039 = (FStar_Absyn_Print.sli f)
in (let _109_1038 = (FStar_All.pipe_right e pat_to_string)
in (FStar_Util.format2 "%s=%s" _109_1039 _109_1038)))
end)) l)
in (FStar_Util.format1 "{%s}" _109_1040))
end
| PatOr (l) -> begin
(to_string_l "|\n " pat_to_string l)
end
| PatAscribed (p, t) -> begin
(let _109_1042 = (FStar_All.pipe_right p pat_to_string)
in (let _109_1041 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "(%s:%s)" _109_1042 _109_1041)))
end))

let error = (fun msg tm r -> (let tm = (FStar_All.pipe_right tm term_to_string)
in (let tm = (match (((FStar_String.length tm) >= 80)) with
| true -> begin
(let _109_1046 = (FStar_Util.substring tm 0 77)
in (Prims.strcat _109_1046 "..."))
end
| false -> begin
tm
end)
...
let mkRefSet = (fun r elts -> (let empty = (let _109_1090 = (let _109_1089 = (FStar_Absyn_Util.set_lid_range FStar_Absyn_Const.set_empty r)
in Var (_109_1089))
in (mk_term _109_1090 r Expr))
in (let ref_constr = (let _109_1092 = (let _109_1091 = (FStar_Absyn_Util.set_lid_range FStar_Absyn_Const.heap_ref r)
in Var (_109_1091))
in (mk_term _109_1092 r Expr))
in (let singleton = (let _109_1094 = (let _109_1093 = (FStar_Absyn_Util.set_lid_range FStar_Absyn_Const.set_singleton r)
in Var (_109_1093))
in (mk_term _109_1094 r Expr))
in (let union = (let _109_1096 = (let _109_1095 = (FStar_Absyn_Util.set_lid_range FStar_Absyn_Const.set_union r)
in Var (_109_1095))
in (mk_term _109_1096 r Expr))
...
(match (t.tm) with
| Name (s) -> begin
(let _109_1108 = (let _109_1107 = (let _109_1106 = (FStar_List.map (fun a -> (a, Nothing)) args)
in (s, _109_1106))
in Construct (_109_1107))
in (mk_term _109_1108 r Un))
end
| _40_529 -> begin
...
in (let admit = (let admit_name = (let _109_1114 = (let _109_1113 = (FStar_Absyn_Util.set_lid_range FStar_Absyn_Const.admit_lid r)
in Var (_109_1113))
in (mk_term _109_1114 r Expr))
in (mkExplicitApp admit_name ((unit_const)::[]) r))
in (let magic = (let magic_name = (let _109_1116 = (let _109_1115 = (FStar_Absyn_Util.set_lid_range FStar_Absyn_Const.magic_lid r)
in Var (_109_1115))
in (mk_term _109_1116 r Expr))
in (mkExplicitApp magic_name ((unit_const)::[]) r))
in (let admit_magic = (mk_term (Seq ((admit, magic))) r Expr)
in admit_magic)))))

let mkWildAdmitMagic = (fun r -> (let _109_1118 = (mkAdmitMagic r)
in ((mk_pattern PatWild r), None, _109_1118)))
...
in (let focussed = (let _109_1121 = (FStar_List.filter Prims.fst branches)
in (FStar_All.pipe_right _109_1121 (FStar_List.map Prims.snd)))
in (let _109_1123 = (let _109_1122 = (mkWildAdmitMagic r)
in (_109_1122)::[])
in (FStar_List.append focussed _109_1123))))
end
| false -> begin
...
| false -> begin
(let _109_1127 = (mkAdmitMagic r)
in ((Prims.fst lb), _109_1127))
end)
end)) lbs))
end
| false -> begin
...
let mkFsTypApp = (fun t args r -> (let _109_1135 = (FStar_List.map (fun a -> (a, FsTypApp)) args)
in (mkApp t _109_1135 r)))

let mkTuple = (fun args r -> (let cons = (FStar_Absyn_Util.mk_tuple_data_lid (FStar_List.length args) r)
in (let _109_1141 = (FStar_List.map (fun x -> (x, Nothing)) args)
in (mkApp (mk_term (Name (cons)) r Expr) _109_1141 r))))

let mkDTuple = (fun args r -> (let cons = (FStar_Absyn_Util.mk_dtuple_data_lid (FStar_List.length args) r)
in (let _109_1147 = (FStar_List.map (fun x -> (x, Nothing)) args)
in (mkApp (mk_term (Name (cons)) r Expr) _109_1147 r))))
