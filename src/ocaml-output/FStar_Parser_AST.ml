...
let (uu___is_Static : quote_kind -> Prims.bool) =
  fun projectee -> match projectee with | Static -> true | uu____62 -> false
let (uu___is_Dynamic : quote_kind -> Prims.bool) =
  fun projectee -> match projectee with | Dynamic -> true | uu____66 -> false
type term' =
  | Wild 
...
let (uu___is_Var : term' -> Prims.bool) =
  fun projectee -> match projectee with | Var _0 -> true | uu____635 -> false
...
let (uu___is_Abs : term' -> Prims.bool) =
  fun projectee -> match projectee with | Abs _0 -> true | uu____745 -> false
let (__proj__Abs__item___0 :
  term' -> (pattern Prims.list, term) FStar_Pervasives_Native.tuple2) =
  fun projectee -> match projectee with | Abs _0 -> _0
let (uu___is_App : term' -> Prims.bool) =
  fun projectee -> match projectee with | App _0 -> true | uu____781 -> false
let (__proj__App__item___0 :
  term' -> (term, term, imp) FStar_Pervasives_Native.tuple3) =
  fun projectee -> match projectee with | App _0 -> _0
let (uu___is_Let : term' -> Prims.bool) =
  fun projectee -> match projectee with | Let _0 -> true | uu____831 -> false
...
let (uu___is_Seq : term' -> Prims.bool) =
  fun projectee -> match projectee with | Seq _0 -> true | uu____935 -> false
...
let (uu___is_If : term' -> Prims.bool) =
  fun projectee -> match projectee with | If _0 -> true | uu____1001 -> false
...
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Noeq -> true | uu____2668 -> false
...
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Logic -> true | uu____2732 -> false
      ...
      fun decorations ->
        ...
        let attributes_ =
          let uu____3773 =
            FStar_List.choose
              (fun uu___40_3782 ->
                 match uu___40_3782 with
                 | DeclAttributes a -> FStar_Pervasives_Native.Some a
                 | uu____3792 -> FStar_Pervasives_Native.None) decorations in
          at_most_one "attribute set" r uu____3773 in
        let attributes_1 = FStar_Util.dflt [] attributes_ in
        let qualifiers =
          FStar_List.choose
            (fun uu___41_3807 ->
               match uu___41_3807 with
               | Qualifier q -> FStar_Pervasives_Native.Some q
               | uu____3811 -> FStar_Pervasives_Native.None) decorations in
      ...
      fun r ->
        fun l ->
          let t1 =
            ...
            | uu____3868 -> Op ((FStar_Ident.mk_ident ("-", rminus)), [t]) in
          mk_term t1 r l
...
let focusAttrLetBindings :
  'Auu____4766 'Auu____4767 .
    ('Auu____4766,
      (Prims.bool, ('Auu____4767, term) FStar_Pervasives_Native.tuple2)
        FStar_Pervasives_Native.tuple2)
      FStar_Pervasives_Native.tuple2 Prims.list ->
      FStar_Range.range ->
  ...
  fun lbs ->
    fun r ->
      let should_filter =
        FStar_Util.for_some
          (fun uu____4831 ->
             match uu____4831 with | (attr, (focus, uu____4846)) -> focus)
          lbs in
      if should_filter
      then
        (FStar_Errors.log_issue r
                      ...
                      (match pat.pat with
                       ...
                       | uu____5185 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____5189 =
                                 let uu____5190 = FStar_Ident.lid_of_ids [x] in
                                 Var uu____5190 in
                             ...
                             let otherwise_branch =
                               ...
                               ((mk_pattern PatWild phi.range),
                                 FStar_Pervasives_Native.None, uu____5211) in
                             mk_term
...
let (compile_op :
  ...
  fun arity ->
    fun s ->
      fun r ->
        let name_of_char uu___43_5483 =
          match uu___43_5483 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___45_5613 ->
    match uu___45_5613 with | Hash -> "#" | uu____5614 -> ""
          ...
          to_string_l " "
            (fun uu____5790 ->
               ...
               | (a1, (p1, b1)) ->
                   ...
                   let uu____5820 = FStar_All.pipe_right b1 term_to_string in
        ...
        let uu____5982 =
          to_string_l " "
            (fun uu____5991 ->
               ...
               | (l, e1) ->
                   let uu____5998 = FStar_All.pipe_right e1 term_to_string in
          ...
          to_string_l "; "
            (fun uu____6216 ->
               ...
               | (f, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____6223) l in
...
let (decl_to_string : decl -> Prims.string) =
  fun d ->
        ...
        let uu____6509 =
          let uu____6510 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____6532 ->
                    match uu____6532 with | (x, uu____6540) -> id_of_tycon x)) in
    ...
    | Splice t ->
        let uu____6575 =
          let uu____6576 = term_to_string t in Prims.strcat uu____6576 ")" in
