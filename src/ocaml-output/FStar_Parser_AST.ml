...
let (uu___is_Paren : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Paren _0 -> true | uu____1517 -> false
  
let (__proj__Paren__item___0 : term' -> term) =
  fun projectee  -> match projectee with | Paren _0 -> _0 
let (uu___is_Requires : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Requires _0 -> true | uu____1535 -> false
...
let (uu___is_Ensures : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Ensures _0 -> true | uu____1571 -> false
...
let (uu___is_Labeled : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Labeled _0 -> true | uu____1607 -> false
...
let (uu___is_Discrim : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Discrim _0 -> true | uu____1637 -> false
  
let (__proj__Discrim__item___0 : term' -> FStar_Ident.lid) =
  fun projectee  -> match projectee with | Discrim _0 -> _0 
let (uu___is_Attributes : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Attributes _0 -> true | uu____1651 -> false
  
let (__proj__Attributes__item___0 : term' -> term Prims.list) =
  fun projectee  -> match projectee with | Attributes _0 -> _0 
let (uu___is_Quote : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Quote _0 -> true | uu____1669 -> false
...
let (uu___is_Variable : binder' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Variable _0 -> true | uu____1699 -> false
  
let (__proj__Variable__item___0 : binder' -> FStar_Ident.ident) =
  fun projectee  -> match projectee with | Variable _0 -> _0 
let (uu___is_TVariable : binder' -> Prims.bool) =
  fun projectee  ->
    match projectee with | TVariable _0 -> true | uu____1711 -> false
  
let (__proj__TVariable__item___0 : binder' -> FStar_Ident.ident) =
  fun projectee  -> match projectee with | TVariable _0 -> _0 
let (uu___is_Annotated : binder' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Annotated _0 -> true | uu____1727 -> false
...
let (uu___is_TAnnotated : binder' -> Prims.bool) =
  fun projectee  ->
    match projectee with | TAnnotated _0 -> true | uu____1755 -> false
...
let (uu___is_NoName : binder' -> Prims.bool) =
  fun projectee  ->
    match projectee with | NoName _0 -> true | uu____1779 -> false
...
let (uu___is_PatWild : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatWild  -> true | uu____1818 -> false
  
let (uu___is_PatConst : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatConst _0 -> true | uu____1823 -> false
  
let (__proj__PatConst__item___0 : pattern' -> FStar_Const.sconst) =
  fun projectee  -> match projectee with | PatConst _0 -> _0 
let (uu___is_PatApp : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatApp _0 -> true | uu____1841 -> false
...
let (uu___is_PatVar : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatVar _0 -> true | uu____1877 -> false
...
let (uu___is_PatName : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatName _0 -> true | uu____1907 -> false
  
let (__proj__PatName__item___0 : pattern' -> FStar_Ident.lid) =
  fun projectee  -> match projectee with | PatName _0 -> _0 
let (uu___is_PatTvar : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatTvar _0 -> true | uu____1925 -> false
...
let (uu___is_PatList : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatList _0 -> true | uu____1957 -> false
  
let (__proj__PatList__item___0 : pattern' -> pattern Prims.list) =
  fun projectee  -> match projectee with | PatList _0 -> _0 
let (uu___is_PatTuple : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatTuple _0 -> true | uu____1981 -> false
...
let (uu___is_PatRecord : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatRecord _0 -> true | uu____2017 -> false
...
let (uu___is_PatAscribed : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatAscribed _0 -> true | uu____2051 -> false
...
let (uu___is_PatOr : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatOr _0 -> true | uu____2077 -> false
  
let (__proj__PatOr__item___0 : pattern' -> pattern Prims.list) =
  fun projectee  -> match projectee with | PatOr _0 -> _0 
let (uu___is_PatOp : pattern' -> Prims.bool) =
  fun projectee  ->
    match projectee with | PatOp _0 -> true | uu____2095 -> false
...
let (uu___is_TyconAbstract : tycon -> Prims.bool) =
  fun projectee  ->
    match projectee with | TyconAbstract _0 -> true | uu____2233 -> false
...
let (uu___is_TyconAbbrev : tycon -> Prims.bool) =
  fun projectee  ->
    match projectee with | TyconAbbrev _0 -> true | uu____2287 -> false
...
let (uu___is_TyconRecord : tycon -> Prims.bool) =
  fun projectee  ->
    match projectee with | TyconRecord _0 -> true | uu____2357 -> false
...
let (uu___is_TyconVariant : tycon -> Prims.bool) =
  fun projectee  ->
    match projectee with | TyconVariant _0 -> true | uu____2461 -> false
...
let (uu___is_Private : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Private  -> true | uu____2550 -> false
  
let (uu___is_Abstract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Abstract  -> true | uu____2554 -> false
  
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Noeq  -> true | uu____2558 -> false
  
let (uu___is_Unopteq : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Unopteq  -> true | uu____2562 -> false
  
let (uu___is_Assumption : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Assumption  -> true | uu____2566 -> false
  
let (uu___is_DefaultEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | DefaultEffect  -> true | uu____2570 -> false
  
let (uu___is_TotalEffect : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | TotalEffect  -> true | uu____2574 -> false
  
let (uu___is_Effect_qual : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Effect_qual  -> true | uu____2578 -> false
  
let (uu___is_New : qualifier -> Prims.bool) =
  fun projectee  -> match projectee with | New  -> true | uu____2582 -> false 
let (uu___is_Inline : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Inline  -> true | uu____2586 -> false
  
let (uu___is_Visible : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Visible  -> true | uu____2590 -> false
...
let (uu___is_Irreducible : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Irreducible  -> true | uu____2602 -> false
  
let (uu___is_NoExtract : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | NoExtract  -> true | uu____2606 -> false
  
let (uu___is_Reifiable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reifiable  -> true | uu____2610 -> false
  
let (uu___is_Reflectable : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Reflectable  -> true | uu____2614 -> false
  
let (uu___is_Opaque : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Opaque  -> true | uu____2618 -> false
  
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee  ->
    match projectee with | Logic  -> true | uu____2622 -> false
...
let (uu___is_Qualifier : decoration -> Prims.bool) =
  fun projectee  ->
    match projectee with | Qualifier _0 -> true | uu____2643 -> false
  
let (__proj__Qualifier__item___0 : decoration -> qualifier) =
  fun projectee  -> match projectee with | Qualifier _0 -> _0 
let (uu___is_DeclAttributes : decoration -> Prims.bool) =
  fun projectee  ->
    match projectee with | DeclAttributes _0 -> true | uu____2657 -> false
  
let (__proj__DeclAttributes__item___0 : decoration -> term Prims.list) =
  fun projectee  -> match projectee with | DeclAttributes _0 -> _0 
let (uu___is_Doc : decoration -> Prims.bool) =
  fun projectee  ->
    match projectee with | Doc _0 -> true | uu____2675 -> false
...
let (uu___is_NonReifiableLift : lift_op -> Prims.bool) =
  fun projectee  ->
    match projectee with | NonReifiableLift _0 -> true | uu____2703 -> false
  
let (__proj__NonReifiableLift__item___0 : lift_op -> term) =
  fun projectee  -> match projectee with | NonReifiableLift _0 -> _0 
let (uu___is_ReifiableLift : lift_op -> Prims.bool) =
  fun projectee  ->
    match projectee with | ReifiableLift _0 -> true | uu____2719 -> false
...
let (uu___is_LiftForFree : lift_op -> Prims.bool) =
  fun projectee  ->
    match projectee with | LiftForFree _0 -> true | uu____2743 -> false
...
let (uu___is_SetOptions : pragma -> Prims.bool) =
  fun projectee  ->
    match projectee with | SetOptions _0 -> true | uu____2795 -> false
  
let (__proj__SetOptions__item___0 : pragma -> Prims.string) =
  fun projectee  -> match projectee with | SetOptions _0 -> _0 
let (uu___is_ResetOptions : pragma -> Prims.bool) =
  fun projectee  ->
    match projectee with | ResetOptions _0 -> true | uu____2809 -> false
...
let (uu___is_LightOff : pragma -> Prims.bool) =
  fun projectee  ->
    match projectee with | LightOff  -> true | uu____2826 -> false
...
let (uu___is_TopLevelModule : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | TopLevelModule _0 -> true | uu____2977 -> false
  
let (__proj__TopLevelModule__item___0 : decl' -> FStar_Ident.lid) =
  fun projectee  -> match projectee with | TopLevelModule _0 -> _0 
let (uu___is_Open : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Open _0 -> true | uu____2989 -> false
  
let (__proj__Open__item___0 : decl' -> FStar_Ident.lid) =
  fun projectee  -> match projectee with | Open _0 -> _0 
let (uu___is_Include : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Include _0 -> true | uu____3001 -> false
  
let (__proj__Include__item___0 : decl' -> FStar_Ident.lid) =
  fun projectee  -> match projectee with | Include _0 -> _0 
let (uu___is_ModuleAbbrev : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | ModuleAbbrev _0 -> true | uu____3017 -> false
...
let (uu___is_TopLevelLet : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | TopLevelLet _0 -> true | uu____3051 -> false
...
let (uu___is_Main : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Main _0 -> true | uu____3093 -> false
  
let (__proj__Main__item___0 : decl' -> term) =
  fun projectee  -> match projectee with | Main _0 -> _0 
let (uu___is_Tycon : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tycon _0 -> true | uu____3117 -> false
...
let (uu___is_Val : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Val _0 -> true | uu____3169 -> false
...
let (uu___is_Exception : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Exception _0 -> true | uu____3199 -> false
...
let (uu___is_NewEffect : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | NewEffect _0 -> true | uu____3229 -> false
  
let (__proj__NewEffect__item___0 : decl' -> effect_decl) =
  fun projectee  -> match projectee with | NewEffect _0 -> _0 
let (uu___is_SubEffect : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | SubEffect _0 -> true | uu____3241 -> false
  
let (__proj__SubEffect__item___0 : decl' -> lift) =
  fun projectee  -> match projectee with | SubEffect _0 -> _0 
let (uu___is_Pragma : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pragma _0 -> true | uu____3253 -> false
  
let (__proj__Pragma__item___0 : decl' -> pragma) =
  fun projectee  -> match projectee with | Pragma _0 -> _0 
let (uu___is_Fsdoc : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Fsdoc _0 -> true | uu____3265 -> false
  
let (__proj__Fsdoc__item___0 : decl' -> fsdoc) =
  fun projectee  -> match projectee with | Fsdoc _0 -> _0 
let (uu___is_Assume : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Assume _0 -> true | uu____3281 -> false
...
let (uu___is_DefineEffect : effect_decl -> Prims.bool) =
  fun projectee  ->
    match projectee with | DefineEffect _0 -> true | uu____3371 -> false
...
let (uu___is_RedefineEffect : effect_decl -> Prims.bool) =
  fun projectee  ->
    match projectee with | RedefineEffect _0 -> true | uu____3427 -> false
...
let (uu___is_Module : modul -> Prims.bool) =
  fun projectee  ->
    match projectee with | Module _0 -> true | uu____3491 -> false
...
let (uu___is_Interface : modul -> Prims.bool) =
  fun projectee  ->
    match projectee with | Interface _0 -> true | uu____3529 -> false
      ...
      (let uu____3575 =
         let uu____3580 =
           FStar_Util.format1
            ...
            in
         (FStar_Errors.Fatal_InvalidIdentifier, uu____3580)  in
       FStar_Errors.raise_error uu____3575 id1.FStar_Ident.idRange)
  
let at_most_one :
  'Auu____3585 .
    Prims.string ->
      FStar_Range.range ->
        'Auu____3585 Prims.list ->
          'Auu____3585 FStar_Pervasives_Native.option
  =
  fun s  ->
    fun r  ->
      fun l  ->
            ...
            let uu____3608 =
              let uu____3613 =
                FStar_Util.format1
                 ...
                 in
              (FStar_Errors.Fatal_MoreThanOneDeclaration, uu____3613)  in
            FStar_Errors.raise_error uu____3608 r
      ...
      fun decorations  ->
        let doc1 =
          let uu____3632 =
            FStar_List.choose
              (fun uu___36_3637  ->
                 match uu___36_3637 with
                 | Doc d1 -> FStar_Pervasives_Native.Some d1
                 | uu____3641 -> FStar_Pervasives_Native.None) decorations
             in
          at_most_one "fsdoc" r uu____3632  in
        let attributes_ =
          let uu____3647 =
            FStar_List.choose
              (fun uu___37_3656  ->
                 match uu___37_3656 with
                 | DeclAttributes a -> FStar_Pervasives_Native.Some a
                 | uu____3666 -> FStar_Pervasives_Native.None) decorations
             in
          at_most_one "attribute set" r uu____3647  in
        let attributes_1 = FStar_Util.dflt [] attributes_  in
        let qualifiers =
          FStar_List.choose
            (fun uu___38_3681  ->
               match uu___38_3681 with
               | Qualifier q -> FStar_Pervasives_Native.Some q
               | uu____3685 -> FStar_Pervasives_Native.None) decorations
           in
      ...
      fun r  ->
        fun l  ->
          let t1 =
            ...
            | uu____3742 -> Op ((FStar_Ident.mk_ident ("-", rminus)), [t])
             in
          mk_term t1 r l
            ...
            let uu____3811 =
              let uu____3812 =
                let uu____3813 =
                  let uu____3828 =
                    let uu____3829 =
                      let uu____3830 = FStar_Ident.lid_of_ids [x]  in
                      Var uu____3830  in
                    mk_term uu____3829 r1 Expr  in
                  (uu____3828, branches)  in
                Match uu____3813  in
              mk_term uu____3812 r2 Expr  in
            ([mk_pattern (PatVar (x, FStar_Pervasives_Native.None)) r1],
              uu____3811)
             in
          Abs uu____3804  in
        mk_term uu____3803 r2 Expr
...
let (un_function :
  ...
  fun p  ->
    fun tm  ->
      ...
      | (PatVar uu____3863,Abs (pats,body)) ->
          FStar_Pervasives_Native.Some
...
let (lid_with_range :
  ...
  fun lid  ->
    fun r  ->
      let uu____3897 = FStar_Ident.path_of_lid lid  in
      FStar_Ident.lid_of_path uu____3897 r
             ...
             | Name s ->
                 let uu____4161 =
                   let uu____4162 =
                     ...
                     (s, uu____4173)  in
                   Construct uu____4162  in
                 mk_term uu____4161 r Un
             | uu____4192 ->
                 FStar_List.fold_left
...
let mkWildAdmitMagic :
  'Auu____4208 .
    FStar_Range.range ->
      (pattern,'Auu____4208 FStar_Pervasives_Native.option,term)
        FStar_Pervasives_Native.tuple3
  =
  fun r  ->
    let uu____4221 = mkAdmitMagic r  in
    ((mk_pattern PatWild r), FStar_Pervasives_Native.None, uu____4221)
  
let focusBranches :
  'Auu____4227 .
    (Prims.bool,(pattern,'Auu____4227 FStar_Pervasives_Native.option,
                  term) FStar_Pervasives_Native.tuple3)
      FStar_Pervasives_Native.tuple2 Prims.list ->
      FStar_Range.range ->
        (pattern,'Auu____4227 FStar_Pervasives_Native.option,term)
          FStar_Pervasives_Native.tuple3 Prims.list
  =
  fun branches  ->
    fun r  ->
      ...
      then
        (FStar_Errors.log_issue r
         ...
         (let focussed =
            ...
            FStar_All.pipe_right uu____4317
              (FStar_List.map FStar_Pervasives_Native.snd)
             in
          let uu____4404 =
            let uu____4415 = mkWildAdmitMagic r  in [uu____4415]  in
          FStar_List.append focussed uu____4404))
      else
...
let focusLetBindings :
  'Auu____4504 .
    (Prims.bool,('Auu____4504,term) FStar_Pervasives_Native.tuple2)
      FStar_Pervasives_Native.tuple2 Prims.list ->
      FStar_Range.range ->
        ('Auu____4504,term) FStar_Pervasives_Native.tuple2 Prims.list
  =
  fun lbs  ->
    fun r  ->
           ...
           (fun uu____4574  ->
              ...
              | (f,lb) ->
                  ...
                  then lb
                    ...
                    (let uu____4602 = mkAdmitMagic r  in
                     ((FStar_Pervasives_Native.fst lb), uu____4602))) lbs)
      else
        FStar_All.pipe_right lbs (FStar_List.map FStar_Pervasives_Native.snd)
  
let focusAttrLetBindings :
  'Auu____4640 'Auu____4641 .
    ('Auu____4641,(Prims.bool,('Auu____4640,term)
                                FStar_Pervasives_Native.tuple2)
                    FStar_Pervasives_Native.tuple2)
      FStar_Pervasives_Native.tuple2 Prims.list ->
      FStar_Range.range ->
        ('Auu____4641,('Auu____4640,term) FStar_Pervasives_Native.tuple2)
          FStar_Pervasives_Native.tuple2 Prims.list
  =
  fun lbs  ->
    fun r  ->
      let should_filter =
        FStar_Util.for_some
          (fun uu____4705  ->
             match uu____4705 with | (attr,(focus,uu____4720)) -> focus) lbs
         in
      if should_filter
      then
        (FStar_Errors.log_issue r
           ...
           (fun uu____4772  ->
              ...
              | (attr,(f,lb)) ->
                  ...
                  then (attr, lb)
                    ...
                    (let uu____4825 =
                       let uu____4830 = mkAdmitMagic r  in
                       ((FStar_Pervasives_Native.fst lb), uu____4830)  in
                     (attr, uu____4825))) lbs)
      else
        FStar_All.pipe_right lbs
          (FStar_List.map
             (fun uu____4884  ->
                match uu____4884 with | (attr,(uu____4906,lb)) -> (attr, lb)))
  
let (mkFsTypApp : term -> term Prims.list -> FStar_Range.range -> term) =
  fun t  ->
    fun args  ->
      fun r  ->
        let uu____4941 = FStar_List.map (fun a  -> (a, FsTypApp)) args  in
        mkApp t uu____4941 r
...
let (mkTuple : term Prims.list -> FStar_Range.range -> term) =
  fun args  ->
    fun r  ->
      ...
      let uu____4965 = FStar_List.map (fun x  -> (x, Nothing)) args  in
      mkApp (mk_term (Name cons1) r Expr) uu____4965 r
...
let (mkDTuple : term Prims.list -> FStar_Range.range -> term) =
  fun args  ->
    fun r  ->
      ...
      let uu____4989 = FStar_List.map (fun x  -> (x, Nothing)) args  in
      mkApp (mk_term (Name cons1) r Expr) uu____4989 r
                      ...
                      (match pat.pat with
                       ...
                       | uu____5059 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____5063 =
                                 let uu____5064 = FStar_Ident.lid_of_ids [x]
                                    in
                                 Var uu____5064  in
                               mk_term uu____5063 phi.range Formula  in
                             let pat_branch =
                                 ...
                                 let uu____5086 =
                                   let uu____5087 =
                                     FStar_Ident.lid_of_path ["False"]
                                      ...
                                      in
                                   Name uu____5087  in
                                 mk_term uu____5086 phi.range Formula  in
...
let rec (extract_named_refinement :
  ...
  fun t1  ->
    ...
    | Refine
        ({ b = Annotated (x,t); brange = uu____5163; blevel = uu____5164;
           aqual = uu____5165;_},t')
        ->
        FStar_Pervasives_Native.Some
          ...
          (match ds with
           ...
           | d::ds1 ->
               (match d.d with
                ...
                | uu____5246 -> as_mlist ((m_name, m_decl), (d :: cur1)) ds1))
        ...
        | (d,ds1) ->
            (match d.d with
             ...
             | uu____5314 ->
                 ...
                 (FStar_List.iter
                    (fun uu___39_5325  ->
                       match uu___39_5325 with
                       | { d = TopLevelModule uu____5326; drange = r;
                           doc = uu____5328; quals = uu____5329;
                           attrs = uu____5330;_} ->
                           FStar_Errors.raise_error
                             (FStar_Errors.Fatal_UnexpectedModuleDeclaration,
...
let (compile_op :
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___40_5349 =
          match uu___40_5349 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
        ...
        let uu____5427 =
          let uu____5428 =
            FStar_List.map
             ...
             in
          FStar_String.concat "," uu____5428  in
        Prims.strcat comment uu____5427
  
let (string_of_let_qualifier : let_qualifier -> Prims.string) =
  fun uu___41_5447  ->
    match uu___41_5447 with
    | NoLetQualifier  -> ""
    | Rec  -> "rec"
    | Mutable  -> "mutable"
...
let to_string_l :
  'Auu____5452 .
    Prims.string ->
      ('Auu____5452 -> Prims.string) ->
        'Auu____5452 Prims.list -> Prims.string
  =
  fun sep  ->
    fun f  ->
      fun l  ->
        let uu____5474 = FStar_List.map f l  in
        FStar_String.concat sep uu____5474
  
let (imp_to_string : imp -> Prims.string) =
  fun uu___42_5479  ->
    match uu___42_5479 with | Hash  -> "#" | uu____5480 -> ""
  
let rec (term_to_string : term -> Prims.string) =
  fun x  ->
    match x.tm with
    | Wild  -> "_"
    | Requires (t,uu____5497) ->
        let uu____5502 = term_to_string t  in
        FStar_Util.format1 "(requires %s)" uu____5502
    | Ensures (t,uu____5504) ->
        let uu____5509 = term_to_string t  in
        FStar_Util.format1 "(ensures %s)" uu____5509
    | Labeled (t,l,uu____5512) ->
        let uu____5513 = term_to_string t  in
        FStar_Util.format2 "(labeled %s %s)" l uu____5513
        ...
        let uu____5521 =
          let uu____5522 =
            FStar_List.map
             ...
             in
          FStar_String.concat ", " uu____5522  in
        FStar_Util.format2 "%s(%s)" (FStar_Ident.text_of_id s) uu____5521
        ...
        let uu____5545 =
          to_string_l " "
            (fun uu____5554  ->
               ...
               | (a,imp) ->
                   let uu____5561 = term_to_string a  in
                   FStar_Util.format2 "%s%s" (imp_to_string imp) uu____5561)
            args
           in
        FStar_Util.format2 "(%s %s)" l.FStar_Ident.str uu____5545
    | Abs (pats,t) ->
        let uu____5568 = to_string_l " " pat_to_string pats  in
        let uu____5569 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "(fun %s -> %s)" uu____5568 uu____5569
    | App (t1,t2,imp) ->
        let uu____5573 = FStar_All.pipe_right t1 term_to_string  in
        let uu____5574 = FStar_All.pipe_right t2 term_to_string  in
        FStar_Util.format3 "%s %s%s" uu____5573 (imp_to_string imp)
          uu____5574
    | Let (Rec ,(a,(p,b))::lbs,body) ->
        let uu____5632 = attrs_opt_to_string a  in
        let uu____5633 =
          let uu____5634 = FStar_All.pipe_right p pat_to_string  in
          let uu____5635 = FStar_All.pipe_right b term_to_string  in
          FStar_Util.format2 "%s=%s" uu____5634 uu____5635  in
        let uu____5636 =
          to_string_l " "
            (fun uu____5656  ->
               match uu____5656 with
               | (a1,(p1,b1)) ->
                   let uu____5684 = attrs_opt_to_string a1  in
                   let uu____5685 = FStar_All.pipe_right p1 pat_to_string  in
                   let uu____5686 = FStar_All.pipe_right b1 term_to_string
                      in
                   FStar_Util.format3 "%sand %s=%s" uu____5684 uu____5685
                     uu____5686) lbs
           in
        let uu____5687 = FStar_All.pipe_right body term_to_string  in
        FStar_Util.format4 "%slet rec %s%s in %s" uu____5632 uu____5633
          uu____5636 uu____5687
    | Let (q,(attrs,(pat,tm))::[],body) ->
        let uu____5743 = attrs_opt_to_string attrs  in
        let uu____5744 = FStar_All.pipe_right pat pat_to_string  in
        let uu____5745 = FStar_All.pipe_right tm term_to_string  in
        let uu____5746 = FStar_All.pipe_right body term_to_string  in
        FStar_Util.format5 "%slet %s %s = %s in %s" uu____5743
          (string_of_let_qualifier q) uu____5744 uu____5745 uu____5746
    | Seq (t1,t2) ->
        let uu____5749 = FStar_All.pipe_right t1 term_to_string  in
        let uu____5750 = FStar_All.pipe_right t2 term_to_string  in
        FStar_Util.format2 "%s; %s" uu____5749 uu____5750
    | If (t1,t2,t3) ->
        let uu____5754 = FStar_All.pipe_right t1 term_to_string  in
        let uu____5755 = FStar_All.pipe_right t2 term_to_string  in
        let uu____5756 = FStar_All.pipe_right t3 term_to_string  in
        FStar_Util.format3 "if %s then %s else %s" uu____5754 uu____5755
          uu____5756
    | Match (t,branches) ->
        let uu____5779 = FStar_All.pipe_right t term_to_string  in
        let uu____5780 =
          to_string_l " | "
            (fun uu____5796  ->
               match uu____5796 with
               | (p,w,e) ->
                   let uu____5812 = FStar_All.pipe_right p pat_to_string  in
                   let uu____5813 =
                     match w with
                     | FStar_Pervasives_Native.None  -> ""
                     | FStar_Pervasives_Native.Some e1 ->
                         let uu____5815 = term_to_string e1  in
                         FStar_Util.format1 "when %s" uu____5815
                      in
                   let uu____5816 = FStar_All.pipe_right e term_to_string  in
                   FStar_Util.format3 "%s %s -> %s" uu____5812 uu____5813
                     uu____5816) branches
           in
        FStar_Util.format2 "match %s with %s" uu____5779 uu____5780
    | Ascribed (t1,t2,FStar_Pervasives_Native.None ) ->
        let uu____5821 = FStar_All.pipe_right t1 term_to_string  in
        let uu____5822 = FStar_All.pipe_right t2 term_to_string  in
        FStar_Util.format2 "(%s : %s)" uu____5821 uu____5822
    | Ascribed (t1,t2,FStar_Pervasives_Native.Some tac) ->
        ...
        let uu____5830 = FStar_All.pipe_right tac term_to_string  in
        FStar_Util.format3 "(%s : %s by %s)" uu____5828 uu____5829 uu____5830
    | Record (FStar_Pervasives_Native.Some e,fields) ->
        let uu____5847 = FStar_All.pipe_right e term_to_string  in
        let uu____5848 =
          to_string_l " "
            (fun uu____5857  ->
               match uu____5857 with
               | (l,e1) ->
                   let uu____5864 = FStar_All.pipe_right e1 term_to_string
                      in
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____5864)
            fields
           in
        FStar_Util.format2 "{%s with %s}" uu____5847 uu____5848
        ...
        let uu____5880 =
          to_string_l " "
            (fun uu____5889  ->
               ...
               | (l,e) ->
                   let uu____5896 = FStar_All.pipe_right e term_to_string  in
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____5896)
            fields
           in
        FStar_Util.format1 "{%s}" uu____5880
    | Project (e,l) ->
        let uu____5899 = FStar_All.pipe_right e term_to_string  in
        FStar_Util.format2 "%s.%s" uu____5899 l.FStar_Ident.str
    ...
    | Product (b::[],t) when x.level = Type_level ->
        let uu____5919 = FStar_All.pipe_right b binder_to_string  in
        let uu____5920 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s -> %s" uu____5919 uu____5920
    | Product (b::[],t) when x.level = Kind ->
        let uu____5925 = FStar_All.pipe_right b binder_to_string  in
        let uu____5926 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s => %s" uu____5925 uu____5926
    | Sum (binders,t) ->
        let uu____5933 =
          let uu____5934 =
            FStar_All.pipe_right binders (FStar_List.map binder_to_string)
             in
          FStar_All.pipe_right uu____5934 (FStar_String.concat " * ")  in
        let uu____5943 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s * %s" uu____5933 uu____5943
    | QForall (bs,pats,t) ->
        let uu____5959 = to_string_l " " binder_to_string bs  in
        let uu____5960 =
          to_string_l " \\/ " (to_string_l "; " term_to_string) pats  in
        let uu____5963 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format3 "forall %s.{:pattern %s} %s" uu____5959 uu____5960
          uu____5963
    | QExists (bs,pats,t) ->
        ...
        FStar_Util.format3 "exists %s.{:pattern %s} %s" uu____5979 uu____5980
          uu____5983
    | Refine (b,t) ->
        let uu____5986 = FStar_All.pipe_right b binder_to_string  in
        let uu____5987 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s:{%s}" uu____5986 uu____5987
    | NamedTyp (x1,t) ->
        let uu____5990 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s:%s" x1.FStar_Ident.idText uu____5990
    | Paren t ->
        let uu____5992 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format1 "(%s)" uu____5992
    | Product (bs,t) ->
        let uu____5999 =
          let uu____6000 =
            FStar_All.pipe_right bs (FStar_List.map binder_to_string)  in
          FStar_All.pipe_right uu____6000 (FStar_String.concat ",")  in
        let uu____6009 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "Unidentified product: [%s] %s" uu____5999
          uu____6009
    | t -> "_"
...
and (binder_to_string : binder -> Prims.string) =
  fun x  ->
    let s =
      ...
      | TAnnotated (i,t) ->
          let uu____6017 = FStar_All.pipe_right t term_to_string  in
          FStar_Util.format2 "%s:%s" i.FStar_Ident.idText uu____6017
      | Annotated (i,t) ->
          let uu____6020 = FStar_All.pipe_right t term_to_string  in
          FStar_Util.format2 "%s:%s" i.FStar_Ident.idText uu____6020
      | NoName t -> FStar_All.pipe_right t term_to_string  in
    let uu____6022 = aqual_to_string x.aqual  in
    FStar_Util.format2 "%s%s" uu____6022 s

and (aqual_to_string : aqual -> Prims.string) =
  fun uu___43_6023  ->
    match uu___43_6023 with
...
and (pat_to_string : pattern -> Prims.string) =
  fun x  ->
    ...
    | PatApp (p,ps) ->
        let uu____6033 = FStar_All.pipe_right p pat_to_string  in
        let uu____6034 = to_string_l " " pat_to_string ps  in
        FStar_Util.format2 "(%s %s)" uu____6033 uu____6034
    | PatTvar (i,aq) ->
        let uu____6041 = aqual_to_string aq  in
        FStar_Util.format2 "%s%s" uu____6041 i.FStar_Ident.idText
    | PatVar (i,aq) ->
        let uu____6048 = aqual_to_string aq  in
        FStar_Util.format2 "%s%s" uu____6048 i.FStar_Ident.idText
    | PatName l -> l.FStar_Ident.str
    | PatList l ->
        let uu____6053 = to_string_l "; " pat_to_string l  in
        FStar_Util.format1 "[%s]" uu____6053
    | PatTuple (l,false ) ->
        let uu____6059 = to_string_l ", " pat_to_string l  in
        FStar_Util.format1 "(%s)" uu____6059
    | PatTuple (l,true ) ->
        let uu____6065 = to_string_l ", " pat_to_string l  in
        FStar_Util.format1 "(|%s|)" uu____6065
    | PatRecord l ->
        let uu____6073 =
          to_string_l "; "
            (fun uu____6082  ->
               ...
               | (f,e) ->
                   let uu____6089 = FStar_All.pipe_right e pat_to_string  in
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____6089) l
           in
        FStar_Util.format1 "{%s}" uu____6073
    | PatOr l -> to_string_l "|\n " pat_to_string l
    | PatOp op -> FStar_Util.format1 "(%s)" (FStar_Ident.text_of_id op)
    | PatAscribed (p,t) ->
        let uu____6096 = FStar_All.pipe_right p pat_to_string  in
        let uu____6097 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "(%s:%s)" uu____6096 uu____6097

and (attrs_opt_to_string :
  term Prims.list FStar_Pervasives_Native.option -> Prims.string) =
  fun uu___44_6098  ->
    match uu___44_6098 with
    | FStar_Pervasives_Native.None  -> ""
    | FStar_Pervasives_Native.Some attrs ->
        let uu____6110 =
          let uu____6111 = FStar_List.map term_to_string attrs  in
          FStar_All.pipe_right uu____6111 (FStar_String.concat "; ")  in
        FStar_Util.format1 "[@ %s]" uu____6110
...
let rec (head_id_of_pat : pattern -> FStar_Ident.lid Prims.list) =
  fun p  ->
    ...
    | PatName l -> [l]
    | PatVar (i,uu____6125) ->
        let uu____6130 = FStar_Ident.lid_of_ids [i]  in [uu____6130]
    | PatApp (p1,uu____6132) -> head_id_of_pat p1
    | PatAscribed (p1,uu____6138) -> head_id_of_pat p1
    | uu____6139 -> []
  
let lids_of_let :
  'Auu____6142 .
    (pattern,'Auu____6142) FStar_Pervasives_Native.tuple2 Prims.list ->
  ...
  fun defs  ->
    FStar_All.pipe_right defs
      (FStar_List.collect
         (fun uu____6176  ->
            match uu____6176 with | (p,uu____6184) -> head_id_of_pat p))
  
let (id_of_tycon : tycon -> Prims.string) =
  fun uu___45_6187  ->
    match uu___45_6187 with
    | TyconAbstract (i,uu____6189,uu____6190) -> i.FStar_Ident.idText
    | TyconAbbrev (i,uu____6200,uu____6201,uu____6202) ->
        i.FStar_Ident.idText
    | TyconRecord (i,uu____6212,uu____6213,uu____6214) ->
        i.FStar_Ident.idText
    | TyconVariant (i,uu____6244,uu____6245,uu____6246) ->
        i.FStar_Ident.idText
  ...
  fun d  ->
    ...
    | ModuleAbbrev (i,l) ->
        FStar_Util.format2 "module %s = %s" i.FStar_Ident.idText
          l.FStar_Ident.str
    | TopLevelLet (uu____6291,pats) ->
        let uu____6305 =
          let uu____6306 =
            let uu____6309 = lids_of_let pats  in
            FStar_All.pipe_right uu____6309
              (FStar_List.map (fun l  -> l.FStar_Ident.str))
             in
          FStar_All.pipe_right uu____6306 (FStar_String.concat ", ")  in
        Prims.strcat "let " uu____6305
    | Main uu____6320 -> "main ..."
    | Assume (i,uu____6322) -> Prims.strcat "assume " i.FStar_Ident.idText
    | Tycon (uu____6323,tys) ->
        let uu____6341 =
          let uu____6342 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____6364  ->
                    match uu____6364 with | (x,uu____6372) -> id_of_tycon x))
             in
          FStar_All.pipe_right uu____6342 (FStar_String.concat ", ")  in
        Prims.strcat "type " uu____6341
    | Val (i,uu____6380) -> Prims.strcat "val " i.FStar_Ident.idText
    | Exception (i,uu____6382) ->
        Prims.strcat "exception " i.FStar_Ident.idText
    | NewEffect (DefineEffect (i,uu____6388,uu____6389,uu____6390)) ->
        Prims.strcat "new_effect " i.FStar_Ident.idText
    | NewEffect (RedefineEffect (i,uu____6400,uu____6401)) ->
        Prims.strcat "new_effect " i.FStar_Ident.idText
    | SubEffect uu____6406 -> "sub_effect"
    | Pragma uu____6407 -> "pragma"
    | Fsdoc uu____6408 -> "fsdoc"
  
let (modul_to_string : modul -> Prims.string) =
  fun m  ->
    match m with
    | Module (uu____6412,decls) ->
        let uu____6418 =
          FStar_All.pipe_right decls (FStar_List.map decl_to_string)  in
        FStar_All.pipe_right uu____6418 (FStar_String.concat "\n")
    | Interface (uu____6427,decls,uu____6429) ->
        let uu____6434 =
          FStar_All.pipe_right decls (FStar_List.map decl_to_string)  in
        FStar_All.pipe_right uu____6434 (FStar_String.concat "\n")
