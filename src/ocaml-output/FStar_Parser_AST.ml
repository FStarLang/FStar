  ...
  fun x ->
    ...
    | LexList l ->
        let uu___ =
          ...
          | hd::tl ->
              ...
              FStar_Compiler_Effect.pipe_right tl uu___1 in
    ...
    | Op (s, xs) ->
        ...
        let uu___1 =
          let uu___2 =
            FStar_Compiler_List.map
              (fun x1 -> FStar_Compiler_Effect.pipe_right x1 term_to_string)
              xs in
          FStar_String.concat ", " uu___2 in
    ...
    | Abs (pats, t) ->
        ...
        let uu___1 = FStar_Compiler_Effect.pipe_right t term_to_string in
        FStar_Compiler_Util.format2 "(fun %s -> %s)" uu___ uu___1
    | App (t1, t2, imp1) ->
        let uu___ = FStar_Compiler_Effect.pipe_right t1 term_to_string in
        let uu___1 = FStar_Compiler_Effect.pipe_right t2 term_to_string in
        FStar_Compiler_Util.format3 "%s %s%s" uu___ (imp_to_string imp1)
          uu___1
    | Let (Rec, (a, (p, b))::lbs, body) ->
        let uu___ = attrs_opt_to_string a in
        let uu___1 =
          let uu___2 = FStar_Compiler_Effect.pipe_right p pat_to_string in
          let uu___3 = FStar_Compiler_Effect.pipe_right b term_to_string in
          ...
          to_string_l " "
            (fun uu___3 ->
               ...
               | (a1, (p1, b1)) ->
                   ...
                   let uu___5 =
                     FStar_Compiler_Effect.pipe_right p1 pat_to_string in
                   let uu___6 =
                     FStar_Compiler_Effect.pipe_right b1 term_to_string in
                   FStar_Compiler_Util.format3 "%sand %s=%s" uu___4 uu___5
                     uu___6) lbs in
        let uu___3 = FStar_Compiler_Effect.pipe_right body term_to_string in
        FStar_Compiler_Util.format4 "%slet rec %s%s in %s" uu___ uu___1
          uu___2 uu___3
    | Let (q, (attrs, (pat, tm))::[], body) ->
        let uu___ = attrs_opt_to_string attrs in
        let uu___1 = FStar_Compiler_Effect.pipe_right pat pat_to_string in
        let uu___2 = FStar_Compiler_Effect.pipe_right tm term_to_string in
        let uu___3 = FStar_Compiler_Effect.pipe_right body term_to_string in
    ...
    | If (t1, ret_opt, t2, t3) ->
        ...
        let uu___2 = FStar_Compiler_Effect.pipe_right t2 term_to_string in
        let uu___3 = FStar_Compiler_Effect.pipe_right t3 term_to_string in
    ...
    | Ascribed (t1, t2, FStar_Pervasives_Native.Some tac) ->
        let uu___ = FStar_Compiler_Effect.pipe_right t1 term_to_string in
        let uu___1 = FStar_Compiler_Effect.pipe_right t2 term_to_string in
        let uu___2 = FStar_Compiler_Effect.pipe_right tac term_to_string in
        FStar_Compiler_Util.format3 "(%s : %s by %s)" uu___ uu___1 uu___2
    | Record (FStar_Pervasives_Native.Some e, fields) ->
        let uu___ = FStar_Compiler_Effect.pipe_right e term_to_string in
        let uu___1 =
          to_string_l " "
            (fun uu___2 ->
               match uu___2 with
               | (l, e1) ->
                   ...
                   let uu___4 =
                     FStar_Compiler_Effect.pipe_right e1 term_to_string in
          ...
          to_string_l " "
            (fun uu___1 ->
               ...
               | (l, e) ->
                   ...
                   let uu___3 =
                     FStar_Compiler_Effect.pipe_right e term_to_string in
    ...
    | Product (b::[], t) when x.level = Type_level ->
        let uu___ = FStar_Compiler_Effect.pipe_right b binder_to_string in
        let uu___1 = FStar_Compiler_Effect.pipe_right t term_to_string in
        FStar_Compiler_Util.format2 "%s -> %s" uu___ uu___1
    ...
    | QForall (bs, (uu___, pats), t) ->
        ...
        let uu___3 = FStar_Compiler_Effect.pipe_right t term_to_string in
    ...
    | NamedTyp (x1, t) ->
        ...
        FStar_Compiler_Util.format2 "%s:%s" uu___ uu___1
    | Paren t ->
        let uu___ = FStar_Compiler_Effect.pipe_right t term_to_string in
        FStar_Compiler_Util.format1 "(%s)" uu___
    | Product (bs, t) ->
        let uu___ =
          let uu___1 =
    ...
    | Attributes ts ->
        let uu___ =
          ...
          FStar_Compiler_Effect.pipe_left (FStar_String.concat " ") uu___1 in
    ...
    | CalcProof (rel, init, steps) ->
        ...
        let uu___2 =
          ...
          FStar_Compiler_Effect.pipe_left (FStar_String.concat " ") uu___3 in
    ...
    fun scrutinee ->
      fun branches ->
        fun ret_opt ->
          ...
          let uu___ =
            FStar_Compiler_Effect.pipe_right scrutinee term_to_string in
          let uu___1 =
            match ret_opt with
            | FStar_Pervasives_Native.None -> ""
            | FStar_Pervasives_Native.Some ret ->
          ...
          let uu___2 =
            to_string_l " | "
              (fun uu___3 ->
                 ...
                 | (p, w, e) ->
                     let uu___4 =
                       FStar_Compiler_Effect.pipe_right p pat_to_string in
                     let uu___5 =
                       match w with
                       | FStar_Pervasives_Native.None -> ""
  ...
  fun x ->
    let s =
      ...
      | Annotated (i, t) ->
          ...
          let uu___1 = FStar_Compiler_Effect.pipe_right t term_to_string in
          FStar_Compiler_Util.format2 "%s:%s" uu___ uu___1
      | NoName t -> FStar_Compiler_Effect.pipe_right t term_to_string in
...
and (pat_to_string : pattern -> Prims.string) =
  fun x ->
    ...
    | PatApp (p, ps) ->
        let uu___ = FStar_Compiler_Effect.pipe_right p pat_to_string in
          ...
          to_string_l "; "
            (fun uu___1 ->
               ...
               | (f, e) ->
                   ...
                   let uu___3 =
                     FStar_Compiler_Effect.pipe_right e pat_to_string in
...
let (decl_to_string : decl -> Prims.string) =
  fun d ->
    ...
    | Tycon (uu___, uu___1, tys) ->
        let uu___2 =
          let uu___3 =
            FStar_Compiler_Effect.pipe_right tys
          ...
          let uu___1 =
            let uu___2 =
              FStar_Compiler_List.map (fun i -> FStar_Ident.string_of_id i)
                ids in
            FStar_Compiler_Effect.pipe_left (FStar_String.concat ";") uu___2 in
          let uu___2 =
            let uu___3 =
  ...
  fun m ->
    ...
    | Interface (uu___, decls, uu___1) ->
        let uu___2 =
          FStar_Compiler_Effect.pipe_right decls
            (FStar_Compiler_List.map decl_to_string) in
        FStar_Compiler_Effect.pipe_right uu___2 (FStar_String.concat "\n")
