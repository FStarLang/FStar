...
let (uu___is_TopLevelModule : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | TopLevelModule _0 -> true | uu____3512 -> false
  
let (__proj__TopLevelModule__item___0 : decl' -> FStar_Ident.lid) =
  fun projectee  -> match projectee with | TopLevelModule _0 -> _0 
let (uu___is_Open : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Open _0 -> true | uu____3526 -> false
  
let (__proj__Open__item___0 : decl' -> FStar_Ident.lid) =
  fun projectee  -> match projectee with | Open _0 -> _0 
let (uu___is_Include : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Include _0 -> true | uu____3540 -> false
  
let (__proj__Include__item___0 : decl' -> FStar_Ident.lid) =
  fun projectee  -> match projectee with | Include _0 -> _0 
let (uu___is_ModuleAbbrev : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | ModuleAbbrev _0 -> true | uu____3558 -> false
...
let (uu___is_TopLevelLet : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | TopLevelLet _0 -> true | uu____3594 -> false
...
let (uu___is_Main : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Main _0 -> true | uu____3638 -> false
  
let (__proj__Main__item___0 : decl' -> term) =
  fun projectee  -> match projectee with | Main _0 -> _0 
let (uu___is_Tycon : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tycon _0 -> true | uu____3664 -> false
...
let (uu___is_Val : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Val _0 -> true | uu____3718 -> false
...
let (uu___is_Exception : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Exception _0 -> true | uu____3750 -> false
...
let (uu___is_NewEffect : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | NewEffect _0 -> true | uu____3782 -> false
  
let (__proj__NewEffect__item___0 : decl' -> effect_decl) =
  fun projectee  -> match projectee with | NewEffect _0 -> _0 
let (uu___is_SubEffect : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | SubEffect _0 -> true | uu____3796 -> false
  
let (__proj__SubEffect__item___0 : decl' -> lift) =
  fun projectee  -> match projectee with | SubEffect _0 -> _0 
let (uu___is_Pragma : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pragma _0 -> true | uu____3810 -> false
  
let (__proj__Pragma__item___0 : decl' -> pragma) =
  fun projectee  -> match projectee with | Pragma _0 -> _0 
let (uu___is_Fsdoc : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Fsdoc _0 -> true | uu____3824 -> false
  
let (__proj__Fsdoc__item___0 : decl' -> fsdoc) =
  fun projectee  -> match projectee with | Fsdoc _0 -> _0 
let (uu___is_Assume : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Assume _0 -> true | uu____3842 -> false
...
let (uu___is_Splice : decl' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Splice _0 -> true | uu____3874 -> false
...
let (uu___is_DefineEffect : effect_decl -> Prims.bool) =
  fun projectee  ->
    match projectee with | DefineEffect _0 -> true | uu____3982 -> false
...
let (uu___is_RedefineEffect : effect_decl -> Prims.bool) =
  fun projectee  ->
    match projectee with | RedefineEffect _0 -> true | uu____4040 -> false
...
let (uu___is_Module : modul -> Prims.bool) =
  fun projectee  ->
    match projectee with | Module _0 -> true | uu____4108 -> false
...
let (uu___is_Interface : modul -> Prims.bool) =
  fun projectee  ->
    match projectee with | Interface _0 -> true | uu____4148 -> false
      ...
      (let uu____4198 =
         let uu____4203 =
           FStar_Util.format1
            ...
            in
         (FStar_Errors.Fatal_InvalidIdentifier, uu____4203)  in
       FStar_Errors.raise_error uu____4198 id1.FStar_Ident.idRange)
  
let at_most_one :
  'Auu____4212 .
    Prims.string ->
      FStar_Range.range ->
        'Auu____4212 Prims.list ->
          'Auu____4212 FStar_Pervasives_Native.option
  =
  fun s  ->
    fun r  ->
      fun l  ->
            ...
            let uu____4238 =
              let uu____4243 =
                FStar_Util.format1
                 ...
                 in
              (FStar_Errors.Fatal_MoreThanOneDeclaration, uu____4243)  in
            FStar_Errors.raise_error uu____4238 r
      ...
      fun decorations  ->
        let doc1 =
          let uu____4268 =
            FStar_List.choose
              (fun uu___89_4273  ->
                 match uu___89_4273 with
                 | Doc d1 -> FStar_Pervasives_Native.Some d1
                 | uu____4277 -> FStar_Pervasives_Native.None) decorations
             in
          at_most_one "fsdoc" r uu____4268  in
        let attributes_ =
          let uu____4283 =
            FStar_List.choose
              (fun uu___90_4292  ->
                 match uu___90_4292 with
                 | DeclAttributes a -> FStar_Pervasives_Native.Some a
                 | uu____4302 -> FStar_Pervasives_Native.None) decorations
             in
          at_most_one "attribute set" r uu____4283  in
        let attributes_1 = FStar_Util.dflt [] attributes_  in
        let qualifiers =
          FStar_List.choose
            (fun uu___91_4317  ->
               match uu___91_4317 with
               | Qualifier q -> FStar_Pervasives_Native.Some q
               | uu____4321 -> FStar_Pervasives_Native.None) decorations
           in
      ...
      fun r  ->
        fun l  ->
          let t1 =
            ...
            | uu____4404 ->
                let uu____4405 =
                  let uu____4412 = FStar_Ident.mk_ident ("-", rminus)  in
                  (uu____4412, [t])  in
                Op uu____4405
             in
          mk_term t1 r l
            ...
            let uu____4495 =
              let uu____4496 =
                let uu____4497 =
                  let uu____4512 =
                    let uu____4513 =
                      let uu____4514 = FStar_Ident.lid_of_ids [x]  in
                      Var uu____4514  in
                    mk_term uu____4513 r1 Expr  in
                  (uu____4512, branches)  in
                Match uu____4497  in
              mk_term uu____4496 r2 Expr  in
            ([mk_pattern (PatVar (x, FStar_Pervasives_Native.None)) r1],
              uu____4495)
             in
          Abs uu____4488  in
        mk_term uu____4487 r2 Expr
...
let (un_function :
  ...
  fun p  ->
    fun tm  ->
      ...
      | (PatVar uu____4551,Abs (pats,body)) ->
          FStar_Pervasives_Native.Some
...
let (lid_with_range :
  ...
  fun lid  ->
    fun r  ->
      let uu____4589 = FStar_Ident.path_of_lid lid  in
      FStar_Ident.lid_of_path uu____4589 r
  ...
  fun r  ->
    fun elts  ->
      ...
      | (empty_lid,singleton_lid,union_lid,addr_of_lid) ->
          let empty1 =
            let uu____4835 =
              let uu____4836 = FStar_Ident.set_lid_range empty_lid r  in
              Var uu____4836  in
            mk_term uu____4835 r Expr  in
          let addr_of =
            let uu____4838 =
              let uu____4839 = FStar_Ident.set_lid_range addr_of_lid r  in
              Var uu____4839  in
            mk_term uu____4838 r Expr  in
          let singleton1 =
            let uu____4841 =
              let uu____4842 = FStar_Ident.set_lid_range singleton_lid r  in
              Var uu____4842  in
            mk_term uu____4841 r Expr  in
          let union1 =
            let uu____4844 =
              let uu____4845 = FStar_Ident.set_lid_range union_lid r  in
              Var uu____4845  in
            mk_term uu____4844 r Expr  in
             ...
             | Name s ->
                 let uu____4905 =
                   let uu____4906 =
                     ...
                     (s, uu____4917)  in
                   Construct uu____4906  in
                 mk_term uu____4905 r Un
             | uu____4936 ->
                 FStar_List.fold_left
...
let mkWildAdmitMagic :
  ...
  =
  fun r  ->
    let uu____4974 = mkAdmitMagic r  in
    ((mk_pattern (PatWild FStar_Pervasives_Native.None) r),
      FStar_Pervasives_Native.None, uu____4974)
  
let focusBranches :
  'Auu____4983 .
    (Prims.bool,(pattern,'Auu____4983 FStar_Pervasives_Native.option,
        ...
        (FStar_Errors.log_issue r
         ...
         (let focussed =
            ...
            FStar_All.pipe_right uu____5075
             ...
             in
          let uu____5162 =
            let uu____5173 = mkWildAdmitMagic r  in [uu____5173]  in
          FStar_List.append focussed uu____5162))
      else
...
let focusLetBindings :
  'Auu____5265 .
    (Prims.bool,('Auu____5265,term) FStar_Pervasives_Native.tuple2)
      FStar_Pervasives_Native.tuple2 Prims.list ->
      FStar_Range.range ->
        ('Auu____5265,term) FStar_Pervasives_Native.tuple2 Prims.list
  =
  fun lbs  ->
    fun r  ->
           ...
           (fun uu____5337  ->
              ...
              | (f,lb) ->
                  ...
                  then lb
                    ...
                    (let uu____5365 = mkAdmitMagic r  in
                     ((FStar_Pervasives_Native.fst lb), uu____5365))) lbs)
      else
        FStar_All.pipe_right lbs (FStar_List.map FStar_Pervasives_Native.snd)
  
let focusAttrLetBindings :
  'Auu____5407 'Auu____5408 .
    ('Auu____5407,(Prims.bool,('Auu____5408,term)
                                FStar_Pervasives_Native.tuple2)
                    FStar_Pervasives_Native.tuple2)
      FStar_Pervasives_Native.tuple2 Prims.list ->
      FStar_Range.range ->
        ('Auu____5407,('Auu____5408,term) FStar_Pervasives_Native.tuple2)
          FStar_Pervasives_Native.tuple2 Prims.list
  =
  fun lbs  ->
    fun r  ->
      let should_filter =
        FStar_Util.for_some
          (fun uu____5474  ->
             match uu____5474 with | (attr,(focus,uu____5489)) -> focus) lbs
         in
      if should_filter
      then
        (FStar_Errors.log_issue r
           ...
           (fun uu____5541  ->
              ...
              | (attr,(f,lb)) ->
                  ...
                  then (attr, lb)
                    ...
                    (let uu____5594 =
                       let uu____5599 = mkAdmitMagic r  in
                       ((FStar_Pervasives_Native.fst lb), uu____5599)  in
                     (attr, uu____5594))) lbs)
      else
        FStar_All.pipe_right lbs
          (FStar_List.map
             (fun uu____5653  ->
                match uu____5653 with | (attr,(uu____5675,lb)) -> (attr, lb)))
  
let (mkFsTypApp : term -> term Prims.list -> FStar_Range.range -> term) =
  fun t  ->
    fun args  ->
      fun r  ->
        let uu____5716 = FStar_List.map (fun a  -> (a, FsTypApp)) args  in
        mkApp t uu____5716 r
...
let (mkTuple : term Prims.list -> FStar_Range.range -> term) =
  fun args  ->
    fun r  ->
      ...
      let uu____5744 = FStar_List.map (fun x  -> (x, Nothing)) args  in
      mkApp (mk_term (Name cons1) r Expr) uu____5744 r
...
let (mkDTuple : term Prims.list -> FStar_Range.range -> term) =
  fun args  ->
    fun r  ->
      ...
      let uu____5772 = FStar_List.map (fun x  -> (x, Nothing)) args  in
      mkApp (mk_term (Name cons1) r Expr) uu____5772 r
                      ...
                      (match pat.pat with
                       ...
                       | uu____5870 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____5874 =
                                 let uu____5875 = FStar_Ident.lid_of_ids [x]
                                    in
                                 Var uu____5875  in
...
let rec (extract_named_refinement :
  ...
  fun t1  ->
    ...
    | Refine
        ({ b = Annotated (x,t); brange = uu____5984; blevel = uu____5985;
           aqual = uu____5986;_},t')
        ->
        FStar_Pervasives_Native.Some
          ...
          (match ds with
           ...
           | d::ds1 ->
               (match d.d with
                ...
                | uu____6073 -> as_mlist ((m_name, m_decl), (d :: cur1)) ds1))
        ...
        | (d,ds1) ->
            (match d.d with
             ...
             | uu____6147 ->
                 ...
                 (FStar_List.iter
                    (fun uu___92_6158  ->
                       match uu___92_6158 with
                       | { d = TopLevelModule uu____6159; drange = r;
                           doc = uu____6161; quals = uu____6162;
                           attrs = uu____6163;_} ->
                           FStar_Errors.raise_error
                             (FStar_Errors.Fatal_UnexpectedModuleDeclaration,
...
let (compile_op :
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___93_6190 =
          match uu___93_6190 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
        ...
        | uu____6215 ->
            let uu____6216 =
              let uu____6217 =
                let uu____6220 = FStar_String.list_of_string s  in
                FStar_List.map name_of_char uu____6220  in
              FStar_String.concat "_" uu____6217  in
            Prims.strcat "op_" uu____6216
        ...
        let uu____6274 =
          let uu____6275 =
            FStar_List.map
             ...
             in
          FStar_String.concat "," uu____6275  in
        Prims.strcat comment uu____6274
  
let (string_of_let_qualifier : let_qualifier -> Prims.string) =
  fun uu___94_6296  ->
    match uu___94_6296 with
    | NoLetQualifier  -> ""
    | Rec  -> "rec"
    | Mutable  -> "mutable"
...
let to_string_l :
  'Auu____6305 .
    Prims.string ->
      ('Auu____6305 -> Prims.string) ->
        'Auu____6305 Prims.list -> Prims.string
  =
  fun sep  ->
    fun f  ->
      fun l  ->
        let uu____6330 = FStar_List.map f l  in
        FStar_String.concat sep uu____6330
  
let (imp_to_string : imp -> Prims.string) =
  fun uu___95_6337  ->
    match uu___95_6337 with | Hash  -> "#" | uu____6338 -> ""
  
let rec (term_to_string : term -> Prims.string) =
  fun x  ->
    match x.tm with
    | Wild  -> "_"
    | Requires (t,uu____6367) ->
        let uu____6372 = term_to_string t  in
        FStar_Util.format1 "(requires %s)" uu____6372
    | Ensures (t,uu____6374) ->
        let uu____6379 = term_to_string t  in
        FStar_Util.format1 "(ensures %s)" uu____6379
    | Labeled (t,l,uu____6382) ->
        let uu____6383 = term_to_string t  in
        FStar_Util.format2 "(labeled %s %s)" l uu____6383
    | Const c -> FStar_Parser_Const.const_to_string c
    | Op (s,xs) ->
        let uu____6391 = FStar_Ident.text_of_id s  in
        let uu____6392 =
          let uu____6393 =
            FStar_List.map
              (fun x1  -> FStar_All.pipe_right x1 term_to_string) xs
             in
          FStar_String.concat ", " uu____6393  in
        FStar_Util.format2 "%s(%s)" uu____6391 uu____6392
        ...
        let uu____6416 =
          to_string_l " "
            (fun uu____6425  ->
               ...
               | (a,imp) ->
                   let uu____6432 = term_to_string a  in
                   FStar_Util.format2 "%s%s" (imp_to_string imp) uu____6432)
            args
           in
        FStar_Util.format2 "(%s %s)" l.FStar_Ident.str uu____6416
    | Abs (pats,t) ->
        let uu____6439 = to_string_l " " pat_to_string pats  in
        let uu____6440 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "(fun %s -> %s)" uu____6439 uu____6440
    | App (t1,t2,imp) ->
        let uu____6444 = FStar_All.pipe_right t1 term_to_string  in
        let uu____6445 = FStar_All.pipe_right t2 term_to_string  in
        FStar_Util.format3 "%s %s%s" uu____6444 (imp_to_string imp)
          uu____6445
    | Let (Rec ,(a,(p,b))::lbs,body) ->
        let uu____6503 = attrs_opt_to_string a  in
        let uu____6504 =
          let uu____6505 = FStar_All.pipe_right p pat_to_string  in
          let uu____6506 = FStar_All.pipe_right b term_to_string  in
          FStar_Util.format2 "%s=%s" uu____6505 uu____6506  in
        let uu____6507 =
          to_string_l " "
            (fun uu____6527  ->
               match uu____6527 with
               | (a1,(p1,b1)) ->
                   let uu____6555 = attrs_opt_to_string a1  in
                   let uu____6556 = FStar_All.pipe_right p1 pat_to_string  in
                   let uu____6557 = FStar_All.pipe_right b1 term_to_string
                      in
                   FStar_Util.format3 "%sand %s=%s" uu____6555 uu____6556
                     uu____6557) lbs
           in
        let uu____6558 = FStar_All.pipe_right body term_to_string  in
        FStar_Util.format4 "%slet rec %s%s in %s" uu____6503 uu____6504
          uu____6507 uu____6558
    | Let (q,(attrs,(pat,tm))::[],body) ->
        let uu____6614 = attrs_opt_to_string attrs  in
        let uu____6615 = FStar_All.pipe_right pat pat_to_string  in
        let uu____6616 = FStar_All.pipe_right tm term_to_string  in
        let uu____6617 = FStar_All.pipe_right body term_to_string  in
        FStar_Util.format5 "%slet %s %s = %s in %s" uu____6614
          (string_of_let_qualifier q) uu____6615 uu____6616 uu____6617
    | Seq (t1,t2) ->
        let uu____6620 = FStar_All.pipe_right t1 term_to_string  in
        let uu____6621 = FStar_All.pipe_right t2 term_to_string  in
        FStar_Util.format2 "%s; %s" uu____6620 uu____6621
    | If (t1,t2,t3) ->
        let uu____6625 = FStar_All.pipe_right t1 term_to_string  in
        let uu____6626 = FStar_All.pipe_right t2 term_to_string  in
        let uu____6627 = FStar_All.pipe_right t3 term_to_string  in
        FStar_Util.format3 "if %s then %s else %s" uu____6625 uu____6626
          uu____6627
    | Match (t,branches) ->
        let uu____6650 = FStar_All.pipe_right t term_to_string  in
        let uu____6651 =
          to_string_l " | "
            (fun uu____6667  ->
               match uu____6667 with
               | (p,w,e) ->
                   let uu____6683 = FStar_All.pipe_right p pat_to_string  in
                   let uu____6684 =
                     match w with
                     | FStar_Pervasives_Native.None  -> ""
                     | FStar_Pervasives_Native.Some e1 ->
                         let uu____6686 = term_to_string e1  in
                         FStar_Util.format1 "when %s" uu____6686
                      in
                   let uu____6687 = FStar_All.pipe_right e term_to_string  in
                   FStar_Util.format3 "%s %s -> %s" uu____6683 uu____6684
                     uu____6687) branches
           in
        FStar_Util.format2 "match %s with %s" uu____6650 uu____6651
    | Ascribed (t1,t2,FStar_Pervasives_Native.None ) ->
        let uu____6692 = FStar_All.pipe_right t1 term_to_string  in
        let uu____6693 = FStar_All.pipe_right t2 term_to_string  in
        FStar_Util.format2 "(%s : %s)" uu____6692 uu____6693
    | Ascribed (t1,t2,FStar_Pervasives_Native.Some tac) ->
        let uu____6699 = FStar_All.pipe_right t1 term_to_string  in
        let uu____6700 = FStar_All.pipe_right t2 term_to_string  in
        let uu____6701 = FStar_All.pipe_right tac term_to_string  in
        FStar_Util.format3 "(%s : %s by %s)" uu____6699 uu____6700 uu____6701
    | Record (FStar_Pervasives_Native.Some e,fields) ->
        let uu____6718 = FStar_All.pipe_right e term_to_string  in
        let uu____6719 =
          to_string_l " "
            (fun uu____6728  ->
               match uu____6728 with
               | (l,e1) ->
                   let uu____6735 = FStar_All.pipe_right e1 term_to_string
                      in
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____6735)
            fields
           in
        FStar_Util.format2 "{%s with %s}" uu____6718 uu____6719
          ...
          to_string_l " "
            (fun uu____6760  ->
               ...
               | (l,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____6767)
            fields
           in
        FStar_Util.format1 "{%s}" uu____6751
    | Project (e,l) ->
        let uu____6770 = FStar_All.pipe_right e term_to_string  in
        FStar_Util.format2 "%s.%s" uu____6770 l.FStar_Ident.str
    ...
    | Product (b::[],t) when x.level = Type_level ->
        let uu____6790 = FStar_All.pipe_right b binder_to_string  in
        let uu____6791 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s -> %s" uu____6790 uu____6791
    | Product (b::[],t) when x.level = Kind ->
        let uu____6796 = FStar_All.pipe_right b binder_to_string  in
        let uu____6797 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s => %s" uu____6796 uu____6797
    | Sum (binders,t) ->
        let uu____6804 =
          let uu____6805 =
            FStar_All.pipe_right binders (FStar_List.map binder_to_string)
             in
          FStar_All.pipe_right uu____6805 (FStar_String.concat " * ")  in
        let uu____6814 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s * %s" uu____6804 uu____6814
    | QForall (bs,pats,t) ->
        let uu____6830 = to_string_l " " binder_to_string bs  in
        let uu____6831 =
          to_string_l " \\/ " (to_string_l "; " term_to_string) pats  in
        let uu____6834 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format3 "forall %s.{:pattern %s} %s" uu____6830 uu____6831
          uu____6834
    | QExists (bs,pats,t) ->
        let uu____6850 = to_string_l " " binder_to_string bs  in
        let uu____6851 =
          to_string_l " \\/ " (to_string_l "; " term_to_string) pats  in
        let uu____6854 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format3 "exists %s.{:pattern %s} %s" uu____6850 uu____6851
          uu____6854
    | Refine (b,t) ->
        let uu____6857 = FStar_All.pipe_right b binder_to_string  in
        let uu____6858 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s:{%s}" uu____6857 uu____6858
    | NamedTyp (x1,t) ->
        let uu____6861 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s:%s" x1.FStar_Ident.idText uu____6861
    | Paren t ->
    ...
    | Product (bs,t) ->
        let uu____6870 =
          ...
          FStar_All.pipe_right uu____6871 (FStar_String.concat ",")  in
        let uu____6880 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "Unidentified product: [%s] %s" uu____6870
          uu____6880
    | t -> "_"
...
and (binder_to_string : binder -> Prims.string) =
  fun x  ->
    let s =
      ...
      | Annotated (i,t) ->
          let uu____6891 = FStar_All.pipe_right t term_to_string  in
          FStar_Util.format2 "%s:%s" i.FStar_Ident.idText uu____6891
      | NoName t -> FStar_All.pipe_right t term_to_string  in
    let uu____6893 = aqual_to_string x.aqual  in
    FStar_Util.format2 "%s%s" uu____6893 s

and (aqual_to_string :
  arg_qualifier FStar_Pervasives_Native.option -> Prims.string) =
  fun uu___96_6894  ->
    match uu___96_6894 with
...
and (pat_to_string : pattern -> Prims.string) =
  fun x  ->
    ...
    | PatWild uu____6901 -> "#_"
    | PatConst c -> FStar_Parser_Const.const_to_string c
    | PatApp (p,ps) ->
        let uu____6911 = FStar_All.pipe_right p pat_to_string  in
        let uu____6912 = to_string_l " " pat_to_string ps  in
        FStar_Util.format2 "(%s %s)" uu____6911 uu____6912
    | PatTvar (i,aq) ->
        let uu____6919 = aqual_to_string aq  in
        FStar_Util.format2 "%s%s" uu____6919 i.FStar_Ident.idText
    | PatVar (i,aq) ->
        let uu____6926 = aqual_to_string aq  in
        FStar_Util.format2 "%s%s" uu____6926 i.FStar_Ident.idText
    ...
    | PatTuple (l,true ) ->
        let uu____6943 = to_string_l ", " pat_to_string l  in
        FStar_Util.format1 "(|%s|)" uu____6943
    | PatRecord l ->
        let uu____6951 =
          to_string_l "; "
            (fun uu____6960  ->
               ...
               | (f,e) ->
                   let uu____6967 = FStar_All.pipe_right e pat_to_string  in
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____6967) l
           in
        FStar_Util.format1 "{%s}" uu____6951
    | PatOr l -> to_string_l "|\n " pat_to_string l
    | PatOp op ->
        let uu____6972 = FStar_Ident.text_of_id op  in
        FStar_Util.format1 "(%s)" uu____6972
    | PatAscribed (p,(t,FStar_Pervasives_Native.None )) ->
        let uu____6983 = FStar_All.pipe_right p pat_to_string  in
        let uu____6984 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "(%s:%s)" uu____6983 uu____6984
    | PatAscribed (p,(t,FStar_Pervasives_Native.Some tac)) ->
        let uu____6996 = FStar_All.pipe_right p pat_to_string  in
        let uu____6997 = FStar_All.pipe_right t term_to_string  in
        let uu____6998 = FStar_All.pipe_right tac term_to_string  in
        FStar_Util.format3 "(%s:%s by %s)" uu____6996 uu____6997 uu____6998

and (attrs_opt_to_string :
  term Prims.list FStar_Pervasives_Native.option -> Prims.string) =
  fun uu___97_6999  ->
    match uu___97_6999 with
    | FStar_Pervasives_Native.None  -> ""
    | FStar_Pervasives_Native.Some attrs ->
        let uu____7011 =
          let uu____7012 = FStar_List.map term_to_string attrs  in
          FStar_All.pipe_right uu____7012 (FStar_String.concat "; ")  in
        FStar_Util.format1 "[@ %s]" uu____7011
...
let rec (head_id_of_pat : pattern -> FStar_Ident.lident Prims.list) =
  fun p  ->
    ...
    | PatName l -> [l]
    | PatVar (i,uu____7028) ->
        let uu____7033 = FStar_Ident.lid_of_ids [i]  in [uu____7033]
    | PatApp (p1,uu____7035) -> head_id_of_pat p1
    | PatAscribed (p1,uu____7041) -> head_id_of_pat p1
    | uu____7054 -> []
  
let lids_of_let :
  'Auu____7059 .
    (pattern,'Auu____7059) FStar_Pervasives_Native.tuple2 Prims.list ->
  ...
  fun defs  ->
    FStar_All.pipe_right defs
      (FStar_List.collect
         (fun uu____7094  ->
            match uu____7094 with | (p,uu____7102) -> head_id_of_pat p))
  
let (id_of_tycon : tycon -> Prims.string) =
  fun uu___98_7107  ->
    match uu___98_7107 with
    | TyconAbstract (i,uu____7109,uu____7110) -> i.FStar_Ident.idText
    | TyconAbbrev (i,uu____7120,uu____7121,uu____7122) ->
        i.FStar_Ident.idText
    | TyconRecord (i,uu____7132,uu____7133,uu____7134) ->
        i.FStar_Ident.idText
    | TyconVariant (i,uu____7164,uu____7165,uu____7166) ->
        i.FStar_Ident.idText
  ...
  fun d  ->
    ...
    | ModuleAbbrev (i,l) ->
        FStar_Util.format2 "module %s = %s" i.FStar_Ident.idText
          l.FStar_Ident.str
    | TopLevelLet (uu____7213,pats) ->
        let uu____7227 =
          let uu____7228 =
            let uu____7231 = lids_of_let pats  in
            FStar_All.pipe_right uu____7231
              (FStar_List.map (fun l  -> l.FStar_Ident.str))
             in
          FStar_All.pipe_right uu____7228 (FStar_String.concat ", ")  in
        Prims.strcat "let " uu____7227
    | Main uu____7242 -> "main ..."
    | Assume (i,uu____7244) -> Prims.strcat "assume " i.FStar_Ident.idText
    | Tycon (uu____7245,tys) ->
        let uu____7263 =
          let uu____7264 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____7286  ->
                    match uu____7286 with | (x,uu____7294) -> id_of_tycon x))
             in
          FStar_All.pipe_right uu____7264 (FStar_String.concat ", ")  in
        Prims.strcat "type " uu____7263
    | Val (i,uu____7302) -> Prims.strcat "val " i.FStar_Ident.idText
    | Exception (i,uu____7304) ->
        Prims.strcat "exception " i.FStar_Ident.idText
    | NewEffect (DefineEffect (i,uu____7310,uu____7311,uu____7312)) ->
        Prims.strcat "new_effect " i.FStar_Ident.idText
    | NewEffect (RedefineEffect (i,uu____7322,uu____7323)) ->
        Prims.strcat "new_effect " i.FStar_Ident.idText
    | Splice (ids,t) ->
        let uu____7334 =
          let uu____7335 =
            ...
            FStar_All.pipe_left (FStar_String.concat ";") uu____7336  in
          let uu____7343 =
            let uu____7344 =
              let uu____7345 = term_to_string t  in
              Prims.strcat uu____7345 ")"  in
            Prims.strcat "] (" uu____7344  in
          Prims.strcat uu____7335 uu____7343  in
        Prims.strcat "splice[" uu____7334
    | SubEffect uu____7346 -> "sub_effect"
    | Pragma uu____7347 -> "pragma"
    | Fsdoc uu____7348 -> "fsdoc"
  
let (modul_to_string : modul -> Prims.string) =
  fun m  ->
    match m with
    | Module (uu____7354,decls) ->
        let uu____7360 =
          FStar_All.pipe_right decls (FStar_List.map decl_to_string)  in
        FStar_All.pipe_right uu____7360 (FStar_String.concat "\n")
    | Interface (uu____7369,decls,uu____7371) ->
        let uu____7376 =
          FStar_All.pipe_right decls (FStar_List.map decl_to_string)  in
        FStar_All.pipe_right uu____7376 (FStar_String.concat "\n")
