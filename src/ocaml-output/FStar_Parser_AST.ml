...
(let _161_1202 = (let _161_1201 = (let _161_1200 = (FStar_Util.format1 "Invalid identifer \'%s\'; expected a symbol that begins with a lower-case character" id.FStar_Ident.idText)
in ((_161_1200), (id.FStar_Ident.idRange)))
in FStar_Syntax_Syntax.Error (_161_1201))
in (Prims.raise _161_1202))
end)
end else begin
()
end)
...
| _61_278 -> begin
(let _161_1208 = (let _161_1207 = (let _161_1206 = (FStar_Util.format1 "At most one %s is allowed on declarations" s)
in ((_161_1206), (r)))
in FStar_Syntax_Syntax.Error (_161_1207))
in (Prims.raise _161_1208))
end))


let mk_decl : decl'  ->  FStar_Range.range  ->  decoration Prims.list  ->  decl = (fun d r decorations -> (

let doc = (let _161_1216 = (FStar_List.choose (fun _61_1 -> (match (_61_1) with
| Doc (d) -> begin
Some (d)
end
| _61_286 -> begin
...
in (at_most_one "fsdoc" r _161_1216))
in (

let attributes_ = (let _161_1218 = (FStar_List.choose (fun _61_2 -> (match (_61_2) with
...
in (at_most_one "attribute set" r _161_1218))
in (
...
in (let _161_1261 = (let _161_1260 = (let _161_1259 = (let _161_1258 = (let _161_1257 = (let _161_1256 = (let _161_1255 = (let _161_1254 = (FStar_Ident.lid_of_ids ((x)::[]))
in Var (_161_1254))
in (mk_term _161_1255 r1 Expr))
in ((_161_1256), (branches)))
in Match (_161_1257))
in (mk_term _161_1258 r2 Expr))
in ((((mk_pattern (PatVar (((x), (None)))) r1))::[]), (_161_1259)))
in Abs (_161_1260))
in (mk_term _161_1261 r2 Expr))))
...
let lid_with_range : FStar_Ident.lident  ->  FStar_Range.range  ->  FStar_Ident.lident = (fun lid r -> (let _161_1270 = (FStar_Ident.path_of_lid lid)
in (FStar_Ident.lid_of_path _161_1270 r)))
...
(match (t.tm) with
| Name (s) -> begin
(let _161_1324 = (let _161_1323 = (let _161_1322 = (FStar_List.map (fun a -> ((a), (Nothing))) args)
in ((s), (_161_1322)))
in Construct (_161_1323))
in (mk_term _161_1324 r Un))
end
| _61_409 -> begin
...
let mkWildAdmitMagic = (fun r -> (let _161_1330 = (mkAdmitMagic r)
in (((mk_pattern PatWild r)), (None), (_161_1330))))
...
let focussed = (let _161_1333 = (FStar_List.filter Prims.fst branches)
in (FStar_All.pipe_right _161_1333 (FStar_List.map Prims.snd)))
in (let _161_1335 = (let _161_1334 = (mkWildAdmitMagic r)
in (_161_1334)::[])
in (FStar_List.append focussed _161_1335))))
end else begin
...
(let _161_1339 = (mkAdmitMagic r)
in (((Prims.fst lb)), (_161_1339)))
end
end)) lbs))
end else begin
...
let mkFsTypApp : term  ->  term Prims.list  ->  FStar_Range.range  ->  term = (fun t args r -> (let _161_1347 = (FStar_List.map (fun a -> ((a), (FsTypApp))) args)
in (mkApp t _161_1347 r)))
...
in (let _161_1353 = (FStar_List.map (fun x -> ((x), (Nothing))) args)
in (mkApp (mk_term (Name (cons)) r Expr) _161_1353 r))))
...
in (let _161_1359 = (FStar_List.map (fun x -> ((x), (Nothing))) args)
in (mkApp (mk_term (Name (cons)) r Expr) _161_1359 r))))
...
let x_var = (let _161_1385 = (let _161_1384 = (FStar_Ident.lid_of_ids ((x)::[]))
in Var (_161_1384))
in (mk_term _161_1385 phi.range Formula))
in (

let pat_branch = ((pat), (None), (phi))
in (

let otherwise_branch = (let _161_1388 = (let _161_1387 = (let _161_1386 = (FStar_Ident.lid_of_path (("False")::[]) phi.range)
in Name (_161_1386))
in (mk_term _161_1387 phi.range Formula))
in (((mk_pattern PatWild phi.range)), (None), (_161_1388)))
...
in (let _161_1401 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid m'))
...
| _61_585 -> begin
(let _161_1411 = (let _161_1410 = (let _161_1409 = (FStar_String.list_of_string s)
in (FStar_List.map name_of_char _161_1409))
in (FStar_String.concat "_" _161_1410))
in (Prims.strcat "op_" _161_1411))
end)))
...
(let _161_1418 = (let _161_1417 = (FStar_List.map (fun _61_592 -> (match (_61_592) with
| (k, v) -> begin
(Prims.strcat k (Prims.strcat "->" v))
end)) keywords)
in (FStar_String.concat "," _161_1417))
in (Prims.strcat comment _161_1418))
end))
...
let to_string_l = (fun sep f l -> (let _161_1427 = (FStar_List.map f l)
in (FStar_String.concat sep _161_1427)))
...
(let _161_1435 = (term_to_string t)
in (FStar_Util.format1 "(requires %s)" _161_1435))
end
| Ensures (t, _61_613) -> begin
(let _161_1436 = (term_to_string t)
in (FStar_Util.format1 "(ensures %s)" _161_1436))
end
| Labeled (t, l, _61_619) -> begin
(let _161_1437 = (term_to_string t)
in (FStar_Util.format2 "(labeled %s %s)" l _161_1437))
end
| Const (c) -> begin
(FStar_Absyn_Print.const_to_string c)
end
| Op (s, xs) -> begin
(let _161_1440 = (let _161_1439 = (FStar_List.map (fun x -> (FStar_All.pipe_right x term_to_string)) xs)
in (FStar_String.concat ", " _161_1439))
in (FStar_Util.format2 "%s(%s)" s _161_1440))
end
...
(let _161_1443 = (to_string_l " " (fun _61_641 -> (match (_61_641) with
| (a, imp) -> begin
(let _161_1442 = (term_to_string a)
in (FStar_Util.format2 "%s%s" (imp_to_string imp) _161_1442))
end)) args)
in (FStar_Util.format2 "(%s %s)" l.FStar_Ident.str _161_1443))
end
| Abs (pats, t) -> begin
(let _161_1445 = (to_string_l " " pat_to_string pats)
in (let _161_1444 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "(fun %s -> %s)" _161_1445 _161_1444)))
end
| App (t1, t2, imp) -> begin
(let _161_1447 = (FStar_All.pipe_right t1 term_to_string)
in (let _161_1446 = (FStar_All.pipe_right t2 term_to_string)
in (FStar_Util.format3 "%s %s%s" _161_1447 (imp_to_string imp) _161_1446)))
end
| Let (Rec, lbs, body) -> begin
(let _161_1452 = (to_string_l " and " (fun _61_658 -> (match (_61_658) with
| (p, b) -> begin
(let _161_1450 = (FStar_All.pipe_right p pat_to_string)
in (let _161_1449 = (FStar_All.pipe_right b term_to_string)
in (FStar_Util.format2 "%s=%s" _161_1450 _161_1449)))
end)) lbs)
in (let _161_1451 = (FStar_All.pipe_right body term_to_string)
in (FStar_Util.format2 "let rec %s in %s" _161_1452 _161_1451)))
end
| Let (q, ((pat, tm))::[], body) -> begin
(let _161_1455 = (FStar_All.pipe_right pat pat_to_string)
in (let _161_1454 = (FStar_All.pipe_right tm term_to_string)
in (let _161_1453 = (FStar_All.pipe_right body term_to_string)
in (FStar_Util.format4 "let %s %s = %s in %s" (string_of_let_qualifier q) _161_1455 _161_1454 _161_1453))))
end
| Seq (t1, t2) -> begin
(let _161_1457 = (FStar_All.pipe_right t1 term_to_string)
in (let _161_1456 = (FStar_All.pipe_right t2 term_to_string)
in (FStar_Util.format2 "%s; %s" _161_1457 _161_1456)))
end
| If (t1, t2, t3) -> begin
(let _161_1460 = (FStar_All.pipe_right t1 term_to_string)
in (let _161_1459 = (FStar_All.pipe_right t2 term_to_string)
in (let _161_1458 = (FStar_All.pipe_right t3 term_to_string)
in (FStar_Util.format3 "if %s then %s else %s" _161_1460 _161_1459 _161_1458))))
end
| Match (t, branches) -> begin
(let _161_1467 = (FStar_All.pipe_right t term_to_string)
in (let _161_1466 = (to_string_l " | " (fun _61_683 -> (match (_61_683) with
| (p, w, e) -> begin
(let _161_1465 = (FStar_All.pipe_right p pat_to_string)
in (let _161_1464 = (match (w) with
| None -> begin
""
end
| Some (e) -> begin
(let _161_1462 = (term_to_string e)
in (FStar_Util.format1 "when %s" _161_1462))
end)
in (let _161_1463 = (FStar_All.pipe_right e term_to_string)
in (FStar_Util.format3 "%s %s -> %s" _161_1465 _161_1464 _161_1463))))
end)) branches)
in (FStar_Util.format2 "match %s with %s" _161_1467 _161_1466)))
end
| Ascribed (t1, t2) -> begin
(let _161_1469 = (FStar_All.pipe_right t1 term_to_string)
in (let _161_1468 = (FStar_All.pipe_right t2 term_to_string)
in (FStar_Util.format2 "(%s : %s)" _161_1469 _161_1468)))
end
| Record (Some (e), fields) -> begin
(let _161_1473 = (FStar_All.pipe_right e term_to_string)
in (let _161_1472 = (to_string_l " " (fun _61_698 -> (match (_61_698) with
| (l, e) -> begin
(let _161_1471 = (FStar_All.pipe_right e term_to_string)
in (FStar_Util.format2 "%s=%s" l.FStar_Ident.str _161_1471))
end)) fields)
in (FStar_Util.format2 "{%s with %s}" _161_1473 _161_1472)))
end
| Record (None, fields) -> begin
(let _161_1476 = (to_string_l " " (fun _61_705 -> (match (_61_705) with
| (l, e) -> begin
(let _161_1475 = (FStar_All.pipe_right e term_to_string)
in (FStar_Util.format2 "%s=%s" l.FStar_Ident.str _161_1475))
end)) fields)
in (FStar_Util.format1 "{%s}" _161_1476))
end
| Project (e, l) -> begin
(let _161_1477 = (FStar_All.pipe_right e term_to_string)
in (FStar_Util.format2 "%s.%s" _161_1477 l.FStar_Ident.str))
end
| Product ([], t) -> begin
(term_to_string t)
end
...
(let _161_1479 = (FStar_All.pipe_right b binder_to_string)
in (let _161_1478 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s -> %s" _161_1479 _161_1478)))
end
| Product ((b)::[], t) when (x.level = Kind) -> begin
(let _161_1481 = (FStar_All.pipe_right b binder_to_string)
in (let _161_1480 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s => %s" _161_1481 _161_1480)))
end
| Sum (binders, t) -> begin
(let _161_1484 = (let _161_1482 = (FStar_All.pipe_right binders (FStar_List.map binder_to_string))
in (FStar_All.pipe_right _161_1482 (FStar_String.concat " * ")))
in (let _161_1483 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s * %s" _161_1484 _161_1483)))
end
| QForall (bs, pats, t) -> begin
(let _161_1487 = (to_string_l " " binder_to_string bs)
in (let _161_1486 = (to_string_l " \\/ " (to_string_l "; " term_to_string) pats)
in (let _161_1485 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format3 "forall %s.{:pattern %s} %s" _161_1487 _161_1486 _161_1485))))
end
| QExists (bs, pats, t) -> begin
(let _161_1490 = (to_string_l " " binder_to_string bs)
in (let _161_1489 = (to_string_l " \\/ " (to_string_l "; " term_to_string) pats)
in (let _161_1488 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format3 "exists %s.{:pattern %s} %s" _161_1490 _161_1489 _161_1488))))
end
| Refine (b, t) -> begin
(let _161_1492 = (FStar_All.pipe_right b binder_to_string)
in (let _161_1491 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s:{%s}" _161_1492 _161_1491)))
end
| NamedTyp (x, t) -> begin
(let _161_1493 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s:%s" x.FStar_Ident.idText _161_1493))
end
| Paren (t) -> begin
(let _161_1494 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format1 "(%s)" _161_1494))
end
| Product (bs, t) -> begin
(let _161_1497 = (let _161_1495 = (FStar_All.pipe_right bs (FStar_List.map binder_to_string))
in (FStar_All.pipe_right _161_1495 (FStar_String.concat ",")))
in (let _161_1496 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "Unidentified product: [%s] %s" _161_1497 _161_1496)))
end
| t -> begin
"_"
end))
...
(let _161_1499 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s:%s" i.FStar_Ident.idText _161_1499))
end
| NoName (t) -> begin
(FStar_All.pipe_right t term_to_string)
end)
in (let _161_1500 = (aqual_to_string x.aqual)
in (FStar_Util.format2 "%s%s" _161_1500 s))))
...
| PatApp (p, ps) -> begin
(let _161_1504 = (FStar_All.pipe_right p pat_to_string)
in (let _161_1503 = (to_string_l " " pat_to_string ps)
in (FStar_Util.format2 "(%s %s)" _161_1504 _161_1503)))
end
| (PatTvar (i, aq)) | (PatVar (i, aq)) -> begin
(let _161_1505 = (aqual_to_string aq)
in (FStar_Util.format2 "%s%s" _161_1505 i.FStar_Ident.idText))
end
| PatName (l) -> begin
l.FStar_Ident.str
end
| PatList (l) -> begin
(let _161_1506 = (to_string_l "; " pat_to_string l)
in (FStar_Util.format1 "[%s]" _161_1506))
end
| PatTuple (l, false) -> begin
(let _161_1507 = (to_string_l ", " pat_to_string l)
in (FStar_Util.format1 "(%s)" _161_1507))
end
| PatTuple (l, true) -> begin
(let _161_1508 = (to_string_l ", " pat_to_string l)
in (FStar_Util.format1 "(|%s|)" _161_1508))
end
| PatRecord (l) -> begin
(let _161_1511 = (to_string_l "; " (fun _61_812 -> (match (_61_812) with
| (f, e) -> begin
(let _161_1510 = (FStar_All.pipe_right e pat_to_string)
in (FStar_Util.format2 "%s=%s" f.FStar_Ident.str _161_1510))
end)) l)
in (FStar_Util.format1 "{%s}" _161_1511))
end
| PatOr (l) -> begin
(to_string_l "|\n " pat_to_string l)
end
...
(let _161_1513 = (FStar_All.pipe_right p pat_to_string)
in (let _161_1512 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "(%s:%s)" _161_1513 _161_1512)))
end))
...
(let _161_1516 = (FStar_Ident.lid_of_ids ((i)::[]))
in (_161_1516)::[])
end
...
(let _161_1526 = (let _161_1525 = (let _161_1524 = (lids_of_let pats)
in (FStar_All.pipe_right _161_1524 (FStar_List.map (fun l -> l.FStar_Ident.str))))
in (FStar_All.pipe_right _161_1525 (FStar_String.concat ", ")))
in (Prims.strcat "let " _161_1526))
end
| Main (_61_901) -> begin
"main ..."
end
...
(let _161_1529 = (let _161_1528 = (FStar_All.pipe_right tys (FStar_List.map (fun _61_916 -> (match (_61_916) with
| (x, _61_915) -> begin
(id_of_tycon x)
end))))
in (FStar_All.pipe_right _161_1528 (FStar_String.concat ", ")))
in (Prims.strcat "type " _161_1529))
end
| Val (i, _61_919) -> begin
...
(let _161_1532 = (FStar_All.pipe_right decls (FStar_List.map decl_to_string))
in (FStar_All.pipe_right _161_1532 (FStar_String.concat "\n")))
end))
...
(let _161_1536 = (FStar_Util.substring tm (Prims.parse_int "0") (Prims.parse_int "77"))
in (Prims.strcat _161_1536 "..."))
end else begin
tm
end
