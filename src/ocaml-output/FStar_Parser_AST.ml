...
let (imp_to_string : imp -> Prims.string) =
  fun uu___6_7536 -> match uu___6_7536 with | Hash -> "#" | uu____7539 -> ""
          ...
          to_string_l " "
            (fun uu____7793 ->
               ...
               | (a1, (p1, b1)) ->
                   ...
                   let uu____7827 = FStar_All.pipe_right b1 term_to_string in
        ...
        let uu____8246 =
          to_string_l " "
            (fun uu____8257 ->
               ...
               | (l, e1) ->
                   let uu____8265 = FStar_All.pipe_right e1 term_to_string in
          ...
          to_string_l "; "
            (fun uu____8737 ->
               ...
               | (f, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____8745) l in
        ...
        let uu____9100 =
          let uu____9102 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____9127 ->
                    match uu____9127 with | (x, uu____9136) -> id_of_tycon x)) in
