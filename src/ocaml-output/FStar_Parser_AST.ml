...
let (uu___is_Mutable : let_qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Mutable -> true | uu____48 -> false
type quote_kind =
  | Static 
  | Dynamic 
let (uu___is_Static : quote_kind -> Prims.bool) =
  fun projectee -> match projectee with | Static -> true | uu____54 -> false
let (uu___is_Dynamic : quote_kind -> Prims.bool) =
  fun projectee -> match projectee with | Dynamic -> true | uu____60 -> false
type term' =
  | Wild 
...
let (uu___is_Var : term' -> Prims.bool) =
  fun projectee -> match projectee with | Var _0 -> true | uu____716 -> false
...
let (uu___is_Abs : term' -> Prims.bool) =
  fun projectee -> match projectee with | Abs _0 -> true | uu____834 -> false
let (__proj__Abs__item___0 :
  term' -> (pattern Prims.list, term) FStar_Pervasives_Native.tuple2) =
  fun projectee -> match projectee with | Abs _0 -> _0
let (uu___is_App : term' -> Prims.bool) =
  fun projectee -> match projectee with | App _0 -> true | uu____872 -> false
let (__proj__App__item___0 :
  term' -> (term, term, imp) FStar_Pervasives_Native.tuple3) =
  fun projectee -> match projectee with | App _0 -> _0
let (uu___is_Let : term' -> Prims.bool) =
  fun projectee -> match projectee with | Let _0 -> true | uu____924 -> false
...
let (uu___is_If : term' -> Prims.bool) =
  fun projectee -> match projectee with | If _0 -> true | uu____1102 -> false
...
let (uu___is_Hash : imp -> Prims.bool) =
  fun projectee -> match projectee with | Hash -> true | uu____2465 -> false
...
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Noeq -> true | uu____2957 -> false
...
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Logic -> true | uu____3053 -> false
...
type decl' =
  ...
  FStar_Pervasives_Native.tuple2 
  | Main of term 
  | Tycon of (Prims.bool, Prims.bool,
      ...
      fun decorations ->
        let doc1 =
          let uu____4297 =
            FStar_List.choose
              (fun uu___89_4302 ->
                 match uu___89_4302 with
                 | Doc d1 -> FStar_Pervasives_Native.Some d1
                 | uu____4306 -> FStar_Pervasives_Native.None) decorations in
          at_most_one "fsdoc" r uu____4297 in
        let attributes_ =
          let uu____4312 =
            FStar_List.choose
              (fun uu___90_4321 ->
                 match uu___90_4321 with
                 | DeclAttributes a -> FStar_Pervasives_Native.Some a
                 | uu____4331 -> FStar_Pervasives_Native.None) decorations in
          at_most_one "attribute set" r uu____4312 in
        let attributes_1 = FStar_Util.dflt [] attributes_ in
        let qualifiers =
          FStar_List.choose
            (fun uu___91_4346 ->
               match uu___91_4346 with
               | Qualifier q -> FStar_Pervasives_Native.Some q
               | uu____4350 -> FStar_Pervasives_Native.None) decorations in
...
let focusAttrLetBindings :
  'Auu____5436 'Auu____5437 .
    ('Auu____5436,
      (Prims.bool, ('Auu____5437, term) FStar_Pervasives_Native.tuple2)
        FStar_Pervasives_Native.tuple2)
      FStar_Pervasives_Native.tuple2 Prims.list ->
      FStar_Range.range ->
  ...
  fun lbs ->
    fun r ->
      let should_filter =
        FStar_Util.for_some
          (fun uu____5503 ->
             match uu____5503 with | (attr, (focus, uu____5518)) -> focus)
          lbs in
      if should_filter
      then
        (FStar_Errors.log_issue r
                      ...
                      (match pat.pat with
                       ...
                       | uu____5899 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____5903 =
                                 let uu____5904 = FStar_Ident.lid_of_ids [x] in
                                 Var uu____5904 in
...
let (compile_op :
  ...
  fun arity ->
    fun s ->
      fun r ->
        let name_of_char uu___93_6219 =
          match uu___93_6219 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___95_6366 ->
    match uu___95_6366 with | Hash -> "#" | uu____6367 -> ""
          ...
          to_string_l " "
            (fun uu____6556 ->
               ...
               | (a1, (p1, b1)) ->
                   ...
                   let uu____6586 = FStar_All.pipe_right b1 term_to_string in
        ...
        let uu____6748 =
          to_string_l " "
            (fun uu____6757 ->
               ...
               | (l, e1) ->
                   let uu____6764 = FStar_All.pipe_right e1 term_to_string in
          ...
          to_string_l "; "
            (fun uu____6989 ->
               ...
               | (f, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____6996) l in
        ...
        let uu____7294 =
          let uu____7295 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____7317 ->
                    match uu____7317 with | (x, uu____7325) -> id_of_tycon x)) in
