          ...
          to_string_l " and "
            (fun uu____3529  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____3534 uu____3535) lbs
           in
               ...
               | (p,w,e) ->
                   ...
                   let uu____3590 =
                     ...
                     | Some e1 ->
                         ...
                         FStar_Util.format1 "when %s" uu____3592
                      in
        ...
        let uu____3616 =
          to_string_l " "
            (fun uu____3619  ->
               ...
               | (l,e1) ->
                   let uu____3624 = FStar_All.pipe_right e1 term_to_string
                      in
          ...
          to_string_l "; "
            (fun uu____3768  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____3773) l
           in
        ...
        let uu____3898 =
          let uu____3899 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3909  ->
                    match uu____3909 with | (x,uu____3914) -> id_of_tycon x))
             in
