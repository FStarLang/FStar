...
let (compile_op :
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___72_5385 =
          match uu___72_5385 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___74_5515  ->
    match uu___74_5515 with | Hash  -> "#" | uu____5516 -> ""
