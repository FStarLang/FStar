      ...
      fun decorations  ->
        let doc1 =
          let uu____3612 =
            FStar_List.choose
              (fun uu___34_3617  ->
                 match uu___34_3617 with
                 | Doc d1 -> FStar_Pervasives_Native.Some d1
                 | uu____3621 -> FStar_Pervasives_Native.None) decorations
             in
        ...
        let attributes_ =
          let uu____3627 =
            FStar_List.choose
              (fun uu___35_3636  ->
                 match uu___35_3636 with
                 | DeclAttributes a -> FStar_Pervasives_Native.Some a
                 | uu____3646 -> FStar_Pervasives_Native.None) decorations
             in
        ...
        let qualifiers =
          FStar_List.choose
            (fun uu___36_3661  ->
               match uu___36_3661 with
               | Qualifier q -> FStar_Pervasives_Native.Some q
               | uu____3665 -> FStar_Pervasives_Native.None) decorations
           in
      ...
      fun r  ->
        fun l  ->
          let t1 =
            ...
            | uu____3722 -> Op ((FStar_Ident.mk_ident ("-", rminus)), [t])
             in
          mk_term t1 r l
                      ...
                      (match pat.pat with
                       ...
                       | uu____4747 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____4751 =
                                 let uu____4752 = FStar_Ident.lid_of_ids [x]
                                    in
                                 Var uu____4752  in
                             ...
                             let otherwise_branch =
                               ...
                               ((mk_pattern PatWild phi.range),
                                 FStar_Pervasives_Native.None, uu____4773)
                                in
                             mk_term
...
let compile_op :
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___38_5037 =
          match uu___38_5037 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let imp_to_string : imp -> Prims.string =
  fun uu___40_5167  ->
    match uu___40_5167 with | Hash  -> "#" | uu____5168 -> ""
          ...
          to_string_l " and "
            (fun uu____5281  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____5288 uu____5289) lbs
           in
               ...
               | (p,w,e) ->
                   ...
                   let uu____5378 =
                     ...
                     | FStar_Pervasives_Native.Some e1 ->
                         ...
                         FStar_Util.format1 "when %s" uu____5380
                      in
        ...
        let uu____5413 =
          to_string_l " "
            (fun uu____5422  ->
               ...
               | (l,e1) ->
                   let uu____5429 = FStar_All.pipe_right e1 term_to_string
                      in
          ...
          to_string_l "; "
            (fun uu____5647  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____5654) l
           in
        ...
        let uu____5888 =
          let uu____5889 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____5911  ->
                    match uu____5911 with | (x,uu____5919) -> id_of_tycon x))
             in
