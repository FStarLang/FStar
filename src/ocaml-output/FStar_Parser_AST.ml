...
let compile_op: Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___79_3464 =
        match uu___79_3464 with
        | '&' -> "Amp"
        | '@' -> "At"
        | '+' -> "Plus"
...
let imp_to_string: imp -> Prims.string =
  fun uu___81_3537  ->
    match uu___81_3537 with | Hash  -> "#" | uu____3538 -> ""
