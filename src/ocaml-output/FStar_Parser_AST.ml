...
let compile_op:
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___106_5340 =
          match uu___106_5340 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let imp_to_string: imp -> Prims.string =
  fun uu___108_5454  ->
    match uu___108_5454 with | Hash  -> "#" | uu____5455 -> ""
