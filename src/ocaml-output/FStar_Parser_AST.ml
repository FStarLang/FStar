...
let compile_op: Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___110_3431 =
        match uu___110_3431 with
        | '&' -> "Amp"
        | '@' -> "At"
        | '+' -> "Plus"
...
let imp_to_string: imp -> Prims.string =
  fun uu___112_3504  ->
    match uu___112_3504 with | Hash  -> "#" | uu____3505 -> ""
