...
type lift =
  {
  effect_binders: binder Prims.list ;
  msource: term ;
  mdest: term ;
  lift_op: lift_op }
type pragma =
...
let uu___is_TopLevelModule : decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | TopLevelModule _0 -> true | uu____2035 -> false
  
let __proj__TopLevelModule__item___0 : decl' -> FStar_Ident.lid =
  fun projectee  -> match projectee with | TopLevelModule _0 -> _0 
let uu___is_Open : decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | Open _0 -> true | uu____2047 -> false
  
let __proj__Open__item___0 : decl' -> FStar_Ident.lid =
  fun projectee  -> match projectee with | Open _0 -> _0 
let uu___is_Include : decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | Include _0 -> true | uu____2059 -> false
  
let __proj__Include__item___0 : decl' -> FStar_Ident.lid =
  fun projectee  -> match projectee with | Include _0 -> _0 
let uu___is_ModuleAbbrev : decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | ModuleAbbrev _0 -> true | uu____2073 -> false
...
let uu___is_TopLevelLet : decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | TopLevelLet _0 -> true | uu____2096 -> false
...
let uu___is_Main : decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | Main _0 -> true | uu____2123 -> false
  
let __proj__Main__item___0 : decl' -> term =
  fun projectee  -> match projectee with | Main _0 -> _0 
let uu___is_Tycon : decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tycon _0 -> true | uu____2141 -> false
...
let uu___is_Val : decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | Val _0 -> true | uu____2173 -> false
  
let __proj__Val__item___0 : decl' -> (FStar_Ident.ident * term) =
  fun projectee  -> match projectee with | Val _0 -> _0 
let uu___is_Exception : decl' -> Prims.bool =
  fun projectee  ->
    match projectee with | Exception _0 -> true | uu____2194 -> false
...
let uu___is_RedefineEffect : effect_decl -> Prims.bool =
  fun projectee  ->
    match projectee with | RedefineEffect _0 -> true | uu____2365 -> false
...
let uu___is_Module : modul -> Prims.bool =
  fun projectee  ->
    match projectee with | Module _0 -> true | uu____2405 -> false
  
let __proj__Module__item___0 : modul -> (FStar_Ident.lid * decl Prims.list) =
  fun projectee  -> match projectee with | Module _0 -> _0 
let uu___is_Interface : modul -> Prims.bool =
  fun projectee  ->
    match projectee with | Interface _0 -> true | uu____2430 -> false
         ...
         let uu____2460 =
           let uu____2463 =
             FStar_Util.format1
              ...
              in
           (uu____2463, (id.FStar_Ident.idRange))  in
         FStar_Errors.Error uu____2460  in
       Prims.raise uu____2459)
        ...
        let uu____2488 =
          let uu____2491 =
            FStar_Util.format1 "At most one %s is allowed on declarations" s
             in
          (uu____2491, r)  in
        FStar_Errors.Error uu____2488  in
      Prims.raise uu____2487
      ...
      fun decorations  ->
        let doc1 =
          let uu____2506 =
            FStar_List.choose
              (fun uu___104_2508  ->
                 match uu___104_2508 with
                 | Doc d1 -> Some d1
                 | uu____2511 -> None) decorations
             in
          at_most_one "fsdoc" r uu____2506  in
        let attributes_ =
          let uu____2515 =
            FStar_List.choose
              (fun uu___105_2519  ->
                 match uu___105_2519 with
                 | DeclAttributes a -> Some a
                 | uu____2525 -> None) decorations
             in
          at_most_one "attribute set" r uu____2515  in
        let attributes_1 = FStar_Util.dflt [] attributes_  in
        let qualifiers =
          FStar_List.choose
            (fun uu___106_2533  ->
               match uu___106_2533 with
               | Qualifier q -> Some q
               | uu____2536 -> None) decorations
           in
            ...
            let uu____2629 =
              let uu____2630 =
                let uu____2631 =
                  let uu____2639 =
                    let uu____2640 =
                      let uu____2641 = FStar_Ident.lid_of_ids [x]  in
                      Var uu____2641  in
                    mk_term uu____2640 r1 Expr  in
                  (uu____2639, branches)  in
                Match uu____2631  in
              mk_term uu____2630 r2 Expr  in
            ([mk_pattern (PatVar (x, None)) r1], uu____2629)  in
          Abs uu____2625  in
        mk_term uu____2624 r2 Expr
  
let un_function : pattern -> term -> (pattern * term) Prims.option =
  fun p  ->
    fun tm  ->
      match ((p.pat), (tm.tm)) with
      | (PatVar uu____2661,Abs (pats,body)) ->
...
let lid_with_range :
  ...
  fun lid  ->
    fun r  ->
      let uu____2683 = FStar_Ident.path_of_lid lid  in
      FStar_Ident.lid_of_path uu____2683 r
             ...
             | Name s ->
                 let uu____2858 =
                   let uu____2859 =
                     ...
                     (s, uu____2865)  in
                   Construct uu____2859  in
                 mk_term uu____2858 r Un
             | uu____2875 ->
                 FStar_List.fold_left
...
let mkWildAdmitMagic r =
  let uu____2898 = mkAdmitMagic r  in
  ((mk_pattern PatWild r), None, uu____2898) 
let focusBranches branches r =
  ...
  then
    (FStar_Errors.warn r "Focusing on only some cases";
     (let focussed =
        let uu____2954 = FStar_List.filter Prims.fst branches  in
        FStar_All.pipe_right uu____2954 (FStar_List.map Prims.snd)  in
      let uu____2998 = let uu____3004 = mkWildAdmitMagic r  in [uu____3004]
         in
      FStar_List.append focussed uu____2998))
       ...
       (fun uu____3090  ->
          ...
          | (f,lb) ->
              ...
              then lb
                ...
                (let uu____3106 = mkAdmitMagic r  in
                 ((Prims.fst lb), uu____3106))) lbs)
  else FStar_All.pipe_right lbs (FStar_List.map Prims.snd) 
let mkFsTypApp : term -> term Prims.list -> FStar_Range.range -> term =
  fun t  ->
    fun args  ->
      fun r  ->
        let uu____3135 = FStar_List.map (fun a  -> (a, FsTypApp)) args  in
        mkApp t uu____3135 r
...
let mkTuple : term Prims.list -> FStar_Range.range -> term =
  fun args  ->
    fun r  ->
      ...
      let uu____3154 = FStar_List.map (fun x  -> (x, Nothing)) args  in
      mkApp (mk_term (Name cons1) r Expr) uu____3154 r
...
let mkDTuple : term Prims.list -> FStar_Range.range -> term =
  fun args  ->
    fun r  ->
      ...
      let uu____3173 = FStar_List.map (fun x  -> (x, Nothing)) args  in
      mkApp (mk_term (Name cons1) r Expr) uu____3173 r
                      ...
                      (match pat.pat with
                       ...
                       | uu____3231 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____3235 =
                                 let uu____3236 = FStar_Ident.lid_of_ids [x]
                                    in
                                 Var uu____3236  in
                               mk_term uu____3235 phi.range Formula  in
                                 ...
                                 let uu____3249 =
                                   let uu____3250 =
                                     FStar_Ident.lid_of_path ["False"]
                                      ...
                                      in
                                   Name uu____3250  in
                                 mk_term uu____3249 phi.range Formula  in
...
let rec extract_named_refinement :
  ...
  fun t1  ->
    ...
    | Refine
        ({ b = Annotated (x,t); brange = uu____3293; blevel = uu____3294;
           aqual = uu____3295;_},t')
        -> Some (x, t, (Some t'))
        ...
        fun ds  ->
          ...
          | TopLevelModule m ->
              let ds1 =
                if is_light
                then
                  let uu____3392 = mk_decl (Pragma LightOff) light_range []
                     in
                  uu____3392 :: ds
                else ds  in
              let ms = as_mlist [] ((m, d), []) ds1  in
              ((let uu____3400 = FStar_List.tl ms  in
                match uu____3400 with
                | (Module (m',uu____3403))::uu____3404 ->
                    let msg =
          ...
          | uu____3414 ->
              ...
              (FStar_List.iter
                 (fun uu___107_3418  ->
                    match uu___107_3418 with
                    | { d = TopLevelModule uu____3419; drange = r;
                        doc = uu____3421; quals = uu____3422;
                        attrs = uu____3423;_} ->
                        Prims.raise
                          (FStar_Errors.Error
...
let compile_op : Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___108_3437 =
        match uu___108_3437 with
        | '&' -> "Amp"
        | '@' -> "At"
        | '+' -> "Plus"
      ...
      | uu____3439 ->
          let uu____3440 =
            let uu____3441 =
              let uu____3443 = FStar_String.list_of_string s  in
              FStar_List.map name_of_char uu____3443  in
            FStar_String.concat "_" uu____3441  in
          Prims.strcat "op_" uu____3440
        ...
        let uu____3469 =
          let uu____3470 =
            FStar_List.map
             ...
             in
          FStar_String.concat "," uu____3470  in
        Prims.strcat comment uu____3469
  
let string_of_let_qualifier : let_qualifier -> Prims.string =
  fun uu___109_3481  ->
    match uu___109_3481 with
    | NoLetQualifier  -> ""
    | Rec  -> "rec"
    | Mutable  -> "mutable"
  
let to_string_l sep f l =
  let uu____3506 = FStar_List.map f l  in FStar_String.concat sep uu____3506 
let imp_to_string : imp -> Prims.string =
  fun uu___110_3510  ->
    match uu___110_3510 with | Hash  -> "#" | uu____3511 -> ""
  
let rec term_to_string : term -> Prims.string =
  fun x  ->
    match x.tm with
    | Wild  -> "_"
    | Requires (t,uu____3522) ->
        let uu____3525 = term_to_string t  in
        FStar_Util.format1 "(requires %s)" uu____3525
    | Ensures (t,uu____3527) ->
        let uu____3530 = term_to_string t  in
        FStar_Util.format1 "(ensures %s)" uu____3530
    | Labeled (t,l,uu____3533) ->
        let uu____3534 = term_to_string t  in
        FStar_Util.format2 "(labeled %s %s)" l uu____3534
        ...
        let uu____3540 =
          let uu____3541 =
            FStar_List.map
             ...
             in
          FStar_String.concat ", " uu____3541  in
        FStar_Util.format2 "%s(%s)" s uu____3540
        ...
        let uu____3554 =
          to_string_l " "
            (fun uu____3557  ->
               ...
               | (a,imp) ->
                   let uu____3562 = term_to_string a  in
                   FStar_Util.format2 "%s%s" (imp_to_string imp) uu____3562)
            args
           in
        FStar_Util.format2 "(%s %s)" l.FStar_Ident.str uu____3554
    | Abs (pats,t) ->
        let uu____3567 = to_string_l " " pat_to_string pats  in
        let uu____3568 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "(fun %s -> %s)" uu____3567 uu____3568
    | App (t1,t2,imp) ->
        let uu____3572 = FStar_All.pipe_right t1 term_to_string  in
        let uu____3573 = FStar_All.pipe_right t2 term_to_string  in
        FStar_Util.format3 "%s %s%s" uu____3572 (imp_to_string imp)
          uu____3573
    | Let (Rec ,lbs,body) ->
        let uu____3582 =
          to_string_l " and "
            (fun uu____3585  ->
               ...
               | (p,b) ->
                   ...
                   let uu____3591 = FStar_All.pipe_right b term_to_string  in
                   FStar_Util.format2 "%s=%s" uu____3590 uu____3591) lbs
           in
        let uu____3592 = FStar_All.pipe_right body term_to_string  in
        FStar_Util.format2 "let rec %s in %s" uu____3582 uu____3592
    | Let (q,(pat,tm)::[],body) ->
        let uu____3604 = FStar_All.pipe_right pat pat_to_string  in
        let uu____3605 = FStar_All.pipe_right tm term_to_string  in
        let uu____3606 = FStar_All.pipe_right body term_to_string  in
        FStar_Util.format4 "let %s %s = %s in %s" (string_of_let_qualifier q)
          uu____3604 uu____3605 uu____3606
    | Seq (t1,t2) ->
        let uu____3609 = FStar_All.pipe_right t1 term_to_string  in
        let uu____3610 = FStar_All.pipe_right t2 term_to_string  in
        FStar_Util.format2 "%s; %s" uu____3609 uu____3610
    | If (t1,t2,t3) ->
        let uu____3614 = FStar_All.pipe_right t1 term_to_string  in
        let uu____3615 = FStar_All.pipe_right t2 term_to_string  in
        let uu____3616 = FStar_All.pipe_right t3 term_to_string  in
        FStar_Util.format3 "if %s then %s else %s" uu____3614 uu____3615
          uu____3616
    | Match (t,branches) ->
        let uu____3629 = FStar_All.pipe_right t term_to_string  in
        let uu____3630 =
          to_string_l " | "
            (fun uu____3635  ->
               match uu____3635 with
               | (p,w,e) ->
                   let uu____3645 = FStar_All.pipe_right p pat_to_string  in
                   let uu____3646 =
                     match w with
                     | None  -> ""
                     | Some e1 ->
                         let uu____3648 = term_to_string e1  in
                         FStar_Util.format1 "when %s" uu____3648
                      in
                   let uu____3649 = FStar_All.pipe_right e term_to_string  in
                   FStar_Util.format3 "%s %s -> %s" uu____3645 uu____3646
                     uu____3649) branches
           in
        FStar_Util.format2 "match %s with %s" uu____3629 uu____3630
    | Ascribed (t1,t2) ->
    ...
    | Record (Some e,fields) ->
        let uu____3663 = FStar_All.pipe_right e term_to_string  in
        let uu____3664 =
          to_string_l " "
            (fun uu____3667  ->
               match uu____3667 with
               | (l,e1) ->
                   let uu____3672 = FStar_All.pipe_right e1 term_to_string
                      in
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____3672)
            fields
           in
        FStar_Util.format2 "{%s with %s}" uu____3663 uu____3664
    | Record (None ,fields) ->
        let uu____3681 =
          to_string_l " "
            (fun uu____3684  ->
               ...
               | (l,e) ->
                   let uu____3689 = FStar_All.pipe_right e term_to_string  in
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____3689)
            fields
           in
        FStar_Util.format1 "{%s}" uu____3681
    | Project (e,l) ->
        let uu____3692 = FStar_All.pipe_right e term_to_string  in
        FStar_Util.format2 "%s.%s" uu____3692 l.FStar_Ident.str
    ...
    | Product (b::[],t) when x.level = Type_level ->
        let uu____3706 = FStar_All.pipe_right b binder_to_string  in
        let uu____3707 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s -> %s" uu____3706 uu____3707
        ...
        let uu____3717 =
          let uu____3718 =
            FStar_All.pipe_right binders (FStar_List.map binder_to_string)
             in
          FStar_All.pipe_right uu____3718 (FStar_String.concat " * ")  in
        let uu____3723 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s * %s" uu____3717 uu____3723
    | QForall (bs,pats,t) ->
        let uu____3733 = to_string_l " " binder_to_string bs  in
        let uu____3734 =
          to_string_l " \\/ " (to_string_l "; " term_to_string) pats  in
        let uu____3736 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format3 "forall %s.{:pattern %s} %s" uu____3733 uu____3734
          uu____3736
    | QExists (bs,pats,t) ->
        let uu____3746 = to_string_l " " binder_to_string bs  in
        let uu____3747 =
          to_string_l " \\/ " (to_string_l "; " term_to_string) pats  in
        let uu____3749 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format3 "exists %s.{:pattern %s} %s" uu____3746 uu____3747
          uu____3749
    | Refine (b,t) ->
        let uu____3752 = FStar_All.pipe_right b binder_to_string  in
        let uu____3753 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s:{%s}" uu____3752 uu____3753
    | NamedTyp (x1,t) ->
        let uu____3756 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "%s:%s" x1.FStar_Ident.idText uu____3756
    | Paren t ->
        let uu____3758 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format1 "(%s)" uu____3758
    | Product (bs,t) ->
        let uu____3763 =
          let uu____3764 =
            FStar_All.pipe_right bs (FStar_List.map binder_to_string)  in
          FStar_All.pipe_right uu____3764 (FStar_String.concat ",")  in
        let uu____3769 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "Unidentified product: [%s] %s" uu____3763
          uu____3769
    | t -> "_"
  ...
  fun x  ->
    let s =
      ...
      | TAnnotated (i,t)|Annotated (i,t) ->
          let uu____3777 = FStar_All.pipe_right t term_to_string  in
          FStar_Util.format2 "%s:%s" i.FStar_Ident.idText uu____3777
      | NoName t -> FStar_All.pipe_right t term_to_string  in
    let uu____3779 = aqual_to_string x.aqual  in
    FStar_Util.format2 "%s%s" uu____3779 s

and aqual_to_string : aqual -> Prims.string =
  fun uu___111_3780  ->
    match uu___111_3780 with
    | Some (Equality ) -> "$"
    | Some (Implicit ) -> "#"
    | uu____3781 -> ""
...
and pat_to_string : pattern -> Prims.string =
  fun x  ->
    ...
    | PatApp (p,ps) ->
        let uu____3788 = FStar_All.pipe_right p pat_to_string  in
        let uu____3789 = to_string_l " " pat_to_string ps  in
        FStar_Util.format2 "(%s %s)" uu____3788 uu____3789
    | PatTvar (i,aq)|PatVar (i,aq) ->
        let uu____3796 = aqual_to_string aq  in
        FStar_Util.format2 "%s%s" uu____3796 i.FStar_Ident.idText
    | PatName l -> l.FStar_Ident.str
    | PatList l ->
        let uu____3800 = to_string_l "; " pat_to_string l  in
        FStar_Util.format1 "[%s]" uu____3800
    | PatTuple (l,false ) ->
        let uu____3804 = to_string_l ", " pat_to_string l  in
        FStar_Util.format1 "(%s)" uu____3804
    | PatTuple (l,true ) ->
        let uu____3808 = to_string_l ", " pat_to_string l  in
        FStar_Util.format1 "(|%s|)" uu____3808
    | PatRecord l ->
        let uu____3813 =
          to_string_l "; "
            (fun uu____3816  ->
               ...
               | (f,e) ->
                   let uu____3821 = FStar_All.pipe_right e pat_to_string  in
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____3821) l
           in
        FStar_Util.format1 "{%s}" uu____3813
    | PatOr l -> to_string_l "|\n " pat_to_string l
    | PatOp op -> FStar_Util.format1 "(%s)" op
    | PatAscribed (p,t) ->
        let uu____3827 = FStar_All.pipe_right p pat_to_string  in
        let uu____3828 = FStar_All.pipe_right t term_to_string  in
        FStar_Util.format2 "(%s:%s)" uu____3827 uu____3828
...
let rec head_id_of_pat : pattern -> FStar_Ident.lid Prims.list =
  fun p  ->
    ...
    | PatName l -> [l]
    | PatVar (i,uu____3836) ->
        let uu____3839 = FStar_Ident.lid_of_ids [i]  in [uu____3839]
    | PatApp (p1,uu____3841) -> head_id_of_pat p1
    | PatAscribed (p1,uu____3845) -> head_id_of_pat p1
    | uu____3846 -> []
...
let lids_of_let defs =
  FStar_All.pipe_right defs
    (FStar_List.collect
       (fun uu____3867  ->
          match uu____3867 with | (p,uu____3872) -> head_id_of_pat p))
  
let id_of_tycon : tycon -> Prims.string =
  fun uu___112_3875  ->
    match uu___112_3875 with
    | TyconAbstract (i,_,_)
  ...
  fun d  ->
    ...
    | ModuleAbbrev (i,l) ->
        FStar_Util.format2 "module %s = %s" i.FStar_Ident.idText
          l.FStar_Ident.str
    | TopLevelLet (uu____3916,pats) ->
        let uu____3924 =
          let uu____3925 =
            let uu____3927 = lids_of_let pats  in
            FStar_All.pipe_right uu____3927
              (FStar_List.map (fun l  -> l.FStar_Ident.str))
             in
          FStar_All.pipe_right uu____3925 (FStar_String.concat ", ")  in
        Prims.strcat "let " uu____3924
    | Main uu____3933 -> "main ..."
    | Assume (i,uu____3935) -> Prims.strcat "assume " i.FStar_Ident.idText
    | Tycon (uu____3936,tys) ->
        let uu____3946 =
          let uu____3947 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3957  ->
                    match uu____3957 with | (x,uu____3962) -> id_of_tycon x))
             in
          FStar_All.pipe_right uu____3947 (FStar_String.concat ", ")  in
        Prims.strcat "type " uu____3946
    | Val (i,uu____3967) -> Prims.strcat "val " i.FStar_Ident.idText
    | Exception (i,uu____3969) ->
    ...
    | SubEffect uu____3994 -> "sub_effect"
    | Pragma uu____3995 -> "pragma"
    | Fsdoc uu____3996 -> "fsdoc"
...
let modul_to_string : modul -> Prims.string =
  fun m  ->
    ...
    | Module (_,decls)|Interface (_,decls,_) ->
        ...
        FStar_All.pipe_right uu____4008 (FStar_String.concat "\n")
