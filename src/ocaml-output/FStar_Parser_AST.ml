      ...
      fun r  ->
        fun l  ->
          let t1 =
            ...
            | uu____2552 -> Op ((FStar_Ident.mk_ident ("-", rminus)), [t])
             in
          mk_term t1 r l
  ...
  then
    (FStar_Errors.warn r "Focusing on only some cases";
     (let focussed =
        ...
        FStar_All.pipe_right uu____2926 (FStar_List.map FStar_Pervasives.snd)
         in
      let uu____2970 = let uu____2976 = mkWildAdmitMagic r  in [uu____2976]
         in
                      ...
                      (match pat.pat with
                       ...
                       | uu____3203 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____3207 =
                                 let uu____3208 = FStar_Ident.lid_of_ids [x]
                                    in
                                 Var uu____3208  in
          ...
          to_string_l " and "
            (fun uu____3576  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____3581 uu____3582) lbs
           in
               ...
               | (p,w,e) ->
                   ...
                   let uu____3637 =
                     ...
                     | Some e1 ->
                         ...
                         FStar_Util.format1 "when %s" uu____3639
                      in
        ...
        let uu____3663 =
          to_string_l " "
            (fun uu____3666  ->
               ...
               | (l,e1) ->
                   let uu____3671 = FStar_All.pipe_right e1 term_to_string
                      in
          ...
          to_string_l "; "
            (fun uu____3815  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____3820) l
           in
        ...
        let uu____3945 =
          let uu____3946 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3956  ->
                    match uu____3956 with | (x,uu____3961) -> id_of_tycon x))
             in
