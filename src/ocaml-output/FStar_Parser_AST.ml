...
let (compile_op :
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___86_6090 =
          match uu___86_6090 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___88_6237  ->
    match uu___88_6237 with | Hash  -> "#" | uu____6238 -> ""
