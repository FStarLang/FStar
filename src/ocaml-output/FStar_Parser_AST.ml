          ...
          to_string_l " and "
            (fun uu____3579  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____3584 uu____3585) lbs
           in
               ...
               | (p,w,e) ->
                   ...
                   let uu____3640 =
                     ...
                     | Some e1 ->
                         ...
                         FStar_Util.format1 "when %s" uu____3642
                      in
          ...
          to_string_l "; "
            (fun uu____3818  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____3823) l
           in
        ...
        let uu____3948 =
          let uu____3949 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3959  ->
                    match uu____3959 with | (x,uu____3964) -> id_of_tycon x))
             in
