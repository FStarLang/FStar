      ...
      fun decorations  ->
        let doc =
          let uu____2471 =
            FStar_List.choose
              (fun uu___104_2473  ->
                 match uu___104_2473 with
                 | Doc d -> Some d
                 | uu____2476 -> None) decorations
             in
        ...
        let attributes_ =
          let uu____2480 =
            FStar_List.choose
              (fun uu___105_2484  ->
                 match uu___105_2484 with
                 | DeclAttributes a -> Some a
                 | uu____2490 -> None) decorations
             in
        ...
        let qualifiers =
          FStar_List.choose
            (fun uu___106_2498  ->
               match uu___106_2498 with
               | Qualifier q -> Some q
               | uu____2501 -> None) decorations
           in
  ...
  then
    (FStar_Errors.warn r "Focusing on only some cases";
     (let focussed =
      ...
      let uu____2963 = let uu____2969 = mkWildAdmitMagic r  in [uu____2969]
         in
...
let mkTuple : term Prims.list -> FStar_Range.range -> term =
  fun args  ->
    fun r  ->
      ...
      mkApp (mk_term (Name cons) r Expr) uu____3119 r
...
let mkDTuple : term Prims.list -> FStar_Range.range -> term =
  fun args  ->
    fun r  ->
      ...
      mkApp (mk_term (Name cons) r Expr) uu____3138 r
...
let compile_op : Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___108_3402 =
        match uu___108_3402 with
        | '&' -> "Amp"
        | '@' -> "At"
        | '+' -> "Plus"
...
let imp_to_string : imp -> Prims.string =
  fun uu___110_3475  ->
    match uu___110_3475 with | Hash  -> "#" | uu____3476 -> ""
...
let rec term_to_string : term -> Prims.string =
  fun x  ->
          ...
          to_string_l " and "
            (fun uu____3550  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____3555 uu____3556) lbs
           in
            ...
            (fun uu____3600  ->
               ...
               | (p,w,e) ->
                   ...
                   let uu____3611 =
                     ...
                     | None  -> ""
                     | Some e ->
                         let uu____3613 = term_to_string e  in
                         FStar_Util.format1 "when %s" uu____3613
                      in
        ...
        let uu____3629 =
          to_string_l " "
            (fun uu____3632  ->
               ...
               | (l,e) ->
                   let uu____3637 = FStar_All.pipe_right e term_to_string  in
    ...
    | NamedTyp (x,t) ->
        ...
        FStar_Util.format2 "%s:%s" x.FStar_Ident.idText uu____3721
    | Paren t ->
          ...
          to_string_l "; "
            (fun uu____3781  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____3786) l
           in
...
let rec head_id_of_pat : pattern -> FStar_Ident.lid Prims.list =
  fun p  ->
    ...
    | PatApp (p,uu____3806) -> head_id_of_pat p
    | PatAscribed (p,uu____3810) -> head_id_of_pat p
    | uu____3811 -> []
        ...
        let uu____3911 =
          let uu____3912 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3922  ->
                    match uu____3922 with | (x,uu____3927) -> id_of_tycon x))
             in
