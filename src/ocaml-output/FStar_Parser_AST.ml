      ...
      fun r  ->
        fun l  ->
          let t1 =
            ...
            | uu____2558 -> Op ((FStar_Ident.mk_ident ("-", rminus)), [t]) in
          mk_term t1 r l
  ...
  then
    (FStar_Errors.warn r "Focusing on only some cases";
     (let focussed =
      ...
      let uu____2976 = let uu____2982 = mkWildAdmitMagic r in [uu____2982] in
...
let compile_op: Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___111_3434 =
        match uu___111_3434 with
        | '&' -> "Amp"
        | '@' -> "At"
        | '+' -> "Plus"
...
let imp_to_string: imp -> Prims.string =
  fun uu___113_3507  ->
    match uu___113_3507 with | Hash  -> "#" | uu____3508 -> ""
          ...
          to_string_l " and "
            (fun uu____3582  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____3587 uu____3588) lbs in
        ...
        let uu____3669 =
          to_string_l " "
            (fun uu____3672  ->
               ...
               | (l,e1) ->
                   let uu____3677 = FStar_All.pipe_right e1 term_to_string in
          ...
          to_string_l "; "
            (fun uu____3821  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____3826) l in
        ...
        let uu____3951 =
          let uu____3952 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3962  ->
                    match uu____3962 with | (x,uu____3967) -> id_of_tycon x)) in
