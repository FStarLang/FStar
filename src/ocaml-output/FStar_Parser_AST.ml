...
let (compile_op :
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___40_5483 =
          match uu___40_5483 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___42_5613  ->
    match uu___42_5613 with | Hash  -> "#" | uu____5614 -> ""
