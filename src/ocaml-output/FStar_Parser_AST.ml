...
type term' =
  ...
  FStar_Pervasives_Native_Tuple2.tuple2 
  | Construct of
  (FStar_Ident.lid,(term,imp) FStar_Pervasives_Native_Tuple2.tuple2
                     Prims.list)
  FStar_Pervasives_Native_Tuple2.tuple2 
  | Abs of (pattern Prims.list,term) FStar_Pervasives_Native_Tuple2.tuple2 
  | App of (term,term,imp) FStar_Pervasives_Native_Tuple3.tuple3 
  | Let of
  (let_qualifier,(term Prims.list FStar_Pervasives_Native.option,(pattern,
                                                                   term)
                                                                   FStar_Pervasives_Native_Tuple2.tuple2)
                   FStar_Pervasives_Native_Tuple2.tuple2 Prims.list,term)
  FStar_Pervasives_Native_Tuple3.tuple3 
  | LetOpen of (FStar_Ident.lid,term) FStar_Pervasives_Native_Tuple2.tuple2 
  | Seq of (term,term) FStar_Pervasives_Native_Tuple2.tuple2 
  | Bind of (FStar_Ident.ident,term,term)
  FStar_Pervasives_Native_Tuple3.tuple3 
  | If of (term,term,term) FStar_Pervasives_Native_Tuple3.tuple3 
  | Match of
  ...
  (term FStar_Pervasives_Native.option,(FStar_Ident.lid,term)
                                         ...
                                         Prims.list)
  FStar_Pervasives_Native_Tuple2.tuple2 
  | Project of (term,FStar_Ident.lid) FStar_Pervasives_Native_Tuple2.tuple2 
  | Product of (binder Prims.list,term) FStar_Pervasives_Native_Tuple2.tuple2
  ...
  FStar_Pervasives_Native_Tuple3.tuple3 
  | Refine of (binder,term) FStar_Pervasives_Native_Tuple2.tuple2 
  ...
  | Antiquote of term 
  | Quote of (term,quote_kind) FStar_Pervasives_Native_Tuple2.tuple2 
  | VQuote of term 
...
and term = {
  ...
  level: level }
and calc_step =
  | CalcStep of (term,term,term) FStar_Pervasives_Native_Tuple3.tuple3 
and binder' =
...
and pattern' =
  ...
  FStar_Pervasives_Native_Tuple2.tuple2 
  | PatRecord of (FStar_Ident.lid,pattern)
...
let (__proj__Op__item___0 :
  term' ->
    (FStar_Ident.ident,term Prims.list) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__Projector__item___0 :
  term' ->
    (FStar_Ident.lid,FStar_Ident.ident) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__Abs__item___0 :
  term' -> (pattern Prims.list,term) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (__proj__App__item___0 :
  term' -> (term,term,imp) FStar_Pervasives_Native_Tuple3.tuple3) =
...
let (__proj__Let__item___0 :
  term' ->
    (let_qualifier,(term Prims.list FStar_Pervasives_Native.option,(pattern,
                                                                    ...
                                                                    FStar_Pervasives_Native_Tuple2.tuple2)
                     FStar_Pervasives_Native_Tuple2.tuple2 Prims.list,
      term) FStar_Pervasives_Native_Tuple3.tuple3)
...
let (__proj__LetOpen__item___0 :
  term' -> (FStar_Ident.lid,term) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (__proj__Seq__item___0 :
  term' -> (term,term) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (__proj__Bind__item___0 :
  term' ->
    (FStar_Ident.ident,term,term) FStar_Pervasives_Native_Tuple3.tuple3)
...
let (__proj__If__item___0 :
  term' -> (term,term,term) FStar_Pervasives_Native_Tuple3.tuple3) =
...
let (__proj__Project__item___0 :
  term' -> (term,FStar_Ident.lid) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (__proj__Product__item___0 :
  term' -> (binder Prims.list,term) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (__proj__Refine__item___0 :
  term' -> (binder,term) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (__proj__NamedTyp__item___0 :
  term' -> (FStar_Ident.ident,term) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (__proj__Labeled__item___0 :
  term' ->
    (term,Prims.string,Prims.bool) FStar_Pervasives_Native_Tuple3.tuple3)
...
let (__proj__Quote__item___0 :
  term' -> (term,quote_kind) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (__proj__CalcProof__item___0 :
  term' ->
    (term,term,calc_step Prims.list) FStar_Pervasives_Native_Tuple3.tuple3)
...
let (__proj__CalcStep__item___0 :
  calc_step -> (term,term,term) FStar_Pervasives_Native_Tuple3.tuple3) =
...
let (__proj__Annotated__item___0 :
  binder' -> (FStar_Ident.ident,term) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__PatApp__item___0 :
  pattern' ->
    (pattern,pattern Prims.list) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__PatTuple__item___0 :
  pattern' ->
    (pattern Prims.list,Prims.bool) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__PatRecord__item___0 :
  pattern' ->
    (FStar_Ident.lid,pattern) FStar_Pervasives_Native_Tuple2.tuple2
      Prims.list)
...
type tycon =
  ...
  | TyconAbbrev of
  (FStar_Ident.ident,binder Prims.list,knd FStar_Pervasives_Native.option,
  term) FStar_Pervasives_Native_Tuple4.tuple4 
  | TyconRecord of
  (FStar_Ident.ident,binder Prims.list,knd FStar_Pervasives_Native.option,
  ...
  (FStar_Ident.ident,term FStar_Pervasives_Native.option,fsdoc
    ...
    Prims.bool) FStar_Pervasives_Native_Tuple4.tuple4 Prims.list)
  FStar_Pervasives_Native_Tuple4.tuple4 
...
type lift_op =
  ...
  | ReifiableLift of (term,term) FStar_Pervasives_Native_Tuple2.tuple2 
  | LiftForFree of term 
...
let (__proj__ReifiableLift__item___0 :
  lift_op -> (term,term) FStar_Pervasives_Native_Tuple2.tuple2) =
...
type decl' =
  ...
  FStar_Pervasives_Native_Tuple2.tuple2 
  | TopLevelLet of
  (let_qualifier,(pattern,term) FStar_Pervasives_Native_Tuple2.tuple2
                   Prims.list)
  FStar_Pervasives_Native_Tuple2.tuple2 
  | Main of term 
  | Tycon of
  (Prims.bool,Prims.bool,(tycon,fsdoc FStar_Pervasives_Native.option)
                           FStar_Pervasives_Native_Tuple2.tuple2 Prims.list)
  FStar_Pervasives_Native_Tuple3.tuple3 
  | Val of (FStar_Ident.ident,term) FStar_Pervasives_Native_Tuple2.tuple2 
  ...
  | Pragma of pragma 
  | Fsdoc of fsdoc 
  | Assume of (FStar_Ident.ident,term) FStar_Pervasives_Native_Tuple2.tuple2
...
let (__proj__ModuleAbbrev__item___0 :
  decl' ->
    (FStar_Ident.ident,FStar_Ident.lid) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__Val__item___0 :
  decl' -> (FStar_Ident.ident,term) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (__proj__Splice__item___0 :
  decl' ->
    (FStar_Ident.ident Prims.list,term) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__Module__item___0 :
  modul ->
    (FStar_Ident.lid,decl Prims.list) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (un_function :
  pattern ->
    term ->
      (pattern,term) FStar_Pervasives_Native_Tuple2.tuple2
        FStar_Pervasives_Native.option)
  =
  fun p  ->
    fun tm  ->
...
let (mkApp :
  term ->
    (term,imp) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list ->
...
let focusLetBindings :
  'Auu____6288 .
    (Prims.bool,('Auu____6288,term) FStar_Pervasives_Native_Tuple2.tuple2)
      FStar_Pervasives_Native_Tuple2.tuple2 Prims.list ->
      FStar_Range.range ->
        ('Auu____6288,term) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list
  =
  fun lbs  ->
    fun r  ->
...
let focusAttrLetBindings :
  'Auu____6449 'Auu____6450 .
    ('Auu____6449,(Prims.bool,('Auu____6450,term)
                                FStar_Pervasives_Native_Tuple2.tuple2)
                    FStar_Pervasives_Native_Tuple2.tuple2)
      FStar_Pervasives_Native_Tuple2.tuple2 Prims.list ->
      FStar_Range.range ->
        ('Auu____6449,('Auu____6450,term)
                        FStar_Pervasives_Native_Tuple2.tuple2)
          FStar_Pervasives_Native_Tuple2.tuple2 Prims.list
  =
  fun lbs  ->
...
let rec (as_mlist :
  ((FStar_Ident.lid,decl) FStar_Pervasives_Native_Tuple2.tuple2,decl
                                                                  Prims.list)
    FStar_Pervasives_Native_Tuple2.tuple2 -> decl Prims.list -> modul)
  =
  fun cur  ->
    fun ds  ->
...
let (compile_op :
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___99_7292 =
          match uu___99_7292 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let (string_of_fsdoc :
  (Prims.string,(Prims.string,Prims.string)
                  FStar_Pervasives_Native_Tuple2.tuple2 Prims.list)
    FStar_Pervasives_Native_Tuple2.tuple2 -> Prims.string)
  =
  fun uu____7412  ->
...
let (string_of_let_qualifier : let_qualifier -> Prims.string) =
  fun uu___100_7485  ->
    match uu___100_7485 with | NoLetQualifier  -> "" | Rec  -> "rec"
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___101_7539  ->
    match uu___101_7539 with | Hash  -> "#" | uu____7542 -> ""
...
let lids_of_let :
  'Auu____8840 .
    (pattern,'Auu____8840) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list
