          ...
          let uu____3788 =
            FStar_List.choose
              (fun uu___38_3793 ->
                 ...
                 | uu____3797 -> FStar_Pervasives_Native.None) decorations in
          ...
          let uu____3803 =
            FStar_List.choose
              (fun uu___39_3812 ->
                 ...
                 | uu____3822 -> FStar_Pervasives_Native.None) decorations in
...
let focusAttrLetBindings :
  'Auu____4814 'Auu____4815 .
    ('Auu____4814,
      (Prims.bool, ('Auu____4815, term) FStar_Pervasives_Native.tuple2)
        FStar_Pervasives_Native.tuple2)
      FStar_Pervasives_Native.tuple2 Prims.list ->
      FStar_Range.range ->
  ...
  fun lbs ->
    fun r ->
      let should_filter =
        FStar_Util.for_some
          (fun uu____4879 ->
             match uu____4879 with | (attr, (focus, uu____4894)) -> focus)
          lbs in
      if should_filter
      then
        (FStar_Errors.log_issue r
                      ...
                      (match pat.pat with
                       ...
                       | uu____5233 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____5237 =
                                 let uu____5238 = FStar_Ident.lid_of_ids [x] in
                                 Var uu____5238 in
                             ...
                             let otherwise_branch =
                               ...
                               ((mk_pattern PatWild phi.range),
                                 FStar_Pervasives_Native.None, uu____5259) in
                             mk_term
          ...
          to_string_l " "
            (fun uu____5839 ->
               ...
               | (a1, (p1, b1)) ->
                   ...
                   let uu____5869 = FStar_All.pipe_right b1 term_to_string in
        ...
        let uu____6031 =
          to_string_l " "
            (fun uu____6040 ->
               ...
               | (l, e1) ->
                   let uu____6047 = FStar_All.pipe_right e1 term_to_string in
          ...
          to_string_l "; "
            (fun uu____6265 ->
               ...
               | (f, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____6272) l in
        ...
        let uu____6559 =
          let uu____6560 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____6582 ->
                    match uu____6582 with | (x, uu____6590) -> id_of_tycon x)) in
