...
let uu___is_Wild: term' -> Prims.bool =
  fun projectee  -> match projectee with | Wild  -> true | uu____385 -> false
let uu___is_Const: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Const _0 -> true | uu____390 -> false
let __proj__Const__item___0: term' -> FStar_Const.sconst =
  fun projectee  -> match projectee with | Const _0 -> _0
let uu___is_Op: term' -> Prims.bool =
  fun projectee  -> match projectee with | Op _0 -> true | uu____405 -> false
let __proj__Op__item___0: term' -> (Prims.string* term Prims.list) =
  fun projectee  -> match projectee with | Op _0 -> _0
let uu___is_Tvar: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Tvar _0 -> true | uu____426 -> false
let __proj__Tvar__item___0: term' -> FStar_Ident.ident =
  fun projectee  -> match projectee with | Tvar _0 -> _0
let uu___is_Uvar: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Uvar _0 -> true | uu____438 -> false
let __proj__Uvar__item___0: term' -> FStar_Ident.ident =
  fun projectee  -> match projectee with | Uvar _0 -> _0
let uu___is_Var: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Var _0 -> true | uu____450 -> false
let __proj__Var__item___0: term' -> FStar_Ident.lid =
  fun projectee  -> match projectee with | Var _0 -> _0
let uu___is_Name: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Name _0 -> true | uu____462 -> false
let __proj__Name__item___0: term' -> FStar_Ident.lid =
  fun projectee  -> match projectee with | Name _0 -> _0
let uu___is_Projector: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Projector _0 -> true | uu____476 -> false
let __proj__Projector__item___0:
  term' -> (FStar_Ident.lid* FStar_Ident.ident) =
  fun projectee  -> match projectee with | Projector _0 -> _0
let uu___is_Construct: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Construct _0 -> true | uu____499 -> false
let __proj__Construct__item___0:
  term' -> (FStar_Ident.lid* (term* imp) Prims.list) =
  fun projectee  -> match projectee with | Construct _0 -> _0
let uu___is_Abs: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Abs _0 -> true | uu____529 -> false
let __proj__Abs__item___0: term' -> (pattern Prims.list* term) =
  fun projectee  -> match projectee with | Abs _0 -> _0
let uu___is_App: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | App _0 -> true | uu____553 -> false
let __proj__App__item___0: term' -> (term* term* imp) =
  fun projectee  -> match projectee with | App _0 -> _0
let uu___is_Let: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Let _0 -> true | uu____580 -> false
let __proj__Let__item___0:
  term' -> (let_qualifier* (pattern* term) Prims.list* term) =
  fun projectee  -> match projectee with | Let _0 -> _0
let uu___is_LetOpen: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | LetOpen _0 -> true | uu____612 -> false
let __proj__LetOpen__item___0: term' -> (FStar_Ident.lid* term) =
  fun projectee  -> match projectee with | LetOpen _0 -> _0
let uu___is_Seq: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Seq _0 -> true | uu____632 -> false
let __proj__Seq__item___0: term' -> (term* term) =
  fun projectee  -> match projectee with | Seq _0 -> _0
let uu___is_If: term' -> Prims.bool =
  fun projectee  -> match projectee with | If _0 -> true | uu____653 -> false
let __proj__If__item___0: term' -> (term* term* term) =
  fun projectee  -> match projectee with | If _0 -> _0
let uu___is_Match: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Match _0 -> true | uu____681 -> false
let __proj__Match__item___0:
  term' -> (term* (pattern* term Prims.option* term) Prims.list) =
  fun projectee  -> match projectee with | Match _0 -> _0
let uu___is_TryWith: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | TryWith _0 -> true | uu____721 -> false
let __proj__TryWith__item___0:
  term' -> (term* (pattern* term Prims.option* term) Prims.list) =
  fun projectee  -> match projectee with | TryWith _0 -> _0
let uu___is_Ascribed: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Ascribed _0 -> true | uu____758 -> false
let __proj__Ascribed__item___0: term' -> (term* term* term Prims.option) =
  fun projectee  -> match projectee with | Ascribed _0 -> _0
let uu___is_Record: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Record _0 -> true | uu____788 -> false
let __proj__Record__item___0:
  term' -> (term Prims.option* (FStar_Ident.lid* term) Prims.list) =
  fun projectee  -> match projectee with | Record _0 -> _0
let uu___is_Project: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Project _0 -> true | uu____820 -> false
let __proj__Project__item___0: term' -> (term* FStar_Ident.lid) =
  fun projectee  -> match projectee with | Project _0 -> _0
let uu___is_Product: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Product _0 -> true | uu____841 -> false
let __proj__Product__item___0: term' -> (binder Prims.list* term) =
  fun projectee  -> match projectee with | Product _0 -> _0
let uu___is_Sum: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Sum _0 -> true | uu____865 -> false
let __proj__Sum__item___0: term' -> (binder Prims.list* term) =
  fun projectee  -> match projectee with | Sum _0 -> _0
let uu___is_QForall: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | QForall _0 -> true | uu____892 -> false
let __proj__QForall__item___0:
  term' -> (binder Prims.list* term Prims.list Prims.list* term) =
  fun projectee  -> match projectee with | QForall _0 -> _0
let uu___is_QExists: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | QExists _0 -> true | uu____928 -> false
let __proj__QExists__item___0:
  term' -> (binder Prims.list* term Prims.list Prims.list* term) =
  fun projectee  -> match projectee with | QExists _0 -> _0
let uu___is_Refine: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Refine _0 -> true | uu____960 -> false
let __proj__Refine__item___0: term' -> (binder* term) =
  fun projectee  -> match projectee with | Refine _0 -> _0
let uu___is_NamedTyp: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | NamedTyp _0 -> true | uu____980 -> false
let __proj__NamedTyp__item___0: term' -> (FStar_Ident.ident* term) =
  fun projectee  -> match projectee with | NamedTyp _0 -> _0
let uu___is_Paren: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Paren _0 -> true | uu____998 -> false
let __proj__Paren__item___0: term' -> term =
  fun projectee  -> match projectee with | Paren _0 -> _0
let uu___is_Requires: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Requires _0 -> true | uu____1013 -> false
let __proj__Requires__item___0: term' -> (term* Prims.string Prims.option) =
  fun projectee  -> match projectee with | Requires _0 -> _0
let uu___is_Ensures: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Ensures _0 -> true | uu____1037 -> false
let __proj__Ensures__item___0: term' -> (term* Prims.string Prims.option) =
  fun projectee  -> match projectee with | Ensures _0 -> _0
let uu___is_Labeled: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Labeled _0 -> true | uu____1061 -> false
let __proj__Labeled__item___0: term' -> (term* Prims.string* Prims.bool) =
  fun projectee  -> match projectee with | Labeled _0 -> _0
let uu___is_Assign: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Assign _0 -> true | uu____1084 -> false
let __proj__Assign__item___0: term' -> (FStar_Ident.ident* term) =
  fun projectee  -> match projectee with | Assign _0 -> _0
let uu___is_Discrim: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Discrim _0 -> true | uu____1102 -> false
let __proj__Discrim__item___0: term' -> FStar_Ident.lid =
  fun projectee  -> match projectee with | Discrim _0 -> _0
let uu___is_Attributes: term' -> Prims.bool =
  fun projectee  ->
    match projectee with | Attributes _0 -> true | uu____1115 -> false
let __proj__Attributes__item___0: term' -> term Prims.list =
  fun projectee  -> match projectee with | Attributes _0 -> _0
let uu___is_Variable: binder' -> Prims.bool =
  fun projectee  ->
    match projectee with | Variable _0 -> true | uu____1142 -> false
let __proj__Variable__item___0: binder' -> FStar_Ident.ident =
  fun projectee  -> match projectee with | Variable _0 -> _0
let uu___is_TVariable: binder' -> Prims.bool =
  fun projectee  ->
    match projectee with | TVariable _0 -> true | uu____1154 -> false
let __proj__TVariable__item___0: binder' -> FStar_Ident.ident =
  fun projectee  -> match projectee with | TVariable _0 -> _0
let uu___is_Annotated: binder' -> Prims.bool =
  fun projectee  ->
    match projectee with | Annotated _0 -> true | uu____1168 -> false
let __proj__Annotated__item___0: binder' -> (FStar_Ident.ident* term) =
  fun projectee  -> match projectee with | Annotated _0 -> _0
let uu___is_TAnnotated: binder' -> Prims.bool =
  fun projectee  ->
    match projectee with | TAnnotated _0 -> true | uu____1188 -> false
let __proj__TAnnotated__item___0: binder' -> (FStar_Ident.ident* term) =
  fun projectee  -> match projectee with | TAnnotated _0 -> _0
let uu___is_NoName: binder' -> Prims.bool =
  fun projectee  ->
    match projectee with | NoName _0 -> true | uu____1206 -> false
let __proj__NoName__item___0: binder' -> term =
  fun projectee  -> match projectee with | NoName _0 -> _0
let uu___is_PatWild: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatWild  -> true | uu____1233 -> false
let uu___is_PatConst: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatConst _0 -> true | uu____1238 -> false
let __proj__PatConst__item___0: pattern' -> FStar_Const.sconst =
  fun projectee  -> match projectee with | PatConst _0 -> _0
let uu___is_PatApp: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatApp _0 -> true | uu____1253 -> false
let __proj__PatApp__item___0: pattern' -> (pattern* pattern Prims.list) =
  fun projectee  -> match projectee with | PatApp _0 -> _0
let uu___is_PatVar: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatVar _0 -> true | uu____1277 -> false
let __proj__PatVar__item___0:
  pattern' -> (FStar_Ident.ident* arg_qualifier Prims.option) =
  fun projectee  -> match projectee with | PatVar _0 -> _0
let uu___is_PatName: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatName _0 -> true | uu____1298 -> false
let __proj__PatName__item___0: pattern' -> FStar_Ident.lid =
  fun projectee  -> match projectee with | PatName _0 -> _0
let uu___is_PatTvar: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatTvar _0 -> true | uu____1313 -> false
let __proj__PatTvar__item___0:
  pattern' -> (FStar_Ident.ident* arg_qualifier Prims.option) =
  fun projectee  -> match projectee with | PatTvar _0 -> _0
let uu___is_PatList: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatList _0 -> true | uu____1335 -> false
let __proj__PatList__item___0: pattern' -> pattern Prims.list =
  fun projectee  -> match projectee with | PatList _0 -> _0
let uu___is_PatTuple: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatTuple _0 -> true | uu____1353 -> false
let __proj__PatTuple__item___0: pattern' -> (pattern Prims.list* Prims.bool)
  = fun projectee  -> match projectee with | PatTuple _0 -> _0
let uu___is_PatRecord: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatRecord _0 -> true | uu____1377 -> false
let __proj__PatRecord__item___0:
  pattern' -> (FStar_Ident.lid* pattern) Prims.list =
  fun projectee  -> match projectee with | PatRecord _0 -> _0
let uu___is_PatAscribed: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatAscribed _0 -> true | uu____1400 -> false
let __proj__PatAscribed__item___0: pattern' -> (pattern* term) =
  fun projectee  -> match projectee with | PatAscribed _0 -> _0
let uu___is_PatOr: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatOr _0 -> true | uu____1419 -> false
let __proj__PatOr__item___0: pattern' -> pattern Prims.list =
  fun projectee  -> match projectee with | PatOr _0 -> _0
let uu___is_PatOp: pattern' -> Prims.bool =
  fun projectee  ->
    match projectee with | PatOp _0 -> true | uu____1434 -> false
...
let compile_op: Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___81_3412 =
        match uu___81_3412 with
        | '&' -> "Amp"
        | '@' -> "At"
        | '+' -> "Plus"
...
let string_of_let_qualifier: let_qualifier -> Prims.string =
  fun uu___82_3425  ->
    match uu___82_3425 with
    | NoLetQualifier  -> ""
    | Rec  -> "rec"
    | Mutable  -> "mutable"
let to_string_l sep f l =
  let uu____3450 = FStar_List.map f l in FStar_String.concat sep uu____3450
let imp_to_string: imp -> Prims.string =
  fun uu___83_3454  ->
    match uu___83_3454 with | Hash  -> "#" | uu____3455 -> ""
let rec term_to_string: term -> Prims.string =
  fun x  ->
    match x.tm with
    | Wild  -> "_"
    | Requires (t,uu____3466) ->
        let uu____3469 = term_to_string t in
        FStar_Util.format1 "(requires %s)" uu____3469
    | Ensures (t,uu____3471) ->
        let uu____3474 = term_to_string t in
        FStar_Util.format1 "(ensures %s)" uu____3474
    | Labeled (t,l,uu____3477) ->
        let uu____3478 = term_to_string t in
        FStar_Util.format2 "(labeled %s %s)" l uu____3478
    ...
    | Op (s,xs) ->
        ...
        FStar_Util.format2 "%s(%s)" s uu____3484
        ...
        let uu____3498 =
          to_string_l " "
            (fun uu____3501  ->
               ...
               | (a,imp) ->
                   let uu____3506 = term_to_string a in
                   FStar_Util.format2 "%s%s" (imp_to_string imp) uu____3506)
            args in
        FStar_Util.format2 "(%s %s)" l.FStar_Ident.str uu____3498
    | Abs (pats,t) ->
        let uu____3511 = to_string_l " " pat_to_string pats in
        let uu____3512 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "(fun %s -> %s)" uu____3511 uu____3512
    | App (t1,t2,imp) ->
        let uu____3516 = FStar_All.pipe_right t1 term_to_string in
        let uu____3517 = FStar_All.pipe_right t2 term_to_string in
        FStar_Util.format3 "%s %s%s" uu____3516 (imp_to_string imp)
          uu____3517
    | Let (Rec ,lbs,body) ->
        let uu____3526 =
          to_string_l " and "
            (fun uu____3529  ->
               ...
               | (p,b) ->
                   let uu____3534 = FStar_All.pipe_right p pat_to_string in
                   let uu____3535 = FStar_All.pipe_right b term_to_string in
                   FStar_Util.format2 "%s=%s" uu____3534 uu____3535) lbs in
        let uu____3536 = FStar_All.pipe_right body term_to_string in
        FStar_Util.format2 "let rec %s in %s" uu____3526 uu____3536
    | Let (q,(pat,tm)::[],body) ->
        let uu____3548 = FStar_All.pipe_right pat pat_to_string in
        let uu____3549 = FStar_All.pipe_right tm term_to_string in
        let uu____3550 = FStar_All.pipe_right body term_to_string in
        FStar_Util.format4 "let %s %s = %s in %s" (string_of_let_qualifier q)
          uu____3548 uu____3549 uu____3550
    | Seq (t1,t2) ->
        let uu____3553 = FStar_All.pipe_right t1 term_to_string in
        let uu____3554 = FStar_All.pipe_right t2 term_to_string in
        FStar_Util.format2 "%s; %s" uu____3553 uu____3554
    | If (t1,t2,t3) ->
        let uu____3558 = FStar_All.pipe_right t1 term_to_string in
        let uu____3559 = FStar_All.pipe_right t2 term_to_string in
        let uu____3560 = FStar_All.pipe_right t3 term_to_string in
        FStar_Util.format3 "if %s then %s else %s" uu____3558 uu____3559
          uu____3560
    | Match (t,branches) ->
        let uu____3573 = FStar_All.pipe_right t term_to_string in
        let uu____3574 =
          to_string_l " | "
            (fun uu____3579  ->
               ...
               | (p,w,e) ->
                   ...
                   let uu____3590 =
                     ...
                     | None  -> ""
                     | Some e1 ->
                         let uu____3592 = term_to_string e1 in
                         FStar_Util.format1 "when %s" uu____3592 in
                   let uu____3593 = FStar_All.pipe_right e term_to_string in
                   FStar_Util.format3 "%s %s -> %s" uu____3589 uu____3590
                     uu____3593) branches in
        FStar_Util.format2 "match %s with %s" uu____3573 uu____3574
    | Ascribed (t1,t2,None ) ->
        let uu____3597 = FStar_All.pipe_right t1 term_to_string in
        let uu____3598 = FStar_All.pipe_right t2 term_to_string in
        FStar_Util.format2 "(%s : %s)" uu____3597 uu____3598
    | Ascribed (t1,t2,Some tac) ->
        let uu____3603 = FStar_All.pipe_right t1 term_to_string in
        let uu____3604 = FStar_All.pipe_right t2 term_to_string in
        let uu____3605 = FStar_All.pipe_right tac term_to_string in
        FStar_Util.format3 "(%s : %s by %s)" uu____3603 uu____3604 uu____3605
    | Record (Some e,fields) ->
        let uu____3615 = FStar_All.pipe_right e term_to_string in
        let uu____3616 =
          to_string_l " "
            (fun uu____3619  ->
               match uu____3619 with
               | (l,e1) ->
                   let uu____3624 = FStar_All.pipe_right e1 term_to_string in
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____3624)
            fields in
        FStar_Util.format2 "{%s with %s}" uu____3615 uu____3616
    | Record (None ,fields) ->
        let uu____3633 =
          to_string_l " "
            (fun uu____3636  ->
               ...
               | (l,e) ->
                   let uu____3641 = FStar_All.pipe_right e term_to_string in
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____3641)
            fields in
        FStar_Util.format1 "{%s}" uu____3633
    | Project (e,l) ->
        let uu____3644 = FStar_All.pipe_right e term_to_string in
        FStar_Util.format2 "%s.%s" uu____3644 l.FStar_Ident.str
    ...
    | Product (b::[],t) when x.level = Type_level ->
        let uu____3658 = FStar_All.pipe_right b binder_to_string in
        let uu____3659 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s -> %s" uu____3658 uu____3659
    | Product (b::[],t) when x.level = Kind ->
        let uu____3663 = FStar_All.pipe_right b binder_to_string in
        let uu____3664 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s => %s" uu____3663 uu____3664
    | Sum (binders,t) ->
        let uu____3669 =
          let uu____3670 =
            FStar_All.pipe_right binders (FStar_List.map binder_to_string) in
          FStar_All.pipe_right uu____3670 (FStar_String.concat " * ") in
        let uu____3675 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s * %s" uu____3669 uu____3675
    | QForall (bs,pats,t) ->
        let uu____3685 = to_string_l " " binder_to_string bs in
        let uu____3686 =
          to_string_l " \\/ " (to_string_l "; " term_to_string) pats in
        let uu____3688 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format3 "forall %s.{:pattern %s} %s" uu____3685 uu____3686
          uu____3688
    | QExists (bs,pats,t) ->
        ...
        FStar_Util.format3 "exists %s.{:pattern %s} %s" uu____3698 uu____3699
          uu____3701
    | Refine (b,t) ->
        let uu____3704 = FStar_All.pipe_right b binder_to_string in
        let uu____3705 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s:{%s}" uu____3704 uu____3705
    | NamedTyp (x1,t) ->
        let uu____3708 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s:%s" x1.FStar_Ident.idText uu____3708
    | Paren t ->
        let uu____3710 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format1 "(%s)" uu____3710
    | Product (bs,t) ->
        let uu____3715 =
          let uu____3716 =
            FStar_All.pipe_right bs (FStar_List.map binder_to_string) in
          FStar_All.pipe_right uu____3716 (FStar_String.concat ",") in
        let uu____3721 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "Unidentified product: [%s] %s" uu____3715
          uu____3721
    | t -> "_"
  ...
  fun x  ->
    let s =
      ...
      | TAnnotated (i,t)|Annotated (i,t) ->
          ...
          FStar_Util.format2 "%s:%s" i.FStar_Ident.idText uu____3729
      | NoName t -> FStar_All.pipe_right t term_to_string in
    let uu____3731 = aqual_to_string x.aqual in
    FStar_Util.format2 "%s%s" uu____3731 s
and aqual_to_string: aqual -> Prims.string =
  fun uu___84_3732  ->
    match uu___84_3732 with
    | Some (Equality ) -> "$"
    | Some (Implicit ) -> "#"
    | uu____3733 -> ""
and pat_to_string: pattern -> Prims.string =
  fun x  ->
    ...
    | PatApp (p,ps) ->
        let uu____3740 = FStar_All.pipe_right p pat_to_string in
        let uu____3741 = to_string_l " " pat_to_string ps in
        FStar_Util.format2 "(%s %s)" uu____3740 uu____3741
    | PatTvar (i,aq)|PatVar (i,aq) ->
        let uu____3748 = aqual_to_string aq in
        FStar_Util.format2 "%s%s" uu____3748 i.FStar_Ident.idText
    | PatName l -> l.FStar_Ident.str
    | PatList l ->
        let uu____3752 = to_string_l "; " pat_to_string l in
        FStar_Util.format1 "[%s]" uu____3752
    | PatTuple (l,false ) ->
        let uu____3756 = to_string_l ", " pat_to_string l in
        FStar_Util.format1 "(%s)" uu____3756
    | PatTuple (l,true ) ->
        let uu____3760 = to_string_l ", " pat_to_string l in
        FStar_Util.format1 "(|%s|)" uu____3760
    | PatRecord l ->
        let uu____3765 =
          to_string_l "; "
            (fun uu____3768  ->
               ...
               | (f,e) ->
                   let uu____3773 = FStar_All.pipe_right e pat_to_string in
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____3773) l in
        FStar_Util.format1 "{%s}" uu____3765
    | PatOr l -> to_string_l "|\n " pat_to_string l
    | PatOp op -> FStar_Util.format1 "(%s)" op
    | PatAscribed (p,t) ->
        let uu____3779 = FStar_All.pipe_right p pat_to_string in
        let uu____3780 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "(%s:%s)" uu____3779 uu____3780
let rec head_id_of_pat: pattern -> FStar_Ident.lid Prims.list =
  fun p  ->
    match p.pat with
    | PatName l -> [l]
    | PatVar (i,uu____3788) ->
        let uu____3791 = FStar_Ident.lid_of_ids [i] in [uu____3791]
    | PatApp (p1,uu____3793) -> head_id_of_pat p1
    | PatAscribed (p1,uu____3797) -> head_id_of_pat p1
    | uu____3798 -> []
let lids_of_let defs =
  FStar_All.pipe_right defs
    (FStar_List.collect
       (fun uu____3819  ->
          match uu____3819 with | (p,uu____3824) -> head_id_of_pat p))
let id_of_tycon: tycon -> Prims.string =
  fun uu___85_3827  ->
    match uu___85_3827 with
    | TyconAbstract (i,_,_)
  ...
  fun d  ->
    ...
    | ModuleAbbrev (i,l) ->
        FStar_Util.format2 "module %s = %s" i.FStar_Ident.idText
          l.FStar_Ident.str
    | TopLevelLet (uu____3868,pats) ->
        let uu____3876 =
          let uu____3877 =
            let uu____3879 = lids_of_let pats in
            FStar_All.pipe_right uu____3879
              (FStar_List.map (fun l  -> l.FStar_Ident.str)) in
          FStar_All.pipe_right uu____3877 (FStar_String.concat ", ") in
        Prims.strcat "let " uu____3876
    | Main uu____3885 -> "main ..."
    | Assume (i,uu____3887) -> Prims.strcat "assume " i.FStar_Ident.idText
    | Tycon (uu____3888,tys) ->
        let uu____3898 =
          let uu____3899 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3909  ->
                    match uu____3909 with | (x,uu____3914) -> id_of_tycon x)) in
          FStar_All.pipe_right uu____3899 (FStar_String.concat ", ") in
        Prims.strcat "type " uu____3898
    | Val (i,uu____3919) -> Prims.strcat "val " i.FStar_Ident.idText
    | Exception (i,uu____3921) ->
        Prims.strcat "exception " i.FStar_Ident.idText
    | NewEffect (DefineEffect (i,_,_,_))|NewEffect (RedefineEffect (i,_,_))
        -> Prims.strcat "new_effect " i.FStar_Ident.idText
    | SubEffect uu____3933 -> "sub_effect"
    | Pragma uu____3934 -> "pragma"
    | Fsdoc uu____3935 -> "fsdoc"
let modul_to_string: modul -> Prims.string =
  fun m  ->
    ...
    | Module (_,decls)|Interface (_,decls,_) ->
        ...
        FStar_All.pipe_right uu____3947 (FStar_String.concat "\n")
let error msg tm r =
