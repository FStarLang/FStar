      ...
      fun r  ->
        fun l  ->
          let t1 =
            ...
            | uu____2588 -> Op ((FStar_Ident.mk_ident ("-", rminus)), [t])
             in
          mk_term t1 r l
  ...
  then
    (FStar_Errors.warn r "Focusing on only some cases";
     (let focussed =
      ...
      let uu____3006 = let uu____3012 = mkWildAdmitMagic r  in [uu____3012]
         in
          ...
          to_string_l " and "
            (fun uu____3612  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____3617 uu____3618) lbs
           in
               ...
               | (p,w,e) ->
                   ...
                   let uu____3673 =
                     ...
                     | Some e1 ->
                         ...
                         FStar_Util.format1 "when %s" uu____3675
                      in
          ...
          to_string_l "; "
            (fun uu____3851  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____3856) l
           in
        ...
        let uu____3981 =
          let uu____3982 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3992  ->
                    match uu____3992 with | (x,uu____3997) -> id_of_tycon x))
             in
