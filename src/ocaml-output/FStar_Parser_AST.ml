...
let (compile_op :
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___227_6187 =
          match uu___227_6187 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___229_6334  ->
    match uu___229_6334 with | Hash  -> "#" | uu____6335 -> ""
