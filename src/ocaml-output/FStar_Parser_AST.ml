...
let (compile_op :
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___359_6167 =
          match uu___359_6167 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___361_6314  ->
    match uu___361_6314 with | Hash  -> "#" | uu____6315 -> ""
