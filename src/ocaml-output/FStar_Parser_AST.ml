...
let uu____2791 = (FStar_Util.format1 "Invalid identifer \'%s\'; expected a symbol that begins with a lower-case character" id.FStar_Ident.idText)
in ((uu____2791), (id.FStar_Ident.idRange)))
in FStar_Errors.Error (uu____2788))
in (FStar_Pervasives.raise uu____2787))
end)))
...
let uu____2823 = (FStar_Util.format1 "At most one %s is allowed on declarations" s)
in ((uu____2823), (r)))
in FStar_Errors.Error (uu____2820))
in (FStar_Pervasives.raise uu____2819))
end))
...
let uu____2841 = (FStar_List.choose (fun uu___74_2845 -> (match (uu___74_2845) with
| Doc (d1) -> begin
...
in (at_most_one "fsdoc" r uu____2841))
in (

let attributes_ = (

let uu____2852 = (FStar_List.choose (fun uu___75_2858 -> (match (uu___75_2858) with
...
in (at_most_one "attribute set" r uu____2852))
in (

let attributes_1 = (FStar_Util.dflt [] attributes_)
in (

let qualifiers = (FStar_List.choose (fun uu___76_2874 -> (match (uu___76_2874) with
| Qualifier (q) -> begin
...
let uu____3003 = (FStar_Ident.lid_of_ids ((x)::[]))
in Var (uu____3003))
in (mk_term uu____3002 r1 Expr))
in ((uu____3001), (branches)))
in Match (uu____2993))
in (mk_term uu____2992 r2 Expr))
in ((((mk_pattern (PatVar (((x), (FStar_Pervasives_Native.None)))) r1))::[]), (uu____2991)))
in Abs (uu____2987))
in (mk_term uu____2986 r2 Expr))))


let un_function : pattern  ->  term  ->  (pattern * term) FStar_Pervasives_Native.option = (fun p tm -> (match (((p.pat), (tm.tm))) with
| (PatVar (uu____3025), Abs (pats, body)) -> begin
...
let uu____3049 = (FStar_Ident.path_of_lid lid)
in (FStar_Ident.lid_of_path uu____3049 r)))
...
| uu____3186 -> begin
(FStar_List.fold_left (fun t1 uu____3194 -> (match (uu____3194) with
| (a, imp) -> begin
...
let uu____3209 = ((FStar_Parser_Const.tset_empty), (FStar_Parser_Const.tset_singleton), (FStar_Parser_Const.tset_union))
...
let uu____3266 = (FStar_List.map (fun a -> ((a), (Nothing))) args)
in ((s), (uu____3266)))
in Construct (uu____3260))
in (mk_term uu____3259 r Un))
end
| uu____3277 -> begin
...
let uu____3305 = (mkAdmitMagic r)
in (((mk_pattern PatWild r)), (FStar_Pervasives_Native.None), (uu____3305))))
...
let uu____3364 = (FStar_List.filter FStar_Pervasives_Native.fst branches)
in (FStar_All.pipe_right uu____3364 (FStar_List.map FStar_Pervasives_Native.snd)))
in (

let uu____3408 = (

let uu____3414 = (mkWildAdmitMagic r)
in (uu____3414)::[])
in (FStar_List.append focussed uu____3408)));
)
end
| uu____3431 -> begin
...
(FStar_List.map (fun uu____3506 -> (match (uu____3506) with
| (f, lb) -> begin
(match (f) with
| true -> begin
lb
...
let uu____3522 = (mkAdmitMagic r)
in (((FStar_Pervasives_Native.fst lb)), (uu____3522)))
end)
end)) lbs);
)
end
...
let uu____3554 = (FStar_List.map (fun a -> ((a), (FsTypApp))) args)
in (mkApp t uu____3554 r)))
...
let uu____3579 = (FStar_List.map (fun x -> ((x), (Nothing))) args)
in (mkApp (mk_term (Name (cons1)) r Expr) uu____3579 r))))
...
let uu____3604 = (FStar_List.map (fun x -> ((x), (Nothing))) args)
in (mkApp (mk_term (Name (cons1)) r Expr) uu____3604 r))))
...
let uu____3680 = (FStar_Ident.lid_of_ids ((x)::[]))
in Var (uu____3680))
in (mk_term uu____3679 phi.range Formula))
in (
...
let uu____3694 = (FStar_Ident.lid_of_path (("False")::[]) phi.range)
in Name (uu____3694))
in (mk_term uu____3693 phi.range Formula))
in (((mk_pattern PatWild phi.range)), (FStar_Pervasives_Native.None), (uu____3692)))
...
| Refine ({b = Annotated (x, t); brange = uu____3738; blevel = uu____3739; aqual = uu____3740}, t') -> begin
...
let uu____3862 = (mk_decl (Pragma (LightOff)) light_range [])
in (uu____3862)::ds1)
end
| uu____3863 -> begin
ds1
...
let uu____3870 = (FStar_List.tl ms)
in (match (uu____3870) with
| (Module (m', uu____3873))::uu____3874 -> begin
(

let msg = "Support for more than one module in a file is deprecated"
in (

let uu____3879 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid m'))
...
let ds2 = (d)::ds1
in ((FStar_List.iter (fun uu___77_3894 -> (match (uu___77_3894) with
| {d = TopLevelModule (uu____3895); drange = r; doc = uu____3897; quals = uu____3898; attrs = uu____3899} -> begin
...
let name_of_char = (fun uu___78_3915 -> (match (uu___78_3915) with
| '&' -> begin
"Amp"
end
| '@' -> begin
...
let uu____3921 = (FStar_String.list_of_string s)
in (FStar_List.map name_of_char uu____3921))
in (FStar_String.concat "_" uu____3919))
in (Prims.strcat "op_" uu____3918))
end)))
...
let string_of_fsdoc : (Prims.string * (Prims.string * Prims.string) Prims.list)  ->  Prims.string = (fun uu____3935 -> (match (uu____3935) with
| (comment, keywords) -> begin
(

let uu____3949 = (

let uu____3950 = (FStar_List.map (fun uu____3957 -> (match (uu____3957) with
| (k, v1) -> begin
(Prims.strcat k (Prims.strcat "->" v1))
end)) keywords)
in (FStar_String.concat "," uu____3950))
in (Prims.strcat comment uu____3949))
end))


let string_of_let_qualifier : let_qualifier  ->  Prims.string = (fun uu___79_3965 -> (match (uu___79_3965) with
| NoLetQualifier -> begin
""
end
| Rec -> begin
...
let uu____3994 = (FStar_List.map f l)
in (FStar_String.concat sep uu____3994)))


let imp_to_string : imp  ->  Prims.string = (fun uu___80_3999 -> (match (uu___80_3999) with
| Hash -> begin
"#"
end
| uu____4000 -> begin
...
| Requires (t, uu____4011) -> begin
(

let uu____4014 = (term_to_string t)
in (FStar_Util.format1 "(requires %s)" uu____4014))
end
| Ensures (t, uu____4016) -> begin
(

let uu____4019 = (term_to_string t)
in (FStar_Util.format1 "(ensures %s)" uu____4019))
end
| Labeled (t, l, uu____4022) -> begin
(

let uu____4023 = (term_to_string t)
in (FStar_Util.format2 "(labeled %s %s)" l uu____4023))
end
| Const (c) -> begin
...
let uu____4030 = (FStar_List.map (fun x1 -> (FStar_All.pipe_right x1 term_to_string)) xs)
in (FStar_String.concat ", " uu____4030))
in (FStar_Util.format2 "%s(%s)" (FStar_Ident.text_of_id s) uu____4029))
end
| Tvar (id) -> begin
...
let uu____4046 = (to_string_l " " (fun uu____4053 -> (match (uu____4053) with
| (a, imp) -> begin
(

let uu____4058 = (term_to_string a)
in (FStar_Util.format2 "%s%s" (imp_to_string imp) uu____4058))
end)) args)
in (FStar_Util.format2 "(%s %s)" l.FStar_Ident.str uu____4046))
end
| Abs (pats, t) -> begin
(

let uu____4063 = (to_string_l " " pat_to_string pats)
in (

let uu____4064 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "(fun %s -> %s)" uu____4063 uu____4064)))
end
| App (t1, t2, imp) -> begin
(

let uu____4068 = (FStar_All.pipe_right t1 term_to_string)
in (

let uu____4069 = (FStar_All.pipe_right t2 term_to_string)
in (FStar_Util.format3 "%s %s%s" uu____4068 (imp_to_string imp) uu____4069)))
end
| Let (Rec, lbs, body) -> begin
(

let uu____4078 = (to_string_l " and " (fun uu____4086 -> (match (uu____4086) with
| (p, b) -> begin
(

let uu____4091 = (FStar_All.pipe_right p pat_to_string)
in (

let uu____4092 = (FStar_All.pipe_right b term_to_string)
in (FStar_Util.format2 "%s=%s" uu____4091 uu____4092)))
end)) lbs)
in (

let uu____4093 = (FStar_All.pipe_right body term_to_string)
in (FStar_Util.format2 "let rec %s in %s" uu____4078 uu____4093)))
end
| Let (q, ((pat, tm))::[], body) -> begin
(

let uu____4105 = (FStar_All.pipe_right pat pat_to_string)
in (

let uu____4106 = (FStar_All.pipe_right tm term_to_string)
in (

let uu____4107 = (FStar_All.pipe_right body term_to_string)
in (FStar_Util.format4 "let %s %s = %s in %s" (string_of_let_qualifier q) uu____4105 uu____4106 uu____4107))))
end
| Seq (t1, t2) -> begin
(

let uu____4110 = (FStar_All.pipe_right t1 term_to_string)
in (

let uu____4111 = (FStar_All.pipe_right t2 term_to_string)
in (FStar_Util.format2 "%s; %s" uu____4110 uu____4111)))
end
| If (t1, t2, t3) -> begin
(

let uu____4115 = (FStar_All.pipe_right t1 term_to_string)
in (

let uu____4116 = (FStar_All.pipe_right t2 term_to_string)
in (

let uu____4117 = (FStar_All.pipe_right t3 term_to_string)
in (FStar_Util.format3 "if %s then %s else %s" uu____4115 uu____4116 uu____4117))))
end
| Match (t, branches) -> begin
(

let uu____4130 = (FStar_All.pipe_right t term_to_string)
in (

let uu____4131 = (to_string_l " | " (fun uu____4143 -> (match (uu____4143) with
| (p, w, e) -> begin
(

let uu____4153 = (FStar_All.pipe_right p pat_to_string)
in (

let uu____4154 = (match (w) with
| FStar_Pervasives_Native.None -> begin
""
end
...
let uu____4156 = (term_to_string e1)
in (FStar_Util.format1 "when %s" uu____4156))
end)
in (

let uu____4157 = (FStar_All.pipe_right e term_to_string)
in (FStar_Util.format3 "%s %s -> %s" uu____4153 uu____4154 uu____4157))))
end)) branches)
in (FStar_Util.format2 "match %s with %s" uu____4130 uu____4131)))
end
| Ascribed (t1, t2, FStar_Pervasives_Native.None) -> begin
(

let uu____4161 = (FStar_All.pipe_right t1 term_to_string)
in (

let uu____4162 = (FStar_All.pipe_right t2 term_to_string)
in (FStar_Util.format2 "(%s : %s)" uu____4161 uu____4162)))
end
| Ascribed (t1, t2, FStar_Pervasives_Native.Some (tac)) -> begin
(

let uu____4167 = (FStar_All.pipe_right t1 term_to_string)
in (

let uu____4168 = (FStar_All.pipe_right t2 term_to_string)
in (

let uu____4169 = (FStar_All.pipe_right tac term_to_string)
in (FStar_Util.format3 "(%s : %s by %s)" uu____4167 uu____4168 uu____4169))))
end
| Record (FStar_Pervasives_Native.Some (e), fields) -> begin
(

let uu____4179 = (FStar_All.pipe_right e term_to_string)
in (

let uu____4180 = (to_string_l " " (fun uu____4187 -> (match (uu____4187) with
| (l, e1) -> begin
(

let uu____4192 = (FStar_All.pipe_right e1 term_to_string)
in (FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____4192))
end)) fields)
in (FStar_Util.format2 "{%s with %s}" uu____4179 uu____4180)))
end
| Record (FStar_Pervasives_Native.None, fields) -> begin
(

let uu____4201 = (to_string_l " " (fun uu____4208 -> (match (uu____4208) with
| (l, e) -> begin
(

let uu____4213 = (FStar_All.pipe_right e term_to_string)
in (FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____4213))
end)) fields)
in (FStar_Util.format1 "{%s}" uu____4201))
end
| Project (e, l) -> begin
(

let uu____4216 = (FStar_All.pipe_right e term_to_string)
in (FStar_Util.format2 "%s.%s" uu____4216 l.FStar_Ident.str))
end
| Product ([], t) -> begin
(term_to_string t)
end
...
let uu____4230 = (FStar_All.pipe_right b binder_to_string)
in (

let uu____4231 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s -> %s" uu____4230 uu____4231)))
end
| Product ((b)::[], t) when (x.level = Kind) -> begin
(

let uu____4235 = (FStar_All.pipe_right b binder_to_string)
in (

let uu____4236 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s => %s" uu____4235 uu____4236)))
end
| Sum (binders, t) -> begin
(
...
let uu____4242 = (FStar_All.pipe_right binders (FStar_List.map binder_to_string))
in (FStar_All.pipe_right uu____4242 (FStar_String.concat " * ")))
in (

let uu____4247 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s * %s" uu____4241 uu____4247)))
end
| QForall (bs, pats, t) -> begin
(

let uu____4257 = (to_string_l " " binder_to_string bs)
in (

let uu____4258 = (to_string_l " \\/ " (to_string_l "; " term_to_string) pats)
in (

let uu____4260 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format3 "forall %s.{:pattern %s} %s" uu____4257 uu____4258 uu____4260))))
end
| QExists (bs, pats, t) -> begin
(

let uu____4270 = (to_string_l " " binder_to_string bs)
in (

let uu____4271 = (to_string_l " \\/ " (to_string_l "; " term_to_string) pats)
in (

let uu____4273 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format3 "exists %s.{:pattern %s} %s" uu____4270 uu____4271 uu____4273))))
end
| Refine (b, t) -> begin
(

let uu____4276 = (FStar_All.pipe_right b binder_to_string)
in (

let uu____4277 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s:{%s}" uu____4276 uu____4277)))
end
| NamedTyp (x1, t) -> begin
(

let uu____4280 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s:%s" x1.FStar_Ident.idText uu____4280))
end
| Paren (t) -> begin
(

let uu____4282 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format1 "(%s)" uu____4282))
end
| Product (bs, t) -> begin
(
...
let uu____4288 = (FStar_All.pipe_right bs (FStar_List.map binder_to_string))
in (FStar_All.pipe_right uu____4288 (FStar_String.concat ",")))
in (

let uu____4293 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "Unidentified product: [%s] %s" uu____4287 uu____4293)))
end
| t -> begin
"_"
end))
...
let uu____4301 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s:%s" i.FStar_Ident.idText uu____4301))
end
| Annotated (i, t) -> begin
(

let uu____4304 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "%s:%s" i.FStar_Ident.idText uu____4304))
end
| NoName (t) -> begin
...
let uu____4306 = (aqual_to_string x.aqual)
in (FStar_Util.format2 "%s%s" uu____4306 s))))
and aqual_to_string : aqual  ->  Prims.string = (fun uu___81_4307 -> (match (uu___81_4307) with
...
let uu____4315 = (FStar_All.pipe_right p pat_to_string)
in (

let uu____4316 = (to_string_l " " pat_to_string ps)
in (FStar_Util.format2 "(%s %s)" uu____4315 uu____4316)))
end
| PatTvar (i, aq) -> begin
(

let uu____4321 = (aqual_to_string aq)
in (FStar_Util.format2 "%s%s" uu____4321 i.FStar_Ident.idText))
end
| PatVar (i, aq) -> begin
(

let uu____4326 = (aqual_to_string aq)
in (FStar_Util.format2 "%s%s" uu____4326 i.FStar_Ident.idText))
end
| PatName (l) -> begin
l.FStar_Ident.str
end
...
let uu____4330 = (to_string_l "; " pat_to_string l)
in (FStar_Util.format1 "[%s]" uu____4330))
end
| PatTuple (l, false) -> begin
(

let uu____4334 = (to_string_l ", " pat_to_string l)
in (FStar_Util.format1 "(%s)" uu____4334))
end
| PatTuple (l, true) -> begin
(

let uu____4338 = (to_string_l ", " pat_to_string l)
in (FStar_Util.format1 "(|%s|)" uu____4338))
end
| PatRecord (l) -> begin
(

let uu____4343 = (to_string_l "; " (fun uu____4350 -> (match (uu____4350) with
| (f, e) -> begin
(

let uu____4355 = (FStar_All.pipe_right e pat_to_string)
in (FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____4355))
end)) l)
in (FStar_Util.format1 "{%s}" uu____4343))
end
| PatOr (l) -> begin
(to_string_l "|\n " pat_to_string l)
end
...
let uu____4361 = (FStar_All.pipe_right p pat_to_string)
in (

let uu____4362 = (FStar_All.pipe_right t term_to_string)
in (FStar_Util.format2 "(%s:%s)" uu____4361 uu____4362)))
end))
...
| PatVar (i, uu____4371) -> begin
(

let uu____4374 = (FStar_Ident.lid_of_ids ((i)::[]))
in (uu____4374)::[])
end
| PatApp (p1, uu____4376) -> begin
(head_id_of_pat p1)
end
| PatAscribed (p1, uu____4380) -> begin
(head_id_of_pat p1)
end
| uu____4381 -> begin
[]
...
let lids_of_let = (fun defs -> (FStar_All.pipe_right defs (FStar_List.collect (fun uu____4407 -> (match (uu____4407) with
| (p, uu____4412) -> begin
(head_id_of_pat p)
end)))))


let id_of_tycon : tycon  ->  Prims.string = (fun uu___82_4416 -> (match (uu___82_4416) with
| TyconAbstract (i, uu____4418, uu____4419) -> begin
i.FStar_Ident.idText
end
| TyconAbbrev (i, uu____4425, uu____4426, uu____4427) -> begin
i.FStar_Ident.idText
end
| TyconRecord (i, uu____4433, uu____4434, uu____4435) -> begin
i.FStar_Ident.idText
end
| TyconVariant (i, uu____4451, uu____4452, uu____4453) -> begin
i.FStar_Ident.idText
end))
...
| TopLevelLet (uu____4481, pats) -> begin
(
...
let uu____4492 = (lids_of_let pats)
in (FStar_All.pipe_right uu____4492 (FStar_List.map (fun l -> l.FStar_Ident.str))))
in (FStar_All.pipe_right uu____4490 (FStar_String.concat ", ")))
in (Prims.strcat "let " uu____4489))
end
| Main (uu____4499) -> begin
"main ..."
end
| Assume (i, uu____4501) -> begin
(Prims.strcat "assume " i.FStar_Ident.idText)
end
| Tycon (uu____4502, tys) -> begin
(

let uu____4512 = (

let uu____4513 = (FStar_All.pipe_right tys (FStar_List.map (fun uu____4526 -> (match (uu____4526) with
| (x, uu____4531) -> begin
(id_of_tycon x)
end))))
in (FStar_All.pipe_right uu____4513 (FStar_String.concat ", ")))
in (Prims.strcat "type " uu____4512))
end
| Val (i, uu____4536) -> begin
(Prims.strcat "val " i.FStar_Ident.idText)
end
| Exception (i, uu____4538) -> begin
(Prims.strcat "exception " i.FStar_Ident.idText)
end
| NewEffect (DefineEffect (i, uu____4542, uu____4543, uu____4544)) -> begin
(Prims.strcat "new_effect " i.FStar_Ident.idText)
end
| NewEffect (RedefineEffect (i, uu____4550, uu____4551)) -> begin
(Prims.strcat "new_effect " i.FStar_Ident.idText)
end
| SubEffect (uu____4554) -> begin
"sub_effect"
end
| Pragma (uu____4555) -> begin
"pragma"
end
| Fsdoc (uu____4556) -> begin
"fsdoc"
end))


let modul_to_string : modul  ->  Prims.string = (fun m -> (match (m) with
| Module (uu____4561, decls) -> begin
(

let uu____4565 = (FStar_All.pipe_right decls (FStar_List.map decl_to_string))
in (FStar_All.pipe_right uu____4565 (FStar_String.concat "\n")))
end
| Interface (uu____4570, decls, uu____4572) -> begin
(

let uu____4575 = (FStar_All.pipe_right decls (FStar_List.map decl_to_string))
in (FStar_All.pipe_right uu____4575 (FStar_String.concat "\n")))
end))
...
let uu____4609 = (FStar_Util.substring tm1 (Prims.parse_int "0") (Prims.parse_int "77"))
in (Prims.strcat uu____4609 "..."))
end
| uu____4610 -> begin
tm1
end)
