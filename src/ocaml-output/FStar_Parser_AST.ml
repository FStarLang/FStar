...
let compile_op:
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___100_5038 =
          match uu___100_5038 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let imp_to_string: imp -> Prims.string =
  fun uu___102_5143  ->
    match uu___102_5143 with | Hash  -> "#" | uu____5144 -> ""
