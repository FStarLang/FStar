...
let (uu___is_Formula : level -> Prims.bool) =
  fun projectee -> match projectee with | Formula -> true | uu____30 -> false
type imp =
  | FsTypApp 
  | Hash 
  | UnivApp 
...
let (uu___is_UnivApp : imp -> Prims.bool) =
  fun projectee -> match projectee with | UnivApp -> true | uu____48 -> false
let (uu___is_Nothing : imp -> Prims.bool) =
  fun projectee -> match projectee with | Nothing -> true | uu____54 -> false
type arg_qualifier =
  | Implicit 
...
let (uu___is_Mutable : let_qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Mutable -> true | uu____86 -> false
type quote_kind =
  | Static 
  | Dynamic [@@deriving show]
let (uu___is_Static : quote_kind -> Prims.bool) =
  fun projectee -> match projectee with | Static -> true | uu____92 -> false
let (uu___is_Dynamic : quote_kind -> Prims.bool) =
  fun projectee -> match projectee with | Dynamic -> true | uu____98 -> false
type term' =
  | Wild 
...
let (uu___is_Var : term' -> Prims.bool) =
  fun projectee -> match projectee with | Var _0 -> true | uu____739 -> false
...
let (uu___is_Abs : term' -> Prims.bool) =
  fun projectee -> match projectee with | Abs _0 -> true | uu____857 -> false
let (__proj__Abs__item___0 :
  term' -> (pattern Prims.list, term) FStar_Pervasives_Native.tuple2) =
  fun projectee -> match projectee with | Abs _0 -> _0
let (uu___is_App : term' -> Prims.bool) =
  fun projectee -> match projectee with | App _0 -> true | uu____895 -> false
let (__proj__App__item___0 :
  term' -> (term, term, imp) FStar_Pervasives_Native.tuple3) =
  fun projectee -> match projectee with | App _0 -> _0
let (uu___is_Let : term' -> Prims.bool) =
  fun projectee -> match projectee with | Let _0 -> true | uu____947 -> false
...
let (uu___is_If : term' -> Prims.bool) =
  fun projectee -> match projectee with | If _0 -> true | uu____1125 -> false
...
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Noeq -> true | uu____2902 -> false
...
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Logic -> true | uu____2998 -> false
...
let (__proj__Splice__item___0 :
  decl' ->
    (FStar_Ident.ident Prims.list, term) FStar_Pervasives_Native.tuple2)
      ...
      fun decorations ->
        let doc1 =
          let uu____4178 =
            FStar_List.choose
              (fun uu___41_4183 ->
                 match uu___41_4183 with
                 | Doc d1 -> FStar_Pervasives_Native.Some d1
                 | uu____4187 -> FStar_Pervasives_Native.None) decorations in
          at_most_one "fsdoc" r uu____4178 in
        let attributes_ =
          let uu____4193 =
            FStar_List.choose
              (fun uu___42_4202 ->
                 match uu___42_4202 with
                 | DeclAttributes a -> FStar_Pervasives_Native.Some a
                 | uu____4212 -> FStar_Pervasives_Native.None) decorations in
          at_most_one "attribute set" r uu____4193 in
        let attributes_1 = FStar_Util.dflt [] attributes_ in
        let qualifiers =
          FStar_List.choose
            (fun uu___43_4227 ->
               match uu___43_4227 with
               | Qualifier q -> FStar_Pervasives_Native.Some q
               | uu____4231 -> FStar_Pervasives_Native.None) decorations in
...
let focusAttrLetBindings :
  'Auu____5313 'Auu____5314 .
    ('Auu____5313,
      (Prims.bool, ('Auu____5314, term) FStar_Pervasives_Native.tuple2)
        FStar_Pervasives_Native.tuple2)
      FStar_Pervasives_Native.tuple2 Prims.list ->
      FStar_Range.range ->
  ...
  fun lbs ->
    fun r ->
      let should_filter =
        FStar_Util.for_some
          (fun uu____5380 ->
             match uu____5380 with | (attr, (focus, uu____5395)) -> focus)
          lbs in
      if should_filter
      then
        (FStar_Errors.log_issue r
                      ...
                      (match pat.pat with
                       ...
                       | uu____5772 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____5776 =
                                 let uu____5777 = FStar_Ident.lid_of_ids [x] in
                                 Var uu____5777 in
                             ...
                             let otherwise_branch =
                               ...
                               ((mk_pattern PatWild phi.range),
                                 FStar_Pervasives_Native.None, uu____5798) in
                             mk_term
...
let (compile_op :
  ...
  fun arity ->
    fun s ->
      fun r ->
        let name_of_char uu___45_6090 =
          match uu___45_6090 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let (imp_to_string : imp -> Prims.string) =
  fun uu___47_6237 ->
    match uu___47_6237 with | Hash -> "#" | uu____6238 -> ""
          ...
          to_string_l " "
            (fun uu____6425 ->
               ...
               | (a1, (p1, b1)) ->
                   ...
                   let uu____6455 = FStar_All.pipe_right b1 term_to_string in
        ...
        let uu____6617 =
          to_string_l " "
            (fun uu____6626 ->
               ...
               | (l, e1) ->
                   let uu____6633 = FStar_All.pipe_right e1 term_to_string in
          ...
          to_string_l "; "
            (fun uu____6851 ->
               ...
               | (f, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____6858) l in
        ...
        let uu____7154 =
          let uu____7155 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____7177 ->
                    match uu____7177 with | (x, uu____7185) -> id_of_tycon x)) in
