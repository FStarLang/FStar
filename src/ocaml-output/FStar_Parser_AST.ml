...
let uu____4178 = (FStar_List.choose (fun uu___38_4183 -> (match (uu___38_4183) with
| Doc (d1) -> begin
...
let uu____4193 = (FStar_List.choose (fun uu___39_4202 -> (match (uu___39_4202) with
...
let qualifiers = (FStar_List.choose (fun uu___40_4227 -> (match (uu___40_4227) with
| Qualifier (q) -> begin
...
let ds2 = (d)::ds1
in ((FStar_List.iter (fun uu___41_6058 -> (match (uu___41_6058) with
...
let name_of_char = (fun uu___42_6090 -> (match (uu___42_6090) with
| 38 (*&*) -> begin
"Amp"
end
| 64 (*@*) -> begin
...
let string_of_let_qualifier : let_qualifier  ->  Prims.string = (fun uu___43_6196 -> (match (uu___43_6196) with
| NoLetQualifier -> begin
""
end
| Rec -> begin
...
let imp_to_string : imp  ->  Prims.string = (fun uu___44_6237 -> (match (uu___44_6237) with
| Hash -> begin
"#"
end
| uu____6238 -> begin
...
and aqual_to_string : aqual  ->  Prims.string = (fun uu___45_6792 -> (match (uu___45_6792) with
...
and attrs_opt_to_string : term Prims.list FStar_Pervasives_Native.option  ->  Prims.string = (fun uu___46_6890 -> (match (uu___46_6890) with
| FStar_Pervasives_Native.None -> begin
""
end
...
let id_of_tycon : tycon  ->  Prims.string = (fun uu___47_6998 -> (match (uu___47_6998) with
