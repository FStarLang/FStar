...
let compile_op:
  ...
  fun arity  ->
    fun s  ->
      fun r  ->
        let name_of_char uu___85_5038 =
          match uu___85_5038 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
...
let imp_to_string: imp -> Prims.string =
  fun uu___87_5143  ->
    match uu___87_5143 with | Hash  -> "#" | uu____5144 -> ""
