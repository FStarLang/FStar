...
let compile_op: Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___112_3464 =
...
let imp_to_string: imp -> Prims.string =
  fun uu___114_3537  ->
    match uu___114_3537 with | Hash  -> "#" | uu____3538 -> ""
