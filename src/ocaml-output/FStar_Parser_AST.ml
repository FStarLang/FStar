...
let (uu___is_Formula : level -> Prims.bool) =
  fun projectee -> match projectee with | Formula -> true | uu____70 -> false
type let_qualifier =
  | NoLetQualifier 
  | Rec 
...
let (uu___is_Static : quote_kind -> Prims.bool) =
  fun projectee -> match projectee with | Static -> true | uu____103 -> false
...
let (uu___is_Var : term' -> Prims.bool) =
  fun projectee -> match projectee with | Var _0 -> true | uu____845 -> false
...
let (uu___is_Abs : term' -> Prims.bool) =
  fun projectee -> match projectee with | Abs _0 -> true | uu____983 -> false
...
let (uu___is_If : term' -> Prims.bool) =
  fun projectee -> match projectee with | If _0 -> true | uu____1281 -> false
...
let (uu___is_Hash : imp -> Prims.bool) =
  fun projectee -> match projectee with | Hash -> true | uu____3031 -> false
...
let (uu___is_Infix : imp -> Prims.bool) =
  fun projectee -> match projectee with | Infix -> true | uu____3072 -> false
...
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Noeq -> true | uu____3602 -> false
...
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Logic -> true | uu____3778 -> false
          ...
          let uu____5236 =
            FStar_List.choose
              (fun uu___0_5241 ->
                 ...
                 | uu____5245 -> FStar_Pervasives_Native.None) decorations in
          ...
          let uu____5252 =
            FStar_List.choose
              (fun uu___1_5261 ->
                 ...
                 | uu____5271 -> FStar_Pervasives_Native.None) decorations in
        ...
        let qualifiers =
          FStar_List.choose
            (fun uu___2_5287 ->
               ...
               | uu____5291 -> FStar_Pervasives_Native.None) decorations in
  ...
  fun lbs ->
    fun r ->
      let should_filter =
        FStar_Util.for_some
          (fun uu____6517 ->
             match uu____6517 with | (attr, (focus, uu____6534)) -> focus)
          lbs in
      if should_filter
      then
        (FStar_Errors.log_issue r
                      ...
                      (match pat.pat with
                       ...
                       | uu____6947 ->
                           ...
                           let phi1 =
                             let x_var =
                               let uu____6951 =
                                 let uu____6952 = FStar_Ident.lid_of_ids [x] in
                                 Var uu____6952 in
            ...
            (match d.d with
             ...
             | uu____7237 ->
                 ...
                 (FStar_List.iter
                  ...
                  FStar_Util.Inr ds2))
let compile_op :
  'Auu____7270 . Prims.int -> Prims.string -> 'Auu____7270 -> Prims.string =
  fun arity ->
    fun s ->
      fun r ->
        let name_of_char uu___4_7298 =
          match uu___4_7298 with
          | 38 -> "Amp"
          | 64 -> "At"
          | 43 -> "Plus"
          ...
          | c ->
              let uu____7347 =
                FStar_Util.string_of_int (FStar_Util.int_of_char c) in
              Prims.op_Hat "u" uu____7347 in
        match s with
        ...
        | uu____7367 ->
            let uu____7369 =
              let uu____7371 =
                let uu____7375 = FStar_String.list_of_string s in
                FStar_List.map name_of_char uu____7375 in
              FStar_String.concat "_" uu____7371 in
            Prims.op_Hat "op_" uu____7369
let compile_op' : 'Auu____7390 . Prims.string -> 'Auu____7390 -> Prims.string
          ...
          let uu____7461 =
            FStar_List.map
              (fun uu____7475 ->
                 ...
                 | (k, v1) -> Prims.op_Hat k (Prims.op_Hat "->" v1)) keywords in
          FStar_String.concat "," uu____7461 in
        Prims.op_Hat comment uu____7459
let (string_of_let_qualifier : let_qualifier -> Prims.string) =
  fun uu___5_7497 ->
    match uu___5_7497 with | NoLetQualifier -> "" | Rec -> "rec"
let to_string_l :
  'Auu____7510 .
    Prims.string ->
      ('Auu____7510 -> Prims.string) ->
        'Auu____7510 Prims.list -> Prims.string
  =
  fun sep ->
    fun f ->
      fun l ->
        let uu____7540 = FStar_List.map f l in
        FStar_String.concat sep uu____7540
let (imp_to_string : imp -> Prims.string) =
  fun uu___6_7551 -> match uu___6_7551 with | Hash -> "#" | uu____7554 -> ""
let rec (term_to_string : term -> Prims.string) =
  fun x ->
    match x.tm with
    | Wild -> "_"
    | Requires (t, uu____7597) ->
        let uu____7604 = term_to_string t in
        FStar_Util.format1 "(requires %s)" uu____7604
    | Ensures (t, uu____7608) ->
        let uu____7615 = term_to_string t in
        FStar_Util.format1 "(ensures %s)" uu____7615
    | Labeled (t, l, uu____7620) ->
        let uu____7625 = term_to_string t in
        FStar_Util.format2 "(labeled %s %s)" l uu____7625
    | Const c -> FStar_Parser_Const.const_to_string c
    | Op (s, xs) ->
        let uu____7635 = FStar_Ident.text_of_id s in
        let uu____7637 =
          let uu____7639 =
            FStar_List.map (fun x1 -> FStar_All.pipe_right x1 term_to_string)
              xs in
          FStar_String.concat ", " uu____7639 in
        FStar_Util.format2 "%s(%s)" uu____7635 uu____7637
    ...
    | Projector (rec_lid, field_id) ->
        let uu____7655 = FStar_Ident.string_of_lid rec_lid in
        FStar_Util.format2 "%s?.%s" uu____7655 field_id.FStar_Ident.idText
    | Construct (l, args) ->
        let uu____7672 =
          to_string_l " "
            (fun uu____7683 ->
               ...
               | (a, imp) ->
                   let uu____7691 = term_to_string a in
                   FStar_Util.format2 "%s%s" (imp_to_string imp) uu____7691)
            args in
        FStar_Util.format2 "(%s %s)" l.FStar_Ident.str uu____7672
    | Abs (pats, t) ->
        let uu____7701 = to_string_l " " pat_to_string pats in
        let uu____7704 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "(fun %s -> %s)" uu____7701 uu____7704
    | App (t1, t2, imp) ->
        let uu____7711 = FStar_All.pipe_right t1 term_to_string in
        let uu____7714 = FStar_All.pipe_right t2 term_to_string in
        FStar_Util.format3 "%s %s%s" uu____7711 (imp_to_string imp)
          uu____7714
    | Let (Rec, (a, (p, b))::lbs, body) ->
        let uu____7775 = attrs_opt_to_string a in
        let uu____7777 =
          let uu____7779 = FStar_All.pipe_right p pat_to_string in
          let uu____7782 = FStar_All.pipe_right b term_to_string in
          FStar_Util.format2 "%s=%s" uu____7779 uu____7782 in
        let uu____7786 =
          to_string_l " "
            (fun uu____7808 ->
               match uu____7808 with
               | (a1, (p1, b1)) ->
                   let uu____7837 = attrs_opt_to_string a1 in
                   let uu____7839 = FStar_All.pipe_right p1 pat_to_string in
                   let uu____7842 = FStar_All.pipe_right b1 term_to_string in
                   FStar_Util.format3 "%sand %s=%s" uu____7837 uu____7839
                     uu____7842) lbs in
        let uu____7846 = FStar_All.pipe_right body term_to_string in
        FStar_Util.format4 "%slet rec %s%s in %s" uu____7775 uu____7777
          uu____7786 uu____7846
    | Let (q, (attrs, (pat, tm))::[], body) ->
        let uu____7905 = attrs_opt_to_string attrs in
        let uu____7907 = FStar_All.pipe_right pat pat_to_string in
        let uu____7910 = FStar_All.pipe_right tm term_to_string in
        let uu____7913 = FStar_All.pipe_right body term_to_string in
        FStar_Util.format5 "%slet %s %s = %s in %s" uu____7905
          (string_of_let_qualifier q) uu____7907 uu____7910 uu____7913
    | Let (uu____7917, uu____7918, uu____7919) ->
        FStar_Errors.raise_error
          (FStar_Errors.Fatal_EmptySurfaceLet,
            "Internal error: found an invalid surface Let") x.range
    | LetOpen (lid, t) ->
        let uu____7953 = FStar_Ident.string_of_lid lid in
        let uu____7955 = term_to_string t in
        FStar_Util.format2 "let open %s in %s" uu____7953 uu____7955
    | Seq (t1, t2) ->
        let uu____7960 = FStar_All.pipe_right t1 term_to_string in
        let uu____7963 = FStar_All.pipe_right t2 term_to_string in
        FStar_Util.format2 "%s; %s" uu____7960 uu____7963
    | Bind (id1, t1, t2) ->
        let uu____7970 = term_to_string t1 in
        let uu____7972 = term_to_string t2 in
        FStar_Util.format3 "%s <- %s; %s" id1.FStar_Ident.idText uu____7970
          uu____7972
    | If (t1, t2, t3) ->
        let uu____7978 = FStar_All.pipe_right t1 term_to_string in
        let uu____7981 = FStar_All.pipe_right t2 term_to_string in
        let uu____7984 = FStar_All.pipe_right t3 term_to_string in
        FStar_Util.format3 "if %s then %s else %s" uu____7978 uu____7981
          uu____7984
    | Match (t, branches) ->
        let s =
          match x.tm with
          | Match uu____8013 -> "match"
          | TryWith uu____8029 -> "try"
          | uu____8045 -> failwith "impossible" in
        let uu____8048 = FStar_All.pipe_right t term_to_string in
        let uu____8051 =
          to_string_l " | "
            (fun uu____8069 ->
               match uu____8069 with
               | (p, w, e) ->
                   let uu____8086 = FStar_All.pipe_right p pat_to_string in
                   let uu____8089 =
                     match w with
                     | FStar_Pervasives_Native.None -> ""
                     | FStar_Pervasives_Native.Some e1 ->
                         let uu____8094 = term_to_string e1 in
                         FStar_Util.format1 "when %s" uu____8094 in
                   let uu____8097 = FStar_All.pipe_right e term_to_string in
                   FStar_Util.format3 "%s %s -> %s" uu____8086 uu____8089
                     uu____8097) branches in
        FStar_Util.format3 "%s %s with %s" s uu____8048 uu____8051
    | TryWith (t, branches) ->
        let s =
          match x.tm with
          | Match uu____8127 -> "match"
          | TryWith uu____8143 -> "try"
          | uu____8159 -> failwith "impossible" in
        let uu____8162 = FStar_All.pipe_right t term_to_string in
        let uu____8165 =
          to_string_l " | "
            (fun uu____8183 ->
               match uu____8183 with
               | (p, w, e) ->
                   let uu____8200 = FStar_All.pipe_right p pat_to_string in
                   let uu____8203 =
                     match w with
                     | FStar_Pervasives_Native.None -> ""
                     | FStar_Pervasives_Native.Some e1 ->
                         let uu____8208 = term_to_string e1 in
                         FStar_Util.format1 "when %s" uu____8208 in
                   let uu____8211 = FStar_All.pipe_right e term_to_string in
                   FStar_Util.format3 "%s %s -> %s" uu____8200 uu____8203
                     uu____8211) branches in
        FStar_Util.format3 "%s %s with %s" s uu____8162 uu____8165
    | Ascribed (t1, t2, FStar_Pervasives_Native.None) ->
        ...
        FStar_Util.format2 "(%s : %s)" uu____8220 uu____8223
    | Ascribed (t1, t2, FStar_Pervasives_Native.Some tac) ->
        let uu____8232 = FStar_All.pipe_right t1 term_to_string in
        let uu____8235 = FStar_All.pipe_right t2 term_to_string in
        let uu____8238 = FStar_All.pipe_right tac term_to_string in
        FStar_Util.format3 "(%s : %s by %s)" uu____8232 uu____8235 uu____8238
        ...
        let uu____8261 =
          to_string_l " "
            (fun uu____8272 ->
               ...
               | (l, e1) ->
                   let uu____8280 = FStar_All.pipe_right e1 term_to_string in
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____8280)
            fields in
        FStar_Util.format2 "{%s with %s}" uu____8258 uu____8261
          ...
          to_string_l " "
            (fun uu____8311 ->
               ...
               | (l, e) ->
                   ...
                   FStar_Util.format2 "%s=%s" l.FStar_Ident.str uu____8319)
            fields in
        FStar_Util.format1 "{%s}" uu____8300
    | Project (e, l) ->
        let uu____8326 = FStar_All.pipe_right e term_to_string in
        FStar_Util.format2 "%s.%s" uu____8326 l.FStar_Ident.str
    ...
    | Product (b::[], t) when x.level = Type_level ->
        let uu____8349 = FStar_All.pipe_right b binder_to_string in
        let uu____8352 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s -> %s" uu____8349 uu____8352
    | Product (b::[], t) when x.level = Kind ->
        let uu____8360 = FStar_All.pipe_right b binder_to_string in
        let uu____8363 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s => %s" uu____8360 uu____8363
    | Sum (binders, t) ->
        let uu____8381 =
          FStar_All.pipe_right (FStar_List.append binders [FStar_Util.Inr t])
            (FStar_List.map
               (fun uu___7_8413 ->
                  match uu___7_8413 with
                  | FStar_Util.Inl b -> binder_to_string b
                  | FStar_Util.Inr t1 -> term_to_string t1)) in
        FStar_All.pipe_right uu____8381 (FStar_String.concat " & ")
    | QForall (bs, (uu____8427, pats), t) ->
        let uu____8456 = to_string_l " " binder_to_string bs in
        let uu____8459 =
          to_string_l " \\/ " (to_string_l "; " term_to_string) pats in
        let uu____8465 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format3 "forall %s.{:pattern %s} %s" uu____8456 uu____8459
          uu____8465
    | QExists (bs, (uu____8470, pats), t) ->
        let uu____8499 = to_string_l " " binder_to_string bs in
        let uu____8502 =
          to_string_l " \\/ " (to_string_l "; " term_to_string) pats in
        let uu____8508 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format3 "exists %s.{:pattern %s} %s" uu____8499 uu____8502
          uu____8508
    | Refine (b, t) ->
        let uu____8514 = FStar_All.pipe_right b binder_to_string in
        let uu____8517 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s:{%s}" uu____8514 uu____8517
    | NamedTyp (x1, t) ->
        let uu____8523 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "%s:%s" x1.FStar_Ident.idText uu____8523
    | Paren t ->
        let uu____8528 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format1 "(%s)" uu____8528
    | Product (bs, t) ->
        let uu____8538 =
          let uu____8540 =
            FStar_All.pipe_right bs (FStar_List.map binder_to_string) in
          FStar_All.pipe_right uu____8540 (FStar_String.concat ",") in
        let uu____8555 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "Unidentified product: [%s] %s" uu____8538
          uu____8555
    | Discrim lid ->
        let uu____8560 = FStar_Ident.string_of_lid lid in
        FStar_Util.format1 "%s?" uu____8560
    | Attributes ts ->
        let uu____8566 =
          let uu____8568 = FStar_List.map term_to_string ts in
          FStar_All.pipe_left (FStar_String.concat " ") uu____8568 in
        FStar_Util.format1 "(attributes %s)" uu____8566
    | Antiquote t ->
        let uu____8580 = term_to_string t in
        FStar_Util.format1 "(`#%s)" uu____8580
    | Quote (t, Static) ->
        let uu____8584 = term_to_string t in
        FStar_Util.format1 "(`(%s))" uu____8584
    | Quote (t, Dynamic) ->
        let uu____8588 = term_to_string t in
        FStar_Util.format1 "quote (%s)" uu____8588
    | VQuote t ->
        let uu____8592 = term_to_string t in
        FStar_Util.format1 "`%%%s" uu____8592
    | CalcProof (rel, init1, steps) ->
        let uu____8602 = term_to_string rel in
        let uu____8604 = term_to_string init1 in
        let uu____8606 =
          let uu____8608 = FStar_List.map calc_step_to_string steps in
          FStar_All.pipe_left (FStar_String.concat " ") uu____8608 in
        FStar_Util.format3 "calc (%s) { %s %s }" uu____8602 uu____8604
          uu____8606
and (calc_step_to_string : calc_step -> Prims.string) =
  fun uu____8619 ->
    match uu____8619 with
    | CalcStep (rel, just, next) ->
        let uu____8624 = term_to_string rel in
        let uu____8626 = term_to_string just in
        let uu____8628 = term_to_string next in
        FStar_Util.format3 "%s{ %s } %s" uu____8624 uu____8626 uu____8628
and (binder_to_string : binder -> Prims.string) =
  fun x ->
    let s =
      ...
      | TAnnotated (i, t) ->
          let uu____8640 = FStar_All.pipe_right t term_to_string in
          FStar_Util.format2 "%s:%s" i.FStar_Ident.idText uu____8640
      | Annotated (i, t) ->
          let uu____8646 = FStar_All.pipe_right t term_to_string in
          FStar_Util.format2 "%s:%s" i.FStar_Ident.idText uu____8646
      | NoName t -> FStar_All.pipe_right t term_to_string in
    let uu____8652 = aqual_to_string x.aqual in
    FStar_Util.format2 "%s%s" uu____8652 s
and (aqual_to_string :
  arg_qualifier FStar_Pervasives_Native.option -> Prims.string) =
  fun uu___8_8655 ->
    match uu___8_8655 with
...
and (pat_to_string : pattern -> Prims.string) =
  fun x ->
    ...
    | PatWild uu____8668 -> "#_"
    | PatConst c -> FStar_Parser_Const.const_to_string c
    | PatApp (p, ps) ->
        let uu____8679 = FStar_All.pipe_right p pat_to_string in
        let uu____8682 = to_string_l " " pat_to_string ps in
        FStar_Util.format2 "(%s %s)" uu____8679 uu____8682
    | PatTvar (i, aq) ->
        let uu____8692 = aqual_to_string aq in
        FStar_Util.format2 "%s%s" uu____8692 i.FStar_Ident.idText
    | PatVar (i, aq) ->
        let uu____8701 = aqual_to_string aq in
        FStar_Util.format2 "%s%s" uu____8701 i.FStar_Ident.idText
    | PatName l -> l.FStar_Ident.str
    | PatList l ->
        let uu____8708 = to_string_l "; " pat_to_string l in
        FStar_Util.format1 "[%s]" uu____8708
    | PatTuple (l, false) ->
        let uu____8719 = to_string_l ", " pat_to_string l in
        FStar_Util.format1 "(%s)" uu____8719
    | PatTuple (l, true) ->
        let uu____8730 = to_string_l ", " pat_to_string l in
        FStar_Util.format1 "(|%s|)" uu____8730
    | PatRecord l ->
        let uu____8741 =
          to_string_l "; "
            (fun uu____8752 ->
               ...
               | (f, e) ->
                   let uu____8760 = FStar_All.pipe_right e pat_to_string in
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____8760) l in
        FStar_Util.format1 "{%s}" uu____8741
    | PatOr l -> to_string_l "|\n " pat_to_string l
    | PatOp op ->
        let uu____8770 = FStar_Ident.text_of_id op in
        FStar_Util.format1 "(%s)" uu____8770
    | PatAscribed (p, (t, FStar_Pervasives_Native.None)) ->
        let uu____8783 = FStar_All.pipe_right p pat_to_string in
        let uu____8786 = FStar_All.pipe_right t term_to_string in
        FStar_Util.format2 "(%s:%s)" uu____8783 uu____8786
    | PatAscribed (p, (t, FStar_Pervasives_Native.Some tac)) ->
        let uu____8801 = FStar_All.pipe_right p pat_to_string in
        let uu____8804 = FStar_All.pipe_right t term_to_string in
        let uu____8807 = FStar_All.pipe_right tac term_to_string in
        FStar_Util.format3 "(%s:%s by %s)" uu____8801 uu____8804 uu____8807
and (attrs_opt_to_string :
  term Prims.list FStar_Pervasives_Native.option -> Prims.string) =
  fun uu___9_8811 ->
    match uu___9_8811 with
    | FStar_Pervasives_Native.None -> ""
    | FStar_Pervasives_Native.Some attrs ->
        let uu____8825 =
          let uu____8827 = FStar_List.map term_to_string attrs in
          FStar_All.pipe_right uu____8827 (FStar_String.concat "; ") in
...
let rec (head_id_of_pat : pattern -> FStar_Ident.lident Prims.list) =
  fun p ->
    ...
    | PatName l -> [l]
    | PatVar (i, uu____8850) ->
        let uu____8855 = FStar_Ident.lid_of_ids [i] in [uu____8855]
    | PatApp (p1, uu____8857) -> head_id_of_pat p1
    | PatAscribed (p1, uu____8863) -> head_id_of_pat p1
    | uu____8876 -> []
let lids_of_let :
  'Auu____8882 .
    (pattern * 'Auu____8882) Prims.list -> FStar_Ident.lident Prims.list
  =
  fun defs ->
    FStar_All.pipe_right defs
      (FStar_List.collect
         (fun uu____8917 ->
            match uu____8917 with | (p, uu____8925) -> head_id_of_pat p))
let (id_of_tycon : tycon -> Prims.string) =
  fun uu___10_8932 ->
    match uu___10_8932 with
    | TyconAbstract (i, uu____8935, uu____8936) -> i.FStar_Ident.idText
    | TyconAbbrev (i, uu____8946, uu____8947, uu____8948) ->
        i.FStar_Ident.idText
    | TyconRecord (i, uu____8958, uu____8959, uu____8960) ->
        i.FStar_Ident.idText
    | TyconVariant (i, uu____8990, uu____8991, uu____8992) ->
        i.FStar_Ident.idText
  ...
  fun d ->
    ...
    | ModuleAbbrev (i, l) ->
        FStar_Util.format2 "module %s = %s" i.FStar_Ident.idText
          l.FStar_Ident.str
    | TopLevelLet (uu____9050, pats) ->
        let uu____9064 =
          let uu____9066 =
            let uu____9070 = lids_of_let pats in
            FStar_All.pipe_right uu____9070
              (FStar_List.map (fun l -> l.FStar_Ident.str)) in
          FStar_All.pipe_right uu____9066 (FStar_String.concat ", ") in
        Prims.op_Hat "let " uu____9064
    | Main uu____9087 -> "main ..."
    | Assume (i, uu____9090) -> Prims.op_Hat "assume " i.FStar_Ident.idText
    | Tycon (uu____9092, uu____9093, tys) ->
        let uu____9115 =
          let uu____9117 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____9142 ->
                    match uu____9142 with | (x, uu____9151) -> id_of_tycon x)) in
          FStar_All.pipe_right uu____9117 (FStar_String.concat ", ") in
        Prims.op_Hat "type " uu____9115
    | Val (i, uu____9163) -> Prims.op_Hat "val " i.FStar_Ident.idText
    | Exception (i, uu____9166) ->
        Prims.op_Hat "exception " i.FStar_Ident.idText
    | NewEffect (DefineEffect (i, uu____9173, uu____9174, uu____9175)) ->
        Prims.op_Hat "new_effect " i.FStar_Ident.idText
    | NewEffect (RedefineEffect (i, uu____9186, uu____9187)) ->
        Prims.op_Hat "new_effect " i.FStar_Ident.idText
    | Splice (ids, t) ->
        let uu____9199 =
          let uu____9201 =
            ...
            FStar_All.pipe_left (FStar_String.concat ";") uu____9203 in
          let uu____9215 =
            let uu____9217 =
              let uu____9219 = term_to_string t in
              Prims.op_Hat uu____9219 ")" in
            Prims.op_Hat "] (" uu____9217 in
          Prims.op_Hat uu____9201 uu____9215 in
        Prims.op_Hat "splice[" uu____9199
    | SubEffect uu____9224 -> "sub_effect"
    | Pragma uu____9226 -> "pragma"
    | Fsdoc uu____9228 -> "fsdoc"
let (modul_to_string : modul -> Prims.string) =
  fun m ->
    match m with
    | Module (uu____9238, decls) ->
        let uu____9244 =
          FStar_All.pipe_right decls (FStar_List.map decl_to_string) in
        FStar_All.pipe_right uu____9244 (FStar_String.concat "\n")
    | Interface (uu____9259, decls, uu____9261) ->
        let uu____9268 =
          FStar_All.pipe_right decls (FStar_List.map decl_to_string) in
        FStar_All.pipe_right uu____9268 (FStar_String.concat "\n")
let (decl_is_val : FStar_Ident.ident -> decl -> Prims.bool) =
  fun id1 ->
    fun decl ->
      match decl.d with
      | Val (id', uu____9297) -> FStar_Ident.ident_equals id1 id'
      | uu____9298 -> false
let (thunk : term -> term) =
  fun ens ->
      ...
      FStar_All.pipe_right bs
        (FStar_List.map
           (fun b ->
              ...
              | Variable i -> i
              | TVariable i -> i
              | Annotated (i, uu____9336) -> i
              | TAnnotated (i, uu____9338) -> i
              | NoName uu____9339 ->
                  FStar_Errors.raise_error
