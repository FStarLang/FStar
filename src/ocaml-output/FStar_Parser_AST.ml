      ...
      fun decorations  ->
        ...
        let attributes_ =
          let uu____2505 =
            FStar_List.choose
              (fun uu___105_2509  ->
                 match uu___105_2509 with
                 | DeclAttributes a -> Some a
                 | uu____2515 -> None) decorations
             in
        ...
        let qualifiers =
          FStar_List.choose
            (fun uu___106_2523  ->
               match uu___106_2523 with
               | Qualifier q -> Some q
               | uu____2526 -> None) decorations
           in
  ...
  then
    (FStar_Errors.warn r "Focusing on only some cases";
     (let focussed =
      ...
      let uu____2988 = let uu____2994 = mkWildAdmitMagic r  in [uu____2994]
         in
...
let mkTuple : term Prims.list -> FStar_Range.range -> term =
  fun args  ->
    fun r  ->
      ...
      mkApp (mk_term (Name cons1) r Expr) uu____3144 r
...
let mkDTuple : term Prims.list -> FStar_Range.range -> term =
  fun args  ->
    fun r  ->
      ...
      mkApp (mk_term (Name cons1) r Expr) uu____3163 r
...
let compile_op : Prims.int -> Prims.string -> Prims.string =
  fun arity  ->
    fun s  ->
      let name_of_char uu___108_3427 =
        match uu___108_3427 with
        | '&' -> "Amp"
        | '@' -> "At"
        | '+' -> "Plus"
...
let imp_to_string : imp -> Prims.string =
  fun uu___110_3500  ->
    match uu___110_3500 with | Hash  -> "#" | uu____3501 -> ""
...
let rec term_to_string : term -> Prims.string =
  fun x  ->
          ...
          to_string_l " and "
            (fun uu____3575  ->
               ...
               | (p,b) ->
                   ...
                   FStar_Util.format2 "%s=%s" uu____3580 uu____3581) lbs
           in
            ...
            (fun uu____3625  ->
               ...
               | (p,w,e) ->
                   ...
                   let uu____3636 =
                     ...
                     | None  -> ""
                     | Some e1 ->
                         let uu____3638 = term_to_string e1  in
                         FStar_Util.format1 "when %s" uu____3638
                      in
        ...
        let uu____3654 =
          to_string_l " "
            (fun uu____3657  ->
               ...
               | (l,e1) ->
                   let uu____3662 = FStar_All.pipe_right e1 term_to_string
                      in
    ...
    | NamedTyp (x1,t) ->
        ...
        FStar_Util.format2 "%s:%s" x1.FStar_Ident.idText uu____3746
    | Paren t ->
          ...
          to_string_l "; "
            (fun uu____3806  ->
               ...
               | (f,e) ->
                   ...
                   FStar_Util.format2 "%s=%s" f.FStar_Ident.str uu____3811) l
           in
...
let rec head_id_of_pat : pattern -> FStar_Ident.lid Prims.list =
  fun p  ->
    ...
    | PatApp (p1,uu____3831) -> head_id_of_pat p1
    | PatAscribed (p1,uu____3835) -> head_id_of_pat p1
    | uu____3836 -> []
        ...
        let uu____3936 =
          let uu____3937 =
            FStar_All.pipe_right tys
              (FStar_List.map
                 (fun uu____3947  ->
                    match uu____3947 with | (x,uu____3952) -> id_of_tycon x))
             in
