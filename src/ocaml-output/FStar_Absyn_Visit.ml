...
(let _111_8 = (FStar_Absyn_Syntax.mk_Typ_app (t', args) None typ.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left (compress_typ_aux pos) _111_8))
end
| _26_55 -> begin
typ
end)
...
| (t, env) -> begin
(let _111_292 = (FStar_Absyn_Syntax.mk_Total t)
in (_111_292, env))
end))
end
...
| (env, flags) -> begin
(let _111_295 = (FStar_Absyn_Syntax.mk_Comp (
...
let _26_507 = (match ((let _111_299 = (compress_typ t)
in _111_299.FStar_Absyn_Syntax.n)) with
...
in (let _111_388 = (k' k.FStar_Absyn_Syntax.pos)
in (_111_388, env))))

# 382 "FStar.Absyn.Visit.fst"
...
(let _111_429 = (let _111_428 = (let _111_427 = (let _111_426 = (FStar_Util.mk_ref false)
in (t1, t2, _111_426))
in FStar_Absyn_Syntax.Meta_slack_formula (_111_427))
in (FStar_Absyn_Syntax.mk_Typ_meta' _111_428))
in (FStar_All.pipe_left w _111_429))
end
| _26_1026 -> begin
(FStar_All.failwith "impossible")
end)
...
(let _111_459 = (mk_eqns eqns' el')
in ((p, None, e))::_111_459)
end
| ((p, Some (_26_1167), _26_1170)::eqns', w::e::el') -> begin
(let _111_460 = (mk_eqns eqns' el')
in ((p, Some (w), e))::_111_460)
end
| ([], []) -> begin
[]
end
...
in (let _111_465 = (let _111_464 = (let _111_463 = (mk_eqns eqns el)
in (e1, _111_463))
in (FStar_Absyn_Syntax.mk_Exp_match _111_464))
in (FStar_All.pipe_left w _111_465)))
end
...
# 433 "FStar.Absyn.Visit.fst"
let collect_from_typ = (fun f env t -> (let _111_589 = (reduce_typ (fun _26_1260 _26_1262 _26_1264 env _26_1267 k -> (k, env)) (fun _26_1242 vt _26_1245 env bvs t -> (
# 438 "FStar.Absyn.Visit.fst"
let env = (f env t)
in (match ((let _111_546 = (compress_typ t)
in _111_546.FStar_Absyn_Syntax.n)) with
| (FStar_Absyn_Syntax.Typ_unknown) | (FStar_Absyn_Syntax.Typ_btvar (_)) | (FStar_Absyn_Syntax.Typ_const (_)) -> begin
(t, env)
end
| _26_1259 -> begin
...
in (FStar_All.pipe_left Prims.snd _111_589)))
