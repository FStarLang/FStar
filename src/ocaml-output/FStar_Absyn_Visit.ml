...
in (let _26_23 = (FStar_ST.op_Colon_Equals m (Some (t')))
in t'))
end)
end
...
(let _56_8 = (FStar_Absyn_Syntax.mk_Typ_app (t', args) None typ.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left (compress_typ_aux pos) _56_8))
end
| _26_55 -> begin
typ
end)
...
in (let _26_82 = (FStar_ST.op_Colon_Equals m (Some (e')))
in e'))
end)
end
...
in (let _26_127 = (FStar_ST.op_Colon_Equals m (Some (k')))
in k'))
end)
end
| _26_130 -> begin
...
in (let _26_236 = (match (k.FStar_Absyn_Syntax.n) with
...
and map_args = (fun map_typ map_exp env binders arguments -> (let _26_270 = (FStar_List.fold_left (fun _26_254 _26_257 -> (match ((_26_254, _26_257)) with
...
and map_binders = (fun map_kind map_typ env binders bs -> (let _26_301 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun _26_280 b -> (match (_26_280) with
| (bs, binders, env) -> begin
(match (b) with
...
| (t, env) -> begin
(let _56_292 = (FStar_Absyn_Syntax.mk_Total t)
in (_56_292, env))
end))
end
...
| (env, flags) -> begin
(let _56_295 = (FStar_Absyn_Syntax.mk_Comp (let _26_344 = ct
...
and visit_typ = (fun env binders t -> (let _26_507 = (match ((let _56_299 = (compress_typ t)
in _56_299.FStar_Absyn_Syntax.n)) with
...
| (t, env) -> begin
(let map_pats = (fun env pats -> (let _26_494 = (FStar_List.fold_left (fun _26_474 arg -> (match (_26_474) with
| (pats, env) -> begin
(match (arg) with
...
in (let _26_504 = (FStar_List.fold_left (fun _26_497 pats -> (match (_26_497) with
| (out, env) -> begin
...
and reduce_exp = (fun map_kind' map_typ' map_exp' combine_kind combine_typ combine_exp env binders e -> (let rec map_exps = (fun env binders el -> (let _26_545 = (FStar_List.fold_left (fun _26_538 e -> (match (_26_538) with
| (out, env) -> begin
...
and map_exps_with_binders = (fun env el -> (let _26_559 = (FStar_List.fold_left (fun _26_550 _26_553 -> (match ((_26_550, _26_553)) with
| ((out, env), (b, e)) -> begin
...
in (let _26_746 = (match (e.FStar_Absyn_Syntax.n) with
...
in (let branches = (FStar_All.pipe_right pl (FStar_List.collect (fun _26_671 -> (match (_26_671) with
| (p, w, e) -> begin
...
in (let _26_679 = (map_exps_with_binders env (((binders, e1))::branches))
...
in (let _26_709 = (map_exps_with_binders env (((binders, lb.FStar_Absyn_Syntax.lbdef))::((binders', e2))::[]))
...
in (let _26_729 = (FStar_All.pipe_right tl (FStar_List.fold_left (fun _26_722 t -> (match (_26_722) with
| (tl, env) -> begin
...
in (let _26_740 = (map_exps env binders (FStar_List.append el ((e)::[])))
...
in (let _56_388 = (k' k.FStar_Absyn_Syntax.pos)
in (_56_388, env))))
...
(let _56_429 = (let _56_428 = (let _56_427 = (let _56_426 = (FStar_Util.mk_ref false)
in (t1, t2, _56_426))
in FStar_Absyn_Syntax.Meta_slack_formula (_56_427))
in (FStar_Absyn_Syntax.mk_Typ_meta' _56_428))
in (FStar_All.pipe_left w _56_429))
end
| _26_1026 -> begin
(FStar_All.failwith "impossible")
end)
...
(let _56_459 = (mk_eqns eqns' el')
in ((p, None, e))::_56_459)
end
| ((p, Some (_26_1167), _26_1170)::eqns', w::e::el') -> begin
(let _56_460 = (mk_eqns eqns' el')
in ((p, Some (w), e))::_56_460)
end
| ([], []) -> begin
[]
end
...
in (let _56_465 = (let _56_464 = (let _56_463 = (mk_eqns eqns el)
in (e1, _56_463))
in (FStar_Absyn_Syntax.mk_Exp_match _56_464))
in (FStar_All.pipe_left w _56_465)))
end
...
| (el, e'::[]) -> begin
(let lbs' = (FStar_List.map3 (fun lb t e -> (let _26_1208 = lb
...
let collect_from_typ = (fun f env t -> (let _56_589 = (reduce_typ (fun _26_1260 _26_1262 _26_1264 env _26_1267 k -> (k, env)) (fun _26_1242 vt _26_1245 env bvs t -> (let env = (f env t)
in (match ((let _56_546 = (compress_typ t)
in _56_546.FStar_Absyn_Syntax.n)) with
| (FStar_Absyn_Syntax.Typ_unknown) | (FStar_Absyn_Syntax.Typ_btvar (_)) | (FStar_Absyn_Syntax.Typ_const (_)) -> begin
(t, env)
end
| _26_1259 -> begin
...
in (FStar_All.pipe_left Prims.snd _56_589)))
