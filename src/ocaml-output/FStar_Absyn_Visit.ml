...
(let _94_8 = (FStar_Absyn_Syntax.mk_Typ_app (t', args) None typ.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left (compress_typ_aux pos) _94_8))
end
| _25_55 -> begin
typ
end)
...
| (t, env) -> begin
(let _94_292 = (FStar_Absyn_Syntax.mk_Total t)
in (_94_292, env))
end))
end
...
| (env, flags) -> begin
(let _94_295 = (FStar_Absyn_Syntax.mk_Comp (let _25_344 = ct
...
and visit_typ = (fun env binders t -> (let _25_494 = (match ((let _94_299 = (compress_typ t)
in _94_299.FStar_Absyn_Syntax.n)) with
...
in (let _94_382 = (k' k.FStar_Absyn_Syntax.pos)
in (_94_382, env))))
...
(let _94_423 = (let _94_422 = (let _94_421 = (let _94_420 = (FStar_Util.mk_ref false)
in (t1, t2, _94_420))
in FStar_Absyn_Syntax.Meta_slack_formula (_94_421))
in (FStar_Absyn_Syntax.mk_Typ_meta' _94_422))
in (FStar_All.pipe_left w _94_423))
end
| _25_1012 -> begin
(FStar_All.failwith "impossible")
end)
...
(let _94_453 = (mk_eqns eqns' el')
in ((p, None, e))::_94_453)
end
| ((p, Some (_25_1153), _25_1156)::eqns', w::e::el') -> begin
(let _94_454 = (mk_eqns eqns' el')
in ((p, Some (w), e))::_94_454)
end
| ([], []) -> begin
[]
end
...
in (let _94_459 = (let _94_458 = (let _94_457 = (mk_eqns eqns el)
in (e1, _94_457))
in (FStar_Absyn_Syntax.mk_Exp_match _94_458))
in (FStar_All.pipe_left w _94_459)))
end
...
let collect_from_typ = (fun f env t -> (let _94_583 = (reduce_typ (fun _25_1246 _25_1248 _25_1250 env _25_1253 k -> (k, env)) (fun _25_1228 vt _25_1231 env bvs t -> (let env = (f env t)
in (match ((let _94_540 = (compress_typ t)
in _94_540.FStar_Absyn_Syntax.n)) with
| (FStar_Absyn_Syntax.Typ_unknown) | (FStar_Absyn_Syntax.Typ_btvar (_)) | (FStar_Absyn_Syntax.Typ_const (_)) -> begin
(t, env)
end
| _25_1245 -> begin
...
in (FStar_All.pipe_left Prims.snd _94_583)))
