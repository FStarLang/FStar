...
(let _79_8 = (FStar_Absyn_Syntax.mk_Typ_app (t', args) None typ.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left (compress_typ_aux pos) _79_8))
end
| _26_55 -> begin
typ
end)
...
| (t, env) -> begin
(let _79_292 = (FStar_Absyn_Syntax.mk_Total t)
in (_79_292, env))
end))
end
...
| (env, flags) -> begin
(let _79_295 = (FStar_Absyn_Syntax.mk_Comp (let _26_344 = ct
...
and visit_typ = (fun env binders t -> (let _26_507 = (match ((let _79_299 = (compress_typ t)
in _79_299.FStar_Absyn_Syntax.n)) with
...
in (let _79_388 = (k' k.FStar_Absyn_Syntax.pos)
in (_79_388, env))))
...
(let _79_429 = (let _79_428 = (let _79_427 = (let _79_426 = (FStar_Util.mk_ref false)
in (t1, t2, _79_426))
in FStar_Absyn_Syntax.Meta_slack_formula (_79_427))
in (FStar_Absyn_Syntax.mk_Typ_meta' _79_428))
in (FStar_All.pipe_left w _79_429))
end
| _26_1026 -> begin
(FStar_All.failwith "impossible")
end)
...
(let _79_459 = (mk_eqns eqns' el')
in ((p, None, e))::_79_459)
end
| ((p, Some (_26_1167), _26_1170)::eqns', w::e::el') -> begin
(let _79_460 = (mk_eqns eqns' el')
in ((p, Some (w), e))::_79_460)
end
| ([], []) -> begin
[]
end
...
in (let _79_465 = (let _79_464 = (let _79_463 = (mk_eqns eqns el)
in (e1, _79_463))
in (FStar_Absyn_Syntax.mk_Exp_match _79_464))
in (FStar_All.pipe_left w _79_465)))
end
...
let collect_from_typ = (fun f env t -> (let _79_589 = (reduce_typ (fun _26_1260 _26_1262 _26_1264 env _26_1267 k -> (k, env)) (fun _26_1242 vt _26_1245 env bvs t -> (let env = (f env t)
in (match ((let _79_546 = (compress_typ t)
in _79_546.FStar_Absyn_Syntax.n)) with
| (FStar_Absyn_Syntax.Typ_unknown) | (FStar_Absyn_Syntax.Typ_btvar (_)) | (FStar_Absyn_Syntax.Typ_const (_)) -> begin
(t, env)
end
| _26_1259 -> begin
...
in (FStar_All.pipe_left Prims.snd _79_589)))
