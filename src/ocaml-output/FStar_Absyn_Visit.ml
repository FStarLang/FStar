...
(let _130_8 = (FStar_Absyn_Syntax.mk_Typ_app ((t'), (args)) None typ.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left (compress_typ_aux pos) _130_8))
end
| _31_55 -> begin
typ
end)
...
| (t, env) -> begin
(let _130_292 = (FStar_Absyn_Syntax.mk_Total t)
in ((_130_292), (env)))
end))
end
...
| (env, flags) -> begin
(let _130_295 = (FStar_Absyn_Syntax.mk_Comp (
...
let _31_507 = (match ((let _130_299 = (compress_typ t)
in _130_299.FStar_Absyn_Syntax.n)) with
...
in (let _130_388 = (k' k.FStar_Absyn_Syntax.pos)
in ((_130_388), (env)))))
...
(let _130_429 = (let _130_428 = (let _130_427 = (let _130_426 = (FStar_Util.mk_ref false)
in ((t1), (t2), (_130_426)))
in FStar_Absyn_Syntax.Meta_slack_formula (_130_427))
in (FStar_Absyn_Syntax.mk_Typ_meta' _130_428))
in (FStar_All.pipe_left w _130_429))
end
| _31_1026 -> begin
(failwith "impossible")
end)
...
(let _130_459 = (mk_eqns eqns' el')
in (((p), (None), (e)))::_130_459)
end
| (((p, Some (_31_1167), _31_1170))::eqns', (w)::(e)::el') -> begin
(let _130_460 = (mk_eqns eqns' el')
in (((p), (Some (w)), (e)))::_130_460)
end
| ([], []) -> begin
[]
end
...
in (let _130_465 = (let _130_464 = (let _130_463 = (mk_eqns eqns el)
in ((e1), (_130_463)))
in (FStar_Absyn_Syntax.mk_Exp_match _130_464))
in (FStar_All.pipe_left w _130_465)))
end
...
let collect_from_typ = (fun f env t -> (let _130_589 = (reduce_typ (fun _31_1260 _31_1262 _31_1264 env _31_1267 k -> ((k), (env))) (fun _31_1242 vt _31_1245 env bvs t -> (

let env = (f env t)
in (match ((let _130_546 = (compress_typ t)
in _130_546.FStar_Absyn_Syntax.n)) with
| (FStar_Absyn_Syntax.Typ_unknown) | (FStar_Absyn_Syntax.Typ_btvar (_)) | (FStar_Absyn_Syntax.Typ_const (_)) -> begin
((t), (env))
end
| _31_1259 -> begin
...
in (FStar_All.pipe_left Prims.snd _130_589)))
