...
in (FStar_Util.print_string uu____2420));
(aux t);
)
end))
end
...
let uu____2434 = (aux t)
in (

let uu____2442 = (FStar_List.collect aux tms)
in (FStar_List.append uu____2434 uu____2442)))
end
| FStar_SMTEncoding_Term.Labeled (t, uu____2461, uu____2462) -> begin
(aux t)
end
| FStar_SMTEncoding_Term.LblPos (t, uu____2466) -> begin
(aux t)
end
| uu____2469 -> begin
[]
...
in (aux tm0)))
in (match (decl) with
| FStar_SMTEncoding_Term.DefineFun (nm, args, ret1, tm, uu____2486) -> begin
(from_term tm tm)
end
...
and extract_quantifiers : (query_info * FStar_SMTEncoding_Term.decl Prims.list)  ->  (Prims.string * quantifier_info) Prims.list = (fun uu____2510 -> (match (uu____2510) with
| (query, decls) -> begin
(FStar_List.fold_left (fun l d -> (

let uu____2556 = (extract_quantifiers_from_decls query d)
in (FStar_List.append uu____2556 l))) [] decls)
end))
...
let comp = (fun uu____2627 uu____2628 -> (match (((uu____2627), (uu____2628))) with
| ((id1, q1), (id2, q2)) -> begin
...
let uu____2877 = (aux tl1 s ((q)::[]) [])
in (FStar_List.rev uu____2877))
end)))
in (
...
let uu____2932 = (quantifier_file q1)
in (

let uu____2934 = (quantifier_file q2)
in (Prims.op_Equality uu____2932 uu____2934))) && (

let uu____2939 = (quantifier_range q1)
in (

let uu____2941 = (quantifier_range q2)
...
let uu____2979 = (equal_range hd1 q)
...
let uu____3013 = (rm hd1 i [])
in (aux uu____3013 ((hd1)::o)))
end
| [] -> begin
(FStar_List.rev o)
end))
...
let insert = (fun o uu____3038 -> (match (uu____3038) with
| (id1, info) -> begin
(

let uu____3060 = (

let uu____3070 = (FStar_Util.psmap_try_find qip id1)
...
let uu____3184 = (FStar_List.collect extract_quantifiers queries)
in (FStar_All.pipe_right uu____3184 (FStar_Util.sort_with comp)))
in (FStar_All.pipe_right uu____3176 conflate))
in (FStar_All.pipe_right uu____3166 (FStar_List.map (fun uu____3274 -> (match (uu____3274) with
| (s, q) -> begin
(

let uu____3297 = (remove_duplicates q)
in ((s), (uu____3297)))
end)))))
in (
...
let uu____3319 = (FStar_Util.psmap_empty ())
in (FStar_List.fold_left insert uu____3319))
in (FStar_All.pipe_right uu____3156 uu____3303)))))))))


let tabular_profile : qiprofile FStar_Util.psmap  ->  Prims.string Prims.list Prims.list = (fun q -> (

let comp = (fun uu____3384 uu____3385 -> (match (((uu____3384), (uu____3385))) with
| ((i1, q1), (i2, q2)) -> begin
(match ((i1 < i2)) with
| true -> begin
(Prims.parse_int "1")
...
let uu____3467 = (quantifier_module info)
in (

let uu____3469 = (

let uu____3473 = (quantifier_file info)
in (

let uu____3475 = (

let uu____3479 = (quantifier_range info)
in (uu____3479)::[])
in (uu____3473)::uu____3475))
in (uu____3467)::uu____3469))
in ("")::uu____3463)
in ("")::uu____3459))
in (
...
let uu____3523 = (FStar_Util.psmap_try_find q k)
in (FStar_Util.must uu____3523))
...
let uu____3562 = (FStar_Util.string_of_int prof.qiprofile_instances)
in (

let uu____3564 = (

let uu____3568 = (quantifier_module hd1)
in (

let uu____3570 = (

let uu____3574 = (quantifier_file hd1)
in (

let uu____3576 = (

let uu____3580 = (quantifier_range hd1)
in (uu____3580)::[])
in (uu____3574)::uu____3576))
in (uu____3568)::uu____3570))
in (uu____3562)::uu____3564))
in (prof.qiprofile_id)::uu____3558)
in (

let uu____3588 = (FStar_List.map qid_to_tail_rows tl1)
in (uu____3554)::uu____3588))
in (FStar_List.append o uu____3548))
end)
end
| uu____3603 -> begin
o
...
let uu____3618 = (FStar_Util.psmap_fold q (fun k v1 acc -> (((v1.qiprofile_instances), (k)))::acc) [])
in (FStar_All.pipe_right uu____3618 (FStar_Util.sort_with comp)))
in (FStar_All.pipe_right uu____3609 (FStar_List.map (fun uu____3707 -> (match (uu____3707) with
| (i, q1) -> begin
q1
end)))))
in (FStar_All.pipe_right uu____3605 (FStar_List.fold_left qid_to_rows [])))))))
...
let uu____3794 = (prettyprint_table fmt tab)
in (match (uu____3794) with
| (content_string, content_length) -> begin
(

let uu____3807 = uu____3794
in (

let uu____3814 = (

let headers = (FStar_All.pipe_right queries (FStar_List.map (fun uu____3846 -> (match (uu____3846) with
| (q1, ds) -> begin
(query_name q1)
end))))
in (

let uu____3860 = (FStar_List.fold_left (fun x s -> (max x (FStar_String.length s))) (Prims.parse_int "0") headers)
in (((FStar_String.concat "\n" headers)), (uu____3860))))
in (match (uu____3814) with
| (header_string, header_length) -> begin
(

let uu____3880 = uu____3814
in (

let line = (

let uu____3889 = (max content_length header_length)
in (FStar_Util.repeat uu____3889 "-"))
in (FStar_Util.print_string (Prims.op_Hat line (Prims.op_Hat "\n" (Prims.op_Hat header_string (Prims.op_Hat "\n" (Prims.op_Hat line (Prims.op_Hat "\n" (Prims.op_Hat content_string (Prims.op_Hat "\n" (Prims.op_Hat line "\n\n"))))))))))))
end)))
end)))))
end))
