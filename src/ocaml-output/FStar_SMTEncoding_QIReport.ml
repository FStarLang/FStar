    ...
    fun tab ->
             ...
             | (ls, rs) ->
                 ...
                 (match uu____275 with
                  | (lx, rx) ->
                      ...
                      let uu____305 = max1 r rx in (uu____303, uu____305))) in
      ...
      let maxlength_init =
        FStar_Common.tabulate (FStar_List.length fmt)
          (fun uu____490 -> (Prims.int_zero, Prims.int_zero)) in
      let maxlength_list =
      ...
      let totallength =
        FStar_List.fold_left
          ...
          Prims.int_zero maxlength_list in
      let enlarge uu____568 uu____569 =
        ...
        | ((sl, sr), (l, r)) ->
            ...
            Prims.op_Hat uu____620 uu____623 in
        ...
        | (fmt_hd::fmt_tl, (ln_l, ln_r)::ln_tl, row_hd::row_tl) ->
            ...
            (match uu____736 with
             | (sl, sr) ->
                 ...
                 let uu____765 = enlarge_row fmt_tl ln_tl row_tl in uu____759
                   :: uu____765)
        | uu____770 -> [] in
      let lines =
        let uu____795 = FStar_List.map (enlarge_row fmt maxlength_list) tab in
        FStar_All.pipe_right uu____795
          (FStar_List.map (fun l -> FStar_String.concat "  " l)) in
      let totallength1 =
        FStar_List.fold_left
  ...
  fun s ->
    ...
    let comp uu____1394 uu____1395 =
      ...
      | ((qid1, inst1, gen1, cost1), (qid2, inst2, gen2, cost2)) ->
          FStar_Util.compare qid1 qid2 in
    let conflate l =
    ...
    let add1 o uu____1907 =
      ...
      | (qid, inst1, gen1, cost) ->
          FStar_Util.psmap_add o qid (inst1, gen1, cost) in
    let uu____1944 =
      let uu____1959 =
        let uu____1974 =
          let uu____1989 =
    ...
    fun decl ->
      let from_term context tm0 =
        let rec aux tm =
          ...
          | FStar_SMTEncoding_Term.Labeled (t, uu____2462, uu____2463) ->
              aux t
  ...
  fun queries ->
    fun qiprofile_output ->
      ...
      let conflate l =
        ...
        | [] -> []
        | (s, q)::tl1 ->
            let uu____2878 = aux tl1 s [q] [] in FStar_List.rev uu____2878 in
          ...
          (let uu____2933 = quantifier_file q1 in
           let uu____2935 = quantifier_file q2 in uu____2933 = uu____2935) &&
            (let uu____2940 = quantifier_range q1 in
             let uu____2942 = quantifier_range q2 in uu____2940 = uu____2942) in
        let rec rm q i o =
          match i with
          | hd1::tl1 ->
              let uu____2977 =
        ...
        | (id1, info) ->
            ...
            (match uu____3061 with
             | (inst1, gen1, cost) ->
                 ...
                 FStar_Util.psmap_add o id1 value) in
      let uu____3157 =
        let uu____3167 =
          let uu____3177 =
            let uu____3185 = FStar_List.collect extract_quantifiers queries in
        ...
        FStar_All.pipe_right uu____3167
          (FStar_List.map
             (fun uu____3275 ->
                ...
                | (s, q) ->
                    let uu____3298 = remove_duplicates q in (s, uu____3298))) in
      let uu____3304 =
  ...
  fun q ->
    let comp uu____3385 uu____3386 =
      ...
      | ((i1, q1), (i2, q2)) ->
          if i1 < i2
          then Prims.int_one
          else if i1 > i2 then ~- Prims.int_one else Prims.int_zero in
                ...
                let uu____3559 =
                  ...
                  let uu____3565 =
                    ...
                    let uu____3571 =
                      ...
                      let uu____3577 =
                        let uu____3581 = quantifier_range hd1 in [uu____3581] in
      ...
      let uu____3610 =
        let uu____3619 =
          FStar_Util.psmap_fold q
            (fun k ->
               fun v1 -> fun acc -> ((v1.qiprofile_instances), k) :: acc) [] in
        FStar_All.pipe_right uu____3619 (FStar_Util.sort_with comp) in
      FStar_All.pipe_right uu____3610
        (FStar_List.map
           (fun uu____3708 -> match uu____3708 with | (i, q1) -> q1)) in
               ...
               let uu____3815 =
                 let headers =
                   FStar_All.pipe_right queries
                     (FStar_List.map
                        (fun uu____3847 ->
                           match uu____3847 with | (q1, ds) -> query_name q1)) in
                 let uu____3861 =
                   FStar_List.fold_left
                     (fun x -> fun s -> max x (FStar_String.length s))
                     Prims.int_zero headers in
