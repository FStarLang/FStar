    ...
    fun f  ->
      let comp_to_comp_typ c1 =
        ...
        | FStar_Syntax_Syntax.GTotal (t,u_opt) ->
         ...
         in
      let uu___91_1159 = c  in
      let uu____1160 =
        let uu____1161 =
          let uu___92_1162 = comp_to_comp_typ c  in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___92_1162.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___92_1162.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___92_1162.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___92_1162.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          }  in
        FStar_Syntax_Syntax.Comp uu____1161  in
      {
        FStar_Syntax_Syntax.n = uu____1160;
        FStar_Syntax_Syntax.pos = (uu___91_1159.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___91_1159.FStar_Syntax_Syntax.vars)
      }
    ...
    fun fs  ->
      let comp_typ_set_flags c =
        ...
        | FStar_Syntax_Syntax.Comp ct ->
            let ct1 =
              let uu___93_1197 = ct  in
              {
                FStar_Syntax_Syntax.comp_univs =
                  (uu___93_1197.FStar_Syntax_Syntax.comp_univs);
                FStar_Syntax_Syntax.effect_name =
                  (uu___93_1197.FStar_Syntax_Syntax.effect_name);
                FStar_Syntax_Syntax.result_typ =
                  (uu___93_1197.FStar_Syntax_Syntax.result_typ);
                FStar_Syntax_Syntax.effect_args =
                  (uu___93_1197.FStar_Syntax_Syntax.effect_args);
                FStar_Syntax_Syntax.flags = fs
              }  in
            let uu___94_1198 = c  in
            {
              FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
              FStar_Syntax_Syntax.pos =
                (uu___94_1198.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___94_1198.FStar_Syntax_Syntax.vars)
            }
         in
...
let (set_result_typ :
  ...
  fun c  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___95_1860 = ct  in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___95_1860.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___95_1860.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___95_1860.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___95_1860.FStar_Syntax_Syntax.flags)
             })
...
let rec (eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___88_2214 = if uu___88_2214 then Equal else Unknown  in
      let equal_iff uu___89_2219 = if uu___89_2219 then Equal else NotEqual
         in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___96_3381 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___96_3381.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___96_3381.FStar_Syntax_Syntax.sort)
          }  in
              ...
              let uu____3498 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___97_3499.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____3500;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___97_3499.FStar_Syntax_Syntax.residual_flags)
                }  in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____4053 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___98_4054.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____4055;
              FStar_Syntax_Syntax.residual_flags =
                (uu___98_4054.FStar_Syntax_Syntax.residual_flags)
            }  in
      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____9475 ->
            ...
            (match uu____9490 with
             | (hd1,args) ->
                 let uu___99_9523 = t  in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___99_9523.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___99_9523.FStar_Syntax_Syntax.vars)
                 })
        | uu____9534 -> t  in
...
let rec (bottom_fold :
  ...
  fun f  ->
    fun t  ->
      ...
      let tn =
        let uu____10409 = FStar_Syntax_Subst.compress t  in
        uu____10409.FStar_Syntax_Syntax.n  in
      let tn1 =
        match tn with
        | FStar_Syntax_Syntax.Tm_app (f1,args) ->
            let uu____10435 =
              let uu____10450 = ff f1  in
              let uu____10451 =
                FStar_List.map
                  (fun uu____10470  ->
                     match uu____10470 with
                     | (a,q) -> let uu____10481 = ff a  in (uu____10481, q))
                  args
                 in
              (uu____10450, uu____10451)  in
            FStar_Syntax_Syntax.Tm_app uu____10435
        | FStar_Syntax_Syntax.Tm_abs (bs,t1,k) ->
            let uu____10511 = FStar_Syntax_Subst.open_term bs t1  in
            (match uu____10511 with
             | (bs1,t') ->
                 let t'' = ff t'  in
                 let uu____10519 =
                   let uu____10536 = FStar_Syntax_Subst.close bs1 t''  in
                   (bs1, uu____10536, k)  in
                 FStar_Syntax_Syntax.Tm_abs uu____10519)
        | FStar_Syntax_Syntax.Tm_arrow (bs,k) -> tn
        | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
            let uu____10563 = let uu____10570 = ff t1  in (uu____10570, us)
               in
            FStar_Syntax_Syntax.Tm_uinst uu____10563
        | uu____10571 -> tn  in
      f
        (let uu___100_10574 = t  in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___100_10574.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___100_10574.FStar_Syntax_Syntax.vars)
         })
  
let rec (sizeof : FStar_Syntax_Syntax.term -> Prims.int) =
  fun t  ->
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____10578 ->
        let uu____10603 =
          let uu____10604 = FStar_Syntax_Subst.compress t  in
          sizeof uu____10604  in
        (Prims.parse_int "1") + uu____10603
    | FStar_Syntax_Syntax.Tm_bvar bv ->
        let uu____10606 = sizeof bv.FStar_Syntax_Syntax.sort  in
        (Prims.parse_int "1") + uu____10606
    | FStar_Syntax_Syntax.Tm_name bv ->
        let uu____10608 = sizeof bv.FStar_Syntax_Syntax.sort  in
        (Prims.parse_int "1") + uu____10608
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
        let uu____10615 = sizeof t1  in (FStar_List.length us) + uu____10615
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____10618) ->
        let uu____10639 = sizeof t1  in
        let uu____10640 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____10651  ->
                 ...
                 | (bv,uu____10657) ->
                     let uu____10658 = sizeof bv.FStar_Syntax_Syntax.sort  in
                     acc + uu____10658) (Prims.parse_int "0") bs
           in
        uu____10639 + uu____10640
    | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
        let uu____10681 = sizeof hd1  in
        let uu____10682 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____10693  ->
                 ...
                 | (arg,uu____10699) ->
                     let uu____10700 = sizeof arg  in acc + uu____10700)
            (Prims.parse_int "0") args
           in
        uu____10681 + uu____10682
    | uu____10701 -> (Prims.parse_int "1")
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid  ->
    fun t  ->
      let uu____10708 =
        let uu____10709 = un_uinst t  in uu____10709.FStar_Syntax_Syntax.n
         in
