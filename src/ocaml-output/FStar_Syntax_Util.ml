...
let destruct_typ_as_formula:
  ...
  fun f  ->
    ...
    let destruct_q_conn t =
      ...
      let flat t1 =
        let uu____6438 = head_and_args t1 in
        match uu____6438 with
        | (t2,args) ->
            let uu____6485 = un_uinst t2 in
            let uu____6486 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____6519  ->
                      ...
                      | (t3,imp) ->
                          let uu____6530 = unascribe t3 in (uu____6530, imp))) in
            (uu____6485, uu____6486) in
      let rec aux qopt out t1 =
        let uu____6565 = let uu____6582 = flat t1 in (qopt, uu____6582) in
           ...
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               ...
               ({
                  FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                    (b::[],t2,uu____6698);
                  FStar_Syntax_Syntax.pos = uu____6699;
                  FStar_Syntax_Syntax.vars = uu____6700;_},uu____6701)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.None
        ...
        | (FStar_Pervasives_Native.None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               FStar_Syntax_Syntax.pos = uu____6872;
               FStar_Syntax_Syntax.vars = uu____6873;_},uu____6874::({
                                                                    FStar_Syntax_Syntax.n
                                                                    =
                                                                    FStar_Syntax_Syntax.Tm_abs
                                                                    (b::[],t2,uu____6877);
            ...
            aux
              (FStar_Pervasives_Native.Some
                 (is_forall
                    (tc.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v))
              (b :: out) t2
        | (FStar_Pervasives_Native.Some b,uu____6968) ->
            let bs = FStar_List.rev out in
            let uu____7002 = FStar_Syntax_Subst.open_term bs t1 in
            (match uu____7002 with
             | (bs1,t2) ->
                 let uu____7011 = patterns t2 in
        ...
        | uu____7073 -> FStar_Pervasives_Native.None in
    ...
    let destruct_sq_base_conn t =
      let uu____7139 = un_squash t in
      FStar_Util.bind_opt uu____7139
        (fun t1  ->
           let uu____7155 = head_and_args' t1 in
           match uu____7155 with
           | (hd1,args) ->
               let uu____7188 =
                 let uu____7193 =
                   let uu____7194 = un_uinst hd1 in
                   uu____7194.FStar_Syntax_Syntax.n in
                 (uu____7193, (FStar_List.length args)) in
               (match uu____7188 with
                ...
                | uu____7277 -> FStar_Pervasives_Native.None)) in
    let rec destruct_sq_forall t =
      let uu____7300 = un_squash t in
      FStar_Util.bind_opt uu____7300
        (fun t1  ->
           let uu____7315 = arrow_one t1 in
           match uu____7315 with
           | FStar_Pervasives_Native.Some (b,c) ->
               let uu____7330 =
                 let uu____7331 = is_tot_or_gtot_comp c in
                 Prims.op_Negation uu____7331 in
               if uu____7330
               then FStar_Pervasives_Native.None
               else
                 (let q =
                    let uu____7338 = comp_to_comp_typ c in
                    uu____7338.FStar_Syntax_Syntax.result_typ in
                  let uu____7339 =
                    is_free_in (FStar_Pervasives_Native.fst b) q in
                  if uu____7339
                  then
                    let uu____7342 = patterns q in
                         ...
                         let uu____7404 =
                           let uu____7407 =
                             FStar_Syntax_Syntax.as_arg
                               (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort in
                           let uu____7408 =
                             let uu____7411 = FStar_Syntax_Syntax.as_arg q in
                             [uu____7411] in
                           uu____7407 :: uu____7408 in
                         (FStar_Parser_Const.imp_lid, uu____7404) in
                       BaseConn uu____7399 in
                     FStar_Pervasives_Native.Some uu____7398))
           | uu____7414 -> FStar_Pervasives_Native.None)
    and destruct_sq_exists t =
      let uu____7422 = un_squash t in
      FStar_Util.bind_opt uu____7422
        (fun t1  ->
           let uu____7453 = head_and_args' t1 in
           ...
           | (hd1,args) ->
               ...
               (match uu____7486 with
                | (FStar_Syntax_Syntax.Tm_fvar
                   fv,(a1,uu____7515)::(a2,uu____7517)::[]) when
                    FStar_Syntax_Syntax.fv_eq_lid fv
                      FStar_Parser_Const.dtuple2_lid
                    ->
                    let uu____7552 =
                      let uu____7553 = FStar_Syntax_Subst.compress a2 in
                      uu____7553.FStar_Syntax_Syntax.n in
                    (match uu____7552 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[],q,uu____7560) ->
                         let uu____7587 = FStar_Syntax_Subst.open_term [b] q in
    ...
    and maybe_collect f1 =
      ...
      | FStar_Pervasives_Native.Some (QAll (bs,pats,phi)) ->
          let uu____7720 = destruct_sq_forall phi in
      ...
      | FStar_Pervasives_Native.Some (QEx (bs,pats,phi)) ->
          let uu____7748 = destruct_sq_exists phi in
    ...
    let uu____7777 = destruct_base_conn phi in
    FStar_Util.catch_opt uu____7777
      (fun uu____7782  ->
         let uu____7783 = destruct_q_conn phi in
         FStar_Util.catch_opt uu____7783
           (fun uu____7788  ->
              let uu____7789 = destruct_sq_base_conn phi in
              FStar_Util.catch_opt uu____7789
                (fun uu____7794  ->
                   let uu____7795 = destruct_sq_forall phi in
                   FStar_Util.catch_opt uu____7795
                     (fun uu____7800  ->
                        let uu____7801 = destruct_sq_exists phi in
                        FStar_Util.catch_opt uu____7801
                          (fun uu____7805  -> FStar_Pervasives_Native.None)))))
let action_as_lb:
  FStar_Ident.lident ->
        ...
        let uu____7815 =
          let uu____7820 =
            FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name
              ...
              FStar_Pervasives_Native.None in
          FStar_Util.Inr uu____7820 in
        let uu____7821 =
          let uu____7822 =
            FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ in
          arrow a.FStar_Syntax_Syntax.action_params uu____7822 in
        let uu____7825 =
          abs a.FStar_Syntax_Syntax.action_params
            a.FStar_Syntax_Syntax.action_defn FStar_Pervasives_Native.None in
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7815
          a.FStar_Syntax_Syntax.action_univs uu____7821
          FStar_Parser_Const.effect_Tot_lid uu____7825 in
      {
  ...
  fun t  ->
    ...
    let uu____7851 =
      let uu____7854 =
        let uu____7855 =
          let uu____7870 =
            let uu____7873 = FStar_Syntax_Syntax.as_arg t in [uu____7873] in
          (reify_, uu____7870) in
        FStar_Syntax_Syntax.Tm_app uu____7855 in
      FStar_Syntax_Syntax.mk uu____7854 in
    uu____7851 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos
let rec delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____7886 -> failwith "Impossible"
    | FStar_Syntax_Syntax.Tm_fvar fv -> fv.FStar_Syntax_Syntax.fv_delta
    | FStar_Syntax_Syntax.Tm_bvar uu____7912 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_name uu____7913 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_match uu____7914 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_uvar uu____7937 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_unknown  -> FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_type uu____7954 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_constant uu____7955 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_arrow uu____7956 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_uinst (t2,uu____7970) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____7975;
           FStar_Syntax_Syntax.index = uu____7976;
           FStar_Syntax_Syntax.sort = t2;_},uu____7978)
        -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_meta (t2,uu____7986) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____7992,uu____7993) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_app (t2,uu____8035) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_abs (uu____8056,t2,uu____8058) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_let (uu____8079,t2) -> delta_qualifier t2
...
let incr_delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  -> let uu____8107 = delta_qualifier t in incr_delta_depth uu____8107
let is_unknown: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____8112 =
      let uu____8113 = FStar_Syntax_Subst.compress t in
...
let rec list_elements:
  ...
  =
  fun e  ->
    let uu____8129 = let uu____8144 = unmeta e in head_and_args uu____8144 in
    match uu____8129 with
    | (head1,args) ->
        let uu____8171 =
          let uu____8184 =
            let uu____8185 = un_uinst head1 in
            uu____8185.FStar_Syntax_Syntax.n in
          (uu____8184, args) in
        (match uu____8171 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____8201) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid ->
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____8221::(hd1,uu____8223)::(tl1,uu____8225)::[]) when
...
let rec apply_last:
  'Auu____8316 .
    ('Auu____8316 -> 'Auu____8316) ->
      'Auu____8316 Prims.list -> 'Auu____8316 Prims.list
  =
  fun f  ->
    fun l  ->
      match l with
      | [] -> failwith "apply_last: got empty list"
      | a::[] -> let uu____8339 = f a in [uu____8339]
      | x::xs -> let uu____8344 = apply_last f xs in x :: uu____8344
let dm4f_lid:
            ...
            let uu____8388 =
              let uu____8389 =
                FStar_Syntax_Syntax.lid_as_fv l1
                  FStar_Syntax_Syntax.Delta_constant
                  (FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor) in
              FStar_Syntax_Syntax.Tm_fvar uu____8389 in
            FStar_Syntax_Syntax.mk uu____8388 in
          uu____8385 FStar_Pervasives_Native.None rng in
        let cons1 args pos =
          let uu____8402 =
            let uu____8403 =
              let uu____8404 = ctor FStar_Parser_Const.cons_lid in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____8404
                [FStar_Syntax_Syntax.U_zero] in
            FStar_Syntax_Syntax.mk_Tm_app uu____8403 args in
          uu____8402 FStar_Pervasives_Native.None pos in
        let nil args pos =
          let uu____8416 =
            let uu____8417 =
              let uu____8418 = ctor FStar_Parser_Const.nil_lid in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____8418
                [FStar_Syntax_Syntax.U_zero] in
            FStar_Syntax_Syntax.mk_Tm_app uu____8417 args in
          uu____8416 FStar_Pervasives_Native.None pos in
        let uu____8421 =
          let uu____8422 =
            let uu____8423 = FStar_Syntax_Syntax.iarg typ in [uu____8423] in
          nil uu____8422 rng in
        FStar_List.fold_right
          (fun t  ->
             fun a  ->
               let uu____8429 =
                 let uu____8430 = FStar_Syntax_Syntax.iarg typ in
                 let uu____8431 =
                   let uu____8434 = FStar_Syntax_Syntax.as_arg t in
                   let uu____8435 =
                     let uu____8438 = FStar_Syntax_Syntax.as_arg a in
                     [uu____8438] in
                   uu____8434 :: uu____8435 in
                 uu____8430 :: uu____8431 in
               cons1 uu____8429 t.FStar_Syntax_Syntax.pos) l uu____8421
let uvar_from_id:
  Prims.int ->
    FStar_Syntax_Syntax.typ ->
      FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax
  ...
  fun id1  ->
    fun t  ->
      let uu____8449 =
        let uu____8452 =
          let uu____8453 =
            let uu____8470 = FStar_Syntax_Unionfind.from_id id1 in
            (uu____8470, t) in
          FStar_Syntax_Syntax.Tm_uvar uu____8453 in
        FStar_Syntax_Syntax.mk uu____8452 in
      uu____8449 FStar_Pervasives_Native.None FStar_Range.dummyRange
let rec eqlist:
  'a .
...
let rec term_eq:
  ...
  fun t1  ->
    fun t2  ->
      let canon_app t =
        match t.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Tm_app uu____8895 ->
            let uu____8910 = head_and_args' t in
            (match uu____8910 with
             | (hd1,args) ->
                 let uu___174_8943 = t in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___174_8943.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___174_8943.FStar_Syntax_Syntax.vars)
                 })
        | uu____8954 -> t in
      let t11 = let uu____8958 = unmeta_safe t1 in canon_app uu____8958 in
      let t21 = let uu____8964 = unmeta_safe t2 in canon_app uu____8964 in
      match ((t11.FStar_Syntax_Syntax.n), (t21.FStar_Syntax_Syntax.n)) with
...
and branch_eq:
  ...
  fun uu____9335  ->
    fun uu____9336  ->
      match (uu____9335, uu____9336) with | ((p1,w1,t1),(p2,w2,t2)) -> false
let rec bottom_fold:
  (FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term) ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
  =
  fun f  ->
    fun t  ->
      ...
      let tn =
        let uu____9476 = FStar_Syntax_Subst.compress t in
        uu____9476.FStar_Syntax_Syntax.n in
      let tn1 =
        match tn with
        | FStar_Syntax_Syntax.Tm_app (f1,args) ->
            let uu____9502 =
              let uu____9517 = ff f1 in
              let uu____9518 =
                FStar_List.map
                  (fun uu____9537  ->
                     match uu____9537 with
                     | (a,q) -> let uu____9548 = ff a in (uu____9548, q))
                  args in
              (uu____9517, uu____9518) in
            FStar_Syntax_Syntax.Tm_app uu____9502
        | FStar_Syntax_Syntax.Tm_abs (bs,t1,k) ->
            let uu____9578 = FStar_Syntax_Subst.open_term bs t1 in
            (match uu____9578 with
             | (bs1,t') ->
                 let t'' = ff t' in
                 let uu____9586 =
                   let uu____9603 = FStar_Syntax_Subst.close bs1 t'' in
                   (bs1, uu____9603, k) in
                 FStar_Syntax_Syntax.Tm_abs uu____9586)
        | FStar_Syntax_Syntax.Tm_arrow (bs,k) -> tn
        | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
            let uu____9630 = let uu____9637 = ff t1 in (uu____9637, us) in
            FStar_Syntax_Syntax.Tm_uinst uu____9630
        | uu____9638 -> tn in
      f
        (let uu___175_9641 = t in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___175_9641.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___175_9641.FStar_Syntax_Syntax.vars)
         })
let rec sizeof: FStar_Syntax_Syntax.term -> Prims.int =
  fun t  ->
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____9646 ->
        let uu____9671 =
          let uu____9672 = FStar_Syntax_Subst.compress t in sizeof uu____9672 in
        (Prims.parse_int "1") + uu____9671
    | FStar_Syntax_Syntax.Tm_bvar bv ->
        let uu____9674 = sizeof bv.FStar_Syntax_Syntax.sort in
        (Prims.parse_int "1") + uu____9674
    | FStar_Syntax_Syntax.Tm_name bv ->
        let uu____9676 = sizeof bv.FStar_Syntax_Syntax.sort in
        (Prims.parse_int "1") + uu____9676
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
        let uu____9683 = sizeof t1 in (FStar_List.length us) + uu____9683
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____9686) ->
        let uu____9707 = sizeof t1 in
        let uu____9708 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____9719  ->
                 ...
                 | (bv,uu____9725) ->
                     let uu____9726 = sizeof bv.FStar_Syntax_Syntax.sort in
                     acc + uu____9726) (Prims.parse_int "0") bs in
        uu____9707 + uu____9708
    | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
        let uu____9749 = sizeof hd1 in
        let uu____9750 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____9761  ->
                 ...
                 | (arg,uu____9767) ->
                     let uu____9768 = sizeof arg in acc + uu____9768)
            (Prims.parse_int "0") args in
        uu____9749 + uu____9750
    | uu____9769 -> Prims.parse_int "1"
let is_fvar: FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool =
  fun lid  ->
    fun t  ->
      let uu____9778 =
        let uu____9779 = un_uinst t in uu____9779.FStar_Syntax_Syntax.n in
          ...
          let uu____9819 =
            let uu____9822 =
              let uu____9823 =
                let uu____9830 =
                  let uu____9831 =
                    let uu____9840 = FStar_Dyn.mkdyn b in (uu____9840, s, ty) in
                  FStar_Syntax_Syntax.Meta_alien uu____9831 in
                (FStar_Syntax_Syntax.tun, uu____9830) in
              FStar_Syntax_Syntax.Tm_meta uu____9823 in
            FStar_Syntax_Syntax.mk uu____9822 in
          uu____9819 FStar_Pervasives_Native.None
            (match r with
...
let un_alien: FStar_Syntax_Syntax.term -> FStar_Dyn.dyn =
  fun t  ->
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_meta
        (uu____9852,FStar_Syntax_Syntax.Meta_alien
         (blob,uu____9854,uu____9855))
        -> blob
    | uu____9864 -> failwith "unexpected: term was not an alien embedding"