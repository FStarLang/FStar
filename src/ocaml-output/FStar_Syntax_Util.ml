      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun b  ->
              ...
              else (let _0_198 = arg_of_non_null_binder b  in (b, _0_198))))
       in
...
let rec eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___172_1152 = if uu___172_1152 then Equal else Unknown
         in
      let equal_iff uu___173_1157 = if uu___173_1157 then Equal else NotEqual
         in
                ...
                | (FStar_Syntax_Syntax.Tm_abs (bs',t,lopt'),None ) ->
                    (FStar_Syntax_Syntax.mk
                       (FStar_Syntax_Syntax.Tm_abs
                          (let _0_227 =
                             let _0_225 = FStar_Syntax_Subst.close_binders bs
                                in
             ...
             (FStar_Syntax_Syntax.Tm_app
                (let _0_280 =
                   ...
                   let _0_278 =
                     ...
                     let _0_276 =
                       let _0_275 = FStar_Syntax_Syntax.as_arg e2  in
                       [_0_275]  in
                     _0_277 :: _0_276  in
                   _0_279 :: _0_278  in
                        ...
                        Some
                          (FStar_Util.Inl
                             (let _0_289 =
                              ...
                              FStar_All.pipe_left lcomp_of_comp _0_289))
                         in
                      abs _0_291 body _0_290)
                    in
                 [_0_292]  in
               _0_294 :: _0_293  in
...
let destruct_typ_as_formula :
  ...
  fun f  ->
             ...
             | (t,args) ->
                 ...
                 let uu____3873 =
                   (is_constructor t lid) &&
                    ...
                    in
                 if uu____3873 then Some (BaseConn (lid, args)) else None)
         in
    ...
    let patterns t =
      ...
      | uu____3930 ->
          let _0_301 = FStar_Syntax_Subst.compress t  in ([], _0_301)
       in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____4018  ->
                      ...
                      | (t,imp) -> let _0_302 = unascribe t  in (_0_302, imp)))
               in
            (_0_304, _0_303)
         in
...
let mk_reify t =
  ...
  (FStar_Syntax_Syntax.mk
     (FStar_Syntax_Syntax.Tm_app
        (let _0_308 = let _0_307 = FStar_Syntax_Syntax.as_arg t  in [_0_307]
            in
...
let is_unknown : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____4540 = (FStar_Syntax_Subst.compress t).FStar_Syntax_Syntax.n
       in
