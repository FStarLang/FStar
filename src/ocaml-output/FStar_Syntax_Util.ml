    ...
    fun f  ->
      let comp_to_comp_typ c1 =
        ...
        | FStar_Syntax_Syntax.GTotal (t,u_opt) ->
         ...
         in
      let uu___78_1084 = c  in
      let uu____1085 =
        let uu____1086 =
          let uu___79_1087 = comp_to_comp_typ c  in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___79_1087.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___79_1087.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___79_1087.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___79_1087.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          }  in
        FStar_Syntax_Syntax.Comp uu____1086  in
      {
        FStar_Syntax_Syntax.n = uu____1085;
        FStar_Syntax_Syntax.pos = (uu___78_1084.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___78_1084.FStar_Syntax_Syntax.vars)
      }
...
let set_result_typ :
  ...
  fun c  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___80_1735 = ct  in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___80_1735.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___80_1735.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___80_1735.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___80_1735.FStar_Syntax_Syntax.flags)
             })
...
let rec eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___75_1999 = if uu___75_1999 then Equal else Unknown  in
      let equal_iff uu___76_2004 = if uu___76_2004 then Equal else NotEqual
         in
      let eq_and f g = match f with | Equal  -> g () | uu____2018 -> Unknown
         in
      let eq_inj f g =
        match (f, g) with
        | (Equal ,Equal ) -> Equal
            ...
            (FStar_List.fold_left
               (fun acc  ->
                  fun uu____2129  ->
                    ...
                    | ((a1,q1),(a2,q2)) ->
                        let uu____2157 = eq_tm a1 a2  in
                        eq_inj acc uu____2157) Equal) uu____2071
        else NotEqual  in
...
let destruct :
  ...
  fun typ  ->
    fun lid  ->
      ...
      let uu____2691 =
        let uu____2692 = un_uinst typ1  in uu____2692.FStar_Syntax_Syntax.n
         in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___81_3152 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___81_3152.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___81_3152.FStar_Syntax_Syntax.sort)
          }  in
              ...
              let uu____3269 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___82_3270.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____3271;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___82_3270.FStar_Syntax_Syntax.residual_flags)
                }  in
            ...
            (match ((body.FStar_Syntax_Syntax.n), lopt) with
                ...
                (bs',t1,lopt'),FStar_Pervasives_Native.None ) ->
                 let uu____3312 =
                   let uu____3315 =
                     let uu____3316 =
                       let uu____3333 =
                         let uu____3340 = FStar_Syntax_Subst.close_binders bs
                            in
             ...
             | uu____3367 ->
                 let uu____3374 =
                   let uu____3377 =
                     let uu____3378 =
                       let uu____3395 = FStar_Syntax_Subst.close_binders bs
                          in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____3824 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___83_3825.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____3826;
              FStar_Syntax_Syntax.residual_flags =
                (uu___83_3825.FStar_Syntax_Syntax.residual_flags)
            }  in
  ...
  fun phi  ->
    let uu____4696 =
      let uu____4699 =
        let uu____4700 =
          let uu____4715 =
            let uu____4718 = FStar_Syntax_Syntax.as_arg phi  in [uu____4718]
             in
          (t_not, uu____4715)  in
  ...
  fun e  ->
    let uu____4779 =
      let uu____4782 =
        let uu____4783 =
          let uu____4798 =
            let uu____4801 = FStar_Syntax_Syntax.as_arg e  in [uu____4801]
             in
          (b2t_v, uu____4798)  in
...
let is_sub_singleton : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____5851 = let uu____5866 = unmeta t  in head_and_args uu____5866
       in
    match uu____5851 with
    | (head1,uu____5868) ->
        let uu____5889 =
          let uu____5890 = un_uinst head1  in
  ...
  fun f  ->
    ...
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____6446 =
        ...
        | (lid,arity) ->
            let uu____6455 =
              let uu____6470 = unmeta_monadic f2  in head_and_args uu____6470
               in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____6710  ->
                      ...
                      | (t3,imp) ->
                          let uu____6721 = unascribe t3  in (uu____6721, imp)))
               in
            (uu____6676, uu____6677)
         in
                         ...
                         let uu____7595 =
                           let uu____7598 =
                             FStar_Syntax_Syntax.as_arg
                              ...
                              in
                           let uu____7599 =
                             let uu____7602 = FStar_Syntax_Syntax.as_arg q
                                in
                             [uu____7602]  in
                   ...
                   fv,(a1,uu____7706)::(a2,uu____7708)::[]) when
                    ...
                    (match uu____7743 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[],q,uu____7751) ->
                         let uu____7778 = FStar_Syntax_Subst.open_term [b] q
                            in
    ...
    | FStar_Syntax_Syntax.Tm_abs (b::[],e,uu____8010) ->
        ...
        (match uu____8037 with
         | (bs,e1) ->
             ...
             let uu____8063 = is_free_in (FStar_Pervasives_Native.fst b1) e1
                in
             if uu____8063
             then
               let uu____8066 =
    ...
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____8095
          ...
          FStar_Parser_Const.effect_Tot_lid uu____8105
         in
      {
  ...
  fun t  ->
    ...
    let uu____8130 =
      let uu____8133 =
        let uu____8134 =
          let uu____8149 =
            let uu____8152 = FStar_Syntax_Syntax.as_arg t  in [uu____8152]
             in
...
let incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let uu____8383 = delta_qualifier t  in incr_delta_depth uu____8383
...
let rec list_elements :
  ...
  =
  fun e  ->
    let uu____8403 = let uu____8418 = unmeta e  in head_and_args uu____8418
       in
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____8687 =
          let uu____8688 =
            let uu____8689 = FStar_Syntax_Syntax.iarg typ  in [uu____8689]
             in
      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____9140 ->
            ...
            (match uu____9155 with
             | (hd1,args) ->
                 let uu___84_9188 = t  in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___84_9188.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___84_9188.FStar_Syntax_Syntax.vars)
                 })
        | uu____9199 -> t  in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____9881 -> tn  in
      f
        (let uu___85_9884 = t  in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___85_9884.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars = (uu___85_9884.FStar_Syntax_Syntax.vars)
         })
...
let rec sizeof : FStar_Syntax_Syntax.term -> Prims.int =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_delayed uu____9888 ->
        let uu____9913 =
          let uu____9914 = FStar_Syntax_Subst.compress t  in
          sizeof uu____9914  in
            ...
            (fun acc  ->
               fun uu____9961  ->
                 ...
                 | (bv,uu____9967) ->
                     ...
                     acc + uu____9968) (Prims.parse_int "0") bs
           in
...
let is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool =
  fun lid  ->
    fun t  ->
      let uu____10018 =
        let uu____10019 = un_uinst t  in uu____10019.FStar_Syntax_Syntax.n
         in
