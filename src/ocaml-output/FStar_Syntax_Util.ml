      ...
      let uu___2 =
        let uu___3 =
          let uu___4 =
            ...
            let uu___6 = FStar_Ident.range_of_lid lid  in (uu___5, uu___6)
             in
...
let (name_function_binders :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (binders,comp) ->
        let uu___ =
          let uu___1 = let uu___2 = name_binders binders  in (uu___2, comp)
             in
  ...
  fun t1  ->
    fun t2  ->
      ...
      | (FStar_Syntax_Syntax.Tm_constant c,FStar_Syntax_Syntax.Tm_constant d)
          -> let uu___ = FStar_Const.eq_const c d  in equal_iff uu___
      | (FStar_Syntax_Syntax.Tm_uvar
         (u1,([],uu___)),FStar_Syntax_Syntax.Tm_uvar (u2,([],uu___1))) ->
          let uu___2 =
                 ...
                 let uu___3 =
                   (let uu___4 = eq_tm t1 t2  in uu___4 = Equal) &&
                     (related_by
                        (fun t11  ->
                           fun t21  ->
                             let uu___4 = eq_tm t11 t21  in uu___4 = Equal)
                        w1 w2)
                    in
...
let (destruct :
  ...
  fun typ  ->
    fun lid  ->
      ...
      let uu___ = let uu___1 = un_uinst typ1  in uu___1.FStar_Syntax_Syntax.n
         in
      match uu___ with
      | FStar_Syntax_Syntax.Tm_app (head,args) ->
...
let (lids_of_sigelt :
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_effect_abbrev (lid,uu___,uu___1,uu___2,uu___3)
        -> [lid]
    | FStar_Syntax_Syntax.Sig_datacon (lid,uu___,uu___1,uu___2,uu___3,uu___4)
        -> [lid]
            ...
            (match body.FStar_Syntax_Syntax.n with
             | FStar_Syntax_Syntax.Tm_abs (bs',t1,lopt') ->
                 let uu___1 =
                   let uu___2 =
                     ...
                     let uu___4 = close_lopt lopt'  in (uu___3, t1, uu___4)
                      in
             ...
             | uu___1 ->
                 let uu___2 =
                   let uu___3 =
                     let uu___4 = FStar_Syntax_Subst.close_binders bs  in
                     let uu___5 = close_lopt lopt  in (uu___4, body, uu___5)
                      in
...
let rec (arrow_formals_comp_ln :
  ...
  fun k  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
        let uu___ =
          (is_total_comp c) &&
            (let uu___1 = has_decreases c  in Prims.op_Negation uu___1)
           in
        if uu___
        then
    ...
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu___;
           ...
           FStar_Syntax_Syntax.sort = s;_},uu___2)
        ->
        let rec aux s1 k2 =
          let uu___3 =
          ...
          | FStar_Syntax_Syntax.Tm_refine
              ({ FStar_Syntax_Syntax.ppname = uu___4;
                 ...
                 FStar_Syntax_Syntax.sort = s2;_},uu___6)
              -> aux s2 k2
          | uu___4 ->
              let uu___5 = FStar_Syntax_Syntax.mk_Total k2  in ([], uu___5)
           in
        aux s k1
  ...
  fun lb  ->
    let rec arrow_until_decreases k =
      ...
      | FStar_Syntax_Syntax.Tm_refine
          ({ FStar_Syntax_Syntax.ppname = uu___;
             FStar_Syntax_Syntax.index = uu___1;
             FStar_Syntax_Syntax.sort = k2;_},uu___2)
               ...
               let uu___3 =
                 FStar_All.pipe_right bs
                   (FStar_List.map
                      (fun uu___4  ->
                         match uu___4 with
                         | (x,uu___5) -> FStar_Util.set_mem x d_bvs))
                  in
                    ...
                    | (FStar_Pervasives_Native.Some fvs,uu___) ->
                        let universes =
                          FStar_All.pipe_right univ_vars
                            (FStar_List.map
                               (fun uu___1  ->
                                  FStar_Syntax_Syntax.U_name uu___1))
                           in
                        let inst =
...
let rec (is_constructed_typ :
  ...
  fun t  ->
    fun lid  ->
      ...
      | FStar_Syntax_Syntax.Tm_uinst (t1,uu___1) -> is_constructed_typ t1 lid
      | uu___1 -> false
...
let (type_u :
  ...
  fun uu___  ->
    let u =
      let uu___1 = FStar_Syntax_Unionfind.univ_fresh FStar_Range.dummyRange
         in
            ...
            let uu___1 =
              let uu___2 =
                let uu___3 =
                  ...
                  let uu___5 =
                    let uu___6 = FStar_Syntax_Syntax.as_arg phi2  in [uu___6]
                     in
                  uu___4 :: uu___5  in
                (tand, uu___3)  in
...
let (mk_neg :
  ...
  fun phi  ->
    let uu___ =
      let uu___1 =
        let uu___2 = let uu___3 = FStar_Syntax_Syntax.as_arg phi  in [uu___3]
           in
        (t_not, uu___2)  in
      FStar_Syntax_Syntax.Tm_app uu___1  in
...
let (b2t :
  ...
  fun e  ->
    let uu___ =
      let uu___1 =
        let uu___2 = let uu___3 = FStar_Syntax_Syntax.as_arg e  in [uu___3]
           in
        (b2t_v, uu___2)  in
      FStar_Syntax_Syntax.Tm_app uu___1  in
            ...
            let uu___1 =
              let uu___2 =
                ...
                let uu___4 =
                  ...
                  let uu___6 =
                    let uu___7 = FStar_Syntax_Syntax.as_arg e2  in [uu___7]
                     in
                  uu___5 :: uu___6  in
                uu___3 :: uu___4  in
              (eq_inst, uu___2)  in
        ...
        (match uu___1 with
         | (FStar_Syntax_Syntax.Tm_uinst
            ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
               ...
               FStar_Syntax_Syntax.vars = uu___3;_},u::[]),(t1,uu___4)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid
...
let (arrow_one_ln :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (b::bs,c) ->
        let uu___1 =
          let uu___2 =
            let uu___3 = arrow bs c  in FStar_Syntax_Syntax.mk_Total uu___3
             in
          (b, uu___2)  in
        FStar_Pervasives_Native.Some uu___1
    | uu___1 -> FStar_Pervasives_Native.None
...
let (destruct_typ_as_formula :
  ...
  fun f  ->
    let rec unmeta_monadic f1 =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          (t,FStar_Syntax_Syntax.Meta_monadic_lift uu___) -> unmeta_monadic t
      | uu___ -> f2  in
    ...
    let destruct_sq_base_conn t =
      ...
      FStar_Util.bind_opt uu___
        (fun t1  ->
           ...
           | (hd,args) ->
               let uu___2 =
                 let uu___3 = un_uinst hd  in uu___3.FStar_Syntax_Syntax.n
                  in
               (match uu___2 with
                | FStar_Syntax_Syntax.Tm_fvar fv ->
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu___3  ->
                      match uu___3 with
                      | (t3,imp) ->
                          let uu___4 = unascribe t3  in (uu___4, imp)))
               in
            (uu___1, uu___2)
         in
           ...
           | FStar_Pervasives_Native.Some (b,c) ->
               ...
               then FStar_Pervasives_Native.None
                 ...
                 (let q =
                  ...
                  let uu___4 = is_free_in (FStar_Pervasives_Native.fst b) q
                     in
                  if uu___4
                  then
      ...
      FStar_Util.bind_opt uu___
        (fun t1  ->
           ...
           | (hd,args) ->
               let uu___2 =
                 let uu___3 =
                   let uu___4 = un_uinst hd  in uu___4.FStar_Syntax_Syntax.n
                    in
                 (uu___3, args)  in
               (match uu___2 with
                | (FStar_Syntax_Syntax.Tm_fvar
                   fv,(a1,uu___3)::(a2,uu___4)::[]) when
                    FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      fun pos  ->
        let lb =
          ...
          close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu___
            ...
            FStar_Parser_Const.effect_Tot_lid uu___2 [] pos
           in
        {
...
let (mk_reify :
  ...
  fun t  ->
    ...
    let uu___ =
      let uu___1 =
        let uu___2 = let uu___3 = FStar_Syntax_Syntax.as_arg t  in [uu___3]
           in
        (reify_, uu___2)  in
      FStar_Syntax_Syntax.Tm_app uu___1  in
    FStar_Syntax_Syntax.mk uu___ t.FStar_Syntax_Syntax.pos
...
let rec (delta_qualifier :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu___,uu___1) -> delta_qualifier t2
    ...
    fun rng  ->
      fun l  ->
        ...
        let nil args pos =
          ...
          FStar_Syntax_Syntax.mk_Tm_app uu___ args pos  in
        let uu___ =
          let uu___1 = let uu___2 = FStar_Syntax_Syntax.iarg typ  in [uu___2]
             in
          nil uu___1 rng  in
        FStar_List.fold_right
          (fun t  ->
             fun a  ->
               let uu___1 =
                 ...
                 let uu___3 =
                   ...
                   let uu___5 =
                     let uu___6 = FStar_Syntax_Syntax.as_arg a  in [uu___6]
                      in
                   uu___4 :: uu___5  in
                 uu___2 :: uu___3  in
  ...
  fun dbg  ->
    fun t1  ->
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_uvar
           (u1,uu___1),FStar_Syntax_Syntax.Tm_uvar (u2,uu___2)) ->
            check "uvar"
        ...
        | (FStar_Syntax_Syntax.Tm_quoted
           (qt1,qi1),FStar_Syntax_Syntax.Tm_quoted (qt2,qi2)) ->
            (let uu___1 =
               let uu___2 = eq_quoteinfo qi1 qi2  in uu___2 = Equal  in
...
let (term_eq :
  ...
  fun t1  ->
    fun t2  ->
      let r =
        let uu___ = FStar_ST.op_Bang debug_term_eq  in
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid  ->
    fun t  ->
      let uu___ = let uu___1 = un_uinst t  in uu___1.FStar_Syntax_Syntax.n
         in
      match uu___ with
      | FStar_Syntax_Syntax.Tm_fvar fv ->
  ...
  fun tm  ->
    ...
    | FStar_Syntax_Syntax.Tm_app (t1,args) ->
        let uu___ =
          FStar_List.collect
            (fun uu___1  ->
               match uu___1 with | (x,uu___2) -> unbound_variables x) args
           in
                  ...
                  | (p,wopt,t2) ->
                      ...
                      let uu___4 =
                        ...
                        | FStar_Pervasives_Native.Some t3 ->
                         ...
                         in
                      FStar_List.append uu___3 uu___4))
           in
            ...
            | FStar_Util.Inl bv ->
                let uu___4 =
                  FStar_Syntax_Subst.open_term
                   ...
                   in
                (match uu___4 with | (uu___5,t2) -> unbound_variables t2)
             in
             ...
             let uu___3 =
               FStar_List.collect
                 (fun lb  ->
                    ...
                    FStar_List.append uu___4 uu___5) lbs1
                in
             FStar_List.append uu___2 uu___3)
    ...
    | FStar_Syntax_Syntax.Tm_abs (b::[],e,uu___1) ->
        ...
        (match uu___2 with
         | (bs,e1) ->
             ...
             then
               let uu___4 =
                 let uu___5 = FStar_Syntax_Syntax.as_arg exp_unit  in
                 [uu___5]  in
               mk_app t uu___4
             else e1)
    | uu___1 ->
...
let (smt_lemma_as_forall :
  ...
  fun t  ->
    fun universe_of_binders  ->
      ...
      let one_pat p =
        let uu___ =
          let uu___1 = unmeta p  in FStar_All.pipe_right uu___1 head_and_args
           in
        match uu___ with
        | (head,args) ->
            let uu___1 =
              let uu___2 =
                let uu___3 = un_uinst head  in uu___3.FStar_Syntax_Syntax.n
                 in
              (uu___2, args)  in
            (match uu___1 with
             | (FStar_Syntax_Syntax.Tm_fvar fv,(uu___2,uu___3)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             | uu___2 ->
                 ...
                 FStar_Errors.raise_error uu___3 p.FStar_Syntax_Syntax.pos)
         in
      let lemma_pats p =
        ...
        | t1::[] ->
            ...
            (match uu___ with
             ...
             | uu___1 ->
                 ...
                 [uu___2])
        | uu___ ->
            let uu___1 = FStar_All.pipe_right elts (FStar_List.map one_pat)
               in
            [uu___1]
         in
      let uu___ =
          ...
          let body =
            let uu___1 =
              let uu___2 =
                ...
                let uu___4 =
                  let uu___5 =
                    let uu___6 = FStar_Syntax_Syntax.binders_to_names binders
                       in
                    (uu___6, patterns)  in
  ...
  fun f  ->
    fun combs  ->
      let map_tuple uu___ =
        match uu___ with
        | (ts1,ts2) ->
            let uu___1 = f ts1  in let uu___2 = f ts2  in (uu___1, uu___2)
         in
