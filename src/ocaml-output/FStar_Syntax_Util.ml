  ...
  fun phi  ->
    let uu____4738 =
      let uu____4741 =
        let uu____4742 =
          let uu____4757 =
            let uu____4760 = FStar_Syntax_Syntax.as_arg phi  in [uu____4760]
             in
          (t_not, uu____4757)  in
  ...
  fun e  ->
    let uu____4821 =
      let uu____4824 =
        let uu____4825 =
          let uu____4840 =
            let uu____4843 = FStar_Syntax_Syntax.as_arg e  in [uu____4843]
             in
          (b2t_v, uu____4840)  in
...
let (is_sub_singleton : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____5944 = let uu____5959 = unmeta t  in head_and_args uu____5959
       in
    match uu____5944 with
    | (head1,uu____5961) ->
        let uu____5982 =
          let uu____5983 = un_uinst head1  in
  ...
  fun f  ->
    ...
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____6539 =
        ...
        | (lid,arity) ->
            let uu____6548 =
              let uu____6563 = unmeta_monadic f2  in head_and_args uu____6563
               in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____6803  ->
                      ...
                      | (t3,imp) ->
                          let uu____6814 = unascribe t3  in (uu____6814, imp)))
               in
                         ...
                         let uu____7688 =
                           let uu____7691 =
                             FStar_Syntax_Syntax.as_arg
                              ...
                              in
                           let uu____7692 =
                             let uu____7695 = FStar_Syntax_Syntax.as_arg q
                                in
                             [uu____7695]  in
                   ...
                   fv,(a1,uu____7799)::(a2,uu____7801)::[]) when
                    ...
                    (match uu____7836 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[],q,uu____7844) ->
                         let uu____7871 = FStar_Syntax_Subst.open_term [b] q
                            in
    ...
    | FStar_Syntax_Syntax.Tm_abs (b::[],e,uu____8103) ->
        ...
        (match uu____8130 with
         | (bs,e1) ->
             ...
             let uu____8156 = is_free_in (FStar_Pervasives_Native.fst b1) e1
                in
             if uu____8156
             then
               let uu____8159 =
    ...
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____8188
          ...
          FStar_Parser_Const.effect_Tot_lid uu____8198
         in
      {
  ...
  fun t  ->
    ...
    let uu____8223 =
      let uu____8226 =
        let uu____8227 =
          let uu____8242 =
            let uu____8245 = FStar_Syntax_Syntax.as_arg t  in [uu____8245]
             in
...
let (incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth) =
  fun t  ->
    let uu____8476 = delta_qualifier t  in incr_delta_depth uu____8476
...
let rec (list_elements :
  ...
  =
  fun e  ->
    let uu____8496 = let uu____8511 = unmeta e  in head_and_args uu____8511
       in
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____8780 =
          let uu____8781 =
            let uu____8782 = FStar_Syntax_Syntax.iarg typ  in [uu____8782]
             in
      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____9233 ->
            ...
            (match uu____9248 with
             | (hd1,args) ->
                 let uu___58_9281 = t  in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___58_9281.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___58_9281.FStar_Syntax_Syntax.vars)
                 })
        | uu____9292 -> t  in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____9974 -> tn  in
      f
        (let uu___59_9977 = t  in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___59_9977.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars = (uu___59_9977.FStar_Syntax_Syntax.vars)
         })
            ...
            (fun acc  ->
               fun uu____10054  ->
                 ...
                 | (bv,uu____10060) ->
                     ...
                     acc + uu____10061) (Prims.parse_int "0") bs
           in
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid  ->
    fun t  ->
      let uu____10111 =
        let uu____10112 = un_uinst t  in uu____10112.FStar_Syntax_Syntax.n
         in
  ...
  fun p  ->
    fun r  ->
      let set_options1 t s =
        let uu____10203 = FStar_Options.set_options t s  in
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____10211 = FStar_Options.restore_cmd_line_options false
               in
            FStar_All.pipe_right uu____10211 FStar_Pervasives.ignore);
           (match sopt with
            | FStar_Pervasives_Native.None  -> ()
