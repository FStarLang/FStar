  ...
  fun phi  ->
    let uu____4728 =
      let uu____4731 =
        let uu____4732 =
          let uu____4747 =
            let uu____4750 = FStar_Syntax_Syntax.as_arg phi  in [uu____4750]
             in
          (t_not, uu____4747)  in
  ...
  fun e  ->
    let uu____4822 =
      let uu____4825 =
        let uu____4826 =
          let uu____4841 =
            let uu____4844 = FStar_Syntax_Syntax.as_arg e  in [uu____4844]
             in
          (b2t_v, uu____4841)  in
  ...
  fun f  ->
    ...
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____6000 =
        ...
        | (lid,arity) ->
            let uu____6009 =
              let uu____6024 = unmeta_monadic f2  in head_and_args uu____6024
               in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          (pats, uu____6125)
      | uu____6136 ->
          let uu____6137 = FStar_Syntax_Subst.compress t1  in
          ([], uu____6137)
       in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____6265  ->
                      ...
                      | (t3,imp) ->
                          let uu____6276 = unascribe t3  in (uu____6276, imp)))
               in
    ...
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7609
          ...
          FStar_Parser_Const.effect_Tot_lid uu____7619
         in
      {
  ...
  fun t  ->
    ...
    let uu____7645 =
      let uu____7648 =
        let uu____7649 =
          let uu____7664 =
            let uu____7667 = FStar_Syntax_Syntax.as_arg t  in [uu____7667]
             in
...
let incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let uu____7901 = delta_qualifier t  in incr_delta_depth uu____7901
...
let rec list_elements :
  ...
  =
  fun e  ->
    let uu____7923 = let uu____7938 = unmeta e  in head_and_args uu____7938
       in
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____8215 =
          let uu____8216 =
            let uu____8217 = FStar_Syntax_Syntax.iarg typ  in [uu____8217]
             in
      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____8697 ->
            ...
            (match uu____8712 with
             | (hd1,args) ->
                 let uu___171_8745 = t  in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___171_8745.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___171_8745.FStar_Syntax_Syntax.vars)
                 })
        | uu____8756 -> t  in
      let t11 = canon_app t1  in
      let t21 = canon_app t2  in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____9436 -> tn  in
      f
        (let uu___172_9439 = t  in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___172_9439.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___172_9439.FStar_Syntax_Syntax.vars)
         })
...
let rec sizeof : FStar_Syntax_Syntax.term -> Prims.int =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_delayed uu____9444 ->
        let uu____9469 =
          let uu____9470 = FStar_Syntax_Subst.compress t  in
          sizeof uu____9470  in
            ...
            (fun acc  ->
               fun uu____9517  ->
                 ...
                 | (bv,uu____9523) ->
                     ...
                     acc + uu____9524) (Prims.parse_int "0") bs
           in
