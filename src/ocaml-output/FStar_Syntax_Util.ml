  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___171_3249 = x in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___171_3249.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___171_3249.FStar_Syntax_Syntax.sort)
          } in
      ...
      fun lopt  ->
        let close_lopt lopt1 =
          ...
          | FStar_Pervasives_Native.Some rc ->
              let uu____3373 =
                let uu___172_3374 = rc in
                let uu____3375 =
                  FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                    (FStar_Syntax_Subst.close bs) in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___172_3374.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____3375;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___172_3374.FStar_Syntax_Syntax.residual_flags)
                } in
...
let abs_formals:
  ...
  fun t  ->
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____3928 =
            let uu___173_3929 = rc in
            let uu____3930 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (FStar_Syntax_Subst.subst s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___173_3929.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____3930;
              FStar_Syntax_Syntax.residual_flags =
                (uu___173_3929.FStar_Syntax_Syntax.residual_flags)
            } in
        ...
        let uu____7829 =
          let uu____7834 =
            FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name
              ...
              FStar_Pervasives_Native.None in
          FStar_Util.Inr uu____7834 in
        let uu____7835 =
          let uu____7836 =
            FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ in
          arrow a.FStar_Syntax_Syntax.action_params uu____7836 in
        let uu____7839 =
          abs a.FStar_Syntax_Syntax.action_params
            a.FStar_Syntax_Syntax.action_defn FStar_Pervasives_Native.None in
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7829
          a.FStar_Syntax_Syntax.action_univs uu____7835
          FStar_Parser_Const.effect_Tot_lid uu____7839 in
      {
  ...
  fun t  ->
    ...
    let uu____7865 =
      let uu____7868 =
        let uu____7869 =
          let uu____7884 =
            let uu____7887 = FStar_Syntax_Syntax.as_arg t in [uu____7887] in
          (reify_, uu____7884) in
        FStar_Syntax_Syntax.Tm_app uu____7869 in
      FStar_Syntax_Syntax.mk uu____7868 in
    uu____7865 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos
let rec delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____7900 -> failwith "Impossible"
    | FStar_Syntax_Syntax.Tm_fvar fv -> fv.FStar_Syntax_Syntax.fv_delta
    | FStar_Syntax_Syntax.Tm_bvar uu____7926 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_name uu____7927 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_match uu____7928 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_uvar uu____7951 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_unknown  -> FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_type uu____7968 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_constant uu____7969 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_arrow uu____7970 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_uinst (t2,uu____7984) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____7989;
           FStar_Syntax_Syntax.index = uu____7990;
           FStar_Syntax_Syntax.sort = t2;_},uu____7992)
        -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_meta (t2,uu____8000) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____8006,uu____8007) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_app (t2,uu____8049) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_abs (uu____8070,t2,uu____8072) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_let (uu____8093,t2) -> delta_qualifier t2
...
let incr_delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  -> let uu____8121 = delta_qualifier t in incr_delta_depth uu____8121
let is_unknown: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____8126 =
      let uu____8127 = FStar_Syntax_Subst.compress t in
      uu____8127.FStar_Syntax_Syntax.n in
...
let rec list_elements:
  ...
  =
  fun e  ->
    let uu____8143 = let uu____8158 = unmeta e in head_and_args uu____8158 in
    match uu____8143 with
    | (head1,args) ->
        let uu____8185 =
          let uu____8198 =
            let uu____8199 = un_uinst head1 in
            uu____8199.FStar_Syntax_Syntax.n in
          (uu____8198, args) in
        (match uu____8185 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____8215) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid ->
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____8235::(hd1,uu____8237)::(tl1,uu____8239)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid ->
             let uu____8286 =
               let uu____8291 =
                 let uu____8296 = list_elements tl1 in
                 FStar_Util.must uu____8296 in
               hd1 :: uu____8291 in
             FStar_Pervasives_Native.Some uu____8286
         | uu____8309 -> FStar_Pervasives_Native.None)
let rec apply_last:
  'Auu____8330 .
    ('Auu____8330 -> 'Auu____8330) ->
      'Auu____8330 Prims.list -> 'Auu____8330 Prims.list
  =
  fun f  ->
    fun l  ->
      match l with
      | [] -> failwith "apply_last: got empty list"
      | a::[] -> let uu____8353 = f a in [uu____8353]
      | x::xs -> let uu____8358 = apply_last f xs in x :: uu____8358
let dm4f_lid:
    ...
    fun rng  ->
      fun l  ->
            ...
            let uu____8402 =
              let uu____8403 =
                FStar_Syntax_Syntax.lid_as_fv l1
                  FStar_Syntax_Syntax.Delta_constant
                  (FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor) in
              FStar_Syntax_Syntax.Tm_fvar uu____8403 in
            FStar_Syntax_Syntax.mk uu____8402 in
          uu____8399 FStar_Pervasives_Native.None rng in
        let cons1 args pos =
          let uu____8416 =
            let uu____8417 =
              let uu____8418 = ctor FStar_Parser_Const.cons_lid in
        ...
        let nil args pos =
          let uu____8430 =
            let uu____8431 =
              let uu____8432 = ctor FStar_Parser_Const.nil_lid in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____8432
                [FStar_Syntax_Syntax.U_zero] in
            FStar_Syntax_Syntax.mk_Tm_app uu____8431 args in
          uu____8430 FStar_Pervasives_Native.None pos in
        let uu____8435 =
          let uu____8436 =
            let uu____8437 = FStar_Syntax_Syntax.iarg typ in [uu____8437] in
          nil uu____8436 rng in
        FStar_List.fold_right
          (fun t  ->
             fun a  ->
               let uu____8443 =
                 let uu____8444 = FStar_Syntax_Syntax.iarg typ in
                 let uu____8445 =
                   let uu____8448 = FStar_Syntax_Syntax.as_arg t in
                   let uu____8449 =
                     let uu____8452 = FStar_Syntax_Syntax.as_arg a in
                     [uu____8452] in
                   uu____8448 :: uu____8449 in
                 uu____8444 :: uu____8445 in
               cons1 uu____8443 t.FStar_Syntax_Syntax.pos) l uu____8435
let uvar_from_id:
  Prims.int ->
    FStar_Syntax_Syntax.typ ->
      FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax
  ...
  fun id  ->
    fun t  ->
      let uu____8463 =
        let uu____8466 =
          let uu____8467 =
            let uu____8484 = FStar_Syntax_Unionfind.from_id id in
            (uu____8484, t) in
          FStar_Syntax_Syntax.Tm_uvar uu____8467 in
        FStar_Syntax_Syntax.mk uu____8466 in
      uu____8463 FStar_Pervasives_Native.None FStar_Range.dummyRange
let rec eqlist:
  'a .
...
let rec term_eq:
  ...
  fun t1  ->
    fun t2  ->
      let canon_app t =
        match t.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Tm_app uu____8909 ->
            let uu____8924 = head_and_args' t in
            (match uu____8924 with
             | (hd1,args) ->
                 let uu___174_8957 = t in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___174_8957.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___174_8957.FStar_Syntax_Syntax.vars)
                 })
        | uu____8968 -> t in
      let t11 = let uu____8972 = unmeta_safe t1 in canon_app uu____8972 in
      let t21 = let uu____8978 = unmeta_safe t2 in canon_app uu____8978 in
      match ((t11.FStar_Syntax_Syntax.n), (t21.FStar_Syntax_Syntax.n)) with
...
and branch_eq:
  ...
  fun uu____9349  ->
    fun uu____9350  ->
      match (uu____9349, uu____9350) with | ((p1,w1,t1),(p2,w2,t2)) -> false
let rec bottom_fold:
  (FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term) ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
  =
  fun f  ->
    fun t  ->
      ...
      let tn =
        let uu____9490 = FStar_Syntax_Subst.compress t in
        uu____9490.FStar_Syntax_Syntax.n in
      let tn1 =
        match tn with
        | FStar_Syntax_Syntax.Tm_app (f1,args) ->
            let uu____9516 =
              let uu____9531 = ff f1 in
              let uu____9532 =
                FStar_List.map
                  (fun uu____9551  ->
                     match uu____9551 with
                     | (a,q) -> let uu____9562 = ff a in (uu____9562, q))
                  args in
              (uu____9531, uu____9532) in
            FStar_Syntax_Syntax.Tm_app uu____9516
        | FStar_Syntax_Syntax.Tm_abs (bs,t1,k) ->
            let uu____9592 = FStar_Syntax_Subst.open_term bs t1 in
            (match uu____9592 with
             | (bs1,t') ->
                 let t'' = ff t' in
                 let uu____9600 =
                   let uu____9617 = FStar_Syntax_Subst.close bs1 t'' in
                   (bs1, uu____9617, k) in
                 FStar_Syntax_Syntax.Tm_abs uu____9600)
        | FStar_Syntax_Syntax.Tm_arrow (bs,k) -> tn
        | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
            let uu____9644 = let uu____9651 = ff t1 in (uu____9651, us) in
            FStar_Syntax_Syntax.Tm_uinst uu____9644
        | uu____9652 -> tn in
      f
        (let uu___175_9655 = t in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___175_9655.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___175_9655.FStar_Syntax_Syntax.vars)
         })
let rec sizeof: FStar_Syntax_Syntax.term -> Prims.int =
  fun t  ->
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____9660 ->
        let uu____9685 =
          let uu____9686 = FStar_Syntax_Subst.compress t in sizeof uu____9686 in
        (Prims.parse_int "1") + uu____9685
    | FStar_Syntax_Syntax.Tm_bvar bv ->
        let uu____9688 = sizeof bv.FStar_Syntax_Syntax.sort in
        (Prims.parse_int "1") + uu____9688
    | FStar_Syntax_Syntax.Tm_name bv ->
        let uu____9690 = sizeof bv.FStar_Syntax_Syntax.sort in
        (Prims.parse_int "1") + uu____9690
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
        let uu____9697 = sizeof t1 in (FStar_List.length us) + uu____9697
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____9700) ->
        let uu____9721 = sizeof t1 in
        let uu____9722 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____9733  ->
                 ...
                 | (bv,uu____9739) ->
                     let uu____9740 = sizeof bv.FStar_Syntax_Syntax.sort in
                     acc + uu____9740) (Prims.parse_int "0") bs in
        uu____9721 + uu____9722
    | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
        let uu____9763 = sizeof hd1 in
        let uu____9764 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____9775  ->
                 ...
                 | (arg,uu____9781) ->
                     let uu____9782 = sizeof arg in acc + uu____9782)
            (Prims.parse_int "0") args in
        uu____9763 + uu____9764
    | uu____9783 -> Prims.parse_int "1"
let is_fvar: FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool =
  fun lid  ->
    fun t  ->
      let uu____9792 =
        let uu____9793 = un_uinst t in uu____9793.FStar_Syntax_Syntax.n in
          ...
          let uu____9833 =
            let uu____9836 =
              let uu____9837 =
                let uu____9844 =
                  let uu____9845 =
                    let uu____9854 = FStar_Dyn.mkdyn b in (uu____9854, s, ty) in
                  FStar_Syntax_Syntax.Meta_alien uu____9845 in
                (FStar_Syntax_Syntax.tun, uu____9844) in
              FStar_Syntax_Syntax.Tm_meta uu____9837 in
            FStar_Syntax_Syntax.mk uu____9836 in
          uu____9833 FStar_Pervasives_Native.None
            (match r with
...
let un_alien: FStar_Syntax_Syntax.term -> FStar_Dyn.dyn =
  fun t  ->
    ...
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_meta
        (uu____9867,FStar_Syntax_Syntax.Meta_alien
         (blob,uu____9869,uu____9870))
        -> blob
    | uu____9879 -> failwith "unexpected: term was not an alien embedding"