    ...
    fun f  ->
      let comp_to_comp_typ c1 =
        ...
        | FStar_Syntax_Syntax.GTotal (t,u_opt) ->
         ...
         in
      let uu___73_1159 = c  in
      let uu____1160 =
        let uu____1161 =
          let uu___74_1162 = comp_to_comp_typ c  in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___74_1162.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___74_1162.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___74_1162.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___74_1162.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          }  in
        FStar_Syntax_Syntax.Comp uu____1161  in
      {
        FStar_Syntax_Syntax.n = uu____1160;
        FStar_Syntax_Syntax.pos = (uu___73_1159.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___73_1159.FStar_Syntax_Syntax.vars)
      }
    ...
    fun fs  ->
      let comp_typ_set_flags c =
        ...
        | FStar_Syntax_Syntax.Comp ct ->
            let ct1 =
              let uu___75_1197 = ct  in
              {
                FStar_Syntax_Syntax.comp_univs =
                  (uu___75_1197.FStar_Syntax_Syntax.comp_univs);
                FStar_Syntax_Syntax.effect_name =
                  (uu___75_1197.FStar_Syntax_Syntax.effect_name);
                FStar_Syntax_Syntax.result_typ =
                  (uu___75_1197.FStar_Syntax_Syntax.result_typ);
                FStar_Syntax_Syntax.effect_args =
                  (uu___75_1197.FStar_Syntax_Syntax.effect_args);
                FStar_Syntax_Syntax.flags = fs
              }  in
            let uu___76_1198 = c  in
            {
              FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
              FStar_Syntax_Syntax.pos =
                (uu___76_1198.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___76_1198.FStar_Syntax_Syntax.vars)
            }
         in
...
let (set_result_typ :
  ...
  fun c  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___77_1860 = ct  in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___77_1860.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___77_1860.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___77_1860.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___77_1860.FStar_Syntax_Syntax.flags)
             })
...
let rec (eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___70_2214 = if uu___70_2214 then Equal else Unknown  in
      let equal_iff uu___71_2219 = if uu___71_2219 then Equal else NotEqual
         in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___78_3381 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___78_3381.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___78_3381.FStar_Syntax_Syntax.sort)
          }  in
              ...
              let uu____3498 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___79_3499.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____3500;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___79_3499.FStar_Syntax_Syntax.residual_flags)
                }  in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____4053 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___80_4054.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____4055;
              FStar_Syntax_Syntax.residual_flags =
                (uu___80_4054.FStar_Syntax_Syntax.residual_flags)
            }  in
      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____9475 ->
            ...
            (match uu____9490 with
             | (hd1,args) ->
                 let uu___81_9523 = t  in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___81_9523.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___81_9523.FStar_Syntax_Syntax.vars)
                 })
        | uu____9534 -> t  in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____10571 -> tn  in
      f
        (let uu___82_10574 = t  in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___82_10574.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___82_10574.FStar_Syntax_Syntax.vars)
         })
