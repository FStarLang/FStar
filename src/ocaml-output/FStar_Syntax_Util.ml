...
let (is_fun : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun e  ->
    ...
    | FStar_Syntax_Syntax.Tm_abs uu____5090 -> true
    | uu____5110 -> false
  
let (is_function_typ : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____5119 =
      let uu____5120 = FStar_Syntax_Subst.compress t  in
      uu____5120.FStar_Syntax_Syntax.n  in
    match uu____5119 with
    | FStar_Syntax_Syntax.Tm_arrow uu____5124 -> true
    | uu____5140 -> false
...
let rec (pre_typ : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term) =
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t  in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_refine (x,uu____5150) ->
        pre_typ x.FStar_Syntax_Syntax.sort
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____5156,uu____5157) ->
        pre_typ t2
    | uu____5198 -> t1
...
let (destruct :
  ...
  fun typ  ->
    fun lid  ->
      ...
      let uu____5223 =
        let uu____5224 = un_uinst typ1  in uu____5224.FStar_Syntax_Syntax.n
         in
...
let (lids_of_sigelt :
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_let (uu____5340,lids) -> lids
    | FStar_Syntax_Syntax.Sig_splice (lids,uu____5347) -> lids
    | FStar_Syntax_Syntax.Sig_bundle (uu____5352,lids) -> lids
    | FStar_Syntax_Syntax.Sig_inductive_typ
        (lid,uu____5363,uu____5364,uu____5365,uu____5366,uu____5367) -> 
        [lid]
    | FStar_Syntax_Syntax.Sig_effect_abbrev
        (lid,uu____5377,uu____5378,uu____5379,uu____5380) -> [lid]
    | FStar_Syntax_Syntax.Sig_datacon
        (lid,uu____5386,uu____5387,uu____5388,uu____5389,uu____5390) -> 
        [lid]
    | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____5398,uu____5399) ->
        [lid]
    | FStar_Syntax_Syntax.Sig_assume (lid,uu____5401,uu____5402) -> [lid]
    | FStar_Syntax_Syntax.Sig_new_effect_for_free n1 ->
        [n1.FStar_Syntax_Syntax.mname]
    | FStar_Syntax_Syntax.Sig_new_effect n1 -> [n1.FStar_Syntax_Syntax.mname]
    | FStar_Syntax_Syntax.Sig_sub_effect uu____5405 -> []
    | FStar_Syntax_Syntax.Sig_pragma uu____5406 -> []
    | FStar_Syntax_Syntax.Sig_main uu____5407 -> []
...
let range_of_arg :
  'Auu____5461 'Auu____5462 .
    ('Auu____5461 FStar_Syntax_Syntax.syntax * 'Auu____5462) ->
      FStar_Range.range
  =
  fun uu____5473  ->
    match uu____5473 with | (hd1,uu____5481) -> hd1.FStar_Syntax_Syntax.pos
  
let range_of_args :
  'Auu____5495 'Auu____5496 .
    ('Auu____5495 FStar_Syntax_Syntax.syntax * 'Auu____5496) Prims.list ->
      ...
      let uu____5653 =
        FStar_List.map
          (fun uu____5680  ->
             ...
             | (bv,aq) ->
                 let uu____5699 = FStar_Syntax_Syntax.bv_to_name bv  in
                 (uu____5699, aq)) bs
         in
      mk_app f uu____5653
...
let (mk_data :
  ...
  fun l  ->
    fun args  ->
      match args with
      | [] ->
          let uu____5749 = FStar_Ident.range_of_lid l  in
          let uu____5750 =
            let uu____5759 =
              FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.delta_constant
                (FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor)
               in
            FStar_Syntax_Syntax.mk uu____5759  in
          uu____5750 FStar_Pervasives_Native.None uu____5749
      | uu____5764 ->
          let e =
            let uu____5778 =
              FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.delta_constant
...
let (mk_field_projector_name :
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        let nm =
          let uu____5855 = FStar_Syntax_Syntax.is_null_bv x  in
          if uu____5855
          then
            let uu____5858 =
              let uu____5864 =
                let uu____5866 = FStar_Util.string_of_int i  in
                Prims.op_Hat "_" uu____5866  in
              let uu____5869 = FStar_Syntax_Syntax.range_of_bv x  in
              (uu____5864, uu____5869)  in
            FStar_Ident.mk_ident uu____5858
          else x.FStar_Syntax_Syntax.ppname  in
        let y =
          let uu___978_5874 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___978_5874.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___978_5874.FStar_Syntax_Syntax.sort)
          }  in
        let uu____5875 = mk_field_projector_name_from_ident lid nm  in
        (uu____5875, y)
...
let (ses_of_sigbundle :
  ...
  fun se  ->
    match se.FStar_Syntax_Syntax.sigel with
    | FStar_Syntax_Syntax.Sig_bundle (ses,uu____5887) -> ses
    | uu____5896 -> failwith "ses_of_sigbundle: not a Sig_bundle"
...
let (eff_decl_of_new_effect :
  ...
  fun se  ->
    ...
    | uu____5907 -> failwith "eff_decl_of_new_effect: not a Sig_new_effect"
  
let (set_uvar : FStar_Syntax_Syntax.uvar -> FStar_Syntax_Syntax.term -> unit)
  =
  fun uv  ->
    fun t  ->
      let uu____5920 = FStar_Syntax_Unionfind.find uv  in
      match uu____5920 with
      | FStar_Pervasives_Native.Some uu____5923 ->
          let uu____5924 =
            let uu____5926 =
              let uu____5928 = FStar_Syntax_Unionfind.uvar_id uv  in
              FStar_All.pipe_left FStar_Util.string_of_int uu____5928  in
            FStar_Util.format1 "Changing a fixed uvar! ?%s\n" uu____5926  in
          failwith uu____5924
      | uu____5933 -> FStar_Syntax_Unionfind.change uv t
  ...
  fun bs  ->
    fun t  ->
      fun lopt  ->
              ...
              let uu____6062 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___1039_6063.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____6064;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___1039_6063.FStar_Syntax_Syntax.residual_flags)
                }  in
        ...
        | uu____6081 ->
            let body =
              let uu____6083 = FStar_Syntax_Subst.close bs t  in
              FStar_Syntax_Subst.compress uu____6083  in
            (match body.FStar_Syntax_Syntax.n with
             | FStar_Syntax_Syntax.Tm_abs (bs',t1,lopt') ->
                 let uu____6113 =
                   let uu____6120 =
                     let uu____6121 =
                       let uu____6140 =
                         let uu____6149 = FStar_Syntax_Subst.close_binders bs
                            in
                         FStar_List.append uu____6149 bs'  in
                       let uu____6164 = close_lopt lopt'  in
                       (uu____6140, t1, uu____6164)  in
                     FStar_Syntax_Syntax.Tm_abs uu____6121  in
                   FStar_Syntax_Syntax.mk uu____6120  in
             ...
             | uu____6179 ->
                 let uu____6180 =
                   let uu____6187 =
                     let uu____6188 =
                       let uu____6207 = FStar_Syntax_Subst.close_binders bs
                          in
                       let uu____6216 = close_lopt lopt  in
                       (uu____6207, body, uu____6216)  in
                     FStar_Syntax_Syntax.Tm_abs uu____6188  in
                   FStar_Syntax_Syntax.mk uu____6187  in
    ...
    fun c  ->
      ...
      | uu____6272 ->
          let uu____6281 =
            let uu____6288 =
              let uu____6289 =
                let uu____6304 = FStar_Syntax_Subst.close_binders bs  in
                let uu____6313 = FStar_Syntax_Subst.close_comp bs c  in
                (uu____6304, uu____6313)  in
              FStar_Syntax_Syntax.Tm_arrow uu____6289  in
            FStar_Syntax_Syntax.mk uu____6288  in
          uu____6281 FStar_Pervasives_Native.None c.FStar_Syntax_Syntax.pos
...
let (flat_arrow :
  ...
  fun bs  ->
    fun c  ->
      let t = arrow bs c  in
      let uu____6362 =
        let uu____6363 = FStar_Syntax_Subst.compress t  in
        uu____6363.FStar_Syntax_Syntax.n  in
      match uu____6362 with
      | FStar_Syntax_Syntax.Tm_arrow (bs1,c1) ->
          (match c1.FStar_Syntax_Syntax.n with
           | FStar_Syntax_Syntax.Total (tres,uu____6393) ->
               let uu____6402 =
                 let uu____6403 = FStar_Syntax_Subst.compress tres  in
...
let (refine :
  ...
  fun b  ->
    fun t  ->
      let uu____6466 =
        let uu____6467 = FStar_Syntax_Syntax.range_of_bv b  in
        FStar_Range.union_ranges uu____6467 t.FStar_Syntax_Syntax.pos  in
      let uu____6468 =
        let uu____6475 =
          let uu____6476 =
            let uu____6483 =
              let uu____6486 =
                let uu____6487 = FStar_Syntax_Syntax.mk_binder b  in
                [uu____6487]  in
              FStar_Syntax_Subst.close uu____6486 t  in
            (b, uu____6483)  in
          FStar_Syntax_Syntax.Tm_refine uu____6476  in
        FStar_Syntax_Syntax.mk uu____6475  in
      uu____6468 FStar_Pervasives_Native.None uu____6466
...
let rec (arrow_formals_comp :
  ...
  fun k  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
        let uu____6567 = FStar_Syntax_Subst.open_comp bs c  in
        (match uu____6567 with
         | (bs1,c1) ->
             let uu____6586 = is_total_comp c1  in
             if uu____6586
             then
               let uu____6601 = arrow_formals_comp (comp_result c1)  in
               (match uu____6601 with
                | (bs',k2) -> ((FStar_List.append bs1 bs'), k2))
             else (bs1, c1))
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____6668;
           FStar_Syntax_Syntax.index = uu____6669;
           FStar_Syntax_Syntax.sort = s;_},uu____6671)
        ->
        let rec aux s1 k2 =
          let uu____6702 =
            let uu____6703 = FStar_Syntax_Subst.compress s1  in
            uu____6703.FStar_Syntax_Syntax.n  in
          match uu____6702 with
          | FStar_Syntax_Syntax.Tm_arrow uu____6718 -> arrow_formals_comp s1
          | FStar_Syntax_Syntax.Tm_refine
              ({ FStar_Syntax_Syntax.ppname = uu____6733;
                 FStar_Syntax_Syntax.index = uu____6734;
                 FStar_Syntax_Syntax.sort = s2;_},uu____6736)
              -> aux s2 k2
          | uu____6744 ->
              let uu____6745 = FStar_Syntax_Syntax.mk_Total k2  in
              ([], uu____6745)
           in
        aux s k1
    | uu____6760 ->
        let uu____6761 = FStar_Syntax_Syntax.mk_Total k1  in ([], uu____6761)
...
let rec (arrow_formals :
  ...
  =
  fun k  ->
    let uu____6796 = arrow_formals_comp k  in
    match uu____6796 with | (bs,c) -> (bs, (comp_result c))
...
let (let_rec_arity :
  ...
  fun lb  ->
    let rec arrow_until_decreases k =
      ...
      match k1.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
          let uu____6938 = FStar_Syntax_Subst.open_comp bs c  in
           ...
           | (bs1,c1) ->
               ...
               let uu____6962 =
                 FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
                   (FStar_Util.find_opt
                      (fun uu___12_6971  ->
                         match uu___12_6971 with
                         | FStar_Syntax_Syntax.DECREASES uu____6973 -> true
                         | uu____6977 -> false))
                  in
               (match uu____6962 with
                ...
                | uu____7012 ->
                    let uu____7015 = is_total_comp c1  in
                    if uu____7015
                    then
                      let uu____7034 = arrow_until_decreases (comp_result c1)
                         in
                      (match uu____7034 with
                       | (bs',d) -> ((FStar_List.append bs1 bs'), d))
                    else (bs1, FStar_Pervasives_Native.None)))
      | FStar_Syntax_Syntax.Tm_refine
          ({ FStar_Syntax_Syntax.ppname = uu____7127;
             FStar_Syntax_Syntax.index = uu____7128;
             FStar_Syntax_Syntax.sort = k2;_},uu____7130)
          -> arrow_until_decreases k2
      | uu____7138 -> ([], FStar_Pervasives_Native.None)  in
    let uu____7159 = arrow_until_decreases lb.FStar_Syntax_Syntax.lbtyp  in
        ...
        let uu____7213 =
          FStar_Util.map_opt dopt
            (fun d  ->
               ...
               let uu____7234 =
                 FStar_Common.tabulate n_univs (fun uu____7240  -> false)  in
               let uu____7243 =
                 FStar_All.pipe_right bs
                   (FStar_List.map
                      (fun uu____7268  ->
                         match uu____7268 with
                         | (x,uu____7277) -> FStar_Util.set_mem x d_bvs))
                  in
               FStar_List.append uu____7234 uu____7243)
           in
        ((n_univs + (FStar_List.length bs)), uu____7213)
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____7333 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___1161_7334.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____7335;
              FStar_Syntax_Syntax.residual_flags =
                (uu___1161_7334.FStar_Syntax_Syntax.residual_flags)
            }  in
    ...
    let rec aux t1 abs_body_lcomp =
      let uu____7378 =
        let uu____7379 =
          ...
          FStar_All.pipe_left unascribe uu____7382  in
        uu____7379.FStar_Syntax_Syntax.n  in
      match uu____7378 with
      | FStar_Syntax_Syntax.Tm_abs (bs,t2,what) ->
          let uu____7428 = aux t2 what  in
          (match uu____7428 with
           | (bs',t3,what1) -> ((FStar_List.append bs bs'), t3, what1))
      | uu____7500 -> ([], t1, abs_body_lcomp)  in
    let uu____7517 = aux t FStar_Pervasives_Native.None  in
    match uu____7517 with
    | (bs,t1,abs_body_lcomp) ->
        let uu____7565 = FStar_Syntax_Subst.open_term' bs t1  in
              ...
              fun attrs  ->
                fun pos  ->
                  let def1 =
                    ...
                    | (FStar_Pervasives_Native.None ,uu____7728) -> def
                    | (uu____7739,[]) -> def
                    | (FStar_Pervasives_Native.Some fvs,uu____7751) ->
                        let universes =
                          FStar_All.pipe_right univ_vars
                            (FStar_List.map
                               (fun _7767  ->
                                  FStar_Syntax_Syntax.U_name _7767))
                           in
                        let inst1 =
  ...
  fun uvs  ->
    fun binders  ->
      fun c  ->
        match binders with
        | [] ->
            let uu____7849 = FStar_Syntax_Subst.open_univ_vars_comp uvs c  in
            (match uu____7849 with | (uvs1,c1) -> (uvs1, [], c1))
        | uu____7884 ->
            let t' = arrow binders c  in
            let uu____7896 = FStar_Syntax_Subst.open_univ_vars uvs t'  in
            (match uu____7896 with
             | (uvs1,t'1) ->
                 let uu____7917 =
                   let uu____7918 = FStar_Syntax_Subst.compress t'1  in
                   uu____7918.FStar_Syntax_Syntax.n  in
                 (match uu____7917 with
                  | FStar_Syntax_Syntax.Tm_arrow (binders1,c1) ->
                      (uvs1, binders1, c1)
                  | uu____7967 -> failwith "Impossible"))
...
let (is_constructor :
  ...
  fun t  ->
    fun lid  ->
      let uu____8066 =
        let uu____8067 = pre_typ t  in uu____8067.FStar_Syntax_Syntax.n  in
...
let rec (is_constructed_typ :
  ...
  fun t  ->
    fun lid  ->
      let uu____8086 =
        let uu____8087 = pre_typ t  in uu____8087.FStar_Syntax_Syntax.n  in
      match uu____8086 with
      | FStar_Syntax_Syntax.Tm_fvar uu____8091 -> is_constructor t lid
      | FStar_Syntax_Syntax.Tm_app (t1,uu____8093) ->
          is_constructed_typ t1 lid
      | FStar_Syntax_Syntax.Tm_uinst (t1,uu____8119) ->
          is_constructed_typ t1 lid
      | uu____8124 -> false
...
let rec (get_tycon :
  ...
  fun t  ->
    let t1 = pre_typ t  in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_bvar uu____8137 ->
        FStar_Pervasives_Native.Some t1
    | FStar_Syntax_Syntax.Tm_name uu____8138 ->
        FStar_Pervasives_Native.Some t1
    | FStar_Syntax_Syntax.Tm_fvar uu____8139 ->
        FStar_Pervasives_Native.Some t1
    | FStar_Syntax_Syntax.Tm_app (t2,uu____8141) -> get_tycon t2
    | uu____8166 -> FStar_Pervasives_Native.None
  
let (is_fstar_tactics_by_tactic : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____8174 =
      let uu____8175 = un_uinst t  in uu____8175.FStar_Syntax_Syntax.n  in
...
let (is_builtin_tactic : FStar_Ident.lident -> Prims.bool) =
  fun md  ->
    ...
    then
      let uu____8194 =
        let uu____8198 = FStar_List.splitAt (Prims.of_int (2)) path  in
        FStar_Pervasives_Native.fst uu____8198  in
...
let (type_u :
  ...
  fun uu____8249  ->
    let u =
      let uu____8255 = FStar_Syntax_Unionfind.univ_fresh ()  in
      FStar_All.pipe_left (fun _8272  -> FStar_Syntax_Syntax.U_unif _8272)
        uu____8255
       in
    let uu____8273 =
...
let (attr_eq :
  ...
  fun a  ->
    fun a'  ->
      let uu____8286 = eq_tm a a'  in
      match uu____8286 with | Equal  -> true | uu____8289 -> false
      ...
      let uu____8302 =
        let uu____8303 =
          FStar_Ident.lid_of_path ["FStar"; "Pervasives"; "Substitute"]
           ...
           in
        FStar_Syntax_Syntax.lid_as_fv uu____8303
          FStar_Syntax_Syntax.delta_constant FStar_Pervasives_Native.None
         in
      FStar_Syntax_Syntax.Tm_fvar uu____8302  in
          ...
          let uu____8415 =
            ...
            let uu____8419 =
              let uu____8426 =
                let uu____8427 =
                  let uu____8444 =
                    let uu____8455 = FStar_Syntax_Syntax.as_arg phi11  in
                    let uu____8464 =
                      let uu____8475 = FStar_Syntax_Syntax.as_arg phi2  in
                      [uu____8475]  in
                    uu____8455 :: uu____8464  in
                  (tand, uu____8444)  in
                FStar_Syntax_Syntax.Tm_app uu____8427  in
              FStar_Syntax_Syntax.mk uu____8426  in
            uu____8419 FStar_Pervasives_Native.None uu____8418  in
      ...
      fun phi2  ->
        ...
        let uu____8553 =
          let uu____8560 =
            let uu____8561 =
              let uu____8578 =
                let uu____8589 = FStar_Syntax_Syntax.as_arg phi1  in
                let uu____8598 =
                  let uu____8609 = FStar_Syntax_Syntax.as_arg phi2  in
                  [uu____8609]  in
                uu____8589 :: uu____8598  in
              (op_t, uu____8578)  in
            FStar_Syntax_Syntax.Tm_app uu____8561  in
          FStar_Syntax_Syntax.mk uu____8560  in
        uu____8553 FStar_Pervasives_Native.None uu____8552
  ...
  fun phi  ->
    let uu____8666 =
      let uu____8673 =
        let uu____8674 =
          let uu____8691 =
            let uu____8702 = FStar_Syntax_Syntax.as_arg phi  in [uu____8702]
             in
          (t_not, uu____8691)  in
        FStar_Syntax_Syntax.Tm_app uu____8674  in
      FStar_Syntax_Syntax.mk uu____8673  in
    uu____8666 FStar_Pervasives_Native.None phi.FStar_Syntax_Syntax.pos
  ...
  fun e  ->
    let uu____8899 =
      let uu____8906 =
        let uu____8907 =
          let uu____8924 =
            let uu____8935 = FStar_Syntax_Syntax.as_arg e  in [uu____8935]
             in
          (b2t_v, uu____8924)  in
        FStar_Syntax_Syntax.Tm_app uu____8907  in
      FStar_Syntax_Syntax.mk uu____8906  in
    uu____8899 FStar_Pervasives_Native.None e.FStar_Syntax_Syntax.pos
...
let (unb2t :
  ...
  =
  fun e  ->
    let uu____8982 = head_and_args e  in
    match uu____8982 with
    | (hd1,args) ->
        let uu____9027 =
          let uu____9042 =
            let uu____9043 = FStar_Syntax_Subst.compress hd1  in
            uu____9043.FStar_Syntax_Syntax.n  in
          (uu____9042, args)  in
        (match uu____9027 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,(e1,uu____9060)::[]) when
...
let (is_t_true : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____9117 =
      let uu____9118 = unmeta t  in uu____9118.FStar_Syntax_Syntax.n  in
...
let (mk_conj_simp :
  ...
  fun t1  ->
    fun t2  ->
      let uu____9146 = is_t_true t1  in
      if uu____9146
      then t2
      else
        (let uu____9153 = is_t_true t2  in
         if uu____9153 then t1 else mk_conj t1 t2)
...
let (mk_disj_simp :
  ...
  fun t1  ->
    fun t2  ->
      let uu____9181 = is_t_true t1  in
      if uu____9181
      then t_true
      else
        (let uu____9188 = is_t_true t2  in
         if uu____9188 then t_true else mk_disj t1 t2)
    ...
    fun e2  ->
      ...
      let uu____9218 =
        let uu____9225 =
          let uu____9226 =
            let uu____9243 =
              let uu____9254 = FStar_Syntax_Syntax.as_arg e1  in
              let uu____9263 =
                let uu____9274 = FStar_Syntax_Syntax.as_arg e2  in
                [uu____9274]  in
              uu____9254 :: uu____9263  in
            (teq, uu____9243)  in
          FStar_Syntax_Syntax.Tm_app uu____9226  in
        FStar_Syntax_Syntax.mk uu____9225  in
      uu____9218 FStar_Pervasives_Native.None uu____9217
        ...
        fun e2  ->
          ...
          let uu____9342 =
            let uu____9349 =
              let uu____9350 =
                let uu____9367 =
                  let uu____9378 = FStar_Syntax_Syntax.iarg t  in
                  let uu____9387 =
                    let uu____9398 = FStar_Syntax_Syntax.as_arg e1  in
                    let uu____9407 =
                      let uu____9418 = FStar_Syntax_Syntax.as_arg e2  in
                      [uu____9418]  in
                    uu____9398 :: uu____9407  in
                  uu____9378 :: uu____9387  in
                (eq_inst, uu____9367)  in
      ...
      fun t'  ->
        ...
        let uu____9495 =
          let uu____9502 =
            let uu____9503 =
              let uu____9520 =
                let uu____9531 = FStar_Syntax_Syntax.iarg t  in
                let uu____9540 =
                  let uu____9551 = FStar_Syntax_Syntax.as_arg x  in
                  let uu____9560 =
                    let uu____9571 = FStar_Syntax_Syntax.as_arg t'  in
                    [uu____9571]  in
                  uu____9551 :: uu____9560  in
                uu____9531 :: uu____9540  in
              (t_has_type1, uu____9520)  in
            FStar_Syntax_Syntax.Tm_app uu____9503  in
          FStar_Syntax_Syntax.mk uu____9502  in
        uu____9495 FStar_Pervasives_Native.None FStar_Range.dummyRange
      ...
      fun e  ->
        ...
        let uu____9648 =
          let uu____9655 =
            let uu____9656 =
              let uu____9673 =
                let uu____9684 = FStar_Syntax_Syntax.iarg t  in
                let uu____9693 =
                  let uu____9704 = FStar_Syntax_Syntax.as_arg e  in
                  [uu____9704]  in
                uu____9684 :: uu____9693  in
              (t_with_type1, uu____9673)  in
            FStar_Syntax_Syntax.Tm_app uu____9656  in
          FStar_Syntax_Syntax.mk uu____9655  in
        uu____9648 FStar_Pervasives_Native.None FStar_Range.dummyRange
      ...
      let uu____9759 =
        let uu____9766 =
          FStar_Syntax_Syntax.fvar FStar_Parser_Const.lextop_lid
            ...
            (FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor)
           in
        (uu____9766, [FStar_Syntax_Syntax.U_zero])  in
      FStar_Syntax_Syntax.Tm_uinst uu____9759  in
    FStar_Syntax_Syntax.mk uu____9758  in
  uu____9751 FStar_Pervasives_Native.None FStar_Range.dummyRange 
...
let (lcomp_of_comp : FStar_Syntax_Syntax.comp -> FStar_Syntax_Syntax.lcomp) =
  fun c0  ->
    let uu____9781 =
      ...
      | FStar_Syntax_Syntax.Total uu____9794 ->
          (FStar_Parser_Const.effect_Tot_lid, [FStar_Syntax_Syntax.TOTAL])
      | FStar_Syntax_Syntax.GTotal uu____9805 ->
          (FStar_Parser_Const.effect_GTot_lid,
            [FStar_Syntax_Syntax.SOMETRIVIAL])
              ...
              let uu____9934 =
                ...
                let uu____9954 =
                  let uu____9965 =
                    let uu____9974 =
                      let uu____9975 =
                        let uu____9976 = FStar_Syntax_Syntax.mk_binder x  in
                        [uu____9976]  in
                      abs uu____9975 body
                        (FStar_Pervasives_Native.Some (residual_tot ktype0))
                       in
                    FStar_Syntax_Syntax.as_arg uu____9974  in
                  [uu____9965]  in
                uu____9945 :: uu____9954  in
              (fa, uu____9934)  in
            FStar_Syntax_Syntax.Tm_app uu____9917  in
  ...
  fun bs  ->
    fun f  ->
      FStar_List.fold_right
        (fun b  ->
           fun f1  ->
             let uu____10103 = FStar_Syntax_Syntax.is_null_binder b  in
             if uu____10103
             then f1
...
let rec (is_wild_pat :
  ...
  fun p  ->
    ...
    | FStar_Syntax_Syntax.Pat_wild uu____10122 -> true
    | uu____10124 -> false
        ...
        let then_branch =
          let uu____10171 =
            FStar_Syntax_Syntax.withinfo
              ...
              t1.FStar_Syntax_Syntax.pos
             in
          (uu____10171, FStar_Pervasives_Native.None, t1)  in
        let else_branch =
          let uu____10200 =
            FStar_Syntax_Syntax.withinfo
             ...
             in
          (uu____10200, FStar_Pervasives_Native.None, t2)  in
        let uu____10214 =
          let uu____10215 =
            FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos
              t2.FStar_Syntax_Syntax.pos
             in
          FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos uu____10215  in
        FStar_Syntax_Syntax.mk
          (FStar_Syntax_Syntax.Tm_match (b, [then_branch; else_branch]))
          FStar_Pervasives_Native.None uu____10214
    ...
    fun p  ->
      let sq =
        FStar_Syntax_Syntax.fvar FStar_Parser_Const.squash_lid
          ...
          FStar_Pervasives_Native.None
         in
      let uu____10291 = FStar_Syntax_Syntax.mk_Tm_uinst sq [u]  in
      let uu____10294 =
        let uu____10305 = FStar_Syntax_Syntax.as_arg p  in [uu____10305]  in
      mk_app uu____10291 uu____10294
    ...
    fun p  ->
      let sq =
        FStar_Syntax_Syntax.fvar FStar_Parser_Const.auto_squash_lid
          ...
          FStar_Pervasives_Native.None
         in
      let uu____10345 = FStar_Syntax_Syntax.mk_Tm_uinst sq [u]  in
      let uu____10348 =
        let uu____10359 = FStar_Syntax_Syntax.as_arg p  in [uu____10359]  in
      mk_app uu____10345 uu____10348
...
let (un_squash :
  ...
  =
  fun t  ->
    let uu____10394 = head_and_args t  in
    ...
    | (head1,args) ->
        ...
        let uu____10443 =
          let uu____10458 =
            let uu____10459 = FStar_Syntax_Subst.compress head3  in
            uu____10459.FStar_Syntax_Syntax.n  in
          (uu____10458, args)  in
        (match uu____10443 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,(p,uu____10478)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid
         ...
         | (FStar_Syntax_Syntax.Tm_refine (b,p),[]) ->
             (match (b.FStar_Syntax_Syntax.sort).FStar_Syntax_Syntax.n with
              | FStar_Syntax_Syntax.Tm_fvar fv when
                  ...
                  let uu____10544 =
                    let uu____10549 =
                      let uu____10550 = FStar_Syntax_Syntax.mk_binder b  in
                      [uu____10550]  in
                    FStar_Syntax_Subst.open_term uu____10549 p  in
                  (match uu____10544 with
                   | (bs,p1) ->
                       let b1 =
                         match bs with
                         | b1::[] -> b1
                         | uu____10607 -> failwith "impossible"  in
                       let uu____10615 =
                         let uu____10617 = FStar_Syntax_Free.names p1  in
         ...
         | uu____10636 -> FStar_Pervasives_Native.None)
...
let (is_squash :
  ...
  =
  fun t  ->
    let uu____10667 = head_and_args t  in
    match uu____10667 with
    | (head1,args) ->
        let uu____10718 =
          let uu____10733 =
            let uu____10734 = FStar_Syntax_Subst.compress head1  in
            uu____10734.FStar_Syntax_Syntax.n  in
          (uu____10733, args)  in
        (match uu____10718 with
         | (FStar_Syntax_Syntax.Tm_uinst
            ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
               FStar_Syntax_Syntax.pos = uu____10756;
               FStar_Syntax_Syntax.vars = uu____10757;_},u::[]),(t1,uu____10760)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid
             -> FStar_Pervasives_Native.Some (u, t1)
         | uu____10807 -> FStar_Pervasives_Native.None)
...
let (is_auto_squash :
  ...
  =
  fun t  ->
    let uu____10842 = head_and_args t  in
    match uu____10842 with
    | (head1,args) ->
        let uu____10893 =
          let uu____10908 =
            let uu____10909 = FStar_Syntax_Subst.compress head1  in
        ...
        (match uu____10893 with
         | (FStar_Syntax_Syntax.Tm_uinst
            ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
               ...
               FStar_Syntax_Syntax.vars = uu____10932;_},u::[]),(t1,uu____10935)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Parser_Const.auto_squash_lid
             -> FStar_Pervasives_Native.Some (u, t1)
         | uu____10982 -> FStar_Pervasives_Native.None)
  
let (is_sub_singleton : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____11010 =
      let uu____11027 = unmeta t  in head_and_args uu____11027  in
    match uu____11010 with
    | (head1,uu____11030) ->
        let uu____11055 =
          let uu____11056 = un_uinst head1  in
...
let (arrow_one :
  ...
  fun t  ->
    let uu____11081 =
      let uu____11094 =
        let uu____11095 = FStar_Syntax_Subst.compress t  in
      ...
      | FStar_Syntax_Syntax.Tm_arrow (b::bs,c) ->
          let uu____11225 =
            let uu____11236 =
              let uu____11237 = arrow bs c  in
              FStar_Syntax_Syntax.mk_Total uu____11237  in
            (b, uu____11236)  in
          FStar_Pervasives_Native.Some uu____11225
      | uu____11254 -> FStar_Pervasives_Native.None  in
    FStar_Util.bind_opt uu____11081
      (fun uu____11292  ->
...
let rec apply_last :
  'Auu____14384 .
    ('Auu____14384 -> 'Auu____14384) ->
      'Auu____14384 Prims.list -> 'Auu____14384 Prims.list
  =
  fun f  ->
    fun l  ->
      match l with
        ...
        FStar_List.fold_right
          (fun t  ->
             fun a  ->
               ...
               cons1 uu____14555 t.FStar_Syntax_Syntax.pos) l uu____14519
...
let rec (term_eq_dbg :
  ...
  fun dbg  ->
    fun t1  ->
      fun t2  ->
        let t11 = let uu____15245 = unmeta_safe t1  in canon_app uu____15245
           in
        let t21 = let uu____15251 = unmeta_safe t2  in canon_app uu____15251
           in
        let uu____15254 =
          let uu____15259 =
            let uu____15260 =
              let uu____15263 = un_uinst t11  in
              FStar_Syntax_Subst.compress uu____15263  in
            uu____15260.FStar_Syntax_Syntax.n  in
          let uu____15264 =
            let uu____15265 =
              let uu____15268 = un_uinst t21  in
              FStar_Syntax_Subst.compress uu____15268  in
            uu____15265.FStar_Syntax_Syntax.n  in
          (uu____15259, uu____15264)  in
        match uu____15254 with
        | (FStar_Syntax_Syntax.Tm_uinst uu____15270,uu____15271) ->
            failwith "term_eq: impossible, should have been removed"
        | (uu____15280,FStar_Syntax_Syntax.Tm_uinst uu____15281) ->
            failwith "term_eq: impossible, should have been removed"
        | (FStar_Syntax_Syntax.Tm_delayed uu____15290,uu____15291) ->
            failwith "term_eq: impossible, should have been removed"
        | (uu____15316,FStar_Syntax_Syntax.Tm_delayed uu____15317) ->
            failwith "term_eq: impossible, should have been removed"
        | (FStar_Syntax_Syntax.Tm_ascribed uu____15342,uu____15343) ->
            failwith "term_eq: impossible, should have been removed"
        ...
        | (FStar_Syntax_Syntax.Tm_fvar x,FStar_Syntax_Syntax.Tm_fvar y) ->
            let uu____15412 = FStar_Syntax_Syntax.fv_eq x y  in
            check "fvar" uu____15412
        | (FStar_Syntax_Syntax.Tm_constant c1,FStar_Syntax_Syntax.Tm_constant
           c2) ->
            let uu____15417 = FStar_Const.eq_const c1 c2  in
            check "const" uu____15417
        | (FStar_Syntax_Syntax.Tm_type
           uu____15420,FStar_Syntax_Syntax.Tm_type uu____15421) -> true
        | (FStar_Syntax_Syntax.Tm_abs (b1,t12,k1),FStar_Syntax_Syntax.Tm_abs
           (b2,t22,k2)) ->
            (let uu____15479 = eqlist (binder_eq_dbg dbg) b1 b2  in
             check "abs binders" uu____15479) &&
              (let uu____15489 = term_eq_dbg dbg t12 t22  in
               check "abs bodies" uu____15489)
        | (FStar_Syntax_Syntax.Tm_arrow (b1,c1),FStar_Syntax_Syntax.Tm_arrow
           (b2,c2)) ->
            (let uu____15538 = eqlist (binder_eq_dbg dbg) b1 b2  in
             check "arrow binders" uu____15538) &&
              (let uu____15548 = comp_eq_dbg dbg c1 c2  in
               check "arrow comp" uu____15548)
        | (FStar_Syntax_Syntax.Tm_refine
           (b1,t12),FStar_Syntax_Syntax.Tm_refine (b2,t22)) ->
            (let uu____15565 =
               term_eq_dbg dbg b1.FStar_Syntax_Syntax.sort
                ...
                in
             check "refine bv sort" uu____15565) &&
              (let uu____15569 = term_eq_dbg dbg t12 t22  in
               check "refine formula" uu____15569)
        | (FStar_Syntax_Syntax.Tm_app (f1,a1),FStar_Syntax_Syntax.Tm_app
           (f2,a2)) ->
            (let uu____15626 = term_eq_dbg dbg f1 f2  in
             check "app head" uu____15626) &&
              (let uu____15630 = eqlist (arg_eq_dbg dbg) a1 a2  in
               check "app args" uu____15630)
        | (FStar_Syntax_Syntax.Tm_match
           (t12,bs1),FStar_Syntax_Syntax.Tm_match (t22,bs2)) ->
            (let uu____15719 = term_eq_dbg dbg t12 t22  in
             check "match head" uu____15719) &&
              (let uu____15723 = eqlist (branch_eq_dbg dbg) bs1 bs2  in
               check "match branches" uu____15723)
        | (FStar_Syntax_Syntax.Tm_lazy uu____15740,uu____15741) ->
            let uu____15742 =
              let uu____15744 = unlazy t11  in
              term_eq_dbg dbg uu____15744 t21  in
            check "lazy_l" uu____15742
        | (uu____15746,FStar_Syntax_Syntax.Tm_lazy uu____15747) ->
            let uu____15748 =
              let uu____15750 = unlazy t21  in
              term_eq_dbg dbg t11 uu____15750  in
            check "lazy_r" uu____15748
        | (FStar_Syntax_Syntax.Tm_let
           ((b1,lbs1),t12),FStar_Syntax_Syntax.Tm_let ((b2,lbs2),t22)) ->
            ((check "let flag" (b1 = b2)) &&
               (let uu____15795 = eqlist (letbinding_eq_dbg dbg) lbs1 lbs2
                   in
                check "let lbs" uu____15795))
              &&
              (let uu____15799 = term_eq_dbg dbg t12 t22  in
               check "let body" uu____15799)
        | (FStar_Syntax_Syntax.Tm_uvar
           (u1,uu____15803),FStar_Syntax_Syntax.Tm_uvar (u2,uu____15805)) ->
            check "uvar"
        ...
        | (FStar_Syntax_Syntax.Tm_quoted
           (qt1,qi1),FStar_Syntax_Syntax.Tm_quoted (qt2,qi2)) ->
            (let uu____15863 =
               let uu____15865 = eq_quoteinfo qi1 qi2  in uu____15865 = Equal
                in
             check "tm_quoted qi" uu____15863) &&
              (let uu____15868 = term_eq_dbg dbg qt1 qt2  in
               check "tm_quoted payload" uu____15868)
        | (FStar_Syntax_Syntax.Tm_meta (t12,m1),FStar_Syntax_Syntax.Tm_meta
           (t22,m2)) ->
            (match (m1, m2) with
             | (FStar_Syntax_Syntax.Meta_monadic
                (n1,ty1),FStar_Syntax_Syntax.Meta_monadic (n2,ty2)) ->
                 (let uu____15898 = FStar_Ident.lid_equals n1 n2  in
                  check "meta_monadic lid" uu____15898) &&
                   (let uu____15902 = term_eq_dbg dbg ty1 ty2  in
                    check "meta_monadic type" uu____15902)
             | (FStar_Syntax_Syntax.Meta_monadic_lift
                (s1,t13,ty1),FStar_Syntax_Syntax.Meta_monadic_lift
                (s2,t23,ty2)) ->
                 ((let uu____15921 = FStar_Ident.lid_equals s1 s2  in
                   check "meta_monadic_lift src" uu____15921) &&
                    (let uu____15925 = FStar_Ident.lid_equals t13 t23  in
                     check "meta_monadic_lift tgt" uu____15925))
                   &&
                   (let uu____15929 = term_eq_dbg dbg ty1 ty2  in
                    check "meta_monadic_lift type" uu____15929)
             | uu____15932 -> fail "metas")
        | (FStar_Syntax_Syntax.Tm_unknown ,uu____15938) -> fail "unk"
        | (uu____15940,FStar_Syntax_Syntax.Tm_unknown ) -> fail "unk"
        | (FStar_Syntax_Syntax.Tm_bvar uu____15942,uu____15943) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_name uu____15945,uu____15946) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_fvar uu____15948,uu____15949) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_constant uu____15951,uu____15952) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_type uu____15954,uu____15955) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_abs uu____15957,uu____15958) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_arrow uu____15978,uu____15979) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_refine uu____15995,uu____15996) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_app uu____16004,uu____16005) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_match uu____16023,uu____16024) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_let uu____16048,uu____16049) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_uvar uu____16064,uu____16065) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_meta uu____16079,uu____16080) ->
            fail "bottom"
        | (uu____16088,FStar_Syntax_Syntax.Tm_bvar uu____16089) ->
            fail "bottom"
        | (uu____16091,FStar_Syntax_Syntax.Tm_name uu____16092) ->
            fail "bottom"
        | (uu____16094,FStar_Syntax_Syntax.Tm_fvar uu____16095) ->
            fail "bottom"
        | (uu____16097,FStar_Syntax_Syntax.Tm_constant uu____16098) ->
            fail "bottom"
        | (uu____16100,FStar_Syntax_Syntax.Tm_type uu____16101) ->
            fail "bottom"
        | (uu____16103,FStar_Syntax_Syntax.Tm_abs uu____16104) ->
            fail "bottom"
        | (uu____16124,FStar_Syntax_Syntax.Tm_arrow uu____16125) ->
            fail "bottom"
        | (uu____16141,FStar_Syntax_Syntax.Tm_refine uu____16142) ->
            fail "bottom"
        | (uu____16150,FStar_Syntax_Syntax.Tm_app uu____16151) ->
            fail "bottom"
        | (uu____16169,FStar_Syntax_Syntax.Tm_match uu____16170) ->
            fail "bottom"
        | (uu____16194,FStar_Syntax_Syntax.Tm_let uu____16195) ->
            fail "bottom"
        | (uu____16210,FStar_Syntax_Syntax.Tm_uvar uu____16211) ->
            fail "bottom"
        | (uu____16225,FStar_Syntax_Syntax.Tm_meta uu____16226) ->
            fail "bottom"
    ...
    fun a1  ->
      fun a2  ->
        eqprod
          (fun t1  ->
             fun t2  ->
               let uu____16261 = term_eq_dbg dbg t1 t2  in
               check "arg tm" uu____16261)
          (fun q1  ->
             fun q2  ->
               let uu____16273 =
                 let uu____16275 = eq_aqual q1 q2  in uu____16275 = Equal  in
               check "arg qual" uu____16273) a1 a2
             ...
             fun b21  ->
               let uu____16300 =
                 term_eq_dbg dbg b11.FStar_Syntax_Syntax.sort
                  ...
                  in
               check "binder sort" uu____16300)
          (fun q1  ->
             fun q2  ->
               let uu____16312 =
                 let uu____16314 = eq_aqual q1 q2  in uu____16314 = Equal  in
               check "binder qual" uu____16312) b1 b2
      ...
      fun c2  ->
        ...
        ((let uu____16334 =
            FStar_Ident.lid_equals c11.FStar_Syntax_Syntax.effect_name
             ...
             in
          check "comp eff" uu____16334) &&
           (let uu____16338 =
              term_eq_dbg dbg c11.FStar_Syntax_Syntax.result_typ
                c21.FStar_Syntax_Syntax.result_typ
               in
            check "comp result typ" uu____16338))
          && true
...
and (branch_eq_dbg :
  ...
  fun dbg  ->
    fun uu____16348  ->
      fun uu____16349  ->
        match (uu____16348, uu____16349) with
        | ((p1,w1,t1),(p2,w2,t2)) ->
            ((let uu____16476 = FStar_Syntax_Syntax.eq_pat p1 p2  in
              check "branch pat" uu____16476) &&
               (let uu____16480 = term_eq_dbg dbg t1 t2  in
                check "branch body" uu____16480))
              &&
              (let uu____16484 =
                 match (w1, w2) with
                 | (FStar_Pervasives_Native.Some
                 ...
                 | uu____16526 -> false  in
               check "branch when" uu____16484)
      ...
      fun lb2  ->
        ((let uu____16547 =
            eqsum (fun bv1  -> fun bv2  -> true) FStar_Syntax_Syntax.fv_eq
             ...
             in
          check "lb bv" uu____16547) &&
           (let uu____16556 =
              term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbtyp
                lb2.FStar_Syntax_Syntax.lbtyp
               in
            check "lb typ" uu____16556))
          &&
          (let uu____16560 =
             term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbdef
               lb2.FStar_Syntax_Syntax.lbdef
              in
           check "lb def" uu____16560)
...
let (term_eq :
  ...
  fun t1  ->
    fun t2  ->
      let r =
        let uu____16577 = FStar_ST.op_Bang debug_term_eq  in
        term_eq_dbg uu____16577 t1 t2  in
      FStar_ST.op_Colon_Equals debug_term_eq false; r
  
let rec (sizeof : FStar_Syntax_Syntax.term -> Prims.int) =
  fun t  ->
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____16631 ->
        let uu____16654 =
          let uu____16656 = FStar_Syntax_Subst.compress t  in
          sizeof uu____16656  in
        Prims.int_one + uu____16654
    | FStar_Syntax_Syntax.Tm_bvar bv ->
        let uu____16659 = sizeof bv.FStar_Syntax_Syntax.sort  in
        Prims.int_one + uu____16659
    | FStar_Syntax_Syntax.Tm_name bv ->
        let uu____16663 = sizeof bv.FStar_Syntax_Syntax.sort  in
        Prims.int_one + uu____16663
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
        let uu____16672 = sizeof t1  in (FStar_List.length us) + uu____16672
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____16676) ->
        let uu____16701 = sizeof t1  in
        let uu____16703 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____16718  ->
                 ...
                 | (bv,uu____16728) ->
                     ...
                     acc + uu____16733) Prims.int_zero bs
           in
        uu____16701 + uu____16703
    | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
        let uu____16762 = sizeof hd1  in
        let uu____16764 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____16779  ->
                 ...
                 | (arg,uu____16789) ->
                     let uu____16794 = sizeof arg  in acc + uu____16794)
            Prims.int_zero args
           in
        uu____16762 + uu____16764
    | uu____16797 -> Prims.int_one
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid  ->
    fun t  ->
      let uu____16811 =
        let uu____16812 = un_uinst t  in uu____16812.FStar_Syntax_Syntax.n
         in
...
let (get_attribute :
  ...
  fun attr  ->
    fun attrs  ->
      FStar_List.tryPick
        (fun t  ->
           let uu____16878 = head_and_args t  in
           match uu____16878 with
           | (head1,args) ->
               let uu____16933 =
                 let uu____16934 = FStar_Syntax_Subst.compress head1  in
                 uu____16934.FStar_Syntax_Syntax.n  in
               (match uu____16933 with
                | FStar_Syntax_Syntax.Tm_fvar fv when
                    FStar_Syntax_Syntax.fv_eq_lid fv attr ->
                    FStar_Pervasives_Native.Some args
                | uu____16960 -> FStar_Pervasives_Native.None)) attrs
...
let (process_pragma :
  ...
  fun p  ->
    fun r  ->
      let set_options1 s =
        let uu____16990 = FStar_Options.set_options s  in
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____17004 = FStar_Options.restore_cmd_line_options false
               in
            FStar_All.pipe_right uu____17004 (fun a1  -> ()));
           (match sopt with
            | FStar_Pervasives_Native.None  -> ()
      ...
      | FStar_Syntax_Syntax.PopOptions  ->
          let uu____17019 = FStar_Options.internal_pop ()  in
          if uu____17019
          then ()
          else
            FStar_Errors.raise_error
...
let rec (unbound_variables :
  ...
  fun tm  ->
    ...
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____17051 -> failwith "Impossible"
    | FStar_Syntax_Syntax.Tm_name x -> []
    | FStar_Syntax_Syntax.Tm_uvar uu____17078 -> []
    | FStar_Syntax_Syntax.Tm_type u -> []
    | FStar_Syntax_Syntax.Tm_bvar x -> [x]
    | FStar_Syntax_Syntax.Tm_fvar uu____17093 -> []
    | FStar_Syntax_Syntax.Tm_constant uu____17094 -> []
    | FStar_Syntax_Syntax.Tm_lazy uu____17095 -> []
    | FStar_Syntax_Syntax.Tm_unknown  -> []
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) -> unbound_variables t1
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____17104) ->
        let uu____17129 = FStar_Syntax_Subst.open_term bs t1  in
         ...
         | (bs1,t2) ->
             let uu____17138 =
               FStar_List.collect
                ...
                in
             let uu____17165 = unbound_variables t2  in
             FStar_List.append uu____17138 uu____17165)
    | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
        let uu____17190 = FStar_Syntax_Subst.open_comp bs c  in
               ...
               FStar_List.collect
                 (fun uu____17211  ->
                    ...
                    | (b,uu____17221) ->
                        unbound_variables b.FStar_Syntax_Syntax.sort) bs1
                in
             let uu____17226 = unbound_variables_comp c1  in
         ...
         | (bs,t2) ->
             let uu____17258 =
               FStar_List.collect
                ...
                in
             let uu____17285 = unbound_variables t2  in
             FStar_List.append uu____17258 uu____17285)
    | FStar_Syntax_Syntax.Tm_app (t1,args) ->
        let uu____17314 =
          FStar_List.collect
            (fun uu____17328  ->
               match uu____17328 with
               | (x,uu____17340) -> unbound_variables x) args
           in
        let uu____17349 = unbound_variables t1  in
        FStar_List.append uu____17314 uu____17349
    | FStar_Syntax_Syntax.Tm_match (t1,pats) ->
        ...
        let uu____17393 =
          FStar_All.pipe_right pats
            (FStar_List.collect
               (fun br  ->
                  let uu____17408 = FStar_Syntax_Subst.open_branch br  in
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (t1,asc,uu____17447) ->
        let uu____17488 = unbound_variables t1  in
        let uu____17491 =
          let uu____17494 =
          ...
          FStar_List.append uu____17494 uu____17525  in
        FStar_List.append uu____17488 uu____17491
    | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),t1) ->
        let uu____17566 = unbound_variables lb.FStar_Syntax_Syntax.lbtyp  in
        let uu____17569 =
          let uu____17572 = unbound_variables lb.FStar_Syntax_Syntax.lbdef
             in
          let uu____17575 =
            match lb.FStar_Syntax_Syntax.lbname with
            | FStar_Util.Inr uu____17580 -> unbound_variables t1
            | FStar_Util.Inl bv ->
                let uu____17582 =
                ...
                (match uu____17582 with
                 | (uu____17603,t2) -> unbound_variables t2)
             in
          FStar_List.append uu____17572 uu____17575  in
        FStar_List.append uu____17566 uu____17569
    | FStar_Syntax_Syntax.Tm_let ((uu____17605,lbs),t1) ->
        let uu____17625 = FStar_Syntax_Subst.open_let_rec lbs t1  in
        (match uu____17625 with
         | (lbs1,t2) ->
             let uu____17640 = unbound_variables t2  in
             let uu____17643 =
               FStar_List.collect
                 (fun lb  ->
                    let uu____17650 =
                    ...
                    FStar_List.append uu____17650 uu____17653) lbs1
                in
             FStar_List.append uu____17640 uu____17643)
    | FStar_Syntax_Syntax.Tm_quoted (tm1,qi) ->
        (match qi.FStar_Syntax_Syntax.qkind with
         | FStar_Syntax_Syntax.Quote_static  -> []
         | FStar_Syntax_Syntax.Quote_dynamic  -> unbound_variables tm1)
    | FStar_Syntax_Syntax.Tm_meta (t1,m) ->
        let uu____17670 = unbound_variables t1  in
        let uu____17673 =
          match m with
          | FStar_Syntax_Syntax.Meta_pattern (uu____17678,args) ->
              FStar_List.collect
                (FStar_List.collect
                   (fun uu____17733  ->
                      match uu____17733 with
                      | (a,uu____17745) -> unbound_variables a)) args
          | FStar_Syntax_Syntax.Meta_monadic_lift
              (uu____17754,uu____17755,t') -> unbound_variables t'
          | FStar_Syntax_Syntax.Meta_monadic (uu____17761,t') ->
              unbound_variables t'
          | FStar_Syntax_Syntax.Meta_labeled uu____17767 -> []
          | FStar_Syntax_Syntax.Meta_desugared uu____17776 -> []
          | FStar_Syntax_Syntax.Meta_named uu____17777 -> []  in
        FStar_List.append uu____17670 uu____17673
...
and (unbound_variables_comp :
  ...
  fun c  ->
    match c.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.GTotal (t,uu____17784) -> unbound_variables t
    | FStar_Syntax_Syntax.Total (t,uu____17794) -> unbound_variables t
    | FStar_Syntax_Syntax.Comp ct ->
        let uu____17804 = unbound_variables ct.FStar_Syntax_Syntax.result_typ
           in
        let uu____17807 =
          FStar_List.collect
            (fun uu____17821  ->
               match uu____17821 with
               | (a,uu____17833) -> unbound_variables a)
            ct.FStar_Syntax_Syntax.effect_args
           in
        FStar_List.append uu____17804 uu____17807
  ...
  fun attr_lid  ->
    fun attrs  ->
      let rec aux acc attrs1 =
        ...
        | [] -> FStar_Pervasives_Native.None
        | h::t ->
            let uu____17948 = head_and_args h  in
            (match uu____17948 with
             | (head1,args) ->
                 let uu____18009 =
                   let uu____18010 = FStar_Syntax_Subst.compress head1  in
  ...
  fun attr_lid  ->
    fun se  ->
      ...
      | FStar_Pervasives_Native.Some (attrs',t) ->
          FStar_Pervasives_Native.Some
            ((let uu___2513_18129 = se  in
              {
                FStar_Syntax_Syntax.sigel =
                  (uu___2513_18129.FStar_Syntax_Syntax.sigel);
                FStar_Syntax_Syntax.sigrng =
                  (uu___2513_18129.FStar_Syntax_Syntax.sigrng);
                FStar_Syntax_Syntax.sigquals =
                  (uu___2513_18129.FStar_Syntax_Syntax.sigquals);
                FStar_Syntax_Syntax.sigmeta =
                  (uu___2513_18129.FStar_Syntax_Syntax.sigmeta);
                FStar_Syntax_Syntax.sigattrs = attrs';
                FStar_Syntax_Syntax.sigopts =
                  (uu___2513_18129.FStar_Syntax_Syntax.sigopts)
              }), t)
  
let (is_smt_lemma : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____18137 =
      let uu____18138 = FStar_Syntax_Subst.compress t  in
      uu____18138.FStar_Syntax_Syntax.n  in
    match uu____18137 with
    | FStar_Syntax_Syntax.Tm_arrow (uu____18142,c) ->
        (match c.FStar_Syntax_Syntax.n with
         | FStar_Syntax_Syntax.Comp ct when
             ...
             (match ct.FStar_Syntax_Syntax.effect_args with
              | _req::_ens::(pats,uu____18170)::uu____18171 ->
                  let pats' = unmeta pats  in
                  let uu____18231 = head_and_args pats'  in
                  (match uu____18231 with
                   | (head1,uu____18250) ->
                       let uu____18275 =
                         let uu____18276 = un_uinst head1  in
...
let rec (list_elements :
  ...
  fun e  ->
    let uu____18313 =
      let uu____18330 = unmeta e  in head_and_args uu____18330  in
    match uu____18313 with
    | (head1,args) ->
        let uu____18361 =
          let uu____18376 =
            let uu____18377 = un_uinst head1  in
            uu____18377.FStar_Syntax_Syntax.n  in
          (uu____18376, args)  in
        (match uu____18361 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____18395) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid ->
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____18419::(hd1,uu____18421)::(tl1,uu____18423)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid ->
             let uu____18490 =
               let uu____18493 =
                 let uu____18496 = list_elements tl1  in
                 FStar_Util.must uu____18496  in
               hd1 :: uu____18493  in
...
let (unthunk_lemma_post :
  ...
  fun t  ->
    let uu____18534 =
      let uu____18535 = FStar_Syntax_Subst.compress t  in
      uu____18535.FStar_Syntax_Syntax.n  in
    match uu____18534 with
    | FStar_Syntax_Syntax.Tm_abs (b::[],e,uu____18542) ->
        let uu____18577 = FStar_Syntax_Subst.open_term [b] e  in
        (match uu____18577 with
         | (bs,e1) ->
             let b1 = FStar_List.hd bs  in
             let uu____18611 = is_free_in (FStar_Pervasives_Native.fst b1) e1
                in
             if uu____18611
             then
               let uu____18618 =
    ...
    | uu____18656 ->
        let uu____18657 =
          let uu____18668 = FStar_Syntax_Syntax.as_arg exp_unit  in
          [uu____18668]  in
        mk_app t uu____18657
  ...
  fun t  ->
    fun universe_of_binders  ->
      let list_elements1 e =
        let uu____18723 = list_elements e  in
      ...
      let one_pat p =
        let uu____18754 =
          let uu____18771 = unmeta p  in
          FStar_All.pipe_right uu____18771 head_and_args  in
        match uu____18754 with
        | (head1,args) ->
            let uu____18822 =
              let uu____18837 =
                let uu____18838 = un_uinst head1  in
                uu____18838.FStar_Syntax_Syntax.n  in
              (uu____18837, args)  in
            (match uu____18822 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu____18860,uu____18861)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.smtpat_lid
                 -> arg
             | uu____18913 -> failwith "Unexpected pattern term")
         in
      let lemma_pats p =
        let elts = list_elements1 p  in
        let smt_pat_or1 t1 =
          let uu____18968 =
            let uu____18985 = unmeta t1  in
            FStar_All.pipe_right uu____18985 head_and_args  in
          match uu____18968 with
          | (head1,args) ->
              let uu____19032 =
                let uu____19047 =
                  let uu____19048 = un_uinst head1  in
                  uu____19048.FStar_Syntax_Syntax.n  in
                (uu____19047, args)  in
              (match uu____19032 with
               | (FStar_Syntax_Syntax.Tm_fvar fv,(e,uu____19067)::[]) when
                   FStar_Syntax_Syntax.fv_eq_lid fv
                     FStar_Parser_Const.smtpatOr_lid
                   -> FStar_Pervasives_Native.Some e
               | uu____19104 -> FStar_Pervasives_Native.None)
           in
        match elts with
        | t1::[] ->
            let uu____19134 = smt_pat_or1 t1  in
            (match uu____19134 with
             | FStar_Pervasives_Native.Some e ->
                 let uu____19156 = list_elements1 e  in
                 FStar_All.pipe_right uu____19156
                   (FStar_List.map
                      (fun branch1  ->
                         let uu____19186 = list_elements1 branch1  in
      ...
      let uu____19319 =
        ...
        | FStar_Syntax_Syntax.Tm_arrow (binders,c) ->
            let uu____19410 = FStar_Syntax_Subst.open_comp binders c  in
            (match uu____19410 with
             | (binders1,c1) ->
                 (match c1.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Comp
                      { FStar_Syntax_Syntax.comp_univs = uu____19481;
                        FStar_Syntax_Syntax.effect_name = uu____19482;
                        FStar_Syntax_Syntax.result_typ = uu____19483;
                        FStar_Syntax_Syntax.effect_args =
                          (pre,uu____19485)::(post,uu____19487)::(pats,uu____19489)::[];
                        FStar_Syntax_Syntax.flags = uu____19490;_}
                      ->
                      let uu____19551 = lemma_pats pats  in
                      (binders1, pre, post, uu____19551)
                  | uu____19588 -> failwith "impos"))
        | uu____19622 -> failwith "Impos"  in
      ...
      | (binders,pre,post,patterns) ->
          ...
          let body =
            let uu____19714 =
              let uu____19721 =
                let uu____19722 =
                  let uu____19729 = mk_imp pre post1  in
                  let uu____19732 =
                    let uu____19733 =
                      let uu____19754 =
                        FStar_Syntax_Syntax.binders_to_names binders  in
                      (uu____19754, patterns)  in
                    FStar_Syntax_Syntax.Meta_pattern uu____19733  in
                  (uu____19729, uu____19732)  in
                FStar_Syntax_Syntax.Tm_meta uu____19722  in
              FStar_Syntax_Syntax.mk uu____19721  in
            uu____19714 FStar_Pervasives_Native.None
              t.FStar_Syntax_Syntax.pos
             in
          let quant =
            let uu____19778 = universe_of_binders binders  in
            FStar_List.fold_right2
              (fun b  ->
                 fun u  ->
                   fun out  ->
