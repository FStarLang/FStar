  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___127_5397 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___127_5397.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___127_5397.FStar_Syntax_Syntax.sort)
          }  in
              ...
              let uu____5565 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___128_5566.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____5567;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___128_5566.FStar_Syntax_Syntax.residual_flags)
                }  in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____6819 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___129_6820.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____6821;
              FStar_Syntax_Syntax.residual_flags =
                (uu___129_6820.FStar_Syntax_Syntax.residual_flags)
            }  in
    ...
    fun r  ->
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____15778 = FStar_Options.restore_cmd_line_options false
               in
            FStar_All.pipe_right uu____15778 (fun a233  -> ()));
           (match sopt with
            | FStar_Pervasives_Native.None  -> ()
  ...
  fun attr_lid  ->
    fun se  ->
      ...
      | FStar_Pervasives_Native.Some (attrs',t) ->
          FStar_Pervasives_Native.Some
            ((let uu___130_16857 = se  in
              {
                FStar_Syntax_Syntax.sigel =
                  (uu___130_16857.FStar_Syntax_Syntax.sigel);
                FStar_Syntax_Syntax.sigrng =
                  (uu___130_16857.FStar_Syntax_Syntax.sigrng);
                FStar_Syntax_Syntax.sigquals =
                  (uu___130_16857.FStar_Syntax_Syntax.sigquals);
                FStar_Syntax_Syntax.sigmeta =
                  (uu___130_16857.FStar_Syntax_Syntax.sigmeta);
