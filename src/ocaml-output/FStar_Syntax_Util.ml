...
let uu____9932 = (delta_qualifier t)
in (incr_delta_depth uu____9932)))
...
let uu____9939 = (FStar_Syntax_Subst.compress t)
in uu____9939.FStar_Syntax_Syntax.n)
...
let uu____9971 = (unmeta e)
in (head_and_args uu____9971))
...
let uu____10012 = (un_uinst head1)
in uu____10012.FStar_Syntax_Syntax.n)
in ((uu____10011), (args)))
in (match (uu____9998) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____10028) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid) -> begin
FStar_Pervasives_Native.Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____10048)::((hd1, uu____10050))::((tl1, uu____10052))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid) -> begin
(
...
let uu____10109 = (list_elements tl1)
in (FStar_Util.must uu____10109))
in (hd1)::uu____10104)
in FStar_Pervasives_Native.Some (uu____10099))
end
| uu____10122 -> begin
FStar_Pervasives_Native.None
end))
...
let rec apply_last : 'Auu____10143 . ('Auu____10143  ->  'Auu____10143)  ->  'Auu____10143 Prims.list  ->  'Auu____10143 Prims.list = (fun f l -> (match (l) with
| [] -> begin
...
let uu____10173 = (apply_last f xs)
in (x)::uu____10173)
end))
...
let uu____10227 = (FStar_Syntax_Syntax.lid_as_fv l1 FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in FStar_Syntax_Syntax.Tm_fvar (uu____10227))
in (FStar_Syntax_Syntax.mk uu____10226))
in (uu____10219 FStar_Pervasives_Native.None rng)))
in (
...
let uu____10250 = (ctor FStar_Parser_Const.cons_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____10250 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____10249 args))
in (uu____10244 FStar_Pervasives_Native.None pos)))
in (
...
let uu____10272 = (ctor FStar_Parser_Const.nil_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____10272 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____10271 args))
in (uu____10266 FStar_Pervasives_Native.None pos)))
in (
...
let uu____10277 = (FStar_Syntax_Syntax.iarg typ)
in (uu____10277)::[])
in (nil uu____10276 rng))
in (FStar_List.fold_right (fun t a -> (

let uu____10283 = (

let uu____10284 = (FStar_Syntax_Syntax.iarg typ)
in (

let uu____10285 = (

let uu____10288 = (FStar_Syntax_Syntax.as_arg t)
in (

let uu____10289 = (

let uu____10292 = (FStar_Syntax_Syntax.as_arg a)
in (uu____10292)::[])
in (uu____10288)::uu____10289))
in (uu____10284)::uu____10285))
in (cons1 uu____10283 t.FStar_Syntax_Syntax.pos))) l uu____10275))))))
...
let uu____10330 = (FStar_Syntax_Unionfind.from_id id1)
in ((uu____10330), (t)))
in FStar_Syntax_Syntax.Tm_uvar (uu____10313))
in (FStar_Syntax_Syntax.mk uu____10312))
in (uu____10305 FStar_Pervasives_Native.None FStar_Range.dummyRange)))
...
let uu____10717 = (FStar_ST.op_Bang debug_term_eq)
...
let uu____10911 = (unmeta_safe t1)
in (canon_app uu____10911))
in (

let t21 = (

let uu____10915 = (unmeta_safe t2)
in (canon_app uu____10915))
in (
...
let uu____10925 = (un_uinst t11)
in (FStar_Syntax_Subst.compress uu____10925))
...
let uu____10930 = (un_uinst t21)
in (FStar_Syntax_Subst.compress uu____10930))
in uu____10927.FStar_Syntax_Syntax.n)
in ((uu____10921), (uu____10926))))
in (match (uu____10916) with
| (FStar_Syntax_Syntax.Tm_uinst (uu____10931), uu____10932) -> begin
(failwith "term_eq: impossible, should have been removed")
end
| (uu____10939, FStar_Syntax_Syntax.Tm_uinst (uu____10940)) -> begin
(failwith "term_eq: impossible, should have been removed")
end
| (FStar_Syntax_Syntax.Tm_delayed (uu____10947), uu____10948) -> begin
(failwith "term_eq: impossible, should have been removed")
end
| (uu____10973, FStar_Syntax_Syntax.Tm_delayed (uu____10974)) -> begin
(failwith "term_eq: impossible, should have been removed")
end
| (FStar_Syntax_Syntax.Tm_ascribed (uu____10999), uu____11000) -> begin
(failwith "term_eq: impossible, should have been removed")
end
| (uu____11027, FStar_Syntax_Syntax.Tm_ascribed (uu____11028)) -> begin
(failwith "term_eq: impossible, should have been removed")
end
...
let uu____11061 = (FStar_Syntax_Syntax.fv_eq x y)
in (check "fvar" uu____11061))
end
| (FStar_Syntax_Syntax.Tm_constant (c1), FStar_Syntax_Syntax.Tm_constant (c2)) -> begin
(

let uu____11064 = (FStar_Const.eq_const c1 c2)
in (check "const" uu____11064))
end
| (FStar_Syntax_Syntax.Tm_type (uu____11065), FStar_Syntax_Syntax.Tm_type (uu____11066)) -> begin
true
end
| (FStar_Syntax_Syntax.Tm_abs (b1, t12, k1), FStar_Syntax_Syntax.Tm_abs (b2, t22, k2)) -> begin
((

let uu____11115 = (eqlist (binder_eq_dbg dbg) b1 b2)
in (check "abs binders" uu____11115)) && (

let uu____11121 = (term_eq_dbg dbg t12 t22)
in (check "abs bodies" uu____11121)))
end
| (FStar_Syntax_Syntax.Tm_arrow (b1, c1), FStar_Syntax_Syntax.Tm_arrow (b2, c2)) -> begin
((

let uu____11160 = (eqlist (binder_eq_dbg dbg) b1 b2)
in (check "arrow binders" uu____11160)) && (

let uu____11166 = (comp_eq_dbg dbg c1 c2)
in (check "arrow comp" uu____11166)))
end
...
let uu____11180 = (term_eq_dbg dbg t12 t22)
in (check "refine formula" uu____11180)))
end
| (FStar_Syntax_Syntax.Tm_app (f1, a1), FStar_Syntax_Syntax.Tm_app (f2, a2)) -> begin
((

let uu____11227 = (term_eq_dbg dbg f1 f2)
in (check "app head" uu____11227)) && (

let uu____11229 = (eqlist (arg_eq_dbg dbg) a1 a2)
in (check "app args" uu____11229)))
end
| (FStar_Syntax_Syntax.Tm_match (t12, bs1), FStar_Syntax_Syntax.Tm_match (t22, bs2)) -> begin
((

let uu____11314 = (term_eq_dbg dbg t12 t22)
in (check "match head" uu____11314)) && (

let uu____11316 = (eqlist (branch_eq_dbg dbg) bs1 bs2)
in (check "match branches" uu____11316)))
end
| (FStar_Syntax_Syntax.Tm_lazy (uu____11331), uu____11332) -> begin
(

let uu____11333 = (

let uu____11334 = (unlazy t11)
in (term_eq_dbg dbg uu____11334 t21))
in (check "lazy_l" uu____11333))
end
| (uu____11335, FStar_Syntax_Syntax.Tm_lazy (uu____11336)) -> begin
(

let uu____11337 = (

let uu____11338 = (unlazy t21)
in (term_eq_dbg dbg t11 uu____11338))
in (check "lazy_r" uu____11337))
end
...
let uu____11374 = (eqlist (letbinding_eq_dbg dbg) lbs1 lbs2)
in (check "let lbs" uu____11374))) && (

let uu____11376 = (term_eq_dbg dbg t12 t22)
in (check "let body" uu____11376)))
end
| (FStar_Syntax_Syntax.Tm_uvar (u1, uu____11378), FStar_Syntax_Syntax.Tm_uvar (u2, uu____11380)) -> begin
...
let uu____11452 = (term_eq_dbg dbg qt1 qt2)
in (check "tm_quoted payload" uu____11452)))
end
...
let uu____11479 = (FStar_Ident.lid_equals n1 n2)
in (check "meta_monadic lid" uu____11479)) && (

let uu____11481 = (term_eq_dbg dbg ty1 ty2)
in (check "meta_monadic type" uu____11481)))
end
| (FStar_Syntax_Syntax.Meta_monadic_lift (s1, t13, ty1), FStar_Syntax_Syntax.Meta_monadic_lift (s2, t23, ty2)) -> begin
(((

let uu____11498 = (FStar_Ident.lid_equals s1 s2)
in (check "meta_monadic_lift src" uu____11498)) && (

let uu____11500 = (FStar_Ident.lid_equals t13 t23)
in (check "meta_monadic_lift tgt" uu____11500))) && (

let uu____11502 = (term_eq_dbg dbg ty1 ty2)
in (check "meta_monadic_lift type" uu____11502)))
end
| uu____11503 -> begin
(fail "metas")
end)
end
| (FStar_Syntax_Syntax.Tm_unknown, uu____11508) -> begin
(fail "unk")
end
| (uu____11509, FStar_Syntax_Syntax.Tm_unknown) -> begin
(fail "unk")
end
| (FStar_Syntax_Syntax.Tm_bvar (uu____11510), uu____11511) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_name (uu____11512), uu____11513) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_fvar (uu____11514), uu____11515) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_constant (uu____11516), uu____11517) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_type (uu____11518), uu____11519) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_abs (uu____11520), uu____11521) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_arrow (uu____11538), uu____11539) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_refine (uu____11552), uu____11553) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_app (uu____11560), uu____11561) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_match (uu____11576), uu____11577) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_let (uu____11600), uu____11601) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_uvar (uu____11614), uu____11615) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_meta (uu____11632), uu____11633) -> begin
(fail "bottom")
end
| (uu____11640, FStar_Syntax_Syntax.Tm_bvar (uu____11641)) -> begin
(fail "bottom")
end
| (uu____11642, FStar_Syntax_Syntax.Tm_name (uu____11643)) -> begin
(fail "bottom")
end
| (uu____11644, FStar_Syntax_Syntax.Tm_fvar (uu____11645)) -> begin
(fail "bottom")
end
| (uu____11646, FStar_Syntax_Syntax.Tm_constant (uu____11647)) -> begin
(fail "bottom")
end
| (uu____11648, FStar_Syntax_Syntax.Tm_type (uu____11649)) -> begin
(fail "bottom")
end
| (uu____11650, FStar_Syntax_Syntax.Tm_abs (uu____11651)) -> begin
(fail "bottom")
end
| (uu____11668, FStar_Syntax_Syntax.Tm_arrow (uu____11669)) -> begin
(fail "bottom")
end
| (uu____11682, FStar_Syntax_Syntax.Tm_refine (uu____11683)) -> begin
(fail "bottom")
end
| (uu____11690, FStar_Syntax_Syntax.Tm_app (uu____11691)) -> begin
(fail "bottom")
end
| (uu____11706, FStar_Syntax_Syntax.Tm_match (uu____11707)) -> begin
(fail "bottom")
end
| (uu____11730, FStar_Syntax_Syntax.Tm_let (uu____11731)) -> begin
(fail "bottom")
end
| (uu____11744, FStar_Syntax_Syntax.Tm_uvar (uu____11745)) -> begin
(fail "bottom")
end
| (uu____11762, FStar_Syntax_Syntax.Tm_meta (uu____11763)) -> begin
(fail "bottom")
end)))))
...
let uu____11790 = (term_eq_dbg dbg t1 t2)
in (check "arg tm" uu____11790))) (fun q1 q2 -> (check "arg qual" (Prims.op_Equality q1 q2))) a1 a2))
...
let uu____11811 = (term_eq_dbg dbg b11.FStar_Syntax_Syntax.sort b21.FStar_Syntax_Syntax.sort)
in (check "binder sort" uu____11811))) (fun q1 q2 -> (check "binder qual" (Prims.op_Equality q1 q2))) b1 b2))
...
let uu____11831 = (FStar_Ident.lid_equals c11.FStar_Syntax_Syntax.effect_name c21.FStar_Syntax_Syntax.effect_name)
in (check "comp eff" uu____11831)) && (

let uu____11833 = (term_eq_dbg dbg c11.FStar_Syntax_Syntax.result_typ c21.FStar_Syntax_Syntax.result_typ)
in (check "comp result typ" uu____11833))) && true))))
and eq_flags_dbg : Prims.bool  ->  FStar_Syntax_Syntax.cflags  ->  FStar_Syntax_Syntax.cflags  ->  Prims.bool = (fun dbg f1 f2 -> true)
and branch_eq_dbg : Prims.bool  ->  (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax FStar_Pervasives_Native.option * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax)  ->  (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax FStar_Pervasives_Native.option * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax)  ->  Prims.bool = (fun dbg uu____11838 uu____11839 -> (match (((uu____11838), (uu____11839))) with
| ((p1, w1, t1), (p2, w2, t2)) -> begin
(((

let uu____11964 = (FStar_Syntax_Syntax.eq_pat p1 p2)
in (check "branch pat" uu____11964)) && (

let uu____11966 = (term_eq_dbg dbg t1 t2)
in (check "branch body" uu____11966))) && (

let uu____11968 = (match (((w1), (w2))) with
| (FStar_Pervasives_Native.Some (x), FStar_Pervasives_Native.Some (y)) -> begin
(term_eq_dbg dbg x y)
end
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None) -> begin
...
in (check "branch when" uu____11968)))
end))
...
let uu____12025 = (eqsum (fun bv1 bv2 -> true) FStar_Syntax_Syntax.fv_eq lb1.FStar_Syntax_Syntax.lbname lb2.FStar_Syntax_Syntax.lbname)
in (check "lb bv" uu____12025)) && (

let uu____12031 = (term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbtyp lb2.FStar_Syntax_Syntax.lbtyp)
in (check "lb typ" uu____12031))) && (

let uu____12033 = (term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbdef lb2.FStar_Syntax_Syntax.lbdef)
in (check "lb def" uu____12033))))
...
let uu____12045 = (FStar_ST.op_Bang debug_term_eq)
in (term_eq_dbg uu____12045 t1 t2))
...
| FStar_Syntax_Syntax.Tm_delayed (uu____12110) -> begin
(

let uu____12135 = (

let uu____12136 = (FStar_Syntax_Subst.compress t)
in (sizeof uu____12136))
in ((Prims.parse_int "1") + uu____12135))
end
| FStar_Syntax_Syntax.Tm_bvar (bv) -> begin
(

let uu____12138 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____12138))
end
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
(

let uu____12140 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____12140))
end
| FStar_Syntax_Syntax.Tm_uinst (t1, us) -> begin
(

let uu____12147 = (sizeof t1)
in ((FStar_List.length us) + uu____12147))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, uu____12150) -> begin
(

let uu____12171 = (sizeof t1)
in (

let uu____12172 = (FStar_List.fold_left (fun acc uu____12183 -> (match (uu____12183) with
| (bv, uu____12189) -> begin
(

let uu____12190 = (sizeof bv.FStar_Syntax_Syntax.sort)
in (acc + uu____12190))
end)) (Prims.parse_int "0") bs)
in (uu____12171 + uu____12172)))
end
| FStar_Syntax_Syntax.Tm_app (hd1, args) -> begin
(

let uu____12213 = (sizeof hd1)
in (

let uu____12214 = (FStar_List.fold_left (fun acc uu____12225 -> (match (uu____12225) with
| (arg, uu____12231) -> begin
(

let uu____12232 = (sizeof arg)
in (acc + uu____12232))
end)) (Prims.parse_int "0") args)
in (uu____12213 + uu____12214)))
end
| uu____12233 -> begin
(Prims.parse_int "1")
end))
...
let uu____12245 = (un_uinst t)
in uu____12245.FStar_Syntax_Syntax.n)
...
let uu____12290 = (FStar_Options.set_options t s)
...
let uu____12298 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right uu____12298 (fun a238 -> ())));
(match (sopt) with
| FStar_Pervasives_Native.None -> begin
()
end
...
| FStar_Syntax_Syntax.Tm_delayed (uu____12318) -> begin
(failwith "Impossible")
end
...
| FStar_Syntax_Syntax.Tm_fvar (uu____12374) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_constant (uu____12375) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_lazy (uu____12376) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
[]
...
| FStar_Syntax_Syntax.Tm_abs (bs, t1, uu____12385) -> begin
(

let uu____12406 = (FStar_Syntax_Subst.open_term bs t1)
in (match (uu____12406) with
| (bs1, t2) -> begin
(

let uu____12415 = (FStar_List.collect (fun uu____12425 -> (match (uu____12425) with
| (b, uu____12433) -> begin
(unbound_variables b.FStar_Syntax_Syntax.sort)
end)) bs1)
in (

let uu____12434 = (unbound_variables t2)
in (FStar_List.append uu____12415 uu____12434)))
end))
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(

let uu____12455 = (FStar_Syntax_Subst.open_comp bs c)
in (match (uu____12455) with
| (bs1, c1) -> begin
(

let uu____12464 = (FStar_List.collect (fun uu____12474 -> (match (uu____12474) with
| (b, uu____12482) -> begin
(unbound_variables b.FStar_Syntax_Syntax.sort)
end)) bs1)
in (

let uu____12483 = (unbound_variables_comp c1)
in (FStar_List.append uu____12464 uu____12483)))
end))
end
| FStar_Syntax_Syntax.Tm_refine (b, t1) -> begin
(

let uu____12492 = (FStar_Syntax_Subst.open_term ((((b), (FStar_Pervasives_Native.None)))::[]) t1)
in (match (uu____12492) with
| (bs, t2) -> begin
(

let uu____12515 = (FStar_List.collect (fun uu____12525 -> (match (uu____12525) with
| (b1, uu____12533) -> begin
(unbound_variables b1.FStar_Syntax_Syntax.sort)
end)) bs)
in (

let uu____12534 = (unbound_variables t2)
in (FStar_List.append uu____12515 uu____12534)))
end))
end
| FStar_Syntax_Syntax.Tm_app (t1, args) -> begin
(

let uu____12559 = (FStar_List.collect (fun uu____12569 -> (match (uu____12569) with
| (x, uu____12577) -> begin
(unbound_variables x)
end)) args)
in (

let uu____12578 = (unbound_variables t1)
in (FStar_List.append uu____12559 uu____12578)))
end
| FStar_Syntax_Syntax.Tm_match (t1, pats) -> begin
(

let uu____12619 = (unbound_variables t1)
in (

let uu____12622 = (FStar_All.pipe_right pats (FStar_List.collect (fun br -> (

let uu____12651 = (FStar_Syntax_Subst.open_branch br)
in (match (uu____12651) with
| (p, wopt, t2) -> begin
(

let uu____12673 = (unbound_variables t2)
in (

let uu____12676 = (match (wopt) with
| FStar_Pervasives_Native.None -> begin
[]
end
...
in (FStar_List.append uu____12673 uu____12676)))
end)))))
in (FStar_List.append uu____12619 uu____12622)))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, asc, uu____12690) -> begin
(

let uu____12731 = (unbound_variables t1)
in (

let uu____12734 = (

let uu____12737 = (match ((FStar_Pervasives_Native.fst asc)) with
...
let uu____12768 = (match ((FStar_Pervasives_Native.snd asc)) with
| FStar_Pervasives_Native.None -> begin
[]
end
...
in (FStar_List.append uu____12737 uu____12768)))
in (FStar_List.append uu____12731 uu____12734)))
end
| FStar_Syntax_Syntax.Tm_let ((false, (lb)::[]), t1) -> begin
(

let uu____12806 = (unbound_variables lb.FStar_Syntax_Syntax.lbtyp)
in (

let uu____12809 = (

let uu____12812 = (unbound_variables lb.FStar_Syntax_Syntax.lbdef)
in (

let uu____12815 = (match (lb.FStar_Syntax_Syntax.lbname) with
| FStar_Util.Inr (uu____12820) -> begin
(unbound_variables t1)
end
| FStar_Util.Inl (bv) -> begin
(

let uu____12822 = (FStar_Syntax_Subst.open_term ((((bv), (FStar_Pervasives_Native.None)))::[]) t1)
in (match (uu____12822) with
| (uu____12843, t2) -> begin
(unbound_variables t2)
end))
end)
in (FStar_List.append uu____12812 uu____12815)))
in (FStar_List.append uu____12806 uu____12809)))
end
| FStar_Syntax_Syntax.Tm_let ((uu____12845, lbs), t1) -> begin
(

let uu____12862 = (FStar_Syntax_Subst.open_let_rec lbs t1)
in (match (uu____12862) with
| (lbs1, t2) -> begin
(

let uu____12877 = (unbound_variables t2)
in (

let uu____12880 = (FStar_List.collect (fun lb -> (

let uu____12887 = (unbound_variables lb.FStar_Syntax_Syntax.lbtyp)
in (

let uu____12890 = (unbound_variables lb.FStar_Syntax_Syntax.lbdef)
in (FStar_List.append uu____12887 uu____12890)))) lbs1)
in (FStar_List.append uu____12877 uu____12880)))
end))
end
...
let uu____12907 = (unbound_variables t1)
in (

let uu____12910 = (match (m) with
| FStar_Syntax_Syntax.Meta_pattern (args) -> begin
(FStar_List.collect (FStar_List.collect (fun uu____12939 -> (match (uu____12939) with
| (a, uu____12947) -> begin
(unbound_variables a)
end))) args)
end
| FStar_Syntax_Syntax.Meta_monadic_lift (uu____12948, uu____12949, t') -> begin
(unbound_variables t')
end
| FStar_Syntax_Syntax.Meta_monadic (uu____12955, t') -> begin
(unbound_variables t')
end
| FStar_Syntax_Syntax.Meta_labeled (uu____12961) -> begin
[]
end
| FStar_Syntax_Syntax.Meta_desugared (uu____12968) -> begin
[]
end
| FStar_Syntax_Syntax.Meta_named (uu____12969) -> begin
[]
end)
in (FStar_List.append uu____12907 uu____12910)))
end)))
...
| FStar_Syntax_Syntax.GTotal (t, uu____12974) -> begin
(unbound_variables t)
end
| FStar_Syntax_Syntax.Total (t, uu____12984) -> begin
(unbound_variables t)
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(

let uu____12994 = (unbound_variables ct.FStar_Syntax_Syntax.result_typ)
in (

let uu____12997 = (FStar_List.collect (fun uu____13007 -> (match (uu____13007) with
| (a, uu____13015) -> begin
(unbound_variables a)
end)) ct.FStar_Syntax_Syntax.effect_args)
in (FStar_List.append uu____12994 uu____12997)))
end))
