...
| FStar_Syntax_Syntax.Tm_uinst (t1, uu____2574) -> begin
(is_unit t1)
end
| uu____2579 -> begin
false
...
let uu____2585 = (unrefine t)
in uu____2585.FStar_Syntax_Syntax.n)
in (match (uu____2584) with
| FStar_Syntax_Syntax.Tm_type (uu____2588) -> begin
true
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
| FStar_Syntax_Syntax.Tm_app (head1, uu____2591) -> begin
(non_informative head1)
end
| FStar_Syntax_Syntax.Tm_uinst (t1, uu____2613) -> begin
(non_informative t1)
end
| FStar_Syntax_Syntax.Tm_arrow (uu____2618, c) -> begin
...
let uu____2642 = (FStar_Syntax_Subst.compress e)
in uu____2642.FStar_Syntax_Syntax.n)
in (match (uu____2641) with
| FStar_Syntax_Syntax.Tm_abs (uu____2645) -> begin
true
end
| uu____2662 -> begin
false
...
let uu____2668 = (FStar_Syntax_Subst.compress t)
in uu____2668.FStar_Syntax_Syntax.n)
in (match (uu____2667) with
| FStar_Syntax_Syntax.Tm_arrow (uu____2671) -> begin
true
end
| uu____2684 -> begin
false
...
| FStar_Syntax_Syntax.Tm_ascribed (t2, uu____2697, uu____2698) -> begin
(pre_typ t2)
end
| uu____2739 -> begin
t1
...
let uu____2760 = (un_uinst typ1)
in uu____2760.FStar_Syntax_Syntax.n)
...
| FStar_Syntax_Syntax.Sig_let (uu____2856, lids) -> begin
lids
end
| FStar_Syntax_Syntax.Sig_bundle (uu____2862, lids) -> begin
lids
end
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, uu____2873, uu____2874, uu____2875, uu____2876, uu____2877) -> begin
(lid)::[]
end
| FStar_Syntax_Syntax.Sig_effect_abbrev (lid, uu____2887, uu____2888, uu____2889, uu____2890) -> begin
(lid)::[]
end
| FStar_Syntax_Syntax.Sig_datacon (lid, uu____2896, uu____2897, uu____2898, uu____2899, uu____2900) -> begin
(lid)::[]
end
| FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____2906, uu____2907) -> begin
(lid)::[]
end
| FStar_Syntax_Syntax.Sig_assume (lid, uu____2909, uu____2910) -> begin
(lid)::[]
end
...
| FStar_Syntax_Syntax.Sig_sub_effect (uu____2913) -> begin
[]
end
| FStar_Syntax_Syntax.Sig_pragma (uu____2914) -> begin
[]
end
| FStar_Syntax_Syntax.Sig_main (uu____2915) -> begin
[]
end))
...
let range_of_lb : 'Auu____2946 'Auu____2947 . ((FStar_Syntax_Syntax.bv, FStar_Ident.lid) FStar_Util.either * 'Auu____2947 * 'Auu____2946)  ->  FStar_Range.range = (fun uu___175_2961 -> (match (uu___175_2961) with
| (FStar_Util.Inl (x), uu____2973, uu____2974) -> begin
(FStar_Syntax_Syntax.range_of_bv x)
end
| (FStar_Util.Inr (l), uu____2980, uu____2981) -> begin
(FStar_Ident.range_of_lid l)
end))


let range_of_arg : 'Auu____2992 'Auu____2993 . ('Auu____2993 FStar_Syntax_Syntax.syntax * 'Auu____2992)  ->  FStar_Range.range = (fun uu____3003 -> (match (uu____3003) with
| (hd1, uu____3011) -> begin
hd1.FStar_Syntax_Syntax.pos
end))


let range_of_args : 'Auu____3024 'Auu____3025 . ('Auu____3025 FStar_Syntax_Syntax.syntax * 'Auu____3024) Prims.list  ->  FStar_Range.range  ->  FStar_Range.range = (fun args r -> (FStar_All.pipe_right args (FStar_List.fold_left (fun r1 a -> (FStar_Range.union_ranges r1 (range_of_arg a))) r)))
...
let uu____3160 = (FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in ((uu____3160), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Data_app))))
in FStar_Syntax_Syntax.Tm_meta (uu____3153))
in (FStar_Syntax_Syntax.mk uu____3152))
in (uu____3149 FStar_Pervasives_Native.None (FStar_Ident.range_of_lid l)))
end
| uu____3164 -> begin
(
...
let uu____3176 = (FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in (mk_app uu____3176 args))
...
let uu____3194 = (FStar_Util.substring_from x.FStar_Ident.idText (Prims.parse_int "9"))
in ((uu____3194), (x.FStar_Ident.idRange)))
in (FStar_Ident.mk_ident uu____3189))
end
| uu____3195 -> begin
x
end))
...
let uu____3237 = (FStar_Syntax_Syntax.is_null_bv x)
...
let uu____3244 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" uu____3244))
in (

let uu____3245 = (FStar_Syntax_Syntax.range_of_bv x)
in ((uu____3243), (uu____3245))))
in (FStar_Ident.mk_ident uu____3238))
end
| uu____3246 -> begin
...
let uu___179_3248 = x
in {FStar_Syntax_Syntax.ppname = nm; FStar_Syntax_Syntax.index = uu___179_3248.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___179_3248.FStar_Syntax_Syntax.sort})
in (

let uu____3249 = (mk_field_projector_name_from_ident lid nm)
in ((uu____3249), (y))))))


let set_uvar : FStar_Syntax_Syntax.uvar  ->  FStar_Syntax_Syntax.term  ->  Prims.unit = (fun uv t -> (

let uu____3258 = (FStar_Syntax_Unionfind.find uv)
in (match (uu____3258) with
| FStar_Pervasives_Native.Some (uu____3261) -> begin
(
...
let uu____3264 = (FStar_Syntax_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int uu____3264))
in (FStar_Util.format1 "Changing a fixed uvar! ?%s\n" uu____3263))
in (failwith uu____3262))
end
| uu____3265 -> begin
...
let uu___180_3373 = rc
in (

let uu____3374 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (FStar_Syntax_Subst.close bs))
in {FStar_Syntax_Syntax.residual_effect = uu___180_3373.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____3374; FStar_Syntax_Syntax.residual_flags = uu___180_3373.FStar_Syntax_Syntax.residual_flags}))
in FStar_Pervasives_Native.Some (uu____3372))
end))
in (match (bs) with
| [] -> begin
t
...
let uu____3387 = (FStar_Syntax_Subst.close bs t)
in (FStar_Syntax_Subst.compress uu____3387))
...
let uu____3443 = (FStar_Syntax_Subst.close_binders bs)
in (FStar_List.append uu____3443 bs'))
in (

let uu____3454 = (close_lopt lopt')
in ((uu____3436), (t1), (uu____3454))))
in FStar_Syntax_Syntax.Tm_abs (uu____3419))
in (FStar_Syntax_Syntax.mk uu____3418))
in (uu____3415 FStar_Pervasives_Native.None t1.FStar_Syntax_Syntax.pos))
end
| uu____3470 -> begin
(
...
let uu____3498 = (FStar_Syntax_Subst.close_binders bs)
in (

let uu____3499 = (close_lopt lopt)
in ((uu____3498), (body), (uu____3499))))
in FStar_Syntax_Syntax.Tm_abs (uu____3481))
in (FStar_Syntax_Syntax.mk uu____3480))
in (uu____3477 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos))
end))
end)))
...
let uu____3563 = (FStar_Syntax_Subst.close_binders bs)
in (

let uu____3564 = (FStar_Syntax_Subst.close_comp bs c)
in ((uu____3563), (uu____3564))))
in FStar_Syntax_Syntax.Tm_arrow (uu____3550))
in (FStar_Syntax_Syntax.mk uu____3549))
in (uu____3546 FStar_Pervasives_Native.None c.FStar_Syntax_Syntax.pos))
end))
...
let uu____3598 = (FStar_Syntax_Subst.compress t)
in uu____3598.FStar_Syntax_Syntax.n)
in (match (uu____3597) with
| FStar_Syntax_Syntax.Tm_arrow (bs1, c1) -> begin
(match (c1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (tres, uu____3624) -> begin
(

let uu____3633 = (

let uu____3634 = (FStar_Syntax_Subst.compress tres)
...
let uu____3683 = (FStar_Syntax_Syntax.range_of_bv b)
in (FStar_Range.union_ranges uu____3683 t.FStar_Syntax_Syntax.pos))
in (
...
let uu____3697 = (FStar_Syntax_Syntax.mk_binder b)
in (uu____3697)::[])
in (FStar_Syntax_Subst.close uu____3696 t))
in ((b), (uu____3695)))
in FStar_Syntax_Syntax.Tm_refine (uu____3688))
in (FStar_Syntax_Syntax.mk uu____3687))
in (uu____3684 FStar_Pervasives_Native.None uu____3682))))
...
let uu____3748 = (FStar_Syntax_Subst.open_comp bs c)
in (match (uu____3748) with
| (bs1, c1) -> begin
(

let uu____3765 = (is_tot_or_gtot_comp c1)
in (match (uu____3765) with
| true -> begin
(

let uu____3776 = (arrow_formals_comp (comp_result c1))
...
let uu____3823 = (FStar_Syntax_Syntax.mk_Total k1)
in (([]), (uu____3823)))
end)))
...
let uu____3850 = (arrow_formals_comp k)
...
let uu___181_3928 = rc
in (

let uu____3929 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (FStar_Syntax_Subst.subst s))
in {FStar_Syntax_Syntax.residual_effect = uu___181_3928.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____3929; FStar_Syntax_Syntax.residual_flags = uu___181_3928.FStar_Syntax_Syntax.residual_flags}))
in FStar_Pervasives_Native.Some (uu____3927))
end
| uu____3936 -> begin
l
end))
...
let uu____3968 = (FStar_Syntax_Subst.compress t1)
in (FStar_All.pipe_left unascribe uu____3968))
in uu____3965.FStar_Syntax_Syntax.n)
in (match (uu____3964) with
| FStar_Syntax_Syntax.Tm_abs (bs, t2, what) -> begin
(

let uu____4006 = (aux t2 what)
...
let uu____4079 = (aux t FStar_Pervasives_Native.None)
in (match (uu____4079) with
| (bs, t1, abs_body_lcomp) -> begin
(

let uu____4121 = (FStar_Syntax_Subst.open_term' bs t1)
...
| (FStar_Pervasives_Native.None, uu____4235) -> begin
def
end
| (uu____4246, []) -> begin
def
end
| (FStar_Pervasives_Native.Some (fvs), uu____4258) -> begin
(
...
let uu____4361 = (FStar_Syntax_Subst.open_univ_vars_comp uvs c)
...
let uu____4400 = (FStar_Syntax_Subst.open_univ_vars uvs t')
...
let uu____4420 = (FStar_Syntax_Subst.compress t'1)
in uu____4420.FStar_Syntax_Syntax.n)
...
let uu____4540 = (pre_typ t)
in uu____4540.FStar_Syntax_Syntax.n)
in (match (uu____4539) with
| FStar_Syntax_Syntax.Tm_fvar (uu____4543) -> begin
(is_constructor t lid)
end
| FStar_Syntax_Syntax.Tm_app (t1, uu____4545) -> begin
(is_constructed_typ t1 lid)
end
| FStar_Syntax_Syntax.Tm_uinst (t1, uu____4567) -> begin
(is_constructed_typ t1 lid)
end
| uu____4572 -> begin
false
...
let t1 = (pre_typ t)
in (match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_bvar (uu____4582) -> begin
FStar_Pervasives_Native.Some (t1)
end
| FStar_Syntax_Syntax.Tm_name (uu____4583) -> begin
FStar_Pervasives_Native.Some (t1)
end
| FStar_Syntax_Syntax.Tm_fvar (uu____4584) -> begin
FStar_Pervasives_Native.Some (t1)
end
| FStar_Syntax_Syntax.Tm_app (t2, uu____4586) -> begin
(get_tycon t2)
end
| uu____4607 -> begin
FStar_Pervasives_Native.None
...
let uu____4620 = (un_uinst t)
in uu____4620.FStar_Syntax_Syntax.n)
...
let uu____4640 = (un_uinst t)
in uu____4640.FStar_Syntax_Syntax.n)
...
let type_u : Prims.unit  ->  (FStar_Syntax_Syntax.typ * FStar_Syntax_Syntax.universe) = (fun uu____4656 -> (

let u = (

let uu____4662 = (FStar_Syntax_Unionfind.univ_fresh ())
in (FStar_All.pipe_left (fun _0_28 -> FStar_Syntax_Syntax.U_unif (_0_28)) uu____4662))
in (

let uu____4679 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (u)) FStar_Pervasives_Native.None FStar_Range.dummyRange)
in ((uu____4679), (u)))))
...
let uu____4691 = (FStar_Ident.lid_of_path (("FStar")::("Pervasives")::("Substitute")::[]) FStar_Range.dummyRange)
in (FStar_Syntax_Syntax.lid_as_fv uu____4691 FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None))
in FStar_Syntax_Syntax.Tm_fvar (uu____4690))
in (FStar_Syntax_Syntax.mk uu____4689))
in (uu____4686 FStar_Pervasives_Native.None FStar_Range.dummyRange))
...
let uu____4747 = (FStar_Range.union_ranges phi11.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (
...
let uu____4770 = (FStar_Syntax_Syntax.as_arg phi11)
in (

let uu____4771 = (

let uu____4774 = (FStar_Syntax_Syntax.as_arg phi2)
in (uu____4774)::[])
in (uu____4770)::uu____4771))
in ((tand), (uu____4767)))
in FStar_Syntax_Syntax.Tm_app (uu____4752))
in (FStar_Syntax_Syntax.mk uu____4751))
in (uu____4748 FStar_Pervasives_Native.None uu____4747)))
in FStar_Pervasives_Native.Some (uu____4744))
end))
...
let uu____4800 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (
...
let uu____4823 = (FStar_Syntax_Syntax.as_arg phi1)
in (

let uu____4824 = (

let uu____4827 = (FStar_Syntax_Syntax.as_arg phi2)
in (uu____4827)::[])
in (uu____4823)::uu____4824))
in ((op_t), (uu____4820)))
in FStar_Syntax_Syntax.Tm_app (uu____4805))
in (FStar_Syntax_Syntax.mk uu____4804))
in (uu____4801 FStar_Pervasives_Native.None uu____4800))))
...
let uu____4863 = (FStar_Syntax_Syntax.as_arg phi)
in (uu____4863)::[])
in ((t_not), (uu____4860)))
in FStar_Syntax_Syntax.Tm_app (uu____4845))
in (FStar_Syntax_Syntax.mk uu____4844))
in (uu____4841 FStar_Pervasives_Native.None phi.FStar_Syntax_Syntax.pos)))
...
let uu____4957 = (FStar_Syntax_Syntax.as_arg e)
in (uu____4957)::[])
in ((b2t_v), (uu____4954)))
in FStar_Syntax_Syntax.Tm_app (uu____4939))
in (FStar_Syntax_Syntax.mk uu____4938))
in (uu____4935 FStar_Pervasives_Native.None e.FStar_Syntax_Syntax.pos)))
...
let uu____4973 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (
...
let uu____4996 = (FStar_Syntax_Syntax.as_arg e1)
in (

let uu____4997 = (

let uu____5000 = (FStar_Syntax_Syntax.as_arg e2)
in (uu____5000)::[])
in (uu____4996)::uu____4997))
in ((teq), (uu____4993)))
in FStar_Syntax_Syntax.Tm_app (uu____4978))
in (FStar_Syntax_Syntax.mk uu____4977))
in (uu____4974 FStar_Pervasives_Native.None uu____4973))))
...
let uu____5023 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (
...
let uu____5046 = (FStar_Syntax_Syntax.iarg t)
in (

let uu____5047 = (

let uu____5050 = (FStar_Syntax_Syntax.as_arg e1)
in (

let uu____5051 = (

let uu____5054 = (FStar_Syntax_Syntax.as_arg e2)
in (uu____5054)::[])
in (uu____5050)::uu____5051))
in (uu____5046)::uu____5047))
in ((eq_inst), (uu____5043)))
in FStar_Syntax_Syntax.Tm_app (uu____5028))
in (FStar_Syntax_Syntax.mk uu____5027))
in (uu____5024 FStar_Pervasives_Native.None uu____5023)))))
...
let uu____5102 = (FStar_Syntax_Syntax.iarg t)
in (

let uu____5103 = (

let uu____5106 = (FStar_Syntax_Syntax.as_arg x)
in (

let uu____5107 = (

let uu____5110 = (FStar_Syntax_Syntax.as_arg t')
in (uu____5110)::[])
in (uu____5106)::uu____5107))
in (uu____5102)::uu____5103))
in ((t_has_type1), (uu____5099)))
in FStar_Syntax_Syntax.Tm_app (uu____5084))
in (FStar_Syntax_Syntax.mk uu____5083))
in (uu____5080 FStar_Pervasives_Native.None FStar_Range.dummyRange)))))
...
let uu____5131 = (FStar_Syntax_Syntax.fvar FStar_Parser_Const.lextop_lid FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in ((uu____5131), ((FStar_Syntax_Syntax.U_zero)::[])))
in FStar_Syntax_Syntax.Tm_uinst (uu____5124))
in (FStar_Syntax_Syntax.mk uu____5123))
in (uu____5120 FStar_Pervasives_Native.None FStar_Range.dummyRange))
...
let uu____5145 = (match (c0.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (uu____5158) -> begin
((FStar_Parser_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[]))
end
| FStar_Syntax_Syntax.GTotal (uu____5169) -> begin
...
{FStar_Syntax_Syntax.eff_name = eff_name; FStar_Syntax_Syntax.res_typ = (comp_result c0); FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = (fun uu____5190 -> c0)}
end)))
...
let uu____5277 = (FStar_Syntax_Syntax.iarg x.FStar_Syntax_Syntax.sort)
in (
...
let uu____5284 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____5284)::[])
in (abs uu____5283 body (FStar_Pervasives_Native.Some ((residual_tot ktype0)))))
in (FStar_Syntax_Syntax.as_arg uu____5282))
in (uu____5281)::[])
in (uu____5277)::uu____5278))
in ((fa), (uu____5274)))
in FStar_Syntax_Syntax.Tm_app (uu____5259))
in (FStar_Syntax_Syntax.mk uu____5258))
in (uu____5255 FStar_Pervasives_Native.None FStar_Range.dummyRange)))
...
let uu____5330 = (FStar_Syntax_Syntax.is_null_binder b)
...
| FStar_Syntax_Syntax.Pat_wild (uu____5340) -> begin
true
end
| uu____5341 -> begin
false
...
let uu____5383 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) t1.FStar_Syntax_Syntax.pos)
in ((uu____5383), (FStar_Pervasives_Native.None), (t1)))
in (

let else_branch = (

let uu____5411 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (false))) t2.FStar_Syntax_Syntax.pos)
in ((uu____5411), (FStar_Pervasives_Native.None), (t2)))
in (

let uu____5424 = (

let uu____5425 = (FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos t2.FStar_Syntax_Syntax.pos)
in (FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos uu____5425))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (((b), ((then_branch)::(else_branch)::[])))) FStar_Pervasives_Native.None uu____5424)))))
...
let uu____5493 = (FStar_Syntax_Syntax.mk_Tm_uinst sq ((FStar_Syntax_Syntax.U_zero)::[]))
in (

let uu____5496 = (

let uu____5505 = (FStar_Syntax_Syntax.as_arg p)
in (uu____5505)::[])
in (mk_app uu____5493 uu____5496)))))
...
let uu____5514 = (head_and_args t)
...
let uu____5569 = (un_uinst head1)
in uu____5569.FStar_Syntax_Syntax.n)
in ((uu____5568), (args)))
in (match (uu____5555) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((p, uu____5586))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid) -> begin
...
let uu____5644 = (FStar_Syntax_Syntax.mk_binder b)
in (uu____5644)::[])
in (FStar_Syntax_Subst.open_term uu____5643 p))
...
let uu____5679 = (FStar_Syntax_Free.names p1)
in (FStar_Util.set_mem (FStar_Pervasives_Native.fst b1) uu____5679))
...
let uu____5737 = (FStar_Syntax_Subst.compress t)
...
let uu____5856 = (arrow bs c)
in (FStar_Syntax_Syntax.mk_Total uu____5856))
in ((b), (uu____5855)))
in FStar_Pervasives_Native.Some (uu____5846))
end
| uu____5869 -> begin
FStar_Pervasives_Native.None
end))
in (FStar_Util.bind_opt uu____5723 (fun uu____5905 -> (match (uu____5905) with
| (b, c) -> begin
(

let uu____5940 = (FStar_Syntax_Subst.open_comp ((b)::[]) c)
...
let uu____6012 = (FStar_Syntax_Free.names t)
in (FStar_Util.set_mem bv uu____6012)))
...
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic (uu____6165)) -> begin
(unmeta_monadic t)
end
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic_lift (uu____6177)) -> begin
(unmeta_monadic t)
end
| uu____6190 -> begin
f2
...
let aux = (fun f2 uu____6268 -> (match (uu____6268) with
| (lid, arity) -> begin
(

let uu____6277 = (

let uu____6292 = (unmeta_monadic f2)
in (head_and_args uu____6292))
...
let uu____6318 = ((is_constructor t1 lid) && (Prims.op_Equality (FStar_List.length args) arity))
...
let uu____6393 = (FStar_Syntax_Subst.compress t2)
in ((pats), (uu____6393)))
end
| uu____6404 -> begin
(([]), (t1))
...
let uu____6451 = (head_and_args t1)
in (match (uu____6451) with
| (t2, args) -> begin
(

let uu____6498 = (un_uinst t2)
in (

let uu____6499 = (FStar_All.pipe_right args (FStar_List.map (fun uu____6532 -> (match (uu____6532) with
| (t3, imp) -> begin
(

let uu____6543 = (unascribe t3)
in ((uu____6543), (imp)))
end))))
in ((uu____6498), (uu____6499))))
end)))
in (
...
let uu____6595 = (flat t1)
in ((qopt), (uu____6595)))
in (match (uu____6578) with
| (FStar_Pervasives_Native.Some (fa), ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6622; FStar_Syntax_Syntax.vars = uu____6623}, (({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6626); FStar_Syntax_Syntax.pos = uu____6627; FStar_Syntax_Syntax.vars = uu____6628}, uu____6629))::[])) when (is_q fa tc) -> begin
(aux qopt ((b)::out) t2)
end
| (FStar_Pervasives_Native.Some (fa), ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6706; FStar_Syntax_Syntax.vars = uu____6707}, (uu____6708)::(({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6711); FStar_Syntax_Syntax.pos = uu____6712; FStar_Syntax_Syntax.vars = uu____6713}, uu____6714))::[])) when (is_q fa tc) -> begin
(aux qopt ((b)::out) t2)
end
| (FStar_Pervasives_Native.None, ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6802; FStar_Syntax_Syntax.vars = uu____6803}, (({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6806); FStar_Syntax_Syntax.pos = uu____6807; FStar_Syntax_Syntax.vars = uu____6808}, uu____6809))::[])) when (is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v) -> begin
(aux (FStar_Pervasives_Native.Some ((is_forall tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v))) ((b)::out) t2)
end
| (FStar_Pervasives_Native.None, ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6885; FStar_Syntax_Syntax.vars = uu____6886}, (uu____6887)::(({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6890); FStar_Syntax_Syntax.pos = uu____6891; FStar_Syntax_Syntax.vars = uu____6892}, uu____6893))::[])) when (is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v) -> begin
(aux (FStar_Pervasives_Native.Some ((is_forall tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v))) ((b)::out) t2)
end
| (FStar_Pervasives_Native.Some (b), uu____6981) -> begin
(

let bs = (FStar_List.rev out)
in (

let uu____7015 = (FStar_Syntax_Subst.open_term bs t1)
in (match (uu____7015) with
| (bs1, t2) -> begin
(

let uu____7024 = (patterns t2)
...
let uu____7152 = (un_squash t)
in (FStar_Util.bind_opt uu____7152 (fun t1 -> (

let uu____7168 = (head_and_args' t1)
...
let uu____7207 = (un_uinst hd1)
in uu____7207.FStar_Syntax_Syntax.n)
in ((uu____7206), ((FStar_List.length args))))
...
let uu____7313 = (un_squash t)
in (FStar_Util.bind_opt uu____7313 (fun t1 -> (

let uu____7328 = (arrow_one t1)
...
let uu____7344 = (is_tot_or_gtot_comp c)
in (not (uu____7344)))
...
let uu____7351 = (comp_to_comp_typ c)
in uu____7351.FStar_Syntax_Syntax.result_typ)
in (

let uu____7352 = (is_free_in (FStar_Pervasives_Native.fst b) q)
in (match (uu____7352) with
| true -> begin
(

let uu____7355 = (patterns q)
...
let uu____7420 = (FStar_Syntax_Syntax.as_arg (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort)
in (

let uu____7421 = (

let uu____7424 = (FStar_Syntax_Syntax.as_arg q)
in (uu____7424)::[])
in (uu____7420)::uu____7421))
in ((FStar_Parser_Const.imp_lid), (uu____7417)))
in BaseConn (uu____7412))
...
let uu____7435 = (un_squash t)
in (FStar_Util.bind_opt uu____7435 (fun t1 -> (

let uu____7466 = (head_and_args' t1)
...
let uu____7513 = (un_uinst hd1)
in uu____7513.FStar_Syntax_Syntax.n)
in ((uu____7512), (args)))
in (match (uu____7499) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((a1, uu____7528))::((a2, uu____7530))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.dtuple2_lid) -> begin
(

let uu____7565 = (

let uu____7566 = (FStar_Syntax_Subst.compress a2)
in uu____7566.FStar_Syntax_Syntax.n)
in (match (uu____7565) with
| FStar_Syntax_Syntax.Tm_abs ((b)::[], q, uu____7573) -> begin
(

let uu____7600 = (FStar_Syntax_Subst.open_term ((b)::[]) q)
...
let uu____7733 = (destruct_sq_forall phi)
...
let uu____7761 = (destruct_sq_exists phi)
...
let uu____7790 = (destruct_base_conn phi)
in (FStar_Util.catch_opt uu____7790 (fun uu____7795 -> (

let uu____7796 = (destruct_q_conn phi)
in (FStar_Util.catch_opt uu____7796 (fun uu____7801 -> (

let uu____7802 = (destruct_sq_base_conn phi)
in (FStar_Util.catch_opt uu____7802 (fun uu____7807 -> (

let uu____7808 = (destruct_sq_forall phi)
in (FStar_Util.catch_opt uu____7808 (fun uu____7813 -> (

let uu____7814 = (destruct_sq_exists phi)
in (FStar_Util.catch_opt uu____7814 (fun uu____7818 -> FStar_Pervasives_Native.None))))))))))))))))))))))))
...
let uu____7826 = (FStar_Syntax_Subst.compress t)
in uu____7826.FStar_Syntax_Syntax.n)
in (match (uu____7825) with
| FStar_Syntax_Syntax.Tm_abs ((b)::[], e, uu____7833) -> begin
(

let uu____7860 = (FStar_Syntax_Subst.open_term ((b)::[]) e)
...
let uu____7886 = (is_free_in (FStar_Pervasives_Native.fst b1) e1)
...
let uu____7898 = (FStar_Syntax_Syntax.as_arg exp_unit)
in (uu____7898)::[])
in (mk_app t uu____7889))
end
| uu____7899 -> begin
e1
end)))
...
let uu____7910 = (FStar_Syntax_Syntax.as_arg exp_unit)
in (uu____7910)::[])
in (mk_app t uu____7901))
end)))
...
let uu____7925 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.Delta_equational FStar_Pervasives_Native.None)
in FStar_Util.Inr (uu____7925))
in (

let uu____7926 = (

let uu____7927 = (FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ)
in (arrow a.FStar_Syntax_Syntax.action_params uu____7927))
in (

let uu____7930 = (abs a.FStar_Syntax_Syntax.action_params a.FStar_Syntax_Syntax.action_defn FStar_Pervasives_Native.None)
in (close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7920 a.FStar_Syntax_Syntax.action_univs uu____7926 FStar_Parser_Const.effect_Tot_lid uu____7930))))
...
let uu____7978 = (FStar_Syntax_Syntax.as_arg t)
in (uu____7978)::[])
in ((reify_), (uu____7975)))
in FStar_Syntax_Syntax.Tm_app (uu____7960))
in (FStar_Syntax_Syntax.mk uu____7959))
in (uu____7956 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos))))
...
let t1 = (FStar_Syntax_Subst.compress t)
in (match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____7991) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
fv.FStar_Syntax_Syntax.fv_delta
end
| FStar_Syntax_Syntax.Tm_bvar (uu____8017) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_name (uu____8018) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_match (uu____8019) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_uvar (uu____8042) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_type (uu____8059) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_constant (uu____8060) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_arrow (uu____8061) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_uinst (t2, uu____8075) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_refine ({FStar_Syntax_Syntax.ppname = uu____8080; FStar_Syntax_Syntax.index = uu____8081; FStar_Syntax_Syntax.sort = t2}, uu____8083) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_meta (t2, uu____8091) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_ascribed (t2, uu____8097, uu____8098) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_app (t2, uu____8140) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_abs (uu____8161, t2, uu____8163) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_let (uu____8184, t2) -> begin
(delta_qualifier t2)
end)))
...
let uu____8212 = (delta_qualifier t)
in (incr_delta_depth uu____8212)))
...
let uu____8218 = (FStar_Syntax_Subst.compress t)
in uu____8218.FStar_Syntax_Syntax.n)
...
let uu____8249 = (unmeta e)
in (head_and_args uu____8249))
...
let uu____8290 = (un_uinst head1)
in uu____8290.FStar_Syntax_Syntax.n)
in ((uu____8289), (args)))
in (match (uu____8276) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____8306) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid) -> begin
FStar_Pervasives_Native.Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____8326)::((hd1, uu____8328))::((tl1, uu____8330))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid) -> begin
(
...
let uu____8387 = (list_elements tl1)
in (FStar_Util.must uu____8387))
in (hd1)::uu____8382)
...
let rec apply_last : 'Auu____8421 . ('Auu____8421  ->  'Auu____8421)  ->  'Auu____8421 Prims.list  ->  'Auu____8421 Prims.list = (fun f l -> (match (l) with
| [] -> begin
...
let uu____8449 = (apply_last f xs)
in (x)::uu____8449)
end))
...
let uu____8494 = (FStar_Syntax_Syntax.lid_as_fv l1 FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in FStar_Syntax_Syntax.Tm_fvar (uu____8494))
in (FStar_Syntax_Syntax.mk uu____8493))
in (uu____8490 FStar_Pervasives_Native.None rng)))
in (
...
let uu____8509 = (ctor FStar_Parser_Const.cons_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____8509 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____8508 args))
in (uu____8507 FStar_Pervasives_Native.None pos)))
in (
...
let uu____8523 = (ctor FStar_Parser_Const.nil_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____8523 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____8522 args))
in (uu____8521 FStar_Pervasives_Native.None pos)))
in (
...
let uu____8528 = (FStar_Syntax_Syntax.iarg typ)
in (uu____8528)::[])
in (nil uu____8527 rng))
in (FStar_List.fold_right (fun t a -> (

let uu____8534 = (

let uu____8535 = (FStar_Syntax_Syntax.iarg typ)
in (

let uu____8536 = (

let uu____8539 = (FStar_Syntax_Syntax.as_arg t)
in (

let uu____8540 = (

let uu____8543 = (FStar_Syntax_Syntax.as_arg a)
in (uu____8543)::[])
in (uu____8539)::uu____8540))
in (uu____8535)::uu____8536))
in (cons1 uu____8534 t.FStar_Syntax_Syntax.pos))) l uu____8526))))))
...
let uu____8575 = (FStar_Syntax_Unionfind.from_id id)
in ((uu____8575), (t)))
in FStar_Syntax_Syntax.Tm_uvar (uu____8558))
in (FStar_Syntax_Syntax.mk uu____8557))
in (uu____8554 FStar_Pervasives_Native.None FStar_Range.dummyRange)))
...
| FStar_Syntax_Syntax.Tm_app (uu____9000) -> begin
(

let uu____9015 = (head_and_args' t)
in (match (uu____9015) with
| (hd1, args) -> begin
(

let uu___182_9048 = t
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app (((hd1), (args))); FStar_Syntax_Syntax.pos = uu___182_9048.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___182_9048.FStar_Syntax_Syntax.vars})
end))
end
| uu____9059 -> begin
t
...
let uu____9063 = (unmeta_safe t1)
in (canon_app uu____9063))
in (

let t21 = (

let uu____9069 = (unmeta_safe t2)
in (canon_app uu____9069))
in (match (((t11.FStar_Syntax_Syntax.n), (t21.FStar_Syntax_Syntax.n))) with
...
let uu____9581 = (FStar_Syntax_Subst.compress t)
in uu____9581.FStar_Syntax_Syntax.n)
in (
...
let uu____9622 = (ff f1)
in (

let uu____9623 = (FStar_List.map (fun uu____9642 -> (match (uu____9642) with
| (a, q) -> begin
(
...
in ((uu____9622), (uu____9623))))
in FStar_Syntax_Syntax.Tm_app (uu____9607))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, k) -> begin
(

let uu____9683 = (FStar_Syntax_Subst.open_term bs t1)
...
let uu____9708 = (FStar_Syntax_Subst.close bs1 t'')
in ((bs1), (uu____9708), (k)))
in FStar_Syntax_Syntax.Tm_abs (uu____9691)))
end))
end
...
let uu____9742 = (ff t1)
in ((uu____9742), (us)))
in FStar_Syntax_Syntax.Tm_uinst (uu____9735))
end
| uu____9743 -> begin
tn
end)
...
let uu___183_9746 = t
in {FStar_Syntax_Syntax.n = tn1; FStar_Syntax_Syntax.pos = uu___183_9746.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___183_9746.FStar_Syntax_Syntax.vars}))))))


let rec sizeof : FStar_Syntax_Syntax.term  ->  Prims.int = (fun t -> (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____9751) -> begin
(

let uu____9776 = (

let uu____9777 = (FStar_Syntax_Subst.compress t)
in (sizeof uu____9777))
in ((Prims.parse_int "1") + uu____9776))
end
| FStar_Syntax_Syntax.Tm_bvar (bv) -> begin
(

let uu____9779 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____9779))
end
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
(

let uu____9781 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____9781))
end
| FStar_Syntax_Syntax.Tm_uinst (t1, us) -> begin
(

let uu____9788 = (sizeof t1)
in ((FStar_List.length us) + uu____9788))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, uu____9791) -> begin
(

let uu____9812 = (sizeof t1)
in (

let uu____9813 = (FStar_List.fold_left (fun acc uu____9824 -> (match (uu____9824) with
| (bv, uu____9830) -> begin
(

let uu____9831 = (sizeof bv.FStar_Syntax_Syntax.sort)
in (acc + uu____9831))
end)) (Prims.parse_int "0") bs)
in (uu____9812 + uu____9813)))
end
| FStar_Syntax_Syntax.Tm_app (hd1, args) -> begin
(

let uu____9854 = (sizeof hd1)
in (

let uu____9855 = (FStar_List.fold_left (fun acc uu____9866 -> (match (uu____9866) with
| (arg, uu____9872) -> begin
(

let uu____9873 = (sizeof arg)
in (acc + uu____9873))
end)) (Prims.parse_int "0") args)
in (uu____9854 + uu____9855)))
end
| uu____9874 -> begin
(Prims.parse_int "1")
end))
...
let uu____9884 = (un_uinst t)
in uu____9884.FStar_Syntax_Syntax.n)
...
let uu____9945 = (FStar_Dyn.mkdyn b)
in ((uu____9945), (s), (ty)))
in FStar_Syntax_Syntax.Meta_alien (uu____9936))
in ((FStar_Syntax_Syntax.tun), (uu____9935)))
in FStar_Syntax_Syntax.Tm_meta (uu____9928))
in (FStar_Syntax_Syntax.mk uu____9927))
in (uu____9924 FStar_Pervasives_Native.None (match (r) with
...
let t1 = (FStar_Syntax_Subst.compress t)
in (match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_meta (uu____9958, FStar_Syntax_Syntax.Meta_alien (blob, uu____9960, uu____9961)) -> begin
blob
end
| uu____9970 -> begin
