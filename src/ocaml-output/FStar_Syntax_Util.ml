...
let constant_univ_as_nat : FStar_Syntax_Syntax.universe  ->  Prims.int = (fun u -> (let _116_72 = (univ_kernel u)
in (Prims.snd _116_72)))
...
let copt = (let _116_78 = (FStar_List.zip us1 us2)
in (FStar_Util.find_map _116_78 (fun _34_187 -> (match (_34_187) with
| (u1, u2) -> begin
(
...
let ml_comp : FStar_Syntax_Syntax.typ  ->  FStar_Range.range  ->  FStar_Syntax_Syntax.comp = (fun t r -> (let _116_88 = (let _116_87 = (FStar_Ident.set_lid_range FStar_Syntax_Const.effect_ML_lid r)
in {FStar_Syntax_Syntax.effect_name = _116_87; FStar_Syntax_Syntax.result_typ = t; FStar_Syntax_Syntax.effect_args = []; FStar_Syntax_Syntax.flags = (FStar_Syntax_Syntax.MLEFFECT)::[]})
in (FStar_Syntax_Syntax.mk_Comp _116_88)))
...
let is_pure_or_ghost_function : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _116_123 = (FStar_Syntax_Subst.compress t)
in _116_123.FStar_Syntax_Syntax.n)) with
...
let is_lemma : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _116_126 = (FStar_Syntax_Subst.compress t)
in _116_126.FStar_Syntax_Syntax.n)) with
...
let is_smt_lemma : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _116_133 = (FStar_Syntax_Subst.compress t)
in _116_133.FStar_Syntax_Syntax.n)) with
...
| (head, _34_368) -> begin
(match ((let _116_134 = (un_uinst head)
in _116_134.FStar_Syntax_Syntax.n)) with
...
let is_fun : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun e -> (match ((let _116_153 = (FStar_Syntax_Subst.compress e)
in _116_153.FStar_Syntax_Syntax.n)) with
...
let is_function_typ : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _116_156 = (FStar_Syntax_Subst.compress t)
in _116_156.FStar_Syntax_Syntax.n)) with
...
in (match ((let _116_163 = (un_uinst typ)
in _116_163.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_app (head, args) -> begin
(
...
| [] -> begin
(let _116_182 = (let _116_181 = (let _116_180 = (FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in (_116_180, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Data_app)))
in FStar_Syntax_Syntax.Tm_meta (_116_181))
in (FStar_Syntax_Syntax.mk _116_182 None (FStar_Ident.range_of_lid l)))
end
| _34_727 -> begin
(
# 442 "FStar.Syntax.Util.fst"
let e = (let _116_183 = (FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in (mk_app _116_183 args))
...
(let _116_189 = (let _116_188 = (FStar_Util.substring_from x.FStar_Ident.idText 7)
in (_116_188, x.FStar_Ident.idRange))
in (FStar_Ident.mk_ident _116_189))
end else begin
x
end)
...
(let _116_199 = (let _116_198 = (let _116_196 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _116_196))
in (let _116_197 = (FStar_Syntax_Syntax.range_of_bv x)
in (_116_198, _116_197)))
in (FStar_Ident.mk_ident _116_199))
end else begin
...
in (let _116_203 = (let _116_202 = (let _116_201 = (let _116_200 = (unmangle_field_name nm)
in (_116_200)::[])
in (FStar_List.append (FStar_Ident.ids_of_lid lid) _116_201))
in (FStar_Ident.lid_of_ids _116_202))
in (_116_203, y)))))

# 458 "FStar.Syntax.Util.fst"
let set_uvar = (fun uv t -> (match ((FStar_Unionfind.find uv)) with
| FStar_Syntax_Syntax.Fixed (_34_741) -> begin
(let _116_208 = (let _116_207 = (let _116_206 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _116_206))
in (FStar_Util.format1 "Changing a fixed uvar! ?%s\n" _116_207))
in (FStar_All.failwith _116_208))
end
| _34_744 -> begin
...
| _34_791 -> begin
(let _116_215 = (FStar_Syntax_Syntax.mk_Total k)
in ([], _116_215))
end)))
...
let body = (let _116_224 = (FStar_Syntax_Subst.close bs t)
in (FStar_Syntax_Subst.compress _116_224))
in (match ((body.FStar_Syntax_Syntax.n, lopt)) with
| (FStar_Syntax_Syntax.Tm_abs (bs', t, lopt'), None) -> begin
(let _116_228 = (let _116_227 = (let _116_226 = (let _116_225 = (FStar_Syntax_Subst.close_binders bs)
in (FStar_List.append _116_225 bs'))
in (_116_226, t, lopt))
in FStar_Syntax_Syntax.Tm_abs (_116_227))
in (FStar_Syntax_Syntax.mk _116_228 None t.FStar_Syntax_Syntax.pos))
end
| _34_811 -> begin
(
...
| Some (lc) -> begin
(let _116_229 = (FStar_Syntax_Subst.close_lcomp bs lc)
in Some (_116_229))
end)
in (let _116_232 = (let _116_231 = (let _116_230 = (FStar_Syntax_Subst.close_binders bs)
in (_116_230, body, lopt))
in FStar_Syntax_Syntax.Tm_abs (_116_231))
in (FStar_Syntax_Syntax.mk _116_232 None t.FStar_Syntax_Syntax.pos)))
end))
end))
...
| _34_820 -> begin
(let _116_240 = (let _116_239 = (let _116_238 = (FStar_Syntax_Subst.close_binders bs)
in (let _116_237 = (FStar_Syntax_Subst.close_comp bs c)
in (_116_238, _116_237)))
in FStar_Syntax_Syntax.Tm_arrow (_116_239))
in (FStar_Syntax_Syntax.mk _116_240 None c.FStar_Syntax_Syntax.pos))
end))

# 506 "FStar.Syntax.Util.fst"
let refine : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun b t -> (let _116_252 = (let _116_248 = (let _116_247 = (let _116_246 = (let _116_245 = (FStar_Syntax_Syntax.mk_binder b)
in (_116_245)::[])
in (FStar_Syntax_Subst.close _116_246 t))
in (b, _116_247))
in FStar_Syntax_Syntax.Tm_refine (_116_248))
in (let _116_251 = (FStar_ST.read b.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.tk)
in (let _116_250 = (let _116_249 = (FStar_Syntax_Syntax.range_of_bv b)
in (FStar_Range.union_ranges _116_249 t.FStar_Syntax_Syntax.pos))
in (FStar_Syntax_Syntax.mk _116_252 _116_251 _116_250)))))
...
let universes = (FStar_All.pipe_right univ_vars (FStar_List.map (fun _116_277 -> FStar_Syntax_Syntax.U_name (_116_277))))
in (
...
| (uvs, t') -> begin
(match ((let _116_285 = (FStar_Syntax_Subst.compress t')
in _116_285.FStar_Syntax_Syntax.n)) with
...
let t = (let _116_292 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "tuple%s" _116_292))
in (let _116_293 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _116_293 r))))
...
let t = (let _116_298 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Mktuple%s" _116_298))
in (let _116_299 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _116_299 r))))

# 554 "FStar.Syntax.Util.fst"
let is_tuple_data_lid : FStar_Ident.lident  ->  Prims.int  ->  Prims.bool = (fun f n -> (let _116_304 = (mk_tuple_data_lid n FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f _116_304)))
...
let t = (let _116_311 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "dtuple%s" _116_311))
in (let _116_312 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _116_312 r))))
...
let t = (let _116_317 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Mkdtuple%s" _116_317))
in (let _116_318 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _116_318 r))))
...
let is_constructor : FStar_Syntax_Syntax.term  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _116_334 = (pre_typ t)
in _116_334.FStar_Syntax_Syntax.n)) with
...
let rec is_constructed_typ : FStar_Syntax_Syntax.term  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _116_339 = (pre_typ t)
in _116_339.FStar_Syntax_Syntax.n)) with
...
let u = (let _116_350 = (FStar_Unionfind.fresh None)
in (FStar_All.pipe_left (fun _116_349 -> FStar_Syntax_Syntax.U_unif (_116_349)) _116_350))
in (let _116_351 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (u)) None FStar_Range.dummyRange)
in (_116_351, u)))
end))
...
| Some (phi1) -> begin
(let _116_365 = (let _116_364 = (let _116_362 = (let _116_361 = (let _116_360 = (FStar_Syntax_Syntax.as_arg phi1)
in (let _116_359 = (let _116_358 = (FStar_Syntax_Syntax.as_arg phi2)
in (_116_358)::[])
in (_116_360)::_116_359))
in (tand, _116_361))
in FStar_Syntax_Syntax.Tm_app (_116_362))
in (let _116_363 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _116_364 None _116_363)))
in Some (_116_365))
end))

# 655 "FStar.Syntax.Util.fst"
let mk_binop = (fun op_t phi1 phi2 -> (let _116_375 = (let _116_373 = (let _116_372 = (let _116_371 = (FStar_Syntax_Syntax.as_arg phi1)
in (let _116_370 = (let _116_369 = (FStar_Syntax_Syntax.as_arg phi2)
in (_116_369)::[])
in (_116_371)::_116_370))
in (op_t, _116_372))
in FStar_Syntax_Syntax.Tm_app (_116_373))
in (let _116_374 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _116_375 None _116_374))))

# 656 "FStar.Syntax.Util.fst"
let mk_neg = (fun phi -> (let _116_380 = (let _116_379 = (let _116_378 = (let _116_377 = (FStar_Syntax_Syntax.as_arg phi)
in (_116_377)::[])
in (t_not, _116_378))
in FStar_Syntax_Syntax.Tm_app (_116_379))
in (FStar_Syntax_Syntax.mk _116_380 None phi.FStar_Syntax_Syntax.pos)))
...
let mk_imp : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun phi1 phi2 -> (match ((let _116_393 = (FStar_Syntax_Subst.compress phi1)
in _116_393.FStar_Syntax_Syntax.n)) with
...
| _34_975 -> begin
(match ((let _116_394 = (FStar_Syntax_Subst.compress phi2)
...
let b2t = (fun e -> (let _116_401 = (let _116_400 = (let _116_399 = (let _116_398 = (FStar_Syntax_Syntax.as_arg e)
in (_116_398)::[])
in (b2t_v, _116_399))
in FStar_Syntax_Syntax.Tm_app (_116_400))
in (FStar_Syntax_Syntax.mk _116_401 None e.FStar_Syntax_Syntax.pos)))
...
in (let _116_408 = (let _116_406 = (let _116_405 = (let _116_404 = (FStar_Syntax_Syntax.null_binder atyp)
in (let _116_403 = (let _116_402 = (FStar_Syntax_Syntax.null_binder btyp)
in (_116_402)::[])
in (_116_404)::_116_403))
in ((b, Some (FStar_Syntax_Syntax.imp_tag)))::_116_405)
in ((a, Some (FStar_Syntax_Syntax.imp_tag)))::_116_406)
in (let _116_407 = (FStar_Syntax_Syntax.mk_Total ktype0)
in (arrow _116_408 _116_407)))))))

# 686 "FStar.Syntax.Util.fst"
let teq : FStar_Syntax_Syntax.term = (fvar_const FStar_Syntax_Const.eq2_lid)

# 688 "FStar.Syntax.Util.fst"
let mk_eq = (fun t1 t2 e1 e2 -> (let _116_419 = (let _116_417 = (let _116_416 = (let _116_415 = (FStar_Syntax_Syntax.as_arg e1)
in (let _116_414 = (let _116_413 = (FStar_Syntax_Syntax.as_arg e2)
in (_116_413)::[])
in (_116_415)::_116_414))
in (teq, _116_416))
in FStar_Syntax_Syntax.Tm_app (_116_417))
in (let _116_418 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _116_419 None _116_418))))
...
in (let _116_430 = (let _116_429 = (let _116_428 = (let _116_427 = (FStar_Syntax_Syntax.iarg t)
in (let _116_426 = (let _116_425 = (FStar_Syntax_Syntax.as_arg x)
in (let _116_424 = (let _116_423 = (FStar_Syntax_Syntax.as_arg t')
in (_116_423)::[])
in (_116_425)::_116_424))
in (_116_427)::_116_426))
in (t_has_type, _116_428))
in FStar_Syntax_Syntax.Tm_app (_116_429))
in (FStar_Syntax_Syntax.mk _116_430 None FStar_Range.dummyRange)))))
...
let atyp = (FStar_Syntax_Syntax.bv_to_tm a)
in (let _116_434 = (let _116_432 = (let _116_431 = (FStar_Syntax_Syntax.null_binder atyp)
in (_116_431)::[])
in ((a, Some (FStar_Syntax_Syntax.imp_tag)))::_116_432)
in (let _116_433 = (FStar_Syntax_Syntax.mk_Total ktype0)
in (arrow _116_434 _116_433)))))
...
let mk_forall : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun x body -> (let _116_451 = (let _116_450 = (let _116_449 = (let _116_448 = (let _116_447 = (let _116_446 = (let _116_442 = (FStar_Syntax_Syntax.mk_binder x)
in (_116_442)::[])
in (let _116_445 = (let _116_444 = (let _116_443 = (FStar_Syntax_Syntax.mk_Total ktype0)
in (FStar_All.pipe_left lcomp_of_comp _116_443))
in Some (_116_444))
in (abs _116_446 body _116_445)))
in (FStar_Syntax_Syntax.as_arg _116_447))
in (_116_448)::[])
in (tforall, _116_449))
in FStar_Syntax_Syntax.Tm_app (_116_450))
in (FStar_Syntax_Syntax.mk _116_451 None FStar_Range.dummyRange)))
...
let then_branch = (let _116_462 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t1.FStar_Syntax_Syntax.pos)
in (_116_462, None, t1))
in (
# 724 "FStar.Syntax.Util.fst"
let else_branch = (let _116_463 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (false))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Syntax_Syntax.pos)
in (_116_463, None, t2))
in (let _116_465 = (let _116_464 = (FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos t2.FStar_Syntax_Syntax.pos)
in (FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos _116_464))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match ((b, (then_branch)::(else_branch)::[]))) None _116_465)))))
...
(let _116_518 = (FStar_Syntax_Subst.compress t)
in (pats, _116_518))
end
| _34_1049 -> begin
...
| (t, args) -> begin
(let _116_531 = (un_uinst t)
in (let _116_530 = (FStar_All.pipe_right args (FStar_List.map (fun _34_1062 -> (match (_34_1062) with
| (t, imp) -> begin
(let _116_529 = (unascribe t)
in (_116_529, imp))
end))))
in (_116_531, _116_530)))
end)))
in (
# 769 "FStar.Syntax.Util.fst"
let rec aux = (fun qopt out t -> (match ((let _116_538 = (flat t)
in (qopt, _116_538))) with
