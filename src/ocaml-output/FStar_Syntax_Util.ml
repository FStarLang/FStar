...
let mk_dtuple_lid : Prims.int -> FStar_Range.range -> FStar_Ident.lident =
  fun n1  ->
    fun r  ->
      ...
      let uu____3282 = let uu____3283 = mod_prefix_dtuple n1  in uu____3283 t
         in
...
let mk_dtuple_data_lid : Prims.int -> FStar_Range.range -> FStar_Ident.lident
  ...
  fun n1  ->
    fun r  ->
      ...
      let uu____3294 = let uu____3295 = mod_prefix_dtuple n1  in uu____3295 t
         in
    ...
    let uu____3523 =
      let uu____3524 =
        let uu____3534 =
          ...
          let uu____3537 =
            let uu____3539 = FStar_Syntax_Syntax.as_arg phi2  in [uu____3539]
             in
...
let mk_neg phi =
  let uu____3560 =
    let uu____3563 =
      let uu____3564 =
        let uu____3574 =
          let uu____3576 = FStar_Syntax_Syntax.as_arg phi  in [uu____3576]
           in
        (t_not, uu____3574)  in
    ...
    let uu____3711 =
      let uu____3712 =
        let uu____3722 =
          ...
          let uu____3725 =
            let uu____3727 = FStar_Syntax_Syntax.as_arg e2  in [uu____3727]
             in
      ...
      let uu____3815 =
        let uu____3825 =
          ...
          let uu____3828 =
            ...
            let uu____3831 =
              let uu____3833 = FStar_Syntax_Syntax.as_arg t'  in [uu____3833]
               in
            ...
            let uu____3922 =
              let uu____3923 =
                ...
                let uu____3926 =
                  let uu____3933 =
                    let uu____3939 =
                      let uu____3940 = FStar_Syntax_Syntax.mk_Total ktype0
                         in
...
let uu___is_QAll : connective -> Prims.bool =
  fun projectee  ->
    match projectee with | QAll _0 -> true | uu____4159 -> false
...
let uu___is_QEx : connective -> Prims.bool =
  fun projectee  ->
    match projectee with | QEx _0 -> true | uu____4183 -> false
...
let uu___is_BaseConn : connective -> Prims.bool =
  fun projectee  ->
    match projectee with | BaseConn _0 -> true | uu____4206 -> false
...
let destruct_typ_as_formula : FStar_Syntax_Syntax.term -> connective option =
  fun f  ->
    let rec unmeta_monadic f1 =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          (t,FStar_Syntax_Syntax.Meta_monadic uu____4231) -> unmeta_monadic t
      | FStar_Syntax_Syntax.Tm_meta
          (t,FStar_Syntax_Syntax.Meta_monadic_lift uu____4241) ->
          unmeta_monadic t
      | uu____4251 -> f2  in
    let destruct_base_conn f1 =
      ...
      let rec aux f2 uu____4296 =
        match uu____4296 with
        | (lid,arity) ->
            let uu____4302 =
              let uu____4312 = unmeta_monadic f2  in head_and_args uu____4312
               in
             ...
             | (t,args) ->
                 ...
                 let uu____4331 =
                   (is_constructor t1 lid) &&
                    ...
                    in
                 if uu____4331 then Some (BaseConn (lid, args)) else None)
         in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          let uu____4382 = FStar_Syntax_Subst.compress t2  in
          (pats, uu____4382)
      | uu____4389 ->
          let uu____4390 = FStar_Syntax_Subst.compress t1  in
          ([], uu____4390)
       in
    let destruct_q_conn t =
      let is_q fa fv =
        ...
        then is_forall (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
         ...
         in
      let flat t1 =
        let uu____4432 = head_and_args t1  in
        match uu____4432 with
        | (t2,args) ->
            let uu____4463 = un_uinst t2  in
            let uu____4464 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____4480  ->
                      ...
                      | (t3,imp) ->
                          let uu____4487 = unascribe t3  in (uu____4487, imp)))
               in
            (uu____4463, uu____4464)
         in
      let rec aux qopt out t1 =
        let uu____4510 = let uu____4519 = flat t1  in (qopt, uu____4519)  in
        match uu____4510 with
        | (Some
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
                 FStar_Syntax_Syntax.tk = uu____4534;
                 FStar_Syntax_Syntax.pos = uu____4535;
                 FStar_Syntax_Syntax.vars = uu____4536;_},({
                                                             ...
                                                             FStar_Syntax_Syntax.vars
                                                               = uu____4542;_},uu____4543)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (Some
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
                 FStar_Syntax_Syntax.tk = uu____4604;
                 FStar_Syntax_Syntax.pos = uu____4605;
                 FStar_Syntax_Syntax.vars = uu____4606;_},uu____4607::
               ({
                  FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                    (b::[],t2,uu____4610);
                  FStar_Syntax_Syntax.tk = uu____4611;
                  FStar_Syntax_Syntax.pos = uu____4612;
                  FStar_Syntax_Syntax.vars = uu____4613;_},uu____4614)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               FStar_Syntax_Syntax.tk = uu____4682;
               FStar_Syntax_Syntax.pos = uu____4683;
               FStar_Syntax_Syntax.vars = uu____4684;_},({
                                                           FStar_Syntax_Syntax.n
                                                             =
                                                             FStar_Syntax_Syntax.Tm_abs
                                                             (b::[],t2,uu____4687);
        ...
        | (None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               ...
               FStar_Syntax_Syntax.vars = uu____4761;_},uu____4762::({
                                                                    FStar_Syntax_Syntax.n
                                                                    =
                                                                    FStar_Syntax_Syntax.Tm_abs
                                                                    (b::[],t2,uu____4765);
        ...
        | (Some b,uu____4845) ->
            ...
            let uu____4863 = FStar_Syntax_Subst.open_term bs t1  in
            (match uu____4863 with
             | (bs1,t2) ->
                 let uu____4869 = patterns t2  in
    ...
    let uu____4919 = destruct_base_conn phi  in
    match uu____4919 with | Some b -> Some b | None  -> destruct_q_conn phi
        ...
        let uu____4930 =
          let uu____4933 =
            FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name
             ...
             in
          FStar_Util.Inr uu____4933  in
        let uu____4934 =
          let uu____4935 =
            FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ  in
          arrow a.FStar_Syntax_Syntax.action_params uu____4935  in
        let uu____4938 =
          abs a.FStar_Syntax_Syntax.action_params
            a.FStar_Syntax_Syntax.action_defn None
           in
        close_univs_and_mk_letbinding None uu____4930
          a.FStar_Syntax_Syntax.action_univs uu____4934
          FStar_Syntax_Const.effect_Tot_lid uu____4938
         in
      {
...
let mk_reify t =
  ...
  let uu____4971 =
    let uu____4974 =
      let uu____4975 =
        let uu____4985 =
          let uu____4987 = FStar_Syntax_Syntax.as_arg t  in [uu____4987]  in
        (reify_, uu____4985)  in
      FStar_Syntax_Syntax.Tm_app uu____4975  in
    FStar_Syntax_Syntax.mk uu____4974  in
  uu____4971 None t.FStar_Syntax_Syntax.pos 
let rec delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t  in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____5003 -> failwith "Impossible"
    | FStar_Syntax_Syntax.Tm_fvar fv -> fv.FStar_Syntax_Syntax.fv_delta
    | FStar_Syntax_Syntax.Tm_bvar uu____5025 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_name uu____5026 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_match uu____5027 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_uvar uu____5043 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_unknown  -> FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_type uu____5052 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_constant uu____5053 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_arrow uu____5054 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_uinst (t2,uu____5063) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____5068;
           FStar_Syntax_Syntax.index = uu____5069;
           FStar_Syntax_Syntax.sort = t2;_},uu____5071)
        -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_meta (t2,uu____5079) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____5085,uu____5086) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_app (t2,uu____5116) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_abs (uu____5131,t2,uu____5133) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_let (uu____5156,t2) -> delta_qualifier t2
...
let incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let uu____5176 = delta_qualifier t  in incr_delta_depth uu____5176
  
let is_unknown : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____5180 =
      let uu____5181 = FStar_Syntax_Subst.compress t  in
...
let rec list_elements :
  ...
  fun e  ->
    let uu____5192 = let uu____5202 = unmeta e  in head_and_args uu____5202
       in
    match uu____5192 with
    | (head1,args) ->
        let uu____5221 =
          let uu____5229 =
            let uu____5230 = un_uinst head1  in
            uu____5230.FStar_Syntax_Syntax.n  in
          (uu____5229, args)  in
        (match uu____5221 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____5241) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.nil_lid ->
             Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____5254::(hd1,uu____5256)::(tl1,uu____5258)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.cons_lid ->
             let uu____5292 =
               let uu____5296 =
                 let uu____5300 = list_elements tl1  in
                 FStar_Util.must uu____5300  in
               hd1 :: uu____5296  in
             Some uu____5292
         | uu____5309 -> None)
...
let rec apply_last f l =
  ...
  | a::[] -> let uu____5340 = f a  in [uu____5340]
  | x::xs -> let uu____5344 = apply_last f xs  in x :: uu____5344 
let dm4f_lid :
    ...
    fun rng  ->
      fun l  ->
            ...
            let uu____5377 =
              let uu____5378 =
                FStar_Syntax_Syntax.lid_as_fv l1
                  ...
                  (Some FStar_Syntax_Syntax.Data_ctor)
                 in
              FStar_Syntax_Syntax.Tm_fvar uu____5378  in
            FStar_Syntax_Syntax.mk uu____5377  in
          uu____5374 None rng  in
        let cons1 args pos =
          let uu____5396 =
            let uu____5397 =
              let uu____5398 = ctor FStar_Syntax_Const.cons_lid  in
        ...
        let nil args pos =
          let uu____5412 =
            let uu____5413 =
              let uu____5414 = ctor FStar_Syntax_Const.nil_lid  in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____5414
                [FStar_Syntax_Syntax.U_zero]
               in
            FStar_Syntax_Syntax.mk_Tm_app uu____5413 args  in
          uu____5412 None pos  in
        let uu____5419 =
          let uu____5420 =
            let uu____5421 = FStar_Syntax_Syntax.iarg typ  in [uu____5421]
             in
          nil uu____5420 rng  in
        FStar_List.fold_right
          (fun t  ->
             fun a  ->
               let uu____5424 =
                 let uu____5425 = FStar_Syntax_Syntax.iarg typ  in
                 let uu____5426 =
                   let uu____5428 = FStar_Syntax_Syntax.as_arg t  in
                   let uu____5429 =
                     let uu____5431 = FStar_Syntax_Syntax.as_arg a  in
                     [uu____5431]  in
                   uu____5428 :: uu____5429  in
                 uu____5425 :: uu____5426  in
               cons1 uu____5424 t.FStar_Syntax_Syntax.pos) l uu____5419
...
let eqopt e x y =
  match (x, y) with | (Some x1,Some y1) -> e x1 y1 | uu____5656 -> false 
let rec term_eq :
  ...
  fun t1  ->
    fun t2  ->
      let uu____5749 =
        let uu____5752 =
          let uu____5753 = FStar_Syntax_Subst.compress t1  in
          uu____5753.FStar_Syntax_Syntax.n  in
        let uu____5756 =
          let uu____5757 = FStar_Syntax_Subst.compress t2  in
          uu____5757.FStar_Syntax_Syntax.n  in
        (uu____5752, uu____5756)  in
...
and branch_eq :
  ...
  fun uu____6040  ->
    fun uu____6041  ->
      match (uu____6040, uu____6041) with | ((p1,w1,t1),(p2,w2,t2)) -> false
...
let rec bottom_fold :
  ...
  fun f  ->
    fun t  ->
      ...
      let tn =
        let uu____6151 = un_uinst t  in uu____6151.FStar_Syntax_Syntax.n  in
      let tn1 =
        match tn with
        | FStar_Syntax_Syntax.Tm_app (f1,args) ->
            let uu____6171 =
              let uu____6181 = ff f1  in
              let uu____6182 =
                FStar_List.map
                  (fun uu____6190  ->
                     match uu____6190 with
                     | (a,q) -> let uu____6197 = ff a  in (uu____6197, q))
                  args
                 in
              (uu____6181, uu____6182)  in
            FStar_Syntax_Syntax.Tm_app uu____6171
        | FStar_Syntax_Syntax.Tm_abs (bs,t1,k) ->
            let uu____6226 = FStar_Syntax_Subst.open_term bs t1  in
            (match uu____6226 with
             | (bs1,t') ->
                 let t'' = ff t'  in
                 let uu____6232 =
                   let uu____6247 = FStar_Syntax_Subst.close bs1 t''  in
                   (bs1, uu____6247, k)  in
                 FStar_Syntax_Syntax.Tm_abs uu____6232)
        | FStar_Syntax_Syntax.Tm_arrow (bs,k) -> tn
        | uu____6266 -> tn  in
      f
        (let uu___168_6267 = t  in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.tk = (uu___168_6267.FStar_Syntax_Syntax.tk);
           FStar_Syntax_Syntax.pos = (uu___168_6267.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___168_6267.FStar_Syntax_Syntax.vars)
         })
