      ...
      fun t2 ->
        ...
        | (FStar_Syntax_Syntax.Tm_quoted (qt1, qi1),
           FStar_Syntax_Syntax.Tm_quoted (qt2, qi2)) ->
            (let uu____15654 =
               let uu____15656 = eq_quoteinfo qi1 qi2 in uu____15656 = Equal in
            ...
            (fun acc ->
               fun uu____16509 ->
                 ...
                 | (bv, uu____16519) ->
                     ...
                     acc + uu____16524) (Prims.parse_int "0") bs in
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid ->
    fun t ->
      let uu____16602 =
        let uu____16603 = un_uinst t in uu____16603.FStar_Syntax_Syntax.n in
  ...
  fun p ->
    fun r ->
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____16674 = FStar_Options.restore_cmd_line_options false in
...
let rec (unbound_variables :
  ...
  fun tm ->
        ...
        let uu____16984 =
          FStar_List.collect
            (fun uu____16998 ->
               ...
               | (x, uu____17010) -> unbound_variables x) args in
            ...
            (FStar_List.collect
               (fun br ->
                  ...
                  | (p, wopt, t2) ->
                      ...
                      FStar_List.append uu____17100 uu____17103)) in
    ...
    | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), t1) ->
        ...
        let uu____17239 =
          let uu____17242 = unbound_variables lb.FStar_Syntax_Syntax.lbdef in
          let uu____17245 =
            ...
            | FStar_Util.Inl bv ->
                ...
                (match uu____17252 with
                 | (uu____17273, t2) -> unbound_variables t2) in
             ...
             let uu____17313 =
               FStar_List.collect
                 (fun lb ->
                    ...
                    FStar_List.append uu____17320 uu____17323) lbs1 in
...
and (unbound_variables_comp :
  ...
  fun c ->
    ...
    | FStar_Syntax_Syntax.Comp ct ->
        let uu____17474 = unbound_variables ct.FStar_Syntax_Syntax.result_typ in
        let uu____17477 =
          FStar_List.collect
            (fun uu____17491 ->
...
let rec (list_elements :
  ...
  =
  fun e ->
    let uu____17983 = let uu____18000 = unmeta e in head_and_args uu____18000 in
    ...
    | (head1, args) ->
        ...
        (match uu____18031 with
         | (FStar_Syntax_Syntax.Tm_fvar fv, uu____18065) when
             ...
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            uu____18089::(hd1, uu____18091)::(tl1, uu____18093)::[]) when
    ...
    | FStar_Syntax_Syntax.Tm_abs (b::[], e, uu____18212) ->
        ...
        (match uu____18247 with
         | (bs, e1) ->
             ...
             let uu____18281 = is_free_in (FStar_Pervasives_Native.fst b1) e1 in
             if uu____18281
             then
               let uu____18288 =
      ...
      let one_pat p =
        ...
        | (head1, args) ->
            ...
            (match uu____18492 with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                (uu____18530, uu____18531)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.smtpat_lid
                 -> arg
             | uu____18583 -> failwith "Unexpected pattern term") in
      let lemma_pats p =
        ...
        let smt_pat_or1 t1 =
          ...
          | (head1, args) ->
              ...
              (match uu____18702 with
               ...
               | uu____18774 -> FStar_Pervasives_Native.None) in
        match elts with
        | t1::[] ->
                 ...
                 (match c1.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Comp
                      { FStar_Syntax_Syntax.comp_univs = uu____19151;
                        ...
                        FStar_Syntax_Syntax.effect_args =
                          (pre, uu____19155)::(post, uu____19157)::(pats,
                                                                    uu____19159)::[];
