...
let is_tuple_data_lid' : FStar_Ident.lident  ->  Prims.bool = (fun f -> (FStar_Util.starts_with (FStar_Ident.text_of_lid f) "Mktuple"))
...
let is_dtuple_constructor_lid : FStar_Ident.lident  ->  Prims.bool = (fun lid -> (FStar_Util.starts_with (FStar_Ident.text_of_lid lid) "Prims.dtuple"))
...
| FStar_Syntax_Syntax.Tm_fvar (_39_1219) -> begin
(is_constructor t lid)
end
| FStar_Syntax_Syntax.Tm_app (t, _39_1223) -> begin
...
| FStar_Syntax_Syntax.Tm_app (t, _39_1241) -> begin
(get_tycon t)
end
| _39_1245 -> begin
None
...
let type_u : Prims.unit  ->  (FStar_Syntax_Syntax.typ * FStar_Syntax_Syntax.universe) = (fun _39_1248 -> (match (()) with
| () -> begin
(
...
let _39_1309 = (match (c0.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (_39_1300) -> begin
((FStar_Syntax_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[]))
end
| FStar_Syntax_Syntax.GTotal (_39_1303) -> begin
...
in (match (_39_1309) with
| (eff_name, flags) -> begin
{FStar_Syntax_Syntax.eff_name = eff_name; FStar_Syntax_Syntax.res_typ = (comp_result c0); FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = (fun _39_1310 -> (match (()) with
| () -> begin
c0
end))}
end)))
...
| FStar_Syntax_Syntax.Pat_wild (_39_1319) -> begin
true
end
| _39_1322 -> begin
false
...
let rec aux = (fun f _39_1361 -> (match (_39_1361) with
| (lid, arity) -> begin
(

let _39_1364 = (let _137_557 = (unmeta_monadic f)
in (head_and_args _137_557))
in (match (_39_1364) with
| (t, args) -> begin
(
...
let _39_1385 = (head_and_args t)
in (match (_39_1385) with
| (t, args) -> begin
(let _137_573 = (un_uinst t)
in (let _137_572 = (FStar_All.pipe_right args (FStar_List.map (fun _39_1388 -> (match (_39_1388) with
| (t, imp) -> begin
...
| (Some (b), _39_1515) -> begin
(

let bs = (FStar_List.rev out)
in (

let _39_1520 = (FStar_Syntax_Subst.open_term bs t)
in (match (_39_1520) with
| (bs, t) -> begin
(

let _39_1523 = (patterns t)
in (match (_39_1523) with
| (pats, body) -> begin
if b then begin
...
let lb = (let _137_584 = (let _137_583 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.Delta_equational None)
in FStar_Util.Inr (_137_583))
in (close_univs_and_mk_letbinding None _137_584 a.FStar_Syntax_Syntax.action_univs a.FStar_Syntax_Syntax.action_typ FStar_Syntax_Const.effect_Tot_lid a.FStar_Syntax_Syntax.action_defn))
...
in (let _137_589 = (let _137_588 = (let _137_587 = (let _137_586 = (FStar_Syntax_Syntax.as_arg t)
in (_137_586)::[])
in ((reify_), (_137_587)))
in FStar_Syntax_Syntax.Tm_app (_137_588))
in (FStar_Syntax_Syntax.mk _137_589 None t.FStar_Syntax_Syntax.pos))))
...
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (_39_1537) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
let is_unknown : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _137_601 = (FStar_Syntax_Subst.compress t)
in _137_601.FStar_Syntax_Syntax.n)) with
...
let _39_1618 = (let _137_604 = (unmeta e)
in (head_and_args _137_604))
in (match (_39_1618) with
| (head, args) -> begin
(match ((let _137_606 = (let _137_605 = (un_uinst head)
in _137_605.FStar_Syntax_Syntax.n)
in ((_137_606), (args)))) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), _39_1622) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.nil_lid) -> begin
Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_39_1635)::((hd, _39_1632))::((tl, _39_1628))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.cons_lid) -> begin
(let _137_609 = (let _137_608 = (let _137_607 = (list_elements tl)
in (FStar_Util.must _137_607))
in (hd)::_137_608)
in Some (_137_609))
end
| _39_1639 -> begin
