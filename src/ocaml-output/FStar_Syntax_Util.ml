      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____8935 ->
            ...
            (match uu____8950 with
             | (hd1,args) ->
                 let uu___174_8983 = t in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___174_8983.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___174_8983.FStar_Syntax_Syntax.vars)
                 })
        | uu____8994 -> t in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____9678 -> tn in
      f
        (let uu___175_9681 = t in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___175_9681.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___175_9681.FStar_Syntax_Syntax.vars)
         })
