...
| (FStar_Syntax_Syntax.Sig_inductive_typ (lid, _, _, _, _, _, _, _)) | (FStar_Syntax_Syntax.Sig_effect_abbrev (lid, _, _, _, _, _, _)) | (FStar_Syntax_Syntax.Sig_datacon (lid, _, _, _, _, _, _, _)) | (FStar_Syntax_Syntax.Sig_declare_typ (lid, _, _, _, _)) -> begin
(lid)::[]
end
...
| (FStar_Util.Inl (x), _39_924, _39_926) -> begin
(FStar_Syntax_Syntax.range_of_bv x)
end
| (FStar_Util.Inr (l), _39_931, _39_933) -> begin
(FStar_Ident.range_of_lid l)
end))


let range_of_arg = (fun _39_938 -> (match (_39_938) with
| (hd, _39_937) -> begin
...
let _39_966 = x
in {FStar_Syntax_Syntax.ppname = nm; FStar_Syntax_Syntax.index = _39_966.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _39_966.FStar_Syntax_Syntax.sort})
in (let _136_221 = (mk_field_projector_name_from_ident lid nm)
in ((_136_221), (y))))))


let set_uvar = (fun uv t -> (match ((FStar_Unionfind.find uv)) with
| FStar_Syntax_Syntax.Fixed (_39_972) -> begin
...
(match (c.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (tres, _39_1052) -> begin
...
let _39_1076 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_39_1076) with
| (bs, c) -> begin
if (is_tot_or_gtot_comp c) then begin
(

let _39_1079 = (arrow_formals_comp (comp_result c))
in (match (_39_1079) with
| (bs', k) -> begin
...
let _39_1085 = (arrow_formals_comp k)
...
let _39_1098 = (aux t what)
in (match (_39_1098) with
| (bs', t, what) -> begin
...
let _39_1104 = (aux t None)
in (match (_39_1104) with
| (bs, t, what) -> begin
(

let _39_1107 = (FStar_Syntax_Subst.open_term bs t)
in (match (_39_1107) with
| (bs, t) -> begin
((bs), (t), (what))
end))
end))))
...
let _39_1144 = (FStar_Syntax_Subst.open_univ_vars_comp uvs c)
...
let _39_1150 = (FStar_Syntax_Subst.open_univ_vars uvs t')
in (match (_39_1150) with
| (uvs, t') -> begin
...
| FStar_Syntax_Syntax.Tm_fvar (_39_1197) -> begin
(is_constructor t lid)
end
| FStar_Syntax_Syntax.Tm_app (t, _39_1201) -> begin
...
let type_u : Prims.unit  ->  (FStar_Syntax_Syntax.typ * FStar_Syntax_Syntax.universe) = (fun _39_1226 -> (match (()) with
| () -> begin
(
...
let _39_1287 = (match (c0.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (_39_1278) -> begin
((FStar_Syntax_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[]))
end
| FStar_Syntax_Syntax.GTotal (_39_1281) -> begin
...
in (match (_39_1287) with
| (eff_name, flags) -> begin
{FStar_Syntax_Syntax.eff_name = eff_name; FStar_Syntax_Syntax.res_typ = (comp_result c0); FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = (fun _39_1288 -> (match (()) with
| () -> begin
c0
end))}
end)))
...
| FStar_Syntax_Syntax.Pat_wild (_39_1297) -> begin
true
end
| _39_1300 -> begin
false
...
let rec aux = (fun f _39_1339 -> (match (_39_1339) with
| (lid, arity) -> begin
(

let _39_1342 = (let _136_549 = (unmeta_monadic f)
in (head_and_args _136_549))
in (match (_39_1342) with
| (t, args) -> begin
(
...
let _39_1363 = (head_and_args t)
in (match (_39_1363) with
| (t, args) -> begin
(let _136_565 = (un_uinst t)
in (let _136_564 = (FStar_All.pipe_right args (FStar_List.map (fun _39_1366 -> (match (_39_1366) with
| (t, imp) -> begin
...
| (Some (b), _39_1493) -> begin
(

let bs = (FStar_List.rev out)
in (

let _39_1498 = (FStar_Syntax_Subst.open_term bs t)
in (match (_39_1498) with
| (bs, t) -> begin
(

let _39_1501 = (patterns t)
...
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (_39_1515) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
let _39_1596 = (let _136_596 = (unmeta e)
in (head_and_args _136_596))
in (match (_39_1596) with
| (head, args) -> begin
(match ((let _136_598 = (let _136_597 = (un_uinst head)
in _136_597.FStar_Syntax_Syntax.n)
in ((_136_598), (args)))) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), _39_1600) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.nil_lid) -> begin
Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_39_1613)::((hd, _39_1610))::((tl, _39_1606))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.cons_lid) -> begin
...
let mk_assume : FStar_Ident.lident  ->  FStar_Syntax_Syntax.typ  ->  FStar_Range.range  ->  FStar_Syntax_Syntax.sigelt = (fun lid formula range -> (let _136_615 = (let _136_614 = (let _136_611 = (let _136_610 = (let _136_609 = (let _136_608 = (FStar_Syntax_Syntax.lid_as_fv lid (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) None)
in FStar_Util.Inr (_136_608))
in {FStar_Syntax_Syntax.lbname = _136_609; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = formula; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = FStar_Syntax_Syntax.tun})
in (_136_610)::[])
in ((false), (_136_611)))
in (let _136_613 = (let _136_612 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string ((((FStar_Util.unicode_of_string "axiom")), (range))))) None range)
in (_136_612)::[])
in ((_136_614), (range), ((lid)::[]), ((FStar_Syntax_Syntax.Assumption)::[]), (_136_613))))
in FStar_Syntax_Syntax.Sig_let (_136_615)))
