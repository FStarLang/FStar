  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_iff uu___173_1236 =
        match uu___173_1236 with | true  -> Equal | uu____1237 -> NotEqual
         in
    ...
    let uu____3777 =
      let uu____3778 =
        let uu____3788 =
          ...
          let uu____3791 =
            let uu____3793 = FStar_Syntax_Syntax.as_arg e2  in [uu____3793]
             in
      ...
      let uu____3835 =
        let uu____3845 =
          ...
          let uu____3848 =
            ...
            let uu____3851 =
              let uu____3853 = FStar_Syntax_Syntax.as_arg t'  in [uu____3853]
               in
      ...
      FStar_List.fold_right
        (fun b  ->
           fun f  ->
             ...
             | true  -> f
             | uu____3979 -> mk_forall (Prims.fst b) f) bs f
  ...
  fun f  ->
    ...
    let destruct_base_conn f =
      ...
      let rec aux f uu____4271 =
        ...
        | (lid,arity) ->
            let uu____4277 =
              let uu____4287 = unmeta_monadic f  in head_and_args uu____4287
               in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta (t,FStar_Syntax_Syntax.Meta_pattern pats)
          ...
          (pats, uu____4357)
      | uu____4364 ->
          let uu____4365 = FStar_Syntax_Subst.compress t  in ([], uu____4365)
       in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____4455  ->
                      ...
                      | (t,imp) ->
                          let uu____4462 = unascribe t  in (uu____4462, imp)))
               in
            (uu____4438, uu____4439)
         in
                 ...
                 (match uu____4777 with
                  | (pats,body) ->
                      (match b with
                       ...
                       | uu____4808 -> Some (QEx (bs, pats, body)))))
        | uu____4815 -> None  in
      aux None [] t  in
...
let rec list_elements :
  ...
  =
  fun e  ->
    let uu____5020 = let uu____5030 = unmeta e  in head_and_args uu____5030
       in
