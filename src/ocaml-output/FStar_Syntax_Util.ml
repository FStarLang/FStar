...
let uu___176_642 = (comp_to_comp_typ c)
in {FStar_Syntax_Syntax.comp_univs = uu___176_642.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___176_642.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu___176_642.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___176_642.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = f})
in FStar_Syntax_Syntax.Comp (uu____641))
in {FStar_Syntax_Syntax.n = uu____640; FStar_Syntax_Syntax.tk = uu___175_639.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___175_639.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___175_639.FStar_Syntax_Syntax.vars}))))
...
let is_total_comp = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___163_704 -> (match (uu___163_704) with
...
let is_total_lcomp : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun c -> ((FStar_Ident.lid_equals c.FStar_Syntax_Syntax.eff_name FStar_Syntax_Const.effect_Tot_lid) || (FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___164_710 -> (match (uu___164_710) with
| (FStar_Syntax_Syntax.TOTAL) | (FStar_Syntax_Syntax.RETURN) -> begin
true
end
| uu____711 -> begin
...
let is_partial_return = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___166_730 -> (match (uu___166_730) with
...
let is_lcomp_partial_return : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun c -> (FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___167_736 -> (match (uu___167_736) with
| (FStar_Syntax_Syntax.RETURN) | (FStar_Syntax_Syntax.PARTIAL_RETURN) -> begin
true
end
| uu____737 -> begin
...
| FStar_Syntax_Syntax.Comp (ct) -> begin
(((is_total_comp c) || (is_pure_effect ct.FStar_Syntax_Syntax.effect_name)) || (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___168_777 -> (match (uu___168_777) with
...
let is_pure_lcomp : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun lc -> (((is_total_lcomp lc) || (is_pure_effect lc.FStar_Syntax_Syntax.eff_name)) || (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___169_797 -> (match (uu___169_797) with
| FStar_Syntax_Syntax.LEMMA -> begin
true
end
| uu____798 -> begin
...
| FStar_Syntax_Syntax.Comp (c1) -> begin
((FStar_Ident.lid_equals c1.FStar_Syntax_Syntax.effect_name FStar_Syntax_Const.effect_ML_lid) || (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___170_1018 -> (match (uu___170_1018) with
...
let uu___177_1077 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___177_1077.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___177_1077.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = t; FStar_Syntax_Syntax.effect_args = uu___177_1077.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___177_1077.FStar_Syntax_Syntax.flags}))
end))


let is_trivial_wp = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___171_1090 -> (match (uu___171_1090) with
| (FStar_Syntax_Syntax.TOTAL) | (FStar_Syntax_Syntax.RETURN) -> begin
true
end
| uu____1091 -> begin
...
let equal_if = (fun uu___172_1271 -> (match (uu___172_1271) with
| true -> begin
Equal
end
| uu____1272 -> begin
...
let equal_iff = (fun uu___173_1276 -> (match (uu___173_1276) with
| true -> begin
Equal
end
| uu____1277 -> begin
...
let range_of_lb = (fun uu___174_1908 -> (match (uu___174_1908) with
...
let uu___178_2145 = x
in {FStar_Syntax_Syntax.ppname = nm; FStar_Syntax_Syntax.index = uu___178_2145.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___178_2145.FStar_Syntax_Syntax.sort})
in (
...
let uu___179_2801 = l1
in (

let uu____2802 = (FStar_Syntax_Subst.subst s l1.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = uu___179_2801.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____2802; FStar_Syntax_Syntax.cflags = uu___179_2801.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____2805 -> (
...
let uu____5221 = (apply_last f xs)
in (x)::uu____5221)
end))
