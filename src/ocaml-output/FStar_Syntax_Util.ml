...
let qual_id : FStar_Ident.lident  ->  FStar_Ident.ident  ->  FStar_Ident.lident = (fun lid id -> (let _139_5 = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns ((lid.FStar_Ident.ident)::(id)::[])))
in (FStar_Ident.set_lid_range _139_5 id.FStar_Ident.idRange)))
...
| (b, imp) -> begin
(let _139_11 = (FStar_Syntax_Syntax.bv_to_name b)
in ((_139_11), (imp)))
end))
...
(let _139_15 = (arg_of_non_null_binder b)
in (_139_15)::[])
end))))


let args_of_binders : FStar_Syntax_Syntax.binders  ->  ((FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.arg_qualifier Prims.option) Prims.list * (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier Prims.option) Prims.list) = (fun binders -> (let _139_22 = (FStar_All.pipe_right binders (FStar_List.map (fun b -> if (FStar_Syntax_Syntax.is_null_binder b) then begin
(

let b = (let _139_19 = (FStar_Syntax_Syntax.new_bv None (Prims.fst b).FStar_Syntax_Syntax.sort)
in ((_139_19), ((Prims.snd b))))
in (let _139_20 = (arg_of_non_null_binder b)
in ((b), (_139_20))))
end else begin
(let _139_21 = (arg_of_non_null_binder b)
in ((b), (_139_21)))
end)))
in (FStar_All.pipe_right _139_22 FStar_List.unzip)))
...
let b = (let _139_28 = (let _139_27 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _139_27))
in (FStar_Ident.id_of_text _139_28))
in (
...
(let _139_32 = (let _139_31 = (let _139_30 = (name_binders binders)
in ((_139_30), (comp)))
in FStar_Syntax_Syntax.Tm_arrow (_139_31))
in (FStar_Syntax_Syntax.mk _139_32 None t.FStar_Syntax_Syntax.pos))
end
| _39_38 -> begin
t
end))
...
| (t, imp) -> begin
(let _139_37 = (let _139_36 = (FStar_Syntax_Syntax.null_binder t)
in (FStar_All.pipe_left Prims.fst _139_36))
in ((_139_37), (imp)))
end)))))
...
| (t, imp) -> begin
(let _139_41 = (FStar_Syntax_Syntax.new_bv (Some (t.FStar_Syntax_Syntax.pos)) t)
in ((_139_41), (imp)))
end)))))


let binders_of_freevars : FStar_Syntax_Syntax.bv FStar_Util.set  ->  FStar_Syntax_Syntax.binder Prims.list = (fun fvs -> (let _139_44 = (FStar_Util.set_elements fvs)
in (FStar_All.pipe_right _139_44 (FStar_List.map FStar_Syntax_Syntax.mk_binder))))
...
(let _139_60 = (let _139_59 = (FStar_Syntax_Syntax.bv_to_name y)
in ((x), (_139_59)))
in FStar_Syntax_Syntax.NT (_139_60))
...
let constant_univ_as_nat : FStar_Syntax_Syntax.universe  ->  Prims.int = (fun u -> (let _139_67 = (univ_kernel u)
in (Prims.snd _139_67)))
...
let copt = (let _139_73 = (FStar_List.zip us1 us2)
in (FStar_Util.find_map _139_73 (fun _39_169 -> (match (_39_169) with
| (u1, u2) -> begin
(
...
(let _139_92 = (let _139_91 = (FStar_Util.map_opt u_opt (fun x -> (x)::[]))
in (FStar_Util.dflt [] _139_91))
in {FStar_Syntax_Syntax.comp_univs = _139_92; FStar_Syntax_Syntax.effect_name = (comp_effect_name c); FStar_Syntax_Syntax.result_typ = t; FStar_Syntax_Syntax.effect_args = []; FStar_Syntax_Syntax.flags = (comp_flags c)})
end))
in (

let _39_231 = c
in (let _139_94 = (let _139_93 = (
...
in FStar_Syntax_Syntax.Comp (_139_93))
in {FStar_Syntax_Syntax.n = _139_94; FStar_Syntax_Syntax.tk = _39_231.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _39_231.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _39_231.FStar_Syntax_Syntax.vars}))))
...
let is_pure_or_ghost_function : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _139_126 = (FStar_Syntax_Subst.compress t)
in _139_126.FStar_Syntax_Syntax.n)) with
...
let is_lemma : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _139_129 = (FStar_Syntax_Subst.compress t)
in _139_129.FStar_Syntax_Syntax.n)) with
...
let is_smt_lemma : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _139_136 = (FStar_Syntax_Subst.compress t)
in _139_136.FStar_Syntax_Syntax.n)) with
...
| (head, _39_369) -> begin
(match ((let _139_137 = (un_uinst head)
in _139_137.FStar_Syntax_Syntax.n)) with
...
let rec is_unit : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _139_156 = (unrefine t)
in _139_156.FStar_Syntax_Syntax.n)) with
...
let rec non_informative : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _139_159 = (unrefine t)
in _139_159.FStar_Syntax_Syntax.n)) with
...
let is_fun : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun e -> (match ((let _139_162 = (FStar_Syntax_Subst.compress e)
in _139_162.FStar_Syntax_Syntax.n)) with
...
let is_function_typ : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _139_165 = (FStar_Syntax_Subst.compress t)
in _139_165.FStar_Syntax_Syntax.n)) with
...
in (match ((let _139_172 = (un_uinst typ)
in _139_172.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_app (head, args) -> begin
(
...
| [] -> begin
(let _139_193 = (let _139_192 = (let _139_191 = (FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in ((_139_191), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Data_app))))
in FStar_Syntax_Syntax.Tm_meta (_139_192))
in (FStar_Syntax_Syntax.mk _139_193 None (FStar_Ident.range_of_lid l)))
end
| _39_974 -> begin
(

let e = (let _139_194 = (FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in (mk_app _139_194 args))
...
(let _139_200 = (let _139_199 = (FStar_Util.substring_from x.FStar_Ident.idText (Prims.parse_int "7"))
in ((_139_199), (x.FStar_Ident.idRange)))
in (FStar_Ident.mk_ident _139_200))
end else begin
x
end)
...
(let _139_220 = (let _139_219 = (let _139_217 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _139_217))
in (let _139_218 = (FStar_Syntax_Syntax.range_of_bv x)
in ((_139_219), (_139_218))))
in (FStar_Ident.mk_ident _139_220))
end else begin
...
in (let _139_221 = (mk_field_projector_name_from_ident lid nm)
in ((_139_221), (y))))))


let set_uvar = (fun uv t -> (match ((FStar_Unionfind.find uv)) with
| FStar_Syntax_Syntax.Fixed (_39_996) -> begin
(let _139_226 = (let _139_225 = (let _139_224 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _139_224))
in (FStar_Util.format1 "Changing a fixed uvar! ?%s\n" _139_225))
in (failwith _139_226))
end
| _39_999 -> begin
...
(let _139_244 = (let _139_243 = (FStar_Syntax_Subst.close_lcomp bs lc)
in FStar_Util.Inl (_139_243))
in Some (_139_244))
end))
in (match (bs) with
| [] -> begin
...
let body = (let _139_245 = (FStar_Syntax_Subst.close bs t)
in (FStar_Syntax_Subst.compress _139_245))
in (match (((body.FStar_Syntax_Syntax.n), (lopt))) with
| (FStar_Syntax_Syntax.Tm_abs (bs', t, lopt'), None) -> begin
(let _139_250 = (let _139_249 = (let _139_248 = (let _139_246 = (FStar_Syntax_Subst.close_binders bs)
in (FStar_List.append _139_246 bs'))
in (let _139_247 = (close_lopt lopt')
in ((_139_248), (t), (_139_247))))
in FStar_Syntax_Syntax.Tm_abs (_139_249))
in (FStar_Syntax_Syntax.mk _139_250 None t.FStar_Syntax_Syntax.pos))
end
| _39_1061 -> begin
(let _139_254 = (let _139_253 = (let _139_252 = (FStar_Syntax_Subst.close_binders bs)
in (let _139_251 = (close_lopt lopt)
in ((_139_252), (body), (_139_251))))
in FStar_Syntax_Syntax.Tm_abs (_139_253))
in (FStar_Syntax_Syntax.mk _139_254 None t.FStar_Syntax_Syntax.pos))
end))
end))
end)
...
| _39_1066 -> begin
(let _139_262 = (let _139_261 = (let _139_260 = (FStar_Syntax_Subst.close_binders bs)
in (let _139_259 = (FStar_Syntax_Subst.close_comp bs c)
in ((_139_260), (_139_259))))
in FStar_Syntax_Syntax.Tm_arrow (_139_261))
in (FStar_Syntax_Syntax.mk _139_262 None c.FStar_Syntax_Syntax.pos))
end))
...
let t = (arrow bs c)
in (match ((let _139_267 = (FStar_Syntax_Subst.compress t)
in _139_267.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(match (c.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (tres, _39_1076) -> begin
(match ((let _139_268 = (FStar_Syntax_Subst.compress tres)
in _139_268.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs', c') -> begin
(let _139_269 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((((FStar_List.append bs bs')), (c')))) _139_269 t.FStar_Syntax_Syntax.pos))
end
| _39_1084 -> begin
t
end)
...
let refine : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun b t -> (let _139_281 = (let _139_277 = (let _139_276 = (let _139_275 = (let _139_274 = (FStar_Syntax_Syntax.mk_binder b)
in (_139_274)::[])
in (FStar_Syntax_Subst.close _139_275 t))
in ((b), (_139_276)))
in FStar_Syntax_Syntax.Tm_refine (_139_277))
in (let _139_280 = (FStar_ST.read b.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.tk)
in (let _139_279 = (let _139_278 = (FStar_Syntax_Syntax.range_of_bv b)
in (FStar_Range.union_ranges _139_278 t.FStar_Syntax_Syntax.pos))
in (FStar_Syntax_Syntax.mk _139_281 _139_280 _139_279)))))
...
| _39_1105 -> begin
(let _139_286 = (FStar_Syntax_Syntax.mk_Total k)
in (([]), (_139_286)))
end)))
...
let rec aux = (fun t what -> (match ((let _139_296 = (let _139_295 = (FStar_Syntax_Subst.compress t)
in (FStar_All.pipe_left unascribe _139_295))
in _139_296.FStar_Syntax_Syntax.n)) with
...
let universes = (FStar_All.pipe_right univ_vars (FStar_List.map (fun _139_319 -> FStar_Syntax_Syntax.U_name (_139_319))))
in (
...
| (uvs, t') -> begin
(match ((let _139_327 = (FStar_Syntax_Subst.compress t')
in _139_327.FStar_Syntax_Syntax.n)) with
...
let t = (let _139_334 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "tuple%s" _139_334))
in (let _139_335 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _139_335 r))))


let mk_tuple_data_lid : Prims.int  ->  FStar_Range.range  ->  FStar_Ident.lident = (fun n r -> (

let t = (let _139_340 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Mktuple%s" _139_340))
in (let _139_341 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _139_341 r))))


let is_tuple_data_lid : FStar_Ident.lident  ->  Prims.int  ->  Prims.bool = (fun f n -> (let _139_346 = (mk_tuple_data_lid n FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f _139_346)))
...
let t = (let _139_353 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "dtuple%s" _139_353))
in (let _139_354 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _139_354 r))))


let mk_dtuple_data_lid : Prims.int  ->  FStar_Range.range  ->  FStar_Ident.lident = (fun n r -> (

let t = (let _139_359 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Mkdtuple%s" _139_359))
in (let _139_360 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _139_360 r))))
...
let is_constructor : FStar_Syntax_Syntax.term  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _139_376 = (pre_typ t)
in _139_376.FStar_Syntax_Syntax.n)) with
...
let rec is_constructed_typ : FStar_Syntax_Syntax.term  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _139_381 = (pre_typ t)
in _139_381.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (_39_1221) -> begin
(is_constructor t lid)
end
| FStar_Syntax_Syntax.Tm_app (t, _39_1225) -> begin
...
| FStar_Syntax_Syntax.Tm_app (t, _39_1243) -> begin
(get_tycon t)
end
| _39_1247 -> begin
None
...
let type_u : Prims.unit  ->  (FStar_Syntax_Syntax.typ * FStar_Syntax_Syntax.universe) = (fun _39_1250 -> (match (()) with
| () -> begin
(

let u = (let _139_389 = (FStar_Unionfind.fresh None)
in (FStar_All.pipe_left (fun _139_388 -> FStar_Syntax_Syntax.U_unif (_139_388)) _139_389))
in (let _139_390 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (u)) None FStar_Range.dummyRange)
in ((_139_390), (u))))
end))
...
| Some (phi1) -> begin
(let _139_404 = (let _139_403 = (let _139_401 = (let _139_400 = (let _139_399 = (FStar_Syntax_Syntax.as_arg phi1)
in (let _139_398 = (let _139_397 = (FStar_Syntax_Syntax.as_arg phi2)
in (_139_397)::[])
in (_139_399)::_139_398))
in ((tand), (_139_400)))
in FStar_Syntax_Syntax.Tm_app (_139_401))
in (let _139_402 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _139_403 None _139_402)))
in Some (_139_404))
end))


let mk_binop = (fun op_t phi1 phi2 -> (let _139_414 = (let _139_412 = (let _139_411 = (let _139_410 = (FStar_Syntax_Syntax.as_arg phi1)
in (let _139_409 = (let _139_408 = (FStar_Syntax_Syntax.as_arg phi2)
in (_139_408)::[])
in (_139_410)::_139_409))
in ((op_t), (_139_411)))
in FStar_Syntax_Syntax.Tm_app (_139_412))
in (let _139_413 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _139_414 None _139_413))))


let mk_neg = (fun phi -> (let _139_419 = (let _139_418 = (let _139_417 = (let _139_416 = (FStar_Syntax_Syntax.as_arg phi)
in (_139_416)::[])
in ((t_not), (_139_417)))
in FStar_Syntax_Syntax.Tm_app (_139_418))
in (FStar_Syntax_Syntax.mk _139_419 None phi.FStar_Syntax_Syntax.pos)))
...
let mk_imp : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun phi1 phi2 -> (match ((let _139_432 = (FStar_Syntax_Subst.compress phi1)
in _139_432.FStar_Syntax_Syntax.n)) with
...
| _39_1283 -> begin
(match ((let _139_433 = (FStar_Syntax_Subst.compress phi2)
in _139_433.FStar_Syntax_Syntax.n)) with
...
let b2t = (fun e -> (let _139_440 = (let _139_439 = (let _139_438 = (let _139_437 = (FStar_Syntax_Syntax.as_arg e)
in (_139_437)::[])
in ((b2t_v), (_139_438)))
in FStar_Syntax_Syntax.Tm_app (_139_439))
in (FStar_Syntax_Syntax.mk _139_440 None e.FStar_Syntax_Syntax.pos)))


let teq : FStar_Syntax_Syntax.term = (fvar_const FStar_Syntax_Const.eq2_lid)


let mk_eq = (fun t1 t2 e1 e2 -> (let _139_451 = (let _139_449 = (let _139_448 = (let _139_447 = (FStar_Syntax_Syntax.as_arg e1)
in (let _139_446 = (let _139_445 = (FStar_Syntax_Syntax.as_arg e2)
in (_139_445)::[])
in (_139_447)::_139_446))
in ((teq), (_139_448)))
in FStar_Syntax_Syntax.Tm_app (_139_449))
in (let _139_450 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _139_451 None _139_450))))
...
in (let _139_462 = (let _139_461 = (let _139_460 = (let _139_459 = (FStar_Syntax_Syntax.iarg t)
in (let _139_458 = (let _139_457 = (FStar_Syntax_Syntax.as_arg x)
in (let _139_456 = (let _139_455 = (FStar_Syntax_Syntax.as_arg t')
in (_139_455)::[])
in (_139_457)::_139_456))
in (_139_459)::_139_458))
in ((t_has_type), (_139_460)))
in FStar_Syntax_Syntax.Tm_app (_139_461))
in (FStar_Syntax_Syntax.mk _139_462 None FStar_Range.dummyRange)))))
...
let _39_1311 = (match (c0.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (_39_1302) -> begin
((FStar_Syntax_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[]))
end
| FStar_Syntax_Syntax.GTotal (_39_1305) -> begin
...
in (match (_39_1311) with
| (eff_name, flags) -> begin
{FStar_Syntax_Syntax.eff_name = eff_name; FStar_Syntax_Syntax.res_typ = (comp_result c0); FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = (fun _39_1312 -> (match (()) with
| () -> begin
c0
end))}
end)))
...
let mk_forall : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun x body -> (let _139_482 = (let _139_481 = (let _139_480 = (let _139_479 = (FStar_Syntax_Syntax.iarg x.FStar_Syntax_Syntax.sort)
in (let _139_478 = (let _139_477 = (let _139_476 = (let _139_475 = (let _139_470 = (FStar_Syntax_Syntax.mk_binder x)
in (_139_470)::[])
in (let _139_474 = (let _139_473 = (let _139_472 = (let _139_471 = (FStar_Syntax_Syntax.mk_Total ktype0)
in (FStar_All.pipe_left lcomp_of_comp _139_471))
in FStar_Util.Inl (_139_472))
in Some (_139_473))
in (abs _139_475 body _139_474)))
in (FStar_Syntax_Syntax.as_arg _139_476))
in (_139_477)::[])
in (_139_479)::_139_478))
in ((tforall), (_139_480)))
in FStar_Syntax_Syntax.Tm_app (_139_481))
in (FStar_Syntax_Syntax.mk _139_482 None FStar_Range.dummyRange)))
...
| FStar_Syntax_Syntax.Pat_wild (_39_1321) -> begin
true
end
| _39_1324 -> begin
false
...
let then_branch = (let _139_493 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t1.FStar_Syntax_Syntax.pos)
in ((_139_493), (None), (t1)))
in (

let else_branch = (let _139_494 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (false))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Syntax_Syntax.pos)
in ((_139_494), (None), (t2)))
in (let _139_496 = (let _139_495 = (FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos t2.FStar_Syntax_Syntax.pos)
in (FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos _139_495))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (((b), ((then_branch)::(else_branch)::[])))) None _139_496)))))
...
let rec aux = (fun f _39_1363 -> (match (_39_1363) with
| (lid, arity) -> begin
(

let _39_1366 = (let _139_549 = (unmeta_monadic f)
in (head_and_args _139_549))
...
(let _139_552 = (FStar_Syntax_Subst.compress t)
in ((pats), (_139_552)))
end
| _39_1377 -> begin
(let _139_553 = (FStar_Syntax_Subst.compress t)
in (([]), (_139_553)))
end)))
in (
...
let _39_1387 = (head_and_args t)
in (match (_39_1387) with
| (t, args) -> begin
(let _139_565 = (un_uinst t)
in (let _139_564 = (FStar_All.pipe_right args (FStar_List.map (fun _39_1390 -> (match (_39_1390) with
| (t, imp) -> begin
(let _139_563 = (unascribe t)
in ((_139_563), (imp)))
end))))
in ((_139_565), (_139_564))))
end)))
in (

let rec aux = (fun qopt out t -> (match ((let _139_572 = (flat t)
in ((qopt), (_139_572)))) with
...
| (Some (b), _39_1517) -> begin
(

let bs = (FStar_List.rev out)
in (

let _39_1522 = (FStar_Syntax_Subst.open_term bs t)
in (match (_39_1522) with
| (bs, t) -> begin
(

let _39_1525 = (patterns t)
...
let lb = (let _139_578 = (let _139_577 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.Delta_equational None)
in FStar_Util.Inr (_139_577))
in (close_univs_and_mk_letbinding None _139_578 a.FStar_Syntax_Syntax.action_univs a.FStar_Syntax_Syntax.action_typ FStar_Syntax_Const.effect_Tot_lid a.FStar_Syntax_Syntax.action_defn))
...
in (let _139_583 = (let _139_582 = (let _139_581 = (let _139_580 = (FStar_Syntax_Syntax.as_arg t)
in (_139_580)::[])
in ((reify_), (_139_581)))
in FStar_Syntax_Syntax.Tm_app (_139_582))
in (FStar_Syntax_Syntax.mk _139_583 None t.FStar_Syntax_Syntax.pos))))
...
let is_unknown : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _139_595 = (FStar_Syntax_Subst.compress t)
in _139_595.FStar_Syntax_Syntax.n)) with
...
let _39_1621 = (let _139_598 = (unmeta e)
in (head_and_args _139_598))
in (match (_39_1621) with
| (head, args) -> begin
(match ((let _139_600 = (let _139_599 = (un_uinst head)
in _139_599.FStar_Syntax_Syntax.n)
in ((_139_600), (args)))) with
...
(let _139_603 = (let _139_602 = (let _139_601 = (list_elements tl)
in (FStar_Util.must _139_601))
in (hd)::_139_602)
in Some (_139_603))
end
| _39_1642 -> begin
