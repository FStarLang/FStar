...
let (comp_set_flags :
  ...
  fun c  ->
    fun f  ->
      let uu___95_1233 = c  in
      let uu____1234 =
        let uu____1235 =
          let uu___96_1236 = comp_to_comp_typ_nouniv c  in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___96_1236.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___96_1236.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___96_1236.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___96_1236.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          }  in
        FStar_Syntax_Syntax.Comp uu____1235  in
      {
        FStar_Syntax_Syntax.n = uu____1234;
        FStar_Syntax_Syntax.pos = (uu___95_1233.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___95_1233.FStar_Syntax_Syntax.vars)
      }
    ...
    fun fs  ->
      let comp_typ_set_flags c =
        ...
        | FStar_Syntax_Syntax.Comp ct ->
            let ct1 =
              let uu___97_1277 = ct  in
              {
                FStar_Syntax_Syntax.comp_univs =
                  (uu___97_1277.FStar_Syntax_Syntax.comp_univs);
                FStar_Syntax_Syntax.effect_name =
                  (uu___97_1277.FStar_Syntax_Syntax.effect_name);
                FStar_Syntax_Syntax.result_typ =
                  (uu___97_1277.FStar_Syntax_Syntax.result_typ);
                FStar_Syntax_Syntax.effect_args =
                  (uu___97_1277.FStar_Syntax_Syntax.effect_args);
                FStar_Syntax_Syntax.flags = fs
              }  in
            let uu___98_1278 = c  in
            {
              FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
              FStar_Syntax_Syntax.pos =
                (uu___98_1278.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___98_1278.FStar_Syntax_Syntax.vars)
            }
         in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___99_1990 = ct  in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___99_1990.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___99_1990.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___99_1990.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___99_1990.FStar_Syntax_Syntax.flags)
             })
...
let rec (eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___92_2494 = if uu___92_2494 then Equal else Unknown  in
      let equal_iff uu___93_2501 = if uu___93_2501 then Equal else NotEqual
         in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___100_4357 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___100_4357.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___100_4357.FStar_Syntax_Syntax.sort)
          }  in
              ...
              let uu____4519 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___101_4520.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____4521;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___101_4520.FStar_Syntax_Syntax.residual_flags)
                }  in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____5114 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___102_5115.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____5116;
              FStar_Syntax_Syntax.residual_flags =
                (uu___102_5115.FStar_Syntax_Syntax.residual_flags)
            }  in
    ...
    fun r  ->
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____12414 = FStar_Options.restore_cmd_line_options false
               in
            FStar_All.pipe_right uu____12414 (fun a237  -> ()));
           (match sopt with
            | FStar_Pervasives_Native.None  -> ()
