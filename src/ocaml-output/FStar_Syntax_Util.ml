            ...
            (fun acc ->
               fun uu____16512 ->
                 ...
                 | (bv, uu____16522) ->
                     ...
                     acc + uu____16527) Prims.int_zero bs in
  ...
  fun p ->
    fun r ->
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____16669 = FStar_Options.restore_cmd_line_options false in
...
let rec (unbound_variables :
  ...
  fun tm ->
        ...
        let uu____16979 =
          FStar_List.collect
            (fun uu____16993 ->
               ...
               | (x, uu____17005) -> unbound_variables x) args in
            ...
            (FStar_List.collect
               (fun br ->
                  ...
                  | (p, wopt, t2) ->
                      ...
                      FStar_List.append uu____17095 uu____17098)) in
    ...
    | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), t1) ->
        ...
        let uu____17234 =
          let uu____17237 = unbound_variables lb.FStar_Syntax_Syntax.lbdef in
          let uu____17240 =
            ...
            | FStar_Util.Inl bv ->
                ...
                (match uu____17247 with
                 | (uu____17268, t2) -> unbound_variables t2) in
             ...
             let uu____17308 =
               FStar_List.collect
                 (fun lb ->
                    ...
                    FStar_List.append uu____17315 uu____17318) lbs1 in
...
and (unbound_variables_comp :
  ...
  fun c ->
    ...
    | FStar_Syntax_Syntax.Comp ct ->
        let uu____17469 = unbound_variables ct.FStar_Syntax_Syntax.result_typ in
        let uu____17472 =
          FStar_List.collect
            (fun uu____17486 ->
...
let rec (list_elements :
  ...
  =
  fun e ->
    let uu____17978 = let uu____17995 = unmeta e in head_and_args uu____17995 in
    ...
    | (head1, args) ->
        ...
        (match uu____18026 with
         | (FStar_Syntax_Syntax.Tm_fvar fv, uu____18060) when
             ...
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            uu____18084::(hd1, uu____18086)::(tl1, uu____18088)::[]) when
    ...
    | FStar_Syntax_Syntax.Tm_abs (b::[], e, uu____18207) ->
        ...
        (match uu____18242 with
         | (bs, e1) ->
             ...
             let uu____18276 = is_free_in (FStar_Pervasives_Native.fst b1) e1 in
             if uu____18276
             then
               let uu____18283 =
      ...
      let one_pat p =
        ...
        | (head1, args) ->
            ...
            (match uu____18487 with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                (uu____18525, uu____18526)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.smtpat_lid
                 -> arg
             | uu____18578 -> failwith "Unexpected pattern term") in
      let lemma_pats p =
        ...
        let smt_pat_or1 t1 =
          ...
          | (head1, args) ->
              ...
              (match uu____18697 with
               ...
               | uu____18769 -> FStar_Pervasives_Native.None) in
        match elts with
        | t1::[] ->
                 ...
                 (match c1.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Comp
                      { FStar_Syntax_Syntax.comp_univs = uu____19146;
                        ...
                        FStar_Syntax_Syntax.effect_args =
                          (pre, uu____19150)::(post, uu____19152)::(pats,
                                                                    uu____19154)::[];
