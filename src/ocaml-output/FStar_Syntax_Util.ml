      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____8886 ->
            ...
            (match uu____8901 with
             | (hd1,args) ->
                 let uu___175_8934 = t in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___175_8934.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___175_8934.FStar_Syntax_Syntax.vars)
                 })
        | uu____8945 -> t in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____9629 -> tn in
      f
        (let uu___176_9632 = t in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___176_9632.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___176_9632.FStar_Syntax_Syntax.vars)
         })
