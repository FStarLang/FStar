...
let rec (maybe_equal_term :
  ...
  fun t1 ->
    fun t2 ->
      ...
      let rec maybe_equal_args args1 args2 =
        match (args1, args2) with
        | ([], []) -> true
        | ((a1, q1)::args11, (a2, q2)::args21) ->
            ((q1 = q2) && (maybe_equal_term a1 a2)) &&
              (maybe_equal_args args11 args21)
        | uu___ -> false in
      let maybe_equal_binders bs1 bs2 =
        if
      ...
      let rec maybe_equal_univs u1 u2 =
        ...
        | (FStar_Syntax_Syntax.U_bvar x, FStar_Syntax_Syntax.U_bvar y) ->
            x = y
        | (FStar_Syntax_Syntax.U_name x, FStar_Syntax_Syntax.U_name y) ->
            FStar_Ident.ident_equals x y
        | (FStar_Syntax_Syntax.U_succ u11, FStar_Syntax_Syntax.U_succ u21) ->
            maybe_equal_univs u11 u21
        | (FStar_Syntax_Syntax.U_max us1, FStar_Syntax_Syntax.U_max us2) ->
            ((FStar_Compiler_List.length us1) =
               (FStar_Compiler_List.length us2))
              && (FStar_Compiler_List.forall2 maybe_equal_univs us1 us2)
        | (FStar_Syntax_Syntax.U_unknown, FStar_Syntax_Syntax.U_unknown) ->
            true
        | (FStar_Syntax_Syntax.U_unif uu___, uu___1) -> true
        | (uu___, FStar_Syntax_Syntax.U_unif uu___1) -> true
        | uu___ -> false in
      let maybe_equal_comp c1 c2 =
        match ((c1.FStar_Syntax_Syntax.n), (c2.FStar_Syntax_Syntax.n)) with
        | (FStar_Syntax_Syntax.Total (t12, u1opt), FStar_Syntax_Syntax.Total
           (t22, u2opt)) -> maybe_equal_term t12 t22
        | (FStar_Syntax_Syntax.GTotal (t12, u1opt),
           FStar_Syntax_Syntax.GTotal (t22, u2opt)) ->
            maybe_equal_term t12 t22
        | (FStar_Syntax_Syntax.Comp ct1, FStar_Syntax_Syntax.Comp ct2) ->
            (((FStar_Ident.lid_equals ct1.FStar_Syntax_Syntax.effect_name
               ...
               &&
               (maybe_equal_term ct1.FStar_Syntax_Syntax.result_typ
                  ct2.FStar_Syntax_Syntax.result_typ))
              &&
              (maybe_equal_args ct1.FStar_Syntax_Syntax.effect_args
                 ct2.FStar_Syntax_Syntax.effect_args)
        | uu___ -> false in
      let equal_data f1 args1 f2 args2 =
        let uu___ = FStar_Syntax_Syntax.fv_eq f1 f2 in
        if uu___ then maybe_equal_args args1 args2 else false in
      let qual_is_inj uu___ =
        ...
        | FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Record_ctor
            uu___1) -> true
        | uu___1 -> false in
      let heads_and_args_in_case_both_data_or_injective =
        let uu___ =
                      ...
                      (FStar_Syntax_Syntax.fv_eq f g) &&
                        ((qual_is_inj f.FStar_Syntax_Syntax.fv_qual) ||
                           (let uu___3 =
                            ...
                            FStar_Compiler_List.mem uu___3 injectives))
      ...
      | (FStar_Syntax_Syntax.Tm_lazy uu___, uu___1) -> false
      | (uu___, FStar_Syntax_Syntax.Tm_lazy uu___1) -> false
      | (FStar_Syntax_Syntax.Tm_name a, FStar_Syntax_Syntax.Tm_name b) ->
          FStar_Syntax_Syntax.bv_eq a b
      | uu___ when
          FStar_Compiler_Effect.op_Bar_Greater
            heads_and_args_in_case_both_data_or_injective
      ...
      | (FStar_Syntax_Syntax.Tm_fvar f, FStar_Syntax_Syntax.Tm_fvar g) ->
          FStar_Syntax_Syntax.fv_eq f g
      | (FStar_Syntax_Syntax.Tm_uinst (f, us1), FStar_Syntax_Syntax.Tm_uinst
         (g, us2)) ->
          (maybe_equal_term f g) &&
            (maybe_equal_univs (FStar_Syntax_Syntax.U_max us1)
               (FStar_Syntax_Syntax.U_max us2))
      ...
      | (FStar_Syntax_Syntax.Tm_app (h1, args1), FStar_Syntax_Syntax.Tm_app
         (h2, args2)) ->
          (maybe_equal_term h1 h2) && (maybe_equal_args args1 args2)
