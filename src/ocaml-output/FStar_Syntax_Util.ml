  ...
  fun u1  ->
    fun u2  ->
      ...
      | (FStar_Syntax_Syntax.U_unknown ,FStar_Syntax_Syntax.U_unknown ) ->
          (Prims.parse_int "0")
      | (FStar_Syntax_Syntax.U_unknown ,uu____823) ->
          ~- (Prims.parse_int "1")
...
let rec eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___173_2064 = if uu___173_2064 then Equal else Unknown
         in
      let equal_iff uu___174_2069 = if uu___174_2069 then Equal else NotEqual
         in
      let eq_and f g = match f with | Equal  -> g () | uu____2083 -> Unknown
         in
      let eq_inj f g =
        match (f, g) with
        | (Equal ,Equal ) -> Equal
            ...
            (FStar_List.fold_left
               (fun acc  ->
                  fun uu____2194  ->
                    ...
                    | ((a1,q1),(a2,q2)) ->
                        let uu____2222 = eq_tm a1 a2  in
                        eq_inj acc uu____2222) Equal) uu____2136
        else NotEqual  in
...
let destruct :
  ...
  fun typ  ->
    fun lid  ->
      ...
      let uu____2760 =
        let uu____2761 = un_uinst typ1  in uu____2761.FStar_Syntax_Syntax.n
         in
  ...
  fun phi  ->
    let uu____4842 =
      let uu____4845 =
        let uu____4846 =
          let uu____4861 =
            let uu____4864 = FStar_Syntax_Syntax.as_arg phi  in [uu____4864]
             in
          (t_not, uu____4861)  in
  ...
  fun e  ->
    let uu____4936 =
      let uu____4939 =
        let uu____4940 =
          let uu____4955 =
            let uu____4958 = FStar_Syntax_Syntax.as_arg e  in [uu____4958]
             in
          (b2t_v, uu____4955)  in
  ...
  fun f  ->
    ...
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____6269 =
        ...
        | (lid,arity) ->
            let uu____6278 =
              let uu____6293 = unmeta_monadic f2  in head_and_args uu____6293
               in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____6533  ->
                      ...
                      | (t3,imp) ->
                          let uu____6544 = unascribe t3  in (uu____6544, imp)))
               in
    ...
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7921
          ...
          FStar_Parser_Const.effect_Tot_lid uu____7931
         in
      {
  ...
  fun t  ->
    ...
    let uu____7957 =
      let uu____7960 =
        let uu____7961 =
          let uu____7976 =
            let uu____7979 = FStar_Syntax_Syntax.as_arg t  in [uu____7979]
             in
...
let incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let uu____8213 = delta_qualifier t  in incr_delta_depth uu____8213
...
let rec list_elements :
  ...
  =
  fun e  ->
    let uu____8235 = let uu____8250 = unmeta e  in head_and_args uu____8250
       in
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____8527 =
          let uu____8528 =
            let uu____8529 = FStar_Syntax_Syntax.iarg typ  in [uu____8529]
             in
            ...
            (fun acc  ->
               fun uu____9825  ->
                 ...
                 | (bv,uu____9831) ->
                     ...
                     acc + uu____9832) (Prims.parse_int "0") bs
           in
          ...
          let uu____9925 =
            let uu____9928 =
              let uu____9929 =
                let uu____9936 =
                  let uu____9937 =
                    let uu____9946 = FStar_Dyn.mkdyn b  in
                    (uu____9946, s, ty)  in
