      ...
      | uu____1649 ->
          let uu____1660 =
            ...
            FStar_Util.format2
              ...
              (c.FStar_Syntax_Syntax.effect_name).FStar_Ident.str uu____1662 in
          failwith uu____1660 in
...
let (uu___is_Equal : eq_result -> Prims.bool) =
  fun projectee -> match projectee with | Equal -> true | uu____2973 -> false
...
let rec (eq_tm :
  ...
  fun t1 ->
    fun t2 ->
      ...
      let eq_and f g = match f with | Equal -> g () | uu____3189 -> Unknown in
            ...
            (FStar_List.fold_left
               (fun acc ->
                  fun uu____3292 ->
                    ...
                    | ((a1, q1), (a2, q2)) ->
                        let uu____3333 = eq_tm a1 a2 in eq_inj acc uu____3333)
               Equal) uu____3215
        else NotEqual in
            ...
            (match uu____3417 with
             | (head2, args2) ->
                 ...
                 (match uu____3487 with
                  ...
                  | uu____3524 -> FStar_Pervasives_Native.None)) in
      let uu____3537 =
        let uu____3542 =
          let uu____3543 = unmeta t11 in uu____3543.FStar_Syntax_Syntax.n in
        let uu____3546 =
          let uu____3547 = unmeta t21 in uu____3547.FStar_Syntax_Syntax.n in
      ...
      | (FStar_Syntax_Syntax.Tm_uvar (u1, ([], uu____3677)),
         FStar_Syntax_Syntax.Tm_uvar (u2, ([], uu____3679))) ->
          let uu____3708 =
...
let (destruct :
  ...
  fun typ ->
    fun lid ->
      ...
      let uu____5238 =
        let uu____5239 = un_uinst typ1 in uu____5239.FStar_Syntax_Syntax.n in
            ...
            (match body.FStar_Syntax_Syntax.n with
             | FStar_Syntax_Syntax.Tm_abs (bs', t1, lopt') ->
                 let uu____6118 =
                   let uu____6125 =
                     let uu____6126 =
                       let uu____6145 =
                         let uu____6154 = FStar_Syntax_Subst.close_binders bs in
             ...
             | uu____6184 ->
                 let uu____6185 =
                   let uu____6192 =
                     let uu____6193 =
                       let uu____6212 = FStar_Syntax_Subst.close_binders bs in
           ...
           | (bs1, c1) ->
               ...
               (match uu____6967 with
                ...
                | uu____7017 ->
                    ...
                    if uu____7020
                    then
                      let uu____7039 = arrow_until_decreases (comp_result c1) in
                 ...
                 FStar_All.pipe_right bs
                   (FStar_List.map
                      (fun uu____7273 ->
                         ...
                         | (x, uu____7282) -> FStar_Util.set_mem x d_bvs)) in
               FStar_List.append uu____7239 uu____7248) in
                    ...
                    | (FStar_Pervasives_Native.Some fvs, uu____7756) ->
                        let universes =
                          FStar_All.pipe_right univ_vars
                            (FStar_List.map
                               (fun _7772 -> FStar_Syntax_Syntax.U_name _7772)) in
                        let inst1 =
  ...
  fun phi ->
    let uu____8671 =
      let uu____8678 =
        let uu____8679 =
          let uu____8696 =
            let uu____8707 = FStar_Syntax_Syntax.as_arg phi in [uu____8707] in
          (t_not, uu____8696) in
  ...
  fun e ->
    let uu____8904 =
      let uu____8911 =
        let uu____8912 =
          let uu____8929 =
            let uu____8940 = FStar_Syntax_Syntax.as_arg e in [uu____8940] in
          (b2t_v, uu____8929) in
        ...
        (match uu____10663 with
         | (FStar_Syntax_Syntax.Tm_uinst
            ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
               ...
               FStar_Syntax_Syntax.vars = uu____10702;_},
             u::[]),
            (t1, uu____10705)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid
        ...
        (match uu____10838 with
         | (FStar_Syntax_Syntax.Tm_uinst
            ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
               ...
               FStar_Syntax_Syntax.vars = uu____10877;_},
             u::[]),
            (t1, uu____10880)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Parser_Const.auto_squash_lid
...
let (is_sub_singleton : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t ->
    let uu____10955 = let uu____10972 = unmeta t in head_and_args uu____10972 in
    ...
    let destruct_base_conn t =
      ...
      | (hd1, args) ->
          ...
          (match uu____12049 with
           ...
           | uu____12056 -> FStar_Pervasives_Native.None) in
               ...
               (match uu____12120 with
                | FStar_Syntax_Syntax.Tm_fvar fv ->
                    lookup_arity_lid destruct_sq_base_table
                      (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
                      args
                | uu____12127 -> FStar_Pervasives_Native.None)) in
    let patterns t =
      let t1 = FStar_Syntax_Subst.compress t in
      match t1.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Tm_meta
                ...
                (FStar_List.map
                   (fun uu____12383 ->
                      ...
                      | (t3, imp) ->
                          ...
                          (uu____12402, imp))) in
            (uu____12341, uu____12342) in
      let rec aux qopt out t1 =
        let uu____12453 = let uu____12477 = flat t1 in (qopt, uu____12477) in
        ...
        | (FStar_Pervasives_Native.Some fa,
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
            ...
            ({
               ...
               FStar_Syntax_Syntax.vars = uu____12523;_},
             uu____12524)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.Some fa,
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
              FStar_Syntax_Syntax.pos = uu____12626;
              FStar_Syntax_Syntax.vars = uu____12627;_},
            uu____12628::({
        ...
        | (FStar_Pervasives_Native.None,
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
            ...
            ({
               FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                 (b::[], t2, uu____12755);
               FStar_Syntax_Syntax.pos = uu____12756;
               FStar_Syntax_Syntax.vars = uu____12757;_},
             uu____12758)::[]))
            when
        ...
        | (FStar_Pervasives_Native.None,
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
              ...
              FStar_Syntax_Syntax.vars = uu____12866;_},
            uu____12867::({
                            FStar_Syntax_Syntax.n =
                              FStar_Syntax_Syntax.Tm_abs
                              (b::[], t2, uu____12870);
                            FStar_Syntax_Syntax.pos = uu____12871;
                            FStar_Syntax_Syntax.vars = uu____12872;_},
                          uu____12873)::[]))
            when
            is_qlid (tc.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v ->
            let uu____12982 =
                         ...
                         let uu____13282 =
                           let uu____13283 =
                             FStar_Syntax_Syntax.as_arg
                               (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort in
                           let uu____13294 =
                             let uu____13305 = FStar_Syntax_Syntax.as_arg q in
                             [uu____13305] in
        ...
        (fun t1 ->
           ...
           | (hd1, args) ->
               ...
               (match uu____13416 with
                | (FStar_Syntax_Syntax.Tm_fvar fv,
                   (a1, uu____13449)::(a2, uu____13451)::[]) when
                    FStar_Syntax_Syntax.fv_eq_lid fv
                    ...
                    (match uu____13502 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[], q, uu____13510) ->
                         let uu____13545 = FStar_Syntax_Subst.open_term [b] q in
      ...
      fun pos ->
        let lb =
          ...
          close_univs_and_mk_letbinding FStar_Pervasives_Native.None
            ...
            FStar_Parser_Const.effect_Tot_lid uu____13794 [] pos in
        {
  ...
  fun t ->
    ...
    let uu____13820 =
      let uu____13827 =
        let uu____13828 =
          let uu____13845 =
            let uu____13856 = FStar_Syntax_Syntax.as_arg t in [uu____13856] in
  ...
  fun t ->
    ...
    let uu____13919 =
      let uu____13926 =
        let uu____13927 =
          let uu____13944 =
            let uu____13955 = FStar_Syntax_Syntax.as_arg t in [uu____13955] in
  ...
  fun typ ->
    fun rng ->
      fun l ->
        ...
        let uu____14404 =
          let uu____14405 =
            let uu____14406 = FStar_Syntax_Syntax.iarg typ in [uu____14406] in
...
let rec (term_eq_dbg :
  ...
  fun dbg ->
    fun t1 ->
      fun t2 ->
        let t11 = let uu____15112 = unmeta_safe t1 in canon_app uu____15112 in
        let t21 = let uu____15118 = unmeta_safe t2 in canon_app uu____15118 in
        let uu____15121 =
          let uu____15126 =
            let uu____15127 =
        ...
        | (FStar_Syntax_Syntax.Tm_type uu____15287,
           FStar_Syntax_Syntax.Tm_type uu____15288) -> true
        ...
        | (FStar_Syntax_Syntax.Tm_quoted (qt1, qi1),
           FStar_Syntax_Syntax.Tm_quoted (qt2, qi2)) ->
            (let uu____15730 =
               let uu____15732 = eq_quoteinfo qi1 qi2 in uu____15732 = Equal in
            ...
            (fun acc ->
               fun uu____16579 ->
                 ...
                 | (bv, uu____16589) ->
                     ...
                     acc + uu____16594) Prims.int_zero bs in
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid ->
    fun t ->
      let uu____16672 =
        let uu____16673 = un_uinst t in uu____16673.FStar_Syntax_Syntax.n in
  ...
  fun p ->
    fun r ->
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____16865 = FStar_Options.restore_cmd_line_options false in
...
let rec (unbound_variables :
  ...
  fun tm ->
        ...
        let uu____17175 =
          FStar_List.collect
            (fun uu____17189 ->
               ...
               | (x, uu____17201) -> unbound_variables x) args in
            ...
            (FStar_List.collect
               (fun br ->
                  ...
                  | (p, wopt, t2) ->
                      ...
                      FStar_List.append uu____17291 uu____17294)) in
    ...
    | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), t1) ->
        ...
        let uu____17430 =
          let uu____17433 = unbound_variables lb.FStar_Syntax_Syntax.lbdef in
          let uu____17436 =
            ...
            | FStar_Util.Inl bv ->
                ...
                (match uu____17443 with
                 | (uu____17464, t2) -> unbound_variables t2) in
             ...
             let uu____17504 =
               FStar_List.collect
                 (fun lb ->
                    ...
                    FStar_List.append uu____17511 uu____17514) lbs1 in
...
and (unbound_variables_comp :
  ...
  fun c ->
    ...
    | FStar_Syntax_Syntax.Comp ct ->
        let uu____17665 = unbound_variables ct.FStar_Syntax_Syntax.result_typ in
        let uu____17668 =
          FStar_List.collect
            (fun uu____17682 ->
...
let rec (list_elements :
  ...
  =
  fun e ->
    let uu____18174 = let uu____18191 = unmeta e in head_and_args uu____18191 in
    ...
    | (head1, args) ->
        ...
        (match uu____18222 with
         | (FStar_Syntax_Syntax.Tm_fvar fv, uu____18256) when
             ...
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            uu____18280::(hd1, uu____18282)::(tl1, uu____18284)::[]) when
    ...
    | FStar_Syntax_Syntax.Tm_abs (b::[], e, uu____18403) ->
        ...
        (match uu____18438 with
         | (bs, e1) ->
             ...
             let uu____18472 = is_free_in (FStar_Pervasives_Native.fst b1) e1 in
             if uu____18472
             then
               let uu____18479 =
      ...
      let one_pat p =
        ...
        | (head1, args) ->
            ...
            (match uu____18687 with
             | (FStar_Syntax_Syntax.Tm_fvar fv,
                (uu____18725, uu____18726)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
        ...
        let smt_pat_or1 t1 =
          ...
          | (head1, args) ->
              ...
              (match uu____18908 with
               ...
               | uu____18980 -> FStar_Pervasives_Native.None) in
        match elts with
        | t1::[] ->
                 ...
                 (match c1.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Comp
                      { FStar_Syntax_Syntax.comp_univs = uu____19371;
                        ...
                        FStar_Syntax_Syntax.effect_args =
                          (pre, uu____19375)::(post, uu____19377)::(pats,
                                                                    uu____19379)::[];
    ...
    fun combs ->
      let map_tuple uu____19787 =
        ...
        | (ts1, ts2) ->
            ...
            let uu____19799 = f ts2 in (uu____19798, uu____19799) in
      ...
      let uu____19820 = map_tuple combs.FStar_Syntax_Syntax.l_if_then_else in
      {
