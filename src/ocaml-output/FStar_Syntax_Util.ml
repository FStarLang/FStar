    ...
    FStar_All.pipe_right binders
      (FStar_List.collect
         (fun b  ->
            ...
            | true  -> []
            | uu____49 ->
                let uu____50 = arg_of_non_null_binder b in [uu____50]))
let args_of_binders:
  FStar_Syntax_Syntax.binders ->
            ...
            (fun f  ->
               fun a  ->
                 fun out  ->
                   ...
                   out) formals actuals []
      | uu____335 -> failwith "Ill-formed substitution"
let rename_binders:
  FStar_Syntax_Syntax.binders ->
  ...
  fun replace_xs  ->
    fun with_ys  ->
      ...
      | uu____378 -> failwith "Ill-formed substitution"
...
let rec eq_tm:
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___172_1231 =
        match uu___172_1231 with | true  -> Equal | uu____1232 -> Unknown in
      let equal_iff uu___173_1236 =
        match uu___173_1236 with | true  -> Equal | uu____1237 -> NotEqual in
    ...
    fun x  ->
      fun i  ->
        let nm =
          ...
          | uu____2159 -> x.FStar_Syntax_Syntax.ppname in
        let y =
      ...
      FStar_List.fold_right
        (fun b  ->
           fun f  ->
             ...
             | true  -> f
             | uu____4011 -> mk_forall (Prims.fst b) f) bs f
  ...
  fun f  ->
    ...
    let destruct_base_conn f =
      ...
      let rec aux f uu____4303 =
        ...
        | (lid,arity) ->
            let uu____4309 =
              let uu____4319 = unmeta_monadic f in head_and_args uu____4319 in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta (t,FStar_Syntax_Syntax.Meta_pattern pats)
          ...
          (pats, uu____4389)
      | uu____4396 ->
          let uu____4397 = FStar_Syntax_Subst.compress t in ([], uu____4397) in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____4487  ->
                      ...
                      | (t,imp) ->
                          let uu____4494 = unascribe t in (uu____4494, imp))) in
                 ...
                 (match uu____4809 with
                  | (pats,body) ->
                      (match b with
                       ...
                       | uu____4840 -> Some (QEx (bs, pats, body)))))
        | uu____4847 -> None in
      aux None [] t in
