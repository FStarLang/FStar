      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun b  ->
              ...
              | uu____102 ->
                  let _0_198 = arg_of_non_null_binder b in (b, _0_198))) in
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_iff uu___173_1157 =
        match uu___173_1157 with | true  -> Equal | uu____1158 -> NotEqual in
        ...
        | uu____2140 ->
            let close_lopt lopt =
              ...
              | Some (FStar_Util.Inl lc) ->
                  Some
                    (FStar_Util.Inl (FStar_Syntax_Subst.close_lcomp bs lc)) in
            (match bs with
             | [] -> t
             | uu____2202 ->
                 let body =
  ...
  fun f  ->
    ...
    let destruct_q_conn t =
      let is_q fa fv =
        ...
        | uu____3950 ->
            is_exists (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v in
      let flat t =
