...
let arg_of_non_null_binder uu____24 =
  match uu____24 with
  | (b,imp) -> let _0_194 = FStar_Syntax_Syntax.bv_to_name b in (_0_194, imp)
    ...
    FStar_All.pipe_right binders
      (FStar_List.collect
         (fun b  ->
            ...
            if uu____41
            then []
            else (let _0_195 = arg_of_non_null_binder b in [_0_195])))
let args_of_binders:
  FStar_Syntax_Syntax.binders ->
      ...
      FStar_All.pipe_right binders
        (FStar_List.map
           (fun b  ->
              ...
              else (let _0_198 = arg_of_non_null_binder b in (b, _0_198)))) in
  ...
  fun u1  ->
    fun u2  ->
      ...
      | (FStar_Syntax_Syntax.U_unknown ,FStar_Syntax_Syntax.U_unknown ) ->
          Prims.parse_int "0"
      | (FStar_Syntax_Syntax.U_unknown ,uu____389) -> - (Prims.parse_int "1")
...
let comp_effect_name c =
  ...
  | FStar_Syntax_Syntax.Total uu____496 -> FStar_Syntax_Const.effect_Tot_lid
  | FStar_Syntax_Syntax.GTotal uu____502 ->
...
let comp_set_flags:
  ...
  fun c  ->
    fun f  ->
      let comp_to_comp_typ c =
        ...
        | FStar_Syntax_Syntax.Total (t,u_opt)|FStar_Syntax_Syntax.GTotal
          (t,u_opt) ->
            ...
            {
              FStar_Syntax_Syntax.comp_univs = _0_212;
      ...
      {
        FStar_Syntax_Syntax.n = _0_213;
        FStar_Syntax_Syntax.tk = (uu___175_569.FStar_Syntax_Syntax.tk);
        FStar_Syntax_Syntax.pos = (uu___175_569.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___175_569.FStar_Syntax_Syntax.vars)
      }
...
let is_pure_comp c =
  match c.FStar_Syntax_Syntax.n with
  | FStar_Syntax_Syntax.Total uu____691 -> true
  | FStar_Syntax_Syntax.GTotal uu____697 -> false
             ...
             (match ct.FStar_Syntax_Syntax.effect_args with
              | _req::_ens::(pats,uu____852)::uu____853 ->
                  ...
                  (match uu____884 with
                   | (head,uu____895) ->
                       let uu____910 = (un_uinst head).FStar_Syntax_Syntax.n in
...
let set_result_typ c t =
  match c.FStar_Syntax_Syntax.n with
  | FStar_Syntax_Syntax.Total uu____980 -> FStar_Syntax_Syntax.mk_Total t
  | FStar_Syntax_Syntax.GTotal uu____986 -> FStar_Syntax_Syntax.mk_GTotal t
  | FStar_Syntax_Syntax.Comp ct ->
      FStar_Syntax_Syntax.mk_Comp
        (let uu___177_993 = ct in
         {
           FStar_Syntax_Syntax.comp_univs =
             (uu___177_993.FStar_Syntax_Syntax.comp_univs);
           FStar_Syntax_Syntax.effect_name =
             (uu___177_993.FStar_Syntax_Syntax.effect_name);
           FStar_Syntax_Syntax.result_typ = t;
           FStar_Syntax_Syntax.effect_args =
             (uu___177_993.FStar_Syntax_Syntax.effect_args);
           FStar_Syntax_Syntax.flags =
             (uu___177_993.FStar_Syntax_Syntax.flags)
         })
let is_trivial_wp c =
  FStar_All.pipe_right (comp_flags c)
    (FStar_Util.for_some
       (fun uu___171_1006  ->
          match uu___171_1006 with
          | FStar_Syntax_Syntax.TOTAL |FStar_Syntax_Syntax.RETURN  -> true
          | uu____1007 -> false))
...
let rec ascribe t k =
  match t.FStar_Syntax_Syntax.n with
  | FStar_Syntax_Syntax.Tm_ascribed (t',uu____1087,uu____1088) ->
      ascribe t' k
  | uu____1107 ->
...
let rec eq_tm:
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___172_1152 = if uu___172_1152 then Equal else Unknown in
      let equal_iff uu___173_1157 = if uu___173_1157 then Equal else NotEqual in
      let eq_and f g = match f with | Equal  -> g () | uu____1171 -> Unknown in
      ...
      | (FStar_Syntax_Syntax.Tm_uvar
         (u1,uu____1192),FStar_Syntax_Syntax.Tm_uvar (u2,uu____1194)) ->
...
let rec non_informative: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_app (head,uu____1399) -> non_informative head
    | FStar_Syntax_Syntax.Tm_uinst (t,uu____1415) -> non_informative t
    | FStar_Syntax_Syntax.Tm_arrow (uu____1420,c) ->
        (is_tot_or_gtot_comp c) && (non_informative (comp_result c))
    | uu____1432 -> false
let is_fun: FStar_Syntax_Syntax.term -> Prims.bool =
  fun e  ->
    let uu____1436 = (FStar_Syntax_Subst.compress e).FStar_Syntax_Syntax.n in
    match uu____1436 with
    | FStar_Syntax_Syntax.Tm_abs uu____1437 -> true
    | uu____1452 -> false
let is_function_typ: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____1456 = (FStar_Syntax_Subst.compress t).FStar_Syntax_Syntax.n in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let _0_222 = mk_field_projector_name_from_ident lid nm in (_0_222, y)
let set_uvar uv t =
        ...
        then t
          ...
          (let close_lopt lopt =
             ...
             | Some (FStar_Util.Inl lc) ->
                 Some (FStar_Util.Inl (FStar_Syntax_Subst.close_lcomp bs lc)) in
           match bs with
           | [] -> t
           | uu____2202 ->
               let body =
                 FStar_Syntax_Subst.compress (FStar_Syntax_Subst.close bs t) in
               (match ((body.FStar_Syntax_Syntax.n), lopt) with
                | (FStar_Syntax_Syntax.Tm_abs (bs',t,lopt'),None ) ->
                    (FStar_Syntax_Syntax.mk
                       (FStar_Syntax_Syntax.Tm_abs
                          (let _0_227 =
                             let _0_225 = FStar_Syntax_Subst.close_binders bs in
                ...
                | uu____2270 ->
                    (FStar_Syntax_Syntax.mk
                       (FStar_Syntax_Syntax.Tm_abs
                          (let _0_229 = FStar_Syntax_Subst.close_binders bs in
...
let flat_arrow:
  ...
  fun bs  ->
    fun c  ->
      let t = arrow bs c in
      let uu____2348 = (FStar_Syntax_Subst.compress t).FStar_Syntax_Syntax.n in
           ...
           | FStar_Syntax_Syntax.Total (tres,uu____2366) ->
               ...
               (match uu____2373 with
                | FStar_Syntax_Syntax.Tm_arrow (bs',c') ->
                    ...
                    (FStar_Syntax_Syntax.mk
                       (FStar_Syntax_Syntax.Tm_arrow
                          ((FStar_List.append bs bs'), c'))) _0_232
                      t.FStar_Syntax_Syntax.pos
                | uu____2406 -> t)
           | uu____2407 -> t)
      | uu____2408 -> t
    ...
    fun t  ->
      ...
      (FStar_Syntax_Syntax.mk
         (FStar_Syntax_Syntax.Tm_refine
            (let _0_235 =
               let _0_234 =
                 let _0_233 = FStar_Syntax_Syntax.mk_binder b in [_0_233] in
          ...
          let l =
              ...
              FStar_Syntax_Subst.subst s l.FStar_Syntax_Syntax.res_typ in
            {
              FStar_Syntax_Syntax.eff_name =
                (uu___179_2595.FStar_Syntax_Syntax.eff_name);
              FStar_Syntax_Syntax.res_typ = _0_241;
              FStar_Syntax_Syntax.cflags =
                (uu___179_2595.FStar_Syntax_Syntax.cflags);
              FStar_Syntax_Syntax.comp =
                (fun uu____2596  ->
    ...
    let rec aux t abs_body_lcomp =
      let uu____2643 =
        (let _0_242 = FStar_Syntax_Subst.compress t in
         FStar_All.pipe_left unascribe _0_242).FStar_Syntax_Syntax.n in
                ...
                | (Some fvs,uu____2898) ->
                    let universes =
                      FStar_All.pipe_right univ_vars
                        (FStar_List.map
                           (fun _0_243  -> FStar_Syntax_Syntax.U_name _0_243)) in
                    let inst =
...
let mk_neg phi =
  (FStar_Syntax_Syntax.mk
     (FStar_Syntax_Syntax.Tm_app
        (let _0_267 = let _0_266 = FStar_Syntax_Syntax.as_arg phi in [_0_266] in
...
let b2t e =
  (FStar_Syntax_Syntax.mk
     (FStar_Syntax_Syntax.Tm_app
        (let _0_269 = let _0_268 = FStar_Syntax_Syntax.as_arg e in [_0_268] in
          ...
          (FStar_Syntax_Syntax.mk
             (FStar_Syntax_Syntax.Tm_app
                (let _0_280 =
                   ...
                   let _0_278 =
                     let _0_277 = FStar_Syntax_Syntax.as_arg e1 in
                     let _0_276 =
...
let mk_has_type t x t' =
  ...
  (FStar_Syntax_Syntax.mk
     (FStar_Syntax_Syntax.Tm_app
        (let _0_287 =
           let _0_286 = FStar_Syntax_Syntax.iarg t in
           let _0_285 =
             let _0_284 = FStar_Syntax_Syntax.as_arg x in
             let _0_283 =
               let _0_282 = FStar_Syntax_Syntax.as_arg t' in [_0_282] in
             _0_284 :: _0_283 in
           _0_286 :: _0_285 in
         (t_has_type, _0_287)))) None FStar_Range.dummyRange
...
let lcomp_of_comp:
  ...
  fun c0  ->
    let uu____3491 =
      ...
      | FStar_Syntax_Syntax.Total uu____3498 ->
          (FStar_Syntax_Const.effect_Tot_lid, [FStar_Syntax_Syntax.TOTAL])
      | FStar_Syntax_Syntax.GTotal uu____3505 ->
          (FStar_Syntax_Const.effect_GTot_lid,
    ...
    | (eff_name,flags) ->
        {
          ...
          FStar_Syntax_Syntax.comp = ((fun uu____3518  -> c0))
        }
let mk_forall:
  FStar_Syntax_Syntax.bv ->
    FStar_Syntax_Syntax.typ ->
               ...
               let _0_293 =
                 let _0_292 =
                   FStar_Syntax_Syntax.as_arg
                     (let _0_291 =
                        let _0_288 = FStar_Syntax_Syntax.mk_binder x in
                        [_0_288] in
                      let _0_290 =
                        Some
                          (FStar_Util.Inl
                             (let _0_289 =
                              ...
                              FStar_All.pipe_left lcomp_of_comp _0_289)) in
                      abs _0_291 body _0_290) in
                 [_0_292] in
               _0_294 :: _0_293 in
             (tforall, _0_295)))) None FStar_Range.dummyRange
  ...
  fun bs  ->
    fun f  ->
      FStar_List.fold_right
        (fun b  ->
           fun f  ->
             let uu____3554 = FStar_Syntax_Syntax.is_null_binder b in
             if uu____3554 then f else mk_forall (Prims.fst b) f) bs f
let rec is_wild_pat p =
  match p.FStar_Syntax_Syntax.v with
  | FStar_Syntax_Syntax.Pat_wild uu____3567 -> true
  | uu____3568 -> false
  ...
  let _0_299 =
    let _0_298 =
      FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos
        t2.FStar_Syntax_Syntax.pos in
    FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos _0_298 in
  FStar_Syntax_Syntax.mk
...
let uu___is_QAll: connective -> Prims.bool =
  fun projectee  ->
    match projectee with | QAll _0 -> true | uu____3712 -> false
let __proj__QAll__item___0:
  connective -> (FStar_Syntax_Syntax.binders* qpats* FStar_Syntax_Syntax.typ)
  = fun projectee  -> match projectee with | QAll _0 -> _0
let uu___is_QEx: connective -> Prims.bool =
  fun projectee  ->
    match projectee with | QEx _0 -> true | uu____3736 -> false
let __proj__QEx__item___0:
  connective -> (FStar_Syntax_Syntax.binders* qpats* FStar_Syntax_Syntax.typ)
  = fun projectee  -> match projectee with | QEx _0 -> _0
let uu___is_BaseConn: connective -> Prims.bool =
  fun projectee  ->
    match projectee with | BaseConn _0 -> true | uu____3759 -> false
...
let destruct_typ_as_formula:
  ...
  fun f  ->
    ...
    let destruct_base_conn f =
      ...
      let rec aux f uu____3839 =
        match uu____3839 with
        | (lid,arity) ->
            let uu____3845 = head_and_args (unmeta_monadic f) in
            (match uu____3845 with
             | (t,args) ->
                 ...
                 if uu____3873 then Some (BaseConn (lid, args)) else None) in
      FStar_Util.find_map connectives (aux f) in
    let patterns t =
      let t = FStar_Syntax_Subst.compress t in
      match t.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Tm_meta (t,FStar_Syntax_Syntax.Meta_pattern pats)
          -> let _0_300 = FStar_Syntax_Subst.compress t in (pats, _0_300)
      | uu____3930 ->
          let _0_301 = FStar_Syntax_Subst.compress t in ([], _0_301) in
    let destruct_q_conn t =
      ...
      let flat t =
        let uu____3972 = head_and_args t in
        match uu____3972 with
        | (t,args) ->
            let _0_304 = un_uinst t in
            let _0_303 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____4018  ->
                      match uu____4018 with
                      | (t,imp) -> let _0_302 = unascribe t in (_0_302, imp))) in
            (_0_304, _0_303) in
      let rec aux qopt out t =
        let uu____4044 = let _0_305 = flat t in (qopt, _0_305) in
        ...
        | (Some b,uu____4306) ->
            ...
            let uu____4324 = FStar_Syntax_Subst.open_term bs t in
            (match uu____4324 with
             | (bs,t) ->
                 let uu____4330 = patterns t in
    ...
    let uu____4380 = destruct_base_conn phi in
    match uu____4380 with | Some b -> Some b | None  -> destruct_q_conn phi
let action_as_lb:
  FStar_Ident.lident ->
  ...
  fun eff_lid  ->
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding None _0_306
...
let mk_reify t =
  ...
  (FStar_Syntax_Syntax.mk
     (FStar_Syntax_Syntax.Tm_app
        (let _0_308 = let _0_307 = FStar_Syntax_Syntax.as_arg t in [_0_307] in
         (reify_, _0_308)))) None t.FStar_Syntax_Syntax.pos
let rec delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let t = FStar_Syntax_Subst.compress t in
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____4434 -> failwith "Impossible"
...
let is_unknown: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____4540 = (FStar_Syntax_Subst.compress t).FStar_Syntax_Syntax.n in
...
let rec list_elements:
  ...
  =
  fun e  ->
    let uu____4549 = head_and_args (unmeta e) in
    match uu____4549 with
    | (head,args) ->
        let uu____4577 =
          let _0_309 = (un_uinst head).FStar_Syntax_Syntax.n in
          (_0_309, args) in
        (match uu____4577 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____4593) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.nil_lid ->
             Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____4606::(hd,uu____4608)::(tl,uu____4610)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.cons_lid ->
             Some
               (let _0_310 = FStar_Util.must (list_elements tl) in hd ::
                  _0_310)
         | uu____4650 -> None)