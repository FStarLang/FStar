...
let comp_set_flags:
  ...
  fun c  ->
    fun f  ->
      ...
      let uu___73_1093 = c in
      let uu____1094 =
        let uu____1095 =
          let uu___74_1096 = comp_to_comp_typ c in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___74_1096.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___74_1096.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___74_1096.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___74_1096.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          } in
        FStar_Syntax_Syntax.Comp uu____1095 in
      {
        FStar_Syntax_Syntax.n = uu____1094;
        FStar_Syntax_Syntax.pos = (uu___73_1093.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___73_1093.FStar_Syntax_Syntax.vars)
      }
...
let set_result_typ:
  ...
  fun c  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___75_1744 = ct in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___75_1744.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___75_1744.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___75_1744.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___75_1744.FStar_Syntax_Syntax.flags)
             })
let is_trivial_wp:
  FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax -> Prims.bool =
  fun c  ->
...
let rec eq_tm:
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___70_2006 = if uu___70_2006 then Equal else Unknown in
      let equal_iff uu___71_2011 = if uu___71_2011 then Equal else NotEqual in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___76_3154 = x in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___76_3154.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___76_3154.FStar_Syntax_Syntax.sort)
          } in
      ...
      fun lopt  ->
        let close_lopt lopt1 =
          ...
          | FStar_Pervasives_Native.Some rc ->
              let uu____3271 =
                let uu___77_3272 = rc in
                let uu____3273 =
                  FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                    (FStar_Syntax_Subst.close bs) in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___77_3272.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____3273;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___77_3272.FStar_Syntax_Syntax.residual_flags)
                } in
...
let abs_formals:
  ...
  fun t  ->
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____3816 =
            let uu___78_3817 = rc in
            let uu____3818 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (FStar_Syntax_Subst.subst s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___78_3817.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____3818;
              FStar_Syntax_Syntax.residual_flags =
                (uu___78_3817.FStar_Syntax_Syntax.residual_flags)
            } in
...
let rec term_eq:
  ...
  fun t1  ->
    fun t2  ->
      let canon_app t =
        match t.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Tm_app uu____8774 ->
            let uu____8789 = head_and_args' t in
            (match uu____8789 with
             | (hd1,args) ->
                 let uu___79_8822 = t in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___79_8822.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___79_8822.FStar_Syntax_Syntax.vars)
                 })
        | uu____8833 -> t in
      let t11 = let uu____8837 = unmeta_safe t1 in canon_app uu____8837 in
      let t21 = let uu____8843 = unmeta_safe t2 in canon_app uu____8843 in
      match ((t11.FStar_Syntax_Syntax.n), (t21.FStar_Syntax_Syntax.n)) with
...
and branch_eq:
  ...
  fun uu____9214  ->
    fun uu____9215  ->
      match (uu____9214, uu____9215) with | ((p1,w1,t1),(p2,w2,t2)) -> false
let rec bottom_fold:
  (FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term) ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
  =
  fun f  ->
    fun t  ->
      ...
      let tn =
        let uu____9353 = FStar_Syntax_Subst.compress t in
        uu____9353.FStar_Syntax_Syntax.n in
      let tn1 =
        match tn with
        | FStar_Syntax_Syntax.Tm_app (f1,args) ->
            let uu____9379 =
              let uu____9394 = ff f1 in
              let uu____9395 =
                FStar_List.map
                  (fun uu____9414  ->
                     match uu____9414 with
                     | (a,q) -> let uu____9425 = ff a in (uu____9425, q))
                  args in
              (uu____9394, uu____9395) in
            FStar_Syntax_Syntax.Tm_app uu____9379
        | FStar_Syntax_Syntax.Tm_abs (bs,t1,k) ->
            ...
            (match uu____9455 with
             | (bs1,t') ->
                 let t'' = ff t' in
                 let uu____9463 =
                   let uu____9480 = FStar_Syntax_Subst.close bs1 t'' in
                   (bs1, uu____9480, k) in
                 FStar_Syntax_Syntax.Tm_abs uu____9463)
        | FStar_Syntax_Syntax.Tm_arrow (bs,k) -> tn
        | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
            let uu____9507 = let uu____9514 = ff t1 in (uu____9514, us) in
            FStar_Syntax_Syntax.Tm_uinst uu____9507
        | uu____9515 -> tn in
      f
        (let uu___80_9518 = t in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___80_9518.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars = (uu___80_9518.FStar_Syntax_Syntax.vars)
         })
let rec sizeof: FStar_Syntax_Syntax.term -> Prims.int =
  fun t  ->
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____9522 ->
        let uu____9547 =
          let uu____9548 = FStar_Syntax_Subst.compress t in sizeof uu____9548 in
        (Prims.parse_int "1") + uu____9547
    | FStar_Syntax_Syntax.Tm_bvar bv ->
        let uu____9550 = sizeof bv.FStar_Syntax_Syntax.sort in
        (Prims.parse_int "1") + uu____9550
    | FStar_Syntax_Syntax.Tm_name bv ->
        let uu____9552 = sizeof bv.FStar_Syntax_Syntax.sort in
        (Prims.parse_int "1") + uu____9552
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
        let uu____9559 = sizeof t1 in (FStar_List.length us) + uu____9559
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____9562) ->
        let uu____9583 = sizeof t1 in
        let uu____9584 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____9595  ->
                 ...
                 | (bv,uu____9601) ->
                     let uu____9602 = sizeof bv.FStar_Syntax_Syntax.sort in
                     acc + uu____9602) (Prims.parse_int "0") bs in
        uu____9583 + uu____9584
    | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
        let uu____9625 = sizeof hd1 in
        let uu____9626 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____9637  ->
                 ...
                 | (arg,uu____9643) ->
                     let uu____9644 = sizeof arg in acc + uu____9644)
            (Prims.parse_int "0") args in
        uu____9625 + uu____9626
    | uu____9645 -> Prims.parse_int "1"
let is_fvar: FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool =
  fun lid  ->
    fun t  ->
      let uu____9652 =
        let uu____9653 = un_uinst t in uu____9653.FStar_Syntax_Syntax.n in
          ...
          let uu____9687 =
            let uu____9690 =
              let uu____9691 =
                let uu____9698 =
                  let uu____9699 =
                    let uu____9708 = FStar_Dyn.mkdyn b in (uu____9708, s, ty) in
                  FStar_Syntax_Syntax.Meta_alien uu____9699 in
                (FStar_Syntax_Syntax.tun, uu____9698) in
              FStar_Syntax_Syntax.Tm_meta uu____9691 in
...
let un_alien: FStar_Syntax_Syntax.term -> FStar_Dyn.dyn =
  fun t  ->
    ...
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_meta
        (uu____9718,FStar_Syntax_Syntax.Meta_alien
         (blob,uu____9720,uu____9721))
        -> blob
    | uu____9730 -> failwith "unexpected: term was not an alien embedding"