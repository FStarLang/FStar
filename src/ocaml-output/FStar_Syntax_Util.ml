...
let name_function_binders:
  'Auu____160 .
    (FStar_Syntax_Syntax.term','Auu____160) FStar_Syntax_Syntax.syntax ->
      (FStar_Syntax_Syntax.term','Auu____160) FStar_Syntax_Syntax.syntax
  =
  fun t  ->
...
let mk_subst: 'Auu____292 . 'Auu____292 -> 'Auu____292 Prims.list =
  fun s  -> [s]
let subst_of_list:
  FStar_Syntax_Syntax.binders ->
...
let comp_effect_name:
  'Auu____567 .
    (FStar_Syntax_Syntax.comp','Auu____567) FStar_Syntax_Syntax.syntax ->
      FStar_Ident.lident
  =
  fun c  ->
    match c.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Comp c1 -> c1.FStar_Syntax_Syntax.effect_name
    | FStar_Syntax_Syntax.Total uu____577 ->
        FStar_Parser_Const.effect_Tot_lid
    | FStar_Syntax_Syntax.GTotal uu____583 ->
        FStar_Parser_Const.effect_GTot_lid
let comp_flags:
  'Auu____591 .
    (FStar_Syntax_Syntax.comp','Auu____591) FStar_Syntax_Syntax.syntax ->
      FStar_Syntax_Syntax.cflags Prims.list
  =
  fun c  ->
    match c.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Total uu____601 -> [FStar_Syntax_Syntax.TOTAL]
    | FStar_Syntax_Syntax.GTotal uu____607 ->
...
let is_named_tot:
  'Auu____704 .
    (FStar_Syntax_Syntax.comp','Auu____704) FStar_Syntax_Syntax.syntax ->
      Prims.bool
  =
  fun c  ->
    match c.FStar_Syntax_Syntax.n with
...
let is_total_comp:
  'Auu____728 .
    (FStar_Syntax_Syntax.comp','Auu____728) FStar_Syntax_Syntax.syntax ->
      Prims.bool
  =
  fun c  ->
...
let is_partial_return:
  'Auu____754 .
    (FStar_Syntax_Syntax.comp','Auu____754) FStar_Syntax_Syntax.syntax ->
      Prims.bool
  =
  fun c  ->
    FStar_All.pipe_right (comp_flags c)
...
let is_tot_or_gtot_comp:
  'Auu____774 .
    (FStar_Syntax_Syntax.comp','Auu____774) FStar_Syntax_Syntax.syntax ->
      Prims.bool
  =
  fun c  ->
    (is_total_comp c) ||
...
let is_pure_comp:
  'Auu____788 .
    (FStar_Syntax_Syntax.comp','Auu____788) FStar_Syntax_Syntax.syntax ->
      Prims.bool
  =
  fun c  ->
    match c.FStar_Syntax_Syntax.n with
...
let is_pure_or_ghost_comp:
  'Auu____818 .
    (FStar_Syntax_Syntax.comp','Auu____818) FStar_Syntax_Syntax.syntax ->
      Prims.bool
...
let is_ml_comp:
  'Auu____1041 .
    (FStar_Syntax_Syntax.comp','Auu____1041) FStar_Syntax_Syntax.syntax ->
      Prims.bool
  =
  fun c  ->
    match c.FStar_Syntax_Syntax.n with
...
let comp_result:
  'Auu____1057 .
    (FStar_Syntax_Syntax.comp','Auu____1057) FStar_Syntax_Syntax.syntax ->
      (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
        FStar_Syntax_Syntax.syntax
  =
  fun c  ->
...
let set_result_typ:
  'Auu____1088 .
    (FStar_Syntax_Syntax.comp','Auu____1088) FStar_Syntax_Syntax.syntax ->
      FStar_Syntax_Syntax.typ -> FStar_Syntax_Syntax.comp
  =
  fun c  ->
    fun t  ->
      match c.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Total uu____1101 ->
          FStar_Syntax_Syntax.mk_Total t
      | FStar_Syntax_Syntax.GTotal uu____1107 ->
...
let is_trivial_wp:
  'Auu____1117 .
    (FStar_Syntax_Syntax.comp','Auu____1117) FStar_Syntax_Syntax.syntax ->
      Prims.bool
  =
  fun c  ->
    FStar_All.pipe_right (comp_flags c)
...
let is_primop:
  'Auu____1136 .
    (FStar_Syntax_Syntax.term','Auu____1136) FStar_Syntax_Syntax.syntax ->
      Prims.bool
  =
  fun f  ->
...
let rec ascribe:
  'Auu____1190 .
    (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
      FStar_Syntax_Syntax.syntax ->
      (((FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
          FStar_Syntax_Syntax.syntax,(FStar_Syntax_Syntax.comp',Prims.unit)
                                       FStar_Syntax_Syntax.syntax)
         FStar_Util.either,(FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
                             FStar_Syntax_Syntax.syntax
                             FStar_Pervasives_Native.option)
        FStar_Pervasives_Native.tuple2 ->
        (FStar_Syntax_Syntax.term','Auu____1190) FStar_Syntax_Syntax.syntax
  =
  fun t  ->
    fun k  ->
      match t.FStar_Syntax_Syntax.n with
...
let range_of_lb:
  'Auu____1839 'Auu____1840 .
    ((FStar_Syntax_Syntax.bv,FStar_Ident.lid) FStar_Util.either,'Auu____1840,
      'Auu____1839) FStar_Pervasives_Native.tuple3 -> FStar_Range.range
  =
  fun uu___162_1849  ->
...
let range_of_arg:
  'Auu____1869 'Auu____1870 'Auu____1871 .
    (('Auu____1871,'Auu____1870) FStar_Syntax_Syntax.syntax,'Auu____1869)
      FStar_Pervasives_Native.tuple2 -> FStar_Range.range
  =
  fun uu____1879  ->
    match uu____1879 with | (hd1,uu____1885) -> hd1.FStar_Syntax_Syntax.pos
let range_of_args:
  'Auu____1895 'Auu____1896 'Auu____1897 .
    (('Auu____1897,'Auu____1896) FStar_Syntax_Syntax.syntax,'Auu____1895)
      FStar_Pervasives_Native.tuple2 Prims.list ->
  ...
  'Auu____1934 .
    (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
      ...
      ((FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
         FStar_Syntax_Syntax.syntax,FStar_Syntax_Syntax.aqual)
        FStar_Pervasives_Native.tuple2 Prims.list ->
        (FStar_Syntax_Syntax.term','Auu____1934) FStar_Syntax_Syntax.syntax
  =
  fun f  ->
    fun args  ->
  ...
  'Auu____1974 .
    FStar_Ident.lident ->
      ((FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
         FStar_Syntax_Syntax.syntax,FStar_Syntax_Syntax.aqual)
        FStar_Pervasives_Native.tuple2 Prims.list ->
        (FStar_Syntax_Syntax.term','Auu____1974) FStar_Syntax_Syntax.syntax
  =
  fun l  ->
    fun args  ->
      match args with
...
let set_uvar:
  'Auu____2091 .
    'Auu____2091 FStar_Syntax_Syntax.uvar_basis FStar_Unionfind.uvar ->
      'Auu____2091 -> Prims.unit
  =
  fun uv  ->
    fun t  ->
...
let is_equality:
  'Auu____3232 .
    (FStar_Ident.lident,'Auu____3232) FStar_Syntax_Syntax.withinfo_t ->
      Prims.bool
...
let mk_binop:
  'Auu____3467 .
    (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
      ...
      FStar_Syntax_Syntax.term ->
        FStar_Syntax_Syntax.term ->
          (FStar_Syntax_Syntax.term','Auu____3467) FStar_Syntax_Syntax.syntax
  =
  fun op_t  ->
    fun phi1  ->
      fun phi2  ->
          ...
          let uu____3490 =
            let uu____3491 =
              let uu____3501 =
                ...
                let uu____3504 =
                  let uu____3506 = FStar_Syntax_Syntax.as_arg phi2 in
                  [uu____3506] in
...
let mk_neg:
  'Auu____3520 .
    FStar_Syntax_Syntax.term ->
      (FStar_Syntax_Syntax.term','Auu____3520) FStar_Syntax_Syntax.syntax
  =
  fun phi  ->
    let uu____3527 =
      let uu____3530 =
...
let mk_conj:
  'Auu____3556 .
    FStar_Syntax_Syntax.term ->
      FStar_Syntax_Syntax.term ->
        (FStar_Syntax_Syntax.term','Auu____3556) FStar_Syntax_Syntax.syntax
...
let mk_disj:
  'Auu____3578 .
    FStar_Syntax_Syntax.term ->
      FStar_Syntax_Syntax.term ->
        (FStar_Syntax_Syntax.term','Auu____3578) FStar_Syntax_Syntax.syntax
...
let b2t:
  'Auu____3611 .
    FStar_Syntax_Syntax.term ->
      (FStar_Syntax_Syntax.term','Auu____3611) FStar_Syntax_Syntax.syntax
  =
  fun e  ->
    let uu____3618 =
      let uu____3621 =
...
let mk_untyped_eq2:
  'Auu____3647 .
    FStar_Syntax_Syntax.term ->
      FStar_Syntax_Syntax.term ->
        (FStar_Syntax_Syntax.term','Auu____3647) FStar_Syntax_Syntax.syntax
  =
  fun e1  ->
    fun e2  ->
      let uu____3658 =
        ...
        let uu____3662 =
          let uu____3663 =
            let uu____3673 =
              ...
              let uu____3676 =
                let uu____3678 = FStar_Syntax_Syntax.as_arg e2 in
                [uu____3678] in
...
let mk_has_type:
  'Auu____3738 .
    FStar_Syntax_Syntax.term ->
      FStar_Syntax_Syntax.term ->
        FStar_Syntax_Syntax.term ->
          (FStar_Syntax_Syntax.term','Auu____3738) FStar_Syntax_Syntax.syntax
  =
  fun t  ->
    fun x  ->
      fun t'  ->
            ...
            let uu____3766 =
              let uu____3776 =
                ...
                let uu____3779 =
                  ...
                  let uu____3782 =
                    let uu____3784 = FStar_Syntax_Syntax.as_arg t' in
                    [uu____3784] in
...
let mk_forall_aux:
  'Auu____3835 .
    (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
      ...
      FStar_Syntax_Syntax.bv ->
        FStar_Syntax_Syntax.term ->
          (FStar_Syntax_Syntax.term','Auu____3835) FStar_Syntax_Syntax.syntax
  =
  fun fa  ->
    fun x  ->
      fun body  ->
...
let rec is_wild_pat:
  'Auu____3945 .
    (FStar_Syntax_Syntax.pat','Auu____3945) FStar_Syntax_Syntax.withinfo_t ->
      Prims.bool
  =
  fun p  ->
  ...
  'Auu____3960 .
    (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
      ...
      (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
        ...
        (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
          FStar_Syntax_Syntax.syntax ->
          (FStar_Syntax_Syntax.term','Auu____3960) FStar_Syntax_Syntax.syntax
  =
  fun b  ->
    fun t1  ->
      fun t2  ->
  ...
  fun f  ->
    ...
    let destruct_base_conn f1 =
      ...
      let rec aux f2 uu____4247 =
        ...
        | (lid,arity) ->
            let uu____4253 =
              let uu____4263 = unmeta_monadic f2 in head_and_args uu____4263 in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          (pats, uu____4333)
      | uu____4340 ->
          let uu____4341 = FStar_Syntax_Subst.compress t1 in ([], uu____4341) in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____4431  ->
                      ...
                      | (t3,imp) ->
                          let uu____4438 = unascribe t3 in (uu____4438, imp))) in
    ...
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____4881
          ...
          FStar_Parser_Const.effect_Tot_lid uu____4889 in
      {
...
let mk_reify:
  'Auu____4904 .
    (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
      FStar_Syntax_Syntax.syntax ->
      (FStar_Syntax_Syntax.term','Auu____4904) FStar_Syntax_Syntax.syntax
  =
  fun t  ->
    let reify_ =
      FStar_Syntax_Syntax.mk
...
let incr_delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  -> let uu____5127 = delta_qualifier t in incr_delta_depth uu____5127
...
let rec list_elements:
  ...
  =
  fun e  ->
    let uu____5143 = let uu____5153 = unmeta e in head_and_args uu____5153 in
...
let rec apply_last:
  'Auu____5272 .
    ('Auu____5272 -> 'Auu____5272) ->
      'Auu____5272 Prims.list -> 'Auu____5272 Prims.list
  =
  fun f  ->
    fun l  ->
      match l with
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____5370 =
          let uu____5371 =
            let uu____5372 = FStar_Syntax_Syntax.iarg typ in [uu____5372] in
  ...
  fun b1  ->
    fun b2  ->
      eqprod
        ...
        b1 b2
and lcomp_eq:
  'Auu____5640 'Auu____5641 . 'Auu____5641 -> 'Auu____5640 -> Prims.bool =
  fun c1  -> fun c2  -> false
and residual_eq:
  'Auu____5652 'Auu____5653 . 'Auu____5653 -> 'Auu____5652 -> Prims.bool =
  fun r1  -> fun r2  -> false
and comp_eq:
  (FStar_Syntax_Syntax.comp',Prims.unit) FStar_Syntax_Syntax.syntax ->
    (FStar_Syntax_Syntax.comp',Prims.unit) FStar_Syntax_Syntax.syntax ->
