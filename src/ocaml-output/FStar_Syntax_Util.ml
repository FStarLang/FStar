...
let rec (univ_kernel :
  FStar_Syntax_Syntax.universe ->
    (FStar_Syntax_Syntax.universe,Prims.int)
      FStar_Pervasives_Native_Tuple2.tuple2)
  =
  fun u  ->
    match u with
...
and (eq_antiquotes :
  (FStar_Syntax_Syntax.bv,FStar_Syntax_Syntax.term'
    ...
    (FStar_Syntax_Syntax.bv,FStar_Syntax_Syntax.term'
                              FStar_Syntax_Syntax.syntax)
      FStar_Pervasives_Native_Tuple2.tuple2 Prims.list -> eq_result)
  =
  fun a1  ->
    fun a2  ->
      match (a1, a2) with
...
and (branch_matches :
  (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t,FStar_Syntax_Syntax.term'
    ...
    (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t,FStar_Syntax_Syntax.term'
                                                               ...
                                                               FStar_Pervasives_Native.option,
      FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax)
      FStar_Pervasives_Native_Tuple3.tuple3 -> eq_result)
  =
  fun b1  ->
    fun b2  ->
...
let rec (arrow_formals_comp :
  FStar_Syntax_Syntax.term ->
    ((FStar_Syntax_Syntax.bv,FStar_Syntax_Syntax.arg_qualifier
                               FStar_Pervasives_Native.option)
       FStar_Pervasives_Native_Tuple2.tuple2 Prims.list,FStar_Syntax_Syntax.comp)
      FStar_Pervasives_Native_Tuple2.tuple2)
  =
  fun k  ->
    ...
    ('a -> 'a -> Prims.bool) ->
      ('b -> 'b -> Prims.bool) ->
        ('a,'b) FStar_Pervasives_Native_Tuple2.tuple2 ->
          ('a,'b) FStar_Pervasives_Native_Tuple2.tuple2 -> Prims.bool
  =
  fun e1  ->
    fun e2  ->
      fun x  ->
