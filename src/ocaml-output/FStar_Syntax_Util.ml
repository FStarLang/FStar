                ...
                | (FStar_Pervasives_Native.Some fvs,uu____4174) ->
                    let universes =
                      FStar_All.pipe_right univ_vars
                        (FStar_List.map
                           (fun _0_19  -> FStar_Syntax_Syntax.U_name _0_19))
                       in
                    let inst1 =
...
let type_u :
  ...
  fun uu____4556  ->
    let u =
      ...
      FStar_All.pipe_left (fun _0_20  -> FStar_Syntax_Syntax.U_unif _0_20)
        uu____4562
       in
    let uu____4579 =
  ...
  fun f  ->
    ...
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____6004 =
        ...
        | (lid,arity) ->
            let uu____6013 =
              let uu____6028 = unmeta_monadic f2  in head_and_args uu____6028
               in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          (pats, uu____6129)
      | uu____6140 ->
          let uu____6141 = FStar_Syntax_Subst.compress t1  in
          ([], uu____6141)
       in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____6269  ->
                      ...
                      | (t3,imp) ->
                          let uu____6280 = unascribe t3  in (uu____6280, imp)))
               in
            (uu____6235, uu____6236)
         in
        ...
        (fun t1  ->
           ...
           | (hd1,args) ->
               ...
               (match uu____6938 with
                | (FStar_Syntax_Syntax.Tm_fvar fv,_0_21) when
                ...
                | (FStar_Syntax_Syntax.Tm_fvar fv,_0_22) when
                    (_0_22 = (Prims.parse_int "2")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_or_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.or_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_0_23) when
                    (_0_23 = (Prims.parse_int "2")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_eq2_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.eq2_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_0_24) when
                    (_0_24 = (Prims.parse_int "3")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_eq2_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.eq2_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_0_25) when
                    (_0_25 = (Prims.parse_int "2")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_eq3_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.eq3_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_0_26) when
                    (_0_26 = (Prims.parse_int "4")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_eq3_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.eq3_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_0_27) when
                    (_0_27 = (Prims.parse_int "0")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                ...
                | uu____7027 -> FStar_Pervasives_Native.None))
       in
                   ...
                   fv,(a1,uu____7313)::(a2,uu____7315)::[]) when
                    ...
                    (match uu____7350 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[],q,uu____7358) ->
                         let uu____7385 = FStar_Syntax_Subst.open_term [b] q
                            in
    ...
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7613
          ...
          FStar_Parser_Const.effect_Tot_lid uu____7623
         in
      {
  ...
  fun t  ->
    ...
    let uu____7649 =
      let uu____7652 =
        let uu____7653 =
          let uu____7668 =
            let uu____7671 = FStar_Syntax_Syntax.as_arg t  in [uu____7671]
             in
...
let incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let uu____7905 = delta_qualifier t  in incr_delta_depth uu____7905
...
let rec list_elements :
  ...
  =
  fun e  ->
    let uu____7927 = let uu____7942 = unmeta e  in head_and_args uu____7942
       in
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____8219 =
          let uu____8220 =
            let uu____8221 = FStar_Syntax_Syntax.iarg typ  in [uu____8221]
             in
...
let rec sizeof : FStar_Syntax_Syntax.term -> Prims.int =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_delayed uu____9448 ->
        let uu____9473 =
          let uu____9474 = FStar_Syntax_Subst.compress t  in
          sizeof uu____9474  in
            ...
            (fun acc  ->
               fun uu____9521  ->
                 ...
                 | (bv,uu____9527) ->
                     ...
                     acc + uu____9528) (Prims.parse_int "0") bs
           in
