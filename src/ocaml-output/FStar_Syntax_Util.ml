...
let comp_set_flags:
  ...
  fun c  ->
    fun f  ->
      ...
      let uu___176_1084 = c in
      let uu____1085 =
        let uu____1086 =
          let uu___177_1087 = comp_to_comp_typ c in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___177_1087.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___177_1087.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___177_1087.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___177_1087.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          } in
        FStar_Syntax_Syntax.Comp uu____1086 in
      {
        FStar_Syntax_Syntax.n = uu____1085;
        FStar_Syntax_Syntax.pos = (uu___176_1084.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___176_1084.FStar_Syntax_Syntax.vars)
      }
...
let set_result_typ:
  ...
  fun c  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___178_1735 = ct in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___178_1735.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___178_1735.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___178_1735.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___178_1735.FStar_Syntax_Syntax.flags)
             })
let is_trivial_wp:
  FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax -> Prims.bool =
  fun c  ->
...
let rec eq_tm:
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___173_1997 = if uu___173_1997 then Equal else Unknown in
      let equal_iff uu___174_2002 = if uu___174_2002 then Equal else NotEqual in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___179_3145 = x in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___179_3145.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___179_3145.FStar_Syntax_Syntax.sort)
          } in
      ...
      fun lopt  ->
        let close_lopt lopt1 =
          ...
          | FStar_Pervasives_Native.Some rc ->
              let uu____3262 =
                let uu___180_3263 = rc in
                let uu____3264 =
                  FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                    (FStar_Syntax_Subst.close bs) in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___180_3263.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____3264;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___180_3263.FStar_Syntax_Syntax.residual_flags)
                } in
...
let abs_formals:
  ...
  fun t  ->
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____3807 =
            let uu___181_3808 = rc in
            let uu____3809 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (FStar_Syntax_Subst.subst s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___181_3808.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____3809;
              FStar_Syntax_Syntax.residual_flags =
                (uu___181_3808.FStar_Syntax_Syntax.residual_flags)
            } in
      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____8746 ->
            ...
            (match uu____8761 with
             | (hd1,args) ->
                 let uu___182_8794 = t in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___182_8794.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___182_8794.FStar_Syntax_Syntax.vars)
                 })
        | uu____8805 -> t in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____9487 -> tn in
      f
        (let uu___183_9490 = t in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___183_9490.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___183_9490.FStar_Syntax_Syntax.vars)
         })
