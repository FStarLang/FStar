      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____8746 ->
            ...
            (match uu____8761 with
             | (hd1,args) ->
                 let uu___79_8794 = t in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___79_8794.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___79_8794.FStar_Syntax_Syntax.vars)
                 })
        | uu____8805 -> t in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____9487 -> tn in
      f
        (let uu___80_9490 = t in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___80_9490.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars = (uu___80_9490.FStar_Syntax_Syntax.vars)
         })
...
let un_alien: FStar_Syntax_Syntax.term -> FStar_Dyn.dyn =
  fun t  ->
    ...
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_meta
        (uu____9690,FStar_Syntax_Syntax.Meta_alien
         (blob,uu____9692,uu____9693))
        -> blob
    | uu____9702 -> failwith "unexpected: term was not an alien embedding"