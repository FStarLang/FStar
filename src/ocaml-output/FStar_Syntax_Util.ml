...
let uu___175_637 = (comp_to_comp_typ c)
in {FStar_Syntax_Syntax.comp_univs = uu___175_637.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___175_637.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu___175_637.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___175_637.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = f})
in FStar_Syntax_Syntax.Comp (uu____636))
in {FStar_Syntax_Syntax.n = uu____635; FStar_Syntax_Syntax.tk = uu___174_634.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___174_634.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___174_634.FStar_Syntax_Syntax.vars}))))
...
let is_total_comp = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___162_699 -> (match (uu___162_699) with
...
let is_total_lcomp : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun c -> ((FStar_Ident.lid_equals c.FStar_Syntax_Syntax.eff_name FStar_Syntax_Const.effect_Tot_lid) || (FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___163_705 -> (match (uu___163_705) with
| (FStar_Syntax_Syntax.TOTAL) | (FStar_Syntax_Syntax.RETURN) -> begin
true
end
| uu____706 -> begin
...
let is_partial_return = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___165_725 -> (match (uu___165_725) with
...
let is_lcomp_partial_return : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun c -> (FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___166_731 -> (match (uu___166_731) with
| (FStar_Syntax_Syntax.RETURN) | (FStar_Syntax_Syntax.PARTIAL_RETURN) -> begin
true
end
| uu____732 -> begin
...
| FStar_Syntax_Syntax.Comp (ct) -> begin
(((is_total_comp c) || (is_pure_effect ct.FStar_Syntax_Syntax.effect_name)) || (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___167_772 -> (match (uu___167_772) with
...
let is_pure_lcomp : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun lc -> (((is_total_lcomp lc) || (is_pure_effect lc.FStar_Syntax_Syntax.eff_name)) || (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___168_792 -> (match (uu___168_792) with
| FStar_Syntax_Syntax.LEMMA -> begin
true
end
| uu____793 -> begin
...
| FStar_Syntax_Syntax.Comp (c) -> begin
((FStar_Ident.lid_equals c.FStar_Syntax_Syntax.effect_name FStar_Syntax_Const.effect_ML_lid) || (FStar_All.pipe_right c.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___169_1013 -> (match (uu___169_1013) with
...
let uu___176_1072 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___176_1072.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___176_1072.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = t; FStar_Syntax_Syntax.effect_args = uu___176_1072.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___176_1072.FStar_Syntax_Syntax.flags}))
end))


let is_trivial_wp = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___170_1085 -> (match (uu___170_1085) with
| (FStar_Syntax_Syntax.TOTAL) | (FStar_Syntax_Syntax.RETURN) -> begin
true
end
| uu____1086 -> begin
...
let equal_if = (fun uu___171_1231 -> (match (uu___171_1231) with
| true -> begin
Equal
end
| uu____1232 -> begin
...
let equal_iff = (fun uu___172_1236 -> (match (uu___172_1236) with
| true -> begin
Equal
end
| uu____1237 -> begin
...
let range_of_lb = (fun uu___173_1924 -> (match (uu___173_1924) with
...
let uu___177_2161 = x
in {FStar_Syntax_Syntax.ppname = nm; FStar_Syntax_Syntax.index = uu___177_2161.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___177_2161.FStar_Syntax_Syntax.sort})
in (
...
in {FStar_Syntax_Syntax.eff_name = uu___178_2831.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____2832; FStar_Syntax_Syntax.cflags = uu___178_2831.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____2835 -> (
...
let uu____3759 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (
...
let uu____3776 = (FStar_Syntax_Syntax.as_arg e1)
in (

let uu____3777 = (

let uu____3779 = (FStar_Syntax_Syntax.as_arg e2)
in (uu____3779)::[])
in (uu____3776)::uu____3777))
in ((teq), (uu____3774)))
in FStar_Syntax_Syntax.Tm_app (uu____3764))
in (FStar_Syntax_Syntax.mk uu____3763))
in (uu____3760 None uu____3759))))
...
let uu____3802 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (
...
let uu____3819 = (FStar_Syntax_Syntax.iarg t)
in (

let uu____3820 = (

let uu____3822 = (FStar_Syntax_Syntax.as_arg e1)
in (

let uu____3823 = (

let uu____3825 = (FStar_Syntax_Syntax.as_arg e2)
in (uu____3825)::[])
in (uu____3822)::uu____3823))
in (uu____3819)::uu____3820))
in ((eq_inst), (uu____3817)))
in FStar_Syntax_Syntax.Tm_app (uu____3807))
in (FStar_Syntax_Syntax.mk uu____3806))
in (uu____3803 None uu____3802)))))
...
let uu____3882 = (FStar_Syntax_Syntax.as_arg x)
in (

let uu____3883 = (

let uu____3885 = (FStar_Syntax_Syntax.as_arg t')
in (uu____3885)::[])
in (uu____3882)::uu____3883))
in (uu____3879)::uu____3880))
in ((t_has_type), (uu____3877)))
in FStar_Syntax_Syntax.Tm_app (uu____3867))
in (FStar_Syntax_Syntax.mk uu____3866))
in (uu____3863 None FStar_Range.dummyRange)))))
...
let uu____3904 = (match (c0.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (uu____3911) -> begin
((FStar_Syntax_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[]))
end
| FStar_Syntax_Syntax.GTotal (uu____3918) -> begin
...
{FStar_Syntax_Syntax.eff_name = eff_name; FStar_Syntax_Syntax.res_typ = (comp_result c0); FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = (fun uu____3931 -> c0)}
end)))
...
let uu____3954 = (FStar_Syntax_Syntax.iarg x.FStar_Syntax_Syntax.sort)
in (
...
let uu____3978 = (FStar_Syntax_Syntax.mk_Total ktype0)
in (FStar_All.pipe_left lcomp_of_comp uu____3978))
in FStar_Util.Inl (uu____3977))
in Some (uu____3971))
in (abs uu____3959 body uu____3964)))
in (FStar_Syntax_Syntax.as_arg uu____3958))
in (uu____3957)::[])
in (uu____3954)::uu____3955))
in ((tforall), (uu____3952)))
in FStar_Syntax_Syntax.Tm_app (uu____3942))
in (FStar_Syntax_Syntax.mk uu____3941))
in (uu____3938 None FStar_Range.dummyRange)))
...
let uu____4010 = (FStar_Syntax_Syntax.is_null_binder b)
...
| FStar_Syntax_Syntax.Pat_wild (uu____4023) -> begin
true
end
| uu____4024 -> begin
false
...
let uu____4067 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t1.FStar_Syntax_Syntax.pos)
in ((uu____4067), (None), (t1)))
in (

let else_branch = (

let uu____4090 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (false))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Syntax_Syntax.pos)
in ((uu____4090), (None), (t2)))
in (

let uu____4102 = (

let uu____4103 = (FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos t2.FStar_Syntax_Syntax.pos)
in (FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos uu____4103))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (((b), ((then_branch)::(else_branch)::[])))) None uu____4102)))))
...
let rec aux = (fun f uu____4303 -> (match (uu____4303) with
| (lid, arity) -> begin
(

let uu____4309 = (

let uu____4319 = (unmeta_monadic f)
in (head_and_args uu____4319))
...
let uu____4338 = ((is_constructor t lid) && ((FStar_List.length args) = arity))
...
let uu____4389 = (FStar_Syntax_Subst.compress t)
in ((pats), (uu____4389)))
end
| uu____4396 -> begin
(
...
let uu____4439 = (head_and_args t)
in (match (uu____4439) with
| (t, args) -> begin
(

let uu____4470 = (un_uinst t)
in (

let uu____4471 = (FStar_All.pipe_right args (FStar_List.map (fun uu____4487 -> (match (uu____4487) with
| (t, imp) -> begin
(

let uu____4494 = (unascribe t)
in ((uu____4494), (imp)))
end))))
in ((uu____4470), (uu____4471))))
end)))
in (
...
| (Some (b), uu____4785) -> begin
(

let bs = (FStar_List.rev out)
in (

let uu____4803 = (FStar_Syntax_Subst.open_term bs t)
in (match (uu____4803) with
| (bs, t) -> begin
(

let uu____4809 = (patterns t)
in (match (uu____4809) with
| (pats, body) -> begin
(match (b) with
| true -> begin
...
let uu____4859 = (destruct_base_conn phi)
...
let uu____4873 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.Delta_equational None)
in FStar_Util.Inr (uu____4873))
in (close_univs_and_mk_letbinding None uu____4870 a.FStar_Syntax_Syntax.action_univs a.FStar_Syntax_Syntax.action_typ FStar_Syntax_Const.effect_Tot_lid a.FStar_Syntax_Syntax.action_defn))
...
let uu____4918 = (FStar_Syntax_Syntax.as_arg t)
in (uu____4918)::[])
in ((reify_), (uu____4916)))
in FStar_Syntax_Syntax.Tm_app (uu____4906))
in (FStar_Syntax_Syntax.mk uu____4905))
in (uu____4902 None t.FStar_Syntax_Syntax.pos))))
...
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____4934) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
let uu____5041 = (FStar_Syntax_Subst.compress t)
in uu____5041.FStar_Syntax_Syntax.n)
...
let uu____5062 = (unmeta e)
in (head_and_args uu____5062))
...
let uu____5090 = (un_uinst head)
in uu____5090.FStar_Syntax_Syntax.n)
in ((uu____5089), (args)))
in (match (uu____5081) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____5101) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.nil_lid) -> begin
Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____5114)::((hd, uu____5116))::((tl, uu____5118))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.cons_lid) -> begin
(
...
let uu____5160 = (list_elements tl)
in (FStar_Util.must uu____5160))
in (hd)::uu____5156)
in Some (uu____5152))
end
| uu____5169 -> begin
