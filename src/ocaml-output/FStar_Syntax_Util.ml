...
let lcomp_of_comp:
  ...
  fun c0  ->
    let uu____3483 =
      ...
      | FStar_Syntax_Syntax.Total uu____3490 ->
          (FStar_Syntax_Const.effect_Tot_lid, [FStar_Syntax_Syntax.TOTAL])
      | FStar_Syntax_Syntax.GTotal uu____3497 ->
          (FStar_Syntax_Const.effect_GTot_lid,
    ...
    | (eff_name,flags) ->
        {
          ...
          FStar_Syntax_Syntax.comp = ((fun uu____3510  -> c0))
        }
let mk_forall:
  FStar_Syntax_Syntax.bv ->
                        ...
                        Some
                          (FStar_Util.Inl
                             (let _0_282 =
                              ...
                              FStar_All.pipe_left lcomp_of_comp _0_282)) in
                      abs _0_284 body _0_283) in
                 [_0_285] in
               _0_287 :: _0_286 in
      ...
      FStar_List.fold_right
        (fun b  ->
           fun f  ->
             ...
             if uu____3546 then f else mk_forall (Prims.fst b) f) bs f
...
let destruct_typ_as_formula:
  ...
  fun f  ->
        ...
        | (lid,arity) ->
            ...
            (match uu____3837 with
             | (t,args) ->
                 ...
                 if uu____3865 then Some (BaseConn (lid, args)) else None) in
    ...
    let patterns t =
      ...
      | uu____3922 ->
          let _0_294 = FStar_Syntax_Subst.compress t in ([], _0_294) in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____4010  ->
                      ...
                      | (t,imp) -> let _0_295 = unascribe t in (_0_295, imp))) in
            (_0_297, _0_296) in
...
let mk_reify t =
  ...
  (FStar_Syntax_Syntax.mk
     (FStar_Syntax_Syntax.Tm_app
        (let _0_301 = let _0_300 = FStar_Syntax_Syntax.as_arg t in [_0_300] in
...
let is_unknown: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____4532 = (FStar_Syntax_Subst.compress t).FStar_Syntax_Syntax.n in
    ...
    | (head,args) ->
        ...
        (match uu____4569 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____4598::(hd,uu____4600)::(tl,uu____4602)::[]) when
