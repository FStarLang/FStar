...
let type_u : Prims.unit  ->  (FStar_Syntax_Syntax.typ * FStar_Syntax_Syntax.universe) = (fun uu____4628 -> (

let u = (

let uu____4634 = (FStar_Syntax_Unionfind.univ_fresh ())
in (FStar_All.pipe_left (fun _0_29 -> FStar_Syntax_Syntax.U_unif (_0_29)) uu____4634))
in (

let uu____4651 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (u)) FStar_Pervasives_Native.None FStar_Range.dummyRange)
in ((uu____4651), (u)))))
...
let uu____4663 = (FStar_Ident.lid_of_path (("FStar")::("Pervasives")::("Substitute")::[]) FStar_Range.dummyRange)
in (FStar_Syntax_Syntax.lid_as_fv uu____4663 FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None))
in FStar_Syntax_Syntax.Tm_fvar (uu____4662))
in (FStar_Syntax_Syntax.mk uu____4661))
in (uu____4658 FStar_Pervasives_Native.None FStar_Range.dummyRange))
...
let uu____4715 = (FStar_Range.union_ranges phi11.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (
...
let uu____4738 = (FStar_Syntax_Syntax.as_arg phi11)
in (

let uu____4739 = (

let uu____4742 = (FStar_Syntax_Syntax.as_arg phi2)
in (uu____4742)::[])
in (uu____4738)::uu____4739))
in ((tand), (uu____4735)))
in FStar_Syntax_Syntax.Tm_app (uu____4720))
in (FStar_Syntax_Syntax.mk uu____4719))
in (uu____4716 FStar_Pervasives_Native.None uu____4715)))
...
let uu____4768 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (
...
let uu____4791 = (FStar_Syntax_Syntax.as_arg phi1)
in (

let uu____4792 = (

let uu____4795 = (FStar_Syntax_Syntax.as_arg phi2)
in (uu____4795)::[])
in (uu____4791)::uu____4792))
in ((op_t), (uu____4788)))
in FStar_Syntax_Syntax.Tm_app (uu____4773))
in (FStar_Syntax_Syntax.mk uu____4772))
in (uu____4769 FStar_Pervasives_Native.None uu____4768))))
...
let uu____4831 = (FStar_Syntax_Syntax.as_arg phi)
in (uu____4831)::[])
in ((t_not), (uu____4828)))
in FStar_Syntax_Syntax.Tm_app (uu____4813))
in (FStar_Syntax_Syntax.mk uu____4812))
in (uu____4809 FStar_Pervasives_Native.None phi.FStar_Syntax_Syntax.pos)))
...
let uu____4925 = (FStar_Syntax_Syntax.as_arg e)
in (uu____4925)::[])
in ((b2t_v), (uu____4922)))
in FStar_Syntax_Syntax.Tm_app (uu____4907))
in (FStar_Syntax_Syntax.mk uu____4906))
in (uu____4903 FStar_Pervasives_Native.None e.FStar_Syntax_Syntax.pos)))
...
let uu____4941 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (
...
let uu____4964 = (FStar_Syntax_Syntax.as_arg e1)
in (

let uu____4965 = (

let uu____4968 = (FStar_Syntax_Syntax.as_arg e2)
in (uu____4968)::[])
in (uu____4964)::uu____4965))
in ((teq), (uu____4961)))
in FStar_Syntax_Syntax.Tm_app (uu____4946))
in (FStar_Syntax_Syntax.mk uu____4945))
in (uu____4942 FStar_Pervasives_Native.None uu____4941))))
...
let uu____4991 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (
...
let uu____5014 = (FStar_Syntax_Syntax.iarg t)
in (

let uu____5015 = (

let uu____5018 = (FStar_Syntax_Syntax.as_arg e1)
in (

let uu____5019 = (

let uu____5022 = (FStar_Syntax_Syntax.as_arg e2)
in (uu____5022)::[])
in (uu____5018)::uu____5019))
in (uu____5014)::uu____5015))
in ((eq_inst), (uu____5011)))
in FStar_Syntax_Syntax.Tm_app (uu____4996))
in (FStar_Syntax_Syntax.mk uu____4995))
in (uu____4992 FStar_Pervasives_Native.None uu____4991)))))
...
let uu____5070 = (FStar_Syntax_Syntax.iarg t)
in (

let uu____5071 = (

let uu____5074 = (FStar_Syntax_Syntax.as_arg x)
in (

let uu____5075 = (

let uu____5078 = (FStar_Syntax_Syntax.as_arg t')
in (uu____5078)::[])
in (uu____5074)::uu____5075))
in (uu____5070)::uu____5071))
in ((t_has_type1), (uu____5067)))
in FStar_Syntax_Syntax.Tm_app (uu____5052))
in (FStar_Syntax_Syntax.mk uu____5051))
in (uu____5048 FStar_Pervasives_Native.None FStar_Range.dummyRange)))))
...
let uu____5099 = (FStar_Syntax_Syntax.fvar FStar_Parser_Const.lextop_lid FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in ((uu____5099), ((FStar_Syntax_Syntax.U_zero)::[])))
in FStar_Syntax_Syntax.Tm_uinst (uu____5092))
in (FStar_Syntax_Syntax.mk uu____5091))
in (uu____5088 FStar_Pervasives_Native.None FStar_Range.dummyRange))
...
let uu____5113 = (match (c0.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (uu____5126) -> begin
((FStar_Parser_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[]))
end
| FStar_Syntax_Syntax.GTotal (uu____5137) -> begin
...
{FStar_Syntax_Syntax.eff_name = eff_name; FStar_Syntax_Syntax.res_typ = (comp_result c0); FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = (fun uu____5158 -> c0)}
end)))
...
let uu____5245 = (FStar_Syntax_Syntax.iarg x.FStar_Syntax_Syntax.sort)
in (
...
let uu____5252 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____5252)::[])
in (abs uu____5251 body (FStar_Pervasives_Native.Some ((residual_tot ktype0)))))
in (FStar_Syntax_Syntax.as_arg uu____5250))
in (uu____5249)::[])
in (uu____5245)::uu____5246))
in ((fa), (uu____5242)))
in FStar_Syntax_Syntax.Tm_app (uu____5227))
in (FStar_Syntax_Syntax.mk uu____5226))
in (uu____5223 FStar_Pervasives_Native.None FStar_Range.dummyRange)))
...
let uu____5298 = (FStar_Syntax_Syntax.is_null_binder b)
in (match (uu____5298) with
| true -> begin
f1
end
| uu____5299 -> begin
...
| FStar_Syntax_Syntax.Pat_wild (uu____5308) -> begin
true
end
| uu____5309 -> begin
false
...
let uu____5351 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) t1.FStar_Syntax_Syntax.pos)
in ((uu____5351), (FStar_Pervasives_Native.None), (t1)))
in (

let else_branch = (

let uu____5379 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (false))) t2.FStar_Syntax_Syntax.pos)
in ((uu____5379), (FStar_Pervasives_Native.None), (t2)))
in (

let uu____5392 = (

let uu____5393 = (FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos t2.FStar_Syntax_Syntax.pos)
in (FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos uu____5393))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (((b), ((then_branch)::(else_branch)::[])))) FStar_Pervasives_Native.None uu____5392)))))
...
let uu____5461 = (FStar_Syntax_Syntax.mk_Tm_uinst sq ((FStar_Syntax_Syntax.U_zero)::[]))
in (

let uu____5464 = (

let uu____5473 = (FStar_Syntax_Syntax.as_arg p)
in (uu____5473)::[])
in (mk_app uu____5461 uu____5464)))))
...
let uu____5482 = (head_and_args t)
...
let uu____5537 = (un_uinst head1)
in uu____5537.FStar_Syntax_Syntax.n)
in ((uu____5536), (args)))
in (match (uu____5523) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((p, uu____5554))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid) -> begin
...
let uu____5612 = (FStar_Syntax_Syntax.mk_binder b)
in (uu____5612)::[])
in (FStar_Syntax_Subst.open_term uu____5611 p))
...
let uu____5647 = (FStar_Syntax_Free.names p1)
in (FStar_Util.set_mem (FStar_Pervasives_Native.fst b1) uu____5647))
...
let uu____5705 = (FStar_Syntax_Subst.compress t)
...
let uu____5824 = (arrow bs c)
in (FStar_Syntax_Syntax.mk_Total uu____5824))
in ((b), (uu____5823)))
in FStar_Pervasives_Native.Some (uu____5814))
end
| uu____5837 -> begin
FStar_Pervasives_Native.None
end))
in (FStar_Util.bind_opt uu____5691 (fun uu____5873 -> (match (uu____5873) with
| (b, c) -> begin
(

let uu____5908 = (FStar_Syntax_Subst.open_comp ((b)::[]) c)
...
let uu____5980 = (FStar_Syntax_Free.names t)
in (FStar_Util.set_mem bv uu____5980)))
...
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic (uu____6133)) -> begin
(unmeta_monadic t)
end
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic_lift (uu____6145)) -> begin
(unmeta_monadic t)
end
| uu____6158 -> begin
f2
...
let aux = (fun f2 uu____6236 -> (match (uu____6236) with
| (lid, arity) -> begin
(

let uu____6245 = (

let uu____6260 = (unmeta_monadic f2)
in (head_and_args uu____6260))
...
let uu____6286 = ((is_constructor t1 lid) && (Prims.op_Equality (FStar_List.length args) arity))
...
let uu____6361 = (FStar_Syntax_Subst.compress t2)
in ((pats), (uu____6361)))
end
| uu____6372 -> begin
(

let uu____6373 = (FStar_Syntax_Subst.compress t1)
in (([]), (uu____6373)))
end)))
in (
...
let uu____6420 = (head_and_args t1)
in (match (uu____6420) with
| (t2, args) -> begin
(

let uu____6467 = (un_uinst t2)
in (

let uu____6468 = (FStar_All.pipe_right args (FStar_List.map (fun uu____6501 -> (match (uu____6501) with
| (t3, imp) -> begin
(

let uu____6512 = (unascribe t3)
in ((uu____6512), (imp)))
end))))
...
let uu____6564 = (flat t1)
in ((qopt), (uu____6564)))
in (match (uu____6547) with
| (FStar_Pervasives_Native.Some (fa), ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6591; FStar_Syntax_Syntax.vars = uu____6592}, (({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6595); FStar_Syntax_Syntax.pos = uu____6596; FStar_Syntax_Syntax.vars = uu____6597}, uu____6598))::[])) when (is_q fa tc) -> begin
(aux qopt ((b)::out) t2)
end
| (FStar_Pervasives_Native.Some (fa), ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6675; FStar_Syntax_Syntax.vars = uu____6676}, (uu____6677)::(({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6680); FStar_Syntax_Syntax.pos = uu____6681; FStar_Syntax_Syntax.vars = uu____6682}, uu____6683))::[])) when (is_q fa tc) -> begin
(aux qopt ((b)::out) t2)
end
| (FStar_Pervasives_Native.None, ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6771; FStar_Syntax_Syntax.vars = uu____6772}, (({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6775); FStar_Syntax_Syntax.pos = uu____6776; FStar_Syntax_Syntax.vars = uu____6777}, uu____6778))::[])) when (is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v) -> begin
(aux (FStar_Pervasives_Native.Some ((is_forall tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v))) ((b)::out) t2)
end
| (FStar_Pervasives_Native.None, ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6854; FStar_Syntax_Syntax.vars = uu____6855}, (uu____6856)::(({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6859); FStar_Syntax_Syntax.pos = uu____6860; FStar_Syntax_Syntax.vars = uu____6861}, uu____6862))::[])) when (is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v) -> begin
(aux (FStar_Pervasives_Native.Some ((is_forall tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v))) ((b)::out) t2)
end
| (FStar_Pervasives_Native.Some (b), uu____6950) -> begin
(

let bs = (FStar_List.rev out)
in (

let uu____6984 = (FStar_Syntax_Subst.open_term bs t1)
in (match (uu____6984) with
| (bs1, t2) -> begin
(

let uu____6993 = (patterns t2)
...
let uu____7121 = (un_squash t)
in (FStar_Util.bind_opt uu____7121 (fun t1 -> (

let uu____7137 = (head_and_args' t1)
...
let uu____7176 = (un_uinst hd1)
in uu____7176.FStar_Syntax_Syntax.n)
in ((uu____7175), ((FStar_List.length args))))
...
let uu____7282 = (un_squash t)
in (FStar_Util.bind_opt uu____7282 (fun t1 -> (

let uu____7297 = (arrow_one t1)
...
let uu____7313 = (is_tot_or_gtot_comp c)
in (not (uu____7313)))
...
let uu____7320 = (comp_to_comp_typ c)
in uu____7320.FStar_Syntax_Syntax.result_typ)
in (

let uu____7321 = (FStar_Syntax_Subst.open_term ((b)::[]) q)
...
let uu____7357 = (is_free_in (FStar_Pervasives_Native.fst b1) q1)
in (match (uu____7357) with
| true -> begin
(

let uu____7360 = (patterns q1)
...
let uu____7437 = (FStar_Syntax_Syntax.as_arg (FStar_Pervasives_Native.fst b1).FStar_Syntax_Syntax.sort)
in (

let uu____7438 = (

let uu____7441 = (FStar_Syntax_Syntax.as_arg q1)
in (uu____7441)::[])
in (uu____7437)::uu____7438))
in ((FStar_Parser_Const.imp_lid), (uu____7434)))
in BaseConn (uu____7429))
...
let uu____7452 = (un_squash t)
in (FStar_Util.bind_opt uu____7452 (fun t1 -> (

let uu____7483 = (head_and_args' t1)
...
let uu____7530 = (un_uinst hd1)
in uu____7530.FStar_Syntax_Syntax.n)
in ((uu____7529), (args)))
in (match (uu____7516) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((a1, uu____7545))::((a2, uu____7547))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.dtuple2_lid) -> begin
(

let uu____7582 = (

let uu____7583 = (FStar_Syntax_Subst.compress a2)
in uu____7583.FStar_Syntax_Syntax.n)
in (match (uu____7582) with
| FStar_Syntax_Syntax.Tm_abs ((b)::[], q, uu____7590) -> begin
(

let uu____7617 = (FStar_Syntax_Subst.open_term ((b)::[]) q)
...
let uu____7750 = (destruct_sq_forall phi)
...
let uu____7778 = (destruct_sq_exists phi)
...
let uu____7807 = (destruct_base_conn phi)
in (FStar_Util.catch_opt uu____7807 (fun uu____7812 -> (

let uu____7813 = (destruct_q_conn phi)
in (FStar_Util.catch_opt uu____7813 (fun uu____7818 -> (

let uu____7819 = (destruct_sq_base_conn phi)
in (FStar_Util.catch_opt uu____7819 (fun uu____7824 -> (

let uu____7825 = (destruct_sq_forall phi)
in (FStar_Util.catch_opt uu____7825 (fun uu____7830 -> (

let uu____7831 = (destruct_sq_exists phi)
in (FStar_Util.catch_opt uu____7831 (fun uu____7835 -> FStar_Pervasives_Native.None))))))))))))))))))))))))
...
let uu____7850 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.Delta_equational FStar_Pervasives_Native.None)
in FStar_Util.Inr (uu____7850))
in (

let uu____7851 = (

let uu____7852 = (FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ)
in (arrow a.FStar_Syntax_Syntax.action_params uu____7852))
in (

let uu____7855 = (abs a.FStar_Syntax_Syntax.action_params a.FStar_Syntax_Syntax.action_defn FStar_Pervasives_Native.None)
in (close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7845 a.FStar_Syntax_Syntax.action_univs uu____7851 FStar_Parser_Const.effect_Tot_lid uu____7855))))
...
let uu____7903 = (FStar_Syntax_Syntax.as_arg t)
in (uu____7903)::[])
in ((reify_), (uu____7900)))
in FStar_Syntax_Syntax.Tm_app (uu____7885))
in (FStar_Syntax_Syntax.mk uu____7884))
in (uu____7881 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos))))
...
let t1 = (FStar_Syntax_Subst.compress t)
in (match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____7916) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
fv.FStar_Syntax_Syntax.fv_delta
end
| FStar_Syntax_Syntax.Tm_bvar (uu____7942) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_name (uu____7943) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_match (uu____7944) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_uvar (uu____7967) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_type (uu____7984) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_constant (uu____7985) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_arrow (uu____7986) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_uinst (t2, uu____8000) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_refine ({FStar_Syntax_Syntax.ppname = uu____8005; FStar_Syntax_Syntax.index = uu____8006; FStar_Syntax_Syntax.sort = t2}, uu____8008) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_meta (t2, uu____8016) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_ascribed (t2, uu____8022, uu____8023) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_app (t2, uu____8065) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_abs (uu____8086, t2, uu____8088) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_let (uu____8109, t2) -> begin
(delta_qualifier t2)
end)))
...
let uu____8137 = (delta_qualifier t)
in (incr_delta_depth uu____8137)))
...
let uu____8143 = (FStar_Syntax_Subst.compress t)
in uu____8143.FStar_Syntax_Syntax.n)
...
let uu____8174 = (unmeta e)
in (head_and_args uu____8174))
...
let uu____8215 = (un_uinst head1)
in uu____8215.FStar_Syntax_Syntax.n)
in ((uu____8214), (args)))
in (match (uu____8201) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____8231) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid) -> begin
FStar_Pervasives_Native.Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____8251)::((hd1, uu____8253))::((tl1, uu____8255))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid) -> begin
(
...
let uu____8312 = (list_elements tl1)
in (FStar_Util.must uu____8312))
in (hd1)::uu____8307)
in FStar_Pervasives_Native.Some (uu____8302))
end
| uu____8325 -> begin
FStar_Pervasives_Native.None
end))
...
let rec apply_last : 'Auu____8346 . ('Auu____8346  ->  'Auu____8346)  ->  'Auu____8346 Prims.list  ->  'Auu____8346 Prims.list = (fun f l -> (match (l) with
| [] -> begin
...
let uu____8374 = (apply_last f xs)
in (x)::uu____8374)
end))
...
let uu____8419 = (FStar_Syntax_Syntax.lid_as_fv l1 FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in FStar_Syntax_Syntax.Tm_fvar (uu____8419))
in (FStar_Syntax_Syntax.mk uu____8418))
in (uu____8415 FStar_Pervasives_Native.None rng)))
in (
...
let uu____8434 = (ctor FStar_Parser_Const.cons_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____8434 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____8433 args))
in (uu____8432 FStar_Pervasives_Native.None pos)))
in (
...
let uu____8448 = (ctor FStar_Parser_Const.nil_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____8448 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____8447 args))
in (uu____8446 FStar_Pervasives_Native.None pos)))
in (
...
let uu____8453 = (FStar_Syntax_Syntax.iarg typ)
in (uu____8453)::[])
in (nil uu____8452 rng))
in (FStar_List.fold_right (fun t a -> (

let uu____8459 = (

let uu____8460 = (FStar_Syntax_Syntax.iarg typ)
in (

let uu____8461 = (

let uu____8464 = (FStar_Syntax_Syntax.as_arg t)
in (

let uu____8465 = (

let uu____8468 = (FStar_Syntax_Syntax.as_arg a)
in (uu____8468)::[])
in (uu____8464)::uu____8465))
in (uu____8460)::uu____8461))
in (cons1 uu____8459 t.FStar_Syntax_Syntax.pos))) l uu____8451))))))
...
let uu____8500 = (FStar_Syntax_Unionfind.from_id id)
in ((uu____8500), (t)))
in FStar_Syntax_Syntax.Tm_uvar (uu____8483))
in (FStar_Syntax_Syntax.mk uu____8482))
in (uu____8479 FStar_Pervasives_Native.None FStar_Range.dummyRange)))
...
| FStar_Syntax_Syntax.Tm_app (uu____8925) -> begin
(

let uu____8940 = (head_and_args' t)
in (match (uu____8940) with
| (hd1, args) -> begin
(

let uu___175_8973 = t
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app (((hd1), (args))); FStar_Syntax_Syntax.pos = uu___175_8973.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___175_8973.FStar_Syntax_Syntax.vars})
end))
end
| uu____8984 -> begin
t
...
let uu____8988 = (unmeta_safe t1)
in (canon_app uu____8988))
in (

let t21 = (

let uu____8994 = (unmeta_safe t2)
in (canon_app uu____8994))
in (match (((t11.FStar_Syntax_Syntax.n), (t21.FStar_Syntax_Syntax.n))) with
...
let uu____9506 = (FStar_Syntax_Subst.compress t)
in uu____9506.FStar_Syntax_Syntax.n)
in (
...
let uu____9547 = (ff f1)
in (

let uu____9548 = (FStar_List.map (fun uu____9567 -> (match (uu____9567) with
| (a, q) -> begin
(
...
in FStar_Syntax_Syntax.Tm_app (uu____9532))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, k) -> begin
(

let uu____9608 = (FStar_Syntax_Subst.open_term bs t1)
...
let uu____9633 = (FStar_Syntax_Subst.close bs1 t'')
in ((bs1), (uu____9633), (k)))
in FStar_Syntax_Syntax.Tm_abs (uu____9616)))
end))
end
...
let uu____9667 = (ff t1)
in ((uu____9667), (us)))
in FStar_Syntax_Syntax.Tm_uinst (uu____9660))
end
| uu____9668 -> begin
tn
end)
...
let uu___176_9671 = t
in {FStar_Syntax_Syntax.n = tn1; FStar_Syntax_Syntax.pos = uu___176_9671.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___176_9671.FStar_Syntax_Syntax.vars}))))))


let rec sizeof : FStar_Syntax_Syntax.term  ->  Prims.int = (fun t -> (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____9676) -> begin
(

let uu____9701 = (

let uu____9702 = (FStar_Syntax_Subst.compress t)
in (sizeof uu____9702))
in ((Prims.parse_int "1") + uu____9701))
end
| FStar_Syntax_Syntax.Tm_bvar (bv) -> begin
(

let uu____9704 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____9704))
end
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
(

let uu____9706 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____9706))
end
| FStar_Syntax_Syntax.Tm_uinst (t1, us) -> begin
(

let uu____9713 = (sizeof t1)
in ((FStar_List.length us) + uu____9713))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, uu____9716) -> begin
(

let uu____9737 = (sizeof t1)
in (

let uu____9738 = (FStar_List.fold_left (fun acc uu____9749 -> (match (uu____9749) with
| (bv, uu____9755) -> begin
(

let uu____9756 = (sizeof bv.FStar_Syntax_Syntax.sort)
in (acc + uu____9756))
end)) (Prims.parse_int "0") bs)
in (uu____9737 + uu____9738)))
end
| FStar_Syntax_Syntax.Tm_app (hd1, args) -> begin
(

let uu____9779 = (sizeof hd1)
in (

let uu____9780 = (FStar_List.fold_left (fun acc uu____9791 -> (match (uu____9791) with
| (arg, uu____9797) -> begin
(

let uu____9798 = (sizeof arg)
in (acc + uu____9798))
end)) (Prims.parse_int "0") args)
in (uu____9779 + uu____9780)))
end
| uu____9799 -> begin
(Prims.parse_int "1")
end))
...
let uu____9805 = (un_uinst t)
in uu____9805.FStar_Syntax_Syntax.n)
...
let uu____9852 = (FStar_Dyn.mkdyn b)
in ((uu____9852), (s)))
in FStar_Syntax_Syntax.Meta_alien (uu____9847))
in ((FStar_Syntax_Syntax.tun), (uu____9846)))
in FStar_Syntax_Syntax.Tm_meta (uu____9839))
in (FStar_Syntax_Syntax.mk uu____9838))
in (uu____9835 FStar_Pervasives_Native.None (match (r) with
...
| FStar_Syntax_Syntax.Tm_meta (uu____9864, FStar_Syntax_Syntax.Meta_alien (blob, uu____9866)) -> begin
blob
end
| uu____9871 -> begin
