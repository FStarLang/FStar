...
let destruct:
  ...
  fun typ  ->
    fun lid  ->
      ...
      let uu____1901 =
        let uu____1902 = un_uinst typ1 in uu____1902.FStar_Syntax_Syntax.n in
            ...
            (match ((body.FStar_Syntax_Syntax.n), lopt) with
             | (FStar_Syntax_Syntax.Tm_abs (bs',t1,lopt'),None ) ->
                 let uu____2410 =
                   let uu____2413 =
                     let uu____2414 =
                       let uu____2424 =
                         let uu____2428 = FStar_Syntax_Subst.close_binders bs in
             ...
             | uu____2450 ->
                 let uu____2454 =
                   let uu____2457 =
                     let uu____2458 =
                       let uu____2468 = FStar_Syntax_Subst.close_binders bs in
           ...
           | FStar_Syntax_Syntax.Total (tres,uu____2570) ->
               ...
               (match uu____2577 with
                | FStar_Syntax_Syntax.Tm_arrow (bs',c') ->
                    let uu____2595 = FStar_ST.read t.FStar_Syntax_Syntax.tk in
                    FStar_Syntax_Syntax.mk
...
let mk_dtuple_lid: Prims.int -> FStar_Range.range -> FStar_Ident.lident =
  fun n1  ->
    fun r  ->
      ...
      let uu____3197 = let uu____3198 = mod_prefix_dtuple n1 in uu____3198 t in
...
let mk_dtuple_data_lid: Prims.int -> FStar_Range.range -> FStar_Ident.lident
  ...
  fun n1  ->
    fun r  ->
      ...
      let uu____3209 = let uu____3210 = mod_prefix_dtuple n1 in uu____3210 t in
    ...
    let uu____3455 =
      let uu____3456 =
        let uu____3466 =
          ...
          let uu____3469 =
            let uu____3471 = FStar_Syntax_Syntax.as_arg phi2 in [uu____3471] in
...
let mk_neg phi =
  let uu____3492 =
    let uu____3495 =
      let uu____3496 =
        let uu____3506 =
          let uu____3508 = FStar_Syntax_Syntax.as_arg phi in [uu____3508] in
        (t_not, uu____3506) in
    ...
    let uu____3627 =
      let uu____3628 =
        let uu____3638 =
          ...
          let uu____3641 =
            let uu____3643 = FStar_Syntax_Syntax.as_arg e2 in [uu____3643] in
      ...
      let uu____3731 =
        let uu____3741 =
          ...
          let uu____3744 =
            ...
            let uu____3747 =
              let uu____3749 = FStar_Syntax_Syntax.as_arg t' in [uu____3749] in
  ...
  fun f  ->
    ...
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____4479 =
        ...
        | (lid,arity) ->
            let uu____4485 =
              let uu____4495 = unmeta_monadic f2 in head_and_args uu____4495 in
            (match uu____4485 with
             | (t,args) ->
                 ...
                 if uu____4514 then Some (BaseConn (lid, args)) else None) in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          (pats, uu____4565)
      | uu____4572 ->
          let uu____4573 = FStar_Syntax_Subst.compress t1 in ([], uu____4573) in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____4663  ->
                      ...
                      | (t3,imp) ->
                          let uu____4670 = unascribe t3 in (uu____4670, imp))) in
                   ...
                   fv,(a1,uu____5350)::(a2,uu____5352)::[]) when
                    ...
                    (match uu____5378 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[],q,uu____5385) ->
                         let uu____5401 = FStar_Syntax_Subst.open_term [b] q in
    ...
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding None uu____5538
          ...
          FStar_Syntax_Const.effect_Tot_lid uu____5546 in
      {
...
let incr_delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  -> let uu____5763 = delta_qualifier t in incr_delta_depth uu____5763
...
let rec list_elements:
  ...
  fun e  ->
    let uu____5779 = let uu____5789 = unmeta e in head_and_args uu____5789 in
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____6006 =
          let uu____6007 =
            let uu____6008 = FStar_Syntax_Syntax.iarg typ in [uu____6008] in
...
let rec sizeof: FStar_Syntax_Syntax.term -> Prims.int =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_delayed uu____6908 ->
        let uu____6923 =
          let uu____6924 = FStar_Syntax_Subst.compress t in sizeof uu____6924 in
            ...
            (fun acc  ->
               fun uu____6959  ->
                 ...
                 | (bv,uu____6963) ->
                     ...
                     acc + uu____6964) (Prims.parse_int "0") bs in
