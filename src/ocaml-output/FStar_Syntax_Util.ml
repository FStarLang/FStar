...
let uu___169_1111 = (comp_to_comp_typ c)
in {FStar_Syntax_Syntax.comp_univs = uu___169_1111.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___169_1111.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu___169_1111.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___169_1111.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = f})
in FStar_Syntax_Syntax.Comp (uu____1110))
in {FStar_Syntax_Syntax.n = uu____1109; FStar_Syntax_Syntax.pos = uu___168_1108.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___168_1108.FStar_Syntax_Syntax.vars}))))
...
let is_total_comp : FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax  ->  Prims.bool = (fun c -> ((FStar_Ident.lid_equals (comp_effect_name c) FStar_Parser_Const.effect_Tot_lid) || (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___156_1184 -> (match (uu___156_1184) with
...
let is_total_lcomp : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun c -> ((FStar_Ident.lid_equals c.FStar_Syntax_Syntax.eff_name FStar_Parser_Const.effect_Tot_lid) || (FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___157_1193 -> (match (uu___157_1193) with
| FStar_Syntax_Syntax.TOTAL -> begin
true
end
| FStar_Syntax_Syntax.RETURN -> begin
...
let is_partial_return : FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax  ->  Prims.bool = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___159_1215 -> (match (uu___159_1215) with
| FStar_Syntax_Syntax.RETURN -> begin
true
end
...
let is_lcomp_partial_return : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun c -> (FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___160_1224 -> (match (uu___160_1224) with
| FStar_Syntax_Syntax.RETURN -> begin
true
end
| FStar_Syntax_Syntax.PARTIAL_RETURN -> begin
...
| FStar_Syntax_Syntax.Comp (ct) -> begin
(((is_total_comp c) || (is_pure_effect ct.FStar_Syntax_Syntax.effect_name)) || (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___161_1268 -> (match (uu___161_1268) with
...
let is_pure_lcomp : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun lc -> (((is_total_lcomp lc) || (is_pure_effect lc.FStar_Syntax_Syntax.eff_name)) || (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___162_1289 -> (match (uu___162_1289) with
| FStar_Syntax_Syntax.LEMMA -> begin
true
end
| uu____1290 -> begin
...
| FStar_Syntax_Syntax.Comp (c1) -> begin
((FStar_Ident.lid_equals c1.FStar_Syntax_Syntax.effect_name FStar_Parser_Const.effect_ML_lid) || (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___163_1715 -> (match (uu___163_1715) with
...
let uu___170_1784 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___170_1784.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___170_1784.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = t; FStar_Syntax_Syntax.effect_args = uu___170_1784.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___170_1784.FStar_Syntax_Syntax.flags}))
end))


let is_trivial_wp : FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax  ->  Prims.bool = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___164_1796 -> (match (uu___164_1796) with
| FStar_Syntax_Syntax.TOTAL -> begin
true
end
| FStar_Syntax_Syntax.RETURN -> begin
...
let equal_if = (fun uu___165_2055 -> (match (uu___165_2055) with
| true -> begin
Equal
end
| uu____2056 -> begin
...
let equal_iff = (fun uu___166_2060 -> (match (uu___166_2060) with
| true -> begin
Equal
end
| uu____2061 -> begin
...
let range_of_lb : 'Auu____2934 'Auu____2935 . ((FStar_Syntax_Syntax.bv, FStar_Ident.lid) FStar_Util.either * 'Auu____2935 * 'Auu____2934)  ->  FStar_Range.range = (fun uu___167_2949 -> (match (uu___167_2949) with
...
let uu___171_3236 = x
in {FStar_Syntax_Syntax.ppname = nm; FStar_Syntax_Syntax.index = uu___171_3236.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___171_3236.FStar_Syntax_Syntax.sort})
in (
...
let uu___172_3361 = rc
in (

let uu____3362 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (FStar_Syntax_Subst.close bs))
in {FStar_Syntax_Syntax.residual_effect = uu___172_3361.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____3362; FStar_Syntax_Syntax.residual_flags = uu___172_3361.FStar_Syntax_Syntax.residual_flags}))
...
let uu___173_3916 = rc
in (

let uu____3917 = (FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ (FStar_Syntax_Subst.subst s))
in {FStar_Syntax_Syntax.residual_effect = uu___173_3916.FStar_Syntax_Syntax.residual_effect; FStar_Syntax_Syntax.residual_typ = uu____3917; FStar_Syntax_Syntax.residual_flags = uu___173_3916.FStar_Syntax_Syntax.residual_flags}))
...
let uu____6429 = (head_and_args t1)
in (match (uu____6429) with
| (t2, args) -> begin
(

let uu____6476 = (un_uinst t2)
in (

let uu____6477 = (FStar_All.pipe_right args (FStar_List.map (fun uu____6510 -> (match (uu____6510) with
| (t3, imp) -> begin
(

let uu____6521 = (unascribe t3)
in ((uu____6521), (imp)))
end))))
...
let uu____6573 = (flat t1)
in ((qopt), (uu____6573)))
in (match (uu____6556) with
| (FStar_Pervasives_Native.Some (fa), ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6600; FStar_Syntax_Syntax.vars = uu____6601}, (({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6604); FStar_Syntax_Syntax.pos = uu____6605; FStar_Syntax_Syntax.vars = uu____6606}, uu____6607))::[])) when (is_q fa tc) -> begin
(aux qopt ((b)::out) t2)
end
| (FStar_Pervasives_Native.Some (fa), ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6684; FStar_Syntax_Syntax.vars = uu____6685}, (uu____6686)::(({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6689); FStar_Syntax_Syntax.pos = uu____6690; FStar_Syntax_Syntax.vars = uu____6691}, uu____6692))::[])) when (is_q fa tc) -> begin
(aux qopt ((b)::out) t2)
end
| (FStar_Pervasives_Native.None, ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6780; FStar_Syntax_Syntax.vars = uu____6781}, (({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6784); FStar_Syntax_Syntax.pos = uu____6785; FStar_Syntax_Syntax.vars = uu____6786}, uu____6787))::[])) when (is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v) -> begin
(aux (FStar_Pervasives_Native.Some ((is_forall tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v))) ((b)::out) t2)
end
| (FStar_Pervasives_Native.None, ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6863; FStar_Syntax_Syntax.vars = uu____6864}, (uu____6865)::(({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6868); FStar_Syntax_Syntax.pos = uu____6869; FStar_Syntax_Syntax.vars = uu____6870}, uu____6871))::[])) when (is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v) -> begin
(aux (FStar_Pervasives_Native.Some ((is_forall tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v))) ((b)::out) t2)
end
| (FStar_Pervasives_Native.Some (b), uu____6959) -> begin
(

let bs = (FStar_List.rev out)
in (

let uu____6993 = (FStar_Syntax_Subst.open_term bs t1)
in (match (uu____6993) with
| (bs1, t2) -> begin
(

let uu____7002 = (patterns t2)
...
let uu____7130 = (un_squash t)
in (FStar_Util.bind_opt uu____7130 (fun t1 -> (

let uu____7146 = (head_and_args' t1)
...
let uu____7185 = (un_uinst hd1)
in uu____7185.FStar_Syntax_Syntax.n)
in ((uu____7184), ((FStar_List.length args))))
...
let uu____7291 = (un_squash t)
in (FStar_Util.bind_opt uu____7291 (fun t1 -> (

let uu____7306 = (arrow_one t1)
...
let uu____7322 = (is_tot_or_gtot_comp c)
in (not (uu____7322)))
...
let uu____7329 = (comp_to_comp_typ c)
in uu____7329.FStar_Syntax_Syntax.result_typ)
in (

let uu____7330 = (is_free_in (FStar_Pervasives_Native.fst b) q)
in (match (uu____7330) with
| true -> begin
(

let uu____7333 = (patterns q)
...
let uu____7398 = (FStar_Syntax_Syntax.as_arg (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort)
in (
...
in (uu____7402)::[])
in (uu____7398)::uu____7399))
in ((FStar_Parser_Const.imp_lid), (uu____7395)))
in BaseConn (uu____7390))
in FStar_Pervasives_Native.Some (uu____7389))
end)))
end))
end
| uu____7405 -> begin
...
let uu____7413 = (un_squash t)
in (FStar_Util.bind_opt uu____7413 (fun t1 -> (

let uu____7444 = (head_and_args' t1)
...
let uu____7491 = (un_uinst hd1)
in uu____7491.FStar_Syntax_Syntax.n)
in ((uu____7490), (args)))
in (match (uu____7477) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((a1, uu____7506))::((a2, uu____7508))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.dtuple2_lid) -> begin
(

let uu____7543 = (

let uu____7544 = (FStar_Syntax_Subst.compress a2)
in uu____7544.FStar_Syntax_Syntax.n)
in (match (uu____7543) with
| FStar_Syntax_Syntax.Tm_abs ((b)::[], q, uu____7551) -> begin
(
...
let uu____7711 = (destruct_sq_forall phi)
...
let uu____7739 = (destruct_sq_exists phi)
...
let uu____7768 = (destruct_base_conn phi)
in (FStar_Util.catch_opt uu____7768 (fun uu____7773 -> (

let uu____7774 = (destruct_q_conn phi)
in (FStar_Util.catch_opt uu____7774 (fun uu____7779 -> (

let uu____7780 = (destruct_sq_base_conn phi)
in (FStar_Util.catch_opt uu____7780 (fun uu____7785 -> (

let uu____7786 = (destruct_sq_forall phi)
in (FStar_Util.catch_opt uu____7786 (fun uu____7791 -> (

let uu____7792 = (destruct_sq_exists phi)
in (FStar_Util.catch_opt uu____7792 (fun uu____7796 -> FStar_Pervasives_Native.None))))))))))))))))))))))))
...
let uu____7811 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.Delta_equational FStar_Pervasives_Native.None)
in FStar_Util.Inr (uu____7811))
in (

let uu____7812 = (

let uu____7813 = (FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ)
in (arrow a.FStar_Syntax_Syntax.action_params uu____7813))
in (

let uu____7816 = (abs a.FStar_Syntax_Syntax.action_params a.FStar_Syntax_Syntax.action_defn FStar_Pervasives_Native.None)
in (close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7806 a.FStar_Syntax_Syntax.action_univs uu____7812 FStar_Parser_Const.effect_Tot_lid uu____7816))))
...
let uu____7864 = (FStar_Syntax_Syntax.as_arg t)
in (uu____7864)::[])
in ((reify_), (uu____7861)))
in FStar_Syntax_Syntax.Tm_app (uu____7846))
in (FStar_Syntax_Syntax.mk uu____7845))
in (uu____7842 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos))))
...
let t1 = (FStar_Syntax_Subst.compress t)
in (match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____7877) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
fv.FStar_Syntax_Syntax.fv_delta
end
| FStar_Syntax_Syntax.Tm_bvar (uu____7903) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_name (uu____7904) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_match (uu____7905) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_uvar (uu____7928) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_type (uu____7945) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_constant (uu____7946) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_arrow (uu____7947) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_uinst (t2, uu____7961) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_refine ({FStar_Syntax_Syntax.ppname = uu____7966; FStar_Syntax_Syntax.index = uu____7967; FStar_Syntax_Syntax.sort = t2}, uu____7969) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_meta (t2, uu____7977) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_ascribed (t2, uu____7983, uu____7984) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_app (t2, uu____8026) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_abs (uu____8047, t2, uu____8049) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_let (uu____8070, t2) -> begin
(delta_qualifier t2)
end)))
...
let uu____8098 = (delta_qualifier t)
in (incr_delta_depth uu____8098)))
...
let uu____8104 = (FStar_Syntax_Subst.compress t)
in uu____8104.FStar_Syntax_Syntax.n)
...
let uu____8135 = (unmeta e)
in (head_and_args uu____8135))
...
let uu____8176 = (un_uinst head1)
in uu____8176.FStar_Syntax_Syntax.n)
in ((uu____8175), (args)))
in (match (uu____8162) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____8192) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid) -> begin
FStar_Pervasives_Native.Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____8212)::((hd1, uu____8214))::((tl1, uu____8216))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid) -> begin
(
...
let uu____8273 = (list_elements tl1)
in (FStar_Util.must uu____8273))
in (hd1)::uu____8268)
...
let rec apply_last : 'Auu____8307 . ('Auu____8307  ->  'Auu____8307)  ->  'Auu____8307 Prims.list  ->  'Auu____8307 Prims.list = (fun f l -> (match (l) with
| [] -> begin
...
let uu____8335 = (apply_last f xs)
in (x)::uu____8335)
end))
...
let uu____8380 = (FStar_Syntax_Syntax.lid_as_fv l1 FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in FStar_Syntax_Syntax.Tm_fvar (uu____8380))
in (FStar_Syntax_Syntax.mk uu____8379))
in (uu____8376 FStar_Pervasives_Native.None rng)))
in (
...
let uu____8395 = (ctor FStar_Parser_Const.cons_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____8395 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____8394 args))
in (uu____8393 FStar_Pervasives_Native.None pos)))
in (
...
let uu____8409 = (ctor FStar_Parser_Const.nil_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____8409 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____8408 args))
in (uu____8407 FStar_Pervasives_Native.None pos)))
in (
...
let uu____8414 = (FStar_Syntax_Syntax.iarg typ)
in (uu____8414)::[])
in (nil uu____8413 rng))
in (FStar_List.fold_right (fun t a -> (

let uu____8420 = (

let uu____8421 = (FStar_Syntax_Syntax.iarg typ)
in (

let uu____8422 = (

let uu____8425 = (FStar_Syntax_Syntax.as_arg t)
in (

let uu____8426 = (

let uu____8429 = (FStar_Syntax_Syntax.as_arg a)
in (uu____8429)::[])
in (uu____8425)::uu____8426))
in (uu____8421)::uu____8422))
in (cons1 uu____8420 t.FStar_Syntax_Syntax.pos))) l uu____8412))))))
...
let uu____8461 = (FStar_Syntax_Unionfind.from_id id)
in ((uu____8461), (t)))
in FStar_Syntax_Syntax.Tm_uvar (uu____8444))
in (FStar_Syntax_Syntax.mk uu____8443))
in (uu____8440 FStar_Pervasives_Native.None FStar_Range.dummyRange)))
...
| FStar_Syntax_Syntax.Tm_app (uu____8886) -> begin
(

let uu____8901 = (head_and_args' t)
in (match (uu____8901) with
| (hd1, args) -> begin
(

let uu___174_8934 = t
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app (((hd1), (args))); FStar_Syntax_Syntax.pos = uu___174_8934.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___174_8934.FStar_Syntax_Syntax.vars})
end))
end
| uu____8945 -> begin
t
...
let uu____8949 = (unmeta_safe t1)
in (canon_app uu____8949))
in (

let t21 = (

let uu____8955 = (unmeta_safe t2)
in (canon_app uu____8955))
in (match (((t11.FStar_Syntax_Syntax.n), (t21.FStar_Syntax_Syntax.n))) with
...
let uu____9467 = (FStar_Syntax_Subst.compress t)
in uu____9467.FStar_Syntax_Syntax.n)
in (
...
let uu____9508 = (ff f1)
in (

let uu____9509 = (FStar_List.map (fun uu____9528 -> (match (uu____9528) with
| (a, q) -> begin
(
...
in ((uu____9508), (uu____9509))))
in FStar_Syntax_Syntax.Tm_app (uu____9493))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, k) -> begin
(

let uu____9569 = (FStar_Syntax_Subst.open_term bs t1)
...
let uu____9594 = (FStar_Syntax_Subst.close bs1 t'')
in ((bs1), (uu____9594), (k)))
in FStar_Syntax_Syntax.Tm_abs (uu____9577)))
end))
end
...
let uu____9628 = (ff t1)
in ((uu____9628), (us)))
in FStar_Syntax_Syntax.Tm_uinst (uu____9621))
end
| uu____9629 -> begin
tn
end)
...
let uu___175_9632 = t
in {FStar_Syntax_Syntax.n = tn1; FStar_Syntax_Syntax.pos = uu___175_9632.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___175_9632.FStar_Syntax_Syntax.vars}))))))


let rec sizeof : FStar_Syntax_Syntax.term  ->  Prims.int = (fun t -> (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____9637) -> begin
(

let uu____9662 = (

let uu____9663 = (FStar_Syntax_Subst.compress t)
in (sizeof uu____9663))
in ((Prims.parse_int "1") + uu____9662))
end
| FStar_Syntax_Syntax.Tm_bvar (bv) -> begin
(

let uu____9665 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____9665))
end
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
(

let uu____9667 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____9667))
end
| FStar_Syntax_Syntax.Tm_uinst (t1, us) -> begin
(

let uu____9674 = (sizeof t1)
in ((FStar_List.length us) + uu____9674))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, uu____9677) -> begin
(

let uu____9698 = (sizeof t1)
in (

let uu____9699 = (FStar_List.fold_left (fun acc uu____9710 -> (match (uu____9710) with
| (bv, uu____9716) -> begin
(

let uu____9717 = (sizeof bv.FStar_Syntax_Syntax.sort)
in (acc + uu____9717))
end)) (Prims.parse_int "0") bs)
in (uu____9698 + uu____9699)))
end
| FStar_Syntax_Syntax.Tm_app (hd1, args) -> begin
(

let uu____9740 = (sizeof hd1)
in (

let uu____9741 = (FStar_List.fold_left (fun acc uu____9752 -> (match (uu____9752) with
| (arg, uu____9758) -> begin
(

let uu____9759 = (sizeof arg)
in (acc + uu____9759))
end)) (Prims.parse_int "0") args)
in (uu____9740 + uu____9741)))
end
| uu____9760 -> begin
(Prims.parse_int "1")
end))
...
let uu____9831 = (FStar_Dyn.mkdyn b)
in ((uu____9831), (s), (ty)))
in FStar_Syntax_Syntax.Meta_alien (uu____9822))
in ((FStar_Syntax_Syntax.tun), (uu____9821)))
in FStar_Syntax_Syntax.Tm_meta (uu____9814))
in (FStar_Syntax_Syntax.mk uu____9813))
in (uu____9810 FStar_Pervasives_Native.None (match (r) with
...
| FStar_Syntax_Syntax.Tm_meta (uu____9843, FStar_Syntax_Syntax.Meta_alien (blob, uu____9845, uu____9846)) -> begin
blob
end
| uu____9855 -> begin
