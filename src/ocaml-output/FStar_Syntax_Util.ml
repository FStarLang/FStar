...
type eq_result =
<<<<<<< 773059392ae16bf3ee85c2677712fea6169e1b2b
  | Equal 
  | NotEqual 
  | Unknown 
  ...
  fun f  ->
    ...
    let destruct_q_conn t =
      ...
      let rec aux qopt out t1 =
        let uu____12195 = let uu____12219 = flat t1  in (qopt, uu____12219)
           in
        ...
        | (FStar_Pervasives_Native.Some
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               ...
               ({
                  ...
                  FStar_Syntax_Syntax.vars = uu____12375;_},uu____12376)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.None
        ...
        | (FStar_Pervasives_Native.None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               ...
               FStar_Syntax_Syntax.vars = uu____12608;_},uu____12609::
             ({
                FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                  (b::[],t2,uu____12612);
                FStar_Syntax_Syntax.pos = uu____12613;
                FStar_Syntax_Syntax.vars = uu____12614;_},uu____12615)::[]))
            when
            is_qlid (tc.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v ->
            let uu____12724 =
              let uu____12728 =
        ...
        (fun t1  ->
           ...
           | (hd1,args) ->
               ...
               (match uu____12997 with
                ...
                | uu____13042 -> FStar_Pervasives_Native.None))
       in
        ...
        (fun t1  ->
           ...
           | (hd1,args) ->
               ...
               (match uu____13325 with
                | (FStar_Syntax_Syntax.Tm_fvar
                   fv,(a1,uu____13358)::(a2,uu____13360)::[]) when
                    FStar_Syntax_Syntax.fv_eq_lid fv
      ...
      fun pos  ->
        let lb =
          ...
          close_univs_and_mk_letbinding FStar_Pervasives_Native.None
            ...
            FStar_Parser_Const.effect_Tot_lid uu____13703 [] pos
           in
        {
  ...
  fun t  ->
    ...
    let uu____13729 =
      let uu____13736 =
        let uu____13737 =
          let uu____13754 =
            let uu____13765 = FStar_Syntax_Syntax.as_arg t  in [uu____13765]
             in
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____14003;
           ...
           FStar_Syntax_Syntax.sort = t2;_},uu____14006)
        -> delta_qualifier t2
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____14313 =
          let uu____14314 =
            let uu____14315 = FStar_Syntax_Syntax.iarg typ  in [uu____14315]
             in
...
let rec (term_eq_dbg :
  ...
  fun dbg  ->
    fun t1  ->
      fun t2  ->
        let t11 = let uu____15039 = unmeta_safe t1  in canon_app uu____15039
           in
        let t21 = let uu____15045 = unmeta_safe t2  in canon_app uu____15045
           in
        let uu____15048 =
          let uu____15053 =
            let uu____15054 =
        ...
        | (FStar_Syntax_Syntax.Tm_type
           uu____15214,FStar_Syntax_Syntax.Tm_type uu____15215) -> true
        ...
        | (FStar_Syntax_Syntax.Tm_lazy uu____15534,uu____15535) ->
            let uu____15536 =
              let uu____15538 = unlazy t11  in
              term_eq_dbg dbg uu____15538 t21  in
            check "lazy_l" uu____15536
        | (uu____15540,FStar_Syntax_Syntax.Tm_lazy uu____15541) ->
            let uu____15542 =
              let uu____15544 = unlazy t21  in
              term_eq_dbg dbg t11 uu____15544  in
        ...
        | (FStar_Syntax_Syntax.Tm_uvar
           (u1,uu____15597),FStar_Syntax_Syntax.Tm_uvar (u2,uu____15599)) ->
            check "uvar"
        ...
        | (FStar_Syntax_Syntax.Tm_quoted
           (qt1,qi1),FStar_Syntax_Syntax.Tm_quoted (qt2,qi2)) ->
            (let uu____15657 =
               let uu____15659 = eq_quoteinfo qi1 qi2  in uu____15659 = Equal
                in
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid  ->
    fun t  ->
      let uu____16605 =
        let uu____16606 = un_uinst t  in uu____16606.FStar_Syntax_Syntax.n
         in
        ...
        let uu____16987 =
          FStar_List.collect
            (fun uu____17001  ->
               ...
               | (x,uu____17013) -> unbound_variables x) args
           in
                  ...
                  | (p,wopt,t2) ->
                      ...
                      let uu____17106 =
                        ...
                        | FStar_Pervasives_Native.Some t3 ->
                         ...
                         in
                      FStar_List.append uu____17103 uu____17106))
           in
          ...
          let uu____17248 =
            ...
            | FStar_Util.Inl bv ->
                ...
                (match uu____17255 with
                 | (uu____17276,t2) -> unbound_variables t2)
             in
             ...
             let uu____17316 =
               FStar_List.collect
                 (fun lb  ->
                    ...
                    FStar_List.append uu____17323 uu____17326) lbs1
                in
...
let rec (list_elements :
  ...
  fun e  ->
    let uu____17986 =
      let uu____18003 = unmeta e  in head_and_args uu____18003  in
    ...
    | (head1,args) ->
        ...
        (match uu____18034 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____18068) when
             ...
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____18092::(hd1,uu____18094)::(tl1,uu____18096)::[]) when
      ...
      let one_pat p =
        ...
        | (head1,args) ->
            ...
            (match uu____18495 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu____18533,uu____18534)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.smtpat_lid
                 -> arg
             | uu____18586 -> failwith "Unexpected pattern term")
         in
      let lemma_pats p =
        ...
        let smt_pat_or1 t1 =
          ...
          | (head1,args) ->
              ...
              (match uu____18705 with
               ...
               | uu____18777 -> FStar_Pervasives_Native.None)
           in
        match elts with
        | t1::[] ->
                  ...
                  | FStar_Syntax_Syntax.Comp
                      { FStar_Syntax_Syntax.comp_univs = uu____19154;
                        ...
                        FStar_Syntax_Syntax.effect_args =
                          (pre,uu____19158)::(post,uu____19160)::(pats,uu____19162)::[];
...
let uu____15360 = (term_eq_dbg dbg t12 t22)
in (check "refine formula" uu____15360)))
end
| (FStar_Syntax_Syntax.Tm_app (f1, a1), FStar_Syntax_Syntax.Tm_app (f2, a2)) -> begin
((

let uu____15417 = (term_eq_dbg dbg f1 f2)
in (check "app head" uu____15417)) && (

let uu____15421 = (eqlist (arg_eq_dbg dbg) a1 a2)
in (check "app args" uu____15421)))
end
| (FStar_Syntax_Syntax.Tm_match (t12, bs1), FStar_Syntax_Syntax.Tm_match (t22, bs2)) -> begin
((

let uu____15510 = (term_eq_dbg dbg t12 t22)
in (check "match head" uu____15510)) && (

let uu____15514 = (eqlist (branch_eq_dbg dbg) bs1 bs2)
in (check "match branches" uu____15514)))
end
| (FStar_Syntax_Syntax.Tm_lazy (uu____15531), uu____15532) -> begin
(

let uu____15533 = (

let uu____15535 = (unlazy t11)
in (term_eq_dbg dbg uu____15535 t21))
in (check "lazy_l" uu____15533))
end
| (uu____15537, FStar_Syntax_Syntax.Tm_lazy (uu____15538)) -> begin
(

let uu____15539 = (

let uu____15541 = (unlazy t21)
in (term_eq_dbg dbg t11 uu____15541))
in (check "lazy_r" uu____15539))
end
...
let uu____15586 = (eqlist (letbinding_eq_dbg dbg) lbs1 lbs2)
in (check "let lbs" uu____15586))) && (

let uu____15590 = (term_eq_dbg dbg t12 t22)
in (check "let body" uu____15590)))
end
| (FStar_Syntax_Syntax.Tm_uvar (u1, uu____15594), FStar_Syntax_Syntax.Tm_uvar (u2, uu____15596)) -> begin
...
let uu____15656 = (eq_quoteinfo qi1 qi2)
in (Prims.op_Equality uu____15656 Equal))
in (check "tm_quoted qi" uu____15654)) && (

let uu____15659 = (term_eq_dbg dbg qt1 qt2)
in (check "tm_quoted payload" uu____15659)))
end
...
let uu____15689 = (FStar_Ident.lid_equals n1 n2)
in (check "meta_monadic lid" uu____15689)) && (

let uu____15693 = (term_eq_dbg dbg ty1 ty2)
in (check "meta_monadic type" uu____15693)))
end
| (FStar_Syntax_Syntax.Meta_monadic_lift (s1, t13, ty1), FStar_Syntax_Syntax.Meta_monadic_lift (s2, t23, ty2)) -> begin
(((

let uu____15712 = (FStar_Ident.lid_equals s1 s2)
in (check "meta_monadic_lift src" uu____15712)) && (

let uu____15716 = (FStar_Ident.lid_equals t13 t23)
in (check "meta_monadic_lift tgt" uu____15716))) && (

let uu____15720 = (term_eq_dbg dbg ty1 ty2)
in (check "meta_monadic_lift type" uu____15720)))
end
| uu____15723 -> begin
(fail "metas")
end)
end
| (FStar_Syntax_Syntax.Tm_unknown, uu____15729) -> begin
(fail "unk")
end
| (uu____15731, FStar_Syntax_Syntax.Tm_unknown) -> begin
(fail "unk")
end
| (FStar_Syntax_Syntax.Tm_bvar (uu____15733), uu____15734) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_name (uu____15736), uu____15737) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_fvar (uu____15739), uu____15740) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_constant (uu____15742), uu____15743) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_type (uu____15745), uu____15746) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_abs (uu____15748), uu____15749) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_arrow (uu____15769), uu____15770) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_refine (uu____15786), uu____15787) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_app (uu____15795), uu____15796) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_match (uu____15814), uu____15815) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_let (uu____15839), uu____15840) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_uvar (uu____15855), uu____15856) -> begin
(fail "bottom")
end
| (FStar_Syntax_Syntax.Tm_meta (uu____15870), uu____15871) -> begin
(fail "bottom")
end
| (uu____15879, FStar_Syntax_Syntax.Tm_bvar (uu____15880)) -> begin
(fail "bottom")
end
| (uu____15882, FStar_Syntax_Syntax.Tm_name (uu____15883)) -> begin
(fail "bottom")
end
| (uu____15885, FStar_Syntax_Syntax.Tm_fvar (uu____15886)) -> begin
(fail "bottom")
end
| (uu____15888, FStar_Syntax_Syntax.Tm_constant (uu____15889)) -> begin
(fail "bottom")
end
| (uu____15891, FStar_Syntax_Syntax.Tm_type (uu____15892)) -> begin
(fail "bottom")
end
| (uu____15894, FStar_Syntax_Syntax.Tm_abs (uu____15895)) -> begin
(fail "bottom")
end
| (uu____15915, FStar_Syntax_Syntax.Tm_arrow (uu____15916)) -> begin
(fail "bottom")
end
| (uu____15932, FStar_Syntax_Syntax.Tm_refine (uu____15933)) -> begin
(fail "bottom")
end
| (uu____15941, FStar_Syntax_Syntax.Tm_app (uu____15942)) -> begin
(fail "bottom")
end
| (uu____15960, FStar_Syntax_Syntax.Tm_match (uu____15961)) -> begin
(fail "bottom")
end
| (uu____15985, FStar_Syntax_Syntax.Tm_let (uu____15986)) -> begin
(fail "bottom")
end
| (uu____16001, FStar_Syntax_Syntax.Tm_uvar (uu____16002)) -> begin
(fail "bottom")
end
| (uu____16016, FStar_Syntax_Syntax.Tm_meta (uu____16017)) -> begin
(fail "bottom")
end)))))
...
let uu____16052 = (term_eq_dbg dbg t1 t2)
in (check "arg tm" uu____16052))) (fun q1 q2 -> (

let uu____16064 = (

let uu____16066 = (eq_aqual q1 q2)
in (Prims.op_Equality uu____16066 Equal))
in (check "arg qual" uu____16064))) a1 a2))
...
let uu____16091 = (term_eq_dbg dbg b11.FStar_Syntax_Syntax.sort b21.FStar_Syntax_Syntax.sort)
in (check "binder sort" uu____16091))) (fun q1 q2 -> (

let uu____16103 = (

let uu____16105 = (eq_aqual q1 q2)
in (Prims.op_Equality uu____16105 Equal))
in (check "binder qual" uu____16103))) b1 b2))
...
let uu____16125 = (FStar_Ident.lid_equals c11.FStar_Syntax_Syntax.effect_name c21.FStar_Syntax_Syntax.effect_name)
in (check "comp eff" uu____16125)) && (

let uu____16129 = (term_eq_dbg dbg c11.FStar_Syntax_Syntax.result_typ c21.FStar_Syntax_Syntax.result_typ)
in (check "comp result typ" uu____16129))) && true))))
and eq_flags_dbg : Prims.bool  ->  FStar_Syntax_Syntax.cflag  ->  FStar_Syntax_Syntax.cflag  ->  Prims.bool = (fun dbg f1 f2 -> true)
and branch_eq_dbg : Prims.bool  ->  (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax FStar_Pervasives_Native.option * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax)  ->  (FStar_Syntax_Syntax.pat' FStar_Syntax_Syntax.withinfo_t * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax FStar_Pervasives_Native.option * FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax)  ->  Prims.bool = (fun dbg uu____16139 uu____16140 -> (match (((uu____16139), (uu____16140))) with
| ((p1, w1, t1), (p2, w2, t2)) -> begin
(((

let uu____16267 = (FStar_Syntax_Syntax.eq_pat p1 p2)
in (check "branch pat" uu____16267)) && (

let uu____16271 = (term_eq_dbg dbg t1 t2)
in (check "branch body" uu____16271))) && (

let uu____16275 = (match (((w1), (w2))) with
| (FStar_Pervasives_Native.Some (x), FStar_Pervasives_Native.Some (y)) -> begin
(term_eq_dbg dbg x y)
end
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None) -> begin
...
in (check "branch when" uu____16275)))
end))
...
let uu____16338 = (eqsum (fun bv1 bv2 -> true) FStar_Syntax_Syntax.fv_eq lb1.FStar_Syntax_Syntax.lbname lb2.FStar_Syntax_Syntax.lbname)
in (check "lb bv" uu____16338)) && (

let uu____16347 = (term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbtyp lb2.FStar_Syntax_Syntax.lbtyp)
in (check "lb typ" uu____16347))) && (

let uu____16351 = (term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbdef lb2.FStar_Syntax_Syntax.lbdef)
in (check "lb def" uu____16351))))
...
let uu____16368 = (FStar_ST.op_Bang debug_term_eq)
in (term_eq_dbg uu____16368 t1 t2))
...
| FStar_Syntax_Syntax.Tm_delayed (uu____16422) -> begin
(

let uu____16445 = (

let uu____16447 = (FStar_Syntax_Subst.compress t)
in (sizeof uu____16447))
in ((Prims.parse_int "1") + uu____16445))
end
| FStar_Syntax_Syntax.Tm_bvar (bv) -> begin
(

let uu____16450 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____16450))
end
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
(

let uu____16454 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____16454))
end
| FStar_Syntax_Syntax.Tm_uinst (t1, us) -> begin
(

let uu____16463 = (sizeof t1)
in ((FStar_List.length us) + uu____16463))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, uu____16467) -> begin
(

let uu____16492 = (sizeof t1)
in (

let uu____16494 = (FStar_List.fold_left (fun acc uu____16509 -> (match (uu____16509) with
| (bv, uu____16519) -> begin
(

let uu____16524 = (sizeof bv.FStar_Syntax_Syntax.sort)
in (acc + uu____16524))
end)) (Prims.parse_int "0") bs)
in (uu____16492 + uu____16494)))
end
| FStar_Syntax_Syntax.Tm_app (hd1, args) -> begin
(

let uu____16553 = (sizeof hd1)
in (

let uu____16555 = (FStar_List.fold_left (fun acc uu____16570 -> (match (uu____16570) with
| (arg, uu____16580) -> begin
(

let uu____16585 = (sizeof arg)
in (acc + uu____16585))
end)) (Prims.parse_int "0") args)
in (uu____16553 + uu____16555)))
end
| uu____16588 -> begin
(Prims.parse_int "1")
end))
...
let uu____16603 = (un_uinst t)
in uu____16603.FStar_Syntax_Syntax.n)
...
let uu____16657 = (FStar_Options.set_options t s)
in (match (uu____16657) with
...
let uu____16674 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right uu____16674 (fun a1 -> ())));
(match (sopt) with
| FStar_Pervasives_Native.None -> begin
()
end
...
let uu____16689 = (FStar_Options.internal_pop ())
...
| FStar_Syntax_Syntax.Tm_delayed (uu____16721) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_name (x) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_uvar (uu____16748) -> begin
[]
end
...
| FStar_Syntax_Syntax.Tm_fvar (uu____16763) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_constant (uu____16764) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_lazy (uu____16765) -> begin
[]
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
[]
...
| FStar_Syntax_Syntax.Tm_abs (bs, t1, uu____16774) -> begin
(

let uu____16799 = (FStar_Syntax_Subst.open_term bs t1)
in (match (uu____16799) with
| (bs1, t2) -> begin
(

let uu____16808 = (FStar_List.collect (fun uu____16820 -> (match (uu____16820) with
| (b, uu____16830) -> begin
(unbound_variables b.FStar_Syntax_Syntax.sort)
end)) bs1)
in (

let uu____16835 = (unbound_variables t2)
in (FStar_List.append uu____16808 uu____16835)))
end))
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(

let uu____16860 = (FStar_Syntax_Subst.open_comp bs c)
in (match (uu____16860) with
| (bs1, c1) -> begin
(

let uu____16869 = (FStar_List.collect (fun uu____16881 -> (match (uu____16881) with
| (b, uu____16891) -> begin
(unbound_variables b.FStar_Syntax_Syntax.sort)
end)) bs1)
in (

let uu____16896 = (unbound_variables_comp c1)
in (FStar_List.append uu____16869 uu____16896)))
end))
end
| FStar_Syntax_Syntax.Tm_refine (b, t1) -> begin
(

let uu____16905 = (FStar_Syntax_Subst.open_term ((((b), (FStar_Pervasives_Native.None)))::[]) t1)
in (match (uu____16905) with
| (bs, t2) -> begin
(

let uu____16928 = (FStar_List.collect (fun uu____16940 -> (match (uu____16940) with
| (b1, uu____16950) -> begin
...
let uu____16984 = (FStar_List.collect (fun uu____16998 -> (match (uu____16998) with
| (x, uu____17010) -> begin
(unbound_variables x)
end)) args)
in (

let uu____17019 = (unbound_variables t1)
in (FStar_List.append uu____16984 uu____17019)))
end
| FStar_Syntax_Syntax.Tm_match (t1, pats) -> begin
(

let uu____17060 = (unbound_variables t1)
in (

let uu____17063 = (FStar_All.pipe_right pats (FStar_List.collect (fun br -> (

let uu____17078 = (FStar_Syntax_Subst.open_branch br)
in (match (uu____17078) with
| (p, wopt, t2) -> begin
(

let uu____17100 = (unbound_variables t2)
in (

let uu____17103 = (match (wopt) with
| FStar_Pervasives_Native.None -> begin
[]
end
...
in (FStar_List.append uu____17100 uu____17103)))
end)))))
in (FStar_List.append uu____17060 uu____17063)))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, asc, uu____17117) -> begin
(

let uu____17158 = (unbound_variables t1)
in (

let uu____17161 = (

let uu____17164 = (match ((FStar_Pervasives_Native.fst asc)) with
...
let uu____17195 = (match ((FStar_Pervasives_Native.snd asc)) with
| FStar_Pervasives_Native.None -> begin
[]
end
...
in (FStar_List.append uu____17164 uu____17195)))
in (FStar_List.append uu____17158 uu____17161)))
end
| FStar_Syntax_Syntax.Tm_let ((false, (lb)::[]), t1) -> begin
(

let uu____17236 = (unbound_variables lb.FStar_Syntax_Syntax.lbtyp)
in (

let uu____17239 = (

let uu____17242 = (unbound_variables lb.FStar_Syntax_Syntax.lbdef)
in (

let uu____17245 = (match (lb.FStar_Syntax_Syntax.lbname) with
| FStar_Util.Inr (uu____17250) -> begin
(unbound_variables t1)
end
| FStar_Util.Inl (bv) -> begin
(

let uu____17252 = (FStar_Syntax_Subst.open_term ((((bv), (FStar_Pervasives_Native.None)))::[]) t1)
in (match (uu____17252) with
| (uu____17273, t2) -> begin
(unbound_variables t2)
end))
end)
in (FStar_List.append uu____17242 uu____17245)))
in (FStar_List.append uu____17236 uu____17239)))
end
| FStar_Syntax_Syntax.Tm_let ((uu____17275, lbs), t1) -> begin
(

let uu____17295 = (FStar_Syntax_Subst.open_let_rec lbs t1)
in (match (uu____17295) with
| (lbs1, t2) -> begin
(

let uu____17310 = (unbound_variables t2)
in (

let uu____17313 = (FStar_List.collect (fun lb -> (

let uu____17320 = (unbound_variables lb.FStar_Syntax_Syntax.lbtyp)
in (

let uu____17323 = (unbound_variables lb.FStar_Syntax_Syntax.lbdef)
in (FStar_List.append uu____17320 uu____17323)))) lbs1)
in (FStar_List.append uu____17310 uu____17313)))
end))
end
...
let uu____17340 = (unbound_variables t1)
in (

let uu____17343 = (match (m) with
| FStar_Syntax_Syntax.Meta_pattern (uu____17348, args) -> begin
(FStar_List.collect (FStar_List.collect (fun uu____17403 -> (match (uu____17403) with
| (a, uu____17415) -> begin
(unbound_variables a)
end))) args)
end
| FStar_Syntax_Syntax.Meta_monadic_lift (uu____17424, uu____17425, t') -> begin
(unbound_variables t')
end
| FStar_Syntax_Syntax.Meta_monadic (uu____17431, t') -> begin
(unbound_variables t')
end
| FStar_Syntax_Syntax.Meta_labeled (uu____17437) -> begin
[]
end
| FStar_Syntax_Syntax.Meta_desugared (uu____17446) -> begin
[]
end
| FStar_Syntax_Syntax.Meta_named (uu____17447) -> begin
[]
end)
in (FStar_List.append uu____17340 uu____17343)))
end)))
...
| FStar_Syntax_Syntax.GTotal (t, uu____17454) -> begin
(unbound_variables t)
end
| FStar_Syntax_Syntax.Total (t, uu____17464) -> begin
(unbound_variables t)
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(

let uu____17474 = (unbound_variables ct.FStar_Syntax_Syntax.result_typ)
in (

let uu____17477 = (FStar_List.collect (fun uu____17491 -> (match (uu____17491) with
| (a, uu____17503) -> begin
(unbound_variables a)
end)) ct.FStar_Syntax_Syntax.effect_args)
in (FStar_List.append uu____17474 uu____17477)))
end))
...
let uu____17618 = (head_and_args h)
in (match (uu____17618) with
| (head1, args) -> begin
(

let uu____17679 = (

let uu____17680 = (FStar_Syntax_Subst.compress head1)
in uu____17680.FStar_Syntax_Syntax.n)
...
let uu____17757 = (extract_attr' attr_lid se.FStar_Syntax_Syntax.sigattrs)
in (match (uu____17757) with
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end
...
let uu___2540_17799 = se
in {FStar_Syntax_Syntax.sigel = uu___2540_17799.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___2540_17799.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___2540_17799.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___2540_17799.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = attrs'})), (t)))
end)))
...
let uu____17808 = (FStar_Syntax_Subst.compress t)
in uu____17808.FStar_Syntax_Syntax.n)
in (match (uu____17807) with
| FStar_Syntax_Syntax.Tm_arrow (uu____17812, c) -> begin
(match (c.FStar_Syntax_Syntax.n) with
...
(match (ct.FStar_Syntax_Syntax.effect_args) with
| (_req)::(_ens)::((pats, uu____17840))::uu____17841 -> begin
(

let pats' = (unmeta pats)
in (

let uu____17901 = (head_and_args pats')
in (match (uu____17901) with
| (head1, uu____17920) -> begin
(

let uu____17945 = (

let uu____17946 = (un_uinst head1)
in uu____17946.FStar_Syntax_Syntax.n)
...
let uu____18000 = (unmeta e)
in (head_and_args uu____18000))
...
let uu____18047 = (un_uinst head1)
in uu____18047.FStar_Syntax_Syntax.n)
in ((uu____18046), (args)))
in (match (uu____18031) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____18065) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid) -> begin
FStar_Pervasives_Native.Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____18089)::((hd1, uu____18091))::((tl1, uu____18093))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid) -> begin
(
...
let uu____18166 = (list_elements tl1)
in (FStar_Util.must uu____18166))
in (hd1)::uu____18163)
in FStar_Pervasives_Native.Some (uu____18160))
end
| uu____18175 -> begin
FStar_Pervasives_Native.None
end))
...
let uu____18205 = (FStar_Syntax_Subst.compress t)
in uu____18205.FStar_Syntax_Syntax.n)
in (match (uu____18204) with
| FStar_Syntax_Syntax.Tm_abs ((b)::[], e, uu____18212) -> begin
(

let uu____18247 = (FStar_Syntax_Subst.open_term ((b)::[]) e)
...
let uu____18281 = (is_free_in (FStar_Pervasives_Native.fst b1) e1)
in (match (uu____18281) with
| true -> begin
(

let uu____18288 = (

let uu____18299 = (FStar_Syntax_Syntax.as_arg exp_unit)
in (uu____18299)::[])
in (mk_app t uu____18288))
end
| uu____18324 -> begin
e1
end)))
...
let uu____18338 = (FStar_Syntax_Syntax.as_arg exp_unit)
in (uu____18338)::[])
in (mk_app t uu____18327))
end)))
...
let uu____18393 = (list_elements e)
in (match (uu____18393) with
...
let uu____18441 = (unmeta p)
in (FStar_All.pipe_right uu____18441 head_and_args))
...
let uu____18508 = (un_uinst head1)
in uu____18508.FStar_Syntax_Syntax.n)
in ((uu____18507), (args)))
in (match (uu____18492) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((uu____18530, uu____18531))::(arg)::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.smtpat_lid) -> begin
arg
end
| uu____18583 -> begin
...
let uu____18655 = (unmeta t1)
in (FStar_All.pipe_right uu____18655 head_and_args))
...
let uu____18718 = (un_uinst head1)
in uu____18718.FStar_Syntax_Syntax.n)
in ((uu____18717), (args)))
in (match (uu____18702) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((e, uu____18737))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.smtpatOr_lid) -> begin
FStar_Pervasives_Native.Some (e)
end
| uu____18774 -> begin
FStar_Pervasives_Native.None
...
let uu____18804 = (smt_pat_or1 t1)
in (match (uu____18804) with
| FStar_Pervasives_Native.Some (e) -> begin
(

let uu____18826 = (list_elements1 e)
in (FStar_All.pipe_right uu____18826 (FStar_List.map (fun branch1 -> (

let uu____18856 = (list_elements1 branch1)
in (FStar_All.pipe_right uu____18856 (FStar_List.map one_pat)))))))
end
| uu____18879 -> begin
(

let uu____18884 = (FStar_All.pipe_right elts (FStar_List.map one_pat))
in (uu____18884)::[])
end))
end
| uu____18935 -> begin
...
let uu____18938 = (FStar_All.pipe_right elts (FStar_List.map one_pat))
in (uu____18938)::[])
end))))
in (
...
let uu____19023 = (FStar_Syntax_Subst.compress t)
in uu____19023.FStar_Syntax_Syntax.n)
in (match (uu____19022) with
| FStar_Syntax_Syntax.Tm_arrow (binders, c) -> begin
(

let uu____19080 = (FStar_Syntax_Subst.open_comp binders c)
in (match (uu____19080) with
| (binders1, c1) -> begin
(match (c1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Comp ({FStar_Syntax_Syntax.comp_univs = uu____19151; FStar_Syntax_Syntax.effect_name = uu____19152; FStar_Syntax_Syntax.result_typ = uu____19153; FStar_Syntax_Syntax.effect_args = ((pre, uu____19155))::((post, uu____19157))::((pats, uu____19159))::[]; FStar_Syntax_Syntax.flags = uu____19160}) -> begin
(

let uu____19221 = (lemma_pats pats)
in ((binders1), (pre), (post), (uu____19221)))
end
| uu____19258 -> begin
(failwith "impos")
end)
...
let uu____19399 = (mk_imp pre post1)
in (
...
let uu____19424 = (FStar_Syntax_Syntax.binders_to_names binders)
in ((uu____19424), (patterns)))
in FStar_Syntax_Syntax.Meta_pattern (uu____19403))
in ((uu____19399), (uu____19402))))
in FStar_Syntax_Syntax.Tm_meta (uu____19392))
in (FStar_Syntax_Syntax.mk uu____19391))
in (uu____19384 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos))
in (

let quant = (

let uu____19448 = (universe_of_binders binders)
in (FStar_List.fold_right2 (fun b u out -> (mk_forall u (FStar_Pervasives_Native.fst b) out)) binders uu____19448 body))
in quant)))
end))))))
