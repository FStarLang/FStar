            ...
            let uu____3906 =
              let uu____3907 =
                ...
                let uu____3910 =
                  let uu____3917 =
                    let uu____3923 =
                      let uu____3924 = FStar_Syntax_Syntax.mk_Total ktype0
                         in
  ...
  fun f  ->
    ...
    let destruct_base_conn f1 =
      ...
      let rec aux f2 uu____4280 =
        ...
        | (lid,arity) ->
            let uu____4286 =
              let uu____4296 = unmeta_monadic f2  in head_and_args uu____4296
               in
             ...
             | (t,args) ->
                 ...
                 let uu____4315 =
                   (is_constructor t1 lid) &&
                    ...
                    in
                 if uu____4315 then Some (BaseConn (lid, args)) else None)
         in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          (pats, uu____4366)
      | uu____4373 ->
          let uu____4374 = FStar_Syntax_Subst.compress t1  in
          ([], uu____4374)
       in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____4464  ->
                      ...
                      | (t3,imp) ->
                          let uu____4471 = unascribe t3  in (uu____4471, imp)))
               in
    ...
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding None uu____4914
          ...
          FStar_Syntax_Const.effect_Tot_lid uu____4922
         in
      {
...
let incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let uu____5160 = delta_qualifier t  in incr_delta_depth uu____5160
...
let rec list_elements :
  ...
  fun e  ->
    let uu____5176 = let uu____5186 = unmeta e  in head_and_args uu____5186
       in
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____5403 =
          let uu____5404 =
            let uu____5405 = FStar_Syntax_Syntax.iarg typ  in [uu____5405]
             in
