...
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (_39_1534) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
let _39_1615 = (let _136_598 = (unmeta e)
in (head_and_args _136_598))
in (match (_39_1615) with
| (head, args) -> begin
(match ((let _136_600 = (let _136_599 = (un_uinst head)
in _136_599.FStar_Syntax_Syntax.n)
in ((_136_600), (args)))) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), _39_1619) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.nil_lid) -> begin
Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_39_1632)::((hd, _39_1629))::((tl, _39_1625))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.cons_lid) -> begin
