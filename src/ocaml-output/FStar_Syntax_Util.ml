...
let rec eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___166_2055 = if uu___166_2055 then Equal else Unknown
         in
      let equal_iff uu___167_2060 = if uu___167_2060 then Equal else NotEqual
         in
  ...
  fun phi  ->
    let uu____4809 =
      let uu____4812 =
        let uu____4813 =
          let uu____4828 =
            let uu____4831 = FStar_Syntax_Syntax.as_arg phi  in [uu____4831]
             in
          (t_not, uu____4828)  in
  ...
  fun e  ->
    let uu____4903 =
      let uu____4906 =
        let uu____4907 =
          let uu____4922 =
            let uu____4925 = FStar_Syntax_Syntax.as_arg e  in [uu____4925]
             in
          (b2t_v, uu____4922)  in
  ...
  fun f  ->
    ...
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____6236 =
        ...
        | (lid,arity) ->
            let uu____6245 =
              let uu____6260 = unmeta_monadic f2  in head_and_args uu____6260
               in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          (pats, uu____6361)
      | uu____6372 ->
          let uu____6373 = FStar_Syntax_Subst.compress t1  in
          ([], uu____6373)
       in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____6501  ->
                      ...
                      | (t3,imp) ->
                          let uu____6512 = unascribe t3  in (uu____6512, imp)))
               in
    ...
    fun a  ->
      let lb =
        ...
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7845
          ...
          FStar_Parser_Const.effect_Tot_lid uu____7855
         in
      {
  ...
  fun t  ->
    ...
    let uu____7881 =
      let uu____7884 =
        let uu____7885 =
          let uu____7900 =
            let uu____7903 = FStar_Syntax_Syntax.as_arg t  in [uu____7903]
             in
...
let incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let uu____8137 = delta_qualifier t  in incr_delta_depth uu____8137
...
let rec list_elements :
  ...
  =
  fun e  ->
    let uu____8159 = let uu____8174 = unmeta e  in head_and_args uu____8174
       in
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____8451 =
          let uu____8452 =
            let uu____8453 = FStar_Syntax_Syntax.iarg typ  in [uu____8453]
             in
...
let rec sizeof : FStar_Syntax_Syntax.term -> Prims.int =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_delayed uu____9676 ->
        let uu____9701 =
          let uu____9702 = FStar_Syntax_Subst.compress t  in
          sizeof uu____9702  in
            ...
            (fun acc  ->
               fun uu____9749  ->
                 ...
                 | (bv,uu____9755) ->
                     ...
                     acc + uu____9756) (Prims.parse_int "0") bs
           in
