      ...
      (FStar_List.append lid.FStar_Ident.ns
         [ FStar_Ident.mk_ident
             ( Prims.strcat FStar_Ident.reserved_prefix
                 (Prims.strcat "is_" lid.FStar_Ident.ident.FStar_Ident.idText)
...
let arg_of_non_null_binder:
  ...
  fun uu____29 ->
    match uu____29 with b, imp ->
      let uu____36 = FStar_Syntax_Syntax.bv_to_name b in
      (uu____36, imp)
...
let args_of_non_null_binders
  ...
  fun binders ->
    FStar_All.pipe_right binders
      (FStar_List.collect (fun b ->
           let uu____59 = FStar_Syntax_Syntax.is_null_binder b in
           if uu____59 then []
           else
             let uu____71 = arg_of_non_null_binder b in
             [uu____71] ))
        ...
        (FStar_List.map (fun b ->
             ...
             if uu____141 then
               let b1 =
                 ...
                 in
                 (uu____159, FStar_Pervasives_Native.snd b)
               in
               let uu____160 = arg_of_non_null_binder b1 in
               (b1, uu____160)
             else
               let uu____174 = arg_of_non_null_binder b in
               (b, uu____174) ))
    in
  ...
  fun binders ->
    FStar_All.pipe_right binders
      (FStar_List.mapi (fun i b ->
           ...
           if uu____256 then
             let uu____261 = b in
             match uu____261 with a, imp ->
               let b1 =
                 let uu____269 =
                   let uu____270 = FStar_Util.string_of_int i in
                   Prims.strcat "_" uu____270
                 in
                 FStar_Ident.id_of_text uu____269
               in
               let b2 =
  ...
  fun t ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (binders, comp) ->
        let uu____302 =
          let uu____305 =
            let uu____306 =
              let uu____319 = name_binders binders in
              (uu____319, comp)
            in
            FStar_Syntax_Syntax.Tm_arrow uu____306
          in
          FStar_Syntax_Syntax.mk uu____305
        in
...
let null_binders_of_tks
    : ( FStar_Syntax_Syntax.typ
      , FStar_Syntax_Syntax.aqual )
      FStar_Pervasives_Native.tuple2
      Prims.list -> FStar_Syntax_Syntax.binders =
  fun tks ->
    FStar_All.pipe_right tks
      (FStar_List.map (fun uu____377 ->
           match uu____377 with t, imp ->
             let uu____388 =
...
let binders_of_tks
  ...
  fun tks ->
    FStar_All.pipe_right tks
      (FStar_List.map (fun uu____439 ->
           match uu____439 with t, imp ->
             let uu____456 =
...
let mk_subst: 'Auu____475. 'Auu____475 -> 'Auu____475 Prims.list = fun s -> [s]

let subst_of_list
    : FStar_Syntax_Syntax.binders -> FStar_Syntax_Syntax.args
      -> FStar_Syntax_Syntax.subst_t =
  fun formals actuals ->
    if FStar_List.length formals = FStar_List.length actuals then
      FStar_List.fold_right2
        (fun f a out ->
          FStar_Syntax_Syntax.NT
            (FStar_Pervasives_Native.fst f, FStar_Pervasives_Native.fst a)
          :: out )
        formals actuals []
...
let rename_binders
    : FStar_Syntax_Syntax.binders -> FStar_Syntax_Syntax.binders
      -> FStar_Syntax_Syntax.subst_t =
  fun replace_xs with_ys ->
    if FStar_List.length replace_xs = FStar_List.length with_ys then
      FStar_List.map2
        (fun uu____562 uu____563 ->
          match (uu____562, uu____563) with (x, uu____581), (y, uu____583) ->
            let uu____592 =
              let uu____599 = FStar_Syntax_Syntax.bv_to_name y in
              (x, uu____599)
            in
            FStar_Syntax_Syntax.NT uu____592 )
        replace_xs with_ys
    else failwith "Ill-formed substitution"
...
let constant_univ_as_nat : FStar_Syntax_Syntax.universe -> Prims.int =
  fun u ->
    let uu____783 = univ_kernel u in
    FStar_Pervasives_Native.snd uu____783
...
let rec compare_univs
  ...
  fun u1 u2 ->
    ...
    | ( FStar_Syntax_Syntax.U_name uu____804
      , FStar_Syntax_Syntax.U_unif uu____805 ) ->
        -Prims.parse_int "1"
    | ( FStar_Syntax_Syntax.U_unif uu____814
      , FStar_Syntax_Syntax.U_name uu____815 ) ->
        Prims.parse_int "1"
    ...
    | FStar_Syntax_Syntax.U_max us1, FStar_Syntax_Syntax.U_max us2 -> (
        ...
        if n1 <> n2 then n1 - n2
          ...
          let copt =
            ...
            FStar_Util.find_map uu____874 (fun uu____889 ->
                match uu____889 with u11, u21 ->
                  let c = compare_univs u11 u21 in
                  if c <> Prims.parse_int "0" then
    ...
    | FStar_Syntax_Syntax.U_max uu____903, uu____904 -> -Prims.parse_int "1"
    | uu____907, FStar_Syntax_Syntax.U_max uu____908 -> Prims.parse_int "1"
    | uu____911 ->
        let uu____916 = univ_kernel u1 in
        match uu____916 with k1, n1 ->
          let uu____923 = univ_kernel u2 in
          match uu____923 with k2, n2 ->
...
let comp_effect_name
  ...
  fun c ->
    ...
    | FStar_Syntax_Syntax.Total uu____963 -> FStar_Parser_Const.effect_Tot_lid
...
let comp_flags
  ...
  fun c ->
    ...
    | FStar_Syntax_Syntax.GTotal uu____1001 -> [FStar_Syntax_Syntax.SOMETRIVIAL]
    | FStar_Syntax_Syntax.Comp ct -> ct.FStar_Syntax_Syntax.flags


let comp_set_flags
    : FStar_Syntax_Syntax.comp -> FStar_Syntax_Syntax.cflags Prims.list
      -> FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax =
  fun c f ->
    ...
    let uu____1085 =
      ...
      in
      FStar_Syntax_Syntax.Comp uu____1086
    in
  ...
  fun lc fs ->
    let comp_typ_set_flags c =
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          ...
          ; FStar_Syntax_Syntax.pos= uu___53_1123.FStar_Syntax_Syntax.pos
          ; FStar_Syntax_Syntax.vars= uu___53_1123.FStar_Syntax_Syntax.vars }
    in
    FStar_Syntax_Syntax.mk_lcomp lc.FStar_Syntax_Syntax.eff_name
      lc.FStar_Syntax_Syntax.res_typ fs (fun uu____1126 ->
        let uu____1127 = FStar_Syntax_Syntax.lcomp_comp lc in
        comp_typ_set_flags uu____1127 )


let comp_to_comp_typ : FStar_Syntax_Syntax.comp -> FStar_Syntax_Syntax.comp_typ =
  fun c ->
    match c.FStar_Syntax_Syntax.n with
...
let is_total_comp
  ...
  fun c ->
    ...
    || FStar_All.pipe_right (comp_flags c)
         (FStar_Util.for_some (fun uu___38_1197 ->
...
let is_total_lcomp : FStar_Syntax_Syntax.lcomp -> Prims.bool =
  fun c ->
    ...
    || FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags
         (FStar_Util.for_some (fun uu___39_1205 ->
...
let is_tot_or_gtot_lcomp : FStar_Syntax_Syntax.lcomp -> Prims.bool =
  fun c ->
    ...
    || FStar_Ident.lid_equals c.FStar_Syntax_Syntax.eff_name
         FStar_Parser_Const.effect_GTot_lid )
    || FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags
         (FStar_Util.for_some (fun uu___40_1213 ->
...
let is_partial_return
  ...
  fun c ->
    FStar_All.pipe_right (comp_flags c)
      (FStar_Util.for_some (fun uu___41_1225 ->
...
let is_lcomp_partial_return : FStar_Syntax_Syntax.lcomp -> Prims.bool =
  fun c ->
    FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags
      (FStar_Util.for_some (fun uu___42_1233 ->
...
let is_pure_comp
  ...
  fun c ->
    ...
    | FStar_Syntax_Syntax.Comp ct ->
        (is_total_comp c || is_pure_effect ct.FStar_Syntax_Syntax.effect_name)
        || FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
             (FStar_Util.for_some (fun uu___43_1274 ->
...
let is_pure_lcomp : FStar_Syntax_Syntax.lcomp -> Prims.bool =
  fun lc ->
    ...
    || FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags
         (FStar_Util.for_some (fun uu___44_1292 ->
...
let is_pure_or_ghost_lcomp : FStar_Syntax_Syntax.lcomp -> Prims.bool =
  fun lc -> is_pure_lcomp lc || is_ghost_effect lc.FStar_Syntax_Syntax.eff_name
...
let is_pure_or_ghost_function : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t ->
    let uu____1300 =
      ...
      uu____1301.FStar_Syntax_Syntax.n
    in
...
let is_lemma : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t ->
    let uu____1335 =
      ...
      uu____1336.FStar_Syntax_Syntax.n
    in
...
let rec head_and_args'
  ...
  fun t ->
    ...
    | FStar_Syntax_Syntax.Tm_app (head1, args) -> (
        ...
        match uu____1487 with head2, args' ->
  ...
  fun c ->
    ...
    | FStar_Syntax_Syntax.Comp c1 ->
        ...
        || FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
             (FStar_Util.for_some (fun uu___45_1709 ->
...
let set_result_typ
  ...
  fun c t ->
    match c.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Total uu____1754 -> FStar_Syntax_Syntax.mk_Total t
    | FStar_Syntax_Syntax.GTotal uu____1763 -> FStar_Syntax_Syntax.mk_GTotal t
    | FStar_Syntax_Syntax.Comp ct ->
        FStar_Syntax_Syntax.mk_Comp
          (let uu___54_1775 = ct in
           ...
           ; FStar_Syntax_Syntax.flags= uu___54_1775.FStar_Syntax_Syntax.flags
           })
...
let is_trivial_wp
  ...
  fun c ->
    FStar_All.pipe_right (comp_flags c)
      (FStar_Util.for_some (fun uu___46_1786 ->
...
type eq_result = Equal | NotEqual | Unknown [@@deriving show]

let uu___is_Equal : eq_result -> Prims.bool =
  fun projectee -> match projectee with Equal -> true | uu____1965 -> false
...
let uu___is_Unknown : eq_result -> Prims.bool =
  fun projectee -> match projectee with Unknown -> true | uu____1973 -> false
...
let rec eq_tm
  ...
  fun t1 t2 ->
    let canon_app t =
      let uu____1996 =
        let uu____2009 = unascribe t in
        head_and_args' uu____2009
      in
      match uu____1996 with hd1, args ->
      ...
      if uu____2107 then
        ...
        FStar_All.pipe_left
          (FStar_List.fold_left
             (fun acc uu____2169 ->
               match uu____2169 with (a1, q1), (a2, q2) ->
                 let uu____2197 = eq_tm a1 a2 in
                 eq_inj acc uu____2197 )
             Equal)
          uu____2111
      else NotEqual
    in
    ...
    | FStar_Syntax_Syntax.Tm_bvar bv1, FStar_Syntax_Syntax.Tm_bvar bv2 ->
        equal_if (bv1.FStar_Syntax_Syntax.index = bv2.FStar_Syntax_Syntax.index)
    | FStar_Syntax_Syntax.Tm_name a, FStar_Syntax_Syntax.Tm_name b ->
        equal_if (FStar_Syntax_Syntax.bv_eq a b)
    | FStar_Syntax_Syntax.Tm_fvar f, FStar_Syntax_Syntax.Tm_fvar g ->
        if f.FStar_Syntax_Syntax.fv_qual
        ...
        then equal_data f [] g []
          ...
          equal_if uu____2218
    | FStar_Syntax_Syntax.Tm_uinst (f, us), FStar_Syntax_Syntax.Tm_uinst (g, vs) ->
        let uu____2231 = eq_tm f g in
        eq_and uu____2231 (fun uu____2234 ->
            let uu____2235 = eq_univs_list us vs in
            equal_if uu____2235 )
    | ( FStar_Syntax_Syntax.Tm_constant FStar_Const.Const_range uu____2236
      , uu____2237 ) ->
        Unknown
    | ( uu____2238
      , FStar_Syntax_Syntax.Tm_constant FStar_Const.Const_range uu____2239 ) ->
        Unknown
    | FStar_Syntax_Syntax.Tm_constant c, FStar_Syntax_Syntax.Tm_constant d ->
        let uu____2242 = FStar_Const.eq_const c d in
        equal_iff uu____2242
    | ( FStar_Syntax_Syntax.Tm_uvar (u1, uu____2244)
      , FStar_Syntax_Syntax.Tm_uvar (u2, uu____2246) ) ->
      ...
      -> (
        let uu____2340 =
          let uu____2345 =
            ...
            uu____2346.FStar_Syntax_Syntax.n
          in
          let uu____2349 =
            let uu____2350 = un_uinst h2 in
            uu____2350.FStar_Syntax_Syntax.n
          in
          (uu____2345, uu____2349)
        in
        match uu____2340 with
        | FStar_Syntax_Syntax.Tm_fvar f1, FStar_Syntax_Syntax.Tm_fvar f2
          when f1.FStar_Syntax_Syntax.fv_qual
               = FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor
               && f2.FStar_Syntax_Syntax.fv_qual
                  = FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor ->
            equal_data f1 args1 f2 args2
        | FStar_Syntax_Syntax.Tm_fvar f1, FStar_Syntax_Syntax.Tm_fvar f2
          when FStar_Syntax_Syntax.fv_eq f1 f2
               &&
               let uu____2362 =
                 let uu____2363 = FStar_Syntax_Syntax.lid_of_fv f1 in
                 FStar_Ident.string_of_lid uu____2363
               in
    ...
    | FStar_Syntax_Syntax.Tm_type u, FStar_Syntax_Syntax.Tm_type v1 ->
        let uu____2374 = eq_univs u v1 in
        equal_if uu____2374
...
and eq_args : FStar_Syntax_Syntax.args -> FStar_Syntax_Syntax.args -> eq_result =
  fun a1 a2 ->
    match (a1, a2) with
    | [], [] -> Equal
    | (a, uu____2425) :: a11, (b, uu____2428) :: b1 -> (
        let uu____2482 = eq_tm a b in
        match uu____2482 with Equal -> eq_args a11 b1 | uu____2483 -> Unknown )
    | uu____2484 -> Unknown


and eq_univs_list
    : FStar_Syntax_Syntax.universes -> FStar_Syntax_Syntax.universes
      -> Prims.bool =
  fun us vs ->
...
let rec is_unit : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t ->
    let uu____2548 =
      let uu____2549 = unrefine t in
      uu____2549.FStar_Syntax_Syntax.n
    in
    match uu____2548 with
    | FStar_Syntax_Syntax.Tm_fvar fv ->
        ( FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.unit_lid
        || FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid )
        || FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.auto_squash_lid
...
let rec non_informative : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t ->
    let uu____2563 =
      let uu____2564 = unrefine t in
      uu____2564.FStar_Syntax_Syntax.n
    in
...
let is_fun : FStar_Syntax_Syntax.term -> Prims.bool =
  fun e ->
    let uu____2619 =
      ...
      uu____2620.FStar_Syntax_Syntax.n
    in
...
let is_function_typ : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t ->
    let uu____2644 =
      ...
      uu____2645.FStar_Syntax_Syntax.n
    in
...
let destruct
  ...
  fun typ lid ->
    ...
    let uu____2733 =
      let uu____2734 = un_uinst typ1 in
    ...
    | FStar_Syntax_Syntax.Tm_app (head1, args) -> (
        ...
        | FStar_Syntax_Syntax.Tm_fvar tc
          when FStar_Syntax_Syntax.fv_eq_lid tc lid ->
            FStar_Pervasives_Native.Some args
        | uu____2789 -> FStar_Pervasives_Native.None )
    | FStar_Syntax_Syntax.Tm_fvar tc when FStar_Syntax_Syntax.fv_eq_lid tc lid ->
...
let lids_of_sigelt
  ...
  fun se ->
    ...
    | FStar_Syntax_Syntax.Sig_effect_abbrev
        (lid, uu____2860, uu____2861, uu____2862, uu____2863) ->
        [lid]
    | FStar_Syntax_Syntax.Sig_datacon
        (lid, uu____2869, uu____2870, uu____2871, uu____2872, uu____2873) ->
        [lid]
    | FStar_Syntax_Syntax.Sig_declare_typ (lid, uu____2879, uu____2880) -> [lid]
...
let range_of_lb:
      ...
      ( (FStar_Syntax_Syntax.bv, FStar_Ident.lid) FStar_Util.either
      , 'Auu____2914
      , 'Auu____2913 )
      FStar_Pervasives_Native.tuple3 -> FStar_Range.range =
  fun uu___49_2928 ->
    match uu___49_2928 with
...
let range_of_arg:
      ...
      ( 'Auu____2957 FStar_Syntax_Syntax.syntax
      , 'Auu____2956 )
...
let range_of_args:
      ...
      ( 'Auu____2985 FStar_Syntax_Syntax.syntax
      , 'Auu____2984 )
      FStar_Pervasives_Native.tuple2
      Prims.list -> FStar_Range.range -> FStar_Range.range =
  fun args r ->
    FStar_All.pipe_right args
      (FStar_List.fold_left
         (fun r1 a -> FStar_Range.union_ranges r1 (range_of_arg a))
         r)
    ...
    | [] ->
        let uu____3105 =
          let uu____3108 =
            ...
            in
            FStar_Syntax_Syntax.Tm_meta uu____3109
          in
          FStar_Syntax_Syntax.mk uu____3108
        in
        uu____3105 FStar_Pervasives_Native.None (FStar_Ident.range_of_lid l)
    | uu____3120 ->
        let e =
          let uu____3132 =
            FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant
...
let mangle_field_name : FStar_Ident.ident -> FStar_Ident.ident =
  fun x ->
    FStar_Ident.mk_ident
      (Prims.strcat "__fname__" x.FStar_Ident.idText, x.FStar_Ident.idRange)


let unmangle_field_name : FStar_Ident.ident -> FStar_Ident.ident =
  fun x ->
    if FStar_Util.starts_with x.FStar_Ident.idText "__fname__" then
      let uu____3143 =
        let uu____3148 =
          FStar_Util.substring_from x.FStar_Ident.idText (Prims.parse_int "9")
        in
        (uu____3148, x.FStar_Ident.idRange)
      in
...
let mk_field_projector_name_from_ident
  ...
  fun lid i ->
    ...
    let newi =
      if field_projector_contains_constructor jtext then j
      else
        FStar_Ident.mk_ident
...
let mk_field_projector_name
    : FStar_Ident.lident -> FStar_Syntax_Syntax.bv -> Prims.int
      -> ( FStar_Ident.lident
         , FStar_Syntax_Syntax.bv )
         FStar_Pervasives_Native.tuple2 =
  fun lid x i ->
      ...
      if uu____3183 then
        let uu____3184 =
          let uu____3189 =
            ...
            Prims.strcat "_" uu____3190
          in
          let uu____3191 = FStar_Syntax_Syntax.range_of_bv x in
          (uu____3189, uu____3191)
        in
        FStar_Ident.mk_ident uu____3184
      else x.FStar_Syntax_Syntax.ppname
    in
    let y =
      let uu___55_3194 = x in
      { FStar_Syntax_Syntax.ppname= nm
      ; FStar_Syntax_Syntax.index= uu___55_3194.FStar_Syntax_Syntax.index
      ; FStar_Syntax_Syntax.sort= uu___55_3194.FStar_Syntax_Syntax.sort }
    in
    ...
    | FStar_Pervasives_Native.Some uu____3205 ->
        let uu____3206 =
          let uu____3207 =
            ...
            FStar_All.pipe_left FStar_Util.string_of_int uu____3208
          in
...
let qualifier_equal
    : FStar_Syntax_Syntax.qualifier -> FStar_Syntax_Syntax.qualifier
      -> Prims.bool =
  fun q1 q2 ->
    match (q1, q2) with
    ...
    | ( FStar_Syntax_Syntax.RecordType (ns1, f1)
      , FStar_Syntax_Syntax.RecordType (ns2, f2) ) ->
        ( ( FStar_List.length ns1 = FStar_List.length ns2
          && FStar_List.forall2
               (fun x1 x2 -> x1.FStar_Ident.idText = x2.FStar_Ident.idText)
               f1 f2 )
  ...
  fun bs t lopt ->
    let close_lopt lopt1 =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____3311 =
            let uu___56_3312 = rc in
            let uu____3313 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (FStar_Syntax_Subst.close bs)
            in
            { FStar_Syntax_Syntax.residual_effect=
                uu___56_3312.FStar_Syntax_Syntax.residual_effect
            ; FStar_Syntax_Syntax.residual_typ= uu____3313
            ; FStar_Syntax_Syntax.residual_flags=
                uu___56_3312.FStar_Syntax_Syntax.residual_flags }
          in
          FStar_Pervasives_Native.Some uu____3311
    in
    match bs with
    | [] -> t
    | uu____3324 ->
        let body =
          ...
          FStar_Syntax_Subst.compress uu____3326
        in
              ...
              let uu____3357 =
                let uu____3358 =
                  let uu____3375 =
                    ...
                    FStar_List.append uu____3382 bs'
                  in
                  let uu____3393 = close_lopt lopt' in
                  (uu____3375, t1, uu____3393)
                in
                FStar_Syntax_Syntax.Tm_abs uu____3358
              in
              FStar_Syntax_Syntax.mk uu____3357
            in
            uu____3354 FStar_Pervasives_Native.None t1.FStar_Syntax_Syntax.pos
        | uu____3409 ->
            let uu____3416 =
              let uu____3419 =
                let uu____3420 =
                  ...
                  (uu____3437, body, uu____3438)
                in
                FStar_Syntax_Syntax.Tm_abs uu____3420
              in
              FStar_Syntax_Syntax.mk uu____3419
            in
            uu____3416 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos
    ...
    | uu____3476 ->
        let uu____3483 =
          let uu____3486 =
            ...
            in
            FStar_Syntax_Syntax.Tm_arrow uu____3487
          in
          FStar_Syntax_Syntax.mk uu____3486
        in
...
let flat_arrow
  ...
  fun bs c ->
    ...
    let uu____3532 =
      ...
      uu____3533.FStar_Syntax_Syntax.n
    in
    ...
    | FStar_Syntax_Syntax.Tm_arrow (bs1, c1) -> (
      ...
      | FStar_Syntax_Syntax.Total (tres, uu____3559) -> (
          ...
          | FStar_Syntax_Syntax.Tm_arrow (bs', c') ->
              FStar_Syntax_Syntax.mk
                (FStar_Syntax_Syntax.Tm_arrow (FStar_List.append bs1 bs', c'))
                FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos
          | uu____3604 -> t )
      | uu____3605 -> t )
    | uu____3606 -> t
...
let refine
  ...
  fun b t ->
    let uu____3615 =
      ...
      FStar_Range.union_ranges uu____3616 t.FStar_Syntax_Syntax.pos
    in
    let uu____3617 =
      let uu____3620 =
        let uu____3621 =
          let uu____3628 =
            let uu____3629 =
              ...
              [uu____3630]
            in
            FStar_Syntax_Subst.close uu____3629 t
          in
          (b, uu____3628)
        in
        FStar_Syntax_Syntax.Tm_refine uu____3621
      in
      FStar_Syntax_Syntax.mk uu____3620
    in
...
let rec arrow_formals_comp
  ...
  fun k ->
    ...
    | uu____3763 ->
        let uu____3764 = FStar_Syntax_Syntax.mk_Total k1 in
        ([], uu____3764)
...
let abs_formals
  ...
  fun t ->
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____3866 =
            let uu___57_3867 = rc in
            let uu____3868 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (FStar_Syntax_Subst.subst s)
            in
            { FStar_Syntax_Syntax.residual_effect=
                uu___57_3867.FStar_Syntax_Syntax.residual_effect
            ; FStar_Syntax_Syntax.residual_typ= uu____3868
            ; FStar_Syntax_Syntax.residual_flags=
                uu___57_3867.FStar_Syntax_Syntax.residual_flags }
          in
    ...
    let rec aux t1 abs_body_lcomp =
      let uu____3903 =
        let uu____3904 =
          ...
          FStar_All.pipe_left unascribe uu____3907
        in
        uu____3904.FStar_Syntax_Syntax.n
      in
      match uu____3903 with
      | FStar_Syntax_Syntax.Tm_abs (bs, t2, what) -> (
          let uu____3945 = aux t2 what in
          match uu____3945 with bs', t3, what1 ->
            (FStar_List.append bs bs', t3, what1) )
      | uu____4005 -> ([], t1, abs_body_lcomp)
    in
    let uu____4018 = aux t FStar_Pervasives_Native.None in
    match uu____4018 with bs, t1, abs_body_lcomp ->
      let uu____4060 = FStar_Syntax_Subst.open_term' bs t1 in
      match uu____4060 with bs1, t2, opening ->
...
let mk_letbinding
  ...
  fun lbname univ_vars typ eff def lbattrs ->
...
let close_univs_and_mk_letbinding
    : FStar_Syntax_Syntax.fv Prims.list FStar_Pervasives_Native.option
      -> (FStar_Syntax_Syntax.bv, FStar_Syntax_Syntax.fv) FStar_Util.either
      -> FStar_Ident.ident Prims.list -> FStar_Syntax_Syntax.term
      -> FStar_Ident.lident -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax Prims.list
      -> FStar_Syntax_Syntax.letbinding =
  fun recs lbname univ_vars typ eff def attrs ->
    let def1 =
      ...
      | FStar_Pervasives_Native.Some fvs, uu____4208 ->
          let universes =
            FStar_All.pipe_right univ_vars
              (FStar_List.map (fun _0_27 -> FStar_Syntax_Syntax.U_name _0_27))
          in
          let inst1 =
...
let open_univ_vars_binders_and_comp
  ...
  fun uvs binders c ->
    ...
    | uu____4337 ->
        ...
        match uu____4347 with uvs1, t'1 ->
          let uu____4366 =
            let uu____4367 = FStar_Syntax_Subst.compress t'1 in
            uu____4367.FStar_Syntax_Syntax.n
          in
          match uu____4366 with
          | FStar_Syntax_Syntax.Tm_arrow (binders1, c1) -> (uvs1, binders1, c1)
...
let is_constructor
  ...
  fun t lid ->
    let uu____4462 =
      let uu____4463 = pre_typ t in
      uu____4463.FStar_Syntax_Syntax.n
    in
...
let rec is_constructed_typ
  ...
  fun t lid ->
    let uu____4474 =
      let uu____4475 = pre_typ t in
      uu____4475.FStar_Syntax_Syntax.n
    in
    match uu____4474 with
    | FStar_Syntax_Syntax.Tm_fvar uu____4478 -> is_constructor t lid
    | FStar_Syntax_Syntax.Tm_app (t1, uu____4480) -> is_constructed_typ t1 lid
...
let rec get_tycon
  ...
  fun t ->
    let t1 = pre_typ t in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_bvar uu____4516 -> FStar_Pervasives_Native.Some t1
    | FStar_Syntax_Syntax.Tm_name uu____4517 -> FStar_Pervasives_Native.Some t1
    | FStar_Syntax_Syntax.Tm_fvar uu____4518 -> FStar_Pervasives_Native.Some t1
...
let is_fstar_tactics_embed : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t ->
    let uu____4551 =
      let uu____4552 = un_uinst t in
      uu____4552.FStar_Syntax_Syntax.n
    in
...
let is_fstar_tactics_quote : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t ->
    let uu____4560 =
      let uu____4561 = un_uinst t in
      uu____4561.FStar_Syntax_Syntax.n
    in
...
let is_fstar_tactics_by_tactic : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t ->
    let uu____4569 =
      let uu____4570 = un_uinst t in
      uu____4570.FStar_Syntax_Syntax.n
    in
...
let is_builtin_tactic : FStar_Ident.lident -> Prims.bool =
  fun md ->
    ...
    if FStar_List.length path > Prims.parse_int "2" then
      let uu____4581 =
        let uu____4584 = FStar_List.splitAt (Prims.parse_int "2") path in
        FStar_Pervasives_Native.fst uu____4584
      in
...
let type_u
  ...
  fun uu____4611 ->
    let u =
      ...
      FStar_All.pipe_left
        (fun _0_28 -> FStar_Syntax_Syntax.U_unif _0_28)
        uu____4617
    in
    let uu____4634 =
...
let attr_substitute : FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax =
  let uu____4641 =
    let uu____4644 =
      ...
      in
      FStar_Syntax_Syntax.Tm_fvar uu____4645
    in
    FStar_Syntax_Syntax.mk uu____4644
  in
              ...
              let uu____4701 =
                let uu____4716 =
                  ...
                  let uu____4720 =
                    ...
                    [uu____4723]
                  in
                  uu____4719 :: uu____4720
                in
                (tand, uu____4716)
              in
              FStar_Syntax_Syntax.Tm_app uu____4701
            in
            FStar_Syntax_Syntax.mk uu____4700
          in
...
let mk_binop
  ...
  fun op_t phi1 phi2 ->
    ...
    let uu____4747 =
      ...
      in
      FStar_Syntax_Syntax.mk uu____4750
    in
  ...
  fun phi ->
    let uu____4786 =
      let uu____4789 =
        let uu____4790 =
          let uu____4805 =
            let uu____4808 = FStar_Syntax_Syntax.as_arg phi in
            [uu____4808]
          in
          (t_not, uu____4805)
        in
        FStar_Syntax_Syntax.Tm_app uu____4790
      in
      FStar_Syntax_Syntax.mk uu____4789
    in
...
let mk_conj
    : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax =
  fun phi1 phi2 -> mk_binop tand phi1 phi2


let mk_conj_l : FStar_Syntax_Syntax.term Prims.list -> FStar_Syntax_Syntax.term =
  fun phi ->
    match phi with
    | [] ->
...
let mk_disj
    : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax =
  fun phi1 phi2 -> mk_binop tor phi1 phi2


let mk_disj_l : FStar_Syntax_Syntax.term Prims.list -> FStar_Syntax_Syntax.term =
  fun phi ->
    match phi with
    | [] -> t_false
...
let mk_imp
    : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun phi1 phi2 -> mk_binop timp phi1 phi2


let mk_iff
    : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
      -> FStar_Syntax_Syntax.term =
  fun phi1 phi2 -> mk_binop tiff phi1 phi2
    ...
    let uu____4869 =
      let uu____4872 =
        let uu____4873 =
          ...
          (b2t_v, uu____4888)
        in
        FStar_Syntax_Syntax.Tm_app uu____4873
      in
      FStar_Syntax_Syntax.mk uu____4872
    in
...
let mk_untyped_eq2
  ...
  fun e1 e2 ->
    ...
    let uu____4906 =
      ...
      in
      FStar_Syntax_Syntax.mk uu____4909
    in
      ...
      let uu____4955 =
        let uu____4956 =
          let uu____4971 =
            ...
            in
            uu____4974 :: uu____4975
          in
          (eq_inst, uu____4971)
        in
        FStar_Syntax_Syntax.Tm_app uu____4956
      in
      FStar_Syntax_Syntax.mk uu____4955
    in
    ...
    let uu____5005 =
      let uu____5008 =
        let uu____5009 =
          ...
          in
          (t_has_type1, uu____5024)
        in
        FStar_Syntax_Syntax.Tm_app uu____5009
      in
      FStar_Syntax_Syntax.mk uu____5008
    in
...
let mk_with_type
  ...
  fun u t e ->
    ...
    in
    let t_with_type1 =
      FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst (t_with_type, [u]))
        FStar_Pervasives_Native.None FStar_Range.dummyRange
    in
    let uu____5060 =
      let uu____5063 =
        let uu____5064 =
          ...
          in
          (t_with_type1, uu____5079)
        in
        FStar_Syntax_Syntax.Tm_app uu____5064
      in
      FStar_Syntax_Syntax.mk uu____5063
    in
      ...
      let uu____5100 =
        let uu____5107 =
          FStar_Syntax_Syntax.fvar FStar_Parser_Const.lextop_lid
            ...
            (FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor)
        in
        (uu____5107, [FStar_Syntax_Syntax.U_zero])
      in
      FStar_Syntax_Syntax.Tm_uinst uu____5100
    in
    FStar_Syntax_Syntax.mk uu____5099
  in
...
let lcomp_of_comp
  ...
  fun c0 ->
    ...
    in
    match uu____5120 with eff_name, flags1 ->
    ...
    let uu____5221 =
      let uu____5224 =
        let uu____5225 =
          let uu____5240 =
            let uu____5243 =
              FStar_Syntax_Syntax.iarg x.FStar_Syntax_Syntax.sort
            in
            let uu____5244 =
              let uu____5247 =
                let uu____5248 =
                ...
                in
                FStar_Syntax_Syntax.as_arg uu____5248
              in
              [uu____5247]
            in
          ...
          (fa, uu____5240)
        in
        FStar_Syntax_Syntax.Tm_app uu____5225
      in
...
let mk_forall_no_univ
    : FStar_Syntax_Syntax.bv -> FStar_Syntax_Syntax.typ
      -> FStar_Syntax_Syntax.typ =
  fun x body -> mk_forall_aux tforall x body


let mk_forall
    : FStar_Syntax_Syntax.universe -> FStar_Syntax_Syntax.bv
...
let close_forall_no_univs
    : FStar_Syntax_Syntax.binder Prims.list -> FStar_Syntax_Syntax.typ
      -> FStar_Syntax_Syntax.typ =
  fun bs f ->
    FStar_List.fold_right
      (fun b f1 ->
        let uu____5289 = FStar_Syntax_Syntax.is_null_binder b in
        if uu____5289 then f1
        else mk_forall_no_univ (FStar_Pervasives_Native.fst b) f1 )
      bs f
...
let if_then_else
  ...
  fun b t1 t2 ->
    let then_branch =
      ...
      in
      (uu____5338, FStar_Pervasives_Native.None, t1)
    in
    let else_branch =
      let uu____5366 =
        FStar_Syntax_Syntax.withinfo
      ...
      in
      (uu____5366, FStar_Pervasives_Native.None, t2)
    in
    let uu____5379 =
      let uu____5380 =
        FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos
          t2.FStar_Syntax_Syntax.pos
      in
      FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos uu____5380
    in
    FStar_Syntax_Syntax.mk
...
let mk_squash
  ...
  fun u p ->
    ...
    let uu____5453 =
      let uu____5462 = FStar_Syntax_Syntax.as_arg p in
      [uu____5462]
    in
...
let mk_auto_squash
  ...
  fun u p ->
    ...
    let uu____5475 =
      let uu____5484 = FStar_Syntax_Syntax.as_arg p in
      [uu____5484]
    in
...
let un_squash
  ...
  fun t ->
    ...
    match uu____5492 with head1, args ->
      let uu____5533 =
        let uu____5546 =
          let uu____5547 = un_uinst head1 in
          uu____5547.FStar_Syntax_Syntax.n
        in
        (uu____5546, args)
      in
      match uu____5533 with
      | FStar_Syntax_Syntax.Tm_fvar fv, [(p, uu____5564)]
          ...
          -> (
            let uu____5616 =
              let uu____5621 =
                ...
                [uu____5622]
              in
              FStar_Syntax_Subst.open_term uu____5621 p
            in
            match uu____5616 with bs, p1 ->
              let b1 =
                match bs with
                | [b1] -> b1
                | uu____5651 -> failwith "impossible"
              in
              let uu____5656 =
                let uu____5657 = FStar_Syntax_Free.names p1 in
                FStar_Util.set_mem (FStar_Pervasives_Native.fst b1) uu____5657
              in
              if uu____5656 then FStar_Pervasives_Native.None
...
let is_squash
  ...
  fun t ->
    ...
    match uu____5696 with head1, args ->
      let uu____5741 =
        let uu____5754 =
          let uu____5755 = FStar_Syntax_Subst.compress head1 in
          uu____5755.FStar_Syntax_Syntax.n
        in
        (uu____5754, args)
      in
      ...
      | ( FStar_Syntax_Syntax.Tm_uinst
            ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar fv
              ...
              ; FStar_Syntax_Syntax.vars= uu____5776; _ }
            , [u] )
        , [(t1, uu____5779)] )
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid ->
...
let is_auto_squash
  ...
  fun t ->
    ...
    match uu____5848 with head1, args ->
      let uu____5893 =
        let uu____5906 =
          let uu____5907 = FStar_Syntax_Subst.compress head1 in
          uu____5907.FStar_Syntax_Syntax.n
        in
        (uu____5906, args)
      in
      ...
      | ( FStar_Syntax_Syntax.Tm_uinst
            ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar fv
              ...
              ; FStar_Syntax_Syntax.vars= uu____5928; _ }
            , [u] )
        , [(t1, uu____5931)] )
...
let is_sub_singleton : FStar_Syntax_Syntax.term -> Prims.bool =
  fun t ->
    let uu____5992 =
      let uu____6007 = unmeta t in
      head_and_args uu____6007
    in
    match uu____5992 with head1, uu____6009 ->
      let uu____6030 =
        let uu____6031 = un_uinst head1 in
        uu____6031.FStar_Syntax_Syntax.n
      in
      ...
      | FStar_Syntax_Syntax.Tm_fvar fv ->
          ( ( ( ( ( ( ( ( ( ( ( ( ( ( ( ( FStar_Syntax_Syntax.fv_eq_lid fv
                ...
                || FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.eq3_lid
                )
              || FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.b2t_lid )
            || FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.haseq_lid )
          || FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.has_type_lid
          )
          || FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.precedes_lid
      | uu____6035 -> false
  ...
  fun t ->
    let uu____6051 =
      let uu____6064 =
        ...
        uu____6065.FStar_Syntax_Syntax.n
      in
      ...
      | FStar_Syntax_Syntax.Tm_arrow (b :: bs, c) ->
          let uu____6174 =
            let uu____6183 =
              ...
              FStar_Syntax_Syntax.mk_Total uu____6184
            in
            (b, uu____6183)
          in
    ...
    in
    FStar_Util.bind_opt uu____6051 (fun uu____6233 ->
        match uu____6233 with b, c ->
          let uu____6268 = FStar_Syntax_Subst.open_comp [b] c in
          match uu____6268 with bs, c1 ->
            let b1 =
              match bs with
              | [b1] -> b1
              | uu____6315 ->
...
let uu___is_QAll : connective -> Prims.bool =
  fun projectee -> match projectee with QAll _0 -> true | uu____6381 -> false
...
let uu___is_QEx : connective -> Prims.bool =
  fun projectee -> match projectee with QEx _0 -> true | uu____6417 -> false
...
let destruct_typ_as_formula
  ...
  fun f ->
    let rec unmeta_monadic f1 =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          (t, FStar_Syntax_Syntax.Meta_monadic uu____6484) ->
          unmeta_monadic t
      | FStar_Syntax_Syntax.Tm_meta
    ...
    let destruct_base_conn f1 =
      let connectives =
        ...
        ; (FStar_Parser_Const.eq3_lid, Prims.parse_int "2") ]
      in
      let aux f2 uu____6587 =
        match uu____6587 with lid, arity ->
          let uu____6596 =
            let uu____6611 = unmeta_monadic f2 in
            head_and_args uu____6611
          in
          match uu____6596 with t, args ->
            let t1 = un_uinst t in
            let uu____6637 =
              is_constructor t1 lid && FStar_List.length args = arity
            in
            if uu____6637 then
              FStar_Pervasives_Native.Some (BaseConn (lid, args))
            else FStar_Pervasives_Native.None
      in
      FStar_Util.find_map connectives (aux f1)
    in
    let patterns t =
      let t1 = FStar_Syntax_Subst.compress t in
      match t1.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Tm_meta (t2, FStar_Syntax_Syntax.Meta_pattern pats) ->
    ...
    let destruct_q_conn t =
      ...
      let flat t1 =
        ...
        match uu____6770 with t2, args ->
          let uu____6817 = un_uinst t2 in
          let uu____6818 =
            FStar_All.pipe_right args
              (FStar_List.map (fun uu____6851 ->
                   match uu____6851 with t3, imp ->
                     let uu____6862 = unascribe t3 in
                     (uu____6862, imp) ))
          in
      ...
      let rec aux qopt out t1 =
        ...
        | ( FStar_Pervasives_Native.Some fa
          , ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar tc
            ...
            , [ ( { FStar_Syntax_Syntax.n=
                      FStar_Syntax_Syntax.Tm_abs ([b], t2, uu____6945)
        ...
        | ( FStar_Pervasives_Native.Some fa
          , ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar tc
              ...
              ; FStar_Syntax_Syntax.vars= uu____7026; _ }
            , [ uu____7027
              ; ( { FStar_Syntax_Syntax.n=
                      FStar_Syntax_Syntax.Tm_abs ([b], t2, uu____7030)
                  ; FStar_Syntax_Syntax.pos= uu____7031
                  ; FStar_Syntax_Syntax.vars= uu____7032; _ }
                , uu____7033 ) ] ) )
          when is_q fa tc ->
            aux qopt (b :: out) t2
        | ( FStar_Pervasives_Native.None
          , ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar tc
            ...
            , [ ( { FStar_Syntax_Syntax.n=
                      FStar_Syntax_Syntax.Tm_abs ([b], t2, uu____7125)
                  ; FStar_Syntax_Syntax.pos= uu____7126
                  ; FStar_Syntax_Syntax.vars= uu____7127; _ }
                , uu____7128 ) ] ) )
          when is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v ->
            aux
              (FStar_Pervasives_Native.Some
                 (is_forall
        ...
        | ( FStar_Pervasives_Native.None
          , ( { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_fvar tc
              ...
              ; FStar_Syntax_Syntax.vars= uu____7205; _ }
            , [ uu____7206
              ; ( { FStar_Syntax_Syntax.n=
                      FStar_Syntax_Syntax.Tm_abs ([b], t2, uu____7209)
                  ; FStar_Syntax_Syntax.pos= uu____7210
                  ; FStar_Syntax_Syntax.vars= uu____7211; _ }
                , uu____7212 ) ] ) )
          when is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v ->
            aux
              (FStar_Pervasives_Native.Some
        ...
        | FStar_Pervasives_Native.Some b, uu____7300 -> (
            ...
            match uu____7334 with bs1, t2 ->
              let uu____7343 = patterns t2 in
              match uu____7343 with pats, body ->
                if b then FStar_Pervasives_Native.Some (QAll (bs1, pats, body))
    ...
    let destruct_sq_base_conn t =
      ...
      FStar_Util.bind_opt uu____7471 (fun t1 ->
          let uu____7487 = head_and_args' t1 in
          match uu____7487 with hd1, args ->
            let uu____7520 =
              let uu____7525 =
                let uu____7526 = un_uinst hd1 in
                uu____7526.FStar_Syntax_Syntax.n
              in
              (uu____7525, FStar_List.length args)
            in
            match uu____7520 with
            | FStar_Syntax_Syntax.Tm_fvar fv, _0_29
              when _0_29 = Prims.parse_int "2"
                   && FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.c_and_lid ->
                FStar_Pervasives_Native.Some
                  (BaseConn (FStar_Parser_Const.and_lid, args))
            | FStar_Syntax_Syntax.Tm_fvar fv, _0_30
              when _0_30 = Prims.parse_int "2"
                   && FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.c_or_lid ->
                FStar_Pervasives_Native.Some
                  (BaseConn (FStar_Parser_Const.or_lid, args))
            | FStar_Syntax_Syntax.Tm_fvar fv, _0_31
              when _0_31 = Prims.parse_int "2"
                   && FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.c_eq2_lid ->
                FStar_Pervasives_Native.Some
                  (BaseConn (FStar_Parser_Const.eq2_lid, args))
            | FStar_Syntax_Syntax.Tm_fvar fv, _0_32
              when _0_32 = Prims.parse_int "3"
                   && FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.c_eq2_lid ->
                FStar_Pervasives_Native.Some
                  (BaseConn (FStar_Parser_Const.eq2_lid, args))
            | FStar_Syntax_Syntax.Tm_fvar fv, _0_33
              when _0_33 = Prims.parse_int "2"
                   && FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.c_eq3_lid ->
                FStar_Pervasives_Native.Some
                  (BaseConn (FStar_Parser_Const.eq3_lid, args))
            | FStar_Syntax_Syntax.Tm_fvar fv, _0_34
              when _0_34 = Prims.parse_int "4"
                   && FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.c_eq3_lid ->
                FStar_Pervasives_Native.Some
                  (BaseConn (FStar_Parser_Const.eq3_lid, args))
            | FStar_Syntax_Syntax.Tm_fvar fv, _0_35
              when _0_35 = Prims.parse_int "0"
                   && FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.c_true_lid ->
                FStar_Pervasives_Native.Some
                  (BaseConn (FStar_Parser_Const.true_lid, args))
            | FStar_Syntax_Syntax.Tm_fvar fv, _0_36
              when _0_36 = Prims.parse_int "0"
                   && FStar_Syntax_Syntax.fv_eq_lid fv
                        FStar_Parser_Const.c_false_lid ->
                FStar_Pervasives_Native.Some
                  (BaseConn (FStar_Parser_Const.false_lid, args))
            | uu____7609 -> FStar_Pervasives_Native.None )
    in
    let rec destruct_sq_forall t =
      let uu____7632 = un_squash t in
      FStar_Util.bind_opt uu____7632 (fun t1 ->
          ...
          | FStar_Pervasives_Native.Some (b, c) ->
              ...
              in
              if uu____7662 then FStar_Pervasives_Native.None
              else
                let q =
                  let uu____7670 = comp_to_comp_typ c in
                  uu____7670.FStar_Syntax_Syntax.result_typ
                in
                let uu____7671 =
                  is_free_in (FStar_Pervasives_Native.fst b) q
                in
                if uu____7671 then
                  let uu____7674 = patterns q in
                  match uu____7674 with pats, q1 ->
                    FStar_All.pipe_left maybe_collect
                      (FStar_Pervasives_Native.Some (QAll ([b], pats, q1)))
                else
                  let uu____7730 =
                    let uu____7731 =
                      let uu____7736 =
                      ...
                      in
                      (FStar_Parser_Const.imp_lid, uu____7736)
                    in
                    BaseConn uu____7731
                  in
    ...
    and destruct_sq_exists t =
      ...
      FStar_Util.bind_opt uu____7754 (fun t1 ->
          let uu____7785 = head_and_args' t1 in
          match uu____7785 with hd1, args ->
            let uu____7818 =
              let uu____7831 =
                let uu____7832 = un_uinst hd1 in
                uu____7832.FStar_Syntax_Syntax.n
              in
              (uu____7831, args)
            in
            match uu____7818 with
            | ( FStar_Syntax_Syntax.Tm_fvar fv
              , [(a1, uu____7847); (a2, uu____7849)] )
              when FStar_Syntax_Syntax.fv_eq_lid fv
                     FStar_Parser_Const.dtuple2_lid
              -> (
                let uu____7884 =
                  let uu____7885 = FStar_Syntax_Subst.compress a2 in
                  uu____7885.FStar_Syntax_Syntax.n
                in
                match uu____7884 with
                | FStar_Syntax_Syntax.Tm_abs ([b], q, uu____7892) -> (
                    let uu____7919 = FStar_Syntax_Subst.open_term [b] q in
                    match uu____7919 with bs, q1 ->
                      let b1 =
                        match bs with
                        | [b1] -> b1
                        | uu____7958 -> failwith "impossible"
                      in
                      let uu____7963 = patterns q1 in
                      match uu____7963 with pats, q2 ->
                        FStar_All.pipe_left maybe_collect
                          (FStar_Pervasives_Native.Some (QEx ([b1], pats, q2)))
                    )
      ...
      | FStar_Pervasives_Native.Some QAll (bs, pats, phi) -> (
          ...
          | FStar_Pervasives_Native.Some QAll (bs', pats', psi) ->
              FStar_All.pipe_left
                ...
                (QAll
                   (FStar_List.append bs bs', FStar_List.append pats pats', psi))
          | uu____8074 -> f1 )
    ...
    FStar_Util.catch_opt uu____8109 (fun uu____8114 ->
        let uu____8115 = destruct_q_conn phi in
        FStar_Util.catch_opt uu____8115 (fun uu____8120 ->
            let uu____8121 = destruct_sq_base_conn phi in
            FStar_Util.catch_opt uu____8121 (fun uu____8126 ->
                let uu____8127 = destruct_sq_forall phi in
                FStar_Util.catch_opt uu____8127 (fun uu____8132 ->
                    let uu____8133 = destruct_sq_exists phi in
                    FStar_Util.catch_opt uu____8133 (fun uu____8137 ->
                        FStar_Pervasives_Native.None ) ) ) ) )
...
let action_as_lb
    : FStar_Ident.lident -> FStar_Syntax_Syntax.action
      -> FStar_Syntax_Syntax.sigelt =
  fun eff_lid a ->
    let lb =
      let uu____8236 =
        let uu____8241 =
          FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name
            FStar_Syntax_Syntax.Delta_equational FStar_Pervasives_Native.None
        in
        FStar_Util.Inr uu____8241
      in
      let uu____8242 =
        let uu____8243 =
          FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ
        in
        arrow a.FStar_Syntax_Syntax.action_params uu____8243
      in
      let uu____8246 =
      ...
      close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____8236
        ...
        FStar_Parser_Const.effect_Tot_lid uu____8246 []
    in
  ...
  fun t ->
    ...
    let uu____8273 =
      let uu____8276 =
        let uu____8277 =
          let uu____8292 =
            let uu____8295 = FStar_Syntax_Syntax.as_arg t in
            [uu____8295]
          in
          (reify_, uu____8292)
        in
        FStar_Syntax_Syntax.Tm_app uu____8277
      in
      FStar_Syntax_Syntax.mk uu____8276
    in
...
let incr_delta_qualifier
    : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t ->
    let uu____8526 = delta_qualifier t in
    incr_delta_depth uu____8526
...
let rec list_elements
  ...
  fun e ->
    let uu____8546 =
      let uu____8561 = unmeta e in
      head_and_args uu____8561
    in
    match uu____8546 with head1, args ->
      let uu____8588 =
        let uu____8601 =
          let uu____8602 = un_uinst head1 in
          uu____8602.FStar_Syntax_Syntax.n
        in
        (uu____8601, args)
      in
      match uu____8588 with
      | FStar_Syntax_Syntax.Tm_fvar fv, uu____8618
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid ->
          FStar_Pervasives_Native.Some []
      | ( FStar_Syntax_Syntax.Tm_fvar fv
        , [uu____8638; (hd1, uu____8640); (tl1, uu____8642)] )
        when FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid ->
          let uu____8689 =
            let uu____8694 =
              let uu____8699 = list_elements tl1 in
              FStar_Util.must uu____8699
            in
            hd1 :: uu____8694
          in
...
let rec apply_last:
          'Auu____8730. ('Auu____8730 -> 'Auu____8730)
          -> 'Auu____8730 Prims.list -> 'Auu____8730 Prims.list =
  fun f l ->
    match l with
    | [] -> failwith "apply_last: got empty list"
    | [a] ->
        let uu____8753 = f a in
        [uu____8753]
    | x :: xs ->
        let uu____8758 = apply_last f xs in
        x :: uu____8758
  ...
  fun typ rng l ->
    let ctor l1 =
      let uu____8794 =
        let uu____8797 =
          let uu____8798 =
            FStar_Syntax_Syntax.lid_as_fv l1 FStar_Syntax_Syntax.Delta_constant
              (FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor)
          in
          FStar_Syntax_Syntax.Tm_fvar uu____8798
        in
        FStar_Syntax_Syntax.mk uu____8797
      in
      uu____8794 FStar_Pervasives_Native.None rng
    in
    let cons1 args pos =
      let uu____8811 =
        let uu____8812 =
        ...
        in
        FStar_Syntax_Syntax.mk_Tm_app uu____8812 args
      in
      uu____8811 FStar_Pervasives_Native.None pos
    in
    let nil args pos =
      let uu____8825 =
        let uu____8826 =
          ...
          FStar_Syntax_Syntax.mk_Tm_uinst uu____8827
            [FStar_Syntax_Syntax.U_zero]
        in
        FStar_Syntax_Syntax.mk_Tm_app uu____8826 args
      in
      uu____8825 FStar_Pervasives_Native.None pos
    in
    let uu____8830 =
      let uu____8831 =
        let uu____8832 = FStar_Syntax_Syntax.iarg typ in
        [uu____8832]
      in
      nil uu____8831 rng
    in
    FStar_List.fold_right
      (fun t a ->
        ...
        in
        cons1 uu____8838 t.FStar_Syntax_Syntax.pos )
      l uu____8830


let uvar_from_id
    : Prims.int -> FStar_Syntax_Syntax.typ
      -> FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax =
  fun id1 t ->
    let uu____8856 =
      let uu____8859 =
      ...
      in
      FStar_Syntax_Syntax.mk uu____8859
    in
...
let eqsum:
      'a 'b. ('a -> 'a -> Prims.bool) -> ('b -> 'b -> Prims.bool)
...
let eqopt:
      'a. ('a -> 'a -> Prims.bool) -> 'a FStar_Pervasives_Native.option
  ...
  fun t1 t2 ->
    let canon_app t =
      ...
      | FStar_Syntax_Syntax.Tm_app uu____9283 -> (
          ...
          match uu____9298 with hd1, args ->
            let uu___58_9331 = t in
            { FStar_Syntax_Syntax.n= FStar_Syntax_Syntax.Tm_app (hd1, args)
            ; FStar_Syntax_Syntax.pos= uu___58_9331.FStar_Syntax_Syntax.pos
            ; FStar_Syntax_Syntax.vars= uu___58_9331.FStar_Syntax_Syntax.vars
            } )
      | uu____9342 -> t
    in
    let t11 =
      let uu____9346 = unmeta_safe t1 in
      canon_app uu____9346
    in
    let t21 =
      let uu____9352 = unmeta_safe t2 in
      canon_app uu____9352
    in
    match (t11.FStar_Syntax_Syntax.n, t21.FStar_Syntax_Syntax.n) with
    ...
    | ( FStar_Syntax_Syntax.Tm_uinst (t12, us1)
      , FStar_Syntax_Syntax.Tm_uinst (t22, us2) ) ->
    ...
    | FStar_Syntax_Syntax.Tm_type x, FStar_Syntax_Syntax.Tm_type y -> x = y
    | ( FStar_Syntax_Syntax.Tm_abs (b1, t12, k1)
      , FStar_Syntax_Syntax.Tm_abs (b2, t22, k2) ) ->
        eqlist binder_eq b1 b2 && term_eq t12 t22
    | FStar_Syntax_Syntax.Tm_app (f1, a1), FStar_Syntax_Syntax.Tm_app (f2, a2) ->
...
and arg_eq
  ...
  fun a1 a2 -> eqprod term_eq (fun q1 q2 -> q1 = q2) a1 a2
...
and binder_eq
  ...
  fun b1 b2 ->
    eqprod
      (fun b11 b21 ->
        term_eq b11.FStar_Syntax_Syntax.sort b21.FStar_Syntax_Syntax.sort )
      (fun q1 q2 -> q1 = q2)
      b1 b2
...
and comp_eq
  ...
  fun c1 c2 ->
    ...
    | FStar_Syntax_Syntax.Total (t1, u1), FStar_Syntax_Syntax.Total (t2, u2) ->
        term_eq t1 t2
    | FStar_Syntax_Syntax.GTotal (t1, u1), FStar_Syntax_Syntax.GTotal (t2, u2) ->
        term_eq t1 t2
...
let rec bottom_fold
  ...
  fun f t ->
    ...
    let tn =
      ...
      uu____9862.FStar_Syntax_Syntax.n
    in
    let tn1 =
      match tn with
      | FStar_Syntax_Syntax.Tm_app (f1, args) ->
          let uu____9888 =
            ...
            let uu____9904 =
              FStar_List.map
                (fun uu____9923 ->
                  match uu____9923 with a, q ->
                    let uu____9934 = ff a in
                    (uu____9934, q) )
                args
            in
    ...
    in
    f
      (let uu___59_10027 = t in
       { FStar_Syntax_Syntax.n= tn1
       ; FStar_Syntax_Syntax.pos= uu___59_10027.FStar_Syntax_Syntax.pos
       ; FStar_Syntax_Syntax.vars= uu___59_10027.FStar_Syntax_Syntax.vars })
  ...
  fun t ->
    ...
    | FStar_Syntax_Syntax.Tm_app (hd1, args) ->
        ...
        let uu____10135 =
          FStar_List.fold_left
            (fun acc uu____10146 ->
              match uu____10146 with arg, uu____10152 ->
                let uu____10153 = sizeof arg in
                acc + uu____10153 )
...
let is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool =
  fun lid t ->
    let uu____10161 =
      let uu____10162 = un_uinst t in
      uu____10162.FStar_Syntax_Syntax.n
    in
    match uu____10161 with
    | FStar_Syntax_Syntax.Tm_fvar fv -> FStar_Syntax_Syntax.fv_eq_lid fv lid
    | uu____10166 -> false
...
let mk_alien:
      'a. FStar_Syntax_Syntax.typ -> 'a -> Prims.string
        ...
        let uu____10200 =
          let uu____10207 =
            let uu____10208 =
              ...
              (uu____10217, s, ty)
            in
            FStar_Syntax_Syntax.Meta_alien uu____10208
          in
          (FStar_Syntax_Syntax.tun, uu____10207)
        in
        FStar_Syntax_Syntax.Tm_meta uu____10200
      in
      FStar_Syntax_Syntax.mk uu____10199
    in
...
let un_alien : FStar_Syntax_Syntax.term -> FStar_Dyn.dyn =
  fun t ->
    ...
    | FStar_Syntax_Syntax.Tm_meta
        ( uu____10227
        , FStar_Syntax_Syntax.Meta_alien (blob, uu____10229, uu____10230) ) ->
        blob
...
let process_pragma
  ...
  fun p r ->
    ...
    | FStar_Syntax_Syntax.LightOff ->
        if p = FStar_Syntax_Syntax.LightOff then FStar_Options.set_ml_ish ()
        else ()
    ...
    | FStar_Syntax_Syntax.ResetOptions sopt ->
        ...
        match sopt with
        | FStar_Pervasives_Native.None -> ()
        | FStar_Pervasives_Native.Some s -> set_options1 FStar_Options.Reset s
