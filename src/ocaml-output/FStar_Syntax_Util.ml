...
let comp_set_flags:
  ...
  fun c  ->
    fun f  ->
      ...
      let uu___149_1117 = c in
      let uu____1118 =
        let uu____1119 =
          let uu___150_1120 = comp_to_comp_typ c in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___150_1120.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___150_1120.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___150_1120.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___150_1120.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          } in
        FStar_Syntax_Syntax.Comp uu____1119 in
      {
        FStar_Syntax_Syntax.n = uu____1118;
        FStar_Syntax_Syntax.pos = (uu___149_1117.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___149_1117.FStar_Syntax_Syntax.vars)
      }
...
let set_result_typ:
  ...
  fun c  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___151_1793 = ct in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___151_1793.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___151_1793.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___151_1793.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___151_1793.FStar_Syntax_Syntax.flags)
             })
let is_trivial_wp:
  FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax -> Prims.bool =
  fun c  ->
...
let rec eq_tm:
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___146_2064 = if uu___146_2064 then Equal else Unknown in
      let equal_iff uu___147_2069 = if uu___147_2069 then Equal else NotEqual in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___152_3248 = x in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___152_3248.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___152_3248.FStar_Syntax_Syntax.sort)
          } in
      ...
      fun lopt  ->
        let close_lopt lopt1 =
          ...
          | FStar_Pervasives_Native.Some rc ->
              let uu____3372 =
                let uu___153_3373 = rc in
                let uu____3374 =
                  FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                    (FStar_Syntax_Subst.close bs) in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___153_3373.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____3374;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___153_3373.FStar_Syntax_Syntax.residual_flags)
                } in
...
let abs_formals:
  ...
  fun t  ->
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____3927 =
            let uu___154_3928 = rc in
            let uu____3929 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (FStar_Syntax_Subst.subst s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___154_3928.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____3929;
              FStar_Syntax_Syntax.residual_flags =
                (uu___154_3928.FStar_Syntax_Syntax.residual_flags)
            } in
      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____9000 ->
            ...
            (match uu____9015 with
             | (hd1,args) ->
                 let uu___155_9048 = t in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___155_9048.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___155_9048.FStar_Syntax_Syntax.vars)
                 })
        | uu____9059 -> t in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____9743 -> tn in
      f
        (let uu___156_9746 = t in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___156_9746.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___156_9746.FStar_Syntax_Syntax.vars)
         })
...
let un_alien: FStar_Syntax_Syntax.term -> FStar_Dyn.dyn =
  fun t  ->
    ...
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_meta
        (uu____9956,FStar_Syntax_Syntax.Meta_alien
         (blob,uu____9958,uu____9959))
        -> blob
    | uu____9968 -> failwith "unexpected: term was not an alien embedding"