...
let comp_set_flags:
  ...
  fun c  ->
    fun f  ->
      ...
      let uu___176_1108 = c in
      let uu____1109 =
        let uu____1110 =
          let uu___177_1111 = comp_to_comp_typ c in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___177_1111.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___177_1111.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___177_1111.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___177_1111.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          } in
        FStar_Syntax_Syntax.Comp uu____1110 in
      {
        FStar_Syntax_Syntax.n = uu____1109;
        FStar_Syntax_Syntax.pos = (uu___176_1108.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___176_1108.FStar_Syntax_Syntax.vars)
      }
...
let set_result_typ:
  ...
  fun c  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___178_1784 = ct in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___178_1784.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___178_1784.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___178_1784.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___178_1784.FStar_Syntax_Syntax.flags)
             })
let is_trivial_wp:
  FStar_Syntax_Syntax.comp' FStar_Syntax_Syntax.syntax -> Prims.bool =
  fun c  ->
...
let rec eq_tm:
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___173_2055 = if uu___173_2055 then Equal else Unknown in
      let equal_iff uu___174_2060 = if uu___174_2060 then Equal else NotEqual in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___179_3236 = x in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___179_3236.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___179_3236.FStar_Syntax_Syntax.sort)
          } in
      ...
      fun lopt  ->
        let close_lopt lopt1 =
          ...
          | FStar_Pervasives_Native.Some rc ->
              let uu____3360 =
                let uu___180_3361 = rc in
                let uu____3362 =
                  FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                    (FStar_Syntax_Subst.close bs) in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___180_3361.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____3362;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___180_3361.FStar_Syntax_Syntax.residual_flags)
                } in
...
let abs_formals:
  ...
  fun t  ->
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____3915 =
            let uu___181_3916 = rc in
            let uu____3917 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (FStar_Syntax_Subst.subst s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___181_3916.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____3917;
              FStar_Syntax_Syntax.residual_flags =
                (uu___181_3916.FStar_Syntax_Syntax.residual_flags)
            } in
...
let destruct_typ_as_formula:
  ...
  fun f  ->
    ...
    let destruct_q_conn t =
      ...
      let flat t1 =
        let uu____6435 = head_and_args t1 in
        match uu____6435 with
        | (t2,args) ->
            let uu____6482 = un_uinst t2 in
            let uu____6483 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____6516  ->
                      ...
                      | (t3,imp) ->
                          let uu____6527 = unascribe t3 in (uu____6527, imp))) in
            (uu____6482, uu____6483) in
      let rec aux qopt out t1 =
        let uu____6562 = let uu____6579 = flat t1 in (qopt, uu____6579) in
           ...
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               ...
               ({
                  FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                    (b::[],t2,uu____6695);
                  FStar_Syntax_Syntax.pos = uu____6696;
                  FStar_Syntax_Syntax.vars = uu____6697;_},uu____6698)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.None
            ...
            aux
              (FStar_Pervasives_Native.Some
                 (is_forall
                    (tc.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v))
              (b :: out) t2
        | (FStar_Pervasives_Native.Some b,uu____6965) ->
            let bs = FStar_List.rev out in
            let uu____6999 = FStar_Syntax_Subst.open_term bs t1 in
            (match uu____6999 with
             | (bs1,t2) ->
                 let uu____7008 = patterns t2 in
        ...
        | uu____7070 -> FStar_Pervasives_Native.None in
    ...
    let destruct_sq_base_conn t =
      let uu____7136 = un_squash t in
      FStar_Util.bind_opt uu____7136
        (fun t1  ->
           let uu____7152 = head_and_args' t1 in
           match uu____7152 with
           | (hd1,args) ->
               let uu____7185 =
                 let uu____7190 =
                   let uu____7191 = un_uinst hd1 in
                   uu____7191.FStar_Syntax_Syntax.n in
                 (uu____7190, (FStar_List.length args)) in
               (match uu____7185 with
                ...
                | uu____7274 -> FStar_Pervasives_Native.None)) in
    let rec destruct_sq_forall t =
      let uu____7297 = un_squash t in
      FStar_Util.bind_opt uu____7297
        (fun t1  ->
           let uu____7312 = arrow_one t1 in
           match uu____7312 with
           | FStar_Pervasives_Native.Some (b,c) ->
               let uu____7327 =
                 let uu____7328 = is_tot_or_gtot_comp c in
                 Prims.op_Negation uu____7328 in
               if uu____7327
               then FStar_Pervasives_Native.None
               else
                 (let q =
                    let uu____7335 = comp_to_comp_typ c in
                    uu____7335.FStar_Syntax_Syntax.result_typ in
                  let uu____7336 =
                    is_free_in (FStar_Pervasives_Native.fst b) q in
                  if uu____7336
                  then
                    let uu____7339 = patterns q in
                         ...
                         let uu____7401 =
                           let uu____7404 =
                             FStar_Syntax_Syntax.as_arg
                               (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort in
                           let uu____7405 =
                             let uu____7408 = FStar_Syntax_Syntax.as_arg q in
                             [uu____7408] in
                           uu____7404 :: uu____7405 in
                         (FStar_Parser_Const.imp_lid, uu____7401) in
                       BaseConn uu____7396 in
                     FStar_Pervasives_Native.Some uu____7395))
           | uu____7411 -> FStar_Pervasives_Native.None)
    and destruct_sq_exists t =
      let uu____7419 = un_squash t in
      FStar_Util.bind_opt uu____7419
        (fun t1  ->
           let uu____7450 = head_and_args' t1 in
           match uu____7450 with
           | (hd1,args) ->
               let uu____7483 =
                 let uu____7496 =
                   let uu____7497 = un_uinst hd1 in
                   uu____7497.FStar_Syntax_Syntax.n in
                 (uu____7496, args) in
               (match uu____7483 with
                | (FStar_Syntax_Syntax.Tm_fvar
                   fv,(a1,uu____7512)::(a2,uu____7514)::[]) when
                    FStar_Syntax_Syntax.fv_eq_lid fv
                      FStar_Parser_Const.dtuple2_lid
                    ->
                    let uu____7549 =
                      let uu____7550 = FStar_Syntax_Subst.compress a2 in
                      uu____7550.FStar_Syntax_Syntax.n in
                    (match uu____7549 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[],q,uu____7557) ->
                         let uu____7584 = FStar_Syntax_Subst.open_term [b] q in
                         (match uu____7584 with
                          | (bs,q1) ->
                              let b1 =
                                match bs with
                                | b1::[] -> b1
                                | uu____7623 -> failwith "impossible" in
                              let uu____7628 = patterns q1 in
                              (match uu____7628 with
                               | (pats,q2) ->
                                   FStar_All.pipe_left maybe_collect
                                     (FStar_Pervasives_Native.Some
                                        (QEx ([b1], pats, q2)))))
                     | uu____7695 -> FStar_Pervasives_Native.None)
                | uu____7696 -> FStar_Pervasives_Native.None))
    and maybe_collect f1 =
      match f1 with
      | FStar_Pervasives_Native.Some (QAll (bs,pats,phi)) ->
          let uu____7717 = destruct_sq_forall phi in
      ...
      | FStar_Pervasives_Native.Some (QEx (bs,pats,phi)) ->
          let uu____7745 = destruct_sq_exists phi in
    ...
    let uu____7774 = destruct_base_conn phi in
    FStar_Util.catch_opt uu____7774
      (fun uu____7779  ->
         let uu____7780 = destruct_q_conn phi in
         FStar_Util.catch_opt uu____7780
           (fun uu____7785  ->
              let uu____7786 = destruct_sq_base_conn phi in
              FStar_Util.catch_opt uu____7786
                (fun uu____7791  ->
                   let uu____7792 = destruct_sq_forall phi in
                   FStar_Util.catch_opt uu____7792
                     (fun uu____7797  ->
                        let uu____7798 = destruct_sq_exists phi in
                        FStar_Util.catch_opt uu____7798
                          (fun uu____7802  -> FStar_Pervasives_Native.None)))))
let unthunk_lemma_post:
  ...
  fun t  ->
    let uu____7809 =
      let uu____7810 = FStar_Syntax_Subst.compress t in
      uu____7810.FStar_Syntax_Syntax.n in
    match uu____7809 with
    | FStar_Syntax_Syntax.Tm_abs (b::[],e,uu____7817) ->
        let uu____7844 = FStar_Syntax_Subst.open_term [b] e in
        (match uu____7844 with
         | (bs,e1) ->
             let b1 = FStar_List.hd bs in
             let uu____7870 = is_free_in (FStar_Pervasives_Native.fst b1) e1 in
             if uu____7870
             then
               let uu____7873 =
                 let uu____7882 = FStar_Syntax_Syntax.as_arg exp_unit in
                 [uu____7882] in
               mk_app t uu____7873
             else e1)
    | uu____7884 ->
        let uu____7885 =
          let uu____7894 = FStar_Syntax_Syntax.as_arg exp_unit in
          [uu____7894] in
        mk_app t uu____7885
let action_as_lb:
  FStar_Ident.lident ->
    ...
    fun a  ->
      let lb =
        ...
        let uu____7910 =
          ...
          arrow a.FStar_Syntax_Syntax.action_params uu____7911 in
        let uu____7914 =
          abs a.FStar_Syntax_Syntax.action_params
            a.FStar_Syntax_Syntax.action_defn FStar_Pervasives_Native.None in
        close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7904
          a.FStar_Syntax_Syntax.action_univs uu____7910
          FStar_Parser_Const.effect_Tot_lid uu____7914 in
      {
  ...
  fun t  ->
    ...
    let uu____7940 =
      let uu____7943 =
        let uu____7944 =
          let uu____7959 =
            let uu____7962 = FStar_Syntax_Syntax.as_arg t in [uu____7962] in
          (reify_, uu____7959) in
        FStar_Syntax_Syntax.Tm_app uu____7944 in
      FStar_Syntax_Syntax.mk uu____7943 in
    uu____7940 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos
let rec delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____7975 -> failwith "Impossible"
    | FStar_Syntax_Syntax.Tm_fvar fv -> fv.FStar_Syntax_Syntax.fv_delta
    | FStar_Syntax_Syntax.Tm_bvar uu____8001 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_name uu____8002 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_match uu____8003 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_uvar uu____8026 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_unknown  -> FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_type uu____8043 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_constant uu____8044 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_arrow uu____8045 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_uinst (t2,uu____8059) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____8064;
           FStar_Syntax_Syntax.index = uu____8065;
           FStar_Syntax_Syntax.sort = t2;_},uu____8067)
        -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_meta (t2,uu____8075) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____8081,uu____8082) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_app (t2,uu____8124) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_abs (uu____8145,t2,uu____8147) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_let (uu____8168,t2) -> delta_qualifier t2
...
let incr_delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  -> let uu____8196 = delta_qualifier t in incr_delta_depth uu____8196
let is_unknown: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____8201 =
      let uu____8202 = FStar_Syntax_Subst.compress t in
      uu____8202.FStar_Syntax_Syntax.n in
...
let rec list_elements:
  ...
  =
  fun e  ->
    let uu____8218 = let uu____8233 = unmeta e in head_and_args uu____8233 in
    match uu____8218 with
    | (head1,args) ->
        let uu____8260 =
          let uu____8273 =
            let uu____8274 = un_uinst head1 in
            uu____8274.FStar_Syntax_Syntax.n in
          (uu____8273, args) in
        (match uu____8260 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____8290) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid ->
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____8310::(hd1,uu____8312)::(tl1,uu____8314)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid ->
             let uu____8361 =
               let uu____8366 =
                 let uu____8371 = list_elements tl1 in
                 FStar_Util.must uu____8371 in
               hd1 :: uu____8366 in
             FStar_Pervasives_Native.Some uu____8361
         | uu____8384 -> FStar_Pervasives_Native.None)
let rec apply_last:
  'Auu____8405 .
    ('Auu____8405 -> 'Auu____8405) ->
      'Auu____8405 Prims.list -> 'Auu____8405 Prims.list
  =
  fun f  ->
    fun l  ->
      match l with
      | [] -> failwith "apply_last: got empty list"
      | a::[] -> let uu____8428 = f a in [uu____8428]
      | x::xs -> let uu____8433 = apply_last f xs in x :: uu____8433
let dm4f_lid:
            ...
            let uu____8477 =
              let uu____8478 =
                FStar_Syntax_Syntax.lid_as_fv l1
                  FStar_Syntax_Syntax.Delta_constant
                  (FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor) in
              FStar_Syntax_Syntax.Tm_fvar uu____8478 in
            FStar_Syntax_Syntax.mk uu____8477 in
          uu____8474 FStar_Pervasives_Native.None rng in
        let cons1 args pos =
          let uu____8491 =
            let uu____8492 =
              let uu____8493 = ctor FStar_Parser_Const.cons_lid in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____8493
                [FStar_Syntax_Syntax.U_zero] in
            FStar_Syntax_Syntax.mk_Tm_app uu____8492 args in
          uu____8491 FStar_Pervasives_Native.None pos in
        let nil args pos =
          let uu____8505 =
            let uu____8506 =
              let uu____8507 = ctor FStar_Parser_Const.nil_lid in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____8507
                [FStar_Syntax_Syntax.U_zero] in
            FStar_Syntax_Syntax.mk_Tm_app uu____8506 args in
          uu____8505 FStar_Pervasives_Native.None pos in
        let uu____8510 =
          let uu____8511 =
            let uu____8512 = FStar_Syntax_Syntax.iarg typ in [uu____8512] in
          nil uu____8511 rng in
        FStar_List.fold_right
          (fun t  ->
             fun a  ->
               let uu____8518 =
                 let uu____8519 = FStar_Syntax_Syntax.iarg typ in
                 let uu____8520 =
                   let uu____8523 = FStar_Syntax_Syntax.as_arg t in
                   let uu____8524 =
                     let uu____8527 = FStar_Syntax_Syntax.as_arg a in
                     [uu____8527] in
                   uu____8523 :: uu____8524 in
                 uu____8519 :: uu____8520 in
               cons1 uu____8518 t.FStar_Syntax_Syntax.pos) l uu____8510
let uvar_from_id:
  Prims.int ->
    FStar_Syntax_Syntax.typ ->
      FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax
  ...
  fun id  ->
    fun t  ->
      let uu____8538 =
        let uu____8541 =
          let uu____8542 =
            let uu____8559 = FStar_Syntax_Unionfind.from_id id in
            (uu____8559, t) in
          FStar_Syntax_Syntax.Tm_uvar uu____8542 in
        FStar_Syntax_Syntax.mk uu____8541 in
      uu____8538 FStar_Pervasives_Native.None FStar_Range.dummyRange
let rec eqlist:
  'a .
...
let rec term_eq:
  ...
  fun t1  ->
    fun t2  ->
      let canon_app t =
        match t.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Tm_app uu____8984 ->
            let uu____8999 = head_and_args' t in
            (match uu____8999 with
             | (hd1,args) ->
                 let uu___182_9032 = t in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___182_9032.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___182_9032.FStar_Syntax_Syntax.vars)
                 })
        | uu____9043 -> t in
      let t11 = let uu____9047 = unmeta_safe t1 in canon_app uu____9047 in
      let t21 = let uu____9053 = unmeta_safe t2 in canon_app uu____9053 in
      match ((t11.FStar_Syntax_Syntax.n), (t21.FStar_Syntax_Syntax.n)) with
...
and branch_eq:
  ...
  fun uu____9424  ->
    fun uu____9425  ->
      match (uu____9424, uu____9425) with | ((p1,w1,t1),(p2,w2,t2)) -> false
let rec bottom_fold:
  (FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term) ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
  =
  fun f  ->
    fun t  ->
      ...
      let tn =
        let uu____9565 = FStar_Syntax_Subst.compress t in
        uu____9565.FStar_Syntax_Syntax.n in
      let tn1 =
        match tn with
        | FStar_Syntax_Syntax.Tm_app (f1,args) ->
            let uu____9591 =
              let uu____9606 = ff f1 in
              let uu____9607 =
                FStar_List.map
                  (fun uu____9626  ->
                     match uu____9626 with
                     | (a,q) -> let uu____9637 = ff a in (uu____9637, q))
                  args in
              (uu____9606, uu____9607) in
            FStar_Syntax_Syntax.Tm_app uu____9591
        | FStar_Syntax_Syntax.Tm_abs (bs,t1,k) ->
            let uu____9667 = FStar_Syntax_Subst.open_term bs t1 in
            (match uu____9667 with
             | (bs1,t') ->
                 let t'' = ff t' in
                 let uu____9675 =
                   let uu____9692 = FStar_Syntax_Subst.close bs1 t'' in
                   (bs1, uu____9692, k) in
                 FStar_Syntax_Syntax.Tm_abs uu____9675)
        | FStar_Syntax_Syntax.Tm_arrow (bs,k) -> tn
        | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
            let uu____9719 = let uu____9726 = ff t1 in (uu____9726, us) in
            FStar_Syntax_Syntax.Tm_uinst uu____9719
        | uu____9727 -> tn in
      f
        (let uu___183_9730 = t in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___183_9730.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___183_9730.FStar_Syntax_Syntax.vars)
         })
let rec sizeof: FStar_Syntax_Syntax.term -> Prims.int =
  fun t  ->
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____9735 ->
        let uu____9760 =
          let uu____9761 = FStar_Syntax_Subst.compress t in sizeof uu____9761 in
        (Prims.parse_int "1") + uu____9760
    | FStar_Syntax_Syntax.Tm_bvar bv ->
        let uu____9763 = sizeof bv.FStar_Syntax_Syntax.sort in
        (Prims.parse_int "1") + uu____9763
    | FStar_Syntax_Syntax.Tm_name bv ->
        let uu____9765 = sizeof bv.FStar_Syntax_Syntax.sort in
        (Prims.parse_int "1") + uu____9765
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
        let uu____9772 = sizeof t1 in (FStar_List.length us) + uu____9772
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____9775) ->
        let uu____9796 = sizeof t1 in
        let uu____9797 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____9808  ->
                 ...
                 | (bv,uu____9814) ->
                     let uu____9815 = sizeof bv.FStar_Syntax_Syntax.sort in
                     acc + uu____9815) (Prims.parse_int "0") bs in
        uu____9796 + uu____9797
    | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
        let uu____9838 = sizeof hd1 in
        let uu____9839 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____9850  ->
                 ...
                 | (arg,uu____9856) ->
                     let uu____9857 = sizeof arg in acc + uu____9857)
            (Prims.parse_int "0") args in
        uu____9838 + uu____9839
    | uu____9858 -> Prims.parse_int "1"
let is_fvar: FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool =
  fun lid  ->
    fun t  ->
      let uu____9867 =
        let uu____9868 = un_uinst t in uu____9868.FStar_Syntax_Syntax.n in
          ...
          let uu____9908 =
            let uu____9911 =
              let uu____9912 =
                let uu____9919 =
                  let uu____9920 =
                    let uu____9929 = FStar_Dyn.mkdyn b in (uu____9929, s, ty) in
                  FStar_Syntax_Syntax.Meta_alien uu____9920 in
                (FStar_Syntax_Syntax.tun, uu____9919) in
              FStar_Syntax_Syntax.Tm_meta uu____9912 in
            FStar_Syntax_Syntax.mk uu____9911 in
          uu____9908 FStar_Pervasives_Native.None
            (match r with
...
let un_alien: FStar_Syntax_Syntax.term -> FStar_Dyn.dyn =
  fun t  ->
    ...
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_meta
        (uu____9942,FStar_Syntax_Syntax.Meta_alien
         (blob,uu____9944,uu____9945))
        -> blob
    | uu____9954 -> failwith "unexpected: term was not an alien embedding"