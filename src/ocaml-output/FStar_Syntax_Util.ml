        ...
        (FStar_List.map
           (fun b ->
              ...
              then
                ...
                (let uu____246 = arg_of_non_null_binder b in (b, uu____246)))) in
         ...
         (fun uu____449 ->
            ...
            | (t, imp) ->
                let uu____460 =
                  ...
                  FStar_All.pipe_left FStar_Pervasives_Native.fst uu____461 in
                (uu____460, imp)))
let (binders_of_tks :
  (FStar_Syntax_Syntax.typ, FStar_Syntax_Syntax.aqual)
    FStar_Pervasives_Native.tuple2 Prims.list -> FStar_Syntax_Syntax.binders)
...
let (uu___is_Equal : eq_result -> Prims.bool) =
  fun projectee -> match projectee with | Equal -> true | uu____2161 -> false
...
let rec (eq_tm :
  ...
  fun t1 ->
    fun t2 ->
      ...
      let equal_iff uu___50_2232 = if uu___50_2232 then Equal else NotEqual in
      let eq_and f g = match f with | Equal -> g () | uu____2246 -> Unknown in
      let eq_inj f g =
        match (f, g) with
        | (Equal, Equal) -> Equal
            ...
            (FStar_List.fold_left
               (fun acc ->
                  fun uu____2357 ->
                    ...
                    | ((a1, q1), (a2, q2)) ->
                        let uu____2385 = eq_tm a1 a2 in eq_inj acc uu____2385)
               Equal) uu____2299
        else NotEqual in
      let uu____2387 =
        let uu____2392 =
          let uu____2393 = unmeta t11 in uu____2393.FStar_Syntax_Syntax.n in
        let uu____2396 =
          let uu____2397 = unmeta t21 in uu____2397.FStar_Syntax_Syntax.n in
      ...
      | (FStar_Syntax_Syntax.Tm_uvar (u1, uu____2451),
         FStar_Syntax_Syntax.Tm_uvar (u2, uu____2453)) ->
...
let (destruct :
  ...
  fun typ ->
    fun lid ->
      ...
      let uu____3404 =
        let uu____3405 = un_uinst typ1 in uu____3405.FStar_Syntax_Syntax.n in
            ...
            (match ((body.FStar_Syntax_Syntax.n), lopt) with
                ...
                FStar_Pervasives_Native.None) ->
                 let uu____4036 =
                   let uu____4039 =
                     let uu____4040 =
                       let uu____4057 =
                         let uu____4064 = FStar_Syntax_Subst.close_binders bs in
             ...
             | uu____4091 ->
                 let uu____4098 =
                   let uu____4101 =
                     let uu____4102 =
                       let uu____4119 = FStar_Syntax_Subst.close_binders bs in
  ...
  fun phi ->
    let uu____5462 =
      let uu____5465 =
        let uu____5466 =
          let uu____5481 =
            let uu____5484 = FStar_Syntax_Syntax.as_arg phi in [uu____5484] in
          (t_not, uu____5481) in
  ...
  fun e ->
    let uu____5545 =
      let uu____5548 =
        let uu____5549 =
          let uu____5564 =
            let uu____5567 = FStar_Syntax_Syntax.as_arg e in [uu____5567] in
          (b2t_v, uu____5564) in
...
let (is_sub_singleton : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t ->
    let uu____6668 = let uu____6683 = unmeta t in head_and_args uu____6683 in
    match uu____6668 with
    | (head1, uu____6685) ->
        let uu____6706 =
          let uu____6707 = un_uinst head1 in uu____6707.FStar_Syntax_Syntax.n in
  ...
  fun f ->
    let rec unmeta_monadic f1 =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          (t, FStar_Syntax_Syntax.Meta_monadic uu____7160) ->
          unmeta_monadic t
      | FStar_Syntax_Syntax.Tm_meta
    ...
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____7263 =
        ...
        | (lid, arity) ->
            let uu____7272 =
              let uu____7287 = unmeta_monadic f2 in head_and_args uu____7287 in
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____7527 ->
                      ...
                      | (t3, imp) ->
                          let uu____7538 = unascribe t3 in (uu____7538, imp))) in
      ...
      let rec aux qopt out t1 =
        ...
        | (FStar_Pervasives_Native.Some fa,
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
            ...
            ({
               ...
               FStar_Syntax_Syntax.vars = uu____7623;_},
             uu____7624)::[]))
        ...
        | (FStar_Pervasives_Native.Some fa,
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
            ...
            uu____7703::({
                           ...
                           FStar_Syntax_Syntax.vars = uu____7708;_},
                         uu____7709)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.None,
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
            ...
            ({
               ...
               FStar_Syntax_Syntax.vars = uu____7803;_},
             uu____7804)::[]))
            when
        ...
        | (FStar_Pervasives_Native.None,
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
              ...
              FStar_Syntax_Syntax.vars = uu____7885;_},
            uu____7886::({
                           FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                             (b::[], t2, uu____7889);
                           FStar_Syntax_Syntax.pos = uu____7890;
                           FStar_Syntax_Syntax.vars = uu____7891;_},
                         uu____7892)::[]))
            when
            is_qlid (tc.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v ->
            let uu____7975 =
                         ...
                         let uu____8420 =
                           let uu____8423 =
                             FStar_Syntax_Syntax.as_arg
                               (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort in
                           let uu____8424 =
                             let uu____8427 = FStar_Syntax_Syntax.as_arg q in
                             [uu____8427] in
        ...
        (fun t1 ->
           ...
           | (hd1, args) ->
               ...
               (match uu____8502 with
                | (FStar_Syntax_Syntax.Tm_fvar fv,
                   (a1, uu____8531)::(a2, uu____8533)::[]) when
                    FStar_Syntax_Syntax.fv_eq_lid fv
                    ...
                    (match uu____8568 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[], q, uu____8576) ->
                         let uu____8603 = FStar_Syntax_Subst.open_term [b] q in
    ...
    | FStar_Syntax_Syntax.Tm_abs (b::[], e, uu____8835) ->
        ...
        (match uu____8862 with
         | (bs, e1) ->
             ...
             let uu____8888 = is_free_in (FStar_Pervasives_Native.fst b1) e1 in
             if uu____8888
             then
               let uu____8891 =
      ...
      fun pos ->
        let lb =
          ...
          close_univs_and_mk_letbinding FStar_Pervasives_Native.None
            ...
            FStar_Parser_Const.effect_Tot_lid uu____8933 [] pos in
        {
  ...
  fun t ->
    ...
    let uu____8960 =
      let uu____8963 =
        let uu____8964 =
          let uu____8979 =
            let uu____8982 = FStar_Syntax_Syntax.as_arg t in [uu____8982] in
...
let (incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth) =
  fun t -> let uu____9222 = delta_qualifier t in incr_delta_depth uu____9222
...
let rec (list_elements :
  ...
  =
  fun e ->
    let uu____9242 = let uu____9257 = unmeta e in head_and_args uu____9257 in
    ...
    | (head1, args) ->
        ...
        (match uu____9284 with
         | (FStar_Syntax_Syntax.Tm_fvar fv, uu____9314) when
             ...
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            uu____9334::(hd1, uu____9336)::(tl1, uu____9338)::[]) when
  ...
  fun typ ->
    fun rng ->
      fun l ->
        ...
        let uu____9524 =
          let uu____9525 =
            let uu____9526 = FStar_Syntax_Syntax.iarg typ in [uu____9526] in
...
let rec (term_eq_dbg :
  ...
  fun dbg ->
    fun t1 ->
      fun t2 ->
        let t11 = let uu____10028 = unmeta_safe t1 in canon_app uu____10028 in
        let t21 = let uu____10032 = unmeta_safe t2 in canon_app uu____10032 in
        let uu____10033 =
          let uu____10038 =
            let uu____10039 =
        ...
        | (FStar_Syntax_Syntax.Tm_type uu____10182,
           FStar_Syntax_Syntax.Tm_type uu____10183) -> true
    ...
    fun t ->
      ...
      let tn1 =
        ...
        | FStar_Syntax_Syntax.Tm_uinst (t1, us) ->
            let uu____11367 = let uu____11374 = ff t1 in (uu____11374, us) in
            ...
            (fun acc ->
               fun uu____11455 ->
                 ...
                 | (bv, uu____11461) ->
                     ...
                     acc + uu____11462) (Prims.parse_int "0") bs in
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid ->
    fun t ->
      let uu____11512 =
        let uu____11513 = un_uinst t in uu____11513.FStar_Syntax_Syntax.n in
  ...
  fun p ->
    fun r ->
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____11552 = FStar_Options.restore_cmd_line_options false in
