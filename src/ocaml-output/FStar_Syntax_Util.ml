  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___123_5106 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___123_5106.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___123_5106.FStar_Syntax_Syntax.sort)
          }  in
              ...
              let uu____5274 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___124_5275.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____5276;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___124_5275.FStar_Syntax_Syntax.residual_flags)
                }  in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____6031 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___125_6032.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____6033;
              FStar_Syntax_Syntax.residual_flags =
                (uu___125_6032.FStar_Syntax_Syntax.residual_flags)
            }  in
