...
let (comp_set_flags :
  ...
  fun c  ->
    fun f  ->
      let uu___89_1233 = c  in
      let uu____1234 =
        let uu____1235 =
          let uu___90_1236 = comp_to_comp_typ_nouniv c  in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___90_1236.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___90_1236.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___90_1236.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___90_1236.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          }  in
        FStar_Syntax_Syntax.Comp uu____1235  in
      {
        FStar_Syntax_Syntax.n = uu____1234;
        FStar_Syntax_Syntax.pos = (uu___89_1233.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___89_1233.FStar_Syntax_Syntax.vars)
      }
    ...
    fun fs  ->
      let comp_typ_set_flags c =
        ...
        | FStar_Syntax_Syntax.Comp ct ->
            let ct1 =
              let uu___91_1277 = ct  in
              {
                FStar_Syntax_Syntax.comp_univs =
                  (uu___91_1277.FStar_Syntax_Syntax.comp_univs);
                FStar_Syntax_Syntax.effect_name =
                  (uu___91_1277.FStar_Syntax_Syntax.effect_name);
                FStar_Syntax_Syntax.result_typ =
                  (uu___91_1277.FStar_Syntax_Syntax.result_typ);
                FStar_Syntax_Syntax.effect_args =
                  (uu___91_1277.FStar_Syntax_Syntax.effect_args);
                FStar_Syntax_Syntax.flags = fs
              }  in
            let uu___92_1278 = c  in
            {
              FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
              FStar_Syntax_Syntax.pos =
                (uu___92_1278.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___92_1278.FStar_Syntax_Syntax.vars)
            }
         in
    ...
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___93_1990 = ct  in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___93_1990.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___93_1990.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___93_1990.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___93_1990.FStar_Syntax_Syntax.flags)
             })
...
let rec (eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___86_2494 = if uu___86_2494 then Equal else Unknown  in
      let equal_iff uu___87_2501 = if uu___87_2501 then Equal else NotEqual
         in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___94_4357 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___94_4357.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___94_4357.FStar_Syntax_Syntax.sort)
          }  in
              ...
              let uu____4519 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___95_4520.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____4521;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___95_4520.FStar_Syntax_Syntax.residual_flags)
                }  in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____5114 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___96_5115.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____5116;
              FStar_Syntax_Syntax.residual_flags =
                (uu___96_5115.FStar_Syntax_Syntax.residual_flags)
            }  in
