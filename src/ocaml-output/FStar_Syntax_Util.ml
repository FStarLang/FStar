...
let un_uinst: FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_uinst (t2,uu____936) ->
        FStar_Syntax_Subst.compress t2
    | uu____941 -> t1
let is_smt_lemma: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____945 =
      let uu____946 = FStar_Syntax_Subst.compress t in
      uu____946.FStar_Syntax_Syntax.n in
    match uu____945 with
    | FStar_Syntax_Syntax.Tm_arrow (uu____949,c) ->
        (match c.FStar_Syntax_Syntax.n with
         | FStar_Syntax_Syntax.Comp ct when
             ...
             (match ct.FStar_Syntax_Syntax.effect_args with
              | _req::_ens::(pats,uu____965)::uu____966 ->
                  let pats' = unmeta pats in
                  let uu____997 = head_and_args pats' in
                  (match uu____997 with
                   | (head1,uu____1008) ->
                       let uu____1023 =
                         let uu____1024 = un_uinst head1 in
  ...
  | FStar_Syntax_Syntax.Comp c1 ->
      (FStar_Ident.lid_equals c1.FStar_Syntax_Syntax.effect_name
        ...
        (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags
           (FStar_Util.for_some
              (fun uu___166_1050  ->
                 match uu___166_1050 with
                 | FStar_Syntax_Syntax.MLEFFECT  -> true
                 | uu____1051 -> false)))
  | uu____1052 -> false
let comp_result c =
  match c.FStar_Syntax_Syntax.n with
  | FStar_Syntax_Syntax.Total (t,uu____1067) -> t
  | FStar_Syntax_Syntax.GTotal (t,uu____1075) -> t
  | FStar_Syntax_Syntax.Comp ct -> ct.FStar_Syntax_Syntax.result_typ
let set_result_typ c t =
  match c.FStar_Syntax_Syntax.n with
  | FStar_Syntax_Syntax.Total uu____1099 -> FStar_Syntax_Syntax.mk_Total t
  | FStar_Syntax_Syntax.GTotal uu____1105 -> FStar_Syntax_Syntax.mk_GTotal t
  | FStar_Syntax_Syntax.Comp ct ->
      FStar_Syntax_Syntax.mk_Comp
        (let uu___173_1112 = ct in
         {
           FStar_Syntax_Syntax.comp_univs =
             (uu___173_1112.FStar_Syntax_Syntax.comp_univs);
           FStar_Syntax_Syntax.effect_name =
             (uu___173_1112.FStar_Syntax_Syntax.effect_name);
           FStar_Syntax_Syntax.result_typ = t;
           FStar_Syntax_Syntax.effect_args =
             (uu___173_1112.FStar_Syntax_Syntax.effect_args);
           FStar_Syntax_Syntax.flags =
             (uu___173_1112.FStar_Syntax_Syntax.flags)
         })
let is_trivial_wp c =
  FStar_All.pipe_right (comp_flags c)
    (FStar_Util.for_some
       (fun uu___167_1125  ->
          match uu___167_1125 with
          | FStar_Syntax_Syntax.TOTAL  -> true
          | FStar_Syntax_Syntax.RETURN  -> true
          | uu____1126 -> false))
...
let rec unascribe: FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun e  ->
    let e1 = FStar_Syntax_Subst.compress e in
    match e1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_ascribed (e2,uu____1154,uu____1155) ->
        unascribe e2
    | uu____1184 -> e1
let rec ascribe t k =
  match t.FStar_Syntax_Syntax.n with
  | FStar_Syntax_Syntax.Tm_ascribed (t',uu____1226,uu____1227) ->
      ascribe t' k
  | uu____1256 ->
...
let uu___is_Equal: eq_result -> Prims.bool =
  fun projectee  ->
    match projectee with | Equal  -> true | uu____1278 -> false
let uu___is_NotEqual: eq_result -> Prims.bool =
  fun projectee  ->
    match projectee with | NotEqual  -> true | uu____1282 -> false
let uu___is_Unknown: eq_result -> Prims.bool =
  fun projectee  ->
    match projectee with | Unknown  -> true | uu____1286 -> false
let rec eq_tm:
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___168_1306 = if uu___168_1306 then Equal else Unknown in
      let equal_iff uu___169_1311 = if uu___169_1311 then Equal else NotEqual in
      let eq_and f g = match f with | Equal  -> g () | uu____1325 -> Unknown in
      match ((t11.FStar_Syntax_Syntax.n), (t21.FStar_Syntax_Syntax.n)) with
      | (FStar_Syntax_Syntax.Tm_name a,FStar_Syntax_Syntax.Tm_name b) ->
          equal_if (FStar_Syntax_Syntax.bv_eq a b)
      | (FStar_Syntax_Syntax.Tm_fvar f,FStar_Syntax_Syntax.Tm_fvar g) ->
          let uu____1330 = FStar_Syntax_Syntax.fv_eq f g in
          equal_if uu____1330
      | (FStar_Syntax_Syntax.Tm_uinst (f,us),FStar_Syntax_Syntax.Tm_uinst
         (g,vs)) ->
          let uu____1343 = eq_tm f g in
          eq_and uu____1343
            (fun uu____1344  ->
               let uu____1345 = eq_univs_list us vs in equal_if uu____1345)
      | (FStar_Syntax_Syntax.Tm_constant c,FStar_Syntax_Syntax.Tm_constant d)
          ->
          let uu____1348 = FStar_Const.eq_const c d in equal_iff uu____1348
      | (FStar_Syntax_Syntax.Tm_uvar
         (u1,uu____1350),FStar_Syntax_Syntax.Tm_uvar (u2,uu____1352)) ->
          let uu____1377 = FStar_Syntax_Unionfind.equiv u1 u2 in
          equal_if uu____1377
      | (FStar_Syntax_Syntax.Tm_app (h1,args1),FStar_Syntax_Syntax.Tm_app
         (h2,args2)) ->
          let uu____1410 = eq_tm h1 h2 in
          eq_and uu____1410 (fun uu____1411  -> eq_args args1 args2)
      | (FStar_Syntax_Syntax.Tm_type u,FStar_Syntax_Syntax.Tm_type v1) ->
          let uu____1414 = eq_univs u v1 in equal_if uu____1414
      | (FStar_Syntax_Syntax.Tm_meta (t12,uu____1416),uu____1417) ->
          eq_tm t12 t21
      | (uu____1422,FStar_Syntax_Syntax.Tm_meta (t22,uu____1424)) ->
          eq_tm t11 t22
      | uu____1429 -> Unknown
and eq_args:
  ...
  fun a1  ->
    fun a2  ->
      match (a1, a2) with
      | ([],[]) -> Equal
      | ((a,uu____1453)::a11,(b,uu____1456)::b1) ->
          let uu____1494 = eq_tm a b in
...
let rec unrefine: FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_refine (x,uu____1510) ->
        unrefine x.FStar_Syntax_Syntax.sort
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____1516,uu____1517) ->
        unrefine t2
    | uu____1546 -> t1
let rec is_unit: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____1550 =
      let uu____1551 = unrefine t in uu____1551.FStar_Syntax_Syntax.n in
    match uu____1550 with
    | FStar_Syntax_Syntax.Tm_type uu____1554 -> true
    | FStar_Syntax_Syntax.Tm_fvar fv ->
    ...
    | FStar_Syntax_Syntax.Tm_uinst (t1,uu____1557) -> is_unit t1
    | uu____1562 -> false
let rec non_informative: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____1566 =
      let uu____1567 = unrefine t in uu____1567.FStar_Syntax_Syntax.n in
    match uu____1566 with
    | FStar_Syntax_Syntax.Tm_type uu____1570 -> true
    | FStar_Syntax_Syntax.Tm_fvar fv ->
        ((FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.unit_lid) ||
           (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.squash_lid))
          || (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.erased_lid)
    | FStar_Syntax_Syntax.Tm_app (head1,uu____1573) -> non_informative head1
    | FStar_Syntax_Syntax.Tm_uinst (t1,uu____1589) -> non_informative t1
...
let is_fun: FStar_Syntax_Syntax.term -> Prims.bool =
  fun e  ->
    let uu____1610 =
      let uu____1611 = FStar_Syntax_Subst.compress e in
      uu____1611.FStar_Syntax_Syntax.n in
    match uu____1610 with
    | FStar_Syntax_Syntax.Tm_abs uu____1614 -> true
    | uu____1629 -> false
let is_function_typ: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____1633 =
      let uu____1634 = FStar_Syntax_Subst.compress t in
      uu____1634.FStar_Syntax_Syntax.n in
    match uu____1633 with
    | FStar_Syntax_Syntax.Tm_arrow uu____1637 -> true
    | uu____1645 -> false
let rec pre_typ: FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term =
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_refine (x,uu____1651) ->
        pre_typ x.FStar_Syntax_Syntax.sort
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____1657,uu____1658) ->
        pre_typ t2
    | uu____1687 -> t1
let destruct:
  FStar_Syntax_Syntax.term ->
  ...
  fun typ  ->
    fun lid  ->
      ...
      let uu____1701 =
        let uu____1702 = un_uinst typ1 in uu____1702.FStar_Syntax_Syntax.n in
...
let lids_of_sigelt:
  ...
  fun se  ->
    ...
    | FStar_Syntax_Syntax.Sig_let (uu____1767,lids,uu____1769) -> lids
    | FStar_Syntax_Syntax.Sig_bundle (uu____1774,lids) -> lids
    | FStar_Syntax_Syntax.Sig_inductive_typ
        (lid,uu____1781,uu____1782,uu____1783,uu____1784,uu____1785) -> 
        [lid]
    | FStar_Syntax_Syntax.Sig_effect_abbrev
        (lid,uu____1791,uu____1792,uu____1793,uu____1794) -> [lid]
    | FStar_Syntax_Syntax.Sig_datacon
        (lid,uu____1798,uu____1799,uu____1800,uu____1801,uu____1802) -> 
        [lid]
    | FStar_Syntax_Syntax.Sig_declare_typ (lid,uu____1806,uu____1807) ->
        [lid]
    | FStar_Syntax_Syntax.Sig_assume (lid,uu____1809) -> [lid]
    | FStar_Syntax_Syntax.Sig_new_effect_for_free n1 ->
        [n1.FStar_Syntax_Syntax.mname]
    | FStar_Syntax_Syntax.Sig_new_effect n1 -> [n1.FStar_Syntax_Syntax.mname]
    | FStar_Syntax_Syntax.Sig_sub_effect uu____1812 -> []
    | FStar_Syntax_Syntax.Sig_pragma uu____1813 -> []
    | FStar_Syntax_Syntax.Sig_main uu____1814 -> []
let lid_of_sigelt: FStar_Syntax_Syntax.sigelt -> FStar_Ident.lident option =
  fun se  ->
    match lids_of_sigelt se with | l::[] -> Some l | uu____1822 -> None
let quals_of_sigelt:
  FStar_Syntax_Syntax.sigelt -> FStar_Syntax_Syntax.qualifier Prims.list =
  fun x  -> x.FStar_Syntax_Syntax.sigquals
let range_of_sigelt: FStar_Syntax_Syntax.sigelt -> FStar_Range.range =
  fun x  -> x.FStar_Syntax_Syntax.sigrng
let range_of_lb uu___170_1844 =
  match uu___170_1844 with
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___174_2081 = x in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___174_2081.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___174_2081.FStar_Syntax_Syntax.sort)
          } in
...
let set_uvar:
  ...
  fun uv  ->
    fun t  ->
      let uu____2089 = FStar_Syntax_Unionfind.find uv in
      match uu____2089 with
      | Some uu____2091 ->
          let uu____2092 =
            let uu____2093 =
              let uu____2094 = FStar_Syntax_Unionfind.uvar_id uv in
              FStar_All.pipe_left FStar_Util.string_of_int uu____2094 in
            FStar_Util.format1 "Changing a fixed uvar! ?%s\n" uu____2093 in
          failwith uu____2092
      | uu____2095 -> FStar_Syntax_Unionfind.change uv t
let qualifier_equal:
    ...
    fun t  ->
      fun lopt  ->
        let close_lopt lopt1 =
          match lopt1 with
          | None  -> lopt1
          | Some (FStar_Util.Inr uu____2214) -> lopt1
          | Some (FStar_Util.Inl lc) ->
              let uu____2235 =
                let uu____2241 = FStar_Syntax_Subst.close_lcomp bs lc in
                FStar_Util.Inl uu____2241 in
              Some uu____2235 in
        match bs with
        | [] -> t
        | uu____2252 ->
            let body =
              let uu____2254 = FStar_Syntax_Subst.close bs t in
              FStar_Syntax_Subst.compress uu____2254 in
             ...
             | (FStar_Syntax_Syntax.Tm_abs (bs',t1,lopt'),None ) ->
                 let uu____2297 =
                   let uu____2300 =
                     let uu____2301 =
                       let uu____2316 =
                         let uu____2320 = FStar_Syntax_Subst.close_binders bs in
                         FStar_List.append uu____2320 bs' in
                       let uu____2326 = close_lopt lopt' in
                       (uu____2316, t1, uu____2326) in
                     FStar_Syntax_Syntax.Tm_abs uu____2301 in
                   FStar_Syntax_Syntax.mk uu____2300 in
                 uu____2297 None t1.FStar_Syntax_Syntax.pos
             | uu____2352 ->
                 let uu____2361 =
                   let uu____2364 =
                     let uu____2365 =
                       let uu____2380 = FStar_Syntax_Subst.close_binders bs in
                       let uu____2381 = close_lopt lopt in
                       (uu____2380, body, uu____2381) in
                     FStar_Syntax_Syntax.Tm_abs uu____2365 in
                   FStar_Syntax_Syntax.mk uu____2364 in
                 uu____2361 None t.FStar_Syntax_Syntax.pos)
let arrow:
  (FStar_Syntax_Syntax.bv* FStar_Syntax_Syntax.aqual) Prims.list ->
    (FStar_Syntax_Syntax.comp',Prims.unit) FStar_Syntax_Syntax.syntax ->
      (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
    ...
    fun c  ->
      ...
      | uu____2424 ->
          let uu____2428 =
            let uu____2431 =
              let uu____2432 =
                let uu____2440 = FStar_Syntax_Subst.close_binders bs in
                let uu____2441 = FStar_Syntax_Subst.close_comp bs c in
                (uu____2440, uu____2441) in
              FStar_Syntax_Syntax.Tm_arrow uu____2432 in
            FStar_Syntax_Syntax.mk uu____2431 in
          uu____2428 None c.FStar_Syntax_Syntax.pos
let flat_arrow:
  (FStar_Syntax_Syntax.bv* FStar_Syntax_Syntax.aqual) Prims.list ->
    (FStar_Syntax_Syntax.comp',Prims.unit) FStar_Syntax_Syntax.syntax ->
      (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
  ...
  fun bs  ->
    fun c  ->
      ...
      | FStar_Syntax_Syntax.Tm_arrow (bs1,c1) ->
          (match c1.FStar_Syntax_Syntax.n with
           | FStar_Syntax_Syntax.Total (tres,uu____2492) ->
               let uu____2499 =
                 let uu____2500 = FStar_Syntax_Subst.compress tres in
                 uu____2500.FStar_Syntax_Syntax.n in
               (match uu____2499 with
                | FStar_Syntax_Syntax.Tm_arrow (bs',c') ->
                    let uu____2517 = FStar_ST.read t.FStar_Syntax_Syntax.tk in
                    FStar_Syntax_Syntax.mk
                      (FStar_Syntax_Syntax.Tm_arrow
                         ((FStar_List.append bs1 bs'), c')) uu____2517
...
let refine:
  ...
  fun b  ->
    fun t  ->
      ...
      let uu____2549 =
        let uu____2550 = FStar_Syntax_Syntax.range_of_bv b in
        FStar_Range.union_ranges uu____2550 t.FStar_Syntax_Syntax.pos in
      let uu____2551 =
        let uu____2554 =
          let uu____2555 =
            let uu____2560 =
              let uu____2561 =
                let uu____2562 = FStar_Syntax_Syntax.mk_binder b in
                [uu____2562] in
              FStar_Syntax_Subst.close uu____2561 t in
            (b, uu____2560) in
          FStar_Syntax_Syntax.Tm_refine uu____2555 in
        FStar_Syntax_Syntax.mk uu____2554 in
      uu____2551 uu____2544 uu____2549
  ...
  fun k  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
        ...
        (match uu____2600 with
         | (bs1,c1) ->
             let uu____2610 = is_tot_or_gtot_comp c1 in
             if uu____2610
             then
               let uu____2616 = arrow_formals_comp (comp_result c1) in
               (match uu____2616 with
                | (bs',k2) -> ((FStar_List.append bs1 bs'), k2))
             else (bs1, c1))
    | uu____2641 ->
        let uu____2642 = FStar_Syntax_Syntax.mk_Total k1 in ([], uu____2642)
let rec arrow_formals:
  ...
  =
  fun k  ->
    let uu____2658 = arrow_formals_comp k in
    match uu____2658 with | (bs,c) -> (bs, (comp_result c))
let abs_formals:
  FStar_Syntax_Syntax.term ->
  ...
  fun t  ->
    let subst_lcomp_opt s l =
      ...
      | Some (FStar_Util.Inl l1) ->
          let l2 =
            let uu___175_2739 = l1 in
            let uu____2740 =
              FStar_Syntax_Subst.subst s l1.FStar_Syntax_Syntax.res_typ in
            {
              FStar_Syntax_Syntax.eff_name =
                (uu___175_2739.FStar_Syntax_Syntax.eff_name);
              FStar_Syntax_Syntax.res_typ = uu____2740;
              FStar_Syntax_Syntax.cflags =
                (uu___175_2739.FStar_Syntax_Syntax.cflags);
              FStar_Syntax_Syntax.comp =
                (fun uu____2743  ->
                   let uu____2744 = l1.FStar_Syntax_Syntax.comp () in
                   FStar_Syntax_Subst.subst_comp s uu____2744)
            } in
    ...
    let rec aux t1 abs_body_lcomp =
      let uu____2791 =
        let uu____2792 =
          let uu____2795 = FStar_Syntax_Subst.compress t1 in
          FStar_All.pipe_left unascribe uu____2795 in
        uu____2792.FStar_Syntax_Syntax.n in
      match uu____2791 with
      | FStar_Syntax_Syntax.Tm_abs (bs,t2,what) ->
          let uu____2833 = aux t2 what in
          (match uu____2833 with
           | (bs',t3,what1) -> ((FStar_List.append bs bs'), t3, what1))
      | uu____2890 -> ([], t1, abs_body_lcomp) in
    let uu____2902 = aux t None in
    match uu____2902 with
    | (bs,t1,abs_body_lcomp) ->
        let uu____2950 = FStar_Syntax_Subst.open_term' bs t1 in
  ...
  fun uvs  ->
    fun binders  ->
      fun c  ->
        match binders with
        | [] ->
            let uu____3114 = FStar_Syntax_Subst.open_univ_vars_comp uvs c in
            (match uu____3114 with | (uvs1,c1) -> (uvs1, [], c1))
        | uu____3130 ->
            let t' = arrow binders c in
            let uu____3137 = FStar_Syntax_Subst.open_univ_vars uvs t' in
            (match uu____3137 with
             | (uvs1,t'1) ->
                 let uu____3148 =
                   let uu____3149 = FStar_Syntax_Subst.compress t'1 in
                   uu____3149.FStar_Syntax_Syntax.n in
                 (match uu____3148 with
                  | FStar_Syntax_Syntax.Tm_arrow (binders1,c1) ->
                      (uvs1, binders1, c1)
                  | uu____3175 -> failwith "Impossible"))
...
let mk_tuple_lid: Prims.int -> FStar_Range.range -> FStar_Ident.lident =
  fun n1  ->
    fun r  ->
      let t =
        let uu____3220 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "tuple%s" uu____3220 in
      let uu____3221 = FStar_Syntax_Const.psconst t in
      FStar_Ident.set_lid_range uu____3221 r
let mk_tuple_data_lid: Prims.int -> FStar_Range.range -> FStar_Ident.lident =
  fun n1  ->
    fun r  ->
      let t =
        let uu____3229 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "Mktuple%s" uu____3229 in
      let uu____3230 = FStar_Syntax_Const.psconst t in
      FStar_Ident.set_lid_range uu____3230 r
let is_tuple_data_lid: FStar_Ident.lident -> Prims.int -> Prims.bool =
  fun f  ->
    fun n1  ->
      let uu____3237 = mk_tuple_data_lid n1 FStar_Range.dummyRange in
      FStar_Ident.lid_equals f uu____3237
  ...
  fun n1  ->
    fun r  ->
      let t =
        ...
        FStar_Util.format1 "dtuple%s" uu____3263 in
      let uu____3264 = let uu____3265 = mod_prefix_dtuple n1 in uu____3265 t in
      FStar_Ident.set_lid_range uu____3264 r
  ...
  fun n1  ->
    fun r  ->
      let t =
        ...
        FStar_Util.format1 "Mkdtuple%s" uu____3275 in
      let uu____3276 = let uu____3277 = mod_prefix_dtuple n1 in uu____3277 t in
      FStar_Ident.set_lid_range uu____3276 r
...
let is_constructor:
  ...
  fun t  ->
    fun lid  ->
      let uu____3317 =
        let uu____3318 = pre_typ t in uu____3318.FStar_Syntax_Syntax.n in
...
let rec is_constructed_typ:
  ...
  fun t  ->
    fun lid  ->
      let uu____3333 =
        let uu____3334 = pre_typ t in uu____3334.FStar_Syntax_Syntax.n in
      match uu____3333 with
      | FStar_Syntax_Syntax.Tm_fvar uu____3337 -> is_constructor t lid
      | FStar_Syntax_Syntax.Tm_app (t1,uu____3339) ->
...
let rec get_tycon:
  ...
  fun t  ->
    let t1 = pre_typ t in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_bvar uu____3361 -> Some t1
    | FStar_Syntax_Syntax.Tm_name uu____3362 -> Some t1
    | FStar_Syntax_Syntax.Tm_fvar uu____3363 -> Some t1
    | FStar_Syntax_Syntax.Tm_app (t2,uu____3365) -> get_tycon t2
    | uu____3380 -> None
...
let type_u:
  ...
  fun uu____3410  ->
    let u =
      let uu____3414 = FStar_Syntax_Unionfind.univ_fresh () in
          ...
          let uu____3442 =
            ...
            let uu____3446 =
              let uu____3449 =
                let uu____3450 =
                  let uu____3460 =
                    let uu____3462 = FStar_Syntax_Syntax.as_arg phi11 in
                    let uu____3463 =
                      let uu____3465 = FStar_Syntax_Syntax.as_arg phi2 in
                      [uu____3465] in
                    uu____3462 :: uu____3463 in
                  (tand, uu____3460) in
                FStar_Syntax_Syntax.Tm_app uu____3450 in
              FStar_Syntax_Syntax.mk uu____3449 in
            uu____3446 None uu____3445 in
          Some uu____3442
let mk_binop op_t phi1 phi2 =
  ...
  let uu____3501 =
    let uu____3504 =
      let uu____3505 =
        let uu____3515 =
          let uu____3517 = FStar_Syntax_Syntax.as_arg phi1 in
          let uu____3518 =
            let uu____3520 = FStar_Syntax_Syntax.as_arg phi2 in [uu____3520] in
          uu____3517 :: uu____3518 in
        (op_t, uu____3515) in
      FStar_Syntax_Syntax.Tm_app uu____3505 in
    FStar_Syntax_Syntax.mk uu____3504 in
  uu____3501 None uu____3500
let mk_neg phi =
  let uu____3541 =
    let uu____3544 =
      let uu____3545 =
        let uu____3555 =
          let uu____3557 = FStar_Syntax_Syntax.as_arg phi in [uu____3557] in
        (t_not, uu____3555) in
      FStar_Syntax_Syntax.Tm_app uu____3545 in
    FStar_Syntax_Syntax.mk uu____3544 in
  uu____3541 None phi.FStar_Syntax_Syntax.pos
...
let b2t e =
  let uu____3648 =
    let uu____3651 =
      let uu____3652 =
        let uu____3662 =
          let uu____3664 = FStar_Syntax_Syntax.as_arg e in [uu____3664] in
        (b2t_v, uu____3662) in
      FStar_Syntax_Syntax.Tm_app uu____3652 in
    FStar_Syntax_Syntax.mk uu____3651 in
  uu____3648 None e.FStar_Syntax_Syntax.pos
...
let mk_untyped_eq2 e1 e2 =
  ...
  let uu____3689 =
    let uu____3692 =
      let uu____3693 =
        let uu____3703 =
          let uu____3705 = FStar_Syntax_Syntax.as_arg e1 in
          let uu____3706 =
            let uu____3708 = FStar_Syntax_Syntax.as_arg e2 in [uu____3708] in
          uu____3705 :: uu____3706 in
        (teq, uu____3703) in
      FStar_Syntax_Syntax.Tm_app uu____3693 in
    FStar_Syntax_Syntax.mk uu____3692 in
  uu____3689 None uu____3688
let mk_eq2:
        ...
        fun e2  ->
          ...
          let uu____3732 =
            let uu____3735 =
              let uu____3736 =
                let uu____3746 =
                  let uu____3748 = FStar_Syntax_Syntax.iarg t in
                  let uu____3749 =
                    let uu____3751 = FStar_Syntax_Syntax.as_arg e1 in
                    let uu____3752 =
                      let uu____3754 = FStar_Syntax_Syntax.as_arg e2 in
                      [uu____3754] in
                    uu____3751 :: uu____3752 in
                  uu____3748 :: uu____3749 in
                (eq_inst, uu____3746) in
              FStar_Syntax_Syntax.Tm_app uu____3736 in
            FStar_Syntax_Syntax.mk uu____3735 in
          uu____3732 None uu____3731
let mk_has_type t x t' =
  ...
  let uu____3792 =
    let uu____3795 =
      let uu____3796 =
        let uu____3806 =
          let uu____3808 = FStar_Syntax_Syntax.iarg t in
          let uu____3809 =
            let uu____3811 = FStar_Syntax_Syntax.as_arg x in
            let uu____3812 =
              let uu____3814 = FStar_Syntax_Syntax.as_arg t' in [uu____3814] in
            uu____3811 :: uu____3812 in
          uu____3808 :: uu____3809 in
        (t_has_type1, uu____3806) in
      FStar_Syntax_Syntax.Tm_app uu____3796 in
    FStar_Syntax_Syntax.mk uu____3795 in
  uu____3792 None FStar_Range.dummyRange
...
let lcomp_of_comp:
  ...
  fun c0  ->
    let uu____3833 =
      ...
      | FStar_Syntax_Syntax.Total uu____3840 ->
          (FStar_Syntax_Const.effect_Tot_lid, [FStar_Syntax_Syntax.TOTAL])
      | FStar_Syntax_Syntax.GTotal uu____3847 ->
          (FStar_Syntax_Const.effect_GTot_lid,
    ...
    | (eff_name,flags) ->
        {
          ...
          FStar_Syntax_Syntax.comp = ((fun uu____3860  -> c0))
        }
        ...
        let uu____3898 =
          ...
          let uu____3901 =
            let uu____3903 =
              let uu____3904 =
                let uu____3905 =
                  let uu____3906 = FStar_Syntax_Syntax.mk_binder x in
                  [uu____3906] in
                let uu____3907 =
                  let uu____3914 =
                    let uu____3920 =
                      let uu____3921 = FStar_Syntax_Syntax.mk_Total ktype0 in
                      FStar_All.pipe_left lcomp_of_comp uu____3921 in
                    FStar_Util.Inl uu____3920 in
                  Some uu____3914 in
                abs uu____3905 body uu____3907 in
              FStar_Syntax_Syntax.as_arg uu____3904 in
            [uu____3903] in
          uu____3900 :: uu____3901 in
        (fa, uu____3898) in
      FStar_Syntax_Syntax.Tm_app uu____3888 in
    FStar_Syntax_Syntax.mk uu____3887 in
  uu____3884 None FStar_Range.dummyRange
  ...
  fun bs  ->
    fun f  ->
      FStar_List.fold_right
        (fun b  ->
           fun f1  ->
             let uu____3971 = FStar_Syntax_Syntax.is_null_binder b in
             if uu____3971 then f1 else mk_forall_no_univ (fst b) f1) bs f
let rec is_wild_pat p =
  match p.FStar_Syntax_Syntax.v with
  | FStar_Syntax_Syntax.Pat_wild uu____3984 -> true
  | uu____3985 -> false
let if_then_else b t1 t2 =
  ...
  let else_branch =
    ...
    (uu____4051, None, t2) in
  let uu____4063 =
    let uu____4064 =
      FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos
        t2.FStar_Syntax_Syntax.pos in
    FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos uu____4064 in
  FStar_Syntax_Syntax.mk
...
let uu___is_QAll: connective -> Prims.bool =
  fun projectee  ->
    match projectee with | QAll _0 -> true | uu____4137 -> false
let __proj__QAll__item___0:
  connective -> (FStar_Syntax_Syntax.binders* qpats* FStar_Syntax_Syntax.typ)
  = fun projectee  -> match projectee with | QAll _0 -> _0
let uu___is_QEx: connective -> Prims.bool =
  fun projectee  ->
    match projectee with | QEx _0 -> true | uu____4161 -> false
let __proj__QEx__item___0:
  connective -> (FStar_Syntax_Syntax.binders* qpats* FStar_Syntax_Syntax.typ)
  = fun projectee  -> match projectee with | QEx _0 -> _0
let uu___is_BaseConn: connective -> Prims.bool =
  fun projectee  ->
    match projectee with | BaseConn _0 -> true | uu____4184 -> false
...
let destruct_typ_as_formula: FStar_Syntax_Syntax.term -> connective option =
  fun f  ->
    let rec unmeta_monadic f1 =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          (t,FStar_Syntax_Syntax.Meta_monadic uu____4209) -> unmeta_monadic t
      | FStar_Syntax_Syntax.Tm_meta
          (t,FStar_Syntax_Syntax.Meta_monadic_lift uu____4219) ->
          unmeta_monadic t
      | uu____4229 -> f2 in
    let destruct_base_conn f1 =
      ...
      let rec aux f2 uu____4274 =
        match uu____4274 with
        | (lid,arity) ->
            let uu____4280 =
              let uu____4290 = unmeta_monadic f2 in head_and_args uu____4290 in
            (match uu____4280 with
             | (t,args) ->
                 ...
                 if uu____4309 then Some (BaseConn (lid, args)) else None) in
    ...
    let patterns t =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          let uu____4360 = FStar_Syntax_Subst.compress t2 in
          (pats, uu____4360)
      | uu____4367 ->
          let uu____4368 = FStar_Syntax_Subst.compress t1 in ([], uu____4368) in
    let destruct_q_conn t =
      ...
      let flat t1 =
        let uu____4410 = head_and_args t1 in
        match uu____4410 with
        | (t2,args) ->
            let uu____4441 = un_uinst t2 in
            let uu____4442 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____4458  ->
                      ...
                      | (t3,imp) ->
                          let uu____4465 = unascribe t3 in (uu____4465, imp))) in
            (uu____4441, uu____4442) in
      let rec aux qopt out t1 =
        let uu____4488 = let uu____4497 = flat t1 in (qopt, uu____4497) in
        match uu____4488 with
        | (Some
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
                 FStar_Syntax_Syntax.tk = uu____4512;
                 FStar_Syntax_Syntax.pos = uu____4513;
                 FStar_Syntax_Syntax.vars = uu____4514;_},({
                                                             ...
                                                             FStar_Syntax_Syntax.vars
                                                               = uu____4520;_},uu____4521)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (Some
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
                 FStar_Syntax_Syntax.tk = uu____4582;
                 FStar_Syntax_Syntax.pos = uu____4583;
                 FStar_Syntax_Syntax.vars = uu____4584;_},uu____4585::
               ({
                  FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                    (b::[],t2,uu____4588);
                  FStar_Syntax_Syntax.tk = uu____4589;
                  FStar_Syntax_Syntax.pos = uu____4590;
                  FStar_Syntax_Syntax.vars = uu____4591;_},uu____4592)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               FStar_Syntax_Syntax.tk = uu____4660;
               FStar_Syntax_Syntax.pos = uu____4661;
               FStar_Syntax_Syntax.vars = uu____4662;_},({
                                                           FStar_Syntax_Syntax.n
                                                             =
                                                             FStar_Syntax_Syntax.Tm_abs
                                                             (b::[],t2,uu____4665);
        ...
        | (None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               FStar_Syntax_Syntax.tk = uu____4737;
               FStar_Syntax_Syntax.pos = uu____4738;
               FStar_Syntax_Syntax.vars = uu____4739;_},uu____4740::({
                                                                    FStar_Syntax_Syntax.n
                                                                    =
                                                                    FStar_Syntax_Syntax.Tm_abs
                                                                    (b::[],t2,uu____4743);
        ...
        | (Some b,uu____4823) ->
            ...
            let uu____4841 = FStar_Syntax_Subst.open_term bs t1 in
            (match uu____4841 with
             | (bs1,t2) ->
                 let uu____4847 = patterns t2 in
    ...
    let uu____4897 = destruct_base_conn phi in
    match uu____4897 with | Some b -> Some b | None  -> destruct_q_conn phi
let action_as_lb:
  FStar_Ident.lident ->
    ...
    fun a  ->
      let lb =
        let uu____4908 =
          ...
          FStar_Util.Inr uu____4911 in
        let uu____4912 =
          let uu____4913 =
            FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ in
          arrow a.FStar_Syntax_Syntax.action_params uu____4913 in
        let uu____4916 =
          abs a.FStar_Syntax_Syntax.action_params
            a.FStar_Syntax_Syntax.action_defn None in
        close_univs_and_mk_letbinding None uu____4908
          a.FStar_Syntax_Syntax.action_univs uu____4912
          FStar_Syntax_Const.effect_Tot_lid uu____4916 in
      {
...
let mk_reify t =
  ...
  let uu____4949 =
    let uu____4952 =
      let uu____4953 =
        let uu____4963 =
          let uu____4965 = FStar_Syntax_Syntax.as_arg t in [uu____4965] in
        (reify_, uu____4963) in
      FStar_Syntax_Syntax.Tm_app uu____4953 in
    FStar_Syntax_Syntax.mk uu____4952 in
  uu____4949 None t.FStar_Syntax_Syntax.pos
let rec delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____4981 -> failwith "Impossible"
    | FStar_Syntax_Syntax.Tm_fvar fv -> fv.FStar_Syntax_Syntax.fv_delta
    | FStar_Syntax_Syntax.Tm_bvar uu____5003 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_name uu____5004 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_match uu____5005 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_uvar uu____5021 ->
        FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_unknown  -> FStar_Syntax_Syntax.Delta_equational
    | FStar_Syntax_Syntax.Tm_type uu____5030 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_constant uu____5031 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_arrow uu____5032 ->
        FStar_Syntax_Syntax.Delta_constant
    | FStar_Syntax_Syntax.Tm_uinst (t2,uu____5041) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____5046;
           FStar_Syntax_Syntax.index = uu____5047;
           FStar_Syntax_Syntax.sort = t2;_},uu____5049)
        -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_meta (t2,uu____5057) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____5063,uu____5064) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_app (t2,uu____5094) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_abs (uu____5109,t2,uu____5111) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_let (uu____5134,t2) -> delta_qualifier t2
...
let incr_delta_qualifier:
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth =
  fun t  -> let uu____5154 = delta_qualifier t in incr_delta_depth uu____5154
let is_unknown: FStar_Syntax_Syntax.term -> Prims.bool =
  fun t  ->
    let uu____5158 =
      let uu____5159 = FStar_Syntax_Subst.compress t in
...
let rec list_elements:
  ...
  fun e  ->
    let uu____5170 = let uu____5180 = unmeta e in head_and_args uu____5180 in
    match uu____5170 with
    | (head1,args) ->
        let uu____5199 =
          let uu____5207 =
            let uu____5208 = un_uinst head1 in
            uu____5208.FStar_Syntax_Syntax.n in
          (uu____5207, args) in
        (match uu____5199 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____5219) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.nil_lid ->
             Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____5232::(hd1,uu____5234)::(tl1,uu____5236)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.cons_lid ->
             let uu____5270 =
               let uu____5274 =
                 let uu____5278 = list_elements tl1 in
                 FStar_Util.must uu____5278 in
               hd1 :: uu____5274 in
             Some uu____5270
         | uu____5287 -> None)
let rec apply_last f l =
  ...
  | a::[] -> let uu____5318 = f a in [uu____5318]
  | x::xs -> let uu____5322 = apply_last f xs in x :: uu____5322
let dm4f_lid:
            ...
            let uu____5355 =
              let uu____5356 =
                FStar_Syntax_Syntax.lid_as_fv l1
                  FStar_Syntax_Syntax.Delta_constant
                  (Some FStar_Syntax_Syntax.Data_ctor) in
              FStar_Syntax_Syntax.Tm_fvar uu____5356 in
            FStar_Syntax_Syntax.mk uu____5355 in
          uu____5352 None rng in
        let cons1 args pos =
          let uu____5374 =
            let uu____5375 =
              let uu____5376 = ctor FStar_Syntax_Const.cons_lid in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____5376
                [FStar_Syntax_Syntax.U_zero] in
            FStar_Syntax_Syntax.mk_Tm_app uu____5375 args in
          uu____5374 None pos in
        let nil args pos =
          let uu____5390 =
            let uu____5391 =
              let uu____5392 = ctor FStar_Syntax_Const.nil_lid in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____5392
                [FStar_Syntax_Syntax.U_zero] in
            FStar_Syntax_Syntax.mk_Tm_app uu____5391 args in
          uu____5390 None pos in
        let uu____5397 =
          let uu____5398 =
            let uu____5399 = FStar_Syntax_Syntax.iarg typ in [uu____5399] in
          nil uu____5398 rng in
        FStar_List.fold_right
          (fun t  ->
             fun a  ->
               let uu____5402 =
                 let uu____5403 = FStar_Syntax_Syntax.iarg typ in
                 let uu____5404 =
                   let uu____5406 = FStar_Syntax_Syntax.as_arg t in
                   let uu____5407 =
                     let uu____5409 = FStar_Syntax_Syntax.as_arg a in
                     [uu____5409] in
                   uu____5406 :: uu____5407 in
                 uu____5403 :: uu____5404 in
               cons1 uu____5402 t.FStar_Syntax_Syntax.pos) l uu____5397
...
let eqopt e x y =
  match (x, y) with | (Some x1,Some y1) -> e x1 y1 | uu____5634 -> false
let rec term_eq:
...
and branch_eq:
  ...
  fun uu____6018  ->
    fun uu____6019  ->
      match (uu____6018, uu____6019) with | ((p1,w1,t1),(p2,w2,t2)) -> false
let rec bottom_fold:
  (FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term) ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
  =
  fun f  ->
    fun t  ->
      ...
      let tn =
        let uu____6129 = un_uinst t in uu____6129.FStar_Syntax_Syntax.n in
      let tn1 =
        match tn with
        | FStar_Syntax_Syntax.Tm_app (f1,args) ->
            let uu____6149 =
              let uu____6159 = ff f1 in
              let uu____6160 =
                FStar_List.map
                  (fun uu____6168  ->
                     match uu____6168 with
                     | (a,q) -> let uu____6175 = ff a in (uu____6175, q))
                  args in
              (uu____6159, uu____6160) in
            FStar_Syntax_Syntax.Tm_app uu____6149
        | FStar_Syntax_Syntax.Tm_abs (bs,t1,k) ->
            let uu____6204 = FStar_Syntax_Subst.open_term bs t1 in
            (match uu____6204 with
             | (bs1,t') ->
                 let t'' = ff t' in
                 let uu____6210 =
                   let uu____6225 = FStar_Syntax_Subst.close bs1 t'' in
                   (bs1, uu____6225, k) in
                 FStar_Syntax_Syntax.Tm_abs uu____6210)
        | FStar_Syntax_Syntax.Tm_arrow (bs,k) -> tn
        | uu____6244 -> tn in
      f
        (let uu___176_6245 = t in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.tk = (uu___176_6245.FStar_Syntax_Syntax.tk);
           FStar_Syntax_Syntax.pos = (uu___176_6245.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___176_6245.FStar_Syntax_Syntax.vars)
         })