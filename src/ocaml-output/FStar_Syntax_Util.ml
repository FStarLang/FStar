...
let binders_of_freevars : (FStar_Syntax_Syntax.bv Prims.list * (FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.bv  ->  Prims.bool))  ->  FStar_Syntax_Syntax.binder Prims.list = (fun fvs -> (let _107_55 = (FStar_Util.set_elements fvs)
in (FStar_All.pipe_right _107_55 (FStar_List.map FStar_Syntax_Syntax.mk_binder))))
...
(let _107_71 = (let _107_70 = (FStar_Syntax_Syntax.bv_to_name y)
in (x, _107_70))
in FStar_Syntax_Syntax.NT (_107_71))
...
let constant_univ_as_nat : FStar_Syntax_Syntax.universe  ->  Prims.int = (fun u -> (let _107_78 = (univ_kernel u)
in (Prims.snd _107_78)))
...
let copt = (let _107_84 = (FStar_List.zip us1 us2)
in (FStar_Util.find_map _107_84 (fun _28_192 -> (match (_28_192) with
| (u1, u2) -> begin
(
...
let ml_comp : FStar_Syntax_Syntax.typ  ->  FStar_Range.range  ->  FStar_Syntax_Syntax.comp = (fun t r -> (let _107_94 = (let _107_93 = (FStar_Ident.set_lid_range FStar_Syntax_Const.effect_ML_lid r)
in {FStar_Syntax_Syntax.effect_name = _107_93; FStar_Syntax_Syntax.result_typ = t; FStar_Syntax_Syntax.effect_args = []; FStar_Syntax_Syntax.flags = (FStar_Syntax_Syntax.MLEFFECT)::[]})
in (FStar_Syntax_Syntax.mk_Comp _107_94)))
...
let is_pure_or_ghost_function : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _107_129 = (FStar_Syntax_Subst.compress t)
in _107_129.FStar_Syntax_Syntax.n)) with
...
let is_lemma : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _107_132 = (FStar_Syntax_Subst.compress t)
in _107_132.FStar_Syntax_Syntax.n)) with
...
let is_smt_lemma : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _107_139 = (FStar_Syntax_Subst.compress t)
in _107_139.FStar_Syntax_Syntax.n)) with
...
| (head, _28_373) -> begin
(match ((let _107_140 = (un_uinst head)
in _107_140.FStar_Syntax_Syntax.n)) with
...
let is_fun : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun e -> (match ((let _107_159 = (FStar_Syntax_Subst.compress e)
in _107_159.FStar_Syntax_Syntax.n)) with
...
let is_function_typ : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _107_162 = (FStar_Syntax_Subst.compress t)
in _107_162.FStar_Syntax_Syntax.n)) with
...
in (match ((let _107_169 = (un_uinst typ)
in _107_169.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_app (head, args) -> begin
(
...
| [] -> begin
(let _107_188 = (let _107_187 = (let _107_186 = (FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in (_107_186, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Data_app)))
in FStar_Syntax_Syntax.Tm_meta (_107_187))
in (FStar_Syntax_Syntax.mk _107_188 None (FStar_Ident.range_of_lid l)))
end
| _28_732 -> begin
(
# 445 "FStar.Syntax.Util.fst"
let e = (let _107_189 = (FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in (mk_app _107_189 args))
...
(let _107_195 = (let _107_194 = (FStar_Util.substring_from x.FStar_Ident.idText 7)
in (_107_194, x.FStar_Ident.idRange))
in (FStar_Ident.mk_ident _107_195))
end else begin
x
end)
...
(let _107_205 = (let _107_204 = (let _107_202 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _107_202))
in (let _107_203 = (FStar_Syntax_Syntax.range_of_bv x)
in (_107_204, _107_203)))
in (FStar_Ident.mk_ident _107_205))
end else begin
...
in (let _107_209 = (let _107_208 = (let _107_207 = (let _107_206 = (unmangle_field_name nm)
in (_107_206)::[])
in (FStar_List.append (FStar_Ident.ids_of_lid lid) _107_207))
in (FStar_Ident.lid_of_ids _107_208))
in (_107_209, y)))))

# 459 "FStar.Syntax.Util.fst"
let set_uvar = (fun uv t -> (match ((FStar_Unionfind.find uv)) with
| FStar_Syntax_Syntax.Fixed (_28_746) -> begin
(let _107_214 = (let _107_213 = (let _107_212 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _107_212))
in (FStar_Util.format1 "Changing a fixed uvar! ?%s\n" _107_213))
in (FStar_All.failwith _107_214))
end
| _28_749 -> begin
...
| _28_796 -> begin
(let _107_221 = (FStar_Syntax_Syntax.mk_Total k)
in ([], _107_221))
end)))
...
let rec abs_formals : FStar_Syntax_Syntax.term  ->  ((FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.arg_qualifier Prims.option) Prims.list * FStar_Syntax_Syntax.term) = (fun t -> (match ((let _107_226 = (FStar_Syntax_Subst.compress t)
in _107_226.FStar_Syntax_Syntax.n)) with
...
let body = (let _107_233 = (FStar_Syntax_Subst.close bs t)
in (FStar_Syntax_Subst.compress _107_233))
in (match ((body.FStar_Syntax_Syntax.n, lopt)) with
| (FStar_Syntax_Syntax.Tm_abs (bs', t, lopt'), None) -> begin
(let _107_237 = (let _107_236 = (let _107_235 = (let _107_234 = (FStar_Syntax_Subst.close_binders bs)
in (FStar_List.append _107_234 bs'))
in (_107_235, t, lopt))
in FStar_Syntax_Syntax.Tm_abs (_107_236))
in (FStar_Syntax_Syntax.mk _107_237 None t.FStar_Syntax_Syntax.pos))
end
| _28_828 -> begin
(
...
| Some (lc) -> begin
(let _107_238 = (FStar_Syntax_Subst.close_lcomp bs lc)
in Some (_107_238))
end)
in (let _107_241 = (let _107_240 = (let _107_239 = (FStar_Syntax_Subst.close_binders bs)
in (_107_239, body, lopt))
in FStar_Syntax_Syntax.Tm_abs (_107_240))
in (FStar_Syntax_Syntax.mk _107_241 None t.FStar_Syntax_Syntax.pos)))
end))
end))
...
| _28_837 -> begin
(let _107_249 = (let _107_248 = (let _107_247 = (FStar_Syntax_Subst.close_binders bs)
in (let _107_246 = (FStar_Syntax_Subst.close_comp bs c)
in (_107_247, _107_246)))
in FStar_Syntax_Syntax.Tm_arrow (_107_248))
in (FStar_Syntax_Syntax.mk _107_249 None c.FStar_Syntax_Syntax.pos))
end))

# 514 "FStar.Syntax.Util.fst"
let refine : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun b t -> (let _107_261 = (let _107_257 = (let _107_256 = (let _107_255 = (let _107_254 = (FStar_Syntax_Syntax.mk_binder b)
in (_107_254)::[])
in (FStar_Syntax_Subst.close _107_255 t))
in (b, _107_256))
in FStar_Syntax_Syntax.Tm_refine (_107_257))
in (let _107_260 = (FStar_ST.read b.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.tk)
in (let _107_259 = (let _107_258 = (FStar_Syntax_Syntax.range_of_bv b)
in (FStar_Range.union_ranges _107_258 t.FStar_Syntax_Syntax.pos))
in (FStar_Syntax_Syntax.mk _107_261 _107_260 _107_259)))))
...
let universes = (FStar_All.pipe_right univ_vars (FStar_List.map (fun _107_286 -> FStar_Syntax_Syntax.U_name (_107_286))))
in (
...
| (uvs, t') -> begin
(match ((let _107_294 = (FStar_Syntax_Subst.compress t')
in _107_294.FStar_Syntax_Syntax.n)) with
...
in (FStar_Util.format1 "tuple%s" _107_301))
...
let t = (let _107_307 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Mktuple%s" _107_307))
in (let _107_308 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _107_308 r))))

# 561 "FStar.Syntax.Util.fst"
let is_tuple_data_lid : FStar_Ident.lident  ->  Prims.int  ->  Prims.bool = (fun f n -> (let _107_313 = (mk_tuple_data_lid n FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f _107_313)))
...
in (FStar_Util.format1 "dtuple%s" _107_320))
...
let t = (let _107_326 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Mkdtuple%s" _107_326))
in (let _107_327 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _107_327 r))))
...
let is_constructor : FStar_Syntax_Syntax.term  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _107_343 = (pre_typ t)
in _107_343.FStar_Syntax_Syntax.n)) with
...
let rec is_constructed_typ : FStar_Syntax_Syntax.term  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _107_348 = (pre_typ t)
in _107_348.FStar_Syntax_Syntax.n)) with
...
let u = (let _107_359 = (FStar_Unionfind.fresh None)
in (FStar_All.pipe_left (fun _107_358 -> FStar_Syntax_Syntax.U_unif (_107_358)) _107_359))
in (let _107_360 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (u)) None FStar_Range.dummyRange)
in (_107_360, u)))
end))
...
| Some (phi1) -> begin
(let _107_374 = (let _107_373 = (let _107_371 = (let _107_370 = (let _107_369 = (FStar_Syntax_Syntax.as_arg phi1)
in (let _107_368 = (let _107_367 = (FStar_Syntax_Syntax.as_arg phi2)
in (_107_367)::[])
in (_107_369)::_107_368))
in (tand, _107_370))
in FStar_Syntax_Syntax.Tm_app (_107_371))
in (let _107_372 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _107_373 None _107_372)))
in Some (_107_374))
end))

# 663 "FStar.Syntax.Util.fst"
let mk_binop = (fun op_t phi1 phi2 -> (let _107_384 = (let _107_382 = (let _107_381 = (let _107_380 = (FStar_Syntax_Syntax.as_arg phi1)
in (let _107_379 = (let _107_378 = (FStar_Syntax_Syntax.as_arg phi2)
in (_107_378)::[])
in (_107_380)::_107_379))
in (op_t, _107_381))
in FStar_Syntax_Syntax.Tm_app (_107_382))
in (let _107_383 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _107_384 None _107_383))))

# 664 "FStar.Syntax.Util.fst"
let mk_neg = (fun phi -> (let _107_389 = (let _107_388 = (let _107_387 = (let _107_386 = (FStar_Syntax_Syntax.as_arg phi)
in (_107_386)::[])
in (t_not, _107_387))
in FStar_Syntax_Syntax.Tm_app (_107_388))
in (FStar_Syntax_Syntax.mk _107_389 None phi.FStar_Syntax_Syntax.pos)))
...
let mk_imp : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun phi1 phi2 -> (match ((let _107_402 = (FStar_Syntax_Subst.compress phi1)
in _107_402.FStar_Syntax_Syntax.n)) with
...
| _28_992 -> begin
(match ((let _107_403 = (FStar_Syntax_Subst.compress phi2)
in _107_403.FStar_Syntax_Syntax.n)) with
...
let b2t = (fun e -> (let _107_410 = (let _107_409 = (let _107_408 = (let _107_407 = (FStar_Syntax_Syntax.as_arg e)
in (_107_407)::[])
in (b2t_v, _107_408))
in FStar_Syntax_Syntax.Tm_app (_107_409))
in (FStar_Syntax_Syntax.mk _107_410 None e.FStar_Syntax_Syntax.pos)))

# 685 "FStar.Syntax.Util.fst"
let teq : FStar_Syntax_Syntax.term = (fvar_const FStar_Syntax_Const.eq2_lid)

# 687 "FStar.Syntax.Util.fst"
let mk_eq = (fun t1 t2 e1 e2 -> (let _107_421 = (let _107_419 = (let _107_418 = (let _107_417 = (FStar_Syntax_Syntax.as_arg e1)
in (let _107_416 = (let _107_415 = (FStar_Syntax_Syntax.as_arg e2)
in (_107_415)::[])
in (_107_417)::_107_416))
in (teq, _107_418))
in FStar_Syntax_Syntax.Tm_app (_107_419))
in (let _107_420 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _107_421 None _107_420))))
...
in (let _107_432 = (let _107_431 = (let _107_430 = (let _107_429 = (FStar_Syntax_Syntax.iarg t)
in (let _107_428 = (let _107_427 = (FStar_Syntax_Syntax.as_arg x)
in (let _107_426 = (let _107_425 = (FStar_Syntax_Syntax.as_arg t')
in (_107_425)::[])
in (_107_427)::_107_426))
in (_107_429)::_107_428))
in (t_has_type, _107_430))
in FStar_Syntax_Syntax.Tm_app (_107_431))
in (FStar_Syntax_Syntax.mk _107_432 None FStar_Range.dummyRange)))))
...
let mk_forall : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun x body -> (let _107_449 = (let _107_448 = (let _107_447 = (let _107_446 = (let _107_445 = (let _107_444 = (let _107_440 = (FStar_Syntax_Syntax.mk_binder x)
in (_107_440)::[])
in (let _107_443 = (let _107_442 = (let _107_441 = (FStar_Syntax_Syntax.mk_Total ktype0)
in (FStar_All.pipe_left lcomp_of_comp _107_441))
in Some (_107_442))
in (abs _107_444 body _107_443)))
in (FStar_Syntax_Syntax.as_arg _107_445))
in (_107_446)::[])
in (tforall, _107_447))
in FStar_Syntax_Syntax.Tm_app (_107_448))
in (FStar_Syntax_Syntax.mk _107_449 None FStar_Range.dummyRange)))
...
let then_branch = (let _107_460 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t1.FStar_Syntax_Syntax.pos)
in (_107_460, None, t1))
in (
# 721 "FStar.Syntax.Util.fst"
let else_branch = (let _107_461 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (false))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Syntax_Syntax.pos)
in (_107_461, None, t2))
in (let _107_463 = (let _107_462 = (FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos t2.FStar_Syntax_Syntax.pos)
in (FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos _107_462))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match ((b, (then_branch)::(else_branch)::[]))) None _107_463)))))
...
(let _107_516 = (FStar_Syntax_Subst.compress t)
in (pats, _107_516))
end
| _28_1060 -> begin
(let _107_517 = (FStar_Syntax_Subst.compress t)
in ([], _107_517))
end)))
in (
...
| (t, args) -> begin
(let _107_529 = (un_uinst t)
in (let _107_528 = (FStar_All.pipe_right args (FStar_List.map (fun _28_1073 -> (match (_28_1073) with
| (t, imp) -> begin
(let _107_527 = (unascribe t)
in (_107_527, imp))
end))))
in (_107_529, _107_528)))
end)))
in (
# 766 "FStar.Syntax.Util.fst"
let rec aux = (fun qopt out t -> (match ((let _107_536 = (flat t)
in (qopt, _107_536))) with
