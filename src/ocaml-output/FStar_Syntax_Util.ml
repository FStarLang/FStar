            ...
            (fun acc ->
               fun uu____11274 ->
                 ...
                 | (bv, uu____11280) ->
                     ...
                     acc + uu____11281) (Prims.parse_int "0") bs in
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid ->
    fun t ->
      let uu____11331 =
        let uu____11332 = un_uinst t in uu____11332.FStar_Syntax_Syntax.n in
  ...
  fun p ->
    fun r ->
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____11371 = FStar_Options.restore_cmd_line_options false in
