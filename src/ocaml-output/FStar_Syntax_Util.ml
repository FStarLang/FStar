...
let rec (eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___117_3070 = if uu___117_3070 then Equal else Unknown
         in
      let equal_iff uu___118_3077 = if uu___118_3077 then Equal else NotEqual
         in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___126_5455 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___126_5455.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___126_5455.FStar_Syntax_Syntax.sort)
          }  in
              ...
              let uu____5623 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___127_5624.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____5625;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___127_5624.FStar_Syntax_Syntax.residual_flags)
                }  in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____6807 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___128_6808.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____6809;
              FStar_Syntax_Syntax.residual_flags =
                (uu___128_6808.FStar_Syntax_Syntax.residual_flags)
            }  in
