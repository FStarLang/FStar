...
let uu___179_642 = (comp_to_comp_typ c)
in {FStar_Syntax_Syntax.comp_univs = uu___179_642.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___179_642.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu___179_642.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___179_642.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = f})
in FStar_Syntax_Syntax.Comp (uu____641))
in {FStar_Syntax_Syntax.n = uu____640; FStar_Syntax_Syntax.tk = uu___178_639.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___178_639.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___178_639.FStar_Syntax_Syntax.vars}))))
...
let is_total_comp = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___166_704 -> (match (uu___166_704) with
...
let is_total_lcomp : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun c -> ((FStar_Ident.lid_equals c.FStar_Syntax_Syntax.eff_name FStar_Syntax_Const.effect_Tot_lid) || (FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___167_710 -> (match (uu___167_710) with
| (FStar_Syntax_Syntax.TOTAL) | (FStar_Syntax_Syntax.RETURN) -> begin
true
end
| uu____711 -> begin
...
let is_partial_return = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___169_730 -> (match (uu___169_730) with
...
let is_lcomp_partial_return : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun c -> (FStar_All.pipe_right c.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___170_736 -> (match (uu___170_736) with
| (FStar_Syntax_Syntax.RETURN) | (FStar_Syntax_Syntax.PARTIAL_RETURN) -> begin
true
end
| uu____737 -> begin
...
| FStar_Syntax_Syntax.Comp (ct) -> begin
(((is_total_comp c) || (is_pure_effect ct.FStar_Syntax_Syntax.effect_name)) || (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___171_777 -> (match (uu___171_777) with
...
let is_pure_lcomp : FStar_Syntax_Syntax.lcomp  ->  Prims.bool = (fun lc -> (((is_total_lcomp lc) || (is_pure_effect lc.FStar_Syntax_Syntax.eff_name)) || (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_Util.for_some (fun uu___172_797 -> (match (uu___172_797) with
| FStar_Syntax_Syntax.LEMMA -> begin
true
end
| uu____798 -> begin
...
| FStar_Syntax_Syntax.Comp (c1) -> begin
((FStar_Ident.lid_equals c1.FStar_Syntax_Syntax.effect_name FStar_Syntax_Const.effect_ML_lid) || (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_Util.for_some (fun uu___173_1018 -> (match (uu___173_1018) with
...
let uu___180_1077 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___180_1077.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___180_1077.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = t; FStar_Syntax_Syntax.effect_args = uu___180_1077.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___180_1077.FStar_Syntax_Syntax.flags}))
end))


let is_trivial_wp = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun uu___174_1090 -> (match (uu___174_1090) with
| (FStar_Syntax_Syntax.TOTAL) | (FStar_Syntax_Syntax.RETURN) -> begin
true
end
| uu____1091 -> begin
...
let equal_if = (fun uu___175_1271 -> (match (uu___175_1271) with
| true -> begin
Equal
end
| uu____1272 -> begin
...
let equal_iff = (fun uu___176_1276 -> (match (uu___176_1276) with
| true -> begin
Equal
end
| uu____1277 -> begin
...
let range_of_lb = (fun uu___177_1908 -> (match (uu___177_1908) with
...
let uu___181_2145 = x
in {FStar_Syntax_Syntax.ppname = nm; FStar_Syntax_Syntax.index = uu___181_2145.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___181_2145.FStar_Syntax_Syntax.sort})
in (
...
let uu___182_2801 = l1
in (

let uu____2802 = (FStar_Syntax_Subst.subst s l1.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = uu___182_2801.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = uu____2802; FStar_Syntax_Syntax.cflags = uu___182_2801.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____2805 -> (
...
let uu____3700 = (FStar_Syntax_Syntax.as_arg e)
in (uu____3700)::[])
in ((b2t_v), (uu____3698)))
in FStar_Syntax_Syntax.Tm_app (uu____3688))
in (FStar_Syntax_Syntax.mk uu____3687))
in (uu____3684 None e.FStar_Syntax_Syntax.pos)))
...
let uu____3724 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (
...
let uu____3741 = (FStar_Syntax_Syntax.as_arg e1)
in (

let uu____3742 = (

let uu____3744 = (FStar_Syntax_Syntax.as_arg e2)
in (uu____3744)::[])
in (uu____3741)::uu____3742))
in ((teq), (uu____3739)))
in FStar_Syntax_Syntax.Tm_app (uu____3729))
in (FStar_Syntax_Syntax.mk uu____3728))
in (uu____3725 None uu____3724))))
...
let uu____3767 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (
...
let uu____3784 = (FStar_Syntax_Syntax.iarg t)
in (

let uu____3785 = (

let uu____3787 = (FStar_Syntax_Syntax.as_arg e1)
in (

let uu____3788 = (

let uu____3790 = (FStar_Syntax_Syntax.as_arg e2)
in (uu____3790)::[])
in (uu____3787)::uu____3788))
in (uu____3784)::uu____3785))
in ((eq_inst), (uu____3782)))
in FStar_Syntax_Syntax.Tm_app (uu____3772))
in (FStar_Syntax_Syntax.mk uu____3771))
in (uu____3768 None uu____3767)))))
...
let uu____3844 = (FStar_Syntax_Syntax.iarg t)
in (

let uu____3845 = (

let uu____3847 = (FStar_Syntax_Syntax.as_arg x)
in (

let uu____3848 = (

let uu____3850 = (FStar_Syntax_Syntax.as_arg t')
in (uu____3850)::[])
in (uu____3847)::uu____3848))
in (uu____3844)::uu____3845))
in ((t_has_type1), (uu____3842)))
in FStar_Syntax_Syntax.Tm_app (uu____3832))
in (FStar_Syntax_Syntax.mk uu____3831))
in (uu____3828 None FStar_Range.dummyRange)))))
...
let uu____3869 = (match (c0.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (uu____3876) -> begin
((FStar_Syntax_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[]))
end
| FStar_Syntax_Syntax.GTotal (uu____3883) -> begin
...
{FStar_Syntax_Syntax.eff_name = eff_name; FStar_Syntax_Syntax.res_typ = (comp_result c0); FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = (fun uu____3896 -> c0)}
end)))
...
let uu____3936 = (FStar_Syntax_Syntax.iarg x.FStar_Syntax_Syntax.sort)
in (
...
let uu____3942 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____3942)::[])
in (
...
let uu____3957 = (FStar_Syntax_Syntax.mk_Total ktype0)
in (FStar_All.pipe_left lcomp_of_comp uu____3957))
in FStar_Util.Inl (uu____3956))
in Some (uu____3950))
in (abs uu____3941 body uu____3943)))
in (FStar_Syntax_Syntax.as_arg uu____3940))
in (uu____3939)::[])
in (uu____3936)::uu____3937))
in ((fa), (uu____3934)))
in FStar_Syntax_Syntax.Tm_app (uu____3924))
in (FStar_Syntax_Syntax.mk uu____3923))
in (uu____3920 None FStar_Range.dummyRange)))
...
let uu____4007 = (FStar_Syntax_Syntax.is_null_binder b)
...
| FStar_Syntax_Syntax.Pat_wild (uu____4020) -> begin
true
end
| uu____4021 -> begin
false
...
let uu____4064 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t1.FStar_Syntax_Syntax.pos)
in ((uu____4064), (None), (t1)))
in (

let else_branch = (

let uu____4087 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (false))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Syntax_Syntax.pos)
in ((uu____4087), (None), (t2)))
in (

let uu____4099 = (

let uu____4100 = (FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos t2.FStar_Syntax_Syntax.pos)
in (FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos uu____4100))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (((b), ((then_branch)::(else_branch)::[])))) None uu____4099)))))
...
let rec aux = (fun f2 uu____4300 -> (match (uu____4300) with
| (lid, arity) -> begin
(

let uu____4306 = (

let uu____4316 = (unmeta_monadic f2)
in (head_and_args uu____4316))
...
let uu____4335 = ((is_constructor t1 lid) && ((FStar_List.length args) = arity))
...
let uu____4386 = (FStar_Syntax_Subst.compress t2)
in ((pats), (uu____4386)))
end
| uu____4393 -> begin
(

let uu____4394 = (FStar_Syntax_Subst.compress t1)
in (([]), (uu____4394)))
end)))
in (
...
let uu____4436 = (head_and_args t1)
in (match (uu____4436) with
| (t2, args) -> begin
(

let uu____4467 = (un_uinst t2)
in (

let uu____4468 = (FStar_All.pipe_right args (FStar_List.map (fun uu____4484 -> (match (uu____4484) with
| (t3, imp) -> begin
(

let uu____4491 = (unascribe t3)
in ((uu____4491), (imp)))
end))))
in ((uu____4467), (uu____4468))))
end)))
in (
...
let uu____4523 = (flat t1)
in ((qopt), (uu____4523)))
in (match (uu____4514) with
...
| (Some (b), uu____4782) -> begin
(

let bs = (FStar_List.rev out)
in (

let uu____4800 = (FStar_Syntax_Subst.open_term bs t1)
in (match (uu____4800) with
| (bs1, t2) -> begin
(

let uu____4806 = (patterns t2)
...
let uu____4856 = (destruct_base_conn phi)
...
let uu____4870 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.Delta_equational None)
in FStar_Util.Inr (uu____4870))
in (

let uu____4871 = (

let uu____4872 = (FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ)
in (arrow a.FStar_Syntax_Syntax.action_params uu____4872))
in (

let uu____4875 = (abs a.FStar_Syntax_Syntax.action_params a.FStar_Syntax_Syntax.action_defn None)
in (close_univs_and_mk_letbinding None uu____4867 a.FStar_Syntax_Syntax.action_univs uu____4871 FStar_Syntax_Const.effect_Tot_lid uu____4875))))
...
let uu____4925 = (FStar_Syntax_Syntax.as_arg t)
in (uu____4925)::[])
in ((reify_), (uu____4923)))
in FStar_Syntax_Syntax.Tm_app (uu____4913))
in (FStar_Syntax_Syntax.mk uu____4912))
in (uu____4909 None t.FStar_Syntax_Syntax.pos))))
...
let t1 = (FStar_Syntax_Subst.compress t)
in (match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____4941) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
let uu____5053 = (FStar_Syntax_Subst.compress t)
in uu____5053.FStar_Syntax_Syntax.n)
...
let uu____5074 = (unmeta e)
in (head_and_args uu____5074))
...
let uu____5102 = (un_uinst head1)
in uu____5102.FStar_Syntax_Syntax.n)
in ((uu____5101), (args)))
in (match (uu____5093) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____5113) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.nil_lid) -> begin
Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____5126)::((hd1, uu____5128))::((tl1, uu____5130))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.cons_lid) -> begin
(
...
let uu____5172 = (list_elements tl1)
in (FStar_Util.must uu____5172))
in (hd1)::uu____5168)
in Some (uu____5164))
end
| uu____5181 -> begin
...
let eqlen = (fun xs ys -> ((FStar_List.length xs) = (FStar_List.length ys)))
...
let uu____5258 = (FStar_Syntax_Subst.compress t1)
in uu____5258.FStar_Syntax_Syntax.n)
in (

let uu____5261 = (

let uu____5262 = (FStar_Syntax_Subst.compress t2)
in uu____5262.FStar_Syntax_Syntax.n)
in ((uu____5257), (uu____5261))))
...
((((eqlen b1 b2) && (FStar_List.forall2 (fun uu____5329 uu____5330 -> (match (((uu____5329), (uu____5330))) with
| ((bv1, a1), (bv2, a2)) -> begin
((FStar_Syntax_Syntax.bv_eq bv1 bv2) && (a1 = a2))
end)) b1 b2)) && (term_eq t11 t21)) && true)
end
| (FStar_Syntax_Syntax.Tm_app (f1, a1), FStar_Syntax_Syntax.Tm_app (f2, a2)) -> begin
(((term_eq f1 f2) && (eqlen a1 a2)) && (FStar_List.forall2 (fun uu____5387 uu____5388 -> (match (((uu____5387), (uu____5388))) with
| ((x, uu____5398), (y, uu____5400)) -> begin
(term_eq x y)
end)) a1 a2))
end
| (FStar_Syntax_Syntax.Tm_arrow (b1, c1), FStar_Syntax_Syntax.Tm_arrow (b2, c2)) -> begin
((FStar_List.forall2 (fun uu____5433 uu____5434 -> (match (((uu____5433), (uu____5434))) with
| ((bv1, a1), (bv2, a2)) -> begin
((FStar_Syntax_Syntax.bv_eq bv1 bv2) && (a1 = a2))
end)) b1 b2) && (comp_eq c1 c2))
end
...
(((term_eq t11 t21) && (eqlen bs1 bs2)) && (FStar_List.forall2 branch_eq bs1 bs2))
end
| (uu____5549, uu____5550) -> begin
false
end)))
...
(((((c11.FStar_Syntax_Syntax.comp_univs = c21.FStar_Syntax_Syntax.comp_univs) && (c11.FStar_Syntax_Syntax.effect_name = c21.FStar_Syntax_Syntax.effect_name)) && (term_eq c11.FStar_Syntax_Syntax.result_typ c21.FStar_Syntax_Syntax.result_typ)) && (FStar_List.forall2 (fun uu____5595 uu____5596 -> (match (((uu____5595), (uu____5596))) with
| ((x, uu____5606), (y, uu____5608)) -> begin
(term_eq x y)
end)) c11.FStar_Syntax_Syntax.effect_args c21.FStar_Syntax_Syntax.effect_args)) && (eq_flags c11.FStar_Syntax_Syntax.flags c21.FStar_Syntax_Syntax.flags))
end
| (uu____5613, uu____5614) -> begin
false
end))
and eq_flags : FStar_Syntax_Syntax.cflags Prims.list  ->  FStar_Syntax_Syntax.cflags Prims.list  ->  Prims.bool = (fun f1 f2 -> false)
and branch_eq : ((FStar_Syntax_Syntax.pat', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.withinfo_t * (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax Prims.option * (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax)  ->  ((FStar_Syntax_Syntax.pat', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.withinfo_t * (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax Prims.option * (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax)  ->  Prims.bool = (fun uu____5619 uu____5620 -> (match (((uu____5619), (uu____5620))) with
...
let uu____5730 = (un_uinst t)
in uu____5730.FStar_Syntax_Syntax.n)
in (
...
let uu____5760 = (ff f1)
in (

let uu____5761 = (FStar_List.map (fun uu____5769 -> (match (uu____5769) with
| (a, q) -> begin
(
...
in ((uu____5760), (uu____5761))))
in FStar_Syntax_Syntax.Tm_app (uu____5750))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, k) -> begin
(

let uu____5805 = (FStar_Syntax_Subst.open_term bs t1)
...
let uu____5826 = (FStar_Syntax_Subst.close bs t'')
in ((bs), (uu____5826), (k)))
in FStar_Syntax_Syntax.Tm_abs (uu____5811)))
end))
end
...
let uu___183_5849 = t
in {FStar_Syntax_Syntax.n = tn1; FStar_Syntax_Syntax.tk = uu___183_5849.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___183_5849.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___183_5849.FStar_Syntax_Syntax.vars}))))))
