...
in (uu____956 = (Prims.parse_int "0"))))
...
let uu____4706 = (FStar_Range.union_ranges phi11.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (
...
let uu____4729 = (FStar_Syntax_Syntax.as_arg phi11)
in (

let uu____4730 = (

let uu____4733 = (FStar_Syntax_Syntax.as_arg phi2)
in (uu____4733)::[])
in (uu____4729)::uu____4730))
in ((tand), (uu____4726)))
in FStar_Syntax_Syntax.Tm_app (uu____4711))
in (FStar_Syntax_Syntax.mk uu____4710))
in (uu____4707 FStar_Pervasives_Native.None uu____4706)))
...
let uu____4759 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (
...
let uu____4782 = (FStar_Syntax_Syntax.as_arg phi1)
in (

let uu____4783 = (

let uu____4786 = (FStar_Syntax_Syntax.as_arg phi2)
in (uu____4786)::[])
in (uu____4782)::uu____4783))
in ((op_t), (uu____4779)))
in FStar_Syntax_Syntax.Tm_app (uu____4764))
in (FStar_Syntax_Syntax.mk uu____4763))
in (uu____4760 FStar_Pervasives_Native.None uu____4759))))
...
let uu____4822 = (FStar_Syntax_Syntax.as_arg phi)
in (uu____4822)::[])
in ((t_not), (uu____4819)))
in FStar_Syntax_Syntax.Tm_app (uu____4804))
in (FStar_Syntax_Syntax.mk uu____4803))
in (uu____4800 FStar_Pervasives_Native.None phi.FStar_Syntax_Syntax.pos)))
...
let uu____4916 = (FStar_Syntax_Syntax.as_arg e)
in (uu____4916)::[])
in ((b2t_v), (uu____4913)))
in FStar_Syntax_Syntax.Tm_app (uu____4898))
in (FStar_Syntax_Syntax.mk uu____4897))
in (uu____4894 FStar_Pervasives_Native.None e.FStar_Syntax_Syntax.pos)))
...
let uu____4932 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (
...
let uu____4955 = (FStar_Syntax_Syntax.as_arg e1)
in (

let uu____4956 = (

let uu____4959 = (FStar_Syntax_Syntax.as_arg e2)
in (uu____4959)::[])
in (uu____4955)::uu____4956))
in ((teq), (uu____4952)))
in FStar_Syntax_Syntax.Tm_app (uu____4937))
in (FStar_Syntax_Syntax.mk uu____4936))
in (uu____4933 FStar_Pervasives_Native.None uu____4932))))
...
let uu____4982 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (
...
let uu____5005 = (FStar_Syntax_Syntax.iarg t)
in (

let uu____5006 = (

let uu____5009 = (FStar_Syntax_Syntax.as_arg e1)
in (

let uu____5010 = (

let uu____5013 = (FStar_Syntax_Syntax.as_arg e2)
in (uu____5013)::[])
in (uu____5009)::uu____5010))
in (uu____5005)::uu____5006))
in ((eq_inst), (uu____5002)))
in FStar_Syntax_Syntax.Tm_app (uu____4987))
in (FStar_Syntax_Syntax.mk uu____4986))
in (uu____4983 FStar_Pervasives_Native.None uu____4982)))))
...
let uu____5061 = (FStar_Syntax_Syntax.iarg t)
in (

let uu____5062 = (

let uu____5065 = (FStar_Syntax_Syntax.as_arg x)
in (

let uu____5066 = (

let uu____5069 = (FStar_Syntax_Syntax.as_arg t')
in (uu____5069)::[])
in (uu____5065)::uu____5066))
in (uu____5061)::uu____5062))
in ((t_has_type1), (uu____5058)))
in FStar_Syntax_Syntax.Tm_app (uu____5043))
in (FStar_Syntax_Syntax.mk uu____5042))
in (uu____5039 FStar_Pervasives_Native.None FStar_Range.dummyRange)))))
...
let uu____5090 = (FStar_Syntax_Syntax.fvar FStar_Parser_Const.lextop_lid FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in ((uu____5090), ((FStar_Syntax_Syntax.U_zero)::[])))
in FStar_Syntax_Syntax.Tm_uinst (uu____5083))
in (FStar_Syntax_Syntax.mk uu____5082))
in (uu____5079 FStar_Pervasives_Native.None FStar_Range.dummyRange))
...
let uu____5104 = (match (c0.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (uu____5117) -> begin
((FStar_Parser_Const.effect_Tot_lid), ((FStar_Syntax_Syntax.TOTAL)::[]))
end
| FStar_Syntax_Syntax.GTotal (uu____5128) -> begin
...
{FStar_Syntax_Syntax.eff_name = eff_name; FStar_Syntax_Syntax.res_typ = (comp_result c0); FStar_Syntax_Syntax.cflags = flags; FStar_Syntax_Syntax.comp = (fun uu____5149 -> c0)}
end)))
...
let uu____5236 = (FStar_Syntax_Syntax.iarg x.FStar_Syntax_Syntax.sort)
in (
...
let uu____5243 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____5243)::[])
in (abs uu____5242 body (FStar_Pervasives_Native.Some ((residual_tot ktype0)))))
in (FStar_Syntax_Syntax.as_arg uu____5241))
in (uu____5240)::[])
in (uu____5236)::uu____5237))
in ((fa), (uu____5233)))
in FStar_Syntax_Syntax.Tm_app (uu____5218))
in (FStar_Syntax_Syntax.mk uu____5217))
in (uu____5214 FStar_Pervasives_Native.None FStar_Range.dummyRange)))
...
let uu____5289 = (FStar_Syntax_Syntax.is_null_binder b)
...
| FStar_Syntax_Syntax.Pat_wild (uu____5299) -> begin
true
end
| uu____5300 -> begin
false
...
let uu____5342 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) t1.FStar_Syntax_Syntax.pos)
in ((uu____5342), (FStar_Pervasives_Native.None), (t1)))
in (

let else_branch = (

let uu____5370 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (false))) t2.FStar_Syntax_Syntax.pos)
in ((uu____5370), (FStar_Pervasives_Native.None), (t2)))
in (

let uu____5383 = (

let uu____5384 = (FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos t2.FStar_Syntax_Syntax.pos)
in (FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos uu____5384))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (((b), ((then_branch)::(else_branch)::[])))) FStar_Pervasives_Native.None uu____5383)))))
...
let uu____5452 = (FStar_Syntax_Syntax.mk_Tm_uinst sq ((FStar_Syntax_Syntax.U_zero)::[]))
in (

let uu____5455 = (

let uu____5464 = (FStar_Syntax_Syntax.as_arg p)
in (uu____5464)::[])
in (mk_app uu____5452 uu____5455)))))
...
let uu____5473 = (head_and_args t)
...
let uu____5528 = (un_uinst head1)
in uu____5528.FStar_Syntax_Syntax.n)
in ((uu____5527), (args)))
in (match (uu____5514) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((p, uu____5545))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid) -> begin
...
let uu____5603 = (FStar_Syntax_Syntax.mk_binder b)
in (uu____5603)::[])
in (FStar_Syntax_Subst.open_term uu____5602 p))
...
let uu____5638 = (FStar_Syntax_Free.names p1)
in (FStar_Util.set_mem (FStar_Pervasives_Native.fst b1) uu____5638))
...
let uu____5815 = (arrow bs c)
in (FStar_Syntax_Syntax.mk_Total uu____5815))
in ((b), (uu____5814)))
in FStar_Pervasives_Native.Some (uu____5805))
end
| uu____5828 -> begin
FStar_Pervasives_Native.None
end))
in (FStar_Util.bind_opt uu____5682 (fun uu____5864 -> (match (uu____5864) with
| (b, c) -> begin
(

let uu____5899 = (FStar_Syntax_Subst.open_comp ((b)::[]) c)
...
let uu____5971 = (FStar_Syntax_Free.names t)
in (FStar_Util.set_mem bv uu____5971)))
...
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic (uu____6124)) -> begin
(unmeta_monadic t)
end
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic_lift (uu____6136)) -> begin
(unmeta_monadic t)
end
| uu____6149 -> begin
f2
...
let aux = (fun f2 uu____6227 -> (match (uu____6227) with
| (lid, arity) -> begin
(

let uu____6236 = (

let uu____6251 = (unmeta_monadic f2)
in (head_and_args uu____6251))
...
let uu____6277 = ((is_constructor t1 lid) && ((FStar_List.length args) = arity))
...
let uu____6352 = (FStar_Syntax_Subst.compress t2)
in ((pats), (uu____6352)))
end
| uu____6363 -> begin
(

let uu____6364 = (FStar_Syntax_Subst.compress t1)
in (([]), (uu____6364)))
end)))
in (
...
let uu____6411 = (head_and_args t1)
in (match (uu____6411) with
| (t2, args) -> begin
(

let uu____6458 = (un_uinst t2)
in (

let uu____6459 = (FStar_All.pipe_right args (FStar_List.map (fun uu____6492 -> (match (uu____6492) with
| (t3, imp) -> begin
(

let uu____6503 = (unascribe t3)
in ((uu____6503), (imp)))
end))))
in ((uu____6458), (uu____6459))))
end)))
in (
...
let uu____6555 = (flat t1)
in ((qopt), (uu____6555)))
in (match (uu____6538) with
| (FStar_Pervasives_Native.Some (fa), ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6582; FStar_Syntax_Syntax.vars = uu____6583}, (({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6586); FStar_Syntax_Syntax.pos = uu____6587; FStar_Syntax_Syntax.vars = uu____6588}, uu____6589))::[])) when (is_q fa tc) -> begin
(aux qopt ((b)::out) t2)
end
| (FStar_Pervasives_Native.Some (fa), ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6666; FStar_Syntax_Syntax.vars = uu____6667}, (uu____6668)::(({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6671); FStar_Syntax_Syntax.pos = uu____6672; FStar_Syntax_Syntax.vars = uu____6673}, uu____6674))::[])) when (is_q fa tc) -> begin
(aux qopt ((b)::out) t2)
end
| (FStar_Pervasives_Native.None, ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6762; FStar_Syntax_Syntax.vars = uu____6763}, (({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6766); FStar_Syntax_Syntax.pos = uu____6767; FStar_Syntax_Syntax.vars = uu____6768}, uu____6769))::[])) when (is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v) -> begin
(aux (FStar_Pervasives_Native.Some ((is_forall tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v))) ((b)::out) t2)
end
| (FStar_Pervasives_Native.None, ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (tc); FStar_Syntax_Syntax.pos = uu____6845; FStar_Syntax_Syntax.vars = uu____6846}, (uu____6847)::(({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs ((b)::[], t2, uu____6850); FStar_Syntax_Syntax.pos = uu____6851; FStar_Syntax_Syntax.vars = uu____6852}, uu____6853))::[])) when (is_qlid tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v) -> begin
(aux (FStar_Pervasives_Native.Some ((is_forall tc.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v))) ((b)::out) t2)
end
| (FStar_Pervasives_Native.Some (b), uu____6941) -> begin
(

let bs = (FStar_List.rev out)
in (

let uu____6975 = (FStar_Syntax_Subst.open_term bs t1)
in (match (uu____6975) with
| (bs1, t2) -> begin
(

let uu____6984 = (patterns t2)
...
let uu____7112 = (un_squash t)
in (FStar_Util.bind_opt uu____7112 (fun t1 -> (

let uu____7128 = (head_and_args' t1)
...
let uu____7167 = (un_uinst hd1)
in uu____7167.FStar_Syntax_Syntax.n)
in ((uu____7166), ((FStar_List.length args))))
...
let uu____7273 = (un_squash t)
in (FStar_Util.bind_opt uu____7273 (fun t1 -> (

let uu____7288 = (arrow_one t1)
...
let uu____7304 = (is_tot_or_gtot_comp c)
in (not (uu____7304)))
...
let uu____7311 = (comp_to_comp_typ c)
in uu____7311.FStar_Syntax_Syntax.result_typ)
in (

let uu____7312 = (FStar_Syntax_Subst.open_term ((b)::[]) q)
...
let uu____7348 = (is_free_in (FStar_Pervasives_Native.fst b1) q1)
in (match (uu____7348) with
| true -> begin
(

let uu____7351 = (patterns q1)
...
let uu____7428 = (FStar_Syntax_Syntax.as_arg (FStar_Pervasives_Native.fst b1).FStar_Syntax_Syntax.sort)
in (

let uu____7429 = (

let uu____7432 = (FStar_Syntax_Syntax.as_arg q1)
in (uu____7432)::[])
in (uu____7428)::uu____7429))
in ((FStar_Parser_Const.imp_lid), (uu____7425)))
in BaseConn (uu____7420))
in FStar_Pervasives_Native.Some (uu____7419))
end)))
end)))
end))
end
...
let uu____7443 = (un_squash t)
in (FStar_Util.bind_opt uu____7443 (fun t1 -> (

let uu____7474 = (head_and_args' t1)
...
let uu____7521 = (un_uinst hd1)
in uu____7521.FStar_Syntax_Syntax.n)
in ((uu____7520), (args)))
in (match (uu____7507) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((a1, uu____7536))::((a2, uu____7538))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.dtuple2_lid) -> begin
(

let uu____7573 = (

let uu____7574 = (FStar_Syntax_Subst.compress a2)
in uu____7574.FStar_Syntax_Syntax.n)
in (match (uu____7573) with
| FStar_Syntax_Syntax.Tm_abs ((b)::[], q, uu____7581) -> begin
(

let uu____7608 = (FStar_Syntax_Subst.open_term ((b)::[]) q)
...
let uu____7741 = (destruct_sq_forall phi)
...
let uu____7769 = (destruct_sq_exists phi)
...
let uu____7798 = (destruct_base_conn phi)
in (FStar_Util.catch_opt uu____7798 (fun uu____7803 -> (

let uu____7804 = (destruct_q_conn phi)
in (FStar_Util.catch_opt uu____7804 (fun uu____7809 -> (

let uu____7810 = (destruct_sq_base_conn phi)
in (FStar_Util.catch_opt uu____7810 (fun uu____7815 -> (

let uu____7816 = (destruct_sq_forall phi)
in (FStar_Util.catch_opt uu____7816 (fun uu____7821 -> (

let uu____7822 = (destruct_sq_exists phi)
in (FStar_Util.catch_opt uu____7822 (fun uu____7826 -> FStar_Pervasives_Native.None))))))))))))))))))))))))
...
let uu____7841 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.Delta_equational FStar_Pervasives_Native.None)
in FStar_Util.Inr (uu____7841))
in (

let uu____7842 = (

let uu____7843 = (FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ)
in (arrow a.FStar_Syntax_Syntax.action_params uu____7843))
in (

let uu____7846 = (abs a.FStar_Syntax_Syntax.action_params a.FStar_Syntax_Syntax.action_defn FStar_Pervasives_Native.None)
in (close_univs_and_mk_letbinding FStar_Pervasives_Native.None uu____7836 a.FStar_Syntax_Syntax.action_univs uu____7842 FStar_Parser_Const.effect_Tot_lid uu____7846))))
...
let uu____7894 = (FStar_Syntax_Syntax.as_arg t)
in (uu____7894)::[])
in ((reify_), (uu____7891)))
in FStar_Syntax_Syntax.Tm_app (uu____7876))
in (FStar_Syntax_Syntax.mk uu____7875))
in (uu____7872 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos))))
...
let t1 = (FStar_Syntax_Subst.compress t)
in (match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____7907) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
fv.FStar_Syntax_Syntax.fv_delta
end
| FStar_Syntax_Syntax.Tm_bvar (uu____7933) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_name (uu____7934) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_match (uu____7935) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_uvar (uu____7958) -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_unknown -> begin
FStar_Syntax_Syntax.Delta_equational
end
| FStar_Syntax_Syntax.Tm_type (uu____7975) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_constant (uu____7976) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_arrow (uu____7977) -> begin
FStar_Syntax_Syntax.Delta_constant
end
| FStar_Syntax_Syntax.Tm_uinst (t2, uu____7991) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_refine ({FStar_Syntax_Syntax.ppname = uu____7996; FStar_Syntax_Syntax.index = uu____7997; FStar_Syntax_Syntax.sort = t2}, uu____7999) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_meta (t2, uu____8007) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_ascribed (t2, uu____8013, uu____8014) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_app (t2, uu____8056) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_abs (uu____8077, t2, uu____8079) -> begin
(delta_qualifier t2)
end
| FStar_Syntax_Syntax.Tm_let (uu____8100, t2) -> begin
(delta_qualifier t2)
end)))
...
let uu____8128 = (delta_qualifier t)
in (incr_delta_depth uu____8128)))
...
let uu____8134 = (FStar_Syntax_Subst.compress t)
in uu____8134.FStar_Syntax_Syntax.n)
...
let uu____8165 = (unmeta e)
in (head_and_args uu____8165))
...
let uu____8206 = (un_uinst head1)
in uu____8206.FStar_Syntax_Syntax.n)
in ((uu____8205), (args)))
in (match (uu____8192) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____8222) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid) -> begin
FStar_Pervasives_Native.Some ([])
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____8242)::((hd1, uu____8244))::((tl1, uu____8246))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid) -> begin
(
...
let uu____8303 = (list_elements tl1)
in (FStar_Util.must uu____8303))
in (hd1)::uu____8298)
in FStar_Pervasives_Native.Some (uu____8293))
end
| uu____8316 -> begin
FStar_Pervasives_Native.None
end))
...
let rec apply_last : 'Auu____8337 . ('Auu____8337  ->  'Auu____8337)  ->  'Auu____8337 Prims.list  ->  'Auu____8337 Prims.list = (fun f l -> (match (l) with
| [] -> begin
...
let uu____8365 = (apply_last f xs)
in (x)::uu____8365)
end))
...
let uu____8410 = (FStar_Syntax_Syntax.lid_as_fv l1 FStar_Syntax_Syntax.Delta_constant (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.Data_ctor)))
in FStar_Syntax_Syntax.Tm_fvar (uu____8410))
in (FStar_Syntax_Syntax.mk uu____8409))
in (uu____8406 FStar_Pervasives_Native.None rng)))
in (
...
let uu____8425 = (ctor FStar_Parser_Const.cons_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____8425 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____8424 args))
in (uu____8423 FStar_Pervasives_Native.None pos)))
in (
...
let uu____8439 = (ctor FStar_Parser_Const.nil_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____8439 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app uu____8438 args))
in (uu____8437 FStar_Pervasives_Native.None pos)))
in (
...
let uu____8444 = (FStar_Syntax_Syntax.iarg typ)
in (uu____8444)::[])
in (nil uu____8443 rng))
in (FStar_List.fold_right (fun t a -> (

let uu____8450 = (

let uu____8451 = (FStar_Syntax_Syntax.iarg typ)
in (

let uu____8452 = (

let uu____8455 = (FStar_Syntax_Syntax.as_arg t)
in (

let uu____8456 = (

let uu____8459 = (FStar_Syntax_Syntax.as_arg a)
in (uu____8459)::[])
in (uu____8455)::uu____8456))
in (uu____8451)::uu____8452))
in (cons1 uu____8450 t.FStar_Syntax_Syntax.pos))) l uu____8442))))))
...
let uu____8491 = (FStar_Syntax_Unionfind.from_id id)
in ((uu____8491), (t)))
in FStar_Syntax_Syntax.Tm_uvar (uu____8474))
in (FStar_Syntax_Syntax.mk uu____8473))
in (uu____8470 FStar_Pervasives_Native.None FStar_Range.dummyRange)))
...
| FStar_Syntax_Syntax.Tm_app (uu____8916) -> begin
(

let uu____8931 = (head_and_args' t)
in (match (uu____8931) with
| (hd1, args) -> begin
(

let uu___175_8964 = t
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app (((hd1), (args))); FStar_Syntax_Syntax.pos = uu___175_8964.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___175_8964.FStar_Syntax_Syntax.vars})
end))
end
| uu____8975 -> begin
t
...
let uu____8979 = (unmeta_safe t1)
in (canon_app uu____8979))
in (

let t21 = (

let uu____8985 = (unmeta_safe t2)
in (canon_app uu____8985))
in (match (((t11.FStar_Syntax_Syntax.n), (t21.FStar_Syntax_Syntax.n))) with
...
let uu____9497 = (FStar_Syntax_Subst.compress t)
in uu____9497.FStar_Syntax_Syntax.n)
in (
...
let uu____9538 = (ff f1)
in (

let uu____9539 = (FStar_List.map (fun uu____9558 -> (match (uu____9558) with
| (a, q) -> begin
(
...
in ((uu____9538), (uu____9539))))
in FStar_Syntax_Syntax.Tm_app (uu____9523))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, k) -> begin
(

let uu____9599 = (FStar_Syntax_Subst.open_term bs t1)
...
let uu____9624 = (FStar_Syntax_Subst.close bs1 t'')
in ((bs1), (uu____9624), (k)))
in FStar_Syntax_Syntax.Tm_abs (uu____9607)))
end))
end
...
let uu____9658 = (ff t1)
in ((uu____9658), (us)))
in FStar_Syntax_Syntax.Tm_uinst (uu____9651))
end
| uu____9659 -> begin
tn
end)
...
let uu___176_9662 = t
in {FStar_Syntax_Syntax.n = tn1; FStar_Syntax_Syntax.pos = uu___176_9662.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___176_9662.FStar_Syntax_Syntax.vars}))))))
...
in (sizeof uu____9693))
in ((Prims.parse_int "1") + uu____9692))
end
| FStar_Syntax_Syntax.Tm_bvar (bv) -> begin
(

let uu____9695 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____9695))
end
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
(

let uu____9697 = (sizeof bv.FStar_Syntax_Syntax.sort)
in ((Prims.parse_int "1") + uu____9697))
end
| FStar_Syntax_Syntax.Tm_uinst (t1, us) -> begin
(

let uu____9704 = (sizeof t1)
in ((FStar_List.length us) + uu____9704))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t1, uu____9707) -> begin
(

let uu____9728 = (sizeof t1)
in (

let uu____9729 = (FStar_List.fold_left (fun acc uu____9740 -> (match (uu____9740) with
| (bv, uu____9746) -> begin
(

let uu____9747 = (sizeof bv.FStar_Syntax_Syntax.sort)
in (acc + uu____9747))
end)) (Prims.parse_int "0") bs)
in (uu____9728 + uu____9729)))
end
| FStar_Syntax_Syntax.Tm_app (hd1, args) -> begin
(

let uu____9770 = (sizeof hd1)
in (

let uu____9771 = (FStar_List.fold_left (fun acc uu____9782 -> (match (uu____9782) with
| (arg, uu____9788) -> begin
(

let uu____9789 = (sizeof arg)
in (acc + uu____9789))
end)) (Prims.parse_int "0") args)
in (uu____9770 + uu____9771)))
end
| uu____9790 -> begin
(Prims.parse_int "1")
end))
...
let uu____9843 = (FStar_Dyn.mkdyn b)
in ((uu____9843), (s)))
in FStar_Syntax_Syntax.Meta_alien (uu____9838))
in ((FStar_Syntax_Syntax.tun), (uu____9837)))
in FStar_Syntax_Syntax.Tm_meta (uu____9830))
in (FStar_Syntax_Syntax.mk uu____9829))
in (uu____9826 FStar_Pervasives_Native.None (match (r) with
...
| FStar_Syntax_Syntax.Tm_meta (uu____9855, FStar_Syntax_Syntax.Meta_alien (blob, uu____9857)) -> begin
blob
end
| uu____9862 -> begin
