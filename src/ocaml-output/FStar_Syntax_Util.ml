...
let is_pure_or_ghost_function : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _132_113 = (FStar_Syntax_Subst.compress t)
in _132_113.FStar_Syntax_Syntax.n)) with
...
let is_lemma : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _132_116 = (FStar_Syntax_Subst.compress t)
in _132_116.FStar_Syntax_Syntax.n)) with
...
let is_smt_lemma : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _132_123 = (FStar_Syntax_Subst.compress t)
...
| (head, _38_355) -> begin
(match ((let _132_124 = (un_uinst head)
in _132_124.FStar_Syntax_Syntax.n)) with
...
let rec is_unit : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _132_143 = (unrefine t)
in _132_143.FStar_Syntax_Syntax.n)) with
...
let rec non_informative : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _132_146 = (unrefine t)
in _132_146.FStar_Syntax_Syntax.n)) with
...
let is_fun : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun e -> (match ((let _132_149 = (FStar_Syntax_Subst.compress e)
in _132_149.FStar_Syntax_Syntax.n)) with
...
let is_function_typ : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _132_152 = (FStar_Syntax_Subst.compress t)
in _132_152.FStar_Syntax_Syntax.n)) with
...
in (match ((let _132_159 = (un_uinst typ)
...
| [] -> begin
(let _132_180 = (let _132_179 = (let _132_178 = (FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in ((_132_178), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Data_app))))
in FStar_Syntax_Syntax.Tm_meta (_132_179))
in (FStar_Syntax_Syntax.mk _132_180 None (FStar_Ident.range_of_lid l)))
end
| _38_944 -> begin
(

let e = (let _132_181 = (FStar_Syntax_Syntax.fvar l FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in (mk_app _132_181 args))
...
(let _132_187 = (let _132_186 = (FStar_Util.substring_from x.FStar_Ident.idText (Prims.parse_int "7"))
in ((_132_186), (x.FStar_Ident.idRange)))
in (FStar_Ident.mk_ident _132_187))
end else begin
x
end)
...
(let _132_197 = (let _132_196 = (let _132_194 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _132_194))
in (let _132_195 = (FStar_Syntax_Syntax.range_of_bv x)
in ((_132_196), (_132_195))))
in (FStar_Ident.mk_ident _132_197))
end else begin
...
in (let _132_201 = (let _132_200 = (let _132_199 = (let _132_198 = (unmangle_field_name nm)
in (_132_198)::[])
in (FStar_List.append (FStar_Ident.ids_of_lid lid) _132_199))
in (FStar_Ident.lid_of_ids _132_200))
in ((_132_201), (y))))))


let set_uvar = (fun uv t -> (match ((FStar_Unionfind.find uv)) with
| FStar_Syntax_Syntax.Fixed (_38_958) -> begin
(let _132_206 = (let _132_205 = (let _132_204 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _132_204))
in (FStar_Util.format1 "Changing a fixed uvar! ?%s\n" _132_205))
in (FStar_All.failwith _132_206))
end
| _38_961 -> begin
...
| _38_1001 -> begin
(let _132_213 = (FStar_Syntax_Syntax.mk_Total k)
in (([]), (_132_213)))
end)))
...
let rec abs_formals : FStar_Syntax_Syntax.term  ->  ((FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.arg_qualifier Prims.option) Prims.list * FStar_Syntax_Syntax.term) = (fun t -> (match ((let _132_218 = (FStar_Syntax_Subst.compress t)
in _132_218.FStar_Syntax_Syntax.n)) with
...
(let _132_228 = (let _132_227 = (FStar_Syntax_Subst.close_lcomp bs lc)
...
let body = (let _132_229 = (FStar_Syntax_Subst.close bs t)
in (FStar_Syntax_Subst.compress _132_229))
in (match (((body.FStar_Syntax_Syntax.n), (lopt))) with
| (FStar_Syntax_Syntax.Tm_abs (bs', t, lopt'), None) -> begin
(let _132_234 = (let _132_233 = (let _132_232 = (let _132_230 = (FStar_Syntax_Subst.close_binders bs)
in (FStar_List.append _132_230 bs'))
in (let _132_231 = (close_lopt lopt')
in ((_132_232), (t), (_132_231))))
in FStar_Syntax_Syntax.Tm_abs (_132_233))
in (FStar_Syntax_Syntax.mk _132_234 None t.FStar_Syntax_Syntax.pos))
end
| _38_1043 -> begin
(
...
| Some (FStar_Util.Inl (lc)) -> begin
(let _132_236 = (let _132_235 = (FStar_Syntax_Subst.close_lcomp bs lc)
in FStar_Util.Inl (_132_235))
in Some (_132_236))
end)
in (let _132_239 = (let _132_238 = (let _132_237 = (FStar_Syntax_Subst.close_binders bs)
in ((_132_237), (body), (lopt)))
...
| _38_1057 -> begin
(let _132_247 = (let _132_246 = (let _132_245 = (FStar_Syntax_Subst.close_binders bs)
in (let _132_244 = (FStar_Syntax_Subst.close_comp bs c)
in ((_132_245), (_132_244))))
in FStar_Syntax_Syntax.Tm_arrow (_132_246))
in (FStar_Syntax_Syntax.mk _132_247 None c.FStar_Syntax_Syntax.pos))
end))
...
let t = (arrow bs c)
in (match ((let _132_252 = (FStar_Syntax_Subst.compress t)
in _132_252.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(match (c.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (tres, _38_1067) -> begin
(match ((let _132_253 = (FStar_Syntax_Subst.compress tres)
in _132_253.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs', c') -> begin
(let _132_254 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((((FStar_List.append bs bs')), (c')))) _132_254 t.FStar_Syntax_Syntax.pos))
end
| _38_1075 -> begin
t
end)
...
let refine : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun b t -> (let _132_266 = (let _132_262 = (let _132_261 = (let _132_260 = (let _132_259 = (FStar_Syntax_Syntax.mk_binder b)
in (_132_259)::[])
in (FStar_Syntax_Subst.close _132_260 t))
in ((b), (_132_261)))
in FStar_Syntax_Syntax.Tm_refine (_132_262))
in (let _132_265 = (FStar_ST.read b.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.tk)
in (let _132_264 = (let _132_263 = (FStar_Syntax_Syntax.range_of_bv b)
in (FStar_Range.union_ranges _132_263 t.FStar_Syntax_Syntax.pos))
in (FStar_Syntax_Syntax.mk _132_266 _132_265 _132_264)))))
...
let universes = (FStar_All.pipe_right univ_vars (FStar_List.map (fun _132_291 -> FStar_Syntax_Syntax.U_name (_132_291))))
in (
...
| (uvs, t') -> begin
(match ((let _132_299 = (FStar_Syntax_Subst.compress t')
in _132_299.FStar_Syntax_Syntax.n)) with
...
let t = (let _132_306 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "tuple%s" _132_306))
in (let _132_307 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _132_307 r))))


let mk_tuple_data_lid : Prims.int  ->  FStar_Range.range  ->  FStar_Ident.lident = (fun n r -> (

let t = (let _132_312 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Mktuple%s" _132_312))
in (let _132_313 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _132_313 r))))


let is_tuple_data_lid : FStar_Ident.lident  ->  Prims.int  ->  Prims.bool = (fun f n -> (let _132_318 = (mk_tuple_data_lid n FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f _132_318)))
...
let t = (let _132_325 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "dtuple%s" _132_325))
in (let _132_326 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _132_326 r))))


let mk_dtuple_data_lid : Prims.int  ->  FStar_Range.range  ->  FStar_Ident.lident = (fun n r -> (

let t = (let _132_331 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Mkdtuple%s" _132_331))
in (let _132_332 = (FStar_Syntax_Const.pconst t)
in (FStar_Ident.set_lid_range _132_332 r))))
...
let is_constructor : FStar_Syntax_Syntax.term  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _132_348 = (pre_typ t)
in _132_348.FStar_Syntax_Syntax.n)) with
...
let rec is_constructed_typ : FStar_Syntax_Syntax.term  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _132_353 = (pre_typ t)
in _132_353.FStar_Syntax_Syntax.n)) with
...
let u = (let _132_364 = (FStar_Unionfind.fresh None)
in (FStar_All.pipe_left (fun _132_363 -> FStar_Syntax_Syntax.U_unif (_132_363)) _132_364))
in (let _132_365 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (u)) None FStar_Range.dummyRange)
in ((_132_365), (u))))
end))
...
| Some (phi1) -> begin
(let _132_379 = (let _132_378 = (let _132_376 = (let _132_375 = (let _132_374 = (FStar_Syntax_Syntax.as_arg phi1)
in (let _132_373 = (let _132_372 = (FStar_Syntax_Syntax.as_arg phi2)
in (_132_372)::[])
in (_132_374)::_132_373))
in ((tand), (_132_375)))
in FStar_Syntax_Syntax.Tm_app (_132_376))
in (let _132_377 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _132_378 None _132_377)))
in Some (_132_379))
end))


let mk_binop = (fun op_t phi1 phi2 -> (let _132_389 = (let _132_387 = (let _132_386 = (let _132_385 = (FStar_Syntax_Syntax.as_arg phi1)
in (let _132_384 = (let _132_383 = (FStar_Syntax_Syntax.as_arg phi2)
in (_132_383)::[])
in (_132_385)::_132_384))
in ((op_t), (_132_386)))
in FStar_Syntax_Syntax.Tm_app (_132_387))
in (let _132_388 = (FStar_Range.union_ranges phi1.FStar_Syntax_Syntax.pos phi2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _132_389 None _132_388))))


let mk_neg = (fun phi -> (let _132_394 = (let _132_393 = (let _132_392 = (let _132_391 = (FStar_Syntax_Syntax.as_arg phi)
in (_132_391)::[])
in ((t_not), (_132_392)))
in FStar_Syntax_Syntax.Tm_app (_132_393))
in (FStar_Syntax_Syntax.mk _132_394 None phi.FStar_Syntax_Syntax.pos)))
...
let mk_imp : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun phi1 phi2 -> (match ((let _132_407 = (FStar_Syntax_Subst.compress phi1)
...
| _38_1244 -> begin
(match ((let _132_408 = (FStar_Syntax_Subst.compress phi2)
in _132_408.FStar_Syntax_Syntax.n)) with
...
let b2t = (fun e -> (let _132_415 = (let _132_414 = (let _132_413 = (let _132_412 = (FStar_Syntax_Syntax.as_arg e)
in (_132_412)::[])
in ((b2t_v), (_132_413)))
in FStar_Syntax_Syntax.Tm_app (_132_414))
in (FStar_Syntax_Syntax.mk _132_415 None e.FStar_Syntax_Syntax.pos)))


let teq : FStar_Syntax_Syntax.term = (fvar_const FStar_Syntax_Const.eq2_lid)


let mk_eq = (fun t1 t2 e1 e2 -> (let _132_426 = (let _132_424 = (let _132_423 = (let _132_422 = (FStar_Syntax_Syntax.as_arg e1)
in (let _132_421 = (let _132_420 = (FStar_Syntax_Syntax.as_arg e2)
in (_132_420)::[])
in (_132_422)::_132_421))
in ((teq), (_132_423)))
in FStar_Syntax_Syntax.Tm_app (_132_424))
in (let _132_425 = (FStar_Range.union_ranges e1.FStar_Syntax_Syntax.pos e2.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk _132_426 None _132_425))))
...
in (let _132_437 = (let _132_436 = (let _132_435 = (let _132_434 = (FStar_Syntax_Syntax.iarg t)
in (let _132_433 = (let _132_432 = (FStar_Syntax_Syntax.as_arg x)
in (let _132_431 = (let _132_430 = (FStar_Syntax_Syntax.as_arg t')
in (_132_430)::[])
in (_132_432)::_132_431))
in (_132_434)::_132_433))
in ((t_has_type), (_132_435)))
in FStar_Syntax_Syntax.Tm_app (_132_436))
in (FStar_Syntax_Syntax.mk _132_437 None FStar_Range.dummyRange)))))
...
let mk_forall : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun x body -> (let _132_457 = (let _132_456 = (let _132_455 = (let _132_454 = (FStar_Syntax_Syntax.iarg x.FStar_Syntax_Syntax.sort)
in (let _132_453 = (let _132_452 = (let _132_451 = (let _132_450 = (let _132_445 = (FStar_Syntax_Syntax.mk_binder x)
in (_132_445)::[])
in (let _132_449 = (let _132_448 = (let _132_447 = (let _132_446 = (FStar_Syntax_Syntax.mk_Total ktype0)
in (FStar_All.pipe_left lcomp_of_comp _132_446))
in FStar_Util.Inl (_132_447))
in Some (_132_448))
in (abs _132_450 body _132_449)))
in (FStar_Syntax_Syntax.as_arg _132_451))
in (_132_452)::[])
in (_132_454)::_132_453))
in ((tforall), (_132_455)))
in FStar_Syntax_Syntax.Tm_app (_132_456))
in (FStar_Syntax_Syntax.mk _132_457 None FStar_Range.dummyRange)))
...
let then_branch = (let _132_468 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t1.FStar_Syntax_Syntax.pos)
in ((_132_468), (None), (t1)))
in (

let else_branch = (let _132_469 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (false))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Syntax_Syntax.pos)
in ((_132_469), (None), (t2)))
in (let _132_471 = (let _132_470 = (FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos t2.FStar_Syntax_Syntax.pos)
in (FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos _132_470))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (((b), ((then_branch)::(else_branch)::[])))) None _132_471)))))
...
let _38_1327 = (let _132_524 = (unmeta_monadic f)
in (head_and_args _132_524))
...
| _38_1338 -> begin
(let _132_528 = (FStar_Syntax_Subst.compress t)
in (([]), (_132_528)))
end)))
in (
...
| (t, args) -> begin
(let _132_540 = (un_uinst t)
in (let _132_539 = (FStar_All.pipe_right args (FStar_List.map (fun _38_1351 -> (match (_38_1351) with
| (t, imp) -> begin
(let _132_538 = (unascribe t)
in ((_132_538), (imp)))
end))))
in ((_132_540), (_132_539))))
end)))
in (

let rec aux = (fun qopt out t -> (match ((let _132_547 = (flat t)
in ((qopt), (_132_547)))) with
...
let lb = (let _132_551 = (let _132_550 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.Delta_equational None)
in FStar_Util.Inr (_132_550))
in {FStar_Syntax_Syntax.lbname = _132_551; FStar_Syntax_Syntax.lbunivs = a.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.lbtyp = a.FStar_Syntax_Syntax.action_typ; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = a.FStar_Syntax_Syntax.action_defn})
...
in (let _132_556 = (let _132_555 = (let _132_554 = (let _132_553 = (FStar_Syntax_Syntax.as_arg t)
in (_132_553)::[])
in ((reify_), (_132_554)))
in FStar_Syntax_Syntax.Tm_app (_132_555))
in (FStar_Syntax_Syntax.mk _132_556 None t.FStar_Syntax_Syntax.pos))))
...
let is_unknown : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _132_568 = (FStar_Syntax_Subst.compress t)
in _132_568.FStar_Syntax_Syntax.n)) with
...
let _38_1581 = (let _132_571 = (unmeta e)
in (head_and_args _132_571))
in (match (_38_1581) with
| (head, args) -> begin
(match ((let _132_573 = (let _132_572 = (un_uinst head)
in _132_572.FStar_Syntax_Syntax.n)
in ((_132_573), (args)))) with
...
(let _132_576 = (let _132_575 = (let _132_574 = (list_elements tl)
in (FStar_Util.must _132_574))
in (hd)::_132_575)
in Some (_132_576))
end
| _38_1602 -> begin
