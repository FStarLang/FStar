...
let (comp_set_flags :
  ...
  fun c  ->
    fun f  ->
      let uu___99_1139 = c  in
      let uu____1140 =
        let uu____1141 =
          let uu___100_1142 = comp_to_comp_typ_nouniv c  in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___100_1142.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___100_1142.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___100_1142.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___100_1142.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          }  in
        FStar_Syntax_Syntax.Comp uu____1141  in
      {
        FStar_Syntax_Syntax.n = uu____1140;
        FStar_Syntax_Syntax.pos = (uu___99_1139.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___99_1139.FStar_Syntax_Syntax.vars)
      }
    ...
    fun fs  ->
      let comp_typ_set_flags c =
        ...
        | FStar_Syntax_Syntax.Comp ct ->
            let ct1 =
              let uu___101_1177 = ct  in
              {
                FStar_Syntax_Syntax.comp_univs =
                  (uu___101_1177.FStar_Syntax_Syntax.comp_univs);
                FStar_Syntax_Syntax.effect_name =
                  (uu___101_1177.FStar_Syntax_Syntax.effect_name);
                FStar_Syntax_Syntax.result_typ =
                  (uu___101_1177.FStar_Syntax_Syntax.result_typ);
                FStar_Syntax_Syntax.effect_args =
                  (uu___101_1177.FStar_Syntax_Syntax.effect_args);
                FStar_Syntax_Syntax.flags = fs
              }  in
            let uu___102_1178 = c  in
            {
              FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
              FStar_Syntax_Syntax.pos =
                (uu___102_1178.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___102_1178.FStar_Syntax_Syntax.vars)
            }
         in
...
let (set_result_typ :
  ...
  fun c  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___103_1833 = ct  in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___103_1833.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___103_1833.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___103_1833.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___103_1833.FStar_Syntax_Syntax.flags)
             })
...
let rec (eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___96_2218 = if uu___96_2218 then Equal else Unknown  in
      let equal_iff uu___97_2223 = if uu___97_2223 then Equal else NotEqual
         in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___104_3819 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___104_3819.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___104_3819.FStar_Syntax_Syntax.sort)
          }  in
              ...
              let uu____3936 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___105_3937.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____3938;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___105_3937.FStar_Syntax_Syntax.residual_flags)
                }  in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____4491 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___106_4492.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____4493;
              FStar_Syntax_Syntax.residual_flags =
                (uu___106_4492.FStar_Syntax_Syntax.residual_flags)
            }  in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____11303 -> tn  in
      f
        (let uu___107_11306 = t  in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___107_11306.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars =
             (uu___107_11306.FStar_Syntax_Syntax.vars)
         })
