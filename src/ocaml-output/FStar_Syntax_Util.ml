...
let (destruct :
  ...
  fun typ ->
    fun lid ->
      ...
      let uu____4788 =
        let uu____4789 = un_uinst typ1 in uu____4789.FStar_Syntax_Syntax.n in
  ...
  fun lid ->
    fun x ->
      fun i ->
        ...
        let y =
          let uu___126_5416 = x in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___126_5416.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___126_5416.FStar_Syntax_Syntax.sort)
          } in
      ...
      fun lopt ->
        let close_lopt lopt1 =
          ...
          | FStar_Pervasives_Native.Some rc ->
              let uu____5584 =
                let uu___127_5585 = rc in
                let uu____5586 =
                  FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                    (FStar_Syntax_Subst.close bs) in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___127_5585.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____5586;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___127_5585.FStar_Syntax_Syntax.residual_flags)
                } in
            ...
            (match body.FStar_Syntax_Syntax.n with
             | FStar_Syntax_Syntax.Tm_abs (bs', t1, lopt') ->
                 let uu____5635 =
                   let uu____5642 =
                     let uu____5643 =
                       let uu____5662 =
                         let uu____5671 = FStar_Syntax_Subst.close_binders bs in
             ...
             | uu____5704 ->
                 let uu____5705 =
                   let uu____5712 =
                     let uu____5713 =
                       let uu____5732 = FStar_Syntax_Subst.close_binders bs in
           ...
           | (bs1, c1) ->
               ...
               (match uu____6480 with
                ...
                | uu____6527 ->
                    ...
                    if uu____6530
                    then
                      let uu____6547 = arrow_until_decreases (comp_result c1) in
                 ...
                 FStar_All.pipe_right bs
                   (FStar_List.map
                      (fun uu____6772 ->
                         ...
                         | (x, uu____6780) -> FStar_Util.set_mem x d_bvs)) in
               FStar_List.append uu____6741 uu____6750) in
...
let (abs_formals :
  ...
  fun t ->
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____6838 =
            let uu___128_6839 = rc in
            let uu____6840 =
              FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                (FStar_Syntax_Subst.subst s) in
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___128_6839.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____6840;
              FStar_Syntax_Syntax.residual_flags =
                (uu___128_6839.FStar_Syntax_Syntax.residual_flags)
            } in
  ...
  fun phi ->
    let uu____8060 =
      let uu____8067 =
        let uu____8068 =
          let uu____8085 =
            let uu____8096 = FStar_Syntax_Syntax.as_arg phi in [uu____8096] in
          (t_not, uu____8085) in
  ...
  fun e ->
    let uu____8289 =
      let uu____8296 =
        let uu____8297 =
          let uu____8314 =
            let uu____8325 = FStar_Syntax_Syntax.as_arg e in [uu____8325] in
          (b2t_v, uu____8314) in
        ...
        (match uu____9930 with
         | (FStar_Syntax_Syntax.Tm_uinst
            ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
               ...
               FStar_Syntax_Syntax.vars = uu____9969;_},
             u::[]),
            (t1, uu____9972)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid
        ...
        (match uu____10104 with
         | (FStar_Syntax_Syntax.Tm_uinst
            ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
               ...
               FStar_Syntax_Syntax.vars = uu____10143;_},
             u::[]),
            (t1, uu____10146)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Parser_Const.auto_squash_lid
...
let (is_sub_singleton : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t ->
    let uu____10219 = let uu____10236 = unmeta t in head_and_args uu____10236 in
  ...
  fun f ->
    ...
    let destruct_q_conn t =
      ...
      let rec aux qopt out t1 =
        let uu____11269 = let uu____11292 = flat t1 in (qopt, uu____11292) in
           ...
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
            ...
            ({
               FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                 (b::[], t2, uu____11335);
               FStar_Syntax_Syntax.pos = uu____11336;
               FStar_Syntax_Syntax.vars = uu____11337;_},
             uu____11338)::[]))
        ...
        | (FStar_Pervasives_Native.None,
           ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
              ...
              FStar_Syntax_Syntax.vars = uu____11669;_},
            uu____11670::({
                            FStar_Syntax_Syntax.n =
                              FStar_Syntax_Syntax.Tm_abs
                              (b::[], t2, uu____11673);
                            FStar_Syntax_Syntax.pos = uu____11674;
                            FStar_Syntax_Syntax.vars = uu____11675;_},
                          uu____11676)::[]))
            when
            is_qlid (tc.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v ->
            let uu____11783 =
        ...
        (fun t1 ->
           ...
           | (hd1, args) ->
               ...
               (match uu____12032 with
                ...
                | uu____12059 -> FStar_Pervasives_Native.None)) in
                         ...
                         let uu____12200 =
                           let uu____12201 =
                             FStar_Syntax_Syntax.as_arg
                               (FStar_Pervasives_Native.fst b).FStar_Syntax_Syntax.sort in
                           let uu____12212 =
                             let uu____12223 = FStar_Syntax_Syntax.as_arg q in
                             [uu____12223] in
        ...
        (fun t1 ->
           ...
           | (hd1, args) ->
               ...
               (match uu____12334 with
                | (FStar_Syntax_Syntax.Tm_fvar fv,
                   (a1, uu____12367)::(a2, uu____12369)::[]) when
                    FStar_Syntax_Syntax.fv_eq_lid fv
                    ...
                    (match uu____12420 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[], q, uu____12428) ->
                         let uu____12463 = FStar_Syntax_Subst.open_term [b] q in
    ...
    | FStar_Syntax_Syntax.Tm_abs (b::[], e, uu____12701) ->
        ...
        (match uu____12736 with
         | (bs, e1) ->
             ...
             let uu____12770 = is_free_in (FStar_Pervasives_Native.fst b1) e1 in
             if uu____12770
             then
               let uu____12775 =
      ...
      fun pos ->
        let lb =
          ...
          close_univs_and_mk_letbinding FStar_Pervasives_Native.None
            ...
            FStar_Parser_Const.effect_Tot_lid uu____12875 [] pos in
        {
  ...
  fun t ->
    ...
    let uu____12898 =
      let uu____12905 =
        let uu____12906 =
          let uu____12923 =
            let uu____12934 = FStar_Syntax_Syntax.as_arg t in [uu____12934] in
  ...
  fun t ->
    ...
    let uu____13001 =
      let uu____13008 =
        let uu____13009 =
          let uu____13026 =
            let uu____13037 = FStar_Syntax_Syntax.as_arg t in [uu____13037] in
...
let rec (list_elements :
  ...
  =
  fun e ->
    let uu____13344 = let uu____13361 = unmeta e in head_and_args uu____13361 in
    ...
    | (head1, args) ->
        ...
        (match uu____13392 with
         | (FStar_Syntax_Syntax.Tm_fvar fv, uu____13426) when
             ...
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            uu____13450::(hd1, uu____13452)::(tl1, uu____13454)::[]) when
  ...
  fun typ ->
    fun rng ->
      fun l ->
        ...
        let uu____13691 =
          let uu____13692 =
            let uu____13693 = FStar_Syntax_Syntax.iarg typ in [uu____13693] in
...
let rec (term_eq_dbg :
  ...
  fun dbg ->
    fun t1 ->
      fun t2 ->
        let t11 = let uu____14360 = unmeta_safe t1 in canon_app uu____14360 in
        let t21 = let uu____14366 = unmeta_safe t2 in canon_app uu____14366 in
        let uu____14369 =
          let uu____14374 =
            let uu____14375 =
        ...
        | (FStar_Syntax_Syntax.Tm_type uu____14514,
           FStar_Syntax_Syntax.Tm_type uu____14515) -> true
        ...
        | (FStar_Syntax_Syntax.Tm_quoted (qt1, qi1),
           FStar_Syntax_Syntax.Tm_quoted (qt2, qi2)) ->
            (let uu____14916 =
               let uu____14917 = eq_quoteinfo qi1 qi2 in uu____14917 = Equal in
            ...
            (fun acc ->
               fun uu____15664 ->
                 ...
                 | (bv, uu____15672) ->
                     ...
                     acc + uu____15677) (Prims.parse_int "0") bs in
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid ->
    fun t ->
      let uu____15743 =
        let uu____15744 = un_uinst t in uu____15744.FStar_Syntax_Syntax.n in
  ...
  fun p ->
    fun r ->
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____15797 = FStar_Options.restore_cmd_line_options false in
...
let rec (unbound_variables :
  ...
  fun tm ->
        ...
        let uu____16092 =
          FStar_List.collect
            (fun uu____16106 ->
               ...
               | (x, uu____16118) -> unbound_variables x) args in
            ...
            (FStar_List.collect
               (fun br ->
                  ...
                  | (p, wopt, t2) ->
                      ...
                      FStar_List.append uu____16208 uu____16211)) in
    ...
    | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), t1) ->
        ...
        let uu____16344 =
          let uu____16347 = unbound_variables lb.FStar_Syntax_Syntax.lbdef in
          let uu____16350 =
            ...
            | FStar_Util.Inl bv ->
                ...
                (match uu____16357 with
                 | (uu____16378, t2) -> unbound_variables t2) in
             ...
             let uu____16415 =
               FStar_List.collect
                 (fun lb ->
                    ...
                    FStar_List.append uu____16422 uu____16425) lbs1 in
...
and (unbound_variables_comp :
  ...
  fun c ->
    ...
    | FStar_Syntax_Syntax.Comp ct ->
        let uu____16553 = unbound_variables ct.FStar_Syntax_Syntax.result_typ in
        let uu____16556 =
          FStar_List.collect
            (fun uu____16570 ->
