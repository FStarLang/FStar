...
let rec non_informative : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _130_153 = (unrefine t)
in _130_153.FStar_Syntax_Syntax.n)) with
...
let mk_forall : FStar_Syntax_Syntax.bv  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun x body -> (let _130_455 = (let _130_454 = (let _130_453 = (let _130_452 = (FStar_Syntax_Syntax.iarg x.FStar_Syntax_Syntax.sort)
in (let _130_451 = (let _130_450 = (let _130_449 = (let _130_448 = (let _130_443 = (FStar_Syntax_Syntax.mk_binder x)
in (_130_443)::[])
...
in ((tforall), (_130_453)))
in FStar_Syntax_Syntax.Tm_app (_130_454))
in (FStar_Syntax_Syntax.mk _130_455 None FStar_Range.dummyRange)))
...
let then_branch = (let _130_466 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t1.FStar_Syntax_Syntax.pos)
in ((_130_466), (None), (t1)))
in (
# 751 "FStar.Syntax.Util.fst"
let else_branch = (let _130_467 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (false))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Syntax_Syntax.pos)
in ((_130_467), (None), (t2)))
in (let _130_469 = (let _130_468 = (FStar_Range.union_ranges t1.FStar_Syntax_Syntax.pos t2.FStar_Syntax_Syntax.pos)
in (FStar_Range.union_ranges b.FStar_Syntax_Syntax.pos _130_468))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (((b), ((then_branch)::(else_branch)::[])))) None _130_469)))))
...
let _38_1115 = (let _130_522 = (unmeta_monadic f)
in (head_and_args _130_522))
...
(let _130_525 = (FStar_Syntax_Subst.compress t)
in ((pats), (_130_525)))
end
| _38_1126 -> begin
(let _130_526 = (FStar_Syntax_Subst.compress t)
in (([]), (_130_526)))
end)))
in (
# 799 "FStar.Syntax.Util.fst"
let destruct_q_conn = (fun t -> (
# 800 "FStar.Syntax.Util.fst"
...
in (
# 801 "FStar.Syntax.Util.fst"
let flat = (fun t -> (
# 802 "FStar.Syntax.Util.fst"
let _38_1136 = (head_and_args t)
in (match (_38_1136) with
| (t, args) -> begin
(let _130_538 = (un_uinst t)
in (let _130_537 = (FStar_All.pipe_right args (FStar_List.map (fun _38_1139 -> (match (_38_1139) with
| (t, imp) -> begin
(let _130_536 = (unascribe t)
in ((_130_536), (imp)))
end))))
in ((_130_538), (_130_537))))
end)))
in (
# 804 "FStar.Syntax.Util.fst"
let rec aux = (fun qopt out t -> (match ((let _130_545 = (flat t)
in ((qopt), (_130_545)))) with
...
(
# 816 "FStar.Syntax.Util.fst"
let bs = (FStar_List.rev out)
in (
# 817 "FStar.Syntax.Util.fst"
...
# 829 "FStar.Syntax.Util.fst"
let action_as_lb : FStar_Syntax_Syntax.action  ->  FStar_Syntax_Syntax.sigelt = (fun a -> (
# 833 "FStar.Syntax.Util.fst"
let lb = (let _130_549 = (let _130_548 = (FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name FStar_Syntax_Syntax.Delta_equational None)
in FStar_Util.Inr (_130_548))
in {FStar_Syntax_Syntax.lbname = _130_549; FStar_Syntax_Syntax.lbunivs = a.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.lbtyp = a.FStar_Syntax_Syntax.action_typ; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = a.FStar_Syntax_Syntax.action_defn})
...
# 840 "FStar.Syntax.Util.fst"
let mk_reify = (fun t -> (
# 844 "FStar.Syntax.Util.fst"
let reify_ = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify)) None t.FStar_Syntax_Syntax.pos)
in (let _130_554 = (let _130_553 = (let _130_552 = (let _130_551 = (FStar_Syntax_Syntax.as_arg t)
in (_130_551)::[])
in ((reify_), (_130_552)))
in FStar_Syntax_Syntax.Tm_app (_130_553))
in (FStar_Syntax_Syntax.mk _130_554 None t.FStar_Syntax_Syntax.pos))))

# 845 "FStar.Syntax.Util.fst"
let rec delta_qualifier : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.delta_depth = (fun t -> (
# 851 "FStar.Syntax.Util.fst"
let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
...
# 878 "FStar.Syntax.Util.fst"
let is_unknown : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _130_566 = (FStar_Syntax_Subst.compress t)
in _130_566.FStar_Syntax_Syntax.n)) with
