    ...
    fun f  ->
      let comp_to_comp_typ c1 =
        ...
        | FStar_Syntax_Syntax.GTotal (t,u_opt) ->
         ...
         in
      let uu___77_1084 = c  in
      let uu____1085 =
        let uu____1086 =
          let uu___78_1087 = comp_to_comp_typ c  in
          {
            FStar_Syntax_Syntax.comp_univs =
              (uu___78_1087.FStar_Syntax_Syntax.comp_univs);
            FStar_Syntax_Syntax.effect_name =
              (uu___78_1087.FStar_Syntax_Syntax.effect_name);
            FStar_Syntax_Syntax.result_typ =
              (uu___78_1087.FStar_Syntax_Syntax.result_typ);
            FStar_Syntax_Syntax.effect_args =
              (uu___78_1087.FStar_Syntax_Syntax.effect_args);
            FStar_Syntax_Syntax.flags = f
          }  in
        FStar_Syntax_Syntax.Comp uu____1086  in
      {
        FStar_Syntax_Syntax.n = uu____1085;
        FStar_Syntax_Syntax.pos = (uu___77_1084.FStar_Syntax_Syntax.pos);
        FStar_Syntax_Syntax.vars = (uu___77_1084.FStar_Syntax_Syntax.vars)
      }
...
let set_result_typ :
  ...
  fun c  ->
    fun t  ->
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          FStar_Syntax_Syntax.mk_Comp
            (let uu___79_1735 = ct  in
             {
               FStar_Syntax_Syntax.comp_univs =
                 (uu___79_1735.FStar_Syntax_Syntax.comp_univs);
               FStar_Syntax_Syntax.effect_name =
                 (uu___79_1735.FStar_Syntax_Syntax.effect_name);
               FStar_Syntax_Syntax.result_typ = t;
               FStar_Syntax_Syntax.effect_args =
                 (uu___79_1735.FStar_Syntax_Syntax.effect_args);
               FStar_Syntax_Syntax.flags =
                 (uu___79_1735.FStar_Syntax_Syntax.flags)
             })
...
let rec eq_tm :
  ...
  fun t1  ->
    fun t2  ->
      ...
      let equal_if uu___74_1999 = if uu___74_1999 then Equal else Unknown  in
      let equal_iff uu___75_2004 = if uu___75_2004 then Equal else NotEqual
         in
  ...
  fun lid  ->
    fun x  ->
      fun i  ->
        ...
        let y =
          let uu___80_3152 = x  in
          {
            FStar_Syntax_Syntax.ppname = nm;
            FStar_Syntax_Syntax.index =
              (uu___80_3152.FStar_Syntax_Syntax.index);
            FStar_Syntax_Syntax.sort =
              (uu___80_3152.FStar_Syntax_Syntax.sort)
          }  in
              ...
              let uu____3269 =
                   ...
                   in
                {
                  FStar_Syntax_Syntax.residual_effect =
                    (uu___81_3270.FStar_Syntax_Syntax.residual_effect);
                  FStar_Syntax_Syntax.residual_typ = uu____3271;
                  FStar_Syntax_Syntax.residual_flags =
                    (uu___81_3270.FStar_Syntax_Syntax.residual_flags)
                }  in
    ...
    let subst_lcomp_opt s l =
      ...
      | FStar_Pervasives_Native.Some rc ->
          let uu____3824 =
            ...
            {
              FStar_Syntax_Syntax.residual_effect =
                (uu___82_3825.FStar_Syntax_Syntax.residual_effect);
              FStar_Syntax_Syntax.residual_typ = uu____3826;
              FStar_Syntax_Syntax.residual_flags =
                (uu___82_3825.FStar_Syntax_Syntax.residual_flags)
            }  in
      ...
      let canon_app t =
        ...
        | FStar_Syntax_Syntax.Tm_app uu____9140 ->
            ...
            (match uu____9155 with
             | (hd1,args) ->
                 let uu___83_9188 = t  in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd1, args));
                   FStar_Syntax_Syntax.pos =
                     (uu___83_9188.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___83_9188.FStar_Syntax_Syntax.vars)
                 })
        | uu____9199 -> t  in
  ...
  fun f  ->
    fun t  ->
      ...
      let tn1 =
        ...
        | uu____9881 -> tn  in
      f
        (let uu___84_9884 = t  in
         {
           FStar_Syntax_Syntax.n = tn1;
           FStar_Syntax_Syntax.pos = (uu___84_9884.FStar_Syntax_Syntax.pos);
           FStar_Syntax_Syntax.vars = (uu___84_9884.FStar_Syntax_Syntax.vars)
         })
