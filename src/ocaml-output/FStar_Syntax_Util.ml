...
let (destruct :
  ...
  fun typ  ->
    fun lid  ->
      ...
      let uu____5388 =
        let uu____5389 = un_uinst typ1  in uu____5389.FStar_Syntax_Syntax.n
         in
      ...
      let newi =
        ...
        then i
          ...
          (let uu____5946 =
           ...
           FStar_Ident.mk_ident uu____5946)
         in
      let uu____5959 =
      ...
      fun lopt  ->
        let close_lopt lopt1 =
          ...
          | FStar_Pervasives_Native.Some rc ->
              ...
              FStar_Pervasives_Native.Some uu____6207
           in
        match bs with
        | [] -> t
        | uu____6226 ->
            ...
            (match body.FStar_Syntax_Syntax.n with
             | FStar_Syntax_Syntax.Tm_abs (bs',t1,lopt') ->
                 let uu____6258 =
                   let uu____6259 =
                     let uu____6278 =
                       let uu____6287 = FStar_Syntax_Subst.close_binders bs
                          in
...
let rec (arrow_formals_comp_ln :
  ...
  fun k  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
        let uu____6796 =
          (is_total_comp c) &&
            (let uu____6799 = has_decreases c  in
             Prims.op_Negation uu____6799)
           in
        if uu____6796
        then
    ...
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____6881;
           ...
           FStar_Syntax_Syntax.sort = s;_},uu____6884)
        ->
        let rec aux s1 k2 =
          let uu____6915 =
          ...
          | FStar_Syntax_Syntax.Tm_refine
              ({ FStar_Syntax_Syntax.ppname = uu____6946;
                 ...
                 FStar_Syntax_Syntax.sort = s2;_},uu____6949)
              -> aux s2 k2
          | uu____6957 ->
    ...
    let rec arrow_until_decreases k =
           ...
           | (bs1,c1) ->
               ...
               (match uu____7247 with
                ...
                | uu____7297 ->
                    ...
                    if uu____7300
                    then
                      let uu____7319 = arrow_until_decreases (comp_result c1)
                         in
      ...
      | FStar_Syntax_Syntax.Tm_refine
          ({ FStar_Syntax_Syntax.ppname = uu____7412;
             ...
             FStar_Syntax_Syntax.sort = k2;_},uu____7415)
                 ...
                 FStar_All.pipe_right bs
                   (FStar_List.map
                      (fun uu____7553  ->
                         ...
                         | (x,uu____7562) -> FStar_Util.set_mem x d_bvs))
                  in
               FStar_List.append uu____7519 uu____7528)
           in
    ...
    | (bs,c) ->
        (match bs with
         ...
         | uu____7940 ->
             let uu____7949 =
               let uu____7950 =
                 let uu____7965 = FStar_List.map no_acc bs  in
                 (uu____7965, c)  in
                    ...
                    | (FStar_Pervasives_Native.Some fvs,uu____8159) ->
                        let universes =
                          FStar_All.pipe_right univ_vars
                            (FStar_List.map
                               (fun uu____8175  ->
                                  FStar_Syntax_Syntax.U_name uu____8175))
                           in
                        let inst =
...
let (type_u :
  ...
  fun uu____8659  ->
    let u =
      ...
      FStar_All.pipe_left
        (fun uu____8686  -> FStar_Syntax_Syntax.U_unif uu____8686) uu____8665
       in
    let uu____8687 =
...
let (mk_neg :
  ...
  fun phi  ->
    let uu____9060 =
      let uu____9061 =
        let uu____9078 =
          let uu____9089 = FStar_Syntax_Syntax.as_arg phi  in [uu____9089]
           in
        (t_not, uu____9078)  in
      ...
      let uu____9597 =
        let uu____9598 =
          let uu____9615 =
            ...
            let uu____9635 =
              let uu____9646 = FStar_Syntax_Syntax.as_arg e2  in [uu____9646]
               in
        ...
        (match uu____10996 with
         | (FStar_Syntax_Syntax.Tm_uinst
            ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
               ...
               FStar_Syntax_Syntax.vars = uu____11035;_},u::[]),(t1,uu____11038)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.squash_lid
        ...
        (match uu____11171 with
         | (FStar_Syntax_Syntax.Tm_uinst
            ({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar fv;
               ...
               FStar_Syntax_Syntax.vars = uu____11210;_},u::[]),(t1,uu____11213)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Parser_Const.auto_squash_lid
             -> FStar_Pervasives_Native.Some (u, t1)
...
let (is_sub_singleton : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    let uu____11288 =
      let uu____11305 = unmeta t  in head_and_args uu____11305  in
                ...
                (FStar_List.map
                   (fun uu____12716  ->
                      ...
                      | (t3,imp) ->
                          ...
                          (uu____12735, imp)))
               in
            (uu____12674, uu____12675)
         in
      let rec aux qopt out t1 =
        let uu____12786 = let uu____12810 = flat t1  in (qopt, uu____12810)
           in
           ...
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
                 ...
                 FStar_Syntax_Syntax.vars = uu____12851;_},({
                                                              ...
                                                              FStar_Syntax_Syntax.pos
                                                                = uu____12855;
                                                              FStar_Syntax_Syntax.vars
                                                                = uu____12856;_},uu____12857)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.Some
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
                 FStar_Syntax_Syntax.pos = uu____12959;
                 FStar_Syntax_Syntax.vars = uu____12960;_},uu____12961::
               ({
                  FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                    (b::[],t2,uu____12964);
                  FStar_Syntax_Syntax.pos = uu____12965;
                  FStar_Syntax_Syntax.vars = uu____12966;_},uu____12967)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.None
        ...
        | (FStar_Pervasives_Native.None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               ...
               FStar_Syntax_Syntax.vars = uu____13199;_},uu____13200::
             ({
                FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                  (b::[],t2,uu____13203);
                FStar_Syntax_Syntax.pos = uu____13204;
                FStar_Syntax_Syntax.vars = uu____13205;_},uu____13206)::[]))
            when
            is_qlid (tc.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v ->
            let uu____13315 =
              let uu____13319 =
                         ...
                         let uu____13615 =
                           let uu____13616 =
                             FStar_Syntax_Syntax.as_arg
                              ...
                              in
                           let uu____13627 =
                             let uu____13638 = FStar_Syntax_Syntax.as_arg q
                                in
                             [uu____13638]  in
        ...
        (fun t1  ->
           ...
           | (hd,args) ->
               ...
               (match uu____13749 with
                | (FStar_Syntax_Syntax.Tm_fvar
                   fv,(a1,uu____13782)::(a2,uu____13784)::[]) when
                    FStar_Syntax_Syntax.fv_eq_lid fv
                    ...
                    (match uu____13835 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[],q,uu____13843) ->
                         let uu____13878 = FStar_Syntax_Subst.open_term [b] q
                            in
      ...
      | FStar_Pervasives_Native.Some (QEx (bs,pats,phi)) ->
          ...
          (match uu____14047 with
           | FStar_Pervasives_Native.Some (QEx (bs',pats',psi)) ->
               FStar_All.pipe_left
                 (fun uu____14057  ->
                    FStar_Pervasives_Native.Some uu____14057)
                 (QEx
                    ((FStar_List.append bs bs'),
                      (FStar_List.append pats pats'), psi))
           | uu____14064 -> f1)
      ...
      fun pos  ->
        let lb =
          ...
          close_univs_and_mk_letbinding FStar_Pervasives_Native.None
            ...
            FStar_Parser_Const.effect_Tot_lid uu____14127 [] pos
           in
        {
...
let (mk_reify :
  ...
  fun t  ->
    ...
    let uu____14153 =
      let uu____14154 =
        let uu____14171 =
          let uu____14182 = FStar_Syntax_Syntax.as_arg t  in [uu____14182]
           in
...
let (mk_reflect :
  ...
  fun t  ->
    ...
    let uu____14238 =
      let uu____14239 =
        let uu____14256 =
          let uu____14267 = FStar_Syntax_Syntax.as_arg t  in [uu____14267]
           in
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____14398;
           ...
           FStar_Syntax_Syntax.sort = t2;_},uu____14401)
        -> delta_qualifier t2
  ...
  fun typ  ->
    fun rng  ->
      fun l  ->
        ...
        let uu____14687 =
          let uu____14688 =
            let uu____14689 = FStar_Syntax_Syntax.iarg typ  in [uu____14689]
             in
...
let rec (term_eq_dbg :
  ...
  fun dbg  ->
    fun t1  ->
      fun t2  ->
        let t11 = let uu____15379 = unmeta_safe t1  in canon_app uu____15379
           in
        let t21 = let uu____15383 = unmeta_safe t2  in canon_app uu____15383
           in
        let uu____15386 =
          let uu____15391 =
            let uu____15392 =
        ...
        | (FStar_Syntax_Syntax.Tm_type
           uu____15536,FStar_Syntax_Syntax.Tm_type uu____15537) -> true
        ...
        | (FStar_Syntax_Syntax.Tm_lazy uu____15856,uu____15857) ->
            let uu____15858 =
              let uu____15860 = unlazy t11  in
              term_eq_dbg dbg uu____15860 t21  in
            check "lazy_l" uu____15858
        | (uu____15862,FStar_Syntax_Syntax.Tm_lazy uu____15863) ->
            let uu____15864 =
              let uu____15866 = unlazy t21  in
              term_eq_dbg dbg t11 uu____15866  in
            check "lazy_r" uu____15864
        | (FStar_Syntax_Syntax.Tm_let
           ((b1,lbs1),t12),FStar_Syntax_Syntax.Tm_let ((b2,lbs2),t22)) ->
            ((check "let flag" (b1 = b2)) &&
               (let uu____15911 = eqlist (letbinding_eq_dbg dbg) lbs1 lbs2
                   in
        ...
        | (FStar_Syntax_Syntax.Tm_uvar
           (u1,uu____15919),FStar_Syntax_Syntax.Tm_uvar (u2,uu____15921)) ->
            check "uvar"
        ...
        | (FStar_Syntax_Syntax.Tm_quoted
           (qt1,qi1),FStar_Syntax_Syntax.Tm_quoted (qt2,qi2)) ->
            (let uu____15981 =
               let uu____15983 = eq_quoteinfo qi1 qi2  in uu____15983 = Equal
                in
            ...
            (fun acc  ->
               fun uu____16817  ->
                 ...
                 | (bv,uu____16827) ->
                     ...
                     acc + uu____16832) Prims.int_zero bs
           in
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid  ->
    fun t  ->
      let uu____16910 =
        let uu____16911 = un_uinst t  in uu____16911.FStar_Syntax_Syntax.n
         in
    ...
    fun r  ->
      ...
      (let set_options s =
       ...
       | FStar_Syntax_Syntax.ResetOptions sopt ->
           ((let uu____17128 = FStar_Options.restore_cmd_line_options false
                in
...
let rec (unbound_variables :
  ...
  fun tm  ->
        ...
        let uu____17431 =
          FStar_List.collect
            (fun uu____17445  ->
               ...
               | (x,uu____17457) -> unbound_variables x) args
           in
                  ...
                  | (p,wopt,t2) ->
                      ...
                      let uu____17550 =
                        ...
                        | FStar_Pervasives_Native.Some t3 ->
                         ...
                         in
                      FStar_List.append uu____17547 uu____17550))
           in
    ...
    | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),t1) ->
        ...
        let uu____17686 =
          let uu____17689 = unbound_variables lb.FStar_Syntax_Syntax.lbdef
             in
          let uu____17692 =
            ...
            | FStar_Util.Inl bv ->
                ...
                (match uu____17699 with
                 | (uu____17720,t2) -> unbound_variables t2)
             in
             ...
             let uu____17760 =
               FStar_List.collect
                 (fun lb  ->
                    ...
                    FStar_List.append uu____17767 uu____17770) lbs1
                in
...
and (unbound_variables_comp :
  ...
  fun c  ->
    ...
    | FStar_Syntax_Syntax.Comp ct ->
        let uu____17921 = unbound_variables ct.FStar_Syntax_Syntax.result_typ
           in
        let uu____17924 =
          FStar_List.collect
            (fun uu____17938  ->
...
let rec (list_elements :
  ...
  fun e  ->
    let uu____18430 =
      let uu____18447 = unmeta e  in head_and_args uu____18447  in
    ...
    | (head,args) ->
        ...
        (match uu____18478 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____18512) when
             ...
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____18536::(hd,uu____18538)::(tl,uu____18540)::[]) when
    ...
    | FStar_Syntax_Syntax.Tm_abs (b::[],e,uu____18651) ->
        ...
        (match uu____18686 with
         | (bs,e1) ->
             ...
             let uu____18718 = is_free_in (FStar_Pervasives_Native.fst b1) e1
                in
             if uu____18718
             then
               let uu____18723 =
      ...
      let one_pat p =
        ...
        | (head,args) ->
            ...
            (match uu____18937 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu____18975,uu____18976)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                 ...
                 (match c1.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Comp
                      { FStar_Syntax_Syntax.comp_univs = uu____19613;
                        ...
                        FStar_Syntax_Syntax.effect_args =
                          (pre,uu____19617)::(post,uu____19619)::(pats,uu____19621)::[];
    ...
    fun combs  ->
      let map_tuple uu____20010 =
        ...
        | (ts1,ts2) ->
            ...
            let uu____20022 = f ts2  in (uu____20021, uu____20022)
         in
      ...
      let uu____20043 = map_tuple combs.FStar_Syntax_Syntax.l_if_then_else
         in
      {
