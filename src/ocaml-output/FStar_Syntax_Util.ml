...
let args_of_binders : FStar_Syntax_Syntax.binders  ->  (FStar_Syntax_Syntax.binders * FStar_Syntax_Syntax.args) = (fun binders -> (let _0_190 = (FStar_All.pipe_right binders (FStar_List.map (fun b -> (
...
in (FStar_Util.find_map _0_200 (fun uu____433 -> (match (uu____433) with
| (u1, u2) -> begin
(
...
in {FStar_Syntax_Syntax.n = _0_204; FStar_Syntax_Syntax.tk = uu___175_569.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___175_569.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___175_569.FStar_Syntax_Syntax.vars}))))
...
in (eq_and _0_205 (fun uu____1188 -> (equal_if (eq_univs_list us vs)))))
end
...
in (eq_and _0_206 (fun uu____1254 -> (eq_args args1 args2))))
end
...
let uu____2583 = (let _0_231 = (FStar_Syntax_Subst.compress t)
...
in (let _0_285 = (FStar_All.pipe_right args (FStar_List.map (fun uu____3941 -> (match (uu____3941) with
| (t, imp) -> begin
...
let uu____3967 = (let _0_287 = (flat t)
in ((qopt), (_0_287)))
...
let uu____4500 = (let _0_291 = (un_uinst head).FStar_Syntax_Syntax.n
in ((_0_291), (args)))
