    ...
    then
      ...
      let b1 =
        b &&
          (let uu___1 = FStar_Tactics_Types.goal_witness g  in
           FStar_TypeChecker_Env.closed env uu___1)
         in
      let b2 =
        b1 &&
      ...
      let uu___1 =
        (let uu___2 = aux b2 env  in Prims.op_Negation uu___2) &&
          (let uu___2 = FStar_ST.op_Bang nwarn  in
           uu___2 < (Prims.of_int (5)))
         in
      (if uu___1
       then
         ((let uu___3 =
           ...
           let uu___4 =
             let uu___5 =
               let uu___6 = FStar_Tactics_Printing.goal_to_string_verbose g
                  in
               FStar_Util.format1
          ...
          (let uu___3 =
             let uu___4 = FStar_ST.op_Bang nwarn  in uu___4 + Prims.int_one
              in
  ...
  fun reason  ->
    fun env  ->
      fun typ  ->
        ...
        match uu___ with
        | (u,ctx_uvar,g_u) ->
            let uu___1 = add_implicits g_u.FStar_TypeChecker_Common.implicits
               in
            bind uu___1
              (fun uu___2  ->
                 let uu___3 =
