         ...
         (let uv = g.FStar_Tactics_Types.goal_ctx_uvar in
          ...
          (let should_register = is_goal_safe_as_well_typed g in
           ...
           then
             ...
             (if uu___5
              then
                let uu___6 = FStar_Compiler_Util.string_of_int i in
             ...
             ((let uu___6 =
               ...
               then
                 ...
                 let uu___8 = FStar_Syntax_Print.ctx_uvar_to_string uv in
              ...
              (let goal_ty = FStar_Syntax_Util.ctx_uvar_typ uv in
               let uu___6 =
                 FStar_TypeChecker_Core.compute_term_type_handle_guards env1
                   goal_ty false (fun uu___7 -> fun uu___8 -> true) in
               match uu___6 with
               | FStar_Pervasives.Inl uu___7 -> ()
               | FStar_Pervasives.Inr err ->
                   let msg =
                     let uu___7 =
                       let uu___8 = FStar_Syntax_Util.ctx_uvar_typ uv in
