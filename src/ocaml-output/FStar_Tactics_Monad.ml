  ...
  fun msg ->
    mk_tac
      (fun ps ->
         ...
         FStar_Tactics_Result.Failed
           ((FStar_Tactics_Common.TacticFailure msg), ps))
let catch : 'a . 'a tac -> (Prims.exn, 'a) Prims.either tac =
  fun t ->
    mk_tac
      (fun ps ->
         ...
         | FStar_Tactics_Result.Success (a1, q) ->
             (FStar_Syntax_Unionfind.commit tx;
              FStar_Tactics_Result.Success ((Prims.Inr a1), q))
         | FStar_Tactics_Result.Failed (m, q) ->
             (FStar_Syntax_Unionfind.rollback tx;
              (let ps1 =
               ...
               FStar_Tactics_Result.Success ((Prims.Inl m), ps1))))
let recover : 'a . 'a tac -> (Prims.exn, 'a) Prims.either tac =
  fun t ->
    mk_tac
      (fun ps ->
         let uu___ = run t ps in
         ...
         | FStar_Tactics_Result.Success (a1, q) ->
             FStar_Tactics_Result.Success ((Prims.Inr a1), q)
         | FStar_Tactics_Result.Failed (m, q) ->
             FStar_Tactics_Result.Success ((Prims.Inl m), q))
let trytac : 'a . 'a tac -> 'a FStar_Pervasives_Native.option tac =
  fun t ->
    ...
    bind uu___
      (fun r ->
         match r with
         | Prims.Inr v -> ret (FStar_Pervasives_Native.Some v)
         | Prims.Inl uu___1 -> ret FStar_Pervasives_Native.None)
