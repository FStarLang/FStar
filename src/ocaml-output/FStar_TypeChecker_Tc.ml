...
let _59_404 = act
in {FStar_Syntax_Syntax.action_name = _59_404.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_univs = univs; FStar_Syntax_Syntax.action_defn = defn; FStar_Syntax_Syntax.action_typ = typ}))
end))
end)))
in (
...
in {FStar_Syntax_Syntax.qualifiers = _59_409.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _59_409.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = univs; FStar_Syntax_Syntax.binders = effect_params; FStar_Syntax_Syntax.signature = signature; FStar_Syntax_Syntax.ret_wp = _154_337; FStar_Syntax_Syntax.bind_wp = _154_336; FStar_Syntax_Syntax.if_then_else = _154_335; FStar_Syntax_Syntax.ite_wp = _154_334; FStar_Syntax_Syntax.stronger = _154_333; FStar_Syntax_Syntax.close_wp = _154_332; FStar_Syntax_Syntax.assert_p = _154_331; FStar_Syntax_Syntax.assume_p = _154_330; FStar_Syntax_Syntax.null_wp = _154_329; FStar_Syntax_Syntax.trivial = _154_328; FStar_Syntax_Syntax.repr = _154_327; FStar_Syntax_Syntax.return_repr = _154_326; FStar_Syntax_Syntax.bind_repr = _154_325; FStar_Syntax_Syntax.actions = _154_324})))))))))))))))
in (
...
in {FStar_Syntax_Syntax.action_name = _59_594.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_univs = _59_594.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_defn = _154_426; FStar_Syntax_Syntax.action_typ = _154_425})))
in (_154_427)::actions)
...
let _59_1737 = (FStar_Syntax_Subst.open_comp tps c)
in (match (_59_1737) with
| (tps, c) -> begin
(

let _59_1741 = (tc_tparams env tps)
in (match (_59_1741) with
| (tps, env, us) -> begin
(

let _59_1745 = (FStar_TypeChecker_TcTerm.tc_comp env c)
in (match (_59_1745) with
| (c, u, g) -> begin
(

let _59_1746 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (
...
let _59_1752 = (let _154_824 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _154_824))
in (match (_59_1752) with
| (uvs, t) -> begin
(

let _59_1771 = (match ((let _154_826 = (let _154_825 = (FStar_Syntax_Subst.compress t)
in _154_825.FStar_Syntax_Syntax.n)
in ((tps), (_154_826)))) with
| ([], FStar_Syntax_Syntax.Tm_arrow (_59_1755, c)) -> begin
(([]), (c))
end
| (_59_1761, FStar_Syntax_Syntax.Tm_arrow (tps, c)) -> begin
((tps), (c))
end
| _59_1768 -> begin
(FStar_All.failwith "Impossible")
end)
in (match (_59_1771) with
| (tps, c) -> begin
(

let _59_1776 = if (((FStar_List.length uvs) <> (Prims.parse_int "1")) && (not ((FStar_Ident.lid_equals lid FStar_Syntax_Const.effect_Lemma_lid)))) then begin
(

let _59_1775 = (FStar_Syntax_Subst.open_univ_vars uvs t)
...
let _59_1792 = (let _154_834 = (let _154_833 = (FStar_Syntax_Util.type_u ())
...
let _59_1812 = (FStar_TypeChecker_TcTerm.tc_term env e)
in (match (_59_1812) with
| (e, c, g1) -> begin
(

let _59_1817 = (let _154_838 = (let _154_835 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_154_835))
...
in (match (_59_1817) with
| (e, _59_1815, g) -> begin
(

let _59_1818 = (let _154_839 = (FStar_TypeChecker_Rel.conj_guard g1 g)
...
let _59_1862 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.fold_left (fun _59_1839 lb -> (match (_59_1839) with
...
let _59_1858 = (match ((FStar_TypeChecker_Env.try_lookup_val_decl env lbname.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)) with
| None -> begin
((gen), (lb), (quals_opt))
end
...
let _59_1853 = (match (lb.FStar_Syntax_Syntax.lbtyp.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
()
end
| _59_1852 -> begin
...
let _59_1905 = (match ((FStar_TypeChecker_TcTerm.tc_maybe_toplevel_term (

let _59_1875 = env
in {FStar_TypeChecker_Env.solver = _59_1875.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_1875.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_1875.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_1875.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_1875.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_1875.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_1875.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_1875.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_1875.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_1875.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_1875.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = should_generalize; FStar_TypeChecker_Env.letrecs = _59_1875.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _59_1875.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_1875.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_1875.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_1875.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _59_1875.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_1875.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_1875.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_1875.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_1875.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_1875.FStar_TypeChecker_Env.qname_and_index}) e)) with
| ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let (lbs, e); FStar_Syntax_Syntax.tk = _59_1882; FStar_Syntax_Syntax.pos = _59_1880; FStar_Syntax_Syntax.vars = _59_1878}, _59_1889, g) when (FStar_TypeChecker_Rel.is_trivial g) -> begin
(

let quals = (match (e.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_meta (_59_1893, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect)) -> begin
...
in (match (_59_1905) with
| (se, lbs) -> begin
(

let _59_1911 = if (log env) then begin
...
in (match (se) with
| FStar_Syntax_Syntax.Sig_pragma (_59_1933) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_inductive_typ (_)) | (FStar_Syntax_Syntax.Sig_datacon (_)) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _59_1944, r) -> begin
if (is_abstract quals) then begin
(FStar_List.fold_right (fun se _59_1951 -> (match (_59_1951) with
| (out, hidden) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, us, bs, t, _59_1957, _59_1959, quals, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (l, us, t, _59_1969, _59_1971, _59_1973, _59_1975, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_assume (_59_1983, _59_1985, quals, _59_1988) -> begin
if (is_abstract quals) then begin
(([]), (hidden))
end else begin
(((se)::[]), (hidden))
...
| FStar_Syntax_Syntax.Sig_main (_59_2009) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_new_effect (_)) | (FStar_Syntax_Syntax.Sig_new_effect_for_free (_)) | (FStar_Syntax_Syntax.Sig_sub_effect (_)) | (FStar_Syntax_Syntax.Sig_effect_abbrev (_)) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), _59_2028, _59_2030, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some is_hidden_proj_or_disc)) -> begin
(
...
let process_one_decl = (fun _59_2051 se -> (match (_59_2051) with
| (ses, exports, env, hidden) -> begin
(

let _59_2053 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _59_2057 = (tc_decl env se)
in (match (_59_2057) with
| (ses', env) -> begin
(

let _59_2060 = if ((FStar_Options.log_types ()) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("LogTypes")))) then begin
...
let _59_2063 = (FStar_List.iter (fun se -> (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env se)) ses')
in (

let _59_2072 = (FStar_List.fold_left (fun _59_2067 se -> (match (_59_2067) with
| (le, lh) -> begin
(
...
let _59_2102 = (FStar_List.fold_left (fun acc se -> (match (se) with
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ne, r) -> begin
(

let _59_2086 = acc
in (match (_59_2086) with
| (_59_2080, _59_2082, env, _59_2085) -> begin
(

let _59_2090 = (cps_and_elaborate env ne)
in (match (_59_2090) with
...
| (ses, exports, env, _59_2101) -> begin
...
in {FStar_TypeChecker_Env.solver = _59_2107.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2107.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2107.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2107.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2107.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2107.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2107.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2107.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2107.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2107.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2107.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2107.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2107.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _59_2107.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _59_2107.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2107.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = modul.FStar_Syntax_Syntax.is_interface; FStar_TypeChecker_Env.admit = _154_912; FStar_TypeChecker_Env.lax = _59_2107.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_2107.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_2107.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2107.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2107.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2107.FStar_TypeChecker_Env.qname_and_index}))
in (

let _59_2110 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push msg)
in (

let env = (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name)
in (

let _59_2116 = (tc_decls env modul.FStar_Syntax_Syntax.declarations)
in (match (_59_2116) with
| (ses, exports, env) -> begin
(((

let _59_2117 = modul
in {FStar_Syntax_Syntax.name = _59_2117.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = ses; FStar_Syntax_Syntax.exports = _59_2117.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _59_2117.FStar_Syntax_Syntax.is_interface})), (exports), (env))
end))))))))


let tc_more_partial_modul : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_Syntax_Syntax.modul * FStar_Syntax_Syntax.sigelt Prims.list * FStar_TypeChecker_Env.env) = (fun env modul decls -> (

let _59_2125 = (tc_decls env decls)
...
let _59_2126 = modul
in {FStar_Syntax_Syntax.name = _59_2126.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = (FStar_List.append modul.FStar_Syntax_Syntax.declarations ses); FStar_Syntax_Syntax.exports = _59_2126.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _59_2126.FStar_Syntax_Syntax.is_interface})
...
let _59_2132 = env
in {FStar_TypeChecker_Env.solver = _59_2132.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2132.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2132.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2132.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2132.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2132.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2132.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2132.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2132.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2132.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2132.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2132.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2132.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _59_2132.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2132.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_2132.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_2132.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = true; FStar_TypeChecker_Env.type_of = _59_2132.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2132.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2132.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2132.FStar_TypeChecker_Env.qname_and_index})
in (

let check_term = (fun lid univs t -> (

let _59_2141 = (FStar_Syntax_Subst.open_univ_vars univs t)
in (match (_59_2141) with
| (univs, t) -> begin
(

let _59_2143 = if (let _154_932 = (let _154_931 = (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name)
...
let _59_2150 = (let _154_947 = (let _154_946 = (FStar_Syntax_Print.lid_to_string modul.FStar_Syntax_Syntax.name)
...
let _59_2152 = (check_term lid univs t)
...
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _59_2159, _59_2161) -> begin
...
| FStar_Syntax_Syntax.Sig_inductive_typ (l, univs, binders, typ, _59_2169, _59_2171, _59_2173, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (l, univs, t, _59_2182, _59_2184, _59_2186, _59_2188, _59_2190) -> begin
(check_term l univs t)
end
| FStar_Syntax_Syntax.Sig_declare_typ (l, univs, t, quals, _59_2198) -> begin
if (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private)))) then begin
(check_term l univs t)
end else begin
()
...
| FStar_Syntax_Syntax.Sig_let ((_59_2202, lbs), _59_2206, _59_2208, quals) -> begin
if (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private)))) then begin
...
let _59_2244 = modul
in {FStar_Syntax_Syntax.name = _59_2244.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = _59_2244.FStar_Syntax_Syntax.declarations; FStar_Syntax_Syntax.exports = exports; FStar_Syntax_Syntax.is_interface = modul.FStar_Syntax_Syntax.is_interface})
in (

let env = (FStar_TypeChecker_Env.finish_module env modul)
in (

let _59_2248 = (check_exports env modul exports)
in (

let _59_2250 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop (Prims.strcat "Ending modul " modul.FStar_Syntax_Syntax.name.FStar_Ident.str))
in (

let _59_2252 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_modul env modul)
in (

let _59_2254 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (

let _59_2256 = (let _154_960 = (FStar_Options.restore_cmd_line_options true)
...
let _59_2263 = (tc_partial_modul env modul)
in (match (_59_2263) with
...
let _59_2266 = if (FStar_Options.debug_any ()) then begin
...
let _59_2270 = (tc_modul env m)
in (match (_59_2270) with
| (m, env) -> begin
(

let _59_2271 = if (FStar_Options.dump_module m.FStar_Syntax_Syntax.name.FStar_Ident.str) then begin
