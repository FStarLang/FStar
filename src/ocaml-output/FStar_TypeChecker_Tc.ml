      ...
      fun quals  ->
        fun lids  ->
          ...
          | {
              ...
              FStar_Syntax_Syntax.sigmeta = uu____2674;_}::{
                                                             FStar_Syntax_Syntax.sigel
                                                               =
                                                               FStar_Syntax_Syntax.Sig_datacon
                                                               (lex_top1,[],_t_top,_lex_t_top,_0_28,uu____2678);
                                                               ...
                                                               = uu____2680;_}::
              {
                FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon
                  (lex_cons,[],_t_cons,_lex_t_cons,_0_29,uu____2684);
                FStar_Syntax_Syntax.sigrng = r2;
                FStar_Syntax_Syntax.sigquals = [];
                FStar_Syntax_Syntax.sigmeta = uu____2686;_}::[]
              when
              ...
              let lex_cons_t =
                let a =
                  ...
                  FStar_Syntax_Syntax.new_bv (Some r2) uu____2754 in
                let hd1 =
                  let uu____2760 = FStar_Syntax_Syntax.bv_to_name a in
                  FStar_Syntax_Syntax.new_bv (Some r2) uu____2760 in
                let tl1 =
                  let uu____2762 =
                    let uu____2763 =
                      let uu____2766 =
                        let uu____2767 =
                          let uu____2772 =
                            FStar_Syntax_Syntax.fvar
                              ...
                              FStar_Syntax_Syntax.Delta_constant None in
                          (uu____2772, [FStar_Syntax_Syntax.U_name ucons2]) in
                ...
                let res =
                  let uu____2785 =
                    let uu____2788 =
                      ...
                      FStar_Syntax_Syntax.Tm_uinst uu____2789 in
                    FStar_Syntax_Syntax.mk uu____2788 in
                  uu____2785 None r2 in
                let uu____2804 = FStar_Syntax_Syntax.mk_Total res in
                FStar_Syntax_Util.arrow
                  [(a, (Some FStar_Syntax_Syntax.imp_tag));
                  (hd1, None);
                  (tl1, None)] uu____2804 in
              let lex_cons_t1 =
              ...
              let uu____2826 = FStar_TypeChecker_Env.get_range env in
              {
                ...
                FStar_Syntax_Syntax.sigrng = uu____2826;
                FStar_Syntax_Syntax.sigquals = [];
                FStar_Syntax_Syntax.sigmeta =
                  FStar_Syntax_Syntax.default_sigmeta
              }
          | uu____2829 ->
              let uu____2831 =
                let uu____2832 =
                  ...
                  FStar_Syntax_Print.sigelt_to_string uu____2833 in
      ...
      fun phi  ->
        fun quals  ->
          fun r  ->
            ...
            let uu____2843 = FStar_Syntax_Util.type_u () in
            match uu____2843 with
            | (k,uu____2847) ->
                let phi1 =
                  let uu____2849 = tc_check_trivial_guard env1 phi k in
        ...
        fun lids  ->
          ...
          | (sig_bndle,tcs,datas) ->
              ...
              ((let uu____2886 =
               ...
               (let skip_prims_type uu____2916 =
                  let lid =
                    let ty = FStar_List.hd tcs in
                    match ty.FStar_Syntax_Syntax.sigel with
                    | FStar_Syntax_Syntax.Sig_inductive_typ
                        (lid,uu____2920,uu____2921,uu____2922,uu____2923,uu____2924)
                        -> lid
                    | uu____2929 -> failwith "Impossible" in
                  let types_to_skip =
                    ["c_False";
                    "c_True";
                    "equals";
                ...
                then ([sig_bndle], data_ops_ses)
                  ...
                  (let is_unopteq =
                   ...
                   let uu____2951 =
                     let uu____2953 =
                       let uu____2954 = FStar_TypeChecker_Env.get_range env0 in
                       {
                         FStar_Syntax_Syntax.sigel =
                           (FStar_Syntax_Syntax.Sig_bundle
                              ((FStar_List.append tcs datas), lids));
                         FStar_Syntax_Syntax.sigrng = uu____2954;
                         FStar_Syntax_Syntax.sigquals = quals;
                         FStar_Syntax_Syntax.sigmeta =
                           FStar_Syntax_Syntax.default_sigmeta
                       } in
                     uu____2953 :: ses1 in
                   (uu____2951, data_ops_ses))))
and tc_decl:
  FStar_TypeChecker_Env.env ->
      ...
      (let r = se.FStar_Syntax_Syntax.sigrng in
       ...
       | FStar_Syntax_Syntax.Sig_pragma p ->
           let set_options1 t s =
             let uu____3021 = FStar_Options.set_options t s in
           ...
           (match p with
            ...
            | FStar_Syntax_Syntax.ResetOptions sopt ->
                ((let uu____3038 =
                  ...
                  FStar_All.pipe_right uu____3038 Prims.ignore);
                 (match sopt with
                  | None  -> ()
                  | Some s -> set_options1 FStar_Options.Reset s);
                 ([se], [])))
       | FStar_Syntax_Syntax.Sig_new_effect_for_free ne ->
           let uu____3044 = cps_and_elaborate env1 ne in
           (match uu____3044 with
            | (ses,ne1,lift_from_pure_opt) ->
                let effect_and_lift_ses =
                  match lift_from_pure_opt with
                  | Some lift ->
                      [(let uu___105_3065 = se in
                        {
                          FStar_Syntax_Syntax.sigel =
                            (FStar_Syntax_Syntax.Sig_new_effect ne1);
                          FStar_Syntax_Syntax.sigrng =
                            (uu___105_3065.FStar_Syntax_Syntax.sigrng);
                          FStar_Syntax_Syntax.sigquals =
                            (uu___105_3065.FStar_Syntax_Syntax.sigquals);
                          FStar_Syntax_Syntax.sigmeta =
                            (uu___105_3065.FStar_Syntax_Syntax.sigmeta)
                        });
                      lift]
                  | None  ->
                      [(let uu___106_3066 = se in
                        {
                          FStar_Syntax_Syntax.sigel =
                            (FStar_Syntax_Syntax.Sig_new_effect ne1);
                          FStar_Syntax_Syntax.sigrng =
                            (uu___106_3066.FStar_Syntax_Syntax.sigrng);
                          FStar_Syntax_Syntax.sigquals =
                            (uu___106_3066.FStar_Syntax_Syntax.sigquals);
                          FStar_Syntax_Syntax.sigmeta =
                            (uu___106_3066.FStar_Syntax_Syntax.sigmeta)
                        })] in
                ([], (FStar_List.append ses effect_and_lift_ses)))
       | FStar_Syntax_Syntax.Sig_new_effect ne ->
           let ne1 = tc_eff_decl env1 ne in
           let se1 =
             let uu___107_3072 = se in
             {
               FStar_Syntax_Syntax.sigel =
                 (FStar_Syntax_Syntax.Sig_new_effect ne1);
               FStar_Syntax_Syntax.sigrng =
                 (uu___107_3072.FStar_Syntax_Syntax.sigrng);
               FStar_Syntax_Syntax.sigquals =
                 (uu___107_3072.FStar_Syntax_Syntax.sigquals);
               FStar_Syntax_Syntax.sigmeta =
                 (uu___107_3072.FStar_Syntax_Syntax.sigmeta)
             } in
           ([se1], [])
           ...
           let uu____3078 =
             let uu____3083 =
               FStar_TypeChecker_Env.lookup_effect_lid env1
                 sub1.FStar_Syntax_Syntax.source in
             monad_signature env1 sub1.FStar_Syntax_Syntax.source uu____3083 in
                 ...
                 | (b,wp_b_tgt) ->
                           ...
                           then no_reify eff_name
                             ...
                             (let uu____3185 =
                              ...
                              let uu____3186 =
                                ...
                                FStar_Syntax_Syntax.mk uu____3189 in
                              uu____3186 None uu____3185) in
                     let uu____3215 =
                       match ((sub1.FStar_Syntax_Syntax.lift),
                               (sub1.FStar_Syntax_Syntax.lift_wp))
                       with
                       | (None ,None ) -> failwith "Impossible"
                       | (lift,Some (uu____3230,lift_wp)) ->
                           let uu____3243 =
                       ...
                       | (Some (what,lift),None ) ->
                           ((let uu____3258 =
                            ...
                            (let dmff_env =
                             ...
                             | (lift1,comp,uu____3271) ->
                                 let uu____3272 =
                                   FStar_TypeChecker_DMFF.star_expr dmff_env
                                     lift1 in
                                 (match uu____3272 with
                                  | (uu____3279,lift_wp,lift_elab) ->
                                      let uu____3282 =
                     ...
                     (match uu____3215 with
                      | (lift,lift_wp) ->
                          ...
                          let env2 =
                            let uu___108_3306 = env1 in
                            {
                              FStar_TypeChecker_Env.solver =
                                (uu___108_3306.FStar_TypeChecker_Env.solver);
                              FStar_TypeChecker_Env.range =
                                (uu___108_3306.FStar_TypeChecker_Env.range);
                              FStar_TypeChecker_Env.curmodule =
                                (uu___108_3306.FStar_TypeChecker_Env.curmodule);
                              FStar_TypeChecker_Env.gamma =
                                (uu___108_3306.FStar_TypeChecker_Env.gamma);
                              FStar_TypeChecker_Env.gamma_cache =
                                (uu___108_3306.FStar_TypeChecker_Env.gamma_cache);
                              FStar_TypeChecker_Env.modules =
                                (uu___108_3306.FStar_TypeChecker_Env.modules);
                              FStar_TypeChecker_Env.expected_typ =
                                (uu___108_3306.FStar_TypeChecker_Env.expected_typ);
                              FStar_TypeChecker_Env.sigtab =
                                (uu___108_3306.FStar_TypeChecker_Env.sigtab);
                              FStar_TypeChecker_Env.is_pattern =
                                (uu___108_3306.FStar_TypeChecker_Env.is_pattern);
                              FStar_TypeChecker_Env.instantiate_imp =
                                (uu___108_3306.FStar_TypeChecker_Env.instantiate_imp);
                              FStar_TypeChecker_Env.effects =
                                (uu___108_3306.FStar_TypeChecker_Env.effects);
                              FStar_TypeChecker_Env.generalize =
                                (uu___108_3306.FStar_TypeChecker_Env.generalize);
                              FStar_TypeChecker_Env.letrecs =
                                (uu___108_3306.FStar_TypeChecker_Env.letrecs);
                              FStar_TypeChecker_Env.top_level =
                                (uu___108_3306.FStar_TypeChecker_Env.top_level);
                              FStar_TypeChecker_Env.check_uvars =
                                (uu___108_3306.FStar_TypeChecker_Env.check_uvars);
                              FStar_TypeChecker_Env.use_eq =
                                (uu___108_3306.FStar_TypeChecker_Env.use_eq);
                              FStar_TypeChecker_Env.is_iface =
                                (uu___108_3306.FStar_TypeChecker_Env.is_iface);
                              FStar_TypeChecker_Env.admit =
                                (uu___108_3306.FStar_TypeChecker_Env.admit);
                              FStar_TypeChecker_Env.lax = true;
                              FStar_TypeChecker_Env.lax_universes =
                                (uu___108_3306.FStar_TypeChecker_Env.lax_universes);
                              FStar_TypeChecker_Env.type_of =
                                (uu___108_3306.FStar_TypeChecker_Env.type_of);
                              FStar_TypeChecker_Env.universe_of =
                                (uu___108_3306.FStar_TypeChecker_Env.universe_of);
                              FStar_TypeChecker_Env.use_bv_sorts =
                                (uu___108_3306.FStar_TypeChecker_Env.use_bv_sorts);
                              FStar_TypeChecker_Env.qname_and_index =
                                (uu___108_3306.FStar_TypeChecker_Env.qname_and_index)
                            } in
                          let lift1 =
                            match lift with
                            | None  -> None
                            | Some (uu____3310,lift1) ->
                                let uu____3317 =
                                  let uu____3322 =
                                 ...
                                 | (a1,wp_a_src1) ->
                                         ...
                                         let uu____3345 =
                                           let uu____3348 =
                                             let uu____3349 =
                                               ...
                                               (lift_wp1, uu____3359) in
                                             FStar_Syntax_Syntax.Tm_app
                                               uu____3349 in
                                           FStar_Syntax_Syntax.mk uu____3348 in
                                         uu____3345 None uu____3344 in
                                       repr_type
                                     ...
                                     let expected_k1 =
                                       ...
                                       let uu____3388 =
                                         FStar_Syntax_Syntax.mk_Total
                                           repr_result in
                                       FStar_Syntax_Util.arrow uu____3377
                                         uu____3388 in
                                     let uu____3391 =
                                       FStar_TypeChecker_TcTerm.tc_tot_or_gtot_term
                                         env2 expected_k1 in
                                     (match uu____3391 with
                                      | (expected_k2,uu____3397,uu____3398)
                                          ->
                                          let lift2 =
                                          ...
                                          Some lift2)) in
                          let sub2 =
                            let uu___109_3401 = sub1 in
                            {
                              FStar_Syntax_Syntax.source =
                                (uu___109_3401.FStar_Syntax_Syntax.source);
                              FStar_Syntax_Syntax.target =
                                (uu___109_3401.FStar_Syntax_Syntax.target);
                              FStar_Syntax_Syntax.lift_wp = (Some lift_wp);
                              FStar_Syntax_Syntax.lift = lift1
                            } in
                          let se1 =
                            let uu___110_3403 = se in
                            {
                              FStar_Syntax_Syntax.sigel =
                                (FStar_Syntax_Syntax.Sig_sub_effect sub2);
                              FStar_Syntax_Syntax.sigrng =
                                (uu___110_3403.FStar_Syntax_Syntax.sigrng);
                              FStar_Syntax_Syntax.sigquals =
                                (uu___110_3403.FStar_Syntax_Syntax.sigquals);
                              FStar_Syntax_Syntax.sigmeta =
                                (uu___110_3403.FStar_Syntax_Syntax.sigmeta)
                            } in
                          ([se1], []))))
       | FStar_Syntax_Syntax.Sig_effect_abbrev (lid,uvs,tps,c,flags) ->
           let env0 = env1 in
           let env2 = FStar_TypeChecker_Env.set_range env1 r in
           let uu____3416 = FStar_Syntax_Subst.open_comp tps c in
                           ...
                           (let tps3 = FStar_Syntax_Subst.close_binders tps2 in
                            ...
                            | (uvs1,t) ->
                                let uu____3464 =
                                  ...
                                  | ([],FStar_Syntax_Syntax.Tm_arrow
                                     (uu____3486,c4)) -> ([], c4)
                                  | (uu____3510,FStar_Syntax_Syntax.Tm_arrow
                                     (tps4,c4)) -> (tps4, c4)
                                ...
                                (match uu____3464 with
                                 | (tps4,c4) ->
                                     (if
                                      ...
                                      (let se1 =
                                         let uu___111_3574 = se in
                                         {
                                           FStar_Syntax_Syntax.sigel =
                                             (FStar_Syntax_Syntax.Sig_effect_abbrev
                                                (lid, uvs1, tps4, c4, flags));
                                           FStar_Syntax_Syntax.sigrng =
                                             (uu___111_3574.FStar_Syntax_Syntax.sigrng);
                                           FStar_Syntax_Syntax.sigquals =
                                             (uu___111_3574.FStar_Syntax_Syntax.sigquals);
                                           FStar_Syntax_Syntax.sigmeta =
                                             (uu___111_3574.FStar_Syntax_Syntax.sigmeta)
                                         } in
                                       ([se1], [])))))))))
       ...
       | FStar_Syntax_Syntax.Sig_declare_typ (lid,uvs,t) ->
           ...
           let uu____3601 =
             ...
             then
               let uu____3602 =
                 ...
                 Prims.fst uu____3603 in
               check_and_gen env2 t uu____3602
             else
               (let uu____3607 = FStar_Syntax_Subst.open_univ_vars uvs t in
                match uu____3607 with
                | (uvs1,t1) ->
                    let t2 =
                      let uu____3613 =
                        let uu____3614 = FStar_Syntax_Util.type_u () in
                        Prims.fst uu____3614 in
                      tc_check_trivial_guard env2 t1 uu____3613 in
                    let t3 =
                      FStar_TypeChecker_Normalize.normalize
           ...
           (match uu____3601 with
            | (uvs1,t1) ->
                let se1 =
                  let uu___112_3628 = se in
                  {
                    FStar_Syntax_Syntax.sigel =
                      (FStar_Syntax_Syntax.Sig_declare_typ (lid, uvs1, t1));
                    FStar_Syntax_Syntax.sigrng =
                      (uu___112_3628.FStar_Syntax_Syntax.sigrng);
                    FStar_Syntax_Syntax.sigquals =
                      (uu___112_3628.FStar_Syntax_Syntax.sigquals);
                    FStar_Syntax_Syntax.sigmeta =
                      (uu___112_3628.FStar_Syntax_Syntax.sigmeta)
                  } in
                ([se1], []))
       ...
       | FStar_Syntax_Syntax.Sig_main e ->
           ...
           let uu____3640 = FStar_TypeChecker_TcTerm.tc_term env3 e in
            ...
            | (e1,c,g1) ->
                let uu____3651 =
                  let uu____3655 =
                    ...
                    Some uu____3657 in
                  let uu____3658 =
                    let uu____3661 = c.FStar_Syntax_Syntax.comp () in
                    (e1, uu____3661) in
                  FStar_TypeChecker_TcTerm.check_expected_effect env3
                    uu____3655 uu____3658 in
                (match uu____3651 with
                 | (e2,uu____3671,g) ->
                     ((let uu____3674 = FStar_TypeChecker_Rel.conj_guard g1 g in
                       FStar_TypeChecker_Rel.force_trivial_guard env3
                         uu____3674);
                      (let se1 =
                         let uu___113_3676 = se in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_main e2);
                           FStar_Syntax_Syntax.sigrng =
                             (uu___113_3676.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             (uu___113_3676.FStar_Syntax_Syntax.sigquals);
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___113_3676.FStar_Syntax_Syntax.sigmeta)
                         } in
                       ([se1], [])))))
             ...
             | Some q' ->
                 ...
                 then Some q
                   ...
                   (let uu____3721 =
                      let uu____3722 =
                        let uu____3725 =
                          let uu____3726 = FStar_Syntax_Print.lid_to_string l in
                          let uu____3727 =
                          ...
                          FStar_Util.format3
                            ...
                            uu____3726 uu____3727 uu____3728 in
                        (uu____3725, r) in
                      FStar_Errors.Error uu____3722 in
                    Prims.raise uu____3721) in
           let uu____3731 =
                             ...
                             | Some ((uvs,tval),quals) ->
                                 ...
                                 ((match (lb.FStar_Syntax_Syntax.lbtyp).FStar_Syntax_Syntax.n
                                  ...
                                  (let uu____3842 =
                                   ...
                                   (false, uu____3842, quals_opt1))) in
                  ...
                  let uu____3906 =
                    let uu____3909 =
                      let uu____3910 =
                        ...
                        (((Prims.fst lbs), lbs'1), uu____3918) in
                      FStar_Syntax_Syntax.Tm_let uu____3910 in
                    FStar_Syntax_Syntax.mk uu____3909 in
                  uu____3906 None r in
                let uu____3940 =
                  let uu____3946 =
                    FStar_TypeChecker_TcTerm.tc_maybe_toplevel_term
                      (let uu___114_3950 = env2 in
                       {
                         FStar_TypeChecker_Env.solver =
                           (uu___114_3950.FStar_TypeChecker_Env.solver);
                         FStar_TypeChecker_Env.range =
                           (uu___114_3950.FStar_TypeChecker_Env.range);
                         FStar_TypeChecker_Env.curmodule =
                           (uu___114_3950.FStar_TypeChecker_Env.curmodule);
                         FStar_TypeChecker_Env.gamma =
                           (uu___114_3950.FStar_TypeChecker_Env.gamma);
                         FStar_TypeChecker_Env.gamma_cache =
                           (uu___114_3950.FStar_TypeChecker_Env.gamma_cache);
                         FStar_TypeChecker_Env.modules =
                           (uu___114_3950.FStar_TypeChecker_Env.modules);
                         FStar_TypeChecker_Env.expected_typ =
                           (uu___114_3950.FStar_TypeChecker_Env.expected_typ);
                         FStar_TypeChecker_Env.sigtab =
                           (uu___114_3950.FStar_TypeChecker_Env.sigtab);
                         FStar_TypeChecker_Env.is_pattern =
                           (uu___114_3950.FStar_TypeChecker_Env.is_pattern);
                         FStar_TypeChecker_Env.instantiate_imp =
                           (uu___114_3950.FStar_TypeChecker_Env.instantiate_imp);
                         FStar_TypeChecker_Env.effects =
                           (uu___114_3950.FStar_TypeChecker_Env.effects);
                         FStar_TypeChecker_Env.generalize = should_generalize;
                         FStar_TypeChecker_Env.letrecs =
                           (uu___114_3950.FStar_TypeChecker_Env.letrecs);
                         FStar_TypeChecker_Env.top_level = true;
                         FStar_TypeChecker_Env.check_uvars =
                           (uu___114_3950.FStar_TypeChecker_Env.check_uvars);
                         FStar_TypeChecker_Env.use_eq =
                           (uu___114_3950.FStar_TypeChecker_Env.use_eq);
                         FStar_TypeChecker_Env.is_iface =
                           (uu___114_3950.FStar_TypeChecker_Env.is_iface);
                         FStar_TypeChecker_Env.admit =
                           (uu___114_3950.FStar_TypeChecker_Env.admit);
                         FStar_TypeChecker_Env.lax =
                           (uu___114_3950.FStar_TypeChecker_Env.lax);
                         FStar_TypeChecker_Env.lax_universes =
                           (uu___114_3950.FStar_TypeChecker_Env.lax_universes);
                         FStar_TypeChecker_Env.type_of =
                           (uu___114_3950.FStar_TypeChecker_Env.type_of);
                         FStar_TypeChecker_Env.universe_of =
                           (uu___114_3950.FStar_TypeChecker_Env.universe_of);
                         FStar_TypeChecker_Env.use_bv_sorts =
                           (uu___114_3950.FStar_TypeChecker_Env.use_bv_sorts);
                         FStar_TypeChecker_Env.qname_and_index =
                           (uu___114_3950.FStar_TypeChecker_Env.qname_and_index)
                       }) e in
                  match uu____3946 with
                  | ({
                       FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let
                         (lbs1,e1);
                       FStar_Syntax_Syntax.tk = uu____3958;
                       FStar_Syntax_Syntax.pos = uu____3959;
                       FStar_Syntax_Syntax.vars = uu____3960;_},uu____3961,g)
                      when FStar_TypeChecker_Rel.is_trivial g ->
                      let quals1 =
                        match e1.FStar_Syntax_Syntax.n with
                        | FStar_Syntax_Syntax.Tm_meta
                            (uu____3980,FStar_Syntax_Syntax.Meta_desugared
                          ...
                          (fun uu___87_3988  ->
                             ...
                             | FStar_Syntax_Syntax.Inline_for_extraction  ->
                                 let uu____3990 =
                                   ...
                                   Prims.op_Negation uu____3991 in
                                 if uu____3990
                                 then None
                                 else
                                   Some
                                     FStar_Syntax_Syntax.Inline_for_extraction
                             | q -> Some q) quals1 in
                      ((let uu___115_4004 = se in
                        {
                          FStar_Syntax_Syntax.sigel =
                            (FStar_Syntax_Syntax.Sig_let (lbs1, lids, attrs));
                          FStar_Syntax_Syntax.sigrng =
                            (uu___115_4004.FStar_Syntax_Syntax.sigrng);
                          FStar_Syntax_Syntax.sigquals = quals2;
                          FStar_Syntax_Syntax.sigmeta =
                            (uu___115_4004.FStar_Syntax_Syntax.sigmeta)
                        }), lbs1)
                                         ...
                                         let uu____4051 =
                                           let uu____4052 =
                                             let uu____4057 =
                                               FStar_Util.right
                                                 lb.FStar_Syntax_Syntax.lbname in
                                             uu____4057.FStar_Syntax_Syntax.fv_name in
                                           uu____4052.FStar_Syntax_Syntax.v in
  ...
  fun hidden  ->
    fun se  ->
      ...
      let is_hidden_proj_or_disc q =
        ...
        | uu____4108 -> false in
      match se.FStar_Syntax_Syntax.sigel with
      | FStar_Syntax_Syntax.Sig_pragma uu____4113 -> ([], hidden)
      | FStar_Syntax_Syntax.Sig_inductive_typ _
        |FStar_Syntax_Syntax.Sig_datacon _ -> failwith "Impossible"
      | FStar_Syntax_Syntax.Sig_bundle (ses,uu____4123) ->
          let uu____4128 = is_abstract se.FStar_Syntax_Syntax.sigquals in
          if uu____4128
          then
            let for_export_bundle se1 uu____4147 =
              match uu____4147 with
              | (out,hidden1) ->
                  (match se1.FStar_Syntax_Syntax.sigel with
                   | FStar_Syntax_Syntax.Sig_inductive_typ
                       (l,us,bs,t,uu____4170,uu____4171) ->
                       let dec =
                         let uu___116_4177 = se1 in
                         let uu____4178 =
                           let uu____4179 =
                             let uu____4183 =
                               let uu____4186 =
                                 FStar_Syntax_Syntax.mk_Total t in
                               FStar_Syntax_Util.arrow bs uu____4186 in
                             (l, us, uu____4183) in
                           FStar_Syntax_Syntax.Sig_declare_typ uu____4179 in
                         {
                           FStar_Syntax_Syntax.sigel = uu____4178;
                           FStar_Syntax_Syntax.sigrng =
                             (uu___116_4177.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             (FStar_Syntax_Syntax.Assumption ::
                             FStar_Syntax_Syntax.New ::
                             (se1.FStar_Syntax_Syntax.sigquals));
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___116_4177.FStar_Syntax_Syntax.sigmeta)
                         } in
                       ((dec :: out), hidden1)
                   | FStar_Syntax_Syntax.Sig_datacon
                       (l,us,t,uu____4196,uu____4197,uu____4198) ->
                       let dec =
                         let uu___117_4202 = se1 in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ (l, us, t));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___117_4202.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             [FStar_Syntax_Syntax.Assumption];
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___117_4202.FStar_Syntax_Syntax.sigmeta)
                         } in
                       ((dec :: out), (l :: hidden1))
                   | uu____4205 -> (out, hidden1)) in
            FStar_List.fold_right for_export_bundle ses ([], hidden)
          else ([se], hidden)
      | FStar_Syntax_Syntax.Sig_assume (uu____4217,uu____4218) ->
          let uu____4219 = is_abstract se.FStar_Syntax_Syntax.sigquals in
          if uu____4219 then ([], hidden) else ([se], hidden)
      | FStar_Syntax_Syntax.Sig_declare_typ (l,us,t) ->
          let uu____4232 =
            FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
          ...
          if uu____4232
          then
            ([(let uu___118_4240 = se in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_declare_typ (l, us, t));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___118_4240.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   [FStar_Syntax_Syntax.Assumption];
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___118_4240.FStar_Syntax_Syntax.sigmeta)
               })], (l :: hidden))
          else
            (let uu____4242 =
               FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                 (FStar_Util.for_some
                    (fun uu___89_4244  ->
                       match uu___89_4244 with
                       | FStar_Syntax_Syntax.Assumption 
                         |FStar_Syntax_Syntax.Projector _
                          |FStar_Syntax_Syntax.Discriminator _ -> true
                       | uu____4247 -> false)) in
             if uu____4242 then ([se], hidden) else ([], hidden))
      | FStar_Syntax_Syntax.Sig_main uu____4257 -> ([], hidden)
      ...
      | FStar_Syntax_Syntax.Sig_let ((false ,lb::[]),uu____4267,uu____4268)
          when
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
          ...
          then ([], hidden)
            ...
            (let dec =
             ...
             ([dec], (lid :: hidden)))
      | FStar_Syntax_Syntax.Sig_let (lbs,l,uu____4305) ->
          let uu____4310 = is_abstract se.FStar_Syntax_Syntax.sigquals in
          if uu____4310
          then
            let uu____4315 =
              FStar_All.pipe_right (Prims.snd lbs)
                          ...
                          let uu____4327 =
                            let uu____4328 =
                              let uu____4333 =
                                FStar_Util.right
                                  lb.FStar_Syntax_Syntax.lbname in
                              uu____4333.FStar_Syntax_Syntax.fv_name in
                            uu____4328.FStar_Syntax_Syntax.v in
                          (uu____4327, (lb.FStar_Syntax_Syntax.lbunivs),
                            (lb.FStar_Syntax_Syntax.lbtyp)) in
                        FStar_Syntax_Syntax.Sig_declare_typ uu____4323 in
                      {
                        FStar_Syntax_Syntax.sigel = uu____4322;
                        FStar_Syntax_Syntax.sigrng =
                          (uu___119_4321.FStar_Syntax_Syntax.sigrng);
                        FStar_Syntax_Syntax.sigquals =
                          (FStar_Syntax_Syntax.Assumption ::
                          (se.FStar_Syntax_Syntax.sigquals));
                        FStar_Syntax_Syntax.sigmeta =
                          (uu___119_4321.FStar_Syntax_Syntax.sigmeta)
                      })) in
            (uu____4315, hidden)
          else ([se], hidden)
let add_sigelt_to_env:
  ...
  fun env  ->
    fun se  ->
      match se.FStar_Syntax_Syntax.sigel with
      | FStar_Syntax_Syntax.Sig_inductive_typ uu____4351 ->
          failwith "add_sigelt_to_env: Impossible, bare data constructor"
      | FStar_Syntax_Syntax.Sig_datacon uu____4360 ->
          failwith "add_sigelt_to_env: Impossible, bare data constructor"
      | FStar_Syntax_Syntax.Sig_pragma p ->
          (match p with
           | FStar_Syntax_Syntax.ResetOptions uu____4369 ->
               ((env.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.refresh
                  ();
                env)
           | uu____4372 -> env)
      | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____4373 -> env
      | FStar_Syntax_Syntax.Sig_new_effect ne ->
            ...
            (FStar_List.fold_left
               (fun env2  ->
                  fun a  ->
                    ...
                    FStar_TypeChecker_Env.push_sigelt env2 uu____4379) env1)
      | FStar_Syntax_Syntax.Sig_declare_typ (_,_,_)
        |FStar_Syntax_Syntax.Sig_let (_,_,_) when
          FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
            (FStar_Util.for_some
               (fun uu___90_4389  ->
                  match uu___90_4389 with
                  | FStar_Syntax_Syntax.OnlyName  -> true
                  | uu____4390 -> false))
          -> env
      | uu____4391 -> FStar_TypeChecker_Env.push_sigelt env se
let tc_decls:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.sigelt Prims.list ->
      (FStar_Syntax_Syntax.sigelt Prims.list* FStar_Syntax_Syntax.sigelt
  ...
  fun env  ->
    fun ses  ->
      let rec process_one_decl uu____4427 se =
        ...
        | (ses1,exports,env1,hidden) ->
            ((let uu____4457 =
              ...
              if uu____4457
              then
                let uu____4458 = FStar_Syntax_Print.sigelt_to_string se in
                FStar_Util.print1
                  ">>>>>>>>>>>>>>Checking top-level decl %s\n" uu____4458
              else ());
             (let uu____4460 = tc_decl env1 se in
                          ...
                          (fun s  ->
                             fun se1  ->
                               let uu____4490 =
                                 ...
                                 Prims.strcat uu____4491 "\n" in
                               Prims.strcat s uu____4490) "" ses' in
                   ...
                   FStar_List.iter
                     (fun se1  ->
                        (env2.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.encode_sig
                          env2 se1) ses';
                   (let uu____4495 =
                      let accum_exports_hidden uu____4513 se1 =
                        match uu____4513 with
                        | (exports1,hidden1) ->
                            let uu____4529 = for_export hidden1 se1 in
...
let tc_partial_modul:
  ...
  fun env  ->
    fun modul  ->
      ...
      (let uu____4630 = FStar_Options.debug_any () in
       if uu____4630
       then
      ...
      (let name =
       ...
       let env1 =
         let uu___120_4636 = env in
         {
           FStar_TypeChecker_Env.solver =
             (uu___120_4636.FStar_TypeChecker_Env.solver);
           FStar_TypeChecker_Env.range =
             (uu___120_4636.FStar_TypeChecker_Env.range);
           FStar_TypeChecker_Env.curmodule =
             (uu___120_4636.FStar_TypeChecker_Env.curmodule);
           FStar_TypeChecker_Env.gamma =
             (uu___120_4636.FStar_TypeChecker_Env.gamma);
           FStar_TypeChecker_Env.gamma_cache =
             (uu___120_4636.FStar_TypeChecker_Env.gamma_cache);
           FStar_TypeChecker_Env.modules =
             (uu___120_4636.FStar_TypeChecker_Env.modules);
           FStar_TypeChecker_Env.expected_typ =
             (uu___120_4636.FStar_TypeChecker_Env.expected_typ);
           FStar_TypeChecker_Env.sigtab =
             (uu___120_4636.FStar_TypeChecker_Env.sigtab);
           FStar_TypeChecker_Env.is_pattern =
             (uu___120_4636.FStar_TypeChecker_Env.is_pattern);
           FStar_TypeChecker_Env.instantiate_imp =
             (uu___120_4636.FStar_TypeChecker_Env.instantiate_imp);
           FStar_TypeChecker_Env.effects =
             (uu___120_4636.FStar_TypeChecker_Env.effects);
           FStar_TypeChecker_Env.generalize =
             (uu___120_4636.FStar_TypeChecker_Env.generalize);
           FStar_TypeChecker_Env.letrecs =
             (uu___120_4636.FStar_TypeChecker_Env.letrecs);
           FStar_TypeChecker_Env.top_level =
             (uu___120_4636.FStar_TypeChecker_Env.top_level);
           FStar_TypeChecker_Env.check_uvars =
             (uu___120_4636.FStar_TypeChecker_Env.check_uvars);
           FStar_TypeChecker_Env.use_eq =
             (uu___120_4636.FStar_TypeChecker_Env.use_eq);
           FStar_TypeChecker_Env.is_iface =
             (modul.FStar_Syntax_Syntax.is_interface);
           FStar_TypeChecker_Env.admit = (Prims.op_Negation verify);
           FStar_TypeChecker_Env.lax =
             (uu___120_4636.FStar_TypeChecker_Env.lax);
           FStar_TypeChecker_Env.lax_universes =
             (uu___120_4636.FStar_TypeChecker_Env.lax_universes);
           FStar_TypeChecker_Env.type_of =
             (uu___120_4636.FStar_TypeChecker_Env.type_of);
           FStar_TypeChecker_Env.universe_of =
             (uu___120_4636.FStar_TypeChecker_Env.universe_of);
           FStar_TypeChecker_Env.use_bv_sorts =
             (uu___120_4636.FStar_TypeChecker_Env.use_bv_sorts);
           FStar_TypeChecker_Env.qname_and_index =
             (uu___120_4636.FStar_TypeChecker_Env.qname_and_index)
         } in
       (env1.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.push msg;
       (let env2 =
          FStar_TypeChecker_Env.set_current_module env1
            modul.FStar_Syntax_Syntax.name in
        let uu____4639 = tc_decls env2 modul.FStar_Syntax_Syntax.declarations in
        match uu____4639 with
        | (ses,exports,env3) ->
            ((let uu___121_4657 = modul in
              {
                FStar_Syntax_Syntax.name =
                  (uu___121_4657.FStar_Syntax_Syntax.name);
                FStar_Syntax_Syntax.declarations = ses;
                FStar_Syntax_Syntax.exports =
                  (uu___121_4657.FStar_Syntax_Syntax.exports);
                FStar_Syntax_Syntax.is_interface =
                  (uu___121_4657.FStar_Syntax_Syntax.is_interface)
              }), exports, env3)))
let tc_more_partial_modul:
  ...
  fun env  ->
    fun modul  ->
      fun decls  ->
        let uu____4673 = tc_decls env decls in
        match uu____4673 with
        | (ses,exports,env1) ->
            let modul1 =
              let uu___122_4691 = modul in
              {
                FStar_Syntax_Syntax.name =
                  (uu___122_4691.FStar_Syntax_Syntax.name);
                FStar_Syntax_Syntax.declarations =
                  (FStar_List.append modul.FStar_Syntax_Syntax.declarations
                     ses);
                FStar_Syntax_Syntax.exports =
                  (uu___122_4691.FStar_Syntax_Syntax.exports);
                FStar_Syntax_Syntax.is_interface =
                  (uu___122_4691.FStar_Syntax_Syntax.is_interface)
              } in
            (modul1, exports, env1)
let check_exports:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun modul  ->
      fun exports  ->
        let env1 =
          let uu___123_4705 = env in
          {
            FStar_TypeChecker_Env.solver =
              (uu___123_4705.FStar_TypeChecker_Env.solver);
            FStar_TypeChecker_Env.range =
              (uu___123_4705.FStar_TypeChecker_Env.range);
            FStar_TypeChecker_Env.curmodule =
              (uu___123_4705.FStar_TypeChecker_Env.curmodule);
            FStar_TypeChecker_Env.gamma =
              (uu___123_4705.FStar_TypeChecker_Env.gamma);
            FStar_TypeChecker_Env.gamma_cache =
              (uu___123_4705.FStar_TypeChecker_Env.gamma_cache);
            FStar_TypeChecker_Env.modules =
              (uu___123_4705.FStar_TypeChecker_Env.modules);
            FStar_TypeChecker_Env.expected_typ =
              (uu___123_4705.FStar_TypeChecker_Env.expected_typ);
            FStar_TypeChecker_Env.sigtab =
              (uu___123_4705.FStar_TypeChecker_Env.sigtab);
            FStar_TypeChecker_Env.is_pattern =
              (uu___123_4705.FStar_TypeChecker_Env.is_pattern);
            FStar_TypeChecker_Env.instantiate_imp =
              (uu___123_4705.FStar_TypeChecker_Env.instantiate_imp);
            FStar_TypeChecker_Env.effects =
              (uu___123_4705.FStar_TypeChecker_Env.effects);
            FStar_TypeChecker_Env.generalize =
              (uu___123_4705.FStar_TypeChecker_Env.generalize);
            FStar_TypeChecker_Env.letrecs =
              (uu___123_4705.FStar_TypeChecker_Env.letrecs);
            FStar_TypeChecker_Env.top_level = true;
            FStar_TypeChecker_Env.check_uvars =
              (uu___123_4705.FStar_TypeChecker_Env.check_uvars);
            FStar_TypeChecker_Env.use_eq =
              (uu___123_4705.FStar_TypeChecker_Env.use_eq);
            FStar_TypeChecker_Env.is_iface =
              (uu___123_4705.FStar_TypeChecker_Env.is_iface);
            FStar_TypeChecker_Env.admit =
              (uu___123_4705.FStar_TypeChecker_Env.admit);
            FStar_TypeChecker_Env.lax = true;
            FStar_TypeChecker_Env.lax_universes = true;
            FStar_TypeChecker_Env.type_of =
              (uu___123_4705.FStar_TypeChecker_Env.type_of);
            FStar_TypeChecker_Env.universe_of =
              (uu___123_4705.FStar_TypeChecker_Env.universe_of);
            FStar_TypeChecker_Env.use_bv_sorts =
              (uu___123_4705.FStar_TypeChecker_Env.use_bv_sorts);
            FStar_TypeChecker_Env.qname_and_index =
              (uu___123_4705.FStar_TypeChecker_Env.qname_and_index)
          } in
        let check_term lid univs1 t =
          let uu____4716 = FStar_Syntax_Subst.open_univ_vars univs1 t in
              ...
              ((let uu____4722 =
                  let uu____4723 =
                    let uu____4726 =
                      FStar_TypeChecker_Env.set_current_module env1
                        modul.FStar_Syntax_Syntax.name in
                    FStar_TypeChecker_Env.debug uu____4726 in
                  FStar_All.pipe_left uu____4723
                    (FStar_Options.Other "Exports") in
                if uu____4722
                then
                  let uu____4727 = FStar_Syntax_Print.lid_to_string lid in
                  let uu____4728 =
                    let uu____4729 =
                  ...
                  let uu____4734 = FStar_Syntax_Print.term_to_string t1 in
                  FStar_Util.print3 "Checking for export %s <%s> : %s\n"
                    uu____4727 uu____4728 uu____4734
                else ());
               (let env2 = FStar_TypeChecker_Env.push_univ_vars env1 univs2 in
                let uu____4737 =
                  FStar_TypeChecker_TcTerm.tc_trivial_guard env2 t1 in
                FStar_All.pipe_right uu____4737 Prims.ignore)) in
        let check_term1 lid univs1 t =
          (let uu____4755 =
             let uu____4756 =
               FStar_Syntax_Print.lid_to_string
                 modul.FStar_Syntax_Syntax.name in
             let uu____4757 = FStar_Syntax_Print.lid_to_string lid in
             FStar_Util.format2
               "Interface of %s violates its abstraction (add a 'private' qualifier to '%s'?)"
               uu____4756 uu____4757 in
           FStar_Errors.message_prefix.FStar_Errors.set_prefix uu____4755);
          check_term lid univs1 t;
          FStar_Errors.message_prefix.FStar_Errors.clear_prefix () in
        let rec check_sigelt se =
          match se.FStar_Syntax_Syntax.sigel with
          | FStar_Syntax_Syntax.Sig_bundle (ses,uu____4764) ->
              let uu____4769 =
                let uu____4770 =
                  FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                    (FStar_List.contains FStar_Syntax_Syntax.Private) in
                Prims.op_Negation uu____4770 in
              if uu____4769
              then FStar_All.pipe_right ses (FStar_List.iter check_sigelt)
              else ()
          | FStar_Syntax_Syntax.Sig_inductive_typ
              (l,univs1,binders,typ,uu____4778,uu____4779) ->
              let t =
                let uu____4787 =
                  let uu____4790 =
                    let uu____4791 =
                      let uu____4799 = FStar_Syntax_Syntax.mk_Total typ in
                      (binders, uu____4799) in
                    FStar_Syntax_Syntax.Tm_arrow uu____4791 in
                  FStar_Syntax_Syntax.mk uu____4790 in
                uu____4787 None se.FStar_Syntax_Syntax.sigrng in
              check_term1 l univs1 t
          | FStar_Syntax_Syntax.Sig_datacon
              (l,univs1,t,uu____4811,uu____4812,uu____4813) ->
              check_term1 l univs1 t
          | FStar_Syntax_Syntax.Sig_declare_typ (l,univs1,t) ->
              let uu____4819 =
                let uu____4820 =
                  FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                    (FStar_List.contains FStar_Syntax_Syntax.Private) in
                Prims.op_Negation uu____4820 in
              if uu____4819 then check_term1 l univs1 t else ()
          | FStar_Syntax_Syntax.Sig_let
              ((uu____4823,lbs),uu____4825,uu____4826) ->
              let uu____4836 =
                let uu____4837 =
                  FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals
                    (FStar_List.contains FStar_Syntax_Syntax.Private) in
                Prims.op_Negation uu____4837 in
              if uu____4836
              then
...
let finish_partial_modul:
  ...
  fun env  ->
    fun modul  ->
      fun exports  ->
        let modul1 =
          let uu___124_4888 = modul in
          {
            FStar_Syntax_Syntax.name =
              (uu___124_4888.FStar_Syntax_Syntax.name);
            FStar_Syntax_Syntax.declarations =
              (uu___124_4888.FStar_Syntax_Syntax.declarations);
  ...
  fun env  ->
    fun m  ->
      ...
      (let env1 =
         ...
         {
           FStar_TypeChecker_Env.solver =
             (uu___125_4936.FStar_TypeChecker_Env.solver);
           FStar_TypeChecker_Env.range =
             (uu___125_4936.FStar_TypeChecker_Env.range);
           FStar_TypeChecker_Env.curmodule =
             (uu___125_4936.FStar_TypeChecker_Env.curmodule);
           FStar_TypeChecker_Env.gamma =
             (uu___125_4936.FStar_TypeChecker_Env.gamma);
           FStar_TypeChecker_Env.gamma_cache =
             (uu___125_4936.FStar_TypeChecker_Env.gamma_cache);
           FStar_TypeChecker_Env.modules =
             (uu___125_4936.FStar_TypeChecker_Env.modules);
           FStar_TypeChecker_Env.expected_typ =
             (uu___125_4936.FStar_TypeChecker_Env.expected_typ);
           FStar_TypeChecker_Env.sigtab =
             (uu___125_4936.FStar_TypeChecker_Env.sigtab);
           FStar_TypeChecker_Env.is_pattern =
             (uu___125_4936.FStar_TypeChecker_Env.is_pattern);
           FStar_TypeChecker_Env.instantiate_imp =
             (uu___125_4936.FStar_TypeChecker_Env.instantiate_imp);
           FStar_TypeChecker_Env.effects =
             (uu___125_4936.FStar_TypeChecker_Env.effects);
           FStar_TypeChecker_Env.generalize =
             (uu___125_4936.FStar_TypeChecker_Env.generalize);
           FStar_TypeChecker_Env.letrecs =
             (uu___125_4936.FStar_TypeChecker_Env.letrecs);
           FStar_TypeChecker_Env.top_level =
             (uu___125_4936.FStar_TypeChecker_Env.top_level);
           FStar_TypeChecker_Env.check_uvars =
             (uu___125_4936.FStar_TypeChecker_Env.check_uvars);
           FStar_TypeChecker_Env.use_eq =
             (uu___125_4936.FStar_TypeChecker_Env.use_eq);
           FStar_TypeChecker_Env.is_iface =
             (uu___125_4936.FStar_TypeChecker_Env.is_iface);
           FStar_TypeChecker_Env.admit =
             (uu___125_4936.FStar_TypeChecker_Env.admit);
           FStar_TypeChecker_Env.lax = uu____4937;
           FStar_TypeChecker_Env.lax_universes =
             (uu___125_4936.FStar_TypeChecker_Env.lax_universes);
           FStar_TypeChecker_Env.type_of =
             (uu___125_4936.FStar_TypeChecker_Env.type_of);
           FStar_TypeChecker_Env.universe_of =
             (uu___125_4936.FStar_TypeChecker_Env.universe_of);
           FStar_TypeChecker_Env.use_bv_sorts =
             (uu___125_4936.FStar_TypeChecker_Env.use_bv_sorts);
           FStar_TypeChecker_Env.qname_and_index =
             (uu___125_4936.FStar_TypeChecker_Env.qname_and_index)
         } in
                       ...
                       | (univnames1,e) ->
                             ...
                             n1 uu____4987 e in
                           {
                             FStar_Syntax_Syntax.lbname =
                               (uu___126_4983.FStar_Syntax_Syntax.lbname);
                             FStar_Syntax_Syntax.lbunivs =
                               (uu___126_4983.FStar_Syntax_Syntax.lbunivs);
                             FStar_Syntax_Syntax.lbtyp =
                               (uu___126_4983.FStar_Syntax_Syntax.lbtyp);
                             FStar_Syntax_Syntax.lbeff =
                               (uu___126_4983.FStar_Syntax_Syntax.lbeff);
                             FStar_Syntax_Syntax.lbdef = uu____4984
                           } in
                     let uu___127_4988 = se in
                     let uu____4989 =
                       let uu____4990 =
                         let uu____4996 =
                           let uu____5000 = FStar_List.map update lbs in
                           (b, uu____5000) in
                         (uu____4996, ids, attrs) in
                       FStar_Syntax_Syntax.Sig_let uu____4990 in
                     {
                       FStar_Syntax_Syntax.sigel = uu____4989;
                       FStar_Syntax_Syntax.sigrng =
                         (uu___127_4988.FStar_Syntax_Syntax.sigrng);
                       FStar_Syntax_Syntax.sigquals =
                         (uu___127_4988.FStar_Syntax_Syntax.sigquals);
                       FStar_Syntax_Syntax.sigmeta =
                         (uu___127_4988.FStar_Syntax_Syntax.sigmeta)
                     }
                 | uu____5008 -> se in
               let normalized_module =
                 let uu___128_5010 = m1 in
                 let uu____5011 =
                   FStar_List.map normalize_toplevel_lets
                     m1.FStar_Syntax_Syntax.declarations in
                 {
                   FStar_Syntax_Syntax.name =
                     (uu___128_5010.FStar_Syntax_Syntax.name);
                   FStar_Syntax_Syntax.declarations = uu____5011;
                   FStar_Syntax_Syntax.exports =
                     (uu___128_5010.FStar_Syntax_Syntax.exports);
                   FStar_Syntax_Syntax.is_interface =
                     (uu___128_5010.FStar_Syntax_Syntax.is_interface)
                 } in
               let uu____5012 =
