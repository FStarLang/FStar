...
let _59_520 = (match ((let _154_375 = (FStar_Syntax_Util.abs bs body None)
...
let _59_526 = (let _154_384 = (let _154_383 = (FStar_Syntax_Util.unascribe wp_b1)
...
let _59_562 = (let _154_412 = (mk_lid name)
...
let _59_563 = (let _154_414 = (let _154_413 = (FStar_ST.read sigelts)
in (sigelt)::_154_413)
...
let _59_567 = (let _154_416 = (let _154_415 = (FStar_ST.read sigelts)
...
let _59_570 = (let _154_418 = (let _154_417 = (FStar_ST.read sigelts)
...
let _59_573 = (let _154_420 = (let _154_419 = (FStar_ST.read sigelts)
...
let _59_576 = (let _154_422 = (let _154_421 = (FStar_ST.read sigelts)
...
let _59_595 = (FStar_List.fold_left (fun _59_580 action -> (match (_59_580) with
| (dmff_env, actions) -> begin
(

let _59_586 = (elaborate_and_star dmff_env ((action.FStar_Syntax_Syntax.action_univs), (action.FStar_Syntax_Syntax.action_defn)))
...
in {FStar_Syntax_Syntax.action_name = _59_591.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_univs = _59_591.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_defn = _154_426; FStar_Syntax_Syntax.action_typ = _154_425})))
in (_154_427)::actions)
...
let _59_646 = (match ((let _154_442 = (let _154_441 = (FStar_Syntax_Subst.compress wp_type)
in (FStar_All.pipe_left FStar_Syntax_Util.unascribe _154_441))
in _154_442.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_abs ((type_param)::effect_param, arrow, _59_607) -> begin
(

let _59_620 = (match ((FStar_Syntax_Subst.open_term ((type_param)::effect_param) arrow)) with
| ((b)::bs, body) -> begin
((b), (bs), (body))
end
| _59_616 -> begin
...
let _59_627 = (FStar_Syntax_Subst.open_comp wp_binders c)
in (match (_59_627) with
| (wp_binders, c) -> begin
(

let _59_634 = (FStar_List.partition (fun _59_631 -> (match (_59_631) with
| (bv, _59_630) -> begin
...
let _59_647 = (let _154_456 = (register "pre" pre)
in (Prims.ignore _154_456))
in (

let _59_649 = (let _154_457 = (register "post" post)
in (Prims.ignore _154_457))
in (

let _59_651 = (let _154_458 = (register "wp" wp_type)
...
in (([]), (_154_462)))
in {FStar_Syntax_Syntax.qualifiers = _59_653.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _59_653.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = _59_653.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = _154_469; FStar_Syntax_Syntax.signature = _154_468; FStar_Syntax_Syntax.ret_wp = _154_467; FStar_Syntax_Syntax.bind_wp = _154_466; FStar_Syntax_Syntax.if_then_else = _59_653.FStar_Syntax_Syntax.if_then_else; FStar_Syntax_Syntax.ite_wp = _59_653.FStar_Syntax_Syntax.ite_wp; FStar_Syntax_Syntax.stronger = _59_653.FStar_Syntax_Syntax.stronger; FStar_Syntax_Syntax.close_wp = _59_653.FStar_Syntax_Syntax.close_wp; FStar_Syntax_Syntax.assert_p = _59_653.FStar_Syntax_Syntax.assert_p; FStar_Syntax_Syntax.assume_p = _59_653.FStar_Syntax_Syntax.assume_p; FStar_Syntax_Syntax.null_wp = _59_653.FStar_Syntax_Syntax.null_wp; FStar_Syntax_Syntax.trivial = _59_653.FStar_Syntax_Syntax.trivial; FStar_Syntax_Syntax.repr = _154_465; FStar_Syntax_Syntax.return_repr = _154_464; FStar_Syntax_Syntax.bind_repr = _154_463; FStar_Syntax_Syntax.actions = actions}))))))))
in (

let _59_658 = (FStar_TypeChecker_DMFF.gen_wps_for_free env effect_binders a wp_a ed)
in (match (_59_658) with
| (sigelts', ed) -> begin
(

let _59_659 = if (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("ED"))) then begin
...
let _59_675 = ()
in (match (ses) with
| (FStar_Syntax_Syntax.Sig_inductive_typ (lex_t, [], [], t, _59_704, _59_706, [], r))::(FStar_Syntax_Syntax.Sig_datacon (lex_top, [], _t_top, _lex_t_top, _154_481, [], _59_695, r1))::(FStar_Syntax_Syntax.Sig_datacon (lex_cons, [], _t_cons, _lex_t_cons, _154_482, [], _59_684, r2))::[] when (((_154_481 = (Prims.parse_int "0")) && (_154_482 = (Prims.parse_int "0"))) && (((FStar_Ident.lid_equals lex_t FStar_Syntax_Const.lex_t_lid) && (FStar_Ident.lid_equals lex_top FStar_Syntax_Const.lextop_lid)) && (FStar_Ident.lid_equals lex_cons FStar_Syntax_Const.lexcons_lid))) -> begin
(
...
let _59_740 = (FStar_Syntax_Util.type_u ())
...
let _59_742 = (FStar_TypeChecker_Util.check_uvars r phi)
...
let _59_767 = (warn_positivity tc r)
in (

let _59_771 = (FStar_Syntax_Subst.open_term tps k)
in (match (_59_771) with
| (tps, k) -> begin
(

let _59_776 = (FStar_TypeChecker_TcTerm.tc_binders env tps)
in (match (_59_776) with
| (tps, env_tps, guard_params, us) -> begin
(

let _59_779 = (FStar_Syntax_Util.arrow_formals k)
in (match (_59_779) with
| (indices, t) -> begin
(

let _59_784 = (FStar_TypeChecker_TcTerm.tc_binders env_tps indices)
...
let _59_789 = (FStar_TypeChecker_TcTerm.tc_tot_or_gtot_term env' t)
...
let _59_796 = (FStar_Syntax_Util.type_u ())
in (match (_59_796) with
| (t_type, u) -> begin
(

let _59_797 = (let _154_524 = (FStar_TypeChecker_Rel.teq env' t t_type)
...
let positive_if_pure = (fun _59_806 l -> ())
in (
...
let tps_u_opt = (FStar_Util.find_map tcs (fun _59_827 -> (match (_59_827) with
| (se, u_tc) -> begin
...
| FStar_Syntax_Syntax.Sig_inductive_typ (_59_829, _59_831, tps, _59_834, _59_836, _59_838, _59_840, _59_842) -> begin
(FStar_All.pipe_right tps (FStar_List.map (fun _59_848 -> (match (_59_848) with
| (x, _59_847) -> begin
...
let _59_878 = (match ((let _154_541 = (FStar_Syntax_Subst.compress t)
in _154_541.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, res) -> begin
(

let _59_866 = (FStar_Util.first_N ntps bs)
...
let subst = (FStar_All.pipe_right tps (FStar_List.mapi (fun i _59_872 -> (match (_59_872) with
| (x, _59_871) -> begin
...
in (match (_59_878) with
| (arguments, result) -> begin
(

let _59_879 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _59_884 = (tc_tparams env arguments)
in (match (_59_884) with
| (arguments, env', us) -> begin
(

let _59_887 = (FStar_TypeChecker_TcTerm.tc_trivial_guard env' result)
in (match (_59_887) with
| (result, res_lcomp) -> begin
(

let _59_892 = (match ((let _154_548 = (FStar_Syntax_Subst.compress res_lcomp.FStar_Syntax_Syntax.res_typ)
in _154_548.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_type (_59_889) -> begin
()
end
| ty -> begin
...
let _59_897 = (FStar_Syntax_Util.head_and_args result)
in (match (_59_897) with
| (head, _59_896) -> begin
(

let _59_902 = (match ((let _154_554 = (FStar_Syntax_Subst.compress head)
...
let g = (FStar_List.fold_left2 (fun g _59_908 u_x -> (match (_59_908) with
| (x, _59_907) -> begin
(
...
let t = (let _154_567 = (let _154_565 = (FStar_All.pipe_right tps (FStar_List.map (fun _59_916 -> (match (_59_916) with
| (x, _59_915) -> begin
...
let _59_925 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (

let binders = (FStar_All.pipe_right tcs (FStar_List.map (fun _59_2 -> (match (_59_2) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_59_929, _59_931, tps, k, _59_935, _59_937, _59_939, _59_941) -> begin
...
| FStar_Syntax_Syntax.Sig_datacon (_59_949, _59_951, t, _59_954, _59_956, _59_958, _59_960, _59_962) -> begin
...
let _59_969 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _59_973 = (FStar_TypeChecker_Util.generalize_universes env t)
in (match (_59_973) with
| (uvs, t) -> begin
(

let _59_975 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _59_979 = (FStar_Syntax_Subst.open_univ_vars uvs t)
in (match (_59_979) with
| (uvs, t) -> begin
(

let _59_983 = (FStar_Syntax_Util.arrow_formals t)
in (match (_59_983) with
| (args, _59_982) -> begin
(

let _59_986 = (FStar_Util.first_N (FStar_List.length binders) args)
in (match (_59_986) with
| (tc_types, data_types) -> begin
(

let tcs = (FStar_List.map2 (fun _59_990 se -> (match (_59_990) with
| (x, _59_989) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (tc, _59_994, tps, _59_997, mutuals, datas, quals, r) -> begin
(

let ty = (FStar_Syntax_Subst.close_univ_vars uvs x.FStar_Syntax_Syntax.sort)
in (

let _59_1020 = (match ((let _154_588 = (FStar_Syntax_Subst.compress ty)
in _154_588.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, c) -> begin
(

let _59_1011 = (FStar_Util.first_N (FStar_List.length tps) binders)
...
| FStar_Syntax_Syntax.Sig_inductive_typ (tc, _59_1031, _59_1033, _59_1035, _59_1037, _59_1039, _59_1041, _59_1043) -> begin
((tc), (uvs_universes))
end
| _59_1047 -> begin
(FStar_All.failwith "Impossible")
end))))
in (FStar_List.map2 (fun _59_1052 d -> (match (_59_1052) with
| (t, _59_1051) -> begin
(match (d) with
| FStar_Syntax_Syntax.Sig_datacon (l, _59_1056, _59_1058, tc, ntps, quals, mutuals, r) -> begin
(
...
let _59_1078 = (FStar_All.pipe_right ses (FStar_List.partition (fun _59_5 -> (match (_59_5) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_59_1072) -> begin
true
end
| _59_1075 -> begin
false
end))))
in (match (_59_1078) with
| (tys, datas) -> begin
(

let _59_1085 = if (FStar_All.pipe_right datas (FStar_Util.for_some (fun _59_6 -> (match (_59_6) with
| FStar_Syntax_Syntax.Sig_datacon (_59_1081) -> begin
false
end
| _59_1084 -> begin
true
...
let _59_1104 = (FStar_List.fold_right (fun tc _59_1092 -> (match (_59_1092) with
| (env, all_tcs, g) -> begin
(

let _59_1097 = (tc_tycon env tc)
...
let _59_1099 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _59_1114 = (FStar_List.fold_right (fun se _59_1108 -> (match (_59_1108) with
| (datas, g) -> begin
(

let _59_1111 = (tc_data env tcs se)
in (match (_59_1111) with
| (data, g') -> begin
...
let _59_1117 = (let _154_608 = (FStar_List.map Prims.fst tcs)
...
| FStar_Syntax_Syntax.Sig_datacon (_59_1122, _59_1124, t, _59_1127, _59_1129, _59_1131, _59_1133, _59_1135) -> begin
t
end
| _59_1139 -> begin
(FStar_All.failwith "Impossible!")
...
let optimized_haseq_scheme = (fun _59_1142 -> (

let haseq_ty = (fun usubst us acc ty -> (

let _59_1169 = (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _59_1151, bs, t, _59_1155, d_lids, _59_1158, _59_1160) -> begin
((lid), (bs), (t), (d_lids))
end
| _59_1164 -> begin
(FStar_All.failwith "Impossible!")
end)
in (match (_59_1169) with
...
let _59_1174 = (FStar_Syntax_Subst.open_term bs t)
...
| FStar_Syntax_Syntax.Tm_arrow (ibs, _59_1177) -> begin
ibs
end
| _59_1181 -> begin
[]
...
let ind = (let _154_630 = (FStar_List.map (fun _59_1188 -> (match (_59_1188) with
| (bv, aq) -> begin
...
let ind = (let _154_633 = (FStar_List.map (fun _59_1192 -> (match (_59_1192) with
| (bv, aq) -> begin
...
let _59_1203 = acc
in (match (_59_1203) with
| (_59_1197, en, _59_1200, _59_1202) -> begin
(
...
in {FStar_Syntax_Syntax.n = _154_650; FStar_Syntax_Syntax.tk = _59_1214.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _59_1214.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _59_1214.FStar_Syntax_Syntax.vars}))
in (
...
| FStar_Syntax_Syntax.Sig_datacon (_59_1233, _59_1235, _59_1237, t_lid, _59_1240, _59_1242, _59_1244, _59_1246) -> begin
(t_lid = lid)
end
| _59_1250 -> begin
(FStar_All.failwith "Impossible")
...
| FStar_Syntax_Syntax.Tm_arrow (dbs, _59_1258) -> begin
(
...
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_59_1280, us, _59_1283, _59_1285, _59_1287, _59_1289, _59_1291, _59_1293) -> begin
us
end
| _59_1297 -> begin
(FStar_All.failwith "Impossible!")
...
let _59_1301 = (FStar_Syntax_Subst.univ_var_opening us)
in (match (_59_1301) with
| (usubst, us) -> begin
(
...
let _59_1303 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push "haseq")
in (

let _59_1305 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env sig_bndle)
in (

let env = (FStar_TypeChecker_Env.push_univ_vars env us)
in (

let _59_1312 = (FStar_List.fold_left (haseq_ty usubst us) (([]), (env), (FStar_Syntax_Util.t_true), (FStar_Syntax_Util.t_true)) tcs)
...
let _59_1317 = (FStar_TypeChecker_TcTerm.tc_trivial_guard env phi)
in (match (_59_1317) with
| (phi, _59_1316) -> begin
(

let _59_1318 = if (FStar_TypeChecker_Env.should_verify env) then begin
...
let ses = (FStar_List.fold_left (fun l _59_1323 -> (match (_59_1323) with
| (lid, fml) -> begin
(
...
let _59_1326 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop "haseq")
in ses)))
end)))
end))))))
end)))))
...
let unoptimized_haseq_scheme = (fun _59_1329 -> (

let mutuals = (FStar_List.map (fun ty -> (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _59_1334, _59_1336, _59_1338, _59_1340, _59_1342, _59_1344, _59_1346) -> begin
lid
end
| _59_1350 -> begin
(FStar_All.failwith "Impossible!")
...
let _59_1377 = (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _59_1359, bs, t, _59_1363, d_lids, _59_1366, _59_1368) -> begin
((lid), (bs), (t), (d_lids))
end
| _59_1372 -> begin
(FStar_All.failwith "Impossible!")
end)
in (match (_59_1377) with
| (lid, bs, t, d_lids) -> begin
(
...
let _59_1382 = (FStar_Syntax_Subst.open_term bs t)
...
| FStar_Syntax_Syntax.Tm_arrow (ibs, _59_1385) -> begin
ibs
end
| _59_1389 -> begin
[]
...
let ind = (let _154_707 = (FStar_List.map (fun _59_1396 -> (match (_59_1396) with
| (bv, aq) -> begin
...
let ind = (let _154_710 = (FStar_List.map (fun _59_1400 -> (match (_59_1400) with
| (bv, aq) -> begin
...
| FStar_Syntax_Syntax.Tm_uinst (t', _59_1411) -> begin
(is_mutual t')
end
...
| FStar_Syntax_Syntax.Tm_meta (t', _59_1424) -> begin
(is_mutual t')
end
| _59_1428 -> begin
false
...
| FStar_Syntax_Syntax.Tm_arrow (dbs, _59_1441) -> begin
(
...
let t_datas = (FStar_List.filter (fun s -> (match (s) with
| FStar_Syntax_Syntax.Sig_datacon (_59_1460, _59_1462, _59_1464, t_lid, _59_1467, _59_1469, _59_1471, _59_1473) -> begin
(t_lid = lid)
end
| _59_1477 -> begin
(FStar_All.failwith "Impossible")
...
in {FStar_Syntax_Syntax.n = _154_743; FStar_Syntax_Syntax.tk = _59_1481.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _59_1481.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _59_1481.FStar_Syntax_Syntax.vars}))
in (
...
let ty = (FStar_List.hd tcs)
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, us, _59_1494, _59_1496, _59_1498, _59_1500, _59_1502, _59_1504) -> begin
((lid), (us))
end
| _59_1508 -> begin
(FStar_All.failwith "Impossible!")
end))
in (match (_59_1511) with
| (lid, us) -> begin
(

let _59_1514 = (FStar_Syntax_Subst.univ_var_opening us)
...
let _59_1517 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push "haseq")
in (

let _59_1519 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env sig_bndle)
in (
...
let _59_1523 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop "haseq")
in (se)::[])))))))
end))
end)))))
in (

let skip_prims_type = (fun _59_1526 -> (

let lid = (

let ty = (FStar_List.hd tcs)
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _59_1531, _59_1533, _59_1535, _59_1537, _59_1539, _59_1541, _59_1543) -> begin
lid
end
| _59_1547 -> begin
(FStar_All.failwith "Impossible")
...
let _59_1559 = (FStar_TypeChecker_Util.check_sigelt_quals env se)
in (match (se) with
...
let _59_1599 = (set_options FStar_Options.Set o)
in (((se)::[]), (env)))
end
| FStar_Syntax_Syntax.ResetOptions (sopt) -> begin
(

let _59_1603 = (let _154_774 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _154_774 Prims.ignore))
in (

let _59_1608 = (match (sopt) with
| None -> begin
()
end
| Some (s) -> begin
...
let _59_1610 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (((se)::[]), (env)))))
end))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (_59_1613) -> begin
(FStar_All.failwith "impossible")
end
...
let _59_1629 = (FStar_All.pipe_right ne.FStar_Syntax_Syntax.actions (FStar_List.fold_left (fun _59_1624 a -> (match (_59_1624) with
| (env, ses) -> begin
(
...
let _59_1638 = (let _154_778 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _154_778))
in (match (_59_1638) with
| (a, wp_a_src) -> begin
(

let _59_1641 = (let _154_779 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
...
let _59_1682 = (match (((sub.FStar_Syntax_Syntax.lift), (sub.FStar_Syntax_Syntax.lift_wp))) with
| (None, None) -> begin
(FStar_All.failwith "Impossible")
end
| (lift, Some (_59_1659, lift_wp)) -> begin
...
let _59_1675 = (FStar_TypeChecker_DMFF.star_expr dmff_env lift)
in (match (_59_1675) with
| (_59_1672, lift_wp, lift_elab) -> begin
(

let _59_1676 = (recheck_debug "lift-wp" env lift_wp)
in (

let _59_1678 = (recheck_debug "lift-elab" env lift_elab)
...
let _59_1684 = env
in {FStar_TypeChecker_Env.solver = _59_1684.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_1684.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_1684.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_1684.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_1684.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_1684.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_1684.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_1684.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_1684.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_1684.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_1684.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_1684.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_1684.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _59_1684.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _59_1684.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_1684.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_1684.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_1684.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = _59_1684.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_1684.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_1684.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_1684.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_1684.FStar_TypeChecker_Env.qname_and_index})
in (
...
| Some (_59_1689, lift) -> begin
(

let _59_1695 = (let _154_809 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
...
let _59_1709 = (FStar_TypeChecker_TcTerm.tc_tot_or_gtot_term env expected_k)
in (match (_59_1709) with
| (expected_k, _59_1706, _59_1708) -> begin
(
...
let _59_1712 = env
in {FStar_TypeChecker_Env.solver = _59_1712.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_1712.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_1712.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_1712.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_1712.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_1712.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_1712.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_1712.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_1712.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_1712.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_1712.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_1712.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_1712.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _59_1712.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _59_1712.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_1712.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_1712.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_1712.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax; FStar_TypeChecker_Env.lax_universes = _59_1712.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_1712.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_1712.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_1712.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_1712.FStar_TypeChecker_Env.qname_and_index})
in (

let sub = (

let _59_1715 = sub
in {FStar_Syntax_Syntax.source = _59_1715.FStar_Syntax_Syntax.source; FStar_Syntax_Syntax.target = _59_1715.FStar_Syntax_Syntax.target; FStar_Syntax_Syntax.lift_wp = Some (lift_wp); FStar_Syntax_Syntax.lift = lift})
in (
...
let _59_1734 = (FStar_Syntax_Subst.open_comp tps c)
in (match (_59_1734) with
| (tps, c) -> begin
(

let _59_1738 = (tc_tparams env tps)
in (match (_59_1738) with
| (tps, env, us) -> begin
(

let _59_1742 = (FStar_TypeChecker_TcTerm.tc_comp env c)
in (match (_59_1742) with
| (c, u, g) -> begin
(

let _59_1743 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (
...
let _59_1749 = (let _154_824 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _154_824))
in (match (_59_1749) with
| (uvs, t) -> begin
(

let _59_1768 = (match ((let _154_826 = (let _154_825 = (FStar_Syntax_Subst.compress t)
in _154_825.FStar_Syntax_Syntax.n)
in ((tps), (_154_826)))) with
| ([], FStar_Syntax_Syntax.Tm_arrow (_59_1752, c)) -> begin
(([]), (c))
end
| (_59_1758, FStar_Syntax_Syntax.Tm_arrow (tps, c)) -> begin
((tps), (c))
end
| _59_1765 -> begin
(FStar_All.failwith "Impossible")
end)
in (match (_59_1768) with
| (tps, c) -> begin
(

let _59_1773 = if (((FStar_List.length uvs) <> (Prims.parse_int "1")) && (not ((FStar_Ident.lid_equals lid FStar_Syntax_Const.effect_Lemma_lid)))) then begin
(

let _59_1772 = (FStar_Syntax_Subst.open_univ_vars uvs t)
...
let _59_1789 = (let _154_834 = (let _154_833 = (FStar_Syntax_Util.type_u ())
...
let _59_1809 = (FStar_TypeChecker_TcTerm.tc_term env e)
in (match (_59_1809) with
| (e, c, g1) -> begin
(

let _59_1814 = (let _154_838 = (let _154_835 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_154_835))
...
let _59_1815 = (let _154_839 = (FStar_TypeChecker_Rel.conj_guard g1 g)
...
let _59_1859 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.fold_left (fun _59_1836 lb -> (match (_59_1836) with
...
let _59_1855 = (match ((FStar_TypeChecker_Env.try_lookup_val_decl env lbname.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)) with
| None -> begin
((gen), (lb), (quals_opt))
end
...
let _59_1850 = (match (lb.FStar_Syntax_Syntax.lbtyp.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
()
end
| _59_1849 -> begin
...
let _59_1902 = (match ((FStar_TypeChecker_TcTerm.tc_maybe_toplevel_term (

let _59_1872 = env
in {FStar_TypeChecker_Env.solver = _59_1872.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_1872.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_1872.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_1872.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_1872.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_1872.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_1872.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_1872.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_1872.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_1872.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_1872.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = should_generalize; FStar_TypeChecker_Env.letrecs = _59_1872.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _59_1872.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_1872.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_1872.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_1872.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _59_1872.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_1872.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_1872.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_1872.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_1872.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_1872.FStar_TypeChecker_Env.qname_and_index}) e)) with
| ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let (lbs, e); FStar_Syntax_Syntax.tk = _59_1879; FStar_Syntax_Syntax.pos = _59_1877; FStar_Syntax_Syntax.vars = _59_1875}, _59_1886, g) when (FStar_TypeChecker_Rel.is_trivial g) -> begin
(

let quals = (match (e.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_meta (_59_1890, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect)) -> begin
...
in (match (_59_1902) with
| (se, lbs) -> begin
(

let _59_1908 = if (log env) then begin
...
in (match (se) with
| FStar_Syntax_Syntax.Sig_pragma (_59_1930) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_inductive_typ (_)) | (FStar_Syntax_Syntax.Sig_datacon (_)) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _59_1941, r) -> begin
if (is_abstract quals) then begin
(FStar_List.fold_right (fun se _59_1948 -> (match (_59_1948) with
| (out, hidden) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, us, bs, t, _59_1954, _59_1956, quals, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (l, us, t, _59_1966, _59_1968, _59_1970, _59_1972, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_assume (_59_1980, _59_1982, quals, _59_1985) -> begin
if (is_abstract quals) then begin
(([]), (hidden))
end else begin
(((se)::[]), (hidden))
...
| FStar_Syntax_Syntax.Sig_main (_59_2006) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_new_effect (_)) | (FStar_Syntax_Syntax.Sig_new_effect_for_free (_)) | (FStar_Syntax_Syntax.Sig_sub_effect (_)) | (FStar_Syntax_Syntax.Sig_effect_abbrev (_)) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), _59_2025, _59_2027, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some is_hidden_proj_or_disc)) -> begin
(
...
let process_one_decl = (fun _59_2048 se -> (match (_59_2048) with
| (ses, exports, env, hidden) -> begin
(

let _59_2050 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _59_2054 = (tc_decl env se)
in (match (_59_2054) with
| (ses', env) -> begin
(

let _59_2057 = if ((FStar_Options.log_types ()) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("LogTypes")))) then begin
...
let _59_2060 = (FStar_List.iter (fun se -> (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env se)) ses')
in (

let _59_2069 = (FStar_List.fold_left (fun _59_2064 se -> (match (_59_2064) with
| (le, lh) -> begin
(
...
let _59_2099 = (FStar_List.fold_left (fun acc se -> (match (se) with
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ne, r) -> begin
(

let _59_2083 = acc
in (match (_59_2083) with
| (_59_2077, _59_2079, env, _59_2082) -> begin
(

let _59_2087 = (cps_and_elaborate env ne)
...
in (match (_59_2099) with
| (ses, exports, env, _59_2098) -> begin
...
in {FStar_TypeChecker_Env.solver = _59_2104.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2104.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2104.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2104.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2104.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2104.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2104.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2104.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2104.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2104.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2104.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2104.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2104.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _59_2104.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _59_2104.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2104.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = modul.FStar_Syntax_Syntax.is_interface; FStar_TypeChecker_Env.admit = _154_912; FStar_TypeChecker_Env.lax = _59_2104.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_2104.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_2104.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2104.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2104.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2104.FStar_TypeChecker_Env.qname_and_index}))
in (

let _59_2107 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push msg)
in (

let env = (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name)
in (

let _59_2113 = (tc_decls env modul.FStar_Syntax_Syntax.declarations)
in (match (_59_2113) with
| (ses, exports, env) -> begin
(((

let _59_2114 = modul
in {FStar_Syntax_Syntax.name = _59_2114.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = ses; FStar_Syntax_Syntax.exports = _59_2114.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _59_2114.FStar_Syntax_Syntax.is_interface})), (exports), (env))
end))))))))


let tc_more_partial_modul : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_Syntax_Syntax.modul * FStar_Syntax_Syntax.sigelt Prims.list * FStar_TypeChecker_Env.env) = (fun env modul decls -> (

let _59_2122 = (tc_decls env decls)
...
let _59_2123 = modul
in {FStar_Syntax_Syntax.name = _59_2123.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = (FStar_List.append modul.FStar_Syntax_Syntax.declarations ses); FStar_Syntax_Syntax.exports = _59_2123.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _59_2123.FStar_Syntax_Syntax.is_interface})
...
let _59_2129 = env
in {FStar_TypeChecker_Env.solver = _59_2129.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2129.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2129.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2129.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2129.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2129.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2129.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2129.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2129.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2129.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2129.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2129.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2129.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _59_2129.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2129.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_2129.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_2129.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = true; FStar_TypeChecker_Env.type_of = _59_2129.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2129.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2129.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2129.FStar_TypeChecker_Env.qname_and_index})
in (

let check_term = (fun lid univs t -> (

let _59_2138 = (FStar_Syntax_Subst.open_univ_vars univs t)
in (match (_59_2138) with
| (univs, t) -> begin
(

let _59_2140 = if (let _154_932 = (let _154_931 = (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name)
...
let _59_2147 = (let _154_947 = (let _154_946 = (FStar_Syntax_Print.lid_to_string modul.FStar_Syntax_Syntax.name)
...
let _59_2149 = (check_term lid univs t)
...
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _59_2156, _59_2158) -> begin
...
| FStar_Syntax_Syntax.Sig_inductive_typ (l, univs, binders, typ, _59_2166, _59_2168, _59_2170, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (l, univs, t, _59_2179, _59_2181, _59_2183, _59_2185, _59_2187) -> begin
(check_term l univs t)
end
| FStar_Syntax_Syntax.Sig_declare_typ (l, univs, t, quals, _59_2195) -> begin
if (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private)))) then begin
(check_term l univs t)
end else begin
()
...
| FStar_Syntax_Syntax.Sig_let ((_59_2199, lbs), _59_2203, _59_2205, quals) -> begin
if (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private)))) then begin
...
let _59_2241 = modul
in {FStar_Syntax_Syntax.name = _59_2241.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = _59_2241.FStar_Syntax_Syntax.declarations; FStar_Syntax_Syntax.exports = exports; FStar_Syntax_Syntax.is_interface = modul.FStar_Syntax_Syntax.is_interface})
in (

let env = (FStar_TypeChecker_Env.finish_module env modul)
in (

let _59_2245 = (check_exports env modul exports)
in (

let _59_2247 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop (Prims.strcat "Ending modul " modul.FStar_Syntax_Syntax.name.FStar_Ident.str))
in (

let _59_2249 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_modul env modul)
in (

let _59_2251 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (

let _59_2253 = (let _154_960 = (FStar_Options.restore_cmd_line_options true)
...
let _59_2260 = (tc_partial_modul env modul)
...
let _59_2263 = if (FStar_Options.debug_any ()) then begin
...
let _59_2267 = (tc_modul env m)
in (match (_59_2267) with
| (m, env) -> begin
(

let _59_2268 = if (FStar_Options.dump_module m.FStar_Syntax_Syntax.name.FStar_Ident.str) then begin
