...
let _57_1637 = (let _147_608 = (FStar_All.pipe_right exps (FStar_List.map (fun e -> (
...
let _57_1615 = (let _147_591 = (FStar_TypeChecker_Rel.discharge_guard env (
...
in (FStar_All.pipe_right _147_595 (FStar_List.map (fun _57_1623 -> (match (_57_1623) with
| (u, _57_1622) -> begin
...
let _57_1631 = if (let _147_597 = (FStar_Util.set_is_subset_of uvs1 uvs2)
...
in (let _147_601 = (let _147_600 = (FStar_All.pipe_right unresolved (FStar_List.map (fun _57_1630 -> (match (_57_1630) with
| (u, _57_1629) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end))))
...
let _57_1644 = (let _147_609 = (FStar_TypeChecker_Env.push_bv env scrutinee)
...
let _57_1657 = (let _147_610 = (FStar_TypeChecker_Env.set_expected_typ pat_env FStar_TypeChecker_Common.t_bool)
...
let sub_term_guards = (let _147_662 = (FStar_All.pipe_right args (FStar_List.mapi (fun i _57_1784 -> (match (_57_1784) with
| (ei, _57_1783) -> begin
(
...
let _57_1838 = (let _147_678 = (let _147_677 = (let _147_676 = (let _147_675 = (c1.FStar_Syntax_Syntax.comp ())
...
let _57_1879 = (let _147_687 = (let _147_686 = (FStar_TypeChecker_Env.clear_expected_typ env)
...
let _57_1886 = (let _147_689 = (let _147_688 = (FStar_Syntax_Syntax.mk_binder x)
in (_147_688)::[])
...
let _57_1892 = (let _147_690 = (FStar_TypeChecker_Env.push_bv env x)
...
let g_lbs = (let _147_701 = (FStar_TypeChecker_Rel.solve_deferred_constraints env g_lbs)
in (FStar_All.pipe_right _147_701 FStar_TypeChecker_Rel.resolve_implicits))
in (

let all_lb_names = (let _147_704 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (FStar_Util.right lb.FStar_Syntax_Syntax.lbname))))
in (FStar_All.pipe_right _147_704 (fun _147_703 -> Some (_147_703))))
in (
...
let ecs = (let _147_708 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (let _147_707 = (FStar_Syntax_Syntax.mk_Total lb.FStar_Syntax_Syntax.lbtyp)
in (lb.FStar_Syntax_Syntax.lbname, lb.FStar_Syntax_Syntax.lbdef, _147_707)))))
in (FStar_TypeChecker_Util.generalize env _147_708))
...
let cres = (let _147_710 = (FStar_Syntax_Syntax.mk_Total FStar_TypeChecker_Common.t_unit)
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _147_710))
in (
...
| (lbs, e2) -> begin
(let _147_712 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_let (((true, lbs), e2))) (Some (FStar_TypeChecker_Common.t_unit.FStar_Syntax_Syntax.n)) top.FStar_Syntax_Syntax.pos)
in (let _147_711 = (FStar_TypeChecker_Rel.discharge_guard env g_lbs)
in (_147_712, cres, _147_711)))
end)))))))
end))
end))
end))
...
let _57_2045 = (let _147_729 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (

let _57_2039 = (let _147_728 = (FStar_TypeChecker_Env.set_expected_typ env lb.FStar_Syntax_Syntax.lbtyp)
in (tc_tot_or_gtot_term _147_728 lb.FStar_Syntax_Syntax.lbdef))
...
in (FStar_All.pipe_right _147_729 FStar_List.unzip))
...
let _57_2071 = (let _147_736 = (FStar_TypeChecker_Env.set_range env1 e1.FStar_Syntax_Syntax.pos)
in (FStar_TypeChecker_Util.strengthen_precondition (Some ((fun _57_2068 -> (match (()) with
| () -> begin
FStar_TypeChecker_Errors.ill_kinded_type
end)))) _147_736 e1 c1 wf_annot))
...
(let _147_737 = (FStar_TypeChecker_Rel.guard_to_string env g1)
in (FStar_Util.print1 "checked top-level def, guard is %s\n" _147_737))
end else begin
()
end
in (let _147_738 = (FStar_Option.isSome topt)
in (e1, univ_vars, c1, g1, _147_738))))
end))
end)))
end)))
end)))
...
(let _147_742 = (FStar_TypeChecker_Env.set_expected_typ env1 t)
in (Some (t), FStar_TypeChecker_Rel.trivial_guard, univ_vars, _147_742))
end else begin
(
...
(let _147_745 = (let _147_743 = (FStar_Syntax_Syntax.range_of_lbname lb.FStar_Syntax_Syntax.lbname)
in (FStar_Range.string_of_range _147_743))
in (let _147_744 = (FStar_Syntax_Print.term_to_string t)
...
let t = (norm env1 t)
in (let _147_746 = (FStar_TypeChecker_Env.set_expected_typ env1 t)
in (Some (t), g, univ_vars, _147_746))))
end))
end))
end)
end))
...
(let _147_750 = (FStar_Syntax_Print.bv_to_string (Prims.fst x))
in (let _147_749 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print2 "Pushing binder %s at type %s\n" _147_750 _147_749)))
end else begin
()
end
in (let _147_751 = (maybe_push_binding env x)
in (x, _147_751, g, u))))
end))
end))
end))
...
| (bs, env', g', us) -> begin
(let _147_759 = (let _147_758 = (FStar_TypeChecker_Rel.close_guard ((b)::[]) g')
in (FStar_TypeChecker_Rel.conj_guard g _147_758))
in ((b)::bs, env', _147_759, (u)::us))
end))
end))
end))
in (aux env bs)))
...
| (args, g') -> begin
(let _147_771 = (FStar_TypeChecker_Rel.conj_guard g g')
in ((args)::pats, _147_771))
end))
...
(let _147_774 = (FStar_Syntax_Print.comp_to_string c)
...
(let _147_775 = (FStar_Syntax_Syntax.mk_Total (FStar_Syntax_Util.comp_result c))
in (_147_775, false))
end else begin
(let _147_776 = (FStar_Syntax_Syntax.mk_GTotal (FStar_Syntax_Util.comp_result c))
in (_147_776, true))
end
...
in (e, (FStar_Syntax_Util.lcomp_of_comp target_comp), _147_777))
end
| _57_2176 -> begin
if allow_ghost then begin
(let _147_780 = (let _147_779 = (let _147_778 = (FStar_TypeChecker_Errors.expected_ghost_expression e c)
in (_147_778, e.FStar_Syntax_Syntax.pos))
in FStar_Syntax_Syntax.Error (_147_779))
in (Prims.raise _147_780))
end else begin
(let _147_783 = (let _147_782 = (let _147_781 = (FStar_TypeChecker_Errors.expected_pure_expression e c)
in (_147_781, e.FStar_Syntax_Syntax.pos))
in FStar_Syntax_Syntax.Error (_147_782))
in (Prims.raise _147_783))
end
end)
end))))))
end
...
let check_and_gen : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.typ  ->  FStar_Syntax_Syntax.tscheme = (fun env t k -> (let _147_803 = (tc_check_trivial_guard env t k)
in (FStar_TypeChecker_Util.generalize_universes env _147_803)))


let check_nogen = (fun env t k -> (

let t = (tc_check_trivial_guard env t k)
in (let _147_807 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env t)
in ([], _147_807))))
...
| () -> begin
(let _147_822 = (let _147_821 = (let _147_820 = (FStar_TypeChecker_Errors.unexpected_signature_for_monad env m s)
in (_147_820, (FStar_Ident.range_of_lid m)))
in FStar_Syntax_Syntax.Error (_147_821))
in (Prims.raise _147_822))
end))
in (
...
| (uvs, t') -> begin
(match ((let _147_829 = (FStar_Syntax_Subst.compress t')
...
let fail = (fun t -> (let _147_840 = (let _147_839 = (let _147_838 = (FStar_TypeChecker_Errors.unexpected_signature_for_monad env mname t)
in (_147_838, (FStar_Ident.range_of_lid mname)))
in FStar_Syntax_Syntax.Error (_147_839))
in (Prims.raise _147_840)))
in (match ((let _147_841 = (FStar_Syntax_Subst.compress signature)
in _147_841.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(
...
let _57_2303 = ed
in (let _147_860 = (op ed.FStar_Syntax_Syntax.ret)
in (let _147_859 = (op ed.FStar_Syntax_Syntax.bind_wp)
in (let _147_858 = (op ed.FStar_Syntax_Syntax.bind_wlp)
in (let _147_857 = (op ed.FStar_Syntax_Syntax.if_then_else)
in (let _147_856 = (op ed.FStar_Syntax_Syntax.ite_wp)
in (let _147_855 = (op ed.FStar_Syntax_Syntax.ite_wlp)
in (let _147_854 = (op ed.FStar_Syntax_Syntax.wp_binop)
in (let _147_853 = (op ed.FStar_Syntax_Syntax.wp_as_type)
in (let _147_852 = (op ed.FStar_Syntax_Syntax.close_wp)
in (let _147_851 = (op ed.FStar_Syntax_Syntax.assert_p)
in (let _147_850 = (op ed.FStar_Syntax_Syntax.assume_p)
in (let _147_849 = (op ed.FStar_Syntax_Syntax.null_wp)
in (let _147_848 = (op ed.FStar_Syntax_Syntax.trivial)
in {FStar_Syntax_Syntax.qualifiers = _57_2303.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _57_2303.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = _57_2303.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = _57_2303.FStar_Syntax_Syntax.binders; FStar_Syntax_Syntax.signature = _57_2303.FStar_Syntax_Syntax.signature; FStar_Syntax_Syntax.ret = _147_860; FStar_Syntax_Syntax.bind_wp = _147_859; FStar_Syntax_Syntax.bind_wlp = _147_858; FStar_Syntax_Syntax.if_then_else = _147_857; FStar_Syntax_Syntax.ite_wp = _147_856; FStar_Syntax_Syntax.ite_wlp = _147_855; FStar_Syntax_Syntax.wp_binop = _147_854; FStar_Syntax_Syntax.wp_as_type = _147_853; FStar_Syntax_Syntax.close_wp = _147_852; FStar_Syntax_Syntax.assert_p = _147_851; FStar_Syntax_Syntax.assume_p = _147_850; FStar_Syntax_Syntax.null_wp = _147_849; FStar_Syntax_Syntax.trivial = _147_848}))))))))))))))))
end)
in (ed, a, wp))
end)))
...
let n = (match ((let _147_882 = (FStar_Syntax_Subst.compress tm)
in _147_882.FStar_Syntax_Syntax.n)) with
...
let _57_2345 = bv
in (let _147_884 = (visit_term bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _57_2345.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _57_2345.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _147_884}))
in (let _147_885 = (FStar_Syntax_Syntax.as_implicit false)
in (_147_886, _147_885)))
end))
and visit_maybe_lcomp = (fun lcomp -> (match (lcomp) with
| Some (FStar_Util.Inl (lcomp)) -> begin
(let _147_891 = (let _147_890 = (let _147_889 = (let _147_888 = (lcomp.FStar_Syntax_Syntax.comp ())
in (visit_comp _147_888))
in (FStar_Syntax_Util.lcomp_of_comp _147_889))
in FStar_Util.Inl (_147_890))
in Some (_147_891))
end
| comp -> begin
comp
...
in FStar_Syntax_Syntax.Total (_147_893))
end
| FStar_Syntax_Syntax.GTotal (tm) -> begin
(let _147_894 = (visit_term tm)
in FStar_Syntax_Syntax.GTotal (_147_894))
end
| comp -> begin
comp
end)
...
let _57_2368 = (let _147_902 = (FStar_Syntax_Print.term_to_string t)
...
let _57_2384 = (let _147_905 = (let _147_904 = (normalize res_typ)
in (FStar_Syntax_Print.term_to_string _147_904))
in (FStar_Util.print2 "Inferred type for %s: %s\n" str _147_905))
in (let _147_907 = (let _147_906 = (normalize e)
...
let rec collect_binders = (fun t -> (match ((let _147_910 = (FStar_Syntax_Subst.compress t)
in _147_910.FStar_Syntax_Syntax.n)) with
...
in (let _147_911 = (collect_binders rest)
in (FStar_List.append bs _147_911)))
end
...
let wp_binders = (let _147_918 = (normalize wp_a)
in (collect_binders _147_918))
in ((fun t -> (let _147_924 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow wp_binders _147_924))), (fun t -> (let _147_927 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.arrow wp_binders _147_927))), (fun _57_2406 -> (match (()) with
| () -> begin
(FStar_List.map (fun _57_2410 -> (match (_57_2410) with
| (bv, _57_2409) -> begin
(

let _57_2411 = (let _147_931 = ((FStar_ST.read i) + 1)
in (FStar_ST.op_Colon_Equals i _147_931))
in (let _147_934 = (let _147_933 = (let _147_932 = (FStar_ST.read i)
in (FStar_Util.string_of_int _147_932))
in (Prims.strcat "g" _147_933))
in (FStar_Syntax_Syntax.gen_bv _147_934 None bv.FStar_Syntax_Syntax.sort)))
end)) wp_binders)
end)))))
...
| (t, b) -> begin
(let _147_940 = (FStar_Syntax_Syntax.as_implicit b)
in (t, _147_940))
end)))
in (

let implicit_binders_of_list = (FStar_List.map (fun t -> (let _147_943 = (FStar_Syntax_Syntax.as_implicit true)
in (t, _147_943))))
in (

let args_of_bv = (FStar_List.map (fun bv -> (let _147_946 = (FStar_Syntax_Syntax.bv_to_name bv)
in (FStar_Syntax_Syntax.as_arg _147_946))))
in (
...
let x = (let _147_947 = (FStar_Syntax_Syntax.bv_to_name t)
in (FStar_Syntax_Syntax.gen_bv "x" None _147_947))
in (

let ret = (let _147_952 = (let _147_951 = (let _147_950 = (let _147_949 = (let _147_948 = (FStar_Syntax_Syntax.bv_to_name t)
in (mk_ctx _147_948))
in (FStar_Syntax_Syntax.mk_Total _147_949))
in (FStar_Syntax_Util.lcomp_of_comp _147_950))
in FStar_Util.Inl (_147_951))
in Some (_147_952))
in (
...
let body = (let _147_954 = (implicit_binders_of_list gamma)
in (let _147_953 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Util.abs _147_954 _147_953 ret)))
in (let _147_955 = (binders_of_list (((t, true))::((x, false))::[]))
in (FStar_Syntax_Util.abs _147_955 body ret)))))))
in (

let _57_2431 = (let _147_959 = (let _147_958 = (let _147_957 = (let _147_956 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_956)::[])
in (FStar_List.append binders _147_957))
in (FStar_Syntax_Util.abs _147_958 c_pure None))
in (check "pure" _147_959))
in (
...
let l = (let _147_967 = (let _147_966 = (let _147_965 = (let _147_962 = (let _147_961 = (let _147_960 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.new_bv None _147_960))
in (FStar_Syntax_Syntax.mk_binder _147_961))
in (_147_962)::[])
in (let _147_964 = (let _147_963 = (FStar_Syntax_Syntax.bv_to_name t2)
in (FStar_Syntax_Syntax.mk_GTotal _147_963))
in (FStar_Syntax_Util.arrow _147_965 _147_964)))
in (mk_gctx _147_966))
in (FStar_Syntax_Syntax.gen_bv "l" None _147_967))
in (

let r = (let _147_969 = (let _147_968 = (FStar_Syntax_Syntax.bv_to_name t1)
in (mk_gctx _147_968))
in (FStar_Syntax_Syntax.gen_bv "r" None _147_969))
in (

let ret = (let _147_974 = (let _147_973 = (let _147_972 = (let _147_971 = (let _147_970 = (FStar_Syntax_Syntax.bv_to_name t2)
in (mk_gctx _147_970))
in (FStar_Syntax_Syntax.mk_Total _147_971))
in (FStar_Syntax_Util.lcomp_of_comp _147_972))
in FStar_Util.Inl (_147_973))
in Some (_147_974))
in (
...
let inner_body = (let _147_980 = (FStar_Syntax_Syntax.bv_to_name l)
in (let _147_979 = (let _147_978 = (let _147_977 = (let _147_976 = (let _147_975 = (FStar_Syntax_Syntax.bv_to_name r)
in (FStar_Syntax_Util.mk_app _147_975 gamma_as_args))
in (FStar_Syntax_Syntax.as_arg _147_976))
in (_147_977)::[])
in (FStar_List.append gamma_as_args _147_978))
in (FStar_Syntax_Util.mk_app _147_980 _147_979)))
in (let _147_981 = (implicit_binders_of_list gamma)
in (FStar_Syntax_Util.abs _147_981 inner_body ret)))))
in (let _147_982 = (binders_of_list (((t1, true))::((t2, true))::((l, false))::((r, false))::[]))
in (FStar_Syntax_Util.abs _147_982 outer_body ret))))))))
in (

let _57_2443 = (let _147_986 = (let _147_985 = (let _147_984 = (let _147_983 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_983)::[])
in (FStar_List.append binders _147_984))
in (FStar_Syntax_Util.abs _147_985 c_app None))
in (check "app" _147_986))
in (
...
let t_f = (let _147_991 = (let _147_988 = (let _147_987 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.null_binder _147_987))
in (_147_988)::[])
in (let _147_990 = (let _147_989 = (FStar_Syntax_Syntax.bv_to_name t2)
in (FStar_Syntax_Syntax.mk_GTotal _147_989))
in (FStar_Syntax_Util.arrow _147_991 _147_990)))
in (

let f = (FStar_Syntax_Syntax.gen_bv "f" None t_f)
in (

let a1 = (let _147_993 = (let _147_992 = (FStar_Syntax_Syntax.bv_to_name t1)
in (mk_gctx _147_992))
in (FStar_Syntax_Syntax.gen_bv "a1" None _147_993))
in (

let ret = (let _147_998 = (let _147_997 = (let _147_996 = (let _147_995 = (let _147_994 = (FStar_Syntax_Syntax.bv_to_name t2)
in (mk_gctx _147_994))
in (FStar_Syntax_Syntax.mk_Total _147_995))
in (FStar_Syntax_Util.lcomp_of_comp _147_996))
in FStar_Util.Inl (_147_997))
in Some (_147_998))
in (let _147_1011 = (binders_of_list (((t1, true))::((t2, true))::((f, false))::((a1, false))::[]))
in (let _147_1010 = (let _147_1009 = (let _147_1008 = (let _147_1007 = (let _147_1006 = (let _147_1005 = (let _147_1002 = (let _147_1001 = (let _147_1000 = (let _147_999 = (FStar_Syntax_Syntax.bv_to_name f)
in (_147_999)::[])
in (unknown)::_147_1000)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1001))
in (FStar_Syntax_Util.mk_app c_pure _147_1002))
in (let _147_1004 = (let _147_1003 = (FStar_Syntax_Syntax.bv_to_name a1)
in (_147_1003)::[])
in (_147_1005)::_147_1004))
in (unknown)::_147_1006)
in (unknown)::_147_1007)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1008))
in (FStar_Syntax_Util.mk_app c_app _147_1009))
in (FStar_Syntax_Util.abs _147_1011 _147_1010 ret)))))))))
in (

let _57_2453 = (let _147_1015 = (let _147_1014 = (let _147_1013 = (let _147_1012 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1012)::[])
in (FStar_List.append binders _147_1013))
in (FStar_Syntax_Util.abs _147_1014 c_lift1 None))
in (check "lift1" _147_1015))
in (
...
let t_f = (let _147_1023 = (let _147_1020 = (let _147_1016 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.null_binder _147_1016))
in (let _147_1019 = (let _147_1018 = (let _147_1017 = (FStar_Syntax_Syntax.bv_to_name t2)
in (FStar_Syntax_Syntax.null_binder _147_1017))
in (_147_1018)::[])
in (_147_1020)::_147_1019))
in (let _147_1022 = (let _147_1021 = (FStar_Syntax_Syntax.bv_to_name t3)
in (FStar_Syntax_Syntax.mk_GTotal _147_1021))
in (FStar_Syntax_Util.arrow _147_1023 _147_1022)))
in (

let f = (FStar_Syntax_Syntax.gen_bv "f" None t_f)
in (

let a1 = (let _147_1025 = (let _147_1024 = (FStar_Syntax_Syntax.bv_to_name t1)
in (mk_gctx _147_1024))
in (FStar_Syntax_Syntax.gen_bv "a1" None _147_1025))
in (

let a2 = (let _147_1027 = (let _147_1026 = (FStar_Syntax_Syntax.bv_to_name t2)
in (mk_gctx _147_1026))
in (FStar_Syntax_Syntax.gen_bv "a2" None _147_1027))
in (

let ret = (let _147_1032 = (let _147_1031 = (let _147_1030 = (let _147_1029 = (let _147_1028 = (FStar_Syntax_Syntax.bv_to_name t3)
in (mk_gctx _147_1028))
in (FStar_Syntax_Syntax.mk_Total _147_1029))
in (FStar_Syntax_Util.lcomp_of_comp _147_1030))
in FStar_Util.Inl (_147_1031))
in Some (_147_1032))
in (let _147_1052 = (binders_of_list (((t1, true))::((t2, true))::((t3, true))::((f, false))::((a1, false))::((a2, false))::[]))
in (let _147_1051 = (let _147_1050 = (let _147_1049 = (let _147_1048 = (let _147_1047 = (let _147_1046 = (let _147_1043 = (let _147_1042 = (let _147_1041 = (let _147_1040 = (let _147_1039 = (let _147_1036 = (let _147_1035 = (let _147_1034 = (let _147_1033 = (FStar_Syntax_Syntax.bv_to_name f)
in (_147_1033)::[])
in (unknown)::_147_1034)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1035))
in (FStar_Syntax_Util.mk_app c_pure _147_1036))
in (let _147_1038 = (let _147_1037 = (FStar_Syntax_Syntax.bv_to_name a1)
in (_147_1037)::[])
in (_147_1039)::_147_1038))
in (unknown)::_147_1040)
in (unknown)::_147_1041)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1042))
in (FStar_Syntax_Util.mk_app c_app _147_1043))
in (let _147_1045 = (let _147_1044 = (FStar_Syntax_Syntax.bv_to_name a2)
in (_147_1044)::[])
in (_147_1046)::_147_1045))
in (unknown)::_147_1047)
in (unknown)::_147_1048)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1049))
in (FStar_Syntax_Util.mk_app c_app _147_1050))
in (FStar_Syntax_Util.abs _147_1052 _147_1051 ret)))))))))))
in (

let _57_2464 = (let _147_1056 = (let _147_1055 = (let _147_1054 = (let _147_1053 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1053)::[])
in (FStar_List.append binders _147_1054))
in (FStar_Syntax_Util.abs _147_1055 c_lift2 None))
in (check "lift2" _147_1056))
in (
...
let t_f = (let _147_1062 = (let _147_1058 = (let _147_1057 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.null_binder _147_1057))
in (_147_1058)::[])
in (let _147_1061 = (let _147_1060 = (let _147_1059 = (FStar_Syntax_Syntax.bv_to_name t2)
in (mk_gctx _147_1059))
in (FStar_Syntax_Syntax.mk_Total _147_1060))
...
let ret = (let _147_1072 = (let _147_1071 = (let _147_1070 = (let _147_1069 = (let _147_1068 = (let _147_1067 = (let _147_1064 = (let _147_1063 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.null_binder _147_1063))
in (_147_1064)::[])
in (let _147_1066 = (let _147_1065 = (FStar_Syntax_Syntax.bv_to_name t2)
in (FStar_Syntax_Syntax.mk_GTotal _147_1065))
in (FStar_Syntax_Util.arrow _147_1067 _147_1066)))
in (mk_ctx _147_1068))
in (FStar_Syntax_Syntax.mk_Total _147_1069))
in (FStar_Syntax_Util.lcomp_of_comp _147_1070))
in FStar_Util.Inl (_147_1071))
in Some (_147_1072))
in (

let e1 = (let _147_1073 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.gen_bv "e1" None _147_1073))
in (

let gamma = (mk_gamma ())
in (

let body = (let _147_1083 = (let _147_1076 = (FStar_Syntax_Syntax.binders_of_list gamma)
in (let _147_1075 = (let _147_1074 = (FStar_Syntax_Syntax.mk_binder e1)
in (_147_1074)::[])
in (FStar_List.append _147_1076 _147_1075)))
in (let _147_1082 = (let _147_1081 = (FStar_Syntax_Syntax.bv_to_name f)
in (let _147_1080 = (let _147_1079 = (let _147_1077 = (FStar_Syntax_Syntax.bv_to_name e1)
in (FStar_Syntax_Syntax.as_arg _147_1077))
in (let _147_1078 = (args_of_bv gamma)
in (_147_1079)::_147_1078))
in (FStar_Syntax_Util.mk_app _147_1081 _147_1080)))
in (FStar_Syntax_Util.abs _147_1083 _147_1082 ret)))
in (let _147_1084 = (binders_of_list (((t1, true))::((t2, true))::((f, false))::[]))
in (FStar_Syntax_Util.abs _147_1084 body ret))))))))))
in (

let _57_2475 = (let _147_1088 = (let _147_1087 = (let _147_1086 = (let _147_1085 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1085)::[])
in (FStar_List.append binders _147_1086))
in (FStar_Syntax_Util.abs _147_1087 c_push None))
in (check "push" _147_1088))
in (

let ret_tot_wp_a = (let _147_1091 = (let _147_1090 = (let _147_1089 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.lcomp_of_comp _147_1089))
in FStar_Util.Inl (_147_1090))
in Some (_147_1091))
in (
...
in (let _147_1102 = (FStar_Syntax_Syntax.binders_of_list ((a)::(c)::[]))
in (let _147_1101 = (

let l_ite = (FStar_Syntax_Syntax.fvar FStar_Syntax_Const.ite_lid (FStar_Syntax_Syntax.Delta_unfoldable (2)) None)
in (let _147_1100 = (let _147_1099 = (let _147_1098 = (let _147_1097 = (let _147_1096 = (let _147_1095 = (let _147_1094 = (let _147_1093 = (let _147_1092 = (FStar_Syntax_Syntax.bv_to_name c)
in (FStar_Syntax_Syntax.as_arg _147_1092))
in (_147_1093)::[])
in (FStar_Syntax_Util.mk_app l_ite _147_1094))
in (_147_1095)::[])
in (unknown)::_147_1096)
in (unknown)::_147_1097)
in (unknown)::_147_1098)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1099))
in (FStar_Syntax_Util.mk_app c_lift2 _147_1100)))
in (FStar_Syntax_Util.abs _147_1102 _147_1101 ret_tot_wp_a))))
in (

let wp_if_then_else = (normalize_and_make_binders_explicit wp_if_then_else)
in (

let _57_2482 = (let _147_1103 = (FStar_Syntax_Util.abs binders wp_if_then_else None)
in (check "wp_if_then_else" _147_1103))
in (
...
let op = (let _147_1109 = (let _147_1108 = (let _147_1106 = (FStar_Syntax_Syntax.null_binder FStar_Syntax_Util.ktype0)
in (let _147_1105 = (let _147_1104 = (FStar_Syntax_Syntax.null_binder FStar_Syntax_Util.ktype0)
in (_147_1104)::[])
in (_147_1106)::_147_1105))
in (let _147_1107 = (FStar_Syntax_Syntax.mk_GTotal FStar_Syntax_Util.ktype0)
in (FStar_Syntax_Util.arrow _147_1108 _147_1107)))
in (FStar_Syntax_Syntax.gen_bv "op" None _147_1109))
in (

let r = (FStar_Syntax_Syntax.gen_bv "r" None wp_a)
in (let _147_1121 = (FStar_Syntax_Syntax.binders_of_list ((a)::(l)::(op)::(r)::[]))
in (let _147_1120 = (let _147_1119 = (let _147_1118 = (let _147_1117 = (let _147_1116 = (let _147_1115 = (let _147_1114 = (FStar_Syntax_Syntax.bv_to_name op)
in (let _147_1113 = (let _147_1112 = (FStar_Syntax_Syntax.bv_to_name l)
in (let _147_1111 = (let _147_1110 = (FStar_Syntax_Syntax.bv_to_name r)
in (_147_1110)::[])
in (_147_1112)::_147_1111))
in (_147_1114)::_147_1113))
in (unknown)::_147_1115)
in (unknown)::_147_1116)
in (unknown)::_147_1117)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1118))
in (FStar_Syntax_Util.mk_app c_lift2 _147_1119))
in (FStar_Syntax_Util.abs _147_1121 _147_1120 ret_tot_wp_a))))))
in (

let wp_binop = (normalize_and_make_binders_explicit wp_binop)
in (

let _57_2489 = (let _147_1122 = (FStar_Syntax_Util.abs binders wp_binop None)
in (check "wp_binop" _147_1122))
in (
...
let body = (let _147_1136 = (let _147_1135 = (let _147_1134 = (let _147_1133 = (let _147_1132 = (let _147_1129 = (let _147_1128 = (let _147_1127 = (let _147_1126 = (let _147_1125 = (let _147_1124 = (let _147_1123 = (FStar_Syntax_Syntax.bv_to_name q)
in (FStar_Syntax_Syntax.as_arg _147_1123))
in (_147_1124)::[])
in (FStar_Syntax_Util.mk_app l_and _147_1125))
in (_147_1126)::[])
in (unknown)::_147_1127)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1128))
in (FStar_Syntax_Util.mk_app c_pure _147_1129))
in (let _147_1131 = (let _147_1130 = (FStar_Syntax_Syntax.bv_to_name wp)
in (_147_1130)::[])
in (_147_1132)::_147_1131))
in (unknown)::_147_1133)
in (unknown)::_147_1134)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1135))
in (FStar_Syntax_Util.mk_app c_app _147_1136))
in (let _147_1137 = (FStar_Syntax_Syntax.binders_of_list ((a)::(q)::(wp)::[]))
in (FStar_Syntax_Util.abs _147_1137 body ret_tot_wp_a))))))
in (

let wp_assert = (normalize_and_make_binders_explicit wp_assert)
in (

let _57_2497 = (let _147_1138 = (FStar_Syntax_Util.abs binders wp_assert None)
in (check "wp_assert" _147_1138))
in (
...
let body = (let _147_1152 = (let _147_1151 = (let _147_1150 = (let _147_1149 = (let _147_1148 = (let _147_1145 = (let _147_1144 = (let _147_1143 = (let _147_1142 = (let _147_1141 = (let _147_1140 = (let _147_1139 = (FStar_Syntax_Syntax.bv_to_name q)
in (FStar_Syntax_Syntax.as_arg _147_1139))
in (_147_1140)::[])
in (FStar_Syntax_Util.mk_app l_imp _147_1141))
in (_147_1142)::[])
in (unknown)::_147_1143)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1144))
in (FStar_Syntax_Util.mk_app c_pure _147_1145))
in (let _147_1147 = (let _147_1146 = (FStar_Syntax_Syntax.bv_to_name wp)
in (_147_1146)::[])
in (_147_1148)::_147_1147))
in (unknown)::_147_1149)
in (unknown)::_147_1150)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1151))
in (FStar_Syntax_Util.mk_app c_app _147_1152))
in (let _147_1153 = (FStar_Syntax_Syntax.binders_of_list ((a)::(q)::(wp)::[]))
in (FStar_Syntax_Util.abs _147_1153 body ret_tot_wp_a))))))
in (

let wp_assume = (normalize_and_make_binders_explicit wp_assume)
in (

let _57_2505 = (let _147_1154 = (FStar_Syntax_Util.abs binders wp_assume None)
in (check "wp_assume" _147_1154))
in (

let tforall = (let _147_1157 = (FStar_Syntax_Syntax.mk_Tm_uinst FStar_Syntax_Util.tforall ((FStar_Syntax_Syntax.U_unknown)::[]))
in (let _147_1156 = (let _147_1155 = (FStar_Syntax_Syntax.as_arg unknown)
in (_147_1155)::[])
in (FStar_Syntax_Util.mk_app _147_1157 _147_1156)))
in (
...
let t_f = (let _147_1161 = (let _147_1159 = (let _147_1158 = (FStar_Syntax_Syntax.bv_to_name b)
in (FStar_Syntax_Syntax.null_binder _147_1158))
in (_147_1159)::[])
in (let _147_1160 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1161 _147_1160)))
in (

let f = (FStar_Syntax_Syntax.gen_bv "f" None t_f)
in (

let body = (let _147_1174 = (let _147_1173 = (let _147_1172 = (let _147_1171 = (let _147_1170 = (let _147_1162 = (FStar_List.map FStar_Syntax_Syntax.as_arg ((unknown)::(tforall)::[]))
in (FStar_Syntax_Util.mk_app c_pure _147_1162))
in (let _147_1169 = (let _147_1168 = (let _147_1167 = (let _147_1166 = (let _147_1165 = (let _147_1164 = (let _147_1163 = (FStar_Syntax_Syntax.bv_to_name f)
in (_147_1163)::[])
in (unknown)::_147_1164)
in (unknown)::_147_1165)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1166))
in (FStar_Syntax_Util.mk_app c_push _147_1167))
in (_147_1168)::[])
in (_147_1170)::_147_1169))
in (unknown)::_147_1171)
in (unknown)::_147_1172)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1173))
in (FStar_Syntax_Util.mk_app c_app _147_1174))
in (let _147_1175 = (FStar_Syntax_Syntax.binders_of_list ((a)::(b)::(f)::[]))
in (FStar_Syntax_Util.abs _147_1175 body ret_tot_wp_a))))))
in (

let wp_close = (normalize_and_make_binders_explicit wp_close)
in (

let _57_2514 = (let _147_1176 = (FStar_Syntax_Util.abs binders wp_close None)
in (check "wp_close" _147_1176))
in (

let ret_tot_type0 = (let _147_1179 = (let _147_1178 = (let _147_1177 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Util.ktype0)
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _147_1177))
in FStar_Util.Inl (_147_1178))
in Some (_147_1179))
in (

let mk_forall = (fun x body -> (

let tforall = (let _147_1186 = (FStar_Syntax_Syntax.mk_Tm_uinst FStar_Syntax_Util.tforall ((FStar_Syntax_Syntax.U_unknown)::[]))
in (let _147_1185 = (let _147_1184 = (FStar_Syntax_Syntax.as_arg x.FStar_Syntax_Syntax.sort)
in (_147_1184)::[])
in (FStar_Syntax_Util.mk_app _147_1186 _147_1185)))
in (let _147_1193 = (let _147_1192 = (let _147_1191 = (let _147_1190 = (let _147_1189 = (let _147_1188 = (let _147_1187 = (FStar_Syntax_Syntax.mk_binder x)
in (_147_1187)::[])
in (FStar_Syntax_Util.abs _147_1188 body ret_tot_type0))
in (FStar_Syntax_Syntax.as_arg _147_1189))
in (_147_1190)::[])
in (tforall, _147_1191))
in FStar_Syntax_Syntax.Tm_app (_147_1192))
in (FStar_Syntax_Syntax.mk _147_1193 None FStar_Range.dummyRange))))
in (

let rec mk_leq = (fun t x y -> (match ((let _147_1201 = (let _147_1200 = (FStar_Syntax_Subst.compress t)
in (normalize _147_1200))
in _147_1201.FStar_Syntax_Syntax.n)) with
...
let body = (let _147_1213 = (let _147_1203 = (FStar_Syntax_Syntax.bv_to_name a1)
in (let _147_1202 = (FStar_Syntax_Syntax.bv_to_name a2)
in (mk_leq a _147_1203 _147_1202)))
in (let _147_1212 = (let _147_1211 = (let _147_1206 = (let _147_1205 = (let _147_1204 = (FStar_Syntax_Syntax.bv_to_name a1)
in (FStar_Syntax_Syntax.as_arg _147_1204))
in (_147_1205)::[])
in (FStar_Syntax_Util.mk_app x _147_1206))
in (let _147_1210 = (let _147_1209 = (let _147_1208 = (let _147_1207 = (FStar_Syntax_Syntax.bv_to_name a2)
in (FStar_Syntax_Syntax.as_arg _147_1207))
in (_147_1208)::[])
in (FStar_Syntax_Util.mk_app y _147_1209))
in (mk_leq b _147_1211 _147_1210)))
in (FStar_Syntax_Util.mk_imp _147_1213 _147_1212)))
in (let _147_1214 = (mk_forall a2 body)
in (mk_forall a1 _147_1214))))))
end
...
let _57_2562 = t
in (let _147_1218 = (let _147_1217 = (let _147_1216 = (let _147_1215 = (FStar_Syntax_Util.arrow binders comp)
in (FStar_Syntax_Syntax.mk_Total _147_1215))
in ((binder)::[], _147_1216))
in FStar_Syntax_Syntax.Tm_arrow (_147_1217))
in {FStar_Syntax_Syntax.n = _147_1218; FStar_Syntax_Syntax.tk = _57_2562.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _57_2562.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _57_2562.FStar_Syntax_Syntax.vars}))
in (mk_leq t x y))
end
...
let body = (let _147_1220 = (FStar_Syntax_Syntax.bv_to_name wp1)
in (let _147_1219 = (FStar_Syntax_Syntax.bv_to_name wp2)
in (mk_leq wp_a _147_1220 _147_1219)))
in (let _147_1221 = (FStar_Syntax_Syntax.binders_of_list ((wp1)::(wp2)::[]))
in (FStar_Syntax_Util.abs _147_1221 body ret_tot_type0)))))
in (

let _57_2574 = (let _147_1225 = (let _147_1224 = (let _147_1223 = (let _147_1222 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1222)::[])
in (FStar_List.append binders _147_1223))
in (FStar_Syntax_Util.abs _147_1224 stronger None))
in (check "stronger" _147_1225))
in (
...
let body = (let _147_1233 = (let _147_1232 = (let _147_1231 = (let _147_1228 = (let _147_1227 = (let _147_1226 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.as_arg _147_1226))
in (_147_1227)::[])
in (FStar_Syntax_Util.mk_app null_wp _147_1228))
in (let _147_1230 = (let _147_1229 = (FStar_Syntax_Syntax.bv_to_name wp)
in (_147_1229)::[])
in (_147_1231)::_147_1230))
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1232))
in (FStar_Syntax_Util.mk_app stronger _147_1233))
in (let _147_1234 = (FStar_Syntax_Syntax.binders_of_list ((a)::(wp)::[]))
in (FStar_Syntax_Util.abs _147_1234 body ret_tot_type0))))
in (

let wp_trivial = (normalize_and_make_binders_explicit wp_trivial)
in (

let _57_2581 = (let _147_1235 = (FStar_Syntax_Util.abs binders wp_trivial None)
in (check "wp_trivial" _147_1235))
in (
...
let env = (let _147_1244 = (FStar_Syntax_Syntax.new_bv None ed.FStar_Syntax_Syntax.signature)
in (FStar_TypeChecker_Env.push_bv env _147_1244))
in (

let _57_2616 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env0) (FStar_Options.Other ("ED"))) then begin
(let _147_1247 = (FStar_Syntax_Print.lid_to_string ed.FStar_Syntax_Syntax.mname)
in (let _147_1246 = (FStar_Syntax_Print.binders_to_string " " ed.FStar_Syntax_Syntax.binders)
in (let _147_1245 = (FStar_Syntax_Print.term_to_string ed.FStar_Syntax_Syntax.signature)
in (FStar_Util.print3 "Checking effect signature: %s %s : %s\n" _147_1247 _147_1246 _147_1245))))
end else begin
()
end
in (
...
let expected_k = (let _147_1259 = (let _147_1257 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1256 = (let _147_1255 = (let _147_1254 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.null_binder _147_1254))
in (_147_1255)::[])
in (_147_1257)::_147_1256))
in (let _147_1258 = (FStar_Syntax_Syntax.mk_GTotal wp_a)
in (FStar_Syntax_Util.arrow _147_1259 _147_1258)))
...
let a_wp_b = (let _147_1263 = (let _147_1261 = (let _147_1260 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.null_binder _147_1260))
in (_147_1261)::[])
in (let _147_1262 = (FStar_Syntax_Syntax.mk_Total wp_b)
in (FStar_Syntax_Util.arrow _147_1263 _147_1262)))
in (

let a_wlp_b = a_wp_b
in (

let expected_k = (let _147_1278 = (let _147_1276 = (FStar_Syntax_Syntax.null_binder FStar_TypeChecker_Common.t_range)
in (let _147_1275 = (let _147_1274 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1273 = (let _147_1272 = (FStar_Syntax_Syntax.mk_binder b)
in (let _147_1271 = (let _147_1270 = (FStar_Syntax_Syntax.null_binder wp_a)
in (let _147_1269 = (let _147_1268 = (FStar_Syntax_Syntax.null_binder wlp_a)
in (let _147_1267 = (let _147_1266 = (FStar_Syntax_Syntax.null_binder a_wp_b)
in (let _147_1265 = (let _147_1264 = (FStar_Syntax_Syntax.null_binder a_wlp_b)
in (_147_1264)::[])
in (_147_1266)::_147_1265))
in (_147_1268)::_147_1267))
in (_147_1270)::_147_1269))
in (_147_1272)::_147_1271))
in (_147_1274)::_147_1273))
in (_147_1276)::_147_1275))
in (let _147_1277 = (FStar_Syntax_Syntax.mk_Total wp_b)
in (FStar_Syntax_Util.arrow _147_1278 _147_1277)))
...
let a_wlp_b = (let _147_1282 = (let _147_1280 = (let _147_1279 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.null_binder _147_1279))
in (_147_1280)::[])
in (let _147_1281 = (FStar_Syntax_Syntax.mk_Total wlp_b)
in (FStar_Syntax_Util.arrow _147_1282 _147_1281)))
in (

let expected_k = (let _147_1293 = (let _147_1291 = (FStar_Syntax_Syntax.null_binder FStar_TypeChecker_Common.t_range)
in (let _147_1290 = (let _147_1289 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1288 = (let _147_1287 = (FStar_Syntax_Syntax.mk_binder b)
in (let _147_1286 = (let _147_1285 = (FStar_Syntax_Syntax.null_binder wlp_a)
in (let _147_1284 = (let _147_1283 = (FStar_Syntax_Syntax.null_binder a_wlp_b)
in (_147_1283)::[])
in (_147_1285)::_147_1284))
in (_147_1287)::_147_1286))
in (_147_1289)::_147_1288))
in (_147_1291)::_147_1290))
in (let _147_1292 = (FStar_Syntax_Syntax.mk_Total wlp_b)
in (FStar_Syntax_Util.arrow _147_1293 _147_1292)))
...
let p = (let _147_1295 = (let _147_1294 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _147_1294 Prims.fst))
in (FStar_Syntax_Syntax.new_bv (Some ((FStar_Ident.range_of_lid ed.FStar_Syntax_Syntax.mname))) _147_1295))
in (

let expected_k = (let _147_1304 = (let _147_1302 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1301 = (let _147_1300 = (FStar_Syntax_Syntax.mk_binder p)
in (let _147_1299 = (let _147_1298 = (FStar_Syntax_Syntax.null_binder wp_a)
...
let expected_k = (let _147_1311 = (let _147_1309 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1308 = (let _147_1307 = (FStar_Syntax_Syntax.null_binder wlp_a)
...
let expected_k = (let _147_1316 = (let _147_1314 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1313 = (let _147_1312 = (FStar_Syntax_Syntax.null_binder wlp_a)
in (_147_1312)::[])
in (_147_1314)::_147_1313))
in (let _147_1315 = (FStar_Syntax_Syntax.mk_Total wlp_a)
in (FStar_Syntax_Util.arrow _147_1316 _147_1315)))
...
let t = (let _147_1317 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_max ((u1)::(u2)::[]))) None _147_1317))
in (let _147_1322 = (let _147_1320 = (FStar_Syntax_Syntax.null_binder t1)
in (let _147_1319 = (let _147_1318 = (FStar_Syntax_Syntax.null_binder t2)
in (_147_1318)::[])
...
in (let _147_1328 = (let _147_1327 = (FStar_Syntax_Syntax.null_binder wp_a)
in (let _147_1326 = (let _147_1325 = (FStar_Syntax_Syntax.null_binder bin_op)
in (let _147_1324 = (let _147_1323 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1323)::[])
...
in (let _147_1333 = (let _147_1332 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1332)::[])
in (_147_1334)::_147_1333))
in (let _147_1335 = (FStar_Syntax_Syntax.mk_Total t)
...
let b = (let _147_1338 = (let _147_1337 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _147_1337 Prims.fst))
in (FStar_Syntax_Syntax.new_bv (Some ((FStar_Ident.range_of_lid ed.FStar_Syntax_Syntax.mname))) _147_1338))
in (

let b_wp_a = (let _147_1342 = (let _147_1340 = (let _147_1339 = (FStar_Syntax_Syntax.bv_to_name b)
in (FStar_Syntax_Syntax.null_binder _147_1339))
in (_147_1340)::[])
in (let _147_1341 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1342 _147_1341)))
in (

let expected_k = (let _147_1349 = (let _147_1347 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1346 = (let _147_1345 = (FStar_Syntax_Syntax.mk_binder b)
in (let _147_1344 = (let _147_1343 = (FStar_Syntax_Syntax.null_binder b_wp_a)
in (_147_1343)::[])
in (_147_1345)::_147_1344))
in (_147_1347)::_147_1346))
in (let _147_1348 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1349 _147_1348)))
in (check_and_gen' env ed.FStar_Syntax_Syntax.close_wp expected_k))))
in (

let assert_p = (

let expected_k = (let _147_1358 = (let _147_1356 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1355 = (let _147_1354 = (let _147_1351 = (let _147_1350 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _147_1350 Prims.fst))
in (FStar_Syntax_Syntax.null_binder _147_1351))
in (let _147_1353 = (let _147_1352 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1352)::[])
in (_147_1354)::_147_1353))
in (_147_1356)::_147_1355))
in (let _147_1357 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1358 _147_1357)))
in (check_and_gen' env ed.FStar_Syntax_Syntax.assert_p expected_k))
in (

let assume_p = (

let expected_k = (let _147_1367 = (let _147_1365 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1364 = (let _147_1363 = (let _147_1360 = (let _147_1359 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _147_1359 Prims.fst))
in (FStar_Syntax_Syntax.null_binder _147_1360))
in (let _147_1362 = (let _147_1361 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1361)::[])
in (_147_1363)::_147_1362))
in (_147_1365)::_147_1364))
in (let _147_1366 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1367 _147_1366)))
in (check_and_gen' env ed.FStar_Syntax_Syntax.assume_p expected_k))
in (

let null_wp = (

let expected_k = (let _147_1370 = (let _147_1368 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1368)::[])
in (let _147_1369 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1370 _147_1369)))
...
let expected_k = (let _147_1375 = (let _147_1373 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1372 = (let _147_1371 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1371)::[])
in (_147_1373)::_147_1372))
in (let _147_1374 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.arrow _147_1375 _147_1374)))
in (check_and_gen' env ed.FStar_Syntax_Syntax.trivial expected_k))
end))
in (

let t = (let _147_1376 = (FStar_Syntax_Syntax.mk_Total ed.FStar_Syntax_Syntax.signature)
in (FStar_Syntax_Util.arrow ed.FStar_Syntax_Syntax.binders _147_1376))
in (
...
let _57_2705 = (match ((let _147_1378 = (let _147_1377 = (FStar_Syntax_Subst.compress t)
in _147_1377.FStar_Syntax_Syntax.n)
in (binders, _147_1378))) with
| ([], _57_2692) -> begin
([], t)
end
...
let ts = (let _147_1383 = (FStar_Syntax_Subst.close_tscheme binders ts)
in (FStar_Syntax_Subst.close_univ_vars_tscheme univs _147_1383))
in (
...
let _57_2712 = ed
in (let _147_1396 = (close 0 ret)
in (let _147_1395 = (close 1 bind_wp)
in (let _147_1394 = (close 1 bind_wlp)
in (let _147_1393 = (close 0 if_then_else)
in (let _147_1392 = (close 0 ite_wp)
in (let _147_1391 = (close 0 ite_wlp)
in (let _147_1390 = (close 0 wp_binop)
in (let _147_1389 = (close 0 wp_as_type)
in (let _147_1388 = (close 1 close_wp)
in (let _147_1387 = (close 0 assert_p)
in (let _147_1386 = (close 0 assume_p)
in (let _147_1385 = (close 0 null_wp)
in (let _147_1384 = (close 0 trivial_wp)
in {FStar_Syntax_Syntax.qualifiers = _57_2712.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _57_2712.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = univs; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = signature; FStar_Syntax_Syntax.ret = _147_1396; FStar_Syntax_Syntax.bind_wp = _147_1395; FStar_Syntax_Syntax.bind_wlp = _147_1394; FStar_Syntax_Syntax.if_then_else = _147_1393; FStar_Syntax_Syntax.ite_wp = _147_1392; FStar_Syntax_Syntax.ite_wlp = _147_1391; FStar_Syntax_Syntax.wp_binop = _147_1390; FStar_Syntax_Syntax.wp_as_type = _147_1389; FStar_Syntax_Syntax.close_wp = _147_1388; FStar_Syntax_Syntax.assert_p = _147_1387; FStar_Syntax_Syntax.assume_p = _147_1386; FStar_Syntax_Syntax.null_wp = _147_1385; FStar_Syntax_Syntax.trivial = _147_1384}))))))))))))))
in (

let _57_2715 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _147_1397 = (FStar_Syntax_Print.eff_decl_to_string ed)
in (FStar_Util.print_string _147_1397))
end else begin
()
end
in ed)))
...
let lex_top_t = (let _147_1405 = (let _147_1404 = (let _147_1403 = (let _147_1402 = (FStar_Ident.set_lid_range FStar_Syntax_Const.lex_t_lid r1)
in (FStar_Syntax_Syntax.fvar _147_1402 FStar_Syntax_Syntax.Delta_constant None))
in (_147_1403, (FStar_Syntax_Syntax.U_name (utop))::[]))
in FStar_Syntax_Syntax.Tm_uinst (_147_1404))
in (FStar_Syntax_Syntax.mk _147_1405 None r1))
in (
...
let a = (let _147_1406 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_name (ucons1))) None r2)
in (FStar_Syntax_Syntax.new_bv (Some (r2)) _147_1406))
in (

let hd = (let _147_1407 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.new_bv (Some (r2)) _147_1407))
in (

let tl = (let _147_1412 = (let _147_1411 = (let _147_1410 = (let _147_1409 = (let _147_1408 = (FStar_Ident.set_lid_range FStar_Syntax_Const.lex_t_lid r2)
in (FStar_Syntax_Syntax.fvar _147_1408 FStar_Syntax_Syntax.Delta_constant None))
in (_147_1409, (FStar_Syntax_Syntax.U_name (ucons2))::[]))
in FStar_Syntax_Syntax.Tm_uinst (_147_1410))
in (FStar_Syntax_Syntax.mk _147_1411 None r2))
in (FStar_Syntax_Syntax.new_bv (Some (r2)) _147_1412))
in (

let res = (let _147_1416 = (let _147_1415 = (let _147_1414 = (let _147_1413 = (FStar_Ident.set_lid_range FStar_Syntax_Const.lex_t_lid r2)
in (FStar_Syntax_Syntax.fvar _147_1413 FStar_Syntax_Syntax.Delta_constant None))
in (_147_1414, (FStar_Syntax_Syntax.U_max ((FStar_Syntax_Syntax.U_name (ucons1))::(FStar_Syntax_Syntax.U_name (ucons2))::[]))::[]))
in FStar_Syntax_Syntax.Tm_uinst (_147_1415))
in (FStar_Syntax_Syntax.mk _147_1416 None r2))
in (let _147_1417 = (FStar_Syntax_Syntax.mk_Total res)
in (FStar_Syntax_Util.arrow (((a, Some (FStar_Syntax_Syntax.imp_tag)))::((hd, None))::((tl, None))::[]) _147_1417))))))
in (
...
in (let _147_1419 = (let _147_1418 = (FStar_TypeChecker_Env.get_range env)
in ((tc)::(dc_lextop)::(dc_lexcons)::[], [], lids, _147_1418))
in FStar_Syntax_Syntax.Sig_bundle (_147_1419)))))))))))))))
end
| _57_2784 -> begin
(let _147_1421 = (let _147_1420 = (FStar_Syntax_Print.sigelt_to_string (FStar_Syntax_Syntax.Sig_bundle ((ses, [], lids, FStar_Range.dummyRange))))
in (FStar_Util.format1 "Unexpected lex_t: %s\n" _147_1420))
in (FStar_All.failwith _147_1421))
end))))
...
let warn_positivity = (fun l r -> (let _147_1435 = (let _147_1434 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format1 "Positivity check is not yet implemented (%s)" _147_1434))
in (FStar_TypeChecker_Errors.diag r _147_1435)))
in (
...
let k = (let _147_1440 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow indices _147_1440))
in (
...
let _57_2832 = (let _147_1441 = (FStar_TypeChecker_Rel.teq env' t t_type)
in (FStar_TypeChecker_Rel.force_trivial_guard env' _147_1441))
in (

let t_tc = (let _147_1442 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow (FStar_List.append tps indices) _147_1442))
in (
...
in (let _147_1443 = (FStar_TypeChecker_Env.push_let_binding env_tps (FStar_Util.Inr (fv_tc)) ([], t_tc))
in (_147_1443, FStar_Syntax_Syntax.Sig_inductive_typ ((tc, [], tps, k, mutuals, data, quals, r)), u)))))))
end)))
end))
end))
end))
...
| (se, u_tc) -> begin
if (let _147_1456 = (let _147_1455 = (FStar_Syntax_Util.lid_of_sigelt se)
in (FStar_Util.must _147_1455))
in (FStar_Ident.lid_equals tc_lid _147_1456)) then begin
(
...
let _57_2913 = (match ((let _147_1458 = (FStar_Syntax_Subst.compress t)
in _147_1458.FStar_Syntax_Syntax.n)) with
...
in (let _147_1461 = (FStar_Syntax_Subst.subst subst t)
in (FStar_Syntax_Util.arrow_formals _147_1461))))
end))
end
| _57_2910 -> begin
([], t)
...
(let _147_1464 = (FStar_Syntax_Print.lid_to_string c)
in (let _147_1463 = (FStar_Syntax_Print.binders_to_string "->" arguments)
in (let _147_1462 = (FStar_Syntax_Print.term_to_string result)
in (FStar_Util.print3 "Checking datacon  %s : %s -> %s \n" _147_1464 _147_1463 _147_1462))))
end else begin
()
end
in (
...
let _57_2932 = (match ((let _147_1465 = (FStar_Syntax_Subst.compress head)
in _147_1465.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv) when (FStar_Syntax_Syntax.fv_eq_lid fv tc_lid) -> begin
()
end
| _57_2931 -> begin
(let _147_1469 = (let _147_1468 = (let _147_1467 = (let _147_1466 = (FStar_Syntax_Print.lid_to_string tc_lid)
in (FStar_Util.format1 "Expected a constructor of type %s" _147_1466))
in (_147_1467, r))
in FStar_Syntax_Syntax.Error (_147_1468))
in (Prims.raise _147_1469))
end)
in (
...
let _57_2940 = ()
in (let _147_1473 = (FStar_TypeChecker_Rel.universe_inequality u_x u_tc)
in (FStar_TypeChecker_Rel.conj_guard g _147_1473)))
end)) FStar_TypeChecker_Rel.trivial_guard arguments us)
in (

let t = (let _147_1477 = (let _147_1475 = (FStar_All.pipe_right tps (FStar_List.map (fun _57_2946 -> (match (_57_2946) with
| (x, _57_2945) -> begin
(x, Some (FStar_Syntax_Syntax.Implicit (true)))
end))))
in (FStar_List.append _147_1475 arguments))
in (let _147_1476 = (FStar_Syntax_Syntax.mk_Total result)
in (FStar_Syntax_Util.arrow _147_1477 _147_1476)))
...
(let _147_1488 = (let _147_1487 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_All.pipe_left (FStar_Syntax_Util.arrow tps) _147_1487))
in (FStar_Syntax_Syntax.null_binder _147_1488))
end
| _57_2975 -> begin
(FStar_All.failwith "Impossible")
end))))
...
let t = (let _147_1490 = (FStar_Syntax_Syntax.mk_Total FStar_TypeChecker_Common.t_unit)
in (FStar_Syntax_Util.arrow (FStar_List.append binders binders') _147_1490))
in (

let _57_2999 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _147_1491 = (FStar_TypeChecker_Normalize.term_to_string env t)
...
(let _147_1495 = (let _147_1493 = (FStar_All.pipe_right uvs (FStar_List.map (fun u -> u.FStar_Ident.idText)))
in (FStar_All.pipe_right _147_1493 (FStar_String.concat ", ")))
in (let _147_1494 = (FStar_Syntax_Print.term_to_string t)
...
let _57_3050 = (match ((let _147_1498 = (FStar_Syntax_Subst.compress ty)
in _147_1498.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, c) -> begin
(
...
| _57_3044 -> begin
(let _147_1499 = (FStar_ST.read x.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((rest, c))) _147_1499 x.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.pos))
end)
in (tps, t))
end))
end
...
let uvs_universes = (FStar_All.pipe_right uvs (FStar_List.map (fun _147_1500 -> FStar_Syntax_Syntax.U_name (_147_1500))))
in (
...
let ty = (let _147_1504 = (FStar_Syntax_InstFV.instantiate tc_insts t.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _147_1504 (FStar_Syntax_Subst.close_univ_vars uvs)))
...
(let _147_1508 = (FStar_Syntax_Print.sigelt_to_string tc)
in (FStar_Util.print1 "Checked inductive: %s\n" _147_1508))
end else begin
()
end
in (let _147_1509 = (FStar_TypeChecker_Rel.conj_guard g g')
in (env, ((tc, tc_u))::all_tcs, _147_1509))))
end))
...
| (data, g') -> begin
(let _147_1512 = (FStar_TypeChecker_Rel.conj_guard g g')
in ((data)::datas, _147_1512))
end))
end)) datas ([], g))
...
let _57_3138 = (let _147_1513 = (FStar_List.map Prims.fst tcs)
in (generalize_and_inst_within env0 g _147_1513 datas))
in (match (_57_3138) with
| (tcs, datas) -> begin
(let _147_1515 = (let _147_1514 = (FStar_TypeChecker_Env.get_range env0)
in ((FStar_List.append tcs datas), quals, lids, _147_1514))
in FStar_Syntax_Syntax.Sig_bundle (_147_1515))
end))
end))
end)))
end)))))))))
...
in (let _147_1520 = (FStar_TypeChecker_Env.push_sigelt env se)
in (se, _147_1520))))
end
...
in (let _147_1521 = (FStar_TypeChecker_Env.push_sigelt env se)
in (se, _147_1521))))
end
...
let _57_3180 = (let _147_1526 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _147_1526 Prims.ignore))
in (
...
let _57_3209 = (let _147_1527 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _147_1527))
in (match (_57_3209) with
| (a, wp_a_src) -> begin
(

let _57_3212 = (let _147_1528 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
in (monad_signature env sub.FStar_Syntax_Syntax.target _147_1528))
in (match (_57_3212) with
| (b, wp_b_tgt) -> begin
(

let wp_a_tgt = (let _147_1532 = (let _147_1531 = (let _147_1530 = (let _147_1529 = (FStar_Syntax_Syntax.bv_to_name a)
in (b, _147_1529))
in FStar_Syntax_Syntax.NT (_147_1530))
in (_147_1531)::[])
in (FStar_Syntax_Subst.subst _147_1532 wp_b_tgt))
in (

let expected_k = (let _147_1537 = (let _147_1535 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1534 = (let _147_1533 = (FStar_Syntax_Syntax.null_binder wp_a_src)
in (_147_1533)::[])
in (_147_1535)::_147_1534))
in (let _147_1536 = (FStar_Syntax_Syntax.mk_Total wp_a_tgt)
in (FStar_Syntax_Util.arrow _147_1537 _147_1536)))
in (
...
let _57_3250 = (let _147_1538 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((tps, c))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _147_1538))
in (match (_57_3250) with
| (uvs, t) -> begin
(

let _57_3269 = (match ((let _147_1540 = (let _147_1539 = (FStar_Syntax_Subst.compress t)
in _147_1539.FStar_Syntax_Syntax.n)
in (tps, _147_1540))) with
...
let _57_3284 = (let _147_1542 = (let _147_1541 = (FStar_Syntax_Util.type_u ())
in (Prims.fst _147_1541))
in (check_and_gen env t _147_1542))
...
let phi = (let _147_1543 = (tc_check_trivial_guard env phi k)
in (FStar_All.pipe_right _147_1543 (norm env)))
in (
...
let _57_3317 = (let _147_1547 = (let _147_1544 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_147_1544))
in (let _147_1546 = (let _147_1545 = (c.FStar_Syntax_Syntax.comp ())
in (e, _147_1545))
in (check_expected_effect env _147_1547 _147_1546)))
in (match (_57_3317) with
| (e, _57_3315, g) -> begin
(

let _57_3318 = (let _147_1548 = (FStar_TypeChecker_Rel.conj_guard g1 g)
in (FStar_TypeChecker_Rel.force_trivial_guard env _147_1548))
in (
...
(let _147_1560 = (let _147_1559 = (let _147_1558 = (let _147_1557 = (FStar_Syntax_Print.lid_to_string l)
in (let _147_1556 = (FStar_Syntax_Print.quals_to_string q)
in (let _147_1555 = (FStar_Syntax_Print.quals_to_string q')
in (FStar_Util.format3 "Inconsistent qualifier annotations on %s; Expected {%s}, got {%s}" _147_1557 _147_1556 _147_1555))))
in (_147_1558, r))
in FStar_Syntax_Syntax.Error (_147_1559))
in (Prims.raise _147_1560))
end
end))
in (
...
in (let _147_1563 = (FStar_Syntax_Syntax.mk_lb (FStar_Util.Inr (lbname), uvs, FStar_Syntax_Const.effect_ALL_lid, tval, lb.FStar_Syntax_Syntax.lbdef))
in (false, _147_1563, quals_opt))))
end)
...
let e = (let _147_1567 = (let _147_1566 = (let _147_1565 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)) None r)
in (((Prims.fst lbs), lbs'), _147_1565))
in FStar_Syntax_Syntax.Tm_let (_147_1566))
in (FStar_Syntax_Syntax.mk _147_1567 None r))
in (
...
(let _147_1575 = (let _147_1574 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (

let should_log = (match ((let _147_1571 = (let _147_1570 = (let _147_1569 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _147_1569.FStar_Syntax_Syntax.fv_name)
in _147_1570.FStar_Syntax_Syntax.v)
in (FStar_TypeChecker_Env.try_lookup_val_decl env _147_1571))) with
| None -> begin
true
end
| _57_3409 -> begin
...
(let _147_1573 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
in (let _147_1572 = (FStar_Syntax_Print.term_to_string lb.FStar_Syntax_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" _147_1573 _147_1572)))
end else begin
""
end))))
in (FStar_All.pipe_right _147_1574 (FStar_String.concat "\n")))
in (FStar_Util.print1 "%s\n" _147_1575))
end else begin
()
end
...
let dec = (let _147_1591 = (let _147_1590 = (let _147_1589 = (let _147_1588 = (let _147_1587 = (FStar_Syntax_Syntax.mk_Total t)
in (bs, _147_1587))
in FStar_Syntax_Syntax.Tm_arrow (_147_1588))
in (FStar_Syntax_Syntax.mk _147_1589 None r))
in (l, us, _147_1590, (FStar_Syntax_Syntax.Assumption)::(FStar_Syntax_Syntax.New)::quals, r))
in FStar_Syntax_Syntax.Sig_declare_typ (_147_1591))
in ((dec)::out, hidden))
end
...
if (is_abstract quals) then begin
(let _147_1598 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let _147_1597 = (let _147_1596 = (let _147_1595 = (let _147_1594 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _147_1594.FStar_Syntax_Syntax.fv_name)
in _147_1595.FStar_Syntax_Syntax.v)
in (_147_1596, lb.FStar_Syntax_Syntax.lbunivs, lb.FStar_Syntax_Syntax.lbtyp, (FStar_Syntax_Syntax.Assumption)::quals, r))
in FStar_Syntax_Syntax.Sig_declare_typ (_147_1597)))))
in (_147_1598, hidden))
end else begin
((se)::[], hidden)
end
...
(let _147_1605 = (FStar_Syntax_Print.sigelt_to_string se)
...
let _57_3558 = if ((FStar_Options.log_types ()) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("LogTypes")))) then begin
(let _147_1606 = (FStar_Syntax_Print.sigelt_to_string se)
...
(let _147_1607 = (FStar_All.pipe_right (FStar_List.rev exports) FStar_List.flatten)
in ((FStar_List.rev ses), _147_1607, env))
end)))
...
in (let _147_1625 = (FStar_Options.restore_cmd_line_options true)
in (FStar_All.pipe_right _147_1625 Prims.ignore)))))
end else begin
()
end
in (modul, env)))))
...
(let _147_1634 = (FStar_Syntax_Print.term_to_string e)
...
(let _147_1639 = (let _147_1638 = (let _147_1637 = (FStar_TypeChecker_Env.get_range env)
in ((Prims.strcat "Implicit argument: " msg), _147_1637))
in FStar_Syntax_Syntax.Error (_147_1638))
in (Prims.raise _147_1639))
end
...
(let _147_1644 = (let _147_1643 = (let _147_1642 = (let _147_1640 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "Implicit argument: Expected a total term; got a ghost term: %s" _147_1640))
in (let _147_1641 = (FStar_TypeChecker_Env.get_range env)
in (_147_1642, _147_1641)))
in FStar_Syntax_Syntax.Error (_147_1643))
in (Prims.raise _147_1644))
end
end)))))
...
let _57_3641 = if (FStar_Options.debug_any ()) then begin
(let _147_1649 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
...
let _57_3646 = if (FStar_Options.dump_module m.FStar_Syntax_Syntax.name.FStar_Ident.str) then begin
(let _147_1650 = (FStar_Syntax_Print.modul_to_string m)
in (FStar_Util.print1 "%s\n" _147_1650))
end else begin
()
end
