  ...
  fun hidden  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_assume
          ...
          if uu____3348 then ([], hidden) else ([se], hidden)
               ...
               FStar_All.pipe_right quals
                 (FStar_Util.for_some
                    (fun uu___80_3377  ->
                       ...
                       | uu____3380 -> false))
                in
             if uu____3375 then ([se], hidden) else ([], hidden))
              ...
              let uu____3957 =
                Prims.op_Negation
                  (FStar_All.pipe_right quals
                     (FStar_List.contains FStar_Syntax_Syntax.Private))
                 in
              if uu____3957 then check_term l univs t else ()
          | FStar_Syntax_Syntax.Sig_let
    ...
    fun modul  ->
      fun exports  ->
        ...
        (let uu____4034 = Prims.op_Negation (FStar_Options.lax ())  in
         if uu____4034 then check_exports env modul exports else ());
