           ...
           | {
               ...
               FStar_Syntax_Syntax.sigopts = uu___7;_}::{
                                                          FStar_Syntax_Syntax.sigel
                                                            ...
                                                            (lex_top,uu___8,_t_top,_lex_t_top,uu___9,uu___10);
                                                            ...
                                                            = uu___13;_}::
               {
                 FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon
                   (lex_cons,uu___14,_t_cons,_lex_t_cons,uu___15,uu___16);
               ...
               let lex_cons_t =
                 let a =
                   ...
                   FStar_Syntax_Syntax.new_bv
                     (FStar_Pervasives_Native.Some r2) uu___20
                    in
                 let hd =
                 ...
                 FStar_Syntax_Util.arrow
                   ...
                   (tl, FStar_Pervasives_Native.None)] uu___20
                  in
               let lex_cons_t1 =
  ...
  fun env  ->
    fun ses  ->
      fun quals  ->
        fun attrs  ->
          fun lids  ->
            (let uu___1 = FStar_TypeChecker_Env.debug env FStar_Options.Low
                in
             if uu___1
             then
               let uu___2 =
             ...
             | (sig_bndle,tcs,datas) ->
                 ...
                 ((let uu___3 =
                     (FStar_Options.no_positivity ()) ||
                       (let uu___4 = FStar_TypeChecker_Env.should_verify env
                           in
                        ...
                        (fun ty  ->
                           ...
                           then
                             let uu___6 =
                               ...
                               | FStar_Syntax_Syntax.Sig_inductive_typ
                                   (lid,uu___7,uu___8,uu___9,uu___10,uu___11)
                                   ...
                                   let uu___8 =
                                     let uu___9 =
                                       ...
                                       Prims.op_Hat uu___10
                                        ...
                                        in
                                     Prims.op_Hat "Inductive type " uu___9
                                      in
                      ...
                      FStar_List.iter
                        (fun d  ->
                           let uu___6 =
                             ...
                             | FStar_Syntax_Syntax.Sig_datacon
                                 (data_lid,uu___7,uu___8,ty_lid,uu___9,uu___10)
                                 -> (data_lid, ty_lid)
                             | uu___7 -> failwith "Impossible"  in
                           match uu___6 with
                           | (data_lid,ty_lid) ->
            ...
            then
              ...
              (try
                 (fun uu___2  ->
                    match () with
                    | () ->
                        let uu___3 = tc_inductive' env1 ses quals attrs lids
                           in
  ...
  fun env  ->
    fun se  ->
      ...
      | FStar_Syntax_Syntax.Sig_let (lbs,l) ->
          let uu___ =
            let uu___1 = FStar_Options.ide ()  in Prims.op_Negation uu___1
             in
          if uu___
          then
            let uu___1 =
                              ...
                              let uu___3 =
                                let uu___4 =
                                  ...
                                  FStar_Util.format2
                                    ...
                                    uu___5 uu___6
                                   in
                                (FStar_Errors.Error_MustEraseMissing, uu___4)
                                 in
      ...
      let tc_and_elab_tactic env1 tau =
        let uu___ =
          FStar_TypeChecker_TcTerm.tc_tactic FStar_Syntax_Syntax.t_unit
            FStar_Syntax_Syntax.t_unit env1 tau
           in
        match uu___ with
        | (tau1,uu___1,g_tau) ->
            (FStar_TypeChecker_Rel.force_trivial_guard env1 g_tau; tau1)
         in
      let ats1 =
        let uu___ =
          FStar_Syntax_Util.extract_attr'
            FStar_Parser_Const.postprocess_extr_with ats
           in
        match uu___ with
        ...
        | FStar_Pervasives_Native.Some
            ...
            let uu___1 =
              ...
              FStar_Syntax_Util.mk_app uu___2
                [(tau2, FStar_Pervasives_Native.None)]
               in
            uu___1 :: ats2
        | FStar_Pervasives_Native.Some
            (ats2,(tau,FStar_Pervasives_Native.None )::[]) ->
                ...
                let uu___4 =
                  let uu___5 =
                    FStar_Ident.string_of_lid
                      FStar_Parser_Const.postprocess_extr_with
                     in
                  FStar_Util.format1 "Ill-formed application of `%s`" uu___5
                   in
                   ...
                   let uu___4 =
                     let uu___5 =
                       FStar_List.map FStar_Util.string_of_int
                         expected_errors
                        in
                     FStar_All.pipe_left (FStar_String.concat "; ") uu___5
                      in
                   ...
                   FStar_Errors.catch_errors
                     (fun uu___4  ->
                        FStar_Options.with_saved_options
                          (fun uu___5  ->
                             let uu___6 =
                               let uu___7 = FStar_ST.op_Bang tc_decls_knot
                                  in
                ...
                | (lid1,uvs1,tps1,c1) ->
                    ...
                    (match uu___3 with
                     | (lid2,uvs2,tps2,c2) ->
                         ...
                         ([se2], [], env0)))
           | FStar_Syntax_Syntax.Sig_declare_typ (uu___2,uu___3,uu___4) when
                                    ...
                                    let uu___11 =
                                      let uu___12 =
                                        FStar_List.map
                                         ...
                                         in
                                      FStar_All.pipe_left
                                        (FStar_String.concat ", ") uu___12
                                       in
                                    FStar_Util.format2
                                      "Splice declared the name %s but it was not defined.\nThose defined were: %s"
                                      uu___10 uu___11
                                     in
                                  (FStar_Errors.Fatal_SplicedUndef, uu___9)
                                   in
               ...
               let check_quals_eq l qopt val_q =
                 ...
                 | FStar_Pervasives_Native.Some q' ->
                     ...
                     then FStar_Pervasives_Native.Some q'
                       ...
                       (let uu___4 =
                          let uu___5 =
                            let uu___6 = FStar_Syntax_Print.lid_to_string l
                               in
                            let uu___7 =
                           ...
                           then
                             ...
                             | (e2,ms) ->
                                 ((let uu___7 =
                                   ...
                                   if uu___7
                                   then
                                     let uu___8 = FStar_Util.string_of_int ms
                                        in
                                     FStar_Util.print1
                                  ...
                                  (let uu___8 =
                                   ...
                                   then
                                     let uu___9 =
                                       FStar_Syntax_Print.term_to_string e2
                                        in
                                     FStar_Util.print1
                                  ...
                                  (let e3 =
                                     let uu___8 =
                                       FStar_TypeChecker_Normalize.remove_uvar_solutions
                                         env' e2
                                        in
                                     FStar_All.pipe_right uu___8 drop_lbtyp
                                      in
                                   (let uu___9 =
                                      FStar_All.pipe_left
                                        (FStar_TypeChecker_Env.debug env1)
                                   ...
                                   ((let uu___7 =
                                    ...
                                    (let uu___7 =
                                       ...
                                       | ({
                                            ...
                                            FStar_Syntax_Syntax.vars = uu___9;_},uu___10,g)
                                           when
                                           ...
                                           let quals1 =
                                             ...
                                             | FStar_Syntax_Syntax.Tm_meta
                                                 (uu___11,FStar_Syntax_Syntax.Meta_desugared
                                                               ...
                                                               let uu___15 =
                                                                 let uu___16
                                                                   ...
                                                                   FStar_Util.right
                                                                    lb.FStar_Syntax_Syntax.lbname
                                                                    in
                                                                 uu___16.FStar_Syntax_Syntax.fv_name
                                                                  in
                                                               uu___15.FStar_Syntax_Syntax.v
                                                                in
                                                             FStar_TypeChecker_Env.try_lookup_val_decl
                                                               env1 uu___14
                                                              in
        ...
        (match se.FStar_Syntax_Syntax.sigel with
         ...
         | uu___1 ->
             ...
             (match se.FStar_Syntax_Syntax.sigel with
              ...
              | FStar_Syntax_Syntax.Sig_polymonadic_bind (m,n,p,uu___2,ty) ->
                  FStar_TypeChecker_Util.update_env_polymonadic_bind env1 m n
                    p ty
              | FStar_Syntax_Syntax.Sig_polymonadic_subcomp (m,n,uu___2,ty)
                  ->
        ...
        | (uu___1,env1) ->
            let r =
              ...
              FStar_Profiling.profile
                (fun uu___3  -> process_one_decl acc se) uu___2
...
let (tc_partial_modul :
  ...
  fun env  ->
    fun modul  ->
      let verify =
        let uu___ = FStar_Ident.string_of_lid modul.FStar_Syntax_Syntax.name
           in
...
let (tc_modul :
  ...
  fun env0  ->
    fun m  ->
      fun iface_exists  ->
        let msg =
          let uu___ = FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name
             in
...
let (load_checked_module :
  ...
  fun en  ->
    fun m  ->
      ...
      let env1 =
        let uu___ =
          let uu___1 = FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name
             in
               ...
               FStar_All.pipe_right lids
                 (FStar_List.iter
                    (fun lid  ->
                       ...
                       ()));
               env4) env1 m.FStar_Syntax_Syntax.declarations
         in
  ...
  fun env  ->
    fun m  ->
      fun b  ->
        ...
        (let uu___2 =
           let uu___3 = FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name
              in
