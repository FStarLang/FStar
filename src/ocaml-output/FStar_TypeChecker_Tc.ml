           ...
           let uu____8684 =
             let uu____8691 =
               FStar_TypeChecker_Env.lookup_effect_lid env
                 sub1.FStar_Syntax_Syntax.source in
             monad_signature env sub1.FStar_Syntax_Syntax.source uu____8691 in
                ...
                (match uu____8708 with
                 | (b, wp_b_tgt) ->
                     ...
                     let expected_k =
                       ...
                       let uu____8802 = FStar_Syntax_Syntax.mk_Total wp_a_tgt in
                                          ...
                                          let expected_k1 =
                                            ...
                                            let uu____9982 =
                                              FStar_Syntax_Syntax.mk_Total
                                                repr_result in
                                            FStar_Syntax_Util.arrow
                                              uu____9910 uu____9982 in
                                          let uu____9985 =
                                            FStar_TypeChecker_TcTerm.tc_tot_or_gtot_term
                                              env2 expected_k1 in
                                          (match uu____9985 with
                                           | (expected_k2, uu____10003,
                                              uu____10004) ->
                                               let lift3 =
                                                 if
                                                   (FStar_List.length uvs) =
                              ...
                              let uu____10071 =
                                let uu____10077 =
                                  ...
                                  FStar_Util.format3
                                    ...
                                    uu____10079 uu____10081 uu____10083 in
                              ...
                              let uu____10185 =
                                let uu____10191 =
                                  ...
                                  FStar_Util.format3
                                    ...
                                    uu____10193 uu____10195 uu____10197 in
                                (FStar_Errors.Fatal_TooManyUniverse,
                                  uu____10191) in
             ...
             then
               ...
               | (uvs1, t1) ->
                   ((let uu____10932 =
                     ...
                     if uu____10932
                     then
                       let uu____10937 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____10939 =
                         FStar_Syntax_Print.univ_names_to_string uvs1 in
                       FStar_Util.print2
                                ...
                                let uu____11128 =
                                  let uu____11130 =
                                    FStar_List.map FStar_Ident.string_of_lid
                                      lids' in
                                  FStar_All.pipe_left
                                    (FStar_String.concat ", ") uu____11130 in
                                FStar_Util.format2
                                  "Splice declared the name %s but it was not defined.\nThose defined were: %s"
                                  uu____11126 uu____11128 in
                              (FStar_Errors.Fatal_SplicedUndef, uu____11124) in
           ...
           let check_quals_eq l qopt val_q =
             ...
             | FStar_Pervasives_Native.Some q' ->
                 ...
                 then FStar_Pervasives_Native.Some q'
                   ...
                   (let uu____11256 =
                      let uu____11262 =
                        let uu____11264 = FStar_Syntax_Print.lid_to_string l in
                        let uu____11266 =
                        ...
                        FStar_Util.format3
                          ...
                          uu____11264 uu____11266 uu____11268 in
                      (FStar_Errors.Fatal_InconsistentQualifierAnnotation,
                        uu____11262) in
                    FStar_Errors.raise_error uu____11256 r) in
                             ...
                             | FStar_Pervasives_Native.Some
                                 ...
                                 (if
                                  ...
                                  (let uu____11916 =
                                   ...
                                   (false, uu____11916, quals_opt1))) in
                ...
                let e1 =
                  ...
                  then
                    let drop_lbtyp e_lax =
                      let uu____12097 =
                        let uu____12098 = FStar_Syntax_Subst.compress e_lax in
                        uu____12098.FStar_Syntax_Syntax.n in
                      match uu____12097 with
                      | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), e2) ->
                          let lb_unannotated =
                            let uu____12120 =
                              let uu____12121 = FStar_Syntax_Subst.compress e in
                             ...
                             let uu____12184 =
                               ...
                               FStar_All.pipe_right uu____12185
                                 (fun uu____12207 ->
                                    ...
                                    | (e1, uu____12215, uu____12216) -> e1) in
                             FStar_All.pipe_right uu____12184
                               (FStar_TypeChecker_Normalize.remove_uvar_solutions
                                  env') in
                           FStar_All.pipe_right uu____12183 drop_lbtyp) in
                     ...
                     (match uu____12373 with
                      | (r1, ms) ->
                          ((let uu____12420 =
                            ...
                            if uu____12420
                            then
                              let uu____12425 = FStar_Util.string_of_int ms in
                              FStar_Util.print1
                           ...
                           (let uu____12430 =
                              ...
                              | ({
                                   ...
                                   FStar_Syntax_Syntax.vars = uu____12456;_},
                                 uu____12457, g) when
                                                    ...
                                                    let uu____12641 =
                                                      let uu____12642 =
                                                        let uu____12645 =
                                                          FStar_Util.right
                                                            lb.FStar_Syntax_Syntax.lbname in
                                                        uu____12645.FStar_Syntax_Syntax.fv_name in
                                                      uu____12642.FStar_Syntax_Syntax.v in
...
let (tc_decl :
  ...
  fun env ->
    fun se ->
      ...
      (let uu____12720 = FStar_TypeChecker_Env.debug env1 FStar_Options.Low in
       if uu____12720
       then
           ...
           ((let uu____12797 =
             ...
             then
               let uu____12800 =
                 ...
                 FStar_All.pipe_left (FStar_String.concat "; ") uu____12802 in
               ...
               FStar_Errors.catch_errors
                 (fun uu____12846 ->
                    FStar_Options.with_saved_options
                      (fun uu____12858 -> tc_decl' env' se)) in
                  ...
                  (let sort = FStar_List.sortWith (fun x -> fun y -> x - y) in
                   ...
                   (match errs with
                    ...
                    | uu____12947 ->
                        ...
                        then
                          let uu____12958 =
                            let uu____12968 = check_multi_eq errnos1 actual in
                         ...
                         let dec =
                           ...
                           let uu____13323 =
                             let uu____13324 =
                               ...
                               (l, us, uu____13331) in
                             FStar_Syntax_Syntax.Sig_declare_typ uu____13324 in
                           {
...
let (add_sigelt_to_env :
  ...
  fun env ->
    fun se ->
      (let uu____13612 = FStar_TypeChecker_Env.debug env FStar_Options.Low in
       if uu____13612
       then
    ...
    fun ses ->
                         ...
                         FStar_List.fold_left
                           (fun s ->
                              fun se1 ->
                                ...
                                Prims.op_Hat s uu____13936) "" ses'1 in
                    ...
                    (let uu____13948 =
                       ...
                       then ((FStar_List.rev_append ses'1 exports), [])
                         ...
                         (let accum_exports_hidden uu____13999 se1 =
                            ...
                            | (exports1, hidden1) ->
                                let uu____14027 = for_export env3 hidden1 se1 in
      ...
      let process_one_decl_timed acc se =
        ...
        | (uu____14216, uu____14217, env1, uu____14219) ->
            let uu____14232 =
              FStar_Util.record_time
                (fun uu____14279 -> process_one_decl acc se) in
             ...
             | (r, ms_elapsed) ->
                 ((let uu____14345 =
                   ...
                   then
                     ...
                     let uu____14351 = FStar_Util.string_of_int ms_elapsed in
          ...
          | (univs2, t1) ->
              ((let uu____14470 =
               ...
               (let env2 = FStar_TypeChecker_Env.push_univ_vars env1 univs2 in
                ...
                FStar_All.pipe_right uu____14509 (fun a2 -> ()))) in
    ...
    fun m ->
      ...
      let should_keep_lbdef t =
        ...
        let c_opt =
          ...
          then
            ...
            (let uu____15065 =
             ...
             | uu____15097 -> FStar_Pervasives_Native.None) in
        match c_opt with
        ...
        | FStar_Pervasives_Native.Some c ->
            ...
            then false
              ...
              (let uu____15116 = FStar_Syntax_Util.is_pure_or_ghost_comp c in
               if uu____15116
               then true
               else
                 (let uu____15123 = comp_effect_name1 c in
                  FStar_TypeChecker_Env.is_reifiable_effect en uu____15123)) in
      let extract_sigelt s =
        ...
        (match s.FStar_Syntax_Syntax.sigel with
                 ...
                 (FStar_List.fold_left
                    (fun sigelts1 ->
                       fun s1 ->
                         ...
                         | FStar_Syntax_Syntax.Sig_inductive_typ
                             (lid, uu____15230, uu____15231, uu____15232,
                         ...
                         | FStar_Syntax_Syntax.Sig_datacon
                             (lid, uu____15300, uu____15301, uu____15302,
         ...
         | FStar_Syntax_Syntax.Sig_assume (lid, uu____15541, uu____15542) ->
             ...
             then
               let is_haseq_of_abstract_inductive =
                 let uu____15550 = FStar_ST.op_Bang abstract_inductive_tycons in
                 FStar_List.existsML
                   (fun l ->
                      let uu____15579 =
                        FStar_TypeChecker_TcInductive.get_haseq_axiom_lid l in
                      FStar_Ident.lid_equals lid uu____15579) uu____15550 in
         ...
         | FStar_Syntax_Syntax.Sig_pragma uu____15613 -> [s]) in
    ...
    fun modul ->
      ...
      (let name =
       ...
       let env2 =
         FStar_TypeChecker_Env.set_current_module env1
           modul.FStar_Syntax_Syntax.name in
       let uu____15836 = tc_decls env2 modul.FStar_Syntax_Syntax.declarations in
            ...
            let should_extract_interface =
              ((((Prims.op_Negation loading_from_cache) &&
                ...
                (let uu____16027 = FStar_Errors.get_err_count () in
                 uu____16027 = (Prims.parse_int "0")) in
              ...
              (let modul =
               ...
               (let uu____16219 =
                  ((let uu____16223 = FStar_Options.lax () in
                    ...
                    (let uu____16226 =
                       FStar_Options.use_extracted_interfaces () in
                     Prims.op_Negation uu____16226) in
