...
let uu___90_257 = ed
in {FStar_Syntax_Syntax.qualifiers = uu___90_257.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.cattributes = uu___90_257.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___90_257.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = uu___90_257.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = effect_params; FStar_Syntax_Syntax.signature = signature; FStar_Syntax_Syntax.ret_wp = uu___90_257.FStar_Syntax_Syntax.ret_wp; FStar_Syntax_Syntax.bind_wp = uu___90_257.FStar_Syntax_Syntax.bind_wp; FStar_Syntax_Syntax.if_then_else = uu___90_257.FStar_Syntax_Syntax.if_then_else; FStar_Syntax_Syntax.ite_wp = uu___90_257.FStar_Syntax_Syntax.ite_wp; FStar_Syntax_Syntax.stronger = uu___90_257.FStar_Syntax_Syntax.stronger; FStar_Syntax_Syntax.close_wp = uu___90_257.FStar_Syntax_Syntax.close_wp; FStar_Syntax_Syntax.assert_p = uu___90_257.FStar_Syntax_Syntax.assert_p; FStar_Syntax_Syntax.assume_p = uu___90_257.FStar_Syntax_Syntax.assume_p; FStar_Syntax_Syntax.null_wp = uu___90_257.FStar_Syntax_Syntax.null_wp; FStar_Syntax_Syntax.trivial = uu___90_257.FStar_Syntax_Syntax.trivial; FStar_Syntax_Syntax.repr = uu___90_257.FStar_Syntax_Syntax.repr; FStar_Syntax_Syntax.return_repr = uu___90_257.FStar_Syntax_Syntax.return_repr; FStar_Syntax_Syntax.bind_repr = uu___90_257.FStar_Syntax_Syntax.bind_repr; FStar_Syntax_Syntax.actions = uu___90_257.FStar_Syntax_Syntax.actions})
in (
...
in {FStar_Syntax_Syntax.action_name = uu___92_302.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_unqualified_name = uu___92_302.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = uu___92_302.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_params = uu___92_302.FStar_Syntax_Syntax.action_params; FStar_Syntax_Syntax.action_defn = uu____303; FStar_Syntax_Syntax.action_typ = uu____310})))) ed1.FStar_Syntax_Syntax.actions)
in {FStar_Syntax_Syntax.qualifiers = uu___91_279.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.cattributes = uu___91_279.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___91_279.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = uu___91_279.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = uu___91_279.FStar_Syntax_Syntax.binders; FStar_Syntax_Syntax.signature = uu___91_279.FStar_Syntax_Syntax.signature; FStar_Syntax_Syntax.ret_wp = uu____280; FStar_Syntax_Syntax.bind_wp = uu____281; FStar_Syntax_Syntax.if_then_else = uu____282; FStar_Syntax_Syntax.ite_wp = uu____283; FStar_Syntax_Syntax.stronger = uu____284; FStar_Syntax_Syntax.close_wp = uu____285; FStar_Syntax_Syntax.assert_p = uu____286; FStar_Syntax_Syntax.assume_p = uu____287; FStar_Syntax_Syntax.null_wp = uu____288; FStar_Syntax_Syntax.trivial = uu____289; FStar_Syntax_Syntax.repr = uu____290; FStar_Syntax_Syntax.return_repr = uu____297; FStar_Syntax_Syntax.bind_repr = uu____298; FStar_Syntax_Syntax.actions = uu____299}))))))))))))))))
end)
in (
...
let uu___93_965 = env2
in {FStar_TypeChecker_Env.solver = uu___93_965.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___93_965.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___93_965.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___93_965.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___93_965.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___93_965.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___93_965.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___93_965.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___93_965.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___93_965.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___93_965.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___93_965.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___93_965.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___93_965.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___93_965.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___93_965.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___93_965.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___93_965.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___93_965.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___93_965.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___93_965.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___93_965.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___93_965.FStar_TypeChecker_Env.qname_and_index})
in (
...
let uu___94_1057 = (FStar_TypeChecker_Env.set_expected_typ env1 act_typ)
in {FStar_TypeChecker_Env.solver = uu___94_1057.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___94_1057.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___94_1057.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___94_1057.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___94_1057.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___94_1057.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___94_1057.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___94_1057.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___94_1057.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = false; FStar_TypeChecker_Env.effects = uu___94_1057.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___94_1057.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___94_1057.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___94_1057.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___94_1057.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___94_1057.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___94_1057.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___94_1057.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___94_1057.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___94_1057.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___94_1057.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___94_1057.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___94_1057.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___94_1057.FStar_TypeChecker_Env.qname_and_index})
in ((
...
let uu___95_1201 = act
in {FStar_Syntax_Syntax.action_name = uu___95_1201.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_unqualified_name = uu___95_1201.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = univs1; FStar_Syntax_Syntax.action_params = uu___95_1201.FStar_Syntax_Syntax.action_params; FStar_Syntax_Syntax.action_defn = act_defn2; FStar_Syntax_Syntax.action_typ = act_typ3}))
end)));
))
end))))
end));
...
let uu___96_1297 = act
in {FStar_Syntax_Syntax.action_name = uu___96_1297.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_unqualified_name = uu___96_1297.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = univs2; FStar_Syntax_Syntax.action_params = uu___96_1297.FStar_Syntax_Syntax.action_params; FStar_Syntax_Syntax.action_defn = defn; FStar_Syntax_Syntax.action_typ = typ})
end))
end)))
in (
...
in {FStar_Syntax_Syntax.ppname = uu___98_1376.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___98_1376.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1377}))
in ((uu____1375), (qual)))
end)) effect_binders)
in (
...
| (action_params, env', uu____2197) -> begin
(

let action_params1 = (FStar_List.map (fun uu____2206 -> (match (uu____2206) with
| (bv, qual) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___99_2214.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___99_2214.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2215}))
in ((uu____2213), (qual)))
end)) action_params)
in (
...
let uu____2219 = (elaborate_and_star dmff_env' action_params1 ((action.FStar_Syntax_Syntax.action_univs), (action.FStar_Syntax_Syntax.action_defn)))
...
in {FStar_Syntax_Syntax.action_name = uu___100_2261.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_unqualified_name = uu___100_2261.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = uu___100_2261.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_params = []; FStar_Syntax_Syntax.action_defn = uu____2262; FStar_Syntax_Syntax.action_typ = uu____2263})))
...
in (([]), (uu____2595)))
in {FStar_Syntax_Syntax.qualifiers = uu___101_2569.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.cattributes = uu___101_2569.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___101_2569.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = uu___101_2569.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = uu____2570; FStar_Syntax_Syntax.signature = uu____2571; FStar_Syntax_Syntax.ret_wp = uu____2572; FStar_Syntax_Syntax.bind_wp = uu____2579; FStar_Syntax_Syntax.if_then_else = uu___101_2569.FStar_Syntax_Syntax.if_then_else; FStar_Syntax_Syntax.ite_wp = uu___101_2569.FStar_Syntax_Syntax.ite_wp; FStar_Syntax_Syntax.stronger = uu___101_2569.FStar_Syntax_Syntax.stronger; FStar_Syntax_Syntax.close_wp = uu___101_2569.FStar_Syntax_Syntax.close_wp; FStar_Syntax_Syntax.assert_p = uu___101_2569.FStar_Syntax_Syntax.assert_p; FStar_Syntax_Syntax.assume_p = uu___101_2569.FStar_Syntax_Syntax.assume_p; FStar_Syntax_Syntax.null_wp = uu___101_2569.FStar_Syntax_Syntax.null_wp; FStar_Syntax_Syntax.trivial = uu___101_2569.FStar_Syntax_Syntax.trivial; FStar_Syntax_Syntax.repr = uu____2586; FStar_Syntax_Syntax.return_repr = uu____2587; FStar_Syntax_Syntax.bind_repr = uu____2594; FStar_Syntax_Syntax.actions = actions1}))))))))
in (
...
let uu___102_3084 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_new_effect (ne1); FStar_Syntax_Syntax.sigrng = uu___102_3084.FStar_Syntax_Syntax.sigrng}))::(lift)::[]
end
| None -> begin
((

let uu___103_3085 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_new_effect (ne1); FStar_Syntax_Syntax.sigrng = uu___103_3085.FStar_Syntax_Syntax.sigrng}))::[]
end)
...
let uu___104_3091 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_new_effect (ne1); FStar_Syntax_Syntax.sigrng = uu___104_3091.FStar_Syntax_Syntax.sigrng})
in (((se1)::[]), ([]))))
end
...
let uu___105_3313 = env1
in {FStar_TypeChecker_Env.solver = uu___105_3313.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___105_3313.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___105_3313.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___105_3313.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___105_3313.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___105_3313.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___105_3313.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___105_3313.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___105_3313.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___105_3313.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___105_3313.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___105_3313.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___105_3313.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___105_3313.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___105_3313.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___105_3313.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___105_3313.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___105_3313.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___105_3313.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___105_3313.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___105_3313.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___105_3313.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___105_3313.FStar_TypeChecker_Env.qname_and_index})
in (
...
let uu___106_3408 = sub1
in {FStar_Syntax_Syntax.source = uu___106_3408.FStar_Syntax_Syntax.source; FStar_Syntax_Syntax.target = uu___106_3408.FStar_Syntax_Syntax.target; FStar_Syntax_Syntax.lift_wp = Some (lift_wp); FStar_Syntax_Syntax.lift = lift1})
in (

let se1 = (

let uu___107_3410 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_sub_effect (sub2); FStar_Syntax_Syntax.sigrng = uu___107_3410.FStar_Syntax_Syntax.sigrng})
in (((se1)::[]), ([])))))))
end)))))
end))
end))))
...
let uu___108_3584 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_effect_abbrev (((lid), (uvs1), (tps4), (c4), (tags), (flags))); FStar_Syntax_Syntax.sigrng = uu___108_3584.FStar_Syntax_Syntax.sigrng})
in (((se1)::[]), ([])));
)
end))
end))));
...
| (FStar_Syntax_Syntax.Sig_declare_typ (_, _, _, quals)) | (FStar_Syntax_Syntax.Sig_let (_, _, quals, _)) when (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___82_3609 -> (match (uu___82_3609) with
...
let uu___109_3647 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((lid), (uvs1), (t1), (quals))); FStar_Syntax_Syntax.sigrng = uu___109_3647.FStar_Syntax_Syntax.sigrng})
in (((se1)::[]), ([])))
end)))
end
...
let uu___110_3699 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_main (e2); FStar_Syntax_Syntax.sigrng = uu___110_3699.FStar_Syntax_Syntax.sigrng})
in (((se1)::[]), ([])));
)
end))
end))))
...
let uu____3921 = (FStar_All.pipe_right q (FStar_Util.for_some (fun uu___83_3923 -> (match (uu___83_3923) with
...
let uu___111_3976 = env2
in {FStar_TypeChecker_Env.solver = uu___111_3976.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___111_3976.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___111_3976.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___111_3976.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___111_3976.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___111_3976.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___111_3976.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___111_3976.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___111_3976.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___111_3976.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___111_3976.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = should_generalize; FStar_TypeChecker_Env.letrecs = uu___111_3976.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = uu___111_3976.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___111_3976.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___111_3976.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___111_3976.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___111_3976.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___111_3976.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___111_3976.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___111_3976.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___111_3976.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___111_3976.FStar_TypeChecker_Env.qname_and_index}) e)
...
let quals3 = (FStar_List.choose (fun uu___84_4014 -> (match (uu___84_4014) with
...
let uu___112_4030 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let (((lbs1), (lids), (quals3), (attrs))); FStar_Syntax_Syntax.sigrng = uu___112_4030.FStar_Syntax_Syntax.sigrng})), (lbs1))))
end
| uu____4037 -> begin
(failwith "impossible")
end))
...
let is_abstract = (fun quals -> (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___85_4126 -> (match (uu___85_4126) with
...
in {FStar_Syntax_Syntax.sigel = uu____4211; FStar_Syntax_Syntax.sigrng = uu___113_4210.FStar_Syntax_Syntax.sigrng}))
in (((dec)::out), (hidden1)))
end
...
let uu___114_4241 = se1
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), (us), (t), ((FStar_Syntax_Syntax.Assumption)::[]))); FStar_Syntax_Syntax.sigrng = uu___114_4241.FStar_Syntax_Syntax.sigrng})
...
let uu___115_4286 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), (us), (t), ((FStar_Syntax_Syntax.Assumption)::[]))); FStar_Syntax_Syntax.sigrng = uu___115_4286.FStar_Syntax_Syntax.sigrng}))::[]), ((l)::hidden))
end
| uu____4288 -> begin
(

let uu____4289 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___86_4291 -> (match (uu___86_4291) with
...
in {FStar_Syntax_Syntax.sigel = uu____4376; FStar_Syntax_Syntax.sigrng = uu___116_4375.FStar_Syntax_Syntax.sigrng})))))
...
| (FStar_Syntax_Syntax.Sig_declare_typ (_, _, _, quals)) | (FStar_Syntax_Syntax.Sig_let (_, _, quals, _)) when (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___87_4455 -> (match (uu___87_4455) with
| FStar_Syntax_Syntax.OnlyName -> begin
true
end
| uu____4456 -> begin
...
let uu___117_4702 = env
in {FStar_TypeChecker_Env.solver = uu___117_4702.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___117_4702.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___117_4702.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___117_4702.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___117_4702.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___117_4702.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___117_4702.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___117_4702.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___117_4702.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___117_4702.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___117_4702.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___117_4702.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___117_4702.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___117_4702.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___117_4702.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___117_4702.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = modul.FStar_Syntax_Syntax.is_interface; FStar_TypeChecker_Env.admit = (not (verify)); FStar_TypeChecker_Env.lax = uu___117_4702.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___117_4702.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___117_4702.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___117_4702.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___117_4702.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___117_4702.FStar_TypeChecker_Env.qname_and_index})
...
let uu___118_4723 = modul
in {FStar_Syntax_Syntax.name = uu___118_4723.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = ses; FStar_Syntax_Syntax.exports = uu___118_4723.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___118_4723.FStar_Syntax_Syntax.is_interface})), (exports), (env3))
end)));
))));
)))))
...
let uu___119_4757 = modul
in {FStar_Syntax_Syntax.name = uu___119_4757.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = (FStar_List.append modul.FStar_Syntax_Syntax.declarations ses); FStar_Syntax_Syntax.exports = uu___119_4757.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___119_4757.FStar_Syntax_Syntax.is_interface})
...
let uu___120_4771 = env
in {FStar_TypeChecker_Env.solver = uu___120_4771.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___120_4771.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___120_4771.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___120_4771.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___120_4771.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___120_4771.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___120_4771.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___120_4771.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___120_4771.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___120_4771.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___120_4771.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___120_4771.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___120_4771.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = uu___120_4771.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___120_4771.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___120_4771.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___120_4771.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = true; FStar_TypeChecker_Env.type_of = uu___120_4771.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___120_4771.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___120_4771.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___120_4771.FStar_TypeChecker_Env.qname_and_index})
in (
...
let uu___121_4972 = modul
in {FStar_Syntax_Syntax.name = uu___121_4972.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = uu___121_4972.FStar_Syntax_Syntax.declarations; FStar_Syntax_Syntax.exports = exports; FStar_Syntax_Syntax.is_interface = modul.FStar_Syntax_Syntax.is_interface})
in (
...
in (not (uu____5022)))
in {FStar_TypeChecker_Env.solver = uu___122_5020.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___122_5020.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___122_5020.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___122_5020.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___122_5020.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___122_5020.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___122_5020.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___122_5020.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___122_5020.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___122_5020.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___122_5020.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___122_5020.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___122_5020.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___122_5020.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___122_5020.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___122_5020.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___122_5020.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___122_5020.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu____5021; FStar_TypeChecker_Env.lax_universes = uu___122_5020.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___122_5020.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___122_5020.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___122_5020.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___122_5020.FStar_TypeChecker_Env.qname_and_index}))
in (
...
in (n1 uu____5074 e))
in {FStar_Syntax_Syntax.lbname = uu___123_5070.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___123_5070.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___123_5070.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___123_5070.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____5071}))
end)))
in (

let uu___124_5075 = se
in (
...
in {FStar_Syntax_Syntax.sigel = uu____5076; FStar_Syntax_Syntax.sigrng = uu___124_5075.FStar_Syntax_Syntax.sigrng}))))
end
| uu____5098 -> begin
se
end))
...
let uu___125_5100 = m1
in (

let uu____5101 = (FStar_List.map normalize_toplevel_lets m1.FStar_Syntax_Syntax.declarations)
in {FStar_Syntax_Syntax.name = uu___125_5100.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = uu____5101; FStar_Syntax_Syntax.exports = uu___125_5100.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___125_5100.FStar_Syntax_Syntax.is_interface}))
in (
