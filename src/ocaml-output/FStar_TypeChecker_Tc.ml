...
in (
# 2860 "FStar.TypeChecker.Tc.fst"
let _58_3825 = (
# 2861 "FStar.TypeChecker.Tc.fst"
let ty = (FStar_List.hd tcs)
in (match (ty) with
...
in (
# 2873 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.push_univ_vars env us)
in (
# 2874 "FStar.TypeChecker.Tc.fst"
...
(
# 2901 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.set_range env r)
in (
# 2902 "FStar.TypeChecker.Tc.fst"
...
(
# 2987 "FStar.TypeChecker.Tc.fst"
let _58_3976 = ()
in (
# 2988 "FStar.TypeChecker.Tc.fst"
let env0 = env
in (
# 2989 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.set_range env r)
in (
# 2990 "FStar.TypeChecker.Tc.fst"
let _58_3982 = (FStar_Syntax_Subst.open_comp tps c)
in (match (_58_3982) with
| (tps, c) -> begin
(
# 2991 "FStar.TypeChecker.Tc.fst"
...
| (tps, c) -> begin
(
# 3001 "FStar.TypeChecker.Tc.fst"
let se = FStar_Syntax_Syntax.Sig_effect_abbrev (((lid), (uvs), (tps), (c), (tags), (r)))
in (
# 3002 "FStar.TypeChecker.Tc.fst"
...
(
# 3006 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.set_range env r)
in (
# 3007 "FStar.TypeChecker.Tc.fst"
let _58_4027 = ()
in (
# 3008 "FStar.TypeChecker.Tc.fst"
...
| (uvs, t) -> begin
(
# 3009 "FStar.TypeChecker.Tc.fst"
let se = FStar_Syntax_Syntax.Sig_declare_typ (((lid), (uvs), (t), (quals), (r)))
in (
# 3010 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.push_sigelt env se)
in (((se)::[]), (env))))
end))))
end
...
(
# 3014 "FStar.TypeChecker.Tc.fst"
let se = (tc_assume env lid phi quals r)
in (
# 3015 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.push_sigelt env se)
in (((se)::[]), (env))))
end
| FStar_Syntax_Syntax.Sig_main (e, r) -> begin
(
# 3019 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.set_range env r)
in (
# 3020 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.set_expected_typ env FStar_TypeChecker_Common.t_unit)
in (
# 3021 "FStar.TypeChecker.Tc.fst"
let _58_4051 = (tc_term env e)
in (match (_58_4051) with
| (e, c, g1) -> begin
(
# 3022 "FStar.TypeChecker.Tc.fst"
...
in (
# 3024 "FStar.TypeChecker.Tc.fst"
let se = FStar_Syntax_Syntax.Sig_main (((e), (r)))
in (
# 3025 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.push_sigelt env se)
in (((se)::[]), (env)))))
end))
end))))
...
(
# 3029 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.set_range env r)
in (
# 3030 "FStar.TypeChecker.Tc.fst"
...
(
# 3050 "FStar.TypeChecker.Tc.fst"
let quals_opt = (check_quals_eq lbname.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v quals_opt quals)
in (
# 3051 "FStar.TypeChecker.Tc.fst"
...
in (
# 3067 "FStar.TypeChecker.Tc.fst"
let lbs' = (FStar_List.rev lbs')
in (
# 3070 "FStar.TypeChecker.Tc.fst"
...
# 3096 "FStar.TypeChecker.Tc.fst"
let for_export : FStar_Ident.lident Prims.list  ->  FStar_Syntax_Syntax.sigelt  ->  (FStar_Syntax_Syntax.sigelt Prims.list * FStar_Ident.lident Prims.list) = (fun hidden se -> (
# 3120 "FStar.TypeChecker.Tc.fst"
...
(
# 3169 "FStar.TypeChecker.Tc.fst"
let fv = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in (
# 3170 "FStar.TypeChecker.Tc.fst"
let lid = fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v
in if (FStar_All.pipe_right hidden (FStar_Util.for_some (FStar_Syntax_Syntax.fv_eq_lid fv))) then begin
(([]), (hidden))
end else begin
(
# 3173 "FStar.TypeChecker.Tc.fst"
...
in (
# 3187 "FStar.TypeChecker.Tc.fst"
let _58_4297 = (tc_decl env se)
in (match (_58_4297) with
| (ses', env) -> begin
(
# 3189 "FStar.TypeChecker.Tc.fst"
...
# 3213 "FStar.TypeChecker.Tc.fst"
let tc_partial_modul : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  (FStar_Syntax_Syntax.modul * FStar_Syntax_Syntax.sigelt Prims.list * FStar_TypeChecker_Env.env) = (fun env modul -> (
# 3214 "FStar.TypeChecker.Tc.fst"
...
in (
# 3215 "FStar.TypeChecker.Tc.fst"
let msg = (Prims.strcat "Internals for " name)
in (
# 3216 "FStar.TypeChecker.Tc.fst"
let env = (
# 3216 "FStar.TypeChecker.Tc.fst"
let _58_4343 = env
...
# 3228 "FStar.TypeChecker.Tc.fst"
let finish_partial_modul : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  FStar_Syntax_Syntax.sigelts  ->  (FStar_Syntax_Syntax.modul * FStar_TypeChecker_Env.env) = (fun env modul exports -> (
# 3229 "FStar.TypeChecker.Tc.fst"
let modul = (
# 3229 "FStar.TypeChecker.Tc.fst"
let _58_4368 = modul
...
in (
# 3230 "FStar.TypeChecker.Tc.fst"
let env = (FStar_TypeChecker_Env.finish_module env modul)
in (
# 3231 "FStar.TypeChecker.Tc.fst"
...
in (
# 3274 "FStar.TypeChecker.Tc.fst"
let ok = (fun u -> (
# 3275 "FStar.TypeChecker.Tc.fst"
...
# 3298 "FStar.TypeChecker.Tc.fst"
let check_module : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  (FStar_Syntax_Syntax.modul * FStar_TypeChecker_Env.env) = (fun env m -> (
# 3299 "FStar.TypeChecker.Tc.fst"
...
in (
# 3301 "FStar.TypeChecker.Tc.fst"
let _58_4471 = (tc_modul env m)
in (match (_58_4471) with
| (m, env) -> begin
(
# 3302 "FStar.TypeChecker.Tc.fst"
