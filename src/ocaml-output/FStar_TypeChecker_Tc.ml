...
let _59_837 = (match ((let _154_509 = (FStar_Syntax_Subst.compress head)
in _154_509.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv) when (FStar_Syntax_Syntax.fv_eq_lid fv tc_lid) -> begin
()
end
| _59_836 -> begin
(let _154_514 = (let _154_513 = (let _154_512 = (let _154_511 = (FStar_Syntax_Print.lid_to_string tc_lid)
in (let _154_510 = (FStar_Syntax_Print.term_to_string head)
in (FStar_Util.format2 "Expected a constructor of type %s; got %s" _154_511 _154_510)))
in ((_154_512), (r)))
...
let _59_845 = ()
in (let _154_518 = (FStar_TypeChecker_Rel.universe_inequality u_x u_tc)
in (FStar_TypeChecker_Rel.conj_guard g _154_518)))
end)) FStar_TypeChecker_Rel.trivial_guard arguments us)
in (

let t = (let _154_522 = (let _154_520 = (FStar_All.pipe_right tps (FStar_List.map (fun _59_851 -> (match (_59_851) with
| (x, _59_850) -> begin
((x), (Some (FStar_Syntax_Syntax.Implicit (true))))
end))))
in (FStar_List.append _154_520 arguments))
in (let _154_521 = (FStar_Syntax_Syntax.mk_Total result)
in (FStar_Syntax_Util.arrow _154_522 _154_521)))
...
(let _154_533 = (let _154_532 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_All.pipe_left (FStar_Syntax_Util.arrow tps) _154_532))
in (FStar_Syntax_Syntax.null_binder _154_533))
end
| _59_880 -> begin
(FStar_All.failwith "Impossible")
end))))
...
let t = (let _154_535 = (FStar_Syntax_Syntax.mk_Total FStar_TypeChecker_Common.t_unit)
in (FStar_Syntax_Util.arrow (FStar_List.append binders binders') _154_535))
in (

let _59_904 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _154_536 = (FStar_TypeChecker_Normalize.term_to_string env t)
...
(let _154_540 = (let _154_538 = (FStar_All.pipe_right uvs (FStar_List.map (fun u -> u.FStar_Ident.idText)))
in (FStar_All.pipe_right _154_538 (FStar_String.concat ", ")))
in (let _154_539 = (FStar_Syntax_Print.term_to_string t)
...
let _59_955 = (match ((let _154_543 = (FStar_Syntax_Subst.compress ty)
...
| _59_949 -> begin
(let _154_544 = (FStar_ST.read x.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((rest), (c)))) _154_544 x.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.pos))
end)
in ((tps), (t)))
end))
end
...
let uvs_universes = (FStar_All.pipe_right uvs (FStar_List.map (fun _154_545 -> FStar_Syntax_Syntax.U_name (_154_545))))
in (
...
let ty = (let _154_549 = (FStar_Syntax_InstFV.instantiate tc_insts t.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _154_549 (FStar_Syntax_Subst.close_univ_vars uvs)))
...
(let _154_554 = (let _154_553 = (let _154_552 = (FStar_TypeChecker_Env.get_range env)
in (("Mutually defined type contains a non-inductive element"), (_154_552)))
in FStar_Syntax_Syntax.Error (_154_553))
in (Prims.raise _154_554))
end else begin
()
end
in (
...
(let _154_557 = (FStar_Syntax_Print.sigelt_to_string tc)
in (FStar_Util.print1 "Checked inductive: %s\n" _154_557))
end else begin
()
end
in (let _154_559 = (let _154_558 = (FStar_TypeChecker_Rel.conj_guard guard g')
in (FStar_TypeChecker_Rel.conj_guard g _154_558))
in ((env), ((((tc), (tc_u)))::all_tcs), (_154_559)))))
end))
...
| (data, g') -> begin
(let _154_562 = (FStar_TypeChecker_Rel.conj_guard g g')
in (((data)::datas), (_154_562)))
end))
end)) datas (([]), (g)))
...
let _59_1052 = (let _154_563 = (FStar_List.map Prims.fst tcs)
in (generalize_and_inst_within env0 g _154_563 datas))
in (match (_59_1052) with
| (tcs, datas) -> begin
(

let sig_bndle = (let _154_565 = (let _154_564 = (FStar_TypeChecker_Env.get_range env0)
in (((FStar_List.append tcs datas)), (quals), (lids), (_154_564)))
in FStar_Syntax_Syntax.Sig_bundle (_154_565))
in (
...
let t = (let _154_578 = (FStar_Syntax_Subst.shift_subst (FStar_List.length bs) usubst)
in (FStar_Syntax_Subst.subst _154_578 t))
in (
...
let ibs = (match ((let _154_579 = (FStar_Syntax_Subst.compress t)
in _154_579.FStar_Syntax_Syntax.n)) with
...
let ind = (let _154_582 = (FStar_Syntax_Syntax.fvar lid FStar_Syntax_Syntax.Delta_constant None)
in (let _154_581 = (FStar_List.map (fun u -> FStar_Syntax_Syntax.U_name (u)) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst _154_582 _154_581)))
in (

let ind = (let _154_585 = (FStar_List.map (fun _59_1123 -> (match (_59_1123) with
| (bv, aq) -> begin
(let _154_584 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((_154_584), (aq)))
end)) bs)
in (FStar_Syntax_Syntax.mk_Tm_app ind _154_585 None dr))
in (

let ind = (let _154_588 = (FStar_List.map (fun _59_1127 -> (match (_59_1127) with
| (bv, aq) -> begin
(let _154_587 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((_154_587), (aq)))
end)) ibs)
in (FStar_Syntax_Syntax.mk_Tm_app ind _154_588 None dr))
in (

let haseq_ind = (let _154_590 = (let _154_589 = (FStar_Syntax_Syntax.as_arg ind)
in (_154_589)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _154_590 None dr))
in (
...
let opt = (let _154_593 = (let _154_592 = (FStar_Syntax_Util.type_u ())
in (Prims.fst _154_592))
in (FStar_TypeChecker_Rel.try_subtype' en (Prims.fst b).FStar_Syntax_Syntax.sort _154_593 false))
in (match (opt) with
| None -> begin
false
end
...
let haseq_bs = (FStar_List.fold_left (fun t b -> (let _154_599 = (let _154_598 = (let _154_597 = (let _154_596 = (FStar_Syntax_Syntax.bv_to_name (Prims.fst b))
in (FStar_Syntax_Syntax.as_arg _154_596))
in (_154_597)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _154_598 None dr))
in (FStar_Syntax_Util.mk_conj t _154_599))) FStar_Syntax_Util.t_true bs')
in (
...
let _59_1149 = fml
in (let _154_605 = (let _154_604 = (let _154_603 = (let _154_602 = (let _154_601 = (let _154_600 = (FStar_Syntax_Syntax.as_arg haseq_ind)
in (_154_600)::[])
in (_154_601)::[])
in FStar_Syntax_Syntax.Meta_pattern (_154_602))
in ((fml), (_154_603)))
in FStar_Syntax_Syntax.Tm_meta (_154_604))
in {FStar_Syntax_Syntax.n = _154_605; FStar_Syntax_Syntax.tk = _59_1149.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _59_1149.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _59_1149.FStar_Syntax_Syntax.vars}))
in (

let fml = (FStar_List.fold_right (fun b t -> (let _154_611 = (let _154_610 = (let _154_609 = (let _154_608 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) _154_608 None))
in (FStar_Syntax_Syntax.as_arg _154_609))
in (_154_610)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_611 None dr))) ibs fml)
in (
...
in (_154_616)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_617 None dr))) bs fml)
in (
...
in (match ((let _154_621 = (FStar_Syntax_Subst.compress dt)
in _154_621.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (dbs, _59_1193) -> begin
(

let dbs = (let _154_622 = (FStar_List.splitAt (FStar_List.length bs) dbs)
in (Prims.snd _154_622))
in (

let dbs = (let _154_623 = (FStar_Syntax_Subst.opening_of_binders bs)
in (FStar_Syntax_Subst.subst_binders _154_623 dbs))
in (
...
let haseq_b = (let _154_627 = (let _154_626 = (FStar_Syntax_Syntax.as_arg (Prims.fst b).FStar_Syntax_Syntax.sort)
in (_154_626)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _154_627 None dr))
in (

let sort_range = (Prims.fst b).FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.pos
in (

let haseq_b = (let _154_629 = (let _154_628 = (FStar_Syntax_Print.term_to_string ind)
in (FStar_Util.format1 "Failed to prove that the type \'%s\' supports decidable equality because of this argument; add the \'noeq\' qualifier" _154_628))
in (FStar_TypeChecker_Util.label _154_629 sort_range haseq_b))
in (FStar_Syntax_Util.mk_conj t haseq_b))))) FStar_Syntax_Util.t_true dbs)
in (FStar_List.fold_right (fun b t -> (let _154_635 = (let _154_634 = (let _154_633 = (let _154_632 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) _154_632 None))
in (FStar_Syntax_Syntax.as_arg _154_633))
in (_154_634)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_635 None dr))) dbs cond)))))
end
| _59_1208 -> begin
...
let cond = (FStar_List.fold_left (fun acc d -> (let _154_638 = (haseq_data d)
in (FStar_Syntax_Util.mk_conj acc _154_638))) FStar_Syntax_Util.t_true t_datas)
in (

let axiom_lid = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns (((FStar_Ident.id_of_text (Prims.strcat lid.FStar_Ident.ident.FStar_Ident.idText "_haseq")))::[])))
in (let _154_640 = (FStar_Syntax_Util.mk_conj guard' guard)
in (let _154_639 = (FStar_Syntax_Util.mk_conj cond' cond)
in (((FStar_List.append l_axioms ((((axiom_lid), (fml)))::[]))), (env), (_154_640), (_154_639))))))))))
end)))))))))))))))
end))))
end)))
in (
...
(let _154_641 = (FStar_TypeChecker_Rel.guard_of_guard_formula (FStar_TypeChecker_Common.NonTrivial (phi)))
in (FStar_TypeChecker_Rel.force_trivial_guard env _154_641))
end else begin
()
end
in (
...
let t = (let _154_655 = (FStar_Syntax_Subst.shift_subst (FStar_List.length bs) usubst)
in (FStar_Syntax_Subst.subst _154_655 t))
in (
...
let ibs = (match ((let _154_656 = (FStar_Syntax_Subst.compress t)
in _154_656.FStar_Syntax_Syntax.n)) with
...
let ind = (let _154_659 = (FStar_Syntax_Syntax.fvar lid FStar_Syntax_Syntax.Delta_constant None)
in (let _154_658 = (FStar_List.map (fun u -> FStar_Syntax_Syntax.U_name (u)) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst _154_659 _154_658)))
in (

let ind = (let _154_662 = (FStar_List.map (fun _59_1331 -> (match (_59_1331) with
| (bv, aq) -> begin
(let _154_661 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((_154_661), (aq)))
end)) bs)
in (FStar_Syntax_Syntax.mk_Tm_app ind _154_662 None dr))
in (

let ind = (let _154_665 = (FStar_List.map (fun _59_1335 -> (match (_59_1335) with
| (bv, aq) -> begin
(let _154_664 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((_154_664), (aq)))
end)) ibs)
in (FStar_Syntax_Syntax.mk_Tm_app ind _154_665 None dr))
in (

let haseq_ind = (let _154_667 = (let _154_666 = (FStar_Syntax_Syntax.as_arg ind)
in (_154_666)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _154_667 None dr))
in (

let rec is_mutual = (fun t -> (match ((let _154_671 = (FStar_Syntax_Subst.compress t)
in _154_671.FStar_Syntax_Syntax.n)) with
...
(let _154_673 = (FStar_List.map Prims.fst args)
in (exists_mutual _154_673))
end
end
...
let dt = (FStar_Syntax_Subst.subst usubst dt)
in (match ((let _154_679 = (FStar_Syntax_Subst.compress dt)
in _154_679.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (dbs, _59_1376) -> begin
(

let dbs = (let _154_680 = (FStar_List.splitAt (FStar_List.length bs) dbs)
in (Prims.snd _154_680))
in (

let dbs = (let _154_681 = (FStar_Syntax_Subst.opening_of_binders bs)
in (FStar_Syntax_Subst.subst_binders _154_681 dbs))
in (
...
let haseq_sort = (let _154_685 = (let _154_684 = (FStar_Syntax_Syntax.as_arg (Prims.fst b).FStar_Syntax_Syntax.sort)
in (_154_684)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _154_685 None dr))
in (
...
let cond = (FStar_List.fold_right (fun b t -> (let _154_691 = (let _154_690 = (let _154_689 = (let _154_688 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) _154_688 None))
in (FStar_Syntax_Syntax.as_arg _154_689))
in (_154_690)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_691 None dr))) dbs cond)
...
let _59_1416 = fml
in (let _154_698 = (let _154_697 = (let _154_696 = (let _154_695 = (let _154_694 = (let _154_693 = (FStar_Syntax_Syntax.as_arg haseq_ind)
in (_154_693)::[])
in (_154_694)::[])
in FStar_Syntax_Syntax.Meta_pattern (_154_695))
in ((fml), (_154_696)))
in FStar_Syntax_Syntax.Tm_meta (_154_697))
in {FStar_Syntax_Syntax.n = _154_698; FStar_Syntax_Syntax.tk = _59_1416.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _59_1416.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _59_1416.FStar_Syntax_Syntax.vars}))
in (

let fml = (FStar_List.fold_right (fun b t -> (let _154_704 = (let _154_703 = (let _154_702 = (let _154_701 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) _154_701 None))
in (FStar_Syntax_Syntax.as_arg _154_702))
in (_154_703)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_704 None dr))) ibs fml)
in (
...
in (_154_709)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_710 None dr))) bs fml)
...
let se = (let _154_711 = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns (((FStar_Ident.id_of_text (Prims.strcat lid.FStar_Ident.ident.FStar_Ident.idText "_haseq")))::[])))
in (tc_assume env _154_711 fml [] dr))
in (
...
in (let _154_719 = (let _154_718 = (let _154_717 = (FStar_TypeChecker_Env.get_range env0)
in (((FStar_List.append tcs datas)), (quals), (lids), (_154_717)))
in FStar_Syntax_Syntax.Sig_bundle (_154_718))
in (_154_719)::ses)))
end)))))))
end))
end))
...
in (let _154_722 = (FStar_TypeChecker_Env.push_sigelt env se)
in (((se)::[]), (_154_722)))))
end
...
let _59_1538 = (let _154_729 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _154_729 Prims.ignore))
in (
...
in (let _154_732 = (FStar_TypeChecker_Env.push_sigelt env se_let)
in ((_154_732), ((se_let)::ses))))
end)) ((env), ((se)::[]))))
...
let _59_1573 = (let _154_733 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _154_733))
in (match (_59_1573) with
| (a, wp_a_src) -> begin
(

let _59_1576 = (let _154_734 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
in (monad_signature env sub.FStar_Syntax_Syntax.target _154_734))
in (match (_59_1576) with
| (b, wp_b_tgt) -> begin
(

let wp_a_tgt = (let _154_738 = (let _154_737 = (let _154_736 = (let _154_735 = (FStar_Syntax_Syntax.bv_to_name a)
in ((b), (_154_735)))
in FStar_Syntax_Syntax.NT (_154_736))
in (_154_737)::[])
in (FStar_Syntax_Subst.subst _154_738 wp_b_tgt))
in (

let expected_k = (let _154_743 = (let _154_741 = (FStar_Syntax_Syntax.mk_binder a)
in (let _154_740 = (let _154_739 = (FStar_Syntax_Syntax.null_binder wp_a_src)
in (_154_739)::[])
in (_154_741)::_154_740))
in (let _154_742 = (FStar_Syntax_Syntax.mk_Total wp_a_tgt)
in (FStar_Syntax_Util.arrow _154_743 _154_742)))
in (

let repr_type = (fun eff_name a wp -> (

let no_reify = (fun l -> (let _154_755 = (let _154_754 = (let _154_753 = (FStar_Util.format1 "Effect %s cannot be reified" l.FStar_Ident.str)
in (let _154_752 = (FStar_TypeChecker_Env.get_range env)
in ((_154_753), (_154_752))))
in FStar_Syntax_Syntax.Error (_154_754))
in (Prims.raise _154_755)))
...
(let _154_762 = (let _154_760 = (let _154_759 = (let _154_758 = (FStar_Syntax_Syntax.as_arg a)
in (let _154_757 = (let _154_756 = (FStar_Syntax_Syntax.as_arg wp)
in (_154_756)::[])
in (_154_758)::_154_757))
in ((repr), (_154_759)))
in FStar_Syntax_Syntax.Tm_app (_154_760))
in (let _154_761 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk _154_762 None _154_761)))
end)
end)))
in (
...
(let _154_763 = (check_and_gen env lift_wp expected_k)
in ((lift), (_154_763)))
end
...
let _59_1630 = (let _154_764 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
...
let lift_wp_a = (let _154_771 = (let _154_769 = (let _154_768 = (let _154_767 = (FStar_Syntax_Syntax.as_arg a_typ)
in (let _154_766 = (let _154_765 = (FStar_Syntax_Syntax.as_arg wp_a_typ)
in (_154_765)::[])
in (_154_767)::_154_766))
in ((lift_wp), (_154_768)))
in FStar_Syntax_Syntax.Tm_app (_154_769))
in (let _154_770 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk _154_771 None _154_770)))
in (repr_type sub.FStar_Syntax_Syntax.target a_typ lift_wp_a)))
in (

let expected_k = (let _154_778 = (let _154_776 = (FStar_Syntax_Syntax.mk_binder a)
in (let _154_775 = (let _154_774 = (FStar_Syntax_Syntax.mk_binder wp_a)
in (let _154_773 = (let _154_772 = (FStar_Syntax_Syntax.null_binder repr_f)
in (_154_772)::[])
in (_154_774)::_154_773))
in (_154_776)::_154_775))
in (let _154_777 = (FStar_Syntax_Syntax.mk_Total repr_result)
in (FStar_Syntax_Util.arrow _154_778 _154_777)))
in (
...
let _59_1684 = (let _154_779 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _154_779))
in (match (_59_1684) with
| (uvs, t) -> begin
(

let _59_1703 = (match ((let _154_781 = (let _154_780 = (FStar_Syntax_Subst.compress t)
in _154_780.FStar_Syntax_Syntax.n)
in ((tps), (_154_781)))) with
...
(let _154_786 = (let _154_785 = (let _154_784 = (let _154_783 = (FStar_Syntax_Print.lid_to_string lid)
in (let _154_782 = (FStar_All.pipe_right (FStar_List.length uvs) FStar_Util.string_of_int)
in (FStar_Util.format2 "Effect abbreviations must be polymorphic in exactly 1 universe; %s has %s universes" _154_783 _154_782)))
in ((_154_784), (r)))
...
let _59_1720 = (let _154_788 = (let _154_787 = (FStar_Syntax_Util.type_u ())
in (Prims.fst _154_787))
in (check_and_gen env t _154_788))
...
let _59_1745 = (let _154_792 = (let _154_789 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_154_789))
in (let _154_791 = (let _154_790 = (c.FStar_Syntax_Syntax.comp ())
in ((e), (_154_790)))
in (FStar_TypeChecker_TcTerm.check_expected_effect env _154_792 _154_791)))
in (match (_59_1745) with
| (e, _59_1743, g) -> begin
(

let _59_1746 = (let _154_793 = (FStar_TypeChecker_Rel.conj_guard g1 g)
in (FStar_TypeChecker_Rel.force_trivial_guard env _154_793))
in (
...
(let _154_805 = (let _154_804 = (let _154_803 = (let _154_802 = (FStar_Syntax_Print.lid_to_string l)
in (let _154_801 = (FStar_Syntax_Print.quals_to_string q)
in (let _154_800 = (FStar_Syntax_Print.quals_to_string q')
in (FStar_Util.format3 "Inconsistent qualifier annotations on %s; Expected {%s}, got {%s}" _154_802 _154_801 _154_800))))
in ((_154_803), (r)))
in FStar_Syntax_Syntax.Error (_154_804))
in (Prims.raise _154_805))
end
end))
in (
...
in (let _154_808 = (FStar_Syntax_Syntax.mk_lb ((FStar_Util.Inr (lbname)), (uvs), (FStar_Syntax_Const.effect_ALL_lid), (tval), (lb.FStar_Syntax_Syntax.lbdef)))
in ((false), (_154_808), (quals_opt)))))
end)
...
let e = (let _154_812 = (let _154_811 = (let _154_810 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)) None r)
in (((((Prims.fst lbs)), (lbs'))), (_154_810)))
in FStar_Syntax_Syntax.Tm_let (_154_811))
in (FStar_Syntax_Syntax.mk _154_812 None r))
in (
...
(let _154_820 = (let _154_819 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (

let should_log = (match ((let _154_816 = (let _154_815 = (let _154_814 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _154_814.FStar_Syntax_Syntax.fv_name)
in _154_815.FStar_Syntax_Syntax.v)
in (FStar_TypeChecker_Env.try_lookup_val_decl env _154_816))) with
| None -> begin
true
end
| _59_1837 -> begin
...
(let _154_818 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
in (let _154_817 = (FStar_Syntax_Print.term_to_string lb.FStar_Syntax_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" _154_818 _154_817)))
end else begin
""
end))))
in (FStar_All.pipe_right _154_819 (FStar_String.concat "\n")))
...
let dec = (let _154_834 = (let _154_833 = (let _154_832 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow bs _154_832))
in ((l), (us), (_154_833), ((FStar_Syntax_Syntax.Assumption)::(FStar_Syntax_Syntax.New)::quals), (r)))
in FStar_Syntax_Syntax.Sig_declare_typ (_154_834))
in (((dec)::out), (hidden)))
end
...
if (is_abstract quals) then begin
(let _154_841 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let _154_840 = (let _154_839 = (let _154_838 = (let _154_837 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _154_837.FStar_Syntax_Syntax.fv_name)
in _154_838.FStar_Syntax_Syntax.v)
in ((_154_839), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp), ((FStar_Syntax_Syntax.Assumption)::quals), (r)))
in FStar_Syntax_Syntax.Sig_declare_typ (_154_840)))))
in ((_154_841), (hidden)))
end else begin
(((se)::[]), (hidden))
end
...
(let _154_850 = (FStar_Syntax_Print.sigelt_to_string se)
...
(let _154_855 = (FStar_List.fold_left (fun s se -> (let _154_854 = (let _154_853 = (FStar_Syntax_Print.sigelt_to_string se)
in (Prims.strcat _154_853 "\n"))
in (Prims.strcat s _154_854))) "" ses')
...
(let _154_861 = (FStar_All.pipe_right (FStar_List.rev_append exports []) FStar_List.flatten)
in (((FStar_List.rev_append ses [])), (_154_861), (env)))
end))))
...
let _59_2067 = if (let _154_886 = (let _154_885 = (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name)
in (FStar_TypeChecker_Env.debug _154_885))
in (FStar_All.pipe_left _154_886 (FStar_Options.Other ("Exports")))) then begin
(let _154_891 = (FStar_Syntax_Print.lid_to_string lid)
in (let _154_890 = (let _154_888 = (FStar_All.pipe_right univs (FStar_List.map (fun x -> (FStar_Syntax_Print.univ_to_string (FStar_Syntax_Syntax.U_name (x))))))
in (FStar_All.pipe_right _154_888 (FStar_String.concat ", ")))
in (let _154_889 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print3 "Checking for export %s <%s> : %s\n" _154_891 _154_890 _154_889))))
end else begin
()
end
in (
...
in (let _154_892 = (FStar_TypeChecker_TcTerm.tc_trivial_guard env t)
in (FStar_All.pipe_right _154_892 Prims.ignore))))
end)))
in (

let check_term = (fun lid univs t -> (

let _59_2074 = (let _154_901 = (let _154_900 = (FStar_Syntax_Print.lid_to_string modul.FStar_Syntax_Syntax.name)
in (let _154_899 = (FStar_Syntax_Print.lid_to_string lid)
in (FStar_Util.format2 "Interface of %s violates its abstraction (add a \'private\' qualifier to \'%s\'?)" _154_900 _154_899)))
in (FStar_TypeChecker_Errors.message_prefix.FStar_TypeChecker_Errors.set_prefix _154_901))
in (
...
let t = (let _154_906 = (let _154_905 = (let _154_904 = (FStar_Syntax_Syntax.mk_Total typ)
in ((binders), (_154_904)))
in FStar_Syntax_Syntax.Tm_arrow (_154_905))
in (FStar_Syntax_Syntax.mk _154_906 None r))
...
let _59_2180 = (let _154_914 = (FStar_Options.restore_cmd_line_options true)
in (FStar_All.pipe_right _154_914 Prims.ignore))
in ((modul), (env))))))))))
...
(let _154_923 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
...
(let _154_924 = (FStar_Syntax_Print.modul_to_string m)
in (FStar_Util.print1 "%s\n" _154_924))
end else begin
()
end
