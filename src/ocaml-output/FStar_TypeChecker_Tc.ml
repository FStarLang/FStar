                                        ...
                                        | (expected_k1,uu____1248,uu____1249)
                                            ...
                                            let env3 =
                                              let uu___361_1254 = env2 in
                                              {
                                                ...
                                                FStar_TypeChecker_Env.dep_graph
                                                  =
                                                  (uu___361_1254.FStar_TypeChecker_Env.dep_graph)
                                              } in
                                            let br =
                                              check_and_gen' env3
                                                ed2.FStar_Syntax_Syntax.bind_repr
                                     ...
                                     | (act_typ,uu____1384,g_t) ->
                                         let env' =
                                               ...
                                               env1 act_typ in
                                           {
                                             ...
                                             FStar_TypeChecker_Env.dep_graph
                                               =
                                               (uu___362_1387.FStar_TypeChecker_Env.dep_graph)
                                           } in
                                         ((let uu____1389 =
                      ...
                      | (lift,lift_wp) ->
                          ...
                          let env2 =
                            let uu___373_5128 = env1 in
                            {
                              ...
                              FStar_TypeChecker_Env.dep_graph =
                                (uu___373_5128.FStar_TypeChecker_Env.dep_graph)
                            } in
                          let lift1 =
                            match lift with
                            | FStar_Pervasives_Native.None  ->
                      ...
                      (let uu___382_6441 = env2 in
                       {
                         ...
                         FStar_TypeChecker_Env.dep_graph =
                           (uu___382_6441.FStar_TypeChecker_Env.dep_graph)
                       }) e in
        ...
        (let name =
         ...
         let env1 =
           let uu___392_8401 = env in
           {
             ...
             FStar_TypeChecker_Env.dep_graph =
               (uu___392_8401.FStar_TypeChecker_Env.dep_graph)
           } in
      ...
      fun exports  ->
        let env1 =
          let uu___395_8508 = env in
          {
            ...
            FStar_TypeChecker_Env.dep_graph =
              (uu___395_8508.FStar_TypeChecker_Env.dep_graph)
          } in
    ...
    fun m  ->
      ...
      (let env1 =
           ...
           Prims.op_Negation uu____8801 in
         {
           ...
           FStar_TypeChecker_Env.dep_graph =
             (uu___397_8799.FStar_TypeChecker_Env.dep_graph)
         } in
