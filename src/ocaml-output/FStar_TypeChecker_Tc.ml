...
let _60_882 = (match ((let _157_540 = (FStar_Syntax_Subst.compress t)
...
let _60_896 = (match ((let _157_547 = (FStar_Syntax_Subst.compress res_lcomp.FStar_Syntax_Syntax.res_typ)
...
let _60_906 = (match ((let _157_553 = (FStar_Syntax_Subst.compress head)
...
let t = (let _157_566 = (let _157_564 = (FStar_All.pipe_right tps (FStar_List.map (fun _60_920 -> (match (_60_920) with
| (x, _60_919) -> begin
...
let _60_1024 = (match ((let _157_587 = (FStar_Syntax_Subst.compress ty)
...
let _60_1121 = (let _157_607 = (FStar_List.map Prims.fst tcs)
...
let ind = (let _157_630 = (FStar_List.map (fun _60_1193 -> (match (_60_1193) with
| (bv, aq) -> begin
...
let ind = (let _157_633 = (FStar_List.map (fun _60_1197 -> (match (_60_1197) with
| (bv, aq) -> begin
...
in {FStar_Syntax_Syntax.n = _157_650; FStar_Syntax_Syntax.tk = _60_1219.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _60_1219.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _60_1219.FStar_Syntax_Syntax.vars}))
in (
...
let ind = (let _157_707 = (FStar_List.map (fun _60_1401 -> (match (_60_1401) with
| (bv, aq) -> begin
...
let ind = (let _157_710 = (FStar_List.map (fun _60_1405 -> (match (_60_1405) with
| (bv, aq) -> begin
...
in {FStar_Syntax_Syntax.n = _157_743; FStar_Syntax_Syntax.tk = _60_1486.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _60_1486.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _60_1486.FStar_Syntax_Syntax.vars}))
in (
...
let _60_1610 = (let _157_775 = (FStar_Options.restore_cmd_line_options false)
...
let _60_1645 = (let _157_779 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _157_779))
in (match (_60_1645) with
| (a, wp_a_src) -> begin
(

let _60_1648 = (let _157_780 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
...
let _60_1702 = (let _157_810 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
...
let _60_1757 = (let _157_825 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _157_825))
in (match (_60_1757) with
| (uvs, t) -> begin
(

let _60_1776 = (match ((let _157_827 = (let _157_826 = (FStar_Syntax_Subst.compress t)
...
let _60_1823 = if (uvs = []) then begin
...
let _60_1820 = (FStar_Syntax_Subst.open_univ_vars uvs t)
...
let _60_1843 = (FStar_TypeChecker_TcTerm.tc_term env e)
in (match (_60_1843) with
| (e, c, g1) -> begin
(

let _60_1848 = (let _157_844 = (let _157_841 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_157_841))
...
in (match (_60_1848) with
| (e, _60_1846, g) -> begin
(

let _60_1849 = (let _157_845 = (FStar_TypeChecker_Rel.conj_guard g1 g)
...
| FStar_Syntax_Syntax.Sig_let (lbs, r, lids, quals, _60_1858) -> begin
(
