...
let uu___93_1631 = action
in (let _0_495 = (apply_close action_elab)
in (let _0_494 = (apply_close action_typ_with_wp)
in {FStar_Syntax_Syntax.action_name = uu___93_1631.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_unqualified_name = uu___93_1631.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = uu___93_1631.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_defn = _0_495; FStar_Syntax_Syntax.action_typ = _0_494})))
in (_0_496)::actions)
in ((dmff_env), (_0_497)))))))
end))
...
in (([]), (_0_520)))
in {FStar_Syntax_Syntax.qualifiers = uu___94_1883.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.cattributes = uu___94_1883.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___94_1883.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = uu___94_1883.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = _0_527; FStar_Syntax_Syntax.signature = _0_526; FStar_Syntax_Syntax.ret_wp = _0_525; FStar_Syntax_Syntax.bind_wp = _0_524; FStar_Syntax_Syntax.if_then_else = uu___94_1883.FStar_Syntax_Syntax.if_then_else; FStar_Syntax_Syntax.ite_wp = uu___94_1883.FStar_Syntax_Syntax.ite_wp; FStar_Syntax_Syntax.stronger = uu___94_1883.FStar_Syntax_Syntax.stronger; FStar_Syntax_Syntax.close_wp = uu___94_1883.FStar_Syntax_Syntax.close_wp; FStar_Syntax_Syntax.assert_p = uu___94_1883.FStar_Syntax_Syntax.assert_p; FStar_Syntax_Syntax.assume_p = uu___94_1883.FStar_Syntax_Syntax.assume_p; FStar_Syntax_Syntax.null_wp = uu___94_1883.FStar_Syntax_Syntax.null_wp; FStar_Syntax_Syntax.trivial = uu___94_1883.FStar_Syntax_Syntax.trivial; FStar_Syntax_Syntax.repr = _0_523; FStar_Syntax_Syntax.return_repr = _0_522; FStar_Syntax_Syntax.bind_repr = _0_521; FStar_Syntax_Syntax.actions = actions}))))))))
in (
...
let uu____2126 = ((FStar_Options.no_positivity ()) || (FStar_Options.lax ()))
...
let uu____2132 = (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, uu____2138, uu____2139, uu____2140, uu____2141, uu____2142, uu____2143, r) -> begin
((lid), (r))
end
| uu____2151 -> begin
(failwith "Impossible!")
...
let skip_prims_type = (((match (tcs) with
| [] -> begin
false
end
| uu____2158 -> begin
true
end) && (FStar_Ident.lid_equals env.FStar_TypeChecker_Env.curmodule FStar_Syntax_Const.prims_lid)) && (

let lid = (

let ty = (FStar_List.hd tcs)
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, uu____2163, uu____2164, uu____2165, uu____2166, uu____2167, uu____2168, uu____2169) -> begin
lid
end
| uu____2176 -> begin
(failwith "Impossible")
...
let data_ops_ses = (let _0_544 = (FStar_List.map (FStar_TypeChecker_Util.mk_data_operations skip_prims_type quals env tcs) datas)
in (FStar_All.pipe_right _0_544 FStar_List.flatten))
in (

let is_noeq = (FStar_List.existsb (fun q -> (q = FStar_Syntax_Syntax.Noeq)) quals)
in (match ((((match (tcs) with
| [] -> begin
true
end
| uu____2192 -> begin
false
end) || skip_prims_type) || is_noeq)) with
| true -> begin
...
let uu____2255 = (tc_inductive env ses quals lids)
...
let uu____2285 = (FStar_Options.set_options t s)
...
| FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____2308) -> begin
(failwith "impossible")
end
...
let uu____2321 = (FStar_All.pipe_right ne.FStar_Syntax_Syntax.actions (FStar_List.fold_left (fun uu____2332 a -> (match (uu____2332) with
| (env, ses) -> begin
(
...
let uu____2362 = (let _0_551 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _0_551))
in (match (uu____2362) with
| (a, wp_a_src) -> begin
(

let uu____2378 = (let _0_552 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
...
let uu____2418 = (FStar_TypeChecker_Env.effect_decl_opt env eff_name)
...
let uu____2425 = (not ((FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reifiable))))
...
let uu____2439 = (match (((sub.FStar_Syntax_Syntax.lift), (sub.FStar_Syntax_Syntax.lift_wp))) with
| (None, None) -> begin
(failwith "Impossible")
end
| (lift, Some (uu____2454, lift_wp)) -> begin
...
let uu____2481 = (FStar_TypeChecker_DMFF.star_expr dmff_env lift)
in (match (uu____2481) with
| (uu____2488, lift_wp, lift_elab) -> begin
(

let uu____2491 = (recheck_debug "lift-wp" env lift_wp)
in (

let uu____2492 = (recheck_debug "lift-elab" env lift_elab)
...
let uu___95_2516 = env
in {FStar_TypeChecker_Env.solver = uu___95_2516.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___95_2516.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___95_2516.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___95_2516.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___95_2516.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___95_2516.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___95_2516.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___95_2516.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___95_2516.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___95_2516.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___95_2516.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___95_2516.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___95_2516.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___95_2516.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___95_2516.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___95_2516.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___95_2516.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___95_2516.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___95_2516.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___95_2516.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___95_2516.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___95_2516.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___95_2516.FStar_TypeChecker_Env.qname_and_index})
in (
...
| Some (uu____2520, lift) -> begin
(

let uu____2527 = (let _0_569 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
...
let uu____2565 = (FStar_TypeChecker_TcTerm.tc_tot_or_gtot_term env expected_k)
in (match (uu____2565) with
| (expected_k, uu____2571, uu____2572) -> begin
(
...
let uu___96_2575 = env
in {FStar_TypeChecker_Env.solver = uu___96_2575.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___96_2575.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___96_2575.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___96_2575.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___96_2575.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___96_2575.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___96_2575.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___96_2575.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___96_2575.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___96_2575.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___96_2575.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___96_2575.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___96_2575.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___96_2575.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___96_2575.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___96_2575.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___96_2575.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___96_2575.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax; FStar_TypeChecker_Env.lax_universes = uu___96_2575.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___96_2575.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___96_2575.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___96_2575.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___96_2575.FStar_TypeChecker_Env.qname_and_index})
in (

let sub = (

let uu___97_2577 = sub
in {FStar_Syntax_Syntax.source = uu___97_2577.FStar_Syntax_Syntax.source; FStar_Syntax_Syntax.target = uu___97_2577.FStar_Syntax_Syntax.target; FStar_Syntax_Syntax.lift_wp = Some (lift_wp); FStar_Syntax_Syntax.lift = lift})
in (
...
let uu____2596 = (FStar_Syntax_Subst.open_comp tps c)
in (match (uu____2596) with
| (tps, c) -> begin
(

let uu____2606 = (FStar_TypeChecker_TcTerm.tc_tparams env tps)
in (match (uu____2606) with
| (tps, env, us) -> begin
(

let uu____2618 = (FStar_TypeChecker_TcTerm.tc_comp env c)
...
let uu____2633 = (let _0_582 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None r)
...
let uu____2659 = (let _0_583 = (FStar_Syntax_Subst.compress t).FStar_Syntax_Syntax.n
in ((tps), (_0_583)))
in (match (uu____2659) with
| ([], FStar_Syntax_Syntax.Tm_arrow (uu____2669, c)) -> begin
(([]), (c))
end
| (uu____2693, FStar_Syntax_Syntax.Tm_arrow (tps, c)) -> begin
((tps), (c))
end
| uu____2711 -> begin
(failwith "Impossible")
...
let uu____2741 = (FStar_Syntax_Subst.open_univ_vars uvs t)
...
| (FStar_Syntax_Syntax.Sig_declare_typ (_, _, _, quals, _)) | (FStar_Syntax_Syntax.Sig_let (_, _, _, quals, _)) when (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___77_2777 -> (match (uu___77_2777) with
...
let uu____2791 = (FStar_Syntax_Subst.open_univ_vars uvs t)
...
let uu____2825 = (FStar_TypeChecker_TcTerm.tc_term env e)
in (match (uu____2825) with
| (e, c, g1) -> begin
(

let uu____2837 = (let _0_594 = Some ((FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r))
...
let uu____2893 = (((FStar_List.length q) = (FStar_List.length q')) && (FStar_List.forall2 FStar_Syntax_Util.qualifier_equal q q'))
...
let uu____2904 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.fold_left (fun uu____2925 lb -> (match (uu____2925) with
...
let uu____2955 = (FStar_TypeChecker_Env.try_lookup_val_decl env lbname.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
...
let uu____3068 = (FStar_All.pipe_right q (FStar_Util.for_some (fun uu___78_3070 -> (match (uu___78_3070) with
...
let uu____3108 = (FStar_TypeChecker_TcTerm.tc_maybe_toplevel_term (

let uu___98_3112 = env
in {FStar_TypeChecker_Env.solver = uu___98_3112.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___98_3112.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___98_3112.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___98_3112.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___98_3112.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___98_3112.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___98_3112.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___98_3112.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___98_3112.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___98_3112.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___98_3112.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = should_generalize; FStar_TypeChecker_Env.letrecs = uu___98_3112.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = uu___98_3112.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___98_3112.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___98_3112.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___98_3112.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___98_3112.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___98_3112.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___98_3112.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___98_3112.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___98_3112.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___98_3112.FStar_TypeChecker_Env.qname_and_index}) e)
in (match (uu____3108) with
| ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let (lbs, e); FStar_Syntax_Syntax.tk = uu____3120; FStar_Syntax_Syntax.pos = uu____3121; FStar_Syntax_Syntax.vars = uu____3122}, uu____3123, g) when (FStar_TypeChecker_Rel.is_trivial g) -> begin
(

let quals = (match (e.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_meta (uu____3142, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect)) -> begin
...
let uu____3187 = (let _0_602 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname).FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v
...
let is_abstract = (fun quals -> (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___79_3232 -> (match (uu___79_3232) with
...
in (match (se) with
| FStar_Syntax_Syntax.Sig_pragma (uu____3246) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_inductive_typ (_)) | (FStar_Syntax_Syntax.Sig_datacon (_)) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, uu____3259, r) -> begin
(

let uu____3267 = (is_abstract quals)
in (match (uu____3267) with
| true -> begin
(FStar_List.fold_right (fun se uu____3277 -> (match (uu____3277) with
| (out, hidden) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, us, bs, t, uu____3300, uu____3301, quals, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (l, us, t, uu____3319, uu____3320, uu____3321, uu____3322, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_assume (uu____3340, uu____3341, quals, uu____3343) -> begin
(

let uu____3346 = (is_abstract quals)
...
let uu____3363 = (FStar_All.pipe_right quals (FStar_Util.for_some is_hidden_proj_or_disc))
...
let uu____3373 = (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___80_3375 -> (match (uu___80_3375) with
...
| FStar_Syntax_Syntax.Sig_main (uu____3388) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_new_effect (_)) | (FStar_Syntax_Syntax.Sig_new_effect_for_free (_)) | (FStar_Syntax_Syntax.Sig_sub_effect (_)) | (FStar_Syntax_Syntax.Sig_effect_abbrev (_)) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), uu____3400, uu____3401, quals, uu____3403) when (FStar_All.pipe_right quals (FStar_Util.for_some is_hidden_proj_or_disc)) -> begin
(
...
let uu____3421 = (FStar_All.pipe_right hidden (FStar_Util.for_some (FStar_Syntax_Syntax.fv_eq_lid fv)))
...
| FStar_Syntax_Syntax.Sig_let (lbs, r, l, quals, uu____3445) -> begin
(

let uu____3452 = (is_abstract quals)
...
let rec process_one_decl = (fun uu____3508 se -> (match (uu____3508) with
| (ses, exports, env, hidden) -> begin
((

let uu____3539 = (FStar_TypeChecker_Env.debug env FStar_Options.Low)
...
let uu____3541 = (tc_decl env se)
in (match (uu____3541) with
| (ses', env, ses_elaborated) -> begin
((

let uu____3563 = ((FStar_Options.log_types ()) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("LogTypes"))))
...
let uu____3569 = (FStar_List.fold_left (fun uu____3578 se -> (match (uu____3578) with
| (le, lh) -> begin
(
...
let uu____3634 = (FStar_List.fold_left (fun acc se -> (match (se) with
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ne, r) -> begin
(

let uu____3671 = acc
in (match (uu____3671) with
| (uu____3688, uu____3689, env, uu____3691) -> begin
(

let uu____3700 = (cps_and_elaborate env ne)
...
| (ses, exports, env, uu____3747) -> begin
...
let uu____3779 = (FStar_Options.debug_any ())
...
let uu___99_3785 = env
in {FStar_TypeChecker_Env.solver = uu___99_3785.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___99_3785.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___99_3785.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___99_3785.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___99_3785.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___99_3785.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___99_3785.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___99_3785.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___99_3785.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___99_3785.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___99_3785.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___99_3785.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___99_3785.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___99_3785.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___99_3785.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___99_3785.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = modul.FStar_Syntax_Syntax.is_interface; FStar_TypeChecker_Env.admit = (not (verify)); FStar_TypeChecker_Env.lax = uu___99_3785.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___99_3785.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___99_3785.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___99_3785.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___99_3785.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___99_3785.FStar_TypeChecker_Env.qname_and_index})
...
let uu____3788 = (tc_decls env modul.FStar_Syntax_Syntax.declarations)
in (match (uu____3788) with
| (ses, exports, env) -> begin
(((

let uu___100_3806 = modul
in {FStar_Syntax_Syntax.name = uu___100_3806.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = ses; FStar_Syntax_Syntax.exports = uu___100_3806.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___100_3806.FStar_Syntax_Syntax.is_interface})), (exports), (env))
end)));
))));
)))))
...
let uu____3822 = (tc_decls env decls)
...
let uu___101_3840 = modul
in {FStar_Syntax_Syntax.name = uu___101_3840.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = (FStar_List.append modul.FStar_Syntax_Syntax.declarations ses); FStar_Syntax_Syntax.exports = uu___101_3840.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___101_3840.FStar_Syntax_Syntax.is_interface})
...
let uu___102_3854 = env
in {FStar_TypeChecker_Env.solver = uu___102_3854.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___102_3854.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___102_3854.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___102_3854.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___102_3854.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___102_3854.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___102_3854.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___102_3854.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___102_3854.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___102_3854.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___102_3854.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___102_3854.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___102_3854.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = uu___102_3854.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___102_3854.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___102_3854.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___102_3854.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = true; FStar_TypeChecker_Env.type_of = uu___102_3854.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___102_3854.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___102_3854.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___102_3854.FStar_TypeChecker_Env.qname_and_index})
in (

let check_term = (fun lid univs t -> (

let uu____3865 = (FStar_Syntax_Subst.open_univ_vars univs t)
in (match (uu____3865) with
| (univs, t) -> begin
((

let uu____3871 = (let _0_616 = (FStar_TypeChecker_Env.debug (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name))
...
let rec check_sigelt = (fun uu___81_3896 -> (match (uu___81_3896) with
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, uu____3899, uu____3900) -> begin
(

let uu____3907 = (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private))))
...
| FStar_Syntax_Syntax.Sig_inductive_typ (l, univs, binders, typ, uu____3915, uu____3916, uu____3917, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (l, univs, t, uu____3939, uu____3940, uu____3941, uu____3942, uu____3943) -> begin
(check_term l univs t)
end
| FStar_Syntax_Syntax.Sig_declare_typ (l, univs, t, quals, uu____3952) -> begin
(

let uu____3955 = (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private))))
...
| FStar_Syntax_Syntax.Sig_let ((uu____3958, lbs), uu____3960, uu____3961, quals, uu____3963) -> begin
(

let uu____3975 = (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private))))
...
let uu____3996 = (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private))))
...
let uu___103_4029 = modul
in {FStar_Syntax_Syntax.name = uu___103_4029.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = uu___103_4029.FStar_Syntax_Syntax.declarations; FStar_Syntax_Syntax.exports = exports; FStar_Syntax_Syntax.is_interface = modul.FStar_Syntax_Syntax.is_interface})
in (

let env = (FStar_TypeChecker_Env.finish_module env modul)
in ((

let uu____4032 = (not ((FStar_Options.lax ())))
...
let uu____4038 = (not ((FStar_Options.interactive ())))
...
let uu____4048 = (tc_partial_modul env modul)
...
let uu____4069 = (FStar_Options.debug_any ())
...
let uu___104_4073 = env
in (let _0_627 = (not ((FStar_Options.should_verify m.FStar_Syntax_Syntax.name.FStar_Ident.str)))
in {FStar_TypeChecker_Env.solver = uu___104_4073.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___104_4073.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___104_4073.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___104_4073.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___104_4073.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___104_4073.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___104_4073.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___104_4073.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___104_4073.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___104_4073.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___104_4073.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___104_4073.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___104_4073.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___104_4073.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___104_4073.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___104_4073.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___104_4073.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___104_4073.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _0_627; FStar_TypeChecker_Env.lax_universes = uu___104_4073.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___104_4073.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___104_4073.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___104_4073.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___104_4073.FStar_TypeChecker_Env.qname_and_index}))
in (

let uu____4074 = (tc_modul env m)
in (match (uu____4074) with
| (m, env) -> begin
((

let uu____4082 = (FStar_Options.dump_module m.FStar_Syntax_Syntax.name.FStar_Ident.str)
...
let uu____4085 = ((FStar_Options.dump_module m.FStar_Syntax_Syntax.name.FStar_Ident.str) && (FStar_Options.debug_at_level m.FStar_Syntax_Syntax.name.FStar_Ident.str (FStar_Options.Other ("Normalize"))))
in (match (uu____4085) with
| true -> begin
(

let normalize_toplevel_lets = (fun uu___82_4089 -> (match (uu___82_4089) with
...
let uu____4116 = (FStar_Syntax_Subst.open_univ_vars lb.FStar_Syntax_Syntax.lbunivs lb.FStar_Syntax_Syntax.lbdef)
in (match (uu____4116) with
| (univnames, e) -> begin
(

let uu___105_4121 = lb
in (let _0_630 = (let _0_629 = (FStar_TypeChecker_Env.push_univ_vars env univnames)
in (n _0_629 e))
in {FStar_Syntax_Syntax.lbname = uu___105_4121.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___105_4121.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___105_4121.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___105_4121.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _0_630}))
end)))
in FStar_Syntax_Syntax.Sig_let ((let _0_632 = (let _0_631 = (FStar_List.map update lbs)
in ((b), (_0_631)))
in ((_0_632), (r), (ids), (qs), (attrs))))))
end
| se -> begin
se
end))
...
let uu___106_4131 = m
in (let _0_633 = (FStar_List.map normalize_toplevel_lets m.FStar_Syntax_Syntax.declarations)
in {FStar_Syntax_Syntax.name = uu___106_4131.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = _0_633; FStar_Syntax_Syntax.exports = uu___106_4131.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___106_4131.FStar_Syntax_Syntax.is_interface}))
in (let _0_634 = (FStar_Syntax_Print.modul_to_string normalized_module)
in (FStar_Util.print1 "%s\n" _0_634))))
end
| uu____4132 -> begin
()
