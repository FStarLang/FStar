...
let _58_2517 = (get_effect_signature ())
...
let _58_2529 = (FStar_Syntax_Util.type_u ())
...
let _58_2545 = (FStar_Syntax_Util.type_u ())
...
let _58_2669 = if ((FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reifiable)) || (FStar_All.pipe_right ed.FStar_Syntax_Syntax.qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reflectable))) then begin
(

let repr = (

let _58_2551 = (FStar_Syntax_Util.type_u ())
...
| FStar_Syntax_Syntax.Tm_app (_58_2563, ((t, _58_2570))::((wp, _58_2566))::[]) -> begin
((t), (wp))
end
| _58_2576 -> begin
...
let _58_2580 = (get_effect_signature ())
...
let _58_2594 = (tc_tot_or_gtot_term env expected_k)
in (match (_58_2594) with
| (expected_k, _58_2591, _58_2593) -> begin
(
...
let _58_2606 = (tc_tot_or_gtot_term env expected_k)
in (match (_58_2606) with
| (expected_k, _58_2603, _58_2605) -> begin
(

let env = (FStar_TypeChecker_Env.set_range env (Prims.snd ed.FStar_Syntax_Syntax.return_repr).FStar_Syntax_Syntax.pos)
in (

let _58_2610 = (check_and_gen' env ed.FStar_Syntax_Syntax.return_repr expected_k)
...
let _58_2620 = (tc_tot_or_gtot_term env act.FStar_Syntax_Syntax.action_defn)
in (match (_58_2620) with
| (act_defn, c, g_a) -> begin
(

let _58_2640 = (match ((let _150_1104 = (FStar_Syntax_Subst.compress c.FStar_Syntax_Syntax.res_typ)
in _150_1104.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(

let _58_2628 = (FStar_Syntax_Subst.open_comp bs c)
...
let _58_2635 = (tc_tot_or_gtot_term env k)
in (match (_58_2635) with
| (k, _58_2633, g) -> begin
((k), (g))
end))))
end))
...
let _58_2642 = (let _150_1107 = (let _150_1106 = (FStar_TypeChecker_Rel.conj_guard g_k g)
...
let _58_2650 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_58_2650) with
| (bs, c) -> begin
(

let _58_2653 = (destruct_repr (FStar_Syntax_Util.comp_result c))
...
let _58_2660 = (FStar_TypeChecker_Util.generalize_universes env act_defn)
...
let _58_2662 = act
in {FStar_Syntax_Syntax.action_name = _58_2662.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_univs = univs; FStar_Syntax_Syntax.action_defn = act_defn; FStar_Syntax_Syntax.action_typ = act_ty}))
end)))))
end))
end)))
...
let _58_2673 = (FStar_TypeChecker_Util.generalize_universes env0 t)
in (match (_58_2673) with
| (univs, t) -> begin
(

let _58_2689 = (match ((let _150_1114 = (let _150_1113 = (FStar_Syntax_Subst.compress t)
in _150_1113.FStar_Syntax_Syntax.n)
in ((binders), (_150_1114)))) with
| ([], _58_2676) -> begin
(([]), (t))
end
| (_58_2679, FStar_Syntax_Syntax.Tm_arrow (binders, c)) -> begin
...
let _58_2698 = (close (- (1)) ((act.FStar_Syntax_Syntax.action_univs), (act.FStar_Syntax_Syntax.action_defn)))
in (match (_58_2698) with
| (univs, defn) -> begin
(

let _58_2701 = (close (- (1)) ((act.FStar_Syntax_Syntax.action_univs), (act.FStar_Syntax_Syntax.action_typ)))
...
let _58_2704 = act
in {FStar_Syntax_Syntax.action_name = _58_2704.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_univs = univs; FStar_Syntax_Syntax.action_defn = defn; FStar_Syntax_Syntax.action_typ = typ}))
end))
end)))
in (
...
in {FStar_Syntax_Syntax.qualifiers = _58_2706.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _58_2706.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = univs; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = signature; FStar_Syntax_Syntax.ret_wp = _150_1136; FStar_Syntax_Syntax.bind_wp = _150_1135; FStar_Syntax_Syntax.if_then_else = _150_1134; FStar_Syntax_Syntax.ite_wp = _150_1133; FStar_Syntax_Syntax.stronger = _150_1132; FStar_Syntax_Syntax.close_wp = _150_1131; FStar_Syntax_Syntax.assert_p = _150_1130; FStar_Syntax_Syntax.assume_p = _150_1129; FStar_Syntax_Syntax.null_wp = _150_1128; FStar_Syntax_Syntax.trivial = _150_1127; FStar_Syntax_Syntax.repr = _150_1126; FStar_Syntax_Syntax.return_repr = _150_1125; FStar_Syntax_Syntax.bind_repr = _150_1124; FStar_Syntax_Syntax.actions = _150_1123})))))))))))))))
in (

let _58_2711 = if ((FStar_TypeChecker_Env.debug env FStar_Options.Low) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("EffDecl")))) then begin
...
let _58_2717 = (FStar_Syntax_Subst.open_term ed.FStar_Syntax_Syntax.binders ed.FStar_Syntax_Syntax.signature)
in (match (_58_2717) with
| (binders_un, signature_un) -> begin
(

let _58_2722 = (tc_tparams env0 binders_un)
in (match (_58_2722) with
| (binders, env, _58_2721) -> begin
(

let _58_2726 = (tc_trivial_guard env signature_un)
in (match (_58_2726) with
| (signature, _58_2725) -> begin
(

let _58_2739 = (match ((let _150_1140 = (FStar_Syntax_Subst.compress signature)
in _150_1140.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (((a, _58_2729))::[], effect_marker) -> begin
((a), (effect_marker))
end
| _58_2736 -> begin
...
let _58_2748 = (tc_term env t)
in (match (_58_2748) with
| (t, comp, _58_2747) -> begin
((t), (comp))
end)))))
in (
...
let _58_2753 = (let _150_1149 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print2 "Term has been %s-transformed to:\n%s\n----------\n" s _150_1149))
in (

let _58_2760 = (tc_term env t)
in (match (_58_2760) with
| (t', _58_2757, _58_2759) -> begin
(

let _58_2761 = (let _150_1150 = (FStar_Syntax_Print.term_to_string t')
...
let _58_2767 = (open_and_check ed.FStar_Syntax_Syntax.repr)
in (match (_58_2767) with
| (repr, _comp) -> begin
(

let _58_2768 = (let _150_1153 = (FStar_Syntax_Print.term_to_string repr)
...
let _58_2773 = (FStar_TypeChecker_DMFF.star_type_definition dmff_env repr)
...
let _58_2788 = (open_and_check item)
in (match (_58_2788) with
| (item, item_comp) -> begin
(

let _58_2789 = if (not ((FStar_Syntax_Util.is_total_lcomp item_comp))) then begin
...
let _58_2795 = (FStar_TypeChecker_DMFF.star_expr_definition dmff_env item)
in (match (_58_2795) with
...
let _58_2801 = (elaborate_and_star dmff_env ed.FStar_Syntax_Syntax.bind_repr)
in (match (_58_2801) with
| (dmff_env, bind_wp, bind_elab) -> begin
(

let _58_2805 = (elaborate_and_star dmff_env ed.FStar_Syntax_Syntax.return_repr)
...
let _58_2839 = (FStar_List.fold_left (fun _58_2829 action -> (match (_58_2829) with
| (dmff_env, actions) -> begin
(

let _58_2834 = (elaborate_and_star dmff_env ((action.FStar_Syntax_Syntax.action_univs), (action.FStar_Syntax_Syntax.action_defn)))
in (match (_58_2834) with
| (dmff_env, action_wp, action_elab) -> begin
((dmff_env), (((

let _58_2835 = action
in {FStar_Syntax_Syntax.action_name = _58_2835.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_univs = _58_2835.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_defn = action_elab; FStar_Syntax_Syntax.action_typ = _58_2835.FStar_Syntax_Syntax.action_typ}))::actions))
end))
end)) ((dmff_env), ([])) ed.FStar_Syntax_Syntax.actions)
in (match (_58_2839) with
| (dmff_env, actions) -> begin
(
...
in {FStar_Syntax_Syntax.action_name = _58_2849.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_univs = _58_2849.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_defn = _150_1194; FStar_Syntax_Syntax.action_typ = _58_2849.FStar_Syntax_Syntax.action_typ}))) actions)
in {FStar_Syntax_Syntax.qualifiers = _58_2846.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _58_2846.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = _58_2846.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = _150_1201; FStar_Syntax_Syntax.signature = effect_signature; FStar_Syntax_Syntax.ret_wp = _150_1200; FStar_Syntax_Syntax.bind_wp = _150_1199; FStar_Syntax_Syntax.if_then_else = _58_2846.FStar_Syntax_Syntax.if_then_else; FStar_Syntax_Syntax.ite_wp = _58_2846.FStar_Syntax_Syntax.ite_wp; FStar_Syntax_Syntax.stronger = _58_2846.FStar_Syntax_Syntax.stronger; FStar_Syntax_Syntax.close_wp = _58_2846.FStar_Syntax_Syntax.close_wp; FStar_Syntax_Syntax.assert_p = _58_2846.FStar_Syntax_Syntax.assert_p; FStar_Syntax_Syntax.assume_p = _58_2846.FStar_Syntax_Syntax.assume_p; FStar_Syntax_Syntax.null_wp = _58_2846.FStar_Syntax_Syntax.null_wp; FStar_Syntax_Syntax.trivial = _58_2846.FStar_Syntax_Syntax.trivial; FStar_Syntax_Syntax.repr = _150_1198; FStar_Syntax_Syntax.return_repr = _150_1197; FStar_Syntax_Syntax.bind_repr = _150_1196; FStar_Syntax_Syntax.actions = _150_1195}))))))))
in (

let _58_2852 = if (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("ED"))) then begin
...
let _58_2861 = (match (is_for_free) with
| ForFree -> begin
...
let _58_2874 = ()
in (match (ses) with
| (FStar_Syntax_Syntax.Sig_inductive_typ (lex_t, [], [], t, _58_2903, _58_2905, [], r))::(FStar_Syntax_Syntax.Sig_datacon (lex_top, [], _t_top, _lex_t_top, 0, [], _58_2894, r1))::(FStar_Syntax_Syntax.Sig_datacon (lex_cons, [], _t_cons, _lex_t_cons, 0, [], _58_2883, r2))::[] when (((FStar_Ident.lid_equals lex_t FStar_Syntax_Const.lex_t_lid) && (FStar_Ident.lid_equals lex_top FStar_Syntax_Const.lextop_lid)) && (FStar_Ident.lid_equals lex_cons FStar_Syntax_Const.lexcons_lid)) -> begin
(
...
let _58_2939 = (FStar_Syntax_Util.type_u ())
...
let _58_2941 = (FStar_TypeChecker_Util.check_uvars r phi)
...
let _58_2966 = (warn_positivity tc r)
in (

let _58_2970 = (FStar_Syntax_Subst.open_term tps k)
in (match (_58_2970) with
| (tps, k) -> begin
(

let _58_2975 = (tc_binders env tps)
in (match (_58_2975) with
| (tps, env_tps, guard_params, us) -> begin
(

let _58_2978 = (FStar_Syntax_Util.arrow_formals k)
in (match (_58_2978) with
| (indices, t) -> begin
(

let _58_2983 = (tc_binders env_tps indices)
...
let _58_2988 = (tc_tot_or_gtot_term env' t)
...
let _58_2995 = (FStar_Syntax_Util.type_u ())
in (match (_58_2995) with
| (t_type, u) -> begin
(

let _58_2996 = (let _150_1254 = (FStar_TypeChecker_Rel.teq env' t t_type)
...
let positive_if_pure = (fun _58_3005 l -> ())
in (
...
let tps_u_opt = (FStar_Util.find_map tcs (fun _58_3026 -> (match (_58_3026) with
| (se, u_tc) -> begin
...
| FStar_Syntax_Syntax.Sig_inductive_typ (_58_3028, _58_3030, tps, _58_3033, _58_3035, _58_3037, _58_3039, _58_3041) -> begin
(FStar_All.pipe_right tps (FStar_List.map (fun _58_3047 -> (match (_58_3047) with
| (x, _58_3046) -> begin
...
let _58_3077 = (match ((let _150_1271 = (FStar_Syntax_Subst.compress t)
in _150_1271.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, res) -> begin
(

let _58_3065 = (FStar_Util.first_N ntps bs)
...
let subst = (FStar_All.pipe_right tps (FStar_List.mapi (fun i _58_3071 -> (match (_58_3071) with
| (x, _58_3070) -> begin
...
let _58_3078 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _58_3083 = (tc_tparams env arguments)
in (match (_58_3083) with
| (arguments, env', us) -> begin
(

let _58_3087 = (tc_trivial_guard env' result)
in (match (_58_3087) with
| (result, _58_3086) -> begin
(

let _58_3091 = (FStar_Syntax_Util.head_and_args result)
in (match (_58_3091) with
| (head, _58_3090) -> begin
(

let _58_3096 = (match ((let _150_1278 = (FStar_Syntax_Subst.compress head)
...
let g = (FStar_List.fold_left2 (fun g _58_3102 u_x -> (match (_58_3102) with
| (x, _58_3101) -> begin
(
...
let t = (let _150_1291 = (let _150_1289 = (FStar_All.pipe_right tps (FStar_List.map (fun _58_3110 -> (match (_58_3110) with
| (x, _58_3109) -> begin
...
let _58_3119 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (

let binders = (FStar_All.pipe_right tcs (FStar_List.map (fun _58_8 -> (match (_58_8) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_58_3123, _58_3125, tps, k, _58_3129, _58_3131, _58_3133, _58_3135) -> begin
...
| FStar_Syntax_Syntax.Sig_datacon (_58_3143, _58_3145, t, _58_3148, _58_3150, _58_3152, _58_3154, _58_3156) -> begin
...
let _58_3163 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _58_3167 = (FStar_TypeChecker_Util.generalize_universes env t)
in (match (_58_3167) with
| (uvs, t) -> begin
(

let _58_3169 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _58_3173 = (FStar_Syntax_Subst.open_univ_vars uvs t)
in (match (_58_3173) with
| (uvs, t) -> begin
(

let _58_3177 = (FStar_Syntax_Util.arrow_formals t)
in (match (_58_3177) with
| (args, _58_3176) -> begin
(

let _58_3180 = (FStar_Util.first_N (FStar_List.length binders) args)
in (match (_58_3180) with
| (tc_types, data_types) -> begin
(

let tcs = (FStar_List.map2 (fun _58_3184 se -> (match (_58_3184) with
| (x, _58_3183) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (tc, _58_3188, tps, _58_3191, mutuals, datas, quals, r) -> begin
(

let ty = (FStar_Syntax_Subst.close_univ_vars uvs x.FStar_Syntax_Syntax.sort)
in (

let _58_3214 = (match ((let _150_1312 = (FStar_Syntax_Subst.compress ty)
in _150_1312.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, c) -> begin
(

let _58_3205 = (FStar_Util.first_N (FStar_List.length tps) binders)
...
| FStar_Syntax_Syntax.Sig_inductive_typ (tc, _58_3225, _58_3227, _58_3229, _58_3231, _58_3233, _58_3235, _58_3237) -> begin
((tc), (uvs_universes))
end
| _58_3241 -> begin
(FStar_All.failwith "Impossible")
end))))
in (FStar_List.map2 (fun _58_3246 d -> (match (_58_3246) with
| (t, _58_3245) -> begin
(match (d) with
| FStar_Syntax_Syntax.Sig_datacon (l, _58_3250, _58_3252, tc, ntps, quals, mutuals, r) -> begin
(
...
let _58_3272 = (FStar_All.pipe_right ses (FStar_List.partition (fun _58_11 -> (match (_58_11) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_58_3266) -> begin
true
end
| _58_3269 -> begin
false
end))))
in (match (_58_3272) with
| (tys, datas) -> begin
(

let _58_3279 = if (FStar_All.pipe_right datas (FStar_Util.for_some (fun _58_12 -> (match (_58_12) with
| FStar_Syntax_Syntax.Sig_datacon (_58_3275) -> begin
false
end
| _58_3278 -> begin
true
...
let _58_3298 = (FStar_List.fold_right (fun tc _58_3286 -> (match (_58_3286) with
| (env, all_tcs, g) -> begin
(

let _58_3291 = (tc_tycon env tc)
...
let _58_3293 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _58_3308 = (FStar_List.fold_right (fun se _58_3302 -> (match (_58_3302) with
| (datas, g) -> begin
(

let _58_3305 = (tc_data env tcs se)
...
in (match (_58_3308) with
| (datas, g) -> begin
(

let _58_3311 = (let _150_1332 = (FStar_List.map Prims.fst tcs)
...
| FStar_Syntax_Syntax.Sig_datacon (_58_3316, _58_3318, t, _58_3321, _58_3323, _58_3325, _58_3327, _58_3329) -> begin
t
end
| _58_3333 -> begin
(FStar_All.failwith "Impossible!")
...
let _58_3360 = (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _58_3342, bs, t, _58_3346, d_lids, _58_3349, _58_3351) -> begin
((lid), (bs), (t), (d_lids))
end
| _58_3355 -> begin
(FStar_All.failwith "Impossible!")
end)
in (match (_58_3360) with
...
let _58_3365 = (FStar_Syntax_Subst.open_term bs t)
in (match (_58_3365) with
| (bs, t) -> begin
(

let ibs = (match ((let _150_1346 = (FStar_Syntax_Subst.compress t)
in _150_1346.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (ibs, _58_3368) -> begin
ibs
end
| _58_3372 -> begin
[]
...
let ind = (let _150_1352 = (FStar_List.map (fun _58_3379 -> (match (_58_3379) with
| (bv, aq) -> begin
...
let ind = (let _150_1355 = (FStar_List.map (fun _58_3383 -> (match (_58_3383) with
| (bv, aq) -> begin
...
let _58_3394 = acc
in (match (_58_3394) with
| (_58_3388, en, _58_3391, _58_3393) -> begin
(
...
in {FStar_Syntax_Syntax.n = _150_1372; FStar_Syntax_Syntax.tk = _58_3405.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _58_3405.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _58_3405.FStar_Syntax_Syntax.vars}))
in (
...
| FStar_Syntax_Syntax.Sig_datacon (_58_3424, _58_3426, _58_3428, t_lid, _58_3431, _58_3433, _58_3435, _58_3437) -> begin
(t_lid = lid)
end
| _58_3441 -> begin
(FStar_All.failwith "Impossible")
...
| FStar_Syntax_Syntax.Tm_arrow (dbs, _58_3450) -> begin
(
...
let _58_3466 = (FStar_List.fold_left haseq_data ((env), (FStar_Syntax_Util.t_true)) t_datas)
...
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_58_3472, us, _58_3475, _58_3477, _58_3479, _58_3481, _58_3483, _58_3485) -> begin
us
end
| _58_3489 -> begin
(FStar_All.failwith "Impossible!")
...
let _58_3493 = (FStar_Syntax_Subst.univ_var_opening us)
...
let _58_3495 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push "haseq")
in (

let _58_3497 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env sig_bndle)
in (

let env = (FStar_TypeChecker_Env.push_univ_vars env us)
in (

let _58_3504 = (FStar_List.fold_left (haseq_ty usubst us) (([]), (env), (FStar_Syntax_Util.t_true), (FStar_Syntax_Util.t_true)) tcs)
in (match (_58_3504) with
...
let _58_3509 = (tc_trivial_guard env phi)
in (match (_58_3509) with
| (phi, _58_3508) -> begin
(

let _58_3510 = if (FStar_Options.should_verify env.FStar_TypeChecker_Env.curmodule.FStar_Ident.str) then begin
...
let _58_3512 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop "haseq")
in (

let env = (FStar_TypeChecker_Env.push_univ_vars env0 us)
in (

let ses = (FStar_List.fold_left (fun l _58_3518 -> (match (_58_3518) with
| (lid, fml) -> begin
(
...
let _58_3561 = (set_options FStar_Options.Set o)
in (((se)::[]), (env)))
end
| FStar_Syntax_Syntax.ResetOptions (sopt) -> begin
(

let _58_3565 = (let _150_1418 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _150_1418 Prims.ignore))
in (

let _58_3570 = (match (sopt) with
| None -> begin
()
end
| Some (s) -> begin
...
let _58_3572 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (((se)::[]), (env)))))
end))
end
...
let _58_3595 = (FStar_All.pipe_right ne.FStar_Syntax_Syntax.actions (FStar_List.fold_left (fun _58_3590 a -> (match (_58_3590) with
| (env, ses) -> begin
(
...
let _58_3604 = (let _150_1422 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _150_1422))
in (match (_58_3604) with
| (a, wp_a_src) -> begin
(

let _58_3607 = (let _150_1423 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
in (monad_signature env sub.FStar_Syntax_Syntax.target _150_1423))
in (match (_58_3607) with
| (b, wp_b_tgt) -> begin
(
...
| Some (_58_3623, lift) -> begin
(

let _58_3629 = (let _150_1452 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
...
let _58_3642 = (tc_tot_or_gtot_term env expected_k)
in (match (_58_3642) with
| (expected_k, _58_3639, _58_3641) -> begin
(
...
let _58_3645 = sub
in {FStar_Syntax_Syntax.source = _58_3645.FStar_Syntax_Syntax.source; FStar_Syntax_Syntax.target = _58_3645.FStar_Syntax_Syntax.target; FStar_Syntax_Syntax.lift_wp = lift_wp; FStar_Syntax_Syntax.lift = lift})
in (
...
let _58_3664 = (FStar_Syntax_Subst.open_comp tps c)
in (match (_58_3664) with
| (tps, c) -> begin
(

let _58_3668 = (tc_tparams env tps)
in (match (_58_3668) with
| (tps, env, us) -> begin
(

let _58_3672 = (tc_comp env c)
in (match (_58_3672) with
| (c, u, g) -> begin
(

let _58_3673 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (
...
let _58_3679 = (let _150_1467 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _150_1467))
in (match (_58_3679) with
| (uvs, t) -> begin
(

let _58_3698 = (match ((let _150_1469 = (let _150_1468 = (FStar_Syntax_Subst.compress t)
in _150_1468.FStar_Syntax_Syntax.n)
in ((tps), (_150_1469)))) with
| ([], FStar_Syntax_Syntax.Tm_arrow (_58_3682, c)) -> begin
(([]), (c))
end
| (_58_3688, FStar_Syntax_Syntax.Tm_arrow (tps, c)) -> begin
((tps), (c))
end
| _58_3695 -> begin
(FStar_All.failwith "Impossible")
end)
in (match (_58_3698) with
| (tps, c) -> begin
(
...
let _58_3713 = (let _150_1471 = (let _150_1470 = (FStar_Syntax_Util.type_u ())
in (Prims.fst _150_1470))
in (check_and_gen env t _150_1471))
in (match (_58_3713) with
| (uvs, t) -> begin
(
...
let _58_3733 = (tc_term env e)
in (match (_58_3733) with
| (e, c, g1) -> begin
(

let _58_3738 = (let _150_1475 = (let _150_1472 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_150_1472))
in (let _150_1474 = (let _150_1473 = (c.FStar_Syntax_Syntax.comp ())
in ((e), (_150_1473)))
in (check_expected_effect env _150_1475 _150_1474)))
in (match (_58_3738) with
| (e, _58_3736, g) -> begin
(

let _58_3739 = (let _150_1476 = (FStar_TypeChecker_Rel.conj_guard g1 g)
...
let _58_3783 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.fold_left (fun _58_3760 lb -> (match (_58_3760) with
...
let _58_3779 = (match ((FStar_TypeChecker_Env.try_lookup_val_decl env lbname.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)) with
| None -> begin
((gen), (lb), (quals_opt))
end
...
let _58_3774 = (match (lb.FStar_Syntax_Syntax.lbtyp.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
()
end
| _58_3773 -> begin
...
let _58_3826 = (match ((tc_maybe_toplevel_term (

let _58_3796 = env
in {FStar_TypeChecker_Env.solver = _58_3796.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _58_3796.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _58_3796.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _58_3796.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _58_3796.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _58_3796.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _58_3796.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _58_3796.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _58_3796.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _58_3796.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _58_3796.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = should_generalize; FStar_TypeChecker_Env.letrecs = _58_3796.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _58_3796.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _58_3796.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _58_3796.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _58_3796.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.type_of = _58_3796.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _58_3796.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _58_3796.FStar_TypeChecker_Env.use_bv_sorts}) e)) with
| ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let (lbs, e); FStar_Syntax_Syntax.tk = _58_3803; FStar_Syntax_Syntax.pos = _58_3801; FStar_Syntax_Syntax.vars = _58_3799}, _58_3810, g) when (FStar_TypeChecker_Rel.is_trivial g) -> begin
(

let quals = (match (e.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_meta (_58_3814, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect)) -> begin
...
in (match (_58_3826) with
| (se, lbs) -> begin
(

let _58_3832 = if (log env) then begin
...
in (match (se) with
| FStar_Syntax_Syntax.Sig_pragma (_58_3854) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_inductive_typ (_)) | (FStar_Syntax_Syntax.Sig_datacon (_)) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _58_3865, _58_3867) -> begin
if (is_abstract quals) then begin
(FStar_List.fold_right (fun se _58_3873 -> (match (_58_3873) with
| (out, hidden) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, us, bs, t, _58_3879, _58_3881, quals, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (l, us, t, _58_3891, _58_3893, _58_3895, _58_3897, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_assume (_58_3905, _58_3907, quals, _58_3910) -> begin
if (is_abstract quals) then begin
(([]), (hidden))
end else begin
(((se)::[]), (hidden))
...
| FStar_Syntax_Syntax.Sig_main (_58_3931) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_new_effect (_)) | (FStar_Syntax_Syntax.Sig_new_effect_for_free (_)) | (FStar_Syntax_Syntax.Sig_sub_effect (_)) | (FStar_Syntax_Syntax.Sig_effect_abbrev (_)) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), _58_3950, _58_3952, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some is_hidden_proj_or_disc)) -> begin
(
...
let _58_3999 = (FStar_All.pipe_right ses (FStar_List.fold_left (fun _58_3972 se -> (match (_58_3972) with
| (ses, exports, env, hidden) -> begin
(

let _58_3974 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _58_3978 = (tc_decl env se)
in (match (_58_3978) with
| (ses', env) -> begin
(

let _58_3981 = if ((FStar_Options.log_types ()) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("LogTypes")))) then begin
...
let _58_3984 = (FStar_List.iter (fun se -> (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env se)) ses')
in (

let _58_3993 = (FStar_List.fold_left (fun _58_3988 se -> (match (_58_3988) with
| (le, lh) -> begin
(
...
in {FStar_TypeChecker_Env.solver = _58_4004.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _58_4004.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _58_4004.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _58_4004.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _58_4004.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _58_4004.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _58_4004.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _58_4004.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _58_4004.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _58_4004.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _58_4004.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _58_4004.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _58_4004.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _58_4004.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _58_4004.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _58_4004.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = modul.FStar_Syntax_Syntax.is_interface; FStar_TypeChecker_Env.admit = _150_1547; FStar_TypeChecker_Env.type_of = _58_4004.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _58_4004.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _58_4004.FStar_TypeChecker_Env.use_bv_sorts}))
in (

let _58_4007 = if (not ((FStar_Ident.lid_equals modul.FStar_Syntax_Syntax.name FStar_Syntax_Const.prims_lid))) then begin
...
let _58_4013 = (tc_decls env modul.FStar_Syntax_Syntax.declarations)
in (match (_58_4013) with
| (ses, exports, env) -> begin
(((

let _58_4014 = modul
in {FStar_Syntax_Syntax.name = _58_4014.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = ses; FStar_Syntax_Syntax.exports = _58_4014.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _58_4014.FStar_Syntax_Syntax.is_interface})), (exports), (env))
end))))))))


let tc_more_partial_modul : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_Syntax_Syntax.modul * FStar_Syntax_Syntax.sigelt Prims.list * FStar_TypeChecker_Env.env) = (fun env modul decls -> (

let _58_4022 = (tc_decls env decls)
in (match (_58_4022) with
| (ses, exports, env) -> begin
(
...
let _58_4023 = modul
in {FStar_Syntax_Syntax.name = _58_4023.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = (FStar_List.append modul.FStar_Syntax_Syntax.declarations ses); FStar_Syntax_Syntax.exports = _58_4023.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _58_4023.FStar_Syntax_Syntax.is_interface})
...
let _58_4029 = modul
in {FStar_Syntax_Syntax.name = _58_4029.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = _58_4029.FStar_Syntax_Syntax.declarations; FStar_Syntax_Syntax.exports = exports; FStar_Syntax_Syntax.is_interface = modul.FStar_Syntax_Syntax.is_interface})
in (

let env = (FStar_TypeChecker_Env.finish_module env modul)
in (

let _58_4039 = if (not ((FStar_Ident.lid_equals modul.FStar_Syntax_Syntax.name FStar_Syntax_Const.prims_lid))) then begin
(

let _58_4033 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop (Prims.strcat "Ending modul " modul.FStar_Syntax_Syntax.name.FStar_Ident.str))
in (

let _58_4035 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_modul env modul)
in (

let _58_4037 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
...
let _58_4046 = (tc_partial_modul env modul)
in (match (_58_4046) with
...
let _58_4049 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
...
let _58_4051 = env
in {FStar_TypeChecker_Env.solver = _58_4051.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _58_4051.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _58_4051.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _58_4051.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _58_4051.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _58_4051.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _58_4051.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _58_4051.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _58_4051.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _58_4051.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _58_4051.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _58_4051.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _58_4051.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = _58_4051.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _58_4051.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _58_4051.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _58_4051.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.type_of = _58_4051.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _58_4051.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _58_4051.FStar_TypeChecker_Env.use_bv_sorts})
in (
...
with
| FStar_Syntax_Syntax.Error (msg, _58_4059) -> begin
