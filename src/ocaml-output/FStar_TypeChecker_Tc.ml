...
| FStar_Syntax_Syntax.Sig_datacon (_60_1126, _60_1128, t, _60_1131, _60_1133, _60_1135, _60_1137, _60_1139) -> begin
t
end
| _60_1143 -> begin
(FStar_All.failwith "Impossible!")
...
let optimized_haseq_scheme = (fun _60_1146 -> (

let haseq_ty = (fun usubst us acc ty -> (

let _60_1173 = (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _60_1155, bs, t, _60_1159, d_lids, _60_1162, _60_1164) -> begin
((lid), (bs), (t), (d_lids))
end
| _60_1168 -> begin
(FStar_All.failwith "Impossible!")
end)
in (match (_60_1173) with
...
let _60_1178 = (FStar_Syntax_Subst.open_term bs t)
in (match (_60_1178) with
| (bs, t) -> begin
(

let ibs = (match ((let _157_624 = (FStar_Syntax_Subst.compress t)
in _157_624.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (ibs, _60_1181) -> begin
ibs
end
| _60_1185 -> begin
[]
...
let ind = (let _157_630 = (FStar_List.map (fun _60_1192 -> (match (_60_1192) with
| (bv, aq) -> begin
...
let ind = (let _157_633 = (FStar_List.map (fun _60_1196 -> (match (_60_1196) with
| (bv, aq) -> begin
...
let _60_1207 = acc
in (match (_60_1207) with
| (_60_1201, en, _60_1204, _60_1206) -> begin
(
...
in {FStar_Syntax_Syntax.n = _157_650; FStar_Syntax_Syntax.tk = _60_1218.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _60_1218.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _60_1218.FStar_Syntax_Syntax.vars}))
in (
...
| FStar_Syntax_Syntax.Sig_datacon (_60_1237, _60_1239, _60_1241, t_lid, _60_1244, _60_1246, _60_1248, _60_1250) -> begin
(t_lid = lid)
end
| _60_1254 -> begin
(FStar_All.failwith "Impossible")
...
| FStar_Syntax_Syntax.Tm_arrow (dbs, _60_1262) -> begin
(
...
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_60_1284, us, _60_1287, _60_1289, _60_1291, _60_1293, _60_1295, _60_1297) -> begin
us
end
| _60_1301 -> begin
(FStar_All.failwith "Impossible!")
...
let _60_1305 = (FStar_Syntax_Subst.univ_var_opening us)
...
let _60_1307 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push "haseq")
in (

let _60_1309 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env sig_bndle)
in (

let env = (FStar_TypeChecker_Env.push_univ_vars env us)
in (

let _60_1316 = (FStar_List.fold_left (haseq_ty usubst us) (([]), (env), (FStar_Syntax_Util.t_true), (FStar_Syntax_Util.t_true)) tcs)
in (match (_60_1316) with
...
let _60_1321 = (FStar_TypeChecker_TcTerm.tc_trivial_guard env phi)
in (match (_60_1321) with
| (phi, _60_1320) -> begin
(

let _60_1322 = if (FStar_TypeChecker_Env.should_verify env) then begin
...
let ses = (FStar_List.fold_left (fun l _60_1327 -> (match (_60_1327) with
| (lid, fml) -> begin
(
...
let _60_1330 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop "haseq")
in ses)))
end)))
end))))))
end)))))
...
let unoptimized_haseq_scheme = (fun _60_1333 -> (

let mutuals = (FStar_List.map (fun ty -> (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _60_1338, _60_1340, _60_1342, _60_1344, _60_1346, _60_1348, _60_1350) -> begin
lid
end
| _60_1354 -> begin
(FStar_All.failwith "Impossible!")
...
let _60_1381 = (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _60_1363, bs, t, _60_1367, d_lids, _60_1370, _60_1372) -> begin
((lid), (bs), (t), (d_lids))
end
| _60_1376 -> begin
(FStar_All.failwith "Impossible!")
end)
in (match (_60_1381) with
| (lid, bs, t, d_lids) -> begin
(
...
let _60_1386 = (FStar_Syntax_Subst.open_term bs t)
in (match (_60_1386) with
| (bs, t) -> begin
(

let ibs = (match ((let _157_701 = (FStar_Syntax_Subst.compress t)
in _157_701.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (ibs, _60_1389) -> begin
ibs
end
| _60_1393 -> begin
[]
...
let ind = (let _157_707 = (FStar_List.map (fun _60_1400 -> (match (_60_1400) with
| (bv, aq) -> begin
...
let ind = (let _157_710 = (FStar_List.map (fun _60_1404 -> (match (_60_1404) with
| (bv, aq) -> begin
...
| FStar_Syntax_Syntax.Tm_uinst (t', _60_1415) -> begin
(is_mutual t')
end
...
| FStar_Syntax_Syntax.Tm_meta (t', _60_1428) -> begin
(is_mutual t')
end
| _60_1432 -> begin
false
...
| FStar_Syntax_Syntax.Tm_arrow (dbs, _60_1445) -> begin
(
...
let t_datas = (FStar_List.filter (fun s -> (match (s) with
| FStar_Syntax_Syntax.Sig_datacon (_60_1464, _60_1466, _60_1468, t_lid, _60_1471, _60_1473, _60_1475, _60_1477) -> begin
(t_lid = lid)
end
| _60_1481 -> begin
(FStar_All.failwith "Impossible")
...
in {FStar_Syntax_Syntax.n = _157_743; FStar_Syntax_Syntax.tk = _60_1485.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _60_1485.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _60_1485.FStar_Syntax_Syntax.vars}))
in (
...
let ty = (FStar_List.hd tcs)
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, us, _60_1498, _60_1500, _60_1502, _60_1504, _60_1506, _60_1508) -> begin
((lid), (us))
end
| _60_1512 -> begin
(FStar_All.failwith "Impossible!")
end))
in (match (_60_1515) with
| (lid, us) -> begin
(

let _60_1518 = (FStar_Syntax_Subst.univ_var_opening us)
in (match (_60_1518) with
| (usubst, us) -> begin
(
...
let _60_1521 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push "haseq")
in (

let _60_1523 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env sig_bndle)
in (
...
let _60_1527 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop "haseq")
in (se)::[])))))))
end))
end)))))
in (

let skip_prims_type = (fun _60_1530 -> (

let lid = (

let ty = (FStar_List.hd tcs)
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _60_1535, _60_1537, _60_1539, _60_1541, _60_1543, _60_1545, _60_1547) -> begin
lid
end
| _60_1551 -> begin
(FStar_All.failwith "Impossible")
...
let _60_1563 = (FStar_TypeChecker_Util.check_sigelt_quals env se)
in (match (se) with
...
let _60_1603 = (set_options FStar_Options.Set o)
in (((se)::[]), (env)))
end
| FStar_Syntax_Syntax.ResetOptions (sopt) -> begin
(

let _60_1607 = (let _157_774 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _157_774 Prims.ignore))
in (

let _60_1612 = (match (sopt) with
| None -> begin
()
end
| Some (s) -> begin
...
let _60_1614 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (((se)::[]), (env)))))
end))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (_60_1617) -> begin
(FStar_All.failwith "impossible")
end
...
let _60_1633 = (FStar_All.pipe_right ne.FStar_Syntax_Syntax.actions (FStar_List.fold_left (fun _60_1628 a -> (match (_60_1628) with
| (env, ses) -> begin
(
...
let _60_1642 = (let _157_778 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _157_778))
in (match (_60_1642) with
| (a, wp_a_src) -> begin
(

let _60_1645 = (let _157_779 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
...
let _60_1686 = (match (((sub.FStar_Syntax_Syntax.lift), (sub.FStar_Syntax_Syntax.lift_wp))) with
| (None, None) -> begin
(FStar_All.failwith "Impossible")
end
| (lift, Some (_60_1663, lift_wp)) -> begin
...
let _60_1679 = (FStar_TypeChecker_DMFF.star_expr dmff_env lift)
in (match (_60_1679) with
| (_60_1676, lift_wp, lift_elab) -> begin
(

let _60_1680 = (recheck_debug "lift-wp" env lift_wp)
in (

let _60_1682 = (recheck_debug "lift-elab" env lift_elab)
in ((Some ((([]), (lift_elab)))), ((([]), (lift_wp))))))
end)))
end)
in (match (_60_1686) with
| (lift, lift_wp) -> begin
(
...
let _60_1688 = env
in {FStar_TypeChecker_Env.solver = _60_1688.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _60_1688.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _60_1688.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _60_1688.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _60_1688.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _60_1688.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _60_1688.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _60_1688.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _60_1688.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _60_1688.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _60_1688.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _60_1688.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _60_1688.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _60_1688.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _60_1688.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _60_1688.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _60_1688.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _60_1688.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = _60_1688.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _60_1688.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _60_1688.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _60_1688.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _60_1688.FStar_TypeChecker_Env.qname_and_index})
in (
...
| Some (_60_1693, lift) -> begin
(

let _60_1699 = (let _157_809 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
...
let _60_1713 = (FStar_TypeChecker_TcTerm.tc_tot_or_gtot_term env expected_k)
in (match (_60_1713) with
| (expected_k, _60_1710, _60_1712) -> begin
(
...
let _60_1716 = env
in {FStar_TypeChecker_Env.solver = _60_1716.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _60_1716.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _60_1716.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _60_1716.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _60_1716.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _60_1716.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _60_1716.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _60_1716.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _60_1716.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _60_1716.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _60_1716.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _60_1716.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _60_1716.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _60_1716.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _60_1716.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _60_1716.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _60_1716.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _60_1716.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax; FStar_TypeChecker_Env.lax_universes = _60_1716.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _60_1716.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _60_1716.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _60_1716.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _60_1716.FStar_TypeChecker_Env.qname_and_index})
in (

let sub = (

let _60_1719 = sub
in {FStar_Syntax_Syntax.source = _60_1719.FStar_Syntax_Syntax.source; FStar_Syntax_Syntax.target = _60_1719.FStar_Syntax_Syntax.target; FStar_Syntax_Syntax.lift_wp = Some (lift_wp); FStar_Syntax_Syntax.lift = lift})
in (
...
let _60_1739 = (FStar_Syntax_Subst.open_comp tps c)
in (match (_60_1739) with
| (tps, c) -> begin
(

let _60_1743 = (tc_tparams env tps)
in (match (_60_1743) with
| (tps, env, us) -> begin
(

let _60_1747 = (FStar_TypeChecker_TcTerm.tc_comp env c)
in (match (_60_1747) with
| (c, u, g) -> begin
(

let _60_1748 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (
...
let _60_1754 = (let _157_824 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _157_824))
in (match (_60_1754) with
| (uvs, t) -> begin
(

let _60_1773 = (match ((let _157_826 = (let _157_825 = (FStar_Syntax_Subst.compress t)
in _157_825.FStar_Syntax_Syntax.n)
in ((tps), (_157_826)))) with
| ([], FStar_Syntax_Syntax.Tm_arrow (_60_1757, c)) -> begin
(([]), (c))
end
| (_60_1763, FStar_Syntax_Syntax.Tm_arrow (tps, c)) -> begin
((tps), (c))
end
| _60_1770 -> begin
(FStar_All.failwith "Impossible")
end)
in (match (_60_1773) with
| (tps, c) -> begin
(

let _60_1778 = if (((FStar_List.length uvs) <> (Prims.parse_int "1")) && (not ((FStar_Ident.lid_equals lid FStar_Syntax_Const.effect_Lemma_lid)))) then begin
(

let _60_1777 = (FStar_Syntax_Subst.open_univ_vars uvs t)
...
let _60_1794 = (let _157_834 = (let _157_833 = (FStar_Syntax_Util.type_u ())
...
let _60_1814 = (FStar_TypeChecker_TcTerm.tc_term env e)
in (match (_60_1814) with
| (e, c, g1) -> begin
(

let _60_1819 = (let _157_838 = (let _157_835 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_157_835))
...
let _60_1820 = (let _157_839 = (FStar_TypeChecker_Rel.conj_guard g1 g)
...
let _60_1864 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.fold_left (fun _60_1841 lb -> (match (_60_1841) with
...
let _60_1860 = (match ((FStar_TypeChecker_Env.try_lookup_val_decl env lbname.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)) with
| None -> begin
((gen), (lb), (quals_opt))
end
...
let _60_1855 = (match (lb.FStar_Syntax_Syntax.lbtyp.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
()
end
| _60_1854 -> begin
...
let _60_1907 = (match ((FStar_TypeChecker_TcTerm.tc_maybe_toplevel_term (

let _60_1877 = env
in {FStar_TypeChecker_Env.solver = _60_1877.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _60_1877.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _60_1877.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _60_1877.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _60_1877.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _60_1877.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _60_1877.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _60_1877.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _60_1877.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _60_1877.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _60_1877.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = should_generalize; FStar_TypeChecker_Env.letrecs = _60_1877.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _60_1877.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _60_1877.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _60_1877.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _60_1877.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _60_1877.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _60_1877.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _60_1877.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _60_1877.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _60_1877.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _60_1877.FStar_TypeChecker_Env.qname_and_index}) e)) with
| ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let (lbs, e); FStar_Syntax_Syntax.tk = _60_1884; FStar_Syntax_Syntax.pos = _60_1882; FStar_Syntax_Syntax.vars = _60_1880}, _60_1891, g) when (FStar_TypeChecker_Rel.is_trivial g) -> begin
(

let quals = (match (e.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_meta (_60_1895, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect)) -> begin
...
in (match (_60_1907) with
| (se, lbs) -> begin
(

let _60_1913 = if (log env) then begin
...
in (match (se) with
| FStar_Syntax_Syntax.Sig_pragma (_60_1935) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_inductive_typ (_)) | (FStar_Syntax_Syntax.Sig_datacon (_)) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _60_1946, r) -> begin
if (is_abstract quals) then begin
(FStar_List.fold_right (fun se _60_1953 -> (match (_60_1953) with
| (out, hidden) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, us, bs, t, _60_1959, _60_1961, quals, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (l, us, t, _60_1971, _60_1973, _60_1975, _60_1977, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_assume (_60_1985, _60_1987, quals, _60_1990) -> begin
if (is_abstract quals) then begin
(([]), (hidden))
end else begin
(((se)::[]), (hidden))
...
| FStar_Syntax_Syntax.Sig_main (_60_2011) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_new_effect (_)) | (FStar_Syntax_Syntax.Sig_new_effect_for_free (_)) | (FStar_Syntax_Syntax.Sig_sub_effect (_)) | (FStar_Syntax_Syntax.Sig_effect_abbrev (_)) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), _60_2030, _60_2032, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some is_hidden_proj_or_disc)) -> begin
(
...
let process_one_decl = (fun _60_2053 se -> (match (_60_2053) with
| (ses, exports, env, hidden) -> begin
(

let _60_2055 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _60_2059 = (tc_decl env se)
in (match (_60_2059) with
| (ses', env) -> begin
(

let _60_2062 = if ((FStar_Options.log_types ()) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("LogTypes")))) then begin
...
let _60_2065 = (FStar_List.iter (fun se -> (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env se)) ses')
in (

let _60_2074 = (FStar_List.fold_left (fun _60_2069 se -> (match (_60_2069) with
| (le, lh) -> begin
(
...
let _60_2104 = (FStar_List.fold_left (fun acc se -> (match (se) with
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ne, r) -> begin
(

let _60_2088 = acc
in (match (_60_2088) with
| (_60_2082, _60_2084, env, _60_2087) -> begin
(

let _60_2092 = (cps_and_elaborate env ne)
in (match (_60_2092) with
...
| (ses, exports, env, _60_2103) -> begin
...
in {FStar_TypeChecker_Env.solver = _60_2109.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _60_2109.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _60_2109.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _60_2109.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _60_2109.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _60_2109.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _60_2109.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _60_2109.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _60_2109.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _60_2109.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _60_2109.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _60_2109.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _60_2109.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _60_2109.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _60_2109.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _60_2109.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = modul.FStar_Syntax_Syntax.is_interface; FStar_TypeChecker_Env.admit = _157_912; FStar_TypeChecker_Env.lax = _60_2109.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _60_2109.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _60_2109.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _60_2109.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _60_2109.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _60_2109.FStar_TypeChecker_Env.qname_and_index}))
in (

let _60_2112 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push msg)
in (

let env = (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name)
in (

let _60_2118 = (tc_decls env modul.FStar_Syntax_Syntax.declarations)
in (match (_60_2118) with
| (ses, exports, env) -> begin
(((

let _60_2119 = modul
in {FStar_Syntax_Syntax.name = _60_2119.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = ses; FStar_Syntax_Syntax.exports = _60_2119.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _60_2119.FStar_Syntax_Syntax.is_interface})), (exports), (env))
end))))))))


let tc_more_partial_modul : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_Syntax_Syntax.modul * FStar_Syntax_Syntax.sigelt Prims.list * FStar_TypeChecker_Env.env) = (fun env modul decls -> (

let _60_2127 = (tc_decls env decls)
...
let _60_2128 = modul
in {FStar_Syntax_Syntax.name = _60_2128.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = (FStar_List.append modul.FStar_Syntax_Syntax.declarations ses); FStar_Syntax_Syntax.exports = _60_2128.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _60_2128.FStar_Syntax_Syntax.is_interface})
...
let _60_2134 = env
in {FStar_TypeChecker_Env.solver = _60_2134.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _60_2134.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _60_2134.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _60_2134.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _60_2134.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _60_2134.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _60_2134.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _60_2134.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _60_2134.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _60_2134.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _60_2134.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _60_2134.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _60_2134.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _60_2134.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _60_2134.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _60_2134.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _60_2134.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = true; FStar_TypeChecker_Env.type_of = _60_2134.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _60_2134.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _60_2134.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _60_2134.FStar_TypeChecker_Env.qname_and_index})
in (

let check_term = (fun lid univs t -> (

let _60_2143 = (FStar_Syntax_Subst.open_univ_vars univs t)
in (match (_60_2143) with
| (univs, t) -> begin
(

let _60_2145 = if (let _157_932 = (let _157_931 = (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name)
...
let _60_2152 = (let _157_947 = (let _157_946 = (FStar_Syntax_Print.lid_to_string modul.FStar_Syntax_Syntax.name)
...
let _60_2154 = (check_term lid univs t)
...
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _60_2161, _60_2163) -> begin
...
| FStar_Syntax_Syntax.Sig_inductive_typ (l, univs, binders, typ, _60_2171, _60_2173, _60_2175, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (l, univs, t, _60_2184, _60_2186, _60_2188, _60_2190, _60_2192) -> begin
(check_term l univs t)
end
| FStar_Syntax_Syntax.Sig_declare_typ (l, univs, t, quals, _60_2200) -> begin
if (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private)))) then begin
(check_term l univs t)
end else begin
()
...
| FStar_Syntax_Syntax.Sig_let ((_60_2204, lbs), _60_2208, _60_2210, quals) -> begin
if (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private)))) then begin
...
let _60_2247 = modul
in {FStar_Syntax_Syntax.name = _60_2247.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = _60_2247.FStar_Syntax_Syntax.declarations; FStar_Syntax_Syntax.exports = exports; FStar_Syntax_Syntax.is_interface = modul.FStar_Syntax_Syntax.is_interface})
in (

let env = (FStar_TypeChecker_Env.finish_module env modul)
in (

let _60_2251 = (check_exports env modul exports)
in (

let _60_2253 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop (Prims.strcat "Ending modul " modul.FStar_Syntax_Syntax.name.FStar_Ident.str))
in (

let _60_2255 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_modul env modul)
in (

let _60_2257 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (

let _60_2259 = (let _157_960 = (FStar_Options.restore_cmd_line_options true)
...
let _60_2266 = (tc_partial_modul env modul)
in (match (_60_2266) with
...
let _60_2269 = if (FStar_Options.debug_any ()) then begin
...
let _60_2273 = (tc_modul env m)
in (match (_60_2273) with
| (m, env) -> begin
(

let _60_2274 = if (FStar_Options.dump_module m.FStar_Syntax_Syntax.name.FStar_Ident.str) then begin
...
let _60_2292 = if ((FStar_Options.dump_module m.FStar_Syntax_Syntax.name.FStar_Ident.str) && (FStar_Options.debug_at_level m.FStar_Syntax_Syntax.name.FStar_Ident.str (FStar_Options.Other ("Normalize")))) then begin
(let _157_980 = (let _157_979 = (

let _60_2276 = m
in (let _157_978 = (FStar_List.map (fun _60_12 -> (match (_60_12) with
...
in (let _157_977 = (let _157_976 = (let _157_975 = (FStar_List.map (fun lb -> (

let _60_2289 = lb
in (let _157_974 = (n lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _60_2289.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _60_2289.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _60_2289.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _60_2289.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _157_974}))) lbs)
in ((b), (_157_975)))
in ((_157_976), (r), (ids), (qs)))
in FStar_Syntax_Syntax.Sig_let (_157_977)))
end
| se -> begin
se
end)) m.FStar_Syntax_Syntax.declarations)
in {FStar_Syntax_Syntax.name = _60_2276.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = _157_978; FStar_Syntax_Syntax.exports = _60_2276.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _60_2276.FStar_Syntax_Syntax.is_interface}))
in (FStar_Syntax_Print.modul_to_string _157_979))
in (FStar_Util.print1 "%s\n" _157_980))
end else begin
()
end
