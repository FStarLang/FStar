...
let p = (let _150_1457 = (FStar_Ident.path_of_lid l)
in (let _150_1456 = (let _150_1455 = (let _150_1454 = (FStar_Syntax_Syntax.next_id ())
in (FStar_All.pipe_right _150_1454 FStar_Util.string_of_int))
in (_150_1455)::[])
in (FStar_List.append _150_1457 _150_1456)))
...
let _58_3638 = env
in {FStar_TypeChecker_Env.solver = _58_3638.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _58_3638.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _58_3638.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _58_3638.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _58_3638.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _58_3638.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _58_3638.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _58_3638.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _58_3638.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _58_3638.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _58_3638.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _58_3638.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _58_3638.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _58_3638.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _58_3638.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _58_3638.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _58_3638.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _58_3638.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _58_3638.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.type_of = _58_3638.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _58_3638.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _58_3638.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = Some (((lid), (0)))}))
in (match (se) with
...
in (let _150_1458 = (FStar_TypeChecker_Env.push_sigelt env se)
in (((se)::[]), (_150_1458)))))
end
...
let _58_3679 = (set_options FStar_Options.Set o)
in (((se)::[]), (env)))
end
| FStar_Syntax_Syntax.ResetOptions (sopt) -> begin
(

let _58_3683 = (let _150_1465 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _150_1465 Prims.ignore))
in (

let _58_3688 = (match (sopt) with
| None -> begin
()
end
| Some (s) -> begin
...
let _58_3690 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (((se)::[]), (env)))))
end))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (_58_3693) -> begin
(FStar_All.failwith "impossible")
end
...
let _58_3709 = (FStar_All.pipe_right ne.FStar_Syntax_Syntax.actions (FStar_List.fold_left (fun _58_3704 a -> (match (_58_3704) with
| (env, ses) -> begin
(

let se_let = (FStar_Syntax_Util.action_as_lb a)
in (let _150_1468 = (FStar_TypeChecker_Env.push_sigelt env se_let)
in ((_150_1468), ((se_let)::ses))))
end)) ((env), ((se)::[]))))
...
let _58_3718 = (let _150_1469 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _150_1469))
in (match (_58_3718) with
| (a, wp_a_src) -> begin
(

let _58_3721 = (let _150_1470 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
in (monad_signature env sub.FStar_Syntax_Syntax.target _150_1470))
in (match (_58_3721) with
| (b, wp_b_tgt) -> begin
(

let wp_a_tgt = (let _150_1474 = (let _150_1473 = (let _150_1472 = (let _150_1471 = (FStar_Syntax_Syntax.bv_to_name a)
in ((b), (_150_1471)))
in FStar_Syntax_Syntax.NT (_150_1472))
in (_150_1473)::[])
in (FStar_Syntax_Subst.subst _150_1474 wp_b_tgt))
in (

let expected_k = (let _150_1479 = (let _150_1477 = (FStar_Syntax_Syntax.mk_binder a)
in (let _150_1476 = (let _150_1475 = (FStar_Syntax_Syntax.null_binder wp_a_src)
in (_150_1475)::[])
in (_150_1477)::_150_1476))
in (let _150_1478 = (FStar_Syntax_Syntax.mk_Total wp_a_tgt)
in (FStar_Syntax_Util.arrow _150_1479 _150_1478)))
in (
...
let no_reify = (fun l -> (let _150_1491 = (let _150_1490 = (let _150_1489 = (FStar_Util.format1 "Effect %s cannot be reified" l.FStar_Ident.str)
in (let _150_1488 = (FStar_TypeChecker_Env.get_range env)
in ((_150_1489), (_150_1488))))
in FStar_Syntax_Syntax.Error (_150_1490))
in (Prims.raise _150_1491)))
...
(let _150_1498 = (let _150_1496 = (let _150_1495 = (let _150_1494 = (FStar_Syntax_Syntax.as_arg a)
in (let _150_1493 = (let _150_1492 = (FStar_Syntax_Syntax.as_arg wp)
in (_150_1492)::[])
in (_150_1494)::_150_1493))
in ((repr), (_150_1495)))
in FStar_Syntax_Syntax.Tm_app (_150_1496))
in (let _150_1497 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk _150_1498 None _150_1497)))
end)
end)))
in (
...
| Some (_58_3737, lift) -> begin
(

let _58_3743 = (let _150_1499 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _150_1499))
...
let lift_wp_a = (let _150_1506 = (let _150_1504 = (let _150_1503 = (let _150_1502 = (FStar_Syntax_Syntax.as_arg a_typ)
in (let _150_1501 = (let _150_1500 = (FStar_Syntax_Syntax.as_arg wp_a_typ)
in (_150_1500)::[])
in (_150_1502)::_150_1501))
in (((Prims.snd sub.FStar_Syntax_Syntax.lift_wp)), (_150_1503)))
in FStar_Syntax_Syntax.Tm_app (_150_1504))
in (let _150_1505 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk _150_1506 None _150_1505)))
in (repr_type sub.FStar_Syntax_Syntax.target a_typ lift_wp_a))
in (

let expected_k = (let _150_1513 = (let _150_1511 = (FStar_Syntax_Syntax.mk_binder a)
in (let _150_1510 = (let _150_1509 = (FStar_Syntax_Syntax.mk_binder wp_a)
in (let _150_1508 = (let _150_1507 = (FStar_Syntax_Syntax.null_binder repr_f)
in (_150_1507)::[])
in (_150_1509)::_150_1508))
in (_150_1511)::_150_1510))
in (let _150_1512 = (FStar_Syntax_Syntax.mk_Total repr_result)
in (FStar_Syntax_Util.arrow _150_1513 _150_1512)))
in (

let _58_3756 = (tc_tot_or_gtot_term env expected_k)
in (match (_58_3756) with
| (expected_k, _58_3753, _58_3755) -> begin
(
...
let _58_3759 = sub
in {FStar_Syntax_Syntax.source = _58_3759.FStar_Syntax_Syntax.source; FStar_Syntax_Syntax.target = _58_3759.FStar_Syntax_Syntax.target; FStar_Syntax_Syntax.lift_wp = lift_wp; FStar_Syntax_Syntax.lift = lift})
in (
...
let _58_3778 = (FStar_Syntax_Subst.open_comp tps c)
in (match (_58_3778) with
| (tps, c) -> begin
(

let _58_3782 = (tc_tparams env tps)
in (match (_58_3782) with
| (tps, env, us) -> begin
(

let _58_3786 = (tc_comp env c)
in (match (_58_3786) with
| (c, u, g) -> begin
(

let _58_3787 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (
...
let _58_3793 = (let _150_1514 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _150_1514))
in (match (_58_3793) with
| (uvs, t) -> begin
(

let _58_3812 = (match ((let _150_1516 = (let _150_1515 = (FStar_Syntax_Subst.compress t)
in _150_1515.FStar_Syntax_Syntax.n)
in ((tps), (_150_1516)))) with
| ([], FStar_Syntax_Syntax.Tm_arrow (_58_3796, c)) -> begin
(([]), (c))
end
| (_58_3802, FStar_Syntax_Syntax.Tm_arrow (tps, c)) -> begin
((tps), (c))
end
| _58_3809 -> begin
(FStar_All.failwith "Impossible")
...
let _58_3827 = (let _150_1518 = (let _150_1517 = (FStar_Syntax_Util.type_u ())
in (Prims.fst _150_1517))
in (check_and_gen env t _150_1518))
...
let _58_3847 = (tc_term env e)
in (match (_58_3847) with
| (e, c, g1) -> begin
(

let _58_3852 = (let _150_1522 = (let _150_1519 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_150_1519))
in (let _150_1521 = (let _150_1520 = (c.FStar_Syntax_Syntax.comp ())
in ((e), (_150_1520)))
in (check_expected_effect env _150_1522 _150_1521)))
in (match (_58_3852) with
| (e, _58_3850, g) -> begin
(

let _58_3853 = (let _150_1523 = (FStar_TypeChecker_Rel.conj_guard g1 g)
in (FStar_TypeChecker_Rel.force_trivial_guard env _150_1523))
in (
...
(let _150_1535 = (let _150_1534 = (let _150_1533 = (let _150_1532 = (FStar_Syntax_Print.lid_to_string l)
in (let _150_1531 = (FStar_Syntax_Print.quals_to_string q)
in (let _150_1530 = (FStar_Syntax_Print.quals_to_string q')
in (FStar_Util.format3 "Inconsistent qualifier annotations on %s; Expected {%s}, got {%s}" _150_1532 _150_1531 _150_1530))))
in ((_150_1533), (r)))
in FStar_Syntax_Syntax.Error (_150_1534))
in (Prims.raise _150_1535))
end
end))
in (

let _58_3897 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.fold_left (fun _58_3874 lb -> (match (_58_3874) with
...
let _58_3893 = (match ((FStar_TypeChecker_Env.try_lookup_val_decl env lbname.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)) with
| None -> begin
((gen), (lb), (quals_opt))
end
...
let _58_3888 = (match (lb.FStar_Syntax_Syntax.lbtyp.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
()
end
| _58_3887 -> begin
...
in (let _150_1538 = (FStar_Syntax_Syntax.mk_lb ((FStar_Util.Inr (lbname)), (uvs), (FStar_Syntax_Const.effect_ALL_lid), (tval), (lb.FStar_Syntax_Syntax.lbdef)))
in ((false), (_150_1538), (quals_opt)))))
end)
in (match (_58_3893) with
...
let e = (let _150_1542 = (let _150_1541 = (let _150_1540 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)) None r)
in (((((Prims.fst lbs)), (lbs'))), (_150_1540)))
in FStar_Syntax_Syntax.Tm_let (_150_1541))
in (FStar_Syntax_Syntax.mk _150_1542 None r))
in (

let _58_3940 = (match ((tc_maybe_toplevel_term (

let _58_3910 = env
in {FStar_TypeChecker_Env.solver = _58_3910.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _58_3910.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _58_3910.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _58_3910.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _58_3910.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _58_3910.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _58_3910.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _58_3910.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _58_3910.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _58_3910.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _58_3910.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = should_generalize; FStar_TypeChecker_Env.letrecs = _58_3910.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _58_3910.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _58_3910.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _58_3910.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _58_3910.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _58_3910.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.type_of = _58_3910.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _58_3910.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _58_3910.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _58_3910.FStar_TypeChecker_Env.qname_and_index}) e)) with
| ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let (lbs, e); FStar_Syntax_Syntax.tk = _58_3917; FStar_Syntax_Syntax.pos = _58_3915; FStar_Syntax_Syntax.vars = _58_3913}, _58_3924, g) when (FStar_TypeChecker_Rel.is_trivial g) -> begin
(

let quals = (match (e.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_meta (_58_3928, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect)) -> begin
...
in (match (_58_3940) with
| (se, lbs) -> begin
(

let _58_3946 = if (log env) then begin
(let _150_1550 = (let _150_1549 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (

let should_log = (match ((let _150_1546 = (let _150_1545 = (let _150_1544 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _150_1544.FStar_Syntax_Syntax.fv_name)
in _150_1545.FStar_Syntax_Syntax.v)
in (FStar_TypeChecker_Env.try_lookup_val_decl env _150_1546))) with
| None -> begin
true
end
| _58_3944 -> begin
...
(let _150_1548 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
in (let _150_1547 = (FStar_Syntax_Print.term_to_string lb.FStar_Syntax_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" _150_1548 _150_1547)))
end else begin
""
end))))
in (FStar_All.pipe_right _150_1549 (FStar_String.concat "\n")))
in (FStar_Util.print1 "%s\n" _150_1550))
end else begin
()
end
...
in (match (se) with
| FStar_Syntax_Syntax.Sig_pragma (_58_3968) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_inductive_typ (_)) | (FStar_Syntax_Syntax.Sig_datacon (_)) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _58_3979, _58_3981) -> begin
if (is_abstract quals) then begin
(FStar_List.fold_right (fun se _58_3987 -> (match (_58_3987) with
| (out, hidden) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, us, bs, t, _58_3993, _58_3995, quals, r) -> begin
(

let dec = (let _150_1566 = (let _150_1565 = (let _150_1564 = (let _150_1563 = (let _150_1562 = (FStar_Syntax_Syntax.mk_Total t)
in ((bs), (_150_1562)))
in FStar_Syntax_Syntax.Tm_arrow (_150_1563))
in (FStar_Syntax_Syntax.mk _150_1564 None r))
in ((l), (us), (_150_1565), ((FStar_Syntax_Syntax.Assumption)::(FStar_Syntax_Syntax.New)::quals), (r)))
in FStar_Syntax_Syntax.Sig_declare_typ (_150_1566))
in (((dec)::out), (hidden)))
end
| FStar_Syntax_Syntax.Sig_datacon (l, us, t, _58_4005, _58_4007, _58_4009, _58_4011, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_assume (_58_4019, _58_4021, quals, _58_4024) -> begin
if (is_abstract quals) then begin
(([]), (hidden))
end else begin
(((se)::[]), (hidden))
...
| FStar_Syntax_Syntax.Sig_main (_58_4045) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_new_effect (_)) | (FStar_Syntax_Syntax.Sig_new_effect_for_free (_)) | (FStar_Syntax_Syntax.Sig_sub_effect (_)) | (FStar_Syntax_Syntax.Sig_effect_abbrev (_)) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), _58_4064, _58_4066, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some is_hidden_proj_or_disc)) -> begin
(
...
if (is_abstract quals) then begin
(let _150_1573 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let _150_1572 = (let _150_1571 = (let _150_1570 = (let _150_1569 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _150_1569.FStar_Syntax_Syntax.fv_name)
in _150_1570.FStar_Syntax_Syntax.v)
in ((_150_1571), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp), ((FStar_Syntax_Syntax.Assumption)::quals), (r)))
in FStar_Syntax_Syntax.Sig_declare_typ (_150_1572)))))
in ((_150_1573), (hidden)))
end else begin
(((se)::[]), (hidden))
end
...
let process_one_decl = (fun _58_4087 se -> (match (_58_4087) with
| (ses, exports, env, hidden) -> begin
(

let _58_4089 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _150_1582 = (FStar_Syntax_Print.sigelt_to_string se)
...
let _58_4093 = (tc_decl env se)
in (match (_58_4093) with
| (ses', env) -> begin
(

let _58_4096 = if ((FStar_Options.log_types ()) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("LogTypes")))) then begin
(let _150_1587 = (FStar_List.fold_left (fun s se -> (let _150_1586 = (let _150_1585 = (FStar_Syntax_Print.sigelt_to_string se)
in (Prims.strcat _150_1585 "\n"))
in (Prims.strcat s _150_1586))) "" ses')
...
let _58_4099 = (FStar_List.iter (fun se -> (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env se)) ses')
in (

let _58_4108 = (FStar_List.fold_left (fun _58_4103 se -> (match (_58_4103) with
| (le, lh) -> begin
(
...
let _58_4134 = (FStar_List.fold_left (fun acc se -> (match (se) with
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ne, r) -> begin
(

let _58_4122 = acc
in (match (_58_4122) with
| (_58_4116, _58_4118, env, _58_4121) -> begin
(

let _58_4125 = (cps_and_elaborate env ne)
...
| (ses, exports, env, _58_4133) -> begin
(let _150_1593 = (FStar_All.pipe_right (FStar_List.rev_append exports []) FStar_List.flatten)
in (((FStar_List.rev_append ses [])), (_150_1593), (env)))
end))))
...
let _58_4139 = env
in (let _150_1598 = (not ((FStar_Options.should_verify modul.FStar_Syntax_Syntax.name.FStar_Ident.str)))
in {FStar_TypeChecker_Env.solver = _58_4139.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _58_4139.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _58_4139.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _58_4139.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _58_4139.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _58_4139.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _58_4139.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _58_4139.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _58_4139.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _58_4139.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _58_4139.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _58_4139.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _58_4139.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _58_4139.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _58_4139.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _58_4139.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = modul.FStar_Syntax_Syntax.is_interface; FStar_TypeChecker_Env.admit = _150_1598; FStar_TypeChecker_Env.lax = _58_4139.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.type_of = _58_4139.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _58_4139.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _58_4139.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _58_4139.FStar_TypeChecker_Env.qname_and_index}))
in (

let _58_4142 = if (not ((FStar_Ident.lid_equals modul.FStar_Syntax_Syntax.name FStar_Syntax_Const.prims_lid))) then begin
...
let _58_4148 = (tc_decls env modul.FStar_Syntax_Syntax.declarations)
in (match (_58_4148) with
| (ses, exports, env) -> begin
(((

let _58_4149 = modul
in {FStar_Syntax_Syntax.name = _58_4149.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = ses; FStar_Syntax_Syntax.exports = _58_4149.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _58_4149.FStar_Syntax_Syntax.is_interface})), (exports), (env))
end))))))))


let tc_more_partial_modul : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_Syntax_Syntax.modul * FStar_Syntax_Syntax.sigelt Prims.list * FStar_TypeChecker_Env.env) = (fun env modul decls -> (

let _58_4157 = (tc_decls env decls)
...
let _58_4158 = modul
in {FStar_Syntax_Syntax.name = _58_4158.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = (FStar_List.append modul.FStar_Syntax_Syntax.declarations ses); FStar_Syntax_Syntax.exports = _58_4158.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _58_4158.FStar_Syntax_Syntax.is_interface})
...
let _58_4164 = modul
in {FStar_Syntax_Syntax.name = _58_4164.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = _58_4164.FStar_Syntax_Syntax.declarations; FStar_Syntax_Syntax.exports = exports; FStar_Syntax_Syntax.is_interface = modul.FStar_Syntax_Syntax.is_interface})
in (

let env = (FStar_TypeChecker_Env.finish_module env modul)
in (

let _58_4174 = if (not ((FStar_Ident.lid_equals modul.FStar_Syntax_Syntax.name FStar_Syntax_Const.prims_lid))) then begin
(

let _58_4168 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop (Prims.strcat "Ending modul " modul.FStar_Syntax_Syntax.name.FStar_Ident.str))
in (

let _58_4170 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_modul env modul)
in (

let _58_4172 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (let _150_1611 = (FStar_Options.restore_cmd_line_options true)
in (FStar_All.pipe_right _150_1611 Prims.ignore)))))
end else begin
()
end
in ((modul), (env))))))
...
let _58_4181 = (tc_partial_modul env modul)
in (match (_58_4181) with
...
let _58_4184 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
(let _150_1620 = (FStar_Syntax_Print.term_to_string e)
...
let _58_4186 = env
in {FStar_TypeChecker_Env.solver = _58_4186.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _58_4186.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _58_4186.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _58_4186.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _58_4186.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _58_4186.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _58_4186.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _58_4186.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _58_4186.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _58_4186.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _58_4186.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _58_4186.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _58_4186.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = _58_4186.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _58_4186.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _58_4186.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _58_4186.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _58_4186.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.type_of = _58_4186.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _58_4186.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _58_4186.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _58_4186.FStar_TypeChecker_Env.qname_and_index})
in (
...
with
| FStar_Syntax_Syntax.Error (msg, _58_4194) -> begin
(let _150_1625 = (let _150_1624 = (let _150_1623 = (FStar_TypeChecker_Env.get_range env)
in (((Prims.strcat "Implicit argument: " msg)), (_150_1623)))
in FStar_Syntax_Syntax.Error (_150_1624))
in (Prims.raise _150_1625))
end
in (match (_58_4202) with
| (t, c, g) -> begin
if (FStar_Syntax_Util.is_total_lcomp c) then begin
((t), (c.FStar_Syntax_Syntax.res_typ), (g))
end else begin
(let _150_1630 = (let _150_1629 = (let _150_1628 = (let _150_1626 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "Implicit argument: Expected a total term; got a ghost term: %s" _150_1626))
in (let _150_1627 = (FStar_TypeChecker_Env.get_range env)
in ((_150_1628), (_150_1627))))
...
let _58_4205 = if (FStar_TypeChecker_Env.debug env FStar_Options.Extreme) then begin
(let _150_1635 = (FStar_Syntax_Print.tag_of_term e)
...
let _58_4210 = (FStar_TypeChecker_Env.clear_expected_typ env)
...
let _58_4211 = env
in {FStar_TypeChecker_Env.solver = _58_4211.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _58_4211.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _58_4211.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _58_4211.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _58_4211.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _58_4211.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _58_4211.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _58_4211.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _58_4211.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _58_4211.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _58_4211.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _58_4211.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _58_4211.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = _58_4211.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _58_4211.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _58_4211.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _58_4211.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.type_of = _58_4211.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _58_4211.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = _58_4211.FStar_TypeChecker_Env.qname_and_index})
in (

let fail = (fun e t -> (let _150_1645 = (let _150_1644 = (let _150_1643 = (let _150_1641 = (FStar_Syntax_Print.term_to_string e)
in (let _150_1640 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format2 "Expected a term of type \'Type\'; got %s : %s" _150_1641 _150_1640)))
in (let _150_1642 = (FStar_TypeChecker_Env.get_range env)
in ((_150_1643), (_150_1642))))
in FStar_Syntax_Syntax.Error (_150_1644))
in (Prims.raise _150_1645)))
in (

let ok = (fun u -> (

let _58_4219 = if (FStar_TypeChecker_Env.debug env FStar_Options.Extreme) then begin
(let _150_1649 = (FStar_Syntax_Print.tag_of_term e)
in (let _150_1648 = (FStar_Syntax_Print.univ_to_string u)
...
let universe_of_type = (fun e t -> (match ((let _150_1654 = (FStar_Syntax_Util.unrefine t)
in _150_1654.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_type (u) -> begin
(ok u)
end
| _58_4227 -> begin
...
let _58_4230 = (FStar_Syntax_Util.head_and_args e)
in (match (_58_4230) with
| (head, args) -> begin
(match ((let _150_1655 = (FStar_Syntax_Subst.compress head)
in _150_1655.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uvar (_58_4232, t) -> begin
(
...
in (match ((let _150_1656 = (FStar_Syntax_Subst.compress t)
in _150_1656.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (_58_4238, t) -> begin
...
let _58_4258 = (tc_term env e)
in (match (_58_4258) with
| (_58_4248, {FStar_Syntax_Syntax.eff_name = _58_4255; FStar_Syntax_Syntax.res_typ = t; FStar_Syntax_Syntax.cflags = _58_4252; FStar_Syntax_Syntax.comp = _58_4250}, g) -> begin
(

let _58_4259 = (FStar_TypeChecker_Rel.solve_deferred_constraints env g)
in (let _150_1658 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::[]) env t)
in (FStar_All.pipe_left (universe_of_type e) _150_1658)))
end)))
end)
end))))))
end)))
...
let _58_4263 = if (FStar_Options.debug_any ()) then begin
(let _150_1663 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
...
let _58_4267 = (tc_modul env m)
in (match (_58_4267) with
| (m, env) -> begin
(

let _58_4268 = if (FStar_Options.dump_module m.FStar_Syntax_Syntax.name.FStar_Ident.str) then begin
(let _150_1664 = (FStar_Syntax_Print.modul_to_string m)
in (FStar_Util.print1 "%s\n" _150_1664))
end else begin
()
end
