...
let _59_568 = (let _154_405 = (let _154_404 = (FStar_ST.read sigelts)
...
let _59_571 = (let _154_407 = (let _154_406 = (FStar_ST.read sigelts)
...
let _59_590 = (FStar_List.fold_left (fun _59_575 action -> (match (_59_575) with
| (dmff_env, actions) -> begin
(

let _59_581 = (elaborate_and_star dmff_env ((action.FStar_Syntax_Syntax.action_univs), (action.FStar_Syntax_Syntax.action_defn)))
...
in (let _154_413 = (let _154_412 = (

let _59_586 = action
in (let _154_411 = (apply_close action_elab)
in (let _154_410 = (apply_close action_typ_with_wp)
in {FStar_Syntax_Syntax.action_name = _59_586.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_univs = _59_586.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_defn = _154_411; FStar_Syntax_Syntax.action_typ = _154_410})))
in (_154_412)::actions)
in ((dmff_env), (_154_413)))))))
end))
...
let binders = (let _154_416 = (FStar_Syntax_Syntax.mk_binder a)
in (let _154_415 = (let _154_414 = (FStar_Syntax_Syntax.mk_binder wp)
in (_154_414)::[])
in (_154_416)::_154_415))
in (let _154_425 = (let _154_424 = (let _154_422 = (let _154_421 = (let _154_420 = (let _154_419 = (let _154_418 = (FStar_Syntax_Syntax.bv_to_name a)
in (let _154_417 = (FStar_Syntax_Syntax.as_implicit false)
in ((_154_418), (_154_417))))
in (_154_419)::[])
in ((repr), (_154_420)))
in FStar_Syntax_Syntax.Tm_app (_154_421))
in (mk _154_422))
in (let _154_423 = (FStar_Syntax_Syntax.bv_to_name wp)
in (FStar_TypeChecker_DMFF.trans_F dmff_env _154_424 _154_423)))
in (FStar_Syntax_Util.abs binders _154_425 None))))
in (
...
let _59_597 = (let _154_426 = (register "wp" wp_type)
in (Prims.ignore _154_426))
in (

let ed = (

let _59_599 = ed
in (let _154_437 = (FStar_Syntax_Subst.close_binders effect_binders)
in (let _154_436 = (FStar_Syntax_Subst.close effect_binders effect_signature)
in (let _154_435 = (let _154_427 = (apply_close return_wp)
in (([]), (_154_427)))
in (let _154_434 = (let _154_428 = (apply_close bind_wp)
in (([]), (_154_428)))
in (let _154_433 = (apply_close repr)
in (let _154_432 = (let _154_429 = (apply_close return_elab)
in (([]), (_154_429)))
in (let _154_431 = (let _154_430 = (apply_close bind_elab)
in (([]), (_154_430)))
in {FStar_Syntax_Syntax.qualifiers = _59_599.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _59_599.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = _59_599.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = _154_437; FStar_Syntax_Syntax.signature = _154_436; FStar_Syntax_Syntax.ret_wp = _154_435; FStar_Syntax_Syntax.bind_wp = _154_434; FStar_Syntax_Syntax.if_then_else = _59_599.FStar_Syntax_Syntax.if_then_else; FStar_Syntax_Syntax.ite_wp = _59_599.FStar_Syntax_Syntax.ite_wp; FStar_Syntax_Syntax.stronger = _59_599.FStar_Syntax_Syntax.stronger; FStar_Syntax_Syntax.close_wp = _59_599.FStar_Syntax_Syntax.close_wp; FStar_Syntax_Syntax.assert_p = _59_599.FStar_Syntax_Syntax.assert_p; FStar_Syntax_Syntax.assume_p = _59_599.FStar_Syntax_Syntax.assume_p; FStar_Syntax_Syntax.null_wp = _59_599.FStar_Syntax_Syntax.null_wp; FStar_Syntax_Syntax.trivial = _59_599.FStar_Syntax_Syntax.trivial; FStar_Syntax_Syntax.repr = _154_433; FStar_Syntax_Syntax.return_repr = _154_432; FStar_Syntax_Syntax.bind_repr = _154_431; FStar_Syntax_Syntax.actions = actions}))))))))
in (

let _59_604 = (FStar_TypeChecker_DMFF.gen_wps_for_free env effect_binders a wp_a ed)
in (match (_59_604) with
| (sigelts', ed) -> begin
(

let _59_605 = if (FStar_TypeChecker_Env.debug env (FStar_Options.Other ("ED"))) then begin
(let _154_438 = (FStar_Syntax_Print.eff_decl_to_string true ed)
in (FStar_Util.print_string _154_438))
end else begin
()
end
in (
...
let lift_from_pure = (let _154_441 = (let _154_440 = (let _154_439 = (apply_close lift_from_pure_wp)
in (([]), (_154_439)))
in Some (_154_440))
in {FStar_Syntax_Syntax.source = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.target = ed.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.lift_wp = _154_441; FStar_Syntax_Syntax.lift = None})
in Some (FStar_Syntax_Syntax.Sig_sub_effect (((lift_from_pure), (FStar_Range.dummyRange)))))
end else begin
None
end
in (let _154_444 = (let _154_443 = (let _154_442 = (FStar_ST.read sigelts)
in (FStar_List.rev _154_442))
in (FStar_List.append _154_443 sigelts'))
in ((_154_444), (ed), (lift_from_pure_opt)))))
end))))))))
end))))))))))))))
end))
end))))))))))))
...
let _59_621 = ()
in (match (ses) with
| (FStar_Syntax_Syntax.Sig_inductive_typ (lex_t, [], [], t, _59_650, _59_652, [], r))::(FStar_Syntax_Syntax.Sig_datacon (lex_top, [], _t_top, _lex_t_top, _154_449, [], _59_641, r1))::(FStar_Syntax_Syntax.Sig_datacon (lex_cons, [], _t_cons, _lex_t_cons, _154_450, [], _59_630, r2))::[] when (((_154_449 = (Prims.parse_int "0")) && (_154_450 = (Prims.parse_int "0"))) && (((FStar_Ident.lid_equals lex_t FStar_Syntax_Const.lex_t_lid) && (FStar_Ident.lid_equals lex_top FStar_Syntax_Const.lextop_lid)) && (FStar_Ident.lid_equals lex_cons FStar_Syntax_Const.lexcons_lid))) -> begin
(
...
let lex_top_t = (let _154_453 = (let _154_452 = (let _154_451 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range FStar_Syntax_Const.lex_t_lid r1) FStar_Syntax_Syntax.Delta_constant None)
in ((_154_451), ((FStar_Syntax_Syntax.U_name (utop))::[])))
in FStar_Syntax_Syntax.Tm_uinst (_154_452))
in (FStar_Syntax_Syntax.mk _154_453 None r1))
in (
...
let a = (let _154_454 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_name (ucons1))) None r2)
in (FStar_Syntax_Syntax.new_bv (Some (r2)) _154_454))
in (

let hd = (let _154_455 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.new_bv (Some (r2)) _154_455))
in (

let tl = (let _154_459 = (let _154_458 = (let _154_457 = (let _154_456 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range FStar_Syntax_Const.lex_t_lid r2) FStar_Syntax_Syntax.Delta_constant None)
in ((_154_456), ((FStar_Syntax_Syntax.U_name (ucons2))::[])))
in FStar_Syntax_Syntax.Tm_uinst (_154_457))
in (FStar_Syntax_Syntax.mk _154_458 None r2))
in (FStar_Syntax_Syntax.new_bv (Some (r2)) _154_459))
in (

let res = (let _154_462 = (let _154_461 = (let _154_460 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range FStar_Syntax_Const.lex_t_lid r2) FStar_Syntax_Syntax.Delta_constant None)
in ((_154_460), ((FStar_Syntax_Syntax.U_max ((FStar_Syntax_Syntax.U_name (ucons1))::(FStar_Syntax_Syntax.U_name (ucons2))::[]))::[])))
in FStar_Syntax_Syntax.Tm_uinst (_154_461))
in (FStar_Syntax_Syntax.mk _154_462 None r2))
in (let _154_463 = (FStar_Syntax_Syntax.mk_Total res)
in (FStar_Syntax_Util.arrow ((((a), (Some (FStar_Syntax_Syntax.imp_tag))))::(((hd), (None)))::(((tl), (None)))::[]) _154_463))))))
in (
...
in (let _154_465 = (let _154_464 = (FStar_TypeChecker_Env.get_range env)
in (((tc)::(dc_lextop)::(dc_lexcons)::[]), ([]), (lids), (_154_464)))
in FStar_Syntax_Syntax.Sig_bundle (_154_465)))))))))))))))
end
| _59_676 -> begin
(let _154_467 = (let _154_466 = (FStar_Syntax_Print.sigelt_to_string (FStar_Syntax_Syntax.Sig_bundle (((ses), ([]), (lids), (FStar_Range.dummyRange)))))
in (FStar_Util.format1 "Unexpected lex_t: %s\n" _154_466))
in (FStar_All.failwith _154_467))
end))))
...
let _59_686 = (FStar_Syntax_Util.type_u ())
in (match (_59_686) with
| (k, _59_685) -> begin
(

let phi = (let _154_473 = (tc_check_trivial_guard env phi k)
in (FStar_All.pipe_right _154_473 (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.Eager_unfolding)::[]) env)))
in (

let _59_688 = (FStar_TypeChecker_Util.check_uvars r phi)
...
let warn_positivity = (fun l r -> (let _154_483 = (let _154_482 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format1 "Positivity check is not yet implemented (%s)" _154_482))
in (FStar_TypeChecker_Errors.diag r _154_483)))
in (
...
let _59_713 = (warn_positivity tc r)
in (

let _59_717 = (FStar_Syntax_Subst.open_term tps k)
in (match (_59_717) with
| (tps, k) -> begin
(

let _59_722 = (FStar_TypeChecker_TcTerm.tc_binders env tps)
in (match (_59_722) with
| (tps, env_tps, guard_params, us) -> begin
(

let _59_725 = (FStar_Syntax_Util.arrow_formals k)
in (match (_59_725) with
| (indices, t) -> begin
(

let _59_730 = (FStar_TypeChecker_TcTerm.tc_binders env_tps indices)
...
let _59_735 = (FStar_TypeChecker_TcTerm.tc_tot_or_gtot_term env' t)
in (match (_59_735) with
| (t, _59_733, g) -> begin
(let _154_490 = (let _154_489 = (let _154_488 = (FStar_TypeChecker_Rel.conj_guard guard_indices g)
in (FStar_TypeChecker_Rel.conj_guard guard_params _154_488))
in (FStar_TypeChecker_Rel.discharge_guard env' _154_489))
in ((t), (_154_490)))
end))
in (match (_59_738) with
| (t, guard) -> begin
(

let k = (let _154_491 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow indices _154_491))
in (

let _59_742 = (FStar_Syntax_Util.type_u ())
in (match (_59_742) with
| (t_type, u) -> begin
(

let _59_743 = (let _154_492 = (FStar_TypeChecker_Rel.teq env' t t_type)
in (FStar_TypeChecker_Rel.force_trivial_guard env' _154_492))
in (

let t_tc = (let _154_493 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow (FStar_List.append tps indices) _154_493))
in (
...
in (let _154_494 = (FStar_TypeChecker_Env.push_let_binding env_tps (FStar_Util.Inr (fv_tc)) (([]), (t_tc)))
in ((_154_494), (FStar_Syntax_Syntax.Sig_inductive_typ (((tc), ([]), (tps), (k), (mutuals), (data), (quals), (r)))), (u), (guard))))))))
end)))
end))
end))
end))
...
let positive_if_pure = (fun _59_752 l -> ())
in (
...
let tps_u_opt = (FStar_Util.find_map tcs (fun _59_773 -> (match (_59_773) with
| (se, u_tc) -> begin
if (let _154_507 = (let _154_506 = (FStar_Syntax_Util.lid_of_sigelt se)
in (FStar_Util.must _154_506))
in (FStar_Ident.lid_equals tc_lid _154_507)) then begin
(

let tps = (match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_59_775, _59_777, tps, _59_780, _59_782, _59_784, _59_786, _59_788) -> begin
(FStar_All.pipe_right tps (FStar_List.map (fun _59_794 -> (match (_59_794) with
| (x, _59_793) -> begin
...
let _59_824 = (match ((let _154_509 = (FStar_Syntax_Subst.compress t)
in _154_509.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, res) -> begin
(

let _59_812 = (FStar_Util.first_N ntps bs)
in (match (_59_812) with
| (_59_810, bs') -> begin
(
...
let subst = (FStar_All.pipe_right tps (FStar_List.mapi (fun i _59_818 -> (match (_59_818) with
| (x, _59_817) -> begin
FStar_Syntax_Syntax.DB ((((ntps - ((Prims.parse_int "1") + i))), (x)))
end))))
in (let _154_512 = (FStar_Syntax_Subst.subst subst t)
in (FStar_Syntax_Util.arrow_formals _154_512))))
end))
end
| _59_821 -> begin
(([]), (t))
...
let _59_825 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _154_515 = (FStar_Syntax_Print.lid_to_string c)
in (let _154_514 = (FStar_Syntax_Print.binders_to_string "->" arguments)
in (let _154_513 = (FStar_Syntax_Print.term_to_string result)
in (FStar_Util.print3 "Checking datacon  %s : %s -> %s \n" _154_515 _154_514 _154_513))))
end else begin
()
end
in (

let _59_830 = (tc_tparams env arguments)
in (match (_59_830) with
| (arguments, env', us) -> begin
(

let _59_833 = (FStar_TypeChecker_TcTerm.tc_trivial_guard env' result)
in (match (_59_833) with
| (result, res_lcomp) -> begin
(

let _59_838 = (match ((let _154_516 = (FStar_Syntax_Subst.compress res_lcomp.FStar_Syntax_Syntax.res_typ)
in _154_516.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_type (_59_835) -> begin
()
end
| ty -> begin
(let _154_521 = (let _154_520 = (let _154_519 = (let _154_518 = (FStar_Syntax_Print.term_to_string result)
in (let _154_517 = (FStar_Syntax_Print.term_to_string res_lcomp.FStar_Syntax_Syntax.res_typ)
in (FStar_Util.format2 "The type of %s is %s, but since this is the result type of a constructor its type should be Type" _154_518 _154_517)))
in ((_154_519), (r)))
in FStar_Syntax_Syntax.Error (_154_520))
in (Prims.raise _154_521))
end)
in (

let _59_843 = (FStar_Syntax_Util.head_and_args result)
in (match (_59_843) with
| (head, _59_842) -> begin
(

let _59_848 = (match ((let _154_522 = (FStar_Syntax_Subst.compress head)
in _154_522.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv) when (FStar_Syntax_Syntax.fv_eq_lid fv tc_lid) -> begin
()
end
| _59_847 -> begin
(let _154_527 = (let _154_526 = (let _154_525 = (let _154_524 = (FStar_Syntax_Print.lid_to_string tc_lid)
in (let _154_523 = (FStar_Syntax_Print.term_to_string head)
in (FStar_Util.format2 "Expected a constructor of type %s; got %s" _154_524 _154_523)))
in ((_154_525), (r)))
in FStar_Syntax_Syntax.Error (_154_526))
in (Prims.raise _154_527))
end)
in (

let g = (FStar_List.fold_left2 (fun g _59_854 u_x -> (match (_59_854) with
| (x, _59_853) -> begin
(

let _59_856 = ()
in (let _154_531 = (FStar_TypeChecker_Rel.universe_inequality u_x u_tc)
in (FStar_TypeChecker_Rel.conj_guard g _154_531)))
end)) FStar_TypeChecker_Rel.trivial_guard arguments us)
in (

let t = (let _154_535 = (let _154_533 = (FStar_All.pipe_right tps (FStar_List.map (fun _59_862 -> (match (_59_862) with
| (x, _59_861) -> begin
((x), (Some (FStar_Syntax_Syntax.Implicit (true))))
end))))
in (FStar_List.append _154_533 arguments))
in (let _154_534 = (FStar_Syntax_Syntax.mk_Total result)
in (FStar_Syntax_Util.arrow _154_535 _154_534)))
...
let _59_871 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (

let binders = (FStar_All.pipe_right tcs (FStar_List.map (fun _59_2 -> (match (_59_2) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_59_875, _59_877, tps, k, _59_881, _59_883, _59_885, _59_887) -> begin
(let _154_546 = (let _154_545 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_All.pipe_left (FStar_Syntax_Util.arrow tps) _154_545))
in (FStar_Syntax_Syntax.null_binder _154_546))
end
| _59_891 -> begin
(FStar_All.failwith "Impossible")
end))))
...
| FStar_Syntax_Syntax.Sig_datacon (_59_895, _59_897, t, _59_900, _59_902, _59_904, _59_906, _59_908) -> begin
...
let t = (let _154_548 = (FStar_Syntax_Syntax.mk_Total FStar_TypeChecker_Common.t_unit)
in (FStar_Syntax_Util.arrow (FStar_List.append binders binders') _154_548))
in (

let _59_915 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _154_549 = (FStar_TypeChecker_Normalize.term_to_string env t)
...
let _59_919 = (FStar_TypeChecker_Util.generalize_universes env t)
in (match (_59_919) with
| (uvs, t) -> begin
(

let _59_921 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _154_553 = (let _154_551 = (FStar_All.pipe_right uvs (FStar_List.map (fun u -> u.FStar_Ident.idText)))
in (FStar_All.pipe_right _154_551 (FStar_String.concat ", ")))
in (let _154_552 = (FStar_Syntax_Print.term_to_string t)
...
let _59_925 = (FStar_Syntax_Subst.open_univ_vars uvs t)
in (match (_59_925) with
| (uvs, t) -> begin
(

let _59_929 = (FStar_Syntax_Util.arrow_formals t)
in (match (_59_929) with
| (args, _59_928) -> begin
(

let _59_932 = (FStar_Util.first_N (FStar_List.length binders) args)
in (match (_59_932) with
| (tc_types, data_types) -> begin
(

let tcs = (FStar_List.map2 (fun _59_936 se -> (match (_59_936) with
| (x, _59_935) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (tc, _59_940, tps, _59_943, mutuals, datas, quals, r) -> begin
(

let ty = (FStar_Syntax_Subst.close_univ_vars uvs x.FStar_Syntax_Syntax.sort)
in (

let _59_966 = (match ((let _154_556 = (FStar_Syntax_Subst.compress ty)
in _154_556.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, c) -> begin
(

let _59_957 = (FStar_Util.first_N (FStar_List.length tps) binders)
in (match (_59_957) with
| (tps, rest) -> begin
(
...
| _59_960 -> begin
(let _154_557 = (FStar_ST.read x.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((rest), (c)))) _154_557 x.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.pos))
end)
in ((tps), (t)))
end))
end
...
let uvs_universes = (FStar_All.pipe_right uvs (FStar_List.map (fun _154_558 -> FStar_Syntax_Syntax.U_name (_154_558))))
in (

let tc_insts = (FStar_All.pipe_right tcs (FStar_List.map (fun _59_4 -> (match (_59_4) with
| FStar_Syntax_Syntax.Sig_inductive_typ (tc, _59_977, _59_979, _59_981, _59_983, _59_985, _59_987, _59_989) -> begin
((tc), (uvs_universes))
end
| _59_993 -> begin
(FStar_All.failwith "Impossible")
end))))
in (FStar_List.map2 (fun _59_998 d -> (match (_59_998) with
| (t, _59_997) -> begin
(match (d) with
| FStar_Syntax_Syntax.Sig_datacon (l, _59_1002, _59_1004, tc, ntps, quals, mutuals, r) -> begin
(

let ty = (let _154_562 = (FStar_Syntax_InstFV.instantiate tc_insts t.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _154_562 (FStar_Syntax_Subst.close_univ_vars uvs)))
...
let _59_1024 = (FStar_All.pipe_right ses (FStar_List.partition (fun _59_5 -> (match (_59_5) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_59_1018) -> begin
true
end
| _59_1021 -> begin
false
...
let _59_1031 = if (FStar_All.pipe_right datas (FStar_Util.for_some (fun _59_6 -> (match (_59_6) with
| FStar_Syntax_Syntax.Sig_datacon (_59_1027) -> begin
false
end
| _59_1030 -> begin
true
end)))) then begin
(let _154_567 = (let _154_566 = (let _154_565 = (FStar_TypeChecker_Env.get_range env)
in (("Mutually defined type contains a non-inductive element"), (_154_565)))
in FStar_Syntax_Syntax.Error (_154_566))
in (Prims.raise _154_567))
end else begin
()
end
in (
...
let _59_1050 = (FStar_List.fold_right (fun tc _59_1038 -> (match (_59_1038) with
| (env, all_tcs, g) -> begin
(

let _59_1043 = (tc_tycon env tc)
...
let _59_1045 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _154_570 = (FStar_Syntax_Print.sigelt_to_string tc)
in (FStar_Util.print1 "Checked inductive: %s\n" _154_570))
end else begin
()
end
in (let _154_572 = (let _154_571 = (FStar_TypeChecker_Rel.conj_guard guard g')
in (FStar_TypeChecker_Rel.conj_guard g _154_571))
in ((env), ((((tc), (tc_u)))::all_tcs), (_154_572)))))
end))
...
let _59_1060 = (FStar_List.fold_right (fun se _59_1054 -> (match (_59_1054) with
| (datas, g) -> begin
(

let _59_1057 = (tc_data env tcs se)
in (match (_59_1057) with
| (data, g') -> begin
(let _154_575 = (FStar_TypeChecker_Rel.conj_guard g g')
in (((data)::datas), (_154_575)))
end))
end)) datas (([]), (g)))
in (match (_59_1060) with
| (datas, g) -> begin
(

let _59_1063 = (let _154_576 = (FStar_List.map Prims.fst tcs)
in (generalize_and_inst_within env0 g _154_576 datas))
in (match (_59_1063) with
| (tcs, datas) -> begin
(

let sig_bndle = (let _154_578 = (let _154_577 = (FStar_TypeChecker_Env.get_range env0)
in (((FStar_List.append tcs datas)), (quals), (lids), (_154_577)))
in FStar_Syntax_Syntax.Sig_bundle (_154_578))
in (

let datacon_typ = (fun data -> (match (data) with
| FStar_Syntax_Syntax.Sig_datacon (_59_1068, _59_1070, t, _59_1073, _59_1075, _59_1077, _59_1079, _59_1081) -> begin
t
end
| _59_1085 -> begin
(FStar_All.failwith "Impossible!")
...
let optimized_haseq_scheme = (fun _59_1088 -> (

let haseq_ty = (fun usubst us acc ty -> (

let _59_1115 = (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _59_1097, bs, t, _59_1101, d_lids, _59_1104, _59_1106) -> begin
((lid), (bs), (t), (d_lids))
end
| _59_1110 -> begin
(FStar_All.failwith "Impossible!")
...
let t = (let _154_591 = (FStar_Syntax_Subst.shift_subst (FStar_List.length bs) usubst)
in (FStar_Syntax_Subst.subst _154_591 t))
in (

let _59_1120 = (FStar_Syntax_Subst.open_term bs t)
in (match (_59_1120) with
| (bs, t) -> begin
(

let ibs = (match ((let _154_592 = (FStar_Syntax_Subst.compress t)
in _154_592.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (ibs, _59_1123) -> begin
ibs
end
| _59_1127 -> begin
[]
...
let ind = (let _154_595 = (FStar_Syntax_Syntax.fvar lid FStar_Syntax_Syntax.Delta_constant None)
in (let _154_594 = (FStar_List.map (fun u -> FStar_Syntax_Syntax.U_name (u)) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst _154_595 _154_594)))
in (

let ind = (let _154_598 = (FStar_List.map (fun _59_1134 -> (match (_59_1134) with
| (bv, aq) -> begin
(let _154_597 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((_154_597), (aq)))
end)) bs)
in (FStar_Syntax_Syntax.mk_Tm_app ind _154_598 None dr))
in (

let ind = (let _154_601 = (FStar_List.map (fun _59_1138 -> (match (_59_1138) with
| (bv, aq) -> begin
(let _154_600 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((_154_600), (aq)))
end)) ibs)
in (FStar_Syntax_Syntax.mk_Tm_app ind _154_601 None dr))
in (

let haseq_ind = (let _154_603 = (let _154_602 = (FStar_Syntax_Syntax.as_arg ind)
in (_154_602)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _154_603 None dr))
in (

let bs' = (FStar_List.filter (fun b -> (

let _59_1149 = acc
in (match (_59_1149) with
| (_59_1143, en, _59_1146, _59_1148) -> begin
(

let opt = (let _154_606 = (let _154_605 = (FStar_Syntax_Util.type_u ())
in (Prims.fst _154_605))
in (FStar_TypeChecker_Rel.try_subtype' en (Prims.fst b).FStar_Syntax_Syntax.sort _154_606 false))
in (match (opt) with
| None -> begin
false
end
...
let haseq_bs = (FStar_List.fold_left (fun t b -> (let _154_612 = (let _154_611 = (let _154_610 = (let _154_609 = (FStar_Syntax_Syntax.bv_to_name (Prims.fst b))
in (FStar_Syntax_Syntax.as_arg _154_609))
in (_154_610)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _154_611 None dr))
in (FStar_Syntax_Util.mk_conj t _154_612))) FStar_Syntax_Util.t_true bs')
in (
...
let _59_1160 = fml
in (let _154_618 = (let _154_617 = (let _154_616 = (let _154_615 = (let _154_614 = (let _154_613 = (FStar_Syntax_Syntax.as_arg haseq_ind)
in (_154_613)::[])
in (_154_614)::[])
in FStar_Syntax_Syntax.Meta_pattern (_154_615))
in ((fml), (_154_616)))
in FStar_Syntax_Syntax.Tm_meta (_154_617))
in {FStar_Syntax_Syntax.n = _154_618; FStar_Syntax_Syntax.tk = _59_1160.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _59_1160.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _59_1160.FStar_Syntax_Syntax.vars}))
in (

let fml = (FStar_List.fold_right (fun b t -> (let _154_624 = (let _154_623 = (let _154_622 = (let _154_621 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) _154_621 None))
in (FStar_Syntax_Syntax.as_arg _154_622))
in (_154_623)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_624 None dr))) ibs fml)
in (

let fml = (FStar_List.fold_right (fun b t -> (let _154_630 = (let _154_629 = (let _154_628 = (let _154_627 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) _154_627 None))
in (FStar_Syntax_Syntax.as_arg _154_628))
in (_154_629)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_630 None dr))) bs fml)
in (
...
| FStar_Syntax_Syntax.Sig_datacon (_59_1179, _59_1181, _59_1183, t_lid, _59_1186, _59_1188, _59_1190, _59_1192) -> begin
(t_lid = lid)
end
| _59_1196 -> begin
(FStar_All.failwith "Impossible")
...
in (match ((let _154_634 = (FStar_Syntax_Subst.compress dt)
in _154_634.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (dbs, _59_1204) -> begin
(

let dbs = (let _154_635 = (FStar_List.splitAt (FStar_List.length bs) dbs)
in (Prims.snd _154_635))
in (

let dbs = (let _154_636 = (FStar_Syntax_Subst.opening_of_binders bs)
in (FStar_Syntax_Subst.subst_binders _154_636 dbs))
in (
...
let haseq_b = (let _154_640 = (let _154_639 = (FStar_Syntax_Syntax.as_arg (Prims.fst b).FStar_Syntax_Syntax.sort)
in (_154_639)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _154_640 None dr))
in (

let sort_range = (Prims.fst b).FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.pos
in (

let haseq_b = (let _154_642 = (let _154_641 = (FStar_Syntax_Print.term_to_string ind)
in (FStar_Util.format1 "Failed to prove that the type \'%s\' supports decidable equality because of this argument; add the \'noeq\' qualifier" _154_641))
in (FStar_TypeChecker_Util.label _154_642 sort_range haseq_b))
in (FStar_Syntax_Util.mk_conj t haseq_b))))) FStar_Syntax_Util.t_true dbs)
in (FStar_List.fold_right (fun b t -> (let _154_648 = (let _154_647 = (let _154_646 = (let _154_645 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) _154_645 None))
in (FStar_Syntax_Syntax.as_arg _154_646))
in (_154_647)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_648 None dr))) dbs cond)))))
end
| _59_1219 -> begin
...
let cond = (FStar_List.fold_left (fun acc d -> (let _154_651 = (haseq_data d)
in (FStar_Syntax_Util.mk_conj acc _154_651))) FStar_Syntax_Util.t_true t_datas)
in (

let axiom_lid = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns (((FStar_Ident.id_of_text (Prims.strcat lid.FStar_Ident.ident.FStar_Ident.idText "_haseq")))::[])))
in (let _154_653 = (FStar_Syntax_Util.mk_conj guard' guard)
in (let _154_652 = (FStar_Syntax_Util.mk_conj cond' cond)
in (((FStar_List.append l_axioms ((((axiom_lid), (fml)))::[]))), (env), (_154_653), (_154_652))))))))))
end)))))))))))))))
end))))
end)))
in (
...
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_59_1226, us, _59_1229, _59_1231, _59_1233, _59_1235, _59_1237, _59_1239) -> begin
us
end
| _59_1243 -> begin
(FStar_All.failwith "Impossible!")
...
let _59_1247 = (FStar_Syntax_Subst.univ_var_opening us)
...
let _59_1249 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push "haseq")
in (

let _59_1251 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env sig_bndle)
in (

let env = (FStar_TypeChecker_Env.push_univ_vars env us)
in (

let _59_1258 = (FStar_List.fold_left (haseq_ty usubst us) (([]), (env), (FStar_Syntax_Util.t_true), (FStar_Syntax_Util.t_true)) tcs)
in (match (_59_1258) with
...
let _59_1263 = (FStar_TypeChecker_TcTerm.tc_trivial_guard env phi)
in (match (_59_1263) with
| (phi, _59_1262) -> begin
(

let _59_1264 = if (FStar_TypeChecker_Env.should_verify env) then begin
(let _154_654 = (FStar_TypeChecker_Rel.guard_of_guard_formula (FStar_TypeChecker_Common.NonTrivial (phi)))
in (FStar_TypeChecker_Rel.force_trivial_guard env _154_654))
end else begin
()
end
in (

let ses = (FStar_List.fold_left (fun l _59_1269 -> (match (_59_1269) with
| (lid, fml) -> begin
(
...
let _59_1272 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop "haseq")
in ses)))
end)))
end))))))
end)))))
...
let unoptimized_haseq_scheme = (fun _59_1275 -> (

let mutuals = (FStar_List.map (fun ty -> (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _59_1280, _59_1282, _59_1284, _59_1286, _59_1288, _59_1290, _59_1292) -> begin
lid
end
| _59_1296 -> begin
(FStar_All.failwith "Impossible!")
...
let _59_1323 = (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _59_1305, bs, t, _59_1309, d_lids, _59_1312, _59_1314) -> begin
((lid), (bs), (t), (d_lids))
end
| _59_1318 -> begin
(FStar_All.failwith "Impossible!")
end)
in (match (_59_1323) with
| (lid, bs, t, d_lids) -> begin
(
...
let t = (let _154_668 = (FStar_Syntax_Subst.shift_subst (FStar_List.length bs) usubst)
in (FStar_Syntax_Subst.subst _154_668 t))
in (

let _59_1328 = (FStar_Syntax_Subst.open_term bs t)
in (match (_59_1328) with
| (bs, t) -> begin
(

let ibs = (match ((let _154_669 = (FStar_Syntax_Subst.compress t)
in _154_669.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (ibs, _59_1331) -> begin
ibs
end
| _59_1335 -> begin
[]
...
let ind = (let _154_672 = (FStar_Syntax_Syntax.fvar lid FStar_Syntax_Syntax.Delta_constant None)
in (let _154_671 = (FStar_List.map (fun u -> FStar_Syntax_Syntax.U_name (u)) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst _154_672 _154_671)))
in (

let ind = (let _154_675 = (FStar_List.map (fun _59_1342 -> (match (_59_1342) with
| (bv, aq) -> begin
(let _154_674 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((_154_674), (aq)))
end)) bs)
in (FStar_Syntax_Syntax.mk_Tm_app ind _154_675 None dr))
in (

let ind = (let _154_678 = (FStar_List.map (fun _59_1346 -> (match (_59_1346) with
| (bv, aq) -> begin
(let _154_677 = (FStar_Syntax_Syntax.bv_to_name bv)
in ((_154_677), (aq)))
end)) ibs)
in (FStar_Syntax_Syntax.mk_Tm_app ind _154_678 None dr))
in (

let haseq_ind = (let _154_680 = (let _154_679 = (FStar_Syntax_Syntax.as_arg ind)
in (_154_679)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.t_haseq _154_680 None dr))
in (

let rec is_mutual = (fun t -> (match ((let _154_684 = (FStar_Syntax_Subst.compress t)
in _154_684.FStar_Syntax_Syntax.n)) with
...
| FStar_Syntax_Syntax.Tm_uinst (t', _59_1357) -> begin
(is_mutual t')
end
...
(let _154_686 = (FStar_List.map Prims.fst args)
in (exists_mutual _154_686))
end
end
| FStar_Syntax_Syntax.Tm_meta (t', _59_1370) -> begin
(is_mutual t')
end
| _59_1374 -> begin
false
...
let dt = (FStar_Syntax_Subst.subst usubst dt)
in (match ((let _154_692 = (FStar_Syntax_Subst.compress dt)
in _154_692.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (dbs, _59_1387) -> begin
(

let dbs = (let _154_693 = (FStar_List.splitAt (FStar_List.length bs) dbs)
in (Prims.snd _154_693))
in (

let dbs = (let _154_694 = (FStar_Syntax_Subst.opening_of_binders bs)
in (FStar_Syntax_Subst.subst_binders _154_694 dbs))
in (
...
let haseq_sort = (let _154_698 = (let _154_697 = (FStar_Syntax_Syntax.as_arg (Prims.fst b).FStar_Syntax_Syntax.sort)
in (_154_697)::[])
...
let cond = (FStar_List.fold_right (fun b t -> (let _154_704 = (let _154_703 = (let _154_702 = (let _154_701 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) _154_701 None))
in (FStar_Syntax_Syntax.as_arg _154_702))
in (_154_703)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_704 None dr))) dbs cond)
...
let t_datas = (FStar_List.filter (fun s -> (match (s) with
| FStar_Syntax_Syntax.Sig_datacon (_59_1406, _59_1408, _59_1410, t_lid, _59_1413, _59_1415, _59_1417, _59_1419) -> begin
(t_lid = lid)
end
| _59_1423 -> begin
(FStar_All.failwith "Impossible")
...
let _59_1427 = fml
in (let _154_711 = (let _154_710 = (let _154_709 = (let _154_708 = (let _154_707 = (let _154_706 = (FStar_Syntax_Syntax.as_arg haseq_ind)
in (_154_706)::[])
in (_154_707)::[])
in FStar_Syntax_Syntax.Meta_pattern (_154_708))
in ((fml), (_154_709)))
in FStar_Syntax_Syntax.Tm_meta (_154_710))
in {FStar_Syntax_Syntax.n = _154_711; FStar_Syntax_Syntax.tk = _59_1427.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _59_1427.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _59_1427.FStar_Syntax_Syntax.vars}))
in (

let fml = (FStar_List.fold_right (fun b t -> (let _154_717 = (let _154_716 = (let _154_715 = (let _154_714 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) _154_714 None))
in (FStar_Syntax_Syntax.as_arg _154_715))
in (_154_716)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_717 None dr))) ibs fml)
in (

let fml = (FStar_List.fold_right (fun b t -> (let _154_723 = (let _154_722 = (let _154_721 = (let _154_720 = (FStar_Syntax_Subst.close ((b)::[]) t)
in (FStar_Syntax_Util.abs (((((Prims.fst b)), (None)))::[]) _154_720 None))
in (FStar_Syntax_Syntax.as_arg _154_721))
in (_154_722)::[])
in (FStar_Syntax_Syntax.mk_Tm_app FStar_Syntax_Util.tforall _154_723 None dr))) bs fml)
...
let ty = (FStar_List.hd tcs)
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, us, _59_1440, _59_1442, _59_1444, _59_1446, _59_1448, _59_1450) -> begin
((lid), (us))
end
| _59_1454 -> begin
(FStar_All.failwith "Impossible!")
...
let _59_1460 = (FStar_Syntax_Subst.univ_var_opening us)
...
let _59_1463 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push "haseq")
in (

let _59_1465 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env sig_bndle)
in (

let env = (FStar_TypeChecker_Env.push_univ_vars env us)
in (

let se = (let _154_724 = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns (((FStar_Ident.id_of_text (Prims.strcat lid.FStar_Ident.ident.FStar_Ident.idText "_haseq")))::[])))
in (tc_assume env _154_724 fml [] dr))
in (

let _59_1469 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop "haseq")
in (se)::[])))))))
end))
end)))))
in (

let skip_prims_type = (fun _59_1472 -> (

let lid = (

let ty = (FStar_List.hd tcs)
in (match (ty) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, _59_1477, _59_1479, _59_1481, _59_1483, _59_1485, _59_1487, _59_1489) -> begin
lid
end
| _59_1493 -> begin
(FStar_All.failwith "Impossible")
...
in (let _154_732 = (let _154_731 = (let _154_730 = (FStar_TypeChecker_Env.get_range env0)
in (((FStar_List.append tcs datas)), (quals), (lids), (_154_730)))
in FStar_Syntax_Syntax.Sig_bundle (_154_731))
in (_154_732)::ses)))
end)))))))
end))
end))
...
let _59_1505 = (FStar_TypeChecker_Util.check_sigelt_quals se)
in (match (se) with
...
in (let _154_735 = (FStar_TypeChecker_Env.push_sigelt env se)
in (((se)::[]), (_154_735)))))
end
...
let _59_1545 = (set_options FStar_Options.Set o)
in (((se)::[]), (env)))
end
| FStar_Syntax_Syntax.ResetOptions (sopt) -> begin
(

let _59_1549 = (let _154_742 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _154_742 Prims.ignore))
in (

let _59_1554 = (match (sopt) with
| None -> begin
()
end
| Some (s) -> begin
...
let _59_1556 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (((se)::[]), (env)))))
end))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (_59_1559) -> begin
(FStar_All.failwith "impossible")
end
...
let _59_1575 = (FStar_All.pipe_right ne.FStar_Syntax_Syntax.actions (FStar_List.fold_left (fun _59_1570 a -> (match (_59_1570) with
| (env, ses) -> begin
(

let se_let = (FStar_Syntax_Util.action_as_lb a)
in (let _154_745 = (FStar_TypeChecker_Env.push_sigelt env se_let)
in ((_154_745), ((se_let)::ses))))
end)) ((env), ((se)::[]))))
in (match (_59_1575) with
| (env, ses) -> begin
(((se)::[]), (env))
end)))))
end
...
let _59_1584 = (let _154_746 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _154_746))
in (match (_59_1584) with
| (a, wp_a_src) -> begin
(

let _59_1587 = (let _154_747 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
in (monad_signature env sub.FStar_Syntax_Syntax.target _154_747))
in (match (_59_1587) with
| (b, wp_b_tgt) -> begin
(

let wp_a_tgt = (let _154_751 = (let _154_750 = (let _154_749 = (let _154_748 = (FStar_Syntax_Syntax.bv_to_name a)
in ((b), (_154_748)))
in FStar_Syntax_Syntax.NT (_154_749))
in (_154_750)::[])
in (FStar_Syntax_Subst.subst _154_751 wp_b_tgt))
in (

let expected_k = (let _154_756 = (let _154_754 = (FStar_Syntax_Syntax.mk_binder a)
in (let _154_753 = (let _154_752 = (FStar_Syntax_Syntax.null_binder wp_a_src)
in (_154_752)::[])
in (_154_754)::_154_753))
in (let _154_755 = (FStar_Syntax_Syntax.mk_Total wp_a_tgt)
in (FStar_Syntax_Util.arrow _154_756 _154_755)))
in (

let repr_type = (fun eff_name a wp -> (

let no_reify = (fun l -> (let _154_768 = (let _154_767 = (let _154_766 = (FStar_Util.format1 "Effect %s cannot be reified" l.FStar_Ident.str)
in (let _154_765 = (FStar_TypeChecker_Env.get_range env)
in ((_154_766), (_154_765))))
in FStar_Syntax_Syntax.Error (_154_767))
in (Prims.raise _154_768)))
...
(let _154_775 = (let _154_773 = (let _154_772 = (let _154_771 = (FStar_Syntax_Syntax.as_arg a)
in (let _154_770 = (let _154_769 = (FStar_Syntax_Syntax.as_arg wp)
in (_154_769)::[])
in (_154_771)::_154_770))
in ((repr), (_154_772)))
in FStar_Syntax_Syntax.Tm_app (_154_773))
in (let _154_774 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk _154_775 None _154_774)))
end)
end)))
in (

let _59_1628 = (match (((sub.FStar_Syntax_Syntax.lift), (sub.FStar_Syntax_Syntax.lift_wp))) with
| (None, None) -> begin
(FStar_All.failwith "Impossible")
end
| (lift, Some (_59_1605, lift_wp)) -> begin
(let _154_776 = (check_and_gen env lift_wp expected_k)
in ((lift), (_154_776)))
end
...
let _59_1621 = (FStar_TypeChecker_DMFF.star_expr dmff_env lift)
in (match (_59_1621) with
| (_59_1618, lift_wp, lift_elab) -> begin
(

let _59_1622 = (recheck_debug "lift-wp" env lift_wp)
in (

let _59_1624 = (recheck_debug "lift-elab" env lift_elab)
...
let _59_1630 = env
in {FStar_TypeChecker_Env.solver = _59_1630.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_1630.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_1630.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_1630.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_1630.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_1630.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_1630.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_1630.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_1630.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_1630.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_1630.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_1630.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_1630.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _59_1630.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _59_1630.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_1630.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_1630.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_1630.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = _59_1630.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_1630.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_1630.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_1630.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_1630.FStar_TypeChecker_Env.qname_and_index})
in (
...
| Some (_59_1635, lift) -> begin
(

let _59_1641 = (let _154_777 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _154_777))
...
let lift_wp_a = (let _154_784 = (let _154_782 = (let _154_781 = (let _154_780 = (FStar_Syntax_Syntax.as_arg a_typ)
in (let _154_779 = (let _154_778 = (FStar_Syntax_Syntax.as_arg wp_a_typ)
in (_154_778)::[])
in (_154_780)::_154_779))
in ((lift_wp), (_154_781)))
in FStar_Syntax_Syntax.Tm_app (_154_782))
in (let _154_783 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk _154_784 None _154_783)))
in (repr_type sub.FStar_Syntax_Syntax.target a_typ lift_wp_a)))
in (

let expected_k = (let _154_791 = (let _154_789 = (FStar_Syntax_Syntax.mk_binder a)
in (let _154_788 = (let _154_787 = (FStar_Syntax_Syntax.mk_binder wp_a)
in (let _154_786 = (let _154_785 = (FStar_Syntax_Syntax.null_binder repr_f)
in (_154_785)::[])
in (_154_787)::_154_786))
in (_154_789)::_154_788))
in (let _154_790 = (FStar_Syntax_Syntax.mk_Total repr_result)
in (FStar_Syntax_Util.arrow _154_791 _154_790)))
in (

let _59_1655 = (FStar_TypeChecker_TcTerm.tc_tot_or_gtot_term env expected_k)
in (match (_59_1655) with
| (expected_k, _59_1652, _59_1654) -> begin
(
...
let _59_1658 = env
in {FStar_TypeChecker_Env.solver = _59_1658.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_1658.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_1658.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_1658.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_1658.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_1658.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_1658.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_1658.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_1658.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_1658.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_1658.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_1658.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_1658.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _59_1658.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _59_1658.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_1658.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_1658.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_1658.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax; FStar_TypeChecker_Env.lax_universes = _59_1658.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_1658.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_1658.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_1658.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_1658.FStar_TypeChecker_Env.qname_and_index})
in (

let sub = (

let _59_1661 = sub
in {FStar_Syntax_Syntax.source = _59_1661.FStar_Syntax_Syntax.source; FStar_Syntax_Syntax.target = _59_1661.FStar_Syntax_Syntax.target; FStar_Syntax_Syntax.lift_wp = Some (lift_wp); FStar_Syntax_Syntax.lift = lift})
in (
...
let _59_1680 = (FStar_Syntax_Subst.open_comp tps c)
in (match (_59_1680) with
| (tps, c) -> begin
(

let _59_1684 = (tc_tparams env tps)
in (match (_59_1684) with
| (tps, env, us) -> begin
(

let _59_1688 = (FStar_TypeChecker_TcTerm.tc_comp env c)
in (match (_59_1688) with
| (c, u, g) -> begin
(

let _59_1689 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (
...
let _59_1695 = (let _154_792 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _154_792))
in (match (_59_1695) with
| (uvs, t) -> begin
(

let _59_1714 = (match ((let _154_794 = (let _154_793 = (FStar_Syntax_Subst.compress t)
in _154_793.FStar_Syntax_Syntax.n)
in ((tps), (_154_794)))) with
| ([], FStar_Syntax_Syntax.Tm_arrow (_59_1698, c)) -> begin
(([]), (c))
end
| (_59_1704, FStar_Syntax_Syntax.Tm_arrow (tps, c)) -> begin
((tps), (c))
end
| _59_1711 -> begin
(FStar_All.failwith "Impossible")
end)
in (match (_59_1714) with
| (tps, c) -> begin
(

let _59_1719 = if (((FStar_List.length uvs) <> (Prims.parse_int "1")) && (not ((FStar_Ident.lid_equals lid FStar_Syntax_Const.effect_Lemma_lid)))) then begin
(

let _59_1718 = (FStar_Syntax_Subst.open_univ_vars uvs t)
in (match (_59_1718) with
| (_59_1716, t) -> begin
(let _154_800 = (let _154_799 = (let _154_798 = (let _154_797 = (FStar_Syntax_Print.lid_to_string lid)
in (let _154_796 = (FStar_All.pipe_right (FStar_List.length uvs) FStar_Util.string_of_int)
in (let _154_795 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format3 "Effect abbreviations must be polymorphic in exactly 1 universe; %s has %s universes (%s)" _154_797 _154_796 _154_795))))
in ((_154_798), (r)))
...
let _59_1735 = (let _154_802 = (let _154_801 = (FStar_Syntax_Util.type_u ())
in (Prims.fst _154_801))
in (check_and_gen env t _154_802))
...
let _59_1755 = (FStar_TypeChecker_TcTerm.tc_term env e)
in (match (_59_1755) with
| (e, c, g1) -> begin
(

let _59_1760 = (let _154_806 = (let _154_803 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_154_803))
in (let _154_805 = (let _154_804 = (c.FStar_Syntax_Syntax.comp ())
in ((e), (_154_804)))
in (FStar_TypeChecker_TcTerm.check_expected_effect env _154_806 _154_805)))
in (match (_59_1760) with
| (e, _59_1758, g) -> begin
(

let _59_1761 = (let _154_807 = (FStar_TypeChecker_Rel.conj_guard g1 g)
in (FStar_TypeChecker_Rel.force_trivial_guard env _154_807))
in (
...
(let _154_819 = (let _154_818 = (let _154_817 = (let _154_816 = (FStar_Syntax_Print.lid_to_string l)
in (let _154_815 = (FStar_Syntax_Print.quals_to_string q)
in (let _154_814 = (FStar_Syntax_Print.quals_to_string q')
in (FStar_Util.format3 "Inconsistent qualifier annotations on %s; Expected {%s}, got {%s}" _154_816 _154_815 _154_814))))
in ((_154_817), (r)))
in FStar_Syntax_Syntax.Error (_154_818))
in (Prims.raise _154_819))
end
end))
in (

let _59_1805 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.fold_left (fun _59_1782 lb -> (match (_59_1782) with
...
let _59_1801 = (match ((FStar_TypeChecker_Env.try_lookup_val_decl env lbname.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)) with
| None -> begin
((gen), (lb), (quals_opt))
end
...
let _59_1796 = (match (lb.FStar_Syntax_Syntax.lbtyp.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
()
end
| _59_1795 -> begin
...
in (let _154_822 = (FStar_Syntax_Syntax.mk_lb ((FStar_Util.Inr (lbname)), (uvs), (FStar_Syntax_Const.effect_ALL_lid), (tval), (lb.FStar_Syntax_Syntax.lbdef)))
in ((false), (_154_822), (quals_opt)))))
end)
...
let e = (let _154_826 = (let _154_825 = (let _154_824 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)) None r)
in (((((Prims.fst lbs)), (lbs'))), (_154_824)))
in FStar_Syntax_Syntax.Tm_let (_154_825))
in (FStar_Syntax_Syntax.mk _154_826 None r))
in (

let _59_1848 = (match ((FStar_TypeChecker_TcTerm.tc_maybe_toplevel_term (

let _59_1818 = env
in {FStar_TypeChecker_Env.solver = _59_1818.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_1818.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_1818.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_1818.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_1818.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_1818.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_1818.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_1818.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_1818.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_1818.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_1818.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = should_generalize; FStar_TypeChecker_Env.letrecs = _59_1818.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _59_1818.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_1818.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_1818.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_1818.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _59_1818.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_1818.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_1818.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_1818.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_1818.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_1818.FStar_TypeChecker_Env.qname_and_index}) e)) with
| ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let (lbs, e); FStar_Syntax_Syntax.tk = _59_1825; FStar_Syntax_Syntax.pos = _59_1823; FStar_Syntax_Syntax.vars = _59_1821}, _59_1832, g) when (FStar_TypeChecker_Rel.is_trivial g) -> begin
(

let quals = (match (e.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_meta (_59_1836, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect)) -> begin
...
let _59_1854 = if (log env) then begin
(let _154_834 = (let _154_833 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (

let should_log = (match ((let _154_830 = (let _154_829 = (let _154_828 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _154_828.FStar_Syntax_Syntax.fv_name)
in _154_829.FStar_Syntax_Syntax.v)
in (FStar_TypeChecker_Env.try_lookup_val_decl env _154_830))) with
| None -> begin
true
end
| _59_1852 -> begin
...
(let _154_832 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
in (let _154_831 = (FStar_Syntax_Print.term_to_string lb.FStar_Syntax_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" _154_832 _154_831)))
end else begin
""
end))))
in (FStar_All.pipe_right _154_833 (FStar_String.concat "\n")))
...
in (match (se) with
| FStar_Syntax_Syntax.Sig_pragma (_59_1876) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_inductive_typ (_)) | (FStar_Syntax_Syntax.Sig_datacon (_)) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _59_1887, r) -> begin
if (is_abstract quals) then begin
(FStar_List.fold_right (fun se _59_1894 -> (match (_59_1894) with
| (out, hidden) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, us, bs, t, _59_1900, _59_1902, quals, r) -> begin
(

let dec = (let _154_848 = (let _154_847 = (let _154_846 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow bs _154_846))
in ((l), (us), (_154_847), ((FStar_Syntax_Syntax.Assumption)::(FStar_Syntax_Syntax.New)::quals), (r)))
in FStar_Syntax_Syntax.Sig_declare_typ (_154_848))
in (((dec)::out), (hidden)))
end
| FStar_Syntax_Syntax.Sig_datacon (l, us, t, _59_1912, _59_1914, _59_1916, _59_1918, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_assume (_59_1926, _59_1928, quals, _59_1931) -> begin
if (is_abstract quals) then begin
(([]), (hidden))
end else begin
(((se)::[]), (hidden))
...
| FStar_Syntax_Syntax.Sig_main (_59_1952) -> begin
(([]), (hidden))
end
| (FStar_Syntax_Syntax.Sig_new_effect (_)) | (FStar_Syntax_Syntax.Sig_new_effect_for_free (_)) | (FStar_Syntax_Syntax.Sig_sub_effect (_)) | (FStar_Syntax_Syntax.Sig_effect_abbrev (_)) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), _59_1971, _59_1973, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some is_hidden_proj_or_disc)) -> begin
(
...
if (is_abstract quals) then begin
(let _154_855 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let _154_854 = (let _154_853 = (let _154_852 = (let _154_851 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _154_851.FStar_Syntax_Syntax.fv_name)
in _154_852.FStar_Syntax_Syntax.v)
in ((_154_853), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp), ((FStar_Syntax_Syntax.Assumption)::quals), (r)))
in FStar_Syntax_Syntax.Sig_declare_typ (_154_854)))))
in ((_154_855), (hidden)))
end else begin
(((se)::[]), (hidden))
end
...
let process_one_decl = (fun _59_1994 se -> (match (_59_1994) with
| (ses, exports, env, hidden) -> begin
(

let _59_1996 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _154_864 = (FStar_Syntax_Print.sigelt_to_string se)
...
let _59_2000 = (tc_decl env se)
in (match (_59_2000) with
| (ses', env) -> begin
(

let _59_2003 = if ((FStar_Options.log_types ()) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("LogTypes")))) then begin
(let _154_869 = (FStar_List.fold_left (fun s se -> (let _154_868 = (let _154_867 = (FStar_Syntax_Print.sigelt_to_string se)
in (Prims.strcat _154_867 "\n"))
in (Prims.strcat s _154_868))) "" ses')
...
let _59_2006 = (FStar_List.iter (fun se -> (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env se)) ses')
in (

let _59_2015 = (FStar_List.fold_left (fun _59_2010 se -> (match (_59_2010) with
| (le, lh) -> begin
(
...
let _59_2045 = (FStar_List.fold_left (fun acc se -> (match (se) with
| FStar_Syntax_Syntax.Sig_new_effect_for_free (ne, r) -> begin
(

let _59_2029 = acc
in (match (_59_2029) with
| (_59_2023, _59_2025, env, _59_2028) -> begin
(

let _59_2033 = (cps_and_elaborate env ne)
in (match (_59_2033) with
...
| (ses, exports, env, _59_2044) -> begin
(let _154_875 = (FStar_All.pipe_right (FStar_List.rev_append exports []) FStar_List.flatten)
in (((FStar_List.rev_append ses [])), (_154_875), (env)))
end))))
...
let _59_2050 = env
in (let _154_880 = (not ((FStar_Options.should_verify modul.FStar_Syntax_Syntax.name.FStar_Ident.str)))
in {FStar_TypeChecker_Env.solver = _59_2050.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2050.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2050.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2050.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2050.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2050.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2050.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2050.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2050.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2050.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2050.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2050.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2050.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _59_2050.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _59_2050.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2050.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = modul.FStar_Syntax_Syntax.is_interface; FStar_TypeChecker_Env.admit = _154_880; FStar_TypeChecker_Env.lax = _59_2050.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = _59_2050.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _59_2050.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2050.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2050.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2050.FStar_TypeChecker_Env.qname_and_index}))
in (

let _59_2053 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.push msg)
in (

let env = (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name)
in (

let _59_2059 = (tc_decls env modul.FStar_Syntax_Syntax.declarations)
in (match (_59_2059) with
| (ses, exports, env) -> begin
(((

let _59_2060 = modul
in {FStar_Syntax_Syntax.name = _59_2060.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = ses; FStar_Syntax_Syntax.exports = _59_2060.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _59_2060.FStar_Syntax_Syntax.is_interface})), (exports), (env))
end))))))))


let tc_more_partial_modul : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_Syntax_Syntax.modul * FStar_Syntax_Syntax.sigelt Prims.list * FStar_TypeChecker_Env.env) = (fun env modul decls -> (

let _59_2068 = (tc_decls env decls)
...
let _59_2069 = modul
in {FStar_Syntax_Syntax.name = _59_2069.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = (FStar_List.append modul.FStar_Syntax_Syntax.declarations ses); FStar_Syntax_Syntax.exports = _59_2069.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _59_2069.FStar_Syntax_Syntax.is_interface})
...
let _59_2075 = env
in {FStar_TypeChecker_Env.solver = _59_2075.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _59_2075.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _59_2075.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _59_2075.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _59_2075.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _59_2075.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _59_2075.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _59_2075.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _59_2075.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _59_2075.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _59_2075.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _59_2075.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _59_2075.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _59_2075.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _59_2075.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _59_2075.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _59_2075.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = true; FStar_TypeChecker_Env.type_of = _59_2075.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _59_2075.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _59_2075.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = _59_2075.FStar_TypeChecker_Env.qname_and_index})
in (

let check_term = (fun lid univs t -> (

let _59_2084 = (FStar_Syntax_Subst.open_univ_vars univs t)
in (match (_59_2084) with
| (univs, t) -> begin
(

let _59_2086 = if (let _154_900 = (let _154_899 = (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name)
in (FStar_TypeChecker_Env.debug _154_899))
in (FStar_All.pipe_left _154_900 (FStar_Options.Other ("Exports")))) then begin
(let _154_905 = (FStar_Syntax_Print.lid_to_string lid)
in (let _154_904 = (let _154_902 = (FStar_All.pipe_right univs (FStar_List.map (fun x -> (FStar_Syntax_Print.univ_to_string (FStar_Syntax_Syntax.U_name (x))))))
in (FStar_All.pipe_right _154_902 (FStar_String.concat ", ")))
in (let _154_903 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print3 "Checking for export %s <%s> : %s\n" _154_905 _154_904 _154_903))))
end else begin
()
end
in (
...
in (let _154_906 = (FStar_TypeChecker_TcTerm.tc_trivial_guard env t)
in (FStar_All.pipe_right _154_906 Prims.ignore))))
end)))
in (

let check_term = (fun lid univs t -> (

let _59_2093 = (let _154_915 = (let _154_914 = (FStar_Syntax_Print.lid_to_string modul.FStar_Syntax_Syntax.name)
in (let _154_913 = (FStar_Syntax_Print.lid_to_string lid)
in (FStar_Util.format2 "Interface of %s violates its abstraction (add a \'private\' qualifier to \'%s\'?)" _154_914 _154_913)))
in (FStar_TypeChecker_Errors.message_prefix.FStar_TypeChecker_Errors.set_prefix _154_915))
in (

let _59_2095 = (check_term lid univs t)
...
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _59_2102, _59_2104) -> begin
...
| FStar_Syntax_Syntax.Sig_inductive_typ (l, univs, binders, typ, _59_2112, _59_2114, _59_2116, r) -> begin
(

let t = (let _154_920 = (let _154_919 = (let _154_918 = (FStar_Syntax_Syntax.mk_Total typ)
in ((binders), (_154_918)))
in FStar_Syntax_Syntax.Tm_arrow (_154_919))
in (FStar_Syntax_Syntax.mk _154_920 None r))
in (check_term l univs t))
end
| FStar_Syntax_Syntax.Sig_datacon (l, univs, t, _59_2125, _59_2127, _59_2129, _59_2131, _59_2133) -> begin
(check_term l univs t)
end
| FStar_Syntax_Syntax.Sig_declare_typ (l, univs, t, quals, _59_2141) -> begin
if (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private)))) then begin
(check_term l univs t)
end else begin
()
...
| FStar_Syntax_Syntax.Sig_let ((_59_2145, lbs), _59_2149, _59_2151, quals) -> begin
if (not ((FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Private)))) then begin
...
let _59_2187 = modul
in {FStar_Syntax_Syntax.name = _59_2187.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = _59_2187.FStar_Syntax_Syntax.declarations; FStar_Syntax_Syntax.exports = exports; FStar_Syntax_Syntax.is_interface = modul.FStar_Syntax_Syntax.is_interface})
in (

let env = (FStar_TypeChecker_Env.finish_module env modul)
in (

let _59_2191 = (check_exports env modul exports)
in (

let _59_2193 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop (Prims.strcat "Ending modul " modul.FStar_Syntax_Syntax.name.FStar_Ident.str))
in (

let _59_2195 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_modul env modul)
in (

let _59_2197 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (

let _59_2199 = (let _154_928 = (FStar_Options.restore_cmd_line_options true)
in (FStar_All.pipe_right _154_928 Prims.ignore))
in ((modul), (env))))))))))


let tc_modul : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  (FStar_Syntax_Syntax.modul * FStar_TypeChecker_Env.env) = (fun env modul -> (

let _59_2206 = (tc_partial_modul env modul)
in (match (_59_2206) with
...
let _59_2209 = if (FStar_Options.debug_any ()) then begin
(let _154_937 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
...
let _59_2213 = (tc_modul env m)
in (match (_59_2213) with
| (m, env) -> begin
(

let _59_2214 = if (FStar_Options.dump_module m.FStar_Syntax_Syntax.name.FStar_Ident.str) then begin
(let _154_938 = (FStar_Syntax_Print.modul_to_string m)
in (FStar_Util.print1 "%s\n" _154_938))
end else begin
()
end
