...
let uu___103_1669 = act
in {FStar_Syntax_Syntax.action_name = uu___103_1669.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_unqualified_name = uu___103_1669.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = univs2; FStar_Syntax_Syntax.action_params = uu___103_1669.FStar_Syntax_Syntax.action_params; FStar_Syntax_Syntax.action_defn = defn; FStar_Syntax_Syntax.action_typ = typ})
end))
end)))
in (
...
in {FStar_Syntax_Syntax.cattributes = uu___104_1674.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___104_1674.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = univs1; FStar_Syntax_Syntax.binders = effect_params; FStar_Syntax_Syntax.signature = signature1; FStar_Syntax_Syntax.ret_wp = uu____1675; FStar_Syntax_Syntax.bind_wp = uu____1676; FStar_Syntax_Syntax.if_then_else = uu____1677; FStar_Syntax_Syntax.ite_wp = uu____1678; FStar_Syntax_Syntax.stronger = uu____1679; FStar_Syntax_Syntax.close_wp = uu____1680; FStar_Syntax_Syntax.assert_p = uu____1681; FStar_Syntax_Syntax.assume_p = uu____1682; FStar_Syntax_Syntax.null_wp = uu____1683; FStar_Syntax_Syntax.trivial = uu____1684; FStar_Syntax_Syntax.repr = uu____1685; FStar_Syntax_Syntax.return_repr = uu____1697; FStar_Syntax_Syntax.bind_repr = uu____1698; FStar_Syntax_Syntax.actions = uu____1699})))))))))))))))
in ((
...
in {FStar_Syntax_Syntax.ppname = uu___105_1809.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___105_1809.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1810}))
in ((uu____1808), (qual)))
end)) effect_binders)
in (
...
let uu____2802 = (FStar_ST.op_Bang sigelts)
in (sigelt)::uu____2802)
in (FStar_ST.op_Colon_Equals sigelts uu____2799));
fv;
)
end))
end))))))
...
let uu____2875 = (FStar_Syntax_Syntax.mk_sigelt (FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.SetOptions ("--admit_smt_queries true"))))
in (

let uu____2876 = (FStar_ST.op_Bang sigelts)
in (uu____2875)::uu____2876))
in (FStar_ST.op_Colon_Equals sigelts uu____2872));
(
...
let uu____2948 = (FStar_Syntax_Syntax.mk_sigelt (FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.SetOptions ("--admit_smt_queries false"))))
in (

let uu____2949 = (FStar_ST.op_Bang sigelts)
in (uu____2948)::uu____2949))
in (FStar_ST.op_Colon_Equals sigelts uu____2945));
(
...
let uu____3021 = (FStar_Syntax_Syntax.mk_sigelt (FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.SetOptions ("--admit_smt_queries true"))))
in (

let uu____3022 = (FStar_ST.op_Bang sigelts)
in (uu____3021)::uu____3022))
in (FStar_ST.op_Colon_Equals sigelts uu____3018));
(
...
let uu____3094 = (FStar_Syntax_Syntax.mk_sigelt (FStar_Syntax_Syntax.Sig_pragma (FStar_Syntax_Syntax.SetOptions ("--admit_smt_queries false"))))
in (

let uu____3095 = (FStar_ST.op_Bang sigelts)
in (uu____3094)::uu____3095))
in (FStar_ST.op_Colon_Equals sigelts uu____3091));
(

let uu____3162 = (FStar_List.fold_left (fun uu____3202 action -> (match (uu____3202) with
...
let uu____3230 = (FStar_TypeChecker_DMFF.get_env dmff_env3)
in (FStar_TypeChecker_TcTerm.tc_tparams uu____3230 params_un))
in (match (uu____3223) with
| (action_params, env', uu____3239) -> begin
(

let action_params1 = (FStar_List.map (fun uu____3259 -> (match (uu____3259) with
| (bv, qual) -> begin
(

let uu____3270 = (

let uu___106_3271 = bv
in (

let uu____3272 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.EraseUniverses)::[]) env' bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___106_3271.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___106_3271.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____3272}))
in ((uu____3270), (qual)))
end)) action_params)
in (
...
let uu____3276 = (elaborate_and_star dmff_env' action_params1 ((action.FStar_Syntax_Syntax.action_univs), (action.FStar_Syntax_Syntax.action_defn)))
...
let uu____3307 = (FStar_Syntax_Syntax.mk_Total action_typ_with_wp1)
in (FStar_Syntax_Util.flat_arrow action_params2 uu____3307))
end)
in ((

let uu____3311 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env1) (FStar_Options.Other ("ED")))
in (match (uu____3311) with
| true -> begin
(

let uu____3312 = (FStar_Syntax_Print.binders_to_string "," params_un)
in (

let uu____3313 = (FStar_Syntax_Print.binders_to_string "," action_params2)
in (

let uu____3314 = (FStar_Syntax_Print.term_to_string action_typ_with_wp2)
in (

let uu____3315 = (FStar_Syntax_Print.term_to_string action_elab2)
in (FStar_Util.print4 "original action_params %s, end action_params %s, type %s, term %s\n" uu____3312 uu____3313 uu____3314 uu____3315)))))
end
| uu____3316 -> begin
()
end));
...
let uu___107_3323 = action
in (

let uu____3324 = (apply_close action_elab3)
in (

let uu____3325 = (apply_close action_typ_with_wp3)
in {FStar_Syntax_Syntax.action_name = uu___107_3323.FStar_Syntax_Syntax.action_name; FStar_Syntax_Syntax.action_unqualified_name = uu___107_3323.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = uu___107_3323.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_params = []; FStar_Syntax_Syntax.action_defn = uu____3324; FStar_Syntax_Syntax.action_typ = uu____3325})))
in (uu____3322)::actions)
in ((dmff_env4), (uu____3319)))));
))))))))
end))))
end)))
...
let uu____3358 = (FStar_Syntax_Syntax.mk_binder a1)
in (

let uu____3359 = (

let uu____3362 = (FStar_Syntax_Syntax.mk_binder wp)
in (uu____3362)::[])
...
let uu____3393 = (FStar_Syntax_Syntax.bv_to_name a1)
in (

let uu____3394 = (FStar_Syntax_Syntax.as_implicit false)
in ((uu____3393), (uu____3394))))
in (uu____3388)::[])
in ((repr), (uu____3381)))
in FStar_Syntax_Syntax.Tm_app (uu____3366))
in (mk1 uu____3365))
in (

let uu____3409 = (FStar_Syntax_Syntax.bv_to_name wp)
in (FStar_TypeChecker_DMFF.trans_F dmff_env3 uu____3364 uu____3409)))
in (FStar_Syntax_Util.abs binders uu____3363 FStar_Pervasives_Native.None))))
in (
...
let uu____3423 = (FStar_Syntax_Subst.compress wp_type1)
in (FStar_All.pipe_left FStar_Syntax_Util.unascribe uu____3423))
in uu____3420.FStar_Syntax_Syntax.n)
in (match (uu____3419) with
| FStar_Syntax_Syntax.Tm_abs ((type_param)::effect_param, arrow1, uu____3433) -> begin
(

let uu____3462 = (

let uu____3479 = (FStar_Syntax_Subst.open_term ((type_param)::effect_param) arrow1)
...
let uu____3591 = (FStar_Syntax_Subst.compress arrow2)
in (FStar_All.pipe_left FStar_Syntax_Util.unascribe uu____3591))
in uu____3588.FStar_Syntax_Syntax.n)
in (match (uu____3587) with
| FStar_Syntax_Syntax.Tm_arrow (wp_binders, c) -> begin
(

let uu____3616 = (FStar_Syntax_Subst.open_comp wp_binders c)
in (match (uu____3616) with
| (wp_binders1, c1) -> begin
(

let uu____3629 = (FStar_List.partition (fun uu____3654 -> (match (uu____3654) with
| (bv, uu____3660) -> begin
(

let uu____3661 = (

let uu____3662 = (FStar_Syntax_Free.names bv.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right uu____3662 (FStar_Util.set_mem (FStar_Pervasives_Native.fst type_param1))))
in (FStar_All.pipe_right uu____3661 Prims.op_Negation))
end)) wp_binders1)
...
let uu____3729 = (FStar_Syntax_Print.term_to_string arrow2)
in (FStar_Util.format1 "Impossible: multiple post candidates %s" uu____3729))
in (failwith uu____3728))
end)
in (

let uu____3734 = (FStar_Syntax_Util.arrow pre_args c1)
in (

let uu____3737 = (FStar_Syntax_Util.abs ((type_param1)::effect_param1) (FStar_Pervasives_Native.fst post).FStar_Syntax_Syntax.sort FStar_Pervasives_Native.None)
in ((uu____3734), (uu____3737)))))
end))
end))
end
| uu____3744 -> begin
...
let uu____3746 = (FStar_Syntax_Print.term_to_string arrow2)
in (FStar_Util.format1 "Impossible: pre/post arrow %s" uu____3746))
in (failwith uu____3745))
end))
end))
end
| uu____3753 -> begin
...
let uu____3755 = (FStar_Syntax_Print.term_to_string wp_type1)
in (FStar_Util.format1 "Impossible: pre/post abs %s" uu____3755))
in (failwith uu____3754))
end))
in (match (uu____3412) with
| (pre, post) -> begin
((

let uu____3779 = (register "pre" pre)
in ());
(

let uu____3781 = (register "post" post)
in ());
(

let uu____3783 = (register "wp" wp_type1)
in ());
(

let ed1 = (

let uu___108_3785 = ed
in (

let uu____3786 = (FStar_Syntax_Subst.close_binders effect_binders1)
in (

let uu____3787 = (FStar_Syntax_Subst.close effect_binders1 effect_signature1)
in (

let uu____3788 = (

let uu____3789 = (apply_close return_wp2)
in (([]), (uu____3789)))
in (

let uu____3796 = (

let uu____3797 = (apply_close bind_wp2)
in (([]), (uu____3797)))
in (

let uu____3804 = (apply_close repr3)
in (

let uu____3805 = (

let uu____3806 = (apply_close return_elab1)
in (([]), (uu____3806)))
in (

let uu____3813 = (

let uu____3814 = (apply_close bind_elab1)
in (([]), (uu____3814)))
in {FStar_Syntax_Syntax.cattributes = uu___108_3785.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___108_3785.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = uu___108_3785.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = uu____3786; FStar_Syntax_Syntax.signature = uu____3787; FStar_Syntax_Syntax.ret_wp = uu____3788; FStar_Syntax_Syntax.bind_wp = uu____3796; FStar_Syntax_Syntax.if_then_else = uu___108_3785.FStar_Syntax_Syntax.if_then_else; FStar_Syntax_Syntax.ite_wp = uu___108_3785.FStar_Syntax_Syntax.ite_wp; FStar_Syntax_Syntax.stronger = uu___108_3785.FStar_Syntax_Syntax.stronger; FStar_Syntax_Syntax.close_wp = uu___108_3785.FStar_Syntax_Syntax.close_wp; FStar_Syntax_Syntax.assert_p = uu___108_3785.FStar_Syntax_Syntax.assert_p; FStar_Syntax_Syntax.assume_p = uu___108_3785.FStar_Syntax_Syntax.assume_p; FStar_Syntax_Syntax.null_wp = uu___108_3785.FStar_Syntax_Syntax.null_wp; FStar_Syntax_Syntax.trivial = uu___108_3785.FStar_Syntax_Syntax.trivial; FStar_Syntax_Syntax.repr = uu____3804; FStar_Syntax_Syntax.return_repr = uu____3805; FStar_Syntax_Syntax.bind_repr = uu____3813; FStar_Syntax_Syntax.actions = actions1}))))))))
in (

let uu____3821 = (FStar_TypeChecker_DMFF.gen_wps_for_free env1 effect_binders1 a1 wp_a ed1)
in (match (uu____3821) with
| (sigelts', ed2) -> begin
((

let uu____3839 = (FStar_TypeChecker_Env.debug env1 (FStar_Options.Other ("ED")))
in (match (uu____3839) with
| true -> begin
(

let uu____3840 = (FStar_Syntax_Print.eff_decl_to_string true ed2)
in (FStar_Util.print_string uu____3840))
end
| uu____3841 -> begin
()
end));
...
let uu____3864 = (apply_close lift_from_pure_wp1)
in (([]), (uu____3864)))
in FStar_Pervasives_Native.Some (uu____3855))
in {FStar_Syntax_Syntax.source = FStar_Parser_Const.effect_PURE_lid; FStar_Syntax_Syntax.target = ed2.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.lift_wp = uu____3852; FStar_Syntax_Syntax.lift = FStar_Pervasives_Native.None})
in (

let uu____3879 = (FStar_Syntax_Syntax.mk_sigelt (FStar_Syntax_Syntax.Sig_sub_effect (lift_from_pure)))
in FStar_Pervasives_Native.Some (uu____3879)))
end
| uu____3880 -> begin
...
let uu____3887 = (FStar_ST.op_Bang sigelts)
in (FStar_List.rev uu____3887))
in (FStar_List.append uu____3884 sigelts'))
in ((uu____3881), (ed2), (lift_from_pure_opt))));
)
end)));
)
end))))))
...
let tc_lex_t : 'Auu____3936 . FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  'Auu____3936 Prims.list  ->  FStar_Ident.lident Prims.list  ->  FStar_Syntax_Syntax.sigelt = (fun env ses quals lids -> (match (ses) with
| ({FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_inductive_typ (lex_t1, [], [], t, uu____3979, uu____3980); FStar_Syntax_Syntax.sigrng = r; FStar_Syntax_Syntax.sigquals = []; FStar_Syntax_Syntax.sigmeta = uu____3982; FStar_Syntax_Syntax.sigattrs = uu____3983})::({FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (lex_top1, [], _t_top, _lex_t_top, _0_41, uu____3987); FStar_Syntax_Syntax.sigrng = r1; FStar_Syntax_Syntax.sigquals = []; FStar_Syntax_Syntax.sigmeta = uu____3989; FStar_Syntax_Syntax.sigattrs = uu____3990})::({FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_datacon (lex_cons, [], _t_cons, _lex_t_cons, _0_42, uu____3994); FStar_Syntax_Syntax.sigrng = r2; FStar_Syntax_Syntax.sigquals = []; FStar_Syntax_Syntax.sigmeta = uu____3996; FStar_Syntax_Syntax.sigattrs = uu____3997})::[] when (((_0_41 = (Prims.parse_int "0")) && (_0_42 = (Prims.parse_int "0"))) && (((FStar_Ident.lid_equals lex_t1 FStar_Parser_Const.lex_t_lid) && (FStar_Ident.lid_equals lex_top1 FStar_Parser_Const.lextop_lid)) && (FStar_Ident.lid_equals lex_cons FStar_Parser_Const.lexcons_lid))) -> begin
(
...
let uu____4073 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range FStar_Parser_Const.lex_t_lid r1) FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None)
in ((uu____4073), ((FStar_Syntax_Syntax.U_name (utop))::[])))
in FStar_Syntax_Syntax.Tm_uinst (uu____4066))
in (FStar_Syntax_Syntax.mk uu____4065))
in (uu____4062 FStar_Pervasives_Native.None r1))
in (
...
let uu____4091 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_name (ucons1))) FStar_Pervasives_Native.None r2)
in (FStar_Syntax_Syntax.new_bv (FStar_Pervasives_Native.Some (r2)) uu____4091))
in (

let hd1 = (

let uu____4093 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.new_bv (FStar_Pervasives_Native.Some (r2)) uu____4093))
in (
...
let uu____4107 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range FStar_Parser_Const.lex_t_lid r2) FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None)
in ((uu____4107), ((FStar_Syntax_Syntax.U_name (ucons2))::[])))
in FStar_Syntax_Syntax.Tm_uinst (uu____4100))
in (FStar_Syntax_Syntax.mk uu____4099))
in (uu____4096 FStar_Pervasives_Native.None r2))
in (FStar_Syntax_Syntax.new_bv (FStar_Pervasives_Native.Some (r2)) uu____4095))
in (
...
in ((uu____4127), ((FStar_Syntax_Syntax.U_max ((FStar_Syntax_Syntax.U_name (ucons1))::(FStar_Syntax_Syntax.U_name (ucons2))::[]))::[])))
...
let uu____4133 = (FStar_Syntax_Syntax.mk_Total res)
in (FStar_Syntax_Util.arrow ((((a), (FStar_Pervasives_Native.Some (FStar_Syntax_Syntax.imp_tag))))::(((hd1), (FStar_Pervasives_Native.None)))::(((tl1), (FStar_Pervasives_Native.None)))::[]) uu____4133))))))
in (
...
let uu____4172 = (FStar_TypeChecker_Env.get_range env)
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_bundle ((((tc)::(dc_lextop)::(dc_lexcons)::[]), (lids))); FStar_Syntax_Syntax.sigrng = uu____4172; FStar_Syntax_Syntax.sigquals = []; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []}))))))))))))))
end
| uu____4177 -> begin
(
...
let uu____4182 = (FStar_Syntax_Syntax.mk_sigelt (FStar_Syntax_Syntax.Sig_bundle (((ses), (lids)))))
in (FStar_Syntax_Print.sigelt_to_string uu____4182))
in (FStar_Util.format1 "Unexpected lex_t: %s\n" uu____4181))
in (failwith uu____4180))
end))
...
let uu____4212 = (FStar_Syntax_Util.type_u ())
...
let uu____4220 = (tc_check_trivial_guard env1 phi k)
in (FStar_All.pipe_right uu____4220 (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.Eager_unfolding)::[]) env1)))
in ((FStar_TypeChecker_Util.check_uvars r phi1);
(

let uu____4222 = (FStar_TypeChecker_Util.generalize_universes env1 phi1)
...
let uu____4268 = (FStar_TypeChecker_TcInductive.check_inductive_well_typedness env1 ses quals lids)
...
let uu____4301 = (FStar_List.map (FStar_TypeChecker_Util.mk_data_operations quals env1 tcs) datas)
in (FStar_All.pipe_right uu____4301 FStar_List.flatten))
in ((

let uu____4315 = ((FStar_Options.no_positivity ()) || (FStar_Options.lax ()))
...
let uu____4326 = (match (ty.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, uu____4336, uu____4337, uu____4338, uu____4339, uu____4340) -> begin
...
let skip_prims_type = (fun uu____4360 -> (

let lid = (

let ty = (FStar_List.hd tcs)
in (match (ty.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (lid, uu____4364, uu____4365, uu____4366, uu____4367, uu____4368) -> begin
lid
end
| uu____4377 -> begin
(failwith "Impossible")
...
let uu____4395 = ((((FStar_List.length tcs) = (Prims.parse_int "0")) || ((FStar_Ident.lid_equals env1.FStar_TypeChecker_Env.curmodule FStar_Parser_Const.prims_lid) && (skip_prims_type ()))) || is_noeq)
...
let uu____4422 = (FStar_TypeChecker_Env.get_range env1)
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_bundle ((((FStar_List.append tcs datas)), (lids))); FStar_Syntax_Syntax.sigrng = uu____4422; FStar_Syntax_Syntax.sigquals = quals; FStar_Syntax_Syntax.sigmeta = FStar_Syntax_Syntax.default_sigmeta; FStar_Syntax_Syntax.sigattrs = []})
in (uu____4421)::ses1)
in ((uu____4418), (data_ops_ses)))))
end))
in ((

let uu____4432 = (FStar_TypeChecker_Env.pop env1 "tc_inductive")
in ());
res;
))));
))
...
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____4468) -> begin
(failwith "Impossible bare data-constructor")
end
| FStar_Syntax_Syntax.Sig_datacon (uu____4493) -> begin
(failwith "Impossible bare data-constructor")
end
...
let uu____4545 = (tc_inductive env2 ses se.FStar_Syntax_Syntax.sigquals lids)
...
let uu____4584 = (FStar_Options.set_options t s)
...
let uu____4610 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right uu____4610 FStar_Pervasives.ignore));
(match (sopt) with
| FStar_Pervasives_Native.None -> begin
()
end
...
let uu____4618 = (cps_and_elaborate env1 ne)
...
let uu___109_4655 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_new_effect (ne1); FStar_Syntax_Syntax.sigrng = uu___109_4655.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___109_4655.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___109_4655.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___109_4655.FStar_Syntax_Syntax.sigattrs}))::(lift)::[]
end
| FStar_Pervasives_Native.None -> begin
((

let uu___110_4657 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_new_effect (ne1); FStar_Syntax_Syntax.sigrng = uu___110_4657.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___110_4657.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___110_4657.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___110_4657.FStar_Syntax_Syntax.sigattrs}))::[]
end)
...
let uu___111_4665 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_new_effect (ne1); FStar_Syntax_Syntax.sigrng = uu___111_4665.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___111_4665.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___111_4665.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___111_4665.FStar_Syntax_Syntax.sigattrs})
in (((se1)::[]), ([]))))
end
...
let uu____4680 = (FStar_TypeChecker_Env.lookup_effect_lid env1 sub1.FStar_Syntax_Syntax.source)
in (monad_signature env1 sub1.FStar_Syntax_Syntax.source uu____4680))
...
let uu____4702 = (FStar_TypeChecker_Env.lookup_effect_lid env1 sub1.FStar_Syntax_Syntax.target)
in (monad_signature env1 sub1.FStar_Syntax_Syntax.target uu____4702))
...
let uu____4729 = (FStar_Syntax_Syntax.bv_to_name a)
in ((b), (uu____4729)))
in FStar_Syntax_Syntax.NT (uu____4722))
in (uu____4721)::[])
in (FStar_Syntax_Subst.subst uu____4718 wp_b_tgt))
in (
...
let uu____4740 = (FStar_Syntax_Syntax.mk_binder a)
in (

let uu____4741 = (

let uu____4744 = (FStar_Syntax_Syntax.null_binder wp_a_src)
in (uu____4744)::[])
in (uu____4740)::uu____4741))
in (

let uu____4745 = (FStar_Syntax_Syntax.mk_Total wp_a_tgt)
in (FStar_Syntax_Util.arrow uu____4733 uu____4745)))
in (
...
let uu____4772 = (FStar_Util.format1 "Effect %s cannot be reified" l.FStar_Ident.str)
in (

let uu____4773 = (FStar_TypeChecker_Env.get_range env1)
in ((uu____4772), (uu____4773))))
in FStar_Errors.Error (uu____4767))
in (FStar_Exn.raise uu____4766)))
in (

let uu____4776 = (FStar_TypeChecker_Env.effect_decl_opt env1 eff_name)
...
let uu____4809 = (FStar_All.pipe_right qualifiers (FStar_List.contains FStar_Syntax_Syntax.Reifiable))
in (not (uu____4809)))
...
let uu____4815 = (FStar_TypeChecker_Env.get_range env1)
in (
...
let uu____4838 = (FStar_Syntax_Syntax.as_arg a1)
in (

let uu____4839 = (

let uu____4842 = (FStar_Syntax_Syntax.as_arg wp)
in (uu____4842)::[])
in (uu____4838)::uu____4839))
in ((repr), (uu____4835)))
in FStar_Syntax_Syntax.Tm_app (uu____4820))
in (FStar_Syntax_Syntax.mk uu____4819))
in (uu____4816 FStar_Pervasives_Native.None uu____4815)))
end)))
end))))
in (

let uu____4848 = (match (((sub1.FStar_Syntax_Syntax.lift), (sub1.FStar_Syntax_Syntax.lift_wp))) with
| (FStar_Pervasives_Native.None, FStar_Pervasives_Native.None) -> begin
(failwith "Impossible")
end
| (lift, FStar_Pervasives_Native.Some (uu____4876, lift_wp)) -> begin
(

let uu____4900 = (check_and_gen env1 lift_wp expected_k)
in ((lift), (uu____4900)))
end
| (FStar_Pervasives_Native.Some (what, lift), FStar_Pervasives_Native.None) -> begin
((

let uu____4926 = (FStar_TypeChecker_Env.debug env1 (FStar_Options.Other ("ED")))
in (match (uu____4926) with
| true -> begin
(

let uu____4927 = (FStar_Syntax_Print.term_to_string lift)
...
let uu____4930 = (FStar_TypeChecker_TcTerm.tc_term env1 lift)
in (match (uu____4930) with
| (lift1, comp, uu____4945) -> begin
(

let uu____4946 = (FStar_TypeChecker_DMFF.star_expr dmff_env lift1)
in (match (uu____4946) with
| (uu____4959, lift_wp, lift_elab) -> begin
(

let uu____4962 = (recheck_debug "lift-wp" env1 lift_wp)
in (

let uu____4963 = (recheck_debug "lift-elab" env1 lift_elab)
...
let uu___112_5004 = env1
in {FStar_TypeChecker_Env.solver = uu___112_5004.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___112_5004.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___112_5004.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___112_5004.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___112_5004.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___112_5004.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___112_5004.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___112_5004.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___112_5004.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___112_5004.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___112_5004.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___112_5004.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___112_5004.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___112_5004.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___112_5004.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___112_5004.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___112_5004.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___112_5004.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___112_5004.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___112_5004.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.type_of = uu___112_5004.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___112_5004.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___112_5004.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___112_5004.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___112_5004.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___112_5004.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___112_5004.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___112_5004.FStar_TypeChecker_Env.identifier_info})
in (
...
| FStar_Pervasives_Native.Some (uu____5010, lift1) -> begin
(

let uu____5022 = (

let uu____5029 = (FStar_TypeChecker_Env.lookup_effect_lid env2 sub1.FStar_Syntax_Syntax.source)
in (monad_signature env2 sub1.FStar_Syntax_Syntax.source uu____5029))
...
let uu____5053 = (FStar_TypeChecker_Env.get_range env2)
in (
...
let uu____5076 = (FStar_Syntax_Syntax.as_arg a_typ)
in (

let uu____5077 = (

let uu____5080 = (FStar_Syntax_Syntax.as_arg wp_a_typ)
in (uu____5080)::[])
in (uu____5076)::uu____5077))
in ((lift_wp1), (uu____5073)))
in FStar_Syntax_Syntax.Tm_app (uu____5058))
in (FStar_Syntax_Syntax.mk uu____5057))
in (uu____5054 FStar_Pervasives_Native.None uu____5053)))
...
let uu____5096 = (FStar_Syntax_Syntax.mk_binder a1)
in (

let uu____5097 = (

let uu____5100 = (FStar_Syntax_Syntax.mk_binder wp_a)
in (

let uu____5101 = (

let uu____5104 = (FStar_Syntax_Syntax.null_binder repr_f)
in (uu____5104)::[])
in (uu____5100)::uu____5101))
in (uu____5096)::uu____5097))
in (

let uu____5105 = (FStar_Syntax_Syntax.mk_Total repr_result)
in (FStar_Syntax_Util.arrow uu____5089 uu____5105)))
in (

let uu____5108 = (FStar_TypeChecker_TcTerm.tc_tot_or_gtot_term env2 expected_k1)
in (match (uu____5108) with
| (expected_k2, uu____5118, uu____5119) -> begin
(
...
let uu___113_5122 = sub1
in {FStar_Syntax_Syntax.source = uu___113_5122.FStar_Syntax_Syntax.source; FStar_Syntax_Syntax.target = uu___113_5122.FStar_Syntax_Syntax.target; FStar_Syntax_Syntax.lift_wp = FStar_Pervasives_Native.Some (lift_wp); FStar_Syntax_Syntax.lift = lift1})
in (

let se1 = (

let uu___114_5124 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_sub_effect (sub2); FStar_Syntax_Syntax.sigrng = uu___114_5124.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___114_5124.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___114_5124.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___114_5124.FStar_Syntax_Syntax.sigattrs})
in (((se1)::[]), ([])))))))
end)))))
end))
end))))
...
let uu____5143 = (FStar_Syntax_Subst.open_comp tps c)
in (match (uu____5143) with
| (tps1, c1) -> begin
(

let uu____5158 = (FStar_TypeChecker_TcTerm.tc_tparams env2 tps1)
in (match (uu____5158) with
| (tps2, env3, us) -> begin
(

let uu____5176 = (FStar_TypeChecker_TcTerm.tc_comp env3 c1)
...
let uu____5198 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps3), (c3)))) FStar_Pervasives_Native.None r)
in (FStar_TypeChecker_Util.generalize_universes env0 uu____5198))
...
let uu____5232 = (FStar_Syntax_Subst.compress t)
in uu____5232.FStar_Syntax_Syntax.n)
in ((tps3), (uu____5231)))
in (match (uu____5226) with
| ([], FStar_Syntax_Syntax.Tm_arrow (uu____5247, c4)) -> begin
(([]), (c4))
end
| (uu____5287, FStar_Syntax_Syntax.Tm_arrow (tps4, c4)) -> begin
((tps4), (c4))
end
| uu____5314 -> begin
(failwith "Impossible")
...
let uu____5358 = (FStar_Syntax_Subst.open_univ_vars uvs1 t)
...
let uu____5372 = (FStar_Syntax_Print.lid_to_string lid)
in (

let uu____5373 = (FStar_All.pipe_right (FStar_List.length uvs1) FStar_Util.string_of_int)
in (

let uu____5374 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.format3 "Effect abbreviations must be polymorphic in exactly 1 universe; %s has %s universes (%s)" uu____5372 uu____5373 uu____5374))))
in ((uu____5371), (r)))
in FStar_Errors.Error (uu____5366))
in (FStar_Exn.raise uu____5365))
end))
end
| uu____5375 -> begin
()
...
let uu___115_5377 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_effect_abbrev (((lid), (uvs1), (tps4), (c4), (flags))); FStar_Syntax_Syntax.sigrng = uu___115_5377.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___115_5377.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___115_5377.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___115_5377.FStar_Syntax_Syntax.sigattrs})
in (((se1)::[]), ([])));
)
end))
end))));
...
| FStar_Syntax_Syntax.Sig_declare_typ (uu____5394, uu____5395, uu____5396) when (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___89_5400 -> (match (uu___89_5400) with
...
| FStar_Syntax_Syntax.Sig_let (uu____5406, uu____5407) when (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___89_5415 -> (match (uu___89_5415) with
| FStar_Syntax_Syntax.OnlyName -> begin
true
end
| uu____5416 -> begin
...
let uu____5426 = (FStar_TypeChecker_Env.lid_exists env2 lid)
...
let uu____5433 = (FStar_Util.format1 "Top-level declaration %s for a name that is already used in this module; top-level declarations must be unique in their module" (FStar_Ident.text_of_lid lid))
in ((uu____5433), (r)))
in FStar_Errors.Error (uu____5428))
in (FStar_Exn.raise uu____5427))
end
| uu____5434 -> begin
()
end));
...
let uu____5435 = (match ((uvs = [])) with
| true -> begin
(

let uu____5436 = (

let uu____5437 = (FStar_Syntax_Util.type_u ())
in (FStar_Pervasives_Native.fst uu____5437))
in (check_and_gen env2 t uu____5436))
end
| uu____5442 -> begin
(

let uu____5443 = (FStar_Syntax_Subst.open_univ_vars uvs t)
...
let uu____5452 = (FStar_Syntax_Util.type_u ())
in (FStar_Pervasives_Native.fst uu____5452))
in (tc_check_trivial_guard env2 t1 uu____5451))
in (
...
let uu____5458 = (FStar_Syntax_Subst.close_univ_vars uvs1 t3)
in ((uvs1), (uu____5458)))))
end))
end)
...
let uu___116_5474 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((lid), (uvs1), (t1))); FStar_Syntax_Syntax.sigrng = uu___116_5474.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___116_5474.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___116_5474.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___116_5474.FStar_Syntax_Syntax.sigattrs})
in (((se1)::[]), ([])))
end));
))
end
...
let uu____5484 = (FStar_Syntax_Subst.open_univ_vars us phi)
in (match (uu____5484) with
| (uu____5497, phi1) -> begin
(
...
let uu____5507 = (FStar_TypeChecker_TcTerm.tc_term env3 e)
...
let uu____5535 = (FStar_Syntax_Util.ml_comp FStar_Syntax_Syntax.t_unit r)
in FStar_Pervasives_Native.Some (uu____5535))
in (

let uu____5536 = (

let uu____5541 = (c.FStar_Syntax_Syntax.comp ())
in ((e1), (uu____5541)))
in (FStar_TypeChecker_TcTerm.check_expected_effect env3 uu____5532 uu____5536)))
in (match (uu____5525) with
| (e2, uu____5555, g) -> begin
((

let uu____5558 = (FStar_TypeChecker_Rel.conj_guard g1 g)
in (FStar_TypeChecker_Rel.force_trivial_guard env3 uu____5558));
(

let se1 = (

let uu___117_5560 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_main (e2); FStar_Syntax_Syntax.sigrng = uu___117_5560.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___117_5560.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___117_5560.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___117_5560.FStar_Syntax_Syntax.sigattrs})
in (((se1)::[]), ([])));
)
end))
end))))
...
let uu____5611 = (((FStar_List.length q) = (FStar_List.length q')) && (FStar_List.forall2 FStar_Syntax_Util.qualifier_equal q q'))
...
let uu____5626 = (FStar_Syntax_Print.lid_to_string l)
in (

let uu____5627 = (FStar_Syntax_Print.quals_to_string q)
in (

let uu____5628 = (FStar_Syntax_Print.quals_to_string q')
in (FStar_Util.format3 "Inconsistent qualifier annotations on %s; Expected {%s}, got {%s}" uu____5626 uu____5627 uu____5628))))
in ((uu____5625), (r)))
in FStar_Errors.Error (uu____5620))
in (FStar_Exn.raise uu____5619))
end))
end))
in (
...
let uu____5655 = (FStar_Syntax_Subst.compress def)
in uu____5655.FStar_Syntax_Syntax.n)
in (match (uu____5654) with
| FStar_Syntax_Syntax.Tm_abs (binders, uu____5665, uu____5666) -> begin
binders
end
| uu____5687 -> begin
[]
...
in (match (typ1) with
| {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_arrow (val_bs, c); FStar_Syntax_Syntax.pos = r1; FStar_Syntax_Syntax.vars = uu____5697} -> begin
(
...
| (((body_bv, uu____5822))::bt, ((val_bv, aqual))::vt) -> begin
(

let uu____5859 = (rename_binders1 bt vt)
in ((match ((((has_auto_name body_bv)), ((has_auto_name val_bv)))) with
| (true, uu____5875) -> begin
((val_bv), (aqual))
end
| (false, true) -> begin
(((

let uu___118_5877 = val_bv
in {FStar_Syntax_Syntax.ppname = (

let uu___119_5880 = val_bv.FStar_Syntax_Syntax.ppname
in {FStar_Ident.idText = body_bv.FStar_Syntax_Syntax.ppname.FStar_Ident.idText; FStar_Ident.idRange = uu___119_5880.FStar_Ident.idRange}); FStar_Syntax_Syntax.index = uu___118_5877.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu___118_5877.FStar_Syntax_Syntax.sort})), (aqual))
end
| (false, false) -> begin
((val_bv), (aqual))
end))::uu____5859)
...
let uu____5898 = (rename_binders1 def_bs val_bs)
in ((uu____5898), (c)))
in FStar_Syntax_Syntax.Tm_arrow (uu____5885))
in (FStar_Syntax_Syntax.mk uu____5884))
in (uu____5881 FStar_Pervasives_Native.None r1))))
end
| uu____5916 -> begin
typ1
end))))
...
let uu___120_5917 = lb
in (

let uu____5918 = (rename_in_typ lb.FStar_Syntax_Syntax.lbdef lb.FStar_Syntax_Syntax.lbtyp)
in {FStar_Syntax_Syntax.lbname = uu___120_5917.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___120_5917.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu____5918; FStar_Syntax_Syntax.lbeff = uu___120_5917.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu___120_5917.FStar_Syntax_Syntax.lbdef}))))
in (

let uu____5921 = (FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) (FStar_List.fold_left (fun uu____5972 lb -> (match (uu____5972) with
...
let uu____6025 = (FStar_TypeChecker_Env.try_lookup_val_decl env2 lbname.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
...
let uu____6153 = (FStar_Syntax_Syntax.mk_lb ((FStar_Util.Inr (lbname)), (uvs), (FStar_Parser_Const.effect_ALL_lid), (tval), (def)))
in ((false), (uu____6153), (quals_opt1)));
)))
end))
...
let uu____6247 = (FStar_All.pipe_right q (FStar_Util.for_some (fun uu___90_6251 -> (match (uu___90_6251) with
...
let uu____6279 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)) FStar_Pervasives_Native.None r)
in (((((FStar_Pervasives_Native.fst lbs)), (lbs'1))), (uu____6279)))
in FStar_Syntax_Syntax.Tm_let (uu____6266))
in (FStar_Syntax_Syntax.mk uu____6265))
in (uu____6262 FStar_Pervasives_Native.None r))
in (

let uu____6297 = (

let uu____6308 = (FStar_TypeChecker_TcTerm.tc_maybe_toplevel_term (

let uu___121_6317 = env2
in {FStar_TypeChecker_Env.solver = uu___121_6317.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___121_6317.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___121_6317.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___121_6317.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___121_6317.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___121_6317.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___121_6317.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___121_6317.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___121_6317.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___121_6317.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___121_6317.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = should_generalize; FStar_TypeChecker_Env.letrecs = uu___121_6317.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = uu___121_6317.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___121_6317.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___121_6317.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___121_6317.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___121_6317.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___121_6317.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___121_6317.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.type_of = uu___121_6317.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___121_6317.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___121_6317.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___121_6317.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___121_6317.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___121_6317.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___121_6317.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___121_6317.FStar_TypeChecker_Env.identifier_info}) e)
in (match (uu____6308) with
| ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let (lbs1, e1); FStar_Syntax_Syntax.pos = uu____6330; FStar_Syntax_Syntax.vars = uu____6331}, uu____6332, g) when (FStar_TypeChecker_Rel.is_trivial g) -> begin
(

let lbs2 = (

let uu____6361 = (FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs1) (FStar_List.map rename_parameters))
in (((FStar_Pervasives_Native.fst lbs1)), (uu____6361)))
in (

let quals1 = (match (e1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_meta (uu____6379, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect)) -> begin
...
let quals2 = (FStar_List.choose (fun uu___91_6390 -> (match (uu___91_6390) with
| FStar_Syntax_Syntax.Inline_for_extraction -> begin
(

let uu____6393 = (

let uu____6394 = (FStar_List.for_all (fun lb -> (
...
let uu____6401 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
...
let uu___122_6416 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let (((lbs2), (lids))); FStar_Syntax_Syntax.sigrng = uu___122_6416.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = quals2; FStar_Syntax_Syntax.sigmeta = uu___122_6416.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___122_6416.FStar_Syntax_Syntax.sigattrs})), (lbs2)))))
end
| uu____6425 -> begin
(failwith "impossible")
end))
...
let uu____6476 = (FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs1) (FStar_List.map (fun lb -> (
...
let uu____6504 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in uu____6504.FStar_Syntax_Syntax.fv_name)
in uu____6501.FStar_Syntax_Syntax.v)
in (FStar_TypeChecker_Env.try_lookup_val_decl env2 uu____6500))
...
let uu____6520 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
in (

let uu____6521 = (FStar_Syntax_Print.term_to_string lb.FStar_Syntax_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" uu____6520 uu____6521)))
end
| uu____6522 -> begin
""
end)))))
in (FStar_All.pipe_right uu____6476 (FStar_String.concat "\n")))
...
let uu____6552 = (FStar_Syntax_Subst.open_comp bs c)
in (match (uu____6552) with
| (bs1, c1) -> begin
(

let uu____6559 = (FStar_Syntax_Util.is_total_comp c1)
...
let uu____6572 = (FStar_Syntax_Subst.compress t')
in uu____6572.FStar_Syntax_Syntax.n)
...
let uu____6598 = (FStar_Syntax_Subst.compress h)
in uu____6598.FStar_Syntax_Syntax.n)
...
let uu____6608 = (FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.u_tac_lid FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None)
in (FStar_All.pipe_left FStar_Syntax_Syntax.fv_to_tm uu____6608))
in (
...
let uu____6611 = (FStar_Syntax_Syntax.mk_Tm_uinst h'' u')
in (FStar_Syntax_Syntax.mk_Tm_app uu____6611 args))
in (uu____6610 FStar_Pervasives_Native.None t'.FStar_Syntax_Syntax.pos))
in (FStar_Syntax_Syntax.mk_Total' uu____6609 u)))
end
| uu____6614 -> begin
c1
end))
...
let uu____6632 = (FStar_Syntax_Subst.close_comp bs1 c')
in ((bs1), (uu____6632)))
in FStar_Syntax_Syntax.Tm_arrow (uu____6619))
in {FStar_Syntax_Syntax.n = uu____6618; FStar_Syntax_Syntax.pos = uu___123_6617.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___123_6617.FStar_Syntax_Syntax.vars})))
end
| uu____6633 -> begin
t1
end))
...
let uu____6657 = (FStar_Syntax_Subst.compress h)
in uu____6657.FStar_Syntax_Syntax.n)
...
let uu____6667 = (FStar_Syntax_Syntax.lid_as_fv FStar_Parser_Const.u_tac_lid FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None)
in (FStar_All.pipe_left FStar_Syntax_Syntax.fv_to_tm uu____6667))
in (

let uu____6668 = (

let uu____6669 = (FStar_Syntax_Syntax.mk_Tm_uinst h'' u')
in (FStar_Syntax_Syntax.mk_Tm_app uu____6669 args))
in (uu____6668 FStar_Pervasives_Native.None t1.FStar_Syntax_Syntax.pos)))
end
| uu____6672 -> begin
t1
end))
...
let uu____6701 = (FStar_Syntax_Syntax.lid_as_fv assm_lid FStar_Syntax_Syntax.Delta_constant FStar_Pervasives_Native.None)
in (FStar_All.pipe_left FStar_Syntax_Syntax.fv_to_tm uu____6701))
in (

let tac_args = (FStar_List.map (fun x -> (

let uu____6718 = (FStar_Syntax_Syntax.bv_to_name (FStar_Pervasives_Native.fst x))
in ((uu____6718), ((FStar_Pervasives_Native.snd x))))) bs)
in (
...
let uu____6749 = (FStar_Syntax_Syntax.new_bv FStar_Pervasives_Native.None FStar_Syntax_Syntax.t_unit)
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder uu____6749))
in (
...
let uu___124_6756 = se1
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let (((((b), (((

let uu___125_6768 = lb
in {FStar_Syntax_Syntax.lbname = uu___125_6768.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___125_6768.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___125_6768.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___125_6768.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = func}))::[]))), (lids))); FStar_Syntax_Syntax.sigrng = uu___124_6756.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___124_6756.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___124_6756.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___124_6756.FStar_Syntax_Syntax.sigattrs}))))))))))
in (
...
let uu____6785 = (FStar_Syntax_Util.arrow_formals_comp hd1.FStar_Syntax_Syntax.lbtyp)
...
let uu____6820 = (FStar_Syntax_Subst.compress t)
in uu____6820.FStar_Syntax_Syntax.n)
...
let uu____6856 = (FStar_Util.right hd1.FStar_Syntax_Syntax.lbname)
in uu____6856.FStar_Syntax_Syntax.fv_name)
in uu____6853.FStar_Syntax_Syntax.v)
in (

let assm_lid = (

let uu____6858 = (FStar_All.pipe_left FStar_Ident.id_of_text (Prims.strcat "__" tac_lid.FStar_Ident.ident.FStar_Ident.idText))
in (FStar_Ident.lid_of_ns_and_id tac_lid.FStar_Ident.ns uu____6858))
in (

let uu____6859 = ((is_native_tactic env2 assm_lid h1) && (

let uu____6861 = (

let uu____6862 = (FStar_TypeChecker_Env.try_lookup_val_decl env2 tac_lid)
in (FStar_All.pipe_left FStar_Util.is_some uu____6862))
in (not (uu____6861))))
...
let uu____6931 = (FStar_TypeChecker_Env.debug env2 (FStar_Options.Other ("NativeTactics")))
in (match (uu____6931) with
| true -> begin
(

let uu____6932 = (FStar_Syntax_Print.sigelt_to_string se_assm)
in (

let uu____6933 = (FStar_Syntax_Print.sigelt_to_string se_refl)
...
let is_abstract = (fun quals -> (FStar_All.pipe_right quals (FStar_Util.for_some (fun uu___92_6986 -> (match (uu___92_6986) with
...
| FStar_Syntax_Syntax.Projector (l, uu____6993) -> begin
...
in (match (se.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_pragma (uu____7008) -> begin
(([]), (hidden))
end
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____7013) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Sig_datacon (uu____7038) -> begin
(failwith "Impossible")
end
| FStar_Syntax_Syntax.Sig_bundle (ses, uu____7062) -> begin
(

let uu____7071 = (is_abstract se.FStar_Syntax_Syntax.sigquals)
in (match (uu____7071) with
| true -> begin
(

let for_export_bundle = (fun se1 uu____7102 -> (match (uu____7102) with
| (out, hidden1) -> begin
(match (se1.FStar_Syntax_Syntax.sigel) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, us, bs, t, uu____7141, uu____7142) -> begin
(

let dec = (

let uu___126_7152 = se1
in (
...
let uu____7164 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow bs uu____7164))
in ((l), (us), (uu____7161)))
in FStar_Syntax_Syntax.Sig_declare_typ (uu____7154))
in {FStar_Syntax_Syntax.sigel = uu____7153; FStar_Syntax_Syntax.sigrng = uu___126_7152.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Assumption)::(FStar_Syntax_Syntax.New)::se1.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___126_7152.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___126_7152.FStar_Syntax_Syntax.sigattrs}))
in (((dec)::out), (hidden1)))
end
| FStar_Syntax_Syntax.Sig_datacon (l, us, t, uu____7176, uu____7177, uu____7178) -> begin
(

let dec = (

let uu___127_7184 = se1
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), (us), (t))); FStar_Syntax_Syntax.sigrng = uu___127_7184.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Assumption)::[]; FStar_Syntax_Syntax.sigmeta = uu___127_7184.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___127_7184.FStar_Syntax_Syntax.sigattrs})
...
| FStar_Syntax_Syntax.Sig_assume (uu____7211, uu____7212, uu____7213) -> begin
(

let uu____7214 = (is_abstract se.FStar_Syntax_Syntax.sigquals)
...
let uu____7235 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some is_hidden_proj_or_disc))
in (match (uu____7235) with
| true -> begin
((((

let uu___128_7251 = se
in {FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_declare_typ (((l), (us), (t))); FStar_Syntax_Syntax.sigrng = uu___128_7251.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Assumption)::[]; FStar_Syntax_Syntax.sigmeta = uu___128_7251.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___128_7251.FStar_Syntax_Syntax.sigattrs}))::[]), ((l)::hidden))
end
| uu____7252 -> begin
(

let uu____7253 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___93_7257 -> (match (uu___93_7257) with
| FStar_Syntax_Syntax.Assumption -> begin
true
end
| FStar_Syntax_Syntax.Projector (uu____7258) -> begin
true
end
| FStar_Syntax_Syntax.Discriminator (uu____7263) -> begin
true
end
| uu____7264 -> begin
false
...
| FStar_Syntax_Syntax.Sig_main (uu____7282) -> begin
(([]), (hidden))
end
| FStar_Syntax_Syntax.Sig_new_effect (uu____7287) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____7292) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_sub_effect (uu____7297) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_effect_abbrev (uu____7302) -> begin
(((se)::[]), (hidden))
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), uu____7320) when (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some is_hidden_proj_or_disc)) -> begin
(
...
let uu____7337 = (FStar_All.pipe_right hidden (FStar_Util.for_some (FStar_Syntax_Syntax.fv_eq_lid fv)))
...
let uu____7368 = (is_abstract se.FStar_Syntax_Syntax.sigquals)
in (match (uu____7368) with
| true -> begin
(

let uu____7377 = (FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) (FStar_List.map (fun lb -> (

let uu___129_7390 = se
in (
...
let uu____7403 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in uu____7403.FStar_Syntax_Syntax.fv_name)
in uu____7400.FStar_Syntax_Syntax.v)
in ((uu____7399), (lb.FStar_Syntax_Syntax.lbunivs), (lb.FStar_Syntax_Syntax.lbtyp)))
in FStar_Syntax_Syntax.Sig_declare_typ (uu____7392))
in {FStar_Syntax_Syntax.sigel = uu____7391; FStar_Syntax_Syntax.sigrng = uu___129_7390.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = (FStar_Syntax_Syntax.Assumption)::se.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___129_7390.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___129_7390.FStar_Syntax_Syntax.sigattrs})))))
in ((uu____7377), (hidden)))
end
| uu____7412 -> begin
(((se)::[]), (hidden))
end))
...
| FStar_Syntax_Syntax.Sig_inductive_typ (uu____7425) -> begin
(failwith "add_sigelt_to_env: Impossible, bare data constructor")
end
| FStar_Syntax_Syntax.Sig_datacon (uu____7442) -> begin
(failwith "add_sigelt_to_env: Impossible, bare data constructor")
end
| FStar_Syntax_Syntax.Sig_pragma (p) -> begin
(match (p) with
| FStar_Syntax_Syntax.SetOptions (uu____7458) -> begin
(

let uu____7459 = (FStar_Options.using_facts_from ())
...
let uu____7489 = (FStar_List.map (fun s -> (((FStar_Ident.path_of_text s)), (true))) ns)
in (FStar_List.append uu____7489 (((([]), (false)))::[])))
in (uu____7480)::[])
in (

let uu___130_7544 = env
in {FStar_TypeChecker_Env.solver = uu___130_7544.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___130_7544.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___130_7544.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___130_7544.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___130_7544.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___130_7544.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___130_7544.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___130_7544.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___130_7544.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___130_7544.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___130_7544.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___130_7544.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___130_7544.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___130_7544.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___130_7544.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___130_7544.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___130_7544.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___130_7544.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___130_7544.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___130_7544.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___130_7544.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.type_of = uu___130_7544.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___130_7544.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___130_7544.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___130_7544.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = proof_ns; FStar_TypeChecker_Env.synth = uu___130_7544.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___130_7544.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___130_7544.FStar_TypeChecker_Env.identifier_info}))
end
| FStar_Pervasives_Native.None -> begin
(

let uu___131_7547 = env
in {FStar_TypeChecker_Env.solver = uu___131_7547.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___131_7547.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___131_7547.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___131_7547.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___131_7547.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___131_7547.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___131_7547.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___131_7547.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___131_7547.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___131_7547.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___131_7547.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___131_7547.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___131_7547.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___131_7547.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___131_7547.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___131_7547.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___131_7547.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___131_7547.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___131_7547.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___131_7547.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___131_7547.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.type_of = uu___131_7547.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___131_7547.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___131_7547.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___131_7547.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = ([])::[]; FStar_TypeChecker_Env.synth = uu___131_7547.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___131_7547.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___131_7547.FStar_TypeChecker_Env.identifier_info})
end))
end
| FStar_Syntax_Syntax.ResetOptions (uu____7564) -> begin
(

let uu____7567 = (FStar_Options.using_facts_from ())
...
let uu____7597 = (FStar_List.map (fun s -> (((FStar_Ident.path_of_text s)), (true))) ns)
in (FStar_List.append uu____7597 (((([]), (false)))::[])))
in (uu____7588)::[])
in (

let uu___130_7652 = env
in {FStar_TypeChecker_Env.solver = uu___130_7652.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___130_7652.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___130_7652.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___130_7652.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___130_7652.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___130_7652.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___130_7652.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___130_7652.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___130_7652.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___130_7652.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___130_7652.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___130_7652.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___130_7652.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___130_7652.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___130_7652.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___130_7652.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___130_7652.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___130_7652.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___130_7652.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___130_7652.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___130_7652.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.type_of = uu___130_7652.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___130_7652.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___130_7652.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___130_7652.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = proof_ns; FStar_TypeChecker_Env.synth = uu___130_7652.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___130_7652.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___130_7652.FStar_TypeChecker_Env.identifier_info}))
end
| FStar_Pervasives_Native.None -> begin
(

let uu___131_7655 = env
in {FStar_TypeChecker_Env.solver = uu___131_7655.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___131_7655.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___131_7655.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___131_7655.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___131_7655.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___131_7655.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___131_7655.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___131_7655.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___131_7655.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___131_7655.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___131_7655.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___131_7655.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___131_7655.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___131_7655.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___131_7655.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___131_7655.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___131_7655.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___131_7655.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu___131_7655.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___131_7655.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___131_7655.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.type_of = uu___131_7655.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___131_7655.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___131_7655.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___131_7655.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = ([])::[]; FStar_TypeChecker_Env.synth = uu___131_7655.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___131_7655.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___131_7655.FStar_TypeChecker_Env.identifier_info})
end))
end
| uu____7672 -> begin
env
...
| FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____7673) -> begin
env
end
| FStar_Syntax_Syntax.Sig_new_effect (ne) -> begin
(
...
let uu____7683 = (FStar_Syntax_Util.action_as_lb ne.FStar_Syntax_Syntax.mname a)
in (FStar_TypeChecker_Env.push_sigelt env2 uu____7683))) env1)))
end
| FStar_Syntax_Syntax.Sig_declare_typ (uu____7684, uu____7685, uu____7686) when (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___94_7690 -> (match (uu___94_7690) with
| FStar_Syntax_Syntax.OnlyName -> begin
true
end
| uu____7691 -> begin
...
| FStar_Syntax_Syntax.Sig_let (uu____7692, uu____7693) when (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_Util.for_some (fun uu___94_7701 -> (match (uu___94_7701) with
| FStar_Syntax_Syntax.OnlyName -> begin
true
end
| uu____7702 -> begin
...
let rec process_one_decl = (fun uu____7765 se -> (match (uu____7765) with
| (ses1, exports, env1, hidden) -> begin
((

let uu____7818 = (FStar_TypeChecker_Env.debug env1 FStar_Options.Low)
in (match (uu____7818) with
| true -> begin
(

let uu____7819 = (FStar_Syntax_Print.sigelt_to_string se)
...
let uu____7821 = (tc_decl env1 se)
...
let uu____7871 = (FStar_TypeChecker_Env.debug env1 (FStar_Options.Other ("UF")))
in (match (uu____7871) with
| true -> begin
(

let uu____7872 = (FStar_Syntax_Print.sigelt_to_string se1)
in (FStar_Util.print1 "About to elim vars from %s" uu____7872))
end
| uu____7873 -> begin
()
end));
...
let uu____7895 = ((FStar_Options.log_types ()) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env2) (FStar_Options.Other ("LogTypes"))))
in (match (uu____7895) with
| true -> begin
(

let uu____7896 = (FStar_List.fold_left (fun s se1 -> (

let uu____7902 = (

let uu____7903 = (FStar_Syntax_Print.sigelt_to_string se1)
in (Prims.strcat uu____7903 "\n"))
in (Prims.strcat s uu____7902))) "" ses'1)
...
let accum_exports_hidden = (fun uu____7938 se1 -> (match (uu____7938) with
| (exports1, hidden1) -> begin
(

let uu____7966 = (for_export hidden1 se1)
...
let uu___132_8045 = s
in {FStar_Syntax_Syntax.sigel = uu___132_8045.FStar_Syntax_Syntax.sigel; FStar_Syntax_Syntax.sigrng = uu___132_8045.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___132_8045.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___132_8045.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = se.FStar_Syntax_Syntax.sigattrs})) ses'1)
...
| (uu____8158, uu____8159, env1, uu____8161) -> begin
(

let uu____8174 = (FStar_Util.record_time (fun uu____8220 -> (process_one_decl acc se)))
in (match (uu____8174) with
| (r, ms_elapsed) -> begin
((

let uu____8284 = (FStar_TypeChecker_Env.debug env1 (FStar_Options.Other ("TCDeclTime")))
in (match (uu____8284) with
| true -> begin
(

let uu____8285 = (FStar_Syntax_Print.sigelt_to_string_short se)
in (

let uu____8286 = (FStar_Util.string_of_int ms_elapsed)
...
let uu____8288 = (FStar_Util.fold_flatten process_one_decl_timed (([]), ([]), (env), ([])) ses)
in (match (uu____8288) with
| (ses1, exports, env1, uu____8336) -> begin
...
let uu____8375 = (FStar_Options.debug_any ())
...
let uu___133_8381 = env
in {FStar_TypeChecker_Env.solver = uu___133_8381.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___133_8381.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___133_8381.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___133_8381.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___133_8381.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___133_8381.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___133_8381.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___133_8381.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___133_8381.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___133_8381.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___133_8381.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___133_8381.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___133_8381.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___133_8381.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___133_8381.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___133_8381.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = modul.FStar_Syntax_Syntax.is_interface; FStar_TypeChecker_Env.admit = (not (verify)); FStar_TypeChecker_Env.lax = uu___133_8381.FStar_TypeChecker_Env.lax; FStar_TypeChecker_Env.lax_universes = uu___133_8381.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___133_8381.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.type_of = uu___133_8381.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___133_8381.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___133_8381.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___133_8381.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___133_8381.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___133_8381.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___133_8381.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___133_8381.FStar_TypeChecker_Env.identifier_info})
...
let uu____8384 = (tc_decls env2 modul.FStar_Syntax_Syntax.declarations)
in (match (uu____8384) with
| (ses, exports, env3) -> begin
(((

let uu___134_8417 = modul
in {FStar_Syntax_Syntax.name = uu___134_8417.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = ses; FStar_Syntax_Syntax.exports = uu___134_8417.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___134_8417.FStar_Syntax_Syntax.is_interface})), (exports), (env3))
end)));
))));
)))))
...
let uu____8442 = (tc_decls env decls)
...
let uu___135_8473 = modul
in {FStar_Syntax_Syntax.name = uu___135_8473.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = (FStar_List.append modul.FStar_Syntax_Syntax.declarations ses); FStar_Syntax_Syntax.exports = uu___135_8473.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___135_8473.FStar_Syntax_Syntax.is_interface})
...
let uu___136_8493 = env
in {FStar_TypeChecker_Env.solver = uu___136_8493.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___136_8493.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___136_8493.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___136_8493.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___136_8493.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___136_8493.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___136_8493.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___136_8493.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___136_8493.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___136_8493.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___136_8493.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___136_8493.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___136_8493.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = uu___136_8493.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___136_8493.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___136_8493.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___136_8493.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = true; FStar_TypeChecker_Env.failhard = uu___136_8493.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.type_of = uu___136_8493.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___136_8493.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___136_8493.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___136_8493.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___136_8493.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___136_8493.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___136_8493.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___136_8493.FStar_TypeChecker_Env.identifier_info})
in (

let check_term = (fun lid univs1 t -> (

let uu____8504 = (FStar_Syntax_Subst.open_univ_vars univs1 t)
...
let uu____8516 = (FStar_TypeChecker_Env.set_current_module env1 modul.FStar_Syntax_Syntax.name)
in (FStar_TypeChecker_Env.debug uu____8516))
in (FStar_All.pipe_left uu____8513 (FStar_Options.Other ("Exports"))))
in (match (uu____8512) with
| true -> begin
(

let uu____8517 = (FStar_Syntax_Print.lid_to_string lid)
in (

let uu____8518 = (

let uu____8519 = (FStar_All.pipe_right univs2 (FStar_List.map (fun x -> (FStar_Syntax_Print.univ_to_string (FStar_Syntax_Syntax.U_name (x))))))
in (FStar_All.pipe_right uu____8519 (FStar_String.concat ", ")))
in (
...
let uu____8531 = (FStar_TypeChecker_TcTerm.tc_trivial_guard env2 t1)
in (FStar_All.pipe_right uu____8531 FStar_Pervasives.ignore)));
)
end)))
in (
...
let uu____8556 = (FStar_Syntax_Print.lid_to_string modul.FStar_Syntax_Syntax.name)
in (

let uu____8557 = (FStar_Syntax_Print.lid_to_string lid)
in (FStar_Util.format2 "Interface of %s violates its abstraction (add a \'private\' qualifier to \'%s\'?)" uu____8556 uu____8557)))
in (FStar_Errors.message_prefix.FStar_Errors.set_prefix uu____8555));
...
| FStar_Syntax_Syntax.Sig_bundle (ses, uu____8564) -> begin
(

let uu____8573 = (

let uu____8574 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_List.contains FStar_Syntax_Syntax.Private))
in (not (uu____8574)))
...
| FStar_Syntax_Syntax.Sig_inductive_typ (l, univs1, binders, typ, uu____8584, uu____8585) -> begin
(
...
let uu____8614 = (FStar_Syntax_Syntax.mk_Total typ)
in ((binders), (uu____8614)))
in FStar_Syntax_Syntax.Tm_arrow (uu____8601))
in (FStar_Syntax_Syntax.mk uu____8600))
in (uu____8597 FStar_Pervasives_Native.None se.FStar_Syntax_Syntax.sigrng))
in (check_term1 l univs1 t))
end
| FStar_Syntax_Syntax.Sig_datacon (l, univs1, t, uu____8621, uu____8622, uu____8623) -> begin
...
let uu____8632 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_List.contains FStar_Syntax_Syntax.Private))
in (not (uu____8632)))
...
| FStar_Syntax_Syntax.Sig_let ((uu____8636, lbs), uu____8638) -> begin
(

let uu____8653 = (

let uu____8654 = (FStar_All.pipe_right se.FStar_Syntax_Syntax.sigquals (FStar_List.contains FStar_Syntax_Syntax.Private))
in (not (uu____8654)))
...
| FStar_Syntax_Syntax.Sig_main (uu____8681) -> begin
()
end
| FStar_Syntax_Syntax.Sig_assume (uu____8682) -> begin
()
end
| FStar_Syntax_Syntax.Sig_new_effect (uu____8689) -> begin
()
end
| FStar_Syntax_Syntax.Sig_new_effect_for_free (uu____8690) -> begin
()
end
| FStar_Syntax_Syntax.Sig_sub_effect (uu____8691) -> begin
()
end
| FStar_Syntax_Syntax.Sig_pragma (uu____8692) -> begin
()
end))
...
let uu___137_8711 = modul
in {FStar_Syntax_Syntax.name = uu___137_8711.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = uu___137_8711.FStar_Syntax_Syntax.declarations; FStar_Syntax_Syntax.exports = exports; FStar_Syntax_Syntax.is_interface = modul.FStar_Syntax_Syntax.is_interface})
in (
...
let uu____8715 = (FStar_Options.lax ())
in (not (uu____8715)))
...
let uu____8722 = (FStar_Options.interactive ())
in (not (uu____8722)))
in (match (uu____8721) with
| true -> begin
(

let uu____8723 = (FStar_Options.restore_cmd_line_options true)
in (FStar_All.pipe_right uu____8723 FStar_Pervasives.ignore))
end
| uu____8724 -> begin
()
end));
...
let uu____8737 = (tc_partial_modul env modul)
...
let uu____8770 = (FStar_Options.debug_any ())
in (match (uu____8770) with
| true -> begin
(

let uu____8771 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
...
let uu___138_8775 = env
in (

let uu____8776 = (

let uu____8777 = (FStar_Options.should_verify m.FStar_Syntax_Syntax.name.FStar_Ident.str)
in (not (uu____8777)))
in {FStar_TypeChecker_Env.solver = uu___138_8775.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___138_8775.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___138_8775.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___138_8775.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___138_8775.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___138_8775.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___138_8775.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___138_8775.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___138_8775.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___138_8775.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___138_8775.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___138_8775.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___138_8775.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___138_8775.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___138_8775.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___138_8775.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___138_8775.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___138_8775.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = uu____8776; FStar_TypeChecker_Env.lax_universes = uu___138_8775.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___138_8775.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.type_of = uu___138_8775.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___138_8775.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___138_8775.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___138_8775.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___138_8775.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___138_8775.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___138_8775.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___138_8775.FStar_TypeChecker_Env.identifier_info}))
in (

let uu____8778 = (tc_modul env1 m)
in (match (uu____8778) with
| (m1, env2) -> begin
((

let uu____8790 = (FStar_Options.dump_module m1.FStar_Syntax_Syntax.name.FStar_Ident.str)
in (match (uu____8790) with
| true -> begin
(

let uu____8791 = (FStar_Syntax_Print.modul_to_string m1)
in (FStar_Util.print1 "%s\n" uu____8791))
end
| uu____8792 -> begin
()
...
let uu____8794 = ((FStar_Options.dump_module m1.FStar_Syntax_Syntax.name.FStar_Ident.str) && (FStar_Options.debug_at_level m1.FStar_Syntax_Syntax.name.FStar_Ident.str (FStar_Options.Other ("Normalize"))))
...
let uu____8825 = (FStar_Syntax_Subst.open_univ_vars lb.FStar_Syntax_Syntax.lbunivs lb.FStar_Syntax_Syntax.lbdef)
in (match (uu____8825) with
| (univnames1, e) -> begin
(

let uu___139_8832 = lb
in (

let uu____8833 = (

let uu____8836 = (FStar_TypeChecker_Env.push_univ_vars env2 univnames1)
in (n1 uu____8836 e))
in {FStar_Syntax_Syntax.lbname = uu___139_8832.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___139_8832.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___139_8832.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___139_8832.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____8833}))
end)))
in (

let uu___140_8837 = se
in (
...
let uu____8853 = (FStar_List.map update lbs)
in ((b), (uu____8853)))
in ((uu____8846), (ids)))
in FStar_Syntax_Syntax.Sig_let (uu____8839))
in {FStar_Syntax_Syntax.sigel = uu____8838; FStar_Syntax_Syntax.sigrng = uu___140_8837.FStar_Syntax_Syntax.sigrng; FStar_Syntax_Syntax.sigquals = uu___140_8837.FStar_Syntax_Syntax.sigquals; FStar_Syntax_Syntax.sigmeta = uu___140_8837.FStar_Syntax_Syntax.sigmeta; FStar_Syntax_Syntax.sigattrs = uu___140_8837.FStar_Syntax_Syntax.sigattrs}))))
end
| uu____8866 -> begin
se
end))
...
let uu___141_8868 = m1
in (

let uu____8869 = (FStar_List.map normalize_toplevel_lets m1.FStar_Syntax_Syntax.declarations)
in {FStar_Syntax_Syntax.name = uu___141_8868.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = uu____8869; FStar_Syntax_Syntax.exports = uu___141_8868.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___141_8868.FStar_Syntax_Syntax.is_interface}))
in (

let uu____8870 = (FStar_Syntax_Print.modul_to_string normalized_module)
in (FStar_Util.print1 "%s\n" uu____8870))))
end
| uu____8871 -> begin
()
