           ...
           let uu____4862 =
             let uu____4869 =
               FStar_TypeChecker_Env.lookup_effect_lid env1
                 sub1.FStar_Syntax_Syntax.source in
             monad_signature env1 sub1.FStar_Syntax_Syntax.source uu____4869 in
                ...
                (match uu____4884 with
                 | (b,wp_b_tgt) ->
                     ...
                     let expected_k =
                       ...
                       let uu____4934 = FStar_Syntax_Syntax.mk_Total wp_a_tgt in
           ...
           ((let uu____5613 = FStar_TypeChecker_Env.lid_exists env2 lid in
            ...
            (let uu____5621 =
               ...
               then
                 ...
                 (let uu____5629 = FStar_Syntax_Subst.open_univ_vars uvs t in
            ...
            | (e1,c,g1) ->
                let uu____5711 =
                  ...
                  FStar_TypeChecker_TcTerm.check_expected_effect env3
                    uu____5718 uu____5722 in
                (match uu____5711 with
                 | (e2,uu____5737,g) ->
                     ((let uu____5740 = FStar_TypeChecker_Rel.conj_guard g1 g in
           ...
           let check_quals_eq l qopt q =
             ...
             | FStar_Pervasives_Native.Some q' ->
                 ...
                 then FStar_Pervasives_Native.Some q
                   ...
                   (let uu____5801 =
                      let uu____5806 =
                        let uu____5807 = FStar_Syntax_Print.lid_to_string l in
                        let uu____5808 = FStar_Syntax_Print.quals_to_string q in
                        let uu____5809 =
                      ...
                      (FStar_Errors.Fatal_InconsistentQualifierAnnotation,
                        uu____5806) in
                    FStar_Errors.raise_error uu____5801 r) in
                                  ...
                                  (let uu____6334 =
                                     FStar_Syntax_Syntax.mk_lb
                                       ((FStar_Util.Inr lbname), uvs,
                                         ...
                                         tval, def) in
                                   (false, uu____6334, quals_opt1))) in
                     ...
                     (FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs1)
                                         ...
                                         let uu____6657 =
                                           let uu____6658 =
                                             let uu____6661 =
                                               FStar_Util.right
                                                 lb.FStar_Syntax_Syntax.lbname in
                                             uu____6661.FStar_Syntax_Syntax.fv_name in
                                           uu____6658.FStar_Syntax_Syntax.v in
                      ...
                      (let reified_tactic_type l t =
                                      ...
                                      let uu____6776 =
                                        let uu____6789 =
                                          FStar_Syntax_Subst.close_comp bs1
                                            c' in
                                        (bs1, uu____6789) in
                                      FStar_Syntax_Syntax.Tm_arrow uu____6776 in
                                    {
                         ...
                         | FStar_Syntax_Syntax.Tm_app (h,args) ->
                             let uu____6813 =
                               let uu____6814 = FStar_Syntax_Subst.compress h in
                                  ...
                                  let h'' =
                                    let uu____6824 =
                                      FStar_Syntax_Syntax.lid_as_fv
                                        ...
                                        FStar_Pervasives_Native.None in
                                    FStar_All.pipe_left
                                      FStar_Syntax_Syntax.fv_to_tm uu____6824 in
                                  let uu____6825 =
                                    let uu____6826 =
                                   ...
                                   | FStar_Syntax_Syntax.Tm_app (h,args) ->
                                       ...
                                       let tac_lid =
                                         let uu____7010 =
                                           ...
                                           uu____7013.FStar_Syntax_Syntax.fv_name in
                                       ...
                                       let assm_lid =
                                         ...
                                         FStar_Ident.lid_of_ns_and_id
                                           tac_lid.FStar_Ident.ns uu____7015 in
                                       let uu____7016 =
                         ...
                         FStar_List.fold_left
                           (fun s  ->
                              fun se1  ->
                                ...
                                Prims.strcat s uu____7924) "" ses'1 in
        ...
        | (uu____8180,uu____8181,env1,uu____8183) ->
            let uu____8196 =
              FStar_Util.record_time
                (fun uu____8242  -> process_one_decl acc se) in
          ...
          | (univs2,t1) ->
              ((let uu____8530 =
               ...
               (let env2 = FStar_TypeChecker_Env.push_univ_vars env1 univs2 in
                ...
                FStar_All.pipe_right uu____8549 FStar_Pervasives.ignore)) in
        ...
        fun exports  ->
          ...
          (let uu____8732 =
             (let uu____8735 = FStar_Options.lax () in
              Prims.op_Negation uu____8735) && must_check_exports in
