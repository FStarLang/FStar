...
| FStar_Const.Const_int (_57_803, Some (FStar_Const.Unsigned, FStar_Const.Int8)) -> begin
FStar_TypeChecker_Common.t_uint8
end
| FStar_Const.Const_int (_57_811, Some (FStar_Const.Signed, FStar_Const.Int8)) -> begin
FStar_TypeChecker_Common.t_int8
end
| FStar_Const.Const_int (_57_819, Some (FStar_Const.Unsigned, FStar_Const.Int16)) -> begin
FStar_TypeChecker_Common.t_uint16
end
| FStar_Const.Const_int (_57_827, Some (FStar_Const.Signed, FStar_Const.Int16)) -> begin
FStar_TypeChecker_Common.t_int16
end
| FStar_Const.Const_int (_57_835, Some (FStar_Const.Unsigned, FStar_Const.Int32)) -> begin
FStar_TypeChecker_Common.t_uint32
end
| FStar_Const.Const_int (_57_843, Some (FStar_Const.Signed, FStar_Const.Int32)) -> begin
FStar_TypeChecker_Common.t_int32
end
| FStar_Const.Const_int (_57_851, Some (FStar_Const.Unsigned, FStar_Const.Int64)) -> begin
FStar_TypeChecker_Common.t_uint64
end
| FStar_Const.Const_int (_57_859, Some (FStar_Const.Signed, FStar_Const.Int64)) -> begin
FStar_TypeChecker_Common.t_int64
end
| FStar_Const.Const_string (_57_867) -> begin
FStar_TypeChecker_Common.t_string
end
| FStar_Const.Const_float (_57_870) -> begin
FStar_TypeChecker_Common.t_float
end
| FStar_Const.Const_char (_57_873) -> begin
FStar_TypeChecker_Common.t_char
end
| FStar_Const.Const_effect -> begin
FStar_Syntax_Util.ktype0
end
| FStar_Const.Const_range (_57_877) -> begin
...
let _57_887 = (FStar_Syntax_Util.type_u ())
in (match (_57_887) with
| (k, u) -> begin
(

let _57_892 = (tc_check_tot_or_gtot_term env t k)
...
let _57_897 = (FStar_Syntax_Util.type_u ())
in (match (_57_897) with
| (k, u) -> begin
(

let _57_902 = (tc_check_tot_or_gtot_term env t k)
...
let _57_911 = (tc_check_tot_or_gtot_term env tc FStar_Syntax_Syntax.teff)
in (match (_57_911) with
| (tc, _57_909, f) -> begin
(

let _57_915 = (FStar_Syntax_Util.head_and_args tc)
in (match (_57_915) with
| (_57_913, args) -> begin
(

let _57_918 = (let _147_341 = (FStar_List.hd args)
...
let _57_934 = (let _147_343 = (FStar_All.pipe_right c.FStar_Syntax_Syntax.flags (FStar_List.map (fun _57_5 -> (match (_57_5) with
| FStar_Syntax_Syntax.DECREASES (e) -> begin
(

let _57_925 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (_57_925) with
| (env, _57_924) -> begin
(

let _57_930 = (tc_tot_or_gtot_term env e)
...
let _57_941 = c
in {FStar_Syntax_Syntax.effect_name = _57_941.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = (Prims.fst res); FStar_Syntax_Syntax.effect_args = args; FStar_Syntax_Syntax.flags = _57_941.FStar_Syntax_Syntax.flags}))
...
in (match (u) with
| FStar_Syntax_Syntax.U_bvar (_57_949) -> begin
...
let rec aux = (fun _57_982 bs bs_expected -> (match (_57_982) with
...
let _57_1013 = (match ((imp, imp')) with
...
let _57_1030 = (match ((let _147_383 = (FStar_Syntax_Util.unmeta hd.FStar_Syntax_Syntax.sort)
...
let _57_1019 = if (FStar_TypeChecker_Env.debug env FStar_Options.High) then begin
...
let _57_1025 = (tc_tot_or_gtot_term env hd.FStar_Syntax_Syntax.sort)
...
let _57_1031 = hd
in {FStar_Syntax_Syntax.ppname = _57_1031.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _57_1031.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})
in (
...
let _57_1052 = (match (env.FStar_TypeChecker_Env.letrecs) with
| [] -> begin
()
end
| _57_1051 -> begin
...
let _57_1059 = (tc_binders env bs)
in (match (_57_1059) with
| (bs, envbody, g, _57_1058) -> begin
(

let _57_1077 = (match ((let _147_395 = (FStar_Syntax_Subst.compress body)
in _147_395.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_ascribed (e, FStar_Util.Inr (c), _57_1064) -> begin
(

let _57_1071 = (tc_comp envbody c)
...
let _57_1104 = (match (env.FStar_TypeChecker_Env.letrecs) with
| [] -> begin
()
end
| _57_1103 -> begin
...
let _57_1111 = (tc_binders env bs)
in (match (_57_1111) with
| (bs, envbody, g, _57_1110) -> begin
(

let _57_1115 = (FStar_TypeChecker_Env.clear_expected_typ envbody)
in (match (_57_1115) with
| (envbody, _57_1114) -> begin
(Some ((t, true)), bs, [], None, envbody, body, g)
end))
end)))
end
| FStar_Syntax_Syntax.Tm_refine (b, _57_1118) -> begin
(

let _57_1129 = (as_function_typ norm b.FStar_Syntax_Syntax.sort)
in (match (_57_1129) with
| (_57_1122, bs, bs', copt, env, body, g) -> begin
...
let _57_1136 = (FStar_Syntax_Subst.open_comp bs_expected c_expected)
...
let rec handle_more = (fun _57_1147 c_expected -> (match (_57_1147) with
...
let _57_1168 = (check_binders env more_bs bs_expected)
in (match (_57_1168) with
| (env, bs', more, guard', subst) -> begin
...
let _57_1176 = envbody
in {FStar_TypeChecker_Env.solver = _57_1176.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _57_1176.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _57_1176.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _57_1176.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _57_1176.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _57_1176.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _57_1176.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _57_1176.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _57_1176.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _57_1176.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _57_1176.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _57_1176.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = []; FStar_TypeChecker_Env.top_level = _57_1176.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _57_1176.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _57_1176.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _57_1176.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _57_1176.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.type_of = _57_1176.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _57_1176.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _57_1176.FStar_TypeChecker_Env.use_bv_sorts})
in (FStar_All.pipe_right letrecs (FStar_List.fold_left (fun _57_1181 _57_1184 -> (match ((_57_1181, _57_1184)) with
| ((env, letrec_binders), (l, t)) -> begin
(

let _57_1190 = (let _147_429 = (let _147_428 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (FStar_All.pipe_right _147_428 Prims.fst))
in (tc_term _147_429 t))
in (match (_57_1190) with
| (t, _57_1187, _57_1189) -> begin
(
...
let _57_1194 = x
in {FStar_Syntax_Syntax.ppname = _57_1194.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _57_1194.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t}))
...
let _57_1203 = (check_actuals_against_formals env bs bs_expected)
in (match (_57_1203) with
| (envbody, bs, g, c) -> begin
(

let _57_1206 = if (FStar_Options.should_verify env.FStar_TypeChecker_Env.curmodule.FStar_Ident.str) then begin
...
let _57_1219 = (expected_function_typ env None body)
in (match (_57_1219) with
| (_57_1211, bs, _57_1214, c_opt, envbody, body, g) -> begin
...
let _57_1223 = (FStar_TypeChecker_Env.clear_expected_typ env)
in (match (_57_1223) with
| (env, topt) -> begin
(

let _57_1227 = if (FStar_TypeChecker_Env.debug env FStar_Options.High) then begin
...
let _57_1236 = (expected_function_typ env topt body)
in (match (_57_1236) with
| (tfun_opt, bs, letrec_binders, c_opt, envbody, body, g) -> begin
(

let _57_1242 = (tc_term (

let _57_1237 = envbody
in {FStar_TypeChecker_Env.solver = _57_1237.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _57_1237.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _57_1237.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _57_1237.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _57_1237.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _57_1237.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _57_1237.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _57_1237.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _57_1237.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _57_1237.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _57_1237.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _57_1237.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _57_1237.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = _57_1237.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = use_eq; FStar_TypeChecker_Env.is_iface = _57_1237.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _57_1237.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.type_of = _57_1237.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _57_1237.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _57_1237.FStar_TypeChecker_Env.use_bv_sorts}) body)
...
let _57_1244 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Implicits"))) then begin
...
let _57_1251 = (let _147_437 = (let _147_436 = (cbody.FStar_Syntax_Syntax.comp ())
in (body, _147_436))
in (check_expected_effect (

let _57_1246 = envbody
in {FStar_TypeChecker_Env.solver = _57_1246.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _57_1246.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _57_1246.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _57_1246.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _57_1246.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _57_1246.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _57_1246.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _57_1246.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _57_1246.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _57_1246.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _57_1246.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _57_1246.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _57_1246.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _57_1246.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _57_1246.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = use_eq; FStar_TypeChecker_Env.is_iface = _57_1246.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _57_1246.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.type_of = _57_1246.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _57_1246.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _57_1246.FStar_TypeChecker_Env.use_bv_sorts}) c_opt _147_437))
...
let _57_1274 = (match (tfun_opt) with
| Some (t, use_teq) -> begin
(

let t = (FStar_Syntax_Subst.compress t)
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_arrow (_57_1263) -> begin
(e, t, guard)
end
| _57_1266 -> begin
(

let _57_1269 = if use_teq then begin
...
let _57_1278 = (FStar_TypeChecker_Util.strengthen_precondition None env e (FStar_Syntax_Util.lcomp_of_comp c) guard)
in (match (_57_1278) with
| (c, g) -> begin
(e, c, g)
end)))
end))))))
...
let _57_1288 = if (FStar_TypeChecker_Env.debug env FStar_Options.High) then begin
...
let _57_1322 = (tc_term env e)
in (match (_57_1322) with
| (e, c, g_e) -> begin
(

let _57_1326 = (tc_args env tl)
in (match (_57_1326) with
...
let _57_1330 = (tc_args env args)
in (match (_57_1330) with
| (args, comps, g_args) -> begin
(

let bs = (let _147_464 = (FStar_All.pipe_right comps (FStar_List.map (fun _57_1334 -> (match (_57_1334) with
| (_57_1332, c) -> begin
...
| FStar_Syntax_Syntax.Tm_type (_57_1346) -> begin
...
let _57_1355 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) FStar_Options.Extreme) then begin
...
let _57_1357 = (let _147_488 = (FStar_TypeChecker_Rel.teq env tf bs_cres)
...
in (FStar_List.fold_right (fun _57_1361 out -> (match (_57_1361) with
| (r1, c) -> begin
...
let _57_1370 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_57_1370) with
| (bs, c) -> begin
(

let rec tc_args = (fun _57_1378 bs cres args -> (match (_57_1378) with
| (subst, outargs, arg_rets, comps, g, fvs) -> begin
(match ((bs, args)) with
| (((x, Some (FStar_Syntax_Syntax.Implicit (_57_1385))))::rest, ((_57_1393, None))::_57_1391) -> begin
(

let t = (FStar_Syntax_Subst.subst subst x.FStar_Syntax_Syntax.sort)
in (

let _57_1399 = (check_no_escape (Some (head)) env fvs t)
in (

let _57_1405 = (FStar_TypeChecker_Util.new_implicit_var "Instantiating implicit argument in application" head.FStar_Syntax_Syntax.pos env t)
in (match (_57_1405) with
| (varg, _57_1403, implicits) -> begin
(
...
let _57_1437 = (match ((aqual, aq)) with
...
let _57_1440 = x
in {FStar_Syntax_Syntax.ppname = _57_1440.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _57_1440.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = targ})
in (

let _57_1443 = if (FStar_TypeChecker_Env.debug env FStar_Options.Extreme) then begin
...
let _57_1445 = (check_no_escape (Some (head)) env fvs targ)
in (
...
let _57_1448 = env
in {FStar_TypeChecker_Env.solver = _57_1448.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _57_1448.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _57_1448.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _57_1448.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _57_1448.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _57_1448.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _57_1448.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _57_1448.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _57_1448.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _57_1448.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _57_1448.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _57_1448.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _57_1448.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _57_1448.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _57_1448.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = (is_eq aqual); FStar_TypeChecker_Env.is_iface = _57_1448.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _57_1448.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.type_of = _57_1448.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _57_1448.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _57_1448.FStar_TypeChecker_Env.use_bv_sorts})
in (

let _57_1451 = if (FStar_TypeChecker_Env.debug env FStar_Options.High) then begin
...
let _57_1463 = (((e.FStar_Syntax_Syntax.pos, Some (x), c))::comps, g)
...
let _57_1470 = (check_no_escape (Some (head)) env fvs cres.FStar_Syntax_Syntax.res_typ)
in (

let _57_1490 = (match (bs) with
| [] -> begin
(
...
let refine_with_equality = ((FStar_Syntax_Util.is_pure_or_ghost_lcomp cres) && (FStar_All.pipe_right comps (FStar_Util.for_some (fun _57_1480 -> (match (_57_1480) with
| (_57_1476, _57_1478, c) -> begin
...
let _57_1482 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _57_1491 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let comp = (FStar_List.fold_left (fun out _57_1497 -> (match (_57_1497) with
| (r1, x, c) -> begin
...
let _57_1503 = (FStar_TypeChecker_Util.strengthen_precondition None env app comp g)
...
let _57_1520 = (FStar_Syntax_Subst.open_comp bs cres')
in (match (_57_1520) with
| (bs, cres') -> begin
(
...
let _57_1638 = (let _147_604 = (FStar_All.pipe_right exps (FStar_List.map (fun e -> (
...
let _57_1616 = (let _147_587 = (FStar_TypeChecker_Rel.discharge_guard env (
...
in (FStar_All.pipe_right _147_591 (FStar_List.map (fun _57_1624 -> (match (_57_1624) with
| (u, _57_1623) -> begin
...
let _57_1632 = if (let _147_593 = (FStar_Util.set_is_subset_of uvs1 uvs2)
...
in (let _147_597 = (let _147_596 = (FStar_All.pipe_right unresolved (FStar_List.map (fun _57_1631 -> (match (_57_1631) with
| (u, _57_1630) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end))))
...
let _57_1645 = (let _147_605 = (FStar_TypeChecker_Env.push_bv env scrutinee)
...
let _57_1658 = (let _147_606 = (FStar_TypeChecker_Env.set_expected_typ pat_env FStar_TypeChecker_Common.t_bool)
...
let sub_term_guards = (let _147_658 = (FStar_All.pipe_right args (FStar_List.mapi (fun i _57_1785 -> (match (_57_1785) with
| (ei, _57_1784) -> begin
(
...
let _57_1839 = (let _147_674 = (let _147_673 = (let _147_672 = (let _147_671 = (c1.FStar_Syntax_Syntax.comp ())
...
let _57_1848 = if (FStar_Options.warn_top_level_effects ()) then begin
...
let _57_1880 = (let _147_683 = (let _147_682 = (FStar_TypeChecker_Env.clear_expected_typ env)
...
let _57_1887 = (let _147_685 = (let _147_684 = (FStar_Syntax_Syntax.mk_binder x)
in (_147_684)::[])
...
let _57_1893 = (let _147_686 = (FStar_TypeChecker_Env.push_bv env x)
...
let _57_2046 = (let _147_726 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (

let _57_2040 = (let _147_725 = (FStar_TypeChecker_Env.set_expected_typ env lb.FStar_Syntax_Syntax.lbtyp)
...
let _57_2072 = (let _147_733 = (FStar_TypeChecker_Env.set_range env1 e1.FStar_Syntax_Syntax.pos)
...
let _57_2285 = (open_effect_signature env ed.FStar_Syntax_Syntax.mname ed.FStar_Syntax_Syntax.signature)
in (match (_57_2285) with
| (a, wp) -> begin
(
...
in {FStar_Syntax_Syntax.qualifiers = _57_2296.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _57_2296.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = _57_2296.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = _57_2296.FStar_Syntax_Syntax.binders; FStar_Syntax_Syntax.signature = _57_2296.FStar_Syntax_Syntax.signature; FStar_Syntax_Syntax.ret = _147_855; FStar_Syntax_Syntax.bind_wp = _147_854; FStar_Syntax_Syntax.if_then_else = _147_853; FStar_Syntax_Syntax.ite_wp = _147_852; FStar_Syntax_Syntax.wp_binop = _147_851; FStar_Syntax_Syntax.wp_as_type = _147_850; FStar_Syntax_Syntax.close_wp = _147_849; FStar_Syntax_Syntax.assert_p = _147_848; FStar_Syntax_Syntax.assume_p = _147_847; FStar_Syntax_Syntax.null_wp = _147_846; FStar_Syntax_Syntax.trivial = _147_845}))))))))))))))
end)
in (ed, a, wp))
end)))
...
and visit_binder = (fun _57_2337 -> (match (_57_2337) with
| (bv, a) -> begin
(let _147_881 = (

let _57_2338 = bv
in (let _147_879 = (visit_term bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _57_2338.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _57_2338.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _147_879}))
...
let _57_2352 = comp
in {FStar_Syntax_Syntax.n = n; FStar_Syntax_Syntax.tk = _57_2352.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _57_2352.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _57_2352.FStar_Syntax_Syntax.vars})))
and visit_args = (fun args -> (FStar_List.map (fun _57_2357 -> (match (_57_2357) with
| (tm, q) -> begin
...
let _57_2361 = (let _147_897 = (FStar_Syntax_Print.term_to_string t)
...
let _57_2376 = (tc_term env t)
in (match (_57_2376) with
| (e, {FStar_Syntax_Syntax.eff_name = _57_2372; FStar_Syntax_Syntax.res_typ = res_typ; FStar_Syntax_Syntax.cflags = _57_2369; FStar_Syntax_Syntax.comp = _57_2367}, _57_2375) -> begin
(

let _57_2377 = (let _147_900 = (let _147_899 = (normalize res_typ)
...
| FStar_Syntax_Syntax.Tm_type (_57_2391) -> begin
[]
end
| _57_2394 -> begin
...
in (FStar_Syntax_Util.arrow wp_binders _147_922))), (fun _57_2399 -> (match (()) with
| () -> begin
(FStar_List.map (fun _57_2403 -> (match (_57_2403) with
| (bv, _57_2402) -> begin
(

let _57_2404 = (let _147_926 = ((FStar_ST.read i) + 1)
...
let binders_of_list = (FStar_List.map (fun _57_2412 -> (match (_57_2412) with
| (t, b) -> begin
...
let _57_2424 = (let _147_954 = (let _147_953 = (let _147_952 = (let _147_951 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_951)::[])
...
let _57_2436 = (let _147_981 = (let _147_980 = (let _147_979 = (let _147_978 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_978)::[])
...
let _57_2446 = (let _147_1010 = (let _147_1009 = (let _147_1008 = (let _147_1007 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1007)::[])
...
let _57_2457 = (let _147_1051 = (let _147_1050 = (let _147_1049 = (let _147_1048 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1048)::[])
...
let _57_2468 = (let _147_1083 = (let _147_1082 = (let _147_1081 = (let _147_1080 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1080)::[])
...
let _57_2475 = (let _147_1098 = (FStar_Syntax_Util.abs binders wp_if_then_else None)
...
let _57_2482 = (let _147_1117 = (FStar_Syntax_Util.abs binders wp_binop None)
...
let _57_2490 = (let _147_1133 = (FStar_Syntax_Util.abs binders wp_assert None)
...
let _57_2498 = (let _147_1149 = (FStar_Syntax_Util.abs binders wp_assume None)
...
let _57_2507 = (let _147_1171 = (FStar_Syntax_Util.abs binders wp_close None)
...
in {FStar_Syntax_Syntax.n = _147_1213; FStar_Syntax_Syntax.tk = _57_2555.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _57_2555.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _57_2555.FStar_Syntax_Syntax.vars}))
in (mk_leq t x y))
end
...
let _57_2567 = (let _147_1220 = (let _147_1219 = (let _147_1218 = (let _147_1217 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1217)::[])
...
let _57_2595 = ed
in {FStar_Syntax_Syntax.qualifiers = _57_2595.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _57_2595.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = _57_2595.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = signature; FStar_Syntax_Syntax.ret = _57_2595.FStar_Syntax_Syntax.ret; FStar_Syntax_Syntax.bind_wp = _57_2595.FStar_Syntax_Syntax.bind_wp; FStar_Syntax_Syntax.if_then_else = _57_2595.FStar_Syntax_Syntax.if_then_else; FStar_Syntax_Syntax.ite_wp = _57_2595.FStar_Syntax_Syntax.ite_wp; FStar_Syntax_Syntax.wp_binop = _57_2595.FStar_Syntax_Syntax.wp_binop; FStar_Syntax_Syntax.wp_as_type = _57_2595.FStar_Syntax_Syntax.wp_as_type; FStar_Syntax_Syntax.close_wp = _57_2595.FStar_Syntax_Syntax.close_wp; FStar_Syntax_Syntax.assert_p = _57_2595.FStar_Syntax_Syntax.assert_p; FStar_Syntax_Syntax.assume_p = _57_2595.FStar_Syntax_Syntax.assume_p; FStar_Syntax_Syntax.null_wp = _57_2595.FStar_Syntax_Syntax.null_wp; FStar_Syntax_Syntax.trivial = _57_2595.FStar_Syntax_Syntax.trivial})
in (
...
let _57_2639 = (FStar_Syntax_Util.type_u ())
...
let _57_2669 = (FStar_TypeChecker_Util.generalize_universes env0 t)
in (match (_57_2669) with
| (univs, t) -> begin
(

let _57_2685 = (match ((let _147_1347 = (let _147_1346 = (FStar_Syntax_Subst.compress t)
in _147_1346.FStar_Syntax_Syntax.n)
in (binders, _147_1347))) with
| ([], _57_2672) -> begin
([], t)
end
| (_57_2675, FStar_Syntax_Syntax.Tm_arrow (binders, c)) -> begin
...
in {FStar_Syntax_Syntax.qualifiers = _57_2692.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _57_2692.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = univs; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = signature; FStar_Syntax_Syntax.ret = _147_1363; FStar_Syntax_Syntax.bind_wp = _147_1362; FStar_Syntax_Syntax.if_then_else = _147_1361; FStar_Syntax_Syntax.ite_wp = _147_1360; FStar_Syntax_Syntax.wp_binop = _147_1359; FStar_Syntax_Syntax.wp_as_type = _147_1358; FStar_Syntax_Syntax.close_wp = _147_1357; FStar_Syntax_Syntax.assert_p = _147_1356; FStar_Syntax_Syntax.assume_p = _147_1355; FStar_Syntax_Syntax.null_wp = _147_1354; FStar_Syntax_Syntax.trivial = _147_1353}))))))))))))
in (

let _57_2695 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _57_2709 = ()
in (match (ses) with
| (FStar_Syntax_Syntax.Sig_inductive_typ (lex_t, [], [], t, _57_2738, _57_2740, [], r))::(FStar_Syntax_Syntax.Sig_datacon (lex_top, [], _t_top, _lex_t_top, 0, [], _57_2729, r1))::(FStar_Syntax_Syntax.Sig_datacon (lex_cons, [], _t_cons, _lex_t_cons, 0, [], _57_2718, r2))::[] when (((FStar_Ident.lid_equals lex_t FStar_Syntax_Const.lex_t_lid) && (FStar_Ident.lid_equals lex_top FStar_Syntax_Const.lextop_lid)) && (FStar_Ident.lid_equals lex_cons FStar_Syntax_Const.lexcons_lid)) -> begin
(
...
let _57_2788 = (warn_positivity tc r)
in (

let _57_2792 = (FStar_Syntax_Subst.open_term tps k)
in (match (_57_2792) with
| (tps, k) -> begin
(

let _57_2796 = (tc_tparams env tps)
in (match (_57_2796) with
| (tps, env_tps, us) -> begin
(

let _57_2799 = (FStar_Syntax_Util.arrow_formals k)
in (match (_57_2799) with
| (indices, t) -> begin
(

let _57_2803 = (tc_tparams env_tps indices)
in (match (_57_2803) with
| (indices, env', us') -> begin
(

let _57_2807 = (tc_trivial_guard env' t)
...
let _57_2811 = (FStar_Syntax_Util.type_u ())
in (match (_57_2811) with
| (t_type, u) -> begin
(

let _57_2812 = (let _147_1408 = (FStar_TypeChecker_Rel.teq env' t t_type)
...
let positive_if_pure = (fun _57_2821 l -> ())
in (
...
let tps_u_opt = (FStar_Util.find_map tcs (fun _57_2842 -> (match (_57_2842) with
| (se, u_tc) -> begin
...
| FStar_Syntax_Syntax.Sig_inductive_typ (_57_2844, _57_2846, tps, _57_2849, _57_2851, _57_2853, _57_2855, _57_2857) -> begin
(FStar_All.pipe_right tps (FStar_List.map (fun _57_2863 -> (match (_57_2863) with
| (x, _57_2862) -> begin
...
let _57_2893 = (match ((let _147_1425 = (FStar_Syntax_Subst.compress t)
in _147_1425.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, res) -> begin
(

let _57_2881 = (FStar_Util.first_N ntps bs)
in (match (_57_2881) with
| (_57_2879, bs') -> begin
(
...
let subst = (FStar_All.pipe_right tps (FStar_List.mapi (fun i _57_2887 -> (match (_57_2887) with
| (x, _57_2886) -> begin
...
let _57_2894 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _57_2899 = (tc_tparams env arguments)
in (match (_57_2899) with
| (arguments, env', us) -> begin
(

let _57_2903 = (tc_trivial_guard env' result)
in (match (_57_2903) with
| (result, _57_2902) -> begin
(

let _57_2907 = (FStar_Syntax_Util.head_and_args result)
in (match (_57_2907) with
| (head, _57_2906) -> begin
(

let _57_2912 = (match ((let _147_1432 = (FStar_Syntax_Subst.compress head)
...
let g = (FStar_List.fold_left2 (fun g _57_2918 u_x -> (match (_57_2918) with
| (x, _57_2917) -> begin
(
...
let t = (let _147_1444 = (let _147_1442 = (FStar_All.pipe_right tps (FStar_List.map (fun _57_2926 -> (match (_57_2926) with
| (x, _57_2925) -> begin
...
let _57_2935 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (

let binders = (FStar_All.pipe_right tcs (FStar_List.map (fun _57_7 -> (match (_57_7) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_57_2939, _57_2941, tps, k, _57_2945, _57_2947, _57_2949, _57_2951) -> begin
...
| FStar_Syntax_Syntax.Sig_datacon (_57_2959, _57_2961, t, _57_2964, _57_2966, _57_2968, _57_2970, _57_2972) -> begin
...
let _57_2979 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _57_2983 = (FStar_TypeChecker_Util.generalize_universes env t)
in (match (_57_2983) with
| (uvs, t) -> begin
(

let _57_2985 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _57_2989 = (FStar_Syntax_Subst.open_univ_vars uvs t)
in (match (_57_2989) with
| (uvs, t) -> begin
(

let _57_2993 = (FStar_Syntax_Util.arrow_formals t)
in (match (_57_2993) with
| (args, _57_2992) -> begin
(

let _57_2996 = (FStar_Util.first_N (FStar_List.length binders) args)
in (match (_57_2996) with
| (tc_types, data_types) -> begin
(

let tcs = (FStar_List.map2 (fun _57_3000 se -> (match (_57_3000) with
| (x, _57_2999) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (tc, _57_3004, tps, _57_3007, mutuals, datas, quals, r) -> begin
(

let ty = (FStar_Syntax_Subst.close_univ_vars uvs x.FStar_Syntax_Syntax.sort)
in (

let _57_3030 = (match ((let _147_1465 = (FStar_Syntax_Subst.compress ty)
in _147_1465.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, c) -> begin
(

let _57_3021 = (FStar_Util.first_N (FStar_List.length tps) binders)
in (match (_57_3021) with
| (tps, rest) -> begin
(
...
| FStar_Syntax_Syntax.Sig_inductive_typ (tc, _57_3041, _57_3043, _57_3045, _57_3047, _57_3049, _57_3051, _57_3053) -> begin
(tc, uvs_universes)
end
| _57_3057 -> begin
(FStar_All.failwith "Impossible")
end))))
in (FStar_List.map2 (fun _57_3062 d -> (match (_57_3062) with
| (t, _57_3061) -> begin
(match (d) with
| FStar_Syntax_Syntax.Sig_datacon (l, _57_3066, _57_3068, tc, ntps, quals, mutuals, r) -> begin
(
...
let _57_3088 = (FStar_All.pipe_right ses (FStar_List.partition (fun _57_10 -> (match (_57_10) with
| FStar_Syntax_Syntax.Sig_inductive_typ (_57_3082) -> begin
true
end
| _57_3085 -> begin
false
...
let _57_3105 = (FStar_List.fold_right (fun tc _57_3094 -> (match (_57_3094) with
| (env, all_tcs, g) -> begin
(

let _57_3098 = (tc_tycon env tc)
...
let _57_3100 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _57_3115 = (FStar_List.fold_right (fun se _57_3109 -> (match (_57_3109) with
| (datas, g) -> begin
(

let _57_3112 = (tc_data env tcs se)
...
let _57_3118 = (let _147_1480 = (FStar_List.map Prims.fst tcs)
...
let _57_3156 = (set_options FStar_Options.Set o)
in (se, env))
end
| FStar_Syntax_Syntax.ResetOptions (sopt) -> begin
(

let _57_3160 = (let _147_1493 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _147_1493 Prims.ignore))
in (

let _57_3165 = (match (sopt) with
| None -> begin
()
end
| Some (s) -> begin
...
let _57_3167 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
in (se, env))))
end))
end
...
let _57_3189 = (let _147_1494 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _147_1494))
in (match (_57_3189) with
| (a, wp_a_src) -> begin
(

let _57_3192 = (let _147_1495 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
...
let _57_3196 = sub
in {FStar_Syntax_Syntax.source = _57_3196.FStar_Syntax_Syntax.source; FStar_Syntax_Syntax.target = _57_3196.FStar_Syntax_Syntax.target; FStar_Syntax_Syntax.lift = lift})
in (
...
let _57_3215 = (FStar_Syntax_Subst.open_comp tps c)
in (match (_57_3215) with
| (tps, c) -> begin
(

let _57_3219 = (tc_tparams env tps)
in (match (_57_3219) with
| (tps, env, us) -> begin
(

let _57_3223 = (tc_comp env c)
in (match (_57_3223) with
| (c, u, g) -> begin
(

let _57_3224 = (FStar_TypeChecker_Rel.force_trivial_guard env g)
in (
...
let _57_3230 = (let _147_1505 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((tps, c))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _147_1505))
in (match (_57_3230) with
| (uvs, t) -> begin
(

let _57_3249 = (match ((let _147_1507 = (let _147_1506 = (FStar_Syntax_Subst.compress t)
in _147_1506.FStar_Syntax_Syntax.n)
in (tps, _147_1507))) with
| ([], FStar_Syntax_Syntax.Tm_arrow (_57_3233, c)) -> begin
([], c)
end
| (_57_3239, FStar_Syntax_Syntax.Tm_arrow (tps, c)) -> begin
(tps, c)
end
| _57_3246 -> begin
(FStar_All.failwith "Impossible")
...
let _57_3264 = (let _147_1509 = (let _147_1508 = (FStar_Syntax_Util.type_u ())
...
let _57_3277 = (FStar_Syntax_Util.type_u ())
...
let _57_3279 = (FStar_TypeChecker_Util.check_uvars r phi)
in (
...
let _57_3292 = (tc_term env e)
in (match (_57_3292) with
| (e, c, g1) -> begin
(

let _57_3297 = (let _147_1514 = (let _147_1511 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_147_1511))
...
let _57_3298 = (let _147_1515 = (FStar_TypeChecker_Rel.conj_guard g1 g)
...
let _57_3342 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.fold_left (fun _57_3319 lb -> (match (_57_3319) with
...
let _57_3338 = (match ((FStar_TypeChecker_Env.try_lookup_val_decl env lbname.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)) with
| None -> begin
(gen, lb, quals_opt)
end
...
let _57_3333 = (match (lb.FStar_Syntax_Syntax.lbtyp.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_unknown -> begin
()
end
| _57_3332 -> begin
...
let _57_3385 = (match ((tc_maybe_toplevel_term (

let _57_3355 = env
in {FStar_TypeChecker_Env.solver = _57_3355.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _57_3355.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _57_3355.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _57_3355.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _57_3355.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _57_3355.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _57_3355.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _57_3355.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _57_3355.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _57_3355.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _57_3355.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = should_generalize; FStar_TypeChecker_Env.letrecs = _57_3355.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = true; FStar_TypeChecker_Env.check_uvars = _57_3355.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _57_3355.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _57_3355.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _57_3355.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.type_of = _57_3355.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _57_3355.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _57_3355.FStar_TypeChecker_Env.use_bv_sorts}) e)) with
| ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_let (lbs, e); FStar_Syntax_Syntax.tk = _57_3362; FStar_Syntax_Syntax.pos = _57_3360; FStar_Syntax_Syntax.vars = _57_3358}, _57_3369, g) when (FStar_TypeChecker_Rel.is_trivial g) -> begin
(

let quals = (match (e.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_meta (_57_3373, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Masked_effect)) -> begin
...
in (match (_57_3385) with
| (se, lbs) -> begin
(

let _57_3391 = if (log env) then begin
...
in (match (se) with
| FStar_Syntax_Syntax.Sig_pragma (_57_3413) -> begin
([], hidden)
end
| (FStar_Syntax_Syntax.Sig_inductive_typ (_)) | (FStar_Syntax_Syntax.Sig_datacon (_)) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Syntax_Syntax.Sig_bundle (ses, quals, _57_3424, _57_3426) -> begin
if (is_abstract quals) then begin
(FStar_List.fold_right (fun se _57_3432 -> (match (_57_3432) with
| (out, hidden) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, us, bs, t, _57_3438, _57_3440, quals, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_datacon (l, us, t, _57_3450, _57_3452, _57_3454, _57_3456, r) -> begin
(
...
| FStar_Syntax_Syntax.Sig_assume (_57_3464, _57_3466, quals, _57_3469) -> begin
if (is_abstract quals) then begin
([], hidden)
end else begin
((se)::[], hidden)
...
| FStar_Syntax_Syntax.Sig_main (_57_3490) -> begin
([], hidden)
end
| (FStar_Syntax_Syntax.Sig_new_effect (_)) | (FStar_Syntax_Syntax.Sig_new_effect_for_free (_)) | (FStar_Syntax_Syntax.Sig_sub_effect (_)) | (FStar_Syntax_Syntax.Sig_effect_abbrev (_)) -> begin
((se)::[], hidden)
end
| FStar_Syntax_Syntax.Sig_let ((false, (lb)::[]), _57_3509, _57_3511, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some is_hidden_proj_or_disc)) -> begin
(
...
let _57_3550 = (FStar_All.pipe_right ses (FStar_List.fold_left (fun _57_3531 se -> (match (_57_3531) with
| (ses, exports, env, hidden) -> begin
(

let _57_3533 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
...
let _57_3537 = (tc_decl env se)
in (match (_57_3537) with
| (se, env) -> begin
(

let _57_3538 = if ((FStar_Options.log_types ()) || (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("LogTypes")))) then begin
...
let _57_3540 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_sig env se)
in (

let _57_3544 = (for_export hidden se)
...
| (ses, exports, env, _57_3549) -> begin
...
in {FStar_TypeChecker_Env.solver = _57_3555.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _57_3555.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _57_3555.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _57_3555.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _57_3555.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _57_3555.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _57_3555.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _57_3555.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _57_3555.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _57_3555.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _57_3555.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _57_3555.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _57_3555.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _57_3555.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _57_3555.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _57_3555.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = modul.FStar_Syntax_Syntax.is_interface; FStar_TypeChecker_Env.admit = _147_1579; FStar_TypeChecker_Env.type_of = _57_3555.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _57_3555.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _57_3555.FStar_TypeChecker_Env.use_bv_sorts}))
in (

let _57_3558 = if (not ((FStar_Ident.lid_equals modul.FStar_Syntax_Syntax.name FStar_Syntax_Const.prims_lid))) then begin
...
let _57_3564 = (tc_decls env modul.FStar_Syntax_Syntax.declarations)
in (match (_57_3564) with
| (ses, exports, env) -> begin
((

let _57_3565 = modul
in {FStar_Syntax_Syntax.name = _57_3565.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = ses; FStar_Syntax_Syntax.exports = _57_3565.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _57_3565.FStar_Syntax_Syntax.is_interface}), exports, env)
end))))))))


let tc_more_partial_modul : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.modul  ->  FStar_Syntax_Syntax.sigelt Prims.list  ->  (FStar_Syntax_Syntax.modul * FStar_Syntax_Syntax.sigelt Prims.list * FStar_TypeChecker_Env.env) = (fun env modul decls -> (

let _57_3573 = (tc_decls env decls)
...
let _57_3574 = modul
in {FStar_Syntax_Syntax.name = _57_3574.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = (FStar_List.append modul.FStar_Syntax_Syntax.declarations ses); FStar_Syntax_Syntax.exports = _57_3574.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = _57_3574.FStar_Syntax_Syntax.is_interface})
...
let _57_3580 = modul
in {FStar_Syntax_Syntax.name = _57_3580.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = _57_3580.FStar_Syntax_Syntax.declarations; FStar_Syntax_Syntax.exports = exports; FStar_Syntax_Syntax.is_interface = modul.FStar_Syntax_Syntax.is_interface})
in (

let env = (FStar_TypeChecker_Env.finish_module env modul)
in (

let _57_3590 = if (not ((FStar_Ident.lid_equals modul.FStar_Syntax_Syntax.name FStar_Syntax_Const.prims_lid))) then begin
(

let _57_3584 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.pop (Prims.strcat "Ending modul " modul.FStar_Syntax_Syntax.name.FStar_Ident.str))
in (

let _57_3586 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.encode_modul env modul)
in (

let _57_3588 = (env.FStar_TypeChecker_Env.solver.FStar_TypeChecker_Env.refresh ())
...
let _57_3597 = (tc_partial_modul env modul)
...
let _57_3600 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("RelCheck"))) then begin
...
let _57_3602 = env
in {FStar_TypeChecker_Env.solver = _57_3602.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _57_3602.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _57_3602.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _57_3602.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _57_3602.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _57_3602.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = _57_3602.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = _57_3602.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _57_3602.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _57_3602.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _57_3602.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _57_3602.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _57_3602.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = false; FStar_TypeChecker_Env.check_uvars = _57_3602.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _57_3602.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _57_3602.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _57_3602.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.type_of = _57_3602.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _57_3602.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = _57_3602.FStar_TypeChecker_Env.use_bv_sorts})
in (
...
with
| FStar_Syntax_Syntax.Error (msg, _57_3610) -> begin
...
let _57_3621 = if (FStar_Options.debug_any ()) then begin
...
let _57_3625 = (tc_modul env m)
in (match (_57_3625) with
| (m, env) -> begin
(

let _57_3626 = if (FStar_Options.dump_module m.FStar_Syntax_Syntax.name.FStar_Ident.str) then begin
