...
let (tc_inductive' :
  ...
  fun env ->
    fun ses ->
      fun quals ->
        fun lids ->
          (let uu____6911 = FStar_TypeChecker_Env.debug env FStar_Options.Low in
           if uu____6911
           then
             let uu____6912 =
               ...
               ((let uu____6959 =
                   (FStar_Options.no_positivity ()) ||
                     (let uu____6961 =
                      ...
                      Prims.op_Negation uu____6961) in
                 if uu____6959
                 then ()
                 else
                   (let env1 =
                      ...
                      (fun ty ->
                         ...
                         then
                           let uu____6972 =
                             ...
                             | FStar_Syntax_Syntax.Sig_inductive_typ
                                 (lid, uu____6982, uu____6983, uu____6984,
                                  uu____6985, uu____6986)
                ...
                (let skip_prims_type uu____7008 =
                   let lid =
                     ...
                     match ty.FStar_Syntax_Syntax.sigel with
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         (lid, uu____7012, uu____7013, uu____7014,
    ...
    fun ses ->
      fun quals ->
        fun lids ->
          ...
          let pop1 uu____7103 =
            let uu____7104 = FStar_TypeChecker_Env.pop env1 "tc_inductive" in
            () in
          try
            (fun uu___387_7113 ->
               match () with
           ...
           let uu____8182 =
             let uu____8189 =
               FStar_TypeChecker_Env.lookup_effect_lid env
                 sub1.FStar_Syntax_Syntax.source in
             monad_signature env sub1.FStar_Syntax_Syntax.source uu____8189 in
                ...
                (match uu____8206 with
                 | (b, wp_b_tgt) ->
                     ...
                     let expected_k =
                       ...
                       let uu____8300 = FStar_Syntax_Syntax.mk_Total wp_a_tgt in
                                          ...
                                          let expected_k1 =
                                            ...
                                            let uu____9413 =
                                              FStar_Syntax_Syntax.mk_Total
                                                repr_result in
                                            FStar_Syntax_Util.arrow
                                              uu____9341 uu____9413 in
                                          let uu____9416 =
                                            FStar_TypeChecker_TcTerm.tc_tot_or_gtot_term
                                              env2 expected_k1 in
                                          (match uu____9416 with
                                           | (expected_k2, uu____9426,
                                              uu____9427) ->
                                               let lift3 =
                                                 if
                                                   (FStar_List.length uvs) =
                              ...
                              let uu____9460 =
                                let uu____9465 =
                                  ...
                                  FStar_Util.format3
                                    ...
                                    uu____9466 uu____9467 uu____9468 in
                              ...
                              (FStar_Util.is_some lift1) &&
                                (let uu____9493 =
                                   ...
                                   FStar_All.pipe_right uu____9494
                                     FStar_List.length in
                                 uu____9493 <> (Prims.parse_int "1")) in
                            if uu____9491
                            then
                              let uu____9532 =
                                let uu____9537 =
                                  ...
                                  FStar_Util.format3
                                    ...
                                    uu____9538 uu____9539 uu____9540 in
                                (FStar_Errors.Fatal_TooManyUniverse,
                                  uu____9537) in
             ...
             then
               ...
               | (uvs1, t1) ->
                   ((let uu____10145 =
                     ...
                     if uu____10145
                     then
                       let uu____10146 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____10147 =
                         FStar_Syntax_Print.univ_names_to_string uvs1 in
                       FStar_Util.print2
                                ...
                                let uu____10324 =
                                  let uu____10325 =
                                    FStar_List.map FStar_Ident.string_of_lid
                                      lids' in
                                  FStar_All.pipe_left
                                    (FStar_String.concat ", ") uu____10325 in
                                FStar_Util.format2
                                  "Splice declared the name %s but it was not defined.\nThose defined were: %s"
                                  uu____10323 uu____10324 in
                              (FStar_Errors.Fatal_SplicedUndef, uu____10322) in
                        ...
                        (let uu____10441 =
                           let uu____10446 =
                             ...
                             FStar_Util.format3
                               ...
                               uu____10447 uu____10448 uu____10449 in
                           (FStar_Errors.Fatal_InconsistentQualifierAnnotation,
                             uu____10446) in
                         FStar_Errors.raise_error uu____10441 r)) in
                             ...
                             | FStar_Pervasives_Native.Some
                                 ...
                                 (if
                                  ...
                                  (let uu____11062 =
                                   ...
                                   (false, uu____11062, quals_opt1))) in
            ...
            | (should_generalize, lbs', quals_opt) ->
                ...
                let e1 =
                  ...
                  then
                    let drop_lbtyp e_lax =
                      let uu____11216 =
                        let uu____11217 = FStar_Syntax_Subst.compress e_lax in
                        uu____11217.FStar_Syntax_Syntax.n in
                      match uu____11216 with
                      | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), e2) ->
                          let lb_unannotated =
                            let uu____11235 =
                              let uu____11236 = FStar_Syntax_Subst.compress e in
                        ...
                        let uu____11277 =
                          ...
                          FStar_All.pipe_right uu____11278
                            (fun uu____11298 ->
                               ...
                               | (e1, uu____11306, uu____11307) -> e1) in
                ...
                let uu____11313 =
                  ...
                  | ({
                     ...
                     uu____11345, g) when FStar_TypeChecker_Env.is_trivial g
                      ->
                      let lbs2 =
                        let uu____11372 =
                          FStar_All.pipe_right
                                         ...
                                         let uu____11483 =
                                           let uu____11484 =
                                             let uu____11487 =
                                               FStar_Util.right
                                                 lb.FStar_Syntax_Syntax.lbname in
                                             uu____11487.FStar_Syntax_Syntax.fv_name in
                                           uu____11484.FStar_Syntax_Syntax.v in
...
let (tc_decl :
  ...
  fun env ->
    fun se ->
      ...
      (let uu____11545 = FStar_TypeChecker_Env.debug env1 FStar_Options.Low in
       if uu____11545
       then
           ...
           ((let uu____11599 =
             ...
             then
               let uu____11600 =
                 ...
                 FStar_All.pipe_left (FStar_String.concat "; ") uu____11601 in
               ...
               FStar_Errors.catch_errors
                 (fun uu____11637 ->
                    FStar_Options.with_saved_options
                      (fun uu____11649 -> tc_decl' env' se)) in
                       ...
                       (FStar_List.iter FStar_Errors.print_issue errs;
                        (let uu____11797 =
                           let uu____11802 =
                             ...
                             let uu____11804 = FStar_Util.string_of_int n1 in
                             let uu____11805 = FStar_Util.string_of_int n2 in
                             FStar_Util.format3
                               "This top-level definition was expected to raise Error #%s %s times, but it raised it %s times"
                               uu____11803 uu____11804 uu____11805 in
                       ...
                       let dec =
                         ...
                         let uu____12076 =
                           let uu____12077 =
                             ...
                             (l, us, uu____12084) in
                           FStar_Syntax_Syntax.Sig_declare_typ uu____12077 in
                         {
...
let (add_sigelt_to_env :
  ...
  fun env ->
    fun se ->
      (let uu____12334 = FStar_TypeChecker_Env.debug env FStar_Options.Low in
       if uu____12334
       then
                         ...
                         FStar_List.fold_left
                           (fun s ->
                              fun se1 ->
                                ...
                                Prims.strcat s uu____12616) "" ses'1 in
        ...
        | (uu____12894, uu____12895, env1, uu____12897) ->
            let uu____12910 =
              FStar_Util.record_time
                (fun uu____12956 -> process_one_decl acc se) in
             ...
             | (r, ms_elapsed) ->
                 ((let uu____13020 =
                   ...
                   then
                     ...
                     let uu____13022 = FStar_Util.string_of_int ms_elapsed in
          ...
          | (univs2, t1) ->
              ((let uu____13134 =
               ...
               (let env2 = FStar_TypeChecker_Env.push_univ_vars env1 univs2 in
                ...
                FStar_All.pipe_right uu____13157 (fun a237 -> ()))) in
    ...
    fun m ->
          ...
          | uu____13477 ->
              (match t.FStar_Syntax_Syntax.n with
               ...
               | uu____13516 ->
                   ...
                   uu____13517 FStar_Pervasives_Native.None r) in
        ...
        let c_opt =
          ...
          then
            ...
            (let uu____13668 =
             ...
             | uu____13700 -> FStar_Pervasives_Native.None) in
          ...
          (let c = FStar_All.pipe_right c_opt FStar_Util.must in
           ...
           then
             ...
             (let uu____13725 = comp_effect_name1 c in
              FStar_TypeChecker_Env.is_reifiable_effect en uu____13725)) in
      let extract_sigelt s =
        ...
        (match s.FStar_Syntax_Syntax.sigel with
                 ...
                 (FStar_List.fold_left
                    (fun sigelts1 ->
                       fun s1 ->
                         ...
                         | FStar_Syntax_Syntax.Sig_inductive_typ
                             (lid, uu____13822, uu____13823, uu____13824,
                         ...
                         | FStar_Syntax_Syntax.Sig_datacon
                             (lid, uu____13936, uu____13937, uu____13938,
         ...
         | FStar_Syntax_Syntax.Sig_assume (lid, uu____14196, uu____14197) ->
             ...
             then
               let is_haseq_of_abstract_inductive =
                 let uu____14202 = FStar_ST.op_Bang abstract_inductive_tycons in
                 FStar_List.existsML
                   (fun l ->
                      let uu____14253 =
                        FStar_TypeChecker_TcInductive.get_haseq_axiom_lid l in
                      FStar_Ident.lid_equals lid uu____14253) uu____14202 in
         ...
         | FStar_Syntax_Syntax.Sig_pragma uu____14284 -> [s]) in
    ...
    fun modul ->
      ...
      (let name =
       ...
       let env2 =
         FStar_TypeChecker_Env.set_current_module env1
           modul.FStar_Syntax_Syntax.name in
       let uu____14453 = tc_decls env2 modul.FStar_Syntax_Syntax.declarations in
        ...
        fun m ->
          fun exports ->
            let should_extract_interface =
              ((((Prims.op_Negation loading_from_cache) &&
                ...
                (let uu____14652 = FStar_Errors.get_err_count () in
                 uu____14652 = (Prims.parse_int "0")) in
            ...
            then
              ...
              (let modul =
                 let uu____14784 = FStar_Options.use_extracted_interfaces () in
                 if uu____14784
                 then
