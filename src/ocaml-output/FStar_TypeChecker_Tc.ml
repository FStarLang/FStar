...
let uu____1570 = (let _0_481 = (mk_lid name)
...
let uu____1692 = (let _0_506 = (FStar_Syntax_Subst.compress wp_type)
...
let uu____1795 = (let _0_507 = (FStar_Syntax_Subst.compress arrow)
...
in (([]), (_0_518)))
in {FStar_Syntax_Syntax.qualifiers = uu___107_1908.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.cattributes = uu___107_1908.FStar_Syntax_Syntax.cattributes; FStar_Syntax_Syntax.mname = uu___107_1908.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = uu___107_1908.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = _0_525; FStar_Syntax_Syntax.signature = _0_524; FStar_Syntax_Syntax.ret_wp = _0_523; FStar_Syntax_Syntax.bind_wp = _0_522; FStar_Syntax_Syntax.if_then_else = uu___107_1908.FStar_Syntax_Syntax.if_then_else; FStar_Syntax_Syntax.ite_wp = uu___107_1908.FStar_Syntax_Syntax.ite_wp; FStar_Syntax_Syntax.stronger = uu___107_1908.FStar_Syntax_Syntax.stronger; FStar_Syntax_Syntax.close_wp = uu___107_1908.FStar_Syntax_Syntax.close_wp; FStar_Syntax_Syntax.assert_p = uu___107_1908.FStar_Syntax_Syntax.assert_p; FStar_Syntax_Syntax.assume_p = uu___107_1908.FStar_Syntax_Syntax.assume_p; FStar_Syntax_Syntax.null_wp = uu___107_1908.FStar_Syntax_Syntax.null_wp; FStar_Syntax_Syntax.trivial = uu___107_1908.FStar_Syntax_Syntax.trivial; FStar_Syntax_Syntax.repr = _0_521; FStar_Syntax_Syntax.return_repr = _0_520; FStar_Syntax_Syntax.bind_repr = _0_519; FStar_Syntax_Syntax.actions = actions}))))))))
in (
...
let uu____2348 = (let _0_551 = (FStar_Util.must (FStar_Syntax_Util.lid_of_sigelt se))
...
let t = (let _0_565 = (let _0_563 = (FStar_All.pipe_right tps (FStar_List.map (fun uu____2621 -> (match (uu____2621) with
| (x, uu____2628) -> begin
...
let uu____3168 = (let _0_580 = (FStar_List.map Prims.fst tcs)
...
let ind = ((let _0_587 = (FStar_List.map (fun uu____3370 -> (match (uu____3370) with
| (bv, aq) -> begin
...
let ind = ((let _0_589 = (FStar_List.map (fun uu____3388 -> (match (uu____3388) with
| (bv, aq) -> begin
...
in (_0_597)::[]))
in ((fml), (_0_598))))
in {FStar_Syntax_Syntax.n = _0_599; FStar_Syntax_Syntax.tk = uu___108_3445.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___108_3445.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___108_3445.FStar_Syntax_Syntax.vars}))
in (
...
let ind = ((let _0_622 = (FStar_List.map (fun uu____3854 -> (match (uu____3854) with
| (bv, aq) -> begin
...
let ind = ((let _0_624 = (FStar_List.map (fun uu____3872 -> (match (uu____3872) with
| (bv, aq) -> begin
...
in (_0_634)::[]))
in ((fml), (_0_635))))
in {FStar_Syntax_Syntax.n = _0_636; FStar_Syntax_Syntax.tk = uu___109_4066.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___109_4066.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___109_4066.FStar_Syntax_Syntax.vars}))
in (
...
let uu____4361 = (let _0_650 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _0_650))
in (match (uu____4361) with
| (a, wp_a_src) -> begin
(

let uu____4377 = (let _0_651 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
...
let uu____4526 = (let _0_668 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
...
let uu____4632 = (let _0_681 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((tps), (c)))) None r)
...
let uu____4658 = (let _0_682 = (FStar_Syntax_Subst.compress t).FStar_Syntax_Syntax.n
in ((tps), (_0_682)))
...
let uu____4836 = (let _0_693 = Some ((FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r))
...
let uu____5186 = (let _0_701 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname).FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v
...
let uu____5870 = (let _0_715 = (FStar_TypeChecker_Env.debug (FStar_TypeChecker_Env.set_current_module env modul.FStar_Syntax_Syntax.name))
...
in {FStar_TypeChecker_Env.solver = uu___119_6072.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___119_6072.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___119_6072.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___119_6072.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___119_6072.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___119_6072.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___119_6072.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___119_6072.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___119_6072.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___119_6072.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___119_6072.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___119_6072.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___119_6072.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___119_6072.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___119_6072.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___119_6072.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___119_6072.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___119_6072.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = _0_726; FStar_TypeChecker_Env.lax_universes = uu___119_6072.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___119_6072.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___119_6072.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___119_6072.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___119_6072.FStar_TypeChecker_Env.qname_and_index}))
in (
...
in (n _0_728 e))
in {FStar_Syntax_Syntax.lbname = uu___120_6120.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___120_6120.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___120_6120.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = uu___120_6120.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _0_729}))
end)))
...
in {FStar_Syntax_Syntax.name = uu___121_6130.FStar_Syntax_Syntax.name; FStar_Syntax_Syntax.declarations = _0_732; FStar_Syntax_Syntax.exports = uu___121_6130.FStar_Syntax_Syntax.exports; FStar_Syntax_Syntax.is_interface = uu___121_6130.FStar_Syntax_Syntax.is_interface}))
