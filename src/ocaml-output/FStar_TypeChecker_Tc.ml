...
let _57_2045 = (let _147_730 = (FStar_All.pipe_right lbs (FStar_List.map (fun lb -> (

let _57_2039 = (let _147_729 = (FStar_TypeChecker_Env.set_expected_typ env lb.FStar_Syntax_Syntax.lbtyp)
...
let _57_2071 = (let _147_737 = (FStar_TypeChecker_Env.set_range env1 e1.FStar_Syntax_Syntax.pos)
...
let _57_2303 = ed
in (let _147_861 = (op ed.FStar_Syntax_Syntax.ret)
in (let _147_860 = (op ed.FStar_Syntax_Syntax.bind_wp)
in (let _147_859 = (op ed.FStar_Syntax_Syntax.bind_wlp)
in (let _147_858 = (op ed.FStar_Syntax_Syntax.if_then_else)
in (let _147_857 = (op ed.FStar_Syntax_Syntax.ite_wp)
in (let _147_856 = (op ed.FStar_Syntax_Syntax.ite_wlp)
...
in {FStar_Syntax_Syntax.qualifiers = _57_2303.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _57_2303.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = _57_2303.FStar_Syntax_Syntax.univs; FStar_Syntax_Syntax.binders = _57_2303.FStar_Syntax_Syntax.binders; FStar_Syntax_Syntax.signature = _57_2303.FStar_Syntax_Syntax.signature; FStar_Syntax_Syntax.ret = _147_861; FStar_Syntax_Syntax.bind_wp = _147_860; FStar_Syntax_Syntax.bind_wlp = _147_859; FStar_Syntax_Syntax.if_then_else = _147_858; FStar_Syntax_Syntax.ite_wp = _147_857; FStar_Syntax_Syntax.ite_wlp = _147_856; FStar_Syntax_Syntax.wp_binop = _147_855; FStar_Syntax_Syntax.wp_as_type = _147_854; FStar_Syntax_Syntax.close_wp = _147_853; FStar_Syntax_Syntax.assert_p = _147_852; FStar_Syntax_Syntax.assume_p = _147_851; FStar_Syntax_Syntax.null_wp = _147_850; FStar_Syntax_Syntax.trivial = _147_849}))))))))))))))))
end)
in (ed, a, wp))
end)))
...
let n = (match ((let _147_883 = (FStar_Syntax_Subst.compress tm)
in _147_883.FStar_Syntax_Syntax.n)) with
...
let _57_2345 = bv
in (let _147_885 = (visit_term bv.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _57_2345.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _57_2345.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _147_885}))
in (let _147_886 = (FStar_Syntax_Syntax.as_implicit false)
in (_147_887, _147_886)))
end))
and visit_maybe_lcomp = (fun lcomp -> (match (lcomp) with
| Some (FStar_Util.Inl (lcomp)) -> begin
(let _147_892 = (let _147_891 = (let _147_890 = (let _147_889 = (lcomp.FStar_Syntax_Syntax.comp ())
in (visit_comp _147_889))
in (FStar_Syntax_Util.lcomp_of_comp _147_890))
in FStar_Util.Inl (_147_891))
in Some (_147_892))
end
| comp -> begin
comp
...
in FStar_Syntax_Syntax.Total (_147_894))
end
| FStar_Syntax_Syntax.GTotal (tm) -> begin
(let _147_895 = (visit_term tm)
in FStar_Syntax_Syntax.GTotal (_147_895))
end
| comp -> begin
comp
end)
...
let _57_2368 = (let _147_903 = (FStar_Syntax_Print.term_to_string t)
...
let _57_2384 = (let _147_906 = (let _147_905 = (normalize res_typ)
in (FStar_Syntax_Print.term_to_string _147_905))
in (FStar_Util.print2 "Inferred type for %s: %s\n" str _147_906))
in (let _147_908 = (let _147_907 = (normalize e)
...
let rec collect_binders = (fun t -> (match ((let _147_911 = (FStar_Syntax_Subst.compress t)
in _147_911.FStar_Syntax_Syntax.n)) with
...
in (let _147_912 = (collect_binders rest)
in (FStar_List.append bs _147_912)))
end
...
let wp_binders = (let _147_919 = (normalize wp_a)
in (collect_binders _147_919))
in ((fun t -> (let _147_925 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow wp_binders _147_925))), (fun t -> (let _147_928 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.arrow wp_binders _147_928))), (fun _57_2406 -> (match (()) with
| () -> begin
(FStar_List.map (fun _57_2410 -> (match (_57_2410) with
| (bv, _57_2409) -> begin
(

let _57_2411 = (let _147_932 = ((FStar_ST.read i) + 1)
in (FStar_ST.op_Colon_Equals i _147_932))
in (let _147_935 = (let _147_934 = (let _147_933 = (FStar_ST.read i)
in (FStar_Util.string_of_int _147_933))
in (Prims.strcat "g" _147_934))
in (FStar_Syntax_Syntax.gen_bv _147_935 None bv.FStar_Syntax_Syntax.sort)))
end)) wp_binders)
end)))))
...
| (t, b) -> begin
(let _147_941 = (FStar_Syntax_Syntax.as_implicit b)
in (t, _147_941))
end)))
in (

let implicit_binders_of_list = (FStar_List.map (fun t -> (let _147_944 = (FStar_Syntax_Syntax.as_implicit true)
in (t, _147_944))))
in (

let args_of_bv = (FStar_List.map (fun bv -> (let _147_947 = (FStar_Syntax_Syntax.bv_to_name bv)
in (FStar_Syntax_Syntax.as_arg _147_947))))
in (
...
let x = (let _147_948 = (FStar_Syntax_Syntax.bv_to_name t)
in (FStar_Syntax_Syntax.gen_bv "x" None _147_948))
in (

let ret = (let _147_953 = (let _147_952 = (let _147_951 = (let _147_950 = (let _147_949 = (FStar_Syntax_Syntax.bv_to_name t)
in (mk_ctx _147_949))
in (FStar_Syntax_Syntax.mk_Total _147_950))
in (FStar_Syntax_Util.lcomp_of_comp _147_951))
in FStar_Util.Inl (_147_952))
in Some (_147_953))
in (
...
let body = (let _147_955 = (implicit_binders_of_list gamma)
in (let _147_954 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Util.abs _147_955 _147_954 ret)))
in (let _147_956 = (binders_of_list (((t, true))::((x, false))::[]))
in (FStar_Syntax_Util.abs _147_956 body ret)))))))
in (

let _57_2431 = (let _147_960 = (let _147_959 = (let _147_958 = (let _147_957 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_957)::[])
in (FStar_List.append binders _147_958))
in (FStar_Syntax_Util.abs _147_959 c_pure None))
in (check "pure" _147_960))
in (
...
let l = (let _147_968 = (let _147_967 = (let _147_966 = (let _147_963 = (let _147_962 = (let _147_961 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.new_bv None _147_961))
in (FStar_Syntax_Syntax.mk_binder _147_962))
in (_147_963)::[])
in (let _147_965 = (let _147_964 = (FStar_Syntax_Syntax.bv_to_name t2)
in (FStar_Syntax_Syntax.mk_GTotal _147_964))
in (FStar_Syntax_Util.arrow _147_966 _147_965)))
in (mk_gctx _147_967))
in (FStar_Syntax_Syntax.gen_bv "l" None _147_968))
in (

let r = (let _147_970 = (let _147_969 = (FStar_Syntax_Syntax.bv_to_name t1)
in (mk_gctx _147_969))
in (FStar_Syntax_Syntax.gen_bv "r" None _147_970))
in (

let ret = (let _147_975 = (let _147_974 = (let _147_973 = (let _147_972 = (let _147_971 = (FStar_Syntax_Syntax.bv_to_name t2)
in (mk_gctx _147_971))
in (FStar_Syntax_Syntax.mk_Total _147_972))
in (FStar_Syntax_Util.lcomp_of_comp _147_973))
in FStar_Util.Inl (_147_974))
in Some (_147_975))
in (
...
let inner_body = (let _147_981 = (FStar_Syntax_Syntax.bv_to_name l)
in (let _147_980 = (let _147_979 = (let _147_978 = (let _147_977 = (let _147_976 = (FStar_Syntax_Syntax.bv_to_name r)
in (FStar_Syntax_Util.mk_app _147_976 gamma_as_args))
in (FStar_Syntax_Syntax.as_arg _147_977))
in (_147_978)::[])
in (FStar_List.append gamma_as_args _147_979))
in (FStar_Syntax_Util.mk_app _147_981 _147_980)))
in (let _147_982 = (implicit_binders_of_list gamma)
in (FStar_Syntax_Util.abs _147_982 inner_body ret)))))
in (let _147_983 = (binders_of_list (((t1, true))::((t2, true))::((l, false))::((r, false))::[]))
in (FStar_Syntax_Util.abs _147_983 outer_body ret))))))))
in (

let _57_2443 = (let _147_987 = (let _147_986 = (let _147_985 = (let _147_984 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_984)::[])
in (FStar_List.append binders _147_985))
in (FStar_Syntax_Util.abs _147_986 c_app None))
in (check "app" _147_987))
in (
...
let t_f = (let _147_992 = (let _147_989 = (let _147_988 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.null_binder _147_988))
in (_147_989)::[])
in (let _147_991 = (let _147_990 = (FStar_Syntax_Syntax.bv_to_name t2)
in (FStar_Syntax_Syntax.mk_GTotal _147_990))
...
let a1 = (let _147_994 = (let _147_993 = (FStar_Syntax_Syntax.bv_to_name t1)
in (mk_gctx _147_993))
in (FStar_Syntax_Syntax.gen_bv "a1" None _147_994))
in (

let ret = (let _147_999 = (let _147_998 = (let _147_997 = (let _147_996 = (let _147_995 = (FStar_Syntax_Syntax.bv_to_name t2)
in (mk_gctx _147_995))
in (FStar_Syntax_Syntax.mk_Total _147_996))
in (FStar_Syntax_Util.lcomp_of_comp _147_997))
in FStar_Util.Inl (_147_998))
in Some (_147_999))
in (let _147_1012 = (binders_of_list (((t1, true))::((t2, true))::((f, false))::((a1, false))::[]))
in (let _147_1011 = (let _147_1010 = (let _147_1009 = (let _147_1008 = (let _147_1007 = (let _147_1006 = (let _147_1003 = (let _147_1002 = (let _147_1001 = (let _147_1000 = (FStar_Syntax_Syntax.bv_to_name f)
in (_147_1000)::[])
in (unknown)::_147_1001)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1002))
in (FStar_Syntax_Util.mk_app c_pure _147_1003))
in (let _147_1005 = (let _147_1004 = (FStar_Syntax_Syntax.bv_to_name a1)
in (_147_1004)::[])
in (_147_1006)::_147_1005))
in (unknown)::_147_1007)
in (unknown)::_147_1008)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1009))
in (FStar_Syntax_Util.mk_app c_app _147_1010))
in (FStar_Syntax_Util.abs _147_1012 _147_1011 ret)))))))))
in (

let _57_2453 = (let _147_1016 = (let _147_1015 = (let _147_1014 = (let _147_1013 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1013)::[])
in (FStar_List.append binders _147_1014))
in (FStar_Syntax_Util.abs _147_1015 c_lift1 None))
in (check "lift1" _147_1016))
in (
...
let t_f = (let _147_1024 = (let _147_1021 = (let _147_1017 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.null_binder _147_1017))
in (let _147_1020 = (let _147_1019 = (let _147_1018 = (FStar_Syntax_Syntax.bv_to_name t2)
in (FStar_Syntax_Syntax.null_binder _147_1018))
in (_147_1019)::[])
in (_147_1021)::_147_1020))
in (let _147_1023 = (let _147_1022 = (FStar_Syntax_Syntax.bv_to_name t3)
in (FStar_Syntax_Syntax.mk_GTotal _147_1022))
in (FStar_Syntax_Util.arrow _147_1024 _147_1023)))
in (

let f = (FStar_Syntax_Syntax.gen_bv "f" None t_f)
in (

let a1 = (let _147_1026 = (let _147_1025 = (FStar_Syntax_Syntax.bv_to_name t1)
in (mk_gctx _147_1025))
in (FStar_Syntax_Syntax.gen_bv "a1" None _147_1026))
in (

let a2 = (let _147_1028 = (let _147_1027 = (FStar_Syntax_Syntax.bv_to_name t2)
in (mk_gctx _147_1027))
in (FStar_Syntax_Syntax.gen_bv "a2" None _147_1028))
in (

let ret = (let _147_1033 = (let _147_1032 = (let _147_1031 = (let _147_1030 = (let _147_1029 = (FStar_Syntax_Syntax.bv_to_name t3)
in (mk_gctx _147_1029))
in (FStar_Syntax_Syntax.mk_Total _147_1030))
in (FStar_Syntax_Util.lcomp_of_comp _147_1031))
in FStar_Util.Inl (_147_1032))
in Some (_147_1033))
in (let _147_1053 = (binders_of_list (((t1, true))::((t2, true))::((t3, true))::((f, false))::((a1, false))::((a2, false))::[]))
in (let _147_1052 = (let _147_1051 = (let _147_1050 = (let _147_1049 = (let _147_1048 = (let _147_1047 = (let _147_1044 = (let _147_1043 = (let _147_1042 = (let _147_1041 = (let _147_1040 = (let _147_1037 = (let _147_1036 = (let _147_1035 = (let _147_1034 = (FStar_Syntax_Syntax.bv_to_name f)
in (_147_1034)::[])
in (unknown)::_147_1035)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1036))
in (FStar_Syntax_Util.mk_app c_pure _147_1037))
in (let _147_1039 = (let _147_1038 = (FStar_Syntax_Syntax.bv_to_name a1)
in (_147_1038)::[])
in (_147_1040)::_147_1039))
in (unknown)::_147_1041)
in (unknown)::_147_1042)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1043))
in (FStar_Syntax_Util.mk_app c_app _147_1044))
in (let _147_1046 = (let _147_1045 = (FStar_Syntax_Syntax.bv_to_name a2)
in (_147_1045)::[])
in (_147_1047)::_147_1046))
in (unknown)::_147_1048)
in (unknown)::_147_1049)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1050))
in (FStar_Syntax_Util.mk_app c_app _147_1051))
in (FStar_Syntax_Util.abs _147_1053 _147_1052 ret)))))))))))
in (

let _57_2464 = (let _147_1057 = (let _147_1056 = (let _147_1055 = (let _147_1054 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1054)::[])
in (FStar_List.append binders _147_1055))
in (FStar_Syntax_Util.abs _147_1056 c_lift2 None))
in (check "lift2" _147_1057))
in (
...
let t_f = (let _147_1063 = (let _147_1059 = (let _147_1058 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.null_binder _147_1058))
in (_147_1059)::[])
in (let _147_1062 = (let _147_1061 = (let _147_1060 = (FStar_Syntax_Syntax.bv_to_name t2)
in (mk_gctx _147_1060))
in (FStar_Syntax_Syntax.mk_Total _147_1061))
in (FStar_Syntax_Util.arrow _147_1063 _147_1062)))
in (

let f = (FStar_Syntax_Syntax.gen_bv "f" None t_f)
in (

let ret = (let _147_1073 = (let _147_1072 = (let _147_1071 = (let _147_1070 = (let _147_1069 = (let _147_1068 = (let _147_1065 = (let _147_1064 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.null_binder _147_1064))
in (_147_1065)::[])
in (let _147_1067 = (let _147_1066 = (FStar_Syntax_Syntax.bv_to_name t2)
in (FStar_Syntax_Syntax.mk_GTotal _147_1066))
in (FStar_Syntax_Util.arrow _147_1068 _147_1067)))
in (mk_ctx _147_1069))
in (FStar_Syntax_Syntax.mk_Total _147_1070))
in (FStar_Syntax_Util.lcomp_of_comp _147_1071))
in FStar_Util.Inl (_147_1072))
in Some (_147_1073))
in (

let e1 = (let _147_1074 = (FStar_Syntax_Syntax.bv_to_name t1)
in (FStar_Syntax_Syntax.gen_bv "e1" None _147_1074))
in (

let gamma = (mk_gamma ())
in (

let body = (let _147_1084 = (let _147_1077 = (FStar_Syntax_Syntax.binders_of_list gamma)
in (let _147_1076 = (let _147_1075 = (FStar_Syntax_Syntax.mk_binder e1)
in (_147_1075)::[])
in (FStar_List.append _147_1077 _147_1076)))
in (let _147_1083 = (let _147_1082 = (FStar_Syntax_Syntax.bv_to_name f)
in (let _147_1081 = (let _147_1080 = (let _147_1078 = (FStar_Syntax_Syntax.bv_to_name e1)
in (FStar_Syntax_Syntax.as_arg _147_1078))
in (let _147_1079 = (args_of_bv gamma)
in (_147_1080)::_147_1079))
in (FStar_Syntax_Util.mk_app _147_1082 _147_1081)))
in (FStar_Syntax_Util.abs _147_1084 _147_1083 ret)))
in (let _147_1085 = (binders_of_list (((t1, true))::((t2, true))::((f, false))::[]))
in (FStar_Syntax_Util.abs _147_1085 body ret))))))))))
in (

let _57_2475 = (let _147_1089 = (let _147_1088 = (let _147_1087 = (let _147_1086 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1086)::[])
in (FStar_List.append binders _147_1087))
in (FStar_Syntax_Util.abs _147_1088 c_push None))
in (check "push" _147_1089))
in (

let ret_tot_wp_a = (let _147_1092 = (let _147_1091 = (let _147_1090 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.lcomp_of_comp _147_1090))
in FStar_Util.Inl (_147_1091))
in Some (_147_1092))
in (
...
in (let _147_1103 = (FStar_Syntax_Syntax.binders_of_list ((a)::(c)::[]))
in (let _147_1102 = (

let l_ite = (FStar_Syntax_Syntax.fvar FStar_Syntax_Const.ite_lid (FStar_Syntax_Syntax.Delta_unfoldable (2)) None)
in (let _147_1101 = (let _147_1100 = (let _147_1099 = (let _147_1098 = (let _147_1097 = (let _147_1096 = (let _147_1095 = (let _147_1094 = (let _147_1093 = (FStar_Syntax_Syntax.bv_to_name c)
in (FStar_Syntax_Syntax.as_arg _147_1093))
in (_147_1094)::[])
in (FStar_Syntax_Util.mk_app l_ite _147_1095))
in (_147_1096)::[])
in (unknown)::_147_1097)
in (unknown)::_147_1098)
in (unknown)::_147_1099)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1100))
in (FStar_Syntax_Util.mk_app c_lift2 _147_1101)))
in (FStar_Syntax_Util.abs _147_1103 _147_1102 ret_tot_wp_a))))
in (

let wp_if_then_else = (normalize_and_make_binders_explicit wp_if_then_else)
in (

let _57_2482 = (let _147_1104 = (FStar_Syntax_Util.abs binders wp_if_then_else None)
in (check "wp_if_then_else" _147_1104))
in (
...
let op = (let _147_1110 = (let _147_1109 = (let _147_1107 = (FStar_Syntax_Syntax.null_binder FStar_Syntax_Util.ktype0)
in (let _147_1106 = (let _147_1105 = (FStar_Syntax_Syntax.null_binder FStar_Syntax_Util.ktype0)
in (_147_1105)::[])
in (_147_1107)::_147_1106))
in (let _147_1108 = (FStar_Syntax_Syntax.mk_GTotal FStar_Syntax_Util.ktype0)
in (FStar_Syntax_Util.arrow _147_1109 _147_1108)))
in (FStar_Syntax_Syntax.gen_bv "op" None _147_1110))
in (

let r = (FStar_Syntax_Syntax.gen_bv "r" None wp_a)
in (let _147_1122 = (FStar_Syntax_Syntax.binders_of_list ((a)::(l)::(op)::(r)::[]))
in (let _147_1121 = (let _147_1120 = (let _147_1119 = (let _147_1118 = (let _147_1117 = (let _147_1116 = (let _147_1115 = (FStar_Syntax_Syntax.bv_to_name op)
in (let _147_1114 = (let _147_1113 = (FStar_Syntax_Syntax.bv_to_name l)
in (let _147_1112 = (let _147_1111 = (FStar_Syntax_Syntax.bv_to_name r)
in (_147_1111)::[])
in (_147_1113)::_147_1112))
in (_147_1115)::_147_1114))
in (unknown)::_147_1116)
in (unknown)::_147_1117)
in (unknown)::_147_1118)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1119))
in (FStar_Syntax_Util.mk_app c_lift2 _147_1120))
in (FStar_Syntax_Util.abs _147_1122 _147_1121 ret_tot_wp_a))))))
in (

let wp_binop = (normalize_and_make_binders_explicit wp_binop)
in (

let _57_2489 = (let _147_1123 = (FStar_Syntax_Util.abs binders wp_binop None)
in (check "wp_binop" _147_1123))
in (
...
let body = (let _147_1137 = (let _147_1136 = (let _147_1135 = (let _147_1134 = (let _147_1133 = (let _147_1130 = (let _147_1129 = (let _147_1128 = (let _147_1127 = (let _147_1126 = (let _147_1125 = (let _147_1124 = (FStar_Syntax_Syntax.bv_to_name q)
in (FStar_Syntax_Syntax.as_arg _147_1124))
in (_147_1125)::[])
in (FStar_Syntax_Util.mk_app l_and _147_1126))
in (_147_1127)::[])
in (unknown)::_147_1128)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1129))
in (FStar_Syntax_Util.mk_app c_pure _147_1130))
in (let _147_1132 = (let _147_1131 = (FStar_Syntax_Syntax.bv_to_name wp)
in (_147_1131)::[])
in (_147_1133)::_147_1132))
in (unknown)::_147_1134)
in (unknown)::_147_1135)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1136))
in (FStar_Syntax_Util.mk_app c_app _147_1137))
in (let _147_1138 = (FStar_Syntax_Syntax.binders_of_list ((a)::(q)::(wp)::[]))
in (FStar_Syntax_Util.abs _147_1138 body ret_tot_wp_a))))))
in (

let wp_assert = (normalize_and_make_binders_explicit wp_assert)
in (

let _57_2497 = (let _147_1139 = (FStar_Syntax_Util.abs binders wp_assert None)
in (check "wp_assert" _147_1139))
in (
...
let body = (let _147_1153 = (let _147_1152 = (let _147_1151 = (let _147_1150 = (let _147_1149 = (let _147_1146 = (let _147_1145 = (let _147_1144 = (let _147_1143 = (let _147_1142 = (let _147_1141 = (let _147_1140 = (FStar_Syntax_Syntax.bv_to_name q)
in (FStar_Syntax_Syntax.as_arg _147_1140))
in (_147_1141)::[])
in (FStar_Syntax_Util.mk_app l_imp _147_1142))
in (_147_1143)::[])
in (unknown)::_147_1144)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1145))
in (FStar_Syntax_Util.mk_app c_pure _147_1146))
in (let _147_1148 = (let _147_1147 = (FStar_Syntax_Syntax.bv_to_name wp)
in (_147_1147)::[])
in (_147_1149)::_147_1148))
in (unknown)::_147_1150)
in (unknown)::_147_1151)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1152))
in (FStar_Syntax_Util.mk_app c_app _147_1153))
in (let _147_1154 = (FStar_Syntax_Syntax.binders_of_list ((a)::(q)::(wp)::[]))
in (FStar_Syntax_Util.abs _147_1154 body ret_tot_wp_a))))))
in (

let wp_assume = (normalize_and_make_binders_explicit wp_assume)
in (

let _57_2505 = (let _147_1155 = (FStar_Syntax_Util.abs binders wp_assume None)
in (check "wp_assume" _147_1155))
in (

let tforall = (let _147_1158 = (FStar_Syntax_Syntax.mk_Tm_uinst FStar_Syntax_Util.tforall ((FStar_Syntax_Syntax.U_unknown)::[]))
in (let _147_1157 = (let _147_1156 = (FStar_Syntax_Syntax.as_arg unknown)
in (_147_1156)::[])
in (FStar_Syntax_Util.mk_app _147_1158 _147_1157)))
in (
...
let t_f = (let _147_1162 = (let _147_1160 = (let _147_1159 = (FStar_Syntax_Syntax.bv_to_name b)
in (FStar_Syntax_Syntax.null_binder _147_1159))
in (_147_1160)::[])
in (let _147_1161 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1162 _147_1161)))
in (

let f = (FStar_Syntax_Syntax.gen_bv "f" None t_f)
in (

let body = (let _147_1175 = (let _147_1174 = (let _147_1173 = (let _147_1172 = (let _147_1171 = (let _147_1163 = (FStar_List.map FStar_Syntax_Syntax.as_arg ((unknown)::(tforall)::[]))
in (FStar_Syntax_Util.mk_app c_pure _147_1163))
in (let _147_1170 = (let _147_1169 = (let _147_1168 = (let _147_1167 = (let _147_1166 = (let _147_1165 = (let _147_1164 = (FStar_Syntax_Syntax.bv_to_name f)
in (_147_1164)::[])
in (unknown)::_147_1165)
in (unknown)::_147_1166)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1167))
in (FStar_Syntax_Util.mk_app c_push _147_1168))
in (_147_1169)::[])
in (_147_1171)::_147_1170))
in (unknown)::_147_1172)
in (unknown)::_147_1173)
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1174))
in (FStar_Syntax_Util.mk_app c_app _147_1175))
in (let _147_1176 = (FStar_Syntax_Syntax.binders_of_list ((a)::(b)::(f)::[]))
in (FStar_Syntax_Util.abs _147_1176 body ret_tot_wp_a))))))
in (

let wp_close = (normalize_and_make_binders_explicit wp_close)
in (

let _57_2514 = (let _147_1177 = (FStar_Syntax_Util.abs binders wp_close None)
in (check "wp_close" _147_1177))
in (

let ret_tot_type0 = (let _147_1180 = (let _147_1179 = (let _147_1178 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Util.ktype0)
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _147_1178))
in FStar_Util.Inl (_147_1179))
in Some (_147_1180))
in (

let mk_forall = (fun x body -> (

let tforall = (let _147_1187 = (FStar_Syntax_Syntax.mk_Tm_uinst FStar_Syntax_Util.tforall ((FStar_Syntax_Syntax.U_unknown)::[]))
in (let _147_1186 = (let _147_1185 = (FStar_Syntax_Syntax.as_arg x.FStar_Syntax_Syntax.sort)
in (_147_1185)::[])
in (FStar_Syntax_Util.mk_app _147_1187 _147_1186)))
in (let _147_1194 = (let _147_1193 = (let _147_1192 = (let _147_1191 = (let _147_1190 = (let _147_1189 = (let _147_1188 = (FStar_Syntax_Syntax.mk_binder x)
in (_147_1188)::[])
in (FStar_Syntax_Util.abs _147_1189 body ret_tot_type0))
in (FStar_Syntax_Syntax.as_arg _147_1190))
in (_147_1191)::[])
in (tforall, _147_1192))
in FStar_Syntax_Syntax.Tm_app (_147_1193))
in (FStar_Syntax_Syntax.mk _147_1194 None FStar_Range.dummyRange))))
in (

let rec mk_leq = (fun t x y -> (match ((let _147_1202 = (let _147_1201 = (FStar_Syntax_Subst.compress t)
in (normalize _147_1201))
in _147_1202.FStar_Syntax_Syntax.n)) with
...
let body = (let _147_1214 = (let _147_1204 = (FStar_Syntax_Syntax.bv_to_name a1)
in (let _147_1203 = (FStar_Syntax_Syntax.bv_to_name a2)
in (mk_leq a _147_1204 _147_1203)))
in (let _147_1213 = (let _147_1212 = (let _147_1207 = (let _147_1206 = (let _147_1205 = (FStar_Syntax_Syntax.bv_to_name a1)
in (FStar_Syntax_Syntax.as_arg _147_1205))
in (_147_1206)::[])
in (FStar_Syntax_Util.mk_app x _147_1207))
in (let _147_1211 = (let _147_1210 = (let _147_1209 = (let _147_1208 = (FStar_Syntax_Syntax.bv_to_name a2)
in (FStar_Syntax_Syntax.as_arg _147_1208))
in (_147_1209)::[])
in (FStar_Syntax_Util.mk_app y _147_1210))
in (mk_leq b _147_1212 _147_1211)))
in (FStar_Syntax_Util.mk_imp _147_1214 _147_1213)))
in (let _147_1215 = (mk_forall a2 body)
in (mk_forall a1 _147_1215))))))
end
...
let _57_2562 = t
in (let _147_1219 = (let _147_1218 = (let _147_1217 = (let _147_1216 = (FStar_Syntax_Util.arrow binders comp)
in (FStar_Syntax_Syntax.mk_Total _147_1216))
in ((binder)::[], _147_1217))
in FStar_Syntax_Syntax.Tm_arrow (_147_1218))
in {FStar_Syntax_Syntax.n = _147_1219; FStar_Syntax_Syntax.tk = _57_2562.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _57_2562.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _57_2562.FStar_Syntax_Syntax.vars}))
in (mk_leq t x y))
end
...
let body = (let _147_1221 = (FStar_Syntax_Syntax.bv_to_name wp1)
in (let _147_1220 = (FStar_Syntax_Syntax.bv_to_name wp2)
in (mk_leq wp_a _147_1221 _147_1220)))
in (let _147_1222 = (FStar_Syntax_Syntax.binders_of_list ((wp1)::(wp2)::[]))
in (FStar_Syntax_Util.abs _147_1222 body ret_tot_type0)))))
in (

let _57_2574 = (let _147_1226 = (let _147_1225 = (let _147_1224 = (let _147_1223 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1223)::[])
in (FStar_List.append binders _147_1224))
in (FStar_Syntax_Util.abs _147_1225 stronger None))
in (check "stronger" _147_1226))
in (
...
let body = (let _147_1234 = (let _147_1233 = (let _147_1232 = (let _147_1229 = (let _147_1228 = (let _147_1227 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.as_arg _147_1227))
in (_147_1228)::[])
in (FStar_Syntax_Util.mk_app null_wp _147_1229))
in (let _147_1231 = (let _147_1230 = (FStar_Syntax_Syntax.bv_to_name wp)
in (_147_1230)::[])
in (_147_1232)::_147_1231))
in (FStar_List.map FStar_Syntax_Syntax.as_arg _147_1233))
in (FStar_Syntax_Util.mk_app stronger _147_1234))
in (let _147_1235 = (FStar_Syntax_Syntax.binders_of_list ((a)::(wp)::[]))
in (FStar_Syntax_Util.abs _147_1235 body ret_tot_type0))))
in (

let wp_trivial = (normalize_and_make_binders_explicit wp_trivial)
in (

let _57_2581 = (let _147_1236 = (FStar_Syntax_Util.abs binders wp_trivial None)
in (check "wp_trivial" _147_1236))
in (
...
let env = (let _147_1245 = (FStar_Syntax_Syntax.new_bv None ed.FStar_Syntax_Syntax.signature)
in (FStar_TypeChecker_Env.push_bv env _147_1245))
in (

let _57_2616 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env0) (FStar_Options.Other ("ED"))) then begin
(let _147_1248 = (FStar_Syntax_Print.lid_to_string ed.FStar_Syntax_Syntax.mname)
in (let _147_1247 = (FStar_Syntax_Print.binders_to_string " " ed.FStar_Syntax_Syntax.binders)
in (let _147_1246 = (FStar_Syntax_Print.term_to_string ed.FStar_Syntax_Syntax.signature)
in (FStar_Util.print3 "Checking effect signature: %s %s : %s\n" _147_1248 _147_1247 _147_1246))))
end else begin
()
end
in (
...
let expected_k = (let _147_1260 = (let _147_1258 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1257 = (let _147_1256 = (let _147_1255 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.null_binder _147_1255))
in (_147_1256)::[])
in (_147_1258)::_147_1257))
in (let _147_1259 = (FStar_Syntax_Syntax.mk_GTotal wp_a)
...
let a_wp_b = (let _147_1264 = (let _147_1262 = (let _147_1261 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.null_binder _147_1261))
in (_147_1262)::[])
in (let _147_1263 = (FStar_Syntax_Syntax.mk_Total wp_b)
in (FStar_Syntax_Util.arrow _147_1264 _147_1263)))
in (

let a_wlp_b = a_wp_b
in (

let expected_k = (let _147_1279 = (let _147_1277 = (FStar_Syntax_Syntax.null_binder FStar_TypeChecker_Common.t_range)
in (let _147_1276 = (let _147_1275 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1274 = (let _147_1273 = (FStar_Syntax_Syntax.mk_binder b)
in (let _147_1272 = (let _147_1271 = (FStar_Syntax_Syntax.null_binder wp_a)
in (let _147_1270 = (let _147_1269 = (FStar_Syntax_Syntax.null_binder wlp_a)
in (let _147_1268 = (let _147_1267 = (FStar_Syntax_Syntax.null_binder a_wp_b)
in (let _147_1266 = (let _147_1265 = (FStar_Syntax_Syntax.null_binder a_wlp_b)
in (_147_1265)::[])
in (_147_1267)::_147_1266))
in (_147_1269)::_147_1268))
in (_147_1271)::_147_1270))
in (_147_1273)::_147_1272))
in (_147_1275)::_147_1274))
in (_147_1277)::_147_1276))
in (let _147_1278 = (FStar_Syntax_Syntax.mk_Total wp_b)
in (FStar_Syntax_Util.arrow _147_1279 _147_1278)))
...
let a_wlp_b = (let _147_1283 = (let _147_1281 = (let _147_1280 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.null_binder _147_1280))
in (_147_1281)::[])
in (let _147_1282 = (FStar_Syntax_Syntax.mk_Total wlp_b)
in (FStar_Syntax_Util.arrow _147_1283 _147_1282)))
in (

let expected_k = (let _147_1294 = (let _147_1292 = (FStar_Syntax_Syntax.null_binder FStar_TypeChecker_Common.t_range)
in (let _147_1291 = (let _147_1290 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1289 = (let _147_1288 = (FStar_Syntax_Syntax.mk_binder b)
in (let _147_1287 = (let _147_1286 = (FStar_Syntax_Syntax.null_binder wlp_a)
in (let _147_1285 = (let _147_1284 = (FStar_Syntax_Syntax.null_binder a_wlp_b)
in (_147_1284)::[])
in (_147_1286)::_147_1285))
in (_147_1288)::_147_1287))
in (_147_1290)::_147_1289))
in (_147_1292)::_147_1291))
in (let _147_1293 = (FStar_Syntax_Syntax.mk_Total wlp_b)
in (FStar_Syntax_Util.arrow _147_1294 _147_1293)))
...
let p = (let _147_1296 = (let _147_1295 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _147_1295 Prims.fst))
in (FStar_Syntax_Syntax.new_bv (Some ((FStar_Ident.range_of_lid ed.FStar_Syntax_Syntax.mname))) _147_1296))
in (

let expected_k = (let _147_1305 = (let _147_1303 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1302 = (let _147_1301 = (FStar_Syntax_Syntax.mk_binder p)
in (let _147_1300 = (let _147_1299 = (FStar_Syntax_Syntax.null_binder wp_a)
in (let _147_1298 = (let _147_1297 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1297)::[])
...
let expected_k = (let _147_1312 = (let _147_1310 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1309 = (let _147_1308 = (FStar_Syntax_Syntax.null_binder wlp_a)
in (let _147_1307 = (let _147_1306 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1306)::[])
in (_147_1308)::_147_1307))
in (_147_1310)::_147_1309))
in (let _147_1311 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1312 _147_1311)))
...
in (let _147_1314 = (let _147_1313 = (FStar_Syntax_Syntax.null_binder wlp_a)
in (_147_1313)::[])
in (_147_1315)::_147_1314))
in (let _147_1316 = (FStar_Syntax_Syntax.mk_Total wlp_a)
...
let t = (let _147_1318 = (FStar_TypeChecker_Env.get_range env)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_max ((u1)::(u2)::[]))) None _147_1318))
in (let _147_1323 = (let _147_1321 = (FStar_Syntax_Syntax.null_binder t1)
in (let _147_1320 = (let _147_1319 = (FStar_Syntax_Syntax.null_binder t2)
in (_147_1319)::[])
in (_147_1321)::_147_1320))
in (let _147_1322 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.arrow _147_1323 _147_1322))))
end))
end))
in (

let expected_k = (let _147_1332 = (let _147_1330 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1329 = (let _147_1328 = (FStar_Syntax_Syntax.null_binder wp_a)
in (let _147_1327 = (let _147_1326 = (FStar_Syntax_Syntax.null_binder bin_op)
in (let _147_1325 = (let _147_1324 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1324)::[])
in (_147_1326)::_147_1325))
in (_147_1328)::_147_1327))
in (_147_1330)::_147_1329))
in (let _147_1331 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1332 _147_1331)))
...
let expected_k = (let _147_1337 = (let _147_1335 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1334 = (let _147_1333 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1333)::[])
in (_147_1335)::_147_1334))
in (let _147_1336 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow _147_1337 _147_1336)))
...
let b = (let _147_1339 = (let _147_1338 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _147_1338 Prims.fst))
in (FStar_Syntax_Syntax.new_bv (Some ((FStar_Ident.range_of_lid ed.FStar_Syntax_Syntax.mname))) _147_1339))
in (

let b_wp_a = (let _147_1343 = (let _147_1341 = (let _147_1340 = (FStar_Syntax_Syntax.bv_to_name b)
in (FStar_Syntax_Syntax.null_binder _147_1340))
in (_147_1341)::[])
in (let _147_1342 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1343 _147_1342)))
in (

let expected_k = (let _147_1350 = (let _147_1348 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1347 = (let _147_1346 = (FStar_Syntax_Syntax.mk_binder b)
in (let _147_1345 = (let _147_1344 = (FStar_Syntax_Syntax.null_binder b_wp_a)
in (_147_1344)::[])
in (_147_1346)::_147_1345))
in (_147_1348)::_147_1347))
in (let _147_1349 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1350 _147_1349)))
in (check_and_gen' env ed.FStar_Syntax_Syntax.close_wp expected_k))))
in (

let assert_p = (

let expected_k = (let _147_1359 = (let _147_1357 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1356 = (let _147_1355 = (let _147_1352 = (let _147_1351 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _147_1351 Prims.fst))
in (FStar_Syntax_Syntax.null_binder _147_1352))
in (let _147_1354 = (let _147_1353 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1353)::[])
in (_147_1355)::_147_1354))
in (_147_1357)::_147_1356))
in (let _147_1358 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1359 _147_1358)))
in (check_and_gen' env ed.FStar_Syntax_Syntax.assert_p expected_k))
in (

let assume_p = (

let expected_k = (let _147_1368 = (let _147_1366 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1365 = (let _147_1364 = (let _147_1361 = (let _147_1360 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _147_1360 Prims.fst))
in (FStar_Syntax_Syntax.null_binder _147_1361))
in (let _147_1363 = (let _147_1362 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1362)::[])
in (_147_1364)::_147_1363))
in (_147_1366)::_147_1365))
in (let _147_1367 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1368 _147_1367)))
in (check_and_gen' env ed.FStar_Syntax_Syntax.assume_p expected_k))
in (

let null_wp = (

let expected_k = (let _147_1371 = (let _147_1369 = (FStar_Syntax_Syntax.mk_binder a)
in (_147_1369)::[])
in (let _147_1370 = (FStar_Syntax_Syntax.mk_Total wp_a)
in (FStar_Syntax_Util.arrow _147_1371 _147_1370)))
...
let expected_k = (let _147_1376 = (let _147_1374 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1373 = (let _147_1372 = (FStar_Syntax_Syntax.null_binder wp_a)
in (_147_1372)::[])
in (_147_1374)::_147_1373))
in (let _147_1375 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.arrow _147_1376 _147_1375)))
in (check_and_gen' env ed.FStar_Syntax_Syntax.trivial expected_k))
end))
in (

let t = (let _147_1377 = (FStar_Syntax_Syntax.mk_Total ed.FStar_Syntax_Syntax.signature)
in (FStar_Syntax_Util.arrow ed.FStar_Syntax_Syntax.binders _147_1377))
in (
...
let _57_2705 = (match ((let _147_1379 = (let _147_1378 = (FStar_Syntax_Subst.compress t)
in _147_1378.FStar_Syntax_Syntax.n)
in (binders, _147_1379))) with
| ([], _57_2692) -> begin
([], t)
end
...
let ts = (let _147_1384 = (FStar_Syntax_Subst.close_tscheme binders ts)
in (FStar_Syntax_Subst.close_univ_vars_tscheme univs _147_1384))
in (
...
let _57_2712 = ed
in (let _147_1397 = (close 0 ret)
in (let _147_1396 = (close 1 bind_wp)
in (let _147_1395 = (close 1 bind_wlp)
in (let _147_1394 = (close 0 if_then_else)
in (let _147_1393 = (close 0 ite_wp)
in (let _147_1392 = (close 0 ite_wlp)
in (let _147_1391 = (close 0 wp_binop)
in (let _147_1390 = (close 0 wp_as_type)
in (let _147_1389 = (close 1 close_wp)
in (let _147_1388 = (close 0 assert_p)
in (let _147_1387 = (close 0 assume_p)
in (let _147_1386 = (close 0 null_wp)
in (let _147_1385 = (close 0 trivial_wp)
in {FStar_Syntax_Syntax.qualifiers = _57_2712.FStar_Syntax_Syntax.qualifiers; FStar_Syntax_Syntax.mname = _57_2712.FStar_Syntax_Syntax.mname; FStar_Syntax_Syntax.univs = univs; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = signature; FStar_Syntax_Syntax.ret = _147_1397; FStar_Syntax_Syntax.bind_wp = _147_1396; FStar_Syntax_Syntax.bind_wlp = _147_1395; FStar_Syntax_Syntax.if_then_else = _147_1394; FStar_Syntax_Syntax.ite_wp = _147_1393; FStar_Syntax_Syntax.ite_wlp = _147_1392; FStar_Syntax_Syntax.wp_binop = _147_1391; FStar_Syntax_Syntax.wp_as_type = _147_1390; FStar_Syntax_Syntax.close_wp = _147_1389; FStar_Syntax_Syntax.assert_p = _147_1388; FStar_Syntax_Syntax.assume_p = _147_1387; FStar_Syntax_Syntax.null_wp = _147_1386; FStar_Syntax_Syntax.trivial = _147_1385}))))))))))))))
in (

let _57_2715 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _147_1398 = (FStar_Syntax_Print.eff_decl_to_string ed)
in (FStar_Util.print_string _147_1398))
end else begin
()
end
in ed)))
...
let lex_top_t = (let _147_1406 = (let _147_1405 = (let _147_1404 = (let _147_1403 = (FStar_Ident.set_lid_range FStar_Syntax_Const.lex_t_lid r1)
in (FStar_Syntax_Syntax.fvar _147_1403 FStar_Syntax_Syntax.Delta_constant None))
in (_147_1404, (FStar_Syntax_Syntax.U_name (utop))::[]))
in FStar_Syntax_Syntax.Tm_uinst (_147_1405))
in (FStar_Syntax_Syntax.mk _147_1406 None r1))
in (
...
let a = (let _147_1407 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_name (ucons1))) None r2)
in (FStar_Syntax_Syntax.new_bv (Some (r2)) _147_1407))
in (

let hd = (let _147_1408 = (FStar_Syntax_Syntax.bv_to_name a)
in (FStar_Syntax_Syntax.new_bv (Some (r2)) _147_1408))
in (

let tl = (let _147_1413 = (let _147_1412 = (let _147_1411 = (let _147_1410 = (let _147_1409 = (FStar_Ident.set_lid_range FStar_Syntax_Const.lex_t_lid r2)
in (FStar_Syntax_Syntax.fvar _147_1409 FStar_Syntax_Syntax.Delta_constant None))
in (_147_1410, (FStar_Syntax_Syntax.U_name (ucons2))::[]))
in FStar_Syntax_Syntax.Tm_uinst (_147_1411))
in (FStar_Syntax_Syntax.mk _147_1412 None r2))
in (FStar_Syntax_Syntax.new_bv (Some (r2)) _147_1413))
in (

let res = (let _147_1417 = (let _147_1416 = (let _147_1415 = (let _147_1414 = (FStar_Ident.set_lid_range FStar_Syntax_Const.lex_t_lid r2)
in (FStar_Syntax_Syntax.fvar _147_1414 FStar_Syntax_Syntax.Delta_constant None))
in (_147_1415, (FStar_Syntax_Syntax.U_max ((FStar_Syntax_Syntax.U_name (ucons1))::(FStar_Syntax_Syntax.U_name (ucons2))::[]))::[]))
in FStar_Syntax_Syntax.Tm_uinst (_147_1416))
in (FStar_Syntax_Syntax.mk _147_1417 None r2))
in (let _147_1418 = (FStar_Syntax_Syntax.mk_Total res)
in (FStar_Syntax_Util.arrow (((a, Some (FStar_Syntax_Syntax.imp_tag)))::((hd, None))::((tl, None))::[]) _147_1418))))))
in (
...
in (let _147_1420 = (let _147_1419 = (FStar_TypeChecker_Env.get_range env)
in ((tc)::(dc_lextop)::(dc_lexcons)::[], [], lids, _147_1419))
in FStar_Syntax_Syntax.Sig_bundle (_147_1420)))))))))))))))
end
| _57_2784 -> begin
(let _147_1422 = (let _147_1421 = (FStar_Syntax_Print.sigelt_to_string (FStar_Syntax_Syntax.Sig_bundle ((ses, [], lids, FStar_Range.dummyRange))))
in (FStar_Util.format1 "Unexpected lex_t: %s\n" _147_1421))
in (FStar_All.failwith _147_1422))
end))))
...
let warn_positivity = (fun l r -> (let _147_1436 = (let _147_1435 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format1 "Positivity check is not yet implemented (%s)" _147_1435))
in (FStar_TypeChecker_Errors.diag r _147_1436)))
in (
...
let k = (let _147_1441 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow indices _147_1441))
in (
...
let _57_2832 = (let _147_1442 = (FStar_TypeChecker_Rel.teq env' t t_type)
in (FStar_TypeChecker_Rel.force_trivial_guard env' _147_1442))
in (

let t_tc = (let _147_1443 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow (FStar_List.append tps indices) _147_1443))
in (
...
in (let _147_1444 = (FStar_TypeChecker_Env.push_let_binding env_tps (FStar_Util.Inr (fv_tc)) ([], t_tc))
in (_147_1444, FStar_Syntax_Syntax.Sig_inductive_typ ((tc, [], tps, k, mutuals, data, quals, r)), u)))))))
end)))
end))
end))
end))
...
| (se, u_tc) -> begin
if (let _147_1457 = (let _147_1456 = (FStar_Syntax_Util.lid_of_sigelt se)
in (FStar_Util.must _147_1456))
in (FStar_Ident.lid_equals tc_lid _147_1457)) then begin
(
...
let _57_2913 = (match ((let _147_1459 = (FStar_Syntax_Subst.compress t)
in _147_1459.FStar_Syntax_Syntax.n)) with
...
in (let _147_1462 = (FStar_Syntax_Subst.subst subst t)
in (FStar_Syntax_Util.arrow_formals _147_1462))))
end))
end
| _57_2910 -> begin
([], t)
...
(let _147_1465 = (FStar_Syntax_Print.lid_to_string c)
in (let _147_1464 = (FStar_Syntax_Print.binders_to_string "->" arguments)
in (let _147_1463 = (FStar_Syntax_Print.term_to_string result)
in (FStar_Util.print3 "Checking datacon  %s : %s -> %s \n" _147_1465 _147_1464 _147_1463))))
end else begin
()
end
in (
...
let _57_2932 = (match ((let _147_1466 = (FStar_Syntax_Subst.compress head)
in _147_1466.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv) when (FStar_Syntax_Syntax.fv_eq_lid fv tc_lid) -> begin
()
end
| _57_2931 -> begin
(let _147_1470 = (let _147_1469 = (let _147_1468 = (let _147_1467 = (FStar_Syntax_Print.lid_to_string tc_lid)
in (FStar_Util.format1 "Expected a constructor of type %s" _147_1467))
in (_147_1468, r))
in FStar_Syntax_Syntax.Error (_147_1469))
in (Prims.raise _147_1470))
end)
in (
...
let _57_2940 = ()
in (let _147_1474 = (FStar_TypeChecker_Rel.universe_inequality u_x u_tc)
in (FStar_TypeChecker_Rel.conj_guard g _147_1474)))
end)) FStar_TypeChecker_Rel.trivial_guard arguments us)
in (

let t = (let _147_1478 = (let _147_1476 = (FStar_All.pipe_right tps (FStar_List.map (fun _57_2946 -> (match (_57_2946) with
| (x, _57_2945) -> begin
(x, Some (FStar_Syntax_Syntax.Implicit (true)))
end))))
in (FStar_List.append _147_1476 arguments))
in (let _147_1477 = (FStar_Syntax_Syntax.mk_Total result)
in (FStar_Syntax_Util.arrow _147_1478 _147_1477)))
...
(let _147_1489 = (let _147_1488 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_All.pipe_left (FStar_Syntax_Util.arrow tps) _147_1488))
in (FStar_Syntax_Syntax.null_binder _147_1489))
end
| _57_2975 -> begin
(FStar_All.failwith "Impossible")
end))))
...
let t = (let _147_1491 = (FStar_Syntax_Syntax.mk_Total FStar_TypeChecker_Common.t_unit)
in (FStar_Syntax_Util.arrow (FStar_List.append binders binders') _147_1491))
in (

let _57_2999 = if (FStar_TypeChecker_Env.debug env FStar_Options.Low) then begin
(let _147_1492 = (FStar_TypeChecker_Normalize.term_to_string env t)
...
(let _147_1496 = (let _147_1494 = (FStar_All.pipe_right uvs (FStar_List.map (fun u -> u.FStar_Ident.idText)))
in (FStar_All.pipe_right _147_1494 (FStar_String.concat ", ")))
in (let _147_1495 = (FStar_Syntax_Print.term_to_string t)
...
let _57_3050 = (match ((let _147_1499 = (FStar_Syntax_Subst.compress ty)
in _147_1499.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (binders, c) -> begin
(
...
| _57_3044 -> begin
(let _147_1500 = (FStar_ST.read x.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.tk)
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((rest, c))) _147_1500 x.FStar_Syntax_Syntax.sort.FStar_Syntax_Syntax.pos))
end)
in (tps, t))
end))
end
...
let uvs_universes = (FStar_All.pipe_right uvs (FStar_List.map (fun _147_1501 -> FStar_Syntax_Syntax.U_name (_147_1501))))
in (
...
let ty = (let _147_1505 = (FStar_Syntax_InstFV.instantiate tc_insts t.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _147_1505 (FStar_Syntax_Subst.close_univ_vars uvs)))
...
(let _147_1509 = (FStar_Syntax_Print.sigelt_to_string tc)
in (FStar_Util.print1 "Checked inductive: %s\n" _147_1509))
end else begin
()
end
in (let _147_1510 = (FStar_TypeChecker_Rel.conj_guard g g')
in (env, ((tc, tc_u))::all_tcs, _147_1510))))
end))
...
| (data, g') -> begin
(let _147_1513 = (FStar_TypeChecker_Rel.conj_guard g g')
in ((data)::datas, _147_1513))
end))
end)) datas ([], g))
...
let _57_3138 = (let _147_1514 = (FStar_List.map Prims.fst tcs)
in (generalize_and_inst_within env0 g _147_1514 datas))
in (match (_57_3138) with
| (tcs, datas) -> begin
(let _147_1516 = (let _147_1515 = (FStar_TypeChecker_Env.get_range env0)
in ((FStar_List.append tcs datas), quals, lids, _147_1515))
in FStar_Syntax_Syntax.Sig_bundle (_147_1516))
end))
end))
end)))
end)))))))))
...
in (let _147_1522 = (FStar_TypeChecker_Env.push_sigelt env se)
in (se, _147_1522))))
end
...
let _57_3180 = (let _147_1527 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right _147_1527 Prims.ignore))
in (
...
let _57_3209 = (let _147_1528 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.source)
in (monad_signature env sub.FStar_Syntax_Syntax.source _147_1528))
in (match (_57_3209) with
| (a, wp_a_src) -> begin
(

let _57_3212 = (let _147_1529 = (FStar_TypeChecker_Env.lookup_effect_lid env sub.FStar_Syntax_Syntax.target)
in (monad_signature env sub.FStar_Syntax_Syntax.target _147_1529))
in (match (_57_3212) with
| (b, wp_b_tgt) -> begin
(

let wp_a_tgt = (let _147_1533 = (let _147_1532 = (let _147_1531 = (let _147_1530 = (FStar_Syntax_Syntax.bv_to_name a)
in (b, _147_1530))
in FStar_Syntax_Syntax.NT (_147_1531))
in (_147_1532)::[])
in (FStar_Syntax_Subst.subst _147_1533 wp_b_tgt))
in (

let expected_k = (let _147_1538 = (let _147_1536 = (FStar_Syntax_Syntax.mk_binder a)
in (let _147_1535 = (let _147_1534 = (FStar_Syntax_Syntax.null_binder wp_a_src)
in (_147_1534)::[])
in (_147_1536)::_147_1535))
in (let _147_1537 = (FStar_Syntax_Syntax.mk_Total wp_a_tgt)
in (FStar_Syntax_Util.arrow _147_1538 _147_1537)))
in (
...
let _57_3250 = (let _147_1539 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow ((tps, c))) None r)
in (FStar_TypeChecker_Util.generalize_universes env0 _147_1539))
in (match (_57_3250) with
| (uvs, t) -> begin
(

let _57_3269 = (match ((let _147_1541 = (let _147_1540 = (FStar_Syntax_Subst.compress t)
in _147_1540.FStar_Syntax_Syntax.n)
in (tps, _147_1541))) with
...
let _57_3284 = (let _147_1543 = (let _147_1542 = (FStar_Syntax_Util.type_u ())
in (Prims.fst _147_1542))
in (check_and_gen env t _147_1543))
...
let phi = (let _147_1544 = (tc_check_trivial_guard env phi k)
in (FStar_All.pipe_right _147_1544 (norm env)))
in (
...
let _57_3317 = (let _147_1548 = (let _147_1545 = (FStar_Syntax_Util.ml_comp FStar_TypeChecker_Common.t_unit r)
in Some (_147_1545))
in (let _147_1547 = (let _147_1546 = (c.FStar_Syntax_Syntax.comp ())
in (e, _147_1546))
in (check_expected_effect env _147_1548 _147_1547)))
in (match (_57_3317) with
| (e, _57_3315, g) -> begin
(

let _57_3318 = (let _147_1549 = (FStar_TypeChecker_Rel.conj_guard g1 g)
in (FStar_TypeChecker_Rel.force_trivial_guard env _147_1549))
in (
...
(let _147_1561 = (let _147_1560 = (let _147_1559 = (let _147_1558 = (FStar_Syntax_Print.lid_to_string l)
in (let _147_1557 = (FStar_Syntax_Print.quals_to_string q)
in (let _147_1556 = (FStar_Syntax_Print.quals_to_string q')
in (FStar_Util.format3 "Inconsistent qualifier annotations on %s; Expected {%s}, got {%s}" _147_1558 _147_1557 _147_1556))))
in (_147_1559, r))
in FStar_Syntax_Syntax.Error (_147_1560))
in (Prims.raise _147_1561))
end
end))
in (
...
in (let _147_1564 = (FStar_Syntax_Syntax.mk_lb (FStar_Util.Inr (lbname), uvs, FStar_Syntax_Const.effect_ALL_lid, tval, lb.FStar_Syntax_Syntax.lbdef))
in (false, _147_1564, quals_opt))))
end)
...
let e = (let _147_1568 = (let _147_1567 = (let _147_1566 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)) None r)
in (((Prims.fst lbs), lbs'), _147_1566))
in FStar_Syntax_Syntax.Tm_let (_147_1567))
in (FStar_Syntax_Syntax.mk _147_1568 None r))
in (
...
(let _147_1576 = (let _147_1575 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (

let should_log = (match ((let _147_1572 = (let _147_1571 = (let _147_1570 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _147_1570.FStar_Syntax_Syntax.fv_name)
in _147_1571.FStar_Syntax_Syntax.v)
in (FStar_TypeChecker_Env.try_lookup_val_decl env _147_1572))) with
| None -> begin
true
end
| _57_3409 -> begin
...
(let _147_1574 = (FStar_Syntax_Print.lbname_to_string lb.FStar_Syntax_Syntax.lbname)
in (let _147_1573 = (FStar_Syntax_Print.term_to_string lb.FStar_Syntax_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" _147_1574 _147_1573)))
end else begin
""
end))))
in (FStar_All.pipe_right _147_1575 (FStar_String.concat "\n")))
in (FStar_Util.print1 "%s\n" _147_1576))
end else begin
()
end
...
let dec = (let _147_1592 = (let _147_1591 = (let _147_1590 = (let _147_1589 = (let _147_1588 = (FStar_Syntax_Syntax.mk_Total t)
in (bs, _147_1588))
in FStar_Syntax_Syntax.Tm_arrow (_147_1589))
in (FStar_Syntax_Syntax.mk _147_1590 None r))
in (l, us, _147_1591, (FStar_Syntax_Syntax.Assumption)::(FStar_Syntax_Syntax.New)::quals, r))
in FStar_Syntax_Syntax.Sig_declare_typ (_147_1592))
in ((dec)::out, hidden))
end
...
if (is_abstract quals) then begin
(let _147_1599 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let _147_1598 = (let _147_1597 = (let _147_1596 = (let _147_1595 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _147_1595.FStar_Syntax_Syntax.fv_name)
in _147_1596.FStar_Syntax_Syntax.v)
in (_147_1597, lb.FStar_Syntax_Syntax.lbunivs, lb.FStar_Syntax_Syntax.lbtyp, (FStar_Syntax_Syntax.Assumption)::quals, r))
in FStar_Syntax_Syntax.Sig_declare_typ (_147_1598)))))
in (_147_1599, hidden))
end else begin
((se)::[], hidden)
end
...
(let _147_1607 = (FStar_Syntax_Print.sigelt_to_string se)
...
(let _147_1608 = (FStar_All.pipe_right (FStar_List.rev exports) FStar_List.flatten)
in ((FStar_List.rev ses), _147_1608, env))
end)))
...
in (let _147_1626 = (FStar_Options.restore_cmd_line_options true)
in (FStar_All.pipe_right _147_1626 Prims.ignore)))))
end else begin
()
end
in (modul, env)))))
...
(let _147_1635 = (FStar_Syntax_Print.term_to_string e)
...
(let _147_1640 = (let _147_1639 = (let _147_1638 = (FStar_TypeChecker_Env.get_range env)
in ((Prims.strcat "Implicit argument: " msg), _147_1638))
in FStar_Syntax_Syntax.Error (_147_1639))
in (Prims.raise _147_1640))
end
...
(let _147_1645 = (let _147_1644 = (let _147_1643 = (let _147_1641 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format1 "Implicit argument: Expected a total term; got a ghost term: %s" _147_1641))
in (let _147_1642 = (FStar_TypeChecker_Env.get_range env)
in (_147_1643, _147_1642)))
in FStar_Syntax_Syntax.Error (_147_1644))
in (Prims.raise _147_1645))
end
end)))))
...
(let _147_1650 = (FStar_Syntax_Print.lid_to_string m.FStar_Syntax_Syntax.name)
...
(let _147_1651 = (FStar_Syntax_Print.modul_to_string m)
in (FStar_Util.print1 "%s\n" _147_1651))
end else begin
()
end
