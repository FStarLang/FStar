           ...
           | FStar_Syntax_Syntax.Sig_polymonadic_bind (m,n,p,t,uu____4355) ->
               ...
               (match uu____4437 with
                | (t2,ty) ->
                    ...
                    ([se2], [], env0))
           | FStar_Syntax_Syntax.Sig_polymonadic_subcomp (m,n,t,uu____4463)
               ->
               let t1 =
                 let uu____4465 =
                   (FStar_Options.use_two_phase_tc ()) &&
                         ...
                         let dec =
                           ...
                           let uu____4938 =
                             let uu____4939 =
                               ...
                               (l, us, uu____4946)  in
                             FStar_Syntax_Syntax.Sig_declare_typ uu____4939
                              in
                           {
...
let (add_sigelt_to_env :
  ...
  fun env  ->
    fun se  ->
      fun from_cache  ->
        (let uu____5252 = FStar_TypeChecker_Env.debug env FStar_Options.Low
            in
         if uu____5252
         then
                           ...
                           FStar_List.fold_left
                             (fun s  ->
                                fun se1  ->
                                  ...
                                  Prims.op_Hat s uu____5692) "" ses'1
                            in
      ...
      let process_one_decl_timed acc se =
        ...
        | (uu____5972,uu____5973,env1,uu____5975) ->
            let r =
              let uu____6009 =
                let uu____6013 =
                  let uu____6015 = FStar_TypeChecker_Env.current_module env1
                     in
          ...
          | (univs1,t1) ->
              ((let uu____6264 =
               ...
               (let env2 = FStar_TypeChecker_Env.push_univ_vars env1 univs1
                ...
                FStar_All.pipe_right uu____6303 (fun uu____6312  -> ())))
           in
    ...
    fun m  ->
          ...
          | uu____6688 ->
              (match t.FStar_Syntax_Syntax.n with
               ...
               | uu____6727 ->
                   ...
                   FStar_Syntax_Syntax.mk uu____6728 r)
           in
              ...
              (let uu____6930 = FStar_Syntax_Util.is_pure_or_ghost_comp c  in
               ...
               then true
                 ...
                 (let uu____6937 = comp_effect_name c  in
                  FStar_TypeChecker_Env.is_reifiable_effect en uu____6937))
         in
      let extract_sigelt s =
        ...
        (match s.FStar_Syntax_Syntax.sigel with
                 ...
                 (FStar_List.fold_left
                    (fun sigelts1  ->
                       fun s1  ->
                         ...
                         | FStar_Syntax_Syntax.Sig_inductive_typ
                             (lid,uu____7060,uu____7061,uu____7062,uu____7063,uu____7064)
                             ->
                             ((let uu____7074 =
                                 let uu____7077 =
                              ...
                              (let uu____7126 = vals_of_abstract_inductive s1
                                  in
                               FStar_List.append uu____7126 sigelts1))
                         | FStar_Syntax_Syntax.Sig_datacon
                             (lid,uu____7130,uu____7131,uu____7132,uu____7133,uu____7134)
                             ->
                             ((let uu____7142 =
                                 let uu____7145 =
                                   FStar_ST.op_Bang
         ...
         | FStar_Syntax_Syntax.Sig_assume (lid,uu____7367,uu____7368) ->
             ...
             then
               let is_haseq_of_abstract_inductive =
                 let uu____7376 = FStar_ST.op_Bang abstract_inductive_tycons
                    in
                 FStar_List.existsML
                   (fun l  ->
                      let uu____7405 =
                        FStar_TypeChecker_TcInductive.get_haseq_axiom_lid l
                         in
                      FStar_Ident.lid_equals lid uu____7405) uu____7376
                  in
         ...
         | FStar_Syntax_Syntax.Sig_polymonadic_subcomp uu____7450 -> [s])
         in
      ...
      (let name =
       ...
       let env2 =
         FStar_TypeChecker_Env.set_current_module env1
           modul.FStar_Syntax_Syntax.name
          in
       let uu____7687 = tc_decls env2 modul.FStar_Syntax_Syntax.declarations
          in
              ...
              ((let uu____7891 =
                ...
                then
                  ...
                  let uu____7909 =
                    ...
                    then
                      let uu____7917 =
                        let uu____7919 = FStar_Syntax_Print.modul_to_string m
                           in
