  ...
  fun env ->
    fun se ->
      ...
      let get_n lid =
        ...
        then FStar_All.op_Bar_Greater n_opt FStar_Util.must
    ...
    fun ts ->
      fun r ->
        let uu___ =
          ...
          FStar_All.op_Bar_Greater uu___1 FStar_Pervasives_Native.fst in
            ...
            (let uu___1 =
             ...
             | (sig_bndle, tcs, datas) ->
                 ...
                 let data_ops_ses =
                   ...
                   FStar_All.op_Bar_Greater uu___2 FStar_List.flatten in
                 ((let uu___3 =
                   ...
                   let res =
                     ...
                     then (sig_bndle, data_ops_ses)
                       ...
                       (let is_unopteq =
                        ...
                        let uu___4 = FStar_List.op_At ses1 data_ops_ses in
                        (sig_bndle, uu___4)) in
                   res)))
let (tc_inductive :
  FStar_TypeChecker_Env.env ->
              ...
              (try
                 (fun uu___2 ->
                    ...
                    | () ->
                        ...
                        FStar_All.op_Bar_Greater uu___3 (fun r -> pop (); r))
                   ()
                   ...
                   (FStar_List.iter
                      (fun lb ->
                         ...
                         let has_iface_val =
                           ...
                           FStar_All.op_Bar_Greater iface_decls uu___2 in
                         if has_iface_val
                         then
                           let must_erase =
            ...
            let rename_parameters lb =
              let rename_in_typ def typ =
                ...
                | {
                    ...
                    FStar_Syntax_Syntax.vars = uu___;_} ->
                    let has_auto_name bv =
                      let uu___1 =
                        FStar_Ident.string_of_id
                          bv.FStar_Syntax_Syntax.ppname in
                      FStar_Util.starts_with uu___1
                    ...
                    let rec rename_binders def_bs1 val_bs1 =
                      ...
                      | ({ FStar_Syntax_Syntax.binder_bv = body_bv;
                           ...
                           FStar_Syntax_Syntax.binder_attrs = uu___2;_}::bt,
                         val_b::vt) ->
                          let uu___3 =
                            let uu___4 =
                              let uu___5 = has_auto_name body_bv in
                              let uu___6 =
                                has_auto_name
                          ...
                          let uu___4 = rename_binders bt vt in uu___3 ::
                            uu___4 in
                    let uu___1 =
                      let uu___2 =
                  ...
                  lb.FStar_Syntax_Syntax.lbtyp in
              {
                FStar_Syntax_Syntax.lbname =
                  (uu___.FStar_Syntax_Syntax.lbname);
                ...
                FStar_Syntax_Syntax.lbdef = (uu___.FStar_Syntax_Syntax.lbdef);
                FStar_Syntax_Syntax.lbattrs =
                  (uu___.FStar_Syntax_Syntax.lbattrs);
                ...
                (match uu___1 with
                 | (attrs, pre_tau) ->
                     ...
                     let e =
                       ...
                       FStar_Syntax_Syntax.mk uu___2 r in
                     let env' =
                       let uu___2 = env1 in
                       {
                         FStar_TypeChecker_Env.solver =
                     ...
                     let e1 =
                       ...
                       then
                         let drop_lbtyp e_lax =
                           let uu___3 =
                             let uu___4 = FStar_Syntax_Subst.compress e_lax in
                           ...
                           | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), e2)
                               ...
                               let lb_unannotated =
                                 let uu___4 =
                                   let uu___5 = FStar_Syntax_Subst.compress e in
                         ...
                         ((let uu___4 =
                          ...
                          (let e3 =
                             let uu___4 =
                               FStar_TypeChecker_Normalize.remove_uvar_solutions
                                 env' e2 in
                             FStar_All.op_Bar_Greater uu___4 drop_lbtyp in
                           (let uu___5 =
                              FStar_All.op_Less_Bar
                                (FStar_TypeChecker_Env.debug env1)
                                (FStar_Options.Other "TwoPhases") in
                                                   ...
                                                   let uu___10 =
                                                     let uu___11 =
                                                       let uu___12 =
                                                         FStar_Util.right
                                                           lb.FStar_Syntax_Syntax.lbname in
                                                       uu___12.FStar_Syntax_Syntax.fv_name in
                                                     uu___11.FStar_Syntax_Syntax.v in
                                                   FStar_TypeChecker_Env.try_lookup_val_decl
                                                     env1 uu___10 in
                                                 match uu___9 with
                                                 | FStar_Pervasives_Native.None
      ...
      proc_check_with se.FStar_Syntax_Syntax.sigattrs
        (fun uu___1 ->
                   ...
                   let uu___4 =
                     let uu___5 =
                       FStar_List.map FStar_Util.string_of_int
                         expected_errors in
                     FStar_All.op_Less_Bar (FStar_String.concat "; ") uu___5 in
               ...
               then
                 ...
                 (match uu___2 with
                  | (ses, ne1, lift_from_pure_opt) ->
                      ...
                      let uu___3 = FStar_List.op_At ses effect_and_lift_ses in
                      ([], uu___3, env0))
               else
                 (let ne1 =
           ...
           | FStar_Syntax_Syntax.Sig_declare_typ (uu___2, uu___3, uu___4)
               when
               FStar_All.op_Bar_Greater se1.FStar_Syntax_Syntax.sigquals
                 (FStar_Util.for_some
                    (fun uu___5 ->
                       match uu___5 with
                         ...
                         then
                           let uu___9 =
                             let uu___10 =
                               FStar_List.map
                                 FStar_Syntax_Print.sigelt_to_string ses in
                             FStar_All.op_Less_Bar (FStar_String.concat "\n")
                               uu___10 in
                           FStar_Util.print1
         ...
         | uu___1 ->
             ...
             (match se.FStar_Syntax_Syntax.sigel with
              ...
              | FStar_Syntax_Syntax.Sig_new_effect ne ->
                  ...
                  FStar_All.op_Bar_Greater ne.FStar_Syntax_Syntax.actions
                    (FStar_List.fold_left
                       (fun env3 ->
                          fun a ->
                            let uu___2 =
              ...
              ((let uu___4 =
               ...
               (let uu___6 =
                ...
                | (ses', ses_elaborated, env2) ->
                    ...
                    let ses_elaborated1 =
                      FStar_All.op_Bar_Greater ses_elaborated
                        (FStar_List.map
                           (fun se1 ->
                              (let uu___8 =
                                 FStar_TypeChecker_Env.debug env2
                    ...
                    (FStar_TypeChecker_Env.promote_id_info env2
                     ...
                     (let env3 =
                        FStar_All.op_Bar_Greater ses'1
                          (FStar_List.fold_left
                             (fun env4 ->
      ...
      fun decls ->
        ...
        | (ses, env1) ->
            let modul1 =
              let uu___1 = modul in
              let uu___2 =
                FStar_List.op_At modul.FStar_Syntax_Syntax.declarations ses in
              {
                FStar_Syntax_Syntax.name = (uu___1.FStar_Syntax_Syntax.name);
                FStar_Syntax_Syntax.declarations = uu___2;
                FStar_Syntax_Syntax.is_interface =
        ...
        fun m ->
          ...
          (let uu___1 =
             FStar_All.op_Bar_Greater
               env.FStar_TypeChecker_Env.qtbl_name_and_index
               FStar_Pervasives_Native.fst in
           FStar_All.op_Bar_Greater uu___1 FStar_Util.smap_clear);
          (let uu___2 =
             let uu___3 =
               let uu___4 =
