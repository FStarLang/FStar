...
let kunary = (fun ( k ) ( k' ) -> (let _52_4326 = (let _52_4325 = (let _52_4324 = (Microsoft_FStar_Absyn_Syntax.null_t_binder k)
in (_52_4324)::[])
in (_52_4325, k'))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _52_4326 Microsoft_FStar_Absyn_Syntax.dummyRange)))

let kbin = (fun ( k1 ) ( k2 ) ( k' ) -> (let _52_4337 = (let _52_4336 = (let _52_4335 = (Microsoft_FStar_Absyn_Syntax.null_t_binder k1)
...
let ktern = (fun ( k1 ) ( k2 ) ( k3 ) ( k' ) -> (let _52_4352 = (let _52_4351 = (let _52_4350 = (Microsoft_FStar_Absyn_Syntax.null_t_binder k1)
