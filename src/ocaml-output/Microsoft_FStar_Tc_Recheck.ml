...
(let _68_12020 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in (recompute_kind _68_12020))
end
...
(let _68_12022 = (let _68_12021 = (recompute_kind body)
in (binders, _68_12021))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _68_12022 t.Microsoft_FStar_Absyn_Syntax.pos))
end
...
| (_, []) -> begin
(let _68_12029 = (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (bs, k) t.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Prims.pipe_right _68_12029 (Microsoft_FStar_Absyn_Util.subst_kind subst)))
end
| (b::bs, a::args) -> begin
(let subst = (let _68_12030 = (Microsoft_FStar_Absyn_Util.subst_formal b a)
in (_68_12030)::subst)
in (aux subst bs args))
end
| _ -> begin
(let _68_12035 = (let _68_12034 = (Microsoft_FStar_Absyn_Print.kind_to_string k1)
in (let _68_12033 = (Microsoft_FStar_Absyn_Print.tag_of_typ t)
in (let _68_12032 = (Microsoft_FStar_Absyn_Print.kind_to_string k)
in (let _68_12031 = (Support.Prims.pipe_right (Support.List.length args) Support.Microsoft.FStar.Util.string_of_int)
in (Support.Microsoft.FStar.Util.format4 "Head kind is %s\nToo many arguments in type %s; result kind is %s\nwith %s remaining args\n" _68_12034 _68_12033 _68_12032 _68_12031)))))
in (failwith (_68_12035)))
end))
in (aux [] bs args))
end)))
end)
...
(let _68_12040 = (Microsoft_FStar_Absyn_Util.compress_exp e)
in (recompute_typ _68_12040))
end
...
(let _68_12043 = (let _68_12042 = (let _68_12041 = (recompute_typ body)
in (Microsoft_FStar_Absyn_Syntax.mk_Total _68_12041))
in (bs, _68_12042))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun _68_12043 None e.Microsoft_FStar_Absyn_Syntax.pos))
end
...
| (_, []) -> begin
(let _68_12050 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (bs, c) None e.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Prims.pipe_right _68_12050 (Microsoft_FStar_Absyn_Util.subst_typ subst)))
end
| (b::bs, a::args) -> begin
(let subst = (let _68_12051 = (Microsoft_FStar_Absyn_Util.subst_formal b a)
in (_68_12051)::subst)
in (aux subst bs args))
end
| _ -> begin
