...
(let _65_12018 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in (recompute_kind _65_12018))
end
...
(let _65_12020 = (let _65_12019 = (recompute_kind body)
in (binders, _65_12019))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow _65_12020 t.Microsoft_FStar_Absyn_Syntax.pos))
end
...
| (_, []) -> begin
(let _65_12027 = (Microsoft_FStar_Absyn_Syntax.mk_Kind_arrow (bs, k) t.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Prims.pipe_right _65_12027 (Microsoft_FStar_Absyn_Util.subst_kind subst)))
end
| (b::bs, a::args) -> begin
(let subst = (let _65_12028 = (Microsoft_FStar_Absyn_Util.subst_formal b a)
in (_65_12028)::subst)
in (aux subst bs args))
end
| _ -> begin
(let _65_12033 = (let _65_12032 = (Microsoft_FStar_Absyn_Print.kind_to_string k1)
in (let _65_12031 = (Microsoft_FStar_Absyn_Print.tag_of_typ t)
in (let _65_12030 = (Microsoft_FStar_Absyn_Print.kind_to_string k)
in (let _65_12029 = (Support.Prims.pipe_right (Support.List.length args) Support.Microsoft.FStar.Util.string_of_int)
in (Support.Microsoft.FStar.Util.format4 "Head kind is %s\nToo many arguments in type %s; result kind is %s\nwith %s remaining args\n" _65_12032 _65_12031 _65_12030 _65_12029)))))
in (failwith (_65_12033)))
end))
in (aux [] bs args))
end)))
end)
...
(let _65_12038 = (Microsoft_FStar_Absyn_Util.compress_exp e)
in (recompute_typ _65_12038))
end
...
(let _65_12041 = (let _65_12040 = (let _65_12039 = (recompute_typ body)
in (Microsoft_FStar_Absyn_Syntax.mk_Total _65_12039))
in (bs, _65_12040))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun _65_12041 None e.Microsoft_FStar_Absyn_Syntax.pos))
end
...
| (_, []) -> begin
(let _65_12048 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (bs, c) None e.Microsoft_FStar_Absyn_Syntax.pos)
in (Support.Prims.pipe_right _65_12048 (Microsoft_FStar_Absyn_Util.subst_typ subst)))
end
| (b::bs, a::args) -> begin
(let subst = (let _65_12049 = (Microsoft_FStar_Absyn_Util.subst_formal b a)
in (_65_12049)::subst)
in (aux subst bs args))
end
| _ -> begin
