...
in (Support.All.pipe_right _96_39 (Microsoft_FStar_Absyn_Util.subst_kind subst)))
end
| (b::bs, a::args) -> begin
...
in (let _96_41 = (Support.All.pipe_right (Support.List.length args) Support.Microsoft.FStar.Util.string_of_int)
...
in (Support.All.failwith _96_45))
end))
in (aux [] bs args))
end)))
end)
...
in (Support.All.pipe_right _96_60 (Microsoft_FStar_Absyn_Util.subst_typ subst)))
end
| (b::bs, a::args) -> begin
