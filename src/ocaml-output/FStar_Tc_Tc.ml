...
| true -> begin
(let _39_2695 = (let _104_1194 = (FStar_Absyn_Util.function_formals t)
...
in (let _39_2862 = (let _104_1239 = (let _104_1236 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit r)
in Some (_104_1236))
...
| (e, _39_2860, g) -> begin
(let _39_2863 = (let _104_1240 = (FStar_Tc_Rel.conj_guard g1 g)
...
in (let _39_3093 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.partition (fun lb -> ((FStar_Absyn_Util.is_pure_or_ghost_function lb.FStar_Absyn_Syntax.lbtyp) && (let _104_1273 = (FStar_Absyn_Util.is_lemma lb.FStar_Absyn_Syntax.lbtyp)
...
in (let _39_3182 = (match (((not (modul.FStar_Absyn_Syntax.is_interface)) || (let _104_1307 = (FStar_ST.read FStar_Options.admit_fsi)
...
let check_module = (fun env m -> (let _39_3205 = (match (((let _104_1326 = (FStar_ST.read FStar_Options.debug)
...
in (let _39_3212 = (let _104_1336 = (let _104_1335 = (let _104_1334 = (FStar_Absyn_Syntax.text_of_lid m.FStar_Absyn_Syntax.name)
