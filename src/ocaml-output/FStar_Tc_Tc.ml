...
in {FStar_Tc_Env.solver = _38_24.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_24.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_24.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_24.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_24.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_24.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_24.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_24.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_24.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = true; FStar_Tc_Env.instantiate_vargs = true; FStar_Tc_Env.effects = _38_24.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_24.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_24.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_24.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_24.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = _38_24.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = _38_24.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_24.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_24.FStar_Tc_Env.default_effects}))

let no_inst = (fun env -> (let _38_27 = env
in {FStar_Tc_Env.solver = _38_27.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_27.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_27.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_27.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_27.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_27.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_27.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_27.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_27.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = false; FStar_Tc_Env.instantiate_vargs = false; FStar_Tc_Env.effects = _38_27.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_27.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_27.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_27.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_27.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = _38_27.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = _38_27.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_27.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_27.FStar_Tc_Env.default_effects}))
...
in {FStar_Absyn_Syntax.eff_name = _38_132.FStar_Absyn_Syntax.eff_name; FStar_Absyn_Syntax.res_typ = t; FStar_Absyn_Syntax.cflags = _38_132.FStar_Absyn_Syntax.cflags; FStar_Absyn_Syntax.comp = (fun _38_134 -> (match (()) with
| () -> begin
...
in (let _38_158 = (match ((FStar_Tc_Env.expected_typ env)) with
| None -> begin
(e, lc, FStar_Tc_Rel.trivial_guard)
end
| Some (t') -> begin
(let _38_147 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in (let _38_151 = (FStar_Tc_Util.check_and_ascribe env e t t')
in (match (_38_151) with
| (e, g) -> begin
(let _38_154 = (let _104_125 = (FStar_All.pipe_left (fun _104_124 -> Some (_104_124)) (FStar_Tc_Errors.subtyping_failed env t t'))
...
| (e, lc, g) -> begin
(let _38_159 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
...
(let _38_187 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
...
in (let _38_195 = (let _104_144 = (expected_c'.FStar_Absyn_Syntax.comp ())
in (FStar_All.pipe_left (FStar_Tc_Util.check_comp env e c) _104_144))
in (match (_38_195) with
| (e, _38_193, g) -> begin
(let _38_196 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
...
| (e, l, g) -> begin
(e, l, (let _38_221 = g
in {FStar_Tc_Rel.guard_f = _38_221.FStar_Tc_Rel.guard_f; FStar_Tc_Rel.deferred = _38_221.FStar_Tc_Rel.deferred; FStar_Tc_Rel.implicits = (FStar_List.append imps g.FStar_Tc_Rel.implicits)}))
end))

let add_implicit = (fun u g -> (let _38_225 = g
in {FStar_Tc_Rel.guard_f = _38_225.FStar_Tc_Rel.guard_f; FStar_Tc_Rel.deferred = _38_225.FStar_Tc_Rel.deferred; FStar_Tc_Rel.implicits = (u)::g.FStar_Tc_Rel.implicits}))
...
(let _38_244 = (match ((FStar_Tc_Env.debug env FStar_Options.Medium)) with
| true -> begin
...
in (let _38_249 = (FStar_Tc_Env.clear_expected_typ env)
...
| FStar_Absyn_Syntax.Kind_abbrev ((l, args), {FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Kind_unknown; FStar_Absyn_Syntax.tk = _38_263; FStar_Absyn_Syntax.pos = _38_261; FStar_Absyn_Syntax.fvs = _38_259; FStar_Absyn_Syntax.uvs = _38_257}) -> begin
(let _38_272 = (FStar_Tc_Env.lookup_kind_abbrev env l)
...
| false -> begin
(let _38_308 = (FStar_List.fold_left2 (fun _38_279 b a -> (match (_38_279) with
| (subst, args, guards) -> begin
(match (((Prims.fst b), (Prims.fst a))) with
| (FStar_Util.Inl (a), FStar_Util.Inl (t)) -> begin
(let _38_289 = (let _104_220 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
...
| (k, f) -> begin
(let _38_322 = (FStar_All.pipe_left (tc_args env) (Prims.snd kabr))
...
and tc_vbinder = (fun env x -> (let _38_342 = (tc_typ_check env x.FStar_Absyn_Syntax.sort FStar_Absyn_Syntax.ktype)
in (match (_38_342) with
| (t, g) -> begin
(let x = (let _38_343 = x
in {FStar_Absyn_Syntax.v = _38_343.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = t; FStar_Absyn_Syntax.p = _38_343.FStar_Absyn_Syntax.p})
...
(match (b) with
| FStar_Util.Inl (a) -> begin
(let _38_362 = (tc_kind env a.FStar_Absyn_Syntax.sort)
in (match (_38_362) with
| (k, g) -> begin
(let b = (FStar_Util.Inl ((let _38_363 = a
in {FStar_Absyn_Syntax.v = _38_363.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = k; FStar_Absyn_Syntax.p = _38_363.FStar_Absyn_Syntax.p})), imp)
...
in (aux env bs)))
and tc_args = (fun env args -> (FStar_List.fold_right (fun _38_386 _38_389 -> (match ((_38_386, _38_389)) with
...
(let _38_410 = (tc_typ_check env t FStar_Absyn_Syntax.ktype)
...
in (let _38_418 = (tc_typ_check env tc FStar_Absyn_Syntax.keffect)
in (match (_38_418) with
| (tc, f) -> begin
(let _38_422 = (FStar_Absyn_Util.head_and_args tc)
in (match (_38_422) with
| (_38_420, args) -> begin
(let _38_434 = (match (args) with
| (FStar_Util.Inl (res), _38_427)::args -> begin
(res, args)
end
| _38_431 -> begin
(FStar_All.failwith "Impossible")
...
| (res, args) -> begin
(let _38_450 = (let _104_261 = (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_List.map (fun _38_3 -> (match (_38_3) with
| FStar_Absyn_Syntax.DECREASES (e) -> begin
(let _38_441 = (FStar_Tc_Env.clear_expected_typ env)
...
| (flags, guards) -> begin
(let _104_263 = (FStar_Absyn_Syntax.mk_Comp (let _38_451 = c
in {FStar_Absyn_Syntax.effect_name = _38_451.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = res; FStar_Absyn_Syntax.effect_args = args; FStar_Absyn_Syntax.flags = _38_451.FStar_Absyn_Syntax.flags}))
...
in {FStar_Absyn_Syntax.v = _38_463.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = k; FStar_Absyn_Syntax.p = _38_463.FStar_Absyn_Syntax.p})
in (let t = (FStar_All.pipe_left (w k) (FStar_Absyn_Syntax.mk_Typ_btvar a))
in (let _38_470 = (FStar_Tc_Util.maybe_instantiate_typ env t k)
...
in {FStar_Absyn_Syntax.v = _38_475.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = qk; FStar_Absyn_Syntax.p = _38_475.FStar_Absyn_Syntax.p})
...
in {FStar_Absyn_Syntax.v = _38_482.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = qk; FStar_Absyn_Syntax.p = _38_482.FStar_Absyn_Syntax.p})
...
in {FStar_Absyn_Syntax.v = _38_492.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = k; FStar_Absyn_Syntax.p = _38_492.FStar_Absyn_Syntax.p})
in (let t = (FStar_Absyn_Syntax.mk_Typ_const i (Some (k)) t.FStar_Absyn_Syntax.pos)
in (let _38_499 = (FStar_Tc_Util.maybe_instantiate_typ env t k)
...
in (let _38_550 = (match ((FStar_Absyn_Util.is_smt_lemma t)) with
| true -> begin
(match (cod.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Comp ({FStar_Absyn_Syntax.effect_name = _38_533; FStar_Absyn_Syntax.result_typ = _38_531; FStar_Absyn_Syntax.effect_args = (FStar_Util.Inl (pre), _38_527)::(FStar_Util.Inl (post), _38_522)::(FStar_Util.Inr (pats), _38_517)::[]; FStar_Absyn_Syntax.flags = _38_513}) -> begin
(let fvs = (FStar_Absyn_Util.freevars_exp pats)
in (match ((FStar_All.pipe_right bs (FStar_Util.find_opt (fun _38_540 -> (match (_38_540) with
| (b, _38_539) -> begin
(match (b) with
| FStar_Util.Inl (a) -> begin
...
| (x, env, f1) -> begin
(let _38_576 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in (let _38_580 = (tc_typ_check env phi FStar_Absyn_Syntax.ktype)
...
(let _38_585 = (match ((FStar_Tc_Env.debug env FStar_Options.Extreme)) with
| true -> begin
...
in (let _38_593 = (match ((FStar_Tc_Env.debug env FStar_Options.Extreme)) with
| true -> begin
...
| FStar_Absyn_Syntax.Kind_uvar (_38_598) -> begin
...
in (let _38_608 = (let _104_321 = (FStar_Tc_Rel.keq env None k1 kar)
...
in (let _38_681 = (let _104_337 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
...
(let formal = (FStar_List.hd formals)
in (let _38_710 = (let _104_338 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
...
in (let _38_731 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in {FStar_Tc_Env.solver = _38_733.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_733.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_733.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_733.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_733.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_733.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_733.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_733.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_733.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_733.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_733.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_733.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_733.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_733.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_733.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_733.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = (is_eq aqual); FStar_Tc_Env.is_iface = _38_733.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_733.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_733.FStar_Tc_Env.default_effects}) t formal_k)
in (match (_38_737) with
| (t, g') -> begin
(let _38_738 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in {FStar_Tc_Env.solver = _38_754.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_754.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_754.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_754.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_754.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_754.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_754.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_754.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_754.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_754.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_754.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_754.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_754.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_754.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_754.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_754.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = (is_eq aqual); FStar_Tc_Env.is_iface = _38_754.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_754.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_754.FStar_Tc_Env.default_effects})
in (let _38_757 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
| ((FStar_Util.Inl (a), _38_770), (FStar_Util.Inr (v), imp)) -> begin
...
| ((FStar_Util.Inr (_38_782), _38_785), (FStar_Util.Inl (_38_788), _38_791)) -> begin
...
| ([], _38_800) -> begin
(let _104_361 = (let _104_360 = (let _104_359 = (let _104_358 = (let _104_356 = (let _104_355 = (FStar_All.pipe_right outargs (FStar_List.filter (fun _38_4 -> (match (_38_4) with
| (_38_804, Some (FStar_Absyn_Syntax.Implicit)) -> begin
false
end
| _38_809 -> begin
true
...
| (FStar_Absyn_Syntax.Typ_uvar (_38_813), FStar_Absyn_Syntax.Kind_arrow (formals, k)) when ((FStar_List.length args) = (FStar_List.length formals)) -> begin
...
| (k1, g) -> begin
(let _38_855 = (FStar_Tc_Rel.new_tvar s.FStar_Absyn_Syntax.pos [] k1)
in (match (_38_855) with
| (_38_853, u') -> begin
(let _38_856 = (FStar_Absyn_Util.unchecked_unify u u')
in (u', k1, g))
end))
end))
end
...
| FStar_Absyn_Syntax.Typ_uvar (_38_861, k1) -> begin
(let s = (FStar_Absyn_Util.compress_typ t)
in (match (s.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_uvar (u, k1) -> begin
(let _38_870 = (match ((FStar_All.pipe_left (FStar_Tc_Env.debug env) FStar_Options.High)) with
| true -> begin
...
| _38_873 -> begin
(let _38_874 = (match ((FStar_All.pipe_left (FStar_Tc_Env.debug env) FStar_Options.High)) with
| true -> begin
...
(let _38_913 = (tc_typ_check env qbody FStar_Absyn_Syntax.ktype)
...
| FStar_Absyn_Syntax.Exp_uvar (_38_937, t1) -> begin
(value_check_expected_typ env e (FStar_Util.Inl (t1)))
end
| FStar_Absyn_Syntax.Exp_bvar (x) -> begin
(let t = (FStar_Tc_Env.lookup_bvar env x)
in (let e = (FStar_Absyn_Syntax.mk_Exp_bvar (let _38_944 = x
in {FStar_Absyn_Syntax.v = _38_944.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = t; FStar_Absyn_Syntax.p = _38_944.FStar_Absyn_Syntax.p}) (Some (t)) e.FStar_Absyn_Syntax.pos)
in (let _38_950 = (FStar_Tc_Util.maybe_instantiate env e t)
...
in (let e = (FStar_Absyn_Syntax.mk_Exp_fvar ((let _38_957 = v
in {FStar_Absyn_Syntax.v = _38_957.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = t; FStar_Absyn_Syntax.p = _38_957.FStar_Absyn_Syntax.p}), dc) (Some (t)) e.FStar_Absyn_Syntax.pos)
in (let _38_963 = (FStar_Tc_Util.maybe_instantiate env e t)
...
| None -> begin
(let _38_994 = (match (env.FStar_Tc_Env.letrecs) with
| [] -> begin
()
end
| _38_993 -> begin
...
(let _38_1028 = (match (env.FStar_Tc_Env.letrecs) with
| [] -> begin
()
end
| _38_1027 -> begin
...
| (bs, envbody, g) -> begin
(let _38_1037 = (FStar_Tc_Env.clear_expected_typ envbody)
...
| ((FStar_Util.Inl (_38_1062), _38_1065), (FStar_Util.Inr (_38_1068), _38_1071)) -> begin
(let env = (maybe_push_binding env hdannot)
in (tc_binders ((hdannot)::out, env, g, subst) tl_annot c bs))
end
| ((FStar_Util.Inl (a), _38_1078), (FStar_Util.Inl (b), imp)) -> begin
(let ka = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in (let _38_1096 = (match (b.FStar_Absyn_Syntax.sort.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_unknown -> begin
(ka, FStar_Tc_Rel.trivial_guard)
end
| _38_1088 -> begin
(let _38_1091 = (tc_kind env b.FStar_Absyn_Syntax.sort)
...
| (k, g) -> begin
(let b = (FStar_Util.Inl ((let _38_1097 = b
in {FStar_Absyn_Syntax.v = _38_1097.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = k; FStar_Absyn_Syntax.p = _38_1097.FStar_Absyn_Syntax.p})), imp)
in (let env = (maybe_push_binding env b)
in (let subst = (maybe_alpha_subst subst hdannot b)
in (tc_binders ((b)::out, env, g, subst) tl_annot c tl))))
end)))
end
| ((FStar_Util.Inr (x), _38_1105), (FStar_Util.Inr (y), imp)) -> begin
(let tx = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (let _38_1127 = (match ((let _104_429 = (FStar_Absyn_Util.unmeta_typ y.FStar_Absyn_Syntax.sort)
in _104_429.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Typ_unknown -> begin
(tx, g)
end
| _38_1115 -> begin
(let _38_1116 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in (let _38_1122 = (tc_typ env y.FStar_Absyn_Syntax.sort)
...
| (t, g) -> begin
(let b = (FStar_Util.Inr ((let _38_1128 = y
in {FStar_Absyn_Syntax.v = _38_1128.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = t; FStar_Absyn_Syntax.p = _38_1128.FStar_Absyn_Syntax.p})), imp)
in (let env = (maybe_push_binding env b)
in (let subst = (maybe_alpha_subst subst hdannot b)
in (tc_binders ((b)::out, env, g, subst) tl_annot c tl))))
end)))
...
| {FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Typ_fun (bs_annot, c'); FStar_Absyn_Syntax.tk = _38_1146; FStar_Absyn_Syntax.pos = _38_1144; FStar_Absyn_Syntax.fvs = _38_1142; FStar_Absyn_Syntax.uvs = _38_1140} -> begin
...
| letrecs -> begin
(let _38_1163 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in {FStar_Tc_Env.solver = _38_1166.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_1166.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_1166.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_1166.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_1166.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_1166.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_1166.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_1166.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_1166.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_1166.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_1166.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_1166.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_1166.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = []; FStar_Tc_Env.top_level = _38_1166.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_1166.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = _38_1166.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = _38_1166.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_1166.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_1166.FStar_Tc_Env.default_effects})
in (let filter_types_and_functions = (fun bs -> (FStar_All.pipe_right bs (FStar_List.collect (fun b -> (match (b) with
| (FStar_Util.Inl (_38_1173), _38_1176) -> begin
[]
end
| (FStar_Util.Inr (x), _38_1181) -> begin
...
| FStar_Absyn_Syntax.Typ_fun (_38_1184) -> begin
[]
end
| _38_1187 -> begin
...
in (let as_lex_list = (fun dec -> (let _38_1194 = (FStar_Absyn_Util.head_and_args_e dec)
in (match (_38_1194) with
| (head, _38_1193) -> begin
(match (head.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_fvar (fv, _38_1197) when (FStar_Absyn_Syntax.lid_equals fv.FStar_Absyn_Syntax.v FStar_Absyn_Const.lexcons_lid) -> begin
dec
end
| _38_1201 -> begin
(mk_lex_list ((dec)::[]))
...
in (match ((FStar_All.pipe_right ct.FStar_Absyn_Syntax.flags (FStar_List.tryFind (fun _38_6 -> (match (_38_6) with
| FStar_Absyn_Syntax.DECREASES (_38_1205) -> begin
true
end
| _38_1208 -> begin
false
...
(let _38_1212 = (match (((FStar_List.length bs') <> (FStar_List.length actuals))) with
| true -> begin
...
| ((FStar_Util.Inl (formal), _38_1220), (FStar_Util.Inl (actual), _38_1225)) -> begin
...
| ((FStar_Util.Inr (formal), _38_1231), (FStar_Util.Inr (actual), _38_1236)) -> begin
...
in (let letrecs = (FStar_All.pipe_right letrecs (FStar_List.map (fun _38_1252 -> (match (_38_1252) with
| (l, t0) -> begin
...
in (let precedes = (match ((FStar_All.pipe_right ct.FStar_Absyn_Syntax.flags (FStar_List.tryFind (fun _38_7 -> (match (_38_7) with
| FStar_Absyn_Syntax.DECREASES (_38_1268) -> begin
true
end
| _38_1271 -> begin
false
...
in (let bs = (FStar_List.append bs (((FStar_Util.Inr ((let _38_1288 = x
in {FStar_Absyn_Syntax.v = _38_1288.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = refined_domain; FStar_Absyn_Syntax.p = _38_1288.FStar_Absyn_Syntax.p})), imp))::[]))
in (let t' = (FStar_Absyn_Syntax.mk_Typ_fun (bs, c) None r)
in (let _38_1292 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
...
in (let _38_1299 = (let _104_489 = (let _104_488 = (FStar_Tc_Env.clear_expected_typ env)
...
in (let _104_495 = (FStar_All.pipe_right letrecs (FStar_List.fold_left (fun env _38_1308 -> (match (_38_1308) with
| (x, t) -> begin
(FStar_Tc_Env.push_local_binding env (binding_of_lb x t))
end)) env))
in (let _104_494 = (FStar_All.pipe_right letrecs (FStar_List.collect (fun _38_8 -> (match (_38_8) with
...
in (let _38_1320 = (tc_binders ([], env, FStar_Tc_Rel.trivial_guard, []) bs' c bs)
in (match (_38_1320) with
| (bs, envbody, g, c) -> begin
(let _38_1323 = (match ((FStar_Options.should_verify env.FStar_Tc_Env.curmodule.FStar_Absyn_Syntax.str)) with
| true -> begin
...
| FStar_Absyn_Syntax.Typ_refine (b, _38_1327) -> begin
(let _38_1337 = (as_function_typ norm b.FStar_Absyn_Syntax.sort)
...
in (let _38_1352 = (FStar_Tc_Env.clear_expected_typ env)
...
in {FStar_Tc_Env.solver = _38_1360.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_1360.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_1360.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_1360.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_1360.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_1360.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_1360.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_1360.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_1360.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_1360.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_1360.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_1360.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_1360.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_1360.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = false; FStar_Tc_Env.check_uvars = _38_1360.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = use_eq; FStar_Tc_Env.is_iface = _38_1360.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_1360.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_1360.FStar_Tc_Env.default_effects}) body)
in (match (_38_1365) with
| (body, cbody, guard_body) -> begin
(let _38_1366 = (match ((FStar_Tc_Env.debug env FStar_Options.Medium)) with
| true -> begin
...
in (let _38_1369 = (match ((FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Implicits")))) with
| true -> begin
...
in (let _38_1376 = (let _104_502 = (let _104_501 = (cbody.FStar_Absyn_Syntax.comp ())
in (body, _104_501))
in (check_expected_effect (let _38_1371 = envbody
in {FStar_Tc_Env.solver = _38_1371.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_1371.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_1371.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_1371.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_1371.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_1371.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_1371.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_1371.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_1371.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_1371.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_1371.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_1371.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_1371.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_1371.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_1371.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_1371.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = use_eq; FStar_Tc_Env.is_iface = _38_1371.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_1371.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_1371.FStar_Tc_Env.default_effects}) c_opt _104_502))
...
| true -> begin
(let _38_1378 = (let _104_503 = (FStar_Tc_Rel.conj_guard g guard)
in (FStar_Tc_Util.discharge_guard envbody _104_503))
in (let _38_1380 = FStar_Tc_Rel.trivial_guard
in {FStar_Tc_Rel.guard_f = _38_1380.FStar_Tc_Rel.guard_f; FStar_Tc_Rel.deferred = _38_1380.FStar_Tc_Rel.deferred; FStar_Tc_Rel.implicits = guard.FStar_Tc_Rel.implicits}))
end
| false -> begin
...
(let t = (FStar_Absyn_Util.compress_typ t)
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_fun (_38_1392) -> begin
...
| (e, tfun, guard) -> begin
(let _38_1404 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
...
in (let _38_1409 = (let _104_516 = (FStar_Tc_Util.lcomp_of_comp c)
...
in (let _38_1415 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
...
in (let top = e
in (match (e.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_delayed (_38_1421) -> begin
...
| FStar_Absyn_Syntax.Exp_ascribed (e1, t1, _38_1441) -> begin
(let _38_1446 = (tc_typ_check env t1 FStar_Absyn_Syntax.ktype)
in (match (_38_1446) with
| (t1, f) -> begin
(let _38_1450 = (let _104_548 = (FStar_Tc_Env.set_expected_typ env t1)
in (tc_exp _104_548 e1))
in (match (_38_1450) with
| (e1, c, g) -> begin
(let _38_1454 = (let _104_552 = (FStar_Tc_Env.set_range env t1.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Util.strengthen_precondition (Some ((fun _38_1451 -> (match (()) with
| () -> begin
...
| FStar_Absyn_Syntax.Exp_let ((_38_1465, {FStar_Absyn_Syntax.lbname = x; FStar_Absyn_Syntax.lbtyp = _38_1470; FStar_Absyn_Syntax.lbeff = _38_1468; FStar_Absyn_Syntax.lbdef = e1}::[]), e2) -> begin
(let _38_1481 = (let _104_560 = (FStar_Tc_Env.set_expected_typ env FStar_Tc_Recheck.t_unit)
...
in (let _38_1508 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
| FStar_Absyn_Syntax.Exp_fvar (fv, _38_1519) when (((FStar_Absyn_Syntax.lid_equals fv.FStar_Absyn_Syntax.v FStar_Absyn_Const.op_And) || (FStar_Absyn_Syntax.lid_equals fv.FStar_Absyn_Syntax.v FStar_Absyn_Const.op_Or)) && (n_args = 2)) -> begin
(let env = (FStar_Tc_Env.set_expected_typ env FStar_Absyn_Util.t_bool)
in (match (args) with
| (FStar_Util.Inr (e1), _38_1531)::(FStar_Util.Inr (e2), _38_1526)::[] -> begin
...
in (let _38_1552 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
| (FStar_Util.Inl (t), _38_1585)::_38_1581 -> begin
...
in (let _38_1608 = (let _104_615 = (let _104_614 = (FStar_Absyn_Syntax.mk_Typ_fun (bs, cres) (Some (FStar_Absyn_Syntax.ktype)) tf.FStar_Absyn_Syntax.pos)
...
(match ((bs, args)) with
| ((FStar_Util.Inl (a), Some (FStar_Absyn_Syntax.Implicit))::rest, (_38_1639, None)::_38_1637) -> begin
(let k = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in (let _38_1645 = (fxv_check head env (FStar_Util.Inl (k)) fvs)
in (let _38_1649 = (let _104_656 = (let _104_655 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _104_655))
in (FStar_Tc_Rel.new_tvar _104_656 vars k))
in (match (_38_1649) with
| (targ, u) -> begin
(let _38_1650 = (match ((FStar_Tc_Env.debug env FStar_Options.Extreme)) with
| true -> begin
...
| ((FStar_Util.Inr (x), Some (FStar_Absyn_Syntax.Implicit))::rest, (_38_1664, None)::_38_1662) -> begin
(let t = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (let _38_1670 = (fxv_check head env (FStar_Util.Inr (t)) fvs)
in (let _38_1674 = (FStar_Tc_Util.new_implicit_evar env t)
...
(let _38_1690 = (match ((FStar_Tc_Env.debug env FStar_Options.Extreme)) with
| true -> begin
...
in (let _38_1693 = (fxv_check head env (FStar_Util.Inl (k)) fvs)
in (let _38_1699 = (tc_typ_check (let _38_1695 = env
in {FStar_Tc_Env.solver = _38_1695.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_1695.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_1695.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_1695.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_1695.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_1695.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_1695.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_1695.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_1695.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_1695.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_1695.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_1695.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_1695.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_1695.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_1695.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_1695.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = (is_eq aqual); FStar_Tc_Env.is_iface = _38_1695.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_1695.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_1695.FStar_Tc_Env.default_effects}) t k)
...
in {FStar_Tc_Rel.guard_f = f; FStar_Tc_Rel.deferred = _38_1701.FStar_Tc_Rel.deferred; FStar_Tc_Rel.implicits = _38_1701.FStar_Tc_Rel.implicits})
...
(let _38_1719 = (match ((FStar_Tc_Env.debug env FStar_Options.Extreme)) with
| true -> begin
...
in (let _38_1722 = (match ((FStar_Tc_Env.debug env FStar_Options.Extreme)) with
| true -> begin
...
in (let _38_1724 = (fxv_check head env (FStar_Util.Inr (targ)) fvs)
in (let env = (FStar_Tc_Env.set_expected_typ env targ)
in (let env = (let _38_1727 = env
in {FStar_Tc_Env.solver = _38_1727.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_1727.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_1727.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_1727.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_1727.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_1727.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_1727.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_1727.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_1727.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_1727.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_1727.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_1727.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_1727.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_1727.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_1727.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_1727.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = (is_eq aqual); FStar_Tc_Env.is_iface = _38_1727.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_1727.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_1727.FStar_Tc_Env.default_effects})
in (let _38_1730 = (match (((FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("EQ"))) && env.FStar_Tc_Env.use_eq)) with
| true -> begin
...
in (let _38_1732 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in (let _38_1739 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in (let _38_1746 = (((Some (FStar_Tc_Env.Binding_var ((x.FStar_Absyn_Syntax.v, targ))), c))::comps, g)
...
| ((FStar_Util.Inr (_38_1753), _38_1756)::_38_1751, (FStar_Util.Inl (_38_1762), _38_1765)::_38_1760) -> begin
...
| ((FStar_Util.Inl (_38_1772), _38_1775)::_38_1770, (FStar_Util.Inr (_38_1781), _38_1784)::_38_1779) -> begin
...
| (_38_1789, []) -> begin
(let _38_1792 = (fxv_check head env (FStar_Util.Inr (cres.FStar_Absyn_Syntax.res_typ)) fvs)
in (let _38_1810 = (match (bs) with
| [] -> begin
(let cres = (FStar_Tc_Util.subst_lcomp subst cres)
in (let g = (FStar_Tc_Rel.conj_guard g_head g)
in (let refine_with_equality = ((FStar_Absyn_Util.is_pure_or_ghost_lcomp cres) && (FStar_All.pipe_right comps (FStar_Util.for_some (fun _38_1800 -> (match (_38_1800) with
| (_38_1798, c) -> begin
...
| false -> begin
(let _38_1802 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
...
| (cres, g) -> begin
(let _38_1811 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
...
in (let _38_1820 = (FStar_Tc_Util.strengthen_precondition None env app comp g)
in (match (_38_1820) with
| (comp, g) -> begin
(let _38_1821 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
...
(let _38_1837 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
...
| (e, c, g) -> begin
(let _38_1849 = (match ((FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Implicits")))) with
| true -> begin
...
in (let _38_1856 = (match ((FStar_Tc_Env.debug env FStar_Options.Extreme)) with
| true -> begin
...
(let _38_1868 = (FStar_Tc_Env.clear_expected_typ env)
...
in (let _38_1897 = (let _38_1894 = (FStar_List.fold_right (fun _38_1888 _38_1891 -> (match ((_38_1888, _38_1891)) with
...
(let _38_1898 = (match ((FStar_Tc_Env.debug env FStar_Options.Extreme)) with
| true -> begin
...
in (let _104_797 = (let _104_796 = (let _104_795 = (FStar_List.map (fun _38_1908 -> (match (_38_1908) with
...
| FStar_Absyn_Syntax.Exp_let ((false, {FStar_Absyn_Syntax.lbname = x; FStar_Absyn_Syntax.lbtyp = t; FStar_Absyn_Syntax.lbeff = _38_1913; FStar_Absyn_Syntax.lbdef = e1}::[]), e2) -> begin
(let env = (instantiate_both env)
in (let env0 = env
in (let topt = (FStar_Tc_Env.expected_typ env)
in (let top_level = (match (x) with
| FStar_Util.Inr (_38_1926) -> begin
true
end
| _38_1929 -> begin
false
end)
in (let _38_1934 = (FStar_Tc_Env.clear_expected_typ env)
in (match (_38_1934) with
| (env1, _38_1933) -> begin
(let _38_1947 = (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_unknown -> begin
...
| false -> begin
(let _38_1940 = (tc_typ_check env1 t FStar_Absyn_Syntax.ktype)
in (match (_38_1940) with
| (t, f) -> begin
(let _38_1941 = (match ((FStar_Tc_Env.debug env FStar_Options.Medium)) with
| true -> begin
...
in {FStar_Tc_Env.solver = _38_1948.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_1948.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_1948.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_1948.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_1948.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_1948.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_1948.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_1948.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_1948.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_1948.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_1948.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_1948.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_1948.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_1948.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = top_level; FStar_Tc_Env.check_uvars = _38_1948.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = _38_1948.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = _38_1948.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_1948.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_1948.FStar_Tc_Env.default_effects}) e1)
in (match (_38_1953) with
| (e1, c1, g1) -> begin
(let _38_1957 = (let _104_807 = (FStar_Tc_Env.set_range env t.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Util.strengthen_precondition (Some ((fun _38_1954 -> (match (()) with
| () -> begin
FStar_Tc_Errors.ill_kinded_type
...
| (c1, guard_f) -> begin
(match (x) with
| FStar_Util.Inr (_38_1959) -> begin
(let _38_1970 = (match ((FStar_Options.should_verify env.FStar_Tc_Env.curmodule.FStar_Absyn_Syntax.str)) with
| true -> begin
(let _38_1963 = (let _104_808 = (FStar_Tc_Rel.conj_guard g1 guard_f)
...
| false -> begin
(let _38_1964 = (match ((FStar_ST.read FStar_Options.warn_top_level_effects)) with
| true -> begin
...
| false -> begin
(let _38_1966 = (let _104_811 = (FStar_Tc_Rel.conj_guard g1 guard_f)
...
| (e2, c1) -> begin
(let _38_1975 = (match (env.FStar_Tc_Env.generalize) with
| true -> begin
...
in (let _38_1978 = (FStar_ST.op_Colon_Equals e2.FStar_Absyn_Syntax.tk (Some (FStar_Tc_Recheck.t_unit)))
...
in (let _38_1986 = (let _104_825 = (FStar_Tc_Env.push_local_binding env b)
...
in (let _38_1995 = (let _104_844 = (FStar_Tc_Rel.teq env tres t)
...
| FStar_Absyn_Syntax.Exp_let ((false, _38_2001), _38_2004) -> begin
(FStar_All.failwith "impossible")
end
| FStar_Absyn_Syntax.Exp_let ((true, lbs), e1) -> begin
(let env = (instantiate_both env)
in (let _38_2016 = (FStar_Tc_Env.clear_expected_typ env)
in (match (_38_2016) with
| (env0, topt) -> begin
(let is_inner_let = (FStar_All.pipe_right lbs (FStar_Util.for_some (fun _38_9 -> (match (_38_9) with
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inl (_38_2025); FStar_Absyn_Syntax.lbtyp = _38_2023; FStar_Absyn_Syntax.lbeff = _38_2021; FStar_Absyn_Syntax.lbdef = _38_2019} -> begin
true
end
| _38_2029 -> begin
false
end))))
in (let _38_2056 = (FStar_All.pipe_right lbs (FStar_List.fold_left (fun _38_2033 _38_2039 -> (match ((_38_2033, _38_2039)) with
| ((xts, env), {FStar_Absyn_Syntax.lbname = x; FStar_Absyn_Syntax.lbtyp = t; FStar_Absyn_Syntax.lbeff = _38_2036; FStar_Absyn_Syntax.lbdef = e}) -> begin
(let _38_2044 = (FStar_Tc_Util.extract_lb_annotation env t e)
...
| true -> begin
(let _38_2046 = (match ((FStar_All.pipe_left (FStar_Tc_Env.debug env) FStar_Options.High)) with
| true -> begin
...
in {FStar_Tc_Env.solver = _38_2048.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_2048.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_2048.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_2048.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_2048.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_2048.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_2048.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_2048.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_2048.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_2048.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_2048.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_2048.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_2048.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_2048.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_2048.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = true; FStar_Tc_Env.use_eq = _38_2048.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = _38_2048.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_2048.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_2048.FStar_Tc_Env.default_effects}) t FStar_Absyn_Syntax.ktype)
...
| true -> begin
(let _38_2051 = env
in {FStar_Tc_Env.solver = _38_2051.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_2051.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_2051.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_2051.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_2051.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_2051.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_2051.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_2051.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_2051.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_2051.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_2051.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_2051.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_2051.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = ((x, t))::env.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_2051.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_2051.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = _38_2051.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = _38_2051.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_2051.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_2051.FStar_Tc_Env.default_effects})
end
| false -> begin
(FStar_Tc_Env.push_local_binding env (binding_of_lb x t))
end)
...
| (lbs, env') -> begin
(let _38_2071 = (let _104_855 = (let _104_854 = (FStar_All.pipe_right lbs FStar_List.rev)
in (FStar_All.pipe_right _104_854 (FStar_List.map (fun _38_2060 -> (match (_38_2060) with
| (x, t, e) -> begin
(let t = (FStar_Tc_Normalize.norm_typ ((FStar_Tc_Normalize.Beta)::[]) env t)
in (let _38_2062 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in (let _38_2090 = (match (((not (env.FStar_Tc_Env.generalize)) || is_inner_let)) with
| true -> begin
(let _104_857 = (FStar_List.map (fun _38_2076 -> (match (_38_2076) with
| (x, t, e) -> begin
...
| false -> begin
(let _38_2077 = (FStar_Tc_Util.discharge_guard env g_lbs)
in (let ecs = (let _104_861 = (FStar_All.pipe_right lbs (FStar_List.map (fun _38_2082 -> (match (_38_2082) with
| (x, t, e) -> begin
...
in (let _104_863 = (FStar_List.map (fun _38_2087 -> (match (_38_2087) with
| (x, e, c) -> begin
...
in (let _38_2092 = (FStar_Tc_Util.discharge_guard env g_lbs)
in (let _38_2094 = (FStar_ST.op_Colon_Equals e1.FStar_Absyn_Syntax.tk (Some (FStar_Tc_Recheck.t_unit)))
...
| false -> begin
(let _38_2110 = (FStar_All.pipe_right lbs (FStar_List.fold_left (fun _38_2098 _38_2105 -> (match ((_38_2098, _38_2105)) with
| ((bindings, env), {FStar_Absyn_Syntax.lbname = x; FStar_Absyn_Syntax.lbtyp = t; FStar_Absyn_Syntax.lbeff = _38_2102; FStar_Absyn_Syntax.lbdef = _38_2100}) -> begin
...
in {FStar_Absyn_Syntax.eff_name = _38_2118.FStar_Absyn_Syntax.eff_name; FStar_Absyn_Syntax.res_typ = tres; FStar_Absyn_Syntax.cflags = _38_2118.FStar_Absyn_Syntax.cflags; FStar_Absyn_Syntax.comp = _38_2118.FStar_Absyn_Syntax.comp})
...
in (match ((FStar_All.pipe_right lbs (FStar_List.tryFind (fun _38_10 -> (match (_38_10) with
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inr (_38_2135); FStar_Absyn_Syntax.lbtyp = _38_2133; FStar_Absyn_Syntax.lbeff = _38_2131; FStar_Absyn_Syntax.lbdef = _38_2129} -> begin
false
end
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inl (x); FStar_Absyn_Syntax.lbtyp = _38_2143; FStar_Absyn_Syntax.lbeff = _38_2141; FStar_Absyn_Syntax.lbdef = _38_2139} -> begin
(FStar_Util.set_mem (FStar_Absyn_Util.bvd_to_bvar_s x FStar_Absyn_Syntax.tun) fvs.FStar_Absyn_Syntax.fxvs)
end))))) with
| Some ({FStar_Absyn_Syntax.lbname = FStar_Util.Inl (y); FStar_Absyn_Syntax.lbtyp = _38_2152; FStar_Absyn_Syntax.lbeff = _38_2150; FStar_Absyn_Syntax.lbdef = _38_2148}) -> begin
(let t' = (FStar_Tc_Util.new_tvar env0 FStar_Absyn_Syntax.ktype)
in (let _38_2158 = (let _104_875 = (FStar_Tc_Rel.teq env tres t')
...
(let tc_pat = (fun allow_implicits pat_t p0 -> (let _38_2176 = (FStar_Tc_Util.pat_as_exps allow_implicits env p0)
in (match (_38_2176) with
| (bindings, exps, p) -> begin
(let pat_env = (FStar_List.fold_left FStar_Tc_Env.push_local_binding env bindings)
in (let _38_2185 = (match ((FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Pat")))) with
| true -> begin
(FStar_All.pipe_right bindings (FStar_List.iter (fun _38_11 -> (match (_38_11) with
...
in (let _38_2190 = (FStar_Tc_Env.clear_expected_typ pat_env)
in (match (_38_2190) with
| (env1, _38_2189) -> begin
(let env1 = (let _38_2191 = env1
in {FStar_Tc_Env.solver = _38_2191.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_2191.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_2191.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_2191.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_2191.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_2191.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_2191.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_2191.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = true; FStar_Tc_Env.instantiate_targs = _38_2191.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_2191.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_2191.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_2191.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_2191.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_2191.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_2191.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = _38_2191.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = _38_2191.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_2191.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_2191.FStar_Tc_Env.default_effects})
in (let expected_pat_t = (FStar_Tc_Rel.unrefine env pat_t)
in (let exps = (FStar_All.pipe_right exps (FStar_List.map (fun e -> (let _38_2196 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
| (e, lc, g) -> begin
(let _38_2202 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in (let _38_2206 = (let _104_894 = (FStar_Tc_Rel.solve_deferred_constraints env g)
in (FStar_All.pipe_left Prims.ignore _104_894))
in (let e' = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env e)
in (let _38_2209 = (match ((let _104_897 = (let _104_896 = (FStar_Absyn_Util.uvars_in_exp e')
...
in (let _38_2211 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in (let _38_2222 = (match ((FStar_All.pipe_left (FStar_Tc_Env.debug env) (FStar_Options.Other ("Pat")))) with
| true -> begin
(FStar_All.pipe_right bindings (FStar_List.iter (fun _38_12 -> (match (_38_12) with
| FStar_Tc_Env.Binding_var (x, t) -> begin
...
| false -> begin
(let _38_2236 = (let _104_907 = (FStar_Tc_Env.set_expected_typ pat_env FStar_Tc_Recheck.t_bool)
...
in (let _38_2252 = (let _104_910 = (FStar_Tc_Env.push_local_binding env (FStar_Tc_Env.Binding_var ((scrutinee_x, pat_t))))
...
| FStar_Absyn_Syntax.Exp_constant (_38_2324) -> begin
...
| FStar_Absyn_Syntax.Exp_fvar (f, _38_2328) -> begin
(discriminate scrutinee f)
end
| FStar_Absyn_Syntax.Exp_app ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Exp_fvar (f, _38_2341); FStar_Absyn_Syntax.tk = _38_2338; FStar_Absyn_Syntax.pos = _38_2336; FStar_Absyn_Syntax.fvs = _38_2334; FStar_Absyn_Syntax.uvs = _38_2332}, args) -> begin
...
in (let _38_2369 = (tc_typ_check scrutinee_env t FStar_Absyn_Syntax.mk_Kind_type)
...
in (let _38_2377 = (match ((FStar_Tc_Env.debug env FStar_Options.High)) with
| true -> begin
...
in (match ((FStar_Tc_Rel.sub_comp (let _38_2423 = env
in {FStar_Tc_Env.solver = _38_2423.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_2423.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_2423.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_2423.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_2423.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_2423.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_2423.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_2423.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_2423.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_2423.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_2423.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_2423.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_2423.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_2423.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_2423.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_2423.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = false; FStar_Tc_Env.is_iface = _38_2423.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_2423.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_2423.FStar_Tc_Env.default_effects}) c expected_c)) with
| Some (g') -> begin
...
| (tps, env, g) -> begin
(let _38_2435 = (FStar_Tc_Util.force_trivial env g)
in (tps, env))
end)))

let a_kwp_a = (fun env m s -> (match (s.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_arrow ((FStar_Util.Inl (a), _38_2454)::(FStar_Util.Inl (wp), _38_2449)::(FStar_Util.Inl (_38_2441), _38_2444)::[], _38_2458) -> begin
...
let rec tc_eff_decl = (fun env m -> (let _38_2468 = (tc_binders env m.FStar_Absyn_Syntax.binders)
in (match (_38_2468) with
| (binders, env, g) -> begin
(let _38_2469 = (FStar_Tc_Util.discharge_guard env g)
in (let mk = (tc_kind_trivial env m.FStar_Absyn_Syntax.signature)
in (let _38_2474 = (a_kwp_a env m.FStar_Absyn_Syntax.mname mk)
...
in (let _38_2508 = (let expected_k = (let _104_1144 = (let _104_1143 = (let _104_1142 = (let _104_1141 = (FStar_Absyn_Syntax.t_binder a)
...
(let _38_2527 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.refresh ())
in (let _38_2529 = (let _104_1166 = (FStar_Options.reset_options ())
...
(let _38_2544 = (let _104_1167 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.source)
in (a_kwp_a env sub.FStar_Absyn_Syntax.source _104_1167))
in (match (_38_2544) with
| (a, kwp_a_src) -> begin
(let _38_2547 = (let _104_1168 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.target)
...
in {FStar_Absyn_Syntax.source = _38_2551.FStar_Absyn_Syntax.source; FStar_Absyn_Syntax.target = _38_2551.FStar_Absyn_Syntax.target; FStar_Absyn_Syntax.lift = lift})
...
in (let _38_2573 = (match ((FStar_Tc_Env.debug env FStar_Options.Extreme)) with
| true -> begin
...
in (let _38_2591 = (match ((FStar_Absyn_Util.compress_kind k)) with
| {FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Kind_uvar (_38_2586); FStar_Absyn_Syntax.tk = _38_2584; FStar_Absyn_Syntax.pos = _38_2582; FStar_Absyn_Syntax.fvs = _38_2580; FStar_Absyn_Syntax.uvs = _38_2578} -> begin
...
| (c, g) -> begin
(let tags = (FStar_All.pipe_right tags (FStar_List.map (fun _38_13 -> (match (_38_13) with
...
in (FStar_All.pipe_right _104_1189 (fun _38_2645 -> (match (_38_2645) with
| (t, k) -> begin
...
in (let _38_2653 = (let _104_1191 = (FStar_Tc_Rel.keq env' (Some (t)) k1 k2)
...
in (let _38_2683 = (match ((FStar_Absyn_Util.function_formals t)) with
...
| true -> begin
(let _38_2695 = (let _104_1194 = (FStar_Absyn_Util.function_formals t)
in (FStar_All.pipe_right _104_1194 FStar_Util.must))
in (match (_38_2695) with
| (formals, _38_2694) -> begin
(FStar_All.pipe_right formals (FStar_List.iter (fun _38_2699 -> (match (_38_2699) with
| (a, _38_2698) -> begin
(match (a) with
| FStar_Util.Inl (_38_2701) -> begin
()
end
| FStar_Util.Inr (y) -> begin
(let t = y.FStar_Absyn_Syntax.sort
in (FStar_Absyn_Visit.collect_from_typ (fun b t -> (match ((let _104_1198 = (FStar_Absyn_Util.compress_typ t)
in _104_1198.FStar_Absyn_Syntax.n)) with
...
| Some (tname) -> begin
(let _104_1204 = (let _104_1203 = (let _104_1202 = (let _104_1200 = (let _104_1199 = (FStar_Absyn_Syntax.range_of_lid lid)
in (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid _104_1199))
in (FStar_Tc_Errors.constructor_fails_the_positivity_check env _104_1200 tname))
in (let _104_1201 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_104_1202, _104_1201)))
in FStar_Absyn_Syntax.Error (_104_1203))
in (Prims.raise _104_1204))
end)
end
| _38_2714 -> begin
()
...
in (let _38_2715 = (FStar_All.pipe_right formals (FStar_List.iter positivity_check))
in (let _38_2722 = (match ((FStar_Absyn_Util.destruct result_t tname)) with
| Some (_38_2718) -> begin
()
end
| _38_2721 -> begin
(let _104_1211 = (let _104_1210 = (let _104_1209 = (let _104_1207 = (let _104_1205 = (FStar_Absyn_Syntax.range_of_lid lid)
in (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid _104_1205))
in (let _104_1206 = (FStar_Absyn_Util.ftv tname FStar_Absyn_Syntax.kun)
in (FStar_Tc_Errors.constructor_builds_the_wrong_type env _104_1207 result_t _104_1206)))
in (let _104_1208 = (FStar_Absyn_Syntax.range_of_lid lid)
in (_104_1209, _104_1208)))
in FStar_Absyn_Syntax.Error (_104_1210))
in (Prims.raise _104_1211))
end)
in (let se = FStar_Absyn_Syntax.Sig_datacon ((lid, t, tycon, quals, mutuals, r))
in (let env = (FStar_Tc_Env.push_sigelt env se)
in (let _38_2726 = (match ((log env)) with
| true -> begin
(let _104_1213 = (let _104_1212 = (FStar_Tc_Normalize.typ_norm_to_string env t)
in (FStar_Util.format2 "data %s : %s\n" lid.FStar_Absyn_Syntax.str _104_1212))
in (FStar_All.pipe_left FStar_Util.print_string _104_1213))
end
| false -> begin
()
end)
...
(let env = (FStar_Tc_Env.set_range env r)
in (let t = (let _104_1214 = (tc_typ_check_trivial env t FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _104_1214 (FStar_Tc_Normalize.norm_typ ((FStar_Tc_Normalize.Beta)::(FStar_Tc_Normalize.SNComp)::[]) env)))
in (let _38_2736 = (FStar_Tc_Util.check_uvars r t)
in (let se = FStar_Absyn_Syntax.Sig_val_decl ((lid, t, quals, r))
in (let env = (FStar_Tc_Env.push_sigelt env se)
in (let _38_2740 = (match ((log env)) with
| true -> begin
(let _104_1216 = (let _104_1215 = (FStar_Tc_Normalize.typ_norm_to_string env t)
in (FStar_Util.format2 "val %s : %s\n" lid.FStar_Absyn_Syntax.str _104_1215))
in (FStar_All.pipe_left FStar_Util.print_string _104_1216))
end
| false -> begin
()
end)
...
(let env = (FStar_Tc_Env.set_range env r)
in (let phi = (let _104_1217 = (tc_typ_check_trivial env phi FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _104_1217 (norm_t env)))
in (let _38_2750 = (FStar_Tc_Util.check_uvars r phi)
...
(let env = (FStar_Tc_Env.set_range env r)
in (let _38_2803 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.fold_left (fun _38_2763 lb -> (match (_38_2763) with
| (gen, lbs) -> begin
(let _38_2800 = (match (lb) with
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inl (_38_2772); FStar_Absyn_Syntax.lbtyp = _38_2770; FStar_Absyn_Syntax.lbeff = _38_2768; FStar_Absyn_Syntax.lbdef = _38_2766} -> begin
(FStar_All.failwith "impossible")
end
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inr (l); FStar_Absyn_Syntax.lbtyp = t; FStar_Absyn_Syntax.lbeff = _38_2777; FStar_Absyn_Syntax.lbdef = e} -> begin
(let _38_2797 = (match ((FStar_Tc_Env.try_lookup_val_decl env l)) with
| None -> begin
(gen, lb)
end
| Some (t', _38_2785) -> begin
(let _38_2788 = (match ((FStar_Tc_Env.debug env FStar_Options.Medium)) with
| true -> begin
(let _104_1220 = (FStar_Absyn_Print.typ_to_string t')
in (FStar_Util.fprint2 "Using annotation %s for let binding %s\n" _104_1220 l.FStar_Absyn_Syntax.str))
end
| false -> begin
()
end)
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_unknown -> begin
(let _104_1221 = (FStar_Absyn_Syntax.mk_lb (FStar_Util.Inr (l), FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _104_1221))
end
| _38_2792 -> begin
(let _38_2793 = (match ((not (deserialized))) with
| true -> begin
(let _104_1223 = (let _104_1222 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "%s: Warning: Annotation from val declaration overrides inline type annotation\n" _104_1222))
in (FStar_All.pipe_left FStar_Util.print_string _104_1223))
end
| false -> begin
()
end)
in (let _104_1224 = (FStar_Absyn_Syntax.mk_lb (FStar_Util.Inr (l), FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _104_1224)))
end))
end)
...
in (let e = (let _104_1229 = (let _104_1228 = (let _104_1227 = (syn' env FStar_Tc_Recheck.t_unit)
in (FStar_All.pipe_left _104_1227 (FStar_Absyn_Syntax.mk_Exp_constant FStar_Absyn_Syntax.Const_unit)))
in (((Prims.fst lbs), lbs'), _104_1228))
in (FStar_Absyn_Syntax.mk_Exp_let _104_1229 None r))
in (let _38_2838 = (match ((tc_exp (let _38_2806 = env
in {FStar_Tc_Env.solver = _38_2806.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_2806.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_2806.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_2806.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_2806.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_2806.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_2806.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_2806.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_2806.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_2806.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_2806.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_2806.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = generalize; FStar_Tc_Env.letrecs = _38_2806.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_2806.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_2806.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = _38_2806.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = _38_2806.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _38_2806.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _38_2806.FStar_Tc_Env.default_effects}) e)) with
| ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Exp_let (lbs, e); FStar_Absyn_Syntax.tk = _38_2815; FStar_Absyn_Syntax.pos = _38_2813; FStar_Absyn_Syntax.fvs = _38_2811; FStar_Absyn_Syntax.uvs = _38_2809}, _38_2822, g) when (FStar_Tc_Rel.is_trivial g) -> begin
(let quals = (match (e.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (_38_2826, FStar_Absyn_Syntax.MaskedEffect)) -> begin
...
| true -> begin
(let _104_1235 = (let _104_1234 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let should_log = (match ((let _104_1231 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (FStar_Tc_Env.try_lookup_val_decl env _104_1231))) with
| None -> begin
true
end
| _38_2842 -> begin
...
| true -> begin
(let _104_1233 = (FStar_Absyn_Print.lbname_to_string lb.FStar_Absyn_Syntax.lbname)
in (let _104_1232 = (FStar_Tc_Normalize.typ_norm_to_string env lb.FStar_Absyn_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" _104_1233 _104_1232)))
end
| false -> begin
""
end)))))
in (FStar_All.pipe_right _104_1234 (FStar_String.concat "\n")))
...
in (let _38_2862 = (let _104_1239 = (let _104_1236 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit r)
in Some (_104_1236))
in (let _104_1238 = (let _104_1237 = (c.FStar_Absyn_Syntax.comp ())
in (e, _104_1237))
in (check_expected_effect env _104_1239 _104_1238)))
in (match (_38_2862) with
| (e, _38_2860, g) -> begin
(let _38_2863 = (let _104_1240 = (FStar_Tc_Rel.conj_guard g1 g)
in (FStar_Tc_Util.discharge_guard env _104_1240))
...
(let env = (FStar_Tc_Env.set_range env r)
in (let _38_2882 = (FStar_All.pipe_right ses (FStar_List.partition (fun _38_14 -> (match (_38_14) with
| FStar_Absyn_Syntax.Sig_tycon (_38_2876) -> begin
true
end
| _38_2879 -> begin
false
...
| (tycons, rest) -> begin
(let _38_2891 = (FStar_All.pipe_right rest (FStar_List.partition (fun _38_15 -> (match (_38_15) with
| FStar_Absyn_Syntax.Sig_typ_abbrev (_38_2885) -> begin
true
end
| _38_2888 -> begin
false
...
| (abbrevs, rest) -> begin
(let recs = (FStar_All.pipe_right abbrevs (FStar_List.map (fun _38_16 -> (match (_38_16) with
| FStar_Absyn_Syntax.Sig_typ_abbrev (lid, tps, k, t, [], r) -> begin
(let k = (match (k.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_unknown -> begin
(let _104_1244 = (FStar_Tc_Rel.new_kvar r tps)
in (FStar_All.pipe_right _104_1244 Prims.fst))
end
| _38_2903 -> begin
k
end)
...
in (let _38_2910 = (FStar_List.split recs)
in (match (_38_2910) with
| (recs, abbrev_defs) -> begin
(let msg = (match ((FStar_ST.read FStar_Options.logQueries)) with
| true -> begin
(let _104_1245 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (FStar_Util.format1 "Recursive bindings: %s" _104_1245))
end
| false -> begin
""
end)
in (let _38_2912 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.push msg)
...
(let tt = (let _104_1248 = (FStar_Absyn_Syntax.mk_Typ_ascribed (t, k) t.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.close_with_lam tps _104_1248))
in (let _38_2948 = (tc_typ_trivial env1 tt)
in (match (_38_2948) with
| (tt, _38_2947) -> begin
(let _38_2957 = (match (tt.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_lam (bs, t) -> begin
(bs, t)
end
| _38_2954 -> begin
...
| (tps, t) -> begin
(let _104_1250 = (let _104_1249 = (FStar_Absyn_Util.compress_kind k)
in (lid, tps, _104_1249, t, [], r))
in FStar_Absyn_Syntax.Sig_typ_abbrev (_104_1250))
end))
end)))
end
| _38_2959 -> begin
(let _104_1252 = (let _104_1251 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "(%s) Impossible" _104_1251))
in (FStar_All.failwith _104_1252))
end)) recs abbrev_defs)
in (let _38_2961 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.pop msg)
...
and tc_decls = (fun for_export env ses deserialized -> (let _38_2985 = (FStar_All.pipe_right ses (FStar_List.fold_left (fun _38_2972 se -> (match (_38_2972) with
| (ses, all_non_private, env) -> begin
(let _38_2974 = (match ((FStar_Tc_Env.debug env FStar_Options.Low)) with
| true -> begin
(let _104_1260 = (let _104_1259 = (FStar_Absyn_Print.sigelt_to_string se)
in (FStar_Util.format1 "Checking sigelt\t%s\n" _104_1259))
in (FStar_Util.print_string _104_1260))
end
| false -> begin
()
end)
...
| (se, env) -> begin
(let _38_2979 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.encode_sig env se)
...
| (ses, all_non_private, env) -> begin
(let _104_1261 = (FStar_All.pipe_right (FStar_List.rev all_non_private) FStar_List.flatten)
in ((FStar_List.rev ses), _104_1261, env))
end)))
and non_private = (fun env se -> (let is_private = (fun quals -> (FStar_List.contains FStar_Absyn_Syntax.Private quals))
in (match (se) with
| FStar_Absyn_Syntax.Sig_bundle (ses, quals, _38_2993, _38_2995) -> begin
(se)::[]
end
| FStar_Absyn_Syntax.Sig_tycon (_38_2999, _38_3001, _38_3003, _38_3005, _38_3007, quals, r) -> begin
...
| FStar_Absyn_Syntax.Sig_assume (_38_3021, _38_3023, quals, _38_3026) -> begin
(match ((is_private quals)) with
| true -> begin
[]
end
...
| FStar_Absyn_Syntax.Sig_val_decl (_38_3030, _38_3032, quals, _38_3035) -> begin
(match ((is_private quals)) with
| true -> begin
[]
end
...
| FStar_Absyn_Syntax.Sig_main (_38_3039) -> begin
[]
end
...
| FStar_Absyn_Syntax.Sig_datacon (_38_3057) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Absyn_Syntax.Sig_let (lbs, r, l, _38_3063) -> begin
(let check_priv = (fun lbs -> (let is_priv = (fun _38_17 -> (match (_38_17) with
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inr (l); FStar_Absyn_Syntax.lbtyp = _38_3074; FStar_Absyn_Syntax.lbeff = _38_3072; FStar_Absyn_Syntax.lbdef = _38_3070} -> begin
...
| true -> begin
(match ((FStar_All.pipe_right lbs (FStar_Util.for_some (fun x -> (let _104_1271 = (is_priv x)
in (FStar_All.pipe_right _104_1271 Prims.op_Negation)))))) with
| true -> begin
...
in (let _38_3093 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.partition (fun lb -> ((FStar_Absyn_Util.is_pure_or_ghost_function lb.FStar_Absyn_Syntax.lbtyp) && (let _104_1273 = (FStar_Absyn_Util.is_lemma lb.FStar_Absyn_Syntax.lbtyp)
in (FStar_All.pipe_left Prims.op_Negation _104_1273))))))
...
| FStar_Util.Inl (_38_3121) -> begin
(FStar_All.failwith "impossible")
end
| FStar_Util.Inr (l) -> begin
(let _104_1277 = (let _104_1276 = (let _104_1275 = (FStar_Absyn_Syntax.range_of_lid l)
in (l, lb.FStar_Absyn_Syntax.lbtyp, (FStar_Absyn_Syntax.Assumption)::[], _104_1275))
in FStar_Absyn_Syntax.Sig_val_decl (_104_1276))
in (_104_1277)::[])
end))))
end)
end
...
let get_exports = (fun env modul non_private_decls -> (let assume_vals = (fun decls -> (FStar_All.pipe_right decls (FStar_List.map (fun _38_18 -> (match (_38_18) with
| FStar_Absyn_Syntax.Sig_val_decl (lid, t, quals, r) -> begin
...
| false -> begin
(let exports = (let _104_1289 = (FStar_Tc_Env.modules env)
in (FStar_Util.find_map _104_1289 (fun m -> (match ((m.FStar_Absyn_Syntax.is_interface && (FStar_Absyn_Syntax.lid_equals modul.FStar_Absyn_Syntax.name m.FStar_Absyn_Syntax.name))) with
| true -> begin
(let _104_1288 = (FStar_All.pipe_right m.FStar_Absyn_Syntax.exports assume_vals)
in Some (_104_1288))
end
| false -> begin
None
...
in (let _104_1294 = (not ((FStar_Options.should_verify modul.FStar_Absyn_Syntax.name.FStar_Absyn_Syntax.str)))
in {FStar_Tc_Env.solver = _38_3150.FStar_Tc_Env.solver; FStar_Tc_Env.range = _38_3150.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _38_3150.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _38_3150.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _38_3150.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _38_3150.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _38_3150.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _38_3150.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _38_3150.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _38_3150.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _38_3150.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _38_3150.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _38_3150.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _38_3150.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _38_3150.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _38_3150.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = _38_3150.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = modul.FStar_Absyn_Syntax.is_interface; FStar_Tc_Env.admit = _104_1294; FStar_Tc_Env.default_effects = _38_3150.FStar_Tc_Env.default_effects}))
in (let _38_3153 = (match ((not ((FStar_Absyn_Syntax.lid_equals modul.FStar_Absyn_Syntax.name FStar_Absyn_Const.prims_lid)))) with
| true -> begin
...
in (let _38_3159 = (tc_decls true env modul.FStar_Absyn_Syntax.declarations modul.FStar_Absyn_Syntax.is_deserialized)
in (match (_38_3159) with
| (ses, non_private_decls, env) -> begin
((let _38_3160 = modul
in {FStar_Absyn_Syntax.name = _38_3160.FStar_Absyn_Syntax.name; FStar_Absyn_Syntax.declarations = ses; FStar_Absyn_Syntax.exports = _38_3160.FStar_Absyn_Syntax.exports; FStar_Absyn_Syntax.is_interface = _38_3160.FStar_Absyn_Syntax.is_interface; FStar_Absyn_Syntax.is_deserialized = _38_3160.FStar_Absyn_Syntax.is_deserialized}), non_private_decls, env)
end))))))))
...
in {FStar_Absyn_Syntax.name = _38_3169.FStar_Absyn_Syntax.name; FStar_Absyn_Syntax.declarations = (FStar_List.append modul.FStar_Absyn_Syntax.declarations ses); FStar_Absyn_Syntax.exports = _38_3169.FStar_Absyn_Syntax.exports; FStar_Absyn_Syntax.is_interface = _38_3169.FStar_Absyn_Syntax.is_interface; FStar_Absyn_Syntax.is_deserialized = _38_3169.FStar_Absyn_Syntax.is_deserialized})
...
in {FStar_Absyn_Syntax.name = _38_3176.FStar_Absyn_Syntax.name; FStar_Absyn_Syntax.declarations = _38_3176.FStar_Absyn_Syntax.declarations; FStar_Absyn_Syntax.exports = exports; FStar_Absyn_Syntax.is_interface = modul.FStar_Absyn_Syntax.is_interface; FStar_Absyn_Syntax.is_deserialized = modul.FStar_Absyn_Syntax.is_deserialized})
in (let env = (FStar_Tc_Env.finish_module env modul)
in (let _38_3186 = (match ((not ((FStar_Absyn_Syntax.lid_equals modul.FStar_Absyn_Syntax.name FStar_Absyn_Const.prims_lid)))) with
| true -> begin
(let _38_3180 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.pop (Prims.strcat "Ending modul " modul.FStar_Absyn_Syntax.name.FStar_Absyn_Syntax.str))
in (let _38_3182 = (match (((not (modul.FStar_Absyn_Syntax.is_interface)) || (let _104_1307 = (FStar_ST.read FStar_Options.admit_fsi)
in (FStar_List.contains modul.FStar_Absyn_Syntax.name.FStar_Absyn_Syntax.str _104_1307)))) with
| true -> begin
...
in (let _38_3184 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.refresh ())
in (let _104_1308 = (FStar_Options.reset_options ())
in (FStar_All.pipe_right _104_1308 Prims.ignore)))))
end
| false -> begin
()
end)
...
in (let _38_3200 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.encode_sig env elt)
in env)))
in (let en = (FStar_Tc_Env.set_current_module en m.FStar_Absyn_Syntax.name)
in (let _104_1321 = (FStar_List.fold_left do_sigelt en m.FStar_Absyn_Syntax.exports)
in (FStar_Tc_Env.finish_module _104_1321 m)))))

let check_module = (fun env m -> (let _38_3205 = (match (((let _104_1326 = (FStar_ST.read FStar_Options.debug)
in (FStar_List.length _104_1326)) <> 0)) with
| true -> begin
(let _104_1327 = (FStar_Absyn_Print.sli m.FStar_Absyn_Syntax.name)
...
in (let _38_3218 = (match (m.FStar_Absyn_Syntax.is_deserialized) with
| true -> begin
...
| (m, env) -> begin
(let _38_3214 = (match ((FStar_ST.read FStar_Options.serialize_mods)) with
| true -> begin
(let c_file_name = (let _104_1333 = (let _104_1332 = (let _104_1330 = (let _104_1329 = (let _104_1328 = (FStar_Options.get_fstar_home ())
in (Prims.strcat _104_1328 "/"))
in (Prims.strcat _104_1329 FStar_Options.cache_dir))
in (Prims.strcat _104_1330 "/"))
in (let _104_1331 = (FStar_Absyn_Syntax.text_of_lid m.FStar_Absyn_Syntax.name)
in (Prims.strcat _104_1332 _104_1331)))
in (Prims.strcat _104_1333 ".cache"))
in (let _38_3212 = (let _104_1336 = (let _104_1335 = (let _104_1334 = (FStar_Absyn_Syntax.text_of_lid m.FStar_Absyn_Syntax.name)
in (Prims.strcat "Serializing module " _104_1334))
in (Prims.strcat _104_1335 "\n"))
in (FStar_Util.print_string _104_1336))
in (let _104_1337 = (FStar_Util.get_owriter c_file_name)
in (FStar_Absyn_SSyntax.serialize_modul _104_1337 m))))
end
| false -> begin
()
end)
...
| (m, env) -> begin
(let _38_3219 = (match ((FStar_Options.should_dump m.FStar_Absyn_Syntax.name.FStar_Absyn_Syntax.str)) with
| true -> begin
(let _104_1338 = (FStar_Absyn_Print.modul_to_string m)
in (FStar_Util.fprint1 "%s\n" _104_1338))
end
| false -> begin
()
