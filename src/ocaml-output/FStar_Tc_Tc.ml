...
let _47_154 = (let _147_119 = (FStar_All.pipe_left (fun _147_118 -> Some (_147_118)) (FStar_Tc_Errors.subtyping_failed env t t'))
...
let _47_195 = (let _147_138 = (expected_c'.FStar_Absyn_Syntax.comp ())
...
let _47_289 = (let _147_216 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
...
let _47_459 = (let _147_262 = (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_List.map (fun _47_3 -> (match (_47_3) with
...
let _47_662 = (let _147_327 = (FStar_Tc_Rel.keq env None k1 kar)
...
let _47_743 = (let _147_343 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
...
let _47_776 = (let _147_346 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
...
| ([], _47_866) -> begin
(let _147_371 = (let _147_370 = (let _147_369 = (let _147_368 = (let _147_366 = (let _147_365 = (FStar_All.pipe_right outargs (FStar_List.filter (fun _47_4 -> (match (_47_4) with
...
let _47_1178 = (match ((let _147_439 = (FStar_Absyn_Util.unmeta_typ y.FStar_Absyn_Syntax.sort)
...
let _47_1350 = (let _147_499 = (let _147_498 = (FStar_Tc_Env.clear_expected_typ env)
...
in (let _147_505 = (FStar_All.pipe_right letrecs (FStar_List.fold_left (fun env _47_1359 -> (match (_47_1359) with
| (x, t) -> begin
(FStar_Tc_Env.push_local_binding env (binding_of_lb x t))
end)) env))
in (let _147_504 = (FStar_All.pipe_right letrecs (FStar_List.collect (fun _47_8 -> (match (_47_8) with
...
let _47_1429 = (let _147_513 = (FStar_Tc_Rel.conj_guard g guard)
...
let _47_1460 = (let _147_526 = (FStar_Tc_Util.lcomp_of_comp c)
...
let _47_1501 = (let _147_558 = (FStar_Tc_Env.set_expected_typ env t1)
in (tc_exp _147_558 e1))
in (match (_47_1501) with
| (e1, c, g) -> begin
(

let _47_1505 = (let _147_562 = (FStar_Tc_Env.set_range env t1.FStar_Absyn_Syntax.pos)
...
let _47_1509 = (let _147_566 = (let _147_565 = (w c)
...
let _47_1519 = (let _147_575 = (FStar_Tc_Env.set_expected_typ env pats_t)
...
let _47_1546 = (let _147_578 = (FStar_Tc_Env.set_expected_typ env FStar_Tc_Recheck.t_unit)
...
let _47_1673 = (let _147_633 = (let _147_632 = (FStar_Absyn_Syntax.mk_Typ_fun ((bs), (cres)) (Some (FStar_Absyn_Syntax.ktype)) tf.FStar_Absyn_Syntax.pos)
...
let _47_1716 = (let _147_648 = (let _147_647 = (FStar_List.hd args)
...
in (let _147_761 = (let _147_760 = (let _147_759 = (FStar_List.map (fun _47_1977 -> (match (_47_1977) with
...
let _47_2026 = (let _147_771 = (FStar_Tc_Env.set_range env t.FStar_Absyn_Syntax.pos)
...
let _47_2032 = (let _147_772 = (FStar_Tc_Rel.conj_guard g1 guard_f)
...
let _47_2058 = (let _147_788 = (FStar_Tc_Env.push_local_binding env b)
...
let _47_2067 = (let _147_807 = (FStar_Tc_Rel.teq env tres t)
...
let _47_2141 = (let _147_817 = (let _147_816 = (FStar_All.pipe_right lbs FStar_List.rev)
in (FStar_All.pipe_right _147_816 (FStar_List.map (fun _47_2130 -> (match (_47_2130) with
| (x, t, e) -> begin
(
...
(let _147_819 = (FStar_List.map (fun _47_2146 -> (match (_47_2146) with
| (x, t, e) -> begin
...
let ecs = (let _147_822 = (FStar_All.pipe_right lbs (FStar_List.map (fun _47_2152 -> (match (_47_2152) with
| (x, t, e) -> begin
...
in (let _147_824 = (FStar_List.map (fun _47_2157 -> (match (_47_2157) with
| (x, e, c) -> begin
...
let _47_2228 = (let _147_836 = (FStar_Tc_Rel.teq env tres t')
...
let _47_2276 = (let _147_856 = (FStar_Tc_Rel.solve_deferred_constraints env g)
...
let _47_2279 = if (let _147_859 = (let _147_858 = (FStar_Absyn_Util.uvars_in_exp e')
...
let _47_2304 = (let _147_868 = (FStar_Tc_Env.set_expected_typ pat_env FStar_Tc_Recheck.t_bool)
...
let _47_2320 = (let _147_871 = (FStar_Tc_Env.push_local_binding env (FStar_Tc_Env.Binding_var (((scrutinee_x), (pat_t)))))
...
let _47_2601 = (let _147_1125 = (FStar_Options.restore_cmd_line_options false)
...
let _47_2623 = (let _147_1126 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.source)
in (a_kwp_a env sub.FStar_Absyn_Syntax.source _147_1126))
in (match (_47_2623) with
| (a, kwp_a_src) -> begin
(

let _47_2626 = (let _147_1127 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.target)
...
let _47_2727 = (let _147_1148 = (tc_typ_trivial env' t)
in (FStar_All.pipe_right _147_1148 (fun _47_2724 -> (match (_47_2724) with
| (t, k) -> begin
...
let _47_2732 = (let _147_1150 = (FStar_Tc_Rel.keq env' (Some (t)) k1 k2)
...
let _47_2810 = (let _147_1167 = (FStar_Absyn_Util.function_formals t)
...
let _47_3005 = (let _147_1209 = (let _147_1206 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit r)
in Some (_147_1206))
...
let _47_3006 = (let _147_1210 = (FStar_Tc_Rel.conj_guard g1 g)
...
let _47_3116 = (let _147_1232 = (FStar_Absyn_Print.sigelt_to_string_short se)
