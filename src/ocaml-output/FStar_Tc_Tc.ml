...
open Prims
# 30 "FStar.Tc.Tc.fst"
let syn' = (fun env k -> (let _126_11 = (FStar_Tc_Env.get_range env)
in (FStar_Absyn_Syntax.syn _126_11 (Some (k)))))

# 31 "FStar.Tc.Tc.fst"
let log : FStar_Tc_Env.env  ->  Prims.bool = (fun env -> ((FStar_ST.read FStar_Options.log_types) && (not ((let _126_14 = (FStar_Tc_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Absyn_Const.prims_lid _126_14))))))
...
in (let _126_34 = (let _126_33 = (let _126_32 = (let _126_27 = (let _126_26 = (FStar_Tc_Recheck.recompute_typ v)
in (FStar_All.pipe_left (fun _126_25 -> FStar_Util.Inl (_126_25)) _126_26))
in (_126_27, Some (FStar_Absyn_Syntax.Implicit (false))))
in (let _126_31 = (let _126_30 = (FStar_Absyn_Syntax.varg v)
in (let _126_29 = (let _126_28 = (FStar_Absyn_Syntax.varg tl)
in (_126_28)::[])
in (_126_30)::_126_29))
in (_126_32)::_126_31))
in (FStar_Absyn_Util.lex_pair, _126_33))
in (FStar_Absyn_Syntax.mk_Exp_app _126_34 (Some (FStar_Absyn_Util.lex_t)) r)))) vs FStar_Absyn_Util.lex_top))
...
# 47 "FStar.Tc.Tc.fst"
let norm_t : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun env t -> (let _126_47 = (steps env)
in (FStar_Tc_Normalize.norm_typ _126_47 env t)))

# 48 "FStar.Tc.Tc.fst"
let norm_k : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.knd = (fun env k -> (let _126_52 = (steps env)
in (FStar_Tc_Normalize.norm_kind _126_52 env k)))

# 49 "FStar.Tc.Tc.fst"
let norm_c : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.comp  ->  FStar_Absyn_Syntax.comp = (fun env c -> (let _126_57 = (steps env)
in (FStar_Tc_Normalize.norm_comp _126_57 env c)))
...
(let _126_76 = if norm then begin
(norm_k env k)
end else begin
k
end
in (FStar_Absyn_Util.freevars_kind _126_76))
end
| FStar_Util.Inr (t) -> begin
(let _126_77 = if norm then begin
(norm_t env t)
end else begin
t
end
in (FStar_Absyn_Util.freevars_typ _126_77))
end)
in (
# 56 "FStar.Tc.Tc.fst"
...
(
# 62 "FStar.Tc.Tc.fst"
let escaping = (let _126_82 = (let _126_81 = (FStar_Util.set_elements a)
in (FStar_All.pipe_right _126_81 (FStar_List.map (fun x -> (FStar_Absyn_Print.strBvd x.FStar_Absyn_Syntax.v)))))
in (FStar_All.pipe_right _126_82 (FStar_String.concat ", ")))
in (
# 63 "FStar.Tc.Tc.fst"
let msg = if ((FStar_Util.set_count a) > 1) then begin
(let _126_83 = (FStar_Tc_Normalize.exp_norm_to_string env head)
in (FStar_Util.format2 "Bound variables \'{%s}\' in the type of \'%s\' escape because of impure applications; add explicit let-bindings" escaping _126_83))
end else begin
(let _126_84 = (FStar_Tc_Normalize.exp_norm_to_string env head)
in (FStar_Util.format2 "Bound variable \'%s\' in the type of \'%s\' escapes because of impure applications; add explicit let-bindings" escaping _126_84))
end
in (let _126_87 = (let _126_86 = (let _126_85 = (FStar_Tc_Env.get_range env)
in (msg, _126_85))
in FStar_Absyn_Syntax.Error (_126_86))
in (Prims.raise _126_87))))
end))
in (match (kt) with
| FStar_Util.Inl (k) -> begin
(
...
(let _126_98 = (let _126_97 = (let _126_96 = (FStar_Absyn_Util.btvar_to_typ b)
in (a.FStar_Absyn_Syntax.v, _126_96))
in FStar_Util.Inl (_126_97))
in (_126_98)::s)
end
end
...
(let _126_101 = (let _126_100 = (let _126_99 = (FStar_Absyn_Util.bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _126_99))
in FStar_Util.Inr (_126_100))
in (_126_101)::s)
end
end
| _42_114 -> begin
...
| () -> begin
(let _126_110 = (lc.FStar_Absyn_Syntax.comp ())
in (FStar_Absyn_Util.set_result_typ _126_110 t))
end))}))
...
(let _126_117 = if (not ((FStar_Absyn_Util.is_pure_or_ghost_function t))) then begin
(FStar_Absyn_Syntax.mk_Total t)
end else begin
(FStar_Tc_Util.return_value env t e)
end
in (FStar_Tc_Util.lcomp_of_comp _126_117))
end
...
(let _126_119 = (FStar_Absyn_Print.typ_to_string t)
in (let _126_118 = (FStar_Absyn_Print.typ_to_string t')
...
(
# 129 "FStar.Tc.Tc.fst"
let _42_154 = (let _126_125 = (FStar_All.pipe_left (fun _126_124 -> Some (_126_124)) (FStar_Tc_Errors.subtyping_failed env t t'))
in (FStar_Tc_Util.strengthen_precondition _126_125 env e lc g))
...
(let _126_126 = (FStar_Absyn_Print.lcomp_typ_to_string lc)
...
| None -> begin
(let _126_139 = (norm_c env c)
in (e, _126_139, FStar_Tc_Rel.trivial_guard))
end
| Some (expected_c) -> begin
(
# 162 "FStar.Tc.Tc.fst"
let _42_187 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _126_142 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _126_141 = (FStar_Absyn_Print.comp_typ_to_string c)
in (let _126_140 = (FStar_Absyn_Print.comp_typ_to_string expected_c)
in (FStar_Util.print3 "(%s) About to check\n\t%s\nagainst expected effect\n\t%s\n" _126_142 _126_141 _126_140))))
end else begin
()
end
in (
...
in (
# 165 "FStar.Tc.Tc.fst"
let expected_c' = (let _126_143 = (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp expected_c)
in (FStar_Tc_Util.refresh_comp_label env true _126_143))
in (
# 166 "FStar.Tc.Tc.fst"
let _42_195 = (let _126_144 = (expected_c'.FStar_Absyn_Syntax.comp ())
in (FStar_All.pipe_left (FStar_Tc_Util.check_comp env e c) _126_144))
in (match (_42_195) with
| (e, _42_193, g) -> begin
(
# 167 "FStar.Tc.Tc.fst"
let _42_196 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _126_146 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _126_145 = (FStar_Tc_Rel.guard_to_string env g)
...
(let _126_152 = (let _126_151 = (let _126_150 = (FStar_Tc_Errors.unexpected_non_trivial_precondition_on_term env f)
in (let _126_149 = (FStar_Tc_Env.get_range env)
in (_126_150, _126_149)))
...
| Some (t) -> begin
(let _126_159 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.print1 "Expected type is %s" _126_159))
end))
...
(let _126_212 = (FStar_Range.string_of_range k.FStar_Absyn_Syntax.pos)
in (let _126_211 = (FStar_Absyn_Print.kind_to_string k)
in (FStar_Util.print2 "(%s) - Checking kind %s" _126_212 _126_211)))
end else begin
()
end
in (
...
| (args, g) -> begin
(let _126_214 = (FStar_All.pipe_left w (FStar_Absyn_Syntax.mk_Kind_uvar (u, args)))
in (_126_214, g))
end))
end)))
end
...
(let _126_218 = (let _126_217 = (let _126_216 = (let _126_215 = (FStar_Absyn_Print.sli l)
in (Prims.strcat "Unexpected number of arguments to kind abbreviation " _126_215))
in (_126_216, k.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_126_217))
in (Prims.raise _126_218))
end else begin
(
# 204 "FStar.Tc.Tc.fst"
...
(
# 207 "FStar.Tc.Tc.fst"
let _42_289 = (let _126_222 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in (tc_typ_check env t _126_222))
in (match (_42_289) with
| (t, g) -> begin
(
# 208 "FStar.Tc.Tc.fst"
let subst = (FStar_Util.Inl ((a.FStar_Absyn_Syntax.v, t)))::subst
in (let _126_224 = (let _126_223 = (FStar_Absyn_Syntax.targ t)
in (_126_223)::args)
in (subst, _126_224, (g)::guards)))
end))
end
| (FStar_Util.Inr (x), FStar_Util.Inr (e)) -> begin
(
# 211 "FStar.Tc.Tc.fst"
let env = (let _126_225 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Env.set_expected_typ env _126_225))
in (
# 212 "FStar.Tc.Tc.fst"
...
in (let _126_227 = (let _126_226 = (FStar_Absyn_Syntax.varg e)
in (_126_226)::args)
in (subst, _126_227, (g)::guards)))
end)))
end
| _42_304 -> begin
...
in (let _126_230 = (FStar_List.fold_left FStar_Tc_Rel.conj_guard g guards)
in (k', _126_230))))))
end))
end
end))
...
in (let _126_232 = (FStar_Tc_Rel.conj_guard f g)
in (kk, _126_232))))
end))
end))
end
...
in (let _126_235 = (FStar_All.pipe_left w (FStar_Absyn_Syntax.mk_Kind_arrow (bs, k)))
in (let _126_234 = (FStar_Tc_Rel.conj_guard g f)
in (_126_235, _126_234))))
end))
end))
end
| FStar_Absyn_Syntax.Kind_unknown -> begin
(let _126_236 = (FStar_Tc_Util.new_kvar env)
in (_126_236, FStar_Tc_Rel.trivial_guard))
end))))
...
in (
# 242 "FStar.Tc.Tc.fst"
let env' = (let _126_239 = (FStar_Absyn_Syntax.v_binder x)
in (maybe_push_binding env _126_239))
in (x, env', g)))
end)))
...
| (bs, env', g') -> begin
(let _126_247 = (let _126_246 = (FStar_Tc_Rel.close_guard ((b)::[]) g')
in (FStar_Tc_Rel.conj_guard g _126_246))
in ((b)::bs, env', _126_247))
end))))
end))
end
| FStar_Util.Inr (x) -> begin
...
| (bs, env', g') -> begin
(let _126_249 = (let _126_248 = (FStar_Tc_Rel.close_guard ((b)::[]) g')
in (FStar_Tc_Rel.conj_guard g _126_248))
in ((b)::bs, env', _126_249))
end)))
end))
end)
end))
...
| (t, _42_394, g') -> begin
(let _126_254 = (FStar_Tc_Rel.conj_guard g g')
in (((FStar_Util.Inl (t), imp))::args, _126_254))
end))
end
...
| (e, _42_401, g') -> begin
(let _126_255 = (FStar_Tc_Rel.conj_guard g g')
in (((FStar_Util.Inr (e), imp))::args, _126_255))
end))
end)
...
| (args, g') -> begin
(let _126_260 = (FStar_Tc_Rel.conj_guard g g')
in ((args)::pats, _126_260))
end))
...
| (t, g) -> begin
(let _126_263 = (FStar_Absyn_Syntax.mk_Total t)
in (_126_263, g))
end))
end
...
in (
# 286 "FStar.Tc.Tc.fst"
let tc = (let _126_266 = (let _126_265 = (let _126_264 = (FStar_Absyn_Syntax.targ c.FStar_Absyn_Syntax.result_typ)
in (_126_264)::c.FStar_Absyn_Syntax.effect_args)
in (head, _126_265))
in (FStar_Absyn_Syntax.mk_Typ_app _126_266 None c.FStar_Absyn_Syntax.result_typ.FStar_Absyn_Syntax.pos))
in (
# 287 "FStar.Tc.Tc.fst"
...
(
# 292 "FStar.Tc.Tc.fst"
let _42_459 = (let _126_268 = (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_List.map (fun _42_3 -> (match (_42_3) with
...
in (FStar_All.pipe_right _126_268 FStar_List.unzip))
in (match (_42_459) with
| (flags, guards) -> begin
(let _126_270 = (FStar_Absyn_Syntax.mk_Comp (
# 298 "FStar.Tc.Tc.fst"
let _42_460 = c
...
in (let _126_269 = (FStar_List.fold_left FStar_Tc_Rel.conj_guard f guards)
in (_126_270, _126_269)))
end))
end))
end))
end)))))
...
in (let _126_293 = (FStar_Absyn_Syntax.mk_Typ_const i (Some (qk)) t.FStar_Absyn_Syntax.pos)
in (_126_293, qk, FStar_Tc_Rel.trivial_guard)))))
end
...
in (let _126_294 = (FStar_Absyn_Syntax.mk_Typ_const i (Some (qk)) t.FStar_Absyn_Syntax.pos)
in (_126_294, qk, FStar_Tc_Rel.trivial_guard)))))
end
...
(
# 345 "FStar.Tc.Tc.fst"
let rec extract_pats = (fun pats -> (match ((let _126_299 = (FStar_Absyn_Util.compress_exp pats)
in _126_299.FStar_Absyn_Syntax.n)) with
...
in (let _126_300 = (extract_pats tl)
in (FStar_List.append pat _126_300)))
end))
end
| _42_588 -> begin
[]
...
in (
# 354 "FStar.Tc.Tc.fst"
let pats = (let _126_301 = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env pats)
in (extract_pats _126_301))
in (
# 355 "FStar.Tc.Tc.fst"
...
| Some (b) -> begin
(let _126_304 = (let _126_303 = (FStar_Absyn_Print.binder_to_string b)
in (FStar_Util.format1 "Pattern misses at least one bound variables: %s" _126_303))
in (FStar_Tc_Errors.warn t.FStar_Absyn_Syntax.pos _126_304))
end))))
end
| _42_603 -> begin
(FStar_All.failwith "Impossible")
...
in (let _126_306 = (let _126_305 = (FStar_Tc_Rel.close_guard bs f)
in (FStar_Tc_Rel.conj_guard g _126_305))
in (t, FStar_Absyn_Syntax.ktype, _126_306))))
end))
end))
end
...
in (let _126_311 = (FStar_All.pipe_left (w k) (FStar_Absyn_Syntax.mk_Typ_lam (bs, t)))
in (let _126_310 = (let _126_309 = (FStar_Tc_Rel.close_guard bs f)
in (FStar_All.pipe_left (FStar_Tc_Rel.conj_guard g) _126_309))
in (_126_311, k, _126_310))))
end))
end))
end
...
(let _126_314 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _126_313 = (FStar_Absyn_Print.typ_to_string phi)
in (let _126_312 = (match ((FStar_Tc_Env.expected_typ env)) with
| None -> begin
"None"
end
| Some (t) -> begin
...
| (phi, f2) -> begin
(let _126_321 = (FStar_All.pipe_left (w FStar_Absyn_Syntax.ktype) (FStar_Absyn_Syntax.mk_Typ_refine (x, phi)))
in (let _126_320 = (let _126_319 = (let _126_318 = (let _126_317 = (FStar_Absyn_Syntax.v_binder x)
in (_126_317)::[])
in (FStar_Tc_Rel.close_guard _126_318 f2))
in (FStar_Tc_Rel.conj_guard f1 _126_319))
in (_126_321, FStar_Absyn_Syntax.ktype, _126_320)))
end)))
end))
end
...
(let _126_324 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _126_323 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
in (let _126_322 = (FStar_Absyn_Print.typ_to_string top)
in (FStar_Util.print3 "(%s) Checking type application (%s): %s\n" _126_324 _126_323 _126_322))))
end else begin
()
end
in (
...
(let _126_328 = (FStar_Range.string_of_range head.FStar_Absyn_Syntax.pos)
in (let _126_327 = (FStar_Absyn_Print.typ_to_string head)
in (let _126_326 = (FStar_Absyn_Print.kind_to_string k1')
in (let _126_325 = (FStar_Absyn_Print.kind_to_string k1)
in (FStar_Util.print4 "(%s) head %s has kind %s ... after norm %s\n" _126_328 _126_327 _126_326 _126_325)))))
end else begin
()
end
in (
...
in (
# 403 "FStar.Tc.Tc.fst"
let kres = (let _126_331 = (FStar_Tc_Rel.new_kvar k1.FStar_Absyn_Syntax.pos binders)
in (FStar_All.pipe_right _126_331 Prims.fst))
in (
# 404 "FStar.Tc.Tc.fst"
let bs = (let _126_332 = (FStar_Tc_Util.tks_of_args args)
in (FStar_Absyn_Util.null_binders_of_tks _126_332))
in (
# 405 "FStar.Tc.Tc.fst"
let kar = (FStar_Absyn_Syntax.mk_Kind_arrow (bs, kres) k1.FStar_Absyn_Syntax.pos)
in (
# 406 "FStar.Tc.Tc.fst"
let _42_662 = (let _126_333 = (FStar_Tc_Rel.keq env None k1 kar)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env) _126_333))
in (kres, args, g)))))))
end))
end
...
| ([], []) -> begin
(let _126_344 = (FStar_Absyn_Util.subst_kind subst kres)
in (_126_344, (FStar_List.rev outargs), g))
end
...
(let _126_348 = (let _126_347 = (let _126_346 = (let _126_345 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _126_345))
in ("Argument is marked as instantiating an implicit parameter; although the expected parameter is explicit", _126_346))
in FStar_Absyn_Syntax.Error (_126_347))
in (Prims.raise _126_348))
end
...
in (
# 419 "FStar.Tc.Tc.fst"
let _42_743 = (let _126_349 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Util.new_implicit_tvar env _126_349))
in (match (_42_743) with
| (t, u) -> begin
(
# 420 "FStar.Tc.Tc.fst"
let targ = (let _126_351 = (FStar_All.pipe_left (fun _126_350 -> Some (_126_350)) (FStar_Absyn_Syntax.Implicit (false)))
in (FStar_Util.Inl (t), _126_351))
in (
# 421 "FStar.Tc.Tc.fst"
...
in (
# 428 "FStar.Tc.Tc.fst"
let _42_776 = (let _126_352 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Util.new_implicit_evar env _126_352))
in (match (_42_776) with
| (e, u) -> begin
(
# 429 "FStar.Tc.Tc.fst"
let varg = (let _126_354 = (FStar_All.pipe_left (fun _126_353 -> Some (_126_353)) (FStar_Absyn_Syntax.Implicit (false)))
in (FStar_Util.Inr (e), _126_354))
in (
# 430 "FStar.Tc.Tc.fst"
...
(let _126_356 = (FStar_Absyn_Print.arg_to_string actual)
in (let _126_355 = (FStar_Absyn_Print.kind_to_string formal_k)
...
(let _126_357 = (FStar_Tc_Rel.guard_to_string env g')
...
in (
# 445 "FStar.Tc.Tc.fst"
let g' = (let _126_359 = (let _126_358 = (FStar_Tc_Util.short_circuit_typ (FStar_Util.Inl (head)) outargs)
in (FStar_All.pipe_left FStar_Tc_Rel.guard_of_guard_formula _126_358))
in (FStar_Tc_Rel.imp_guard _126_359 g'))
in (
# 446 "FStar.Tc.Tc.fst"
let subst = (maybe_extend_subst subst formal actual)
in (let _126_360 = (FStar_Tc_Rel.conj_guard g g')
in (check_args ((actual)::outargs) subst _126_360 formals actuals))))))
end))))
end
...
(let _126_362 = (FStar_Absyn_Print.arg_to_string actual)
in (let _126_361 = (FStar_Absyn_Print.typ_to_string tx)
...
in (
# 456 "FStar.Tc.Tc.fst"
let g' = (let _126_364 = (let _126_363 = (FStar_Tc_Util.short_circuit_typ (FStar_Util.Inl (head)) outargs)
in (FStar_All.pipe_left FStar_Tc_Rel.guard_of_guard_formula _126_363))
in (FStar_Tc_Rel.imp_guard _126_364 g'))
in (
# 457 "FStar.Tc.Tc.fst"
let subst = (maybe_extend_subst subst formal actual)
in (let _126_365 = (FStar_Tc_Rel.conj_guard g g')
in (check_args ((actual)::outargs) subst _126_365 formals actuals)))))
end))))))
end
...
in (let _126_367 = (let _126_366 = (FStar_Absyn_Syntax.targ tv)
in (_126_366)::actuals)
in (check_args outargs subst g ((formal)::formals) _126_367)))
end
| _42_846 -> begin
...
| (_42_861, []) -> begin
(let _126_369 = (let _126_368 = (FStar_Absyn_Syntax.mk_Kind_arrow (formals, kres) kres.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.subst_kind subst _126_368))
in (_126_369, (FStar_List.rev outargs), g))
end
| ([], _42_866) -> begin
(let _126_377 = (let _126_376 = (let _126_375 = (let _126_374 = (let _126_372 = (let _126_371 = (FStar_All.pipe_right outargs (FStar_List.filter (fun _42_4 -> (match (_42_4) with
...
in (FStar_List.length _126_371))
in (FStar_All.pipe_right _126_372 FStar_Util.string_of_int))
in (let _126_373 = (FStar_All.pipe_right (FStar_List.length args0) FStar_Util.string_of_int)
in (FStar_Util.format2 "Too many arguments to type; expected %s arguments but got %s" _126_374 _126_373)))
in (_126_375, top.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_126_376))
in (Prims.raise _126_377))
end))
in (check_args [] [] f1 formals args))
end
| _42_879 -> begin
(let _126_380 = (let _126_379 = (let _126_378 = (FStar_Tc_Errors.expected_tcon_kind env top k1)
in (_126_378, top.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_126_379))
in (Prims.raise _126_380))
end)
end))
in (match ((let _126_384 = (let _126_381 = (FStar_Absyn_Util.compress_typ head)
in _126_381.FStar_Absyn_Syntax.n)
in (let _126_383 = (let _126_382 = (FStar_Absyn_Util.compress_kind k1)
in _126_382.FStar_Absyn_Syntax.n)
in (_126_384, _126_383)))) with
...
| (t1, f2) -> begin
(let _126_388 = (FStar_All.pipe_left (w k1) (FStar_Absyn_Syntax.mk_Typ_ascribed' (t1, k1)))
in (let _126_387 = (FStar_Tc_Rel.conj_guard f1 f2)
in (_126_388, k1, _126_387)))
end))
end))
end
...
(let _126_390 = (FStar_Absyn_Print.typ_to_string s)
in (let _126_389 = (FStar_Absyn_Print.kind_to_string k1)
in (FStar_Util.print2 "Admitting un-instantiated uvar %s at kind %s\n" _126_390 _126_389)))
end else begin
()
end
in (let _126_393 = (FStar_All.pipe_left (w k1) (FStar_Absyn_Syntax.mk_Typ_uvar' (u, k1)))
in (_126_393, k1, FStar_Tc_Rel.trivial_guard)))
end
| _42_921 -> begin
(
# 515 "FStar.Tc.Tc.fst"
let _42_922 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) FStar_Options.High) then begin
(let _126_395 = (FStar_Absyn_Print.typ_to_string s)
in (let _126_394 = (FStar_Absyn_Print.kind_to_string k1)
...
| (t, k, f) -> begin
(let _126_396 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_refresh_label ((t, b, r))))
in (_126_396, k, f))
end))
end
...
| (t, k, f) -> begin
(let _126_397 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_labeled ((t, l, r, p))))
in (_126_397, k, f))
end))
end
...
| (t, k, f) -> begin
(let _126_398 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named ((t, l))))
in (_126_398, k, f))
end))
end
...
in (let _126_401 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_pattern ((quant, pats))))
in (let _126_400 = (FStar_Tc_Util.force_tk quant)
in (let _126_399 = (FStar_Tc_Rel.conj_guard f g)
in (_126_401, _126_400, _126_399)))))
end))
end))
end
...
| _42_972 -> begin
(let _126_403 = (let _126_402 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "Unexpected type : %s\n" _126_402))
in (FStar_All.failwith _126_403))
end))))))
...
(let _126_410 = (let _126_409 = (FStar_Absyn_Syntax.mk_Total t)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _126_409))
in FStar_Util.Inr (_126_410))
end
in (let _126_411 = (value_check_expected_typ env e tc)
in (FStar_All.pipe_left (with_implicits implicits) _126_411)))
end))))
end
...
(let _126_413 = (let _126_412 = (FStar_Absyn_Syntax.mk_Total t)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _126_412))
in FStar_Util.Inr (_126_413))
end
in (
# 573 "FStar.Tc.Tc.fst"
...
(let _126_419 = (let _126_418 = (let _126_417 = (FStar_Util.format1 "Expected a data constructor; got %s" v.FStar_Absyn_Syntax.v.FStar_Ident.str)
in (let _126_416 = (FStar_Tc_Env.get_range env)
in (_126_417, _126_416)))
in FStar_Absyn_Syntax.Error (_126_418))
in (Prims.raise _126_419))
end else begin
(let _126_420 = (value_check_expected_typ env e tc)
in (FStar_All.pipe_left (with_implicits implicits) _126_420))
end))
end))))
end
...
(
# 587 "FStar.Tc.Tc.fst"
let fail = (fun msg t -> (let _126_425 = (let _126_424 = (let _126_423 = (FStar_Tc_Errors.expected_a_term_of_type_t_got_a_function env msg t top)
in (_126_423, top.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_126_424))
in (Prims.raise _126_425)))
in (
# 588 "FStar.Tc.Tc.fst"
...
in (
# 602 "FStar.Tc.Tc.fst"
let rec as_function_typ = (fun norm t -> (match ((let _126_434 = (FStar_Absyn_Util.compress_typ t)
in _126_434.FStar_Absyn_Syntax.n)) with
...
| ([], []) -> begin
(let _126_443 = (FStar_Absyn_Util.subst_comp subst c)
in ((FStar_List.rev out), env, g, _126_443))
end
...
in (
# 636 "FStar.Tc.Tc.fst"
let g = (let _126_444 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard g _126_444))
in (k, g)))
end))
end)
...
in (
# 645 "FStar.Tc.Tc.fst"
let _42_1178 = (match ((let _126_445 = (FStar_Absyn_Util.unmeta_typ y.FStar_Absyn_Syntax.sort)
in _126_445.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Typ_unknown -> begin
(tx, g)
end
| _42_1166 -> begin
...
(let _126_446 = (FStar_Absyn_Print.binder_to_string hd)
...
in (
# 651 "FStar.Tc.Tc.fst"
let g = (let _126_447 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard g _126_447))
in (t, g)))
end)))
end)
...
| _42_1185 -> begin
(let _126_450 = (let _126_449 = (FStar_Absyn_Print.binder_to_string hdannot)
in (let _126_448 = (FStar_Absyn_Print.binder_to_string hd)
in (FStar_Util.format2 "Annotated %s; given %s" _126_449 _126_448)))
in (fail _126_450 t))
end)
end
| ([], _42_1188) -> begin
...
| t -> begin
(let _126_452 = (let _126_451 = (FStar_Absyn_Print.tag_of_typ t)
in (FStar_Util.format1 "More arguments than annotated type (%s)" _126_451))
in (fail _126_452 t))
end)
end else begin
...
(
# 669 "FStar.Tc.Tc.fst"
let c = (let _126_453 = (FStar_Absyn_Syntax.mk_Typ_fun (bs_annot, c) (Some (FStar_Absyn_Syntax.ktype)) c.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.total_comp _126_453 c.FStar_Absyn_Syntax.pos))
in (let _126_454 = (FStar_Absyn_Util.subst_comp subst c)
in ((FStar_List.rev out), env, g, _126_454)))
end)
end))
in (
# 672 "FStar.Tc.Tc.fst"
...
(let _126_459 = (FStar_Absyn_Print.typ_to_string t)
...
(match ((let _126_465 = (let _126_464 = (let _126_463 = (FStar_Absyn_Util.unrefine x.FStar_Absyn_Syntax.sort)
in (whnf env _126_463))
in (FStar_Absyn_Util.unrefine _126_464))
in _126_465.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Typ_fun (_42_1235) -> begin
[]
end
| _42_1238 -> begin
(let _126_466 = (FStar_Absyn_Util.bvar_to_exp x)
in (_126_466)::[])
end)
end)))))
in (
...
(let _126_475 = (let _126_474 = (let _126_473 = (let _126_471 = (FStar_Util.string_of_int (FStar_List.length bs'))
in (let _126_470 = (FStar_Util.string_of_int (FStar_List.length actuals))
in (FStar_Util.format2 "Decreases clause on a function with an unexpected number of arguments (expected %s; got %s)" _126_471 _126_470)))
in (let _126_472 = (FStar_Tc_Env.get_range env)
in (_126_473, _126_472)))
in FStar_Absyn_Syntax.Error (_126_474))
in (Prims.raise _126_475))
end else begin
()
end
in (
...
(let _126_479 = (let _126_478 = (FStar_Absyn_Util.btvar_to_typ actual)
in (formal.FStar_Absyn_Syntax.v, _126_478))
in FStar_Util.Inl (_126_479))
end
| ((FStar_Util.Inr (formal), _42_1282), (FStar_Util.Inr (actual), _42_1287)) -> begin
(let _126_481 = (let _126_480 = (FStar_Absyn_Util.bvar_to_exp actual)
in (formal.FStar_Absyn_Syntax.v, _126_480))
in FStar_Util.Inr (_126_481))
end
| _42_1291 -> begin
(FStar_All.failwith "impossible")
end)) bs' actuals)
...
in (match ((let _126_483 = (FStar_Absyn_Util.compress_typ t)
in _126_483.FStar_Absyn_Syntax.n)) with
...
let dec = (
# 726 "FStar.Tc.Tc.fst"
let subst = (let _126_487 = (let _126_486 = (let _126_485 = (FStar_Absyn_Util.bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _126_485))
in FStar_Util.Inr (_126_486))
in (_126_487)::[])
in (FStar_Absyn_Util.subst_exp subst dec))
in (let _126_492 = (let _126_491 = (let _126_490 = (FStar_Absyn_Syntax.varg dec)
in (let _126_489 = (let _126_488 = (FStar_Absyn_Syntax.varg prev_dec)
in (_126_488)::[])
in (_126_490)::_126_489))
in (precedes, _126_491))
in (FStar_Absyn_Syntax.mk_Typ_app _126_492 None r))))
end
| _42_1330 -> begin
(
# 731 "FStar.Tc.Tc.fst"
let formal_args = (let _126_495 = (let _126_494 = (let _126_493 = (FStar_Absyn_Syntax.v_binder y)
in (_126_493)::[])
in (FStar_List.append bs _126_494))
in (FStar_All.pipe_right _126_495 filter_types_and_functions))
in (
# 732 "FStar.Tc.Tc.fst"
...
in (let _126_500 = (let _126_499 = (let _126_498 = (FStar_Absyn_Syntax.varg lhs)
in (let _126_497 = (let _126_496 = (FStar_Absyn_Syntax.varg prev_dec)
in (_126_496)::[])
in (_126_498)::_126_497))
in (precedes, _126_499))
in (FStar_Absyn_Syntax.mk_Typ_app _126_500 None r))))
end)
in (
# 737 "FStar.Tc.Tc.fst"
...
(let _126_503 = (FStar_Absyn_Print.lbname_to_string l)
in (let _126_502 = (FStar_Absyn_Print.typ_to_string t)
in (let _126_501 = (FStar_Absyn_Print.typ_to_string t')
in (FStar_Util.print3 "Refined let rec %s\n\tfrom type %s\n\tto type %s\n" _126_503 _126_502 _126_501))))
end else begin
()
end
in (
# 743 "FStar.Tc.Tc.fst"
let _42_1350 = (let _126_505 = (let _126_504 = (FStar_Tc_Env.clear_expected_typ env)
in (FStar_All.pipe_right _126_504 Prims.fst))
in (tc_typ _126_505 t'))
...
in (let _126_511 = (FStar_All.pipe_right letrecs (FStar_List.fold_left (fun env _42_1359 -> (match (_42_1359) with
| (x, t) -> begin
(FStar_Tc_Env.push_local_binding env (binding_of_lb x t))
end)) env))
in (let _126_510 = (FStar_All.pipe_right letrecs (FStar_List.collect (fun _42_8 -> (match (_42_8) with
| (FStar_Util.Inl (x), t) -> begin
(let _126_509 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_126_509)::[])
end
| _42_1366 -> begin
[]
end))))
in (_126_511, _126_510)))))))))))
end))
in (
# 755 "FStar.Tc.Tc.fst"
...
| _42_1390 -> begin
if (not (norm)) then begin
(let _126_512 = (whnf env t)
in (as_function_typ true _126_512))
end else begin
(
# 771 "FStar.Tc.Tc.fst"
...
(let _126_515 = (FStar_Absyn_Print.exp_to_string body)
in (let _126_514 = (FStar_Absyn_Print.lcomp_typ_to_string cbody)
in (let _126_513 = (FStar_Tc_Rel.guard_to_string env guard_body)
in (FStar_Util.print3 "!!!!!!!!!!!!!!!body %s has type %s\nguard is %s\n" _126_515 _126_514 _126_513))))
end else begin
()
end
in (
...
(let _126_516 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length guard_body.FStar_Tc_Rel.implicits))
...
(
# 787 "FStar.Tc.Tc.fst"
let _42_1429 = (let _126_519 = (FStar_Tc_Rel.conj_guard g guard)
in (FStar_Tc_Util.discharge_guard envbody _126_519))
in (
# 787 "FStar.Tc.Tc.fst"
...
in (
# 792 "FStar.Tc.Tc.fst"
let e = (let _126_521 = (let _126_520 = (FStar_Absyn_Syntax.mk_Exp_abs (bs, body) (Some (tfun_computed)) top.FStar_Absyn_Syntax.pos)
in (_126_520, tfun_computed, Some (FStar_Absyn_Const.effect_Tot_lid)))
in (FStar_Absyn_Syntax.mk_Exp_ascribed _126_521 None top.FStar_Absyn_Syntax.pos))
in (
# 794 "FStar.Tc.Tc.fst"
...
(let _126_524 = (let _126_523 = (let _126_522 = (FStar_Absyn_Syntax.mk_Exp_abs (bs, body) (Some (t)) e.FStar_Absyn_Syntax.pos)
in (_126_522, t, Some (FStar_Absyn_Const.effect_Tot_lid)))
in (FStar_Absyn_Syntax.mk_Exp_ascribed _126_523 None top.FStar_Absyn_Syntax.pos))
in (_126_524, t, guard))
end
| _42_1446 -> begin
(
...
(let _126_525 = (FStar_Tc_Rel.teq env t tfun_computed)
in (e, _126_525))
end else begin
...
| (e, guard') -> begin
(let _126_527 = (FStar_Absyn_Syntax.mk_Exp_ascribed (e, t, Some (FStar_Absyn_Const.effect_Tot_lid)) None top.FStar_Absyn_Syntax.pos)
in (let _126_526 = (FStar_Tc_Rel.conj_guard guard guard')
in (_126_527, t, _126_526)))
end))
end))
end
| None -> begin
...
(let _126_530 = (FStar_Absyn_Print.typ_to_string tfun)
in (let _126_529 = (FStar_Absyn_Print.tag_of_typ tfun)
in (let _126_528 = (FStar_Tc_Rel.guard_to_string env guard)
in (FStar_Util.print3 "!!!!!!!!!!!!!!!Annotating lambda with type %s (%s)\nGuard is %s\n" _126_530 _126_529 _126_528))))
end else begin
()
end
in (
...
in (
# 817 "FStar.Tc.Tc.fst"
let _42_1460 = (let _126_532 = (FStar_Tc_Util.lcomp_of_comp c)
in (FStar_Tc_Util.strengthen_precondition None env e _126_532 guard))
...
| _42_1462 -> begin
(let _126_534 = (let _126_533 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format1 "Unexpected value: %s" _126_533))
in (FStar_All.failwith _126_534))
end))))
...
(let _126_539 = (let _126_537 = (FStar_Tc_Env.get_range env)
in (FStar_All.pipe_left FStar_Range.string_of_range _126_537))
in (let _126_538 = (FStar_Absyn_Print.tag_of_exp e)
...
(let _126_563 = (FStar_Absyn_Util.compress_exp e)
in (tc_exp env _126_563))
end
...
(
# 840 "FStar.Tc.Tc.fst"
let _42_1501 = (let _126_564 = (FStar_Tc_Env.set_expected_typ env t1)
in (tc_exp _126_564 e1))
in (match (_42_1501) with
| (e1, c, g) -> begin
(
# 841 "FStar.Tc.Tc.fst"
let _42_1505 = (let _126_568 = (FStar_Tc_Env.set_range env t1.FStar_Absyn_Syntax.pos)
...
(
# 842 "FStar.Tc.Tc.fst"
let _42_1509 = (let _126_572 = (let _126_571 = (w c)
in (FStar_All.pipe_left _126_571 (FStar_Absyn_Syntax.mk_Exp_ascribed (e1, t1, Some (c.FStar_Absyn_Syntax.eff_name)))))
in (comp_check_expected_typ env _126_572 c))
in (match (_42_1509) with
| (e, c, f2) -> begin
(let _126_574 = (let _126_573 = (FStar_Tc_Rel.conj_guard g f2)
in (FStar_Tc_Rel.conj_guard f _126_573))
in (e, c, _126_574))
end))
end))
end))
...
(
# 846 "FStar.Tc.Tc.fst"
let pats_t = (let _126_580 = (let _126_579 = (let _126_575 = (FStar_Absyn_Const.kunary FStar_Absyn_Syntax.mk_Kind_type FStar_Absyn_Syntax.mk_Kind_type)
in (FStar_Absyn_Util.ftv FStar_Absyn_Const.list_lid _126_575))
in (let _126_578 = (let _126_577 = (let _126_576 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.pattern_lid FStar_Absyn_Syntax.mk_Kind_type)
in (FStar_Absyn_Syntax.targ _126_576))
in (_126_577)::[])
in (_126_579, _126_578)))
in (FStar_Absyn_Syntax.mk_Typ_app _126_580 None FStar_Absyn_Syntax.dummyRange))
in (
# 847 "FStar.Tc.Tc.fst"
let _42_1519 = (let _126_581 = (FStar_Tc_Env.set_expected_typ env pats_t)
in (tc_ghost_exp _126_581 e))
...
in (
# 849 "FStar.Tc.Tc.fst"
let c = (let _126_582 = (FStar_Absyn_Util.gtotal_comp pats_t)
in (FStar_All.pipe_right _126_582 FStar_Tc_Util.lcomp_of_comp))
in (e, c, g)))
end)))
end
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, FStar_Absyn_Syntax.Sequence)) -> begin
(match ((let _126_583 = (FStar_Absyn_Util.compress_exp e)
in _126_583.FStar_Absyn_Syntax.n)) with
...
(
# 855 "FStar.Tc.Tc.fst"
let _42_1546 = (let _126_584 = (FStar_Tc_Env.set_expected_typ env FStar_Tc_Recheck.t_unit)
in (tc_exp _126_584 e1))
...
in (let _126_597 = (let _126_595 = (let _126_594 = (let _126_593 = (let _126_592 = (w c)
in (let _126_591 = (let _126_590 = (let _126_589 = (let _126_588 = (let _126_587 = (FStar_Absyn_Syntax.mk_lb (x, c1.FStar_Absyn_Syntax.eff_name, FStar_Tc_Recheck.t_unit, e1))
in (_126_587)::[])
in (false, _126_588))
in (_126_589, e2))
in (FStar_Absyn_Syntax.mk_Exp_let _126_590))
in (FStar_All.pipe_left _126_592 _126_591)))
in (_126_593, FStar_Absyn_Syntax.Sequence))
in FStar_Absyn_Syntax.Meta_desugared (_126_594))
in (FStar_Absyn_Syntax.mk_Exp_meta _126_595))
in (let _126_596 = (FStar_Tc_Rel.conj_guard g1 g2)
in (_126_597, c, _126_596))))
end))
end))
end
| _42_1553 -> begin
...
| (e, c, g) -> begin
(let _126_598 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared ((e, FStar_Absyn_Syntax.Sequence))))
in (_126_598, c, g))
end))
end)
end
...
| (e, c, g) -> begin
(let _126_599 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared ((e, i))))
in (_126_599, c, g))
end))
end
...
in (
# 870 "FStar.Tc.Tc.fst"
let env = (let _126_601 = (let _126_600 = (FStar_Tc_Env.clear_expected_typ env)
in (FStar_All.pipe_right _126_600 Prims.fst))
in (FStar_All.pipe_right _126_601 instantiate_both))
in (
# 871 "FStar.Tc.Tc.fst"
let _42_1573 = if (FStar_Tc_Env.debug env FStar_Options.High) then begin
(let _126_603 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _126_602 = (FStar_Absyn_Print.exp_to_string top)
...
(let _126_609 = (let _126_606 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Util.b2t _126_606))
in (let _126_608 = (let _126_607 = (FStar_Tc_Util.return_value env FStar_Absyn_Util.t_bool xexp)
in (FStar_All.pipe_right _126_607 FStar_Tc_Util.lcomp_of_comp))
in (FStar_Tc_Util.ite env _126_609 c2 _126_608)))
end else begin
(let _126_613 = (let _126_610 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Util.b2t _126_610))
in (let _126_612 = (let _126_611 = (FStar_Tc_Util.return_value env FStar_Absyn_Util.t_bool xexp)
in (FStar_All.pipe_right _126_611 FStar_Tc_Util.lcomp_of_comp))
in (FStar_Tc_Util.ite env _126_613 _126_612 c2)))
end
in (
# 888 "FStar.Tc.Tc.fst"
let c = (let _126_616 = (let _126_615 = (FStar_All.pipe_left (fun _126_614 -> Some (_126_614)) (FStar_Tc_Env.Binding_var ((x.FStar_Absyn_Syntax.v, FStar_Absyn_Util.t_bool))))
in (_126_615, c2))
in (FStar_Tc_Util.bind env None c1 _126_616))
in (
# 889 "FStar.Tc.Tc.fst"
let e = (let _126_621 = (let _126_620 = (let _126_619 = (FStar_Absyn_Syntax.varg e1)
in (let _126_618 = (let _126_617 = (FStar_Absyn_Syntax.varg e2)
in (_126_617)::[])
in (_126_619)::_126_618))
in (head, _126_620))
in (FStar_Absyn_Syntax.mk_Exp_app _126_621 (Some (FStar_Absyn_Util.t_bool)) top.FStar_Absyn_Syntax.pos))
in (let _126_623 = (let _126_622 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard g_head _126_622))
in (e, c, _126_623)))))))
end))
end))
end
...
(let _126_625 = (FStar_Range.string_of_range head.FStar_Absyn_Syntax.pos)
in (let _126_624 = (FStar_Absyn_Print.typ_to_string thead)
...
in (
# 898 "FStar.Tc.Tc.fst"
let rec check_function_app = (fun norm tf -> (match ((let _126_630 = (FStar_Absyn_Util.unrefine tf)
in _126_630.FStar_Absyn_Syntax.n)) with
| (FStar_Absyn_Syntax.Typ_uvar (_)) | (FStar_Absyn_Syntax.Typ_app ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Typ_uvar (_); FStar_Absyn_Syntax.tk = _; FStar_Absyn_Syntax.pos = _; FStar_Absyn_Syntax.fvs = _; FStar_Absyn_Syntax.uvs = _}, _)) -> begin
(
# 901 "FStar.Tc.Tc.fst"
...
(let _126_635 = (FStar_Tc_Rel.conj_guard g_e g_rest)
in (((FStar_Util.Inr (e), imp))::args, (c)::comps, _126_635))
end))
end))
end))
in (
...
(
# 913 "FStar.Tc.Tc.fst"
let bs = (let _126_636 = (FStar_Tc_Util.tks_of_args args)
in (FStar_Absyn_Util.null_binders_of_tks _126_636))
in (
# 914 "FStar.Tc.Tc.fst"
let cres = (let _126_637 = (FStar_Tc_Util.new_tvar env FStar_Absyn_Syntax.ktype)
in (FStar_Absyn_Util.ml_comp _126_637 top.FStar_Absyn_Syntax.pos))
in (
# 915 "FStar.Tc.Tc.fst"
let _42_1673 = (let _126_639 = (let _126_638 = (FStar_Absyn_Syntax.mk_Typ_fun (bs, cres) (Some (FStar_Absyn_Syntax.ktype)) tf.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Rel.teq env tf _126_638))
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env) _126_639))
in (
# 916 "FStar.Tc.Tc.fst"
let comp = (let _126_642 = (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp cres)
in (FStar_List.fold_right (fun c out -> (FStar_Tc_Util.bind env None c (None, out))) ((chead)::comps) _126_642))
in (let _126_644 = (FStar_Absyn_Syntax.mk_Exp_app (head, args) (Some (comp.FStar_Absyn_Syntax.res_typ)) top.FStar_Absyn_Syntax.pos)
in (let _126_643 = (FStar_Tc_Rel.conj_guard g_head g_args)
in (_126_644, comp, _126_643)))))))
end)))
end
| FStar_Absyn_Syntax.Typ_fun (bs, c) -> begin
(
...
in (
# 935 "FStar.Tc.Tc.fst"
let _42_1716 = (let _126_680 = (let _126_679 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _126_679))
in (FStar_Tc_Rel.new_tvar _126_680 vars k))
in (match (_42_1716) with
| (targ, u) -> begin
(
# 936 "FStar.Tc.Tc.fst"
let _42_1717 = if (FStar_Tc_Env.debug env FStar_Options.Extreme) then begin
(let _126_682 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (let _126_681 = (FStar_Absyn_Print.typ_to_string targ)
in (FStar_Util.print2 "Instantiating %s to %s" _126_682 _126_681)))
end else begin
()
end
in (
...
in (
# 938 "FStar.Tc.Tc.fst"
let arg = (let _126_683 = (FStar_Absyn_Syntax.as_implicit true)
in (FStar_Util.Inl (targ), _126_683))
in (let _126_692 = (let _126_691 = (let _126_690 = (let _126_689 = (let _126_688 = (FStar_Tc_Util.as_uvar_t u)
in (_126_688, u.FStar_Absyn_Syntax.pos))
in FStar_Util.Inl (_126_689))
in (add_implicit _126_690 g))
in (subst, (arg)::outargs, (arg)::arg_rets, comps, _126_691, fvs))
in (tc_args _126_692 rest cres args)))))
end))))
end
...
in (
# 946 "FStar.Tc.Tc.fst"
let arg = (let _126_693 = (FStar_Absyn_Syntax.as_implicit true)
in (FStar_Util.Inr (varg), _126_693))
...
(let _126_699 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (let _126_698 = (FStar_Absyn_Print.typ_to_string t)
...
(
# 954 "FStar.Tc.Tc.fst"
let f = (let _126_700 = (FStar_Tc_Rel.guard_form g')
in (FStar_Tc_Util.label_guard FStar_Tc_Errors.ill_kinded_type t.FStar_Absyn_Syntax.pos _126_700))
in (
# 955 "FStar.Tc.Tc.fst"
let g' = (
# 955 "FStar.Tc.Tc.fst"
...
in (
# 957 "FStar.Tc.Tc.fst"
let subst = (let _126_701 = (FStar_List.hd bs)
in (maybe_extend_subst subst _126_701 arg))
in (let _126_707 = (let _126_706 = (FStar_Tc_Rel.conj_guard g g')
in (subst, (arg)::outargs, (arg)::arg_rets, comps, _126_706, fvs))
in (tc_args _126_707 rest cres rest'))))))
end)))))
end
...
(let _126_709 = (FStar_Absyn_Print.subst_to_string subst)
in (let _126_708 = (FStar_Absyn_Print.typ_to_string x.FStar_Absyn_Syntax.sort)
...
(let _126_710 = (FStar_Absyn_Print.typ_to_string targ)
...
(let _126_712 = (FStar_Absyn_Print.exp_to_string e)
in (let _126_711 = (FStar_Absyn_Print.typ_to_string targ)
...
(let _126_715 = (FStar_Absyn_Print.tag_of_exp e)
in (let _126_714 = (FStar_Absyn_Print.exp_to_string e)
in (let _126_713 = (FStar_Absyn_Print.typ_to_string targ)
in (FStar_Util.print3 "Checking arg (%s) %s at type %s\n" _126_715 _126_714 _126_713))))
end else begin
()
end
in (
...
(let _126_717 = (FStar_Tc_Rel.guard_to_string env g_e)
in (let _126_716 = (FStar_Tc_Rel.guard_to_string env g)
...
(
# 974 "FStar.Tc.Tc.fst"
let subst = (let _126_718 = (FStar_List.hd bs)
in (maybe_extend_subst subst _126_718 arg))
in (tc_args (subst, (arg)::outargs, (arg)::arg_rets, comps, g, fvs) rest cres rest'))
end else begin
if (FStar_Tc_Util.is_pure_or_ghost_effect env c.FStar_Absyn_Syntax.eff_name) then begin
(
# 977 "FStar.Tc.Tc.fst"
let subst = (let _126_723 = (FStar_List.hd bs)
in (maybe_extend_subst subst _126_723 arg))
in (
# 978 "FStar.Tc.Tc.fst"
...
if (let _126_728 = (FStar_List.hd bs)
in (FStar_Absyn_Syntax.is_null_binder _126_728)) then begin
(
# 982 "FStar.Tc.Tc.fst"
let newx = (FStar_Absyn_Util.gen_bvar_p e.FStar_Absyn_Syntax.pos c.FStar_Absyn_Syntax.res_typ)
in (
# 983 "FStar.Tc.Tc.fst"
let arg' = (let _126_729 = (FStar_Absyn_Util.bvar_to_exp newx)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _126_729))
in (
# 984 "FStar.Tc.Tc.fst"
...
(let _126_742 = (let _126_741 = (let _126_735 = (let _126_734 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _126_734))
in (_126_735)::arg_rets)
in (let _126_740 = (let _126_738 = (let _126_737 = (FStar_All.pipe_left (fun _126_736 -> Some (_126_736)) (FStar_Tc_Env.Binding_var ((x.FStar_Absyn_Syntax.v, targ))))
in (_126_737, c))
in (_126_738)::comps)
in (let _126_739 = (FStar_Util.set_add x fvs)
in (subst, (arg)::outargs, _126_741, _126_740, g, _126_739))))
in (tc_args _126_742 rest cres rest'))
end
end
end)))
end))))))))))
...
(let _126_746 = (let _126_745 = (let _126_744 = (let _126_743 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _126_743))
in ("Expected an expression; got a type", _126_744))
in FStar_Absyn_Syntax.Error (_126_745))
in (Prims.raise _126_746))
end
| ((FStar_Util.Inl (_42_1841), _42_1844)::_42_1839, (FStar_Util.Inr (_42_1850), _42_1853)::_42_1848) -> begin
(let _126_750 = (let _126_749 = (let _126_748 = (let _126_747 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _126_747))
in ("Expected a type; got an expression", _126_748))
in FStar_Absyn_Syntax.Error (_126_749))
in (Prims.raise _126_750))
end
| (_42_1858, []) -> begin
(
# 995 "FStar.Tc.Tc.fst"
...
(let _126_752 = (FStar_Absyn_Syntax.mk_Exp_app_flat (head, (FStar_List.rev arg_rets)) (Some (cres.FStar_Absyn_Syntax.res_typ)) top.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Util.maybe_assume_result_eq_pure_term env _126_752 cres))
end else begin
(
# 1015 "FStar.Tc.Tc.fst"
let _42_1871 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _126_755 = (FStar_Absyn_Print.exp_to_string head)
in (let _126_754 = (FStar_Absyn_Print.lcomp_typ_to_string cres)
in (let _126_753 = (FStar_Tc_Rel.guard_to_string env g)
in (FStar_Util.print3 "Not refining result: f=%s; cres=%s; guard=%s\n" _126_755 _126_754 _126_753))))
end else begin
()
end
in cres)
end
in (let _126_756 = (FStar_Tc_Util.refresh_comp_label env false cres)
in (_126_756, g))))))
end
| _42_1875 -> begin
(
# 1023 "FStar.Tc.Tc.fst"
let g = (let _126_757 = (FStar_Tc_Rel.conj_guard g_head g)
in (FStar_All.pipe_right _126_757 (FStar_Tc_Rel.solve_deferred_constraints env)))
in (let _126_763 = (let _126_762 = (let _126_761 = (let _126_760 = (let _126_759 = (let _126_758 = (cres.FStar_Absyn_Syntax.comp ())
in (bs, _126_758))
in (FStar_Absyn_Syntax.mk_Typ_fun _126_759 (Some (FStar_Absyn_Syntax.ktype)) top.FStar_Absyn_Syntax.pos))
in (FStar_All.pipe_left (FStar_Absyn_Util.subst_typ subst) _126_760))
in (FStar_Absyn_Syntax.mk_Total _126_761))
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _126_762))
in (_126_763, g)))
end)
...
(let _126_764 = (FStar_Absyn_Print.lcomp_typ_to_string cres)
...
(let _126_770 = (FStar_Tc_Normalize.exp_norm_to_string env app)
in (let _126_769 = (let _126_768 = (comp.FStar_Absyn_Syntax.comp ())
in (FStar_Absyn_Print.comp_typ_to_string _126_768))
...
let tres = (let _126_775 = (FStar_Absyn_Util.compress_typ tres)
in (FStar_All.pipe_right _126_775 FStar_Absyn_Util.unrefine))
...
(let _126_776 = (FStar_Range.string_of_range tres.FStar_Absyn_Syntax.pos)
in (FStar_Util.print1 "%s: Warning: Potentially redundant explicit currying of a function type \n" _126_776))
end else begin
()
end
in (let _126_781 = (FStar_Tc_Util.lcomp_of_comp cres')
in (tc_args (subst, outargs, arg_rets, ((None, cres))::comps, g, fvs) bs _126_781 args)))
end
| _42_1909 when (not (norm)) -> begin
(let _126_782 = (whnf env tres)
in (aux true _126_782))
end
| _42_1911 -> begin
(let _126_788 = (let _126_787 = (let _126_786 = (let _126_784 = (FStar_Tc_Normalize.typ_norm_to_string env tf)
in (let _126_783 = (FStar_Absyn_Print.exp_to_string top)
in (FStar_Util.format2 "Too many arguments to function of type %s; got %s" _126_784 _126_783)))
in (let _126_785 = (FStar_Absyn_Syntax.argpos arg)
in (_126_786, _126_785)))
in FStar_Absyn_Syntax.Error (_126_787))
in (Prims.raise _126_788))
end)))
in (aux false cres.FStar_Absyn_Syntax.res_typ))
end)
end))
in (let _126_789 = (FStar_Tc_Util.lcomp_of_comp c)
in (tc_args ([], [], [], [], FStar_Tc_Rel.trivial_guard, FStar_Absyn_Syntax.no_fvs.FStar_Absyn_Syntax.fxvs) bs _126_789 args))))
end
| _42_1913 -> begin
if (not (norm)) then begin
(let _126_790 = (whnf env tf)
in (check_function_app true _126_790))
end else begin
(let _126_793 = (let _126_792 = (let _126_791 = (FStar_Tc_Errors.expected_function_typ env tf)
in (_126_791, head.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_126_792))
in (Prims.raise _126_793))
end
end))
in (let _126_794 = (FStar_Absyn_Util.unrefine thead)
in (check_function_app false _126_794)))))
end))
end))
in (
...
(let _126_795 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length g.FStar_Tc_Rel.implicits))
...
(let _126_800 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _126_799 = (FStar_Absyn_Print.typ_to_string c.FStar_Absyn_Syntax.res_typ)
in (let _126_798 = (let _126_797 = (FStar_Tc_Env.expected_typ env0)
in (FStar_All.pipe_right _126_797 (fun x -> (match (x) with
| None -> begin
"None"
end
| Some (t) -> begin
...
| (e, c, g') -> begin
(let _126_801 = (FStar_Tc_Rel.conj_guard g g')
in (e, c, _126_801))
end)))))
end)))
end)))))
...
in (let _126_802 = (FStar_Tc_Env.set_expected_typ env res_t)
in (_126_802, res_t)))
end)
...
let guard_x = (let _126_804 = (FStar_All.pipe_left (fun _126_803 -> Some (_126_803)) e1.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.new_bvd _126_804))
in (
...
(let _126_807 = (FStar_Tc_Rel.conj_guard g gaccum)
in (((f, c))::caccum, _126_807))
end)) t_eqns ([], FStar_Tc_Rel.trivial_guard))
in (match (_42_1963) with
| (cases, g) -> begin
(let _126_808 = (FStar_Tc_Util.bind_cases env res_t cases)
in (_126_808, g))
end))
...
(let _126_812 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _126_811 = (FStar_Absyn_Print.lcomp_typ_to_string c1)
in (let _126_810 = (FStar_Absyn_Print.lcomp_typ_to_string c_branches)
in (let _126_809 = (FStar_Tc_Rel.guard_to_string env g_branches)
in (FStar_Util.print4 "(%s) comp\n\tscrutinee: %s\n\tbranches: %s\nguard = %s\n" _126_812 _126_811 _126_810 _126_809)))))
end else begin
()
end
in (
# 1088 "FStar.Tc.Tc.fst"
let cres = (let _126_815 = (let _126_814 = (FStar_All.pipe_left (fun _126_813 -> Some (_126_813)) (FStar_Tc_Env.Binding_var ((guard_x, c1.FStar_Absyn_Syntax.res_typ))))
in (_126_814, c_branches))
in (FStar_Tc_Util.bind env (Some (e1)) c1 _126_815))
in (
# 1090 "FStar.Tc.Tc.fst"
let e = (let _126_822 = (w cres)
in (let _126_821 = (let _126_820 = (let _126_819 = (FStar_List.map (fun _42_1977 -> (match (_42_1977) with
| (f, _42_1972, _42_1974, _42_1976) -> begin
f
end)) t_eqns)
in (e1, _126_819))
in (FStar_Absyn_Syntax.mk_Exp_match _126_820))
in (FStar_All.pipe_left _126_822 _126_821)))
in (let _126_824 = (FStar_Absyn_Syntax.mk_Exp_ascribed (e, cres.FStar_Absyn_Syntax.res_typ, Some (cres.FStar_Absyn_Syntax.eff_name)) None e.FStar_Absyn_Syntax.pos)
in (let _126_823 = (FStar_Tc_Rel.conj_guard g1 g_branches)
in (_126_824, cres, _126_823))))))
end))))
end))
end)))
end))
...
(let _126_825 = (FStar_Tc_Env.set_expected_typ env1 t)
in (FStar_Tc_Rel.trivial_guard, _126_825))
end else begin
(
...
(let _126_827 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _126_826 = (FStar_Absyn_Print.typ_to_string t)
...
let _42_2026 = (let _126_831 = (FStar_Tc_Env.set_range env t.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Util.strengthen_precondition (Some ((fun _42_2023 -> (match (()) with
| () -> begin
FStar_Tc_Errors.ill_kinded_type
end)))) _126_831 e1 c1 f))
...
let _42_2032 = (let _126_832 = (FStar_Tc_Rel.conj_guard g1 guard_f)
in (FStar_Tc_Util.check_top_level env _126_832 c1))
...
(let _126_833 = (FStar_Tc_Env.get_range env)
in (FStar_Tc_Errors.warn _126_833 FStar_Tc_Errors.top_level_effect))
end else begin
()
end
in (let _126_834 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared ((e2, FStar_Absyn_Syntax.Masked_effect))))
in (_126_834, c1)))
end
end))
end else begin
...
in (let _126_835 = (c1.FStar_Absyn_Syntax.comp ())
in (e2, _126_835)))))
end
...
(let _126_836 = (FStar_Tc_Util.generalize false env1 (((x, e1, c1))::[]))
in (FStar_All.pipe_left FStar_List.hd _126_836))
end else begin
(x, e1, c1)
end
...
let cres = (let _126_837 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit top.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _126_837))
in (
# 1132 "FStar.Tc.Tc.fst"
let cres = if (FStar_Absyn_Util.is_total_comp c1) then begin
cres
end else begin
(let _126_838 = (FStar_Tc_Util.lcomp_of_comp c1)
in (FStar_Tc_Util.bind env None _126_838 (None, cres)))
end
in (
# 1135 "FStar.Tc.Tc.fst"
let _42_2050 = (FStar_ST.op_Colon_Equals e2.FStar_Absyn_Syntax.tk (Some (FStar_Tc_Recheck.t_unit)))
in (let _126_847 = (let _126_846 = (w cres)
in (let _126_845 = (let _126_844 = (let _126_843 = (let _126_842 = (let _126_841 = (FStar_Absyn_Syntax.mk_lb (x, (FStar_Absyn_Util.comp_effect_name c1), (FStar_Absyn_Util.comp_result c1), e1))
in (_126_841)::[])
in (false, _126_842))
in (_126_843, e2))
in (FStar_Absyn_Syntax.mk_Exp_let _126_844))
in (FStar_All.pipe_left _126_846 _126_845)))
in (_126_847, cres, FStar_Tc_Rel.trivial_guard)))))
end))
end))
end
| FStar_Util.Inl (bvd) -> begin
...
let _42_2058 = (let _126_848 = (FStar_Tc_Env.push_local_binding env b)
in (tc_exp _126_848 e2))
...
let e = (let _126_856 = (w cres)
in (let _126_855 = (let _126_854 = (let _126_853 = (let _126_852 = (let _126_851 = (FStar_Absyn_Syntax.mk_lb (x, c1.FStar_Absyn_Syntax.eff_name, c1.FStar_Absyn_Syntax.res_typ, e1))
in (_126_851)::[])
in (false, _126_852))
in (_126_853, e2))
in (FStar_Absyn_Syntax.mk_Exp_let _126_854))
in (FStar_All.pipe_left _126_856 _126_855)))
in (
# 1143 "FStar.Tc.Tc.fst"
let g2 = (let _126_865 = (let _126_858 = (let _126_857 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s bvd c1.FStar_Absyn_Syntax.res_typ))
in (_126_857)::[])
in (FStar_Tc_Rel.close_guard _126_858))
in (let _126_864 = (let _126_863 = (let _126_862 = (let _126_861 = (let _126_860 = (FStar_Absyn_Util.bvd_to_exp bvd c1.FStar_Absyn_Syntax.res_typ)
in (FStar_Absyn_Util.mk_eq c1.FStar_Absyn_Syntax.res_typ c1.FStar_Absyn_Syntax.res_typ _126_860 e1))
in (FStar_All.pipe_left (fun _126_859 -> FStar_Tc_Rel.NonTrivial (_126_859)) _126_861))
in (FStar_Tc_Rel.guard_of_guard_formula _126_862))
in (FStar_Tc_Rel.imp_guard _126_863 g2))
in (FStar_All.pipe_left _126_865 _126_864)))
in (
# 1145 "FStar.Tc.Tc.fst"
let guard = (let _126_866 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard guard_f _126_866))
in (match (topt) with
| None -> begin
(
...
let _42_2067 = (let _126_867 = (FStar_Tc_Rel.teq env tres t)
in (FStar_All.pipe_left (FStar_Tc_Rel.try_discharge_guard env) _126_867))
in (e, cres, guard)))
end else begin
(e, cres, guard)
end))
...
(let _126_871 = (tc_typ_check_trivial (
...
in (FStar_All.pipe_right _126_871 (norm_t env)))
end
in (
...
let _42_2141 = (let _126_877 = (let _126_876 = (FStar_All.pipe_right lbs FStar_List.rev)
in (FStar_All.pipe_right _126_876 (FStar_List.map (fun _42_2130 -> (match (_42_2130) with
| (x, t, e) -> begin
(
...
(let _126_875 = (FStar_Absyn_Print.lbname_to_string x)
in (let _126_874 = (FStar_Absyn_Print.exp_to_string e)
in (let _126_873 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.print3 "Checking %s = %s against type %s\n" _126_875 _126_874 _126_873))))
end else begin
()
end
in (
...
in (FStar_All.pipe_right _126_877 FStar_List.unzip))
...
(let _126_879 = (FStar_List.map (fun _42_2146 -> (match (_42_2146) with
| (x, t, e) -> begin
...
let ecs = (let _126_882 = (FStar_All.pipe_right lbs (FStar_List.map (fun _42_2152 -> (match (_42_2152) with
| (x, t, e) -> begin
(let _126_881 = (FStar_All.pipe_left (FStar_Absyn_Util.total_comp t) (FStar_Absyn_Util.range_of_lb (x, t, e)))
in (x, e, _126_881))
end))))
in (FStar_Tc_Util.generalize true env _126_882))
in (let _126_884 = (FStar_List.map (fun _42_2157 -> (match (_42_2157) with
| (x, e, c) -> begin
(FStar_Absyn_Syntax.mk_lb (x, FStar_Absyn_Const.effect_Tot_lid, (FStar_Absyn_Util.comp_result c), e))
end)) ecs)
in (_126_884, FStar_Tc_Rel.trivial_guard))))
end
...
let cres = (let _126_885 = (FStar_Absyn_Util.total_comp FStar_Tc_Recheck.t_unit top.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _126_885))
in (
...
in (let _126_889 = (let _126_888 = (w cres)
in (FStar_All.pipe_left _126_888 (FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))))
in (_126_889, cres, FStar_Tc_Rel.trivial_guard)))))
end else begin
(
...
let e = (let _126_894 = (w cres)
in (FStar_All.pipe_left _126_894 (FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))))
in (match (topt) with
| Some (_42_2193) -> begin
(e, cres, guard)
end
...
let _42_2228 = (let _126_896 = (FStar_Tc_Rel.teq env tres t')
in (FStar_All.pipe_left (FStar_Tc_Rel.try_discharge_guard env) _126_896))
in (e, cres, guard)))
end
| _42_2231 -> begin
(e, cres, guard)
...
(let _126_909 = (FStar_Absyn_Print.strBvd x)
in (let _126_908 = (FStar_Tc_Normalize.typ_norm_to_string env t)
...
let expected_pat_t = (let _126_910 = (FStar_Tc_Rel.unrefine env pat_t)
in (FStar_Tc_Normalize.norm_typ ((FStar_Tc_Normalize.Beta)::[]) env _126_910))
in (
...
(let _126_913 = (FStar_Absyn_Print.exp_to_string e)
in (let _126_912 = (FStar_Absyn_Print.typ_to_string pat_t)
...
(let _126_915 = (FStar_Tc_Normalize.exp_norm_to_string env e)
in (let _126_914 = (FStar_Tc_Normalize.typ_norm_to_string env lc.FStar_Absyn_Syntax.res_typ)
...
let _42_2276 = (let _126_916 = (FStar_Tc_Rel.solve_deferred_constraints env g)
in (FStar_All.pipe_left Prims.ignore _126_916))
in (
# 1268 "FStar.Tc.Tc.fst"
let e' = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env e)
in (
# 1269 "FStar.Tc.Tc.fst"
let _42_2279 = if (let _126_919 = (let _126_918 = (FStar_Absyn_Util.uvars_in_exp e')
in (let _126_917 = (FStar_Absyn_Util.uvars_in_typ expected_pat_t)
in (FStar_Absyn_Util.uvars_included_in _126_918 _126_917)))
in (FStar_All.pipe_left Prims.op_Negation _126_919)) then begin
(let _126_924 = (let _126_923 = (let _126_922 = (let _126_921 = (FStar_Absyn_Print.exp_to_string e')
in (let _126_920 = (FStar_Absyn_Print.typ_to_string expected_pat_t)
in (FStar_Util.format2 "Implicit pattern variables in %s could not be resolved against expected type %s; please bind them explicitly" _126_921 _126_920)))
in (_126_922, p.FStar_Absyn_Syntax.p))
...
| FStar_Tc_Env.Binding_var (x, t) -> begin
(let _126_927 = (FStar_Absyn_Print.strBvd x)
in (let _126_926 = (FStar_Absyn_Print.typ_to_string t)
...
let _42_2304 = (let _126_928 = (FStar_Tc_Env.set_expected_typ pat_env FStar_Tc_Recheck.t_bool)
in (tc_exp _126_928 e))
...
| Some (w) -> begin
(let _126_930 = (FStar_Absyn_Util.mk_eq FStar_Absyn_Util.t_bool FStar_Absyn_Util.t_bool w FStar_Absyn_Const.exp_true_bool)
in (FStar_All.pipe_left (fun _126_929 -> Some (_126_929)) _126_930))
end)
in (
...
let _42_2320 = (let _126_931 = (FStar_Tc_Env.push_local_binding env (FStar_Tc_Env.Binding_var ((scrutinee_x, pat_t))))
in (FStar_All.pipe_right _126_931 FStar_Tc_Env.clear_expected_typ))
...
let clause = (let _126_935 = (FStar_Tc_Recheck.recompute_typ scrutinee)
in (let _126_934 = (FStar_Tc_Recheck.recompute_typ e)
in (FStar_Absyn_Util.mk_eq _126_935 _126_934 scrutinee e)))
in (match (fopt) with
| None -> begin
Some (clause)
end
| Some (f) -> begin
(let _126_937 = (FStar_Absyn_Util.mk_disj clause f)
in (FStar_All.pipe_left (fun _126_936 -> Some (_126_936)) _126_937))
end))
end))) None))
in (
...
| (Some (f), Some (w)) -> begin
(let _126_940 = (let _126_939 = (FStar_Absyn_Util.mk_conj f w)
in (FStar_All.pipe_left (fun _126_938 -> FStar_Tc_Rel.NonTrivial (_126_938)) _126_939))
in (FStar_Tc_Util.weaken_precondition env c _126_940))
end
| (None, Some (w)) -> begin
...
let disc = (let _126_946 = (let _126_945 = (FStar_Absyn_Util.mk_discriminator f.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Util.fvar None _126_945))
in (FStar_All.pipe_left _126_946 (FStar_Ident.range_of_lid f.FStar_Absyn_Syntax.v)))
in (
# 1318 "FStar.Tc.Tc.fst"
let disc = (let _126_949 = (let _126_948 = (let _126_947 = (FStar_All.pipe_left FStar_Absyn_Syntax.varg scrutinee)
in (_126_947)::[])
in (disc, _126_948))
in (FStar_Absyn_Syntax.mk_Exp_app _126_949 None scrutinee.FStar_Absyn_Syntax.pos))
...
(let _126_958 = (let _126_957 = (let _126_956 = (FStar_Absyn_Syntax.varg scrutinee)
in (let _126_955 = (let _126_954 = (FStar_Absyn_Syntax.varg pat_exp)
in (_126_954)::[])
in (_126_956)::_126_955))
in (FStar_Absyn_Util.teq, _126_957))
in (FStar_Absyn_Syntax.mk_Typ_app _126_958 None scrutinee.FStar_Absyn_Syntax.pos))
end
...
let sub_term_guards = (let _126_967 = (FStar_All.pipe_right args (FStar_List.mapi (fun i arg -> (match ((Prims.fst arg)) with
...
in if (let _126_961 = (FStar_Tc_Env.is_projector env projector)
in (FStar_All.pipe_left Prims.op_Negation _126_961)) then begin
[]
end else begin
(
# 1338 "FStar.Tc.Tc.fst"
let sub_term = (let _126_965 = (let _126_964 = (FStar_Absyn_Util.fvar None projector f.FStar_Absyn_Syntax.p)
in (let _126_963 = (let _126_962 = (FStar_Absyn_Syntax.varg scrutinee)
in (_126_962)::[])
in (_126_964, _126_963)))
in (FStar_Absyn_Syntax.mk_Exp_app _126_965 None f.FStar_Absyn_Syntax.p))
in (let _126_966 = (mk_guard sub_term ei)
in (_126_966)::[]))
end)
end))))
in (FStar_All.pipe_right _126_967 FStar_List.flatten))
in (FStar_Absyn_Util.mk_conj_l ((head)::sub_term_guards))))
end
| _42_2428 -> begin
(let _126_970 = (let _126_969 = (FStar_Range.string_of_range pat_exp.FStar_Absyn_Syntax.pos)
in (let _126_968 = (FStar_Absyn_Print.exp_to_string pat_exp)
in (FStar_Util.format2 "tc_eqn: Impossible (%s) %s" _126_969 _126_968)))
in (FStar_All.failwith _126_970))
end)))
in (
...
let path_guard = (let _126_979 = (FStar_All.pipe_right disj_exps (FStar_List.map (fun e -> (let _126_978 = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env e)
in (mk_guard scrutinee pat_t _126_978)))))
in (FStar_All.pipe_right _126_979 FStar_Absyn_Util.mk_disj_l))
in (
...
let guard = (let _126_980 = (FStar_Tc_Rel.conj_guard g_when g_branch)
in (FStar_Tc_Rel.conj_guard g_pat _126_980))
in (
# 1353 "FStar.Tc.Tc.fst"
let _42_2445 = if (FStar_Tc_Env.debug env FStar_Options.High) then begin
(let _126_981 = (FStar_Tc_Rel.guard_to_string env guard)
in (FStar_All.pipe_left (FStar_Util.print1 "Carrying guard from match: %s\n") _126_981))
end else begin
()
end
in (let _126_983 = (let _126_982 = (FStar_Tc_Rel.conj_guard g_when g_branch)
in (FStar_Tc_Rel.conj_guard g_pat _126_982))
in ((pattern, when_clause, branch), path_guard, c, _126_983))))))))))
end)))
end)))
end))
end)))
...
let c = (let _126_993 = (c.FStar_Absyn_Syntax.comp ())
in (FStar_All.pipe_right _126_993 (norm_c env)))
in (match ((let _126_995 = (let _126_994 = (FStar_Tc_Env.get_range env)
in (FStar_Absyn_Util.total_comp (FStar_Absyn_Util.comp_result c) _126_994))
in (FStar_Tc_Rel.sub_comp env c _126_995))) with
| Some (g') -> begin
(let _126_996 = (FStar_Tc_Rel.conj_guard g g')
in (e, (FStar_Absyn_Util.comp_result c), _126_996))
end
| _42_2481 -> begin
(let _126_999 = (let _126_998 = (let _126_997 = (FStar_Tc_Errors.expected_pure_expression e c)
in (_126_997, e.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_126_998))
in (Prims.raise _126_999))
end)))
end
end)))
...
let c = (let _126_1002 = (c.FStar_Absyn_Syntax.comp ())
in (FStar_All.pipe_right _126_1002 (norm_c env)))
in (
...
| Some (g') -> begin
(let _126_1003 = (FStar_Tc_Rel.conj_guard g g')
in (e, (FStar_Absyn_Util.comp_result c), _126_1003))
end
| _42_2496 -> begin
(let _126_1006 = (let _126_1005 = (let _126_1004 = (FStar_Tc_Errors.expected_ghost_expression e c)
in (_126_1004, e.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_126_1005))
in (Prims.raise _126_1006))
end))))
end
end)))
...
| _42_2530 -> begin
(let _126_1019 = (let _126_1018 = (let _126_1017 = (FStar_Tc_Errors.unexpected_signature_for_monad env m s)
in (_126_1017, (FStar_Ident.range_of_lid m)))
in FStar_Absyn_Syntax.Error (_126_1018))
in (Prims.raise _126_1019))
end))
...
let a_kwp_b = (let _126_1032 = (let _126_1031 = (let _126_1030 = (FStar_Absyn_Syntax.null_v_binder a_typ)
in (_126_1030)::[])
in (_126_1031, kwp_b))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1032 a_typ.FStar_Absyn_Syntax.pos))
in (
...
let expected_k = (let _126_1046 = (let _126_1045 = (let _126_1044 = (let _126_1043 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1042 = (let _126_1041 = (FStar_Absyn_Syntax.null_v_binder a_typ)
in (_126_1041)::[])
in (_126_1043)::_126_1042))
in (_126_1044, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1045))
in (FStar_All.pipe_left w _126_1046))
in (let _126_1047 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.ret expected_k)
in (FStar_All.pipe_right _126_1047 (norm_t env))))
in (
# 1423 "FStar.Tc.Tc.fst"
let bind_wp = (
# 1424 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1062 = (let _126_1061 = (let _126_1060 = (let _126_1059 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1058 = (let _126_1057 = (FStar_Absyn_Syntax.t_binder b)
in (let _126_1056 = (let _126_1055 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (let _126_1054 = (let _126_1053 = (FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (let _126_1052 = (let _126_1051 = (FStar_Absyn_Syntax.null_t_binder a_kwp_b)
in (let _126_1050 = (let _126_1049 = (FStar_Absyn_Syntax.null_t_binder a_kwlp_b)
in (_126_1049)::[])
in (_126_1051)::_126_1050))
in (_126_1053)::_126_1052))
in (_126_1055)::_126_1054))
in (_126_1057)::_126_1056))
in (_126_1059)::_126_1058))
in (_126_1060, kwp_b))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1061))
in (FStar_All.pipe_left w _126_1062))
in (let _126_1063 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.bind_wp expected_k)
in (FStar_All.pipe_right _126_1063 (norm_t env))))
in (
# 1429 "FStar.Tc.Tc.fst"
let bind_wlp = (
# 1430 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1074 = (let _126_1073 = (let _126_1072 = (let _126_1071 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1070 = (let _126_1069 = (FStar_Absyn_Syntax.t_binder b)
in (let _126_1068 = (let _126_1067 = (FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (let _126_1066 = (let _126_1065 = (FStar_Absyn_Syntax.null_t_binder a_kwlp_b)
in (_126_1065)::[])
in (_126_1067)::_126_1066))
in (_126_1069)::_126_1068))
in (_126_1071)::_126_1070))
in (_126_1072, kwlp_b))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1073))
in (FStar_All.pipe_left w _126_1074))
in (let _126_1075 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.bind_wlp expected_k)
in (FStar_All.pipe_right _126_1075 (norm_t env))))
in (
# 1435 "FStar.Tc.Tc.fst"
let if_then_else = (
# 1436 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1086 = (let _126_1085 = (let _126_1084 = (let _126_1083 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1082 = (let _126_1081 = (FStar_Absyn_Syntax.t_binder b)
in (let _126_1080 = (let _126_1079 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (let _126_1078 = (let _126_1077 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_126_1077)::[])
in (_126_1079)::_126_1078))
in (_126_1081)::_126_1080))
in (_126_1083)::_126_1082))
in (_126_1084, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1085))
in (FStar_All.pipe_left w _126_1086))
in (let _126_1087 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.if_then_else expected_k)
in (FStar_All.pipe_right _126_1087 (norm_t env))))
in (
# 1441 "FStar.Tc.Tc.fst"
let ite_wp = (
# 1442 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1096 = (let _126_1095 = (let _126_1094 = (let _126_1093 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1092 = (let _126_1091 = (FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (let _126_1090 = (let _126_1089 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_126_1089)::[])
in (_126_1091)::_126_1090))
in (_126_1093)::_126_1092))
in (_126_1094, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1095))
in (FStar_All.pipe_left w _126_1096))
in (let _126_1097 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.ite_wp expected_k)
in (FStar_All.pipe_right _126_1097 (norm_t env))))
in (
# 1447 "FStar.Tc.Tc.fst"
let ite_wlp = (
# 1448 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1104 = (let _126_1103 = (let _126_1102 = (let _126_1101 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1100 = (let _126_1099 = (FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (_126_1099)::[])
in (_126_1101)::_126_1100))
in (_126_1102, kwlp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1103))
in (FStar_All.pipe_left w _126_1104))
in (let _126_1105 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.ite_wlp expected_k)
in (FStar_All.pipe_right _126_1105 (norm_t env))))
in (
# 1452 "FStar.Tc.Tc.fst"
let wp_binop = (
# 1453 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1117 = (let _126_1116 = (let _126_1115 = (let _126_1114 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1113 = (let _126_1112 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (let _126_1111 = (let _126_1110 = (let _126_1107 = (FStar_Absyn_Const.kbin FStar_Absyn_Syntax.ktype FStar_Absyn_Syntax.ktype FStar_Absyn_Syntax.ktype)
in (FStar_Absyn_Syntax.null_t_binder _126_1107))
in (let _126_1109 = (let _126_1108 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_126_1108)::[])
in (_126_1110)::_126_1109))
in (_126_1112)::_126_1111))
in (_126_1114)::_126_1113))
in (_126_1115, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1116))
in (FStar_All.pipe_left w _126_1117))
in (let _126_1118 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.wp_binop expected_k)
in (FStar_All.pipe_right _126_1118 (norm_t env))))
in (
# 1459 "FStar.Tc.Tc.fst"
let wp_as_type = (
# 1460 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1125 = (let _126_1124 = (let _126_1123 = (let _126_1122 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1121 = (let _126_1120 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_126_1120)::[])
in (_126_1122)::_126_1121))
in (_126_1123, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1124))
in (FStar_All.pipe_left w _126_1125))
in (let _126_1126 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.wp_as_type expected_k)
in (FStar_All.pipe_right _126_1126 (norm_t env))))
in (
# 1464 "FStar.Tc.Tc.fst"
let close_wp = (
# 1465 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1135 = (let _126_1134 = (let _126_1133 = (let _126_1132 = (FStar_Absyn_Syntax.t_binder b)
in (let _126_1131 = (let _126_1130 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1129 = (let _126_1128 = (FStar_Absyn_Syntax.null_t_binder a_kwp_b)
in (_126_1128)::[])
in (_126_1130)::_126_1129))
in (_126_1132)::_126_1131))
in (_126_1133, kwp_b))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1134))
in (FStar_All.pipe_left w _126_1135))
in (let _126_1136 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.close_wp expected_k)
in (FStar_All.pipe_right _126_1136 (norm_t env))))
in (
# 1469 "FStar.Tc.Tc.fst"
let close_wp_t = (
# 1470 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1149 = (let _126_1148 = (let _126_1147 = (let _126_1146 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1145 = (let _126_1144 = (let _126_1143 = (let _126_1142 = (let _126_1141 = (let _126_1140 = (let _126_1139 = (FStar_Absyn_Syntax.null_t_binder FStar_Absyn_Syntax.ktype)
in (_126_1139)::[])
in (_126_1140, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1141))
in (FStar_All.pipe_left w _126_1142))
in (FStar_Absyn_Syntax.null_t_binder _126_1143))
in (_126_1144)::[])
in (_126_1146)::_126_1145))
in (_126_1147, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1148))
in (FStar_All.pipe_left w _126_1149))
in (let _126_1150 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.close_wp_t expected_k)
in (FStar_All.pipe_right _126_1150 (norm_t env))))
in (
# 1474 "FStar.Tc.Tc.fst"
let _42_2576 = (
# 1475 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1159 = (let _126_1158 = (let _126_1157 = (let _126_1156 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1155 = (let _126_1154 = (FStar_Absyn_Syntax.null_t_binder FStar_Absyn_Syntax.ktype)
in (let _126_1153 = (let _126_1152 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_126_1152)::[])
in (_126_1154)::_126_1153))
in (_126_1156)::_126_1155))
in (_126_1157, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1158))
in (FStar_All.pipe_left w _126_1159))
in (let _126_1163 = (let _126_1160 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.assert_p expected_k)
in (FStar_All.pipe_right _126_1160 (norm_t env)))
in (let _126_1162 = (let _126_1161 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.assume_p expected_k)
in (FStar_All.pipe_right _126_1161 (norm_t env)))
in (_126_1163, _126_1162))))
...
let expected_k = (let _126_1168 = (let _126_1167 = (let _126_1166 = (let _126_1165 = (FStar_Absyn_Syntax.t_binder a)
in (_126_1165)::[])
in (_126_1166, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1167))
in (FStar_All.pipe_left w _126_1168))
in (let _126_1169 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.null_wp expected_k)
in (FStar_All.pipe_right _126_1169 (norm_t env))))
in (
# 1482 "FStar.Tc.Tc.fst"
let trivial_wp = (
# 1483 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1176 = (let _126_1175 = (let _126_1174 = (let _126_1173 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1172 = (let _126_1171 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_126_1171)::[])
in (_126_1173)::_126_1172))
in (_126_1174, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1175))
in (FStar_All.pipe_left w _126_1176))
in (let _126_1177 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.trivial expected_k)
in (FStar_All.pipe_right _126_1177 (norm_t env))))
...
let _42_2597 = (let _126_1181 = (FStar_Options.reset_options ())
in (FStar_All.pipe_right _126_1181 Prims.ignore))
in (se, env)))
end)
end
...
let _42_2612 = (let _126_1182 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.source)
in (a_kwp_a env sub.FStar_Absyn_Syntax.source _126_1182))
in (match (_42_2612) with
| (a, kwp_a_src) -> begin
(
# 1529 "FStar.Tc.Tc.fst"
let _42_2615 = (let _126_1183 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.target)
in (a_kwp_a env sub.FStar_Absyn_Syntax.target _126_1183))
in (match (_42_2615) with
| (b, kwp_b_tgt) -> begin
(
# 1530 "FStar.Tc.Tc.fst"
let kwp_a_tgt = (let _126_1187 = (let _126_1186 = (let _126_1185 = (let _126_1184 = (FStar_Absyn_Util.btvar_to_typ a)
in (b.FStar_Absyn_Syntax.v, _126_1184))
in FStar_Util.Inl (_126_1185))
in (_126_1186)::[])
in (FStar_Absyn_Util.subst_kind _126_1187 kwp_b_tgt))
in (
# 1531 "FStar.Tc.Tc.fst"
let expected_k = (let _126_1193 = (let _126_1192 = (let _126_1191 = (let _126_1190 = (FStar_Absyn_Syntax.t_binder a)
in (let _126_1189 = (let _126_1188 = (FStar_Absyn_Syntax.null_t_binder kwp_a_src)
in (_126_1188)::[])
in (_126_1190)::_126_1189))
in (_126_1191, kwp_a_tgt))
in (FStar_Absyn_Syntax.mk_Kind_arrow _126_1192))
in (FStar_All.pipe_right r _126_1193))
in (
...
(let _126_1196 = (FStar_Absyn_Print.sli lid)
in (let _126_1195 = (let _126_1194 = (FStar_Absyn_Util.close_kind tps k)
in (FStar_Absyn_Print.kind_to_string _126_1194))
...
(let _126_1197 = (FStar_Tc_Rel.keq env None k FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env) _126_1197))
end
| _42_2658 -> begin
()
end)
...
in (let _126_1200 = (FStar_All.pipe_right c'.FStar_Absyn_Syntax.effect_name (fun _126_1199 -> Some (_126_1199)))
in FStar_Absyn_Syntax.DefaultEffect (_126_1200)))
end
| t -> begin
t
end))))
...
let _42_2716 = (let _126_1204 = (tc_typ_trivial env' t)
in (FStar_All.pipe_right _126_1204 (fun _42_2713 -> (match (_42_2713) with
| (t, k) -> begin
(let _126_1203 = (norm_t env' t)
in (let _126_1202 = (norm_k env' k)
in (_126_1203, _126_1202)))
end))))
...
let k2 = (let _126_1205 = (tc_kind_trivial env' k)
in (FStar_All.pipe_right _126_1205 (norm_k env)))
in (
# 1583 "FStar.Tc.Tc.fst"
let _42_2721 = (let _126_1206 = (FStar_Tc_Rel.keq env' (Some (t)) k1 k2)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env') _126_1206))
in k2))
end)
in (
...
in (FStar_Absyn_Visit.collect_from_typ (fun b t -> (match ((let _126_1214 = (FStar_Absyn_Util.compress_typ t)
in _126_1214.FStar_Absyn_Syntax.n)) with
...
| Some (tname) -> begin
(let _126_1218 = (let _126_1217 = (let _126_1216 = (let _126_1215 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (FStar_Tc_Errors.constructor_fails_the_positivity_check env _126_1215 tname))
in (_126_1216, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_126_1217))
in (Prims.raise _126_1218))
end)
end
| _42_2778 -> begin
()
...
(let _126_1219 = (FStar_Tc_Errors.cardinality_constraint_violated lid a)
in (FStar_Tc_Errors.warn r _126_1219))
end else begin
if (FStar_Options.check_cardinality ()) then begin
(let _126_1222 = (let _126_1221 = (let _126_1220 = (FStar_Tc_Errors.cardinality_constraint_violated lid a)
in (_126_1220, r))
in FStar_Absyn_Syntax.Error (_126_1221))
in (Prims.raise _126_1222))
end else begin
()
end
end
...
let _42_2799 = (let _126_1223 = (FStar_Absyn_Util.function_formals t)
in (FStar_All.pipe_right _126_1223 FStar_Util.must))
...
| Some (args) -> begin
if (not ((((FStar_List.length args) >= (FStar_List.length tps)) && (let _126_1227 = (let _126_1226 = (FStar_Util.first_N (FStar_List.length tps) args)
in (FStar_All.pipe_right _126_1226 Prims.fst))
...
(let _126_1228 = (FStar_Absyn_Util.ftv tname FStar_Absyn_Syntax.kun)
in (FStar_Absyn_Util.mk_typ_app _126_1228 expected_args))
end))
end)
in (let _126_1232 = (let _126_1231 = (let _126_1230 = (let _126_1229 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (FStar_Tc_Errors.constructor_builds_the_wrong_type env _126_1229 result_t expected_t))
in (_126_1230, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_126_1231))
in (Prims.raise _126_1232)))
end else begin
()
end
end
| _42_2853 -> begin
(let _126_1237 = (let _126_1236 = (let _126_1235 = (let _126_1234 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (let _126_1233 = (FStar_Absyn_Util.ftv tname FStar_Absyn_Syntax.kun)
in (FStar_Tc_Errors.constructor_builds_the_wrong_type env _126_1234 result_t _126_1233)))
in (_126_1235, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_126_1236))
in (Prims.raise _126_1237))
end)
in (
...
(let _126_1239 = (let _126_1238 = (FStar_Tc_Normalize.typ_norm_to_string env t)
in (FStar_Util.format2 "data %s : %s\n" lid.FStar_Ident.str _126_1238))
in (FStar_All.pipe_left FStar_Util.print_string _126_1239))
end else begin
()
end
in (se, env)))))))
...
let t = (let _126_1240 = (tc_typ_check_trivial env t FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _126_1240 (FStar_Tc_Normalize.norm_typ ((FStar_Tc_Normalize.Beta)::(FStar_Tc_Normalize.SNComp)::[]) env)))
in (
...
(let _126_1242 = (let _126_1241 = (FStar_Tc_Normalize.typ_norm_to_string env t)
in (FStar_Util.format2 "val %s : %s\n" lid.FStar_Ident.str _126_1241))
in (FStar_All.pipe_left FStar_Util.print_string _126_1242))
end else begin
()
end
in (se, env)))))))
...
let phi = (let _126_1243 = (tc_typ_check_trivial env phi FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _126_1243 (norm_t env)))
in (
...
(let _126_1246 = (FStar_Absyn_Print.typ_to_string t')
in (FStar_Util.print2 "Using annotation %s for let binding %s\n" _126_1246 l.FStar_Ident.str))
end else begin
()
end
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_unknown -> begin
(let _126_1247 = (FStar_Absyn_Syntax.mk_lb (FStar_Util.Inr (l), FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _126_1247))
end
| _42_2924 -> begin
(
...
(let _126_1249 = (let _126_1248 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "%s: Warning: Annotation from val declaration overrides inline type annotation\n" _126_1248))
in (FStar_All.pipe_left FStar_Util.print_string _126_1249))
end else begin
()
end
in (let _126_1250 = (FStar_Absyn_Syntax.mk_lb (FStar_Util.Inr (l), FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _126_1250)))
end))
end)
...
let e = (let _126_1255 = (let _126_1254 = (let _126_1253 = (syn' env FStar_Tc_Recheck.t_unit)
in (FStar_All.pipe_left _126_1253 (FStar_Absyn_Syntax.mk_Exp_constant FStar_Const.Const_unit)))
in (((Prims.fst lbs), lbs'), _126_1254))
in (FStar_Absyn_Syntax.mk_Exp_let _126_1255 None r))
in (
...
(let _126_1261 = (let _126_1260 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (
# 1707 "FStar.Tc.Tc.fst"
let should_log = (match ((let _126_1257 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (FStar_Tc_Env.try_lookup_val_decl env _126_1257))) with
| None -> begin
true
end
| _42_2974 -> begin
...
(let _126_1259 = (FStar_Absyn_Print.lbname_to_string lb.FStar_Absyn_Syntax.lbname)
in (let _126_1258 = (FStar_Tc_Normalize.typ_norm_to_string env lb.FStar_Absyn_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" _126_1259 _126_1258)))
end else begin
""
end))))
in (FStar_All.pipe_right _126_1260 (FStar_String.concat "\n")))
...
let _42_2994 = (let _126_1265 = (let _126_1262 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit r)
in Some (_126_1262))
in (let _126_1264 = (let _126_1263 = (c.FStar_Absyn_Syntax.comp ())
in (e, _126_1263))
in (check_expected_effect env _126_1265 _126_1264)))
in (match (_42_2994) with
| (e, _42_2992, g) -> begin
(
# 1722 "FStar.Tc.Tc.fst"
let _42_2995 = (let _126_1266 = (FStar_Tc_Rel.conj_guard g1 g)
in (FStar_Tc_Util.discharge_guard env _126_1266))
in (
...
let k = (match (k.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_unknown -> begin
(let _126_1270 = (FStar_Tc_Rel.new_kvar r tps)
in (FStar_All.pipe_right _126_1270 Prims.fst))
end
| _42_3035 -> begin
k
end)
...
(let _126_1271 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (FStar_Util.format1 "Recursive bindings: %s" _126_1271))
end else begin
""
end
in (
...
let tt = (let _126_1274 = (FStar_Absyn_Syntax.mk_Typ_ascribed (t, k) t.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.close_with_lam tps _126_1274))
in (
...
| (tps, t) -> begin
(let _126_1276 = (let _126_1275 = (FStar_Absyn_Util.compress_kind k)
in (lid, tps, _126_1275, t, [], r))
in FStar_Absyn_Syntax.Sig_typ_abbrev (_126_1276))
end))
end)))
end
| _42_3085 -> begin
(let _126_1278 = (let _126_1277 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "(%s) Impossible" _126_1277))
in (FStar_All.failwith _126_1278))
...
let _42_3102 = (let _126_1288 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (FStar_Util.print2 "Time %ss : %s\n" (FStar_Util.string_of_float diff) _126_1288))
in res))))))
in (
...
(let _126_1292 = (let _126_1291 = (FStar_Absyn_Print.sigelt_to_string se)
in (FStar_Util.format1 "Checking sigelt\t%s\n" _126_1291))
in (FStar_Util.print_string _126_1292))
end else begin
()
end
in (
...
if (is_abstract quals) then begin
(let _126_1310 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let _126_1309 = (let _126_1308 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (_126_1308, lb.FStar_Absyn_Syntax.lbtyp, (FStar_Absyn_Syntax.Assumption)::quals, r))
in FStar_Absyn_Syntax.Sig_val_decl (_126_1309)))))
in (_126_1310, hidden))
end else begin
((se)::[], hidden)
end
...
in (let _126_1332 = (FStar_Options.reset_options ())
in (FStar_All.pipe_right _126_1332 Prims.ignore)))))
end else begin
()
end
in (modul, env))))))
...
in (let _126_1345 = (FStar_List.fold_left do_sigelt en m.FStar_Absyn_Syntax.exports)
in (FStar_Tc_Env.finish_module _126_1345 m)))))
...
let _42_3318 = if ((let _126_1350 = (FStar_ST.read FStar_Options.debug)
in (FStar_List.length _126_1350)) <> 0) then begin
(let _126_1351 = (FStar_Absyn_Print.sli m.FStar_Absyn_Syntax.name)
...
(let _126_1352 = (FStar_Absyn_Print.modul_to_string m)
in (FStar_Util.print1 "%s\n" _126_1352))
end else begin
()
end
