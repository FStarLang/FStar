...
open Prims
# 30 "FStar.Tc.Tc.fst"
let syn' = (fun env k -> (let _124_11 = (FStar_Tc_Env.get_range env)
in (FStar_Absyn_Syntax.syn _124_11 (Some (k)))))

# 31 "FStar.Tc.Tc.fst"
let log : FStar_Tc_Env.env  ->  Prims.bool = (fun env -> ((FStar_ST.read FStar_Options.log_types) && (not ((let _124_14 = (FStar_Tc_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Absyn_Const.prims_lid _124_14))))))
...
in (let _124_34 = (let _124_33 = (let _124_32 = (let _124_27 = (let _124_26 = (FStar_Tc_Recheck.recompute_typ v)
in (FStar_All.pipe_left (fun _124_25 -> FStar_Util.Inl (_124_25)) _124_26))
in (_124_27, Some (FStar_Absyn_Syntax.Implicit (false))))
in (let _124_31 = (let _124_30 = (FStar_Absyn_Syntax.varg v)
in (let _124_29 = (let _124_28 = (FStar_Absyn_Syntax.varg tl)
in (_124_28)::[])
in (_124_30)::_124_29))
in (_124_32)::_124_31))
in (FStar_Absyn_Util.lex_pair, _124_33))
in (FStar_Absyn_Syntax.mk_Exp_app _124_34 (Some (FStar_Absyn_Util.lex_t)) r)))) vs FStar_Absyn_Util.lex_top))
...
# 47 "FStar.Tc.Tc.fst"
let norm_t : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun env t -> (let _124_47 = (steps env)
in (FStar_Tc_Normalize.norm_typ _124_47 env t)))

# 48 "FStar.Tc.Tc.fst"
let norm_k : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.knd = (fun env k -> (let _124_52 = (steps env)
in (FStar_Tc_Normalize.norm_kind _124_52 env k)))

# 49 "FStar.Tc.Tc.fst"
let norm_c : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.comp  ->  FStar_Absyn_Syntax.comp = (fun env c -> (let _124_57 = (steps env)
in (FStar_Tc_Normalize.norm_comp _124_57 env c)))
...
(let _124_76 = if norm then begin
(norm_k env k)
end else begin
k
end
in (FStar_Absyn_Util.freevars_kind _124_76))
end
| FStar_Util.Inr (t) -> begin
(let _124_77 = if norm then begin
(norm_t env t)
end else begin
t
end
in (FStar_Absyn_Util.freevars_typ _124_77))
end)
in (
# 56 "FStar.Tc.Tc.fst"
...
(
# 62 "FStar.Tc.Tc.fst"
let escaping = (let _124_82 = (let _124_81 = (FStar_Util.set_elements a)
in (FStar_All.pipe_right _124_81 (FStar_List.map (fun x -> (FStar_Absyn_Print.strBvd x.FStar_Absyn_Syntax.v)))))
in (FStar_All.pipe_right _124_82 (FStar_String.concat ", ")))
in (
# 63 "FStar.Tc.Tc.fst"
let msg = if ((FStar_Util.set_count a) > 1) then begin
(let _124_83 = (FStar_Tc_Normalize.exp_norm_to_string env head)
in (FStar_Util.format2 "Bound variables \'{%s}\' in the type of \'%s\' escape because of impure applications; add explicit let-bindings" escaping _124_83))
end else begin
(let _124_84 = (FStar_Tc_Normalize.exp_norm_to_string env head)
in (FStar_Util.format2 "Bound variable \'%s\' in the type of \'%s\' escapes because of impure applications; add explicit let-bindings" escaping _124_84))
end
in (let _124_87 = (let _124_86 = (let _124_85 = (FStar_Tc_Env.get_range env)
in (msg, _124_85))
in FStar_Absyn_Syntax.Error (_124_86))
in (Prims.raise _124_87))))
end))
in (match (kt) with
| FStar_Util.Inl (k) -> begin
(
...
(let _124_98 = (let _124_97 = (let _124_96 = (FStar_Absyn_Util.btvar_to_typ b)
in (a.FStar_Absyn_Syntax.v, _124_96))
in FStar_Util.Inl (_124_97))
in (_124_98)::s)
end
end
...
(let _124_101 = (let _124_100 = (let _124_99 = (FStar_Absyn_Util.bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _124_99))
in FStar_Util.Inr (_124_100))
in (_124_101)::s)
end
end
| _42_114 -> begin
...
| () -> begin
(let _124_110 = (lc.FStar_Absyn_Syntax.comp ())
in (FStar_Absyn_Util.set_result_typ _124_110 t))
end))}))
...
(let _124_117 = if (not ((FStar_Absyn_Util.is_pure_or_ghost_function t))) then begin
(FStar_Absyn_Syntax.mk_Total t)
end else begin
(FStar_Tc_Util.return_value env t e)
end
in (FStar_Tc_Util.lcomp_of_comp _124_117))
end
...
(let _124_119 = (FStar_Absyn_Print.typ_to_string t)
in (let _124_118 = (FStar_Absyn_Print.typ_to_string t')
...
(
# 129 "FStar.Tc.Tc.fst"
let _42_154 = (let _124_125 = (FStar_All.pipe_left (fun _124_124 -> Some (_124_124)) (FStar_Tc_Errors.subtyping_failed env t t'))
in (FStar_Tc_Util.strengthen_precondition _124_125 env e lc g))
...
(let _124_126 = (FStar_Absyn_Print.lcomp_typ_to_string lc)
...
| None -> begin
(let _124_139 = (norm_c env c)
in (e, _124_139, FStar_Tc_Rel.trivial_guard))
end
| Some (expected_c) -> begin
(
# 162 "FStar.Tc.Tc.fst"
let _42_187 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _124_142 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _124_141 = (FStar_Absyn_Print.comp_typ_to_string c)
in (let _124_140 = (FStar_Absyn_Print.comp_typ_to_string expected_c)
in (FStar_Util.print3 "(%s) About to check\n\t%s\nagainst expected effect\n\t%s\n" _124_142 _124_141 _124_140))))
end else begin
()
end
in (
...
in (
# 165 "FStar.Tc.Tc.fst"
let expected_c' = (let _124_143 = (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp expected_c)
in (FStar_Tc_Util.refresh_comp_label env true _124_143))
in (
# 166 "FStar.Tc.Tc.fst"
let _42_195 = (let _124_144 = (expected_c'.FStar_Absyn_Syntax.comp ())
in (FStar_All.pipe_left (FStar_Tc_Util.check_comp env e c) _124_144))
in (match (_42_195) with
| (e, _42_193, g) -> begin
(
# 167 "FStar.Tc.Tc.fst"
let _42_196 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _124_146 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _124_145 = (FStar_Tc_Rel.guard_to_string env g)
...
(let _124_152 = (let _124_151 = (let _124_150 = (FStar_Tc_Errors.unexpected_non_trivial_precondition_on_term env f)
in (let _124_149 = (FStar_Tc_Env.get_range env)
in (_124_150, _124_149)))
in FStar_Absyn_Syntax.Error (_124_151))
in (Prims.raise _124_152))
end)
end))
...
| Some (t) -> begin
(let _124_159 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.print1 "Expected type is %s" _124_159))
end))
...
(let _124_212 = (FStar_Range.string_of_range k.FStar_Absyn_Syntax.pos)
in (let _124_211 = (FStar_Absyn_Print.kind_to_string k)
in (FStar_Util.print2 "(%s) - Checking kind %s" _124_212 _124_211)))
end else begin
()
end
in (
...
| (args, g) -> begin
(let _124_214 = (FStar_All.pipe_left w (FStar_Absyn_Syntax.mk_Kind_uvar (u, args)))
in (_124_214, g))
end))
end)))
end
...
(let _124_218 = (let _124_217 = (let _124_216 = (let _124_215 = (FStar_Absyn_Print.sli l)
in (Prims.strcat "Unexpected number of arguments to kind abbreviation " _124_215))
in (_124_216, k.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_124_217))
in (Prims.raise _124_218))
end else begin
(
# 204 "FStar.Tc.Tc.fst"
...
(
# 207 "FStar.Tc.Tc.fst"
let _42_289 = (let _124_222 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in (tc_typ_check env t _124_222))
in (match (_42_289) with
| (t, g) -> begin
(
# 208 "FStar.Tc.Tc.fst"
let subst = (FStar_Util.Inl ((a.FStar_Absyn_Syntax.v, t)))::subst
in (let _124_224 = (let _124_223 = (FStar_Absyn_Syntax.targ t)
in (_124_223)::args)
in (subst, _124_224, (g)::guards)))
end))
end
| (FStar_Util.Inr (x), FStar_Util.Inr (e)) -> begin
(
# 211 "FStar.Tc.Tc.fst"
let env = (let _124_225 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Env.set_expected_typ env _124_225))
in (
# 212 "FStar.Tc.Tc.fst"
...
in (let _124_227 = (let _124_226 = (FStar_Absyn_Syntax.varg e)
in (_124_226)::args)
in (subst, _124_227, (g)::guards)))
end)))
end
| _42_304 -> begin
...
in (let _124_230 = (FStar_List.fold_left FStar_Tc_Rel.conj_guard g guards)
in (k', _124_230))))))
end))
end
end))
...
in (let _124_232 = (FStar_Tc_Rel.conj_guard f g)
in (kk, _124_232))))
end))
end))
end
...
in (let _124_235 = (FStar_All.pipe_left w (FStar_Absyn_Syntax.mk_Kind_arrow (bs, k)))
in (let _124_234 = (FStar_Tc_Rel.conj_guard g f)
in (_124_235, _124_234))))
end))
end))
end
| FStar_Absyn_Syntax.Kind_unknown -> begin
(let _124_236 = (FStar_Tc_Util.new_kvar env)
in (_124_236, FStar_Tc_Rel.trivial_guard))
end))))
...
in (
# 242 "FStar.Tc.Tc.fst"
let env' = (let _124_239 = (FStar_Absyn_Syntax.v_binder x)
in (maybe_push_binding env _124_239))
in (x, env', g)))
end)))
...
| (bs, env', g') -> begin
(let _124_247 = (let _124_246 = (FStar_Tc_Rel.close_guard ((b)::[]) g')
in (FStar_Tc_Rel.conj_guard g _124_246))
in ((b)::bs, env', _124_247))
end))))
end))
end
| FStar_Util.Inr (x) -> begin
...
| (bs, env', g') -> begin
(let _124_249 = (let _124_248 = (FStar_Tc_Rel.close_guard ((b)::[]) g')
in (FStar_Tc_Rel.conj_guard g _124_248))
in ((b)::bs, env', _124_249))
end)))
end))
end)
end))
...
| (t, _42_394, g') -> begin
(let _124_254 = (FStar_Tc_Rel.conj_guard g g')
in (((FStar_Util.Inl (t), imp))::args, _124_254))
end))
end
...
| (e, _42_401, g') -> begin
(let _124_255 = (FStar_Tc_Rel.conj_guard g g')
in (((FStar_Util.Inr (e), imp))::args, _124_255))
end))
end)
...
| (args, g') -> begin
(let _124_260 = (FStar_Tc_Rel.conj_guard g g')
in ((args)::pats, _124_260))
end))
...
| (t, g) -> begin
(let _124_263 = (FStar_Absyn_Syntax.mk_Total t)
in (_124_263, g))
end))
end
...
in (
# 286 "FStar.Tc.Tc.fst"
let tc = (let _124_266 = (let _124_265 = (let _124_264 = (FStar_Absyn_Syntax.targ c.FStar_Absyn_Syntax.result_typ)
in (_124_264)::c.FStar_Absyn_Syntax.effect_args)
in (head, _124_265))
in (FStar_Absyn_Syntax.mk_Typ_app _124_266 None c.FStar_Absyn_Syntax.result_typ.FStar_Absyn_Syntax.pos))
in (
# 287 "FStar.Tc.Tc.fst"
...
(
# 292 "FStar.Tc.Tc.fst"
let _42_459 = (let _124_268 = (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_List.map (fun _42_3 -> (match (_42_3) with
...
in (FStar_All.pipe_right _124_268 FStar_List.unzip))
in (match (_42_459) with
| (flags, guards) -> begin
(let _124_270 = (FStar_Absyn_Syntax.mk_Comp (
# 298 "FStar.Tc.Tc.fst"
let _42_460 = c
...
in (let _124_269 = (FStar_List.fold_left FStar_Tc_Rel.conj_guard f guards)
in (_124_270, _124_269)))
end))
end))
end))
end)))))
...
in (let _124_293 = (FStar_Absyn_Syntax.mk_Typ_const i (Some (qk)) t.FStar_Absyn_Syntax.pos)
in (_124_293, qk, FStar_Tc_Rel.trivial_guard)))))
end
...
in (let _124_294 = (FStar_Absyn_Syntax.mk_Typ_const i (Some (qk)) t.FStar_Absyn_Syntax.pos)
in (_124_294, qk, FStar_Tc_Rel.trivial_guard)))))
end
...
(
# 345 "FStar.Tc.Tc.fst"
let rec extract_pats = (fun pats -> (match ((let _124_299 = (FStar_Absyn_Util.compress_exp pats)
...
in (let _124_300 = (extract_pats tl)
in (FStar_List.append pat _124_300)))
end))
end
| _42_588 -> begin
[]
...
in (
# 354 "FStar.Tc.Tc.fst"
let pats = (let _124_301 = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env pats)
in (extract_pats _124_301))
in (
# 355 "FStar.Tc.Tc.fst"
...
| Some (b) -> begin
(let _124_304 = (let _124_303 = (FStar_Absyn_Print.binder_to_string b)
in (FStar_Util.format1 "Pattern misses at least one bound variables: %s" _124_303))
in (FStar_Tc_Errors.warn t.FStar_Absyn_Syntax.pos _124_304))
end))))
end
| _42_603 -> begin
(FStar_All.failwith "Impossible")
...
in (let _124_306 = (let _124_305 = (FStar_Tc_Rel.close_guard bs f)
in (FStar_Tc_Rel.conj_guard g _124_305))
in (t, FStar_Absyn_Syntax.ktype, _124_306))))
end))
end))
end
...
in (let _124_311 = (FStar_All.pipe_left (w k) (FStar_Absyn_Syntax.mk_Typ_lam (bs, t)))
in (let _124_310 = (let _124_309 = (FStar_Tc_Rel.close_guard bs f)
in (FStar_All.pipe_left (FStar_Tc_Rel.conj_guard g) _124_309))
in (_124_311, k, _124_310))))
end))
end))
end
...
(let _124_314 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _124_313 = (FStar_Absyn_Print.typ_to_string phi)
in (let _124_312 = (match ((FStar_Tc_Env.expected_typ env)) with
| None -> begin
"None"
end
| Some (t) -> begin
...
| (phi, f2) -> begin
(let _124_321 = (FStar_All.pipe_left (w FStar_Absyn_Syntax.ktype) (FStar_Absyn_Syntax.mk_Typ_refine (x, phi)))
in (let _124_320 = (let _124_319 = (let _124_318 = (let _124_317 = (FStar_Absyn_Syntax.v_binder x)
in (_124_317)::[])
in (FStar_Tc_Rel.close_guard _124_318 f2))
in (FStar_Tc_Rel.conj_guard f1 _124_319))
in (_124_321, FStar_Absyn_Syntax.ktype, _124_320)))
end)))
end))
end
...
(let _124_324 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _124_323 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
in (let _124_322 = (FStar_Absyn_Print.typ_to_string top)
in (FStar_Util.print3 "(%s) Checking type application (%s): %s\n" _124_324 _124_323 _124_322))))
end else begin
()
end
in (
...
(let _124_328 = (FStar_Range.string_of_range head.FStar_Absyn_Syntax.pos)
in (let _124_327 = (FStar_Absyn_Print.typ_to_string head)
in (let _124_326 = (FStar_Absyn_Print.kind_to_string k1')
in (let _124_325 = (FStar_Absyn_Print.kind_to_string k1)
in (FStar_Util.print4 "(%s) head %s has kind %s ... after norm %s\n" _124_328 _124_327 _124_326 _124_325)))))
end else begin
()
end
in (
...
in (
# 403 "FStar.Tc.Tc.fst"
let kres = (let _124_331 = (FStar_Tc_Rel.new_kvar k1.FStar_Absyn_Syntax.pos binders)
in (FStar_All.pipe_right _124_331 Prims.fst))
in (
# 404 "FStar.Tc.Tc.fst"
let bs = (let _124_332 = (FStar_Tc_Util.tks_of_args args)
in (FStar_Absyn_Util.null_binders_of_tks _124_332))
in (
# 405 "FStar.Tc.Tc.fst"
let kar = (FStar_Absyn_Syntax.mk_Kind_arrow (bs, kres) k1.FStar_Absyn_Syntax.pos)
in (
# 406 "FStar.Tc.Tc.fst"
let _42_662 = (let _124_333 = (FStar_Tc_Rel.keq env None k1 kar)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env) _124_333))
in (kres, args, g)))))))
end))
end
...
| ([], []) -> begin
(let _124_344 = (FStar_Absyn_Util.subst_kind subst kres)
in (_124_344, (FStar_List.rev outargs), g))
end
...
(let _124_348 = (let _124_347 = (let _124_346 = (let _124_345 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _124_345))
in ("Argument is marked as instantiating an implicit parameter; although the expected parameter is explicit", _124_346))
in FStar_Absyn_Syntax.Error (_124_347))
in (Prims.raise _124_348))
end
...
in (
# 419 "FStar.Tc.Tc.fst"
let _42_743 = (let _124_349 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Util.new_implicit_tvar env _124_349))
in (match (_42_743) with
| (t, u) -> begin
(
# 420 "FStar.Tc.Tc.fst"
let targ = (let _124_351 = (FStar_All.pipe_left (fun _124_350 -> Some (_124_350)) (FStar_Absyn_Syntax.Implicit (false)))
in (FStar_Util.Inl (t), _124_351))
in (
# 421 "FStar.Tc.Tc.fst"
...
in (
# 428 "FStar.Tc.Tc.fst"
let _42_776 = (let _124_352 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Util.new_implicit_evar env _124_352))
in (match (_42_776) with
| (e, u) -> begin
(
# 429 "FStar.Tc.Tc.fst"
let varg = (let _124_354 = (FStar_All.pipe_left (fun _124_353 -> Some (_124_353)) (FStar_Absyn_Syntax.Implicit (false)))
in (FStar_Util.Inr (e), _124_354))
in (
# 430 "FStar.Tc.Tc.fst"
...
(let _124_356 = (FStar_Absyn_Print.arg_to_string actual)
in (let _124_355 = (FStar_Absyn_Print.kind_to_string formal_k)
...
(let _124_357 = (FStar_Tc_Rel.guard_to_string env g')
...
in (
# 445 "FStar.Tc.Tc.fst"
let g' = (let _124_359 = (let _124_358 = (FStar_Tc_Util.short_circuit_typ (FStar_Util.Inl (head)) outargs)
in (FStar_All.pipe_left FStar_Tc_Rel.guard_of_guard_formula _124_358))
in (FStar_Tc_Rel.imp_guard _124_359 g'))
in (
# 446 "FStar.Tc.Tc.fst"
let subst = (maybe_extend_subst subst formal actual)
in (let _124_360 = (FStar_Tc_Rel.conj_guard g g')
in (check_args ((actual)::outargs) subst _124_360 formals actuals))))))
end))))
end
...
(let _124_362 = (FStar_Absyn_Print.arg_to_string actual)
in (let _124_361 = (FStar_Absyn_Print.typ_to_string tx)
...
in (
# 456 "FStar.Tc.Tc.fst"
let g' = (let _124_364 = (let _124_363 = (FStar_Tc_Util.short_circuit_typ (FStar_Util.Inl (head)) outargs)
in (FStar_All.pipe_left FStar_Tc_Rel.guard_of_guard_formula _124_363))
in (FStar_Tc_Rel.imp_guard _124_364 g'))
in (
# 457 "FStar.Tc.Tc.fst"
let subst = (maybe_extend_subst subst formal actual)
in (let _124_365 = (FStar_Tc_Rel.conj_guard g g')
in (check_args ((actual)::outargs) subst _124_365 formals actuals)))))
end))))))
end
...
in (let _124_367 = (let _124_366 = (FStar_Absyn_Syntax.targ tv)
in (_124_366)::actuals)
in (check_args outargs subst g ((formal)::formals) _124_367)))
end
| _42_846 -> begin
...
| (_42_861, []) -> begin
(let _124_369 = (let _124_368 = (FStar_Absyn_Syntax.mk_Kind_arrow (formals, kres) kres.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.subst_kind subst _124_368))
in (_124_369, (FStar_List.rev outargs), g))
end
| ([], _42_866) -> begin
(let _124_377 = (let _124_376 = (let _124_375 = (let _124_374 = (let _124_372 = (let _124_371 = (FStar_All.pipe_right outargs (FStar_List.filter (fun _42_4 -> (match (_42_4) with
...
in (FStar_List.length _124_371))
in (FStar_All.pipe_right _124_372 FStar_Util.string_of_int))
in (let _124_373 = (FStar_All.pipe_right (FStar_List.length args0) FStar_Util.string_of_int)
in (FStar_Util.format2 "Too many arguments to type; expected %s arguments but got %s" _124_374 _124_373)))
in (_124_375, top.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_124_376))
in (Prims.raise _124_377))
end))
in (check_args [] [] f1 formals args))
end
| _42_879 -> begin
(let _124_380 = (let _124_379 = (let _124_378 = (FStar_Tc_Errors.expected_tcon_kind env top k1)
in (_124_378, top.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_124_379))
in (Prims.raise _124_380))
end)
end))
in (match ((let _124_384 = (let _124_381 = (FStar_Absyn_Util.compress_typ head)
in _124_381.FStar_Absyn_Syntax.n)
in (let _124_383 = (let _124_382 = (FStar_Absyn_Util.compress_kind k1)
in _124_382.FStar_Absyn_Syntax.n)
in (_124_384, _124_383)))) with
...
| (t1, f2) -> begin
(let _124_388 = (FStar_All.pipe_left (w k1) (FStar_Absyn_Syntax.mk_Typ_ascribed' (t1, k1)))
in (let _124_387 = (FStar_Tc_Rel.conj_guard f1 f2)
in (_124_388, k1, _124_387)))
end))
end))
end
...
(let _124_390 = (FStar_Absyn_Print.typ_to_string s)
in (let _124_389 = (FStar_Absyn_Print.kind_to_string k1)
in (FStar_Util.print2 "Admitting un-instantiated uvar %s at kind %s\n" _124_390 _124_389)))
end else begin
()
end
in (let _124_393 = (FStar_All.pipe_left (w k1) (FStar_Absyn_Syntax.mk_Typ_uvar' (u, k1)))
in (_124_393, k1, FStar_Tc_Rel.trivial_guard)))
end
| _42_921 -> begin
(
# 515 "FStar.Tc.Tc.fst"
let _42_922 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) FStar_Options.High) then begin
(let _124_395 = (FStar_Absyn_Print.typ_to_string s)
in (let _124_394 = (FStar_Absyn_Print.kind_to_string k1)
...
| (t, k, f) -> begin
(let _124_396 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_refresh_label ((t, b, r))))
in (_124_396, k, f))
end))
end
...
| (t, k, f) -> begin
(let _124_397 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_labeled ((t, l, r, p))))
in (_124_397, k, f))
end))
end
...
| (t, k, f) -> begin
(let _124_398 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named ((t, l))))
in (_124_398, k, f))
end))
end
...
in (let _124_401 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_pattern ((quant, pats))))
in (let _124_400 = (FStar_Tc_Util.force_tk quant)
in (let _124_399 = (FStar_Tc_Rel.conj_guard f g)
in (_124_401, _124_400, _124_399)))))
end))
end))
end
...
| _42_972 -> begin
(let _124_403 = (let _124_402 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "Unexpected type : %s\n" _124_402))
in (FStar_All.failwith _124_403))
end))))))
...
(let _124_410 = (let _124_409 = (FStar_Absyn_Syntax.mk_Total t)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _124_409))
in FStar_Util.Inr (_124_410))
end
in (let _124_411 = (value_check_expected_typ env e tc)
in (FStar_All.pipe_left (with_implicits implicits) _124_411)))
end))))
end
...
(let _124_413 = (let _124_412 = (FStar_Absyn_Syntax.mk_Total t)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _124_412))
in FStar_Util.Inr (_124_413))
end
in (
# 573 "FStar.Tc.Tc.fst"
...
(let _124_419 = (let _124_418 = (let _124_417 = (FStar_Util.format1 "Expected a data constructor; got %s" v.FStar_Absyn_Syntax.v.FStar_Ident.str)
in (let _124_416 = (FStar_Tc_Env.get_range env)
in (_124_417, _124_416)))
in FStar_Absyn_Syntax.Error (_124_418))
in (Prims.raise _124_419))
end else begin
(let _124_420 = (value_check_expected_typ env e tc)
in (FStar_All.pipe_left (with_implicits implicits) _124_420))
end))
end))))
end
...
(
# 587 "FStar.Tc.Tc.fst"
let fail = (fun msg t -> (let _124_425 = (let _124_424 = (let _124_423 = (FStar_Tc_Errors.expected_a_term_of_type_t_got_a_function env msg t top)
in (_124_423, top.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_124_424))
in (Prims.raise _124_425)))
in (
# 588 "FStar.Tc.Tc.fst"
...
in (
# 602 "FStar.Tc.Tc.fst"
let rec as_function_typ = (fun norm t -> (match ((let _124_434 = (FStar_Absyn_Util.compress_typ t)
in _124_434.FStar_Absyn_Syntax.n)) with
...
| ([], []) -> begin
(let _124_443 = (FStar_Absyn_Util.subst_comp subst c)
in ((FStar_List.rev out), env, g, _124_443))
end
...
in (
# 636 "FStar.Tc.Tc.fst"
let g = (let _124_444 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard g _124_444))
in (k, g)))
end))
end)
...
in (
# 645 "FStar.Tc.Tc.fst"
let _42_1178 = (match ((let _124_445 = (FStar_Absyn_Util.unmeta_typ y.FStar_Absyn_Syntax.sort)
in _124_445.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Typ_unknown -> begin
(tx, g)
end
| _42_1166 -> begin
...
(let _124_446 = (FStar_Absyn_Print.binder_to_string hd)
...
in (
# 651 "FStar.Tc.Tc.fst"
let g = (let _124_447 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard g _124_447))
in (t, g)))
end)))
end)
...
| _42_1185 -> begin
(let _124_450 = (let _124_449 = (FStar_Absyn_Print.binder_to_string hdannot)
in (let _124_448 = (FStar_Absyn_Print.binder_to_string hd)
in (FStar_Util.format2 "Annotated %s; given %s" _124_449 _124_448)))
in (fail _124_450 t))
end)
end
| ([], _42_1188) -> begin
...
| t -> begin
(let _124_452 = (let _124_451 = (FStar_Absyn_Print.tag_of_typ t)
in (FStar_Util.format1 "More arguments than annotated type (%s)" _124_451))
in (fail _124_452 t))
end)
end else begin
...
(
# 669 "FStar.Tc.Tc.fst"
let c = (let _124_453 = (FStar_Absyn_Syntax.mk_Typ_fun (bs_annot, c) (Some (FStar_Absyn_Syntax.ktype)) c.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.total_comp _124_453 c.FStar_Absyn_Syntax.pos))
in (let _124_454 = (FStar_Absyn_Util.subst_comp subst c)
in ((FStar_List.rev out), env, g, _124_454)))
end)
end))
in (
# 672 "FStar.Tc.Tc.fst"
...
(let _124_459 = (FStar_Absyn_Print.typ_to_string t)
...
(match ((let _124_465 = (let _124_464 = (let _124_463 = (FStar_Absyn_Util.unrefine x.FStar_Absyn_Syntax.sort)
in (whnf env _124_463))
in (FStar_Absyn_Util.unrefine _124_464))
in _124_465.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Typ_fun (_42_1235) -> begin
[]
end
| _42_1238 -> begin
(let _124_466 = (FStar_Absyn_Util.bvar_to_exp x)
in (_124_466)::[])
end)
end)))))
in (
...
(let _124_475 = (let _124_474 = (let _124_473 = (let _124_471 = (FStar_Util.string_of_int (FStar_List.length bs'))
in (let _124_470 = (FStar_Util.string_of_int (FStar_List.length actuals))
in (FStar_Util.format2 "Decreases clause on a function with an unexpected number of arguments (expected %s; got %s)" _124_471 _124_470)))
in (let _124_472 = (FStar_Tc_Env.get_range env)
in (_124_473, _124_472)))
in FStar_Absyn_Syntax.Error (_124_474))
in (Prims.raise _124_475))
end else begin
()
end
in (
...
(let _124_479 = (let _124_478 = (FStar_Absyn_Util.btvar_to_typ actual)
in (formal.FStar_Absyn_Syntax.v, _124_478))
in FStar_Util.Inl (_124_479))
end
| ((FStar_Util.Inr (formal), _42_1282), (FStar_Util.Inr (actual), _42_1287)) -> begin
(let _124_481 = (let _124_480 = (FStar_Absyn_Util.bvar_to_exp actual)
in (formal.FStar_Absyn_Syntax.v, _124_480))
in FStar_Util.Inr (_124_481))
end
| _42_1291 -> begin
(FStar_All.failwith "impossible")
end)) bs' actuals)
...
in (match ((let _124_483 = (FStar_Absyn_Util.compress_typ t)
in _124_483.FStar_Absyn_Syntax.n)) with
...
let dec = (
# 726 "FStar.Tc.Tc.fst"
let subst = (let _124_487 = (let _124_486 = (let _124_485 = (FStar_Absyn_Util.bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _124_485))
in FStar_Util.Inr (_124_486))
in (_124_487)::[])
in (FStar_Absyn_Util.subst_exp subst dec))
in (let _124_492 = (let _124_491 = (let _124_490 = (FStar_Absyn_Syntax.varg dec)
in (let _124_489 = (let _124_488 = (FStar_Absyn_Syntax.varg prev_dec)
in (_124_488)::[])
in (_124_490)::_124_489))
in (precedes, _124_491))
in (FStar_Absyn_Syntax.mk_Typ_app _124_492 None r))))
end
| _42_1330 -> begin
(
# 731 "FStar.Tc.Tc.fst"
let formal_args = (let _124_495 = (let _124_494 = (let _124_493 = (FStar_Absyn_Syntax.v_binder y)
in (_124_493)::[])
in (FStar_List.append bs _124_494))
in (FStar_All.pipe_right _124_495 filter_types_and_functions))
in (
# 732 "FStar.Tc.Tc.fst"
...
in (let _124_500 = (let _124_499 = (let _124_498 = (FStar_Absyn_Syntax.varg lhs)
in (let _124_497 = (let _124_496 = (FStar_Absyn_Syntax.varg prev_dec)
in (_124_496)::[])
in (_124_498)::_124_497))
in (precedes, _124_499))
in (FStar_Absyn_Syntax.mk_Typ_app _124_500 None r))))
end)
in (
# 737 "FStar.Tc.Tc.fst"
...
(let _124_503 = (FStar_Absyn_Print.lbname_to_string l)
in (let _124_502 = (FStar_Absyn_Print.typ_to_string t)
in (let _124_501 = (FStar_Absyn_Print.typ_to_string t')
in (FStar_Util.print3 "Refined let rec %s\n\tfrom type %s\n\tto type %s\n" _124_503 _124_502 _124_501))))
end else begin
()
end
in (
# 743 "FStar.Tc.Tc.fst"
let _42_1350 = (let _124_505 = (let _124_504 = (FStar_Tc_Env.clear_expected_typ env)
in (FStar_All.pipe_right _124_504 Prims.fst))
in (tc_typ _124_505 t'))
...
in (let _124_511 = (FStar_All.pipe_right letrecs (FStar_List.fold_left (fun env _42_1359 -> (match (_42_1359) with
| (x, t) -> begin
(FStar_Tc_Env.push_local_binding env (binding_of_lb x t))
end)) env))
in (let _124_510 = (FStar_All.pipe_right letrecs (FStar_List.collect (fun _42_8 -> (match (_42_8) with
| (FStar_Util.Inl (x), t) -> begin
(let _124_509 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_124_509)::[])
end
| _42_1366 -> begin
[]
end))))
in (_124_511, _124_510)))))))))))
end))
in (
# 755 "FStar.Tc.Tc.fst"
...
| _42_1390 -> begin
if (not (norm)) then begin
(let _124_512 = (whnf env t)
in (as_function_typ true _124_512))
end else begin
(
# 771 "FStar.Tc.Tc.fst"
...
(let _124_515 = (FStar_Absyn_Print.exp_to_string body)
in (let _124_514 = (FStar_Absyn_Print.lcomp_typ_to_string cbody)
in (let _124_513 = (FStar_Tc_Rel.guard_to_string env guard_body)
in (FStar_Util.print3 "!!!!!!!!!!!!!!!body %s has type %s\nguard is %s\n" _124_515 _124_514 _124_513))))
end else begin
()
end
in (
...
(let _124_516 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length guard_body.FStar_Tc_Rel.implicits))
...
(
# 787 "FStar.Tc.Tc.fst"
let _42_1429 = (let _124_519 = (FStar_Tc_Rel.conj_guard g guard)
in (FStar_Tc_Util.discharge_guard envbody _124_519))
in (
# 787 "FStar.Tc.Tc.fst"
...
in (
# 792 "FStar.Tc.Tc.fst"
let e = (let _124_521 = (let _124_520 = (FStar_Absyn_Syntax.mk_Exp_abs (bs, body) (Some (tfun_computed)) top.FStar_Absyn_Syntax.pos)
in (_124_520, tfun_computed, Some (FStar_Absyn_Const.effect_Tot_lid)))
in (FStar_Absyn_Syntax.mk_Exp_ascribed _124_521 None top.FStar_Absyn_Syntax.pos))
in (
# 794 "FStar.Tc.Tc.fst"
...
(let _124_524 = (let _124_523 = (let _124_522 = (FStar_Absyn_Syntax.mk_Exp_abs (bs, body) (Some (t)) e.FStar_Absyn_Syntax.pos)
in (_124_522, t, Some (FStar_Absyn_Const.effect_Tot_lid)))
in (FStar_Absyn_Syntax.mk_Exp_ascribed _124_523 None top.FStar_Absyn_Syntax.pos))
in (_124_524, t, guard))
end
| _42_1446 -> begin
(
...
(let _124_525 = (FStar_Tc_Rel.teq env t tfun_computed)
in (e, _124_525))
end else begin
...
| (e, guard') -> begin
(let _124_527 = (FStar_Absyn_Syntax.mk_Exp_ascribed (e, t, Some (FStar_Absyn_Const.effect_Tot_lid)) None top.FStar_Absyn_Syntax.pos)
in (let _124_526 = (FStar_Tc_Rel.conj_guard guard guard')
in (_124_527, t, _124_526)))
end))
end))
end
| None -> begin
...
(let _124_530 = (FStar_Absyn_Print.typ_to_string tfun)
in (let _124_529 = (FStar_Absyn_Print.tag_of_typ tfun)
in (let _124_528 = (FStar_Tc_Rel.guard_to_string env guard)
in (FStar_Util.print3 "!!!!!!!!!!!!!!!Annotating lambda with type %s (%s)\nGuard is %s\n" _124_530 _124_529 _124_528))))
end else begin
()
end
in (
...
in (
# 817 "FStar.Tc.Tc.fst"
let _42_1460 = (let _124_532 = (FStar_Tc_Util.lcomp_of_comp c)
in (FStar_Tc_Util.strengthen_precondition None env e _124_532 guard))
...
| _42_1462 -> begin
(let _124_534 = (let _124_533 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format1 "Unexpected value: %s" _124_533))
in (FStar_All.failwith _124_534))
end))))
...
(let _124_539 = (let _124_537 = (FStar_Tc_Env.get_range env)
in (FStar_All.pipe_left FStar_Range.string_of_range _124_537))
in (let _124_538 = (FStar_Absyn_Print.tag_of_exp e)
...
(let _124_563 = (FStar_Absyn_Util.compress_exp e)
in (tc_exp env _124_563))
end
...
(
# 840 "FStar.Tc.Tc.fst"
let _42_1501 = (let _124_564 = (FStar_Tc_Env.set_expected_typ env t1)
in (tc_exp _124_564 e1))
in (match (_42_1501) with
| (e1, c, g) -> begin
(
# 841 "FStar.Tc.Tc.fst"
let _42_1505 = (let _124_568 = (FStar_Tc_Env.set_range env t1.FStar_Absyn_Syntax.pos)
...
(
# 842 "FStar.Tc.Tc.fst"
let _42_1509 = (let _124_572 = (let _124_571 = (w c)
in (FStar_All.pipe_left _124_571 (FStar_Absyn_Syntax.mk_Exp_ascribed (e1, t1, Some (c.FStar_Absyn_Syntax.eff_name)))))
in (comp_check_expected_typ env _124_572 c))
in (match (_42_1509) with
| (e, c, f2) -> begin
(let _124_574 = (let _124_573 = (FStar_Tc_Rel.conj_guard g f2)
in (FStar_Tc_Rel.conj_guard f _124_573))
in (e, c, _124_574))
end))
end))
end))
...
(
# 846 "FStar.Tc.Tc.fst"
let pats_t = (let _124_580 = (let _124_579 = (let _124_575 = (FStar_Absyn_Const.kunary FStar_Absyn_Syntax.mk_Kind_type FStar_Absyn_Syntax.mk_Kind_type)
in (FStar_Absyn_Util.ftv FStar_Absyn_Const.list_lid _124_575))
in (let _124_578 = (let _124_577 = (let _124_576 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.pattern_lid FStar_Absyn_Syntax.mk_Kind_type)
in (FStar_Absyn_Syntax.targ _124_576))
in (_124_577)::[])
in (_124_579, _124_578)))
in (FStar_Absyn_Syntax.mk_Typ_app _124_580 None FStar_Absyn_Syntax.dummyRange))
in (
# 847 "FStar.Tc.Tc.fst"
let _42_1519 = (let _124_581 = (FStar_Tc_Env.set_expected_typ env pats_t)
in (tc_ghost_exp _124_581 e))
...
in (
# 849 "FStar.Tc.Tc.fst"
let c = (let _124_582 = (FStar_Absyn_Util.gtotal_comp pats_t)
in (FStar_All.pipe_right _124_582 FStar_Tc_Util.lcomp_of_comp))
in (e, c, g)))
end)))
end
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, FStar_Absyn_Syntax.Sequence)) -> begin
(match ((let _124_583 = (FStar_Absyn_Util.compress_exp e)
in _124_583.FStar_Absyn_Syntax.n)) with
...
(
# 855 "FStar.Tc.Tc.fst"
let _42_1546 = (let _124_584 = (FStar_Tc_Env.set_expected_typ env FStar_Tc_Recheck.t_unit)
in (tc_exp _124_584 e1))
...
in (let _124_597 = (let _124_595 = (let _124_594 = (let _124_593 = (let _124_592 = (w c)
in (let _124_591 = (let _124_590 = (let _124_589 = (let _124_588 = (let _124_587 = (FStar_Absyn_Syntax.mk_lb (x, c1.FStar_Absyn_Syntax.eff_name, FStar_Tc_Recheck.t_unit, e1))
in (_124_587)::[])
in (false, _124_588))
in (_124_589, e2))
in (FStar_Absyn_Syntax.mk_Exp_let _124_590))
in (FStar_All.pipe_left _124_592 _124_591)))
in (_124_593, FStar_Absyn_Syntax.Sequence))
in FStar_Absyn_Syntax.Meta_desugared (_124_594))
in (FStar_Absyn_Syntax.mk_Exp_meta _124_595))
in (let _124_596 = (FStar_Tc_Rel.conj_guard g1 g2)
in (_124_597, c, _124_596))))
end))
end))
end
| _42_1553 -> begin
...
| (e, c, g) -> begin
(let _124_598 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared ((e, FStar_Absyn_Syntax.Sequence))))
in (_124_598, c, g))
end))
end)
end
...
| (e, c, g) -> begin
(let _124_599 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared ((e, i))))
in (_124_599, c, g))
end))
end
...
in (
# 870 "FStar.Tc.Tc.fst"
let env = (let _124_601 = (let _124_600 = (FStar_Tc_Env.clear_expected_typ env)
in (FStar_All.pipe_right _124_600 Prims.fst))
in (FStar_All.pipe_right _124_601 instantiate_both))
in (
# 871 "FStar.Tc.Tc.fst"
let _42_1573 = if (FStar_Tc_Env.debug env FStar_Options.High) then begin
(let _124_603 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _124_602 = (FStar_Absyn_Print.exp_to_string top)
...
(let _124_609 = (let _124_606 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Util.b2t _124_606))
in (let _124_608 = (let _124_607 = (FStar_Tc_Util.return_value env FStar_Absyn_Util.t_bool xexp)
in (FStar_All.pipe_right _124_607 FStar_Tc_Util.lcomp_of_comp))
in (FStar_Tc_Util.ite env _124_609 c2 _124_608)))
end else begin
(let _124_613 = (let _124_610 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Util.b2t _124_610))
in (let _124_612 = (let _124_611 = (FStar_Tc_Util.return_value env FStar_Absyn_Util.t_bool xexp)
in (FStar_All.pipe_right _124_611 FStar_Tc_Util.lcomp_of_comp))
in (FStar_Tc_Util.ite env _124_613 _124_612 c2)))
end
in (
# 888 "FStar.Tc.Tc.fst"
let c = (let _124_616 = (let _124_615 = (FStar_All.pipe_left (fun _124_614 -> Some (_124_614)) (FStar_Tc_Env.Binding_var ((x.FStar_Absyn_Syntax.v, FStar_Absyn_Util.t_bool))))
in (_124_615, c2))
in (FStar_Tc_Util.bind env None c1 _124_616))
in (
# 889 "FStar.Tc.Tc.fst"
let e = (let _124_621 = (let _124_620 = (let _124_619 = (FStar_Absyn_Syntax.varg e1)
in (let _124_618 = (let _124_617 = (FStar_Absyn_Syntax.varg e2)
in (_124_617)::[])
in (_124_619)::_124_618))
in (head, _124_620))
in (FStar_Absyn_Syntax.mk_Exp_app _124_621 (Some (FStar_Absyn_Util.t_bool)) top.FStar_Absyn_Syntax.pos))
in (let _124_623 = (let _124_622 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard g_head _124_622))
in (e, c, _124_623)))))))
end))
end))
end
...
(let _124_625 = (FStar_Range.string_of_range head.FStar_Absyn_Syntax.pos)
in (let _124_624 = (FStar_Absyn_Print.typ_to_string thead)
...
in (
# 898 "FStar.Tc.Tc.fst"
let rec check_function_app = (fun norm tf -> (match ((let _124_630 = (FStar_Absyn_Util.unrefine tf)
in _124_630.FStar_Absyn_Syntax.n)) with
| (FStar_Absyn_Syntax.Typ_uvar (_)) | (FStar_Absyn_Syntax.Typ_app ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Typ_uvar (_); FStar_Absyn_Syntax.tk = _; FStar_Absyn_Syntax.pos = _; FStar_Absyn_Syntax.fvs = _; FStar_Absyn_Syntax.uvs = _}, _)) -> begin
(
# 901 "FStar.Tc.Tc.fst"
...
(let _124_635 = (FStar_Tc_Rel.conj_guard g_e g_rest)
in (((FStar_Util.Inr (e), imp))::args, (c)::comps, _124_635))
end))
end))
end))
in (
...
(
# 913 "FStar.Tc.Tc.fst"
let bs = (let _124_636 = (FStar_Tc_Util.tks_of_args args)
in (FStar_Absyn_Util.null_binders_of_tks _124_636))
in (
# 914 "FStar.Tc.Tc.fst"
let cres = (let _124_637 = (FStar_Tc_Util.new_tvar env FStar_Absyn_Syntax.ktype)
in (FStar_Absyn_Util.ml_comp _124_637 top.FStar_Absyn_Syntax.pos))
in (
# 915 "FStar.Tc.Tc.fst"
let _42_1673 = (let _124_639 = (let _124_638 = (FStar_Absyn_Syntax.mk_Typ_fun (bs, cres) (Some (FStar_Absyn_Syntax.ktype)) tf.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Rel.teq env tf _124_638))
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env) _124_639))
in (
# 916 "FStar.Tc.Tc.fst"
let comp = (let _124_642 = (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp cres)
in (FStar_List.fold_right (fun c out -> (FStar_Tc_Util.bind env None c (None, out))) ((chead)::comps) _124_642))
in (let _124_644 = (FStar_Absyn_Syntax.mk_Exp_app (head, args) (Some (comp.FStar_Absyn_Syntax.res_typ)) top.FStar_Absyn_Syntax.pos)
in (let _124_643 = (FStar_Tc_Rel.conj_guard g_head g_args)
in (_124_644, comp, _124_643)))))))
end)))
end
| FStar_Absyn_Syntax.Typ_fun (bs, c) -> begin
(
...
in (
# 935 "FStar.Tc.Tc.fst"
let _42_1716 = (let _124_680 = (let _124_679 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _124_679))
in (FStar_Tc_Rel.new_tvar _124_680 vars k))
in (match (_42_1716) with
| (targ, u) -> begin
(
# 936 "FStar.Tc.Tc.fst"
let _42_1717 = if (FStar_Tc_Env.debug env FStar_Options.Extreme) then begin
(let _124_682 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (let _124_681 = (FStar_Absyn_Print.typ_to_string targ)
in (FStar_Util.print2 "Instantiating %s to %s" _124_682 _124_681)))
end else begin
()
end
in (
...
in (
# 938 "FStar.Tc.Tc.fst"
let arg = (let _124_683 = (FStar_Absyn_Syntax.as_implicit true)
in (FStar_Util.Inl (targ), _124_683))
in (let _124_692 = (let _124_691 = (let _124_690 = (let _124_689 = (let _124_688 = (FStar_Tc_Util.as_uvar_t u)
in (_124_688, u.FStar_Absyn_Syntax.pos))
in FStar_Util.Inl (_124_689))
in (add_implicit _124_690 g))
in (subst, (arg)::outargs, (arg)::arg_rets, comps, _124_691, fvs))
in (tc_args _124_692 rest cres args)))))
end))))
end
...
in (
# 946 "FStar.Tc.Tc.fst"
let arg = (let _124_693 = (FStar_Absyn_Syntax.as_implicit true)
in (FStar_Util.Inr (varg), _124_693))
...
(let _124_699 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (let _124_698 = (FStar_Absyn_Print.typ_to_string t)
...
(
# 954 "FStar.Tc.Tc.fst"
let f = (let _124_700 = (FStar_Tc_Rel.guard_form g')
in (FStar_Tc_Util.label_guard FStar_Tc_Errors.ill_kinded_type t.FStar_Absyn_Syntax.pos _124_700))
in (
# 955 "FStar.Tc.Tc.fst"
let g' = (
# 955 "FStar.Tc.Tc.fst"
...
in (
# 957 "FStar.Tc.Tc.fst"
let subst = (let _124_701 = (FStar_List.hd bs)
in (maybe_extend_subst subst _124_701 arg))
in (let _124_707 = (let _124_706 = (FStar_Tc_Rel.conj_guard g g')
in (subst, (arg)::outargs, (arg)::arg_rets, comps, _124_706, fvs))
in (tc_args _124_707 rest cres rest'))))))
end)))))
end
...
(let _124_709 = (FStar_Absyn_Print.subst_to_string subst)
in (let _124_708 = (FStar_Absyn_Print.typ_to_string x.FStar_Absyn_Syntax.sort)
...
(let _124_710 = (FStar_Absyn_Print.typ_to_string targ)
...
(let _124_712 = (FStar_Absyn_Print.exp_to_string e)
in (let _124_711 = (FStar_Absyn_Print.typ_to_string targ)
...
(let _124_715 = (FStar_Absyn_Print.tag_of_exp e)
in (let _124_714 = (FStar_Absyn_Print.exp_to_string e)
in (let _124_713 = (FStar_Absyn_Print.typ_to_string targ)
in (FStar_Util.print3 "Checking arg (%s) %s at type %s\n" _124_715 _124_714 _124_713))))
end else begin
()
end
in (
...
(let _124_717 = (FStar_Tc_Rel.guard_to_string env g_e)
in (let _124_716 = (FStar_Tc_Rel.guard_to_string env g)
...
(
# 974 "FStar.Tc.Tc.fst"
let subst = (let _124_718 = (FStar_List.hd bs)
in (maybe_extend_subst subst _124_718 arg))
in (tc_args (subst, (arg)::outargs, (arg)::arg_rets, comps, g, fvs) rest cres rest'))
end else begin
if (FStar_Tc_Util.is_pure_or_ghost_effect env c.FStar_Absyn_Syntax.eff_name) then begin
(
# 977 "FStar.Tc.Tc.fst"
let subst = (let _124_723 = (FStar_List.hd bs)
in (maybe_extend_subst subst _124_723 arg))
in (
# 978 "FStar.Tc.Tc.fst"
...
if (let _124_728 = (FStar_List.hd bs)
in (FStar_Absyn_Syntax.is_null_binder _124_728)) then begin
(
# 982 "FStar.Tc.Tc.fst"
let newx = (FStar_Absyn_Util.gen_bvar_p e.FStar_Absyn_Syntax.pos c.FStar_Absyn_Syntax.res_typ)
in (
# 983 "FStar.Tc.Tc.fst"
let arg' = (let _124_729 = (FStar_Absyn_Util.bvar_to_exp newx)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _124_729))
in (
# 984 "FStar.Tc.Tc.fst"
...
(let _124_742 = (let _124_741 = (let _124_735 = (let _124_734 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _124_734))
in (_124_735)::arg_rets)
in (let _124_740 = (let _124_738 = (let _124_737 = (FStar_All.pipe_left (fun _124_736 -> Some (_124_736)) (FStar_Tc_Env.Binding_var ((x.FStar_Absyn_Syntax.v, targ))))
in (_124_737, c))
in (_124_738)::comps)
in (let _124_739 = (FStar_Util.set_add x fvs)
in (subst, (arg)::outargs, _124_741, _124_740, g, _124_739))))
in (tc_args _124_742 rest cres rest'))
end
end
end)))
end))))))))))
...
(let _124_746 = (let _124_745 = (let _124_744 = (let _124_743 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _124_743))
in ("Expected an expression; got a type", _124_744))
in FStar_Absyn_Syntax.Error (_124_745))
in (Prims.raise _124_746))
end
| ((FStar_Util.Inl (_42_1841), _42_1844)::_42_1839, (FStar_Util.Inr (_42_1850), _42_1853)::_42_1848) -> begin
(let _124_750 = (let _124_749 = (let _124_748 = (let _124_747 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _124_747))
in ("Expected a type; got an expression", _124_748))
in FStar_Absyn_Syntax.Error (_124_749))
in (Prims.raise _124_750))
end
| (_42_1858, []) -> begin
(
# 995 "FStar.Tc.Tc.fst"
...
(let _124_752 = (FStar_Absyn_Syntax.mk_Exp_app_flat (head, (FStar_List.rev arg_rets)) (Some (cres.FStar_Absyn_Syntax.res_typ)) top.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Util.maybe_assume_result_eq_pure_term env _124_752 cres))
end else begin
(
# 1015 "FStar.Tc.Tc.fst"
let _42_1871 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _124_755 = (FStar_Absyn_Print.exp_to_string head)
in (let _124_754 = (FStar_Absyn_Print.lcomp_typ_to_string cres)
in (let _124_753 = (FStar_Tc_Rel.guard_to_string env g)
in (FStar_Util.print3 "Not refining result: f=%s; cres=%s; guard=%s\n" _124_755 _124_754 _124_753))))
end else begin
()
end
in cres)
end
in (let _124_756 = (FStar_Tc_Util.refresh_comp_label env false cres)
in (_124_756, g))))))
end
| _42_1875 -> begin
(
# 1023 "FStar.Tc.Tc.fst"
let g = (let _124_757 = (FStar_Tc_Rel.conj_guard g_head g)
in (FStar_All.pipe_right _124_757 (FStar_Tc_Rel.solve_deferred_constraints env)))
in (let _124_763 = (let _124_762 = (let _124_761 = (let _124_760 = (let _124_759 = (let _124_758 = (cres.FStar_Absyn_Syntax.comp ())
in (bs, _124_758))
in (FStar_Absyn_Syntax.mk_Typ_fun _124_759 (Some (FStar_Absyn_Syntax.ktype)) top.FStar_Absyn_Syntax.pos))
in (FStar_All.pipe_left (FStar_Absyn_Util.subst_typ subst) _124_760))
in (FStar_Absyn_Syntax.mk_Total _124_761))
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _124_762))
in (_124_763, g)))
end)
...
(let _124_764 = (FStar_Absyn_Print.lcomp_typ_to_string cres)
...
(let _124_770 = (FStar_Tc_Normalize.exp_norm_to_string env app)
in (let _124_769 = (let _124_768 = (comp.FStar_Absyn_Syntax.comp ())
in (FStar_Absyn_Print.comp_typ_to_string _124_768))
...
let tres = (let _124_775 = (FStar_Absyn_Util.compress_typ tres)
in (FStar_All.pipe_right _124_775 FStar_Absyn_Util.unrefine))
...
(let _124_776 = (FStar_Range.string_of_range tres.FStar_Absyn_Syntax.pos)
in (FStar_Util.print1 "%s: Warning: Potentially redundant explicit currying of a function type \n" _124_776))
end else begin
()
end
in (let _124_781 = (FStar_Tc_Util.lcomp_of_comp cres')
in (tc_args (subst, outargs, arg_rets, ((None, cres))::comps, g, fvs) bs _124_781 args)))
end
| _42_1909 when (not (norm)) -> begin
(let _124_782 = (whnf env tres)
in (aux true _124_782))
end
| _42_1911 -> begin
(let _124_788 = (let _124_787 = (let _124_786 = (let _124_784 = (FStar_Tc_Normalize.typ_norm_to_string env tf)
in (let _124_783 = (FStar_Absyn_Print.exp_to_string top)
in (FStar_Util.format2 "Too many arguments to function of type %s; got %s" _124_784 _124_783)))
in (let _124_785 = (FStar_Absyn_Syntax.argpos arg)
in (_124_786, _124_785)))
in FStar_Absyn_Syntax.Error (_124_787))
in (Prims.raise _124_788))
end)))
in (aux false cres.FStar_Absyn_Syntax.res_typ))
end)
end))
in (let _124_789 = (FStar_Tc_Util.lcomp_of_comp c)
in (tc_args ([], [], [], [], FStar_Tc_Rel.trivial_guard, FStar_Absyn_Syntax.no_fvs.FStar_Absyn_Syntax.fxvs) bs _124_789 args))))
end
| _42_1913 -> begin
if (not (norm)) then begin
(let _124_790 = (whnf env tf)
in (check_function_app true _124_790))
end else begin
(let _124_793 = (let _124_792 = (let _124_791 = (FStar_Tc_Errors.expected_function_typ env tf)
in (_124_791, head.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_124_792))
in (Prims.raise _124_793))
end
end))
in (let _124_794 = (FStar_Absyn_Util.unrefine thead)
in (check_function_app false _124_794)))))
end))
end))
in (
...
(let _124_795 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length g.FStar_Tc_Rel.implicits))
...
(let _124_800 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _124_799 = (FStar_Absyn_Print.typ_to_string c.FStar_Absyn_Syntax.res_typ)
in (let _124_798 = (let _124_797 = (FStar_Tc_Env.expected_typ env0)
in (FStar_All.pipe_right _124_797 (fun x -> (match (x) with
| None -> begin
"None"
end
| Some (t) -> begin
...
| (e, c, g') -> begin
(let _124_801 = (FStar_Tc_Rel.conj_guard g g')
in (e, c, _124_801))
end)))))
end)))
end)))))
...
in (let _124_802 = (FStar_Tc_Env.set_expected_typ env res_t)
in (_124_802, res_t)))
end)
...
let guard_x = (let _124_804 = (FStar_All.pipe_left (fun _124_803 -> Some (_124_803)) e1.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.new_bvd _124_804))
in (
...
(let _124_807 = (FStar_Tc_Rel.conj_guard g gaccum)
in (((f, c))::caccum, _124_807))
end)) t_eqns ([], FStar_Tc_Rel.trivial_guard))
in (match (_42_1963) with
| (cases, g) -> begin
(let _124_808 = (FStar_Tc_Util.bind_cases env res_t cases)
in (_124_808, g))
end))
...
(let _124_812 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _124_811 = (FStar_Absyn_Print.lcomp_typ_to_string c1)
in (let _124_810 = (FStar_Absyn_Print.lcomp_typ_to_string c_branches)
in (let _124_809 = (FStar_Tc_Rel.guard_to_string env g_branches)
in (FStar_Util.print4 "(%s) comp\n\tscrutinee: %s\n\tbranches: %s\nguard = %s\n" _124_812 _124_811 _124_810 _124_809)))))
end else begin
()
end
in (
# 1088 "FStar.Tc.Tc.fst"
let cres = (let _124_815 = (let _124_814 = (FStar_All.pipe_left (fun _124_813 -> Some (_124_813)) (FStar_Tc_Env.Binding_var ((guard_x, c1.FStar_Absyn_Syntax.res_typ))))
in (_124_814, c_branches))
in (FStar_Tc_Util.bind env (Some (e1)) c1 _124_815))
in (
# 1090 "FStar.Tc.Tc.fst"
let e = (let _124_822 = (w cres)
in (let _124_821 = (let _124_820 = (let _124_819 = (FStar_List.map (fun _42_1977 -> (match (_42_1977) with
| (f, _42_1972, _42_1974, _42_1976) -> begin
f
end)) t_eqns)
in (e1, _124_819))
in (FStar_Absyn_Syntax.mk_Exp_match _124_820))
in (FStar_All.pipe_left _124_822 _124_821)))
in (let _124_824 = (FStar_Absyn_Syntax.mk_Exp_ascribed (e, cres.FStar_Absyn_Syntax.res_typ, Some (cres.FStar_Absyn_Syntax.eff_name)) None e.FStar_Absyn_Syntax.pos)
in (let _124_823 = (FStar_Tc_Rel.conj_guard g1 g_branches)
in (_124_824, cres, _124_823))))))
end))))
end))
end)))
end))
...
(let _124_825 = (FStar_Tc_Env.set_expected_typ env1 t)
in (FStar_Tc_Rel.trivial_guard, _124_825))
end else begin
(
...
(let _124_827 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _124_826 = (FStar_Absyn_Print.typ_to_string t)
...
let _42_2026 = (let _124_831 = (FStar_Tc_Env.set_range env t.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Util.strengthen_precondition (Some ((fun _42_2023 -> (match (()) with
| () -> begin
FStar_Tc_Errors.ill_kinded_type
end)))) _124_831 e1 c1 f))
...
let _42_2032 = (let _124_832 = (FStar_Tc_Rel.conj_guard g1 guard_f)
in (FStar_Tc_Util.check_top_level env _124_832 c1))
...
(let _124_833 = (FStar_Tc_Env.get_range env)
in (FStar_Tc_Errors.warn _124_833 FStar_Tc_Errors.top_level_effect))
end else begin
()
end
in (let _124_834 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared ((e2, FStar_Absyn_Syntax.Masked_effect))))
in (_124_834, c1)))
end
end))
end else begin
...
in (let _124_835 = (c1.FStar_Absyn_Syntax.comp ())
in (e2, _124_835)))))
end
...
(let _124_836 = (FStar_Tc_Util.generalize false env1 (((x, e1, c1))::[]))
in (FStar_All.pipe_left FStar_List.hd _124_836))
end else begin
(x, e1, c1)
end
...
let cres = (let _124_837 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit top.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _124_837))
in (
# 1132 "FStar.Tc.Tc.fst"
let cres = if (FStar_Absyn_Util.is_total_comp c1) then begin
cres
end else begin
(let _124_838 = (FStar_Tc_Util.lcomp_of_comp c1)
in (FStar_Tc_Util.bind env None _124_838 (None, cres)))
end
in (
# 1135 "FStar.Tc.Tc.fst"
let _42_2050 = (FStar_ST.op_Colon_Equals e2.FStar_Absyn_Syntax.tk (Some (FStar_Tc_Recheck.t_unit)))
in (let _124_847 = (let _124_846 = (w cres)
in (let _124_845 = (let _124_844 = (let _124_843 = (let _124_842 = (let _124_841 = (FStar_Absyn_Syntax.mk_lb (x, (FStar_Absyn_Util.comp_effect_name c1), (FStar_Absyn_Util.comp_result c1), e1))
in (_124_841)::[])
in (false, _124_842))
in (_124_843, e2))
in (FStar_Absyn_Syntax.mk_Exp_let _124_844))
in (FStar_All.pipe_left _124_846 _124_845)))
in (_124_847, cres, FStar_Tc_Rel.trivial_guard)))))
end))
end))
end
| FStar_Util.Inl (bvd) -> begin
...
let _42_2058 = (let _124_848 = (FStar_Tc_Env.push_local_binding env b)
in (tc_exp _124_848 e2))
...
let e = (let _124_856 = (w cres)
in (let _124_855 = (let _124_854 = (let _124_853 = (let _124_852 = (let _124_851 = (FStar_Absyn_Syntax.mk_lb (x, c1.FStar_Absyn_Syntax.eff_name, c1.FStar_Absyn_Syntax.res_typ, e1))
in (_124_851)::[])
in (false, _124_852))
in (_124_853, e2))
in (FStar_Absyn_Syntax.mk_Exp_let _124_854))
in (FStar_All.pipe_left _124_856 _124_855)))
in (
# 1143 "FStar.Tc.Tc.fst"
let g2 = (let _124_865 = (let _124_858 = (let _124_857 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s bvd c1.FStar_Absyn_Syntax.res_typ))
in (_124_857)::[])
in (FStar_Tc_Rel.close_guard _124_858))
in (let _124_864 = (let _124_863 = (let _124_862 = (let _124_861 = (let _124_860 = (FStar_Absyn_Util.bvd_to_exp bvd c1.FStar_Absyn_Syntax.res_typ)
in (FStar_Absyn_Util.mk_eq c1.FStar_Absyn_Syntax.res_typ c1.FStar_Absyn_Syntax.res_typ _124_860 e1))
in (FStar_All.pipe_left (fun _124_859 -> FStar_Tc_Rel.NonTrivial (_124_859)) _124_861))
in (FStar_Tc_Rel.guard_of_guard_formula _124_862))
in (FStar_Tc_Rel.imp_guard _124_863 g2))
in (FStar_All.pipe_left _124_865 _124_864)))
in (
# 1145 "FStar.Tc.Tc.fst"
let guard = (let _124_866 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard guard_f _124_866))
in (match (topt) with
| None -> begin
(
...
let _42_2067 = (let _124_867 = (FStar_Tc_Rel.teq env tres t)
in (FStar_All.pipe_left (FStar_Tc_Rel.try_discharge_guard env) _124_867))
in (e, cres, guard)))
end else begin
(e, cres, guard)
end))
...
(let _124_871 = (tc_typ_check_trivial (
...
in (FStar_All.pipe_right _124_871 (norm_t env)))
end
in (
...
let _42_2141 = (let _124_877 = (let _124_876 = (FStar_All.pipe_right lbs FStar_List.rev)
in (FStar_All.pipe_right _124_876 (FStar_List.map (fun _42_2130 -> (match (_42_2130) with
| (x, t, e) -> begin
(
...
(let _124_875 = (FStar_Absyn_Print.lbname_to_string x)
in (let _124_874 = (FStar_Absyn_Print.exp_to_string e)
in (let _124_873 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.print3 "Checking %s = %s against type %s\n" _124_875 _124_874 _124_873))))
end else begin
()
end
in (
...
in (FStar_All.pipe_right _124_877 FStar_List.unzip))
...
(let _124_879 = (FStar_List.map (fun _42_2146 -> (match (_42_2146) with
| (x, t, e) -> begin
...
let ecs = (let _124_882 = (FStar_All.pipe_right lbs (FStar_List.map (fun _42_2152 -> (match (_42_2152) with
| (x, t, e) -> begin
(let _124_881 = (FStar_All.pipe_left (FStar_Absyn_Util.total_comp t) (FStar_Absyn_Util.range_of_lb (x, t, e)))
in (x, e, _124_881))
end))))
in (FStar_Tc_Util.generalize true env _124_882))
in (let _124_884 = (FStar_List.map (fun _42_2157 -> (match (_42_2157) with
| (x, e, c) -> begin
(FStar_Absyn_Syntax.mk_lb (x, FStar_Absyn_Const.effect_Tot_lid, (FStar_Absyn_Util.comp_result c), e))
end)) ecs)
in (_124_884, FStar_Tc_Rel.trivial_guard))))
end
...
let cres = (let _124_885 = (FStar_Absyn_Util.total_comp FStar_Tc_Recheck.t_unit top.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _124_885))
in (
...
in (let _124_889 = (let _124_888 = (w cres)
in (FStar_All.pipe_left _124_888 (FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))))
in (_124_889, cres, FStar_Tc_Rel.trivial_guard)))))
end else begin
(
...
let e = (let _124_894 = (w cres)
in (FStar_All.pipe_left _124_894 (FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))))
in (match (topt) with
| Some (_42_2193) -> begin
(e, cres, guard)
end
...
let _42_2228 = (let _124_896 = (FStar_Tc_Rel.teq env tres t')
in (FStar_All.pipe_left (FStar_Tc_Rel.try_discharge_guard env) _124_896))
in (e, cres, guard)))
end
| _42_2231 -> begin
(e, cres, guard)
...
(let _124_909 = (FStar_Absyn_Print.strBvd x)
in (let _124_908 = (FStar_Tc_Normalize.typ_norm_to_string env t)
...
let expected_pat_t = (let _124_910 = (FStar_Tc_Rel.unrefine env pat_t)
in (FStar_Tc_Normalize.norm_typ ((FStar_Tc_Normalize.Beta)::[]) env _124_910))
in (
...
(let _124_913 = (FStar_Absyn_Print.exp_to_string e)
in (let _124_912 = (FStar_Absyn_Print.typ_to_string pat_t)
...
(let _124_915 = (FStar_Tc_Normalize.exp_norm_to_string env e)
in (let _124_914 = (FStar_Tc_Normalize.typ_norm_to_string env lc.FStar_Absyn_Syntax.res_typ)
...
let _42_2276 = (let _124_916 = (FStar_Tc_Rel.solve_deferred_constraints env g)
in (FStar_All.pipe_left Prims.ignore _124_916))
in (
# 1268 "FStar.Tc.Tc.fst"
let e' = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env e)
in (
# 1269 "FStar.Tc.Tc.fst"
let _42_2279 = if (let _124_919 = (let _124_918 = (FStar_Absyn_Util.uvars_in_exp e')
in (let _124_917 = (FStar_Absyn_Util.uvars_in_typ expected_pat_t)
in (FStar_Absyn_Util.uvars_included_in _124_918 _124_917)))
in (FStar_All.pipe_left Prims.op_Negation _124_919)) then begin
(let _124_924 = (let _124_923 = (let _124_922 = (let _124_921 = (FStar_Absyn_Print.exp_to_string e')
in (let _124_920 = (FStar_Absyn_Print.typ_to_string expected_pat_t)
in (FStar_Util.format2 "Implicit pattern variables in %s could not be resolved against expected type %s; please bind them explicitly" _124_921 _124_920)))
in (_124_922, p.FStar_Absyn_Syntax.p))
in FStar_Absyn_Syntax.Error (_124_923))
in (Prims.raise _124_924))
end else begin
()
end
in e))))))
...
| FStar_Tc_Env.Binding_var (x, t) -> begin
(let _124_927 = (FStar_Absyn_Print.strBvd x)
in (let _124_926 = (FStar_Absyn_Print.typ_to_string t)
...
let _42_2304 = (let _124_928 = (FStar_Tc_Env.set_expected_typ pat_env FStar_Tc_Recheck.t_bool)
in (tc_exp _124_928 e))
...
| Some (w) -> begin
(let _124_930 = (FStar_Absyn_Util.mk_eq FStar_Absyn_Util.t_bool FStar_Absyn_Util.t_bool w FStar_Absyn_Const.exp_true_bool)
in (FStar_All.pipe_left (fun _124_929 -> Some (_124_929)) _124_930))
end)
in (
...
let _42_2320 = (let _124_931 = (FStar_Tc_Env.push_local_binding env (FStar_Tc_Env.Binding_var ((scrutinee_x, pat_t))))
in (FStar_All.pipe_right _124_931 FStar_Tc_Env.clear_expected_typ))
...
let clause = (let _124_935 = (FStar_Tc_Recheck.recompute_typ scrutinee)
in (let _124_934 = (FStar_Tc_Recheck.recompute_typ e)
in (FStar_Absyn_Util.mk_eq _124_935 _124_934 scrutinee e)))
in (match (fopt) with
| None -> begin
Some (clause)
end
| Some (f) -> begin
(let _124_937 = (FStar_Absyn_Util.mk_disj clause f)
in (FStar_All.pipe_left (fun _124_936 -> Some (_124_936)) _124_937))
end))
end))) None))
in (
...
| (Some (f), Some (w)) -> begin
(let _124_940 = (let _124_939 = (FStar_Absyn_Util.mk_conj f w)
in (FStar_All.pipe_left (fun _124_938 -> FStar_Tc_Rel.NonTrivial (_124_938)) _124_939))
in (FStar_Tc_Util.weaken_precondition env c _124_940))
end
| (None, Some (w)) -> begin
...
let disc = (let _124_946 = (let _124_945 = (FStar_Absyn_Util.mk_discriminator f.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Util.fvar None _124_945))
in (FStar_All.pipe_left _124_946 (FStar_Ident.range_of_lid f.FStar_Absyn_Syntax.v)))
in (
# 1318 "FStar.Tc.Tc.fst"
let disc = (let _124_949 = (let _124_948 = (let _124_947 = (FStar_All.pipe_left FStar_Absyn_Syntax.varg scrutinee)
in (_124_947)::[])
in (disc, _124_948))
in (FStar_Absyn_Syntax.mk_Exp_app _124_949 None scrutinee.FStar_Absyn_Syntax.pos))
...
(let _124_958 = (let _124_957 = (let _124_956 = (FStar_Absyn_Syntax.varg scrutinee)
in (let _124_955 = (let _124_954 = (FStar_Absyn_Syntax.varg pat_exp)
in (_124_954)::[])
in (_124_956)::_124_955))
in (FStar_Absyn_Util.teq, _124_957))
in (FStar_Absyn_Syntax.mk_Typ_app _124_958 None scrutinee.FStar_Absyn_Syntax.pos))
end
...
let sub_term_guards = (let _124_967 = (FStar_All.pipe_right args (FStar_List.mapi (fun i arg -> (match ((Prims.fst arg)) with
...
in if (let _124_961 = (FStar_Tc_Env.is_projector env projector)
in (FStar_All.pipe_left Prims.op_Negation _124_961)) then begin
[]
end else begin
(
# 1338 "FStar.Tc.Tc.fst"
let sub_term = (let _124_965 = (let _124_964 = (FStar_Absyn_Util.fvar None projector f.FStar_Absyn_Syntax.p)
in (let _124_963 = (let _124_962 = (FStar_Absyn_Syntax.varg scrutinee)
in (_124_962)::[])
in (_124_964, _124_963)))
in (FStar_Absyn_Syntax.mk_Exp_app _124_965 None f.FStar_Absyn_Syntax.p))
in (let _124_966 = (mk_guard sub_term ei)
in (_124_966)::[]))
end)
end))))
in (FStar_All.pipe_right _124_967 FStar_List.flatten))
in (FStar_Absyn_Util.mk_conj_l ((head)::sub_term_guards))))
end
| _42_2428 -> begin
(let _124_970 = (let _124_969 = (FStar_Range.string_of_range pat_exp.FStar_Absyn_Syntax.pos)
in (let _124_968 = (FStar_Absyn_Print.exp_to_string pat_exp)
in (FStar_Util.format2 "tc_eqn: Impossible (%s) %s" _124_969 _124_968)))
in (FStar_All.failwith _124_970))
end)))
in (
...
let path_guard = (let _124_979 = (FStar_All.pipe_right disj_exps (FStar_List.map (fun e -> (let _124_978 = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env e)
in (mk_guard scrutinee pat_t _124_978)))))
in (FStar_All.pipe_right _124_979 FStar_Absyn_Util.mk_disj_l))
in (
...
let guard = (let _124_980 = (FStar_Tc_Rel.conj_guard g_when g_branch)
in (FStar_Tc_Rel.conj_guard g_pat _124_980))
in (
# 1353 "FStar.Tc.Tc.fst"
let _42_2445 = if (FStar_Tc_Env.debug env FStar_Options.High) then begin
(let _124_981 = (FStar_Tc_Rel.guard_to_string env guard)
in (FStar_All.pipe_left (FStar_Util.print1 "Carrying guard from match: %s\n") _124_981))
end else begin
()
end
in (let _124_983 = (let _124_982 = (FStar_Tc_Rel.conj_guard g_when g_branch)
in (FStar_Tc_Rel.conj_guard g_pat _124_982))
in ((pattern, when_clause, branch), path_guard, c, _124_983))))))))))
end)))
end)))
end))
end)))
...
let c = (let _124_993 = (c.FStar_Absyn_Syntax.comp ())
in (FStar_All.pipe_right _124_993 (norm_c env)))
in (match ((let _124_995 = (let _124_994 = (FStar_Tc_Env.get_range env)
in (FStar_Absyn_Util.total_comp (FStar_Absyn_Util.comp_result c) _124_994))
in (FStar_Tc_Rel.sub_comp env c _124_995))) with
| Some (g') -> begin
(let _124_996 = (FStar_Tc_Rel.conj_guard g g')
in (e, (FStar_Absyn_Util.comp_result c), _124_996))
end
| _42_2481 -> begin
(let _124_999 = (let _124_998 = (let _124_997 = (FStar_Tc_Errors.expected_pure_expression e c)
in (_124_997, e.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_124_998))
in (Prims.raise _124_999))
end)))
end
end)))
...
let c = (let _124_1002 = (c.FStar_Absyn_Syntax.comp ())
in (FStar_All.pipe_right _124_1002 (norm_c env)))
in (
...
| Some (g') -> begin
(let _124_1003 = (FStar_Tc_Rel.conj_guard g g')
in (e, (FStar_Absyn_Util.comp_result c), _124_1003))
end
| _42_2496 -> begin
(let _124_1006 = (let _124_1005 = (let _124_1004 = (FStar_Tc_Errors.expected_ghost_expression e c)
in (_124_1004, e.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_124_1005))
in (Prims.raise _124_1006))
end))))
end
end)))
...
| _42_2530 -> begin
(let _124_1019 = (let _124_1018 = (let _124_1017 = (FStar_Tc_Errors.unexpected_signature_for_monad env m s)
in (_124_1017, (FStar_Ident.range_of_lid m)))
in FStar_Absyn_Syntax.Error (_124_1018))
in (Prims.raise _124_1019))
end))
...
let a_kwp_b = (let _124_1032 = (let _124_1031 = (let _124_1030 = (FStar_Absyn_Syntax.null_v_binder a_typ)
in (_124_1030)::[])
in (_124_1031, kwp_b))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1032 a_typ.FStar_Absyn_Syntax.pos))
in (
...
let expected_k = (let _124_1046 = (let _124_1045 = (let _124_1044 = (let _124_1043 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1042 = (let _124_1041 = (FStar_Absyn_Syntax.null_v_binder a_typ)
in (_124_1041)::[])
in (_124_1043)::_124_1042))
in (_124_1044, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1045))
in (FStar_All.pipe_left w _124_1046))
in (let _124_1047 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.ret expected_k)
in (FStar_All.pipe_right _124_1047 (norm_t env))))
in (
# 1423 "FStar.Tc.Tc.fst"
let bind_wp = (
# 1424 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1062 = (let _124_1061 = (let _124_1060 = (let _124_1059 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1058 = (let _124_1057 = (FStar_Absyn_Syntax.t_binder b)
in (let _124_1056 = (let _124_1055 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (let _124_1054 = (let _124_1053 = (FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (let _124_1052 = (let _124_1051 = (FStar_Absyn_Syntax.null_t_binder a_kwp_b)
in (let _124_1050 = (let _124_1049 = (FStar_Absyn_Syntax.null_t_binder a_kwlp_b)
in (_124_1049)::[])
in (_124_1051)::_124_1050))
in (_124_1053)::_124_1052))
in (_124_1055)::_124_1054))
in (_124_1057)::_124_1056))
in (_124_1059)::_124_1058))
in (_124_1060, kwp_b))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1061))
in (FStar_All.pipe_left w _124_1062))
in (let _124_1063 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.bind_wp expected_k)
in (FStar_All.pipe_right _124_1063 (norm_t env))))
in (
# 1429 "FStar.Tc.Tc.fst"
let bind_wlp = (
# 1430 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1074 = (let _124_1073 = (let _124_1072 = (let _124_1071 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1070 = (let _124_1069 = (FStar_Absyn_Syntax.t_binder b)
in (let _124_1068 = (let _124_1067 = (FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (let _124_1066 = (let _124_1065 = (FStar_Absyn_Syntax.null_t_binder a_kwlp_b)
in (_124_1065)::[])
in (_124_1067)::_124_1066))
in (_124_1069)::_124_1068))
in (_124_1071)::_124_1070))
in (_124_1072, kwlp_b))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1073))
in (FStar_All.pipe_left w _124_1074))
in (let _124_1075 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.bind_wlp expected_k)
in (FStar_All.pipe_right _124_1075 (norm_t env))))
in (
# 1435 "FStar.Tc.Tc.fst"
let if_then_else = (
# 1436 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1086 = (let _124_1085 = (let _124_1084 = (let _124_1083 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1082 = (let _124_1081 = (FStar_Absyn_Syntax.t_binder b)
in (let _124_1080 = (let _124_1079 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (let _124_1078 = (let _124_1077 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_124_1077)::[])
in (_124_1079)::_124_1078))
in (_124_1081)::_124_1080))
in (_124_1083)::_124_1082))
in (_124_1084, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1085))
in (FStar_All.pipe_left w _124_1086))
in (let _124_1087 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.if_then_else expected_k)
in (FStar_All.pipe_right _124_1087 (norm_t env))))
in (
# 1441 "FStar.Tc.Tc.fst"
let ite_wp = (
# 1442 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1096 = (let _124_1095 = (let _124_1094 = (let _124_1093 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1092 = (let _124_1091 = (FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (let _124_1090 = (let _124_1089 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_124_1089)::[])
in (_124_1091)::_124_1090))
in (_124_1093)::_124_1092))
in (_124_1094, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1095))
in (FStar_All.pipe_left w _124_1096))
in (let _124_1097 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.ite_wp expected_k)
in (FStar_All.pipe_right _124_1097 (norm_t env))))
in (
# 1447 "FStar.Tc.Tc.fst"
let ite_wlp = (
# 1448 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1104 = (let _124_1103 = (let _124_1102 = (let _124_1101 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1100 = (let _124_1099 = (FStar_Absyn_Syntax.null_t_binder kwlp_a)
in (_124_1099)::[])
in (_124_1101)::_124_1100))
in (_124_1102, kwlp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1103))
in (FStar_All.pipe_left w _124_1104))
in (let _124_1105 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.ite_wlp expected_k)
in (FStar_All.pipe_right _124_1105 (norm_t env))))
in (
# 1452 "FStar.Tc.Tc.fst"
let wp_binop = (
# 1453 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1117 = (let _124_1116 = (let _124_1115 = (let _124_1114 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1113 = (let _124_1112 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (let _124_1111 = (let _124_1110 = (let _124_1107 = (FStar_Absyn_Const.kbin FStar_Absyn_Syntax.ktype FStar_Absyn_Syntax.ktype FStar_Absyn_Syntax.ktype)
in (FStar_Absyn_Syntax.null_t_binder _124_1107))
in (let _124_1109 = (let _124_1108 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_124_1108)::[])
in (_124_1110)::_124_1109))
in (_124_1112)::_124_1111))
in (_124_1114)::_124_1113))
in (_124_1115, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1116))
in (FStar_All.pipe_left w _124_1117))
in (let _124_1118 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.wp_binop expected_k)
in (FStar_All.pipe_right _124_1118 (norm_t env))))
in (
# 1459 "FStar.Tc.Tc.fst"
let wp_as_type = (
# 1460 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1125 = (let _124_1124 = (let _124_1123 = (let _124_1122 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1121 = (let _124_1120 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_124_1120)::[])
in (_124_1122)::_124_1121))
in (_124_1123, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1124))
in (FStar_All.pipe_left w _124_1125))
in (let _124_1126 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.wp_as_type expected_k)
in (FStar_All.pipe_right _124_1126 (norm_t env))))
in (
# 1464 "FStar.Tc.Tc.fst"
let close_wp = (
# 1465 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1135 = (let _124_1134 = (let _124_1133 = (let _124_1132 = (FStar_Absyn_Syntax.t_binder b)
in (let _124_1131 = (let _124_1130 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1129 = (let _124_1128 = (FStar_Absyn_Syntax.null_t_binder a_kwp_b)
in (_124_1128)::[])
in (_124_1130)::_124_1129))
in (_124_1132)::_124_1131))
in (_124_1133, kwp_b))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1134))
in (FStar_All.pipe_left w _124_1135))
in (let _124_1136 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.close_wp expected_k)
in (FStar_All.pipe_right _124_1136 (norm_t env))))
in (
# 1469 "FStar.Tc.Tc.fst"
let close_wp_t = (
# 1470 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1149 = (let _124_1148 = (let _124_1147 = (let _124_1146 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1145 = (let _124_1144 = (let _124_1143 = (let _124_1142 = (let _124_1141 = (let _124_1140 = (let _124_1139 = (FStar_Absyn_Syntax.null_t_binder FStar_Absyn_Syntax.ktype)
in (_124_1139)::[])
in (_124_1140, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1141))
in (FStar_All.pipe_left w _124_1142))
in (FStar_Absyn_Syntax.null_t_binder _124_1143))
in (_124_1144)::[])
in (_124_1146)::_124_1145))
in (_124_1147, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1148))
in (FStar_All.pipe_left w _124_1149))
in (let _124_1150 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.close_wp_t expected_k)
in (FStar_All.pipe_right _124_1150 (norm_t env))))
in (
# 1474 "FStar.Tc.Tc.fst"
let _42_2576 = (
# 1475 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1159 = (let _124_1158 = (let _124_1157 = (let _124_1156 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1155 = (let _124_1154 = (FStar_Absyn_Syntax.null_t_binder FStar_Absyn_Syntax.ktype)
in (let _124_1153 = (let _124_1152 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_124_1152)::[])
in (_124_1154)::_124_1153))
in (_124_1156)::_124_1155))
in (_124_1157, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1158))
in (FStar_All.pipe_left w _124_1159))
in (let _124_1163 = (let _124_1160 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.assert_p expected_k)
in (FStar_All.pipe_right _124_1160 (norm_t env)))
in (let _124_1162 = (let _124_1161 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.assume_p expected_k)
in (FStar_All.pipe_right _124_1161 (norm_t env)))
in (_124_1163, _124_1162))))
...
let expected_k = (let _124_1168 = (let _124_1167 = (let _124_1166 = (let _124_1165 = (FStar_Absyn_Syntax.t_binder a)
in (_124_1165)::[])
in (_124_1166, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1167))
in (FStar_All.pipe_left w _124_1168))
in (let _124_1169 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.null_wp expected_k)
in (FStar_All.pipe_right _124_1169 (norm_t env))))
in (
# 1482 "FStar.Tc.Tc.fst"
let trivial_wp = (
# 1483 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1176 = (let _124_1175 = (let _124_1174 = (let _124_1173 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1172 = (let _124_1171 = (FStar_Absyn_Syntax.null_t_binder kwp_a)
in (_124_1171)::[])
in (_124_1173)::_124_1172))
in (_124_1174, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1175))
in (FStar_All.pipe_left w _124_1176))
in (let _124_1177 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.trivial expected_k)
in (FStar_All.pipe_right _124_1177 (norm_t env))))
...
(
# 1516 "FStar.Tc.Tc.fst"
let _42_2595 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.refresh ())
in (
# 1517 "FStar.Tc.Tc.fst"
let _42_2597 = (let _124_1181 = (FStar_Options.reset_options ())
in (FStar_All.pipe_right _124_1181 Prims.ignore))
in (se, env)))
end)
end
...
let _42_2612 = (let _124_1182 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.source)
in (a_kwp_a env sub.FStar_Absyn_Syntax.source _124_1182))
in (match (_42_2612) with
| (a, kwp_a_src) -> begin
(
# 1529 "FStar.Tc.Tc.fst"
let _42_2615 = (let _124_1183 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.target)
in (a_kwp_a env sub.FStar_Absyn_Syntax.target _124_1183))
in (match (_42_2615) with
| (b, kwp_b_tgt) -> begin
(
# 1530 "FStar.Tc.Tc.fst"
let kwp_a_tgt = (let _124_1187 = (let _124_1186 = (let _124_1185 = (let _124_1184 = (FStar_Absyn_Util.btvar_to_typ a)
in (b.FStar_Absyn_Syntax.v, _124_1184))
in FStar_Util.Inl (_124_1185))
in (_124_1186)::[])
in (FStar_Absyn_Util.subst_kind _124_1187 kwp_b_tgt))
in (
# 1531 "FStar.Tc.Tc.fst"
let expected_k = (let _124_1193 = (let _124_1192 = (let _124_1191 = (let _124_1190 = (FStar_Absyn_Syntax.t_binder a)
in (let _124_1189 = (let _124_1188 = (FStar_Absyn_Syntax.null_t_binder kwp_a_src)
in (_124_1188)::[])
in (_124_1190)::_124_1189))
in (_124_1191, kwp_a_tgt))
in (FStar_Absyn_Syntax.mk_Kind_arrow _124_1192))
in (FStar_All.pipe_right r _124_1193))
in (
...
# 1533 "FStar.Tc.Tc.fst"
let _42_2619 = sub
in {FStar_Absyn_Syntax.source = _42_2619.FStar_Absyn_Syntax.source; FStar_Absyn_Syntax.target = _42_2619.FStar_Absyn_Syntax.target; FStar_Absyn_Syntax.lift = lift})
in (
...
let _42_2636 = (tc_tparams env tps)
in (match (_42_2636) with
| (tps, env) -> begin
(
...
let _42_2641 = if (FStar_Tc_Env.debug env FStar_Options.Extreme) then begin
(let _124_1196 = (FStar_Absyn_Print.sli lid)
in (let _124_1195 = (let _124_1194 = (FStar_Absyn_Util.close_kind tps k)
in (FStar_Absyn_Print.kind_to_string _124_1194))
...
let _42_2659 = (match ((FStar_Absyn_Util.compress_kind k)) with
| {FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Kind_uvar (_42_2654); FStar_Absyn_Syntax.tk = _42_2652; FStar_Absyn_Syntax.pos = _42_2650; FStar_Absyn_Syntax.fvs = _42_2648; FStar_Absyn_Syntax.uvs = _42_2646} -> begin
(let _124_1197 = (FStar_Tc_Rel.keq env None k FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env) _124_1197))
end
| _42_2658 -> begin
()
end)
...
let env0 = env
in (
# 1555 "FStar.Tc.Tc.fst"
let env = (FStar_Tc_Env.set_range env r)
in (
# 1556 "FStar.Tc.Tc.fst"
let _42_2672 = (tc_tparams env tps)
in (match (_42_2672) with
| (tps, env) -> begin
(
# 1557 "FStar.Tc.Tc.fst"
...
let _42_2687 = (tc_tparams env tps)
in (match (_42_2687) with
| (tps, env) -> begin
(
# 1566 "FStar.Tc.Tc.fst"
let _42_2690 = (tc_comp env c)
in (match (_42_2690) with
| (c, g) -> begin
(
...
in (let _124_1200 = (FStar_All.pipe_right c'.FStar_Absyn_Syntax.effect_name (fun _124_1199 -> Some (_124_1199)))
in FStar_Absyn_Syntax.DefaultEffect (_124_1200)))
end
| t -> begin
t
end))))
...
let _42_2710 = (tc_tparams env tps)
in (match (_42_2710) with
| (tps, env') -> begin
(
# 1579 "FStar.Tc.Tc.fst"
let _42_2716 = (let _124_1204 = (tc_typ_trivial env' t)
in (FStar_All.pipe_right _124_1204 (fun _42_2713 -> (match (_42_2713) with
| (t, k) -> begin
(let _124_1203 = (norm_t env' t)
in (let _124_1202 = (norm_k env' k)
in (_124_1203, _124_1202)))
end))))
in (match (_42_2716) with
| (t, k1) -> begin
(
# 1580 "FStar.Tc.Tc.fst"
...
let k2 = (let _124_1205 = (tc_kind_trivial env' k)
in (FStar_All.pipe_right _124_1205 (norm_k env)))
in (
# 1583 "FStar.Tc.Tc.fst"
let _42_2721 = (let _124_1206 = (FStar_Tc_Rel.keq env' (Some (t)) k1 k2)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env') _124_1206))
in k2))
end)
in (
...
let _42_2741 = (tc_binders env tps)
in (match (_42_2741) with
| (tps, env, g) -> begin
(
# 1591 "FStar.Tc.Tc.fst"
let tycon = (tname, tps, k)
in (
# 1592 "FStar.Tc.Tc.fst"
let _42_2743 = (FStar_Tc_Util.discharge_guard env g)
in (
...
let _42_2755 = (match ((FStar_Absyn_Util.function_formals t)) with
...
in (match (_42_2755) with
| (formals, result_t) -> begin
(
# 1600 "FStar.Tc.Tc.fst"
let cardinality_and_positivity_check = (fun formal -> (
# 1601 "FStar.Tc.Tc.fst"
let check_positivity = (fun formals -> (FStar_All.pipe_right formals (FStar_List.iter (fun _42_2763 -> (match (_42_2763) with
| (a, _42_2762) -> begin
(match (a) with
| FStar_Util.Inl (_42_2765) -> begin
()
end
...
in (FStar_Absyn_Visit.collect_from_typ (fun b t -> (match ((let _124_1214 = (FStar_Absyn_Util.compress_typ t)
in _124_1214.FStar_Absyn_Syntax.n)) with
...
| Some (tname) -> begin
(let _124_1218 = (let _124_1217 = (let _124_1216 = (let _124_1215 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (FStar_Tc_Errors.constructor_fails_the_positivity_check env _124_1215 tname))
in (_124_1216, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_124_1217))
in (Prims.raise _124_1218))
end)
end
| _42_2778 -> begin
()
...
| FStar_Util.Inl (a) -> begin
(
# 1617 "FStar.Tc.Tc.fst"
let _42_2781 = if (FStar_Options.warn_cardinality ()) then begin
(let _124_1219 = (FStar_Tc_Errors.cardinality_constraint_violated lid a)
in (FStar_Tc_Errors.warn r _124_1219))
end else begin
if (FStar_Options.check_cardinality ()) then begin
(let _124_1222 = (let _124_1221 = (let _124_1220 = (FStar_Tc_Errors.cardinality_constraint_violated lid a)
in (_124_1220, r))
in FStar_Absyn_Syntax.Error (_124_1221))
in (Prims.raise _124_1222))
end else begin
()
end
end
...
in (match (k.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_arrow (_42_2785) -> begin
(
# 1626 "FStar.Tc.Tc.fst"
let _42_2790 = (FStar_Absyn_Util.kind_formals k)
in (match (_42_2790) with
| (formals, _42_2789) -> begin
...
(
# 1634 "FStar.Tc.Tc.fst"
let _42_2799 = (let _124_1223 = (FStar_Absyn_Util.function_formals t)
in (FStar_All.pipe_right _124_1223 FStar_Util.must))
in (match (_42_2799) with
| (formals, _42_2798) -> begin
(check_positivity formals)
end))
end else begin
()
...
in (
# 1637 "FStar.Tc.Tc.fst"
let _42_2800 = (FStar_All.pipe_right formals (FStar_List.iter cardinality_and_positivity_check))
in (
# 1639 "FStar.Tc.Tc.fst"
let _42_2854 = (match ((FStar_Absyn_Util.destruct result_t tname)) with
| Some (args) -> begin
if (not ((((FStar_List.length args) >= (FStar_List.length tps)) && (let _124_1227 = (let _124_1226 = (FStar_Util.first_N (FStar_List.length tps) args)
in (FStar_All.pipe_right _124_1226 Prims.fst))
in (FStar_List.forall2 (fun _42_2807 _42_2811 -> (match ((_42_2807, _42_2811)) with
| ((a, _42_2806), (b, _42_2810)) -> begin
(match ((a, b)) with
| (FStar_Util.Inl ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Typ_btvar (aa); FStar_Absyn_Syntax.tk = _42_2819; FStar_Absyn_Syntax.pos = _42_2817; FStar_Absyn_Syntax.fvs = _42_2815; FStar_Absyn_Syntax.uvs = _42_2813}), FStar_Util.Inl (bb)) -> begin
(FStar_Absyn_Util.bvar_eq aa bb)
end
| (FStar_Util.Inr ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Exp_bvar (xx); FStar_Absyn_Syntax.tk = _42_2834; FStar_Absyn_Syntax.pos = _42_2832; FStar_Absyn_Syntax.fvs = _42_2830; FStar_Absyn_Syntax.uvs = _42_2828}), FStar_Util.Inr (yy)) -> begin
(FStar_Absyn_Util.bvar_eq xx yy)
end
| _42_2843 -> begin
false
end)
end)) _124_1227 tps))))) then begin
(
# 1646 "FStar.Tc.Tc.fst"
...
| _42_2846 -> begin
(
# 1649 "FStar.Tc.Tc.fst"
let _42_2850 = (FStar_Absyn_Util.args_of_binders tps)
in (match (_42_2850) with
| (_42_2848, expected_args) -> begin
(let _124_1228 = (FStar_Absyn_Util.ftv tname FStar_Absyn_Syntax.kun)
in (FStar_Absyn_Util.mk_typ_app _124_1228 expected_args))
end))
end)
in (let _124_1232 = (let _124_1231 = (let _124_1230 = (let _124_1229 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (FStar_Tc_Errors.constructor_builds_the_wrong_type env _124_1229 result_t expected_t))
in (_124_1230, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_124_1231))
in (Prims.raise _124_1232)))
end else begin
()
end
end
| _42_2853 -> begin
(let _124_1237 = (let _124_1236 = (let _124_1235 = (let _124_1234 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (let _124_1233 = (FStar_Absyn_Util.ftv tname FStar_Absyn_Syntax.kun)
in (FStar_Tc_Errors.constructor_builds_the_wrong_type env _124_1234 result_t _124_1233)))
in (_124_1235, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_124_1236))
in (Prims.raise _124_1237))
end)
in (
# 1653 "FStar.Tc.Tc.fst"
let se = FStar_Absyn_Syntax.Sig_datacon ((lid, t, tycon, quals, mutuals, r))
in (
# 1654 "FStar.Tc.Tc.fst"
let env = (FStar_Tc_Env.push_sigelt env se)
in (
# 1655 "FStar.Tc.Tc.fst"
let _42_2858 = if (log env) then begin
(let _124_1239 = (let _124_1238 = (FStar_Tc_Normalize.typ_norm_to_string env t)
in (FStar_Util.format2 "data %s : %s\n" lid.FStar_Ident.str _124_1238))
in (FStar_All.pipe_left FStar_Util.print_string _124_1239))
end else begin
()
end
in (se, env)))))))
...
let t = (let _124_1240 = (tc_typ_check_trivial env t FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _124_1240 (FStar_Tc_Normalize.norm_typ ((FStar_Tc_Normalize.Beta)::(FStar_Tc_Normalize.SNComp)::[]) env)))
in (
# 1661 "FStar.Tc.Tc.fst"
let _42_2868 = (FStar_Tc_Util.check_uvars r t)
in (
# 1662 "FStar.Tc.Tc.fst"
...
let _42_2872 = if (log env) then begin
(let _124_1242 = (let _124_1241 = (FStar_Tc_Normalize.typ_norm_to_string env t)
in (FStar_Util.format2 "val %s : %s\n" lid.FStar_Ident.str _124_1241))
in (FStar_All.pipe_left FStar_Util.print_string _124_1242))
end else begin
()
end
in (se, env)))))))
...
let phi = (let _124_1243 = (tc_typ_check_trivial env phi FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _124_1243 (norm_t env)))
in (
# 1670 "FStar.Tc.Tc.fst"
let _42_2882 = (FStar_Tc_Util.check_uvars r phi)
in (
# 1671 "FStar.Tc.Tc.fst"
...
let _42_2935 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.fold_left (fun _42_2895 lb -> (match (_42_2895) with
| (gen, lbs) -> begin
(
# 1679 "FStar.Tc.Tc.fst"
let _42_2932 = (match (lb) with
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inl (_42_2904); FStar_Absyn_Syntax.lbtyp = _42_2902; FStar_Absyn_Syntax.lbeff = _42_2900; FStar_Absyn_Syntax.lbdef = _42_2898} -> begin
(FStar_All.failwith "impossible")
end
| {FStar_Absyn_Syntax.lbname = FStar_Util.Inr (l); FStar_Absyn_Syntax.lbtyp = t; FStar_Absyn_Syntax.lbeff = _42_2909; FStar_Absyn_Syntax.lbdef = e} -> begin
(
# 1682 "FStar.Tc.Tc.fst"
let _42_2929 = (match ((FStar_Tc_Env.try_lookup_val_decl env l)) with
| None -> begin
(gen, lb)
end
| Some (t', _42_2917) -> begin
(
# 1685 "FStar.Tc.Tc.fst"
let _42_2920 = if (FStar_Tc_Env.debug env FStar_Options.Medium) then begin
(let _124_1246 = (FStar_Absyn_Print.typ_to_string t')
in (FStar_Util.print2 "Using annotation %s for let binding %s\n" _124_1246 l.FStar_Ident.str))
end else begin
()
end
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_unknown -> begin
(let _124_1247 = (FStar_Absyn_Syntax.mk_lb (FStar_Util.Inr (l), FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _124_1247))
end
| _42_2924 -> begin
(
# 1691 "FStar.Tc.Tc.fst"
let _42_2925 = if (not (deserialized)) then begin
(let _124_1249 = (let _124_1248 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "%s: Warning: Annotation from val declaration overrides inline type annotation\n" _124_1248))
in (FStar_All.pipe_left FStar_Util.print_string _124_1249))
end else begin
()
end
in (let _124_1250 = (FStar_Absyn_Syntax.mk_lb (FStar_Util.Inr (l), FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _124_1250)))
end))
end)
in (match (_42_2929) with
| (gen, lb) -> begin
(gen, lb)
end))
end)
in (match (_42_2932) with
| (gen, lb) -> begin
(gen, (lb)::lbs)
end))
end)) (true, [])))
in (match (_42_2935) with
| (generalize, lbs') -> begin
(
# 1696 "FStar.Tc.Tc.fst"
let lbs' = (FStar_List.rev lbs')
in (
# 1697 "FStar.Tc.Tc.fst"
let e = (let _124_1255 = (let _124_1254 = (let _124_1253 = (syn' env FStar_Tc_Recheck.t_unit)
in (FStar_All.pipe_left _124_1253 (FStar_Absyn_Syntax.mk_Exp_constant FStar_Const.Const_unit)))
in (((Prims.fst lbs), lbs'), _124_1254))
in (FStar_Absyn_Syntax.mk_Exp_let _124_1255 None r))
in (
# 1698 "FStar.Tc.Tc.fst"
let _42_2970 = (match ((tc_exp (
# 1698 "FStar.Tc.Tc.fst"
let _42_2938 = env
in {FStar_Tc_Env.solver = _42_2938.FStar_Tc_Env.solver; FStar_Tc_Env.range = _42_2938.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _42_2938.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _42_2938.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _42_2938.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _42_2938.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _42_2938.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _42_2938.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _42_2938.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _42_2938.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _42_2938.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _42_2938.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = generalize; FStar_Tc_Env.letrecs = _42_2938.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _42_2938.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _42_2938.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = _42_2938.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = _42_2938.FStar_Tc_Env.is_iface; FStar_Tc_Env.admit = _42_2938.FStar_Tc_Env.admit; FStar_Tc_Env.default_effects = _42_2938.FStar_Tc_Env.default_effects}) e)) with
| ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Exp_let (lbs, e); FStar_Absyn_Syntax.tk = _42_2947; FStar_Absyn_Syntax.pos = _42_2945; FStar_Absyn_Syntax.fvs = _42_2943; FStar_Absyn_Syntax.uvs = _42_2941}, _42_2954, g) when (FStar_Tc_Rel.is_trivial g) -> begin
(
# 1700 "FStar.Tc.Tc.fst"
let quals = (match (e.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (_42_2958, FStar_Absyn_Syntax.Masked_effect)) -> begin
...
in (match (_42_2970) with
| (se, lbs) -> begin
(
# 1705 "FStar.Tc.Tc.fst"
let _42_2976 = if (log env) then begin
(let _124_1261 = (let _124_1260 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (
# 1707 "FStar.Tc.Tc.fst"
let should_log = (match ((let _124_1257 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (FStar_Tc_Env.try_lookup_val_decl env _124_1257))) with
| None -> begin
true
end
| _42_2974 -> begin
...
(let _124_1259 = (FStar_Absyn_Print.lbname_to_string lb.FStar_Absyn_Syntax.lbname)
in (let _124_1258 = (FStar_Tc_Normalize.typ_norm_to_string env lb.FStar_Absyn_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" _124_1259 _124_1258)))
end else begin
""
end))))
in (FStar_All.pipe_right _124_1260 (FStar_String.concat "\n")))
...
let env = (FStar_Tc_Env.set_range env r)
in (
# 1718 "FStar.Tc.Tc.fst"
let env = (FStar_Tc_Env.set_expected_typ env FStar_Tc_Recheck.t_unit)
in (
# 1719 "FStar.Tc.Tc.fst"
let _42_2988 = (tc_exp env e)
in (match (_42_2988) with
| (e, c, g1) -> begin
(
# 1720 "FStar.Tc.Tc.fst"
let g1 = (FStar_Tc_Rel.solve_deferred_constraints env g1)
in (
# 1721 "FStar.Tc.Tc.fst"
let _42_2994 = (let _124_1265 = (let _124_1262 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit r)
in Some (_124_1262))
in (let _124_1264 = (let _124_1263 = (c.FStar_Absyn_Syntax.comp ())
in (e, _124_1263))
in (check_expected_effect env _124_1265 _124_1264)))
in (match (_42_2994) with
| (e, _42_2992, g) -> begin
(
# 1722 "FStar.Tc.Tc.fst"
let _42_2995 = (let _124_1266 = (FStar_Tc_Rel.conj_guard g1 g)
in (FStar_Tc_Util.discharge_guard env _124_1266))
in (
...
let _42_3014 = (FStar_All.pipe_right ses (FStar_List.partition (fun _42_14 -> (match (_42_14) with
| FStar_Absyn_Syntax.Sig_tycon (_42_3008) -> begin
true
end
| _42_3011 -> begin
false
end))))
in (match (_42_3014) with
| (tycons, rest) -> begin
(
# 1730 "FStar.Tc.Tc.fst"
let _42_3023 = (FStar_All.pipe_right rest (FStar_List.partition (fun _42_15 -> (match (_42_15) with
| FStar_Absyn_Syntax.Sig_typ_abbrev (_42_3017) -> begin
true
end
| _42_3020 -> begin
false
end))))
in (match (_42_3023) with
| (abbrevs, rest) -> begin
(
# 1731 "FStar.Tc.Tc.fst"
...
let k = (match (k.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_unknown -> begin
(let _124_1270 = (FStar_Tc_Rel.new_kvar r tps)
in (FStar_All.pipe_right _124_1270 Prims.fst))
end
| _42_3035 -> begin
k
end)
...
in (
# 1738 "FStar.Tc.Tc.fst"
let _42_3042 = (FStar_List.split recs)
in (match (_42_3042) with
| (recs, abbrev_defs) -> begin
(
# 1739 "FStar.Tc.Tc.fst"
let msg = if (FStar_ST.read FStar_Options.logQueries) then begin
(let _124_1271 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (FStar_Util.format1 "Recursive bindings: %s" _124_1271))
end else begin
""
end
in (
# 1742 "FStar.Tc.Tc.fst"
let _42_3044 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.push msg)
in (
# 1743 "FStar.Tc.Tc.fst"
let _42_3049 = (tc_decls env tycons deserialized)
in (match (_42_3049) with
| (tycons, _42_3048) -> begin
(
# 1744 "FStar.Tc.Tc.fst"
let _42_3053 = (tc_decls env recs deserialized)
...
let _42_3058 = (tc_decls env1 rest deserialized)
in (match (_42_3058) with
| (rest, _42_3057) -> begin
(
...
let tt = (let _124_1274 = (FStar_Absyn_Syntax.mk_Typ_ascribed (t, k) t.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.close_with_lam tps _124_1274))
in (
# 1750 "FStar.Tc.Tc.fst"
let _42_3074 = (tc_typ_trivial env1 tt)
in (match (_42_3074) with
| (tt, _42_3073) -> begin
(
# 1751 "FStar.Tc.Tc.fst"
let _42_3083 = (match (tt.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_lam (bs, t) -> begin
(bs, t)
end
| _42_3080 -> begin
...
in (match (_42_3083) with
| (tps, t) -> begin
(let _124_1276 = (let _124_1275 = (FStar_Absyn_Util.compress_kind k)
in (lid, tps, _124_1275, t, [], r))
in FStar_Absyn_Syntax.Sig_typ_abbrev (_124_1276))
end))
end)))
end
| _42_3085 -> begin
(let _124_1278 = (let _124_1277 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "(%s) Impossible" _124_1277))
in (FStar_All.failwith _124_1278))
end)) recs abbrev_defs)
in (
# 1757 "FStar.Tc.Tc.fst"
let _42_3087 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.pop msg)
in (
# 1758 "FStar.Tc.Tc.fst"
let se = FStar_Absyn_Syntax.Sig_bundle (((FStar_List.append (FStar_List.append tycons abbrevs) rest), quals, lids, r))
in (
# 1759 "FStar.Tc.Tc.fst"
let env = (FStar_Tc_Env.push_sigelt env se)
in (se, env)))))
end)))
end))
...
let _42_3102 = (let _124_1288 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (FStar_Util.print2 "Time %ss : %s\n" (FStar_Util.string_of_float diff) _124_1288))
in res))))))
in (
# 1771 "FStar.Tc.Tc.fst"
let _42_3117 = (FStar_All.pipe_right ses (FStar_List.fold_left (fun _42_3106 se -> (match (_42_3106) with
| (ses, env) -> begin
(
# 1773 "FStar.Tc.Tc.fst"
let _42_3108 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _124_1292 = (let _124_1291 = (FStar_Absyn_Print.sigelt_to_string se)
in (FStar_Util.format1 "Checking sigelt\t%s\n" _124_1291))
in (FStar_Util.print_string _124_1292))
end else begin
()
end
in (
# 1775 "FStar.Tc.Tc.fst"
let _42_3112 = if (FStar_ST.read FStar_Options.timing) then begin
(time_tc_decl env se deserialized)
end else begin
(tc_decl env se deserialized)
end
in (match (_42_3112) with
| (se, env) -> begin
(
# 1779 "FStar.Tc.Tc.fst"
let _42_3113 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.encode_sig env se)
in ((se)::ses, env))
end)))
end)) ([], env)))
in (match (_42_3117) with
| (ses, env) -> begin
...
in (match (se) with
| FStar_Absyn_Syntax.Sig_pragma (_42_3138) -> begin
([], hidden)
end
| FStar_Absyn_Syntax.Sig_datacon (_42_3141) -> begin
(FStar_All.failwith "Impossible")
end
...
| FStar_Absyn_Syntax.Sig_bundle (ses, quals, _42_3161, _42_3163) -> begin
if (is_abstract quals) then begin
(FStar_List.fold_right (fun se _42_3169 -> (match (_42_3169) with
| (out, hidden) -> begin
(match (se) with
| FStar_Absyn_Syntax.Sig_tycon (l, bs, t, _42_3174, _42_3176, quals, r) -> begin
(
# 1830 "FStar.Tc.Tc.fst"
let dec = FStar_Absyn_Syntax.Sig_tycon ((l, bs, t, [], [], quals, r))
in ((dec)::out, hidden))
end
| FStar_Absyn_Syntax.Sig_datacon (l, t, _tc, quals, _mutuals, r) -> begin
(
# 1833 "FStar.Tc.Tc.fst"
...
| FStar_Absyn_Syntax.Sig_assume (_42_3194, _42_3196, quals, _42_3199) -> begin
if (is_abstract quals) then begin
([], hidden)
end else begin
((se)::[], hidden)
...
| FStar_Absyn_Syntax.Sig_main (_42_3219) -> begin
([], hidden)
end
| (FStar_Absyn_Syntax.Sig_new_effect (_)) | (FStar_Absyn_Syntax.Sig_sub_effect (_)) | (FStar_Absyn_Syntax.Sig_effect_abbrev (_)) -> begin
((se)::[], hidden)
end
| FStar_Absyn_Syntax.Sig_let ((false, lb::[]), _42_3235, _42_3237, quals) when (FStar_All.pipe_right quals (FStar_Util.for_some is_hidden_proj_or_disc)) -> begin
(
# 1864 "FStar.Tc.Tc.fst"
...
if (is_abstract quals) then begin
(let _124_1310 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let _124_1309 = (let _124_1308 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (_124_1308, lb.FStar_Absyn_Syntax.lbtyp, (FStar_Absyn_Syntax.Assumption)::quals, r))
in FStar_Absyn_Syntax.Sig_val_decl (_124_1309)))))
in (_124_1310, hidden))
end else begin
((se)::[], hidden)
end
...
# 1876 "FStar.Tc.Tc.fst"
let get_exports : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.modul  ->  FStar_Absyn_Syntax.sigelt Prims.list = (fun env modul -> (
# 1877 "FStar.Tc.Tc.fst"
let _42_3262 = (FStar_All.pipe_right modul.FStar_Absyn_Syntax.declarations (FStar_List.fold_left (fun _42_3254 se -> (match (_42_3254) with
| (exports, hidden) -> begin
(
# 1878 "FStar.Tc.Tc.fst"
let _42_3258 = (for_export env hidden se)
in (match (_42_3258) with
| (exports', hidden) -> begin
((exports')::exports, hidden)
end))
end)) ([], [])))
in (match (_42_3262) with
| (exports, _42_3261) -> begin
...
in (
# 1885 "FStar.Tc.Tc.fst"
let env = (
# 1885 "FStar.Tc.Tc.fst"
let _42_3267 = env
in (let _124_1321 = (not ((FStar_Options.should_verify modul.FStar_Absyn_Syntax.name.FStar_Ident.str)))
in {FStar_Tc_Env.solver = _42_3267.FStar_Tc_Env.solver; FStar_Tc_Env.range = _42_3267.FStar_Tc_Env.range; FStar_Tc_Env.curmodule = _42_3267.FStar_Tc_Env.curmodule; FStar_Tc_Env.gamma = _42_3267.FStar_Tc_Env.gamma; FStar_Tc_Env.modules = _42_3267.FStar_Tc_Env.modules; FStar_Tc_Env.expected_typ = _42_3267.FStar_Tc_Env.expected_typ; FStar_Tc_Env.level = _42_3267.FStar_Tc_Env.level; FStar_Tc_Env.sigtab = _42_3267.FStar_Tc_Env.sigtab; FStar_Tc_Env.is_pattern = _42_3267.FStar_Tc_Env.is_pattern; FStar_Tc_Env.instantiate_targs = _42_3267.FStar_Tc_Env.instantiate_targs; FStar_Tc_Env.instantiate_vargs = _42_3267.FStar_Tc_Env.instantiate_vargs; FStar_Tc_Env.effects = _42_3267.FStar_Tc_Env.effects; FStar_Tc_Env.generalize = _42_3267.FStar_Tc_Env.generalize; FStar_Tc_Env.letrecs = _42_3267.FStar_Tc_Env.letrecs; FStar_Tc_Env.top_level = _42_3267.FStar_Tc_Env.top_level; FStar_Tc_Env.check_uvars = _42_3267.FStar_Tc_Env.check_uvars; FStar_Tc_Env.use_eq = _42_3267.FStar_Tc_Env.use_eq; FStar_Tc_Env.is_iface = modul.FStar_Absyn_Syntax.is_interface; FStar_Tc_Env.admit = _124_1321; FStar_Tc_Env.default_effects = _42_3267.FStar_Tc_Env.default_effects}))
in (
# 1886 "FStar.Tc.Tc.fst"
let _42_3270 = if (not ((FStar_Ident.lid_equals modul.FStar_Absyn_Syntax.name FStar_Absyn_Const.prims_lid))) then begin
...
let _42_3275 = (tc_decls env modul.FStar_Absyn_Syntax.declarations modul.FStar_Absyn_Syntax.is_deserialized)
in (match (_42_3275) with
| (ses, env) -> begin
((
# 1889 "FStar.Tc.Tc.fst"
let _42_3276 = modul
in {FStar_Absyn_Syntax.name = _42_3276.FStar_Absyn_Syntax.name; FStar_Absyn_Syntax.declarations = ses; FStar_Absyn_Syntax.exports = _42_3276.FStar_Absyn_Syntax.exports; FStar_Absyn_Syntax.is_interface = _42_3276.FStar_Absyn_Syntax.is_interface; FStar_Absyn_Syntax.is_deserialized = _42_3276.FStar_Absyn_Syntax.is_deserialized}), env)
end))))))))
...
let _42_3283 = (tc_decls env decls false)
in (match (_42_3283) with
| (ses, env) -> begin
(
...
# 1893 "FStar.Tc.Tc.fst"
let _42_3284 = modul
in {FStar_Absyn_Syntax.name = _42_3284.FStar_Absyn_Syntax.name; FStar_Absyn_Syntax.declarations = (FStar_List.append modul.FStar_Absyn_Syntax.declarations ses); FStar_Absyn_Syntax.exports = _42_3284.FStar_Absyn_Syntax.exports; FStar_Absyn_Syntax.is_interface = _42_3284.FStar_Absyn_Syntax.is_interface; FStar_Absyn_Syntax.is_deserialized = _42_3284.FStar_Absyn_Syntax.is_deserialized})
in (modul, env))
end)))
...
# 1898 "FStar.Tc.Tc.fst"
let _42_3290 = modul
in {FStar_Absyn_Syntax.name = _42_3290.FStar_Absyn_Syntax.name; FStar_Absyn_Syntax.declarations = _42_3290.FStar_Absyn_Syntax.declarations; FStar_Absyn_Syntax.exports = exports; FStar_Absyn_Syntax.is_interface = modul.FStar_Absyn_Syntax.is_interface; FStar_Absyn_Syntax.is_deserialized = modul.FStar_Absyn_Syntax.is_deserialized})
in (
# 1899 "FStar.Tc.Tc.fst"
let env = (FStar_Tc_Env.finish_module env modul)
in (
# 1900 "FStar.Tc.Tc.fst"
let _42_3300 = if (not ((FStar_Ident.lid_equals modul.FStar_Absyn_Syntax.name FStar_Absyn_Const.prims_lid))) then begin
(
# 1902 "FStar.Tc.Tc.fst"
let _42_3294 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.pop (Prims.strcat "Ending modul " modul.FStar_Absyn_Syntax.name.FStar_Ident.str))
in (
# 1903 "FStar.Tc.Tc.fst"
let _42_3296 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.encode_modul env modul)
in (
# 1904 "FStar.Tc.Tc.fst"
let _42_3298 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.refresh ())
in (let _124_1332 = (FStar_Options.reset_options ())
in (FStar_All.pipe_right _124_1332 Prims.ignore)))))
end else begin
()
end
in (modul, env))))))
...
let _42_3306 = (tc_partial_modul env modul)
in (match (_42_3306) with
| (modul, env) -> begin
...
let _42_3313 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.encode_sig env elt)
in env)))
in (
# 1919 "FStar.Tc.Tc.fst"
let en = (FStar_Tc_Env.set_current_module en m.FStar_Absyn_Syntax.name)
in (let _124_1345 = (FStar_List.fold_left do_sigelt en m.FStar_Absyn_Syntax.exports)
in (FStar_Tc_Env.finish_module _124_1345 m)))))
...
let _42_3318 = if ((let _124_1350 = (FStar_ST.read FStar_Options.debug)
in (FStar_List.length _124_1350)) <> 0) then begin
(let _124_1351 = (FStar_Absyn_Print.sli m.FStar_Absyn_Syntax.name)
...
let _42_3322 = (tc_modul env m)
in (match (_42_3322) with
| (m, env) -> begin
(
# 1927 "FStar.Tc.Tc.fst"
let _42_3323 = if (FStar_Options.should_dump m.FStar_Absyn_Syntax.name.FStar_Ident.str) then begin
(let _124_1352 = (FStar_Absyn_Print.modul_to_string m)
in (FStar_Util.print1 "%s\n" _124_1352))
end else begin
()
end
