...
let _42_2597 = (let _127_1181 = (FStar_Options.reset_options ())
in (FStar_All.pipe_right _127_1181 Prims.ignore))
in (se, env)))
end)
end
...
let _42_2612 = (let _127_1182 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.source)
in (a_kwp_a env sub.FStar_Absyn_Syntax.source _127_1182))
in (match (_42_2612) with
| (a, kwp_a_src) -> begin
(
# 1529 "FStar.Tc.Tc.fst"
let _42_2615 = (let _127_1183 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.target)
in (a_kwp_a env sub.FStar_Absyn_Syntax.target _127_1183))
in (match (_42_2615) with
| (b, kwp_b_tgt) -> begin
(
# 1530 "FStar.Tc.Tc.fst"
let kwp_a_tgt = (let _127_1187 = (let _127_1186 = (let _127_1185 = (let _127_1184 = (FStar_Absyn_Util.btvar_to_typ a)
in (b.FStar_Absyn_Syntax.v, _127_1184))
in FStar_Util.Inl (_127_1185))
in (_127_1186)::[])
in (FStar_Absyn_Util.subst_kind _127_1187 kwp_b_tgt))
in (
# 1531 "FStar.Tc.Tc.fst"
let expected_k = (let _127_1193 = (let _127_1192 = (let _127_1191 = (let _127_1190 = (FStar_Absyn_Syntax.t_binder a)
in (let _127_1189 = (let _127_1188 = (FStar_Absyn_Syntax.null_t_binder kwp_a_src)
in (_127_1188)::[])
in (_127_1190)::_127_1189))
in (_127_1191, kwp_a_tgt))
in (FStar_Absyn_Syntax.mk_Kind_arrow _127_1192))
in (FStar_All.pipe_right r _127_1193))
in (
...
(let _127_1196 = (FStar_Absyn_Print.sli lid)
in (let _127_1195 = (let _127_1194 = (FStar_Absyn_Util.close_kind tps k)
in (FStar_Absyn_Print.kind_to_string _127_1194))
...
(let _127_1197 = (FStar_Tc_Rel.keq env None k FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env) _127_1197))
end
| _42_2658 -> begin
()
end)
...
in (let _127_1200 = (FStar_All.pipe_right c'.FStar_Absyn_Syntax.effect_name (fun _127_1199 -> Some (_127_1199)))
in FStar_Absyn_Syntax.DefaultEffect (_127_1200)))
end
| t -> begin
t
end))))
...
let _42_2716 = (let _127_1204 = (tc_typ_trivial env' t)
in (FStar_All.pipe_right _127_1204 (fun _42_2713 -> (match (_42_2713) with
| (t, k) -> begin
(let _127_1203 = (norm_t env' t)
in (let _127_1202 = (norm_k env' k)
in (_127_1203, _127_1202)))
end))))
...
let k2 = (let _127_1205 = (tc_kind_trivial env' k)
in (FStar_All.pipe_right _127_1205 (norm_k env)))
in (
# 1583 "FStar.Tc.Tc.fst"
let _42_2721 = (let _127_1206 = (FStar_Tc_Rel.keq env' (Some (t)) k1 k2)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env') _127_1206))
in k2))
end)
in (
...
in (FStar_Absyn_Visit.collect_from_typ (fun b t -> (match ((let _127_1214 = (FStar_Absyn_Util.compress_typ t)
in _127_1214.FStar_Absyn_Syntax.n)) with
...
| Some (tname) -> begin
(let _127_1218 = (let _127_1217 = (let _127_1216 = (let _127_1215 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (FStar_Tc_Errors.constructor_fails_the_positivity_check env _127_1215 tname))
in (_127_1216, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_127_1217))
in (Prims.raise _127_1218))
end)
end
| _42_2778 -> begin
()
...
(let _127_1219 = (FStar_Tc_Errors.cardinality_constraint_violated lid a)
in (FStar_Tc_Errors.warn r _127_1219))
end else begin
if (FStar_Options.check_cardinality ()) then begin
(let _127_1222 = (let _127_1221 = (let _127_1220 = (FStar_Tc_Errors.cardinality_constraint_violated lid a)
in (_127_1220, r))
...
let _42_2799 = (let _127_1223 = (FStar_Absyn_Util.function_formals t)
in (FStar_All.pipe_right _127_1223 FStar_Util.must))
...
| Some (args) -> begin
if (not ((((FStar_List.length args) >= (FStar_List.length tps)) && (let _127_1227 = (let _127_1226 = (FStar_Util.first_N (FStar_List.length tps) args)
in (FStar_All.pipe_right _127_1226 Prims.fst))
...
(let _127_1228 = (FStar_Absyn_Util.ftv tname FStar_Absyn_Syntax.kun)
in (FStar_Absyn_Util.mk_typ_app _127_1228 expected_args))
end))
end)
in (let _127_1232 = (let _127_1231 = (let _127_1230 = (let _127_1229 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (FStar_Tc_Errors.constructor_builds_the_wrong_type env _127_1229 result_t expected_t))
in (_127_1230, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_127_1231))
in (Prims.raise _127_1232)))
end else begin
()
end
end
| _42_2853 -> begin
(let _127_1237 = (let _127_1236 = (let _127_1235 = (let _127_1234 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (let _127_1233 = (FStar_Absyn_Util.ftv tname FStar_Absyn_Syntax.kun)
in (FStar_Tc_Errors.constructor_builds_the_wrong_type env _127_1234 result_t _127_1233)))
in (_127_1235, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_127_1236))
in (Prims.raise _127_1237))
end)
in (
...
(let _127_1239 = (let _127_1238 = (FStar_Tc_Normalize.typ_norm_to_string env t)
in (FStar_Util.format2 "data %s : %s\n" lid.FStar_Ident.str _127_1238))
in (FStar_All.pipe_left FStar_Util.print_string _127_1239))
end else begin
()
end
in (se, env)))))))
...
let t = (let _127_1240 = (tc_typ_check_trivial env t FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _127_1240 (FStar_Tc_Normalize.norm_typ ((FStar_Tc_Normalize.Beta)::(FStar_Tc_Normalize.SNComp)::[]) env)))
in (
...
(let _127_1242 = (let _127_1241 = (FStar_Tc_Normalize.typ_norm_to_string env t)
in (FStar_Util.format2 "val %s : %s\n" lid.FStar_Ident.str _127_1241))
in (FStar_All.pipe_left FStar_Util.print_string _127_1242))
end else begin
()
end
in (se, env)))))))
...
let phi = (let _127_1243 = (tc_typ_check_trivial env phi FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _127_1243 (norm_t env)))
in (
...
(let _127_1246 = (FStar_Absyn_Print.typ_to_string t')
in (FStar_Util.print2 "Using annotation %s for let binding %s\n" _127_1246 l.FStar_Ident.str))
end else begin
()
end
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_unknown -> begin
(let _127_1247 = (FStar_Absyn_Syntax.mk_lb (FStar_Util.Inr (l), FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _127_1247))
end
| _42_2924 -> begin
(
...
(let _127_1249 = (let _127_1248 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "%s: Warning: Annotation from val declaration overrides inline type annotation\n" _127_1248))
in (FStar_All.pipe_left FStar_Util.print_string _127_1249))
end else begin
()
end
in (let _127_1250 = (FStar_Absyn_Syntax.mk_lb (FStar_Util.Inr (l), FStar_Absyn_Const.effect_ALL_lid, t', e))
in (false, _127_1250)))
end))
end)
...
let e = (let _127_1255 = (let _127_1254 = (let _127_1253 = (syn' env FStar_Tc_Recheck.t_unit)
in (FStar_All.pipe_left _127_1253 (FStar_Absyn_Syntax.mk_Exp_constant FStar_Const.Const_unit)))
in (((Prims.fst lbs), lbs'), _127_1254))
in (FStar_Absyn_Syntax.mk_Exp_let _127_1255 None r))
in (
...
(let _127_1261 = (let _127_1260 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (
# 1707 "FStar.Tc.Tc.fst"
let should_log = (match ((let _127_1257 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (FStar_Tc_Env.try_lookup_val_decl env _127_1257))) with
| None -> begin
true
end
| _42_2974 -> begin
...
(let _127_1259 = (FStar_Absyn_Print.lbname_to_string lb.FStar_Absyn_Syntax.lbname)
in (let _127_1258 = (FStar_Tc_Normalize.typ_norm_to_string env lb.FStar_Absyn_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" _127_1259 _127_1258)))
end else begin
""
end))))
in (FStar_All.pipe_right _127_1260 (FStar_String.concat "\n")))
...
let _42_2994 = (let _127_1265 = (let _127_1262 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit r)
in Some (_127_1262))
in (let _127_1264 = (let _127_1263 = (c.FStar_Absyn_Syntax.comp ())
in (e, _127_1263))
in (check_expected_effect env _127_1265 _127_1264)))
in (match (_42_2994) with
| (e, _42_2992, g) -> begin
(
# 1722 "FStar.Tc.Tc.fst"
let _42_2995 = (let _127_1266 = (FStar_Tc_Rel.conj_guard g1 g)
in (FStar_Tc_Util.discharge_guard env _127_1266))
in (
...
let k = (match (k.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_unknown -> begin
(let _127_1270 = (FStar_Tc_Rel.new_kvar r tps)
in (FStar_All.pipe_right _127_1270 Prims.fst))
end
| _42_3035 -> begin
k
end)
...
(let _127_1271 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (FStar_Util.format1 "Recursive bindings: %s" _127_1271))
end else begin
""
end
in (
...
let tt = (let _127_1274 = (FStar_Absyn_Syntax.mk_Typ_ascribed (t, k) t.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.close_with_lam tps _127_1274))
in (
...
| (tps, t) -> begin
(let _127_1276 = (let _127_1275 = (FStar_Absyn_Util.compress_kind k)
in (lid, tps, _127_1275, t, [], r))
in FStar_Absyn_Syntax.Sig_typ_abbrev (_127_1276))
end))
end)))
end
| _42_3085 -> begin
(let _127_1278 = (let _127_1277 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "(%s) Impossible" _127_1277))
in (FStar_All.failwith _127_1278))
...
let _42_3102 = (let _127_1288 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (FStar_Util.print2 "Time %ss : %s\n" (FStar_Util.string_of_float diff) _127_1288))
in res))))))
in (
...
(let _127_1292 = (let _127_1291 = (FStar_Absyn_Print.sigelt_to_string se)
in (FStar_Util.format1 "Checking sigelt\t%s\n" _127_1291))
in (FStar_Util.print_string _127_1292))
end else begin
()
end
in (
...
if (is_abstract quals) then begin
(let _127_1310 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let _127_1309 = (let _127_1308 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (_127_1308, lb.FStar_Absyn_Syntax.lbtyp, (FStar_Absyn_Syntax.Assumption)::quals, r))
in FStar_Absyn_Syntax.Sig_val_decl (_127_1309)))))
in (_127_1310, hidden))
end else begin
((se)::[], hidden)
end
...
in (let _127_1332 = (FStar_Options.reset_options ())
in (FStar_All.pipe_right _127_1332 Prims.ignore)))))
end else begin
()
end
in (modul, env))))))
...
in (let _127_1345 = (FStar_List.fold_left do_sigelt en m.FStar_Absyn_Syntax.exports)
in (FStar_Tc_Env.finish_module _127_1345 m)))))
...
let _42_3318 = if ((let _127_1350 = (FStar_ST.read FStar_Options.debug)
in (FStar_List.length _127_1350)) <> 0) then begin
(let _127_1351 = (FStar_Absyn_Print.sli m.FStar_Absyn_Syntax.name)
...
(let _127_1352 = (FStar_Absyn_Print.modul_to_string m)
in (FStar_Util.print1 "%s\n" _127_1352))
end else begin
()
end
