...
(let _124_912 = (FStar_Absyn_Print.exp_to_string e)
in (let _124_911 = (FStar_Absyn_Print.typ_to_string pat_t)
...
(let _124_914 = (FStar_Tc_Normalize.exp_norm_to_string env e)
in (let _124_913 = (FStar_Tc_Normalize.typ_norm_to_string env lc.FStar_Absyn_Syntax.res_typ)
...
let _42_2276 = (let _124_915 = (FStar_Tc_Rel.solve_deferred_constraints env g)
in (FStar_All.pipe_left Prims.ignore _124_915))
in (
# 1271 "FStar.Tc.Tc.fst"
let e' = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env e)
in (
# 1272 "FStar.Tc.Tc.fst"
let _42_2279 = if (let _124_918 = (let _124_917 = (FStar_Absyn_Util.uvars_in_exp e')
in (let _124_916 = (FStar_Absyn_Util.uvars_in_typ expected_pat_t)
in (FStar_Absyn_Util.uvars_included_in _124_917 _124_916)))
in (FStar_All.pipe_left Prims.op_Negation _124_918)) then begin
(let _124_923 = (let _124_922 = (let _124_921 = (let _124_920 = (FStar_Absyn_Print.exp_to_string e')
in (let _124_919 = (FStar_Absyn_Print.typ_to_string expected_pat_t)
in (FStar_Util.format2 "Implicit pattern variables in %s could not be resolved against expected type %s; please bind them explicitly" _124_920 _124_919)))
in (_124_921, p.FStar_Absyn_Syntax.p))
in FStar_Absyn_Syntax.Error (_124_922))
in (Prims.raise _124_923))
end else begin
()
end
in (
...
(let _124_924 = (FStar_Tc_Normalize.exp_norm_to_string env e)
...
let _42_2306 = (let _124_928 = (FStar_Tc_Env.set_expected_typ pat_env FStar_Tc_Recheck.t_bool)
...
let _42_2322 = (let _124_931 = (FStar_Tc_Env.push_local_binding env (FStar_Tc_Env.Binding_var ((scrutinee_x, pat_t))))
...
let _42_2599 = (let _124_1181 = (FStar_Options.reset_options ())
...
let _42_2614 = (let _124_1182 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.source)
in (a_kwp_a env sub.FStar_Absyn_Syntax.source _124_1182))
in (match (_42_2614) with
| (a, kwp_a_src) -> begin
(
# 1535 "FStar.Tc.Tc.fst"
let _42_2617 = (let _124_1183 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.target)
...
let _42_2718 = (let _124_1204 = (tc_typ_trivial env' t)
in (FStar_All.pipe_right _124_1204 (fun _42_2715 -> (match (_42_2715) with
| (t, k) -> begin
...
let _42_2723 = (let _124_1206 = (FStar_Tc_Rel.keq env' (Some (t)) k1 k2)
...
let _42_2801 = (let _124_1223 = (FStar_Absyn_Util.function_formals t)
...
let _42_2996 = (let _124_1265 = (let _124_1262 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit r)
in Some (_124_1262))
...
let _42_2997 = (let _124_1266 = (FStar_Tc_Rel.conj_guard g1 g)
...
let _42_3104 = (let _124_1288 = (FStar_Absyn_Print.sigelt_to_string_short se)
...
let _42_3320 = if ((let _124_1350 = (FStar_ST.read FStar_Options.debug)
