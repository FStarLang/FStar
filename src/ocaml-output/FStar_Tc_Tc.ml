...
open Prims
let syn' = (fun env k -> (let _157_11 = (FStar_Tc_Env.get_range env)
in (FStar_Absyn_Syntax.syn _157_11 (Some (k)))))

let log : FStar_Tc_Env.env  ->  Prims.bool = (fun env -> ((FStar_ST.read FStar_Options.log_types) && (not ((let _157_14 = (FStar_Tc_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Absyn_Const.prims_lid _157_14))))))

let rng : FStar_Tc_Env.env  ->  FStar_Range.range = (fun env -> (FStar_Tc_Env.get_range env))

let instantiate_both : FStar_Tc_Env.env  ->  FStar_Tc_Env.env = (fun env -> (let _54_24 = env
...
let no_inst : FStar_Tc_Env.env  ->  FStar_Tc_Env.env = (fun env -> (let _54_27 = env
...
in (let _157_30 = (let _157_29 = (let _157_28 = (let _157_27 = (let _157_26 = (FStar_Tc_Recheck.recompute_typ v)
in (FStar_All.pipe_left (fun _157_25 -> FStar_Util.Inl (_157_25)) _157_26))
in (_157_27, Some (FStar_Absyn_Syntax.Implicit)))
in (_157_28)::((FStar_Absyn_Syntax.varg v))::((FStar_Absyn_Syntax.varg tl))::[])
in (FStar_Absyn_Util.lex_pair, _157_29))
in (FStar_Absyn_Syntax.mk_Exp_app _157_30 (Some (FStar_Absyn_Util.lex_t)) r)))) vs FStar_Absyn_Util.lex_top))

let is_eq : FStar_Absyn_Syntax.arg_qualifier Prims.option  ->  Prims.bool = (fun _54_1 -> (match (_54_1) with
...
let norm_t : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun env t -> (let _157_43 = (steps env)
in (FStar_Tc_Normalize.norm_typ _157_43 env t)))

let norm_k : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.knd = (fun env k -> (let _157_48 = (steps env)
in (FStar_Tc_Normalize.norm_kind _157_48 env k)))

let norm_c : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.comp  ->  FStar_Absyn_Syntax.comp = (fun env c -> (let _157_53 = (steps env)
in (FStar_Tc_Normalize.norm_comp _157_53 env c)))
...
(let _157_72 = if norm then begin
(norm_k env k)
end else begin
k
end
in (FStar_Absyn_Util.freevars_kind _157_72))
end
| FStar_Util.Inr (t) -> begin
(let _157_73 = if norm then begin
(norm_t env t)
end else begin
t
end
in (FStar_Absyn_Util.freevars_typ _157_73))
end)
...
| () -> begin
(let escaping = (let _157_78 = (let _157_77 = (FStar_Util.set_elements a)
in (FStar_All.pipe_right _157_77 (FStar_List.map (fun x -> (FStar_Absyn_Print.strBvd x.FStar_Absyn_Syntax.v)))))
in (FStar_All.pipe_right _157_78 (FStar_String.concat ", ")))
in (let msg = if ((FStar_Util.set_count a) > 1) then begin
(let _157_79 = (FStar_Tc_Normalize.exp_norm_to_string env head)
in (FStar_Util.format2 "Bound variables \'{%s}\' in the type of \'%s\' escape because of impure applications; add explicit let-bindings" escaping _157_79))
end else begin
(let _157_80 = (FStar_Tc_Normalize.exp_norm_to_string env head)
in (FStar_Util.format2 "Bound variable \'%s\' in the type of \'%s\' escapes because of impure applications; add explicit let-bindings" escaping _157_80))
end
in (let _157_83 = (let _157_82 = (let _157_81 = (FStar_Tc_Env.get_range env)
in (msg, _157_81))
in FStar_Absyn_Syntax.Error (_157_82))
in (Prims.raise _157_83))))
end))
in (match (kt) with
| FStar_Util.Inl (k) -> begin
...
(let _157_94 = (let _157_93 = (let _157_92 = (FStar_Absyn_Util.btvar_to_typ b)
in (a.FStar_Absyn_Syntax.v, _157_92))
in FStar_Util.Inl (_157_93))
in (_157_94)::s)
end
end
...
(let _157_97 = (let _157_96 = (let _157_95 = (FStar_Absyn_Util.bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _157_95))
in FStar_Util.Inr (_157_96))
in (_157_97)::s)
end
end
| _54_114 -> begin
...
let set_lcomp_result : FStar_Absyn_Syntax.lcomp  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.lcomp = (fun lc t -> (let _54_132 = lc
...
| () -> begin
(let _157_106 = (lc.FStar_Absyn_Syntax.comp ())
in (FStar_Absyn_Util.set_result_typ _157_106 t))
end))}))
...
(let _157_113 = if (not ((FStar_Absyn_Util.is_pure_or_ghost_function t))) then begin
(FStar_Absyn_Syntax.mk_Total t)
end else begin
(FStar_Tc_Util.return_value env t e)
end
in (FStar_Tc_Util.lcomp_of_comp _157_113))
end
...
(let _157_115 = (FStar_Absyn_Print.typ_to_string t)
in (let _157_114 = (FStar_Absyn_Print.typ_to_string t')
...
| (e, g) -> begin
(let _54_154 = (let _157_121 = (FStar_All.pipe_left (fun _157_120 -> Some (_157_120)) (FStar_Tc_Errors.subtyping_failed env t t'))
in (FStar_Tc_Util.strengthen_precondition _157_121 env e lc g))
...
(let _157_122 = (FStar_Absyn_Print.lcomp_typ_to_string lc)
...
let check_expected_effect : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.comp Prims.option  ->  (FStar_Absyn_Syntax.exp * FStar_Absyn_Syntax.comp)  ->  (FStar_Absyn_Syntax.exp * FStar_Absyn_Syntax.comp * FStar_Tc_Rel.guard_t) = (fun env copt _54_171 -> (match (_54_171) with
| (e, c) -> begin
...
| None -> begin
(let _157_135 = (norm_c env c)
in (e, _157_135, FStar_Tc_Rel.trivial_guard))
end
| Some (expected_c) -> begin
(let _54_187 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _157_138 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _157_137 = (FStar_Absyn_Print.comp_typ_to_string c)
in (let _157_136 = (FStar_Absyn_Print.comp_typ_to_string expected_c)
in (FStar_Util.print3 "(%s) About to check\n\t%s\nagainst expected effect\n\t%s\n" _157_138 _157_137 _157_136))))
end else begin
()
end
in (let c = (norm_c env c)
in (let expected_c' = (let _157_139 = (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp expected_c)
in (FStar_Tc_Util.refresh_comp_label env true _157_139))
in (let _54_195 = (let _157_140 = (expected_c'.FStar_Absyn_Syntax.comp ())
in (FStar_All.pipe_left (FStar_Tc_Util.check_comp env e c) _157_140))
in (match (_54_195) with
| (e, _54_193, g) -> begin
(let _54_196 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _157_142 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _157_141 = (FStar_Tc_Rel.guard_to_string env g)
...
(let _157_148 = (let _157_147 = (let _157_146 = (FStar_Tc_Errors.unexpected_non_trivial_precondition_on_term env f)
in (let _157_145 = (FStar_Tc_Env.get_range env)
in (_157_146, _157_145)))
in FStar_Absyn_Syntax.Error (_157_147))
...
| Some (t) -> begin
(let _157_155 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.print1 "Expected type is %s" _157_155))
end))
...
(let _157_208 = (FStar_Range.string_of_range k.FStar_Absyn_Syntax.pos)
in (let _157_207 = (FStar_Absyn_Print.kind_to_string k)
in (FStar_Util.print2 "(%s) - Checking kind %s" _157_208 _157_207)))
end else begin
()
end
...
| (args, g) -> begin
(let _157_210 = (FStar_All.pipe_left w (FStar_Absyn_Syntax.mk_Kind_uvar (u, args)))
in (_157_210, g))
end))
end)))
end
...
(let _157_214 = (let _157_213 = (let _157_212 = (let _157_211 = (FStar_Absyn_Print.sli l)
in (Prims.strcat "Unexpected number of arguments to kind abbreviation " _157_211))
in (_157_212, k.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_157_213))
in (Prims.raise _157_214))
end else begin
...
| (FStar_Util.Inl (a), FStar_Util.Inl (t)) -> begin
(let _54_289 = (let _157_218 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in (tc_typ_check env t _157_218))
...
| (FStar_Util.Inr (x), FStar_Util.Inr (e)) -> begin
(let env = (let _157_219 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Env.set_expected_typ env _157_219))
...
in (let _157_222 = (FStar_List.fold_left FStar_Tc_Rel.conj_guard g guards)
in (k', _157_222))))))
end))
end
end))
...
in (let _157_224 = (FStar_Tc_Rel.conj_guard f g)
in (kk, _157_224))))
end))
end))
end
...
| (bs, env', g') -> begin
(let _157_238 = (let _157_237 = (FStar_Tc_Rel.close_guard ((b)::[]) g')
in (FStar_Tc_Rel.conj_guard g _157_237))
in ((b)::bs, env', _157_238))
end))))
end))
end
| FStar_Util.Inr (x) -> begin
...
| (bs, env', g') -> begin
(let _157_240 = (let _157_239 = (FStar_Tc_Rel.close_guard ((b)::[]) g')
in (FStar_Tc_Rel.conj_guard g _157_239))
in ((b)::bs, env', _157_240))
end)))
end))
end)
end))
in (aux env bs)))
and tc_args : FStar_Tc_Env.env  ->  (((FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax, (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Util.either * FStar_Absyn_Syntax.arg_qualifier Prims.option) Prims.list  ->  (FStar_Absyn_Syntax.args * FStar_Tc_Rel.guard_t) = (fun env args -> (FStar_List.fold_right (fun _54_386 _54_389 -> (match ((_54_386, _54_389)) with
...
| (t, _54_394, g') -> begin
(let _157_245 = (FStar_Tc_Rel.conj_guard g g')
in (((FStar_Util.Inl (t), imp))::args, _157_245))
end))
end
...
| (t, g) -> begin
(let _157_254 = (FStar_Absyn_Syntax.mk_Total t)
in (_157_254, g))
end))
end
...
| (res, args) -> begin
(let _54_459 = (let _157_256 = (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_List.map (fun _54_3 -> (match (_54_3) with
...
in (FStar_All.pipe_right _157_256 FStar_List.unzip))
in (match (_54_459) with
| (flags, guards) -> begin
(let _157_258 = (FStar_Absyn_Syntax.mk_Comp (let _54_460 = c
...
in (let _157_257 = (FStar_List.fold_left FStar_Tc_Rel.conj_guard f guards)
in (_157_258, _157_257)))
end))
end))
end))
end)))))
...
in (let _157_281 = (FStar_Absyn_Syntax.mk_Typ_const i (Some (qk)) t.FStar_Absyn_Syntax.pos)
in (_157_281, qk, FStar_Tc_Rel.trivial_guard)))))
end
...
in (let _157_282 = (FStar_Absyn_Syntax.mk_Typ_const i (Some (qk)) t.FStar_Absyn_Syntax.pos)
in (_157_282, qk, FStar_Tc_Rel.trivial_guard)))))
end
...
(let rec extract_pats = (fun pats -> (match ((let _157_287 = (FStar_Absyn_Util.compress_exp pats)
in _157_287.FStar_Absyn_Syntax.n)) with
...
in (let _157_288 = (extract_pats tl)
in (FStar_List.append pat _157_288)))
end))
end
| _54_588 -> begin
[]
end))
in (let pats = (let _157_289 = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env pats)
in (extract_pats _157_289))
...
| Some (b) -> begin
(let _157_292 = (let _157_291 = (FStar_Absyn_Print.binder_to_string b)
in (FStar_Util.format1 "Pattern misses at least one bound variables: %s" _157_291))
in (FStar_Tc_Errors.warn t.FStar_Absyn_Syntax.pos _157_292))
end))))
end
| _54_603 -> begin
(FStar_All.failwith "Impossible")
...
in (let _157_294 = (let _157_293 = (FStar_Tc_Rel.close_guard bs f)
in (FStar_Tc_Rel.conj_guard g _157_293))
in (t, FStar_Absyn_Syntax.ktype, _157_294))))
end))
end))
end
...
in (let _157_299 = (FStar_All.pipe_left (w k) (FStar_Absyn_Syntax.mk_Typ_lam (bs, t)))
in (let _157_298 = (let _157_297 = (FStar_Tc_Rel.close_guard bs f)
in (FStar_All.pipe_left (FStar_Tc_Rel.conj_guard g) _157_297))
in (_157_299, k, _157_298))))
end))
end))
end
...
(let _157_302 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _157_301 = (FStar_Absyn_Print.typ_to_string phi)
in (let _157_300 = (match ((FStar_Tc_Env.expected_typ env)) with
| None -> begin
"None"
end
| Some (t) -> begin
...
| (phi, f2) -> begin
(let _157_307 = (FStar_All.pipe_left (w FStar_Absyn_Syntax.ktype) (FStar_Absyn_Syntax.mk_Typ_refine (x, phi)))
in (let _157_306 = (let _157_305 = (FStar_Tc_Rel.close_guard (((FStar_Absyn_Syntax.v_binder x))::[]) f2)
in (FStar_Tc_Rel.conj_guard f1 _157_305))
in (_157_307, FStar_Absyn_Syntax.ktype, _157_306)))
end)))
end))
end
| FStar_Absyn_Syntax.Typ_app (head, args) -> begin
(let _54_639 = if (FStar_Tc_Env.debug env FStar_Options.Extreme) then begin
(let _157_310 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _157_309 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
in (let _157_308 = (FStar_Absyn_Print.typ_to_string top)
in (FStar_Util.print3 "(%s) Checking type application (%s): %s\n" _157_310 _157_309 _157_308))))
end else begin
()
end
...
(let _157_314 = (FStar_Range.string_of_range head.FStar_Absyn_Syntax.pos)
in (let _157_313 = (FStar_Absyn_Print.typ_to_string head)
in (let _157_312 = (FStar_Absyn_Print.kind_to_string k1')
in (let _157_311 = (FStar_Absyn_Print.kind_to_string k1)
in (FStar_Util.print4 "(%s) head %s has kind %s ... after norm %s\n" _157_314 _157_313 _157_312 _157_311)))))
end else begin
()
end
...
in (let kres = (let _157_317 = (FStar_Tc_Rel.new_kvar k1.FStar_Absyn_Syntax.pos binders)
in (FStar_All.pipe_right _157_317 Prims.fst))
in (let bs = (let _157_318 = (FStar_Tc_Util.tks_of_args args)
in (FStar_Absyn_Util.null_binders_of_tks _157_318))
in (let kar = (FStar_Absyn_Syntax.mk_Kind_arrow (bs, kres) k1.FStar_Absyn_Syntax.pos)
in (let _54_662 = (let _157_319 = (FStar_Tc_Rel.keq env None k1 kar)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env) _157_319))
in (kres, args, g)))))))
end))
end
...
| ([], []) -> begin
(let _157_330 = (FStar_Absyn_Util.subst_kind subst kres)
in (_157_330, (FStar_List.rev outargs), g))
end
...
(let _157_334 = (let _157_333 = (let _157_332 = (let _157_331 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _157_331))
in ("Argument is marked as instantiating an implicit parameter; although the expected parameter is explicit", _157_332))
in FStar_Absyn_Syntax.Error (_157_333))
in (Prims.raise _157_334))
end
...
in (let _54_735 = (let _157_335 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Util.new_implicit_tvar env _157_335))
...
(let formal = (FStar_List.hd formals)
in (let _54_764 = (let _157_336 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (FStar_Tc_Util.new_implicit_evar env _157_336))
...
(let _157_338 = (FStar_Absyn_Print.arg_to_string actual)
in (let _157_337 = (FStar_Absyn_Print.kind_to_string formal_k)
...
(let _157_339 = (FStar_Tc_Rel.guard_to_string env g')
in (FStar_Util.print1 ">>>Got guard %s\n" _157_339))
end else begin
()
end
in (let actual = (FStar_Util.Inl (t), imp)
in (let g' = (let _157_341 = (let _157_340 = (FStar_Tc_Util.short_circuit_typ (FStar_Util.Inl (head)) outargs)
in (FStar_All.pipe_left FStar_Tc_Rel.guard_of_guard_formula _157_340))
in (FStar_Tc_Rel.imp_guard _157_341 g'))
in (let subst = (maybe_extend_subst subst formal actual)
in (let _157_342 = (FStar_Tc_Rel.conj_guard g g')
in (check_args ((actual)::outargs) subst _157_342 formals actuals))))))
end))))
end
...
(let _157_344 = (FStar_Absyn_Print.arg_to_string actual)
in (let _157_343 = (FStar_Absyn_Print.typ_to_string tx)
...
in (let g' = (let _157_346 = (let _157_345 = (FStar_Tc_Util.short_circuit_typ (FStar_Util.Inl (head)) outargs)
in (FStar_All.pipe_left FStar_Tc_Rel.guard_of_guard_formula _157_345))
in (FStar_Tc_Rel.imp_guard _157_346 g'))
in (let subst = (maybe_extend_subst subst formal actual)
in (let _157_347 = (FStar_Tc_Rel.conj_guard g g')
in (check_args ((actual)::outargs) subst _157_347 formals actuals)))))
end))))))
end
...
| (_54_849, []) -> begin
(let _157_349 = (let _157_348 = (FStar_Absyn_Syntax.mk_Kind_arrow (formals, kres) kres.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.subst_kind subst _157_348))
in (_157_349, (FStar_List.rev outargs), g))
end
| ([], _54_854) -> begin
(let _157_357 = (let _157_356 = (let _157_355 = (let _157_354 = (let _157_352 = (let _157_351 = (FStar_All.pipe_right outargs (FStar_List.filter (fun _54_4 -> (match (_54_4) with
...
in (FStar_List.length _157_351))
in (FStar_All.pipe_right _157_352 FStar_Util.string_of_int))
in (let _157_353 = (FStar_All.pipe_right (FStar_List.length args0) FStar_Util.string_of_int)
in (FStar_Util.format2 "Too many arguments to type; expected %s arguments but got %s" _157_354 _157_353)))
in (_157_355, top.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_157_356))
in (Prims.raise _157_357))
end))
in (check_args [] [] f1 formals args))
end
| _54_865 -> begin
(let _157_360 = (let _157_359 = (let _157_358 = (FStar_Tc_Errors.expected_tcon_kind env top k1)
in (_157_358, top.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_157_359))
in (Prims.raise _157_360))
end)
end))
in (match ((let _157_364 = (let _157_361 = (FStar_Absyn_Util.compress_typ head)
in _157_361.FStar_Absyn_Syntax.n)
in (let _157_363 = (let _157_362 = (FStar_Absyn_Util.compress_kind k1)
in _157_362.FStar_Absyn_Syntax.n)
in (_157_364, _157_363)))) with
...
| (t1, f2) -> begin
(let _157_368 = (FStar_All.pipe_left (w k1) (FStar_Absyn_Syntax.mk_Typ_ascribed' (t1, k1)))
in (let _157_367 = (FStar_Tc_Rel.conj_guard f1 f2)
in (_157_368, k1, _157_367)))
end))
end))
end
...
(let _157_370 = (FStar_Absyn_Print.typ_to_string s)
in (let _157_369 = (FStar_Absyn_Print.kind_to_string k1)
in (FStar_Util.print2 "Admitting un-instantiated uvar %s at kind %s\n" _157_370 _157_369)))
end else begin
()
end
in (let _157_373 = (FStar_All.pipe_left (w k1) (FStar_Absyn_Syntax.mk_Typ_uvar' (u, k1)))
in (_157_373, k1, FStar_Tc_Rel.trivial_guard)))
end
| _54_907 -> begin
(let _54_908 = if (FStar_All.pipe_left (FStar_Tc_Env.debug env) FStar_Options.High) then begin
(let _157_375 = (FStar_Absyn_Print.typ_to_string s)
in (let _157_374 = (FStar_Absyn_Print.kind_to_string k1)
...
| (t, k, f) -> begin
(let _157_376 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_refresh_label ((t, b, r))))
in (_157_376, k, f))
end))
end
...
| (t, k, f) -> begin
(let _157_377 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_labeled ((t, l, r, p))))
in (_157_377, k, f))
end))
end
...
| (t, k, f) -> begin
(let _157_378 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_named ((t, l))))
in (_157_378, k, f))
end))
end
...
in (let _157_381 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_pattern ((quant, pats))))
in (let _157_380 = (FStar_Tc_Util.force_tk quant)
in (let _157_379 = (FStar_Tc_Rel.conj_guard f g)
in (_157_381, _157_380, _157_379)))))
end))
end))
end
...
| _54_958 -> begin
(let _157_383 = (let _157_382 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "Unexpected type : %s\n" _157_382))
in (FStar_All.failwith _157_383))
end))))))
and tc_typ_check : FStar_Tc_Env.env  ->  (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.knd  ->  (FStar_Absyn_Syntax.typ * FStar_Tc_Rel.guard_t) = (fun env t k -> (let _54_965 = (tc_typ env t)
...
(let _157_390 = (let _157_389 = (FStar_Absyn_Syntax.mk_Total t)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _157_389))
in FStar_Util.Inr (_157_390))
end
in (let _157_391 = (value_check_expected_typ env e tc)
in (FStar_All.pipe_left (with_implicits implicits) _157_391)))
end))))
end
...
(let _157_393 = (let _157_392 = (FStar_Absyn_Syntax.mk_Total t)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _157_392))
in FStar_Util.Inr (_157_393))
end
...
(let _157_399 = (let _157_398 = (let _157_397 = (FStar_Util.format1 "Expected a data constructor; got %s" v.FStar_Absyn_Syntax.v.FStar_Ident.str)
in (let _157_396 = (FStar_Tc_Env.get_range env)
in (_157_397, _157_396)))
in FStar_Absyn_Syntax.Error (_157_398))
in (Prims.raise _157_399))
end else begin
(let _157_400 = (value_check_expected_typ env e tc)
in (FStar_All.pipe_left (with_implicits implicits) _157_400))
end))
end))))
end
...
(let fail = (fun msg t -> (let _157_405 = (let _157_404 = (let _157_403 = (FStar_Tc_Errors.expected_a_term_of_type_t_got_a_function env msg t top)
in (_157_403, top.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_157_404))
in (Prims.raise _157_405)))
...
in (let rec as_function_typ = (fun norm t -> (match ((let _157_414 = (FStar_Absyn_Util.compress_typ t)
in _157_414.FStar_Absyn_Syntax.n)) with
...
| ([], []) -> begin
(let _157_423 = (FStar_Absyn_Util.subst_comp subst c)
in ((FStar_List.rev out), env, g, _157_423))
end
...
in (let g = (let _157_424 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard g _157_424))
in (k, g)))
end))
end)
...
(let tx = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (let _54_1164 = (match ((let _157_425 = (FStar_Absyn_Util.unmeta_typ y.FStar_Absyn_Syntax.sort)
in _157_425.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Typ_unknown -> begin
(tx, g)
end
| _54_1152 -> begin
(let _54_1153 = if (FStar_Tc_Env.debug env FStar_Options.High) then begin
(let _157_426 = (FStar_Absyn_Print.binder_to_string hd)
...
in (let g = (let _157_427 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard g _157_427))
in (t, g)))
end)))
end)
...
| _54_1171 -> begin
(let _157_430 = (let _157_429 = (FStar_Absyn_Print.binder_to_string hdannot)
in (let _157_428 = (FStar_Absyn_Print.binder_to_string hd)
in (FStar_Util.format2 "Annotated %s; given %s" _157_429 _157_428)))
in (fail _157_430 t))
end)
end
| ([], _54_1174) -> begin
...
| t -> begin
(let _157_432 = (let _157_431 = (FStar_Absyn_Print.tag_of_typ t)
in (FStar_Util.format1 "More arguments than annotated type (%s)" _157_431))
in (fail _157_432 t))
end)
end else begin
...
| (_54_1191, []) -> begin
(let c = (let _157_433 = (FStar_Absyn_Syntax.mk_Typ_fun (bs_annot, c) (Some (FStar_Absyn_Syntax.ktype)) c.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.total_comp _157_433 c.FStar_Absyn_Syntax.pos))
in (let _157_434 = (FStar_Absyn_Util.subst_comp subst c)
in ((FStar_List.rev out), env, g, _157_434)))
end)
end))
...
(let _157_439 = (FStar_Absyn_Print.typ_to_string t)
...
(match ((let _157_445 = (let _157_444 = (let _157_443 = (FStar_Absyn_Util.unrefine x.FStar_Absyn_Syntax.sort)
in (whnf env _157_443))
in (FStar_Absyn_Util.unrefine _157_444))
in _157_445.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Typ_fun (_54_1221) -> begin
[]
end
| _54_1224 -> begin
(let _157_446 = (FStar_Absyn_Util.bvar_to_exp x)
in (_157_446)::[])
end)
end)))))
...
(let _157_455 = (let _157_454 = (let _157_453 = (let _157_451 = (FStar_Util.string_of_int (FStar_List.length bs'))
in (let _157_450 = (FStar_Util.string_of_int (FStar_List.length actuals))
in (FStar_Util.format2 "Decreases clause on a function with an unexpected number of arguments (expected %s; got %s)" _157_451 _157_450)))
in (let _157_452 = (FStar_Tc_Env.get_range env)
in (_157_453, _157_452)))
in FStar_Absyn_Syntax.Error (_157_454))
in (Prims.raise _157_455))
end else begin
()
end
...
(let _157_459 = (let _157_458 = (FStar_Absyn_Util.btvar_to_typ actual)
in (formal.FStar_Absyn_Syntax.v, _157_458))
in FStar_Util.Inl (_157_459))
end
| ((FStar_Util.Inr (formal), _54_1268), (FStar_Util.Inr (actual), _54_1273)) -> begin
(let _157_461 = (let _157_460 = (FStar_Absyn_Util.bvar_to_exp actual)
in (formal.FStar_Absyn_Syntax.v, _157_460))
in FStar_Util.Inr (_157_461))
end
| _54_1277 -> begin
(FStar_All.failwith "impossible")
end)) bs' actuals)
...
in (match ((let _157_463 = (FStar_Absyn_Util.compress_typ t)
in _157_463.FStar_Absyn_Syntax.n)) with
...
in (let dec = (let subst = (let _157_467 = (let _157_466 = (let _157_465 = (FStar_Absyn_Util.bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _157_465))
in FStar_Util.Inr (_157_466))
in (_157_467)::[])
in (FStar_Absyn_Util.subst_exp subst dec))
...
(let _157_470 = (FStar_Absyn_Print.lbname_to_string l)
in (let _157_469 = (FStar_Absyn_Print.typ_to_string t)
in (let _157_468 = (FStar_Absyn_Print.typ_to_string t')
in (FStar_Util.print3 "Refined let rec %s\n\tfrom type %s\n\tto type %s\n" _157_470 _157_469 _157_468))))
end else begin
()
end
in (let _54_1336 = (let _157_472 = (let _157_471 = (FStar_Tc_Env.clear_expected_typ env)
in (FStar_All.pipe_right _157_471 Prims.fst))
in (tc_typ _157_472 t'))
...
in (let _157_477 = (FStar_All.pipe_right letrecs (FStar_List.fold_left (fun env _54_1345 -> (match (_54_1345) with
| (x, t) -> begin
(FStar_Tc_Env.push_local_binding env (binding_of_lb x t))
end)) env))
in (let _157_476 = (FStar_All.pipe_right letrecs (FStar_List.collect (fun _54_8 -> (match (_54_8) with
...
| _54_1376 -> begin
if (not (norm)) then begin
(let _157_478 = (whnf env t)
in (as_function_typ true _157_478))
end else begin
...
(let _157_481 = (FStar_Absyn_Print.exp_to_string body)
in (let _157_480 = (FStar_Absyn_Print.lcomp_typ_to_string cbody)
in (let _157_479 = (FStar_Tc_Rel.guard_to_string env guard_body)
in (FStar_Util.print3 "!!!!!!!!!!!!!!!body %s has type %s\nguard is %s\n" _157_481 _157_480 _157_479))))
end else begin
()
end
...
(let _54_1415 = (let _157_485 = (FStar_Tc_Rel.conj_guard g guard)
in (FStar_Tc_Util.discharge_guard envbody _157_485))
...
in (let e = (let _157_487 = (let _157_486 = (FStar_Absyn_Syntax.mk_Exp_abs (bs, body) (Some (tfun_computed)) top.FStar_Absyn_Syntax.pos)
in (_157_486, tfun_computed, Some (FStar_Absyn_Const.effect_Tot_lid)))
in (FStar_Absyn_Syntax.mk_Exp_ascribed _157_487 None top.FStar_Absyn_Syntax.pos))
in (let _54_1440 = (match (tfun_opt) with
| Some (t, use_teq) -> begin
(let t = (FStar_Absyn_Util.compress_typ t)
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_fun (_54_1429) -> begin
(let _157_490 = (let _157_489 = (let _157_488 = (FStar_Absyn_Syntax.mk_Exp_abs (bs, body) (Some (t)) e.FStar_Absyn_Syntax.pos)
in (_157_488, t, Some (FStar_Absyn_Const.effect_Tot_lid)))
in (FStar_Absyn_Syntax.mk_Exp_ascribed _157_489 None top.FStar_Absyn_Syntax.pos))
in (_157_490, t, guard))
end
| _54_1432 -> begin
(let _54_1435 = if use_teq then begin
(let _157_491 = (FStar_Tc_Rel.teq env t tfun_computed)
in (e, _157_491))
end else begin
...
| (e, guard') -> begin
(let _157_493 = (FStar_Absyn_Syntax.mk_Exp_ascribed (e, t, Some (FStar_Absyn_Const.effect_Tot_lid)) None top.FStar_Absyn_Syntax.pos)
in (let _157_492 = (FStar_Tc_Rel.conj_guard guard guard')
in (_157_493, t, _157_492)))
end))
end))
end
| None -> begin
...
(let _157_496 = (FStar_Absyn_Print.typ_to_string tfun)
in (let _157_495 = (FStar_Absyn_Print.tag_of_typ tfun)
in (let _157_494 = (FStar_Tc_Rel.guard_to_string env guard)
in (FStar_Util.print3 "!!!!!!!!!!!!!!!Annotating lambda with type %s (%s)\nGuard is %s\n" _157_496 _157_495 _157_494))))
end else begin
()
end
...
in (let _54_1446 = (let _157_498 = (FStar_Tc_Util.lcomp_of_comp c)
in (FStar_Tc_Util.strengthen_precondition None env e _157_498 guard))
...
| _54_1448 -> begin
(let _157_500 = (let _157_499 = (FStar_Absyn_Print.exp_to_string e)
in (FStar_Util.format1 "Unexpected value: %s" _157_499))
in (FStar_All.failwith _157_500))
end))))
...
(let _157_505 = (let _157_503 = (FStar_Tc_Env.get_range env)
in (FStar_All.pipe_left FStar_Range.string_of_range _157_503))
in (let _157_504 = (FStar_Absyn_Print.tag_of_exp e)
...
(let _157_529 = (FStar_Absyn_Util.compress_exp e)
in (tc_exp env _157_529))
end
...
| (t1, f) -> begin
(let _54_1487 = (let _157_530 = (FStar_Tc_Env.set_expected_typ env t1)
in (tc_exp _157_530 e1))
in (match (_54_1487) with
| (e1, c, g) -> begin
(let _54_1491 = (let _157_534 = (FStar_Tc_Env.set_range env t1.FStar_Absyn_Syntax.pos)
...
| (c, f) -> begin
(let _54_1495 = (let _157_538 = (let _157_537 = (w c)
in (FStar_All.pipe_left _157_537 (FStar_Absyn_Syntax.mk_Exp_ascribed (e1, t1, Some (c.FStar_Absyn_Syntax.eff_name)))))
in (comp_check_expected_typ env _157_538 c))
in (match (_54_1495) with
| (e, c, f2) -> begin
(let _157_540 = (let _157_539 = (FStar_Tc_Rel.conj_guard g f2)
in (FStar_Tc_Rel.conj_guard f _157_539))
in (e, c, _157_540))
end))
end))
end))
...
(let pats_t = (let _157_546 = (let _157_545 = (let _157_541 = (FStar_Absyn_Const.kunary FStar_Absyn_Syntax.mk_Kind_type FStar_Absyn_Syntax.mk_Kind_type)
in (FStar_Absyn_Util.ftv FStar_Absyn_Const.list_lid _157_541))
in (let _157_544 = (let _157_543 = (let _157_542 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.pattern_lid FStar_Absyn_Syntax.mk_Kind_type)
in (FStar_Absyn_Syntax.targ _157_542))
in (_157_543)::[])
in (_157_545, _157_544)))
in (FStar_Absyn_Syntax.mk_Typ_app _157_546 None FStar_Absyn_Syntax.dummyRange))
in (let _54_1505 = (let _157_547 = (FStar_Tc_Env.set_expected_typ env pats_t)
in (tc_ghost_exp _157_547 e))
...
in (let c = (let _157_548 = (FStar_Absyn_Util.gtotal_comp pats_t)
in (FStar_All.pipe_right _157_548 FStar_Tc_Util.lcomp_of_comp))
in (e, c, g)))
end)))
end
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, FStar_Absyn_Syntax.Sequence)) -> begin
(match ((let _157_549 = (FStar_Absyn_Util.compress_exp e)
in _157_549.FStar_Absyn_Syntax.n)) with
...
(let _54_1532 = (let _157_550 = (FStar_Tc_Env.set_expected_typ env FStar_Tc_Recheck.t_unit)
in (tc_exp _157_550 e1))
...
in (let _157_558 = (let _157_556 = (let _157_555 = (let _157_554 = (let _157_553 = (w c)
in (FStar_All.pipe_left _157_553 (FStar_Absyn_Syntax.mk_Exp_let ((false, ((FStar_Absyn_Syntax.mk_lb (x, c1.FStar_Absyn_Syntax.eff_name, FStar_Tc_Recheck.t_unit, e1)))::[]), e2))))
in (_157_554, FStar_Absyn_Syntax.Sequence))
in FStar_Absyn_Syntax.Meta_desugared (_157_555))
in (FStar_Absyn_Syntax.mk_Exp_meta _157_556))
in (let _157_557 = (FStar_Tc_Rel.conj_guard g1 g2)
in (_157_558, c, _157_557))))
end))
end))
end
| _54_1539 -> begin
...
| (e, c, g) -> begin
(let _157_559 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared ((e, FStar_Absyn_Syntax.Sequence))))
in (_157_559, c, g))
end))
end)
end
...
| (e, c, g) -> begin
(let _157_560 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared ((e, i))))
in (_157_560, c, g))
end))
end
| FStar_Absyn_Syntax.Exp_app (head, args) -> begin
(let env0 = env
in (let env = (let _157_562 = (let _157_561 = (FStar_Tc_Env.clear_expected_typ env)
in (FStar_All.pipe_right _157_561 Prims.fst))
in (FStar_All.pipe_right _157_562 instantiate_both))
in (let _54_1559 = if (FStar_Tc_Env.debug env FStar_Options.High) then begin
(let _157_564 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _157_563 = (FStar_Absyn_Print.exp_to_string top)
...
(let _157_570 = (let _157_567 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Util.b2t _157_567))
in (let _157_569 = (let _157_568 = (FStar_Tc_Util.return_value env FStar_Absyn_Util.t_bool xexp)
in (FStar_All.pipe_right _157_568 FStar_Tc_Util.lcomp_of_comp))
in (FStar_Tc_Util.ite env _157_570 c2 _157_569)))
end else begin
(let _157_574 = (let _157_571 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Util.b2t _157_571))
in (let _157_573 = (let _157_572 = (FStar_Tc_Util.return_value env FStar_Absyn_Util.t_bool xexp)
in (FStar_All.pipe_right _157_572 FStar_Tc_Util.lcomp_of_comp))
in (FStar_Tc_Util.ite env _157_574 _157_573 c2)))
end
in (let c = (let _157_577 = (let _157_576 = (FStar_All.pipe_left (fun _157_575 -> Some (_157_575)) (FStar_Tc_Env.Binding_var ((x.FStar_Absyn_Syntax.v, FStar_Absyn_Util.t_bool))))
in (_157_576, c2))
in (FStar_Tc_Util.bind env None c1 _157_577))
...
in (let _157_579 = (let _157_578 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard g_head _157_578))
in (e, c, _157_579)))))))
end))
end))
end
...
(let _157_581 = (FStar_Range.string_of_range head.FStar_Absyn_Syntax.pos)
in (let _157_580 = (FStar_Absyn_Print.typ_to_string thead)
in (FStar_Util.print2 "(%s) Type of head is %s\n" _157_581 _157_580)))
end else begin
()
end
in (let rec check_function_app = (fun norm tf -> (match ((let _157_586 = (FStar_Absyn_Util.unrefine tf)
in _157_586.FStar_Absyn_Syntax.n)) with
| (FStar_Absyn_Syntax.Typ_uvar (_)) | (FStar_Absyn_Syntax.Typ_app ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Typ_uvar (_); FStar_Absyn_Syntax.tk = _; FStar_Absyn_Syntax.pos = _; FStar_Absyn_Syntax.fvs = _; FStar_Absyn_Syntax.uvs = _}, _)) -> begin
...
(let _157_591 = (FStar_Tc_Rel.conj_guard g_e g_rest)
in (((FStar_Util.Inr (e), imp))::args, (c)::comps, _157_591))
end))
end))
end))
...
(let bs = (let _157_592 = (FStar_Tc_Util.tks_of_args args)
in (FStar_Absyn_Util.null_binders_of_tks _157_592))
in (let cres = (let _157_593 = (FStar_Tc_Util.new_tvar env FStar_Absyn_Syntax.ktype)
in (FStar_Absyn_Util.ml_comp _157_593 top.FStar_Absyn_Syntax.pos))
in (let _54_1659 = (let _157_595 = (let _157_594 = (FStar_Absyn_Syntax.mk_Typ_fun (bs, cres) (Some (FStar_Absyn_Syntax.ktype)) tf.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Rel.teq env tf _157_594))
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env) _157_595))
in (let comp = (let _157_598 = (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp cres)
in (FStar_List.fold_right (fun c out -> (FStar_Tc_Util.bind env None c (None, out))) ((chead)::comps) _157_598))
in (let _157_600 = (FStar_Absyn_Syntax.mk_Exp_app (head, args) (Some (comp.FStar_Absyn_Syntax.res_typ)) top.FStar_Absyn_Syntax.pos)
in (let _157_599 = (FStar_Tc_Rel.conj_guard g_head g_args)
in (_157_600, comp, _157_599)))))))
end)))
end
| FStar_Absyn_Syntax.Typ_fun (bs, c) -> begin
...
in (let _54_1700 = (let _157_636 = (let _157_635 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _157_635))
in (FStar_Tc_Rel.new_tvar _157_636 vars k))
in (match (_54_1700) with
| (targ, u) -> begin
(let _54_1701 = if (FStar_Tc_Env.debug env FStar_Options.Extreme) then begin
(let _157_638 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (let _157_637 = (FStar_Absyn_Print.typ_to_string targ)
in (FStar_Util.print2 "Instantiating %s to %s" _157_638 _157_637)))
end else begin
()
end
...
in (let _157_647 = (let _157_646 = (let _157_645 = (let _157_644 = (let _157_643 = (FStar_Tc_Util.as_uvar_t u)
in (_157_643, u.FStar_Absyn_Syntax.pos))
in FStar_Util.Inl (_157_644))
in (add_implicit _157_645 g))
in (subst, (arg)::outargs, (arg)::arg_rets, comps, _157_646, fvs))
in (tc_args _157_647 rest cres args)))))
end))))
end
...
(let _157_653 = (FStar_Absyn_Print.strBvd a.FStar_Absyn_Syntax.v)
in (let _157_652 = (FStar_Absyn_Print.typ_to_string t)
...
| (t, g') -> begin
(let f = (let _157_654 = (FStar_Tc_Rel.guard_form g')
in (FStar_Tc_Util.label_guard FStar_Tc_Errors.ill_kinded_type t.FStar_Absyn_Syntax.pos _157_654))
...
in (let subst = (let _157_655 = (FStar_List.hd bs)
in (maybe_extend_subst subst _157_655 arg))
in (let _157_661 = (let _157_660 = (FStar_Tc_Rel.conj_guard g g')
in (subst, (arg)::outargs, (arg)::arg_rets, comps, _157_660, fvs))
in (tc_args _157_661 rest cres rest'))))))
end)))))
end
...
(let _157_663 = (FStar_Absyn_Print.subst_to_string subst)
in (let _157_662 = (FStar_Absyn_Print.typ_to_string x.FStar_Absyn_Syntax.sort)
...
(let _157_664 = (FStar_Absyn_Print.typ_to_string targ)
...
(let _157_666 = (FStar_Absyn_Print.exp_to_string e)
in (let _157_665 = (FStar_Absyn_Print.typ_to_string targ)
...
(let _157_669 = (FStar_Absyn_Print.tag_of_exp e)
in (let _157_668 = (FStar_Absyn_Print.exp_to_string e)
in (let _157_667 = (FStar_Absyn_Print.typ_to_string targ)
in (FStar_Util.print3 "Checking arg (%s) %s at type %s\n" _157_669 _157_668 _157_667))))
end else begin
()
end
...
(let _157_671 = (FStar_Tc_Rel.guard_to_string env g_e)
in (let _157_670 = (FStar_Tc_Rel.guard_to_string env g)
...
(let subst = (let _157_672 = (FStar_List.hd bs)
in (maybe_extend_subst subst _157_672 arg))
in (tc_args (subst, (arg)::outargs, (arg)::arg_rets, comps, g, fvs) rest cres rest'))
end else begin
if (FStar_Tc_Util.is_pure_or_ghost_effect env c.FStar_Absyn_Syntax.eff_name) then begin
(let subst = (let _157_677 = (FStar_List.hd bs)
in (maybe_extend_subst subst _157_677 arg))
...
if (let _157_682 = (FStar_List.hd bs)
in (FStar_Absyn_Syntax.is_null_binder _157_682)) then begin
(let newx = (FStar_Absyn_Util.gen_bvar_p e.FStar_Absyn_Syntax.pos c.FStar_Absyn_Syntax.res_typ)
in (let arg' = (let _157_683 = (FStar_Absyn_Util.bvar_to_exp newx)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _157_683))
...
(let _157_696 = (let _157_695 = (let _157_689 = (let _157_688 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _157_688))
in (_157_689)::arg_rets)
in (let _157_694 = (let _157_692 = (let _157_691 = (FStar_All.pipe_left (fun _157_690 -> Some (_157_690)) (FStar_Tc_Env.Binding_var ((x.FStar_Absyn_Syntax.v, targ))))
in (_157_691, c))
in (_157_692)::comps)
in (let _157_693 = (FStar_Util.set_add x fvs)
in (subst, (arg)::outargs, _157_695, _157_694, g, _157_693))))
in (tc_args _157_696 rest cres rest'))
end
end
end)))
end))))))))))
...
(let _157_700 = (let _157_699 = (let _157_698 = (let _157_697 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _157_697))
in ("Expected an expression; got a type", _157_698))
in FStar_Absyn_Syntax.Error (_157_699))
in (Prims.raise _157_700))
end
| ((FStar_Util.Inl (_54_1823), _54_1826)::_54_1821, (FStar_Util.Inr (_54_1832), _54_1835)::_54_1830) -> begin
(let _157_704 = (let _157_703 = (let _157_702 = (let _157_701 = (FStar_List.hd args)
in (FStar_Absyn_Util.range_of_arg _157_701))
in ("Expected a type; got an expression", _157_702))
in FStar_Absyn_Syntax.Error (_157_703))
in (Prims.raise _157_704))
end
| (_54_1840, []) -> begin
...
(let _157_706 = (FStar_Absyn_Syntax.mk_Exp_app_flat (head, (FStar_List.rev arg_rets)) (Some (cres.FStar_Absyn_Syntax.res_typ)) top.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Util.maybe_assume_result_eq_pure_term env _157_706 cres))
end else begin
(let _54_1853 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _157_709 = (FStar_Absyn_Print.exp_to_string head)
in (let _157_708 = (FStar_Absyn_Print.lcomp_typ_to_string cres)
in (let _157_707 = (FStar_Tc_Rel.guard_to_string env g)
in (FStar_Util.print3 "Not refining result: f=%s; cres=%s; guard=%s\n" _157_709 _157_708 _157_707))))
end else begin
()
end
in cres)
end
in (let _157_710 = (FStar_Tc_Util.refresh_comp_label env false cres)
in (_157_710, g))))))
end
| _54_1857 -> begin
(let g = (let _157_711 = (FStar_Tc_Rel.conj_guard g_head g)
in (FStar_All.pipe_right _157_711 (FStar_Tc_Rel.solve_deferred_constraints env)))
in (let _157_717 = (let _157_716 = (let _157_715 = (let _157_714 = (let _157_713 = (let _157_712 = (cres.FStar_Absyn_Syntax.comp ())
in (bs, _157_712))
in (FStar_Absyn_Syntax.mk_Typ_fun _157_713 (Some (FStar_Absyn_Syntax.ktype)) top.FStar_Absyn_Syntax.pos))
in (FStar_All.pipe_left (FStar_Absyn_Util.subst_typ subst) _157_714))
in (FStar_Absyn_Syntax.mk_Total _157_715))
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _157_716))
in (_157_717, g)))
end)
in (match (_54_1861) with
| (cres, g) -> begin
(let _54_1862 = if (FStar_Tc_Env.debug env FStar_Options.Low) then begin
(let _157_718 = (FStar_Absyn_Print.lcomp_typ_to_string cres)
...
(let _157_724 = (FStar_Tc_Normalize.exp_norm_to_string env app)
in (let _157_723 = (let _157_722 = (comp.FStar_Absyn_Syntax.comp ())
in (FStar_Absyn_Print.comp_typ_to_string _157_722))
...
| ([], arg::_54_1876) -> begin
(let rec aux = (fun norm tres -> (let tres = (let _157_729 = (FStar_Absyn_Util.compress_typ tres)
in (FStar_All.pipe_right _157_729 FStar_Absyn_Util.unrefine))
...
(let _157_730 = (FStar_Range.string_of_range tres.FStar_Absyn_Syntax.pos)
in (FStar_Util.print1 "%s: Warning: Potentially redundant explicit currying of a function type \n" _157_730))
end else begin
()
end
in (let _157_735 = (FStar_Tc_Util.lcomp_of_comp cres')
in (tc_args (subst, outargs, arg_rets, ((None, cres))::comps, g, fvs) bs _157_735 args)))
end
| _54_1891 when (not (norm)) -> begin
(let _157_736 = (whnf env tres)
in (aux true _157_736))
end
| _54_1893 -> begin
(let _157_741 = (let _157_740 = (let _157_739 = (let _157_738 = (FStar_Tc_Normalize.typ_norm_to_string env tf)
in (let _157_737 = (FStar_Absyn_Print.exp_to_string top)
in (FStar_Util.format2 "Too many arguments to function of type %s; got %s" _157_738 _157_737)))
in (_157_739, (FStar_Absyn_Syntax.argpos arg)))
in FStar_Absyn_Syntax.Error (_157_740))
in (Prims.raise _157_741))
end)))
in (aux false cres.FStar_Absyn_Syntax.res_typ))
end)
end))
in (let _157_742 = (FStar_Tc_Util.lcomp_of_comp c)
in (tc_args ([], [], [], [], FStar_Tc_Rel.trivial_guard, FStar_Absyn_Syntax.no_fvs.FStar_Absyn_Syntax.fxvs) bs _157_742 args))))
end
| _54_1895 -> begin
if (not (norm)) then begin
(let _157_743 = (whnf env tf)
in (check_function_app true _157_743))
end else begin
(let _157_746 = (let _157_745 = (let _157_744 = (FStar_Tc_Errors.expected_function_typ env tf)
in (_157_744, head.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_157_745))
in (Prims.raise _157_746))
end
end))
in (let _157_747 = (FStar_Absyn_Util.unrefine thead)
in (check_function_app false _157_747)))))
end))
end))
in (let _54_1899 = (aux ())
...
(let _157_748 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length g.FStar_Tc_Rel.implicits))
...
(let _157_753 = (FStar_Range.string_of_range e.FStar_Absyn_Syntax.pos)
in (let _157_752 = (FStar_Absyn_Print.typ_to_string c.FStar_Absyn_Syntax.res_typ)
in (let _157_751 = (let _157_750 = (FStar_Tc_Env.expected_typ env0)
in (FStar_All.pipe_right _157_750 (fun x -> (match (x) with
| None -> begin
"None"
end
| Some (t) -> begin
...
| (e, c, g') -> begin
(let _157_754 = (FStar_Tc_Rel.conj_guard g g')
in (e, c, _157_754))
end)))))
end)))
end)))))
...
in (let _157_755 = (FStar_Tc_Env.set_expected_typ env res_t)
in (_157_755, res_t)))
end)
in (match (_54_1931) with
| (env_branches, res_t) -> begin
(let guard_x = (let _157_757 = (FStar_All.pipe_left (fun _157_756 -> Some (_157_756)) e1.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.new_bvd _157_757))
...
(let _157_760 = (FStar_Tc_Rel.conj_guard g gaccum)
in (((f, c))::caccum, _157_760))
end)) t_eqns ([], FStar_Tc_Rel.trivial_guard))
in (match (_54_1945) with
| (cases, g) -> begin
(let _157_761 = (FStar_Tc_Util.bind_cases env res_t cases)
in (_157_761, g))
end))
in (match (_54_1948) with
| (c_branches, g_branches) -> begin
(let _54_1949 = if (FStar_Tc_Env.debug env FStar_Options.Extreme) then begin
(let _157_765 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _157_764 = (FStar_Absyn_Print.lcomp_typ_to_string c1)
in (let _157_763 = (FStar_Absyn_Print.lcomp_typ_to_string c_branches)
in (let _157_762 = (FStar_Tc_Rel.guard_to_string env g_branches)
in (FStar_Util.print4 "(%s) comp\n\tscrutinee: %s\n\tbranches: %s\nguard = %s\n" _157_765 _157_764 _157_763 _157_762)))))
end else begin
()
end
in (let cres = (let _157_768 = (let _157_767 = (FStar_All.pipe_left (fun _157_766 -> Some (_157_766)) (FStar_Tc_Env.Binding_var ((guard_x, c1.FStar_Absyn_Syntax.res_typ))))
in (_157_767, c_branches))
in (FStar_Tc_Util.bind env (Some (e1)) c1 _157_768))
in (let e = (let _157_775 = (w cres)
in (let _157_774 = (let _157_773 = (let _157_772 = (FStar_List.map (fun _54_1959 -> (match (_54_1959) with
| (f, _54_1954, _54_1956, _54_1958) -> begin
f
end)) t_eqns)
in (e1, _157_772))
in (FStar_Absyn_Syntax.mk_Exp_match _157_773))
in (FStar_All.pipe_left _157_775 _157_774)))
in (let _157_777 = (FStar_Absyn_Syntax.mk_Exp_ascribed (e, cres.FStar_Absyn_Syntax.res_typ, Some (cres.FStar_Absyn_Syntax.eff_name)) None e.FStar_Absyn_Syntax.pos)
in (let _157_776 = (FStar_Tc_Rel.conj_guard g1 g_branches)
in (_157_777, cres, _157_776))))))
end))))
end))
end)))
end))
...
(let _157_778 = (FStar_Tc_Env.set_expected_typ env1 t)
in (FStar_Tc_Rel.trivial_guard, _157_778))
end else begin
...
(let _157_780 = (FStar_Range.string_of_range top.FStar_Absyn_Syntax.pos)
in (let _157_779 = (FStar_Absyn_Print.typ_to_string t)
...
| (e1, c1, g1) -> begin
(let _54_2008 = (let _157_784 = (FStar_Tc_Env.set_range env t.FStar_Absyn_Syntax.pos)
in (FStar_Tc_Util.strengthen_precondition (Some ((fun _54_2005 -> (match (()) with
| () -> begin
FStar_Tc_Errors.ill_kinded_type
end)))) _157_784 e1 c1 f))
...
(let _54_2014 = (let _157_785 = (FStar_Tc_Rel.conj_guard g1 guard_f)
in (FStar_Tc_Util.check_top_level env _157_785 c1))
...
(let _157_786 = (FStar_Tc_Env.get_range env)
in (FStar_Tc_Errors.warn _157_786 FStar_Tc_Errors.top_level_effect))
end else begin
()
end
in (let _157_787 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared ((e2, FStar_Absyn_Syntax.Masked_effect))))
in (_157_787, c1)))
end
end))
end else begin
(let _54_2017 = (let _157_788 = (FStar_Tc_Rel.conj_guard g1 guard_f)
in (FStar_Tc_Util.discharge_guard env _157_788))
in (let _157_789 = (c1.FStar_Absyn_Syntax.comp ())
in (e2, _157_789)))
end
in (match (_54_2021) with
| (e2, c1) -> begin
(let _54_2026 = if env.FStar_Tc_Env.generalize then begin
(let _157_790 = (FStar_Tc_Util.generalize false env1 (((x, e1, c1))::[]))
in (FStar_All.pipe_left FStar_List.hd _157_790))
end else begin
(x, e1, c1)
end
in (match (_54_2026) with
| (_54_2023, e1, c1) -> begin
(let cres = (let _157_791 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit top.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _157_791))
in (let cres = if (FStar_Absyn_Util.is_total_comp c1) then begin
cres
end else begin
(let _157_792 = (FStar_Tc_Util.lcomp_of_comp c1)
in (FStar_Tc_Util.bind env None _157_792 (None, cres)))
end
in (let _54_2029 = (FStar_ST.op_Colon_Equals e2.FStar_Absyn_Syntax.tk (Some (FStar_Tc_Recheck.t_unit)))
in (let _157_796 = (let _157_795 = (w cres)
in (FStar_All.pipe_left _157_795 (FStar_Absyn_Syntax.mk_Exp_let ((false, ((FStar_Absyn_Syntax.mk_lb (x, (FStar_Absyn_Util.comp_effect_name c1), (FStar_Absyn_Util.comp_result c1), e1)))::[]), e2))))
in (_157_796, cres, FStar_Tc_Rel.trivial_guard)))))
end))
end))
end
| FStar_Util.Inl (bvd) -> begin
(let b = (binding_of_lb x c1.FStar_Absyn_Syntax.res_typ)
in (let _54_2037 = (let _157_797 = (FStar_Tc_Env.push_local_binding env b)
in (tc_exp _157_797 e2))
in (match (_54_2037) with
| (e2, c2, g2) -> begin
(let cres = (FStar_Tc_Util.bind env (Some (e1)) c1 (Some (b), c2))
in (let e = (let _157_800 = (w cres)
in (FStar_All.pipe_left _157_800 (FStar_Absyn_Syntax.mk_Exp_let ((false, ((FStar_Absyn_Syntax.mk_lb (x, c1.FStar_Absyn_Syntax.eff_name, c1.FStar_Absyn_Syntax.res_typ, e1)))::[]), e2))))
in (let g2 = (let _157_806 = (let _157_805 = (let _157_804 = (let _157_803 = (let _157_802 = (FStar_Absyn_Util.bvd_to_exp bvd c1.FStar_Absyn_Syntax.res_typ)
in (FStar_Absyn_Util.mk_eq c1.FStar_Absyn_Syntax.res_typ c1.FStar_Absyn_Syntax.res_typ _157_802 e1))
in (FStar_All.pipe_left (fun _157_801 -> FStar_Tc_Rel.NonTrivial (_157_801)) _157_803))
in (FStar_Tc_Rel.guard_of_guard_formula _157_804))
in (FStar_Tc_Rel.imp_guard _157_805 g2))
in (FStar_All.pipe_left (FStar_Tc_Rel.close_guard (((FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s bvd c1.FStar_Absyn_Syntax.res_typ)))::[])) _157_806))
in (let guard = (let _157_807 = (FStar_Tc_Rel.conj_guard g1 g2)
in (FStar_Tc_Rel.conj_guard guard_f _157_807))
in (match (topt) with
| None -> begin
...
in (let _54_2046 = (let _157_808 = (FStar_Tc_Rel.teq env tres t)
in (FStar_All.pipe_left (FStar_Tc_Rel.try_discharge_guard env) _157_808))
in (e, cres, guard)))
end else begin
(e, cres, guard)
end))
...
(let _157_812 = (tc_typ_check_trivial (let _54_2097 = env0
...
in (FStar_All.pipe_right _157_812 (norm_t env)))
end
...
| (lbs, env') -> begin
(let _54_2120 = (let _157_818 = (let _157_817 = (FStar_All.pipe_right lbs FStar_List.rev)
in (FStar_All.pipe_right _157_817 (FStar_List.map (fun _54_2109 -> (match (_54_2109) with
| (x, t, e) -> begin
...
(let _157_816 = (FStar_Absyn_Print.lbname_to_string x)
in (let _157_815 = (FStar_Absyn_Print.exp_to_string e)
in (let _157_814 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.print3 "Checking %s = %s against type %s\n" _157_816 _157_815 _157_814))))
end else begin
()
end
...
in (FStar_All.pipe_right _157_818 FStar_List.unzip))
...
(let _157_820 = (FStar_List.map (fun _54_2125 -> (match (_54_2125) with
| (x, t, e) -> begin
...
in (let ecs = (let _157_823 = (FStar_All.pipe_right lbs (FStar_List.map (fun _54_2131 -> (match (_54_2131) with
| (x, t, e) -> begin
(let _157_822 = (FStar_All.pipe_left (FStar_Absyn_Util.total_comp t) (FStar_Absyn_Util.range_of_lb (x, t, e)))
in (x, e, _157_822))
end))))
in (FStar_Tc_Util.generalize true env _157_823))
in (let _157_825 = (FStar_List.map (fun _54_2136 -> (match (_54_2136) with
| (x, e, c) -> begin
(FStar_Absyn_Syntax.mk_lb (x, FStar_Absyn_Const.effect_Tot_lid, (FStar_Absyn_Util.comp_result c), e))
end)) ecs)
in (_157_825, FStar_Tc_Rel.trivial_guard))))
end
in (match (_54_2139) with
| (lbs, g_lbs) -> begin
if (not (is_inner_let)) then begin
(let cres = (let _157_826 = (FStar_Absyn_Util.total_comp FStar_Tc_Recheck.t_unit top.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left FStar_Tc_Util.lcomp_of_comp _157_826))
...
in (let _157_830 = (let _157_829 = (w cres)
in (FStar_All.pipe_left _157_829 (FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))))
in (_157_830, cres, FStar_Tc_Rel.trivial_guard)))))
end else begin
...
in (let e = (let _157_835 = (w cres)
in (FStar_All.pipe_left _157_835 (FStar_Absyn_Syntax.mk_Exp_let ((true, lbs), e1))))
in (match (topt) with
| Some (_54_2172) -> begin
(e, cres, guard)
end
...
(let t' = (FStar_Tc_Util.new_tvar env0 FStar_Absyn_Syntax.ktype)
in (let _54_2207 = (let _157_837 = (FStar_Tc_Rel.teq env tres t')
in (FStar_All.pipe_left (FStar_Tc_Rel.try_discharge_guard env) _157_837))
in (e, cres, guard)))
end
| _54_2210 -> begin
(e, cres, guard)
...
and tc_eqn : FStar_Absyn_Syntax.bvvdef  ->  FStar_Absyn_Syntax.typ  ->  FStar_Tc_Env.env  ->  (FStar_Absyn_Syntax.pat * FStar_Absyn_Syntax.exp Prims.option * FStar_Absyn_Syntax.exp)  ->  ((FStar_Absyn_Syntax.pat * FStar_Absyn_Syntax.exp Prims.option * FStar_Absyn_Syntax.exp) * FStar_Absyn_Syntax.typ * FStar_Absyn_Syntax.lcomp * FStar_Tc_Rel.guard_t) = (fun scrutinee_x pat_t env _54_2217 -> (match (_54_2217) with
...
(let _157_850 = (FStar_Absyn_Print.strBvd x)
in (let _157_849 = (FStar_Tc_Normalize.typ_norm_to_string env t)
...
(let _157_853 = (FStar_Absyn_Print.exp_to_string e)
in (let _157_852 = (FStar_Absyn_Print.typ_to_string pat_t)
...
(let _157_855 = (FStar_Tc_Normalize.exp_norm_to_string env e)
in (let _157_854 = (FStar_Tc_Normalize.typ_norm_to_string env lc.FStar_Absyn_Syntax.res_typ)
...
in (let _54_2255 = (let _157_856 = (FStar_Tc_Rel.solve_deferred_constraints env g)
in (FStar_All.pipe_left Prims.ignore _157_856))
in (let e' = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env e)
in (let _54_2258 = if (let _157_859 = (let _157_858 = (FStar_Absyn_Util.uvars_in_exp e')
in (let _157_857 = (FStar_Absyn_Util.uvars_in_typ expected_pat_t)
in (FStar_Absyn_Util.uvars_included_in _157_858 _157_857)))
in (FStar_All.pipe_left Prims.op_Negation _157_859)) then begin
(let _157_864 = (let _157_863 = (let _157_862 = (let _157_861 = (FStar_Absyn_Print.exp_to_string e')
in (let _157_860 = (FStar_Absyn_Print.typ_to_string expected_pat_t)
in (FStar_Util.format2 "Implicit pattern variables in %s could not be resolved against expected type %s; please bind them explicitly" _157_861 _157_860)))
in (_157_862, p.FStar_Absyn_Syntax.p))
in FStar_Absyn_Syntax.Error (_157_863))
in (Prims.raise _157_864))
end else begin
()
end
in (let _54_2260 = if (FStar_Tc_Env.debug env FStar_Options.High) then begin
(let _157_865 = (FStar_Tc_Normalize.exp_norm_to_string env e)
...
| FStar_Tc_Env.Binding_var (x, t) -> begin
(let _157_868 = (FStar_Absyn_Print.strBvd x)
in (let _157_867 = (FStar_Absyn_Print.typ_to_string t)
...
(let _54_2285 = (let _157_869 = (FStar_Tc_Env.set_expected_typ pat_env FStar_Tc_Recheck.t_bool)
in (tc_exp _157_869 e))
...
| Some (w) -> begin
(let _157_871 = (FStar_Absyn_Util.mk_eq FStar_Absyn_Util.t_bool FStar_Absyn_Util.t_bool w FStar_Absyn_Const.exp_true_bool)
in (FStar_All.pipe_left (fun _157_870 -> Some (_157_870)) _157_871))
end)
...
in (let _54_2301 = (let _157_872 = (FStar_Tc_Env.push_local_binding env (FStar_Tc_Env.Binding_var ((scrutinee_x, pat_t))))
in (FStar_All.pipe_right _157_872 FStar_Tc_Env.clear_expected_typ))
...
| _54_2315 -> begin
(let clause = (let _157_876 = (FStar_Tc_Recheck.recompute_typ scrutinee)
in (let _157_875 = (FStar_Tc_Recheck.recompute_typ e)
in (FStar_Absyn_Util.mk_eq _157_876 _157_875 scrutinee e)))
in (match (fopt) with
| None -> begin
Some (clause)
end
| Some (f) -> begin
(let _157_878 = (FStar_Absyn_Util.mk_disj clause f)
in (FStar_All.pipe_left (fun _157_877 -> Some (_157_877)) _157_878))
end))
end))) None))
...
| (Some (f), Some (w)) -> begin
(let _157_881 = (let _157_880 = (FStar_Absyn_Util.mk_conj f w)
in (FStar_All.pipe_left (fun _157_879 -> FStar_Tc_Rel.NonTrivial (_157_879)) _157_880))
in (FStar_Tc_Util.weaken_precondition env c _157_881))
end
| (None, Some (w)) -> begin
(FStar_Tc_Util.weaken_precondition env c (FStar_Tc_Rel.NonTrivial (w)))
end)
in (FStar_Tc_Util.close_comp env bindings c)))
in (let discriminate = (fun scrutinee f -> (let disc = (let _157_887 = (let _157_886 = (FStar_Absyn_Util.mk_discriminator f.FStar_Absyn_Syntax.v)
in (FStar_Absyn_Util.fvar None _157_886))
in (FStar_All.pipe_left _157_887 (FStar_Ident.range_of_lid f.FStar_Absyn_Syntax.v)))
in (let disc = (let _157_890 = (let _157_889 = (let _157_888 = (FStar_All.pipe_left FStar_Absyn_Syntax.varg scrutinee)
in (_157_888)::[])
in (disc, _157_889))
in (FStar_Absyn_Syntax.mk_Exp_app _157_890 None scrutinee.FStar_Absyn_Syntax.pos))
...
in (let sub_term_guards = (let _157_900 = (FStar_All.pipe_right args (FStar_List.mapi (fun i arg -> (match ((Prims.fst arg)) with
...
in (let sub_term = (let _157_898 = (let _157_897 = (FStar_Absyn_Util.fvar None projector f.FStar_Absyn_Syntax.p)
in (_157_897, ((FStar_Absyn_Syntax.varg scrutinee))::[]))
in (FStar_Absyn_Syntax.mk_Exp_app _157_898 None f.FStar_Absyn_Syntax.p))
in (let _157_899 = (mk_guard sub_term ei)
in (_157_899)::[])))
end))))
in (FStar_All.pipe_right _157_900 FStar_List.flatten))
in (FStar_Absyn_Util.mk_conj_l ((head)::sub_term_guards))))
end
| _54_2409 -> begin
(let _157_903 = (let _157_902 = (FStar_Range.string_of_range pat_exp.FStar_Absyn_Syntax.pos)
in (let _157_901 = (FStar_Absyn_Print.exp_to_string pat_exp)
in (FStar_Util.format2 "tc_eqn: Impossible (%s) %s" _157_902 _157_901)))
in (FStar_All.failwith _157_903))
end)))
...
in (let path_guard = (let _157_912 = (FStar_All.pipe_right disj_exps (FStar_List.map (fun e -> (let _157_911 = (FStar_Tc_Normalize.norm_exp ((FStar_Tc_Normalize.Beta)::[]) env e)
in (mk_guard scrutinee pat_t _157_911)))))
in (FStar_All.pipe_right _157_912 FStar_Absyn_Util.mk_disj_l))
...
in (let guard = (let _157_913 = (FStar_Tc_Rel.conj_guard g_when g_branch)
in (FStar_Tc_Rel.conj_guard g_pat _157_913))
in (let _54_2426 = if (FStar_Tc_Env.debug env FStar_Options.High) then begin
(let _157_914 = (FStar_Tc_Rel.guard_to_string env guard)
in (FStar_All.pipe_left (FStar_Util.print1 "Carrying guard from match: %s\n") _157_914))
end else begin
()
end
in (let _157_916 = (let _157_915 = (FStar_Tc_Rel.conj_guard g_when g_branch)
in (FStar_Tc_Rel.conj_guard g_pat _157_915))
in ((pattern, when_clause, branch), path_guard, c, _157_916))))))))))
end)))
end)))
end))
end)))
end))
and tc_kind_trivial : FStar_Tc_Env.env  ->  (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.knd = (fun env k -> (let _54_2432 = (tc_kind env k)
in (match (_54_2432) with
| (k, g) -> begin
(let _54_2433 = (FStar_Tc_Util.discharge_guard env g)
in k)
end)))
and tc_typ_trivial : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.typ  ->  (FStar_Absyn_Syntax.typ * FStar_Absyn_Syntax.knd) = (fun env t -> (let _54_2440 = (tc_typ env t)
in (match (_54_2440) with
| (t, k, g) -> begin
(let _54_2441 = (FStar_Tc_Util.discharge_guard env g)
in (t, k))
end)))
and tc_typ_check_trivial : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.typ = (fun env t k -> (let _54_2448 = (tc_typ_check env t k)
in (match (_54_2448) with
| (t, f) -> begin
(let _54_2449 = (FStar_Tc_Util.discharge_guard env f)
in t)
end)))
and tc_total_exp : FStar_Tc_Env.env  ->  (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  (FStar_Absyn_Syntax.exp * FStar_Absyn_Syntax.typ * FStar_Tc_Rel.guard_t) = (fun env e -> (let _54_2456 = (tc_exp env e)
...
in (let c = (let _157_926 = (c.FStar_Absyn_Syntax.comp ())
in (FStar_All.pipe_right _157_926 (norm_c env)))
in (match ((let _157_928 = (let _157_927 = (FStar_Tc_Env.get_range env)
in (FStar_Absyn_Util.total_comp (FStar_Absyn_Util.comp_result c) _157_927))
in (FStar_Tc_Rel.sub_comp env c _157_928))) with
| Some (g') -> begin
(let _157_929 = (FStar_Tc_Rel.conj_guard g g')
in (e, (FStar_Absyn_Util.comp_result c), _157_929))
end
| _54_2462 -> begin
(let _157_932 = (let _157_931 = (let _157_930 = (FStar_Tc_Errors.expected_pure_expression e c)
in (_157_930, e.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_157_931))
in (Prims.raise _157_932))
end)))
end
end)))
and tc_ghost_exp : FStar_Tc_Env.env  ->  (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  (FStar_Absyn_Syntax.exp * FStar_Absyn_Syntax.typ * FStar_Tc_Rel.guard_t) = (fun env e -> (let _54_2468 = (tc_exp env e)
in (match (_54_2468) with
| (e, c, g) -> begin
if (FStar_Absyn_Util.is_total_lcomp c) then begin
(e, c.FStar_Absyn_Syntax.res_typ, g)
end else begin
(let c = (let _157_935 = (c.FStar_Absyn_Syntax.comp ())
in (FStar_All.pipe_right _157_935 (norm_c env)))
...
| Some (g') -> begin
(let _157_936 = (FStar_Tc_Rel.conj_guard g g')
in (e, (FStar_Absyn_Util.comp_result c), _157_936))
end
| _54_2477 -> begin
(let _157_939 = (let _157_938 = (let _157_937 = (FStar_Tc_Errors.expected_ghost_expression e c)
in (_157_937, e.FStar_Absyn_Syntax.pos))
in FStar_Absyn_Syntax.Error (_157_938))
in (Prims.raise _157_939))
end))))
end
end)))

let tc_tparams : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.binders  ->  (FStar_Absyn_Syntax.binders * FStar_Tc_Env.env) = (fun env tps -> (let _54_2483 = (tc_binders env tps)
...
| _54_2511 -> begin
(let _157_952 = (let _157_951 = (let _157_950 = (FStar_Tc_Errors.unexpected_signature_for_monad env m s)
in (_157_950, (FStar_Ident.range_of_lid m)))
in FStar_Absyn_Syntax.Error (_157_951))
in (Prims.raise _157_952))
end))

let rec tc_eff_decl : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.eff_decl  ->  FStar_Absyn_Syntax.eff_decl = (fun env m -> (let _54_2517 = (tc_binders env m.FStar_Absyn_Syntax.binders)
...
in (let _157_974 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.ret expected_k)
in (FStar_All.pipe_right _157_974 (norm_t env))))
...
in (let _157_976 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.bind_wp expected_k)
in (FStar_All.pipe_right _157_976 (norm_t env))))
...
in (let _157_978 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.bind_wlp expected_k)
in (FStar_All.pipe_right _157_978 (norm_t env))))
...
in (let _157_980 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.if_then_else expected_k)
in (FStar_All.pipe_right _157_980 (norm_t env))))
...
in (let _157_982 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.ite_wp expected_k)
in (FStar_All.pipe_right _157_982 (norm_t env))))
...
in (let _157_984 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.ite_wlp expected_k)
in (FStar_All.pipe_right _157_984 (norm_t env))))
in (let wp_binop = (let expected_k = (let _157_992 = (let _157_991 = (let _157_990 = (let _157_989 = (let _157_988 = (let _157_987 = (let _157_986 = (FStar_Absyn_Const.kbin FStar_Absyn_Syntax.ktype FStar_Absyn_Syntax.ktype FStar_Absyn_Syntax.ktype)
in (FStar_Absyn_Syntax.null_t_binder _157_986))
in (_157_987)::((FStar_Absyn_Syntax.null_t_binder kwp_a))::[])
in ((FStar_Absyn_Syntax.null_t_binder kwp_a))::_157_988)
in ((FStar_Absyn_Syntax.t_binder a))::_157_989)
in (_157_990, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _157_991))
in (FStar_All.pipe_left w _157_992))
in (let _157_993 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.wp_binop expected_k)
in (FStar_All.pipe_right _157_993 (norm_t env))))
...
in (let _157_995 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.wp_as_type expected_k)
in (FStar_All.pipe_right _157_995 (norm_t env))))
...
in (let _157_997 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.close_wp expected_k)
in (FStar_All.pipe_right _157_997 (norm_t env))))
in (let close_wp_t = (let expected_k = (let _157_1005 = (let _157_1004 = (let _157_1003 = (let _157_1002 = (let _157_1001 = (let _157_1000 = (FStar_All.pipe_left w (FStar_Absyn_Syntax.mk_Kind_arrow (((FStar_Absyn_Syntax.null_t_binder FStar_Absyn_Syntax.ktype))::[], kwp_a)))
in (FStar_Absyn_Syntax.null_t_binder _157_1000))
in (_157_1001)::[])
in ((FStar_Absyn_Syntax.t_binder a))::_157_1002)
in (_157_1003, kwp_a))
in (FStar_Absyn_Syntax.mk_Kind_arrow _157_1004))
in (FStar_All.pipe_left w _157_1005))
in (let _157_1006 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.close_wp_t expected_k)
in (FStar_All.pipe_right _157_1006 (norm_t env))))
...
in (let _157_1011 = (let _157_1008 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.assert_p expected_k)
in (FStar_All.pipe_right _157_1008 (norm_t env)))
in (let _157_1010 = (let _157_1009 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.assume_p expected_k)
in (FStar_All.pipe_right _157_1009 (norm_t env)))
in (_157_1011, _157_1010))))
...
in (let _157_1013 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.null_wp expected_k)
in (FStar_All.pipe_right _157_1013 (norm_t env))))
...
in (let _157_1015 = (tc_typ_check_trivial env m.FStar_Absyn_Syntax.trivial expected_k)
in (FStar_All.pipe_right _157_1015 (norm_t env))))
...
in (let _54_2578 = (let _157_1019 = (FStar_Options.reset_options ())
in (FStar_All.pipe_right _157_1019 Prims.ignore))
in (se, env)))
end)
end
...
(let _54_2593 = (let _157_1020 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.source)
in (a_kwp_a env sub.FStar_Absyn_Syntax.source _157_1020))
in (match (_54_2593) with
| (a, kwp_a_src) -> begin
(let _54_2596 = (let _157_1021 = (FStar_Tc_Env.lookup_effect_lid env sub.FStar_Absyn_Syntax.target)
in (a_kwp_a env sub.FStar_Absyn_Syntax.target _157_1021))
in (match (_54_2596) with
| (b, kwp_b_tgt) -> begin
(let kwp_a_tgt = (let _157_1025 = (let _157_1024 = (let _157_1023 = (let _157_1022 = (FStar_Absyn_Util.btvar_to_typ a)
in (b.FStar_Absyn_Syntax.v, _157_1022))
in FStar_Util.Inl (_157_1023))
in (_157_1024)::[])
in (FStar_Absyn_Util.subst_kind _157_1025 kwp_b_tgt))
...
(let _157_1028 = (FStar_Absyn_Print.sli lid)
in (let _157_1027 = (let _157_1026 = (FStar_Absyn_Util.close_kind tps k)
in (FStar_Absyn_Print.kind_to_string _157_1026))
...
(let _157_1029 = (FStar_Tc_Rel.keq env None k FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env) _157_1029))
end
| _54_2639 -> begin
()
end)
...
in (let _157_1032 = (FStar_All.pipe_right c'.FStar_Absyn_Syntax.effect_name (fun _157_1031 -> Some (_157_1031)))
in FStar_Absyn_Syntax.DefaultEffect (_157_1032)))
end
| t -> begin
t
end))))
...
| (tps, env') -> begin
(let _54_2697 = (let _157_1036 = (tc_typ_trivial env' t)
in (FStar_All.pipe_right _157_1036 (fun _54_2694 -> (match (_54_2694) with
| (t, k) -> begin
(let _157_1035 = (norm_t env' t)
in (let _157_1034 = (norm_k env' k)
in (_157_1035, _157_1034)))
end))))
...
| _54_2700 -> begin
(let k2 = (let _157_1037 = (tc_kind_trivial env' k)
in (FStar_All.pipe_right _157_1037 (norm_k env)))
in (let _54_2702 = (let _157_1038 = (FStar_Tc_Rel.keq env' (Some (t)) k1 k2)
in (FStar_All.pipe_left (FStar_Tc_Util.force_trivial env') _157_1038))
in k2))
end)
...
in (FStar_Absyn_Visit.collect_from_typ (fun b t -> (match ((let _157_1046 = (FStar_Absyn_Util.compress_typ t)
in _157_1046.FStar_Absyn_Syntax.n)) with
...
| Some (tname) -> begin
(let _157_1050 = (let _157_1049 = (let _157_1048 = (let _157_1047 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (FStar_Tc_Errors.constructor_fails_the_positivity_check env _157_1047 tname))
in (_157_1048, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_157_1049))
...
(let _157_1051 = (FStar_Tc_Errors.cardinality_constraint_violated lid a)
in (FStar_Tc_Errors.warn r _157_1051))
end else begin
if (FStar_Options.check_cardinality ()) then begin
(let _157_1054 = (let _157_1053 = (let _157_1052 = (FStar_Tc_Errors.cardinality_constraint_violated lid a)
in (_157_1052, r))
in FStar_Absyn_Syntax.Error (_157_1053))
in (Prims.raise _157_1054))
end else begin
()
end
end
...
(let _54_2780 = (let _157_1055 = (FStar_Absyn_Util.function_formals t)
in (FStar_All.pipe_right _157_1055 FStar_Util.must))
...
| Some (args) -> begin
if (not ((((FStar_List.length args) >= (FStar_List.length tps)) && (let _157_1059 = (let _157_1058 = (FStar_Util.first_N (FStar_List.length tps) args)
in (FStar_All.pipe_right _157_1058 Prims.fst))
...
(let _157_1060 = (FStar_Absyn_Util.ftv tname FStar_Absyn_Syntax.kun)
in (FStar_Absyn_Util.mk_typ_app _157_1060 expected_args))
end))
end)
in (let _157_1064 = (let _157_1063 = (let _157_1062 = (let _157_1061 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (FStar_Tc_Errors.constructor_builds_the_wrong_type env _157_1061 result_t expected_t))
in (_157_1062, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_157_1063))
in (Prims.raise _157_1064)))
end else begin
()
end
end
| _54_2834 -> begin
(let _157_1069 = (let _157_1068 = (let _157_1067 = (let _157_1066 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) lid (FStar_Ident.range_of_lid lid))
in (let _157_1065 = (FStar_Absyn_Util.ftv tname FStar_Absyn_Syntax.kun)
in (FStar_Tc_Errors.constructor_builds_the_wrong_type env _157_1066 result_t _157_1065)))
in (_157_1067, (FStar_Ident.range_of_lid lid)))
in FStar_Absyn_Syntax.Error (_157_1068))
...
(let _157_1071 = (let _157_1070 = (FStar_Tc_Normalize.typ_norm_to_string env t)
in (FStar_Util.format2 "data %s : %s\n" lid.FStar_Ident.str _157_1070))
in (FStar_All.pipe_left FStar_Util.print_string _157_1071))
end else begin
()
end
in (se, env)))))))
...
(let env = (FStar_Tc_Env.set_range env r)
in (let t = (let _157_1072 = (tc_typ_check_trivial env t FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _157_1072 (FStar_Tc_Normalize.norm_typ ((FStar_Tc_Normalize.Beta)::(FStar_Tc_Normalize.SNComp)::[]) env)))
...
(let _157_1074 = (let _157_1073 = (FStar_Tc_Normalize.typ_norm_to_string env t)
in (FStar_Util.format2 "val %s : %s\n" lid.FStar_Ident.str _157_1073))
in (FStar_All.pipe_left FStar_Util.print_string _157_1074))
end else begin
()
end
in (se, env)))))))
...
(let env = (FStar_Tc_Env.set_range env r)
in (let phi = (let _157_1075 = (tc_typ_check_trivial env phi FStar_Absyn_Syntax.ktype)
in (FStar_All.pipe_right _157_1075 (norm_t env)))
...
(let _157_1078 = (FStar_Absyn_Print.typ_to_string t')
in (FStar_Util.print2 "Using annotation %s for let binding %s\n" _157_1078 l.FStar_Ident.str))
end else begin
()
end
in (match (t.FStar_Absyn_Syntax.n) with
...
(let _157_1080 = (let _157_1079 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "%s: Warning: Annotation from val declaration overrides inline type annotation\n" _157_1079))
in (FStar_All.pipe_left FStar_Util.print_string _157_1080))
end else begin
()
end
...
in (let e = (let _157_1085 = (let _157_1084 = (let _157_1083 = (syn' env FStar_Tc_Recheck.t_unit)
in (FStar_All.pipe_left _157_1083 (FStar_Absyn_Syntax.mk_Exp_constant FStar_Const.Const_unit)))
in (((Prims.fst lbs), lbs'), _157_1084))
in (FStar_Absyn_Syntax.mk_Exp_let _157_1085 None r))
...
(let _157_1091 = (let _157_1090 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let should_log = (match ((let _157_1087 = (FStar_Util.right lb.FStar_Absyn_Syntax.lbname)
in (FStar_Tc_Env.try_lookup_val_decl env _157_1087))) with
| None -> begin
true
end
| _54_2955 -> begin
...
(let _157_1089 = (FStar_Absyn_Print.lbname_to_string lb.FStar_Absyn_Syntax.lbname)
in (let _157_1088 = (FStar_Tc_Normalize.typ_norm_to_string env lb.FStar_Absyn_Syntax.lbtyp)
in (FStar_Util.format2 "let %s : %s" _157_1089 _157_1088)))
end else begin
""
end))))
in (FStar_All.pipe_right _157_1090 (FStar_String.concat "\n")))
...
in (let _54_2975 = (let _157_1095 = (let _157_1092 = (FStar_Absyn_Util.ml_comp FStar_Tc_Recheck.t_unit r)
in Some (_157_1092))
in (let _157_1094 = (let _157_1093 = (c.FStar_Absyn_Syntax.comp ())
in (e, _157_1093))
in (check_expected_effect env _157_1095 _157_1094)))
in (match (_54_2975) with
| (e, _54_2973, g) -> begin
(let _54_2976 = (let _157_1096 = (FStar_Tc_Rel.conj_guard g1 g)
in (FStar_Tc_Util.discharge_guard env _157_1096))
...
(let k = (match (k.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_unknown -> begin
(let _157_1100 = (FStar_Tc_Rel.new_kvar r tps)
in (FStar_All.pipe_right _157_1100 Prims.fst))
end
| _54_3016 -> begin
k
end)
...
(let _157_1101 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (FStar_Util.format1 "Recursive bindings: %s" _157_1101))
end else begin
""
end
...
(let tt = (let _157_1104 = (FStar_Absyn_Syntax.mk_Typ_ascribed (t, k) t.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Util.close_with_lam tps _157_1104))
...
| (tps, t) -> begin
(let _157_1106 = (let _157_1105 = (FStar_Absyn_Util.compress_kind k)
in (lid, tps, _157_1105, t, [], r))
in FStar_Absyn_Syntax.Sig_typ_abbrev (_157_1106))
end))
end)))
end
| _54_3072 -> begin
(let _157_1108 = (let _157_1107 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "(%s) Impossible" _157_1107))
in (FStar_All.failwith _157_1108))
...
in (let _54_3090 = (let _157_1119 = (FStar_Absyn_Print.sigelt_to_string_short se)
in (FStar_Util.print2 "Time %ss : %s\n" (FStar_Util.string_of_float diff) _157_1119))
in res))))))
...
(let _157_1123 = (let _157_1122 = (FStar_Absyn_Print.sigelt_to_string se)
in (FStar_Util.format1 "Checking sigelt\t%s\n" _157_1122))
in (FStar_Util.print_string _157_1123))
end else begin
()
end
...
| (ses, all_non_private, env) -> begin
(let _157_1124 = (FStar_All.pipe_right (FStar_List.rev all_non_private) FStar_List.flatten)
in ((FStar_List.rev ses), _157_1124, env))
end))))
...
if (FStar_All.pipe_right lbs (FStar_Util.for_some (fun x -> (let _157_1134 = (is_priv x)
in (FStar_All.pipe_right _157_1134 Prims.op_Negation))))) then begin
...
in (let _54_3216 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.partition (fun lb -> ((FStar_Absyn_Util.is_pure_or_ghost_function lb.FStar_Absyn_Syntax.lbtyp) && (let _157_1136 = (FStar_Absyn_Util.is_lemma lb.FStar_Absyn_Syntax.lbtyp)
in (FStar_All.pipe_left Prims.op_Negation _157_1136))))))
...
let get_exports : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.modul  ->  FStar_Absyn_Syntax.sigelt Prims.list  ->  FStar_Absyn_Syntax.sigelt Prims.list = (fun env modul non_private_decls -> (let assume_vals = (fun decls -> (FStar_All.pipe_right decls (FStar_List.map (fun _54_18 -> (match (_54_18) with
| FStar_Absyn_Syntax.Sig_val_decl (lid, t, quals, r) -> begin
...
(let exports = (let _157_1149 = (FStar_Tc_Env.modules env)
in (FStar_Util.find_map _157_1149 (fun m -> if (m.FStar_Absyn_Syntax.is_interface && (FStar_Absyn_Syntax.lid_equals modul.FStar_Absyn_Syntax.name m.FStar_Absyn_Syntax.name)) then begin
(let _157_1148 = (FStar_All.pipe_right m.FStar_Absyn_Syntax.exports assume_vals)
in Some (_157_1148))
end else begin
None
end)))
...
let tc_more_partial_modul : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.modul  ->  FStar_Absyn_Syntax.sigelt Prims.list  ->  (FStar_Absyn_Syntax.modul * FStar_Absyn_Syntax.sigelt Prims.list * FStar_Tc_Env.env) = (fun env modul decls -> (let _54_3291 = (tc_decls true env decls false)
...
in (let _54_3305 = if ((not (modul.FStar_Absyn_Syntax.is_interface)) || (let _157_1167 = (FStar_ST.read FStar_Options.admit_fsi)
in (FStar_List.contains modul.FStar_Absyn_Syntax.name.FStar_Ident.str _157_1167))) then begin
(env.FStar_Tc_Env.solver.FStar_Tc_Env.encode_modul env modul)
end else begin
()
end
in (let _54_3307 = (env.FStar_Tc_Env.solver.FStar_Tc_Env.refresh ())
in (let _157_1168 = (FStar_Options.reset_options ())
in (FStar_All.pipe_right _157_1168 Prims.ignore)))))
end else begin
()
end
in (modul, env))))))

let tc_modul : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.modul  ->  (FStar_Absyn_Syntax.modul * FStar_Tc_Env.env) = (fun env modul -> (let _54_3316 = (tc_partial_modul env modul)
...
in (let _157_1181 = (FStar_List.fold_left do_sigelt en m.FStar_Absyn_Syntax.exports)
in (FStar_Tc_Env.finish_module _157_1181 m)))))

let check_module : FStar_Tc_Env.env  ->  FStar_Absyn_Syntax.modul  ->  (FStar_Absyn_Syntax.modul Prims.list * FStar_Tc_Env.env) = (fun env m -> (let _54_3328 = if ((let _157_1186 = (FStar_ST.read FStar_Options.debug)
in (FStar_List.length _157_1186)) <> 0) then begin
(let _157_1187 = (FStar_Absyn_Print.sli m.FStar_Absyn_Syntax.name)
...
(let c_file_name = (let _157_1192 = (let _157_1191 = (let _157_1190 = (let _157_1189 = (let _157_1188 = (FStar_Options.get_fstar_home ())
in (Prims.strcat _157_1188 "/"))
in (Prims.strcat _157_1189 FStar_Options.cache_dir))
in (Prims.strcat _157_1190 "/"))
in (Prims.strcat _157_1191 (FStar_Ident.text_of_lid m.FStar_Absyn_Syntax.name)))
in (Prims.strcat _157_1192 ".cache"))
...
in (let _157_1193 = (FStar_Util.get_owriter c_file_name)
in (FStar_Absyn_SSyntax.serialize_modul _157_1193 m))))
end else begin
()
end
in (m, env))
...
(let _157_1194 = (FStar_Absyn_Print.modul_to_string m)
in (FStar_Util.print1 "%s\n" _157_1194))
end else begin
()
end
