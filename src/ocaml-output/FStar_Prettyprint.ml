...
let uu____91 = (temp_file_name filename)
in (FStar_Util.open_file_for_writing uu____91))
in FStar_Pervasives_Native.Some (uu____90))
in ((filename), (uu____87)))
end
| FromTempToFile -> begin
(

let uu____96 = (temp_file_name filename)
in (

let uu____98 = (

let uu____101 = (FStar_Util.open_file_for_writing filename)
in FStar_Pervasives_Native.Some (uu____101))
in ((uu____96), (uu____98))))
end
| FromTempToStdout -> begin
(

let uu____105 = (temp_file_name filename)
in ((uu____105), (FStar_Pervasives_Native.None)))
end)
in (match (uu____72) with
| (inf, outf) -> begin
(

let uu____118 = (FStar_Parser_Driver.parse_file inf)
...
let uu____167 = (FStar_Parser_ToDocument.modul_with_comments_to_document modul comments1)
...
let uu____204 = (FStar_Pprint.pretty_string (FStar_Util.float_of_string "1.0") (Prims.parse_int "100") doc1)
in (FStar_All.pipe_left (FStar_Util.append_to_file f) uu____204))
end
...
let uu____227 = (FStar_Parser_ToDocument.comments_to_document leftover_comments)
in (uu____227)::[])
in (FStar_Pprint.hardline)::uu____224)
in (FStar_Pprint.hardline)::uu____221)
in (FStar_Pprint.concat uu____218))
end
| uu____228 -> begin
...
let uu____235 = (FStar_Pprint.pretty_string (FStar_Util.float_of_string "1.0") (Prims.parse_int "100") left_over_doc)
in (FStar_All.pipe_left (FStar_Util.append_to_file f) uu____235));
...
let uu____249 = (temp_file_name f)
in (FStar_Util.delete_file uu____249))) filenames)
end
| FromTempToStdout -> begin
(FStar_List.iter (fun f -> (

let uu____256 = (temp_file_name f)
in (FStar_Util.delete_file uu____256))) filenames)
end
| ToTempFile -> begin
()
end);
