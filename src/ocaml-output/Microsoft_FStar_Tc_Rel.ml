...
in (let _106_11 = (let _106_10 = (let _106_9 = (Microsoft_FStar_Absyn_Util.args_of_non_null_binders binders)
in (u, _106_9))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_uvar _106_10 r))
in (_106_11, u)))))

let new_tvar = (fun ( r ) ( binders ) ( k ) -> (let wf = (fun ( t ) ( tk ) -> true)
in (let binders = (Support.All.pipe_right binders (Support.List.filter (fun ( x ) -> (let _106_23 = (Microsoft_FStar_Absyn_Syntax.is_null_binder x)
in (Support.All.pipe_right _106_23 Support.Prims.op_Negation)))))
...
in (let _106_24 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_app (uv, args) None r)
in (_106_24, uv)))))
end)))))

let new_evar = (fun ( r ) ( binders ) ( t ) -> (let wf = (fun ( e ) ( t ) -> true)
in (let binders = (Support.All.pipe_right binders (Support.List.filter (fun ( x ) -> (let _106_36 = (Microsoft_FStar_Absyn_Syntax.is_null_binder x)
in (Support.All.pipe_right _106_36 Support.Prims.op_Negation)))))
in (let uv = (Support.Microsoft.FStar.Unionfind.fresh Microsoft_FStar_Absyn_Syntax.Uvar)
in (match (binders) with
| [] -> begin
...
| _35_69 -> begin
(let args = (Microsoft_FStar_Absyn_Util.args_of_non_null_binders binders)
in (let t' = (let _106_38 = (let _106_37 = (Microsoft_FStar_Absyn_Syntax.mk_Total t)
in (binders, _106_37))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun _106_38 None r))
...
| _35_75 -> begin
(let _106_39 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app (uv, args) None r)
in (_106_39, uv))
end))))
end)))))
...
| KProb (p) -> begin
(let _106_241 = (Microsoft_FStar_Absyn_Print.kind_to_string p.lhs)
in (let _106_240 = (Microsoft_FStar_Absyn_Print.kind_to_string p.rhs)
in (Support.Microsoft.FStar.Util.format3 "\t%s\n\t\t%s\n\t%s" _106_241 (rel_to_string p.relation) _106_240)))
end
| TProb (p) -> begin
(let _106_254 = (let _106_253 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env p.lhs)
in (let _106_252 = (let _106_251 = (Microsoft_FStar_Absyn_Print.tag_of_typ p.lhs)
in (let _106_250 = (let _106_249 = (let _106_248 = (Support.All.pipe_right p.reason Support.List.hd)
in (let _106_247 = (let _106_246 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env p.rhs)
in (let _106_245 = (let _106_244 = (Microsoft_FStar_Absyn_Print.tag_of_typ p.rhs)
in (let _106_243 = (let _106_242 = (Microsoft_FStar_Tc_Normalize.formula_norm_to_string env (Support.Prims.fst p.logical_guard))
in (_106_242)::[])
in (_106_244)::_106_243))
in (_106_246)::_106_245))
in (_106_248)::_106_247))
in ((rel_to_string p.relation))::_106_249)
in (_106_251)::_106_250))
in (_106_253)::_106_252))
in (Support.Microsoft.FStar.Util.format "\t%s (%s) \n\t\t%s(%s)\n\t%s (%s) (guard %s)" _106_254))
end
| EProb (p) -> begin
(let _106_256 = (Microsoft_FStar_Tc_Normalize.exp_norm_to_string env p.lhs)
in (let _106_255 = (Microsoft_FStar_Tc_Normalize.exp_norm_to_string env p.rhs)
in (Support.Microsoft.FStar.Util.format3 "\t%s \n\t\t%s\n\t%s" _106_256 (rel_to_string p.relation) _106_255)))
end
| CProb (p) -> begin
(let _106_258 = (Microsoft_FStar_Tc_Normalize.comp_typ_norm_to_string env p.lhs)
in (let _106_257 = (Microsoft_FStar_Tc_Normalize.comp_typ_norm_to_string env p.rhs)
in (Support.Microsoft.FStar.Util.format3 "\t%s \n\t\t%s\n\t%s" _106_258 (rel_to_string p.relation) _106_257)))
end))
...
| false -> begin
(let _106_264 = (Support.Microsoft.FStar.Unionfind.uvar_id u)
in (Support.All.pipe_right _106_264 Support.Microsoft.FStar.Util.string_of_int))
end))
in (match (uvi) with
| UK ((u, _35_150)) -> begin
(let _106_265 = (str u)
in (Support.All.pipe_right _106_265 (Support.Microsoft.FStar.Util.format1 "UK %s")))
end
| UT (((u, _35_155), t)) -> begin
(let _106_268 = (str u)
in (Support.All.pipe_right _106_268 (fun ( x ) -> (let _106_267 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env t)
in (Support.Microsoft.FStar.Util.format2 "UT %s %s" x _106_267)))))
end
| UE (((u, _35_163), _35_166)) -> begin
(let _106_269 = (str u)
in (Support.All.pipe_right _106_269 (Support.Microsoft.FStar.Util.format1 "UE %s")))
end)))
...
| KProb (p) -> begin
(Support.All.pipe_right (maybe_invert p) (fun ( _106_276 ) -> KProb (_106_276)))
end
| TProb (p) -> begin
(Support.All.pipe_right (maybe_invert p) (fun ( _106_277 ) -> TProb (_106_277)))
end
| EProb (p) -> begin
(Support.All.pipe_right (maybe_invert p) (fun ( _106_278 ) -> EProb (_106_278)))
end
| CProb (p) -> begin
(Support.All.pipe_right (maybe_invert p) (fun ( _106_279 ) -> CProb (_106_279)))
end))
...
| KProb (p) -> begin
(Support.All.pipe_left (fun ( _106_298 ) -> KProb (_106_298)) (invert p))
end
| TProb (p) -> begin
(Support.All.pipe_left (fun ( _106_299 ) -> TProb (_106_299)) (invert p))
end
| EProb (p) -> begin
(Support.All.pipe_left (fun ( _106_300 ) -> EProb (_106_300)) (invert p))
end
| CProb (p) -> begin
(Support.All.pipe_left (fun ( _106_301 ) -> CProb (_106_301)) (invert p))
end))

let is_top_level_prob = (fun ( p ) -> ((Support.All.pipe_right (p_reason p) Support.List.length) = 1))

let mk_problem = (fun ( scope ) ( orig ) ( lhs ) ( rel ) ( rhs ) ( elt ) ( reason ) -> (let _106_311 = (new_tvar (p_loc orig) scope Microsoft_FStar_Absyn_Syntax.ktype)
in {lhs = lhs; relation = rel; rhs = rhs; element = elt; logical_guard = _106_311; scope = []; reason = (reason)::(p_reason orig); loc = (p_loc orig); rank = None}))

let new_problem = (fun ( env ) ( lhs ) ( rel ) ( rhs ) ( elt ) ( loc ) ( reason ) -> (let _106_321 = (let _106_320 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _106_319 = (Microsoft_FStar_Tc_Env.binders env)
in (new_tvar _106_320 _106_319 Microsoft_FStar_Absyn_Syntax.ktype)))
in {lhs = lhs; relation = rel; rhs = rhs; element = elt; logical_guard = _106_321; scope = []; reason = (reason)::[]; loc = loc; rank = None}))
...
| None -> begin
(let _106_332 = (let _106_331 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (_106_331)::[])
in (Microsoft_FStar_Absyn_Util.close_forall _106_332 phi))
end
| Some (e) -> begin
...
| (_35_291, uv) -> begin
(let _35_301 = (match ((let _106_343 = (Microsoft_FStar_Absyn_Util.compress_typ uv)
in _106_343.Microsoft_FStar_Absyn_Syntax.n)) with
...
| true -> begin
(let _106_345 = (let _106_344 = (Support.List.map (uvi_to_string wl.tcenv) uvis)
in (Support.All.pipe_right _106_344 (Support.String.concat ", ")))
...
let explain = (fun ( env ) ( d ) ( s ) -> (let _106_366 = (Support.All.pipe_left Support.Microsoft.FStar.Range.string_of_range (p_loc d))
in (let _106_365 = (prob_to_string env d)
in (let _106_364 = (Support.All.pipe_right (p_reason d) (Support.String.concat "\n\t>"))
in (Support.Microsoft.FStar.Util.format4 "(%s) Failed to solve the sub-problem\n%s\nWhich arose because:\n\t%s\nFailed because:%s\n" _106_366 _106_365 _106_364 s)))))
...
in (let _106_377 = (Support.List.map Support.Prims.snd g.carry)
in {attempting = _106_377; deferred = _35_328.deferred; subst = _35_328.subst; ctr = _35_328.ctr; slack_vars = g.slack; defer_ok = false; smt_ok = _35_328.smt_ok; tcenv = _35_328.tcenv})))
...
| true -> begin
(let _106_402 = (prob_to_string env prob)
...
(let _106_433 = (let _106_432 = (norm_targ env t)
in (Support.All.pipe_left (fun ( _106_431 ) -> Support.Microsoft.FStar.Util.Inl (_106_431)) _106_432))
in (_106_433, (Support.Prims.snd a)))
end
| Support.Microsoft.FStar.Util.Inr (v) -> begin
(let _106_436 = (let _106_435 = (Microsoft_FStar_Tc_Normalize.norm_exp ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env v)
in (Support.All.pipe_left (fun ( _106_434 ) -> Support.Microsoft.FStar.Util.Inr (_106_434)) _106_435))
in (_106_436, (Support.Prims.snd a)))
end))

let whnf = (fun ( env ) ( t ) -> (let _106_441 = (Microsoft_FStar_Tc_Normalize.whnf env t)
in (Support.All.pipe_right _106_441 Microsoft_FStar_Absyn_Util.compress_typ)))

let sn = (fun ( env ) ( t ) -> (let _106_446 = (Microsoft_FStar_Tc_Normalize.norm_typ ((Microsoft_FStar_Tc_Normalize.Beta)::(Microsoft_FStar_Tc_Normalize.Eta)::[]) env t)
in (Support.All.pipe_right _106_446 Microsoft_FStar_Absyn_Util.compress_typ)))
...
(let _106_452 = (let _106_451 = (let _35_426 = a
in (let _106_450 = (Microsoft_FStar_Tc_Normalize.norm_kind ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env a.Microsoft_FStar_Absyn_Syntax.sort)
in {Microsoft_FStar_Absyn_Syntax.v = _35_426.Microsoft_FStar_Absyn_Syntax.v; Microsoft_FStar_Absyn_Syntax.sort = _106_450; Microsoft_FStar_Absyn_Syntax.p = _35_426.Microsoft_FStar_Absyn_Syntax.p}))
in Support.Microsoft.FStar.Util.Inl (_106_451))
in (_106_452, imp))
end
| (Support.Microsoft.FStar.Util.Inr (x), imp) -> begin
(let _106_455 = (let _106_454 = (let _35_432 = x
in (let _106_453 = (norm_targ env x.Microsoft_FStar_Absyn_Syntax.sort)
in {Microsoft_FStar_Absyn_Syntax.v = _35_432.Microsoft_FStar_Absyn_Syntax.v; Microsoft_FStar_Absyn_Syntax.sort = _106_453; Microsoft_FStar_Absyn_Syntax.p = _35_432.Microsoft_FStar_Absyn_Syntax.p}))
in Support.Microsoft.FStar.Util.Inr (_106_454))
in (_106_455, imp))
end)))))

let whnf_k = (fun ( env ) ( k ) -> (let _106_460 = (Microsoft_FStar_Tc_Normalize.norm_kind ((Microsoft_FStar_Tc_Normalize.Beta)::(Microsoft_FStar_Tc_Normalize.Eta)::(Microsoft_FStar_Tc_Normalize.WHNF)::[]) env k)
in (Support.All.pipe_right _106_460 Microsoft_FStar_Absyn_Util.compress_kind)))

let whnf_e = (fun ( env ) ( e ) -> (let _106_465 = (Microsoft_FStar_Tc_Normalize.norm_exp ((Microsoft_FStar_Tc_Normalize.Beta)::(Microsoft_FStar_Tc_Normalize.Eta)::(Microsoft_FStar_Tc_Normalize.WHNF)::[]) env e)
in (Support.All.pipe_right _106_465 Microsoft_FStar_Absyn_Util.compress_exp)))
...
(let k = (let _106_472 = (Microsoft_FStar_Absyn_Util.subst_of_list formals actuals)
in (Microsoft_FStar_Absyn_Util.subst_kind _106_472 body))
...
let rec compress = (fun ( env ) ( wl ) ( t ) -> (let t = (let _106_479 = (Microsoft_FStar_Absyn_Util.unmeta_typ t)
in (whnf env _106_479))
...
let normalize_refinement = (fun ( env ) ( wl ) ( t0 ) -> (let _106_492 = (compress env wl t0)
in (Microsoft_FStar_Tc_Normalize.normalize_refinement env _106_492)))
...
| tt -> begin
(let _106_505 = (let _106_504 = (Microsoft_FStar_Absyn_Print.typ_to_string tt)
in (let _106_503 = (Microsoft_FStar_Absyn_Print.tag_of_typ tt)
in (Support.Microsoft.FStar.Util.format2 "impossible: Got %s ... %s\n" _106_504 _106_503)))
in (Support.All.failwith _106_505))
end)
end)
end
...
| false -> begin
(let _35_563 = (let _106_506 = (normalize_refinement env wl t1)
in (aux true _106_506))
...
(let _106_509 = (let _106_508 = (Microsoft_FStar_Absyn_Print.typ_to_string t1)
in (let _106_507 = (Microsoft_FStar_Absyn_Print.tag_of_typ t1)
in (Support.Microsoft.FStar.Util.format2 "impossible (outer): Got %s ... %s\n" _106_508 _106_507)))
in (Support.All.failwith _106_509))
end))
in (let _106_510 = (compress env wl t1)
in (aux false _106_510))))

let unrefine = (fun ( env ) ( t ) -> (let _106_515 = (base_and_refinement env (empty_worklist env) t)
in (Support.All.pipe_right _106_515 Support.Prims.fst)))

let trivial_refinement = (fun ( t ) -> (let _106_517 = (Microsoft_FStar_Absyn_Util.gen_bvar_p t.Microsoft_FStar_Absyn_Syntax.pos t)
in (_106_517, Microsoft_FStar_Absyn_Util.t_true)))
...
in (let _106_537 = (Support.All.pipe_right uvs.Microsoft_FStar_Absyn_Syntax.uvars_t Support.Microsoft.FStar.Util.set_elements)
in (Support.All.pipe_right _106_537 (Support.Microsoft.FStar.Util.for_some (fun ( _35_624 ) -> (match (_35_624) with
| (uvt, _35_623) -> begin
...
| false -> begin
(let _106_550 = (let _106_549 = (Microsoft_FStar_Absyn_Print.uvar_t_to_string uk)
in (let _106_548 = (Microsoft_FStar_Absyn_Print.typ_to_string t)
in (let _106_547 = (let _106_546 = (Support.All.pipe_right wl.subst (Support.List.map (uvi_to_string env)))
in (Support.All.pipe_right _106_546 (Support.String.concat ", ")))
in (Support.Microsoft.FStar.Util.format3 "occurs-check failed (%s occurs in %s) (with substitution %s)" _106_549 _106_548 _106_547))))
in Some (_106_550))
end)
in (occurs_ok, msg))))
...
| (occurs_ok, msg) -> begin
(let _106_561 = (Microsoft_FStar_Absyn_Util.fvs_included fvs_t fvs)
in (occurs_ok, _106_561, (msg, fvs, fvs_t)))
end))))
...
| false -> begin
(let _106_573 = (let _106_572 = (Microsoft_FStar_Absyn_Print.uvar_e_to_string ut)
in (let _106_571 = (let _106_569 = (let _106_568 = (Support.Microsoft.FStar.Util.set_elements uvs.Microsoft_FStar_Absyn_Syntax.uvars_e)
in (Support.All.pipe_right _106_568 (Support.List.map Microsoft_FStar_Absyn_Print.uvar_e_to_string)))
in (Support.All.pipe_right _106_569 (Support.String.concat ", ")))
in (let _106_570 = (Microsoft_FStar_Tc_Normalize.exp_norm_to_string env e)
in (Support.Microsoft.FStar.Util.format3 "occurs-check failed (%s occurs in {%s} uvars of %s)" _106_572 _106_571 _106_570))))
in Some (_106_573))
end)
in (occurs_ok, msg)))))
...
in (let _106_580 = (let _106_579 = (Support.Microsoft.FStar.Util.set_intersect fvs1.Microsoft_FStar_Absyn_Syntax.ftvs fvs2.Microsoft_FStar_Absyn_Syntax.ftvs)
in (let _106_578 = (Support.Microsoft.FStar.Util.set_intersect fvs1.Microsoft_FStar_Absyn_Syntax.fxvs fvs2.Microsoft_FStar_Absyn_Syntax.fxvs)
in {Microsoft_FStar_Absyn_Syntax.ftvs = _106_579; Microsoft_FStar_Absyn_Syntax.fxvs = _106_578}))
in (Microsoft_FStar_Absyn_Syntax.binders_of_freevars _106_580)))))
...
| true -> begin
(let _106_596 = (Microsoft_FStar_Absyn_Print.arg_to_string hd)
...
let rec head_matches = (fun ( t1 ) ( t2 ) -> (match ((let _106_613 = (let _106_610 = (Microsoft_FStar_Absyn_Util.unmeta_typ t1)
in _106_610.Microsoft_FStar_Absyn_Syntax.n)
in (let _106_612 = (let _106_611 = (Microsoft_FStar_Absyn_Util.unmeta_typ t2)
in _106_611.Microsoft_FStar_Absyn_Syntax.n)
in (_106_613, _106_612)))) with
...
(let _106_614 = (head_matches x.Microsoft_FStar_Absyn_Syntax.sort y.Microsoft_FStar_Absyn_Syntax.sort)
in (Support.All.pipe_right _106_614 head_match))
end
| (Microsoft_FStar_Absyn_Syntax.Typ_refine ((x, _35_843)), _35_847) -> begin
(let _106_615 = (head_matches x.Microsoft_FStar_Absyn_Syntax.sort t2)
in (Support.All.pipe_right _106_615 head_match))
end
| (_35_850, Microsoft_FStar_Absyn_Syntax.Typ_refine ((x, _35_853))) -> begin
(let _106_616 = (head_matches t1 x.Microsoft_FStar_Absyn_Syntax.sort)
in (Support.All.pipe_right _106_616 head_match))
end
...
in (let _106_753 = (let _106_752 = (mk_problem scope orig gi_ps (vary_rel rel variance) ki None "kind subterm")
in (Support.All.pipe_left (fun ( _106_751 ) -> KProb (_106_751)) _106_752))
in (Microsoft_FStar_Absyn_Syntax.K (gi_xs), _106_753)))
end))
end
...
in (let _106_756 = (let _106_755 = (mk_problem scope orig gi_ps (vary_rel rel variance) ti None "type subterm")
in (Support.All.pipe_left (fun ( _106_754 ) -> TProb (_106_754)) _106_755))
in (Microsoft_FStar_Absyn_Syntax.T ((gi_xs, Some (k))), _106_756)))
end)))
end
...
in (let _106_759 = (let _106_758 = (mk_problem scope orig gi_ps (vary_rel rel variance) ei None "expression subterm")
in (Support.All.pipe_left (fun ( _106_757 ) -> EProb (_106_757)) _106_758))
in (Microsoft_FStar_Absyn_Syntax.E (gi_xs), _106_759)))
end)))
end
...
(let _106_768 = (let _106_767 = (Microsoft_FStar_Absyn_Syntax.mk_Total gi_xs)
in (Support.All.pipe_left (fun ( _106_766 ) -> Microsoft_FStar_Absyn_Syntax.C (_106_766)) _106_767))
in (_106_768, (prob)::[]))
end
| _35_1198 -> begin
(Support.All.failwith "impossible")
...
in (let _35_1231 = (let _106_770 = (Support.List.map (sub_prob scope args) components)
in (Support.All.pipe_right _106_770 Support.List.unzip))
in (match (_35_1231) with
| (ktecs, sub_probs) -> begin
(let gi_xs = (let _106_775 = (let _106_774 = (let _106_771 = (Support.List.hd ktecs)
in (Support.All.pipe_right _106_771 un_T))
in (let _106_773 = (let _106_772 = (Support.List.tl ktecs)
in (Support.All.pipe_right _106_772 (Support.List.map arg_of_ktec)))
in {Microsoft_FStar_Absyn_Syntax.effect_name = c.Microsoft_FStar_Absyn_Syntax.effect_name; Microsoft_FStar_Absyn_Syntax.result_typ = _106_774; Microsoft_FStar_Absyn_Syntax.effect_args = _106_773; Microsoft_FStar_Absyn_Syntax.flags = c.Microsoft_FStar_Absyn_Syntax.flags}))
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.mk_Comp _106_775))
...
(let _106_777 = (let _106_776 = (Microsoft_FStar_Absyn_Util.arg_of_non_null_binder b)
in (_106_776)::args)
in (Some (b), (b)::scope, _106_777))
end
| _35_1249 -> begin
(None, scope, args)
end)
...
| None -> begin
(let _106_780 = (let _106_779 = (Support.All.pipe_right probs (Support.List.map (fun ( prob ) -> (Support.All.pipe_right (p_guard prob) Support.Prims.fst))))
in (f)::_106_779)
in (Microsoft_FStar_Absyn_Util.mk_conj_l _106_780))
end
| Some (b) -> begin
(let _106_784 = (let _106_783 = (Microsoft_FStar_Absyn_Util.close_forall ((b)::[]) f)
in (let _106_782 = (Support.All.pipe_right probs (Support.List.map (fun ( prob ) -> (Support.All.pipe_right (p_guard prob) Support.Prims.fst))))
in (_106_783)::_106_782))
in (Microsoft_FStar_Absyn_Util.mk_conj_l _106_784))
end)
...
| (mul, s) -> begin
(match ((let _106_802 = (Microsoft_FStar_Absyn_Util.compress_typ s)
in _106_802.Microsoft_FStar_Absyn_Syntax.n)) with
| Microsoft_FStar_Absyn_Syntax.Typ_uvar ((uv, k)) -> begin
...
let new_slack_var = (fun ( env ) ( slack ) -> (let xs = (let _106_810 = (let _106_809 = (destruct_flex_pattern env (Support.Prims.snd slack.lower))
in (Support.All.pipe_right _106_809 Support.Prims.snd))
in (Support.All.pipe_right _106_810 Support.Microsoft.FStar.Util.must))
in (let _106_811 = (new_tvar (Support.Prims.fst slack.lower).Microsoft_FStar_Absyn_Syntax.pos xs Microsoft_FStar_Absyn_Syntax.ktype)
in (_106_811, xs))))
...
in (let _106_821 = (let _106_820 = (let _106_819 = (let _106_818 = (Support.Microsoft.FStar.Util.mk_ref false)
in (low, high, _106_818))
in Microsoft_FStar_Absyn_Syntax.Meta_slack_formula (_106_819))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_meta _106_820))
in (_106_821, wl)))))
end)))
end)))
...
(let _106_845 = (let _106_844 = (mk_conn lhs rest)
in (_106_844, uvar))
in Some (_106_845))
end)
end))
...
| true -> begin
(let _106_846 = (Microsoft_FStar_Absyn_Util.unmeta_typ phi)
in Support.Microsoft.FStar.Util.Inl (_106_846))
end
| false -> begin
(let low = (let _106_847 = (compress env wl phi1)
in (Support.All.pipe_left (destruct Microsoft_FStar_Absyn_Const.or_lid Microsoft_FStar_Absyn_Util.mk_disj) _106_847))
in (let hi = (let _106_848 = (compress env wl phi2)
in (Support.All.pipe_left (destruct Microsoft_FStar_Absyn_Const.and_lid Microsoft_FStar_Absyn_Util.mk_disj) _106_848))
in (match ((low, hi)) with
| (None, None) -> begin
(let _35_1401 = (Support.ST.op_Colon_Equals flag true)
in (let _106_849 = (Microsoft_FStar_Absyn_Util.unmeta_typ phi)
in Support.Microsoft.FStar.Util.Inl (_106_849)))
end
...
| KProb (p) -> begin
(let _106_879 = (let _35_1524 = p
in (let _106_877 = (compress_k wl.tcenv wl p.lhs)
in (let _106_876 = (compress_k wl.tcenv wl p.rhs)
in {lhs = _106_877; relation = _35_1524.relation; rhs = _106_876; element = _35_1524.element; logical_guard = _35_1524.logical_guard; scope = _35_1524.scope; reason = _35_1524.reason; loc = _35_1524.loc; rank = _35_1524.rank})))
in (Support.All.pipe_right _106_879 (fun ( _106_878 ) -> KProb (_106_878))))
end
| TProb (p) -> begin
(let _106_883 = (let _35_1528 = p
in (let _106_881 = (compress wl.tcenv wl p.lhs)
in (let _106_880 = (compress wl.tcenv wl p.rhs)
in {lhs = _106_881; relation = _35_1528.relation; rhs = _106_880; element = _35_1528.element; logical_guard = _35_1528.logical_guard; scope = _35_1528.scope; reason = _35_1528.reason; loc = _35_1528.loc; rank = _35_1528.rank})))
in (Support.All.pipe_right _106_883 (fun ( _106_882 ) -> TProb (_106_882))))
end
| EProb (p) -> begin
(let _106_887 = (let _35_1532 = p
in (let _106_885 = (compress_e wl.tcenv wl p.lhs)
in (let _106_884 = (compress_e wl.tcenv wl p.rhs)
in {lhs = _106_885; relation = _35_1532.relation; rhs = _106_884; element = _35_1532.element; logical_guard = _35_1532.logical_guard; scope = _35_1532.scope; reason = _35_1532.reason; loc = _35_1532.loc; rank = _35_1532.rank})))
in (Support.All.pipe_right _106_887 (fun ( _106_886 ) -> EProb (_106_886))))
end
| CProb (_35_1535) -> begin
p
end))

let rank = (fun ( wl ) ( prob ) -> (let prob = (let _106_892 = (compress_prob wl prob)
in (Support.All.pipe_right _106_892 maybe_invert_p))
in (match (prob) with
| KProb (kp) -> begin
...
in (let _106_894 = (Support.All.pipe_right (let _35_1567 = kp
in {lhs = _35_1567.lhs; relation = _35_1567.relation; rhs = _35_1567.rhs; element = _35_1567.element; logical_guard = _35_1567.logical_guard; scope = _35_1567.scope; reason = _35_1567.reason; loc = _35_1567.loc; rank = Some (rank)}) (fun ( _106_893 ) -> KProb (_106_893)))
in (rank, _106_894)))
end
| TProb (tp) -> begin
...
in (let _106_896 = (let _35_1611 = tp
in (let _106_895 = (force_refinement (b, ref_opt))
in {lhs = _35_1611.lhs; relation = _35_1611.relation; rhs = _106_895; element = _35_1611.element; logical_guard = _35_1611.logical_guard; scope = _35_1611.scope; reason = _35_1611.reason; loc = _35_1611.loc; rank = _35_1611.rank}))
in (rank, _106_896)))
end)
end))
end
...
| _35_1624 -> begin
(let _106_898 = (let _35_1625 = tp
in (let _106_897 = (force_refinement (b, ref_opt))
in {lhs = _106_897; relation = _35_1625.relation; rhs = _35_1625.rhs; element = _35_1625.element; logical_guard = _35_1625.logical_guard; scope = _35_1625.scope; reason = _35_1625.reason; loc = _35_1625.loc; rank = _35_1625.rank}))
in (refine_flex, _106_898))
end)
end))
end
...
| (rank, tp) -> begin
(let _106_900 = (Support.All.pipe_right (let _35_1635 = tp
in {lhs = _35_1635.lhs; relation = _35_1635.relation; rhs = _35_1635.rhs; element = _35_1635.element; logical_guard = _35_1635.logical_guard; scope = _35_1635.scope; reason = _35_1635.reason; loc = _35_1635.loc; rank = Some (rank)}) (fun ( _106_899 ) -> TProb (_106_899)))
in (rank, _106_900))
end))
end))
end))
...
in (let _106_902 = (Support.All.pipe_right (let _35_1672 = ep
in {lhs = _35_1672.lhs; relation = _35_1672.relation; rhs = _35_1672.rhs; element = _35_1672.element; logical_guard = _35_1672.logical_guard; scope = _35_1672.scope; reason = _35_1672.reason; loc = _35_1672.loc; rank = Some (rank)}) (fun ( _106_901 ) -> EProb (_106_901)))
in (rank, _106_902)))
end))
end))
end
| CProb (cp) -> begin
(let _106_904 = (Support.All.pipe_right (let _35_1676 = cp
in {lhs = _35_1676.lhs; relation = _35_1676.relation; rhs = _35_1676.rhs; element = _35_1676.element; logical_guard = _35_1676.logical_guard; scope = _35_1676.scope; reason = _35_1676.reason; loc = _35_1676.loc; rank = Some (rigid_rigid)}) (fun ( _106_903 ) -> CProb (_106_903)))
in (rigid_rigid, _106_904))
end)))
...
| true -> begin
(let _106_954 = (prob_to_string env (TProb (tp)))
...
| false -> begin
(let _106_966 = (let _106_965 = (let _106_964 = (new_problem env t1 EQ t2 None t1.Microsoft_FStar_Absyn_Syntax.pos "joining refinements")
in (Support.All.pipe_left (fun ( _106_963 ) -> TProb (_106_963)) _106_964))
in (_106_965)::[])
in Some (_106_966))
end)
end
...
| Some (m) -> begin
(let phi2 = (let _106_973 = (let _106_972 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (let _106_971 = (Microsoft_FStar_Absyn_Syntax.v_binder y)
in (Microsoft_FStar_Absyn_Util.mk_subst_one_binder _106_972 _106_971)))
in (Microsoft_FStar_Absyn_Util.subst_typ _106_973 phi2))
in (let _106_977 = (let _106_976 = (let _106_975 = (let _106_974 = (Microsoft_FStar_Absyn_Util.mk_conj phi1 phi2)
in (x, _106_974))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_refine _106_975 (Some (Microsoft_FStar_Absyn_Syntax.ktype)) t1.Microsoft_FStar_Absyn_Syntax.pos))
in (_106_976, m))
in Some (_106_977)))
end))
end
...
| (u', _35_1798) -> begin
(match ((let _106_979 = (compress env wl u')
in _106_979.Microsoft_FStar_Absyn_Syntax.n)) with
...
| TProb (hd)::tl -> begin
(match ((let _106_984 = (compress env wl hd.rhs)
in (conjoin bound _106_984))) with
...
in (match ((let _106_986 = (let _106_985 = (compress env wl tp.rhs)
in (_106_985, []))
in (make_upper_bound _106_986 upper_bounds))) with
| None -> begin
...
(match (attempt) with
| [] -> begin
(let _106_995 = (let _106_994 = (let _106_993 = (Support.List.map (fun ( _35_1902 ) -> (match (_35_1902) with
| (_35_1899, x, y) -> begin
(x, y)
end)) probs.deferred)
in {carry = _106_993; slack = probs.slack_vars})
in (probs.subst, _106_994))
in Success (_106_995))
end
| _35_1904 -> begin
(let _106_998 = (let _35_1905 = probs
in (let _106_997 = (Support.All.pipe_right attempt (Support.List.map (fun ( _35_1912 ) -> (match (_35_1912) with
| (_35_1908, _35_1910, y) -> begin
y
end))))
in {attempting = _106_997; deferred = rest; subst = _35_1905.subst; ctr = _35_1905.ctr; slack_vars = _35_1905.slack_vars; defer_ok = _35_1905.defer_ok; smt_ok = _35_1905.smt_ok; tcenv = _35_1905.tcenv}))
in (solve env _106_998))
end)
end))
end)
end))
...
| (hd1::xs, hd2::ys) -> begin
(let subst = (let _106_1024 = (Microsoft_FStar_Absyn_Util.mk_subst_one_binder hd2 hd1)
in (Support.List.append _106_1024 subst))
in (let env = (let _106_1025 = (Microsoft_FStar_Tc_Env.binding_of_binder hd2)
in (Microsoft_FStar_Tc_Env.push_local_binding env _106_1025))
in (let prob = (match (((Support.Prims.fst hd1), (Support.Prims.fst hd2))) with
| (Support.Microsoft.FStar.Util.Inl (a), Support.Microsoft.FStar.Util.Inl (b)) -> begin
(let _106_1029 = (let _106_1028 = (Microsoft_FStar_Absyn_Util.subst_kind subst a.Microsoft_FStar_Absyn_Syntax.sort)
in (let _106_1027 = (Support.All.pipe_left invert_rel (p_rel orig))
in (mk_problem ((hd2)::scope) orig _106_1028 _106_1027 b.Microsoft_FStar_Absyn_Syntax.sort None "Formal type parameter")))
in (Support.All.pipe_left (fun ( _106_1026 ) -> KProb (_106_1026)) _106_1029))
end
| (Support.Microsoft.FStar.Util.Inr (x), Support.Microsoft.FStar.Util.Inr (y)) -> begin
(let _106_1033 = (let _106_1032 = (Microsoft_FStar_Absyn_Util.subst_typ subst x.Microsoft_FStar_Absyn_Syntax.sort)
in (let _106_1031 = (Support.All.pipe_left invert_rel (p_rel orig))
in (mk_problem ((hd2)::scope) orig _106_1032 _106_1031 y.Microsoft_FStar_Absyn_Syntax.sort None "Formal value parameter")))
in (Support.All.pipe_left (fun ( _106_1030 ) -> TProb (_106_1030)) _106_1033))
end
| _35_1988 -> begin
(Support.All.failwith "impos")
end)
...
(let phi = (let _106_1035 = (Support.All.pipe_right (p_guard prob) Support.Prims.fst)
in (let _106_1034 = (Microsoft_FStar_Absyn_Util.close_forall ((hd2)::[]) phi)
in (Microsoft_FStar_Absyn_Util.mk_conj _106_1035 _106_1034)))
...
| true -> begin
(let _106_1042 = (solve_prob orig None [] wl)
in (solve env _106_1042))
end
| false -> begin
(let k1 = problem.lhs
...
| true -> begin
(let _106_1043 = (solve_prob orig None [] wl)
in (solve env _106_1043))
end
| false -> begin
...
(let im = (let _106_1059 = (let _106_1058 = (h gs_xs)
in (xs, _106_1058))
in (Microsoft_FStar_Absyn_Syntax.mk_Kind_lam _106_1059 r))
...
in (let _106_1068 = (solve_prob orig None ((UK ((u, k1)))::[]) wl)
in (solve env _106_1068)))
end
| false -> begin
(let _106_1073 = (let _106_1072 = (Support.All.pipe_right xs Microsoft_FStar_Absyn_Util.args_of_non_null_binders)
in (let _106_1071 = (decompose_kind env k)
in (rel, u, _106_1072, xs, _106_1071)))
in (imitate_k _106_1073))
end))))
end
| None -> begin
...
(let _106_1074 = (solve_prob orig None [] wl)
in (Support.All.pipe_left (solve env) _106_1074))
end
...
(let sub_prob = (fun ( scope ) ( env ) ( subst ) -> (let _106_1083 = (let _106_1082 = (Microsoft_FStar_Absyn_Util.subst_kind subst k1')
in (mk_problem scope orig _106_1082 problem.relation k2' None "Arrow-kind result"))
in (Support.All.pipe_left (fun ( _106_1081 ) -> KProb (_106_1081)) _106_1083)))
...
| true -> begin
(let _106_1094 = (prob_to_string env orig)
...
(let im = (let _106_1106 = (let _106_1105 = (h gs_xs)
in (xs, _106_1105))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam' _106_1106 None r))
in (let _35_2196 = (match ((Support.All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Rel")))) with
| true -> begin
(let _106_1111 = (Microsoft_FStar_Absyn_Print.typ_to_string im)
in (let _106_1110 = (Microsoft_FStar_Absyn_Print.tag_of_typ im)
in (let _106_1109 = (let _106_1107 = (Support.List.map (prob_to_string env) sub_probs)
in (Support.All.pipe_right _106_1107 (Support.String.concat ", ")))
in (let _106_1108 = (Microsoft_FStar_Tc_Normalize.formula_norm_to_string env formula)
in (Support.Microsoft.FStar.Util.fprint4 "Imitating %s (%s)\nsub_probs = %s\nformula=%s\n" _106_1111 _106_1110 _106_1109 _106_1108)))))
end
| false -> begin
()
end)
...
in (let _106_1131 = (Microsoft_FStar_Absyn_Syntax.targ gi_xs)
in (let _106_1130 = (Microsoft_FStar_Absyn_Syntax.targ gi_ps)
in (_106_1131, _106_1130, subst))))))
end)))
end
| Support.Microsoft.FStar.Util.Inr (x) -> begin
...
in (let _106_1133 = (Microsoft_FStar_Absyn_Syntax.varg gi_xs)
in (let _106_1132 = (Microsoft_FStar_Absyn_Syntax.varg gi_ps)
in (_106_1133, _106_1132, subst))))))
end)))
end)
...
in (match ((let _106_1135 = (let _106_1134 = (Support.List.nth xs i)
in (Support.All.pipe_left Support.Prims.fst _106_1134))
in ((Support.Prims.fst pi), _106_1135))) with
| (Support.Microsoft.FStar.Util.Inl (pi), Support.Microsoft.FStar.Util.Inl (xi)) -> begin
(match ((let _106_1136 = (matches pi)
in (Support.All.pipe_left Support.Prims.op_Negation _106_1136))) with
| true -> begin
None
end
| false -> begin
...
in (let proj = (let _106_1138 = (let _106_1137 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_app' (xi, g_xs) (Some (Microsoft_FStar_Absyn_Syntax.ktype)) r)
in (xs, _106_1137))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _106_1138 None r))
in (let sub = (let _106_1144 = (let _106_1143 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_app' (proj, ps) (Some (Microsoft_FStar_Absyn_Syntax.ktype)) r)
in (let _106_1142 = (let _106_1141 = (Support.List.map (fun ( _35_2268 ) -> (match (_35_2268) with
| (_35_2264, _35_2266, y) -> begin
y
end)) qs)
in (Support.All.pipe_left h _106_1141))
in (mk_problem (p_scope orig) orig _106_1143 (p_rel orig) _106_1142 None "projection")))
in (Support.All.pipe_left (fun ( _106_1139 ) -> TProb (_106_1139)) _106_1144))
in (let _35_2270 = (match ((Support.All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Rel")))) with
| true -> begin
(let _106_1146 = (Microsoft_FStar_Absyn_Print.typ_to_string proj)
in (let _106_1145 = (prob_to_string env sub)
in (Support.Microsoft.FStar.Util.fprint2 "Projecting %s\n\tsubprob=%s\n" _106_1146 _106_1145)))
end
| false -> begin
()
end)
in (let wl = (let _106_1148 = (let _106_1147 = (Support.All.pipe_left Support.Prims.fst (p_guard sub))
in Some (_106_1147))
in (solve_prob orig _106_1148 ((UT ((u, proj)))::[]) wl))
in (let _106_1150 = (solve env (attempt ((sub)::[]) wl))
in (Support.All.pipe_left (fun ( _106_1149 ) -> Some (_106_1149)) _106_1150)))))))
end))
end)
end
| _35_2274 -> begin
...
(let subterms = (fun ( ps ) -> (let xs = (let _106_1177 = (Microsoft_FStar_Absyn_Util.kind_formals k)
in (Support.All.pipe_right _106_1177 Support.Prims.fst))
in (let xs = (Microsoft_FStar_Absyn_Util.name_binders xs)
in (let _106_1182 = (decompose_typ env t2)
in ((uv, k), ps, xs, _106_1182)))))
...
| true -> begin
(let _106_1193 = (Microsoft_FStar_Absyn_Print.freevars_to_string fvs_hd)
in (Support.Microsoft.FStar.Util.fprint1 "Free variables are %s" _106_1193))
end
| false -> begin
()
end)
...
in (let imitate_ok = (fun ( t2 ) -> (let fvs_hd = (let _106_1197 = (let _106_1196 = (Microsoft_FStar_Absyn_Util.head_and_args t2)
in (Support.All.pipe_right _106_1196 Support.Prims.fst))
in (Support.All.pipe_right _106_1197 Microsoft_FStar_Absyn_Util.freevars_typ))
...
| true -> begin
(let _106_1199 = (let _106_1198 = (Support.Option.get msg)
in (Support.String.strcat "occurs-check failed: " _106_1198))
in (giveup_or_defer orig _106_1199))
end
| false -> begin
...
| true -> begin
(let _106_1200 = (subterms args_lhs)
in (imitate_t orig env wl _106_1200))
end
| false -> begin
(let _35_2339 = (match ((Support.All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Rel")))) with
| true -> begin
(let _106_1203 = (Microsoft_FStar_Absyn_Print.typ_to_string t1)
in (let _106_1202 = (Microsoft_FStar_Absyn_Print.freevars_to_string fvs1)
in (let _106_1201 = (Microsoft_FStar_Absyn_Print.freevars_to_string fvs2)
in (Support.Microsoft.FStar.Util.fprint3 "Pattern %s with fvars=%s succeeded fvar check: %s\n" _106_1203 _106_1202 _106_1201))))
end
| false -> begin
()
end)
...
| _35_2343 -> begin
(let _106_1205 = (let _106_1204 = (sn_binders env vars)
in (_106_1204, t2))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _106_1205 None t1.Microsoft_FStar_Absyn_Syntax.pos))
end)
...
| true -> begin
(let _106_1208 = (Microsoft_FStar_Absyn_Print.typ_to_string t1)
in (let _106_1207 = (Microsoft_FStar_Absyn_Print.freevars_to_string fvs1)
in (let _106_1206 = (Microsoft_FStar_Absyn_Print.freevars_to_string fvs2)
in (Support.Microsoft.FStar.Util.fprint3 "Pattern %s with fvars=%s failed fvar check: %s ... imitating\n" _106_1208 _106_1207 _106_1206))))
end
| false -> begin
()
end)
in (let _106_1209 = (subterms args_lhs)
in (imitate_or_project (Support.List.length args_lhs) _106_1209 (- (1)))))
end
| false -> begin
...
| false -> begin
(match ((let _106_1210 = (Microsoft_FStar_Absyn_Util.freevars_typ t1)
in (check_head _106_1210 t2))) with
| true -> begin
(let im_ok = (imitate_ok t2)
in (let _35_2350 = (match ((Support.All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Rel")))) with
| true -> begin
(let _106_1211 = (Microsoft_FStar_Absyn_Print.typ_to_string t1)
in (Support.Microsoft.FStar.Util.fprint2 "Not a pattern (%s) ... %s\n" _106_1211 (match ((im_ok < 0)) with
| true -> begin
"imitating"
end
| false -> begin
...
in (let _106_1212 = (subterms args_lhs)
in (imitate_or_project (Support.List.length args_lhs) _106_1212 im_ok))))
end
| false -> begin
...
(let sol = (let _106_1230 = (let _106_1229 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam (binders, u1_ys) (Some (k)) t.Microsoft_FStar_Absyn_Syntax.pos)
in ((u, k), _106_1229))
in UT (_106_1230))
in (sol, (t', u, k1, ys)))
end))
...
| Support.Microsoft.FStar.Util.Inl (a) -> begin
(let _106_1234 = (let _106_1233 = (Microsoft_FStar_Tc_Recheck.recompute_kind a)
in (Support.All.pipe_right _106_1233 (Microsoft_FStar_Absyn_Util.gen_bvar_p a.Microsoft_FStar_Absyn_Syntax.pos)))
in (Support.All.pipe_right _106_1234 Microsoft_FStar_Absyn_Syntax.t_binder))
end
| Support.Microsoft.FStar.Util.Inr (x) -> begin
(let _106_1236 = (let _106_1235 = (Microsoft_FStar_Tc_Recheck.recompute_typ x)
in (Support.All.pipe_right _106_1235 (Microsoft_FStar_Absyn_Util.gen_bvar_p x.Microsoft_FStar_Absyn_Syntax.pos)))
in (Support.All.pipe_right _106_1236 Microsoft_FStar_Absyn_Syntax.v_binder))
end))
in (let _35_2399 = (match ((pat_var_opt env ys hd)) with
| None -> begin
(let _106_1237 = (new_binder hd)
in (_106_1237, ys))
end
| Some (y) -> begin
(match (xs_opt) with
...
(match (((Support.Microsoft.FStar.Unionfind.equivalent u1 u2) && (binders_eq xs ys))) with
| true -> begin
(let _106_1249 = (solve_prob orig None [] wl)
in (solve env _106_1249))
end
| false -> begin
(let xs = (sn_binders env xs)
...
| true -> begin
(let _106_1255 = (Microsoft_FStar_Absyn_Print.typ_to_string t1)
in (let _106_1254 = (Microsoft_FStar_Absyn_Print.typ_to_string t2)
...
(let _106_1259 = (mk_problem (p_scope orig) orig t1 EQ t2 None "flex-flex index")
in (Support.All.pipe_right _106_1259 (fun ( _106_1258 ) -> TProb (_106_1258))))
end
| (Support.Microsoft.FStar.Util.Inr (t1), Support.Microsoft.FStar.Util.Inr (t2)) -> begin
(let _106_1261 = (mk_problem (p_scope orig) orig t1 EQ t2 None "flex-flex index")
in (Support.All.pipe_right _106_1261 (fun ( _106_1260 ) -> EProb (_106_1260))))
end
| _35_2458 -> begin
(Support.All.failwith "Impossible")
end))) xs args2)
in (let guard = (let _106_1263 = (Support.List.map (fun ( p ) -> (Support.All.pipe_right (p_guard p) Support.Prims.fst)) sub_probs)
in (Microsoft_FStar_Absyn_Util.mk_conj_l _106_1263))
...
| true -> begin
(let sol = (let _106_1265 = (let _106_1264 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam' (xs, t2) (Some (k1)) t1.Microsoft_FStar_Absyn_Syntax.pos)
in ((u1, k1), _106_1264))
in UT (_106_1265))
...
| true -> begin
(let _106_1266 = (uvi_to_string env sol)
...
| (Some (xs), Some (ys)) -> begin
(let _106_1267 = (Microsoft_FStar_Tc_Recheck.recompute_kind t2)
in (solve_both_pats wl (u1, k1, xs) (u2, k2, ys) _106_1267 t2.Microsoft_FStar_Absyn_Syntax.pos))
end
| (Some (xs), None) -> begin
...
| true -> begin
(let _106_1268 = (uvi_to_string env sol)
...
in (match ((Support.Microsoft.FStar.Util.physical_equality problem.lhs problem.rhs)) with
| true -> begin
(let _106_1269 = (solve_prob orig None [] wl)
in (solve env _106_1269))
end
| false -> begin
(let t1 = problem.lhs
...
| true -> begin
(let _106_1270 = (solve_prob orig None [] wl)
in (solve env _106_1270))
end
| false -> begin
(let _35_2529 = (match ((Microsoft_FStar_Tc_Env.debug env (Microsoft_FStar_Options.Other ("Rel")))) with
| true -> begin
(let _106_1273 = (prob_to_string env orig)
in (let _106_1272 = (let _106_1271 = (Support.List.map (uvi_to_string wl.tcenv) wl.subst)
in (Support.All.pipe_right _106_1271 (Support.String.concat "; ")))
...
in (match ((l1 = l2)) with
| true -> begin
(let _106_1307 = (let _106_1304 = (mk_cod1 [])
in (bs1, _106_1304))
in (let _106_1306 = (let _106_1305 = (mk_cod2 [])
in (bs2, _106_1305))
in (_106_1307, _106_1306)))
end
| false -> begin
(match ((l1 > l2)) with
| true -> begin
(let _106_1310 = (curry l2 bs1 mk_cod1)
in (let _106_1309 = (let _106_1308 = (mk_cod2 [])
in (bs2, _106_1308))
in (_106_1310, _106_1309)))
end
| false -> begin
(let _106_1313 = (let _106_1311 = (mk_cod1 [])
in (bs1, _106_1311))
in (let _106_1312 = (curry l1 bs2 mk_cod2)
in (_106_1313, _106_1312)))
end)
end))))
end))
in (match ((t1.Microsoft_FStar_Absyn_Syntax.n, t2.Microsoft_FStar_Absyn_Syntax.n)) with
...
| true -> begin
(let _106_1314 = (solve_prob orig None [] wl)
in (solve env _106_1314))
end
| false -> begin
(let _106_1318 = (let _106_1317 = (let _106_1316 = (Microsoft_FStar_Absyn_Util.mk_eq_typ t1 t2)
in (Support.All.pipe_left (fun ( _106_1315 ) -> Some (_106_1315)) _106_1316))
in (solve_prob orig _106_1317 [] wl))
in (solve env _106_1318))
end)
end
...
| bs -> begin
(let _106_1323 = (Microsoft_FStar_Absyn_Syntax.mk_Typ_fun (bs, c) None c.Microsoft_FStar_Absyn_Syntax.pos)
in (Microsoft_FStar_Absyn_Syntax.mk_Total _106_1323))
end))
...
| true -> begin
(let _106_1330 = (let _106_1329 = (Microsoft_FStar_Tc_Env.get_range env)
in (Support.All.pipe_right _106_1329 Support.Microsoft.FStar.Range.string_of_range))
in (Support.Microsoft.FStar.Util.fprint2 "(%s) Using relation %s at higher order\n" _106_1330 (rel_to_string rel)))
end
| false -> begin
()
end)
in (let _106_1332 = (mk_problem scope orig c1 rel c2 None "function co-domain")
in (Support.All.pipe_left (fun ( _106_1331 ) -> CProb (_106_1331)) _106_1332)))))))
end)))
end
...
in (let _106_1343 = (mk_problem scope orig t1' problem.relation t2' None "lambda co-domain")
in (Support.All.pipe_left (fun ( _106_1342 ) -> TProb (_106_1342)) _106_1343)))))
end)))
end
...
| (x2, phi2) -> begin
(let base_prob = (let _106_1345 = (mk_problem (p_scope orig) orig x1.Microsoft_FStar_Absyn_Syntax.sort problem.relation x2.Microsoft_FStar_Absyn_Syntax.sort problem.element "refinement base type")
in (Support.All.pipe_left (fun ( _106_1344 ) -> TProb (_106_1344)) _106_1345))
in (let x1_for_x2 = (let _106_1347 = (Microsoft_FStar_Absyn_Syntax.v_binder x1)
in (let _106_1346 = (Microsoft_FStar_Absyn_Syntax.v_binder x2)
in (Microsoft_FStar_Absyn_Util.mk_subst_one_binder _106_1347 _106_1346)))
in (let phi2 = (Microsoft_FStar_Absyn_Util.subst_typ x1_for_x2 phi2)
in (let mk_imp = (fun ( imp ) ( phi1 ) ( phi2 ) -> (let _106_1364 = (imp phi1 phi2)
in (Support.All.pipe_right _106_1364 (guard_on_element problem x1))))
...
in (let guard = (let _106_1367 = (Support.All.pipe_right (p_guard base_prob) Support.Prims.fst)
in (Microsoft_FStar_Absyn_Util.mk_conj _106_1367 impl))
in (let wl = (solve_prob orig (Some (guard)) [] wl)
in (solve env (attempt ((base_prob)::[]) wl)))))
end))
in (match ((problem.relation = EQ)) with
| true -> begin
(let ref_prob = (let _106_1369 = (mk_problem (p_scope orig) orig phi1 EQ phi2 None "refinement formula")
in (Support.All.pipe_left (fun ( _106_1368 ) -> TProb (_106_1368)) _106_1369))
...
(let guard = (let _106_1372 = (Support.All.pipe_right (p_guard base_prob) Support.Prims.fst)
in (let _106_1371 = (let _106_1370 = (Support.All.pipe_right (p_guard ref_prob) Support.Prims.fst)
in (Support.All.pipe_right _106_1370 (guard_on_element problem x1)))
in (Microsoft_FStar_Absyn_Util.mk_conj _106_1372 _106_1371)))
in (let wl = (solve_prob orig (Some (guard)) [] wl)
...
(let _106_1374 = (destruct_flex_t t1)
in (let _106_1373 = (destruct_flex_t t2)
in (flex_flex orig _106_1374 _106_1373)))
end
| ((Microsoft_FStar_Absyn_Syntax.Typ_uvar (_), _)) | ((Microsoft_FStar_Absyn_Syntax.Typ_app (({Microsoft_FStar_Absyn_Syntax.n = Microsoft_FStar_Absyn_Syntax.Typ_uvar (_); Microsoft_FStar_Absyn_Syntax.tk = _; Microsoft_FStar_Absyn_Syntax.pos = _; Microsoft_FStar_Absyn_Syntax.fvs = _; Microsoft_FStar_Absyn_Syntax.uvs = _}, _)), _)) when (problem.relation = EQ) -> begin
(let _106_1375 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid orig _106_1375 t2 wl))
end
...
in (match ((let _106_1376 = (is_top_level_prob orig)
in (Support.All.pipe_left Support.Prims.op_Negation _106_1376))) with
| true -> begin
(let _106_1379 = (Support.All.pipe_left (fun ( _106_1377 ) -> TProb (_106_1377)) (let _35_2805 = problem
...
in (let _106_1378 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid _106_1379 _106_1378 t2 wl)))
end
| false -> begin
...
(match (ref_opt) with
| None -> begin
(let _106_1382 = (Support.All.pipe_left (fun ( _106_1380 ) -> TProb (_106_1380)) (let _35_2811 = problem
...
in (let _106_1381 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid _106_1382 _106_1381 t_base wl)))
end
| Some ((y, phi)) -> begin
...
in (let base_prob = (let _106_1384 = (mk_problem problem.scope orig t1 new_rel y.Microsoft_FStar_Absyn_Syntax.sort problem.element "flex-rigid: base type")
in (Support.All.pipe_left (fun ( _106_1383 ) -> TProb (_106_1383)) _106_1384))
in (let guard = (let _106_1385 = (Support.All.pipe_right (p_guard base_prob) Support.Prims.fst)
in (Microsoft_FStar_Absyn_Util.mk_conj _106_1385 impl))
in (let wl = (solve_prob orig (Some (guard)) [] wl)
in (solve env (attempt ((base_prob)::[]) wl)))))))
end)
end))
...
(let t2 = (let _106_1386 = (base_and_refinement env wl t2)
in (Support.All.pipe_left force_refinement _106_1386))
...
(let t1 = (let _106_1387 = (base_and_refinement env wl t1)
in (Support.All.pipe_left force_refinement _106_1387))
...
(let head1 = (let _106_1388 = (Microsoft_FStar_Absyn_Util.head_and_args t1)
in (Support.All.pipe_right _106_1388 Support.Prims.fst))
in (let head2 = (let _106_1389 = (Microsoft_FStar_Absyn_Util.head_and_args t2)
in (Support.All.pipe_right _106_1389 Support.Prims.fst))
...
| true -> begin
(let _106_1395 = (let _106_1394 = (let _106_1393 = (Microsoft_FStar_Absyn_Util.mk_eq_typ t1 t2)
in (Support.All.pipe_left (fun ( _106_1392 ) -> Some (_106_1392)) _106_1393))
in (solve_prob orig _106_1394 [] wl))
in (solve env _106_1395))
end
| false -> begin
...
| true -> begin
(let _106_1397 = (Microsoft_FStar_Absyn_Print.typ_to_string t1)
in (let _106_1396 = (Microsoft_FStar_Absyn_Print.typ_to_string t2)
...
| true -> begin
(let _106_1402 = (let _106_1401 = (Microsoft_FStar_Absyn_Print.typ_to_string head)
in (let _106_1400 = (Microsoft_FStar_Absyn_Print.args_to_string args)
in (let _106_1399 = (Microsoft_FStar_Absyn_Print.typ_to_string head')
in (let _106_1398 = (Microsoft_FStar_Absyn_Print.args_to_string args')
in (Support.Microsoft.FStar.Util.format4 "unequal number of arguments: %s[%s] and %s[%s]" _106_1401 _106_1400 _106_1399 _106_1398)))))
in (giveup env _106_1402 orig))
end
| false -> begin
(match (((nargs = 0) || (eq_args args args'))) with
| true -> begin
(let _106_1403 = (solve_prob orig None [] wl)
in (solve env _106_1403))
end
| false -> begin
...
| true -> begin
(let _106_1406 = (let _106_1405 = (Microsoft_FStar_Absyn_Print.typ_to_string head)
in (let _106_1404 = (Microsoft_FStar_Absyn_Print.typ_to_string head')
in (Support.Microsoft.FStar.Util.format2 "Assertion failed: expected full match of %s and %s\n" _106_1405 _106_1404)))
in (Support.All.failwith _106_1406))
end
| false -> begin
()
end)
...
(let _106_1410 = (mk_problem (p_scope orig) orig t EQ t' None "type index")
in (Support.All.pipe_left (fun ( _106_1409 ) -> TProb (_106_1409)) _106_1410))
end
| (Support.Microsoft.FStar.Util.Inr (v), Support.Microsoft.FStar.Util.Inr (v')) -> begin
(let _106_1412 = (mk_problem (p_scope orig) orig v EQ v' None "term index")
in (Support.All.pipe_left (fun ( _106_1411 ) -> EProb (_106_1411)) _106_1412))
end
| _35_2973 -> begin
(Support.All.failwith "Impossible")
end)) args args')
in (let formula = (let _106_1414 = (Support.List.map (fun ( p ) -> (Support.Prims.fst (p_guard p))) subprobs)
in (Microsoft_FStar_Absyn_Util.mk_conj_l _106_1414))
...
| (Support.Microsoft.FStar.Util.Inl (t1), Support.Microsoft.FStar.Util.Inl (t2)) -> begin
(let _106_1429 = (sub_prob t1 EQ t2 "effect arg")
in (Support.All.pipe_left (fun ( _106_1428 ) -> TProb (_106_1428)) _106_1429))
end
| (Support.Microsoft.FStar.Util.Inr (e1), Support.Microsoft.FStar.Util.Inr (e2)) -> begin
(let _106_1431 = (sub_prob e1 EQ e2 "effect arg")
in (Support.All.pipe_left (fun ( _106_1430 ) -> EProb (_106_1430)) _106_1431))
end
| _35_3053 -> begin
(Support.All.failwith "impossible")
end)) c1_comp.Microsoft_FStar_Absyn_Syntax.effect_args c2_comp.Microsoft_FStar_Absyn_Syntax.effect_args)
in (let guard = (let _106_1433 = (Support.List.map (fun ( p ) -> (Support.All.pipe_right (p_guard p) Support.Prims.fst)) sub_probs)
in (Microsoft_FStar_Absyn_Util.mk_conj_l _106_1433))
in (let wl = (solve_prob orig (Some (guard)) [] wl)
in (solve env (attempt sub_probs wl)))))))
in (match ((Support.Microsoft.FStar.Util.physical_equality c1 c2)) with
| true -> begin
(let _106_1434 = (solve_prob orig None [] wl)
in (solve env _106_1434))
end
| false -> begin
(let _35_3058 = (match ((Support.All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Rel")))) with
| true -> begin
(let _106_1436 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string c1)
in (let _106_1435 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string c2)
in (Support.Microsoft.FStar.Util.fprint3 "solve_c %s %s %s\n" _106_1436 (rel_to_string problem.relation) _106_1435)))
end
| false -> begin
()
end)
...
(let _106_1438 = (let _35_3076 = problem
in (let _106_1437 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.mk_Comp (Microsoft_FStar_Absyn_Util.comp_to_comp_typ c1))
in {lhs = _106_1437; relation = _35_3076.relation; rhs = _35_3076.rhs; element = _35_3076.element; logical_guard = _35_3076.logical_guard; scope = _35_3076.scope; reason = _35_3076.reason; loc = _35_3076.loc; rank = _35_3076.rank}))
in (solve_c env _106_1438 wl))
end
| (Microsoft_FStar_Absyn_Syntax.Comp (_35_3079), Microsoft_FStar_Absyn_Syntax.Total (_35_3082)) -> begin
(let _106_1440 = (let _35_3085 = problem
in (let _106_1439 = (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.mk_Comp (Microsoft_FStar_Absyn_Util.comp_to_comp_typ c2))
in {lhs = _35_3085.lhs; relation = _35_3085.relation; rhs = _106_1439; element = _35_3085.element; logical_guard = _35_3085.logical_guard; scope = _35_3085.scope; reason = _35_3085.reason; loc = _35_3085.loc; rank = _35_3085.rank}))
in (solve_c env _106_1440 wl))
end
...
| None -> begin
(let _106_1443 = (let _106_1442 = (Microsoft_FStar_Absyn_Print.sli c1.Microsoft_FStar_Absyn_Syntax.effect_name)
in (let _106_1441 = (Microsoft_FStar_Absyn_Print.sli c2.Microsoft_FStar_Absyn_Syntax.effect_name)
in (Support.Microsoft.FStar.Util.format2 "incompatible monad ordering: %s </: %s" _106_1442 _106_1441)))
in (giveup env _106_1443 orig))
end
| Some (edge) -> begin
...
| _35_3115 -> begin
(let _106_1446 = (let _106_1445 = (let _106_1444 = (Microsoft_FStar_Absyn_Syntax.range_of_lid c1.Microsoft_FStar_Absyn_Syntax.effect_name)
in (Support.Microsoft.FStar.Range.string_of_range _106_1444))
in (Support.Microsoft.FStar.Util.format1 "Unexpected number of indices on a normalized effect (%s)" _106_1445))
in (Support.All.failwith _106_1446))
end)
in (match (_35_3118) with
| (wp, wlp) -> begin
(let c1 = (let _106_1452 = (let _106_1451 = (let _106_1447 = (edge.Microsoft_FStar_Tc_Env.mlift c1.Microsoft_FStar_Absyn_Syntax.result_typ wp)
in (Microsoft_FStar_Absyn_Syntax.targ _106_1447))
in (let _106_1450 = (let _106_1449 = (let _106_1448 = (edge.Microsoft_FStar_Tc_Env.mlift c1.Microsoft_FStar_Absyn_Syntax.result_typ wlp)
in (Microsoft_FStar_Absyn_Syntax.targ _106_1448))
in (_106_1449)::[])
in (_106_1451)::_106_1450))
in {Microsoft_FStar_Absyn_Syntax.effect_name = c2.Microsoft_FStar_Absyn_Syntax.effect_name; Microsoft_FStar_Absyn_Syntax.result_typ = c1.Microsoft_FStar_Absyn_Syntax.result_typ; Microsoft_FStar_Absyn_Syntax.effect_args = _106_1452; Microsoft_FStar_Absyn_Syntax.flags = c1.Microsoft_FStar_Absyn_Syntax.flags})
in (solve_eq c1 c2))
end))
end
| false -> begin
...
| _35_3145 -> begin
(let _106_1456 = (let _106_1455 = (Microsoft_FStar_Absyn_Print.sli c1.Microsoft_FStar_Absyn_Syntax.effect_name)
in (let _106_1454 = (Microsoft_FStar_Absyn_Print.sli c2.Microsoft_FStar_Absyn_Syntax.effect_name)
in (Support.Microsoft.FStar.Util.format2 "Got effects %s and %s, expected normalized effects" _106_1455 _106_1454)))
in (Support.All.failwith _106_1456))
end)
...
in (let _106_1462 = (let _106_1461 = (let _106_1460 = (Microsoft_FStar_Absyn_Syntax.targ c1.Microsoft_FStar_Absyn_Syntax.result_typ)
in (let _106_1459 = (let _106_1458 = (let _106_1457 = (edge.Microsoft_FStar_Tc_Env.mlift c1.Microsoft_FStar_Absyn_Syntax.result_typ wpc1)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _106_1457))
in (_106_1458)::[])
in (_106_1460)::_106_1459))
in (c2_decl.Microsoft_FStar_Absyn_Syntax.trivial, _106_1461))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _106_1462 (Some (Microsoft_FStar_Absyn_Syntax.ktype)) r)))
end
| false -> begin
(let wp2_imp_wp1 = (let _106_1474 = (let _106_1473 = (let _106_1472 = (Microsoft_FStar_Absyn_Syntax.targ c2.Microsoft_FStar_Absyn_Syntax.result_typ)
in (let _106_1471 = (let _106_1470 = (Microsoft_FStar_Absyn_Syntax.targ wpc2)
in (let _106_1469 = (let _106_1468 = (let _106_1464 = (let _106_1463 = (Microsoft_FStar_Absyn_Const.kbin Microsoft_FStar_Absyn_Syntax.ktype Microsoft_FStar_Absyn_Syntax.ktype Microsoft_FStar_Absyn_Syntax.ktype)
in (Microsoft_FStar_Absyn_Util.ftv Microsoft_FStar_Absyn_Const.imp_lid _106_1463))
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _106_1464))
in (let _106_1467 = (let _106_1466 = (let _106_1465 = (edge.Microsoft_FStar_Tc_Env.mlift c1.Microsoft_FStar_Absyn_Syntax.result_typ wpc1)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.targ _106_1465))
in (_106_1466)::[])
in (_106_1468)::_106_1467))
in (_106_1470)::_106_1469))
in (_106_1472)::_106_1471))
in (c2_decl.Microsoft_FStar_Absyn_Syntax.wp_binop, _106_1473))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _106_1474 None r))
in (let _106_1479 = (let _106_1478 = (let _106_1477 = (Microsoft_FStar_Absyn_Syntax.targ c2.Microsoft_FStar_Absyn_Syntax.result_typ)
in (let _106_1476 = (let _106_1475 = (Microsoft_FStar_Absyn_Syntax.targ wp2_imp_wp1)
in (_106_1475)::[])
in (_106_1477)::_106_1476))
in (c2_decl.Microsoft_FStar_Absyn_Syntax.wp_as_type, _106_1478))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _106_1479 (Some (Microsoft_FStar_Absyn_Syntax.ktype)) r)))
end)
in (let base_prob = (let _106_1481 = (sub_prob c1.Microsoft_FStar_Absyn_Syntax.result_typ problem.relation c2.Microsoft_FStar_Absyn_Syntax.result_typ "result type")
in (Support.All.pipe_left (fun ( _106_1480 ) -> TProb (_106_1480)) _106_1481))
in (let wl = (let _106_1485 = (let _106_1484 = (let _106_1483 = (Support.All.pipe_right (p_guard base_prob) Support.Prims.fst)
in (Microsoft_FStar_Absyn_Util.mk_conj _106_1483 g))
in (Support.All.pipe_left (fun ( _106_1482 ) -> Some (_106_1482)) _106_1484))
in (solve_prob orig _106_1485 [] wl))
in (solve env (attempt ((base_prob)::[]) wl))))))
end)
end)))
end)
...
| true -> begin
(let _106_1495 = (prob_to_string env orig)
...
(let maybe_vars1 = (pat_vars env [] args1)
in (let sub_problems = (fun ( xs ) ( args2 ) -> (let _35_3212 = (let _106_1511 = (Support.All.pipe_right args2 (Support.List.map (fun ( _35_34 ) -> (match (_35_34) with
...
in (let _106_1507 = (let _106_1506 = (sub_prob gi_pi t "type index")
in (Support.All.pipe_left (fun ( _106_1505 ) -> TProb (_106_1505)) _106_1506))
in ((Support.Microsoft.FStar.Util.Inl (gi_xi), imp), _106_1507)))
end)))
end
...
in (let _106_1510 = (let _106_1509 = (sub_prob gi_pi v "expression index")
in (Support.All.pipe_left (fun ( _106_1508 ) -> EProb (_106_1508)) _106_1509))
in ((Support.Microsoft.FStar.Util.Inr (gi_xi), imp), _106_1510)))
end)))
end))))
in (Support.All.pipe_right _106_1511 Support.List.unzip))
in (match (_35_3212) with
| (gi_xi, gi_pi) -> begin
(let formula = (let _106_1513 = (Support.List.map (fun ( p ) -> (Support.All.pipe_right (p_guard p) Support.Prims.fst)) gi_pi)
in (Microsoft_FStar_Absyn_Util.mk_conj_l _106_1513))
in (gi_xi, gi_pi, formula))
end)))
in (let project_e = (fun ( head2 ) ( args2 ) -> (let giveup = (fun ( reason ) -> (let _106_1520 = (Support.Microsoft.FStar.Util.format1 "flex-rigid: refusing to project expressions (%s)" reason)
in (giveup env _106_1520 orig)))
in (match ((let _106_1521 = (Microsoft_FStar_Absyn_Util.compress_exp head2)
in _106_1521.Microsoft_FStar_Absyn_Syntax.n)) with
...
| true -> begin
(let _106_1524 = (let _106_1523 = (Microsoft_FStar_Absyn_Print.binders_to_string ", " all_xs)
in (let _106_1522 = (Microsoft_FStar_Absyn_Print.args_to_string args2)
in (Support.Microsoft.FStar.Util.format2 "unequal arity:\n\texpetced binders %s\n\tgot args {%s}" _106_1523 _106_1522)))
in (giveup _106_1524))
end
| false -> begin
...
(match ((let _106_1529 = (Microsoft_FStar_Absyn_Util.compress_exp arg)
in _106_1529.Microsoft_FStar_Absyn_Syntax.n)) with
...
| (gi_xi, gi_pi, f) -> begin
(let sol = (let _106_1533 = (let _106_1532 = (let _106_1531 = (let _106_1530 = (Microsoft_FStar_Absyn_Util.bvar_to_exp xi)
in (_106_1530, gi_xi))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_app' _106_1531 None e1.Microsoft_FStar_Absyn_Syntax.pos))
in (all_xs, _106_1532))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_abs _106_1533 None e1.Microsoft_FStar_Absyn_Syntax.pos))
in (let _35_3283 = (match ((Support.All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Rel")))) with
| true -> begin
(let _106_1537 = (Microsoft_FStar_Absyn_Print.uvar_e_to_string (u1, t1))
in (let _106_1536 = (Microsoft_FStar_Absyn_Print.exp_to_string sol)
in (let _106_1535 = (let _106_1534 = (Support.All.pipe_right gi_pi (Support.List.map (prob_to_string env)))
in (Support.All.pipe_right _106_1534 (Support.String.concat "\n")))
in (Support.Microsoft.FStar.Util.fprint3 "Projected: %s -> %s\nSubprobs=\n%s\n" _106_1537 _106_1536 _106_1535))))
end
| false -> begin
()
end)
in (let _106_1539 = (let _106_1538 = (solve_prob orig (Some (f)) ((UE (((u1, t1), sol)))::[]) wl)
in (attempt gi_pi _106_1538))
in (solve env _106_1539))))
end))
end
| false -> begin
(aux xs args)
...
| (x::xs, arg::args) -> begin
(let _106_1542 = (let _106_1541 = (Microsoft_FStar_Absyn_Print.binder_to_string x)
in (let _106_1540 = (Microsoft_FStar_Absyn_Print.arg_to_string arg)
...
| true -> begin
(let _106_1546 = (Microsoft_FStar_Absyn_Print.exp_to_string e1)
in (let _106_1545 = (Microsoft_FStar_Absyn_Print.exp_to_string e2)
...
| _35_3323 -> begin
(let _106_1548 = (let _106_1547 = (Microsoft_FStar_Absyn_Syntax.mk_Exp_app' (head2, gi_xi) None e1.Microsoft_FStar_Absyn_Syntax.pos)
in (xs, _106_1547))
in (Microsoft_FStar_Absyn_Syntax.mk_Exp_abs _106_1548 None e1.Microsoft_FStar_Absyn_Syntax.pos))
end))
in (let _35_3325 = (match ((Support.All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Rel")))) with
| true -> begin
(let _106_1552 = (Microsoft_FStar_Absyn_Print.uvar_e_to_string (u1, t1))
in (let _106_1551 = (Microsoft_FStar_Absyn_Print.exp_to_string sol)
in (let _106_1550 = (let _106_1549 = (Support.All.pipe_right gi_pi (Support.List.map (prob_to_string env)))
in (Support.All.pipe_right _106_1549 (Support.String.concat "\n")))
in (Support.Microsoft.FStar.Util.fprint3 "Imitated: %s -> %s\nSubprobs=\n%s\n" _106_1552 _106_1551 _106_1550))))
end
| false -> begin
()
end)
in (let _106_1554 = (let _106_1553 = (solve_prob orig (Some (f)) ((UE (((u1, t1), sol)))::[]) wl)
in (attempt gi_pi _106_1553))
in (solve env _106_1554))))
end))
end))
end
| false -> begin
...
in (let _106_1555 = (solve_prob orig None ((UE (((u1, t1), sol)))::[]) wl)
in (solve env _106_1555)))
end
| false -> begin
(imitate_or_project_e ())
end)
...
in (let _35_3370 = (let _106_1560 = (Microsoft_FStar_Tc_Env.get_range env)
in (new_evar _106_1560 zs tt))
...
in (let _106_1561 = (solve_prob orig None ((UE (((u1, t1), sub1)))::(UE (((u2, t2), sub2)))::[]) wl)
in (solve env _106_1561))))
end))))
end)
end)))
end))
...
| true -> begin
(let _106_1566 = (prob_to_string env orig)
in (Support.Microsoft.FStar.Util.fprint1 "Using SMT to solve:\n%s\n" _106_1566))
end
| false -> begin
()
end)
in (let _35_3381 = (let _106_1568 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _106_1567 = (Microsoft_FStar_Tc_Env.binders env)
in (new_tvar _106_1568 _106_1567 Microsoft_FStar_Absyn_Syntax.ktype)))
in (match (_35_3381) with
| (t, _35_3380) -> begin
(let _106_1572 = (let _106_1571 = (let _106_1570 = (Microsoft_FStar_Absyn_Util.mk_eq t t e1 e2)
in (Support.All.pipe_left (fun ( _106_1569 ) -> Some (_106_1569)) _106_1570))
in (solve_prob orig _106_1571 [] wl))
in (solve env _106_1572))
end)))
end
| false -> begin
...
(let _106_1574 = (destruct_flex_e e1)
in (let _106_1573 = (destruct_flex_e e2)
in (flex_flex _106_1574 _106_1573)))
end
...
(let _106_1575 = (destruct_flex_e e1)
in (flex_rigid _106_1575 e2))
end
...
(let _106_1576 = (destruct_flex_e e2)
in (flex_rigid _106_1576 e1))
end
...
| true -> begin
(let _106_1577 = (solve_prob orig None [] wl)
in (solve env _106_1577))
end
| false -> begin
(let _106_1583 = (let _106_1582 = (let _106_1581 = (let _106_1580 = (Microsoft_FStar_Tc_Recheck.recompute_typ e1)
in (let _106_1579 = (Microsoft_FStar_Tc_Recheck.recompute_typ e2)
in (Microsoft_FStar_Absyn_Util.mk_eq _106_1580 _106_1579 e1 e2)))
in (Support.All.pipe_left (fun ( _106_1578 ) -> Some (_106_1578)) _106_1581))
in (solve_prob orig _106_1582 [] wl))
in (solve env _106_1583))
end)
end
...
| true -> begin
(let _106_1584 = (solve_prob orig None [] wl)
in (solve env _106_1584))
end
| false -> begin
...
| true -> begin
(let _106_1589 = (solve_prob orig None [] wl)
in (solve env _106_1589))
end
| false -> begin
...
(let _106_1591 = (let _35_3603 = problem
in (let _106_1590 = (whnf_e env e1)
in {lhs = _106_1590; relation = _35_3603.relation; rhs = _35_3603.rhs; element = _35_3603.element; logical_guard = _35_3603.logical_guard; scope = _35_3603.scope; reason = _35_3603.reason; loc = _35_3603.loc; rank = _35_3603.rank}))
in (solve_e env _106_1591 wl))
end
...
(let _106_1593 = (let _35_3624 = problem
in (let _106_1592 = (whnf_e env e2)
in {lhs = _35_3624.lhs; relation = _35_3624.relation; rhs = _106_1592; element = _35_3624.element; logical_guard = _35_3624.logical_guard; scope = _35_3624.scope; reason = _35_3624.reason; loc = _35_3624.loc; rank = _35_3624.rank}))
in (solve_e env _106_1593 wl))
end
...
| ([], []) -> begin
(let guard = (let _106_1603 = (let _106_1602 = (Support.List.map p_guard sub_probs)
in (Support.All.pipe_right _106_1602 (Support.List.map Support.Prims.fst)))
in (Microsoft_FStar_Absyn_Util.mk_conj_l _106_1603))
...
(let _106_1604 = (solve_prob orig None wl.subst (let _35_3649 = orig_wl
...
in (solve env _106_1604))
end
| _35_3652 -> begin
(let _35_3656 = (let _106_1606 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _106_1605 = (Microsoft_FStar_Tc_Env.binders env)
in (new_tvar _106_1606 _106_1605 Microsoft_FStar_Absyn_Syntax.ktype)))
in (match (_35_3656) with
| (t, _35_3655) -> begin
(let guard = (let _106_1607 = (Microsoft_FStar_Absyn_Util.mk_eq t t e1 e2)
in (Microsoft_FStar_Absyn_Util.mk_disj g _106_1607))
in (let _106_1608 = (solve_prob orig (Some (guard)) wl.subst (let _35_3658 = orig_wl
...
| (Support.Microsoft.FStar.Util.Inl (t1), Support.Microsoft.FStar.Util.Inl (t2)) -> begin
(let _106_1610 = (mk_problem (p_scope orig) orig t1 EQ t2 None "expression type arg")
in (Support.All.pipe_left (fun ( _106_1609 ) -> TProb (_106_1609)) _106_1610))
end
| (Support.Microsoft.FStar.Util.Inr (e1), Support.Microsoft.FStar.Util.Inr (e2)) -> begin
(let _106_1612 = (mk_problem (p_scope orig) orig e1 EQ e2 None "expression arg")
in (Support.All.pipe_left (fun ( _106_1611 ) -> EProb (_106_1611)) _106_1612))
end
| _35_3678 -> begin
...
in (let rec match_head_and_args = (fun ( head1 ) ( head2 ) -> (match ((let _106_1620 = (let _106_1617 = (Microsoft_FStar_Absyn_Util.compress_exp head1)
in _106_1617.Microsoft_FStar_Absyn_Syntax.n)
in (let _106_1619 = (let _106_1618 = (Microsoft_FStar_Absyn_Util.compress_exp head2)
in _106_1618.Microsoft_FStar_Absyn_Syntax.n)
in (_106_1620, _106_1619)))) with
...
(let _106_1622 = (let _35_3739 = problem
in (let _106_1621 = (whnf_e env e1)
in {lhs = _106_1621; relation = _35_3739.relation; rhs = _35_3739.rhs; element = _35_3739.element; logical_guard = _35_3739.logical_guard; scope = _35_3739.scope; reason = _35_3739.reason; loc = _35_3739.loc; rank = _35_3739.rank}))
in (solve_e env _106_1622 wl))
end
| (_35_3742, Microsoft_FStar_Absyn_Syntax.Exp_abs (_35_3744)) -> begin
(let _106_1624 = (let _35_3747 = problem
in (let _106_1623 = (whnf_e env e2)
in {lhs = _35_3747.lhs; relation = _35_3747.relation; rhs = _106_1623; element = _35_3747.element; logical_guard = _35_3747.logical_guard; scope = _35_3747.scope; reason = _35_3747.reason; loc = _35_3747.loc; rank = _35_3747.rank}))
in (solve_e env _106_1624 wl))
end
| _35_3750 -> begin
(smt_fallback e1 e2)
end))
...
| _35_3752 -> begin
(let _35_3756 = (let _106_1626 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _106_1625 = (Microsoft_FStar_Tc_Env.binders env)
in (new_tvar _106_1626 _106_1625 Microsoft_FStar_Absyn_Syntax.ktype)))
...
| true -> begin
(let _106_1627 = (Microsoft_FStar_Absyn_Print.typ_to_string guard)
in (Support.Microsoft.FStar.Util.fprint1 "Emitting guard %s\n" _106_1627))
end
| false -> begin
()
end)
in (let _106_1631 = (let _106_1630 = (let _106_1629 = (Microsoft_FStar_Absyn_Util.mk_eq t t e1 e2)
in (Support.All.pipe_left (fun ( _106_1628 ) -> Some (_106_1628)) _106_1629))
in (solve_prob orig _106_1630 [] wl))
in (solve env _106_1631))))
end))
end)))))))))))
...
in (let carry = (let _106_1662 = (Support.List.map (fun ( _35_3776 ) -> (match (_35_3776) with
| (_35_3774, x) -> begin
(prob_to_string env x)
end)) g.deferred.carry)
in (Support.All.pipe_right _106_1662 (Support.String.concat ",\n")))
...
in (let _106_1679 = (let _35_3807 = g
in (let _106_1678 = (let _106_1677 = (let _106_1676 = (let _106_1675 = (let _106_1674 = (Microsoft_FStar_Absyn_Syntax.v_binder x)
in (_106_1674)::[])
in (_106_1675, f))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_lam _106_1676 None f.Microsoft_FStar_Absyn_Syntax.pos))
in (Support.All.pipe_left (fun ( _106_1673 ) -> NonTrivial (_106_1673)) _106_1677))
in {guard_f = _106_1678; deferred = _35_3807.deferred; implicits = _35_3807.implicits}))
in Some (_106_1679)))
end))
...
| NonTrivial (f) -> begin
(let _35_3814 = g
in (let _106_1691 = (let _106_1690 = (let _106_1689 = (let _106_1688 = (let _106_1687 = (let _106_1686 = (Microsoft_FStar_Absyn_Syntax.varg e)
in (_106_1686)::[])
in (f, _106_1687))
in (Microsoft_FStar_Absyn_Syntax.mk_Typ_app _106_1688))
in (Support.All.pipe_left (Microsoft_FStar_Absyn_Syntax.syn f.Microsoft_FStar_Absyn_Syntax.pos (Some (Microsoft_FStar_Absyn_Syntax.ktype))) _106_1689))
in NonTrivial (_106_1690))
in {guard_f = _106_1691; deferred = _35_3814.deferred; implicits = _35_3814.implicits}))
end))
...
(let _106_1698 = (Microsoft_FStar_Absyn_Util.mk_conj f1 f2)
in NonTrivial (_106_1698))
end))
...
let binop_guard = (fun ( f ) ( g1 ) ( g2 ) -> (let _106_1721 = (f g1.guard_f g2.guard_f)
in {guard_f = _106_1721; deferred = {carry = (Support.List.append g1.deferred.carry g2.deferred.carry); slack = (Support.List.append g1.deferred.slack g2.deferred.slack)}; implicits = (Support.List.append g1.implicits g2.implicits)}))
...
| NonTrivial (f) -> begin
(let _35_3864 = g
in (let _106_1736 = (let _106_1735 = (Microsoft_FStar_Absyn_Util.close_forall binders f)
in (Support.All.pipe_right _106_1735 (fun ( _106_1734 ) -> NonTrivial (_106_1734))))
in {guard_f = _106_1736; deferred = _35_3864.deferred; implicits = _35_3864.implicits}))
end))
...
| true -> begin
(let _106_1748 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env lhs)
in (let _106_1747 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env rhs)
in (Support.Microsoft.FStar.Util.format3 "Top-level:\n%s\n\t%s\n%s" _106_1748 (rel_to_string rel) _106_1747)))
end
| false -> begin
"TOP"
end)
...
let new_t_prob = (fun ( env ) ( t1 ) ( rel ) ( t2 ) -> (let x = (let _106_1757 = (Microsoft_FStar_Tc_Env.get_range env)
in (Microsoft_FStar_Absyn_Util.gen_bvar_p _106_1757 t1))
...
in (let p = (let _106_1761 = (let _106_1759 = (Microsoft_FStar_Absyn_Util.bvar_to_exp x)
in (Support.All.pipe_left (fun ( _106_1758 ) -> Some (_106_1758)) _106_1759))
in (let _106_1760 = (Microsoft_FStar_Tc_Env.get_range env)
in (new_t_problem env t1 rel t2 _106_1761 _106_1760)))
in (TProb (p), x)))))
...
| true -> begin
(let _106_1769 = (Microsoft_FStar_Tc_Normalize.kind_norm_to_string env lhs)
in (let _106_1768 = (Microsoft_FStar_Tc_Normalize.kind_norm_to_string env rhs)
in (Support.Microsoft.FStar.Util.format3 "Top-level:\n%s\n\t%s\n%s" _106_1769 (rel_to_string rel) _106_1768)))
end
| false -> begin
"TOP"
end)
...
| true -> begin
(let _106_1774 = (Microsoft_FStar_Absyn_Print.typ_to_string f)
...
| true -> begin
(let _106_1786 = (explain env d s)
in (Support.All.pipe_left Support.Microsoft.FStar.Util.print_string _106_1786))
end
| false -> begin
()
end)
...
| Some (d) -> begin
(let _106_1798 = (let _106_1797 = (let _106_1796 = (let _106_1795 = (Support.All.pipe_right (p_guard prob) Support.Prims.fst)
in (Support.All.pipe_right _106_1795 (fun ( _106_1794 ) -> NonTrivial (_106_1794))))
in {guard_f = _106_1796; deferred = d; implicits = []})
in (simplify_guard env _106_1797))
in (Support.All.pipe_left (fun ( _106_1793 ) -> Some (_106_1793)) _106_1798))
end))
...
| true -> begin
(let _106_1806 = (Microsoft_FStar_Absyn_Print.kind_to_string k1)
in (let _106_1805 = (Microsoft_FStar_Absyn_Print.kind_to_string k2)
in (Support.Microsoft.FStar.Util.fprint2 "try_keq of %s and %s\n" _106_1806 _106_1805)))
end
| false -> begin
()
end)
in (let prob = (let _106_1811 = (let _106_1810 = (Microsoft_FStar_Tc_Normalize.norm_kind ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env k1)
in (let _106_1809 = (Microsoft_FStar_Tc_Normalize.norm_kind ((Microsoft_FStar_Tc_Normalize.Beta)::[]) env k2)
in (let _106_1808 = (Microsoft_FStar_Tc_Env.get_range env)
in (new_k_problem env _106_1810 EQ _106_1809 None _106_1808))))
in (Support.All.pipe_left (fun ( _106_1807 ) -> KProb (_106_1807)) _106_1811))
in (let _106_1813 = (solve_and_commit env (singleton env prob) (fun ( _35_3939 ) -> None))
in (Support.All.pipe_left (with_guard env prob) _106_1813)))))
...
in (match (t) with
| None -> begin
(let _106_1824 = (let _106_1823 = (let _106_1822 = (Microsoft_FStar_Tc_Errors.incompatible_kinds env k2 k1)
in (_106_1822, r))
in Microsoft_FStar_Absyn_Syntax.Error (_106_1823))
in (raise (_106_1824)))
end
| Some (t) -> begin
(let _106_1827 = (let _106_1826 = (let _106_1825 = (Microsoft_FStar_Tc_Errors.expected_typ_of_kind env k2 t k1)
in (_106_1825, r))
in Microsoft_FStar_Absyn_Syntax.Error (_106_1826))
in (raise (_106_1827)))
end))
end
| Some (g) -> begin
...
| true -> begin
(let _106_1837 = (let _106_1834 = (Microsoft_FStar_Tc_Env.get_range env)
in (Support.All.pipe_left Support.Microsoft.FStar.Range.string_of_range _106_1834))
in (let _106_1836 = (Microsoft_FStar_Absyn_Print.kind_to_string k1)
in (let _106_1835 = (Microsoft_FStar_Absyn_Print.kind_to_string k2)
in (Support.Microsoft.FStar.Util.fprint3 "(%s) subkind of %s and %s\n" _106_1837 _106_1836 _106_1835))))
end
| false -> begin
()
end)
in (let prob = (let _106_1842 = (let _106_1841 = (whnf_k env k1)
in (let _106_1840 = (whnf_k env k2)
in (let _106_1839 = (Microsoft_FStar_Tc_Env.get_range env)
in (new_k_problem env _106_1841 SUB _106_1840 None _106_1839))))
in (Support.All.pipe_left (fun ( _106_1838 ) -> KProb (_106_1838)) _106_1842))
in (let res = (let _106_1849 = (let _106_1848 = (solve_and_commit env (singleton env prob) (fun ( _35_3961 ) -> (let _106_1847 = (let _106_1846 = (let _106_1845 = (Microsoft_FStar_Tc_Errors.incompatible_kinds env k1 k2)
in (let _106_1844 = (Microsoft_FStar_Tc_Env.get_range env)
in (_106_1845, _106_1844)))
in Microsoft_FStar_Absyn_Syntax.Error (_106_1846))
in (raise (_106_1847)))))
in (Support.All.pipe_left (with_guard env prob) _106_1848))
in (Support.Microsoft.FStar.Util.must _106_1849))
in res))))
...
| true -> begin
(let _106_1857 = (Microsoft_FStar_Absyn_Print.typ_to_string t1)
in (let _106_1856 = (Microsoft_FStar_Absyn_Print.typ_to_string t2)
in (Support.Microsoft.FStar.Util.fprint2 "try_teq of %s and %s\n" _106_1857 _106_1856)))
end
| false -> begin
()
end)
in (let prob = (let _106_1860 = (let _106_1859 = (Microsoft_FStar_Tc_Env.get_range env)
in (new_t_problem env t1 EQ t2 None _106_1859))
in (Support.All.pipe_left (fun ( _106_1858 ) -> TProb (_106_1858)) _106_1860))
in (let g = (let _106_1862 = (solve_and_commit env (singleton env prob) (fun ( _35_3970 ) -> None))
in (Support.All.pipe_left (with_guard env prob) _106_1862))
in g))))

let teq = (fun ( env ) ( t1 ) ( t2 ) -> (match ((try_teq env t1 t2)) with
| None -> begin
(let _106_1872 = (let _106_1871 = (let _106_1870 = (Microsoft_FStar_Tc_Errors.basic_type_error env None t2 t1)
in (let _106_1869 = (Microsoft_FStar_Tc_Env.get_range env)
in (_106_1870, _106_1869)))
in Microsoft_FStar_Absyn_Syntax.Error (_106_1871))
in (raise (_106_1872)))
end
| Some (g) -> begin
(let _35_3979 = (match ((Support.All.pipe_left (Microsoft_FStar_Tc_Env.debug env) (Microsoft_FStar_Options.Other ("Rel")))) with
| true -> begin
(let _106_1875 = (Microsoft_FStar_Absyn_Print.typ_to_string t1)
in (let _106_1874 = (Microsoft_FStar_Absyn_Print.typ_to_string t2)
in (let _106_1873 = (guard_to_string env g)
in (Support.Microsoft.FStar.Util.fprint3 "teq of %s and %s succeeded with guard %s\n" _106_1875 _106_1874 _106_1873))))
end
| false -> begin
()
end)
...
| true -> begin
(let _106_1883 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env t1)
in (let _106_1882 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env t2)
...
| (prob, x) -> begin
(let g = (let _106_1885 = (solve_and_commit env (singleton env prob) (fun ( _35_3989 ) -> None))
in (Support.All.pipe_left (with_guard env prob) _106_1885))
...
| true -> begin
(let _106_1889 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env t1)
in (let _106_1888 = (Microsoft_FStar_Tc_Normalize.typ_norm_to_string env t2)
in (let _106_1887 = (let _106_1886 = (Support.Microsoft.FStar.Util.must g)
in (guard_to_string env _106_1886))
in (Support.Microsoft.FStar.Util.fprint3 "try_subtype succeeded: %s <: %s\n\tguard is %s\n" _106_1889 _106_1888 _106_1887))))
end
| false -> begin
()
end)
...
let subtype_fail = (fun ( env ) ( t1 ) ( t2 ) -> (let _106_1896 = (let _106_1895 = (let _106_1894 = (Microsoft_FStar_Tc_Errors.basic_type_error env None t2 t1)
in (let _106_1893 = (Microsoft_FStar_Tc_Env.get_range env)
in (_106_1894, _106_1893)))
in Microsoft_FStar_Absyn_Syntax.Error (_106_1895))
in (raise (_106_1896))))
...
| true -> begin
(let _106_1910 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string c1)
in (let _106_1909 = (Microsoft_FStar_Absyn_Print.comp_typ_to_string c2)
...
in (let prob = (let _106_1913 = (let _106_1912 = (Microsoft_FStar_Tc_Env.get_range env)
in (new_problem env c1 rel c2 None _106_1912 "sub_comp"))
in (Support.All.pipe_left (fun ( _106_1911 ) -> CProb (_106_1911)) _106_1913))
in (let _106_1915 = (solve_and_commit env (singleton env prob) (fun ( _35_4010 ) -> None))
in (Support.All.pipe_left (with_guard env prob) _106_1915))))))
...
| true -> begin
(let _106_1928 = (let _106_1927 = (Support.All.pipe_right g.deferred.carry (Support.List.map (fun ( _35_4021 ) -> (match (_35_4021) with
| (msg, x) -> begin
(let _106_1926 = (Support.All.pipe_left Support.Microsoft.FStar.Range.string_of_range (p_loc x))
in (let _106_1925 = (prob_to_string env x)
in (let _106_1924 = (let _106_1923 = (Support.All.pipe_right (p_guard x) Support.Prims.fst)
in (Microsoft_FStar_Tc_Normalize.formula_norm_to_string env _106_1923))
in (Support.Microsoft.FStar.Util.format4 "(At %s) %s\n%s\nguard is %s\n" _106_1926 msg _106_1925 _106_1924))))
end))))
in (Support.All.pipe_right _106_1927 (Support.String.concat "\n")))
in (Support.All.pipe_left (Support.Microsoft.FStar.Util.fprint1 "Trying to solve carried problems: begin\n%s\nend\n") _106_1928))
end
| false -> begin
()
end)
in (let gopt = (let _106_1929 = (wl_of_guard env g.deferred)
in (solve_and_commit env _106_1929 fail))
in (match (gopt) with
...
| true -> begin
(let _106_1936 = (Microsoft_FStar_Tc_Env.get_range env)
in (let _106_1935 = (let _106_1934 = (Microsoft_FStar_Absyn_Print.formula_to_string vc)
in (Support.Microsoft.FStar.Util.format1 "Checking VC=\n%s\n" _106_1934))
in (Microsoft_FStar_Tc_Errors.diag _106_1936 _106_1935)))
end
| false -> begin
()
end)
