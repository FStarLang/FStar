...
# 40 "extractmod.fs"
let _80_16 = (FStar_Extraction_ML_Env.debug g (fun u -> (let _182_24 = (let _182_23 = (FStar_Absyn_Print.sigelt_to_string se)
...
in (
# 59 "extractmod.fs"
let env = (let _182_33 = (let _182_31 = (FStar_Util.right lbname)
in (FStar_All.pipe_left FStar_Absyn_Util.fv _182_31))
in (let _182_32 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_Env.extend_fv' env _182_33 mname _182_32 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit false)))
in (env, (
# 60 "extractmod.fs"
let _80_71 = ml_lb
...
(let _182_36 = (let _182_35 = (let _182_34 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_Env.extend_lb env lbname t _182_34 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit false))
in (FStar_All.pipe_left Prims.fst _182_35))
in (_182_36, ml_lb))
end
...
| (g, ml_lbs') -> begin
(let _182_39 = (let _182_38 = (let _182_37 = (FStar_Extraction_ML_ExtractTyp.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_182_37))
in (_182_38)::(FStar_Extraction_ML_Syntax.MLM_Let (((Prims.fst ml_lbs), (FStar_List.rev ml_lbs'))))::[])
in (g, _182_39))
end))
end
| _80_80 -> begin
...
| Some (bs, c) -> begin
(let _182_41 = (let _182_40 = (fail_exp lid (FStar_Absyn_Util.comp_result c))
in (bs, _182_40))
in (FStar_Absyn_Syntax.mk_Exp_abs _182_41 None FStar_Absyn_Syntax.dummyRange))
end
| _80_92 -> begin
(fail_exp lid t)
end)
...
(let _182_48 = (let _182_47 = (let _182_44 = (FStar_Extraction_ML_ExtractTyp.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_182_44))
in (let _182_46 = (let _182_45 = (FStar_Extraction_ML_ExtractExp.ind_discriminator_body g lid l)
in (_182_45)::[])
in (_182_47)::_182_46))
in (g, _182_48))
end
...
(let _182_52 = (let _182_51 = (let _182_50 = (FStar_Extraction_ML_ExtractTyp.mlloc_of_range r)
in FStar_Extraction_ML_Syntax.MLM_Loc (_182_50))
in (_182_51)::(FStar_Extraction_ML_Syntax.MLM_Top (ml_main))::[])
in (g, _182_52))
end))
end
...
# 102 "extractmod.fs"
let extract_iface : FStar_Extraction_ML_Env.env  ->  FStar_Absyn_Syntax.modul  ->  FStar_Extraction_ML_Env.env = (fun g m -> (let _182_57 = (FStar_Util.fold_map extract_sig g m.FStar_Absyn_Syntax.declarations)
in (FStar_All.pipe_right _182_57 Prims.fst)))
...
# 105 "extractmod.fs"
let _80_159 = (FStar_Absyn_Util.reset_gensym ())
in (
# 106 "extractmod.fs"
...
in if (((m.FStar_Absyn_Syntax.name.FStar_Ident.str = "Prims") || m.FStar_Absyn_Syntax.is_interface) || (let _182_62 = (FStar_ST.read FStar_Options.admit_fsi)
in (FStar_List.contains m.FStar_Absyn_Syntax.name.FStar_Ident.str _182_62))) then begin
(
# 111 "extractmod.fs"
...
in (let _182_67 = (let _182_66 = (let _182_65 = (let _182_64 = (let _182_63 = (FStar_Extraction_ML_Util.flatten_mlpath name)
in (_182_63, Some (([], mlm)), FStar_Extraction_ML_Syntax.MLLib ([])))
in (_182_64)::[])
in FStar_Extraction_ML_Syntax.MLLib (_182_65))
in (_182_66)::[])
in (g, _182_67)))
end))
end))))
