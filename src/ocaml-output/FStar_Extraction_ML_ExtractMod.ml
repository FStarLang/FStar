...
let _63_81 = (FStar_List.fold_left2 (fun _63_54 ml_lb _63_62 -> (match ((_63_54, _63_62)) with
...
let _63_78 = if (FStar_All.pipe_right quals (FStar_Util.for_some (fun _63_1 -> (match (_63_1) with
...
# 60 "FStar.Extraction.ML.ExtractMod.fst"
let _63_71 = ml_lb
in {FStar_Extraction_ML_Syntax.mllb_name = _63_71.FStar_Extraction_ML_Syntax.mllb_name; FStar_Extraction_ML_Syntax.mllb_tysc = _63_71.FStar_Extraction_ML_Syntax.mllb_tysc; FStar_Extraction_ML_Syntax.mllb_add_unit = _63_71.FStar_Extraction_ML_Syntax.mllb_add_unit; FStar_Extraction_ML_Syntax.mllb_def = _63_71.FStar_Extraction_ML_Syntax.mllb_def; FStar_Extraction_ML_Syntax.print_typ = false})
in (env, (
# 61 "FStar.Extraction.ML.ExtractMod.fst"
let _63_74 = ml_lb
in {FStar_Extraction_ML_Syntax.mllb_name = ((Prims.snd mname), 0); FStar_Extraction_ML_Syntax.mllb_tysc = _63_74.FStar_Extraction_ML_Syntax.mllb_tysc; FStar_Extraction_ML_Syntax.mllb_add_unit = _63_74.FStar_Extraction_ML_Syntax.mllb_add_unit; FStar_Extraction_ML_Syntax.mllb_def = _63_74.FStar_Extraction_ML_Syntax.mllb_def; FStar_Extraction_ML_Syntax.print_typ = _63_74.FStar_Extraction_ML_Syntax.print_typ})))))
end else begin
...
| FStar_Absyn_Syntax.Projector (l, _63_120) -> begin
Some (l)
end
| _63_124 -> begin
None
...
let _63_139 = (FStar_Extraction_ML_ExtractExp.synth_exp g e)
in (match (_63_139) with
| (ml_main, _63_136, _63_138) -> begin
...
let _63_162 = (FStar_Absyn_Util.reset_gensym ())
in (
...
# 108 "FStar.Extraction.ML.ExtractMod.fst"
let _63_165 = g
in {FStar_Extraction_ML_Env.tcenv = _63_165.FStar_Extraction_ML_Env.tcenv; FStar_Extraction_ML_Env.gamma = _63_165.FStar_Extraction_ML_Env.gamma; FStar_Extraction_ML_Env.tydefs = _63_165.FStar_Extraction_ML_Env.tydefs; FStar_Extraction_ML_Env.currentModule = name})
...
let _63_171 = (FStar_Util.fold_map extract_sig g m.FStar_Absyn_Syntax.declarations)
in (match (_63_171) with
| (g, sigs) -> begin
(
