...
let fail_exp = (fun lid t -> (let _132_16 = (let _132_15 = (FStar_Absyn_Util.fvar None FStar_Absyn_Const.failwith_lid FStar_Absyn_Syntax.dummyRange)
in (let _132_14 = (let _132_13 = (FStar_Absyn_Syntax.targ t)
in (let _132_12 = (let _132_11 = (let _132_10 = (let _132_9 = (let _132_8 = (let _132_7 = (let _132_6 = (let _132_5 = (FStar_Absyn_Print.sli lid)
in (Prims.strcat "Not yet implemented:" _132_5))
in (FStar_Bytes.string_as_unicode_bytes _132_6))
in (_132_7, FStar_Absyn_Syntax.dummyRange))
in FStar_Absyn_Syntax.Const_string (_132_8))
in (FStar_Absyn_Syntax.mk_Exp_constant _132_9 None FStar_Absyn_Syntax.dummyRange))
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _132_10))
in (_132_11)::[])
in (_132_13)::_132_12))
in (_132_15, _132_14)))
in (FStar_Absyn_Syntax.mk_Exp_app _132_16 None FStar_Absyn_Syntax.dummyRange)))
...
let rec extract_sig = (fun g se -> (let _63_16 = (FStar_Extraction_ML_Env.debug g (fun u -> (let _132_25 = (let _132_24 = (FStar_Absyn_Print.sigelt_to_string se)
in (FStar_Util.format1 "now extracting :  %s \n" _132_24))
in (FStar_Util.print_string _132_25))))
in (match (se) with
...
| true -> begin
(let mname = (let _132_31 = (let _132_30 = (FStar_Util.right lbname)
in (mangle_projector_lid _132_30))
in (FStar_All.pipe_right _132_31 FStar_Extraction_ML_Syntax.mlpath_of_lident))
in (let env = (let _132_34 = (let _132_32 = (FStar_Util.right lbname)
in (FStar_All.pipe_left FStar_Absyn_Util.fv _132_32))
in (let _132_33 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_Env.extend_fv' env _132_34 mname _132_33 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit)))
...
| false -> begin
(let _132_37 = (let _132_36 = (let _132_35 = (FStar_Util.must ml_lb.FStar_Extraction_ML_Syntax.mllb_tysc)
in (FStar_Extraction_ML_Env.extend_lb env lbname t _132_35 ml_lb.FStar_Extraction_ML_Syntax.mllb_add_unit))
in (FStar_All.pipe_left Prims.fst _132_36))
in (_132_37, ml_lb))
end)
...
| Some (bs, c) -> begin
(let _132_39 = (let _132_38 = (fail_exp lid (FStar_Absyn_Util.comp_result c))
in (bs, _132_38))
in (FStar_Absyn_Syntax.mk_Exp_abs _132_39 None FStar_Absyn_Syntax.dummyRange))
end
| _63_92 -> begin
(fail_exp lid t)
end)
...
(let _132_43 = (let _132_42 = (FStar_Extraction_ML_ExtractExp.ind_discriminator_body g lid l)
in (_132_42)::[])
in (g, _132_43))
end
| _63_113 -> begin
...
let extract_iface = (fun g m -> (let _132_49 = (FStar_Util.fold_map extract_sig g m.FStar_Absyn_Syntax.declarations)
in (FStar_All.pipe_right _132_49 Prims.fst)))
...
in (match ((((m.FStar_Absyn_Syntax.name.FStar_Absyn_Syntax.str = "Prims") || m.FStar_Absyn_Syntax.is_interface) || (let _132_54 = (FStar_ST.read FStar_Options.admit_fsi)
in (FStar_List.contains m.FStar_Absyn_Syntax.name.FStar_Absyn_Syntax.str _132_54)))) with
| true -> begin
...
in (let _132_59 = (let _132_58 = (let _132_57 = (let _132_56 = (let _132_55 = (FStar_Extraction_ML_Util.flatten_mlpath name)
in (_132_55, Some (([], mlm)), FStar_Extraction_ML_Syntax.MLLib ([])))
in (_132_56)::[])
in FStar_Extraction_ML_Syntax.MLLib (_132_57))
in (_132_58)::[])
in (g, _132_59)))
end))
end)))))
