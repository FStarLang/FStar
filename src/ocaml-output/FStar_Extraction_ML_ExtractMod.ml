...
in (let _165_67 = (let _165_66 = (let _165_65 = (let _165_64 = (let _165_63 = (FStar_Extraction_ML_Util.flatten_mlpath name)
in (_165_63, Some (([], mlm)), FStar_Extraction_ML_Syntax.MLLib ([])))
in (_165_64)::[])
in FStar_Extraction_ML_Syntax.MLLib (_165_65))
in (_165_66)::[])
in (g, _165_67)))
end))
end))))
