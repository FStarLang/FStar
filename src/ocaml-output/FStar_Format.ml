...
(let _119_22 = (text "[")
in (let _119_21 = (text "]")
in (enclose _119_22 _119_21 (Doc (d)))))
end))
...
(let _119_26 = (text "{")
in (let _119_25 = (text "}")
in (enclose _119_26 _119_25 (Doc (d)))))
end))
...
(let _119_30 = (text "(")
in (let _119_29 = (text ")")
in (enclose _119_30 _119_29 (Doc (d)))))
end))
...
# 63 "FStar.Format.fst"
let groups : doc Prims.list  ->  doc = (fun docs -> (let _119_41 = (reduce docs)
in (group _119_41)))
