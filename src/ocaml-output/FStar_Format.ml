...
type doc = Doc of Prims.string [@@deriving show]
...
let enclose : doc -> doc -> doc -> doc =
  fun uu____27 uu____28 uu____29 ->
    match (uu____27, uu____28, uu____29) with Doc l, Doc r, Doc x ->
...
let cat : doc -> doc -> doc =
  fun uu____49 uu____50 ->
    match (uu____49, uu____50) with Doc d1, Doc d2 -> Doc (Prims.strcat d1 d2)
...
let groups : doc Prims.list -> doc =
  fun docs ->
    let uu____71 = reduce docs in
    group uu____71


let combine : doc -> doc Prims.list -> doc =
  fun uu____78 docs ->
    match uu____78 with Doc sep ->
      let select uu____88 =
        match uu____88 with Doc d ->
          if d = "" then FStar_Pervasives_Native.None
...
let nest : Prims.int -> doc -> doc =
  fun i uu____116 -> match uu____116 with Doc d -> Doc d
...
let pretty : Prims.int -> doc -> Prims.string =
  fun sz uu____135 -> match uu____135 with Doc doc -> doc
