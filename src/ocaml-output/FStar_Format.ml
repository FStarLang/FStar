...
(let _127_22 = (text "[")
in (let _127_21 = (text "]")
in (enclose _127_22 _127_21 (Doc (d)))))
end))
...
(let _127_26 = (text "{")
in (let _127_25 = (text "}")
in (enclose _127_26 _127_25 (Doc (d)))))
end))
...
(let _127_30 = (text "(")
in (let _127_29 = (text ")")
in (enclose _127_30 _127_29 (Doc (d)))))
end))
...
let groups : doc Prims.list  ->  doc = (fun docs -> (let _127_41 = (reduce docs)
in (group _127_41)))
