...
(let _105_22 = (text "[")
in (let _105_21 = (text "]")
in (enclose _105_22 _105_21 (Doc (d)))))
end))
...
(let _105_26 = (text "{")
in (let _105_25 = (text "}")
in (enclose _105_26 _105_25 (Doc (d)))))
end))
...
(let _105_30 = (text "(")
in (let _105_29 = (text ")")
in (enclose _105_30 _105_29 (Doc (d)))))
end))
...
# 66 "FStar.Format.fst"
let groups : doc Prims.list  ->  doc = (fun docs -> (let _105_41 = (reduce docs)
in (group _105_41)))
