...
(let _122_22 = (text "[")
in (let _122_21 = (text "]")
in (enclose _122_22 _122_21 (Doc (d)))))
end))
...
(let _122_26 = (text "{")
in (let _122_25 = (text "}")
in (enclose _122_26 _122_25 (Doc (d)))))
end))
...
(let _122_30 = (text "(")
in (let _122_29 = (text ")")
in (enclose _122_30 _122_29 (Doc (d)))))
end))
...
let groups : doc Prims.list  ->  doc = (fun docs -> (let _122_41 = (reduce docs)
in (group _122_41)))
