...
(let _121_22 = (text "[")
in (let _121_21 = (text "]")
in (enclose _121_22 _121_21 (Doc (d)))))
end))
...
(let _121_26 = (text "{")
in (let _121_25 = (text "}")
in (enclose _121_26 _121_25 (Doc (d)))))
end))
...
(let _121_30 = (text "(")
in (let _121_29 = (text ")")
in (enclose _121_30 _121_29 (Doc (d)))))
end))
...
let groups : doc Prims.list  ->  doc = (fun docs -> (let _121_41 = (reduce docs)
in (group _121_41)))
