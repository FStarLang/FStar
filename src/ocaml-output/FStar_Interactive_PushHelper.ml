      ...
      fun name_events ->
        let cur_mod_str =
          ...
          | FStar_Pervasives_Native.Some md ->
              ...
              FStar_Ident.string_of_lid uu____1171 in
        ...
        FStar_Syntax_DsEnv.ds_push_open_hook =
          (fun dsenv ->
             fun op ->
               let uu____1291 =
                 let uu____1292 =
                   let uu____1297 = FStar_Syntax_DsEnv.current_module dsenv in
                   (uu____1297, op) in
        ...
        FStar_Syntax_DsEnv.ds_push_include_hook =
          (fun dsenv ->
             fun ns ->
               let uu____1303 =
                 let uu____1304 =
                   let uu____1309 = FStar_Syntax_DsEnv.current_module dsenv in
                   (uu____1309, ns) in
          ...
          (fun dsenv ->
             fun x ->
               fun l ->
                 let uu____1317 =
                   let uu____1318 =
                     let uu____1325 = FStar_Syntax_DsEnv.current_module dsenv in
                     (uu____1325, x, l) in
    ...
    let set_hooks dshooks tchooks env1 =
      let uu____1384 =
        FStar_Universal.with_dsenv_of_tcenv env1
          (fun dsenv ->
             let uu____1392 = FStar_Syntax_DsEnv.set_ds_hooks dsenv dshooks in
             ((), uu____1392)) in
    ...
    | (old_dshooks, old_tchooks) ->
        ...
        (match uu____1416 with
         | (events, new_dshooks, new_tchooks) ->
             ...
             (uu____1451,
               ((fun env1 ->
                   let uu____1465 = set_hooks old_dshooks old_tchooks env1 in
                   let uu____1466 =
        ...
        let capitalize str =
          ...
          then str
            ...
            (let first =
             ...
             Prims.op_Hat (FStar_String.uppercase first) uu____2111) in
        let mods = FStar_Parser_Dep.build_inclusion_candidates_list () in
        let loaded_mods_set =
          let uu____2128 = FStar_Util.psmap_empty () in
          let uu____2133 =
            let uu____2137 = FStar_Options.prims () in uu____2137 :: deps in
          FStar_List.fold_left
            (fun acc ->
               fun dep ->
                 let uu____2153 = FStar_Parser_Dep.lowercase_module_name dep in
