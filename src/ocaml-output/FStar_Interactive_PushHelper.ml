             ...
             let intf_tasks =
               ...
               | intf::impl::[] ->
                   ((let uu___3 =
                    ...
                    (let uu___4 =
                       let uu___5 = FStar_Parser_Dep.is_implementation impl
                          in
                       ...
                       let uu___5 =
                         let uu___6 =
                           FStar_Util.format1
                            ...
                            in
                         (FStar_Errors.Fatal_MissingImplementation, uu___6)
                          in
                   ...
                   ((let uu___4 =
                       let uu___5 =
                         FStar_Util.format message [our_mod_name; mods_str]
                          in
                       (FStar_Errors.Fatal_TooManyOrTooFewFileMatch, uu___5)
                        in
                     FStar_Errors.raise_err uu___4);
                    [])
                in
...
let (update_names_from_event :
  ...
  fun cur_mod_str  ->
    fun table  ->
      fun evt  ->
        let is_cur_mod lid =
          let uu___ = FStar_Ident.string_of_lid lid  in uu___ = cur_mod_str
           in
        match evt with
      ...
      fun name_events  ->
        let cur_mod_str =
          ...
          | FStar_Pervasives_Native.Some md ->
              ...
              FStar_Ident.string_of_lid uu___
           in
...
let (track_name_changes :
  ...
  fun env  ->
    ...
    let uu___ =
      ...
      let uu___2 = FStar_TypeChecker_Env.tc_hooks env  in (uu___1, uu___2)
       in
    match uu___ with
...
let (tf_of_fname : Prims.string -> FStar_Interactive_JsonHelper.timed_fname)
  =
  fun fname  ->
    let uu___ = FStar_Parser_ParseIt.get_file_last_modification_time fname
       in
    {
      FStar_Interactive_JsonHelper.tf_fname = fname;
      FStar_Interactive_JsonHelper.tf_modtime = uu___
...
let (update_task_timestamps :
  ...
  fun uu___  ->
    ...
    | FStar_Interactive_JsonHelper.LDInterleaved (intf,impl) ->
        let uu___1 =
          let uu___2 = tf_of_fname intf.FStar_Interactive_JsonHelper.tf_fname
             in
          let uu___3 = tf_of_fname impl.FStar_Interactive_JsonHelper.tf_fname
             in
          (uu___2, uu___3)  in
    ...
    | FStar_Interactive_JsonHelper.LDInterfaceOfCurrentFile intf ->
        let uu___1 = tf_of_fname intf.FStar_Interactive_JsonHelper.tf_fname
           in
            ...
            (let first =
             ...
             let uu___1 =
               FStar_String.substring str Prims.int_one
                ...
                in
             Prims.op_Hat (FStar_String.uppercase first) uu___1)
           in
        let mods = FStar_Parser_Dep.build_inclusion_candidates_list ()  in
        let loaded_mods_set =
          let uu___ = FStar_Util.psmap_empty ()  in
          let uu___1 = let uu___2 = FStar_Options.prims ()  in uu___2 :: deps
             in
          FStar_List.fold_left
            (fun acc  ->
               fun dep  ->
                 let uu___2 = FStar_Parser_Dep.lowercase_module_name dep  in
                 FStar_Util.psmap_add acc uu___2 true) uu___ uu___1
           in
        let loaded modname =
