...
| FStar_Const.Const_string (s, uu____62) -> begin
(FStar_Util.format1 "\"%s\"" s)
end
| FStar_Const.Const_bytearray (uu____63) -> begin
"<bytearray>"
end
| FStar_Const.Const_int (x1, uu____68) -> begin
x1
end
...
let uu____78 = (sli l)
in (FStar_Util.format1 "[[%s.reflect]]" uu____78))
end))
...
let uu____86 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____86))
in (

let uu____87 = (psnconst t)
in (FStar_Ident.set_lid_range uu____87 r))))
...
in (FStar_Util.format1 "Mktuple%s" uu____101))
in (
...
let uu____112 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____112)))
...
let uu____133 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "dtuple%s" uu____133))
in (

let uu____134 = (

let uu____135 = (mod_prefix_dtuple n1)
in (uu____135 t))
in (FStar_Ident.set_lid_range uu____134 r))))
...
let uu____151 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mkdtuple%s" uu____151))
in (

let uu____152 = (

let uu____153 = (mod_prefix_dtuple n1)
in (uu____153 t))
in (FStar_Ident.set_lid_range uu____152 r))))
...
let uu____165 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____165)))
