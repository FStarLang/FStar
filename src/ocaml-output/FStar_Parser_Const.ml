...
let (gen_reset :
  ...
  let reset uu____214 = FStar_Util.write x (Prims.parse_int "0") in
  (gen1, reset)
let (next_id : Prims.unit -> Prims.int) =
  FStar_Pervasives_Native.fst gen_reset
let (sli : FStar_Ident.lident -> Prims.string) =
  fun l ->
    let uu____298 = FStar_Options.print_real_names () in
    if uu____298
...
let (const_to_string : FStar_Const.sconst -> Prims.string) =
  fun x ->
    ...
    | FStar_Const.Const_string (s, uu____307) ->
        FStar_Util.format1 "\"%s\"" s
    | FStar_Const.Const_bytearray uu____308 -> "<bytearray>"
    | FStar_Const.Const_int (x1, uu____316) -> x1
    ...
    | FStar_Const.Const_reflect l ->
        let uu____332 = sli l in
        FStar_Util.format1 "[[%s.reflect]]" uu____332
let (mk_tuple_lid : Prims.int -> FStar_Range.range -> FStar_Ident.lident) =
  fun n1 ->
    fun r ->
      let t =
        let uu____340 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "tuple%s" uu____340 in
      let uu____341 = psnconst t in FStar_Ident.set_lid_range uu____341 r
...
let (mk_tuple_data_lid :
  ...
  fun n1 ->
    fun r ->
      let t =
        let uu____355 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "Mktuple%s" uu____355 in
      let uu____356 = psnconst t in FStar_Ident.set_lid_range uu____356 r
...
let (is_tuple_data_lid : FStar_Ident.lident -> Prims.int -> Prims.bool) =
  fun f ->
    fun n1 ->
      let uu____366 = mk_tuple_data_lid n1 FStar_Range.dummyRange in
      FStar_Ident.lid_equals f uu____366
...
let (mk_dtuple_lid : Prims.int -> FStar_Range.range -> FStar_Ident.lident) =
  fun n1 ->
    fun r ->
      let t =
        let uu____387 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "dtuple%s" uu____387 in
      let uu____388 = let uu____389 = mod_prefix_dtuple n1 in uu____389 t in
      FStar_Ident.set_lid_range uu____388 r
...
let (mk_dtuple_data_lid :
  ...
  fun n1 ->
    fun r ->
      let t =
        let uu____405 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "Mkdtuple%s" uu____405 in
      let uu____406 = let uu____407 = mod_prefix_dtuple n1 in uu____407 t in
      FStar_Ident.set_lid_range uu____406 r
...
let (is_dtuple_data_lid : FStar_Ident.lident -> Prims.int -> Prims.bool) =
  fun f ->
    fun n1 ->
      let uu____419 = mk_dtuple_data_lid n1 FStar_Range.dummyRange in
      FStar_Ident.lid_equals f uu____419
