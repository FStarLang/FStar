...
let reset = (fun uu____226 -> (FStar_Util.write x (Prims.parse_int "0")))
in ((gen1), (reset)))))
...
let uu____318 = (FStar_Options.print_real_names ())
...
| FStar_Const.Const_string (s, uu____329) -> begin
(FStar_Util.format1 "\"%s\"" s)
end
| FStar_Const.Const_bytearray (uu____330) -> begin
"<bytearray>"
end
| FStar_Const.Const_int (x1, uu____338) -> begin
x1
end
...
let uu____354 = (sli l)
in (FStar_Util.format1 "[[%s.reflect]]" uu____354))
end))
...
let uu____366 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____366))
in (

let uu____367 = (psnconst t)
in (FStar_Ident.set_lid_range uu____367 r))))
...
let uu____378 = (FStar_Ident.text_of_id lid)
in (is_tuple_constructor_string uu____378)))
...
let uu____390 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mktuple%s" uu____390))
in (

let uu____391 = (psnconst t)
in (FStar_Ident.set_lid_range uu____391 r))))
...
let uu____407 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____407)))
...
let uu____439 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "dtuple%s" uu____439))
in (

let uu____440 = (

let uu____441 = (mod_prefix_dtuple n1)
in (uu____441 t))
in (FStar_Ident.set_lid_range uu____440 r))))
...
let uu____467 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mkdtuple%s" uu____467))
in (

let uu____468 = (

let uu____469 = (mod_prefix_dtuple n1)
in (uu____469 t))
in (FStar_Ident.set_lid_range uu____468 r))))
...
let uu____489 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____489)))


let is_dtuple_data_lid' : FStar_Ident.lident  ->  Prims.bool = (fun f -> (

let uu____495 = (FStar_Ident.text_of_lid f)
in (is_dtuple_datacon_string uu____495)))
