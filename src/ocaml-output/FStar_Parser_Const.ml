...
let reset = (fun uu____49 -> (FStar_Util.write x (Prims.parse_int "0")))
in ((gen1), (reset)))))
...
let uu____67 = (FStar_Options.print_real_names ())
...
| FStar_Const.Const_string (bytes, uu____77) -> begin
(FStar_Util.format1 "\"%s\"" (FStar_Util.string_of_bytes bytes))
end
| FStar_Const.Const_bytearray (uu____82) -> begin
"<bytearray>"
end
| FStar_Const.Const_int (x1, uu____90) -> begin
x1
end
...
let uu____106 = (sli l)
in (FStar_Util.format1 "[[%s.reflect]]" uu____106))
end))
...
let uu____116 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____116))
in (

let uu____117 = (psnconst t)
in (FStar_Ident.set_lid_range uu____117 r))))
...
let uu____135 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mktuple%s" uu____135))
in (

let uu____136 = (psnconst t)
in (FStar_Ident.set_lid_range uu____136 r))))
...
let uu____149 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____149)))
...
in (FStar_Util.format1 "dtuple%s" uu____174))
in (

let uu____175 = (

let uu____176 = (mod_prefix_dtuple n1)
in (uu____176 t))
in (FStar_Ident.set_lid_range uu____175 r))))
...
let uu____196 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mkdtuple%s" uu____196))
in (

let uu____197 = (

let uu____198 = (mod_prefix_dtuple n1)
in (uu____198 t))
in (FStar_Ident.set_lid_range uu____197 r))))
...
let uu____213 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____213)))
