...
let gen1 = (fun uu____39 -> ((FStar_Util.incr x);
(FStar_Util.read x);
))
in (

let reset = (fun uu____79 -> (FStar_Util.write x (Prims.parse_int "0")))
in ((gen1), (reset)))))
...
let uu____109 = (FStar_Options.print_real_names ())
...
| FStar_Const.Const_string (s, uu____119) -> begin
(FStar_Util.format1 "\"%s\"" s)
end
| FStar_Const.Const_bytearray (uu____120) -> begin
"<bytearray>"
end
| FStar_Const.Const_int (x1, uu____128) -> begin
x1
end
...
let uu____144 = (sli l)
in (FStar_Util.format1 "[[%s.reflect]]" uu____144))
end))
...
let uu____154 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____154))
in (

let uu____155 = (psnconst t)
in (FStar_Ident.set_lid_range uu____155 r))))
...
let uu____173 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mktuple%s" uu____173))
in (

let uu____174 = (psnconst t)
in (FStar_Ident.set_lid_range uu____174 r))))
...
let uu____187 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____187)))
...
let uu____212 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "dtuple%s" uu____212))
in (

let uu____213 = (

let uu____214 = (mod_prefix_dtuple n1)
in (uu____214 t))
in (FStar_Ident.set_lid_range uu____213 r))))
...
let uu____234 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mkdtuple%s" uu____234))
in (

let uu____235 = (

let uu____236 = (mod_prefix_dtuple n1)
in (uu____236 t))
in (FStar_Ident.set_lid_range uu____235 r))))
...
let uu____251 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____251)))
...
let fstar_reflection_types_binder_lid : FStar_Ident.lident = (FStar_Ident.lid_of_path (("FStar")::("Reflection")::("Types")::("binder")::[]) FStar_Range.dummyRange)
