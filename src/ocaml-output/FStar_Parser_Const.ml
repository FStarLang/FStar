...
let (mk_dtuple_lid : Prims.int -> FStar_Range.range -> FStar_Ident.lident) =
  fun n1 ->
    fun r ->
      ...
      let uu____1145 = let uu____1146 = mod_prefix_dtuple n1 in uu____1146 t in
...
let (mk_dtuple_data_lid :
  ...
  fun n1 ->
    fun r ->
      ...
      let uu____1190 = let uu____1191 = mod_prefix_dtuple n1 in uu____1191 t in
