...
let const_to_string: FStar_Const.sconst -> Prims.string =
  fun x  ->
    ...
    | FStar_Const.Const_reflect l ->
        let uu____156 = sli l in
        FStar_Util.format1 "[[%s.reflect]]" uu____156
let mk_tuple_lid: Prims.int -> FStar_Range.range -> FStar_Ident.lident =
  fun n1  ->
    fun r  ->
      let t =
        let uu____166 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "tuple%s" uu____166 in
      let uu____167 = psnconst t in FStar_Ident.set_lid_range uu____167 r
...
let mk_tuple_data_lid: Prims.int -> FStar_Range.range -> FStar_Ident.lident =
  fun n1  ->
    fun r  ->
      let t =
        let uu____185 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "Mktuple%s" uu____185 in
      let uu____186 = psnconst t in FStar_Ident.set_lid_range uu____186 r
...
let is_tuple_data_lid: FStar_Ident.lident -> Prims.int -> Prims.bool =
  fun f  ->
    fun n1  ->
      let uu____199 = mk_tuple_data_lid n1 FStar_Range.dummyRange in
      FStar_Ident.lid_equals f uu____199
  ...
  fun n1  ->
    fun r  ->
      let t =
        ...
        FStar_Util.format1 "dtuple%s" uu____224 in
      let uu____225 = let uu____226 = mod_prefix_dtuple n1 in uu____226 t in
      FStar_Ident.set_lid_range uu____225 r
...
let mk_dtuple_data_lid: Prims.int -> FStar_Range.range -> FStar_Ident.lident
  ...
  fun n1  ->
    fun r  ->
      let t =
        let uu____246 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "Mkdtuple%s" uu____246 in
      let uu____247 = let uu____248 = mod_prefix_dtuple n1 in uu____248 t in
      FStar_Ident.set_lid_range uu____247 r
...
let is_dtuple_data_lid: FStar_Ident.lident -> Prims.int -> Prims.bool =
  fun f  ->
    fun n1  ->
      let uu____263 = mk_dtuple_data_lid n1 FStar_Range.dummyRange in
      FStar_Ident.lid_equals f uu____263
