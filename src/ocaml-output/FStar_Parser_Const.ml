...
let gen1 = (fun uu____877 -> ((FStar_Util.incr x);
(FStar_Util.read x);
))
in (

let reset = (fun uu____885 -> (FStar_Util.write x (Prims.parse_int "0")))
in ((gen1), (reset)))))
...
let uu____916 = (FStar_Options.print_real_names ())
...
| FStar_Const.Const_string (s, uu____945) -> begin
(FStar_Util.format1 "\"%s\"" s)
end
| FStar_Const.Const_bytearray (uu____949) -> begin
"<bytearray>"
end
| FStar_Const.Const_int (x1, uu____958) -> begin
x1
end
| FStar_Const.Const_char (c) -> begin
(

let uu____975 = (FStar_String.op_Hat (FStar_Util.string_of_char c) "\'")
in (FStar_String.op_Hat "\'" uu____975))
end
...
let uu____984 = (sli l)
in (FStar_Util.format1 "[[%s.reflect]]" uu____984))
end))
...
let uu____1002 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____1002))
in (

let uu____1005 = (psnconst t)
in (FStar_Ident.set_lid_range uu____1005 r))))
...
let uu____1026 = (FStar_Ident.text_of_id lid)
in (is_tuple_constructor_string uu____1026)))
...
in (FStar_Util.format1 "Mktuple%s" uu____1043))
in (

let uu____1046 = (psnconst t)
in (FStar_Ident.set_lid_range uu____1046 r))))
...
let uu____1074 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____1074)))
...
let uu____1122 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "dtuple%s" uu____1122))
in (

let uu____1125 = (

let uu____1126 = (mod_prefix_dtuple n1)
in (uu____1126 t))
in (FStar_Ident.set_lid_range uu____1125 r))))
...
let uu____1167 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mkdtuple%s" uu____1167))
in (

let uu____1170 = (

let uu____1171 = (mod_prefix_dtuple n1)
in (uu____1171 t))
in (FStar_Ident.set_lid_range uu____1170 r))))
...
let uu____1204 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____1204)))


let is_dtuple_data_lid' : FStar_Ident.lident  ->  Prims.bool = (fun f -> (

let uu____1212 = (FStar_Ident.text_of_lid f)
in (is_dtuple_datacon_string uu____1212)))
