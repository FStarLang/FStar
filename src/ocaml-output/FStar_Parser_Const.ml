...
let gen1 = (fun uu____34 -> ((FStar_Util.incr x);
(FStar_Util.read x);
))
in (

let reset = (fun uu____214 -> (FStar_Util.write x (Prims.parse_int "0")))
in ((gen1), (reset)))))
...
let uu____298 = (FStar_Options.print_real_names ())
...
| FStar_Const.Const_string (s, uu____307) -> begin
(FStar_Util.format1 "\"%s\"" s)
end
| FStar_Const.Const_bytearray (uu____308) -> begin
"<bytearray>"
end
| FStar_Const.Const_int (x1, uu____316) -> begin
x1
end
...
let uu____332 = (sli l)
in (FStar_Util.format1 "[[%s.reflect]]" uu____332))
end))
...
let uu____340 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____340))
in (

let uu____341 = (psnconst t)
in (FStar_Ident.set_lid_range uu____341 r))))
...
let uu____355 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mktuple%s" uu____355))
in (

let uu____356 = (psnconst t)
in (FStar_Ident.set_lid_range uu____356 r))))
...
let uu____366 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____366)))
...
let uu____387 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "dtuple%s" uu____387))
in (

let uu____388 = (

let uu____389 = (mod_prefix_dtuple n1)
in (uu____389 t))
in (FStar_Ident.set_lid_range uu____388 r))))
...
let uu____405 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mkdtuple%s" uu____405))
in (

let uu____406 = (

let uu____407 = (mod_prefix_dtuple n1)
in (uu____407 t))
in (FStar_Ident.set_lid_range uu____406 r))))
...
let uu____419 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____419)))
