...
let gen1 = (fun uu____27 -> ((FStar_Util.incr x);
(FStar_Util.read x);
))
in (

let reset = (fun uu____37 -> (FStar_Util.write x (Prims.parse_int "0")))
in ((gen1), (reset)))))
...
let uu____53 = (FStar_Options.print_real_names ())
...
| FStar_Const.Const_string (bytes, uu____62) -> begin
(FStar_Util.format1 "\"%s\"" (FStar_Util.string_of_bytes bytes))
end
| FStar_Const.Const_bytearray (uu____65) -> begin
"<bytearray>"
end
| FStar_Const.Const_int (x1, uu____70) -> begin
x1
end
...
let uu____80 = (sli l)
in (FStar_Util.format1 "[[%s.reflect]]" uu____80))
end))
...
let uu____88 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____88))
in (

let uu____89 = (psnconst t)
in (FStar_Ident.set_lid_range uu____89 r))))
...
let uu____103 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mktuple%s" uu____103))
in (

let uu____104 = (psnconst t)
in (FStar_Ident.set_lid_range uu____104 r))))
...
let uu____114 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____114)))
...
in (FStar_Util.format1 "dtuple%s" uu____135))
in (

let uu____136 = (

let uu____137 = (mod_prefix_dtuple n1)
in (uu____137 t))
...
in (FStar_Util.format1 "Mkdtuple%s" uu____153))
in (

let uu____154 = (

let uu____155 = (mod_prefix_dtuple n1)
in (uu____155 t))
in (FStar_Ident.set_lid_range uu____154 r))))
...
let uu____167 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____167)))
