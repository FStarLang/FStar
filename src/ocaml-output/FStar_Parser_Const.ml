...
let uu____186 = (sli l)
in (FStar_Util.format1 "[[%s.reflect]]" uu____186))
end))
...
let uu____198 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____198))
in (

let uu____199 = (psnconst t)
in (FStar_Ident.set_lid_range uu____199 r))))
...
let uu____210 = (FStar_Ident.text_of_id lid)
in (is_tuple_constructor_string uu____210)))
...
let uu____222 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mktuple%s" uu____222))
in (

let uu____223 = (psnconst t)
in (FStar_Ident.set_lid_range uu____223 r))))
...
let uu____239 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____239)))
...
let uu____271 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "dtuple%s" uu____271))
in (

let uu____272 = (

let uu____273 = (mod_prefix_dtuple n1)
in (uu____273 t))
in (FStar_Ident.set_lid_range uu____272 r))))
...
let uu____299 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mkdtuple%s" uu____299))
in (

let uu____300 = (

let uu____301 = (mod_prefix_dtuple n1)
in (uu____301 t))
in (FStar_Ident.set_lid_range uu____300 r))))
...
let uu____321 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____321)))


let is_dtuple_data_lid' : FStar_Ident.lident  ->  Prims.bool = (fun f -> (

let uu____327 = (FStar_Ident.text_of_lid f)
in (is_dtuple_datacon_string uu____327)))
