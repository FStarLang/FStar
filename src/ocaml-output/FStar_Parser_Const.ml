...
let (mk_dtuple_lid : Prims.int -> FStar_Range.range -> FStar_Ident.lident) =
  fun n1 ->
    fun r ->
      ...
      let uu____1125 = let uu____1126 = mod_prefix_dtuple n1 in uu____1126 t in
...
let (mk_dtuple_data_lid :
  ...
  fun n1 ->
    fun r ->
      ...
      let uu____1170 = let uu____1171 = mod_prefix_dtuple n1 in uu____1171 t in
