...
| FStar_Const.Const_string (bytes, uu____119) -> begin
(FStar_Util.format1 "\"%s\"" (FStar_Util.string_of_bytes bytes))
end
| FStar_Const.Const_bytearray (uu____124) -> begin
"<bytearray>"
end
| FStar_Const.Const_int (x1, uu____132) -> begin
x1
end
...
let uu____148 = (sli l)
in (FStar_Util.format1 "[[%s.reflect]]" uu____148))
end))
...
let uu____158 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____158))
in (

let uu____159 = (psnconst t)
in (FStar_Ident.set_lid_range uu____159 r))))
...
let uu____177 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mktuple%s" uu____177))
in (

let uu____178 = (psnconst t)
in (FStar_Ident.set_lid_range uu____178 r))))
...
let uu____191 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____191)))
...
let uu____216 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "dtuple%s" uu____216))
in (

let uu____217 = (

let uu____218 = (mod_prefix_dtuple n1)
in (uu____218 t))
in (FStar_Ident.set_lid_range uu____217 r))))
...
let uu____238 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mkdtuple%s" uu____238))
in (

let uu____239 = (

let uu____240 = (mod_prefix_dtuple n1)
in (uu____240 t))
in (FStar_Ident.set_lid_range uu____239 r))))
...
let uu____255 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____255)))
