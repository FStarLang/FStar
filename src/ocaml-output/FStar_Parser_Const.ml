...
let smt_theory_symbol_attr_lid : FStar_Ident.lident = (pconst "smt_theory_symbol")
...
let trivial_pure_post_lid : FStar_Ident.lident = (psconst "trivial_pure_post")
...
let s2l : Prims.string  ->  FStar_Ident.lident = (fun n1 -> (p2l (("FStar")::("String")::(n1)::[])))
...
let real_const : Prims.string  ->  FStar_Ident.lident = (fun s -> (p2l (("FStar")::("Real")::(s)::[])))
...
let real_op_Subtraction : FStar_Ident.lident = (real_const "op_Subtraction_Dot")
...
let array_of_list_lid : FStar_Ident.lident = (p2l (("FStar")::("Array")::("of_list")::[]))
...
let inspect : FStar_Ident.lident = (p2l (("FStar")::("Tactics")::("Builtins")::("inspect")::[]))


let pack : FStar_Ident.lident = (p2l (("FStar")::("Tactics")::("Builtins")::("pack")::[]))


let binder_to_term : FStar_Ident.lident = (p2l (("FStar")::("Tactics")::("Derived")::("binder_to_term")::[]))
...
let term_view_lid : FStar_Ident.lident = (p2l (("FStar")::("Reflection")::("Data")::("term_view")::[]))
...
let strict_on_arguments_attr : FStar_Ident.lident = (p2l (("FStar")::("Pervasives")::("strict_on_arguments")::[]))


let erasable_attr : FStar_Ident.lident = (p2l (("FStar")::("Pervasives")::("erasable")::[]))


let comment_attr : FStar_Ident.lident = (p2l (("FStar")::("Pervasives")::("Comment")::[]))
...
let preprocess_with : FStar_Ident.lident = (p2l (("FStar")::("Tactics")::("Effect")::("preprocess_with")::[]))


let postprocess_extr_with : FStar_Ident.lident = (p2l (("FStar")::("Tactics")::("Effect")::("postprocess_for_extraction_with")::[]))


let check_with_lid : FStar_Ident.lident = (FStar_Ident.lid_of_path (("FStar")::("Reflection")::("Basic")::("check_with")::[]) FStar_Range.dummyRange)
...
let gen1 = (fun uu____987 -> ((FStar_Util.incr x);
(FStar_Util.read x);
))
in (

let reset = (fun uu____995 -> (FStar_Util.write x (Prims.parse_int "0")))
in ((gen1), (reset)))))
...
let uu____1026 = (FStar_Options.print_real_names ())
...
(FStar_String.op_Hat r "R")
end
| FStar_Const.Const_float (x1) -> begin
(FStar_Util.string_of_float x1)
end
| FStar_Const.Const_string (s, uu____1055) -> begin
(FStar_Util.format1 "\"%s\"" s)
end
| FStar_Const.Const_bytearray (uu____1059) -> begin
"<bytearray>"
end
| FStar_Const.Const_int (x1, uu____1068) -> begin
x1
end
| FStar_Const.Const_char (c) -> begin
(

let uu____1085 = (FStar_String.op_Hat (FStar_Util.string_of_char c) "\'")
in (FStar_String.op_Hat "\'" uu____1085))
end
...
let uu____1094 = (sli l)
in (FStar_Util.format1 "[[%s.reflect]]" uu____1094))
end))
...
let uu____1112 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "tuple%s" uu____1112))
in (

let uu____1115 = (psnconst t)
in (FStar_Ident.set_lid_range uu____1115 r))))
...
let is_tuple_constructor_id : FStar_Ident.ident  ->  Prims.bool = (fun id1 -> (

let uu____1136 = (FStar_Ident.text_of_id id1)
in (is_tuple_constructor_string uu____1136)))


let is_tuple_constructor_lid : FStar_Ident.lident  ->  Prims.bool = (fun lid -> (

let uu____1145 = (FStar_Ident.text_of_lid lid)
in (is_tuple_constructor_string uu____1145)))
...
let uu____1162 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mktuple%s" uu____1162))
in (

let uu____1165 = (psnconst t)
in (FStar_Ident.set_lid_range uu____1165 r))))
...
let is_tuple_datacon_id : FStar_Ident.ident  ->  Prims.bool = (fun id1 -> (

let uu____1186 = (FStar_Ident.text_of_id id1)
in (is_tuple_datacon_string uu____1186)))


let is_tuple_datacon_lid : FStar_Ident.lident  ->  Prims.bool = (fun lid -> (

let uu____1195 = (FStar_Ident.text_of_lid lid)
in (is_tuple_datacon_string uu____1195)))


let is_tuple_data_lid : FStar_Ident.lident  ->  Prims.int  ->  Prims.bool = (fun f n1 -> (

let uu____1211 = (mk_tuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____1211)))
...
let uu____1259 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "dtuple%s" uu____1259))
in (

let uu____1262 = (

let uu____1263 = (mod_prefix_dtuple n1)
in (uu____1263 t))
...
let uu____1304 = (FStar_Util.string_of_int n1)
in (FStar_Util.format1 "Mkdtuple%s" uu____1304))
in (

let uu____1307 = (

let uu____1308 = (mod_prefix_dtuple n1)
in (uu____1308 t))
in (FStar_Ident.set_lid_range uu____1307 r))))
...
let uu____1341 = (mk_dtuple_data_lid n1 FStar_Range.dummyRange)
in (FStar_Ident.lid_equals f uu____1341)))


let is_dtuple_data_lid' : FStar_Ident.lident  ->  Prims.bool = (fun f -> (

let uu____1349 = (FStar_Ident.text_of_lid f)
in (is_dtuple_datacon_string uu____1349)))
