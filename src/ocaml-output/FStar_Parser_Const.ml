...
let mk_dtuple_lid : Prims.int -> FStar_Range.range -> FStar_Ident.lident =
  fun n1  ->
    fun r  ->
      ...
      let uu____136 = let uu____137 = mod_prefix_dtuple n1  in uu____137 t
         in
...
let mk_dtuple_data_lid : Prims.int -> FStar_Range.range -> FStar_Ident.lident
  ...
  fun n1  ->
    fun r  ->
      ...
      let uu____154 = let uu____155 = mod_prefix_dtuple n1  in uu____155 t
         in
...
let fstar_tactics_embed_lid : FStar_Ident.lident =
  fstar_tactics_lid "__embed" 