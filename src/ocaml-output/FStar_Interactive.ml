    ...
    fun kind  ->
      fun text1  ->
        fun line  ->
          fun column1  ->
            fun peek_only  ->
              let uu____3793 = ((st.repl_stack), (st.repl_env), (st.repl_ts))
                 in
          ...
          | (dsenv,tcenv) ->
              let info_of_lid_str lid_str =
                ...
                FStar_All.pipe_right uu____4157
                 ...
                 in
              let docs_of_lid lid =
                let uu____4248 = FStar_ToSyntax_Env.try_lookup_doc dsenv lid
                   in
                FStar_All.pipe_right uu____4248
                  (FStar_Util.map_option FStar_Pervasives_Native.fst)
                 in
              let def_of_lid lid =
                let uu____4277 = FStar_TypeChecker_Env.lookup_qname tcenv lid
                   in
            ...
            | (prefix1,matched,match_len) ->
                ...
                (match uu____5121 with
                 | (stripped_ns,shortened) ->
                     ...
                     (uu____5148, uu____5149, uu____5150, match_len))
             in
                           ...
                           | FStar_Pervasives_Native.Some l ->
                               let uu____5450 =
                                 FStar_Ident.lid_of_ids
                                  ...
                                  in
                               FStar_Ident.lid_equals l uu____5450)))
               in
              ...
              (fun uu____5656  ->
                 ...
                 | (candidate,ns,match_len) ->
                     FStar_Util.JsonList
                       ...
                       FStar_Util.JsonStr candidate]) uu____5578
             in
  ...
  fun st  ->
    fun term  ->
      fun rules  ->
        ...
        let parse1 frag =
          let uu____5855 = FStar_Parser_ParseIt.parse (FStar_Util.Inr frag)
             in
        ...
        let desugar dsenv decls =
          let uu____5956 = FStar_ToSyntax_ToSyntax.desugar_decls dsenv decls
             in
          ...
          let st_matches candidate term =
            let found =
              ...
              | TypeContainsLid lid ->
                  ...
                  FStar_Util.set_mem lid uu____6652
               in
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____6890 = let uu____6903 = run_query st  in uu____6903 query.qq
       in
