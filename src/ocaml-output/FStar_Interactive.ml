  ...
  fun key  ->
    fun a  ->
      let uu____2262 =
        FStar_Util.try_find
          (fun uu____2276  ->
             match uu____2276 with | (k,uu____2282) -> k = key) a
         in
                ...
                FStar_All.pipe_right uu____2459
                  (FStar_Util.map_option
                     (fun loc  ->
                        ...
                        (uu____2526, uu____2528, uu____2530)))
                 in
              let uu____2532 =
              ...
              let uu____2775 =
                let uu____2778 =
                  ...
                  | FStar_Pervasives_Native.Some r ->
                      let uu____2784 = json_of_use_range r  in [uu____2784]
                   in
                let uu____2785 =
                  match issue.FStar_Errors.issue_range with
  ...
  let js_features =
    let uu____3035 =
      FStar_List.map (fun _0_45  -> FStar_Util.JsonStr _0_45)
       ...
       in
    FStar_All.pipe_left (fun _0_46  -> FStar_Util.JsonList _0_46) uu____3035
     in
            ...
            FStar_List.map
              (fun uu____3421  ->
                 ...
                 | (name,value,doc1,dflt1) ->
                     ...
                     FStar_Util.JsonAssoc uu____3440) opts_and_defaults
             in
            ...
            | (prefix1,matched,match_len) ->
                ...
                (match uu____5220 with
                 | (stripped_ns,shortened) ->
                     ...
                     (uu____5247, uu____5248, uu____5249, match_len))
             in
                           ...
                           | FStar_Pervasives_Native.Some l ->
                               let uu____5549 =
                                 FStar_Ident.lid_of_ids
                                  ...
                                  in
                               FStar_Ident.lid_equals l uu____5549)))
               in
              ...
              (fun uu____5755  ->
                 ...
                 | (candidate,ns,match_len) ->
                     FStar_Util.JsonList
                       ...
                       FStar_Util.JsonStr candidate]) uu____5677
             in
...
let json_of_search_result :
  ...
  fun dsenv  ->
    fun tcenv  ->
      fun sc  ->
        let typ_str =
          let uu____6651 = sc_typ tcenv sc  in
          term_to_string tcenv uu____6651  in
        let uu____6652 =
          let uu____6659 =
            let uu____6664 =
              let uu____6665 =
          ...
          let st_matches candidate term =
            let found =
              ...
              | TypeContainsLid lid ->
                  ...
                  FStar_Util.set_mem lid uu____6751
               in
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____6997 = let uu____7010 = run_query st  in uu____7010 query.qq
       in
