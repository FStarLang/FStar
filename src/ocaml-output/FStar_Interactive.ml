              ...
              FStar_All.pipe_right uu____1371
                (FStar_Util.map_option
                   (fun loc  ->
                      ...
                      (uu____1404, uu____1406, uu____1408)))
               in
            let uu____1410 =
              let uu____1412 =
          ...
          let uu____1528 =
            let uu____1531 =
              let uu____1532 =
                ...
                | None  -> []
                | Some r -> let uu____1536 = json_of_range r  in [uu____1536]
                 in
  ...
  let js_features =
    let uu____1628 =
      FStar_List.map (fun _0_35  -> FStar_Util.JsonStr _0_35)
       ...
       in
    FStar_All.pipe_left (fun _0_36  -> FStar_Util.JsonList _0_36) uu____1628
     in
      ...
      (match uu____1897 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           let errors =
             ...
             FStar_All.pipe_right uu____1967 (FStar_List.map json_of_issue)
              in
           (FStar_Errors.clear ();
            (let st' =
        ...
        FStar_All.pipe_right uu____2106
          (FStar_Util.map_option
             (fun uu____2132  ->
                ...
                | ((uu____2142,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
         in
      let docs_of_lid lid =
        ...
        | (prefix1,matched,match_len) ->
            ...
            (match uu____2572 with
             | (stripped_ns,shortened) ->
                 ...
                 (uu____2587, uu____2588, uu____2589, match_len))
         in
                       ...
                       | Some l ->
                           let uu____2764 =
                             FStar_Ident.lid_of_ids (FStar_List.append ns id)
                              in
                           FStar_Ident.lid_equals l uu____2764)))
           in
          ...
          (fun uu____2871  ->
             ...
             | (candidate,ns,match_len) ->
                 FStar_Util.JsonList
                   ...
                   FStar_Util.JsonStr candidate]) uu____2833
         in
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____2931 = let uu____2938 = run_query st  in uu____2938 query.qq
       in
...
let interactive_error_handler : FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____2968 =
      let uu____2970 = FStar_ST.read issues  in e :: uu____2970  in
