    ...
    fun kind  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,tcenv) ->
              let tcenv1 =
                let uu___192_241 = tcenv in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___192_241.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___192_241.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___192_241.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___192_241.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___192_241.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___192_241.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___192_241.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___192_241.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___192_241.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___192_241.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___192_241.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___192_241.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___192_241.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___192_241.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___192_241.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___192_241.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___192_241.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___192_241.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = (kind = LaxCheck);
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___192_241.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.type_of =
                    (uu___192_241.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___192_241.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___192_241.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___192_241.FStar_TypeChecker_Env.qname_and_index);
                  FStar_TypeChecker_Env.proof_ns =
                    (uu___192_241.FStar_TypeChecker_Env.proof_ns);
                  FStar_TypeChecker_Env.synth =
                    (uu___192_241.FStar_TypeChecker_Env.synth);
...
let js_int: FStar_Util.json -> Prims.int =
  fun uu___183_1090  ->
    match uu___183_1090 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
let js_str: FStar_Util.json -> Prims.string =
  fun uu___184_1096  ->
    match uu___184_1096 with
    | FStar_Util.JsonStr s -> s
    | other -> js_fail "string" other
let js_list k uu___185_1117 =
  match uu___185_1117 with
  ...
  | (env,curmod)::stack ->
      (pop st.repl_env "#pop";
       ...
       ((QueryOK, FStar_Util.JsonNull),
         (FStar_Util.Inl
            ((let uu___199_2504 = st in
              {
                repl_line = (uu___199_2504.repl_line);
                repl_column = (uu___199_2504.repl_column);
                repl_fname = (uu___199_2504.repl_fname);
                repl_stack = stack;
                repl_curmod = curmod;
                repl_env = env;
                repl_ts = (uu___199_2504.repl_ts);
                repl_stdin = (uu___199_2504.repl_stdin)
              })))))
  ...
  | (stack,env,ts) ->
      ...
      (match uu____2563 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           (FStar_Errors.clear ();
            (let st' =
               let uu___200_2643 = st in
               {
                 repl_line = line;
                 repl_column = column1;
                 repl_fname = (uu___200_2643.repl_fname);
                 repl_stack = stack2;
                 repl_curmod = (uu___200_2643.repl_curmod);
                 repl_env = (uu___200_2643.repl_env);
                 repl_ts = ts1;
                 repl_stdin = (uu___200_2643.repl_stdin)
               } in
             match res with
             | FStar_Pervasives_Native.Some (curmod,env3,nerrs) when
                 ...
                 ((QueryOK, (FStar_Util.JsonList errors)),
                   (FStar_Util.Inl
                      (let uu___201_2673 = st' in
                       {
                         repl_line = (uu___201_2673.repl_line);
                         repl_column = (uu___201_2673.repl_column);
                         repl_fname = (uu___201_2673.repl_fname);
                         repl_stack = (uu___201_2673.repl_stack);
                         repl_curmod = curmod;
                         repl_env = env4;
                         repl_ts = (uu___201_2673.repl_ts);
                         repl_stdin = (uu___201_2673.repl_stdin)
                       })))
             | uu____2674 ->
                 let env3 = reset_mark env_mark in
                 let uu____2685 =
                   run_pop
                     (let uu___202_2693 = st' in
                      {
                        repl_line = (uu___202_2693.repl_line);
                        repl_column = (uu___202_2693.repl_column);
                        repl_fname = (uu___202_2693.repl_fname);
                        repl_stack = (uu___202_2693.repl_stack);
                        repl_curmod = (uu___202_2693.repl_curmod);
                        repl_env = env3;
                        repl_ts = (uu___202_2693.repl_ts);
                        repl_stdin = (uu___202_2693.repl_stdin)
                      }) in
...
let run_compute st term rules =
  let run_and_rewind st1 task =
    ...
    let st' =
      let uu___203_3757 = st1 in
      {
        repl_line = (uu___203_3757.repl_line);
        repl_column = (uu___203_3757.repl_column);
        repl_fname = (uu___203_3757.repl_fname);
        repl_stack = (uu___203_3757.repl_stack);
        repl_curmod = (uu___203_3757.repl_curmod);
        repl_env = env;
        repl_ts = (uu___203_3757.repl_ts);
        repl_stdin = (uu___203_3757.repl_stdin)
      } in
    ...
    | {
        FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
          ((uu____3789,{ FStar_Syntax_Syntax.lbname = uu____3790;
                         ...
                         FStar_Syntax_Syntax.lbdef = def;_}::[]),uu____3795,uu____3796);
        FStar_Syntax_Syntax.sigrng = uu____3797;
        FStar_Syntax_Syntax.sigquals = uu____3798;
        FStar_Syntax_Syntax.sigmeta = uu____3799;_}::[] ->
        FStar_Pervasives_Native.Some def
    | uu____3818 -> FStar_Pervasives_Native.None in
  let parse1 frag =
    let uu____3828 = FStar_Parser_ParseIt.parse (FStar_Util.Inr frag) in
    match uu____3828 with
    | FStar_Util.Inl (FStar_Util.Inr decls,uu____3841) ->
        FStar_Pervasives_Native.Some decls
    | uu____3864 -> FStar_Pervasives_Native.None in
  let desugar dsenv decls =
    let uu____3884 = FStar_ToSyntax_ToSyntax.desugar_decls dsenv decls in
    FStar_Pervasives_Native.snd uu____3884 in
  let typecheck tcenv decls =
    let uu____3897 = FStar_TypeChecker_Tc.tc_decls tcenv decls in
    match uu____3897 with | (ses,uu____3905,uu____3906) -> ses in
  let rules1 =
    FStar_List.append
      (match rules with
  ...
  run_and_rewind st
    (fun st1  ->
       let uu____3925 = st1.repl_env in
                     ...
                     (try
                        ...
                        | FStar_Pervasives_Native.Some def ->
                            ...
                            let uu____3964 =
                              ...
                              FStar_Util.JsonStr uu____3965 in
                            (QueryOK, uu____3964)
                      with
                      | e ->
                          let uu____3973 =
                            let uu____3974 = FStar_Errors.issue_of_exn e in
                            match uu____3974 with
                            | FStar_Pervasives_Native.Some issue ->
                                let uu____3977 =
                                  FStar_Errors.format_issue issue in
                                FStar_Util.JsonStr uu____3977
...
let uu___is_NameContainsStr: search_term' -> Prims.bool =
  fun projectee  ->
    match projectee with | NameContainsStr _0 -> true | uu____3999 -> false
let __proj__NameContainsStr__item___0: search_term' -> Prims.string =
  fun projectee  -> match projectee with | NameContainsStr _0 -> _0
let uu___is_TypeContainsLid: search_term' -> Prims.bool =
  fun projectee  ->
    match projectee with | TypeContainsLid _0 -> true | uu____4013 -> false
...
let sc_of_lid: FStar_Ident.lid -> search_candidate =
  fun lid  ->
    let uu____4121 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
    let uu____4126 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
    { sc_lid = lid; sc_typ = uu____4121; sc_fvars = uu____4126 }
let sc_typ:
  FStar_TypeChecker_Env.env -> search_candidate -> FStar_Syntax_Syntax.typ =
  fun tcenv  ->
    fun sc  ->
      let uu____4146 = FStar_ST.read sc.sc_typ in
      ...
      | FStar_Pervasives_Native.None  ->
          let typ =
            ...
            | FStar_Pervasives_Native.Some ((uu____4171,typ),uu____4173) ->
                typ in
...
let sc_fvars:
  ...
  fun tcenv  ->
    fun sc  ->
      let uu____4195 = FStar_ST.read sc.sc_fvars in
      match uu____4195 with
      | FStar_Pervasives_Native.Some fv -> fv
      | FStar_Pervasives_Native.None  ->
          let fv =
            let uu____4209 = sc_typ tcenv sc in
            FStar_Syntax_Free.fvars uu____4209 in
...
let json_of_search_result:
  ...
  fun dsenv  ->
    fun tcenv  ->
      fun sc  ->
        let typ_str =
          let uu____4229 = sc_typ tcenv sc in
          FStar_Syntax_Print.term_to_string uu____4229 in
        let uu____4230 =
          let uu____4234 =
            let uu____4237 =
              let uu____4238 =
                ...
                uu____4239.FStar_Ident.str in
              FStar_Util.JsonStr uu____4238 in
            ("lid", uu____4237) in
          [uu____4234; ("type", (FStar_Util.JsonStr typ_str))] in
        FStar_Util.JsonAssoc uu____4230
exception InvalidSearch of Prims.string
let uu___is_InvalidSearch: Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with
    | InvalidSearch uu____4253 -> true
    | uu____4254 -> false
let __proj__InvalidSearch__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | InvalidSearch uu____4262 -> uu____4262
let run_search st search_str =
  let uu____4284 = st.repl_env in
  ...
  | (dsenv,tcenv) ->
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              let uu____4305 = sc_fvars tcenv candidate in
              FStar_Util.set_mem lid uu____4305 in
              ...
              let uu____4339 =
                let uu____4340 =
                  FStar_Util.format1 "Improperly quoted search term: %s"
                    term1 in
                InvalidSearch uu____4340 in
              raise uu____4339
            else
              if beg_quote
              then
                (let uu____4342 = strip_quotes term1 in
                 NameContainsStr uu____4342)
              else
      ...
      let pprint_one term =
        ...
        Prims.strcat (if term.st_negate then "-" else "") uu____4363 in
      let results =
        try
          ...
          | [] ->
              let kwds =
                let uu____4417 = FStar_List.map pprint_one terms in
                FStar_Util.concat_l " " uu____4417 in
              let uu____4419 =
                let uu____4420 =
                  FStar_Util.format1 "No results found for query [%s]" kwds in
                InvalidSearch uu____4420 in
              raise uu____4419
          | uu____4423 -> (QueryOK, (FStar_Util.JsonList js))
...
let rec go: repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____4494 = let uu____4501 = run_query st in uu____4501 query.qq in
...
let interactive_error_handler: FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____4531 = let uu____4533 = FStar_ST.read issues in e :: uu____4533 in
    FStar_ST.write issues uu____4531 in
  let count_errors uu____4544 =
    let uu____4545 =
      let uu____4547 = FStar_ST.read issues in
      FStar_List.filter
        (fun e  -> e.FStar_Errors.issue_level = FStar_Errors.EError)
        uu____4547 in
    FStar_List.length uu____4545 in
  let report1 uu____4560 =
    let uu____4561 = FStar_ST.read issues in
    FStar_List.sortWith FStar_Errors.compare_issues uu____4561 in
  let clear1 uu____4569 = FStar_ST.write issues [] in
  {
...
let interactive_mode': Prims.string -> Prims.unit =
  fun filename  ->
    write_hello ();
    (let uu____4582 = deps_of_our_file filename in
          ...
          | (stack,env1,ts) ->
              let initial_range =
                ...
                let uu____4613 =
                  FStar_Range.mk_pos (Prims.parse_int "1")
                    (Prims.parse_int "0") in
                FStar_Range.mk_range "<input>" uu____4612 uu____4613 in
              let env2 =
                let uu____4617 =
                  FStar_TypeChecker_Env.set_range
                    (FStar_Pervasives_Native.snd env1) initial_range in
                ((FStar_Pervasives_Native.fst env1), uu____4617) in
              let env3 =
              ...
              let init_st =
                let uu____4625 = FStar_Util.open_stdin () in
                {
