...
let the_interactive_state : interactive_state = (let _0_667 = (FStar_Util.new_string_builder ())
in (let _0_666 = (FStar_Util.mk_ref None)
in (let _0_665 = (FStar_Util.mk_ref [])
in (let _0_664 = (FStar_Util.mk_ref None)
in {chunk = _0_667; stdin = _0_666; buffer = _0_665; log = _0_664}))))
...
| (l)::(c)::("#lax")::[] -> begin
(let _0_669 = (FStar_Util.int_of_string l)
in (let _0_668 = (FStar_Util.int_of_string c)
in ((true), (_0_669), (_0_668))))
end
| (l)::(c)::[] -> begin
(let _0_671 = (FStar_Util.int_of_string l)
in (let _0_670 = (FStar_Util.int_of_string c)
in ((false), (_0_671), (_0_670))))
end
| uu____597 -> begin
...
let s = the_interactive_state
in (let _0_675 = (let _0_674 = (FStar_ST.read s.buffer)
in (let _0_673 = (let _0_672 = (read_chunk ())
in (_0_672)::[])
in (FStar_List.append _0_674 _0_673)))
in (FStar_ST.write s.buffer _0_675))))
...
in (FStar_List.filter (fun x -> (let _0_677 = (FStar_Parser_Dep.lowercase_module_name x)
in (let _0_676 = (FStar_Parser_Dep.lowercase_module_name filename)
in (_0_677 <> _0_676)))) deps)))
...
let env = (let _0_678 = (FStar_Options.lax ())
in (tc.push env _0_678 true "typecheck_modul"))
in (
...
let uu____1008 = (let _0_680 = (FStar_List.hd stack)
in (let _0_679 = (FStar_List.tl stack)
in ((_0_680), (_0_679))))
...
let uu____1115 = (let _0_682 = (FStar_List.hd st)
in (let _0_681 = (FStar_List.tl st)
in ((_0_682), (_0_681))))
...
| true -> begin
(let _0_683 = (update_deps filename tc curmod stack env ts)
in ((true), (_0_683)))
end
| uu____1376 -> begin
((false), (((stack), (env), (ts))))
...
| true -> begin
(let _0_684 = (FStar_List.hd (FStar_Options.file_list ()))
in (FStar_SMTEncoding_Solver.with_hints_db _0_684 (fun uu____1507 -> (go (((Prims.parse_int "1")), ((Prims.parse_int "0"))) filename tc stack initial_mod env ts))))
end
| uu____1512 -> begin
