        ...
        fun msg  ->
          ...
          | (dsenv,env) ->
              ...
              (FStar_Options.push ();
               ...
               then
                 (let _0_822 = FStar_Options.restore_cmd_line_options false in
                ...
                | uu____1035::ts ->
                    (pop env "";
                     (let uu____1057 =
                        ...
                        let _0_845 = FStar_List.tl stack in (_0_846, _0_845) in
            ...
            fun ts  ->
              ...
              | Push (lax,l,c) ->
                  let uu____1334 =
                    ...
                    then
                      let _0_851 = update_deps filename curmod stack env ts in
                      (true, _0_851)
          ...
          | (stack,env,ts) ->
              ...
              (match uu____1476 with
               | (initial_mod,env) ->
                   ...
                   if uu____1545
                   then
                     let _0_853 = FStar_List.hd (FStar_Options.file_list ()) in
