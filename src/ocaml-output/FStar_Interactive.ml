            ...
            let uu____1683 =
              let uu____1684 =
                let uu____1686 =
                  ...
                  | None  -> []
                  | Some r ->
                      let uu____1690 = json_of_use_range r  in [uu____1690]
                   in
                let uu____1691 =
                  match issue.FStar_Errors.issue_range with
                  | Some r when
  ...
  let js_features =
    let uu____1809 =
      FStar_List.map (fun _0_36  -> FStar_Util.JsonStr _0_36)
       ...
       in
    FStar_All.pipe_left (fun _0_37  -> FStar_Util.JsonList _0_37) uu____1809
     in
            ...
            FStar_List.map
              (fun uu____2010  ->
                 ...
                 | (name,value,doc1,dflt1) ->
                     ...
                     FStar_Util.JsonAssoc uu____2022) opts_and_defaults
             in
      ...
      (match uu____2251 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           let errors =
             ...
             FStar_All.pipe_right uu____2321 (FStar_List.map json_of_issue)
              in
           (FStar_Errors.clear ();
            (let st' =
        ...
        FStar_All.pipe_right uu____2462
          (FStar_Util.map_option
             (fun uu____2488  ->
                ...
                | ((uu____2498,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
         in
      let docs_of_lid lid =
        ...
        | (prefix1,matched,match_len) ->
            ...
            (match uu____2999 with
             | (stripped_ns,shortened) ->
                 ...
                 (uu____3014, uu____3015, uu____3016, match_len))
         in
                       ...
                       | Some l ->
                           let uu____3191 =
                             FStar_Ident.lid_of_ids (FStar_List.append ns id)
                              in
                           FStar_Ident.lid_equals l uu____3191)))
           in
          ...
          (fun uu____3298  ->
             ...
             | (candidate,ns,match_len) ->
                 FStar_Util.JsonList
                   ...
                   FStar_Util.JsonStr candidate]) uu____3260
         in
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____3845
           in
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____4011 = let uu____4018 = run_query st  in uu____4018 query.qq
       in
...
let interactive_error_handler : FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____4048 =
      let uu____4050 = FStar_ST.read issues  in e :: uu____4050  in
