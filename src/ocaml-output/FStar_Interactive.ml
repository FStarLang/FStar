...
let the_interactive_state : interactive_state = (let _0_676 = (FStar_Util.new_string_builder ())
in (let _0_675 = (FStar_Util.mk_ref None)
in (let _0_674 = (FStar_Util.mk_ref [])
in (let _0_673 = (FStar_Util.mk_ref None)
in {chunk = _0_676; stdin = _0_675; buffer = _0_674; log = _0_673}))))
...
| (l)::(c)::("#lax")::[] -> begin
(let _0_678 = (FStar_Util.int_of_string l)
in (let _0_677 = (FStar_Util.int_of_string c)
in ((true), (_0_678), (_0_677))))
end
| (l)::(c)::[] -> begin
(let _0_680 = (FStar_Util.int_of_string l)
in (let _0_679 = (FStar_Util.int_of_string c)
in ((false), (_0_680), (_0_679))))
end
| uu____597 -> begin
...
let s = the_interactive_state
in (let _0_684 = (let _0_683 = (FStar_ST.read s.buffer)
in (let _0_682 = (let _0_681 = (read_chunk ())
in (_0_681)::[])
in (FStar_List.append _0_683 _0_682)))
in (FStar_ST.write s.buffer _0_684))))
...
in (FStar_List.filter (fun x -> (let _0_686 = (FStar_Parser_Dep.lowercase_module_name x)
in (let _0_685 = (FStar_Parser_Dep.lowercase_module_name filename)
in (_0_686 <> _0_685)))) deps)))
...
let env = (let _0_687 = (FStar_Options.lax ())
in (tc.push env _0_687 true "typecheck_modul"))
in (
...
let uu____1008 = (let _0_689 = (FStar_List.hd stack)
in (let _0_688 = (FStar_List.tl stack)
in ((_0_689), (_0_688))))
...
let uu____1115 = (let _0_691 = (FStar_List.hd st)
in (let _0_690 = (FStar_List.tl st)
in ((_0_691), (_0_690))))
...
| true -> begin
(let _0_692 = (update_deps filename tc curmod stack env ts)
in ((true), (_0_692)))
end
| uu____1376 -> begin
((false), (((stack), (env), (ts))))
...
| true -> begin
(let _0_693 = (FStar_List.hd (FStar_Options.file_list ()))
in (FStar_SMTEncoding_Solver.with_hints_db _0_693 (fun uu____1507 -> (go (((Prims.parse_int "1")), ((Prims.parse_int "0"))) filename tc stack initial_mod env ts))))
end
| uu____1512 -> begin
