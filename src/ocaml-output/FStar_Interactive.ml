...
let uu___231_229 = env
in {FStar_TypeChecker_Env.solver = uu___231_229.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___231_229.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___231_229.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___231_229.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___231_229.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___231_229.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___231_229.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___231_229.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___231_229.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___231_229.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___231_229.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___231_229.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___231_229.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___231_229.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___231_229.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___231_229.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___231_229.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___231_229.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax1; FStar_TypeChecker_Env.lax_universes = uu___231_229.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___231_229.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___231_229.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___231_229.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___231_229.FStar_TypeChecker_Env.qname_and_index})
in (
...
let json_to_str : FStar_Util.json  ->  Prims.string = (fun uu___225_983 -> (match (uu___225_983) with
...
let js_int : FStar_Util.json  ->  Prims.int = (fun uu___226_1033 -> (match (uu___226_1033) with
| FStar_Util.JsonInt (i) -> begin
i
end
| other -> begin
...
let js_str : FStar_Util.json  ->  Prims.string = (fun uu___227_1038 -> (match (uu___227_1038) with
| FStar_Util.JsonStr (s) -> begin
s
end
| other -> begin
...
let js_list : FStar_Util.json  ->  FStar_Util.json Prims.list = (fun uu___228_1044 -> (match (uu___228_1044) with
...
let js_assoc : FStar_Util.json  ->  (Prims.string * FStar_Util.json) Prims.list = (fun uu___229_1055 -> (match (uu___229_1055) with
...
let uu____1604 = (json_of_opt (fun _0_33 -> FStar_Util.JsonStr (_0_33)) lr.lr_typ)
in (("type"), (uu____1604)))
in (
...
let uu____1612 = (json_of_opt (fun _0_34 -> FStar_Util.JsonStr (_0_34)) lr.lr_doc)
...
let uu____1628 = (FStar_List.map (fun _0_35 -> FStar_Util.JsonStr (_0_35)) interactive_protocol_features)
in (FStar_All.pipe_left (fun _0_36 -> FStar_Util.JsonList (_0_36)) uu____1628))
...
let uu____1682 = (FStar_List.map (fun _0_37 -> FStar_Util.JsonStr (_0_37)) interactive_protocol_features)
...
let uu___236_1850 = st
in {repl_line = uu___236_1850.repl_line; repl_column = uu___236_1850.repl_column; repl_fname = uu___236_1850.repl_fname; repl_stack = stack; repl_curmod = curmod; repl_env = env; repl_ts = uu___236_1850.repl_ts; repl_stdin = uu___236_1850.repl_stdin}))));
)
end))
...
let uu___237_1973 = st
in {repl_line = line; repl_column = column1; repl_fname = uu___237_1973.repl_fname; repl_stack = stack2; repl_curmod = uu___237_1973.repl_curmod; repl_env = uu___237_1973.repl_env; repl_ts = ts1; repl_stdin = uu___237_1973.repl_stdin})
in (match (res) with
...
let uu___238_2002 = st'
in {repl_line = uu___238_2002.repl_line; repl_column = uu___238_2002.repl_column; repl_fname = uu___238_2002.repl_fname; repl_stack = uu___238_2002.repl_stack; repl_curmod = curmod; repl_env = env4; repl_ts = uu___238_2002.repl_ts; repl_stdin = uu___238_2002.repl_stdin})))))
end
| uu____2003 -> begin
(
...
let uu___239_2021 = st'
in {repl_line = uu___239_2021.repl_line; repl_column = uu___239_2021.repl_column; repl_fname = uu___239_2021.repl_fname; repl_stack = uu___239_2021.repl_stack; repl_curmod = uu___239_2021.repl_curmod; repl_env = env3; repl_ts = uu___239_2021.repl_ts; repl_stdin = uu___239_2021.repl_stdin}))
...
let run_query : repl_state  ->  query'  ->  ((query_status * FStar_Util.json) * (repl_state, Prims.int) FStar_Util.either) = (fun st uu___230_2901 -> (match (uu___230_2901) with
| Exit -> begin
(run_exit st)
end
| DescribeProtocol -> begin
