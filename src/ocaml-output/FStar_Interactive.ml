...
let uu___243_241 = tcenv
in {FStar_TypeChecker_Env.solver = uu___243_241.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___243_241.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___243_241.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___243_241.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___243_241.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___243_241.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___243_241.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___243_241.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___243_241.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___243_241.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___243_241.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___243_241.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___243_241.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___243_241.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___243_241.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___243_241.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___243_241.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___243_241.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = (kind = LaxCheck); FStar_TypeChecker_Env.lax_universes = uu___243_241.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___243_241.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___243_241.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___243_241.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___243_241.FStar_TypeChecker_Env.qname_and_index})
in (
...
let json_to_str : FStar_Util.json  ->  Prims.string = (fun uu___233_998 -> (match (uu___233_998) with
...
let js_int : FStar_Util.json  ->  Prims.int = (fun uu___234_1048 -> (match (uu___234_1048) with
| FStar_Util.JsonInt (i) -> begin
i
end
| other -> begin
...
let js_str : FStar_Util.json  ->  Prims.string = (fun uu___235_1053 -> (match (uu___235_1053) with
| FStar_Util.JsonStr (s) -> begin
s
end
| other -> begin
...
let js_list = (fun k uu___236_1071 -> (match (uu___236_1071) with
...
let js_assoc : FStar_Util.json  ->  (Prims.string * FStar_Util.json) Prims.list = (fun uu___237_1083 -> (match (uu___237_1083) with
...
let validate_interactive_query : query  ->  query = (fun uu___238_1550 -> (match (uu___238_1550) with
...
let rec json_of_fstar_option : FStar_Options.option_val  ->  FStar_Util.json = (fun uu___239_1573 -> (match (uu___239_1573) with
...
let uu___250_2179 = st
in {repl_line = uu___250_2179.repl_line; repl_column = uu___250_2179.repl_column; repl_fname = uu___250_2179.repl_fname; repl_stack = stack; repl_curmod = curmod; repl_env = env; repl_ts = uu___250_2179.repl_ts; repl_stdin = uu___250_2179.repl_stdin}))));
)
end))
...
let uu___251_2307 = st
in {repl_line = line; repl_column = column1; repl_fname = uu___251_2307.repl_fname; repl_stack = stack2; repl_curmod = uu___251_2307.repl_curmod; repl_env = uu___251_2307.repl_env; repl_ts = ts1; repl_stdin = uu___251_2307.repl_stdin})
in (match (res) with
...
let uu___252_2336 = st'
in {repl_line = uu___252_2336.repl_line; repl_column = uu___252_2336.repl_column; repl_fname = uu___252_2336.repl_fname; repl_stack = uu___252_2336.repl_stack; repl_curmod = curmod; repl_env = env4; repl_ts = uu___252_2336.repl_ts; repl_stdin = uu___252_2336.repl_stdin})))))
end
| uu____2337 -> begin
(
...
let uu___253_2355 = st'
in {repl_line = uu___253_2355.repl_line; repl_column = uu___253_2355.repl_column; repl_fname = uu___253_2355.repl_fname; repl_stack = uu___253_2355.repl_stack; repl_curmod = uu___253_2355.repl_curmod; repl_env = env3; repl_ts = uu___253_2355.repl_ts; repl_stdin = uu___253_2355.repl_stdin}))
...
in (FStar_Util.bind_opt uu____2507 (fun uu___240_2527 -> (match (uu___240_2527) with
...
let uu___254_3348 = st1
in {repl_line = uu___254_3348.repl_line; repl_column = uu___254_3348.repl_column; repl_fname = uu___254_3348.repl_fname; repl_stack = uu___254_3348.repl_stack; repl_curmod = uu___254_3348.repl_curmod; repl_env = env; repl_ts = uu___254_3348.repl_ts; repl_stdin = uu___254_3348.repl_stdin})
...
let st_cost : search_term'  ->  Prims.int = (fun uu___241_3603 -> (match (uu___241_3603) with
...
let run_query : repl_state  ->  query'  ->  ((query_status * FStar_Util.json) * (repl_state, Prims.int) FStar_Util.either) = (fun st uu___242_3957 -> (match (uu___242_3957) with
| Exit -> begin
(run_exit st)
end
| DescribeProtocol -> begin
