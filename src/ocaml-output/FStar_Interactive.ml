    ...
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,env) ->
              let env1 =
                let uu___188_229 = env in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___188_229.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___188_229.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___188_229.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___188_229.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___188_229.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___188_229.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___188_229.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___188_229.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___188_229.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___188_229.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___188_229.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___188_229.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___188_229.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___188_229.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___188_229.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___188_229.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___188_229.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___188_229.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = lax1;
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___188_229.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.type_of =
                    (uu___188_229.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___188_229.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___188_229.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___188_229.FStar_TypeChecker_Env.qname_and_index)
                } in
    ...
    let uu____781 =
      FStar_List.partition
        (fun x  ->
           ...
           let uu____788 = FStar_Parser_Dep.lowercase_module_name filename in
           uu____787 <> uu____788) deps in
              ...
              ((let uu____805 =
                  (let uu____806 = FStar_Parser_Dep.is_interface intf in
                   Prims.op_Negation uu____806) ||
                    (let uu____807 = FStar_Parser_Dep.is_implementation impl in
                     Prims.op_Negation uu____807) in
                if uu____805
                then
                  let uu____808 =
                    FStar_Util.format2
        ...
        fun curmod  ->
          fun env  ->
            fun ts  ->
              ...
              | Info (file,row,col) ->
                  let iopt =
                    FStar_TypeChecker_Err.info_at_pos (Prims.snd env) file
                      row col in
                  ((match iopt with
              ...
              | Code (text1,(ok,fail1)) ->
                  ...
                  (match res with
                   ...
                   | uu____1512 -> fail2 curmod env_mark)
let interactive_mode: Prims.string -> Prims.unit =
  fun filename  ->
    (let uu____1524 =
       let uu____1525 = FStar_Options.codegen () in
       FStar_Option.isSome uu____1525 in
     if uu____1524
     then
       FStar_Util.print_warning
         "code-generation is not supported in interactive mode, ignoring the codegen flag"
     else ());
    (let uu____1528 = deps_of_our_file filename in
     match uu____1528 with
     | (filenames,maybe_intf) ->
         let env = tc_prims () in
         let uu____1542 = tc_deps None [] env filenames [] in
         (match uu____1542 with
          | (stack,env1,ts) ->
              let uu____1557 =
                ...
                | Some intf ->
                    let frag =
                      let uu____1570 = FStar_Util.file_get_contents intf in
                      {
                        FStar_Parser_ParseIt.frag_text = uu____1570;
                        FStar_Parser_ParseIt.frag_line =
                          (Prims.parse_int "0");
                        FStar_Parser_ParseIt.frag_col = (Prims.parse_int "0")
                      } in
                    let uu____1571 = check_frag env1 None frag in
                          ...
                          then
                            ((let uu____1601 =
                                FStar_Util.format1
                                  ...
                                  intf in
                              FStar_Util.print_warning uu____1601);
                             FStar_All.exit (Prims.parse_int "1"))
                          else ();
              ...
              (match uu____1557 with
               | (initial_mod,env2) ->
                   ...
                   then
                     let uu____1630 =
                       let uu____1631 = FStar_Options.file_list () in
                       FStar_List.hd uu____1631 in
                     FStar_SMTEncoding_Solver.with_hints_db uu____1630
                       (fun uu____1633  ->
