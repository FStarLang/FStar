    ...
    fun kind  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,tcenv) ->
              let tcenv1 =
                let uu___208_241 = tcenv in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___208_241.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___208_241.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___208_241.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___208_241.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___208_241.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___208_241.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___208_241.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___208_241.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___208_241.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___208_241.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___208_241.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___208_241.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___208_241.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___208_241.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___208_241.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___208_241.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___208_241.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___208_241.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = (kind = LaxCheck);
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___208_241.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.type_of =
                    (uu___208_241.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___208_241.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___208_241.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___208_241.FStar_TypeChecker_Env.qname_and_index);
                  FStar_TypeChecker_Env.proof_ns =
                    (uu___208_241.FStar_TypeChecker_Env.proof_ns)
                } in
              let dsenv1 =
    ...
    try
      ...
      let uu____1441 =
        ...
        | "push" ->
            let uu____1456 =
              let uu____1462 =
                let uu____1463 = arg "kind" in
                FStar_All.pipe_right uu____1463 js_pushkind in
              let uu____1464 =
                let uu____1465 = arg "code" in
                FStar_All.pipe_right uu____1465 js_str in
              let uu____1466 =
                let uu____1467 = arg "line" in
                FStar_All.pipe_right uu____1467 js_int in
              let uu____1468 =
                let uu____1469 = arg "column" in
                FStar_All.pipe_right uu____1469 js_int in
              (uu____1462, uu____1464, uu____1466, uu____1468,
                (query = "peek")) in
            Push uu____1456
        | "autocomplete" ->
            let uu____1470 =
              let uu____1471 = arg "partial-symbol" in
              FStar_All.pipe_right uu____1471 js_str in
            AutoComplete uu____1470
        | "lookup" ->
            let uu____1472 =
              let uu____1481 =
                let uu____1482 = arg "symbol" in
                FStar_All.pipe_right uu____1482 js_str in
              let uu____1483 =
                let uu____1488 =
                  let uu____1493 = try_arg "location" in
                ...
                FStar_All.pipe_right uu____1488
                  (FStar_Util.map_option
                     (fun loc  ->
                        let uu____1521 =
                          let uu____1522 = assoc1 "[location]" "filename" loc in
                          FStar_All.pipe_right uu____1522 js_str in
                        let uu____1523 =
                          let uu____1524 = assoc1 "[location]" "line" loc in
                          FStar_All.pipe_right uu____1524 js_int in
                        let uu____1525 =
                          let uu____1526 = assoc1 "[location]" "column" loc in
                          FStar_All.pipe_right uu____1526 js_int in
                        (uu____1521, uu____1523, uu____1525))) in
              let uu____1527 =
                let uu____1529 = arg "requested-info" in
                FStar_All.pipe_right uu____1529 (js_list js_str) in
              (uu____1481, uu____1483, uu____1527) in
            Lookup uu____1472
        | "compute" ->
            let uu____1536 =
              let uu____1541 =
                let uu____1542 = arg "term" in
                FStar_All.pipe_right uu____1542 js_str in
              let uu____1543 =
                let uu____1546 = try_arg "rules" in
                FStar_All.pipe_right uu____1546
                  (FStar_Util.map_option (js_list js_reductionrule)) in
              (uu____1541, uu____1543) in
            Compute uu____1536
        | "search" ->
            let uu____1554 =
              let uu____1555 = arg "terms" in
              FStar_All.pipe_right uu____1555 js_str in
            Search uu____1554
        | uu____1556 ->
            let uu____1557 = FStar_Util.format1 "Unknown query '%s'" query in
            ProtocolViolation uu____1557 in
      { qq = uu____1441; qid }
    with | InvalidQuery msg -> { qq = (ProtocolViolation msg); qid }
    | UnexpectedJsonType (expected,got) -> wrap_js_failure qid expected got
let validate_interactive_query: query -> query =
  fun uu___203_1564  ->
    match uu___203_1564 with
...
let read_interactive_query: FStar_Util.stream_reader -> query =
  fun stream  ->
    try
      let uu____1574 = FStar_Util.read_line stream in
      match uu____1574 with
      | None  -> FStar_All.exit (Prims.parse_int "0")
      | Some line ->
          let uu____1577 = FStar_Util.json_of_string line in
          (match uu____1577 with
           | None  ->
               { qq = (ProtocolViolation "Json parsing failed."); qid = "?" }
           | Some request ->
               let uu____1580 = unpack_interactive_query request in
               validate_interactive_query uu____1580)
    with | InvalidQuery msg -> { qq = (ProtocolViolation msg); qid = "?" }
    | UnexpectedJsonType (expected,got) -> wrap_js_failure "?" expected got
let rec json_of_fstar_option: FStar_Options.option_val -> FStar_Util.json =
  fun uu___204_1587  ->
    match uu___204_1587 with
    | FStar_Options.Bool b -> FStar_Util.JsonBool b
    | FStar_Options.String s -> FStar_Util.JsonStr s
    | FStar_Options.Path s -> FStar_Util.JsonStr s
    | FStar_Options.Int n1 -> FStar_Util.JsonInt n1
    | FStar_Options.List vs ->
        let uu____1594 = FStar_List.map json_of_fstar_option vs in
        FStar_Util.JsonList uu____1594
    | FStar_Options.Unset  -> FStar_Util.JsonNull
let json_of_opt json_of_a opt_a =
  let uu____1615 = FStar_Util.map_option json_of_a opt_a in
  FStar_Util.dflt FStar_Util.JsonNull uu____1615
let json_of_pos: FStar_Range.pos -> FStar_Util.json =
  fun pos  ->
    let uu____1620 =
      let uu____1622 =
        let uu____1623 = FStar_Range.line_of_pos pos in
        FStar_Util.JsonInt uu____1623 in
      let uu____1624 =
        let uu____1626 =
          let uu____1627 = FStar_Range.col_of_pos pos in
          FStar_Util.JsonInt uu____1627 in
        [uu____1626] in
      uu____1622 :: uu____1624 in
    FStar_Util.JsonList uu____1620
    ...
    fun b  ->
      fun e  ->
        let uu____1637 =
          let uu____1641 =
            let uu____1645 =
              let uu____1648 = json_of_pos b in ("beg", uu____1648) in
            let uu____1649 =
              let uu____1653 =
                let uu____1656 = json_of_pos e in ("end", uu____1656) in
              [uu____1653] in
            uu____1645 :: uu____1649 in
          ("fname", (FStar_Util.JsonStr file)) :: uu____1641 in
        FStar_Util.JsonAssoc uu____1637
let json_of_use_range: FStar_Range.range -> FStar_Util.json =
  fun r  ->
    let uu____1668 = FStar_Range.file_of_use_range r in
    let uu____1669 = FStar_Range.start_of_use_range r in
    let uu____1670 = FStar_Range.end_of_use_range r in
    json_of_range_fields uu____1668 uu____1669 uu____1670
let json_of_def_range: FStar_Range.range -> FStar_Util.json =
  fun r  ->
    let uu____1674 = FStar_Range.file_of_range r in
    let uu____1675 = FStar_Range.start_of_range r in
    let uu____1676 = FStar_Range.end_of_range r in
    json_of_range_fields uu____1674 uu____1675 uu____1676
            ...
            let uu____1698 =
              let uu____1699 =
                let uu____1701 =
                  ...
                  | None  -> []
                  | Some r ->
                      let uu____1705 = json_of_use_range r in [uu____1705] in
                let uu____1706 =
                  match issue.FStar_Errors.issue_range with
                  | Some r when
                      r.FStar_Range.def_range <> r.FStar_Range.use_range ->
                      let uu____1710 = json_of_def_range r in [uu____1710]
                  | uu____1711 -> [] in
                FStar_List.append uu____1701 uu____1706 in
              FStar_Util.JsonList uu____1699 in
            ("ranges", uu____1698) in
          [uu____1695] in
        ("message", (FStar_Util.JsonStr (issue.FStar_Errors.issue_message)))
          :: uu____1691 in
      ("level", (json_of_issue_level issue.FStar_Errors.issue_level)) ::
        uu____1687 in
    FStar_Util.JsonAssoc uu____1683
type lookup_result =
  {
              ...
              let uu____1803 =
                let uu____1806 =
                  json_of_opt (fun _0_35  -> FStar_Util.JsonStr _0_35)
                    lr.lr_def in
                ("definition", uu____1806) in
              [uu____1803] in
            uu____1795 :: uu____1799 in
          uu____1787 :: uu____1791 in
        uu____1779 :: uu____1783 in
      ("name", (FStar_Util.JsonStr (lr.lr_name))) :: uu____1775 in
    FStar_Util.JsonAssoc uu____1771
let json_of_protocol_info: (Prims.string* FStar_Util.json) Prims.list =
  ...
  let js_features =
    ...
    FStar_All.pipe_left (fun _0_37  -> FStar_Util.JsonList _0_37) uu____1824 in
  [("version", js_version); ("features", js_features)]
let write_json: FStar_Util.json -> Prims.unit =
  fun json  ->
    (let uu____1837 = FStar_Util.string_of_json json in
     FStar_Util.print_raw uu____1837);
    ...
    let js_features =
      let uu____1878 =
        FStar_List.map (fun _0_38  -> FStar_Util.JsonStr _0_38)
          interactive_protocol_features in
      FStar_Util.JsonList uu____1878 in
    write_json
...
let json_of_repl_state:
  ...
  fun st  ->
    let opts_and_defaults =
      let opt_docs =
        let uu____1953 = FStar_Options.docs () in
        FStar_Util.smap_of_list uu____1953 in
      let get_doc k = FStar_Util.smap_try_find opt_docs k in
      FStar_List.map
        (fun uu____1969  ->
           match uu____1969 with
           | (k,v1) ->
               let uu____1979 = FStar_Options.get_option k in
               let uu____1980 = get_doc k in (k, uu____1979, uu____1980, v1))
        ...
        let uu____1987 =
          FStar_List.map
            (fun uu____1995  ->
               ...
               | (uu____2002,fstname,uu____2004,uu____2005) ->
                   FStar_Util.JsonStr fstname) st.repl_ts in
        FStar_Util.JsonList uu____1987 in
      ("loaded-dependencies", uu____1986) in
    let uu____2010 =
      let uu____2014 =
        let uu____2017 =
          let uu____2018 =
              ...
              (fun uu____2025  ->
                 ...
                 | (name,value,doc1,dflt1) ->
                     let uu____2037 =
                       let uu____2041 =
                         let uu____2045 =
                           let uu____2048 = json_of_fstar_option value in
                           ("value", uu____2048) in
                         let uu____2049 =
                           let uu____2053 =
                             let uu____2056 = json_of_fstar_option dflt1 in
                             ("default", uu____2056) in
                           let uu____2057 =
                             let uu____2061 =
                               let uu____2064 =
                                 json_of_opt
                                   ...
                                   doc1 in
                               ("documentation", uu____2064) in
                             [uu____2061] in
                           uu____2053 :: uu____2057 in
                         uu____2045 :: uu____2049 in
                       ("name", (FStar_Util.JsonStr name)) :: uu____2041 in
                     FStar_Util.JsonAssoc uu____2037) opts_and_defaults in
          FStar_Util.JsonList uu____2018 in
        ("options", uu____2017) in
      [uu____2014] in
    uu____1983 :: uu____2010
let run_exit st =
...
let run_describe_repl st =
  let uu____2132 =
    let uu____2135 =
      let uu____2136 = json_of_repl_state st in
      FStar_Util.JsonAssoc uu____2136 in
    (QueryOK, uu____2135) in
  (uu____2132, (FStar_Util.Inl st))
  ...
  | (env,curmod)::stack ->
      (pop st.repl_env "#pop";
       ...
       ((QueryOK, FStar_Util.JsonNull),
         (FStar_Util.Inl
            ((let uu___215_2218 = st in
              {
                repl_line = (uu___215_2218.repl_line);
                repl_column = (uu___215_2218.repl_column);
                repl_fname = (uu___215_2218.repl_fname);
                repl_stack = stack;
                repl_curmod = curmod;
                repl_env = env;
                repl_ts = (uu___215_2218.repl_ts);
                repl_stdin = (uu___215_2218.repl_stdin)
              })))))
let run_push st kind text1 line column1 peek_only =
  let uu____2257 = ((st.repl_stack), (st.repl_env), (st.repl_ts)) in
  ...
  | (stack,env,ts) ->
      ...
      (match uu____2270 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           let errors =
             let uu____2344 = FStar_Errors.report_all () in
             FStar_All.pipe_right uu____2344 (FStar_List.map json_of_issue) in
           (FStar_Errors.clear ();
            (let st' =
               let uu___216_2350 = st in
               {
                 repl_line = line;
                 repl_column = column1;
                 repl_fname = (uu___216_2350.repl_fname);
                 repl_stack = stack2;
                 repl_curmod = (uu___216_2350.repl_curmod);
                 repl_env = (uu___216_2350.repl_env);
                 repl_ts = ts1;
                 repl_stdin = (uu___216_2350.repl_stdin)
               } in
             match res with
             | Some (curmod,env3,nerrs) when
                 ...
                 ((QueryOK, (FStar_Util.JsonList errors)),
                   (FStar_Util.Inl
                      (let uu___217_2379 = st' in
                       {
                         repl_line = (uu___217_2379.repl_line);
                         repl_column = (uu___217_2379.repl_column);
                         repl_fname = (uu___217_2379.repl_fname);
                         repl_stack = (uu___217_2379.repl_stack);
                         repl_curmod = curmod;
                         repl_env = env4;
                         repl_ts = (uu___217_2379.repl_ts);
                         repl_stdin = (uu___217_2379.repl_stdin)
                       })))
             | uu____2380 ->
                 let env3 = reset_mark env_mark in
                 let uu____2391 =
                   run_pop
                     (let uu___218_2398 = st' in
                      {
                        repl_line = (uu___218_2398.repl_line);
                        repl_column = (uu___218_2398.repl_column);
                        repl_fname = (uu___218_2398.repl_fname);
                        repl_stack = (uu___218_2398.repl_stack);
                        repl_curmod = (uu___218_2398.repl_curmod);
                        repl_env = env3;
                        repl_ts = (uu___218_2398.repl_ts);
                        repl_stdin = (uu___218_2398.repl_stdin)
                      }) in
  ...
  | (dsenv,tcenv) ->
      let info_of_lid_str lid_str =
        let lid =
          ...
          FStar_Ident.lid_of_ids uu____2479 in
        let lid1 =
          let uu____2482 =
            FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv lid in
          FStar_All.pipe_left (FStar_Util.dflt lid) uu____2482 in
        let uu____2485 = FStar_TypeChecker_Env.try_lookup_lid tcenv lid1 in
        FStar_All.pipe_right uu____2485
          (FStar_Util.map_option
             (fun uu____2511  ->
                match uu____2511 with
                | ((uu____2521,typ),r) -> ((FStar_Util.Inr lid1), typ, r))) in
      let docs_of_lid lid =
        let uu____2533 = FStar_ToSyntax_Env.try_lookup_doc dsenv lid in
        FStar_All.pipe_right uu____2533
          (FStar_Util.map_option FStar_Pervasives.fst) in
      let def_of_lid lid =
        let uu____2550 = FStar_TypeChecker_Env.lookup_qname tcenv lid in
        FStar_Util.bind_opt uu____2550
          (fun uu___205_2570  ->
             match uu___205_2570 with
             | (FStar_Util.Inr (se,uu____2582),uu____2583) ->
                 let uu____2598 = FStar_Syntax_Print.sigelt_to_string se in
                 Some uu____2598
             | uu____2599 -> None) in
      let info_at_pos_opt =
      ...
      let info_opt =
        ...
        | Some uu____2650 -> info_at_pos_opt
      ...
      let response =
        ...
        | Some (name_or_lid,typ,rng) ->
            ...
            let uu____2727 = json_of_lookup_result result in
            (QueryOK, uu____2727) in
      (response, (FStar_Util.Inl st))
let run_completions st search_term =
  let uu____2750 = st.repl_env in
  match uu____2750 with
  | (dsenv,tcenv) ->
      let rec measure_anchored_match search_term1 candidate =
        match (search_term1, candidate) with
        | ([],uu____2780) -> Some ([], (Prims.parse_int "0"))
        | (uu____2788,[]) -> None
        | (hs::ts,hc::tc) ->
      ...
      let rec locate_match needle candidate =
        let uu____2880 = measure_anchored_match needle candidate in
        ...
        | None  ->
            (match candidate with
             | [] -> None
             | hc::tc ->
                 let uu____2922 = locate_match needle tc in
      ...
      let str_of_ids ids =
        let uu____2977 = FStar_List.map FStar_Ident.text_of_id ids in
        FStar_Util.concat_l "." uu____2977 in
      let match_lident_against needle lident =
        locate_match needle
          (FStar_List.append lident.FStar_Ident.ns [lident.FStar_Ident.ident]) in
      let shorten_namespace uu____3006 =
        ...
        | (prefix1,matched,match_len) ->
            ...
            (match uu____3027 with
             | (stripped_ns,shortened) ->
                 let uu____3042 = str_of_ids shortened in
                 let uu____3043 = str_of_ids matched in
                 let uu____3044 = str_of_ids stripped_ns in
                 (uu____3042, uu____3043, uu____3044, match_len)) in
      ...
      let matches =
                    ...
                    FStar_Option.map
                      (fun fqn  ->
                         let uu____3153 =
                           ...
                           FStar_List.append uu____3155
                             [fqn.FStar_Ident.ident] in
                         ([], uu____3153, matched_length)) uu____3145
                  else None)) in
        let case_b_find_matches_in_env uu____3174 =
          let matches =
          ...
          FStar_All.pipe_right matches
            (FStar_List.filter
               (fun uu____3210  ->
                  ...
                  | (ns,id,uu____3218) ->
                      let uu____3223 =
                        let uu____3225 = FStar_Ident.lid_of_ids id in
                        FStar_ToSyntax_Env.resolve_to_fully_qualified_name
                          dsenv uu____3225 in
                      (match uu____3223 with
                       ...
                       | Some l ->
                           ...
                           FStar_Ident.lid_equals l uu____3227))) in
        let uu____3228 = FStar_Util.prefix needle in
        ...
        | (ns,id) ->
            ...
            FStar_All.pipe_right matched_ids
              (FStar_List.map
                 (fun x  ->
                    let uu____3289 = shorten_namespace x in
                    prepare_candidate uu____3289)) in
      let json_candidates =
        let uu____3296 =
          FStar_Util.sort_with
            (fun uu____3304  ->
               fun uu____3305  ->
                 match (uu____3304, uu____3305) with
                 | ((cd1,ns1,uu____3320),(cd2,ns2,uu____3323)) ->
          ...
          (fun uu____3334  ->
             ...
             | (candidate,ns,match_len) ->
                 FStar_Util.JsonList
                   ...
                   FStar_Util.JsonStr candidate]) uu____3296 in
...
let run_compute st term rules =
  let run_and_rewind st1 task =
    ...
    let st' =
      let uu___219_3404 = st1 in
      {
        repl_line = (uu___219_3404.repl_line);
        repl_column = (uu___219_3404.repl_column);
        repl_fname = (uu___219_3404.repl_fname);
        repl_stack = (uu___219_3404.repl_stack);
        repl_curmod = (uu___219_3404.repl_curmod);
        repl_env = env;
        repl_ts = (uu___219_3404.repl_ts);
        repl_stdin = (uu___219_3404.repl_stdin)
      } in
  ...
  let find_let_body ses =
    ...
    | {
        FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
          ((uu____3436,{ FStar_Syntax_Syntax.lbname = uu____3437;
                         FStar_Syntax_Syntax.lbunivs = uu____3438;
                         FStar_Syntax_Syntax.lbtyp = uu____3439;
                         FStar_Syntax_Syntax.lbeff = uu____3440;
                         FStar_Syntax_Syntax.lbdef = def;_}::[]),uu____3442,uu____3443);
        FStar_Syntax_Syntax.sigrng = uu____3444;
        FStar_Syntax_Syntax.sigquals = uu____3445;
        FStar_Syntax_Syntax.sigmeta = uu____3446;_}::[] -> Some def
    | uu____3465 -> None in
  let parse1 frag =
    let uu____3475 = FStar_Parser_ParseIt.parse (FStar_Util.Inr frag) in
    match uu____3475 with
    | FStar_Util.Inl (FStar_Util.Inr decls,uu____3488) -> Some decls
    | uu____3511 -> None in
  let desugar dsenv decls =
    let uu____3531 = FStar_ToSyntax_ToSyntax.desugar_decls dsenv decls in
    snd uu____3531 in
  let typecheck tcenv decls =
    let uu____3544 = FStar_TypeChecker_Tc.tc_decls tcenv decls in
    match uu____3544 with | (ses,uu____3552,uu____3553) -> ses in
  let rules1 =
    FStar_List.append
      (match rules with
       | Some rules1 -> rules1
  ...
  run_and_rewind st
    (fun st1  ->
       let uu____3566 = st1.repl_env in
                     ...
                     (try
                        ...
                        | Some def ->
                            ...
                            let uu____3602 =
                              ...
                              FStar_Util.JsonStr uu____3603 in
                            (QueryOK, uu____3602)
                      with
                      | e ->
                          let uu____3608 =
                            let uu____3609 = FStar_Errors.issue_of_exn e in
                            match uu____3609 with
                            | Some issue ->
                                let uu____3612 =
                                  FStar_Errors.format_issue issue in
                                FStar_Util.JsonStr uu____3612
                            | None  -> raise e in
                          (QueryNOK, uu____3608)))))
type search_term' =
...
let uu___is_NameContainsStr: search_term' -> Prims.bool =
  fun projectee  ->
    match projectee with | NameContainsStr _0 -> true | uu____3629 -> false
let __proj__NameContainsStr__item___0: search_term' -> Prims.string =
  fun projectee  -> match projectee with | NameContainsStr _0 -> _0
let uu___is_TypeContainsLid: search_term' -> Prims.bool =
  fun projectee  ->
    match projectee with | TypeContainsLid _0 -> true | uu____3641 -> false
...
let sc_of_lid: FStar_Ident.lid -> search_candidate =
  fun lid  ->
    let uu____3713 = FStar_Util.mk_ref None in
    let uu____3718 = FStar_Util.mk_ref None in
    { sc_lid = lid; sc_typ = uu____3713; sc_fvars = uu____3718 }
let sc_typ:
  FStar_TypeChecker_Env.env -> search_candidate -> FStar_Syntax_Syntax.typ =
  fun tcenv  ->
    fun sc  ->
      let uu____3736 = FStar_ST.read sc.sc_typ in
      ...
      | None  ->
          let typ =
            ...
            | Some ((uu____3761,typ),uu____3763) -> typ in
...
let sc_fvars:
  ...
  fun tcenv  ->
    fun sc  ->
      let uu____3783 = FStar_ST.read sc.sc_fvars in
      match uu____3783 with
      | Some fv -> fv
      | None  ->
          let fv =
            let uu____3797 = sc_typ tcenv sc in
            FStar_Syntax_Free.fvars uu____3797 in
...
let json_of_search_result:
  ...
  fun dsenv  ->
    fun tcenv  ->
      fun sc  ->
        let typ_str =
          let uu____3814 = sc_typ tcenv sc in
          FStar_Syntax_Print.term_to_string uu____3814 in
        let uu____3815 =
          let uu____3819 =
            let uu____3822 =
              let uu____3823 =
                ...
                uu____3824.FStar_Ident.str in
              FStar_Util.JsonStr uu____3823 in
            ("lid", uu____3822) in
          [uu____3819; ("type", (FStar_Util.JsonStr typ_str))] in
        FStar_Util.JsonAssoc uu____3815
exception InvalidSearch of Prims.string
let uu___is_InvalidSearch: Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with
    | InvalidSearch uu____3836 -> true
    | uu____3837 -> false
let __proj__InvalidSearch__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | InvalidSearch uu____3844 -> uu____3844
let run_search st search_str =
  let uu____3863 = st.repl_env in
  ...
  | (dsenv,tcenv) ->
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              let uu____3884 = sc_fvars tcenv candidate in
              FStar_Util.set_mem lid uu____3884 in
              ...
              let uu____3918 =
                let uu____3919 =
                  FStar_Util.format1 "Improperly quoted search term: %s"
                    term1 in
                InvalidSearch uu____3919 in
              raise uu____3918
            else
              if beg_quote
              then
                (let uu____3921 = strip_quotes term1 in
                 NameContainsStr uu____3921)
              else
      ...
      let pprint_one term =
        ...
        Prims.strcat (if term.st_negate then "-" else "") uu____3942 in
      let results =
        try
          ...
          | [] ->
              let kwds =
                let uu____3983 = FStar_List.map pprint_one terms in
                FStar_Util.concat_l " " uu____3983 in
              let uu____3985 =
                let uu____3986 =
                  FStar_Util.format1 "No results found for query [%s]" kwds in
                InvalidSearch uu____3986 in
              raise uu____3985
          | uu____3989 -> (QueryOK, (FStar_Util.JsonList js))
...
let rec go: repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____4056 = let uu____4063 = run_query st in uu____4063 query.qq in
...
let interactive_error_handler: FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____4093 = let uu____4095 = FStar_ST.read issues in e :: uu____4095 in
    FStar_ST.write issues uu____4093 in
  let count_errors uu____4106 =
    let uu____4107 =
      let uu____4109 = FStar_ST.read issues in
      FStar_List.filter
        (fun e  -> e.FStar_Errors.issue_level = FStar_Errors.EError)
        uu____4109 in
    FStar_List.length uu____4107 in
...
let interactive_mode': Prims.string -> Prims.unit =
  fun filename  ->
    write_hello ();
    (let uu____4142 = deps_of_our_file filename in
     match uu____4142 with
     | (filenames,maybe_intf) ->
         let env = tc_prims () in
         let uu____4156 = tc_deps None [] env filenames [] in
         (match uu____4156 with
          | (stack,env1,ts) ->
              ...
              then
                let uu____4187 =
                  let uu____4188 = FStar_Options.file_list () in
                  FStar_List.hd uu____4188 in
                FStar_SMTEncoding_Solver.with_hints_db uu____4187
                  (fun uu____4190  -> go init_st)
              else go init_st))
let interactive_mode: Prims.string -> Prims.unit =
  fun filename  ->
    ...
    (let uu____4198 =
       let uu____4199 = FStar_Options.codegen () in
       FStar_Option.isSome uu____4199 in
     if uu____4198
     then
