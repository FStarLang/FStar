    ...
    fun kind  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,tcenv) ->
              let tcenv1 =
                let uu___205_391 = tcenv in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___205_391.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___205_391.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___205_391.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___205_391.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___205_391.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___205_391.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___205_391.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___205_391.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___205_391.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___205_391.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___205_391.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___205_391.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___205_391.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___205_391.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___205_391.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___205_391.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___205_391.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___205_391.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = (kind = LaxCheck);
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___205_391.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.failhard =
                    (uu___205_391.FStar_TypeChecker_Env.failhard);
                  FStar_TypeChecker_Env.nosynth =
                    (uu___205_391.FStar_TypeChecker_Env.nosynth);
                  FStar_TypeChecker_Env.type_of =
                    (uu___205_391.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___205_391.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___205_391.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___205_391.FStar_TypeChecker_Env.qname_and_index);
                  FStar_TypeChecker_Env.proof_ns =
                    (uu___205_391.FStar_TypeChecker_Env.proof_ns);
                  FStar_TypeChecker_Env.synth =
                    (uu___205_391.FStar_TypeChecker_Env.synth);
                  FStar_TypeChecker_Env.is_native_tactic =
                    (uu___205_391.FStar_TypeChecker_Env.is_native_tactic);
                  FStar_TypeChecker_Env.identifier_info =
                    (uu___205_391.FStar_TypeChecker_Env.identifier_info)
                } in
              let dsenv1 =
...
let js_int: FStar_Util.json -> Prims.int =
  fun uu___196_1762  ->
    match uu___196_1762 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
let js_str: FStar_Util.json -> Prims.string =
  fun uu___197_1768  ->
    match uu___197_1768 with
...
let json_of_protocol_info:
  ...
  let js_features =
    ...
    FStar_All.pipe_left (fun _0_46  -> FStar_Util.JsonList _0_46) uu____3047 in
    ...
    then
      ...
      (match st.repl_stack with
       ...
       | (env,curmod)::stack ->
           (pop st.repl_env "#pop";
            (let st' =
               let uu___212_3842 = st in
               {
                 repl_line = (uu___212_3842.repl_line);
                 repl_column = (uu___212_3842.repl_column);
                 repl_fname = (uu___212_3842.repl_fname);
                 repl_stack = stack;
                 repl_curmod = curmod;
                 repl_env = env;
                 repl_ts = (uu___212_3842.repl_ts);
                 repl_stdin = (uu___212_3842.repl_stdin)
               } in
              ...
              | (stack,env,ts) ->
                  ...
                  (match uu____3926 with
                   | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
                       ...
                       (FStar_Errors.clear ();
                        (let st' =
                           let uu___213_4038 = st in
                           {
                             repl_line = line;
                             repl_column = column;
                             repl_fname = (uu___213_4038.repl_fname);
                             repl_stack = stack2;
                             repl_curmod = (uu___213_4038.repl_curmod);
                             repl_env = (uu___213_4038.repl_env);
                             repl_ts = ts1;
                             repl_stdin = (uu___213_4038.repl_stdin)
                           } in
                         match res with
                         | FStar_Pervasives_Native.Some (curmod,env3,nerrs)
                             ...
                             ((QueryOK, (FStar_Util.JsonList errors)),
                               (FStar_Util.Inl
                                  (let uu___214_4092 = st' in
                                   {
                                     repl_line = (uu___214_4092.repl_line);
                                     repl_column =
                                       (uu___214_4092.repl_column);
                                     repl_fname = (uu___214_4092.repl_fname);
                                     repl_stack = (uu___214_4092.repl_stack);
                                     repl_curmod = curmod;
                                     repl_env = env4;
                                     repl_ts = (uu___214_4092.repl_ts);
                                     repl_stdin = (uu___214_4092.repl_stdin)
                                   })))
                         | uu____4093 ->
                             let env3 = reset_mark env_mark in
                             let uu____4113 =
                               run_pop
                                 (let uu___215_4127 = st' in
                                  {
                                    repl_line = (uu___215_4127.repl_line);
                                    repl_column = (uu___215_4127.repl_column);
                                    repl_fname = (uu___215_4127.repl_fname);
                                    repl_stack = (uu___215_4127.repl_stack);
                                    repl_curmod = (uu___215_4127.repl_curmod);
                                    repl_env = env3;
                                    repl_ts = (uu___215_4127.repl_ts);
                                    repl_stdin = (uu___215_4127.repl_stdin)
                                  }) in
    ...
    fun term  ->
      fun rules  ->
        let run_and_rewind st1 task =
          ...
          let st' =
            let uu___216_5874 = st1 in
            {
              repl_line = (uu___216_5874.repl_line);
              repl_column = (uu___216_5874.repl_column);
              repl_fname = (uu___216_5874.repl_fname);
              repl_stack = (uu___216_5874.repl_stack);
              repl_curmod = (uu___216_5874.repl_curmod);
              repl_env = env;
              repl_ts = (uu___216_5874.repl_ts);
              repl_stdin = (uu___216_5874.repl_stdin)
            } in
