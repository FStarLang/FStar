...
let uu___205_379 = tcenv
in {FStar_TypeChecker_Env.solver = uu___205_379.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___205_379.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___205_379.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___205_379.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___205_379.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___205_379.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___205_379.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___205_379.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___205_379.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___205_379.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___205_379.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___205_379.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___205_379.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___205_379.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___205_379.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___205_379.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___205_379.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___205_379.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = (kind = LaxCheck); FStar_TypeChecker_Env.lax_universes = uu___205_379.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___205_379.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.nosynth = uu___205_379.FStar_TypeChecker_Env.nosynth; FStar_TypeChecker_Env.type_of = uu___205_379.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___205_379.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___205_379.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___205_379.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___205_379.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___205_379.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___205_379.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___205_379.FStar_TypeChecker_Env.identifier_info})
in (
...
let json_to_str : FStar_Util.json  ->  Prims.string = (fun uu___195_1679 -> (match (uu___195_1679) with
...
let js_int : FStar_Util.json  ->  Prims.int = (fun uu___196_1750 -> (match (uu___196_1750) with
| FStar_Util.JsonInt (i) -> begin
i
end
| other -> begin
...
let js_str : FStar_Util.json  ->  Prims.string = (fun uu___197_1756 -> (match (uu___197_1756) with
| FStar_Util.JsonStr (s) -> begin
s
end
| other -> begin
...
let js_list : 'Auu____1765 . (FStar_Util.json  ->  'Auu____1765)  ->  FStar_Util.json  ->  'Auu____1765 Prims.list = (fun k uu___198_1778 -> (match (uu___198_1778) with
...
let js_assoc : FStar_Util.json  ->  (Prims.string * FStar_Util.json) Prims.list = (fun uu___199_1796 -> (match (uu___199_1796) with
...
let query_needs_current_module : query'  ->  Prims.bool = (fun uu___200_2155 -> (match (uu___200_2155) with
| Exit -> begin
false
end
| DescribeProtocol -> begin
...
let rec json_of_fstar_option : FStar_Options.option_val  ->  FStar_Util.json = (fun uu___201_2613 -> (match (uu___201_2613) with
...
let uu___212_3830 = st
in {repl_line = uu___212_3830.repl_line; repl_column = uu___212_3830.repl_column; repl_fname = uu___212_3830.repl_fname; repl_stack = stack; repl_curmod = curmod; repl_env = env; repl_ts = uu___212_3830.repl_ts; repl_stdin = uu___212_3830.repl_stdin})
...
let uu___213_4026 = st
in {repl_line = line; repl_column = column; repl_fname = uu___213_4026.repl_fname; repl_stack = stack2; repl_curmod = uu___213_4026.repl_curmod; repl_env = uu___213_4026.repl_env; repl_ts = ts1; repl_stdin = uu___213_4026.repl_stdin})
in (match (res) with
...
let uu___214_4080 = st'
in {repl_line = uu___214_4080.repl_line; repl_column = uu___214_4080.repl_column; repl_fname = uu___214_4080.repl_fname; repl_stack = uu___214_4080.repl_stack; repl_curmod = curmod; repl_env = env4; repl_ts = uu___214_4080.repl_ts; repl_stdin = uu___214_4080.repl_stdin})))))
end
| uu____4081 -> begin
(
...
let uu___215_4115 = st'
in {repl_line = uu___215_4115.repl_line; repl_column = uu___215_4115.repl_column; repl_fname = uu___215_4115.repl_fname; repl_stack = uu___215_4115.repl_stack; repl_curmod = uu___215_4115.repl_curmod; repl_env = env3; repl_ts = uu___215_4115.repl_ts; repl_stdin = uu___215_4115.repl_stdin}))
...
in (FStar_Util.bind_opt uu____4376 (fun uu___202_4420 -> (match (uu___202_4420) with
...
let uu___216_5862 = st1
in {repl_line = uu___216_5862.repl_line; repl_column = uu___216_5862.repl_column; repl_fname = uu___216_5862.repl_fname; repl_stack = uu___216_5862.repl_stack; repl_curmod = uu___216_5862.repl_curmod; repl_env = env; repl_ts = uu___216_5862.repl_ts; repl_stdin = uu___216_5862.repl_stdin})
...
let st_cost : search_term'  ->  Prims.int = (fun uu___203_6249 -> (match (uu___203_6249) with
...
let run_query : repl_state  ->  query'  ->  ((query_status * FStar_Util.json) * (repl_state, Prims.int) FStar_Util.either) = (fun st uu___204_6924 -> (match (uu___204_6924) with
| Exit -> begin
(run_exit st)
end
| DescribeProtocol -> begin
