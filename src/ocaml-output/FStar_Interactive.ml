    ...
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,env) ->
              let env1 =
                let uu___190_229 = env in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___190_229.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___190_229.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___190_229.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___190_229.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___190_229.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___190_229.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___190_229.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___190_229.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___190_229.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___190_229.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___190_229.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___190_229.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___190_229.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___190_229.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___190_229.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___190_229.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___190_229.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___190_229.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = lax1;
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___190_229.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.type_of =
                    (uu___190_229.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___190_229.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___190_229.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___190_229.FStar_TypeChecker_Env.qname_and_index)
                } in
            ...
            fun ts  ->
              ...
              | Info (symbol,fqn_only,pos_opt) ->
                  let info_at_pos_opt =
                    ...
                    | None  -> None
                    | Some (file,row,col) ->
                        FStar_TypeChecker_Err.info_at_pos (Prims.snd env)
                          file row col in
                  let info_opt =
                    match info_at_pos_opt with
                    | Some uu____1432 -> info_at_pos_opt
                    | None  ->
                        if symbol = ""
                        then None
                        else
              ...
              | Completions search_term ->
                  let rec measure_anchored_match search_term1 candidate =
                    ...
                    | ([],uu____1488) -> Some ([], (Prims.parse_int "0"))
                    | (uu____1496,[]) -> None
                    | (hs::ts1,hc::tc) ->
                        ...
                        then
                          (match ts1 with
                           ...
                           | uu____1526 ->
                               let uu____1528 = measure_anchored_match ts1 tc in
                  ...
                  let rec locate_match needle candidate =
                    let uu____1583 = measure_anchored_match needle candidate in
                    ...
                    | None  ->
                        (match candidate with
                         | [] -> None
                         | hc::tc ->
                             let uu____1625 = locate_match needle tc in
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____1730 with
                         | (stripped_ns,shortened) ->
                             let uu____1745 = str_of_ids shortened in
                             let uu____1746 = str_of_ids matched in
                             let uu____1747 = str_of_ids stripped_ns in
                             (uu____1745, uu____1746, uu____1747, match_len)) in
                  let prepare_candidate uu____1758 =
                  ...
                  let matches =
                    let case_a_find_transitive_includes m id =
                      let dsenv = Prims.fst env in
                      let exported_names =
                        FStar_ToSyntax_Env.transitive_exported_ids dsenv m in
                      let matched_length = FStar_String.length id in
                                ...
                                FStar_Option.map
                                  (fun fqn  ->
                                     ((fqn.FStar_Ident.ns),
                                       ...
                                       matched_length)) uu____1830
                              else None)) in
                    let case_b_find_matches_in_env uu____1857 =
                      FStar_List.filter_map (match_lident_against needle)
                        all_lidents_in_env in
                    let uu____1869 = FStar_Util.prefix needle in
                        ...
                        let matched_ids =
                          ...
                          | uu____1894 ->
                              ...
                              (match uu____1897 with
                               ...
                               | Some m ->
                                   case_a_find_transitive_includes m id) in
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x  ->
                                let uu____1930 = shorten_namespace x in
                                prepare_candidate uu____1930)) in
                  ((let uu____1936 =
                      FStar_Util.sort_with
                        (fun uu____1944  ->
                           fun uu____1945  ->
                             match (uu____1944, uu____1945) with
                             | ((cd1,ns1,uu____1960),(cd2,ns2,uu____1963)) ->
              ...
              | Code (text1,(ok,fail1)) ->
                  ...
                  (match res with
                   ...
                   | uu____2155 -> fail2 curmod env_mark)
let interactive_mode: Prims.string -> Prims.unit =
  fun filename  ->
    (let uu____2167 =
       let uu____2168 = FStar_Options.codegen () in
       FStar_Option.isSome uu____2168 in
     if uu____2167
     then
       FStar_Util.print_warning
         "code-generation is not supported in interactive mode, ignoring the codegen flag"
     else ());
    (let uu____2171 = deps_of_our_file filename in
     match uu____2171 with
     | (filenames,maybe_intf) ->
         let env = tc_prims () in
         let uu____2185 = tc_deps None [] env filenames [] in
         (match uu____2185 with
          | (stack,env1,ts) ->
              let uu____2200 =
                ...
                | Some intf ->
                    let frag =
                      let uu____2213 = FStar_Util.file_get_contents intf in
                      {
                        FStar_Parser_ParseIt.frag_text = uu____2213;
                        FStar_Parser_ParseIt.frag_line =
                          (Prims.parse_int "0");
                        FStar_Parser_ParseIt.frag_col = (Prims.parse_int "0")
                      } in
                    let uu____2214 = check_frag env1 None frag in
                          ...
                          then
                            ((let uu____2244 =
                                FStar_Util.format1
                                  ...
                                  intf in
                              FStar_Util.print_warning uu____2244);
                             FStar_All.exit (Prims.parse_int "1"))
                          else ();
                     ...
                     | None  ->
                         ((let uu____2257 =
                             FStar_Util.format1
                               ...
                               intf in
                           FStar_Util.print_warning uu____2257);
                          FStar_All.exit (Prims.parse_int "1")))
                | None  -> (None, env1) in
              (match uu____2200 with
               | (initial_mod,env2) ->
                   ...
                   then
                     let uu____2273 =
                       let uu____2274 = FStar_Options.file_list () in
                       FStar_List.hd uu____2274 in
                     FStar_SMTEncoding_Solver.with_hints_db uu____2273
                       (fun uu____2276  ->
