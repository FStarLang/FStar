          ...
          let uu____1680 =
            let uu____1683 =
              let uu____1684 =
                ...
                | None  -> []
                | Some r ->
                    let uu____1688 = json_of_use_range r  in [uu____1688]
                 in
  ...
  let js_features =
    let uu____1817 =
      FStar_List.map (fun _0_35  -> FStar_Util.JsonStr _0_35)
       ...
       in
    FStar_All.pipe_left (fun _0_36  -> FStar_Util.JsonList _0_36) uu____1817
     in
            ...
            FStar_List.map
              (fun uu____2018  ->
                 ...
                 | (name,value,doc1,dflt1) ->
                     ...
                     FStar_Util.JsonAssoc uu____2030) opts_and_defaults
             in
      ...
      (match uu____2259 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           let errors =
             ...
             FStar_All.pipe_right uu____2329 (FStar_List.map json_of_issue)
              in
           (FStar_Errors.clear ();
            (let st' =
        ...
        FStar_All.pipe_right uu____2470
          (FStar_Util.map_option
             (fun uu____2496  ->
                ...
                | ((uu____2506,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
         in
      let docs_of_lid lid =
        ...
        | (prefix1,matched,match_len) ->
            ...
            (match uu____3007 with
             | (stripped_ns,shortened) ->
                 ...
                 (uu____3022, uu____3023, uu____3024, match_len))
         in
                       ...
                       | Some l ->
                           let uu____3199 =
                             FStar_Ident.lid_of_ids (FStar_List.append ns id)
                              in
                           FStar_Ident.lid_equals l uu____3199)))
           in
          ...
          (fun uu____3306  ->
             ...
             | (candidate,ns,match_len) ->
                 FStar_Util.JsonList
                   ...
                   FStar_Util.JsonStr candidate]) uu____3268
         in
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____3857
           in
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____4023 = let uu____4030 = run_query st  in uu____4030 query.qq
       in
...
let interactive_error_handler : FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____4060 =
      let uu____4062 = FStar_ST.read issues  in e :: uu____4062  in
