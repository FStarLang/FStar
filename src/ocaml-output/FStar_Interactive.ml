              ...
              let tcenv1 =
                let uu___241_241 = tcenv  in
                {
                  ...
                  FStar_TypeChecker_Env.proof_ns =
                    (uu___241_241.FStar_TypeChecker_Env.proof_ns);
                  FStar_TypeChecker_Env.synth =
                    (uu___241_241.FStar_TypeChecker_Env.synth);
                  FStar_TypeChecker_Env.is_native_tactic =
                    (uu___241_241.FStar_TypeChecker_Env.is_native_tactic)
                }  in
              let dsenv1 =
        ...
        | (dsenv,env) ->
            (try
             ...
             | FStar_Errors.Err msg when
                 ...
                 ((let uu____447 =
                     let uu____451 =
                       let uu____454 = FStar_TypeChecker_Env.get_range env
                          in
                       (msg, uu____454)  in
                     [uu____451]  in
    ...
    let uu____475 =
      FStar_List.partition
        (fun x  ->
           ...
           let uu____482 = FStar_Parser_Dep.lowercase_module_name filename
              in
           uu____481 <> uu____482) deps
       in
              ...
              ((let uu____499 =
                  (let uu____500 = FStar_Parser_Dep.is_interface intf  in
                   Prims.op_Negation uu____500) ||
                    (let uu____501 = FStar_Parser_Dep.is_implementation impl
                        in
                     Prims.op_Negation uu____501)
                   in
                if uu____499
                then
                  let uu____502 =
    ...
    try
      ...
      let uu____1513 =
              ...
              let uu____1555 =
                ...
                FStar_All.pipe_right uu____1560
                  (FStar_Util.map_option
                     (fun loc  ->
                        let uu____1593 =
                          let uu____1594 = assoc1 "[location]" "filename" loc
                             in
                        ...
                        let uu____1597 =
                          let uu____1598 = assoc1 "[location]" "column" loc
                             in
                          FStar_All.pipe_right uu____1598 js_int  in
                        (uu____1593, uu____1595, uu____1597)))
                 in
              let uu____1599 =
        ...
        | "search" ->
            ...
            Search uu____1626
        | uu____1628 ->
            let uu____1629 = FStar_Util.format1 "Unknown query '%s'" query
               in
            ProtocolViolation uu____1629
         in
      { qq = uu____1513; qid }
            ...
            let uu____1784 =
              let uu____1785 =
                let uu____1787 =
                  ...
                  | None  -> []
                  | Some r ->
                      let uu____1791 = json_of_use_range r  in [uu____1791]
                   in
                let uu____1792 =
                  match issue.FStar_Errors.issue_range with
                  | Some r when
    ...
    let uu____1908 =
      let uu____1912 =
        ...
        let uu____1920 =
          let uu____1924 =
            let uu____1927 =
              json_of_opt (fun _0_43  -> FStar_Util.JsonStr _0_43) lr.lr_typ
               in
            ("type", uu____1927)  in
          let uu____1928 =
            let uu____1932 =
  ...
  let js_features =
    let uu____1961 =
      FStar_List.map (fun _0_46  -> FStar_Util.JsonStr _0_46)
       ...
       in
    FStar_All.pipe_left (fun _0_47  -> FStar_Util.JsonList _0_47) uu____1961
     in
            ...
            FStar_List.map
              (fun uu____2242  ->
                 ...
                 | (name,value,doc1,dflt1) ->
                     ...
                     FStar_Util.JsonAssoc uu____2254) opts_and_defaults
             in
  ...
  | (env,curmod)::stack ->
      (pop st.repl_env "#pop";
       ...
       ((QueryOK, FStar_Util.JsonNull),
         (FStar_Util.Inl
            ((let uu___248_2449 = st  in
              {
                repl_line = (uu___248_2449.repl_line);
                repl_column = (uu___248_2449.repl_column);
                repl_fname = (uu___248_2449.repl_fname);
                repl_stack = stack;
                repl_curmod = curmod;
                repl_env = env;
                repl_ts = (uu___248_2449.repl_ts);
                repl_stdin = (uu___248_2449.repl_stdin)
              })))))
      ...
      (match uu____2508 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           let errors =
             ...
             FStar_All.pipe_right uu____2582 (FStar_List.map json_of_issue)
              in
           (FStar_Errors.clear ();
            (let st' =
               let uu___249_2588 = st  in
               {
                 repl_line = line;
                 repl_column = column1;
                 repl_fname = (uu___249_2588.repl_fname);
                 repl_stack = stack2;
                 repl_curmod = (uu___249_2588.repl_curmod);
                 repl_env = (uu___249_2588.repl_env);
                 repl_ts = ts1;
                 repl_stdin = (uu___249_2588.repl_stdin)
               }  in
             match res with
             | Some (curmod,env3,nerrs) when
                 ...
                 ((QueryOK, (FStar_Util.JsonList errors)),
                   (FStar_Util.Inl
                      (let uu___250_2617 = st'  in
                       {
                         repl_line = (uu___250_2617.repl_line);
                         repl_column = (uu___250_2617.repl_column);
                         repl_fname = (uu___250_2617.repl_fname);
                         repl_stack = (uu___250_2617.repl_stack);
                         repl_curmod = curmod;
                         repl_env = env4;
                         repl_ts = (uu___250_2617.repl_ts);
                         repl_stdin = (uu___250_2617.repl_stdin)
                       })))
             | uu____2618 ->
                 let env3 = reset_mark env_mark  in
                 let uu____2629 =
                   run_pop
                     (let uu___251_2636 = st'  in
                      {
                        repl_line = (uu___251_2636.repl_line);
                        repl_column = (uu___251_2636.repl_column);
                        repl_fname = (uu___251_2636.repl_fname);
                        repl_stack = (uu___251_2636.repl_stack);
                        repl_curmod = (uu___251_2636.repl_curmod);
                        repl_env = env3;
                        repl_ts = (uu___251_2636.repl_ts);
                        repl_stdin = (uu___251_2636.repl_stdin)
                      })
                    in
        ...
        FStar_All.pipe_right uu____2728
          (FStar_Util.map_option
             (fun uu____2754  ->
                ...
                | ((uu____2764,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
         in
      let docs_of_lid lid =
        ...
        | (prefix1,matched,match_len) ->
            ...
            (match uu____3273 with
             | (stripped_ns,shortened) ->
                 ...
                 (uu____3288, uu____3289, uu____3290, match_len))
         in
                       ...
                       | Some l ->
                           let uu____3473 =
                             FStar_Ident.lid_of_ids (FStar_List.append ns id)
                              in
                           FStar_Ident.lid_equals l uu____3473)))
           in
          ...
          (fun uu____3580  ->
             ...
             | (candidate,ns,match_len) ->
                 FStar_Util.JsonList
                   ...
                   FStar_Util.JsonStr candidate]) uu____3542
         in
...
let run_compute st term rules =
  let run_and_rewind st1 task =
    ...
    let st' =
      let uu___252_3654 = st1  in
      {
        repl_line = (uu___252_3654.repl_line);
        repl_column = (uu___252_3654.repl_column);
        repl_fname = (uu___252_3654.repl_fname);
        repl_stack = (uu___252_3654.repl_stack);
        repl_curmod = (uu___252_3654.repl_curmod);
        repl_env = env;
        repl_ts = (uu___252_3654.repl_ts);
        repl_stdin = (uu___252_3654.repl_stdin)
      }  in
    ...
    | {
        FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
          ((uu____3686,{ FStar_Syntax_Syntax.lbname = uu____3687;
                         ...
                         FStar_Syntax_Syntax.lbdef = def;_}::[]),uu____3692);
        FStar_Syntax_Syntax.sigrng = uu____3693;
        FStar_Syntax_Syntax.sigquals = uu____3694;
        FStar_Syntax_Syntax.sigmeta = uu____3695;
        FStar_Syntax_Syntax.sigattrs = uu____3696;_}::[] -> Some def
    | uu____3714 -> None  in
  let parse1 frag =
    let uu____3724 = FStar_Parser_ParseIt.parse (FStar_Util.Inr frag)  in
    match uu____3724 with
    | FStar_Util.Inl (FStar_Util.Inr decls,uu____3737) -> Some decls
    | uu____3760 -> None  in
  let desugar dsenv decls =
    let uu____3780 = FStar_ToSyntax_ToSyntax.desugar_decls dsenv decls  in
    snd uu____3780  in
  let typecheck tcenv decls =
    let uu____3793 = FStar_TypeChecker_Tc.tc_decls tcenv decls  in
    match uu____3793 with | (ses,uu____3801,uu____3802) -> ses  in
  let rules1 =
    FStar_List.append
      (match rules with
       | Some rules1 -> rules1
  ...
  run_and_rewind st
    (fun st1  ->
       let uu____3815 = st1.repl_env  in
                            ...
                            let uu____3851 =
                              let uu____3852 =
                                FStar_Syntax_Print.term_to_string normalized
                                 in
                              FStar_Util.JsonStr uu____3852  in
                            (QueryOK, uu____3851)
                      with
                      | e ->
                          let uu____3857 =
                            let uu____3858 = FStar_Errors.issue_of_exn e  in
                            match uu____3858 with
                            | Some issue ->
                                let uu____3861 =
                                  FStar_Errors.format_issue issue  in
                                FStar_Util.JsonStr uu____3861
                            | None  -> raise e  in
                          (QueryNOK, uu____3857)))))
...
let uu___is_NameContainsStr : search_term' -> Prims.bool =
  fun projectee  ->
    match projectee with | NameContainsStr _0 -> true | uu____3883 -> false
  
let __proj__NameContainsStr__item___0 : search_term' -> Prims.string =
  fun projectee  -> match projectee with | NameContainsStr _0 -> _0 
let uu___is_TypeContainsLid : search_term' -> Prims.bool =
  fun projectee  ->
    match projectee with | TypeContainsLid _0 -> true | uu____3897 -> false
...
let sc_of_lid : FStar_Ident.lid -> search_candidate =
  fun lid  ->
    let uu____4005 = FStar_Util.mk_ref None  in
    let uu____4010 = FStar_Util.mk_ref None  in
    { sc_lid = lid; sc_typ = uu____4005; sc_fvars = uu____4010 }
  
let sc_typ :
  FStar_TypeChecker_Env.env -> search_candidate -> FStar_Syntax_Syntax.typ =
  fun tcenv  ->
    fun sc  ->
      let uu____4030 = FStar_ST.read sc.sc_typ  in
      ...
      | None  ->
          let typ =
            ...
            | Some ((uu____4055,typ),uu____4057) -> typ  in
...
let sc_fvars :
  ...
  fun tcenv  ->
    fun sc  ->
      let uu____4079 = FStar_ST.read sc.sc_fvars  in
      match uu____4079 with
      | Some fv -> fv
      | None  ->
          let fv =
            let uu____4093 = sc_typ tcenv sc  in
            FStar_Syntax_Free.fvars uu____4093  in
...
let json_of_search_result :
  ...
  fun dsenv  ->
    fun tcenv  ->
      fun sc  ->
        let typ_str =
          let uu____4113 = sc_typ tcenv sc  in
          FStar_Syntax_Print.term_to_string uu____4113  in
        let uu____4114 =
          let uu____4118 =
            let uu____4121 =
              let uu____4122 =
                ...
                uu____4123.FStar_Ident.str  in
              FStar_Util.JsonStr uu____4122  in
            ("lid", uu____4121)  in
          [uu____4118; ("type", (FStar_Util.JsonStr typ_str))]  in
        FStar_Util.JsonAssoc uu____4114
  
exception InvalidSearch of Prims.string 
let uu___is_InvalidSearch : Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with
    | InvalidSearch uu____4137 -> true
    | uu____4138 -> false
  
let __proj__InvalidSearch__item__uu___ : Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | InvalidSearch uu____4146 -> uu____4146
  
let run_search st search_str =
  let uu____4168 = st.repl_env  in
  ...
  | (dsenv,tcenv) ->
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              let uu____4189 = sc_fvars tcenv candidate  in
              FStar_Util.set_mem lid uu____4189
           in
              ...
              let uu____4223 =
                let uu____4224 =
                  FStar_Util.format1 "Improperly quoted search term: %s"
                    term1
                   in
                InvalidSearch uu____4224  in
              raise uu____4223
            else
              if beg_quote
              then
                (let uu____4226 = strip_quotes term1  in
                 NameContainsStr uu____4226)
              else
      ...
      let pprint_one term =
        let uu____4247 =
          ...
          | TypeContainsLid l -> FStar_Util.format1 "%s" l.FStar_Ident.str
           in
        Prims.strcat (if term.st_negate then "-" else "") uu____4247  in
      let results =
        try
          ...
          | [] ->
              let kwds =
                let uu____4288 = FStar_List.map pprint_one terms  in
                FStar_Util.concat_l " " uu____4288  in
              let uu____4290 =
                let uu____4291 =
                  FStar_Util.format1 "No results found for query [%s]" kwds
                   in
                InvalidSearch uu____4291  in
              raise uu____4290
          | uu____4294 -> (QueryOK, (FStar_Util.JsonList js))
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____4363 = let uu____4370 = run_query st  in uu____4370 query.qq
       in
...
let interactive_error_handler : FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____4400 =
      let uu____4402 = FStar_ST.read issues  in e :: uu____4402  in
    FStar_ST.write issues uu____4400  in
  let count_errors uu____4413 =
    let uu____4414 =
      let uu____4416 = FStar_ST.read issues  in
      FStar_List.filter
        (fun e  -> e.FStar_Errors.issue_level = FStar_Errors.EError)
        uu____4416
       in
    FStar_List.length uu____4414  in
  let report1 uu____4428 =
    let uu____4429 = FStar_ST.read issues  in
    FStar_List.sortWith FStar_Errors.compare_issues uu____4429  in
  let clear1 uu____4437 = FStar_ST.write issues []  in
  {
...
let interactive_mode' : Prims.string -> Prims.unit =
  fun filename  ->
    write_hello ();
    (let uu____4450 = deps_of_our_file filename  in
     match uu____4450 with
     | (filenames,maybe_intf) ->
         let env = tc_prims ()  in
         let uu____4464 = tc_deps None [] env filenames []  in
         (match uu____4464 with
          | (stack,env1,ts) ->
              ...
              then
                let uu____4495 =
                  let uu____4496 = FStar_Options.file_list ()  in
                  FStar_List.hd uu____4496  in
                FStar_SMTEncoding_Solver.with_hints_db uu____4495
                  (fun uu____4498  -> go init_st)
              else go init_st))
...
let interactive_mode : Prims.string -> Prims.unit =
  fun filename  ->
    ...
    (let uu____4507 =
       let uu____4508 = FStar_Options.codegen ()  in
       FStar_Option.isSome uu____4508  in
     if uu____4507
     then
