    ...
    fun kind  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,tcenv) ->
              let tcenv1 =
                let uu___211_241 = tcenv in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___211_241.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___211_241.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___211_241.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___211_241.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___211_241.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___211_241.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___211_241.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___211_241.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___211_241.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___211_241.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___211_241.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___211_241.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___211_241.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___211_241.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___211_241.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___211_241.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___211_241.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___211_241.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = (kind = LaxCheck);
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___211_241.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.type_of =
                    (uu___211_241.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___211_241.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___211_241.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___211_241.FStar_TypeChecker_Env.qname_and_index)
                } in
              let dsenv1 =
...
let js_int: FStar_Util.json -> Prims.int =
  fun uu___202_1048  ->
    match uu___202_1048 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
let js_str: FStar_Util.json -> Prims.string =
  fun uu___203_1053  ->
    match uu___203_1053 with
    | FStar_Util.JsonStr s -> s
    | other -> js_fail "string" other
let js_list k uu___204_1071 =
  match uu___204_1071 with
  | FStar_Util.JsonList l -> FStar_List.map k l
  | other -> js_fail "list" other
let js_assoc: FStar_Util.json -> (Prims.string* FStar_Util.json) Prims.list =
  fun uu___205_1083  ->
    match uu___205_1083 with
          ...
          let uu____1669 =
            let uu____1672 =
              let uu____1673 =
                ...
                | None  -> []
                | Some r -> let uu____1677 = json_of_range r in [uu____1677] in
...
let json_of_protocol_info: (Prims.string* FStar_Util.json) Prims.list =
  ...
  let js_features =
    ...
    FStar_All.pipe_left (fun _0_36  -> FStar_Util.JsonList _0_36) uu____1789 in
            ...
            FStar_List.map
              (fun uu____1990  ->
                 ...
                 | (name,value,doc1,dflt1) ->
                     ...
                     FStar_Util.JsonAssoc uu____2002) opts_and_defaults in
  ...
  | (env,curmod)::stack ->
      (pop st.repl_env "#pop";
       ...
       ((QueryOK, FStar_Util.JsonNull),
         (FStar_Util.Inl
            ((let uu___218_2179 = st in
              {
                repl_line = (uu___218_2179.repl_line);
                repl_column = (uu___218_2179.repl_column);
                repl_fname = (uu___218_2179.repl_fname);
                repl_stack = stack;
                repl_curmod = curmod;
                repl_env = env;
                repl_ts = (uu___218_2179.repl_ts);
                repl_stdin = (uu___218_2179.repl_stdin)
              })))))
      ...
      (match uu____2231 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           let errors =
             ...
             FStar_All.pipe_right uu____2301 (FStar_List.map json_of_issue) in
           (FStar_Errors.clear ();
            (let st' =
               let uu___219_2307 = st in
               {
                 repl_line = line;
                 repl_column = column1;
                 repl_fname = (uu___219_2307.repl_fname);
                 repl_stack = stack2;
                 repl_curmod = (uu___219_2307.repl_curmod);
                 repl_env = (uu___219_2307.repl_env);
                 repl_ts = ts1;
                 repl_stdin = (uu___219_2307.repl_stdin)
               } in
             match res with
             | Some (curmod,env3,nerrs) when
                 ...
                 ((QueryOK, (FStar_Util.JsonList errors)),
                   (FStar_Util.Inl
                      (let uu___220_2336 = st' in
                       {
                         repl_line = (uu___220_2336.repl_line);
                         repl_column = (uu___220_2336.repl_column);
                         repl_fname = (uu___220_2336.repl_fname);
                         repl_stack = (uu___220_2336.repl_stack);
                         repl_curmod = curmod;
                         repl_env = env4;
                         repl_ts = (uu___220_2336.repl_ts);
                         repl_stdin = (uu___220_2336.repl_stdin)
                       })))
             | uu____2337 ->
                 let env3 = reset_mark env_mark in
                 let uu____2348 =
                   run_pop
                     (let uu___221_2355 = st' in
                      {
                        repl_line = (uu___221_2355.repl_line);
                        repl_column = (uu___221_2355.repl_column);
                        repl_fname = (uu___221_2355.repl_fname);
                        repl_stack = (uu___221_2355.repl_stack);
                        repl_curmod = (uu___221_2355.repl_curmod);
                        repl_env = env3;
                        repl_ts = (uu___221_2355.repl_ts);
                        repl_stdin = (uu___221_2355.repl_stdin)
                      }) in
        ...
        FStar_All.pipe_right uu____2442
          (FStar_Util.map_option
             (fun uu____2468  ->
                ...
                | ((uu____2478,typ),r) -> ((FStar_Util.Inr lid1), typ, r))) in
      let docs_of_lid lid =
        ...
        | (prefix1,matched,match_len) ->
            ...
            (match uu____2979 with
             | (stripped_ns,shortened) ->
                 ...
                 (uu____2994, uu____2995, uu____2996, match_len)) in
                  ...
                  | (ns,id,uu____3162) ->
                      ...
                      (match uu____3167 with
                       ...
                       | Some l ->
                           ...
                           FStar_Ident.lid_equals l uu____3171))) in
            ...
            FStar_All.pipe_right matched_ids
              (FStar_List.map
                 (fun x  ->
                    ...
                    prepare_candidate uu____3233)) in
      let json_candidates =
        let uu____3240 =
          ...
          (fun uu____3278  ->
             ...
             | (candidate,ns,match_len) ->
                 FStar_Util.JsonList
                   ...
                   FStar_Util.JsonStr candidate]) uu____3240 in
...
let run_compute st term rules =
  let run_and_rewind st1 task =
    ...
    let st' =
      let uu___222_3348 = st1 in
      {
        repl_line = (uu___222_3348.repl_line);
        repl_column = (uu___222_3348.repl_column);
        repl_fname = (uu___222_3348.repl_fname);
        repl_stack = (uu___222_3348.repl_stack);
        repl_curmod = (uu___222_3348.repl_curmod);
        repl_env = env;
        repl_ts = (uu___222_3348.repl_ts);
        repl_stdin = (uu___222_3348.repl_stdin)
      } in
  ...
  let find_let_body ses =
    ...
    | {
        ...
        FStar_Syntax_Syntax.sigqual = uu____3389;_}::[] -> Some def
    | uu____3408 -> None in
  let parse1 frag =
    let uu____3418 = FStar_Parser_ParseIt.parse (FStar_Util.Inr frag) in
    match uu____3418 with
    | FStar_Util.Inl (FStar_Util.Inr decls,uu____3431) -> Some decls
    | uu____3454 -> None in
  let desugar dsenv decls =
    let uu____3474 = FStar_ToSyntax_ToSyntax.desugar_decls dsenv decls in
    Prims.snd uu____3474 in
  let typecheck tcenv decls =
    let uu____3487 = FStar_TypeChecker_Tc.tc_decls tcenv decls in
    match uu____3487 with | (ses,uu____3495,uu____3496) -> ses in
  let rules1 =
    FStar_List.append
      (match rules with
       | Some rules1 -> rules1
  ...
  run_and_rewind st
    (fun st1  ->
       let uu____3509 = st1.repl_env in
                     ...
                     (try
                        ...
                        | Some def ->
                            ...
                            let uu____3545 =
                              ...
                              FStar_Util.JsonStr uu____3546 in
                            (QueryOK, uu____3545)
                      with
                      | e ->
                          let uu____3551 =
                            let uu____3552 = FStar_Errors.issue_of_exn e in
                            match uu____3552 with
                            | Some issue ->
                                let uu____3555 =
                                  FStar_Errors.format_issue issue in
                                FStar_Util.JsonStr uu____3555
...
let uu___is_NameContainsStr: search_term' -> Prims.bool =
  fun projectee  ->
    match projectee with | NameContainsStr _0 -> true | uu____3572 -> false
let __proj__NameContainsStr__item___0: search_term' -> Prims.string =
  fun projectee  -> match projectee with | NameContainsStr _0 -> _0
let uu___is_TypeContainsLid: search_term' -> Prims.bool =
  fun projectee  ->
    match projectee with | TypeContainsLid _0 -> true | uu____3584 -> false
let __proj__TypeContainsLid__item___0: search_term' -> FStar_Ident.lid =
  fun projectee  -> match projectee with | TypeContainsLid _0 -> _0
let st_cost: search_term' -> Prims.int =
  fun uu___209_3602  ->
    match uu___209_3602 with
...
let sc_of_lid: FStar_Ident.lid -> search_candidate =
  fun lid  ->
    let uu____3653 = FStar_Util.mk_ref None in
    let uu____3658 = FStar_Util.mk_ref None in
    { sc_lid = lid; sc_typ = uu____3653; sc_fvars = uu____3658 }
let sc_typ:
  FStar_TypeChecker_Env.env -> search_candidate -> FStar_Syntax_Syntax.typ =
  fun tcenv  ->
    fun sc  ->
      let uu____3676 = FStar_ST.read sc.sc_typ in
      ...
      | None  ->
          let typ =
            ...
            | Some ((uu____3705,typ),uu____3707) -> typ in
...
let sc_fvars:
  ...
  fun tcenv  ->
    fun sc  ->
      let uu____3727 = FStar_ST.read sc.sc_fvars in
      match uu____3727 with
      | Some fv -> fv
      | None  ->
          let fv =
            let uu____3741 = sc_typ tcenv sc in
            FStar_Syntax_Free.fvars uu____3741 in
    ...
    fun tcenv  ->
      fun sc  ->
        let typ_str =
          ...
          FStar_Syntax_Print.term_to_string uu____3758 in
        let uu____3759 =
          let uu____3763 =
            let uu____3766 =
              let uu____3767 =
                ...
                uu____3768.FStar_Ident.str in
              FStar_Util.JsonStr uu____3767 in
            ("lid", uu____3766) in
          [uu____3763; ("type", (FStar_Util.JsonStr typ_str))] in
        FStar_Util.JsonAssoc uu____3759
exception InvalidSearch of Prims.string
let uu___is_InvalidSearch: Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with
    | InvalidSearch uu____3780 -> true
    | uu____3781 -> false
let __proj__InvalidSearch__item__uu___: Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | InvalidSearch uu____3788 -> uu____3788
let run_search st search_str =
  let uu____3807 = st.repl_env in
  ...
  | (dsenv,tcenv) ->
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              let uu____3828 = sc_fvars tcenv candidate in
              FStar_Util.set_mem lid uu____3828 in
              ...
              let uu____3856 =
                let uu____3857 =
                  FStar_Util.format1 "Improperly quoted search term: %s"
                    term1 in
                InvalidSearch uu____3857 in
              Prims.raise uu____3856
            else
              if beg_quote
              then
                (let uu____3859 = strip_quotes term1 in
                 NameContainsStr uu____3859)
              else
      ...
      let pprint_one term =
        ...
        Prims.strcat (if term.st_negate then "-" else "") uu____3880 in
      let results =
        try
          ...
          | [] ->
              let kwds =
                let uu____3921 = FStar_List.map pprint_one terms in
                FStar_Util.concat_l " " uu____3921 in
              let uu____3923 =
                let uu____3924 =
                  FStar_Util.format1 "No results found for query [%s]" kwds in
                InvalidSearch uu____3924 in
              Prims.raise uu____3923
          | uu____3927 -> (QueryOK, (FStar_Util.JsonList js))
...
let rec go: repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____3994 = let uu____4001 = run_query st in uu____4001 query.qq in
...
let interactive_error_handler: FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____4031 = let uu____4033 = FStar_ST.read issues in e :: uu____4033 in
    FStar_ST.write issues uu____4031 in
  let count_errors uu____4044 =
    let uu____4045 =
      let uu____4047 = FStar_ST.read issues in
      FStar_List.filter
        (fun e  -> e.FStar_Errors.issue_level = FStar_Errors.EError)
        uu____4047 in
    FStar_List.length uu____4045 in
  let report uu____4058 =
    let uu____4059 = FStar_ST.read issues in
    FStar_List.sortWith FStar_Errors.compare_issues uu____4059 in
  let clear1 uu____4067 = FStar_ST.write issues [] in
  {
...
let interactive_mode': Prims.string -> Prims.unit =
  fun filename  ->
    write_hello ();
    (let uu____4077 = deps_of_our_file filename in
     match uu____4077 with
     | (filenames,maybe_intf) ->
         let env = tc_prims () in
         let uu____4091 = tc_deps None [] env filenames [] in
          ...
          | (stack,env1,ts) ->
              let initial_range =
                ...
                let uu____4108 =
                  FStar_Range.mk_pos (Prims.parse_int "1")
                    (Prims.parse_int "0") in
                FStar_Range.mk_range "<input>" uu____4107 uu____4108 in
              let env2 =
                let uu____4112 =
                  FStar_TypeChecker_Env.set_range (Prims.snd env1)
                    initial_range in
                ((Prims.fst env1), uu____4112) in
              let env3 =
                match maybe_intf with
                | Some intf -> FStar_Universal.load_interface_decls env2 intf
                | None  -> env2 in
              let init_st =
                let uu____4120 = FStar_Util.open_stdin () in
                {
              ...
              then
                let uu____4122 =
                  let uu____4123 = FStar_Options.file_list () in
                  FStar_List.hd uu____4123 in
                FStar_SMTEncoding_Solver.with_hints_db uu____4122
                  (fun uu____4125  -> go init_st)
              else go init_st))
let interactive_mode: Prims.string -> Prims.unit =
  fun filename  ->
    ...
    (let uu____4133 =
       let uu____4134 = FStar_Options.codegen () in
       FStar_Option.isSome uu____4134 in
     if uu____4133
     then
