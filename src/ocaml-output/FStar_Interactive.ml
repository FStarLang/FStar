...
=======
                let uu___203_379 = tcenv in
>>>>>>> taramana_pointers_with_codes_modifies
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___203_379.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___203_379.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___203_379.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___203_379.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___203_379.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___203_379.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___203_379.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___203_379.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___203_379.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___203_379.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___203_379.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___203_379.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___203_379.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___203_379.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___203_379.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___203_379.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___203_379.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___203_379.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = (kind = LaxCheck);
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___203_379.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.failhard =
                    (uu___203_379.FStar_TypeChecker_Env.failhard);
                  FStar_TypeChecker_Env.type_of =
                    (uu___203_379.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___203_379.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___203_379.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___203_379.FStar_TypeChecker_Env.qname_and_index);
                  FStar_TypeChecker_Env.proof_ns =
                    (uu___203_379.FStar_TypeChecker_Env.proof_ns);
                  FStar_TypeChecker_Env.synth =
                    (uu___203_379.FStar_TypeChecker_Env.synth);
...
=======
                    (uu___203_379.FStar_TypeChecker_Env.identifier_info)
                } in
>>>>>>> taramana_pointers_with_codes_modifies
              let dsenv1 =
...
let js_int : FStar_Util.json -> Prims.int =
  fun uu___194_1762  ->
    match uu___194_1762 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
  
let js_str : FStar_Util.json -> Prims.string =
  fun uu___195_1768  ->
    match uu___195_1768 with
...
let (js_int :FStar_Util.json -> Prims.int)=
  fun uu___194_1750  ->
    match uu___194_1750 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
let (js_str :FStar_Util.json -> Prims.string)=
  fun uu___195_1756  ->
    match uu___195_1756 with
    | FStar_Util.JsonStr s -> s
    | other -> js_fail "string" other
let js_list :
  'Auu____1765 .
...
<<<<<<< HEAD
          (fun uu____2288  ->
             match uu____2288 with | (k,uu____2294) -> k = key) a
         in
...
let rec json_of_fstar_option : FStar_Options.option_val -> FStar_Util.json =
  fun uu___199_2625  ->
    match uu___199_2625 with
=======
let rec (json_of_fstar_option :FStar_Options.option_val -> FStar_Util.json)=
  fun uu___199_2613  ->
    match uu___199_2613 with
>>>>>>> taramana_pointers_with_codes_modifies
...
<<<<<<< HEAD
                      let uu____2796 = json_of_use_range r  in [uu____2796]
                   in
                let uu____2797 =
                  match issue.FStar_Errors.issue_range with
    ...
    let uu____2956 =
      let uu____2963 =
        ...
        let uu____2976 =
          let uu____2983 =
            let uu____2988 =
              json_of_opt (fun _0_42  -> FStar_Util.JsonStr _0_42) lr.lr_typ
               in
            ("type", uu____2988)  in
          let uu____2989 =
            let uu____2996 =
...
<<<<<<< HEAD
       ...
       in
    FStar_All.pipe_left (fun _0_46  -> FStar_Util.JsonList _0_46) uu____3047
     in
...
<<<<<<< HEAD
                     ...
                     FStar_Util.JsonAssoc uu____3452) opts_and_defaults
             in
      ...
      (match st.repl_stack with
       ...
       | (env,curmod)::stack ->
           (pop st.repl_env "#pop";
            (let st' =
<<<<<<< HEAD
               let uu___210_3842 = st  in
=======
               let uu___210_3830 = st in
>>>>>>> taramana_pointers_with_codes_modifies
               {
                 repl_line = (uu___210_3830.repl_line);
                 repl_column = (uu___210_3830.repl_column);
                 repl_fname = (uu___210_3830.repl_fname);
                 repl_stack = stack;
                 repl_curmod = curmod;
                 repl_env = env;
<<<<<<< HEAD
                 repl_ts = (uu___210_3842.repl_ts);
                 repl_stdin = (uu___210_3842.repl_stdin)
               }  in
...
let run_push :
  'Auu____3867 .
=======
                 repl_ts = (uu___210_3830.repl_ts);
                 repl_stdin = (uu___210_3830.repl_stdin)
               } in
             if nothing_left_to_pop st' then cleanup env else ();
             ((QueryOK, FStar_Util.JsonNull), (FStar_Util.Inl st')))))
let run_push :
...
=======
                       ...
                       (FStar_Errors.clear ();
                        (let st' =
                           let uu___211_4026 = st in
>>>>>>> taramana_pointers_with_codes_modifies
                           {
                             repl_line = line;
                             repl_column = column;
                             repl_fname = (uu___211_4026.repl_fname);
                             repl_stack = stack2;
                             repl_curmod = (uu___211_4026.repl_curmod);
                             repl_env = (uu___211_4026.repl_env);
                             repl_ts = ts1;
<<<<<<< HEAD
                             repl_stdin = (uu___211_4038.repl_stdin)
                           }  in
=======
                             repl_stdin = (uu___211_4026.repl_stdin)
                           } in
>>>>>>> taramana_pointers_with_codes_modifies
                         match res with
                         | FStar_Pervasives_Native.Some (curmod,env3,nerrs)
                             ...
                             ((QueryOK, (FStar_Util.JsonList errors)),
                               (FStar_Util.Inl
<<<<<<< HEAD
                                  (let uu___212_4092 = st'  in
=======
                                  (let uu___212_4080 = st' in
>>>>>>> taramana_pointers_with_codes_modifies
                                   {
                                     repl_line = (uu___212_4080.repl_line);
                                     repl_column =
                                       (uu___212_4080.repl_column);
                                     repl_fname = (uu___212_4080.repl_fname);
                                     repl_stack = (uu___212_4080.repl_stack);
                                     repl_curmod = curmod;
                                     repl_env = env4;
                                     repl_ts = (uu___212_4080.repl_ts);
                                     repl_stdin = (uu___212_4080.repl_stdin)
                                   })))
<<<<<<< HEAD
                         | uu____4093 ->
                             ...
                             let uu____4113 =
                               run_pop
                                 (let uu___213_4127 = st'  in
=======
                         | uu____4081 ->
                             let env3 = reset_mark env_mark in
                             let uu____4101 =
                               run_pop
                                 (let uu___213_4115 = st' in
>>>>>>> taramana_pointers_with_codes_modifies
                                  {
                                    repl_line = (uu___213_4115.repl_line);
                                    repl_column = (uu___213_4115.repl_column);
                                    repl_fname = (uu___213_4115.repl_fname);
                                    repl_stack = (uu___213_4115.repl_stack);
                                    repl_curmod = (uu___213_4115.repl_curmod);
                                    repl_env = env3;
<<<<<<< HEAD
                                    repl_ts = (uu___213_4127.repl_ts);
                                    repl_stdin = (uu___213_4127.repl_stdin)
                                  })
                                in
                             (match uu____4113 with
                              | (uu____4140,st'') ->
=======
                                    repl_ts = (uu___213_4115.repl_ts);
                                    repl_stdin = (uu___213_4115.repl_stdin)
                                  }) in
            ...
            | (prefix1,matched,match_len) ->
                ...
                (match uu____5232 with
                 | (stripped_ns,shortened) ->
                     ...
                     (uu____5259, uu____5260, uu____5261, match_len))
             in
...
<<<<<<< HEAD
                                  ...
                                  in
                               FStar_Ident.lid_equals l uu____5561)))
               in
...
<<<<<<< HEAD
                       FStar_Util.JsonStr candidate]) uu____5689
             in
    ...
    fun term  ->
      fun rules  ->
        let run_and_rewind st1 task =
          ...
          let st' =
<<<<<<< HEAD
            let uu___214_5874 = st1  in
=======
            let uu___214_5862 = st1 in
>>>>>>> taramana_pointers_with_codes_modifies
            {
              repl_line = (uu___214_5862.repl_line);
              repl_column = (uu___214_5862.repl_column);
              repl_fname = (uu___214_5862.repl_fname);
              repl_stack = (uu___214_5862.repl_stack);
              repl_curmod = (uu___214_5862.repl_curmod);
              repl_env = env;
<<<<<<< HEAD
              repl_ts = (uu___214_5874.repl_ts);
              repl_stdin = (uu___214_5874.repl_stdin)
            }  in
          (results, (FStar_Util.Inl st'))  in
=======
              repl_ts = (uu___214_5862.repl_ts);
              repl_stdin = (uu___214_5862.repl_stdin)
            } in
          (results, (FStar_Util.Inl st')) in
>>>>>>> taramana_pointers_with_codes_modifies
...
let st_cost : search_term' -> Prims.int =
  fun uu___201_6261  ->
    match uu___201_6261 with
=======
let (st_cost :search_term' -> Prims.int)=
  fun uu___201_6249  ->
    match uu___201_6249 with
>>>>>>> taramana_pointers_with_codes_modifies
  ...
  fun dsenv  ->
    fun tcenv  ->
      fun sc  ->
        let typ_str =
<<<<<<< HEAD
          let uu____6663 = sc_typ tcenv sc  in
          term_to_string tcenv uu____6663  in
        let uu____6664 =
          let uu____6671 =
            let uu____6676 =
              let uu____6677 =
...
<<<<<<< HEAD
                  ...
                  FStar_Util.set_mem lid uu____6763
               in
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____7009 = let uu____7022 = run_query st  in uu____7022 query.qq
       in
