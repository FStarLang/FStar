    ...
    fun kind  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,tcenv) ->
              let tcenv1 =
                let uu___213_379 = tcenv  in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___213_379.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___213_379.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___213_379.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___213_379.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___213_379.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___213_379.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___213_379.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___213_379.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___213_379.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___213_379.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___213_379.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___213_379.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___213_379.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___213_379.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___213_379.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___213_379.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___213_379.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___213_379.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = (kind = LaxCheck);
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___213_379.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.failhard =
                    (uu___213_379.FStar_TypeChecker_Env.failhard);
                  FStar_TypeChecker_Env.nosynth =
                    (uu___213_379.FStar_TypeChecker_Env.nosynth);
                  FStar_TypeChecker_Env.type_of =
                    (uu___213_379.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___213_379.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___213_379.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___213_379.FStar_TypeChecker_Env.qname_and_index);
                  FStar_TypeChecker_Env.proof_ns =
                    (uu___213_379.FStar_TypeChecker_Env.proof_ns);
                  FStar_TypeChecker_Env.synth =
                    (uu___213_379.FStar_TypeChecker_Env.synth);
                  FStar_TypeChecker_Env.is_native_tactic =
                    (uu___213_379.FStar_TypeChecker_Env.is_native_tactic);
                  FStar_TypeChecker_Env.identifier_info =
                    (uu___213_379.FStar_TypeChecker_Env.identifier_info)
                }  in
              let dsenv1 =
...
let js_int : FStar_Util.json -> Prims.int =
  fun uu___204_1789  ->
    match uu___204_1789 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
  
let js_str : FStar_Util.json -> Prims.string =
  fun uu___205_1795  ->
    match uu___205_1795 with
  ...
  fun key  ->
    fun a  ->
      let uu____2301 =
        FStar_Util.try_find
          (fun uu____2315  ->
             match uu____2315 with | (k,uu____2321) -> k = key) a
         in
                ...
                FStar_All.pipe_right uu____2498
                  (FStar_Util.map_option
                     (fun loc  ->
                        ...
                        (uu____2565, uu____2567, uu____2569)))
                 in
              let uu____2571 =
              ...
              let uu____2814 =
                let uu____2817 =
                  ...
                  | FStar_Pervasives_Native.Some r ->
                      let uu____2823 = json_of_use_range r  in [uu____2823]
                   in
                let uu____2824 =
                  match issue.FStar_Errors.issue_range with
  ...
  let js_features =
    let uu____3074 =
      FStar_List.map (fun _0_45  -> FStar_Util.JsonStr _0_45)
       ...
       in
    FStar_All.pipe_left (fun _0_46  -> FStar_Util.JsonList _0_46) uu____3074
     in
            ...
            FStar_List.map
              (fun uu____3460  ->
                 ...
                 | (name,value,doc1,dflt1) ->
                     ...
                     FStar_Util.JsonAssoc uu____3479) opts_and_defaults
             in
    ...
    then
      ...
      (match st.repl_stack with
       ...
       | (env,curmod)::stack ->
           (pop st.repl_env "#pop";
            (let st' =
               let uu___220_3869 = st  in
               {
                 repl_line = (uu___220_3869.repl_line);
                 repl_column = (uu___220_3869.repl_column);
                 repl_fname = (uu___220_3869.repl_fname);
                 repl_stack = stack;
                 repl_curmod = curmod;
                 repl_env = env;
                 repl_ts = (uu___220_3869.repl_ts);
                 repl_stdin = (uu___220_3869.repl_stdin)
               }  in
              ...
              | (stack,env,ts) ->
                  ...
                  (match uu____3953 with
                   | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
                       ...
                       (FStar_Errors.clear ();
                        (let st' =
                           let uu___221_4065 = st  in
                           {
                             repl_line = line;
                             repl_column = column;
                             repl_fname = (uu___221_4065.repl_fname);
                             repl_stack = stack2;
                             repl_curmod = (uu___221_4065.repl_curmod);
                             repl_env = (uu___221_4065.repl_env);
                             repl_ts = ts1;
                             repl_stdin = (uu___221_4065.repl_stdin)
                           }  in
                         match res with
                         | FStar_Pervasives_Native.Some (curmod,env3,nerrs)
                             ...
                             ((QueryOK, (FStar_Util.JsonList errors)),
                               (FStar_Util.Inl
                                  (let uu___222_4119 = st'  in
                                   {
                                     repl_line = (uu___222_4119.repl_line);
                                     repl_column =
                                       (uu___222_4119.repl_column);
                                     repl_fname = (uu___222_4119.repl_fname);
                                     repl_stack = (uu___222_4119.repl_stack);
                                     repl_curmod = curmod;
                                     repl_env = env4;
                                     repl_ts = (uu___222_4119.repl_ts);
                                     repl_stdin = (uu___222_4119.repl_stdin)
                                   })))
                         | uu____4120 ->
                             let env3 = reset_mark env_mark  in
                             let uu____4140 =
                               run_pop
                                 (let uu___223_4154 = st'  in
                                  {
                                    repl_line = (uu___223_4154.repl_line);
                                    repl_column = (uu___223_4154.repl_column);
                                    repl_fname = (uu___223_4154.repl_fname);
                                    repl_stack = (uu___223_4154.repl_stack);
                                    repl_curmod = (uu___223_4154.repl_curmod);
                                    repl_env = env3;
                                    repl_ts = (uu___223_4154.repl_ts);
                                    repl_stdin = (uu___223_4154.repl_stdin)
                                  })
                                in
            ...
            | (prefix1,matched,match_len) ->
                ...
                (match uu____5259 with
                 | (stripped_ns,shortened) ->
                     ...
                     (uu____5286, uu____5287, uu____5288, match_len))
             in
                           ...
                           | FStar_Pervasives_Native.Some l ->
                               let uu____5588 =
                                 FStar_Ident.lid_of_ids
                                  ...
                                  in
                               FStar_Ident.lid_equals l uu____5588)))
               in
              ...
              (fun uu____5794  ->
                 ...
                 | (candidate,ns,match_len) ->
                     FStar_Util.JsonList
                       ...
                       FStar_Util.JsonStr candidate]) uu____5716
             in
    ...
    fun term  ->
      fun rules  ->
        let run_and_rewind st1 task =
          ...
          let st' =
            let uu___224_5901 = st1  in
            {
              repl_line = (uu___224_5901.repl_line);
              repl_column = (uu___224_5901.repl_column);
              repl_fname = (uu___224_5901.repl_fname);
              repl_stack = (uu___224_5901.repl_stack);
              repl_curmod = (uu___224_5901.repl_curmod);
              repl_env = env;
              repl_ts = (uu___224_5901.repl_ts);
              repl_stdin = (uu___224_5901.repl_stdin)
            }  in
                                  ...
                                  | (univs2,def1) ->
                                      let tcenv1 =
                                        FStar_TypeChecker_Env.push_univ_vars
                                         ...
                                         in
                                      let normalized =
                                        normalize_term1 tcenv1 rules1 def1
                                         in
                                      let uu____6267 =
                                        let uu____6268 =
                                          term_to_string tcenv1 normalized
                                           in
...
let json_of_search_result :
  ...
  fun dsenv  ->
    fun tcenv  ->
      fun sc  ->
        let typ_str =
          let uu____6761 = sc_typ tcenv sc  in
          term_to_string tcenv uu____6761  in
        let uu____6762 =
          let uu____6769 =
            let uu____6774 =
              let uu____6775 =
          ...
          let st_matches candidate term =
            let found =
              ...
              | TypeContainsLid lid ->
                  ...
                  FStar_Util.set_mem lid uu____6861
               in
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____7107 = let uu____7120 = run_query st  in uu____7120 query.qq
       in
