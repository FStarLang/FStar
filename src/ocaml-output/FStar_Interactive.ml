...
let reset_mark:
  'Auu____255 .
    ('Auu____255,FStar_TypeChecker_Env.env) FStar_Pervasives_Native.tuple2 ->
      (FStar_ToSyntax_Env.env,FStar_TypeChecker_Env.env)
        FStar_Pervasives_Native.tuple2
  =
  fun uu____263  ->
...
let cleanup:
  'Auu____273 .
    ('Auu____273,FStar_TypeChecker_Env.env) FStar_Pervasives_Native.tuple2 ->
      Prims.unit
  =
  fun uu____279  ->
...
let js_fail: 'Auu____1020 . Prims.string -> FStar_Util.json -> 'Auu____1020 =
...
let js_list:
  'Auu____1042 .
    (FStar_Util.json -> 'Auu____1042) ->
      FStar_Util.json -> 'Auu____1042 Prims.list
  =
  fun k  ->
    fun uu___200_1054  ->
...
let try_assoc:
  'Auu____1333 'Auu____1334 .
    'Auu____1334 ->
      ('Auu____1334,'Auu____1333) FStar_Pervasives_Native.tuple2 Prims.list
        -> 'Auu____1333 FStar_Pervasives_Native.option
  =
  fun key  ->
    fun a  ->
      let uu____1350 =
        FStar_Util.try_find
          (fun uu____1356  ->
             match uu____1356 with | (k,uu____1360) -> k = key) a in
...
let json_of_opt:
  'Auu____1591 .
    ('Auu____1591 -> FStar_Util.json) ->
      'Auu____1591 FStar_Pervasives_Native.option -> FStar_Util.json
  =
  fun json_of_a  ->
    fun opt_a  ->
...
let run_exit:
  'Auu____2089 'Auu____2090 .
    'Auu____2090 ->
      ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
        ('Auu____2089,Prims.int) FStar_Util.either)
        FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    ((QueryOK, FStar_Util.JsonNull), (FStar_Util.Inr (Prims.parse_int "0")))
let run_describe_protocol:
  'Auu____2108 'Auu____2109 .
    'Auu____2109 ->
      ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
        ('Auu____2109,'Auu____2108) FStar_Util.either)
        FStar_Pervasives_Native.tuple2
  =
  fun st  ->
...
let run_describe_repl:
  'Auu____2126 .
    repl_state ->
      ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
        (repl_state,'Auu____2126) FStar_Util.either)
        FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    let uu____2137 =
...
let run_protocol_violation:
  'Auu____2153 'Auu____2154 .
    'Auu____2154 ->
      Prims.string ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          ('Auu____2154,'Auu____2153) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun message  ->
...
let run_pop:
  'Auu____2175 .
    repl_state ->
      ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
        (repl_state,'Auu____2175) FStar_Util.either)
        FStar_Pervasives_Native.tuple2
  =
  fun st  ->
            ...
            Prims.int ->
              Prims.bool ->
                ((query_status,FStar_Util.json)
                   FStar_Pervasives_Native.tuple2,(repl_state,'Auu____2227)
                                                    FStar_Util.either)
                  FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    ...
    repl_state ->
      Prims.string ->
        (Prims.string,Prims.int,Prims.int) FStar_Pervasives_Native.tuple3
          ...
          Prims.string Prims.list ->
            ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
              (repl_state,'Auu____2423) FStar_Util.either)
              FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun symbol  ->
              ...
              let response =
                ...
                | FStar_Pervasives_Native.Some (name_or_lid,typ,rng) ->
                    ...
                    let typ_str =
                      ...
                      then
                        let uu____2703 =
                          FStar_TypeChecker_Normalize.term_to_string tcenv
                            typ in
...
let run_completions:
  'Auu____2732 .
    repl_state ->
      Prims.string ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          (repl_state,'Auu____2732) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun search_term  ->
    ...
    repl_state ->
      Prims.string ->
        FStar_TypeChecker_Normalize.step Prims.list
          FStar_Pervasives_Native.option ->
          ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
            (repl_state,'Auu____3333) FStar_Util.either)
            FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun term  ->
...
let run_search:
  'Auu____3837 .
    repl_state ->
      Prims.string ->
        ((query_status,FStar_Util.json) FStar_Pervasives_Native.tuple2,
          (repl_state,'Auu____3837) FStar_Util.either)
          FStar_Pervasives_Native.tuple2
  =
  fun st  ->
    fun search_str  ->
