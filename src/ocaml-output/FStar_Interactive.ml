...
let _78_127 = (FStar_ST.op_Colon_Equals FStar_Options.verify_module ((module_name)::[]))
in (
# 164 "FStar.Interactive.fst"
let _78_132 = (FStar_Parser_Dep.collect ((filename)::[]))
in (match (_78_132) with
| (_78_130, all_filenames) -> begin
...
let _78_138 = if (let _160_184 = (FStar_ST.read FStar_Options.codegen)
...
let _78_146 = (tc.pop env msg)
in (
# 178 "FStar.Interactive.fst"
let _78_158 = (match (stack) with
| [] -> begin
(
# 180 "FStar.Interactive.fst"
let _78_149 = (FStar_Util.print_error "too many pops")
in (FStar_All.exit 1))
end
| hd::tl -> begin
(hd, tl)
end)
in (match (_78_158) with
...
let _78_172 = (tc.report_fail ())
in (
# 192 "FStar.Interactive.fst"
let _78_174 = (FStar_Util.print1 "%s\n" fail)
in (
