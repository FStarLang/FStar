    ...
    fun kind  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,tcenv) ->
              let tcenv1 =
                let uu___215_241 = tcenv  in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___215_241.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___215_241.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___215_241.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___215_241.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___215_241.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___215_241.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___215_241.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___215_241.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___215_241.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___215_241.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___215_241.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___215_241.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___215_241.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___215_241.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___215_241.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___215_241.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___215_241.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___215_241.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = (kind = LaxCheck);
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___215_241.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.type_of =
                    (uu___215_241.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___215_241.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___215_241.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___215_241.FStar_TypeChecker_Env.qname_and_index)
                }  in
              let dsenv1 =
...
let js_int : FStar_Util.json -> Prims.int =
  fun uu___206_1048  ->
    match uu___206_1048 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
  
let js_str : FStar_Util.json -> Prims.string =
  fun uu___207_1053  ->
    match uu___207_1053 with
    | FStar_Util.JsonStr s -> s
    | other -> js_fail "string" other
  
let js_list k uu___208_1071 =
  match uu___208_1071 with
  | FStar_Util.JsonList l -> FStar_List.map k l
  | other -> js_fail "list" other 
let js_assoc : FStar_Util.json -> (Prims.string * FStar_Util.json) Prims.list
  =
  fun uu___209_1083  ->
    match uu___209_1083 with
  ...
  | (env,curmod)::stack ->
      (pop st.repl_env "#pop";
       ...
       ((QueryOK, FStar_Util.JsonNull),
         (FStar_Util.Inl
            ((let uu___222_2179 = st  in
              {
                repl_line = (uu___222_2179.repl_line);
                repl_column = (uu___222_2179.repl_column);
                repl_fname = (uu___222_2179.repl_fname);
                repl_stack = stack;
                repl_curmod = curmod;
                repl_env = env;
                repl_ts = (uu___222_2179.repl_ts);
                repl_stdin = (uu___222_2179.repl_stdin)
              })))))
  ...
  | (stack,env,ts) ->
      ...
      (match uu____2231 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           (FStar_Errors.clear ();
            (let st' =
               let uu___223_2307 = st  in
               {
                 repl_line = line;
                 repl_column = column1;
                 repl_fname = (uu___223_2307.repl_fname);
                 repl_stack = stack2;
                 repl_curmod = (uu___223_2307.repl_curmod);
                 repl_env = (uu___223_2307.repl_env);
                 repl_ts = ts1;
                 repl_stdin = (uu___223_2307.repl_stdin)
               }  in
             match res with
             | Some (curmod,env3,nerrs) when
                 ...
                 ((QueryOK, (FStar_Util.JsonList errors)),
                   (FStar_Util.Inl
                      (let uu___224_2336 = st'  in
                       {
                         repl_line = (uu___224_2336.repl_line);
                         repl_column = (uu___224_2336.repl_column);
                         repl_fname = (uu___224_2336.repl_fname);
                         repl_stack = (uu___224_2336.repl_stack);
                         repl_curmod = curmod;
                         repl_env = env4;
                         repl_ts = (uu___224_2336.repl_ts);
                         repl_stdin = (uu___224_2336.repl_stdin)
                       })))
             | uu____2337 ->
                 let env3 = reset_mark env_mark  in
                 let uu____2348 =
                   run_pop
                     (let uu___225_2355 = st'  in
                      {
                        repl_line = (uu___225_2355.repl_line);
                        repl_column = (uu___225_2355.repl_column);
                        repl_fname = (uu___225_2355.repl_fname);
                        repl_stack = (uu___225_2355.repl_stack);
                        repl_curmod = (uu___225_2355.repl_curmod);
                        repl_env = env3;
                        repl_ts = (uu___225_2355.repl_ts);
                        repl_stdin = (uu___225_2355.repl_stdin)
                      })
                    in
...
let run_compute st term rules =
  let run_and_rewind st1 task =
    ...
    let st' =
      let uu___226_3348 = st1  in
      {
        repl_line = (uu___226_3348.repl_line);
        repl_column = (uu___226_3348.repl_column);
        repl_fname = (uu___226_3348.repl_fname);
        repl_stack = (uu___226_3348.repl_stack);
        repl_curmod = (uu___226_3348.repl_curmod);
        repl_env = env;
        repl_ts = (uu___226_3348.repl_ts);
        repl_stdin = (uu___226_3348.repl_stdin)
      }  in
    ...
    | {
        FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
          ((uu____3380,{ FStar_Syntax_Syntax.lbname = uu____3381;
                         ...
                         FStar_Syntax_Syntax.lbdef = def;_}::[]),uu____3386,uu____3387);
        FStar_Syntax_Syntax.sigrng = uu____3388;
        FStar_Syntax_Syntax.sigquals = uu____3389;
        FStar_Syntax_Syntax.sigmeta = uu____3390;_}::[] -> Some def
    | uu____3409 -> None  in
  let parse1 frag =
