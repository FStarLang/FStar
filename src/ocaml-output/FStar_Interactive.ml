          ...
          | (dsenv,env) ->
              ...
              (FStar_Options.push ();
               (match restore_cmd_line_options with
                | true  ->
                    let _0_692 = FStar_Options.restore_cmd_line_options false in
                ...
                | uu____996::ts ->
                    (pop env "";
                     (let uu____1018 =
                        ...
                        let _0_713 = FStar_List.tl stack in (_0_714, _0_713) in
            ...
            fun ts  ->
              ...
              | Push (lax,l,c) ->
                  let uu____1289 =
                    ...
                    with
                    | true  ->
                        let _0_717 = update_deps filename curmod stack env ts in
                        (true, _0_717)
