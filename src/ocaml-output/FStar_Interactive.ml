...
let uu___183_229 = env
in {FStar_TypeChecker_Env.solver = uu___183_229.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___183_229.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___183_229.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___183_229.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___183_229.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___183_229.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___183_229.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___183_229.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___183_229.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___183_229.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___183_229.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___183_229.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___183_229.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___183_229.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___183_229.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___183_229.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___183_229.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___183_229.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax; FStar_TypeChecker_Env.lax_universes = uu___183_229.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___183_229.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___183_229.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___183_229.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___183_229.FStar_TypeChecker_Env.qname_and_index})
in (
...
in (FStar_All.pipe_right _0_804 Prims.ignore))
end
| uu____235 -> begin
()
end);
...
Some ((let _0_805 = (FStar_Errors.get_err_count ())
in ((m), (((dsenv), (env))), (_0_805))))
end
| uu____375 -> begin
None
end))
...
((let _0_808 = (let _0_807 = (let _0_806 = (FStar_TypeChecker_Env.get_range env)
in ((msg), (_0_806)))
in (_0_807)::[])
in (FStar_TypeChecker_Err.add_errors env _0_808));
None;
)
end
end))
...
let report_fail : Prims.unit  ->  Prims.unit = (fun uu____422 -> ((let _0_809 = (FStar_Errors.report_all ())
in (FStar_All.pipe_right _0_809 Prims.ignore));
...
let the_interactive_state : interactive_state = (let _0_813 = (FStar_Util.new_string_builder ())
in (let _0_812 = (FStar_Util.mk_ref None)
in (let _0_811 = (FStar_Util.mk_ref [])
in (let _0_810 = (FStar_Util.mk_ref None)
in {chunk = _0_813; stdin = _0_812; buffer = _0_811; log = _0_810}))))
...
| (l)::(c)::("#lax")::[] -> begin
(let _0_815 = (FStar_Util.int_of_string l)
in (let _0_814 = (FStar_Util.int_of_string c)
in ((true), (_0_815), (_0_814))))
end
| (l)::(c)::[] -> begin
(let _0_817 = (FStar_Util.int_of_string l)
in (let _0_816 = (FStar_Util.int_of_string c)
in ((false), (_0_817), (_0_816))))
end
| uu____648 -> begin
...
let s = the_interactive_state
in (let _0_821 = (let _0_820 = (FStar_ST.read s.buffer)
in (let _0_819 = (let _0_818 = (read_chunk ())
in (_0_818)::[])
in (FStar_List.append _0_820 _0_819)))
in (FStar_ST.write s.buffer _0_821))))
...
let uu____690 = (FStar_List.partition (fun x -> (let _0_823 = (FStar_Parser_Dep.lowercase_module_name x)
in (let _0_822 = (FStar_Parser_Dep.lowercase_module_name filename)
in (_0_823 <> _0_822)))) deps)
...
let env = (let _0_824 = (FStar_Options.lax ())
in (push env _0_824 true "typecheck_modul"))
in (
...
let uu____1018 = (let _0_826 = (FStar_List.hd stack)
in (let _0_825 = (FStar_List.tl stack)
in ((_0_826), (_0_825))))
...
let uu____1113 = (let _0_828 = (FStar_List.hd st)
in (let _0_827 = (FStar_List.tl st)
in ((_0_828), (_0_827))))
...
let frag = (let _0_830 = (FStar_Util.file_get_contents intf)
in {FStar_Parser_ParseIt.frag_text = _0_830; FStar_Parser_ParseIt.frag_line = (Prims.parse_int "0"); FStar_Parser_ParseIt.frag_col = (Prims.parse_int "0")})
in (
...
in (FStar_SMTEncoding_Solver.with_hints_db _0_831 (fun uu____1501 -> (go (((Prims.parse_int "1")), ((Prims.parse_int "0"))) filename stack initial_mod env ts))))
end
| uu____1502 -> begin
