...
let try_assoc key a =
  let uu____1350 =
    FStar_Util.try_find
      ...
      a
     in
  FStar_Util.map_option FStar_Pervasives_Native.snd uu____1350 
let wrap_js_failure :
                ...
                FStar_All.pipe_right uu____1480
                  (FStar_Util.map_option
                     (fun loc  ->
                        ...
                        (uu____1513, uu____1515, uu____1517)))
                 in
              let uu____1519 =
              ...
              let uu____1691 =
                let uu____1693 =
                  ...
                  | FStar_Pervasives_Native.Some r ->
                      let uu____1697 = json_of_use_range r  in [uu____1697]
                   in
                let uu____1698 =
                  match issue.FStar_Errors.issue_range with
  ...
  let js_features =
    let uu____1821 =
      FStar_List.map (fun _0_36  -> FStar_Util.JsonStr _0_36)
       ...
       in
    FStar_All.pipe_left (fun _0_37  -> FStar_Util.JsonList _0_37) uu____1821
     in
            ...
            FStar_List.map
              (fun uu____2030  ->
                 ...
                 | (name,value,doc1,dflt1) ->
                     ...
                     FStar_Util.JsonAssoc uu____2042) opts_and_defaults
             in
  ...
  then
    ...
    (match st.repl_stack with
     ...
     | (env,curmod)::stack ->
         (pop st.repl_env "#pop";
          (let st' =
             let uu___214_2231 = st  in
             {
               repl_line = (uu___214_2231.repl_line);
               repl_column = (uu___214_2231.repl_column);
               repl_fname = (uu___214_2231.repl_fname);
               repl_stack = stack;
               repl_curmod = curmod;
               repl_env = env;
               repl_ts = (uu___214_2231.repl_ts);
               repl_stdin = (uu___214_2231.repl_stdin)
             }  in
  ...
  | (stack,env,ts) ->
      ...
      (match uu____2289 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           let errors =
             let uu____2347 = FStar_Errors.report_all ()  in
             FStar_All.pipe_right uu____2347 (FStar_List.map json_of_issue)
              in
           (FStar_Errors.clear ();
            (let st' =
               let uu___215_2353 = st  in
               {
                 repl_line = line;
                 repl_column = column1;
                 repl_fname = (uu___215_2353.repl_fname);
                 repl_stack = stack2;
                 repl_curmod = (uu___215_2353.repl_curmod);
                 repl_env = (uu___215_2353.repl_env);
                 repl_ts = ts1;
                 repl_stdin = (uu___215_2353.repl_stdin)
               }  in
             match res with
             | FStar_Pervasives_Native.Some (curmod,env3,nerrs) when
                 ...
                 ((QueryOK, (FStar_Util.JsonList errors)),
                   (FStar_Util.Inl
                      (let uu___216_2382 = st'  in
                       {
                         repl_line = (uu___216_2382.repl_line);
                         repl_column = (uu___216_2382.repl_column);
                         repl_fname = (uu___216_2382.repl_fname);
                         repl_stack = (uu___216_2382.repl_stack);
                         repl_curmod = curmod;
                         repl_env = env4;
                         repl_ts = (uu___216_2382.repl_ts);
                         repl_stdin = (uu___216_2382.repl_stdin)
                       })))
             | uu____2383 ->
                 let env3 = reset_mark env_mark  in
                 let uu____2394 =
                   run_pop
                     (let uu___217_2401 = st'  in
                      {
                        repl_line = (uu___217_2401.repl_line);
                        repl_column = (uu___217_2401.repl_column);
                        repl_fname = (uu___217_2401.repl_fname);
                        repl_stack = (uu___217_2401.repl_stack);
                        repl_curmod = (uu___217_2401.repl_curmod);
                        repl_env = env3;
                        repl_ts = (uu___217_2401.repl_ts);
                        repl_stdin = (uu___217_2401.repl_stdin)
                      })
                    in
...
let run_lookup st symbol pos_opt requested_info =
  ...
  | (dsenv,tcenv) ->
        ...
        let lid =
          let uu____2482 =
            FStar_List.map FStar_Ident.id_of_text
             ...
             in
          FStar_Ident.lid_of_ids uu____2482  in
        let lid1 =
          let uu____2485 =
            FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv lid  in
          FStar_All.pipe_left (FStar_Util.dflt lid) uu____2485  in
        let uu____2488 = FStar_TypeChecker_Env.try_lookup_lid tcenv lid1  in
        FStar_All.pipe_right uu____2488
          (FStar_Util.map_option
             (fun uu____2514  ->
                match uu____2514 with
                | ((uu____2524,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
         in
      let docs_of_lid lid =
        let uu____2536 = FStar_ToSyntax_Env.try_lookup_doc dsenv lid  in
        FStar_All.pipe_right uu____2536
          (FStar_Util.map_option FStar_Pervasives_Native.fst)
         in
      let def_of_lid lid =
        let uu____2553 = FStar_TypeChecker_Env.lookup_qname tcenv lid  in
        FStar_Util.bind_opt uu____2553
          (fun uu___204_2573  ->
             match uu___204_2573 with
             | (FStar_Util.Inr (se,uu____2585),uu____2586) ->
                 let uu____2601 = FStar_Syntax_Print.sigelt_to_string se  in
                 FStar_Pervasives_Native.Some uu____2601
      ...
      let info_opt =
        ...
        | FStar_Pervasives_Native.Some uu____2653 -> info_at_pos_opt
        | FStar_Pervasives_Native.None  ->
            if symbol = ""
        ...
        | FStar_Pervasives_Native.Some (name_or_lid,typ,rng) ->
            ...
            let typ_str =
              ...
              then
                ...
                FStar_Pervasives_Native.Some uu____2709
            ...
            let uu____2730 = json_of_lookup_result result  in
            (QueryOK, uu____2730)
         in
      (response, (FStar_Util.Inl st))
  
let run_completions st search_term =
  let uu____2753 = st.repl_env  in
  ...
  | (dsenv,tcenv) ->
        ...
        | (hs::ts,hc::tc) ->
            ...
            then
              (match ts with
               ...
               | uu____2821 ->
                   let uu____2823 = measure_anchored_match ts tc  in
                   FStar_All.pipe_right uu____2823
                     (FStar_Util.map_option
                        (fun uu____2842  ->
      ...
      let rec locate_match needle candidate =
        let uu____2878 = measure_anchored_match needle candidate  in
        ...
        | FStar_Pervasives_Native.None  ->
            (match candidate with
             | [] -> FStar_Pervasives_Native.None
             | hc::tc ->
                 let uu____2920 = locate_match needle tc  in
         ...
         in
      let str_of_ids ids =
        let uu____2975 = FStar_List.map FStar_Ident.text_of_id ids  in
        FStar_Util.concat_l "." uu____2975  in
      let match_lident_against needle lident =
        locate_match needle
          (FStar_List.append lident.FStar_Ident.ns [lident.FStar_Ident.ident])
         in
      let shorten_namespace uu____3004 =
        ...
        | (prefix1,matched,match_len) ->
            ...
            (match uu____3025 with
             | (stripped_ns,shortened) ->
                 let uu____3040 = str_of_ids shortened  in
                 let uu____3041 = str_of_ids matched  in
                 let uu____3042 = str_of_ids stripped_ns  in
                 (uu____3040, uu____3041, uu____3042, match_len))
         in
      let prepare_candidate uu____3053 =
      ...
      let matches =
                      ...
                      (fun fqn  ->
                         let uu____3143 =
                           ...
                           FStar_List.append uu____3145
                            ...
                            in
                         ([], uu____3143, matched_length)) uu____3135
                  else FStar_Pervasives_Native.None))
           in
        let case_b_find_matches_in_env uu____3164 =
          let matches =
          ...
          FStar_All.pipe_right matches
            (FStar_List.filter
               (fun uu____3200  ->
                  ...
                  | (ns,id,uu____3208) ->
                      let uu____3213 =
                        let uu____3215 = FStar_Ident.lid_of_ids id  in
                        FStar_ToSyntax_Env.resolve_to_fully_qualified_name
                          dsenv uu____3215
                         in
                       ...
                       | FStar_Pervasives_Native.Some l ->
                           let uu____3217 =
                             FStar_Ident.lid_of_ids (FStar_List.append ns id)
                              in
                           FStar_Ident.lid_equals l uu____3217)))
           in
        let uu____3218 = FStar_Util.prefix needle  in
        ...
        | (ns,id) ->
            ...
            FStar_All.pipe_right matched_ids
              (FStar_List.map
                 (fun x  ->
                    let uu____3279 = shorten_namespace x  in
                    prepare_candidate uu____3279))
         in
      let json_candidates =
        let uu____3286 =
          FStar_Util.sort_with
            (fun uu____3294  ->
               fun uu____3295  ->
                 match (uu____3294, uu____3295) with
                 | ((cd1,ns1,uu____3310),(cd2,ns2,uu____3313)) ->
          ...
          (fun uu____3324  ->
             ...
             | (candidate,ns,match_len) ->
                 FStar_Util.JsonList
                   ...
                   FStar_Util.JsonStr candidate]) uu____3286
         in
...
let run_compute st term rules =
  let run_and_rewind st1 task =
    ...
    let st' =
      let uu___218_3394 = st1  in
      {
        repl_line = (uu___218_3394.repl_line);
        repl_column = (uu___218_3394.repl_column);
        repl_fname = (uu___218_3394.repl_fname);
        repl_stack = (uu___218_3394.repl_stack);
        repl_curmod = (uu___218_3394.repl_curmod);
        repl_env = env;
        repl_ts = (uu___218_3394.repl_ts);
        repl_stdin = (uu___218_3394.repl_stdin)
      }  in
  ...
  let find_let_body ses =
    ...
    | {
        FStar_Syntax_Syntax.sigel = FStar_Syntax_Syntax.Sig_let
          ((uu____3426,{ FStar_Syntax_Syntax.lbname = uu____3427;
                         FStar_Syntax_Syntax.lbunivs = uu____3428;
                         FStar_Syntax_Syntax.lbtyp = uu____3429;
                         FStar_Syntax_Syntax.lbeff = uu____3430;
                         FStar_Syntax_Syntax.lbdef = def;_}::[]),uu____3432,uu____3433);
        FStar_Syntax_Syntax.sigrng = uu____3434;
        FStar_Syntax_Syntax.sigquals = uu____3435;
        FStar_Syntax_Syntax.sigmeta = uu____3436;_}::[] ->
        FStar_Pervasives_Native.Some def
    | uu____3455 -> FStar_Pervasives_Native.None  in
  let parse1 frag =
    let uu____3465 = FStar_Parser_ParseIt.parse (FStar_Util.Inr frag)  in
    match uu____3465 with
    | FStar_Util.Inl (FStar_Util.Inr decls,uu____3478) ->
        FStar_Pervasives_Native.Some decls
    | uu____3501 -> FStar_Pervasives_Native.None  in
  let desugar dsenv decls =
    let uu____3521 = FStar_ToSyntax_ToSyntax.desugar_decls dsenv decls  in
    FStar_Pervasives_Native.snd uu____3521  in
  let typecheck tcenv decls =
    let uu____3534 = FStar_TypeChecker_Tc.tc_decls tcenv decls  in
    match uu____3534 with | (ses,uu____3542,uu____3543) -> ses  in
  let rules1 =
    FStar_List.append
      (match rules with
  ...
  run_and_rewind st
    (fun st1  ->
       let uu____3556 = st1.repl_env  in
                            ...
                            let uu____3592 =
                              let uu____3593 =
                                FStar_Syntax_Print.term_to_string normalized
                                 in
                              FStar_Util.JsonStr uu____3593  in
                            (QueryOK, uu____3592)
                      with
                      | e ->
                          let uu____3598 =
                            let uu____3599 = FStar_Errors.issue_of_exn e  in
...
let uu___is_NameContainsStr : search_term' -> Prims.bool =
  fun projectee  ->
    match projectee with | NameContainsStr _0 -> true | uu____3623 -> false
  
let __proj__NameContainsStr__item___0 : search_term' -> Prims.string =
  fun projectee  -> match projectee with | NameContainsStr _0 -> _0 
let uu___is_TypeContainsLid : search_term' -> Prims.bool =
  fun projectee  ->
    match projectee with | TypeContainsLid _0 -> true | uu____3635 -> false
  
let __proj__TypeContainsLid__item___0 : search_term' -> FStar_Ident.lid =
  fun projectee  -> match projectee with | TypeContainsLid _0 -> _0 
let st_cost : search_term' -> Prims.int =
  fun uu___205_3653  ->
    match uu___205_3653 with
...
let sc_of_lid : FStar_Ident.lid -> search_candidate =
  fun lid  ->
    let uu____3707 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
    let uu____3712 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
    { sc_lid = lid; sc_typ = uu____3707; sc_fvars = uu____3712 }
  
let sc_typ :
  FStar_TypeChecker_Env.env -> search_candidate -> FStar_Syntax_Syntax.typ =
  fun tcenv  ->
    fun sc  ->
      let uu____3730 = FStar_ST.read sc.sc_typ  in
      ...
      | FStar_Pervasives_Native.None  ->
          let typ =
            ...
            | FStar_Pervasives_Native.Some ((uu____3755,typ),uu____3757) ->
                typ
             in
...
let sc_fvars :
  ...
  fun tcenv  ->
    fun sc  ->
      let uu____3777 = FStar_ST.read sc.sc_fvars  in
      match uu____3777 with
      | FStar_Pervasives_Native.Some fv -> fv
      | FStar_Pervasives_Native.None  ->
          let fv =
            let uu____3791 = sc_typ tcenv sc  in
            FStar_Syntax_Free.fvars uu____3791  in
...
let json_of_search_result :
  ...
  fun dsenv  ->
    fun tcenv  ->
      fun sc  ->
        let typ_str =
          let uu____3808 = sc_typ tcenv sc  in
          FStar_Syntax_Print.term_to_string uu____3808  in
        let uu____3809 =
          let uu____3813 =
            let uu____3816 =
              let uu____3817 =
                ...
                uu____3818.FStar_Ident.str  in
              FStar_Util.JsonStr uu____3817  in
            ("lid", uu____3816)  in
          [uu____3813; ("type", (FStar_Util.JsonStr typ_str))]  in
        FStar_Util.JsonAssoc uu____3809
  
exception InvalidSearch of Prims.string 
let uu___is_InvalidSearch : Prims.exn -> Prims.bool =
  fun projectee  ->
    match projectee with
    | InvalidSearch uu____3831 -> true
    | uu____3832 -> false
  
let __proj__InvalidSearch__item__uu___ : Prims.exn -> Prims.string =
  fun projectee  ->
    match projectee with | InvalidSearch uu____3839 -> uu____3839
  
let run_search st search_str =
  let uu____3858 = st.repl_env  in
  ...
  | (dsenv,tcenv) ->
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              let uu____3879 = sc_fvars tcenv candidate  in
              FStar_Util.set_mem lid uu____3879
           in
              ...
              let uu____3907 =
                let uu____3908 =
                  FStar_Util.format1 "Improperly quoted search term: %s"
                    term1
                   in
                InvalidSearch uu____3908  in
              raise uu____3907
            else
              if beg_quote
              then
                (let uu____3910 = strip_quotes term1  in
                 NameContainsStr uu____3910)
              else
      ...
      let pprint_one term =
        let uu____3931 =
          ...
          | TypeContainsLid l -> FStar_Util.format1 "%s" l.FStar_Ident.str
           in
        Prims.strcat (if term.st_negate then "-" else "") uu____3931  in
      let results =
        try
          ...
          | [] ->
              let kwds =
                let uu____3972 = FStar_List.map pprint_one terms  in
                FStar_Util.concat_l " " uu____3972  in
              let uu____3974 =
                let uu____3975 =
                  FStar_Util.format1 "No results found for query [%s]" kwds
                   in
                InvalidSearch uu____3975  in
              raise uu____3974
          | uu____3978 -> (QueryOK, (FStar_Util.JsonList js))
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____4045 = let uu____4052 = run_query st  in uu____4052 query.qq
       in
...
let interactive_error_handler : FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____4082 =
      let uu____4084 = FStar_ST.read issues  in e :: uu____4084  in
    FStar_ST.write issues uu____4082  in
  let count_errors uu____4095 =
    let uu____4096 =
  ...
  let report1 uu____4109 =
    let uu____4110 = FStar_ST.read issues  in
    FStar_List.sortWith FStar_Errors.compare_issues uu____4110  in
  let clear1 uu____4118 = FStar_ST.write issues []  in
  {
...
let interactive_mode' : Prims.string -> Prims.unit =
  fun filename  ->
    write_hello ();
    (let uu____4128 = deps_of_our_file filename  in
     ...
     | (filenames,maybe_intf) ->
         ...
         (match uu____4142 with
          | (stack,env1,ts) ->
              let initial_range =
                ...
                let uu____4159 =
                  FStar_Range.mk_pos (Prims.parse_int "1")
                    (Prims.parse_int "0")
                   in
                FStar_Range.mk_range "<input>" uu____4158 uu____4159  in
              let env2 =
                let uu____4163 =
                  FStar_TypeChecker_Env.set_range
                    (FStar_Pervasives_Native.snd env1) initial_range
                   in
                ((FStar_Pervasives_Native.fst env1), uu____4163)  in
              let env3 =
              ...
              let init_st =
                let uu____4171 = FStar_Util.open_stdin ()  in
                {
...
let interactive_mode : Prims.string -> Prims.unit =
  fun filename  ->
    ...
    (let uu____4184 =
       let uu____4185 = FStar_Options.codegen ()  in
       FStar_Option.isSome uu____4185  in
     if uu____4184
     then
