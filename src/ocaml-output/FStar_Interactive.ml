    ...
    fun kind  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,tcenv) ->
              let tcenv1 =
                let uu___239_228 = tcenv  in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___239_228.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___239_228.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___239_228.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___239_228.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___239_228.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___239_228.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___239_228.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___239_228.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___239_228.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___239_228.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___239_228.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___239_228.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___239_228.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___239_228.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___239_228.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___239_228.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___239_228.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___239_228.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = (kind = LaxCheck);
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___239_228.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.type_of =
                    (uu___239_228.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___239_228.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___239_228.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___239_228.FStar_TypeChecker_Env.qname_and_index);
                  FStar_TypeChecker_Env.proof_ns =
                    (uu___239_228.FStar_TypeChecker_Env.proof_ns);
                  FStar_TypeChecker_Env.synth =
                    (uu___239_228.FStar_TypeChecker_Env.synth);
                  FStar_TypeChecker_Env.is_native_tactic =
                    (uu___239_228.FStar_TypeChecker_Env.is_native_tactic)
                }  in
              let dsenv1 =
...
let js_int : FStar_Util.json -> Prims.int =
  fun uu___230_1031  ->
    match uu___230_1031 with
    | FStar_Util.JsonInt i -> i
    | other -> js_fail "int" other
  
let js_str : FStar_Util.json -> Prims.string =
  fun uu___231_1036  ->
    match uu___231_1036 with
    | FStar_Util.JsonStr s -> s
    | other -> js_fail "string" other
  
let js_list k uu___232_1054 =
  match uu___232_1054 with
  | FStar_Util.JsonList l -> FStar_List.map k l
  | other -> js_fail "list" other 
let js_assoc : FStar_Util.json -> (Prims.string * FStar_Util.json) Prims.list
  =
  fun uu___233_1066  ->
    match uu___233_1066 with
  ...
  let js_features =
    let uu____1821 =
      FStar_List.map (fun _0_46  -> FStar_Util.JsonStr _0_46)
       ...
       in
    FStar_All.pipe_left (fun _0_47  -> FStar_Util.JsonList _0_47) uu____1821
     in
  ...
  | (env,curmod)::stack ->
      (pop st.repl_env "#pop";
       ...
       ((QueryOK, FStar_Util.JsonNull),
         (FStar_Util.Inl
            ((let uu___246_2219 = st  in
              {
                repl_line = (uu___246_2219.repl_line);
                repl_column = (uu___246_2219.repl_column);
                repl_fname = (uu___246_2219.repl_fname);
                repl_stack = stack;
                repl_curmod = curmod;
                repl_env = env;
                repl_ts = (uu___246_2219.repl_ts);
                repl_stdin = (uu___246_2219.repl_stdin)
              })))))
      ...
      (match uu____2271 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           let errors =
             ...
             FStar_All.pipe_right uu____2341 (FStar_List.map json_of_issue)
              in
           (FStar_Errors.clear ();
            (let st' =
               let uu___247_2347 = st  in
               {
                 repl_line = line;
                 repl_column = column1;
                 repl_fname = (uu___247_2347.repl_fname);
                 repl_stack = stack2;
                 repl_curmod = (uu___247_2347.repl_curmod);
                 repl_env = (uu___247_2347.repl_env);
                 repl_ts = ts1;
                 repl_stdin = (uu___247_2347.repl_stdin)
               }  in
             match res with
             | Some (curmod,env3,nerrs) when
                 ...
                 ((QueryOK, (FStar_Util.JsonList errors)),
                   (FStar_Util.Inl
                      (let uu___248_2376 = st'  in
                       {
                         repl_line = (uu___248_2376.repl_line);
                         repl_column = (uu___248_2376.repl_column);
                         repl_fname = (uu___248_2376.repl_fname);
                         repl_stack = (uu___248_2376.repl_stack);
                         repl_curmod = curmod;
                         repl_env = env4;
                         repl_ts = (uu___248_2376.repl_ts);
                         repl_stdin = (uu___248_2376.repl_stdin)
                       })))
             | uu____2377 ->
                 let env3 = reset_mark env_mark  in
                 let uu____2388 =
                   run_pop
                     (let uu___249_2395 = st'  in
                      {
                        repl_line = (uu___249_2395.repl_line);
                        repl_column = (uu___249_2395.repl_column);
                        repl_fname = (uu___249_2395.repl_fname);
                        repl_stack = (uu___249_2395.repl_stack);
                        repl_curmod = (uu___249_2395.repl_curmod);
                        repl_env = env3;
                        repl_ts = (uu___249_2395.repl_ts);
                        repl_stdin = (uu___249_2395.repl_stdin)
                      })
                    in
        ...
        FStar_All.pipe_right uu____2482
          (FStar_Util.map_option
             (fun uu____2508  ->
                ...
                | ((uu____2518,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
         in
      let docs_of_lid lid =
        ...
        | (prefix1,matched,match_len) ->
            ...
            (match uu____3019 with
             | (stripped_ns,shortened) ->
                 ...
                 (uu____3034, uu____3035, uu____3036, match_len))
         in
                       ...
                       | Some l ->
                           let uu____3211 =
                             FStar_Ident.lid_of_ids (FStar_List.append ns id)
                              in
                           FStar_Ident.lid_equals l uu____3211)))
           in
          ...
          (fun uu____3318  ->
             ...
             | (candidate,ns,match_len) ->
                 FStar_Util.JsonList
                   ...
                   FStar_Util.JsonStr candidate]) uu____3280
         in
...
let run_compute st term rules =
  let run_and_rewind st1 task =
    ...
    let st' =
      let uu___250_3388 = st1  in
      {
        repl_line = (uu___250_3388.repl_line);
        repl_column = (uu___250_3388.repl_column);
        repl_fname = (uu___250_3388.repl_fname);
        repl_stack = (uu___250_3388.repl_stack);
        repl_curmod = (uu___250_3388.repl_curmod);
        repl_env = env;
        repl_ts = (uu___250_3388.repl_ts);
        repl_stdin = (uu___250_3388.repl_stdin)
      }  in
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____3873
           in
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____4039 = let uu____4046 = run_query st  in uu____4046 query.qq
       in
...
let interactive_error_handler : FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____4076 =
      let uu____4078 = FStar_ST.read issues  in e :: uu____4078  in
