      ...
      (match uu____2289 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           let errors =
             ...
             FStar_All.pipe_right uu____2347 (FStar_List.map json_of_issue) in
           (FStar_Errors.clear ();
            (let st' =
        ...
        FStar_All.pipe_right uu____2488
          (FStar_Util.map_option
             (fun uu____2514  ->
                ...
                | ((uu____2524,typ),r) -> ((FStar_Util.Inr lid1), typ, r))) in
      let docs_of_lid lid =
      ...
      let def_of_lid lid =
        ...
        FStar_Util.bind_opt uu____2553
          (fun uu___204_2573  ->
             ...
             | uu____2602 -> FStar_Pervasives_Native.None) in
      let info_at_pos_opt =
        ...
        | (prefix1,matched,match_len) ->
            ...
            (match uu____3025 with
             | (stripped_ns,shortened) ->
                 ...
                 (uu____3040, uu____3041, uu____3042, match_len)) in
                  ...
                  | (ns,id,uu____3208) ->
                      ...
                      (match uu____3213 with
                       ...
                       | FStar_Pervasives_Native.Some l ->
                           ...
                           FStar_Ident.lid_equals l uu____3217))) in
            ...
            FStar_All.pipe_right matched_ids
              (FStar_List.map
                 (fun x  ->
                    ...
                    prepare_candidate uu____3279)) in
      let json_candidates =
        let uu____3286 =
          ...
          (fun uu____3324  ->
             ...
             | (candidate,ns,match_len) ->
                 FStar_Util.JsonList
                   ...
                   FStar_Util.JsonStr candidate]) uu____3286 in
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____3879 in
...
let rec go: repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____4045 = let uu____4052 = run_query st in uu____4052 query.qq in
...
let interactive_error_handler: FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____4082 = let uu____4084 = FStar_ST.read issues in e :: uu____4084 in
