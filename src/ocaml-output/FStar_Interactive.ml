                ...
                FStar_All.pipe_right uu____1588
                  (FStar_Util.map_option
                     (fun loc  ->
                        ...
                        (uu____1625, uu____1627, uu____1629)))
                 in
              let uu____1631 =
              ...
              let uu____1823 =
                let uu____1825 =
                  ...
                  | FStar_Pervasives_Native.Some r ->
                      let uu____1829 = json_of_use_range r  in [uu____1829]
                   in
                let uu____1830 =
                  match issue.FStar_Errors.issue_range with
  ...
  let js_features =
    let uu____1999 =
      FStar_List.map (fun _0_43  -> FStar_Util.JsonStr _0_43)
       ...
       in
    FStar_All.pipe_left (fun _0_44  -> FStar_Util.JsonList _0_44) uu____1999
     in
            ...
            FStar_List.map
              (fun uu____2296  ->
                 ...
                 | (name,value,doc1,dflt1) ->
                     ...
                     FStar_Util.JsonAssoc uu____2308) opts_and_defaults
             in
      ...
      (match uu____2563 with
       | (restore_cmd_line_options1,(stack1,env1,ts1)) ->
           ...
           let errors =
             ...
             FStar_All.pipe_right uu____2637 (FStar_List.map json_of_issue)
              in
           (FStar_Errors.clear ();
            (let st' =
        ...
        FStar_All.pipe_right uu____2785
          (FStar_Util.map_option
             (fun uu____2815  ->
                ...
                | ((uu____2825,typ),r) -> ((FStar_Util.Inr lid1), typ, r)))
         in
      let docs_of_lid lid =
      ...
      let def_of_lid lid =
        ...
        FStar_Util.bind_opt uu____2854
          (fun uu___189_2879  ->
             ...
             | uu____2908 -> FStar_Pervasives_Native.None)
         in
      let info_at_pos_opt =
        ...
        | (prefix1,matched,match_len) ->
            ...
            (match uu____3350 with
             | (stripped_ns,shortened) ->
                 ...
                 (uu____3365, uu____3366, uu____3367, match_len))
         in
                       ...
                       | FStar_Pervasives_Native.Some l ->
                           let uu____3562 =
                             FStar_Ident.lid_of_ids (FStar_List.append ns id)
                              in
                           FStar_Ident.lid_equals l uu____3562)))
           in
          ...
          (fun uu____3683  ->
             ...
             | (candidate,ns,match_len) ->
                 FStar_Util.JsonList
                   ...
                   FStar_Util.JsonStr candidate]) uu____3633
         in
      ...
      let st_matches candidate term =
        let found =
          ...
          | TypeContainsLid lid ->
              ...
              FStar_Util.set_mem lid uu____4304
           in
...
let rec go : repl_state -> Prims.unit =
  fun st  ->
    ...
    let uu____4493 = let uu____4500 = run_query st  in uu____4500 query.qq
       in
...
let interactive_error_handler : FStar_Errors.error_handler =
  ...
  let add_one1 e =
    let uu____4530 =
      let uu____4532 = FStar_ST.read issues  in e :: uu____4532  in
