    ...
    let uu____858 =
      FStar_List.partition
        (fun x  ->
           ...
           let uu____865 = FStar_Parser_Dep.lowercase_module_name filename
              in
           uu____864 <> uu____865) deps
       in
              ...
              ((let uu____882 =
                  (let uu____883 = FStar_Parser_Dep.is_interface intf  in
                   Prims.op_Negation uu____883) ||
                    (let uu____884 = FStar_Parser_Dep.is_implementation impl
                        in
                     Prims.op_Negation uu____884)
                   in
                if uu____882
                then
                  let uu____885 =
            ...
            fun ts  ->
              ...
              | Completions search_term ->
                    ...
                    | (hs::ts1,hc::tc) ->
                        ...
                        then
                          (match ts1 with
                           ...
                           | uu____1652 ->
                               let uu____1654 = measure_anchored_match ts1 tc
                                  in
                  ...
                  let rec locate_match needle candidate =
                    let uu____1709 = measure_anchored_match needle candidate
                       in
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____1856 with
                         | (stripped_ns,shortened) ->
                             ...
                             (uu____1871, uu____1872, uu____1873, match_len))
                     in
