...
let left_over_doc = (FStar_Pprint.concat (let _0_580 = (let _0_579 = (let _0_578 = (FStar_Parser_ToDocument.comments_to_document leftover_comments)
in (_0_578)::[])
in (FStar_Pprint.hardline)::_0_579)
in (FStar_Pprint.hardline)::_0_580))
