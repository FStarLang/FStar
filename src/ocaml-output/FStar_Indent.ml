...
let uu____13 = (FStar_Parser_Driver.parse_file filename)
...
let uu____65 = (FStar_Parser_ToDocument.modul_with_comments_to_document module_ comments1)
in (match (uu____65) with
...
let uu____111 = (FStar_Parser_ToDocument.comments_to_document leftover_comments)
in (uu____111)::[])
in (FStar_Pprint.hardline)::uu____108)
in (FStar_Pprint.hardline)::uu____105)
in (FStar_Pprint.concat uu____102))
