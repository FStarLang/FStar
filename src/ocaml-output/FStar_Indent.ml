...
let left_over_doc = (FStar_Pprint.concat (let _0_706 = (let _0_705 = (let _0_704 = (FStar_Parser_ToDocument.comments_to_document leftover_comments)
in (_0_704)::[])
in (FStar_Pprint.hardline)::_0_705)
in (FStar_Pprint.hardline)::_0_706))
