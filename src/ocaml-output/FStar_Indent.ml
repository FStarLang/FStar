...
let uu____11 = (FStar_Parser_Driver.parse_file filename)
...
let uu____43 = (FStar_Parser_ToDocument.modul_with_comments_to_document module_ comments1)
...
let uu____70 = (FStar_Parser_ToDocument.comments_to_document leftover_comments)
in (uu____70)::[])
in (FStar_Pprint.hardline)::uu____68)
in (FStar_Pprint.hardline)::uu____66)
in (FStar_Pprint.concat uu____64))
