...
let uu____12 = (FStar_Parser_Driver.parse_file filename)
...
let uu____55 = (FStar_Parser_ToDocument.modul_with_comments_to_document modul comments1)
...
let uu____97 = (FStar_Parser_ToDocument.comments_to_document leftover_comments)
in (uu____97)::[])
in (FStar_Pprint.hardline)::uu____94)
in (FStar_Pprint.hardline)::uu____91)
in (FStar_Pprint.concat uu____88))
