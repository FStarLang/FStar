...
let generate : FStar_Parser_ParseIt.filename Prims.list -> Prims.unit =
  fun filenames ->
    let parse_and_indent filename =
      ...
      match uu____12 with modul, comments ->
        let leftover_comments =
          ...
          let uu____55 =
            FStar_Parser_ToDocument.modul_with_comments_to_document modul
              comments1
          in
          match uu____55 with doc1, comments2 ->
          ...
          let uu____88 =
            let uu____91 =
              let uu____94 =
                ...
                [uu____97]
              in
              FStar_Pprint.hardline :: uu____94
            in
            FStar_Pprint.hardline :: uu____91
          in
          FStar_Pprint.concat uu____88
        in
        FStar_Pprint.pretty_out_channel
          (FStar_Util.float_of_string "1.0")
