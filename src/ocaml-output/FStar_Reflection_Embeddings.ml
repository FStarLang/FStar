...
let (embed_aqualv :
  ...
  fun rng ->
    fun q ->
      ...
      let uu___54_66 = r in
      {
        FStar_Syntax_Syntax.n = (uu___54_66.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___54_66.FStar_Syntax_Syntax.vars)
      }
let (embed_binders :
  FStar_Range.range ->
      ...
      let r =
        ...
        | FStar_Reflection_Data.C_String s ->
            let uu____130 =
              let uu____131 =
                let uu____132 =
                  let uu____133 = FStar_Syntax_Embeddings.embed_string rng s in
                  FStar_Syntax_Syntax.as_arg uu____133 in
                [uu____132] in
              FStar_Syntax_Syntax.mk_Tm_app
                FStar_Reflection_Data.ref_C_String.FStar_Reflection_Data.t
                uu____131 in
            uu____130 FStar_Pervasives_Native.None FStar_Range.dummyRange in
      let uu___55_136 = r in
      {
        FStar_Syntax_Syntax.n = (uu___55_136.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___55_136.FStar_Syntax_Syntax.vars)
      }
      ...
      fun aq ->
        let uu____256 =
          ...
          FStar_Syntax_Embeddings.embed_tuple2 uu____263
            ...
            FStar_Reflection_Data.fstar_refl_aqualv in
        uu____256 rng aq
let (embed_branch :
  FStar_Range.range ->
      ...
      fun t ->
        ...
        | FStar_Reflection_Data.Tv_App (hd1, a) ->
            let uu____345 =
              let uu____346 =
                let uu____347 =
                  let uu____348 =
                    let uu____349 = embed_term_aq aq in uu____349 rng hd1 in
            ...
            let uu____364 =
              let uu____365 =
                ...
                let uu____368 =
                  let uu____371 =
                    let uu____372 =
                      let uu____373 = embed_term_aq aq in uu____373 rng t1 in
        ...
        | FStar_Reflection_Data.Tv_Type u ->
            let uu____395 =
              let uu____396 =
                let uu____397 =
                  let uu____398 = FStar_Syntax_Embeddings.embed_unit rng () in
            ...
            let uu____403 =
              let uu____404 =
                ...
                let uu____407 =
                  let uu____410 =
                    let uu____411 =
                      let uu____412 = embed_term_aq aq in uu____412 rng t1 in
            ...
            let uu____429 =
              let uu____430 =
                ...
                let uu____433 =
                  let uu____436 =
                    let uu____437 =
                      let uu____438 = embed_term_aq aq in uu____438 rng t1 in
        ...
        | FStar_Reflection_Data.Tv_Let (r, b, t1, t2) ->
            let uu____450 =
              let uu____451 =
                let uu____452 =
                  let uu____453 = FStar_Syntax_Embeddings.embed_bool rng r in
                ...
                let uu____454 =
                  ...
                  let uu____459 =
                    let uu____462 =
                      let uu____463 =
                        let uu____464 = embed_term_aq aq in uu____464 rng t1 in
            ...
            let uu____529 =
              let uu____530 =
                ...
                let uu____539 =
                  let uu____542 =
                    let uu____543 =
                      let uu____544 = embed_term_aq aq in uu____544 rng t1 in
        ...
        | FStar_Reflection_Data.Tv_Unknown ->
            ...
            {
              FStar_Syntax_Syntax.n = (uu___56_620.FStar_Syntax_Syntax.n);
              FStar_Syntax_Syntax.pos = rng;
              FStar_Syntax_Syntax.vars =
                (uu___56_620.FStar_Syntax_Syntax.vars)
            }
let (embed_term_view :
  FStar_Range.range ->
  ...
  fun rng ->
    fun bvv ->
      let uu____653 =
        ...
        FStar_Syntax_Syntax.mk_Tm_app
          FStar_Reflection_Data.ref_Mk_bv.FStar_Reflection_Data.t uu____654 in
  ...
  fun rng ->
    fun cv ->
      ...
      | FStar_Reflection_Data.C_Unknown ->
          ...
          {
            FStar_Syntax_Syntax.n = (uu___57_719.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.pos = rng;
            FStar_Syntax_Syntax.vars = (uu___57_719.FStar_Syntax_Syntax.vars)
          }
let (embed_order :
  ...
  fun rng ->
    fun o ->
      ...
      let uu___58_730 = r in
      {
        FStar_Syntax_Syntax.n = (uu___58_730.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___58_730.FStar_Syntax_Syntax.vars)
      }
let (embed_sigelt :
  ...
  fun rng ->
    fun sev ->
      ...
      | FStar_Reflection_Data.Unk ->
          ...
          {
            FStar_Syntax_Syntax.n = (uu___59_833.FStar_Syntax_Syntax.n);
            FStar_Syntax_Syntax.pos = rng;
            FStar_Syntax_Syntax.vars = (uu___59_833.FStar_Syntax_Syntax.vars)
          }
let rec (embed_exp :
        ...
        | FStar_Reflection_Data.Mult (e1, e2) ->
            let uu____852 =
              ...
              FStar_Syntax_Syntax.mk_Tm_app
                ...
                uu____853 in
            uu____852 FStar_Pervasives_Native.None FStar_Range.dummyRange in
      let uu___60_863 = r in
      {
        FStar_Syntax_Syntax.n = (uu___60_863.FStar_Syntax_Syntax.n);
        FStar_Syntax_Syntax.pos = rng;
        FStar_Syntax_Syntax.vars = (uu___60_863.FStar_Syntax_Syntax.vars)
      }
let (unembed_bv :
         ...
         | uu____1162 ->
             ((let uu____1176 =
                 let uu____1181 =
                   ...
                   FStar_Util.format1 "Not an embedded aqualv: %s" uu____1182 in
         ...
         | uu____1464 ->
             ((let uu____1478 =
                 let uu____1483 =
                   ...
                   FStar_Util.format1 "Not an embedded vconst: %s" uu____1484 in
    ...
    | (hd1, args) ->
        ...
        (match uu____1532 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (f, uu____1595)::(ps, uu____1597)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (bv, uu____1730)::(t2, uu____1732)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
  ...
  fun t ->
    ...
    | (hd1, args) ->
        ...
        (match uu____1869 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (l, uu____2000)::(r, uu____2002)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (b, uu____2068)::(t1, uu____2070)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (b, uu____2120)::(t1, uu____2122)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (b, uu____2206)::(t1, uu____2208)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (u, uu____2292)::(t1, uu____2294)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (r, uu____2344)::(b, uu____2346)::(t1, uu____2348)::(t2,
                                                                 uu____2350)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
                              ...
                              (fun t21 ->
                                 FStar_All.pipe_left
                                   ...
                                   (FStar_Reflection_Data.Tv_Let
                                      (r1, b1, t11, t21))))))
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (t1, uu____2432)::(brs, uu____2434)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (e, uu____2523)::(t1, uu____2525)::(tacopt, uu____2527)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
                         ...
                         (fun tacopt1 ->
                            FStar_All.pipe_left
                              ...
                              (FStar_Reflection_Data.Tv_AscribedT
                                 (e1, t2, tacopt1)))))
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (e, uu____2608)::(c, uu____2610)::(tacopt, uu____2612)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
  ...
  fun t ->
    ...
    | (hd1, args) ->
        ...
        (match uu____2778 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (nm, uu____2807)::(idx, uu____2809)::(s, uu____2811)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             FStar_Util.bind_opt uu____2856
               (fun nm1 ->
                  let uu____2862 = FStar_Syntax_Embeddings.unembed_int idx in
  ...
  fun t ->
    ...
    | (hd1, args) ->
        ...
        (match uu____2943 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (e1, uu____3021)::(e2, uu____3023)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | uu____3071 ->
             ((let uu____3085 =
                 let uu____3090 =
                   ...
                   FStar_Util.format1 "Not an embedded exp: %s" uu____3091 in
  ...
  fun t ->
    ...
    | (hd1, args) ->
        ...
        (match uu____3141 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (t2, uu____3170)::(md, uu____3172)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (pre, uu____3237)::(post, uu____3239)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | uu____3446 ->
             ((let uu____3460 =
                 let uu____3465 =
                   ...
                   FStar_Util.format1 "Not an embedded order: %s" uu____3466 in
  ...
  fun t ->
    ...
    | (hd1, args) ->
        ...
        (match uu____3542 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (nm, uu____3571)::(bs, uu____3573)::(t2, uu____3575)::(dcs,
                                                                   uu____3577)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Reflection_Data.ref_Sg_Inductive.FStar_Reflection_Data.lid
             ->
             let uu____3632 = FStar_Syntax_Embeddings.unembed_string_list nm in
                              ...
                              (fun dcs1 ->
                                 FStar_All.pipe_left
                                   ...
                                   (FStar_Reflection_Data.Sg_Inductive
                                      (nm1, bs1, t3, dcs1))))))
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (r, uu____3703)::(fvar1, uu____3705)::(ty, uu____3707)::(t2,
                                                                    uu____3709)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
    ...
    | (bv, aq) ->
        let uu____3869 =
          let uu____3870 =
            ...
            let uu____3873 =
              let uu____3876 =
                let uu____3877 = embed_aqualv i.FStar_Syntax_Syntax.rng aq in
