        ...
        (if w
         then
           (let uu___3 =
              let uu___4 =
                let uu___5 = FStar_Syntax_Print.term_to_string t  in
                FStar_Util.format1 "Not an embedded optionstate: %s" uu___5
                 in
              (FStar_Errors.Warning_NotEmbedded, uu___4)  in
            FStar_Errors.log_issue t.FStar_Syntax_Syntax.pos uu___3)
         else ();
              ...
              then
                (let uu___4 =
                   let uu___5 =
                     ...
                     FStar_Util.format1 "Not an embedded aqualv: %s" uu___6
                      in
  ...
  let embed_const rng c =
    let r =
      ...
      | FStar_Reflection_Data.C_Reflect ns ->
          let uu___ =
            let uu___1 =
              let uu___2 = embed FStar_Syntax_Embeddings.e_string_list rng ns
                 in
              FStar_Syntax_Syntax.as_arg uu___2  in
            [uu___1]  in
          FStar_Syntax_Syntax.mk_Tm_app
    ...
    | (hd,args) ->
        ...
        (match uu___1 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,(ns,uu___2)::[]) when
             ...
             ->
             let uu___3 = unembed' w FStar_Syntax_Embeddings.e_string_list ns
                in
             FStar_Util.bind_opt uu___3
               (fun ns1  ->
                  FStar_All.pipe_left
             ...
             (if w
              then
                (let uu___4 =
                   let uu___5 =
                     let uu___6 = FStar_Syntax_Print.term_to_string t1  in
                     FStar_Util.format1 "Not an embedded vconst: %s" uu___6
                      in
                   (FStar_Errors.Warning_NotEmbedded, uu___5)  in
                 FStar_Errors.log_issue t1.FStar_Syntax_Syntax.pos uu___4)
              else ();
  ...
  fun aq  ->
    let embed_term_view rng t =
      ...
      | FStar_Reflection_Data.Tv_App (hd,a) ->
          let uu___ =
            let uu___1 =
              let uu___2 = let uu___3 = e_term_aq aq  in embed uu___3 rng hd
                 in
              FStar_Syntax_Syntax.as_arg uu___2  in
            let uu___2 =
              let uu___3 =
                let uu___4 = let uu___5 = e_argv_aq aq  in embed uu___5 rng a
                   in
              ...
              let uu___4 =
                ...
                let uu___6 =
                  ...
                  let uu___8 =
                    let uu___9 =
                      let uu___10 =
                        let uu___11 = e_term_aq aq  in embed uu___11 rng t2
                         in
      ...
      | FStar_Reflection_Data.Tv_Match (t1,brs) ->
          let uu___ =
            let uu___1 =
              let uu___2 = let uu___3 = e_term_aq aq  in embed uu___3 rng t1
                 in
              FStar_Syntax_Syntax.as_arg uu___2  in
            let uu___2 =
              let uu___3 =
      ...
      | FStar_Reflection_Data.Tv_AscribedT (e,t1,tacopt) ->
          let uu___ =
            let uu___1 =
              let uu___2 = let uu___3 = e_term_aq aq  in embed uu___3 rng e
                 in
              FStar_Syntax_Syntax.as_arg uu___2  in
            let uu___2 =
              let uu___3 =
    ...
    let unembed_term_view w t =
      ...
      | (hd,args) ->
          ...
          (match uu___1 with
           ...
           | (FStar_Syntax_Syntax.Tm_fvar fv,(l,uu___2)::(r,uu___3)::[]) when
               FStar_Syntax_Syntax.fv_eq_lid fv
           ...
           | (FStar_Syntax_Syntax.Tm_fvar fv,(u,uu___2)::(l,uu___3)::[]) when
               FStar_Syntax_Syntax.fv_eq_lid fv
           ...
           | (FStar_Syntax_Syntax.Tm_fvar
              fv,(r,uu___2)::(attrs,uu___3)::(b,uu___4)::(t1,uu___5)::
              (t2,uu___6)::[]) when
               FStar_Syntax_Syntax.fv_eq_lid fv
           ...
           | (FStar_Syntax_Syntax.Tm_fvar fv,(t1,uu___2)::(brs,uu___3)::[])
               when
               FStar_Syntax_Syntax.fv_eq_lid fv
               ...
               FStar_Util.bind_opt uu___4
                 (fun t2  ->
                    let uu___5 =
                      let uu___6 = FStar_Syntax_Embeddings.e_list e_branch
                         in
           ...
           | (FStar_Syntax_Syntax.Tm_fvar
              fv,(e,uu___2)::(t1,uu___3)::(tacopt,uu___4)::[]) when
               FStar_Syntax_Syntax.fv_eq_lid fv
                           ...
                           (fun tacopt1  ->
                              FStar_All.pipe_left
                                ...
                                (FStar_Reflection_Data.Tv_AscribedT
                                   (e1, t2, tacopt1)))))
           | (FStar_Syntax_Syntax.Tm_fvar
              fv,(e,uu___2)::(c,uu___3)::(tacopt,uu___4)::[]) when
               FStar_Syntax_Syntax.fv_eq_lid fv
...
let (e_bv_view :
  ...
  let embed_bv_view rng bvv =
    let uu___ =
      ...
      let uu___2 =
        ...
        let uu___4 =
          let uu___5 =
            let uu___6 = embed e_term rng bvv.FStar_Reflection_Data.bv_sort
               in
            FStar_Syntax_Syntax.as_arg uu___6  in
          [uu___5]  in
        uu___3 :: uu___4  in
      uu___1 :: uu___2  in
    FStar_Syntax_Syntax.mk_Tm_app
      FStar_Reflection_Data.ref_Mk_bv.FStar_Reflection_Data.t uu___ rng
     in
  let unembed_bv_view w t =
    ...
    | (hd,args) ->
        ...
        (match uu___1 with
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(nm,uu___2)::(idx,uu___3)::(s,uu___4)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             FStar_Util.bind_opt uu___5
               (fun nm1  ->
                  let uu___6 = unembed' w FStar_Syntax_Embeddings.e_int idx
                     in
                  FStar_Util.bind_opt uu___6
                    (fun idx1  ->
             ...
             (if w
              then
                (let uu___4 =
                   let uu___5 =
                     let uu___6 = FStar_Syntax_Print.term_to_string t1  in
                     FStar_Util.format1 "Not an embedded bv_view: %s" uu___6
                      in
                   (FStar_Errors.Warning_NotEmbedded, uu___5)  in
                 FStar_Errors.log_issue t1.FStar_Syntax_Syntax.pos uu___4)
              else ();
  ...
  let embed_comp_view rng cv =
    ...
    | FStar_Reflection_Data.C_Eff (us,eff,res,args) ->
        let uu___ =
          ...
          uu___1 :: uu___2  in
        FStar_Syntax_Syntax.mk_Tm_app
          FStar_Reflection_Data.ref_C_Eff.FStar_Reflection_Data.t uu___ rng
     in
  let unembed_comp_view w t =
    ...
    | (hd,args) ->
        let uu___1 =
          ...
          (uu___2, args)  in
        (match uu___1 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,(t2,uu___2)::(md,uu___3)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(pre,uu___2)::(post,uu___3)::(pats,uu___4)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
                         ...
                         (fun pats1  ->
                            FStar_All.pipe_left
                              ...
                              (FStar_Reflection_Data.C_Lemma
                                 (pre1, post1, pats1)))))
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(us,uu___2)::(eff,uu___3)::(res,uu___4)::(args1,uu___5)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             (if w
              then
                (let uu___4 =
                   let uu___5 =
                     let uu___6 = FStar_Syntax_Print.term_to_string t1  in
                     FStar_Util.format1 "Not an embedded order: %s" uu___6
                      in
                   (FStar_Errors.Warning_NotEmbedded, uu___5)  in
                 FStar_Errors.log_issue t1.FStar_Syntax_Syntax.pos uu___4)
              else ();
...
let (e_sigelt_view :
  ...
  let embed_sigelt_view rng sev =
    ...
    | FStar_Reflection_Data.Sg_Inductive (nm,univs,bs,t,dcs) ->
        let uu___ =
          let uu___1 =
            let uu___2 = embed FStar_Syntax_Embeddings.e_string_list rng nm
               in
            FStar_Syntax_Syntax.as_arg uu___2  in
          let uu___2 =
            let uu___3 =
  ...
  let unembed_sigelt_view w t =
    ...
    | (hd,args) ->
        ...
        (match uu___1 with
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(nm,uu___2)::(us,uu___3)::(bs,uu___4)::(t2,uu___5)::(dcs,uu___6)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Reflection_Data.ref_Sg_Inductive.FStar_Reflection_Data.lid
             ->
             let uu___7 = unembed' w FStar_Syntax_Embeddings.e_string_list nm
                in
             FStar_Util.bind_opt uu___7
               (fun nm1  ->
                                   ...
                                   (fun dcs1  ->
                                      FStar_All.pipe_left
                                        ...
                                        (FStar_Reflection_Data.Sg_Inductive
                                           (nm1, us1, bs1, t3, dcs1)))))))
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(r,uu___2)::(fvar,uu___3)::(univs,uu___4)::(ty,uu___5)::
            (t2,uu___6)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
  ...
  let rec unembed_exp w t =
    ...
    | (hd,args) ->
        ...
        (match uu___1 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,(e1,uu___2)::(e2,uu___3)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
  ...
  let unembed w t =
    ...
    | (hd,args) ->
        ...
        (match uu___1 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,(l,uu___2)::(i,uu___3)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,(ids1,uu___2)::(ids2,uu___3)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
