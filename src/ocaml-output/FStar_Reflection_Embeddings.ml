      ...
      let r =
        ...
        | FStar_Reflection_Data.C_String s ->
            let uu____103 =
              let uu____104 =
                let uu____105 =
                  let uu____106 = FStar_Syntax_Embeddings.embed_string rng s in
                  FStar_Syntax_Syntax.as_arg uu____106 in
                [uu____105] in
              FStar_Syntax_Syntax.mk_Tm_app
                FStar_Reflection_Data.ref_C_String.FStar_Reflection_Data.t
                uu____104 in
            uu____103 FStar_Pervasives_Native.None FStar_Range.dummyRange in
  ...
  fun rng ->
    fun bvv ->
      let uu____445 =
        ...
        FStar_Syntax_Syntax.mk_Tm_app
          FStar_Reflection_Data.ref_Mk_bv.FStar_Reflection_Data.t uu____446 in
  ...
  fun t ->
    ...
    | FStar_Syntax_Syntax.Tm_meta
        ({ FStar_Syntax_Syntax.n = uu____688;
           ...
           FStar_Syntax_Syntax.vars = uu____690;_},
         ...
         | uu____818 ->
             ((let uu____832 =
                 let uu____837 =
                   ...
                   FStar_Util.format1 "Not an embedded aqualv: %s" uu____838 in
         ...
         | uu____1120 ->
             ((let uu____1134 =
                 let uu____1139 =
                   ...
                   FStar_Util.format1 "Not an embedded vconst: %s" uu____1140 in
    ...
    | (hd1, args) ->
        ...
        (match uu____1188 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (f, uu____1251)::(ps, uu____1253)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (bv, uu____1386)::(t2, uu____1388)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
  ...
  fun t ->
    ...
    | (hd1, args) ->
        ...
        (match uu____1525 with
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (l, uu____1656)::(r, uu____1658)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (b, uu____1724)::(t1, uu____1726)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (b, uu____1776)::(t1, uu____1778)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (b, uu____1862)::(t1, uu____1864)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (u, uu____1948)::(t1, uu____1950)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (r, uu____2000)::(b, uu____2002)::(t1, uu____2004)::(t2,
                                                                 uu____2006)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
                              ...
                              (fun t21 ->
                                 FStar_All.pipe_left
                                   ...
                                   (FStar_Reflection_Data.Tv_Let
                                      (r1, b1, t11, t21))))))
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (t1, uu____2088)::(brs, uu____2090)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (e, uu____2179)::(t1, uu____2181)::(tacopt, uu____2183)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
                         ...
                         (fun tacopt1 ->
                            FStar_All.pipe_left
                              ...
                              (FStar_Reflection_Data.Tv_AscribedT
                                 (e1, t2, tacopt1)))))
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (e, uu____2264)::(c, uu____2266)::(tacopt, uu____2268)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
  ...
  fun t ->
    ...
    | (hd1, args) ->
        ...
        (match uu____2434 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (nm, uu____2463)::(idx, uu____2465)::(s, uu____2467)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
             ...
             FStar_Util.bind_opt uu____2512
               (fun nm1 ->
                  let uu____2518 = FStar_Syntax_Embeddings.unembed_int idx in
  ...
  fun t ->
    ...
    | (hd1, args) ->
        ...
        (match uu____2601 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (t2, uu____2630)::(md, uu____2632)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (pre, uu____2697)::(post, uu____2699)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv
         ...
         | uu____2906 ->
             ((let uu____2920 =
                 let uu____2925 =
                   ...
                   FStar_Util.format1 "Not an embedded order: %s" uu____2926 in
  ...
  fun t ->
    ...
    | (hd1, args) ->
        ...
        (match uu____3002 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (nm, uu____3031)::(bs, uu____3033)::(t2, uu____3035)::(dcs,
                                                                   uu____3037)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
               FStar_Reflection_Data.ref_Sg_Inductive.FStar_Reflection_Data.lid
             ->
             let uu____3092 = FStar_Syntax_Embeddings.unembed_string_list nm in
                              ...
                              (fun dcs1 ->
                                 FStar_All.pipe_left
                                   ...
                                   (FStar_Reflection_Data.Sg_Inductive
                                      (nm1, bs1, t3, dcs1))))))
         | (FStar_Syntax_Syntax.Tm_fvar fv,
            (r, uu____3163)::(fvar1, uu____3165)::(ty, uu____3167)::(t2,
                                                                    uu____3169)::[])
             when
             FStar_Syntax_Syntax.fv_eq_lid fv
  ...
  fun i ->
    ...
    let uu____3311 =
      let uu____3312 =
        let uu____3313 =
          let uu____3314 =
            let uu____3315 = FStar_Reflection_Basic.inspect_bv bv in
            embed_bv_view i.FStar_Syntax_Syntax.rng uu____3315 in
          FStar_Syntax_Syntax.as_arg uu____3314 in
        [uu____3313] in
      FStar_Syntax_Syntax.mk_Tm_app
        FStar_Reflection_Data.fstar_refl_pack_bv.FStar_Reflection_Data.t
        uu____3312 in
    uu____3311 FStar_Pervasives_Native.None i.FStar_Syntax_Syntax.rng
let (unfold_lazy_binder :
  FStar_Syntax_Syntax.lazyinfo -> FStar_Syntax_Syntax.term) =
  fun i ->
    let binder = FStar_Dyn.undyn i.FStar_Syntax_Syntax.blob in
    let uu____3322 = FStar_Reflection_Basic.inspect_binder binder in
    match uu____3322 with
    | (bv, aq) ->
        let uu____3329 =
          let uu____3330 =
            let uu____3331 =
              let uu____3332 = embed_bv i.FStar_Syntax_Syntax.rng bv in
              FStar_Syntax_Syntax.as_arg uu____3332 in
            let uu____3333 =
              let uu____3336 =
                let uu____3337 = embed_aqualv i.FStar_Syntax_Syntax.rng aq in
                FStar_Syntax_Syntax.as_arg uu____3337 in
              [uu____3336] in
            uu____3331 :: uu____3333 in
          FStar_Syntax_Syntax.mk_Tm_app
            FStar_Reflection_Data.fstar_refl_pack_binder.FStar_Reflection_Data.t
            uu____3330 in
        uu____3329 FStar_Pervasives_Native.None i.FStar_Syntax_Syntax.rng
  ...
  fun i ->
    ...
    let uu____3344 =
      let uu____3345 =
        let uu____3346 =
          let uu____3347 =
            let uu____3348 = FStar_Reflection_Basic.inspect_fv fv in
            let uu____3351 =
              FStar_Syntax_Embeddings.embed_list
                FStar_Syntax_Embeddings.embed_string
                FStar_Syntax_Syntax.t_string in
            uu____3351 i.FStar_Syntax_Syntax.rng uu____3348 in
          FStar_Syntax_Syntax.as_arg uu____3347 in
        [uu____3346] in
      FStar_Syntax_Syntax.mk_Tm_app
        FStar_Reflection_Data.fstar_refl_pack_fv.FStar_Reflection_Data.t
        uu____3345 in
    uu____3344 FStar_Pervasives_Native.None i.FStar_Syntax_Syntax.rng
  ...
  fun i ->
    ...
    let uu____3365 =
      let uu____3366 =
        let uu____3367 =
          let uu____3368 =
            let uu____3369 = FStar_Reflection_Basic.inspect_comp comp in
            embed_comp_view i.FStar_Syntax_Syntax.rng uu____3369 in
          FStar_Syntax_Syntax.as_arg uu____3368 in
        [uu____3367] in
      FStar_Syntax_Syntax.mk_Tm_app
        FStar_Reflection_Data.fstar_refl_pack_comp.FStar_Reflection_Data.t
        uu____3366 in
    uu____3365 FStar_Pervasives_Native.None i.FStar_Syntax_Syntax.rng
let (unfold_lazy_env :
  FStar_Syntax_Syntax.lazyinfo -> FStar_Syntax_Syntax.term) =
  ...
  fun i ->
    ...
    let uu____3379 =
      let uu____3380 =
        let uu____3381 =
          let uu____3382 =
            let uu____3383 = FStar_Reflection_Basic.inspect_sigelt sigelt in
            embed_sigelt_view i.FStar_Syntax_Syntax.rng uu____3383 in
          FStar_Syntax_Syntax.as_arg uu____3382 in
        [uu____3381] in
      FStar_Syntax_Syntax.mk_Tm_app
        FStar_Reflection_Data.fstar_refl_pack_sigelt.FStar_Reflection_Data.t
        uu____3380 in
    uu____3379 FStar_Pervasives_Native.None i.FStar_Syntax_Syntax.rng