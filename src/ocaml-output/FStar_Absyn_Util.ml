...
(let _27_34 = (let _57_8 = (let _57_7 = (FStar_Range.string_of_range r)
in (FStar_Util.format3 "%s : %s\n%s\n" _57_7 (if warning then begin
"Warning"
end else begin
"Error"
end) msg))
in (FStar_Util.print_string _57_8))
in ())
end
| FStar_Util.NYI (s) -> begin
(let _27_38 = (let _57_9 = (FStar_Util.format1 "Feature not yet implemented: %s" s)
in (FStar_Util.print_string _57_9))
in ())
end
| FStar_Absyn_Syntax.Err (s) -> begin
(let _57_10 = (FStar_Util.format1 "Error: %s" s)
in (FStar_Util.print_string _57_10))
end
| _27_43 -> begin
(Prims.raise e)
end))
...
| () -> begin
(let _57_38 = (let _57_35 = (let _57_34 = (let _57_33 = (FStar_ST.read n_resets)
in (FStar_Util.string_of_int _57_33))
in (Prims.strcat "_" _57_34))
in (Prims.strcat _57_35 "_"))
in (let _57_37 = (let _57_36 = (let _27_62 = (FStar_Util.incr ctr)
in (FStar_ST.read ctr))
in (FStar_Util.string_of_int _57_36))
in (Prims.strcat _57_38 _57_37)))
...
let freshen_bvd = (fun bvd' -> (let _57_88 = (let _57_87 = (genident (Some ((range_of_bvd bvd'))))
in (bvd'.FStar_Absyn_Syntax.ppname, _57_87))
in (mkbvd _57_88)))

let freshen_bvar = (fun b -> (let _57_90 = (freshen_bvd b.FStar_Absyn_Syntax.v)
in (bvd_to_bvar_s _57_90 b.FStar_Absyn_Syntax.sort)))
...
let fvar = (fun dc l r -> (let _57_115 = (let _57_114 = (let _57_113 = (set_lid_range l r)
in (fv _57_113))
in (_57_114, dc))
in (FStar_Absyn_Syntax.mk_Exp_fvar _57_115 None r)))
...
(let _57_124 = (let _57_123 = (btvar_to_typ a)
in FStar_Util.Inl (_57_123))
in (_57_124, imp))
end
| FStar_Util.Inr (x) -> begin
(let _57_126 = (let _57_125 = (bvar_to_exp x)
in FStar_Util.Inr (_57_125))
in (_57_126, imp))
end)
end))
...
(let _57_130 = (arg_of_non_null_binder b)
in (_57_130)::[])
end))))

let args_of_binders = (fun binders -> (let _57_140 = (FStar_All.pipe_right binders (FStar_List.map (fun b -> if (FStar_Absyn_Syntax.is_null_binder b) then begin
(let b = (match ((Prims.fst b)) with
| FStar_Util.Inl (a) -> begin
(let _57_135 = (let _57_134 = (gen_bvar a.FStar_Absyn_Syntax.sort)
in FStar_Util.Inl (_57_134))
in (_57_135, (Prims.snd b)))
end
| FStar_Util.Inr (x) -> begin
(let _57_137 = (let _57_136 = (gen_bvar x.FStar_Absyn_Syntax.sort)
in FStar_Util.Inr (_57_136))
in (_57_137, (Prims.snd b)))
end)
in (let _57_138 = (arg_of_non_null_binder b)
in (b, _57_138)))
end else begin
(let _57_139 = (arg_of_non_null_binder b)
in (b, _57_139))
end)))
in (FStar_All.pipe_right _57_140 FStar_List.unzip)))
...
(let b = (let _57_146 = (let _57_145 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _57_145))
in (FStar_Ident.id_of_text _57_146))
in (let b = (bvd_to_bvar_s (mkbvd (b, b)) a.FStar_Absyn_Syntax.sort)
in (FStar_Util.Inl (b), imp)))
end
| (FStar_Util.Inr (y), imp) -> begin
(let x = (let _57_148 = (let _57_147 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _57_147))
in (FStar_Ident.id_of_text _57_148))
...
(let _57_152 = (let _57_151 = (name_binders binders)
in (_57_151, comp))
in (FStar_Absyn_Syntax.mk_Typ_fun _57_152 None t.FStar_Absyn_Syntax.pos))
end
| _27_215 -> begin
t
end))
...
(let _57_156 = (FStar_All.pipe_left Prims.fst (FStar_Absyn_Syntax.null_t_binder k))
in (_57_156, imp))
end
| (FStar_Util.Inr (t), imp) -> begin
(let _57_157 = (FStar_All.pipe_left Prims.fst (FStar_Absyn_Syntax.null_v_binder t))
in (_57_157, imp))
end)))))

let binders_of_tks = (fun tks -> (FStar_All.pipe_right tks (FStar_List.map (fun _27_3 -> (match (_27_3) with
| (FStar_Util.Inl (k), imp) -> begin
(let _57_162 = (let _57_161 = (gen_bvar_p k.FStar_Absyn_Syntax.pos k)
in FStar_Util.Inl (_57_161))
in (_57_162, imp))
end
| (FStar_Util.Inr (t), imp) -> begin
(let _57_164 = (let _57_163 = (gen_bvar_p t.FStar_Absyn_Syntax.pos t)
in FStar_Util.Inr (_57_163))
in (_57_164, imp))
end)))))

let binders_of_freevars = (fun fvs -> (let _57_170 = (let _57_167 = (FStar_Util.set_elements fvs.FStar_Absyn_Syntax.ftvs)
in (FStar_All.pipe_right _57_167 (FStar_List.map FStar_Absyn_Syntax.t_binder)))
in (let _57_169 = (let _57_168 = (FStar_Util.set_elements fvs.FStar_Absyn_Syntax.fxvs)
in (FStar_All.pipe_right _57_168 (FStar_List.map FStar_Absyn_Syntax.v_binder)))
in (FStar_List.append _57_170 _57_169))))

let subst_to_string = (fun s -> (let _57_173 = (FStar_All.pipe_right s (FStar_List.map (fun _27_4 -> (match (_27_4) with
...
in (FStar_All.pipe_right _57_173 (FStar_String.concat ", "))))
...
(let _57_198 = (let _57_197 = (compose_subst s' s)
in (let _57_196 = (FStar_Util.mk_ref None)
in (t', _57_197, _57_196)))
in (FStar_Absyn_Syntax.mk_Typ_delayed _57_198 None t.FStar_Absyn_Syntax.pos))
end
...
| _27_311 -> begin
(let _57_203 = (let _57_202 = (FStar_Util.mk_ref None)
in (t0, s, _57_202))
in (FStar_Absyn_Syntax.mk_Typ_delayed _57_203 None t.FStar_Absyn_Syntax.pos))
end))
end))
...
(let _57_208 = (let _57_207 = (compose_subst s' s)
in (let _57_206 = (FStar_Util.mk_ref None)
in (e, _57_207, _57_206)))
in (FStar_Absyn_Syntax.mk_Exp_delayed _57_208 None e.FStar_Absyn_Syntax.pos))
end
...
| _27_345 -> begin
(let _57_212 = (let _57_211 = (FStar_Util.mk_ref None)
in (e0, s, _57_211))
in (FStar_Absyn_Syntax.mk_Exp_delayed _57_212 None e0.FStar_Absyn_Syntax.pos))
end))
end))
...
(let _57_217 = (let _57_216 = (compose_subst s' s)
in (let _57_215 = (FStar_Util.mk_ref None)
in (k, _57_216, _57_215)))
in (FStar_Absyn_Syntax.mk_Kind_delayed _57_217 k0.FStar_Absyn_Syntax.pos))
end
| _27_363 -> begin
(let _57_219 = (let _57_218 = (FStar_Util.mk_ref None)
in (k0, s, _57_218))
in (FStar_Absyn_Syntax.mk_Kind_delayed _57_219 k0.FStar_Absyn_Syntax.pos))
end))
end))
...
(let _57_223 = (subst_exp' s a)
in FStar_Absyn_Syntax.DECREASES (_57_223))
end
| f -> begin
f
end)))))
...
| _27_376 -> begin
(let _27_377 = t
in (let _57_233 = (subst_typ' s t.FStar_Absyn_Syntax.result_typ)
in (let _57_232 = (FStar_List.map (fun _27_8 -> (match (_27_8) with
| (FStar_Util.Inl (t), imp) -> begin
(let _57_228 = (let _57_227 = (subst_typ' s t)
in FStar_Util.Inl (_57_227))
in (_57_228, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _57_230 = (let _57_229 = (subst_exp' s e)
in FStar_Util.Inr (_57_229))
in (_57_230, imp))
end)) t.FStar_Absyn_Syntax.effect_args)
in (let _57_231 = (subst_flags' s t.FStar_Absyn_Syntax.flags)
in {FStar_Absyn_Syntax.effect_name = _27_377.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = _57_233; FStar_Absyn_Syntax.effect_args = _57_232; FStar_Absyn_Syntax.flags = _57_231}))))
end))
...
(let _57_236 = (subst_typ' s t)
in (FStar_Absyn_Syntax.mk_Total _57_236))
end
| FStar_Absyn_Syntax.Comp (ct) -> begin
(let _57_237 = (subst_comp_typ' s ct)
in (FStar_Absyn_Syntax.mk_Comp _57_237))
end)
end))
...
| (FStar_Util.Inl (a), imp) -> begin
(let _57_265 = (let _57_264 = (let _27_418 = a
in (let _57_263 = (subst_kind s a.FStar_Absyn_Syntax.sort)
in {FStar_Absyn_Syntax.v = _27_418.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _57_263; FStar_Absyn_Syntax.p = _27_418.FStar_Absyn_Syntax.p}))
in FStar_Util.Inl (_57_264))
in (_57_265, imp))
end
| (FStar_Util.Inr (x), imp) -> begin
(let _57_268 = (let _57_267 = (let _27_424 = x
in (let _57_266 = (subst_typ s x.FStar_Absyn_Syntax.sort)
in {FStar_Absyn_Syntax.v = _27_424.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _57_266; FStar_Absyn_Syntax.p = _27_424.FStar_Absyn_Syntax.p}))
in FStar_Util.Inr (_57_267))
in (_57_268, imp))
end))

let subst_arg = (fun s _27_10 -> (match (_27_10) with
| (FStar_Util.Inl (t), imp) -> begin
(let _57_272 = (let _57_271 = (subst_typ s t)
in FStar_Util.Inl (_57_271))
in (_57_272, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _57_274 = (let _57_273 = (subst_exp s e)
in FStar_Util.Inr (_57_273))
in (_57_274, imp))
end))
...
(let _57_289 = (let _57_288 = (let _57_287 = (btvar_to_typ a)
in (b.FStar_Absyn_Syntax.v, _57_287))
in FStar_Util.Inl (_57_288))
in (_57_289)::[])
end
end
| (FStar_Util.Inr (x), FStar_Util.Inr (y)) -> begin
...
(let _57_292 = (let _57_291 = (let _57_290 = (bvar_to_exp x)
in (y.FStar_Absyn_Syntax.v, _57_290))
in FStar_Util.Inr (_57_291))
in (_57_292)::[])
end
end
| _27_485 -> begin
...
| (b1::bs1, b2::bs2) -> begin
(let _57_304 = (let _57_303 = (mk_subst_one_binder b1 b2)
in (FStar_List.append _57_303 out))
in (aux _57_304 bs1 bs2))
end
| _27_503 -> begin
None
end))
...
let map_knd = (fun s vk mt me descend binders k -> (let _57_325 = (subst_kind' s k)
in (_57_325, descend)))

let map_typ = (fun s mk vt me descend binders t -> (let _57_333 = (subst_typ' s t)
in (_57_333, descend)))

let map_exp = (fun s mk me ve descend binders e -> (let _57_341 = (subst_exp' s e)
in (_57_341, descend)))
...
(let _57_358 = (let _57_357 = (map_exp descend binders e)
in (FStar_All.pipe_right _57_357 Prims.fst))
in FStar_Absyn_Syntax.DECREASES (_57_358))
end
| f -> begin
f
end)))))
...
| (t, descend) -> begin
(let _57_381 = (FStar_Absyn_Syntax.mk_Total t)
in (_57_381, descend))
end))
end
| FStar_Absyn_Syntax.Comp (ct) -> begin
...
| (args, descend) -> begin
(let _57_384 = (let _57_383 = (let _27_561 = ct
in (let _57_382 = (map_flags s map_exp descend binders ct.FStar_Absyn_Syntax.flags)
in {FStar_Absyn_Syntax.effect_name = _27_561.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = args; FStar_Absyn_Syntax.flags = _57_382}))
in (FStar_Absyn_Syntax.mk_Comp _57_383))
in (_57_384, descend))
end))
end))
end))
...
| FStar_Absyn_Syntax.Kind_delayed (k', s, m) -> begin
(let k' = (let _57_430 = (FStar_Absyn_Visit.reduce_kind (visit_knd s) (map_typ s) (map_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp subst_ctrl [] k')
in (FStar_All.pipe_left Prims.fst _57_430))
...
(let _57_432 = (let _57_431 = (subst_of_list formals actuals)
in (subst_kind _57_431 k'))
in (compress_kind _57_432))
end
| _27_597 -> begin
...
| _27_631 -> begin
(let b = (let _57_509 = (freshen_bvd a.FStar_Absyn_Syntax.v)
in (bvd_to_bvar_s _57_509 k))
in (let s = (let _57_512 = (let _57_511 = (let _57_510 = (btvar_to_typ b)
in (a.FStar_Absyn_Syntax.v, _57_510))
in FStar_Util.Inl (_57_511))
in (extend_subst _57_512 s))
...
| _27_652 -> begin
(let y = (let _57_522 = (freshen_bvd x.FStar_Absyn_Syntax.v)
in (bvd_to_bvar_s _57_522 t))
in (let s = (let _57_525 = (let _57_524 = (let _57_523 = (bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _57_523))
in FStar_Util.Inr (_57_524))
in (extend_subst _57_525 s))
...
(let _57_536 = (let _57_535 = (map_typ s mk vt me null_ctrl boundvars t)
in (FStar_All.pipe_left Prims.fst _57_535))
in FStar_Util.Inl (_57_536))
end
| (_27_673, FStar_Util.Inr (c)) -> begin
(let _57_559 = (let _57_558 = (map_comp s mk (map_typ s mk vt me) (map_exp s mk vt me) null_ctrl boundvars c)
in (FStar_All.pipe_left Prims.fst _57_558))
in FStar_Util.Inr (_57_559))
end)
...
(let _57_561 = (let _57_560 = (subst_typ' s t0)
in (FStar_All.pipe_left compress_typ _57_560))
in (_57_561, ctrl))
end
...
(let _57_571 = (FStar_Absyn_Syntax.mk_Typ_fun (bs, c) None t0.FStar_Absyn_Syntax.pos)
in (_57_571, ctrl))
end
| _27_693 -> begin
...
(let _57_572 = (FStar_Absyn_Syntax.mk_Typ_refine (x, t) None t0.FStar_Absyn_Syntax.pos)
in (_57_572, ctrl))
end
| _27_708 -> begin
(FStar_All.failwith "Impossible")
...
(let _57_573 = (FStar_Absyn_Syntax.mk_Typ_lam (bs, t) None t0.FStar_Absyn_Syntax.pos)
in (_57_573, ctrl))
end
| _27_718 -> begin
(FStar_All.failwith "Impossible")
...
| FStar_Absyn_Syntax.Typ_delayed (FStar_Util.Inl (t', s), m) -> begin
(let res = (let _57_593 = (FStar_Absyn_Visit.reduce_typ (map_knd s) (visit_typ s) (map_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp subst_ctrl [] t')
in (FStar_All.pipe_left Prims.fst _57_593))
in (let res = (compress_typ' res)
in (let _27_736 = (FStar_ST.op_Colon_Equals m (Some (res)))
in res)))
end
| FStar_Absyn_Syntax.Typ_delayed (FStar_Util.Inr (mk_t), m) -> begin
(let t = (let _57_595 = (mk_t ())
in (compress_typ' _57_595))
...
(let _57_661 = (let _57_660 = (subst_exp' s e)
in (FStar_All.pipe_left compress_exp _57_660))
in (_57_661, ctrl))
end
...
in (match (e.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_delayed (e', s, m) -> begin
(let e = (let _57_690 = (FStar_Absyn_Visit.reduce_exp (map_knd s) (map_typ s) (visit_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp subst_ctrl [] e')
in (FStar_All.pipe_left Prims.fst _57_690))
...
in (let s = (mk_subst [])
in (let doit = (fun t -> (let _57_715 = (FStar_Absyn_Visit.reduce_typ (map_knd s) (visit_typ s) (map_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp alpha_ctrl [] t)
in (FStar_All.pipe_left Prims.fst _57_715)))
in (match (t.FStar_Absyn_Syntax.n) with
...
let ml_comp = (fun t r -> (let _57_732 = (let _57_731 = (set_lid_range FStar_Absyn_Const.effect_ML_lid r)
in {FStar_Absyn_Syntax.effect_name = _57_731; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = []; FStar_Absyn_Syntax.flags = (FStar_Absyn_Syntax.MLEFFECT)::[]})
in (FStar_Absyn_Syntax.mk_Comp _57_732)))
...
let is_pure_or_ghost_function = (fun t -> (match ((let _57_771 = (compress_typ t)
in _57_771.FStar_Absyn_Syntax.n)) with
...
let is_lemma = (fun t -> (match ((let _57_774 = (compress_typ t)
in _57_774.FStar_Absyn_Syntax.n)) with
...
let is_smt_lemma = (fun t -> (match ((let _57_777 = (compress_typ t)
in _57_777.FStar_Absyn_Syntax.n)) with
...
(match ((let _57_778 = (unmeta_exp pats)
in _57_778.FStar_Absyn_Syntax.n)) with
...
let rec is_atom = (fun e -> (match ((let _57_788 = (compress_exp e)
in _57_788.FStar_Absyn_Syntax.n)) with
...
let is_fun = (fun e -> (match ((let _57_802 = (compress_exp e)
in _57_802.FStar_Absyn_Syntax.n)) with
...
let is_function_typ = (fun t -> (match ((let _57_805 = (compress_typ t)
in _57_805.FStar_Absyn_Syntax.n)) with
...
| [] -> begin
(let _57_838 = (let _57_837 = (let _57_836 = (fvar (Some (FStar_Absyn_Syntax.Data_ctor)) l (FStar_Ident.range_of_lid l))
in (_57_836, FStar_Absyn_Syntax.Data_app))
in FStar_Absyn_Syntax.Meta_desugared (_57_837))
in (FStar_Absyn_Syntax.mk_Exp_meta _57_838))
end
| _27_1393 -> begin
(let _57_842 = (let _57_841 = (let _57_840 = (let _57_839 = (fvar (Some (FStar_Absyn_Syntax.Data_ctor)) l (FStar_Ident.range_of_lid l))
in (mk_exp_app _57_839 args))
in (_57_840, FStar_Absyn_Syntax.Data_app))
in FStar_Absyn_Syntax.Meta_desugared (_57_841))
in (FStar_Absyn_Syntax.mk_Exp_meta _57_842))
end))
...
(let _57_848 = (let _57_847 = (FStar_Util.substring_from x.FStar_Ident.idText 7)
in (_57_847, x.FStar_Ident.idRange))
in (FStar_Ident.mk_ident _57_848))
end else begin
x
end)

let mk_field_projector_name = (fun lid x i -> (let nm = if (FStar_Absyn_Syntax.is_null_bvar x) then begin
(let _57_854 = (let _57_853 = (let _57_852 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _57_852))
in (_57_853, x.FStar_Absyn_Syntax.p))
in (FStar_Absyn_Syntax.mk_ident _57_854))
end else begin
...
in (let _57_858 = (let _57_857 = (let _57_856 = (let _57_855 = (unmangle_field_name nm)
in (_57_855)::[])
in (FStar_List.append (FStar_Ident.ids_of_lid lid) _57_856))
in (FStar_Ident.lid_of_ids _57_857))
in (_57_858, y)))))

let unchecked_unify = (fun uv t -> (match ((FStar_Unionfind.find uv)) with
| FStar_Absyn_Syntax.Fixed (_27_1408) -> begin
(let _57_863 = (let _57_862 = (let _57_861 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _57_861))
in (FStar_Util.format1 "Changing a fixed uvar! U%s\n" _57_862))
in (FStar_All.failwith _57_863))
end
| _27_1411 -> begin
...
let union_uvs = (fun uvs1 uvs2 -> (let _57_892 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_k uvs2.FStar_Absyn_Syntax.uvars_k)
in (let _57_891 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_t uvs2.FStar_Absyn_Syntax.uvars_t)
in (let _57_890 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_e uvs2.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _57_892; FStar_Absyn_Syntax.uvars_t = _57_891; FStar_Absyn_Syntax.uvars_e = _57_890}))))

let union_fvs = (fun fvs1 fvs2 -> (let _57_898 = (FStar_Util.set_union fvs1.FStar_Absyn_Syntax.ftvs fvs2.FStar_Absyn_Syntax.ftvs)
in (let _57_897 = (FStar_Util.set_union fvs1.FStar_Absyn_Syntax.fxvs fvs2.FStar_Absyn_Syntax.fxvs)
in {FStar_Absyn_Syntax.ftvs = _57_898; FStar_Absyn_Syntax.fxvs = _57_897})))

let union_fvs_uvs = (fun _27_1456 _27_1459 -> (match ((_27_1456, _27_1459)) with
| ((fvs1, uvs1), (fvs2, uvs2)) -> begin
(let _57_904 = (union_fvs fvs1 fvs2)
in (let _57_903 = (union_uvs uvs1 uvs2)
in (_57_904, _57_903)))
end))

let sub_fv = (fun _27_1462 _27_1465 -> (match ((_27_1462, _27_1465)) with
| ((fvs, uvs), (tvars, vvars)) -> begin
(let _57_925 = (let _27_1466 = fvs
in (let _57_924 = (FStar_Util.set_difference fvs.FStar_Absyn_Syntax.ftvs tvars)
in (let _57_923 = (FStar_Util.set_difference fvs.FStar_Absyn_Syntax.fxvs vvars)
in {FStar_Absyn_Syntax.ftvs = _57_924; FStar_Absyn_Syntax.fxvs = _57_923})))
in (_57_925, uvs))
end))
...
let single_fv = (fun x -> (let _57_936 = (FStar_Absyn_Syntax.new_ftv_set ())
in (FStar_Util.set_add x _57_936)))

let single_uv = (fun u -> (let _57_944 = (FStar_Absyn_Syntax.new_uv_set ())
in (FStar_Util.set_add u _57_944)))

let single_uvt = (fun u -> (let _57_952 = (FStar_Absyn_Syntax.new_uvt_set ())
in (FStar_Util.set_add u _57_952)))
...
(let _57_1067 = (let _57_1066 = (let _27_1490 = FStar_Absyn_Syntax.no_fvs
in (let _57_1065 = (single_fv a)
in {FStar_Absyn_Syntax.ftvs = _57_1065; FStar_Absyn_Syntax.fxvs = _27_1490.FStar_Absyn_Syntax.fxvs}))
in (_57_1066, FStar_Absyn_Syntax.no_uvs))
in (cont _57_1067))
end
end
| FStar_Absyn_Syntax.Typ_uvar (uv, k) -> begin
(let _57_1070 = (let _57_1069 = (let _27_1496 = FStar_Absyn_Syntax.no_uvs
in (let _57_1068 = (single_uvt (uv, k))
in {FStar_Absyn_Syntax.uvars_k = _27_1496.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _57_1068; FStar_Absyn_Syntax.uvars_e = _27_1496.FStar_Absyn_Syntax.uvars_e}))
in (FStar_Absyn_Syntax.no_fvs, _57_1069))
in (cont _57_1070))
end
...
| (bvs, vs1) -> begin
(vs_comp c uvonly (fun vs2 -> (let _57_1074 = (let _57_1073 = (union_fvs_uvs vs1 vs2)
in (sub_fv _57_1073 bvs))
in (cont _57_1074))))
end)))
end
| FStar_Absyn_Syntax.Typ_lam (bs, t) -> begin
...
| (bvs, vs1) -> begin
(vs_typ t uvonly (fun vs2 -> (let _57_1078 = (let _57_1077 = (union_fvs_uvs vs1 vs2)
in (sub_fv _57_1077 bvs))
in (cont _57_1078))))
end)))
end
| FStar_Absyn_Syntax.Typ_refine (x, t) -> begin
...
| (bvs, vs1) -> begin
(vs_typ t uvonly (fun vs2 -> (let _57_1082 = (let _57_1081 = (union_fvs_uvs vs1 vs2)
in (sub_fv _57_1081 bvs))
in (cont _57_1082))))
end)))
end
| FStar_Absyn_Syntax.Typ_app (t, args) -> begin
(vs_typ t uvonly (fun vs1 -> (vs_args args uvonly (fun vs2 -> (let _57_1085 = (union_fvs_uvs vs1 vs2)
in (cont _57_1085))))))
end
...
(vs_typ t1 uvonly (fun vs1 -> (vs_typ t2 uvonly (fun vs2 -> (let _57_1088 = (union_fvs_uvs vs1 vs2)
in (cont _57_1088))))))
end
...
(let _57_1125 = (let _57_1124 = (let _57_1122 = (FStar_Util.set_add a tvars)
in (_57_1122, vvars))
in (let _57_1123 = (union_fvs_uvs vs vs2)
in (_57_1124, _57_1123)))
in (cont _57_1125))
end)))))
end
...
| ((tvars, vvars), vs2) -> begin
(let _57_1149 = (let _57_1148 = (let _57_1146 = (FStar_Util.set_add x vvars)
in (tvars, _57_1146))
in (let _57_1147 = (union_fvs_uvs vs vs2)
in (_57_1148, _57_1147)))
in (cont _57_1149))
end)))))
end))
...
(vs_typ t uvonly (fun ft1 -> (vs_args tl uvonly (fun ft2 -> (let _57_1153 = (union_fvs_uvs ft1 ft2)
in (cont _57_1153))))))
end
| (FStar_Util.Inr (e), _27_1622)::tl -> begin
(vs_exp e uvonly (fun ft1 -> (vs_args tl uvonly (fun ft2 -> (let _57_1156 = (union_fvs_uvs ft1 ft2)
in (cont _57_1156))))))
end))
and vs_typ = (fun t uvonly cont -> (match ((let _57_1159 = (FStar_ST.read t.FStar_Absyn_Syntax.fvs)
in (let _57_1158 = (FStar_ST.read t.FStar_Absyn_Syntax.uvs)
in (_57_1159, _57_1158)))) with
...
(let _57_1164 = (let _57_1163 = (FStar_Range.string_of_range k.FStar_Absyn_Syntax.pos)
in (FStar_Util.format1 "%s: Impossible ... found a Kind_lam bare" _57_1163))
in (FStar_All.failwith _57_1164))
end
...
| (fvs, uvs) -> begin
(let _57_1168 = (let _57_1167 = (let _27_1677 = uvs
in (let _57_1166 = (FStar_Util.set_add uv uvs.FStar_Absyn_Syntax.uvars_k)
in {FStar_Absyn_Syntax.uvars_k = _57_1166; FStar_Absyn_Syntax.uvars_t = _27_1677.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _27_1677.FStar_Absyn_Syntax.uvars_e}))
in (fvs, _57_1167))
in (cont _57_1168))
end)))
end
...
| (bvs, vs1) -> begin
(vs_kind k uvonly (fun vs2 -> (let _57_1172 = (let _57_1171 = (union_fvs_uvs vs1 vs2)
in (sub_fv _57_1171 bvs))
in (cont _57_1172))))
end)))
end)))
and vs_kind = (fun k uvonly cont -> (match ((let _57_1175 = (FStar_ST.read k.FStar_Absyn_Syntax.fvs)
in (let _57_1174 = (FStar_ST.read k.FStar_Absyn_Syntax.uvs)
in (_57_1175, _57_1174)))) with
...
(let _57_1181 = (let _57_1180 = (let _27_1737 = FStar_Absyn_Syntax.no_uvs
in (let _57_1179 = (single_uvt (uv, t))
in {FStar_Absyn_Syntax.uvars_k = _27_1737.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _27_1737.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _57_1179}))
in (FStar_Absyn_Syntax.no_fvs, _57_1180))
in (cont _57_1181))
end
| FStar_Absyn_Syntax.Exp_bvar (x) -> begin
if uvonly then begin
...
(let _57_1184 = (let _57_1183 = (let _27_1741 = FStar_Absyn_Syntax.no_fvs
in (let _57_1182 = (single_fv x)
in {FStar_Absyn_Syntax.ftvs = _27_1741.FStar_Absyn_Syntax.ftvs; FStar_Absyn_Syntax.fxvs = _57_1182}))
in (_57_1183, FStar_Absyn_Syntax.no_uvs))
in (cont _57_1184))
end
end
...
| (bvs, vs1) -> begin
(vs_exp e uvonly (fun vs2 -> (let _57_1188 = (let _57_1187 = (union_fvs_uvs vs1 vs2)
in (sub_fv _57_1187 bvs))
in (cont _57_1188))))
end)))
end
| FStar_Absyn_Syntax.Exp_app (e, args) -> begin
(vs_exp e uvonly (fun ft1 -> (vs_args args uvonly (fun ft2 -> (let _57_1191 = (union_fvs_uvs ft1 ft2)
in (cont _57_1191))))))
end
...
and vs_exp = (fun e uvonly cont -> (match ((let _57_1194 = (FStar_ST.read e.FStar_Absyn_Syntax.fvs)
in (let _57_1193 = (FStar_ST.read e.FStar_Absyn_Syntax.uvs)
in (_57_1194, _57_1193)))) with
...
(vs_typ ct.FStar_Absyn_Syntax.result_typ uvonly (fun vs1 -> (vs_args ct.FStar_Absyn_Syntax.effect_args uvonly (fun vs2 -> (let _57_1200 = (union_fvs_uvs vs1 vs2)
in (k _57_1200))))))
end
end))
and vs_comp = (fun c uvonly cont -> (match ((let _57_1203 = (FStar_ST.read c.FStar_Absyn_Syntax.fvs)
in (let _57_1202 = (FStar_ST.read c.FStar_Absyn_Syntax.uvs)
in (_57_1203, _57_1202)))) with
...
| hd::tl -> begin
(vs_either hd uvonly (fun ft1 -> (vs_either_l tl uvonly (fun ft2 -> (let _57_1210 = (union_fvs_uvs ft1 ft2)
in (cont _57_1210))))))
end))
...
| FStar_Util.Inl (t) -> begin
(let _57_1226 = (freevars_typ t)
in (FStar_All.pipe_left (union_fvs out) _57_1226))
end
| FStar_Util.Inr (e) -> begin
(let _57_1227 = (freevars_exp e)
in (FStar_All.pipe_left (union_fvs out) _57_1227))
...
let rec update_uvars = (fun s uvs -> (let out = (let _57_1301 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_k)
in (FStar_All.pipe_right _57_1301 (FStar_List.fold_left (fun out u -> (match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (k) -> begin
(let _57_1299 = (uvars_in_kind k)
in (union_uvs _57_1299 out))
end
| _27_1911 -> begin
(let _27_1912 = out
in (let _57_1300 = (FStar_Util.set_add u out.FStar_Absyn_Syntax.uvars_k)
in {FStar_Absyn_Syntax.uvars_k = _57_1300; FStar_Absyn_Syntax.uvars_t = _27_1912.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _27_1912.FStar_Absyn_Syntax.uvars_e}))
end)) FStar_Absyn_Syntax.no_uvs)))
in (let out = (let _57_1306 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_t)
in (FStar_All.pipe_right _57_1306 (FStar_List.fold_left (fun out _27_1918 -> (match (_27_1918) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (t) -> begin
(let _57_1304 = (uvars_in_typ t)
in (union_uvs _57_1304 out))
end
| _27_1922 -> begin
(let _27_1923 = out
in (let _57_1305 = (FStar_Util.set_add (u, t) out.FStar_Absyn_Syntax.uvars_t)
in {FStar_Absyn_Syntax.uvars_k = _27_1923.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _57_1305; FStar_Absyn_Syntax.uvars_e = _27_1923.FStar_Absyn_Syntax.uvars_e}))
end)
end)) out)))
in (let out = (let _57_1311 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_e)
in (FStar_All.pipe_right _57_1311 (FStar_List.fold_left (fun out _27_1929 -> (match (_27_1929) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (e) -> begin
(let _57_1309 = (uvars_in_exp e)
in (union_uvs _57_1309 out))
end
| _27_1933 -> begin
(let _27_1934 = out
in (let _57_1310 = (FStar_Util.set_add (u, t) out.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _27_1934.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _27_1934.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _57_1310}))
end)
end)) out)))
...
in out)))))
and uvars_in_kind = (fun k -> (let _57_1314 = (vs_kind k true (fun _27_1951 -> (match (_27_1951) with
| (_27_1949, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumKind (k))) _57_1314)))
and uvars_in_typ = (fun t -> (let _57_1317 = (vs_typ t true (fun _27_1956 -> (match (_27_1956) with
| (_27_1954, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumType (t))) _57_1317)))
and uvars_in_exp = (fun e -> (let _57_1320 = (vs_exp e true (fun _27_1961 -> (match (_27_1961) with
| (_27_1959, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumExp (e))) _57_1320)))
and uvars_in_comp = (fun c -> (let _57_1323 = (vs_comp c true (fun _27_1966 -> (match (_27_1966) with
| (_27_1964, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumComp (c))) _57_1323)))
...
| _27_2028 -> begin
(let _57_1344 = (FStar_Absyn_Syntax.mk_Total t)
in (tps, _57_1344))
end)
...
let mk_tuple_lid = (fun n r -> (let t = (let _57_1357 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Tuple%s" _57_1357))
in (let _57_1358 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _57_1358 r))))

let mk_tuple_data_lid = (fun n r -> (let t = (let _57_1363 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "MkTuple%s" _57_1363))
in (let _57_1364 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _57_1364 r))))

let is_tuple_data_lid = (fun f n -> (let _57_1369 = (mk_tuple_data_lid n FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Syntax.lid_equals f _57_1369)))
...
let mk_dtuple_lid = (fun n r -> (let t = (let _57_1376 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "DTuple%s" _57_1376))
in (let _57_1377 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _57_1377 r))))

let mk_dtuple_data_lid = (fun n r -> (let t = (let _57_1382 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "MkDTuple%s" _57_1382))
in (let _57_1383 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _57_1383 r))))
...
let is_constructor = (fun t lid -> (match ((let _57_1399 = (pre_typ t)
in _57_1399.FStar_Absyn_Syntax.n)) with
...
let rec is_constructed_typ = (fun t lid -> (match ((let _57_1404 = (pre_typ t)
in _57_1404.FStar_Absyn_Syntax.n)) with
...
let b2t_v = (let _57_1415 = (let _57_1414 = (let _57_1413 = (let _57_1412 = (FStar_All.pipe_left FStar_Absyn_Syntax.null_v_binder t_bool)
in (_57_1412)::[])
in (_57_1413, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _57_1414 FStar_Absyn_Syntax.dummyRange))
in (ftv FStar_Absyn_Const.b2t_lid _57_1415))
...
| Some (phi1) -> begin
(let _57_1421 = (let _57_1420 = (FStar_Range.union_ranges phi1.FStar_Absyn_Syntax.pos phi2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app (tand, ((FStar_Absyn_Syntax.targ phi1))::((FStar_Absyn_Syntax.targ phi2))::[]) None _57_1420))
in Some (_57_1421))
end))

let mk_binop = (fun op_t phi1 phi2 -> (let _57_1428 = (FStar_Range.union_ranges phi1.FStar_Absyn_Syntax.pos phi2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app (op_t, ((FStar_Absyn_Syntax.targ phi1))::((FStar_Absyn_Syntax.targ phi2))::[]) None _57_1428)))

let mk_neg = (fun phi -> (let _57_1432 = (let _57_1431 = (ftv FStar_Absyn_Const.not_lid kt_kt)
in (_57_1431, ((FStar_Absyn_Syntax.targ phi))::[]))
in (FStar_Absyn_Syntax.mk_Typ_app _57_1432 None phi.FStar_Absyn_Syntax.pos)))
...
let mk_imp = (fun phi1 phi2 -> (match ((let _57_1449 = (compress_typ phi1)
in _57_1449.FStar_Absyn_Syntax.n)) with
...
| _27_2145 -> begin
(match ((let _57_1450 = (compress_typ phi2)
in _57_1450.FStar_Absyn_Syntax.n)) with
...
let b2t = (fun e -> (let _57_1459 = (let _57_1458 = (let _57_1457 = (FStar_All.pipe_left FStar_Absyn_Syntax.varg e)
in (_57_1457)::[])
in (b2t_v, _57_1458))
in (FStar_Absyn_Syntax.mk_Typ_app _57_1459 None e.FStar_Absyn_Syntax.pos)))
...
let eq_k = (let a = (let _57_1462 = (new_bvd None)
in (bvd_to_bvar_s _57_1462 FStar_Absyn_Syntax.ktype))
in (let atyp = (btvar_to_typ a)
in (let b = (let _57_1463 = (new_bvd None)
in (bvd_to_bvar_s _57_1463 FStar_Absyn_Syntax.ktype))
...
| _27_2212 -> begin
(let _57_1472 = (FStar_Range.union_ranges e1.FStar_Absyn_Syntax.pos e2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app (teq, ((FStar_Absyn_Syntax.itarg t1))::((FStar_Absyn_Syntax.itarg t2))::((FStar_Absyn_Syntax.varg e1))::((FStar_Absyn_Syntax.varg e2))::[]) None _57_1472))
end))

let eq_typ = (ftv FStar_Absyn_Const.eqT_lid FStar_Absyn_Syntax.kun)

let mk_eq_typ = (fun t1 t2 -> (let _57_1477 = (FStar_Range.union_ranges t1.FStar_Absyn_Syntax.pos t2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app (eq_typ, ((FStar_Absyn_Syntax.targ t1))::((FStar_Absyn_Syntax.targ t2))::[]) None _57_1477)))
...
in (let lexcons = (let _57_1484 = (let _57_1483 = (let _57_1482 = (let _57_1480 = (let _57_1479 = (let _57_1478 = (btvar_to_typ a)
in (FStar_Absyn_Syntax.null_v_binder _57_1478))
in (_57_1479)::((FStar_Absyn_Syntax.null_v_binder lex_t))::[])
in ((FStar_Absyn_Syntax.t_binder a))::_57_1480)
in (let _57_1481 = (FStar_Absyn_Syntax.mk_Total lex_t)
in (_57_1482, _57_1481)))
in (FStar_Absyn_Syntax.mk_Typ_fun _57_1483 None FStar_Absyn_Syntax.dummyRange))
in (withinfo FStar_Absyn_Const.lexcons_lid _57_1484 FStar_Absyn_Syntax.dummyRange))
in (FStar_Absyn_Syntax.mk_Exp_fvar (lexcons, Some (FStar_Absyn_Syntax.Data_ctor)) None FStar_Absyn_Syntax.dummyRange)))

let forall_kind = (let a = (let _57_1485 = (new_bvd None)
in (bvd_to_bvar_s _57_1485 FStar_Absyn_Syntax.ktype))
in (let atyp = (btvar_to_typ a)
in (let _57_1490 = (let _57_1489 = (let _57_1488 = (let _57_1487 = (let _57_1486 = (FStar_Absyn_Syntax.mk_Kind_arrow (((FStar_Absyn_Syntax.null_v_binder atyp))::[], FStar_Absyn_Syntax.ktype) FStar_Absyn_Syntax.dummyRange)
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder _57_1486))
in (_57_1487)::[])
in ((FStar_Util.Inl (a), Some (FStar_Absyn_Syntax.Implicit)))::_57_1488)
in (_57_1489, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _57_1490 FStar_Absyn_Syntax.dummyRange))))

let tforall = (ftv FStar_Absyn_Const.forall_lid forall_kind)

let allT_k = (fun k -> (let _57_1496 = (let _57_1495 = (let _57_1494 = (let _57_1493 = (FStar_Absyn_Syntax.mk_Kind_arrow (((FStar_Absyn_Syntax.null_t_binder k))::[], FStar_Absyn_Syntax.ktype) FStar_Absyn_Syntax.dummyRange)
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder _57_1493))
in (_57_1494)::[])
in (_57_1495, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _57_1496 FStar_Absyn_Syntax.dummyRange)))

let eqT_k = (fun k -> (let _57_1501 = (let _57_1500 = (let _57_1499 = (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder k)
in (_57_1499)::((FStar_Absyn_Syntax.null_t_binder k))::[])
in (_57_1500, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _57_1501 FStar_Absyn_Syntax.dummyRange)))

let tforall_typ = (fun k -> (let _57_1504 = (allT_k k)
in (ftv FStar_Absyn_Const.allTyp_lid _57_1504)))

let mk_forallT = (fun a b -> (let _57_1513 = (let _57_1512 = (tforall_typ a.FStar_Absyn_Syntax.sort)
in (let _57_1511 = (let _57_1510 = (let _57_1509 = (FStar_Absyn_Syntax.mk_Typ_lam (((FStar_Absyn_Syntax.t_binder a))::[], b) None b.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _57_1509))
in (_57_1510)::[])
in (_57_1512, _57_1511)))
in (FStar_Absyn_Syntax.mk_Typ_app _57_1513 None b.FStar_Absyn_Syntax.pos)))

let mk_forall = (fun x body -> (let r = FStar_Absyn_Syntax.dummyRange
in (let _57_1521 = (let _57_1520 = (let _57_1519 = (let _57_1518 = (FStar_Absyn_Syntax.mk_Typ_lam (((FStar_Absyn_Syntax.v_binder x))::[], body) None r)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _57_1518))
in (_57_1519)::[])
in (tforall, _57_1520))
in (FStar_Absyn_Syntax.mk_Typ_app _57_1521 None r))))
...
| FStar_Util.Inl (a) -> begin
(let _57_1529 = (let _57_1528 = (tforall_typ a.FStar_Absyn_Syntax.sort)
in (_57_1528, ((FStar_Absyn_Syntax.targ body))::[]))
in (FStar_Absyn_Syntax.mk_Typ_app _57_1529 None f.FStar_Absyn_Syntax.pos))
end
| FStar_Util.Inr (x) -> begin
...
(let _57_1593 = (compress_typ t)
in (pats, _57_1593))
end
| _27_2320 -> begin
(let _57_1594 = (compress_typ t)
in ([], _57_1594))
end)))
...
| (t, args) -> begin
(let _57_1608 = (FStar_All.pipe_right args (FStar_List.map (fun _27_26 -> (match (_27_26) with
| (FStar_Util.Inl (t), imp) -> begin
(let _57_1605 = (let _57_1604 = (compress_typ t)
in FStar_Util.Inl (_57_1604))
in (_57_1605, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _57_1607 = (let _57_1606 = (compress_exp e)
in FStar_Util.Inr (_57_1606))
in (_57_1607, imp))
end))))
in (t, _57_1608))
end)))
in (let rec aux = (fun qopt out t -> (match ((let _57_1615 = (flat t)
in (qopt, _57_1615))) with
