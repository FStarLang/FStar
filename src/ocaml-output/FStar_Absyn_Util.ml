...
(let _26_38 = (let _92_9 = (FStar_Util.format1 "Feature not yet implemented: %s" s)
...
| () -> begin
(let _92_38 = (let _92_35 = (let _92_34 = (let _92_33 = (FStar_ST.read n_resets)
in (FStar_Util.string_of_int _92_33))
in (Prims.strcat "_" _92_34))
in (Prims.strcat _92_35 "_"))
in (let _92_37 = (let _92_36 = (let _26_62 = (FStar_Util.incr ctr)
in (FStar_ST.read ctr))
in (FStar_Util.string_of_int _92_36))
in (Prims.strcat _92_38 _92_37)))
...
let freshen_bvd = (fun bvd' -> (let _92_88 = (let _92_87 = (genident (Some ((range_of_bvd bvd'))))
in (bvd'.FStar_Absyn_Syntax.ppname, _92_87))
in (mkbvd _92_88)))

let freshen_bvar = (fun b -> (let _92_90 = (freshen_bvd b.FStar_Absyn_Syntax.v)
in (bvd_to_bvar_s _92_90 b.FStar_Absyn_Syntax.sort)))
...
let set_bvd_range = (fun bvd r -> (let _92_99 = (FStar_Absyn_Syntax.mk_ident (bvd.FStar_Absyn_Syntax.ppname.FStar_Absyn_Syntax.idText, r))
in (let _92_98 = (FStar_Absyn_Syntax.mk_ident (bvd.FStar_Absyn_Syntax.realname.FStar_Absyn_Syntax.idText, r))
in {FStar_Absyn_Syntax.ppname = _92_99; FStar_Absyn_Syntax.realname = _92_98})))
...
let fv = (fun l -> (let _92_107 = (FStar_Absyn_Syntax.range_of_lid l)
in (withinfo l FStar_Absyn_Syntax.tun _92_107)))

let fvvar_of_lid = (fun l t -> (let _92_110 = (FStar_Absyn_Syntax.range_of_lid l)
in (withinfo l t _92_110)))

let fvar = (fun dc l r -> (let _92_119 = (let _92_118 = (let _92_117 = (set_lid_range l r)
in (fv _92_117))
in (_92_118, dc))
in (FStar_Absyn_Syntax.mk_Exp_fvar _92_119 None r)))

let ftv = (fun l k -> (let _92_126 = (let _92_124 = (FStar_Absyn_Syntax.range_of_lid l)
in (withinfo l k _92_124))
in (let _92_125 = (FStar_Absyn_Syntax.range_of_lid l)
in (FStar_Absyn_Syntax.mk_Typ_const _92_126 None _92_125))))
...
(let _92_131 = (let _92_130 = (btvar_to_typ a)
in FStar_Util.Inl (_92_130))
in (_92_131, imp))
end
| FStar_Util.Inr (x) -> begin
(let _92_133 = (let _92_132 = (bvar_to_exp x)
in FStar_Util.Inr (_92_132))
in (_92_133, imp))
end)
end))
...
in FStar_Util.Inl (_92_141))
in (_92_142, (Prims.snd b)))
end
| FStar_Util.Inr (x) -> begin
(let _92_144 = (let _92_143 = (gen_bvar x.FStar_Absyn_Syntax.sort)
...
(let b = (let _92_153 = (let _92_152 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _92_152))
in (FStar_Absyn_Syntax.id_of_text _92_153))
in (let b = (bvd_to_bvar_s (mkbvd (b, b)) a.FStar_Absyn_Syntax.sort)
in (FStar_Util.Inl (b), imp)))
end
| (FStar_Util.Inr (y), imp) -> begin
(let x = (let _92_155 = (let _92_154 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _92_154))
in (FStar_Absyn_Syntax.id_of_text _92_155))
...
(let _92_159 = (let _92_158 = (name_binders binders)
in (_92_158, comp))
in (FStar_Absyn_Syntax.mk_Typ_fun _92_159 None t.FStar_Absyn_Syntax.pos))
end
| _26_215 -> begin
t
end))
...
(let _92_164 = (let _92_163 = (FStar_Absyn_Syntax.null_t_binder k)
in (FStar_All.pipe_left Prims.fst _92_163))
in (_92_164, imp))
end
| (FStar_Util.Inr (t), imp) -> begin
(let _92_166 = (let _92_165 = (FStar_Absyn_Syntax.null_v_binder t)
in (FStar_All.pipe_left Prims.fst _92_165))
in (_92_166, imp))
end)))))

let binders_of_tks = (fun tks -> (FStar_All.pipe_right tks (FStar_List.map (fun _26_3 -> (match (_26_3) with
| (FStar_Util.Inl (k), imp) -> begin
(let _92_171 = (let _92_170 = (gen_bvar_p k.FStar_Absyn_Syntax.pos k)
in FStar_Util.Inl (_92_170))
in (_92_171, imp))
end
| (FStar_Util.Inr (t), imp) -> begin
(let _92_173 = (let _92_172 = (gen_bvar_p t.FStar_Absyn_Syntax.pos t)
in FStar_Util.Inr (_92_172))
in (_92_173, imp))
end)))))

let binders_of_freevars = (fun fvs -> (let _92_179 = (let _92_176 = (FStar_Util.set_elements fvs.FStar_Absyn_Syntax.ftvs)
in (FStar_All.pipe_right _92_176 (FStar_List.map FStar_Absyn_Syntax.t_binder)))
in (let _92_178 = (let _92_177 = (FStar_Util.set_elements fvs.FStar_Absyn_Syntax.fxvs)
in (FStar_All.pipe_right _92_177 (FStar_List.map FStar_Absyn_Syntax.v_binder)))
in (FStar_List.append _92_179 _92_178))))

let subst_to_string = (fun s -> (let _92_182 = (FStar_All.pipe_right s (FStar_List.map (fun _26_4 -> (match (_26_4) with
...
in (FStar_All.pipe_right _92_182 (FStar_String.concat ", "))))
...
(let _92_207 = (let _92_206 = (compose_subst s' s)
in (let _92_205 = (FStar_Util.mk_ref None)
in (t', _92_206, _92_205)))
in (FStar_Absyn_Syntax.mk_Typ_delayed _92_207 None t.FStar_Absyn_Syntax.pos))
end
...
| _26_311 -> begin
(let _92_212 = (let _92_211 = (FStar_Util.mk_ref None)
in (t0, s, _92_211))
in (FStar_Absyn_Syntax.mk_Typ_delayed _92_212 None t.FStar_Absyn_Syntax.pos))
end))
end))
...
(let _92_217 = (let _92_216 = (compose_subst s' s)
in (let _92_215 = (FStar_Util.mk_ref None)
in (e, _92_216, _92_215)))
in (FStar_Absyn_Syntax.mk_Exp_delayed _92_217 None e.FStar_Absyn_Syntax.pos))
end
...
| _26_345 -> begin
(let _92_221 = (let _92_220 = (FStar_Util.mk_ref None)
in (e0, s, _92_220))
in (FStar_Absyn_Syntax.mk_Exp_delayed _92_221 None e0.FStar_Absyn_Syntax.pos))
end))
end))
...
(let _92_226 = (let _92_225 = (compose_subst s' s)
in (let _92_224 = (FStar_Util.mk_ref None)
in (k, _92_225, _92_224)))
in (FStar_Absyn_Syntax.mk_Kind_delayed _92_226 k0.FStar_Absyn_Syntax.pos))
end
| _26_363 -> begin
(let _92_228 = (let _92_227 = (FStar_Util.mk_ref None)
in (k0, s, _92_227))
in (FStar_Absyn_Syntax.mk_Kind_delayed _92_228 k0.FStar_Absyn_Syntax.pos))
end))
end))
...
(let _92_232 = (subst_exp' s a)
in FStar_Absyn_Syntax.DECREASES (_92_232))
end
| f -> begin
f
end)))))
...
| _26_376 -> begin
(let _26_377 = t
in (let _92_242 = (subst_typ' s t.FStar_Absyn_Syntax.result_typ)
in (let _92_241 = (FStar_List.map (fun _26_8 -> (match (_26_8) with
| (FStar_Util.Inl (t), imp) -> begin
(let _92_237 = (let _92_236 = (subst_typ' s t)
in FStar_Util.Inl (_92_236))
in (_92_237, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _92_239 = (let _92_238 = (subst_exp' s e)
in FStar_Util.Inr (_92_238))
in (_92_239, imp))
end)) t.FStar_Absyn_Syntax.effect_args)
in (let _92_240 = (subst_flags' s t.FStar_Absyn_Syntax.flags)
in {FStar_Absyn_Syntax.effect_name = _26_377.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = _92_242; FStar_Absyn_Syntax.effect_args = _92_241; FStar_Absyn_Syntax.flags = _92_240}))))
end))
...
(let _92_245 = (subst_typ' s t)
in (FStar_Absyn_Syntax.mk_Total _92_245))
end
| FStar_Absyn_Syntax.Comp (ct) -> begin
(let _92_246 = (subst_comp_typ' s ct)
in (FStar_Absyn_Syntax.mk_Comp _92_246))
end)
end))
...
| (FStar_Util.Inl (a), imp) -> begin
(let _92_274 = (let _92_273 = (let _26_418 = a
in (let _92_272 = (subst_kind s a.FStar_Absyn_Syntax.sort)
in {FStar_Absyn_Syntax.v = _26_418.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _92_272; FStar_Absyn_Syntax.p = _26_418.FStar_Absyn_Syntax.p}))
in FStar_Util.Inl (_92_273))
in (_92_274, imp))
end
| (FStar_Util.Inr (x), imp) -> begin
(let _92_277 = (let _92_276 = (let _26_424 = x
in (let _92_275 = (subst_typ s x.FStar_Absyn_Syntax.sort)
in {FStar_Absyn_Syntax.v = _26_424.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _92_275; FStar_Absyn_Syntax.p = _26_424.FStar_Absyn_Syntax.p}))
in FStar_Util.Inr (_92_276))
in (_92_277, imp))
end))

let subst_arg = (fun s _26_10 -> (match (_26_10) with
| (FStar_Util.Inl (t), imp) -> begin
(let _92_281 = (let _92_280 = (subst_typ s t)
in FStar_Util.Inl (_92_280))
in (_92_281, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _92_283 = (let _92_282 = (subst_exp s e)
in FStar_Util.Inr (_92_282))
in (_92_283, imp))
end))
...
| (b1::bs1, b2::bs2) -> begin
(let _92_313 = (let _92_312 = (mk_subst_one_binder b1 b2)
in (FStar_List.append _92_312 out))
in (aux _92_313 bs1 bs2))
end
| _26_503 -> begin
None
end))
...
let map_knd = (fun s vk mt me descend binders k -> (let _92_334 = (subst_kind' s k)
in (_92_334, descend)))

let map_typ = (fun s mk vt me descend binders t -> (let _92_342 = (subst_typ' s t)
in (_92_342, descend)))

let map_exp = (fun s mk me ve descend binders e -> (let _92_350 = (subst_exp' s e)
in (_92_350, descend)))
...
(let _92_367 = (let _92_366 = (map_exp descend binders e)
in (FStar_All.pipe_right _92_366 Prims.fst))
in FStar_Absyn_Syntax.DECREASES (_92_367))
end
| f -> begin
f
end)))))
...
| (t, descend) -> begin
(let _92_390 = (FStar_Absyn_Syntax.mk_Total t)
in (_92_390, descend))
end))
end
| FStar_Absyn_Syntax.Comp (ct) -> begin
...
| (args, descend) -> begin
(let _92_393 = (let _92_392 = (let _26_561 = ct
in (let _92_391 = (map_flags s map_exp descend binders ct.FStar_Absyn_Syntax.flags)
in {FStar_Absyn_Syntax.effect_name = _26_561.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = args; FStar_Absyn_Syntax.flags = _92_391}))
in (FStar_Absyn_Syntax.mk_Comp _92_392))
in (_92_393, descend))
end))
end))
end))
...
| FStar_Absyn_Syntax.Kind_delayed (k', s, m) -> begin
(let k' = (let _92_439 = (FStar_Absyn_Visit.reduce_kind (visit_knd s) (map_typ s) (map_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp subst_ctrl [] k')
in (FStar_All.pipe_left Prims.fst _92_439))
...
(let _92_441 = (let _92_440 = (subst_of_list formals actuals)
in (subst_kind _92_440 k'))
in (compress_kind _92_441))
end
| _26_597 -> begin
...
| _26_631 -> begin
(let b = (let _92_518 = (freshen_bvd a.FStar_Absyn_Syntax.v)
in (bvd_to_bvar_s _92_518 k))
in (let s = (let _92_521 = (let _92_520 = (let _92_519 = (btvar_to_typ b)
in (a.FStar_Absyn_Syntax.v, _92_519))
in FStar_Util.Inl (_92_520))
in (extend_subst _92_521 s))
...
| _26_652 -> begin
(let y = (let _92_531 = (freshen_bvd x.FStar_Absyn_Syntax.v)
in (bvd_to_bvar_s _92_531 t))
in (let s = (let _92_534 = (let _92_533 = (let _92_532 = (bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _92_532))
in FStar_Util.Inr (_92_533))
in (extend_subst _92_534 s))
...
(let _92_545 = (let _92_544 = (map_typ s mk vt me null_ctrl boundvars t)
in (FStar_All.pipe_left Prims.fst _92_544))
in FStar_Util.Inl (_92_545))
end
| (_26_673, FStar_Util.Inr (c)) -> begin
(let _92_568 = (let _92_567 = (map_comp s mk (map_typ s mk vt me) (map_exp s mk vt me) null_ctrl boundvars c)
in (FStar_All.pipe_left Prims.fst _92_567))
in FStar_Util.Inr (_92_568))
end)
...
(let _92_570 = (let _92_569 = (subst_typ' s t0)
in (FStar_All.pipe_left compress_typ _92_569))
in (_92_570, ctrl))
end
...
(let _92_580 = (FStar_Absyn_Syntax.mk_Typ_fun (bs, c) None t0.FStar_Absyn_Syntax.pos)
in (_92_580, ctrl))
end
| _26_693 -> begin
...
(let _92_581 = (FStar_Absyn_Syntax.mk_Typ_refine (x, t) None t0.FStar_Absyn_Syntax.pos)
in (_92_581, ctrl))
end
| _26_708 -> begin
(FStar_All.failwith "Impossible")
...
(let _92_582 = (FStar_Absyn_Syntax.mk_Typ_lam (bs, t) None t0.FStar_Absyn_Syntax.pos)
in (_92_582, ctrl))
end
| _26_718 -> begin
(FStar_All.failwith "Impossible")
...
| FStar_Absyn_Syntax.Typ_delayed (FStar_Util.Inl (t', s), m) -> begin
(let res = (let _92_602 = (FStar_Absyn_Visit.reduce_typ (map_knd s) (visit_typ s) (map_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp subst_ctrl [] t')
in (FStar_All.pipe_left Prims.fst _92_602))
in (let res = (compress_typ' res)
in (let _26_736 = (FStar_ST.op_Colon_Equals m (Some (res)))
in res)))
end
| FStar_Absyn_Syntax.Typ_delayed (FStar_Util.Inr (mk_t), m) -> begin
(let t = (let _92_604 = (mk_t ())
in (compress_typ' _92_604))
...
(let _92_670 = (let _92_669 = (subst_exp' s e)
in (FStar_All.pipe_left compress_exp _92_669))
in (_92_670, ctrl))
end
...
in (match (e.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_delayed (e', s, m) -> begin
(let e = (let _92_699 = (FStar_Absyn_Visit.reduce_exp (map_knd s) (map_typ s) (visit_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp subst_ctrl [] e')
in (FStar_All.pipe_left Prims.fst _92_699))
...
in (let s = (mk_subst [])
in (let doit = (fun t -> (let _92_724 = (FStar_Absyn_Visit.reduce_typ (map_knd s) (visit_typ s) (map_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp alpha_ctrl [] t)
in (FStar_All.pipe_left Prims.fst _92_724)))
in (match (t.FStar_Absyn_Syntax.n) with
...
| Some (t) -> begin
(let _92_731 = (compress_typ t)
in Some (_92_731))
end))

let mk_discriminator = (fun lid -> (let _92_736 = (let _92_735 = (let _92_734 = (FStar_Absyn_Syntax.mk_ident ((Prims.strcat "is_" lid.FStar_Absyn_Syntax.ident.FStar_Absyn_Syntax.idText), lid.FStar_Absyn_Syntax.ident.FStar_Absyn_Syntax.idRange))
in (_92_734)::[])
in (FStar_List.append lid.FStar_Absyn_Syntax.ns _92_735))
in (FStar_Absyn_Syntax.lid_of_ids _92_736)))

let is_name = (fun lid -> (let c = (FStar_Util.char_at lid.FStar_Absyn_Syntax.ident.FStar_Absyn_Syntax.idText 0)
in (FStar_Util.is_upper c)))

let ml_comp = (fun t r -> (let _92_744 = (let _92_743 = (set_lid_range FStar_Absyn_Const.effect_ML_lid r)
in {FStar_Absyn_Syntax.effect_name = _92_743; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = []; FStar_Absyn_Syntax.flags = (FStar_Absyn_Syntax.MLEFFECT)::[]})
in (FStar_Absyn_Syntax.mk_Comp _92_744)))
...
let is_pure_or_ghost_function = (fun t -> (match ((let _92_783 = (compress_typ t)
in _92_783.FStar_Absyn_Syntax.n)) with
...
let is_lemma = (fun t -> (match ((let _92_786 = (compress_typ t)
in _92_786.FStar_Absyn_Syntax.n)) with
...
let is_smt_lemma = (fun t -> (match ((let _92_789 = (compress_typ t)
in _92_789.FStar_Absyn_Syntax.n)) with
...
(match ((let _92_790 = (unmeta_exp pats)
...
let rec is_atom = (fun e -> (match ((let _92_800 = (compress_exp e)
in _92_800.FStar_Absyn_Syntax.n)) with
...
let is_fun = (fun e -> (match ((let _92_814 = (compress_exp e)
in _92_814.FStar_Absyn_Syntax.n)) with
...
let is_function_typ = (fun t -> (match ((let _92_817 = (compress_typ t)
in _92_817.FStar_Absyn_Syntax.n)) with
...
| [] -> begin
(let _92_851 = (let _92_850 = (let _92_849 = (let _92_848 = (FStar_Absyn_Syntax.range_of_lid l)
in (fvar (Some (FStar_Absyn_Syntax.Data_ctor)) l _92_848))
in (_92_849, FStar_Absyn_Syntax.Data_app))
in FStar_Absyn_Syntax.Meta_desugared (_92_850))
in (FStar_Absyn_Syntax.mk_Exp_meta _92_851))
end
| _26_1393 -> begin
(let _92_856 = (let _92_855 = (let _92_854 = (let _92_853 = (let _92_852 = (FStar_Absyn_Syntax.range_of_lid l)
in (fvar (Some (FStar_Absyn_Syntax.Data_ctor)) l _92_852))
in (mk_exp_app _92_853 args))
in (_92_854, FStar_Absyn_Syntax.Data_app))
in FStar_Absyn_Syntax.Meta_desugared (_92_855))
in (FStar_Absyn_Syntax.mk_Exp_meta _92_856))
end))
...
in (let _92_873 = (let _92_872 = (let _92_871 = (FStar_Absyn_Syntax.ids_of_lid lid)
in (let _92_870 = (let _92_869 = (unmangle_field_name nm)
in (_92_869)::[])
in (FStar_List.append _92_871 _92_870)))
in (FStar_Absyn_Syntax.lid_of_ids _92_872))
in (_92_873, y)))))

let unchecked_unify = (fun uv t -> (match ((FStar_Unionfind.find uv)) with
| FStar_Absyn_Syntax.Fixed (_26_1408) -> begin
(let _92_878 = (let _92_877 = (let _92_876 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _92_876))
in (FStar_Util.format1 "Changing a fixed uvar! U%s\n" _92_877))
in (FStar_All.failwith _92_878))
end
| _26_1411 -> begin
...
let union_uvs = (fun uvs1 uvs2 -> (let _92_907 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_k uvs2.FStar_Absyn_Syntax.uvars_k)
in (let _92_906 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_t uvs2.FStar_Absyn_Syntax.uvars_t)
in (let _92_905 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_e uvs2.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _92_907; FStar_Absyn_Syntax.uvars_t = _92_906; FStar_Absyn_Syntax.uvars_e = _92_905}))))

let union_fvs = (fun fvs1 fvs2 -> (let _92_913 = (FStar_Util.set_union fvs1.FStar_Absyn_Syntax.ftvs fvs2.FStar_Absyn_Syntax.ftvs)
in (let _92_912 = (FStar_Util.set_union fvs1.FStar_Absyn_Syntax.fxvs fvs2.FStar_Absyn_Syntax.fxvs)
in {FStar_Absyn_Syntax.ftvs = _92_913; FStar_Absyn_Syntax.fxvs = _92_912})))

let union_fvs_uvs = (fun _26_1456 _26_1459 -> (match ((_26_1456, _26_1459)) with
| ((fvs1, uvs1), (fvs2, uvs2)) -> begin
(let _92_919 = (union_fvs fvs1 fvs2)
in (let _92_918 = (union_uvs uvs1 uvs2)
in (_92_919, _92_918)))
end))

let sub_fv = (fun _26_1462 _26_1465 -> (match ((_26_1462, _26_1465)) with
| ((fvs, uvs), (tvars, vvars)) -> begin
(let _92_940 = (let _26_1466 = fvs
in (let _92_939 = (FStar_Util.set_difference fvs.FStar_Absyn_Syntax.ftvs tvars)
in (let _92_938 = (FStar_Util.set_difference fvs.FStar_Absyn_Syntax.fxvs vvars)
in {FStar_Absyn_Syntax.ftvs = _92_939; FStar_Absyn_Syntax.fxvs = _92_938})))
in (_92_940, uvs))
end))
...
let single_fv = (fun x -> (let _92_951 = (FStar_Absyn_Syntax.new_ftv_set ())
in (FStar_Util.set_add x _92_951)))

let single_uv = (fun u -> (let _92_959 = (FStar_Absyn_Syntax.new_uv_set ())
in (FStar_Util.set_add u _92_959)))

let single_uvt = (fun u -> (let _92_967 = (FStar_Absyn_Syntax.new_uvt_set ())
in (FStar_Util.set_add u _92_967)))
...
in (let _92_1083 = (single_uvt (uv, k))
in {FStar_Absyn_Syntax.uvars_k = _26_1496.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _92_1083; FStar_Absyn_Syntax.uvars_e = _26_1496.FStar_Absyn_Syntax.uvars_e}))
in (FStar_Absyn_Syntax.no_fvs, _92_1084))
in (cont _92_1085))
end
...
| (bvs, vs1) -> begin
(vs_comp c uvonly (fun vs2 -> (let _92_1089 = (let _92_1088 = (union_fvs_uvs vs1 vs2)
in (sub_fv _92_1088 bvs))
in (cont _92_1089))))
end)))
end
| FStar_Absyn_Syntax.Typ_lam (bs, t) -> begin
...
| (bvs, vs1) -> begin
(vs_typ t uvonly (fun vs2 -> (let _92_1093 = (let _92_1092 = (union_fvs_uvs vs1 vs2)
in (sub_fv _92_1092 bvs))
in (cont _92_1093))))
end)))
end
| FStar_Absyn_Syntax.Typ_refine (x, t) -> begin
...
| (bvs, vs1) -> begin
(vs_typ t uvonly (fun vs2 -> (let _92_1097 = (let _92_1096 = (union_fvs_uvs vs1 vs2)
in (sub_fv _92_1096 bvs))
in (cont _92_1097))))
end)))
end
| FStar_Absyn_Syntax.Typ_app (t, args) -> begin
(vs_typ t uvonly (fun vs1 -> (vs_args args uvonly (fun vs2 -> (let _92_1100 = (union_fvs_uvs vs1 vs2)
in (cont _92_1100))))))
end
...
(vs_typ t1 uvonly (fun vs1 -> (vs_typ t2 uvonly (fun vs2 -> (let _92_1103 = (union_fvs_uvs vs1 vs2)
in (cont _92_1103))))))
end
...
(let _92_1140 = (let _92_1139 = (let _92_1137 = (FStar_Util.set_add a tvars)
in (_92_1137, vvars))
in (let _92_1138 = (union_fvs_uvs vs vs2)
in (_92_1139, _92_1138)))
in (cont _92_1140))
end)))))
end
...
| ((tvars, vvars), vs2) -> begin
(let _92_1164 = (let _92_1163 = (let _92_1161 = (FStar_Util.set_add x vvars)
in (tvars, _92_1161))
in (let _92_1162 = (union_fvs_uvs vs vs2)
in (_92_1163, _92_1162)))
in (cont _92_1164))
end)))))
end))
...
(vs_typ t uvonly (fun ft1 -> (vs_args tl uvonly (fun ft2 -> (let _92_1168 = (union_fvs_uvs ft1 ft2)
in (cont _92_1168))))))
end
| (FStar_Util.Inr (e), _26_1622)::tl -> begin
(vs_exp e uvonly (fun ft1 -> (vs_args tl uvonly (fun ft2 -> (let _92_1171 = (union_fvs_uvs ft1 ft2)
in (cont _92_1171))))))
end))
and vs_typ = (fun t uvonly cont -> (match ((let _92_1174 = (FStar_ST.read t.FStar_Absyn_Syntax.fvs)
in (let _92_1173 = (FStar_ST.read t.FStar_Absyn_Syntax.uvs)
in (_92_1174, _92_1173)))) with
...
(let _92_1179 = (let _92_1178 = (FStar_Range.string_of_range k.FStar_Absyn_Syntax.pos)
in (FStar_Util.format1 "%s: Impossible ... found a Kind_lam bare" _92_1178))
in (FStar_All.failwith _92_1179))
end
...
| (fvs, uvs) -> begin
(let _92_1183 = (let _92_1182 = (let _26_1677 = uvs
in (let _92_1181 = (FStar_Util.set_add uv uvs.FStar_Absyn_Syntax.uvars_k)
in {FStar_Absyn_Syntax.uvars_k = _92_1181; FStar_Absyn_Syntax.uvars_t = _26_1677.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _26_1677.FStar_Absyn_Syntax.uvars_e}))
in (fvs, _92_1182))
in (cont _92_1183))
end)))
end
...
| (bvs, vs1) -> begin
(vs_kind k uvonly (fun vs2 -> (let _92_1187 = (let _92_1186 = (union_fvs_uvs vs1 vs2)
in (sub_fv _92_1186 bvs))
in (cont _92_1187))))
end)))
end)))
and vs_kind = (fun k uvonly cont -> (match ((let _92_1190 = (FStar_ST.read k.FStar_Absyn_Syntax.fvs)
in (let _92_1189 = (FStar_ST.read k.FStar_Absyn_Syntax.uvs)
in (_92_1190, _92_1189)))) with
...
(let _92_1196 = (let _92_1195 = (let _26_1737 = FStar_Absyn_Syntax.no_uvs
in (let _92_1194 = (single_uvt (uv, t))
in {FStar_Absyn_Syntax.uvars_k = _26_1737.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _26_1737.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _92_1194}))
in (FStar_Absyn_Syntax.no_fvs, _92_1195))
in (cont _92_1196))
end
| FStar_Absyn_Syntax.Exp_bvar (x) -> begin
if uvonly then begin
...
| (bvs, vs1) -> begin
(vs_exp e uvonly (fun vs2 -> (let _92_1203 = (let _92_1202 = (union_fvs_uvs vs1 vs2)
in (sub_fv _92_1202 bvs))
in (cont _92_1203))))
end)))
end
| FStar_Absyn_Syntax.Exp_app (e, args) -> begin
(vs_exp e uvonly (fun ft1 -> (vs_args args uvonly (fun ft2 -> (let _92_1206 = (union_fvs_uvs ft1 ft2)
in (cont _92_1206))))))
end
...
and vs_exp = (fun e uvonly cont -> (match ((let _92_1209 = (FStar_ST.read e.FStar_Absyn_Syntax.fvs)
in (let _92_1208 = (FStar_ST.read e.FStar_Absyn_Syntax.uvs)
in (_92_1209, _92_1208)))) with
...
| hd::tl -> begin
(vs_either hd uvonly (fun ft1 -> (vs_either_l tl uvonly (fun ft2 -> (let _92_1225 = (union_fvs_uvs ft1 ft2)
in (cont _92_1225))))))
end))
...
| FStar_Util.Inl (t) -> begin
(let _92_1241 = (freevars_typ t)
in (FStar_All.pipe_left (union_fvs out) _92_1241))
end
| FStar_Util.Inr (e) -> begin
(let _92_1242 = (freevars_exp e)
...
let rec update_uvars = (fun s uvs -> (let out = (let _92_1316 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_k)
in (FStar_All.pipe_right _92_1316 (FStar_List.fold_left (fun out u -> (match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (k) -> begin
(let _92_1314 = (uvars_in_kind k)
in (union_uvs _92_1314 out))
end
| _26_1911 -> begin
(let _26_1912 = out
in (let _92_1315 = (FStar_Util.set_add u out.FStar_Absyn_Syntax.uvars_k)
in {FStar_Absyn_Syntax.uvars_k = _92_1315; FStar_Absyn_Syntax.uvars_t = _26_1912.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _26_1912.FStar_Absyn_Syntax.uvars_e}))
end)) FStar_Absyn_Syntax.no_uvs)))
in (let out = (let _92_1321 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_t)
in (FStar_All.pipe_right _92_1321 (FStar_List.fold_left (fun out _26_1918 -> (match (_26_1918) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (t) -> begin
(let _92_1319 = (uvars_in_typ t)
in (union_uvs _92_1319 out))
end
| _26_1922 -> begin
(let _26_1923 = out
in (let _92_1320 = (FStar_Util.set_add (u, t) out.FStar_Absyn_Syntax.uvars_t)
in {FStar_Absyn_Syntax.uvars_k = _26_1923.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _92_1320; FStar_Absyn_Syntax.uvars_e = _26_1923.FStar_Absyn_Syntax.uvars_e}))
end)
end)) out)))
in (let out = (let _92_1326 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_e)
in (FStar_All.pipe_right _92_1326 (FStar_List.fold_left (fun out _26_1929 -> (match (_26_1929) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (e) -> begin
(let _92_1324 = (uvars_in_exp e)
in (union_uvs _92_1324 out))
end
| _26_1933 -> begin
(let _26_1934 = out
in (let _92_1325 = (FStar_Util.set_add (u, t) out.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _26_1934.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _26_1934.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _92_1325}))
end)
end)) out)))
...
in out)))))
and uvars_in_kind = (fun k -> (let _92_1329 = (vs_kind k true (fun _26_1951 -> (match (_26_1951) with
| (_26_1949, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumKind (k))) _92_1329)))
and uvars_in_typ = (fun t -> (let _92_1332 = (vs_typ t true (fun _26_1956 -> (match (_26_1956) with
| (_26_1954, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumType (t))) _92_1332)))
and uvars_in_exp = (fun e -> (let _92_1335 = (vs_exp e true (fun _26_1961 -> (match (_26_1961) with
| (_26_1959, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumExp (e))) _92_1335)))
and uvars_in_comp = (fun c -> (let _92_1338 = (vs_comp c true (fun _26_1966 -> (match (_26_1966) with
| (_26_1964, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumComp (c))) _92_1338)))
...
| _26_2028 -> begin
(let _92_1359 = (FStar_Absyn_Syntax.mk_Total t)
in (tps, _92_1359))
end)
...
let mk_tuple_lid = (fun n r -> (let t = (let _92_1372 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Tuple%s" _92_1372))
in (let _92_1373 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _92_1373 r))))

let mk_tuple_data_lid = (fun n r -> (let t = (let _92_1378 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "MkTuple%s" _92_1378))
in (let _92_1379 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _92_1379 r))))

let is_tuple_data_lid = (fun f n -> (let _92_1384 = (mk_tuple_data_lid n FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Syntax.lid_equals f _92_1384)))
...
let mk_dtuple_lid = (fun n r -> (let t = (let _92_1391 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "DTuple%s" _92_1391))
in (let _92_1392 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _92_1392 r))))

let mk_dtuple_data_lid = (fun n r -> (let t = (let _92_1397 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "MkDTuple%s" _92_1397))
in (let _92_1398 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _92_1398 r))))
...
let is_constructor = (fun t lid -> (match ((let _92_1414 = (pre_typ t)
in _92_1414.FStar_Absyn_Syntax.n)) with
...
let rec is_constructed_typ = (fun t lid -> (match ((let _92_1419 = (pre_typ t)
in _92_1419.FStar_Absyn_Syntax.n)) with
...
(let _92_1428 = (FStar_Absyn_Syntax.text_of_lid fn1)
in (let _92_1427 = (FStar_Absyn_Syntax.text_of_lid fn2)
in (FStar_String.compare _92_1428 _92_1427)))
end)))))
...
let b2t_v = (let _92_1432 = (let _92_1431 = (let _92_1430 = (let _92_1429 = (FStar_All.pipe_left FStar_Absyn_Syntax.null_v_binder t_bool)
in (_92_1429)::[])
in (_92_1430, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _92_1431 FStar_Absyn_Syntax.dummyRange))
in (ftv FStar_Absyn_Const.b2t_lid _92_1432))
...
| Some (phi1) -> begin
(let _92_1443 = (let _92_1442 = (let _92_1440 = (let _92_1439 = (FStar_Absyn_Syntax.targ phi1)
in (let _92_1438 = (let _92_1437 = (FStar_Absyn_Syntax.targ phi2)
in (_92_1437)::[])
in (_92_1439)::_92_1438))
in (tand, _92_1440))
in (let _92_1441 = (FStar_Range.union_ranges phi1.FStar_Absyn_Syntax.pos phi2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _92_1442 None _92_1441)))
in Some (_92_1443))
end))

let mk_binop = (fun op_t phi1 phi2 -> (let _92_1455 = (let _92_1453 = (let _92_1452 = (FStar_Absyn_Syntax.targ phi1)
in (let _92_1451 = (let _92_1450 = (FStar_Absyn_Syntax.targ phi2)
in (_92_1450)::[])
in (_92_1452)::_92_1451))
in (op_t, _92_1453))
in (let _92_1454 = (FStar_Range.union_ranges phi1.FStar_Absyn_Syntax.pos phi2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _92_1455 None _92_1454))))

let mk_neg = (fun phi -> (let _92_1461 = (let _92_1460 = (ftv FStar_Absyn_Const.not_lid kt_kt)
in (let _92_1459 = (let _92_1458 = (FStar_Absyn_Syntax.targ phi)
in (_92_1458)::[])
in (_92_1460, _92_1459)))
in (FStar_Absyn_Syntax.mk_Typ_app _92_1461 None phi.FStar_Absyn_Syntax.pos)))
...
let mk_imp = (fun phi1 phi2 -> (match ((let _92_1478 = (compress_typ phi1)
in _92_1478.FStar_Absyn_Syntax.n)) with
...
| _26_2145 -> begin
(match ((let _92_1479 = (compress_typ phi2)
...
let b2t = (fun e -> (let _92_1488 = (let _92_1487 = (let _92_1486 = (FStar_All.pipe_left FStar_Absyn_Syntax.varg e)
in (_92_1486)::[])
in (b2t_v, _92_1487))
in (FStar_Absyn_Syntax.mk_Typ_app _92_1488 None e.FStar_Absyn_Syntax.pos)))
...
let eq_k = (let a = (let _92_1491 = (new_bvd None)
in (bvd_to_bvar_s _92_1491 FStar_Absyn_Syntax.ktype))
in (let atyp = (btvar_to_typ a)
in (let b = (let _92_1492 = (new_bvd None)
in (bvd_to_bvar_s _92_1492 FStar_Absyn_Syntax.ktype))
in (let btyp = (btvar_to_typ b)
in (let _92_1499 = (let _92_1498 = (let _92_1497 = (let _92_1496 = (let _92_1495 = (FStar_Absyn_Syntax.null_v_binder atyp)
in (let _92_1494 = (let _92_1493 = (FStar_Absyn_Syntax.null_v_binder btyp)
in (_92_1493)::[])
in (_92_1495)::_92_1494))
in ((FStar_Util.Inl (b), Some (FStar_Absyn_Syntax.Implicit)))::_92_1496)
in ((FStar_Util.Inl (a), Some (FStar_Absyn_Syntax.Implicit)))::_92_1497)
in (_92_1498, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _92_1499 FStar_Absyn_Syntax.dummyRange))))))
...
| _26_2212 -> begin
(let _92_1517 = (let _92_1515 = (let _92_1514 = (FStar_Absyn_Syntax.itarg t1)
in (let _92_1513 = (let _92_1512 = (FStar_Absyn_Syntax.itarg t2)
in (let _92_1511 = (let _92_1510 = (FStar_Absyn_Syntax.varg e1)
in (let _92_1509 = (let _92_1508 = (FStar_Absyn_Syntax.varg e2)
in (_92_1508)::[])
in (_92_1510)::_92_1509))
in (_92_1512)::_92_1511))
in (_92_1514)::_92_1513))
in (teq, _92_1515))
in (let _92_1516 = (FStar_Range.union_ranges e1.FStar_Absyn_Syntax.pos e2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _92_1517 None _92_1516)))
end))

let eq_typ = (ftv FStar_Absyn_Const.eqT_lid FStar_Absyn_Syntax.kun)

let mk_eq_typ = (fun t1 t2 -> (let _92_1527 = (let _92_1525 = (let _92_1524 = (FStar_Absyn_Syntax.targ t1)
in (let _92_1523 = (let _92_1522 = (FStar_Absyn_Syntax.targ t2)
in (_92_1522)::[])
in (_92_1524)::_92_1523))
in (eq_typ, _92_1525))
in (let _92_1526 = (FStar_Range.union_ranges t1.FStar_Absyn_Syntax.pos t2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _92_1527 None _92_1526))))
...
in (let lexcons = (let _92_1537 = (let _92_1536 = (let _92_1535 = (let _92_1533 = (FStar_Absyn_Syntax.t_binder a)
in (let _92_1532 = (let _92_1531 = (let _92_1528 = (btvar_to_typ a)
in (FStar_Absyn_Syntax.null_v_binder _92_1528))
in (let _92_1530 = (let _92_1529 = (FStar_Absyn_Syntax.null_v_binder lex_t)
in (_92_1529)::[])
in (_92_1531)::_92_1530))
in (_92_1533)::_92_1532))
in (let _92_1534 = (FStar_Absyn_Syntax.mk_Total lex_t)
in (_92_1535, _92_1534)))
in (FStar_Absyn_Syntax.mk_Typ_fun _92_1536 None FStar_Absyn_Syntax.dummyRange))
in (withinfo FStar_Absyn_Const.lexcons_lid _92_1537 FStar_Absyn_Syntax.dummyRange))
in (FStar_Absyn_Syntax.mk_Exp_fvar (lexcons, Some (FStar_Absyn_Syntax.Data_ctor)) None FStar_Absyn_Syntax.dummyRange)))

let forall_kind = (let a = (let _92_1538 = (new_bvd None)
in (bvd_to_bvar_s _92_1538 FStar_Absyn_Syntax.ktype))
in (let atyp = (btvar_to_typ a)
in (let _92_1546 = (let _92_1545 = (let _92_1544 = (let _92_1543 = (let _92_1542 = (let _92_1541 = (let _92_1540 = (let _92_1539 = (FStar_Absyn_Syntax.null_v_binder atyp)
in (_92_1539)::[])
in (_92_1540, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _92_1541 FStar_Absyn_Syntax.dummyRange))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder _92_1542))
in (_92_1543)::[])
in ((FStar_Util.Inl (a), Some (FStar_Absyn_Syntax.Implicit)))::_92_1544)
in (_92_1545, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _92_1546 FStar_Absyn_Syntax.dummyRange))))

let tforall = (ftv FStar_Absyn_Const.forall_lid forall_kind)

let allT_k = (fun k -> (let _92_1555 = (let _92_1554 = (let _92_1553 = (let _92_1552 = (let _92_1551 = (let _92_1550 = (let _92_1549 = (FStar_Absyn_Syntax.null_t_binder k)
in (_92_1549)::[])
in (_92_1550, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _92_1551 FStar_Absyn_Syntax.dummyRange))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder _92_1552))
in (_92_1553)::[])
in (_92_1554, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _92_1555 FStar_Absyn_Syntax.dummyRange)))

let eqT_k = (fun k -> (let _92_1562 = (let _92_1561 = (let _92_1560 = (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder k)
in (let _92_1559 = (let _92_1558 = (FStar_Absyn_Syntax.null_t_binder k)
in (_92_1558)::[])
in (_92_1560)::_92_1559))
in (_92_1561, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _92_1562 FStar_Absyn_Syntax.dummyRange)))

let tforall_typ = (fun k -> (let _92_1565 = (allT_k k)
in (ftv FStar_Absyn_Const.allTyp_lid _92_1565)))

let mk_forallT = (fun a b -> (let _92_1577 = (let _92_1576 = (tforall_typ a.FStar_Absyn_Syntax.sort)
in (let _92_1575 = (let _92_1574 = (let _92_1573 = (let _92_1572 = (let _92_1571 = (let _92_1570 = (FStar_Absyn_Syntax.t_binder a)
in (_92_1570)::[])
in (_92_1571, b))
in (FStar_Absyn_Syntax.mk_Typ_lam _92_1572 None b.FStar_Absyn_Syntax.pos))
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _92_1573))
in (_92_1574)::[])
in (_92_1576, _92_1575)))
in (FStar_Absyn_Syntax.mk_Typ_app _92_1577 None b.FStar_Absyn_Syntax.pos)))

let mk_forall = (fun x body -> (let r = FStar_Absyn_Syntax.dummyRange
in (let _92_1588 = (let _92_1587 = (let _92_1586 = (let _92_1585 = (let _92_1584 = (let _92_1583 = (let _92_1582 = (FStar_Absyn_Syntax.v_binder x)
in (_92_1582)::[])
in (_92_1583, body))
in (FStar_Absyn_Syntax.mk_Typ_lam _92_1584 None r))
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _92_1585))
in (_92_1586)::[])
in (tforall, _92_1587))
in (FStar_Absyn_Syntax.mk_Typ_app _92_1588 None r))))
...
| FStar_Util.Inl (a) -> begin
(let _92_1598 = (let _92_1597 = (tforall_typ a.FStar_Absyn_Syntax.sort)
in (let _92_1596 = (let _92_1595 = (FStar_Absyn_Syntax.targ body)
in (_92_1595)::[])
in (_92_1597, _92_1596)))
in (FStar_Absyn_Syntax.mk_Typ_app _92_1598 None f.FStar_Absyn_Syntax.pos))
end
| FStar_Util.Inr (x) -> begin
(let _92_1602 = (let _92_1601 = (let _92_1600 = (let _92_1599 = (FStar_Absyn_Syntax.targ body)
in (_92_1599)::[])
in ((FStar_Util.Inl (x.FStar_Absyn_Syntax.sort), Some (FStar_Absyn_Syntax.Implicit)))::_92_1600)
in (tforall, _92_1601))
in (FStar_Absyn_Syntax.mk_Typ_app _92_1602 None f.FStar_Absyn_Syntax.pos))
end))
end) bs f))
...
| (t, args) -> begin
(let _92_1681 = (FStar_All.pipe_right args (FStar_List.map (fun _26_26 -> (match (_26_26) with
| (FStar_Util.Inl (t), imp) -> begin
(let _92_1678 = (let _92_1677 = (compress_typ t)
in FStar_Util.Inl (_92_1677))
in (_92_1678, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _92_1680 = (let _92_1679 = (compress_exp e)
in FStar_Util.Inr (_92_1679))
in (_92_1680, imp))
end))))
in (t, _92_1681))
end)))
in (let rec aux = (fun qopt out t -> (match ((let _92_1688 = (flat t)
in (qopt, _92_1688))) with
