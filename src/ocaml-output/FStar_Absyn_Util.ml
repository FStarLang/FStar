...
let union_uvs : FStar_Absyn_Syntax.uvars  ->  FStar_Absyn_Syntax.uvars  ->  FStar_Absyn_Syntax.uvars = (fun uvs1 uvs2 -> (let _100_898 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_k uvs2.FStar_Absyn_Syntax.uvars_k)
in (let _100_897 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_t uvs2.FStar_Absyn_Syntax.uvars_t)
in (let _100_896 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_e uvs2.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _100_898; FStar_Absyn_Syntax.uvars_t = _100_897; FStar_Absyn_Syntax.uvars_e = _100_896}))))

# 805 "FStar.Absyn.Util.fst"
let union_fvs : FStar_Absyn_Syntax.freevars  ->  FStar_Absyn_Syntax.freevars  ->  FStar_Absyn_Syntax.freevars = (fun fvs1 fvs2 -> (let _100_904 = (FStar_Util.set_union fvs1.FStar_Absyn_Syntax.ftvs fvs2.FStar_Absyn_Syntax.ftvs)
in (let _100_903 = (FStar_Util.set_union fvs1.FStar_Absyn_Syntax.fxvs fvs2.FStar_Absyn_Syntax.fxvs)
in {FStar_Absyn_Syntax.ftvs = _100_904; FStar_Absyn_Syntax.fxvs = _100_903})))
...
(let _100_910 = (union_fvs fvs1 fvs2)
in (let _100_909 = (union_uvs uvs1 uvs2)
in (_100_910, _100_909)))
end))
...
let _21_1471 = fvs
in (let _100_930 = (FStar_Util.set_difference fvs.FStar_Absyn_Syntax.ftvs tvars)
in (let _100_929 = (FStar_Util.set_difference fvs.FStar_Absyn_Syntax.fxvs vvars)
in {FStar_Absyn_Syntax.ftvs = _100_930; FStar_Absyn_Syntax.fxvs = _100_929})))
in (_100_931, uvs))
end))
...
let single_fv = (fun x -> (let _100_942 = (FStar_Absyn_Syntax.new_ftv_set ())
in (FStar_Util.set_add x _100_942)))

# 826 "FStar.Absyn.Util.fst"
let single_uv = (fun u -> (let _100_950 = (FStar_Absyn_Syntax.new_uv_set ())
in (FStar_Util.set_add u _100_950)))

# 827 "FStar.Absyn.Util.fst"
let single_uvt = (fun u -> (let _100_958 = (FStar_Absyn_Syntax.new_uvt_set ())
in (FStar_Util.set_add u _100_958)))
...
(let _100_1073 = (let _100_1072 = (
# 836 "FStar.Absyn.Util.fst"
let _21_1495 = FStar_Absyn_Syntax.no_fvs
in (let _100_1071 = (single_fv a)
in {FStar_Absyn_Syntax.ftvs = _100_1071; FStar_Absyn_Syntax.fxvs = _21_1495.FStar_Absyn_Syntax.fxvs}))
in (_100_1072, FStar_Absyn_Syntax.no_uvs))
in (cont _100_1073))
end
end
| FStar_Absyn_Syntax.Typ_uvar (uv, k) -> begin
(let _100_1076 = (let _100_1075 = (
# 839 "FStar.Absyn.Util.fst"
let _21_1501 = FStar_Absyn_Syntax.no_uvs
in (let _100_1074 = (single_uvt (uv, k))
in {FStar_Absyn_Syntax.uvars_k = _21_1501.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _100_1074; FStar_Absyn_Syntax.uvars_e = _21_1501.FStar_Absyn_Syntax.uvars_e}))
in (FStar_Absyn_Syntax.no_fvs, _100_1075))
in (cont _100_1076))
end
...
| (bvs, vs1) -> begin
(vs_comp c uvonly (fun vs2 -> (let _100_1080 = (let _100_1079 = (union_fvs_uvs vs1 vs2)
in (sub_fv _100_1079 bvs))
in (cont _100_1080))))
end)))
end
| FStar_Absyn_Syntax.Typ_lam (bs, t) -> begin
...
| (bvs, vs1) -> begin
(vs_typ t uvonly (fun vs2 -> (let _100_1084 = (let _100_1083 = (union_fvs_uvs vs1 vs2)
...
| (bvs, vs1) -> begin
(vs_typ t uvonly (fun vs2 -> (let _100_1088 = (let _100_1087 = (union_fvs_uvs vs1 vs2)
in (sub_fv _100_1087 bvs))
in (cont _100_1088))))
end)))
end
| FStar_Absyn_Syntax.Typ_app (t, args) -> begin
(vs_typ t uvonly (fun vs1 -> (vs_args args uvonly (fun vs2 -> (let _100_1091 = (union_fvs_uvs vs1 vs2)
in (cont _100_1091))))))
end
...
(vs_typ t1 uvonly (fun vs1 -> (vs_typ t2 uvonly (fun vs2 -> (let _100_1094 = (union_fvs_uvs vs1 vs2)
in (cont _100_1094))))))
end
...
(let _100_1131 = (let _100_1130 = (let _100_1128 = (FStar_Util.set_add a tvars)
in (_100_1128, vvars))
in (let _100_1129 = (union_fvs_uvs vs vs2)
in (_100_1130, _100_1129)))
in (cont _100_1131))
end)))))
end
...
| ((tvars, vvars), vs2) -> begin
(let _100_1155 = (let _100_1154 = (let _100_1152 = (FStar_Util.set_add x vvars)
in (tvars, _100_1152))
in (let _100_1153 = (union_fvs_uvs vs vs2)
in (_100_1154, _100_1153)))
in (cont _100_1155))
end)))))
end))
...
(vs_typ t uvonly (fun ft1 -> (vs_args tl uvonly (fun ft2 -> (let _100_1159 = (union_fvs_uvs ft1 ft2)
in (cont _100_1159))))))
end
| (FStar_Util.Inr (e), _21_1627)::tl -> begin
(vs_exp e uvonly (fun ft1 -> (vs_args tl uvonly (fun ft2 -> (let _100_1162 = (union_fvs_uvs ft1 ft2)
in (cont _100_1162))))))
end))
and vs_typ = (fun t uvonly cont -> (match ((let _100_1165 = (FStar_ST.read t.FStar_Absyn_Syntax.fvs)
in (let _100_1164 = (FStar_ST.read t.FStar_Absyn_Syntax.uvs)
in (_100_1165, _100_1164)))) with
...
(let _100_1170 = (let _100_1169 = (FStar_Range.string_of_range k.FStar_Absyn_Syntax.pos)
in (FStar_Util.format1 "%s: Impossible ... found a Kind_lam bare" _100_1169))
in (FStar_All.failwith _100_1170))
end
...
| (fvs, uvs) -> begin
(let _100_1174 = (let _100_1173 = (
# 929 "FStar.Absyn.Util.fst"
let _21_1682 = uvs
in (let _100_1172 = (FStar_Util.set_add uv uvs.FStar_Absyn_Syntax.uvars_k)
in {FStar_Absyn_Syntax.uvars_k = _100_1172; FStar_Absyn_Syntax.uvars_t = _21_1682.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _21_1682.FStar_Absyn_Syntax.uvars_e}))
in (fvs, _100_1173))
in (cont _100_1174))
end)))
end
...
| (bvs, vs1) -> begin
(vs_kind k uvonly (fun vs2 -> (let _100_1178 = (let _100_1177 = (union_fvs_uvs vs1 vs2)
in (sub_fv _100_1177 bvs))
in (cont _100_1178))))
end)))
end)))
and vs_kind = (fun k uvonly cont -> (match ((let _100_1181 = (FStar_ST.read k.FStar_Absyn_Syntax.fvs)
in (let _100_1180 = (FStar_ST.read k.FStar_Absyn_Syntax.uvs)
in (_100_1181, _100_1180)))) with
...
(let _100_1187 = (let _100_1186 = (
# 957 "FStar.Absyn.Util.fst"
let _21_1742 = FStar_Absyn_Syntax.no_uvs
in (let _100_1185 = (single_uvt (uv, t))
in {FStar_Absyn_Syntax.uvars_k = _21_1742.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _21_1742.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _100_1185}))
in (FStar_Absyn_Syntax.no_fvs, _100_1186))
in (cont _100_1187))
end
| FStar_Absyn_Syntax.Exp_bvar (x) -> begin
if uvonly then begin
...
(let _100_1190 = (let _100_1189 = (
# 962 "FStar.Absyn.Util.fst"
let _21_1746 = FStar_Absyn_Syntax.no_fvs
in (let _100_1188 = (single_fv x)
in {FStar_Absyn_Syntax.ftvs = _21_1746.FStar_Absyn_Syntax.ftvs; FStar_Absyn_Syntax.fxvs = _100_1188}))
in (_100_1189, FStar_Absyn_Syntax.no_uvs))
in (cont _100_1190))
end
end
...
| (bvs, vs1) -> begin
(vs_exp e uvonly (fun vs2 -> (let _100_1194 = (let _100_1193 = (union_fvs_uvs vs1 vs2)
in (sub_fv _100_1193 bvs))
in (cont _100_1194))))
end)))
end
| FStar_Absyn_Syntax.Exp_app (e, args) -> begin
(vs_exp e uvonly (fun ft1 -> (vs_args args uvonly (fun ft2 -> (let _100_1197 = (union_fvs_uvs ft1 ft2)
in (cont _100_1197))))))
end
...
and vs_exp = (fun e uvonly cont -> (match ((let _100_1200 = (FStar_ST.read e.FStar_Absyn_Syntax.fvs)
in (let _100_1199 = (FStar_ST.read e.FStar_Absyn_Syntax.uvs)
in (_100_1200, _100_1199)))) with
...
(vs_typ ct.FStar_Absyn_Syntax.result_typ uvonly (fun vs1 -> (vs_args ct.FStar_Absyn_Syntax.effect_args uvonly (fun vs2 -> (let _100_1206 = (union_fvs_uvs vs1 vs2)
in (k _100_1206))))))
end
end))
and vs_comp = (fun c uvonly cont -> (match ((let _100_1209 = (FStar_ST.read c.FStar_Absyn_Syntax.fvs)
in (let _100_1208 = (FStar_ST.read c.FStar_Absyn_Syntax.uvs)
in (_100_1209, _100_1208)))) with
...
| hd::tl -> begin
(vs_either hd uvonly (fun ft1 -> (vs_either_l tl uvonly (fun ft2 -> (let _100_1216 = (union_fvs_uvs ft1 ft2)
in (cont _100_1216))))))
end))
...
| FStar_Util.Inl (t) -> begin
(let _100_1232 = (freevars_typ t)
in (FStar_All.pipe_left (union_fvs out) _100_1232))
end
| FStar_Util.Inr (e) -> begin
(let _100_1233 = (freevars_exp e)
in (FStar_All.pipe_left (union_fvs out) _100_1233))
...
let out = (let _100_1307 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_k)
in (FStar_All.pipe_right _100_1307 (FStar_List.fold_left (fun out u -> (match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (k) -> begin
(let _100_1305 = (uvars_in_kind k)
in (union_uvs _100_1305 out))
end
| _21_1916 -> begin
(
# 1059 "FStar.Absyn.Util.fst"
let _21_1917 = out
in (let _100_1306 = (FStar_Util.set_add u out.FStar_Absyn_Syntax.uvars_k)
in {FStar_Absyn_Syntax.uvars_k = _100_1306; FStar_Absyn_Syntax.uvars_t = _21_1917.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _21_1917.FStar_Absyn_Syntax.uvars_e}))
end)) FStar_Absyn_Syntax.no_uvs)))
in (
# 1060 "FStar.Absyn.Util.fst"
let out = (let _100_1312 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_t)
in (FStar_All.pipe_right _100_1312 (FStar_List.fold_left (fun out _21_1923 -> (match (_21_1923) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (t) -> begin
(let _100_1310 = (uvars_in_typ t)
in (union_uvs _100_1310 out))
end
| _21_1927 -> begin
(
# 1063 "FStar.Absyn.Util.fst"
let _21_1928 = out
in (let _100_1311 = (FStar_Util.set_add (u, t) out.FStar_Absyn_Syntax.uvars_t)
in {FStar_Absyn_Syntax.uvars_k = _21_1928.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _100_1311; FStar_Absyn_Syntax.uvars_e = _21_1928.FStar_Absyn_Syntax.uvars_e}))
end)
end)) out)))
in (
# 1064 "FStar.Absyn.Util.fst"
let out = (let _100_1317 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_e)
in (FStar_All.pipe_right _100_1317 (FStar_List.fold_left (fun out _21_1934 -> (match (_21_1934) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (e) -> begin
(let _100_1315 = (uvars_in_exp e)
in (union_uvs _100_1315 out))
end
| _21_1938 -> begin
(
# 1067 "FStar.Absyn.Util.fst"
let _21_1939 = out
in (let _100_1316 = (FStar_Util.set_add (u, t) out.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _21_1939.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _21_1939.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _100_1316}))
end)
end)) out)))
in (
...
in out)))))
and uvars_in_kind : (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun k -> (let _100_1320 = (vs_kind k true (fun _21_1956 -> (match (_21_1956) with
| (_21_1954, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumKind (k))) _100_1320)))
and uvars_in_typ : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun t -> (let _100_1323 = (vs_typ t true (fun _21_1961 -> (match (_21_1961) with
| (_21_1959, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumType (t))) _100_1323)))
and uvars_in_exp : (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun e -> (let _100_1326 = (vs_exp e true (fun _21_1966 -> (match (_21_1966) with
| (_21_1964, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumExp (e))) _100_1326)))
and uvars_in_comp : (FStar_Absyn_Syntax.comp', Prims.unit) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun c -> (let _100_1329 = (vs_comp c true (fun _21_1971 -> (match (_21_1971) with
| (_21_1969, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumComp (c))) _100_1329)))
...
| _21_2033 -> begin
(let _100_1350 = (FStar_Absyn_Syntax.mk_Total t)
in (tps, _100_1350))
end)
...
let t = (let _100_1363 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Tuple%s" _100_1363))
in (let _100_1364 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _100_1364 r))))
...
let t = (let _100_1369 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "MkTuple%s" _100_1369))
in (let _100_1370 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _100_1370 r))))

# 1157 "FStar.Absyn.Util.fst"
let is_tuple_data_lid : FStar_Absyn_Syntax.lident  ->  Prims.int  ->  Prims.bool = (fun f n -> (let _100_1375 = (mk_tuple_data_lid n FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Syntax.lid_equals f _100_1375)))
...
let t = (let _100_1382 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "DTuple%s" _100_1382))
in (let _100_1383 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _100_1383 r))))
...
let t = (let _100_1388 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "MkDTuple%s" _100_1388))
in (let _100_1389 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _100_1389 r))))
...
let is_constructor : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _100_1405 = (pre_typ t)
in _100_1405.FStar_Absyn_Syntax.n)) with
...
let rec is_constructed_typ : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _100_1410 = (pre_typ t)
in _100_1410.FStar_Absyn_Syntax.n)) with
...
let b2t_v : FStar_Absyn_Syntax.typ = (let _100_1421 = (let _100_1420 = (let _100_1419 = (let _100_1418 = (FStar_All.pipe_left FStar_Absyn_Syntax.null_v_binder t_bool)
in (_100_1418)::[])
in (_100_1419, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _100_1420 FStar_Absyn_Syntax.dummyRange))
in (ftv FStar_Absyn_Const.b2t_lid _100_1421))
...
| Some (phi1) -> begin
(let _100_1432 = (let _100_1431 = (let _100_1429 = (let _100_1428 = (FStar_Absyn_Syntax.targ phi1)
in (let _100_1427 = (let _100_1426 = (FStar_Absyn_Syntax.targ phi2)
in (_100_1426)::[])
in (_100_1428)::_100_1427))
in (tand, _100_1429))
in (let _100_1430 = (FStar_Range.union_ranges phi1.FStar_Absyn_Syntax.pos phi2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _100_1431 None _100_1430)))
in Some (_100_1432))
end))

# 1234 "FStar.Absyn.Util.fst"
let mk_binop : FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun op_t phi1 phi2 -> (let _100_1444 = (let _100_1442 = (let _100_1441 = (FStar_Absyn_Syntax.targ phi1)
in (let _100_1440 = (let _100_1439 = (FStar_Absyn_Syntax.targ phi2)
in (_100_1439)::[])
in (_100_1441)::_100_1440))
in (op_t, _100_1442))
in (let _100_1443 = (FStar_Range.union_ranges phi1.FStar_Absyn_Syntax.pos phi2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _100_1444 None _100_1443))))

# 1235 "FStar.Absyn.Util.fst"
let mk_neg : FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun phi -> (let _100_1450 = (let _100_1449 = (ftv FStar_Absyn_Const.not_lid kt_kt)
in (let _100_1448 = (let _100_1447 = (FStar_Absyn_Syntax.targ phi)
in (_100_1447)::[])
in (_100_1449, _100_1448)))
in (FStar_Absyn_Syntax.mk_Typ_app _100_1450 None phi.FStar_Absyn_Syntax.pos)))
...
let mk_imp : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun phi1 phi2 -> (match ((let _100_1467 = (compress_typ phi1)
in _100_1467.FStar_Absyn_Syntax.n)) with
...
| _21_2150 -> begin
(match ((let _100_1468 = (compress_typ phi2)
in _100_1468.FStar_Absyn_Syntax.n)) with
...
let b2t : FStar_Absyn_Syntax.exp  ->  FStar_Absyn_Syntax.typ = (fun e -> (let _100_1477 = (let _100_1476 = (let _100_1475 = (FStar_All.pipe_left FStar_Absyn_Syntax.varg e)
in (_100_1475)::[])
in (b2t_v, _100_1476))
in (FStar_Absyn_Syntax.mk_Typ_app _100_1477 None e.FStar_Absyn_Syntax.pos)))
...
let a = (let _100_1480 = (new_bvd None)
in (bvd_to_bvar_s _100_1480 FStar_Absyn_Syntax.ktype))
in (
# 1271 "FStar.Absyn.Util.fst"
let atyp = (btvar_to_typ a)
in (
# 1272 "FStar.Absyn.Util.fst"
let b = (let _100_1481 = (new_bvd None)
in (bvd_to_bvar_s _100_1481 FStar_Absyn_Syntax.ktype))
in (
# 1273 "FStar.Absyn.Util.fst"
let btyp = (btvar_to_typ b)
in (let _100_1488 = (let _100_1487 = (let _100_1486 = (let _100_1485 = (let _100_1484 = (FStar_Absyn_Syntax.null_v_binder atyp)
in (let _100_1483 = (let _100_1482 = (FStar_Absyn_Syntax.null_v_binder btyp)
in (_100_1482)::[])
in (_100_1484)::_100_1483))
in ((FStar_Util.Inl (b), Some (FStar_Absyn_Syntax.Implicit (false))))::_100_1485)
in ((FStar_Util.Inl (a), Some (FStar_Absyn_Syntax.Implicit (false))))::_100_1486)
in (_100_1487, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _100_1488 FStar_Absyn_Syntax.dummyRange))))))
...
| _21_2217 -> begin
(let _100_1506 = (let _100_1504 = (let _100_1503 = (FStar_Absyn_Syntax.itarg t1)
in (let _100_1502 = (let _100_1501 = (FStar_Absyn_Syntax.itarg t2)
in (let _100_1500 = (let _100_1499 = (FStar_Absyn_Syntax.varg e1)
in (let _100_1498 = (let _100_1497 = (FStar_Absyn_Syntax.varg e2)
in (_100_1497)::[])
in (_100_1499)::_100_1498))
in (_100_1501)::_100_1500))
in (_100_1503)::_100_1502))
in (teq, _100_1504))
in (let _100_1505 = (FStar_Range.union_ranges e1.FStar_Absyn_Syntax.pos e2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _100_1506 None _100_1505)))
end))
...
let mk_eq_typ : FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun t1 t2 -> (let _100_1516 = (let _100_1514 = (let _100_1513 = (FStar_Absyn_Syntax.targ t1)
in (let _100_1512 = (let _100_1511 = (FStar_Absyn_Syntax.targ t2)
in (_100_1511)::[])
in (_100_1513)::_100_1512))
in (eq_typ, _100_1514))
in (let _100_1515 = (FStar_Range.union_ranges t1.FStar_Absyn_Syntax.pos t2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _100_1516 None _100_1515))))
...
let lexcons = (let _100_1526 = (let _100_1525 = (let _100_1524 = (let _100_1522 = (FStar_Absyn_Syntax.t_binder a)
in (let _100_1521 = (let _100_1520 = (let _100_1517 = (btvar_to_typ a)
in (FStar_Absyn_Syntax.null_v_binder _100_1517))
in (let _100_1519 = (let _100_1518 = (FStar_Absyn_Syntax.null_v_binder lex_t)
in (_100_1518)::[])
in (_100_1520)::_100_1519))
in (_100_1522)::_100_1521))
in (let _100_1523 = (FStar_Absyn_Syntax.mk_Total lex_t)
in (_100_1524, _100_1523)))
in (FStar_Absyn_Syntax.mk_Typ_fun _100_1525 None FStar_Absyn_Syntax.dummyRange))
in (withinfo FStar_Absyn_Const.lexcons_lid _100_1526 FStar_Absyn_Syntax.dummyRange))
...
let a = (let _100_1527 = (new_bvd None)
in (bvd_to_bvar_s _100_1527 FStar_Absyn_Syntax.ktype))
in (
# 1297 "FStar.Absyn.Util.fst"
let atyp = (btvar_to_typ a)
in (let _100_1535 = (let _100_1534 = (let _100_1533 = (let _100_1532 = (let _100_1531 = (let _100_1530 = (let _100_1529 = (let _100_1528 = (FStar_Absyn_Syntax.null_v_binder atyp)
in (_100_1528)::[])
in (_100_1529, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _100_1530 FStar_Absyn_Syntax.dummyRange))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder _100_1531))
in (_100_1532)::[])
in ((FStar_Util.Inl (a), Some (FStar_Absyn_Syntax.Implicit (false))))::_100_1533)
in (_100_1534, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _100_1535 FStar_Absyn_Syntax.dummyRange))))
...
let allT_k : FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.knd = (fun k -> (let _100_1544 = (let _100_1543 = (let _100_1542 = (let _100_1541 = (let _100_1540 = (let _100_1539 = (let _100_1538 = (FStar_Absyn_Syntax.null_t_binder k)
in (_100_1538)::[])
in (_100_1539, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _100_1540 FStar_Absyn_Syntax.dummyRange))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder _100_1541))
in (_100_1542)::[])
in (_100_1543, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _100_1544 FStar_Absyn_Syntax.dummyRange)))

# 1305 "FStar.Absyn.Util.fst"
let eqT_k : FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.knd = (fun k -> (let _100_1551 = (let _100_1550 = (let _100_1549 = (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder k)
in (let _100_1548 = (let _100_1547 = (FStar_Absyn_Syntax.null_t_binder k)
in (_100_1547)::[])
in (_100_1549)::_100_1548))
in (_100_1550, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _100_1551 FStar_Absyn_Syntax.dummyRange)))

# 1307 "FStar.Absyn.Util.fst"
let tforall_typ : FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.typ = (fun k -> (let _100_1554 = (allT_k k)
in (ftv FStar_Absyn_Const.allTyp_lid _100_1554)))

# 1309 "FStar.Absyn.Util.fst"
let mk_forallT : ((FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax FStar_Absyn_Syntax.bvdef, FStar_Absyn_Syntax.knd) FStar_Absyn_Syntax.withinfo_t  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun a b -> (let _100_1566 = (let _100_1565 = (tforall_typ a.FStar_Absyn_Syntax.sort)
in (let _100_1564 = (let _100_1563 = (let _100_1562 = (let _100_1561 = (let _100_1560 = (let _100_1559 = (FStar_Absyn_Syntax.t_binder a)
in (_100_1559)::[])
in (_100_1560, b))
in (FStar_Absyn_Syntax.mk_Typ_lam _100_1561 None b.FStar_Absyn_Syntax.pos))
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _100_1562))
in (_100_1563)::[])
in (_100_1565, _100_1564)))
in (FStar_Absyn_Syntax.mk_Typ_app _100_1566 None b.FStar_Absyn_Syntax.pos)))
...
in (let _100_1577 = (let _100_1576 = (let _100_1575 = (let _100_1574 = (let _100_1573 = (let _100_1572 = (let _100_1571 = (FStar_Absyn_Syntax.v_binder x)
in (_100_1571)::[])
in (_100_1572, body))
in (FStar_Absyn_Syntax.mk_Typ_lam _100_1573 None r))
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _100_1574))
in (_100_1575)::[])
in (tforall, _100_1576))
in (FStar_Absyn_Syntax.mk_Typ_app _100_1577 None r))))
...
| FStar_Util.Inl (a) -> begin
(let _100_1587 = (let _100_1586 = (tforall_typ a.FStar_Absyn_Syntax.sort)
in (let _100_1585 = (let _100_1584 = (FStar_Absyn_Syntax.targ body)
in (_100_1584)::[])
in (_100_1586, _100_1585)))
in (FStar_Absyn_Syntax.mk_Typ_app _100_1587 None f.FStar_Absyn_Syntax.pos))
end
| FStar_Util.Inr (x) -> begin
(let _100_1591 = (let _100_1590 = (let _100_1589 = (let _100_1588 = (FStar_Absyn_Syntax.targ body)
in (_100_1588)::[])
in ((FStar_Util.Inl (x.FStar_Absyn_Syntax.sort), Some (FStar_Absyn_Syntax.Implicit (false))))::_100_1589)
in (tforall, _100_1590))
in (FStar_Absyn_Syntax.mk_Typ_app _100_1591 None f.FStar_Absyn_Syntax.pos))
end))
end) bs f))
...
(let _100_1655 = (compress_typ t)
in (pats, _100_1655))
end
| _21_2325 -> begin
(let _100_1656 = (compress_typ t)
in ([], _100_1656))
end)))
in (
...
| (t, args) -> begin
(let _100_1670 = (FStar_All.pipe_right args (FStar_List.map (fun _21_26 -> (match (_21_26) with
| (FStar_Util.Inl (t), imp) -> begin
(let _100_1667 = (let _100_1666 = (compress_typ t)
in FStar_Util.Inl (_100_1666))
in (_100_1667, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _100_1669 = (let _100_1668 = (compress_exp e)
in FStar_Util.Inr (_100_1668))
in (_100_1669, imp))
end))))
in (t, _100_1670))
end)))
...
let rec aux = (fun qopt out t -> (match ((let _100_1677 = (flat t)
in (qopt, _100_1677))) with
