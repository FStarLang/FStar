...
let _32_36 = (let _132_8 = (let _132_7 = (FStar_Range.string_of_range r)
in (_132_7)::(if warning then begin
"Warning"
end else begin
"Error"
end)::(msg)::[])
...
| () -> begin
(let _132_36 = (let _132_35 = (let _132_31 = (FStar_ST.read n_resets)
in (FStar_Util.string_of_int _132_31))
in (let _132_34 = (let _132_33 = (let _132_32 = (

let _32_67 = (FStar_Util.incr ctr)
in (FStar_ST.read ctr))
in (FStar_Util.string_of_int _132_32))
in (Prims.strcat "_" _132_33))
in (Prims.strcat _132_35 _132_34)))
in (Prims.strcat "_" _132_36))
...
| _132_44 when (_132_44 = (Prims.parse_int "0")) -> begin
[]
end
| n -> begin
(let _132_46 = (gensym ())
in (let _132_45 = (gensyms (n - (Prims.parse_int "1")))
in (_132_46)::_132_45))
end))
...
let freshen_bvd = (fun bvd' -> (let _132_87 = (let _132_86 = (genident (Some ((range_of_bvd bvd'))))
in ((bvd'.FStar_Absyn_Syntax.ppname), (_132_86)))
in (mkbvd _132_87)))


let freshen_bvar = (fun b -> (let _132_89 = (freshen_bvd b.FStar_Absyn_Syntax.v)
in (bvd_to_bvar_s _132_89 b.FStar_Absyn_Syntax.sort)))
...
let fvar : FStar_Absyn_Syntax.fv_qual Prims.option  ->  FStar_Ident.lident  ->  FStar_Range.range  ->  FStar_Absyn_Syntax.exp = (fun dc l r -> (let _132_114 = (let _132_113 = (let _132_112 = (set_lid_range l r)
in (fv _132_112))
in ((_132_113), (dc)))
in (FStar_Absyn_Syntax.mk_Exp_fvar _132_114 None r)))
...
(let _132_123 = (let _132_122 = (btvar_to_typ a)
in FStar_Util.Inl (_132_122))
in ((_132_123), (imp)))
end
| FStar_Util.Inr (x) -> begin
(let _132_125 = (let _132_124 = (bvar_to_exp x)
in FStar_Util.Inr (_132_124))
in ((_132_125), (imp)))
end)
end))
...
(let _132_129 = (arg_of_non_null_binder b)
in (_132_129)::[])
end))))


let args_of_binders : FStar_Absyn_Syntax.binders  ->  (((((FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax FStar_Absyn_Syntax.bvdef, (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.withinfo_t, ((FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax FStar_Absyn_Syntax.bvdef, (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.withinfo_t) FStar_Util.either * FStar_Absyn_Syntax.arg_qualifier Prims.option) Prims.list * ((FStar_Absyn_Syntax.typ, FStar_Absyn_Syntax.exp) FStar_Util.either * FStar_Absyn_Syntax.arg_qualifier Prims.option) Prims.list) = (fun binders -> (let _132_139 = (FStar_All.pipe_right binders (FStar_List.map (fun b -> if (FStar_Absyn_Syntax.is_null_binder b) then begin
(

let b = (match ((Prims.fst b)) with
| FStar_Util.Inl (a) -> begin
(let _132_134 = (let _132_133 = (gen_bvar a.FStar_Absyn_Syntax.sort)
in FStar_Util.Inl (_132_133))
in ((_132_134), ((Prims.snd b))))
end
| FStar_Util.Inr (x) -> begin
(let _132_136 = (let _132_135 = (gen_bvar x.FStar_Absyn_Syntax.sort)
in FStar_Util.Inr (_132_135))
in ((_132_136), ((Prims.snd b))))
end)
in (let _132_137 = (arg_of_non_null_binder b)
in ((b), (_132_137))))
end else begin
(let _132_138 = (arg_of_non_null_binder b)
in ((b), (_132_138)))
end)))
in (FStar_All.pipe_right _132_139 FStar_List.unzip)))
...
let b = (let _132_145 = (let _132_144 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _132_144))
in (FStar_Ident.id_of_text _132_145))
in (
...
let x = (let _132_147 = (let _132_146 = (FStar_Util.string_of_int i)
...
(let _132_151 = (let _132_150 = (name_binders binders)
in ((_132_150), (comp)))
in (FStar_Absyn_Syntax.mk_Typ_fun _132_151 None t.FStar_Absyn_Syntax.pos))
end
| _32_220 -> begin
t
end))
...
(let _132_156 = (let _132_155 = (FStar_Absyn_Syntax.null_t_binder k)
in (FStar_All.pipe_left Prims.fst _132_155))
in ((_132_156), (imp)))
end
| (FStar_Util.Inr (t), imp) -> begin
(let _132_158 = (let _132_157 = (FStar_Absyn_Syntax.null_v_binder t)
in (FStar_All.pipe_left Prims.fst _132_157))
in ((_132_158), (imp)))
end)))))
...
let binders_of_freevars : FStar_Absyn_Syntax.freevars  ->  FStar_Absyn_Syntax.binder Prims.list = (fun fvs -> (let _132_171 = (let _132_168 = (FStar_Util.set_elements fvs.FStar_Absyn_Syntax.ftvs)
...
let subst_to_string = (fun s -> (let _132_174 = (FStar_All.pipe_right s (FStar_List.map (fun _32_4 -> (match (_32_4) with
...
in (let _132_233 = (FStar_List.map (fun _32_8 -> (match (_32_8) with
...
in {FStar_Absyn_Syntax.effect_name = _32_382.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = _132_234; FStar_Absyn_Syntax.effect_args = _132_233; FStar_Absyn_Syntax.flags = _132_232}))))
end))
...
| (FStar_Util.Inl (a), imp) -> begin
(let _132_266 = (let _132_265 = (

let _32_423 = a
in (let _132_264 = (subst_kind s a.FStar_Absyn_Syntax.sort)
in {FStar_Absyn_Syntax.v = _32_423.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _132_264; FStar_Absyn_Syntax.p = _32_423.FStar_Absyn_Syntax.p}))
in FStar_Util.Inl (_132_265))
in ((_132_266), (imp)))
end
| (FStar_Util.Inr (x), imp) -> begin
(let _132_269 = (let _132_268 = (

let _32_429 = x
in (let _132_267 = (subst_typ s x.FStar_Absyn_Syntax.sort)
in {FStar_Absyn_Syntax.v = _32_429.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _132_267; FStar_Absyn_Syntax.p = _32_429.FStar_Absyn_Syntax.p}))
...
| (args, descend) -> begin
(let _132_385 = (let _132_384 = (

let _32_566 = ct
in (let _132_383 = (map_flags s map_exp descend binders ct.FStar_Absyn_Syntax.flags)
in {FStar_Absyn_Syntax.effect_name = _32_566.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = args; FStar_Absyn_Syntax.flags = _132_383}))
...
let s = (let _132_513 = (let _132_512 = (let _132_511 = (btvar_to_typ b)
...
let s = (let _132_526 = (let _132_525 = (let _132_524 = (bvar_to_exp y)
...
let doit = (fun t -> (let _132_716 = (FStar_Absyn_Visit.reduce_typ (map_knd s) (visit_typ s) (map_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp alpha_ctrl [] t)
...
let mk_discriminator : FStar_Ident.lident  ->  FStar_Ident.lident = (fun lid -> (let _132_728 = (let _132_727 = (let _132_726 = (FStar_Absyn_Syntax.mk_ident (((Prims.strcat "is_" lid.FStar_Ident.ident.FStar_Ident.idText)), (lid.FStar_Ident.ident.FStar_Ident.idRange)))
in (_132_726)::[])
in (FStar_List.append lid.FStar_Ident.ns _132_727))
in (FStar_Ident.lid_of_ids _132_728)))
...
let ml_comp : FStar_Absyn_Syntax.typ  ->  FStar_Range.range  ->  FStar_Absyn_Syntax.comp = (fun t r -> (let _132_736 = (let _132_735 = (set_lid_range FStar_Absyn_Const.effect_ML_lid r)
in {FStar_Absyn_Syntax.effect_name = _132_735; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = []; FStar_Absyn_Syntax.flags = (FStar_Absyn_Syntax.MLEFFECT)::[]})
in (FStar_Absyn_Syntax.mk_Comp _132_736)))
...
let is_pure_or_ghost_function : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  Prims.bool = (fun t -> (match ((let _132_775 = (compress_typ t)
...
let is_lemma : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  Prims.bool = (fun t -> (match ((let _132_778 = (compress_typ t)
...
let is_smt_lemma : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  Prims.bool = (fun t -> (match ((let _132_781 = (compress_typ t)
in _132_781.FStar_Absyn_Syntax.n)) with
...
(match ((let _132_782 = (unmeta_exp pats)
in _132_782.FStar_Absyn_Syntax.n)) with
...
let rec is_atom : (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  Prims.bool = (fun e -> (match ((let _132_792 = (compress_exp e)
in _132_792.FStar_Absyn_Syntax.n)) with
...
let is_fun : (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  Prims.bool = (fun e -> (match ((let _132_806 = (compress_exp e)
...
let is_function_typ : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  Prims.bool = (fun t -> (match ((let _132_809 = (compress_typ t)
in _132_809.FStar_Absyn_Syntax.n)) with
...
| [] -> begin
(let _132_842 = (let _132_841 = (let _132_840 = (fvar (Some (FStar_Absyn_Syntax.Data_ctor)) l (FStar_Ident.range_of_lid l))
...
| _32_1398 -> begin
(let _132_846 = (let _132_845 = (let _132_844 = (let _132_843 = (fvar (Some (FStar_Absyn_Syntax.Data_ctor)) l (FStar_Ident.range_of_lid l))
in (mk_exp_app _132_843 args))
in ((_132_844), (FStar_Absyn_Syntax.Data_app)))
in FStar_Absyn_Syntax.Meta_desugared (_132_845))
in (FStar_Absyn_Syntax.mk_Exp_meta _132_846))
end))
...
(let _132_852 = (let _132_851 = (FStar_Util.substring_from x.FStar_Ident.idText (Prims.parse_int "7"))
in ((_132_851), (x.FStar_Ident.idRange)))
in (FStar_Ident.mk_ident _132_852))
end else begin
x
end)
...
(let _132_858 = (let _132_857 = (let _132_856 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _132_856))
in ((_132_857), (x.FStar_Absyn_Syntax.p)))
in (FStar_Absyn_Syntax.mk_ident _132_858))
end else begin
...
in (let _132_862 = (let _132_861 = (let _132_860 = (let _132_859 = (unmangle_field_name nm)
in (_132_859)::[])
in (FStar_List.append (FStar_Ident.ids_of_lid lid) _132_860))
in (FStar_Ident.lid_of_ids _132_861))
in ((_132_862), (y))))))


let unchecked_unify = (fun uv t -> (match ((FStar_Unionfind.find uv)) with
| FStar_Absyn_Syntax.Fixed (_32_1413) -> begin
(let _132_867 = (let _132_866 = (let _132_865 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _132_865))
in (FStar_Util.format1 "Changing a fixed uvar! U%s\n" _132_866))
in (failwith _132_867))
end
| _32_1416 -> begin
...
let union_uvs : FStar_Absyn_Syntax.uvars  ->  FStar_Absyn_Syntax.uvars  ->  FStar_Absyn_Syntax.uvars = (fun uvs1 uvs2 -> (let _132_884 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_k uvs2.FStar_Absyn_Syntax.uvars_k)
in (let _132_883 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_t uvs2.FStar_Absyn_Syntax.uvars_t)
in (let _132_882 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_e uvs2.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _132_884; FStar_Absyn_Syntax.uvars_t = _132_883; FStar_Absyn_Syntax.uvars_e = _132_882}))))


let union_fvs : FStar_Absyn_Syntax.freevars  ->  FStar_Absyn_Syntax.freevars  ->  FStar_Absyn_Syntax.freevars = (fun fvs1 fvs2 -> (let _132_890 = (FStar_Util.set_union fvs1.FStar_Absyn_Syntax.ftvs fvs2.FStar_Absyn_Syntax.ftvs)
in (let _132_889 = (FStar_Util.set_union fvs1.FStar_Absyn_Syntax.fxvs fvs2.FStar_Absyn_Syntax.fxvs)
in {FStar_Absyn_Syntax.ftvs = _132_890; FStar_Absyn_Syntax.fxvs = _132_889})))
...
(let _132_896 = (union_fvs fvs1 fvs2)
in (let _132_895 = (union_uvs uvs1 uvs2)
in ((_132_896), (_132_895))))
end))
...
let _32_1471 = fvs
in (let _132_900 = (FStar_Util.set_difference fvs.FStar_Absyn_Syntax.ftvs tvars)
in (let _132_899 = (FStar_Util.set_difference fvs.FStar_Absyn_Syntax.fxvs vvars)
in {FStar_Absyn_Syntax.ftvs = _132_900; FStar_Absyn_Syntax.fxvs = _132_899})))
in ((_132_901), (uvs)))
end))
...
let single_fv = (fun x -> (let _132_906 = (FStar_Absyn_Syntax.new_ftv_set ())
in (FStar_Util.set_add x _132_906)))


let single_uv = (fun u -> (let _132_908 = (FStar_Absyn_Syntax.new_uv_set ())
in (FStar_Util.set_add u _132_908)))


let single_uvt = (fun u -> (let _132_910 = (FStar_Absyn_Syntax.new_uvt_set ())
in (FStar_Util.set_add u _132_910)))
...
(let _132_1025 = (let _132_1024 = (

let _32_1495 = FStar_Absyn_Syntax.no_fvs
in (let _132_1023 = (single_fv a)
in {FStar_Absyn_Syntax.ftvs = _132_1023; FStar_Absyn_Syntax.fxvs = _32_1495.FStar_Absyn_Syntax.fxvs}))
in ((_132_1024), (FStar_Absyn_Syntax.no_uvs)))
in (cont _132_1025))
end
end
| FStar_Absyn_Syntax.Typ_uvar (uv, k) -> begin
(let _132_1028 = (let _132_1027 = (

let _32_1501 = FStar_Absyn_Syntax.no_uvs
in (let _132_1026 = (single_uvt ((uv), (k)))
in {FStar_Absyn_Syntax.uvars_k = _32_1501.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _132_1026; FStar_Absyn_Syntax.uvars_e = _32_1501.FStar_Absyn_Syntax.uvars_e}))
in ((FStar_Absyn_Syntax.no_fvs), (_132_1027)))
in (cont _132_1028))
end
...
| (bvs, vs1) -> begin
(vs_comp c uvonly (fun vs2 -> (let _132_1032 = (let _132_1031 = (union_fvs_uvs vs1 vs2)
in (sub_fv _132_1031 bvs))
in (cont _132_1032))))
end)))
end
| FStar_Absyn_Syntax.Typ_lam (bs, t) -> begin
...
| (bvs, vs1) -> begin
(vs_typ t uvonly (fun vs2 -> (let _132_1036 = (let _132_1035 = (union_fvs_uvs vs1 vs2)
in (sub_fv _132_1035 bvs))
in (cont _132_1036))))
end)))
end
| FStar_Absyn_Syntax.Typ_refine (x, t) -> begin
...
| (bvs, vs1) -> begin
(vs_typ t uvonly (fun vs2 -> (let _132_1040 = (let _132_1039 = (union_fvs_uvs vs1 vs2)
in (sub_fv _132_1039 bvs))
in (cont _132_1040))))
end)))
end
| FStar_Absyn_Syntax.Typ_app (t, args) -> begin
(vs_typ t uvonly (fun vs1 -> (vs_args args uvonly (fun vs2 -> (let _132_1043 = (union_fvs_uvs vs1 vs2)
in (cont _132_1043))))))
end
...
(vs_typ t1 uvonly (fun vs1 -> (vs_typ t2 uvonly (fun vs2 -> (let _132_1046 = (union_fvs_uvs vs1 vs2)
in (cont _132_1046))))))
end
...
(let _132_1053 = (let _132_1052 = (let _132_1050 = (FStar_Util.set_add a tvars)
in ((_132_1050), (vvars)))
in (let _132_1051 = (union_fvs_uvs vs vs2)
in ((_132_1052), (_132_1051))))
in (cont _132_1053))
end)))))
end
...
| ((tvars, vvars), vs2) -> begin
(let _132_1059 = (let _132_1058 = (let _132_1056 = (FStar_Util.set_add x vvars)
in ((tvars), (_132_1056)))
in (let _132_1057 = (union_fvs_uvs vs vs2)
in ((_132_1058), (_132_1057))))
in (cont _132_1059))
end)))))
end))
...
(vs_typ t uvonly (fun ft1 -> (vs_args tl uvonly (fun ft2 -> (let _132_1063 = (union_fvs_uvs ft1 ft2)
in (cont _132_1063))))))
end
| ((FStar_Util.Inr (e), _32_1627))::tl -> begin
(vs_exp e uvonly (fun ft1 -> (vs_args tl uvonly (fun ft2 -> (let _132_1066 = (union_fvs_uvs ft1 ft2)
in (cont _132_1066))))))
end))
and vs_typ = (fun t uvonly cont -> (match ((let _132_1069 = (FStar_ST.read t.FStar_Absyn_Syntax.fvs)
in (let _132_1068 = (FStar_ST.read t.FStar_Absyn_Syntax.uvs)
in ((_132_1069), (_132_1068))))) with
...
(let _132_1074 = (let _132_1073 = (FStar_Range.string_of_range k.FStar_Absyn_Syntax.pos)
in (FStar_Util.format1 "%s: Impossible ... found a Kind_lam bare" _132_1073))
in (failwith _132_1074))
end
...
| (fvs, uvs) -> begin
(let _132_1078 = (let _132_1077 = (

let _32_1682 = uvs
in (let _132_1076 = (FStar_Util.set_add uv uvs.FStar_Absyn_Syntax.uvars_k)
in {FStar_Absyn_Syntax.uvars_k = _132_1076; FStar_Absyn_Syntax.uvars_t = _32_1682.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _32_1682.FStar_Absyn_Syntax.uvars_e}))
in ((fvs), (_132_1077)))
in (cont _132_1078))
end)))
end
...
| (bvs, vs1) -> begin
(vs_kind k uvonly (fun vs2 -> (let _132_1082 = (let _132_1081 = (union_fvs_uvs vs1 vs2)
in (sub_fv _132_1081 bvs))
in (cont _132_1082))))
end)))
end)))
and vs_kind = (fun k uvonly cont -> (match ((let _132_1085 = (FStar_ST.read k.FStar_Absyn_Syntax.fvs)
in (let _132_1084 = (FStar_ST.read k.FStar_Absyn_Syntax.uvs)
in ((_132_1085), (_132_1084))))) with
...
(let _132_1091 = (let _132_1090 = (

let _32_1742 = FStar_Absyn_Syntax.no_uvs
in (let _132_1089 = (single_uvt ((uv), (t)))
in {FStar_Absyn_Syntax.uvars_k = _32_1742.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _32_1742.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _132_1089}))
in ((FStar_Absyn_Syntax.no_fvs), (_132_1090)))
in (cont _132_1091))
end
| FStar_Absyn_Syntax.Exp_bvar (x) -> begin
if uvonly then begin
...
(let _132_1094 = (let _132_1093 = (

let _32_1746 = FStar_Absyn_Syntax.no_fvs
in (let _132_1092 = (single_fv x)
in {FStar_Absyn_Syntax.ftvs = _32_1746.FStar_Absyn_Syntax.ftvs; FStar_Absyn_Syntax.fxvs = _132_1092}))
in ((_132_1093), (FStar_Absyn_Syntax.no_uvs)))
in (cont _132_1094))
end
end
...
| (bvs, vs1) -> begin
(vs_exp e uvonly (fun vs2 -> (let _132_1098 = (let _132_1097 = (union_fvs_uvs vs1 vs2)
in (sub_fv _132_1097 bvs))
in (cont _132_1098))))
end)))
end
| FStar_Absyn_Syntax.Exp_app (e, args) -> begin
(vs_exp e uvonly (fun ft1 -> (vs_args args uvonly (fun ft2 -> (let _132_1101 = (union_fvs_uvs ft1 ft2)
in (cont _132_1101))))))
end
...
and vs_exp = (fun e uvonly cont -> (match ((let _132_1104 = (FStar_ST.read e.FStar_Absyn_Syntax.fvs)
in (let _132_1103 = (FStar_ST.read e.FStar_Absyn_Syntax.uvs)
in ((_132_1104), (_132_1103))))) with
...
(vs_typ ct.FStar_Absyn_Syntax.result_typ uvonly (fun vs1 -> (vs_args ct.FStar_Absyn_Syntax.effect_args uvonly (fun vs2 -> (let _132_1110 = (union_fvs_uvs vs1 vs2)
in (k _132_1110))))))
end
end))
and vs_comp = (fun c uvonly cont -> (match ((let _132_1113 = (FStar_ST.read c.FStar_Absyn_Syntax.fvs)
in (let _132_1112 = (FStar_ST.read c.FStar_Absyn_Syntax.uvs)
in ((_132_1113), (_132_1112))))) with
...
| (hd)::tl -> begin
(vs_either hd uvonly (fun ft1 -> (vs_either_l tl uvonly (fun ft2 -> (let _132_1120 = (union_fvs_uvs ft1 ft2)
in (cont _132_1120))))))
end))
...
| FStar_Util.Inl (t) -> begin
(let _132_1136 = (freevars_typ t)
in (FStar_All.pipe_left (union_fvs out) _132_1136))
end
| FStar_Util.Inr (e) -> begin
(let _132_1137 = (freevars_exp e)
in (FStar_All.pipe_left (union_fvs out) _132_1137))
...
let out = (let _132_1211 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_k)
in (FStar_All.pipe_right _132_1211 (FStar_List.fold_left (fun out u -> (match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (k) -> begin
(let _132_1209 = (uvars_in_kind k)
in (union_uvs _132_1209 out))
end
| _32_1916 -> begin
(

let _32_1917 = out
in (let _132_1210 = (FStar_Util.set_add u out.FStar_Absyn_Syntax.uvars_k)
in {FStar_Absyn_Syntax.uvars_k = _132_1210; FStar_Absyn_Syntax.uvars_t = _32_1917.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _32_1917.FStar_Absyn_Syntax.uvars_e}))
end)) FStar_Absyn_Syntax.no_uvs)))
in (

let out = (let _132_1216 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_t)
in (FStar_All.pipe_right _132_1216 (FStar_List.fold_left (fun out _32_1923 -> (match (_32_1923) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (t) -> begin
(let _132_1214 = (uvars_in_typ t)
in (union_uvs _132_1214 out))
end
| _32_1927 -> begin
(

let _32_1928 = out
in (let _132_1215 = (FStar_Util.set_add ((u), (t)) out.FStar_Absyn_Syntax.uvars_t)
in {FStar_Absyn_Syntax.uvars_k = _32_1928.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _132_1215; FStar_Absyn_Syntax.uvars_e = _32_1928.FStar_Absyn_Syntax.uvars_e}))
end)
end)) out)))
in (

let out = (let _132_1221 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_e)
in (FStar_All.pipe_right _132_1221 (FStar_List.fold_left (fun out _32_1934 -> (match (_32_1934) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (e) -> begin
(let _132_1219 = (uvars_in_exp e)
in (union_uvs _132_1219 out))
end
| _32_1938 -> begin
(

let _32_1939 = out
in (let _132_1220 = (FStar_Util.set_add ((u), (t)) out.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _32_1939.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _32_1939.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _132_1220}))
end)
end)) out)))
in (
...
in out)))))
and uvars_in_kind : (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun k -> (let _132_1224 = (vs_kind k true (fun _32_1956 -> (match (_32_1956) with
| (_32_1954, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumKind (k))) _132_1224)))
and uvars_in_typ : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun t -> (let _132_1227 = (vs_typ t true (fun _32_1961 -> (match (_32_1961) with
| (_32_1959, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumType (t))) _132_1227)))
and uvars_in_exp : (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun e -> (let _132_1230 = (vs_exp e true (fun _32_1966 -> (match (_32_1966) with
| (_32_1964, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumExp (e))) _132_1230)))
and uvars_in_comp : (FStar_Absyn_Syntax.comp', Prims.unit) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun c -> (let _132_1233 = (vs_comp c true (fun _32_1971 -> (match (_32_1971) with
| (_32_1969, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumComp (c))) _132_1233)))
...
| _32_2033 -> begin
(let _132_1254 = (FStar_Absyn_Syntax.mk_Total t)
in ((tps), (_132_1254)))
end)
...
let t = (let _132_1267 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Tuple%s" _132_1267))
in (let _132_1268 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _132_1268 r))))


let mk_tuple_data_lid : Prims.int  ->  FStar_Range.range  ->  FStar_Ident.lident = (fun n r -> (

let t = (let _132_1273 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "MkTuple%s" _132_1273))
in (let _132_1274 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _132_1274 r))))


let is_tuple_data_lid : FStar_Absyn_Syntax.lident  ->  Prims.int  ->  Prims.bool = (fun f n -> (let _132_1279 = (mk_tuple_data_lid n FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Syntax.lid_equals f _132_1279)))
...
let t = (let _132_1286 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "DTuple%s" _132_1286))
in (let _132_1287 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _132_1287 r))))


let mk_dtuple_data_lid : Prims.int  ->  FStar_Range.range  ->  FStar_Ident.lident = (fun n r -> (

let t = (let _132_1292 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "MkDTuple%s" _132_1292))
in (let _132_1293 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _132_1293 r))))
...
let is_constructor : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _132_1309 = (pre_typ t)
in _132_1309.FStar_Absyn_Syntax.n)) with
...
let rec is_constructed_typ : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Ident.lident  ->  Prims.bool = (fun t lid -> (match ((let _132_1314 = (pre_typ t)
in _132_1314.FStar_Absyn_Syntax.n)) with
...
let b2t_v : FStar_Absyn_Syntax.typ = (let _132_1325 = (let _132_1324 = (let _132_1323 = (let _132_1322 = (FStar_All.pipe_left FStar_Absyn_Syntax.null_v_binder t_bool)
in (_132_1322)::[])
in ((_132_1323), (FStar_Absyn_Syntax.ktype)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _132_1324 FStar_Absyn_Syntax.dummyRange))
in (ftv FStar_Absyn_Const.b2t_lid _132_1325))
...
| Some (phi1) -> begin
(let _132_1336 = (let _132_1335 = (let _132_1333 = (let _132_1332 = (FStar_Absyn_Syntax.targ phi1)
in (let _132_1331 = (let _132_1330 = (FStar_Absyn_Syntax.targ phi2)
in (_132_1330)::[])
in (_132_1332)::_132_1331))
in ((tand), (_132_1333)))
in (let _132_1334 = (FStar_Range.union_ranges phi1.FStar_Absyn_Syntax.pos phi2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _132_1335 None _132_1334)))
in Some (_132_1336))
end))


let mk_binop : FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun op_t phi1 phi2 -> (let _132_1348 = (let _132_1346 = (let _132_1345 = (FStar_Absyn_Syntax.targ phi1)
in (let _132_1344 = (let _132_1343 = (FStar_Absyn_Syntax.targ phi2)
in (_132_1343)::[])
in (_132_1345)::_132_1344))
in ((op_t), (_132_1346)))
in (let _132_1347 = (FStar_Range.union_ranges phi1.FStar_Absyn_Syntax.pos phi2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _132_1348 None _132_1347))))


let mk_neg : FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun phi -> (let _132_1354 = (let _132_1353 = (ftv FStar_Absyn_Const.not_lid kt_kt)
in (let _132_1352 = (let _132_1351 = (FStar_Absyn_Syntax.targ phi)
in (_132_1351)::[])
in ((_132_1353), (_132_1352))))
in (FStar_Absyn_Syntax.mk_Typ_app _132_1354 None phi.FStar_Absyn_Syntax.pos)))
...
let mk_imp : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun phi1 phi2 -> (match ((let _132_1371 = (compress_typ phi1)
in _132_1371.FStar_Absyn_Syntax.n)) with
...
| _32_2150 -> begin
(match ((let _132_1372 = (compress_typ phi2)
in _132_1372.FStar_Absyn_Syntax.n)) with
...
let b2t : FStar_Absyn_Syntax.exp  ->  FStar_Absyn_Syntax.typ = (fun e -> (let _132_1381 = (let _132_1380 = (let _132_1379 = (FStar_All.pipe_left FStar_Absyn_Syntax.varg e)
in (_132_1379)::[])
in ((b2t_v), (_132_1380)))
in (FStar_Absyn_Syntax.mk_Typ_app _132_1381 None e.FStar_Absyn_Syntax.pos)))
...
let a = (let _132_1384 = (new_bvd None)
in (bvd_to_bvar_s _132_1384 FStar_Absyn_Syntax.ktype))
in (

let atyp = (btvar_to_typ a)
in (

let b = (let _132_1385 = (new_bvd None)
in (bvd_to_bvar_s _132_1385 FStar_Absyn_Syntax.ktype))
in (

let btyp = (btvar_to_typ b)
in (let _132_1392 = (let _132_1391 = (let _132_1390 = (let _132_1389 = (let _132_1388 = (FStar_Absyn_Syntax.null_v_binder atyp)
in (let _132_1387 = (let _132_1386 = (FStar_Absyn_Syntax.null_v_binder btyp)
in (_132_1386)::[])
in (_132_1388)::_132_1387))
in (((FStar_Util.Inl (b)), (Some (FStar_Absyn_Syntax.Implicit (false)))))::_132_1389)
in (((FStar_Util.Inl (a)), (Some (FStar_Absyn_Syntax.Implicit (false)))))::_132_1390)
in ((_132_1391), (FStar_Absyn_Syntax.ktype)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _132_1392 FStar_Absyn_Syntax.dummyRange))))))
...
| _32_2217 -> begin
(let _132_1410 = (let _132_1408 = (let _132_1407 = (FStar_Absyn_Syntax.itarg t1)
in (let _132_1406 = (let _132_1405 = (FStar_Absyn_Syntax.itarg t2)
in (let _132_1404 = (let _132_1403 = (FStar_Absyn_Syntax.varg e1)
in (let _132_1402 = (let _132_1401 = (FStar_Absyn_Syntax.varg e2)
in (_132_1401)::[])
in (_132_1403)::_132_1402))
in (_132_1405)::_132_1404))
in (_132_1407)::_132_1406))
in ((teq), (_132_1408)))
in (let _132_1409 = (FStar_Range.union_ranges e1.FStar_Absyn_Syntax.pos e2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _132_1410 None _132_1409)))
end))
...
let mk_eq_typ : FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun t1 t2 -> (let _132_1420 = (let _132_1418 = (let _132_1417 = (FStar_Absyn_Syntax.targ t1)
in (let _132_1416 = (let _132_1415 = (FStar_Absyn_Syntax.targ t2)
in (_132_1415)::[])
in (_132_1417)::_132_1416))
in ((eq_typ), (_132_1418)))
in (let _132_1419 = (FStar_Range.union_ranges t1.FStar_Absyn_Syntax.pos t2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _132_1420 None _132_1419))))
...
let lexcons = (let _132_1430 = (let _132_1429 = (let _132_1428 = (let _132_1426 = (FStar_Absyn_Syntax.t_binder a)
in (let _132_1425 = (let _132_1424 = (let _132_1421 = (btvar_to_typ a)
in (FStar_Absyn_Syntax.null_v_binder _132_1421))
in (let _132_1423 = (let _132_1422 = (FStar_Absyn_Syntax.null_v_binder lex_t)
in (_132_1422)::[])
in (_132_1424)::_132_1423))
in (_132_1426)::_132_1425))
in (let _132_1427 = (FStar_Absyn_Syntax.mk_Total lex_t)
in ((_132_1428), (_132_1427))))
in (FStar_Absyn_Syntax.mk_Typ_fun _132_1429 None FStar_Absyn_Syntax.dummyRange))
in (withinfo FStar_Absyn_Const.lexcons_lid _132_1430 FStar_Absyn_Syntax.dummyRange))
...
let a = (let _132_1431 = (new_bvd None)
in (bvd_to_bvar_s _132_1431 FStar_Absyn_Syntax.ktype))
in (

let atyp = (btvar_to_typ a)
in (let _132_1439 = (let _132_1438 = (let _132_1437 = (let _132_1436 = (let _132_1435 = (let _132_1434 = (let _132_1433 = (let _132_1432 = (FStar_Absyn_Syntax.null_v_binder atyp)
in (_132_1432)::[])
in ((_132_1433), (FStar_Absyn_Syntax.ktype)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _132_1434 FStar_Absyn_Syntax.dummyRange))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder _132_1435))
in (_132_1436)::[])
in (((FStar_Util.Inl (a)), (Some (FStar_Absyn_Syntax.Implicit (false)))))::_132_1437)
in ((_132_1438), (FStar_Absyn_Syntax.ktype)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _132_1439 FStar_Absyn_Syntax.dummyRange))))


let tforall : FStar_Absyn_Syntax.typ = (ftv FStar_Absyn_Const.forall_lid forall_kind)


let allT_k : FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.knd = (fun k -> (let _132_1448 = (let _132_1447 = (let _132_1446 = (let _132_1445 = (let _132_1444 = (let _132_1443 = (let _132_1442 = (FStar_Absyn_Syntax.null_t_binder k)
in (_132_1442)::[])
in ((_132_1443), (FStar_Absyn_Syntax.ktype)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _132_1444 FStar_Absyn_Syntax.dummyRange))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder _132_1445))
in (_132_1446)::[])
in ((_132_1447), (FStar_Absyn_Syntax.ktype)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _132_1448 FStar_Absyn_Syntax.dummyRange)))


let eqT_k : FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.knd = (fun k -> (let _132_1455 = (let _132_1454 = (let _132_1453 = (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder k)
in (let _132_1452 = (let _132_1451 = (FStar_Absyn_Syntax.null_t_binder k)
in (_132_1451)::[])
in (_132_1453)::_132_1452))
in ((_132_1454), (FStar_Absyn_Syntax.ktype)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _132_1455 FStar_Absyn_Syntax.dummyRange)))


let tforall_typ : FStar_Absyn_Syntax.knd  ->  FStar_Absyn_Syntax.typ = (fun k -> (let _132_1458 = (allT_k k)
in (ftv FStar_Absyn_Const.allTyp_lid _132_1458)))


let mk_forallT : ((FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax FStar_Absyn_Syntax.bvdef, FStar_Absyn_Syntax.knd) FStar_Absyn_Syntax.withinfo_t  ->  FStar_Absyn_Syntax.typ  ->  FStar_Absyn_Syntax.typ = (fun a b -> (let _132_1470 = (let _132_1469 = (tforall_typ a.FStar_Absyn_Syntax.sort)
in (let _132_1468 = (let _132_1467 = (let _132_1466 = (let _132_1465 = (let _132_1464 = (let _132_1463 = (FStar_Absyn_Syntax.t_binder a)
in (_132_1463)::[])
in ((_132_1464), (b)))
in (FStar_Absyn_Syntax.mk_Typ_lam _132_1465 None b.FStar_Absyn_Syntax.pos))
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _132_1466))
in (_132_1467)::[])
in ((_132_1469), (_132_1468))))
in (FStar_Absyn_Syntax.mk_Typ_app _132_1470 None b.FStar_Absyn_Syntax.pos)))
...
in (let _132_1481 = (let _132_1480 = (let _132_1479 = (let _132_1478 = (let _132_1477 = (let _132_1476 = (let _132_1475 = (FStar_Absyn_Syntax.v_binder x)
in (_132_1475)::[])
in ((_132_1476), (body)))
in (FStar_Absyn_Syntax.mk_Typ_lam _132_1477 None r))
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _132_1478))
in (_132_1479)::[])
in ((tforall), (_132_1480)))
in (FStar_Absyn_Syntax.mk_Typ_app _132_1481 None r))))
...
| FStar_Util.Inl (a) -> begin
(let _132_1491 = (let _132_1490 = (tforall_typ a.FStar_Absyn_Syntax.sort)
in (let _132_1489 = (let _132_1488 = (FStar_Absyn_Syntax.targ body)
in (_132_1488)::[])
in ((_132_1490), (_132_1489))))
in (FStar_Absyn_Syntax.mk_Typ_app _132_1491 None f.FStar_Absyn_Syntax.pos))
end
| FStar_Util.Inr (x) -> begin
(let _132_1495 = (let _132_1494 = (let _132_1493 = (let _132_1492 = (FStar_Absyn_Syntax.targ body)
in (_132_1492)::[])
in (((FStar_Util.Inl (x.FStar_Absyn_Syntax.sort)), (Some (FStar_Absyn_Syntax.Implicit (false)))))::_132_1493)
in ((tforall), (_132_1494)))
in (FStar_Absyn_Syntax.mk_Typ_app _132_1495 None f.FStar_Absyn_Syntax.pos))
end))
end) bs f))
...
(let _132_1559 = (compress_typ t)
in ((pats), (_132_1559)))
end
| _32_2325 -> begin
(let _132_1560 = (compress_typ t)
in (([]), (_132_1560)))
end)))
in (
...
| (t, args) -> begin
(let _132_1574 = (FStar_All.pipe_right args (FStar_List.map (fun _32_26 -> (match (_32_26) with
| (FStar_Util.Inl (t), imp) -> begin
(let _132_1571 = (let _132_1570 = (compress_typ t)
in FStar_Util.Inl (_132_1570))
in ((_132_1571), (imp)))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _132_1573 = (let _132_1572 = (compress_exp e)
in FStar_Util.Inr (_132_1572))
in ((_132_1573), (imp)))
end))))
in ((t), (_132_1574)))
end)))
...
let rec aux = (fun qopt out t -> (match ((let _132_1581 = (flat t)
in ((qopt), (_132_1581)))) with
