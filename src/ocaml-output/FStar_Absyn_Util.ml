...
(let _25_34 = (let _91_8 = (let _91_7 = (FStar_Range.string_of_range r)
...
(let _25_38 = (let _91_9 = (FStar_Util.format1 "Feature not yet implemented: %s" s)
...
| (FStar_Util.Inl (_25_155), FStar_Util.Inr (_25_158)) -> begin
(- (1))
end
| (FStar_Util.Inr (_25_162), FStar_Util.Inl (_25_165)) -> begin
1
end
| (FStar_Util.Inl (x), FStar_Util.Inl (y)) -> begin
...
let null_binders_of_tks = (fun tks -> (FStar_All.pipe_right tks (FStar_List.map (fun _25_2 -> (match (_25_2) with
...
let binders_of_tks = (fun tks -> (FStar_All.pipe_right tks (FStar_List.map (fun _25_3 -> (match (_25_3) with
| (FStar_Util.Inl (k), imp) -> begin
...
let subst_to_string = (fun s -> (let _91_182 = (FStar_All.pipe_right s (FStar_List.map (fun _25_4 -> (match (_25_4) with
| FStar_Util.Inl (b, _25_241) -> begin
b.FStar_Absyn_Syntax.realname.FStar_Absyn_Syntax.idText
end
| FStar_Util.Inr (x, _25_246) -> begin
x.FStar_Absyn_Syntax.realname.FStar_Absyn_Syntax.idText
end))))
in (FStar_All.pipe_right _91_182 (FStar_String.concat ", "))))

let subst_tvar = (fun s a -> (FStar_Util.find_map s (fun _25_5 -> (match (_25_5) with
...
let subst_xvar = (fun s a -> (FStar_Util.find_map s (fun _25_6 -> (match (_25_6) with
...
(let t = (mk_t ())
in (let _25_288 = (FStar_ST.op_Colon_Equals m (Some (t)))
in (subst_typ' s t)))
end
...
and subst_flags' = (fun s flags -> (FStar_All.pipe_right flags (FStar_List.map (fun _25_7 -> (match (_25_7) with
...
in (let _91_241 = (FStar_List.map (fun _25_8 -> (match (_25_8) with
...
in {FStar_Absyn_Syntax.effect_name = _25_377.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = _91_242; FStar_Absyn_Syntax.effect_args = _91_241; FStar_Absyn_Syntax.flags = _91_240}))))
end))
...
in {FStar_Absyn_Syntax.v = _25_418.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _91_272; FStar_Absyn_Syntax.p = _25_418.FStar_Absyn_Syntax.p}))
...
in {FStar_Absyn_Syntax.v = _25_424.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _91_275; FStar_Absyn_Syntax.p = _25_424.FStar_Absyn_Syntax.p}))
...
| ((FStar_Util.Inl (a), _25_451), (FStar_Util.Inl (t), _25_456)) -> begin
FStar_Util.Inl ((a.FStar_Absyn_Syntax.v, t))
end
| ((FStar_Util.Inr (x), _25_462), (FStar_Util.Inr (v), _25_467)) -> begin
...
let map_flags = (fun s map_exp descend binders flags -> (FStar_All.pipe_right flags (FStar_List.map (fun _25_11 -> (match (_25_11) with
...
| FStar_Absyn_Syntax.Comp (ct) -> begin
(let _25_557 = (map_typ descend binders ct.FStar_Absyn_Syntax.result_typ)
in (match (_25_557) with
| (t, descend) -> begin
(let _25_560 = (FStar_Absyn_Visit.map_args map_typ map_exp descend binders ct.FStar_Absyn_Syntax.effect_args)
...
in {FStar_Absyn_Syntax.effect_name = _25_561.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = args; FStar_Absyn_Syntax.flags = _91_391}))
...
in (let _25_584 = (FStar_ST.op_Colon_Equals m (Some (k')))
in k')))
end
...
let rec visit_typ = (fun s mk vt me ctrl boundvars t -> (let visit_prod = (fun bs tc -> (let _25_662 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun _25_615 b -> (match (_25_615) with
| (bs, boundvars, s) -> begin
(match (b) with
| (FStar_Util.Inl (a), imp) -> begin
(let _25_624 = (map_knd s mk vt me null_ctrl boundvars a.FStar_Absyn_Syntax.sort)
in (match (_25_624) with
| (k, _25_623) -> begin
(let a = (let _25_625 = a
in {FStar_Absyn_Syntax.v = _25_625.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = k; FStar_Absyn_Syntax.p = _25_625.FStar_Absyn_Syntax.p})
...
| (FStar_Util.Inr (x), imp) -> begin
(let _25_645 = (map_typ s mk vt me null_ctrl boundvars x.FStar_Absyn_Syntax.sort)
in (match (_25_645) with
| (t, _25_644) -> begin
(let x = (let _25_646 = x
in {FStar_Absyn_Syntax.v = _25_646.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = t; FStar_Absyn_Syntax.p = _25_646.FStar_Absyn_Syntax.p})
in (match ((FStar_Absyn_Syntax.is_null_binder b)) with
| true -> begin
...
| (_25_668, FStar_Util.Inl (t)) -> begin
...
| (_25_673, FStar_Util.Inr (c)) -> begin
...
in (let t0 = t
in (match (t0.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_btvar (_25_680) -> begin
...
| ((FStar_Util.Inr (x), _25_701)::[], FStar_Util.Inl (t)) -> begin
...
in (let _25_736 = (FStar_ST.op_Colon_Equals m (Some (res)))
in res)))
end
| FStar_Absyn_Syntax.Typ_delayed (FStar_Util.Inr (mk_t), m) -> begin
(let t = (let _91_604 = (mk_t ())
in (compress_typ' _91_604))
in (let _25_744 = (FStar_ST.op_Colon_Equals m (Some (t)))
in t))
end
| _25_747 -> begin
t
...
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_delayed (_25_751) -> begin
...
| FStar_Absyn_Syntax.Exp_bvar (_25_764) -> begin
...
in (let _25_783 = (FStar_ST.op_Colon_Equals m (Some (res)))
in res)))
end
| _25_786 -> begin
e
...
in (match (e.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, _25_791)) -> begin
(unmeta_exp e)
end
| FStar_Absyn_Syntax.Exp_ascribed (e, _25_797, _25_799) -> begin
(unmeta_exp e)
end
| _25_803 -> begin
e
...
| FStar_Absyn_Syntax.Typ_refine (_25_819) -> begin
(doit t)
end
| _25_822 -> begin
t
...
| FStar_Absyn_Syntax.Total (_25_854) -> begin
c
end
| FStar_Absyn_Syntax.Comp (ct) -> begin
(let _25_858 = c
in {FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Comp ((let _25_860 = ct
in {FStar_Absyn_Syntax.effect_name = _25_860.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = _25_860.FStar_Absyn_Syntax.result_typ; FStar_Absyn_Syntax.effect_args = _25_860.FStar_Absyn_Syntax.effect_args; FStar_Absyn_Syntax.flags = f})); FStar_Absyn_Syntax.tk = _25_858.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = _25_858.FStar_Absyn_Syntax.pos; FStar_Absyn_Syntax.fvs = _25_858.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _25_858.FStar_Absyn_Syntax.uvs})
end))

let comp_flags = (fun c -> (match (c.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Total (_25_864) -> begin
...
| FStar_Absyn_Syntax.Total (_25_872) -> begin
...
let is_total_comp = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun _25_13 -> (match (_25_13) with
...
let is_total_lcomp = (fun c -> ((FStar_Absyn_Syntax.lid_equals c.FStar_Absyn_Syntax.eff_name FStar_Absyn_Const.effect_Tot_lid) || (FStar_All.pipe_right c.FStar_Absyn_Syntax.cflags (FStar_Util.for_some (fun _25_14 -> (match (_25_14) with
| (FStar_Absyn_Syntax.TOTAL) | (FStar_Absyn_Syntax.RETURN) -> begin
true
end
| _25_890 -> begin
...
let is_partial_return = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun _25_16 -> (match (_25_16) with
...
let is_lcomp_partial_return = (fun c -> (FStar_All.pipe_right c.FStar_Absyn_Syntax.cflags (FStar_Util.for_some (fun _25_17 -> (match (_25_17) with
| (FStar_Absyn_Syntax.RETURN) | (FStar_Absyn_Syntax.PARTIAL_RETURN) -> begin
true
end
| _25_908 -> begin
...
| FStar_Absyn_Syntax.Typ_fun (_25_930, c) -> begin
...
| FStar_Absyn_Syntax.Typ_fun (_25_938, c) -> begin
...
| FStar_Absyn_Syntax.Typ_fun (_25_950, c) -> begin
(match (c.FStar_Absyn_Syntax.n) with
...
| _req::_ens::(FStar_Util.Inr (pats), _25_961)::_25_957 -> begin
(match ((let _91_790 = (unmeta_exp pats)
in _91_790.FStar_Absyn_Syntax.n)) with
| FStar_Absyn_Syntax.Exp_app ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Exp_fvar (fv, _25_978); FStar_Absyn_Syntax.tk = _25_975; FStar_Absyn_Syntax.pos = _25_973; FStar_Absyn_Syntax.fvs = _25_971; FStar_Absyn_Syntax.uvs = _25_969}, _25_983) -> begin
...
| FStar_Absyn_Syntax.Comp (c) -> begin
((FStar_Absyn_Syntax.lid_equals c.FStar_Absyn_Syntax.effect_name FStar_Absyn_Const.effect_ML_lid) || (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_Util.for_some (fun _25_20 -> (match (_25_20) with
...
| FStar_Absyn_Syntax.Total (_25_1011) -> begin
(FStar_Absyn_Syntax.mk_Total t)
end
| FStar_Absyn_Syntax.Comp (ct) -> begin
(FStar_Absyn_Syntax.mk_Comp (let _25_1015 = ct
in {FStar_Absyn_Syntax.effect_name = _25_1015.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = _25_1015.FStar_Absyn_Syntax.effect_args; FStar_Absyn_Syntax.flags = _25_1015.FStar_Absyn_Syntax.flags}))
end))

let is_trivial_wp = (fun c -> (FStar_All.pipe_right (comp_flags c) (FStar_Util.for_some (fun _25_21 -> (match (_25_21) with
| (FStar_Absyn_Syntax.TOTAL) | (FStar_Absyn_Syntax.RETURN) -> begin
true
end
| _25_1022 -> begin
...
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, _25_1035)) -> begin
(is_atom e)
end
| _25_1040 -> begin
false
...
| FStar_Absyn_Syntax.Exp_fvar (fv, _25_1044) -> begin
...
| FStar_Absyn_Syntax.Exp_ascribed (e, _25_1052, _25_1054) -> begin
(unascribe e)
end
| _25_1058 -> begin
e
...
| FStar_Absyn_Syntax.Typ_ascribed (t', _25_1063) -> begin
(ascribe_typ t' k)
end
| _25_1067 -> begin
...
| FStar_Absyn_Syntax.Typ_ascribed (t, _25_1071) -> begin
(unascribe_typ t)
end
| _25_1075 -> begin
t
...
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_refine (x, _25_1080) -> begin
(unrefine x.FStar_Absyn_Syntax.sort)
end
| FStar_Absyn_Syntax.Typ_ascribed (t, _25_1085) -> begin
(unrefine t)
end
| _25_1089 -> begin
t
...
| FStar_Absyn_Syntax.Exp_abs (_25_1092) -> begin
true
end
| _25_1095 -> begin
false
...
| FStar_Absyn_Syntax.Typ_fun (_25_1098) -> begin
true
end
| _25_1101 -> begin
false
...
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_refine (x, _25_1106) -> begin
(pre_typ x.FStar_Absyn_Syntax.sort)
end
| FStar_Absyn_Syntax.Typ_ascribed (t, _25_1111) -> begin
(pre_typ t)
end
| _25_1115 -> begin
t
...
| FStar_Absyn_Syntax.Typ_app ({FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Typ_const (tc); FStar_Absyn_Syntax.tk = _25_1126; FStar_Absyn_Syntax.pos = _25_1124; FStar_Absyn_Syntax.fvs = _25_1122; FStar_Absyn_Syntax.uvs = _25_1120}, args) when (FStar_Absyn_Syntax.lid_equals tc.FStar_Absyn_Syntax.v lid) -> begin
Some (args)
end
...
| FStar_Absyn_Syntax.Sig_new_effect (n, _25_1230) -> begin
...
| (FStar_Util.Inl (x), _25_1357, _25_1359) -> begin
(range_of_bvd x)
end
| (FStar_Util.Inr (l), _25_1364, _25_1366) -> begin
(FStar_Absyn_Syntax.range_of_lid l)
end))

let range_of_arg = (fun _25_23 -> (match (_25_23) with
| (FStar_Util.Inl (hd), _25_1372) -> begin
hd.FStar_Absyn_Syntax.pos
end
| (FStar_Util.Inr (hd), _25_1377) -> begin
hd.FStar_Absyn_Syntax.pos
end))
...
in (let y = (let _25_1402 = x.FStar_Absyn_Syntax.v
in {FStar_Absyn_Syntax.ppname = nm; FStar_Absyn_Syntax.realname = _25_1402.FStar_Absyn_Syntax.realname})
...
| FStar_Absyn_Syntax.Fixed (_25_1408) -> begin
...
| (fvs, uvs) -> begin
(let _25_1475 = (FStar_ST.op_Colon_Equals s.FStar_Absyn_Syntax.uvs (Some (uvs)))
...
in (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_delayed (_25_1486) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Absyn_Syntax.Typ_btvar (a) -> begin
(match (uvonly) with
...
| false -> begin
(let _91_1082 = (let _91_1081 = (let _25_1490 = FStar_Absyn_Syntax.no_fvs
in (let _91_1080 = (single_fv a)
in {FStar_Absyn_Syntax.ftvs = _91_1080; FStar_Absyn_Syntax.fxvs = _25_1490.FStar_Absyn_Syntax.fxvs}))
in (_91_1081, FStar_Absyn_Syntax.no_uvs))
in (cont _91_1082))
end)
end
| FStar_Absyn_Syntax.Typ_uvar (uv, k) -> begin
(let _91_1085 = (let _91_1084 = (let _25_1496 = FStar_Absyn_Syntax.no_uvs
in (let _91_1083 = (single_uvt (uv, k))
in {FStar_Absyn_Syntax.uvars_k = _25_1496.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _91_1083; FStar_Absyn_Syntax.uvars_e = _25_1496.FStar_Absyn_Syntax.uvars_e}))
...
| FStar_Absyn_Syntax.Typ_refine (x, t) -> begin
(vs_binders (((FStar_Util.Inr (x), None))::[]) uvonly (fun _25_1524 -> (match (_25_1524) with
| (bvs, vs1) -> begin
...
| FStar_Absyn_Syntax.Typ_ascribed (t, _25_1534) -> begin
(vs_typ t uvonly cont)
end
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_slack_formula (t1, t2, _25_1540)) -> begin
...
| (FStar_Util.Inl (a), _25_1582)::rest -> begin
(vs_kind a.FStar_Absyn_Syntax.sort uvonly (fun vs -> (vs_binders rest uvonly (fun _25_1590 -> (match (_25_1590) with
...
| (FStar_Util.Inr (x), _25_1595)::rest -> begin
(vs_typ x.FStar_Absyn_Syntax.sort uvonly (fun vs -> (vs_binders rest uvonly (fun _25_1603 -> (match (_25_1603) with
| ((tvars, vvars), vs2) -> begin
...
in (match (k.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_lam (_25_1660, k) -> begin
...
| FStar_Absyn_Syntax.Kind_delayed (_25_1665) -> begin
(FStar_All.failwith "Impossible")
end
...
in {FStar_Absyn_Syntax.uvars_k = _91_1181; FStar_Absyn_Syntax.uvars_t = _25_1677.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _25_1677.FStar_Absyn_Syntax.uvars_e}))
in (fvs, _91_1182))
in (cont _91_1183))
end)))
end
| FStar_Absyn_Syntax.Kind_abbrev (_25_1680, k) -> begin
...
in (match (e.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_delayed (_25_1725) -> begin
(FStar_All.failwith "impossible")
end
...
(let _91_1196 = (let _91_1195 = (let _25_1737 = FStar_Absyn_Syntax.no_uvs
in (let _91_1194 = (single_uvt (uv, t))
in {FStar_Absyn_Syntax.uvars_k = _25_1737.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _25_1737.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _91_1194}))
...
| false -> begin
(let _91_1199 = (let _91_1198 = (let _25_1741 = FStar_Absyn_Syntax.no_fvs
in (let _91_1197 = (single_fv x)
in {FStar_Absyn_Syntax.ftvs = _25_1741.FStar_Absyn_Syntax.ftvs; FStar_Absyn_Syntax.fxvs = _91_1197}))
in (_91_1198, FStar_Absyn_Syntax.no_uvs))
in (cont _91_1199))
end)
end
| FStar_Absyn_Syntax.Exp_ascribed (e, _25_1745, _25_1747) -> begin
...
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, _25_1772)) -> begin
(vs_exp e uvonly cont)
end)))
...
let is_free = (fun axs fvs -> (FStar_All.pipe_right axs (FStar_Util.for_some (fun _25_24 -> (match (_25_24) with
| FStar_Util.Inl (a) -> begin
...
in {FStar_Absyn_Syntax.uvars_k = _91_1315; FStar_Absyn_Syntax.uvars_t = _25_1912.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _25_1912.FStar_Absyn_Syntax.uvars_e}))
end)) FStar_Absyn_Syntax.no_uvs)))
in (let out = (let _91_1321 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_t)
in (FStar_All.pipe_right _91_1321 (FStar_List.fold_left (fun out _25_1918 -> (match (_25_1918) with
| (u, t) -> begin
...
in {FStar_Absyn_Syntax.uvars_k = _25_1923.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _91_1320; FStar_Absyn_Syntax.uvars_e = _25_1923.FStar_Absyn_Syntax.uvars_e}))
end)
end)) out)))
in (let out = (let _91_1326 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_e)
in (FStar_All.pipe_right _91_1326 (FStar_List.fold_left (fun out _25_1929 -> (match (_25_1929) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
...
in {FStar_Absyn_Syntax.uvars_k = _25_1934.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _25_1934.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _91_1325}))
end)
end)) out)))
...
in (match (k.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_lam (_25_1972) -> begin
(FStar_All.failwith "Impossible")
end
...
| FStar_Absyn_Syntax.Kind_abbrev (_25_1988, k) -> begin
(kind_formals k)
end
| FStar_Absyn_Syntax.Kind_delayed (_25_1993) -> begin
(FStar_All.failwith "Impossible")
end)))
...
in (match (k.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Kind_abbrev (_25_2007, k) -> begin
(unabbreviate_kind k)
end
| _25_2012 -> begin
k
...
| _25_2022 -> begin
(let _25_2031 = (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_fun (bs', c) -> begin
...
| FStar_Absyn_Syntax.Typ_const (_25_2077) -> begin
(is_constructor t lid)
end
| FStar_Absyn_Syntax.Typ_app (t, _25_2081) -> begin
...
| FStar_Absyn_Syntax.Typ_app (t, _25_2096) -> begin
(get_tycon t)
end
| _25_2100 -> begin
None
...
let sortByFieldName = (fun fn_a_l -> (FStar_All.pipe_right fn_a_l (FStar_List.sortWith (fun _25_2110 _25_2114 -> (match ((_25_2110, _25_2114)) with
...
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_slack_formula (t1, t2, _25_2189)) -> begin
(mk_conj t1 t2)
end
| _25_2194 -> begin
t
...
| FStar_Absyn_Syntax.Pat_wild (_25_2239) -> begin
true
end
| _25_2242 -> begin
false
...
| (FStar_Util.Inl (_25_2300), _25_2303) -> begin
(flag = type_sort)
end
| (FStar_Util.Inr (_25_2306), _25_2309) -> begin
(flag = term_sort)
end)) args arity))) with
| true -> begin
...
| (t, args) -> begin
(let _91_1681 = (FStar_All.pipe_right args (FStar_List.map (fun _25_26 -> (match (_25_26) with
| (FStar_Util.Inl (t), imp) -> begin
