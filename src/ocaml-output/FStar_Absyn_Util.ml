...
(let _26_34 = (let _95_8 = (let _95_7 = (FStar_Range.string_of_range r)
in (FStar_Util.format3 "%s : %s\n%s\n" _95_7 (match (warning) with
| true -> begin
"Warning"
end
| false -> begin
...
in (FStar_Util.print_string _95_8))
in ())
end
| FStar_Util.NYI (s) -> begin
(let _26_38 = (let _95_9 = (FStar_Util.format1 "Feature not yet implemented: %s" s)
in (FStar_Util.print_string _95_9))
in ())
end
| FStar_Absyn_Syntax.Err (s) -> begin
(let _95_10 = (FStar_Util.format1 "Error: %s" s)
in (FStar_Util.print_string _95_10))
end
| _26_43 -> begin
(Prims.raise e)
end))
...
| () -> begin
(let _95_38 = (let _95_35 = (let _95_34 = (let _95_33 = (FStar_ST.read n_resets)
in (FStar_Util.string_of_int _95_33))
in (Prims.strcat "_" _95_34))
in (Prims.strcat _95_35 "_"))
in (let _95_37 = (let _95_36 = (let _26_62 = (FStar_Util.incr ctr)
in (FStar_ST.read ctr))
in (FStar_Util.string_of_int _95_36))
in (Prims.strcat _95_38 _95_37)))
...
let freshen_bvd = (fun bvd' -> (let _95_88 = (let _95_87 = (genident (Some ((range_of_bvd bvd'))))
in (bvd'.FStar_Absyn_Syntax.ppname, _95_87))
in (mkbvd _95_88)))

let freshen_bvar = (fun b -> (let _95_90 = (freshen_bvd b.FStar_Absyn_Syntax.v)
in (bvd_to_bvar_s _95_90 b.FStar_Absyn_Syntax.sort)))
...
let set_bvd_range = (fun bvd r -> (let _95_99 = (FStar_Absyn_Syntax.mk_ident (bvd.FStar_Absyn_Syntax.ppname.FStar_Absyn_Syntax.idText, r))
in (let _95_98 = (FStar_Absyn_Syntax.mk_ident (bvd.FStar_Absyn_Syntax.realname.FStar_Absyn_Syntax.idText, r))
in {FStar_Absyn_Syntax.ppname = _95_99; FStar_Absyn_Syntax.realname = _95_98})))
...
let fv = (fun l -> (let _95_107 = (FStar_Absyn_Syntax.range_of_lid l)
in (withinfo l FStar_Absyn_Syntax.tun _95_107)))

let fvvar_of_lid = (fun l t -> (let _95_110 = (FStar_Absyn_Syntax.range_of_lid l)
in (withinfo l t _95_110)))

let fvar = (fun dc l r -> (let _95_119 = (let _95_118 = (let _95_117 = (set_lid_range l r)
in (fv _95_117))
in (_95_118, dc))
in (FStar_Absyn_Syntax.mk_Exp_fvar _95_119 None r)))

let ftv = (fun l k -> (let _95_126 = (let _95_124 = (FStar_Absyn_Syntax.range_of_lid l)
in (withinfo l k _95_124))
in (let _95_125 = (FStar_Absyn_Syntax.range_of_lid l)
in (FStar_Absyn_Syntax.mk_Typ_const _95_126 None _95_125))))
...
(let _95_131 = (let _95_130 = (btvar_to_typ a)
in FStar_Util.Inl (_95_130))
in (_95_131, imp))
end
| FStar_Util.Inr (x) -> begin
(let _95_133 = (let _95_132 = (bvar_to_exp x)
in FStar_Util.Inr (_95_132))
in (_95_133, imp))
end)
end))
...
| false -> begin
(let _95_137 = (arg_of_non_null_binder b)
in (_95_137)::[])
end)))))

let args_of_binders = (fun binders -> (let _95_147 = (FStar_All.pipe_right binders (FStar_List.map (fun b -> (match ((FStar_Absyn_Syntax.is_null_binder b)) with
| true -> begin
(let b = (match ((Prims.fst b)) with
| FStar_Util.Inl (a) -> begin
(let _95_142 = (let _95_141 = (gen_bvar a.FStar_Absyn_Syntax.sort)
in FStar_Util.Inl (_95_141))
in (_95_142, (Prims.snd b)))
end
| FStar_Util.Inr (x) -> begin
(let _95_144 = (let _95_143 = (gen_bvar x.FStar_Absyn_Syntax.sort)
in FStar_Util.Inr (_95_143))
in (_95_144, (Prims.snd b)))
end)
in (let _95_145 = (arg_of_non_null_binder b)
in (b, _95_145)))
end
| false -> begin
(let _95_146 = (arg_of_non_null_binder b)
in (b, _95_146))
end))))
in (FStar_All.pipe_right _95_147 FStar_List.unzip)))
...
(let b = (let _95_153 = (let _95_152 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _95_152))
in (FStar_Absyn_Syntax.id_of_text _95_153))
in (let b = (bvd_to_bvar_s (mkbvd (b, b)) a.FStar_Absyn_Syntax.sort)
in (FStar_Util.Inl (b), imp)))
end
| (FStar_Util.Inr (y), imp) -> begin
(let x = (let _95_155 = (let _95_154 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _95_154))
in (FStar_Absyn_Syntax.id_of_text _95_155))
...
(let _95_159 = (let _95_158 = (name_binders binders)
in (_95_158, comp))
in (FStar_Absyn_Syntax.mk_Typ_fun _95_159 None t.FStar_Absyn_Syntax.pos))
end
| _26_215 -> begin
t
end))
...
(let _95_164 = (let _95_163 = (FStar_Absyn_Syntax.null_t_binder k)
in (FStar_All.pipe_left Prims.fst _95_163))
in (_95_164, imp))
end
| (FStar_Util.Inr (t), imp) -> begin
(let _95_166 = (let _95_165 = (FStar_Absyn_Syntax.null_v_binder t)
in (FStar_All.pipe_left Prims.fst _95_165))
in (_95_166, imp))
end)))))

let binders_of_tks = (fun tks -> (FStar_All.pipe_right tks (FStar_List.map (fun _26_3 -> (match (_26_3) with
| (FStar_Util.Inl (k), imp) -> begin
(let _95_171 = (let _95_170 = (gen_bvar_p k.FStar_Absyn_Syntax.pos k)
in FStar_Util.Inl (_95_170))
in (_95_171, imp))
end
| (FStar_Util.Inr (t), imp) -> begin
(let _95_173 = (let _95_172 = (gen_bvar_p t.FStar_Absyn_Syntax.pos t)
in FStar_Util.Inr (_95_172))
in (_95_173, imp))
end)))))

let binders_of_freevars = (fun fvs -> (let _95_179 = (let _95_176 = (FStar_Util.set_elements fvs.FStar_Absyn_Syntax.ftvs)
in (FStar_All.pipe_right _95_176 (FStar_List.map FStar_Absyn_Syntax.t_binder)))
in (let _95_178 = (let _95_177 = (FStar_Util.set_elements fvs.FStar_Absyn_Syntax.fxvs)
in (FStar_All.pipe_right _95_177 (FStar_List.map FStar_Absyn_Syntax.v_binder)))
in (FStar_List.append _95_179 _95_178))))

let subst_to_string = (fun s -> (let _95_182 = (FStar_All.pipe_right s (FStar_List.map (fun _26_4 -> (match (_26_4) with
...
in (FStar_All.pipe_right _95_182 (FStar_String.concat ", "))))
...
(let _95_207 = (let _95_206 = (compose_subst s' s)
in (let _95_205 = (FStar_Util.mk_ref None)
in (t', _95_206, _95_205)))
in (FStar_Absyn_Syntax.mk_Typ_delayed _95_207 None t.FStar_Absyn_Syntax.pos))
end
...
| _26_311 -> begin
(let _95_212 = (let _95_211 = (FStar_Util.mk_ref None)
in (t0, s, _95_211))
in (FStar_Absyn_Syntax.mk_Typ_delayed _95_212 None t.FStar_Absyn_Syntax.pos))
end))
end))
...
(let _95_217 = (let _95_216 = (compose_subst s' s)
in (let _95_215 = (FStar_Util.mk_ref None)
in (e, _95_216, _95_215)))
in (FStar_Absyn_Syntax.mk_Exp_delayed _95_217 None e.FStar_Absyn_Syntax.pos))
end
...
| _26_345 -> begin
(let _95_221 = (let _95_220 = (FStar_Util.mk_ref None)
in (e0, s, _95_220))
in (FStar_Absyn_Syntax.mk_Exp_delayed _95_221 None e0.FStar_Absyn_Syntax.pos))
end))
end))
...
(let _95_226 = (let _95_225 = (compose_subst s' s)
in (let _95_224 = (FStar_Util.mk_ref None)
in (k, _95_225, _95_224)))
in (FStar_Absyn_Syntax.mk_Kind_delayed _95_226 k0.FStar_Absyn_Syntax.pos))
end
| _26_363 -> begin
(let _95_228 = (let _95_227 = (FStar_Util.mk_ref None)
in (k0, s, _95_227))
in (FStar_Absyn_Syntax.mk_Kind_delayed _95_228 k0.FStar_Absyn_Syntax.pos))
end))
end))
...
(let _95_232 = (subst_exp' s a)
in FStar_Absyn_Syntax.DECREASES (_95_232))
end
| f -> begin
f
end)))))
...
| _26_376 -> begin
(let _26_377 = t
in (let _95_242 = (subst_typ' s t.FStar_Absyn_Syntax.result_typ)
in (let _95_241 = (FStar_List.map (fun _26_8 -> (match (_26_8) with
| (FStar_Util.Inl (t), imp) -> begin
(let _95_237 = (let _95_236 = (subst_typ' s t)
in FStar_Util.Inl (_95_236))
in (_95_237, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _95_239 = (let _95_238 = (subst_exp' s e)
in FStar_Util.Inr (_95_238))
in (_95_239, imp))
end)) t.FStar_Absyn_Syntax.effect_args)
in (let _95_240 = (subst_flags' s t.FStar_Absyn_Syntax.flags)
in {FStar_Absyn_Syntax.effect_name = _26_377.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = _95_242; FStar_Absyn_Syntax.effect_args = _95_241; FStar_Absyn_Syntax.flags = _95_240}))))
end))
...
(let _95_245 = (subst_typ' s t)
in (FStar_Absyn_Syntax.mk_Total _95_245))
end
| FStar_Absyn_Syntax.Comp (ct) -> begin
(let _95_246 = (subst_comp_typ' s ct)
in (FStar_Absyn_Syntax.mk_Comp _95_246))
end)
end))
...
| (FStar_Util.Inl (a), imp) -> begin
(let _95_274 = (let _95_273 = (let _26_418 = a
in (let _95_272 = (subst_kind s a.FStar_Absyn_Syntax.sort)
in {FStar_Absyn_Syntax.v = _26_418.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _95_272; FStar_Absyn_Syntax.p = _26_418.FStar_Absyn_Syntax.p}))
in FStar_Util.Inl (_95_273))
in (_95_274, imp))
end
| (FStar_Util.Inr (x), imp) -> begin
(let _95_277 = (let _95_276 = (let _26_424 = x
in (let _95_275 = (subst_typ s x.FStar_Absyn_Syntax.sort)
in {FStar_Absyn_Syntax.v = _26_424.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _95_275; FStar_Absyn_Syntax.p = _26_424.FStar_Absyn_Syntax.p}))
in FStar_Util.Inr (_95_276))
in (_95_277, imp))
end))

let subst_arg = (fun s _26_10 -> (match (_26_10) with
| (FStar_Util.Inl (t), imp) -> begin
(let _95_281 = (let _95_280 = (subst_typ s t)
in FStar_Util.Inl (_95_280))
in (_95_281, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _95_283 = (let _95_282 = (subst_exp s e)
in FStar_Util.Inr (_95_282))
in (_95_283, imp))
end))
...
| false -> begin
(let _95_298 = (let _95_297 = (let _95_296 = (btvar_to_typ a)
in (b.FStar_Absyn_Syntax.v, _95_296))
in FStar_Util.Inl (_95_297))
in (_95_298)::[])
end)
end
| (FStar_Util.Inr (x), FStar_Util.Inr (y)) -> begin
...
| false -> begin
(let _95_301 = (let _95_300 = (let _95_299 = (bvar_to_exp x)
in (y.FStar_Absyn_Syntax.v, _95_299))
in FStar_Util.Inr (_95_300))
in (_95_301)::[])
end)
end
| _26_485 -> begin
...
| (b1::bs1, b2::bs2) -> begin
(let _95_313 = (let _95_312 = (mk_subst_one_binder b1 b2)
in (FStar_List.append _95_312 out))
in (aux _95_313 bs1 bs2))
end
| _26_503 -> begin
None
end))
...
let map_knd = (fun s vk mt me descend binders k -> (let _95_334 = (subst_kind' s k)
in (_95_334, descend)))

let map_typ = (fun s mk vt me descend binders t -> (let _95_342 = (subst_typ' s t)
in (_95_342, descend)))

let map_exp = (fun s mk me ve descend binders e -> (let _95_350 = (subst_exp' s e)
in (_95_350, descend)))
...
(let _95_367 = (let _95_366 = (map_exp descend binders e)
in (FStar_All.pipe_right _95_366 Prims.fst))
in FStar_Absyn_Syntax.DECREASES (_95_367))
end
| f -> begin
f
end)))))
...
| (t, descend) -> begin
(let _95_390 = (FStar_Absyn_Syntax.mk_Total t)
in (_95_390, descend))
end))
end
| FStar_Absyn_Syntax.Comp (ct) -> begin
...
| (args, descend) -> begin
(let _95_393 = (let _95_392 = (let _26_561 = ct
in (let _95_391 = (map_flags s map_exp descend binders ct.FStar_Absyn_Syntax.flags)
in {FStar_Absyn_Syntax.effect_name = _26_561.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = args; FStar_Absyn_Syntax.flags = _95_391}))
in (FStar_Absyn_Syntax.mk_Comp _95_392))
in (_95_393, descend))
end))
end))
end))
...
| FStar_Absyn_Syntax.Kind_delayed (k', s, m) -> begin
(let k' = (let _95_439 = (FStar_Absyn_Visit.reduce_kind (visit_knd s) (map_typ s) (map_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp subst_ctrl [] k')
in (FStar_All.pipe_left Prims.fst _95_439))
...
(let _95_441 = (let _95_440 = (subst_of_list formals actuals)
in (subst_kind _95_440 k'))
in (compress_kind _95_441))
end
| _26_597 -> begin
...
| _26_631 -> begin
(let b = (let _95_518 = (freshen_bvd a.FStar_Absyn_Syntax.v)
in (bvd_to_bvar_s _95_518 k))
in (let s = (let _95_521 = (let _95_520 = (let _95_519 = (btvar_to_typ b)
in (a.FStar_Absyn_Syntax.v, _95_519))
in FStar_Util.Inl (_95_520))
in (extend_subst _95_521 s))
...
| _26_652 -> begin
(let y = (let _95_531 = (freshen_bvd x.FStar_Absyn_Syntax.v)
in (bvd_to_bvar_s _95_531 t))
in (let s = (let _95_534 = (let _95_533 = (let _95_532 = (bvar_to_exp y)
in (x.FStar_Absyn_Syntax.v, _95_532))
in FStar_Util.Inr (_95_533))
in (extend_subst _95_534 s))
...
(let _95_545 = (let _95_544 = (map_typ s mk vt me null_ctrl boundvars t)
in (FStar_All.pipe_left Prims.fst _95_544))
in FStar_Util.Inl (_95_545))
end
| (_26_673, FStar_Util.Inr (c)) -> begin
(let _95_568 = (let _95_567 = (map_comp s mk (map_typ s mk vt me) (map_exp s mk vt me) null_ctrl boundvars c)
in (FStar_All.pipe_left Prims.fst _95_567))
in FStar_Util.Inr (_95_568))
end)
...
(let _95_570 = (let _95_569 = (subst_typ' s t0)
in (FStar_All.pipe_left compress_typ _95_569))
in (_95_570, ctrl))
end
...
(let _95_580 = (FStar_Absyn_Syntax.mk_Typ_fun (bs, c) None t0.FStar_Absyn_Syntax.pos)
in (_95_580, ctrl))
end
| _26_693 -> begin
...
(let _95_581 = (FStar_Absyn_Syntax.mk_Typ_refine (x, t) None t0.FStar_Absyn_Syntax.pos)
in (_95_581, ctrl))
end
| _26_708 -> begin
(FStar_All.failwith "Impossible")
...
(let _95_582 = (FStar_Absyn_Syntax.mk_Typ_lam (bs, t) None t0.FStar_Absyn_Syntax.pos)
in (_95_582, ctrl))
end
| _26_718 -> begin
(FStar_All.failwith "Impossible")
...
| FStar_Absyn_Syntax.Typ_delayed (FStar_Util.Inl (t', s), m) -> begin
(let res = (let _95_602 = (FStar_Absyn_Visit.reduce_typ (map_knd s) (visit_typ s) (map_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp subst_ctrl [] t')
in (FStar_All.pipe_left Prims.fst _95_602))
in (let res = (compress_typ' res)
in (let _26_736 = (FStar_ST.op_Colon_Equals m (Some (res)))
in res)))
end
| FStar_Absyn_Syntax.Typ_delayed (FStar_Util.Inr (mk_t), m) -> begin
(let t = (let _95_604 = (mk_t ())
in (compress_typ' _95_604))
...
(let _95_670 = (let _95_669 = (subst_exp' s e)
in (FStar_All.pipe_left compress_exp _95_669))
in (_95_670, ctrl))
end
...
in (match (e.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Exp_delayed (e', s, m) -> begin
(let e = (let _95_699 = (FStar_Absyn_Visit.reduce_exp (map_knd s) (map_typ s) (visit_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp subst_ctrl [] e')
in (FStar_All.pipe_left Prims.fst _95_699))
...
in (let s = (mk_subst [])
in (let doit = (fun t -> (let _95_724 = (FStar_Absyn_Visit.reduce_typ (map_knd s) (visit_typ s) (map_exp s) FStar_Absyn_Visit.combine_kind FStar_Absyn_Visit.combine_typ FStar_Absyn_Visit.combine_exp alpha_ctrl [] t)
in (FStar_All.pipe_left Prims.fst _95_724)))
in (match (t.FStar_Absyn_Syntax.n) with
...
| Some (t) -> begin
(let _95_731 = (compress_typ t)
in Some (_95_731))
end))

let mk_discriminator = (fun lid -> (let _95_736 = (let _95_735 = (let _95_734 = (FStar_Absyn_Syntax.mk_ident ((Prims.strcat "is_" lid.FStar_Absyn_Syntax.ident.FStar_Absyn_Syntax.idText), lid.FStar_Absyn_Syntax.ident.FStar_Absyn_Syntax.idRange))
in (_95_734)::[])
in (FStar_List.append lid.FStar_Absyn_Syntax.ns _95_735))
in (FStar_Absyn_Syntax.lid_of_ids _95_736)))

let is_name = (fun lid -> (let c = (FStar_Util.char_at lid.FStar_Absyn_Syntax.ident.FStar_Absyn_Syntax.idText 0)
in (FStar_Util.is_upper c)))

let ml_comp = (fun t r -> (let _95_744 = (let _95_743 = (set_lid_range FStar_Absyn_Const.effect_ML_lid r)
in {FStar_Absyn_Syntax.effect_name = _95_743; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = []; FStar_Absyn_Syntax.flags = (FStar_Absyn_Syntax.MLEFFECT)::[]})
in (FStar_Absyn_Syntax.mk_Comp _95_744)))
...
let is_pure_or_ghost_function = (fun t -> (match ((let _95_783 = (compress_typ t)
in _95_783.FStar_Absyn_Syntax.n)) with
...
let is_lemma = (fun t -> (match ((let _95_786 = (compress_typ t)
in _95_786.FStar_Absyn_Syntax.n)) with
...
let is_smt_lemma = (fun t -> (match ((let _95_789 = (compress_typ t)
in _95_789.FStar_Absyn_Syntax.n)) with
...
(match ((let _95_790 = (unmeta_exp pats)
in _95_790.FStar_Absyn_Syntax.n)) with
...
let rec is_atom = (fun e -> (match ((let _95_800 = (compress_exp e)
in _95_800.FStar_Absyn_Syntax.n)) with
...
let is_fun = (fun e -> (match ((let _95_814 = (compress_exp e)
in _95_814.FStar_Absyn_Syntax.n)) with
...
let is_function_typ = (fun t -> (match ((let _95_817 = (compress_typ t)
in _95_817.FStar_Absyn_Syntax.n)) with
...
| [] -> begin
(let _95_851 = (let _95_850 = (let _95_849 = (let _95_848 = (FStar_Absyn_Syntax.range_of_lid l)
in (fvar (Some (FStar_Absyn_Syntax.Data_ctor)) l _95_848))
in (_95_849, FStar_Absyn_Syntax.Data_app))
in FStar_Absyn_Syntax.Meta_desugared (_95_850))
in (FStar_Absyn_Syntax.mk_Exp_meta _95_851))
end
| _26_1393 -> begin
(let _95_856 = (let _95_855 = (let _95_854 = (let _95_853 = (let _95_852 = (FStar_Absyn_Syntax.range_of_lid l)
in (fvar (Some (FStar_Absyn_Syntax.Data_ctor)) l _95_852))
in (mk_exp_app _95_853 args))
in (_95_854, FStar_Absyn_Syntax.Data_app))
in FStar_Absyn_Syntax.Meta_desugared (_95_855))
in (FStar_Absyn_Syntax.mk_Exp_meta _95_856))
end))
...
| true -> begin
(let _95_862 = (let _95_861 = (FStar_Util.substring_from x.FStar_Absyn_Syntax.idText 7)
in (_95_861, x.FStar_Absyn_Syntax.idRange))
in (FStar_Absyn_Syntax.mk_ident _95_862))
end
| false -> begin
x
end))
...
| true -> begin
(let _95_868 = (let _95_867 = (let _95_866 = (FStar_Util.string_of_int i)
in (Prims.strcat "_" _95_866))
in (_95_867, x.FStar_Absyn_Syntax.p))
in (FStar_Absyn_Syntax.mk_ident _95_868))
end
| false -> begin
...
in (let _95_873 = (let _95_872 = (let _95_871 = (FStar_Absyn_Syntax.ids_of_lid lid)
in (let _95_870 = (let _95_869 = (unmangle_field_name nm)
in (_95_869)::[])
in (FStar_List.append _95_871 _95_870)))
in (FStar_Absyn_Syntax.lid_of_ids _95_872))
in (_95_873, y)))))

let unchecked_unify = (fun uv t -> (match ((FStar_Unionfind.find uv)) with
| FStar_Absyn_Syntax.Fixed (_26_1408) -> begin
(let _95_878 = (let _95_877 = (let _95_876 = (FStar_Unionfind.uvar_id uv)
in (FStar_All.pipe_left FStar_Util.string_of_int _95_876))
in (FStar_Util.format1 "Changing a fixed uvar! U%s\n" _95_877))
in (FStar_All.failwith _95_878))
end
| _26_1411 -> begin
...
let union_uvs = (fun uvs1 uvs2 -> (let _95_907 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_k uvs2.FStar_Absyn_Syntax.uvars_k)
in (let _95_906 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_t uvs2.FStar_Absyn_Syntax.uvars_t)
in (let _95_905 = (FStar_Util.set_union uvs1.FStar_Absyn_Syntax.uvars_e uvs2.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _95_907; FStar_Absyn_Syntax.uvars_t = _95_906; FStar_Absyn_Syntax.uvars_e = _95_905}))))

let union_fvs = (fun fvs1 fvs2 -> (let _95_913 = (FStar_Util.set_union fvs1.FStar_Absyn_Syntax.ftvs fvs2.FStar_Absyn_Syntax.ftvs)
in (let _95_912 = (FStar_Util.set_union fvs1.FStar_Absyn_Syntax.fxvs fvs2.FStar_Absyn_Syntax.fxvs)
in {FStar_Absyn_Syntax.ftvs = _95_913; FStar_Absyn_Syntax.fxvs = _95_912})))

let union_fvs_uvs = (fun _26_1456 _26_1459 -> (match ((_26_1456, _26_1459)) with
| ((fvs1, uvs1), (fvs2, uvs2)) -> begin
(let _95_919 = (union_fvs fvs1 fvs2)
in (let _95_918 = (union_uvs uvs1 uvs2)
in (_95_919, _95_918)))
end))

let sub_fv = (fun _26_1462 _26_1465 -> (match ((_26_1462, _26_1465)) with
| ((fvs, uvs), (tvars, vvars)) -> begin
(let _95_940 = (let _26_1466 = fvs
in (let _95_939 = (FStar_Util.set_difference fvs.FStar_Absyn_Syntax.ftvs tvars)
in (let _95_938 = (FStar_Util.set_difference fvs.FStar_Absyn_Syntax.fxvs vvars)
in {FStar_Absyn_Syntax.ftvs = _95_939; FStar_Absyn_Syntax.fxvs = _95_938})))
in (_95_940, uvs))
end))
...
let single_fv = (fun x -> (let _95_951 = (FStar_Absyn_Syntax.new_ftv_set ())
in (FStar_Util.set_add x _95_951)))

let single_uv = (fun u -> (let _95_959 = (FStar_Absyn_Syntax.new_uv_set ())
in (FStar_Util.set_add u _95_959)))

let single_uvt = (fun u -> (let _95_967 = (FStar_Absyn_Syntax.new_uvt_set ())
in (FStar_Util.set_add u _95_967)))
...
| false -> begin
(let _95_1082 = (let _95_1081 = (let _26_1490 = FStar_Absyn_Syntax.no_fvs
in (let _95_1080 = (single_fv a)
in {FStar_Absyn_Syntax.ftvs = _95_1080; FStar_Absyn_Syntax.fxvs = _26_1490.FStar_Absyn_Syntax.fxvs}))
in (_95_1081, FStar_Absyn_Syntax.no_uvs))
in (cont _95_1082))
end)
end
| FStar_Absyn_Syntax.Typ_uvar (uv, k) -> begin
(let _95_1085 = (let _95_1084 = (let _26_1496 = FStar_Absyn_Syntax.no_uvs
in (let _95_1083 = (single_uvt (uv, k))
in {FStar_Absyn_Syntax.uvars_k = _26_1496.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _95_1083; FStar_Absyn_Syntax.uvars_e = _26_1496.FStar_Absyn_Syntax.uvars_e}))
in (FStar_Absyn_Syntax.no_fvs, _95_1084))
in (cont _95_1085))
end
...
| (bvs, vs1) -> begin
(vs_comp c uvonly (fun vs2 -> (let _95_1089 = (let _95_1088 = (union_fvs_uvs vs1 vs2)
in (sub_fv _95_1088 bvs))
in (cont _95_1089))))
end)))
end
| FStar_Absyn_Syntax.Typ_lam (bs, t) -> begin
...
| (bvs, vs1) -> begin
(vs_typ t uvonly (fun vs2 -> (let _95_1093 = (let _95_1092 = (union_fvs_uvs vs1 vs2)
in (sub_fv _95_1092 bvs))
in (cont _95_1093))))
end)))
end
| FStar_Absyn_Syntax.Typ_refine (x, t) -> begin
...
| (bvs, vs1) -> begin
(vs_typ t uvonly (fun vs2 -> (let _95_1097 = (let _95_1096 = (union_fvs_uvs vs1 vs2)
in (sub_fv _95_1096 bvs))
in (cont _95_1097))))
end)))
end
| FStar_Absyn_Syntax.Typ_app (t, args) -> begin
(vs_typ t uvonly (fun vs1 -> (vs_args args uvonly (fun vs2 -> (let _95_1100 = (union_fvs_uvs vs1 vs2)
in (cont _95_1100))))))
end
...
(vs_typ t1 uvonly (fun vs1 -> (vs_typ t2 uvonly (fun vs2 -> (let _95_1103 = (union_fvs_uvs vs1 vs2)
in (cont _95_1103))))))
end
...
(let _95_1140 = (let _95_1139 = (let _95_1137 = (FStar_Util.set_add a tvars)
in (_95_1137, vvars))
in (let _95_1138 = (union_fvs_uvs vs vs2)
in (_95_1139, _95_1138)))
in (cont _95_1140))
end)))))
end
...
| ((tvars, vvars), vs2) -> begin
(let _95_1164 = (let _95_1163 = (let _95_1161 = (FStar_Util.set_add x vvars)
in (tvars, _95_1161))
in (let _95_1162 = (union_fvs_uvs vs vs2)
in (_95_1163, _95_1162)))
in (cont _95_1164))
end)))))
end))
...
(vs_typ t uvonly (fun ft1 -> (vs_args tl uvonly (fun ft2 -> (let _95_1168 = (union_fvs_uvs ft1 ft2)
in (cont _95_1168))))))
end
| (FStar_Util.Inr (e), _26_1622)::tl -> begin
(vs_exp e uvonly (fun ft1 -> (vs_args tl uvonly (fun ft2 -> (let _95_1171 = (union_fvs_uvs ft1 ft2)
in (cont _95_1171))))))
end))
and vs_typ = (fun t uvonly cont -> (match ((let _95_1174 = (FStar_ST.read t.FStar_Absyn_Syntax.fvs)
in (let _95_1173 = (FStar_ST.read t.FStar_Absyn_Syntax.uvs)
in (_95_1174, _95_1173)))) with
...
(let _95_1179 = (let _95_1178 = (FStar_Range.string_of_range k.FStar_Absyn_Syntax.pos)
in (FStar_Util.format1 "%s: Impossible ... found a Kind_lam bare" _95_1178))
in (FStar_All.failwith _95_1179))
end
...
| (fvs, uvs) -> begin
(let _95_1183 = (let _95_1182 = (let _26_1677 = uvs
in (let _95_1181 = (FStar_Util.set_add uv uvs.FStar_Absyn_Syntax.uvars_k)
in {FStar_Absyn_Syntax.uvars_k = _95_1181; FStar_Absyn_Syntax.uvars_t = _26_1677.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _26_1677.FStar_Absyn_Syntax.uvars_e}))
in (fvs, _95_1182))
in (cont _95_1183))
end)))
end
...
| (bvs, vs1) -> begin
(vs_kind k uvonly (fun vs2 -> (let _95_1187 = (let _95_1186 = (union_fvs_uvs vs1 vs2)
in (sub_fv _95_1186 bvs))
in (cont _95_1187))))
end)))
end)))
and vs_kind = (fun k uvonly cont -> (match ((let _95_1190 = (FStar_ST.read k.FStar_Absyn_Syntax.fvs)
in (let _95_1189 = (FStar_ST.read k.FStar_Absyn_Syntax.uvs)
in (_95_1190, _95_1189)))) with
...
(let _95_1196 = (let _95_1195 = (let _26_1737 = FStar_Absyn_Syntax.no_uvs
in (let _95_1194 = (single_uvt (uv, t))
in {FStar_Absyn_Syntax.uvars_k = _26_1737.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _26_1737.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _95_1194}))
in (FStar_Absyn_Syntax.no_fvs, _95_1195))
in (cont _95_1196))
end
| FStar_Absyn_Syntax.Exp_bvar (x) -> begin
(match (uvonly) with
...
| false -> begin
(let _95_1199 = (let _95_1198 = (let _26_1741 = FStar_Absyn_Syntax.no_fvs
in (let _95_1197 = (single_fv x)
in {FStar_Absyn_Syntax.ftvs = _26_1741.FStar_Absyn_Syntax.ftvs; FStar_Absyn_Syntax.fxvs = _95_1197}))
in (_95_1198, FStar_Absyn_Syntax.no_uvs))
in (cont _95_1199))
end)
end
...
| (bvs, vs1) -> begin
(vs_exp e uvonly (fun vs2 -> (let _95_1203 = (let _95_1202 = (union_fvs_uvs vs1 vs2)
in (sub_fv _95_1202 bvs))
in (cont _95_1203))))
end)))
end
| FStar_Absyn_Syntax.Exp_app (e, args) -> begin
(vs_exp e uvonly (fun ft1 -> (vs_args args uvonly (fun ft2 -> (let _95_1206 = (union_fvs_uvs ft1 ft2)
in (cont _95_1206))))))
end
...
and vs_exp = (fun e uvonly cont -> (match ((let _95_1209 = (FStar_ST.read e.FStar_Absyn_Syntax.fvs)
in (let _95_1208 = (FStar_ST.read e.FStar_Absyn_Syntax.uvs)
in (_95_1209, _95_1208)))) with
...
| false -> begin
(vs_typ ct.FStar_Absyn_Syntax.result_typ uvonly (fun vs1 -> (vs_args ct.FStar_Absyn_Syntax.effect_args uvonly (fun vs2 -> (let _95_1215 = (union_fvs_uvs vs1 vs2)
in (k _95_1215))))))
end)
end))
and vs_comp = (fun c uvonly cont -> (match ((let _95_1218 = (FStar_ST.read c.FStar_Absyn_Syntax.fvs)
in (let _95_1217 = (FStar_ST.read c.FStar_Absyn_Syntax.uvs)
in (_95_1218, _95_1217)))) with
...
| hd::tl -> begin
(vs_either hd uvonly (fun ft1 -> (vs_either_l tl uvonly (fun ft2 -> (let _95_1225 = (union_fvs_uvs ft1 ft2)
in (cont _95_1225))))))
end))
...
| FStar_Util.Inl (t) -> begin
(let _95_1241 = (freevars_typ t)
in (FStar_All.pipe_left (union_fvs out) _95_1241))
end
| FStar_Util.Inr (e) -> begin
(let _95_1242 = (freevars_exp e)
in (FStar_All.pipe_left (union_fvs out) _95_1242))
...
let rec update_uvars = (fun s uvs -> (let out = (let _95_1316 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_k)
in (FStar_All.pipe_right _95_1316 (FStar_List.fold_left (fun out u -> (match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (k) -> begin
(let _95_1314 = (uvars_in_kind k)
in (union_uvs _95_1314 out))
end
| _26_1911 -> begin
(let _26_1912 = out
in (let _95_1315 = (FStar_Util.set_add u out.FStar_Absyn_Syntax.uvars_k)
in {FStar_Absyn_Syntax.uvars_k = _95_1315; FStar_Absyn_Syntax.uvars_t = _26_1912.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _26_1912.FStar_Absyn_Syntax.uvars_e}))
end)) FStar_Absyn_Syntax.no_uvs)))
in (let out = (let _95_1321 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_t)
in (FStar_All.pipe_right _95_1321 (FStar_List.fold_left (fun out _26_1918 -> (match (_26_1918) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (t) -> begin
(let _95_1319 = (uvars_in_typ t)
in (union_uvs _95_1319 out))
end
| _26_1922 -> begin
(let _26_1923 = out
in (let _95_1320 = (FStar_Util.set_add (u, t) out.FStar_Absyn_Syntax.uvars_t)
in {FStar_Absyn_Syntax.uvars_k = _26_1923.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _95_1320; FStar_Absyn_Syntax.uvars_e = _26_1923.FStar_Absyn_Syntax.uvars_e}))
end)
end)) out)))
in (let out = (let _95_1326 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_e)
in (FStar_All.pipe_right _95_1326 (FStar_List.fold_left (fun out _26_1929 -> (match (_26_1929) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Absyn_Syntax.Fixed (e) -> begin
(let _95_1324 = (uvars_in_exp e)
in (union_uvs _95_1324 out))
end
| _26_1933 -> begin
(let _26_1934 = out
in (let _95_1325 = (FStar_Util.set_add (u, t) out.FStar_Absyn_Syntax.uvars_e)
in {FStar_Absyn_Syntax.uvars_k = _26_1934.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _26_1934.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _95_1325}))
end)
end)) out)))
...
in out)))))
and uvars_in_kind = (fun k -> (let _95_1329 = (vs_kind k true (fun _26_1951 -> (match (_26_1951) with
| (_26_1949, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumKind (k))) _95_1329)))
and uvars_in_typ = (fun t -> (let _95_1332 = (vs_typ t true (fun _26_1956 -> (match (_26_1956) with
| (_26_1954, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumType (t))) _95_1332)))
and uvars_in_exp = (fun e -> (let _95_1335 = (vs_exp e true (fun _26_1961 -> (match (_26_1961) with
| (_26_1959, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumExp (e))) _95_1335)))
and uvars_in_comp = (fun c -> (let _95_1338 = (vs_comp c true (fun _26_1966 -> (match (_26_1966) with
| (_26_1964, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumComp (c))) _95_1338)))
...
| _26_2028 -> begin
(let _95_1359 = (FStar_Absyn_Syntax.mk_Total t)
in (tps, _95_1359))
end)
...
let mk_tuple_lid = (fun n r -> (let t = (let _95_1372 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "Tuple%s" _95_1372))
in (let _95_1373 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _95_1373 r))))

let mk_tuple_data_lid = (fun n r -> (let t = (let _95_1378 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "MkTuple%s" _95_1378))
in (let _95_1379 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _95_1379 r))))

let is_tuple_data_lid = (fun f n -> (let _95_1384 = (mk_tuple_data_lid n FStar_Absyn_Syntax.dummyRange)
in (FStar_Absyn_Syntax.lid_equals f _95_1384)))
...
let mk_dtuple_lid = (fun n r -> (let t = (let _95_1391 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "DTuple%s" _95_1391))
in (let _95_1392 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _95_1392 r))))

let mk_dtuple_data_lid = (fun n r -> (let t = (let _95_1397 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "MkDTuple%s" _95_1397))
in (let _95_1398 = (FStar_Absyn_Const.pconst t)
in (set_lid_range _95_1398 r))))
...
let is_constructor = (fun t lid -> (match ((let _95_1414 = (pre_typ t)
in _95_1414.FStar_Absyn_Syntax.n)) with
...
let rec is_constructed_typ = (fun t lid -> (match ((let _95_1419 = (pre_typ t)
in _95_1419.FStar_Absyn_Syntax.n)) with
...
(let _95_1428 = (FStar_Absyn_Syntax.text_of_lid fn1)
in (let _95_1427 = (FStar_Absyn_Syntax.text_of_lid fn2)
in (FStar_String.compare _95_1428 _95_1427)))
end)))))
...
let b2t_v = (let _95_1432 = (let _95_1431 = (let _95_1430 = (let _95_1429 = (FStar_All.pipe_left FStar_Absyn_Syntax.null_v_binder t_bool)
in (_95_1429)::[])
in (_95_1430, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _95_1431 FStar_Absyn_Syntax.dummyRange))
in (ftv FStar_Absyn_Const.b2t_lid _95_1432))
...
| Some (phi1) -> begin
(let _95_1443 = (let _95_1442 = (let _95_1440 = (let _95_1439 = (FStar_Absyn_Syntax.targ phi1)
in (let _95_1438 = (let _95_1437 = (FStar_Absyn_Syntax.targ phi2)
in (_95_1437)::[])
in (_95_1439)::_95_1438))
in (tand, _95_1440))
in (let _95_1441 = (FStar_Range.union_ranges phi1.FStar_Absyn_Syntax.pos phi2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _95_1442 None _95_1441)))
in Some (_95_1443))
end))

let mk_binop = (fun op_t phi1 phi2 -> (let _95_1455 = (let _95_1453 = (let _95_1452 = (FStar_Absyn_Syntax.targ phi1)
in (let _95_1451 = (let _95_1450 = (FStar_Absyn_Syntax.targ phi2)
in (_95_1450)::[])
in (_95_1452)::_95_1451))
in (op_t, _95_1453))
in (let _95_1454 = (FStar_Range.union_ranges phi1.FStar_Absyn_Syntax.pos phi2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _95_1455 None _95_1454))))

let mk_neg = (fun phi -> (let _95_1461 = (let _95_1460 = (ftv FStar_Absyn_Const.not_lid kt_kt)
in (let _95_1459 = (let _95_1458 = (FStar_Absyn_Syntax.targ phi)
in (_95_1458)::[])
in (_95_1460, _95_1459)))
in (FStar_Absyn_Syntax.mk_Typ_app _95_1461 None phi.FStar_Absyn_Syntax.pos)))
...
let mk_imp = (fun phi1 phi2 -> (match ((let _95_1478 = (compress_typ phi1)
in _95_1478.FStar_Absyn_Syntax.n)) with
...
| _26_2145 -> begin
(match ((let _95_1479 = (compress_typ phi2)
in _95_1479.FStar_Absyn_Syntax.n)) with
...
let b2t = (fun e -> (let _95_1488 = (let _95_1487 = (let _95_1486 = (FStar_All.pipe_left FStar_Absyn_Syntax.varg e)
in (_95_1486)::[])
in (b2t_v, _95_1487))
in (FStar_Absyn_Syntax.mk_Typ_app _95_1488 None e.FStar_Absyn_Syntax.pos)))
...
let eq_k = (let a = (let _95_1491 = (new_bvd None)
in (bvd_to_bvar_s _95_1491 FStar_Absyn_Syntax.ktype))
in (let atyp = (btvar_to_typ a)
in (let b = (let _95_1492 = (new_bvd None)
in (bvd_to_bvar_s _95_1492 FStar_Absyn_Syntax.ktype))
in (let btyp = (btvar_to_typ b)
in (let _95_1499 = (let _95_1498 = (let _95_1497 = (let _95_1496 = (let _95_1495 = (FStar_Absyn_Syntax.null_v_binder atyp)
in (let _95_1494 = (let _95_1493 = (FStar_Absyn_Syntax.null_v_binder btyp)
in (_95_1493)::[])
in (_95_1495)::_95_1494))
in ((FStar_Util.Inl (b), Some (FStar_Absyn_Syntax.Implicit)))::_95_1496)
in ((FStar_Util.Inl (a), Some (FStar_Absyn_Syntax.Implicit)))::_95_1497)
in (_95_1498, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _95_1499 FStar_Absyn_Syntax.dummyRange))))))
...
| _26_2212 -> begin
(let _95_1517 = (let _95_1515 = (let _95_1514 = (FStar_Absyn_Syntax.itarg t1)
in (let _95_1513 = (let _95_1512 = (FStar_Absyn_Syntax.itarg t2)
in (let _95_1511 = (let _95_1510 = (FStar_Absyn_Syntax.varg e1)
in (let _95_1509 = (let _95_1508 = (FStar_Absyn_Syntax.varg e2)
in (_95_1508)::[])
in (_95_1510)::_95_1509))
in (_95_1512)::_95_1511))
in (_95_1514)::_95_1513))
in (teq, _95_1515))
in (let _95_1516 = (FStar_Range.union_ranges e1.FStar_Absyn_Syntax.pos e2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _95_1517 None _95_1516)))
end))

let eq_typ = (ftv FStar_Absyn_Const.eqT_lid FStar_Absyn_Syntax.kun)

let mk_eq_typ = (fun t1 t2 -> (let _95_1527 = (let _95_1525 = (let _95_1524 = (FStar_Absyn_Syntax.targ t1)
in (let _95_1523 = (let _95_1522 = (FStar_Absyn_Syntax.targ t2)
in (_95_1522)::[])
in (_95_1524)::_95_1523))
in (eq_typ, _95_1525))
in (let _95_1526 = (FStar_Range.union_ranges t1.FStar_Absyn_Syntax.pos t2.FStar_Absyn_Syntax.pos)
in (FStar_Absyn_Syntax.mk_Typ_app _95_1527 None _95_1526))))
...
in (let lexcons = (let _95_1537 = (let _95_1536 = (let _95_1535 = (let _95_1533 = (FStar_Absyn_Syntax.t_binder a)
in (let _95_1532 = (let _95_1531 = (let _95_1528 = (btvar_to_typ a)
in (FStar_Absyn_Syntax.null_v_binder _95_1528))
in (let _95_1530 = (let _95_1529 = (FStar_Absyn_Syntax.null_v_binder lex_t)
in (_95_1529)::[])
in (_95_1531)::_95_1530))
in (_95_1533)::_95_1532))
in (let _95_1534 = (FStar_Absyn_Syntax.mk_Total lex_t)
in (_95_1535, _95_1534)))
in (FStar_Absyn_Syntax.mk_Typ_fun _95_1536 None FStar_Absyn_Syntax.dummyRange))
in (withinfo FStar_Absyn_Const.lexcons_lid _95_1537 FStar_Absyn_Syntax.dummyRange))
in (FStar_Absyn_Syntax.mk_Exp_fvar (lexcons, Some (FStar_Absyn_Syntax.Data_ctor)) None FStar_Absyn_Syntax.dummyRange)))

let forall_kind = (let a = (let _95_1538 = (new_bvd None)
in (bvd_to_bvar_s _95_1538 FStar_Absyn_Syntax.ktype))
in (let atyp = (btvar_to_typ a)
in (let _95_1546 = (let _95_1545 = (let _95_1544 = (let _95_1543 = (let _95_1542 = (let _95_1541 = (let _95_1540 = (let _95_1539 = (FStar_Absyn_Syntax.null_v_binder atyp)
in (_95_1539)::[])
in (_95_1540, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _95_1541 FStar_Absyn_Syntax.dummyRange))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder _95_1542))
in (_95_1543)::[])
in ((FStar_Util.Inl (a), Some (FStar_Absyn_Syntax.Implicit)))::_95_1544)
in (_95_1545, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _95_1546 FStar_Absyn_Syntax.dummyRange))))

let tforall = (ftv FStar_Absyn_Const.forall_lid forall_kind)

let allT_k = (fun k -> (let _95_1555 = (let _95_1554 = (let _95_1553 = (let _95_1552 = (let _95_1551 = (let _95_1550 = (let _95_1549 = (FStar_Absyn_Syntax.null_t_binder k)
in (_95_1549)::[])
in (_95_1550, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _95_1551 FStar_Absyn_Syntax.dummyRange))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder _95_1552))
in (_95_1553)::[])
in (_95_1554, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _95_1555 FStar_Absyn_Syntax.dummyRange)))

let eqT_k = (fun k -> (let _95_1562 = (let _95_1561 = (let _95_1560 = (FStar_All.pipe_left FStar_Absyn_Syntax.null_t_binder k)
in (let _95_1559 = (let _95_1558 = (FStar_Absyn_Syntax.null_t_binder k)
in (_95_1558)::[])
in (_95_1560)::_95_1559))
in (_95_1561, FStar_Absyn_Syntax.ktype))
in (FStar_Absyn_Syntax.mk_Kind_arrow _95_1562 FStar_Absyn_Syntax.dummyRange)))

let tforall_typ = (fun k -> (let _95_1565 = (allT_k k)
in (ftv FStar_Absyn_Const.allTyp_lid _95_1565)))

let mk_forallT = (fun a b -> (let _95_1577 = (let _95_1576 = (tforall_typ a.FStar_Absyn_Syntax.sort)
in (let _95_1575 = (let _95_1574 = (let _95_1573 = (let _95_1572 = (let _95_1571 = (let _95_1570 = (FStar_Absyn_Syntax.t_binder a)
in (_95_1570)::[])
in (_95_1571, b))
in (FStar_Absyn_Syntax.mk_Typ_lam _95_1572 None b.FStar_Absyn_Syntax.pos))
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _95_1573))
in (_95_1574)::[])
in (_95_1576, _95_1575)))
in (FStar_Absyn_Syntax.mk_Typ_app _95_1577 None b.FStar_Absyn_Syntax.pos)))

let mk_forall = (fun x body -> (let r = FStar_Absyn_Syntax.dummyRange
in (let _95_1588 = (let _95_1587 = (let _95_1586 = (let _95_1585 = (let _95_1584 = (let _95_1583 = (let _95_1582 = (FStar_Absyn_Syntax.v_binder x)
in (_95_1582)::[])
in (_95_1583, body))
in (FStar_Absyn_Syntax.mk_Typ_lam _95_1584 None r))
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _95_1585))
in (_95_1586)::[])
in (tforall, _95_1587))
in (FStar_Absyn_Syntax.mk_Typ_app _95_1588 None r))))
...
| FStar_Util.Inl (a) -> begin
(let _95_1598 = (let _95_1597 = (tforall_typ a.FStar_Absyn_Syntax.sort)
in (let _95_1596 = (let _95_1595 = (FStar_Absyn_Syntax.targ body)
in (_95_1595)::[])
in (_95_1597, _95_1596)))
in (FStar_Absyn_Syntax.mk_Typ_app _95_1598 None f.FStar_Absyn_Syntax.pos))
end
| FStar_Util.Inr (x) -> begin
(let _95_1602 = (let _95_1601 = (let _95_1600 = (let _95_1599 = (FStar_Absyn_Syntax.targ body)
in (_95_1599)::[])
in ((FStar_Util.Inl (x.FStar_Absyn_Syntax.sort), Some (FStar_Absyn_Syntax.Implicit)))::_95_1600)
in (tforall, _95_1601))
in (FStar_Absyn_Syntax.mk_Typ_app _95_1602 None f.FStar_Absyn_Syntax.pos))
end))
end)) bs f))
...
(let _95_1666 = (compress_typ t)
in (pats, _95_1666))
end
| _26_2320 -> begin
(let _95_1667 = (compress_typ t)
in ([], _95_1667))
end)))
...
| (t, args) -> begin
(let _95_1681 = (FStar_All.pipe_right args (FStar_List.map (fun _26_26 -> (match (_26_26) with
| (FStar_Util.Inl (t), imp) -> begin
(let _95_1678 = (let _95_1677 = (compress_typ t)
in FStar_Util.Inl (_95_1677))
in (_95_1678, imp))
end
| (FStar_Util.Inr (e), imp) -> begin
(let _95_1680 = (let _95_1679 = (compress_exp e)
in FStar_Util.Inr (_95_1679))
in (_95_1680, imp))
end))))
in (t, _95_1681))
end)))
in (let rec aux = (fun qopt out t -> (match ((let _95_1688 = (flat t)
in (qopt, _95_1688))) with
