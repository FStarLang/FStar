...
let kunary : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun k k' -> (let _103_15 = (let _103_14 = (let _103_13 = (let _103_11 = (FStar_Syntax_Syntax.null_binder k)
in (_103_11)::[])
in (let _103_12 = (FStar_Syntax_Syntax.mk_Total k')
in (_103_13, _103_12)))
in FStar_Syntax_Syntax.Tm_arrow (_103_14))
in (mk _103_15)))

# 57 "FStar.Syntax.Const.fst"
let kbin : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun k1 k2 k' -> (let _103_28 = (let _103_27 = (let _103_26 = (let _103_24 = (FStar_Syntax_Syntax.null_binder k1)
in (let _103_23 = (let _103_22 = (FStar_Syntax_Syntax.null_binder k2)
in (_103_22)::[])
in (_103_24)::_103_23))
in (let _103_25 = (FStar_Syntax_Syntax.mk_Total k')
in (_103_26, _103_25)))
in FStar_Syntax_Syntax.Tm_arrow (_103_27))
in (mk _103_28)))

# 58 "FStar.Syntax.Const.fst"
let ktern : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun k1 k2 k3 k' -> (let _103_45 = (let _103_44 = (let _103_43 = (let _103_41 = (FStar_Syntax_Syntax.null_binder k1)
in (let _103_40 = (let _103_39 = (FStar_Syntax_Syntax.null_binder k2)
in (let _103_38 = (let _103_37 = (FStar_Syntax_Syntax.null_binder k3)
in (_103_37)::[])
in (_103_39)::_103_38))
in (_103_41)::_103_40))
in (let _103_42 = (FStar_Syntax_Syntax.mk_Total k')
in (_103_43, _103_42)))
in FStar_Syntax_Syntax.Tm_arrow (_103_44))
in (mk _103_45)))
