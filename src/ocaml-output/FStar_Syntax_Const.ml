...
let kunary : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun k k' -> (mk (FStar_Syntax_Syntax.Tm_arrow ((let _0_180 = (let _0_178 = (FStar_Syntax_Syntax.null_binder k)
in (_0_178)::[])
in (let _0_179 = (FStar_Syntax_Syntax.mk_Total k')
in ((_0_180), (_0_179))))))))


let kbin : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun k1 k2 k' -> (mk (FStar_Syntax_Syntax.Tm_arrow ((let _0_185 = (let _0_183 = (FStar_Syntax_Syntax.null_binder k1)
in (let _0_182 = (let _0_181 = (FStar_Syntax_Syntax.null_binder k2)
in (_0_181)::[])
in (_0_183)::_0_182))
in (let _0_184 = (FStar_Syntax_Syntax.mk_Total k')
in ((_0_185), (_0_184))))))))


let ktern : FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.typ  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun k1 k2 k3 k' -> (mk (FStar_Syntax_Syntax.Tm_arrow ((let _0_192 = (let _0_190 = (FStar_Syntax_Syntax.null_binder k1)
in (let _0_189 = (let _0_188 = (FStar_Syntax_Syntax.null_binder k2)
in (let _0_187 = (let _0_186 = (FStar_Syntax_Syntax.null_binder k3)
in (_0_186)::[])
in (_0_188)::_0_187))
in (_0_190)::_0_189))
in (let _0_191 = (FStar_Syntax_Syntax.mk_Total k')
in ((_0_192), (_0_191))))))))
