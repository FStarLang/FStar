  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_TApp (e1,tys) ->
          let uu___ =
            let uu___1 = FStar_List.map (elim_mlty env) tys  in (e1, uu___1)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor (l,es) ->
          let uu___ =
            let uu___1 = FStar_List.map (elim_mlexpr env) es  in (l, uu___1)
             in
            ...
            let uu___1 =
              FStar_List.map
                (fun uu___2  ->
                   match uu___2 with
                   | (s,e1) ->
                       let uu___3 = elim_mlexpr env e1  in (s, uu___3))
                fields
               in
            (syms, uu___1)  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Raise (p,es) ->
          let uu___ =
            let uu___1 = FStar_List.map (elim_mlexpr env) es  in (p, uu___1)
             in
                           ...
                           then
                             ...
                             (let uu___5 =
                              ...
                              then
                                ...
                                ((let uu___7 =
                                    let uu___8 =
                                      let uu___9 = FStar_Util.string_of_int i
                                         in
                                      let uu___10 =
                ...
                fun td  ->
                  ...
                  | (env1,out) ->
                      (try
                       ...
                       with | Drop_tydef  -> (env1, out))) (env, []) tds
            in
                  ...
                  let uu___4 =
                    FStar_List.map
                      (fun uu___5  ->
                         match uu___5 with
                         | (name1,ty) ->
                             let uu___6 = elim_mlty env ty  in
                             (name1, uu___6)) fields
                     in
                   ...
                   (try
                      (fun uu___2  ->
                         ...
                         | () ->
                             ...
                             (match uu___3 with
                              | (env2,m2) -> (env2, (m2 :: out)))) ()
                    with | Drop_tydef  -> (env1, out))) (env, []) m
         in
