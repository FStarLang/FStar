               ...
               | FStar_SMTEncoding_Term.App
                   ...
                   let _0_355 =
                     FStar_SMTEncoding_Util.mkAnd
                       (let _0_354 = FStar_SMTEncoding_Util.mkNot g in
                        (negs, _0_354)) in
                   get_next_n_ite (n - (Prims.parse_int "1")) e _0_355
                     (fun x  -> f (FStar_SMTEncoding_Util.mkITE (g, t, x)))
               | FStar_SMTEncoding_Term.FreeV uu____42 ->
                   let _0_356 = f FStar_SMTEncoding_Util.mkTrue in
                   (true, _0_356, negs, t)
               | uu____45 ->
          ...
          | uu____76 ->
              (match t.FStar_SMTEncoding_Term.tm with
               | FStar_SMTEncoding_Term.FreeV uu____81 ->
                   let _0_358 =
                     FStar_SMTEncoding_Util.mkAnd
                       (let _0_357 = FStar_SMTEncoding_Util.mkNot t in
                        (negs, _0_357)) in
                   (true, l, _0_358)
               | uu____85 ->
                        ...
                        (match b with
                         | true  ->
                             let _0_360 =
                               ...
                               _0_359 :: l in
                             is_ite_all_the_way n rest negs' _0_360
                         | uu____104 ->
                             (false, [], FStar_SMTEncoding_Util.mkFalse))))
          ...
          (fun t  ->
             check
               (FStar_SMTEncoding_Term.Assume
                  (let _0_361 = FStar_SMTEncoding_Util.mkNot (f t) in
                   (_0_361, None, None)))) (FStar_List.rev l)
  ...
  fun n  ->
    fun q  ->
      ...
      | FStar_SMTEncoding_Term.Assume (q',uu____363,uu____364) ->
          let _0_363 = strip_not q' in
          parse_query_for_split_cases n _0_363 (fun x  -> x)
      | uu____368 ->
