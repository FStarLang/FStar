...
| true -> begin
(let _0_476 = (f FStar_SMTEncoding_Util.mkTrue)
in ((true), (_0_476), (negs), (t)))
end
| uu____30 -> begin
(match (t.FStar_SMTEncoding_Term.tm) with
| FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.ITE, (g)::(t)::(e)::uu____38) -> begin
(let _0_478 = (FStar_SMTEncoding_Util.mkAnd (let _0_477 = (FStar_SMTEncoding_Util.mkNot g)
in ((negs), (_0_477))))
in (get_next_n_ite (n - (Prims.parse_int "1")) e _0_478 (fun x -> (f (FStar_SMTEncoding_Util.mkITE ((g), (t), (x)))))))
end
| FStar_SMTEncoding_Term.FreeV (uu____42) -> begin
(let _0_479 = (f FStar_SMTEncoding_Util.mkTrue)
in ((true), (_0_479), (negs), (t)))
end
| uu____45 -> begin
...
(let _0_481 = (FStar_SMTEncoding_Util.mkAnd (let _0_480 = (FStar_SMTEncoding_Util.mkNot t)
in ((negs), (_0_480))))
in ((true), (l), (_0_481)))
end
| uu____85 -> begin
...
(match (b) with
| true -> begin
(let _0_483 = (let _0_482 = (FStar_SMTEncoding_Util.mkImp ((negs), (t)))
in (_0_482)::l)
in (is_ite_all_the_way n rest negs' _0_483))
end
| uu____104 -> begin
...
let rec check_split_cases : (FStar_SMTEncoding_Term.term  ->  FStar_SMTEncoding_Term.term)  ->  FStar_SMTEncoding_Term.term Prims.list  ->  (FStar_SMTEncoding_Term.decl  ->  Prims.unit)  ->  Prims.unit = (fun f l check -> (FStar_List.iter (fun t -> (check (FStar_SMTEncoding_Term.Assume ((let _0_484 = (FStar_SMTEncoding_Util.mkNot (f t))
in ((_0_484), (None), (None))))))) (FStar_List.rev l)))


let check_exhaustiveness : (FStar_SMTEncoding_Term.term  ->  FStar_SMTEncoding_Term.term)  ->  FStar_SMTEncoding_Term.term  ->  (FStar_SMTEncoding_Term.decl  ->  Prims.unit)  ->  Prims.unit = (fun f negs check -> (check (FStar_SMTEncoding_Term.Assume ((let _0_485 = (FStar_SMTEncoding_Util.mkNot (f (FStar_SMTEncoding_Util.mkNot negs)))
in ((_0_485), (None), (None)))))))
...
(let _0_486 = (strip_not q')
in (parse_query_for_split_cases n _0_486 (fun x -> x)))
end
| uu____368 -> begin
