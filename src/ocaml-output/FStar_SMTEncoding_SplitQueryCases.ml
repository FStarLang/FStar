...
(let _186_14 = (f FStar_SMTEncoding_Util.mkTrue)
in ((true), (_186_14), (negs), (t)))
end else begin
(match (t.FStar_SMTEncoding_Term.tm) with
| FStar_SMTEncoding_Term.App (FStar_SMTEncoding_Term.ITE, (g)::(t)::(e)::_88_7) -> begin
(let _186_19 = (let _186_16 = (let _186_15 = (FStar_SMTEncoding_Util.mkNot g)
in ((negs), (_186_15)))
in (FStar_SMTEncoding_Util.mkAnd _186_16))
in (get_next_n_ite (n - (Prims.parse_int "1")) e _186_19 (fun x -> (let _186_18 = (FStar_SMTEncoding_Util.mkITE ((g), (t), (x)))
in (f _186_18)))))
end
| FStar_SMTEncoding_Term.FreeV (_88_18) -> begin
(let _186_20 = (f FStar_SMTEncoding_Util.mkTrue)
in ((true), (_186_20), (negs), (t)))
end
| _88_21 -> begin
...
(let _186_31 = (let _186_30 = (let _186_29 = (FStar_SMTEncoding_Util.mkNot t)
in ((negs), (_186_29)))
in (FStar_SMTEncoding_Util.mkAnd _186_30))
in ((true), (l), (_186_31)))
end
| _88_30 -> begin
(
...
| (b, t, negs', rest) -> begin
if b then begin
(let _186_34 = (let _186_33 = (FStar_SMTEncoding_Util.mkImp ((negs), (t)))
in (_186_33)::l)
in (is_ite_all_the_way n rest negs' _186_34))
end else begin
...
(parse_query_for_split_cases n t (fun x -> (let _186_61 = (FStar_SMTEncoding_Util.mkForall'' ((l), (opt), (l'), (x)))
in (f _186_61))))
end
...
(parse_query_for_split_cases n t2 (fun x -> (let _186_69 = (FStar_SMTEncoding_Util.mkImp ((t1), (x)))
in (f _186_69))))
end
...
| (b, l, negs) -> begin
((b), ((((fun x -> (let _186_78 = (FStar_SMTEncoding_Util.mkImp ((t1), (x)))
in (f _186_78)))), (l), (negs))))
end))
end
| _88_80 -> begin
...
let rec check_split_cases : (FStar_SMTEncoding_Term.term  ->  FStar_SMTEncoding_Term.term)  ->  FStar_SMTEncoding_Term.term Prims.list  ->  (FStar_SMTEncoding_Term.decl  ->  Prims.unit)  ->  Prims.unit = (fun f l check -> (FStar_List.iter (fun t -> (let _186_117 = (let _186_116 = (let _186_115 = (let _186_114 = (f t)
in (FStar_SMTEncoding_Util.mkNot _186_114))
in ((_186_115), (None), (None)))
in FStar_SMTEncoding_Term.Assume (_186_116))
in (check _186_117))) (FStar_List.rev l)))


let check_exhaustiveness : (FStar_SMTEncoding_Term.term  ->  FStar_SMTEncoding_Term.term)  ->  FStar_SMTEncoding_Term.term  ->  (FStar_SMTEncoding_Term.decl  ->  Prims.unit)  ->  Prims.unit = (fun f negs check -> (let _186_138 = (let _186_137 = (let _186_136 = (let _186_135 = (let _186_134 = (FStar_SMTEncoding_Util.mkNot negs)
in (f _186_134))
in (FStar_SMTEncoding_Util.mkNot _186_135))
in ((_186_136), (None), (None)))
