...
(let _133_41 = (let _133_39 = (FStar_Util.char_at s i)
in (name_of_char _133_39))
in (let _133_40 = (aux (i + 1))
in (_133_41)::_133_40))
end)
in (let _133_43 = (let _133_42 = (aux 0)
in (FStar_String.concat "_" _133_42))
in (Prims.strcat "op_" _133_43)))))

# 141 "FStar.Parser.ToSyntax.fst"
let compile_op_lid : Prims.int  ->  Prims.string  ->  FStar_Range.range  ->  FStar_Ident.lident = (fun n s r -> (let _133_53 = (let _133_52 = (let _133_51 = (let _133_50 = (compile_op n s)
in (_133_50, r))
in (FStar_Ident.mk_ident _133_51))
in (_133_52)::[])
in (FStar_All.pipe_right _133_53 FStar_Ident.lid_of_ids)))
...
let r = (fun l dd -> (let _133_67 = (let _133_66 = (FStar_Ident.set_lid_range l rng)
in (FStar_Syntax_Syntax.lid_as_fv _133_66 dd None))
in Some (_133_67)))
in (
...
in (match ((let _133_70 = (compile_op_lid arity s rng)
in (FStar_Parser_Env.try_lookup_lid env _133_70))) with
...
let sort_ftv : FStar_Ident.ident Prims.list  ->  FStar_Ident.ident Prims.list = (fun ftv -> (let _133_77 = (FStar_Util.remove_dups (fun x y -> (x.FStar_Ident.idText = y.FStar_Ident.idText)) ftv)
in (FStar_All.pipe_left (FStar_Util.sort_with (fun x y -> (FStar_String.compare x.FStar_Ident.idText y.FStar_Ident.idText))) _133_77)))
...
(let _133_84 = (free_type_vars env term)
in (env, _133_84))
end
...
(let _133_85 = (free_type_vars env t)
in (env, _133_85))
end))
and free_type_vars : FStar_Parser_Env.env  ->  FStar_Parser_AST.term  ->  FStar_Ident.ident Prims.list = (fun env t -> (match ((let _133_88 = (unparen t)
in _133_88.FStar_Parser_AST.tm)) with
...
(let _133_91 = (free_type_vars env t1)
in (let _133_90 = (free_type_vars env t2)
in (FStar_List.append _133_91 _133_90)))
end
...
| (env, f) -> begin
(let _133_92 = (free_type_vars env t)
in (FStar_List.append f _133_92))
end))
end
...
| (env, free) -> begin
(let _133_95 = (free_type_vars env body)
in (FStar_List.append free _133_95))
end))
end
...
let rec aux = (fun args t -> (match ((let _133_102 = (unparen t)
in _133_102.FStar_Parser_AST.tm)) with
...
let ftv = (let _133_107 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _133_107))
in if ((FStar_List.length ftv) = 0) then begin
t
end else begin
(
# 255 "FStar.Parser.ToSyntax.fst"
let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _133_111 = (let _133_110 = (let _133_109 = (tm_type x.FStar_Ident.idRange)
in (x, _133_109))
in FStar_Parser_AST.TAnnotated (_133_110))
in (FStar_Parser_AST.mk_binder _133_111 x.FStar_Ident.idRange FStar_Parser_AST.Type (Some (FStar_Parser_AST.Implicit)))))))
in (
...
let ftv = (let _133_116 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _133_116))
in if ((FStar_List.length ftv) = 0) then begin
t
end else begin
(
# 263 "FStar.Parser.ToSyntax.fst"
let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _133_120 = (let _133_119 = (let _133_118 = (tm_type x.FStar_Ident.idRange)
in (x, _133_118))
in FStar_Parser_AST.TAnnotated (_133_119))
in (FStar_Parser_AST.mk_binder _133_120 x.FStar_Ident.idRange FStar_Parser_AST.Type (Some (FStar_Parser_AST.Implicit)))))))
in (
# 264 "FStar.Parser.ToSyntax.fst"
let t = (match ((let _133_121 = (unparen t)
in _133_121.FStar_Parser_AST.tm)) with
...
(let _133_135 = (let _133_134 = (FStar_Parser_Env.qualify env id)
in FStar_Util.Inr (_133_134))
in (_133_135, args, None))
end
...
| (None, k) -> begin
(let _133_172 = (FStar_Syntax_Syntax.null_binder k)
in (_133_172, env))
end
| (Some (a), k) -> begin
(
...
| (p, _51_524) -> begin
(let _133_218 = (pat_vars p)
in (FStar_Util.set_union out _133_218))
...
let t = (let _133_248 = (close_fun env t)
in (desugar_term env _133_248))
in LocalBinder (((
...
in (let _133_249 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_wild (x)))
in (loc, env, LocalBinder ((x, None)), _133_249, false)))
end
| FStar_Parser_AST.PatConst (c) -> begin
(
# 366 "FStar.Parser.ToSyntax.fst"
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _133_250 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_constant (c)))
in (loc, env, LocalBinder ((x, None)), _133_250, false)))
end
...
| (loc, env, xbv) -> begin
(let _133_251 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_var (xbv)))
in (loc, env, LocalBinder ((xbv, aq)), _133_251, imp))
end)))
end
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _133_252 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons ((l, []))))
in (loc, env, LocalBinder ((x, None)), _133_252, false))))
end
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _133_255 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons ((l, args))))
in (loc, env, LocalBinder ((x, None)), _133_255, false))))
end))
end
...
let pat = (let _133_268 = (let _133_267 = (let _133_263 = (FStar_Range.end_range p.FStar_Parser_AST.prange)
in (pos_r _133_263))
in (let _133_266 = (let _133_265 = (let _133_264 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.nil_lid FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in (_133_264, []))
in FStar_Syntax_Syntax.Pat_cons (_133_265))
in (FStar_All.pipe_left _133_267 _133_266)))
in (FStar_List.fold_right (fun hd tl -> (
# 395 "FStar.Parser.ToSyntax.fst"
let r = (FStar_Range.union_ranges hd.FStar_Syntax_Syntax.p tl.FStar_Syntax_Syntax.p)
in (let _133_262 = (let _133_261 = (let _133_260 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.cons_lid FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in (_133_260, ((hd, false))::((tl, false))::[]))
in FStar_Syntax_Syntax.Pat_cons (_133_261))
in (FStar_All.pipe_left (pos_r r) _133_262)))) pats _133_268))
in (
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _133_271 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons ((l, args))))
in (loc, env, LocalBinder ((x, None)), _133_271, false)))))))
end))
end
...
| (f, p) -> begin
(let _133_273 = (FStar_Parser_Env.fail_or (FStar_Parser_Env.qualify_field_to_record env record) f)
in (_133_273, p))
end))))
in (
...
(let _133_282 = (let _133_281 = (let _133_280 = (
# 430 "FStar.Parser.ToSyntax.fst"
let _51_766 = fv
in (let _133_279 = (let _133_278 = (let _133_277 = (let _133_276 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map Prims.fst))
in (record.FStar_Parser_Env.typename, _133_276))
in FStar_Syntax_Syntax.Record_ctor (_133_277))
in Some (_133_278))
in {FStar_Syntax_Syntax.fv_name = _51_766.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = _51_766.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = _133_279}))
in (_133_280, args))
in FStar_Syntax_Syntax.Pat_cons (_133_281))
in (FStar_All.pipe_left pos _133_282))
end
| _51_769 -> begin
p
end)
...
let _51_779 = (let _133_283 = (check_linear_pattern_variables p)
in (FStar_All.pipe_left Prims.ignore _133_283))
in (env, b, p))
end)))))))
...
(let _133_289 = (let _133_288 = (let _133_287 = (FStar_Parser_Env.qualify env x)
in (_133_287, FStar_Syntax_Syntax.tun))
in LetBinder (_133_288))
in (env, _133_289, None))
end
...
(let _133_293 = (let _133_292 = (let _133_291 = (FStar_Parser_Env.qualify env x)
in (let _133_290 = (desugar_term env t)
in (_133_291, _133_290)))
in LetBinder (_133_292))
in (env, _133_293, None))
end
| _51_801 -> begin
...
in (match ((let _133_312 = (unparen top)
in _133_312.FStar_Parser_AST.tm)) with
...
| FStar_Parser_AST.Op ("*", _51_869::_51_867::[]) when (let _133_313 = (op_as_fv env 2 top.FStar_Parser_AST.range "*")
in (FStar_All.pipe_right _133_313 FStar_Option.isNone)) -> begin
(
...
let targs = (let _133_319 = (let _133_316 = (unparen top)
in (flatten _133_316))
in (FStar_All.pipe_right _133_319 (FStar_List.map (fun t -> (let _133_318 = (desugar_typ env t)
in (FStar_Syntax_Syntax.as_arg _133_318))))))
in (
# 495 "FStar.Parser.ToSyntax.fst"
let tup = (let _133_320 = (FStar_Syntax_Util.mk_tuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_Parser_Env.fail_or (FStar_Parser_Env.try_lookup_lid env) _133_320))
in (mk (FStar_Syntax_Syntax.Tm_app ((tup, targs)))))))
end
| FStar_Parser_AST.Tvar (a) -> begin
(let _133_321 = (FStar_Parser_Env.fail_or2 (FStar_Parser_Env.try_lookup_id env) a)
in (FStar_All.pipe_left setpos _133_321))
end
...
let args = (FStar_All.pipe_right args (FStar_List.map (fun t -> (let _133_323 = (desugar_term env t)
in (_133_323, None)))))
...
(let _133_324 = (FStar_Ident.set_lid_range FStar_Syntax_Const.true_lid top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.fvar _133_324 FStar_Syntax_Syntax.Delta_constant None))
end
...
(let _133_325 = (FStar_Ident.set_lid_range FStar_Syntax_Const.false_lid top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.fvar _133_325 FStar_Syntax_Syntax.Delta_constant None))
end
| (FStar_Parser_AST.Var (l)) | (FStar_Parser_AST.Name (l)) -> begin
(let _133_326 = (FStar_Parser_Env.fail_or (FStar_Parser_Env.try_lookup_lid env) l)
in (FStar_All.pipe_left setpos _133_326))
end
| FStar_Parser_AST.Construct (l, args) -> begin
(
...
| None -> begin
(let _133_327 = (FStar_Parser_Env.fail_or (FStar_Parser_Env.try_lookup_lid env) l)
in (_133_327, false))
end
| Some (head) -> begin
(let _133_328 = (mk (FStar_Syntax_Syntax.Tm_fvar (head)))
in (_133_328, true))
end)
...
| None -> begin
(let _133_332 = (FStar_Syntax_Syntax.new_bv (Some (top.FStar_Parser_AST.range)) FStar_Syntax_Syntax.tun)
in (env, _133_332))
end
| Some (x) -> begin
...
| (env, x) -> begin
(let _133_336 = (let _133_335 = (let _133_334 = (let _133_333 = (no_annot_abs tparams t)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _133_333))
in (_133_334)::[])
in (FStar_List.append typs _133_335))
in (env, (FStar_List.append tparams ((((
# 543 "FStar.Parser.ToSyntax.fst"
let _51_984 = x
in {FStar_Syntax_Syntax.ppname = _51_984.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _51_984.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t}), None))::[])), _133_336))
end))
end))
...
let tup = (let _133_337 = (FStar_Syntax_Util.mk_dtuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_Parser_Env.fail_or (FStar_Parser_Env.try_lookup_lid env) _133_337))
...
in (let _133_344 = (FStar_Syntax_Util.arrow (FStar_List.rev bs) cod)
in (FStar_All.pipe_left setpos _133_344)))
end
| hd::tl -> begin
(
...
in (let _133_345 = (FStar_Syntax_Util.refine x f)
in (FStar_All.pipe_left setpos _133_345)))
end))
end)
end
...
(let _133_349 = (let _133_348 = (free_type_vars env t)
in (FStar_List.append _133_348 ftvs))
in (env, _133_349))
end
| _51_1043 -> begin
(env, ftvs)
...
let binders = (let _133_351 = (FStar_All.pipe_right ftv (FStar_List.map (fun a -> (FStar_Parser_AST.mk_pattern (FStar_Parser_AST.PatTvar ((a, true))) top.FStar_Parser_AST.range))))
in (FStar_List.append _133_351 binders))
in (
...
let body = (let _133_361 = (let _133_360 = (FStar_Syntax_Syntax.pat_bvs pat)
in (FStar_All.pipe_right _133_360 (FStar_List.map FStar_Syntax_Syntax.mk_binder)))
in (FStar_Syntax_Subst.close _133_361 body))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match ((sc, ((pat, None, body))::[]))) None body.FStar_Syntax_Syntax.pos))
end
| None -> begin
body
end)
in (let _133_362 = (no_annot_abs (FStar_List.rev bs) body)
in (setpos _133_362))))
end
| p::rest -> begin
(
...
| (Some (p), None) -> begin
(let _133_364 = (let _133_363 = (FStar_Syntax_Syntax.bv_to_name x)
in (_133_363, p))
in Some (_133_364))
end
...
let tup2 = (let _133_365 = (FStar_Syntax_Util.mk_tuple_data_lid 2 top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.lid_as_fv _133_365 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))
in (
# 610 "FStar.Parser.ToSyntax.fst"
let sc = (let _133_373 = (let _133_372 = (let _133_371 = (mk (FStar_Syntax_Syntax.Tm_fvar (tup2)))
in (let _133_370 = (let _133_369 = (FStar_Syntax_Syntax.as_arg sc)
in (let _133_368 = (let _133_367 = (let _133_366 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _133_366))
in (_133_367)::[])
in (_133_369)::_133_368))
in (_133_371, _133_370)))
in FStar_Syntax_Syntax.Tm_app (_133_372))
in (FStar_Syntax_Syntax.mk _133_373 None top.FStar_Parser_AST.range))
in (
# 611 "FStar.Parser.ToSyntax.fst"
let p = (let _133_374 = (FStar_Range.union_ranges p'.FStar_Syntax_Syntax.p p.FStar_Syntax_Syntax.p)
in (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_cons ((tup2, ((p', false))::((p, false))::[]))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n _133_374))
in Some ((sc, p)))))
end
| (FStar_Syntax_Syntax.Tm_app (_51_1104, args), FStar_Syntax_Syntax.Pat_cons (_51_1109, pats)) -> begin
(
# 614 "FStar.Parser.ToSyntax.fst"
let tupn = (let _133_375 = (FStar_Syntax_Util.mk_tuple_data_lid (1 + (FStar_List.length args)) top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.lid_as_fv _133_375 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))
in (
# 615 "FStar.Parser.ToSyntax.fst"
let sc = (let _133_382 = (let _133_381 = (let _133_380 = (mk (FStar_Syntax_Syntax.Tm_fvar (tupn)))
in (let _133_379 = (let _133_378 = (let _133_377 = (let _133_376 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _133_376))
in (_133_377)::[])
in (FStar_List.append args _133_378))
in (_133_380, _133_379)))
in FStar_Syntax_Syntax.Tm_app (_133_381))
in (mk _133_382))
in (
# 616 "FStar.Parser.ToSyntax.fst"
let p = (let _133_383 = (FStar_Range.union_ranges p'.FStar_Syntax_Syntax.p p.FStar_Syntax_Syntax.p)
in (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_cons ((tupn, (FStar_List.append pats (((p, false))::[]))))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n _133_383))
in Some ((sc, p)))))
end
| _51_1118 -> begin
(FStar_All.failwith "Impossible")
...
in (let _133_391 = (let _133_390 = (let _133_389 = (FStar_Syntax_Syntax.fvar a FStar_Syntax_Syntax.Delta_equational None)
in (let _133_388 = (let _133_387 = (FStar_Syntax_Syntax.as_arg phi)
in (let _133_386 = (let _133_385 = (let _133_384 = (mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)))
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _133_384))
in (_133_385)::[])
in (_133_387)::_133_386))
in (_133_389, _133_388)))
in FStar_Syntax_Syntax.Tm_app (_133_390))
in (mk _133_391)))
end
| FStar_Parser_AST.App (_51_1137) -> begin
(
# 633 "FStar.Parser.ToSyntax.fst"
let rec aux = (fun args e -> (match ((let _133_396 = (unparen e)
in _133_396.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App (e, t, imp) -> begin
(
# 635 "FStar.Parser.ToSyntax.fst"
let arg = (let _133_397 = (desugar_term env t)
in (FStar_All.pipe_left (arg_withimp_e imp) _133_397))
in (aux ((arg)::args) e))
end
| _51_1149 -> begin
(
...
(let _133_400 = (let _133_399 = (let _133_398 = (desugar_term env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let ((false, (((FStar_Parser_AST.mk_pattern FStar_Parser_AST.PatWild t1.FStar_Parser_AST.range), t1))::[], t2))) top.FStar_Parser_AST.range FStar_Parser_AST.Expr))
in (_133_398, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Sequence)))
in FStar_Syntax_Syntax.Tm_meta (_133_399))
in (mk _133_400))
end
...
(let _133_404 = (destruct_app_pattern env top_level p)
in (_133_404, def))
end else begin
(match ((FStar_Parser_AST.un_function p def)) with
| Some (p, def) -> begin
(let _133_405 = (destruct_app_pattern env top_level p)
in (_133_405, def))
end
| _51_1175 -> begin
(match (p.FStar_Parser_AST.pat) with
...
(let _133_408 = (let _133_407 = (let _133_406 = (FStar_Parser_Env.qualify env id)
in FStar_Util.Inr (_133_406))
in (_133_407, [], Some (t)))
in (_133_408, def))
end else begin
...
if top_level then begin
(let _133_411 = (let _133_410 = (let _133_409 = (FStar_Parser_Env.qualify env id)
in FStar_Util.Inr (_133_409))
in (_133_410, [], None))
in (_133_411, def))
end else begin
...
| (env, xx) -> begin
(let _133_415 = (let _133_414 = (FStar_Syntax_Syntax.mk_binder xx)
in (_133_414)::rec_bindings)
in (env, FStar_Util.Inl (xx), _133_415))
end))
end
| FStar_Util.Inr (l) -> begin
(let _133_416 = (FStar_Parser_Env.push_top_level_rec_binding env l.FStar_Ident.ident FStar_Syntax_Syntax.Delta_equational)
in (_133_416, FStar_Util.Inr (l), rec_bindings))
end)
...
| Some (t) -> begin
(let _133_423 = (FStar_Range.union_ranges t.FStar_Parser_AST.range def.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term (FStar_Parser_AST.Ascribed ((def, t))) _133_423 FStar_Parser_AST.Expr))
end)
in (
...
| FStar_Util.Inr (l) -> begin
(let _133_425 = (let _133_424 = (incr_delta_qualifier body)
in (FStar_Syntax_Syntax.lid_as_fv l _133_424 None))
in FStar_Util.Inr (_133_425))
end)
in (
...
let body = (desugar_term env' body)
in (let _133_428 = (let _133_427 = (let _133_426 = (FStar_Syntax_Subst.close rec_bindings body)
in ((is_rec, lbs), _133_426))
...
let fv = (let _133_435 = (incr_delta_qualifier t1)
in (FStar_Syntax_Syntax.lid_as_fv l _133_435 None))
...
| Some (pat) -> begin
(let _133_440 = (let _133_439 = (let _133_438 = (FStar_Syntax_Syntax.bv_to_name x)
in (let _133_437 = (let _133_436 = (FStar_Syntax_Util.branch (pat, None, body))
in (_133_436)::[])
in (_133_438, _133_437)))
in FStar_Syntax_Syntax.Tm_match (_133_439))
in (FStar_Syntax_Syntax.mk _133_440 None body.FStar_Syntax_Syntax.pos))
end)
in (let _133_445 = (let _133_444 = (let _133_443 = (let _133_442 = (let _133_441 = (FStar_Syntax_Syntax.mk_binder x)
in (_133_441)::[])
in (FStar_Syntax_Subst.close _133_442 body))
in ((false, ((mk_lb (FStar_Util.Inl (x), x.FStar_Syntax_Syntax.sort, t1)))::[]), _133_443))
in FStar_Syntax_Syntax.Tm_let (_133_444))
...
in (let _133_456 = (let _133_455 = (let _133_454 = (desugar_term env t1)
in (let _133_453 = (let _133_452 = (let _133_447 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Parser_AST.range)
in (let _133_446 = (desugar_term env t2)
in (_133_447, None, _133_446)))
in (let _133_451 = (let _133_450 = (let _133_449 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_wild (x)) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t3.FStar_Parser_AST.range)
in (let _133_448 = (desugar_term env t3)
in (_133_449, None, _133_448)))
in (_133_450)::[])
in (_133_452)::_133_451))
in (_133_454, _133_453)))
in FStar_Syntax_Syntax.Tm_match (_133_455))
in (mk _133_456)))
end
...
| Some (e) -> begin
(let _133_459 = (desugar_term env e)
in Some (_133_459))
end)
in (
...
in (let _133_463 = (let _133_462 = (let _133_461 = (desugar_term env e)
in (let _133_460 = (FStar_List.map desugar_branch branches)
in (_133_461, _133_460)))
in FStar_Syntax_Syntax.Tm_match (_133_462))
in (FStar_All.pipe_left mk _133_463)))
end
| FStar_Parser_AST.Ascribed (e, t) -> begin
(let _133_467 = (let _133_466 = (let _133_465 = (desugar_term env e)
in (let _133_464 = (desugar_typ env t)
in (_133_465, _133_464, None)))
in FStar_Syntax_Syntax.Tm_ascribed (_133_466))
in (FStar_All.pipe_left mk _133_467))
end
...
(match (xopt) with
| None -> begin
(let _133_478 = (let _133_477 = (let _133_476 = (FStar_Util.format1 "Field %s is missing" (FStar_Ident.text_of_lid f))
in (_133_476, top.FStar_Parser_AST.range))
in FStar_Syntax_Syntax.Error (_133_477))
in (Prims.raise _133_478))
end
| Some (x) -> begin
(let _133_479 = (qfn fn)
in (_133_479, (FStar_Parser_AST.mk_term (FStar_Parser_AST.Project ((x, f))) x.FStar_Parser_AST.range x.FStar_Parser_AST.level)))
end)
end))))
in (
...
| None -> begin
(let _133_484 = (let _133_483 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _51_1363 -> (match (_51_1363) with
| (f, _51_1362) -> begin
(let _133_482 = (let _133_481 = (get_field None f)
in (FStar_All.pipe_left Prims.snd _133_481))
in (_133_482, FStar_Parser_AST.Nothing))
end))))
in (record.FStar_Parser_Env.constrname, _133_483))
in FStar_Parser_AST.Construct (_133_484))
end
| Some (e) -> begin
(
...
let xterm = (let _133_486 = (let _133_485 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_133_485))
in (FStar_Parser_AST.mk_term _133_486 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
in (
# 777 "FStar.Parser.ToSyntax.fst"
let record = (let _133_489 = (let _133_488 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _51_1371 -> (match (_51_1371) with
| (f, _51_1370) -> begin
(get_field (Some (xterm)) f)
end))))
in (None, _133_488))
in FStar_Parser_AST.Record (_133_489))
...
let e = (let _133_497 = (let _133_496 = (let _133_495 = (let _133_494 = (FStar_Ident.set_lid_range fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v e.FStar_Syntax_Syntax.pos)
in (let _133_493 = (let _133_492 = (let _133_491 = (let _133_490 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map Prims.fst))
in (record.FStar_Parser_Env.typename, _133_490))
in FStar_Syntax_Syntax.Record_ctor (_133_491))
in Some (_133_492))
in (FStar_Syntax_Syntax.fvar _133_494 FStar_Syntax_Syntax.Delta_constant _133_493)))
in (_133_495, args))
in FStar_Syntax_Syntax.Tm_app (_133_496))
in (FStar_All.pipe_left mk _133_497))
...
in (let _133_503 = (let _133_502 = (let _133_501 = (let _133_498 = (FStar_Ident.set_lid_range fieldname (FStar_Ident.range_of_lid f))
in (FStar_Syntax_Syntax.fvar _133_498 FStar_Syntax_Syntax.Delta_equational (Some (FStar_Syntax_Syntax.Record_projector (fn)))))
in (let _133_500 = (let _133_499 = (FStar_Syntax_Syntax.as_arg e)
in (_133_499)::[])
in (_133_501, _133_500)))
in FStar_Syntax_Syntax.Tm_app (_133_502))
in (FStar_All.pipe_left mk _133_503)))))
end))
end
...
| (a, imp) -> begin
(let _133_507 = (desugar_term env a)
in (arg_withimp_e imp _133_507))
end)))))
...
| (t, _51_1441) -> begin
(match ((let _133_515 = (unparen t)
in _133_515.FStar_Parser_AST.tm)) with
...
| (t, _51_1451) -> begin
(match ((let _133_518 = (unparen t)
in _133_518.FStar_Parser_AST.tm)) with
...
| (t, _51_1462) -> begin
(match ((let _133_523 = (unparen t)
in _133_523.FStar_Parser_AST.tm)) with
...
(let _133_526 = (FStar_Parser_Env.fail_or (FStar_Parser_Env.try_lookup_effect_name env) l)
in (_133_526, args))
end
| FStar_Parser_AST.Name (l) when ((let _133_527 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.lid_equals _133_527 FStar_Syntax_Const.prims_lid)) && (l.FStar_Ident.ident.FStar_Ident.idText = "Tot")) -> begin
(let _133_528 = (FStar_Ident.set_lid_range FStar_Syntax_Const.effect_Tot_lid head.FStar_Parser_AST.range)
in (_133_528, args))
end
| FStar_Parser_AST.Name (l) when ((let _133_529 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.lid_equals _133_529 FStar_Syntax_Const.prims_lid)) && (l.FStar_Ident.ident.FStar_Ident.idText = "GTot")) -> begin
(let _133_530 = (FStar_Ident.set_lid_range FStar_Syntax_Const.effect_GTot_lid head.FStar_Parser_AST.range)
in (_133_530, args))
end
...
(let _133_531 = (FStar_Ident.set_lid_range FStar_Syntax_Const.effect_Tot_lid head.FStar_Parser_AST.range)
in (_133_531, ((t, FStar_Parser_AST.Nothing))::[]))
end
| _51_1511 when default_ok -> begin
(let _133_532 = (FStar_Ident.set_lid_range env.FStar_Parser_Env.default_result_effect head.FStar_Parser_AST.range)
in (_133_532, ((t, FStar_Parser_AST.Nothing))::[]))
end
| _51_1513 -> begin
(let _133_534 = (let _133_533 = (FStar_Parser_AST.term_to_string t)
in (FStar_Util.format1 "%s is not an effect" _133_533))
in (fail _133_534))
end)
end)))
in (
...
(let _133_536 = (let _133_535 = (FStar_Syntax_Print.lid_to_string eff)
in (FStar_Util.format1 "Not enough args to effect %s" _133_535))
in (fail _133_536))
end else begin
()
end
...
let _51_1521 = (let _133_538 = (FStar_List.hd args)
in (let _133_537 = (FStar_List.tl args)
in (_133_538, _133_537)))
...
let pattern = (let _133_542 = (let _133_541 = (FStar_Ident.set_lid_range FStar_Syntax_Const.pattern_lid pat.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.fvar _133_541 FStar_Syntax_Syntax.Delta_constant None))
in (FStar_Syntax_Syntax.mk_Tm_uinst _133_542 ((FStar_Syntax_Syntax.U_zero)::(FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app nil (((pattern, Some (FStar_Syntax_Syntax.imp_tag)))::[]) None pat.FStar_Syntax_Syntax.pos)))
end
| _51_1575 -> begin
pat
end)
in (let _133_546 = (let _133_545 = (let _133_544 = (let _133_543 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta ((pat, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Meta_smt_pat)))) None pat.FStar_Syntax_Syntax.pos)
in (_133_543, aq))
in (_133_544)::[])
in (ens)::_133_545)
in (req)::_133_546))
...
let desugar_pats = (fun env pats -> (FStar_List.map (fun es -> (FStar_All.pipe_right es (FStar_List.map (fun e -> (let _133_581 = (desugar_term env e)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _133_581)))))) pats))
in (match (tk) with
| (Some (a), k) -> begin
(
...
let body = (let _133_584 = (let _133_583 = (let _133_582 = (FStar_Syntax_Syntax.mk_binder a)
in (_133_582)::[])
in (no_annot_abs _133_583 body))
in (FStar_All.pipe_left setpos _133_584))
in (let _133_590 = (let _133_589 = (let _133_588 = (let _133_585 = (FStar_Ident.set_lid_range q b.FStar_Parser_AST.brange)
in (FStar_Syntax_Syntax.fvar _133_585 (FStar_Syntax_Syntax.Delta_unfoldable (1)) None))
in (let _133_587 = (let _133_586 = (FStar_Syntax_Syntax.as_arg body)
in (_133_586)::[])
in (_133_588, _133_587)))
in FStar_Syntax_Syntax.Tm_app (_133_589))
in (FStar_All.pipe_left mk _133_590)))))))
end))
end
| _51_1630 -> begin
(FStar_All.failwith "impossible")
...
let body = (let _133_605 = (q (rest, pats, body))
in (let _133_604 = (FStar_Range.union_ranges b'.FStar_Parser_AST.brange body.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term _133_605 _133_604 FStar_Parser_AST.Formula)))
in (let _133_606 = (q ((b)::[], [], body))
in (FStar_Parser_AST.mk_term _133_606 f.FStar_Parser_AST.range FStar_Parser_AST.Formula))))
end
| _51_1644 -> begin
(FStar_All.failwith "impossible")
end))
in (match ((let _133_607 = (unparen f)
in _133_607.FStar_Parser_AST.tm)) with
...
in (let _133_609 = (push_quant (fun x -> FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env _133_609)))
end
| FStar_Parser_AST.QExists (_1::_2::_3, pats, body) -> begin
(
# 961 "FStar.Parser.ToSyntax.fst"
let binders = (_1)::(_2)::_3
in (let _133_611 = (push_quant (fun x -> FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env _133_611)))
end
...
(let _133_618 = (desugar_typ env t)
in (Some (x), _133_618))
end
| FStar_Parser_AST.TVariable (x) -> begin
(let _133_619 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_unknown)) None x.FStar_Ident.idRange)
in (Some (x), _133_619))
end
| FStar_Parser_AST.NoName (t) -> begin
(let _133_620 = (desugar_typ env t)
in (None, _133_620))
end
...
let binders = (let _133_636 = (let _133_635 = (FStar_Syntax_Util.arrow_formals k)
in (Prims.fst _133_635))
in (FStar_List.append tps _133_636))
in (
...
let binders = (let _133_642 = (let _133_641 = (let _133_640 = (let _133_639 = (let _133_638 = (FStar_Syntax_Syntax.lid_as_fv t FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _133_638))
in (FStar_Syntax_Syntax.mk_Tm_app _133_639 args None p))
in (FStar_All.pipe_left FStar_Syntax_Syntax.null_binder _133_640))
in (_133_641)::[])
in (FStar_List.append imp_binders _133_642))
in (
# 1002 "FStar.Parser.ToSyntax.fst"
let disc_type = (let _133_645 = (let _133_644 = (let _133_643 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.bool_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _133_643))
in (FStar_Syntax_Syntax.mk_Total _133_644))
in (FStar_Syntax_Util.arrow binders _133_645))
in (FStar_All.pipe_right datas (FStar_List.map (fun d -> (
# 1004 "FStar.Parser.ToSyntax.fst"
let disc_name = (FStar_Syntax_Util.mk_discriminator d)
in (let _133_648 = (let _133_647 = (quals ((FStar_Syntax_Syntax.Logic)::(FStar_Syntax_Syntax.Discriminator (d))::[]))
in (disc_name, [], disc_type, _133_647, (FStar_Ident.range_of_lid disc_name)))
in FStar_Syntax_Syntax.Sig_declare_typ (_133_648)))))))))
end))))))
...
let indices = (FStar_All.pipe_right args (FStar_List.map (fun _51_1871 -> (let _133_678 = (FStar_Syntax_Syntax.new_bv (Some (p)) FStar_Syntax_Syntax.tun)
in (FStar_All.pipe_right _133_678 FStar_Syntax_Syntax.mk_binder)))))
in (
# 1025 "FStar.Parser.ToSyntax.fst"
let arg_typ = (let _133_683 = (let _133_679 = (FStar_Syntax_Syntax.lid_as_fv tc FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _133_679))
in (let _133_682 = (FStar_All.pipe_right (FStar_List.append tps indices) (FStar_List.map (fun _51_1876 -> (match (_51_1876) with
| (x, imp) -> begin
(let _133_681 = (FStar_Syntax_Syntax.bv_to_name x)
in (_133_681, imp))
end))))
in (FStar_Syntax_Syntax.mk_Tm_app _133_683 _133_682 None p)))
in (
# 1027 "FStar.Parser.ToSyntax.fst"
let arg_binder = if (not (refine_domain)) then begin
(let _133_684 = (projectee arg_typ)
in (FStar_Syntax_Syntax.mk_binder _133_684))
end else begin
(
...
in (let _133_692 = (let _133_691 = (let _133_690 = (let _133_689 = (let _133_685 = (FStar_Ident.set_lid_range disc_name p)
in (FStar_Syntax_Syntax.fvar _133_685 FStar_Syntax_Syntax.Delta_equational None))
in (let _133_688 = (let _133_687 = (let _133_686 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _133_686))
in (_133_687)::[])
in (FStar_Syntax_Syntax.mk_Tm_app _133_689 _133_688 None p)))
in (FStar_Syntax_Util.b2t _133_690))
in (FStar_Syntax_Util.refine x _133_691))
in {FStar_Syntax_Syntax.ppname = _51_1880.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _51_1880.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _133_692}))
in (FStar_Syntax_Syntax.mk_binder _133_693))))
end
...
let imp_binders = (let _133_695 = (FStar_All.pipe_right indices (FStar_List.map (fun _51_1890 -> (match (_51_1890) with
| (x, _51_1889) -> begin
(x, Some (FStar_Syntax_Syntax.imp_tag))
end))))
in (FStar_List.append imp_tps _133_695))
in (
...
let proj = (let _133_699 = (let _133_698 = (FStar_Syntax_Syntax.lid_as_fv field_name FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Syntax_Syntax.fv_to_tm _133_698))
in (FStar_Syntax_Syntax.mk_Tm_app _133_699 ((arg)::[]) None p))
...
in (let _133_735 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i _51_1911 -> (match (_51_1911) with
| (x, _51_1910) -> begin
(
...
let t = (let _133_703 = (let _133_702 = (FStar_Syntax_Subst.subst subst x.FStar_Syntax_Syntax.sort)
in (FStar_Syntax_Syntax.mk_Total _133_702))
in (FStar_Syntax_Util.arrow binders _133_703))
in (
# 1053 "FStar.Parser.ToSyntax.fst"
let only_decl = (((let _133_704 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Syntax_Const.prims_lid _133_704)) || (fvq <> FStar_Syntax_Syntax.Data_ctor)) || (let _133_706 = (let _133_705 = (FStar_Parser_Env.current_module env)
in _133_705.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors _133_706)))
in (
...
(let _133_711 = (pos (FStar_Syntax_Syntax.Pat_var (projection)))
in (_133_711, b))
end else begin
if (b && (j < ntps)) then begin
(let _133_715 = (let _133_714 = (let _133_713 = (let _133_712 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in (_133_712, FStar_Syntax_Syntax.tun))
in FStar_Syntax_Syntax.Pat_dot_term (_133_713))
in (pos _133_714))
in (_133_715, b))
end else begin
(let _133_718 = (let _133_717 = (let _133_716 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in FStar_Syntax_Syntax.Pat_wild (_133_716))
in (pos _133_717))
in (_133_718, b))
end
end)
...
let pat = (let _133_723 = (let _133_721 = (let _133_720 = (let _133_719 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant (Some (fvq)))
in (_133_719, arg_pats))
in FStar_Syntax_Syntax.Pat_cons (_133_720))
in (FStar_All.pipe_right _133_721 pos))
in (let _133_722 = (FStar_Syntax_Syntax.bv_to_name projection)
in (_133_723, None, _133_722)))
in (
# 1072 "FStar.Parser.ToSyntax.fst"
let body = (let _133_727 = (let _133_726 = (let _133_725 = (let _133_724 = (FStar_Syntax_Util.branch pat)
in (_133_724)::[])
in (arg_exp, _133_725))
in FStar_Syntax_Syntax.Tm_match (_133_726))
in (FStar_Syntax_Syntax.mk _133_727 None p))
in (
...
let lb = (let _133_729 = (let _133_728 = (FStar_Syntax_Syntax.lid_as_fv field_name dd None)
in FStar_Util.Inr (_133_728))
in {FStar_Syntax_Syntax.lbname = _133_729; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = FStar_Syntax_Syntax.tun; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = imp})
in (
# 1082 "FStar.Parser.ToSyntax.fst"
let impl = (let _133_734 = (let _133_733 = (let _133_732 = (let _133_731 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right _133_731 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (_133_732)::[])
in ((false, (lb)::[]), p, _133_733, quals))
in FStar_Syntax_Syntax.Sig_let (_133_734))
...
in (FStar_All.pipe_right _133_735 FStar_List.flatten)))))))))
end)))))))
...
let dd = if (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract)) then begin
(let _133_758 = (incr_delta_qualifier t)
in FStar_Syntax_Syntax.Delta_abstract (_133_758))
end else begin
(incr_delta_qualifier t)
end
in (
# 1111 "FStar.Parser.ToSyntax.fst"
let lb = (let _133_763 = (let _133_759 = (FStar_Syntax_Syntax.lid_as_fv lid dd None)
in FStar_Util.Inr (_133_759))
in (let _133_762 = (let _133_760 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_Syntax_Util.arrow typars _133_760))
in (let _133_761 = (no_annot_abs typars t)
in {FStar_Syntax_Syntax.lbname = _133_763; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = _133_762; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = _133_761})))
...
(let _133_777 = (let _133_776 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_133_776))
in (FStar_Parser_AST.mk_term _133_777 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
...
in (FStar_List.fold_left (fun out b -> (let _133_790 = (let _133_789 = (let _133_788 = (binder_to_term b)
in (out, _133_788, (imp_of_aqual b)))
in FStar_Parser_AST.App (_133_789))
in (FStar_Parser_AST.mk_term _133_790 out.FStar_Parser_AST.range out.FStar_Parser_AST.level))) t binders)))
in (
...
let result = (let _133_796 = (let _133_795 = (let _133_794 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_133_794))
in (FStar_Parser_AST.mk_term _133_795 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _133_796 parms))
in (
# 1145 "FStar.Parser.ToSyntax.fst"
let constrTyp = (FStar_Parser_AST.mk_term (FStar_Parser_AST.Product ((mfields, (with_constructor_effect result)))) id.FStar_Ident.idRange FStar_Parser_AST.Type)
in (let _133_798 = (FStar_All.pipe_right fields (FStar_List.map (fun _51_2079 -> (match (_51_2079) with
| (x, _51_2078) -> begin
(FStar_Parser_Env.qualify env x)
end))))
in (FStar_Parser_AST.TyconVariant ((id, parms, kopt, ((constrName, Some (constrTyp), false))::[])), _133_798))))))
end
| _51_2081 -> begin
(FStar_All.failwith "impossible")
end))
...
let tconstr = (let _133_809 = (let _133_808 = (let _133_807 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_133_807))
in (FStar_Parser_AST.mk_term _133_808 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _133_809 binders))
in (
...
let _51_2148 = (let _133_817 = (FStar_Range.string_of_range rng)
in (let _133_816 = (FStar_Syntax_Print.lid_to_string l)
...
| _51_2153 -> begin
(let _133_820 = (let _133_819 = (let _133_818 = (FStar_Syntax_Syntax.mk_Total k)
in (typars, _133_818))
in FStar_Syntax_Syntax.Tm_arrow (_133_819))
in (FStar_Syntax_Syntax.mk _133_820 None rng))
end)
...
in (let _133_826 = (let _133_825 = (FStar_Parser_Env.qualify env id)
in (let _133_824 = (FStar_All.pipe_right quals (FStar_List.filter (fun _51_17 -> (match (_51_17) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| _51_2189 -> begin
...
in (_133_825, [], typars, c, _133_824, rng)))
in FStar_Syntax_Syntax.Sig_effect_abbrev (_133_826)))))
end else begin
(
...
in (let _133_836 = (let _133_835 = (mk_typ_abbrev id uvs tpars k t ((id)::[]) quals rng)
in ([], _133_835))
in (_133_836)::[]))
end))
end
...
let _51_2326 = (let _133_848 = (FStar_All.pipe_right constrs (FStar_List.map (fun _51_2307 -> (match (_51_2307) with
...
let t = (let _133_840 = (FStar_Parser_Env.default_total env_tps)
in (let _133_839 = (close env_tps t)
in (desugar_term _133_840 _133_839)))
in (
...
in (let _133_847 = (let _133_846 = (let _133_845 = (let _133_844 = (let _133_843 = (let _133_842 = (FStar_All.pipe_right t FStar_Syntax_Util.name_function_binders)
in (FStar_Syntax_Syntax.mk_Total _133_842))
in (FStar_Syntax_Util.arrow data_tpars _133_843))
in (name, univs, _133_844, tname, ntps, quals, mutuals, rng))
in FStar_Syntax_Syntax.Sig_datacon (_133_845))
in (tps, _133_846))
in (name, _133_847)))))))
end))))
in (FStar_All.pipe_left FStar_List.split _133_848))
...
let bundle = (let _133_850 = (let _133_849 = (FStar_List.collect FStar_Syntax_Util.lids_of_sigelt sigelts)
in (sigelts, quals, _133_849, rng))
in FStar_Syntax_Syntax.Sig_bundle (_133_850))
in (
...
| (env, a) -> begin
(let _133_859 = (let _133_858 = (FStar_Syntax_Syntax.mk_binder (
...
(let _133_864 = (FStar_List.map trans_qual qual)
in (desugar_tycon env d.FStar_Parser_AST.drange _133_864 tcs))
end
| FStar_Parser_AST.ToplevelLet (quals, isrec, lets) -> begin
(match ((let _133_866 = (let _133_865 = (desugar_term_maybe_top true env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let ((isrec, lets, (FStar_Parser_AST.mk_term (FStar_Parser_AST.Const (FStar_Const.Const_unit)) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr)))) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))
in (FStar_All.pipe_left FStar_Syntax_Subst.compress _133_865))
in _133_866.FStar_Syntax_Syntax.n)) with
...
(let _133_871 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (
...
in ((Prims.fst lbs), _133_871))
end else begin
lbs
end
in (
# 1324 "FStar.Parser.ToSyntax.fst"
let s = (let _133_874 = (let _133_873 = (FStar_All.pipe_right fvs (FStar_List.map (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (lbs, d.FStar_Parser_AST.drange, _133_873, quals))
in FStar_Syntax_Syntax.Sig_let (_133_874))
in (
...
in (let _133_878 = (let _133_877 = (let _133_876 = (let _133_875 = (FStar_Parser_Env.qualify env id)
in (_133_875, f, (FStar_Syntax_Syntax.Assumption)::[], d.FStar_Parser_AST.drange))
in FStar_Syntax_Syntax.Sig_assume (_133_876))
in (_133_877)::[])
in (env, _133_878)))
end
...
let t = (let _133_879 = (close_fun env t)
in (desugar_term env _133_879))
in (
...
let se = (let _133_882 = (let _133_881 = (FStar_Parser_Env.qualify env id)
in (let _133_880 = (FStar_List.map trans_qual quals)
in (_133_881, [], t, _133_880, d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Sig_declare_typ (_133_882))
in (
...
let t = (let _133_886 = (let _133_883 = (FStar_Syntax_Syntax.null_binder t)
in (_133_883)::[])
in (let _133_885 = (let _133_884 = (FStar_Parser_Env.fail_or (FStar_Parser_Env.try_lookup_lid env) FStar_Syntax_Const.exn_lid)
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total _133_884))
in (FStar_Syntax_Util.arrow _133_886 _133_885)))
in (
...
| _51_2522 -> begin
(let _133_891 = (let _133_890 = (let _133_889 = (let _133_888 = (let _133_887 = (FStar_Parser_AST.term_to_string head)
in (Prims.strcat "Effect " _133_887))
in (Prims.strcat _133_888 " not found"))
in (_133_889, d.FStar_Parser_AST.drange))
in FStar_Syntax_Syntax.Error (_133_890))
in (Prims.raise _133_891))
end)
in (let _133_892 = (desugar_args env args)
in (ed, _133_892)))
end))
...
in (let _133_896 = (let _133_895 = (FStar_Syntax_Subst.subst s x)
in (FStar_Syntax_Subst.close binders _133_895))
in ([], _133_896)))
end))
end))
in (
# 1391 "FStar.Parser.ToSyntax.fst"
let ed = (let _133_913 = (FStar_List.map trans_qual quals)
in (let _133_912 = (FStar_Parser_Env.qualify env0 eff_name)
in (let _133_911 = (let _133_897 = (sub ([], ed.FStar_Syntax_Syntax.signature))
in (Prims.snd _133_897))
in (let _133_910 = (sub ed.FStar_Syntax_Syntax.ret)
in (let _133_909 = (sub ed.FStar_Syntax_Syntax.bind_wp)
in (let _133_908 = (sub ed.FStar_Syntax_Syntax.bind_wlp)
in (let _133_907 = (sub ed.FStar_Syntax_Syntax.if_then_else)
in (let _133_906 = (sub ed.FStar_Syntax_Syntax.ite_wp)
in (let _133_905 = (sub ed.FStar_Syntax_Syntax.ite_wlp)
in (let _133_904 = (sub ed.FStar_Syntax_Syntax.wp_binop)
in (let _133_903 = (sub ed.FStar_Syntax_Syntax.wp_as_type)
in (let _133_902 = (sub ed.FStar_Syntax_Syntax.close_wp)
in (let _133_901 = (sub ed.FStar_Syntax_Syntax.assert_p)
in (let _133_900 = (sub ed.FStar_Syntax_Syntax.assume_p)
in (let _133_899 = (sub ed.FStar_Syntax_Syntax.null_wp)
in (let _133_898 = (sub ed.FStar_Syntax_Syntax.trivial)
in {FStar_Syntax_Syntax.qualifiers = _133_913; FStar_Syntax_Syntax.mname = _133_912; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = _133_911; FStar_Syntax_Syntax.ret = _133_910; FStar_Syntax_Syntax.bind_wp = _133_909; FStar_Syntax_Syntax.bind_wlp = _133_908; FStar_Syntax_Syntax.if_then_else = _133_907; FStar_Syntax_Syntax.ite_wp = _133_906; FStar_Syntax_Syntax.ite_wlp = _133_905; FStar_Syntax_Syntax.wp_binop = _133_904; FStar_Syntax_Syntax.wp_as_type = _133_903; FStar_Syntax_Syntax.close_wp = _133_902; FStar_Syntax_Syntax.assert_p = _133_901; FStar_Syntax_Syntax.assume_p = _133_900; FStar_Syntax_Syntax.null_wp = _133_899; FStar_Syntax_Syntax.trivial = _133_898}))))))))))))))))
in (
...
let eff_k = (let _133_914 = (FStar_Parser_Env.default_total env)
in (desugar_term _133_914 eff_kind))
in (
...
| (env, ses) -> begin
(let _133_918 = (let _133_917 = (FStar_List.hd ses)
in (_133_917)::out)
in (env, _133_918))
end))
end)) (env, [])))
...
in (let _133_922 = (let _133_921 = (FStar_Parser_Env.fail_or (FStar_Parser_Env.try_lookup_definition env) l)
in (FStar_All.pipe_left (FStar_Syntax_Subst.close binders) _133_921))
in ([], _133_922))))
in (
# 1428 "FStar.Parser.ToSyntax.fst"
let ed = (let _133_937 = (FStar_List.map trans_qual quals)
in (let _133_936 = (FStar_Parser_Env.qualify env0 eff_name)
in (let _133_935 = (lookup "return")
in (let _133_934 = (lookup "bind_wp")
in (let _133_933 = (lookup "bind_wlp")
in (let _133_932 = (lookup "if_then_else")
in (let _133_931 = (lookup "ite_wp")
in (let _133_930 = (lookup "ite_wlp")
in (let _133_929 = (lookup "wp_binop")
in (let _133_928 = (lookup "wp_as_type")
in (let _133_927 = (lookup "close_wp")
in (let _133_926 = (lookup "assert_p")
in (let _133_925 = (lookup "assume_p")
in (let _133_924 = (lookup "null_wp")
in (let _133_923 = (lookup "trivial")
in {FStar_Syntax_Syntax.qualifiers = _133_937; FStar_Syntax_Syntax.mname = _133_936; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = eff_k; FStar_Syntax_Syntax.ret = _133_935; FStar_Syntax_Syntax.bind_wp = _133_934; FStar_Syntax_Syntax.bind_wlp = _133_933; FStar_Syntax_Syntax.if_then_else = _133_932; FStar_Syntax_Syntax.ite_wp = _133_931; FStar_Syntax_Syntax.ite_wlp = _133_930; FStar_Syntax_Syntax.wp_binop = _133_929; FStar_Syntax_Syntax.wp_as_type = _133_928; FStar_Syntax_Syntax.close_wp = _133_927; FStar_Syntax_Syntax.assert_p = _133_926; FStar_Syntax_Syntax.assume_p = _133_925; FStar_Syntax_Syntax.null_wp = _133_924; FStar_Syntax_Syntax.trivial = _133_923})))))))))))))))
in (
...
| None -> begin
(let _133_944 = (let _133_943 = (let _133_942 = (let _133_941 = (let _133_940 = (FStar_Syntax_Print.lid_to_string l)
in (Prims.strcat "Effect name " _133_940))
in (Prims.strcat _133_941 " not found"))
in (_133_942, d.FStar_Parser_AST.drange))
in FStar_Syntax_Syntax.Error (_133_943))
in (Prims.raise _133_944))
end
| Some (l) -> begin
l
end))
...
let lift = (let _133_945 = (desugar_term env l.FStar_Parser_AST.lift_op)
in ([], _133_945))
in (
...
(let _133_964 = (let _133_963 = (let _133_962 = (FStar_Ident.lid_of_ids mname.FStar_Ident.ns)
in FStar_Parser_AST.Open (_133_962))
in (FStar_Parser_AST.mk_decl _133_963 (FStar_Ident.range_of_lid mname)))
in (_133_964)::d)
end else begin
d
end
...
(let _133_966 = (FStar_Parser_Env.prepare_module_or_interface true admitted env mname)
in (let _133_965 = (open_ns mname decls)
in (_133_966, mname, _133_965, true)))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(let _133_968 = (FStar_Parser_Env.prepare_module_or_interface false false env mname)
in (let _133_967 = (open_ns mname decls)
in (_133_968, mname, _133_967, false)))
end)
...
(let _133_979 = (FStar_Syntax_Print.modul_to_string modul)
in (FStar_Util.print1 "%s\n" _133_979))
end else begin
()
end
in (let _133_980 = if pop_when_done then begin
