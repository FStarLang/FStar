...
(let _164_45 = (let _164_43 = (FStar_Util.char_at s i)
in (name_of_char _164_43))
in (let _164_44 = (aux (i + (Prims.parse_int "1")))
in (_164_45)::_164_44))
end)
in (match (s) with
| ".[]<-" -> begin
...
| _66_150 -> begin
(let _164_47 = (let _164_46 = (aux (Prims.parse_int "0"))
in (FStar_String.concat "_" _164_46))
in (Prims.strcat "op_" _164_47))
end))))


let compile_op_lid : Prims.int  ->  Prims.string  ->  FStar_Range.range  ->  FStar_Ident.lident = (fun n s r -> (let _164_57 = (let _164_56 = (let _164_55 = (let _164_54 = (compile_op n s)
in ((_164_54), (r)))
in (FStar_Ident.mk_ident _164_55))
in (_164_56)::[])
in (FStar_All.pipe_right _164_57 FStar_Ident.lid_of_ids)))
...
let r = (fun l dd -> (let _164_71 = (let _164_70 = (FStar_Syntax_Syntax.lid_as_fv (FStar_Ident.set_lid_range l rng) dd None)
in (FStar_All.pipe_right _164_70 FStar_Syntax_Syntax.fv_to_tm))
in Some (_164_71)))
in (
...
in (match ((let _164_74 = (compile_op_lid arity s rng)
in (FStar_Parser_Env.try_lookup_lid env _164_74))) with
| Some (t) -> begin
Some ((Prims.fst t))
end
| _66_194 -> begin
...
let sort_ftv : FStar_Ident.ident Prims.list  ->  FStar_Ident.ident Prims.list = (fun ftv -> (let _164_81 = (FStar_Util.remove_dups (fun x y -> (x.FStar_Ident.idText = y.FStar_Ident.idText)) ftv)
in (FStar_All.pipe_left (FStar_Util.sort_with (fun x y -> (FStar_String.compare x.FStar_Ident.idText y.FStar_Ident.idText))) _164_81)))
...
(let _164_88 = (free_type_vars env term)
in ((env), (_164_88)))
end
...
(let _164_89 = (free_type_vars env t)
in ((env), (_164_89)))
end))
and free_type_vars : FStar_Parser_Env.env  ->  FStar_Parser_AST.term  ->  FStar_Ident.ident Prims.list = (fun env t -> (match ((let _164_92 = (unparen t)
in _164_92.FStar_Parser_AST.tm)) with
...
(let _164_95 = (free_type_vars env t1)
in (let _164_94 = (free_type_vars env t2)
in (FStar_List.append _164_95 _164_94)))
end
...
| (env, f) -> begin
(let _164_96 = (free_type_vars env t)
in (FStar_List.append f _164_96))
end))
end
...
| (env, free) -> begin
(let _164_99 = (free_type_vars env body)
in (FStar_List.append free _164_99))
end))
end
...
let rec aux = (fun args t -> (match ((let _164_106 = (unparen t)
in _164_106.FStar_Parser_AST.tm)) with
...
let ftv = (let _164_111 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _164_111))
in if ((FStar_List.length ftv) = (Prims.parse_int "0")) then begin
t
end else begin
(

let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _164_115 = (let _164_114 = (let _164_113 = (tm_type x.FStar_Ident.idRange)
in ((x), (_164_113)))
in FStar_Parser_AST.TAnnotated (_164_114))
in (FStar_Parser_AST.mk_binder _164_115 x.FStar_Ident.idRange FStar_Parser_AST.Type (Some (FStar_Parser_AST.Implicit)))))))
in (
...
let ftv = (let _164_120 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _164_120))
in if ((FStar_List.length ftv) = (Prims.parse_int "0")) then begin
t
end else begin
(

let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _164_124 = (let _164_123 = (let _164_122 = (tm_type x.FStar_Ident.idRange)
in ((x), (_164_122)))
in FStar_Parser_AST.TAnnotated (_164_123))
in (FStar_Parser_AST.mk_binder _164_124 x.FStar_Ident.idRange FStar_Parser_AST.Type (Some (FStar_Parser_AST.Implicit)))))))
in (

let t = (match ((let _164_125 = (unparen t)
in _164_125.FStar_Parser_AST.tm)) with
...
(let _164_143 = (let _164_142 = (FStar_Parser_Env.qualify env id)
in FStar_Util.Inr (_164_142))
in ((_164_143), (args), (None)))
end
...
| (None, k) -> begin
(let _164_180 = (FStar_Syntax_Syntax.null_binder k)
in ((_164_180), (env)))
end
| (Some (a), k) -> begin
(
...
let tm' = (let _164_193 = (let _164_192 = (let _164_188 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.sread_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _164_188))
in (let _164_191 = (let _164_190 = (let _164_189 = (FStar_Syntax_Syntax.as_implicit false)
in ((tm), (_164_189)))
in (_164_190)::[])
in ((_164_192), (_164_191))))
in FStar_Syntax_Syntax.Tm_app (_164_193))
in (FStar_Syntax_Syntax.mk tm' None tm.FStar_Syntax_Syntax.pos)))


let mk_ref_alloc = (fun tm -> (

let tm' = (let _164_200 = (let _164_199 = (let _164_195 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.salloc_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _164_195))
in (let _164_198 = (let _164_197 = (let _164_196 = (FStar_Syntax_Syntax.as_implicit false)
in ((tm), (_164_196)))
in (_164_197)::[])
in ((_164_199), (_164_198))))
in FStar_Syntax_Syntax.Tm_app (_164_200))
in (FStar_Syntax_Syntax.mk tm' None tm.FStar_Syntax_Syntax.pos)))


let mk_ref_assign = (fun t1 t2 pos -> (

let tm = (let _164_212 = (let _164_211 = (let _164_204 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.swrite_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _164_204))
in (let _164_210 = (let _164_209 = (let _164_205 = (FStar_Syntax_Syntax.as_implicit false)
in ((t1), (_164_205)))
in (let _164_208 = (let _164_207 = (let _164_206 = (FStar_Syntax_Syntax.as_implicit false)
in ((t2), (_164_206)))
in (_164_207)::[])
in (_164_209)::_164_208))
in ((_164_211), (_164_210))))
in FStar_Syntax_Syntax.Tm_app (_164_212))
...
(let _164_219 = (sum_to_universe u (n - (Prims.parse_int "1")))
in FStar_Syntax_Syntax.U_succ (_164_219))
end)
...
let rec desugar_maybe_non_constant_universe : FStar_Parser_AST.term  ->  (Prims.int, FStar_Syntax_Syntax.universe) FStar_Util.either = (fun t -> (match ((let _164_224 = (unparen t)
in _164_224.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Wild -> begin
(let _164_225 = (FStar_TypeChecker_Env.new_u_univ ())
in FStar_Util.Inr (_164_225))
end
...
(let _164_226 = (sum_to_universe u n)
in FStar_Util.Inr (_164_226))
end
| (FStar_Util.Inr (u1), FStar_Util.Inr (u2)) -> begin
(let _164_230 = (let _164_229 = (let _164_228 = (let _164_227 = (FStar_Parser_AST.term_to_string t)
in (Prims.strcat "This universe might contain a sum of two universe variables " _164_227))
in ((_164_228), (t.FStar_Parser_AST.range)))
in FStar_Syntax_Syntax.Error (_164_229))
in (Prims.raise _164_230))
end))))
end
| FStar_Parser_AST.App (_66_573) -> begin
(

let rec aux = (fun t univargs -> (match ((let _164_235 = (unparen t)
in _164_235.FStar_Parser_AST.tm)) with
...
(let _164_239 = (let _164_238 = (FStar_List.map (fun _66_10 -> (match (_66_10) with
...
in FStar_Syntax_Syntax.U_max (_164_238))
in FStar_Util.Inr (_164_239))
end else begin
(
...
in (let _164_243 = (FStar_List.fold_left (fun m n -> if (m > n) then begin
m
end else begin
n
end) (Prims.parse_int "0") nargs)
in FStar_Util.Inl (_164_243)))
end)
end
| _66_610 -> begin
(let _164_248 = (let _164_247 = (let _164_246 = (let _164_245 = (let _164_244 = (FStar_Parser_AST.term_to_string t)
in (Prims.strcat _164_244 " in universe context"))
in (Prims.strcat "Unexpected term " _164_245))
in ((_164_246), (t.FStar_Parser_AST.range)))
in FStar_Syntax_Syntax.Error (_164_247))
in (Prims.raise _164_248))
end))
in (aux t []))
end
| _66_612 -> begin
(let _164_253 = (let _164_252 = (let _164_251 = (let _164_250 = (let _164_249 = (FStar_Parser_AST.term_to_string t)
in (Prims.strcat _164_249 " in universe context"))
in (Prims.strcat "Unexpected term " _164_250))
in ((_164_251), (t.FStar_Parser_AST.range)))
in FStar_Syntax_Syntax.Error (_164_252))
in (Prims.raise _164_253))
end))
...
let _66_633 = (let _164_261 = (FStar_List.tl fields)
in (FStar_List.iter check_field _164_261))
in (match (()) with
| () -> begin
record
end))))
...
| (p, _66_660) -> begin
(let _164_318 = (pat_vars p)
in (FStar_Util.set_union out _164_318))
...
(let _164_347 = (let _164_346 = (let _164_345 = (let _164_344 = (let _164_343 = (compile_op (Prims.parse_int "0") op)
in (FStar_Ident.id_of_text _164_343))
in ((_164_344), (None)))
in FStar_Parser_AST.PatVar (_164_345))
in {FStar_Parser_AST.pat = _164_346; FStar_Parser_AST.prange = p.FStar_Parser_AST.prange})
in (aux loc env _164_347))
end
...
let t = (let _164_350 = (close_fun env t)
in (desugar_term env _164_350))
in LocalBinder ((((
...
in (let _164_351 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_wild (x)))
in ((loc), (env), (LocalBinder (((x), (None)))), (_164_351), (false))))
end
| FStar_Parser_AST.PatConst (c) -> begin
(

let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _164_352 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_constant (c)))
in ((loc), (env), (LocalBinder (((x), (None)))), (_164_352), (false))))
end
...
| (loc, env, xbv) -> begin
(let _164_353 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_var (xbv)))
in ((loc), (env), (LocalBinder (((xbv), (aq)))), (_164_353), (imp)))
end))))
end
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _164_354 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l), ([])))))
in ((loc), (env), (LocalBinder (((x), (None)))), (_164_354), (false)))))
end
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _164_357 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l), (args)))))
in ((loc), (env), (LocalBinder (((x), (None)))), (_164_357), (false)))))
end))
end
...
let pat = (let _164_370 = (let _164_369 = (let _164_365 = (FStar_Range.end_range p.FStar_Parser_AST.prange)
in (pos_r _164_365))
in (let _164_368 = (let _164_367 = (let _164_366 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.nil_lid FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in ((_164_366), ([])))
in FStar_Syntax_Syntax.Pat_cons (_164_367))
in (FStar_All.pipe_left _164_369 _164_368)))
in (FStar_List.fold_right (fun hd tl -> (

let r = (FStar_Range.union_ranges hd.FStar_Syntax_Syntax.p tl.FStar_Syntax_Syntax.p)
in (let _164_364 = (let _164_363 = (let _164_362 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.cons_lid FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in ((_164_362), ((((hd), (false)))::(((tl), (false)))::[])))
in FStar_Syntax_Syntax.Pat_cons (_164_363))
in (FStar_All.pipe_left (pos_r r) _164_364)))) pats _164_370))
in (
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _164_373 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l), (args)))))
in ((loc), (env), (LocalBinder (((x), (None)))), (_164_373), (false)))))
end))))
end))
end
...
let app = (let _164_381 = (let _164_380 = (let _164_379 = (let _164_378 = (let _164_377 = (FStar_Ident.lid_of_ids (FStar_List.append record.FStar_Parser_Env.typename.FStar_Ident.ns ((record.FStar_Parser_Env.constrname)::[])))
in FStar_Parser_AST.PatName (_164_377))
in (FStar_Parser_AST.mk_pattern _164_378 p.FStar_Parser_AST.prange))
in ((_164_379), (args)))
in FStar_Parser_AST.PatApp (_164_380))
in (FStar_Parser_AST.mk_pattern _164_381 p.FStar_Parser_AST.prange))
in (
...
(let _164_388 = (let _164_387 = (let _164_386 = (

let _66_905 = fv
in (let _164_385 = (let _164_384 = (let _164_383 = (let _164_382 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map Prims.fst))
in ((record.FStar_Parser_Env.typename), (_164_382)))
in FStar_Syntax_Syntax.Record_ctor (_164_383))
in Some (_164_384))
in {FStar_Syntax_Syntax.fv_name = _66_905.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = _66_905.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = _164_385}))
in ((_164_386), (args)))
in FStar_Syntax_Syntax.Pat_cons (_164_387))
in (FStar_All.pipe_left pos _164_388))
end
| _66_908 -> begin
p
end)
...
let _66_918 = (let _164_389 = (check_linear_pattern_variables p)
in (FStar_All.pipe_left Prims.ignore _164_389))
in ((env), (b), (p)))
end))))))))
...
let mklet = (fun x -> (let _164_398 = (let _164_397 = (let _164_396 = (FStar_Parser_Env.qualify env x)
in ((_164_396), (FStar_Syntax_Syntax.tun)))
in LetBinder (_164_397))
in ((env), (_164_398), (None))))
in if top then begin
(match (p.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatOp (x) -> begin
(let _164_400 = (let _164_399 = (compile_op (Prims.parse_int "0") x)
in (FStar_Ident.id_of_text _164_399))
in (mklet _164_400))
end
...
(let _164_404 = (let _164_403 = (let _164_402 = (FStar_Parser_Env.qualify env x)
in (let _164_401 = (desugar_term env t)
in ((_164_402), (_164_401))))
in LetBinder (_164_403))
in ((env), (_164_404), (None)))
end
| _66_945 -> begin
...
| None -> begin
(let _164_420 = (FStar_Util.format1 "%s not in scope\n" (FStar_Ident.text_of_lid lid))
in (FStar_All.failwith _164_420))
end)
in (

let repr = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_int (((repr), (None))))) None range)
in (let _164_425 = (let _164_424 = (let _164_423 = (let _164_422 = (let _164_421 = (FStar_Syntax_Syntax.as_implicit false)
in ((repr), (_164_421)))
in (_164_422)::[])
in ((lid), (_164_423)))
in FStar_Syntax_Syntax.Tm_app (_164_424))
in (FStar_Syntax_Syntax.mk _164_425 None range))))))
end))
...
(let _164_438 = (let _164_437 = (let _164_436 = (mk_ref_read tm)
in ((_164_436), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Mutable_rval))))
in FStar_Syntax_Syntax.Tm_meta (_164_437))
in (FStar_All.pipe_left mk _164_438))
end else begin
tm
end)
end)))
...
let desugar_attribute = (fun t -> (match ((let _164_443 = (unparen t)
in _164_443.FStar_Parser_AST.tm)) with
...
| _66_1025 -> begin
(let _164_447 = (let _164_446 = (let _164_445 = (let _164_444 = (FStar_Parser_AST.term_to_string t)
in (Prims.strcat "Unknown attribute " _164_444))
in ((_164_445), (t.FStar_Parser_AST.range)))
in FStar_Syntax_Syntax.Error (_164_446))
in (Prims.raise _164_447))
end))
...
in (match ((let _164_455 = (unparen top)
in _164_455.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Wild -> begin
...
| FStar_Parser_AST.Op ("*", (_66_1065)::(_66_1063)::[]) when (let _164_456 = (op_as_term env (Prims.parse_int "2") top.FStar_Parser_AST.range "*")
in (FStar_All.pipe_right _164_456 FStar_Option.isNone)) -> begin
(

let rec flatten = (fun t -> (match (t.FStar_Parser_AST.tm) with
| FStar_Parser_AST.Op ("*", (t1)::(t2)::[]) -> begin
(let _164_459 = (flatten t1)
in (FStar_List.append _164_459 ((t2)::[])))
end
| _66_1078 -> begin
(t)::[]
end))
...
let targs = (let _164_463 = (let _164_460 = (unparen top)
in (flatten _164_460))
in (FStar_All.pipe_right _164_463 (FStar_List.map (fun t -> (let _164_462 = (desugar_typ env t)
in (FStar_Syntax_Syntax.as_arg _164_462))))))
in (

let _66_1084 = (let _164_464 = (FStar_Syntax_Util.mk_tuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) _164_464))
...
| FStar_Parser_AST.Tvar (a) -> begin
(let _164_466 = (let _164_465 = (FStar_Parser_Env.fail_or2 (FStar_Parser_Env.try_lookup_id env) a)
in (Prims.fst _164_465))
in (FStar_All.pipe_left setpos _164_466))
end
| FStar_Parser_AST.Uvar (u) -> begin
...
let args = (FStar_All.pipe_right args (FStar_List.map (fun t -> (let _164_468 = (desugar_term env t)
in ((_164_468), (None))))))
...
(let _164_470 = (let _164_469 = (desugar_universe t)
in FStar_Syntax_Syntax.Tm_type (_164_469))
in (mk _164_470))
end
...
| Some (ed) -> begin
(let _164_471 = (FStar_Ident.lid_of_path (FStar_Ident.path_of_text (Prims.strcat (FStar_Ident.text_of_lid ed.FStar_Syntax_Syntax.mname) (Prims.strcat "_" txt))) FStar_Range.dummyRange)
in (FStar_Syntax_Syntax.fvar _164_471 (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) None))
end
| None -> begin
...
let found = ((let _164_472 = (FStar_Parser_Env.try_lookup_datacon env l)
in (FStar_Option.isSome _164_472)) || (let _164_473 = (FStar_Parser_Env.try_lookup_effect_defn env l)
in (FStar_Option.isSome _164_473)))
in if found then begin
(let _164_474 = (FStar_Syntax_Util.mk_field_projector_name_from_ident l i)
in (desugar_name mk setpos env _164_474))
end else begin
(let _164_477 = (let _164_476 = (let _164_475 = (FStar_Util.format1 "Data constructor or effect %s not found" l.FStar_Ident.str)
in ((_164_475), (top.FStar_Parser_AST.range)))
in FStar_Syntax_Syntax.Error (_164_476))
in (Prims.raise _164_477))
end)
end
| FStar_Parser_AST.Discrim (lid) -> begin
(match ((FStar_Parser_Env.try_lookup_datacon env lid)) with
| None -> begin
(let _164_480 = (let _164_479 = (let _164_478 = (FStar_Util.format1 "Data constructor %s not found" lid.FStar_Ident.str)
in ((_164_478), (top.FStar_Parser_AST.range)))
in FStar_Syntax_Syntax.Error (_164_479))
in (Prims.raise _164_480))
end
| _66_1189 -> begin
(
...
let _66_1199 = (let _164_481 = (mk (FStar_Syntax_Syntax.Tm_fvar (head)))
in ((_164_481), (true)))
...
| None -> begin
(let _164_485 = (FStar_Syntax_Syntax.new_bv (Some (top.FStar_Parser_AST.range)) FStar_Syntax_Syntax.tun)
in ((env), (_164_485)))
end
| Some (x) -> begin
...
| (env, x) -> begin
(let _164_489 = (let _164_488 = (let _164_487 = (let _164_486 = (no_annot_abs tparams t)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _164_486))
in (_164_487)::[])
in (FStar_List.append typs _164_488))
in ((env), ((FStar_List.append tparams (((((

let _66_1228 = x
in {FStar_Syntax_Syntax.ppname = _66_1228.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _66_1228.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (None)))::[]))), (_164_489)))
end))
end))
...
let _66_1238 = (let _164_490 = (FStar_Syntax_Util.mk_dtuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) _164_490))
...
in (let _164_497 = (FStar_Syntax_Util.arrow (FStar_List.rev bs) cod)
in (FStar_All.pipe_left setpos _164_497)))
end
| (hd)::tl -> begin
(
...
in (let _164_498 = (FStar_Syntax_Util.refine x f)
in (FStar_All.pipe_left setpos _164_498)))
end))
end)
end
...
(let _164_502 = (let _164_501 = (free_type_vars env t)
in (FStar_List.append _164_501 ftvs))
in ((env), (_164_502)))
end
| _66_1291 -> begin
((env), (ftvs))
...
let binders = (let _164_504 = (FStar_All.pipe_right ftv (FStar_List.map (fun a -> (FStar_Parser_AST.mk_pattern (FStar_Parser_AST.PatTvar (((a), (Some (FStar_Parser_AST.Implicit))))) top.FStar_Parser_AST.range))))
in (FStar_List.append _164_504 binders))
in (
...
let body = (let _164_514 = (let _164_513 = (FStar_Syntax_Syntax.pat_bvs pat)
in (FStar_All.pipe_right _164_513 (FStar_List.map FStar_Syntax_Syntax.mk_binder)))
in (FStar_Syntax_Subst.close _164_514 body))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (((sc), ((((pat), (None), (body)))::[])))) None body.FStar_Syntax_Syntax.pos))
end
| None -> begin
body
end)
in (let _164_515 = (no_annot_abs (FStar_List.rev bs) body)
in (setpos _164_515))))
end
| (p)::rest -> begin
(
...
| (Some (p), None) -> begin
(let _164_517 = (let _164_516 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_164_516), (p)))
in Some (_164_517))
end
...
let tup2 = (let _164_518 = (FStar_Syntax_Util.mk_tuple_data_lid (Prims.parse_int "2") top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.lid_as_fv _164_518 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))
in (

let sc = (let _164_526 = (let _164_525 = (let _164_524 = (mk (FStar_Syntax_Syntax.Tm_fvar (tup2)))
in (let _164_523 = (let _164_522 = (FStar_Syntax_Syntax.as_arg sc)
in (let _164_521 = (let _164_520 = (let _164_519 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _164_519))
in (_164_520)::[])
in (_164_522)::_164_521))
in ((_164_524), (_164_523))))
in FStar_Syntax_Syntax.Tm_app (_164_525))
in (FStar_Syntax_Syntax.mk _164_526 None top.FStar_Parser_AST.range))
in (

let p = (let _164_527 = (FStar_Range.union_ranges p'.FStar_Syntax_Syntax.p p.FStar_Syntax_Syntax.p)
in (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_cons (((tup2), ((((p'), (false)))::(((p), (false)))::[])))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n _164_527))
in Some (((sc), (p))))))
end
| (FStar_Syntax_Syntax.Tm_app (_66_1352, args), FStar_Syntax_Syntax.Pat_cons (_66_1357, pats)) -> begin
(

let tupn = (let _164_528 = (FStar_Syntax_Util.mk_tuple_data_lid ((Prims.parse_int "1") + (FStar_List.length args)) top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.lid_as_fv _164_528 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))
in (

let sc = (let _164_535 = (let _164_534 = (let _164_533 = (mk (FStar_Syntax_Syntax.Tm_fvar (tupn)))
in (let _164_532 = (let _164_531 = (let _164_530 = (let _164_529 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _164_529))
in (_164_530)::[])
in (FStar_List.append args _164_531))
in ((_164_533), (_164_532))))
in FStar_Syntax_Syntax.Tm_app (_164_534))
in (mk _164_535))
in (

let p = (let _164_536 = (FStar_Range.union_ranges p'.FStar_Syntax_Syntax.p p.FStar_Syntax_Syntax.p)
in (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_cons (((tupn), ((FStar_List.append pats ((((p), (false)))::[])))))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n _164_536))
in Some (((sc), (p))))))
end
| _66_1366 -> begin
(FStar_All.failwith "Impossible")
...
in (let _164_544 = (let _164_543 = (let _164_542 = (FStar_Syntax_Syntax.fvar a FStar_Syntax_Syntax.Delta_equational None)
in (let _164_541 = (let _164_540 = (FStar_Syntax_Syntax.as_arg phi)
in (let _164_539 = (let _164_538 = (let _164_537 = (mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)))
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _164_537))
in (_164_538)::[])
in (_164_540)::_164_539))
in ((_164_542), (_164_541))))
in FStar_Syntax_Syntax.Tm_app (_164_543))
in (mk _164_544))))
end
| FStar_Parser_AST.App (_66_1385, _66_1387, FStar_Parser_AST.UnivApp) -> begin
(

let rec aux = (fun universes e -> (match ((let _164_549 = (unparen e)
in _164_549.FStar_Parser_AST.tm)) with
...
let rec aux = (fun args e -> (match ((let _164_554 = (unparen e)
in _164_554.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App (e, t, imp) -> begin
(

let arg = (let _164_555 = (desugar_term env t)
in (FStar_All.pipe_left (arg_withimp_e imp) _164_555))
in (aux ((arg)::args) e))
end
| _66_1416 -> begin
(
...
(let _164_558 = (let _164_557 = (let _164_556 = (desugar_term env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((FStar_Parser_AST.NoLetQualifier), (((((FStar_Parser_AST.mk_pattern FStar_Parser_AST.PatWild t1.FStar_Parser_AST.range)), (t1)))::[]), (t2)))) top.FStar_Parser_AST.range FStar_Parser_AST.Expr))
in ((_164_556), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Sequence))))
in FStar_Syntax_Syntax.Tm_meta (_164_557))
in (mk _164_558))
end
...
(let _164_562 = (destruct_app_pattern env top_level p)
in ((_164_562), (def)))
end else begin
(match ((FStar_Parser_AST.un_function p def)) with
| Some (p, def) -> begin
(let _164_563 = (destruct_app_pattern env top_level p)
in ((_164_563), (def)))
end
| _66_1448 -> begin
(match (p.FStar_Parser_AST.pat) with
...
(let _164_566 = (let _164_565 = (let _164_564 = (FStar_Parser_Env.qualify env id)
in FStar_Util.Inr (_164_564))
in ((_164_565), ([]), (Some (t))))
in ((_164_566), (def)))
end else begin
...
if top_level then begin
(let _164_569 = (let _164_568 = (let _164_567 = (FStar_Parser_Env.qualify env id)
in FStar_Util.Inr (_164_567))
in ((_164_568), ([]), (None)))
in ((_164_569), (def)))
end else begin
...
| (env, xx) -> begin
(let _164_573 = (let _164_572 = (FStar_Syntax_Syntax.mk_binder xx)
in (_164_572)::rec_bindings)
in ((env), (FStar_Util.Inl (xx)), (_164_573)))
end))
end
| FStar_Util.Inr (l) -> begin
(let _164_574 = (FStar_Parser_Env.push_top_level_rec_binding env l.FStar_Ident.ident FStar_Syntax_Syntax.Delta_equational)
in ((_164_574), (FStar_Util.Inr (l)), (rec_bindings)))
end)
...
in (let _164_582 = (FStar_Range.union_ranges t.FStar_Parser_AST.range def.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term (FStar_Parser_AST.Ascribed (((def), (t)))) _164_582 FStar_Parser_AST.Expr)))
end)
in (
...
| FStar_Util.Inr (l) -> begin
(let _164_584 = (let _164_583 = (FStar_Syntax_Util.incr_delta_qualifier body)
in (FStar_Syntax_Syntax.lid_as_fv l _164_583 None))
in FStar_Util.Inr (_164_584))
end)
in (
...
let body = (desugar_term env' body)
in (let _164_587 = (let _164_586 = (let _164_585 = (FStar_Syntax_Subst.close rec_bindings body)
in ((((is_rec), (lbs))), (_164_585)))
in FStar_Syntax_Syntax.Tm_let (_164_586))
in (FStar_All.pipe_left mk _164_587))))))
end))))
end))
in (
...
let fv = (let _164_594 = (FStar_Syntax_Util.incr_delta_qualifier t1)
in (FStar_Syntax_Syntax.lid_as_fv l _164_594 None))
...
| Some (pat) -> begin
(let _164_599 = (let _164_598 = (let _164_597 = (FStar_Syntax_Syntax.bv_to_name x)
in (let _164_596 = (let _164_595 = (FStar_Syntax_Util.branch ((pat), (None), (body)))
in (_164_595)::[])
in ((_164_597), (_164_596))))
in FStar_Syntax_Syntax.Tm_match (_164_598))
in (FStar_Syntax_Syntax.mk _164_599 None body.FStar_Syntax_Syntax.pos))
end)
in (let _164_604 = (let _164_603 = (let _164_602 = (let _164_601 = (let _164_600 = (FStar_Syntax_Syntax.mk_binder x)
in (_164_600)::[])
in (FStar_Syntax_Subst.close _164_601 body))
in ((((false), (((mk_lb ((FStar_Util.Inl (x)), (x.FStar_Syntax_Syntax.sort), (t1))))::[]))), (_164_602)))
in FStar_Syntax_Syntax.Tm_let (_164_603))
in (FStar_All.pipe_left mk _164_604))))
end)
...
in (let _164_615 = (let _164_614 = (let _164_613 = (desugar_term env t1)
in (let _164_612 = (let _164_611 = (let _164_606 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Parser_AST.range)
in (let _164_605 = (desugar_term env t2)
in ((_164_606), (None), (_164_605))))
in (let _164_610 = (let _164_609 = (let _164_608 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_wild (x)) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t3.FStar_Parser_AST.range)
in (let _164_607 = (desugar_term env t3)
in ((_164_608), (None), (_164_607))))
in (_164_609)::[])
in (_164_611)::_164_610))
in ((_164_613), (_164_612))))
in FStar_Syntax_Syntax.Tm_match (_164_614))
in (mk _164_615)))
end
...
| Some (e) -> begin
(let _164_618 = (desugar_term env e)
in Some (_164_618))
end)
in (
...
in (let _164_622 = (let _164_621 = (let _164_620 = (desugar_term env e)
in (let _164_619 = (FStar_List.map desugar_branch branches)
in ((_164_620), (_164_619))))
in FStar_Syntax_Syntax.Tm_match (_164_621))
in (FStar_All.pipe_left mk _164_622)))
end
...
in (let _164_625 = (let _164_624 = (let _164_623 = (desugar_term env e)
in ((_164_623), (annot), (None)))
in FStar_Syntax_Syntax.Tm_ascribed (_164_624))
in (FStar_All.pipe_left mk _164_625)))))
end
...
(match (xopt) with
| None -> begin
(let _164_633 = (let _164_632 = (let _164_631 = (FStar_Util.format2 "Field %s of record type %s is missing" f.FStar_Ident.idText record.FStar_Parser_Env.typename.FStar_Ident.str)
in ((_164_631), (top.FStar_Parser_AST.range)))
in FStar_Syntax_Syntax.Error (_164_632))
in (Prims.raise _164_633))
end
| Some (x) -> begin
...
| None -> begin
(let _164_638 = (let _164_637 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _66_1645 -> (match (_66_1645) with
| (f, _66_1644) -> begin
(let _164_636 = (let _164_635 = (get_field None f)
in (FStar_All.pipe_left Prims.snd _164_635))
in ((_164_636), (FStar_Parser_AST.Nothing)))
end))))
in ((user_constrname), (_164_637)))
in FStar_Parser_AST.Construct (_164_638))
end
| Some (e) -> begin
(
...
let xterm = (let _164_640 = (let _164_639 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_164_639))
in (FStar_Parser_AST.mk_term _164_640 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
in (

let record = (let _164_643 = (let _164_642 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _66_1653 -> (match (_66_1653) with
| (f, _66_1652) -> begin
(get_field (Some (xterm)) f)
end))))
in ((None), (_164_642)))
in FStar_Parser_AST.Record (_164_643))
...
let e = (let _164_650 = (let _164_649 = (let _164_648 = (let _164_647 = (let _164_646 = (let _164_645 = (let _164_644 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map Prims.fst))
in ((record.FStar_Parser_Env.typename), (_164_644)))
in FStar_Syntax_Syntax.Record_ctor (_164_645))
in Some (_164_646))
in (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v e.FStar_Syntax_Syntax.pos) FStar_Syntax_Syntax.Delta_constant _164_647))
in ((_164_648), (args)))
in FStar_Syntax_Syntax.Tm_app (_164_649))
in (FStar_All.pipe_left mk _164_650))
...
in (let _164_655 = (let _164_654 = (let _164_653 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range projname (FStar_Ident.range_of_lid f)) FStar_Syntax_Syntax.Delta_equational qual)
in (let _164_652 = (let _164_651 = (FStar_Syntax_Syntax.as_arg e)
in (_164_651)::[])
in ((_164_653), (_164_652))))
in FStar_Syntax_Syntax.Tm_app (_164_654))
in (FStar_All.pipe_left mk _164_655)))))
end))
end
...
| (a, imp) -> begin
(let _164_659 = (desugar_term env a)
in (arg_withimp_e imp _164_659))
end)))))
...
| (t, _66_1743) -> begin
(match ((let _164_667 = (unparen t)
in _164_667.FStar_Parser_AST.tm)) with
...
| (t, _66_1753) -> begin
(match ((let _164_670 = (unparen t)
in _164_670.FStar_Parser_AST.tm)) with
...
| (t, _66_1764) -> begin
(match ((let _164_675 = (unparen t)
in _164_675.FStar_Parser_AST.tm)) with
...
(let _164_679 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_effect_name_and_attributes env) l)
in ((_164_679), (args)))
end
| FStar_Parser_AST.Name (l) when ((let _164_680 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.lid_equals _164_680 FStar_Syntax_Const.prims_lid)) && (l.FStar_Ident.ident.FStar_Ident.idText = "Tot")) -> begin
(((((FStar_Ident.set_lid_range FStar_Syntax_Const.effect_Tot_lid head.FStar_Parser_AST.range)), ([]))), (args))
end
| FStar_Parser_AST.Name (l) when ((let _164_681 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.lid_equals _164_681 FStar_Syntax_Const.prims_lid)) && (l.FStar_Ident.ident.FStar_Ident.idText = "GTot")) -> begin
...
| _66_1819 -> begin
(let _164_683 = (let _164_682 = (FStar_Parser_AST.term_to_string t)
in (FStar_Util.format1 "%s is not an effect" _164_682))
in (fail _164_683))
end)
end)))
in (
...
(let _164_685 = (let _164_684 = (FStar_Syntax_Print.lid_to_string eff)
in (FStar_Util.format1 "Not enough args to effect %s" _164_684))
in (fail _164_685))
end else begin
()
end
...
let _66_1829 = (let _164_687 = (FStar_List.hd args)
in (let _164_686 = (FStar_List.tl args)
in ((_164_687), (_164_686))))
...
let pattern = (let _164_690 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range FStar_Syntax_Const.pattern_lid pat.FStar_Syntax_Syntax.pos) FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.mk_Tm_uinst _164_690 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app nil ((((pattern), (Some (FStar_Syntax_Syntax.imp_tag))))::[]) None pat.FStar_Syntax_Syntax.pos)))
end
| _66_1885 -> begin
pat
end)
in (let _164_694 = (let _164_693 = (let _164_692 = (let _164_691 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((pat), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Meta_smt_pat))))) None pat.FStar_Syntax_Syntax.pos)
in ((_164_691), (aq)))
in (_164_692)::[])
in (ens)::_164_693)
in (req)::_164_694))
...
let desugar_pats = (fun env pats -> (FStar_List.map (fun es -> (FStar_All.pipe_right es (FStar_List.map (fun e -> (let _164_729 = (desugar_term env e)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _164_729)))))) pats))
in (match (tk) with
| (Some (a), k) -> begin
(
...
let body = (let _164_732 = (let _164_731 = (let _164_730 = (FStar_Syntax_Syntax.mk_binder a)
in (_164_730)::[])
in (no_annot_abs _164_731 body))
in (FStar_All.pipe_left setpos _164_732))
in (let _164_737 = (let _164_736 = (let _164_735 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range q b.FStar_Parser_AST.brange) (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) None)
in (let _164_734 = (let _164_733 = (FStar_Syntax_Syntax.as_arg body)
in (_164_733)::[])
in ((_164_735), (_164_734))))
in FStar_Syntax_Syntax.Tm_app (_164_736))
in (FStar_All.pipe_left mk _164_737)))))))
end))
end
| _66_1940 -> begin
(FStar_All.failwith "impossible")
...
let body = (let _164_752 = (q ((rest), (pats), (body)))
in (let _164_751 = (FStar_Range.union_ranges b'.FStar_Parser_AST.brange body.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term _164_752 _164_751 FStar_Parser_AST.Formula)))
in (let _164_753 = (q (((b)::[]), ([]), (body)))
in (FStar_Parser_AST.mk_term _164_753 f.FStar_Parser_AST.range FStar_Parser_AST.Formula))))
end
| _66_1954 -> begin
(FStar_All.failwith "impossible")
end))
in (match ((let _164_754 = (unparen f)
in _164_754.FStar_Parser_AST.tm)) with
...
in (let _164_756 = (push_quant (fun x -> FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env _164_756)))
end
| FStar_Parser_AST.QExists ((_1)::(_2)::_3, pats, body) -> begin
(

let binders = (_1)::(_2)::_3
in (let _164_758 = (push_quant (fun x -> FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env _164_758)))
end
...
(let _164_765 = (desugar_typ env t)
in ((Some (x)), (_164_765)))
end
| FStar_Parser_AST.TVariable (x) -> begin
(let _164_766 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_unknown)) None x.FStar_Ident.idRange)
in ((Some (x)), (_164_766)))
end
| FStar_Parser_AST.NoName (t) -> begin
(let _164_767 = (desugar_typ env t)
in ((None), (_164_767)))
end
...
let binders = (let _164_784 = (let _164_783 = (FStar_Syntax_Util.arrow_formals k)
in (Prims.fst _164_783))
in (FStar_List.append tps _164_784))
in (
...
let binders = (let _164_790 = (let _164_789 = (let _164_788 = (let _164_787 = (let _164_786 = (FStar_Syntax_Syntax.lid_as_fv t FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _164_786))
in (FStar_Syntax_Syntax.mk_Tm_app _164_787 args None p))
in (FStar_All.pipe_left FStar_Syntax_Syntax.null_binder _164_788))
in (_164_789)::[])
in (FStar_List.append imp_binders _164_790))
in (

let disc_type = (let _164_793 = (let _164_792 = (let _164_791 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.bool_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _164_791))
in (FStar_Syntax_Syntax.mk_Total _164_792))
in (FStar_Syntax_Util.arrow binders _164_793))
in (FStar_All.pipe_right datas (FStar_List.map (fun d -> (

let disc_name = (FStar_Syntax_Util.mk_discriminator d)
in (let _164_796 = (let _164_795 = (quals ((FStar_Syntax_Syntax.Logic)::(FStar_Syntax_Syntax.Discriminator (d))::[]))
in ((disc_name), ([]), (disc_type), (_164_795), ((FStar_Ident.range_of_lid disc_name))))
in FStar_Syntax_Syntax.Sig_declare_typ (_164_796)))))))))
end)))))))
...
let indices = (FStar_All.pipe_right args (FStar_List.map (fun _66_2188 -> (let _164_828 = (FStar_Syntax_Syntax.new_bv (Some (p)) FStar_Syntax_Syntax.tun)
in (FStar_All.pipe_right _164_828 FStar_Syntax_Syntax.mk_binder)))))
in (

let arg_typ = (let _164_833 = (let _164_829 = (FStar_Syntax_Syntax.lid_as_fv tc FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _164_829))
in (let _164_832 = (FStar_All.pipe_right (FStar_List.append tps indices) (FStar_List.map (fun _66_2193 -> (match (_66_2193) with
| (x, imp) -> begin
(let _164_831 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_164_831), (imp)))
end))))
in (FStar_Syntax_Syntax.mk_Tm_app _164_833 _164_832 None p)))
in (

let arg_binder = if (not (refine_domain)) then begin
(let _164_834 = (projectee arg_typ)
in (FStar_Syntax_Syntax.mk_binder _164_834))
end else begin
(
...
in (let _164_841 = (let _164_840 = (let _164_839 = (let _164_838 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range disc_name p) FStar_Syntax_Syntax.Delta_equational None)
in (let _164_837 = (let _164_836 = (let _164_835 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _164_835))
in (_164_836)::[])
in (FStar_Syntax_Syntax.mk_Tm_app _164_838 _164_837 None p)))
in (FStar_Syntax_Util.b2t _164_839))
in (FStar_Syntax_Util.refine x _164_840))
in {FStar_Syntax_Syntax.ppname = _66_2197.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _66_2197.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _164_841}))
in (FStar_Syntax_Syntax.mk_binder _164_842))))
end
...
let imp_binders = (let _164_844 = (FStar_All.pipe_right indices (FStar_List.map (fun _66_2207 -> (match (_66_2207) with
| (x, _66_2206) -> begin
((x), (Some (FStar_Syntax_Syntax.imp_tag)))
end))))
in (FStar_List.append imp_tps _164_844))
in (
...
let proj = (let _164_848 = (let _164_847 = (FStar_Syntax_Syntax.lid_as_fv field_name FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Syntax_Syntax.fv_to_tm _164_847))
in (FStar_Syntax_Syntax.mk_Tm_app _164_848 ((arg)::[]) None p))
...
in (let _164_887 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i _66_2228 -> (match (_66_2228) with
| (x, _66_2227) -> begin
(
...
let t = (let _164_852 = (let _164_851 = (FStar_Syntax_Subst.subst subst x.FStar_Syntax_Syntax.sort)
in (FStar_Syntax_Syntax.mk_Total _164_851))
in (FStar_Syntax_Util.arrow binders _164_852))
in (

let only_decl = (((let _164_853 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Syntax_Const.prims_lid _164_853)) || (fvq <> FStar_Syntax_Syntax.Data_ctor)) || (let _164_855 = (let _164_854 = (FStar_Parser_Env.current_module env)
in _164_854.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors _164_855)))
in (
...
(let _164_859 = (FStar_List.filter (fun _66_15 -> (match (_66_15) with
...
in (FStar_Syntax_Syntax.Assumption)::_164_859)
end else begin
q
end)
in (
...
(let _164_863 = (pos (FStar_Syntax_Syntax.Pat_var (projection)))
in ((_164_863), (b)))
end else begin
if (b && (j < ntps)) then begin
(let _164_867 = (let _164_866 = (let _164_865 = (let _164_864 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in ((_164_864), (FStar_Syntax_Syntax.tun)))
in FStar_Syntax_Syntax.Pat_dot_term (_164_865))
in (pos _164_866))
in ((_164_867), (b)))
end else begin
(let _164_870 = (let _164_869 = (let _164_868 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in FStar_Syntax_Syntax.Pat_wild (_164_868))
in (pos _164_869))
in ((_164_870), (b)))
end
end)
...
let pat = (let _164_875 = (let _164_873 = (let _164_872 = (let _164_871 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant (Some (fvq)))
in ((_164_871), (arg_pats)))
in FStar_Syntax_Syntax.Pat_cons (_164_872))
in (FStar_All.pipe_right _164_873 pos))
in (let _164_874 = (FStar_Syntax_Syntax.bv_to_name projection)
in ((_164_875), (None), (_164_874))))
in (

let body = (let _164_879 = (let _164_878 = (let _164_877 = (let _164_876 = (FStar_Syntax_Util.branch pat)
in (_164_876)::[])
in ((arg_exp), (_164_877)))
in FStar_Syntax_Syntax.Tm_match (_164_878))
in (FStar_Syntax_Syntax.mk _164_879 None p))
in (
...
let lb = (let _164_881 = (let _164_880 = (FStar_Syntax_Syntax.lid_as_fv field_name dd None)
in FStar_Util.Inr (_164_880))
in {FStar_Syntax_Syntax.lbname = _164_881; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = FStar_Syntax_Syntax.tun; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = imp})
in (

let impl = (let _164_886 = (let _164_885 = (let _164_884 = (let _164_883 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right _164_883 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (_164_884)::[])
in ((((false), ((lb)::[]))), (p), (_164_885), (quals)))
in FStar_Syntax_Syntax.Sig_let (_164_886))
...
in (FStar_All.pipe_right _164_887 FStar_List.flatten)))))))))
end)))))))
...
let dd = if (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract)) then begin
(let _164_912 = (FStar_Syntax_Util.incr_delta_qualifier t)
in FStar_Syntax_Syntax.Delta_abstract (_164_912))
end else begin
(FStar_Syntax_Util.incr_delta_qualifier t)
end
in (

let lb = (let _164_917 = (let _164_913 = (FStar_Syntax_Syntax.lid_as_fv lid dd None)
in FStar_Util.Inr (_164_913))
in (let _164_916 = (let _164_914 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_Syntax_Util.arrow typars _164_914))
in (let _164_915 = (no_annot_abs typars t)
in {FStar_Syntax_Syntax.lbname = _164_917; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = _164_916; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = _164_915})))
...
(let _164_931 = (let _164_930 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_164_930))
in (FStar_Parser_AST.mk_term _164_931 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
...
in (FStar_List.fold_left (fun out b -> (let _164_944 = (let _164_943 = (let _164_942 = (binder_to_term b)
in ((out), (_164_942), ((imp_of_aqual b))))
in FStar_Parser_AST.App (_164_943))
in (FStar_Parser_AST.mk_term _164_944 out.FStar_Parser_AST.range out.FStar_Parser_AST.level))) t binders)))
in (
...
let result = (let _164_950 = (let _164_949 = (let _164_948 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_164_948))
in (FStar_Parser_AST.mk_term _164_949 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _164_950 parms))
in (

let constrTyp = (FStar_Parser_AST.mk_term (FStar_Parser_AST.Product (((mfields), ((with_constructor_effect result))))) id.FStar_Ident.idRange FStar_Parser_AST.Type)
in (let _164_952 = (FStar_All.pipe_right fields (FStar_List.map (fun _66_2415 -> (match (_66_2415) with
| (x, _66_2412, _66_2414) -> begin
(FStar_Syntax_Util.unmangle_field_name x)
end))))
in ((FStar_Parser_AST.TyconVariant (((id), (parms), (kopt), ((((constrName), (Some (constrTyp)), (None), (false)))::[])))), (_164_952)))))))
end
| _66_2417 -> begin
(FStar_All.failwith "impossible")
end))
...
let tconstr = (let _164_963 = (let _164_962 = (let _164_961 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_164_961))
in (FStar_Parser_AST.mk_term _164_962 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _164_963 binders))
in (
...
| None -> begin
(let _164_970 = (tm_type_z id.FStar_Ident.idRange)
in Some (_164_970))
end
| _66_2468 -> begin
kopt
...
let _66_2490 = (let _164_972 = (FStar_Range.string_of_range rng)
in (let _164_971 = (FStar_Syntax_Print.lid_to_string l)
...
| _66_2495 -> begin
(let _164_975 = (let _164_974 = (let _164_973 = (FStar_Syntax_Syntax.mk_Total k)
in ((typars), (_164_973)))
in FStar_Syntax_Syntax.Tm_arrow (_164_974))
in (FStar_Syntax_Syntax.mk _164_975 None rng))
end)
...
let _66_2548 = (match ((let _164_978 = (unparen t)
in _164_978.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Construct (head, args) -> begin
(

let _66_2543 = (match ((FStar_List.rev args)) with
| ((last_arg, _66_2532))::args_rev -> begin
(match ((let _164_979 = (unparen last_arg)
in _164_979.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Attributes (ts) -> begin
...
(let _164_980 = (desugar_attributes env cattributes)
in (((FStar_Parser_AST.mk_term (FStar_Parser_AST.Construct (((head), (args)))) t.FStar_Parser_AST.range t.FStar_Parser_AST.level)), (_164_980)))
end))
end
| _66_2545 -> begin
((t), ([]))
...
in (let _164_984 = (let _164_983 = (FStar_Parser_Env.qualify env id)
in (let _164_982 = (FStar_All.pipe_right quals (FStar_List.filter (fun _66_24 -> (match (_66_24) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| _66_2555 -> begin
...
in ((_164_983), ([]), (typars), (c), (_164_982), ((FStar_List.append cattributes (FStar_Syntax_Util.comp_flags c))), (rng))))
in FStar_Syntax_Syntax.Sig_effect_abbrev (_164_984)))))
end))
end else begin
(
...
| (t, fs) -> begin
(let _164_989 = (let _164_988 = (let _164_987 = (let _164_986 = (let _164_985 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.ids_of_lid _164_985))
in ((_164_986), (fs)))
in FStar_Syntax_Syntax.RecordType (_164_987))
in (_164_988)::quals)
in (desugar_tycon env rng _164_989 ((t)::[])))
end)))
end
...
| (t, fs) -> begin
(let _164_1001 = (let _164_1000 = (let _164_999 = (let _164_998 = (let _164_997 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.ids_of_lid _164_997))
in ((_164_998), (fs)))
in FStar_Syntax_Syntax.RecordType (_164_999))
in (_164_1000)::quals)
in (collect_tcs _164_1001 ((env), (tcs)) t))
end)))
end
...
in (let _164_1004 = (let _164_1003 = (mk_typ_abbrev id uvs tpars k t ((id)::[]) quals rng)
in (([]), (_164_1003)))
in (_164_1004)::[]))
end))
end
...
let _66_2694 = (let _164_1016 = (FStar_All.pipe_right constrs (FStar_List.map (fun _66_2675 -> (match (_66_2675) with
...
let t = (let _164_1008 = (FStar_Parser_Env.default_total env_tps)
in (let _164_1007 = (close env_tps t)
in (desugar_term _164_1008 _164_1007)))
in (
...
in (let _164_1015 = (let _164_1014 = (let _164_1013 = (let _164_1012 = (let _164_1011 = (let _164_1010 = (FStar_All.pipe_right t FStar_Syntax_Util.name_function_binders)
in (FStar_Syntax_Syntax.mk_Total _164_1010))
in (FStar_Syntax_Util.arrow data_tpars _164_1011))
in ((name), (univs), (_164_1012), (tname), (ntps), (quals), (mutuals), (rng)))
in FStar_Syntax_Syntax.Sig_datacon (_164_1013))
in ((tps), (_164_1014)))
in ((name), (_164_1015))))))))
end))))
in (FStar_All.pipe_left FStar_List.split _164_1016))
...
let bundle = (let _164_1018 = (let _164_1017 = (FStar_List.collect FStar_Syntax_Util.lids_of_sigelt sigelts)
in ((sigelts), (quals), (_164_1017), (rng)))
in FStar_Syntax_Syntax.Sig_bundle (_164_1018))
in (
...
| (env, a) -> begin
(let _164_1027 = (let _164_1026 = (FStar_Syntax_Syntax.mk_binder (
...
let eff_k = (let _164_1065 = (FStar_Parser_Env.default_total env)
in (desugar_term _164_1065 eff_kind))
in (
...
| (env, ses) -> begin
(let _164_1069 = (let _164_1068 = (FStar_List.hd ses)
in (_164_1068)::out)
in ((env), (_164_1069)))
end))
end)) ((env), ([]))))
...
(let _164_1075 = (FStar_Parser_Env.qualify env name)
in (let _164_1074 = (let _164_1071 = (desugar_term env def)
in (FStar_Syntax_Subst.close binders _164_1071))
in (let _164_1073 = (let _164_1072 = (desugar_typ env cps_type)
in (FStar_Syntax_Subst.close binders _164_1072))
in {FStar_Syntax_Syntax.action_name = _164_1075; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_defn = _164_1074; FStar_Syntax_Syntax.action_typ = _164_1073})))
end
| FStar_Parser_AST.Tycon (_66_2804, ((FStar_Parser_AST.TyconAbbrev (name, _66_2807, _66_2809, defn), _66_2814))::[]) when for_free -> begin
(let _164_1078 = (FStar_Parser_Env.qualify env name)
in (let _164_1077 = (let _164_1076 = (desugar_term env defn)
in (FStar_Syntax_Subst.close binders _164_1076))
in {FStar_Syntax_Syntax.action_name = _164_1078; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_defn = _164_1077; FStar_Syntax_Syntax.action_typ = FStar_Syntax_Syntax.tun}))
end
| _66_2820 -> begin
...
in (let _164_1082 = (let _164_1081 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_definition env) l)
in (FStar_All.pipe_left (FStar_Syntax_Subst.close binders) _164_1081))
in (([]), (_164_1082)))))
in (
...
in (let _164_1105 = (let _164_1104 = (let _164_1103 = (lookup "return_wp")
in (let _164_1102 = (lookup "bind_wp")
in (let _164_1101 = (lookup "if_then_else")
in (let _164_1100 = (lookup "ite_wp")
in (let _164_1099 = (lookup "stronger")
in (let _164_1098 = (lookup "close_wp")
in (let _164_1097 = (lookup "assert_p")
in (let _164_1096 = (lookup "assume_p")
in (let _164_1095 = (lookup "null_wp")
in (let _164_1094 = (lookup "trivial")
in (let _164_1093 = if rr then begin
(let _164_1090 = (lookup "repr")
in (FStar_All.pipe_left Prims.snd _164_1090))
end else begin
FStar_Syntax_Syntax.tun
end
in (let _164_1092 = if rr then begin
(lookup "return")
end else begin
un_ts
end
in (let _164_1091 = if rr then begin
(lookup "bind")
end else begin
un_ts
end
in {FStar_Syntax_Syntax.qualifiers = qualifiers; FStar_Syntax_Syntax.cattributes = []; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = eff_k; FStar_Syntax_Syntax.ret_wp = _164_1103; FStar_Syntax_Syntax.bind_wp = _164_1102; FStar_Syntax_Syntax.if_then_else = _164_1101; FStar_Syntax_Syntax.ite_wp = _164_1100; FStar_Syntax_Syntax.stronger = _164_1099; FStar_Syntax_Syntax.close_wp = _164_1098; FStar_Syntax_Syntax.assert_p = _164_1097; FStar_Syntax_Syntax.assume_p = _164_1096; FStar_Syntax_Syntax.null_wp = _164_1095; FStar_Syntax_Syntax.trivial = _164_1094; FStar_Syntax_Syntax.repr = _164_1093; FStar_Syntax_Syntax.return_repr = _164_1092; FStar_Syntax_Syntax.bind_repr = _164_1091; FStar_Syntax_Syntax.actions = actions})))))))))))))
in ((_164_1104), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Sig_new_effect (_164_1105))))
end
in (
...
let env = (FStar_All.pipe_right actions (FStar_List.fold_left (fun env a -> (let _164_1108 = (FStar_Syntax_Util.action_as_lb a)
in (FStar_Parser_Env.push_sigelt env _164_1108))) env))
in (
...
| _66_2858 -> begin
(let _164_1135 = (let _164_1134 = (let _164_1133 = (let _164_1132 = (let _164_1131 = (FStar_Parser_AST.term_to_string head)
in (Prims.strcat _164_1131 " not found"))
in (Prims.strcat "Effect " _164_1132))
in ((_164_1133), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_164_1134))
in (Prims.raise _164_1135))
end)
in (

let _66_2874 = (match ((FStar_List.rev args)) with
| ((last_arg, _66_2863))::args_rev -> begin
(match ((let _164_1136 = (unparen last_arg)
in _164_1136.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Attributes (ts) -> begin
((ts), ((FStar_List.rev args_rev)))
end
| _66_2869 -> begin
...
| (cattributes, args) -> begin
(let _164_1138 = (desugar_args env args)
in (let _164_1137 = (desugar_attributes env cattributes)
in ((ed), (_164_1138), (_164_1137))))
end)))
end))
...
in (let _164_1142 = (let _164_1141 = (FStar_Syntax_Subst.subst s x)
in (FStar_Syntax_Subst.close binders _164_1141))
in (([]), (_164_1142)))))
end))
end))
in (
...
let ed = (let _164_1167 = (let _164_1143 = (trans_qual (Some (mname)))
in (FStar_List.map _164_1143 quals))
in (let _164_1166 = (let _164_1144 = (sub (([]), (ed.FStar_Syntax_Syntax.signature)))
in (Prims.snd _164_1144))
in (let _164_1165 = (sub ed.FStar_Syntax_Syntax.ret_wp)
in (let _164_1164 = (sub ed.FStar_Syntax_Syntax.bind_wp)
in (let _164_1163 = (sub ed.FStar_Syntax_Syntax.if_then_else)
in (let _164_1162 = (sub ed.FStar_Syntax_Syntax.ite_wp)
in (let _164_1161 = (sub ed.FStar_Syntax_Syntax.stronger)
in (let _164_1160 = (sub ed.FStar_Syntax_Syntax.close_wp)
in (let _164_1159 = (sub ed.FStar_Syntax_Syntax.assert_p)
in (let _164_1158 = (sub ed.FStar_Syntax_Syntax.assume_p)
in (let _164_1157 = (sub ed.FStar_Syntax_Syntax.null_wp)
in (let _164_1156 = (sub ed.FStar_Syntax_Syntax.trivial)
in (let _164_1155 = (let _164_1145 = (sub (([]), (ed.FStar_Syntax_Syntax.repr)))
in (Prims.snd _164_1145))
in (let _164_1154 = (sub ed.FStar_Syntax_Syntax.return_repr)
in (let _164_1153 = (sub ed.FStar_Syntax_Syntax.bind_repr)
in (let _164_1152 = (FStar_List.map (fun action -> (let _164_1151 = (FStar_Parser_Env.qualify env action.FStar_Syntax_Syntax.action_unqualified_name)
in (let _164_1150 = (let _164_1147 = (sub (([]), (action.FStar_Syntax_Syntax.action_defn)))
in (Prims.snd _164_1147))
in (let _164_1149 = (let _164_1148 = (sub (([]), (action.FStar_Syntax_Syntax.action_typ)))
in (Prims.snd _164_1148))
in {FStar_Syntax_Syntax.action_name = _164_1151; FStar_Syntax_Syntax.action_unqualified_name = action.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = action.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_defn = _164_1150; FStar_Syntax_Syntax.action_typ = _164_1149})))) ed.FStar_Syntax_Syntax.actions)
in {FStar_Syntax_Syntax.qualifiers = _164_1167; FStar_Syntax_Syntax.cattributes = cattributes; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = _164_1166; FStar_Syntax_Syntax.ret_wp = _164_1165; FStar_Syntax_Syntax.bind_wp = _164_1164; FStar_Syntax_Syntax.if_then_else = _164_1163; FStar_Syntax_Syntax.ite_wp = _164_1162; FStar_Syntax_Syntax.stronger = _164_1161; FStar_Syntax_Syntax.close_wp = _164_1160; FStar_Syntax_Syntax.assert_p = _164_1159; FStar_Syntax_Syntax.assume_p = _164_1158; FStar_Syntax_Syntax.null_wp = _164_1157; FStar_Syntax_Syntax.trivial = _164_1156; FStar_Syntax_Syntax.repr = _164_1155; FStar_Syntax_Syntax.return_repr = _164_1154; FStar_Syntax_Syntax.bind_repr = _164_1153; FStar_Syntax_Syntax.actions = _164_1152}))))))))))))))))
in (
...
let env = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.actions (FStar_List.fold_left (fun env a -> (let _164_1170 = (FStar_Syntax_Util.action_as_lb a)
in (FStar_Parser_Env.push_sigelt env _164_1170))) env))
in (
...
(let _164_1175 = (FStar_Parser_Env.push_module_abbrev env x l)
in ((_164_1175), ([])))
end
...
in (let _164_1177 = (FStar_List.map (trans_qual None) qual)
in (desugar_tycon env d.FStar_Parser_AST.drange _164_1177 tcs)))
end
| FStar_Parser_AST.TopLevelLet (quals, isrec, lets) -> begin
(match ((let _164_1179 = (let _164_1178 = (desugar_term_maybe_top true env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((isrec), (lets), ((FStar_Parser_AST.mk_term (FStar_Parser_AST.Const (FStar_Const.Const_unit)) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))))) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))
in (FStar_All.pipe_left FStar_Syntax_Subst.compress _164_1178))
in _164_1179.FStar_Syntax_Syntax.n)) with
...
(let _164_1184 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (
...
in (((Prims.fst lbs)), (_164_1184)))
end else begin
lbs
end
in (

let s = (let _164_1187 = (let _164_1186 = (FStar_All.pipe_right fvs (FStar_List.map (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in ((lbs), (d.FStar_Parser_AST.drange), (_164_1186), (quals)))
in FStar_Syntax_Syntax.Sig_let (_164_1187))
in (
...
in (let _164_1191 = (let _164_1190 = (let _164_1189 = (let _164_1188 = (FStar_Parser_Env.qualify env id)
in ((_164_1188), (f), ((FStar_Syntax_Syntax.Assumption)::[]), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Sig_assume (_164_1189))
in (_164_1190)::[])
in ((env), (_164_1191))))
end
...
let t = (let _164_1192 = (close_fun env t)
in (desugar_term env _164_1192))
in (
...
let se = (let _164_1195 = (let _164_1194 = (FStar_Parser_Env.qualify env id)
in (let _164_1193 = (FStar_List.map (trans_qual None) quals)
in ((_164_1194), ([]), (t), (_164_1193), (d.FStar_Parser_AST.drange))))
in FStar_Syntax_Syntax.Sig_declare_typ (_164_1195))
in (
...
let t = (let _164_1200 = (let _164_1196 = (FStar_Syntax_Syntax.null_binder t)
in (_164_1196)::[])
in (let _164_1199 = (let _164_1198 = (let _164_1197 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) FStar_Syntax_Const.exn_lid)
in (Prims.fst _164_1197))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total _164_1198))
in (FStar_Syntax_Util.arrow _164_1200 _164_1199)))
in (
...
| None -> begin
(let _164_1211 = (let _164_1210 = (let _164_1209 = (let _164_1208 = (let _164_1207 = (FStar_Syntax_Print.lid_to_string l)
in (Prims.strcat _164_1207 " not found"))
in (Prims.strcat "Effect name " _164_1208))
in ((_164_1209), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_164_1210))
in (Prims.raise _164_1211))
end
| Some (l) -> begin
l
end))
...
(let _164_1214 = (let _164_1213 = (let _164_1212 = (desugar_term env t)
in (([]), (_164_1212)))
in Some (_164_1213))
in ((_164_1214), (None)))
end
| FStar_Parser_AST.ReifiableLift (wp, t) -> begin
(let _164_1220 = (let _164_1216 = (let _164_1215 = (desugar_term env wp)
in (([]), (_164_1215)))
in Some (_164_1216))
in (let _164_1219 = (let _164_1218 = (let _164_1217 = (desugar_term env t)
in (([]), (_164_1217)))
in Some (_164_1218))
in ((_164_1220), (_164_1219))))
end
| FStar_Parser_AST.LiftForFree (t) -> begin
(let _164_1223 = (let _164_1222 = (let _164_1221 = (desugar_term env t)
in (([]), (_164_1221)))
in Some (_164_1222))
in ((None), (_164_1223)))
end)
...
(let _164_1241 = (FStar_Parser_Env.prepare_module_or_interface true admitted env mname)
in ((_164_1241), (mname), (decls), (true)))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(let _164_1242 = (FStar_Parser_Env.prepare_module_or_interface false false env mname)
in ((_164_1242), (mname), (decls), (false)))
end)
...
(let _164_1253 = (FStar_Syntax_Print.modul_to_string modul)
in (FStar_Util.print1 "%s\n" _164_1253))
end else begin
()
end
in (let _164_1254 = if pop_when_done then begin
