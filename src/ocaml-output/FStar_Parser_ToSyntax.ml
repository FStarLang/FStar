...
(let _166_226 = (let _166_225 = (FStar_List.map (fun _66_9 -> (match (_66_9) with
...
let _66_600 = (let _166_248 = (FStar_List.tl fields)
...
in Some (_166_371))
in {FStar_Syntax_Syntax.fv_name = _66_872.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = _66_872.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = _166_372}))
in ((_166_373), (args)))
...
let _66_885 = (let _166_376 = (check_linear_pattern_variables p)
...
| FStar_Parser_AST.Op ("*", (_66_1032)::(_66_1030)::[]) when (let _166_443 = (op_as_term env (Prims.parse_int "2") top.FStar_Parser_AST.range "*")
...
let _66_1051 = (let _166_451 = (FStar_Syntax_Util.mk_tuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
...
let _66_1166 = (let _166_468 = (mk (FStar_Syntax_Syntax.Tm_fvar (head)))
in ((_166_468), (true)))
...
let _66_1195 = x
in {FStar_Syntax_Syntax.ppname = _66_1195.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _66_1195.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (None)))::[]))), (_166_476)))
end))
end))
...
let _66_1205 = (let _166_477 = (FStar_Syntax_Util.mk_dtuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
...
| None -> begin
(let _166_625 = (let _166_624 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _66_1612 -> (match (_66_1612) with
| (f, _66_1611) -> begin
...
let record = (let _166_630 = (let _166_629 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _66_1620 -> (match (_66_1620) with
| (f, _66_1619) -> begin
...
let _66_1796 = (let _166_674 = (FStar_List.hd args)
...
in (let _166_794 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i _66_2044 -> (match (_66_2044) with
| (x, _66_2043) -> begin
(
...
(let _166_785 = (FStar_List.filter (fun _66_14 -> (match (_66_14) with
...
in (let _166_856 = (FStar_All.pipe_right fields (FStar_List.map (fun _66_2213 -> (match (_66_2213) with
...
let _66_2288 = (let _166_876 = (FStar_Range.string_of_range rng)
...
let _66_2346 = (match ((let _166_882 = (unparen t)
...
in (let _166_886 = (FStar_All.pipe_right quals (FStar_List.filter (fun _66_22 -> (match (_66_22) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| _66_2353 -> begin
...
let _66_2492 = (let _166_920 = (FStar_All.pipe_right constrs (FStar_List.map (fun _66_2473 -> (match (_66_2473) with
...
let bundle = (let _166_922 = (let _166_921 = (FStar_List.collect FStar_Syntax_Util.lids_of_sigelt sigelts)
in ((sigelts), (quals), (_166_921), (rng)))
in FStar_Syntax_Syntax.Sig_bundle (_166_922))
in (
...
| (env, a) -> begin
(let _166_931 = (let _166_930 = (FStar_Syntax_Syntax.mk_binder (
...
let eff_k = (let _166_969 = (FStar_Parser_Env.default_total env)
in (desugar_term _166_969 eff_kind))
in (
...
| (env, ses) -> begin
(let _166_973 = (let _166_972 = (FStar_List.hd ses)
in (_166_972)::out)
in ((env), (_166_973)))
end))
end)) ((env), ([]))))
...
(let _166_979 = (FStar_Parser_Env.qualify env name)
in (let _166_978 = (let _166_975 = (desugar_term env def)
in (FStar_Syntax_Subst.close binders _166_975))
in (let _166_977 = (let _166_976 = (desugar_typ env cps_type)
in (FStar_Syntax_Subst.close binders _166_976))
in {FStar_Syntax_Syntax.action_name = _166_979; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_defn = _166_978; FStar_Syntax_Syntax.action_typ = _166_977})))
end
| FStar_Parser_AST.Tycon (_66_2602, ((FStar_Parser_AST.TyconAbbrev (name, _66_2605, _66_2607, defn), _66_2612))::[]) when for_free -> begin
(let _166_982 = (FStar_Parser_Env.qualify env name)
in (let _166_981 = (let _166_980 = (desugar_term env defn)
in (FStar_Syntax_Subst.close binders _166_980))
in {FStar_Syntax_Syntax.action_name = _166_982; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_defn = _166_981; FStar_Syntax_Syntax.action_typ = FStar_Syntax_Syntax.tun}))
end
| _66_2618 -> begin
...
in (let _166_986 = (let _166_985 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_definition env) l)
in (FStar_All.pipe_left (FStar_Syntax_Subst.close binders) _166_985))
in (([]), (_166_986)))))
in (
...
in (let _166_1009 = (let _166_1008 = (let _166_1007 = (lookup "return_wp")
in (let _166_1006 = (lookup "bind_wp")
in (let _166_1005 = (lookup "if_then_else")
in (let _166_1004 = (lookup "ite_wp")
in (let _166_1003 = (lookup "stronger")
in (let _166_1002 = (lookup "close_wp")
in (let _166_1001 = (lookup "assert_p")
in (let _166_1000 = (lookup "assume_p")
in (let _166_999 = (lookup "null_wp")
in (let _166_998 = (lookup "trivial")
in (let _166_997 = if rr then begin
(let _166_994 = (lookup "repr")
in (FStar_All.pipe_left Prims.snd _166_994))
end else begin
FStar_Syntax_Syntax.tun
end
...
in {FStar_Syntax_Syntax.qualifiers = qualifiers; FStar_Syntax_Syntax.cattributes = []; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = eff_k; FStar_Syntax_Syntax.ret_wp = _166_1007; FStar_Syntax_Syntax.bind_wp = _166_1006; FStar_Syntax_Syntax.if_then_else = _166_1005; FStar_Syntax_Syntax.ite_wp = _166_1004; FStar_Syntax_Syntax.stronger = _166_1003; FStar_Syntax_Syntax.close_wp = _166_1002; FStar_Syntax_Syntax.assert_p = _166_1001; FStar_Syntax_Syntax.assume_p = _166_1000; FStar_Syntax_Syntax.null_wp = _166_999; FStar_Syntax_Syntax.trivial = _166_998; FStar_Syntax_Syntax.repr = _166_997; FStar_Syntax_Syntax.return_repr = _166_996; FStar_Syntax_Syntax.bind_repr = _166_995; FStar_Syntax_Syntax.actions = actions})))))))))))))
in ((_166_1008), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Sig_new_effect (_166_1009))))
end
in (
...
let env = (FStar_All.pipe_right actions (FStar_List.fold_left (fun env a -> (let _166_1012 = (FStar_Syntax_Util.action_as_lb mname a)
in (FStar_Parser_Env.push_sigelt env _166_1012))) env))
in (
...
| _66_2656 -> begin
(let _166_1039 = (let _166_1038 = (let _166_1037 = (let _166_1036 = (let _166_1035 = (FStar_Parser_AST.term_to_string head)
in (Prims.strcat _166_1035 " not found"))
in (Prims.strcat "Effect " _166_1036))
in ((_166_1037), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_166_1038))
in (Prims.raise _166_1039))
end)
in (

let _66_2672 = (match ((FStar_List.rev args)) with
| ((last_arg, _66_2661))::args_rev -> begin
(match ((let _166_1040 = (unparen last_arg)
in _166_1040.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Attributes (ts) -> begin
((ts), ((FStar_List.rev args_rev)))
end
| _66_2667 -> begin
...
| (cattributes, args) -> begin
(let _166_1042 = (desugar_args env args)
in (let _166_1041 = (desugar_attributes env cattributes)
in ((ed), (_166_1042), (_166_1041))))
end)))
end))
...
in (let _166_1046 = (let _166_1045 = (FStar_Syntax_Subst.subst s x)
in (FStar_Syntax_Subst.close binders _166_1045))
in (([]), (_166_1046)))))
end))
end))
in (
...
let ed = (let _166_1071 = (let _166_1047 = (trans_qual (Some (mname)))
in (FStar_List.map _166_1047 quals))
in (let _166_1070 = (let _166_1048 = (sub (([]), (ed.FStar_Syntax_Syntax.signature)))
in (Prims.snd _166_1048))
in (let _166_1069 = (sub ed.FStar_Syntax_Syntax.ret_wp)
in (let _166_1068 = (sub ed.FStar_Syntax_Syntax.bind_wp)
in (let _166_1067 = (sub ed.FStar_Syntax_Syntax.if_then_else)
in (let _166_1066 = (sub ed.FStar_Syntax_Syntax.ite_wp)
in (let _166_1065 = (sub ed.FStar_Syntax_Syntax.stronger)
in (let _166_1064 = (sub ed.FStar_Syntax_Syntax.close_wp)
in (let _166_1063 = (sub ed.FStar_Syntax_Syntax.assert_p)
in (let _166_1062 = (sub ed.FStar_Syntax_Syntax.assume_p)
in (let _166_1061 = (sub ed.FStar_Syntax_Syntax.null_wp)
in (let _166_1060 = (sub ed.FStar_Syntax_Syntax.trivial)
in (let _166_1059 = (let _166_1049 = (sub (([]), (ed.FStar_Syntax_Syntax.repr)))
in (Prims.snd _166_1049))
in (let _166_1058 = (sub ed.FStar_Syntax_Syntax.return_repr)
in (let _166_1057 = (sub ed.FStar_Syntax_Syntax.bind_repr)
in (let _166_1056 = (FStar_List.map (fun action -> (let _166_1055 = (FStar_Parser_Env.qualify env action.FStar_Syntax_Syntax.action_unqualified_name)
in (let _166_1054 = (let _166_1051 = (sub (([]), (action.FStar_Syntax_Syntax.action_defn)))
in (Prims.snd _166_1051))
in (let _166_1053 = (let _166_1052 = (sub (([]), (action.FStar_Syntax_Syntax.action_typ)))
in (Prims.snd _166_1052))
in {FStar_Syntax_Syntax.action_name = _166_1055; FStar_Syntax_Syntax.action_unqualified_name = action.FStar_Syntax_Syntax.action_unqualified_name; FStar_Syntax_Syntax.action_univs = action.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_defn = _166_1054; FStar_Syntax_Syntax.action_typ = _166_1053})))) ed.FStar_Syntax_Syntax.actions)
in {FStar_Syntax_Syntax.qualifiers = _166_1071; FStar_Syntax_Syntax.cattributes = cattributes; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = _166_1070; FStar_Syntax_Syntax.ret_wp = _166_1069; FStar_Syntax_Syntax.bind_wp = _166_1068; FStar_Syntax_Syntax.if_then_else = _166_1067; FStar_Syntax_Syntax.ite_wp = _166_1066; FStar_Syntax_Syntax.stronger = _166_1065; FStar_Syntax_Syntax.close_wp = _166_1064; FStar_Syntax_Syntax.assert_p = _166_1063; FStar_Syntax_Syntax.assume_p = _166_1062; FStar_Syntax_Syntax.null_wp = _166_1061; FStar_Syntax_Syntax.trivial = _166_1060; FStar_Syntax_Syntax.repr = _166_1059; FStar_Syntax_Syntax.return_repr = _166_1058; FStar_Syntax_Syntax.bind_repr = _166_1057; FStar_Syntax_Syntax.actions = _166_1056}))))))))))))))))
in (
...
let env = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.actions (FStar_List.fold_left (fun env a -> (let _166_1074 = (FStar_Syntax_Util.action_as_lb mname a)
in (FStar_Parser_Env.push_sigelt env _166_1074))) env))
in (
...
(let _166_1079 = (FStar_Parser_Env.push_module_abbrev env x l)
in ((_166_1079), ([])))
end
...
in (let _166_1081 = (FStar_List.map (trans_qual None) quals)
in (desugar_tycon env d.FStar_Parser_AST.drange _166_1081 tcs))))
end
...
in (match ((let _166_1083 = (let _166_1082 = (desugar_term_maybe_top true env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((isrec), (lets), ((FStar_Parser_AST.mk_term (FStar_Parser_AST.Const (FStar_Const.Const_unit)) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))))) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))
in (FStar_All.pipe_left FStar_Syntax_Subst.compress _166_1082))
in _166_1083.FStar_Syntax_Syntax.n)) with
...
(let _166_1088 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (
...
in (((Prims.fst lbs)), (_166_1088)))
end else begin
lbs
end
in (

let s = (let _166_1091 = (let _166_1090 = (FStar_All.pipe_right fvs (FStar_List.map (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in ((lbs), (d.FStar_Parser_AST.drange), (_166_1090), (quals), (attrs)))
in FStar_Syntax_Syntax.Sig_let (_166_1091))
in (
...
in (let _166_1095 = (let _166_1094 = (let _166_1093 = (let _166_1092 = (FStar_Parser_Env.qualify env id)
in ((_166_1092), (f), ((FStar_Syntax_Syntax.Assumption)::[]), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Sig_assume (_166_1093))
in (_166_1094)::[])
in ((env), (_166_1095))))
end
...
let t = (let _166_1096 = (close_fun env t)
in (desugar_term env _166_1096))
in (
...
let se = (let _166_1099 = (let _166_1098 = (FStar_Parser_Env.qualify env id)
in (let _166_1097 = (FStar_List.map (trans_qual None) quals)
in ((_166_1098), ([]), (t), (_166_1097), (d.FStar_Parser_AST.drange))))
in FStar_Syntax_Syntax.Sig_declare_typ (_166_1099))
in (
...
let t = (let _166_1104 = (let _166_1100 = (FStar_Syntax_Syntax.null_binder t)
in (_166_1100)::[])
in (let _166_1103 = (let _166_1102 = (let _166_1101 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) FStar_Syntax_Const.exn_lid)
in (Prims.fst _166_1101))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total _166_1102))
in (FStar_Syntax_Util.arrow _166_1104 _166_1103)))
in (
...
| None -> begin
(let _166_1115 = (let _166_1114 = (let _166_1113 = (let _166_1112 = (let _166_1111 = (FStar_Syntax_Print.lid_to_string l)
in (Prims.strcat _166_1111 " not found"))
in (Prims.strcat "Effect name " _166_1112))
in ((_166_1113), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_166_1114))
in (Prims.raise _166_1115))
end
| Some (l) -> begin
l
end))
...
(let _166_1118 = (let _166_1117 = (let _166_1116 = (desugar_term env t)
in (([]), (_166_1116)))
in Some (_166_1117))
in ((_166_1118), (None)))
end
| FStar_Parser_AST.ReifiableLift (wp, t) -> begin
(let _166_1124 = (let _166_1120 = (let _166_1119 = (desugar_term env wp)
in (([]), (_166_1119)))
in Some (_166_1120))
in (let _166_1123 = (let _166_1122 = (let _166_1121 = (desugar_term env t)
in (([]), (_166_1121)))
in Some (_166_1122))
in ((_166_1124), (_166_1123))))
end
| FStar_Parser_AST.LiftForFree (t) -> begin
(let _166_1127 = (let _166_1126 = (let _166_1125 = (desugar_term env t)
in (([]), (_166_1125)))
in Some (_166_1126))
in ((None), (_166_1127)))
end)
...
(let _166_1145 = (FStar_Parser_Env.prepare_module_or_interface true admitted env mname)
in ((_166_1145), (mname), (decls), (true)))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(let _166_1146 = (FStar_Parser_Env.prepare_module_or_interface false false env mname)
in ((_166_1146), (mname), (decls), (false)))
end)
...
(let _166_1157 = (FStar_Syntax_Print.modul_to_string modul)
in (FStar_Util.print1 "%s\n" _166_1157))
end else begin
()
end
in (let _166_1158 = if pop_when_done then begin
