...
| FStar_Parser_AST.Product (_65_384) -> begin
t
end
| _65_387 -> begin
...
| FStar_Parser_AST.PatAscribed (p, _65_422) -> begin
(is_app_pattern p)
end
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (_65_428); FStar_Parser_AST.prange = _65_426}, _65_432) -> begin
true
end
| _65_436 -> begin
false
...
let _65_453 = (destruct_app_pattern env is_top_level p)
in (match (_65_453) with
| (name, args, _65_452) -> begin
((name), (args), (Some (t)))
end))
end
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (id, _65_458); FStar_Parser_AST.prange = _65_455}, args) when is_top_level -> begin
(let _160_143 = (let _160_142 = (FStar_Parser_Env.qualify env id)
in FStar_Util.Inr (_160_142))
in ((_160_143), (args), (None)))
end
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (id, _65_469); FStar_Parser_AST.prange = _65_466}, args) -> begin
...
| LocalBinder (_65_480) -> begin
_65_480
end))


let ___LetBinder____0 = (fun projectee -> (match (projectee) with
| LetBinder (_65_483) -> begin
_65_483
end))
...
let _65_503 = (FStar_Parser_Env.push_bv env a)
in (match (_65_503) with
| (env, a) -> begin
(((((

let _65_504 = a
in {FStar_Syntax_Syntax.ppname = _65_504.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _65_504.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})), ((trans_aqual imp)))), (env))
end))
end))
...
let mk_lb : (FStar_Syntax_Syntax.lbname * FStar_Syntax_Syntax.typ * FStar_Syntax_Syntax.term)  ->  FStar_Syntax_Syntax.letbinding = (fun _65_509 -> (match (_65_509) with
| (n, t, e) -> begin
...
| FStar_Parser_AST.Const (FStar_Const.Const_int (repr, _65_536)) -> begin
(

let n = (FStar_Util.int_of_string repr)
in (

let _65_541 = if (n < (Prims.parse_int "0")) then begin
...
let _65_624 = (FStar_List.hd fields)
...
let check_field = (fun _65_630 -> (match (_65_630) with
| (f', _65_629) -> begin
...
let _65_632 = (let _160_261 = (FStar_List.tl fields)
...
| FStar_Syntax_Syntax.Pat_cons (_65_652, pats) -> begin
(FStar_All.pipe_right pats (FStar_List.fold_left (fun out _65_660 -> (match (_65_660) with
| (p, _65_659) -> begin
...
let _65_683 = (match (((is_mut), (p.FStar_Parser_AST.pat))) with
...
let _65_697 = (push_bv_maybe_mut e x)
in (match (_65_697) with
| (e, x) -> begin
(((x)::l), (e), (x))
end))
end))
...
let _65_721 = (aux loc env p)
in (match (_65_721) with
| (loc, env, var, p, _65_720) -> begin
(
...
| (loc, env, _65_730, p, _65_733) -> begin
((loc), (env), ((p)::ps))
end))
end)) ((loc), (env), ([])) ps)
...
let _65_758 = x
in {FStar_Syntax_Syntax.ppname = _65_758.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _65_758.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (aq))))
end)
...
let _65_777 = (resolvex loc env x)
...
| FStar_Parser_AST.PatApp ({FStar_Parser_AST.pat = FStar_Parser_AST.PatName (l); FStar_Parser_AST.prange = _65_783}, args) -> begin
(

let _65_805 = (FStar_List.fold_right (fun arg _65_794 -> (match (_65_794) with
| (loc, env, args) -> begin
(

let _65_801 = (aux loc env arg)
in (match (_65_801) with
| (loc, env, _65_798, arg, imp) -> begin
...
| FStar_Parser_AST.PatApp (_65_809) -> begin
(Prims.raise (FStar_Syntax_Syntax.Error ((("Unexpected pattern"), (p.FStar_Parser_AST.prange)))))
end
| FStar_Parser_AST.PatList (pats) -> begin
(

let _65_829 = (FStar_List.fold_right (fun pat _65_817 -> (match (_65_817) with
| (loc, env, pats) -> begin
(

let _65_825 = (aux loc env pat)
in (match (_65_825) with
| (loc, env, _65_821, pat, _65_824) -> begin
((loc), (env), ((pat)::pats))
end))
end)) pats ((loc), (env), ([])))
in (match (_65_829) with
| (loc, env, pats) -> begin
(
...
let _65_855 = (FStar_List.fold_left (fun _65_842 p -> (match (_65_842) with
| (loc, env, pats) -> begin
(

let _65_851 = (aux loc env p)
in (match (_65_851) with
| (loc, env, _65_847, pat, _65_850) -> begin
...
let _65_861 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) l)
in (match (_65_861) with
| (constr, _65_860) -> begin
(
...
let fields = (FStar_All.pipe_right fields (FStar_List.map (fun _65_875 -> (match (_65_875) with
| (f, p) -> begin
((f.FStar_Ident.ident), (p))
end))))
in (

let args = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _65_880 -> (match (_65_880) with
| (f, _65_879) -> begin
(match ((FStar_All.pipe_right fields (FStar_List.tryFind (fun _65_884 -> (match (_65_884) with
| (g, _65_883) -> begin
...
let _65_899 = (aux loc env app)
in (match (_65_899) with
| (env, e, b, p, _65_898) -> begin
(
...
in Some (_160_384))
in {FStar_Syntax_Syntax.fv_name = _65_904.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = _65_904.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = _160_385}))
in ((_160_386), (args)))
...
let _65_916 = (aux [] env p)
in (match (_65_916) with
| (_65_910, env, b, p, _65_915) -> begin
(

let _65_917 = (let _160_389 = (check_linear_pattern_variables p)
...
| FStar_Parser_AST.PatVar (x, _65_929) -> begin
(mklet x)
end
| FStar_Parser_AST.PatAscribed ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (x, _65_936); FStar_Parser_AST.prange = _65_933}, t) -> begin
...
let _65_948 = (desugar_data_pat env p is_mut)
...
and desugar_match_pat_maybe_top : Prims.bool  ->  FStar_Parser_Env.env  ->  FStar_Parser_AST.pattern  ->  (env_t * FStar_Syntax_Syntax.pat) = (fun _65_960 env pat -> (

let _65_968 = (desugar_data_pat env pat false)
in (match (_65_968) with
| (env, _65_966, pat) -> begin
((env), (pat))
end)))
...
let _65_973 = env
in {FStar_Parser_Env.curmodule = _65_973.FStar_Parser_Env.curmodule; FStar_Parser_Env.curmonad = _65_973.FStar_Parser_Env.curmonad; FStar_Parser_Env.modules = _65_973.FStar_Parser_Env.modules; FStar_Parser_Env.scope_mods = _65_973.FStar_Parser_Env.scope_mods; FStar_Parser_Env.sigaccum = _65_973.FStar_Parser_Env.sigaccum; FStar_Parser_Env.sigmap = _65_973.FStar_Parser_Env.sigmap; FStar_Parser_Env.default_result_effect = _65_973.FStar_Parser_Env.default_result_effect; FStar_Parser_Env.iface = _65_973.FStar_Parser_Env.iface; FStar_Parser_Env.admitted_iface = _65_973.FStar_Parser_Env.admitted_iface; FStar_Parser_Env.expect_typ = false})
...
let _65_978 = env
in {FStar_Parser_Env.curmodule = _65_978.FStar_Parser_Env.curmodule; FStar_Parser_Env.curmonad = _65_978.FStar_Parser_Env.curmonad; FStar_Parser_Env.modules = _65_978.FStar_Parser_Env.modules; FStar_Parser_Env.scope_mods = _65_978.FStar_Parser_Env.scope_mods; FStar_Parser_Env.sigaccum = _65_978.FStar_Parser_Env.sigaccum; FStar_Parser_Env.sigmap = _65_978.FStar_Parser_Env.sigmap; FStar_Parser_Env.default_result_effect = _65_978.FStar_Parser_Env.default_result_effect; FStar_Parser_Env.iface = _65_978.FStar_Parser_Env.iface; FStar_Parser_Env.admitted_iface = _65_978.FStar_Parser_Env.admitted_iface; FStar_Parser_Env.expect_typ = true})
in (desugar_term_maybe_top false env e)))
and desugar_machine_integer : FStar_Parser_Env.env  ->  Prims.string  ->  (FStar_Const.signedness * FStar_Const.width)  ->  FStar_Range.range  ->  (FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax = (fun env repr _65_985 range -> (match (_65_985) with
...
let _65_1008 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) l)
in (match (_65_1008) with
| (tm, mut) -> begin
(
...
| FStar_Parser_AST.Var ({FStar_Ident.ns = _65_1020; FStar_Ident.ident = _65_1018; FStar_Ident.nsstr = _65_1016; FStar_Ident.str = "cps"}) -> begin
...
let _65_1032 = e
in {FStar_Syntax_Syntax.n = _65_1032.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _65_1032.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = top.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = _65_1032.FStar_Syntax_Syntax.vars}))
in (match ((let _160_455 = (unparen top)
in _160_455.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Wild -> begin
(setpos FStar_Syntax_Syntax.tun)
end
| FStar_Parser_AST.Labeled (_65_1036) -> begin
...
| FStar_Parser_AST.Op ("*", (_65_1064)::(_65_1062)::[]) when (let _160_456 = (op_as_term env (Prims.parse_int "2") top.FStar_Parser_AST.range "*")
...
let _65_1083 = (let _160_464 = (FStar_Syntax_Util.mk_tuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
...
| FStar_Parser_AST.Name ({FStar_Ident.ns = _65_1103; FStar_Ident.ident = _65_1101; FStar_Ident.nsstr = _65_1099; FStar_Ident.str = "Type0"}) -> begin
(mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_zero)))
end
| FStar_Parser_AST.Name ({FStar_Ident.ns = _65_1112; FStar_Ident.ident = _65_1110; FStar_Ident.nsstr = _65_1108; FStar_Ident.str = "Type"}) -> begin
(mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_unknown)))
end
| FStar_Parser_AST.Construct ({FStar_Ident.ns = _65_1121; FStar_Ident.ident = _65_1119; FStar_Ident.nsstr = _65_1117; FStar_Ident.str = "Type"}, ((t, FStar_Parser_AST.UnivApp))::[]) -> begin
(let _160_470 = (let _160_469 = (desugar_universe t)
in FStar_Syntax_Syntax.Tm_type (_160_469))
in (mk _160_470))
end
| FStar_Parser_AST.Name ({FStar_Ident.ns = _65_1135; FStar_Ident.ident = _65_1133; FStar_Ident.nsstr = _65_1131; FStar_Ident.str = "Effect"}) -> begin
(mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_effect)))
end
| FStar_Parser_AST.Name ({FStar_Ident.ns = _65_1144; FStar_Ident.ident = _65_1142; FStar_Ident.nsstr = _65_1140; FStar_Ident.str = "True"}) -> begin
...
| FStar_Parser_AST.Name ({FStar_Ident.ns = _65_1153; FStar_Ident.ident = _65_1151; FStar_Ident.nsstr = _65_1149; FStar_Ident.str = "False"}) -> begin
...
| FStar_Parser_AST.Projector (eff_name, {FStar_Ident.idText = txt; FStar_Ident.idRange = _65_1158}) when ((is_special_effect_combinator txt) && (FStar_Parser_Env.is_effect_name env eff_name)) -> begin
...
let _65_1173 = (FStar_Parser_Env.fail_or2 (FStar_Parser_Env.try_lookup_id env) ident)
in (match (_65_1173) with
| (t1, mut) -> begin
(

let _65_1174 = if (not (mut)) then begin
...
let _65_1198 = (let _160_481 = (mk (FStar_Syntax_Syntax.Tm_fvar (head)))
in ((_160_481), (true)))
in (match (_65_1198) with
| (head, is_data) -> begin
(match (args) with
| [] -> begin
head
...
let args = (FStar_List.map (fun _65_1204 -> (match (_65_1204) with
| (t, imp) -> begin
(
...
let _65_1233 = (FStar_List.fold_left (fun _65_1216 b -> (match (_65_1216) with
| (env, tparams, typs) -> begin
(

let _65_1220 = (desugar_binder env b)
in (match (_65_1220) with
| (xopt, t) -> begin
(

let _65_1226 = (match (xopt) with
| None -> begin
...
let _65_1227 = x
in {FStar_Syntax_Syntax.ppname = _65_1227.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _65_1227.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (None)))::[]))), (_160_489)))
end))
end))
end)) ((env), ([]), ([])) (FStar_List.append binders (((FStar_Parser_AST.mk_binder (FStar_Parser_AST.NoName (t)) t.FStar_Parser_AST.range FStar_Parser_AST.Type None))::[])))
in (match (_65_1233) with
| (env, _65_1231, targs) -> begin
(

let _65_1237 = (let _160_490 = (FStar_Syntax_Util.mk_dtuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
...
let _65_1244 = (uncurry binders t)
in (match (_65_1244) with
| (bs, t) -> begin
(
...
let _65_1258 = (as_binder env hd.FStar_Parser_AST.aqual bb)
in (match (_65_1258) with
| (b, env) -> begin
(aux env ((b)::bs) tl)
end))))
end))
...
let _65_1273 = (as_binder env None b)
in (match (_65_1273) with
| ((x, _65_1270), env) -> begin
(
...
let _65_1294 = (FStar_List.fold_left (fun _65_1282 pat -> (match (_65_1282) with
| (env, ftvs) -> begin
(match (pat.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatAscribed (_65_1285, t) -> begin
...
let _65_1318 = (desugar_binding_pat env p)
in (match (_65_1318) with
| (env, b, pat) -> begin
(

let _65_1369 = (match (b) with
| LetBinder (_65_1320) -> begin
(FStar_All.failwith "Impossible")
end
| LocalBinder (x, aq) -> begin
(
...
| (FStar_Syntax_Syntax.Tm_name (_65_1342), _65_1345) -> begin
(
...
| (FStar_Syntax_Syntax.Tm_app (_65_1351, args), FStar_Syntax_Syntax.Pat_cons (_65_1356, pats)) -> begin
(
...
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (a); FStar_Parser_AST.range = rng; FStar_Parser_AST.level = _65_1371}, phi, _65_1378) when ((FStar_Ident.lid_equals a FStar_Syntax_Const.assert_lid) || (FStar_Ident.lid_equals a FStar_Syntax_Const.assume_lid)) -> begin
(
...
| FStar_Parser_AST.App (_65_1384, _65_1386, FStar_Parser_AST.UnivApp) -> begin
(
...
| FStar_Parser_AST.App (_65_1403) -> begin
(
...
let ds_let_rec_or_app = (fun _65_1437 -> (match (()) with
| () -> begin
(
...
let funs = (FStar_All.pipe_right bindings (FStar_List.map (fun _65_1441 -> (match (_65_1441) with
| (p, def) -> begin
...
| _65_1447 -> begin
(match (p.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatAscribed ({FStar_Parser_AST.pat = FStar_Parser_AST.PatVar (id, _65_1452); FStar_Parser_AST.prange = _65_1449}, t) -> begin
...
| FStar_Parser_AST.PatVar (id, _65_1461) -> begin
if top_level then begin
...
let _65_1494 = (FStar_List.fold_left (fun _65_1470 _65_1479 -> (match (((_65_1470), (_65_1479))) with
| ((env, fnames, rec_bindings), ((f, _65_1473, _65_1475), _65_1478)) -> begin
(

let _65_1490 = (match (f) with
| FStar_Util.Inl (x) -> begin
(

let _65_1484 = (FStar_Parser_Env.push_bv env x)
in (match (_65_1484) with
| (env, xx) -> begin
...
let desugar_one_def = (fun env lbname _65_1505 -> (match (_65_1505) with
| ((_65_1500, args, result_t), def) -> begin
(
...
let _65_1514 = if (is_comp_type env t) then begin
...
let _65_1540 = (desugar_binding_pat_maybe_top top_level env pat is_mutable)
...
let desugar_branch = (fun _65_1590 -> (match (_65_1590) with
| (pat, wopt, b) -> begin
(

let _65_1593 = (desugar_match_pat env pat)
in (match (_65_1593) with
| (env, pat) -> begin
(
...
| FStar_Parser_AST.Record (_65_1607, []) -> begin
...
let _65_1619 = (FStar_List.hd fields)
in (match (_65_1619) with
| (f, _65_1618) -> begin
f.FStar_Ident.ns
end))
in (
...
let found = (FStar_All.pipe_right fields (FStar_Util.find_opt (fun _65_1627 -> (match (_65_1627) with
| (g, _65_1626) -> begin
...
| None -> begin
(let _160_638 = (let _160_637 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _65_1644 -> (match (_65_1644) with
| (f, _65_1643) -> begin
...
let record = (let _160_643 = (let _160_642 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _65_1652 -> (match (_65_1652) with
| (f, _65_1651) -> begin
...
| FStar_Syntax_Syntax.Tm_meta ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.tk = _65_1668; FStar_Syntax_Syntax.pos = _65_1666; FStar_Syntax_Syntax.vars = _65_1664}, args); FStar_Syntax_Syntax.tk = _65_1662; FStar_Syntax_Syntax.pos = _65_1660; FStar_Syntax_Syntax.vars = _65_1658}, FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Data_app)) -> begin
(
...
let _65_1689 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_dc_by_field_name env) f)
in (match (_65_1689) with
...
| _65_1700 when (top.FStar_Parser_AST.level = FStar_Parser_AST.Formula) -> begin
(desugar_formula env top)
end
| _65_1702 -> begin
(FStar_Parser_AST.error "Unexpected term" top top.FStar_Parser_AST.range)
end
| FStar_Parser_AST.Let (_65_1704, _65_1706, _65_1708) -> begin
(FStar_All.failwith "Not implemented yet")
end
| FStar_Parser_AST.QForall (_65_1712, _65_1714, _65_1716) -> begin
(FStar_All.failwith "Not implemented yet")
end
| FStar_Parser_AST.QExists (_65_1720, _65_1722, _65_1724) -> begin
(FStar_All.failwith "Not implemented yet")
end))))
and desugar_args : FStar_Parser_Env.env  ->  (FStar_Parser_AST.term * FStar_Parser_AST.imp) Prims.list  ->  (FStar_Syntax_Syntax.term * FStar_Syntax_Syntax.arg_qualifier Prims.option) Prims.list = (fun env args -> (FStar_All.pipe_right args (FStar_List.map (fun _65_1731 -> (match (_65_1731) with
| (a, imp) -> begin
...
let is_requires = (fun _65_1743 -> (match (_65_1743) with
| (t, _65_1742) -> begin
(match ((let _160_667 = (unparen t)
in _160_667.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Requires (_65_1745) -> begin
true
end
| _65_1748 -> begin
false
...
let is_ensures = (fun _65_1753 -> (match (_65_1753) with
| (t, _65_1752) -> begin
(match ((let _160_670 = (unparen t)
in _160_670.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Ensures (_65_1755) -> begin
true
end
| _65_1758 -> begin
false
...
let is_app = (fun head _65_1764 -> (match (_65_1764) with
| (t, _65_1763) -> begin
(match ((let _160_675 = (unparen t)
in _160_675.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App ({FStar_Parser_AST.tm = FStar_Parser_AST.Var (d); FStar_Parser_AST.range = _65_1768; FStar_Parser_AST.level = _65_1766}, _65_1773, _65_1775) -> begin
...
let _65_1785 = (head_and_args t)
in (match (_65_1785) with
| (head, args) -> begin
...
| _65_1816 when default_ok -> begin
...
let _65_1823 = (pre_process_comp_typ t)
in (match (_65_1823) with
| ((eff, cattributes), args) -> begin
(

let _65_1824 = if ((FStar_List.length args) = (Prims.parse_int "0")) then begin
...
let _65_1828 = (let _160_687 = (FStar_List.hd args)
...
let _65_1853 = (FStar_All.pipe_right rest (FStar_List.partition (fun _65_1834 -> (match (_65_1834) with
| (t, _65_1833) -> begin
(match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.tk = _65_1840; FStar_Syntax_Syntax.pos = _65_1838; FStar_Syntax_Syntax.vars = _65_1836}, (_65_1845)::[]) -> begin
...
in (match (_65_1853) with
| (dec, rest) -> begin
(

let decreases_clause = (FStar_All.pipe_right dec (FStar_List.map (fun _65_1857 -> (match (_65_1857) with
| (t, _65_1856) -> begin
(match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_app (_65_1859, ((arg, _65_1862))::[]) -> begin
...
let _65_1906 = t
in {FStar_Syntax_Syntax.n = _65_1906.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _65_1906.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = f.FStar_Parser_AST.range; FStar_Syntax_Syntax.vars = _65_1906.FStar_Syntax_Syntax.vars}))
in (
...
let _65_1913 = b
in {FStar_Parser_AST.b = _65_1913.FStar_Parser_AST.b; FStar_Parser_AST.brange = _65_1913.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = _65_1913.FStar_Parser_AST.aqual}))
in (
...
let _65_1927 = (FStar_Parser_Env.push_bv env a)
...
let _65_1928 = a
in {FStar_Syntax_Syntax.ppname = _65_1928.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _65_1928.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
in (
...
let _65_2035 = (FStar_List.fold_left (fun _65_2016 b -> (match (_65_2016) with
| (env, out) -> begin
(
...
let _65_2018 = b
in {FStar_Parser_AST.b = _65_2018.FStar_Parser_AST.b; FStar_Parser_AST.brange = _65_2018.FStar_Parser_AST.brange; FStar_Parser_AST.blevel = FStar_Parser_AST.Formula; FStar_Parser_AST.aqual = _65_2018.FStar_Parser_AST.aqual}))
in (match (tk) with
| (Some (a), k) -> begin
(

let _65_2027 = (FStar_Parser_Env.push_bv env a)
in (match (_65_2027) with
| (env, a) -> begin
(
...
let _65_2028 = a
in {FStar_Syntax_Syntax.ppname = _65_2028.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _65_2028.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k})
...
in (let _160_779 = (let _160_778 = (quals ((FStar_Syntax_Syntax.OnlyName)::(FStar_Syntax_Syntax.Discriminator (d))::[]))
in ((disc_name), ([]), (FStar_Syntax_Syntax.tun), (_160_778), ((FStar_Ident.range_of_lid disc_name))))
in FStar_Syntax_Syntax.Sig_declare_typ (_160_779)))))))))
...
in (let _160_807 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i _65_2076 -> (match (_65_2076) with
| (x, _65_2075) -> begin
(
...
let only_decl = (((let _160_792 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Syntax_Const.prims_lid _160_792)) || (fvq <> FStar_Syntax_Syntax.Data_ctor)) || (let _160_794 = (let _160_793 = (FStar_Parser_Env.current_module env)
in _160_793.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors _160_794)))
in (
...
(let _160_798 = (FStar_List.filter (fun _65_15 -> (match (_65_15) with
...
in (FStar_Syntax_Syntax.Assumption)::_160_798)
end else begin
q
end)
in (
...
let lb = (let _160_801 = (let _160_800 = (FStar_Syntax_Syntax.lid_as_fv field_name dd None)
in FStar_Util.Inr (_160_800))
in {FStar_Syntax_Syntax.lbname = _160_801; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = FStar_Syntax_Syntax.tun; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = FStar_Syntax_Syntax.tun})
in (

let impl = (let _160_806 = (let _160_805 = (let _160_804 = (let _160_803 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right _160_803 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (_160_804)::[])
in ((((false), ((lb)::[]))), (p), (_160_805), (quals)))
in FStar_Syntax_Syntax.Sig_let (_160_806))
...
in (FStar_All.pipe_right _160_807 FStar_List.flatten))))


let mk_data_projector_names = (fun iquals env _65_2105 -> (match (_65_2105) with
| (inductive_tps, se) -> begin
(match (se) with
| FStar_Syntax_Syntax.Sig_datacon (lid, _65_2108, t, _65_2111, n, quals, _65_2115, _65_2117) when (not ((FStar_Ident.lid_equals lid FStar_Syntax_Const.lexcons_lid))) -> begin
(

let _65_2123 = (FStar_Syntax_Util.arrow_formals t)
in (match (_65_2123) with
| (formals, _65_2122) -> begin
(match (formals) with
| [] -> begin
[]
end
...
let filter_records = (fun _65_17 -> (match (_65_17) with
| FStar_Syntax_Syntax.RecordConstructor (_65_2129, fns) -> begin
...
let _65_2144 = (FStar_Util.first_N n formals)
...
let dd = if (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract)) then begin
(let _160_829 = (FStar_Syntax_Util.incr_delta_qualifier t)
in FStar_Syntax_Syntax.Delta_abstract (_160_829))
end else begin
(FStar_Syntax_Util.incr_delta_qualifier t)
end
in (

let lb = (let _160_834 = (let _160_830 = (FStar_Syntax_Syntax.lid_as_fv lid dd None)
in FStar_Util.Inr (_160_830))
in (let _160_833 = (let _160_831 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_Syntax_Util.arrow typars _160_831))
in (let _160_832 = (no_annot_abs typars t)
in {FStar_Syntax_Syntax.lbname = _160_834; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = _160_833; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = _160_832})))
...
let tycon_id = (fun _65_18 -> (match (_65_18) with
...
(let _160_848 = (let _160_847 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_160_847))
in (FStar_Parser_AST.mk_term _160_848 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
...
in (FStar_List.fold_left (fun out b -> (let _160_861 = (let _160_860 = (let _160_859 = (binder_to_term b)
in ((out), (_160_859), ((imp_of_aqual b))))
in FStar_Parser_AST.App (_160_860))
in (FStar_Parser_AST.mk_term _160_861 out.FStar_Parser_AST.range out.FStar_Parser_AST.level))) t binders)))
in (

let tycon_record_as_variant = (fun _65_19 -> (match (_65_19) with
...
let mfields = (FStar_List.map (fun _65_2236 -> (match (_65_2236) with
| (x, t, _65_2235) -> begin
(FStar_Parser_AST.mk_binder (FStar_Parser_AST.Annotated ((((FStar_Syntax_Util.mangle_field_name x)), (t)))) x.FStar_Ident.idRange FStar_Parser_AST.Expr None)
end)) fields)
in (

let result = (let _160_867 = (let _160_866 = (let _160_865 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_160_865))
in (FStar_Parser_AST.mk_term _160_866 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _160_867 parms))
in (

let constrTyp = (FStar_Parser_AST.mk_term (FStar_Parser_AST.Product (((mfields), ((with_constructor_effect result))))) id.FStar_Ident.idRange FStar_Parser_AST.Type)
in (let _160_869 = (FStar_All.pipe_right fields (FStar_List.map (fun _65_2245 -> (match (_65_2245) with
| (x, _65_2242, _65_2244) -> begin
(FStar_Syntax_Util.unmangle_field_name x)
end))))
in ((FStar_Parser_AST.TyconVariant (((id), (parms), (kopt), ((((constrName), (Some (constrTyp)), (None), (false)))::[])))), (_160_869)))))))
end
| _65_2247 -> begin
(FStar_All.failwith "impossible")
end))
...
let desugar_abstract_tc = (fun quals _env mutuals _65_20 -> (match (_65_20) with
| FStar_Parser_AST.TyconAbstract (id, binders, kopt) -> begin
(

let _65_2261 = (typars_of_binders _env binders)
in (match (_65_2261) with
| (_env', typars) -> begin
(
...
let tconstr = (let _160_880 = (let _160_879 = (let _160_878 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_160_878))
in (FStar_Parser_AST.mk_term _160_879 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _160_880 binders))
in (
...
let _65_2289 = (FStar_List.fold_left (fun _65_2280 _65_2283 -> (match (((_65_2280), (_65_2283))) with
| ((env, tps), (x, imp)) -> begin
(

let _65_2286 = (FStar_Parser_Env.push_bv env x.FStar_Syntax_Syntax.ppname)
...
| None -> begin
(let _160_887 = (tm_type_z id.FStar_Ident.idRange)
in Some (_160_887))
end
| _65_2298 -> begin
kopt
...
let _65_2308 = (desugar_abstract_tc quals env [] tc)
in (match (_65_2308) with
| (_65_2302, _65_2304, se, _65_2307) -> begin
(

let se = (match (se) with
| FStar_Syntax_Syntax.Sig_inductive_typ (l, _65_2311, typars, k, [], [], quals, rng) -> begin
(
...
let _65_2320 = (let _160_889 = (FStar_Range.string_of_range rng)
in (let _160_888 = (FStar_Syntax_Print.lid_to_string l)
...
| _65_2325 -> begin
(let _160_892 = (let _160_891 = (let _160_890 = (FStar_Syntax_Syntax.mk_Total k)
in ((typars), (_160_890)))
in FStar_Syntax_Syntax.Tm_arrow (_160_891))
in (FStar_Syntax_Syntax.mk _160_892 None rng))
end)
...
let _65_2340 = (typars_of_binders env binders)
in (match (_65_2340) with
| (env', typars) -> begin
(

let k = (match (kopt) with
| None -> begin
if (FStar_Util.for_some (fun _65_21 -> (match (_65_21) with
...
let quals = if (FStar_All.pipe_right quals (FStar_Util.for_some (fun _65_22 -> (match (_65_22) with
...
let _65_2378 = (match ((let _160_895 = (unparen t)
in _160_895.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Construct (head, args) -> begin
(

let _65_2373 = (match ((FStar_List.rev args)) with
| ((last_arg, _65_2362))::args_rev -> begin
(match ((let _160_896 = (unparen last_arg)
in _160_896.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Attributes (ts) -> begin
...
in (match (_65_2373) with
| (cattributes, args) -> begin
(let _160_897 = (desugar_attributes env cattributes)
in (((FStar_Parser_AST.mk_term (FStar_Parser_AST.Construct (((head), (args)))) t.FStar_Parser_AST.range t.FStar_Parser_AST.level)), (_160_897)))
end))
end
| _65_2375 -> begin
((t), ([]))
end)
in (match (_65_2378) with
| (t, cattributes) -> begin
(
...
in (let _160_901 = (let _160_900 = (FStar_Parser_Env.qualify env id)
in (let _160_899 = (FStar_All.pipe_right quals (FStar_List.filter (fun _65_23 -> (match (_65_23) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| _65_2385 -> begin
...
in ((_160_900), ([]), (typars), (c), (_160_899), ((FStar_List.append cattributes (FStar_Syntax_Util.comp_flags c))), (rng))))
in FStar_Syntax_Syntax.Sig_effect_abbrev (_160_901)))))
end))
end else begin
(
...
| (FStar_Parser_AST.TyconRecord (_65_2391))::[] -> begin
(

let trec = (FStar_List.hd tcs)
in (

let _65_2397 = (tycon_record_as_variant trec)
in (match (_65_2397) with
| (t, fs) -> begin
(let _160_906 = (let _160_905 = (let _160_904 = (let _160_903 = (let _160_902 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.ids_of_lid _160_902))
in ((_160_903), (fs)))
in FStar_Syntax_Syntax.RecordType (_160_904))
in (_160_905)::quals)
in (desugar_tycon env rng _160_906 ((t)::[])))
end)))
end
| (_65_2401)::_65_2399 -> begin
(
...
| (env, tcs) -> begin
(match (tc) with
| FStar_Parser_AST.TyconRecord (_65_2414) -> begin
(

let trec = tc
in (

let _65_2419 = (tycon_record_as_variant trec)
in (match (_65_2419) with
| (t, fs) -> begin
(let _160_918 = (let _160_917 = (let _160_916 = (let _160_915 = (let _160_914 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.ids_of_lid _160_914))
in ((_160_915), (fs)))
in FStar_Syntax_Syntax.RecordType (_160_916))
in (_160_917)::quals)
in (collect_tcs _160_918 ((env), (tcs)) t))
end)))
end
| FStar_Parser_AST.TyconVariant (id, binders, kopt, constructors) -> begin
(

let _65_2431 = (desugar_abstract_tc quals env mutuals (FStar_Parser_AST.TyconAbstract (((id), (binders), (kopt)))))
in (match (_65_2431) with
| (env, _65_2428, se, tconstr) -> begin
...
let _65_2443 = (desugar_abstract_tc quals env mutuals (FStar_Parser_AST.TyconAbstract (((id), (binders), (kopt)))))
in (match (_65_2443) with
| (env, _65_2440, se, tconstr) -> begin
...
let _65_2448 = (FStar_List.fold_left (collect_tcs quals) ((env), ([])) tcs)
...
let tps_sigelts = (FStar_All.pipe_right tcs (FStar_List.collect (fun _65_25 -> (match (_65_25) with
| FStar_Util.Inr (FStar_Syntax_Syntax.Sig_inductive_typ (id, uvs, tpars, k, _65_2456, _65_2458, _65_2460, _65_2462), t, quals) -> begin
(

let _65_2472 = (push_tparams env tpars)
in (match (_65_2472) with
| (env_tps, _65_2471) -> begin
(

let t = (desugar_term env_tps t)
in (let _160_921 = (let _160_920 = (mk_typ_abbrev id uvs tpars k t ((id)::[]) quals rng)
in (([]), (_160_920)))
in (_160_921)::[]))
end))
end
| FStar_Util.Inl (FStar_Syntax_Syntax.Sig_inductive_typ (tname, univs, tpars, k, mutuals, _65_2480, tags, _65_2483), constrs, tconstr, quals) -> begin
(

let tycon = ((tname), (tpars), (k))
in (

let _65_2494 = (push_tparams env tpars)
in (match (_65_2494) with
| (env_tps, tps) -> begin
(

let data_tpars = (FStar_List.map (fun _65_2498 -> (match (_65_2498) with
| (x, _65_2497) -> begin
((x), (Some (FStar_Syntax_Syntax.Implicit (true))))
end)) tps)
in (

let _65_2524 = (let _160_933 = (FStar_All.pipe_right constrs (FStar_List.map (fun _65_2505 -> (match (_65_2505) with
| (id, topt, _65_2503, of_notation) -> begin
(
...
let t = (let _160_925 = (FStar_Parser_Env.default_total env_tps)
in (let _160_924 = (close env_tps t)
in (desugar_term _160_925 _160_924)))
in (

let name = (FStar_Parser_Env.qualify env id)
in (

let quals = (FStar_All.pipe_right tags (FStar_List.collect (fun _65_24 -> (match (_65_24) with
...
in (let _160_932 = (let _160_931 = (let _160_930 = (let _160_929 = (let _160_928 = (let _160_927 = (FStar_All.pipe_right t FStar_Syntax_Util.name_function_binders)
in (FStar_Syntax_Syntax.mk_Total _160_927))
in (FStar_Syntax_Util.arrow data_tpars _160_928))
in ((name), (univs), (_160_929), (tname), (ntps), (quals), (mutuals), (rng)))
in FStar_Syntax_Syntax.Sig_datacon (_160_930))
in ((tps), (_160_931)))
in ((name), (_160_932))))))))
end))))
in (FStar_All.pipe_left FStar_List.split _160_933))
in (match (_65_2524) with
...
let bundle = (let _160_935 = (let _160_934 = (FStar_List.collect FStar_Syntax_Util.lids_of_sigelt sigelts)
in ((sigelts), (quals), (_160_934), (rng)))
in FStar_Syntax_Syntax.Sig_bundle (_160_935))
in (
...
let discs = (FStar_All.pipe_right sigelts (FStar_List.collect (fun _65_26 -> (match (_65_26) with
| FStar_Syntax_Syntax.Sig_inductive_typ (tname, _65_2535, tps, k, _65_2539, constrs, quals, _65_2543) when ((FStar_List.length constrs) > (Prims.parse_int "1")) -> begin
(
...
let _65_2572 = (FStar_List.fold_left (fun _65_2557 b -> (match (_65_2557) with
| (env, binders) -> begin
(match ((desugar_binder env b)) with
| (Some (a), k) -> begin
(

let _65_2565 = (FStar_Parser_Env.push_bv env a)
in (match (_65_2565) with
| (env, a) -> begin
(let _160_944 = (let _160_943 = (FStar_Syntax_Syntax.mk_binder (

let _65_2566 = a
in {FStar_Syntax_Syntax.ppname = _65_2566.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _65_2566.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = k}))
in (_160_943)::binders)
in ((env), (_160_944)))
end))
end
...
let _65_2586 = (desugar_binders monad_env eff_binders)
in (match (_65_2586) with
| (env, binders) -> begin
(

let eff_k = (let _160_982 = (FStar_Parser_Env.default_total env)
in (desugar_term _160_982 eff_kind))
in (

let _65_2597 = (FStar_All.pipe_right eff_decls (FStar_List.fold_left (fun _65_2590 decl -> (match (_65_2590) with
| (env, out) -> begin
(

let _65_2594 = (desugar_decl env decl)
in (match (_65_2594) with
| (env, ses) -> begin
(let _160_986 = (let _160_985 = (FStar_List.hd ses)
in (_160_985)::out)
in ((env), (_160_986)))
end))
end)) ((env), ([]))))
in (match (_65_2597) with
| (env, decls) -> begin
(
...
| FStar_Parser_AST.Tycon (_65_2601, ((FStar_Parser_AST.TyconAbbrev (name, _65_2604, _65_2606, {FStar_Parser_AST.tm = FStar_Parser_AST.Construct (_65_2612, ((def, _65_2619))::((cps_type, _65_2615))::[]); FStar_Parser_AST.range = _65_2610; FStar_Parser_AST.level = _65_2608}), _65_2628))::[]) when (not (for_free)) -> begin
(let _160_992 = (FStar_Parser_Env.qualify env name)
in (let _160_991 = (let _160_988 = (desugar_term env def)
in (FStar_Syntax_Subst.close binders _160_988))
in (let _160_990 = (let _160_989 = (desugar_typ env cps_type)
in (FStar_Syntax_Subst.close binders _160_989))
in {FStar_Syntax_Syntax.action_name = _160_992; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_defn = _160_991; FStar_Syntax_Syntax.action_typ = _160_990})))
end
| FStar_Parser_AST.Tycon (_65_2634, ((FStar_Parser_AST.TyconAbbrev (name, _65_2637, _65_2639, defn), _65_2644))::[]) when for_free -> begin
(let _160_995 = (FStar_Parser_Env.qualify env name)
in (let _160_994 = (let _160_993 = (desugar_term env defn)
in (FStar_Syntax_Subst.close binders _160_993))
in {FStar_Syntax_Syntax.action_name = _160_995; FStar_Syntax_Syntax.action_unqualified_name = name; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_defn = _160_994; FStar_Syntax_Syntax.action_typ = FStar_Syntax_Syntax.tun}))
end
| _65_2650 -> begin
...
in (let _160_999 = (let _160_998 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_definition env) l)
in (FStar_All.pipe_left (FStar_Syntax_Subst.close binders) _160_998))
in (([]), (_160_999)))))
in (
...
in (let _160_1022 = (let _160_1021 = (let _160_1020 = (lookup "return_wp")
in (let _160_1019 = (lookup "bind_wp")
in (let _160_1018 = (lookup "if_then_else")
in (let _160_1017 = (lookup "ite_wp")
in (let _160_1016 = (lookup "stronger")
in (let _160_1015 = (lookup "close_wp")
in (let _160_1014 = (lookup "assert_p")
in (let _160_1013 = (lookup "assume_p")
in (let _160_1012 = (lookup "null_wp")
in (let _160_1011 = (lookup "trivial")
in (let _160_1010 = if rr then begin
(let _160_1007 = (lookup "repr")
in (FStar_All.pipe_left Prims.snd _160_1007))
end else begin
FStar_Syntax_Syntax.tun
end
in (let _160_1009 = if rr then begin
(lookup "return")
end else begin
un_ts
end
in (let _160_1008 = if rr then begin
(lookup "bind")
end else begin
un_ts
end
in {FStar_Syntax_Syntax.qualifiers = qualifiers; FStar_Syntax_Syntax.cattributes = []; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = eff_k; FStar_Syntax_Syntax.ret_wp = _160_1020; FStar_Syntax_Syntax.bind_wp = _160_1019; FStar_Syntax_Syntax.if_then_else = _160_1018; FStar_Syntax_Syntax.ite_wp = _160_1017; FStar_Syntax_Syntax.stronger = _160_1016; FStar_Syntax_Syntax.close_wp = _160_1015; FStar_Syntax_Syntax.assert_p = _160_1014; FStar_Syntax_Syntax.assume_p = _160_1013; FStar_Syntax_Syntax.null_wp = _160_1012; FStar_Syntax_Syntax.trivial = _160_1011; FStar_Syntax_Syntax.repr = _160_1010; FStar_Syntax_Syntax.return_repr = _160_1009; FStar_Syntax_Syntax.bind_repr = _160_1008; FStar_Syntax_Syntax.actions = actions})))))))))))))
in ((_160_1021), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Sig_new_effect (_160_1022))))
end
in (
...
let env = (FStar_All.pipe_right actions (FStar_List.fold_left (fun env a -> (let _160_1025 = (FStar_Syntax_Util.action_as_lb a)
in (FStar_Parser_Env.push_sigelt env _160_1025))) env))
in (
...
let _65_2681 = (desugar_binders env eff_binders)
...
let _65_2684 = (head_and_args defn)
...
| _65_2688 -> begin
(let _160_1052 = (let _160_1051 = (let _160_1050 = (let _160_1049 = (let _160_1048 = (FStar_Parser_AST.term_to_string head)
in (Prims.strcat _160_1048 " not found"))
in (Prims.strcat "Effect " _160_1049))
in ((_160_1050), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_160_1051))
in (Prims.raise _160_1052))
end)
in (

let _65_2704 = (match ((FStar_List.rev args)) with
| ((last_arg, _65_2693))::args_rev -> begin
(match ((let _160_1053 = (unparen last_arg)
in _160_1053.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.Attributes (ts) -> begin
((ts), ((FStar_List.rev args_rev)))
end
| _65_2699 -> begin
...
in (match (_65_2704) with
| (cattributes, args) -> begin
(let _160_1055 = (desugar_args env args)
in (let _160_1054 = (desugar_attributes env cattributes)
in ((ed), (_160_1055), (_160_1054))))
end)))
end))
in (match (_65_2708) with
...
let sub = (fun _65_2714 -> (match (_65_2714) with
| (_65_2712, x) -> begin
(

let _65_2717 = (FStar_Syntax_Subst.open_term ed.FStar_Syntax_Syntax.binders x)
in (match (_65_2717) with
| (edb, x) -> begin
(

let _65_2718 = if ((FStar_List.length args) <> (FStar_List.length edb)) then begin
...
| FStar_Parser_AST.Fsdoc (_65_2740) -> begin
((env), ([]))
end
...
let tcs = (FStar_List.map (fun _65_2758 -> (match (_65_2758) with
| (x, _65_2757) -> begin
x
end)) tcs)
...
| FStar_Syntax_Syntax.Tm_let (lbs, _65_2767) -> begin
(
...
| (_65_2775)::_65_2773 -> begin
(FStar_List.map (trans_qual None) quals)
end
| _65_2778 -> begin
(FStar_All.pipe_right (Prims.snd lbs) (FStar_List.collect (fun _65_27 -> (match (_65_27) with
| {FStar_Syntax_Syntax.lbname = FStar_Util.Inl (_65_2789); FStar_Syntax_Syntax.lbunivs = _65_2787; FStar_Syntax_Syntax.lbtyp = _65_2785; FStar_Syntax_Syntax.lbeff = _65_2783; FStar_Syntax_Syntax.lbdef = _65_2781} -> begin
[]
end
| {FStar_Syntax_Syntax.lbname = FStar_Util.Inr (fv); FStar_Syntax_Syntax.lbunivs = _65_2799; FStar_Syntax_Syntax.lbtyp = _65_2797; FStar_Syntax_Syntax.lbeff = _65_2795; FStar_Syntax_Syntax.lbdef = _65_2793} -> begin
(FStar_Parser_Env.lookup_letbinding_quals env fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
end))))
end)
in (

let quals = if (FStar_All.pipe_right lets (FStar_Util.for_some (fun _65_2807 -> (match (_65_2807) with
| (_65_2805, t) -> begin
...
let _65_2813 = fv
in {FStar_Syntax_Syntax.fv_name = _65_2813.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_abstract (fv.FStar_Syntax_Syntax.fv_delta); FStar_Syntax_Syntax.fv_qual = _65_2813.FStar_Syntax_Syntax.fv_qual})); FStar_Syntax_Syntax.lbunivs = _65_2811.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _65_2811.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _65_2811.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _65_2811.FStar_Syntax_Syntax.lbdef})))))
...
let _65_2847 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) FStar_Syntax_Const.exn_lid)
...
let _65_2876 = (desugar_binders env binders)
in (match (_65_2876) with
| (env_k, binders) -> begin
(
...
let _65_2940 = (match (l.FStar_Parser_AST.lift_op) with
...
let desugar_decls : FStar_Parser_Env.env  ->  FStar_Parser_AST.decl Prims.list  ->  (FStar_Parser_Env.env * FStar_Syntax_Syntax.sigelts) = (fun env decls -> (FStar_List.fold_left (fun _65_2946 d -> (match (_65_2946) with
| (env, sigelts) -> begin
(

let _65_2950 = (desugar_decl env d)
...
in (match (_65_2973) with
| ((env, pop_when_done), mname, decls, intf) -> begin
(

let _65_2976 = (desugar_decls env decls)
...
| FStar_Parser_AST.Interface (mname, _65_2987, _65_2989) -> begin
...
let _65_2997 = (desugar_modul_common curmod env m)
in (match (_65_2997) with
| (x, y, _65_2996) -> begin
((x), (y))
end))))
...
let _65_3003 = (desugar_modul_common None env m)
...
let _65_3005 = if (FStar_Options.dump_module modul.FStar_Syntax_Syntax.name.FStar_Ident.str) then begin
...
let _65_3018 = (FStar_List.fold_left (fun _65_3011 m -> (match (_65_3011) with
| (env, mods) -> begin
(

let _65_3015 = (desugar_modul env m)
...
let _65_3023 = (FStar_Parser_Env.prepare_module_or_interface false false en m.FStar_Syntax_Syntax.name)
...
let _65_3024 = en
in {FStar_Parser_Env.curmodule = Some (m.FStar_Syntax_Syntax.name); FStar_Parser_Env.curmonad = _65_3024.FStar_Parser_Env.curmonad; FStar_Parser_Env.modules = _65_3024.FStar_Parser_Env.modules; FStar_Parser_Env.scope_mods = _65_3024.FStar_Parser_Env.scope_mods; FStar_Parser_Env.sigaccum = _65_3024.FStar_Parser_Env.sigaccum; FStar_Parser_Env.sigmap = _65_3024.FStar_Parser_Env.sigmap; FStar_Parser_Env.default_result_effect = _65_3024.FStar_Parser_Env.default_result_effect; FStar_Parser_Env.iface = _65_3024.FStar_Parser_Env.iface; FStar_Parser_Env.admitted_iface = _65_3024.FStar_Parser_Env.admitted_iface; FStar_Parser_Env.expect_typ = _65_3024.FStar_Parser_Env.expect_typ}) m.FStar_Syntax_Syntax.exports)
in (
