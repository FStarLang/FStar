           ...
           | (m1,env') ->
               let uu___3 =
                 ...
                 FStar_Syntax_DsEnv.prepare_module_or_interface false false
                   env' uu___4 FStar_Syntax_DsEnv.default_mii
                  in
...
let (init_once : unit -> unit) =
  fun uu___  ->
    ...
    (let uu___2 =
       ...
       let uu___4 = FStar_Syntax_DsEnv.empty_env FStar_Parser_Dep.empty_deps
          in
     ...
     | (dsenv,prims_mod) ->
         ...
         let uu___3 = FStar_TypeChecker_Tc.check_module env1 prims_mod false
            in
         (match uu___3 with
          | (_prims_mod,env2) ->
              let env3 =
                 ...
                 (fun uu___2  ->
                    ...
                    | () ->
                        let uu___3 =
                          ...
                          FStar_Universal.tc_one_fragment uu___4 tcenv frag
                           in
                        (match uu___3 with
                         | (test_mod',tcenv') ->
