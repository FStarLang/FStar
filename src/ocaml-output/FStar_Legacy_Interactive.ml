              ...
              ((let uu____889 =
                  (let uu____890 = FStar_Parser_Dep.is_interface intf in
                   Prims.op_Negation uu____890) ||
                    (let uu____891 = FStar_Parser_Dep.is_implementation impl in
                     Prims.op_Negation uu____891) in
                if uu____889
                then
                  let uu____892 =
                    FStar_Util.format2
            ...
            fun ts  ->
              ...
              | Completions search_term ->
                    ...
                    | (hs::ts1,hc::tc) ->
                        ...
                        then
                          (match ts1 with
                           ...
                           | uu____1680 ->
                               let uu____1682 = measure_anchored_match ts1 tc in
                  ...
                  let rec locate_match needle candidate =
                    let uu____1737 = measure_anchored_match needle candidate in
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____1884 with
                         | (stripped_ns,shortened) ->
                             ...
                             (uu____1899, uu____1900, uu____1901, match_len)) in
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x  ->
                                ...
                                prepare_candidate uu____2148)) in
                  ((let uu____2154 =
