...
let push : (FStar_ToSyntax_Env.env * FStar_TypeChecker_Env.env)  ->  Prims.bool  ->  Prims.bool  ->  Prims.string  ->  (FStar_ToSyntax_Env.env * FStar_TypeChecker_Env.env) = (fun uu____361 lax1 restore_cmd_line_options1 msg -> (match (uu____361) with
| (dsenv, env) -> begin
(

let env1 = (

let uu___221_376 = env
in {FStar_TypeChecker_Env.solver = uu___221_376.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___221_376.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___221_376.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___221_376.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___221_376.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___221_376.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___221_376.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___221_376.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___221_376.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___221_376.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___221_376.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___221_376.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___221_376.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___221_376.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___221_376.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___221_376.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___221_376.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___221_376.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax1; FStar_TypeChecker_Env.lax_universes = uu___221_376.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.failhard = uu___221_376.FStar_TypeChecker_Env.failhard; FStar_TypeChecker_Env.type_of = uu___221_376.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___221_376.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___221_376.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___221_376.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___221_376.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___221_376.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___221_376.FStar_TypeChecker_Env.is_native_tactic; FStar_TypeChecker_Env.identifier_info = uu___221_376.FStar_TypeChecker_Env.identifier_info})
in (
...
let uu____384 = (FStar_Options.restore_cmd_line_options false)
in (FStar_All.pipe_right uu____384 FStar_Pervasives.ignore))
end
| uu____385 -> begin
()
end);
...
let mark : (FStar_ToSyntax_Env.env * FStar_TypeChecker_Env.env)  ->  (FStar_ToSyntax_Env.env * FStar_TypeChecker_Env.env) = (fun uu____397 -> (match (uu____397) with
| (dsenv, env) -> begin
(
...
let reset_mark : 'Auu____415 . ('Auu____415 * FStar_TypeChecker_Env.env)  ->  (FStar_ToSyntax_Env.env * FStar_TypeChecker_Env.env) = (fun uu____427 -> (match (uu____427) with
| (uu____432, env) -> begin
(
...
let cleanup : 'Auu____441 . ('Auu____441 * FStar_TypeChecker_Env.env)  ->  Prims.unit = (fun uu____449 -> (match (uu____449) with
| (dsenv, env) -> begin
(FStar_TypeChecker_Env.cleanup_interactive env)
end))


let commit_mark : (FStar_ToSyntax_Env.env * FStar_TypeChecker_Env.env)  ->  (FStar_ToSyntax_Env.env * FStar_TypeChecker_Env.env) = (fun uu____467 -> (match (uu____467) with
| (dsenv, env) -> begin
(
...
let uu____577 = (FStar_Universal.tc_one_fragment curmod dsenv env frag)
...
let uu____630 = (FStar_Errors.get_err_count ())
in ((m), (((dsenv1), (env1))), (uu____630)))
...
let uu____716 = (FStar_Options.trace_error ())
in (not (uu____716))) -> begin
((
...
in ((msg), (uu____730)))
in (uu____725)::[])
in (FStar_TypeChecker_Err.add_errors env uu____718));
FStar_Pervasives_Native.None;
)
end
end))
...
let report_fail : Prims.unit  ->  Prims.unit = (fun uu____754 -> ((

let uu____756 = (FStar_Errors.report_all ())
in (FStar_All.pipe_right uu____756 FStar_Pervasives.ignore));
(FStar_Errors.clear ());
))
...
let uu____1227 = (FStar_Util.new_string_builder ())
in (

let uu____1228 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in (

let uu____1235 = (FStar_Util.mk_ref [])
in (

let uu____1242 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in {chunk = uu____1227; stdin = uu____1228; buffer = uu____1235; log = uu____1242}))))


let rec read_chunk : Prims.unit  ->  input_chunks = (fun uu____1294 -> (
...
let uu____1299 = (FStar_Options.debug_any ())
...
let uu____1303 = (FStar_ST.op_Bang s.log)
...
let uu____1350 = (FStar_ST.op_Bang s.stdin)
...
let uu____1393 = (FStar_Util.read_line stdin)
...
let uu____1425 = (FStar_Util.substring_from l (FStar_String.length "#push"))
in (FStar_Util.trim_string uu____1425))
in (
...
let uu____1441 = (FStar_Util.int_of_string l1)
in (

let uu____1442 = (FStar_Util.int_of_string c)
in ((true), (uu____1441), (uu____1442))))
end
| (l1)::(c)::[] -> begin
(

let uu____1445 = (FStar_Util.int_of_string l1)
in (

let uu____1446 = (FStar_Util.int_of_string c)
in ((false), (uu____1445), (uu____1446))))
end
| uu____1447 -> begin
...
| (uu____1452)::(symbol)::[] -> begin
((FStar_Util.clear_string_builder s.chunk);
Info (((symbol), (true), (FStar_Pervasives_Native.None)));
)
end
| (uu____1469)::(symbol)::(file)::(row)::(col)::[] -> begin
((FStar_Util.clear_string_builder s.chunk);
(
...
let uu____1506 = (FStar_Util.int_of_string row)
in (

let uu____1507 = (FStar_Util.int_of_string col)
in ((file), (uu____1506), (uu____1507))))
in FStar_Pervasives_Native.Some (uu____1499))
in ((symbol), (false), (uu____1490)))
in Info (uu____1475));
)
end
| uu____1522 -> begin
...
let shift_chunk : Prims.unit  ->  input_chunks = (fun uu____1541 -> (

let s = the_interactive_state
in (

let uu____1543 = (FStar_ST.op_Bang s.buffer)
...
let fill_buffer : Prims.unit  ->  Prims.unit = (fun uu____1590 -> (
...
let uu____1595 = (FStar_ST.op_Bang s.buffer)
in (

let uu____1616 = (

let uu____1619 = (read_chunk ())
in (uu____1619)::[])
in (FStar_List.append uu____1595 uu____1616)))
in (FStar_ST.op_Colon_Equals s.buffer uu____1592))))
...
let uu____1653 = (FStar_List.partition (fun x -> (

let uu____1666 = (FStar_Parser_Dep.lowercase_module_name x)
in (

let uu____1667 = (FStar_Parser_Dep.lowercase_module_name filename)
in (uu____1666 <> uu____1667)))) deps)
...
let uu____1697 = (FStar_Parser_Dep.is_interface intf)
in (not (uu____1697))) || (

let uu____1699 = (FStar_Parser_Dep.is_implementation impl)
in (not (uu____1699))))
in (match (uu____1694) with
| true -> begin
(

let uu____1700 = (FStar_Util.format2 "Found %s and %s but not an interface + implementation" intf impl)
in (FStar_Util.print_warning uu____1700))
end
| uu____1701 -> begin
()
end));
...
let uu____1707 = (FStar_Util.format1 "Unexpected: ended up with %s" (FStar_String.concat " " same_name))
in (FStar_Util.print_warning uu____1707));
FStar_Pervasives_Native.None;
)
end)
in ((deps1), (maybe_intf)))
...
let uu____1781 = (FStar_Options.lax ())
in (push env uu____1781 true "typecheck_modul"))
in (

let uu____1782 = (tc_one_file remaining env1)
...
let uu____1846 = (FStar_Util.get_file_last_modification_time intf1)
in FStar_Pervasives_Native.Some (uu____1846))
end
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end)
...
| (uu____2157)::ts3 -> begin
((pop env1 "");
(

let uu____2198 = (

let uu____2213 = (FStar_List.hd stack)
in (

let uu____2222 = (FStar_List.tl stack)
in ((uu____2213), (uu____2222))))
in (match (uu____2198) with
| ((env2, uu____2248), stack1) -> begin
...
let uu____2312 = ts_elt
in (match (uu____2312) with
| (intf, impl, intf_t, impl_t) -> begin
(

let uu____2343 = (match_dep depnames intf impl)
in (match (uu____2343) with
| (b, depnames') -> begin
(

let uu____2362 = ((not (b)) || (is_stale intf impl intf_t impl_t))
...
let uu____2398 = (FStar_List.hd st)
in (

let uu____2407 = (FStar_List.tl st)
in ((uu____2398), (uu____2407))))
...
let uu____2484 = (deps_of_our_file filename)
in (match (uu____2484) with
| (filenames, uu____2500) -> begin
...
let uu____2581 = (FStar_Range.string_of_range range)
in (

let uu____2582 = (FStar_TypeChecker_Normalize.term_to_string env typ)
in (

let uu____2583 = (match (doc1) with
...
in (FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2581 name uu____2582 uu____2583)))))
...
| FStar_Pervasives_Native.Some (uu____2715) -> begin
info_at_pos_opt
end
| FStar_Pervasives_Native.None -> begin
(match ((symbol = "")) with
...
let uu____2770 = (FStar_List.map FStar_Ident.id_of_text (FStar_Util.split symbol "."))
in (FStar_Ident.lid_of_ids uu____2770))
in (
...
let uu____2775 = (FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv lid)
...
let uu____2779 = (FStar_TypeChecker_Env.try_lookup_lid (FStar_Pervasives_Native.snd env) lid1)
in (FStar_All.pipe_right uu____2779 (FStar_Util.map_option (fun uu____2834 -> (match (uu____2834) with
| ((uu____2853, typ), r) -> begin
...
let uu____2896 = (match (name_or_lid) with
...
let uu____2913 = (FStar_Ident.string_of_lid lid)
in (

let uu____2914 = (

let uu____2917 = (FStar_ToSyntax_Env.try_lookup_doc dsenv lid)
in (FStar_All.pipe_right uu____2917 (FStar_Util.map_option FStar_Pervasives_Native.fst)))
in ((uu____2913), (uu____2914))))
end)
in (match (uu____2896) with
| (name, doc1) -> begin
(

let uu____2948 = (format_info (FStar_Pervasives_Native.snd env) name typ rng doc1)
...
let uu____3053 = (measure_anchored_match ts1 tc)
in (FStar_All.pipe_right uu____3053 (FStar_Util.map_option (fun uu____3093 -> (match (uu____3093) with
| (matched, len) -> begin
...
let uu____3148 = (measure_anchored_match needle candidate)
...
let uu____3227 = (locate_match needle tc)
in (FStar_All.pipe_right uu____3227 (FStar_Util.map_option (fun uu____3288 -> (match (uu____3288) with
...
let uu____3332 = (FStar_List.map FStar_Ident.text_of_id ids)
in (FStar_Util.concat_l "." uu____3332)))
in (
...
let shorten_namespace = (fun uu____3379 -> (match (uu____3379) with
...
let uu____3414 = (FStar_ToSyntax_Env.shorten_module_path (FStar_Pervasives_Native.fst env) prefix1 naked_match)
in (match (uu____3414) with
| (stripped_ns, shortened) -> begin
(

let uu____3441 = (str_of_ids shortened)
in (

let uu____3442 = (str_of_ids matched)
in (

let uu____3443 = (str_of_ids stripped_ns)
in ((uu____3441), (uu____3442), (uu____3443), (match_len)))))
end)))
end))
in (

let prepare_candidate = (fun uu____3461 -> (match (uu____3461) with
...
let uu____3590 = (FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv lid)
in (FStar_Option.map (fun fqn -> (

let uu____3606 = (

let uu____3609 = (FStar_List.map FStar_Ident.id_of_text orig_ns)
in (FStar_List.append uu____3609 ((fqn.FStar_Ident.ident)::[])))
in (([]), (uu____3606), (matched_length)))) uu____3590)))
end
| uu____3616 -> begin
FStar_Pervasives_Native.None
end))))))))
...
let case_b_find_matches_in_env = (fun uu____3642 -> (

let uu____3655 = env
in (match (uu____3655) with
| (dsenv, uu____3669) -> begin
(

let matches = (FStar_List.filter_map (match_lident_against needle) all_lidents_in_env)
in (FStar_All.pipe_right matches (FStar_List.filter (fun uu____3732 -> (match (uu____3732) with
| (ns, id, uu____3745) -> begin
(

let uu____3754 = (

let uu____3757 = (FStar_Ident.lid_of_ids id)
in (FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv uu____3757))
...
let uu____3759 = (FStar_Ident.lid_of_ids (FStar_List.append ns id))
in (FStar_Ident.lid_equals l uu____3759))
end))
end)))))
end)))
in (

let uu____3760 = (FStar_Util.prefix needle)
...
let uu____3810 = (FStar_ToSyntax_Env.resolve_module_name (FStar_Pervasives_Native.fst env) l true)
...
let uu____3875 = (shorten_namespace x)
in (prepare_candidate uu____3875))))))
end))))
in ((

let uu____3885 = (FStar_Util.sort_with (fun uu____3908 uu____3909 -> (match (((uu____3908), (uu____3909))) with
| ((cd1, ns1, uu____3936), (cd2, ns2, uu____3939)) -> begin
...
in (FStar_List.iter (fun uu____3964 -> (match (uu____3964) with
| (candidate, ns, match_len) -> begin
(

let uu____3974 = (FStar_Util.string_of_int match_len)
in (FStar_Util.print3 "%s %s %s \n" uu____3974 ns candidate))
end)) uu____3885));
...
let uu____3978 = (match (stack) with
| [] -> begin
...
let uu____4092 = (match (((FStar_List.length stack) = (FStar_List.length ts))) with
| true -> begin
(

let uu____4129 = (update_deps filename curmod stack env ts)
in ((true), (uu____4129)))
end
| uu____4142 -> begin
((false), (((stack), (env), (ts))))
...
let uu____4280 = (FStar_Options.codegen ())
in (FStar_Option.isSome uu____4280))
...
let uu____4284 = (deps_of_our_file filename)
...
let uu____4308 = (tc_deps FStar_Pervasives_Native.None [] env filenames [])
...
let uu____4335 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (

let uu____4336 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (FStar_Range.mk_range "<input>" uu____4335 uu____4336)))
in (

let env2 = (

let uu____4342 = (FStar_TypeChecker_Env.set_range (FStar_Pervasives_Native.snd env1) initial_range)
in (((FStar_Pervasives_Native.fst env1)), (uu____4342)))
in (
...
let uu____4353 = ((FStar_Options.record_hints ()) || (FStar_Options.use_hints ()))
...
let uu____4355 = (FStar_Options.file_list ())
in (FStar_List.hd uu____4355))
in (FStar_SMTEncoding_Solver.with_hints_db uu____4354 (fun uu____4359 -> (go (((Prims.parse_int "1")), ((Prims.parse_int "0"))) filename stack FStar_Pervasives_Native.None env3 ts))))
end
| uu____4360 -> begin
