    ...
    fun lax1  ->
      fun restore_cmd_line_options1  ->
        fun msg  ->
          ...
          | (dsenv,env) ->
              let env1 =
                let uu___230_364 = env in
                {
                  FStar_TypeChecker_Env.solver =
                    (uu___230_364.FStar_TypeChecker_Env.solver);
                  FStar_TypeChecker_Env.range =
                    (uu___230_364.FStar_TypeChecker_Env.range);
                  FStar_TypeChecker_Env.curmodule =
                    (uu___230_364.FStar_TypeChecker_Env.curmodule);
                  FStar_TypeChecker_Env.gamma =
                    (uu___230_364.FStar_TypeChecker_Env.gamma);
                  FStar_TypeChecker_Env.gamma_cache =
                    (uu___230_364.FStar_TypeChecker_Env.gamma_cache);
                  FStar_TypeChecker_Env.modules =
                    (uu___230_364.FStar_TypeChecker_Env.modules);
                  FStar_TypeChecker_Env.expected_typ =
                    (uu___230_364.FStar_TypeChecker_Env.expected_typ);
                  FStar_TypeChecker_Env.sigtab =
                    (uu___230_364.FStar_TypeChecker_Env.sigtab);
                  FStar_TypeChecker_Env.is_pattern =
                    (uu___230_364.FStar_TypeChecker_Env.is_pattern);
                  FStar_TypeChecker_Env.instantiate_imp =
                    (uu___230_364.FStar_TypeChecker_Env.instantiate_imp);
                  FStar_TypeChecker_Env.effects =
                    (uu___230_364.FStar_TypeChecker_Env.effects);
                  FStar_TypeChecker_Env.generalize =
                    (uu___230_364.FStar_TypeChecker_Env.generalize);
                  FStar_TypeChecker_Env.letrecs =
                    (uu___230_364.FStar_TypeChecker_Env.letrecs);
                  FStar_TypeChecker_Env.top_level =
                    (uu___230_364.FStar_TypeChecker_Env.top_level);
                  FStar_TypeChecker_Env.check_uvars =
                    (uu___230_364.FStar_TypeChecker_Env.check_uvars);
                  FStar_TypeChecker_Env.use_eq =
                    (uu___230_364.FStar_TypeChecker_Env.use_eq);
                  FStar_TypeChecker_Env.is_iface =
                    (uu___230_364.FStar_TypeChecker_Env.is_iface);
                  FStar_TypeChecker_Env.admit =
                    (uu___230_364.FStar_TypeChecker_Env.admit);
                  FStar_TypeChecker_Env.lax = lax1;
                  FStar_TypeChecker_Env.lax_universes =
                    (uu___230_364.FStar_TypeChecker_Env.lax_universes);
                  FStar_TypeChecker_Env.failhard =
                    (uu___230_364.FStar_TypeChecker_Env.failhard);
                  FStar_TypeChecker_Env.nosynth =
                    (uu___230_364.FStar_TypeChecker_Env.nosynth);
                  FStar_TypeChecker_Env.type_of =
                    (uu___230_364.FStar_TypeChecker_Env.type_of);
                  FStar_TypeChecker_Env.universe_of =
                    (uu___230_364.FStar_TypeChecker_Env.universe_of);
                  FStar_TypeChecker_Env.use_bv_sorts =
                    (uu___230_364.FStar_TypeChecker_Env.use_bv_sorts);
                  FStar_TypeChecker_Env.qname_and_index =
                    (uu___230_364.FStar_TypeChecker_Env.qname_and_index);
                  FStar_TypeChecker_Env.proof_ns =
                    (uu___230_364.FStar_TypeChecker_Env.proof_ns);
                  FStar_TypeChecker_Env.synth =
                    (uu___230_364.FStar_TypeChecker_Env.synth);
                  FStar_TypeChecker_Env.is_native_tactic =
                    (uu___230_364.FStar_TypeChecker_Env.is_native_tactic);
                  FStar_TypeChecker_Env.identifier_info =
                    (uu___230_364.FStar_TypeChecker_Env.identifier_info)
                } in
...
let rec read_chunk: Prims.unit -> input_chunks =
  fun uu____1207  ->
    ...
    let log1 =
      ...
      else (fun uu____1261  -> ()) in
    let stdin =
      let uu____1263 = FStar_ST.op_Bang s.stdin in
      ...
      | FStar_Pervasives_Native.None  ->
          ...
          (FStar_ST.op_Colon_Equals s.stdin (FStar_Pervasives_Native.Some i);
           i) in
    let line =
      let uu____1306 = FStar_Util.read_line stdin in
    ...
    (let l = FStar_Util.trim_string line in
     ...
     then
       let responses =
         ...
         | uu____1321::ok::fail4::[] -> (ok, fail4)
         | uu____1324 -> ("ok", "fail") in
         ...
         then
           (FStar_Util.clear_string_builder s.chunk;
            (let lc_lax =
               ...
               FStar_Util.trim_string uu____1338 in
             let lc =
               match FStar_Util.split lc_lax " " with
               | l1::c::"#lax"::[] ->
                   let uu____1354 = FStar_Util.int_of_string l1 in
                   let uu____1355 = FStar_Util.int_of_string c in
                   (true, uu____1354, uu____1355)
               | l1::c::[] ->
                   let uu____1358 = FStar_Util.int_of_string l1 in
                   let uu____1359 = FStar_Util.int_of_string c in
                   (false, uu____1358, uu____1359)
               | uu____1360 ->
           ...
           then
             (match FStar_Util.split l " " with
              ...
              | uu____1382::symbol::file::row::col::[] ->
                  (FStar_Util.clear_string_builder s.chunk;
                   (let uu____1388 =
                      let uu____1403 =
                        let uu____1412 =
                          let uu____1419 = FStar_Util.int_of_string row in
                          let uu____1420 = FStar_Util.int_of_string col in
                          (file, uu____1419, uu____1420) in
                        FStar_Pervasives_Native.Some uu____1412 in
                      (symbol, false, uu____1403) in
                    Info uu____1388))
              | uu____1435 ->
...
let shift_chunk: Prims.unit -> input_chunks =
  fun uu____1454  ->
    let s = the_interactive_state in
    let uu____1456 = FStar_ST.op_Bang s.buffer in
...
let fill_buffer: Prims.unit -> Prims.unit =
  fun uu____1503  ->
    let s = the_interactive_state in
    let uu____1505 =
      let uu____1508 = FStar_ST.op_Bang s.buffer in
      let uu____1529 = let uu____1532 = read_chunk () in [uu____1532] in
      FStar_List.append uu____1508 uu____1529 in
    FStar_ST.op_Colon_Equals s.buffer uu____1505
  ...
  fun filename  ->
    ...
    let uu____1566 =
      FStar_List.partition
        (fun x  ->
           let uu____1579 = FStar_Parser_Dep.lowercase_module_name x in
           let uu____1580 = FStar_Parser_Dep.lowercase_module_name filename in
           uu____1579 <> uu____1580) deps in
    ...
    | (deps1,same_name) ->
        let maybe_intf =
          ...
          | intf::impl::[] ->
              ((let uu____1607 =
                  (let uu____1610 = FStar_Parser_Dep.is_interface intf in
                   Prims.op_Negation uu____1610) ||
                    (let uu____1612 = FStar_Parser_Dep.is_implementation impl in
                ...
                then
                  let uu____1613 =
                    FStar_Util.format2
                      ...
                      intf impl in
                  FStar_Util.print_warning uu____1613
                else ());
          ...
          | uu____1616 ->
              ((let uu____1620 =
                ...
                FStar_Util.print_warning uu____1620);
                         ...
                         | FStar_Pervasives_Native.Some intf1 ->
                             let uu____1759 =
                               FStar_Util.get_file_last_modification_time
                                 intf1 in
                             FStar_Pervasives_Native.Some uu____1759
                         | FStar_Pervasives_Native.None  ->
                             FStar_Pervasives_Native.None in
                       let impl_t =
            ...
            let rec iterate depnames st env' ts1 good_stack good_ts =
              ...
              let rec pop_tc_and_stack env1 stack ts2 =
                ...
                | uu____2070::ts3 ->
                    (pop env1 "";
                     (let uu____2111 =
                        let uu____2126 = FStar_List.hd stack in
                        let uu____2135 = FStar_List.tl stack in
                        (uu____2126, uu____2135) in
                      match uu____2111 with
                      | ((env2,uu____2161),stack1) ->
                          pop_tc_and_stack env2 stack1 ts3)) in
              match ts1 with
              | ts_elt::ts' ->
                  let uu____2225 = ts_elt in
                  (match uu____2225 with
                   | (intf,impl,intf_t,impl_t) ->
                       let uu____2256 = match_dep depnames intf impl in
  ...
  fun env  ->
    fun name  ->
      fun typ  ->
        fun range  ->
          fun doc1  ->
            let uu____2494 = FStar_Range.string_of_range range in
            let uu____2495 =
            ...
            let uu____2496 =
              ...
              | FStar_Pervasives_Native.None  -> "" in
            FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2494 name
    ...
    fun filename  ->
      fun stack  ->
        fun curmod  ->
          fun env  ->
            fun ts  ->
              let uu____2530 = shift_chunk () in
              match uu____2530 with
              | Info (symbol,fqn_only,pos_opt) ->
                  let uu____2550 = env in
                         ...
                         | FStar_Pervasives_Native.None  ->
                             ...
                             then FStar_Pervasives_Native.None
                               ...
                               (let lid =
                                  ...
                                  FStar_Ident.lid_of_ids uu____2683 in
                                let lid1 =
                                  if fqn_only
                                  then lid
                                  else
              ...
              | Completions search_term ->
                    ...
                    | (hs::ts1,hc::tc) ->
                        ...
                        then
                          (match ts1 with
                           ...
                           | uu____2963 ->
                               let uu____2966 = measure_anchored_match ts1 tc in
                               FStar_All.pipe_right uu____2966
                                 (FStar_Util.map_option
                                    (fun uu____3006  ->
                  ...
                  let rec locate_match needle candidate =
                    let uu____3061 = measure_anchored_match needle candidate in
                    ...
                    | FStar_Pervasives_Native.None  ->
                        (match candidate with
                         | [] -> FStar_Pervasives_Native.None
                         | hc::tc ->
                             let uu____3140 = locate_match needle tc in
                             FStar_All.pipe_right uu____3140
                               (FStar_Util.map_option
                                  (fun uu____3201  ->
                    ...
                    | (prefix1,matched,match_len) ->
                        ...
                        (match uu____3327 with
                         | (stripped_ns,shortened) ->
                             let uu____3354 = str_of_ids shortened in
                             let uu____3355 = str_of_ids matched in
                             let uu____3356 = str_of_ids stripped_ns in
                             (uu____3354, uu____3355, uu____3356, match_len)) in
                  let prepare_candidate uu____3374 =
                  ...
                  let matches =
                    ...
                    let case_b_find_matches_in_env uu____3555 =
                      let uu____3568 = env in
                                      ...
                                      (match uu____3667 with
                                       ...
                                       | FStar_Pervasives_Native.Some l ->
                                           ...
                                           FStar_Ident.lid_equals l
                                             uu____3672))) in
                    let uu____3673 = FStar_Util.prefix needle in
                    ...
                    | (ns,id) ->
                        ...
                        FStar_All.pipe_right matched_ids
                          (FStar_List.map
                             (fun x  ->
                                let uu____3788 = shorten_namespace x in
                                prepare_candidate uu____3788)) in
                  ((let uu____3798 =
                      FStar_Util.sort_with
                        (fun uu____3821  ->
                           fun uu____3822  ->
                             match (uu____3821, uu____3822) with
                             | ((cd1,ns1,uu____3849),(cd2,ns2,uu____3852)) ->
              ...
              | Code (text1,(ok,fail4)) ->
                  ...
                  (match res with
                   ...
                   | uu____4157 -> fail5 curmod env)
let interactive_mode: Prims.string -> Prims.unit =
  fun filename  ->
    (let uu____4177 =
       let uu____4178 = FStar_Options.codegen () in
       FStar_Option.isSome uu____4178 in
     if uu____4177
     then
       FStar_Util.print_warning
         "code-generation is not supported in interactive mode, ignoring the codegen flag"
     else ());
    (let uu____4182 = deps_of_our_file filename in
          ...
          | (stack,env1,ts) ->
              let initial_range =
                ...
                let uu____4234 =
                  FStar_Range.mk_pos (Prims.parse_int "1")
                    (Prims.parse_int "0") in
                FStar_Range.mk_range "<input>" uu____4233 uu____4234 in
              let env2 =
                let uu____4240 =
                  FStar_TypeChecker_Env.set_range
                    (FStar_Pervasives_Native.snd env1) initial_range in
                ((FStar_Pervasives_Native.fst env1), uu____4240) in
              let env3 =
              ...
              then
                let uu____4252 =
                  let uu____4253 = FStar_Options.file_list () in
                  FStar_List.hd uu____4253 in
                FStar_SMTEncoding_Solver.with_hints_db uu____4252
                  (fun uu____4257  ->
