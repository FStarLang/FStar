...
let uu___213_376 = env
in {FStar_TypeChecker_Env.solver = uu___213_376.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___213_376.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___213_376.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___213_376.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___213_376.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___213_376.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = uu___213_376.FStar_TypeChecker_Env.expected_typ; FStar_TypeChecker_Env.sigtab = uu___213_376.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___213_376.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___213_376.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___213_376.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___213_376.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___213_376.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___213_376.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___213_376.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___213_376.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___213_376.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___213_376.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = lax1; FStar_TypeChecker_Env.lax_universes = uu___213_376.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___213_376.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___213_376.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = uu___213_376.FStar_TypeChecker_Env.use_bv_sorts; FStar_TypeChecker_Env.qname_and_index = uu___213_376.FStar_TypeChecker_Env.qname_and_index; FStar_TypeChecker_Env.proof_ns = uu___213_376.FStar_TypeChecker_Env.proof_ns; FStar_TypeChecker_Env.synth = uu___213_376.FStar_TypeChecker_Env.synth; FStar_TypeChecker_Env.is_native_tactic = uu___213_376.FStar_TypeChecker_Env.is_native_tactic})
in (
...
let uu____1137 = (FStar_Util.new_string_builder ())
in (

let uu____1138 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in (

let uu____1145 = (FStar_Util.mk_ref [])
in (

let uu____1152 = (FStar_Util.mk_ref FStar_Pervasives_Native.None)
in {chunk = uu____1137; stdin = uu____1138; buffer = uu____1145; log = uu____1152}))))


let rec read_chunk : Prims.unit  ->  input_chunks = (fun uu____1168 -> (
...
let uu____1177 = (FStar_ST.read s.log)
...
let uu____1192 = (FStar_ST.read s.stdin)
...
let uu____1353 = (FStar_ST.read s.buffer)
...
let fill_buffer : Prims.unit  ->  Prims.unit = (fun uu____1368 -> (
...
let uu____1373 = (FStar_ST.read s.buffer)
in (

let uu____1378 = (

let uu____1381 = (read_chunk ())
in (uu____1381)::[])
in (FStar_List.append uu____1373 uu____1378)))
in (FStar_ST.write s.buffer uu____1370))))
...
let uu____1399 = (FStar_List.partition (fun x -> (

let uu____1412 = (FStar_Parser_Dep.lowercase_module_name x)
in (

let uu____1413 = (FStar_Parser_Dep.lowercase_module_name filename)
in (uu____1412 <> uu____1413)))) deps)
...
let uu____1443 = (FStar_Parser_Dep.is_interface intf)
in (not (uu____1443))) || (
...
let uu____1446 = (FStar_Util.format2 "Found %s and %s but not an interface + implementation" intf impl)
in (FStar_Util.print_warning uu____1446))
end
| uu____1447 -> begin
()
end));
...
let uu____1453 = (FStar_Util.format1 "Unexpected: ended up with %s" (FStar_String.concat " " same_name))
in (FStar_Util.print_warning uu____1453));
FStar_Pervasives_Native.None;
)
end)
in ((deps1), (maybe_intf)))
...
let uu____1527 = (FStar_Options.lax ())
in (push env uu____1527 true "typecheck_modul"))
in (

let uu____1528 = (tc_one_file remaining env1)
...
let uu____1592 = (FStar_Util.get_file_last_modification_time intf1)
in FStar_Pervasives_Native.Some (uu____1592))
end
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end)
...
| (uu____1903)::ts3 -> begin
((pop env1 "");
(

let uu____1944 = (

let uu____1959 = (FStar_List.hd stack)
in (

let uu____1968 = (FStar_List.tl stack)
in ((uu____1959), (uu____1968))))
in (match (uu____1944) with
| ((env2, uu____1994), stack1) -> begin
...
let uu____2058 = ts_elt
in (match (uu____2058) with
| (intf, impl, intf_t, impl_t) -> begin
(

let uu____2089 = (match_dep depnames intf impl)
in (match (uu____2089) with
| (b, depnames') -> begin
(

let uu____2108 = ((not (b)) || (is_stale intf impl intf_t impl_t))
...
let uu____2144 = (FStar_List.hd st)
in (

let uu____2153 = (FStar_List.tl st)
in ((uu____2144), (uu____2153))))
...
let uu____2230 = (deps_of_our_file filename)
in (match (uu____2230) with
| (filenames, uu____2246) -> begin
...
let uu____2327 = (FStar_Range.string_of_range range)
in (

let uu____2328 = (FStar_TypeChecker_Normalize.term_to_string env typ)
in (

let uu____2329 = (match (doc1) with
...
in (FStar_Util.format4 "(defined at %s) %s: %s%s" uu____2327 name uu____2328 uu____2329)))))
...
| FStar_Pervasives_Native.Some (uu____2461) -> begin
info_at_pos_opt
end
| FStar_Pervasives_Native.None -> begin
(match ((symbol = "")) with
...
let uu____2516 = (FStar_List.map FStar_Ident.id_of_text (FStar_Util.split symbol "."))
in (FStar_Ident.lid_of_ids uu____2516))
in (
...
let uu____2521 = (FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv lid)
...
let uu____2525 = (FStar_TypeChecker_Env.try_lookup_lid (FStar_Pervasives_Native.snd env) lid1)
in (FStar_All.pipe_right uu____2525 (FStar_Util.map_option (fun uu____2580 -> (match (uu____2580) with
| ((uu____2599, typ), r) -> begin
...
let uu____2642 = (match (name_or_lid) with
...
let uu____2659 = (FStar_Ident.string_of_lid lid)
in (

let uu____2660 = (

let uu____2663 = (FStar_ToSyntax_Env.try_lookup_doc dsenv lid)
in (FStar_All.pipe_right uu____2663 (FStar_Util.map_option FStar_Pervasives_Native.fst)))
in ((uu____2659), (uu____2660))))
end)
in (match (uu____2642) with
| (name, doc1) -> begin
(

let uu____2694 = (format_info (FStar_Pervasives_Native.snd env) name typ rng doc1)
...
in (FStar_All.pipe_right uu____2799 (FStar_Util.map_option (fun uu____2839 -> (match (uu____2839) with
| (matched, len) -> begin
...
let uu____2973 = (locate_match needle tc)
in (FStar_All.pipe_right uu____2973 (FStar_Util.map_option (fun uu____3034 -> (match (uu____3034) with
...
let uu____3078 = (FStar_List.map FStar_Ident.text_of_id ids)
in (FStar_Util.concat_l "." uu____3078)))
in (
...
let shorten_namespace = (fun uu____3125 -> (match (uu____3125) with
...
let uu____3160 = (FStar_ToSyntax_Env.shorten_module_path (FStar_Pervasives_Native.fst env) prefix1 naked_match)
in (match (uu____3160) with
| (stripped_ns, shortened) -> begin
(

let uu____3187 = (str_of_ids shortened)
in (

let uu____3188 = (str_of_ids matched)
in (

let uu____3189 = (str_of_ids stripped_ns)
in ((uu____3187), (uu____3188), (uu____3189), (match_len)))))
end)))
end))
in (

let prepare_candidate = (fun uu____3207 -> (match (uu____3207) with
...
let uu____3336 = (FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv lid)
in (FStar_Option.map (fun fqn -> (

let uu____3352 = (

let uu____3355 = (FStar_List.map FStar_Ident.id_of_text orig_ns)
in (FStar_List.append uu____3355 ((fqn.FStar_Ident.ident)::[])))
in (([]), (uu____3352), (matched_length)))) uu____3336)))
end
| uu____3362 -> begin
FStar_Pervasives_Native.None
end))))))))
...
let case_b_find_matches_in_env = (fun uu____3388 -> (

let uu____3401 = env
in (match (uu____3401) with
| (dsenv, uu____3415) -> begin
(

let matches = (FStar_List.filter_map (match_lident_against needle) all_lidents_in_env)
in (FStar_All.pipe_right matches (FStar_List.filter (fun uu____3478 -> (match (uu____3478) with
| (ns, id, uu____3491) -> begin
(

let uu____3500 = (

let uu____3503 = (FStar_Ident.lid_of_ids id)
in (FStar_ToSyntax_Env.resolve_to_fully_qualified_name dsenv uu____3503))
...
let uu____3505 = (FStar_Ident.lid_of_ids (FStar_List.append ns id))
in (FStar_Ident.lid_equals l uu____3505))
end))
end)))))
end)))
in (

let uu____3506 = (FStar_Util.prefix needle)
...
let uu____3556 = (FStar_ToSyntax_Env.resolve_module_name (FStar_Pervasives_Native.fst env) l true)
...
let uu____3621 = (shorten_namespace x)
in (prepare_candidate uu____3621))))))
end))))
in ((

let uu____3631 = (FStar_Util.sort_with (fun uu____3654 uu____3655 -> (match (((uu____3654), (uu____3655))) with
| ((cd1, ns1, uu____3682), (cd2, ns2, uu____3685)) -> begin
...
in (FStar_List.iter (fun uu____3710 -> (match (uu____3710) with
| (candidate, ns, match_len) -> begin
(

let uu____3720 = (FStar_Util.string_of_int match_len)
in (FStar_Util.print3 "%s %s %s \n" uu____3720 ns candidate))
end)) uu____3631));
...
let uu____3724 = (match (stack) with
| [] -> begin
...
let uu____3838 = (match (((FStar_List.length stack) = (FStar_List.length ts))) with
| true -> begin
(

let uu____3875 = (update_deps filename curmod stack env ts)
in ((true), (uu____3875)))
end
| uu____3888 -> begin
((false), (((stack), (env), (ts))))
...
let uu____4026 = (FStar_Options.codegen ())
in (FStar_Option.isSome uu____4026))
...
let uu____4030 = (deps_of_our_file filename)
...
let uu____4054 = (tc_deps FStar_Pervasives_Native.None [] env filenames [])
...
let uu____4081 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (

let uu____4082 = (FStar_Range.mk_pos (Prims.parse_int "1") (Prims.parse_int "0"))
in (FStar_Range.mk_range "<input>" uu____4081 uu____4082)))
in (

let env2 = (

let uu____4088 = (FStar_TypeChecker_Env.set_range (FStar_Pervasives_Native.snd env1) initial_range)
in (((FStar_Pervasives_Native.fst env1)), (uu____4088)))
in (
...
let uu____4099 = ((FStar_Options.record_hints ()) || (FStar_Options.use_hints ()))
...
let uu____4101 = (FStar_Options.file_list ())
in (FStar_List.hd uu____4101))
in (FStar_SMTEncoding_Solver.with_hints_db uu____4100 (fun uu____4105 -> (go (((Prims.parse_int "1")), ((Prims.parse_int "0"))) filename stack FStar_Pervasives_Native.None env3 ts))))
end
| uu____4106 -> begin
