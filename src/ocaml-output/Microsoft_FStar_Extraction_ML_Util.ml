...
(let _70_27261 = (let _70_27260 = (Support.Microsoft.FStar.Util.int_of_string c)
in (Support.Microsoft.FStar.Util.int32_of_int _70_27260))
in Microsoft_FStar_Extraction_ML_Syntax.MLC_Int32 (_70_27261))
end
...
(let _70_27269 = (let _70_27268 = (subst_aux subst t1)
in (let _70_27267 = (subst_aux subst t2)
in (_70_27268, f, _70_27267)))
in Microsoft_FStar_Extraction_ML_Syntax.MLTY_Fun (_70_27269))
end
| Microsoft_FStar_Extraction_ML_Syntax.MLTY_Named ((args, path)) -> begin
(let _70_27271 = (let _70_27270 = (Support.List.map (subst_aux subst) args)
in (_70_27270, path))
in Microsoft_FStar_Extraction_ML_Syntax.MLTY_Named (_70_27271))
end
| Microsoft_FStar_Extraction_ML_Syntax.MLTY_Tuple (ts) -> begin
(let _70_27272 = (Support.List.map (subst_aux subst) ts)
in Microsoft_FStar_Extraction_ML_Syntax.MLTY_Tuple (_70_27272))
end
| Microsoft_FStar_Extraction_ML_Syntax.MLTY_App ((t1, t2)) -> begin
(let _70_27275 = (let _70_27274 = (subst_aux subst t1)
in (let _70_27273 = (subst_aux subst t2)
in (_70_27274, _70_27273)))
in Microsoft_FStar_Extraction_ML_Syntax.MLTY_App (_70_27275))
end
...
| false -> begin
(let _70_27280 = (Support.List.zip formals args)
in (subst_aux _70_27280 t))
end)
end))
...
let tbinder_prefix = (fun ( t ) -> (match ((let _70_27307 = (Microsoft_FStar_Absyn_Util.compress_typ t)
in _70_27307.Microsoft_FStar_Absyn_Syntax.n)) with
...
(let _70_27309 = (mkTypFun ((b)::rest) c t)
in (bs, _70_27309))
end)
end
| _57_185 -> begin
...
let mlpath_of_lid = (fun ( l ) -> (let _70_27336 = (Support.All.pipe_right l.Microsoft_FStar_Absyn_Syntax.ns (Support.List.map (fun ( i ) -> i.Microsoft_FStar_Absyn_Syntax.idText)))
in (_70_27336, l.Microsoft_FStar_Absyn_Syntax.ident.Microsoft_FStar_Absyn_Syntax.idText)))
...
| true -> begin
(let _70_27347 = (let _70_27346 = (eraseTypeDeep g tyd)
in (let _70_27345 = (eraseTypeDeep g tycd)
in (_70_27346, etag, _70_27345)))
in Microsoft_FStar_Extraction_ML_Syntax.MLTY_Fun (_70_27347))
end
| false -> begin
t
end)
...
| false -> begin
(let _70_27349 = (let _70_27348 = (Support.List.map (eraseTypeDeep g) lty)
in (_70_27348, mlp))
in Microsoft_FStar_Extraction_ML_Syntax.MLTY_Named (_70_27349))
end)
end
| Microsoft_FStar_Extraction_ML_Syntax.MLTY_Tuple (lty) -> begin
(let _70_27350 = (Support.List.map (eraseTypeDeep g) lty)
in Microsoft_FStar_Extraction_ML_Syntax.MLTY_Tuple (_70_27350))
end
| Microsoft_FStar_Extraction_ML_Syntax.MLTY_App ((tyf, tyarg)) -> begin
(let _70_27353 = (let _70_27352 = (eraseTypeDeep g tyf)
in (let _70_27351 = (eraseTypeDeep g tyarg)
in (_70_27352, _70_27351)))
in Microsoft_FStar_Extraction_ML_Syntax.MLTY_App (_70_27353))
end
| _57_297 -> begin
t
end))
