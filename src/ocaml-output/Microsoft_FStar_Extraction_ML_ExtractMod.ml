...
in (Support.Prims.strcat "Not yet implemented:" _130_5))
in (Support.Microsoft.FStar.Bytes.string_as_unicode_bytes _130_6))
...
in (Support.All.pipe_left Microsoft_FStar_Absyn_Syntax.varg _130_10))
in (_130_11)::[])
in (_130_13)::_130_12))
in (_130_15, _130_14)))
...
in (let _64_11 = (Support.Microsoft.FStar.Util.prefix x.Microsoft_FStar_Absyn_Syntax.ns)
in (match (_64_11) with
| (prefix, constrName) -> begin
(let mangledName = (Microsoft_FStar_Absyn_Syntax.id_of_text (Support.Prims.strcat (Support.Prims.strcat (Support.Prims.strcat "___" constrName.Microsoft_FStar_Absyn_Syntax.idText) "___") projecteeName.Microsoft_FStar_Absyn_Syntax.idText))
...
in (Support.Microsoft.FStar.Util.print_string _130_25))))
in (match (se) with
...
(let _64_78 = (Support.List.fold_left2 (fun ( _64_54 ) ( ml_lb ) ( _64_62 ) -> (match ((_64_54, _64_62)) with
...
(let _64_75 = (match ((Support.All.pipe_right quals (Support.Microsoft.FStar.Util.for_some (fun ( _64_1 ) -> (match (_64_1) with
...
| true -> begin
(let mname = (let _130_31 = (let _130_30 = (Support.Microsoft.FStar.Util.right lbname)
in (mangle_projector_lid _130_30))
in (Support.All.pipe_right _130_31 Microsoft_FStar_Extraction_ML_Syntax.mlpath_of_lident))
in (let env = (let _130_34 = (let _130_32 = (Support.Microsoft.FStar.Util.right lbname)
in (Support.All.pipe_left Microsoft_FStar_Absyn_Util.fv _130_32))
in (let _130_33 = (Support.Microsoft.FStar.Util.must ml_lb.Microsoft_FStar_Extraction_ML_Syntax.mllb_tysc)
...
| false -> begin
(let _130_37 = (let _130_36 = (let _130_35 = (Support.Microsoft.FStar.Util.must ml_lb.Microsoft_FStar_Extraction_ML_Syntax.mllb_tysc)
...
in (Support.All.pipe_left Support.Prims.fst _130_36))
in (_130_37, ml_lb))
end)
...
| (g, mlm) -> begin
(let is_record = (Support.Microsoft.FStar.Util.for_some (fun ( _64_2 ) -> (match (_64_2) with
...
in (match ((Support.Microsoft.FStar.Util.find_map quals (fun ( _64_3 ) -> (match (_64_3) with
...
| _64_113 -> begin
(match ((Support.Microsoft.FStar.Util.find_map quals (fun ( _64_4 ) -> (match (_64_4) with
...
let extract_iface = (fun ( g ) ( m ) -> (let _130_49 = (Support.Microsoft.FStar.Util.fold_map extract_sig g m.Microsoft_FStar_Absyn_Syntax.declarations)
in (Support.All.pipe_right _130_49 Support.Prims.fst)))
...
in (let _64_163 = (Support.Microsoft.FStar.Util.print_string (Support.Prims.strcat (Support.Prims.strcat "extracting: " m.Microsoft_FStar_Absyn_Syntax.name.Microsoft_FStar_Absyn_Syntax.str) "\n"))
...
| false -> begin
(let _64_171 = (Support.Microsoft.FStar.Util.fold_map extract_sig g m.Microsoft_FStar_Absyn_Syntax.declarations)
