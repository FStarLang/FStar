         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(l,uu____1901)::(r,uu____1903)::[]) when
             ...
             let uu____1929 =
               ...
               let uu____1933 = unembed_term r  in (uu____1932, uu____1933)
                in
             Tv_App uu____1929
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____1936)::(t2,uu____1938)::[]) when
             ...
             let uu____1964 =
               ...
               let uu____1968 = unembed_term t2  in (uu____1967, uu____1968)
                in
             Tv_Abs uu____1964
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____1971)::(t2,uu____1973)::[]) when
             ...
             let uu____1999 =
               ...
               let uu____2003 = unembed_term t2  in (uu____2002, uu____2003)
                in
             Tv_Arrow uu____1999
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____2027)::(t2,uu____2029)::[]) when
             ...
             let uu____2055 =
               ...
               let uu____2059 = unembed_term t2  in (uu____2058, uu____2059)
                in
