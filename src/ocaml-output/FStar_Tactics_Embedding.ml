...
let (t_result_of :
  ...
  =
  fun t ->
    let uu____31 = let uu____40 = FStar_Syntax_Syntax.as_arg t in [uu____40] in
  ...
  fun ea ->
    let embed_result rng res =
      ...
      | FStar_Tactics_Result.Success (a, ps) ->
          ...
          uu____133 FStar_Pervasives_Native.None rng in
    let unembed_result w t =
      ...
      | (FStar_Syntax_Syntax.Tm_fvar fv,
         _t::(a, uu____263)::(ps, uu____265)::[]) when
      ...
      | (FStar_Syntax_Syntax.Tm_fvar fv,
         _t::(msg, uu____332)::(ps, uu____334)::[]) when
         ...
         then
           (let uu____456 =
              let uu____461 =
                ...
                FStar_Util.format1 "Not an embedded direction: %s" uu____462 in
