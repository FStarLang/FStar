...
let mk_tactic_lid_as_term : Prims.string -> FStar_Syntax_Syntax.term =
  fun s ->
    let uu____15 = fstar_tactics_lid' ["Effect"; s] in
    lid_as_tm uu____15
  ...
  fun t s ->
    let uu____31 =
      ...
      let uu____34 =
        ...
        let uu____36 =
          let uu____39 = FStar_Syntax_Syntax.as_arg s in
          [uu____39]
        in
        uu____35 :: uu____36
      in
      FStar_Syntax_Syntax.mk_Tm_app uu____32 uu____34
    in
    uu____31 FStar_Pervasives_Native.None FStar_Range.dummyRange


let embed_proofstate
    : FStar_Range.range -> FStar_Tactics_Types.proofstate
  ...
  fun t ->
    try
      let uu____67 =
        ...
        FStar_All.pipe_right uu____68 FStar_Dyn.undyn
      in
    ...
    with uu____75 ->
      (let uu____77 =
         ...
         in
         (FStar_Errors.Warning_NotEmbedded, uu____82)
       in
...
let embed_result:
      'a. 'a FStar_Syntax_Embeddings.embedder -> FStar_Reflection_Data.typ
      -> 'a FStar_Tactics_Result.__result FStar_Syntax_Embeddings.embedder =
  fun embed_a t_a rng res ->
    match res with
              ...
              let uu____134 =
                let uu____135 =
                  let uu____136 =
                    ...
                    let uu____138 =
                      let uu____139 =
                        FStar_Syntax_Syntax.iarg FStar_Syntax_Syntax.t_string
                      in
                      let uu____140 =
                        let uu____143 =
                          FStar_Syntax_Syntax.iarg t_proofstate
                        in
                        let uu____144 =
                          let uu____147 =
                            let uu____148 =
                              FStar_Syntax_Embeddings.embed_string rng msg
                            in
                            FStar_Syntax_Syntax.as_arg uu____148
                          in
                          let uu____149 =
                            let uu____152 =
                              let uu____153 = embed_proofstate rng ps in
                              FStar_Syntax_Syntax.as_arg uu____153
                            in
                            [uu____152]
                          in
                          uu____147 :: uu____149
                  ...
                  in
                  uu____136 FStar_Pervasives_Native.None rng
                in
                FStar_Syntax_Syntax.as_arg uu____135
              in
              [uu____134]
            in
            uu____130 :: uu____131
          in
          FStar_Syntax_Syntax.mk_Tm_app uu____128 uu____129
        in
          ...
          let uu____162 =
            ...
            let uu____164 =
              let uu____167 =
                      ...
                      let uu____173 =
                        ...
                        let uu____177 =
                          let uu____180 =
                            ...
                            FStar_Syntax_Syntax.as_arg uu____181
                          in
                          let uu____185 =
                            let uu____188 =
                              let uu____189 = embed_proofstate rng ps in
                              FStar_Syntax_Syntax.as_arg uu____189
                            in
                            [uu____188]
                          in
                          uu____180 :: uu____185
                ...
                in
                FStar_Syntax_Syntax.as_arg uu____168
              in
              [uu____167]
            in
            uu____163 :: uu____164
          in
          FStar_Syntax_Syntax.mk_Tm_app uu____161 uu____162
        in
        uu____160 FStar_Pervasives_Native.None rng


let unembed_result:
      'a. FStar_Syntax_Syntax.term -> 'a FStar_Syntax_Embeddings.unembedder
  ...
  fun t unembed_a ->
    let hd'_and_args tm =
      ...
      match uu____245 with hd1, args ->
        let uu____294 =
          let uu____295 = FStar_Syntax_Util.un_uinst hd1 in
          uu____295.FStar_Syntax_Syntax.n
        in
        (uu____294, args)
    in
    let uu____306 = hd'_and_args t in
    match uu____306 with
    | FStar_Syntax_Syntax.Tm_fvar fv, [_t; (tuple2, uu____336)]
      when FStar_Syntax_Syntax.fv_eq_lid fv fstar_tactics_Success_lid ->
        let uu____373 =
          let uu____380 =
            FStar_Syntax_Embeddings.unembed_pair unembed_a unembed_proofstate
          in
          uu____380 tuple2
        in
        FStar_Util.bind_opt uu____373 (fun x ->
            FStar_Pervasives_Native.Some (FStar_Util.Inl x) )
    | FStar_Syntax_Syntax.Tm_fvar fv, [_t; (tuple2, uu____438)]
      when FStar_Syntax_Syntax.fv_eq_lid fv fstar_tactics_Failed_lid ->
        let uu____475 =
          let uu____482 =
          ...
          uu____482 tuple2
        in
        FStar_Util.bind_opt uu____475 (fun x ->
            FStar_Pervasives_Native.Some (FStar_Util.Inr x) )
    | uu____533 ->
        (let uu____547 =
           let uu____552 =
             let uu____553 = FStar_Syntax_Print.term_to_string t in
             FStar_Util.format1 "Not an embedded tactic result: %s" uu____553
           in
           (FStar_Errors.Warning_NotEmbedded, uu____552)
         in
...
let embed_direction
    : FStar_Range.range -> FStar_Tactics_Types.direction
      -> FStar_Syntax_Syntax.term =
  fun rng d ->
    match d with
...
let unembed_direction
  ...
  fun t ->
    let uu____584 =
      ...
      uu____585.FStar_Syntax_Syntax.n
    in
    match uu____584 with
    | FStar_Syntax_Syntax.Tm_fvar fv
      when FStar_Syntax_Syntax.fv_eq_lid fv fstar_tactics_topdown_lid ->
        FStar_Pervasives_Native.Some FStar_Tactics_Types.TopDown
    | FStar_Syntax_Syntax.Tm_fvar fv
      when FStar_Syntax_Syntax.fv_eq_lid fv fstar_tactics_bottomup_lid ->
    ...
    | uu____592 ->
        (let uu____594 =
           ...
           in
           (FStar_Errors.Warning_NotEmbedded, uu____599)
         in
