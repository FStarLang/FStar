...
| FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string (bytes, uu____908)) -> begin
...
let uu____914 = (FStar_Syntax_Print.term_to_string t1)
in (Prims.strcat uu____914 ")"))
in (Prims.strcat "Not an embedded string (" uu____913))
in (failwith uu____912))
end)))
...
let uu____942 = (FStar_Syntax_Syntax.mk_Tm_uinst fstar_tactics_Failed ((FStar_Syntax_Syntax.U_zero)::[]))
in (

let uu____943 = (

let uu____944 = (FStar_Syntax_Syntax.iarg t_a)
in (
...
let uu____948 = (embed_string msg)
in (FStar_Syntax_Syntax.as_arg uu____948))
in (
...
let uu____952 = (embed_state ((ps.FStar_Tactics_Basic.goals), (ps.FStar_Tactics_Basic.smt_goals)))
in (FStar_Syntax_Syntax.as_arg uu____952))
in (uu____951)::[])
in (uu____947)::uu____949))
in (uu____944)::uu____945))
in (FStar_Syntax_Syntax.mk_Tm_app uu____942 uu____943)))
in (uu____941 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
...
let uu____962 = (FStar_Syntax_Syntax.mk_Tm_uinst fstar_tactics_Success ((FStar_Syntax_Syntax.U_zero)::[]))
in (

let uu____963 = (

let uu____964 = (FStar_Syntax_Syntax.iarg t_a)
in (
...
let uu____972 = (embed_state ((ps.FStar_Tactics_Basic.goals), (ps.FStar_Tactics_Basic.smt_goals)))
in (FStar_Syntax_Syntax.as_arg uu____972))
in (uu____971)::[])
in (uu____967)::uu____969))
in (uu____964)::uu____965))
in (FStar_Syntax_Syntax.mk_Tm_app uu____962 uu____963)))
in (uu____961 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end))
...
let uu____1008 = (FStar_Syntax_Util.head_and_args res1)
...
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_t)::((a, uu____1066))::((embedded_state, uu____1068))::[]) when (

let uu____1102 = (fstar_tactics_lid "Success")
in (FStar_Syntax_Syntax.fv_eq_lid fv uu____1102)) -> begin
(

let uu____1103 = (

let uu____1106 = (unembed_a a)
in (

let uu____1107 = (unembed_state env embedded_state)
in ((uu____1106), (uu____1107))))
in FStar_Util.Inl (uu____1103))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_t)::((embedded_string, uu____1115))::((embedded_state, uu____1117))::[]) when (

let uu____1151 = (fstar_tactics_lid "Failed")
in (FStar_Syntax_Syntax.fv_eq_lid fv uu____1151)) -> begin
(

let uu____1152 = (

let uu____1155 = (unembed_string embedded_string)
in (

let uu____1156 = (unembed_state env embedded_state)
in ((uu____1155), (uu____1156))))
in FStar_Util.Inr (uu____1152))
end
| uu____1161 -> begin
(
...
let uu____1170 = (FStar_Syntax_Print.term_to_string res1)
in (FStar_Util.format1 "Not an embedded result: %s" uu____1170))
in (failwith uu____1169))
end))
end))))
...
let uu____1260 = (FStar_Ident.string_of_lid l)
in (Prims.strcat "Unrecognized connective" uu____1260))
in (failwith uu____1259))
end)
end)
end)
end)
...
let uu____1267 = (FStar_List.map (fun uu____1270 -> (match (uu____1270) with
| (x, uu____1274) -> begin
(

let uu____1275 = (embed_term x)
in (FStar_Syntax_Syntax.as_arg uu____1275))
end)) args)
in (FStar_Syntax_Syntax.mk_Tm_app hd1 uu____1267))
in (uu____1266 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end)))
in (match (f) with
...
let uu____1286 = (embed_binders binders)
...
let uu____1290 = (embed_term typ)
in (FStar_Syntax_Syntax.as_arg uu____1290))
in (uu____1289)::[])
in (uu____1285)::uu____1287))
in (FStar_Syntax_Syntax.mk_Tm_app fstar_tactics_Forall uu____1284))
in (uu____1283 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
...
let uu____1301 = (embed_binders binders)
in (FStar_Syntax_Syntax.as_arg uu____1301))
in (
...
let uu____1305 = (embed_term typ)
in (FStar_Syntax_Syntax.as_arg uu____1305))
in (uu____1304)::[])
in (uu____1300)::uu____1302))
in (FStar_Syntax_Syntax.mk_Tm_app fstar_tactics_Exists uu____1299))
in (uu____1298 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
...
let uu____1319 = (embed_term t)
in (FStar_Syntax_Syntax.as_arg uu____1319))
in (
...
in (FStar_Syntax_Syntax.as_arg uu____1323))
in (uu____1322)::[])
in (uu____1318)::uu____1320))
in (FStar_Syntax_Syntax.mk_Tm_app fstar_tactics_App uu____1317))
in (uu____1316 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
| Name (bv) -> begin
(
...
let uu____1333 = (FStar_Syntax_Syntax.mk_binder bv)
in (embed_binder uu____1333))
in (FStar_Syntax_Syntax.as_arg uu____1332))
in (uu____1331)::[])
in (FStar_Syntax_Syntax.mk_Tm_app fstar_tactics_Name uu____1330))
in (uu____1329 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end)))


let term_as_formula : FStar_Syntax_Syntax.term  ->  formula FStar_Pervasives_Native.option = (fun t -> (

let uu____1343 = (FStar_Syntax_Util.destruct_typ_as_formula t)
...
let uu____1350 = (FStar_Syntax_Subst.compress t)
in uu____1350.FStar_Syntax_Syntax.n)
in (match (uu____1349) with
| FStar_Syntax_Syntax.Tm_app (uu____1354) -> begin
(

let uu____1364 = (FStar_Syntax_Util.head_and_args t)
...
let uu____1396 = (FStar_List.map FStar_Pervasives_Native.fst args)
in ((hd1), (uu____1396)))
in App (uu____1392))
in FStar_Pervasives_Native.Some (uu____1391))
end))
end
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
...
let uu____1606 = (FStar_Syntax_Syntax.fv_to_tm fv)
in (protect_embedded_term fstar_tactics_fvar uu____1606)))
...
let uu____1621 = (FStar_Syntax_Util.exp_int s)
in (FStar_Syntax_Syntax.as_arg uu____1621))
in (uu____1620)::[])
in (FStar_Syntax_Syntax.mk_Tm_app tac_C_Int uu____1619))
in (uu____1618 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end))
...
let uu____1633 = (embed_fvar fv)
in (FStar_Syntax_Syntax.as_arg uu____1633))
in (uu____1632)::[])
in (FStar_Syntax_Syntax.mk_Tm_app tac_Tv_FVar uu____1631))
in (uu____1630 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
| Tv_Var (bv) -> begin
(
...
let uu____1642 = (embed_binder bv)
in (FStar_Syntax_Syntax.as_arg uu____1642))
in (uu____1641)::[])
in (FStar_Syntax_Syntax.mk_Tm_app tac_Tv_Var uu____1640))
in (uu____1639 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
| Tv_App (hd1, a) -> begin
(
...
let uu____1652 = (embed_term hd1)
in (FStar_Syntax_Syntax.as_arg uu____1652))
in (
...
let uu____1656 = (embed_term a)
in (FStar_Syntax_Syntax.as_arg uu____1656))
in (uu____1655)::[])
in (uu____1651)::uu____1653))
in (FStar_Syntax_Syntax.mk_Tm_app tac_Tv_App uu____1650))
in (uu____1649 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
| Tv_Abs (b, t1) -> begin
(
...
let uu____1666 = (embed_binder b)
in (FStar_Syntax_Syntax.as_arg uu____1666))
in (
...
let uu____1670 = (embed_term t1)
in (FStar_Syntax_Syntax.as_arg uu____1670))
in (uu____1669)::[])
in (uu____1665)::uu____1667))
in (FStar_Syntax_Syntax.mk_Tm_app tac_Tv_Abs uu____1664))
in (uu____1663 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
| Tv_Arrow (b, t1) -> begin
(
...
let uu____1680 = (embed_binder b)
in (FStar_Syntax_Syntax.as_arg uu____1680))
in (
...
let uu____1684 = (embed_term t1)
in (FStar_Syntax_Syntax.as_arg uu____1684))
in (uu____1683)::[])
in (uu____1679)::uu____1681))
in (FStar_Syntax_Syntax.mk_Tm_app tac_Tv_Arrow uu____1678))
in (uu____1677 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
| Tv_Type (u) -> begin
(
...
let uu____1693 = (embed_unit ())
in (FStar_Syntax_Syntax.as_arg uu____1693))
in (uu____1692)::[])
in (FStar_Syntax_Syntax.mk_Tm_app tac_Tv_Type uu____1691))
in (uu____1690 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
...
let uu____1703 = (embed_binder bv)
in (FStar_Syntax_Syntax.as_arg uu____1703))
in (
...
let uu____1707 = (embed_term t1)
in (FStar_Syntax_Syntax.as_arg uu____1707))
in (uu____1706)::[])
in (uu____1702)::uu____1704))
in (FStar_Syntax_Syntax.mk_Tm_app tac_Tv_Refine uu____1701))
in (uu____1700 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end
| Tv_Const (c) -> begin
(
...
let uu____1716 = (embed_const c)
in (FStar_Syntax_Syntax.as_arg uu____1716))
in (uu____1715)::[])
in (FStar_Syntax_Syntax.mk_Tm_app tac_Tv_Const uu____1714))
in (uu____1713 FStar_Pervasives_Native.None FStar_Range.dummyRange))
end))
...
let uu____1725 = (FStar_Syntax_Util.head_and_args t1)
...
let uu____1760 = (FStar_Syntax_Util.un_uinst hd1)
...
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((i, uu____1780))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv tac_C_Int_lid) -> begin
(

let uu____1798 = (

let uu____1799 = (FStar_Syntax_Subst.compress i)
in uu____1799.FStar_Syntax_Syntax.n)
in (match (uu____1798) with
| FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_int (s, uu____1803)) -> begin
C_Int (s)
end
| uu____1810 -> begin
...
let uu____1823 = (FStar_Syntax_Util.head_and_args t1)
...
let uu____1858 = (FStar_Syntax_Util.un_uinst hd1)
in uu____1858.FStar_Syntax_Syntax.n)
in ((uu____1857), (args)))
in (match (uu____1849) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((b, uu____1868))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv tac_Tv_Var_lid) -> begin
(

let uu____1886 = (unembed_binder b)
in Tv_Var (uu____1886))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((b, uu____1889))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv tac_Tv_FVar_lid) -> begin
(

let uu____1907 = (unembed_fvar b)
in Tv_FVar (uu____1907))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((l, uu____1910))::((r, uu____1912))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv tac_Tv_App_lid) -> begin
(

let uu____1938 = (

let uu____1941 = (unembed_term l)
in (

let uu____1942 = (unembed_term r)
in ((uu____1941), (uu____1942))))
in Tv_App (uu____1938))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((b, uu____1945))::((t2, uu____1947))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv tac_Tv_Abs_lid) -> begin
(

let uu____1973 = (

let uu____1976 = (unembed_binder b)
in (

let uu____1977 = (unembed_term t2)
in ((uu____1976), (uu____1977))))
in Tv_Abs (uu____1973))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((b, uu____1980))::((t2, uu____1982))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv tac_Tv_Arrow_lid) -> begin
(

let uu____2008 = (

let uu____2011 = (unembed_binder b)
in (

let uu____2012 = (unembed_term t2)
in ((uu____2011), (uu____2012))))
in Tv_Arrow (uu____2008))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((u, uu____2015))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv tac_Tv_Type_lid) -> begin
((unembed_unit u);
Tv_Type (());
)
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((b, uu____2036))::((t2, uu____2038))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv tac_Tv_Refine_lid) -> begin
(

let uu____2064 = (

let uu____2067 = (unembed_binder b)
in (

let uu____2068 = (unembed_term t2)
in ((uu____2067), (uu____2068))))
in Tv_Refine (uu____2064))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((c, uu____2071))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv tac_Tv_Const_lid) -> begin
(

let uu____2089 = (unembed_const c)
in Tv_Const (uu____2089))
end
| uu____2090 -> begin
...
let uu____2133 = (FStar_Syntax_Syntax.lid_of_fv fv)
in (FStar_Ident.path_of_lid uu____2133)))


let packfv : Prims.string Prims.list  ->  FStar_Syntax_Syntax.fv = (fun ns -> (

let uu____2139 = (FStar_Parser_Const.p2l ns)
in (FStar_Syntax_Syntax.lid_as_fv uu____2139 FStar_Syntax_Syntax.Delta_equational FStar_Pervasives_Native.None)))
...
let uu____2149 = (FStar_Syntax_Subst.compress t)
in uu____2149.FStar_Syntax_Syntax.n)
...
let uu____2155 = (FStar_Syntax_Syntax.mk_binder bv)
in Tv_Var (uu____2155))
in (FStar_All.pipe_left (fun _0_29 -> FStar_Pervasives_Native.Some (_0_29)) uu____2154))
end
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
...
let uu____2214 = (init args)
in (FStar_Syntax_Syntax.mk_Tm_app hd1 uu____2214))
in (uu____2213 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos))
in ((uu____2210), (a)))
in Tv_App (uu____2207))
in (FStar_All.pipe_left (fun _0_31 -> FStar_Pervasives_Native.Some (_0_31)) uu____2206))
end))
end
| FStar_Syntax_Syntax.Tm_abs ([], uu____2228, uu____2229) -> begin
(failwith "inspect: empty arguments on Tm_abs")
end
| FStar_Syntax_Syntax.Tm_abs ((b)::bs, t1, k) -> begin
(

let uu____2282 = (FStar_Syntax_Subst.open_term ((b)::bs) t1)
in (match (uu____2282) with
| (bs', t2) -> begin
(

let uu____2290 = (match (bs') with
| (b1)::bs1 -> begin
((b1), (bs1))
end
| [] -> begin
...
let uu____2345 = (FStar_Syntax_Util.abs bs1 t2 k)
in ((b1), (uu____2345)))
in Tv_Abs (uu____2342))
in (FStar_All.pipe_left (fun _0_32 -> FStar_Pervasives_Native.Some (_0_32)) uu____2341))
end))
end))
end
| FStar_Syntax_Syntax.Tm_type (uu____2349) -> begin
...
let uu____2379 = (FStar_Syntax_Subst.open_comp ((b)::[]) k)
...
let uu____2408 = (FStar_Syntax_Util.arrow bs k1)
in ((b1), (uu____2408)))
in Tv_Arrow (uu____2405))
in (FStar_All.pipe_left (fun _0_34 -> FStar_Pervasives_Native.Some (_0_34)) uu____2404)))
end))
end
...
let uu____2423 = (FStar_Syntax_Subst.open_term ((b)::[]) t1)
...
| FStar_Const.Const_int (s, uu____2450) -> begin
C_Int (s)
end
| uu____2457 -> begin
...
let uu____2475 = (FStar_Syntax_Syntax.as_arg r)
in (uu____2475)::[])
in (FStar_Syntax_Util.mk_app l uu____2469))
end
| Tv_Abs (b, t) -> begin
...
let uu____2485 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.arrow ((b)::[]) uu____2485))
end
| Tv_Type (()) -> begin
FStar_Syntax_Util.ktype
end
| Tv_Refine ((bv, uu____2489), t) -> begin
...
let uu____2502 = (FStar_Syntax_Util.head_and_args t1)
...
let uu____2537 = (FStar_Syntax_Util.un_uinst hd1)
