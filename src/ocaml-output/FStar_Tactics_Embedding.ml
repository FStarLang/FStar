  ...
  fun env  ->
    fun protected_embedded_env  ->
      ...
      FStar_List.fold_left
        (fun env1  ->
           fun b  ->
             let uu____808 = FStar_TypeChecker_Env.try_lookup_bv env1 (fst b)
                in
                    ...
                    then fstar_tactics_Iff
                      ...
                      then fstar_tactics_Eq
                        ...
                        (let uu____1255 =
                           ...
                           Prims.strcat "Unrecognized connective" uu____1256
                            in
                         failwith uu____1255)
         in
      match args with
              ...
              FStar_List.map
                (fun uu____1266  ->
                   ...
                   | (x,uu____1270) ->
                       ...
                       FStar_Syntax_Syntax.as_arg uu____1271) args
               in
            FStar_Syntax_Syntax.mk_Tm_app hd1 uu____1263  in
          uu____1262 None FStar_Range.dummyRange
       in
    match f with
    ...
    | App (t,ts) ->
        let uu____1312 =
          let uu____1313 =
            ...
            let uu____1316 =
              let uu____1318 =
                let uu____1319 = embed_list embed_term fstar_tactics_term ts
                   in
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(l,uu____1897)::(r,uu____1899)::[]) when
             ...
             let uu____1925 =
               ...
               let uu____1929 = unembed_term r  in (uu____1928, uu____1929)
                in
             Tv_App uu____1925
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____1932)::(t2,uu____1934)::[]) when
             ...
             let uu____1960 =
               ...
               let uu____1964 = unembed_term t2  in (uu____1963, uu____1964)
                in
             Tv_Abs uu____1960
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____1967)::(t2,uu____1969)::[]) when
             ...
             let uu____1995 =
               ...
               let uu____1999 = unembed_term t2  in (uu____1998, uu____1999)
                in
             Tv_Arrow uu____1995
         ...
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,(b,uu____2023)::(t2,uu____2025)::[]) when
             ...
             let uu____2051 =
               ...
               let uu____2055 = unembed_term t2  in (uu____2054, uu____2055)
                in
