...
let (t_result_of :
  ...
  =
  fun t ->
    let uu____43 = let uu____52 = FStar_Syntax_Syntax.as_arg t in [uu____52] in
         ...
         then
           (let uu____95 =
              let uu____100 =
                ...
                FStar_Util.format1 "Not an embedded proofstate: %s" uu____101 in
  ...
  fun ea ->
    let embed_result rng res =
                ...
                let uu____155 =
                  let uu____156 =
                    FStar_Syntax_Embeddings.embed
                      FStar_Syntax_Embeddings.e_string rng msg in
      ...
      | FStar_Tactics_Result.Success (a, ps) ->
          ...
          uu____166 FStar_Pervasives_Native.None rng in
    let unembed_result w t =
      ...
      | (FStar_Syntax_Syntax.Tm_fvar fv,
         _t::(a, uu____306)::(ps, uu____308)::[]) when
      ...
      | (FStar_Syntax_Syntax.Tm_fvar fv,
         _t::(msg, uu____375)::(ps, uu____377)::[]) when
         ...
         then
           (let uu____507 =
              let uu____512 =
                ...
                FStar_Util.format1 "Not an embedded direction: %s" uu____513 in
