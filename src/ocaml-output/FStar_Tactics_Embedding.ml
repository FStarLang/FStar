...
let uu____71 = (fstar_tactics_lid' (("Types")::("guard_policy")::[]))
in (FStar_Syntax_Syntax.tconst uu____71))


let t_direction : FStar_Syntax_Syntax.term = (

let uu____72 = (fstar_tactics_lid' (("Types")::("direction")::[]))
in (FStar_Syntax_Syntax.tconst uu____72))
...
let uu____102 = (FStar_Syntax_Subst.compress t)
in uu____102.FStar_Syntax_Syntax.n)
...
let uu____108 = (FStar_Dyn.undyn i.FStar_Syntax_Syntax.blob)
in (FStar_All.pipe_left (fun _0_17 -> FStar_Pervasives_Native.Some (_0_17)) uu____108))
end
| uu____111 -> begin
((match (w) with
| true -> begin
...
in (FStar_Util.format1 "Not an embedded proofstate: %s" uu____119))
in ((FStar_Errors.Warning_NotEmbedded), (uu____118)))
in (FStar_Errors.log_issue t.FStar_Syntax_Syntax.pos uu____113))
end
| uu____120 -> begin
()
end);
...
let uu____166 = (FStar_Syntax_Syntax.mk_Tm_uinst fstar_tactics_Failed_tm ((FStar_Syntax_Syntax.U_zero)::[]))
in (
...
let uu____175 = (FStar_Syntax_Embeddings.type_of ea)
in (FStar_Syntax_Syntax.iarg uu____175))
in (
...
let uu____192 = (FStar_Syntax_Embeddings.embed FStar_Syntax_Embeddings.e_string rng msg)
in (FStar_Syntax_Syntax.as_arg uu____192))
in (
...
let uu____209 = (FStar_Syntax_Embeddings.embed e_proofstate rng ps)
in (FStar_Syntax_Syntax.as_arg uu____209))
in (uu____202)::[])
in (uu____185)::uu____193))
in (uu____168)::uu____176))
in (FStar_Syntax_Syntax.mk_Tm_app uu____166 uu____167)))
in (uu____161 FStar_Pervasives_Native.None rng))
end
...
let uu____243 = (FStar_Syntax_Syntax.mk_Tm_uinst fstar_tactics_Success_tm ((FStar_Syntax_Syntax.U_zero)::[]))
in (
...
let uu____252 = (FStar_Syntax_Embeddings.type_of ea)
in (FStar_Syntax_Syntax.iarg uu____252))
in (
...
let uu____269 = (FStar_Syntax_Embeddings.embed ea rng a)
in (FStar_Syntax_Syntax.as_arg uu____269))
in (
...
let uu____286 = (FStar_Syntax_Embeddings.embed e_proofstate rng ps)
in (FStar_Syntax_Syntax.as_arg uu____286))
in (uu____279)::[])
in (uu____262)::uu____270))
in (uu____245)::uu____253))
in (FStar_Syntax_Syntax.mk_Tm_app uu____243 uu____244)))
in (uu____238 FStar_Pervasives_Native.None rng))
end))
in (
...
let uu____351 = (FStar_Syntax_Util.head_and_args tm1)
...
let uu____401 = (FStar_Syntax_Util.un_uinst hd1)
in uu____401.FStar_Syntax_Syntax.n)
in ((uu____400), (args)))
end))))
in (

let uu____412 = (hd'_and_args t)
in (match (uu____412) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_t)::((a, uu____432))::((ps, uu____434))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv fstar_tactics_Success_lid) -> begin
(

let uu____481 = (FStar_Syntax_Embeddings.unembed ea a)
in (FStar_Util.bind_opt uu____481 (fun a1 -> (

let uu____489 = (FStar_Syntax_Embeddings.unembed e_proofstate ps)
in (FStar_Util.bind_opt uu____489 (fun ps1 -> FStar_Pervasives_Native.Some (FStar_Tactics_Result.Success (((a1), (ps1))))))))))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_t)::((msg, uu____501))::((ps, uu____503))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv fstar_tactics_Failed_lid) -> begin
(

let uu____550 = (FStar_Syntax_Embeddings.unembed FStar_Syntax_Embeddings.e_string msg)
in (FStar_Util.bind_opt uu____550 (fun msg1 -> (

let uu____558 = (FStar_Syntax_Embeddings.unembed e_proofstate ps)
in (FStar_Util.bind_opt uu____558 (fun ps1 -> FStar_Pervasives_Native.Some (FStar_Tactics_Result.Failed (((msg1), (ps1))))))))))
end
| uu____567 -> begin
((match (w) with
| true -> begin
...
let uu____587 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format1 "Not an embedded tactic result: %s" uu____587))
in ((FStar_Errors.Warning_NotEmbedded), (uu____586)))
in (FStar_Errors.log_issue t.FStar_Syntax_Syntax.pos uu____581))
end
| uu____588 -> begin
()
end);
...
let uu____592 = (FStar_Syntax_Embeddings.type_of ea)
in (t_result_of uu____592))
in (FStar_Syntax_Embeddings.mk_emb embed_result unembed_result uu____591)))))
...
let uu____624 = (FStar_Syntax_Subst.compress t)
in uu____624.FStar_Syntax_Syntax.n)
...
let uu____639 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format1 "Not an embedded direction: %s" uu____639))
in ((FStar_Errors.Warning_NotEmbedded), (uu____638)))
in (FStar_Errors.log_issue t.FStar_Syntax_Syntax.pos uu____633))
end
| uu____640 -> begin
()
end);
...
let uu____670 = (FStar_Syntax_Subst.compress t)
in uu____670.FStar_Syntax_Syntax.n)
...
in (FStar_Util.format1 "Not an embedded guard_policy: %s" uu____687))
in ((FStar_Errors.Warning_NotEmbedded), (uu____686)))
in (FStar_Errors.log_issue t.FStar_Syntax_Syntax.pos uu____681))
end
| uu____688 -> begin
()
end);
