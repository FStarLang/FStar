...
let (t_result_of :
  ...
  =
  fun t ->
    let uu____51 = let uu____62 = FStar_Syntax_Syntax.as_arg t in [uu____62] in
         ...
         then
           (let uu____324 =
              let uu____329 =
                ...
                FStar_Util.format1 "Not an embedded proofstate: %s" uu____330 in
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.rng = uu____513;_},
         uu____514)
        ->
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           ...
           FStar_Syntax_Syntax.rng = uu____699;_},
         uu____700)
        ->
  ...
  fun ea ->
    let embed_result res rng uu____797 uu____798 =
      ...
      | FStar_Tactics_Result.Failed (msg, ps) ->
          ...
          uu____919 FStar_Pervasives_Native.None rng in
    let unembed_result t w uu____1033 =
      ...
      | (FStar_Syntax_Syntax.Tm_fvar fv,
         _t::(a, uu____1154)::(ps, uu____1156)::[]) when
      ...
      | (FStar_Syntax_Syntax.Tm_fvar fv,
         _t::(msg, uu____1243)::(ps, uu____1245)::[]) when
          FStar_Syntax_Syntax.fv_eq_lid fv fstar_tactics_Failed_lid ->
          let uu____1312 = unembed' w FStar_Syntax_Embeddings.e_string msg in
              ...
              let uu____1433 =
                let uu____1438 =
                  FStar_TypeChecker_NBETerm.embed
                    FStar_TypeChecker_NBETerm.e_string cb msg in
         ...
         then
           (let uu____1701 =
              let uu____1706 =
                ...
                FStar_Util.format1 "Not an embedded direction: %s" uu____1707 in
    ...
    | uu____1777 ->
        ((let uu____1779 =
            let uu____1784 =
              ...
              FStar_Util.format1 "Not an embedded direction: %s" uu____1785 in
