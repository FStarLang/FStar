...
| (FStar_Syntax_Syntax.Tm_fvar (fv), ((t1, uu____86))::(uu____87)::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.fstar_tactics_embed_lid) -> begin
t1
end
| uu____113 -> begin
(
...
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____170)::((x, uu____172))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.fstar_tactics_embed_lid) -> begin
x
end
| uu____198 -> begin
(
...
| Unembed_failed (uu____213) -> begin
true
end
| uu____214 -> begin
false
...
| Unembed_failed (uu____221) -> begin
uu____221
end))
...
let uu____225 = (FStar_Syntax_Syntax.bv_to_name (Prims.fst b))
in (protect_embedded_term fstar_tactics_binder uu____225)))
...
let uu____278 = (lid_as_data_tm lid_Mktuple2)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____278 ((FStar_Syntax_Syntax.U_zero)::(FStar_Syntax_Syntax.U_zero)::[])))
in (

let uu____279 = (

let uu____280 = (FStar_Syntax_Syntax.iarg t_a)
in (

let uu____281 = (

let uu____283 = (FStar_Syntax_Syntax.iarg t_b)
in (
...
let uu____287 = (embed_a (Prims.fst x))
in (FStar_Syntax_Syntax.as_arg uu____287))
in (
...
let uu____291 = (embed_b (Prims.snd x))
in (FStar_Syntax_Syntax.as_arg uu____291))
in (uu____290)::[])
in (uu____286)::uu____288))
in (uu____283)::uu____284))
in (uu____280)::uu____281))
in (FStar_Syntax_Syntax.mk_Tm_app uu____277 uu____279)))
in (uu____276 None FStar_Range.dummyRange)))
...
let uu____328 = (FStar_Syntax_Util.head_and_args pair)
...
let uu____365 = (FStar_Syntax_Util.un_uinst hd1)
in uu____365.FStar_Syntax_Syntax.n)
in ((uu____364), (args)))
in (match (uu____356) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____376)::(uu____377)::((a, uu____379))::((b, uu____381))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv lid_Mktuple2) -> begin
(

let uu____423 = (unembed_a a)
in (

let uu____424 = (unembed_b b)
...
let uu____461 = (lid_as_data_tm FStar_Syntax_Const.none_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____461 ((FStar_Syntax_Syntax.U_zero)::[])))
in (

let uu____462 = (

let uu____463 = (FStar_Syntax_Syntax.iarg typ)
in (uu____463)::[])
in (FStar_Syntax_Syntax.mk_Tm_app uu____460 uu____462)))
in (uu____459 None FStar_Range.dummyRange))
end
| Some (a) -> begin
(
...
let uu____471 = (lid_as_data_tm FStar_Syntax_Const.some_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____471 ((FStar_Syntax_Syntax.U_zero)::[])))
in (

let uu____472 = (

let uu____473 = (FStar_Syntax_Syntax.iarg typ)
in (
...
let uu____477 = (embed_a a)
in (FStar_Syntax_Syntax.as_arg uu____477))
in (uu____476)::[])
in (uu____473)::uu____474))
in (FStar_Syntax_Syntax.mk_Tm_app uu____470 uu____472)))
in (uu____469 None FStar_Range.dummyRange))
end))


let unembed_option = (fun unembed_a o -> (

let uu____500 = (FStar_Syntax_Util.head_and_args o)
...
let uu____536 = (FStar_Syntax_Util.un_uinst hd1)
in uu____536.FStar_Syntax_Syntax.n)
in ((uu____535), (args)))
in (match (uu____527) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____546) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.none_lid) -> begin
None
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (uu____558)::((a, uu____560))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.some_lid) -> begin
(

let uu____586 = (unembed_a a)
in Some (uu____586))
end
| uu____587 -> begin
...
let uu____622 = (lid_as_data_tm FStar_Syntax_Const.nil_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____622 ((FStar_Syntax_Syntax.U_zero)::[])))
in (

let uu____623 = (

let uu____624 = (FStar_Syntax_Syntax.iarg t_a)
in (uu____624)::[])
in (FStar_Syntax_Syntax.mk_Tm_app uu____621 uu____623)))
in (uu____620 None FStar_Range.dummyRange))
end
| (hd1)::tl1 -> begin
(
...
let uu____634 = (lid_as_data_tm FStar_Syntax_Const.cons_lid)
in (FStar_Syntax_Syntax.mk_Tm_uinst uu____634 ((FStar_Syntax_Syntax.U_zero)::[])))
in (

let uu____635 = (

let uu____636 = (FStar_Syntax_Syntax.iarg t_a)
in (
...
let uu____640 = (embed_a hd1)
in (FStar_Syntax_Syntax.as_arg uu____640))
in (
...
let uu____644 = (embed_list tl1 embed_a t_a)
in (FStar_Syntax_Syntax.as_arg uu____644))
in (uu____643)::[])
in (uu____639)::uu____641))
in (uu____636)::uu____637))
in (FStar_Syntax_Syntax.mk_Tm_app uu____633 uu____635)))
in (uu____632 None FStar_Range.dummyRange))
end))
...
let uu____668 = (FStar_Syntax_Util.head_and_args l1)
...
let uu____704 = (FStar_Syntax_Util.un_uinst hd1)
in uu____704.FStar_Syntax_Syntax.n)
in ((uu____703), (args)))
in (match (uu____695) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), uu____714) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.nil_lid) -> begin
[]
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_t)::((hd2, uu____728))::((tl1, uu____730))::[]) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.cons_lid) -> begin
(

let uu____764 = (unembed_a hd2)
in (

let uu____765 = (unembed_list tl1 unembed_a)
...
let uu____776 = (FStar_Syntax_Print.term_to_string l1)
in (FStar_Util.format1 "Not an embedded list: %s" uu____776))
in (failwith uu____775))
end))
end))))
...
let uu____791 = (FStar_TypeChecker_Env.all_binders env)
in (embed_list uu____791 embed_binder fstar_tactics_binder))
in (protect_embedded_term fstar_tactics_env uu____790)))
...
let uu____812 = (FStar_TypeChecker_Env.try_lookup_bv env1 (Prims.fst b))
...
let uu____841 = (unembed_pair t (unembed_env env) unembed_term)
...
let unembed_unit : FStar_Syntax_Syntax.term  ->  Prims.unit = (fun uu____882 -> ())
...
let uu____891 = (FStar_Syntax_Subst.compress t)
in uu____891.FStar_Syntax_Syntax.n)
...
| FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string (bytes, uu____915)) -> begin
...
let uu____946 = (FStar_Syntax_Syntax.mk_Tm_uinst fstar_tactics_Failed ((FStar_Syntax_Syntax.U_zero)::[]))
in (

let uu____947 = (

let uu____948 = (FStar_Syntax_Syntax.iarg t_a)
in (
...
let uu____952 = (embed_string msg)
...
let uu____956 = (embed_state ((ps.FStar_Tactics_Basic.goals), (ps.FStar_Tactics_Basic.smt_goals)))
in (FStar_Syntax_Syntax.as_arg uu____956))
in (uu____955)::[])
in (uu____951)::uu____953))
in (uu____948)::uu____949))
in (FStar_Syntax_Syntax.mk_Tm_app uu____946 uu____947)))
in (uu____945 None FStar_Range.dummyRange))
end
...
let uu____966 = (FStar_Syntax_Syntax.mk_Tm_uinst fstar_tactics_Success ((FStar_Syntax_Syntax.U_zero)::[]))
in (

let uu____967 = (

let uu____968 = (FStar_Syntax_Syntax.iarg t_a)
in (
...
let uu____976 = (embed_state ((ps.FStar_Tactics_Basic.goals), (ps.FStar_Tactics_Basic.smt_goals)))
in (FStar_Syntax_Syntax.as_arg uu____976))
in (uu____975)::[])
in (uu____971)::uu____973))
in (uu____968)::uu____969))
in (FStar_Syntax_Syntax.mk_Tm_app uu____966 uu____967)))
in (uu____965 None FStar_Range.dummyRange))
end))
...
let uu____1012 = (FStar_Syntax_Util.head_and_args res1)
...
let uu____1053 = (FStar_Syntax_Util.un_uinst hd1)
in uu____1053.FStar_Syntax_Syntax.n)
in ((uu____1052), (args)))
in (match (uu____1044) with
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_t)::((a, uu____1070))::((embedded_state, uu____1072))::[]) when (

let uu____1106 = (fstar_tactics_lid "Success")
in (FStar_Syntax_Syntax.fv_eq_lid fv uu____1106)) -> begin
(

let uu____1107 = (

let uu____1110 = (unembed_a a)
in (

let uu____1111 = (unembed_state env embedded_state)
in ((uu____1110), (uu____1111))))
in FStar_Util.Inl (uu____1107))
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_t)::((embedded_string, uu____1119))::((embedded_state, uu____1121))::[]) when (

let uu____1155 = (fstar_tactics_lid "Failed")
in (FStar_Syntax_Syntax.fv_eq_lid fv uu____1155)) -> begin
(

let uu____1156 = (

let uu____1159 = (unembed_string embedded_string)
in (

let uu____1160 = (unembed_state env embedded_state)
in ((uu____1159), (uu____1160))))
in FStar_Util.Inr (uu____1156))
end
| uu____1165 -> begin
(
...
let uu____1174 = (FStar_Syntax_Print.term_to_string res1)
in (FStar_Util.format1 "Not an embedded result: %s" uu____1174))
in (failwith uu____1173))
end))
end))))
...
let uu____1261 = (FStar_Ident.string_of_lid l)
in (Prims.strcat "Unrecognized connective" uu____1261))
in (failwith uu____1260))
end)
end)
end)
end)
...
let uu____1268 = (FStar_List.map (fun uu____1271 -> (match (uu____1271) with
| (x, uu____1275) -> begin
(

let uu____1276 = (embed_term x)
in (FStar_Syntax_Syntax.as_arg uu____1276))
end)) args)
in (FStar_Syntax_Syntax.mk_Tm_app hd1 uu____1268))
in (uu____1267 None FStar_Range.dummyRange))
end)))
in (match (f) with
...
let uu____1287 = (embed_binders binders)
...
let uu____1291 = (embed_term typ)
in (FStar_Syntax_Syntax.as_arg uu____1291))
in (uu____1290)::[])
in (uu____1286)::uu____1288))
in (FStar_Syntax_Syntax.mk_Tm_app fstar_tactics_Forall uu____1285))
in (uu____1284 None FStar_Range.dummyRange))
end
...
let uu____1302 = (embed_binders binders)
...
let uu____1306 = (embed_term typ)
in (FStar_Syntax_Syntax.as_arg uu____1306))
in (uu____1305)::[])
in (uu____1301)::uu____1303))
in (FStar_Syntax_Syntax.mk_Tm_app fstar_tactics_Exists uu____1300))
in (uu____1299 None FStar_Range.dummyRange))
end
...
let uu____1324 = (embed_list ts embed_term fstar_tactics_term)
in (FStar_Syntax_Syntax.as_arg uu____1324))
in (uu____1323)::[])
in (uu____1319)::uu____1321))
in (FStar_Syntax_Syntax.mk_Tm_app fstar_tactics_App uu____1318))
...
let uu____1334 = (FStar_Syntax_Syntax.mk_binder bv)
in (embed_binder uu____1334))
in (FStar_Syntax_Syntax.as_arg uu____1333))
in (uu____1332)::[])
in (FStar_Syntax_Syntax.mk_Tm_app fstar_tactics_Name uu____1331))
in (uu____1330 None FStar_Range.dummyRange))
end)))


let term_as_formula : FStar_Syntax_Syntax.term  ->  formula Prims.option = (fun t -> (

let uu____1344 = (FStar_Syntax_Util.destruct_typ_as_formula t)
...
let uu____1351 = (FStar_Syntax_Subst.compress t)
in uu____1351.FStar_Syntax_Syntax.n)
in (match (uu____1350) with
| FStar_Syntax_Syntax.Tm_app (uu____1355) -> begin
(

let uu____1365 = (FStar_Syntax_Util.head_and_args t)
...
let uu____1397 = (FStar_List.map Prims.fst args)
in ((hd1), (uu____1397)))
in App (uu____1393))
in Some (uu____1392))
end))
