...
let (lid_as_data_tm : FStar_Ident.lident -> FStar_Syntax_Syntax.term) =
  fun l  ->
    let uu___ = lid_as_data_fv l  in FStar_Syntax_Syntax.fv_to_tm uu___
    ...
    | FStar_TypeChecker_NBETerm.Lazy
        (FStar_Util.Inl
         { FStar_Syntax_Syntax.blob = b;
           FStar_Syntax_Syntax.lkind = FStar_Syntax_Syntax.Lazy_proofstate ;
           FStar_Syntax_Syntax.ltyp = uu___1;
           FStar_Syntax_Syntax.rng = uu___2;_},uu___3)
        ->
...
let (e_exn : Prims.exn FStar_Syntax_Embeddings.embedding) =
  ...
  let unembed_exn t w uu___ =
    ...
    | uu___2 -> FStar_Pervasives_Native.Some (FStar_Tactics_Common.EExn t)
     in
  let uu___ =
    let uu___1 =
      let uu___2 =
...
let e_result :
  ...
  fun ea  ->
    ...
    let unembed_result t w uu___ =
      ...
      | (FStar_Syntax_Syntax.Tm_fvar fv,_t::(e,uu___2)::(ps,uu___3)::[]) when
      ...
      | uu___2 ->
       ...
       in
    let uu___ =
      let uu___1 = FStar_Syntax_Embeddings.type_of ea  in t_result_of uu___1
       in
    let uu___1 =
      let uu___2 =
        let uu___3 =
    ...
    let embed_result cb res =
      ...
      | FStar_Tactics_Result.Failed (e,ps) ->
          let uu___ =
            ...
            let uu___2 =
              let uu___3 =
                let uu___4 = FStar_TypeChecker_NBETerm.embed e_exn_nbe cb e
                   in
        ...
        (if w
         then
           (let uu___3 =
              let uu___4 =
                let uu___5 = FStar_Syntax_Print.term_to_string t  in
                FStar_Util.format1 "Not an embedded guard_policy: %s" uu___5
                 in
              (FStar_Errors.Warning_NotEmbedded, uu___4)  in
            FStar_Errors.log_issue t.FStar_Syntax_Syntax.pos uu___3)
         else ();
