...
let qual : FStar_Ident.lident  ->  FStar_Ident.ident  ->  FStar_Ident.lident = (fun lid id -> (let _151_90 = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns ((lid.FStar_Ident.ident)::(id)::[])))
in (FStar_Ident.set_lid_range _151_90 id.FStar_Ident.idRange)))


let qualify : env  ->  FStar_Ident.ident  ->  FStar_Ident.lident = (fun env id -> (let _151_95 = (current_module env)
in (qual _151_95 id)))
...
in (let _151_100 = (FStar_Ident.lid_of_ids (FStar_List.append (FStar_List.append (FStar_List.append cur.FStar_Ident.ns ((cur.FStar_Ident.ident)::[])) lid.FStar_Ident.ns) ((lid.FStar_Ident.ident)::[])))
in (FStar_Ident.set_lid_range _151_100 (FStar_Ident.range_of_lid lid)))))
...
| () -> begin
(let _151_104 = (new_sigmap ())
in {curmodule = None; modules = []; open_namespaces = []; modul_abbrevs = []; sigaccum = []; localbindings = []; recbindings = []; sigmap = _151_104; default_result_effect = FStar_Syntax_Const.effect_ML_lid; iface = false; admitted_iface = false; expect_typ = false})
end))
...
(let _151_123 = (let _151_122 = (FStar_Ident.lid_of_path (("Prims")::(y)::[]) id.FStar_Ident.idRange)
in (FStar_Syntax_Syntax.fvar _151_122 dd dq))
in Some (_151_123))
end else begin
None
end
...
(let _151_130 = (let _151_129 = (bv_to_name x id.FStar_Ident.idRange)
in (_151_129, mut))
in Some (_151_130))
end
| _61_88 -> begin
...
in (let _151_141 = (let _151_140 = (current_module env)
in (_151_140)::env.open_namespaces)
in (aux _151_141))))
...
let resolve_in_open_namespaces = (fun env lid finder -> (let _151_153 = (expand_module_abbrevs env lid)
in (resolve_in_open_namespaces' env _151_153 finder)))
...
let lb_fv : FStar_Syntax_Syntax.letbinding Prims.list  ->  FStar_Ident.lident  ->  FStar_Syntax_Syntax.fv = (fun lbs lid -> (let _151_162 = (FStar_Util.find_map lbs (fun lb -> (
...
in (FStar_All.pipe_right _151_162 FStar_Util.must)))
...
(let _151_175 = (let _151_174 = (let _151_173 = (FStar_Syntax_Syntax.fvar lid FStar_Syntax_Syntax.Delta_constant None)
in (_151_173, false))
in Term_name (_151_174))
in Some (_151_175))
end
| FStar_Syntax_Syntax.Sig_datacon (_61_186) -> begin
(let _151_179 = (let _151_178 = (let _151_177 = (let _151_176 = (fv_qual_of_se se)
in (FStar_Syntax_Syntax.fvar lid FStar_Syntax_Syntax.Delta_constant _151_176))
in (_151_177, false))
in Term_name (_151_178))
in Some (_151_179))
end
...
in (let _151_182 = (let _151_181 = (let _151_180 = (FStar_Syntax_Syntax.fvar lid fv.FStar_Syntax_Syntax.fv_delta fv.FStar_Syntax_Syntax.fv_qual)
in (_151_180, false))
in Term_name (_151_181))
in Some (_151_182)))
end
...
in (let _151_188 = (let _151_187 = (let _151_186 = (let _151_185 = (fv_qual_of_se se)
in (FStar_Syntax_Syntax.fvar lid dd _151_185))
in (_151_186, false))
in Term_name (_151_187))
in Some (_151_188)))
end else begin
None
end
...
(let _151_191 = (let _151_190 = (let _151_189 = (FStar_Ident.set_lid_range ne.FStar_Syntax_Syntax.mname (FStar_Ident.range_of_lid lid))
in (se, _151_189))
in Eff_name (_151_190))
in Some (_151_191))
end
...
(let _151_196 = (let _151_195 = (let _151_194 = (let _151_193 = (FStar_Ident.set_lid_range l (FStar_Ident.range_of_lid lid))
in (FStar_Syntax_Syntax.fvar _151_193 dd None))
in (_151_194, false))
in Term_name (_151_195))
in Some (_151_196))
end else begin
None
end
...
let fv = (lb_fv lbs lid)
in (let _151_232 = (FStar_Syntax_Syntax.fvar lid fv.FStar_Syntax_Syntax.fv_delta fv.FStar_Syntax_Syntax.fv_qual)
in Some (_151_232)))
end
| _61_348 -> begin
None
...
(let _151_259 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant None)
in Some (_151_259))
end else begin
None
end
...
(let _151_260 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in Some (_151_260))
end
| _61_417 -> begin
None
...
| () -> begin
(let _151_282 = (let _151_281 = (let _151_279 = (FStar_ST.read record_cache)
in (FStar_List.hd _151_279))
in (let _151_280 = (FStar_ST.read record_cache)
in (_151_281)::_151_280))
in (FStar_ST.op_Colon_Equals record_cache _151_282))
end))
in (

let pop = (fun _61_449 -> (match (()) with
| () -> begin
(let _151_286 = (let _151_285 = (FStar_ST.read record_cache)
in (FStar_List.tl _151_285))
in (FStar_ST.op_Colon_Equals record_cache _151_286))
end))
in (

let peek = (fun _61_451 -> (match (()) with
| () -> begin
(let _151_289 = (FStar_ST.read record_cache)
in (FStar_List.hd _151_289))
end))
in (

let insert = (fun r -> (let _151_296 = (let _151_295 = (let _151_292 = (peek ())
in (r)::_151_292)
in (let _151_294 = (let _151_293 = (FStar_ST.read record_cache)
in (FStar_List.tl _151_293))
in (_151_295)::_151_294))
in (FStar_ST.op_Colon_Equals record_cache _151_296)))
in (
...
(match ((let _151_399 = (find_dc dc)
in (FStar_All.pipe_left FStar_Util.must _151_399))) with
...
(let _151_403 = (let _151_402 = (let _151_401 = if is_rec then begin
(FStar_Syntax_Util.unmangle_field_name x.FStar_Syntax_Syntax.ppname)
end else begin
x.FStar_Syntax_Syntax.ppname
end
in (qual constrname _151_401))
in (_151_402, x.FStar_Syntax_Syntax.sort))
in (_151_403)::[])
end
end))))
in (
...
| (ns, fieldname) -> begin
(let _151_419 = (peek_record_cache ())
in (FStar_Util.find_map _151_419 (fun record -> (
...
(match ((let _151_471 = (FStar_Syntax_Util.lids_of_sigelt se)
in (FStar_Util.find_opt (FStar_Ident.lid_equals l) _151_471))) with
| Some (l) -> begin
...
in (let _151_474 = (let _151_473 = (let _151_472 = (FStar_Util.format2 "Duplicate top-level names [%s]; previously declared at %s" (FStar_Ident.text_of_lid l) r)
in (_151_472, (FStar_Ident.range_of_lid l)))
in FStar_Syntax_Syntax.Error (_151_473))
in (Prims.raise _151_474)))))
in (
...
(let _151_478 = (FStar_List.map (fun se -> (let _151_477 = (FStar_Syntax_Util.lids_of_sigelt se)
in (_151_477, se))) ses)
in (env, _151_478))
end
| _61_734 -> begin
(let _151_481 = (let _151_480 = (let _151_479 = (FStar_Syntax_Util.lids_of_sigelt s)
in (_151_479, s))
in (_151_480)::[])
in (env, _151_481))
end)
...
(let _151_491 = (let _151_490 = (let _151_489 = (FStar_Util.format1 "Namespace %s cannot be found" (FStar_Ident.text_of_lid ns))
in (_151_489, (FStar_Ident.range_of_lid ns)))
in FStar_Syntax_Syntax.Error (_151_490))
in (Prims.raise _151_491))
end))
...
(let _151_501 = (let _151_500 = (let _151_499 = (FStar_Util.format1 "Module %s is already defined" x.FStar_Ident.idText)
in (_151_499, x.FStar_Ident.idRange))
in FStar_Syntax_Syntax.Error (_151_500))
in (Prims.raise _151_501))
end else begin
(
...
(let _151_505 = (let _151_504 = (let _151_503 = (FStar_Util.format1 "Module %s cannot be found" (FStar_Ident.text_of_lid l))
in (_151_503, (FStar_Ident.range_of_lid l)))
in FStar_Syntax_Syntax.Error (_151_504))
in (Prims.raise _151_505))
end)
end)
...
let _61_777 = (let _151_511 = (let _151_510 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid l))
in (let _151_509 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format2 "%s: Warning: Admitting %s without a definition\n" _151_510 _151_509)))
in (FStar_Util.print_string _151_511))
...
(FStar_All.pipe_right lbs (FStar_List.iter (fun lb -> (let _151_522 = (let _151_521 = (let _151_520 = (let _151_519 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _151_519.FStar_Syntax_Syntax.fv_name)
in _151_520.FStar_Syntax_Syntax.v)
in _151_521.FStar_Ident.str)
in (FStar_Util.smap_remove (sigmap env) _151_522)))))
end else begin
()
end
...
let lid = (let _151_525 = (let _151_524 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _151_524.FStar_Syntax_Syntax.fv_name)
in _151_525.FStar_Syntax_Syntax.v)
in (
...
let _61_858 = (let _151_575 = (let _151_574 = (FStar_ST.read stack)
in (env)::_151_574)
in (FStar_ST.op_Colon_Equals stack _151_575))
in (

let _61_860 = env
in (let _151_576 = (FStar_Util.smap_copy (sigmap env))
in {curmodule = _61_860.curmodule; modules = _61_860.modules; open_namespaces = _61_860.open_namespaces; modul_abbrevs = _61_860.modul_abbrevs; sigaccum = _61_860.sigaccum; localbindings = _61_860.localbindings; recbindings = _61_860.recbindings; sigmap = _151_576; default_result_effect = _61_860.default_result_effect; iface = _61_860.iface; admitted_iface = _61_860.admitted_iface; expect_typ = _61_860.expect_typ})))))
in (
...
(let _151_616 = (let _151_615 = (let _151_614 = (FStar_Util.format1 "Duplicate module or interface name: %s" mname.FStar_Ident.str)
in (_151_614, (FStar_Ident.range_of_lid mname)))
in FStar_Syntax_Syntax.Error (_151_615))
in (Prims.raise _151_616))
end else begin
()
end
in (let _151_618 = (let _151_617 = (push env)
in (prep _151_617))
in (_151_618, true)))
end)))
...
let module_of_the_lid = (let _151_634 = (FStar_Ident.path_of_ns lid.FStar_Ident.ns)
in (FStar_Ident.text_of_path _151_634))
in (
...
| _61_979 -> begin
(let _151_638 = (let _151_637 = (let _151_636 = (FStar_Ident.path_of_ns lid.FStar_Ident.ns)
in (FStar_Ident.text_of_path _151_636))
in (FStar_Util.format3 "Hint: %s belongs to module %s, which does not belong to the list of modules in scope, namely %s" (FStar_Ident.text_of_lid lid) _151_637 (FStar_String.concat ", " opened_modules)))
