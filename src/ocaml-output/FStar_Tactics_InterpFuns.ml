...
let uu____8170 = (extract_2 ea eb ncb args)
in (FStar_Util.bind_opt uu____8170 (fun uu____8186 -> (match (uu____8186) with
| (a, b) -> begin
(
...
let uu____8197 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed er uu____8197 r ncb))
in FStar_Pervasives_Native.Some (uu____8196)))
end)))))
...
let uu____8255 = (extract_1_nbe cb ea args)
in (FStar_Util.bind_opt uu____8255 (fun a -> (

let r = (f a)
in (

let uu____8263 = (FStar_TypeChecker_NBETerm.embed er cb r)
in FStar_Pervasives_Native.Some (uu____8263)))))))
...
let uu____8340 = (extract_2_nbe cb ea eb args)
in (FStar_Util.bind_opt uu____8340 (fun uu____8356 -> (match (uu____8356) with
| (a, b) -> begin
(
...
let uu____8366 = (FStar_TypeChecker_NBETerm.embed er cb r)
in FStar_Pervasives_Native.Some (uu____8366)))
end)))))
...
let uu____8472 = (drop nunivs args)
in (mk_total_nbe_interpretation_1 cb nf nea ner uu____8472)))))
...
let uu____8620 = (drop nunivs args)
in (mk_total_nbe_interpretation_2 cb nf nea neb ner uu____8620)))))
