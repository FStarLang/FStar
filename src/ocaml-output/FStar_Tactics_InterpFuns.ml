...
let unembed : 'Auu____8 . 'Auu____8 FStar_Syntax_Embeddings.embedding  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Embeddings.norm_cb  ->  'Auu____8 FStar_Pervasives_Native.option = (fun e t n1 -> (

let uu____32 = (FStar_Syntax_Embeddings.unembed e t)
in (uu____32 true n1)))


let embed : 'Auu____51 . 'Auu____51 FStar_Syntax_Embeddings.embedding  ->  FStar_Range.range  ->  'Auu____51  ->  FStar_Syntax_Embeddings.norm_cb  ->  FStar_Syntax_Syntax.term = (fun e rng t n1 -> (

let uu____78 = (FStar_Syntax_Embeddings.embed e t)
in (uu____78 rng FStar_Pervasives_Native.None n1)))
...
let uu____146 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____146 (fun a1 -> FStar_Pervasives_Native.Some (a1))))
end
| uu____151 -> begin
...
| ((a, uu____207))::((b, uu____209))::[] -> begin
(

let uu____250 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____250 (fun a1 -> (

let uu____260 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____260 (fun b1 -> FStar_Pervasives_Native.Some (((a1), (b1)))))))))
end
| uu____273 -> begin
...
| ((a, uu____349))::((b, uu____351))::((c, uu____353))::[] -> begin
(

let uu____410 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____410 (fun a1 -> (

let uu____422 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____422 (fun b1 -> (

let uu____434 = (unembed ec c ncb)
in (FStar_Util.bind_opt uu____434 (fun c1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1))))))))))))
end
| uu____451 -> begin
...
| ((a, uu____545))::((b, uu____547))::((c, uu____549))::((d, uu____551))::[] -> begin
(

let uu____624 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____624 (fun a1 -> (

let uu____638 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____638 (fun b1 -> (

let uu____652 = (unembed ec c ncb)
in (FStar_Util.bind_opt uu____652 (fun c1 -> (

let uu____666 = (unembed ed d ncb)
in (FStar_Util.bind_opt uu____666 (fun d1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1)))))))))))))))
end
| uu____687 -> begin
...
| ((a, uu____799))::((b, uu____801))::((c, uu____803))::((d, uu____805))::((e, uu____807))::[] -> begin
(

let uu____896 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____896 (fun a1 -> (

let uu____912 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____912 (fun b1 -> (

let uu____928 = (unembed ec c ncb)
in (FStar_Util.bind_opt uu____928 (fun c1 -> (

let uu____944 = (unembed ed d ncb)
in (FStar_Util.bind_opt uu____944 (fun d1 -> (

let uu____960 = (unembed ee e ncb)
in (FStar_Util.bind_opt uu____960 (fun e1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1))))))))))))))))))
end
| uu____985 -> begin
...
| ((a, uu____1115))::((b, uu____1117))::((c, uu____1119))::((d, uu____1121))::((e, uu____1123))::((f, uu____1125))::[] -> begin
(

let uu____1230 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____1230 (fun a1 -> (

let uu____1248 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____1248 (fun b1 -> (

let uu____1266 = (unembed ec c ncb)
in (FStar_Util.bind_opt uu____1266 (fun c1 -> (

let uu____1284 = (unembed ed d ncb)
in (FStar_Util.bind_opt uu____1284 (fun d1 -> (

let uu____1302 = (unembed ee e ncb)
in (FStar_Util.bind_opt uu____1302 (fun e1 -> (

let uu____1320 = (unembed ef f ncb)
in (FStar_Util.bind_opt uu____1320 (fun f1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1), (f1)))))))))))))))))))))
end
| uu____1349 -> begin
...
| ((a, uu____1497))::((b, uu____1499))::((c, uu____1501))::((d, uu____1503))::((e, uu____1505))::((f, uu____1507))::((g, uu____1509))::[] -> begin
(

let uu____1630 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____1630 (fun a1 -> (

let uu____1650 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____1650 (fun b1 -> (

let uu____1670 = (unembed ec c ncb)
in (FStar_Util.bind_opt uu____1670 (fun c1 -> (

let uu____1690 = (unembed ed d ncb)
in (FStar_Util.bind_opt uu____1690 (fun d1 -> (

let uu____1710 = (unembed ee e ncb)
in (FStar_Util.bind_opt uu____1710 (fun e1 -> (

let uu____1730 = (unembed ef f ncb)
in (FStar_Util.bind_opt uu____1730 (fun f1 -> (

let uu____1750 = (unembed eg g ncb)
in (FStar_Util.bind_opt uu____1750 (fun g1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1), (f1), (g1))))))))))))))))))))))))
end
| uu____1783 -> begin
...
| ((a1, uu____2045))::((a2, uu____2047))::((a3, uu____2049))::((a4, uu____2051))::((a5, uu____2053))::((a6, uu____2055))::((a7, uu____2057))::((a8, uu____2059))::((a9, uu____2061))::((a10, uu____2063))::((a11, uu____2065))::((a12, uu____2067))::((a13, uu____2069))::((a14, uu____2071))::[] -> begin
(

let uu____2304 = (unembed e_t1 a1 ncb)
in (FStar_Util.bind_opt uu____2304 (fun a15 -> (

let uu____2338 = (unembed e_t2 a2 ncb)
in (FStar_Util.bind_opt uu____2338 (fun a21 -> (

let uu____2372 = (unembed e_t3 a3 ncb)
in (FStar_Util.bind_opt uu____2372 (fun a31 -> (

let uu____2406 = (unembed e_t4 a4 ncb)
in (FStar_Util.bind_opt uu____2406 (fun a41 -> (

let uu____2440 = (unembed e_t5 a5 ncb)
in (FStar_Util.bind_opt uu____2440 (fun a51 -> (

let uu____2474 = (unembed e_t6 a6 ncb)
in (FStar_Util.bind_opt uu____2474 (fun a61 -> (

let uu____2508 = (unembed e_t7 a7 ncb)
in (FStar_Util.bind_opt uu____2508 (fun a71 -> (

let uu____2542 = (unembed e_t8 a8 ncb)
in (FStar_Util.bind_opt uu____2542 (fun a81 -> (

let uu____2576 = (unembed e_t9 a9 ncb)
in (FStar_Util.bind_opt uu____2576 (fun a91 -> (

let uu____2610 = (unembed e_t10 a10 ncb)
in (FStar_Util.bind_opt uu____2610 (fun a101 -> (

let uu____2644 = (unembed e_t11 a11 ncb)
in (FStar_Util.bind_opt uu____2644 (fun a111 -> (

let uu____2678 = (unembed e_t12 a12 ncb)
in (FStar_Util.bind_opt uu____2678 (fun a121 -> (

let uu____2712 = (unembed e_t13 a13 ncb)
in (FStar_Util.bind_opt uu____2712 (fun a131 -> (

let uu____2746 = (unembed e_t14 a14 ncb)
in (FStar_Util.bind_opt uu____2746 (fun a141 -> FStar_Pervasives_Native.Some (((a15), (a21), (a31), (a41), (a51), (a61), (a71), (a81), (a91), (a101), (a111), (a121), (a131), (a141)))))))))))))))))))))))))))))))))))))))))))))
end
| uu____2807 -> begin
...
let uu____2880 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____2880 (fun a1 -> FStar_Pervasives_Native.Some (a1))))
end
| uu____2885 -> begin
...
| ((a, uu____2939))::((b, uu____2941))::[] -> begin
(

let uu____2954 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____2954 (fun a1 -> (

let uu____2964 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____2964 (fun b1 -> FStar_Pervasives_Native.Some (((a1), (b1)))))))))
end
| uu____2977 -> begin
...
| ((a, uu____3051))::((b, uu____3053))::((c, uu____3055))::[] -> begin
(

let uu____3072 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____3072 (fun a1 -> (

let uu____3084 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____3084 (fun b1 -> (

let uu____3096 = (FStar_TypeChecker_NBETerm.unembed ec cb c)
in (FStar_Util.bind_opt uu____3096 (fun c1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1))))))))))))
end
| uu____3113 -> begin
...
| ((a, uu____3205))::((b, uu____3207))::((c, uu____3209))::((d, uu____3211))::[] -> begin
(

let uu____3232 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____3232 (fun a1 -> (

let uu____3246 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____3246 (fun b1 -> (

let uu____3260 = (FStar_TypeChecker_NBETerm.unembed ec cb c)
in (FStar_Util.bind_opt uu____3260 (fun c1 -> (

let uu____3274 = (FStar_TypeChecker_NBETerm.unembed ed cb d)
in (FStar_Util.bind_opt uu____3274 (fun d1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1)))))))))))))))
end
| uu____3295 -> begin
...
| ((a, uu____3405))::((b, uu____3407))::((c, uu____3409))::((d, uu____3411))::((e, uu____3413))::[] -> begin
(

let uu____3438 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____3438 (fun a1 -> (

let uu____3454 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____3454 (fun b1 -> (

let uu____3470 = (FStar_TypeChecker_NBETerm.unembed ec cb c)
in (FStar_Util.bind_opt uu____3470 (fun c1 -> (

let uu____3486 = (FStar_TypeChecker_NBETerm.unembed ed cb d)
in (FStar_Util.bind_opt uu____3486 (fun d1 -> (

let uu____3502 = (FStar_TypeChecker_NBETerm.unembed ee cb e)
in (FStar_Util.bind_opt uu____3502 (fun e1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1))))))))))))))))))
end
| uu____3527 -> begin
...
| ((a, uu____3655))::((b, uu____3657))::((c, uu____3659))::((d, uu____3661))::((e, uu____3663))::((f, uu____3665))::[] -> begin
(

let uu____3694 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____3694 (fun a1 -> (

let uu____3712 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____3712 (fun b1 -> (

let uu____3730 = (FStar_TypeChecker_NBETerm.unembed ec cb c)
in (FStar_Util.bind_opt uu____3730 (fun c1 -> (

let uu____3748 = (FStar_TypeChecker_NBETerm.unembed ed cb d)
in (FStar_Util.bind_opt uu____3748 (fun d1 -> (

let uu____3766 = (FStar_TypeChecker_NBETerm.unembed ee cb e)
in (FStar_Util.bind_opt uu____3766 (fun e1 -> (

let uu____3784 = (FStar_TypeChecker_NBETerm.unembed ef cb f)
in (FStar_Util.bind_opt uu____3784 (fun f1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1), (f1)))))))))))))))))))))
end
| uu____3813 -> begin
...
| ((a, uu____3959))::((b, uu____3961))::((c, uu____3963))::((d, uu____3965))::((e, uu____3967))::((f, uu____3969))::((g, uu____3971))::[] -> begin
(

let uu____4004 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____4004 (fun a1 -> (

let uu____4024 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____4024 (fun b1 -> (

let uu____4044 = (FStar_TypeChecker_NBETerm.unembed ec cb c)
in (FStar_Util.bind_opt uu____4044 (fun c1 -> (

let uu____4064 = (FStar_TypeChecker_NBETerm.unembed ed cb d)
in (FStar_Util.bind_opt uu____4064 (fun d1 -> (

let uu____4084 = (FStar_TypeChecker_NBETerm.unembed ee cb e)
in (FStar_Util.bind_opt uu____4084 (fun e1 -> (

let uu____4104 = (FStar_TypeChecker_NBETerm.unembed ef cb f)
in (FStar_Util.bind_opt uu____4104 (fun f1 -> (

let uu____4124 = (FStar_TypeChecker_NBETerm.unembed eg cb g)
in (FStar_Util.bind_opt uu____4124 (fun g1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1), (f1), (g1))))))))))))))))))))))))
end
| uu____4157 -> begin
...
let uu____4245 = (extract_2 ea FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____4245 (fun uu____4262 -> (match (uu____4262) with
| (a, ps) -> begin
(
...
let uu____4275 = (t a)
in (FStar_Tactics_Basic.run_safe uu____4275 ps1))
in (
...
in (embed uu____4279 uu____4284 r ncb)))
in FStar_Pervasives_Native.Some (uu____4278))))
end)))))
...
let uu____4376 = (extract_3 ea eb FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____4376 (fun uu____4398 -> (match (uu____4398) with
| (a, b, ps) -> begin
(
...
let uu____4414 = (t a b)
in (FStar_Tactics_Basic.run_safe uu____4414 ps1))
in (

let uu____4417 = (

let uu____4418 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____4423 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____4418 uu____4423 r ncb)))
in FStar_Pervasives_Native.Some (uu____4417))))
end)))))
...
let uu____4534 = (extract_4 ea eb ec FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____4534 (fun uu____4561 -> (match (uu____4561) with
| (a, b, c, ps) -> begin
(
...
let uu____4580 = (t a b c)
in (FStar_Tactics_Basic.run_safe uu____4580 ps1))
in (

let uu____4583 = (

let uu____4584 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____4589 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____4584 uu____4589 r ncb)))
...
let uu____4719 = (extract_5 ea eb ec ed FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____4719 (fun uu____4751 -> (match (uu____4751) with
| (a, b, c, d, ps) -> begin
(
...
let uu____4773 = (t a b c d)
in (FStar_Tactics_Basic.run_safe uu____4773 ps1))
in (

let uu____4776 = (

let uu____4777 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____4782 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____4777 uu____4782 r ncb)))
in FStar_Pervasives_Native.Some (uu____4776))))
end)))))
...
let uu____4931 = (extract_6 ea eb ec ed ee FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____4931 (fun uu____4968 -> (match (uu____4968) with
| (a, b, c, d, e, ps) -> begin
(
...
let uu____4993 = (t a b c d e)
in (FStar_Tactics_Basic.run_safe uu____4993 ps1))
in (

let uu____4996 = (

let uu____4997 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____5002 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____4997 uu____5002 r ncb)))
in FStar_Pervasives_Native.Some (uu____4996))))
end)))))
...
let uu____5170 = (extract_7 ea eb ec ed ee ef FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____5170 (fun uu____5212 -> (match (uu____5212) with
...
let uu____5240 = (t a b c d e f)
in (FStar_Tactics_Basic.run_safe uu____5240 ps1))
in (

let uu____5243 = (

let uu____5244 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____5249 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____5244 uu____5249 r ncb)))
...
let uu____5550 = (extract_14 e_t1 e_t2 e_t3 e_t4 e_t5 e_t6 e_t7 e_t8 e_t9 e_t10 e_t11 e_t12 e_t13 FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____5550 (fun uu____5627 -> (match (uu____5627) with
...
let uu____5676 = (t a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11 a12 a13)
in (FStar_Tactics_Basic.run_safe uu____5676 ps1))
in (

let uu____5679 = (

let uu____5680 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____5685 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____5680 uu____5685 r ncb)))
in FStar_Pervasives_Native.Some (uu____5679))))
end)))))
...
let uu____5749 = (extract_2_nbe cb ea FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____5749 (fun uu____5765 -> (match (uu____5765) with
| (a, ps) -> begin
(
...
let uu____5777 = (t a)
in (FStar_Tactics_Basic.run_safe uu____5777 ps))
in (

let uu____5780 = (

let uu____5781 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____5781 cb r))
in FStar_Pervasives_Native.Some (uu____5780)))
end)))))
...
let uu____5868 = (extract_3_nbe cb ea eb FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____5868 (fun uu____5889 -> (match (uu____5889) with
| (a, b, ps) -> begin
(

let r = (

let uu____5904 = (t a b)
in (FStar_Tactics_Basic.run_safe uu____5904 ps))
in (

let uu____5907 = (

let uu____5908 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____5908 cb r))
in FStar_Pervasives_Native.Some (uu____5907)))
end)))))
...
let uu____6014 = (extract_4_nbe cb ea eb ec FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____6014 (fun uu____6040 -> (match (uu____6040) with
| (a, b, c, ps) -> begin
(

let r = (

let uu____6058 = (t a b c)
in (FStar_Tactics_Basic.run_safe uu____6058 ps))
in (

let uu____6061 = (

let uu____6062 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____6062 cb r))
in FStar_Pervasives_Native.Some (uu____6061)))
end)))))
...
let uu____6187 = (extract_5_nbe cb ea eb ec ed FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____6187 (fun uu____6218 -> (match (uu____6218) with
| (a, b, c, d, ps) -> begin
(

let r = (

let uu____6239 = (t a b c d)
in (FStar_Tactics_Basic.run_safe uu____6239 ps))
in (

let uu____6242 = (

let uu____6243 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____6243 cb r))
in FStar_Pervasives_Native.Some (uu____6242)))
end)))))
...
let uu____6387 = (extract_6_nbe cb ea eb ec ed ee FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____6387 (fun uu____6423 -> (match (uu____6423) with
| (a, b, c, d, e, ps) -> begin
(

let r = (

let uu____6447 = (t a b c d e)
in (FStar_Tactics_Basic.run_safe uu____6447 ps))
in (

let uu____6450 = (

let uu____6451 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____6451 cb r))
...
let uu____6614 = (extract_7_nbe cb ea eb ec ed ee ef FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____6614 (fun uu____6655 -> (match (uu____6655) with
| (a, b, c, d, e, f, ps) -> begin
(

let r = (

let uu____6682 = (t a b c d e f)
in (FStar_Tactics_Basic.run_safe uu____6682 ps))
in (

let uu____6685 = (

let uu____6686 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____6686 cb r))
in FStar_Pervasives_Native.Some (uu____6685)))
end)))))
...
let timing_int : 'Auu____6724 'Auu____6725 'Auu____6726 'Auu____6727 . FStar_Ident.lid  ->  ('Auu____6724  ->  'Auu____6725  ->  'Auu____6726  ->  'Auu____6727)  ->  'Auu____6724  ->  'Auu____6725  ->  'Auu____6726  ->  'Auu____6727 = (fun l f psc cb args -> (

let r = (f psc cb args)
in r))


let timing_nbe : 'Auu____6784 'Auu____6785 'Auu____6786 . FStar_Ident.lid  ->  ('Auu____6784  ->  'Auu____6785  ->  'Auu____6786)  ->  'Auu____6784  ->  'Auu____6785  ->  'Auu____6786 = (fun l f nbe_cbs args -> (
...
let native_tactics : unit  ->  FStar_Tactics_Native.native_primitive_step Prims.list = (fun uu____6906 -> (FStar_Tactics_Native.list_all ()))


let native_tactics_steps : unit  ->  FStar_TypeChecker_Cfg.primitive_step Prims.list = (fun uu____6914 -> (

let uu____6915 = (native_tactics ())
in (FStar_List.map step_from_native_step uu____6915)))


let rec drop : 'Auu____6925 . Prims.int  ->  'Auu____6925 Prims.list  ->  'Auu____6925 Prims.list = (fun n1 l -> (match ((Prims.op_Equality n1 (Prims.parse_int "0"))) with
| true -> begin
l
end
| uu____6947 -> begin
...
let uu____7072 = (drop nunivs args)
in (mk_tactic_nbe_interpretation_1 cb nf nea ner uu____7072)))))
...
let uu____7228 = (drop nunivs args)
in (mk_tactic_nbe_interpretation_2 cb nf nea neb ner uu____7228)))))
...
let uu____7422 = (drop nunivs args)
in (mk_tactic_nbe_interpretation_3 cb nf nea neb nec ner uu____7422)))))
...
let uu____7654 = (drop nunivs args)
in (mk_tactic_nbe_interpretation_4 cb nf nea neb nec ned ner uu____7654)))))
...
in (mk_tactic_nbe_interpretation_5 cb nf nea neb nec ned nee ner uu____7924)))))


let mkt : Prims.string  ->  Prims.int  ->  Prims.int  ->  (FStar_TypeChecker_Cfg.psc  ->  FStar_Syntax_Embeddings.norm_cb  ->  FStar_Syntax_Syntax.args  ->  FStar_Syntax_Syntax.term FStar_Pervasives_Native.option)  ->  (FStar_TypeChecker_NBETerm.nbe_cbs  ->  FStar_TypeChecker_NBETerm.args  ->  FStar_TypeChecker_NBETerm.t FStar_Pervasives_Native.option)  ->  FStar_TypeChecker_Cfg.primitive_step = (fun nm arity nunivs interp nbe_interp -> (

let nm1 = (FStar_Tactics_Embedding.fstar_tactics_lid' (("Builtins")::(nm)::[]))
in {FStar_TypeChecker_Cfg.name = nm1; FStar_TypeChecker_Cfg.arity = arity; FStar_TypeChecker_Cfg.univ_arity = nunivs; FStar_TypeChecker_Cfg.auto_reflect = FStar_Pervasives_Native.None; FStar_TypeChecker_Cfg.strong_reduction_ok = true; FStar_TypeChecker_Cfg.requires_binder_substitution = true; FStar_TypeChecker_Cfg.interpretation = (timing_int nm1 interp); FStar_TypeChecker_Cfg.interpretation_nbe = (timing_nbe nm1 nbe_interp)}))
...
let uu____8075 = (extract_1 ea ncb args)
in (FStar_Util.bind_opt uu____8075 (fun a -> (
...
let uu____8084 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed er uu____8084 r ncb))
in FStar_Pervasives_Native.Some (uu____8083)))))))


let mk_total_interpretation_1_psc : 'a 'r . (FStar_TypeChecker_Cfg.psc  ->  'a  ->  'r)  ->  'a FStar_Syntax_Embeddings.embedding  ->  'r FStar_Syntax_Embeddings.embedding  ->  FStar_TypeChecker_Cfg.psc  ->  FStar_Syntax_Embeddings.norm_cb  ->  FStar_Syntax_Syntax.args  ->  FStar_Syntax_Syntax.term FStar_Pervasives_Native.option = (fun f ea er psc ncb args -> (

let uu____8156 = (extract_1 ea ncb args)
in (FStar_Util.bind_opt uu____8156 (fun a -> (
...
let uu____8165 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed er uu____8165 r ncb))
...
let uu____8251 = (extract_2 ea eb ncb args)
in (FStar_Util.bind_opt uu____8251 (fun uu____8267 -> (match (uu____8267) with
| (a, b) -> begin
(
...
let uu____8278 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed er uu____8278 r ncb))
in FStar_Pervasives_Native.Some (uu____8277)))
end)))))
...
let uu____8336 = (extract_1_nbe cb ea args)
in (FStar_Util.bind_opt uu____8336 (fun a -> (

let r = (f a)
in (

let uu____8344 = (FStar_TypeChecker_NBETerm.embed er cb r)
in FStar_Pervasives_Native.Some (uu____8344)))))))


let mk_total_nbe_interpretation_1_psc : 'a 'r . FStar_TypeChecker_NBETerm.nbe_cbs  ->  (FStar_TypeChecker_Cfg.psc  ->  'a  ->  'r)  ->  'a FStar_TypeChecker_NBETerm.embedding  ->  'r FStar_TypeChecker_NBETerm.embedding  ->  FStar_TypeChecker_NBETerm.args  ->  FStar_TypeChecker_NBETerm.t FStar_Pervasives_Native.option = (fun cb f ea er args -> (

let uu____8407 = (extract_1_nbe cb ea args)
in (FStar_Util.bind_opt uu____8407 (fun a -> (

let r = (f FStar_TypeChecker_Cfg.null_psc a)
in (

let uu____8415 = (FStar_TypeChecker_NBETerm.embed er cb r)
in FStar_Pervasives_Native.Some (uu____8415)))))))
...
let uu____8492 = (extract_2_nbe cb ea eb args)
in (FStar_Util.bind_opt uu____8492 (fun uu____8508 -> (match (uu____8508) with
| (a, b) -> begin
(
...
let uu____8518 = (FStar_TypeChecker_NBETerm.embed er cb r)
in FStar_Pervasives_Native.Some (uu____8518)))
end)))))
...
let uu____8624 = (drop nunivs args)
in (mk_total_nbe_interpretation_1 cb nf nea ner uu____8624)))))


let mktot1_psc : 'a 'na 'nr 'r . Prims.int  ->  Prims.string  ->  (FStar_TypeChecker_Cfg.psc  ->  'a  ->  'r)  ->  'a FStar_Syntax_Embeddings.embedding  ->  'r FStar_Syntax_Embeddings.embedding  ->  (FStar_TypeChecker_Cfg.psc  ->  'na  ->  'nr)  ->  'na FStar_TypeChecker_NBETerm.embedding  ->  'nr FStar_TypeChecker_NBETerm.embedding  ->  FStar_TypeChecker_Cfg.primitive_step = (fun nunivs name f ea er nf nea ner -> (mkt name (Prims.parse_int "1") nunivs (mk_total_interpretation_1_psc f ea er) (fun cb args -> (

let uu____8744 = (drop nunivs args)
in (mk_total_nbe_interpretation_1_psc cb nf nea ner uu____8744)))))
...
let uu____8892 = (drop nunivs args)
in (mk_total_nbe_interpretation_2 cb nf nea neb ner uu____8892)))))
