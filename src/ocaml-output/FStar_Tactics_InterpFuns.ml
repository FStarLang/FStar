...
let embed : 'Auu____58 . 'Auu____58 FStar_Syntax_Embeddings.embedding  ->  FStar_Range.range  ->  'Auu____58  ->  FStar_Syntax_Embeddings.norm_cb  ->  FStar_Syntax_Syntax.term = (fun e rng t n1 -> (

let uu____87 = (FStar_Syntax_Embeddings.embed e t)
in (uu____87 rng FStar_Pervasives_Native.None n1)))
...
let uu____181 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____181 (fun a1 -> FStar_Pervasives_Native.Some (a1))))
end
| uu____188 -> begin
...
| ((a, uu____244))::((b, uu____246))::[] -> begin
(

let uu____287 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____287 (fun a1 -> (

let uu____299 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____299 (fun b1 -> FStar_Pervasives_Native.Some (((a1), (b1)))))))))
end
| uu____314 -> begin
...
| ((a, uu____390))::((b, uu____392))::((c, uu____394))::[] -> begin
(

let uu____451 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____451 (fun a1 -> (

let uu____465 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____465 (fun b1 -> (

let uu____479 = (unembed ec c ncb)
in (FStar_Util.bind_opt uu____479 (fun c1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1))))))))))))
end
| uu____498 -> begin
...
| ((a, uu____592))::((b, uu____594))::((c, uu____596))::((d, uu____598))::[] -> begin
(

let uu____671 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____671 (fun a1 -> (

let uu____687 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____687 (fun b1 -> (

let uu____703 = (unembed ec c ncb)
in (FStar_Util.bind_opt uu____703 (fun c1 -> (

let uu____719 = (unembed ed d ncb)
in (FStar_Util.bind_opt uu____719 (fun d1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1)))))))))))))))
end
| uu____742 -> begin
...
| ((a, uu____854))::((b, uu____856))::((c, uu____858))::((d, uu____860))::((e, uu____862))::[] -> begin
(

let uu____951 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____951 (fun a1 -> (

let uu____969 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____969 (fun b1 -> (

let uu____987 = (unembed ec c ncb)
in (FStar_Util.bind_opt uu____987 (fun c1 -> (

let uu____1005 = (unembed ed d ncb)
in (FStar_Util.bind_opt uu____1005 (fun d1 -> (

let uu____1023 = (unembed ee e ncb)
in (FStar_Util.bind_opt uu____1023 (fun e1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1))))))))))))))))))
end
| uu____1050 -> begin
...
| ((a, uu____1180))::((b, uu____1182))::((c, uu____1184))::((d, uu____1186))::((e, uu____1188))::((f, uu____1190))::[] -> begin
(

let uu____1295 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____1295 (fun a1 -> (

let uu____1315 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____1315 (fun b1 -> (

let uu____1335 = (unembed ec c ncb)
in (FStar_Util.bind_opt uu____1335 (fun c1 -> (

let uu____1355 = (unembed ed d ncb)
in (FStar_Util.bind_opt uu____1355 (fun d1 -> (

let uu____1375 = (unembed ee e ncb)
in (FStar_Util.bind_opt uu____1375 (fun e1 -> (

let uu____1395 = (unembed ef f ncb)
in (FStar_Util.bind_opt uu____1395 (fun f1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1), (f1)))))))))))))))))))))
end
| uu____1426 -> begin
...
| ((a, uu____1574))::((b, uu____1576))::((c, uu____1578))::((d, uu____1580))::((e, uu____1582))::((f, uu____1584))::((g, uu____1586))::[] -> begin
(

let uu____1707 = (unembed ea a ncb)
in (FStar_Util.bind_opt uu____1707 (fun a1 -> (

let uu____1729 = (unembed eb b ncb)
in (FStar_Util.bind_opt uu____1729 (fun b1 -> (

let uu____1751 = (unembed ec c ncb)
in (FStar_Util.bind_opt uu____1751 (fun c1 -> (

let uu____1773 = (unembed ed d ncb)
in (FStar_Util.bind_opt uu____1773 (fun d1 -> (

let uu____1795 = (unembed ee e ncb)
in (FStar_Util.bind_opt uu____1795 (fun e1 -> (

let uu____1817 = (unembed ef f ncb)
in (FStar_Util.bind_opt uu____1817 (fun f1 -> (

let uu____1839 = (unembed eg g ncb)
in (FStar_Util.bind_opt uu____1839 (fun g1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1), (f1), (g1))))))))))))))))))))))))
end
| uu____1874 -> begin
...
| ((a1, uu____2136))::((a2, uu____2138))::((a3, uu____2140))::((a4, uu____2142))::((a5, uu____2144))::((a6, uu____2146))::((a7, uu____2148))::((a8, uu____2150))::((a9, uu____2152))::((a10, uu____2154))::((a11, uu____2156))::((a12, uu____2158))::((a13, uu____2160))::((a14, uu____2162))::[] -> begin
(

let uu____2395 = (unembed e_t1 a1 ncb)
in (FStar_Util.bind_opt uu____2395 (fun a15 -> (

let uu____2431 = (unembed e_t2 a2 ncb)
in (FStar_Util.bind_opt uu____2431 (fun a21 -> (

let uu____2467 = (unembed e_t3 a3 ncb)
in (FStar_Util.bind_opt uu____2467 (fun a31 -> (

let uu____2503 = (unembed e_t4 a4 ncb)
in (FStar_Util.bind_opt uu____2503 (fun a41 -> (

let uu____2539 = (unembed e_t5 a5 ncb)
in (FStar_Util.bind_opt uu____2539 (fun a51 -> (

let uu____2575 = (unembed e_t6 a6 ncb)
in (FStar_Util.bind_opt uu____2575 (fun a61 -> (

let uu____2611 = (unembed e_t7 a7 ncb)
in (FStar_Util.bind_opt uu____2611 (fun a71 -> (

let uu____2647 = (unembed e_t8 a8 ncb)
in (FStar_Util.bind_opt uu____2647 (fun a81 -> (

let uu____2683 = (unembed e_t9 a9 ncb)
in (FStar_Util.bind_opt uu____2683 (fun a91 -> (

let uu____2719 = (unembed e_t10 a10 ncb)
in (FStar_Util.bind_opt uu____2719 (fun a101 -> (

let uu____2755 = (unembed e_t11 a11 ncb)
in (FStar_Util.bind_opt uu____2755 (fun a111 -> (

let uu____2791 = (unembed e_t12 a12 ncb)
in (FStar_Util.bind_opt uu____2791 (fun a121 -> (

let uu____2827 = (unembed e_t13 a13 ncb)
in (FStar_Util.bind_opt uu____2827 (fun a131 -> (

let uu____2863 = (unembed e_t14 a14 ncb)
in (FStar_Util.bind_opt uu____2863 (fun a141 -> FStar_Pervasives_Native.Some (((a15), (a21), (a31), (a41), (a51), (a61), (a71), (a81), (a91), (a101), (a111), (a121), (a131), (a141)))))))))))))))))))))))))))))))))))))))))))))
end
| uu____2926 -> begin
...
let uu____2997 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____2997 (fun a1 -> FStar_Pervasives_Native.Some (a1))))
end
| uu____3002 -> begin
...
| ((a, uu____3054))::((b, uu____3056))::[] -> begin
(

let uu____3069 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____3069 (fun a1 -> (

let uu____3079 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____3079 (fun b1 -> FStar_Pervasives_Native.Some (((a1), (b1)))))))))
end
| uu____3092 -> begin
...
| ((a, uu____3164))::((b, uu____3166))::((c, uu____3168))::[] -> begin
(

let uu____3185 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____3185 (fun a1 -> (

let uu____3197 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____3197 (fun b1 -> (

let uu____3209 = (FStar_TypeChecker_NBETerm.unembed ec cb c)
in (FStar_Util.bind_opt uu____3209 (fun c1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1))))))))))))
end
| uu____3226 -> begin
...
| ((a, uu____3316))::((b, uu____3318))::((c, uu____3320))::((d, uu____3322))::[] -> begin
(

let uu____3343 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____3343 (fun a1 -> (

let uu____3357 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____3357 (fun b1 -> (

let uu____3371 = (FStar_TypeChecker_NBETerm.unembed ec cb c)
in (FStar_Util.bind_opt uu____3371 (fun c1 -> (

let uu____3385 = (FStar_TypeChecker_NBETerm.unembed ed cb d)
in (FStar_Util.bind_opt uu____3385 (fun d1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1)))))))))))))))
end
| uu____3406 -> begin
...
| ((a, uu____3514))::((b, uu____3516))::((c, uu____3518))::((d, uu____3520))::((e, uu____3522))::[] -> begin
(

let uu____3547 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____3547 (fun a1 -> (

let uu____3563 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____3563 (fun b1 -> (

let uu____3579 = (FStar_TypeChecker_NBETerm.unembed ec cb c)
in (FStar_Util.bind_opt uu____3579 (fun c1 -> (

let uu____3595 = (FStar_TypeChecker_NBETerm.unembed ed cb d)
in (FStar_Util.bind_opt uu____3595 (fun d1 -> (

let uu____3611 = (FStar_TypeChecker_NBETerm.unembed ee cb e)
in (FStar_Util.bind_opt uu____3611 (fun e1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1))))))))))))))))))
end
| uu____3636 -> begin
...
| ((a, uu____3762))::((b, uu____3764))::((c, uu____3766))::((d, uu____3768))::((e, uu____3770))::((f, uu____3772))::[] -> begin
(

let uu____3801 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____3801 (fun a1 -> (

let uu____3819 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____3819 (fun b1 -> (

let uu____3837 = (FStar_TypeChecker_NBETerm.unembed ec cb c)
in (FStar_Util.bind_opt uu____3837 (fun c1 -> (

let uu____3855 = (FStar_TypeChecker_NBETerm.unembed ed cb d)
in (FStar_Util.bind_opt uu____3855 (fun d1 -> (

let uu____3873 = (FStar_TypeChecker_NBETerm.unembed ee cb e)
in (FStar_Util.bind_opt uu____3873 (fun e1 -> (

let uu____3891 = (FStar_TypeChecker_NBETerm.unembed ef cb f)
in (FStar_Util.bind_opt uu____3891 (fun f1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1), (f1)))))))))))))))))))))
end
| uu____3920 -> begin
...
| ((a, uu____4064))::((b, uu____4066))::((c, uu____4068))::((d, uu____4070))::((e, uu____4072))::((f, uu____4074))::((g, uu____4076))::[] -> begin
(

let uu____4109 = (FStar_TypeChecker_NBETerm.unembed ea cb a)
in (FStar_Util.bind_opt uu____4109 (fun a1 -> (

let uu____4129 = (FStar_TypeChecker_NBETerm.unembed eb cb b)
in (FStar_Util.bind_opt uu____4129 (fun b1 -> (

let uu____4149 = (FStar_TypeChecker_NBETerm.unembed ec cb c)
in (FStar_Util.bind_opt uu____4149 (fun c1 -> (

let uu____4169 = (FStar_TypeChecker_NBETerm.unembed ed cb d)
in (FStar_Util.bind_opt uu____4169 (fun d1 -> (

let uu____4189 = (FStar_TypeChecker_NBETerm.unembed ee cb e)
in (FStar_Util.bind_opt uu____4189 (fun e1 -> (

let uu____4209 = (FStar_TypeChecker_NBETerm.unembed ef cb f)
in (FStar_Util.bind_opt uu____4209 (fun f1 -> (

let uu____4229 = (FStar_TypeChecker_NBETerm.unembed eg cb g)
in (FStar_Util.bind_opt uu____4229 (fun g1 -> FStar_Pervasives_Native.Some (((a1), (b1), (c1), (d1), (e1), (f1), (g1))))))))))))))))))))))))
end
| uu____4262 -> begin
...
let uu____4350 = (extract_2 ea FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____4350 (fun uu____4369 -> (match (uu____4369) with
| (a, ps) -> begin
(
...
let uu____4382 = (t a)
in (FStar_Tactics_Basic.run_safe uu____4382 ps1))
in (
...
in (embed uu____4386 uu____4391 r ncb)))
...
let uu____4486 = (extract_3 ea eb FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____4486 (fun uu____4510 -> (match (uu____4510) with
| (a, b, ps) -> begin
(
...
let uu____4526 = (t a b)
in (FStar_Tactics_Basic.run_safe uu____4526 ps1))
in (

let uu____4529 = (

let uu____4530 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____4535 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____4530 uu____4535 r ncb)))
in FStar_Pervasives_Native.Some (uu____4529))))
end)))))
...
let uu____4649 = (extract_4 ea eb ec FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____4649 (fun uu____4678 -> (match (uu____4678) with
| (a, b, c, ps) -> begin
(
...
let uu____4697 = (t a b c)
in (FStar_Tactics_Basic.run_safe uu____4697 ps1))
in (

let uu____4700 = (

let uu____4701 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____4706 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____4701 uu____4706 r ncb)))
...
let uu____4839 = (extract_5 ea eb ec ed FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____4839 (fun uu____4873 -> (match (uu____4873) with
| (a, b, c, d, ps) -> begin
(
...
let uu____4895 = (t a b c d)
in (FStar_Tactics_Basic.run_safe uu____4895 ps1))
in (

let uu____4898 = (

let uu____4899 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____4904 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____4899 uu____4904 r ncb)))
...
let uu____5056 = (extract_6 ea eb ec ed ee FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____5056 (fun uu____5095 -> (match (uu____5095) with
| (a, b, c, d, e, ps) -> begin
(
...
let uu____5120 = (t a b c d e)
in (FStar_Tactics_Basic.run_safe uu____5120 ps1))
in (

let uu____5123 = (

let uu____5124 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____5129 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____5124 uu____5129 r ncb)))
in FStar_Pervasives_Native.Some (uu____5123))))
end)))))
...
let uu____5300 = (extract_7 ea eb ec ed ee ef FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____5300 (fun uu____5344 -> (match (uu____5344) with
...
let uu____5372 = (t a b c d e f)
in (FStar_Tactics_Basic.run_safe uu____5372 ps1))
in (

let uu____5375 = (

let uu____5376 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____5381 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____5376 uu____5381 r ncb)))
in FStar_Pervasives_Native.Some (uu____5375))))
end)))))
...
let uu____5685 = (extract_14 e_t1 e_t2 e_t3 e_t4 e_t5 e_t6 e_t7 e_t8 e_t9 e_t10 e_t11 e_t12 e_t13 FStar_Tactics_Embedding.e_proofstate ncb args)
in (FStar_Util.bind_opt uu____5685 (fun uu____5764 -> (match (uu____5764) with
...
let uu____5813 = (t a1 a2 a3 a4 a5 a6 a7 a8 a9 a10 a11 a12 a13)
in (FStar_Tactics_Basic.run_safe uu____5813 ps1))
in (

let uu____5816 = (

let uu____5817 = (FStar_Tactics_Embedding.e_result er)
in (

let uu____5822 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed uu____5817 uu____5822 r ncb)))
in FStar_Pervasives_Native.Some (uu____5816))))
end)))))
...
let uu____5887 = (extract_2_nbe cb ea FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____5887 (fun uu____5903 -> (match (uu____5903) with
| (a, ps) -> begin
(
...
let uu____5915 = (t a)
in (FStar_Tactics_Basic.run_safe uu____5915 ps))
in (

let uu____5918 = (

let uu____5919 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____5919 cb r))
in FStar_Pervasives_Native.Some (uu____5918)))
end)))))
...
let uu____6005 = (extract_3_nbe cb ea eb FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____6005 (fun uu____6026 -> (match (uu____6026) with
| (a, b, ps) -> begin
(

let r = (

let uu____6041 = (t a b)
in (FStar_Tactics_Basic.run_safe uu____6041 ps))
in (

let uu____6044 = (

let uu____6045 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____6045 cb r))
in FStar_Pervasives_Native.Some (uu____6044)))
end)))))
...
let uu____6150 = (extract_4_nbe cb ea eb ec FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____6150 (fun uu____6176 -> (match (uu____6176) with
| (a, b, c, ps) -> begin
(

let r = (

let uu____6194 = (t a b c)
in (FStar_Tactics_Basic.run_safe uu____6194 ps))
in (

let uu____6197 = (

let uu____6198 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____6198 cb r))
...
let uu____6322 = (extract_5_nbe cb ea eb ec ed FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____6322 (fun uu____6353 -> (match (uu____6353) with
| (a, b, c, d, ps) -> begin
(

let r = (

let uu____6374 = (t a b c d)
in (FStar_Tactics_Basic.run_safe uu____6374 ps))
in (

let uu____6377 = (

let uu____6378 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____6378 cb r))
in FStar_Pervasives_Native.Some (uu____6377)))
end)))))
...
let uu____6521 = (extract_6_nbe cb ea eb ec ed ee FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____6521 (fun uu____6557 -> (match (uu____6557) with
| (a, b, c, d, e, ps) -> begin
(

let r = (

let uu____6581 = (t a b c d e)
in (FStar_Tactics_Basic.run_safe uu____6581 ps))
in (

let uu____6584 = (

let uu____6585 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____6585 cb r))
in FStar_Pervasives_Native.Some (uu____6584)))
end)))))
...
let uu____6747 = (extract_7_nbe cb ea eb ec ed ee ef FStar_Tactics_Embedding.e_proofstate_nbe args)
in (FStar_Util.bind_opt uu____6747 (fun uu____6788 -> (match (uu____6788) with
| (a, b, c, d, e, f, ps) -> begin
(

let r = (

let uu____6815 = (t a b c d e f)
in (FStar_Tactics_Basic.run_safe uu____6815 ps))
in (

let uu____6818 = (

let uu____6819 = (FStar_Tactics_Embedding.e_result_nbe er)
in (FStar_TypeChecker_NBETerm.embed uu____6819 cb r))
...
let timing_int : 'Auu____6851 'Auu____6852 'Auu____6853 'Auu____6854 . FStar_Ident.lid  ->  ('Auu____6851  ->  'Auu____6852  ->  'Auu____6853  ->  'Auu____6854)  ->  'Auu____6851  ->  'Auu____6852  ->  'Auu____6853  ->  'Auu____6854 = (fun l f psc cb args -> (

let r = (f psc cb args)
in r))


let timing_nbe : 'Auu____6910 'Auu____6911 'Auu____6912 . FStar_Ident.lid  ->  ('Auu____6910  ->  'Auu____6911  ->  'Auu____6912)  ->  'Auu____6910  ->  'Auu____6911  ->  'Auu____6912 = (fun l f nbe_cbs args -> (
...
let native_tactics : unit  ->  FStar_Tactics_Native.native_primitive_step Prims.list = (fun uu____7018 -> (FStar_Tactics_Native.list_all ()))


let native_tactics_steps : unit  ->  FStar_TypeChecker_Cfg.primitive_step Prims.list = (fun uu____7025 -> (

let uu____7026 = (native_tactics ())
in (FStar_List.map step_from_native_step uu____7026)))


let rec drop : 'Auu____7035 . Prims.int  ->  'Auu____7035 Prims.list  ->  'Auu____7035 Prims.list = (fun n1 l -> (match ((Prims.op_Equality n1 (Prims.parse_int "0"))) with
| true -> begin
l
end
| uu____7052 -> begin
...
let uu____7168 = (drop nunivs args)
in (mk_tactic_nbe_interpretation_1 cb nf nea ner uu____7168)))))
...
let uu____7318 = (drop nunivs args)
in (mk_tactic_nbe_interpretation_2 cb nf nea neb ner uu____7318)))))
...
let uu____7506 = (drop nunivs args)
in (mk_tactic_nbe_interpretation_3 cb nf nea neb nec ner uu____7506)))))
...
let uu____7732 = (drop nunivs args)
in (mk_tactic_nbe_interpretation_4 cb nf nea neb nec ned ner uu____7732)))))
...
in (mk_tactic_nbe_interpretation_5 cb nf nea neb nec ned nee ner uu____7996)))))
...
let uu____8136 = (extract_1 ea ncb args)
in (FStar_Util.bind_opt uu____8136 (fun a -> (
...
let uu____8147 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed er uu____8147 r ncb))
in FStar_Pervasives_Native.Some (uu____8146)))))))
...
let uu____8236 = (extract_2 ea eb ncb args)
in (FStar_Util.bind_opt uu____8236 (fun uu____8254 -> (match (uu____8254) with
| (a, b) -> begin
(
...
let uu____8265 = (FStar_TypeChecker_Cfg.psc_range psc)
in (embed er uu____8265 r ncb))
...
let uu____8324 = (extract_1_nbe cb ea args)
in (FStar_Util.bind_opt uu____8324 (fun a -> (

let r = (f a)
in (

let uu____8332 = (FStar_TypeChecker_NBETerm.embed er cb r)
in FStar_Pervasives_Native.Some (uu____8332)))))))
...
let uu____8408 = (extract_2_nbe cb ea eb args)
in (FStar_Util.bind_opt uu____8408 (fun uu____8424 -> (match (uu____8424) with
| (a, b) -> begin
(
...
let uu____8434 = (FStar_TypeChecker_NBETerm.embed er cb r)
in FStar_Pervasives_Native.Some (uu____8434)))
end)))))
...
let uu____8534 = (drop nunivs args)
in (mk_total_nbe_interpretation_1 cb nf nea ner uu____8534)))))
...
let uu____8676 = (drop nunivs args)
in (mk_total_nbe_interpretation_2 cb nf nea neb ner uu____8676)))))
