      ...
      fun ec ->
        fun ed ->
          fun ncb ->
            fun args ->
              match args with
              | (a, uu____592)::(b, uu____594)::(c, uu____596)::(d,
                                                                 uu____598)::[]
                  ->
        ...
        fun ed ->
          fun ee ->
            fun ncb ->
              fun args ->
                match args with
                | (a, uu____854)::(b, uu____856)::(c, uu____858)::(d,
                                                                   uu____860)::
                    (e, uu____862)::[] ->
          ...
          fun ee ->
            fun ef ->
              fun ncb ->
                fun args ->
                  match args with
                  | (a, uu____1180)::(b, uu____1182)::(c, uu____1184)::
                      (d, uu____1186)::(e, uu____1188)::(f, uu____1190)::[]
                      ->
                                ...
                                FStar_Util.bind_opt uu____1335
                                  (fun c1 ->
                                     ...
                                     FStar_Util.bind_opt uu____1355
                                       (fun d1 ->
                                          let uu____1375 = unembed ee e ncb in
                                  ...
                                  FStar_Util.bind_opt uu____1751
                                    (fun c1 ->
                                       ...
                                       FStar_Util.bind_opt uu____1773
                                         (fun d1 ->
                                            let uu____1795 = unembed ee e ncb in
                                ...
                                FStar_Syntax_Embeddings.norm_cb ->
                                  FStar_Syntax_Syntax.args ->
                                    ('t1, 't2, 't3, 't4, 't5, 't6, 't7, 
                                      ...
                                      't14) FStar_Pervasives_Native.tuple14
                                      FStar_Pervasives_Native.option
  =
  fun e_t1 ->
    fun e_t2 ->
                              ...
                              fun ncb ->
                                fun args ->
                                  ...
                                  | (a1, uu____2136)::(a2, uu____2138)::
                                      ...
                                      ->
                                      let uu____2395 = unembed e_t1 a1 ncb in
        ...
        fun args ->
          ...
          | (a, uu____3054)::(b, uu____3056)::[] ->
              ...
              FStar_Util.bind_opt uu____3069
                (fun a1 ->
                   let uu____3079 = FStar_TypeChecker_NBETerm.unembed eb cb b in
        ...
        fun ec ->
          fun args ->
            ...
            | (a, uu____3164)::(b, uu____3166)::(c, uu____3168)::[] ->
                let uu____3185 = FStar_TypeChecker_NBETerm.unembed ea cb a in
      ...
      fun eb ->
        fun ec ->
          fun ed ->
            fun args ->
              match args with
              | (a, uu____3316)::(b, uu____3318)::(c, uu____3320)::(d,
                                                                    uu____3322)::[]
                  ->
                  let uu____3343 = FStar_TypeChecker_NBETerm.unembed ea cb a in
        ...
        fun ec ->
          fun ed ->
            fun ee ->
              fun args ->
                match args with
                | (a, uu____3514)::(b, uu____3516)::(c, uu____3518)::
                    (d, uu____3520)::(e, uu____3522)::[] ->
                    let uu____3547 =
          ...
          fun ed ->
            fun ee ->
              fun ef ->
                fun args ->
                  match args with
                  | (a, uu____3762)::(b, uu____3764)::(c, uu____3766)::
                      (d, uu____3768)::(e, uu____3770)::(f, uu____3772)::[]
                      ->
                      let uu____3801 =
                        FStar_TypeChecker_NBETerm.unembed ea cb a in
              ...
              FStar_Util.bind_opt uu____4350
                (fun uu____4369 ->
                   ...
                   | (a, ps) ->
                       ...
                       let uu____4385 =
                         let uu____4386 = FStar_Tactics_Embedding.e_result er in
                         let uu____4391 = FStar_TypeChecker_Cfg.psc_range psc in
                      ...
                      (fun uu____4873 ->
                         ...
                         | (a, b, c, d, ps) ->
                             ...
                             let r =
                               ...
                               FStar_Tactics_Basic.run_safe uu____4895 ps1 in
                             let uu____4898 =
                               let uu____4899 =
                                 FStar_Tactics_Embedding.e_result er in
                               let uu____4904 =
                        ...
                        (fun uu____5095 ->
                           ...
                           | (a, b, c, d, e, ps) ->
                               ...
                               let r =
                                 ...
                                 FStar_Tactics_Basic.run_safe uu____5120 ps1 in
                               let uu____5123 =
                                 let uu____5124 =
                                   FStar_Tactics_Embedding.e_result er in
                                 let uu____5129 =
                  ...
                  (fun uu____6176 ->
                     ...
                     | (a, b, c, ps) ->
                         ...
                         let uu____6197 =
                           let uu____6198 =
                             FStar_Tactics_Embedding.e_result_nbe er in
                           FStar_TypeChecker_NBETerm.embed uu____6198 cb r in
                    ...
                    (fun uu____6353 ->
                       ...
                       | (a, b, c, d, ps) ->
                           ...
                           let uu____6377 =
                             let uu____6378 =
                               FStar_Tactics_Embedding.e_result_nbe er in
                             FStar_TypeChecker_NBETerm.embed uu____6378 cb r in
                        ...
                        (fun uu____6788 ->
                           ...
                           | (a, b, c, d, e, f, ps) ->
                               let r =
                                 ...
                                 FStar_Tactics_Basic.run_safe uu____6815 ps in
                               let uu____6818 =
                                 let uu____6819 =
                                   FStar_Tactics_Embedding.e_result_nbe er in
                              ...
                              fun nee ->
                                fun ner ->
                                  mk name (Prims.parse_int "6") nunivs
                                    ...
                                    (fun cb ->
                                       fun args ->
                                         let uu____7996 = drop nunivs args in
