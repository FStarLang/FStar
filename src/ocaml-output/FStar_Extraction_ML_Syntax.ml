...
let idsym: mlident -> mlsymbol = fun s  -> s
  ...
  let n_resets = FStar_Util.mk_ref (Prims.parse_int "0") in
  {
    gensym =
      (fun uu____87  ->
         ...
         (let uu____110 =
            let uu____111 =
              let uu____112 = FStar_ST.op_Bang n_resets in
              FStar_Util.string_of_int uu____112 in
            let uu____137 =
              let uu____138 =
                let uu____139 = FStar_ST.op_Bang ctr in
                FStar_Util.string_of_int uu____139 in
              Prims.strcat "_" uu____138 in
            Prims.strcat uu____111 uu____137 in
          Prims.strcat "_" uu____110));
    reset =
      (fun uu____166  ->
         FStar_ST.op_Colon_Equals ctr (Prims.parse_int "0");
         FStar_Util.incr n_resets)
  }
let gensym: Prims.unit -> mlident = fun uu____216  -> gs.gensym ()
let reset_gensym: Prims.unit -> Prims.unit = fun uu____220  -> gs.reset ()
let rec gensyms: Prims.int -> mlident Prims.list =
  fun x  ->
    match x with
    | _0_41 when _0_41 = (Prims.parse_int "0") -> []
    | n1 ->
        let uu____230 = gensym () in
        let uu____231 = gensyms (n1 - (Prims.parse_int "1")) in uu____230 ::
          uu____231
  ...
  fun x  ->
    ...
    then ([], ((x.FStar_Ident.ident).FStar_Ident.idText))
      ...
      (let uu____241 =
       ...
       (uu____241, ((x.FStar_Ident.ident).FStar_Ident.idText)))
...
let uu___is_E_PURE: e_tag -> Prims.bool =
  fun projectee  ->
    match projectee with | E_PURE  -> true | uu____256 -> false
let uu___is_E_GHOST: e_tag -> Prims.bool =
  fun projectee  ->
    match projectee with | E_GHOST  -> true | uu____261 -> false
let uu___is_E_IMPURE: e_tag -> Prims.bool =
  fun projectee  ->
    match projectee with | E_IMPURE  -> true | uu____266 -> false
...
let uu___is_MLTY_Var: mlty -> Prims.bool =
  fun projectee  ->
    match projectee with | MLTY_Var _0 -> true | uu____310 -> false
...
let uu___is_MLTY_Fun: mlty -> Prims.bool =
  fun projectee  ->
    match projectee with | MLTY_Fun _0 -> true | uu____330 -> false
...
let uu___is_MLTY_Named: mlty -> Prims.bool =
  fun projectee  ->
    match projectee with | MLTY_Named _0 -> true | uu____368 -> false
...
let uu___is_MLTY_Tuple: mlty -> Prims.bool =
  fun projectee  ->
    match projectee with | MLTY_Tuple _0 -> true | uu____402 -> false
...
let uu___is_MLTY_Top: mlty -> Prims.bool =
  fun projectee  ->
    match projectee with | MLTY_Top  -> true | uu____421 -> false
...
let uu___is_MLC_Unit: mlconstant -> Prims.bool =
  fun projectee  ->
    match projectee with | MLC_Unit  -> true | uu____466 -> false
let uu___is_MLC_Bool: mlconstant -> Prims.bool =
  fun projectee  ->
    match projectee with | MLC_Bool _0 -> true | uu____472 -> false
...
let uu___is_MLC_Int: mlconstant -> Prims.bool =
  fun projectee  ->
    match projectee with | MLC_Int _0 -> true | uu____496 -> false
...
let uu___is_MLC_Float: mlconstant -> Prims.bool =
  fun projectee  ->
    match projectee with | MLC_Float _0 -> true | uu____540 -> false
...
let uu___is_MLC_Char: mlconstant -> Prims.bool =
  fun projectee  ->
    match projectee with | MLC_Char _0 -> true | uu____554 -> false
...
let uu___is_MLC_String: mlconstant -> Prims.bool =
  fun projectee  ->
    match projectee with | MLC_String _0 -> true | uu____568 -> false
...
let uu___is_MLC_Bytes: mlconstant -> Prims.bool =
  fun projectee  ->
    match projectee with | MLC_Bytes _0 -> true | uu____584 -> false
...
let uu___is_MLP_Wild: mlpattern -> Prims.bool =
  fun projectee  ->
    match projectee with | MLP_Wild  -> true | uu____649 -> false
let uu___is_MLP_Const: mlpattern -> Prims.bool =
  fun projectee  ->
    match projectee with | MLP_Const _0 -> true | uu____655 -> false
...
let uu___is_MLP_Var: mlpattern -> Prims.bool =
  fun projectee  ->
    match projectee with | MLP_Var _0 -> true | uu____669 -> false
...
let uu___is_MLP_CTor: mlpattern -> Prims.bool =
  fun projectee  ->
    match projectee with | MLP_CTor _0 -> true | uu____689 -> false
...
let uu___is_MLP_Branch: mlpattern -> Prims.bool =
  fun projectee  ->
    match projectee with | MLP_Branch _0 -> true | uu____723 -> false
...
let uu___is_MLP_Record: mlpattern -> Prims.bool =
  fun projectee  ->
    match projectee with | MLP_Record _0 -> true | uu____755 -> false
...
let uu___is_MLP_Tuple: mlpattern -> Prims.bool =
  fun projectee  ->
    match projectee with | MLP_Tuple _0 -> true | uu____807 -> false
...
let uu___is_Mutable: c_flag -> Prims.bool =
  fun projectee  ->
    match projectee with | Mutable  -> true | uu____830 -> false
let uu___is_Assumed: c_flag -> Prims.bool =
  fun projectee  ->
    match projectee with | Assumed  -> true | uu____835 -> false
let uu___is_Private: c_flag -> Prims.bool =
  fun projectee  ->
    match projectee with | Private  -> true | uu____840 -> false
let uu___is_NoExtract: c_flag -> Prims.bool =
  fun projectee  ->
    match projectee with | NoExtract  -> true | uu____845 -> false
let uu___is_Attribute: c_flag -> Prims.bool =
  fun projectee  ->
    match projectee with | Attribute _0 -> true | uu____851 -> false
...
let uu___is_PpxDerivingShow: tyattr -> Prims.bool =
  fun projectee  ->
    match projectee with | PpxDerivingShow  -> true | uu____868 -> false
...
let uu___is_Rec: mlletflavor -> Prims.bool =
  fun projectee  -> match projectee with | Rec  -> true | uu____889 -> false
let uu___is_NonRec: mlletflavor -> Prims.bool =
  fun projectee  ->
    match projectee with | NonRec  -> true | uu____894 -> false
...
let uu___is_MLE_Const: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Const _0 -> true | uu____1102 -> false
...
let uu___is_MLE_Var: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Var _0 -> true | uu____1116 -> false
...
let uu___is_MLE_Name: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Name _0 -> true | uu____1130 -> false
...
let uu___is_MLE_Let: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Let _0 -> true | uu____1156 -> false
...
let uu___is_MLE_App: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_App _0 -> true | uu____1212 -> false
...
let uu___is_MLE_Fun: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Fun _0 -> true | uu____1254 -> false
...
let uu___is_MLE_Match: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Match _0 -> true | uu____1312 -> false
...
let uu___is_MLE_Coerce: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Coerce _0 -> true | uu____1374 -> false
...
let uu___is_MLE_CTor: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_CTor _0 -> true | uu____1412 -> false
...
let uu___is_MLE_Seq: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Seq _0 -> true | uu____1446 -> false
...
let uu___is_MLE_Tuple: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Tuple _0 -> true | uu____1468 -> false
...
let uu___is_MLE_Record: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Record _0 -> true | uu____1500 -> false
...
let uu___is_MLE_Proj: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Proj _0 -> true | uu____1554 -> false
...
let uu___is_MLE_If: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_If _0 -> true | uu____1588 -> false
...
let uu___is_MLE_Raise: mlexpr' -> Prims.bool =
  fun projectee  ->
    match projectee with | MLE_Raise _0 -> true | uu____1632 -> false
...
let uu___is_MLTD_Abbrev: mltybody -> Prims.bool =
  fun projectee  ->
    match projectee with | MLTD_Abbrev _0 -> true | uu____1860 -> false
...
let uu___is_MLTD_Record: mltybody -> Prims.bool =
  fun projectee  ->
    match projectee with | MLTD_Record _0 -> true | uu____1880 -> false
...
let uu___is_MLTD_DType: mltybody -> Prims.bool =
  fun projectee  ->
    match projectee with | MLTD_DType _0 -> true | uu____1924 -> false
...
let uu___is_MLM_Ty: mlmodule1 -> Prims.bool =
  fun projectee  ->
    match projectee with | MLM_Ty _0 -> true | uu____2022 -> false
...
let uu___is_MLM_Let: mlmodule1 -> Prims.bool =
  fun projectee  ->
    match projectee with | MLM_Let _0 -> true | uu____2036 -> false
...
let uu___is_MLM_Exn: mlmodule1 -> Prims.bool =
  fun projectee  ->
    match projectee with | MLM_Exn _0 -> true | uu____2060 -> false
...
let uu___is_MLM_Top: mlmodule1 -> Prims.bool =
  fun projectee  ->
    match projectee with | MLM_Top _0 -> true | uu____2104 -> false
...
let uu___is_MLM_Loc: mlmodule1 -> Prims.bool =
  fun projectee  ->
    match projectee with | MLM_Loc _0 -> true | uu____2118 -> false
...
let uu___is_MLS_Mod: mlsig1 -> Prims.bool =
  fun projectee  ->
    match projectee with | MLS_Mod _0 -> true | uu____2172 -> false
...
let uu___is_MLS_Ty: mlsig1 -> Prims.bool =
  fun projectee  ->
    match projectee with | MLS_Ty _0 -> true | uu____2204 -> false
...
let uu___is_MLS_Val: mlsig1 -> Prims.bool =
  fun projectee  ->
    match projectee with | MLS_Val _0 -> true | uu____2222 -> false
...
let uu___is_MLS_Exn: mlsig1 -> Prims.bool =
  fun projectee  ->
    match projectee with | MLS_Exn _0 -> true | uu____2254 -> false
...
let bv_as_mlident: FStar_Syntax_Syntax.bv -> mlident =
  fun x  ->
    ...
    then
      let uu____2443 =
        let uu____2444 = FStar_Util.string_of_int x.FStar_Syntax_Syntax.index in
        Prims.strcat "_" uu____2444 in
  ...
  fun ts  ->
    ...
    | (vs,ty) ->
        (match ty with
         ...
         | uu____2463 -> failwith "unexpected: pop_unit: not a function type")