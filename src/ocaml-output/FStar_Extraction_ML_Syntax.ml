...
(let _0_161 = (let _0_160 = (let _0_159 = (FStar_Util.string_of_int (FStar_ST.read n_resets))
in (let _0_158 = (let _0_157 = (FStar_Util.string_of_int (FStar_ST.read ctr))
in (Prims.strcat "_" _0_157))
in (Prims.strcat _0_159 _0_158)))
in (Prims.strcat "_" _0_160))
in ((_0_161), ((Prims.parse_int "0"))));
...
| _0_162 when (_0_162 = (Prims.parse_int "0")) -> begin
[]
end
| n -> begin
(let _0_164 = (gensym ())
in (let _0_163 = (gensyms (n - (Prims.parse_int "1")))
in (_0_164)::_0_163))
end))
...
| uu____89 -> begin
(let _0_165 = (FStar_List.map (fun x -> x.FStar_Ident.idText) x.FStar_Ident.ns)
in ((_0_165), (x.FStar_Ident.ident.FStar_Ident.idText)))
end))
...
| true -> begin
(let _0_168 = (let _0_167 = (let _0_166 = (FStar_Util.string_of_int x.FStar_Syntax_Syntax.index)
in (Prims.strcat "_" _0_166))
in (Prims.strcat x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText _0_167))
in ((_0_168), ((Prims.parse_int "0"))))
end
| uu____1460 -> begin
