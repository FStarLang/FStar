...
type mlpath =
  (mlsymbol Prims.list,mlsymbol) FStar_Pervasives_Native_Tuple2.tuple2
...
type mlloc = (Prims.int,Prims.string) FStar_Pervasives_Native_Tuple2.tuple2
let (dummy_loc : mlloc) = ((Prims.parse_int "0"), "") 
type mlty =
  | MLTY_Var of mlident 
  | MLTY_Fun of (mlty,e_tag,mlty) FStar_Pervasives_Native_Tuple3.tuple3 
...
let (__proj__MLTY_Fun__item___0 :
  mlty -> (mlty,e_tag,mlty) FStar_Pervasives_Native_Tuple3.tuple3) =
...
let (__proj__MLTY_Named__item___0 :
  mlty -> (mlty Prims.list,mlpath) FStar_Pervasives_Native_Tuple2.tuple2) =
...
type mltyscheme = (mlidents,mlty) FStar_Pervasives_Native_Tuple2.tuple2
type mlconstant =
  | MLC_Unit 
...
type mlpattern =
  ...
  | MLP_Record of
  (mlsymbol Prims.list,(mlsymbol,mlpattern)
...
let (__proj__MLP_CTor__item___0 :
  mlpattern ->
    (mlpath,mlpattern Prims.list) FStar_Pervasives_Native_Tuple2.tuple2)
...
type mlexpr' =
  ...
  | MLE_Name of mlpath 
  | MLE_Let of
  ((mlletflavor,mllb Prims.list) FStar_Pervasives_Native_Tuple2.tuple2,
  mlexpr) FStar_Pervasives_Native_Tuple2.tuple2 
  | MLE_App of (mlexpr,mlexpr Prims.list)
  FStar_Pervasives_Native_Tuple2.tuple2 
  | MLE_TApp of (mlexpr,mlty Prims.list)
  FStar_Pervasives_Native_Tuple2.tuple2 
  | MLE_Fun of
  ((mlident,mlty) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list,mlexpr)
  FStar_Pervasives_Native_Tuple2.tuple2 
  | MLE_Match of
  (mlexpr,(mlpattern,mlexpr FStar_Pervasives_Native.option,mlexpr)
            FStar_Pervasives_Native_Tuple3.tuple3 Prims.list)
  FStar_Pervasives_Native_Tuple2.tuple2 
  | MLE_Coerce of (mlexpr,mlty,mlty) FStar_Pervasives_Native_Tuple3.tuple3 
  | MLE_CTor of (mlpath,mlexpr Prims.list)
  FStar_Pervasives_Native_Tuple2.tuple2 
  | MLE_Seq of mlexpr Prims.list 
  | MLE_Tuple of mlexpr Prims.list 
  | MLE_Record of
  (mlsymbol Prims.list,(mlsymbol,mlexpr)
                         FStar_Pervasives_Native_Tuple2.tuple2 Prims.list)
  FStar_Pervasives_Native_Tuple2.tuple2 
  | MLE_Proj of (mlexpr,mlpath) FStar_Pervasives_Native_Tuple2.tuple2 
...
let (__proj__MLE_App__item___0 :
  mlexpr' -> (mlexpr,mlexpr Prims.list) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__MLE_TApp__item___0 :
  mlexpr' -> (mlexpr,mlty Prims.list) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__MLE_Fun__item___0 :
  mlexpr' ->
    ((mlident,mlty) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list,
      mlexpr) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__MLE_Coerce__item___0 :
  mlexpr' -> (mlexpr,mlty,mlty) FStar_Pervasives_Native_Tuple3.tuple3) =
...
let (__proj__MLE_CTor__item___0 :
  mlexpr' -> (mlpath,mlexpr Prims.list) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__MLE_Proj__item___0 :
  mlexpr' -> (mlexpr,mlpath) FStar_Pervasives_Native_Tuple2.tuple2) =
...
type mltybody =
  | MLTD_Abbrev of mlty 
  | MLTD_Record of (mlsymbol,mlty) FStar_Pervasives_Native_Tuple2.tuple2
  Prims.list 
  | MLTD_DType of
  (mlsymbol,(mlsymbol,mlty) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list)
  FStar_Pervasives_Native_Tuple2.tuple2 Prims.list 
...
let (__proj__MLTD_Record__item___0 :
  mltybody ->
    (mlsymbol,mlty) FStar_Pervasives_Native_Tuple2.tuple2 Prims.list)
...
let (__proj__MLTD_DType__item___0 :
  mltybody ->
    (mlsymbol,(mlsymbol,mlty) FStar_Pervasives_Native_Tuple2.tuple2
                Prims.list)
      FStar_Pervasives_Native_Tuple2.tuple2 Prims.list)
...
type mlsig1 =
  ...
  FStar_Pervasives_Native_Tuple2.tuple2 
  | MLS_Ty of mltydecl 
  | MLS_Val of (mlsymbol,mltyscheme) FStar_Pervasives_Native_Tuple2.tuple2 
...
let (__proj__MLS_Mod__item___0 :
  mlsig1 ->
    (mlsymbol,mlsig1 Prims.list) FStar_Pervasives_Native_Tuple2.tuple2)
...
let (__proj__MLS_Val__item___0 :
  mlsig1 -> (mlsymbol,mltyscheme) FStar_Pervasives_Native_Tuple2.tuple2) =
...
let (__proj__MLS_Exn__item___0 :
  mlsig1 -> (mlsymbol,mlty Prims.list) FStar_Pervasives_Native_Tuple2.tuple2)
...
type mllib =
  | MLLib of
  (mlpath,(mlsig,mlmodule) FStar_Pervasives_Native_Tuple2.tuple2
