...
let uu___is_Deprecated : meta  ->  Prims.bool = (fun projectee -> (match (projectee) with
| Deprecated (_0) -> begin
true
end
| uu____1557 -> begin
...
let __proj__Deprecated__item___0 : meta  ->  Prims.string = (fun projectee -> (match (projectee) with
| Deprecated (_0) -> begin
_0
end))
...
let uu____3497 = (FStar_Options.codegen ())
in (Prims.op_Equality uu____3497 (FStar_Pervasives_Native.Some (FStar_Options.FSharp))))
...
let uu____3542 = (((FStar_Util.starts_with x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText FStar_Ident.reserved_prefix) || (FStar_Syntax_Syntax.is_null_bv x)) || (is_reserved x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText))
...
let uu____3550 = (FStar_Util.string_of_int x.FStar_Syntax_Syntax.index)
in (Prims.op_Hat "_" uu____3550))
in (Prims.op_Hat x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText uu____3548))
in (FStar_All.pipe_left avoid_keyword uu____3546))
end
| uu____3555 -> begin
...
let uu____3575 = (FStar_List.map (fun x1 -> x1.FStar_Ident.idText) x.FStar_Ident.ns)
in (

let uu____3582 = (avoid_keyword x.FStar_Ident.ident.FStar_Ident.idText)
in ((uu____3575), (uu____3582))))
end)))
