...
type mltybody =
  ...
  | MLTD_DType of (mlsymbol,mlty Prims.list) FStar_Pervasives_Native.tuple2
  Prims.list
...
let __proj__MLTD_DType__item___0:
  mltybody ->
    (mlsymbol,mlty Prims.list) FStar_Pervasives_Native.tuple2 Prims.list
...
type mlmodule1 =
  ...
  | MLM_Exn of (mlsymbol,mlty Prims.list) FStar_Pervasives_Native.tuple2
  | MLM_Top of mlexpr
  | MLM_Loc of mlloc
...
let __proj__MLM_Exn__item___0:
  mlmodule1 -> (mlsymbol,mlty Prims.list) FStar_Pervasives_Native.tuple2 =
