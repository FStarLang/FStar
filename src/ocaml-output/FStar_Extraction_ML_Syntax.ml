  ...
  let n_resets = FStar_Util.mk_ref (Prims.parse_int "0") in
  {
    gensym =
      (fun uu____57  ->
         ...
         (let _0_184 =
            let _0_183 =
              let _0_182 = FStar_Util.string_of_int (FStar_ST.read n_resets) in
              let _0_181 =
                let _0_180 = FStar_Util.string_of_int (FStar_ST.read ctr) in
                Prims.strcat "_" _0_180 in
              Prims.strcat _0_182 _0_181 in
            Prims.strcat "_" _0_183 in
          (_0_184, (Prims.parse_int "0"))));
    reset =
      (fun uu____66  ->
...
let rec gensyms: Prims.int -> mlident Prims.list =
  fun x  ->
    match x with
    | _0_185 when _0_185 = (Prims.parse_int "0") -> []
    | n ->
        let _0_187 = gensym () in
        let _0_186 = gensyms (n - (Prims.parse_int "1")) in _0_187 :: _0_186
  ...
  fun x  ->
    ...
    then ([], ((x.FStar_Ident.ident).FStar_Ident.idText))
      ...
      (let _0_188 =
       ...
       (_0_188, ((x.FStar_Ident.ident).FStar_Ident.idText)))
...
let bv_as_mlident: FStar_Syntax_Syntax.bv -> mlident =
  fun x  ->
    ...
    then
      let _0_191 =
        let _0_190 =
          let _0_189 = FStar_Util.string_of_int x.FStar_Syntax_Syntax.index in
          Prims.strcat "_" _0_189 in
        Prims.strcat (x.FStar_Syntax_Syntax.ppname).FStar_Ident.idText _0_190 in
      (_0_191, (Prims.parse_int "0"))
    else
      (((x.FStar_Syntax_Syntax.ppname).FStar_Ident.idText),
        (Prims.parse_int "0"))