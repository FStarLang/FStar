...
(let _170_729 = (let _170_728 = (let _170_727 = (FStar_Util.string_of_int x.FStar_Syntax_Syntax.index)
in (Prims.strcat "_" _170_727))
in (Prims.strcat x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText _170_728))
in ((_170_729), ((Prims.parse_int "0"))))
end else begin
