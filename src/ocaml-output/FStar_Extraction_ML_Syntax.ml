...
let mlpath_of_lident = (fun x -> (let _125_8 = (FStar_List.map (fun x -> x.FStar_Absyn_Syntax.idText) x.FStar_Absyn_Syntax.ns)
in (_125_8, x.FStar_Absyn_Syntax.ident.FStar_Absyn_Syntax.idText)))
