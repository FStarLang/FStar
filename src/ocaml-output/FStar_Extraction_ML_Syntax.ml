...
let (uu___is_GCType : meta -> Prims.bool) =
  fun projectee  ->
    match projectee with | GCType  -> true | uu____913 -> false
...
let (uu___is_NonRec : mlletflavor -> Prims.bool) =
  fun projectee  ->
    match projectee with | NonRec  -> true | uu____991 -> false
    ...
    fun t  ->
      let obj_ns =
        let uu____2505 =
          ...
          uu____2506 = (FStar_Pervasives_Native.Some FStar_Options.FSharp)
           in
