...
| () -> begin
(let _166_31 = (let _166_30 = (let _166_29 = (let _166_25 = (FStar_ST.read n_resets)
in (FStar_Util.string_of_int _166_25))
in (let _166_28 = (let _166_27 = (let _166_26 = (

let _71_14 = (FStar_Util.incr ctr)
in (FStar_ST.read ctr))
in (FStar_Util.string_of_int _166_26))
in (Prims.strcat "_" _166_27))
in (Prims.strcat _166_29 _166_28)))
in (Prims.strcat "_" _166_30))
in ((_166_31), ((Prims.parse_int "0"))))
...
| _166_39 when (_166_39 = (Prims.parse_int "0")) -> begin
[]
end
| n -> begin
(let _166_41 = (gensym ())
in (let _166_40 = (gensyms (n - (Prims.parse_int "1")))
in (_166_41)::_166_40))
end))


let mlpath_of_lident : FStar_Ident.lident  ->  (Prims.string Prims.list * Prims.string) = (fun x -> (let _166_45 = (FStar_List.map (fun x -> x.FStar_Ident.idText) x.FStar_Ident.ns)
in ((_166_45), (x.FStar_Ident.ident.FStar_Ident.idText))))
...
(let _166_724 = (let _166_723 = (let _166_722 = (FStar_Util.string_of_int x.FStar_Syntax_Syntax.index)
in (Prims.strcat "_" _166_722))
in (Prims.strcat x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText _166_723))
in ((_166_724), ((Prims.parse_int "0"))))
end else begin
