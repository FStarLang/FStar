  ...
  let n_resets = FStar_Util.mk_ref (Prims.parse_int "0")  in
  {
    gensym =
      (fun uu____57  ->
         ...
         (let _0_184 =
            let _0_183 =
              let _0_182 = FStar_Util.string_of_int (FStar_ST.read n_resets)
                 in
              let _0_181 =
...
let bv_as_mlident : FStar_Syntax_Syntax.bv -> mlident =
  fun x  ->
    ...
    then
      let _0_191 =
        let _0_190 =
          let _0_189 = FStar_Util.string_of_int x.FStar_Syntax_Syntax.index
             in
          Prims.strcat "_" _0_189  in
        Prims.strcat (x.FStar_Syntax_Syntax.ppname).FStar_Ident.idText _0_190
         in
