...
let uu____2784 = (FStar_Options.codegen ())
in (Prims.op_Equality uu____2784 (FStar_Pervasives_Native.Some (FStar_Options.FSharp))))
...
let uu____2807 = (((FStar_Util.starts_with x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText FStar_Ident.reserved_prefix) || (FStar_Syntax_Syntax.is_null_bv x)) || (is_reserved x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText))
...
let uu____2810 = (FStar_Util.string_of_int x.FStar_Syntax_Syntax.index)
in (Prims.strcat "_" uu____2810))
in (Prims.strcat x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText uu____2809))
in (FStar_All.pipe_left avoid_keyword uu____2808))
end
| uu____2811 -> begin
