...
open Prims
# 5 "FStar.Extraction.ML.Syntax.fst"
type mlsymbol =
Prims.string
...
# 23 "FStar.Extraction.ML.Syntax.fst"
...
# 135 "FStar.Extraction.ML.Syntax.fst"
