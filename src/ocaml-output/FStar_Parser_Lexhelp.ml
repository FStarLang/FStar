...
let add_string = (fun buf x -> (let _156_24 = (FStar_Bytes.string_as_unicode_bytes x)
...
in (let _65_32 = (let _156_44 = (((FStar_Bytes.length bytes) / 2) - 1)
...
in (hexdigit _156_74)))))
in (let low = (((let _156_75 = (FStar_Util.char_at s 4)
