...
(let _158_115 = (let _158_114 = (args.getSourceDirectory ())
in (FStar_Bytes.string_as_unicode_bytes _158_114))
in FStar_Parser_Parse.STRING (_158_115))
end
| "__SOURCE_FILE__" -> begin
(let _158_117 = (let _158_116 = (FStar_Range.file_of_range r)
in (FStar_Bytes.string_as_unicode_bytes _158_116))
in FStar_Parser_Parse.STRING (_158_117))
end
| "__LINE__" -> begin
(let _158_121 = (let _158_120 = (let _158_119 = (let _158_118 = (FStar_Range.start_of_range r)
in (FStar_Range.line_of_pos _158_118))
in (FStar_All.pipe_left FStar_Util.string_of_int _158_119))
in ((_158_120), (false)))
in FStar_Parser_Parse.INT (_158_121))
end
| _66_92 -> begin
...
(let _158_122 = (intern_string s)
in FStar_Parser_Parse.IDENT (_158_122))
end
end)
end))
