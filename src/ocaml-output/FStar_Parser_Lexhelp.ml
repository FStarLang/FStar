...
let call_string_finish = (fun fin buf endm b -> (let _113_19 = (FStar_Bytes.close buf)
in (fin endm b _113_19)))

let add_string = (fun buf x -> (let _113_24 = (FStar_Bytes.string_as_unicode_bytes x)
in (FStar_Bytes.emit_bytes buf _113_24)))
...
in (let _113_40 = ((FStar_Bytes.length bytes) / 2)
in (FStar_Bytes.make (fun i -> (FStar_Bytes.get bytes (i * 2))) _113_40))))

let stringbuf_is_bytes = (fun buf -> (let bytes = (FStar_Bytes.close buf)
in (let ok = (FStar_Util.mk_ref true)
in (let _46_32 = (let _113_44 = (((FStar_Bytes.length bytes) / 2) - 1)
in (FStar_Util.for_range 0 _113_44 (fun i -> if ((FStar_Bytes.get bytes ((i * 2) + 1)) <> 0) then begin
...
(let _113_63 = (((let _113_59 = (FStar_Util.char_at s 0)
in (hexdigit _113_59)) * 4096) + (((let _113_60 = (FStar_Util.char_at s 1)
in (hexdigit _113_60)) * 256) + (((let _113_61 = (FStar_Util.char_at s 2)
in (hexdigit _113_61)) * 16) + (let _113_62 = (FStar_Util.char_at s 3)
in (hexdigit _113_62)))))
in (FStar_Util.uint16_of_int _113_63))
end)

let hexgraph_short = (fun s -> if ((FStar_String.length s) <> 2) then begin
(FStar_All.failwith "hexgraph")
end else begin
(let _113_68 = (((let _113_66 = (FStar_Util.char_at s 0)
in (hexdigit _113_66)) * 16) + (let _113_67 = (FStar_Util.char_at s 1)
in (hexdigit _113_67)))
in (FStar_Util.uint16_of_int _113_68))
end)

let unicodegraph_long = (fun s -> if ((FStar_String.length s) <> 8) then begin
(FStar_All.failwith "unicodegraph_long")
end else begin
(let high = (((let _113_71 = (FStar_Util.char_at s 0)
in (hexdigit _113_71)) * 4096) + (((let _113_72 = (FStar_Util.char_at s 1)
in (hexdigit _113_72)) * 256) + (((let _113_73 = (FStar_Util.char_at s 2)
in (hexdigit _113_73)) * 16) + (let _113_74 = (FStar_Util.char_at s 3)
in (hexdigit _113_74)))))
in (let low = (((let _113_75 = (FStar_Util.char_at s 4)
in (hexdigit _113_75)) * 4096) + (((let _113_76 = (FStar_Util.char_at s 5)
in (hexdigit _113_76)) * 256) + (((let _113_77 = (FStar_Util.char_at s 6)
in (hexdigit _113_77)) * 16) + (let _113_78 = (FStar_Util.char_at s 7)
in (hexdigit _113_78)))))
...
(let _46_92 = (let _113_127 = (let _113_126 = (FStar_Range.string_of_range r)
in (FStar_Util.format2 "The keyword \'%s\' is reserved for future use by F#. (%s)" s _113_126))
in (FStar_Util.print_string _113_127))
in (let _113_128 = (intern_string s)
in FStar_Parser_Parse.IDENT (_113_128)))
end else begin
v
end
end
...
(let _113_130 = (let _113_129 = (args.getSourceDirectory ())
in (FStar_Bytes.string_as_unicode_bytes _113_129))
in FStar_Parser_Parse.STRING (_113_130))
end
| "__SOURCE_FILE__" -> begin
(let _113_132 = (let _113_131 = (FStar_Range.file_of_range r)
in (FStar_Bytes.string_as_unicode_bytes _113_131))
in FStar_Parser_Parse.STRING (_113_132))
end
| "__LINE__" -> begin
(let _113_136 = (let _113_135 = (let _113_134 = (let _113_133 = (FStar_Range.start_of_range r)
in (FStar_Range.line_of_pos _113_133))
in (FStar_All.pipe_left FStar_Util.string_of_int _113_134))
in (_113_135, false))
in FStar_Parser_Parse.INT (_113_136))
end
| _46_99 -> begin
(let _113_137 = (intern_string s)
in FStar_Parser_Parse.IDENT (_113_137))
end)
end))
