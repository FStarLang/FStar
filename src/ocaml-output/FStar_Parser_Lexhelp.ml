...
let _54_32 = (let _139_44 = (((FStar_Bytes.length bytes) / 2) - 1)
in (FStar_Util.for_range 0 _139_44 (fun i -> if ((FStar_Bytes.get bytes ((i * 2) + 1)) <> 0) then begin
...
(let _139_63 = (((let _139_59 = (FStar_Util.char_at s 0)
in (hexdigit _139_59)) * 4096) + (((let _139_60 = (FStar_Util.char_at s 1)
in (hexdigit _139_60)) * 256) + (((let _139_61 = (FStar_Util.char_at s 2)
in (hexdigit _139_61)) * 16) + (let _139_62 = (FStar_Util.char_at s 3)
in (hexdigit _139_62)))))
...
(let _139_68 = (((let _139_66 = (FStar_Util.char_at s 0)
in (hexdigit _139_66)) * 16) + (let _139_67 = (FStar_Util.char_at s 1)
in (hexdigit _139_67)))
...
let high = (((let _139_71 = (FStar_Util.char_at s 0)
in (hexdigit _139_71)) * 4096) + (((let _139_72 = (FStar_Util.char_at s 1)
in (hexdigit _139_72)) * 256) + (((let _139_73 = (FStar_Util.char_at s 2)
in (hexdigit _139_73)) * 16) + (let _139_74 = (FStar_Util.char_at s 3)
in (hexdigit _139_74)))))
in (
# 109 "FStar.Parser.Lexhelp.fst"
let low = (((let _139_75 = (FStar_Util.char_at s 4)
in (hexdigit _139_75)) * 4096) + (((let _139_76 = (FStar_Util.char_at s 5)
in (hexdigit _139_76)) * 256) + (((let _139_77 = (FStar_Util.char_at s 6)
in (hexdigit _139_77)) * 16) + (let _139_78 = (FStar_Util.char_at s 7)
in (hexdigit _139_78)))))
...
let _54_92 = (let _139_127 = (let _139_126 = (FStar_Range.string_of_range r)
in (FStar_Util.format2 "The keyword \'%s\' is reserved for future use by F#. (%s)" s _139_126))
in (FStar_Util.print_string _139_127))
in (let _139_128 = (intern_string s)
in FStar_Parser_Parse.IDENT (_139_128)))
end else begin
v
end
end
...
(let _139_130 = (let _139_129 = (args.getSourceDirectory ())
in (FStar_Bytes.string_as_unicode_bytes _139_129))
in FStar_Parser_Parse.STRING (_139_130))
end
| "__SOURCE_FILE__" -> begin
(let _139_132 = (let _139_131 = (FStar_Range.file_of_range r)
in (FStar_Bytes.string_as_unicode_bytes _139_131))
in FStar_Parser_Parse.STRING (_139_132))
end
| "__LINE__" -> begin
(let _139_136 = (let _139_135 = (let _139_134 = (let _139_133 = (FStar_Range.start_of_range r)
in (FStar_Range.line_of_pos _139_133))
in (FStar_All.pipe_left FStar_Util.string_of_int _139_134))
in (_139_135, false))
in FStar_Parser_Parse.INT (_139_136))
end
| _54_99 -> begin
...
(let _139_137 = (intern_string s)
in FStar_Parser_Parse.IDENT (_139_137))
end
end)
end))
