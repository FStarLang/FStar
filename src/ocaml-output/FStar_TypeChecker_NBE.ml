  ...
  fun t  ->
    ...
    | FStar_TypeChecker_NBETerm.Meta (t0,m) ->
        ...
        (match uu___ with
         ...
         | FStar_Syntax_Syntax.Meta_monadic_lift (uu___1,uu___2,uu___3) -> t
                   ...
                   let matches_const c s1 =
                     debug cfg
                       (fun uu___2  ->
                          ...
                          let uu___4 = FStar_Syntax_Print.const_to_string s1
                             in
                          FStar_Util.print2
                      ...
                      | FStar_TypeChecker_NBETerm.Constant
                          ...
                          (match s1 with
                           | FStar_Const.Const_int
                               ...
                               let uu___2 = FStar_BigInt.big_int_of_string p1
                                  in
                               i = uu___2
                           | uu___2 -> false)
                      | FStar_TypeChecker_NBETerm.Constant
          ...
          | (lr,rng) ->
              (match lr with
               ...
               | FStar_Util.Inr (elt,FStar_Pervasives_Native.Some us) ->
                   (debug cfg
                      (fun uu___2  ->
                         let uu___3 = FStar_Syntax_Print.univs_to_string us
                            in
                         FStar_Util.print1
      ...
      fun e  ->
        ...
        (let uu___1 =
               ...
               let uu___4 =
                 FStar_List.map
                   (fun x  ->
                      ...
                      FStar_TypeChecker_NBETerm.as_arg uu___5) us
                  in
         ...
         | FStar_Syntax_Syntax.Tm_arrow (xs,c) ->
                   ...
                   (fun uu___4  ->
                      fun uu___5  ->
                        ...
                        | ((ctx,binders_rev),(x,q)) ->
                            ...
                            let x1 =
                              let uu___6 = FStar_Syntax_Syntax.freshen_bv x
                                 in
                              {
             ...
             let uu___2 =
               let uu___3 =
                 let uu___4 = FStar_Thunk.mk norm  in FStar_Util.Inl uu___4
                  in
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu___3;_},arg::more::args)
             ->
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu___4;_},arg::more::args)
             ->
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                  (FStar_Const.Const_reflect uu___2);
                FStar_Syntax_Syntax.pos = uu___3;
                FStar_Syntax_Syntax.vars = uu___4;_},arg::[])
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                  (FStar_Const.Const_reify );
                FStar_Syntax_Syntax.pos = uu___2;
                FStar_Syntax_Syntax.vars = uu___3;_},arg::[])
             when
               ...
               let uu___4 =
                 FStar_List.map
                   (fun x  ->
                      ...
                      (uu___5, (FStar_Pervasives_Native.snd x))) args
                  in
               iapp cfg uu___3 uu___4))
                   ...
                   | FStar_Syntax_Syntax.Pat_var bvar ->
                       let x =
                         ...
                         FStar_Syntax_Syntax.new_bv
                          ...
                          in
                       let uu___4 =
                         let uu___5 = FStar_TypeChecker_NBETerm.mkAccuVar x
                            in
                         uu___5 :: bs1  in
                    ...
                    | (pat,when_clause,e1) ->
                        ...
                        (match uu___4 with
                         | (bs',pat') ->
                             ...
                             FStar_Syntax_Util.branch uu___5)) branches
                in
         ...
         | FStar_Syntax_Syntax.Tm_meta (e1,meta) ->
             let norm_meta uu___2 =
               ...
               | FStar_Syntax_Syntax.Meta_monadic_lift (m0,m1,t) ->
                   ...
                   FStar_Syntax_Syntax.Meta_monadic_lift uu___3
                in
             let uu___2 =
               let uu___3 =
                 let uu___4 = translate cfg bs e1  in
                 let uu___5 = FStar_Thunk.mk norm_meta  in (uu___4, uu___5)
                  in
         ...
         | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
             ...
             then
               ...
               (let def uu___4 =
                ...
                let name =
                  let uu___4 = FStar_Util.left lb.FStar_Syntax_Syntax.lbname
                     in
         ...
         | FStar_Syntax_Syntax.Tm_let ((_rec,lbs),body) ->
             ...
             then
               let vars =
                 FStar_List.map
                   (fun lb  ->
                      ...
                      FStar_Syntax_Syntax.freshen_bv uu___2) lbs
                  in
               let typs =
                 FStar_List.map
               ...
               (let uu___3 = make_rec_env lbs bs  in
                translate cfg uu___3 body)
                 ...
                 FStar_List.map
                   (fun uu___3  ->
                      ...
                      | (bv,t1) ->
                          ...
                          FStar_Syntax_Syntax.NT uu___4) uu___2
                  in
            ...
            then
              ...
              then
                ...
                (let uu___3 = FStar_List.splitAt n args  in
                 ...
                 | (args1,args') ->
                     let uu___4 =
                       let uu___5 = map_rev FStar_Pervasives_Native.fst args1
                          in
                       f1 uu___5  in
        ...
        | FStar_TypeChecker_NBETerm.Construct (i,us,ts) ->
            let rec aux args1 us1 ts1 =
              ...
              | ({
                   ...
                   FStar_TypeChecker_NBETerm.nbe_r = uu___1;_},uu___2)::args2
                  -> aux args2 (u :: us1) ts1
            ...
            (debug cfg
             ...
             then
               (let uu___2 =
                  ...
                  match uu___3 with
                  | FStar_Syntax_Syntax.Tm_abs (bs,body,uu___4) -> (bs, body)
        ...
        | FStar_TypeChecker_NBETerm.Constant
            ...
            (match args with
             | (t,uu___1)::({
                              ...
                              FStar_TypeChecker_NBETerm.nbe_r = uu___2;_},uu___3)::[]
                 ->
                 let uu___4 = t  in
                 {
                   FStar_TypeChecker_NBETerm.nbe_t =
               ...
               (debug1
                ...
                (let uu___4 =
                 ...
                 | FStar_Pervasives_Native.Some prim_step when
                     ...
                     (debug1
                        (fun uu___6  ->
                           let uu___7 = FStar_Syntax_Print.fv_to_string fvar
                              in
                      ...
                      (let uu___6 =
                         let uu___7 =
                           let uu___8 =
                             ...
                             let uu___9 =
                               let uu___10 = FStar_Common.tabulate arity f
                                  in
                 ...
                 | FStar_Pervasives_Native.Some uu___5 ->
                     (debug1
                        (fun uu___7  ->
                           let uu___8 = FStar_Syntax_Print.fv_to_string fvar
                              in
           ...
           | FStar_TypeChecker_Normalize.Should_unfold_reify  ->
               let t =
                 ...
                 then
                   ...
                   | FStar_Pervasives_Native.Some
                       (FStar_Util.Inr
                        ({
                           ...
                           FStar_Syntax_Syntax.sigopts = uu___7;_},_us_opt),_rng)
                       ->
                       (debug1
                          (fun uu___9  ->
                             let uu___10 =
                   ...
                   (debug1
                      (fun uu___5  ->
                         let uu___6 = FStar_Syntax_Print.fv_to_string fvar
                            in
                         FStar_Util.print1
      ...
      fun lb  ->
        ...
        | (formals,uu___1) ->
            ...
            then translate cfg bs lb.FStar_Syntax_Syntax.lbdef
              ...
              (let uu___3 = FStar_Util.is_right lb.FStar_Syntax_Syntax.lbname
                  in
               if uu___3
               then
                 (debug1
    ...
    fun c  ->
      let c' =
        ...
        | FStar_TypeChecker_NBETerm.Comp ctyp ->
            ...
            FStar_Syntax_Syntax.Comp uu___
         in
    ...
    fun bs  ->
      fun c  ->
        ...
        | { FStar_Syntax_Syntax.comp_univs = comp_univs;
            ...
            let uu___1 = FStar_List.map (translate_univ cfg bs) comp_univs
               in
            ...
            let uu___3 =
              FStar_List.map
                (fun x  ->
                   let uu___4 =
                     translate cfg bs (FStar_Pervasives_Native.fst x)  in
                   (uu___4, (FStar_Pervasives_Native.snd x))) effect_args
               in
              ...
              (match e1.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                   let uu___1 =
                     ...
                     FStar_TypeChecker_Env.effect_decl_opt
                       (cfg.core_cfg).FStar_TypeChecker_Cfg.tcenv uu___2
                      in
                   (match uu___1 with
                    | FStar_Pervasives_Native.None  ->
                        let uu___2 =
                          ...
                          FStar_Util.format1
                            "Effect declaration not found: %s" uu___3
                           in
                        failwith uu___2
               ...
               | FStar_Syntax_Syntax.Tm_app
                   ({
                      ...
                      FStar_Syntax_Syntax.pos = uu___2;
                      FStar_Syntax_Syntax.vars = uu___3;_},(e2,uu___4)::[])
                   ->
                   let uu___5 = reifying_false cfg  in translate uu___5 bs e2
               | FStar_Syntax_Syntax.Tm_app (head,args) ->
                   (debug cfg
                      (fun uu___2  ->
                         let uu___3 = FStar_Syntax_Print.term_to_string head
                            in
                         let uu___4 = FStar_Syntax_Print.args_to_string args
                            in
                         FStar_Util.print2
                         ...
                         then fallback1 ()
                           ...
                           (let uu___5 =
                            ...
                            then fallback2 ()
                              ...
                              (let e2 =
                                 let uu___7 = FStar_Syntax_Util.mk_reify head
                                    in
                     ...
                     FStar_All.pipe_right branches
                       (FStar_List.map
                          (fun uu___1  ->
                             match uu___1 with
                             | (pat,wopt,tm) ->
                                 let uu___2 = FStar_Syntax_Util.mk_reify tm
                                    in
                                 (pat, wopt, uu___2)))
                      in
                   let tm =
               ...
               | uu___1 ->
                   let uu___2 =
                     ...
                     FStar_Util.format1
                       "Unexpected case in translate_monadic: %s" uu___3
                      in
                   failwith uu___2)
        ...
        fun e  ->
          ...
          | (msrc,mtgt,ty) ->
              ...
              then
                ...
                (debug cfg
                   (fun uu___3  ->
                      let uu___4 = FStar_TypeChecker_NBETerm.t_to_string t
                         in
    ...
    fun x  ->
      ...
      let readback_args cfg1 args =
        map_rev
          (fun uu___  ->
             match uu___ with
             | (x1,q) -> let uu___1 = readback cfg1 x1  in (uu___1, q)) args
         in
      let with_range t =
        let uu___ = t  in
        {
      ...
      (match x.FStar_TypeChecker_NBETerm.nbe_t with
       ...
       | FStar_TypeChecker_NBETerm.Lam (f,binders,arity) ->
           ...
           (match uu___1 with
            | (binders1,accus_rev,rc) ->
                let body = let uu___2 = f accus_rev  in readback cfg uu___2
                   in
       ...
       | FStar_TypeChecker_NBETerm.Refinement (f,targ) ->
           ...
           then
             let uu___1 =
               let uu___2 = targ ()  in FStar_Pervasives_Native.fst uu___2
                in
             readback cfg uu___1
           else
             (let x1 =
       ...
       | FStar_TypeChecker_NBETerm.Construct (fv,us,args) ->
           ...
           let fv1 =
             ...
             FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_fvar fv) uu___1
              in
           let app =
             let uu___1 =
       ...
       | FStar_TypeChecker_NBETerm.Accu
           ...
           let body1 =
             let uu___1 =
               let uu___2 = FStar_Thunk.force body  in readback cfg uu___2
                in
                ...
                let args1 =
                  FStar_List.map
                    (fun uu___3  ->
                       match uu___3 with
                       | (x1,q) ->
                           let uu___4 = readback cfg x1  in (uu___4, q)) args
                   in
                let uu___3 = FStar_Syntax_Util.mk_app head args1  in
                with_range uu___3)
      ...
      fun env  ->
        fun e  ->
          ...
          (let cfg2 = new_config cfg1  in
           let r = let uu___1 = translate cfg2 [] e  in readback cfg2 uu___1
              in
           (let uu___2 =
              (FStar_TypeChecker_Env.debug env (FStar_Options.Other "NBETop"))
                ||
