    ...
    | FStar_Pervasives_Native.Some
        (FStar_Util.Inr
         ({
            ...
            FStar_Syntax_Syntax.sigopts = uu____1631;_},
          uu____1632),
         uu____1633)
        -> true
    | uu____1693 -> false
                       ...
                       then
                         (debug cfg
                          ...
                          (match res with
                           | [] ->
                               let uu____2906 =
                                 let uu____2907 = make_rec_env tr_lb lbs bs in
                                 tr_lb uu____2907 lb in
                               iapp cfg uu____2906 args1
                           | uu____2910::uu____2911 ->
                               let t =
                                 let uu____2927 =
                                   let uu____2928 = make_rec_env tr_lb lbs bs in
        ...
        then FStar_TypeChecker_NBETerm.mkConstruct fvar1 [] []
          ...
          (let uu____3086 =
           ...
           | FStar_TypeChecker_Normalize.Should_unfold_no ->
               (debug1
                  (fun uu____3095 ->
                     let uu____3096 = FStar_Syntax_Print.fv_to_string fvar1 in
                ...
                | FStar_Pervasives_Native.Some
                    (FStar_Util.Inr
                     ({
                        ...
                        FStar_Syntax_Syntax.sigopts = uu____3305;_},
                      _us_opt),
                     _rng)
                    ->
                            ...
                            debug1
                              (fun uu____3390 ->
                                 let uu____3391 =
                                   ...
                                   FStar_Syntax_Print.tag_of_term uu____3393 in
                                 let uu____3394 =
                                   let uu____3396 =
                                     FStar_Syntax_Subst.compress
                                       lb.FStar_Syntax_Syntax.lbtyp in
                            ...
                            debug1
                              (fun uu____3405 ->
                                 let uu____3406 =
                                   ...
                                   FStar_Syntax_Print.tag_of_term uu____3408 in
                                 let uu____3409 =
                                   let uu____3411 =
                                     FStar_Syntax_Subst.compress
                                       lb.FStar_Syntax_Syntax.lbdef in
                ...
                | FStar_Pervasives_Native.Some
                    (FStar_Util.Inr
                     ({
                        ...
                        FStar_Syntax_Syntax.sigopts = uu____3426;_},
                      _us_opt),
                     _rng)
                    ->
                    let lbm = find_let lbs fvar1 in
                              ...
                              (fun uu____3526 ->
                                 let uu____3527 =
                                   let uu____3529 =
                                     FStar_Syntax_Subst.compress
                                       lb.FStar_Syntax_Syntax.lbdef in
                                   FStar_Syntax_Print.tag_of_term uu____3529 in
                                 let uu____3530 =
                                   let uu____3532 =
                                     FStar_Syntax_Subst.compress
                                       lb.FStar_Syntax_Syntax.lbdef in
          ...
          | lb::lbs' ->
              let uu____3878 =
                let uu____3881 = mkRec' callback lb lbs0 bs0 in uu____3881 ::
                  bs1 in
              aux lbs' lbs0 uu____3878 bs0 in
        aux lbs lbs bs bs
        ...
        (let uu____3961 =
               ...
               let uu____4041 =
                 FStar_List.map
                   (fun x ->
                      ...
                      FStar_TypeChecker_NBETerm.as_arg uu____4045) us in
             ...
             let uu____4349 =
               ...
               let uu____4479 =
                 FStar_Util.map_opt resc
                   (fun c ->
                      fun uu____4491 -> translate_residual_comp cfg bs c) in
               ((fun ys -> translate cfg (FStar_List.rev_append ys bs) body),
                 uu____4380, (FStar_List.length xs), uu____4479) in
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu____4526;_},
              arg::more::args)
             ->
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu____4659;_},
              arg::more::args)
             ->
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu____4792;_},
              arg::[])
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu____4841;_},
              arg::[])
             ->
             let uu____4881 =
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu____4887;_},
              arg::[])
             when
         ...
         | FStar_Syntax_Syntax.Tm_app (head1, args) ->
             (debug1
                (fun uu____4968 ->
                   let uu____4969 = FStar_Syntax_Print.term_to_string head1 in
                   let uu____4971 = FStar_Syntax_Print.args_to_string args in
               ...
               let uu____4975 =
                 FStar_List.map
                   (fun x ->
                      ...
                      (uu____4997, (FStar_Pervasives_Native.snd x))) args in
                 ...
                 let uu____5090 =
                         ...
                         FStar_List.fold_left
                           (fun uu____5167 ->
                              fun uu____5168 ->
                                ...
                                | ((bs2, args1), (arg, b)) ->
                                    let uu____5260 = process_pattern bs2 arg in
                   ...
                   | FStar_Syntax_Syntax.Pat_var bvar ->
                       let x =
                         ...
                         FStar_Syntax_Syntax.new_bv
                           FStar_Pervasives_Native.None uu____5359 in
                       let uu____5361 =
                         let uu____5364 =
                   ...
                   | FStar_Syntax_Syntax.Pat_wild bvar ->
                       let x =
                         ...
                         FStar_Syntax_Syntax.new_bv
                           FStar_Pervasives_Native.None uu____5369 in
                       let uu____5371 =
                         let uu____5374 =
                           FStar_TypeChecker_NBETerm.mkAccuVar x in
                         uu____5374 :: bs1 in
                   ...
                   | FStar_Syntax_Syntax.Pat_dot_term (bvar, tm) ->
                       let x =
                         ...
                         FStar_Syntax_Syntax.new_bv
                           FStar_Pervasives_Native.None uu____5384 in
                       let uu____5386 =
                         let uu____5387 =
                           let uu____5394 =
                    ...
                    | (pat, when_clause, e1) ->
                        ...
                        (match uu____5458 with
                         | (bs', pat') ->
                             ...
                             FStar_Syntax_Util.branch uu____5471)) branches in
             let rec case scrut1 =
               debug1
                 (fun uu____5497 ->
                    let uu____5498 =
         ...
         | FStar_Syntax_Syntax.Tm_let ((true, lbs), body) ->
             let uu____5762 = make_rec_env (translate_letbinding cfg) lbs bs in
             translate cfg uu____5762 body
         | FStar_Syntax_Syntax.Tm_meta (e1, uu____5766) ->
             translate cfg bs e1
                   ...
                   (fun uu____5815 ->
                      ...
                      | (bv, t1) ->
                          let uu____5822 =
                            ...
                            (bv, uu____5829) in
                          FStar_Syntax_Syntax.NT uu____5822) uu____5800 in
    ...
    fun c ->
      let c' =
        ...
        | FStar_TypeChecker_NBETerm.Comp ctyp ->
            ...
            FStar_Syntax_Syntax.Comp uu____5987 in
    ...
    fun bs ->
      fun c ->
        ...
        | { FStar_Syntax_Syntax.comp_univs = comp_univs;
            ...
            let uu____6013 = FStar_List.map (translate_univ bs) comp_univs in
            ...
            let uu____6015 =
              FStar_List.map
                (fun x ->
                   let uu____6043 =
                     translate cfg bs (FStar_Pervasives_Native.fst x) in
                   (uu____6043, (FStar_Pervasives_Native.snd x))) effect_args in
...
and (readback_comp_typ :
  ...
  fun cfg ->
    fun c ->
      let uu____6055 = readback cfg c.FStar_TypeChecker_NBETerm.result_typ in
      let uu____6058 =
        FStar_List.map
          (fun x ->
             let uu____6084 = readback cfg (FStar_Pervasives_Native.fst x) in
              ...
              (match e1.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), body) ->
                   let uu____6176 =
                     ...
                     FStar_TypeChecker_Env.effect_decl_opt
                       cfg.FStar_TypeChecker_Cfg.tcenv uu____6185 in
                   (match uu____6176 with
                    | FStar_Pervasives_Native.None ->
                        let uu____6192 =
                          let uu____6194 = FStar_Ident.string_of_lid m in
                          FStar_Util.format1
                            "Effect declaration not found: %s" uu____6194 in
                        failwith uu____6192
                          ...
                          let uu____6388 =
                            let uu____6389 =
                              let uu____6396 =
                                let uu____6401 =
                                  translate cfg' bs
                                    lb.FStar_Syntax_Syntax.lbtyp in
                                (uu____6401, FStar_Pervasives_Native.None) in
                              let uu____6402 =
                                let uu____6409 =
                            ...
                            let uu____6427 =
                              let uu____6434 =
                                ...
                                (FStar_TypeChecker_NBETerm.Unknown,
                                  FStar_Pervasives_Native.None) :: uu____6441 in
                              FStar_List.append maybe_range_arg uu____6434 in
               ...
               | FStar_Syntax_Syntax.Tm_app
                   ({
                      ...
                      FStar_Syntax_Syntax.vars = uu____6511;_},
                    (e2, uu____6513)::[])
                   ->
                   translate
               ...
               | uu____6889 ->
                   let uu____6890 =
                     ...
                     FStar_Util.format1
                       "Unexpected case in translate_monadic: %s" uu____6892 in
                   failwith uu____6890)
              ...
              then
                let ed =
                  ...
                  FStar_TypeChecker_Env.get_effect_decl
                    cfg.FStar_TypeChecker_Cfg.tcenv uu____6923 in
                let ret1 =
                  let uu____6925 =
                    let uu____6926 =
                      let uu____6929 =
                ...
                (let uu____7047 =
                 ...
                 | FStar_Pervasives_Native.Some
                     ...
                     let lift_lam =
                       ...
                       let uu____7122 =
                         let uu____7125 = FStar_Syntax_Syntax.bv_to_name x in
                        ...
                        (match uu____7346 with
                         | (xt, q) ->
                             let x1 =
                               ...
                               FStar_Syntax_Syntax.new_bv
                                 FStar_Pervasives_Native.None uu____7366 in
                             let uu____7367 =
                               let uu____7370 =
                ...
                let uu____7415 =
                  FStar_Util.map_opt resc
                    (fun thunk1 ->
                       ...
                       readback_residual_comp cfg uu____7426) in
                        ...
                        (match uu____7595 with
                         | (xt, q) ->
                             let x1 =
                               ...
                               FStar_Syntax_Syntax.new_bv
                                 FStar_Pervasives_Native.None uu____7615 in
                             let uu____7616 =
                               let uu____7619 =
                                 FStar_TypeChecker_NBETerm.mkAccuVar x1 in
           ...
           let args =
             map_rev
               (fun uu____7884 ->
                  ...
                  | (x1, q) ->
                      let uu____7895 = readback cfg x1 in (uu____7895, q)) ts in
           ...
           let args =
             map_rev
               (fun uu____7956 ->
                  ...
                  | (x1, q) ->
                      let uu____7967 = readback cfg x1 in (uu____7967, q)) ts in
           let head1 =
...
let (uu___is_Reify : step -> Prims.bool) =
  fun projectee -> match projectee with | Reify -> true | uu____8275 -> false
    ...
    fun steps ->
      fun env ->
        fun e ->
          ...
          (let r =
             let uu____8334 = translate cfg1 [] e in readback cfg1 uu____8334 in
           debug cfg1
             (fun uu____8338 ->
      ...
      fun e ->
        ...
        debug cfg1
          (fun uu____8372 ->
             ...
             FStar_Util.print1 "Calling NBE with (%s) {\n" uu____8373);
        (let r =
           let uu____8377 = translate cfg1 [] e in readback cfg1 uu____8377 in
         debug cfg1
           (fun uu____8381 ->
