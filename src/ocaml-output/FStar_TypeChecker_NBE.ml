  ...
  fun f ->
    fun l ->
      let rec aux l1 =
        match l1 with
        | [] -> []
        | x::xs -> let uu____337 = f x in if uu____337 then l1 else aux xs in
      aux l
            ...
            (let scrutinee = unlazy scrutinee0 in
             let r =
               ...
               | FStar_Syntax_Syntax.Pat_cons (fv, arg_pats) ->
                   ...
                   (match scrutinee with
                    ...
                    | uu____976 -> FStar_Util.Inr true) in
             let res_to_string uu___0_994 =
               ...
               | FStar_Util.Inl bs ->
                   ...
                   Prims.op_Hat "Inl " uu____1017 in
             debug cfg
               (fun uu____1025 ->
                  let uu____1026 =
          ...
          | (p, _wopt, e)::branches2 ->
              ...
              (match uu____1072 with
               | FStar_Util.Inl matches ->
                   (debug cfg
                      (fun uu____1097 ->
                         let uu____1098 = FStar_Syntax_Print.pat_to_string p in
            ...
            let uu____1375 =
              res &&
                (let uu____1378 =
                 ...
                 implies b uu____1378) in
            aux ts2 bs (t :: acc) uu____1375 in
      aux ts ar_list [] true
              ...
              (match lr with
               ...
               | FStar_Util.Inr (elt, FStar_Pervasives_Native.Some us) ->
                   (debug cfg
                    ...
                    FStar_Pervasives_Native.Some elt)
               | uu____1523 -> FStar_Pervasives_Native.None) in
                       ...
                       then
                         (debug cfg
                          ...
                          (match res with
                           | [] ->
                               let uu____2903 =
                                 let uu____2904 = make_rec_env tr_lb lbs bs in
                                 tr_lb uu____2904 lb in
                               iapp cfg uu____2903 args1
                           | uu____2907::uu____2908 ->
                               let t =
                                 let uu____2924 =
                                   let uu____2925 = make_rec_env tr_lb lbs bs in
        ...
        then FStar_TypeChecker_NBETerm.mkConstruct fvar1 [] []
          ...
          (let uu____3083 =
           ...
           | FStar_TypeChecker_Normalize.Should_unfold_no ->
               (debug1
                  (fun uu____3092 ->
                     let uu____3093 = FStar_Syntax_Print.fv_to_string fvar1 in
                ...
                | FStar_Pervasives_Native.Some
                    (FStar_Util.Inr
                     ({
                        ...
                        FStar_Syntax_Syntax.sigattrs = uu____3301;_},
                      _us_opt),
                     _rng)
                    ->
                            ...
                            debug1
                              (fun uu____3384 ->
                                 let uu____3385 =
                                   ...
                                   FStar_Syntax_Print.tag_of_term uu____3387 in
                                 let uu____3388 =
                                   let uu____3390 =
                                     FStar_Syntax_Subst.compress
                                       lb.FStar_Syntax_Syntax.lbtyp in
                            ...
                            debug1
                              (fun uu____3399 ->
                                 let uu____3400 =
                                   ...
                                   FStar_Syntax_Print.tag_of_term uu____3402 in
                                 let uu____3403 =
                                   let uu____3405 =
                                     FStar_Syntax_Subst.compress
                                       lb.FStar_Syntax_Syntax.lbdef in
                ...
                | FStar_Pervasives_Native.Some
                    (FStar_Util.Inr
                     ({
                        ...
                        FStar_Syntax_Syntax.sigattrs = uu____3419;_},
                      _us_opt),
                     _rng)
                    ->
                    let lbm = find_let lbs fvar1 in
                              ...
                              (fun uu____3502 ->
                                 let uu____3503 =
                                   let uu____3505 =
                                     FStar_Syntax_Subst.compress
                                       lb.FStar_Syntax_Syntax.lbtyp in
                                   FStar_Syntax_Print.tag_of_term uu____3505 in
                                 let uu____3506 =
                                   let uu____3508 =
                                     FStar_Syntax_Subst.compress
                                       lb.FStar_Syntax_Syntax.lbtyp in
                              ...
                              (fun uu____3517 ->
                                 let uu____3518 =
                                   let uu____3520 =
                                     FStar_Syntax_Subst.compress
                                       lb.FStar_Syntax_Syntax.lbdef in
                                   FStar_Syntax_Print.tag_of_term uu____3520 in
                                 let uu____3521 =
                                   let uu____3523 =
                                     FStar_Syntax_Subst.compress
                                       lb.FStar_Syntax_Syntax.lbdef in
          ...
          | lb::lbs' ->
              let uu____3869 =
                let uu____3872 = mkRec' callback lb lbs0 bs0 in uu____3872 ::
                  bs1 in
              aux lbs' lbs0 uu____3869 bs0 in
        aux lbs lbs bs bs
        ...
        (let uu____3952 =
               ...
               let uu____4032 =
                 FStar_List.map
                   (fun x ->
                      ...
                      FStar_TypeChecker_NBETerm.as_arg uu____4036) us in
             ...
             let uu____4340 =
               ...
               let uu____4470 =
                 FStar_Util.map_opt resc
                   (fun c ->
                      fun uu____4482 -> translate_residual_comp cfg bs c) in
               ((fun ys -> translate cfg (FStar_List.rev_append ys bs) body),
                 uu____4371, (FStar_List.length xs), uu____4470) in
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu____4650;_},
              arg::more::args)
             ->
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu____4783;_},
              arg::[])
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu____4832;_},
              arg::[])
             ->
             let uu____4872 =
         ...
         | FStar_Syntax_Syntax.Tm_app
             ({
                ...
                FStar_Syntax_Syntax.vars = uu____4878;_},
              arg::[])
             when
         ...
         | FStar_Syntax_Syntax.Tm_app (head1, args) ->
             (debug1
                (fun uu____4959 ->
                   let uu____4960 = FStar_Syntax_Print.term_to_string head1 in
                   let uu____4962 = FStar_Syntax_Print.args_to_string args in
               ...
               let uu____4966 =
                 FStar_List.map
                   (fun x ->
                      ...
                      (uu____4988, (FStar_Pervasives_Native.snd x))) args in
                 ...
                 let uu____5081 =
                         ...
                         FStar_List.fold_left
                           (fun uu____5158 ->
                              fun uu____5159 ->
                                ...
                                | ((bs2, args1), (arg, b)) ->
                                    let uu____5251 = process_pattern bs2 arg in
                   ...
                   | FStar_Syntax_Syntax.Pat_var bvar ->
                       let x =
                         ...
                         FStar_Syntax_Syntax.new_bv
                           FStar_Pervasives_Native.None uu____5350 in
                       let uu____5352 =
                         let uu____5355 =
                   ...
                   | FStar_Syntax_Syntax.Pat_wild bvar ->
                       let x =
                         ...
                         FStar_Syntax_Syntax.new_bv
                           FStar_Pervasives_Native.None uu____5360 in
                       let uu____5362 =
                         let uu____5365 =
                           FStar_TypeChecker_NBETerm.mkAccuVar x in
                         uu____5365 :: bs1 in
                   ...
                   | FStar_Syntax_Syntax.Pat_dot_term (bvar, tm) ->
                       let x =
                         ...
                         FStar_Syntax_Syntax.new_bv
                           FStar_Pervasives_Native.None uu____5375 in
                       let uu____5377 =
                         let uu____5378 =
                           let uu____5385 =
                    ...
                    | (pat, when_clause, e1) ->
                        ...
                        (match uu____5449 with
                         | (bs', pat') ->
                             ...
                             FStar_Syntax_Util.branch uu____5462)) branches in
             let rec case scrut1 =
               debug1
                 (fun uu____5488 ->
                    let uu____5489 =
         ...
         | FStar_Syntax_Syntax.Tm_let ((true, lbs), body) ->
             let uu____5753 = make_rec_env (translate_letbinding cfg) lbs bs in
             translate cfg uu____5753 body
         | FStar_Syntax_Syntax.Tm_meta (e1, uu____5757) ->
             translate cfg bs e1
                   ...
                   (fun uu____5806 ->
                      ...
                      | (bv, t1) ->
                          let uu____5813 =
                            ...
                            (bv, uu____5820) in
                          FStar_Syntax_Syntax.NT uu____5813) uu____5791 in
    ...
    fun c ->
      let c' =
        ...
        | FStar_TypeChecker_NBETerm.Comp ctyp ->
            ...
            FStar_Syntax_Syntax.Comp uu____5978 in
    ...
    fun bs ->
      fun c ->
        ...
        | { FStar_Syntax_Syntax.comp_univs = comp_univs;
            ...
            let uu____6004 = FStar_List.map (translate_univ bs) comp_univs in
            ...
            let uu____6006 =
              FStar_List.map
                (fun x ->
                   let uu____6034 =
                     translate cfg bs (FStar_Pervasives_Native.fst x) in
                   (uu____6034, (FStar_Pervasives_Native.snd x))) effect_args in
...
and (readback_comp_typ :
  ...
  fun cfg ->
    fun c ->
      let uu____6046 = readback cfg c.FStar_TypeChecker_NBETerm.result_typ in
      let uu____6049 =
        FStar_List.map
          (fun x ->
             let uu____6075 = readback cfg (FStar_Pervasives_Native.fst x) in
              ...
              (match e1.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), body) ->
                   let uu____6167 =
                     ...
                     FStar_TypeChecker_Env.effect_decl_opt
                       cfg.FStar_TypeChecker_Cfg.tcenv uu____6176 in
                   (match uu____6167 with
                    | FStar_Pervasives_Native.None ->
                        let uu____6183 =
                          let uu____6185 = FStar_Ident.string_of_lid m in
                          FStar_Util.format1
                            "Effect declaration not found: %s" uu____6185 in
                        failwith uu____6183
                          ...
                          then
                            ...
                            let uu____6302 =
                              let uu____6309 =
                                ...
                                (uu____6314, FStar_Pervasives_Native.None) in
                              [uu____6309] in
                          ...
                          let uu____6354 =
                            ...
                            let uu____6393 =
                              let uu____6400 =
                                ...
                                (FStar_TypeChecker_NBETerm.Unknown,
                                  FStar_Pervasives_Native.None) :: uu____6407 in
                              FStar_List.append maybe_range_arg uu____6400 in
               ...
               | FStar_Syntax_Syntax.Tm_app
                   ({
                      ...
                      FStar_Syntax_Syntax.vars = uu____6477;_},
                    (e2, uu____6479)::[])
                   ->
                   translate
               ...
               | uu____6855 ->
                   let uu____6856 =
                     ...
                     FStar_Util.format1
                       "Unexpected case in translate_monadic: %s" uu____6858 in
                   failwith uu____6856)
              ...
              then
                let ed =
                  ...
                  FStar_TypeChecker_Env.get_effect_decl
                    cfg.FStar_TypeChecker_Cfg.tcenv uu____6889 in
                let ret1 =
                  let uu____6891 =
                    let uu____6892 =
                      FStar_Syntax_Subst.compress
                ...
                (let uu____6964 =
                 ...
                 | FStar_Pervasives_Native.Some
                     ...
                     let lift_lam =
                       ...
                       let uu____7046 =
                         let uu____7049 = FStar_Syntax_Syntax.bv_to_name x in
                         lift FStar_Syntax_Syntax.U_unknown ty
                           FStar_Syntax_Syntax.tun uu____7049 in
                        ...
                        (match uu____7270 with
                         | (xt, q) ->
                             let x1 =
                               ...
                               FStar_Syntax_Syntax.new_bv
                                 FStar_Pervasives_Native.None uu____7290 in
                             let uu____7291 =
                               let uu____7294 =
                ...
                let uu____7339 =
                  FStar_Util.map_opt resc
                    (fun thunk1 ->
                       ...
                       readback_residual_comp cfg uu____7350) in
                        ...
                        (match uu____7519 with
                         | (xt, q) ->
                             let x1 =
                               ...
                               FStar_Syntax_Syntax.new_bv
                                 FStar_Pervasives_Native.None uu____7539 in
                             let uu____7540 =
                               let uu____7543 =
                                 FStar_TypeChecker_NBETerm.mkAccuVar x1 in
           ...
           let args =
             map_rev
               (fun uu____7808 ->
                  ...
                  | (x1, q) ->
                      let uu____7819 = readback cfg x1 in (uu____7819, q)) ts in
           ...
           let args =
             map_rev
               (fun uu____7880 ->
                  ...
                  | (x1, q) ->
                      let uu____7891 = readback cfg x1 in (uu____7891, q)) ts in
           let head1 =
...
let (uu___is_Reify : step -> Prims.bool) =
  fun projectee -> match projectee with | Reify -> true | uu____8199 -> false
    ...
    fun steps ->
      fun env ->
        fun e ->
          ...
          (let r =
             let uu____8258 = translate cfg1 [] e in readback cfg1 uu____8258 in
           debug cfg1
             (fun uu____8262 ->
      ...
      fun e ->
        ...
        debug cfg1
          (fun uu____8296 ->
             ...
             FStar_Util.print1 "Calling NBE with (%s) {\n" uu____8297);
        (let r =
           let uu____8301 = translate cfg1 [] e in readback cfg1 uu____8301 in
         debug cfg1
           (fun uu____8305 ->
