...
let qop_to_string : qop -> Prims.string =
  fun uu___117_1668  ->
    match uu___117_1668 with | Forall  -> "forall" | Exists  -> "exists"
  
let op_to_string : op -> Prims.string =
  fun uu___118_1672  ->
    match uu___118_1672 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
...
let mkInteger : Prims.string -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____1917 =
        let uu____1918 = FStar_Util.ensure_decimal i  in Integer uu____1918
         in
      mk uu____1917 r
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____2211,App (Imp ,t1'::t2'::[])) ->
               let uu____2216 =
                 let uu____2223 =
                   let uu____2226 = mkAnd (t1, t1') r  in [uu____2226; t2']
                    in
                 (Imp, uu____2223)  in
               mkApp' uu____2216 r
           ...
           | uu____2702 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp ,uu____2713),uu____2714) ->
                    let uu____2719 =
                      let uu____2724 = mkNot t1 t1.rng  in (uu____2724, t3)
                       in
                    mkImp uu____2719 r
                   ...
                   FStar_List.fold_left
                     (fun uu____3141  ->
                        fun e  ->
                          ...
                          | (ix1,l) ->
                              let uu____3161 =
                                let uu____3164 = aux ix1 e  in uu____3164 ::
                                  l
                                 in
              ...
              FStar_List.fold_left
                (fun uu____3355  ->
                   fun e  ->
                     ...
                     | (ix,es1) ->
                         let uu____3375 =
                           let uu____3378 = aux shift e  in uu____3378 :: es1
                            in
...
let subst : term -> fv -> term -> term =
  fun t  ->
    fun fv  ->
      fun s  -> let uu____3411 = abstr [fv] t  in inst [s] uu____3411
               ...
               (fun i  ->
                  fun s  ->
                    let uu____3995 =
                      ...
                      (uu____4000, s)  in
                    mkFreeV uu____3995 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let cid_app =
          let uu____4009 =
            let uu____4016 = constr_id_of_sort sort  in (uu____4016, [capp])
             in
...
let injective_constructor :
  ...
  fun uu____4061  ->
    ...
    | (name,fields,sort) ->
        ...
        let bvar i s =
          let uu____4102 = let uu____4107 = bvar_name i  in (uu____4107, s)
             in
               ...
               (fun i  ->
                  fun uu____4128  ->
                    ...
                    | (uu____4135,s,uu____4137) ->
                        let uu____4138 = bvar i s  in uu____4138 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let uu____4147 =
          ...
          FStar_All.pipe_right fields
            (FStar_List.map
               (fun uu____4268  ->
                  ...
                  | (uu____4275,sort1,uu____4277) -> sort1))
           in
        let cdecl =
          DeclFun
        ...
        let disc =
          ...
          | (proj_terms,ex_vars) ->
              ...
              let disc_inv_body1 =
                match ex_vars1 with
                | [] -> disc_inv_body
                | uu____4523 -> mkExists ([], ex_vars1, disc_inv_body) norng
                 in
          ...
          fun depth  ->
            ...
            then enclosing_name
              ...
              (let uu____4992 = FStar_Util.string_of_int n1  in
               FStar_Util.format2 "%s.%s" enclosing_name uu____4992)
           in
            ...
            then
              let uu____5437 =
                FStar_All.pipe_right (FStar_Util.splitlines c)
                  (fun uu___121_5441  ->
                     match uu___121_5441 with | [] -> "" | h::t -> h)
                 in
              FStar_Util.format1 "\n; %s" uu____5437
            else ""
...
let mk_Term_uvar : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____6012 =
        let uu____6019 = let uu____6022 = mkInteger' i norng  in [uu____6022]
           in
...
let mk_Valid : term -> term =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___123_6531 = unboxBool t1  in
        {
          tm = (uu___123_6531.tm);
          freevars = (uu___123_6531.freevars);
          rng = (t.rng)
        }
...
let mk_String_const : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____6664 =
        let uu____6671 = let uu____6674 = mkInteger' i norng  in [uu____6674]
           in
