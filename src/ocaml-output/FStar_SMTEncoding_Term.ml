...
let mkInteger : Prims.string -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____1836 =
        let uu____1837 = FStar_Util.ensure_decimal i  in Integer uu____1837
         in
      mk uu____1836 r
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____2112,App (Imp ,t1'::t2'::[])) ->
               let uu____2117 =
                 let uu____2124 =
                   let uu____2127 = mkAnd (t1, t1') r  in [uu____2127; t2']
                    in
                 (Imp, uu____2124)  in
               mkApp' uu____2117 r
           ...
           | uu____2559 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp ,uu____2570),uu____2571) ->
                    let uu____2576 =
                      let uu____2581 = mkNot t1 t1.rng  in (uu____2581, t3)
                       in
                    mkImp uu____2576 r
                   ...
                   FStar_List.fold_left
                     (fun uu____2992  ->
                        fun e  ->
                          ...
                          | (ix1,l) ->
                              let uu____3012 =
                                let uu____3015 = aux ix1 e  in uu____3015 ::
                                  l
                                 in
              ...
              FStar_List.fold_left
                (fun uu____3204  ->
                   fun e  ->
                     ...
                     | (ix,es1) ->
                         let uu____3224 =
                           let uu____3227 = aux shift e  in uu____3227 :: es1
                            in
...
let subst : term -> fv -> term -> term =
  fun t  ->
    fun fv  ->
      fun s  -> let uu____3257 = abstr [fv] t  in inst [s] uu____3257
               ...
               (fun i  ->
                  fun s  ->
                    let uu____3825 =
                      ...
                      (uu____3830, s)  in
                    mkFreeV uu____3825 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let cid_app =
          let uu____3839 =
            let uu____3846 = constr_id_of_sort sort  in (uu____3846, [capp])
             in
...
let injective_constructor :
  ...
  fun uu____3890  ->
    ...
    | (name,fields,sort) ->
        ...
        let bvar i s =
          let uu____3931 = let uu____3936 = bvar_name i  in (uu____3936, s)
             in
               ...
               (fun i  ->
                  fun uu____3957  ->
                    ...
                    | (uu____3964,s,uu____3966) ->
                        let uu____3967 = bvar i s  in uu____3967 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let uu____3976 =
...
let constructor_to_decl : constructor_t -> decls_t =
  fun uu____4068  ->
    ...
    | (name,fields,sort,id1,injective) ->
          ...
          FStar_All.pipe_right fields
            (FStar_List.map
               (fun uu____4096  ->
                  ...
                  | (uu____4103,sort1,uu____4105) -> sort1))
           in
        let cdecl =
          DeclFun
        ...
        let disc =
          ...
          | (proj_terms,ex_vars) ->
              ...
              let disc_inv_body1 =
                match ex_vars1 with
                | [] -> disc_inv_body
                | uu____4351 -> mkExists ([], ex_vars1, disc_inv_body) norng
                 in
        ...
        let uu____4392 =
          let uu____4395 =
            let uu____4396 = FStar_Util.format1 "<start constructor %s>" name
               in
          ...
          fun depth  ->
            ...
            then enclosing_name
              ...
              (let uu____4834 = FStar_Util.string_of_int n1  in
               FStar_Util.format2 "%s.%s" enclosing_name uu____4834)
           in
                                ...
                                (fun pats2  ->
                                   let uu____5052 =
                                     let uu____5053 =
                                       FStar_List.map
                                         (fun p  ->
                                            let uu____5059 = aux1 n2 names2 p
                                               in
      ...
      fun decl  ->
        ...
        | Assume a ->
            ...
            let fids =
              ...
              then
                let uu____5385 =
                  let uu____5386 = fact_ids_to_string a.assumption_fact_ids
                     in
...
let mk_Range_const : Prims.unit -> term =
  fun uu____5843  ->
    ...
    (let uu____5992 =
       let uu____5999 = let uu____6002 = mkInteger' i norng  in [uu____6002]
          in
...
let mk_Term_uvar : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____6024 =
        let uu____6031 = let uu____6034 = mkInteger' i norng  in [uu____6034]
           in
...
let mk_String_const : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____6626 =
        let uu____6633 = let uu____6636 = mkInteger' i norng  in [uu____6636]
           in
