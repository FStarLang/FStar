...
let (uu___is_App : term' -> Prims.bool) =
  fun projectee -> match projectee with | App _0 -> true | uu____989 -> false
...
let (uu___is_Push : decl -> Prims.bool) =
  fun projectee -> match projectee with | Push -> true | uu____1941 -> false
...
let rec (freevars : term -> (Prims.string * sort * Prims.bool) Prims.list) =
  fun t ->
    ...
    | Quant (uu____2667, uu____2668, uu____2669, uu____2670, t1) ->
        freevars t1
...
let rec (hash_of_term' : term' -> Prims.string) =
  fun t ->
    ...
    | FreeV x ->
        ...
        let uu____3007 =
          let uu____3009 = let uu____3011 = fv_sort x in strSort uu____3011 in
...
let (mkInteger : Prims.string -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____3369 =
        let uu____3370 = FStar_Util.ensure_decimal i in Integer uu____3370 in
      mk uu____3369 r
      ...
      | (t1, t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____3705, App (Imp, t1'::t2'::[])) ->
               let uu____3710 =
                 let uu____3717 =
                   let uu____3720 = mkAnd (t1, t1') r in [uu____3720; t2'] in
                 (Imp, uu____3717) in
               mkApp' uu____3710 r
           ...
           | uu____4353 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp, uu____4364), uu____4365) ->
                    let uu____4370 =
                      let uu____4375 = mkNot t1 t1.rng in (uu____4375, t3) in
                    mkImp uu____4370 r
                   ...
                   FStar_List.fold_left
                     (fun uu____5235 ->
                        fun e ->
                          ...
                          | (ix1, l) ->
                              let uu____5259 =
                                let uu____5262 = aux ix1 e in uu____5262 :: l in
        ...
        | Let (es, body) ->
              ...
              FStar_List.fold_left
                (fun uu____5487 ->
                   fun e ->
                     ...
                     | (ix, es1) ->
                         let uu____5511 =
                           let uu____5514 = aux shift e in uu____5514 :: es1 in
            ...
            (match uu____5467 with
             | (shift1, es_rev) ->
                 ...
                 mkLet uu____5530 t1.rng) in
      aux Prims.int_zero t
let (subst : term -> fv -> term -> term) =
  fun t ->
    fun fv -> fun s -> let uu____5557 = abstr [fv] t in inst [s] uu____5557
let (mkQuant' :
  FStar_Range.range ->
    (qop * term Prims.list Prims.list * Prims.int
                    ...
                    fun s ->
                      let uu____6204 =
                        let uu____6205 =
                          ...
                          (uu____6211, s) in
                        mk_fv uu____6205 in
                      mkFreeV uu____6204 norng)) in
          let bvar_names = FStar_List.map fv_of_term bvars in
          let capp = mkApp (name, bvars) norng in
          let cid_app =
            let uu____6241 =
              let uu____6249 = constr_id_of_sort sort in (uu____6249, [capp]) in
                 ...
                 (fun i ->
                    fun uu____6415 ->
                      ...
                      | (uu____6425, s, uu____6427) ->
                          let uu____6432 = bvar i s in uu____6432 norng)) in
          let bvar_names = FStar_List.map fv_of_term bvars in
          let capp = mkApp (name, bvars) norng in
          let uu____6460 =
            FStar_All.pipe_right fields
            ...
            FStar_All.pipe_right fields
              (FStar_List.map
                 (fun uu____6636 ->
                    ...
                    | (uu____6645, sort1, uu____6647) -> sort1)) in
          let cdecl =
            DeclFun
          ...
          fun depth ->
            ...
            then enclosing_name
              ...
              (let uu____7338 = FStar_Util.string_of_int n1 in
               FStar_Util.format2 "%s.%s" enclosing_name uu____7338) in
                       ...
                       (fun tm ->
                          ...
                          | App
                              (Var "Prims.guard_free",
                               { tm = BoundV uu____7384;
                                 freevars = uu____7385; rng = uu____7386;_}::[])
                              -> tm
                                ...
                                (fun pats2 ->
                                   let uu____7649 =
                                     let uu____7651 =
                                       FStar_List.map
                                         (fun p ->
                                            let uu____7659 = aux1 n2 names2 p in
      ...
      fun decl ->
        ...
        | Assume a ->
            ...
            let fids =
              ...
              then
                let uu____8135 =
                  let uu____8137 = fact_ids_to_string a.assumption_fact_ids in
            ...
            let uu____8150 = termToSmt print_captions n1 a.assumption_term in
  ...
  fun sz ->
    let uu____8393 =
      ...
      let uu____8405 =
        ...
        [uu____8408] in
      (uu____8394, uu____8405, Term_sort, ((Prims.of_int (12)) + sz), true) in
...
let (mk_Range_const : unit -> term) =
  fun uu____8443 ->
    ...
    (let uu____8468 =
       ...
       uu____8470 + Prims.int_one in
     FStar_ST.op_Colon_Equals __range_c uu____8468);
    (let uu____8515 =
       let uu____8523 = let uu____8526 = mkInteger' i norng in [uu____8526] in
...
let (mk_Term_uvar : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____8569 =
        let uu____8577 = let uu____8580 = mkInteger' i norng in [uu____8580] in
...
let (mk_Valid : term -> term) =
  fun t ->
    ...
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_Equality", uu____8879::t1::t2::[]);
           freevars = uu____8882; rng = uu____8883;_}::[])
        -> mkEq (t1, t2) t.rng
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_disEquality", uu____8902::t1::t2::[]);
    ...
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_Negation", t1::[]); freevars = uu____9101;
           rng = uu____9102;_}::[])
    ...
    | App
        (Var "Prims.equals",
         uu____9173::{ tm = App (Var "FStar.BV.bvult", t0::t1::t2::[]);
                       freevars = uu____9177; rng = uu____9178;_}::uu____9179::[])
        when
...
let (mk_String_const : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____9454 =
        let uu____9462 = let uu____9465 = mkInteger' i norng in [uu____9465] in
...
let rec (n_fuel : Prims.int -> term) =
  fun n1 ->
    ...
    then mkApp ("ZFuel", []) norng
      ...
      (let uu____9543 =
         let uu____9551 =
           let uu____9554 = n_fuel (n1 - Prims.int_one) in [uu____9554] in
         ("SFuel", uu____9551) in
