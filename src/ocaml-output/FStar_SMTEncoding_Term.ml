...
let mkInteger : Prims.string -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____1808 =
        let uu____1809 = FStar_Util.ensure_decimal i  in Integer uu____1809
         in
      mk uu____1808 r
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____2084,App (Imp ,t1'::t2'::[])) ->
               let uu____2089 =
                 let uu____2096 =
                   let uu____2099 = mkAnd (t1, t1') r  in [uu____2099; t2']
                    in
                 (Imp, uu____2096)  in
               mkApp' uu____2089 r
           ...
           | uu____2531 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp ,uu____2542),uu____2543) ->
                    let uu____2548 =
                      let uu____2553 = mkNot t1 t1.rng  in (uu____2553, t3)
                       in
                    mkImp uu____2548 r
                   ...
                   FStar_List.fold_left
                     (fun uu____2964  ->
                        fun e  ->
                          ...
                          | (ix1,l) ->
                              let uu____2984 =
                                let uu____2987 = aux ix1 e  in uu____2987 ::
                                  l
                                 in
              ...
              FStar_List.fold_left
                (fun uu____3176  ->
                   fun e  ->
                     ...
                     | (ix,es1) ->
                         let uu____3196 =
                           let uu____3199 = aux shift e  in uu____3199 :: es1
                            in
...
let subst : term -> fv -> term -> term =
  fun t  ->
    fun fv  ->
      fun s  -> let uu____3229 = abstr [fv] t  in inst [s] uu____3229
               ...
               (fun i  ->
                  fun s  ->
                    let uu____3797 =
                      ...
                      (uu____3802, s)  in
                    mkFreeV uu____3797 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let cid_app =
          let uu____3811 =
            let uu____3818 = constr_id_of_sort sort  in (uu____3818, [capp])
             in
...
let injective_constructor :
  ...
  fun uu____3862  ->
    ...
    | (name,fields,sort) ->
        ...
        let bvar i s =
          let uu____3903 = let uu____3908 = bvar_name i  in (uu____3908, s)
             in
               ...
               (fun i  ->
                  fun uu____3929  ->
                    ...
                    | (uu____3936,s,uu____3938) ->
                        let uu____3939 = bvar i s  in uu____3939 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let uu____3948 =
...
let constructor_to_decl : constructor_t -> decls_t =
  fun uu____4040  ->
    ...
    | (name,fields,sort,id1,injective) ->
          ...
          FStar_All.pipe_right fields
            (FStar_List.map
               (fun uu____4068  ->
                  ...
                  | (uu____4075,sort1,uu____4077) -> sort1))
           in
        let cdecl =
          DeclFun
        ...
        let disc =
          ...
          | (proj_terms,ex_vars) ->
              ...
              let disc_inv_body1 =
                match ex_vars1 with
                | [] -> disc_inv_body
                | uu____4323 -> mkExists ([], ex_vars1, disc_inv_body) norng
                 in
        ...
        let uu____4364 =
          let uu____4367 =
            let uu____4368 = FStar_Util.format1 "<start constructor %s>" name
               in
          ...
          fun depth  ->
            ...
            then enclosing_name
              ...
              (let uu____4786 = FStar_Util.string_of_int n1  in
               FStar_Util.format2 "%s.%s" enclosing_name uu____4786)
           in
                                ...
                                (fun pats2  ->
                                   let uu____5004 =
                                     let uu____5005 =
                                       FStar_List.map
                                         (fun p  ->
                                            let uu____5011 = aux1 n2 names2 p
                                               in
      ...
      fun decl  ->
        ...
        | Assume a ->
            ...
            let fids =
              ...
              then
                let uu____5337 =
                  let uu____5338 = fact_ids_to_string a.assumption_fact_ids
                     in
...
let mk_Range_const : Prims.unit -> term =
  fun uu____5791  ->
    ...
    (let uu____5940 =
       let uu____5947 = let uu____5950 = mkInteger' i norng  in [uu____5950]
          in
...
let mk_Term_uvar : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____5972 =
        let uu____5979 = let uu____5982 = mkInteger' i norng  in [uu____5982]
           in
...
let mk_String_const : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____6574 =
        let uu____6581 = let uu____6584 = mkInteger' i norng  in [uu____6584]
           in
