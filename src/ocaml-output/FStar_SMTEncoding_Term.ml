...
let uu___is_Bool_sort : sort -> Prims.bool =
  fun projectee -> match projectee with Bool_sort -> true | uu____28 -> false


let uu___is_Int_sort : sort -> Prims.bool =
  fun projectee -> match projectee with Int_sort -> true | uu____32 -> false
...
let uu___is_Term_sort : sort -> Prims.bool =
  fun projectee -> match projectee with Term_sort -> true | uu____40 -> false


let uu___is_Fuel_sort : sort -> Prims.bool =
  fun projectee -> match projectee with Fuel_sort -> true | uu____44 -> false
...
let uu___is_Array : sort -> Prims.bool =
  fun projectee -> match projectee with Array _0 -> true | uu____65 -> false
...
let uu___is_Arrow : sort -> Prims.bool =
  fun projectee -> match projectee with Arrow _0 -> true | uu____93 -> false
...
let uu___is_Sort : sort -> Prims.bool =
  fun projectee -> match projectee with Sort _0 -> true | uu____117 -> false
...
let uu___is_FalseOp : op -> Prims.bool =
  fun projectee -> match projectee with FalseOp -> true | uu____158 -> false
...
let uu___is_BvToNat : op -> Prims.bool =
  fun projectee -> match projectee with BvToNat -> true | uu____294 -> false
...
type qop = Forall | Exists [@@deriving show]
...
let uu___is_FreeV : term' -> Prims.bool =
  fun projectee -> match projectee with FreeV _0 -> true | uu____468 -> false
...
let uu___is_App : term' -> Prims.bool =
  fun projectee -> match projectee with App _0 -> true | uu____498 -> false
...
let uu___is_Quant : term' -> Prims.bool =
  fun projectee -> match projectee with Quant _0 -> true | uu____546 -> false
...
let uu___is_Let : term' -> Prims.bool =
  fun projectee -> match projectee with Let _0 -> true | uu____618 -> false
...
let uu___is_Name : fact_db_id -> Prims.bool =
  fun projectee -> match projectee with Name _0 -> true | uu____853 -> false
...
let uu___is_Tag : fact_db_id -> Prims.bool =
  fun projectee -> match projectee with Tag _0 -> true | uu____877 -> false
...
let uu___is_Eval : decl -> Prims.bool =
  fun projectee -> match projectee with Eval _0 -> true | uu____1147 -> false
...
let uu___is_Echo : decl -> Prims.bool =
  fun projectee -> match projectee with Echo _0 -> true | uu____1159 -> false
...
let uu___is_Push : decl -> Prims.bool =
  fun projectee -> match projectee with Push -> true | uu____1190 -> false
...
let fv_eq : fv -> fv -> Prims.bool =
  fun x y -> FStar_Pervasives_Native.fst x = FStar_Pervasives_Native.fst y
  ...
  fun t ->
    ...
    | FStar_Pervasives_Native.None ->
        let fvs =
          ...
          FStar_Util.remove_dups fv_eq uu____1484
        in
        FStar_ST.op_Colon_Equals t.freevars (FStar_Pervasives_Native.Some fvs) ;
        fvs
        ...
        let uu____1566 =
          ...
          let uu____1568 =
            let uu____1569 =
              ...
              FStar_All.pipe_right uu____1570 (FStar_String.concat " ")
            in
            Prims.strcat uu____1569 ")"
          in
          Prims.strcat uu____1567 uu____1568
        in
          ...
          let uu____1607 =
            let uu____1608 =
              let uu____1609 =
                ...
                FStar_All.pipe_right uu____1610 (FStar_String.concat " ")
              in
              let uu____1615 =
                let uu____1616 =
                  ...
                  let uu____1618 =
                          ...
                          let uu____1623 =
                            let uu____1624 =
                              FStar_All.pipe_right pats
                                (FStar_List.map (fun pats1 ->
                                     let uu____1640 =
                                       FStar_List.map hash_of_term pats1
                                     in
                    ...
                    in
                    Prims.strcat " " uu____1619
                  in
                  Prims.strcat uu____1617 uu____1618
                in
                Prims.strcat ")(! " uu____1616
              in
              Prims.strcat uu____1609 uu____1615
            in
            Prims.strcat " (" uu____1608
          in
          Prims.strcat (qop_to_string qop) uu____1607
        in
    ...
    | Let (es, body) ->
        let uu____1653 =
          let uu____1654 =
            ...
            FStar_All.pipe_right uu____1655 (FStar_String.concat " ")
          in
          let uu____1660 =
            let uu____1661 =
            ...
            in
            Prims.strcat ") " uu____1661
          in
          Prims.strcat uu____1654 uu____1660
        in
...
let boxBitVecFun
  ...
  fun sz ->
    let uu____1690 =
      ...
      Prims.strcat "BoxBitVec" uu____1691
    in
...
let isInjective : Prims.string -> Prims.bool =
  fun s ->
    if FStar_String.length s >= Prims.parse_int "3" then
      (let uu____1697 =
      ...
      let uu____1699 =
        ...
        FStar_List.existsML (fun c -> c = 46) uu____1700
      in
...
let mkInteger : Prims.string -> FStar_Range.range -> term =
  fun i r ->
    let uu____1778 =
      let uu____1779 = FStar_Util.ensure_decimal i in
      Integer uu____1779
    in
    mk uu____1778 r
...
let mkInteger' : Prims.int -> FStar_Range.range -> term =
  fun i r ->
    let uu____1786 = FStar_Util.string_of_int i in
    mkInteger uu____1786 r


let mkBoundV : Prims.int -> FStar_Range.range -> term =
  fun i r -> mk (BoundV i) r


let mkFreeV
    : (Prims.string, sort) FStar_Pervasives_Native.tuple2 -> FStar_Range.range
      -> term =
  fun x r -> mk (FreeV x) r


let mkApp'
    : (op, term Prims.list) FStar_Pervasives_Native.tuple2 -> FStar_Range.range
      -> term =
  fun f r -> mk (App f) r
...
let mkApp
  ...
  fun uu____1835 r ->
    match uu____1835 with s, args -> mk (App (Var s, args)) r
...
let mkOr
  ...
  fun uu____1953 r ->
    match uu____1953 with t1, t2 ->
      ...
      | App (Or, ts1), uu____2006 -> mkApp' (Or, FStar_List.append ts1 [t2]) r
  ...
  fun uu____2028 r ->
    match uu____2028 with t1, t2 ->
      ...
      | uu____2054, App (Imp, [t1'; t2']) ->
          let uu____2059 =
            let uu____2066 =
              let uu____2069 = mkAnd (t1, t1') r in
              [uu____2069; t2']
            in
            (Imp, uu____2066)
          in
...
let mk_bin_op
    : op -> (term, term) FStar_Pervasives_Native.tuple2 -> FStar_Range.range
      -> term =
  fun op uu____2090 r ->
    match uu____2090 with t1, t2 -> mkApp' (op, [t1; t2]) r


let mkMinus : term -> FStar_Range.range -> term =
  fun t r -> mkApp' (Minus, [t]) r


let mkNatToBv : Prims.int -> term -> FStar_Range.range -> term =
  fun sz t r -> mkApp' (NatToBv sz, [t]) r


let mkBvUext : Prims.int -> term -> FStar_Range.range -> term =
  fun sz t r -> mkApp' (BvUext sz, [t]) r


let mkBvToNat : term -> FStar_Range.range -> term =
  fun t r -> mkApp' (BvToNat, [t]) r
...
let mkBvShl
    : Prims.int -> (term, term) FStar_Pervasives_Native.tuple2
      -> FStar_Range.range -> term =
  fun sz uu____2189 r ->
    match uu____2189 with t1, t2 ->
      let uu____2197 =
        let uu____2204 =
          let uu____2207 =
            let uu____2210 = mkNatToBv sz t2 r in
            [uu____2210]
          in
          t1 :: uu____2207
        in
...
let mkBvShr
    : Prims.int -> (term, term) FStar_Pervasives_Native.tuple2
      -> FStar_Range.range -> term =
  fun sz uu____2224 r ->
    match uu____2224 with t1, t2 ->
      let uu____2232 =
        let uu____2239 =
          let uu____2242 =
            let uu____2245 = mkNatToBv sz t2 r in
            [uu____2245]
          in
          t1 :: uu____2242
        in
...
let mkBvUdiv
    : Prims.int -> (term, term) FStar_Pervasives_Native.tuple2
      -> FStar_Range.range -> term =
  fun sz uu____2259 r ->
    match uu____2259 with t1, t2 ->
      let uu____2267 =
        let uu____2274 =
          let uu____2277 =
            let uu____2280 = mkNatToBv sz t2 r in
            [uu____2280]
          in
          t1 :: uu____2277
        in
...
let mkBvMod
    : Prims.int -> (term, term) FStar_Pervasives_Native.tuple2
      -> FStar_Range.range -> term =
  fun sz uu____2294 r ->
    match uu____2294 with t1, t2 ->
      let uu____2302 =
        let uu____2309 =
          let uu____2312 =
            let uu____2315 = mkNatToBv sz t2 r in
            [uu____2315]
          in
          t1 :: uu____2312
        in
...
let mkBvMul
    : Prims.int -> (term, term) FStar_Pervasives_Native.tuple2
      -> FStar_Range.range -> term =
  fun sz uu____2329 r ->
    match uu____2329 with t1, t2 ->
      let uu____2337 =
        let uu____2344 =
          let uu____2347 =
            let uu____2350 = mkNatToBv sz t2 r in
            [uu____2350]
          in
          t1 :: uu____2347
        in
...
let mkITE
    : (term, term, term) FStar_Pervasives_Native.tuple3 -> FStar_Range.range
      -> term =
  fun uu____2480 r ->
    match uu____2480 with t1, t2, t3 ->
      match t1.tm with
      | App (TrueOp, uu____2491) -> t2
      | App (FalseOp, uu____2496) -> t3
      | uu____2501 ->
        match (t2.tm, t3.tm) with
        | App (TrueOp, uu____2502), App (TrueOp, uu____2503) -> mkTrue r
        | App (TrueOp, uu____2512), uu____2513 ->
            let uu____2518 =
              let uu____2523 = mkNot t1 t1.rng in
              (uu____2523, t3)
            in
            mkImp uu____2518 r
...
let mkQuant
    : ( qop
      ...
      , sort Prims.list
      , term )
      FStar_Pervasives_Native.tuple5 -> FStar_Range.range -> term =
  fun uu____2574 r ->
    match uu____2574 with qop, pats, wopt, vars, body ->
      if FStar_List.length vars = Prims.parse_int "0" then body
      else
        match body.tm with
...
let mkLet
    : (term Prims.list, term) FStar_Pervasives_Native.tuple2
      -> FStar_Range.range -> term =
  fun uu____2640 r ->
    match uu____2640 with es, body ->
      if FStar_List.length es = Prims.parse_int "0" then body
      ...
      | uu____2747 ->
        ...
        | Quant (qop, pats, wopt, vars, body) ->
            ...
            let uu____2828 =
              ...
              (qop, uu____2847, wopt, vars, uu____2868)
            in
        ...
        | Let (es, body) ->
            let uu____2887 =
              FStar_List.fold_left
                (fun uu____2905 e ->
                  match uu____2905 with ix1, l ->
                    let uu____2925 =
                      let uu____2928 = aux ix1 e in
                      uu____2928 :: l
                    in
                    (ix1 + Prims.parse_int "1", uu____2925) )
                (ix, []) es
            in
            match uu____2887 with ix1, es_rev ->
              let uu____2939 =
                let uu____2946 = aux ix1 body in
                (FStar_List.rev es_rev, uu____2946)
              in
...
let inst : term Prims.list -> term -> term =
  fun tms t ->
    ...
    let rec aux shift t1 =
      ...
      | FreeV uu____2971 -> t1
      | BoundV i ->
          if Prims.parse_int "0" <= i - shift && i - shift < n1 then
      ...
      | Labeled (t2, r1, r2) ->
          let uu____3003 =
            let uu____3004 =
              let uu____3011 = aux shift t2 in
              (uu____3011, r1, r2)
            in
            Labeled uu____3004
          in
      ...
      | LblPos (t2, r) ->
          let uu____3014 =
            let uu____3015 =
              let uu____3020 = aux shift t2 in
              (uu____3020, r)
            in
            LblPos uu____3015
          in
      ...
      | Quant (qop, pats, wopt, vars, body) ->
          ...
          let uu____3048 =
            ...
            (qop, uu____3067, wopt, vars, uu____3084)
          in
      ...
      | Let (es, body) ->
          let uu____3099 =
            FStar_List.fold_left
              (fun uu____3117 e ->
                match uu____3117 with ix, es1 ->
                  let uu____3137 =
                    let uu____3140 = aux shift e in
                    uu____3140 :: es1
                  in
                  (shift + Prims.parse_int "1", uu____3137) )
              (shift, []) es
          in
          match uu____3099 with shift1, es_rev ->
            let uu____3151 =
              let uu____3158 = aux shift1 body in
              (FStar_List.rev es_rev, uu____3158)
            in
...
let mkQuant'
    : ( qop
      ...
      FStar_Pervasives_Native.tuple5 -> FStar_Range.range -> term =
  fun uu____3193 ->
    match uu____3193 with qop, pats, wopt, vars, body ->
      let uu____3235 =
        let uu____3254 =
          FStar_All.pipe_right pats
        ...
        (qop, uu____3254, wopt, uu____3271, uu____3278)
      in
      mkQuant uu____3235


let mkForall''
    : ( pat Prims.list Prims.list
      , Prims.int FStar_Pervasives_Native.option
      , sort Prims.list
      , term )
      FStar_Pervasives_Native.tuple4 -> FStar_Range.range -> term =
  fun uu____3307 r ->
    match uu____3307 with pats, wopt, sorts, body ->
...
let mkForall'
    : ( pat Prims.list Prims.list
      ...
      FStar_Pervasives_Native.tuple4 -> FStar_Range.range -> term =
  fun uu____3371 r ->
    match uu____3371 with pats, wopt, vars, body ->
...
let mkForall
    : (pat Prims.list Prims.list, fvs, term) FStar_Pervasives_Native.tuple3
      -> FStar_Range.range -> term =
  fun uu____3426 r ->
    match uu____3426 with pats, vars, body ->
      let uu____3449 =
...
let mkExists
    : (pat Prims.list Prims.list, fvs, term) FStar_Pervasives_Native.tuple3
      -> FStar_Range.range -> term =
  fun uu____3472 r ->
    match uu____3472 with pats, vars, body ->
      let uu____3495 =
...
let mkLet'
    : ( (fv, term) FStar_Pervasives_Native.tuple2 Prims.list
      , term )
      FStar_Pervasives_Native.tuple2 -> FStar_Range.range -> term =
  fun uu____3518 r ->
    match uu____3518 with bindings, body ->
      let uu____3544 = FStar_List.split bindings in
      match uu____3544 with vars, es ->
        let uu____3563 =
          let uu____3570 = abstr vars body in
          (es, uu____3570)
        in
        mkLet uu____3563 r
...
let fresh_token
  ...
  fun uu____3660 id1 ->
    match uu____3660 with tok_name, sort ->
        ...
        let uu____3670 =
          let uu____3671 =
            ...
            let uu____3677 =
              ...
              in
              mkApp uu____3678 norng
            in
            (uu____3676, uu____3677)
          in
          mkEq uu____3671 norng
        in
...
let fresh_constructor
  ...
  fun uu____3706 ->
    match uu____3706 with name, arg_sorts, sort, id1 ->
      let id2 = FStar_Util.string_of_int id1 in
      let bvars =
        FStar_All.pipe_right arg_sorts
          (FStar_List.mapi (fun i s ->
               let uu____3738 =
                 let uu____3743 =
                   let uu____3744 = FStar_Util.string_of_int i in
                   Prims.strcat "x_" uu____3744
                 in
                 (uu____3743, s)
               in
      ...
      let cid_app =
        let uu____3752 =
          let uu____3759 = constr_id_of_sort sort in
          (uu____3759, [capp])
        in
        mkApp uu____3752 norng
      in
          ...
          let uu____3765 =
            let uu____3776 =
              let uu____3777 =
                ...
                (uu____3782, cid_app)
              in
              mkEq uu____3777 norng
            in
            ([[capp]], bvar_names, uu____3776)
          in
          mkForall uu____3765 norng
        in
...
let injective_constructor
  ...
  fun uu____3803 ->
    match uu____3803 with name, fields, sort ->
      let n_bvars = FStar_List.length fields in
      let bvar_name i =
        let uu____3824 = FStar_Util.string_of_int i in
        Prims.strcat "x_" uu____3824
      in
      let bvar_index i = n_bvars - (i + Prims.parse_int "1") in
      let bvar i s =
        let uu____3844 =
          let uu____3849 = bvar_name i in
          (uu____3849, s)
        in
        mkFreeV uu____3844
      in
      let bvars =
        FStar_All.pipe_right fields
          (FStar_List.mapi (fun i uu____3870 ->
               match uu____3870 with uu____3877, s, uu____3879 ->
                 let uu____3880 = bvar i s in
                 uu____3880 norng ))
      in
      let bvar_names = FStar_List.map fv_of_term bvars in
      let capp = mkApp (name, bvars) norng in
      let uu____3889 =
        FStar_All.pipe_right fields
          (FStar_List.mapi (fun i uu____3917 ->
               match uu____3917 with name1, s, projectible ->
                         ...
                         let uu____3952 =
                           let uu____3953 =
                             let uu____3958 =
                               ...
                               uu____3959 norng
                             in
                             (cproj_app, uu____3958)
                           in
                           mkEq uu____3953 norng
                         in
                         ([[capp]], bvar_names, uu____3952)
                       in
                       mkForall uu____3941 norng
                     in
...
let constructor_to_decl : constructor_t -> decls_t =
  fun uu____3981 ->
    match uu____3981 with name, fields, sort, id1, injective ->
      let injective1 = injective || true in
      let field_sorts =
        FStar_All.pipe_right fields
          (FStar_List.map (fun uu____4009 ->
               match uu____4009 with uu____4016, sort1, uu____4018 -> sort1 ))
      in
      let cdecl =
        DeclFun
          (name, field_sorts, sort, FStar_Pervasives_Native.Some "Constructor")
      in
      ...
      let disc =
          ...
          let uu____4036 =
            let uu____4041 =
              let uu____4042 =
                ...
                (uu____4049, [xx])
              in
              mkApp uu____4042 norng
            in
            let uu____4052 =
              let uu____4053 = FStar_Util.string_of_int id1 in
              mkInteger uu____4053 norng
            in
            (uu____4041, uu____4052)
          in
          mkEq uu____4036 norng
        in
        let uu____4054 =
          let uu____4069 =
            FStar_All.pipe_right fields
              (FStar_List.mapi (fun i uu____4119 ->
                   match uu____4119 with proj, s, projectible ->
                     if projectible then
                       ...
                       let fi =
                         let uu____4168 =
                           let uu____4169 = FStar_Util.string_of_int i in
                           Prims.strcat "f_" uu____4169
                         in
                         (uu____4168, s)
                       in
        ...
        in
        match uu____4054 with proj_terms, ex_vars ->
      ...
      in
      let projs =
        if injective1 then injective_constructor (name, fields, sort) else []
      in
      let uu____4305 =
        let uu____4308 =
          ...
          Caption uu____4309
        in
        uu____4308 :: cdecl :: cid :: projs
      in
      let uu____4310 =
        let uu____4313 =
          let uu____4316 =
            let uu____4317 = FStar_Util.format1 "</end constructor %s>" name in
            Caption uu____4317
          in
          [uu____4316]
        in
        FStar_List.append [disc] uu____4313
      in
...
let name_binders_inner
    : Prims.string FStar_Pervasives_Native.option
      -> (Prims.string, sort) FStar_Pervasives_Native.tuple2 Prims.list
      -> Prims.int -> sort Prims.list
      -> ( (Prims.string, sort) FStar_Pervasives_Native.tuple2 Prims.list
         , Prims.string Prims.list
         , Prims.int )
         FStar_Pervasives_Native.tuple3 =
  fun prefix_opt outer_names start sorts ->
    let uu____4364 =
      FStar_All.pipe_right sorts
        (FStar_List.fold_left
           (fun uu____4419 s ->
             match uu____4419 with names1, binders, n1 ->
               let prefix1 =
                 match s with Term_sort -> "@x" | uu____4469 -> "@u"
               in
               let prefix2 =
                 match prefix_opt with
                 | FStar_Pervasives_Native.None -> prefix1
                 | FStar_Pervasives_Native.Some p -> Prims.strcat p prefix1
               in
               let nm =
                 let uu____4473 = FStar_Util.string_of_int n1 in
                 Prims.strcat prefix2 uu____4473
               in
               let names2 = (nm, s) :: names1 in
               let b =
                 let uu____4486 = strSort s in
                 FStar_Util.format2 "(%s %s)" nm uu____4486
               in
               (names2, b :: binders, n1 + Prims.parse_int "1") )
           (outer_names, [], start))
    in
    match uu____4364 with names1, binders, n1 ->
...
let name_macro_binders
  ...
  fun sorts ->
    ...
    in
    match uu____4563 with names1, binders, n1 ->
  ...
  fun print_ranges enclosing_name t ->
    let next_qid =
      ...
      fun depth ->
        ...
        FStar_Util.incr ctr ;
        if n1 = Prims.parse_int "0" then enclosing_name
        else
    ...
    let remove_guard_free pats =
      FStar_All.pipe_right pats
        (FStar_List.map (fun ps ->
             FStar_All.pipe_right ps
               (FStar_List.map (fun tm ->
                    match tm.tm with
                    | App
                        ( Var "Prims.guard_free"
                        , [ { tm= BoundV uu____4760
                            ; freevars= uu____4761
                            ; rng= uu____4762; _ } ] ) ->
                        tm
    ...
    let rec aux' depth n1 names1 t1 =
      ...
      | Quant (qop, pats, wopt, sorts, body) -> (
          ...
          in
          match uu____4866 with names2, binders, n2 ->
            let binders1 =
              ...
              | uu____4915 ->
                  let uu____4920 =
                    FStar_All.pipe_right pats1
                      (FStar_List.map (fun pats2 ->
                           let uu____4936 =
                             let uu____4937 =
                               FStar_List.map
                                 (fun p ->
                                   let uu____4943 = aux1 n2 names2 p in
                                   FStar_Util.format1 "%s" uu____4943 )
                                 pats2
                             in
                             FStar_String.concat " " uu____4937
                           in
                           FStar_Util.format1 "\n:pattern (%s)" uu____4936 ))
                  in
                  FStar_All.pipe_right uu____4920 (FStar_String.concat "\n")
            in
            let uu____4946 =
              let uu____4949 =
                let uu____4952 =
                  ...
                  let uu____4956 =
                    ...
                    [uu____4959; pats_str; qid]
                  in
                  uu____4955 :: uu____4956
                in
                binders1 :: uu____4952
              in
              qop_to_string qop :: uu____4949
            in
  ...
  fun uu___51_5113 ->
    ...
    | FStar_Pervasives_Native.Some c ->
        let uu____5117 =
          ...
          | hd1 :: uu____5132 -> (hd1, "...")
        in
        match uu____5117 with hd1, suffix ->
          FStar_Util.format2 ";;;;;;;;;;;;;;;;%s%s\n" hd1 suffix


let rec declToSmt' : Prims.bool -> Prims.string -> decl -> Prims.string =
  fun print_ranges z3options decl ->
    ...
    | Caption c ->
        ...
        if uu____5163 then
          let uu____5164 =
            FStar_All.pipe_right (FStar_Util.splitlines c) (fun uu___52_5168 ->
    ...
    | DefineFun (f, arg_sorts, retsort, body, c) -> (
        ...
        match uu____5198 with names1, binders ->
          let body1 =
            let uu____5230 =
              FStar_List.map (fun x -> mkFreeV x norng) names1
            in
            inst uu____5230 body
          in
          ...
          FStar_Util.format5 "%s(define-fun %s (%s) %s\n %s)" uu____5243 f
            (FStar_String.concat " " binders)
            uu____5244 uu____5245 )
    | Assume a ->
        let fact_ids_to_string ids =
          FStar_All.pipe_right ids
            (FStar_List.map (fun uu___53_5263 ->
                 match uu___53_5263 with
                 | Name n1 -> Prims.strcat "Name " (FStar_Ident.text_of_lid n1)
                 | Namespace ns ->
        ...
        let fids =
          ...
          if uu____5268 then
            let uu____5269 =
              ...
              FStar_String.concat "; " uu____5270
            in
...
and declToSmt : Prims.string -> decl -> Prims.string =
  fun z3options decl -> declToSmt' true z3options decl


and declToSmt_no_caps : Prims.string -> decl -> Prims.string =
  fun z3options decl -> declToSmt' false z3options decl
...
and mkPrelude : Prims.string -> Prims.string =
  fun z3options ->
    ...
    let constrs =
      [ ( "FString_const"
        , [("FString_const_proj_0", Int_sort, true)]
        , String_sort
        , Prims.parse_int "0"
        , true )
      ; ("Tm_type", [], Term_sort, Prims.parse_int "2", true)
      ; ( "Tm_arrow"
        , [("Tm_arrow_id", Int_sort, true)]
        , Term_sort
        , Prims.parse_int "3"
        , false )
    ...
    let bcons =
      let uu____5609 =
        let uu____5612 =
          FStar_All.pipe_right constrs (FStar_List.collect constructor_to_decl)
        in
        FStar_All.pipe_right uu____5612 (FStar_List.map (declToSmt z3options))
      in
  ...
  fun sz ->
    let uu____5627 =
      let uu____5646 =
        ...
        FStar_Pervasives_Native.fst uu____5647
      in
      let uu____5652 =
        let uu____5661 =
          let uu____5668 =
            let uu____5669 = boxBitVecFun sz in
            FStar_Pervasives_Native.snd uu____5669
          in
          (uu____5668, BitVec_sort sz, true)
        in
        [uu____5661]
      in
      (uu____5646, uu____5652, Term_sort, Prims.parse_int "12" + sz, true)
    in
...
let mk_Range_const : Prims.unit -> term =
  fun uu____5727 ->
    ...
    (let uu____5749 =
       ...
       uu____5750 + Prims.parse_int "1"
     in
     FStar_ST.op_Colon_Equals __range_c uu____5749) ;
    let uu____5789 =
      let uu____5796 =
        let uu____5799 = mkInteger' i norng in
        [uu____5799]
      in
      ("Range_const", uu____5796)
    in
...
let mk_Term_app : term -> term -> FStar_Range.range -> term =
  fun t1 t2 r -> mkApp ("Tm_app", [t1; t2]) r
...
let mk_Term_uvar : Prims.int -> FStar_Range.range -> term =
  fun i r ->
    let uu____5821 =
      let uu____5828 =
        let uu____5831 = mkInteger' i norng in
        [uu____5831]
      in
      ("Tm_uvar", uu____5828)
    in
...
let boxInt : term -> term =
  fun t ->
    maybe_elim_box
      (FStar_Pervasives_Native.fst boxIntFun)
      (FStar_Pervasives_Native.snd boxIntFun)
      t
...
let boxBool : term -> term =
  fun t ->
    maybe_elim_box
      (FStar_Pervasives_Native.fst boxBoolFun)
      (FStar_Pervasives_Native.snd boxBoolFun)
      t
...
let boxString : term -> term =
  fun t ->
    maybe_elim_box
      (FStar_Pervasives_Native.fst boxStringFun)
      (FStar_Pervasives_Native.snd boxStringFun)
      t
...
let boxBitVec : Prims.int -> term -> term =
  fun sz t ->
    let uu____5889 =
      ...
      FStar_Pervasives_Native.fst uu____5890
    in
    let uu____5895 =
      let uu____5896 = boxBitVecFun sz in
      FStar_Pervasives_Native.snd uu____5896
    in
...
let unboxBitVec : Prims.int -> term -> term =
  fun sz t ->
    let uu____5907 =
      ...
      FStar_Pervasives_Native.snd uu____5908
    in
    let uu____5913 =
      let uu____5914 = boxBitVecFun sz in
      FStar_Pervasives_Native.fst uu____5914
    in
      ...
      (fun s l1 ->
        let uu____6024 =
          let uu____6025 =
            ...
            Prims.strcat uu____6026 " ] "
          in
          Prims.strcat "; [ " uu____6025
        in
        Prims.strcat s uu____6024 )
      "" l
...
let mk_Valid : term -> term =
  fun t ->
    ...
    | App
        ( Var "Prims.b2t"
        , [ { tm= App (Var "Prims.op_Equality", [uu____6052; t1; t2])
            ; freevars= uu____6055
            ; rng= uu____6056; _ } ] ) ->
        mkEq (t1, t2) t.rng
    | App
        ( Var "Prims.b2t"
        , [ { tm= App (Var "Prims.op_disEquality", [uu____6069; t1; t2])
            ; freevars= uu____6072
            ; rng= uu____6073; _ } ] ) ->
        let uu____6086 = mkEq (t1, t2) norng in
        mkNot uu____6086 t.rng
    | App
        ( Var "Prims.b2t"
    ...
    | App
        ...
        let uu____6149 =
          ...
          let uu____6155 = unboxInt t2 in
          (uu____6154, uu____6155)
        in
    ...
    | App
        ...
        let uu____6172 =
          ...
          let uu____6178 = unboxInt t2 in
          (uu____6177, uu____6178)
        in
    ...
    | App
        ...
        let uu____6195 =
          ...
          let uu____6201 = unboxBool t2 in
          (uu____6200, uu____6201)
        in
    ...
    | App
        ...
        let uu____6218 =
          ...
          let uu____6224 = unboxBool t2 in
          (uu____6223, uu____6224)
        in
        mkOr uu____6218 t.rng
    | App
        ( Var "Prims.b2t"
        , [ { tm= App (Var "Prims.op_Negation", [t1])
            ; freevars= uu____6226
            ; rng= uu____6227; _ } ] ) ->
        let uu____6240 = unboxBool t1 in
        mkNot uu____6240 t1.rng
    | App
        ( Var "Prims.b2t"
        , [ { tm= App (Var "FStar.BV.bvult", [t0; t1; t2])
            ; freevars= uu____6244
            ; rng= uu____6245; _ } ] )
      when let uu____6258 = getBoxedInteger t0 in
           FStar_Util.is_some uu____6258 ->
        let sz =
          let uu____6262 = getBoxedInteger t0 in
          match uu____6262 with
          | FStar_Pervasives_Native.Some sz -> sz
          | uu____6266 -> failwith "impossible"
        in
        let uu____6269 =
          let uu____6274 = unboxBitVec sz t1 in
          let uu____6275 = unboxBitVec sz t2 in
          (uu____6274, uu____6275)
        in
    ...
    | App
        ...
        , [ uu____6276
          ; { tm= App (Var "FStar.BV.bvult", [t0; t1; t2])
            ...
            ; rng= uu____6281; _ }
          ; uu____6282 ] )
      when let uu____6295 = getBoxedInteger t0 in
           FStar_Util.is_some uu____6295 ->
        let sz =
          let uu____6299 = getBoxedInteger t0 in
          match uu____6299 with
          | FStar_Pervasives_Native.Some sz -> sz
          | uu____6303 -> failwith "impossible"
        in
        let uu____6306 =
          let uu____6311 = unboxBitVec sz t1 in
          let uu____6312 = unboxBitVec sz t2 in
          (uu____6311, uu____6312)
        in
        mkBvUlt uu____6306 t.rng
    | App (Var "Prims.b2t", [t1]) ->
        let uu___54_6316 = unboxBool t1 in
        {tm= uu___54_6316.tm; freevars= uu___54_6316.freevars; rng= t.rng}
    | uu____6317 -> mkApp ("Valid", [t]) t.rng


let mk_HasType : term -> term -> term =
  fun v1 t -> mkApp ("HasType", [v1; t]) t.rng


let mk_HasTypeZ : term -> term -> term =
  fun v1 t -> mkApp ("HasTypeZ", [v1; t]) t.rng
...
let mk_HasTypeFuel : term -> term -> term -> term =
  fun f v1 t ->
    ...
    if uu____6350 then mk_HasType v1 t
...
let mk_NoHoist : term -> term -> term =
  fun dummy b -> mkApp ("NoHoist", [dummy; b]) b.rng
...
let mk_tester : Prims.string -> term -> term =
  fun n1 t -> mkApp (Prims.strcat "is-" n1, [t]) t.rng


let mk_ApplyTF : term -> term -> term =
  fun t t' -> mkApp ("ApplyTF", [t; t']) t.rng


let mk_ApplyTT : term -> term -> FStar_Range.range -> term =
  fun t t' r -> mkApp ("ApplyTT", [t; t']) r
...
let mk_String_const : Prims.int -> FStar_Range.range -> term =
  fun i r ->
    let uu____6423 =
      let uu____6430 =
        let uu____6433 = mkInteger' i norng in
        [uu____6433]
      in
      ("FString_const", uu____6430)
    in
    mkApp uu____6423 r
...
let mk_LexCons : term -> term -> FStar_Range.range -> term =
  fun x1 x2 r -> mkApp ("LexCons", [x1; x2]) r


let rec n_fuel : Prims.int -> term =
  fun n1 ->
    if n1 = Prims.parse_int "0" then mkApp ("ZFuel", []) norng
    else
      let uu____6465 =
        let uu____6472 =
...
let mk_and_opt
    : term FStar_Pervasives_Native.option
      -> term FStar_Pervasives_Native.option -> FStar_Range.range
      -> term FStar_Pervasives_Native.option =
  fun p1 p2 r ->
    match (p1, p2) with
...
let mk_and_opt_l
    : term FStar_Pervasives_Native.option Prims.list -> FStar_Range.range
      -> term FStar_Pervasives_Native.option =
  fun pl r ->
    FStar_List.fold_right
      (fun p out -> mk_and_opt p out r)
      pl FStar_Pervasives_Native.None


let mk_and_l : term Prims.list -> FStar_Range.range -> term =
  fun l r ->
    let uu____6562 = mkTrue r in
    FStar_List.fold_right (fun p1 p2 -> mkAnd (p1, p2) r) l uu____6562


let mk_or_l : term Prims.list -> FStar_Range.range -> term =
  fun l r ->
    let uu____6577 = mkFalse r in
    FStar_List.fold_right (fun p1 p2 -> mkOr (p1, p2) r) l uu____6577


let mk_haseq : term -> term =
  fun t ->
    let uu____6585 = mkApp ("Prims.hasEq", [t]) t.rng in
    mk_Valid uu____6585
