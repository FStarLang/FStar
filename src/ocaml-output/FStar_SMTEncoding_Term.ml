...
let (uu___is_TrueOp : op -> Prims.bool) =
  fun projectee -> match projectee with | TrueOp -> true | uu____190 -> false
...
let (uu___is_Minus : op -> Prims.bool) =
  fun projectee -> match projectee with | Minus -> true | uu____286 -> false
let (uu___is_Mod : op -> Prims.bool) =
  fun projectee -> match projectee with | Mod -> true | uu____292 -> false
let (uu___is_BvAnd : op -> Prims.bool) =
  fun projectee -> match projectee with | BvAnd -> true | uu____298 -> false
let (uu___is_BvXor : op -> Prims.bool) =
  fun projectee -> match projectee with | BvXor -> true | uu____304 -> false
...
let (uu___is_BvAdd : op -> Prims.bool) =
  fun projectee -> match projectee with | BvAdd -> true | uu____316 -> false
let (uu___is_BvSub : op -> Prims.bool) =
  fun projectee -> match projectee with | BvSub -> true | uu____322 -> false
let (uu___is_BvShl : op -> Prims.bool) =
  fun projectee -> match projectee with | BvShl -> true | uu____328 -> false
let (uu___is_BvShr : op -> Prims.bool) =
  fun projectee -> match projectee with | BvShr -> true | uu____334 -> false
let (uu___is_BvUdiv : op -> Prims.bool) =
  fun projectee -> match projectee with | BvUdiv -> true | uu____340 -> false
let (uu___is_BvMod : op -> Prims.bool) =
  fun projectee -> match projectee with | BvMod -> true | uu____346 -> false
let (uu___is_BvMul : op -> Prims.bool) =
  fun projectee -> match projectee with | BvMul -> true | uu____352 -> false
let (uu___is_BvUlt : op -> Prims.bool) =
  fun projectee -> match projectee with | BvUlt -> true | uu____358 -> false
...
let (uu___is_Var : op -> Prims.bool) =
  fun projectee -> match projectee with | Var _0 -> true | uu____405 -> false
...
let (uu___is_Forall : qop -> Prims.bool) =
  fun projectee -> match projectee with | Forall -> true | uu____418 -> false
let (uu___is_Exists : qop -> Prims.bool) =
  fun projectee -> match projectee with | Exists -> true | uu____424 -> false
type term' =
...
let (uu___is_App : term' -> Prims.bool) =
  fun projectee -> match projectee with | App _0 -> true | uu____623 -> false
...
let (uu___is_Let : term' -> Prims.bool) =
  fun projectee -> match projectee with | Let _0 -> true | uu____747 -> false
...
let (uu___is_Push : decl -> Prims.bool) =
  fun projectee -> match projectee with | Push -> true | uu____1376 -> false
...
let rec (freevars :
  ...
  fun t ->
    ...
    | Quant (uu____1595, uu____1596, uu____1597, uu____1598, t1) ->
        freevars t1
...
let (qop_to_string : qop -> Prims.string) =
  fun uu___118_1763 ->
    match uu___118_1763 with | Forall -> "forall" | Exists -> "exists"
...
let (mkInteger : Prims.string -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____2040 =
        let uu____2041 = FStar_Util.ensure_decimal i in Integer uu____2041 in
      mk uu____2040 r
      ...
      | (t1, t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____2352, App (Imp, t1'::t2'::[])) ->
               let uu____2357 =
                 let uu____2364 =
                   let uu____2367 = mkAnd (t1, t1') r in [uu____2367; t2'] in
                 (Imp, uu____2364) in
               mkApp' uu____2357 r
           ...
           | uu____2927 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp, uu____2938), uu____2939) ->
                    let uu____2944 =
                      let uu____2949 = mkNot t1 t1.rng in (uu____2949, t3) in
                    mkImp uu____2944 r
...
let (mkQuant :
  FStar_Range.range ->
    Prims.bool ->
      (qop, term Prims.list Prims.list,
        Prims.int FStar_Pervasives_Native.option, sort Prims.list, term)
        FStar_Pervasives_Native.tuple5 -> term)
  =
  fun r ->
    fun check_pats ->
      fun uu____3208 ->
                   ...
                   FStar_List.fold_left
                     (fun uu____3624 ->
                        fun e ->
                          ...
                          | (ix1, l) ->
                              let uu____3644 =
                                let uu____3647 = aux ix1 e in uu____3647 :: l in
        ...
        | Let (es, body) ->
              ...
              FStar_List.fold_left
                (fun uu____3844 ->
                   fun e ->
                     ...
                     | (ix, es1) ->
                         let uu____3864 =
                           let uu____3867 = aux shift e in uu____3867 :: es1 in
            ...
            (match uu____3826 with
             | (shift1, es_rev) ->
                 ...
                 mkLet uu____3878 t1.rng) in
      aux (Prims.parse_int "0") t
let (subst : term -> fv -> term -> term) =
  fun t ->
    fun fv -> fun s -> let uu____3903 = abstr [fv] t in inst [s] uu____3903
let (mkQuant' :
  FStar_Range.range ->
    (qop, term Prims.list Prims.list,
      Prims.int FStar_Pervasives_Native.option, fv Prims.list, term)
      FStar_Pervasives_Native.tuple5 -> term)
  =
  fun r ->
    fun uu____3931 ->
                 ...
                 (fun i ->
                    fun s ->
                      let uu____4483 =
                        ...
                        (uu____4488, s) in
                      mkFreeV uu____4483 norng)) in
          let bvar_names = FStar_List.map fv_of_term bvars in
          let capp = mkApp (name, bvars) norng in
          let cid_app =
            let uu____4505 =
              let uu____4512 = constr_id_of_sort sort in (uu____4512, [capp]) in
  ...
  fun rng ->
    fun uu____4562 ->
      ...
      | (name, fields, sort) ->
          ...
          let bvar i s =
            let uu____4612 = let uu____4617 = bvar_name i in (uu____4617, s) in
                 ...
                 (fun i ->
                    fun uu____4644 ->
                      ...
                      | (uu____4651, s, uu____4653) ->
                          let uu____4654 = bvar i s in uu____4654 norng)) in
          let bvar_names = FStar_List.map fv_of_term bvars in
          let capp = mkApp (name, bvars) norng in
          let uu____4673 =
            FStar_All.pipe_right fields
            ...
            FStar_All.pipe_right fields
              (FStar_List.map
                 (fun uu____4809 ->
                    ...
                    | (uu____4816, sort1, uu____4818) -> sort1)) in
          let cdecl =
            DeclFun
          ...
          fun depth ->
            ...
            then enclosing_name
              ...
              (let uu____5524 = FStar_Util.string_of_int n1 in
               FStar_Util.format2 "%s.%s" enclosing_name uu____5524) in
                       ...
                       (fun tm ->
                          ...
                          | App
                              (Var "Prims.guard_free",
                               { tm = BoundV uu____5568;
                                 freevars = uu____5569; rng = uu____5570;_}::[])
                              -> tm
                                ...
                                (fun pats2 ->
                                   let uu____5774 =
                                     let uu____5775 =
                                       FStar_List.map
                                         (fun p ->
                                            let uu____5781 = aux1 n2 names2 p in
      ...
      fun decl ->
            ...
            then
              let uu____5998 =
                FStar_All.pipe_right (FStar_Util.splitlines c)
                  (fun uu___122_6002 ->
                     match uu___122_6002 with | [] -> "" | h::t -> h) in
              FStar_Util.format1 "\n; %s" uu____5998
            else ""
        ...
        | Assume a ->
            ...
            let fids =
              ...
              then
                let uu____6107 =
                  let uu____6108 = fact_ids_to_string a.assumption_fact_ids in
...
let (mk_Range_const : unit -> term) =
  fun uu____6204 ->
    ...
    (let uu____6266 =
       let uu____6273 = let uu____6276 = mkInteger' i norng in [uu____6276] in
...
let (mk_Term_uvar : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____6308 =
        let uu____6315 = let uu____6318 = mkInteger' i norng in [uu____6318] in
...
let (mk_Valid : term -> term) =
  fun t ->
    ...
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_Equality", uu____6495::t1::t2::[]);
           freevars = uu____6498; rng = uu____6499;_}::[])
        -> mkEq (t1, t2) t.rng
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_disEquality", uu____6512::t1::t2::[]);
    ...
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_Negation", t1::[]); freevars = uu____6669;
           rng = uu____6670;_}::[])
    ...
    | App
        (Var "Prims.equals",
         uu____6719::{ tm = App (Var "FStar.BV.bvult", t0::t1::t2::[]);
                       freevars = uu____6723; rng = uu____6724;_}::uu____6725::[])
        when
    ...
    | App (Var "Prims.b2t", t1::[]) ->
        let uu___124_6759 = unboxBool t1 in
        {
          tm = (uu___124_6759.tm);
          freevars = (uu___124_6759.freevars);
          rng = (t.rng)
        }
...
let (mk_String_const : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____6929 =
        let uu____6936 = let uu____6939 = mkInteger' i norng in [uu____6939] in
