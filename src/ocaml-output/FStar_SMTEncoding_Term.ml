...
let rec hash_of_term': term' -> Prims.string =
  fun t  ->
    ...
    | FreeV x ->
        let uu____958 =
          let uu____959 = strSort (FStar_Pervasives_Native.snd x) in
          Prims.strcat ":" uu____959 in
        Prims.strcat (FStar_Pervasives_Native.fst x) uu____958
    | App (op,tms) ->
        let uu____964 =
          let uu____965 =
            let uu____966 =
...
let mk: term' -> FStar_Range.range -> term =
  fun t  ->
    fun r  ->
      let uu____1040 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
    ...
    fun t  ->
      ...
      let rec aux' depth n1 names t1 =
        ...
        | BoundV i ->
            ...
            FStar_All.pipe_right uu____2740 FStar_Pervasives_Native.fst
    ...
    fun p2  ->
      fun r  ->
        ...
        | (FStar_Pervasives_Native.Some p11,FStar_Pervasives_Native.Some p21)
            ->
            let uu____3607 = mkAnd (p11, p21) r in
