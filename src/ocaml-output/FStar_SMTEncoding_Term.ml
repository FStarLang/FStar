...
let qop_to_string: qop -> Prims.string =
  fun uu___44_1527  ->
    match uu___44_1527 with | Forall  -> "forall" | Exists  -> "exists"
let op_to_string: op -> Prims.string =
  fun uu___45_1530  ->
    match uu___45_1530 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
            ...
            then
              let uu____5164 =
                FStar_All.pipe_right (FStar_Util.splitlines c)
                  (fun uu___48_5168  ->
                     match uu___48_5168 with | [] -> "" | h::t -> h) in
              FStar_Util.format1 "\n; %s" uu____5164
            else ""
...
let mk_Valid: term -> term =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___50_6316 = unboxBool t1 in
        {
          tm = (uu___50_6316.tm);
          freevars = (uu___50_6316.freevars);
          rng = (t.rng)
        }
