...
let qop_to_string : qop -> Prims.string =
  fun uu___89_965  ->
    match uu___89_965 with | Forall  -> "forall" | Exists  -> "exists"
  
let op_to_string : op -> Prims.string =
  fun uu___90_968  ->
    match uu___90_968 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
  ...
  fun enclosing_name  ->
    fun t  ->
      ...
      let rec aux' depth n1 names1 t1 =
        ...
        | Integer i -> i
        | BoundV i ->
            let uu____2770 = FStar_List.nth names1 i  in
            FStar_All.pipe_right uu____2770 FStar_Pervasives.fst
        | FreeV x -> fst x
        | App (op,[]) -> op_to_string op
        | App (op,tms) ->
            let uu____2780 =
              let uu____2781 = FStar_List.map (aux1 n1 names1) tms  in
              FStar_All.pipe_right uu____2781 (FStar_String.concat "\n")  in
            FStar_Util.format2 "(%s %s)" (op_to_string op) uu____2780
        | Labeled (t2,uu____2785,uu____2786) -> aux1 n1 names1 t2
        | LblPos (t2,s) ->
            let uu____2789 = aux1 n1 names1 t2  in
            FStar_Util.format2 "(! %s :lblpos %s)" uu____2789 s
        | Quant (qop,pats,wopt,sorts,body) ->
            let qid = next_qid ()  in
            let uu____2804 = name_binders_inner None names1 n1 sorts  in
            (match uu____2804 with
             | (names2,binders,n2) ->
                              ...
                              (fun pats2  ->
                                 let uu____2843 =
                                   let uu____2844 =
                                     FStar_List.map
                                       (fun p  ->
                                          let uu____2847 = aux1 n2 names2 p
                                             in
                 ...
                 let uu____2849 =
                   let uu____2851 =
                     let uu____2853 =
                       let uu____2855 = aux1 n2 names2 body  in
                       let uu____2856 =
        ...
        | Let (es,body) ->
                ...
                (fun uu____2878  ->
                   fun e  ->
                     ...
                     | (names0,binders,n0) ->
                         ...
                         let b =
                           let uu____2914 = aux1 n1 names1 e  in
            ...
            (match uu____2863 with
             | (names2,binders,n2) ->
                 let uu____2932 = aux1 n2 names2 body  in
...
let mk_Term_uvar : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____3285 =
        let uu____3289 = let uu____3291 = mkInteger' i norng  in [uu____3291]
           in
...
let mk_Valid : term -> term =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___95_3478 = unboxBool t1  in
        {
          tm = (uu___95_3478.tm);
          freevars = (uu___95_3478.freevars);
          rng = (t.rng)
        }
...
let mk_String_const : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____3574 =
        let uu____3578 = let uu____3580 = mkInteger' i norng  in [uu____3580]
           in
