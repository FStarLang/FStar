...
let (norng :FStar_Range.range)= FStar_Range.dummyRange
let (mkDefineFun
  :(Prims.string,(Prims.string,sort) FStar_Pervasives_Native.tuple2
                   Prims.list,sort,term,caption)
...
>>>>>>> taramana_pointers_with_codes_modifies
  fun i  ->
    fun r  ->
      let uu____5897 =
        let uu____5904 = let uu____5907 = mkInteger' i norng  in [uu____5907]
           in
...
<<<<<<< HEAD
        let uu___95_6416 = unboxBool t1  in
=======
...
>>>>>>> taramana_pointers_with_codes_modifies
  fun i  ->
    fun r  ->
      let uu____6549 =
        let uu____6556 = let uu____6559 = mkInteger' i norng  in [uu____6559]
           in
