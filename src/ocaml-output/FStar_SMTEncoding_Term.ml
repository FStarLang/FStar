...
let freevar_sort : term  ->  sort = (fun uu___106_1378 -> (match (uu___106_1378) with
...
let fv_of_term : term  ->  fv = (fun uu___107_1398 -> (match (uu___107_1398) with
...
let qop_to_string : qop  ->  Prims.string = (fun uu___108_1668 -> (match (uu___108_1668) with
| Forall -> begin
"forall"
end
| Exists -> begin
...
let op_to_string : op  ->  Prims.string = (fun uu___109_1672 -> (match (uu___109_1672) with
| TrueOp -> begin
"true"
end
| FalseOp -> begin
...
let weightToSmt : Prims.int FStar_Pervasives_Native.option  ->  Prims.string = (fun uu___110_1683 -> (match (uu___110_1683) with
| FStar_Pervasives_Native.None -> begin
""
end
...
let caption_to_string : Prims.string FStar_Pervasives_Native.option  ->  Prims.string = (fun uu___111_5384 -> (match (uu___111_5384) with
| FStar_Pervasives_Native.None -> begin
""
end
...
let uu____5422 = (FStar_All.pipe_right (FStar_Util.splitlines c) (fun uu___112_5426 -> (match (uu___112_5426) with
| [] -> begin
""
end
| (h)::t -> begin
...
let fact_ids_to_string = (fun ids -> (FStar_All.pipe_right ids (FStar_List.map (fun uu___113_5521 -> (match (uu___113_5521) with
| Name (n1) -> begin
...
let uu___114_6512 = (unboxBool t1)
in {tm = uu___114_6512.tm; freevars = uu___114_6512.freevars; rng = t.rng})
end
| uu____6513 -> begin
(mkApp (("Valid"), ((t)::[])) t.rng)
end))
