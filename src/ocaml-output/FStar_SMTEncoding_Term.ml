...
let qop_to_string : qop -> Prims.string =
  fun uu___89_927  ->
    match uu___89_927 with | Forall  -> "forall" | Exists  -> "exists"
  
let op_to_string : op -> Prims.string =
  fun uu___90_930  ->
    match uu___90_930 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
...
let mk_Valid : term -> term =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___95_3426 = unboxBool t1  in
        {
          tm = (uu___95_3426.tm);
          freevars = (uu___95_3426.freevars);
          rng = (t.rng)
        }
