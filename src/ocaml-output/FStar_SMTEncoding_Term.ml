  ...
  fun t  ->
    ...
    | LblPos (t,r) ->
        let _0_186 =
          ...
          Prims.strcat _0_185 (Prims.strcat " :lblpos " (Prims.strcat r ")"))
           in
        Prims.strcat "(! " _0_186
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____1069,App (Imp ,t1'::t2'::[])) ->
               let _0_208 =
                 let _0_207 =
                   let _0_206 = mkAnd (t1, t1') r  in [_0_206; t2']  in
                 (Imp, _0_207)  in
               mkApp' _0_208 r
      ...
      let rec aux ix t =
        ...
        | uu____1305 ->
            (match t.tm with
             ...
             | App (op,tms) ->
                 let _0_212 =
                   let _0_211 = FStar_List.map (aux ix) tms  in (op, _0_211)
                    in
                 mkApp' _0_212 t.rng
             | Labeled (t,r1,r2) ->
                 let _0_214 =
                 ...
                 mk _0_214 t.rng
             | LblPos (t,r) ->
                 let _0_216 = LblPos (let _0_215 = aux ix t  in (_0_215, r))
                    in
                 mk _0_216 t.rng
  ...
  fun tms  ->
    fun t  ->
      ...
      let rec aux shift t =
        ...
        | App (op,tms) ->
            let _0_221 =
              let _0_220 = FStar_List.map (aux shift) tms  in (op, _0_220)
               in
            mkApp' _0_221 t.rng
        | Labeled (t,r1,r2) ->
            let _0_223 =
            ...
            mk _0_223 t.rng
        | LblPos (t,r) ->
            let _0_225 = LblPos (let _0_224 = aux shift t  in (_0_224, r))
               in
            mk _0_225 t.rng
        | Quant (qop,pats,wopt,vars,body) ->
            ...
            mkQuant _0_228 t.rng
         in
      aux (Prims.parse_int "0") t
  
let subst : term -> fv -> term -> term =
  fun t  ->
    fun fv  -> fun s  -> let _0_229 = abstr [fv] t  in inst [s] _0_229
    ...
    | (name,fields,sort,id,injective) ->
        ...
        let disc =
                      ...
                      fun uu____1861  ->
                        ...
                        | (proj,s,projectible) ->
                            ...
                            then
                              ...
                              (let fi =
                                 let _0_272 =
                                   let _0_271 = FStar_Util.string_of_int i
                                      in
          ...
          | (proj_terms,ex_vars) ->
              ...
              let disc_inv_body =
                let _0_276 =
                  let _0_275 = mkApp (name, proj_terms) norng  in
                  (xx, _0_275)  in
                                 ...
                                 let _0_289 =
                                   FStar_List.map
                                     (fun p  ->
                                        ...
                                        FStar_Util.format1 "%s" _0_288) pats
                                    in
      ...
      let _0_310 =
        let _0_309 =
          FStar_All.pipe_right constrs
           ...
           in
        FStar_All.pipe_right _0_309 (FStar_List.map (declToSmt z3options))
         in
