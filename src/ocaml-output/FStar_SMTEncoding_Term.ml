          ...
          let uu____2195 =
            let uu____2196 =
              ...
              let uu____2207 =
                FStar_List.collect
                  (fun uu___121_2214  ->
                     match uu___121_2214 with
                     | Assume a -> [a.assumption_name]
                     | uu____2221 -> []) decls
                 in
              FStar_List.append uu____2200 uu____2207  in
            {
...
let (qop_to_string : qop -> Prims.string) =
  fun uu___125_2648  ->
    match uu___125_2648 with | Forall  -> "forall" | Exists  -> "exists"
  
let (op_to_string : op -> Prims.string) =
  fun uu___126_2658  ->
    match uu___126_2658 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
...
let (mk_Valid : term -> term) =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___130_9152 = unboxBool t1  in
        {
          tm = (uu___130_9152.tm);
          freevars = (uu___130_9152.freevars);
          rng = (t.rng)
        }
