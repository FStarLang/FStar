...
let freevar_sort : term  ->  sort = (fun uu___89_736 -> (match (uu___89_736) with
...
let fv_of_term : term  ->  fv = (fun uu___90_749 -> (match (uu___90_749) with
...
let qop_to_string : qop  ->  Prims.string = (fun uu___91_842 -> (match (uu___91_842) with
| Forall -> begin
"forall"
end
| Exists -> begin
...
let op_to_string : op  ->  Prims.string = (fun uu___92_845 -> (match (uu___92_845) with
| TrueOp -> begin
"true"
end
| FalseOp -> begin
...
let weightToSmt : Prims.int Prims.option  ->  Prims.string = (fun uu___93_850 -> (match (uu___93_850) with
| None -> begin
""
end
| Some (i) -> begin
...
let caption_to_string : Prims.string Prims.option  ->  Prims.string = (fun uu___94_2830 -> (match (uu___94_2830) with
| None -> begin
""
end
| Some (c) -> begin
...
let uu____2859 = (FStar_All.pipe_right (FStar_Util.splitlines c) (fun uu___95_2861 -> (match (uu___95_2861) with
| [] -> begin
""
end
| (h)::t -> begin
...
let uu___96_3336 = (unboxBool t1)
in {tm = uu___96_3336.tm; freevars = uu___96_3336.freevars; rng = t.rng})
end
| uu____3339 -> begin
(mkApp (("Valid"), ((t)::[])) t.rng)
end))
