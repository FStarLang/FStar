...
let (decls_list_of : decls_t -> decl Prims.list) =
  fun l ->
    FStar_All.op_Bar_Greater l (FStar_List.collect (fun elt -> elt.decls))
    ...
    | Let (es, body) ->
        let uu___ =
          let uu___1 =
            ...
            FStar_All.op_Bar_Greater uu___2 (FStar_String.concat " ") in
          let uu___2 =
            let uu___3 =
      ...
      | (t1, t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (App (And, ts1), App (And, ts2)) ->
               let uu___1 =
                 let uu___2 = FStar_List.op_At ts1 ts2 in (And, uu___2) in
               mkApp' uu___1 r
           | (uu___1, App (And, ts2)) -> mkApp' (And, (t1 :: ts2)) r
           | (App (And, ts1), uu___1) ->
               let uu___2 =
                 let uu___3 = FStar_List.op_At ts1 [t2] in (And, uu___3) in
               mkApp' uu___2 r
      ...
      | (t1, t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (App (Or, ts1), App (Or, ts2)) ->
               let uu___1 =
                 let uu___2 = FStar_List.op_At ts1 ts2 in (Or, uu___2) in
               mkApp' uu___1 r
           | (uu___1, App (Or, ts2)) -> mkApp' (Or, (t1 :: ts2)) r
           | (App (Or, ts1), uu___1) ->
               let uu___2 =
                 let uu___3 = FStar_List.op_At ts1 [t2] in (Or, uu___3) in
               mkApp' uu___2 r
  ...
  fun rng ->
    fun uu___ ->
      ...
      | (name, arg_sorts, sort1, id) ->
          ...
          let bvars =
            FStar_All.op_Bar_Greater arg_sorts
              (FStar_List.mapi
                 (fun i ->
                    fun s ->
                      let uu___1 =
      ...
      | (name, fields, sort1) ->
          ...
          let bvar i s =
            let uu___1 =
              ...
              mk_fv uu___2 in
            FStar_All.op_Less_Bar mkFreeV uu___1 in
          let bvars =
            FStar_All.op_Bar_Greater fields
              (FStar_List.mapi
                 (fun i ->
                    fun uu___1 ->
                      match uu___1 with
          ...
          FStar_All.op_Bar_Greater uu___1 FStar_List.flatten
                          ...
                          | (proj, s, projectible) ->
                              ...
                              then
                                ...
                                (let fi =
                                 ...
                                 (uu___5, [fi])))) in
              FStar_All.op_Bar_Greater uu___2 FStar_List.split in
            match uu___1 with
            | (proj_terms, ex_vars) ->
          ...
          let uu___2 =
            let uu___3 =
              let uu___4 =
                ...
                Caption uu___5 in
              [uu___4] in
            FStar_List.op_At [disc] uu___3 in
          FStar_List.op_At uu___1 uu___2
  ...
  fun prefix_opt ->
    fun outer_names ->
      fun start ->
        fun sorts ->
          let uu___ =
            FStar_All.op_Bar_Greater sorts
              (FStar_List.fold_left
                 (fun uu___1 ->
                    fun s ->
                      match uu___1 with
        ...
        let rec aux' depth n names t1 =
          ...
          | App (op1, tms) ->
              ...
              let uu___1 =
                ...
                FStar_All.op_Bar_Greater uu___2 (FStar_String.concat "\n") in
              FStar_Util.format2 "(%s %s)" uu___ uu___1
          ...
          | Quant (qop1, pats, wopt, sorts, body) ->
              ...
              (match uu___ with
               | (names1, binders1, n1) ->
                   let binders2 =
                     FStar_All.op_Bar_Greater binders1
                       (FStar_String.concat " ") in
                   ...
                   let pats_str =
                     ...
                     | uu___1 ->
                         let uu___2 =
                           FStar_All.op_Bar_Greater pats1
                             (FStar_List.map
                                (fun pats2 ->
                                   let uu___3 =
                                     let uu___4 =
  ...
  fun print_captions ->
    fun uu___ ->
      ...
      | FStar_Pervasives_Native.Some c when print_captions ->
          let c1 =
            let uu___1 =
              FStar_All.op_Bar_Greater (FStar_String.split [10] c)
      ...
      fun decl1 ->
        ...
        | Caption c ->
            ...
            then
              let uu___ =
                let uu___1 =
                  FStar_All.op_Bar_Greater (FStar_Util.splitlines c)
                    (FStar_List.map
...
and (mkPrelude : Prims.string -> Prims.string) =
  fun z3options ->
    ...
    let bcons =
      let uu___ =
        let uu___1 =
          FStar_All.op_Bar_Greater constrs
...
let (mkBvConstructor : Prims.int -> decl Prims.list) =
  fun sz ->
    ...
    FStar_All.op_Bar_Greater uu___ (constructor_to_decl norng)
...
let (kick_partial_app : term -> term) =
  fun t ->
    ...
    FStar_All.op_Bar_Greater uu___ mk_Valid
