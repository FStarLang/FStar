...
let qop_to_string: qop -> Prims.string =
  fun uu___85_811  ->
    match uu___85_811 with | Forall  -> "forall" | Exists  -> "exists"
let op_to_string: op -> Prims.string =
  fun uu___86_814  ->
    match uu___86_814 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
...
let rec hash_of_term': term' -> Prims.string =
  fun t  ->
    ...
    | FreeV x ->
        let uu____834 =
          let uu____835 = strSort (Prims.snd x) in Prims.strcat ":" uu____835 in
    ...
    | Labeled (t,r1,r2) ->
        let uu____849 = hash_of_term t in
        let uu____850 =
    ...
    | LblPos (t,r) ->
        let uu____854 =
          let uu____855 = hash_of_term t in
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____1117,App (Imp ,t1'::t2'::[])) ->
               let uu____1121 =
                 let uu____1125 =
                   let uu____1127 = mkAnd (t1, t1') r in [uu____1127; t2'] in
                 (Imp, uu____1125) in
               mkApp' uu____1121 r
...
let abstr: fv Prims.list -> term -> term =
  fun fvs  ->
    fun t  ->
      ...
      let rec aux ix t =
        let uu____1348 = FStar_ST.read t.freevars in
            ...
            (match t.tm with
             ...
             | App (op,tms) ->
                 let uu____1381 =
                   ...
                   (op, uu____1385) in
                 mkApp' uu____1381 t.rng
             | Labeled (t,r1,r2) ->
                 let uu____1391 =
                   let uu____1392 =
                     let uu____1396 = aux ix t in (uu____1396, r1, r2) in
                   Labeled uu____1392 in
                 mk uu____1391 t.rng
             | LblPos (t,r) ->
                 let uu____1399 =
                   let uu____1400 =
                     let uu____1403 = aux ix t in (uu____1403, r) in
             ...
             | Quant (qop,pats,wopt,vars,body) ->
                 ...
                 let uu____1419 =
                   ...
                   let uu____1440 = aux (ix + n) body in
                   (qop, uu____1429, wopt, vars, uu____1440) in
                 mkQuant uu____1419 t.rng) in
  ...
  fun tms  ->
    fun t  ->
      ...
      let rec aux shift t =
        ...
        | App (op,tms) ->
            let uu____1476 =
              let uu____1480 = FStar_List.map (aux shift) tms in
              (op, uu____1480) in
            mkApp' uu____1476 t.rng
        | Labeled (t,r1,r2) ->
            let uu____1486 =
              let uu____1487 =
                let uu____1491 = aux shift t in (uu____1491, r1, r2) in
              Labeled uu____1487 in
            mk uu____1486 t.rng
        | LblPos (t,r) ->
            let uu____1494 =
              let uu____1495 =
                let uu____1498 = aux shift t in (uu____1498, r) in
        ...
        | Quant (qop,pats,wopt,vars,body) ->
            ...
            let uu____1517 =
              ...
              let uu____1536 = aux shift body in
              (qop, uu____1527, wopt, vars, uu____1536) in
            mkQuant uu____1517 t.rng in
      aux (Prims.parse_int "0") t
let subst: term -> fv -> term -> term =
  fun t  ->
    fun fv  -> fun s  -> let uu____1550 = abstr [fv] t in inst [s] uu____1550
let mkQuant':
               ...
               (fun i  ->
                  fun s  ->
                    let uu____1858 =
                      ...
                      (uu____1861, s) in
                    mkFreeV uu____1858 norng)) in
        let bvar_names = FStar_List.map fv_of_term bvars in
        let capp = mkApp (name, bvars) norng in
        let cid_app =
          let uu____1868 =
            let uu____1872 = constr_id_of_sort sort in (uu____1872, [capp]) in
        ...
        let uu____1875 =
          let uu____1880 =
            let uu____1881 =
              let uu____1887 =
                let uu____1888 =
                  let uu____1891 = mkInteger id norng in
...
let injective_constructor:
  ...
  fun uu____1905  ->
    ...
    | (name,fields,sort) ->
        ...
        let bvar i s =
          let uu____1938 = let uu____1941 = bvar_name i in (uu____1941, s) in
               ...
               (fun i  ->
                  fun uu____1950  ->
                    ...
                    | (uu____1954,s,uu____1956) ->
                        let uu____1957 = bvar i s in uu____1957 norng)) in
        let bvar_names = FStar_List.map fv_of_term bvars in
        let capp = mkApp (name, bvars) norng in
        let uu____1964 =
          FStar_All.pipe_right fields
...
let constructor_to_decl: constructor_t -> decl Prims.list =
  fun uu____2026  ->
    ...
    | (name,fields,sort,id,injective) ->
          ...
          FStar_All.pipe_right fields
            (FStar_List.map
               (fun uu____2042  ->
                  ...
                  | (uu____2046,sort,uu____2048) -> sort)) in
        ...
        let disc =
          ...
          | (proj_terms,ex_vars) ->
              ...
              let disc_inv_body =
                match ex_vars with
                | [] -> disc_inv_body
                | uu____2185 -> mkExists ([], ex_vars, disc_inv_body) norng in
        ...
        let uu____2208 =
          let uu____2210 =
            let uu____2211 = FStar_Util.format1 "<start constructor %s>" name in
                 ...
                 (fun uu____2270  ->
                    fun s  ->
                      ...
                      | (names,binders,n) ->
                          ...
                          let nm =
                            let uu____2302 = FStar_Util.string_of_int n in
                            Prims.strcat prefix uu____2302 in
...
let termToSmt: term -> Prims.string =
  fun t  ->
    ...
    let rec aux' n names t =
      ...
      | App (op,tms) ->
          let uu____2452 =
            let uu____2453 = FStar_List.map (aux n names) tms in
            FStar_All.pipe_right uu____2453 (FStar_String.concat "\n") in
          FStar_Util.format2 "(%s %s)" (op_to_string op) uu____2452
      | Labeled (t,uu____2457,uu____2458) -> aux n names t
      | LblPos (t,s) ->
          let uu____2461 = aux n names t in
          FStar_Util.format2 "(! %s :lblpos %s)" uu____2461 s
      | Quant (qop,pats,wopt,sorts,body) ->
          let uu____2475 = name_binders_inner None names n sorts in
          (match uu____2475 with
           | (names,binders,n) ->
                            ...
                            (fun pats  ->
                               let uu____2514 =
                                 let uu____2515 =
                                   FStar_List.map
                                     (fun p  ->
                                        let uu____2518 = aux n names p in
               ...
               (match (pats, wopt) with
                | ([]::[],None )|([],None ) ->
                    let uu____2532 = aux n names body in
                    FStar_Util.format3 "(%s (%s)\n %s);;no pats\n"
                      (qop_to_string qop) binders uu____2532
                | uu____2533 ->
                    let uu____2539 = aux n names body in
                    let uu____2540 = weightToSmt wopt in
                    FStar_Util.format5 "(%s (%s)\n (! %s\n %s %s))"
                      (qop_to_string qop) binders uu____2539 uu____2540
                      pats_str))
    and aux n names t =
      let s = aux' n names t in
      match t.rng <> norng with
      | true  ->
          let uu____2546 = FStar_Range.string_of_range t.rng in
          let uu____2547 = FStar_Range.string_of_use_range t.rng in
          FStar_Util.format3 "\n;; def=%s; use=%s\n%s\n" uu____2546
            uu____2547 s
      | uu____2548 -> s in
    aux (Prims.parse_int "0") [] t
      ...
      | Caption c ->
          let uu____2581 =
            FStar_All.pipe_right (FStar_Util.splitlines c)
              (fun uu___89_2583  ->
                 match uu___89_2583 with | [] -> "" | h::t -> h) in
          FStar_Util.format1 "\n; %s" uu____2581
      ...
      | DefineFun (f,arg_sorts,retsort,body,c) ->
          ...
          (match uu____2605 with
           | (names,binders) ->
               ...
               let uu____2632 = termToSmt body in
...
let mk_Term_uvar: Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____2876 =
        let uu____2880 = let uu____2882 = mkInteger' i norng in [uu____2882] in
...
let mk_Valid: term -> term =
  fun t  ->
    ...
    | App
        ...
        -> let uu____3060 = unboxBool t in mkNot uu____3060 t.rng
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___90_3063 = unboxBool t1 in
        {
          tm = (uu___90_3063.tm);
          freevars = (uu___90_3063.freevars);
          rng = (t.rng)
        }
  ...
  fun f  ->
    fun v  ->
      fun t  ->
        ...
        | true  -> mk_HasType v t
        | uu____3096 -> mkApp ("HasTypeFuel", [f; v; t]) t.rng
...
let mk_String_const: Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____3152 =
        let uu____3156 = let uu____3158 = mkInteger' i norng in [uu____3158] in
...
let rec n_fuel: Prims.int -> term =
  fun n  ->
    ...
    | uu____3185 ->
        let uu____3186 =
          let uu____3190 =
            let uu____3192 = n_fuel (n - (Prims.parse_int "1")) in
            [uu____3192] in
          ("SFuel", uu____3190) in
  ...
  fun p1  ->
    fun p2  ->
      fun r  ->
        match (p1, p2) with
        | (Some p1,Some p2) ->
            let uu____3215 = mkAnd (p1, p2) r in Some uu____3215
...
let rec print_smt_term: term -> Prims.string =
  fun t  ->
    ...
    | BoundV n ->
        let uu____3279 = FStar_Util.string_of_int n in
    ...
    | Labeled (t,r1,r2) ->
        let uu____3291 = print_smt_term t in
        FStar_Util.format2 "(Labeled '%s' %s)" r1 uu____3291
    | LblPos (t,s) ->
        let uu____3294 = print_smt_term t in
        FStar_Util.format2 "(LblPos %s %s)" s uu____3294
    | Quant (qop,l,uu____3297,uu____3298,t) ->
        let uu____3308 = print_smt_term_list_list l in
        let uu____3309 = print_smt_term t in
    ...
    FStar_List.fold_left
      (fun s  ->
         fun l  ->
           let uu____3322 =
             let uu____3323 =
               let uu____3324 = print_smt_term_list l in
