...
let (fv_force : fv -> Prims.bool) =
  fun x  ->
    let uu____2391 = x  in
    match uu____2391 with | (uu____2393,uu____2394,force1) -> force1
...
let rec (hash_of_term' : term' -> Prims.string) =
  fun t  ->
    ...
    | FreeV x ->
        ...
        let uu____3049 =
          let uu____3051 = let uu____3053 = fv_sort x  in strSort uu____3053
             in
...
let (mkInteger : Prims.string -> FStar_Range.range -> term) =
  fun i  ->
    fun r  ->
      let uu____3418 =
        let uu____3419 = FStar_Util.ensure_decimal i  in Integer uu____3419
         in
      mk uu____3418 r
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____3754,App (Imp ,t1'::t2'::[])) ->
               let uu____3759 =
                 let uu____3766 =
                   let uu____3769 = mkAnd (t1, t1') r  in [uu____3769; t2']
                    in
                 (Imp, uu____3766)  in
               mkApp' uu____3759 r
           ...
           | uu____4402 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp ,uu____4413),uu____4414) ->
                    let uu____4419 =
                      let uu____4424 = mkNot t1 t1.rng  in (uu____4424, t3)
                       in
                    mkImp uu____4419 r
                   ...
                   FStar_List.fold_left
                     (fun uu____5452  ->
                        fun e  ->
                          ...
                          | (ix1,l) ->
                              let uu____5476 =
                                let uu____5479 = aux ix1 e  in uu____5479 ::
                                  l
                                 in
...
let (subst : term -> fv -> term -> term) =
  fun t  ->
    fun fv  ->
      fun s  -> let uu____5826 = abstr [fv] t  in inst [s] uu____5826
                    ...
                    fun s  ->
                      let uu____6478 =
                        let uu____6479 =
                          ...
                          (uu____6485, s)  in
                        mk_fv uu____6479  in
                      mkFreeV uu____6478 norng))
             in
          let bvar_names = FStar_List.map fv_of_term bvars  in
          let capp = mkApp (name, bvars) norng  in
          let cid_app =
            let uu____6515 =
              let uu____6523 = constr_id_of_sort sort  in
              (uu____6523, [capp])  in
                 ...
                 (fun i  ->
                    fun uu____6689  ->
                      ...
                      | (uu____6699,s,uu____6701) ->
                          let uu____6706 = bvar i s  in uu____6706 norng))
             in
          let bvar_names = FStar_List.map fv_of_term bvars  in
          let capp = mkApp (name, bvars) norng  in
          let uu____6734 =
            ...
            FStar_All.pipe_right fields
              (FStar_List.map
                 (fun uu____6910  ->
                    ...
                    | (uu____6919,sort1,uu____6921) -> sort1))
             in
          let cdecl =
            DeclFun
          ...
          fun depth  ->
            ...
            then enclosing_name
              ...
              (let uu____7612 = FStar_Util.string_of_int n1  in
               FStar_Util.format2 "%s.%s" enclosing_name uu____7612)
           in
                  ...
                  FStar_All.pipe_right ps
                    (FStar_List.map
                       (fun tm  ->
                          ...
                          | App
                              (Var
                               "Prims.guard_free",{ tm = BoundV uu____7658;
                                                    freevars = uu____7659;
                                                    rng = uu____7660;_}::[])
                              -> tm
  ...
  fun sz  ->
    let uu____8740 =
      ...
      let uu____8752 =
        ...
        [uu____8755]  in
      (uu____8741, uu____8752, Term_sort, ((Prims.of_int (12)) + sz), true)
       in
...
let (mk_Range_const : unit -> term) =
  fun uu____8790  ->
    ...
    (let uu____8862 =
       let uu____8870 = let uu____8873 = mkInteger' i norng  in [uu____8873]
          in
...
let (mk_Term_uvar : Prims.int -> FStar_Range.range -> term) =
  fun i  ->
    fun r  ->
      let uu____8916 =
        let uu____8924 = let uu____8927 = mkInteger' i norng  in [uu____8927]
           in
  ...
  fun t  ->
    ...
    | App
        (Var
         "Prims.b2t",{
                       tm = App
                         (Var "Prims.op_Equality",uu____9226::t1::t2::[]);
    ...
    | App
        (Var
         "Prims.b2t",{
                       tm = App
                         (Var "Prims.op_disEquality",uu____9249::t1::t2::[]);
    ...
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_Negation",t1::[]);
                       freevars = uu____9448; rng = uu____9449;_}::[])
    ...
    | App
        (Var
         "Prims.equals",uu____9520::{
                                      tm = App
                                        (Var "FStar.BV.bvult",t0::t1::t2::[]);
                                      freevars = uu____9524;
                                      rng = uu____9525;_}::uu____9526::[])
        when
...
let (mk_String_const : Prims.int -> FStar_Range.range -> term) =
  fun i  ->
    fun r  ->
      let uu____9801 =
        let uu____9809 = let uu____9812 = mkInteger' i norng  in [uu____9812]
           in
