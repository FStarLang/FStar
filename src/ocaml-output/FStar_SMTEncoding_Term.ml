                   ...
                   FStar_List.fold_left
                     (fun uu____1533  ->
                        fun e  ->
                          ...
                          | (ix,l) ->
                              let uu____1545 =
                                let uu____1547 = aux ix e  in uu____1547 :: l
                                 in
              ...
              FStar_List.fold_left
                (fun uu____1665  ->
                   fun e  ->
                     ...
                     | (ix,es) ->
                         let uu____1677 =
                           let uu____1679 = aux shift e  in uu____1679 :: es
                            in
          ...
          FStar_All.pipe_right fields
            (FStar_List.map
               (fun uu____2234  ->
                  ...
                  | (uu____2238,sort,uu____2240) -> sort))
           in
        ...
        let disc =
          ...
          | (proj_terms,ex_vars) ->
              ...
              let disc_inv_body =
                match ex_vars with
                | [] -> disc_inv_body
                | uu____2377 -> mkExists ([], ex_vars, disc_inv_body) norng
                 in
