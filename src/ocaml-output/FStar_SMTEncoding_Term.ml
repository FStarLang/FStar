...
let rec (hash_of_term' : term' -> Prims.string) =
  fun t ->
    ...
    | FreeV x ->
        ...
        let uu____2958 =
          let uu____2960 = let uu____2962 = fv_sort x in strSort uu____2962 in
...
let (mkInteger : Prims.string -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____3539 =
        let uu____3540 = FStar_Util.ensure_decimal i in Integer uu____3540 in
      mk uu____3539 r
      ...
      | (t1, t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____3875, App (Imp, t1'::t2'::[])) ->
               let uu____3880 =
                 let uu____3887 =
                   let uu____3890 = mkAnd (t1, t1') r in [uu____3890; t2'] in
                 (Imp, uu____3887) in
               mkApp' uu____3880 r
           ...
           | uu____4523 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp, uu____4534), uu____4535) ->
                    let uu____4540 =
                      let uu____4545 = mkNot t1 t1.rng in (uu____4545, t3) in
                    mkImp uu____4540 r
    ...
    fun check_pats ->
      fun uu____5134 ->
        ...
        | (qop, pats, wopt, vars, body) ->
            let uu____5178 =
              let uu____5203 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
                   ...
                   FStar_List.fold_left
                     (fun uu____5573 ->
                        fun e ->
                          ...
                          | (ix1, l) ->
                              let uu____5597 =
                                let uu____5600 = aux ix1 e in uu____5600 :: l in
          ...
          | Let (es, body) ->
              ...
              (match uu____5841 with
               | (shift1, es_rev) ->
                   ...
                   mkLet uu____5904 t1.rng) in
        aux (Prims.parse_int "0") t
let (inst : term Prims.list -> term -> term) =
  fun tms -> fun t -> instQid false tms t
let (subst : term -> fv -> term -> term) =
  fun t ->
    fun fv -> fun s -> let uu____5947 = abstr [fv] t in inst [s] uu____5947
let (mkQuant' :
  FStar_Range.range ->
    (qop * term Prims.list Prims.list * Prims.int
                    ...
                    fun s ->
                      let uu____6599 =
                        let uu____6600 =
                          ...
                          (uu____6606, s) in
                        mk_fv uu____6600 in
                      mkFreeV uu____6599 norng)) in
          let bvar_names = FStar_List.map fv_of_term bvars in
          let capp = mkApp (name, bvars) norng in
          let cid_app =
            let uu____6636 =
              let uu____6644 = constr_id_of_sort sort in (uu____6644, [capp]) in
                 ...
                 (fun i ->
                    fun uu____6810 ->
                      ...
                      | (uu____6820, s, uu____6822) ->
                          let uu____6827 = bvar i s in uu____6827 norng)) in
          let bvar_names = FStar_List.map fv_of_term bvars in
          let capp = mkApp (name, bvars) norng in
          let uu____6855 =
            FStar_All.pipe_right fields
            ...
            FStar_All.pipe_right fields
              (FStar_List.map
                 (fun uu____7031 ->
                    ...
                    | (uu____7040, sort1, uu____7042) -> sort1)) in
          let cdecl =
            DeclFun
                       ...
                       (fun tm ->
                          ...
                          | App
                              (Var "Prims.guard_free",
                               { tm = BoundV uu____7733;
                                 freevars = uu____7734; rng = uu____7735;_}::[])
                              -> tm
                                ...
                                (fun pats2 ->
                                   let uu____8040 =
                                     let uu____8042 =
                                       FStar_List.map
                                         (fun p ->
                                            let uu____8050 = aux1 n2 names2 p in
        ...
        (match decl with
         ...
         | Assume a ->
             ...
             let fids =
               ...
               then
                 let uu____8571 =
                   let uu____8573 = fact_ids_to_string a.assumption_fact_ids in
             ...
             let uu____8586 = termToSmt print_captions n1 a.assumption_term in
...
let (mk_Range_const : unit -> term) =
  fun uu____8879 ->
    ...
    (let uu____8951 =
       let uu____8959 = let uu____8962 = mkInteger' i norng in [uu____8962] in
...
let (mk_Term_uvar : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____9005 =
        let uu____9013 = let uu____9016 = mkInteger' i norng in [uu____9016] in
...
let (mk_Valid : term -> term) =
  fun t ->
    ...
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_Equality", uu____9315::t1::t2::[]);
           freevars = uu____9318; rng = uu____9319;_}::[])
        -> mkEq (t1, t2) t.rng
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_disEquality", uu____9338::t1::t2::[]);
    ...
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_Negation", t1::[]); freevars = uu____9537;
           rng = uu____9538;_}::[])
    ...
    | App
        (Var "Prims.equals",
         uu____9609::{ tm = App (Var "FStar.BV.bvult", t0::t1::t2::[]);
                       freevars = uu____9613; rng = uu____9614;_}::uu____9615::[])
        when
...
let (mk_String_const : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____9880 =
        let uu____9888 = let uu____9891 = mkInteger' i norng in [uu____9891] in
