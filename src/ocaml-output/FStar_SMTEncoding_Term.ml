  ...
  fun tms  ->
    fun t  ->
      ...
      let rec aux shift t =
        ...
        | App (op,tms) ->
            let _0_228 =
              let _0_227 = FStar_List.map (aux shift) tms  in (op, _0_227)
               in
            mkApp' _0_228 t.rng
        | Labeled (t,r1,r2) ->
            let _0_230 =
            ...
            mk _0_230 t.rng
        | LblPos (t,r) ->
            let _0_232 = LblPos (let _0_231 = aux shift t  in (_0_231, r))
               in
            mk _0_232 t.rng
        | Quant (qop,pats,wopt,vars,body) ->
            ...
            mkQuant _0_235 t.rng
         in
      aux (Prims.parse_int "0") t
  
let subst : term -> fv -> term -> term =
  fun t  ->
    fun fv  -> fun s  -> let _0_236 = abstr [fv] t  in inst [s] _0_236
               ...
               let _0_249 =
                 ...
                 let _0_247 =
                   let _0_246 =
                     ...
                     let _0_244 =
                       let _0_243 = mkApp (tok_name, []) norng  in [_0_243]
                        in
                     (_0_245, _0_244)  in
...
let injective_constructor :
  ...
  fun uu____1701  ->
    ...
    | (name,fields,sort) ->
        ...
        let bvar_name i =
          let _0_261 = FStar_Util.string_of_int i  in
          Prims.strcat "x_" _0_261  in
    ...
    | (name,fields,sort,id,injective) ->
        ...
        let disc =
                      ...
                      fun uu____1861  ->
                        ...
                        | (proj,s,projectible) ->
                            ...
                            then
                              ...
                              (let fi =
                                 let _0_279 =
                                   let _0_278 = FStar_Util.string_of_int i
                                      in
          ...
          | (proj_terms,ex_vars) ->
              ...
              let disc_inv_body =
                let _0_283 =
                  let _0_282 = mkApp (name, proj_terms) norng  in
                  (xx, _0_282)  in
                                 ...
                                 let _0_296 =
                                   FStar_List.map
                                     (fun p  ->
                                        ...
                                        FStar_Util.format1 "%s" _0_295) pats
                                    in
      ...
      let _0_317 =
        let _0_316 =
          FStar_All.pipe_right constrs
           ...
           in
        FStar_All.pipe_right _0_316 (FStar_List.map (declToSmt z3options))
         in
...
let mk_Valid : term -> term =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        ...
        {
          tm = (uu___90_2715.tm);
          freevars = (uu___90_2715.freevars);
          rng = (t.rng)
        }
