...
let qop_to_string: qop -> Prims.string =
  fun uu___88_842  ->
    match uu___88_842 with | Forall  -> "forall" | Exists  -> "exists"
let op_to_string: op -> Prims.string =
  fun uu___89_845  ->
    match uu___89_845 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
      ...
      | Caption c ->
          let uu____2859 =
            FStar_All.pipe_right (FStar_Util.splitlines c)
              (fun uu___92_2861  ->
                 match uu___92_2861 with | [] -> "" | h::t -> h) in
          FStar_Util.format1 "\n; %s" uu____2859
...
let mk_Valid: term -> term =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___93_3336 = unboxBool t1 in
        {
          tm = (uu___93_3336.tm);
          freevars = (uu___93_3336.freevars);
          rng = (t.rng)
        }
