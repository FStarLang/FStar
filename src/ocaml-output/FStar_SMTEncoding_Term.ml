...
let rec strSort: sort -> Prims.string =
  fun x  ->
    ...
    | Fuel_sort  -> "Fuel"
    | Array (s1,s2) ->
        let _0_170 = strSort s1 in
        let _0_169 = strSort s2 in
        FStar_Util.format2 "(Array %s %s)" _0_170 _0_169
    | Arrow (s1,s2) ->
        let _0_172 = strSort s1 in
        let _0_171 = strSort s2 in
        FStar_Util.format2 "(%s -> %s)" _0_172 _0_171
    | Sort s -> s
type op =
  | TrueOp
  | FalseOp
...
let free_variables: term -> fvs =
  fun t  ->
    ...
    | None  ->
        let fvs =
          let _0_173 = freevars t in FStar_Util.remove_dups fv_eq _0_173 in
...
let weightToSmt: Prims.int Prims.option -> Prims.string =
  fun uu___86_813  ->
    ...
    | None  -> ""
    | Some i ->
        let _0_174 = FStar_Util.string_of_int i in
...
let rec hash_of_term': term' -> Prims.string =
  fun t  ->
    ...
    | Integer i -> i
    | BoundV i ->
        let _0_175 = FStar_Util.string_of_int i in Prims.strcat "@" _0_175
    | FreeV x ->
        let _0_177 =
          let _0_176 = strSort (Prims.snd x) in Prims.strcat ":" _0_176 in
        Prims.strcat (Prims.fst x) _0_177
    | App (op,tms) ->
        let _0_181 =
          let _0_180 =
            let _0_179 =
              let _0_178 = FStar_List.map hash_of_term tms in
              FStar_All.pipe_right _0_178 (FStar_String.concat " ") in
            Prims.strcat _0_179 ")" in
          Prims.strcat (op_to_string op) _0_180 in
        Prims.strcat "(" _0_181
    | Labeled (t,r1,r2) ->
        let _0_184 = hash_of_term t in
        let _0_183 =
          let _0_182 = FStar_Range.string_of_range r2 in
          Prims.strcat r1 _0_182 in
        Prims.strcat _0_184 _0_183
    | LblPos (t,r) ->
        let _0_186 =
          let _0_185 = hash_of_term t in
          Prims.strcat _0_185 (Prims.strcat " :lblpos " (Prims.strcat r ")")) in
        Prims.strcat "(! " _0_186
    | Quant (qop,pats,wopt,sorts,body) ->
        let _0_202 =
          let _0_201 =
            let _0_200 =
              let _0_199 =
                let _0_187 = FStar_List.map strSort sorts in
                FStar_All.pipe_right _0_187 (FStar_String.concat " ") in
              let _0_198 =
                let _0_197 =
                  let _0_196 = hash_of_term body in
                  let _0_195 =
                    let _0_194 =
                      let _0_193 = weightToSmt wopt in
                      let _0_192 =
                        let _0_191 =
                          let _0_190 =
                            let _0_189 =
                              FStar_All.pipe_right pats
                                (FStar_List.map
                                   (fun pats  ->
                                      ...
                                      FStar_All.pipe_right _0_188
                                        (FStar_String.concat " "))) in
                            FStar_All.pipe_right _0_189
                              (FStar_String.concat "; ") in
                          Prims.strcat _0_190 "))" in
                        Prims.strcat " " _0_191 in
                      Prims.strcat _0_193 _0_192 in
                    Prims.strcat " " _0_194 in
                  Prims.strcat _0_196 _0_195 in
                Prims.strcat ")(! " _0_197 in
              Prims.strcat _0_199 _0_198 in
            Prims.strcat " (" _0_200 in
          Prims.strcat (qop_to_string qop) _0_201 in
        Prims.strcat "(" _0_202
and hash_of_term: term -> Prims.string = fun tm  -> hash_of_term' tm.tm
let mk: term' -> FStar_Range.range -> term =
  fun t  ->
    fun r  ->
      let _0_203 = FStar_Util.mk_ref None in
      { tm = t; freevars = _0_203; rng = r }
let mkTrue: FStar_Range.range -> term = fun r  -> mk (App (TrueOp, [])) r
let mkFalse: FStar_Range.range -> term = fun r  -> mk (App (FalseOp, [])) r
let mkInteger: Prims.string -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let _0_204 = Integer (FStar_Util.ensure_decimal i) in mk _0_204 r
let mkInteger': Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  -> let _0_205 = FStar_Util.string_of_int i in mkInteger _0_205 r
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____1069,App (Imp ,t1'::t2'::[])) ->
               let _0_208 =
                 let _0_207 = let _0_206 = mkAnd (t1, t1') r in [_0_206; t2'] in
                 (Imp, _0_207) in
               mkApp' _0_208 r
      ...
      | (t1,t2,t3) ->
          (match ((t2.tm), (t3.tm)) with
           ...
           | (App (TrueOp ,uu____1188),uu____1189) ->
               let _0_210 = let _0_209 = mkNot t1 t1.rng in (_0_209, t3) in
               mkImp _0_210 r
      ...
      let rec aux ix t =
        ...
        | uu____1305 ->
            (match t.tm with
             ...
             | App (op,tms) ->
                 let _0_212 =
                   let _0_211 = FStar_List.map (aux ix) tms in (op, _0_211) in
                 mkApp' _0_212 t.rng
             | Labeled (t,r1,r2) ->
                 let _0_214 =
                   Labeled (let _0_213 = aux ix t in (_0_213, r1, r2)) in
                 mk _0_214 t.rng
             | LblPos (t,r) ->
                 let _0_216 = LblPos (let _0_215 = aux ix t in (_0_215, r)) in
                 mk _0_216 t.rng
             | Quant (qop,pats,wopt,vars,body) ->
                 ...
                 let _0_219 =
                   ...
                   let _0_217 = aux (ix + n) body in
                   (qop, _0_218, wopt, vars, _0_217) in
                 mkQuant _0_219 t.rng) in
  ...
  fun tms  ->
    fun t  ->
      ...
      let rec aux shift t =
        ...
        | App (op,tms) ->
            let _0_221 =
              let _0_220 = FStar_List.map (aux shift) tms in (op, _0_220) in
            mkApp' _0_221 t.rng
        | Labeled (t,r1,r2) ->
            let _0_223 =
              Labeled (let _0_222 = aux shift t in (_0_222, r1, r2)) in
            mk _0_223 t.rng
        | LblPos (t,r) ->
            let _0_225 = LblPos (let _0_224 = aux shift t in (_0_224, r)) in
            mk _0_225 t.rng
        | Quant (qop,pats,wopt,vars,body) ->
            ...
            let _0_228 =
              ...
              let _0_226 = aux shift body in
              (qop, _0_227, wopt, vars, _0_226) in
            mkQuant _0_228 t.rng in
      aux (Prims.parse_int "0") t
let subst: term -> fv -> term -> term =
  fun t  -> fun fv  -> fun s  -> let _0_229 = abstr [fv] t in inst [s] _0_229
let mkQuant':
  ...
  fun uu____1788  ->
    ...
    | (name,fields,sort,id,injective) ->
        ...
        let disc =
          ...
          let disc_eq =
            let _0_269 =
              let _0_268 =
                let _0_265 =
                  let _0_264 = constr_id_of_sort sort in (_0_264, [xx]) in
                mkApp _0_265 norng in
              let _0_267 =
                let _0_266 = FStar_Util.string_of_int id in
                mkInteger _0_266 norng in
              (_0_268, _0_267) in
            mkEq _0_269 norng in
          let uu____1824 =
            let _0_274 =
              FStar_All.pipe_right fields
                (FStar_List.mapi
                   (fun i  ->
                      fun uu____1861  ->
                        ...
                        | (proj,s,projectible) ->
                            if projectible
                            then
                              let _0_270 = mkApp (proj, [xx]) norng in
                              (_0_270, [])
                            else
                              (let fi =
                                 let _0_272 =
                                   let _0_271 = FStar_Util.string_of_int i in
                                   Prims.strcat "f_" _0_271 in
                                 (_0_272, s) in
                               let _0_273 = mkFreeV fi norng in
                               (_0_273, [fi])))) in
            FStar_All.pipe_right _0_274 FStar_List.split in
          match uu____1824 with
          | (proj_terms,ex_vars) ->
              let ex_vars = FStar_List.flatten ex_vars in
              let disc_inv_body =
                let _0_276 =
                  let _0_275 = mkApp (name, proj_terms) norng in (xx, _0_275) in
        ...
        let _0_281 =
          ...
          _0_277 :: cdecl :: cid :: projs in
        let _0_280 =
          let _0_279 =
            let _0_278 =
              Caption (FStar_Util.format1 "</end constructor %s>" name) in
            [_0_278] in
          FStar_List.append [disc] _0_279 in
        FStar_List.append _0_281 _0_280
                 ...
                 (fun uu____1996  ->
                    fun s  ->
                      ...
                      | (names,binders,n) ->
                          ...
                          let nm =
                            let _0_282 = FStar_Util.string_of_int n in
                            Prims.strcat prefix _0_282 in
                          let names = (nm, s) :: names in
                          let b =
                            let _0_283 = strSort s in
                            FStar_Util.format2 "(%s %s)" nm _0_283 in
                          (names, (b :: binders),
                            (n + (Prims.parse_int "1"))))
...
let termToSmt: term -> Prims.string =
  fun t  ->
    ...
    let rec aux' n names t =
      ...
      | Integer i -> i
      | BoundV i ->
          let _0_284 = FStar_List.nth names i in
          FStar_All.pipe_right _0_284 Prims.fst
      | FreeV x -> Prims.fst x
      | App (op,[]) -> op_to_string op
      | App (op,tms) ->
          let _0_286 =
            let _0_285 = FStar_List.map (aux n names) tms in
            FStar_All.pipe_right _0_285 (FStar_String.concat "\n") in
          FStar_Util.format2 "(%s %s)" (op_to_string op) _0_286
      | Labeled (t,uu____2177,uu____2178) -> aux n names t
      | LblPos (t,s) ->
          let _0_287 = aux n names t in
          FStar_Util.format2 "(! %s :lblpos %s)" _0_287 s
      | Quant (qop,pats,wopt,sorts,body) ->
                            ...
                            (fun pats  ->
                               let _0_290 =
                                 let _0_289 =
                                   FStar_List.map
                                     (fun p  ->
                                        let _0_288 = aux n names p in
                                        FStar_Util.format1 "%s" _0_288) pats in
                                 FStar_String.concat " " _0_289 in
                               FStar_Util.format1 "\n:pattern (%s)" _0_290)) in
                     FStar_All.pipe_right _0_291 (FStar_String.concat "\n") in
               (match (pats, wopt) with
                | ([]::[],None )|([],None ) ->
                    let _0_292 = aux n names body in
                    FStar_Util.format3 "(%s (%s)\n %s);;no pats\n"
                      (qop_to_string qop) binders _0_292
                | uu____2245 ->
                    let _0_294 = aux n names body in
                    let _0_293 = weightToSmt wopt in
                    FStar_Util.format5 "(%s (%s)\n (! %s\n %s %s))"
                      (qop_to_string qop) binders _0_294 _0_293 pats_str))
    and aux n names t =
      let s = aux' n names t in
      if t.rng <> norng
      then
        let _0_296 = FStar_Range.string_of_range t.rng in
        let _0_295 = FStar_Range.string_of_use_range t.rng in
        FStar_Util.format3 "\n;; def=%s; use=%s\n%s\n" _0_296 _0_295 s
      else s in
    aux (Prims.parse_int "0") [] t
  ...
  fun z3options  ->
    fun decl  ->
      ...
      | DeclFun (f,argsorts,retsort,c) ->
          ...
          let _0_299 = caption_to_string c in
          let _0_298 = strSort retsort in
          FStar_Util.format4 "%s(declare-fun %s (%s) %s)" _0_299 f
            (FStar_String.concat " " l) _0_298
          ...
          (match uu____2310 with
           | (names,binders) ->
               let body =
                 ...
                 inst _0_300 body in
               let _0_303 = caption_to_string c in
               let _0_302 = strSort retsort in
               let _0_301 = termToSmt body in
               FStar_Util.format5 "%s(define-fun %s (%s) %s\n %s)" _0_303 f
                 (FStar_String.concat " " binders) _0_302 _0_301)
      | Assume (t,c,Some n) ->
          let _0_305 = caption_to_string c in
          let _0_304 = termToSmt t in
          FStar_Util.format3 "%s(assert (!\n%s\n:named %s))" _0_305 _0_304
            (escape n)
      | Assume (t,c,None ) ->
          let _0_307 = caption_to_string c in
          let _0_306 = termToSmt t in
          FStar_Util.format2 "%s(assert %s)" _0_307 _0_306
      | Eval t ->
          let _0_308 = termToSmt t in FStar_Util.format1 "(eval %s)" _0_308
  ...
  fun z3options  ->
    ...
    let bcons =
      let _0_310 =
        ...
        FStar_All.pipe_right _0_309 (FStar_List.map (declToSmt z3options)) in
...
let mk_Term_uvar: Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let _0_313 =
        let _0_312 = let _0_311 = mkInteger' i norng in [_0_311] in
        ("Tm_uvar", _0_312) in
      mkApp _0_313 r
...
let mk_Valid: term -> term =
  fun t  ->
    ...
    | App
        ...
        -> let _0_314 = mkEq (t1, t2) norng in mkNot _0_314 t.rng
    | App
        (Var
    ...
    | App
        ...
        ->
        let _0_326 =
          let _0_325 = unboxInt t1 in
          let _0_324 = unboxInt t2 in (_0_325, _0_324) in
        mkGT _0_326 t.rng
    | App
        (Var
    ...
    | App
        ...
        ->
        let _0_332 =
          let _0_331 = unboxBool t1 in
          let _0_330 = unboxBool t2 in (_0_331, _0_330) in
        mkOr _0_332 t.rng
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_Negation",t::[]);
                       freevars = uu____2705; rng = uu____2706;_}::[])
        -> let _0_333 = unboxBool t in mkNot _0_333 t.rng
...
let mk_String_const: Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let _0_336 =
        let _0_335 = let _0_334 = mkInteger' i norng in [_0_334] in
        ("FString_const", _0_335) in
      mkApp _0_336 r
let mk_Precedes: term -> term -> FStar_Range.range -> term =
  fun x1  ->
    fun x2  ->
      fun r  ->
        let _0_337 = mkApp ("Precedes", [x1; x2]) r in
        FStar_All.pipe_right _0_337 mk_Valid
...
let rec n_fuel: Prims.int -> term =
  fun n  ->
    ...
    then mkApp ("ZFuel", []) norng
      ...
      (let _0_340 =
         let _0_339 =
           let _0_338 = n_fuel (n - (Prims.parse_int "1")) in [_0_338] in
         ("SFuel", _0_339) in
       mkApp _0_340 norng)
...
let mk_and_l: term Prims.list -> FStar_Range.range -> term =
  fun l  ->
    fun r  ->
      let _0_341 = mkTrue r in
      FStar_List.fold_right (fun p1  -> fun p2  -> mkAnd (p1, p2) r) l _0_341
let mk_or_l: term Prims.list -> FStar_Range.range -> term =
  fun l  ->
    fun r  ->
      let _0_342 = mkFalse r in
      FStar_List.fold_right (fun p1  -> fun p2  -> mkOr (p1, p2) r) l _0_342
...
let rec print_smt_term: term -> Prims.string =
  fun t  ->
    ...
    | BoundV n ->
        ...
        FStar_Util.format1 "(BoundV %s)" _0_343
    | FreeV fv -> FStar_Util.format1 "(FreeV %s)" (Prims.fst fv)
    | App (op,l) ->
        let _0_344 = print_smt_term_list l in
        FStar_Util.format2 "(%s %s)" (op_to_string op) _0_344
    | Labeled (t,r1,r2) ->
        let _0_345 = print_smt_term t in
        FStar_Util.format2 "(Labeled '%s' %s)" r1 _0_345
    | LblPos (t,s) ->
        let _0_346 = print_smt_term t in
        FStar_Util.format2 "(LblPos %s %s)" s _0_346
    | Quant (qop,l,uu____2926,uu____2927,t) ->
        let _0_348 = print_smt_term_list_list l in
        let _0_347 = print_smt_term t in
        FStar_Util.format3 "(%s %s %s)" (qop_to_string qop) _0_348 _0_347
and print_smt_term_list: term Prims.list -> Prims.string =
  fun l  ->
    let _0_349 = FStar_List.map print_smt_term l in
    FStar_All.pipe_right _0_349 (FStar_String.concat " ")
    ...
    FStar_List.fold_left
      (fun s  ->
         fun l  ->
           let _0_352 =
             let _0_351 =
               let _0_350 = print_smt_term_list l in
               Prims.strcat _0_350 " ] " in
             Prims.strcat "; [ " _0_351 in
           Prims.strcat s _0_352) "" l