  ...
  fun t  ->
    ...
    | LblPos (t1,r) ->
        let uu___ =
          ...
          Prims.op_Hat uu___1 (Prims.op_Hat " :lblpos " (Prims.op_Hat r ")"))
           in
        Prims.op_Hat "(! " uu___
...
let (isInjective : Prims.string -> Prims.bool) =
  fun s  ->
    ...
    then
      (let uu___ = FStar_String.substring s Prims.int_zero (Prims.of_int (3))
          in
       uu___ = "Box") &&
        (let uu___ =
...
let (mkInteger : Prims.string -> FStar_Range.range -> term) =
  fun i  ->
    fun r  ->
      let uu___ = let uu___1 = FStar_Util.ensure_decimal i  in Integer uu___1
         in
      mk uu___ r
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu___1,App (Imp ,t1'::t2'::[])) ->
               let uu___2 =
                 let uu___3 =
                   let uu___4 = mkAnd (t1, t1') r  in [uu___4; t2']  in
                 (Imp, uu___3)  in
               mkApp' uu___2 r
    ...
    fun uu___  ->
      fun r  ->
        ...
        | (t1,t2) ->
            let uu___1 =
              let uu___2 =
                let uu___3 = let uu___4 = mkNatToBv sz t2 r  in [uu___4]  in
                t1 :: uu___3  in
              (BvShl, uu___2)  in
            mkApp' uu___1 r
           ...
           | uu___1 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp ,uu___2),uu___3) ->
                    let uu___4 =
                      let uu___5 = mkNot t1 t1.rng  in (uu___5, t3)  in
                    mkImp uu___4 r
...
let (mkCases : term Prims.list -> FStar_Range.range -> term) =
  fun t  ->
    fun r  ->
      ...
      | [] -> failwith "Impos"
      | hd::tl ->
          FStar_List.fold_left (fun out  -> fun t1  -> mkAnd (out, t1) r) hd
            tl
                     ...
                     ((let uu___4 =
                         let uu___5 =
                           ...
                           FStar_Util.format1
                             ...
                             uu___6
                            in
                         (FStar_Errors.Warning_SMTPatternIllFormed, uu___5)
                          in
      ...
      let rec aux ix t1 =
        ...
        | uu___1 ->
            (match t1.tm with
             ...
             | App (op1,tms) ->
                 let uu___2 =
                   let uu___3 = FStar_List.map (aux ix) tms  in (op1, uu___3)
                    in
                 mkApp' uu___2 t1.rng
             | Labeled (t2,r1,r2) ->
                 let uu___2 =
                   let uu___3 = let uu___4 = aux ix t2  in (uu___4, r1, r2)
                      in
                   Labeled uu___3  in
                 mk uu___2 t2.rng
             | LblPos (t2,r) ->
                     ...
                     (fun uu___3  ->
                        fun e  ->
                          ...
                          | (ix1,l) ->
                              ...
                              ((ix1 + Prims.int_one), uu___4)) (ix, []) es
                    in
                 (match uu___2 with
                  | (ix1,es_rev) ->
                      let uu___3 =
  ...
  fun tms  ->
    fun t  ->
      ...
      let rec aux shift t1 =
        ...
        | App (op1,tms2) ->
            let uu___ =
              let uu___1 = FStar_List.map (aux shift) tms2  in (op1, uu___1)
               in
            mkApp' uu___ t1.rng
        | Labeled (t2,r1,r2) ->
            let uu___ =
                ...
                (fun uu___1  ->
                   fun e  ->
                     ...
                     | (ix,es1) ->
                         ...
                         ((shift + Prims.int_one), uu___2)) (shift, []) es
               in
            (match uu___ with
             | (shift1,es_rev) ->
                 let uu___1 =
...
let (subst : term -> fv -> term -> term) =
  fun t  ->
    fun fv1  -> fun s  -> let uu___ = abstr [fv1] t  in inst [s] uu___
              ...
              let uu___2 =
                ...
                let uu___4 =
                  let uu___5 =
                    ...
                    let uu___7 =
                      let uu___8 = mkApp (tok_name, []) norng  in [uu___8]
                       in
                    (uu___6, uu___7)  in
          ...
          let a =
            let uu___1 =
              let uu___2 =
                let uu___3 =
                  let uu___4 =
                    let uu___5 = mkInteger id1 norng  in (uu___5, cid_app)
                     in
              ...
              (FStar_List.mapi
                 (fun i  ->
                    fun uu___1  ->
                      match uu___1 with
                      | (uu___2,s,uu___3) ->
                          let uu___4 = bvar i s  in uu___4 norng))
             in
          let bvar_names = FStar_List.map fv_of_term bvars  in
          let capp = mkApp (name, bvars) norng  in
          let uu___1 =
      ...
      | (name,fields,sort1,id,injective) ->
          ...
          let field_sorts =
            FStar_All.pipe_right fields
              (FStar_List.map
                 (fun uu___1  ->
                    match uu___1 with | (uu___2,sort2,uu___3) -> sort2))
             in
          let cdecl =
            DeclFun
          ...
          let disc =
            ...
            let disc_eq =
              let uu___1 =
                let uu___2 =
                  let uu___3 =
                    let uu___4 = constr_id_of_sort sort1  in (uu___4, [xx])
                     in
            ...
            | (proj_terms,ex_vars) ->
                ...
                let disc_inv_body1 =
                  match ex_vars1 with
                  | [] -> disc_inv_body
                  | uu___2 -> mkExists norng ([], ex_vars1, disc_inv_body)
                   in
          ...
          let uu___1 =
            let uu___2 =
              let uu___3 = FStar_Util.format1 "<start constructor %s>" name
                 in
              Caption uu___3  in
          ...
          let uu___2 =
            let uu___3 =
              let uu___4 =
                let uu___5 = FStar_Util.format1 "</end constructor %s>" name
                   in
                Caption uu___5  in
              [uu___4]  in
      ...
      fun t  ->
        let next_qid =
          ...
          fun depth  ->
            ...
            then enclosing_name
              ...
              (let uu___2 = FStar_Util.string_of_int n  in
               FStar_Util.format2 "%s.%s" enclosing_name uu___2)
           in
                  ...
                  FStar_All.pipe_right ps
                    (FStar_List.map
                       (fun tm  ->
                          ...
                          | App
                              (Var
                               "Prims.guard_free",{ tm = BoundV uu___;
                                                    freevars = uu___1;
                                                    rng = uu___2;_}::[])
                              -> tm
        ...
        let rec aux' depth n names t1 =
          ...
          | FreeV x when fv_force x ->
              let uu___ =
                let uu___1 = fv_name x  in
                Prims.op_Hat uu___1 " Dummy_value)"  in
              Prims.op_Hat "(" uu___
          | FreeV x -> fv_name x
          ...
          | Quant (qop1,pats,wopt,sorts,body) ->
              let qid = next_qid ()  in
              let uu___ =
                name_binders_inner FStar_Pervasives_Native.None names n sorts
                 in
              (match uu___ with
               | (names1,binders1,n1) ->
                   let binders2 =
                     FStar_All.pipe_right binders1 (FStar_String.concat " ")
                      in
    ...
    fun z3options  ->
      fun decl1  ->
        ...
        | Module (s,decls) ->
            ...
            if uu___
            then
              let uu___1 = FStar_Util.string_of_int (FStar_List.length decls)
                 in
              let uu___2 = FStar_Util.string_of_int (FStar_String.length res)
                 in
              FStar_Util.format5
        ...
        | Assume a ->
            ...
            let uu___ = caption_to_string print_captions a.assumption_caption
               in
      ...
      let uu___ =
        let uu___1 =
          FStar_All.pipe_right constrs
           ...
           in
        FStar_All.pipe_right uu___1 (FStar_List.map (declToSmt z3options))
         in
      FStar_All.pipe_right uu___ (FStar_String.concat "\n")  in
    let lex_ordering =
...
let (mkBvConstructor : Prims.int -> decl Prims.list) =
  fun sz  ->
    let uu___ =
      let uu___1 =
        let uu___2 = boxBitVecFun sz  in FStar_Pervasives_Native.fst uu___2
         in
      let uu___2 =
        let uu___3 =
          let uu___4 =
...
let (boxBitVec : Prims.int -> term -> term) =
  fun sz  ->
    fun t  ->
      let uu___ =
        let uu___1 = boxBitVecFun sz  in FStar_Pervasives_Native.fst uu___1
         in
      let uu___1 =
        let uu___2 = boxBitVecFun sz  in FStar_Pervasives_Native.snd uu___2
         in
...
let (unboxBitVec : Prims.int -> term -> term) =
  fun sz  ->
    fun t  ->
      let uu___ =
        let uu___1 = boxBitVecFun sz  in FStar_Pervasives_Native.snd uu___1
         in
      let uu___1 =
        let uu___2 = boxBitVecFun sz  in FStar_Pervasives_Native.fst uu___2
         in
...
let (mk_Valid : term -> term) =
  fun t  ->
    ...
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_Equality",uu___::t1::t2::[]);
    ...
    | App
        (Var
         "Prims.b2t",{
                       tm = App
                         (Var "Prims.op_disEquality",uu___::t1::t2::[]);
                       freevars = uu___1; rng = uu___2;_}::[])
...
let rec (n_fuel : Prims.int -> term) =
  fun n  ->
    ...
    then mkApp ("ZFuel", []) norng
      ...
      (let uu___1 =
         let uu___2 = let uu___3 = n_fuel (n - Prims.int_one)  in [uu___3]
            in
         ("SFuel", uu___2)  in
       mkApp uu___1 norng)
