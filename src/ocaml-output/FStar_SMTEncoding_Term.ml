...
let mkInteger : Prims.string -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____1244 =
        let uu____1245 = FStar_Util.ensure_decimal i  in Integer uu____1245
         in
      mk uu____1244 r
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____1452,App (Imp ,t1'::t2'::[])) ->
               let uu____1456 =
                 let uu____1460 =
                   let uu____1462 = mkAnd (t1, t1') r  in [uu____1462; t2']
                    in
                 (Imp, uu____1460)  in
               mkApp' uu____1456 r
           ...
           | uu____1607 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp ,uu____1614),uu____1615) ->
                    let uu____1618 =
                      let uu____1621 = mkNot t1 t1.rng  in (uu____1621, t3)
                       in
                    mkImp uu____1618 r
                   ...
                   FStar_List.fold_left
                     (fun uu____1877  ->
                        fun e  ->
                          ...
                          | (ix1,l) ->
                              let uu____1889 =
                                let uu____1891 = aux ix1 e  in uu____1891 ::
                                  l
                                 in
              ...
              FStar_List.fold_left
                (fun uu____2024  ->
                   fun e  ->
                     ...
                     | (ix,es1) ->
                         let uu____2036 =
                           let uu____2038 = aux shift e  in uu____2038 :: es1
                            in
...
let subst : term -> fv -> term -> term =
  fun t  ->
    fun fv  ->
      fun s  -> let uu____2063 = abstr [fv] t  in inst [s] uu____2063
               ...
               (fun i  ->
                  fun s  ->
                    let uu____2425 =
                      ...
                      (uu____2428, s)  in
                    mkFreeV uu____2425 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let cid_app =
          let uu____2435 =
            let uu____2439 = constr_id_of_sort sort  in (uu____2439, [capp])
             in
...
let injective_constructor :
  ...
  fun uu____2467  ->
    ...
    | (name,fields,sort) ->
        ...
        let bvar i s =
          let uu____2504 = let uu____2507 = bvar_name i  in (uu____2507, s)
             in
               ...
               (fun i  ->
                  fun uu____2522  ->
                    ...
                    | (uu____2526,s,uu____2528) ->
                        let uu____2529 = bvar i s  in uu____2529 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let uu____2536 =
...
let constructor_to_decl : constructor_t -> decl Prims.list =
  fun uu____2597  ->
    ...
    | (name,fields,sort,id,injective) ->
          ...
          FStar_All.pipe_right fields
            (FStar_List.map
               (fun uu____2617  ->
                  ...
                  | (uu____2621,sort1,uu____2623) -> sort1))
           in
        let cdecl =
          DeclFun
        ...
        let disc =
          ...
          | (proj_terms,ex_vars) ->
              ...
              let disc_inv_body1 =
                match ex_vars1 with
                | [] -> disc_inv_body
                | uu____2766 -> mkExists ([], ex_vars1, disc_inv_body) norng
                 in
        ...
        let uu____2789 =
          let uu____2791 =
            let uu____2792 = FStar_Util.format1 "<start constructor %s>" name
               in
        ...
        fun depth  ->
          ...
          then enclosing_name
            ...
            (let uu____3004 = FStar_Util.string_of_int n1  in
             FStar_Util.format2 "%s.%s" enclosing_name uu____3004)
         in
                              ...
                              (fun pats2  ->
                                 let uu____3152 =
                                   let uu____3153 =
                                     FStar_List.map
                                       (fun p  ->
                                          let uu____3158 = aux1 n2 names2 p
                                             in
...
let mk_Term_uvar : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____3614 =
        let uu____3618 = let uu____3620 = mkInteger' i norng  in [uu____3620]
           in
...
let mk_String_const : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____3946 =
        let uu____3950 = let uu____3952 = mkInteger' i norng  in [uu____3952]
           in
