...
let freevar_sort : term  ->  sort = (fun uu___85_736 -> (match (uu___85_736) with
...
let fv_of_term : term  ->  fv = (fun uu___86_749 -> (match (uu___86_749) with
...
let qop_to_string : qop  ->  Prims.string = (fun uu___87_842 -> (match (uu___87_842) with
| Forall -> begin
"forall"
end
| Exists -> begin
...
let op_to_string : op  ->  Prims.string = (fun uu___88_845 -> (match (uu___88_845) with
| TrueOp -> begin
"true"
end
| FalseOp -> begin
...
let weightToSmt : Prims.int Prims.option  ->  Prims.string = (fun uu___89_850 -> (match (uu___89_850) with
| None -> begin
""
end
| Some (i) -> begin
...
let caption_to_string : Prims.string Prims.option  ->  Prims.string = (fun uu___90_2830 -> (match (uu___90_2830) with
| None -> begin
""
end
| Some (c) -> begin
...
let uu____2859 = (FStar_All.pipe_right (FStar_Util.splitlines c) (fun uu___91_2861 -> (match (uu___91_2861) with
| [] -> begin
""
end
| (h)::t -> begin
...
let uu___92_3336 = (unboxBool t1)
in {tm = uu___92_3336.tm; freevars = uu___92_3336.freevars; rng = t.rng})
end
| uu____3339 -> begin
(mkApp (("Valid"), ((t)::[])) t.rng)
end))
