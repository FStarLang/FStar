...
let freevar_sort : term  ->  sort = (fun uu___86_1378 -> (match (uu___86_1378) with
...
let fv_of_term : term  ->  fv = (fun uu___87_1398 -> (match (uu___87_1398) with
...
let qop_to_string : qop  ->  Prims.string = (fun uu___88_1628 -> (match (uu___88_1628) with
| Forall -> begin
"forall"
end
| Exists -> begin
...
let op_to_string : op  ->  Prims.string = (fun uu___89_1632 -> (match (uu___89_1632) with
| TrueOp -> begin
"true"
end
| FalseOp -> begin
...
let weightToSmt : Prims.int FStar_Pervasives_Native.option  ->  Prims.string = (fun uu___90_1643 -> (match (uu___90_1643) with
| FStar_Pervasives_Native.None -> begin
""
end
...
in (FStar_List.existsML (fun c -> (c = 46 (*.*))) uu____1806))
in (not (uu____1805))))
end
| uu____1811 -> begin
false
...
let caption_to_string : Prims.string FStar_Pervasives_Native.option  ->  Prims.string = (fun uu___91_5288 -> (match (uu___91_5288) with
| FStar_Pervasives_Native.None -> begin
""
end
...
let uu____5326 = (FStar_All.pipe_right (FStar_Util.splitlines c) (fun uu___92_5330 -> (match (uu___92_5330) with
| [] -> begin
""
end
| (h)::t -> begin
...
let fact_ids_to_string = (fun ids -> (FStar_All.pipe_right ids (FStar_List.map (fun uu___93_5425 -> (match (uu___93_5425) with
| Name (n1) -> begin
...
let uu___94_6416 = (unboxBool t1)
in {tm = uu___94_6416.tm; freevars = uu___94_6416.freevars; rng = t.rng})
end
| uu____6417 -> begin
(mkApp (("Valid"), ((t)::[])) t.rng)
end))
