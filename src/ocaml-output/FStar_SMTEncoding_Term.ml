...
let rec hash_of_term' : term' -> Prims.string =
  fun t  ->
    ...
    | FreeV x ->
        let uu____869 =
          let uu____870 = strSort (Prims.snd x)  in
    ...
    | Let (es,body) ->
        let uu____936 =
          ...
          let uu____941 =
            let uu____942 =
              let uu____943 = hash_of_term body  in
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____1164,App (Imp ,t1'::t2'::[])) ->
               let uu____1168 =
                 let uu____1172 =
                   let uu____1174 = mkAnd (t1, t1') r  in [uu____1174; t2']
                    in
                 (Imp, uu____1172)  in
               mkApp' uu____1168 r
           ...
           | uu____1290 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp ,uu____1297),uu____1298) ->
                    let uu____1301 =
                      let uu____1304 = mkNot t1 t1.rng  in (uu____1304, t3)
                       in
                    mkImp uu____1301 r
                   ...
                   FStar_List.fold_left
                     (fun uu____1532  ->
                        fun e  ->
                          ...
                          | (ix,l) ->
                              let uu____1544 =
                                let uu____1546 = aux ix e  in uu____1546 :: l
                                 in
              ...
              FStar_List.fold_left
                (fun uu____1664  ->
                   fun e  ->
                     ...
                     | (ix,es) ->
                         let uu____1676 =
                           let uu____1678 = aux shift e  in uu____1678 :: es
                            in
               ...
               (fun i  ->
                  fun s  ->
                    let uu____2039 =
                      ...
                      (uu____2042, s)  in
                    mkFreeV uu____2039 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let cid_app =
          let uu____2049 =
            let uu____2053 = constr_id_of_sort sort  in (uu____2053, [capp])
             in
...
let injective_constructor :
  ...
  fun uu____2088  ->
    ...
    | (name,projectors,sort) ->
        ...
        let bvar i s =
          let uu____2129 = let uu____2132 = bvar_name i  in (uu____2132, s)
             in
            ...
            (FStar_List.mapi
               (fun i  ->
                  fun uu____2142  ->
                    ...
                    | (uu____2145,s) ->
                        let uu____2147 = bvar i s  in uu____2147 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let uu____2154 =
...
let mk_Term_uvar : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____2995 =
        let uu____2999 = let uu____3001 = mkInteger' i norng  in [uu____3001]
           in
...
let mk_String_const : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____3271 =
        let uu____3275 = let uu____3277 = mkInteger' i norng  in [uu____3277]
           in
