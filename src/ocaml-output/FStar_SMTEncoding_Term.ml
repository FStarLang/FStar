...
let freevar_sort : term  ->  sort = (fun uu___105_1378 -> (match (uu___105_1378) with
...
let fv_of_term : term  ->  fv = (fun uu___106_1398 -> (match (uu___106_1398) with
...
let qop_to_string : qop  ->  Prims.string = (fun uu___107_1628 -> (match (uu___107_1628) with
| Forall -> begin
"forall"
end
| Exists -> begin
...
let op_to_string : op  ->  Prims.string = (fun uu___108_1632 -> (match (uu___108_1632) with
| TrueOp -> begin
"true"
end
| FalseOp -> begin
...
let weightToSmt : Prims.int FStar_Pervasives_Native.option  ->  Prims.string = (fun uu___109_1643 -> (match (uu___109_1643) with
| FStar_Pervasives_Native.None -> begin
""
end
...
let caption_to_string : Prims.string FStar_Pervasives_Native.option  ->  Prims.string = (fun uu___110_5288 -> (match (uu___110_5288) with
| FStar_Pervasives_Native.None -> begin
""
end
...
let uu____5326 = (FStar_All.pipe_right (FStar_Util.splitlines c) (fun uu___111_5330 -> (match (uu___111_5330) with
| [] -> begin
""
end
| (h)::t -> begin
...
let fact_ids_to_string = (fun ids -> (FStar_All.pipe_right ids (FStar_List.map (fun uu___112_5425 -> (match (uu___112_5425) with
| Name (n1) -> begin
...
let uu___113_6416 = (unboxBool t1)
in {tm = uu___113_6416.tm; freevars = uu___113_6416.freevars; rng = t.rng})
end
| uu____6417 -> begin
(mkApp (("Valid"), ((t)::[])) t.rng)
end))
