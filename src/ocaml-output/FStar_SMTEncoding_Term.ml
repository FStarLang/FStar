...
let qop_to_string : qop -> Prims.string =
  fun uu___90_927  ->
    match uu___90_927 with | Forall  -> "forall" | Exists  -> "exists"
  
let op_to_string : op -> Prims.string =
  fun uu___91_930  ->
    match uu___91_930 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
...
let rec hash_of_term' : term' -> Prims.string =
  fun t  ->
    ...
    | FreeV x ->
        let uu____950 =
          let uu____951 = strSort (Prims.snd x)  in
          Prims.strcat ":" uu____951  in
...
let mkInteger : Prims.string -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____1061 =
        let uu____1062 = FStar_Util.ensure_decimal i  in Integer uu____1062
         in
      mk uu____1061 r
      ...
      | (t1,t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____1245,App (Imp ,t1'::t2'::[])) ->
               let uu____1249 =
                 let uu____1253 =
                   let uu____1255 = mkAnd (t1, t1') r  in [uu____1255; t2']
                    in
                 (Imp, uu____1253)  in
               mkApp' uu____1249 r
           ...
           | uu____1371 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp ,uu____1378),uu____1379) ->
                    let uu____1382 =
                      let uu____1385 = mkNot t1 t1.rng  in (uu____1385, t3)
                       in
                    mkImp uu____1382 r
                   ...
                   FStar_List.fold_left
                     (fun uu____1613  ->
                        fun e  ->
                          ...
                          | (ix1,l) ->
                              let uu____1625 =
                                let uu____1627 = aux ix1 e  in uu____1627 ::
                                  l
                                 in
              ...
              FStar_List.fold_left
                (fun uu____1745  ->
                   fun e  ->
                     ...
                     | (ix,es1) ->
                         let uu____1757 =
                           let uu____1759 = aux shift e  in uu____1759 :: es1
                            in
...
let subst : term -> fv -> term -> term =
  fun t  ->
    fun fv  ->
      fun s  -> let uu____1781 = abstr [fv] t  in inst [s] uu____1781
               ...
               (fun i  ->
                  fun s  ->
                    let uu____2124 =
                      ...
                      (uu____2127, s)  in
                    mkFreeV uu____2124 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let cid_app =
          let uu____2134 =
            let uu____2138 = constr_id_of_sort sort  in (uu____2138, [capp])
             in
...
let injective_constructor :
  ...
  fun uu____2165  ->
    ...
    | (name,fields,sort) ->
        ...
        let bvar i s =
          let uu____2198 = let uu____2201 = bvar_name i  in (uu____2201, s)
             in
               ...
               (fun i  ->
                  fun uu____2210  ->
                    ...
                    | (uu____2214,s,uu____2216) ->
                        let uu____2217 = bvar i s  in uu____2217 norng))
           in
        let bvar_names = FStar_List.map fv_of_term bvars  in
        let capp = mkApp (name, bvars) norng  in
        let uu____2224 =
...
let constructor_to_decl : constructor_t -> decl Prims.list =
  fun uu____2276  ->
    ...
    | (name,fields,sort,id,injective) ->
          ...
          FStar_All.pipe_right fields
            (FStar_List.map
               (fun uu____2292  ->
                  ...
                  | (uu____2296,sort1,uu____2298) -> sort1))
           in
        ...
        let disc =
          ...
          | (proj_terms,ex_vars) ->
              ...
              let disc_inv_body1 =
                match ex_vars1 with
                | [] -> disc_inv_body
                | uu____2435 -> mkExists ([], ex_vars1, disc_inv_body) norng
                 in
        ...
        let uu____2458 =
          let uu____2460 =
            let uu____2461 = FStar_Util.format1 "<start constructor %s>" name
               in
        ...
        fun depth  ->
          ...
          then enclosing_name
            ...
            (let uu____2656 = FStar_Util.string_of_int n1  in
             FStar_Util.format2 "%s.%s" enclosing_name uu____2656)
         in
                              ...
                              (fun pats2  ->
                                 let uu____2797 =
                                   let uu____2798 =
                                     FStar_List.map
                                       (fun p  ->
                                          let uu____2801 = aux1 n2 names1 p
                                             in
...
let mk_Term_uvar : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____3239 =
        let uu____3243 = let uu____3245 = mkInteger' i norng  in [uu____3245]
           in
...
let boxTerm : sort -> term -> term =
  fun sort  ->
    fun t  ->
      ...
      | Ref_sort  -> boxRef t
      | uu____3286 -> Prims.raise FStar_Util.Impos
...
let unboxTerm : sort -> term -> term =
  fun sort  ->
    fun t  ->
      ...
      | Ref_sort  -> unboxRef t
      | uu____3293 -> Prims.raise FStar_Util.Impos
  ...
  fun t  ->
    ...
    | App
        (Var
         "Prims.b2t",{
                       tm = App
                         (Var "Prims.op_Equality",uu____3301::t1::t2::[]);
    ...
    | App
        (Var
         "Prims.b2t",{
                       tm = App
                         (Var "Prims.op_disEquality",uu____3312::t1::t2::[]);
                       freevars = uu____3315; rng = uu____3316;_}::[])
        -> let uu____3323 = mkEq (t1, t2) norng  in mkNot uu____3323 t.rng
    | App
        (Var
        ...
        ->
        let uu____3334 =
          let uu____3337 = unboxInt t1  in
          let uu____3338 = unboxInt t2  in (uu____3337, uu____3338)  in
        mkLTE uu____3334 t.rng
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_LessThan",t1::t2::[]);
                       freevars = uu____3341; rng = uu____3342;_}::[])
        ->
        let uu____3349 =
          let uu____3352 = unboxInt t1  in
          let uu____3353 = unboxInt t2  in (uu____3352, uu____3353)  in
        mkLT uu____3349 t.rng
    | App
        (Var
         "Prims.b2t",{
                       tm = App
        ...
        ->
        let uu____3364 =
          let uu____3367 = unboxInt t1  in
          let uu____3368 = unboxInt t2  in (uu____3367, uu____3368)  in
        mkGTE uu____3364 t.rng
    | App
        (Var
    ...
    | App
        ...
        ->
        let uu____3394 =
          let uu____3397 = unboxBool t1  in
          let uu____3398 = unboxBool t2  in (uu____3397, uu____3398)  in
        mkAnd uu____3394 t.rng
    | App
        (Var
        ...
        ->
        let uu____3409 =
          let uu____3412 = unboxBool t1  in
          let uu____3413 = unboxBool t2  in (uu____3412, uu____3413)  in
        mkOr uu____3409 t.rng
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_Negation",t1::[]);
                       freevars = uu____3415; rng = uu____3416;_}::[])
        -> let uu____3423 = unboxBool t1  in mkNot uu____3423 t1.rng
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___96_3426 = unboxBool t1  in
        {
          tm = (uu___96_3426.tm);
          freevars = (uu___96_3426.freevars);
          rng = (t.rng)
        }
    | uu____3429 -> mkApp ("Valid", [t]) t.rng
...
let mk_HasTypeFuel : term -> term -> term -> term =
  fun f  ->
    fun v1  ->
      fun t  ->
        let uu____3458 = FStar_Options.unthrottle_inductives ()  in
        if uu____3458
...
let mk_String_const : Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____3522 =
        let uu____3526 = let uu____3528 = mkInteger' i norng  in [uu____3528]
           in
        ("FString_const", uu____3526)  in
      mkApp uu____3522 r
...
let mk_Precedes : term -> term -> FStar_Range.range -> term =
  fun x1  ->
    fun x2  ->
      fun r  ->
        let uu____3539 = mkApp ("Precedes", [x1; x2]) r  in
        FStar_All.pipe_right uu____3539 mk_Valid
...
let rec n_fuel : Prims.int -> term =
  fun n1  ->
    ...
    then mkApp ("ZFuel", []) norng
      ...
      (let uu____3556 =
         let uu____3560 =
           let uu____3562 = n_fuel (n1 - (Prims.parse_int "1"))  in
           [uu____3562]  in
         ("SFuel", uu____3560)  in
       mkApp uu____3556 norng)
  ...
  fun p1  ->
    fun p2  ->
      fun r  ->
        match (p1, p2) with
        | (Some p11,Some p21) ->
            let uu____3585 = mkAnd (p11, p21) r  in Some uu____3585
...
let mk_or_l : term Prims.list -> FStar_Range.range -> term =
  fun l  ->
    fun r  ->
      let uu____3629 = mkFalse r  in
      FStar_List.fold_right (fun p1  -> fun p2  -> mkOr (p1, p2) r) l
        uu____3629
  
let mk_haseq : term -> term =
  fun t  ->
    let uu____3635 = mkApp ("Prims.hasEq", [t]) t.rng  in mk_Valid uu____3635
...
let rec print_smt_term : term -> Prims.string =
  fun t  ->
    ...
    | BoundV n1 ->
        let uu____3649 = FStar_Util.string_of_int n1  in
        FStar_Util.format1 "(BoundV %s)" uu____3649
    | FreeV fv -> FStar_Util.format1 "(FreeV %s)" (Prims.fst fv)
    | App (op,l) ->
        let uu____3657 = print_smt_term_list l  in
        FStar_Util.format2 "(%s %s)" (op_to_string op) uu____3657
    | Labeled (t1,r1,r2) ->
        let uu____3661 = print_smt_term t1  in
        FStar_Util.format2 "(Labeled '%s' %s)" r1 uu____3661
    | LblPos (t1,s) ->
        let uu____3664 = print_smt_term t1  in
        FStar_Util.format2 "(LblPos %s %s)" s uu____3664
    | Quant (qop,l,uu____3667,uu____3668,t1) ->
        let uu____3678 = print_smt_term_list_list l  in
        let uu____3679 = print_smt_term t1  in
        FStar_Util.format3 "(%s %s %s)" (qop_to_string qop) uu____3678
          uu____3679
    | Let (es,body) ->
        let uu____3684 = print_smt_term_list es  in
        let uu____3685 = print_smt_term body  in
        FStar_Util.format2 "(let %s %s)" uu____3684 uu____3685

and print_smt_term_list : term Prims.list -> Prims.string =
  fun l  ->
    let uu____3688 = FStar_List.map print_smt_term l  in
    FStar_All.pipe_right uu____3688 (FStar_String.concat " ")
    ...
    FStar_List.fold_left
      (fun s  ->
         fun l1  ->
           let uu____3698 =
             let uu____3699 =
               let uu____3700 = print_smt_term_list l1  in
               Prims.strcat uu____3700 " ] "  in
             Prims.strcat "; [ " uu____3699  in
           Prims.strcat s uu____3698) "" l
