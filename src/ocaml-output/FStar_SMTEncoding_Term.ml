...
let (uu___is_TrueOp : op -> Prims.bool) =
  fun projectee -> match projectee with | TrueOp -> true | uu____154 -> false
...
let (uu___is_Minus : op -> Prims.bool) =
  fun projectee -> match projectee with | Minus -> true | uu____218 -> false
let (uu___is_Mod : op -> Prims.bool) =
  fun projectee -> match projectee with | Mod -> true | uu____222 -> false
let (uu___is_BvAnd : op -> Prims.bool) =
  fun projectee -> match projectee with | BvAnd -> true | uu____226 -> false
let (uu___is_BvXor : op -> Prims.bool) =
  fun projectee -> match projectee with | BvXor -> true | uu____230 -> false
...
let (uu___is_BvAdd : op -> Prims.bool) =
  fun projectee -> match projectee with | BvAdd -> true | uu____238 -> false
let (uu___is_BvSub : op -> Prims.bool) =
  fun projectee -> match projectee with | BvSub -> true | uu____242 -> false
let (uu___is_BvShl : op -> Prims.bool) =
  fun projectee -> match projectee with | BvShl -> true | uu____246 -> false
let (uu___is_BvShr : op -> Prims.bool) =
  fun projectee -> match projectee with | BvShr -> true | uu____250 -> false
let (uu___is_BvUdiv : op -> Prims.bool) =
  fun projectee -> match projectee with | BvUdiv -> true | uu____254 -> false
let (uu___is_BvMod : op -> Prims.bool) =
  fun projectee -> match projectee with | BvMod -> true | uu____258 -> false
let (uu___is_BvMul : op -> Prims.bool) =
  fun projectee -> match projectee with | BvMul -> true | uu____262 -> false
let (uu___is_BvUlt : op -> Prims.bool) =
  fun projectee -> match projectee with | BvUlt -> true | uu____266 -> false
...
let (uu___is_Var : op -> Prims.bool) =
  fun projectee -> match projectee with | Var _0 -> true | uu____303 -> false
...
let (uu___is_Forall : qop -> Prims.bool) =
  fun projectee -> match projectee with | Forall -> true | uu____314 -> false
let (uu___is_Exists : qop -> Prims.bool) =
  fun projectee -> match projectee with | Exists -> true | uu____318 -> false
type term' =
...
let (uu___is_Integer : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Integer _0 -> true | uu____488 -> false
...
let (uu___is_Let : term' -> Prims.bool) =
  fun projectee -> match projectee with | Let _0 -> true | uu____666 -> false
...
let (uu___is_LblPos : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | LblPos _0 -> true | uu____736 -> false
...
let (uu___is_Name : fact_db_id -> Prims.bool) =
  fun projectee ->
    match projectee with | Name _0 -> true | uu____973 -> false
let (__proj__Name__item___0 : fact_db_id -> FStar_Ident.lid) =
  fun projectee -> match projectee with | Name _0 -> _0
let (uu___is_Namespace : fact_db_id -> Prims.bool) =
  fun projectee ->
    match projectee with | Namespace _0 -> true | uu____985 -> false
let (__proj__Namespace__item___0 : fact_db_id -> FStar_Ident.lid) =
  fun projectee -> match projectee with | Namespace _0 -> _0
let (uu___is_Tag : fact_db_id -> Prims.bool) =
  fun projectee -> match projectee with | Tag _0 -> true | uu____997 -> false
...
let (uu___is_DefPrelude : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | DefPrelude -> true | uu____1126 -> false
let (uu___is_DeclFun : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | DeclFun _0 -> true | uu____1141 -> false
...
let (uu___is_DefineFun : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | DefineFun _0 -> true | uu____1195 -> false
...
let (uu___is_Assume : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | Assume _0 -> true | uu____1243 -> false
let (__proj__Assume__item___0 : decl -> assumption) =
  fun projectee -> match projectee with | Assume _0 -> _0
let (uu___is_Caption : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | Caption _0 -> true | uu____1255 -> false
let (__proj__Caption__item___0 : decl -> Prims.string) =
  fun projectee -> match projectee with | Caption _0 -> _0
let (uu___is_Eval : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | Eval _0 -> true | uu____1267 -> false
let (__proj__Eval__item___0 : decl -> term) =
  fun projectee -> match projectee with | Eval _0 -> _0
let (uu___is_Echo : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | Echo _0 -> true | uu____1279 -> false
let (__proj__Echo__item___0 : decl -> Prims.string) =
  fun projectee -> match projectee with | Echo _0 -> _0
let (uu___is_RetainAssumptions : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | RetainAssumptions _0 -> true | uu____1293 -> false
let (__proj__RetainAssumptions__item___0 : decl -> Prims.string Prims.list) =
  fun projectee -> match projectee with | RetainAssumptions _0 -> _0
let (uu___is_Push : decl -> Prims.bool) =
  fun projectee -> match projectee with | Push -> true | uu____1310 -> false
let (uu___is_Pop : decl -> Prims.bool) =
  fun projectee -> match projectee with | Pop -> true | uu____1314 -> false
let (uu___is_CheckSat : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | CheckSat -> true | uu____1318 -> false
let (uu___is_GetUnsatCore : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | GetUnsatCore -> true | uu____1322 -> false
let (uu___is_SetOption : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | SetOption _0 -> true | uu____1331 -> false
let (__proj__SetOption__item___0 :
  decl -> (Prims.string, Prims.string) FStar_Pervasives_Native.tuple2) =
  fun projectee -> match projectee with | SetOption _0 -> _0
let (uu___is_GetStatistics : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | GetStatistics -> true | uu____1354 -> false
let (uu___is_GetReasonUnknown : decl -> Prims.bool) =
  fun projectee ->
    match projectee with | GetReasonUnknown -> true | uu____1358 -> false
...
let fv_sort :
  'Auu____1378 'Auu____1379 .
    ('Auu____1378, 'Auu____1379) FStar_Pervasives_Native.tuple2 ->
      'Auu____1379
...
let (freevar_sort : term -> sort) =
  fun uu___49_1415 ->
    match uu___49_1415 with
    | { tm = FreeV x; freevars = uu____1417; rng = uu____1418;_} -> fv_sort x
    | uu____1431 -> failwith "impossible"
let (fv_of_term : term -> fv) =
  fun uu___50_1434 ->
    match uu___50_1434 with
    | { tm = FreeV fv; freevars = uu____1436; rng = uu____1437;_} -> fv
    | uu____1450 -> failwith "impossible"
let rec (freevars :
  ...
  fun t ->
    ...
    | BoundV uu____1471 -> []
    | FreeV fv -> [fv]
    | App (uu____1489, tms) -> FStar_List.collect freevars tms
    | Quant (uu____1499, uu____1500, uu____1501, uu____1502, t1) ->
        freevars t1
    | Labeled (t1, uu____1521, uu____1522) -> freevars t1
    | LblPos (t1, uu____1524) -> freevars t1
    | Let (es, body) -> FStar_List.collect freevars (body :: es)
let (free_variables : term -> fvs) =
  fun t ->
    let uu____1538 = FStar_ST.op_Bang t.freevars in
    match uu____1538 with
    | FStar_Pervasives_Native.Some b -> b
    | FStar_Pervasives_Native.None ->
        let fvs =
          let uu____1610 = freevars t in
          FStar_Util.remove_dups fv_eq uu____1610 in
        (FStar_ST.op_Colon_Equals t.freevars
           (FStar_Pervasives_Native.Some fvs);
         fvs)
let (qop_to_string : qop -> Prims.string) =
  fun uu___51_1659 ->
    match uu___51_1659 with | Forall -> "forall" | Exists -> "exists"
let (op_to_string : op -> Prims.string) =
  fun uu___52_1662 ->
    match uu___52_1662 with
    | TrueOp -> "true"
    | FalseOp -> "false"
    | Not -> "not"
    | And -> "and"
    ...
    | BvUext n1 ->
        ...
        FStar_Util.format1 "(_ zero_extend %s)" uu____1664
    | NatToBv n1 ->
        let uu____1666 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "(_ int2bv %s)" uu____1666
    | Var s -> s
let (weightToSmt : Prims.int FStar_Pervasives_Native.option -> Prims.string)
  =
  fun uu___53_1672 ->
    match uu___53_1672 with
    | FStar_Pervasives_Native.None -> ""
    | FStar_Pervasives_Native.Some i ->
        let uu____1676 = FStar_Util.string_of_int i in
...
let rec (hash_of_term' : term' -> Prims.string) =
  fun t ->
    ...
    | Integer i -> i
    | BoundV i ->
        let uu____1684 = FStar_Util.string_of_int i in
        Prims.strcat "@" uu____1684
    | FreeV x ->
        let uu____1690 =
          let uu____1691 = strSort (FStar_Pervasives_Native.snd x) in
          Prims.strcat ":" uu____1691 in
        Prims.strcat (FStar_Pervasives_Native.fst x) uu____1690
    | App (op, tms) ->
        let uu____1698 =
          let uu____1699 = op_to_string op in
          let uu____1700 =
            let uu____1701 =
              let uu____1702 = FStar_List.map hash_of_term tms in
              FStar_All.pipe_right uu____1702 (FStar_String.concat " ") in
            Prims.strcat uu____1701 ")" in
          Prims.strcat uu____1699 uu____1700 in
        Prims.strcat "(" uu____1698
    | Labeled (t1, r1, r2) ->
        let uu____1710 = hash_of_term t1 in
        let uu____1711 =
          let uu____1712 = FStar_Range.string_of_range r2 in
          Prims.strcat r1 uu____1712 in
        Prims.strcat uu____1710 uu____1711
    | LblPos (t1, r) ->
        let uu____1715 =
          let uu____1716 = hash_of_term t1 in
          Prims.strcat uu____1716
            (Prims.strcat " :lblpos " (Prims.strcat r ")")) in
        Prims.strcat "(! " uu____1715
    | Quant (qop, pats, wopt, sorts, body) ->
        let uu____1738 =
          let uu____1739 =
            let uu____1740 =
              let uu____1741 =
                let uu____1742 = FStar_List.map strSort sorts in
                FStar_All.pipe_right uu____1742 (FStar_String.concat " ") in
              let uu____1747 =
                let uu____1748 =
                  let uu____1749 = hash_of_term body in
                  let uu____1750 =
                    let uu____1751 =
                      let uu____1752 = weightToSmt wopt in
                      let uu____1753 =
                        let uu____1754 =
                          let uu____1755 =
                            let uu____1756 =
                        ...
                        Prims.strcat " " uu____1754 in
                      Prims.strcat uu____1752 uu____1753 in
                    Prims.strcat " " uu____1751 in
                  Prims.strcat uu____1749 uu____1750 in
                Prims.strcat ")(! " uu____1748 in
              Prims.strcat uu____1741 uu____1747 in
            Prims.strcat " (" uu____1740 in
          Prims.strcat (qop_to_string qop) uu____1739 in
        Prims.strcat "(" uu____1738
    | Let (es, body) ->
        let uu____1785 =
          let uu____1786 =
            let uu____1787 = FStar_List.map hash_of_term es in
            FStar_All.pipe_right uu____1787 (FStar_String.concat " ") in
          let uu____1792 =
            let uu____1793 =
              let uu____1794 = hash_of_term body in
              Prims.strcat uu____1794 ")" in
            Prims.strcat ") " uu____1793 in
          Prims.strcat uu____1786 uu____1792 in
        Prims.strcat "(let (" uu____1785
...
let (boxBitVecFun :
  ...
  fun sz ->
    let uu____1822 =
      let uu____1823 = FStar_Util.string_of_int sz in
      Prims.strcat "BoxBitVec" uu____1823 in
    mkBoxFunctions uu____1822
  ...
  fun s ->
    ...
    then
      (let uu____1829 =
       ...
       uu____1829 = "Box") &&
        (let uu____1831 =
           let uu____1832 = FStar_String.list_of_string s in
           FStar_List.existsML (fun c -> c = 46) uu____1832 in
         Prims.op_Negation uu____1831)
    else false
let (mk : term' -> FStar_Range.range -> term) =
  fun t ->
    fun r ->
      let uu____1849 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
      { tm = t; freevars = uu____1849; rng = r }
...
let (mkInteger : Prims.string -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____1958 =
        let uu____1959 = FStar_Util.ensure_decimal i in Integer uu____1959 in
      mk uu____1958 r
let (mkInteger' : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____1966 = FStar_Util.string_of_int i in mkInteger uu____1966 r
...
let (mkApp :
  ...
  =
  fun uu____2015 ->
    fun r -> match uu____2015 with | (s, args) -> mk (App ((Var s), args)) r
let (mkNot : term -> FStar_Range.range -> term) =
  fun t ->
    fun r ->
      match t.tm with
      | App (TrueOp, uu____2037) -> mkFalse r
      | App (FalseOp, uu____2042) -> mkTrue r
      | uu____2047 -> mkApp' (Not, [t]) r
let (mkAnd :
    ...
    fun r ->
      ...
      | (t1, t2) ->
          (match ((t1.tm), (t2.tm)) with
           | (App (TrueOp, uu____2066), uu____2067) -> t2
           | (uu____2072, App (TrueOp, uu____2073)) -> t1
           | (App (FalseOp, uu____2078), uu____2079) -> mkFalse r
           | (uu____2084, App (FalseOp, uu____2085)) -> mkFalse r
           | (App (And, ts1), App (And, ts2)) ->
               mkApp' (And, (FStar_List.append ts1 ts2)) r
           | (uu____2102, App (And, ts2)) -> mkApp' (And, (t1 :: ts2)) r
           | (App (And, ts1), uu____2111) ->
               mkApp' (And, (FStar_List.append ts1 [t2])) r
           | uu____2118 -> mkApp' (And, [t1; t2]) r)
let (mkOr :
  (term, term) FStar_Pervasives_Native.tuple2 -> FStar_Range.range -> term) =
  fun uu____2133 ->
    fun r ->
      ...
      | (t1, t2) ->
          (match ((t1.tm), (t2.tm)) with
           | (App (TrueOp, uu____2141), uu____2142) -> mkTrue r
           | (uu____2147, App (TrueOp, uu____2148)) -> mkTrue r
           | (App (FalseOp, uu____2153), uu____2154) -> t2
           | (uu____2159, App (FalseOp, uu____2160)) -> t1
           | (App (Or, ts1), App (Or, ts2)) ->
               mkApp' (Or, (FStar_List.append ts1 ts2)) r
           | (uu____2177, App (Or, ts2)) -> mkApp' (Or, (t1 :: ts2)) r
           | (App (Or, ts1), uu____2186) ->
               mkApp' (Or, (FStar_List.append ts1 [t2])) r
           | uu____2193 -> mkApp' (Or, [t1; t2]) r)
let (mkImp :
  (term, term) FStar_Pervasives_Native.tuple2 -> FStar_Range.range -> term) =
  fun uu____2208 ->
    fun r ->
      ...
      | (t1, t2) ->
          (match ((t1.tm), (t2.tm)) with
           | (uu____2216, App (TrueOp, uu____2217)) -> mkTrue r
           | (App (FalseOp, uu____2222), uu____2223) -> mkTrue r
           | (App (TrueOp, uu____2228), uu____2229) -> t2
           | (uu____2234, App (Imp, t1'::t2'::[])) ->
               let uu____2239 =
                 let uu____2246 =
                   let uu____2249 = mkAnd (t1, t1') r in [uu____2249; t2'] in
                 (Imp, uu____2246) in
               mkApp' uu____2239 r
           | uu____2252 -> mkApp' (Imp, [t1; t2]) r)
let (mk_bin_op :
  op ->
    (term, term) FStar_Pervasives_Native.tuple2 -> FStar_Range.range -> term)
  =
  fun op ->
    fun uu____2270 ->
      fun r -> match uu____2270 with | (t1, t2) -> mkApp' (op, [t1; t2]) r
      ...
      fun r ->
        ...
        | (t1, t2) ->
            let uu____2377 =
              let uu____2384 =
                let uu____2387 =
                  let uu____2390 = mkNatToBv sz t2 r in [uu____2390] in
                t1 :: uu____2387 in
              (BvShl, uu____2384) in
            mkApp' uu____2377 r
let (mkBvShr :
      ...
      fun r ->
        ...
        | (t1, t2) ->
            let uu____2412 =
              let uu____2419 =
                let uu____2422 =
                  let uu____2425 = mkNatToBv sz t2 r in [uu____2425] in
                t1 :: uu____2422 in
              (BvShr, uu____2419) in
            mkApp' uu____2412 r
let (mkBvUdiv :
      ...
      fun r ->
        ...
        | (t1, t2) ->
            let uu____2447 =
              let uu____2454 =
                let uu____2457 =
                  let uu____2460 = mkNatToBv sz t2 r in [uu____2460] in
                t1 :: uu____2457 in
              (BvUdiv, uu____2454) in
            mkApp' uu____2447 r
let (mkBvMod :
  Prims.int ->
    (term, term) FStar_Pervasives_Native.tuple2 -> FStar_Range.range -> term)
      ...
      fun r ->
        ...
        | (t1, t2) ->
            let uu____2482 =
              let uu____2489 =
                let uu____2492 =
                  let uu____2495 = mkNatToBv sz t2 r in [uu____2495] in
                t1 :: uu____2492 in
              (BvMod, uu____2489) in
            mkApp' uu____2482 r
let (mkBvMul :
      ...
      fun r ->
        ...
        | (t1, t2) ->
            let uu____2517 =
              let uu____2524 =
                let uu____2527 =
                  let uu____2530 = mkNatToBv sz t2 r in [uu____2530] in
                t1 :: uu____2527 in
              (BvMul, uu____2524) in
            mkApp' uu____2517 r
let (mkBvUlt :
    ...
    fun r ->
      ...
      | (t1, t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | uu____2573 -> mk_bin_op Eq (t1, t2) r)
let (mkLT :
  (term, term) FStar_Pervasives_Native.tuple2 -> FStar_Range.range -> term) =
  mk_bin_op LT
let (mkLTE :
...
let (mkITE :
  ...
  fun uu____2660 ->
    fun r ->
      ...
      | (t1, t2, t3) ->
          (match t1.tm with
           | App (TrueOp, uu____2671) -> t2
           | App (FalseOp, uu____2676) -> t3
           | uu____2681 ->
               (match ((t2.tm), (t3.tm)) with
                | (App (TrueOp, uu____2682), App (TrueOp, uu____2683)) ->
                    mkTrue r
                | (App (TrueOp, uu____2692), uu____2693) ->
                    let uu____2698 =
                      let uu____2703 = mkNot t1 t1.rng in (uu____2703, t3) in
                    mkImp uu____2698 r
                | (uu____2704, App (TrueOp, uu____2705)) -> mkImp (t1, t2) r
                | (uu____2710, uu____2711) -> mkApp' (ITE, [t1; t2; t3]) r))
    ...
    fun r ->
      ...
      | (qop, pats, wopt, vars, body) ->
          ...
          then body
            ...
            (match body.tm with
             | App (TrueOp, uu____2796) -> body
             | uu____2801 -> mk (Quant (qop, pats, wopt, vars, body)) r)
let (mkLet :
...
let (abstr : fv Prims.list -> term -> term) =
  fun fvs ->
    fun t ->
      ...
      let index_of fv =
        let uu____2854 = FStar_Util.try_find_index (fv_eq fv) fvs in
      ...
      let rec aux ix t1 =
        let uu____2873 = FStar_ST.op_Bang t1.freevars in
        match uu____2873 with
        | FStar_Pervasives_Native.Some [] -> t1
        | uu____2933 ->
            (match t1.tm with
             | Integer uu____2942 -> t1
             | BoundV uu____2943 -> t1
             | FreeV x ->
                 let uu____2949 = index_of x in
             ...
             | App (op, tms) ->
                 let uu____2959 =
                   let uu____2966 = FStar_List.map (aux ix) tms in
                   (op, uu____2966) in
                 mkApp' uu____2959 t1.rng
             | Labeled (t2, r1, r2) ->
                 let uu____2974 =
                   let uu____2975 =
                     let uu____2982 = aux ix t2 in (uu____2982, r1, r2) in
                   Labeled uu____2975 in
                 mk uu____2974 t2.rng
             | LblPos (t2, r) ->
                 let uu____2985 =
                   let uu____2986 =
                     let uu____2991 = aux ix t2 in (uu____2991, r) in
                   LblPos uu____2986 in
                 mk uu____2985 t2.rng
             | Quant (qop, pats, wopt, vars, body) ->
                 ...
                 let uu____3014 =
                   ...
                   let uu____3054 = aux (ix + n1) body in
                   (qop, uu____3033, wopt, vars, uu____3054) in
                 mkQuant uu____3014 t1.rng
             | Let (es, body) ->
                 let uu____3073 =
                   FStar_List.fold_left
                     (fun uu____3091 ->
                        fun e ->
                          ...
                          | (ix1, l) ->
                              let uu____3111 =
                                let uu____3114 = aux ix1 e in uu____3114 :: l in
                              ((ix1 + (Prims.parse_int "1")), uu____3111))
                     (ix, []) es in
                 (match uu____3073 with
                  | (ix1, es_rev) ->
                      let uu____3125 =
                        let uu____3132 = aux ix1 body in
                        ((FStar_List.rev es_rev), uu____3132) in
                      mkLet uu____3125 t1.rng)) in
  ...
  fun tms ->
    fun t ->
      ...
      let rec aux shift t1 =
        ...
        | App (op, tms2) ->
            let uu____3174 =
              let uu____3181 = FStar_List.map (aux shift) tms2 in
              (op, uu____3181) in
            mkApp' uu____3174 t1.rng
        | Labeled (t2, r1, r2) ->
            let uu____3189 =
              let uu____3190 =
                let uu____3197 = aux shift t2 in (uu____3197, r1, r2) in
              Labeled uu____3190 in
            mk uu____3189 t2.rng
        | LblPos (t2, r) ->
            let uu____3200 =
              let uu____3201 =
                let uu____3206 = aux shift t2 in (uu____3206, r) in
        ...
        | Quant (qop, pats, wopt, vars, body) ->
            ...
            let uu____3234 =
              ...
              let uu____3270 = aux shift1 body in
              (qop, uu____3253, wopt, vars, uu____3270) in
            mkQuant uu____3234 t1.rng
        | Let (es, body) ->
            let uu____3285 =
              FStar_List.fold_left
                (fun uu____3303 ->
                   fun e ->
                     ...
                     | (ix, es1) ->
                         let uu____3323 =
                           let uu____3326 = aux shift e in uu____3326 :: es1 in
                         ((shift + (Prims.parse_int "1")), uu____3323))
                (shift, []) es in
            (match uu____3285 with
             | (shift1, es_rev) ->
                 let uu____3337 =
                   let uu____3344 = aux shift1 body in
                   ((FStar_List.rev es_rev), uu____3344) in
                 mkLet uu____3337 t1.rng) in
      aux (Prims.parse_int "0") t
let (subst : term -> fv -> term -> term) =
  fun t ->
    fun fv -> fun s -> let uu____3356 = abstr [fv] t in inst [s] uu____3356
let (mkQuant' :
  (qop, term Prims.list Prims.list, Prims.int FStar_Pervasives_Native.option,
  ...
  fun uu____3379 ->
    ...
    | (qop, pats, wopt, vars, body) ->
        let uu____3421 =
          ...
          let uu____3457 = FStar_List.map fv_sort vars in
          let uu____3464 = abstr vars body in
          (qop, uu____3440, wopt, uu____3457, uu____3464) in
        mkQuant uu____3421
let (mkForall'' :
...
let (mkLet' :
  ...
  fun uu____3704 ->
    fun r ->
      ...
      | (bindings, body) ->
          let uu____3730 = FStar_List.split bindings in
          (match uu____3730 with
           | (vars, es) ->
               let uu____3749 =
                 let uu____3756 = abstr vars body in (es, uu____3756) in
               mkLet uu____3749 r)
...
let (mkDefineFun :
  ...
  fun uu____3777 ->
    ...
    | (nm, vars, s, tm, c) ->
        let uu____3811 =
          let uu____3824 = FStar_List.map fv_sort vars in
          let uu____3831 = abstr vars tm in
          (nm, uu____3824, s, uu____3831, c) in
        DefineFun uu____3811
let (constr_id_of_sort : sort -> Prims.string) =
  fun sort ->
    let uu____3837 = strSort sort in
    FStar_Util.format1 "%s_constr_id" uu____3837
let (fresh_token :
    ...
    fun id1 ->
      ...
      | (tok_name, sort) ->
          ...
          let a =
            let uu____3856 =
              let uu____3857 =
                let uu____3862 = mkInteger' id1 norng in
                let uu____3863 =
                  let uu____3864 =
                    let uu____3871 = constr_id_of_sort sort in
                    let uu____3872 =
                      let uu____3875 = mkApp (tok_name, []) norng in
                      [uu____3875] in
                    (uu____3871, uu____3872) in
                  mkApp uu____3864 norng in
                (uu____3862, uu____3863) in
              mkEq uu____3857 norng in
            {
              assumption_term = uu____3856;
              assumption_caption =
            ...
            (FStar_List.mapi
               (fun i ->
                  fun s ->
                    let uu____3924 =
                      let uu____3929 =
                        let uu____3930 = FStar_Util.string_of_int i in
                        Prims.strcat "x_" uu____3930 in
                      (uu____3929, s) in
                    mkFreeV uu____3924 norng)) in
        let bvar_names = FStar_List.map fv_of_term bvars in
        let capp = mkApp (name, bvars) norng in
        let cid_app =
          let uu____3938 =
            let uu____3945 = constr_id_of_sort sort in (uu____3945, [capp]) in
          mkApp uu____3938 norng in
        ...
        let a =
          let uu____3950 =
            let uu____3951 =
              let uu____3962 =
                let uu____3963 =
                  let uu____3968 = mkInteger id2 norng in
                  (uu____3968, cid_app) in
                mkEq uu____3963 norng in
              ([[capp]], bvar_names, uu____3962) in
            mkForall uu____3951 norng in
          {
            assumption_term = uu____3950;
            assumption_caption =
...
let (injective_constructor :
  ...
  fun uu____3989 ->
    ...
    | (name, fields, sort) ->
        ...
        let bvar i s =
          let uu____4030 = let uu____4035 = bvar_name i in (uu____4035, s) in
          mkFreeV uu____4030 in
        let bvars =
            ...
            (FStar_List.mapi
               (fun i ->
                  fun uu____4056 ->
                    ...
                    | (uu____4063, s, uu____4065) ->
                        let uu____4066 = bvar i s in uu____4066 norng)) in
        let bvar_names = FStar_List.map fv_of_term bvars in
        let capp = mkApp (name, bvars) norng in
        let uu____4075 =
          FStar_All.pipe_right fields
                            ...
                            let uu____4126 =
                              let uu____4127 =
                                let uu____4138 =
                                  let uu____4139 =
                                    let uu____4144 =
                                      let uu____4145 = bvar i s in
                                      uu____4145 norng in
                                    (cproj_app, uu____4144) in
                                  mkEq uu____4139 norng in
                                ([[capp]], bvar_names, uu____4138) in
                              mkForall uu____4127 norng in
                            {
        ...
        FStar_All.pipe_right uu____4075 FStar_List.flatten
let (constructor_to_decl : constructor_t -> decls_t) =
  fun uu____4167 ->
    ...
    | (name, fields, sort, id1, injective) ->
          ...
          FStar_All.pipe_right fields
            (FStar_List.map
               (fun uu____4195 ->
                  ...
                  | (uu____4202, sort1, uu____4204) -> sort1)) in
        let cdecl =
          DeclFun
        ...
        let disc =
          ...
          let disc_eq =
            let uu____4222 =
              let uu____4227 =
                let uu____4228 =
                  let uu____4235 = constr_id_of_sort sort in
                  (uu____4235, [xx]) in
                mkApp uu____4228 norng in
              let uu____4238 =
                let uu____4239 = FStar_Util.string_of_int id1 in
                mkInteger uu____4239 norng in
              (uu____4227, uu____4238) in
            mkEq uu____4222 norng in
          let uu____4240 =
            let uu____4255 =
              FStar_All.pipe_right fields
                (FStar_List.mapi
                   (fun i ->
                      fun uu____4305 ->
                        ...
                        | (proj, s, projectible) ->
                            if projectible
                            then
                              let uu____4335 = mkApp (proj, [xx]) norng in
                              (uu____4335, [])
                            else
                              (let fi =
                                 let uu____4354 =
                                   ...
                                   Prims.strcat "f_" uu____4355 in
                                 (uu____4354, s) in
                               let uu____4356 = mkFreeV fi norng in
                               (uu____4356, [fi])))) in
            FStar_All.pipe_right uu____4255 FStar_List.split in
          match uu____4240 with
          | (proj_terms, ex_vars) ->
              let ex_vars1 = FStar_List.flatten ex_vars in
              let disc_inv_body =
                let uu____4437 =
                  let uu____4442 = mkApp (name, proj_terms) norng in
                  (xx, uu____4442) in
                mkEq uu____4437 norng in
              let disc_inv_body1 =
                match ex_vars1 with
                | [] -> disc_inv_body
                | uu____4450 -> mkExists ([], ex_vars1, disc_inv_body) norng in
        ...
        let uu____4491 =
          let uu____4494 =
            let uu____4495 = FStar_Util.format1 "<start constructor %s>" name in
            Caption uu____4495 in
          uu____4494 :: cdecl :: cid :: projs in
        let uu____4496 =
          let uu____4499 =
            let uu____4502 =
              let uu____4503 =
                FStar_Util.format1 "</end constructor %s>" name in
              Caption uu____4503 in
            [uu____4502] in
          FStar_List.append [disc] uu____4499 in
        FStar_List.append uu____4491 uu____4496
                 ...
                 (fun uu____4605 ->
                    fun s ->
                      ...
                      | (names1, binders, n1) ->
                          ...
                          let nm =
                            let uu____4659 = FStar_Util.string_of_int n1 in
                            Prims.strcat prefix2 uu____4659 in
                          let names2 = (nm, s) :: names1 in
                          let b =
                            let uu____4672 = strSort s in
                            FStar_Util.format2 "(%s %s)" nm uu____4672 in
                          (names2, (b :: binders),
          ...
          fun depth ->
            ...
            then enclosing_name
              ...
              (let uu____5030 = FStar_Util.string_of_int n1 in
               FStar_Util.format2 "%s.%s" enclosing_name uu____5030) in
                       ...
                       (fun tm ->
                          ...
                          | App
                              (Var "Prims.guard_free",
                               { tm = BoundV uu____5072;
                                 freevars = uu____5073; rng = uu____5074;_}::[])
                              -> tm
                                ...
                                (fun pats2 ->
                                   let uu____5248 =
                                     let uu____5249 =
                                       FStar_List.map
                                         (fun p ->
                                            let uu____5255 = aux1 n2 names2 p in
      ...
      fun decl ->
            ...
            then
              let uu____5476 =
                FStar_All.pipe_right (FStar_Util.splitlines c)
                  (fun uu___55_5480 ->
                     match uu___55_5480 with | [] -> "" | h::t -> h) in
              FStar_Util.format1 "\n; %s" uu____5476
            else ""
        ...
        | Assume a ->
            ...
            let fids =
              ...
              then
                let uu____5581 =
                  let uu____5582 = fact_ids_to_string a.assumption_fact_ids in
...
let (mk_Range_const : Prims.unit -> term) =
  fun uu____6063 ->
    ...
    (let uu____6091 =
       let uu____6092 = FStar_ST.op_Bang __range_c in
       uu____6092 + (Prims.parse_int "1") in
     FStar_ST.op_Colon_Equals __range_c uu____6091);
    (let uu____6143 =
       let uu____6150 = let uu____6153 = mkInteger' i norng in [uu____6153] in
       ("Range_const", uu____6150) in
     mkApp uu____6143 norng)
...
let (mk_Term_uvar : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____6175 =
        let uu____6182 = let uu____6185 = mkInteger' i norng in [uu____6185] in
        ("Tm_uvar", uu____6182) in
      mkApp uu____6175 r
    ...
    fun u ->
      fun v1 ->
        fun t ->
          ...
          | uu____6206 -> mkApp (u, [t]) t.rng
let (maybe_elim_box : Prims.string -> Prims.string -> term -> term) =
  fun u ->
    fun v1 ->
      fun t ->
        let uu____6218 = FStar_Options.smtencoding_elim_box () in
        elim_box uu____6218 u v1 t
...
let (boxBitVec : Prims.int -> term -> term) =
  fun sz ->
    fun t ->
      let uu____6243 =
        let uu____6244 = boxBitVecFun sz in
        FStar_Pervasives_Native.fst uu____6244 in
      let uu____6249 =
        let uu____6250 = boxBitVecFun sz in
        FStar_Pervasives_Native.snd uu____6250 in
      elim_box true uu____6243 uu____6249 t
let (unboxBitVec : Prims.int -> term -> term) =
  fun sz ->
    fun t ->
      let uu____6261 =
        let uu____6262 = boxBitVecFun sz in
        FStar_Pervasives_Native.snd uu____6262 in
      let uu____6267 =
        let uu____6268 = boxBitVecFun sz in
        FStar_Pervasives_Native.fst uu____6268 in
      elim_box true uu____6261 uu____6267 t
let (boxTerm : sort -> term -> term) =
  fun sort ->
    fun t ->
      ...
      | uu____6280 -> FStar_Exn.raise FStar_Util.Impos
let (unboxTerm : sort -> term -> term) =
  fun sort ->
    fun t ->
      ...
      | uu____6288 -> FStar_Exn.raise FStar_Util.Impos
let rec (print_smt_term : term -> Prims.string) =
  fun t ->
    match t.tm with
    | Integer n1 -> FStar_Util.format1 "(Integer %s)" n1
    | BoundV n1 ->
        let uu____6304 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "(BoundV %s)" uu____6304
    | FreeV fv ->
        FStar_Util.format1 "(FreeV %s)" (FStar_Pervasives_Native.fst fv)
    | App (op, l) ->
        let uu____6316 = op_to_string op in
        let uu____6317 = print_smt_term_list l in
        FStar_Util.format2 "(%s %s)" uu____6316 uu____6317
    | Labeled (t1, r1, r2) ->
        let uu____6321 = print_smt_term t1 in
        FStar_Util.format2 "(Labeled '%s' %s)" r1 uu____6321
    | LblPos (t1, s) ->
        let uu____6324 = print_smt_term t1 in
        FStar_Util.format2 "(LblPos %s %s)" s uu____6324
    | Quant (qop, l, uu____6327, uu____6328, t1) ->
        let uu____6346 = print_smt_term_list_list l in
        let uu____6347 = print_smt_term t1 in
        FStar_Util.format3 "(%s %s %s)" (qop_to_string qop) uu____6346
          uu____6347
    | Let (es, body) ->
        let uu____6354 = print_smt_term_list es in
        let uu____6355 = print_smt_term body in
        FStar_Util.format2 "(let %s %s)" uu____6354 uu____6355
and (print_smt_term_list : term Prims.list -> Prims.string) =
  fun l ->
    let uu____6359 = FStar_List.map print_smt_term l in
    FStar_All.pipe_right uu____6359 (FStar_String.concat " ")
    ...
    FStar_List.fold_left
      (fun s ->
         fun l1 ->
           let uu____6378 =
             let uu____6379 =
               let uu____6380 = print_smt_term_list l1 in
               Prims.strcat uu____6380 " ] " in
             Prims.strcat "; [ " uu____6379 in
           Prims.strcat s uu____6378) "" l
let (getBoxedInteger : term -> Prims.int FStar_Pervasives_Native.option) =
  fun t ->
    ...
    | App (Var s, t2::[]) when s = (FStar_Pervasives_Native.fst boxIntFun) ->
        (match t2.tm with
         | Integer n1 ->
             let uu____6395 = FStar_Util.int_of_string n1 in
             FStar_Pervasives_Native.Some uu____6395
         | uu____6396 -> FStar_Pervasives_Native.None)
    | uu____6397 -> FStar_Pervasives_Native.None
...
let (mk_Valid : term -> term) =
  fun t ->
    ...
    | App
        (Var "Prims.b2p",
         { tm = App (Var "Prims.op_Equality", uu____6406::t1::t2::[]);
           freevars = uu____6409; rng = uu____6410;_}::[])
        -> mkEq (t1, t2) t.rng
    | App
        (Var "Prims.b2p",
         { tm = App (Var "Prims.op_disEquality", uu____6423::t1::t2::[]);
           freevars = uu____6426; rng = uu____6427;_}::[])
        -> let uu____6440 = mkEq (t1, t2) norng in mkNot uu____6440 t.rng
    | App
        (Var "Prims.b2p",
         { tm = App (Var "Prims.op_LessThanOrEqual", t1::t2::[]);
           freevars = uu____6443; rng = uu____6444;_}::[])
        ->
        let uu____6457 =
          let uu____6462 = unboxInt t1 in
          let uu____6463 = unboxInt t2 in (uu____6462, uu____6463) in
        mkLTE uu____6457 t.rng
    | App
        (Var "Prims.b2p",
         { tm = App (Var "Prims.op_LessThan", t1::t2::[]);
           freevars = uu____6466; rng = uu____6467;_}::[])
        ->
        let uu____6480 =
          let uu____6485 = unboxInt t1 in
          let uu____6486 = unboxInt t2 in (uu____6485, uu____6486) in
        mkLT uu____6480 t.rng
    | App
        (Var "Prims.b2p",
        ...
        ->
        let uu____6503 =
          let uu____6508 = unboxInt t1 in
          let uu____6509 = unboxInt t2 in (uu____6508, uu____6509) in
        mkGTE uu____6503 t.rng
    | App
        (Var "Prims.b2p",
        ...
        ->
        let uu____6526 =
          let uu____6531 = unboxInt t1 in
          let uu____6532 = unboxInt t2 in (uu____6531, uu____6532) in
        mkGT uu____6526 t.rng
    | App
        (Var "Prims.b2p",
        ...
        ->
        let uu____6549 =
          let uu____6554 = unboxBool t1 in
          let uu____6555 = unboxBool t2 in (uu____6554, uu____6555) in
        mkAnd uu____6549 t.rng
    | App
        (Var "Prims.b2p",
        ...
        ->
        let uu____6572 =
          let uu____6577 = unboxBool t1 in
          let uu____6578 = unboxBool t2 in (uu____6577, uu____6578) in
        mkOr uu____6572 t.rng
    | App
        (Var "Prims.b2p",
         { tm = App (Var "Prims.op_Negation", t1::[]); freevars = uu____6580;
           rng = uu____6581;_}::[])
        -> let uu____6594 = unboxBool t1 in mkNot uu____6594 t1.rng
    | App
        (Var "Prims.b2p",
         { tm = App (Var "FStar.BV.bvult", t0::t1::t2::[]);
           freevars = uu____6598; rng = uu____6599;_}::[])
        when
        let uu____6612 = getBoxedInteger t0 in FStar_Util.is_some uu____6612
        ->
        let sz =
          let uu____6616 = getBoxedInteger t0 in
          match uu____6616 with
          | FStar_Pervasives_Native.Some sz -> sz
          | uu____6620 -> failwith "impossible" in
        let uu____6623 =
          let uu____6628 = unboxBitVec sz t1 in
          let uu____6629 = unboxBitVec sz t2 in (uu____6628, uu____6629) in
        mkBvUlt uu____6623 t.rng
    | App
        (Var "Prims.equals",
         uu____6630::{ tm = App (Var "FStar.BV.bvult", t0::t1::t2::[]);
                       freevars = uu____6634; rng = uu____6635;_}::uu____6636::[])
        when
        let uu____6649 = getBoxedInteger t0 in FStar_Util.is_some uu____6649
        ->
        let sz =
          let uu____6653 = getBoxedInteger t0 in
          match uu____6653 with
          | FStar_Pervasives_Native.Some sz -> sz
          | uu____6657 -> failwith "impossible" in
        let uu____6660 =
          let uu____6665 = unboxBitVec sz t1 in
          let uu____6666 = unboxBitVec sz t2 in (uu____6665, uu____6666) in
        mkBvUlt uu____6660 t.rng
    | App (Var "Prims.b2p", t1::[]) ->
        let uu___57_6670 = unboxBool t1 in
        {
          tm = (uu___57_6670.tm);
          freevars = (uu___57_6670.freevars);
          rng = (t.rng)
        }
    | uu____6671 -> mkApp ("Valid", [t]) t.rng
...
let (mk_HasTypeFuel : term -> term -> term -> term) =
  fun f ->
    fun v1 ->
      fun t ->
        let uu____6704 = FStar_Options.unthrottle_inductives () in
        if uu____6704
...
let (mk_String_const : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____6777 =
        let uu____6784 = let uu____6787 = mkInteger' i norng in [uu____6787] in
        ("FString_const", uu____6784) in
      mkApp uu____6777 r
let (mk_Precedes : term -> term -> FStar_Range.range -> term) =
  fun x1 ->
    fun x2 ->
      fun r ->
        let uu____6799 = mkApp ("Precedes", [x1; x2]) r in
        FStar_All.pipe_right uu____6799 mk_Valid
...
let rec (n_fuel : Prims.int -> term) =
  fun n1 ->
    ...
    then mkApp ("ZFuel", []) norng
      ...
      (let uu____6819 =
         let uu____6826 =
           let uu____6829 = n_fuel (n1 - (Prims.parse_int "1")) in
           [uu____6829] in
         ("SFuel", uu____6826) in
       mkApp uu____6819 norng)
    ...
    fun p2 ->
      fun r ->
        ...
        | (FStar_Pervasives_Native.Some p11, FStar_Pervasives_Native.Some
           p21) ->
            let uu____6863 = mkAnd (p11, p21) r in
...
let (mk_and_l : term Prims.list -> FStar_Range.range -> term) =
  fun l ->
    fun r ->
      let uu____6916 = mkTrue r in
      FStar_List.fold_right (fun p1 -> fun p2 -> mkAnd (p1, p2) r) l
        uu____6916
let (mk_or_l : term Prims.list -> FStar_Range.range -> term) =
  fun l ->
    fun r ->
      let uu____6931 = mkFalse r in
      FStar_List.fold_right (fun p1 -> fun p2 -> mkOr (p1, p2) r) l
        uu____6931
let (mk_haseq : term -> term) =
  fun t ->
    let uu____6939 = mkApp ("Prims.hasEq", [t]) t.rng in mk_Valid uu____6939