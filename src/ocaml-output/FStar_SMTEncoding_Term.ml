...
and mkPrelude: Prims.string -> Prims.string =
  fun z3options  ->
    ...
    let bcons =
      ...
      FStar_All.pipe_right uu____3563 (FStar_String.concat "\n") in
    let lex_ordering =
...
let mk_Term_uvar: Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____3595 =
        let uu____3599 = let uu____3601 = mkInteger' i norng in [uu____3601] in
        ("Tm_uvar", uu____3599) in
      mkApp uu____3595 r
...
let boxTerm: sort -> term -> term =
  fun sort  ->
    fun t  ->
      ...
      | Ref_sort  -> boxRef t
      | uu____3661 -> raise FStar_Util.Impos
let unboxTerm: sort -> term -> term =
  fun sort  ->
    fun t  ->
      ...
      | Ref_sort  -> unboxRef t
      | uu____3670 -> raise FStar_Util.Impos
  ...
  fun t  ->
    ...
    | App
        (Var
         "Prims.b2t",{
                       tm = App
                         (Var "Prims.op_Equality",uu____3680::t1::t2::[]);
                       freevars = uu____3683; rng = uu____3684;_}::[])
        -> mkEq (t1, t2) t.rng
    | App
        (Var
         "Prims.b2t",{
                       tm = App
                         (Var "Prims.op_disEquality",uu____3691::t1::t2::[]);
                       freevars = uu____3694; rng = uu____3695;_}::[])
        -> let uu____3702 = mkEq (t1, t2) norng in mkNot uu____3702 t.rng
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_LessThanOrEqual",t1::t2::[]);
                       freevars = uu____3705; rng = uu____3706;_}::[])
        ->
        let uu____3713 =
          let uu____3716 = unboxInt t1 in
          let uu____3717 = unboxInt t2 in (uu____3716, uu____3717) in
        mkLTE uu____3713 t.rng
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_LessThan",t1::t2::[]);
                       freevars = uu____3720; rng = uu____3721;_}::[])
        ->
        let uu____3728 =
          let uu____3731 = unboxInt t1 in
          let uu____3732 = unboxInt t2 in (uu____3731, uu____3732) in
        mkLT uu____3728 t.rng
    | App
        (Var
         "Prims.b2t",{
                       tm = App
                         (Var "Prims.op_GreaterThanOrEqual",t1::t2::[]);
                       freevars = uu____3735; rng = uu____3736;_}::[])
        ->
        let uu____3743 =
          let uu____3746 = unboxInt t1 in
          let uu____3747 = unboxInt t2 in (uu____3746, uu____3747) in
        mkGTE uu____3743 t.rng
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_GreaterThan",t1::t2::[]);
                       freevars = uu____3750; rng = uu____3751;_}::[])
        ->
        let uu____3758 =
          let uu____3761 = unboxInt t1 in
          let uu____3762 = unboxInt t2 in (uu____3761, uu____3762) in
        mkGT uu____3758 t.rng
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_AmpAmp",t1::t2::[]);
                       freevars = uu____3765; rng = uu____3766;_}::[])
        ->
        let uu____3773 =
          let uu____3776 = unboxBool t1 in
          let uu____3777 = unboxBool t2 in (uu____3776, uu____3777) in
        mkAnd uu____3773 t.rng
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_BarBar",t1::t2::[]);
                       freevars = uu____3780; rng = uu____3781;_}::[])
        ->
        let uu____3788 =
          let uu____3791 = unboxBool t1 in
          let uu____3792 = unboxBool t2 in (uu____3791, uu____3792) in
        mkOr uu____3788 t.rng
    | App
        (Var
         "Prims.b2t",{ tm = App (Var "Prims.op_Negation",t1::[]);
                       freevars = uu____3794; rng = uu____3795;_}::[])
        -> let uu____3802 = unboxBool t1 in mkNot uu____3802 t1.rng
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___95_3805 = unboxBool t1 in
        {
          tm = (uu___95_3805.tm);
          freevars = (uu___95_3805.freevars);
          rng = (t.rng)
        }
    | uu____3808 -> mkApp ("Valid", [t]) t.rng
...
let mk_HasTypeFuel: term -> term -> term -> term =
  fun f  ->
    fun v1  ->
      fun t  ->
        let uu____3845 = FStar_Options.unthrottle_inductives () in
        if uu____3845
...
let mk_String_const: Prims.int -> FStar_Range.range -> term =
  fun i  ->
    fun r  ->
      let uu____3927 =
        let uu____3931 = let uu____3933 = mkInteger' i norng in [uu____3933] in
        ("FString_const", uu____3931) in
      mkApp uu____3927 r
let mk_Precedes: term -> term -> FStar_Range.range -> term =
  fun x1  ->
    fun x2  ->
      fun r  ->
        let uu____3947 = mkApp ("Precedes", [x1; x2]) r in
        FStar_All.pipe_right uu____3947 mk_Valid
...
let rec n_fuel: Prims.int -> term =
  fun n1  ->
    ...
    then mkApp ("ZFuel", []) norng
      ...
      (let uu____3968 =
         let uu____3972 =
           let uu____3974 = n_fuel (n1 - (Prims.parse_int "1")) in
           [uu____3974] in
         ("SFuel", uu____3972) in
       mkApp uu____3968 norng)
    ...
    fun p2  ->
      fun r  ->
        ...
        | (FStar_Pervasives_Native.Some p11,FStar_Pervasives_Native.Some p21)
            ->
            let uu____4000 = mkAnd (p11, p21) r in
            FStar_Pervasives_Native.Some uu____4000
...
let mk_and_l: term Prims.list -> FStar_Range.range -> term =
  fun l  ->
    fun r  ->
      let uu____4040 = mkTrue r in
      FStar_List.fold_right (fun p1  -> fun p2  -> mkAnd (p1, p2) r) l
        uu____4040
let mk_or_l: term Prims.list -> FStar_Range.range -> term =
  fun l  ->
    fun r  ->
      let uu____4055 = mkFalse r in
      FStar_List.fold_right (fun p1  -> fun p2  -> mkOr (p1, p2) r) l
        uu____4055
let mk_haseq: term -> term =
  fun t  ->
    let uu____4064 = mkApp ("Prims.hasEq", [t]) t.rng in mk_Valid uu____4064
let rec print_smt_term: term -> Prims.string =
  fun t  ->
    match t.tm with
    | Integer n1 -> FStar_Util.format1 "(Integer %s)" n1
    | BoundV n1 ->
        let uu____4078 = FStar_Util.string_of_int n1 in
        FStar_Util.format1 "(BoundV %s)" uu____4078
    | FreeV fv ->
        FStar_Util.format1 "(FreeV %s)" (FStar_Pervasives_Native.fst fv)
    | App (op,l) ->
        let uu____4086 = print_smt_term_list l in
        FStar_Util.format2 "(%s %s)" (op_to_string op) uu____4086
    | Labeled (t1,r1,r2) ->
        let uu____4090 = print_smt_term t1 in
        FStar_Util.format2 "(Labeled '%s' %s)" r1 uu____4090
    | LblPos (t1,s) ->
        let uu____4093 = print_smt_term t1 in
        FStar_Util.format2 "(LblPos %s %s)" s uu____4093
    | Quant (qop,l,uu____4096,uu____4097,t1) ->
        let uu____4107 = print_smt_term_list_list l in
        let uu____4108 = print_smt_term t1 in
        FStar_Util.format3 "(%s %s %s)" (qop_to_string qop) uu____4107
          uu____4108
    | Let (es,body) ->
        let uu____4113 = print_smt_term_list es in
        let uu____4114 = print_smt_term body in
        FStar_Util.format2 "(let %s %s)" uu____4113 uu____4114
and print_smt_term_list: term Prims.list -> Prims.string =
  fun l  ->
    let uu____4117 = FStar_List.map print_smt_term l in
    ...
    FStar_List.fold_left
      (fun s  ->
         fun l1  ->
           let uu____4130 =
             let uu____4131 =
               let uu____4132 = print_smt_term_list l1 in
               Prims.strcat uu____4132 " ] " in
             Prims.strcat "; [ " uu____4131 in
           Prims.strcat s uu____4130) "" l