...
let (qop_to_string : qop -> Prims.string) =
  fun uu___12_2816  ->
    match uu___12_2816 with | Forall  -> "forall" | Exists  -> "exists"
  
let (op_to_string : op -> Prims.string) =
  fun uu___13_2826  ->
    match uu___13_2826 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
...
let (mk_Valid : term -> term) =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___17_9135 = unboxBool t1  in
        {
          tm = (uu___17_9135.tm);
          freevars = (uu___17_9135.freevars);
          rng = (t.rng)
        }
