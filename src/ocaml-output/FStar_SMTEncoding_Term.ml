...
let rec (freevars : term -> (Prims.string * sort * Prims.bool) Prims.list) =
  fun t ->
    ...
    | Quant (uu____2576, uu____2577, uu____2578, uu____2579, t1) ->
        freevars t1
...
let rec (hash_of_term' : term' -> Prims.string) =
  fun t ->
    ...
    | FreeV x ->
        ...
        let uu____2916 =
          let uu____2918 = let uu____2920 = fv_sort x in strSort uu____2920 in
...
let (mkInteger : Prims.string -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____3278 =
        let uu____3279 = FStar_Util.ensure_decimal i in Integer uu____3279 in
      mk uu____3278 r
      ...
      | (t1, t2) ->
          (match ((t1.tm), (t2.tm)) with
           ...
           | (uu____3614, App (Imp, t1'::t2'::[])) ->
               let uu____3619 =
                 let uu____3626 =
                   let uu____3629 = mkAnd (t1, t1') r in [uu____3629; t2'] in
                 (Imp, uu____3626) in
               mkApp' uu____3619 r
           ...
           | uu____4262 ->
               (match ((t2.tm), (t3.tm)) with
                ...
                | (App (TrueOp, uu____4273), uu____4274) ->
                    let uu____4279 =
                      let uu____4284 = mkNot t1 t1.rng in (uu____4284, t3) in
                    mkImp uu____4279 r
                   ...
                   FStar_List.fold_left
                     (fun uu____5144 ->
                        fun e ->
                          ...
                          | (ix1, l) ->
                              let uu____5168 =
                                let uu____5171 = aux ix1 e in uu____5171 :: l in
        ...
        | Let (es, body) ->
              ...
              FStar_List.fold_left
                (fun uu____5396 ->
                   fun e ->
                     ...
                     | (ix, es1) ->
                         let uu____5420 =
                           let uu____5423 = aux shift e in uu____5423 :: es1 in
            ...
            (match uu____5376 with
             | (shift1, es_rev) ->
                 ...
                 mkLet uu____5439 t1.rng) in
      aux (Prims.parse_int "0") t
let (subst : term -> fv -> term -> term) =
  fun t ->
    fun fv -> fun s -> let uu____5466 = abstr [fv] t in inst [s] uu____5466
let (mkQuant' :
  FStar_Range.range ->
    (qop * term Prims.list Prims.list * Prims.int
                    ...
                    fun s ->
                      let uu____6113 =
                        let uu____6114 =
                          ...
                          (uu____6120, s) in
                        mk_fv uu____6114 in
                      mkFreeV uu____6113 norng)) in
          let bvar_names = FStar_List.map fv_of_term bvars in
          let capp = mkApp (name, bvars) norng in
          let cid_app =
            let uu____6150 =
              let uu____6158 = constr_id_of_sort sort in (uu____6158, [capp]) in
                 ...
                 (fun i ->
                    fun uu____6324 ->
                      ...
                      | (uu____6334, s, uu____6336) ->
                          let uu____6341 = bvar i s in uu____6341 norng)) in
          let bvar_names = FStar_List.map fv_of_term bvars in
          let capp = mkApp (name, bvars) norng in
          let uu____6369 =
            FStar_All.pipe_right fields
            ...
            FStar_All.pipe_right fields
              (FStar_List.map
                 (fun uu____6545 ->
                    ...
                    | (uu____6554, sort1, uu____6556) -> sort1)) in
          let cdecl =
            DeclFun
          ...
          fun depth ->
            ...
            then enclosing_name
              ...
              (let uu____7247 = FStar_Util.string_of_int n1 in
               FStar_Util.format2 "%s.%s" enclosing_name uu____7247) in
                       ...
                       (fun tm ->
                          ...
                          | App
                              (Var "Prims.guard_free",
                               { tm = BoundV uu____7293;
                                 freevars = uu____7294; rng = uu____7295;_}::[])
                              -> tm
                                ...
                                (fun pats2 ->
                                   let uu____7558 =
                                     let uu____7560 =
                                       FStar_List.map
                                         (fun p ->
                                            let uu____7568 = aux1 n2 names2 p in
      ...
      fun decl ->
        ...
        | Assume a ->
            ...
            let fids =
              ...
              then
                let uu____8044 =
                  let uu____8046 = fact_ids_to_string a.assumption_fact_ids in
            ...
            let uu____8059 = termToSmt print_captions n1 a.assumption_term in
...
let (mk_Range_const : unit -> term) =
  fun uu____8352 ->
    ...
    (let uu____8424 =
       let uu____8432 = let uu____8435 = mkInteger' i norng in [uu____8435] in
...
let (mk_Term_uvar : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____8478 =
        let uu____8486 = let uu____8489 = mkInteger' i norng in [uu____8489] in
...
let (mk_Valid : term -> term) =
  fun t ->
    ...
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_Equality", uu____8788::t1::t2::[]);
           freevars = uu____8791; rng = uu____8792;_}::[])
        -> mkEq (t1, t2) t.rng
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_disEquality", uu____8811::t1::t2::[]);
    ...
    | App
        (Var "Prims.b2t",
         { tm = App (Var "Prims.op_Negation", t1::[]); freevars = uu____9010;
           rng = uu____9011;_}::[])
    ...
    | App
        (Var "Prims.equals",
         uu____9082::{ tm = App (Var "FStar.BV.bvult", t0::t1::t2::[]);
                       freevars = uu____9086; rng = uu____9087;_}::uu____9088::[])
        when
...
let (mk_String_const : Prims.int -> FStar_Range.range -> term) =
  fun i ->
    fun r ->
      let uu____9353 =
        let uu____9361 = let uu____9364 = mkInteger' i norng in [uu____9364] in
