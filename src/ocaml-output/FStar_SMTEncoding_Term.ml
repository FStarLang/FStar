...
let qop_to_string: qop -> Prims.string =
  fun uu___116_1668  ->
    match uu___116_1668 with | Forall  -> "forall" | Exists  -> "exists"
          ...
          then
            let uu____5422 =
              FStar_All.pipe_right (FStar_Util.splitlines c)
                (fun uu___120_5426  ->
                   match uu___120_5426 with | [] -> "" | h::t -> h) in
            FStar_Util.format1 "\n; %s" uu____5422
          else ""
...
let mk_Valid: term -> term =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___122_6512 = unboxBool t1 in
        {
          tm = (uu___122_6512.tm);
          freevars = (uu___122_6512.freevars);
          rng = (t.rng)
        }
