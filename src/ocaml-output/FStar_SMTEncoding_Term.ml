...
let (qop_to_string : qop -> Prims.string) =
  fun uu___114_1756  ->
    match uu___114_1756 with | Forall  -> "forall" | Exists  -> "exists"
  
let (op_to_string : op -> Prims.string) =
  fun uu___115_1761  ->
    match uu___115_1761 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
            ...
            then
              let uu____5996 =
                FStar_All.pipe_right (FStar_Util.splitlines c)
                  (fun uu___118_6000  ->
                     match uu___118_6000 with | [] -> "" | h::t -> h)
                 in
              FStar_Util.format1 "\n; %s" uu____5996
            else ""
...
let (mk_Valid : term -> term) =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___120_6756 = unboxBool t1  in
        {
          tm = (uu___120_6756.tm);
          freevars = (uu___120_6756.freevars);
          rng = (t.rng)
        }
