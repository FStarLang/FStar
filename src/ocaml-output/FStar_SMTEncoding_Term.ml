...
let qop_to_string: qop -> Prims.string =
  fun uu___228_1561  ->
    match uu___228_1561 with | Forall  -> "forall" | Exists  -> "exists"
let op_to_string: op -> Prims.string =
  fun uu___229_1564  ->
    match uu___229_1564 with
    | TrueOp  -> "true"
    | FalseOp  -> "false"
    | Not  -> "not"
    | And  -> "and"
            ...
            then
              let uu____5217 =
                FStar_All.pipe_right (FStar_Util.splitlines c)
                  (fun uu___232_5221  ->
                     match uu___232_5221 with | [] -> "" | h::t -> h) in
              FStar_Util.format1 "\n; %s" uu____5217
            else ""
...
let mk_Valid: term -> term =
  fun t  ->
    ...
    | App (Var "Prims.b2t",t1::[]) ->
        let uu___234_6446 = unboxBool t1 in
        {
          tm = (uu___234_6446.tm);
          freevars = (uu___234_6446.freevars);
          rng = (t.rng)
        }
