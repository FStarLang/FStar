...
let z3_job:
  ...
  fun fresh1  ->
    fun label_messages  ->
      fun input  ->
        fun uu____1105  ->
          let ekind uu___96_1121 =
            match uu___96_1121 with
           ...
           | (theory',n_retained,n_pruned) ->
               let missed_assertions th core2 =
                 let missed =
                   ...
                   FStar_All.pipe_right uu____1809 (FStar_String.concat ", ") in
                 let included =
                   let uu____1823 =
                     FStar_All.pipe_right th
                       (FStar_List.collect
                          (fun uu___99_1827  ->
                             match uu___99_1827 with
                             | FStar_SMTEncoding_Term.Assume
                                 (uu____1829,uu____1830,nm) -> [nm]
                             | uu____1832 -> [])) in
                   FStar_All.pipe_right uu____1823 (FStar_String.concat ", ") in
