...
let (uu___is_SAT : z3status -> Prims.bool) =
  fun projectee -> match projectee with | SAT _0 -> true | uu____421 -> false
...
let (uu___is_KILLED : z3status -> Prims.bool) =
  fun projectee -> match projectee with | KILLED -> true | uu____554 -> false
...
let (query_logging : query_log) =
  ...
  let next_file_name uu____1235 =
    ...
    let file_name =
      let uu____1240 =
        ...
        FStar_List.tryFind
          (fun uu____1302 ->
             match uu____1302 with | (m, uu____1311) -> n1 = m) uu____1249 in
      ...
      | FStar_Pervasives_Native.Some (uu____1422, k) ->
          ((let uu____1435 =
           ...
           (let uu____1532 =
            ...
            FStar_Util.format2 "%s-%s" n1 uu____1532)) in
  ...
  let append_to_log str =
    ...
    match uu____1701 with | (f, nm) -> (FStar_Util.append_to_file f str; nm) in
    ...
    let uu____1741 =
      fresh ||
        (let uu____1744 = FStar_Options.n_cores () in
         uu____1744 > (Prims.parse_int "1")) in
...
let (bg_z3_proc : bgproc FStar_ST.ref) =
  ...
  let restart uu____2059 =
    ...
    (let uu____2085 =
     ...
     FStar_ST.op_Colon_Equals the_z3proc uu____2085) in
  FStar_Util.mk_ref
    {
                                  ...
                                  | uu____2937 ->
                                      ...
                                      FStar_Errors.log_issue r
                                        (FStar_Errors.Warning_UnexpectedZ3Output,
                                          msg));
                                 (let uu____2953 = FStar_Util.must result_opt in
                                  {
                  ...
                  | uu___397_3793 ->
                      ...
                      then
                        Obj.magic
                          (Obj.repr
                             ((let uu____3801 =
                                 let uu____3806 = FStar_ST.op_Bang bg_z3_proc in
...
let (refresh : unit -> unit) =
  fun uu____4714 ->
    (let uu____4716 =
     ...
     then
       let uu____4722 =
         let uu____4727 = FStar_ST.op_Bang bg_z3_proc in uu____4727.refresh in
       uu____4722 ()
     else ());
          ...
          FStar_List.sortWith
            (fun uu____4970 ->
               fun uu____4971 ->
                 ...
                 | ((uu____4997, n1), (uu____4999, m)) -> m - n1) modules in
        (if modules1 <> []
         then
      ...
      (let uu____5132 =
         ...
         then
           ...
           (let uu____5312 =
            ...
            (uu____5312, FStar_Pervasives_Native.None)) in
