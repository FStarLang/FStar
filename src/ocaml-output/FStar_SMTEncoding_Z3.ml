...
let z3_job:
  ...
  fun fresh1  ->
    fun label_messages  ->
      fun input  ->
        fun uu____1105  ->
          let ekind uu___99_1121 =
            match uu___99_1121 with
...
let pop: Prims.string -> Prims.unit =
  fun msg  ->
    (let uu____1587 =
       let uu____1590 = FStar_ST.read fresh_scope in FStar_List.tl uu____1590 in
                          ...
                          (fun nm  ->
                             let uu____1809 =
                               FStar_All.pipe_right th
                                 (FStar_Util.for_some
                                    (fun uu___101_1811  ->
                                       match uu___101_1811 with
                                       | FStar_SMTEncoding_Term.Assume
                                           (uu____1812,uu____1813,nm') ->
                                           nm = nm'
                                       | uu____1815 -> false)) in
                             FStar_All.pipe_right uu____1809
                               Prims.op_Negation)) in
                   FStar_All.pipe_right uu____1804 (FStar_String.concat ", ") in
                 let included =
                   let uu____1818 =
                     FStar_All.pipe_right th
                       (FStar_List.collect
                          (fun uu___102_1822  ->
                             match uu___102_1822 with
                             | FStar_SMTEncoding_Term.Assume
