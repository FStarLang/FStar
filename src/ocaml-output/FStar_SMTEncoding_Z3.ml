    ...
    | FStar_Pervasives_Native.Some n1 ->
        let file_name =
          let uu____957 =
            ...
            FStar_List.tryFind
              (fun uu____1026  ->
                 match uu____1026 with | (m,uu____1032) -> n1 = m) uu____964
             in
          ...
          | FStar_Pervasives_Native.Some (uu____1152,k) ->
              ((let uu____1159 =
               ...
               (let uu____1273 =
                ...
                FStar_Util.format2 "%s-%s" n1 uu____1273))
           in
      ...
      let uu____1712 =
        let uu____1713 =
          ...
          (let uu____1736 = FStar_ST.op_Bang ctr  in
           FStar_All.pipe_right uu____1736 FStar_Util.string_of_int)
           in
        FStar_Util.format1 "bg-%s" uu____1713  in
      new_z3proc uu____1712
     in
