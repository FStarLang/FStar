    ...
    | x :: uu____22 ->
        ...
        let rec aux uu___36_36 =
          ...
          | [hash] ->
              ...
              in
              let hash_prefix =
                FStar_String.substring hash (Prims.parse_int "0") n1
              in
              if hash_prefix = _z3hash_expected then (
          ...
          | uu____52 :: q -> aux q
          | uu____56 -> FStar_Pervasives_Native.Some "No Z3 commit hash found"
        in
        aux parts
    ...
    let run_proc_result =
      try
        let uu____99 =
          ...
          FStar_Util.run_proc uu____106 "-version" ""
        in
        FStar_Pervasives_Native.Some uu____99
      with uu____124 -> FStar_Pervasives_Native.None
    in
...
let ini_params : Prims.unit -> Prims.string =
  fun uu____239 ->
    ...
    let uu____241 =
        ...
        let uu____247 =
          let uu____250 =
            let uu____251 =
              ...
              FStar_Util.string_of_int uu____252
            in
            FStar_Util.format1 "smt.random_seed=%s" uu____251
          in
          [uu____250]
        in
      ...
      FStar_List.append uu____244 uu____253
    in
...
let uu___is_UNSAT : z3status -> Prims.bool =
  fun projectee -> match projectee with UNSAT _0 -> true | uu____298 -> false
...
let uu___is_SAT : z3status -> Prims.bool =
  fun projectee -> match projectee with SAT _0 -> true | uu____316 -> false
...
let uu___is_KILLED : z3status -> Prims.bool =
  fun projectee -> match projectee with KILLED -> true | uu____417 -> false
...
let new_z3proc : Prims.string -> FStar_Util.proc =
  fun id1 ->
    let cond pid s =
      let x = FStar_Util.trim_string s = "Done!" in
      x
    in
...
let __proj__Mkbgproc__item__grab : bgproc -> Prims.unit -> FStar_Util.proc =
  fun projectee ->
    ...
    with
    | { grab= __fname__grab
      ; release= __fname__release
      ; refresh= __fname__refresh
      ; restart= __fname__restart; _ }
    -> __fname__grab
...
let __proj__Mkquery_log__item__get_module_name
  ...
  fun projectee ->
    ...
    | { get_module_name= __fname__get_module_name
      ...
      ; write_to_log= __fname__write_to_log
      ; close_log= __fname__close_log
      ; log_file_name= __fname__log_file_name; _ }
...
let query_logging : query_log =
    ...
    | FStar_Pervasives_Native.Some n1 ->
        let file_name =
          let uu____959 =
            ...
            FStar_List.tryFind
              (fun uu____1033 ->
                match uu____1033 with m, uu____1039 -> n1 = m )
              uu____966
          in
          ...
          | FStar_Pervasives_Native.None ->
              (let uu____1045 =
                 ...
                 (n1, Prims.parse_int "0") :: uu____1052
               in
          ...
          | FStar_Pervasives_Native.Some (uu____1169, k) ->
              (let uu____1176 =
                 ...
                 (n1, k + Prims.parse_int "1") :: uu____1183
               in
               FStar_ST.op_Colon_Equals used_file_names uu____1176) ;
              let uu____1300 =
                FStar_Util.string_of_int (k + Prims.parse_int "1")
              in
        ...
        FStar_ST.op_Colon_Equals log_file_opt (FStar_Pervasives_Native.Some fh) ;
        fh
  in
  let get_log_file uu____1398 =
    ...
    | FStar_Pervasives_Native.Some fh -> fh
  in
  let append_to_log str =
    let uu____1452 = get_log_file () in
    FStar_Util.append_to_file uu____1452 str
  in
  ...
  let write_to_log str =
    let uu____1738 =
      ...
      uu____1739 > Prims.parse_int "1"
    in
    if uu____1738 then write_to_new_log str else append_to_log str
  in
...
let bg_z3_proc : bgproc =
  ...
  let new_proc =
    ...
    fun uu____1906 ->
      let uu____1907 =
        ...
        in
        FStar_Util.format1 "bg-%s" uu____1908
      in
  ...
  let refresh uu____2158 =
    ...
    query_logging.close_log () ; release ()
  in
  let restart uu____2215 =
    ...
    (let uu____2265 =
       ...
       FStar_Pervasives_Native.Some uu____2268
     in
...
let __proj__Mksmt_output__item__smt_result : smt_output -> smt_output_section =
  fun projectee ->
    ...
    | { smt_result= __fname__smt_result
      ...
      ; smt_labels= __fname__smt_labels; _ }
    -> __fname__smt_result
...
let smt_output_sections : Prims.string Prims.list -> smt_output =
  fun lines ->
    let rec until tag lines1 =
      ...
      | [] -> FStar_Pervasives_Native.None
      | l :: lines2 ->
          if tag = l then FStar_Pervasives_Native.Some ([], lines2)
          else
            let uu____2519 = until tag lines2 in
            FStar_Util.map_opt uu____2519 (fun uu____2549 ->
                match uu____2549 with until_tag, rest -> (l :: until_tag, rest)
            )
    in
          ...
          match uu____2819 with statistics, lines4 ->
            ...
            match uu____2844 with labels, lines5 ->
              ...
              | uu____2912 ->
                  let uu____2915 =
                    let uu____2920 =
                      let uu____2921 = query_logging.get_module_name () in
                      FStar_Util.format2 "%s: Unexpected output from Z3: %s\n"
                        uu____2921
                        (FStar_String.concat "\n" remaining)
                    in
                    (FStar_Errors.Warning_UnexpectedZ3Output, uu____2920)
                  in
...
let doZ3Exe
    : Prims.bool -> Prims.string -> FStar_SMTEncoding_Term.error_labels
      -> (z3status, z3statistics) FStar_Pervasives_Native.tuple2 =
  fun fresh input label_messages ->
    let parse z3out =
      let lines =
      ...
      let unsat_core =
        ...
        | FStar_Pervasives_Native.Some s ->
            ...
            in
            if FStar_Util.starts_with s2 "error" then
              FStar_Pervasives_Native.None
            else
              let uu____2982 =
      ...
      let labels =
        ...
        | FStar_Pervasives_Native.Some lines1 ->
            let rec lblnegs lines2 =
              match lines2 with
              | lname :: "false" :: rest
                when FStar_Util.starts_with lname "label_" ->
                  let uu____3043 = lblnegs rest in
                  lname :: uu____3043
              | lname :: uu____3047 :: rest
                when FStar_Util.starts_with lname "label_" ->
                  lblnegs rest
              | uu____3051 -> []
            in
            ...
            FStar_All.pipe_right lblnegs1
              (FStar_List.collect (fun l ->
                   let uu____3084 =
                     FStar_All.pipe_right label_messages
                       (FStar_List.tryFind (fun uu____3123 ->
                            match uu____3123
                            with m, uu____3135, uu____3136 ->
      ...
      let statistics =
        ...
        | FStar_Pervasives_Native.Some lines1 ->
            let parse_line line =
              let pline = FStar_Util.split (FStar_Util.trim_string line) ":" in
              match pline with
              | ["("; entry] ->
                  ...
                  in
                  let value =
                    if FStar_Util.ends_with ltok ")" then
                      FStar_Util.substring ltok (Prims.parse_int "0")
                        (FStar_String.length ltok - Prims.parse_int "1")
                    else ltok
                  in
              ...
              | uu____3248 -> ()
            in
            FStar_List.iter parse_line lines1 ;
            statistics
      in
      let reason_unknown =
        FStar_Util.map_opt smt_output.smt_reason_unknown (fun x ->
            let ru = FStar_String.concat " " x in
            if FStar_Util.starts_with ru "(:reason-unknown \"" then
              let reason =
    ...
    let stdout1 =
      if fresh then
        ...
        FStar_Util.launch_process false uu____3323 uu____3324 uu____3325 input
          cond
      else
...
let __proj__Mkjob__item__job: 'a. 'a job -> Prims.unit -> 'a =
  fun projectee ->
    match projectee
    with {job= __fname__job; callback= __fname__callback; _} -> __fname__job


let __proj__Mkjob__item__callback: 'a. 'a job -> 'a -> Prims.unit =
  fun projectee ->
    match projectee
    with {job= __fname__job; callback= __fname__callback; _} ->
      __fname__callback
...
let with_monitor:
      'Auu____3485 'Auu____3486. 'Auu____3486 -> (Prims.unit -> 'Auu____3485)
      -> 'Auu____3485 =
  fun m f ->
    FStar_Util.monitor_enter m ;
    let res = f () in
    FStar_Util.monitor_exit m ; res


let z3_job
    : Prims.bool -> FStar_SMTEncoding_Term.error_labels -> Prims.string
      -> Prims.string FStar_Pervasives_Native.option -> Prims.unit -> z3result =
  fun fresh label_messages input qhash uu____3519 ->
    let start = FStar_Util.now () in
    let uu____3523 =
      try doZ3Exe fresh input label_messages
      with
      | uu____3547
      when let uu____3548 = FStar_Options.trace_error () in
           Prims.op_Negation uu____3548
      ->
        bg_z3_proc.refresh () ;
        let uu____3550 = FStar_Util.smap_create (Prims.parse_int "0") in
        ( UNKNOWN ([], FStar_Pervasives_Native.Some "Z3 raised an exception")
        , uu____3550 )
    in
    match uu____3523 with status, statistics ->
      let uu____3561 =
        let uu____3566 = FStar_Util.now () in
        FStar_Util.time_diff start uu____3566
      in
      match uu____3561 with uu____3567, elapsed_time ->
...
and run_job : z3job -> Prims.unit =
  fun j ->
    let uu____3725 = j.job () in
    FStar_All.pipe_left j.callback uu____3725
...
let init : Prims.unit -> Prims.unit =
  fun uu____3728 ->
    ...
    if n_cores1 > Prims.parse_int "1" then
      let rec aux n1 =
...
let enqueue : z3job -> Prims.unit =
  fun j ->
    ...
    (let uu____3766 =
       ...
       FStar_List.append uu____3769 [j]
     in
...
let finish : Prims.unit -> Prims.unit =
  fun uu____3829 ->
    let rec aux uu____3833 =
      let uu____3834 =
        with_monitor job_queue (fun uu____3850 ->
            let uu____3851 = FStar_ST.op_Bang pending_jobs in
            let uu____3871 =
              let uu____3872 = FStar_ST.op_Bang job_queue in
              FStar_List.length uu____3872
            in
            (uu____3851, uu____3871) )
      in
      match uu____3834 with n1, m ->
        if n1 + m = Prims.parse_int "0" then
...
let giveZ3 : FStar_SMTEncoding_Term.decl Prims.list -> Prims.unit =
  fun decls ->
    FStar_All.pipe_right decls
      (FStar_List.iter (fun uu___38_4260 ->
    ...
    (let uu____4263 = FStar_ST.op_Bang fresh_scope in
     ...
     | hd1 :: tl1 ->
         FStar_ST.op_Colon_Equals fresh_scope
           (FStar_List.append hd1 decls :: tl1)
     | uu____4334 -> failwith "Impossible") ;
    let uu____4339 =
      let uu____4342 = FStar_ST.op_Bang bg_scope in
      FStar_List.append uu____4342 decls
    in
        ...
        let uu____4491 =
          let uu____4502 =
            FStar_All.pipe_right theory
              (FStar_Util.prefix_until (fun uu___39_4530 ->
                   match uu___39_4530 with
                   | FStar_SMTEncoding_Term.CheckSat -> true
                   | uu____4531 -> false ))
          in
          FStar_All.pipe_right uu____4502 FStar_Option.get
        in
        match uu____4491 with prefix1, check_sat, suffix ->
          let pp = FStar_List.map (FStar_SMTEncoding_Term.declToSmt options) in
          let pp_no_cap =
            FStar_List.map (FStar_SMTEncoding_Term.declToSmt_no_caps options)
          in
          ...
          let hs =
            let uu____4642 =
              let uu____4645 =
                ...
                in
                FStar_All.pipe_right uu____4648 pp_no_cap
              in
...
let ask_1_core
    : (FStar_SMTEncoding_Term.decls_t
       -> ( FStar_SMTEncoding_Term.decls_t
          ...
          FStar_Pervasives_Native.tuple2)
      -> Prims.string FStar_Pervasives_Native.option
      -> FStar_SMTEncoding_Term.error_labels -> FStar_SMTEncoding_Term.decls_t
      -> cb -> Prims.unit =
  fun filter_theory cache label_messages qry cb ->
    let theory =
...
let ask_n_cores
  ...
  fun filter_theory cache label_messages qry scope cb ->
    let theory =
      let uu____4893 =
        match scope with
    ...
    match uu____4966 with theory2, used_unsat_core ->
      let uu____4973 = mk_input theory2 in
      match uu____4973 with input, qhash ->
        let uu____4986 =
          let uu____4987 = cache_hit cache qhash cb in
          Prims.op_Negation uu____4987
        in
        if uu____4986 then
...
let ask
    : (FStar_SMTEncoding_Term.decls_t
      ...
      -> FStar_SMTEncoding_Term.decl Prims.list
      -> scope_t FStar_Pervasives_Native.option -> cb -> Prims.unit =
  fun filter1 cache label_messages qry scope cb ->
    let uu____5036 =
      let uu____5037 = FStar_Options.n_cores () in
      uu____5037 = Prims.parse_int "1"
    in
    if uu____5036 then ask_1_core filter1 cache label_messages qry cb
