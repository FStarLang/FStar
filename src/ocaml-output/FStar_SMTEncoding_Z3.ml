...
let query_logging : query_log =
    ...
    | Some n1 ->
        let file_name =
          let uu____638 =
            ...
            FStar_List.tryFind
              (fun uu____653  ->
                 match uu____653 with | (m,uu____657) -> n1 = m) uu____642
             in
          ...
          | Some (uu____681,k) ->
              ((let uu____686 =
               ...
               (let uu____706 =
                ...
                FStar_Util.format2 "%s-%s" n1 uu____706))
           in
  ...
  let log_file_name uu____792 =
    ...
    match uu____793 with | None  -> failwith "no log file" | Some n1 -> n1
     in
...
let bg_z3_proc : bgproc =
      ...
      let uu____811 =
        let uu____812 =
          ...
          (let uu____817 = FStar_ST.read ctr  in
           FStar_All.pipe_right uu____817 FStar_Util.string_of_int)
           in
        FStar_Util.format1 "bg-%s" uu____812  in
      new_z3proc uu____811
     in
  let z3proc uu____823 =
    ...
    (let uu____839 = FStar_ST.read the_z3proc  in FStar_Util.must uu____839)
     in
  let x = []  in
      ...
      let parse z3out =
        ...
        let get_data lines1 =
            ...
            then None
              ...
              (let uu____942 =
                 FStar_All.pipe_right (FStar_Util.split s2 " ")
                  ...
                  in
               FStar_All.pipe_right uu____942 (fun _0_38  -> Some _0_38))
             in
          ...
          (let uu____1060 = FStar_ST.read core  in
           ...
           (uu____1060, statistics, uu____1067))
           in
          ...
          | uu____1121 ->
              let uu____1123 =
                ...
                FStar_Util.format1
                  ...
                  uu____1124
                 in
              FStar_All.pipe_left failwith uu____1123
           in
        let uu____1128 = get_data lines  in
        match uu____1128 with
        | (core,statistics,reason_unknown) ->
            let uu____1143 = result lines core  in (uu____1143, statistics)
         in
      let cond pid s = let x = (FStar_Util.trim_string s) = "Done!"  in x  in
      let stdout1 =
        if fresh1
                     ...
                     | UNKNOWN lblnegs ->
                         ((let uu____1719 = FStar_Options.debug_any ()  in
                          ...
                          (let failing_assertions =
                           ...
                           (uu____1813, elapsed_time, statistics)))
                      in
                   result)
