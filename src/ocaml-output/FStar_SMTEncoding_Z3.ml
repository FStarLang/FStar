...
let get_z3version: Prims.unit -> z3version =
  fun uu____150  ->
    ...
    let uu____152 = FStar_ST.read _z3version in
  ...
  fun uu____238  ->
    ...
    (let uu____241 =
     ...
     then
       ...
       FStar_All.pipe_left FStar_Pervasives.raise uu____243
     else ());
    (let uu____247 =
       let uu____250 =
         let uu____253 =
...
let query_logging: query_log =
  ...
  let new_log_file uu____806 =
    ...
    | FStar_Pervasives_Native.Some n1 ->
        let file_name =
          ...
          | FStar_Pervasives_Native.None  ->
              ((let uu____925 =
                  let uu____932 = FStar_ST.read used_file_names in
                  (n1, (Prims.parse_int "0")) :: uu____932 in
                FStar_ST.write used_file_names uu____925);
               n1)
          | FStar_Pervasives_Native.Some (uu____1039,k) ->
              ((let uu____1046 =
                  let uu____1053 = FStar_ST.read used_file_names in
                  (n1, (k + (Prims.parse_int "1"))) :: uu____1053 in
                FStar_ST.write used_file_names uu____1046);
               (let uu____1160 =
  ...
  let get_log_file uu____1232 =
    let uu____1233 = FStar_ST.read log_file_opt in
  ...
  let write_to_new_log str =
    let dir_name =
      let uu____1279 = FStar_ST.read current_file_name in
      match uu____1279 with
      | FStar_Pervasives_Native.None  ->
          let dir_name =
            let uu____1315 = FStar_ST.read current_module_name in
    ...
    (let uu____1412 =
       let uu____1413 = FStar_ST.read query_number in
       uu____1413 + (Prims.parse_int "1") in
     FStar_ST.write query_number uu____1412);
    (let file_name =
  ...
  let close_log uu____1475 =
    let uu____1476 = FStar_ST.read log_file_opt in
  ...
  let log_file_name uu____1548 =
    let uu____1549 = FStar_ST.read current_file_name in
...
let bg_z3_proc: bgproc =
  ...
  let new_proc =
    ...
    fun uu____1598  ->
      let uu____1599 =
        let uu____1600 =
          FStar_Util.incr ctr;
          (let uu____1623 = FStar_ST.read ctr in
  ...
  let z3proc uu____1651 =
    (let uu____1653 =
       let uu____1654 = FStar_ST.read the_z3proc in
     ...
     then
       ...
       FStar_ST.write the_z3proc uu____1691
     else ());
    (let uu____1728 = FStar_ST.read the_z3proc in FStar_Util.must uu____1728) in
  let x = [] in
  ...
  let refresh uu____1782 =
    ...
    (let uu____1786 =
     ...
     FStar_ST.write the_z3proc uu____1786);
  ...
  let restart uu____1826 =
    ...
    (let uu____1863 =
     ...
     FStar_ST.write the_z3proc uu____1863);
      ...
      let parse z3out =
        ...
        let get_data lines1 =
          ...
          let parse line =
            ...
            | uu____2153 ->
                let uu____2154 = FStar_ST.read in_core in
                if uu____2154
                then
                  let uu____2179 = parse_core line in
                  FStar_ST.write core uu____2179
                else
                  (let uu____2225 = FStar_ST.read in_statistics in
                   if uu____2225
                   then
                     let pline =
                     ...
                     (let uu____2273 = FStar_ST.read in_reason_unknown in
                      if uu____2273
                      then
          ...
          (let uu____2313 = FStar_ST.read core in
           let uu____2358 = FStar_ST.read reason_unknown in
...
let rec dequeue': Prims.unit -> Prims.unit =
  fun uu____3747  ->
    let j =
      let uu____3749 = FStar_ST.read job_queue in
...
and dequeue: Prims.unit -> Prims.unit =
  fun uu____3808  ->
    let uu____3809 = FStar_ST.read running in
    if uu____3809
    then
      let rec aux uu____3823 =
        FStar_Util.monitor_enter job_queue;
        (let uu____3829 = FStar_ST.read job_queue in
...
let enqueue: z3job -> Prims.unit =
  fun j  ->
    FStar_Util.monitor_enter job_queue;
    (let uu____3950 =
       let uu____3953 = FStar_ST.read job_queue in
       FStar_List.append uu____3953 [j] in
     FStar_ST.write job_queue uu____3950);
    ...
    let rec aux uu____4008 =
      let uu____4009 =
        with_monitor job_queue
          (fun uu____4025  ->
             let uu____4026 = FStar_ST.read pending_jobs in
             let uu____4037 =
               let uu____4038 = FStar_ST.read job_queue in
...
let mk_fresh_scope: Prims.unit -> scope_t =
  fun uu____4109  -> FStar_ST.read fresh_scope
let bg_scope: FStar_SMTEncoding_Term.decl Prims.list FStar_ST.ref =
  FStar_Util.mk_ref []
let push: Prims.string -> Prims.unit =
  fun msg  ->
    (let uu____4154 =
       let uu____4159 = FStar_ST.read fresh_scope in
       [FStar_SMTEncoding_Term.Caption msg; FStar_SMTEncoding_Term.Push] ::
         uu____4159 in
     FStar_ST.write fresh_scope uu____4154);
    (let uu____4218 =
       let uu____4221 = FStar_ST.read bg_scope in
       FStar_List.append uu____4221
         [FStar_SMTEncoding_Term.Push; FStar_SMTEncoding_Term.Caption msg] in
     FStar_ST.write bg_scope uu____4218)
let pop: Prims.string -> Prims.unit =
  fun msg  ->
    (let uu____4265 =
       let uu____4270 = FStar_ST.read fresh_scope in FStar_List.tl uu____4270 in
     FStar_ST.write fresh_scope uu____4265);
    (let uu____4329 =
       let uu____4332 = FStar_ST.read bg_scope in
       FStar_List.append uu____4332
         [FStar_SMTEncoding_Term.Caption msg; FStar_SMTEncoding_Term.Pop] in
     FStar_ST.write bg_scope uu____4329)
  ...
  fun filter_theory  ->
    fun label_messages  ->
      fun qry  ->
        fun cb  ->
          let theory =
            let uu____4914 = FStar_ST.read bg_scope in
          ...
          fun cb  ->
            let theory =
              let uu____5039 =
                ...
                | FStar_Pervasives_Native.None  ->
                    (FStar_ST.write bg_scope [];
                     (let uu____5070 = FStar_ST.read fresh_scope in
