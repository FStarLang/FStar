...
let (uu___is_SAT : z3status -> Prims.bool) =
  fun projectee -> match projectee with | SAT _0 -> true | uu____333 -> false
...
let (uu___is_KILLED : z3status -> Prims.bool) =
  fun projectee -> match projectee with | KILLED -> true | uu____466 -> false
...
let (query_logging : query_log) =
  ...
  let next_file_name uu____957 =
    ...
    let file_name =
      let uu____962 =
        ...
        FStar_List.tryFind
          (fun uu____1024 ->
             match uu____1024 with | (m, uu____1033) -> n1 = m) uu____971 in
      ...
      | FStar_Pervasives_Native.Some (uu____1144, k) ->
          ((let uu____1157 =
           ...
           (let uu____1254 = FStar_Util.string_of_int (k + Prims.int_one) in
            FStar_Util.format2 "%s-%s" n1 uu____1254)) in
  ...
  let append_to_log str =
    ...
    match uu____1423 with | (f, nm) -> (FStar_Util.append_to_file f str; nm) in
    ...
    let uu____1779 =
      let uu____1781 =
        ...
        (let uu____1784 = FStar_ST.op_Bang ctr in
         FStar_All.pipe_right uu____1784 FStar_Util.string_of_int) in
        ...
        ((let uu____2679 =
            (FStar_Options.query_stats ()) &&
              (let uu____2682 =
               ...
               Prims.op_Negation uu____2682) in
          if uu____2679
          then
            let uu____2713 =
         ...
         (let out =
            let uu____2743 = z3proc () in FStar_Util.kill_process uu____2743 in
                                  ...
                                  | uu____3794 ->
                                      ...
                                      FStar_Errors.log_issue r
                                        (FStar_Errors.Warning_UnexpectedZ3Output,
                                          msg));
                                 (let uu____3810 = FStar_Util.must result_opt in
                                  {
                  ...
                  | FStar_Pervasives_Native.Some s ->
                      ...
                      then FStar_Pervasives_Native.None
                        ...
                        (let uu____3915 =
                         ...
                         FStar_Pervasives_Native.Some uu____3915) in
                let labels =
                      ...
                      | UNSAT uu____4380 ->
                          (if fresh
                           then ()
                             ...
                             (let uu____4384 =
                                let uu____4395 = FStar_ST.op_Bang bg_z3_proc in
                                uu____4395.store in
...
let (refresh : unit -> unit) =
  fun uu____5120 ->
    let qdata =
      let uu____5130 =
        let uu____5143 = FStar_ST.op_Bang bg_z3_proc in uu____5143.extract in
      uu____5130 () in
    (let uu____5164 =
       let uu____5168 =
         let uu____5176 = FStar_ST.op_Bang bg_z3_proc in uu____5176.refresh in
       uu____5168 () in
                        ...
                        FStar_List.filter
                          (fun uu___2_5343 ->
                             ...
                             | FStar_SMTEncoding_Term.Assume uu____5345 ->
                                 true
                             | uu____5347 -> false) decls in
                      let n1 = FStar_List.length decls1 in
                      (((name, n1) :: out), (n1 + _total))
                  | uu____5364 -> (out, _total))) ([], Prims.int_zero) theory in
          ...
          FStar_List.sortWith
            (fun uu____5426 ->
               fun uu____5427 ->
                 ...
                 | ((uu____5453, n1), (uu____5455, m)) -> m - n1) modules in
        (if modules1 <> []
         then
      ...
      (let uu____5588 =
         ...
         then
           ...
           (let uu____5768 =
            ...
            (uu____5768, FStar_Pervasives_Native.None)) in
                ...
                fun uu____5950 ->
                  let uu____5961 =
                    ...
                    FStar_Profiling.profile
                      ...
                      uu____5971 "FStar.SMTEncoding.Z3" in
