      ...
      Prims.bool ->
        Prims.string ->
          FStar_SMTEncoding_Term.error_labels ->
            (z3status,z3statistics) FStar_Pervasives_Native_Tuple2.tuple2)
  =
  fun log_file  ->
    fun r  ->
      fun fresh  ->
...
let (snapshot :
  Prims.string -> (Prims.int,unit) FStar_Pervasives_Native_Tuple2.tuple2) =
