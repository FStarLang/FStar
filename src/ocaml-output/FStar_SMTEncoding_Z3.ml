...
let z3version_as_string: z3version -> Prims.string =
  fun uu___91_48  ->
    ...
    | Z3V (i,j,k) ->
        ...
        let _0_365 = FStar_Util.string_of_int j in
        let _0_364 = FStar_Util.string_of_int k in
        FStar_Util.format3 "%s.%s.%s" _0_366 _0_365 _0_364
let z3v_compare:
...
let get_z3version: Prims.unit -> z3version =
  fun uu____97  ->
    ...
    | None  ->
        let uu____105 =
          let _0_367 = FStar_Options.z3_exe () in
          FStar_Util.run_proc _0_367 "-version" "" in
  ...
  fun uu____140  ->
    ...
    (let uu____143 =
     ...
     | true  ->
         let _0_370 =
           FStar_Util.Failure
             (let _0_369 = z3version_as_string z3_v in
              FStar_Util.format1
                "Z3 4.5.0 recommended; at least Z3 v4.4.1 required; got %s\n"
                _0_369) in
         FStar_All.pipe_left Prims.raise _0_370
     | uu____144 -> ());
    (let _0_376 =
       let _0_375 =
         let _0_373 =
           let _0_372 =
             let _0_371 = FStar_Util.string_of_int (FStar_Options.z3_seed ()) in
             FStar_Util.format1 "smt.random_seed=%s" _0_371 in
           [_0_372] in
         "-smt2 -in auto_config=false model=true smt.relevancy=2" :: _0_373 in
       let _0_374 = FStar_Options.z3_cliopt () in
       FStar_List.append _0_375 _0_374 in
     FStar_String.concat " " _0_376)
...
let tid: Prims.unit -> Prims.string =
  fun uu____238  ->
    let _0_377 = FStar_Util.current_tid () in
    FStar_All.pipe_right _0_377 FStar_Util.string_of_int
let new_z3proc: Prims.string -> FStar_Util.proc =
  fun id  ->
    let cond pid s = let x = (FStar_Util.trim_string s) = "Done!" in x in
    let _0_379 = FStar_Options.z3_exe () in
    let _0_378 = ini_params () in
    FStar_Util.start_process id _0_379 _0_378 cond
type bgproc =
  {
...
let query_logging: query_log =
    ...
    | Some n ->
        let file_name =
          let uu____430 =
            ...
            FStar_List.tryFind
              (fun uu____436  ->
                 match uu____436 with | (m,uu____440) -> n = m) _0_380 in
          match uu____430 with
          | None  ->
              ((let _0_382 =
                  let _0_381 = FStar_ST.read used_file_names in
                  (n, (Prims.parse_int "0")) :: _0_381 in
                FStar_ST.write used_file_names _0_382);
               n)
          | Some (uu____461,k) ->
              ((let _0_384 =
                  let _0_383 = FStar_ST.read used_file_names in
                  (n, (k + (Prims.parse_int "1"))) :: _0_383 in
                FStar_ST.write used_file_names _0_384);
               (let _0_385 =
                  FStar_Util.string_of_int (k + (Prims.parse_int "1")) in
                FStar_Util.format2 "%s-%s" n _0_385)) in
  ...
  let append_to_log str =
    let _0_386 = get_log_file () in FStar_Util.append_to_file _0_386 str in
...
let bg_z3_proc: bgproc =
  ...
  let z3proc uu____547 =
    (let uu____549 = let _0_389 = FStar_ST.read the_z3proc in _0_389 = None in
     match uu____549 with
     | true  ->
         let _0_390 = Some (new_proc ()) in FStar_ST.write the_z3proc _0_390
     | uu____557 -> ());
...
let at_log_file: Prims.unit -> Prims.string =
  fun uu____601  ->
    ...
    | true  ->
        let _0_393 = query_logging.log_file_name () in
        Prims.strcat "@" _0_393
    | uu____603 -> ""
          ...
          | true  ->
              let uu____657 =
                (((FStar_List.length lines) >= (Prims.parse_int "2")) &&
                   (let _0_396 = FStar_List.hd lines in
                    starts_with '(' _0_396))
               ...
               | true  ->
                   (FStar_Util.print_string
                      (let _0_400 =
                       ...
                       let _0_399 = at_log_file () in
                       Prims.strcat _0_400 _0_399);
                    FStar_List.iter
                      (fun s  ->
                         FStar_Util.print_string
