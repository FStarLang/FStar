...
let (uu___is_SAT : z3status -> Prims.bool) =
  fun projectee -> match projectee with | SAT _0 -> true | uu____373 -> false
...
let (uu___is_KILLED : z3status -> Prims.bool) =
  fun projectee -> match projectee with | KILLED -> true | uu____506 -> false
    ...
    let uu____667 =
      let uu____669 =
        ...
        (let uu____672 = FStar_ST.op_Bang ctr in
         FStar_All.pipe_right uu____672 FStar_Util.string_of_int) in
...
let (query_logging : query_log) =
  ...
  let next_file_name uu____1187 =
    ...
    let file_name =
      let uu____1192 =
        ...
        FStar_List.tryFind
          (fun uu____1254 ->
             match uu____1254 with | (m, uu____1263) -> n1 = m) uu____1201 in
      ...
      | FStar_Pervasives_Native.Some (uu____1374, k) ->
          ((let uu____1387 =
           ...
           (let uu____1484 =
            ...
            FStar_Util.format2 "%s-%s" n1 uu____1484)) in
  ...
  let append_to_log str =
    ...
    match uu____1653 with | (f, nm) -> (FStar_Util.append_to_file f str; nm) in
...
let (bg_z3_proc : bgproc FStar_ST.ref) =
  ...
  let restart uu____2011 =
    ...
    (let uu____2037 =
     ...
     FStar_ST.op_Colon_Equals the_z3proc uu____2037) in
  FStar_Util.mk_ref
    {
                                  ...
                                  | uu____2889 ->
                                      ...
                                      FStar_Errors.log_issue r
                                        (FStar_Errors.Warning_UnexpectedZ3Output,
                                          msg));
                                 (let uu____2905 = FStar_Util.must result_opt in
                                  {
                ...
                | FStar_Pervasives_Native.Some s ->
                    ...
                    then FStar_Pervasives_Native.None
                      ...
                      (let uu____3000 =
                       ...
                       FStar_Pervasives_Native.Some uu____3000) in
              let labels =
                  ...
                  | uu___383_3745 ->
                      ...
                      then
                        Obj.magic
                          (Obj.repr
                             ((let uu____3753 =
                                 let uu____3758 = FStar_ST.op_Bang bg_z3_proc in
...
let (refresh : unit -> unit) =
  fun uu____4666 ->
    (let uu____4668 =
     ...
     then
       let uu____4674 =
         let uu____4679 = FStar_ST.op_Bang bg_z3_proc in uu____4679.refresh in
       uu____4674 ()
     else ());
          ...
          FStar_List.sortWith
            (fun uu____4922 ->
               fun uu____4923 ->
                 ...
                 | ((uu____4949, n1), (uu____4951, m)) -> m - n1) modules in
        (if modules1 <> []
         then
      ...
      (let uu____5084 =
         ...
         then
           ...
           (let uu____5264 =
            ...
            (uu____5264, FStar_Pervasives_Native.None)) in
