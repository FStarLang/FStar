  ...
  fun uu____140  ->
    ...
    (let _0_365 =
       let _0_364 =
         let _0_362 =
           let _0_361 =
             let _0_360 = FStar_Util.string_of_int (FStar_Options.z3_seed ()) in
             FStar_Util.format1 "smt.random_seed=%s" _0_360 in
           [_0_361] in
         "-smt2 -in auto_config=false model=true smt.relevancy=2" :: _0_362 in
    ...
    | Some n ->
        let file_name =
          let uu____430 =
            ...
            FStar_List.tryFind
              (fun uu____436  ->
                 match uu____436 with | (m,uu____440) -> n = m) _0_369 in
          ...
          | Some (uu____461,k) ->
              ((let _0_373 =
               ...
               (let _0_374 =
                ...
                FStar_Util.format2 "%s-%s" n _0_374)) in
      ...
      new_z3proc
        (let _0_377 =
           ...
           (let _0_376 = FStar_ST.read ctr in
            FStar_All.pipe_right _0_376 FStar_Util.string_of_int) in
         FStar_Util.format1 "bg-%s" _0_377) in
  let z3proc uu____547 =
    (let uu____549 = let _0_378 = FStar_ST.read the_z3proc in _0_378 = None in
     if uu____549
     then let _0_379 = Some (new_proc ()) in FStar_ST.write the_z3proc _0_379
     else ());
    ...
    fun input  ->
      let parse z3out =
          ...
          then
            let uu____657 =
              (((FStar_List.length lines) >= (Prims.parse_int "2")) &&
                ...
                && (let _0_386 = last lines in ends_with ')' _0_386) in
            (if uu____657
             then
          ...
          let parse_core s =
            ...
            then None
              ...
              (let _0_391 =
               ...
               FStar_All.pipe_right _0_391 (fun _0_390  -> Some _0_390)) in
          match lines with
        ...
        let unsat_core_and_lblnegs lines succeeded =
          ...
          | (core_opt,rest) ->
              let _0_394 = lblnegs rest succeeded in (core_opt, _0_394) in
        let rec result x =
          match x with
          | "timeout"::tl -> TIMEOUT []
          | "unknown"::tl ->
          ...
          | uu____803 ->
              ...
              FStar_All.pipe_left failwith _0_399 in
        result lines in
      let cond pid s = let x = (FStar_Util.trim_string s) = "Done!" in x in
      let stdout =
        if fresh
                      ...
                      let _0_406 =
                        FStar_Util.Inr
                          (let _0_405 = ekind status in
                           (failing_assertions, _0_405)) in
                      (_0_406, elapsed_time))) in
              result
                           ...
                           let _0_433 =
                             FStar_SMTEncoding_Term.Caption
                               (let _0_432 =
                                  FStar_All.pipe_right core
                                    (FStar_String.concat ", ") in
                                Prims.strcat "UNSAT CORE: " _0_432) in
                           [_0_433] in
