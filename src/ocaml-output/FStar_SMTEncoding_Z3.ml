    ...
    | FStar_Pervasives_Native.Some n1 ->
        let file_name =
          let uu____481 =
            ...
            FStar_List.tryFind
              (fun uu____496  ->
                 match uu____496 with | (m,uu____500) -> n1 = m) uu____485
             in
          ...
          | FStar_Pervasives_Native.Some (uu____524,k) ->
              ((let uu____529 =
               ...
               (let uu____549 =
                ...
                FStar_Util.format2 "%s-%s" n1 uu____549))
           in
...
let bg_z3_proc : bgproc =
  ...
  let z3proc uu____666 =
    ...
    (let uu____682 = FStar_ST.read the_z3proc  in FStar_Util.must uu____682)
     in
  let x = []  in
  ...
  let refresh uu____703 =
    ...
    (let uu____707 =
       let uu____709 = new_proc ()  in FStar_Pervasives_Native.Some uu____709
        in
  ...
  let restart uu____717 =
    ...
    (let uu____725 =
       let uu____727 = new_proc ()  in FStar_Pervasives_Native.Some uu____727
        in
      ...
      let parse z3out =
        ...
        let get_data lines1 =
          ...
          (let uu____885 = FStar_ST.read core  in
           ...
           (uu____885, statistics, uu____892))
           in
          ...
          | uu____946 ->
              let uu____948 =
                ...
                FStar_Util.format1
                  ...
                  uu____949
                 in
              FStar_All.pipe_left failwith uu____948
           in
        let uu____953 = get_data lines  in
        match uu____953 with
        | (core,statistics,reason_unknown) ->
            let uu____968 = result lines core  in (uu____968, statistics)
         in
      let cond pid s = let x = (FStar_Util.trim_string s) = "Done!"  in x  in
      let stdout1 =
        if fresh1
                     ...
                     | UNKNOWN lblnegs ->
                         ((let uu____1522 = FStar_Options.debug_any ()  in
                          ...
                          (let failing_assertions =
                           ...
                           (uu____1616, elapsed_time, statistics)))
                      in
                   result)
...
let pop : Prims.string -> Prims.unit =
  fun msg  ->
    (let uu____1895 =
       let uu____1898 = FStar_ST.read fresh_scope  in
       FStar_List.tl uu____1898  in
...
let ask_offline :
  (FStar_SMTEncoding_Term.decls_t ->
     (FStar_SMTEncoding_Term.decls_t,Prims.bool)
       FStar_Pervasives_Native.tuple2)
    -> FStar_SMTEncoding_Term.decls_t -> Prims.unit
  =
  fun filter1  ->
    fun qry  ->
      let theory =
        let uu____2337 = FStar_ST.read bg_scope  in
        FStar_List.append uu____2337
          (FStar_List.append [FStar_SMTEncoding_Term.Push]
             (FStar_List.append qry [FStar_SMTEncoding_Term.Pop]))
         in
      let uu____2342 = filter1 theory  in
      match uu____2342 with
      | (theory1,used_unsat_core) ->
          let input = mk_input theory1  in FStar_ST.write bg_scope []
