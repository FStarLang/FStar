...
let ekind = (fun uu___93_965 -> (match (uu___93_965) with
...
let uu____973 = (let _0_429 = (FStar_Util.now ())
in (FStar_Util.time_diff start _0_429))
...
| true -> begin
(let _0_430 = (FStar_Util.format1 "Z3 says: %s\n" (status_to_string status))
in (FStar_All.pipe_left FStar_Util.print_string _0_430))
end
| uu____1063 -> begin
()
end));
...
in (let _0_432 = FStar_Util.Inr ((let _0_431 = (ekind status)
in ((failing_assertions), (_0_431))))
in ((_0_432), (elapsed_time))));
)
end)
in result)
end))))))
...
and run_job : z3job  ->  Prims.unit = (fun j -> (let _0_433 = (j.job ())
in (FStar_All.pipe_left j.callback _0_433)))


let init : Prims.unit  ->  Prims.unit = (fun uu____1281 -> (

let n_runners = (let _0_434 = (FStar_Options.n_cores ())
in (_0_434 - (Prims.parse_int "1")))
in (
...
(let _0_436 = (let _0_435 = (FStar_ST.read job_queue)
in (FStar_List.append _0_435 ((j)::[])))
in (FStar_ST.write job_queue _0_436));
...
let uu____1327 = (with_monitor job_queue (fun uu____1336 -> (let _0_438 = (FStar_ST.read pending_jobs)
in (let _0_437 = (FStar_List.length (FStar_ST.read job_queue))
in ((_0_438), (_0_437))))))
in (match (uu____1327) with
| (n, m) -> begin
(match (((n + m) = (Prims.parse_int "0"))) with
| true -> begin
(let _0_439 = (FStar_Errors.report_all ())
in (FStar_All.pipe_right _0_439 Prims.ignore))
end
| uu____1350 -> begin
...
let push : Prims.string  ->  Prims.unit = (fun msg -> ((let _0_441 = (let _0_440 = (FStar_ST.read fresh_scope)
in ((FStar_SMTEncoding_Term.Caption (msg))::(FStar_SMTEncoding_Term.Push)::[])::_0_440)
in (FStar_ST.write fresh_scope _0_441));
(let _0_443 = (let _0_442 = (FStar_ST.read bg_scope)
in (FStar_List.append ((FStar_SMTEncoding_Term.Caption (msg))::(FStar_SMTEncoding_Term.Push)::[]) _0_442))
in (FStar_ST.write bg_scope _0_443));
))


let pop : Prims.string  ->  Prims.unit = (fun msg -> ((let _0_444 = (FStar_List.tl (FStar_ST.read fresh_scope))
in (FStar_ST.write fresh_scope _0_444));
(let _0_446 = (let _0_445 = (FStar_ST.read bg_scope)
in (FStar_List.append ((FStar_SMTEncoding_Term.Pop)::(FStar_SMTEncoding_Term.Caption (msg))::[]) _0_445))
in (FStar_ST.write bg_scope _0_446));
))


let giveZ3 : FStar_SMTEncoding_Term.decl Prims.list  ->  Prims.unit = (fun decls -> ((FStar_All.pipe_right decls (FStar_List.iter (fun uu___94_1413 -> (match (uu___94_1413) with
...
in (FStar_List.append (FStar_List.rev decls) _0_447))
...
(let _0_449 = (FStar_List.rev (FStar_ST.read fresh_scope))
in (FStar_All.pipe_right _0_449 FStar_List.flatten));
)
end
| uu____1460 -> begin
(
...
let missed = (let _0_451 = (FStar_All.pipe_right core (FStar_List.filter (fun nm -> (let _0_450 = (FStar_All.pipe_right th (FStar_Util.for_some (fun uu___95_1650 -> (match (uu___95_1650) with
...
in (FStar_All.pipe_right _0_450 Prims.op_Negation)))))
in (FStar_All.pipe_right _0_451 (FStar_String.concat ", ")))
in (

let included = (let _0_452 = (FStar_All.pipe_right th (FStar_List.collect (fun uu___96_1660 -> (match (uu___96_1660) with
...
in (FStar_All.pipe_right _0_452 (FStar_String.concat ", ")))
...
in (let _0_456 = (FStar_Util.string_of_int n_retained)
in (let _0_455 = (match ((n <> n_retained)) with
| true -> begin
(let _0_453 = (FStar_Util.string_of_int n)
in (FStar_Util.format2 " (expected %s (%s); replay may be inaccurate)" _0_453 missed))
end
| uu____1680 -> begin
""
end)
in (let _0_454 = (FStar_Util.string_of_int n_pruned)
in (FStar_Util.print3 "Hint-info: Retained %s assertions%s and pruned %s assertions using recorded unsat core\n" _0_456 _0_455 _0_454))))))
end
| uu____1681 -> begin
()
end));
(let _0_460 = (let _0_459 = (let _0_458 = FStar_SMTEncoding_Term.Caption ((let _0_457 = (FStar_All.pipe_right core (FStar_String.concat ", "))
in (Prims.strcat "UNSAT CORE: " _0_457)))
in (_0_458)::[])
in (FStar_List.append theory' _0_459))
in ((_0_460), (true)));
))
end))
end))
...
let input = (let _0_461 = (FStar_List.map (FStar_SMTEncoding_Term.declToSmt (z3_options ())) theory)
in (FStar_All.pipe_right _0_461 (FStar_String.concat "\n")))
in ((
