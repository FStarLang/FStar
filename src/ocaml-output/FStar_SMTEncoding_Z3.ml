...
let (parse_z3_version_lines :
  ...
  fun out ->
    ...
    | x::uu____24 ->
        ...
        let rec aux uu___121_40 =
          match uu___121_40 with
          | hash::[] ->
              let n1 =
...
let (z3hash_warning_message :
  ...
  fun uu____76 ->
    let run_proc_result =
      ...
      with | uu___126_90 -> FStar_Pervasives_Native.None in
...
let (uu___is_SAT : z3status -> Prims.bool) =
  fun projectee -> match projectee with | SAT _0 -> true | uu____290 -> false
...
let (uu___is_KILLED : z3status -> Prims.bool) =
  fun projectee -> match projectee with | KILLED -> true | uu____397 -> false
type z3statistics = Prims.string FStar_Util.smap
let (status_tag : z3status -> Prims.string) =
  fun uu___122_404 ->
    match uu___122_404 with
    | SAT uu____405 -> "sat"
    ...
    | FStar_Pervasives_Native.Some n1 ->
        let file_name =
          let uu____999 =
            ...
            FStar_List.tryFind
              (fun uu____1073 ->
                 match uu____1073 with | (m, uu____1079) -> n1 = m)
              uu____1006 in
          ...
          | FStar_Pervasives_Native.Some (uu____1209, k) ->
              ((let uu____1216 =
               ...
               (let uu____1340 =
                ...
                FStar_Util.format2 "%s-%s" n1 uu____1340)) in
...
let (bg_z3_proc : bgproc FStar_ST.ref) =
      ...
      let uu____1974 =
        let uu____1975 =
          ...
          (let uu____2010 = FStar_ST.op_Bang ctr in
           FStar_All.pipe_right uu____2010 FStar_Util.string_of_int) in
        FStar_Util.format1 "bg-%s" uu____1975 in
      new_z3proc uu____1974 in
  ...
  let restart uu____2287 =
    ...
    (let uu____2335 =
     ...
     FStar_ST.op_Colon_Equals the_z3proc uu____2335) in
  FStar_Util.mk_ref
    {
                         ...
                         (match uu____2980 with
                          | (labels, lines5) ->
                              ...
                              ((match remaining with
                               ...
                               (let uu____3057 = FStar_Util.must result_opt in
                                {
              ...
              | FStar_Pervasives_Native.Some s ->
                  ...
                  then FStar_Pervasives_Native.None
                    ...
                    (let uu____3118 =
                     ...
                     FStar_Pervasives_Native.Some uu____3118) in
            let labels =
                    ...
                    Obj.magic
                      (if
                       ...
                       then
                         Obj.repr
                           ((let uu____3715 =
                               let uu____3720 = FStar_ST.op_Bang bg_z3_proc in
                               uu____3720.refresh in
                             uu____3715 ());
                            FStar_Exn.raise uu___128_3708)
                       else Obj.repr (failwith "unreachable")) in
...
let (refresh : unit -> unit) =
  fun uu____4560 ->
    (let uu____4562 =
     ...
     then
       let uu____4564 =
         let uu____4569 = FStar_ST.op_Bang bg_z3_proc in uu____4569.refresh in
       uu____4564 ()
     else ());
    (let uu____4590 =
       let uu____4593 =
    ...
    let uu____4682 =
      ...
      then
        ...
        | (prefix1, check_sat, suffix) ->
            ...
            let uncaption uu___125_4820 =
              match uu___125_4820 with
              | FStar_SMTEncoding_Term.Caption uu____4821 ->
                  FStar_SMTEncoding_Term.Caption ""
              | FStar_SMTEncoding_Term.Assume a ->
                  FStar_SMTEncoding_Term.Assume
                    (let uu___130_4825 = a in
                     {
                       FStar_SMTEncoding_Term.assumption_term =
                         (uu___130_4825.FStar_SMTEncoding_Term.assumption_term);
                       FStar_SMTEncoding_Term.assumption_caption =
                         FStar_Pervasives_Native.None;
                       FStar_SMTEncoding_Term.assumption_name =
                         (uu___130_4825.FStar_SMTEncoding_Term.assumption_name);
                       FStar_SMTEncoding_Term.assumption_fact_ids =
                         (uu___130_4825.FStar_SMTEncoding_Term.assumption_fact_ids)
                     })
