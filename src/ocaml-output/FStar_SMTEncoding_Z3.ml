      ...
      let parse z3out =
        ...
        let get_data lines1 =
            ...
            then None
              ...
              (let uu____773 =
                 FStar_All.pipe_right (FStar_Util.split s2 " ")
                  ...
                  in
               FStar_All.pipe_right uu____773 (fun _0_27  -> Some _0_27))
             in
          ...
          (let uu____866 = FStar_ST.read core  in
           ...
           (uu____866, statistics, uu____873))
           in
          ...
          | uu____927 ->
              let uu____929 =
                ...
                FStar_Util.format1
                  ...
                  uu____930
                 in
              FStar_All.pipe_left failwith uu____929
           in
        ...
        | (core,statistics,reason_unknown) ->
            ((let uu____950 = FStar_Options.print_z3_statistics ()  in
             ...
             (let uu____952 = result lines core  in (uu____952, statistics)))
         in
      let cond pid s = let x = (FStar_Util.trim_string s) = "Done!"  in x  in
      let stdout1 =
        if fresh1
...
let z3_job :
  ...
  fun fresh1  ->
    fun label_messages  ->
      fun input  ->
        fun uu____1095  ->
          let ekind uu___99_1106 =
            match uu___99_1106 with
                     ...
                     | TIMEOUT lblnegs|SAT lblnegs|UNKNOWN lblnegs ->
                         ((let uu____1218 = FStar_Options.debug_any ()  in
                          ...
                          (let failing_assertions =
                           ...
                           (uu____1312, elapsed_time, statistics)))
                      in
                   result)
...
let pop : Prims.string -> Prims.unit =
  fun msg  ->
    (let uu____1591 =
       let uu____1594 = FStar_ST.read fresh_scope  in
       FStar_List.tl uu____1594  in
