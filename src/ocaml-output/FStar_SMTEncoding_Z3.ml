...
let query_logging : query_log =
  ...
  let log_file_name uu____635 =
    ...
    match uu____636 with | None  -> failwith "no log file" | Some n1 -> n1
     in
            ...
            then None
              ...
              (let uu____779 =
                 FStar_All.pipe_right (FStar_Util.split s2 " ")
                  ...
                  in
               FStar_All.pipe_right uu____779 (fun _0_38  -> Some _0_38))
             in
...
let z3_job :
  ...
  fun fresh1  ->
    fun label_messages  ->
      fun input  ->
        fun uu____1115  ->
          let ekind uu___98_1126 =
            match uu___98_1126 with
