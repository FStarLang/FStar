...
let ask_offline : (FStar_SMTEncoding_Term.decls_t  ->  (FStar_SMTEncoding_Term.decls_t * Prims.bool))  ->  FStar_SMTEncoding_Term.decls_t  ->  Prims.unit = (fun filter1 qry -> (

let theory = (

let uu____2337 = (FStar_ST.read bg_scope)
in (FStar_List.append uu____2337 (FStar_List.append ((FStar_SMTEncoding_Term.Push)::[]) (FStar_List.append qry ((FStar_SMTEncoding_Term.Pop)::[])))))
in (

let uu____2342 = (filter1 theory)
