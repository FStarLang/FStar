...
let uu____1814 = (FStar_All.pipe_right th (FStar_Util.for_some (fun uu___95_1816 -> (match (uu___95_1816) with
...
let uu____1823 = (FStar_All.pipe_right th (FStar_List.collect (fun uu___96_1827 -> (match (uu___96_1827) with
