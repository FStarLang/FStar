...
let z3version_as_string : z3version  ->  Prims.string = (fun uu___93_48 -> (match (uu___93_48) with
| Z3V_Unknown (s) -> begin
...
let status_to_string : z3status  ->  Prims.string = (fun uu___94_248 -> (match (uu___94_248) with
| SAT (uu____249) -> begin
"sat"
end
...
let ekind = (fun uu___95_1121 -> (match (uu___95_1121) with
...
let giveZ3 : FStar_SMTEncoding_Term.decl Prims.list  ->  Prims.unit = (fun decls -> ((FStar_All.pipe_right decls (FStar_List.iter (fun uu___96_1619 -> (match (uu___96_1619) with
...
let uu____1809 = (FStar_All.pipe_right th (FStar_Util.for_some (fun uu___97_1811 -> (match (uu___97_1811) with
...
let uu____1818 = (FStar_All.pipe_right th (FStar_List.collect (fun uu___98_1822 -> (match (uu___98_1822) with
