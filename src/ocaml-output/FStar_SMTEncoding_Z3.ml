...
let query_logging : query_log =
    ...
    | Some n1 ->
        let file_name =
          let uu____457 =
            ...
            FStar_List.tryFind
              (fun uu____472  ->
                 match uu____472 with | (m,uu____476) -> n1 = m) uu____461
             in
          ...
          | Some (uu____500,k) ->
              ((let uu____505 =
               ...
               (let uu____525 =
                ...
                FStar_Util.format2 "%s-%s" n1 uu____525))
           in
  ...
  let log_file_name uu____611 =
    ...
    match uu____612 with | None  -> failwith "no log file" | Some n1 -> n1
     in
...
let bg_z3_proc : bgproc =
      ...
      let uu____630 =
        let uu____631 =
          ...
          (let uu____636 = FStar_ST.read ctr  in
           FStar_All.pipe_right uu____636 FStar_Util.string_of_int)
           in
        FStar_Util.format1 "bg-%s" uu____631  in
      new_z3proc uu____630
     in
  let z3proc uu____642 =
    ...
    (let uu____658 = FStar_ST.read the_z3proc  in FStar_Util.must uu____658)
     in
  let x = []  in
      ...
      let parse z3out =
        ...
        let get_data lines1 =
            ...
            then None
              ...
              (let uu____755 =
                 FStar_All.pipe_right (FStar_Util.split s2 " ")
                  ...
                  in
               FStar_All.pipe_right uu____755 (fun _0_28  -> Some _0_28))
             in
          ...
          (let uu____848 = FStar_ST.read core  in
           ...
           (uu____848, statistics, uu____855))
           in
          ...
          | uu____909 ->
              let uu____911 =
                ...
                FStar_Util.format1
                  ...
                  uu____912
                 in
              FStar_All.pipe_left failwith uu____911
           in
        let uu____916 = get_data lines  in
        match uu____916 with
        | (core,statistics,reason_unknown) ->
            let uu____931 = result lines core  in (uu____931, statistics)
         in
      let cond pid s = let x = (FStar_Util.trim_string s) = "Done!"  in x  in
      let stdout1 =
        if fresh1
...
let z3_job :
  ...
  fun fresh1  ->
    fun label_messages  ->
      fun input  ->
        fun uu____1074  ->
          let ekind uu___96_1085 =
            match uu___96_1085 with
                     ...
                     | TIMEOUT lblnegs|SAT lblnegs|UNKNOWN lblnegs ->
                         ((let uu____1197 = FStar_Options.debug_any ()  in
                          ...
                          (let failing_assertions =
                           ...
                           (uu____1291, elapsed_time, statistics)))
                      in
                   result)
...
let pop : Prims.string -> Prims.unit =
  fun msg  ->
    (let uu____1570 =
       let uu____1573 = FStar_ST.read fresh_scope  in
       FStar_List.tl uu____1573  in
