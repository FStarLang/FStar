...
in (FStar_All.pipe_right uu____763 (fun _0_27 -> Some (_0_27))))
end))))
in (match (lines) with
...
let ekind = (fun uu___92_1075 -> (match (uu___92_1075) with
...
let giveZ3 : FStar_SMTEncoding_Term.decl Prims.list  ->  Prims.unit = (fun decls -> ((FStar_All.pipe_right decls (FStar_List.iter (fun uu___93_1582 -> (match (uu___93_1582) with
...
let uu____1834 = (FStar_All.pipe_right th (FStar_Util.for_some (fun uu___94_1836 -> (match (uu___94_1836) with
...
let uu____1844 = (FStar_All.pipe_right th (FStar_List.collect (fun uu___95_1848 -> (match (uu___95_1848) with
