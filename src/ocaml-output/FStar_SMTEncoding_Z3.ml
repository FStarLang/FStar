...
let z3version_as_string : z3version -> Prims.string =
  fun uu___91_48  ->
    ...
    | Z3V (i,j,k) ->
        let _0_384 = FStar_Util.string_of_int i  in
        let _0_383 = FStar_Util.string_of_int j  in
        let _0_382 = FStar_Util.string_of_int k  in
        FStar_Util.format3 "%s.%s.%s" _0_384 _0_383 _0_382
...
let get_z3version : Prims.unit -> z3version =
  fun uu____97  ->
    ...
    | None  ->
        let uu____105 =
          let _0_385 = FStar_Options.z3_exe ()  in
          FStar_Util.run_proc _0_385 "-version" ""  in
  ...
  fun uu____140  ->
    ...
    (let uu____143 =
     ...
     | true  ->
         let _0_388 =
           FStar_Util.Failure
             (let _0_387 = z3version_as_string z3_v  in
              FStar_Util.format1
                "Z3 4.5.0 recommended; at least Z3 v4.4.1 required; got %s\n"
                _0_387)
            in
         FStar_All.pipe_left Prims.raise _0_388
     | uu____144 -> ());
    (let _0_394 =
       let _0_393 =
         let _0_391 =
           let _0_390 =
             let _0_389 = FStar_Util.string_of_int (FStar_Options.z3_seed ())
                in
             FStar_Util.format1 "smt.random_seed=%s" _0_389  in
           [_0_390]  in
         "-smt2 -in auto_config=false model=true smt.relevancy=2" :: _0_391
          in
       let _0_392 = FStar_Options.z3_cliopt ()  in
       FStar_List.append _0_393 _0_392  in
     FStar_String.concat " " _0_394)
...
let tid : Prims.unit -> Prims.string =
  fun uu____238  ->
    let _0_395 = FStar_Util.current_tid ()  in
    FStar_All.pipe_right _0_395 FStar_Util.string_of_int
  
let new_z3proc : Prims.string -> FStar_Util.proc =
  fun id  ->
    let cond pid s = let x = (FStar_Util.trim_string s) = "Done!"  in x  in
    let _0_397 = FStar_Options.z3_exe ()  in
    let _0_396 = ini_params ()  in
    FStar_Util.start_process id _0_397 _0_396 cond
...
let query_logging : query_log =
    ...
    | Some n ->
        let file_name =
          let uu____430 =
            ...
            FStar_List.tryFind
              (fun uu____436  ->
                 match uu____436 with | (m,uu____440) -> n = m) _0_398
             in
          match uu____430 with
          | None  ->
              ((let _0_400 =
                  let _0_399 = FStar_ST.read used_file_names  in
                  (n, (Prims.parse_int "0")) :: _0_399  in
                FStar_ST.write used_file_names _0_400);
               n)
          | Some (uu____461,k) ->
              ((let _0_402 =
                  let _0_401 = FStar_ST.read used_file_names  in
                  (n, (k + (Prims.parse_int "1"))) :: _0_401  in
                FStar_ST.write used_file_names _0_402);
               (let _0_403 =
                  FStar_Util.string_of_int (k + (Prims.parse_int "1"))  in
                FStar_Util.format2 "%s-%s" n _0_403))
           in
  ...
  let append_to_log str =
    let _0_404 = get_log_file ()  in FStar_Util.append_to_file _0_404 str  in
...
let bg_z3_proc : bgproc =
  ...
  let new_proc =
    ...
    fun uu____537  ->
      new_z3proc
        (let _0_406 =
           FStar_Util.incr ctr;
           (let _0_405 = FStar_ST.read ctr  in
            FStar_All.pipe_right _0_405 FStar_Util.string_of_int)
            in
         FStar_Util.format1 "bg-%s" _0_406)
     in
  let z3proc uu____547 =
    (let uu____549 = let _0_407 = FStar_ST.read the_z3proc  in _0_407 = None
        in
     match uu____549 with
     | true  ->
         let _0_408 = Some (new_proc ())  in FStar_ST.write the_z3proc _0_408
     | uu____557 -> ());
  ...
  let refresh uu____577 =
    ...
    (let _0_409 = Some (new_proc ())  in FStar_ST.write the_z3proc _0_409);
  ...
  let restart uu____588 =
    ...
    (let _0_410 = Some (new_proc ())  in FStar_ST.write the_z3proc _0_410);
...
let at_log_file : Prims.unit -> Prims.string =
  fun uu____601  ->
    ...
    | true  ->
        let _0_411 = query_logging.log_file_name ()  in
        Prims.strcat "@" _0_411
    | uu____603 -> ""
    ...
    fun input  ->
      let parse z3out =
          ...
          | true  ->
              let uu____657 =
                (((FStar_List.length lines) >= (Prims.parse_int "2")) &&
                   (let _0_414 = FStar_List.hd lines  in
                    starts_with '(' _0_414))
                  && (let _0_415 = last lines  in ends_with ')' _0_415)
                 in
              (match uu____657 with
               | true  ->
                   (FStar_Util.print_string
                      (let _0_418 =
                         let _0_416 = query_logging.get_module_name ()  in
                         FStar_Util.format1 "BEGIN-STATS %s\n" _0_416  in
                       let _0_417 = at_log_file ()  in
                       Prims.strcat _0_418 _0_417);
                    FStar_List.iter
                      (fun s  ->
                         FStar_Util.print_string
        ...
        let unsat_core_and_lblnegs lines succeeded =
          ...
          | (core_opt,rest) ->
              let _0_423 = lblnegs rest succeeded  in (core_opt, _0_423)
           in
        let rec result x =
          match x with
          | "timeout"::tl -> TIMEOUT []
          ...
          | hd::tl ->
              ((let _0_425 =
                  let _0_424 = query_logging.get_module_name ()  in
                  FStar_Util.format2 "%s: Unexpected output from Z3: %s\n"
                    _0_424 hd
                   in
                FStar_Errors.warn FStar_Range.dummyRange _0_425);
               result tl)
          | uu____803 ->
              let _0_428 =
                let _0_427 =
                ...
                FStar_Util.format1
                 ...
                 in
              FStar_All.pipe_left failwith _0_428
           in
        result lines  in
      let cond pid s = let x = (FStar_Util.trim_string s) = "Done!"  in x  in
      let stdout =
        ...
        | true  ->
            let _0_431 = tid ()  in
            let _0_430 = FStar_Options.z3_exe ()  in
            let _0_429 = ini_params ()  in
            FStar_Util.launch_process _0_431 _0_430 _0_429 input cond
        | uu____815 ->
...
let z3_job :
  ...
  fun fresh  ->
    fun label_messages  ->
      fun input  ->
        fun uu____947  ->
          let ekind uu___93_963 =
            match uu___93_963 with
          ...
          let uu____971 =
            let _0_432 = FStar_Util.now ()  in
            FStar_Util.time_diff start _0_432  in
                ...
                | TIMEOUT lblnegs|SAT lblnegs|UNKNOWN lblnegs ->
                    ((let uu____1060 = FStar_Options.debug_any ()  in
                      ...
                      | true  ->
                          let _0_433 =
                            FStar_Util.format1 "Z3 says: %s\n"
                             ...
                             in
                          FStar_All.pipe_left FStar_Util.print_string _0_433
                      | uu____1061 -> ());
                     (let failing_assertions =
                      ...
                      let _0_435 =
                        FStar_Util.Inr
                          (let _0_434 = ekind status  in
                           (failing_assertions, _0_434))
                         in
                      (_0_435, elapsed_time)))
                 in
              result
...
and run_job : z3job -> Prims.unit =
  fun j  -> let _0_436 = j.job ()  in FStar_All.pipe_left j.callback _0_436
  ...
  fun fresh  ->
    fun j  ->
      ...
      | uu____1291 ->
          (FStar_Util.monitor_enter job_queue;
           (let _0_438 =
              let _0_437 = FStar_ST.read job_queue  in
              FStar_List.append _0_437 [j]  in
            FStar_ST.write job_queue _0_438);
    ...
    let rec aux uu____1319 =
      let uu____1320 =
        with_monitor job_queue
          (fun uu____1329  ->
             let _0_440 = FStar_ST.read pending_jobs  in
             let _0_439 = FStar_List.length (FStar_ST.read job_queue)  in
             (_0_440, _0_439))
         in
          ...
          (match (n + m) = (Prims.parse_int "0") with
           | true  ->
               (FStar_ST.write running false;
                (let _0_441 = FStar_Errors.report_all ()  in
                 FStar_All.pipe_right _0_441 Prims.ignore))
...
let push : Prims.string -> Prims.unit =
  fun msg  ->
    (let _0_443 =
       let _0_442 = FStar_ST.read fresh_scope  in
       [FStar_SMTEncoding_Term.Caption msg; FStar_SMTEncoding_Term.Push] ::
         _0_442
        in
     FStar_ST.write fresh_scope _0_443);
    (let _0_445 =
       let _0_444 = FStar_ST.read bg_scope  in
       FStar_List.append
         [FStar_SMTEncoding_Term.Caption msg; FStar_SMTEncoding_Term.Push]
         _0_444
        in
     FStar_ST.write bg_scope _0_445)
  
let pop : Prims.string -> Prims.unit =
  fun msg  ->
    (let _0_446 = FStar_List.tl (FStar_ST.read fresh_scope)  in
...
let giveZ3 : FStar_SMTEncoding_Term.decl Prims.list -> Prims.unit =
  fun decls  ->
    ...
    (let _0_450 =
       let _0_449 = FStar_ST.read bg_scope  in
       FStar_List.append (FStar_List.rev decls) _0_449  in
     FStar_ST.write bg_scope _0_450)
  ...
  fun fresh  ->
    ...
    | true  ->
        (FStar_ST.write bg_scope [];
         (let _0_451 = FStar_List.rev (FStar_ST.read fresh_scope)  in
          FStar_All.pipe_right _0_451 FStar_List.flatten))
    | uu____1456 ->
...
let refresh : Prims.unit -> Prims.unit =
  fun uu____1468  ->
    (let uu____1470 =
       let _0_452 = FStar_Options.n_cores ()  in
       _0_452 < (Prims.parse_int "2")  in
  ...
  fun core  ->
    fun label_messages  ->
      fun qry  ->
        fun cb  ->
          let fresh =
            let _0_453 = FStar_Options.n_cores ()  in
            _0_453 > (Prims.parse_int "1")  in
                                     ...
                                     FStar_All.pipe_right th
                                       (FStar_Util.for_some
                                          (fun uu___95_1649  ->
                                             ...
                                             | uu____1654 -> false))
                                      in
                                   FStar_All.pipe_right _0_454
                                     Prims.op_Negation))
                            in
                         FStar_All.pipe_right _0_455
                           (FStar_String.concat ", ")
                          in
                       let included =
                         let _0_456 =
                     ...
                     ((let uu____1667 =
                       ...
                       | true  ->
                           ...
                           let missed =
                             ...
                             | uu____1673 -> ""  in
                           let _0_460 = FStar_Util.string_of_int n_retained
                              in
                           let _0_459 =
                             match n <> n_retained with
                             | true  ->
                                 let _0_457 = FStar_Util.string_of_int n  in
                                 FStar_Util.format2
                                   " (expected %s (%s); replay may be inaccurate)"
                                   _0_457 missed
                             | uu____1679 -> ""  in
                           let _0_458 = FStar_Util.string_of_int n_pruned  in
                           FStar_Util.print3
                             ...
                             FStar_SMTEncoding_Term.Caption
                               (let _0_461 =
                                  FStar_All.pipe_right core
                                    (FStar_String.concat ", ")
                                   in
                                Prims.strcat "UNSAT CORE: " _0_461)
                              in
                           [_0_462]  in
                         FStar_List.append theory' _0_463  in
                       (_0_464, true))))
             in
              ...
              let input =
                let _0_465 =
                  FStar_List.map
                   ...
                   in
                FStar_All.pipe_right _0_465 (FStar_String.concat "\n")  in
