...
(let _0_356 = (FStar_Util.string_of_int (FStar_Options.z3_seed ()))
in (FStar_Util.format1 "-smt2 -in AUTO_CONFIG=false MODEL=true SMT.RELEVANCY=2 SMT.RANDOM_SEED=%s" _0_356));
)))
...
let tid : Prims.unit  ->  Prims.string = (fun uu____238 -> (let _0_357 = (FStar_Util.current_tid ())
in (FStar_All.pipe_right _0_357 FStar_Util.string_of_int)))
...
in x))
in (let _0_359 = (FStar_Options.z3_exe ())
in (let _0_358 = (ini_params ())
in (FStar_Util.start_process id _0_359 _0_358 cond)))))
...
let uu____430 = (let _0_360 = (FStar_ST.read used_file_names)
...
| None -> begin
((let _0_362 = (let _0_361 = (FStar_ST.read used_file_names)
in (((n), ((Prims.parse_int "0"))))::_0_361)
in (FStar_ST.write used_file_names _0_362));
n;
)
end
| Some (uu____461, k) -> begin
((let _0_364 = (let _0_363 = (FStar_ST.read used_file_names)
in (((n), ((k + (Prims.parse_int "1")))))::_0_363)
in (FStar_ST.write used_file_names _0_364));
(let _0_365 = (FStar_Util.string_of_int (k + (Prims.parse_int "1")))
in (FStar_Util.format2 "%s-%s" n _0_365));
)
end))
in (
...
let append_to_log = (fun str -> (let _0_366 = (get_log_file ())
in (FStar_Util.append_to_file _0_366 str)))
in (
...
in (fun uu____537 -> (new_z3proc (let _0_368 = ((FStar_Util.incr ctr);
(let _0_367 = (FStar_ST.read ctr)
in (FStar_All.pipe_right _0_367 FStar_Util.string_of_int));
)
in (FStar_Util.format1 "bg-%s" _0_368)))))
in (

let z3proc = (fun uu____547 -> ((

let uu____549 = (let _0_369 = (FStar_ST.read the_z3proc)
in (_0_369 = None))
in (match (uu____549) with
| true -> begin
(let _0_370 = Some ((new_proc ()))
in (FStar_ST.write the_z3proc _0_370))
end
| uu____557 -> begin
()
end));
...
(let _0_371 = Some ((new_proc ()))
in (FStar_ST.write the_z3proc _0_371));
...
(let _0_372 = Some ((new_proc ()))
in (FStar_ST.write the_z3proc _0_372));
...
| true -> begin
(let _0_373 = (query_logging.log_file_name ())
in (Prims.strcat "@" _0_373))
end
| uu____603 -> begin
""
end)))
...
let starts_with = (fun c s -> (((FStar_String.length s) >= (Prims.parse_int "1")) && (let _0_374 = (FStar_String.get s (Prims.parse_int "0"))
in (_0_374 = c))))
in (

let ends_with = (fun c s -> (((FStar_String.length s) >= (Prims.parse_int "1")) && (let _0_375 = (FStar_String.get s ((FStar_String.length s) - (Prims.parse_int "1")))
in (_0_375 = c))))
in (
...
let uu____657 = ((((FStar_List.length lines) >= (Prims.parse_int "2")) && (let _0_376 = (FStar_List.hd lines)
in (starts_with '(' _0_376))) && (let _0_377 = (last lines)
in (ends_with ')' _0_377)))
in (match (uu____657) with
| true -> begin
((FStar_Util.print_string (let _0_380 = (let _0_378 = (query_logging.get_module_name ())
in (FStar_Util.format1 "BEGIN-STATS %s\n" _0_378))
in (let _0_379 = (at_log_file ())
in (Prims.strcat _0_380 _0_379))));
...
| uu____691 -> begin
(let _0_382 = (FStar_All.pipe_right (FStar_Util.split s " ") (FStar_Util.sort_with FStar_String.compare))
in (FStar_All.pipe_right _0_382 (fun _0_381 -> Some (_0_381))))
end))))
in (match (lines) with
| ("<unsat-core>")::(core)::("</unsat-core>")::rest -> begin
(let _0_383 = (parse_core core)
in ((_0_383), (lines)))
end
| uu____709 -> begin
((None), (lines))
...
(let _0_384 = (lblnegs rest succeeded)
in (lname)::_0_384)
end
...
| (core_opt, rest) -> begin
(let _0_385 = (lblnegs rest succeeded)
in ((core_opt), (_0_385)))
end)))
in (
...
| (hd)::tl -> begin
((let _0_387 = (let _0_386 = (query_logging.get_module_name ())
in (FStar_Util.format2 "%s: Unexpected output from Z3: %s\n" _0_386 hd))
in (FStar_Errors.warn FStar_Range.dummyRange _0_387));
(result tl);
)
end
| uu____803 -> begin
(let _0_390 = (let _0_389 = (let _0_388 = (FStar_List.map (fun l -> (FStar_Util.format1 "<%s>" (FStar_Util.trim_string l))) lines)
in (FStar_String.concat "\n" _0_388))
in (FStar_Util.format1 "Unexpected output from Z3: got output lines: %s\n" _0_389))
in (FStar_All.pipe_left failwith _0_390))
end))
in (result lines))))))))
in (
...
let z3_options : Prims.unit  ->  Prims.string = (fun uu____829 -> (let _0_391 = (FStar_Util.string_of_int (FStar_Options.z3_seed ()))
...
let uu____973 = (let _0_392 = (FStar_Util.now ())
in (FStar_Util.time_diff start _0_392))
...
| true -> begin
(let _0_393 = (FStar_Util.format1 "Z3 says: %s\n" (status_to_string status))
in (FStar_All.pipe_left FStar_Util.print_string _0_393))
end
| uu____1063 -> begin
()
end));
...
in (let _0_395 = FStar_Util.Inr ((let _0_394 = (ekind status)
in ((failing_assertions), (_0_394))))
in ((_0_395), (elapsed_time))));
)
end)
in result)
end))))))
...
and run_job : z3job  ->  Prims.unit = (fun j -> (let _0_396 = (j.job ())
in (FStar_All.pipe_left j.callback _0_396)))


let init : Prims.unit  ->  Prims.unit = (fun uu____1281 -> (

let n_runners = (let _0_397 = (FStar_Options.n_cores ())
in (_0_397 - (Prims.parse_int "1")))
in (
...
(let _0_399 = (let _0_398 = (FStar_ST.read job_queue)
in (FStar_List.append _0_398 ((j)::[])))
in (FStar_ST.write job_queue _0_399));
...
let uu____1327 = (with_monitor job_queue (fun uu____1336 -> (let _0_401 = (FStar_ST.read pending_jobs)
in (let _0_400 = (FStar_List.length (FStar_ST.read job_queue))
in ((_0_401), (_0_400))))))
in (match (uu____1327) with
| (n, m) -> begin
(match (((n + m) = (Prims.parse_int "0"))) with
| true -> begin
(let _0_402 = (FStar_Errors.report_all ())
in (FStar_All.pipe_right _0_402 Prims.ignore))
end
| uu____1350 -> begin
...
let push : Prims.string  ->  Prims.unit = (fun msg -> ((let _0_404 = (let _0_403 = (FStar_ST.read fresh_scope)
in ((FStar_SMTEncoding_Term.Caption (msg))::(FStar_SMTEncoding_Term.Push)::[])::_0_403)
in (FStar_ST.write fresh_scope _0_404));
(let _0_406 = (let _0_405 = (FStar_ST.read bg_scope)
in (FStar_List.append ((FStar_SMTEncoding_Term.Caption (msg))::(FStar_SMTEncoding_Term.Push)::[]) _0_405))
in (FStar_ST.write bg_scope _0_406));
))


let pop : Prims.string  ->  Prims.unit = (fun msg -> ((let _0_407 = (FStar_List.tl (FStar_ST.read fresh_scope))
in (FStar_ST.write fresh_scope _0_407));
(let _0_409 = (let _0_408 = (FStar_ST.read bg_scope)
in (FStar_List.append ((FStar_SMTEncoding_Term.Pop)::(FStar_SMTEncoding_Term.Caption (msg))::[]) _0_408))
in (FStar_ST.write bg_scope _0_409));
))
...
in (FStar_List.append (FStar_List.rev decls) _0_410))
...
(let _0_412 = (FStar_List.rev (FStar_ST.read fresh_scope))
in (FStar_All.pipe_right _0_412 FStar_List.flatten));
)
end
| uu____1460 -> begin
(
...
let missed = (let _0_414 = (FStar_All.pipe_right core (FStar_List.filter (fun nm -> (let _0_413 = (FStar_All.pipe_right th (FStar_Util.for_some (fun uu___94_1650 -> (match (uu___94_1650) with
...
in (FStar_All.pipe_right _0_413 Prims.op_Negation)))))
in (FStar_All.pipe_right _0_414 (FStar_String.concat ", ")))
in (

let included = (let _0_415 = (FStar_All.pipe_right th (FStar_List.collect (fun uu___95_1660 -> (match (uu___95_1660) with
...
in (let _0_419 = (FStar_Util.string_of_int n_retained)
in (let _0_418 = (match ((n <> n_retained)) with
| true -> begin
(let _0_416 = (FStar_Util.string_of_int n)
in (FStar_Util.format2 " (expected %s (%s); replay may be inaccurate)" _0_416 missed))
end
| uu____1680 -> begin
""
end)
in (let _0_417 = (FStar_Util.string_of_int n_pruned)
...
(let _0_423 = (let _0_422 = (let _0_421 = FStar_SMTEncoding_Term.Caption ((let _0_420 = (FStar_All.pipe_right core (FStar_String.concat ", "))
in (Prims.strcat "UNSAT CORE: " _0_420)))
in (_0_421)::[])
in (FStar_List.append theory' _0_422))
in ((_0_423), (true)));
))
end))
end))
...
let input = (let _0_425 = (let _0_424 = (FStar_SMTEncoding_Term.declToSmt (z3_options ()))
in (FStar_List.map _0_424 theory))
in (FStar_All.pipe_right _0_425 (FStar_String.concat "\n")))
in ((
