    ...
    let uu____1735 =
      let uu____1737 =
        ...
        (let uu____1740 = FStar_ST.op_Bang ctr in
         FStar_All.pipe_right uu____1740 FStar_Util.string_of_int) in
                                  ...
                                  | uu____3199 ->
                                      ...
                                      FStar_Errors.log_issue r
                                        (FStar_Errors.Warning_UnexpectedZ3Output,
                                          msg));
                                 (let uu____3215 = FStar_Util.must result_opt in
                                  {
...
let (refresh : unit -> unit) =
  fun uu____4481 ->
    (let uu____4483 =
       let uu____4488 = FStar_ST.op_Bang bg_z3_proc in uu____4488.refresh in
     uu____4483 ());
                        ...
                        FStar_List.filter
                          (fun uu___2_4646 ->
                             ...
                             | FStar_SMTEncoding_Term.Assume uu____4648 ->
                                 true
                             | uu____4650 -> false) decls in
                      let n1 = FStar_List.length decls1 in
                      (((name, n1) :: out), (n1 + _total))
                  | uu____4667 -> (out, _total))) ([], Prims.int_zero) theory in
          ...
          FStar_List.sortWith
            (fun uu____4729 ->
               fun uu____4730 ->
                 ...
                 | ((uu____4756, n1), (uu____4758, m)) -> m - n1) modules in
        (if modules1 <> []
         then
            ...
            fun qhash ->
              fun uu____5255 ->
                ...
                let uu____5265 =
                  ...
                  with
                  | uu___499_5282 ->
                      (refresh (); FStar_Exn.raise uu___499_5282) in
