...
let (bg_z3_proc : bgproc FStar_ST.ref) =
  ...
  let ask input =
    ...
    let uu____2017 =
      FStar_Profiling.profile
        (fun uu____2027  ->
           let uu____2028 = z3proc ()  in
           FStar_Util.ask_process uu____2028 input kill_handler)
        (fun uu____2030  -> input) FStar_Options.ProfileSMT
       in
    match uu____2017 with | (x1,uu____2033) -> x1  in
  let refresh uu____2043 =
    (let uu____2045 = z3proc ()  in FStar_Util.kill_process uu____2045);
    (let uu____2047 =
  ...
  let restart uu____2079 =
    query_logging.close_log ();
    FStar_ST.op_Colon_Equals the_z3proc FStar_Pervasives_Native.None;
    (let uu____2105 =
       let uu____2108 = new_z3proc_with_id ()  in
       FStar_Pervasives_Native.Some uu____2108  in
     FStar_ST.op_Colon_Equals the_z3proc uu____2105)
     in
  FStar_Util.mk_ref
    {
    ...
    fun r  ->
      fun lines  ->
        let rec until tag lines1 =
          ...
          | l::lines2 ->
              ...
              then FStar_Pervasives_Native.Some ([], lines2)
                ...
                (let uu____2434 = until tag lines2  in
                 FStar_Util.map_opt uu____2434
                   (fun uu____2470  ->
        ...
        let find_section tag lines1 =
          let uu____2577 = until (start_tag tag) lines1  in
          match uu____2577 with
          | FStar_Pervasives_Native.None  ->
              (FStar_Pervasives_Native.None, lines1)
          | FStar_Pervasives_Native.Some (prefix1,suffix) ->
              let uu____2647 = until (end_tag tag) suffix  in
           ...
           in
        let uu____2732 = find_section "result" lines  in
        match uu____2732 with
        | (result_opt,lines1) ->
            let result = FStar_Util.must result_opt  in
            let uu____2771 = find_section "reason-unknown" lines1  in
            (match uu____2771 with
             | (reason_unknown,lines2) ->
                 let uu____2803 = find_section "unsat-core" lines2  in
                 (match uu____2803 with
                  | (unsat_core,lines3) ->
                      let uu____2835 = find_section "statistics" lines3  in
                      (match uu____2835 with
                       | (statistics,lines4) ->
                           let uu____2867 = find_section "labels" lines4  in
                           (match uu____2867 with
                            | (labels,lines5) ->
                                let remaining =
                                  let uu____2903 = until "Done!" lines5  in
                                  ...
                                  | uu____2957 ->
                                      ...
                                      FStar_Errors.log_issue r
                                        (FStar_Errors.Warning_UnexpectedZ3Output,
                                          msg));
                                 (let uu____2973 = FStar_Util.must result_opt
                                     in
                                  {
                                    smt_result = uu____2973;
            ...
            let parse z3out =
                    ...
                    then FStar_Pervasives_Native.None
                      ...
                      (let uu____3068 =
                         FStar_All.pipe_right (FStar_Util.split s2 " ")
                          ...
                          in
                       FStar_Pervasives_Native.Some uu____3068)
                 in
              let labels =
                ...
                | FStar_Pervasives_Native.Some lines1 ->
                    let rec lblnegs lines2 =
                      ...
                      | lname::"false"::rest when
                          ...
                          let uu____3113 = lblnegs rest  in lname ::
                            uu____3113
                      | lname::uu____3119::rest when
                          FStar_Util.starts_with lname "label_" ->
                          lblnegs rest
                      | uu____3129 -> []  in
              ...
              let reason_unknown =
                FStar_Util.map_opt smt_output.smt_reason_unknown
                 ...
                 in
              let status =
                (let uu____3369 = FStar_Options.debug_any ()  in
                 if uu____3369
                 then
                   let uu____3372 =
                     FStar_Util.format1 "Z3 says: %s\n"
                      ...
                      in
                   FStar_All.pipe_left FStar_Util.print_string uu____3372
                 else ());
                (match smt_output.smt_result with
                 ...
                 | "killed"::[] ->
                     ((let uu____3404 =
                         let uu____3409 = FStar_ST.op_Bang bg_z3_proc  in
                         uu____3409.restart  in
                       uu____3404 ());
                      KILLED)
                 | uu____3429 ->
                     let uu____3430 =
            ...
            fun qhash  ->
              fun uu____3786  ->
                ...
                let uu____3796 =
                  ...
                  | uu___402_3813 ->
                      if
                        let uu____3818 = FStar_Options.trace_error ()  in
                        Prims.op_Negation uu____3818
                      then
                        Obj.magic
                          (Obj.repr
                             ((let uu____3821 =
                                 let uu____3826 = FStar_ST.op_Bang bg_z3_proc
                                    in
                                 uu____3826.refresh  in
                               uu____3821 ());
                              FStar_Exn.raise uu___402_3813))
                      else Obj.magic (Obj.repr (failwith "unreachable"))
                   in
                match uu____3796 with
                | (status,statistics) ->
                    let uu____3852 =
                      let uu____3858 = FStar_Util.now ()  in
                      FStar_Util.time_diff start uu____3858  in
                    (match uu____3852 with
                     | (uu____3859,elapsed_time) ->
                         {
...
let rec (dequeue' : unit -> unit) =
  fun uu____3882  ->
    let j =
      let uu____3884 = FStar_ST.op_Bang job_queue  in
    ...
    FStar_Util.with_monitor job_queue
      (fun uu____3952  -> FStar_Util.decr pending_jobs) ();
    dequeue ()

and (dequeue : unit -> unit) =
  fun uu____3954  ->
    let uu____3955 = FStar_ST.op_Bang running  in
    if uu____3955
    then
      let rec aux uu____3983 =
        FStar_Util.monitor_enter job_queue;
        (let uu____3989 = FStar_ST.op_Bang job_queue  in
...
and (run_job : z3job -> unit) =
  fun j  ->
    let uu____4026 = j.job ()  in FStar_All.pipe_left j.callback uu____4026
...
let (enqueue : z3job -> unit) =
  fun j  ->
    FStar_Util.with_monitor job_queue
      (fun uu____4089  ->
         (let uu____4091 =
            let uu____4094 = FStar_ST.op_Bang job_queue  in
            FStar_List.append uu____4094 [j]  in
          FStar_ST.op_Colon_Equals job_queue uu____4091);
         FStar_Util.monitor_pulse job_queue) ()
  
let (finish : unit -> unit) =
  fun uu____4152  ->
    let rec aux uu____4158 =
      let uu____4159 =
        FStar_Util.with_monitor job_queue
          (fun uu____4177  ->
             let uu____4178 = FStar_ST.op_Bang pending_jobs  in
             let uu____4201 =
               let uu____4202 = FStar_ST.op_Bang job_queue  in
               FStar_List.length uu____4202  in
             (uu____4178, uu____4201)) ()
         in
...
let (mk_fresh_scope : unit -> scope_t) =
  fun uu____4278  -> FStar_ST.op_Bang fresh_scope 
let (flatten_fresh_scope : unit -> FStar_SMTEncoding_Term.decl Prims.list) =
  fun uu____4305  ->
    let uu____4306 =
      let uu____4311 = FStar_ST.op_Bang fresh_scope  in
      FStar_List.rev uu____4311  in
    FStar_List.flatten uu____4306
...
let (push : Prims.string -> unit) =
  fun msg  ->
    FStar_Util.atomically
      (fun uu____4355  ->
         (let uu____4357 =
            let uu____4358 = FStar_ST.op_Bang fresh_scope  in
            [FStar_SMTEncoding_Term.Caption msg; FStar_SMTEncoding_Term.Push]
              :: uu____4358
             in
          FStar_ST.op_Colon_Equals fresh_scope uu____4357);
         (let uu____4403 =
            let uu____4406 = FStar_ST.op_Bang bg_scope  in
            FStar_List.append uu____4406
              [FStar_SMTEncoding_Term.Push;
              FStar_SMTEncoding_Term.Caption msg]
             in
          FStar_ST.op_Colon_Equals bg_scope uu____4403))
...
let (pop : Prims.string -> unit) =
  fun msg  ->
    FStar_Util.atomically
      (fun uu____4466  ->
         (let uu____4468 =
            let uu____4469 = FStar_ST.op_Bang fresh_scope  in
            FStar_List.tl uu____4469  in
          FStar_ST.op_Colon_Equals fresh_scope uu____4468);
         (let uu____4514 =
            let uu____4517 = FStar_ST.op_Bang bg_scope  in
            FStar_List.append uu____4517
              [FStar_SMTEncoding_Term.Caption msg;
              FStar_SMTEncoding_Term.Pop]
             in
          FStar_ST.op_Colon_Equals bg_scope uu____4514))
...
let (rollback :
  ...
  fun msg  ->
    fun depth  ->
      FStar_Common.rollback (fun uu____4604  -> pop msg) fresh_scope depth
...
let (giveZ3 : FStar_SMTEncoding_Term.decl Prims.list -> unit) =
  fun decls  ->
    FStar_All.pipe_right decls
      (FStar_List.iter
         (fun uu___2_4619  ->
            match uu___2_4619 with
            | FStar_SMTEncoding_Term.Push  -> failwith "Unexpected push/pop"
            | FStar_SMTEncoding_Term.Pop  -> failwith "Unexpected push/pop"
            | uu____4622 -> ()));
    (let uu____4624 = FStar_ST.op_Bang fresh_scope  in
     match uu____4624 with
     | hd1::tl1 ->
         FStar_ST.op_Colon_Equals fresh_scope ((FStar_List.append hd1 decls)
           :: tl1)
     | uu____4675 -> failwith "Impossible");
    (let uu____4677 =
       let uu____4680 = FStar_ST.op_Bang bg_scope  in
       FStar_List.append uu____4680 decls  in
     FStar_ST.op_Colon_Equals bg_scope uu____4677)
  
let (refresh : unit -> unit) =
  fun uu____4734  ->
    (let uu____4736 =
       let uu____4738 = FStar_Options.n_cores ()  in
       uu____4738 < (Prims.parse_int "2")  in
     if uu____4736
     then
       let uu____4742 =
         let uu____4747 = FStar_ST.op_Bang bg_z3_proc  in uu____4747.refresh
          in
       uu____4742 ()
     else ());
    (let uu____4769 = flatten_fresh_scope ()  in
     FStar_ST.op_Colon_Equals bg_scope uu____4769)
                 ...
                 (match d with
                  | FStar_SMTEncoding_Term.Module (name,decls) ->
                      let decls1 =
                        FStar_List.filter
                          (fun uu___3_4907  ->
                             match uu___3_4907 with
                             | FStar_SMTEncoding_Term.Assume uu____4909 ->
                                 true
                             | uu____4911 -> false) decls
                         in
                      let n1 = FStar_List.length decls1  in
                      (((name, n1) :: out), (n1 + _total))
                  | uu____4928 -> (out, _total))) ([], (Prims.parse_int "0"))
        theory
       in
          ...
          FStar_List.sortWith
            (fun uu____4990  ->
               fun uu____4991  ->
                 ...
                 | ((uu____5017,n1),(uu____5019,m)) -> m - n1) modules
           in
        (if modules1 <> []
         then
           (let uu____5057 = FStar_Util.string_of_int total_decls  in
            FStar_Util.print1
         ...
         FStar_List.iter
           (fun uu____5072  ->
              ...
              | (m,n1) ->
                  if n1 <> (Prims.parse_int "0")
                  then
                    let uu____5088 = FStar_Util.string_of_int n1  in
                    FStar_Util.print2
...
let (mk_input :
  ...
  fun fresh  ->
    fun theory  ->
      ...
      (let uu____5147 = FStar_Options.print_z3_statistics ()  in
       if uu____5147 then context_profile theory else ());
      (let uu____5152 =
         let uu____5161 =
         ...
         then
             ...
             let uu____5183 =
               FStar_All.pipe_right theory
                 (FStar_Util.prefix_until
                    (fun uu___4_5211  ->
                       match uu___4_5211 with
                       | FStar_SMTEncoding_Term.CheckSat  -> true
                       | uu____5214 -> false))
                in
             FStar_All.pipe_right uu____5183 FStar_Option.get  in
           ...
           | (prefix1,check_sat,suffix) ->
               ...
               let hs =
                 let uu____5297 = FStar_Options.keep_query_captions ()  in
                 if uu____5297
                 then
                   let uu____5301 =
               ...
               let uu____5318 =
                 let uu____5322 = FStar_Util.digest_of_string hs  in
           ...
           (let uu____5332 =
              let uu____5334 =
                FStar_List.map (FStar_SMTEncoding_Term.declToSmt options)
                  theory
                 in
              FStar_All.pipe_right uu____5334 (FStar_String.concat "\n")  in
            (uu____5332, FStar_Pervasives_Native.None))
          in
       match uu____5152 with
       | (r,hash) ->
           let log_file_name =
             let uu____5376 = FStar_Options.log_queries ()  in
             if uu____5376
             then
               let uu____5382 = query_logging.write_to_log fresh r  in
              ...
              fun fresh  ->
                ...
                let theory1 =
                  FStar_List.append theory
                   ...
                   in
                let uu____5607 = filter_theory theory1  in
                match uu____5607 with
                | (theory2,_used_unsat_core) ->
                    let uu____5623 = mk_input fresh theory2  in
                  ...
                  let uu____5739 =
                    ...
                    | FStar_Pervasives_Native.None  ->
                        (FStar_ST.op_Colon_Equals bg_scope [];
                         (let uu____5775 = FStar_ST.op_Bang fresh_scope  in
                          FStar_List.rev uu____5775))
                     in
                  FStar_List.flatten uu____5739  in
                let theory1 =
                  FStar_List.append theory
                    (FStar_List.append [FStar_SMTEncoding_Term.Push]
                       (FStar_List.append qry [FStar_SMTEncoding_Term.Pop]))
                   in
                let uu____5804 = filter_theory theory1  in
                match uu____5804 with
                | (theory2,used_unsat_core) ->
                    let uu____5820 = mk_input true theory2  in
                    (match uu____5820 with
                     | (input,qhash,log_file_name) ->
                         let uu____5852 =
                           let uu____5854 =
                             cache_hit log_file_name cache qhash cb  in
                           Prims.op_Negation uu____5854  in
                         if uu____5852
                         then
                           enqueue
                             {
          ...
          fun qry  ->
            fun scope  ->
              fun cb  ->
                fun fresh  ->
                  let uu____5942 =
                    let uu____5944 = FStar_Options.n_cores ()  in
                    uu____5944 = (Prims.parse_int "1")  in
                  if uu____5942
