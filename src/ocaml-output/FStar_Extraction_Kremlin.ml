    ...
    fun d  ->
      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
          ...
          let env2 =
            FStar_List.fold_left
             ...
             in
          let rec find_return_type uu___125_3399 =
            match uu___125_3399 with
            | FStar_Extraction_ML_Syntax.MLTY_Fun (uu____3400,uu____3401,t)
                -> find_return_type t
            | t -> t  in
          let t =
            let uu____3405 = find_return_type t0  in
            translate_type env2 uu____3405  in
          ...
          then
            (if (FStar_List.length tvars) = (Prims.parse_int "0")
             then
               let uu____3426 =
                 let uu____3427 =
                   let uu____3442 = translate_type env3 t0  in
                   (FStar_Pervasives_Native.None, name1, uu____3442)  in
                 DExternal uu____3427  in
               FStar_Pervasives_Native.Some uu____3426
            ...
            (try
             ...
             | e ->
                 ...
                 (FStar_Util.print2 "Warning: writing a stub for %s (%s)\n"
                  ...
                  (let msg1 =
                     Prims.strcat "This function was not extracted:|n" msg
                      in
                   FStar_Pervasives_Native.Some
                     (DFunction
                        (FStar_Pervasives_Native.None, flags1,
                              ...
                              FStar_Extraction_ML_Syntax.expr =
                                ...
                                ({
                                   ...
                                   FStar_Extraction_ML_Syntax.loc =
                                     uu____3509;_},uu____3510,uu____3511);
                              FStar_Extraction_ML_Syntax.mlty = uu____3512;
                              FStar_Extraction_ML_Syntax.loc = uu____3513;_};
                          FStar_Extraction_ML_Syntax.print_typ = uu____3514;_}::[])
          ->
          let assumed =
            FStar_Util.for_some
              (fun uu___124_3535  ->
                 match uu___124_3535 with
                 | FStar_Extraction_ML_Syntax.Assumed  -> true
                 | uu____3536 -> false) flags
             in
          let env1 =
            if flavor = FStar_Extraction_ML_Syntax.Rec
            then extend env name false
            ...
            FStar_List.fold_left
              (fun env2  ->
                 fun uu____3549  ->
                   ...
                   | (name1,uu____3555) -> extend_t env2 name1) env1 tvars
             in
          let rec find_return_type uu___125_3559 =
            match uu___125_3559 with
            | FStar_Extraction_ML_Syntax.MLTY_Fun (uu____3560,uu____3561,t)
                -> find_return_type t
            | t -> t  in
          let t =
            let uu____3565 = find_return_type t0  in
            translate_type env2 uu____3565  in
          let binders = translate_binders env2 args  in
          let env3 = add_binders env2 args  in
          let name1 = ((env3.module_name), name)  in
          let flags1 = translate_flags flags  in
          ...
          then
            (if (FStar_List.length tvars) = (Prims.parse_int "0")
             then
               let uu____3586 =
                 let uu____3587 =
                   let uu____3602 = translate_type env3 t0  in
                   (FStar_Pervasives_Native.None, name1, uu____3602)  in
                 DExternal uu____3587  in
               FStar_Pervasives_Native.Some uu____3586
             else FStar_Pervasives_Native.None)
          else
            (try
               let body1 = translate_expr env3 body  in
      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
          (flavor,flags,{
                          ...
                          FStar_Extraction_ML_Syntax.print_typ = uu____3666;_}::[])
          ->
          let flags1 = translate_flags flags  in
          ...
          (try
           ...
           with
           | e ->
               ((let uu____3714 = FStar_Util.print_exn e  in
                 FStar_Util.print2
                   "Warning: not translating definition for %s (%s)\n"
                   (FStar_Pervasives_Native.snd name1) uu____3714);
                FStar_Pervasives_Native.Some
           ...
           (match ts with
            | FStar_Pervasives_Native.Some (idents,t) ->
                let uu____3748 =
                  ...
                  FStar_String.concat ", " uu____3749  in
                let uu____3756 =
                  FStar_Extraction_ML_Code.string_of_mlty ([], "") t  in
                FStar_Util.print2 "Type scheme is: forall %s. %s\n"
                  uu____3748 uu____3756
            | FStar_Pervasives_Native.None  -> ());
           FStar_Pervasives_Native.None)
      | FStar_Extraction_ML_Syntax.MLM_Let uu____3759 ->
          failwith "impossible"
      | FStar_Extraction_ML_Syntax.MLM_Loc uu____3762 ->
          FStar_Pervasives_Native.None
      | FStar_Extraction_ML_Syntax.MLM_Ty
          ((assumed,name,_mangled_name,args,uu____3767,FStar_Pervasives_Native.Some
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____3826  ->
                   ...
                   | (name2,uu____3832) -> extend_t env1 name2) env args
             in
          if assumed
          then FStar_Pervasives_Native.None
            ...
            (let uu____3836 =
               let uu____3837 =
                 let uu____3850 = translate_type env1 t  in
                 (name1, (FStar_List.length args), uu____3850)  in
               DTypeAlias uu____3837  in
             FStar_Pervasives_Native.Some uu____3836)
      | FStar_Extraction_ML_Syntax.MLM_Ty
          ((uu____3857,name,_mangled_name,args,uu____3861,FStar_Pervasives_Native.Some
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____3926  ->
                   ...
                   | (name2,uu____3932) -> extend_t env1 name2) env args
             in
          let uu____3933 =
            let uu____3934 =
              let uu____3957 =
                FStar_List.map
                  (fun uu____3984  ->
                     ...
                     | (f,t) ->
                         ...
                         (f, uu____3999)) fields
                 in
              (name1, (FStar_List.length args), uu____3957)  in
            DTypeFlat uu____3934  in
          FStar_Pervasives_Native.Some uu____3933
      | FStar_Extraction_ML_Syntax.MLM_Ty
          ((uu____4025,name,_mangled_name,args,uu____4029,FStar_Pervasives_Native.Some
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____4100  ->
                   ...
                   | (name2,uu____4106) -> extend_t env1 name2) env args
             in
          let uu____4107 =
            let uu____4108 =
              let uu____4137 =
                         ...
                         let uu____4221 =
                           FStar_List.map
                             (fun uu____4248  ->
                                ...
                                | (name2,t) ->
                                    let uu____4263 =
                                      let uu____4268 = translate_type env1 t
                                         in
                                      (uu____4268, false)  in
                                    (name2, uu____4263)) ts
                            in
                         (cons1, uu____4221)) branches
                 in
              (name1, (FStar_List.length args), uu____4137)  in
            DTypeVariant uu____4108  in
          FStar_Pervasives_Native.Some uu____4107
      | FStar_Extraction_ML_Syntax.MLM_Ty
          ((uu____4305,name,_mangled_name,uu____4308,uu____4309,uu____4310)::uu____4311)
          ->
          (FStar_Util.print1
             "Warning: not translating definition for %s (and possibly others)\n"
             name;
      ...
      | FStar_Extraction_ML_Syntax.MLM_Ty [] ->
          (FStar_Util.print_string
           ...
           FStar_Pervasives_Native.None)
      | FStar_Extraction_ML_Syntax.MLM_Top uu____4356 ->
          failwith "todo: translate_decl [MLM_Top]"
      | FStar_Extraction_ML_Syntax.MLM_Exn uu____4359 ->
...
and translate_type : env -> FStar_Extraction_ML_Syntax.mlty -> typ =
  fun env  ->
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Var (name,uu____4375) ->
          let uu____4376 = find_t env name  in TBound uu____4376
      | FStar_Extraction_ML_Syntax.MLTY_Fun (t1,uu____4378,t2) ->
          let uu____4380 =
            let uu____4385 = translate_type env t1  in
            let uu____4386 = translate_type env t2  in
            (uu____4385, uu____4386)  in
          TArrow uu____4380
      | FStar_Extraction_ML_Syntax.MLTY_Named ([],p) when
          let uu____4390 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4390 = "Prims.unit" -> TUnit
      | FStar_Extraction_ML_Syntax.MLTY_Named ([],p) when
          let uu____4394 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4394 = "Prims.bool" -> TBool
      | FStar_Extraction_ML_Syntax.MLTY_Named ([],("FStar"::m::[],"t")) when
          is_machine_int m ->
          let uu____4406 = FStar_Util.must (mk_width m)  in TInt uu____4406
      | FStar_Extraction_ML_Syntax.MLTY_Named ([],("FStar"::m::[],"t'")) when
          is_machine_int m ->
          let uu____4418 = FStar_Util.must (mk_width m)  in TInt uu____4418
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[],p) when
          let uu____4423 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4423 = "FStar.Buffer.buffer" ->
          let uu____4424 = translate_type env arg  in TBuf uu____4424
      | FStar_Extraction_ML_Syntax.MLTY_Named (uu____4425::[],p) when
          let uu____4429 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4429 = "FStar.Ghost.erased" -> TAny
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (args,(ns,t1)) when
          ...
          ->
          let uu____4467 = FStar_List.map (translate_type env) args  in
          TTuple uu____4467
      | FStar_Extraction_ML_Syntax.MLTY_Named (args,lid) ->
          if (FStar_List.length args) > (Prims.parse_int "0")
          then
            let uu____4476 =
              let uu____4489 = FStar_List.map (translate_type env) args  in
              (lid, uu____4489)  in
            TApp uu____4476
          else TQualified lid
      | FStar_Extraction_ML_Syntax.MLTY_Tuple ts ->
          let uu____4498 = FStar_List.map (translate_type env) ts  in
          TTuple uu____4498
...
and translate_binder :
  ...
  fun env  ->
    fun uu____4514  ->
      ...
      | ((name,uu____4520),typ) ->
          let uu____4526 = translate_type env typ  in
          { name; typ = uu____4526; mut = false }
...
and translate_expr : env -> FStar_Extraction_ML_Syntax.mlexpr -> expr =
  fun env  ->
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Var (name,uu____4531) ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Let
          ...
          let is_mut =
            FStar_Util.for_some
              (fun uu___126_4583  ->
                 match uu___126_4583 with
                 | FStar_Extraction_ML_Syntax.Mutable  -> true
                 | uu____4584 -> false) flags
             in
          let uu____4585 =
            if is_mut
            then
              let uu____4594 =
                ...
                | FStar_Extraction_ML_Syntax.MLTY_Named (t::[],p) when
                    ...
                    uu____4599 = "FStar.ST.stackref" -> t
                | uu____4600 ->
                    let uu____4601 =
                      let uu____4602 =
              ...
              let uu____4605 =
                ...
                | {
                    ...
                    FStar_Extraction_ML_Syntax.loc = uu____4609;_} -> body1
                | uu____4612 ->
                    failwith "unexpected: bad desugaring of Mutable"
                 in
              (uu____4594, uu____4605)
            else (typ, body)  in
          (match uu____4585 with
           | (typ1,body1) ->
               let binder =
                 let uu____4617 = translate_type env typ1  in
                 { name; typ = uu____4617; mut = is_mut }  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Match (expr,branches) ->
          let uu____4643 =
            let uu____4654 = translate_expr env expr  in
            let uu____4655 = translate_branches env branches  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu____4679 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____4679 = "FStar.HyperStack.ST.op_Bang") && (is_mutable env v1)
          -> let uu____4680 = find env v1  in EBound uu____4680
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____4682;
             FStar_Extraction_ML_Syntax.loc = uu____4683;_},{
                                                              FStar_Extraction_ML_Syntax.expr
                                                                =
                                                                FStar_Extraction_ML_Syntax.MLE_Var
                                                                (v1,uu____4685);
          ...
          (let uu____4693 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____4693 = "FStar.HyperStack.ST.op_Colon_Equals") &&
            (is_mutable env v1)
          ->
          let uu____4694 =
            let uu____4699 =
              let uu____4700 = find env v1  in EBound uu____4700  in
            let uu____4701 = translate_expr env e1  in
            (uu____4699, uu____4701)  in
          EAssign uu____4694
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          when
          (let uu____4711 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____4711 = "FStar.Buffer.index") ||
            (let uu____4713 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
             uu____4713 = "FStar.Buffer.op_Array_Access")
          ->
          let uu____4714 =
            let uu____4719 = translate_expr env e1  in
            let uu____4720 = translate_expr env e2  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4758;_},e2::[])
          when
          let uu____4762 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4762 = "FStar.Buffer.createL" ->
          ...
          let uu____4808 =
            let uu____4815 =
              let uu____4818 = list_elements2 e2  in
              FStar_List.map (translate_expr env) uu____4818  in
            (Stack, uu____4815)  in
          EBufCreateL uu____4808
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____4824;
             FStar_Extraction_ML_Syntax.loc = uu____4825;_},e1::e2::_e3::[])
          when
          let uu____4831 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4831 = "FStar.Buffer.sub" ->
          let uu____4832 =
            let uu____4837 = translate_expr env e1  in
            let uu____4838 = translate_expr env e2  in
            (uu____4837, uu____4838)  in
          EBufSub uu____4832
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          uu____4846 = "FStar.Buffer.join" -> translate_expr env e1
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____4848;
             FStar_Extraction_ML_Syntax.loc = uu____4849;_},e1::e2::[])
          when
          let uu____4854 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4854 = "FStar.Buffer.offset" ->
          let uu____4855 =
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4864;_},e1::e2::e3::[])
          when
          (let uu____4872 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____4872 = "FStar.Buffer.upd") ||
            (let uu____4874 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
             uu____4874 = "FStar.Buffer.op_Array_Assignment")
          ->
          let uu____4875 =
            let uu____4882 = translate_expr env e1  in
            let uu____4883 = translate_expr env e2  in
            let uu____4884 = translate_expr env e3  in
            (uu____4882, uu____4883, uu____4884)  in
          EBufWrite uu____4875
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____4886;
             FStar_Extraction_ML_Syntax.loc = uu____4887;_},uu____4888::[])
          when
          let uu____4891 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4891 = "FStar.HyperStack.ST.push_frame" -> EPushFrame
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
          ...
          uu____4898 = "FStar.HyperStack.ST.pop_frame" -> EPopFrame
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____4900;
             FStar_Extraction_ML_Syntax.loc = uu____4901;_},e1::e2::e3::e4::e5::[])
          when
          let uu____4909 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4909 = "FStar.Buffer.blit" ->
          let uu____4910 =
            let uu____4921 = translate_expr env e1  in
            let uu____4922 = translate_expr env e2  in
            let uu____4923 = translate_expr env e3  in
            let uu____4924 = translate_expr env e4  in
            let uu____4925 = translate_expr env e5  in
            (uu____4921, uu____4922, uu____4923, uu____4924, uu____4925)  in
          EBufBlit uu____4910
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          uu____4951 = "FStar.HyperStack.ST.get" -> EUnit
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____4953;
             FStar_Extraction_ML_Syntax.loc = uu____4954;_},e1::[])
          when
          let uu____4958 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4958 = "Obj.repr" ->
          let uu____4959 =
            let uu____4964 = translate_expr env e1  in (uu____4964, TAny)  in
          ECast uu____4959
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4968;_},args)
          when (is_machine_int m) && (is_op op) ->
          let uu____4976 = FStar_Util.must (mk_width m)  in
          let uu____4977 = FStar_Util.must (mk_op op)  in
          mk_op_app env uu____4976 uu____4977 args
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          when is_bool_op op ->
          let uu____4988 = FStar_Util.must (mk_bool_op op)  in
          mk_op_app env Bool uu____4988 args
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4991;_},{
                                                              FStar_Extraction_ML_Syntax.expr
                                                                =
          ...
          let uu____5009 =
            let uu____5014 = FStar_Util.must (mk_width m)  in (uu____5014, c)
             in
          EConstant uu____5009
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name
          ...
          when is_machine_int m ->
          let uu____5035 =
            let uu____5040 = FStar_Util.must (mk_width m)  in (uu____5040, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5054;_},arg::[])
          ->
          let is_known_type =
          ...
          then
            let uu____5061 =
              let uu____5066 = translate_expr env arg  in
              (uu____5066, (TInt UInt64))  in
            ECast uu____5061
          else
                      ...
                      then
                        ...
                        then
                          (let uu____5110 =
                             ...
                             (uu____5115, (TInt Int8))  in
                           ECast uu____5110)
                        else
                          (let uu____5117 =
                             let uu____5124 =
                               let uu____5127 = translate_expr env arg  in
                               [uu____5127]  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5135;_},args)
          ->
          let uu____5145 =
            let uu____5152 = FStar_List.map (translate_expr env) args  in
            ((EQualified (path, function_name)), uu____5152)  in
          EApp uu____5145
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Var (name,uu____5160);
             FStar_Extraction_ML_Syntax.mlty = uu____5161;
             FStar_Extraction_ML_Syntax.loc = uu____5162;_},args)
          ->
          let uu____5168 =
            let uu____5175 =
              let uu____5176 = find env name  in EBound uu____5176  in
            let uu____5177 = FStar_List.map (translate_expr env) args  in
            (uu____5175, uu____5177)  in
          EApp uu____5168
      | FStar_Extraction_ML_Syntax.MLE_Coerce (e1,t_from,t_to) ->
          let uu____5185 =
            let uu____5190 = translate_expr env e1  in
            let uu____5191 = translate_type env t_to  in
            (uu____5190, uu____5191)  in
          ECast uu____5185
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____5192,fields) ->
          let uu____5210 =
            let uu____5221 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
            let uu____5222 =
              FStar_List.map
                (fun uu____5241  ->
                   ...
                   | (field,expr) ->
                       let uu____5252 = translate_expr env expr  in
                       (field, uu____5252)) fields
               in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Proj (e1,path) ->
          let uu____5261 =
            ...
            (uu____5268, uu____5269, (FStar_Pervasives_Native.snd path))  in
          EField uu____5261
      | FStar_Extraction_ML_Syntax.MLE_Let uu____5272 ->
          failwith "todo: translate_expr [MLE_Let]"
      | FStar_Extraction_ML_Syntax.MLE_App (head1,uu____5286) ->
          let uu____5291 =
            let uu____5292 =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Seq seqs ->
          let uu____5298 = FStar_List.map (translate_expr env) seqs  in
          ESequence uu____5298
      | FStar_Extraction_ML_Syntax.MLE_Tuple es ->
          let uu____5304 = FStar_List.map (translate_expr env) es  in
          ETuple uu____5304
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____5307,cons1),es) ->
          let uu____5324 =
            let uu____5333 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
            let uu____5334 = FStar_List.map (translate_expr env) es  in
            (uu____5333, cons1, uu____5334)  in
          ECons uu____5324
      | FStar_Extraction_ML_Syntax.MLE_Fun (args,body) ->
          let binders = translate_binders env args  in
          let env1 = add_binders env args  in
          let uu____5357 =
            let uu____5364 = translate_expr env1 body  in
            (binders, uu____5364)  in
          EFun uu____5357
      | FStar_Extraction_ML_Syntax.MLE_If (e1,e2,e3) ->
          let uu____5374 =
            let uu____5381 = translate_expr env e1  in
            let uu____5382 = translate_expr env e2  in
            let uu____5383 =
              match e3 with
              | FStar_Pervasives_Native.None  -> EUnit
              | FStar_Pervasives_Native.Some e31 -> translate_expr env e31
               in
            (uu____5381, uu____5382, uu____5383)  in
          EIfThenElse uu____5374
      | FStar_Extraction_ML_Syntax.MLE_Raise uu____5385 ->
          failwith "todo: translate_expr [MLE_Raise]"
      | FStar_Extraction_ML_Syntax.MLE_Try uu____5392 ->
          failwith "todo: translate_expr [MLE_Try]"
      | FStar_Extraction_ML_Syntax.MLE_Coerce uu____5407 ->
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (ts,lid) ->
          ...
          then
            let uu____5422 =
              let uu____5435 = FStar_List.map (translate_type env) ts  in
              (lid, uu____5435)  in
            TApp uu____5422
          else TQualified lid
      | uu____5441 -> failwith "invalid argument: assert_lid"
  ...
  fun env  ->
    fun uu____5467  ->
      ...
      | (pat,guard,expr) ->
          ...
          then
            let uu____5493 = translate_pat env pat  in
            (match uu____5493 with
             | (env1,pat1) ->
                 let uu____5504 = translate_expr env1 expr  in
                 (pat1, uu____5504))
...
and translate_pat :
  ...
  fun env  ->
    fun p  ->
      ...
      | FStar_Extraction_ML_Syntax.MLP_Var (name,uu____5518) ->
          let env1 = extend env name false  in
          (env1, (PVar { name; typ = TAny; mut = false }))
      | FStar_Extraction_ML_Syntax.MLP_Wild  ->
          let env1 = extend env "_" false  in
          (env1, (PVar { name = "_"; typ = TAny; mut = false }))
      | FStar_Extraction_ML_Syntax.MLP_CTor ((uu____5521,cons1),ps) ->
          let uu____5538 =
            FStar_List.fold_left
              (fun uu____5558  ->
                 fun p1  ->
                   ...
                   | (env1,acc) ->
                       let uu____5578 = translate_pat env1 p1  in
                       (match uu____5578 with
                        | (env2,p2) -> (env2, (p2 :: acc)))) (env, []) ps
             in
          (match uu____5538 with
           | (env1,ps1) -> (env1, (PCons (cons1, (FStar_List.rev ps1)))))
      | FStar_Extraction_ML_Syntax.MLP_Record (uu____5607,ps) ->
          let uu____5625 =
            FStar_List.fold_left
              (fun uu____5659  ->
                 fun uu____5660  ->
                   match (uu____5659, uu____5660) with
                   | ((env1,acc),(field,p1)) ->
                       let uu____5729 = translate_pat env1 p1  in
            ...
            FStar_List.fold_left
              (fun uu____5811  ->
                 fun p1  ->
                   ...
                   | (env1,acc) ->
                       let uu____5831 = translate_pat env1 p1  in
                       (match uu____5831 with
                        | (env2,p2) -> (env2, (p2 :: acc)))) (env, []) ps
             in
          (match uu____5791 with
           | (env1,ps1) -> (env1, (PTuple (FStar_List.rev ps1))))
      | FStar_Extraction_ML_Syntax.MLP_Const uu____5858 ->
          failwith "todo: translate_pat [MLP_Const]"
      | FStar_Extraction_ML_Syntax.MLP_Branch uu____5863 ->
...
and translate_constant : FStar_Extraction_ML_Syntax.mlconstant -> expr =
  fun c  ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s,FStar_Pervasives_Native.Some uu____5873) ->
        failwith
          "impossible: machine integer not desugared to a function call"
    | FStar_Extraction_ML_Syntax.MLC_Float uu____5888 ->
        failwith "todo: translate_expr [MLC_Float]"
    | FStar_Extraction_ML_Syntax.MLC_Char uu____5889 ->
        failwith "todo: translate_expr [MLC_Char]"
    | FStar_Extraction_ML_Syntax.MLC_String uu____5890 ->
        failwith "todo: translate_expr [MLC_String]"
    | FStar_Extraction_ML_Syntax.MLC_Bytes uu____5891 ->
  ...
  fun env  ->
    fun w  ->
      fun op  ->
        fun args  ->
          let uu____5911 =
            let uu____5918 = FStar_List.map (translate_expr env) args  in
            ((EOp (op, w)), uu____5918)  in
          EApp uu____5911
