            ...
            FStar_List.fold_left
              (fun env2  ->
                 fun uu____3371  ->
                   ...
                   | (name1,uu____3377) -> extend_t env2 name1) env1 tvars
             in
            ...
            FStar_List.fold_left
              (fun env2  ->
                 fun uu____3528  ->
                   ...
                   | (name1,uu____3534) -> extend_t env2 name1) env1 tvars
             in
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____3802  ->
                   ...
                   | (name2,uu____3808) -> extend_t env1 name2) env args
             in
          if assumed
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____3902  ->
                   ...
                   | (name2,uu____3908) -> extend_t env1 name2) env args
             in
          let uu____3909 =
            let uu____3910 =
              let uu____3933 =
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____4076  ->
                   ...
                   | (name2,uu____4082) -> extend_t env1 name2) env args
             in
          let uu____4083 =
            let uu____4084 =
              let uu____4113 =
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____4985 =
            let uu____4990 = FStar_Util.must (mk_width m)  in (uu____4990, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____5011 =
            let uu____5016 = FStar_Util.must (mk_width m)  in (uu____5016, c)
             in
