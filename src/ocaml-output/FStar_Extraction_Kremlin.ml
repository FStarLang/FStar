...
let (extend : env -> Prims.string -> env) =
  fun env  ->
    fun x  ->
      let uu___283_3270 = env  in
      {
        names = ({ pretty = x } :: (env.names));
        names_t = (uu___283_3270.names_t);
        module_name = (uu___283_3270.module_name)
      }
  
let (extend_t : env -> Prims.string -> env) =
  fun env  ->
    fun x  ->
      let uu___284_3281 = env  in
      {
        names = (uu___284_3281.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___284_3281.module_name)
      }
              ...
              (let assumed =
               ...
               let env2 =
                 FStar_List.fold_left
                   ...
                   tvars
                  in
               let rec find_return_type eff i uu___281_3898 =
                 match uu___281_3898 with
              ...
              (let assumed =
               ...
               let env2 =
                 FStar_List.fold_left
                   ...
                   tvars
                  in
               let rec find_return_type eff i uu___281_4103 =
