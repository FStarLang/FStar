      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
        ...
        (flavor,flags,{ FStar_Extraction_ML_Syntax.mllb_name = (name,_);
          ...
          let rec find_return_type uu___121_2153 =
            ...
            | t -> t  in
          let t =
            let _0_359 = find_return_type t0  in translate_type env _0_359
             in
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Match (expr,branches) ->
          EMatch
            (let _0_394 = translate_expr env expr  in
             let _0_393 = translate_branches env branches  in
             (_0_394, _0_393))
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          then
            ECast
              (let _0_443 = translate_expr env arg  in
               (_0_443, (TInt UInt64)))
          else
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____2864,fields) ->
          EFlat
            (let _0_460 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
                in
             let _0_459 =
               FStar_List.map
                 (fun uu____2881  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Proj (e,path) ->
          EField
            (let _0_462 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____2907,cons),es) ->
          ECons
            (let _0_465 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
                in
