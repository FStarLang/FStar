...
let extend: env -> Prims.string -> Prims.bool -> env =
  fun env  ->
    fun x  ->
      fun is_mut  ->
        let uu___132_2942 = env in
        {
          names = ({ pretty = x; mut = is_mut } :: (env.names));
          names_t = (uu___132_2942.names_t);
          module_name = (uu___132_2942.module_name)
        }
let extend_t: env -> Prims.string -> env =
  fun env  ->
    fun x  ->
      let uu___133_2951 = env in
      {
        names = (uu___133_2951.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___133_2951.module_name)
      }
    ...
    fun d  ->
      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
          ...
          let assumed =
            FStar_Util.for_some
              (fun uu___129_3446  ->
                 match uu___129_3446 with
                 | FStar_Extraction_ML_Syntax.Assumed  -> true
                 | uu____3447 -> false) flags in
          let env1 =
            ...
            FStar_List.fold_left
              (fun env2  ->
                 fun uu____3460  ->
                   ...
                   | (name1,uu____3466) -> extend_t env2 name1) env1 tvars in
          let rec find_return_type i uu___130_3473 =
            match uu___130_3473 with
      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
          ...
          let assumed =
            FStar_Util.for_some
              (fun uu___129_3621  ->
                 match uu___129_3621 with
                 | FStar_Extraction_ML_Syntax.Assumed  -> true
                 | uu____3622 -> false) flags in
          let env1 =
            if flavor = FStar_Extraction_ML_Syntax.Rec
            then extend env name false
            else env in
            ...
            FStar_List.fold_left
              (fun env2  ->
                 fun uu____3635  ->
                   ...
                   | (name1,uu____3641) -> extend_t env2 name1) env1 tvars in
          let rec find_return_type i uu___130_3648 =
            match uu___130_3648 with
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____3927  ->
                   ...
                   | (name2,uu____3933) -> extend_t env1 name2) env args in
          if assumed
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____4027  ->
                   ...
                   | (name2,uu____4033) -> extend_t env1 name2) env args in
          let uu____4034 =
            let uu____4035 =
              let uu____4058 =
                FStar_List.map
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____4204  ->
                   ...
                   | (name2,uu____4210) -> extend_t env1 name2) env args in
          let uu____4211 =
            let uu____4212 =
              let uu____4245 =
                FStar_List.map
                         ...
                         let uu____4329 =
                           FStar_List.map
                             (fun uu____4356  ->
                                ...
                                | (name2,t) ->
                                    let uu____4371 =
                                      let uu____4376 = translate_type env1 t in
                                      (uu____4376, false) in
                                    (name2, uu____4371)) ts in
                         (cons1, uu____4329)) branches in
    ...
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Let
          ...
          let is_mut =
            FStar_Util.for_some
              (fun uu___131_4698  ->
                 match uu___131_4698 with
                 | FStar_Extraction_ML_Syntax.Mutable  -> true
                 | uu____4699 -> false) flags in
          let uu____4700 =
            if is_mut
            then
              let uu____4709 =
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____5194 =
            let uu____5199 = FStar_Util.must (mk_width m) in (uu____5199, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____5220 =
            let uu____5225 = FStar_Util.must (mk_width m) in (uu____5225, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____5365,fields) ->
          let uu____5383 =
            let uu____5394 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
            let uu____5395 =
              FStar_List.map
                (fun uu____5414  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____5480,cons1),es) ->
          let uu____5497 =
            let uu____5506 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
