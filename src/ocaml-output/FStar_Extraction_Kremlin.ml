      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
        ...
        (flavor,flags,{ FStar_Extraction_ML_Syntax.mllb_name = (name,_);
          ...
          let rec find_return_type uu___144_2112 =
            ...
            | t -> t in
          let t =
            let _0_561 = find_return_type t0 in translate_type env _0_561 in
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Match (expr,branches) ->
          EMatch
            (let _0_596 = translate_expr env expr in
             let _0_595 = translate_branches env branches in (_0_596, _0_595))
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____2807,fields) ->
          EFlat
            (let _0_660 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
             let _0_659 =
               FStar_List.map
                 (fun uu____2824  ->
                    ...
                    | (field,expr) ->
                        ...
                        (field, _0_658)) fields in
             (_0_660, _0_659))
      | FStar_Extraction_ML_Syntax.MLE_Proj (e,path) ->
          EField
            (let _0_662 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____2850,cons),es) ->
          ECons
            (let _0_665 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
