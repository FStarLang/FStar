...
let (uu___is_CDecl : cc -> Prims.bool) =
  fun projectee -> match projectee with | CDecl -> true | uu____1160 -> false
...
let (uu___is_Stack : lifetime -> Prims.bool) =
  fun projectee -> match projectee with | Stack -> true | uu____1244 -> false
...
let (uu___is_EUnit : expr -> Prims.bool) =
  fun projectee -> match projectee with | EUnit -> true | uu____1328 -> false
...
let (uu___is_EAny : expr -> Prims.bool) =
  fun projectee -> match projectee with | EAny -> true | uu____1832 -> false
...
let (uu___is_AddW : op -> Prims.bool) =
  fun projectee -> match projectee with | AddW -> true | uu____2188 -> false
let (uu___is_Sub : op -> Prims.bool) =
  fun projectee -> match projectee with | Sub -> true | uu____2192 -> false
let (uu___is_SubW : op -> Prims.bool) =
  fun projectee -> match projectee with | SubW -> true | uu____2196 -> false
let (uu___is_Div : op -> Prims.bool) =
  fun projectee -> match projectee with | Div -> true | uu____2200 -> false
let (uu___is_DivW : op -> Prims.bool) =
  fun projectee -> match projectee with | DivW -> true | uu____2204 -> false
let (uu___is_Mult : op -> Prims.bool) =
  fun projectee -> match projectee with | Mult -> true | uu____2208 -> false
let (uu___is_MultW : op -> Prims.bool) =
  fun projectee -> match projectee with | MultW -> true | uu____2212 -> false
...
let (uu___is_BAnd : op -> Prims.bool) =
  fun projectee -> match projectee with | BAnd -> true | uu____2224 -> false
let (uu___is_BXor : op -> Prims.bool) =
  fun projectee -> match projectee with | BXor -> true | uu____2228 -> false
...
let (uu___is_BNot : op -> Prims.bool) =
  fun projectee -> match projectee with | BNot -> true | uu____2240 -> false
...
let (uu___is_PUnit : pattern -> Prims.bool) =
  fun projectee -> match projectee with | PUnit -> true | uu____2284 -> false
...
let (uu___is_UInt8 : width -> Prims.bool) =
  fun projectee -> match projectee with | UInt8 -> true | uu____2432 -> false
...
let (uu___is_Int8 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int8 -> true | uu____2448 -> false
let (uu___is_Int16 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int16 -> true | uu____2452 -> false
let (uu___is_Int32 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int32 -> true | uu____2456 -> false
let (uu___is_Int64 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int64 -> true | uu____2460 -> false
let (uu___is_Bool : width -> Prims.bool) =
  fun projectee -> match projectee with | Bool -> true | uu____2464 -> false
let (uu___is_CInt : width -> Prims.bool) =
  fun projectee -> match projectee with | CInt -> true | uu____2468 -> false
...
let (uu___is_TUnit : typ -> Prims.bool) =
  fun projectee -> match projectee with | TUnit -> true | uu____2506 -> false
...
let (uu___is_TBool : typ -> Prims.bool) =
  fun projectee -> match projectee with | TBool -> true | uu____2546 -> false
let (uu___is_TAny : typ -> Prims.bool) =
  fun projectee -> match projectee with | TAny -> true | uu____2550 -> false
      ...
      fun lb ->
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name;
            ...
            let rec find_return_type eff i uu___40_3414 =
              ...
              | FStar_Extraction_ML_Syntax.MLTY_Fun (uu____3419, eff1, t)
             ...
             | (eff, t) ->
                 ...
                 let meta1 =
                   ...
                   | (FStar_Extraction_ML_Syntax.E_GHOST, uu____3455) ->
                       let uu____3456 = translate_flags meta in MustDisappear
                         :: uu____3456
                   | (FStar_Extraction_ML_Syntax.E_PURE, TUnit) ->
                       let uu____3459 = translate_flags meta in MustDisappear
                         :: uu____3459
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name;
            ...
            FStar_Extraction_ML_Syntax.mllb_def =
              {
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____3564;_},
            ...
            let rec find_return_type eff i uu___40_3611 =
              ...
              | FStar_Extraction_ML_Syntax.MLTY_Fun (uu____3616, eff1, t)
                  when i > (Prims.parse_int "0") ->
                  find_return_type eff1 (i - (Prims.parse_int "1")) t
              | t -> (eff, t) in
            let uu____3620 =
             ...
             | (eff, t) ->
                 ...
                 let meta1 =
                   ...
                   | (FStar_Extraction_ML_Syntax.E_GHOST, uu____3652) ->
                       let uu____3653 = translate_flags meta in MustDisappear
                         :: uu____3653
                   | (FStar_Extraction_ML_Syntax.E_PURE, TUnit) ->
                       let uu____3656 = translate_flags meta in MustDisappear
                         :: uu____3656
            ...
            ((let uu____3832 =
                let uu____3837 =
                  FStar_Util.format1 "Not translating definition for %s\n"
                    name in
                (FStar_Errors.Warning_DefinitionNotTranslated, uu____3837) in
          ...
          then
            ...
            (let uu____3883 =
               let uu____3884 =
                 ...
                 (name1, uu____3901, (FStar_List.length args), uu____3904) in
               DTypeAlias uu____3884 in
             FStar_Pervasives_Native.Some uu____3883)
      | (uu____3913, name, _mangled_name, args, flags1,
                         ...
                         let uu____4201 =
                           FStar_List.map
                             (fun uu____4228 ->
                                ...
                                | (name2, t) ->
                                    let uu____4243 =
                                      let uu____4248 = translate_type env1 t in
                                      (uu____4248, false) in
                                    (name2, uu____4243)) ts in
                         (cons1, uu____4201)) branches in
    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named
          ...
          (((let uu____4367 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____4367 = "FStar.Monotonic.HyperStack.s_mref") ||
              (let uu____4369 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____4369 = "FStar.Monotonic.HyperHeap.mrref"))
             ||
             (let uu____4371 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::uu____4376::[], p) when
          ((((((((((let uu____4382 =
              ...
              ||
              (let uu____4398 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[], p) when
          ((((((((((let uu____4410 =
              ...
              ||
              (let uu____4426 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
    ...
    fun e ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4644;_},
                t::[]);
             FStar_Extraction_ML_Syntax.mlty = uu____4646;
             FStar_Extraction_ML_Syntax.loc = uu____4647;_},
           arg::[])
          when
          ...
          let uu____4654 =
            ...
            let uu____4660 = translate_type env t in (uu____4659, uu____4660) in
          ECast uu____4654
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4666;_},
           uu____4667)
          when
               ...
               let print7 =
                 let uu____4702 =
                   let uu____4703 =
                     ...
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____4704 in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____4703 in
                 FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top uu____4702 in
               let print8 =
                 FStar_Extraction_ML_Syntax.with_ty
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4737;_},
                uu____4738);
             FStar_Extraction_ML_Syntax.mlty = uu____4739;
             FStar_Extraction_ML_Syntax.loc = uu____4740;_},
           e1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4757;_},
                uu____4758);
             FStar_Extraction_ML_Syntax.mlty = uu____4759;
             FStar_Extraction_ML_Syntax.loc = uu____4760;_},
           e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4784;_},
           init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4803;_},
                uu____4804);
             FStar_Extraction_ML_Syntax.mlty = uu____4805;
             FStar_Extraction_ML_Syntax.loc = uu____4806;_},
           e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4900;_},
                uu____4901);
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4948;_},
                uu____4949);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4976;_},
           e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4988;_},
                uu____4989);
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5026;_},
                uu____5027);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5096;_},
           e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5117;_},
           uu____5118::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5131;_},
                uu____5132);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5191;_},
           uu____5192::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5235;_},
           {
             ...
             FStar_Extraction_ML_Syntax.mlty = uu____5237;
             FStar_Extraction_ML_Syntax.loc = uu____5238;_}::[])
          when is_machine_int m ->
          let uu____5253 =
            let uu____5258 = FStar_Util.must (mk_width m) in (uu____5258, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____5279 =
            let uu____5284 = FStar_Util.must (mk_width m) in (uu____5284, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5289;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5300;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_String s) -> EString s
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5309;_},
           arg::[])
          ->
          let is_known_type =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____5435, fields) ->
          let uu____5453 =
            let uu____5464 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
            let uu____5465 =
              FStar_List.map
                (fun uu____5484 ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____5548, cons1), es) ->
          let uu____5565 =
            let uu____5574 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
