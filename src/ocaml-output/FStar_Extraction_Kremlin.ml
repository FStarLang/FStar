...
let extend : env -> Prims.string -> Prims.bool -> env =
  fun env  ->
    fun x  ->
      fun is_mut  ->
        let uu___410_2890 = env  in
        {
          names = ({ pretty = x; mut = is_mut } :: (env.names));
          names_t = (uu___410_2890.names_t);
          module_name = (uu___410_2890.module_name)
        }
  
let extend_t : env -> Prims.string -> env =
  fun env  ->
    fun x  ->
      let uu___411_2897 = env  in
      {
        names = (uu___411_2897.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___411_2897.module_name)
      }
        ...
        fun lb  ->
          ...
          | { FStar_Extraction_ML_Syntax.mllb_name = name;
              ...
              let assumed =
                FStar_Util.for_some
                  (fun uu___406_3407  ->
                     match uu___406_3407 with
                     | FStar_Extraction_ML_Syntax.Assumed  -> true
                     | uu____3408 -> false) flags
                 in
              let env1 =
              ...
              let env2 =
                FStar_List.fold_left
                 ...
                 in
              let rec find_return_type eff i uu___407_3429 =
                match uu___407_3429 with
          ...
          | { FStar_Extraction_ML_Syntax.mllb_name = name;
              ...
              let assumed =
                FStar_Util.for_some
                  (fun uu___406_3588  ->
                     match uu___406_3588 with
                     | FStar_Extraction_ML_Syntax.Assumed  -> true
                     | uu____3589 -> false) flags
                 in
              let env1 =
                if flavor = FStar_Extraction_ML_Syntax.Rec
                then extend env name false
              ...
              let env2 =
                FStar_List.fold_left
                  (fun env2  -> fun name1  -> extend_t env2 name1) env1 tvars
                 in
              let rec find_return_type eff i uu___407_3610 =
                match uu___407_3610 with
          ...
          then FStar_Pervasives_Native.None
            ...
            (let uu____3852 =
               let uu____3853 =
                 ...
                 (name1, uu____3870, (FStar_List.length args), uu____3873)
                  in
                         ...
                         let uu____4170 =
                           FStar_List.map
                             (fun uu____4197  ->
                                ...
                                | (name2,t) ->
                                    let uu____4212 =
                                      let uu____4217 = translate_type env1 t
                                         in
                                      (uu____4217, false)  in
                                    (name2, uu____4212)) ts
                            in
                         (cons1, uu____4170)) branches
                 in
    ...
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Let
          ...
          let is_mut =
            FStar_Util.for_some
              (fun uu___408_4479  ->
                 match uu___408_4479 with
                 | FStar_Extraction_ML_Syntax.Mutable  -> true
                 | uu____4480 -> false) flags
             in
          let uu____4481 =
            if is_mut
            then
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu____4612 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____4612 = "FStar.Buffer.index") ||
            (let uu____4614 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____4730 =
            let uu____4737 =
              let uu____4740 = list_elements2 e2  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____4973 =
            let uu____4978 = FStar_Util.must (mk_width m)  in (uu____4978, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____4999 =
            let uu____5004 = FStar_Util.must (mk_width m)  in (uu____5004, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____5155,fields) ->
          let uu____5173 =
            let uu____5184 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
            let uu____5185 =
              FStar_List.map
                (fun uu____5204  ->
...
and translate_constant : FStar_Extraction_ML_Syntax.mlconstant -> expr =
  fun c  ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s,FStar_Pervasives_Native.Some uu____5902) ->
        failwith
          "impossible: machine integer not desugared to a function call"
    | FStar_Extraction_ML_Syntax.MLC_Float uu____5917 ->
        failwith "todo: translate_expr [MLC_Float]"
    | FStar_Extraction_ML_Syntax.MLC_Char uu____5918 ->
        failwith "todo: translate_expr [MLC_Char]"
    | FStar_Extraction_ML_Syntax.MLC_String uu____5919 ->
        failwith "todo: translate_expr [MLC_String]"
    | FStar_Extraction_ML_Syntax.MLC_Bytes uu____5920 ->
  ...
  fun env  ->
    fun w  ->
      fun op  ->
        fun args  ->
          let uu____5940 =
            let uu____5947 = FStar_List.map (translate_expr env) args  in
            ((EOp (op, w)), uu____5947)  in
          EApp uu____5940
