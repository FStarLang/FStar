      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
          ...
          (FStar_Util.print1
           ...
           (match ts with
            | Some (idents,t) ->
                let uu____2278 =
                  let uu____2279 = FStar_List.map FStar_Pervasives.fst idents
                     in
    ...
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu____2826 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____2826 = "FStar.Buffer.index") ||
            (let uu____2827 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu____2943 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____2943 = "FStar.Buffer.upd") ||
            (let uu____2944 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
        ...
        ({
          ...
          let uu____3058 =
            let uu____3061 = FStar_Util.must (mk_width m)  in (uu____3061, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____3168,fields) ->
          let uu____3178 =
            let uu____3184 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
            let uu____3185 =
              FStar_List.map
                (fun uu____3193  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____3235,cons1),es) ->
          let uu____3245 =
            let uu____3250 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
