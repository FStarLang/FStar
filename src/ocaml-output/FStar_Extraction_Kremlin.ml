  ...
  fun env  ->
    fun x  ->
      let uu___269_3270 = env  in
      {
        ...
        names_t = (uu___269_3270.names_t);
        module_name = (uu___269_3270.module_name)
      }
  
let (extend_t : env -> Prims.string -> env) =
  fun env  ->
    fun x  ->
      let uu___270_3281 = env  in
      {
        names = (uu___270_3281.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___270_3281.module_name)
      }
              ...
              (let assumed =
               ...
               let env2 =
                 FStar_List.fold_left
                   ...
                   tvars
                  in
               let rec find_return_type eff i uu___267_3898 =
                 match uu___267_3898 with
              ...
              (let assumed =
               ...
               let env2 =
                 FStar_List.fold_left
                   ...
                   tvars
                  in
               let rec find_return_type eff i uu___267_4103 =
                 match uu___267_4103 with
