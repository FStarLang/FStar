...
let uu___is_CDecl : cc -> Prims.bool =
  fun projectee  ->
    match projectee with | CDecl  -> true | uu____1164 -> false
...
let uu___is_Stack : lifetime -> Prims.bool =
  fun projectee  ->
    match projectee with | Stack  -> true | uu____1248 -> false
...
let uu___is_EUnit : expr -> Prims.bool =
  fun projectee  ->
    match projectee with | EUnit  -> true | uu____1332 -> false
...
let uu___is_EAny : expr -> Prims.bool =
  fun projectee  ->
    match projectee with | EAny  -> true | uu____1836 -> false
...
let uu___is_AddW : op -> Prims.bool =
  fun projectee  ->
    match projectee with | AddW  -> true | uu____2192 -> false
  
let uu___is_Sub : op -> Prims.bool =
  fun projectee  -> match projectee with | Sub  -> true | uu____2196 -> false 
let uu___is_SubW : op -> Prims.bool =
  fun projectee  ->
    match projectee with | SubW  -> true | uu____2200 -> false
  
let uu___is_Div : op -> Prims.bool =
  fun projectee  -> match projectee with | Div  -> true | uu____2204 -> false 
let uu___is_DivW : op -> Prims.bool =
  fun projectee  ->
    match projectee with | DivW  -> true | uu____2208 -> false
  
let uu___is_Mult : op -> Prims.bool =
  fun projectee  ->
    match projectee with | Mult  -> true | uu____2212 -> false
  
let uu___is_MultW : op -> Prims.bool =
  fun projectee  ->
    match projectee with | MultW  -> true | uu____2216 -> false
...
let uu___is_BAnd : op -> Prims.bool =
  fun projectee  ->
    match projectee with | BAnd  -> true | uu____2228 -> false
  
let uu___is_BXor : op -> Prims.bool =
  fun projectee  ->
    match projectee with | BXor  -> true | uu____2232 -> false
...
let uu___is_BNot : op -> Prims.bool =
  fun projectee  ->
    match projectee with | BNot  -> true | uu____2244 -> false
...
let uu___is_PUnit : pattern -> Prims.bool =
  fun projectee  ->
    match projectee with | PUnit  -> true | uu____2288 -> false
...
let uu___is_UInt8 : width -> Prims.bool =
  fun projectee  ->
    match projectee with | UInt8  -> true | uu____2436 -> false
...
let uu___is_Int8 : width -> Prims.bool =
  fun projectee  ->
    match projectee with | Int8  -> true | uu____2452 -> false
  
let uu___is_Int16 : width -> Prims.bool =
  fun projectee  ->
    match projectee with | Int16  -> true | uu____2456 -> false
  
let uu___is_Int32 : width -> Prims.bool =
  fun projectee  ->
    match projectee with | Int32  -> true | uu____2460 -> false
  
let uu___is_Int64 : width -> Prims.bool =
  fun projectee  ->
    match projectee with | Int64  -> true | uu____2464 -> false
  
let uu___is_Bool : width -> Prims.bool =
  fun projectee  ->
    match projectee with | Bool  -> true | uu____2468 -> false
  
let uu___is_CInt : width -> Prims.bool =
  fun projectee  ->
    match projectee with | CInt  -> true | uu____2472 -> false
...
let uu___is_TUnit : typ -> Prims.bool =
  fun projectee  ->
    match projectee with | TUnit  -> true | uu____2518 -> false
...
let uu___is_TBool : typ -> Prims.bool =
  fun projectee  ->
    match projectee with | TBool  -> true | uu____2558 -> false
  
let uu___is_TAny : typ -> Prims.bool =
  fun projectee  ->
    match projectee with | TAny  -> true | uu____2562 -> false
...
let extend : env -> Prims.string -> Prims.bool -> env =
  fun env  ->
    fun x  ->
      fun is_mut  ->
        let uu___44_2958 = env  in
        {
          names = ({ pretty = x; mut = is_mut } :: (env.names));
          names_t = (uu___44_2958.names_t);
          module_name = (uu___44_2958.module_name)
        }
  
let extend_t : env -> Prims.string -> env =
  fun env  ->
    fun x  ->
      let uu___45_2965 = env  in
      {
        names = (uu___45_2965.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___45_2965.module_name)
      }
      ...
      fun lb  ->
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name;
            ...
            let assumed =
              FStar_Util.for_some
                (fun uu___40_3424  ->
                   match uu___40_3424 with
                   | FStar_Extraction_ML_Syntax.Assumed  -> true
                   | uu____3425 -> false) meta
               in
            let env1 =
            ...
            let env2 =
              FStar_List.fold_left
               ...
               in
            let rec find_return_type eff i uu___41_3446 =
              match uu___41_3446 with
              | FStar_Extraction_ML_Syntax.MLTY_Fun (uu____3451,eff1,t) when
                  i > (Prims.parse_int "0") ->
             ...
             | (eff,t) ->
                 ...
                 let meta1 =
                   ...
                   | (FStar_Extraction_ML_Syntax.E_GHOST ,uu____3487) ->
                       let uu____3488 = translate_flags meta  in
                       MustDisappear :: uu____3488
                   | (FStar_Extraction_ML_Syntax.E_PURE ,TUnit ) ->
                       let uu____3491 = translate_flags meta  in
                       MustDisappear :: uu____3491
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name;
            ...
            FStar_Extraction_ML_Syntax.mllb_def =
              {
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____3596;_},uu____3597,uu____3598);
            ...
            let assumed =
              FStar_Util.for_some
                (fun uu___40_3621  ->
                   match uu___40_3621 with
                   | FStar_Extraction_ML_Syntax.Assumed  -> true
                   | uu____3622 -> false) meta
               in
            let env1 =
              if flavor = FStar_Extraction_ML_Syntax.Rec
              then extend env name false
            ...
            let env2 =
              FStar_List.fold_left
                (fun env2  -> fun name1  -> extend_t env2 name1) env1 tvars
               in
            let rec find_return_type eff i uu___41_3643 =
              match uu___41_3643 with
              | FStar_Extraction_ML_Syntax.MLTY_Fun (uu____3648,eff1,t) when
                  i > (Prims.parse_int "0") ->
                  find_return_type eff1 (i - (Prims.parse_int "1")) t
              | t -> (eff, t)  in
            let uu____3652 =
             ...
             | (eff,t) ->
                 ...
                 let meta1 =
                   ...
                   | (FStar_Extraction_ML_Syntax.E_GHOST ,uu____3684) ->
                       let uu____3685 = translate_flags meta  in
                       MustDisappear :: uu____3685
                   | (FStar_Extraction_ML_Syntax.E_PURE ,TUnit ) ->
                       let uu____3688 = translate_flags meta  in
                       MustDisappear :: uu____3688
            ...
            ((let uu____3864 =
                let uu____3869 =
                  FStar_Util.format1 "Not translating definition for %s\n"
                    name
                   in
                (FStar_Errors.Warning_DefinitionNotTranslated, uu____3869)
                 in
...
and translate_type_decl :
  ...
  fun env  ->
    fun ty  ->
          ...
          then
            ...
            (let uu____3915 =
               let uu____3916 =
                 ...
                 (name1, uu____3933, (FStar_List.length args), uu____3936)
                  in
               DTypeAlias uu____3916  in
             FStar_Pervasives_Native.Some uu____3915)
      | (uu____3945,name,_mangled_name,args,flags1,FStar_Pervasives_Native.Some
      ...
      | (uu____4078,name,_mangled_name,args,flags1,FStar_Pervasives_Native.Some
    ...
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Let
          ...
          let is_mut =
            FStar_Util.for_some
              (fun uu___42_4624  ->
                 match uu___42_4624 with
                 | FStar_Extraction_ML_Syntax.Mutable  -> true
                 | uu____4625 -> false) flags1
             in
          let uu____4626 =
            if is_mut
            then
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4711;_},t::[]);
             FStar_Extraction_ML_Syntax.mlty = uu____4713;
             FStar_Extraction_ML_Syntax.loc = uu____4714;_},arg::[])
          when
          ...
          let uu____4721 =
            ...
            let uu____4727 = translate_type env t  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4730;_},uu____4731);
             FStar_Extraction_ML_Syntax.mlty = uu____4732;
             FStar_Extraction_ML_Syntax.loc = uu____4733;_},uu____4734)
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4749;_},arg::[])
          when
                   ...
                   let uu____4770 =
                     let uu____4771 =
                       FStar_Ident.lid_of_str
                        ...
                        in
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____4771
                      in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____4770  in
                 FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top uu____4769
                  in
               let print8 =
                 FStar_Extraction_ML_Syntax.with_ty
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4839;_},e1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4856;_},uu____4857);
             FStar_Extraction_ML_Syntax.mlty = uu____4858;
             FStar_Extraction_ML_Syntax.loc = uu____4859;_},e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4883;_},init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____4902;_},uu____4903);
             FStar_Extraction_ML_Syntax.mlty = uu____4904;
             FStar_Extraction_ML_Syntax.loc = uu____4905;_},_rid::init1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4928;_},_e0::e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4953;_},_e0::e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4978;_},e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5049;_},uu____5050);
             FStar_Extraction_ML_Syntax.mlty = uu____5051;
             FStar_Extraction_ML_Syntax.loc = uu____5052;_},e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5064;_},uu____5065);
             FStar_Extraction_ML_Syntax.mlty = uu____5066;
             FStar_Extraction_ML_Syntax.loc = uu____5067;_},e1::e2::_e3::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5090;_},e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5127;_},e1::e2::e3::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5157;_},e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5178;_},uu____5179::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5192;_},uu____5193);
             FStar_Extraction_ML_Syntax.mlty = uu____5194;
             FStar_Extraction_ML_Syntax.loc = uu____5195;_},e1::e2::e3::e4::e5::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5226;_},uu____5227);
             FStar_Extraction_ML_Syntax.mlty = uu____5228;
             FStar_Extraction_ML_Syntax.loc = uu____5229;_},e1::e2::e3::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5259;_},e1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5273;_},args)
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5285;_},args)
          when is_bool_op op ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____5314 =
            let uu____5319 = FStar_Util.must (mk_width m)  in (uu____5319, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____5340 =
            let uu____5345 = FStar_Util.must (mk_width m)  in (uu____5345, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5370;_},arg::[])
          ->
          let is_known_type =
