...
let (extend : env -> Prims.string -> env) =
  fun env  ->
    fun x  ->
      let uu___272_3276 = env  in
      {
        names = ({ pretty = x } :: (env.names));
        names_t = (uu___272_3276.names_t);
        module_name = (uu___272_3276.module_name)
      }
  
let (extend_t : env -> Prims.string -> env) =
  fun env  ->
    fun x  ->
      let uu___273_3287 = env  in
      {
        names = (uu___273_3287.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___273_3287.module_name)
      }
              ...
              (let assumed =
               ...
               let env2 =
                 FStar_List.fold_left
                   ...
                   tvars
                  in
               let rec find_return_type eff i uu___270_3900 =
                 match uu___270_3900 with
              ...
              (let assumed =
               ...
               let env2 =
                 FStar_List.fold_left
                   ...
                   tvars
                  in
               let rec find_return_type eff i uu___270_4105 =
                 match uu___270_4105 with
