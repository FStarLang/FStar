          ...
          then FStar_Pervasives_Native.None
            ...
            (let uu____3808 =
               let uu____3809 =
                 ...
                 (name1, uu____3826, (FStar_List.length args), uu____3829) in
                         ...
                         let uu____4126 =
                           FStar_List.map
                             (fun uu____4153  ->
                                ...
                                | (name2,t) ->
                                    let uu____4168 =
                                      let uu____4173 = translate_type env1 t in
                                      (uu____4173, false) in
                                    (name2, uu____4168)) ts in
                         (cons1, uu____4126)) branches in
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu____4568 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu____4568 = "FStar.Buffer.index") ||
            (let uu____4570 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____4929 =
            let uu____4934 = FStar_Util.must (mk_width m) in (uu____4934, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____4955 =
            let uu____4960 = FStar_Util.must (mk_width m) in (uu____4960, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____5111,fields) ->
          let uu____5129 =
            let uu____5140 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
            let uu____5141 =
              FStar_List.map
                (fun uu____5160  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____5226,cons1),es) ->
          let uu____5243 =
            let uu____5252 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
...
and translate_constant: FStar_Extraction_ML_Syntax.mlconstant -> expr =
  fun c  ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_String s ->
        ((let uu____5795 =
            let uu____5796 = FStar_String.list_of_string s in
         ...
         EString s)
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s,FStar_Pervasives_Native.Some uu____5806) ->
        failwith
          "impossible: machine integer not desugared to a function call"
    | FStar_Extraction_ML_Syntax.MLC_Float uu____5821 ->
        failwith "todo: translate_expr [MLC_Float]"
    | FStar_Extraction_ML_Syntax.MLC_Char uu____5822 ->
        failwith "todo: translate_expr [MLC_Char]"
    | FStar_Extraction_ML_Syntax.MLC_Bytes uu____5823 ->
  ...
  fun env  ->
    fun w  ->
      fun op  ->
        fun args  ->
          let uu____5843 =
            let uu____5850 = FStar_List.map (translate_expr env) args in
            ((EOp (op, w)), uu____5850) in
          EApp uu____5843