...
let (extend : env -> Prims.string -> env) =
  fun env  ->
    fun x  ->
      let uu___280_3270 = env  in
      {
        names = ({ pretty = x } :: (env.names));
        names_t = (uu___280_3270.names_t);
        module_name = (uu___280_3270.module_name)
      }
  
let (extend_t : env -> Prims.string -> env) =
  fun env  ->
    fun x  ->
      let uu___281_3281 = env  in
      {
        names = (uu___281_3281.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___281_3281.module_name)
      }
              ...
              (let assumed =
               ...
               let env2 =
                 FStar_List.fold_left
                   ...
                   tvars
                  in
               let rec find_return_type eff i uu___278_3894 =
                 match uu___278_3894 with
              ...
              (let assumed =
               ...
               let env2 =
                 FStar_List.fold_left
                   ...
                   tvars
                  in
               let rec find_return_type eff i uu___278_4099 =
                 match uu___278_4099 with
