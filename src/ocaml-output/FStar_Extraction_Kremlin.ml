...
let (uu___is_CDecl : cc -> Prims.bool) =
  fun projectee -> match projectee with | CDecl -> true | uu____1643 -> false
...
let (uu___is_IfDef : flag -> Prims.bool) =
  fun projectee -> match projectee with | IfDef -> true | uu____1834 -> false
let (uu___is_Macro : flag -> Prims.bool) =
  fun projectee -> match projectee with | Macro -> true | uu____1845 -> false
...
let (uu___is_Stack : lifetime -> Prims.bool) =
  fun projectee -> match projectee with | Stack -> true | uu____1890 -> false
...
let (uu___is_EUnit : expr -> Prims.bool) =
  fun projectee -> match projectee with | EUnit -> true | uu____2025 -> false
...
let (uu___is_EAny : expr -> Prims.bool) =
  fun projectee -> match projectee with | EAny -> true | uu____2659 -> false
...
let (uu___is_AddW : op -> Prims.bool) =
  fun projectee -> match projectee with | AddW -> true | uu____3175 -> false
let (uu___is_Sub : op -> Prims.bool) =
  fun projectee -> match projectee with | Sub -> true | uu____3186 -> false
let (uu___is_SubW : op -> Prims.bool) =
  fun projectee -> match projectee with | SubW -> true | uu____3197 -> false
let (uu___is_Div : op -> Prims.bool) =
  fun projectee -> match projectee with | Div -> true | uu____3208 -> false
let (uu___is_DivW : op -> Prims.bool) =
  fun projectee -> match projectee with | DivW -> true | uu____3219 -> false
let (uu___is_Mult : op -> Prims.bool) =
  fun projectee -> match projectee with | Mult -> true | uu____3230 -> false
let (uu___is_MultW : op -> Prims.bool) =
  fun projectee -> match projectee with | MultW -> true | uu____3241 -> false
...
let (uu___is_BAnd : op -> Prims.bool) =
  fun projectee -> match projectee with | BAnd -> true | uu____3274 -> false
let (uu___is_BXor : op -> Prims.bool) =
  fun projectee -> match projectee with | BXor -> true | uu____3285 -> false
...
let (uu___is_BNot : op -> Prims.bool) =
  fun projectee -> match projectee with | BNot -> true | uu____3318 -> false
...
let (uu___is_PUnit : pattern -> Prims.bool) =
  fun projectee -> match projectee with | PUnit -> true | uu____3439 -> false
...
let (uu___is_UInt8 : width -> Prims.bool) =
  fun projectee -> match projectee with | UInt8 -> true | uu____3652 -> false
...
let (uu___is_Int8 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int8 -> true | uu____3696 -> false
let (uu___is_Int16 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int16 -> true | uu____3707 -> false
let (uu___is_Int32 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int32 -> true | uu____3718 -> false
let (uu___is_Int64 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int64 -> true | uu____3729 -> false
let (uu___is_Bool : width -> Prims.bool) =
  fun projectee -> match projectee with | Bool -> true | uu____3740 -> false
let (uu___is_CInt : width -> Prims.bool) =
  fun projectee -> match projectee with | CInt -> true | uu____3751 -> false
...
let (uu___is_TUnit : typ -> Prims.bool) =
  fun projectee -> match projectee with | TUnit -> true | uu____3837 -> false
...
let (uu___is_TBool : typ -> Prims.bool) =
  fun projectee -> match projectee with | TBool -> true | uu____3899 -> false
let (uu___is_TAny : typ -> Prims.bool) =
  fun projectee -> match projectee with | TAny -> true | uu____3910 -> false
    ...
    let uu____5111 =
      FStar_List.choose
        (fun uu___4_5118 ->
           ...
           | uu____5125 -> FStar_Pervasives_Native.None) flags in
      ...
      fun lb ->
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name;
            ...
            ((let uu____5628 =
                ...
                (FStar_Errors.Warning_DefinitionNotTranslated, uu____5634) in
      ...
      | (uu____5658, uu____5659, uu____5660, uu____5661, flags, uu____5663)
          ...
          then FStar_Pervasives_Native.None
            ...
            (match ty with
             ...
             | (uu____5774, name, _mangled_name, args, flags1,
                FStar_Pervasives_Native.Some
                                    ...
                                    (fun uu____6169 ->
                                       ...
                                       | (name2, t) ->
                                           let uu____6189 =
                                             ...
                                             (uu____6195, false) in
                                           (name2, uu____6189)) ts in
                                (cons1, uu____6137)) branches in
                     (name1, flags2, (FStar_List.length args), uu____6036) in
                   DTypeVariant uu____5997 in
                 FStar_Pervasives_Native.Some uu____5996
             | (uu____6248, name, _mangled_name, uu____6251, uu____6252,
                uu____6253) ->
                 ((let uu____6269 =
                     let uu____6275 =
                       FStar_Util.format1
  ...
  fun env ->
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named
          ...
          (((let uu____6353 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____6353 = "FStar.Monotonic.HyperStack.s_mref") ||
              (let uu____6358 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____6358 = "FStar.Monotonic.HyperHeap.mrref"))
             ||
             (let uu____6363 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____6363 = "FStar.HyperStack.ST.m_rref"))
            ||
            (let uu____6368 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::uu____6374::[], p) when
          ((((((((((let uu____6380 =
              ...
              ||
              (let uu____6420 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____6420 = "FStar.HyperStack.ST.mref"))
             ||
             (let uu____6425 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____6425 = "FStar.HyperStack.ST.mmmstackref"))
            ||
            (let uu____6430 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[], p) when
          (((((((((((((let uu____6461 =
            ...
            ||
            (let uu____6526 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (uu____6531::arg::[], p) when
          (let uu____6538 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu____6538 = "FStar.HyperStack.s_ref") ||
            (let uu____6543 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
    ...
    fun e ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6798;_},
           arg::[])
          when
          ...
          let uu____6808 =
            ...
            let uu____6814 = translate_type env t in (uu____6813, uu____6814) in
          ECast uu____6808
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6817;_},
                uu____6818);
             FStar_Extraction_ML_Syntax.mlty = uu____6819;
             FStar_Extraction_ML_Syntax.loc = uu____6820;_},
           uu____6821)
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6836;_},
                uu____6837);
             FStar_Extraction_ML_Syntax.mlty = uu____6838;
             FStar_Extraction_ML_Syntax.loc = uu____6839;_},
           arg::[])
          when
          ((let uu____6849 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            ||
            (let uu____6859 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               ...
               let print7 =
                 let uu____6869 =
                   let uu____6870 =
                     ...
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____6871 in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____6870 in
                 FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top uu____6869 in
               let print8 =
                 FStar_Extraction_ML_Syntax.with_ty
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           e1::e2::[])
          when
          ((((let uu____6917 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____6917 = "FStar.Buffer.index") ||
               (let uu____6922 =
                  FStar_Extraction_ML_Syntax.string_of_mlpath p in
                uu____6922 = "FStar.Buffer.op_Array_Access"))
              ||
              (let uu____6927 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____6927 = "LowStar.Monotonic.Buffer.index"))
             ||
             (let uu____6932 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____6932 = "LowStar.UninitializedBuffer.uindex"))
            ||
            (let uu____6937 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6950;_},
                uu____6951);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6975;_},
                uu____6976);
             FStar_Extraction_ML_Syntax.mlty = uu____6977;
             FStar_Extraction_ML_Syntax.loc = uu____6978;_},
           e1::e2::[])
          when
          ((let uu____6989 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            ||
            (let uu____6999 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7037;_},
                uu____7038);
             FStar_Extraction_ML_Syntax.mlty = uu____7039;
             FStar_Extraction_ML_Syntax.loc = uu____7040;_},
           init1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7064;_},
                uu____7065);
          ...
          ((let uu____7077 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            ||
            (let uu____7087 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7151;_},
           _rid::init1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7179;_},
           _e0::e1::e2::[])
          when
          ((let uu____7191 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            ||
            (let uu____7201 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7216;_},
                uu____7217);
             FStar_Extraction_ML_Syntax.mlty = uu____7218;
             FStar_Extraction_ML_Syntax.loc = uu____7219;_},
           uu____7220)
          when
          (((((let uu____7231 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              ...
              ||
              (let uu____7246 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____7246 = "LowStar.ImmutableBuffer.igcmalloc_and_blit"))
             ||
             (let uu____7251 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7290;_},
           _rid::init1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (((let uu____7330 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____7330 = "FStar.Buffer.rcreate_mm") ||
              (let uu____7335 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____7335 = "LowStar.Monotonic.Buffer.mmalloc"))
             ||
             (let uu____7340 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7360;_},
                uu____7361);
             FStar_Extraction_ML_Syntax.mlty = uu____7362;
             FStar_Extraction_ML_Syntax.loc = uu____7363;_},
           _erid::elen::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7384;_},
                uu____7385);
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7427;_},
                uu____7428);
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7453;_},
                uu____7454);
             FStar_Extraction_ML_Syntax.mlty = uu____7455;
             FStar_Extraction_ML_Syntax.loc = uu____7456;_},
           e1::e2::_e3::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7489;_},
           e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7554;_},
                uu____7555);
             FStar_Extraction_ML_Syntax.mlty = uu____7556;
             FStar_Extraction_ML_Syntax.loc = uu____7557;_},
           e1::e2::e3::[])
          when
          (((let uu____7569 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            ||
            (let uu____7584 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7600;_},
                uu____7601);
             FStar_Extraction_ML_Syntax.mlty = uu____7602;
             FStar_Extraction_ML_Syntax.loc = uu____7603;_},
           e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7629;_},
           uu____7630::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7639;_},
           uu____7640::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           e1::e2::e3::e4::e5::[])
          when
          ((let uu____7666 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu____7666 = "FStar.Buffer.blit") ||
             (let uu____7671 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7671 = "LowStar.Monotonic.Buffer.blit"))
            ||
            (let uu____7676 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7701;_},
           e1::e2::e3::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7739;_},
                uu____7740);
             FStar_Extraction_ML_Syntax.mlty = uu____7741;
             FStar_Extraction_ML_Syntax.loc = uu____7742;_},
           _ebuf::_eseq::[])
          when
          (((let uu____7753 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____7753 = "LowStar.Monotonic.Buffer.witness_p") ||
              (let uu____7758 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____7758 = "LowStar.Monotonic.Buffer.recall_p"))
             ||
             (let uu____7763 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7774;_},
                uu____7775);
             FStar_Extraction_ML_Syntax.mlty = uu____7776;
             FStar_Extraction_ML_Syntax.loc = uu____7777;_},
           e1::[])
          when
          ((((let uu____7787 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             ...
             ||
             (let uu____7802 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7813;_},
           e1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7830;_},
           args)
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7850;_},
           args)
          when is_bool_op op ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____7895 =
            let uu____7901 = FStar_Util.must (mk_width m) in (uu____7901, c) in
          ...
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7905;_},
           {
             FStar_Extraction_ML_Syntax.expr =
               ...
               (FStar_Extraction_ML_Syntax.MLC_Int
               (c, FStar_Pervasives_Native.None));
             FStar_Extraction_ML_Syntax.mlty = uu____7907;
             FStar_Extraction_ML_Syntax.loc = uu____7908;_}::[])
          when is_machine_int m ->
          let uu____7933 =
            let uu____7939 = FStar_Util.must (mk_width m) in (uu____7939, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             FStar_Extraction_ML_Syntax.mlty = uu____7963;
             FStar_Extraction_ML_Syntax.loc = uu____7964;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_String s) -> EString s
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7987;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_String s) -> EString s
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             FStar_Extraction_ML_Syntax.mlty = uu____8007;
             FStar_Extraction_ML_Syntax.loc = uu____8008;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____8027;_},
           arg::[])
          ->
          let is_known_type =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____8205, fields) ->
          let uu____8227 =
            let uu____8239 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
            let uu____8240 =
              FStar_List.map
                (fun uu____8262 ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____8344, cons1), es) ->
          let uu____8359 =
            let uu____8369 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
      ...
      | uu____8499 ->
          let uu____8500 =
            let uu____8502 =
              FStar_Extraction_ML_Code.string_of_mlty ([], "") t in
            FStar_Util.format1
              "invalid argument: expected MLTY_Named, got %s" uu____8502 in
          failwith uu____8500
