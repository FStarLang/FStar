...
let extend : env -> Prims.string -> Prims.bool -> env =
  fun env  ->
    fun x  ->
      fun is_mut  ->
        let uu___202_2890 = env  in
        {
          names = ({ pretty = x; mut = is_mut } :: (env.names));
          names_t = (uu___202_2890.names_t);
          module_name = (uu___202_2890.module_name)
        }
  
let extend_t : env -> Prims.string -> env =
  fun env  ->
    fun x  ->
      let uu___203_2897 = env  in
      {
        names = (uu___203_2897.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___203_2897.module_name)
      }
        ...
        fun lb  ->
          ...
          | { FStar_Extraction_ML_Syntax.mllb_name = name;
              ...
              let assumed =
                FStar_Util.for_some
                  (fun uu___198_3356  ->
                     match uu___198_3356 with
                     | FStar_Extraction_ML_Syntax.Assumed  -> true
                     | uu____3357 -> false) flags1
                 in
              let env1 =
              ...
              let env2 =
                FStar_List.fold_left
                 ...
                 in
              let rec find_return_type eff i uu___199_3378 =
                match uu___199_3378 with
          ...
          | { FStar_Extraction_ML_Syntax.mllb_name = name;
              ...
              let assumed =
                FStar_Util.for_some
                  (fun uu___198_3552  ->
                     match uu___198_3552 with
                     | FStar_Extraction_ML_Syntax.Assumed  -> true
                     | uu____3553 -> false) flags1
                 in
              let env1 =
                if flavor = FStar_Extraction_ML_Syntax.Rec
                then extend env name false
              ...
              let env2 =
                FStar_List.fold_left
                  (fun env2  -> fun name1  -> extend_t env2 name1) env1 tvars
                 in
              let rec find_return_type eff i uu___199_3574 =
                match uu___199_3574 with
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::uu____4333::[],p) when
          (((((let uu____4339 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                  in
              ...
              ||
              (let uu____4345 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                  in
               uu____4345 = "FStar.Monotonic.HyperStack.mmmstackref"))
             ||
             (let uu____4347 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
              uu____4347 = "FStar.Monotonic.HyperStack.mmmref"))
            ||
            (let uu____4349 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
    ...
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Let
          ...
          let is_mut =
            FStar_Util.for_some
              (fun uu___200_4508  ->
                 match uu___200_4508 with
                 | FStar_Extraction_ML_Syntax.Mutable  -> true
                 | uu____4509 -> false) flags1
             in
          let uu____4510 =
            if is_mut
            then
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu____4657 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____4657 = "FStar.Buffer.index") ||
            (let uu____4659 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu____4910 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____4910 = "FStar.Buffer.upd") ||
            (let uu____4912 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____5085 =
            let uu____5090 = FStar_Util.must (mk_width m)  in (uu____5090, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____5111 =
            let uu____5116 = FStar_Util.must (mk_width m)  in (uu____5116, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____5267,fields) ->
          let uu____5285 =
            let uu____5296 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
            let uu____5297 =
              FStar_List.map
                (fun uu____5316  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____5382,cons1),es) ->
          let uu____5399 =
            let uu____5408 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
