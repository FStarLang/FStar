...
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = _83_849; FStar_Extraction_ML_Syntax.loc = _83_847}, (e1)::(e2)::[]) when ((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "FStar.Buffer.join") -> begin
(translate_expr env e1)
end
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = _83_861; FStar_Extraction_ML_Syntax.loc = _83_859}, (e1)::(e2)::[]) when ((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "FStar.Buffer.offset") -> begin
(let _180_883 = (let _180_882 = (translate_expr env e1)
in (let _180_881 = (translate_expr env e2)
in ((_180_882), (_180_881))))
in EBufSub (_180_883))
end
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = _83_873; FStar_Extraction_ML_Syntax.loc = _83_871}, (e1)::(e2)::(e3)::[]) when (((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "FStar.Buffer.upd") || ((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "FStar.Buffer.op_Array_Assignment")) -> begin
...
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = _83_886; FStar_Extraction_ML_Syntax.loc = _83_884}, (_83_891)::[]) when ((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "FStar.ST.push_frame") -> begin
EPushFrame
end
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = _83_898; FStar_Extraction_ML_Syntax.loc = _83_896}, (_83_903)::[]) when ((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "FStar.ST.pop_frame") -> begin
EPopFrame
end
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = _83_910; FStar_Extraction_ML_Syntax.loc = _83_908}, (e1)::(e2)::(e3)::(e4)::(e5)::[]) when ((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "FStar.Buffer.blit") -> begin
...
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = _83_925; FStar_Extraction_ML_Syntax.loc = _83_923}, (e1)::(e2)::(e3)::[]) when ((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "FStar.Buffer.fill") -> begin
...
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = _83_938; FStar_Extraction_ML_Syntax.loc = _83_936}, (_83_943)::[]) when ((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "FStar.ST.get") -> begin
ECast (((EConstant (((UInt8), ("0")))), (TAny)))
end
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (p); FStar_Extraction_ML_Syntax.mlty = _83_950; FStar_Extraction_ML_Syntax.loc = _83_948}, (e)::[]) when ((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "Obj.repr") -> begin
(let _180_899 = (let _180_898 = (translate_expr env e)
in ((_180_898), (TAny)))
in ECast (_180_899))
end
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (("FStar")::(m)::[], op); FStar_Extraction_ML_Syntax.mlty = _83_961; FStar_Extraction_ML_Syntax.loc = _83_959}, args) when ((is_machine_int m) && (is_op op)) -> begin
(let _180_901 = (FStar_Util.must (mk_width m))
in (let _180_900 = (FStar_Util.must (mk_op op))
in (mk_op_app env _180_901 _180_900 args)))
end
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (("Prims")::[], op); FStar_Extraction_ML_Syntax.mlty = _83_975; FStar_Extraction_ML_Syntax.loc = _83_973}, args) when (is_bool_op op) -> begin
...
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (("FStar")::("Int")::("Cast")::[], c); FStar_Extraction_ML_Syntax.mlty = _83_1034; FStar_Extraction_ML_Syntax.loc = _83_1032}, (arg)::[]) -> begin
(
...
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (path, function_name); FStar_Extraction_ML_Syntax.mlty = _83_1051; FStar_Extraction_ML_Syntax.loc = _83_1049}, args) -> begin
...
| FStar_Extraction_ML_Syntax.MLE_Record (_83_1066, fields) -> begin
(let _180_933 = (let _180_932 = (assert_lid env e.FStar_Extraction_ML_Syntax.mlty)
in (let _180_931 = (FStar_List.map (fun _83_1072 -> (match (_83_1072) with
| (field, expr) -> begin
...
| FStar_Extraction_ML_Syntax.MLE_Let (_83_1078) -> begin
(FStar_All.failwith "todo: translate_expr [MLE_Let]")
end
| FStar_Extraction_ML_Syntax.MLE_App (head, _83_1082) -> begin
...
| FStar_Extraction_ML_Syntax.MLE_CTor ((_83_1090, cons), es) -> begin
...
| FStar_Extraction_ML_Syntax.MLE_Fun (_83_1097) -> begin
...
| FStar_Extraction_ML_Syntax.MLE_Raise (_83_1108) -> begin
(FStar_All.failwith "todo: translate_expr [MLE_Raise]")
end
| FStar_Extraction_ML_Syntax.MLE_Try (_83_1111) -> begin
(FStar_All.failwith "todo: translate_expr [MLE_Try]")
end
| FStar_Extraction_ML_Syntax.MLE_Coerce (_83_1114) -> begin
...
and translate_branch : env  ->  FStar_Extraction_ML_Syntax.mlbranch  ->  (pattern * expr) = (fun env _83_1130 -> (match (_83_1130) with
| (pat, guard, expr) -> begin
if (guard = None) then begin
(

let _83_1133 = (translate_pat env pat)
...
| FStar_Extraction_ML_Syntax.MLP_Var (name, _83_1143) -> begin
(
...
| FStar_Extraction_ML_Syntax.MLP_CTor ((_83_1150, cons), ps) -> begin
(

let _83_1165 = (FStar_List.fold_left (fun _83_1158 p -> (match (_83_1158) with
| (env, acc) -> begin
(

let _83_1162 = (translate_pat env p)
in (match (_83_1162) with
| (env, p) -> begin
((env), ((p)::acc))
end))
end)) ((env), ([])) ps)
...
| FStar_Extraction_ML_Syntax.MLP_Record (_83_1167, ps) -> begin
(

let _83_1182 = (FStar_List.fold_left (fun _83_1173 _83_1176 -> (match (((_83_1173), (_83_1176))) with
...
let _83_1194 = (FStar_List.fold_left (fun _83_1187 p -> (match (_83_1187) with
| (env, acc) -> begin
(

let _83_1191 = (translate_pat env p)
in (match (_83_1191) with
| (env, p) -> begin
((env), ((p)::acc))
end))
end)) ((env), ([])) ps)
in (match (_83_1194) with
| (env, ps) -> begin
((env), (PTuple ((FStar_List.rev ps))))
end))
end
| FStar_Extraction_ML_Syntax.MLP_Const (_83_1196) -> begin
(FStar_All.failwith "todo: translate_pat [MLP_Const]")
end
| FStar_Extraction_ML_Syntax.MLP_Branch (_83_1199) -> begin
...
| FStar_Extraction_ML_Syntax.MLC_Int (s, Some (_83_1207)) -> begin
(FStar_All.failwith "impossible: machine integer not desugared to a function call")
end
| FStar_Extraction_ML_Syntax.MLC_Float (_83_1212) -> begin
(FStar_All.failwith "todo: translate_expr [MLC_Float]")
end
| FStar_Extraction_ML_Syntax.MLC_Char (_83_1215) -> begin
(FStar_All.failwith "todo: translate_expr [MLC_Char]")
end
| FStar_Extraction_ML_Syntax.MLC_String (_83_1218) -> begin
(FStar_All.failwith "todo: translate_expr [MLC_String]")
end
| FStar_Extraction_ML_Syntax.MLC_Bytes (_83_1221) -> begin
(FStar_All.failwith "todo: translate_expr [MLC_Bytes]")
end
| FStar_Extraction_ML_Syntax.MLC_Int (_83_1224, None) -> begin
