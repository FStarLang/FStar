            ...
            FStar_List.fold_left
              (fun env2  ->
                 fun uu____2426  ->
                   ...
                   | (name1,uu____2430) -> extend_t env2 name1) env1 tvars
             in
            ...
            FStar_List.fold_left
              (fun env2  ->
                 fun uu____2547  ->
                   ...
                   | (name1,uu____2551) -> extend_t env2 name1) env1 tvars
             in
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____2739  ->
                   ...
                   | (name2,uu____2743) -> extend_t env1 name2) env args
             in
          if assumed
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____2803  ->
                   ...
                   | (name2,uu____2807) -> extend_t env1 name2) env args
             in
          let uu____2808 =
            let uu____2809 =
              let uu____2821 =
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____2908  ->
                   ...
                   | (name2,uu____2912) -> extend_t env1 name2) env args
             in
          let uu____2913 =
            let uu____2914 =
              let uu____2929 =
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____3533 =
            let uu____3536 = FStar_Util.must (mk_width m)  in (uu____3536, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____3550 =
            let uu____3553 = FStar_Util.must (mk_width m)  in (uu____3553, c)
             in
