...
with
| e -> begin
((let _0_541 = (FStar_Util.print_exn e)
...
let t = (let _0_542 = (find_return_type t0)
in (translate_type env _0_542))
in (
...
| true -> begin
Some (DExternal ((let _0_543 = (translate_type env t0)
in ((None), (name), (_0_543)))))
end
| uu____2133 -> begin
try
...
with
| e -> begin
((let _0_544 = (FStar_Util.print_exn e)
in (FStar_Util.print2 "Warning: writing a stub for %s (%s)\n" (Prims.snd name) _0_544));
...
(match (ts) with
| Some (idents, t) -> begin
(let _0_548 = (let _0_546 = (FStar_List.map Prims.fst idents)
in (FStar_String.concat ", " _0_546))
in (let _0_547 = (FStar_Extraction_ML_Code.string_of_mlty (([]), ("")) t)
...
| uu____2254 -> begin
Some (DTypeAlias ((let _0_549 = (translate_type env t)
in ((name), ((FStar_List.length args)), (_0_549)))))
end)))
end
...
in Some (DTypeFlat ((let _0_552 = (FStar_List.map (fun uu____2315 -> (match (uu____2315) with
| (f, t) -> begin
(let _0_551 = (let _0_550 = (translate_type env t)
in ((_0_550), (false)))
in ((f), (_0_551)))
end)) fields)
in ((name), ((FStar_List.length args)), (_0_552)))))))
end
...
in Some (DTypeVariant ((let _0_559 = (FStar_List.mapi (fun i uu____2390 -> (match (uu____2390) with
| (cons, ts) -> begin
(let _0_558 = (FStar_List.mapi (fun j t -> (let _0_557 = (let _0_554 = (FStar_Util.string_of_int i)
in (let _0_553 = (FStar_Util.string_of_int j)
in (FStar_Util.format2 "x%s%s" _0_554 _0_553)))
in (let _0_556 = (let _0_555 = (translate_type env t)
in ((_0_555), (false)))
in ((_0_557), (_0_556))))) ts)
in ((cons), (_0_558)))
end)) branches)
in ((name), ((FStar_List.length args)), (_0_559)))))))
end
...
TArrow ((let _0_561 = (translate_type env t1)
in (let _0_560 = (translate_type env t2)
in ((_0_561), (_0_560)))))
end
...
| true -> begin
TApp ((let _0_562 = (FStar_List.map (translate_type env) args)
in ((lid), (_0_562))))
end
| uu____2506 -> begin
TQualified (lid)
...
(let _0_563 = (translate_type env typ)
in {name = name; typ = _0_563; mut = false})
end))
...
EOp ((let _0_565 = (FStar_Util.must (mk_op op))
in (let _0_564 = (FStar_Util.must (mk_width m))
in ((_0_565), (_0_564)))))
end
| FStar_Extraction_ML_Syntax.MLE_Name (("Prims")::[], op) when (is_bool_op op) -> begin
EOp ((let _0_566 = (FStar_Util.must (mk_bool_op op))
in ((_0_566), (Bool))))
end
...
| true -> begin
(let _0_569 = (match (typ) with
| FStar_Extraction_ML_Syntax.MLTY_Named ((t)::[], p) when ((FStar_Extraction_ML_Syntax.string_of_mlpath p) = "FStar.ST.stackref") -> begin
t
end
| uu____2565 -> begin
(failwith (let _0_567 = (FStar_Extraction_ML_Code.string_of_mlty (([]), ("")) typ)
in (FStar_Util.format1 "unexpected: bad desugaring of Mutable (typ is %s)" _0_567)))
end)
in (let _0_568 = (match (body) with
...
let binder = (let _0_570 = (translate_type env typ)
in {name = name; typ = _0_570; mut = is_mut})
in (
...
EMatch ((let _0_572 = (translate_expr env expr)
in (let _0_571 = (translate_branches env branches)
in ((_0_572), (_0_571)))))
end
...
EAssign ((let _0_574 = EBound ((find env v))
in (let _0_573 = (translate_expr env e)
in ((_0_574), (_0_573)))))
end
...
EBufRead ((let _0_576 = (translate_expr env e1)
in (let _0_575 = (translate_expr env e2)
in ((_0_576), (_0_575)))))
end
...
EBufCreate ((let _0_578 = (translate_expr env e1)
in (let _0_577 = (translate_expr env e2)
in ((Stack), (_0_578), (_0_577)))))
end
...
EBufCreate ((let _0_580 = (translate_expr env e1)
in (let _0_579 = (translate_expr env e2)
in ((Eternal), (_0_580), (_0_579)))))
end
...
in EBufCreateL ((let _0_582 = (let _0_581 = (list_elements e2)
in (FStar_List.map (translate_expr env) _0_581))
in ((Stack), (_0_582))))))
end
...
EBufSub ((let _0_584 = (translate_expr env e1)
in (let _0_583 = (translate_expr env e2)
in ((_0_584), (_0_583)))))
end
...
EBufSub ((let _0_586 = (translate_expr env e1)
in (let _0_585 = (translate_expr env e2)
in ((_0_586), (_0_585)))))
end
...
EBufWrite ((let _0_589 = (translate_expr env e1)
in (let _0_588 = (translate_expr env e2)
in (let _0_587 = (translate_expr env e3)
in ((_0_589), (_0_588), (_0_587))))))
end
...
EBufBlit ((let _0_594 = (translate_expr env e1)
in (let _0_593 = (translate_expr env e2)
in (let _0_592 = (translate_expr env e3)
in (let _0_591 = (translate_expr env e4)
in (let _0_590 = (translate_expr env e5)
in ((_0_594), (_0_593), (_0_592), (_0_591), (_0_590))))))))
end
...
EBufFill ((let _0_597 = (translate_expr env e1)
in (let _0_596 = (translate_expr env e2)
in (let _0_595 = (translate_expr env e3)
in ((_0_597), (_0_596), (_0_595))))))
end
...
ECast ((let _0_598 = (translate_expr env e)
in ((_0_598), (TAny))))
end
...
(let _0_600 = (FStar_Util.must (mk_width m))
in (let _0_599 = (FStar_Util.must (mk_op op))
in (mk_op_app env _0_600 _0_599 args)))
end
...
(let _0_601 = (FStar_Util.must (mk_bool_op op))
in (mk_op_app env Bool _0_601 args))
end
...
EConstant ((let _0_602 = (FStar_Util.must (mk_width m))
in ((_0_602), (c))))
end
...
| true -> begin
ECast ((let _0_603 = (translate_expr env arg)
in ((_0_603), (TInt (UInt64)))))
end
| uu____2783 -> begin
(match (((FStar_Util.ends_with c "uint32") && is_known_type)) with
| true -> begin
ECast ((let _0_604 = (translate_expr env arg)
in ((_0_604), (TInt (UInt32)))))
end
| uu____2784 -> begin
(match (((FStar_Util.ends_with c "uint16") && is_known_type)) with
| true -> begin
ECast ((let _0_605 = (translate_expr env arg)
in ((_0_605), (TInt (UInt16)))))
end
| uu____2785 -> begin
(match (((FStar_Util.ends_with c "uint8") && is_known_type)) with
| true -> begin
ECast ((let _0_606 = (translate_expr env arg)
in ((_0_606), (TInt (UInt8)))))
end
| uu____2786 -> begin
(match (((FStar_Util.ends_with c "int64") && is_known_type)) with
| true -> begin
ECast ((let _0_607 = (translate_expr env arg)
in ((_0_607), (TInt (Int64)))))
end
| uu____2787 -> begin
(match (((FStar_Util.ends_with c "int32") && is_known_type)) with
| true -> begin
ECast ((let _0_608 = (translate_expr env arg)
in ((_0_608), (TInt (Int32)))))
end
| uu____2788 -> begin
(match (((FStar_Util.ends_with c "int16") && is_known_type)) with
| true -> begin
ECast ((let _0_609 = (translate_expr env arg)
in ((_0_609), (TInt (Int16)))))
end
| uu____2789 -> begin
(match (((FStar_Util.ends_with c "int8") && is_known_type)) with
| true -> begin
ECast ((let _0_610 = (translate_expr env arg)
in ((_0_610), (TInt (Int8)))))
end
| uu____2790 -> begin
EApp ((let _0_612 = (let _0_611 = (translate_expr env arg)
in (_0_611)::[])
in ((EQualified (((("FStar")::("Int")::("Cast")::[]), (c)))), (_0_612))))
end)
end)
end)
end)
...
EApp ((let _0_613 = (FStar_List.map (translate_expr env) args)
in ((EQualified (((path), (function_name)))), (_0_613))))
end
| FStar_Extraction_ML_Syntax.MLE_Coerce (e, t_from, t_to) -> begin
ECast ((let _0_615 = (translate_expr env e)
in (let _0_614 = (translate_type env t_to)
in ((_0_615), (_0_614)))))
end
| FStar_Extraction_ML_Syntax.MLE_Record (uu____2807, fields) -> begin
EFlat ((let _0_618 = (assert_lid env e.FStar_Extraction_ML_Syntax.mlty)
in (let _0_617 = (FStar_List.map (fun uu____2824 -> (match (uu____2824) with
| (field, expr) -> begin
(let _0_616 = (translate_expr env expr)
in ((field), (_0_616)))
end)) fields)
in ((_0_618), (_0_617)))))
end
| FStar_Extraction_ML_Syntax.MLE_Proj (e, path) -> begin
EField ((let _0_620 = (assert_lid env e.FStar_Extraction_ML_Syntax.mlty)
in (let _0_619 = (translate_expr env e)
in ((_0_620), (_0_619), ((Prims.snd path))))))
end
| FStar_Extraction_ML_Syntax.MLE_Let (uu____2834) -> begin
(failwith "todo: translate_expr [MLE_Let]")
end
| FStar_Extraction_ML_Syntax.MLE_App (head, uu____2842) -> begin
(failwith (let _0_621 = (FStar_Extraction_ML_Code.string_of_mlexpr (([]), ("")) head)
in (FStar_Util.format1 "todo: translate_expr [MLE_App] (head is: %s)" _0_621)))
end
...
ECons ((let _0_623 = (assert_lid env e.FStar_Extraction_ML_Syntax.mlty)
in (let _0_622 = (FStar_List.map (translate_expr env) es)
in ((_0_623), (cons), (_0_622)))))
end
...
EIfThenElse ((let _0_626 = (translate_expr env e1)
in (let _0_625 = (translate_expr env e2)
in (let _0_624 = (match (e3) with
| None -> begin
EUnit
end
| Some (e3) -> begin
...
| true -> begin
TApp ((let _0_627 = (FStar_List.map (translate_type env) ts)
in ((lid), (_0_627))))
end
| uu____2899 -> begin
TQualified (lid)
...
| (env, pat) -> begin
(let _0_628 = (translate_expr env expr)
in ((pat), (_0_628)))
end))
end
| uu____2937 -> begin
...
and mk_op_app : env  ->  width  ->  op  ->  FStar_Extraction_ML_Syntax.mlexpr Prims.list  ->  expr = (fun env w op args -> EApp ((let _0_629 = (FStar_List.map (translate_expr env) args)
in ((EOp (((op), (w)))), (_0_629)))))
