...
let extend : env -> Prims.string -> Prims.bool -> env =
  fun env  ->
    fun x  ->
      fun is_mut  ->
        let uu___128_1809 = env  in
        {
          names = ({ pretty = x; mut = is_mut } :: (env.names));
          names_t = (uu___128_1809.names_t);
          module_name = (uu___128_1809.module_name)
        }
  
let extend_t : env -> Prims.string -> env =
  fun env  ->
    fun x  ->
      let uu___129_1816 = env  in
      {
        names = (uu___129_1816.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___129_1816.module_name)
      }
            ...
            FStar_List.fold_left
              (fun env2  ->
                 fun uu____2150  ->
                   ...
                   | (name1,uu____2154) -> extend_t env2 name1) env1 tvars
             in
          let rec find_return_type uu___126_2158 =
            match uu___126_2158 with
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____2319  ->
                   ...
                   | (name2,uu____2323) -> extend_t env1 name2) env args
             in
          if assumed
          then None
          else
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____2374  ->
                   ...
                   | (name2,uu____2378) -> extend_t env1 name2) env args
             in
          let uu____2379 =
            let uu____2380 =
              let uu____2392 =
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____2464  ->
                   ...
                   | (name2,uu____2468) -> extend_t env1 name2) env args
             in
          let uu____2469 =
            let uu____2470 =
              let uu____2485 =
