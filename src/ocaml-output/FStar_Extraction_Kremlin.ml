            ...
            FStar_List.fold_left
              (fun env2  ->
                 fun uu____3563  ->
                   ...
                   | (name1,uu____3569) -> extend_t env2 name1) env1 tvars
             in
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____3844  ->
                   ...
                   | (name2,uu____3850) -> extend_t env1 name2) env args
             in
          if assumed
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____3944  ->
                   ...
                   | (name2,uu____3950) -> extend_t env1 name2) env args
             in
          let uu____3951 =
            let uu____3952 =
              let uu____3975 =
            ...
            FStar_List.fold_left
              (fun env1  ->
                 fun uu____4118  ->
                   ...
                   | (name2,uu____4124) -> extend_t env1 name2) env args
             in
          let uu____4125 =
            let uu____4126 =
              let uu____4155 =
  ...
  fun env  ->
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____5032 =
            let uu____5037 = FStar_Util.must (mk_width m)  in (uu____5037, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____5058 =
            let uu____5063 = FStar_Util.must (mk_width m)  in (uu____5063, c)
             in
