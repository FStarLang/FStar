...
let extend: env -> Prims.string -> Prims.bool -> env =
  fun env  ->
    fun x  ->
      fun is_mut  ->
        let uu___157_2960 = env in
        {
          names = ({ pretty = x; mut = is_mut } :: (env.names));
          names_t = (uu___157_2960.names_t);
          module_name = (uu___157_2960.module_name)
        }
let extend_t: env -> Prims.string -> env =
  fun env  ->
    fun x  ->
      let uu___158_2969 = env in
      {
        names = (uu___158_2969.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___158_2969.module_name)
      }
  ...
  fun env  ->
    fun d  ->
      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
          ...
          let rec find_return_type i uu___155_3454 =
            match uu___155_3454 with
      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
          ...
          let env2 =
            FStar_List.fold_left
              (fun env2  -> fun name1  -> extend_t env2 name1) env1 tvars in
          let rec find_return_type i uu___155_3616 =
            match uu___155_3616 with
