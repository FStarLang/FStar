    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[], p) when
          (((((((((((((let uu____6430 =
              ...
              ||
              (let uu____6485 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____6485 = "FStar.HyperStack.ST.ref"))
             ||
             (let uu____6490 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
    ...
    fun e ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6764;_},
                t::[]);
             FStar_Extraction_ML_Syntax.mlty = uu____6766;
             FStar_Extraction_ML_Syntax.loc = uu____6767;_},
           arg::[])
          when
          ...
          let uu____6777 =
            ...
            let uu____6783 = translate_type env t in (uu____6782, uu____6783) in
          ECast uu____6777
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6786;_},
                uu____6787);
             FStar_Extraction_ML_Syntax.mlty = uu____6788;
             FStar_Extraction_ML_Syntax.loc = uu____6789;_},
           uu____6790)
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6805;_},
                uu____6806);
             FStar_Extraction_ML_Syntax.mlty = uu____6807;
             FStar_Extraction_ML_Syntax.loc = uu____6808;_},
           arg::[])
          when
          ((let uu____6818 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               ...
               let print7 =
                 let uu____6838 =
                   let uu____6839 =
                     ...
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____6840 in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____6839 in
                 FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top uu____6838 in
               let print8 =
                 FStar_Extraction_ML_Syntax.with_ty
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6872;_},
                uu____6873);
             FStar_Extraction_ML_Syntax.mlty = uu____6874;
             FStar_Extraction_ML_Syntax.loc = uu____6875;_},
           e1::e2::[])
          when
          ((((let uu____6886 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             ...
             ||
             (let uu____6901 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____6901 = "LowStar.UninitializedBuffer.uindex"))
            ||
            (let uu____6906 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6919;_},
                uu____6920);
             FStar_Extraction_ML_Syntax.mlty = uu____6921;
             FStar_Extraction_ML_Syntax.loc = uu____6922;_},
           e1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6944;_},
                uu____6945);
             FStar_Extraction_ML_Syntax.mlty = uu____6946;
             FStar_Extraction_ML_Syntax.loc = uu____6947;_},
           e1::e2::[])
          when
          ((let uu____6958 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu____6958 = "FStar.Buffer.create") ||
             (let uu____6963 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____6963 = "LowStar.Monotonic.Buffer.malloca"))
            ||
            (let uu____6968 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7006;_},
                uu____7007);
             FStar_Extraction_ML_Syntax.mlty = uu____7008;
             FStar_Extraction_ML_Syntax.loc = uu____7009;_},
           init1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7033;_},
                uu____7034);
          ...
          ((let uu____7046 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu____7046 = "FStar.Buffer.createL") ||
             (let uu____7051 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7051 = "LowStar.Monotonic.Buffer.malloca_of_list"))
            ||
            (let uu____7056 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7117;_},
                uu____7118);
             FStar_Extraction_ML_Syntax.mlty = uu____7119;
             FStar_Extraction_ML_Syntax.loc = uu____7120;_},
           _rid::init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7145;_},
                uu____7146);
             FStar_Extraction_ML_Syntax.mlty = uu____7147;
             FStar_Extraction_ML_Syntax.loc = uu____7148;_},
           _e0::e1::e2::[])
          when
          ((let uu____7160 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu____7160 = "FStar.Buffer.rcreate") ||
             (let uu____7165 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7165 = "LowStar.Monotonic.Buffer.mgcmalloc"))
            ||
            (let uu____7170 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7188;_},
           uu____7189)
          when
          (((((let uu____7200 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              ...
              ||
              (let uu____7215 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____7215 = "LowStar.ImmutableBuffer.igcmalloc_and_blit"))
             ||
             (let uu____7220 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7256;_},
                uu____7257);
             FStar_Extraction_ML_Syntax.mlty = uu____7258;
             FStar_Extraction_ML_Syntax.loc = uu____7259;_},
           _rid::init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7284;_},
                uu____7285);
             FStar_Extraction_ML_Syntax.mlty = uu____7286;
             FStar_Extraction_ML_Syntax.loc = uu____7287;_},
           _e0::e1::e2::[])
          when
          (((let uu____7299 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____7299 = "FStar.Buffer.rcreate_mm") ||
              (let uu____7304 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____7304 = "LowStar.Monotonic.Buffer.mmalloc"))
             ||
             (let uu____7309 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7329;_},
                uu____7330);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7356;_},
           e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7371;_},
                uu____7372);
             FStar_Extraction_ML_Syntax.mlty = uu____7373;
             FStar_Extraction_ML_Syntax.loc = uu____7374;_},
           e2::[])
          when
          (let uu____7384 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu____7384 = "FStar.Buffer.rfree") ||
            (let uu____7389 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7396;_},
                uu____7397);
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7422;_},
                uu____7423);
             FStar_Extraction_ML_Syntax.mlty = uu____7424;
             FStar_Extraction_ML_Syntax.loc = uu____7425;_},
           e1::e2::_e3::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7473;_},
                uu____7474);
             FStar_Extraction_ML_Syntax.mlty = uu____7475;
             FStar_Extraction_ML_Syntax.loc = uu____7476;_},
           e1::e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7498;_},
                uu____7499);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7523;_},
                uu____7524);
             FStar_Extraction_ML_Syntax.mlty = uu____7525;
             FStar_Extraction_ML_Syntax.loc = uu____7526;_},
           e1::e2::e3::[])
          when
          (((let uu____7538 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             ...
             ||
             (let uu____7548 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7548 = "LowStar.Monotonic.Buffer.upd'"))
            ||
            (let uu____7553 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7569;_},
                uu____7570);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7598;_},
           uu____7599::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7608;_},
           uu____7609::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7618;_},
                uu____7619);
             FStar_Extraction_ML_Syntax.mlty = uu____7620;
             FStar_Extraction_ML_Syntax.loc = uu____7621;_},
           e1::e2::e3::e4::e5::[])
          when
          ((let uu____7635 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            ||
            (let uu____7645 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7698;_},
           uu____7699::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7708;_},
                uu____7709);
             FStar_Extraction_ML_Syntax.mlty = uu____7710;
             FStar_Extraction_ML_Syntax.loc = uu____7711;_},
           _ebuf::_eseq::[])
          when
          (((let uu____7722 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____7722 = "LowStar.Monotonic.Buffer.witness_p") ||
              (let uu____7727 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            ||
            (let uu____7737 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7743;_},
                uu____7744);
             FStar_Extraction_ML_Syntax.mlty = uu____7745;
             FStar_Extraction_ML_Syntax.loc = uu____7746;_},
           e1::[])
          when
          ((((let uu____7756 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             ...
             ||
             (let uu____7771 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7771 = "LowStar.ConstBuffer.to_buffer"))
            ||
            (let uu____7776 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7782;_},
           e1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7799;_},
           args)
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7836;_},
           {
             ...
             FStar_Extraction_ML_Syntax.mlty = uu____7838;
             FStar_Extraction_ML_Syntax.loc = uu____7839;_}::[])
          when is_machine_int m ->
          let uu____7864 =
            let uu____7870 = FStar_Util.must (mk_width m) in (uu____7870, c) in
          ...
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7874;_},
           {
             FStar_Extraction_ML_Syntax.expr =
               ...
               (FStar_Extraction_ML_Syntax.MLC_Int
               (c, FStar_Pervasives_Native.None));
             FStar_Extraction_ML_Syntax.mlty = uu____7876;
             FStar_Extraction_ML_Syntax.loc = uu____7877;_}::[])
          when is_machine_int m ->
          let uu____7902 =
            let uu____7908 = FStar_Util.must (mk_width m) in (uu____7908, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7914;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             FStar_Extraction_ML_Syntax.mlty = uu____7932;
             FStar_Extraction_ML_Syntax.loc = uu____7933;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_String s) -> EString s
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             FStar_Extraction_ML_Syntax.mlty = uu____7955;
             FStar_Extraction_ML_Syntax.loc = uu____7956;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_String s) -> EString s
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             FStar_Extraction_ML_Syntax.mlty = uu____7976;
             FStar_Extraction_ML_Syntax.loc = uu____7977;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7996;_},
           arg::[])
          ->
          let is_known_type =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____8174, fields) ->
          let uu____8196 =
            let uu____8208 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
            let uu____8209 =
              FStar_List.map
                (fun uu____8231 ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____8313, cons1), es) ->
          let uu____8328 =
            let uu____8338 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
      ...
      | uu____8468 ->
          let uu____8469 =
            let uu____8471 =
              FStar_Extraction_ML_Code.string_of_mlty ([], "") t in
            FStar_Util.format1
              "invalid argument: expected MLTY_Named, got %s" uu____8471 in
          failwith uu____8469
