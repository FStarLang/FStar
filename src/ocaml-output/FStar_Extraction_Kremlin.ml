        ...
        (flavor,flags,{ FStar_Extraction_ML_Syntax.mllb_name = (name,_);
          ...
          let env2 =
            FStar_List.fold_left
             ...
             in
          let rec find_return_type uu___122_2158 =
            match uu___122_2158 with
