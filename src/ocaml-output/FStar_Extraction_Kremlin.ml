...
let mk_width : Prims.string  ->  width FStar_Pervasives_Native.option = (fun uu___127_2811 -> (match (uu___127_2811) with
| "UInt8" -> begin
...
let mk_bool_op : Prims.string  ->  op FStar_Pervasives_Native.option = (fun uu___128_2820 -> (match (uu___128_2820) with
| "op_Negation" -> begin
...
let mk_op : Prims.string  ->  op FStar_Pervasives_Native.option = (fun uu___129_2835 -> (match (uu___129_2835) with
| "add" -> begin
...
let uu___134_2960 = env
in {names = ({pretty = x; mut = is_mut})::env.names; names_t = uu___134_2960.names_t; module_name = uu___134_2960.module_name}))


let extend_t : env  ->  Prims.string  ->  env = (fun env x -> (

let uu___135_2969 = env
in {names = uu___135_2969.names; names_t = (x)::env.names_t; module_name = uu___135_2969.module_name}))
...
let find : env  ->  Prims.string  ->  Prims.int = (fun env x -> (FStar_All.try_with (fun uu___137_3002 -> (match (()) with
| () -> begin
(FStar_List.index (fun name -> (Prims.op_Equality name.pretty x)) env.names)
end)) (fun uu___136_3008 -> (match (uu___136_3008) with
| uu____3009 -> begin
(
...
let find_t : env  ->  Prims.string  ->  Prims.int = (fun env x -> (FStar_All.try_with (fun uu___139_3020 -> (match (()) with
| () -> begin
(FStar_List.index (fun name -> (Prims.op_Equality name x)) env.names_t)
end)) (fun uu___138_3026 -> (match (uu___138_3026) with
| uu____3027 -> begin
(
...
in (FStar_All.try_with (fun uu___141_3306 -> (match (()) with
| () -> begin
...
end)) (fun uu___140_3314 -> (match (uu___140_3314) with
| e -> begin
((
...
and translate_flags : FStar_Extraction_ML_Syntax.meta Prims.list  ->  flag Prims.list = (fun flags -> (FStar_List.choose (fun uu___130_3399 -> (match (uu___130_3399) with
...
let assumed = (FStar_Util.for_some (fun uu___131_3439 -> (match (uu___131_3439) with
...
let rec find_return_type = (fun i uu___132_3454 -> (match (uu___132_3454) with
...
| uu____3519 -> begin
(FStar_All.try_with (fun uu___143_3524 -> (match (()) with
| () -> begin
(
...
end)) (fun uu___142_3545 -> (match (uu___142_3545) with
| e -> begin
(
...
let assumed = (FStar_Util.for_some (fun uu___131_3601 -> (match (uu___131_3601) with
| FStar_Extraction_ML_Syntax.Assumed -> begin
true
end
| uu____3602 -> begin
...
let rec find_return_type = (fun i uu___132_3616 -> (match (uu___132_3616) with
...
| uu____3681 -> begin
(FStar_All.try_with (fun uu___143_3686 -> (match (()) with
| () -> begin
(

let body1 = (translate_expr env3 body)
in FStar_Pervasives_Native.Some (DFunction (((FStar_Pervasives_Native.None), (flags1), ((FStar_List.length tvars)), (t), (name1), (binders), (body1)))))
end)) (fun uu___142_3707 -> (match (uu___142_3707) with
| e -> begin
(
...
in (FStar_All.try_with (fun uu___145_3762 -> (match (()) with
| () -> begin
(

let expr1 = (translate_expr env expr)
in FStar_Pervasives_Native.Some (DGlobal (((flags1), (name1), (t1), (expr1)))))
end)) (fun uu___144_3777 -> (match (uu___144_3777) with
| e -> begin
((
...
let is_mut = (FStar_Util.for_some (fun uu___133_4608 -> (match (uu___133_4608) with
...
| FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (("FStar")::("Int")::("Cast")::[], c); FStar_Extraction_ML_Syntax.mlty = uu____5146; FStar_Extraction_ML_Syntax.loc = uu____5147}, (arg)::[]) -> begin
(
...
let uu____5159 = (translate_expr env arg)
in ((uu____5159), (TInt (UInt64))))
in ECast (uu____5154))
end
| uu____5160 -> begin
...
let uu____5166 = (translate_expr env arg)
in ((uu____5166), (TInt (UInt32))))
in ECast (uu____5161))
end
| uu____5167 -> begin
...
let uu____5173 = (translate_expr env arg)
in ((uu____5173), (TInt (UInt16))))
in ECast (uu____5168))
end
| uu____5174 -> begin
...
let uu____5180 = (translate_expr env arg)
in ((uu____5180), (TInt (UInt8))))
in ECast (uu____5175))
end
| uu____5181 -> begin
...
let uu____5187 = (translate_expr env arg)
in ((uu____5187), (TInt (Int64))))
in ECast (uu____5182))
end
| uu____5188 -> begin
...
let uu____5194 = (translate_expr env arg)
in ((uu____5194), (TInt (Int32))))
in ECast (uu____5189))
end
| uu____5195 -> begin
...
let uu____5201 = (translate_expr env arg)
in ((uu____5201), (TInt (Int16))))
in ECast (uu____5196))
end
| uu____5202 -> begin
...
let uu____5208 = (translate_expr env arg)
in ((uu____5208), (TInt (Int8))))
in ECast (uu____5203))
end
| uu____5209 -> begin
(
...
let uu____5220 = (translate_expr env arg)
in (uu____5220)::[])
in ((EQualified (((("FStar")::("Int")::("Cast")::[]), (c)))), (uu____5217)))
in EApp (uu____5210))
end)
end)
end)
...
let uu____5238 = (translate_expr env head1)
in (

let uu____5239 = (FStar_List.map (translate_expr env) args)
in ((uu____5238), (uu____5239))))
in EApp (uu____5231))
end
...
let uu____5257 = (translate_expr env head1)
in (

let uu____5258 = (FStar_List.map (translate_type env) ty_args)
in ((uu____5257), (uu____5258))))
in ETypApp (uu____5250))
end
...
let uu____5271 = (translate_expr env e1)
in (

let uu____5272 = (translate_type env t_to)
in ((uu____5271), (uu____5272))))
in ECast (uu____5266))
end
| FStar_Extraction_ML_Syntax.MLE_Record (uu____5273, fields) -> begin
(

let uu____5291 = (

let uu____5302 = (assert_lid env e.FStar_Extraction_ML_Syntax.mlty)
in (

let uu____5303 = (FStar_List.map (fun uu____5322 -> (match (uu____5322) with
| (field, expr) -> begin
(

let uu____5333 = (translate_expr env expr)
in ((field), (uu____5333)))
end)) fields)
in ((uu____5302), (uu____5303))))
in EFlat (uu____5291))
end
...
let uu____5349 = (assert_lid env e1.FStar_Extraction_ML_Syntax.mlty)
in (

let uu____5350 = (translate_expr env e1)
in ((uu____5349), (uu____5350), ((FStar_Pervasives_Native.snd path)))))
in EField (uu____5342))
end
| FStar_Extraction_ML_Syntax.MLE_Let (uu____5353) -> begin
(failwith "todo: translate_expr [MLE_Let]")
end
| FStar_Extraction_ML_Syntax.MLE_App (head1, uu____5367) -> begin
(

let uu____5372 = (

let uu____5373 = (FStar_Extraction_ML_Code.string_of_mlexpr (([]), ("")) head1)
in (FStar_Util.format1 "todo: translate_expr [MLE_App] (head is: %s)" uu____5373))
in (failwith uu____5372))
end
| FStar_Extraction_ML_Syntax.MLE_Seq (seqs) -> begin
(

let uu____5379 = (FStar_List.map (translate_expr env) seqs)
in ESequence (uu____5379))
end
| FStar_Extraction_ML_Syntax.MLE_Tuple (es) -> begin
(

let uu____5385 = (FStar_List.map (translate_expr env) es)
in ETuple (uu____5385))
end
| FStar_Extraction_ML_Syntax.MLE_CTor ((uu____5388, cons1), es) -> begin
(

let uu____5405 = (

let uu____5414 = (assert_lid env e.FStar_Extraction_ML_Syntax.mlty)
in (

let uu____5415 = (FStar_List.map (translate_expr env) es)
in ((uu____5414), (cons1), (uu____5415))))
in ECons (uu____5405))
end
...
let uu____5447 = (translate_expr env1 body)
in (

let uu____5448 = (translate_type env1 body.FStar_Extraction_ML_Syntax.mlty)
in ((binders), (uu____5447), (uu____5448))))
in EFun (uu____5438))))
end
...
let uu____5465 = (translate_expr env e1)
in (

let uu____5466 = (translate_expr env e2)
in (

let uu____5467 = (match (e3) with
| FStar_Pervasives_Native.None -> begin
EUnit
end
...
in ((uu____5465), (uu____5466), (uu____5467)))))
in EIfThenElse (uu____5458))
end
| FStar_Extraction_ML_Syntax.MLE_Raise (uu____5469) -> begin
(failwith "todo: translate_expr [MLE_Raise]")
end
| FStar_Extraction_ML_Syntax.MLE_Try (uu____5476) -> begin
(failwith "todo: translate_expr [MLE_Try]")
end
| FStar_Extraction_ML_Syntax.MLE_Coerce (uu____5491) -> begin
...
let uu____5519 = (FStar_List.map (translate_type env) ts)
in ((lid), (uu____5519)))
in TApp (uu____5506))
end
| uu____5524 -> begin
...
and translate_branch : env  ->  (FStar_Extraction_ML_Syntax.mlpattern * FStar_Extraction_ML_Syntax.mlexpr FStar_Pervasives_Native.option * FStar_Extraction_ML_Syntax.mlexpr)  ->  (pattern * expr) = (fun env uu____5551 -> (match (uu____5551) with
| (pat, guard, expr) -> begin
(match ((Prims.op_Equality guard FStar_Pervasives_Native.None)) with
| true -> begin
(

let uu____5577 = (translate_pat env pat)
in (match (uu____5577) with
| (env1, pat1) -> begin
(

let uu____5588 = (translate_expr env1 expr)
in ((pat1), (uu____5588)))
end))
end
| uu____5589 -> begin
...
| FStar_Extraction_ML_Syntax.MLP_CTor ((uu____5604, cons1), ps) -> begin
(

let uu____5621 = (FStar_List.fold_left (fun uu____5641 p1 -> (match (uu____5641) with
| (env1, acc) -> begin
(

let uu____5661 = (translate_pat env1 p1)
...
| FStar_Extraction_ML_Syntax.MLP_Record (uu____5690, ps) -> begin
(

let uu____5708 = (FStar_List.fold_left (fun uu____5742 uu____5743 -> (match (((uu____5742), (uu____5743))) with
| ((env1, acc), (field, p1)) -> begin
(

let uu____5812 = (translate_pat env1 p1)
...
let uu____5874 = (FStar_List.fold_left (fun uu____5894 p1 -> (match (uu____5894) with
| (env1, acc) -> begin
(

let uu____5914 = (translate_pat env1 p1)
...
| FStar_Extraction_ML_Syntax.MLP_Const (uu____5941) -> begin
(failwith "todo: translate_pat [MLP_Const]")
end
| FStar_Extraction_ML_Syntax.MLP_Branch (uu____5946) -> begin
...
| FStar_Extraction_ML_Syntax.MLC_Int (s, FStar_Pervasives_Native.Some (uu____5956)) -> begin
(failwith "impossible: machine integer not desugared to a function call")
end
| FStar_Extraction_ML_Syntax.MLC_Float (uu____5971) -> begin
(failwith "todo: translate_expr [MLC_Float]")
end
| FStar_Extraction_ML_Syntax.MLC_Char (uu____5972) -> begin
(failwith "todo: translate_expr [MLC_Char]")
end
| FStar_Extraction_ML_Syntax.MLC_String (uu____5973) -> begin
(failwith "todo: translate_expr [MLC_String]")
end
| FStar_Extraction_ML_Syntax.MLC_Bytes (uu____5974) -> begin
...
let uu____6001 = (FStar_List.map (translate_expr env) args)
in ((EOp (((op), (w)))), (uu____6001)))
in EApp (uu____5994)))
