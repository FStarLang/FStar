...
let (uu___is_CDecl : cc -> Prims.bool) =
  fun projectee -> match projectee with | CDecl -> true | uu____1677 -> false
...
let (uu___is_IfDef : flag -> Prims.bool) =
  fun projectee -> match projectee with | IfDef -> true | uu____1868 -> false
let (uu___is_Macro : flag -> Prims.bool) =
  fun projectee -> match projectee with | Macro -> true | uu____1879 -> false
...
let (uu___is_Stack : lifetime -> Prims.bool) =
  fun projectee -> match projectee with | Stack -> true | uu____1924 -> false
...
let (uu___is_EUnit : expr -> Prims.bool) =
  fun projectee -> match projectee with | EUnit -> true | uu____2059 -> false
...
let (uu___is_EAny : expr -> Prims.bool) =
  fun projectee -> match projectee with | EAny -> true | uu____2693 -> false
...
let (uu___is_AddW : op -> Prims.bool) =
  fun projectee -> match projectee with | AddW -> true | uu____3322 -> false
let (uu___is_Sub : op -> Prims.bool) =
  fun projectee -> match projectee with | Sub -> true | uu____3333 -> false
let (uu___is_SubW : op -> Prims.bool) =
  fun projectee -> match projectee with | SubW -> true | uu____3344 -> false
let (uu___is_Div : op -> Prims.bool) =
  fun projectee -> match projectee with | Div -> true | uu____3355 -> false
let (uu___is_DivW : op -> Prims.bool) =
  fun projectee -> match projectee with | DivW -> true | uu____3366 -> false
let (uu___is_Mult : op -> Prims.bool) =
  fun projectee -> match projectee with | Mult -> true | uu____3377 -> false
let (uu___is_MultW : op -> Prims.bool) =
  fun projectee -> match projectee with | MultW -> true | uu____3388 -> false
...
let (uu___is_BAnd : op -> Prims.bool) =
  fun projectee -> match projectee with | BAnd -> true | uu____3421 -> false
let (uu___is_BXor : op -> Prims.bool) =
  fun projectee -> match projectee with | BXor -> true | uu____3432 -> false
...
let (uu___is_BNot : op -> Prims.bool) =
  fun projectee -> match projectee with | BNot -> true | uu____3465 -> false
...
let (uu___is_PUnit : pattern -> Prims.bool) =
  fun projectee -> match projectee with | PUnit -> true | uu____3586 -> false
...
let (uu___is_UInt8 : width -> Prims.bool) =
  fun projectee -> match projectee with | UInt8 -> true | uu____3799 -> false
...
let (uu___is_Int8 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int8 -> true | uu____3843 -> false
let (uu___is_Int16 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int16 -> true | uu____3854 -> false
let (uu___is_Int32 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int32 -> true | uu____3865 -> false
let (uu___is_Int64 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int64 -> true | uu____3876 -> false
let (uu___is_Bool : width -> Prims.bool) =
  fun projectee -> match projectee with | Bool -> true | uu____3887 -> false
let (uu___is_CInt : width -> Prims.bool) =
  fun projectee -> match projectee with | CInt -> true | uu____3898 -> false
...
let (uu___is_TUnit : typ -> Prims.bool) =
  fun projectee -> match projectee with | TUnit -> true | uu____3984 -> false
...
let (uu___is_TBool : typ -> Prims.bool) =
  fun projectee -> match projectee with | TBool -> true | uu____4046 -> false
let (uu___is_TAny : typ -> Prims.bool) =
  fun projectee -> match projectee with | TAny -> true | uu____4057 -> false
    ...
    let uu____5177 =
      FStar_List.choose
        (fun uu___4_5184 ->
           ...
           | uu____5191 -> FStar_Pervasives_Native.None) flags in
      ...
      fun lb ->
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name;
            ...
            ((let uu____5694 =
                ...
                (FStar_Errors.Warning_DefinitionNotTranslated, uu____5700) in
      ...
      | (uu____5724, uu____5725, uu____5726, uu____5727, flags, uu____5729)
          ...
          then FStar_Pervasives_Native.None
            ...
            (match ty with
             ...
             | (uu____5840, name, _mangled_name, args, flags1,
                FStar_Pervasives_Native.Some
                                    ...
                                    (fun uu____6235 ->
                                       ...
                                       | (name2, t) ->
                                           let uu____6255 =
                                             ...
                                             (uu____6261, false) in
                                           (name2, uu____6255)) ts in
                                (cons1, uu____6203)) branches in
                     (name1, flags2, (FStar_List.length args), uu____6102) in
                   DTypeVariant uu____6063 in
                 FStar_Pervasives_Native.Some uu____6062
             | (uu____6314, name, _mangled_name, uu____6317, uu____6318,
                uu____6319) ->
                 ((let uu____6335 =
                     let uu____6341 =
                       FStar_Util.format1
    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named
          ...
          (((let uu____6419 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____6419 = "FStar.Monotonic.HyperStack.s_mref") ||
              (let uu____6424 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____6424 = "FStar.Monotonic.HyperHeap.mrref"))
             ||
             (let uu____6429 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____6429 = "FStar.HyperStack.ST.m_rref"))
            ||
            (let uu____6434 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::uu____6440::[], p) when
          ((((((((((let uu____6446 =
              ...
              ||
              (let uu____6486 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____6486 = "FStar.HyperStack.ST.mref"))
             ||
             (let uu____6491 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____6491 = "FStar.HyperStack.ST.mmmstackref"))
            ||
            (let uu____6496 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[], p) when
          (((((((((((((let uu____6527 =
              ...
              ||
              (let uu____6582 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____6582 = "FStar.HyperStack.ST.ref"))
             ||
             (let uu____6587 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____6587 = "FStar.HyperStack.ST.mmstackref"))
            ||
            (let uu____6592 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
    ...
    fun e ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6861;_},
                t::[]);
             FStar_Extraction_ML_Syntax.mlty = uu____6863;
             FStar_Extraction_ML_Syntax.loc = uu____6864;_},
           arg::[])
          when
          ...
          let uu____6874 =
            ...
            let uu____6880 = translate_type env t in (uu____6879, uu____6880) in
          ECast uu____6874
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6883;_},
                uu____6884);
             FStar_Extraction_ML_Syntax.mlty = uu____6885;
             FStar_Extraction_ML_Syntax.loc = uu____6886;_},
           uu____6887)
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6905;_},
           {
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6908;_}::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6928;_},
                uu____6929);
             FStar_Extraction_ML_Syntax.mlty = uu____6930;
             FStar_Extraction_ML_Syntax.loc = uu____6931;_},
           arg::[])
          when
          ((let uu____6941 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               ...
               let print7 =
                 let uu____6961 =
                   let uu____6962 =
                     ...
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____6963 in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____6962 in
                 FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top uu____6961 in
               let print8 =
                 FStar_Extraction_ML_Syntax.with_ty
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu____6984 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu____6984 = "LowStar.ToFStarBuffer.new_to_old_st") ||
            (let uu____6989 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           e1::e2::[])
          when
          ((((let uu____7009 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7009 = "FStar.Buffer.index") ||
               (let uu____7014 =
                  FStar_Extraction_ML_Syntax.string_of_mlpath p in
                uu____7014 = "FStar.Buffer.op_Array_Access"))
              ||
              (let uu____7019 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            ||
            (let uu____7029 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7042;_},
                uu____7043);
             FStar_Extraction_ML_Syntax.mlty = uu____7044;
             FStar_Extraction_ML_Syntax.loc = uu____7045;_},
           e1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7067;_},
                uu____7068);
             FStar_Extraction_ML_Syntax.mlty = uu____7069;
             FStar_Extraction_ML_Syntax.loc = uu____7070;_},
           e1::e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7129;_},
                uu____7130);
             FStar_Extraction_ML_Syntax.mlty = uu____7131;
             FStar_Extraction_ML_Syntax.loc = uu____7132;_},
           init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7156;_},
                uu____7157);
             FStar_Extraction_ML_Syntax.mlty = uu____7158;
             FStar_Extraction_ML_Syntax.loc = uu____7159;_},
           e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7240;_},
                uu____7241);
             FStar_Extraction_ML_Syntax.mlty = uu____7242;
             FStar_Extraction_ML_Syntax.loc = uu____7243;_},
           _rid::init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7275;_},
                uu____7276);
             FStar_Extraction_ML_Syntax.mlty = uu____7277;
             FStar_Extraction_ML_Syntax.loc = uu____7278;_},
           _e0::e1::e2::[])
          when
          ((let uu____7290 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu____7290 = "FStar.Buffer.rcreate") ||
             (let uu____7295 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7295 = "LowStar.Monotonic.Buffer.mgcmalloc"))
            ||
            (let uu____7300 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7315;_},
                uu____7316);
             FStar_Extraction_ML_Syntax.mlty = uu____7317;
             FStar_Extraction_ML_Syntax.loc = uu____7318;_},
           uu____7319)
          when
          (((((let uu____7330 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             ...
             ||
             (let uu____7350 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7386;_},
                uu____7387);
             FStar_Extraction_ML_Syntax.mlty = uu____7388;
             FStar_Extraction_ML_Syntax.loc = uu____7389;_},
           _rid::init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7421;_},
                uu____7422);
             FStar_Extraction_ML_Syntax.mlty = uu____7423;
             FStar_Extraction_ML_Syntax.loc = uu____7424;_},
           _e0::e1::e2::[])
          when
          (((let uu____7436 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____7436 = "FStar.Buffer.rcreate_mm") ||
              (let uu____7441 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____7441 = "LowStar.Monotonic.Buffer.mmalloc"))
             ||
             (let uu____7446 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7490;_},
                uu____7491);
             FStar_Extraction_ML_Syntax.mlty = uu____7492;
             FStar_Extraction_ML_Syntax.loc = uu____7493;_},
           e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7508;_},
                uu____7509);
             FStar_Extraction_ML_Syntax.mlty = uu____7510;
             FStar_Extraction_ML_Syntax.loc = uu____7511;_},
           e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7533;_},
                uu____7534);
             FStar_Extraction_ML_Syntax.mlty = uu____7535;
             FStar_Extraction_ML_Syntax.loc = uu____7536;_},
           e1::e2::_e3::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7562;_},
           e1::e2::_e3::[])
          when
          (let uu____7574 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu____7574 = "LowStar.Monotonic.Buffer.msub") ||
            (let uu____7579 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7592;_},
                uu____7593);
             FStar_Extraction_ML_Syntax.mlty = uu____7594;
             FStar_Extraction_ML_Syntax.loc = uu____7595;_},
           e1::e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7635;_},
                uu____7636);
             FStar_Extraction_ML_Syntax.mlty = uu____7637;
             FStar_Extraction_ML_Syntax.loc = uu____7638;_},
           e1::e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7660;_},
                uu____7661);
             FStar_Extraction_ML_Syntax.mlty = uu____7662;
             FStar_Extraction_ML_Syntax.loc = uu____7663;_},
           e1::e2::e3::[])
          when
          (((let uu____7675 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____7675 = "FStar.Buffer.upd") ||
              (let uu____7680 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____7680 = "FStar.Buffer.op_Array_Assignment"))
             ||
             (let uu____7685 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7685 = "LowStar.Monotonic.Buffer.upd'"))
            ||
            (let uu____7690 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7706;_},
                uu____7707);
             FStar_Extraction_ML_Syntax.mlty = uu____7708;
             FStar_Extraction_ML_Syntax.loc = uu____7709;_},
           e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7735;_},
           uu____7736::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7745;_},
           uu____7746::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7758;_},
           e1::e2::e3::e4::e5::[])
          when
          ((let uu____7772 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu____7772 = "FStar.Buffer.blit") ||
             (let uu____7777 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7777 = "LowStar.Monotonic.Buffer.blit"))
            ||
            (let uu____7782 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7804;_},
                uu____7805);
             FStar_Extraction_ML_Syntax.mlty = uu____7806;
             FStar_Extraction_ML_Syntax.loc = uu____7807;_},
           e1::e2::e3::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7845;_},
                uu____7846);
             FStar_Extraction_ML_Syntax.mlty = uu____7847;
             FStar_Extraction_ML_Syntax.loc = uu____7848;_},
           _rid::[])
          when
          (let uu____7858 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu____7858 = "FStar.HyperStack.ST.free_drgn") ||
            (let uu____7863 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7869;_},
                uu____7870);
             FStar_Extraction_ML_Syntax.mlty = uu____7871;
             FStar_Extraction_ML_Syntax.loc = uu____7872;_},
           _ebuf::_eseq::[])
          when
          (((let uu____7883 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             ...
             ||
             (let uu____7893 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7904;_},
                uu____7905);
             FStar_Extraction_ML_Syntax.mlty = uu____7906;
             FStar_Extraction_ML_Syntax.loc = uu____7907;_},
           e1::[])
          when
          (let uu____7917 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu____7917 = "LowStar.ConstBuffer.of_buffer") ||
            (let uu____7922 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           e1::[])
          when
          ((let uu____7939 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu____7939 = "LowStar.ConstBuffer.cast") ||
             (let uu____7944 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7944 = "LowStar.ConstBuffer.to_buffer"))
            ||
            (let uu____7949 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____7949 = "LowStar.ConstBuffer.to_ibuffer")
          ->
          let uu____7953 =
            let uu____7958 = translate_expr env e1 in
            let uu____7959 =
              let uu____7960 = translate_type env t in TBuf uu____7960 in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7963;_},
           e1::[])
          when
          let uu____7967 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu____7967 = "Obj.repr" ->
          let uu____7971 =
            let uu____7976 = translate_expr env e1 in (uu____7976, TAny) in
          ECast uu____7971
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          let uu____7996 = FStar_Util.must (mk_width m) in
          let uu____7997 = FStar_Util.must (mk_op op) in
          mk_op_app env uu____7996 uu____7997 args
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name ("Prims"::[], op);
             FStar_Extraction_ML_Syntax.mlty = uu____7999;
             FStar_Extraction_ML_Syntax.loc = uu____8000;_},
           args)
          when is_bool_op op ->
          let uu____8014 = FStar_Util.must (mk_bool_op op) in
          mk_op_app env Bool uu____8014 args
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name
               ("FStar"::m::[], "int_to_t");
             FStar_Extraction_ML_Syntax.mlty = uu____8016;
             FStar_Extraction_ML_Syntax.loc = uu____8017;_},
           {
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Const
             ...
             FStar_Extraction_ML_Syntax.loc = uu____8020;_}::[])
          when is_machine_int m ->
          let uu____8045 =
            let uu____8051 = FStar_Util.must (mk_width m) in (uu____8051, c) in
          EConstant uu____8045
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name
             ...
             FStar_Extraction_ML_Syntax.loc = uu____8055;_},
           {
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_Int
          ...
          when is_machine_int m ->
          let uu____8083 =
            let uu____8089 = FStar_Util.must (mk_width m) in (uu____8089, c) in
          EConstant uu____8083
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name
               ("C"::[], "string_of_literal");
             FStar_Extraction_ML_Syntax.mlty = uu____8091;
             FStar_Extraction_ML_Syntax.loc = uu____8092;_},
           { FStar_Extraction_ML_Syntax.expr = e1;
             FStar_Extraction_ML_Syntax.mlty = uu____8094;
             FStar_Extraction_ML_Syntax.loc = uu____8095;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.mlty = uu____8110;
             FStar_Extraction_ML_Syntax.loc = uu____8111;_},
           { FStar_Extraction_ML_Syntax.expr = e1;
             FStar_Extraction_ML_Syntax.mlty = uu____8113;
             FStar_Extraction_ML_Syntax.loc = uu____8114;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_String s) -> EString s
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____8134;_},
           { FStar_Extraction_ML_Syntax.expr = e1;
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  FStar_Extraction_ML_Syntax.expr =
                    FStar_Extraction_ML_Syntax.MLE_Name p;
                  FStar_Extraction_ML_Syntax.mlty = uu____8155;
                  FStar_Extraction_ML_Syntax.loc = uu____8156;_},
                uu____8157);
           ...
           { FStar_Extraction_ML_Syntax.expr = ebefore;
             FStar_Extraction_ML_Syntax.mlty = uu____8161;
             FStar_Extraction_ML_Syntax.loc = uu____8162;_}::e1::{
                                                                   FStar_Extraction_ML_Syntax.expr
                                                                    = eafter;
                                                                   ...
                                                                   FStar_Extraction_ML_Syntax.loc
                                                                    ...
                                                                    uu____8166;_}::[])
          when
          let uu____8173 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu____8173 = "LowStar.Comment.comment_gen" ->
           ...
           | (FStar_Extraction_ML_Syntax.MLE_Const
              ...
              (FStar_Extraction_ML_Syntax.MLC_String safter)) ->
               (if FStar_Util.contains sbefore "*/"
                ...
                (let uu____8193 =
                   let uu____8202 = translate_expr env e1 in
                   (sbefore, uu____8202, safter) in
                 EComment uu____8193))
           | uu____8205 ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____8212;
             FStar_Extraction_ML_Syntax.loc = uu____8213;_},
           { FStar_Extraction_ML_Syntax.expr = e1;
             FStar_Extraction_ML_Syntax.mlty = uu____8215;
             FStar_Extraction_ML_Syntax.loc = uu____8216;_}::[])
          when
          let uu____8219 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          uu____8219 = "LowStar.Comment.comment" ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_String s) ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.mlty = uu____8233;
             FStar_Extraction_ML_Syntax.loc = uu____8234;_},
           { FStar_Extraction_ML_Syntax.expr = e1;
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name
               ("FStar"::"Int"::"Cast"::[], c);
             FStar_Extraction_ML_Syntax.mlty = uu____8255;
             FStar_Extraction_ML_Syntax.loc = uu____8256;_},
           arg::[])
          ->
          let is_known_type =
          ...
          then
            let uu____8284 =
              let uu____8289 = translate_expr env arg in
              (uu____8289, (TInt UInt64)) in
            ECast uu____8284
          else
            if (FStar_Util.ends_with c "uint32") && is_known_type
            then
              (let uu____8294 =
                 let uu____8299 = translate_expr env arg in
                 (uu____8299, (TInt UInt32)) in
               ECast uu____8294)
            else
              if (FStar_Util.ends_with c "uint16") && is_known_type
              then
                (let uu____8304 =
                   let uu____8309 = translate_expr env arg in
                   (uu____8309, (TInt UInt16)) in
                 ECast uu____8304)
              else
                if (FStar_Util.ends_with c "uint8") && is_known_type
                then
                  (let uu____8314 =
                     let uu____8319 = translate_expr env arg in
                     (uu____8319, (TInt UInt8)) in
                   ECast uu____8314)
                else
                  if (FStar_Util.ends_with c "int64") && is_known_type
                  then
                    (let uu____8324 =
                       let uu____8329 = translate_expr env arg in
                       (uu____8329, (TInt Int64)) in
                     ECast uu____8324)
                  else
                    if (FStar_Util.ends_with c "int32") && is_known_type
                    then
                      (let uu____8334 =
                         let uu____8339 = translate_expr env arg in
                         (uu____8339, (TInt Int32)) in
                       ECast uu____8334)
                    else
                      if (FStar_Util.ends_with c "int16") && is_known_type
                      then
                        (let uu____8344 =
                           let uu____8349 = translate_expr env arg in
                           (uu____8349, (TInt Int16)) in
                         ECast uu____8344)
                      else
                        if (FStar_Util.ends_with c "int8") && is_known_type
                        then
                          (let uu____8354 =
                             let uu____8359 = translate_expr env arg in
                             (uu____8359, (TInt Int8)) in
                           ECast uu____8354)
                        else
                          (let uu____8362 =
                             let uu____8369 =
                               let uu____8372 = translate_expr env arg in
                               [uu____8372] in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App (head1, args) ->
          let uu____8392 =
            let uu____8399 = translate_expr env head1 in
            let uu____8400 = FStar_List.map (translate_expr env) args in
            (uu____8399, uu____8400) in
          EApp uu____8392
      | FStar_Extraction_ML_Syntax.MLE_TApp (head1, ty_args) ->
          let uu____8411 =
            let uu____8418 = translate_expr env head1 in
            let uu____8419 = FStar_List.map (translate_type env) ty_args in
            (uu____8418, uu____8419) in
          ETypApp uu____8411
      | FStar_Extraction_ML_Syntax.MLE_Coerce (e1, t_from, t_to) ->
          let uu____8427 =
            let uu____8432 = translate_expr env e1 in
            let uu____8433 = translate_type env t_to in
            (uu____8432, uu____8433) in
          ECast uu____8427
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____8434, fields) ->
          let uu____8456 =
            let uu____8468 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
            let uu____8469 =
              FStar_List.map
                (fun uu____8491 ->
                   match uu____8491 with
                   | (field, expr) ->
                       let uu____8506 = translate_expr env expr in
                       (field, uu____8506)) fields in
            (uu____8468, uu____8469) in
          EFlat uu____8456
      | FStar_Extraction_ML_Syntax.MLE_Proj (e1, path) ->
          let uu____8517 =
            let uu____8525 =
              assert_lid env e1.FStar_Extraction_ML_Syntax.mlty in
            let uu____8526 = translate_expr env e1 in
            (uu____8525, uu____8526, (FStar_Pervasives_Native.snd path)) in
          EField uu____8517
      | FStar_Extraction_ML_Syntax.MLE_Let uu____8532 ->
          failwith "todo: translate_expr [MLE_Let]"
      | FStar_Extraction_ML_Syntax.MLE_App (head1, uu____8545) ->
          let uu____8550 =
            let uu____8552 =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Seq seqs ->
          let uu____8564 = FStar_List.map (translate_expr env) seqs in
          ESequence uu____8564
      | FStar_Extraction_ML_Syntax.MLE_Tuple es ->
          let uu____8570 = FStar_List.map (translate_expr env) es in
          ETuple uu____8570
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____8573, cons1), es) ->
          let uu____8588 =
            let uu____8598 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
            let uu____8599 = FStar_List.map (translate_expr env) es in
            (uu____8598, cons1, uu____8599) in
          ECons uu____8588
      | FStar_Extraction_ML_Syntax.MLE_Fun (args, body) ->
          let binders = translate_binders env args in
          let env1 = add_binders env args in
          let uu____8625 =
            let uu____8634 = translate_expr env1 body in
            let uu____8635 =
              translate_type env1 body.FStar_Extraction_ML_Syntax.mlty in
            (binders, uu____8634, uu____8635) in
          EFun uu____8625
      | FStar_Extraction_ML_Syntax.MLE_If (e1, e2, e3) ->
          let uu____8645 =
            let uu____8652 = translate_expr env e1 in
            let uu____8653 = translate_expr env e2 in
            let uu____8654 =
              match e3 with
              | FStar_Pervasives_Native.None -> EUnit
              | FStar_Pervasives_Native.Some e31 -> translate_expr env e31 in
            (uu____8652, uu____8653, uu____8654) in
          EIfThenElse uu____8645
      | FStar_Extraction_ML_Syntax.MLE_Raise uu____8656 ->
          failwith "todo: translate_expr [MLE_Raise]"
      | FStar_Extraction_ML_Syntax.MLE_Try uu____8664 ->
          failwith "todo: translate_expr [MLE_Try]"
      | FStar_Extraction_ML_Syntax.MLE_Coerce uu____8680 ->
  ...
  fun env ->
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (ts, lid) ->
          ...
          then
            let uu____8698 =
              let uu____8713 = FStar_List.map (translate_type env) ts in
              (lid, uu____8713) in
            TApp uu____8698
          else TQualified lid
      | uu____8728 ->
          let uu____8729 =
            let uu____8731 =
              FStar_Extraction_ML_Code.string_of_mlty ([], "") t in
            FStar_Util.format1
              "invalid argument: expected MLTY_Named, got %s" uu____8731 in
          failwith uu____8729
  ...
  fun env ->
    fun uu____8765 ->
      ...
      | (pat, guard, expr) ->
          ...
          then
            let uu____8792 = translate_pat env pat in
            (match uu____8792 with
             | (env1, pat1) ->
                 let uu____8803 = translate_expr env1 expr in
                 (pat1, uu____8803))
  ...
  fun env ->
    fun p ->
      ...
      | FStar_Extraction_ML_Syntax.MLP_Const
          ...
          let uu____8878 =
            let uu____8879 =
              let uu____8885 = translate_width sw in (uu____8885, s) in
            PConstant uu____8879 in
          (env, uu____8878)
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor ((uu____8895, cons1), ps) ->
          let uu____8910 =
            FStar_List.fold_left
              (fun uu____8930 ->
                 fun p1 ->
                   ...
                   | (env1, acc) ->
                       let uu____8950 = translate_pat env1 p1 in
                       (match uu____8950 with
                        | (env2, p2) -> (env2, (p2 :: acc)))) (env, []) ps in
          (match uu____8910 with
           | (env1, ps1) -> (env1, (PCons (cons1, (FStar_List.rev ps1)))))
      | FStar_Extraction_ML_Syntax.MLP_Record (uu____8980, ps) ->
          let uu____9002 =
            FStar_List.fold_left
              (fun uu____9039 ->
                 fun uu____9040 ->
                   match (uu____9039, uu____9040) with
                   | ((env1, acc), (field, p1)) ->
                       let uu____9120 = translate_pat env1 p1 in
            ...
            FStar_List.fold_left
              (fun uu____9211 ->
                 fun p1 ->
                   ...
                   | (env1, acc) ->
                       let uu____9231 = translate_pat env1 p1 in
                       (match uu____9231 with
                        | (env2, p2) -> (env2, (p2 :: acc)))) (env, []) ps in
          (match uu____9191 with
           | (env1, ps1) -> (env1, (PTuple (FStar_List.rev ps1))))
      | FStar_Extraction_ML_Syntax.MLP_Const uu____9258 ->
          failwith "todo: translate_pat [MLP_Const]"
      | FStar_Extraction_ML_Syntax.MLP_Branch uu____9264 ->
...
and (translate_constant : FStar_Extraction_ML_Syntax.mlconstant -> expr) =
  fun c ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_String s ->
        ((let uu____9278 =
            let uu____9280 = FStar_String.list_of_string s in
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s, FStar_Pervasives_Native.Some uu____9322) ->
        failwith
          "impossible: machine integer not desugared to a function call"
    | FStar_Extraction_ML_Syntax.MLC_Float uu____9340 ->
        failwith "todo: translate_expr [MLC_Float]"
    | FStar_Extraction_ML_Syntax.MLC_Bytes uu____9342 ->
  ...
  fun env ->
    fun w ->
      fun op ->
        fun args ->
          let uu____9366 =
            let uu____9373 = FStar_List.map (translate_expr env) args in
            ((EOp (op, w)), uu____9373) in
          EApp uu____9366
          ...
          (fun m ->
             ...
             try
               (fun uu___1653_9468 ->
                  ...
                  | () ->
                      ((let uu____9472 =
                          let uu____9474 = FStar_Options.silent () in
                          Prims.op_Negation uu____9474 in
                        if uu____9472
                        then
                          FStar_Util.print1
                            "Attempting to translate module %s\n" m_name
                        else ());
                       (let uu____9480 = translate_module m in
                        FStar_Pervasives_Native.Some uu____9480))) ()
             with
             | uu___1652_9483 ->
                 ((let uu____9487 = FStar_Util.print_exn uu___1652_9483 in
                   FStar_Util.print2
