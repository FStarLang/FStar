    ...
    let uu___ =
      FStar_List.choose
        (fun uu___1  ->
           ...
           | uu___2 -> FStar_Pervasives_Native.None) flags
       in
    match uu___ with
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name1;
            ...
            then FStar_Pervasives_Native.None
              ...
              (let env2 =
               ...
               let env3 =
                 FStar_List.fold_left
                   (fun env4  -> fun name2  -> extend_t env4 name2) env2
                   tvars
                  in
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name1;
            ...
            then FStar_Pervasives_Native.None
              ...
              (let meta1 = translate_flags meta  in
               let env2 =
                 FStar_List.fold_left
                   (fun env3  -> fun name2  -> extend_t env3 name2) env1
                   tvars
                  in
                   ...
                   ((let uu___5 =
                       let uu___6 =
                         ...
                         FStar_Util.format2
                           ...
                           uu___8
                          in
                       (FStar_Errors.Warning_DefinitionNotTranslated, uu___6)
                        in
      ...
      then FStar_Pervasives_Native.None
        ...
        (match ty with
         | { FStar_Extraction_ML_Syntax.tydecl_assumed = assumed;
             ...
             let env2 =
               FStar_List.fold_left
                 (fun env3  -> fun name3  -> extend_t env3 name3) env1 args
                in
             if
               assumed &&
                            ...
                            let uu___7 =
                              FStar_List.map
                                (fun uu___8  ->
                                   ...
                                   | (name3,t) ->
                                       let uu___9 =
                                         let uu___10 = translate_type env2 t
                                            in
                                         (uu___10, false)  in
                                       (name3, uu___9)) ts
                               in
                            (cons, uu___7)) branches1
                    in
...
and (translate_type : env -> FStar_Extraction_ML_Syntax.mlty -> typ) =
  fun env1  ->
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (uu___::arg::uu___1::[],p) when
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::uu___::[],p) when
          ((((((((((let uu___1 =
                  ...
                  ||
                  (let uu___1 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                      in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::uu___::uu___1::[],p) when
          let uu___2 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[],p) when
          (((((((((((((let uu___ =
                   ...
                   ||
                   (let uu___ = FStar_Extraction_ML_Syntax.string_of_mlpath p
                       in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Tuple ts ->
          let uu___ = FStar_List.map (translate_type env1) ts  in
          TTuple uu___
    ...
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Name ("FStar"::m::[],op1) when
          ...
          let uu___ =
            ...
            let uu___2 = FStar_Util.must (mk_width m)  in (uu___1, uu___2)
             in
          EOp uu___
      | FStar_Extraction_ML_Syntax.MLE_Name ("Prims"::[],op1) when
          is_bool_op op1 ->
          let uu___ =
            let uu___1 = FStar_Util.must (mk_bool_op op1)  in (uu___1, Bool)
             in
          EOp uu___
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},t::[]);
             FStar_Extraction_ML_Syntax.mlty = uu___2;
             FStar_Extraction_ML_Syntax.loc = uu___3;_},arg::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu___4;_},uu___5)
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},arg::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},e1::[])
          when
          (let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},e1::e2::[])
          when
          ((((let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
              uu___5 = "FStar.Buffer.index") ||
               (let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                   in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu___5 =
            let uu___6 = translate_expr env1 e1  in
            let uu___7 = translate_expr env1 e2  in (Stack, uu___6, uu___7)
             in
          EBufCreate uu___5
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},elen::[])
          when
          let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},init::[])
          when
          let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},e2::[])
          when
          ((let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},_erid::e2::[])
          when
          (let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},_rid::init::[])
          when
          (let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},_e0::e1::e2::[])
          when
          ((let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          let uu___5 =
            let uu___6 = translate_expr env1 e1  in
            let uu___7 = translate_expr env1 e2  in (Eternal, uu___6, uu___7)
             in
          EBufCreate uu___5
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
          ...
          (((((let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
               uu___6 = "LowStar.Monotonic.Buffer.mgcmalloc_and_blit") ||
                (let uu___6 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                    in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},_erid::elen::[])
          when
          let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},e1::e2::_e3::[])
          when
          let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},e1::e2::e3::[])
          when
          (((let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          let uu___5 =
            let uu___6 = translate_expr env1 e1  in
            let uu___7 = translate_expr env1 e2  in
            let uu___8 = translate_expr env1 e3  in (uu___6, uu___7, uu___8)
             in
          EBufWrite uu___5
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},e1::e2::e3::e4::e5::[])
          when
          ((let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},_rid::[])
          when
          (let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},uu___2);
             FStar_Extraction_ML_Syntax.mlty = uu___3;
             FStar_Extraction_ML_Syntax.loc = uu___4;_},_ebuf::_eseq::[])
          when
          (((let uu___5 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},t::[]);
             FStar_Extraction_ML_Syntax.mlty = uu___2;
             FStar_Extraction_ML_Syntax.loc = uu___3;_},_eqal::e1::[])
          when
          let uu___4 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu___1;_},t::[]);
             FStar_Extraction_ML_Syntax.mlty = uu___2;
             FStar_Extraction_ML_Syntax.loc = uu___3;_},e1::[])
          when
          ((let uu___4 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          ...
          let uu___4 =
            let uu___5 = translate_expr env1 e1  in
            let uu___6 = let uu___7 = translate_type env1 t  in TBuf uu___7
               in
            (uu___5, uu___6)  in
          ECast uu___4
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu___;
             FStar_Extraction_ML_Syntax.loc = uu___1;_},e1::[])
          when
          let uu___2 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu___2 = "Obj.repr" ->
          let uu___2 = let uu___3 = translate_expr env1 e1  in (uu___3, TAny)
             in
          ECast uu___2
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.mlty = uu___;
             FStar_Extraction_ML_Syntax.loc = uu___1;_},args)
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ("FStar"::"Int"::"Cast"::[],c);
             FStar_Extraction_ML_Syntax.mlty = uu___;
             FStar_Extraction_ML_Syntax.loc = uu___1;_},arg::[])
          ->
          let is_known_type =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu___,fields) ->
          let uu___1 =
            let uu___2 = assert_lid env1 e.FStar_Extraction_ML_Syntax.mlty
               in
            let uu___3 =
              FStar_List.map
                (fun uu___4  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Proj (e1,path) ->
          let uu___ =
            let uu___1 = assert_lid env1 e1.FStar_Extraction_ML_Syntax.mlty
               in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Let uu___ ->
          let uu___1 =
            let uu___2 = FStar_Extraction_ML_Code.string_of_mlexpr ([], "") e
               in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Tuple es ->
          let uu___ = FStar_List.map (translate_expr env1) es  in
          ETuple uu___
...
and (assert_lid : env -> FStar_Extraction_ML_Syntax.mlty -> typ) =
  fun env1  ->
    fun t  ->
      ...
      | uu___ ->
          let uu___1 =
            let uu___2 = FStar_Extraction_ML_Code.string_of_mlty ([], "") t
               in
            FStar_Util.format1
              "invalid argument: expected MLTY_Named, got %s" uu___2
             in
          failwith uu___1
