...
let (uu___is_CDecl : cc -> Prims.bool) =
  fun projectee -> match projectee with | CDecl -> true | uu____1637 -> false
...
let (uu___is_IfDef : flag -> Prims.bool) =
  fun projectee -> match projectee with | IfDef -> true | uu____1828 -> false
let (uu___is_Macro : flag -> Prims.bool) =
  fun projectee -> match projectee with | Macro -> true | uu____1839 -> false
let (uu___is_Eternal : lifetime -> Prims.bool) =
  fun projectee ->
    match projectee with | Eternal -> true | uu____1850 -> false
let (uu___is_Stack : lifetime -> Prims.bool) =
  fun projectee -> match projectee with | Stack -> true | uu____1861 -> false
...
let (uu___is_EUnit : expr -> Prims.bool) =
  fun projectee -> match projectee with | EUnit -> true | uu____1996 -> false
...
let (uu___is_EAny : expr -> Prims.bool) =
  fun projectee -> match projectee with | EAny -> true | uu____2630 -> false
...
let (uu___is_AddW : op -> Prims.bool) =
  fun projectee -> match projectee with | AddW -> true | uu____3146 -> false
let (uu___is_Sub : op -> Prims.bool) =
  fun projectee -> match projectee with | Sub -> true | uu____3157 -> false
let (uu___is_SubW : op -> Prims.bool) =
  fun projectee -> match projectee with | SubW -> true | uu____3168 -> false
let (uu___is_Div : op -> Prims.bool) =
  fun projectee -> match projectee with | Div -> true | uu____3179 -> false
let (uu___is_DivW : op -> Prims.bool) =
  fun projectee -> match projectee with | DivW -> true | uu____3190 -> false
let (uu___is_Mult : op -> Prims.bool) =
  fun projectee -> match projectee with | Mult -> true | uu____3201 -> false
let (uu___is_MultW : op -> Prims.bool) =
  fun projectee -> match projectee with | MultW -> true | uu____3212 -> false
...
let (uu___is_BAnd : op -> Prims.bool) =
  fun projectee -> match projectee with | BAnd -> true | uu____3245 -> false
let (uu___is_BXor : op -> Prims.bool) =
  fun projectee -> match projectee with | BXor -> true | uu____3256 -> false
...
let (uu___is_BNot : op -> Prims.bool) =
  fun projectee -> match projectee with | BNot -> true | uu____3289 -> false
...
let (uu___is_PUnit : pattern -> Prims.bool) =
  fun projectee -> match projectee with | PUnit -> true | uu____3410 -> false
...
let (uu___is_UInt8 : width -> Prims.bool) =
  fun projectee -> match projectee with | UInt8 -> true | uu____3623 -> false
...
let (uu___is_Int8 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int8 -> true | uu____3667 -> false
let (uu___is_Int16 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int16 -> true | uu____3678 -> false
let (uu___is_Int32 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int32 -> true | uu____3689 -> false
let (uu___is_Int64 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int64 -> true | uu____3700 -> false
let (uu___is_Bool : width -> Prims.bool) =
  fun projectee -> match projectee with | Bool -> true | uu____3711 -> false
let (uu___is_CInt : width -> Prims.bool) =
  fun projectee -> match projectee with | CInt -> true | uu____3722 -> false
...
let (uu___is_TUnit : typ -> Prims.bool) =
  fun projectee -> match projectee with | TUnit -> true | uu____3808 -> false
...
let (uu___is_TBool : typ -> Prims.bool) =
  fun projectee -> match projectee with | TBool -> true | uu____3870 -> false
let (uu___is_TAny : typ -> Prims.bool) =
  fun projectee -> match projectee with | TAny -> true | uu____3881 -> false
    ...
    let uu____5080 =
      FStar_List.choose
        (fun uu___4_5087 ->
           ...
           | uu____5094 -> FStar_Pervasives_Native.None) flags in
      ...
      fun lb ->
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name;
            ...
            ((let uu____5597 =
                ...
                (FStar_Errors.Warning_DefinitionNotTranslated, uu____5603) in
      ...
      | (uu____5627, uu____5628, uu____5629, uu____5630, flags, uu____5632)
          ...
          then FStar_Pervasives_Native.None
            ...
            (match ty with
             ...
             | (uu____5743, name, _mangled_name, args, flags1,
                FStar_Pervasives_Native.Some
                                    ...
                                    (fun uu____6138 ->
                                       ...
                                       | (name2, t) ->
                                           let uu____6158 =
                                             ...
                                             (uu____6164, false) in
                                           (name2, uu____6158)) ts in
                                (cons1, uu____6106)) branches in
                     (name1, flags2, (FStar_List.length args), uu____6005) in
                   DTypeVariant uu____5966 in
                 FStar_Pervasives_Native.Some uu____5965
             | (uu____6217, name, _mangled_name, uu____6220, uu____6221,
                uu____6222) ->
                 ((let uu____6238 =
                     let uu____6244 =
                       FStar_Util.format1
    ...
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named
          ...
          (((let uu____6322 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____6322 = "FStar.Monotonic.HyperStack.s_mref") ||
              (let uu____6327 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____6327 = "FStar.Monotonic.HyperHeap.mrref"))
             ||
             (let uu____6332 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::uu____6343::[], p) when
          ((((((((((let uu____6349 =
              ...
              ||
              (let uu____6389 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____6389 = "FStar.HyperStack.ST.mref"))
             ||
             (let uu____6394 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____6394 = "FStar.HyperStack.ST.mmmstackref"))
            ||
            (let uu____6399 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[], p) when
          (((((((((((((let uu____6421 =
             ...
             ||
             (let uu____6481 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (uu____6491::arg::[], p) when
          (let uu____6498 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu____6498 = "FStar.HyperStack.s_ref") ||
            (let uu____6503 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
    ...
    fun e ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6755;_},
                t::[]);
             FStar_Extraction_ML_Syntax.mlty = uu____6757;
             FStar_Extraction_ML_Syntax.loc = uu____6758;_},
           arg::[])
          when
          ...
          let uu____6768 =
            ...
            let uu____6774 = translate_type env t in (uu____6773, uu____6774) in
          ECast uu____6768
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6777;_},
                uu____6778);
             FStar_Extraction_ML_Syntax.mlty = uu____6779;
             FStar_Extraction_ML_Syntax.loc = uu____6780;_},
           uu____6781)
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6796;_},
                uu____6797);
             FStar_Extraction_ML_Syntax.mlty = uu____6798;
             FStar_Extraction_ML_Syntax.loc = uu____6799;_},
           arg::[])
          when
          ((let uu____6809 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               ...
               let print7 =
                 let uu____6829 =
                   let uu____6830 =
                     ...
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____6831 in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____6830 in
                 FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top uu____6829 in
               let print8 =
                 FStar_Extraction_ML_Syntax.with_ty
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (((let uu____6877 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             ...
             ||
             (let uu____6887 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6930;_},
                uu____6931);
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6992;_},
                uu____6993);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7022;_},
           e2::[])
          when
          ((let uu____7032 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu____7032 = "FStar.Buffer.createL") ||
             (let uu____7037 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7037 = "LowStar.Monotonic.Buffer.malloca_of_list"))
            ||
            (let uu____7042 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu____7077 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu____7077 = "LowStar.Monotonic.Buffer.mgcmalloc_of_list") ||
            (let uu____7082 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7103;_},
                uu____7104);
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7131;_},
                uu____7132);
             FStar_Extraction_ML_Syntax.mlty = uu____7133;
             FStar_Extraction_ML_Syntax.loc = uu____7134;_},
           _e0::e1::e2::[])
          when
          ((let uu____7146 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu____7146 = "FStar.Buffer.rcreate") ||
             (let uu____7151 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7151 = "LowStar.Monotonic.Buffer.mgcmalloc"))
            ||
            (let uu____7156 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7195;_},
                uu____7196);
             FStar_Extraction_ML_Syntax.mlty = uu____7197;
             FStar_Extraction_ML_Syntax.loc = uu____7198;_},
           _rid::init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7223;_},
                uu____7224);
             FStar_Extraction_ML_Syntax.mlty = uu____7225;
             FStar_Extraction_ML_Syntax.loc = uu____7226;_},
           _e0::e1::e2::[])
          when
          (((let uu____7238 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____7238 = "FStar.Buffer.rcreate_mm") ||
              (let uu____7243 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____7243 = "LowStar.Monotonic.Buffer.mmalloc"))
             ||
             (let uu____7248 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7268;_},
                uu____7269);
             FStar_Extraction_ML_Syntax.mlty = uu____7270;
             FStar_Extraction_ML_Syntax.loc = uu____7271;_},
           _erid::elen::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7292;_},
                uu____7293);
             FStar_Extraction_ML_Syntax.mlty = uu____7294;
             FStar_Extraction_ML_Syntax.loc = uu____7295;_},
           e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7310;_},
                uu____7311);
             FStar_Extraction_ML_Syntax.mlty = uu____7312;
             FStar_Extraction_ML_Syntax.loc = uu____7313;_},
           e2::[])
          when
          (let uu____7323 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
           uu____7323 = "FStar.Buffer.rfree") ||
            (let uu____7328 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7335;_},
                uu____7336);
             FStar_Extraction_ML_Syntax.mlty = uu____7337;
             FStar_Extraction_ML_Syntax.loc = uu____7338;_},
           e1::e2::_e3::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7361;_},
                uu____7362);
             FStar_Extraction_ML_Syntax.mlty = uu____7363;
             FStar_Extraction_ML_Syntax.loc = uu____7364;_},
           e1::e2::_e3::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7387;_},
                uu____7388);
             FStar_Extraction_ML_Syntax.mlty = uu____7389;
             FStar_Extraction_ML_Syntax.loc = uu____7390;_},
           e1::e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7405;_},
                uu____7406);
             FStar_Extraction_ML_Syntax.mlty = uu____7407;
             FStar_Extraction_ML_Syntax.loc = uu____7408;_},
           e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7433;_},
           e1::e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7455;_},
                uu____7456);
             FStar_Extraction_ML_Syntax.mlty = uu____7457;
             FStar_Extraction_ML_Syntax.loc = uu____7458;_},
           e1::e2::e3::[])
          when
          (((let uu____7470 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____7470 = "FStar.Buffer.upd") ||
              (let uu____7475 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               uu____7475 = "FStar.Buffer.op_Array_Assignment"))
             ||
             (let uu____7480 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7501;_},
                uu____7502);
             FStar_Extraction_ML_Syntax.mlty = uu____7503;
             FStar_Extraction_ML_Syntax.loc = uu____7504;_},
           e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7530;_},
           uu____7531::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7550;_},
                uu____7551);
             FStar_Extraction_ML_Syntax.mlty = uu____7552;
             FStar_Extraction_ML_Syntax.loc = uu____7553;_},
           e1::e2::e3::e4::e5::[])
          when
          ((let uu____7567 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            uu____7567 = "FStar.Buffer.blit") ||
             (let uu____7572 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
              uu____7572 = "LowStar.Monotonic.Buffer.blit"))
            ||
            (let uu____7577 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7602;_},
           e1::e2::e3::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7630;_},
           uu____7631::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7640;_},
                uu____7641);
             FStar_Extraction_ML_Syntax.mlty = uu____7642;
             FStar_Extraction_ML_Syntax.loc = uu____7643;_},
           _ebuf::_eseq::[])
          when
          (((let uu____7654 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
             uu____7654 = "LowStar.Monotonic.Buffer.witness_p") ||
              (let uu____7659 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            ||
            (let uu____7669 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7675;_},
           e1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7692;_},
           args)
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7712;_},
           args)
          when is_bool_op op ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7729;_},
           {
             ...
             FStar_Extraction_ML_Syntax.mlty = uu____7731;
             FStar_Extraction_ML_Syntax.loc = uu____7732;_}::[])
          when is_machine_int m ->
          let uu____7757 =
            let uu____7763 = FStar_Util.must (mk_width m) in (uu____7763, c) in
          ...
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7767;_},
           {
             FStar_Extraction_ML_Syntax.expr =
               ...
               (FStar_Extraction_ML_Syntax.MLC_Int
               (c, FStar_Pervasives_Native.None));
             FStar_Extraction_ML_Syntax.mlty = uu____7769;
             FStar_Extraction_ML_Syntax.loc = uu____7770;_}::[])
          when is_machine_int m ->
          let uu____7795 =
            let uu____7801 = FStar_Util.must (mk_width m) in (uu____7801, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7823;_},
           { FStar_Extraction_ML_Syntax.expr = e1;
             FStar_Extraction_ML_Syntax.mlty = uu____7825;
             FStar_Extraction_ML_Syntax.loc = uu____7826;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_String s) -> EString s
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7846;_},
           { FStar_Extraction_ML_Syntax.expr = e1;
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             FStar_Extraction_ML_Syntax.mlty = uu____7869;
             FStar_Extraction_ML_Syntax.loc = uu____7870;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7889;_},
           arg::[])
          ->
          let is_known_type =
          ...
          then
            let uu____7917 =
              let uu____7922 = translate_expr env arg in
              (uu____7922, (TInt UInt64)) in
            ECast uu____7917
          else
            if (FStar_Util.ends_with c "uint32") && is_known_type
            then
              (let uu____7927 =
                 let uu____7932 = translate_expr env arg in
                 (uu____7932, (TInt UInt32)) in
               ECast uu____7927)
            else
              if (FStar_Util.ends_with c "uint16") && is_known_type
              then
                (let uu____7937 =
                   let uu____7942 = translate_expr env arg in
                   (uu____7942, (TInt UInt16)) in
                 ECast uu____7937)
              else
                if (FStar_Util.ends_with c "uint8") && is_known_type
                then
                  (let uu____7947 =
                     let uu____7952 = translate_expr env arg in
                     (uu____7952, (TInt UInt8)) in
                   ECast uu____7947)
                else
                  if (FStar_Util.ends_with c "int64") && is_known_type
                  then
                    (let uu____7957 =
                       let uu____7962 = translate_expr env arg in
                       (uu____7962, (TInt Int64)) in
                     ECast uu____7957)
                  else
                    if (FStar_Util.ends_with c "int32") && is_known_type
                    then
                      (let uu____7967 =
                         let uu____7972 = translate_expr env arg in
                         (uu____7972, (TInt Int32)) in
                       ECast uu____7967)
                    else
                      ...
                      then
                        ...
                        then
                          (let uu____7987 =
                             ...
                             (uu____7992, (TInt Int8)) in
                           ECast uu____7987)
                        else
                          (let uu____7995 =
                             let uu____8002 =
                               let uu____8005 = translate_expr env arg in
                               [uu____8005] in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App (head1, args) ->
          let uu____8025 =
            let uu____8032 = translate_expr env head1 in
            let uu____8033 = FStar_List.map (translate_expr env) args in
            (uu____8032, uu____8033) in
          EApp uu____8025
      | FStar_Extraction_ML_Syntax.MLE_TApp (head1, ty_args) ->
          let uu____8044 =
            let uu____8051 = translate_expr env head1 in
            let uu____8052 = FStar_List.map (translate_type env) ty_args in
            (uu____8051, uu____8052) in
          ETypApp uu____8044
      | FStar_Extraction_ML_Syntax.MLE_Coerce (e1, t_from, t_to) ->
          let uu____8060 =
            let uu____8065 = translate_expr env e1 in
            let uu____8066 = translate_type env t_to in
            (uu____8065, uu____8066) in
          ECast uu____8060
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____8067, fields) ->
          let uu____8089 =
            let uu____8101 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
            let uu____8102 =
              FStar_List.map
                (fun uu____8124 ->
                   match uu____8124 with
                   | (field, expr) ->
                       let uu____8139 = translate_expr env expr in
                       (field, uu____8139)) fields in
            (uu____8101, uu____8102) in
          EFlat uu____8089
      | FStar_Extraction_ML_Syntax.MLE_Proj (e1, path) ->
          let uu____8150 =
            let uu____8158 =
              assert_lid env e1.FStar_Extraction_ML_Syntax.mlty in
            let uu____8159 = translate_expr env e1 in
            (uu____8158, uu____8159, (FStar_Pervasives_Native.snd path)) in
          EField uu____8150
      | FStar_Extraction_ML_Syntax.MLE_Let uu____8165 ->
          failwith "todo: translate_expr [MLE_Let]"
      | FStar_Extraction_ML_Syntax.MLE_App (head1, uu____8178) ->
          let uu____8183 =
            let uu____8185 =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Seq seqs ->
          let uu____8197 = FStar_List.map (translate_expr env) seqs in
          ESequence uu____8197
      | FStar_Extraction_ML_Syntax.MLE_Tuple es ->
          let uu____8203 = FStar_List.map (translate_expr env) es in
          ETuple uu____8203
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____8206, cons1), es) ->
          let uu____8221 =
            let uu____8231 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
            let uu____8232 = FStar_List.map (translate_expr env) es in
            (uu____8231, cons1, uu____8232) in
          ECons uu____8221
      | FStar_Extraction_ML_Syntax.MLE_Fun (args, body) ->
          let binders = translate_binders env args in
          let env1 = add_binders env args in
          let uu____8258 =
            let uu____8267 = translate_expr env1 body in
            let uu____8268 =
              translate_type env1 body.FStar_Extraction_ML_Syntax.mlty in
            (binders, uu____8267, uu____8268) in
          EFun uu____8258
      | FStar_Extraction_ML_Syntax.MLE_If (e1, e2, e3) ->
          let uu____8278 =
            let uu____8285 = translate_expr env e1 in
            let uu____8286 = translate_expr env e2 in
            let uu____8287 =
              match e3 with
              | FStar_Pervasives_Native.None -> EUnit
              | FStar_Pervasives_Native.Some e31 -> translate_expr env e31 in
            (uu____8285, uu____8286, uu____8287) in
          EIfThenElse uu____8278
      | FStar_Extraction_ML_Syntax.MLE_Raise uu____8289 ->
          failwith "todo: translate_expr [MLE_Raise]"
      | FStar_Extraction_ML_Syntax.MLE_Try uu____8297 ->
          failwith "todo: translate_expr [MLE_Try]"
      | FStar_Extraction_ML_Syntax.MLE_Coerce uu____8313 ->
  ...
  fun env ->
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (ts, lid) ->
          ...
          then
            let uu____8331 =
              let uu____8346 = FStar_List.map (translate_type env) ts in
              (lid, uu____8346) in
            TApp uu____8331
          else TQualified lid
      | uu____8361 ->
          let uu____8362 =
            let uu____8364 =
              FStar_Extraction_ML_Code.string_of_mlty ([], "") t in
            FStar_Util.format1
              "invalid argument: expected MLTY_Named, got %s" uu____8364 in
          failwith uu____8362
  ...
  fun env ->
    fun uu____8398 ->
      ...
      | (pat, guard, expr) ->
          ...
          then
            let uu____8425 = translate_pat env pat in
            (match uu____8425 with
             | (env1, pat1) ->
                 let uu____8436 = translate_expr env1 expr in
                 (pat1, uu____8436))
  ...
  fun env ->
    fun p ->
      ...
      | FStar_Extraction_ML_Syntax.MLP_Const
          ...
          let uu____8511 =
            let uu____8512 =
              let uu____8518 = translate_width sw in (uu____8518, s) in
            PConstant uu____8512 in
          (env, uu____8511)
      ...
      | FStar_Extraction_ML_Syntax.MLP_CTor ((uu____8528, cons1), ps) ->
          let uu____8543 =
            FStar_List.fold_left
              (fun uu____8563 ->
                 fun p1 ->
                   ...
                   | (env1, acc) ->
                       let uu____8583 = translate_pat env1 p1 in
                       (match uu____8583 with
                        | (env2, p2) -> (env2, (p2 :: acc)))) (env, []) ps in
          (match uu____8543 with
           | (env1, ps1) -> (env1, (PCons (cons1, (FStar_List.rev ps1)))))
      | FStar_Extraction_ML_Syntax.MLP_Record (uu____8613, ps) ->
          let uu____8635 =
            FStar_List.fold_left
              (fun uu____8672 ->
                 fun uu____8673 ->
                   match (uu____8672, uu____8673) with
                   | ((env1, acc), (field, p1)) ->
                       let uu____8753 = translate_pat env1 p1 in
            ...
            FStar_List.fold_left
              (fun uu____8844 ->
                 fun p1 ->
                   ...
                   | (env1, acc) ->
                       let uu____8864 = translate_pat env1 p1 in
                       (match uu____8864 with
                        | (env2, p2) -> (env2, (p2 :: acc)))) (env, []) ps in
          (match uu____8824 with
           | (env1, ps1) -> (env1, (PTuple (FStar_List.rev ps1))))
      | FStar_Extraction_ML_Syntax.MLP_Const uu____8891 ->
          failwith "todo: translate_pat [MLP_Const]"
      | FStar_Extraction_ML_Syntax.MLP_Branch uu____8897 ->
...
and (translate_constant : FStar_Extraction_ML_Syntax.mlconstant -> expr) =
  fun c ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_String s ->
        ((let uu____8911 =
            let uu____8913 = FStar_String.list_of_string s in
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s, FStar_Pervasives_Native.Some uu____8955) ->
        failwith
          "impossible: machine integer not desugared to a function call"
    | FStar_Extraction_ML_Syntax.MLC_Float uu____8973 ->
        failwith "todo: translate_expr [MLC_Float]"
    | FStar_Extraction_ML_Syntax.MLC_Bytes uu____8975 ->
  ...
  fun env ->
    fun w ->
      fun op ->
        fun args ->
          let uu____8999 =
            let uu____9006 = FStar_List.map (translate_expr env) args in
            ((EOp (op, w)), uu____9006) in
          EApp uu____8999