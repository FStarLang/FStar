...
let (uu___is_Stack : lifetime -> Prims.bool) =
  fun projectee  ->
    match projectee with | Stack  -> true | uu____1701 -> false
...
let (uu___is_EUnit : expr -> Prims.bool) =
  fun projectee  ->
    match projectee with | EUnit  -> true | uu____1836 -> false
...
let (uu___is_EAny : expr -> Prims.bool) =
  fun projectee  ->
    match projectee with | EAny  -> true | uu____2470 -> false
...
let (uu___is_AddW : op -> Prims.bool) =
  fun projectee  ->
    match projectee with | AddW  -> true | uu____2986 -> false
  
let (uu___is_Sub : op -> Prims.bool) =
  fun projectee  -> match projectee with | Sub  -> true | uu____2997 -> false 
let (uu___is_SubW : op -> Prims.bool) =
  fun projectee  ->
    match projectee with | SubW  -> true | uu____3008 -> false
  
let (uu___is_Div : op -> Prims.bool) =
  fun projectee  -> match projectee with | Div  -> true | uu____3019 -> false 
let (uu___is_DivW : op -> Prims.bool) =
  fun projectee  ->
    match projectee with | DivW  -> true | uu____3030 -> false
  
let (uu___is_Mult : op -> Prims.bool) =
  fun projectee  ->
    match projectee with | Mult  -> true | uu____3041 -> false
  
let (uu___is_MultW : op -> Prims.bool) =
  fun projectee  ->
    match projectee with | MultW  -> true | uu____3052 -> false
...
let (uu___is_BAnd : op -> Prims.bool) =
  fun projectee  ->
    match projectee with | BAnd  -> true | uu____3085 -> false
  
let (uu___is_BXor : op -> Prims.bool) =
  fun projectee  ->
    match projectee with | BXor  -> true | uu____3096 -> false
...
let (uu___is_BNot : op -> Prims.bool) =
  fun projectee  ->
    match projectee with | BNot  -> true | uu____3129 -> false
...
let (uu___is_PUnit : pattern -> Prims.bool) =
  fun projectee  ->
    match projectee with | PUnit  -> true | uu____3250 -> false
...
let (uu___is_UInt8 : width -> Prims.bool) =
  fun projectee  ->
    match projectee with | UInt8  -> true | uu____3463 -> false
...
let (uu___is_Int8 : width -> Prims.bool) =
  fun projectee  ->
    match projectee with | Int8  -> true | uu____3507 -> false
  
let (uu___is_Int16 : width -> Prims.bool) =
  fun projectee  ->
    match projectee with | Int16  -> true | uu____3518 -> false
  
let (uu___is_Int32 : width -> Prims.bool) =
  fun projectee  ->
    match projectee with | Int32  -> true | uu____3529 -> false
  
let (uu___is_Int64 : width -> Prims.bool) =
  fun projectee  ->
    match projectee with | Int64  -> true | uu____3540 -> false
  
let (uu___is_Bool : width -> Prims.bool) =
  fun projectee  ->
    match projectee with | Bool  -> true | uu____3551 -> false
  
let (uu___is_CInt : width -> Prims.bool) =
  fun projectee  ->
    match projectee with | CInt  -> true | uu____3562 -> false
...
let (uu___is_TUnit : typ -> Prims.bool) =
  fun projectee  ->
    match projectee with | TUnit  -> true | uu____3648 -> false
...
let (uu___is_TBool : typ -> Prims.bool) =
  fun projectee  ->
    match projectee with | TBool  -> true | uu____3710 -> false
  
let (uu___is_TAny : typ -> Prims.bool) =
  fun projectee  ->
    match projectee with | TAny  -> true | uu____3721 -> false
    ...
    let uu____4920 =
      FStar_List.choose
        (fun uu___4_4927  ->
           ...
           | uu____4934 -> FStar_Pervasives_Native.None) flags
       in
            ...
            ((let uu____5397 =
                let uu____5403 =
                  FStar_Util.format1 "Not extracting %s to KreMLin\n" name
                   in
                (FStar_Errors.Warning_DefinitionNotTranslated, uu____5403)
                 in
      ...
      | (uu____5427,uu____5428,uu____5429,uu____5430,flags,uu____5432) ->
          ...
          then FStar_Pervasives_Native.None
            ...
            (match ty with
             ...
             | (uu____5543,name,_mangled_name,args,flags1,FStar_Pervasives_Native.Some
             ...
             | (uu____5715,name,_mangled_name,args,flags1,FStar_Pervasives_Native.Some
                                  ...
                                  FStar_List.map
                                    (fun uu____5938  ->
                                       ...
                                       | (name2,t) ->
                                           ...
                                           (name2, uu____5958)) ts
                                   in
                                (cons1, uu____5906)) branches
                        in
                     (name1, flags2, (FStar_List.length args), uu____5805)
                      in
                   DTypeVariant uu____5766  in
                 FStar_Pervasives_Native.Some uu____5765
             | (uu____6017,name,_mangled_name,uu____6020,uu____6021,uu____6022)
                 ->
                 ((let uu____6038 =
                     let uu____6044 =
                       FStar_Util.format1
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named
          ...
          (((let uu____6122 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
             uu____6122 = "FStar.Monotonic.HyperStack.s_mref") ||
              (let uu____6127 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                  in
               uu____6127 = "FStar.Monotonic.HyperHeap.mrref"))
             ||
             (let uu____6132 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
              uu____6132 = "FStar.HyperStack.ST.m_rref"))
            ||
            (let uu____6137 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::uu____6143::[],p) when
          ((((((((((let uu____6149 =
              ...
              ||
              (let uu____6189 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                  in
               uu____6189 = "FStar.HyperStack.ST.mref"))
             ||
             (let uu____6194 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
              uu____6194 = "FStar.HyperStack.ST.mmmstackref"))
            ||
            (let uu____6199 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[],p) when
          (((((((((((((let uu____6221 =
              ...
              ||
              (let uu____6276 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                  in
               uu____6276 = "FStar.HyperStack.ST.ref"))
             ||
             (let uu____6281 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
              uu____6281 = "FStar.HyperStack.ST.mmstackref"))
            ||
            (let uu____6286 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (uu____6291::arg::[],p) when
          (let uu____6298 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____6298 = "FStar.HyperStack.s_ref") ||
            (let uu____6303 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
    ...
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6555;_},t::[]);
             FStar_Extraction_ML_Syntax.mlty = uu____6557;
             FStar_Extraction_ML_Syntax.loc = uu____6558;_},arg::[])
          when
          ...
          let uu____6568 =
            ...
            let uu____6574 = translate_type env t  in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6577;_},uu____6578);
             FStar_Extraction_ML_Syntax.mlty = uu____6579;
             FStar_Extraction_ML_Syntax.loc = uu____6580;_},uu____6581)
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6596;_},uu____6597);
             FStar_Extraction_ML_Syntax.mlty = uu____6598;
             FStar_Extraction_ML_Syntax.loc = uu____6599;_},arg::[])
          when
          ((let uu____6609 = FStar_Extraction_ML_Syntax.string_of_mlpath p
               in
            uu____6609 = "FStar.HyperStack.All.failwith") ||
             (let uu____6614 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
              uu____6614 = "FStar.Error.unexpected"))
            ||
            (let uu____6619 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
                   ...
                   let uu____6630 =
                     let uu____6631 =
                       FStar_Ident.lid_of_str
                        ...
                        in
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____6631
                      in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____6630  in
                 FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top uu____6629
                  in
               let print8 =
                 FStar_Extraction_ML_Syntax.with_ty
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6642;_},e1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6666;_},e1::e2::[])
          when
          (((let uu____6677 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
             uu____6677 = "FStar.Buffer.index") ||
              (let uu____6682 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                  in
               uu____6682 = "FStar.Buffer.op_Array_Access"))
             ||
             (let uu____6687 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
              uu____6687 = "LowStar.Monotonic.Buffer.index"))
            ||
            (let uu____6692 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6708;_},e1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6730;_},uu____6731);
             FStar_Extraction_ML_Syntax.mlty = uu____6732;
             FStar_Extraction_ML_Syntax.loc = uu____6733;_},e1::e2::[])
          when
          ((let uu____6744 = FStar_Extraction_ML_Syntax.string_of_mlpath p
               in
            uu____6744 = "FStar.Buffer.create") ||
             (let uu____6749 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
              uu____6749 = "LowStar.Monotonic.Buffer.malloca"))
            ||
            (let uu____6754 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6792;_},uu____6793);
             FStar_Extraction_ML_Syntax.mlty = uu____6794;
             FStar_Extraction_ML_Syntax.loc = uu____6795;_},init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____6819;_},uu____6820);
             FStar_Extraction_ML_Syntax.mlty = uu____6821;
             FStar_Extraction_ML_Syntax.loc = uu____6822;_},e2::[])
          when
          ((let uu____6832 = FStar_Extraction_ML_Syntax.string_of_mlpath p
               in
            uu____6832 = "FStar.Buffer.createL") ||
             (let uu____6837 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6866;_},_erid::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6906;_},_rid::init1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6934;_},_e0::e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6974;_},_erid::elen::[])
          when
          let uu____6983 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____6983 = "LowStar.UninitializedBuffer.ugcmalloc" ->
          let uu____6987 =
            let uu____6992 = translate_expr env elen  in
            (Eternal, uu____6992)  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____6998;_},_rid::init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7023;_},uu____7024);
             FStar_Extraction_ML_Syntax.mlty = uu____7025;
             FStar_Extraction_ML_Syntax.loc = uu____7026;_},_e0::e1::e2::[])
          when
          (((let uu____7038 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
             uu____7038 = "FStar.Buffer.rcreate_mm") ||
              (let uu____7043 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                  in
               uu____7043 = "LowStar.Monotonic.Buffer.mmalloc"))
             ||
             (let uu____7048 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7068;_},uu____7069);
             FStar_Extraction_ML_Syntax.mlty = uu____7070;
             FStar_Extraction_ML_Syntax.loc = uu____7071;_},_erid::elen::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7092;_},uu____7093);
             FStar_Extraction_ML_Syntax.mlty = uu____7094;
             FStar_Extraction_ML_Syntax.loc = uu____7095;_},e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7110;_},uu____7111);
             FStar_Extraction_ML_Syntax.mlty = uu____7112;
             FStar_Extraction_ML_Syntax.loc = uu____7113;_},e2::[])
          when
          (let uu____7123 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____7123 = "FStar.Buffer.rfree") ||
            (let uu____7128 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7138;_},e1::e2::_e3::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7161;_},uu____7162);
             FStar_Extraction_ML_Syntax.mlty = uu____7163;
             FStar_Extraction_ML_Syntax.loc = uu____7164;_},e1::e2::_e3::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7190;_},e1::e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7205;_},uu____7206);
             FStar_Extraction_ML_Syntax.mlty = uu____7207;
             FStar_Extraction_ML_Syntax.loc = uu____7208;_},e1::e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7255;_},uu____7256);
             FStar_Extraction_ML_Syntax.mlty = uu____7257;
             FStar_Extraction_ML_Syntax.loc = uu____7258;_},e1::e2::e3::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7301;_},uu____7302);
             FStar_Extraction_ML_Syntax.mlty = uu____7303;
             FStar_Extraction_ML_Syntax.loc = uu____7304;_},e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____7350;_},uu____7351);
             FStar_Extraction_ML_Syntax.mlty = uu____7352;
             FStar_Extraction_ML_Syntax.loc = uu____7353;_},e1::e2::e3::e4::e5::[])
          when
          ((let uu____7367 = FStar_Extraction_ML_Syntax.string_of_mlpath p
            ...
            ||
            (let uu____7377 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7402;_},e1::e2::e3::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7443;_},_ebuf::_eseq::[])
          when
          (((let uu____7454 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
             uu____7454 = "LowStar.Monotonic.Buffer.witness_p") ||
              (let uu____7459 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                  in
               uu____7459 = "LowStar.Monotonic.Buffer.recall_p"))
             ||
             (let uu____7464 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
              uu____7464 = "LowStar.ImmutableBuffer.witness_contents"))
            ||
            (let uu____7469 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7475;_},e1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7492;_},args)
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7512;_},args)
          when is_bool_op op ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____7557 =
            let uu____7563 = FStar_Util.must (mk_width m)  in (uu____7563, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____7595 =
            let uu____7601 = FStar_Util.must (mk_width m)  in (uu____7601, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7689;_},arg::[])
          ->
          let is_known_type =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____7867,fields) ->
          let uu____7889 =
            let uu____7901 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
            let uu____7902 =
              FStar_List.map
                (fun uu____7924  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____8006,cons1),es) ->
          let uu____8021 =
            let uu____8031 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
