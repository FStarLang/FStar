...
let (extend : env -> Prims.string -> env) =
  fun env  ->
    fun x  ->
      let uu___281_3270 = env  in
      {
        names = ({ pretty = x } :: (env.names));
        names_t = (uu___281_3270.names_t);
        module_name = (uu___281_3270.module_name)
      }
  
let (extend_t : env -> Prims.string -> env) =
  fun env  ->
    fun x  ->
      let uu___282_3281 = env  in
      {
        names = (uu___282_3281.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___282_3281.module_name)
      }
              ...
              (let assumed =
               ...
               let env2 =
                 FStar_List.fold_left
                   ...
                   tvars
                  in
               let rec find_return_type eff i uu___279_3894 =
                 match uu___279_3894 with
              ...
              (let assumed =
               ...
               let env2 =
                 FStar_List.fold_left
                   ...
                   tvars
                  in
               let rec find_return_type eff i uu___279_4099 =
                 match uu___279_4099 with
