    ...
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          ((let uu____7939 = FStar_Extraction_ML_Syntax.string_of_mlpath p
            ...
            uu____7939 = "LowStar.ConstBuffer.cast") ||
             (let uu____7944 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                 in
              uu____7944 = "LowStar.ConstBuffer.to_buffer"))
            ||
            (let uu____7949 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7963;_},e1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____7980;_},args)
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____8000;_},args)
          when is_bool_op op ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____8045 =
            let uu____8051 = FStar_Util.must (mk_width m)  in (uu____8051, c)
             in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____8083 =
            let uu____8089 = FStar_Util.must (mk_width m)  in (uu____8089, c)
             in
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____8156;_},uu____8157);
           ...
           { FStar_Extraction_ML_Syntax.expr = eafter;
             FStar_Extraction_ML_Syntax.mlty = uu____8165;
             FStar_Extraction_ML_Syntax.loc = uu____8166;_}::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____8256;_},arg::[])
          ->
          let is_known_type =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____8434,fields) ->
          let uu____8456 =
            let uu____8468 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
            let uu____8469 =
              FStar_List.map
                (fun uu____8491  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____8573,cons1),es) ->
          let uu____8588 =
            let uu____8598 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
      ...
      | uu____8728 ->
          let uu____8729 =
            let uu____8731 =
              FStar_Extraction_ML_Code.string_of_mlty ([], "") t  in
            FStar_Util.format1
              "invalid argument: expected MLTY_Named, got %s" uu____8731
             in
          failwith uu____8729
