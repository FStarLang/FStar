...
let (uu___is_CDecl : cc -> Prims.bool) =
  fun projectee -> match projectee with | CDecl -> true | uu____1231 -> false
...
let (uu___is_Stack : lifetime -> Prims.bool) =
  fun projectee -> match projectee with | Stack -> true | uu____1341 -> false
...
let (uu___is_EUnit : expr -> Prims.bool) =
  fun projectee -> match projectee with | EUnit -> true | uu____1435 -> false
...
let (uu___is_EAny : expr -> Prims.bool) =
  fun projectee -> match projectee with | EAny -> true | uu____1975 -> false
...
let (uu___is_AddW : op -> Prims.bool) =
  fun projectee -> match projectee with | AddW -> true | uu____2361 -> false
let (uu___is_Sub : op -> Prims.bool) =
  fun projectee -> match projectee with | Sub -> true | uu____2367 -> false
let (uu___is_SubW : op -> Prims.bool) =
  fun projectee -> match projectee with | SubW -> true | uu____2373 -> false
let (uu___is_Div : op -> Prims.bool) =
  fun projectee -> match projectee with | Div -> true | uu____2379 -> false
let (uu___is_DivW : op -> Prims.bool) =
  fun projectee -> match projectee with | DivW -> true | uu____2385 -> false
let (uu___is_Mult : op -> Prims.bool) =
  fun projectee -> match projectee with | Mult -> true | uu____2391 -> false
let (uu___is_MultW : op -> Prims.bool) =
  fun projectee -> match projectee with | MultW -> true | uu____2397 -> false
...
let (uu___is_BAnd : op -> Prims.bool) =
  fun projectee -> match projectee with | BAnd -> true | uu____2415 -> false
let (uu___is_BXor : op -> Prims.bool) =
  fun projectee -> match projectee with | BXor -> true | uu____2421 -> false
...
let (uu___is_BNot : op -> Prims.bool) =
  fun projectee -> match projectee with | BNot -> true | uu____2439 -> false
...
let (uu___is_PUnit : pattern -> Prims.bool) =
  fun projectee -> match projectee with | PUnit -> true | uu____2505 -> false
...
let (uu___is_UInt8 : width -> Prims.bool) =
  fun projectee -> match projectee with | UInt8 -> true | uu____2667 -> false
...
let (uu___is_Int8 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int8 -> true | uu____2691 -> false
let (uu___is_Int16 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int16 -> true | uu____2697 -> false
let (uu___is_Int32 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int32 -> true | uu____2703 -> false
let (uu___is_Int64 : width -> Prims.bool) =
  fun projectee -> match projectee with | Int64 -> true | uu____2709 -> false
let (uu___is_Bool : width -> Prims.bool) =
  fun projectee -> match projectee with | Bool -> true | uu____2715 -> false
let (uu___is_CInt : width -> Prims.bool) =
  fun projectee -> match projectee with | CInt -> true | uu____2721 -> false
...
let (uu___is_TUnit : typ -> Prims.bool) =
  fun projectee -> match projectee with | TUnit -> true | uu____2769 -> false
...
let (uu___is_TBool : typ -> Prims.bool) =
  fun projectee -> match projectee with | TBool -> true | uu____2813 -> false
let (uu___is_TAny : typ -> Prims.bool) =
  fun projectee -> match projectee with | TAny -> true | uu____2819 -> false
...
let (extend : env -> Prims.string -> env) =
  fun env ->
    fun x ->
      let uu___45_3255 = env in
      {
        names = ({ pretty = x } :: (env.names));
        names_t = (uu___45_3255.names_t);
        module_name = (uu___45_3255.module_name)
      }
let (extend_t : env -> Prims.string -> env) =
  fun env ->
    fun x ->
      let uu___46_3266 = env in
      {
        names = (uu___46_3266.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___46_3266.module_name)
      }
      ...
      fun lb ->
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name;
            ...
            then FStar_Pervasives_Native.None
              ...
              (let assumed =
                 FStar_Util.for_some
                   (fun uu___42_3802 ->
                      match uu___42_3802 with
                      | FStar_Extraction_ML_Syntax.Assumed -> true
                      | uu____3803 -> false) meta in
               let env1 =
               ...
               let rec find_return_type eff i uu___43_3830 =
                 match uu___43_3830 with
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name;
            ...
            FStar_Extraction_ML_Syntax.mllb_def =
              {
                FStar_Extraction_ML_Syntax.expr =
                  ...
                  ({
                     ...
                     FStar_Extraction_ML_Syntax.loc = uu____3980;_},
            ...
            then FStar_Pervasives_Native.None
              ...
              (let assumed =
                 FStar_Util.for_some
                   (fun uu___42_4008 ->
                      match uu___42_4008 with
                      | FStar_Extraction_ML_Syntax.Assumed -> true
                      | uu____4009 -> false) meta in
               let env1 =
                 if flavor = FStar_Extraction_ML_Syntax.Rec
                 then extend env name
                 else env in
               let env2 =
                 FStar_List.fold_left
                   (fun env2 -> fun name1 -> extend_t env2 name1) env1 tvars in
               let rec find_return_type eff i uu___43_4036 =
                 match uu___43_4036 with
        ...
        | { FStar_Extraction_ML_Syntax.mllb_name = name;
            ...
            ((let uu____4260 =
                ...
                (FStar_Errors.Warning_DefinitionNotTranslated, uu____4265) in
          ...
          then
            ...
            (let uu____4311 =
               let uu____4312 =
                 ...
                 (name1, uu____4329, (FStar_List.length args), uu____4332) in
               DTypeAlias uu____4312 in
             FStar_Pervasives_Native.Some uu____4311)
      | (uu____4341, name, _mangled_name, args, flags1,
                         ...
                         let uu____4629 =
                           FStar_List.map
                             (fun uu____4656 ->
                                ...
                                | (name2, t) ->
                                    let uu____4671 =
                                      let uu____4676 = translate_type env1 t in
                                      (uu____4676, false) in
                                    (name2, uu____4671)) ts in
                         (cons1, uu____4629)) branches in
  ...
  fun env ->
    fun t ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named
          ...
          (((let uu____4795 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[], p) when
          ((((((((((let uu____4838 =
             ...
             ||
             (let uu____4856 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
    ...
    fun e ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          let uu____5082 =
            ...
            let uu____5088 = translate_type env t in (uu____5087, uu____5088) in
          ECast uu____5082
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5091;_},
                uu____5092);
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5107;_},
                uu____5108);
             FStar_Extraction_ML_Syntax.mlty = uu____5109;
             FStar_Extraction_ML_Syntax.loc = uu____5110;_},
           arg::[])
          when
          ((let uu____5120 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
            ...
            ||
            (let uu____5124 = FStar_Extraction_ML_Syntax.string_of_mlpath p in
               ...
               let print7 =
                 let uu____5130 =
                   let uu____5131 =
                     ...
                     FStar_Extraction_ML_Syntax.mlpath_of_lident uu____5132 in
                   FStar_Extraction_ML_Syntax.MLE_Name uu____5131 in
                 FStar_Extraction_ML_Syntax.with_ty
                   FStar_Extraction_ML_Syntax.MLTY_Top uu____5130 in
               let print8 =
                 FStar_Extraction_ML_Syntax.with_ty
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5139;_},
                uu____5140);
             FStar_Extraction_ML_Syntax.mlty = uu____5141;
             FStar_Extraction_ML_Syntax.loc = uu____5142;_},
           e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5168;_},
           e1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5188;_},
           e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5212;_},
           init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5231;_},
                uu____5232);
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5311;_},
                uu____5312);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5362;_},
           _rid::init1::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5382;_},
                uu____5383);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5425;_},
           e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5440;_},
           e1::e2::_e3::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5460;_},
                uu____5461);
             FStar_Extraction_ML_Syntax.mlty = uu____5462;
             FStar_Extraction_ML_Syntax.loc = uu____5463;_},
           e1::e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5475;_},
                uu____5476);
             FStar_Extraction_ML_Syntax.mlty = uu____5477;
             FStar_Extraction_ML_Syntax.loc = uu____5478;_},
           e1::e2::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5497;_},
                uu____5498);
             FStar_Extraction_ML_Syntax.mlty = uu____5499;
             FStar_Extraction_ML_Syntax.loc = uu____5500;_},
           e1::e2::e3::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5527;_},
                uu____5528);
             FStar_Extraction_ML_Syntax.mlty = uu____5529;
             FStar_Extraction_ML_Syntax.loc = uu____5530;_},
           e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5558;_},
           uu____5559::[])
          when
          ...
          ({
             FStar_Extraction_ML_Syntax.expr =
               ...
               ({
                  ...
                  FStar_Extraction_ML_Syntax.loc = uu____5565;_},
                uu____5566);
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5602;_},
           e1::e2::e3::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5625;_},
           uu____5626::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5632;_},
           e1::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5646;_},
           args)
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____5687 =
            let uu____5692 = FStar_Util.must (mk_width m) in (uu____5692, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          when is_machine_int m ->
          let uu____5713 =
            let uu____5718 = FStar_Util.must (mk_width m) in (uu____5718, c) in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5723;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
           ...
           { FStar_Extraction_ML_Syntax.expr = e1;
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5734;_}::[])
          ->
          (match e1 with
           | FStar_Extraction_ML_Syntax.MLE_Const
               (FStar_Extraction_ML_Syntax.MLC_String s) -> EString s
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5743;_},
           arg::[])
          ->
          let is_known_type =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____5869, fields) ->
          let uu____5887 =
            let uu____5898 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
            let uu____5899 =
              FStar_List.map
                (fun uu____5918 ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____5982, cons1), es) ->
          let uu____5999 =
            let uu____6008 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty in
