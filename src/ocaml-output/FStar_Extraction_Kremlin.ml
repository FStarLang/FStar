...
let extend: env -> Prims.string -> Prims.bool -> env =
  fun env  ->
    fun x  ->
      fun is_mut  ->
        let uu___132_1809 = env in
        {
          names = ({ pretty = x; mut = is_mut } :: (env.names));
          names_t = (uu___132_1809.names_t);
          module_name = (uu___132_1809.module_name)
        }
let extend_t: env -> Prims.string -> env =
  fun env  ->
    fun x  ->
      let uu___133_1816 = env in
      {
        names = (uu___133_1816.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___133_1816.module_name)
      }
    ...
    fun d  ->
      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
        ...
        (flavor,flags,{ FStar_Extraction_ML_Syntax.mllb_name = (name,_);
          ...
          let rec find_return_type uu___130_2158 =
            match uu___130_2158 with
