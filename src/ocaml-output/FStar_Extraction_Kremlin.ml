...
let extend : env -> Prims.string -> Prims.bool -> env =
  fun env  ->
    fun x  ->
      fun is_mut  ->
        let uu___127_2879 = env  in
        {
          names = ({ pretty = x; mut = is_mut } :: (env.names));
          names_t = (uu___127_2879.names_t);
          module_name = (uu___127_2879.module_name)
        }
  
let extend_t : env -> Prims.string -> env =
  fun env  ->
    fun x  ->
      let uu___128_2888 = env  in
      {
        names = (uu___128_2888.names);
        names_t = (x :: (env.names_t));
        module_name = (uu___128_2888.module_name)
      }
      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
          ...
          let env2 =
            FStar_List.fold_left
             ...
             in
          let rec find_return_type i uu___125_3412 =
            match uu___125_3412 with
      ...
      | FStar_Extraction_ML_Syntax.MLM_Let
          ...
          let env2 =
            FStar_List.fold_left
             ...
             in
          let rec find_return_type i uu___125_3579 =
            match uu___125_3579 with
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (arg::[],p) when
          ...
          uu____4447 = "FStar.Buffer.buffer" ->
...
and translate_binder :
  ...
  fun env  ->
    fun uu____4538  ->
      ...
      | ((name,uu____4544),typ) ->
          let uu____4550 = translate_type env typ  in
          { name; typ = uu____4550; mut = false }
...
and translate_expr : env -> FStar_Extraction_ML_Syntax.mlexpr -> expr =
  fun env  ->
    fun e  ->
      ...
      | FStar_Extraction_ML_Syntax.MLE_Var (name,uu____4555) ->
          let uu____4556 = find env name  in EBound uu____4556
      | FStar_Extraction_ML_Syntax.MLE_Name ("FStar"::m::[],op) when
          (is_machine_int m) && (is_op op) ->
          let uu____4561 =
            let uu____4566 = FStar_Util.must (mk_op op)  in
            let uu____4567 = FStar_Util.must (mk_width m)  in
            (uu____4566, uu____4567)  in
          EOp uu____4561
      | FStar_Extraction_ML_Syntax.MLE_Name ("Prims"::[],op) when
          is_bool_op op ->
          let uu____4571 =
            let uu____4576 = FStar_Util.must (mk_bool_op op)  in
            (uu____4576, Bool)  in
          EOp uu____4571
            ...
            then
              let uu____4618 =
                ...
                | FStar_Extraction_ML_Syntax.MLTY_Named (t::[],p) when
                    ...
                    uu____4623 = "FStar.ST.stackref" -> t
                | uu____4624 ->
                    let uu____4625 =
                      let uu____4626 =
              ...
              let uu____4629 =
                ...
                | {
                    ...
                    FStar_Extraction_ML_Syntax.loc = uu____4633;_} -> body1
                | uu____4636 ->
                    failwith "unexpected: bad desugaring of Mutable"
                 in
              (uu____4618, uu____4629)
            else (typ, body)  in
          (match uu____4609 with
           | (typ1,body1) ->
               let binder =
                 let uu____4641 = translate_type env typ1  in
                 { name; typ = uu____4641; mut = is_mut }  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Match (expr,branches) ->
          let uu____4667 =
            let uu____4678 = translate_expr env expr  in
            let uu____4679 = translate_branches env branches  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4728;_},e1::e2::[])
          when
          (let uu____4735 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____4735 = "FStar.Buffer.index") ||
            (let uu____4737 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
             uu____4737 = "FStar.Buffer.op_Array_Access")
          ->
          let uu____4738 =
            let uu____4743 = translate_expr env e1  in
            let uu____4744 = translate_expr env e2  in
            (uu____4743, uu____4744)  in
          EBufRead uu____4738
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4747;_},e1::e2::[])
          when
          let uu____4752 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4752 = "FStar.Buffer.create" ->
          let uu____4753 =
            let uu____4760 = translate_expr env e1  in
            let uu____4761 = translate_expr env e2  in
            (Stack, uu____4760, uu____4761)  in
          EBufCreate uu____4753
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____4763;
             FStar_Extraction_ML_Syntax.loc = uu____4764;_},_e0::e1::e2::[])
          when
          let uu____4770 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4770 = "FStar.Buffer.rcreate" ->
          let uu____4771 =
            let uu____4778 = translate_expr env e1  in
            let uu____4779 = translate_expr env e2  in
            (Eternal, uu____4778, uu____4779)  in
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4782;_},e2::[])
          when
          let uu____4786 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4786 = "FStar.Buffer.createL" ->
          ...
          let uu____4832 =
            let uu____4839 =
              let uu____4842 = list_elements2 e2  in
              FStar_List.map (translate_expr env) uu____4842  in
            (Stack, uu____4839)  in
          EBufCreateL uu____4832
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____4848;
             FStar_Extraction_ML_Syntax.loc = uu____4849;_},e1::e2::_e3::[])
          when
          let uu____4855 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4855 = "FStar.Buffer.sub" ->
          let uu____4856 =
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4865;_},e1::e2::[])
          when
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4873;_},e1::e2::[])
          when
          let uu____4878 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4878 = "FStar.Buffer.offset" ->
          let uu____4879 =
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          (let uu____4896 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
           uu____4896 = "FStar.Buffer.upd") ||
            (let uu____4898 = FStar_Extraction_ML_Syntax.string_of_mlpath p
                in
             uu____4898 = "FStar.Buffer.op_Array_Assignment")
          ->
          let uu____4899 =
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ...
          uu____4915 = "FStar.HyperStack.ST.push_frame" -> EPushFrame
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
          ...
          uu____4922 = "FStar.HyperStack.ST.pop_frame" -> EPopFrame
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____4924;
             FStar_Extraction_ML_Syntax.loc = uu____4925;_},e1::e2::e3::e4::e5::[])
          when
          let uu____4933 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4933 = "FStar.Buffer.blit" ->
          let uu____4934 =
            let uu____4945 = translate_expr env e1  in
            let uu____4946 = translate_expr env e2  in
            let uu____4947 = translate_expr env e3  in
            let uu____4948 = translate_expr env e4  in
            let uu____4949 = translate_expr env e5  in
            (uu____4945, uu____4946, uu____4947, uu____4948, uu____4949)  in
          EBufBlit uu____4934
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____4971;_},uu____4972::[])
          when
          let uu____4975 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4975 = "FStar.HyperStack.ST.get" -> EUnit
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name p;
             FStar_Extraction_ML_Syntax.mlty = uu____4977;
             FStar_Extraction_ML_Syntax.loc = uu____4978;_},e1::[])
          when
          let uu____4982 = FStar_Extraction_ML_Syntax.string_of_mlpath p  in
          uu____4982 = "Obj.repr" ->
          let uu____4983 =
            let uu____4988 = translate_expr env e1  in (uu____4988, TAny)  in
          ECast uu____4983
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
          ...
          let uu____5000 = FStar_Util.must (mk_width m)  in
          let uu____5001 = FStar_Util.must (mk_op op)  in
          mk_op_app env uu____5000 uu____5001 args
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name ("Prims"::[],op);
             FStar_Extraction_ML_Syntax.mlty = uu____5003;
             FStar_Extraction_ML_Syntax.loc = uu____5004;_},args)
          when is_bool_op op ->
          let uu____5012 = FStar_Util.must (mk_bool_op op)  in
          mk_op_app env Bool uu____5012 args
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5015;_},{
                                                              FStar_Extraction_ML_Syntax.expr
                                                                =
          ...
          let uu____5033 =
            let uu____5038 = FStar_Util.must (mk_width m)  in (uu____5038, c)
             in
          EConstant uu____5033
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5041;_},{
                                                              FStar_Extraction_ML_Syntax.expr
                                                                =
                                                                FStar_Extraction_ML_Syntax.MLE_Const
                                                                (FStar_Extraction_ML_Syntax.MLC_Int
          ...
          when is_machine_int m ->
          let uu____5059 =
            let uu____5064 = FStar_Util.must (mk_width m)  in (uu____5064, c)
             in
          EConstant uu____5059
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Name
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5066;_},{
                                                              FStar_Extraction_ML_Syntax.expr
                                                                = e1;
                                                              FStar_Extraction_ML_Syntax.mlty
                                                                = uu____5068;
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5078;_},arg::[])
          ->
          let is_known_type =
          ...
          then
            let uu____5085 =
              ...
              (uu____5090, (TInt UInt64))  in
            ECast uu____5085
          else
            if (FStar_Util.ends_with c "uint32") && is_known_type
            then
              (let uu____5092 =
                 let uu____5097 = translate_expr env arg  in
                 (uu____5097, (TInt UInt32))  in
               ECast uu____5092)
            else
              if (FStar_Util.ends_with c "uint16") && is_known_type
              then
                (let uu____5099 =
                   let uu____5104 = translate_expr env arg  in
                   (uu____5104, (TInt UInt16))  in
                 ECast uu____5099)
              else
                ...
                then
                  (let uu____5106 =
                     ...
                     (uu____5111, (TInt UInt8))  in
                   ECast uu____5106)
                else
                  if (FStar_Util.ends_with c "int64") && is_known_type
                  then
                    (let uu____5113 =
                       let uu____5118 = translate_expr env arg  in
                       (uu____5118, (TInt Int64))  in
                     ECast uu____5113)
                  else
                    if (FStar_Util.ends_with c "int32") && is_known_type
                    then
                      (let uu____5120 =
                         let uu____5125 = translate_expr env arg  in
                         (uu____5125, (TInt Int32))  in
                       ECast uu____5120)
                    else
      ...
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             ...
             FStar_Extraction_ML_Syntax.loc = uu____5159;_},args)
          ->
          let uu____5169 =
            let uu____5176 = FStar_List.map (translate_expr env) args  in
            ((EQualified (path, function_name)), uu____5176)  in
          EApp uu____5169
      | FStar_Extraction_ML_Syntax.MLE_App
          ({
             FStar_Extraction_ML_Syntax.expr =
               FStar_Extraction_ML_Syntax.MLE_Var (name,uu____5184);
             FStar_Extraction_ML_Syntax.mlty = uu____5185;
             FStar_Extraction_ML_Syntax.loc = uu____5186;_},args)
          ->
          let uu____5192 =
            let uu____5199 =
              let uu____5200 = find env name  in EBound uu____5200  in
            let uu____5201 = FStar_List.map (translate_expr env) args  in
            (uu____5199, uu____5201)  in
          EApp uu____5192
      | FStar_Extraction_ML_Syntax.MLE_Coerce (e1,t_from,t_to) ->
          let uu____5209 =
            let uu____5214 = translate_expr env e1  in
            let uu____5215 = translate_type env t_to  in
            (uu____5214, uu____5215)  in
          ECast uu____5209
      | FStar_Extraction_ML_Syntax.MLE_Record (uu____5216,fields) ->
          let uu____5234 =
            let uu____5245 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
            let uu____5246 =
              FStar_List.map
                (fun uu____5265  ->
                   ...
                   | (field,expr) ->
                       let uu____5276 = translate_expr env expr  in
                       (field, uu____5276)) fields
               in
      ...
      | FStar_Extraction_ML_Syntax.MLE_Proj (e1,path) ->
          let uu____5285 =
            ...
            (uu____5292, uu____5293, (FStar_Pervasives_Native.snd path))  in
          EField uu____5285
      | FStar_Extraction_ML_Syntax.MLE_Let uu____5296 ->
          failwith "todo: translate_expr [MLE_Let]"
      | FStar_Extraction_ML_Syntax.MLE_App (head1,uu____5310) ->
          let uu____5315 =
            let uu____5316 =
      ...
      | FStar_Extraction_ML_Syntax.MLE_Seq seqs ->
          let uu____5322 = FStar_List.map (translate_expr env) seqs  in
          ESequence uu____5322
      | FStar_Extraction_ML_Syntax.MLE_Tuple es ->
          let uu____5328 = FStar_List.map (translate_expr env) es  in
          ETuple uu____5328
      | FStar_Extraction_ML_Syntax.MLE_CTor ((uu____5331,cons1),es) ->
          let uu____5348 =
            let uu____5357 = assert_lid env e.FStar_Extraction_ML_Syntax.mlty
               in
            let uu____5358 = FStar_List.map (translate_expr env) es  in
            (uu____5357, cons1, uu____5358)  in
          ECons uu____5348
      | FStar_Extraction_ML_Syntax.MLE_Fun (args,body) ->
          let binders = translate_binders env args  in
          let env1 = add_binders env args  in
          let uu____5381 =
            let uu____5390 = translate_expr env1 body  in
            let uu____5391 =
              translate_type env1 body.FStar_Extraction_ML_Syntax.mlty  in
            (binders, uu____5390, uu____5391)  in
          EFun uu____5381
          ...
          let uu____5401 =
            ...
            let uu____5410 =
              ...
              | FStar_Pervasives_Native.Some e31 -> translate_expr env e31
               in
            (uu____5408, uu____5409, uu____5410)  in
          EIfThenElse uu____5401
      | FStar_Extraction_ML_Syntax.MLE_Raise uu____5412 ->
          failwith "todo: translate_expr [MLE_Raise]"
      | FStar_Extraction_ML_Syntax.MLE_Try uu____5419 ->
          failwith "todo: translate_expr [MLE_Try]"
      | FStar_Extraction_ML_Syntax.MLE_Coerce uu____5434 ->
  ...
  fun env  ->
    fun t  ->
      ...
      | FStar_Extraction_ML_Syntax.MLTY_Named (ts,lid) ->
          ...
          then
            let uu____5449 =
              let uu____5462 = FStar_List.map (translate_type env) ts  in
              (lid, uu____5462)  in
            TApp uu____5449
          else TQualified lid
      | uu____5468 -> failwith "invalid argument: assert_lid"
  ...
  fun env  ->
    fun uu____5494  ->
      ...
      | (pat,guard,expr) ->
          ...
          then
            let uu____5520 = translate_pat env pat  in
            (match uu____5520 with
             | (env1,pat1) ->
                 let uu____5531 = translate_expr env1 expr  in
                 (pat1, uu____5531))
...
and translate_pat :
  ...
  fun env  ->
    fun p  ->
      ...
      | FStar_Extraction_ML_Syntax.MLP_Var (name,uu____5545) ->
          let env1 = extend env name false  in
          (env1, (PVar { name; typ = TAny; mut = false }))
      | FStar_Extraction_ML_Syntax.MLP_Wild  ->
          let env1 = extend env "_" false  in
          (env1, (PVar { name = "_"; typ = TAny; mut = false }))
      | FStar_Extraction_ML_Syntax.MLP_CTor ((uu____5548,cons1),ps) ->
          let uu____5565 =
            FStar_List.fold_left
              (fun uu____5585  ->
                 fun p1  ->
                   ...
                   | (env1,acc) ->
                       let uu____5605 = translate_pat env1 p1  in
                       (match uu____5605 with
                        | (env2,p2) -> (env2, (p2 :: acc)))) (env, []) ps
             in
          (match uu____5565 with
           | (env1,ps1) -> (env1, (PCons (cons1, (FStar_List.rev ps1)))))
      | FStar_Extraction_ML_Syntax.MLP_Record (uu____5634,ps) ->
          let uu____5652 =
            FStar_List.fold_left
              (fun uu____5686  ->
                 fun uu____5687  ->
                   ...
                   | ((env1,acc),(field,p1)) ->
                       let uu____5756 = translate_pat env1 p1  in
            ...
            FStar_List.fold_left
              (fun uu____5838  ->
                 fun p1  ->
                   ...
                   | (env1,acc) ->
                       let uu____5858 = translate_pat env1 p1  in
                       (match uu____5858 with
                        | (env2,p2) -> (env2, (p2 :: acc)))) (env, []) ps
             in
          (match uu____5818 with
           | (env1,ps1) -> (env1, (PTuple (FStar_List.rev ps1))))
      | FStar_Extraction_ML_Syntax.MLP_Const uu____5885 ->
          failwith "todo: translate_pat [MLP_Const]"
      | FStar_Extraction_ML_Syntax.MLP_Branch uu____5890 ->
...
and translate_constant : FStar_Extraction_ML_Syntax.mlconstant -> expr =
  fun c  ->
    ...
    | FStar_Extraction_ML_Syntax.MLC_Int
        (s,FStar_Pervasives_Native.Some uu____5900) ->
        failwith
          "impossible: machine integer not desugared to a function call"
    | FStar_Extraction_ML_Syntax.MLC_Float uu____5915 ->
        failwith "todo: translate_expr [MLC_Float]"
    | FStar_Extraction_ML_Syntax.MLC_Char uu____5916 ->
        failwith "todo: translate_expr [MLC_Char]"
    | FStar_Extraction_ML_Syntax.MLC_String uu____5917 ->
        failwith "todo: translate_expr [MLC_String]"
    | FStar_Extraction_ML_Syntax.MLC_Bytes uu____5918 ->
  ...
  fun env  ->
    fun w  ->
      fun op  ->
        fun args  ->
          let uu____5938 =
            let uu____5945 = FStar_List.map (translate_expr env) args  in
            ((EOp (op, w)), uu____5945)  in
          EApp uu____5938
