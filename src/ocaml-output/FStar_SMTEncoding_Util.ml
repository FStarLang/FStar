...
let mkAssume : (FStar_SMTEncoding_Term.term * FStar_SMTEncoding_Term.caption * Prims.string)  ->  FStar_SMTEncoding_Term.decl = (fun uu____12 -> (match (uu____12) with
| (tm, cap, nm) -> begin
(

let uu____25 = (

let uu____26 = (FStar_SMTEncoding_Term.escape nm)
in {FStar_SMTEncoding_Term.assumption_term = tm; FStar_SMTEncoding_Term.assumption_caption = cap; FStar_SMTEncoding_Term.assumption_name = uu____26; FStar_SMTEncoding_Term.assumption_fact_ids = []})
in FStar_SMTEncoding_Term.Assume (uu____25))
end))


let norng : 'Auu____37 'Auu____38 . ('Auu____37  ->  FStar_Range.range  ->  'Auu____38)  ->  'Auu____37  ->  'Auu____38 = (fun f x -> (f x FStar_Range.dummyRange))
...
let norng2 : 'Auu____568 'Auu____569 'Auu____570 . ('Auu____568  ->  'Auu____569  ->  FStar_Range.range  ->  'Auu____570)  ->  'Auu____568  ->  'Auu____569  ->  'Auu____570 = (fun f x y -> (f x y FStar_Range.dummyRange))


let norng3 : 'Auu____618 'Auu____619 'Auu____620 'Auu____621 . ('Auu____618  ->  'Auu____619  ->  'Auu____620  ->  FStar_Range.range  ->  'Auu____621)  ->  'Auu____618  ->  'Auu____619  ->  'Auu____620  ->  'Auu____621 = (fun f x y z -> (f x y z FStar_Range.dummyRange))


let norng4 : 'Auu____683 'Auu____684 'Auu____685 'Auu____686 'Auu____687 . ('Auu____683  ->  'Auu____684  ->  'Auu____685  ->  'Auu____686  ->  FStar_Range.range  ->  'Auu____687)  ->  'Auu____683  ->  'Auu____684  ->  'Auu____685  ->  'Auu____686  ->  'Auu____687 = (fun f x y z w -> (f x y z w FStar_Range.dummyRange))
