...
let uu____22 = (FStar_SMTEncoding_Term.escape nm)
in {FStar_SMTEncoding_Term.assumption_term = tm; FStar_SMTEncoding_Term.assumption_caption = cap; FStar_SMTEncoding_Term.assumption_name = uu____22; FStar_SMTEncoding_Term.assumption_fact_ids = []})
in FStar_SMTEncoding_Term.Assume (uu____21))
end))


let norng : 'Auu____31 'Auu____32 . ('Auu____31  ->  FStar_Range.range  ->  'Auu____32)  ->  'Auu____31  ->  'Auu____32 = (fun f x -> (f x FStar_Range.dummyRange))
...
let norng2 : 'Auu____507 'Auu____508 'Auu____509 . ('Auu____507  ->  'Auu____508  ->  FStar_Range.range  ->  'Auu____509)  ->  'Auu____507  ->  'Auu____508  ->  'Auu____509 = (fun f x y -> (f x y FStar_Range.dummyRange))


let norng3 : 'Auu____556 'Auu____557 'Auu____558 'Auu____559 . ('Auu____556  ->  'Auu____557  ->  'Auu____558  ->  FStar_Range.range  ->  'Auu____559)  ->  'Auu____556  ->  'Auu____557  ->  'Auu____558  ->  'Auu____559 = (fun f x y z -> (f x y z FStar_Range.dummyRange))


let norng4 : 'Auu____620 'Auu____621 'Auu____622 'Auu____623 'Auu____624 . ('Auu____620  ->  'Auu____621  ->  'Auu____622  ->  'Auu____623  ->  FStar_Range.range  ->  'Auu____624)  ->  'Auu____620  ->  'Auu____621  ->  'Auu____622  ->  'Auu____623  ->  'Auu____624 = (fun f x y z w -> (f x y z w FStar_Range.dummyRange))
