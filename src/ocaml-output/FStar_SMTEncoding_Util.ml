...
let norng : 'Auu____29 'Auu____30 . ('Auu____29  ->  FStar_Range.range  ->  'Auu____30)  ->  'Auu____29  ->  'Auu____30 = (fun f x -> (f x FStar_Range.dummyRange))
...
let norng2 : 'Auu____621 'Auu____622 'Auu____623 . ('Auu____621  ->  'Auu____622  ->  FStar_Range.range  ->  'Auu____623)  ->  'Auu____621  ->  'Auu____622  ->  'Auu____623 = (fun f x y -> (f x y FStar_Range.dummyRange))
