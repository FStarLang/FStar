...
let mkAssume : (FStar_SMTEncoding_Term.term * FStar_SMTEncoding_Term.caption * Prims.string)  ->  FStar_SMTEncoding_Term.decl = (fun uu____9 -> (match (uu____9) with
| (tm, cap, nm) -> begin
...
let norng : 'Auu____23 'Auu____24 . ('Auu____23  ->  FStar_Range.range  ->  'Auu____24)  ->  'Auu____23  ->  'Auu____24 = (fun f x -> (f x FStar_Range.dummyRange))
...
let norng2 : 'Auu____502 'Auu____503 'Auu____504 . ('Auu____502  ->  'Auu____503  ->  FStar_Range.range  ->  'Auu____504)  ->  'Auu____502  ->  'Auu____503  ->  'Auu____504 = (fun f x y -> (f x y FStar_Range.dummyRange))
