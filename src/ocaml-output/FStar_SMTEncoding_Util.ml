...
let norng:
      'Auu____23 'Auu____24. ('Auu____24 -> FStar_Range.range -> 'Auu____23)
      -> 'Auu____24 -> 'Auu____23 =
  fun f x -> f x FStar_Range.dummyRange
...
let norng2:
  ...
  fun f x y -> f x y FStar_Range.dummyRange
