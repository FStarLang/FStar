...
| Array (s1, s2) -> begin
(let _119_54 = (strSort s1)
in (let _119_53 = (strSort s2)
in (FStar_Util.format2 "(Array %s %s)" _119_54 _119_53)))
end
| Arrow (s1, s2) -> begin
(let _119_56 = (strSort s1)
in (let _119_55 = (strSort s2)
in (FStar_Util.format2 "(%s -> %s)" _119_56 _119_55)))
end
| Sort (s) -> begin
s
end))
...
| None -> begin
(let fvs = (let _119_189 = (freevars t)
in (FStar_Util.remove_dups fv_eq _119_189))
...
| Some (i) -> begin
(let _119_196 = (FStar_Util.string_of_int i)
...
| BoundV (i) -> begin
(let _119_199 = (FStar_Util.string_of_int i)
in (Prims.strcat "@" _119_199))
end
| FreeV (x) -> begin
(let _119_200 = (strSort (Prims.snd x))
in (Prims.strcat (Prims.strcat (Prims.fst x) ":") _119_200))
end
| App (op, tms) -> begin
(let _119_204 = (let _119_203 = (let _119_202 = (FStar_List.map (fun t -> t.hash) tms)
in (FStar_All.pipe_right _119_202 (FStar_String.concat " ")))
in (Prims.strcat (Prims.strcat "(" (op_to_string op)) _119_203))
in (Prims.strcat _119_204 ")"))
end
| Quant (qop, pats, wopt, sorts, body) -> begin
(let _119_212 = (let _119_205 = (FStar_List.map strSort sorts)
in (FStar_All.pipe_right _119_205 (FStar_String.concat " ")))
in (let _119_211 = (weightToSmt wopt)
in (let _119_210 = (let _119_209 = (FStar_All.pipe_right pats (FStar_List.map (fun pats -> (let _119_208 = (FStar_List.map (fun p -> p.hash) pats)
in (FStar_All.pipe_right _119_208 (FStar_String.concat " "))))))
in (FStar_All.pipe_right _119_209 (FStar_String.concat "; ")))
in (FStar_Util.format5 "(%s (%s)(! %s %s %s))" (qop_to_string qop) _119_212 body.hash _119_211 _119_210))))
end))

let __all_terms = (let _119_213 = (FStar_Util.smap_create 10000)
in (FStar_ST.alloc _119_213))
...
in (match ((let _119_218 = (all_terms ())
in (FStar_Util.smap_try_find _119_218 key))) with
| Some (tm) -> begin
tm
end
| None -> begin
(let tm = (let _119_219 = (FStar_Util.mk_ref None)
in {tm = t; hash = key; freevars = _119_219})
in (let _50_179 = (let _119_220 = (all_terms ())
in (FStar_Util.smap_add _119_220 key tm))
in tm))
end)))
...
let mkInteger' = (fun i -> (let _119_227 = (FStar_Util.string_of_int i)
in (mkInteger _119_227)))
...
(let _119_246 = (let _119_245 = (let _119_244 = (mkAnd (t1, t1'))
in (_119_244)::(t2')::[])
in (Imp, _119_245))
in (mkApp' _119_246))
end
...
(let _119_267 = (let _119_266 = (mkNot t1)
in (_119_266, t3))
in (mkImp _119_267))
end
...
| App (op, tms) -> begin
(let _119_285 = (let _119_284 = (FStar_List.map (aux ix) tms)
in (op, _119_284))
in (mkApp' _119_285))
end
| Quant (qop, pats, wopt, vars, body) -> begin
(let n = (FStar_List.length vars)
in (let _119_288 = (let _119_287 = (FStar_All.pipe_right pats (FStar_List.map (FStar_List.map (aux (ix + n)))))
in (let _119_286 = (aux (ix + n) body)
in (qop, _119_287, wopt, vars, _119_286)))
in (mkQuant _119_288)))
end)
end))
in (aux 0 t)))))
...
| App (op, tms) -> begin
(let _119_298 = (let _119_297 = (FStar_List.map (aux shift) tms)
in (op, _119_297))
in (mkApp' _119_298))
end
| Quant (qop, pats, wopt, vars, body) -> begin
...
in (let _119_301 = (let _119_300 = (FStar_All.pipe_right pats (FStar_List.map (FStar_List.map (aux shift))))
in (let _119_299 = (aux shift body)
in (qop, _119_300, wopt, vars, _119_299)))
in (mkQuant _119_301))))
end))
in (aux 0 t))))
...
| (qop, pats, wopt, vars, body) -> begin
(let _119_307 = (let _119_306 = (FStar_All.pipe_right pats (FStar_List.map (FStar_List.map (abstr vars))))
in (let _119_305 = (FStar_List.map fv_sort vars)
in (let _119_304 = (abstr vars body)
in (qop, _119_306, wopt, _119_305, _119_304))))
in (mkQuant _119_307))
end))
...
(let _119_408 = (let _119_407 = (FStar_List.map fv_sort vars)
in (let _119_406 = (abstr vars tm)
in (nm, _119_407, s, _119_406, c)))
in DefineFun (_119_408))
end))

let constr_id_of_sort = (fun sort -> (let _119_411 = (strSort sort)
in (FStar_Util.format1 "%s_constr_id" _119_411)))

let fresh_token = (fun _50_530 id -> (match (_50_530) with
| (tok_name, sort) -> begin
(let _119_424 = (let _119_423 = (let _119_422 = (let _119_421 = (mkInteger' id)
in (let _119_420 = (let _119_419 = (let _119_418 = (constr_id_of_sort sort)
in (let _119_417 = (let _119_416 = (mkApp (tok_name, []))
in (_119_416)::[])
in (_119_418, _119_417)))
in (mkApp _119_419))
in (_119_421, _119_420)))
in (mkEq _119_422))
in (_119_423, Some ("fresh token")))
in Assume (_119_424))
end))
...
in (let cdecl = (let _119_428 = (let _119_427 = (FStar_All.pipe_right projectors (FStar_List.map Prims.snd))
in (name, _119_427, sort, Some ("Constructor")))
in DeclFun (_119_428))
in (let n_bvars = (FStar_List.length projectors)
in (let bvar_name = (fun i -> (let _119_431 = (FStar_Util.string_of_int i)
in (Prims.strcat "x_" _119_431)))
in (let bvar_index = (fun i -> (n_bvars - (i + 1)))
in (let bvar = (fun i s -> (let _119_439 = (let _119_438 = (bvar_name i)
in (_119_438, s))
in (mkFreeV _119_439)))
...
in (let cid_app = (let _119_443 = (let _119_442 = (constr_id_of_sort sort)
in (_119_442, (capp)::[]))
in (mkApp _119_443))
in (let cid = (let _119_449 = (let _119_448 = (let _119_447 = (let _119_446 = (let _119_445 = (let _119_444 = (mkInteger id)
in (_119_444, cid_app))
in (mkEq _119_445))
in ([], bvar_names, _119_446))
in (mkForall _119_447))
in (_119_448, Some ("Constructor distinct")))
in Assume (_119_449))
in (let disc_name = (Prims.strcat "is-" name)
in (let xfv = ("x", sort)
in (let xx = (mkFreeV xfv)
in (let disc_eq = (let _119_454 = (let _119_453 = (let _119_451 = (let _119_450 = (constr_id_of_sort sort)
in (_119_450, (xx)::[]))
in (mkApp _119_451))
in (let _119_452 = (mkInteger id)
in (_119_453, _119_452)))
in (mkEq _119_454))
in (let proj_terms = (FStar_All.pipe_right projectors (FStar_List.map (fun _50_563 -> (match (_50_563) with
| (proj, s) -> begin
(mkApp (proj, (xx)::[]))
end))))
in (let disc_inv_body = (let _119_457 = (let _119_456 = (mkApp (name, proj_terms))
in (xx, _119_456))
in (mkEq _119_457))
...
in (let projs = (let _119_468 = (FStar_All.pipe_right projectors (FStar_List.mapi (fun i _50_571 -> (match (_50_571) with
| (name, s) -> begin
(let cproj_app = (mkApp (name, (capp)::[]))
in (let _119_467 = (let _119_466 = (let _119_465 = (let _119_464 = (let _119_463 = (let _119_462 = (let _119_461 = (let _119_460 = (bvar i s)
in (cproj_app, _119_460))
in (mkEq _119_461))
in ((capp)::[], bvar_names, _119_462))
in (mkForall _119_463))
in (_119_464, Some ("Projection inverse")))
in Assume (_119_465))
in (_119_466)::[])
in (DeclFun ((name, (sort)::[], s, Some ("Projector"))))::_119_467))
end))))
in (FStar_All.pipe_right _119_468 FStar_List.flatten))
in (let _119_475 = (let _119_471 = (let _119_470 = (let _119_469 = (FStar_Util.format1 "<start constructor %s>" name)
in Caption (_119_469))
in (_119_470)::(cdecl)::(cid)::projs)
in (FStar_List.append _119_471 ((disc)::[])))
in (let _119_474 = (let _119_473 = (let _119_472 = (FStar_Util.format1 "</end constructor %s>" name)
in Caption (_119_472))
in (_119_473)::[])
in (FStar_List.append _119_475 _119_474)))))))))))))))))))))))
end))
...
in (let nm = (let _119_484 = (FStar_Util.string_of_int n)
in (Prims.strcat prefix _119_484))
in (let names = ((nm, s))::names
in (let b = (let _119_485 = (strSort s)
in (FStar_Util.format2 "(%s %s)" nm _119_485))
...
| BoundV (i) -> begin
(let _119_496 = (FStar_List.nth names i)
in (FStar_All.pipe_right _119_496 Prims.fst))
end
| FreeV (x) -> begin
(Prims.fst x)
end
...
| App (op, tms) -> begin
(let _119_498 = (let _119_497 = (FStar_List.map (aux n names) tms)
in (FStar_All.pipe_right _119_497 (FStar_String.concat "\n")))
in (FStar_Util.format2 "(%s %s)" (op_to_string op) _119_498))
end
| Quant (qop, pats, wopt, sorts, body) -> begin
...
| _50_634 -> begin
(let _119_504 = (FStar_All.pipe_right pats (FStar_List.map (fun pats -> (let _119_503 = (let _119_502 = (FStar_List.map (fun p -> (let _119_501 = (aux n names p)
in (FStar_Util.format1 "%s" _119_501))) pats)
in (FStar_String.concat " " _119_502))
in (FStar_Util.format1 "\n:pattern (%s)" _119_503)))))
in (FStar_All.pipe_right _119_504 (FStar_String.concat "\n")))
end)
in (match ((pats, wopt)) with
| (([]::[], None)) | (([], None)) -> begin
(let _119_505 = (aux n names body)
in (FStar_Util.format3 "(%s (%s)\n %s)" (qop_to_string qop) binders _119_505))
end
| _50_646 -> begin
(let _119_507 = (aux n names body)
in (let _119_506 = (weightToSmt wopt)
in (FStar_Util.format5 "(%s (%s)\n (! %s\n %s %s))" (qop_to_string qop) binders _119_507 _119_506 pats_str)))
end)))
end))
end))
in (aux 0 [] t)))
...
| Caption (c) -> begin
(let _119_516 = (FStar_All.pipe_right (FStar_Util.splitlines c) (fun _50_7 -> (match (_50_7) with
| [] -> begin
""
end
| h::t -> begin
...
in (let _119_518 = (caption_to_string c)
in (let _119_517 = (strSort retsort)
in (FStar_Util.format4 "%s(declare-fun %s (%s) %s)" _119_518 f (FStar_String.concat " " l) _119_517))))
end
| DefineFun (f, arg_sorts, retsort, body, c) -> begin
(let _50_684 = (name_binders arg_sorts)
in (match (_50_684) with
| (names, binders) -> begin
(let body = (let _119_519 = (FStar_List.map mkFreeV names)
in (inst _119_519 body))
in (let _119_522 = (caption_to_string c)
in (let _119_521 = (strSort retsort)
in (let _119_520 = (termToSmt body)
in (FStar_Util.format5 "%s(define-fun %s (%s) %s\n %s)" _119_522 f (FStar_String.concat " " binders) _119_521 _119_520)))))
end))
end
| Assume (t, c) -> begin
(let _119_524 = (caption_to_string c)
in (let _119_523 = (termToSmt t)
in (FStar_Util.format2 "%s(assert %s)" _119_524 _119_523)))
end
| Eval (t) -> begin
(let _119_525 = (termToSmt t)
in (FStar_Util.format1 "(eval %s)" _119_525))
end
| Echo (s) -> begin
...
in (let bcons = (let _119_528 = (let _119_527 = (FStar_All.pipe_right constrs (FStar_List.collect constructor_to_decl))
in (FStar_All.pipe_right _119_527 (FStar_List.map (declToSmt z3options))))
in (FStar_All.pipe_right _119_528 (FStar_String.concat "\n")))
in (let lex_ordering = "\n(define-fun is-Prims.LexCons ((t Term)) Bool \n(is-LexCons t))\n(assert (forall ((x1 Term) (x2 Term) (y1 Term) (y2 Term))\n(iff (Valid (Precedes (LexCons x1 x2) (LexCons y1 y2)))\n(or (Valid (Precedes x1 y1))\n(and (= x1 y1)\n(Valid (Precedes x2 y2)))))))\n"
in (Prims.strcat (Prims.strcat basic bcons) lex_ordering))))))

let mk_Kind_type = (mkApp ("Kind_type", []))

let mk_Kind_uvar = (fun i -> (let _119_533 = (let _119_532 = (let _119_531 = (mkInteger' i)
in (_119_531)::[])
in ("Kind_uvar", _119_532))
in (mkApp _119_533)))
...
let mk_Typ_uvar = (fun i -> (let _119_546 = (let _119_545 = (let _119_544 = (mkInteger' i)
in (_119_544)::[])
in ("Typ_uvar", _119_545))
in (mkApp _119_546)))

let mk_Exp_uvar = (fun i -> (let _119_551 = (let _119_550 = (let _119_549 = (mkInteger' i)
in (_119_549)::[])
in ("Exp_uvar", _119_550))
in (mkApp _119_551)))
...
let mk_String_const = (fun i -> (let _119_640 = (let _119_639 = (let _119_638 = (mkInteger' i)
in (_119_638)::[])
in ("String_const", _119_639))
in (mkApp _119_640)))

let mk_Precedes = (fun x1 x2 -> (let _119_645 = (mkApp ("Precedes", (x1)::(x2)::[]))
in (FStar_All.pipe_right _119_645 mk_Valid)))
...
| false -> begin
(let _119_654 = (let _119_653 = (let _119_652 = (n_fuel (n - 1))
in (_119_652)::[])
in ("SFuel", _119_653))
in (mkApp _119_654))
end))
...
| BoundV (n) -> begin
(let _119_676 = (FStar_Util.string_of_int n)
in (FStar_Util.format1 "BoundV %s" _119_676))
end
| FreeV (fv) -> begin
(FStar_Util.format1 "FreeV %s" (Prims.fst fv))
end
| App (op, l) -> begin
(let _119_677 = (print_smt_term_list l)
in (FStar_Util.format2 "App %s [ %s ]" (op_to_string op) _119_677))
end
| Quant (qop, l, _50_820, _50_822, t) -> begin
(let _119_679 = (print_smt_term_list_list l)
in (let _119_678 = (print_smt_term t)
in (FStar_Util.format3 "Quant %s %s %s" (qop_to_string qop) _119_679 _119_678)))
end))
and print_smt_term_list = (fun l -> (FStar_List.fold_left (fun s t -> (let _119_683 = (print_smt_term t)
in (Prims.strcat (Prims.strcat s "; ") _119_683))) "" l))
and print_smt_term_list_list = (fun l -> (FStar_List.fold_left (fun s l -> (let _119_688 = (let _119_687 = (print_smt_term_list l)
in (Prims.strcat (Prims.strcat s "; [ ") _119_687))
in (Prims.strcat _119_688 " ] "))) "" l))
