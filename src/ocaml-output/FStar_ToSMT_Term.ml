...
let __all_terms : term FStar_Util.smap FStar_ST.ref = (let _140_303 = (FStar_Util.smap_create 10000)
...
(let _140_675 = (let _140_674 = (let _140_673 = (n_fuel (n - 1))
in (_140_673)::[])
in (("SFuel"), (_140_674)))
in (mkApp _140_675))
end)
