    ...
    fun tx  ->
      let rec aux uu___100_151 =
        ...
        | (tx',uf)::rest ->
         ...
         in
      let uu____174 = let uu____178 = FStar_ST.read state  in uu____178.rest
         in
      aux uu____174
...
let find : FStar_Syntax_Syntax.uvar -> FStar_Syntax_Syntax.term option =
  fun u  ->
    let uu____237 = get_term_graph ()  in
    FStar_Unionfind.puf_find uu____237 u
...
let univ_find :
  ...
  fun u  ->
    let uu____306 = get_univ_graph ()  in
    FStar_Unionfind.puf_find uu____306 u
