...
let new_transaction: Prims.unit -> tx =
  fun uu____524  ->
    ...
    (let uu____528 =
       let uu___108_529 = get () in
       let uu____530 = vops.next_minor () in
       {
         term_graph = (uu___108_529.term_graph);
         univ_graph = (uu___108_529.univ_graph);
         version = uu____530
       } in
     set uu____528);
    tx
...
let set_term_graph: tgraph -> Prims.unit =
  fun tg  ->
    let uu____586 =
      let uu___109_587 = get () in
      {
        term_graph = tg;
        univ_graph = (uu___109_587.univ_graph);
        version = (uu___109_587.version)
      } in
    set uu____586
let chk_v:
  'Auu____590 .
...
let set_univ_graph: ugraph -> Prims.unit =
  fun ug  ->
    let uu____797 =
      let uu___110_798 = get () in
      {
        term_graph = (uu___110_798.term_graph);
        univ_graph = ug;
        version = (uu___110_798.version)
      } in
    set uu____797
