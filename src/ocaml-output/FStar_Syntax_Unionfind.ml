...
let (new_transaction : Prims.unit -> tx) =
  fun uu____422  ->
    ...
    (let uu____426 =
       let uu___25_427 = get ()  in
       let uu____428 = vops.next_minor ()  in
       {
         term_graph = (uu___25_427.term_graph);
         univ_graph = (uu___25_427.univ_graph);
         version = uu____428
       }  in
     set uu____426);
    tx
...
let (set_term_graph : tgraph -> Prims.unit) =
  fun tg  ->
    let uu____496 =
      let uu___26_497 = get ()  in
      {
        term_graph = tg;
        univ_graph = (uu___26_497.univ_graph);
        version = (uu___26_497.version)
      }  in
    set uu____496
...
let (set_univ_graph : ugraph -> Prims.unit) =
  fun ug  ->
    let uu____707 =
      let uu___27_708 = get ()  in
      {
        term_graph = (uu___27_708.term_graph);
        univ_graph = ug;
        version = (uu___27_708.version)
      }  in
    set uu____707
