...
let vops : vops_t =
  ...
  let next_minor uu____174 =
    ...
    {FStar_Syntax_Syntax.major= uu____175; FStar_Syntax_Syntax.minor= uu____217}
  in
...
let __proj__Mkuf__item__term_graph : uf -> tgraph =
  fun projectee ->
    match projectee
    with
    | { term_graph= __fname__term_graph
      ; univ_graph= __fname__univ_graph
      ; version= __fname__version; _ }
    -> __fname__term_graph
...
let state : uf FStar_ST.ref =
  let uu____358 =
    let uu____359 = vops.next_major () in
    empty uu____359
  in
  FStar_Util.mk_ref uu____358


type tx = TX of uf [@@deriving show]
...
let get_term_graph : Prims.unit -> tgraph =
  fun uu____487 ->
    let uu____488 = get () in
    uu____488.term_graph


let get_version : Prims.unit -> FStar_Syntax_Syntax.version =
  fun uu____491 ->
    let uu____492 = get () in
    uu____492.version
...
let chk_v:
      ...
      -> 'Auu____500 =
  fun uu____508 ->
    match uu____508 with u, v1 ->
      let expected = get_version () in
      if v1.FStar_Syntax_Syntax.major = expected.FStar_Syntax_Syntax.major
...
let uvar_id : FStar_Syntax_Syntax.uvar -> Prims.int =
  fun u ->
    ...
    let uu____528 = chk_v u in
    FStar_Unionfind.puf_id uu____523 uu____528
...
let from_id : Prims.int -> FStar_Syntax_Syntax.uvar =
  fun n1 ->
    let uu____544 =
      ...
      FStar_Unionfind.puf_fromid uu____549 n1
    in
    let uu____556 = get_version () in
    (uu____544, uu____556)
...
let fresh : Prims.unit -> FStar_Syntax_Syntax.uvar =
  fun uu____563 ->
    let uu____564 =
      ...
      FStar_Unionfind.puf_fresh uu____569 FStar_Pervasives_Native.None
    in
    let uu____576 = get_version () in
    (uu____564, uu____576)
...
let find
  ...
  fun u ->
    ...
    let uu____591 = chk_v u in
    FStar_Unionfind.puf_find uu____586 uu____591


let change : FStar_Syntax_Syntax.uvar -> FStar_Syntax_Syntax.term -> Prims.unit =
  fun u t ->
    let uu____610 =
...
let union : FStar_Syntax_Syntax.uvar -> FStar_Syntax_Syntax.uvar -> Prims.unit =
  fun u v1 ->
    let uu____670 =
      ...
      FStar_Unionfind.puf_union uu____671 uu____676 uu____687
    in
...
let get_univ_graph : Prims.unit -> ugraph =
  fun uu____702 ->
    let uu____703 = get () in
    uu____703.univ_graph
...
let univ_uvar_id : FStar_Syntax_Syntax.universe_uvar -> Prims.int =
  fun u ->
    ...
    let uu____717 = chk_v u in
    FStar_Unionfind.puf_id uu____712 uu____717
...
let univ_from_id : Prims.int -> FStar_Syntax_Syntax.universe_uvar =
  fun n1 ->
    let uu____731 =
      ...
      FStar_Unionfind.puf_fromid uu____736 n1
    in
    let uu____743 = get_version () in
    (uu____731, uu____743)
...
let univ_fresh : Prims.unit -> FStar_Syntax_Syntax.universe_uvar =
  fun uu____750 ->
    let uu____751 =
      ...
      FStar_Unionfind.puf_fresh uu____756 FStar_Pervasives_Native.None
    in
    let uu____763 = get_version () in
    (uu____751, uu____763)
...
let univ_find
  ...
  fun u ->
    ...
    FStar_Unionfind.puf_find uu____773 uu____778
...
let univ_union
  ...
  fun u v1 ->
    let uu____849 =
      ...
      FStar_Unionfind.puf_union uu____850 uu____855 uu____864
    in
