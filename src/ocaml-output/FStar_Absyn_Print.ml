...
in (let _123_336 = (let _123_335 = (FStar_All.pipe_right pats (FStar_List.map (fun _32_607 -> (match (_32_607) with
| (p, wopt, e) -> begin
...
in (let _123_382 = (let _123_381 = (FStar_List.map (fun _32_710 -> (match (_32_710) with
| (x, b) -> begin
(
