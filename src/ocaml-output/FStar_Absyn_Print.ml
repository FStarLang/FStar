...
in (let _93_336 = (let _93_335 = (FStar_All.pipe_right pats (FStar_List.map (fun _27_593 -> (match (_27_593) with
| (p, wopt, e) -> begin
...
in (let _93_378 = (let _93_377 = (FStar_List.map (fun _27_694 -> (match (_27_694) with
| (x, b) -> begin
