...
(match ((let _131_31 = (FStar_List.nth exps (Prims.parse_int "1"))
in (reconstruct_lex _131_31))) with
| Some (xs) -> begin
(let _131_33 = (let _131_32 = (FStar_List.nth exps (Prims.parse_int "0"))
in (_131_32)::xs)
in Some (_131_33))
end
| None -> begin
...
let _33_127 = (let _131_62 = (FStar_Util.substring_from bvd.FStar_Absyn_Syntax.ppname.FStar_Ident.idText (Prims.parse_int "1"))
...
(let _131_140 = (let _131_135 = (FStar_List.nth args (Prims.parse_int "0"))
in (arg_to_string _131_135))
in (let _131_139 = (let _131_136 = (FStar_List.nth args (Prims.parse_int "1"))
in (arg_to_string _131_136))
in (let _131_138 = (let _131_137 = (FStar_List.nth args (Prims.parse_int "2"))
...
(let _131_141 = (FStar_List.nth args (Prims.parse_int "0"))
...
in (let _131_145 = (let _131_142 = (FStar_List.nth args' (Prims.parse_int "0"))
in (qbinder_to_string _131_142))
in (let _131_144 = (let _131_143 = (FStar_List.nth args' (Prims.parse_int "0"))
...
(let _131_151 = (let _131_147 = (FStar_List.nth args' (Prims.parse_int "0"))
in (FStar_All.pipe_right _131_147 arg_to_string))
in (let _131_150 = (FStar_All.pipe_right t infix_type_op_to_string)
in (let _131_149 = (let _131_148 = (FStar_List.nth args' (Prims.parse_int "1"))
...
in (let _131_153 = (let _131_152 = (FStar_List.nth args' (Prims.parse_int "0"))
...
(let _131_164 = if (FStar_Options.hide_uvar_nums ()) then begin
"?"
end else begin
...
(let _131_166 = if (FStar_Options.hide_uvar_nums ()) then begin
"?"
end else begin
...
if ((FStar_Absyn_Syntax.is_null_binder b) || ((let _131_171 = (FStar_Options.print_real_names ())
...
(let _131_176 = (let _131_175 = (strBvd a.FStar_Absyn_Syntax.v)
in (let _131_174 = (let _131_173 = (kind_to_string a.FStar_Absyn_Syntax.sort)
...
if ((FStar_Absyn_Syntax.is_null_binder b) || ((let _131_177 = (FStar_Options.print_real_names ())
...
(let _131_182 = (let _131_181 = (strBvd x.FStar_Absyn_Syntax.v)
in (let _131_180 = (let _131_179 = (typ_to_string x.FStar_Absyn_Syntax.sort)
...
let dec = (let _131_212 = (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_List.collect (fun _33_9 -> (match (_33_9) with
...
in (FStar_All.pipe_right _131_319 (FStar_List.filter (fun _33_15 -> (match (_33_15) with
...
(let _131_324 = (let _131_320 = (FStar_List.nth args' (Prims.parse_int "0"))
in (FStar_All.pipe_right _131_320 arg_to_string))
in (let _131_323 = (FStar_All.pipe_right e infix_prim_op_to_string)
in (let _131_322 = (let _131_321 = (FStar_List.nth args' (Prims.parse_int "1"))
...
in (let _131_326 = (let _131_325 = (FStar_List.nth args' (Prims.parse_int "0"))
...
in (let _131_336 = (let _131_335 = (FStar_All.pipe_right pats (FStar_List.map (fun _33_607 -> (match (_33_607) with
| (p, wopt, e) -> begin
...
| (uv, _33_623) -> begin
(let _131_344 = if (FStar_Options.hide_uvar_nums ()) then begin
"?"
end else begin
...
and uvar_k_to_string = (fun uv -> (let _131_375 = if (FStar_Options.hide_uvar_nums ()) then begin
"?"
end else begin
...
in (let _131_382 = (let _131_381 = (FStar_List.map (fun _33_710 -> (match (_33_710) with
| (x, b) -> begin
(
...
let subst_to_string = (fun subst -> (let _131_394 = (let _131_393 = (FStar_List.map (fun _33_16 -> (match (_33_16) with
...
let f = (fun l -> (let _131_400 = (let _131_399 = (FStar_All.pipe_right l FStar_Util.set_elements)
