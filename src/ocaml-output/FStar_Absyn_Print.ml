...
(
# 212 "FStar.Absyn.Print.fst"
let q_to_string = (fun k a -> (match ((Prims.fst a)) with
| FStar_Util.Inl (t) -> begin
(
# 213 "FStar.Absyn.Print.fst"
...
# 313 "FStar.Absyn.Print.fst"
let const_op = (fun f _32_411 -> f)
in (
# 314 "FStar.Absyn.Print.fst"
