...
| FStar_Absyn_Syntax.Exp_fvar (fv, _26_23) -> begin
...
| FStar_Absyn_Syntax.Exp_fvar (fv, _26_37) -> begin
...
| FStar_Util.Inl (_26_58) -> begin
false
end
| FStar_Util.Inr (_26_61) -> begin
true
end))
...
in (let exps = (FStar_List.map (fun _26_2 -> (match (_26_2) with
| (FStar_Util.Inl (_26_72), _26_75) -> begin
(FStar_All.failwith "impossible")
end
| (FStar_Util.Inr (x), _26_80) -> begin
x
end)) args)
...
| true -> begin
(FStar_All.try_with (fun _26_106 -> (match (()) with
| () -> begin
(let _26_112 = (let _92_62 = (FStar_Util.substring_from bvd.FStar_Absyn_Syntax.ppname.FStar_Absyn_Syntax.idText 1)
...
let filter_imp = (fun a -> (FStar_All.pipe_right a (FStar_List.filter (fun _26_3 -> (match (_26_3) with
| (_26_117, Some (FStar_Absyn_Syntax.Implicit)) -> begin
false
end
| _26_122 -> begin
true
...
| FStar_Absyn_Syntax.Const_string (bytes, _26_135) -> begin
(FStar_Util.format1 "\"%s\"" (FStar_Util.string_of_bytes bytes))
end
| FStar_Absyn_Syntax.Const_bytearray (_26_139) -> begin
"<bytearray>"
end
| FStar_Absyn_Syntax.Const_int (x) -> begin
x
end
| FStar_Absyn_Syntax.Const_int64 (_26_144) -> begin
"<int64>"
end
| FStar_Absyn_Syntax.Const_uint8 (_26_147) -> begin
"<uint8>"
end))

let rec tag_of_typ = (fun t -> (match (t.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Typ_btvar (_26_151) -> begin
"Typ_btvar"
end
| FStar_Absyn_Syntax.Typ_const (v) -> begin
(Prims.strcat "Typ_const " v.FStar_Absyn_Syntax.v.FStar_Absyn_Syntax.str)
end
| FStar_Absyn_Syntax.Typ_fun (_26_156) -> begin
"Typ_fun"
end
| FStar_Absyn_Syntax.Typ_refine (_26_159) -> begin
"Typ_refine"
end
...
| FStar_Absyn_Syntax.Typ_lam (_26_166) -> begin
"Typ_lam"
end
| FStar_Absyn_Syntax.Typ_ascribed (_26_169) -> begin
"Typ_ascribed"
end
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_pattern (_26_172)) -> begin
"Typ_meta_pattern"
end
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_named (_26_176)) -> begin
"Typ_meta_named"
end
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_labeled (_26_180)) -> begin
"Typ_meta_labeled"
end
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_refresh_label (_26_184)) -> begin
"Typ_meta_refresh_label"
end
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_slack_formula (_26_188)) -> begin
"Typ_meta_slack_formula"
end
| FStar_Absyn_Syntax.Typ_uvar (_26_192) -> begin
"Typ_uvar"
end
| FStar_Absyn_Syntax.Typ_delayed (_26_195) -> begin
"Typ_delayed"
end
...
| FStar_Absyn_Syntax.Exp_bvar (_26_200) -> begin
"Exp_bvar"
end
| FStar_Absyn_Syntax.Exp_fvar (_26_203) -> begin
"Exp_fvar"
end
| FStar_Absyn_Syntax.Exp_constant (_26_206) -> begin
"Exp_constant"
end
| FStar_Absyn_Syntax.Exp_abs (_26_209) -> begin
"Exp_abs"
end
| FStar_Absyn_Syntax.Exp_app (_26_212) -> begin
"Exp_app"
end
| FStar_Absyn_Syntax.Exp_match (_26_215) -> begin
"Exp_match"
end
| FStar_Absyn_Syntax.Exp_ascribed (_26_218) -> begin
"Exp_ascribed"
end
| FStar_Absyn_Syntax.Exp_let (_26_221) -> begin
"Exp_let"
end
| FStar_Absyn_Syntax.Exp_uvar (_26_224) -> begin
"Exp_uvar"
end
| FStar_Absyn_Syntax.Exp_delayed (_26_227) -> begin
"Exp_delayed"
end
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (_26_230, m)) -> begin
...
| FStar_Absyn_Syntax.Typ_delayed (_26_243) -> begin
(FStar_All.failwith "impossible")
end
| FStar_Absyn_Syntax.Typ_meta (FStar_Absyn_Syntax.Meta_named (_26_246, l)) -> begin
(sli l)
end
...
| FStar_Absyn_Syntax.Typ_app (_26_266, []) -> begin
...
| false -> begin
(FStar_List.filter (fun _26_5 -> (match (_26_5) with
| (_26_295, Some (FStar_Absyn_Syntax.Implicit)) -> begin
false
end
| _26_300 -> begin
true
...
| {FStar_Absyn_Syntax.n = FStar_Absyn_Syntax.Typ_uvar (_26_324); FStar_Absyn_Syntax.tk = _26_322; FStar_Absyn_Syntax.pos = _26_320; FStar_Absyn_Syntax.fvs = _26_318; FStar_Absyn_Syntax.uvs = _26_316} -> begin
...
and uvar_t_to_string = (fun _26_330 -> (match (_26_330) with
| (uv, k) -> begin
...
(let basic = (match (((FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_Util.for_some (fun _26_8 -> (match (_26_8) with
...
| false -> begin
(match (((not ((FStar_ST.read FStar_Options.print_effect_args))) && (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_Util.for_some (fun _26_9 -> (match (_26_9) with
...
in (let dec = (let _92_212 = (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_List.collect (fun _26_10 -> (match (_26_10) with
...
| (FStar_Util.Inr (e), _26_390) -> begin
(exp_to_string e)
end
| (FStar_Util.Inl (wp), _26_395) -> begin
(formula_to_string wp)
end))
and formula_to_string = (fun phi -> (typ_to_string phi))
and formula_to_string_old_now_unused = (fun phi -> (let const_op = (fun f _26_401 -> f)
in (let un_op = (fun f _26_11 -> (match (_26_11) with
| (FStar_Util.Inl (t), _26_409)::[] -> begin
...
| (FStar_Util.Inl (t1), _26_425)::(FStar_Util.Inl (t2), _26_420)::[] -> begin
...
| (FStar_Util.Inr (e1), _26_441)::(FStar_Util.Inr (e2), _26_436)::[] -> begin
...
| (FStar_Util.Inl (t1), _26_460)::(FStar_Util.Inl (t2), _26_455)::(FStar_Util.Inl (t3), _26_450)::[] -> begin
...
| (FStar_Util.Inl (t1), _26_485)::(FStar_Util.Inl (t2), _26_480)::(FStar_Util.Inr (e1), _26_475)::(FStar_Util.Inr (e2), _26_470)::[] -> begin
...
| (FStar_Util.Inr (e1), _26_496)::(FStar_Util.Inr (e2), _26_491)::[] -> begin
...
(match ((FStar_All.pipe_right connectives (FStar_List.tryFind (fun _26_520 -> (match (_26_520) with
| (l, _26_519) -> begin
...
| Some (_26_523, f) -> begin
(f arms)
end)
end
| Some (FStar_Absyn_Util.QAll (vars, _26_529, body)) -> begin
(let _92_308 = (binders_to_string " " vars)
in (let _92_307 = (formula_to_string body)
in (FStar_Util.format2 "(forall %s. %s)" _92_308 _92_307)))
end
| Some (FStar_Absyn_Util.QEx (vars, _26_536, body)) -> begin
...
| FStar_Absyn_Syntax.Exp_delayed (_26_543) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, _26_547)) -> begin
(exp_to_string e)
end
...
| FStar_Absyn_Syntax.Exp_fvar (fv, _26_559) -> begin
...
in (FStar_All.pipe_right _92_319 (FStar_List.filter (fun _26_16 -> (match (_26_16) with
| (FStar_Util.Inr (_26_578), _26_581) -> begin
true
end
| _26_584 -> begin
false
...
in (let _92_336 = (let _92_335 = (FStar_All.pipe_right pats (FStar_List.map (fun _26_593 -> (match (_26_593) with
| (p, wopt, e) -> begin
...
| FStar_Absyn_Syntax.Exp_ascribed (e, t, _26_600) -> begin
...
and uvar_e_to_string = (fun _26_610 -> (match (_26_610) with
| (uv, _26_609) -> begin
...
| FStar_Absyn_Syntax.Meta_refresh_label (t, _26_628, _26_630) -> begin
(let _92_358 = (typ_to_string t)
in (FStar_Util.format1 "(refresh) %s" _92_358))
end
| FStar_Absyn_Syntax.Meta_labeled (t, l, _26_636, _26_638) -> begin
(let _92_359 = (typ_to_string t)
in (FStar_Util.format2 "(labeled \"%s\") %s" l _92_359))
end
| FStar_Absyn_Syntax.Meta_named (_26_642, l) -> begin
(sli l)
end
...
| FStar_Absyn_Syntax.Meta_slack_formula (t1, t2, _26_653) -> begin
...
| FStar_Absyn_Syntax.Kind_lam (_26_658) -> begin
(FStar_All.failwith "Impossible")
end
| FStar_Absyn_Syntax.Kind_delayed (_26_661) -> begin
(FStar_All.failwith "Impossible")
end
...
and uvar_k_to_string' = (fun _26_683 -> (match (_26_683) with
| (uv, args) -> begin
...
| FStar_Absyn_Syntax.Pat_cons (l, _26_688, pats) -> begin
(let _92_379 = (sli l.FStar_Absyn_Syntax.v)
in (let _92_378 = (let _92_377 = (FStar_List.map (fun _26_694 -> (match (_26_694) with
| (x, b) -> begin
...
| FStar_Absyn_Syntax.Pat_dot_term (x, _26_698) -> begin
(let _92_380 = (strBvd x.FStar_Absyn_Syntax.v)
in (FStar_Util.format1 ".%s" _92_380))
end
| FStar_Absyn_Syntax.Pat_dot_typ (x, _26_703) -> begin
...
| FStar_Absyn_Syntax.Pat_wild (_26_713) -> begin
"_"
end
| FStar_Absyn_Syntax.Pat_twild (_26_716) -> begin
"\'_"
end
...
let subst_to_string = (fun subst -> (let _92_390 = (let _92_389 = (FStar_List.map (fun _26_17 -> (match (_26_17) with
...
| FStar_Absyn_Syntax.Discriminator (_26_740) -> begin
"discriminator"
end
| FStar_Absyn_Syntax.Projector (_26_743) -> begin
"projector"
end
...
| FStar_Absyn_Syntax.Sig_pragma (FStar_Absyn_Syntax.ResetOptions, _26_754) -> begin
"#reset-options"
end
| FStar_Absyn_Syntax.Sig_pragma (FStar_Absyn_Syntax.SetOptions (s), _26_760) -> begin
(FStar_Util.format1 "#set-options \"%s\"" s)
end
| FStar_Absyn_Syntax.Sig_tycon (lid, tps, k, _26_767, _26_769, quals, _26_772) -> begin
...
| FStar_Absyn_Syntax.Sig_typ_abbrev (lid, tps, k, t, _26_780, _26_782) -> begin
...
| FStar_Absyn_Syntax.Sig_datacon (lid, t, _26_788, _26_790, _26_792, _26_794) -> begin
(let _92_415 = (typ_to_string t)
in (FStar_Util.format2 "datacon %s : %s" lid.FStar_Absyn_Syntax.str _92_415))
end
| FStar_Absyn_Syntax.Sig_val_decl (lid, t, quals, _26_801) -> begin
...
| FStar_Absyn_Syntax.Sig_assume (lid, f, _26_807, _26_809) -> begin
(let _92_418 = (typ_to_string f)
in (FStar_Util.format2 "val %s : %s" lid.FStar_Absyn_Syntax.str _92_418))
end
| FStar_Absyn_Syntax.Sig_let (lbs, _26_814, _26_816, b) -> begin
(lbs_to_string lbs)
end
| FStar_Absyn_Syntax.Sig_main (e, _26_822) -> begin
(let _92_419 = (exp_to_string e)
in (FStar_Util.format1 "let _ = %s" _92_419))
end
| FStar_Absyn_Syntax.Sig_bundle (ses, _26_827, _26_829, _26_831) -> begin
(let _92_420 = (FStar_List.map sigelt_to_string ses)
in (FStar_All.pipe_right _92_420 (FStar_String.concat "\n")))
end
| FStar_Absyn_Syntax.Sig_new_effect (_26_835) -> begin
"new_effect { ... }"
end
| FStar_Absyn_Syntax.Sig_sub_effect (_26_838) -> begin
"sub_effect ..."
end
| FStar_Absyn_Syntax.Sig_kind_abbrev (_26_841) -> begin
"kind ..."
end
| FStar_Absyn_Syntax.Sig_effect_abbrev (l, tps, c, _26_847, _26_849) -> begin
(let _92_423 = (sli l)
...
| FStar_Absyn_Syntax.Sig_let ((_26_856, {FStar_Absyn_Syntax.lbname = FStar_Util.Inr (l); FStar_Absyn_Syntax.lbtyp = t; FStar_Absyn_Syntax.lbeff = _26_860; FStar_Absyn_Syntax.lbdef = _26_858}::[]), _26_868, _26_870, _26_872) -> begin
