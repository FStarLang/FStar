...
let rec reconstruct_lex = (fun e -> (match ((let _107_28 = (FStar_Absyn_Util.compress_exp e)
...
let find_lid = (fun x xs -> (let _107_47 = (find (fun p -> (FStar_Ident.lid_equals x (Prims.fst p))) xs)
...
| () -> begin
(let _30_112 = (let _107_62 = (FStar_Util.substring_from bvd.FStar_Absyn_Syntax.ppname.FStar_Ident.idText 1)
...
(let _107_141 = (let _107_136 = (FStar_List.nth args 0)
in (arg_to_string _107_136))
in (let _107_140 = (let _107_137 = (FStar_List.nth args 1)
in (arg_to_string _107_137))
in (let _107_139 = (let _107_138 = (FStar_List.nth args 2)
in (arg_to_string _107_138))
in (FStar_Util.format3 "if %s then %s else %s" _107_141 _107_140 _107_139))))
end else begin
if ((is_b2t t) && ((FStar_List.length args) = 1)) then begin
(let _107_142 = (FStar_List.nth args 0)
in (FStar_All.pipe_right _107_142 arg_to_string))
end else begin
if ((is_quant t) && ((FStar_List.length args) <= 2)) then begin
(let _107_147 = (quant_to_string t)
in (let _107_146 = (let _107_143 = (FStar_List.nth args' 0)
in (qbinder_to_string _107_143))
in (let _107_145 = (let _107_144 = (FStar_List.nth args' 0)
in (qbody_to_string _107_144))
in (FStar_Util.format3 "(%s (%s). %s)" _107_147 _107_146 _107_145))))
end else begin
if ((is_infix_type_op t) && ((FStar_List.length args') = 2)) then begin
(let _107_152 = (let _107_148 = (FStar_List.nth args' 0)
in (FStar_All.pipe_right _107_148 arg_to_string))
in (let _107_151 = (FStar_All.pipe_right t infix_type_op_to_string)
in (let _107_150 = (let _107_149 = (FStar_List.nth args' 1)
in (FStar_All.pipe_right _107_149 arg_to_string))
in (FStar_Util.format3 "(%s %s %s)" _107_152 _107_151 _107_150))))
end else begin
if ((is_unary_type_op t) && ((FStar_List.length args') = 1)) then begin
(let _107_155 = (FStar_All.pipe_right t unary_type_op_to_string)
in (let _107_154 = (let _107_153 = (FStar_List.nth args' 0)
in (FStar_All.pipe_right _107_153 arg_to_string))
in (FStar_Util.format2 "(%s %s)" _107_155 _107_154)))
end else begin
(let _107_157 = (FStar_All.pipe_right t typ_to_string)
in (let _107_156 = (FStar_All.pipe_right args args_to_string)
in (FStar_Util.format2 "(%s %s)" _107_157 _107_156)))
end
end
end
end
...
(let _107_159 = (binders_to_string " " binders)
in (let _107_158 = (FStar_All.pipe_right t2 typ_to_string)
in (FStar_Util.format2 "(fun %s -> %s)" _107_159 _107_158)))
end
| FStar_Absyn_Syntax.Typ_ascribed (t, k) -> begin
if (FStar_ST.read FStar_Options.print_real_names) then begin
(let _107_161 = (typ_to_string t)
in (let _107_160 = (kind_to_string k)
in (FStar_Util.format2 "(%s <: %s)" _107_161 _107_160)))
end else begin
...
(let _107_165 = if (FStar_ST.read FStar_Options.hide_uvar_nums) then begin
"?"
end else begin
(let _107_163 = (FStar_Unionfind.uvar_id uv)
in (FStar_Util.string_of_int _107_163))
end
in (let _107_164 = (kind_to_string k)
in (FStar_Util.format2 "(U%s : %s)" _107_165 _107_164)))
end else begin
(let _107_167 = if (FStar_ST.read FStar_Options.hide_uvar_nums) then begin
"?"
end else begin
(let _107_166 = (FStar_Unionfind.uvar_id uv)
in (FStar_Util.string_of_int _107_166))
end
in (FStar_Util.format1 "U%s" _107_167))
end
end))
...
if ((FStar_Absyn_Syntax.is_null_binder b) || ((let _107_172 = (FStar_ST.read FStar_Options.print_real_names)
in (FStar_All.pipe_right _107_172 Prims.op_Negation)) && (FStar_Absyn_Syntax.is_null_pp a.FStar_Absyn_Syntax.v))) then begin
(kind_to_string a.FStar_Absyn_Syntax.sort)
end else begin
if ((not (is_arrow)) && (not ((FStar_ST.read FStar_Options.print_implicits)))) then begin
(let _107_173 = (strBvd a.FStar_Absyn_Syntax.v)
in (imp_to_string _107_173 imp))
end else begin
(let _107_177 = (let _107_176 = (let _107_174 = (strBvd a.FStar_Absyn_Syntax.v)
in (Prims.strcat _107_174 ":"))
in (let _107_175 = (kind_to_string a.FStar_Absyn_Syntax.sort)
in (Prims.strcat _107_176 _107_175)))
in (imp_to_string _107_177 imp))
end
end
end
| (FStar_Util.Inr (x), imp) -> begin
if ((FStar_Absyn_Syntax.is_null_binder b) || ((let _107_178 = (FStar_ST.read FStar_Options.print_real_names)
in (FStar_All.pipe_right _107_178 Prims.op_Negation)) && (FStar_Absyn_Syntax.is_null_pp x.FStar_Absyn_Syntax.v))) then begin
(typ_to_string x.FStar_Absyn_Syntax.sort)
end else begin
if ((not (is_arrow)) && (not ((FStar_ST.read FStar_Options.print_implicits)))) then begin
(let _107_179 = (strBvd x.FStar_Absyn_Syntax.v)
in (imp_to_string _107_179 imp))
end else begin
(let _107_183 = (let _107_182 = (let _107_180 = (strBvd x.FStar_Absyn_Syntax.v)
in (Prims.strcat _107_180 ":"))
in (let _107_181 = (typ_to_string x.FStar_Absyn_Syntax.sort)
in (Prims.strcat _107_182 _107_181)))
in (imp_to_string _107_183 imp))
end
end
end))
...
(let _107_188 = (FStar_All.pipe_right bs (FStar_List.map arrow_binder_to_string))
in (FStar_All.pipe_right _107_188 (FStar_String.concat sep)))
end else begin
(let _107_189 = (FStar_All.pipe_right bs (FStar_List.map binder_to_string))
in (FStar_All.pipe_right _107_189 (FStar_String.concat sep)))
end))
and arg_to_string = (fun _30_7 -> (match (_30_7) with
| (FStar_Util.Inl (a), imp) -> begin
(let _107_191 = (typ_to_string a)
in (imp_to_string _107_191 imp))
end
| (FStar_Util.Inr (x), imp) -> begin
(let _107_192 = (exp_to_string x)
in (imp_to_string _107_192 imp))
end))
...
in (let _107_194 = (FStar_All.pipe_right args (FStar_List.map arg_to_string))
in (FStar_All.pipe_right _107_194 (FStar_String.concat " ")))))
and lcomp_typ_to_string = (fun lc -> (let _107_197 = (sli lc.FStar_Absyn_Syntax.eff_name)
in (let _107_196 = (typ_to_string lc.FStar_Absyn_Syntax.res_typ)
in (FStar_Util.format2 "%s %s" _107_197 _107_196))))
and comp_typ_to_string = (fun c -> (match (c.FStar_Absyn_Syntax.n) with
| FStar_Absyn_Syntax.Total (t) -> begin
(let _107_199 = (typ_to_string t)
in (FStar_Util.format1 "Tot %s" _107_199))
end
...
(let _107_201 = (typ_to_string c.FStar_Absyn_Syntax.result_typ)
in (FStar_Util.format1 "Tot %s" _107_201))
end else begin
...
(let _107_203 = (typ_to_string c.FStar_Absyn_Syntax.result_typ)
in (FStar_Util.format1 "ALL %s" _107_203))
end else begin
if (FStar_ST.read FStar_Options.print_effect_args) then begin
(let _107_207 = (sli c.FStar_Absyn_Syntax.effect_name)
in (let _107_206 = (typ_to_string c.FStar_Absyn_Syntax.result_typ)
in (let _107_205 = (let _107_204 = (FStar_All.pipe_right c.FStar_Absyn_Syntax.effect_args (FStar_List.map effect_arg_to_string))
in (FStar_All.pipe_right _107_204 (FStar_String.concat ", ")))
in (FStar_Util.format3 "%s (%s) %s" _107_207 _107_206 _107_205))))
end else begin
(let _107_209 = (sli c.FStar_Absyn_Syntax.effect_name)
in (let _107_208 = (typ_to_string c.FStar_Absyn_Syntax.result_typ)
in (FStar_Util.format2 "%s (%s)" _107_209 _107_208)))
end
end
end
end
in (let dec = (let _107_213 = (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_List.collect (fun _30_10 -> (match (_30_10) with
| FStar_Absyn_Syntax.DECREASES (e) -> begin
(let _107_212 = (let _107_211 = (exp_to_string e)
in (FStar_Util.format1 " (decreases %s)" _107_211))
in (_107_212)::[])
end
| _30_386 -> begin
[]
end))))
in (FStar_All.pipe_right _107_213 (FStar_String.concat " ")))
...
(let _107_225 = (formula_to_string t)
in (FStar_Util.format2 "%s %s" f _107_225))
end
| _30_415 -> begin
...
(let _107_231 = (formula_to_string t1)
in (let _107_230 = (formula_to_string t2)
in (FStar_Util.format3 "%s %s %s" _107_231 f _107_230)))
end
| _30_431 -> begin
(FStar_All.failwith "Impos")
end))
...
(let _107_237 = (exp_to_string e1)
in (let _107_236 = (exp_to_string e2)
in (FStar_Util.format3 "%s %s %s" _107_237 f _107_236)))
end
| _30_447 -> begin
(FStar_All.failwith "impos")
end))
...
(let _107_242 = (formula_to_string t1)
in (let _107_241 = (formula_to_string t2)
in (let _107_240 = (formula_to_string t3)
in (FStar_Util.format3 "if %s then %s else %s" _107_242 _107_241 _107_240))))
end
| _30_466 -> begin
(FStar_All.failwith "impos")
end))
...
(let _107_248 = (typ_to_string t1)
in (let _107_247 = (typ_to_string t2)
in (let _107_246 = (exp_to_string e1)
in (let _107_245 = (exp_to_string e2)
in (FStar_Util.format4 "Eq2 %s %s %s %s" _107_248 _107_247 _107_246 _107_245)))))
end else begin
(let _107_250 = (exp_to_string e1)
in (let _107_249 = (exp_to_string e2)
in (FStar_Util.format2 "%s == %s" _107_250 _107_249)))
end
end
| (FStar_Util.Inr (e1), _30_498)::(FStar_Util.Inr (e2), _30_493)::[] -> begin
(let _107_252 = (exp_to_string e1)
in (let _107_251 = (exp_to_string e2)
in (FStar_Util.format2 "%s == %s" _107_252 _107_251)))
end
| _30_502 -> begin
(FStar_All.failwith "Impossible")
end))
...
(let _107_291 = (binders_to_string " " binders)
in (let _107_290 = (formula_to_string phi)
in (FStar_Util.format2 "(fun %s => %s)" _107_291 _107_290)))
end
| _30_512 -> begin
(typ_to_string phi)
end))
...
(let _107_309 = (binders_to_string " " vars)
in (let _107_308 = (formula_to_string body)
in (FStar_Util.format2 "(forall %s. %s)" _107_309 _107_308)))
end
| Some (FStar_Absyn_Util.QEx (vars, _30_538, body)) -> begin
(let _107_311 = (binders_to_string " " vars)
in (let _107_310 = (formula_to_string body)
in (FStar_Util.format2 "(exists %s. %s)" _107_311 _107_310)))
end))))))))))
and exp_to_string = (fun x -> (match ((let _107_313 = (FStar_Absyn_Util.compress_exp x)
in _107_313.FStar_Absyn_Syntax.n)) with
...
(let _107_315 = (binders_to_string " " binders)
in (let _107_314 = (FStar_All.pipe_right e exp_to_string)
in (FStar_Util.format2 "(fun %s -> %s)" _107_315 _107_314)))
end
...
in (match (lex) with
| Some (es) -> begin
(let _107_318 = (let _107_317 = (let _107_316 = (FStar_List.map exp_to_string es)
in (FStar_String.concat "; " _107_316))
in (Prims.strcat "%[" _107_317))
in (Prims.strcat _107_318 "]"))
end
| None -> begin
(let args' = (let _107_320 = (filter_imp args)
in (FStar_All.pipe_right _107_320 (FStar_List.filter (fun _30_16 -> (match (_30_16) with
...
(let _107_325 = (let _107_321 = (FStar_List.nth args' 0)
in (FStar_All.pipe_right _107_321 arg_to_string))
in (let _107_324 = (FStar_All.pipe_right e infix_prim_op_to_string)
in (let _107_323 = (let _107_322 = (FStar_List.nth args' 1)
in (FStar_All.pipe_right _107_322 arg_to_string))
in (FStar_Util.format3 "(%s %s %s)" _107_325 _107_324 _107_323))))
end else begin
if ((is_unary_prim_op e) && ((FStar_List.length args') = 1)) then begin
(let _107_328 = (FStar_All.pipe_right e unary_prim_op_to_string)
in (let _107_327 = (let _107_326 = (FStar_List.nth args' 0)
in (FStar_All.pipe_right _107_326 arg_to_string))
in (FStar_Util.format2 "(%s %s)" _107_328 _107_327)))
end else begin
(let _107_330 = (FStar_All.pipe_right e exp_to_string)
in (let _107_329 = (args_to_string args)
in (FStar_Util.format2 "(%s %s)" _107_330 _107_329)))
end
end)
end))
end
| FStar_Absyn_Syntax.Exp_match (e, pats) -> begin
(let _107_338 = (FStar_All.pipe_right e exp_to_string)
in (let _107_337 = (let _107_336 = (FStar_All.pipe_right pats (FStar_List.map (fun _30_595 -> (match (_30_595) with
| (p, wopt, e) -> begin
(let _107_335 = (FStar_All.pipe_right p pat_to_string)
in (let _107_334 = (match (wopt) with
| None -> begin
""
end
| Some (w) -> begin
(let _107_332 = (FStar_All.pipe_right w exp_to_string)
in (FStar_Util.format1 "when %s" _107_332))
end)
in (let _107_333 = (FStar_All.pipe_right e exp_to_string)
in (FStar_Util.format3 "%s %s -> %s" _107_335 _107_334 _107_333))))
end))))
in (FStar_Util.concat_l "\n\t" _107_336))
in (FStar_Util.format2 "(match %s with %s)" _107_338 _107_337)))
end
| FStar_Absyn_Syntax.Exp_ascribed (e, t, _30_602) -> begin
(let _107_340 = (FStar_All.pipe_right e exp_to_string)
in (let _107_339 = (FStar_All.pipe_right t typ_to_string)
in (FStar_Util.format2 "(%s:%s)" _107_340 _107_339)))
end
| FStar_Absyn_Syntax.Exp_let (lbs, e) -> begin
(let _107_342 = (lbs_to_string lbs)
in (let _107_341 = (FStar_All.pipe_right e exp_to_string)
in (FStar_Util.format2 "%s in %s" _107_342 _107_341)))
end))
and uvar_e_to_string = (fun _30_612 -> (match (_30_612) with
| (uv, _30_611) -> begin
(let _107_345 = if (FStar_ST.read FStar_Options.hide_uvar_nums) then begin
"?"
end else begin
(let _107_344 = (FStar_Unionfind.uvar_id uv)
in (FStar_Util.string_of_int _107_344))
end
in (Prims.strcat "\'e" _107_345))
end))
and lbs_to_string = (fun lbs -> (let _107_352 = (let _107_351 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (let _107_350 = (lbname_to_string lb.FStar_Absyn_Syntax.lbname)
in (let _107_349 = (FStar_All.pipe_right lb.FStar_Absyn_Syntax.lbtyp typ_to_string)
in (let _107_348 = (FStar_All.pipe_right lb.FStar_Absyn_Syntax.lbdef exp_to_string)
in (FStar_Util.format3 "%s:%s = %s" _107_350 _107_349 _107_348)))))))
in (FStar_Util.concat_l "\n and " _107_351))
...
and either_l_to_string = (fun delim l -> (let _107_357 = (FStar_All.pipe_right l (FStar_List.map either_to_string))
in (FStar_All.pipe_right _107_357 (FStar_Util.concat_l delim))))
...
in (FStar_Util.format1 "(refresh) %s" _107_359))
end
| FStar_Absyn_Syntax.Meta_labeled (t, l, _30_638, _30_640) -> begin
(let _107_360 = (typ_to_string t)
in (FStar_Util.format2 "(labeled \"%s\") %s" l _107_360))
end
| FStar_Absyn_Syntax.Meta_named (_30_644, l) -> begin
(sli l)
end
| FStar_Absyn_Syntax.Meta_pattern (t, ps) -> begin
(let _107_362 = (pats_to_string ps)
in (let _107_361 = (FStar_All.pipe_right t typ_to_string)
in (FStar_Util.format2 "{:pattern %s} %s" _107_362 _107_361)))
end
| FStar_Absyn_Syntax.Meta_slack_formula (t1, t2, _30_655) -> begin
(let _107_364 = (formula_to_string t1)
in (let _107_363 = (formula_to_string t2)
in (FStar_Util.format2 "%s /\\ %s" _107_364 _107_363)))
end))
and pats_to_string = (fun ps -> (let _107_368 = (FStar_All.pipe_right ps (FStar_List.map (fun e -> (let _107_367 = (FStar_All.pipe_right e (FStar_List.map arg_to_string))
in (FStar_All.pipe_right _107_367 (FStar_String.concat "; "))))))
in (FStar_All.pipe_right _107_368 (FStar_String.concat " \\/ "))))
and kind_to_string = (fun x -> (match ((let _107_370 = (FStar_Absyn_Util.compress_kind x)
in _107_370.FStar_Absyn_Syntax.n)) with
...
(let _107_372 = (sli n)
in (let _107_371 = (args_to_string args)
in (FStar_Util.format2 "%s %s" _107_372 _107_371)))
end
end
| FStar_Absyn_Syntax.Kind_arrow (binders, k) -> begin
(let _107_374 = (binders_to_string " -> " binders)
in (let _107_373 = (FStar_All.pipe_right k kind_to_string)
in (FStar_Util.format2 "(%s -> %s)" _107_374 _107_373)))
end
| FStar_Absyn_Syntax.Kind_unknown -> begin
"_"
end))
and uvar_k_to_string = (fun uv -> (let _107_376 = if (FStar_ST.read FStar_Options.hide_uvar_nums) then begin
"?"
end else begin
(let _107_375 = (FStar_Unionfind.uvar_id uv)
in (FStar_Util.string_of_int _107_375))
end
in (Prims.strcat "\'k_" _107_376)))
and uvar_k_to_string' = (fun _30_687 -> (match (_30_687) with
| (uv, args) -> begin
(let str = if (FStar_ST.read FStar_Options.hide_uvar_nums) then begin
"?"
end else begin
(let _107_378 = (FStar_Unionfind.uvar_id uv)
in (FStar_Util.string_of_int _107_378))
end
in (let _107_379 = (args_to_string args)
in (FStar_Util.format2 "(\'k_%s %s)" str _107_379)))
end))
and pat_to_string = (fun x -> (match (x.FStar_Absyn_Syntax.v) with
| FStar_Absyn_Syntax.Pat_cons (l, _30_692, pats) -> begin
(let _107_384 = (sli l.FStar_Absyn_Syntax.v)
in (let _107_383 = (let _107_382 = (FStar_List.map (fun _30_698 -> (match (_30_698) with
| (x, b) -> begin
...
in (FStar_All.pipe_right _107_382 (FStar_String.concat " ")))
in (FStar_Util.format2 "(%s %s)" _107_384 _107_383)))
end
...
(let _107_386 = (strBvd x.FStar_Absyn_Syntax.v)
in (FStar_Util.format1 ".\'%s" _107_386))
end
...
(let _107_387 = (FStar_List.map pat_to_string ps)
in (FStar_Util.concat_l " | " _107_387))
end))

let subst_to_string = (fun subst -> (let _107_395 = (let _107_394 = (FStar_List.map (fun _30_17 -> (match (_30_17) with
| FStar_Util.Inl (a, t) -> begin
(let _107_391 = (strBvd a)
in (let _107_390 = (typ_to_string t)
in (FStar_Util.format2 "(%s -> %s)" _107_391 _107_390)))
end
| FStar_Util.Inr (x, e) -> begin
(let _107_393 = (strBvd x)
in (let _107_392 = (exp_to_string e)
in (FStar_Util.format2 "(%s -> %s)" _107_393 _107_392)))
end)) subst)
in (FStar_All.pipe_right _107_394 (FStar_String.concat ", ")))
in (FStar_All.pipe_left (FStar_Util.format1 "{%s}") _107_395)))

let freevars_to_string = (fun fvs -> (let f = (fun l -> (let _107_401 = (let _107_400 = (FStar_All.pipe_right l FStar_Util.set_elements)
in (FStar_All.pipe_right _107_400 (FStar_List.map (fun t -> (strBvd t.FStar_Absyn_Syntax.v)))))
in (FStar_All.pipe_right _107_401 (FStar_String.concat ", "))))
in (let _107_403 = (f fvs.FStar_Absyn_Syntax.ftvs)
in (let _107_402 = (f fvs.FStar_Absyn_Syntax.fxvs)
in (FStar_Util.format2 "ftvs={%s}, fxvs={%s}" _107_403 _107_402)))))
...
(let _107_408 = (let _107_407 = (FStar_All.pipe_right ids (FStar_List.map (fun lid -> lid.FStar_Ident.ident.FStar_Ident.idText)))
in (FStar_All.pipe_right _107_407 (FStar_String.concat ", ")))
in (FStar_Util.format1 "record(%s)" _107_408))
end
| _30_753 -> begin
"other"
end))

let quals_to_string = (fun quals -> (let _107_411 = (FStar_All.pipe_right quals (FStar_List.map qual_to_string))
in (FStar_All.pipe_right _107_411 (FStar_String.concat " "))))
...
(let _107_416 = (quals_to_string quals)
in (let _107_415 = (binders_to_string " " tps)
in (let _107_414 = (kind_to_string k)
in (FStar_Util.format4 "%s type %s %s : %s" _107_416 lid.FStar_Ident.str _107_415 _107_414))))
end
| FStar_Absyn_Syntax.Sig_typ_abbrev (lid, tps, k, t, _30_784, _30_786) -> begin
(let _107_419 = (binders_to_string " " tps)
in (let _107_418 = (kind_to_string k)
in (let _107_417 = (typ_to_string t)
in (FStar_Util.format4 "type %s %s : %s = %s" lid.FStar_Ident.str _107_419 _107_418 _107_417))))
end
| FStar_Absyn_Syntax.Sig_datacon (lid, t, _30_792, _30_794, _30_796, _30_798) -> begin
(let _107_420 = (typ_to_string t)
in (FStar_Util.format2 "datacon %s : %s" lid.FStar_Ident.str _107_420))
end
| FStar_Absyn_Syntax.Sig_val_decl (lid, t, quals, _30_805) -> begin
(let _107_422 = (quals_to_string quals)
in (let _107_421 = (typ_to_string t)
in (FStar_Util.format3 "%s val %s : %s" _107_422 lid.FStar_Ident.str _107_421)))
end
| FStar_Absyn_Syntax.Sig_assume (lid, f, _30_811, _30_813) -> begin
(let _107_423 = (typ_to_string f)
in (FStar_Util.format2 "val %s : %s" lid.FStar_Ident.str _107_423))
end
| FStar_Absyn_Syntax.Sig_let (lbs, _30_818, _30_820, b) -> begin
(lbs_to_string lbs)
end
| FStar_Absyn_Syntax.Sig_main (e, _30_826) -> begin
(let _107_424 = (exp_to_string e)
in (FStar_Util.format1 "let _ = %s" _107_424))
end
| FStar_Absyn_Syntax.Sig_bundle (ses, _30_831, _30_833, _30_835) -> begin
(let _107_425 = (FStar_List.map sigelt_to_string ses)
in (FStar_All.pipe_right _107_425 (FStar_String.concat "\n")))
end
...
(let _107_428 = (sli l)
in (let _107_427 = (binders_to_string " " tps)
in (let _107_426 = (comp_typ_to_string c)
in (FStar_Util.format3 "effect %s %s = %s" _107_428 _107_427 _107_426))))
end))

let format_error = (fun r msg -> (let _107_433 = (FStar_Range.string_of_range r)
...
(let _107_436 = (typ_to_string t)
in (FStar_Util.format2 "let %s : %s" l.FStar_Ident.str _107_436))
end
| _30_880 -> begin
(let _107_439 = (let _107_438 = (FStar_Absyn_Util.lids_of_sigelt x)
in (FStar_All.pipe_right _107_438 (FStar_List.map (fun l -> l.FStar_Ident.str))))
in (FStar_All.pipe_right _107_439 (FStar_String.concat ", ")))
end))

let rec modul_to_string = (fun m -> (let _107_444 = (sli m.FStar_Absyn_Syntax.name)
in (let _107_443 = (let _107_442 = (FStar_List.map sigelt_to_string m.FStar_Absyn_Syntax.declarations)
in (FStar_All.pipe_right _107_442 (FStar_String.concat "\n")))
