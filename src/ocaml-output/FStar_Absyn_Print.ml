...
(let _121_164 = if (FStar_Options.hide_uvar_nums ()) then begin
"?"
end else begin
...
(let _121_166 = if (FStar_Options.hide_uvar_nums ()) then begin
"?"
end else begin
...
if ((FStar_Absyn_Syntax.is_null_binder b) || ((let _121_171 = (FStar_Options.print_real_names ())
...
if ((FStar_Absyn_Syntax.is_null_binder b) || ((let _121_177 = (FStar_Options.print_real_names ())
...
| (uv, _32_619) -> begin
(let _121_344 = if (FStar_Options.hide_uvar_nums ()) then begin
"?"
end else begin
...
and uvar_k_to_string = (fun uv -> (let _121_375 = if (FStar_Options.hide_uvar_nums ()) then begin
"?"
end else begin
