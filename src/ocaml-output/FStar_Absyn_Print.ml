...
in (let _92_336 = (let _92_335 = (FStar_All.pipe_right pats (FStar_List.map (fun _27_593 -> (match (_27_593) with
| (p, wopt, e) -> begin
...
in (let _92_378 = (let _92_377 = (FStar_List.map (fun _27_694 -> (match (_27_694) with
| (x, b) -> begin
