...
let singleton_fvar :
  ...
  fun fv  ->
    let _0_681 =
      ...
      FStar_Util.set_add
        (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v _0_680
       in
    ({
       FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names;
       FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs;
                           ...
                           (FStar_List.fold_left
                              (fun n  ->
                                 fun x  ->
                                   ...
                                   union n _0_711) n)
                          in
                       let _0_713 = union n1 n2  in union n _0_713) _0_714
             in
            ...
            | FStar_Syntax_Syntax.Comp ct ->
                let us =
                  ...
                  free_names_and_uvars_args
                    ct.FStar_Syntax_Syntax.effect_args _0_734 use_cache
                   in
                FStar_List.fold_left
                  (fun us  ->
