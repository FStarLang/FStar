  ...
  fun tm  ->
    fun use_cache  ->
      ...
      | FStar_Syntax_Syntax.Tm_refine (bv,t1) ->
          ...
          aux_binders [(bv, FStar_Pervasives_Native.None)] uu____477
            ...
            FStar_List.fold_left
              (fun n1  ->
                 fun lb  ->
                   ...
                   union n1 uu____775) uu____763
             in
          FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) uu____756
            ...
            | FStar_Syntax_Syntax.Comp ct ->
                let us =
                  ...
                  free_names_and_uvars_args
                    ct.FStar_Syntax_Syntax.effect_args uu____1043 use_cache
                   in
                FStar_List.fold_left
                  (fun us1  ->
                     fun u  ->
            ...
            FStar_All.pipe_right uu____1158
              (FStar_Util.for_some
                 (fun u  ->
                    ...
                    | FStar_Pervasives_Native.Some uu____1171 -> true
...
let names : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.bv FStar_Util.set
  ...
  fun t  ->
    let uu____1176 =
      let uu____1177 = free_names_and_uvars t true  in
      FStar_Pervasives_Native.fst uu____1177  in
...
let uvars :
  ...
  fun t  ->
    let uu____1188 =
      let uu____1189 = free_names_and_uvars t true  in
      FStar_Pervasives_Native.fst uu____1189  in
...
let univs :
  ...
  fun t  ->
    let uu____1198 =
      let uu____1199 = free_names_and_uvars t true  in
      FStar_Pervasives_Native.fst uu____1199  in
...
let univnames :
  ...
  fun t  ->
    let uu____1208 =
      let uu____1209 = free_names_and_uvars t true  in
      FStar_Pervasives_Native.fst uu____1209  in
    uu____1208.FStar_Syntax_Syntax.free_univ_names
  
let fvars : FStar_Syntax_Syntax.term -> FStar_Ident.lident FStar_Util.set =
  fun t  ->
    let uu____1219 = free_names_and_uvars t false  in
    FStar_Pervasives_Native.snd uu____1219
