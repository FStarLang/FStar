  ...
  fun tm  ->
    fun use_cache  ->
      ...
      | FStar_Syntax_Syntax.Tm_app (t1,args) ->
          ...
          free_names_and_uvars_args args uu____433 use_cache
      | FStar_Syntax_Syntax.Tm_match (t1,pats) ->
          let uu____478 =
            let uu____497 = free_names_and_uvars t1 use_cache  in
            FStar_List.fold_left
              (fun n1  ->
                 fun uu____520  ->
                   ...
                   | (p,wopt,t2) ->
                       ...
                       let n3 =
                         let uu____558 = FStar_Syntax_Syntax.pat_bvs p  in
                         FStar_All.pipe_right uu____558
                           (FStar_List.fold_left
                              (fun n3  ->
                                 fun x  ->
                                   let uu____568 =
                                     free_names_and_uvars
                                      ...
                                      in
                                   union n3 uu____568) n1)
                          in
                       let uu____569 = union n11 n2  in union n3 uu____569)
              uu____497
             in
          FStar_All.pipe_right pats uu____478
      | FStar_Syntax_Syntax.Tm_ascribed (t1,asc,uu____586) ->
          ...
          (match FStar_Pervasives_Native.snd asc with
           ...
           | FStar_Pervasives_Native.Some tac ->
               let uu____674 = union u1 u2  in
               let uu____675 = free_names_and_uvars tac use_cache  in
               union uu____674 uu____675)
      | FStar_Syntax_Syntax.Tm_let (lbs,t1) ->
          let uu____694 =
            let uu____701 = free_names_and_uvars t1 use_cache  in
            FStar_List.fold_left
              (fun n1  ->
                 fun lb  ->
                   let uu____707 =
                     ...
                     let uu____709 =
                       free_names_and_uvars lb.FStar_Syntax_Syntax.lbdef
                         use_cache
                        in
                     union uu____708 uu____709  in
                   union n1 uu____707) uu____701
             in
          FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) uu____694
          ...
          (match m with
           | FStar_Syntax_Syntax.Meta_pattern args ->
               FStar_List.fold_right
                 ...
                 args u1
           | FStar_Syntax_Syntax.Meta_monadic (uu____770,t') ->
               let uu____776 = free_names_and_uvars t' use_cache  in
               union u1 uu____776
           | FStar_Syntax_Syntax.Meta_monadic_lift (uu____777,uu____778,t')
               ->
               let uu____784 = free_names_and_uvars t' use_cache  in
               union u1 uu____784
           | FStar_Syntax_Syntax.Meta_labeled uu____785 -> u1
           | FStar_Syntax_Syntax.Meta_desugared uu____792 -> u1
           | FStar_Syntax_Syntax.Meta_named uu____793 -> u1)
...
and (free_names_and_uvars :
  ...
  fun t  ->
    fun use_cache  ->
      ...
      let uu____799 = FStar_ST.op_Bang t1.FStar_Syntax_Syntax.vars  in
      match uu____799 with
      | FStar_Pervasives_Native.Some n1 when
          let uu____830 = should_invalidate_cache n1 use_cache  in
          Prims.op_Negation uu____830 ->
          let uu____831 = FStar_Syntax_Syntax.new_fv_set ()  in
          (n1, uu____831)
      | uu____836 ->
          ...
          (FStar_List.fold_left
             (fun n1  ->
                fun uu____941  ->
                  ...
                  | (x,uu____949) ->
                      let uu____954 = free_names_and_uvars x use_cache  in
                      union n1 uu____954) acc)
...
and (free_names_and_uvars_comp :
  ...
  fun c  ->
    fun use_cache  ->
      let uu____986 = FStar_ST.op_Bang c.FStar_Syntax_Syntax.vars  in
      match uu____986 with
      | FStar_Pervasives_Native.Some n1 ->
          let uu____1017 = should_invalidate_cache n1 use_cache  in
          if uu____1017
          then
            ...
            (let uu____1047 = FStar_Syntax_Syntax.new_fv_set ()  in
             (n1, uu____1047))
      | uu____1052 ->
          let n1 =
            ...
            | FStar_Syntax_Syntax.GTotal (t,FStar_Pervasives_Native.Some u)
                ->
                let uu____1090 = free_univs u  in
                let uu____1091 = free_names_and_uvars t use_cache  in
                union uu____1090 uu____1091
            | FStar_Syntax_Syntax.Total (t,FStar_Pervasives_Native.Some u) ->
                let uu____1100 = free_univs u  in
                let uu____1101 = free_names_and_uvars t use_cache  in
                union uu____1100 uu____1101
            | FStar_Syntax_Syntax.Comp ct ->
                let us =
                  ...
                  free_names_and_uvars_args
                    ct.FStar_Syntax_Syntax.effect_args uu____1110 use_cache
                   in
                FStar_List.fold_left
                  (fun us1  ->
                     fun u  ->
                       let uu____1122 = free_univs u  in union us1 uu____1122)
        ...
        ((FStar_All.pipe_right n1.FStar_Syntax_Syntax.free_uvars
            (FStar_Util.for_some
               (fun u  ->
                  ...
                  | FStar_Pervasives_Native.Some uu____1164 -> true
                  | uu____1165 -> false)))
           ||
           (FStar_All.pipe_right n1.FStar_Syntax_Syntax.free_univs
              (FStar_Util.for_some
                 (fun u  ->
                    let uu____1174 = FStar_Syntax_Unionfind.univ_find u  in
                    match uu____1174 with
                    | FStar_Pervasives_Native.Some uu____1177 -> true
...
let (new_uv_set : unit -> FStar_Syntax_Syntax.uvars) =
  fun uu____1194  -> FStar_Util.new_set compare_uv 
let (compare_universe_uvar :
  ...
  fun x  ->
    fun y  ->
      let uu____1205 = FStar_Syntax_Unionfind.univ_uvar_id x  in
      let uu____1206 = FStar_Syntax_Unionfind.univ_uvar_id y  in
      uu____1205 - uu____1206
  
let (new_universe_uvar_set :
  unit -> FStar_Syntax_Syntax.universe_uvar FStar_Util.set) =
  fun uu____1213  -> FStar_Util.new_set compare_universe_uvar 
...
let (names :
  ...
  fun t  ->
    let uu____1225 =
      let uu____1228 =
        let uu____1229 = free_names_and_uvars t true  in
        FStar_Pervasives_Native.fst uu____1229  in
      uu____1228.FStar_Syntax_Syntax.free_names  in
    FStar_Util.as_set uu____1225 FStar_Syntax_Syntax.order_bv
...
let (uvars :
  ...
  fun t  ->
    let uu____1245 =
      let uu____1248 =
        let uu____1249 = free_names_and_uvars t true  in
        FStar_Pervasives_Native.fst uu____1249  in
      uu____1248.FStar_Syntax_Syntax.free_uvars  in
    FStar_Util.as_set uu____1245 compare_uv
...
let (univs :
  ...
  fun t  ->
    let uu____1265 =
      let uu____1268 =
        let uu____1269 = free_names_and_uvars t true  in
        FStar_Pervasives_Native.fst uu____1269  in
      uu____1268.FStar_Syntax_Syntax.free_univs  in
    FStar_Util.as_set uu____1265 compare_universe_uvar
...
let (univnames :
  ...
  fun t  ->
    let uu____1285 =
      let uu____1288 =
        let uu____1289 = free_names_and_uvars t true  in
        FStar_Pervasives_Native.fst uu____1289  in
      uu____1288.FStar_Syntax_Syntax.free_univ_names  in
    FStar_Util.as_set uu____1285 FStar_Syntax_Syntax.order_univ_name
...
let (univnames_comp :
  ...
  fun c  ->
    let uu____1305 =
      let uu____1308 =
        let uu____1309 = free_names_and_uvars_comp c true  in
        FStar_Pervasives_Native.fst uu____1309  in
      uu____1308.FStar_Syntax_Syntax.free_univ_names  in
    FStar_Util.as_set uu____1305 FStar_Syntax_Syntax.order_univ_name
  
let (fvars : FStar_Syntax_Syntax.term -> FStar_Ident.lident FStar_Util.set) =
  fun t  ->
    let uu____1325 = free_names_and_uvars t false  in
    FStar_Pervasives_Native.snd uu____1325
