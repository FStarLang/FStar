  ...
  fun tm  ->
    fun use_cache  ->
                    ...
                    | (x,uu____352) ->
                        let uu____353 =
                          free_names_and_uvars x.FStar_Syntax_Syntax.sort
                            use_cache
                           in
                        union n1 uu____353) no_free_vars)
           in
      ...
      | FStar_Syntax_Syntax.Tm_let (lbs,t1) ->
          let uu____725 =
            let uu____732 = free_names_and_uvars t1 use_cache  in
            FStar_List.fold_left
              (fun n1  ->
                 fun lb  ->
                   let uu____744 =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          ...
          FStar_List.fold_right
            ...
            args uu____773
      | FStar_Syntax_Syntax.Tm_meta
          (t1,FStar_Syntax_Syntax.Meta_monadic (uu____796,t')) ->
          let uu____806 = free_names_and_uvars t1 use_cache  in
          let uu____810 = free_names_and_uvars t' use_cache  in
          union uu____806 uu____810
      | FStar_Syntax_Syntax.Tm_meta (t1,uu____815) ->
...
and free_names_and_uvars :
  ...
  fun t  ->
    fun use_cache  ->
      ...
      let uu____825 = FStar_ST.read t1.FStar_Syntax_Syntax.vars  in
      match uu____825 with
      | Some n1 when
          let uu____834 = should_invalidate_cache n1 use_cache  in
          Prims.op_Negation uu____834 ->
          let uu____835 = FStar_Syntax_Syntax.new_fv_set ()  in
          (n1, uu____835)
      | uu____838 ->
...
and free_names_and_uvars_comp :
  ...
  fun c  ->
    fun use_cache  ->
      ...
      | Some n1 ->
          let uu____947 = should_invalidate_cache n1 use_cache  in
          if uu____947
          then
            ...
            | FStar_Syntax_Syntax.Comp ct ->
                let us =
                  ...
                  free_names_and_uvars_args
                    ct.FStar_Syntax_Syntax.effect_args uu____1001 use_cache
                   in
                FStar_List.fold_left
                  (fun us1  ->
                     fun u  ->
                       let uu____1013 = free_univs u  in union us1 uu____1013)
...
let names : FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.bv FStar_Util.set
  ...
  fun t  ->
    let uu____1134 =
      let uu____1135 = free_names_and_uvars t true  in Prims.fst uu____1135
       in
...
let uvars :
  ...
  fun t  ->
    let uu____1146 =
      let uu____1147 = free_names_and_uvars t true  in Prims.fst uu____1147
       in
...
let univs :
  ...
  fun t  ->
    let uu____1156 =
      let uu____1157 = free_names_and_uvars t true  in Prims.fst uu____1157
       in
...
let univnames :
  ...
  fun t  ->
    let uu____1166 =
      let uu____1167 = free_names_and_uvars t true  in Prims.fst uu____1167
       in
