...
let no_free_vars:
  (FStar_Syntax_Syntax.free_vars* FStar_Ident.lident FStar_Util.set) =
  let _0_679 = FStar_Syntax_Syntax.new_fv_set () in
  ({
...
let singleton_fvar:
  ...
  fun fv  ->
    let _0_681 =
      let _0_680 = FStar_Syntax_Syntax.new_fv_set () in
      FStar_Util.set_add
        (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v _0_680 in
    ({
       FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names;
       FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs;
       FStar_Syntax_Syntax.free_univs = FStar_Syntax_Syntax.no_universe_uvars;
...
let singleton_bv:
  ...
  fun x  ->
    let _0_685 =
      let _0_683 =
        let _0_682 = FStar_Syntax_Syntax.new_bv_set () in
        FStar_Util.set_add x _0_682 in
      {
        FStar_Syntax_Syntax.free_names = _0_683;
        FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs;
    ...
    let _0_684 = FStar_Syntax_Syntax.new_fv_set () in (_0_685, _0_684)
let singleton_uv:
  ...
  fun x  ->
    let _0_689 =
      let _0_687 =
        let _0_686 = FStar_Syntax_Syntax.new_uv_set () in
        FStar_Util.set_add x _0_686 in
      {
        FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names;
        FStar_Syntax_Syntax.free_uvars = _0_687;
        FStar_Syntax_Syntax.free_univs =
          FStar_Syntax_Syntax.no_universe_uvars;
        FStar_Syntax_Syntax.free_univ_names =
          FStar_Syntax_Syntax.no_universe_names
      } in
    let _0_688 = FStar_Syntax_Syntax.new_fv_set () in (_0_689, _0_688)
let singleton_univ:
  ...
  fun x  ->
    let _0_693 =
      let _0_691 =
        let _0_690 = FStar_Syntax_Syntax.new_universe_uvar_set () in
        FStar_Util.set_add x _0_690 in
      {
        FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names;
        FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs;
        FStar_Syntax_Syntax.free_univs = _0_691;
        FStar_Syntax_Syntax.free_univ_names =
          FStar_Syntax_Syntax.no_universe_names
      } in
    let _0_692 = FStar_Syntax_Syntax.new_fv_set () in (_0_693, _0_692)
let singleton_univ_name:
  ...
  fun x  ->
    let _0_697 =
      let _0_695 =
        let _0_694 = FStar_Syntax_Syntax.new_universe_names_fifo_set () in
        FStar_Util.fifo_set_add x _0_694 in
      {
        FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names;
        FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs;
        FStar_Syntax_Syntax.free_univs =
          FStar_Syntax_Syntax.no_universe_uvars;
        FStar_Syntax_Syntax.free_univ_names = _0_695
      } in
    let _0_696 = FStar_Syntax_Syntax.new_fv_set () in (_0_697, _0_696)
let union f1 f2 =
  let _0_703 =
    let _0_701 =
    ...
    {
      FStar_Syntax_Syntax.free_names = _0_701;
      FStar_Syntax_Syntax.free_uvars = _0_700;
      FStar_Syntax_Syntax.free_univs = _0_699;
      FStar_Syntax_Syntax.free_univ_names = _0_698
    } in
  let _0_702 = FStar_Util.set_union (Prims.snd f1) (Prims.snd f2) in
  (_0_703, _0_702)
let rec free_univs:
  ...
  fun u  ->
    ...
    | FStar_Syntax_Syntax.U_max us ->
        FStar_List.fold_left
          (fun out  ->
             fun x  -> let _0_704 = free_univs x in union out _0_704)
          no_free_vars us
  ...
  fun tm  ->
    fun use_cache  ->
                    ...
                    | (x,uu____276) ->
                        let _0_705 =
                          free_names_and_uvars x.FStar_Syntax_Syntax.sort
                            use_cache in
                        union n _0_705) no_free_vars) in
        union from_binders from_body in
      let t = FStar_Syntax_Subst.compress tm in
      match t.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Tm_delayed uu____278 -> failwith "Impossible"
      | FStar_Syntax_Syntax.Tm_name x -> singleton_bv x
      | FStar_Syntax_Syntax.Tm_uvar (x,t) -> singleton_uv (x, t)
      | FStar_Syntax_Syntax.Tm_type u -> free_univs u
      | FStar_Syntax_Syntax.Tm_bvar uu____321 -> no_free_vars
      ...
      | FStar_Syntax_Syntax.Tm_uinst (t,us) ->
          ...
          FStar_List.fold_left
            (fun out  ->
               fun u  -> let _0_706 = free_univs u in union out _0_706) f us
      | FStar_Syntax_Syntax.Tm_abs (bs,t,uu____344) ->
          let _0_707 = free_names_and_uvars t use_cache in
          aux_binders bs _0_707
      | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
          let _0_708 = free_names_and_uvars_comp c use_cache in
          aux_binders bs _0_708
      | FStar_Syntax_Syntax.Tm_refine (bv,t) ->
          let _0_709 = free_names_and_uvars t use_cache in
          aux_binders [(bv, None)] _0_709
      | FStar_Syntax_Syntax.Tm_app (t,args) ->
          let _0_710 = free_names_and_uvars t use_cache in
          free_names_and_uvars_args args _0_710 use_cache
      | FStar_Syntax_Syntax.Tm_match (t,pats) ->
          let _0_715 =
            let _0_714 = free_names_and_uvars t use_cache in
            FStar_List.fold_left
              (fun n  ->
                 fun uu____462  ->
                   ...
                   | (p,wopt,t) ->
                       ...
                       let n =
                         let _0_712 = FStar_Syntax_Syntax.pat_bvs p in
                         FStar_All.pipe_right _0_712
                           (FStar_List.fold_left
                              (fun n  ->
                                 fun x  ->
                                   let _0_711 =
                                   ...
                                   union n _0_711) n) in
                       let _0_713 = union n1 n2 in union n _0_713) _0_714 in
          FStar_All.pipe_right pats _0_715
      | FStar_Syntax_Syntax.Tm_ascribed (t1,FStar_Util.Inl t2,uu____526) ->
          let _0_717 = free_names_and_uvars t1 use_cache in
          let _0_716 = free_names_and_uvars t2 use_cache in
          union _0_717 _0_716
      | FStar_Syntax_Syntax.Tm_ascribed (t1,FStar_Util.Inr c,uu____547) ->
          let _0_719 = free_names_and_uvars t1 use_cache in
          let _0_718 = free_names_and_uvars_comp c use_cache in
          union _0_719 _0_718
      | FStar_Syntax_Syntax.Tm_let (lbs,t) ->
          let _0_724 =
            let _0_723 = free_names_and_uvars t use_cache in
            FStar_List.fold_left
              (fun n  ->
                 fun lb  ->
                   let _0_722 =
                     ...
                     let _0_720 =
                       free_names_and_uvars lb.FStar_Syntax_Syntax.lbdef
                         use_cache in
                     union _0_721 _0_720 in
                   union n _0_722) _0_723 in
          FStar_All.pipe_right (Prims.snd lbs) _0_724
  ...
  fun t  ->
    fun use_cache  ->
      ...
      | Some n when Prims.op_Negation (should_invalidate_cache n use_cache)
          -> let _0_728 = FStar_Syntax_Syntax.new_fv_set () in (n, _0_728)
      | uu____653 ->
          ...
          (FStar_List.fold_left
             (fun n  ->
                fun uu____692  ->
                  ...
                  | (x,uu____704) ->
                      let _0_729 = free_names_and_uvars x use_cache in
                      union n _0_729) acc)
    ...
    fun use_cache  ->
      ...
      | Some n ->
          ...
          then
            ...
            (let _0_731 = FStar_Syntax_Syntax.new_fv_set () in (n, _0_731))
      | uu____764 ->
          let n =
            ...
            | FStar_Syntax_Syntax.GTotal (t,Some u)|FStar_Syntax_Syntax.Total
              (t,Some u) ->
                let _0_733 = free_univs u in
                let _0_732 = free_names_and_uvars t use_cache in
                union _0_733 _0_732
            | FStar_Syntax_Syntax.Comp ct ->
                let us =
                  ...
                  free_names_and_uvars_args
                    ct.FStar_Syntax_Syntax.effect_args _0_734 use_cache in
                FStar_List.fold_left
                  (fun us  ->
                     fun u  -> let _0_735 = free_univs u in union us _0_735)
