...
let singleton_fvar :
  ...
  fun fv  ->
    let uu____87 =
      ...
      FStar_Util.set_add
        (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v uu____89
       in
    ({
       FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names;
       FStar_Syntax_Syntax.free_uvars = no_uvs;
...
let singleton_univ_name :
  ...
  fun x  ->
    let uu____192 =
      let uu____193 =
        let uu____195 = FStar_Syntax_Syntax.new_universe_names_fifo_set ()
           in
                    ...
                    | (x,uu____421) ->
                        let uu____422 =
                          free_names_and_uvars x.FStar_Syntax_Syntax.sort
                            use_cache
                           in
                        union n1 uu____422) no_free_vars)
           in
            ...
            | FStar_Syntax_Syntax.Comp ct ->
                let us =
                  ...
                  free_names_and_uvars_args
                    ct.FStar_Syntax_Syntax.effect_args uu____1096 use_cache
                   in
                FStar_List.fold_left
                  (fun us1  ->
                     fun u  ->
