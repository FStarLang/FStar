...
in {FStar_Syntax_Syntax.free_names = _0_662; FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs; FStar_Syntax_Syntax.free_univs = FStar_Syntax_Syntax.no_universe_uvars; FStar_Syntax_Syntax.free_univ_names = FStar_Syntax_Syntax.no_universe_names}))
...
in {FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names; FStar_Syntax_Syntax.free_uvars = _0_664; FStar_Syntax_Syntax.free_univs = FStar_Syntax_Syntax.no_universe_uvars; FStar_Syntax_Syntax.free_univ_names = FStar_Syntax_Syntax.no_universe_names}))
...
in {FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names; FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs; FStar_Syntax_Syntax.free_univs = _0_666; FStar_Syntax_Syntax.free_univ_names = FStar_Syntax_Syntax.no_universe_names}))
...
in {FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names; FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs; FStar_Syntax_Syntax.free_univs = FStar_Syntax_Syntax.no_universe_uvars; FStar_Syntax_Syntax.free_univ_names = _0_668}))


let union : FStar_Syntax_Syntax.free_vars  ->  FStar_Syntax_Syntax.free_vars  ->  FStar_Syntax_Syntax.free_vars = (fun f1 f2 -> (let _0_672 = (FStar_Util.set_union f1.FStar_Syntax_Syntax.free_names f2.FStar_Syntax_Syntax.free_names)
in (let _0_671 = (FStar_Util.set_union f1.FStar_Syntax_Syntax.free_uvars f2.FStar_Syntax_Syntax.free_uvars)
in (let _0_670 = (FStar_Util.set_union f1.FStar_Syntax_Syntax.free_univs f2.FStar_Syntax_Syntax.free_univs)
in (let _0_669 = (FStar_Util.fifo_set_union f1.FStar_Syntax_Syntax.free_univ_names f2.FStar_Syntax_Syntax.free_univ_names)
in {FStar_Syntax_Syntax.free_names = _0_672; FStar_Syntax_Syntax.free_uvars = _0_671; FStar_Syntax_Syntax.free_univs = _0_670; FStar_Syntax_Syntax.free_univ_names = _0_669})))))
...
(FStar_List.fold_left (fun out x -> (let _0_673 = (free_univs x)
in (union out _0_673))) no_free_vars us)
end
...
| (x, uu____142) -> begin
(let _0_674 = (free_names_and_uvars x.FStar_Syntax_Syntax.sort)
in (union n _0_674))
end)) no_free_vars))
...
in (FStar_List.fold_left (fun out u -> (let _0_675 = (free_univs u)
in (union out _0_675))) f us))
end
| FStar_Syntax_Syntax.Tm_abs (bs, t, uu____201) -> begin
(let _0_676 = (free_names_and_uvars t)
in (aux_binders bs _0_676))
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
(let _0_677 = (free_names_and_uvars_comp c)
in (aux_binders bs _0_677))
end
| FStar_Syntax_Syntax.Tm_refine (bv, t) -> begin
(let _0_678 = (free_names_and_uvars t)
in (aux_binders ((((bv), (None)))::[]) _0_678))
end
| FStar_Syntax_Syntax.Tm_app (t, args) -> begin
(let _0_679 = (free_names_and_uvars t)
in (free_names_and_uvars_args args _0_679))
end
| FStar_Syntax_Syntax.Tm_match (t, pats) -> begin
(let _0_684 = (let _0_683 = (free_names_and_uvars t)
...
let n = (let _0_681 = (FStar_Syntax_Syntax.pat_bvs p)
in (FStar_All.pipe_right _0_681 (FStar_List.fold_left (fun n x -> (let _0_680 = (free_names_and_uvars x.FStar_Syntax_Syntax.sort)
in (union n _0_680))) n)))
in (let _0_682 = (union n1 n2)
in (union n _0_682)))))
end)) _0_683))
in (FStar_All.pipe_right pats _0_684))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inl (t2), uu____350) -> begin
(let _0_686 = (free_names_and_uvars t1)
in (let _0_685 = (free_names_and_uvars t2)
in (union _0_686 _0_685)))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inr (c), uu____371) -> begin
(let _0_688 = (free_names_and_uvars t1)
in (let _0_687 = (free_names_and_uvars_comp c)
in (union _0_688 _0_687)))
end
| FStar_Syntax_Syntax.Tm_let (lbs, t) -> begin
(let _0_693 = (let _0_692 = (free_names_and_uvars t)
in (FStar_List.fold_left (fun n lb -> (let _0_691 = (let _0_690 = (free_names_and_uvars lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_689 = (free_names_and_uvars lb.FStar_Syntax_Syntax.lbdef)
in (union _0_690 _0_689)))
in (union n _0_691))) _0_692))
in (FStar_All.pipe_right (Prims.snd lbs) _0_693))
end
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_pattern (args)) -> begin
(let _0_694 = (free_names_and_uvars t)
in (FStar_List.fold_right free_names_and_uvars_args args _0_694))
end
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic (uu____424, t')) -> begin
(let _0_696 = (free_names_and_uvars t)
in (let _0_695 = (free_names_and_uvars t')
in (union _0_696 _0_695)))
end
...
| (x, uu____484) -> begin
(let _0_697 = (free_names_and_uvars x)
in (union n _0_697))
end)) acc)))
...
| (x, uu____504) -> begin
(let _0_698 = (free_names_and_uvars x.FStar_Syntax_Syntax.sort)
in (union n _0_698))
end)) acc)))
...
(let _0_700 = (free_univs u)
in (let _0_699 = (free_names_and_uvars t)
in (union _0_700 _0_699)))
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(

let us = (let _0_701 = (free_names_and_uvars ct.FStar_Syntax_Syntax.result_typ)
in (free_names_and_uvars_args ct.FStar_Syntax_Syntax.effect_args _0_701))
in (FStar_List.fold_left (fun us u -> (let _0_702 = (free_univs u)
in (union us _0_702))) us ct.FStar_Syntax_Syntax.comp_univs))
end)
in ((FStar_ST.write c.FStar_Syntax_Syntax.vars (Some (n)));
n;
))
end)))
and should_invalidate_cache : FStar_Syntax_Syntax.free_vars  ->  Prims.bool = (fun n -> ((let _0_703 = (FStar_All.pipe_right n.FStar_Syntax_Syntax.free_uvars FStar_Util.set_elements)
in (FStar_All.pipe_right _0_703 (FStar_Util.for_some (fun uu____598 -> (match (uu____598) with
| (u, uu____608) -> begin
(
...
end))))) || (let _0_704 = (FStar_All.pipe_right n.FStar_Syntax_Syntax.free_univs FStar_Util.set_elements)
in (FStar_All.pipe_right _0_704 (FStar_Util.for_some (fun u -> (
