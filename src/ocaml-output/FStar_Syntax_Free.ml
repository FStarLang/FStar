...
let uu____165 = (FStar_Util.set_union (FStar_Pervasives_Native.fst f1).FStar_Syntax_Syntax.free_names (FStar_Pervasives_Native.fst f2).FStar_Syntax_Syntax.free_names)
in (

let uu____169 = (FStar_Util.set_union (FStar_Pervasives_Native.fst f1).FStar_Syntax_Syntax.free_uvars (FStar_Pervasives_Native.fst f2).FStar_Syntax_Syntax.free_uvars)
in (

let uu____189 = (FStar_Util.set_union (FStar_Pervasives_Native.fst f1).FStar_Syntax_Syntax.free_univs (FStar_Pervasives_Native.fst f2).FStar_Syntax_Syntax.free_univs)
in (

let uu____193 = (FStar_Util.fifo_set_union (FStar_Pervasives_Native.fst f1).FStar_Syntax_Syntax.free_univ_names (FStar_Pervasives_Native.fst f2).FStar_Syntax_Syntax.free_univ_names)
...
let uu____204 = (FStar_Util.set_union (FStar_Pervasives_Native.snd f1) (FStar_Pervasives_Native.snd f2))
...
| FStar_Syntax_Syntax.U_bvar (uu____219) -> begin
no_free_vars
end
...
| FStar_Syntax_Syntax.Tm_constant (uu____403) -> begin
no_free_vars
end
...
in (aux_binders ((((bv), (FStar_Pervasives_Native.None)))::[]) uu____477))
end
...
in (FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs) uu____756))
end
...
let uu____1018 = (free_univs u)
in (

let uu____1022 = (free_names_and_uvars t use_cache)
in (union uu____1018 uu____1022)))
end
| FStar_Syntax_Syntax.Total (t, FStar_Pervasives_Native.Some (u)) -> begin
(

let uu____1033 = (free_univs u)
in (

let uu____1037 = (free_names_and_uvars t use_cache)
in (union uu____1033 uu____1037)))
end
...
let uu____1043 = (free_names_and_uvars ct.FStar_Syntax_Syntax.result_typ use_cache)
in (free_names_and_uvars_args ct.FStar_Syntax_Syntax.effect_args uu____1043 use_cache))
in (FStar_List.fold_left (fun us1 u -> (

let uu____1055 = (free_univs u)
in (union us1 uu____1055))) us ct.FStar_Syntax_Syntax.comp_univs))
end)
...
let uu____1066 = (FStar_All.pipe_right n1.FStar_Syntax_Syntax.free_uvars FStar_Util.set_elements)
in (FStar_All.pipe_right uu____1066 (FStar_Util.for_some (fun uu____1119 -> (match (uu____1119) with
| (u, uu____1129) -> begin
(

let uu____1142 = (FStar_Unionfind.find u)
in (match (uu____1142) with
| FStar_Syntax_Syntax.Fixed (uu____1149) -> begin
true
end
| uu____1154 -> begin
false
...
let uu____1158 = (FStar_All.pipe_right n1.FStar_Syntax_Syntax.free_univs FStar_Util.set_elements)
in (FStar_All.pipe_right uu____1158 (FStar_Util.for_some (fun u -> (

let uu____1168 = (FStar_Unionfind.find u)
in (match (uu____1168) with
| FStar_Pervasives_Native.Some (uu____1171) -> begin
true
end
| FStar_Pervasives_Native.None -> begin
false
...
let uu____1177 = (free_names_and_uvars t true)
in (FStar_Pervasives_Native.fst uu____1177))
in uu____1176.FStar_Syntax_Syntax.free_names))
...
let uu____1189 = (free_names_and_uvars t true)
in (FStar_Pervasives_Native.fst uu____1189))
in uu____1188.FStar_Syntax_Syntax.free_uvars))
...
let uu____1199 = (free_names_and_uvars t true)
in (FStar_Pervasives_Native.fst uu____1199))
in uu____1198.FStar_Syntax_Syntax.free_univs))
...
let uu____1209 = (free_names_and_uvars t true)
in (FStar_Pervasives_Native.fst uu____1209))
in uu____1208.FStar_Syntax_Syntax.free_univ_names))


let fvars : FStar_Syntax_Syntax.term  ->  FStar_Ident.lident FStar_Util.set = (fun t -> (

let uu____1219 = (free_names_and_uvars t false)
in (FStar_Pervasives_Native.snd uu____1219)))
...
let uu____1229 = (free_names_and_uvars_binders bs no_free_vars true)
