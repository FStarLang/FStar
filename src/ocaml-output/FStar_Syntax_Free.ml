                    ...
                    | (x, uu____318) ->
                        let uu____323 =
                          free_names_and_uvars x.FStar_Syntax_Syntax.sort
                            use_cache in
                        union n uu____323) no_free_vars) in
            ...
            FStar_List.fold_left
              (fun n ->
                 fun lb ->
                   ...
                   union n uu____752) uu____746 in
  ...
  fun t ->
    fun use_cache ->
      ...
      | FStar_Pervasives_Native.Some n when
          ...
          let uu____904 = FStar_Syntax_Syntax.new_fv_set () in (n, uu____904)
      | uu____909 ->
            ...
            | FStar_Syntax_Syntax.Comp ct ->
                let us =
                  ...
                  free_names_and_uvars_args
                    ct.FStar_Syntax_Syntax.effect_args uu____1157 use_cache in
                FStar_List.fold_left
                  (fun us1 ->
                     fun u ->
...
let (names_of_binders :
  ...
  fun bs ->
    let uu____1469 =
      let uu____1472 =
        let uu____1473 = free_names_and_uvars_binders bs no_free_vars true in
