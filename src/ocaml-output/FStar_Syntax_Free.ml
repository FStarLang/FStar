...
let singleton_fvar:
  ...
  fun fv  ->
    let _0_674 =
      ...
      FStar_Util.set_add
        (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v _0_673 in
    ({
       FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names;
       FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs;
       FStar_Syntax_Syntax.free_univs = FStar_Syntax_Syntax.no_universe_uvars;
...
let singleton_bv:
  ...
  fun x  ->
    let _0_678 =
      ...
      {
        FStar_Syntax_Syntax.free_names = _0_676;
        FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs;
...
let singleton_uv:
  ...
  fun x  ->
    let _0_682 =
      ...
      {
        FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names;
        FStar_Syntax_Syntax.free_uvars = _0_680;
        FStar_Syntax_Syntax.free_univs =
          FStar_Syntax_Syntax.no_universe_uvars;
        FStar_Syntax_Syntax.free_univ_names =
          FStar_Syntax_Syntax.no_universe_names
  ...
  fun x  ->
    let _0_686 =
        ...
        FStar_Util.set_add x _0_683 in
      {
        FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names;
        FStar_Syntax_Syntax.free_uvars = FStar_Syntax_Syntax.no_uvs;
        FStar_Syntax_Syntax.free_univs = _0_684;
        FStar_Syntax_Syntax.free_univ_names =
          FStar_Syntax_Syntax.no_universe_names
      } in
                    ...
                    | (x,uu____276) ->
                        let _0_698 =
                          free_names_and_uvars x.FStar_Syntax_Syntax.sort
                            use_cache in
                        union n _0_698) no_free_vars) in
                           ...
                           (FStar_List.fold_left
                              (fun n  ->
                                 fun x  ->
                                   ...
                                   union n _0_704) n) in
                       let _0_706 = union n1 n2 in union n _0_706) _0_707 in
            ...
            | FStar_Syntax_Syntax.Comp ct ->
                let us =
                  ...
                  free_names_and_uvars_args
                    ct.FStar_Syntax_Syntax.effect_args _0_727 use_cache in
                FStar_List.fold_left
                  (fun us  ->
