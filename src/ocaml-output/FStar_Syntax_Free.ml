...
let uu___146_67 = (FStar_Pervasives_Native.fst no_free_vars)
in {FStar_Syntax_Syntax.free_names = (x)::[]; FStar_Syntax_Syntax.free_uvars = uu___146_67.FStar_Syntax_Syntax.free_uvars; FStar_Syntax_Syntax.free_univs = uu___146_67.FStar_Syntax_Syntax.free_univs; FStar_Syntax_Syntax.free_univ_names = uu___146_67.FStar_Syntax_Syntax.free_univ_names})), ((FStar_Pervasives_Native.snd no_free_vars))))
...
let uu___147_117 = (FStar_Pervasives_Native.fst no_free_vars)
in {FStar_Syntax_Syntax.free_names = uu___147_117.FStar_Syntax_Syntax.free_names; FStar_Syntax_Syntax.free_uvars = (x)::[]; FStar_Syntax_Syntax.free_univs = uu___147_117.FStar_Syntax_Syntax.free_univs; FStar_Syntax_Syntax.free_univ_names = uu___147_117.FStar_Syntax_Syntax.free_univ_names})), ((FStar_Pervasives_Native.snd no_free_vars))))
...
let uu___148_167 = (FStar_Pervasives_Native.fst no_free_vars)
in {FStar_Syntax_Syntax.free_names = uu___148_167.FStar_Syntax_Syntax.free_names; FStar_Syntax_Syntax.free_uvars = uu___148_167.FStar_Syntax_Syntax.free_uvars; FStar_Syntax_Syntax.free_univs = (x)::[]; FStar_Syntax_Syntax.free_univ_names = uu___148_167.FStar_Syntax_Syntax.free_univ_names})), ((FStar_Pervasives_Native.snd no_free_vars))))
...
let uu___149_185 = (FStar_Pervasives_Native.fst no_free_vars)
in {FStar_Syntax_Syntax.free_names = uu___149_185.FStar_Syntax_Syntax.free_names; FStar_Syntax_Syntax.free_uvars = uu___149_185.FStar_Syntax_Syntax.free_uvars; FStar_Syntax_Syntax.free_univs = uu___149_185.FStar_Syntax_Syntax.free_univs; FStar_Syntax_Syntax.free_univ_names = (x)::[]})), ((FStar_Pervasives_Native.snd no_free_vars))))
...
let uu____1312 = (should_invalidate_cache n1 use_cache)
in (not (uu____1312))) -> begin
(

let uu____1313 = (FStar_Syntax_Syntax.new_fv_set ())
in ((n1), (uu____1313)))
end
| uu____1318 -> begin
...
and free_names_and_uvars_args : (FStar_Syntax_Syntax.term' FStar_Syntax_Syntax.syntax * FStar_Syntax_Syntax.aqual) Prims.list  ->  (FStar_Syntax_Syntax.free_vars * FStar_Ident.lident FStar_Util.set)  ->  Prims.bool  ->  free_vars_and_fvars = (fun args acc use_cache -> (FStar_All.pipe_right args (FStar_List.fold_left (fun n1 uu____1475 -> (match (uu____1475) with
| (x, uu____1495) -> begin
(

let uu____1500 = (free_names_and_uvars x use_cache)
in (union n1 uu____1500))
end)) acc)))
and free_names_and_uvars_binders : FStar_Syntax_Syntax.binders  ->  (FStar_Syntax_Syntax.free_vars * FStar_Ident.lident FStar_Util.set)  ->  Prims.bool  ->  (FStar_Syntax_Syntax.free_vars * FStar_Ident.lident FStar_Util.set) = (fun bs acc use_cache -> (FStar_All.pipe_right bs (FStar_List.fold_left (fun n1 uu____1538 -> (match (uu____1538) with
| (x, uu____1556) -> begin
(

let uu____1557 = (free_names_and_uvars x.FStar_Syntax_Syntax.sort use_cache)
in (union n1 uu____1557))
end)) acc)))
...
let uu____1568 = (FStar_ST.op_Bang c.FStar_Syntax_Syntax.vars)
in (match (uu____1568) with
| FStar_Pervasives_Native.Some (n1) -> begin
(

let uu____1628 = (should_invalidate_cache n1 use_cache)
...
let uu____1687 = (FStar_Syntax_Syntax.new_fv_set ())
in ((n1), (uu____1687)))
end))
end
| uu____1692 -> begin
...
let uu____1730 = (free_univs u)
in (

let uu____1737 = (free_names_and_uvars t use_cache)
in (union uu____1730 uu____1737)))
end
| FStar_Syntax_Syntax.Total (t, FStar_Pervasives_Native.Some (u)) -> begin
(

let uu____1752 = (free_univs u)
in (

let uu____1759 = (free_names_and_uvars t use_cache)
in (union uu____1752 uu____1759)))
end
...
let uu____1768 = (free_names_and_uvars ct.FStar_Syntax_Syntax.result_typ use_cache)
in (free_names_and_uvars_args ct.FStar_Syntax_Syntax.effect_args uu____1768 use_cache))
in (FStar_List.fold_left (fun us1 u -> (

let uu____1792 = (free_univs u)
in (union us1 uu____1792))) us ct.FStar_Syntax_Syntax.comp_univs))
end)
in ((FStar_ST.op_Colon_Equals c.FStar_Syntax_Syntax.vars (FStar_Pervasives_Native.Some ((FStar_Pervasives_Native.fst n1))));
n1;
))
end)))
and should_invalidate_cache : FStar_Syntax_Syntax.free_vars  ->  Prims.bool  ->  Prims.bool = (fun n1 use_cache -> ((not (use_cache)) || ((FStar_All.pipe_right n1.FStar_Syntax_Syntax.free_uvars (FStar_Util.for_some (fun uu____1883 -> (match (uu____1883) with
| (u, uu____1891) -> begin
(

let uu____1896 = (FStar_Syntax_Unionfind.find u)
in (match (uu____1896) with
| FStar_Pervasives_Native.Some (uu____1899) -> begin
true
end
| uu____1900 -> begin
false
...
let uu____1909 = (FStar_Syntax_Unionfind.univ_find u)
in (match (uu____1909) with
| FStar_Pervasives_Native.Some (uu____1912) -> begin
true
end
| FStar_Pervasives_Native.None -> begin
false
...
let compare_uv : 'Auu____1921 'Auu____1922 . (FStar_Syntax_Syntax.uvar * 'Auu____1922)  ->  (FStar_Syntax_Syntax.uvar * 'Auu____1921)  ->  Prims.int = (fun uv1 uv2 -> (

let uu____1947 = (FStar_Syntax_Unionfind.uvar_id (FStar_Pervasives_Native.fst uv1))
in (

let uu____1948 = (FStar_Syntax_Unionfind.uvar_id (FStar_Pervasives_Native.fst uv2))
in (uu____1947 - uu____1948))))


let new_uv_set : Prims.unit  ->  FStar_Syntax_Syntax.uvars = (fun uu____1952 -> (FStar_Util.new_set compare_uv))


let compare_universe_uvar : FStar_Syntax_Syntax.universe_uvar  ->  FStar_Syntax_Syntax.universe_uvar  ->  Prims.int = (fun x y -> (

let uu____1971 = (FStar_Syntax_Unionfind.univ_uvar_id x)
in (

let uu____1972 = (FStar_Syntax_Unionfind.univ_uvar_id y)
in (uu____1971 - uu____1972))))


let new_universe_uvar_set : Prims.unit  ->  FStar_Syntax_Syntax.universe_uvar FStar_Util.set = (fun uu____1978 -> (FStar_Util.new_set compare_universe_uvar))
...
let uu____1991 = (free_names_and_uvars t true)
in (FStar_Pervasives_Native.fst uu____1991))
in uu____1990.FStar_Syntax_Syntax.free_names)
in (FStar_Util.as_set uu____1987 FStar_Syntax_Syntax.order_bv)))
...
let uu____2030 = (free_names_and_uvars t true)
in (FStar_Pervasives_Native.fst uu____2030))
in uu____2029.FStar_Syntax_Syntax.free_uvars)
in (FStar_Util.as_set uu____2010 compare_uv)))
...
let uu____2069 = (free_names_and_uvars t true)
in (FStar_Pervasives_Native.fst uu____2069))
in uu____2068.FStar_Syntax_Syntax.free_univs)
in (FStar_Util.as_set uu____2065 compare_universe_uvar)))
...
let uu____2088 = (free_names_and_uvars t true)
in (FStar_Pervasives_Native.fst uu____2088))
in uu____2087.FStar_Syntax_Syntax.free_univ_names)
in (FStar_Util.as_fifo_set uu____2084 FStar_Syntax_Syntax.order_univ_name)))


let fvars : FStar_Syntax_Syntax.term  ->  FStar_Ident.lident FStar_Util.set = (fun t -> (

let uu____2103 = (free_names_and_uvars t false)
in (FStar_Pervasives_Native.snd uu____2103)))
...
in (FStar_Pervasives_Native.fst uu____2122))
in uu____2121.FStar_Syntax_Syntax.free_names)
in (FStar_Util.as_set uu____2118 FStar_Syntax_Syntax.order_bv)))
