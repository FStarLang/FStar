                    ...
                    | (x, uu____316) ->
                        let uu____321 =
                          free_names_and_uvars x.FStar_Syntax_Syntax.sort
                            use_cache in
                        union n1 uu____321) no_free_vars) in
            ...
            FStar_List.fold_left
              (fun n1 ->
                 fun lb ->
                   ...
                   union n1 uu____758) uu____752 in
...
let (names_of_binders :
  ...
  fun bs ->
    let uu____1475 =
      let uu____1478 =
        let uu____1479 = free_names_and_uvars_binders bs no_free_vars true in
