...
let singleton_fvar :
  ...
  fun fv  ->
    let uu____90 =
      ...
      FStar_Util.set_add
        (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v uu____92
       in
    ({
       FStar_Syntax_Syntax.free_names = FStar_Syntax_Syntax.no_names;
       FStar_Syntax_Syntax.free_uvars = no_uvs;
...
let singleton_univ_name :
  ...
  fun x  ->
    let uu____199 =
      let uu____200 =
        let uu____202 = FStar_Syntax_Syntax.new_universe_names_fifo_set ()
           in
                    ...
                    | (x,uu____432) ->
                        let uu____433 =
                          free_names_and_uvars x.FStar_Syntax_Syntax.sort
                            use_cache
                           in
                        union n1 uu____433) no_free_vars)
           in
            ...
            | FStar_Syntax_Syntax.Comp ct ->
                let us =
                  ...
                  free_names_and_uvars_args
                    ct.FStar_Syntax_Syntax.effect_args uu____1107 use_cache
                   in
                FStar_List.fold_left
                  (fun us1  ->
                     fun u  ->
