...
let (singleton_fvar :
  ...
  fun fv  ->
    let uu___ =
      ...
      FStar_Util.set_add
        (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v uu___1
       in
  ...
  fun u  ->
    ...
    | FStar_Syntax_Syntax.U_max us ->
        FStar_List.fold_left
          (fun out  ->
             fun x  -> let uu___1 = free_univs x  in union out uu___1)
          no_free_vars us
  ...
  fun tm  ->
    fun use_cache  ->
      ...
      | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
          ...
          FStar_List.fold_left
            (fun out  ->
               fun u  -> let uu___ = free_univs u  in union out uu___) f us
                           ...
                           (FStar_List.fold_left
                              (fun n4  ->
                                 fun x  ->
                                   ...
                                   union n4 uu___4) n)
                          in
                       let uu___3 = union n1 n2  in union n3 uu___3) uu___1
             in
            ...
            | FStar_Syntax_Syntax.Comp ct ->
                let us =
                  ...
                  free_names_and_uvars_args
                    ct.FStar_Syntax_Syntax.effect_args uu___2 use_cache
                   in
                FStar_List.fold_left
                  (fun us1  ->
