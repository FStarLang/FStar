...
let from_binders = (FStar_All.pipe_right bs (FStar_List.fold_left (fun n _38_31 -> (match (_38_31) with
| (x, _38_30) -> begin
...
| FStar_Syntax_Syntax.Tm_delayed (_38_35) -> begin
(failwith "Impossible")
end
...
| FStar_Syntax_Syntax.Tm_abs (bs, t, _38_65) -> begin
...
in (FStar_List.fold_left (fun n _38_88 -> (match (_38_88) with
| (p, wopt, t) -> begin
(
...
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inl (t2), _38_101) -> begin
(let _139_66 = (free_names_and_uvars t1)
in (let _139_65 = (free_names_and_uvars t2)
in (union _139_66 _139_65)))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inr (c), _38_108) -> begin
...
| FStar_Syntax_Syntax.Tm_meta (t, FStar_Syntax_Syntax.Meta_monadic (_38_124, t')) -> begin
(let _139_78 = (free_names_and_uvars t)
in (let _139_77 = (free_names_and_uvars t')
in (union _139_78 _139_77)))
end
| FStar_Syntax_Syntax.Tm_meta (t, _38_132) -> begin
...
let _38_139 = (FStar_ST.op_Colon_Equals t.FStar_Syntax_Syntax.vars None)
...
let _38_144 = (FStar_ST.op_Colon_Equals t.FStar_Syntax_Syntax.vars (Some (n)))
in n))
end)))
and free_names_and_uvars_args : FStar_Syntax_Syntax.args  ->  FStar_Syntax_Syntax.free_vars  ->  FStar_Syntax_Syntax.free_vars = (fun args acc -> (FStar_All.pipe_right args (FStar_List.fold_left (fun n _38_152 -> (match (_38_152) with
| (x, _38_151) -> begin
(let _139_84 = (free_names_and_uvars x)
in (union n _139_84))
end)) acc)))
and free_names_and_uvars_binders = (fun bs acc -> (FStar_All.pipe_right bs (FStar_List.fold_left (fun n _38_159 -> (match (_38_159) with
| (x, _38_158) -> begin
...
let _38_163 = (FStar_ST.op_Colon_Equals c.FStar_Syntax_Syntax.vars None)
...
let _38_188 = (FStar_ST.op_Colon_Equals c.FStar_Syntax_Syntax.vars (Some (n)))
in n))
end))
...
in (FStar_All.pipe_right _139_97 (FStar_Util.for_some (fun _38_194 -> (match (_38_194) with
| (u, _38_193) -> begin
(match ((FStar_Unionfind.find u)) with
| FStar_Syntax_Syntax.Fixed (_38_196) -> begin
true
end
| _38_199 -> begin
false
