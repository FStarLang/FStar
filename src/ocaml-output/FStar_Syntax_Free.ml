...
type free_vars_and_fvars =
  ...
  , FStar_Ident.lident FStar_Util.set )
...
let singleton_fvar
  ...
  fun fv ->
    let uu____43 =
      ...
      FStar_Util.set_add fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v
        uu____46
    in
  ...
  fun f1 f2 ->
    let uu____227 =
      FStar_Util.set_union
        (FStar_Pervasives_Native.snd f1)
    ...
    ( { FStar_Syntax_Syntax.free_names=
      ...
      ; FStar_Syntax_Syntax.free_univ_names=
          FStar_List.append
            (FStar_Pervasives_Native.fst f2)
              .FStar_Syntax_Syntax.free_univ_names
            (FStar_Pervasives_Native.fst f1)
              .FStar_Syntax_Syntax.free_univ_names }
    , uu____227 )
  ...
  fun tm use_cache ->
    let aux_binders bs from_body =
      let from_binders =
        FStar_All.pipe_right bs
          (FStar_List.fold_left
             (fun n1 uu____467 ->
               match uu____467 with x, uu____485 ->
                 let uu____486 =
    ...
    | FStar_Syntax_Syntax.Tm_match (t1, pats) ->
        let uu____748 =
          ...
          FStar_List.fold_left
            (fun n1 uu____808 ->
              match uu____808 with p, wopt, t2 ->
                let n11 =
                  match wopt with
    ...
    | FStar_Syntax_Syntax.Tm_ascribed (t1, asc, uu____948) -> (
        ...
        let u2 =
          ...
          | FStar_Util.Inr c2 -> free_names_and_uvars_comp c2 use_cache
        in
        ...
        let uu____1086 =
          ...
          FStar_List.fold_left
            (fun n1 lb ->
              let uu____1121 =
                let uu____1128 =
                  free_names_and_uvars lb.FStar_Syntax_Syntax.lbtyp use_cache
                in
                let uu____1135 =
                  free_names_and_uvars lb.FStar_Syntax_Syntax.lbdef use_cache
                in
                union uu____1128 uu____1135
              in
              union n1 uu____1121 )
            uu____1097
        in
    ...
    | FStar_Syntax_Syntax.Tm_meta (t1, FStar_Syntax_Syntax.Meta_pattern args) ->
        ...
        FStar_List.fold_right
          (fun a acc -> free_names_and_uvars_args a acc use_cache)
          args uu____1168
...
and free_names_and_uvars
  ...
  fun t use_cache ->
    ...
    | FStar_Pervasives_Native.Some n1
      when let uu____1276 = should_invalidate_cache n1 use_cache in
...
and free_names_and_uvars_args
  ...
  fun args acc use_cache ->
    FStar_All.pipe_right args
      (FStar_List.fold_left
         (fun n1 uu____1385 ->
           match uu____1385 with x, uu____1405 ->
...
and free_names_and_uvars_binders
    : FStar_Syntax_Syntax.binders
      ...
      -> ( FStar_Syntax_Syntax.free_vars
         , FStar_Ident.lident FStar_Util.set )
         FStar_Pervasives_Native.tuple2 =
  fun bs acc use_cache ->
    FStar_All.pipe_right bs
      (FStar_List.fold_left
         (fun n1 uu____1448 ->
           match uu____1448 with x, uu____1466 ->
             let uu____1467 =
               free_names_and_uvars x.FStar_Syntax_Syntax.sort use_cache
             in
             union n1 uu____1467 )
          ...
          | FStar_Syntax_Syntax.Comp ct ->
              let us =
                ...
                free_names_and_uvars_args ct.FStar_Syntax_Syntax.effect_args
                  uu____1624 use_cache
              in
              FStar_List.fold_left
                (fun us1 u ->
                  let uu____1648 = free_univs u in
                  union us1 uu____1648 )
...
and should_invalidate_cache
  ...
  fun n1 use_cache ->
    ...
    || FStar_All.pipe_right n1.FStar_Syntax_Syntax.free_uvars
         (FStar_Util.for_some (fun uu____1712 ->
              match uu____1712 with u, uu____1720 ->
...
let compare_uv:
      ...
      -> ( FStar_Syntax_Syntax.uvar
         , 'Auu____1746 )
         FStar_Pervasives_Native.tuple2 -> Prims.int =
  fun uv1 uv2 ->
    let uu____1772 =
      FStar_Syntax_Unionfind.uvar_id (FStar_Pervasives_Native.fst uv1)
    in
    let uu____1773 =
      FStar_Syntax_Unionfind.uvar_id (FStar_Pervasives_Native.fst uv2)
    in
...
let compare_universe_uvar
    : FStar_Syntax_Syntax.universe_uvar -> FStar_Syntax_Syntax.universe_uvar
      -> Prims.int =
  fun x y ->
  ...
  fun t ->
    let uu____1807 =
      let uu____1810 =
        ...
        FStar_Pervasives_Native.fst uu____1811
      in
      uu____1810.FStar_Syntax_Syntax.free_names
    in
  ...
  fun t ->
    let uu____1829 =
      let uu____1848 =
        ...
        FStar_Pervasives_Native.fst uu____1849
      in
      uu____1848.FStar_Syntax_Syntax.free_uvars
    in
...
let univs
  ...
  fun t ->
    let uu____1883 =
      ...
      in
      uu____1886.FStar_Syntax_Syntax.free_univs
    in
  ...
  fun t ->
    let uu____1901 =
      let uu____1904 =
        ...
        FStar_Pervasives_Native.fst uu____1905
      in
      uu____1904.FStar_Syntax_Syntax.free_univ_names
    in
  ...
  fun bs ->
    let uu____1933 =
      let uu____1936 =
        ...
        FStar_Pervasives_Native.fst uu____1937
      in
      uu____1936.FStar_Syntax_Syntax.free_names
    in
