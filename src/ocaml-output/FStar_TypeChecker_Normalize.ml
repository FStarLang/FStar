                      ...
                      (log cfg
                       ...
                       (let ty = norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp in
                        let lbname =
                          ...
                          FStar_Util.Inl
                            (let uu___239_13499 = x in
                             {
                               FStar_Syntax_Syntax.ppname =
                                 (uu___239_13499.FStar_Syntax_Syntax.ppname);
                               FStar_Syntax_Syntax.index =
                                 (uu___239_13499.FStar_Syntax_Syntax.index);
                               FStar_Syntax_Syntax.sort = ty
                             }) in
                        log cfg
                          (fun uu____13502  ->
                        ...
                        (let lb1 =
                           let uu___240_13504 = lb in
                           let uu____13505 =
                             norm cfg env [] lb.FStar_Syntax_Syntax.lbdef in
                           {
                             FStar_Syntax_Syntax.lbname = lbname;
                             FStar_Syntax_Syntax.lbunivs =
                               (uu___240_13504.FStar_Syntax_Syntax.lbunivs);
                             FStar_Syntax_Syntax.lbtyp = ty;
                             FStar_Syntax_Syntax.lbeff =
                               (uu___240_13504.FStar_Syntax_Syntax.lbeff);
                         ...
                         let cfg1 =
                           let uu___241_13560 = cfg in
                           {
                             steps = (uu___241_13560.steps);
                             tcenv = (uu___241_13560.tcenv);
                             delta_level = (uu___241_13560.delta_level);
                             primitive_steps =
                               (uu___241_13560.primitive_steps);
                             strong = true
                           } in
                         log cfg1
                           (fun uu____13563  ->
               ...
               (match uu____13580 with
                | (lbs1,body1) ->
                        ...
                        (fun lb  ->
                           ...
                           let lbname =
                             let uu____13616 =
                               ...
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___242_13617.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___242_13617.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = ty
                               } in
                                 ...
                                 | FStar_Pervasives_Native.Some rc ->
                                     let uu____13714 =
                                           ...
                                           (norm cfg env1 []) in
                                       {
                                         FStar_Syntax_Syntax.residual_effect
                                           =
                                           (uu___243_13715.FStar_Syntax_Syntax.residual_effect);
                                         FStar_Syntax_Syntax.residual_typ =
                                           uu____13716;
                                         FStar_Syntax_Syntax.residual_flags =
                                           (uu___243_13715.FStar_Syntax_Syntax.residual_flags)
                                       } in
                                     FStar_Pervasives_Native.Some uu____13714
                                 | uu____13723 -> lopt in
                               let def =
                                 FStar_Syntax_Util.abs xs1 def_body1 lopt1 in
                               let uu___244_13727 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname = lbname;
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___244_13727.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp = ty;
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___244_13727.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef = def
                               }) lbs1 in
                    let env' =
                      let uu____13737 =
                    ...
                    (match uu____13761 with
                     | (lbs3,body3) ->
                         let t2 =
                           let uu___245_13777 = t1 in
                           {
                             FStar_Syntax_Syntax.n =
                               (FStar_Syntax_Syntax.Tm_let
                                  ((true, lbs3), body3));
                             FStar_Syntax_Syntax.pos =
                               (uu___245_13777.FStar_Syntax_Syntax.pos);
                             FStar_Syntax_Syntax.vars =
                               (uu___245_13777.FStar_Syntax_Syntax.vars)
                           } in
                         rebuild cfg env stack t2))
           | FStar_Syntax_Syntax.Tm_let (lbs,body) when
               FStar_List.contains (Exclude Zeta) cfg.steps ->
               let uu____13804 = closure_as_term cfg env t1 in
               rebuild cfg env stack uu____13804
                      ...
                      fun uu____13899  ->
                        ...
                        | (rec_env,memos,i) ->
                            let bv =
                              ...
                              {
                                FStar_Syntax_Syntax.ppname =
                                  (uu___246_14020.FStar_Syntax_Syntax.ppname);
                                FStar_Syntax_Syntax.index = i;
                                FStar_Syntax_Syntax.sort =
                                  (uu___246_14020.FStar_Syntax_Syntax.sort)
                              } in
           ...
           | FStar_Syntax_Syntax.Tm_meta (head1,m) ->
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                    let uu____14945 =
                      let uu____14946 = should_reify cfg stack in
                        ...
                        then
                          let uu___247_14957 = cfg in
                          {
                            steps =
                              ...
                              Exclude Zeta;
                              NoDeltaSteps];
                            tcenv = (uu___247_14957.tcenv);
                            delta_level =
                              [FStar_TypeChecker_Env.Inlining;
                              FStar_TypeChecker_Env.Eager_unfolding_only];
                            primitive_steps =
                              (uu___247_14957.primitive_steps);
                            strong = (uu___247_14957.strong)
                          }
                        else
                          (let uu___248_14959 = cfg in
                           {
                             steps =
                               (FStar_List.append [Exclude Zeta] cfg.steps);
                             tcenv = (uu___248_14959.tcenv);
                             delta_level = (uu___248_14959.delta_level);
                             primitive_steps =
                               (uu___248_14959.primitive_steps);
                             strong = (uu___248_14959.strong)
                           }) in
                      norm cfg1 env
                        ((Meta
                                 ...
                                 | FStar_Util.Inl x ->
                                     ...
                                     (match uu____15033 with
                                      | FStar_Pervasives_Native.Some e ->
                                          let lb1 =
                                            let uu___249_15038 = lb in
                                            {
                                              FStar_Syntax_Syntax.lbname =
                                                (uu___249_15038.FStar_Syntax_Syntax.lbname);
                                              FStar_Syntax_Syntax.lbunivs =
                                                (uu___249_15038.FStar_Syntax_Syntax.lbunivs);
                                              FStar_Syntax_Syntax.lbtyp =
                                                (uu___249_15038.FStar_Syntax_Syntax.lbtyp);
                                              FStar_Syntax_Syntax.lbeff =
                                ...
                                ((let is_arg_impure uu____15370 =
                                 ...
                                 (let uu____15410 =
                                  ...
                                  | (head_app1,found_action) ->
                                      ...
                                      let uu____15449 = FStar_List.tl stack in
                       ...
                       | FStar_Syntax_Syntax.Tm_match (e,branches) ->
                           ...
                           let tm =
                             mk (FStar_Syntax_Syntax.Tm_match (e, branches1))
                               t2.FStar_Syntax_Syntax.pos in
                           let uu____15665 = FStar_List.tl stack in
                           norm cfg env uu____15665 tm
                       | uu____15666 -> norm cfg env stack head1)
                | FStar_Syntax_Syntax.Meta_monadic_lift (m1,m',t2) ->
                    let uu____15674 = should_reify cfg stack in
                    if uu____15674
                    then
                      let uu____15675 = FStar_List.tl stack in
                      let uu____15676 =
                         ...
                         let cfg1 =
                           let uu___250_15689 = cfg in
                           {
                             steps =
                               ...
                               EraseUniverses;
                               Exclude Zeta];
                             tcenv = (uu___250_15689.tcenv);
                             delta_level =
                               [FStar_TypeChecker_Env.Inlining;
                               FStar_TypeChecker_Env.Eager_unfolding_only];
                             primitive_steps =
                               (uu___250_15689.primitive_steps);
                             strong = (uu___250_15689.strong)
                           } in
                         norm cfg1 env
                           ((Meta
                                ...
                                norm cfg env
                                  ((Meta
                                      ((FStar_Syntax_Syntax.Meta_pattern
                                        ...
                                        (t1.FStar_Syntax_Syntax.pos))) ::
                                  stack) head1
                            | uu____15731 -> norm cfg env stack head1)
                       | [] ->
            ...
            | FStar_Pervasives_Native.Some (us,t) ->
                (log cfg
                 ...
                 (let t1 =
                  ...
                  then
                    match stack with
                    | (UnivArgs (us',uu____15807))::stack1 ->
                        let env1 =
      ...
      fun comp  ->
        ...
        | FStar_Syntax_Syntax.Total (t,uopt) ->
              ...
              FStar_Syntax_Syntax.Total uu____16088 in
            {
              ...
              FStar_Syntax_Syntax.pos =
                (uu___251_16084.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___251_16084.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.GTotal (t,uopt) ->
            let uu___252_16113 = comp1 in
            let uu____16116 =
              let uu____16117 =
              ...
              FStar_Syntax_Syntax.GTotal uu____16117 in
            {
              ...
              FStar_Syntax_Syntax.pos =
                (uu___252_16113.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___252_16113.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.Comp ct ->
            ...
            let flags =
              FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
                (FStar_List.map
                   (fun uu___201_16201  ->
                      match uu___201_16201 with
                      | FStar_Syntax_Syntax.DECREASES t ->
                          let uu____16205 = norm cfg env [] t in
                          FStar_Syntax_Syntax.DECREASES uu____16205
                      | f -> f)) in
            let uu___253_16209 = comp1 in
            let uu____16212 =
              let uu____16213 =
                let uu___254_16214 = ct in
                let uu____16215 =
                  FStar_List.map (norm_universe cfg env)
                  ...
                  norm_args ct.FStar_Syntax_Syntax.effect_args in
                {
                  ...
                  FStar_Syntax_Syntax.effect_name =
                    (uu___254_16214.FStar_Syntax_Syntax.effect_name);
              ...
              FStar_Syntax_Syntax.Comp uu____16213 in
            {
              ...
              FStar_Syntax_Syntax.pos =
                (uu___253_16209.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___253_16209.FStar_Syntax_Syntax.vars)
            }
  ...
  fun cfg  ->
    fun env  ->
      fun c  ->
        let norm1 t =
          norm
            (let uu___255_16237 = cfg in
             {
               steps =
                 [Eager_unfolding;
                 UnfoldUntil FStar_Syntax_Syntax.Delta_constant;
                 AllowUnboundUniverses];
               tcenv = (uu___255_16237.tcenv);
               delta_level = (uu___255_16237.delta_level);
               primitive_steps = (uu___255_16237.primitive_steps);
               strong = (uu___255_16237.strong)
             }) env [] t in
        let non_info t =
        ...
        | FStar_Syntax_Syntax.GTotal (t,uopt) when non_info t ->
            let uu___256_16264 = c in
            {
              FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Total (t, uopt));
              FStar_Syntax_Syntax.pos =
                (uu___256_16264.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___256_16264.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.Comp ct ->
            let l =
              FStar_TypeChecker_Env.norm_eff_name cfg.tcenv
            ...
            then
              let ct1 =
                ...
                | FStar_Pervasives_Native.Some pure_eff ->
                    ...
                    let uu___257_16282 = ct in
                    {
                      FStar_Syntax_Syntax.comp_univs =
                        (uu___257_16282.FStar_Syntax_Syntax.comp_univs);
                      FStar_Syntax_Syntax.effect_name = pure_eff;
                      FStar_Syntax_Syntax.result_typ =
                        (uu___257_16282.FStar_Syntax_Syntax.result_typ);
                      FStar_Syntax_Syntax.effect_args =
                        (uu___257_16282.FStar_Syntax_Syntax.effect_args);
                      FStar_Syntax_Syntax.flags = flags
                    }
                | FStar_Pervasives_Native.None  ->
                    let ct1 =
                      FStar_TypeChecker_Env.unfold_effect_abbrev cfg.tcenv c in
                    let uu___258_16284 = ct1 in
                    {
                      FStar_Syntax_Syntax.comp_univs =
                        (uu___258_16284.FStar_Syntax_Syntax.comp_univs);
                      FStar_Syntax_Syntax.effect_name =
                        FStar_Parser_Const.effect_PURE_lid;
                      FStar_Syntax_Syntax.result_typ =
                        (uu___258_16284.FStar_Syntax_Syntax.result_typ);
                      FStar_Syntax_Syntax.effect_args =
                        (uu___258_16284.FStar_Syntax_Syntax.effect_args);
                      FStar_Syntax_Syntax.flags =
                        (uu___258_16284.FStar_Syntax_Syntax.flags)
                    } in
              let uu___259_16285 = c in
              {
                FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
                FStar_Syntax_Syntax.pos =
                  (uu___259_16285.FStar_Syntax_Syntax.pos);
                FStar_Syntax_Syntax.vars =
                  (uu___259_16285.FStar_Syntax_Syntax.vars)
              }
            else c
        | uu____16287 -> c
and norm_binder:
  ...
  fun cfg  ->
    fun env  ->
      fun uu____16290  ->
        ...
        | (x,imp) ->
            let uu____16293 =
              let uu___260_16294 = x in
              let uu____16295 = norm cfg env [] x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___260_16294.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___260_16294.FStar_Syntax_Syntax.index);
    ...
    fun env  ->
      fun lopt  ->
        ...
        | FStar_Pervasives_Native.Some rc ->
            ...
            let uu____16375 =
              let uu___261_16376 = rc in
              let uu____16377 =
                FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                  (norm cfg env []) in
              {
                FStar_Syntax_Syntax.residual_effect =
                  (uu___261_16376.FStar_Syntax_Syntax.residual_effect);
                FStar_Syntax_Syntax.residual_typ = uu____16377;
                FStar_Syntax_Syntax.residual_flags =
                  (uu___261_16376.FStar_Syntax_Syntax.residual_flags)
              } in
        ...
        fun t  ->
          log cfg
            (fun uu____16397  ->
               ...
               let uu____16407 =
                 let uu____16408 =
                   let uu____16411 = firstn (Prims.parse_int "4") stack in
                   FStar_All.pipe_left FStar_Pervasives_Native.fst
                     uu____16411 in
          ...
          (match stack with
           ...
           | (Steps (s,ps,dl))::stack1 ->
               rebuild
                 (let uu___262_16468 = cfg in
                  {
                    steps = s;
                    tcenv = (uu___262_16468.tcenv);
                    delta_level = dl;
                    primitive_steps = ps;
                    strong = (uu___262_16468.strong)
                  }) env stack1 t
           | (Meta (m,r))::stack1 ->
           ...
           | (Abs (env',bs,env'',lopt,r))::stack1 ->
               ...
               let uu____16546 =
                 let uu___263_16547 = FStar_Syntax_Util.abs bs1 t lopt1 in
                 {
                   FStar_Syntax_Syntax.n =
                     (uu___263_16547.FStar_Syntax_Syntax.n);
                   FStar_Syntax_Syntax.pos = r;
                   FStar_Syntax_Syntax.vars =
                     (uu___263_16547.FStar_Syntax_Syntax.vars)
                 } in
               rebuild cfg env stack1 uu____16546
           ...
           | (UnivArgs (us,r))::stack1 ->
               ...
               rebuild cfg env stack1 t1
           | (Arg (Clos (env_arg,tm,m,uu____16572),aq,r))::stack1 ->
               (log cfg
                  (fun uu____16625  ->
           ...
           | (App (env1,head1,aq,r))::stack1 ->
               let t1 =
                 FStar_Syntax_Syntax.extend_app head1 (t, aq)
                   FStar_Pervasives_Native.None r in
               let uu____16823 = maybe_simplify cfg env1 stack1 t1 in
               rebuild cfg env1 stack1 uu____16823
                   ...
                   (let whnf =
                    ...
                    let cfg_exclude_iota_zeta =
                      let new_delta =
                        FStar_All.pipe_right cfg.delta_level
                          (FStar_List.filter
                             (fun uu___202_16894  ->
                                match uu___202_16894 with
                                | FStar_TypeChecker_Env.Inlining  -> true
                                | FStar_TypeChecker_Env.Eager_unfolding_only 
                                    -> true
                                | uu____16895 -> false)) in
                      let steps' = [Exclude Zeta] in
                      let uu___264_16899 = cfg in
                      {
                        steps = (FStar_List.append steps' cfg.steps);
                        tcenv = (uu___264_16899.tcenv);
                        delta_level = new_delta;
                        primitive_steps = (uu___264_16899.primitive_steps);
                        strong = true
                      } in
                    ...
                    let rec norm_pat env2 p =
                      ...
                      | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
                          ...
                          (match uu____16952 with
                           | (pats1,env3) ->
                               ((let uu___265_17186 = p in
                                 {
                                   FStar_Syntax_Syntax.v =
                                     (FStar_Syntax_Syntax.Pat_cons
                                        (fv, (FStar_List.rev pats1)));
                                   FStar_Syntax_Syntax.p =
                                     (uu___265_17186.FStar_Syntax_Syntax.p)
                                 }), env3))
                      | FStar_Syntax_Syntax.Pat_var x ->
                          let x1 =
                            let uu___266_17205 = x in
                            let uu____17206 =
                              norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___266_17205.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___266_17205.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = uu____17206
                            } in
                          ((let uu___267_17220 = p in
                            {
                              FStar_Syntax_Syntax.v =
                                (FStar_Syntax_Syntax.Pat_var x1);
                              FStar_Syntax_Syntax.p =
                                (uu___267_17220.FStar_Syntax_Syntax.p)
                            }), (dummy :: env2))
                      | FStar_Syntax_Syntax.Pat_wild x ->
                          let x1 =
                            let uu___268_17231 = x in
                            let uu____17232 =
                              norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___268_17231.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___268_17231.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = uu____17232
                            } in
                          ((let uu___269_17246 = p in
                            {
                              FStar_Syntax_Syntax.v =
                                (FStar_Syntax_Syntax.Pat_wild x1);
                              FStar_Syntax_Syntax.p =
                                (uu___269_17246.FStar_Syntax_Syntax.p)
                            }), (dummy :: env2))
                      | FStar_Syntax_Syntax.Pat_dot_term (x,t1) ->
                          let x1 =
                            let uu___270_17262 = x in
                            let uu____17263 =
                              norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                            {
                              FStar_Syntax_Syntax.ppname =
                                (uu___270_17262.FStar_Syntax_Syntax.ppname);
                              FStar_Syntax_Syntax.index =
                                (uu___270_17262.FStar_Syntax_Syntax.index);
                              FStar_Syntax_Syntax.sort = uu____17263
                            } in
                          let t2 = norm_or_whnf env2 t1 in
                          ((let uu___271_17270 = p in
                            {
                              FStar_Syntax_Syntax.v =
                                (FStar_Syntax_Syntax.Pat_dot_term (x1, t2));
                              FStar_Syntax_Syntax.p =
                                (uu___271_17270.FStar_Syntax_Syntax.p)
                            }), env2) in
                    let branches1 =
                      match env1 with
                      | [] when whnf -> branches
                    ...
                    let uu____17345 =
                      mk
                        ...
                        r in
                    rebuild cfg env1 stack1 uu____17345) in
                        ...
                        | FStar_Util.Inl s ->
                            (log cfg
                             ...
                             (let env2 =
                              ...
                              norm cfg env2 stack1 uu____18226))) in
                 let uu____18227 =
                   FStar_All.pipe_right cfg.steps
    ...
    fun s  ->
      fun e  ->
        fun t  ->
          let c = config s e in
          let c1 =
            let uu___272_18283 = config s e in
            {
              steps = (uu___272_18283.steps);
              tcenv = (uu___272_18283.tcenv);
              delta_level = (uu___272_18283.delta_level);
              primitive_steps = (FStar_List.append c.primitive_steps ps);
              strong = (uu___272_18283.strong)
            } in
          norm c1 [] [] t
let normalize:
  steps ->
  ...
  fun env  ->
    fun lc  ->
      ...
      then
        ...
        with
        | FStar_Pervasives_Native.Some pure_eff ->
            let uu___273_18361 = lc in
            {
              FStar_Syntax_Syntax.eff_name = pure_eff;
              FStar_Syntax_Syntax.res_typ =
                (uu___273_18361.FStar_Syntax_Syntax.res_typ);
              FStar_Syntax_Syntax.cflags =
                (uu___273_18361.FStar_Syntax_Syntax.cflags);
              FStar_Syntax_Syntax.comp =
                ((fun uu____18364  ->
           ...
           | (head1,args) ->
               ...
               (match uu____18621 with
                         ...
                         then t
                           ...
                           (let uu____18693 =
                              env.FStar_TypeChecker_Env.type_of
                                (let uu___278_18701 = env in
                                 {
                                   FStar_TypeChecker_Env.solver =
                                     (uu___278_18701.FStar_TypeChecker_Env.solver);
                                   FStar_TypeChecker_Env.range =
                                     (uu___278_18701.FStar_TypeChecker_Env.range);
                                   FStar_TypeChecker_Env.curmodule =
                                     (uu___278_18701.FStar_TypeChecker_Env.curmodule);
                                   FStar_TypeChecker_Env.gamma =
                                     (uu___278_18701.FStar_TypeChecker_Env.gamma);
                                   FStar_TypeChecker_Env.gamma_cache =
                                     (uu___278_18701.FStar_TypeChecker_Env.gamma_cache);
                                   FStar_TypeChecker_Env.modules =
                                     (uu___278_18701.FStar_TypeChecker_Env.modules);
                                   FStar_TypeChecker_Env.expected_typ =
                                     FStar_Pervasives_Native.None;
                                   FStar_TypeChecker_Env.sigtab =
                                     (uu___278_18701.FStar_TypeChecker_Env.sigtab);
                                   FStar_TypeChecker_Env.is_pattern =
                                     (uu___278_18701.FStar_TypeChecker_Env.is_pattern);
                                   FStar_TypeChecker_Env.instantiate_imp =
                                     (uu___278_18701.FStar_TypeChecker_Env.instantiate_imp);
                                   FStar_TypeChecker_Env.effects =
                                     (uu___278_18701.FStar_TypeChecker_Env.effects);
                                   FStar_TypeChecker_Env.generalize =
                                     (uu___278_18701.FStar_TypeChecker_Env.generalize);
                                   FStar_TypeChecker_Env.letrecs =
                                     (uu___278_18701.FStar_TypeChecker_Env.letrecs);
                                   FStar_TypeChecker_Env.top_level =
                                     (uu___278_18701.FStar_TypeChecker_Env.top_level);
                                   FStar_TypeChecker_Env.check_uvars =
                                     (uu___278_18701.FStar_TypeChecker_Env.check_uvars);
                                   FStar_TypeChecker_Env.use_eq =
                                     (uu___278_18701.FStar_TypeChecker_Env.use_eq);
                                   FStar_TypeChecker_Env.is_iface =
                                     (uu___278_18701.FStar_TypeChecker_Env.is_iface);
                                   FStar_TypeChecker_Env.admit =
                                     (uu___278_18701.FStar_TypeChecker_Env.admit);
                                   FStar_TypeChecker_Env.lax = true;
                                   FStar_TypeChecker_Env.lax_universes =
                                     (uu___278_18701.FStar_TypeChecker_Env.lax_universes);
                                   FStar_TypeChecker_Env.failhard =
                                     (uu___278_18701.FStar_TypeChecker_Env.failhard);
                                   FStar_TypeChecker_Env.nosynth =
                                     (uu___278_18701.FStar_TypeChecker_Env.nosynth);
                                   FStar_TypeChecker_Env.tc_term =
                                     (uu___278_18701.FStar_TypeChecker_Env.tc_term);
                                   FStar_TypeChecker_Env.type_of =
                                     (uu___278_18701.FStar_TypeChecker_Env.type_of);
                                   FStar_TypeChecker_Env.universe_of =
                                     (uu___278_18701.FStar_TypeChecker_Env.universe_of);
                                   FStar_TypeChecker_Env.use_bv_sorts = true;
                                   FStar_TypeChecker_Env.qname_and_index =
                                     (uu___278_18701.FStar_TypeChecker_Env.qname_and_index);
                                   FStar_TypeChecker_Env.proof_ns =
                                     (uu___278_18701.FStar_TypeChecker_Env.proof_ns);
                                   FStar_TypeChecker_Env.synth =
                                     (uu___278_18701.FStar_TypeChecker_Env.synth);
                                   FStar_TypeChecker_Env.is_native_tactic =
                                     (uu___278_18701.FStar_TypeChecker_Env.is_native_tactic);
                                   FStar_TypeChecker_Env.identifier_info =
                                     (uu___278_18701.FStar_TypeChecker_Env.identifier_info);
                                   FStar_TypeChecker_Env.tc_hooks =
                                     (uu___278_18701.FStar_TypeChecker_Env.tc_hooks);
                                   FStar_TypeChecker_Env.dsenv =
                                     (uu___278_18701.FStar_TypeChecker_Env.dsenv);
                                   FStar_TypeChecker_Env.dep_graph =
                                     (uu___278_18701.FStar_TypeChecker_Env.dep_graph)
                                 }) t in
                ...
                | uu____18705 ->
                    let uu____18706 =
                      env.FStar_TypeChecker_Env.type_of
                        (let uu___279_18714 = env in
                         {
                           FStar_TypeChecker_Env.solver =
                             (uu___279_18714.FStar_TypeChecker_Env.solver);
                           FStar_TypeChecker_Env.range =
                             (uu___279_18714.FStar_TypeChecker_Env.range);
                           FStar_TypeChecker_Env.curmodule =
                             (uu___279_18714.FStar_TypeChecker_Env.curmodule);
                           FStar_TypeChecker_Env.gamma =
                             (uu___279_18714.FStar_TypeChecker_Env.gamma);
                           FStar_TypeChecker_Env.gamma_cache =
                             (uu___279_18714.FStar_TypeChecker_Env.gamma_cache);
                           FStar_TypeChecker_Env.modules =
                             (uu___279_18714.FStar_TypeChecker_Env.modules);
                           FStar_TypeChecker_Env.expected_typ =
                             FStar_Pervasives_Native.None;
                           FStar_TypeChecker_Env.sigtab =
                             (uu___279_18714.FStar_TypeChecker_Env.sigtab);
                           FStar_TypeChecker_Env.is_pattern =
                             (uu___279_18714.FStar_TypeChecker_Env.is_pattern);
                           FStar_TypeChecker_Env.instantiate_imp =
                             (uu___279_18714.FStar_TypeChecker_Env.instantiate_imp);
                           FStar_TypeChecker_Env.effects =
                             (uu___279_18714.FStar_TypeChecker_Env.effects);
                           FStar_TypeChecker_Env.generalize =
                             (uu___279_18714.FStar_TypeChecker_Env.generalize);
                           FStar_TypeChecker_Env.letrecs =
                             (uu___279_18714.FStar_TypeChecker_Env.letrecs);
                           FStar_TypeChecker_Env.top_level =
                             (uu___279_18714.FStar_TypeChecker_Env.top_level);
                           FStar_TypeChecker_Env.check_uvars =
                             (uu___279_18714.FStar_TypeChecker_Env.check_uvars);
                           FStar_TypeChecker_Env.use_eq =
                             (uu___279_18714.FStar_TypeChecker_Env.use_eq);
                           FStar_TypeChecker_Env.is_iface =
                             (uu___279_18714.FStar_TypeChecker_Env.is_iface);
                           FStar_TypeChecker_Env.admit =
                             (uu___279_18714.FStar_TypeChecker_Env.admit);
                           FStar_TypeChecker_Env.lax = true;
                           FStar_TypeChecker_Env.lax_universes =
                             (uu___279_18714.FStar_TypeChecker_Env.lax_universes);
                           FStar_TypeChecker_Env.failhard =
                             (uu___279_18714.FStar_TypeChecker_Env.failhard);
                           FStar_TypeChecker_Env.nosynth =
                             (uu___279_18714.FStar_TypeChecker_Env.nosynth);
                           FStar_TypeChecker_Env.tc_term =
                             (uu___279_18714.FStar_TypeChecker_Env.tc_term);
                           FStar_TypeChecker_Env.type_of =
                             (uu___279_18714.FStar_TypeChecker_Env.type_of);
                           FStar_TypeChecker_Env.universe_of =
                             (uu___279_18714.FStar_TypeChecker_Env.universe_of);
                           FStar_TypeChecker_Env.use_bv_sorts = true;
                           FStar_TypeChecker_Env.qname_and_index =
                             (uu___279_18714.FStar_TypeChecker_Env.qname_and_index);
                           FStar_TypeChecker_Env.proof_ns =
                             (uu___279_18714.FStar_TypeChecker_Env.proof_ns);
                           FStar_TypeChecker_Env.synth =
                             (uu___279_18714.FStar_TypeChecker_Env.synth);
                           FStar_TypeChecker_Env.is_native_tactic =
                             (uu___279_18714.FStar_TypeChecker_Env.is_native_tactic);
                           FStar_TypeChecker_Env.identifier_info =
                             (uu___279_18714.FStar_TypeChecker_Env.identifier_info);
                           FStar_TypeChecker_Env.tc_hooks =
                             (uu___279_18714.FStar_TypeChecker_Env.tc_hooks);
                           FStar_TypeChecker_Env.dsenv =
                             (uu___279_18714.FStar_TypeChecker_Env.dsenv);
                           FStar_TypeChecker_Env.dep_graph =
                             (uu___279_18714.FStar_TypeChecker_Env.dep_graph)
                         }) t in
      ...
      | FStar_Syntax_Syntax.Sig_inductive_typ
          ...
          (match uu____19333 with
           | (univ_names1,binders1,typ1) ->
               let uu___280_19361 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_inductive_typ
                      (lid, univ_names1, binders1, typ1, lids, lids'));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___280_19361.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___280_19361.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___280_19361.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___280_19361.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_bundle (sigs,lids) ->
          let uu___281_19382 = s in
          let uu____19383 =
            let uu____19384 =
            ...
            FStar_Syntax_Syntax.Sig_bundle uu____19384 in
          {
            ...
            FStar_Syntax_Syntax.sigrng =
              (uu___281_19382.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___281_19382.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___281_19382.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___281_19382.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_datacon (lid,univ_names,typ,lident,i,lids) ->
          let uu____19410 = elim_uvars_aux_t env univ_names [] typ in
          (match uu____19410 with
           | (univ_names1,uu____19428,typ1) ->
               let uu___282_19442 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_datacon
                      (lid, univ_names1, typ1, lident, i, lids));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___282_19442.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___282_19442.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___282_19442.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___282_19442.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_declare_typ (lid,univ_names,typ) ->
          let uu____19448 = elim_uvars_aux_t env univ_names [] typ in
          (match uu____19448 with
           | (univ_names1,uu____19466,typ1) ->
               let uu___283_19480 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_declare_typ
                      (lid, univ_names1, typ1));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___283_19480.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___283_19480.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___283_19480.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___283_19480.FStar_Syntax_Syntax.sigattrs)
               })
              ...
              (FStar_List.map
                 (fun lb  ->
                    ...
                    | (opening,lbunivs) ->
                        ...
                        let uu___284_19541 = lb in
                        {
                          FStar_Syntax_Syntax.lbname =
                            (uu___284_19541.FStar_Syntax_Syntax.lbname);
                          FStar_Syntax_Syntax.lbunivs = lbunivs;
                          FStar_Syntax_Syntax.lbtyp = lbtyp;
                          FStar_Syntax_Syntax.lbeff =
                            (uu___284_19541.FStar_Syntax_Syntax.lbeff);
                          FStar_Syntax_Syntax.lbdef = lbdef
                        })) in
          let uu___285_19542 = s in
          {
            FStar_Syntax_Syntax.sigel =
              (FStar_Syntax_Syntax.Sig_let ((b, lbs1), lids));
            FStar_Syntax_Syntax.sigrng =
              (uu___285_19542.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___285_19542.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___285_19542.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___285_19542.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_main t ->
          let uu___286_19554 = s in
          let uu____19555 =
            ...
            FStar_Syntax_Syntax.Sig_main uu____19556 in
          {
            ...
            FStar_Syntax_Syntax.sigrng =
              (uu___286_19554.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___286_19554.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___286_19554.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___286_19554.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_assume (l,us,t) ->
          let uu____19560 = elim_uvars_aux_t env us [] t in
          (match uu____19560 with
           | (us1,uu____19578,t1) ->
               let uu___287_19592 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_assume (l, us1, t1));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___287_19592.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___287_19592.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___287_19592.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___287_19592.FStar_Syntax_Syntax.sigattrs)
               })
                ...
                | (univs_opening,univs_closing) ->
                    ...
                    (match uu____19676 with
                     | (b_opening,b_closing) ->
                           ...
                           | (action_univs,t) ->
                               ...
                               (match uu____20160 with
                                | (action_params,action_defn,action_typ) ->
                                    let a' =
                                      let uu___288_20201 = a in
                                      {
                                        FStar_Syntax_Syntax.action_name =
                                          (uu___288_20201.FStar_Syntax_Syntax.action_name);
                                        FStar_Syntax_Syntax.action_unqualified_name
                                          =
                                          (uu___288_20201.FStar_Syntax_Syntax.action_unqualified_name);
                         ...
                         let ed1 =
                               ...
                               ed.FStar_Syntax_Syntax.actions in
                           {
                             FStar_Syntax_Syntax.cattributes =
                               (uu___289_20203.FStar_Syntax_Syntax.cattributes);
                             FStar_Syntax_Syntax.mname =
                               (uu___289_20203.FStar_Syntax_Syntax.mname);
                         ...
                         let uu___290_20220 = s in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_new_effect ed1);
                           FStar_Syntax_Syntax.sigrng =
                             (uu___290_20220.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             (uu___290_20220.FStar_Syntax_Syntax.sigquals);
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___290_20220.FStar_Syntax_Syntax.sigmeta);
                           FStar_Syntax_Syntax.sigattrs =
                             (uu___290_20220.FStar_Syntax_Syntax.sigattrs)
                         })))
      | FStar_Syntax_Syntax.Sig_sub_effect sub_eff ->
          let elim_tscheme_opt uu___204_20237 =
            match uu___204_20237 with
          ...
          let sub_eff1 =
              ...
              elim_tscheme_opt sub_eff.FStar_Syntax_Syntax.lift in
            {
              FStar_Syntax_Syntax.source =
                (uu___291_20307.FStar_Syntax_Syntax.source);
              FStar_Syntax_Syntax.target =
                (uu___291_20307.FStar_Syntax_Syntax.target);
      ...
      | FStar_Syntax_Syntax.Sig_effect_abbrev
          ...
          (match uu____20324 with
           | (univ_names1,binders1,comp1) ->
               let uu___293_20358 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_effect_abbrev
                      (lid, univ_names1, binders1, comp1, flags));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___293_20358.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___293_20358.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___293_20358.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___293_20358.FStar_Syntax_Syntax.sigattrs)
               })
