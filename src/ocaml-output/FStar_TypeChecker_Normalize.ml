...
let closure_to_string : closure  ->  Prims.string = (fun _56_1 -> (match (_56_1) with
| Clos (_56_25, t, _56_28, _56_30) -> begin
...
let is_empty = (fun _56_3 -> (match (_56_3) with
| [] -> begin
true
end
| _56_136 -> begin
...
let _56_171 = (FStar_Syntax_Subst.open_comp binders cdef)
in (match (_56_171) with
| (binders, cdef) -> begin
(

let _56_172 = if ((FStar_List.length binders) <> ((FStar_List.length c.FStar_Syntax_Syntax.effect_args) + (Prims.parse_int "1"))) then begin
...
in (FStar_List.map2 (fun _56_177 _56_181 -> (match (((_56_177), (_56_181))) with
| ((x, _56_176), (t, _56_180)) -> begin
...
let _56_184 = (comp_to_comp_typ env c1)
in {FStar_Syntax_Syntax.comp_univs = _56_184.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = _56_184.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _56_184.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _56_184.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = c.FStar_Syntax_Syntax.flags})
...
let _56_206 = (FStar_List.fold_left (fun _56_197 u -> (match (_56_197) with
| (cur_kernel, cur_max, out) -> begin
(

let _56_201 = (FStar_Syntax_Util.univ_kernel u)
...
let _56_250 = (FStar_Syntax_Util.univ_kernel u)
in (match (_56_250) with
| (_56_248, m) -> begin
(n <= m)
end))))) then begin
rest
...
let _56_273 = (log cfg (fun _56_272 -> (match (()) with
| () -> begin
...
| FStar_Syntax_Syntax.Tm_delayed (_56_280) -> begin
(failwith "Impossible")
end
| (FStar_Syntax_Syntax.Tm_unknown) | (FStar_Syntax_Syntax.Tm_constant (_)) | (FStar_Syntax_Syntax.Tm_name (_)) | (FStar_Syntax_Syntax.Tm_fvar (_)) -> begin
t
end
| FStar_Syntax_Syntax.Tm_uvar (_56_293) -> begin
t
end
...
let _56_327 = (closures_as_binders_delayed cfg env bs)
...
let _56_335 = (closures_as_binders_delayed cfg env bs)
in (match (_56_335) with
| (bs, env) -> begin
(
...
let _56_343 = (let _157_332 = (let _157_331 = (FStar_Syntax_Syntax.mk_binder x)
in (_157_331)::[])
in (closures_as_binders_delayed cfg env _157_332))
in (match (_56_343) with
| (x, env) -> begin
(
...
let env = (FStar_List.fold_left (fun env _56_390 -> (Dummy)::env) env lb.FStar_Syntax_Syntax.lbunivs)
in (
...
| FStar_Util.Inr (_56_396) -> begin
body
end
| FStar_Util.Inl (_56_399) -> begin
...
let _56_402 = lb
in {FStar_Syntax_Syntax.lbname = _56_402.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _56_402.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = typ; FStar_Syntax_Syntax.lbeff = _56_402.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = def})
in (mk (FStar_Syntax_Syntax.Tm_let (((((false), ((lb)::[]))), (body)))) t.FStar_Syntax_Syntax.pos)))))))
end
| FStar_Syntax_Syntax.Tm_let ((_56_406, lbs), body) -> begin
(

let norm_one_lb = (fun env lb -> (

let env_univs = (FStar_List.fold_right (fun _56_415 env -> (Dummy)::env) lb.FStar_Syntax_Syntax.lbunivs env)
in (

let env = if (FStar_Syntax_Syntax.is_top_level lbs) then begin
env_univs
end else begin
(FStar_List.fold_right (fun _56_419 env -> (Dummy)::env) lbs env_univs)
end
in (
...
in {FStar_Syntax_Syntax.lbname = _56_423.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _56_423.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _157_380; FStar_Syntax_Syntax.lbeff = _56_423.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _157_379}))))))
in (
...
let body_env = (FStar_List.fold_right (fun _56_426 env -> (Dummy)::env) lbs env)
...
let norm_one_branch = (fun env _56_441 -> (match (_56_441) with
| (pat, w_opt, tm) -> begin
(

let rec norm_pat = (fun env p -> (match (p.FStar_Syntax_Syntax.v) with
| FStar_Syntax_Syntax.Pat_constant (_56_446) -> begin
((p), (env))
end
...
let _56_456 = (norm_pat env hd)
in (match (_56_456) with
| (hd, env') -> begin
(
...
let _56_459 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd)::tl); FStar_Syntax_Syntax.ty = _56_459.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_459.FStar_Syntax_Syntax.p})), (env')))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(

let _56_476 = (FStar_All.pipe_right pats (FStar_List.fold_left (fun _56_467 _56_470 -> (match (((_56_467), (_56_470))) with
| ((pats, env), (p, b)) -> begin
(

let _56_473 = (norm_pat env p)
in (match (_56_473) with
| (p, env) -> begin
(((((p), (b)))::pats), (env))
end))
end)) (([]), (env))))
in (match (_56_476) with
| (pats, env) -> begin
(((

let _56_477 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats)))); FStar_Syntax_Syntax.ty = _56_477.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_477.FStar_Syntax_Syntax.p})), (env))
end))
end
...
in {FStar_Syntax_Syntax.ppname = _56_481.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_481.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _157_395}))
in (((

let _56_484 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = _56_484.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_484.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
...
in {FStar_Syntax_Syntax.ppname = _56_488.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_488.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _157_396}))
in (((

let _56_491 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = _56_491.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_491.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
...
in {FStar_Syntax_Syntax.ppname = _56_497.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_497.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _157_397}))
in (
...
let _56_501 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t))); FStar_Syntax_Syntax.ty = _56_501.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_501.FStar_Syntax_Syntax.p})), (env))))
end))
in (

let _56_505 = (norm_pat env pat)
in (match (_56_505) with
| (pat, env) -> begin
(
...
| _56_522 -> begin
(FStar_List.map (fun _56_525 -> (match (_56_525) with
| (x, imp) -> begin
...
let _56_541 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun _56_531 _56_534 -> (match (((_56_531), (_56_534))) with
| ((env, out), (b, imp)) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = _56_535.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_535.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _157_415}))
in (

let env = (Dummy)::env
in ((env), ((((b), (imp)))::out))))
end)) ((env), ([]))))
in (match (_56_541) with
| (env, bs) -> begin
...
let flags = (FStar_All.pipe_right c.FStar_Syntax_Syntax.flags (FStar_List.map (fun _56_4 -> (match (_56_4) with
...
in {FStar_Syntax_Syntax.comp_univs = _157_425; FStar_Syntax_Syntax.effect_name = _56_565.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = rt; FStar_Syntax_Syntax.effect_args = args; FStar_Syntax_Syntax.flags = flags}))
in (FStar_Syntax_Syntax.mk_Comp _157_426)))))
end)
end))
and filter_out_lcomp_cflags : FStar_Syntax_Syntax.lcomp  ->  FStar_Syntax_Syntax.cflags Prims.list = (fun lc -> (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.filter (fun _56_5 -> (match (_56_5) with
| FStar_Syntax_Syntax.DECREASES (_56_570) -> begin
false
end
| _56_573 -> begin
true
...
| FStar_Syntax_Syntax.Tm_app (op_eq_inst, ((_typ, _56_645))::((a1, _56_641))::((a2, _56_637))::[]) when (is_decidable_equality op_eq_inst) -> begin
(
...
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
(FStar_List.tryFind (fun _56_693 -> (match (_56_693) with
| (l, _56_692) -> begin
...
| FStar_Syntax_Syntax.Tm_app (fv, ((a1, _56_705))::((a2, _56_701))::[]) -> begin
(match ((find_fv fv arith_ops)) with
| None -> begin
tm
end
| Some (_56_712, op) -> begin
(
...
| (FStar_Syntax_Syntax.Tm_app (head1, ((arg1, _56_723))::[]), FStar_Syntax_Syntax.Tm_app (head2, ((arg2, _56_731))::[])) -> begin
...
| FStar_Syntax_Syntax.Tm_app (fv, ((a1, _56_770))::[]) -> begin
(match ((find_fv fv un_ops)) with
| None -> begin
tm
end
| Some (_56_777, op) -> begin
(match ((let _157_726 = (FStar_Syntax_Subst.compress a1)
in _157_726.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string (b, _56_783)) -> begin
...
let _56_795 = t
in {FStar_Syntax_Syntax.n = _56_795.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _56_795.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = tm.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _56_795.FStar_Syntax_Syntax.vars}))
in (
...
| ((Some (true), _56_952))::((_56_943, (arg, _56_946)))::[] -> begin
arg
end
| _56_956 -> begin
tm
...
(match ((FStar_All.pipe_right args (FStar_List.map simplify))) with
| ((Some (true), _56_960))::[] -> begin
(w FStar_Syntax_Util.t_false)
end
| ((Some (false), _56_966))::[] -> begin
(w FStar_Syntax_Util.t_true)
end
| _56_970 -> begin
tm
...
| FStar_Syntax_Syntax.Tm_abs ((_56_988)::[], body, _56_992) -> begin
...
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_56_1014)::(_56_1012)::[]) -> begin
(FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.normalize_term)
end
| (FStar_Syntax_Syntax.Tm_fvar (fv), (_56_1020)::[]) -> begin
...
let _56_1045 = (log cfg (fun _56_1044 -> (match (()) with
| () -> begin
...
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (_56_1048) -> begin
(failwith "Impossible")
end
...
let _56_1091 = cfg
in {steps = s; tcenv = _56_1091.tcenv; delta_level = (FStar_TypeChecker_Env.Unfold (FStar_Syntax_Syntax.Delta_constant))::[]})
in (

let stack' = (Debug (t))::(Steps (((cfg.steps), (cfg.delta_level))))::stack
in (norm cfg' env stack' tm)))))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = _56_1100; FStar_Syntax_Syntax.pos = _56_1098; FStar_Syntax_Syntax.vars = _56_1096}, (a1)::(a2)::rest) -> begin
(

let _56_1114 = (FStar_Syntax_Util.head_and_args t)
...
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = _56_1122; FStar_Syntax_Syntax.pos = _56_1120; FStar_Syntax_Syntax.vars = _56_1118}, (a)::[]) when (FStar_All.pipe_right cfg.steps (FStar_List.contains Reify)) -> begin
(

let _56_1133 = (FStar_Syntax_Util.head_and_args t)
in (match (_56_1133) with
| (reify_head, _56_1132) -> begin
(
...
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reflect (_56_1142)); FStar_Syntax_Syntax.tk = _56_1140; FStar_Syntax_Syntax.pos = _56_1138; FStar_Syntax_Syntax.vars = _56_1136}, (a)::[]) -> begin
...
let should_delta = (FStar_All.pipe_right cfg.delta_level (FStar_Util.for_some (fun _56_6 -> (match (_56_6) with
...
let _56_1175 = (log cfg (fun _56_1174 -> (match (()) with
| () -> begin
...
let _56_1182 = (log cfg (fun _56_1181 -> (match (()) with
| () -> begin
...
(match (stack) with
| (UnivArgs (us', _56_1188))::stack -> begin
(

let env = (FStar_All.pipe_right us' (FStar_List.fold_left (fun env u -> (Univ (u))::env) env))
in (norm cfg env stack t))
end
| _56_1196 when (FStar_All.pipe_right cfg.steps (FStar_List.contains EraseUniverses)) -> begin
(norm cfg env stack t)
end
| _56_1198 -> begin
...
let _56_1216 = (log cfg (fun _56_1215 -> (match (()) with
| () -> begin
...
| FStar_Syntax_Syntax.Tm_abs (_56_1219) -> begin
(norm cfg env stack t')
end
| _56_1222 -> begin
(rebuild cfg env stack t')
...
let _56_1261 = (log cfg (fun _56_1260 -> (match (()) with
| () -> begin
...
| Some (FStar_Util.Inr (l, cflags)) when (((FStar_Ident.lid_equals l FStar_Syntax_Const.effect_Tot_lid) || (FStar_Ident.lid_equals l FStar_Syntax_Const.effect_GTot_lid)) || (FStar_All.pipe_right cflags (FStar_Util.for_some (fun _56_7 -> (match (_56_7) with
...
let _56_1273 = (log cfg (fun _56_1272 -> (match (()) with
| () -> begin
...
| _56_1282 when (FStar_All.pipe_right cfg.steps (FStar_List.contains Reify)) -> begin
...
let _56_1285 = cfg
in {steps = (WHNF)::(Exclude (Iota))::(Exclude (Zeta))::cfg.steps; tcenv = _56_1285.tcenv; delta_level = _56_1285.delta_level})
...
let _56_1293 = (log cfg (fun _56_1292 -> (match (()) with
| () -> begin
...
let _56_1302 = cfg
in {steps = s; tcenv = _56_1302.tcenv; delta_level = dl}) env stack t)
end
| (MemoLazy (r))::stack -> begin
(

let _56_1308 = (set_memo r ((env), (t)))
in (

let _56_1311 = (log cfg (fun _56_1310 -> (match (()) with
| () -> begin
...
let _56_1347 = (FStar_Syntax_Subst.open_term' bs body)
in (match (_56_1347) with
...
let env' = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _56_1355 -> (Dummy)::env) env))
in (

let _56_1359 = (log cfg (fun _56_1358 -> (match (()) with
| () -> begin
...
let stack = (FStar_All.pipe_right stack (FStar_List.fold_right (fun _56_1367 stack -> (match (_56_1367) with
| (a, aq) -> begin
...
let _56_1371 = (log cfg (fun _56_1370 -> (match (()) with
| () -> begin
...
let _56_1381 = x
in {FStar_Syntax_Syntax.ppname = _56_1381.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_1381.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (f)))) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack t)))
end
| _56_1385 -> begin
...
let _56_1389 = (FStar_Syntax_Subst.open_term ((((x), (None)))::[]) f)
in (match (_56_1389) with
| (closing, f) -> begin
(
...
let _56_1391 = x
in {FStar_Syntax_Syntax.ppname = _56_1391.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_1391.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (_157_837)))
...
let _56_1400 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_56_1400) with
| (bs, c) -> begin
(

let c = (let _157_843 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _56_1402 -> (Dummy)::env) env))
...
let _56_1451 = (log cfg (fun _56_1450 -> (match (()) with
| () -> begin
...
| FStar_Syntax_Syntax.Tm_let ((_56_1464, ({FStar_Syntax_Syntax.lbname = FStar_Util.Inr (_56_1476); FStar_Syntax_Syntax.lbunivs = _56_1474; FStar_Syntax_Syntax.lbtyp = _56_1472; FStar_Syntax_Syntax.lbeff = _56_1470; FStar_Syntax_Syntax.lbdef = _56_1468})::_56_1466), _56_1482) -> begin
(rebuild cfg env stack t)
end
| FStar_Syntax_Syntax.Tm_let ((false, (lb)::[]), body) -> begin
(
...
let _56_1496 = (let _157_854 = (let _157_853 = (let _157_852 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.left)
in (FStar_All.pipe_right _157_852 FStar_Syntax_Syntax.mk_binder))
in (_157_853)::[])
in (FStar_Syntax_Subst.open_term _157_854 body))
in (match (_56_1496) with
| (bs, body) -> begin
(
...
in {FStar_Syntax_Syntax.lbname = _157_860; FStar_Syntax_Syntax.lbunivs = _56_1497.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _157_859; FStar_Syntax_Syntax.lbeff = _56_1497.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _157_858}))))
in (

let env' = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _56_1501 -> (Dummy)::env) env))
...
let _56_1527 = (FStar_List.fold_right (fun lb _56_1516 -> (match (_56_1516) with
| (rec_env, memos, i) -> begin
(

let f_i = (let _157_866 = (

let _56_1517 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = _56_1517.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = _56_1517.FStar_Syntax_Syntax.sort})
...
in (match (_56_1527) with
| (rec_env, memos, _56_1526) -> begin
(

let _56_1530 = (FStar_List.map2 (fun lb memo -> (FStar_ST.op_Colon_Equals memo (Some (((rec_env), (lb.FStar_Syntax_Syntax.lbdef)))))) (Prims.snd lbs) memos)
in (
...
| (App ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = _56_1550; FStar_Syntax_Syntax.pos = _56_1548; FStar_Syntax_Syntax.vars = _56_1546}, _56_1555, _56_1557))::_56_1544 -> begin
...
let _56_1566 = cfg
in {steps = (FStar_List.append ((NoDeltaSteps)::(Exclude (Zeta))::[]) cfg.steps); tcenv = _56_1566.tcenv; delta_level = (FStar_TypeChecker_Env.NoDelta)::[]})
...
let _56_1580 = ed.FStar_Syntax_Syntax.bind_repr
in (match (_56_1580) with
| (_56_1578, bind_repr) -> begin
...
| FStar_Syntax_Syntax.Tm_uinst (bind, (_56_1590)::(_56_1588)::[]) -> begin
...
let _56_1609 = ed.FStar_Syntax_Syntax.bind_repr
in (match (_56_1609) with
| (_56_1607, bind_repr) -> begin
(
...
| FStar_Syntax_Syntax.Tm_uinst (t, _56_1616) -> begin
t
end
| _56_1620 -> begin
head
...
| ((head, _56_1645))::args -> begin
(

let _56_1650 = (maybe_unfold_action head)
in (match (_56_1650) with
...
| FStar_Syntax_Syntax.Tm_uinst (bind, (_56_1680)::(_56_1678)::[]) -> begin
...
| FStar_Syntax_Syntax.Tm_meta (e0, FStar_Syntax_Syntax.Meta_monadic_lift (_56_1689)) -> begin
...
let should_reify = (match (stack) with
| (App ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = _56_1719; FStar_Syntax_Syntax.pos = _56_1717; FStar_Syntax_Syntax.vars = _56_1715}, _56_1724, _56_1726))::_56_1713 -> begin
(FStar_All.pipe_right cfg.steps (FStar_List.contains Reify))
end
| _56_1731 -> begin
false
...
let _56_1734 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::[]; tcenv = _56_1734.tcenv; delta_level = (FStar_TypeChecker_Env.Inlining)::(FStar_TypeChecker_Env.Eager_unfolding_only)::[]})
...
| _56_1738 -> begin
(match (stack) with
| (_56_1742)::_56_1740 -> begin
(match (m) with
| FStar_Syntax_Syntax.Meta_labeled (l, r, _56_1747) -> begin
...
let _56_1773 = ed.FStar_Syntax_Syntax.return_repr
in (match (_56_1773) with
| (_56_1771, return_repr) -> begin
(

let return_inst = (match ((let _157_950 = (FStar_Syntax_Subst.compress return_repr)
in _157_950.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uinst (return_tm, (_56_1776)::[]) -> begin
...
and norm_pattern_args : cfg  ->  env  ->  FStar_Syntax_Syntax.args Prims.list  ->  FStar_Syntax_Syntax.args Prims.list = (fun cfg env args -> (FStar_All.pipe_right args (FStar_List.map (FStar_List.map (fun _56_1788 -> (match (_56_1788) with
| (a, imp) -> begin
...
in {FStar_Syntax_Syntax.n = _157_972; FStar_Syntax_Syntax.tk = _56_1797.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _56_1797.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _56_1797.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(
...
in {FStar_Syntax_Syntax.n = _157_976; FStar_Syntax_Syntax.tk = _56_1803.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _56_1803.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _56_1803.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(

let norm_args = (fun args -> (FStar_All.pipe_right args (FStar_List.map (fun _56_1811 -> (match (_56_1811) with
| (a, i) -> begin
...
let flags = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_List.map (fun _56_8 -> (match (_56_8) with
| FStar_Syntax_Syntax.DECREASES (t) -> begin
...
in {FStar_Syntax_Syntax.comp_univs = _157_985; FStar_Syntax_Syntax.effect_name = _56_1819.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _157_984; FStar_Syntax_Syntax.effect_args = _157_983; FStar_Syntax_Syntax.flags = flags}))))
in FStar_Syntax_Syntax.Comp (_157_986))
in {FStar_Syntax_Syntax.n = _157_987; FStar_Syntax_Syntax.tk = _56_1817.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _56_1817.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _56_1817.FStar_Syntax_Syntax.vars}))))
end)))
...
let _56_1826 = cfg
in {steps = (Eager_unfolding)::(UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::(AllowUnboundUniverses)::[]; tcenv = _56_1826.tcenv; delta_level = _56_1826.delta_level}) env [] t))
in (

let non_info = (fun t -> (let _157_995 = (norm t)
in (FStar_Syntax_Util.non_informative _157_995)))
in (match (c.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (_56_1831) -> begin
c
end
...
let _56_1837 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (((t), (uopt))); FStar_Syntax_Syntax.tk = _56_1837.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _56_1837.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _56_1837.FStar_Syntax_Syntax.vars})
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(
...
let _56_1844 = ct
in {FStar_Syntax_Syntax.comp_univs = _56_1844.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = pure_eff; FStar_Syntax_Syntax.result_typ = _56_1844.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _56_1844.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = _56_1844.FStar_Syntax_Syntax.flags})
end
| None -> begin
(
...
let _56_1848 = ct
in {FStar_Syntax_Syntax.comp_univs = _56_1848.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.result_typ = _56_1848.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _56_1848.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = _56_1848.FStar_Syntax_Syntax.flags}))
end)
in (

let _56_1851 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (ct); FStar_Syntax_Syntax.tk = _56_1851.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _56_1851.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _56_1851.FStar_Syntax_Syntax.vars}))
end else begin
c
end)
end
...
and norm_binder : cfg  ->  env  ->  FStar_Syntax_Syntax.binder  ->  FStar_Syntax_Syntax.binder = (fun cfg env _56_1859 -> (match (_56_1859) with
| (x, imp) -> begin
(let _157_1000 = (

let _56_1860 = x
in (let _157_999 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _56_1860.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_1860.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _157_999}))
in ((_157_1000), (imp)))
end))
and norm_binders : cfg  ->  env  ->  FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.binders = (fun cfg env bs -> (

let _56_1873 = (FStar_List.fold_left (fun _56_1867 b -> (match (_56_1867) with
| (nbs', env) -> begin
(
...
let _56_1893 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug cfg.tcenv) (FStar_Options.Other ("print_normalized_terms"))) then begin
...
let _56_1901 = cfg
in {steps = s; tcenv = _56_1901.tcenv; delta_level = dl}) env stack t)
end
...
let _56_1914 = (set_memo r ((env), (t)))
in (

let _56_1917 = (log cfg (fun _56_1916 -> (match (()) with
| () -> begin
...
let _56_1940 = (FStar_Syntax_Util.abs bs t lopt)
in {FStar_Syntax_Syntax.n = _56_1940.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _56_1940.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = _56_1940.FStar_Syntax_Syntax.vars})
...
| (Arg (Clos (env, tm, m, _56_1976), aq, r))::stack -> begin
(

let _56_1985 = (log cfg (fun _56_1984 -> (match (()) with
| () -> begin
...
let _56_2016 = (log cfg (fun _56_2015 -> (match (()) with
| () -> begin
...
let norm_and_rebuild_match = (fun _56_2020 -> (match (()) with
| () -> begin
(
...
let new_delta = (FStar_All.pipe_right cfg.delta_level (FStar_List.filter (fun _56_9 -> (match (_56_9) with
| (FStar_TypeChecker_Env.Inlining) | (FStar_TypeChecker_Env.Eager_unfolding_only) -> begin
true
end
| _56_2026 -> begin
...
let _56_2029 = cfg
in {steps = (FStar_List.append steps' cfg.steps); tcenv = _56_2029.tcenv; delta_level = new_delta})))
in (
...
let rec norm_pat = (fun env p -> (match (p.FStar_Syntax_Syntax.v) with
| FStar_Syntax_Syntax.Pat_constant (_56_2039) -> begin
((p), (env))
end
| FStar_Syntax_Syntax.Pat_disj ([]) -> begin
(failwith "Impossible")
...
let _56_2049 = (norm_pat env hd)
in (match (_56_2049) with
| (hd, env') -> begin
(
...
let _56_2052 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd)::tl); FStar_Syntax_Syntax.ty = _56_2052.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_2052.FStar_Syntax_Syntax.p})), (env')))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(

let _56_2069 = (FStar_All.pipe_right pats (FStar_List.fold_left (fun _56_2060 _56_2063 -> (match (((_56_2060), (_56_2063))) with
| ((pats, env), (p, b)) -> begin
(

let _56_2066 = (norm_pat env p)
in (match (_56_2066) with
| (p, env) -> begin
(((((p), (b)))::pats), (env))
end))
end)) (([]), (env))))
in (match (_56_2069) with
| (pats, env) -> begin
(((

let _56_2070 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats)))); FStar_Syntax_Syntax.ty = _56_2070.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_2070.FStar_Syntax_Syntax.p})), (env))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = _56_2074.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_2074.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _157_1046}))
in (((

let _56_2077 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = _56_2077.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_2077.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = _56_2081.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_2081.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _157_1047}))
in (((

let _56_2084 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = _56_2084.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_2084.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = _56_2090.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_2090.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _157_1048}))
in (
...
let _56_2094 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t))); FStar_Syntax_Syntax.ty = _56_2094.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _56_2094.FStar_Syntax_Syntax.p})), (env))))
end))
in (
...
let _56_2103 = (FStar_Syntax_Subst.open_branch branch)
in (match (_56_2103) with
| (p, wopt, e) -> begin
(

let _56_2106 = (norm_pat env p)
in (match (_56_2106) with
| (p, env) -> begin
(
...
| FStar_Syntax_Syntax.Tm_uinst (h, _56_2117) -> begin
(is_cons h)
end
...
let _56_2159 = (FStar_Syntax_Util.head_and_args scrutinee)
in (match (_56_2159) with
| (head, args) -> begin
...
| FStar_Syntax_Syntax.Pat_dot_term (_56_2182) -> begin
FStar_Util.Inl ([])
end
...
| (((t, _56_2207))::rest_a, ((p, _56_2213))::rest_p) -> begin
...
let _56_2239 = (log cfg (fun _56_2238 -> (match (()) with
| () -> begin
...
let d = (FStar_All.pipe_right s (FStar_List.collect (fun _56_10 -> (match (_56_10) with
| UnfoldUntil (k) -> begin
...
let _56_2275 = lc
in {FStar_Syntax_Syntax.eff_name = pure_eff; FStar_Syntax_Syntax.res_typ = _56_2275.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = _56_2275.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _56_2277 -> (match (()) with
| () -> begin
...
let _56_2307 = (FStar_Syntax_Util.arrow_formals_comp sort)
in (match (_56_2307) with
| (binders, c) -> begin
(match (binders) with
| [] -> begin
t
...
let _56_2313 = (FStar_All.pipe_right binders FStar_Syntax_Util.args_of_binders)
in (match (_56_2313) with
| (binders, args) -> begin
...
| (Some (sort), _56_2319) -> begin
(let _157_1162 = (mk sort t.FStar_Syntax_Syntax.pos)
in (eta_expand_with_type t _157_1162))
end
| (_56_2322, FStar_Syntax_Syntax.Tm_name (x)) -> begin
(eta_expand_with_type t x.FStar_Syntax_Syntax.sort)
end
| _56_2327 -> begin
(

let _56_2330 = (FStar_Syntax_Util.head_and_args t)
in (match (_56_2330) with
| (head, args) -> begin
(match ((let _157_1163 = (FStar_Syntax_Subst.compress head)
in _157_1163.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uvar (_56_2332, thead) -> begin
(

let _56_2338 = (FStar_Syntax_Util.arrow_formals thead)
in (match (_56_2338) with
| (formals, tres) -> begin
...
let _56_2346 = (env.FStar_TypeChecker_Env.type_of (

let _56_2339 = env
in {FStar_TypeChecker_Env.solver = _56_2339.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _56_2339.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _56_2339.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _56_2339.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _56_2339.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _56_2339.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = _56_2339.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _56_2339.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _56_2339.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _56_2339.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _56_2339.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _56_2339.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _56_2339.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _56_2339.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _56_2339.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _56_2339.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _56_2339.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = _56_2339.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _56_2339.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _56_2339.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = _56_2339.FStar_TypeChecker_Env.qname_and_index}) t)
in (match (_56_2346) with
| (_56_2342, ty, _56_2345) -> begin
...
let _56_2356 = (env.FStar_TypeChecker_Env.type_of (

let _56_2349 = env
in {FStar_TypeChecker_Env.solver = _56_2349.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = _56_2349.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = _56_2349.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = _56_2349.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = _56_2349.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = _56_2349.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = _56_2349.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = _56_2349.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = _56_2349.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = _56_2349.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = _56_2349.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = _56_2349.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = _56_2349.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = _56_2349.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = _56_2349.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = _56_2349.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = _56_2349.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = _56_2349.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = _56_2349.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = _56_2349.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = _56_2349.FStar_TypeChecker_Env.qname_and_index}) t)
in (match (_56_2356) with
| (_56_2352, ty, _56_2355) -> begin
(eta_expand_with_type t ty)
end))
end)
end))
