...
let built_in_primitive_steps : primitive_step Prims.list =
  ...
  let int_as_const p i =
    let uu____2407 =
      let uu____2408 =
        let uu____2414 = FStar_Util.string_of_int i  in (uu____2414, None)
         in
  ...
  let lift_binary f aopts =
    match aopts with
    | (Some a0)::(Some a1)::[] ->
        let uu____2752 = f a0 a1  in Some uu____2752
    | uu____2753 -> None  in
    ...
    FStar_All.pipe_right bounded_int_types
      (FStar_List.collect
         (fun m  ->
            ...
            let uu____3623 =
              let uu____3633 =
                let uu____3642 = FStar_Syntax_Const.p2l ["FStar"; m; "sub"]
                   in
              ...
              let uu____3669 =
                let uu____3679 =
                  let uu____3688 = FStar_Syntax_Const.p2l ["FStar"; m; "mul"]
                     in
           ...
           | FStar_Syntax_Syntax.Tm_refine (x,f) ->
               ...
               then
                 ...
                 (let t_x = norm cfg env [] x.FStar_Syntax_Syntax.sort  in
                  let uu____7630 = FStar_Syntax_Subst.open_term [(x, None)] f
                     in
