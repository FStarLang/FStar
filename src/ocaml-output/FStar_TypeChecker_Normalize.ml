                      ...
                      (let whnf =
                             ...
                             FStar_All.pipe_right branches1
                               (FStar_List.map
                                  (fun branch  ->
                                     ...
                                     | (p,wopt,e) ->
                                         let uu____26286 = norm_pat env2 p
                                            in
                       ...
                       let uu____26372 =
                         mk
                          ...
                          in
                       rebuild cfg1 env2 stack2 uu____26372)
                       in
                    let rec is_cons head =
                      let uu____26398 =
                        let uu____26399 = FStar_Syntax_Subst.compress head
                           in
                          ...
                          (match p.FStar_Syntax_Syntax.v with
                           ...
                           | FStar_Syntax_Syntax.Pat_constant s ->
                               (match scrutinee2.FStar_Syntax_Syntax.n with
                                ...
                                | uu____26732 ->
                                    let uu____26733 =
                                      let uu____26735 = is_cons head  in
                           ...
                           | FStar_Syntax_Syntax.Pat_cons (fv,arg_pats) ->
                               ...
                               (match uu____26764 with
                                ...
                                | uu____26784 ->
                                    let uu____26785 =
                                      let uu____26787 = is_cons head  in
                                          ...
                                          | (bv,t2) ->
                                              let uu____27244 =
                                                ...
                                                (uu____27251, uu____27255)
                                                 in
                                              uu____27244 :: env3) env2 s
                                    in
                                 let uu____27381 =
                                   guard_when_clause wopt b rest  in
                                 norm cfg1 env3 stack2 uu____27381)))
                       in
                    if
                      (cfg1.FStar_TypeChecker_Cfg.steps).FStar_TypeChecker_Cfg.iota
...
let (normalize_universe :
  ...
  fun env1  ->
    fun u  ->
      let uu____27598 = FStar_TypeChecker_Cfg.config [] env1  in
...
let (non_info_norm :
  ...
  fun env1  ->
    fun t  ->
      ...
      let uu____27620 = normalize steps env1 t  in
      FStar_TypeChecker_Env.non_informative env1 uu____27620
    ...
    fun t  ->
      ...
      | uu____28000 ->
          ...
          (match uu____28001 with
           | (head,args) ->
               let uu____28044 =
                 let uu____28045 = FStar_Syntax_Subst.compress head  in
    ...
    | FStar_Syntax_Syntax.Tm_match (t2,branches1) ->
        ...
        let uu____28715 =
          let uu____28716 =
            ...
            let uu____28742 = FStar_List.map elim_branch branches1  in
...
and (elim_delayed_subst_meta :
  ...
  fun uu___18_29241  ->
    ...
    | FStar_Syntax_Syntax.Meta_pattern (names,args) ->
        let uu____29276 =
          let uu____29297 = FStar_List.map elim_delayed_subst_term names  in
  ...
  fun env1  ->
    fun s  ->
      ...
      | FStar_Syntax_Syntax.Sig_inductive_typ
          ...
          let uu____30340 = elim_uvars_aux_t env1 univ_names binders typ  in
      ...
      | FStar_Syntax_Syntax.Sig_bundle (sigs,lids) ->
          ...
          let uu____30396 =
            let uu____30397 =
              let uu____30406 = FStar_List.map (elim_uvars env1) sigs  in
              (uu____30406, lids)  in
      ...
      | FStar_Syntax_Syntax.Sig_datacon (lid,univ_names,typ,lident,i,lids) ->
          let uu____30425 = elim_uvars_aux_t env1 univ_names [] typ  in
      ...
      | FStar_Syntax_Syntax.Sig_declare_typ (lid,univ_names,typ) ->
          let uu____30478 = elim_uvars_aux_t env1 univ_names [] typ  in
                        ...
                        let elim t =
                          let uu____30579 =
                            let uu____30580 =
                              ...
                              remove_uvar_solutions env1 uu____30581  in
                            FStar_Syntax_Subst.close_univ_vars lbunivs
                              uu____30580
                             in
      ...
      | FStar_Syntax_Syntax.Sig_main t ->
          ...
          let uu____30593 =
            let uu____30594 = remove_uvar_solutions env1 t  in
      ...
      | FStar_Syntax_Syntax.Sig_assume (l,us,t) ->
          let uu____30598 = elim_uvars_aux_t env1 us [] t  in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____30646 with
           | (univs,binders,uu____30665) ->
               let uu____30686 =
                 let uu____30691 = FStar_Syntax_Subst.univ_var_opening univs
                    in
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect sub_eff ->
          let elim_tscheme_opt uu___19_31372 =
            ...
            | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
            | FStar_Pervasives_Native.Some (us,t) ->
                let uu____31403 = elim_uvars_aux_t env1 us [] t  in
      ...
      | FStar_Syntax_Syntax.Sig_effect_abbrev
          ...
          let uu____31483 = elim_uvars_aux_c env1 univ_names binders comp  in
      ...
      | FStar_Syntax_Syntax.Sig_polymonadic_bind (m,n,p,(us_t,t),(us_ty,ty))
          ->
          let uu____31570 = elim_uvars_aux_t env1 us_t [] t  in
          (match uu____31570 with
           | (us_t1,uu____31594,t1) ->
               let uu____31616 = elim_uvars_aux_t env1 us_ty [] ty  in
...
let (unfold_head_once :
  ...
  fun env1  ->
    fun t  ->
      ...
      | (head,args) ->
          let uu____31793 =
            let uu____31794 = FStar_Syntax_Subst.compress head  in
