  ...
  fun full_norm  ->
    fun args  ->
      ...
      | (steps,uu____12273)::uu____12274::(tm,uu____12276)::[] ->
          ...
          let s =
            let uu____12316 =
              let uu____12319 = full_norm steps  in parse_steps uu____12319
               in
            Beta :: uu____12316  in
          ...
          (match t1.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_fvar fv ->
               ...
               then
                 ...
                 (log cfg
                    (fun uu____12818  ->
                       let uu____12819 = FStar_Syntax_Print.term_to_string t1
                          in
                             ...
                             | (FStar_Pervasives_Native.Some
                                ats,FStar_Pervasives_Native.Some ats') ->
                                 FStar_Util.for_some
                                   ...
                                   ats
                             | (uu____12894,uu____12895) -> false)))
                     in
                  log cfg
                    (fun uu____12917  ->
                       let uu____12918 = FStar_Syntax_Print.term_to_string t1
                          in
                       let uu____12919 =
                         FStar_Range.string_of_range
                           t1.FStar_Syntax_Syntax.pos
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____13417  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____13539  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____13665  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____13921  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____14035  -> dummy :: env1) env)
                              in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                      ...
                      let c2 =
                        let uu____14395 =
                          FStar_All.pipe_right bs1
                            (FStar_List.fold_left
                               (fun env1  ->
                                  fun uu____14419  -> dummy :: env1) env)
                           in
                       ...
                       | uu____14698 ->
                           let uu____14699 =
                             let uu____14700 =
                               ...
                               FStar_Syntax_Syntax.Tm_ascribed uu____14701
                                in
                          ...
                          (let lb1 =
                           ...
                           let env' =
                             FStar_All.pipe_right bs
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____15154  -> dummy :: env1) env)
                              in
                           let stack1 = (Cfg cfg) :: stack  in
                           let cfg1 =
                           ...
                           | (xs,def_body,lopt) ->
                               ...
                               let env1 =
                                 ...
                                 let uu____15278 =
                                   let uu____15287 =
                                     FStar_List.map
                                       (fun uu____15307  -> dummy) xs1
                                      in
                                   FStar_List.append uu____15287 env  in
                                 FStar_List.append uu____15261 uu____15278
                                  in
              ...
              | FStar_Pervasives_Native.Some (us,t) ->
                  (log cfg
                     (fun uu____16555  ->
                        ...
                        let uu____16557 = FStar_Syntax_Print.term_to_string t
                           in
          ...
          fun head1  ->
            fun m  ->
              fun t  ->
                ...
                log cfg
                  (fun uu____16689  ->
                     let uu____16690 = FStar_Syntax_Print.tag_of_term head2
                        in
                     let uu____16691 =
                                      ...
                                      let uu____16772 =
                                        let uu____16775 =
                                          ...
                                          FStar_Syntax_Syntax.Tm_let
                                            uu____16776
                                           in
                                        FStar_Syntax_Syntax.mk uu____16775
                                         in
                                      uu____16772
                                        FStar_Pervasives_Native.None
                                ...
                                | FStar_Pervasives_Native.None  ->
                                    ...
                                    then
                                      ...
                                      (let rng =
                                         ...
                                         let uu____16839 =
                                           let uu____16842 =
                                             ...
                                             FStar_Syntax_Syntax.Tm_abs
                                               uu____16843
                                              in
                                           FStar_Syntax_Syntax.mk uu____16842
                                            in
                                         uu____16839
                                           FStar_Pervasives_Native.None
                                         ...
                                         let uu____16879 =
                                           let uu____16880 =
                                             FStar_Syntax_Subst.compress
                                               bind_repr
                                              in
                                           uu____16880.FStar_Syntax_Syntax.n
                                            in
                                               ...
                                               let uu____16947 =
                                                 ...
                                                 let uu____16951 =
                                                   ...
                                                   uu____16954 :: uu____16955
                                                    in
                                                 uu____16950 :: uu____16951
                                                  in
                                               (bind_inst, uu____16947)  in
                                             FStar_Syntax_Syntax.Tm_app
                                               uu____16932
                                              in
                                           FStar_Syntax_Syntax.mk uu____16931
                                            in
                                         uu____16928
                                       ...
                                       (let uu____16985 = FStar_List.tl stack
                                           in
                      ...
                      | (uu____17010,bind_repr) ->
                          let maybe_unfold_action head3 =
                            ...
                            | FStar_Pervasives_Native.Some x when
                                ...
                                let action_unfolded =
                                  let uu____17081 = maybe_extract_fv head4
                                     in
                          ...
                          ((let is_arg_impure uu____17107 =
                            ...
                            let uu____17131 =
                              let uu____17132 =
                                ...
                                uu____17139 :: args  in
                              FStar_Util.for_some is_arg_impure uu____17132
                               in
                            if uu____17131
                            then
                              let uu____17144 =
                           ...
                           (let uu____17147 = maybe_unfold_action head_app
                               in
                     ...
                     let uu____17502 =
                       let uu____17503 =
                         let uu____17518 =
                           ...
                           let uu____17522 =
                             let uu____17525 = FStar_Syntax_Syntax.as_arg e
                                in
                             [uu____17525]  in
      ...
      fun uu____17804  ->
        ...
        | (x,imp) ->
            let uu____17807 =
              ...
              let uu____17809 = norm cfg env [] x.FStar_Syntax_Syntax.sort
                 in
              {
                FStar_Syntax_Syntax.ppname =
          ...
          (let t1 = maybe_simplify cfg env stack t  in
           ...
           | (MemoLazy r)::stack1 ->
               (set_memo cfg r (env, t1);
                log cfg
                  (fun uu____18018  ->
                     let uu____18019 = FStar_Syntax_Print.term_to_string t1
                        in
                     FStar_Util.print1 "\tSet memo %s\n" uu____18019);
                rebuild cfg env stack1 t1)
           ...
           | (Arg (Clos (env_arg,tm,m,uu____18081),aq,r))::stack1 ->
               (log cfg
                  (fun uu____18134  ->
                     let uu____18135 = FStar_Syntax_Print.term_to_string tm
                        in
           ...
           | (App (env1,head1,aq,r))::stack' when should_reify cfg stack ->
               ...
               let fallback msg uu____18329 =
                 log cfg
                   (fun uu____18333  ->
                      let uu____18334 = FStar_Syntax_Print.term_to_string t1
                         in
           ...
           | (Match (env1,branches,r))::stack1 ->
               (log cfg
                  (fun uu____18426  ->
                     let uu____18427 = FStar_Syntax_Print.term_to_string t1
                        in
                     FStar_Util.print1
                   ...
                   (let whnf = (cfg.steps).weak || (cfg.steps).hnf  in
                              ...
                              (FStar_List.fold_left
                                 (fun uu____18603  ->
                                    fun uu____18604  ->
                                      ...
                                      | ((pats1,env3),(p1,b)) ->
                                          let uu____18695 = norm_pat env3 p1
                                             in
                    ...
                    let uu____18936 =
                      mk
                        ...
                        r
                       in
                    rebuild cfg env1 stack1 uu____18936)
                    in
                       ...
                       (match uu____19398 with
                        | FStar_Util.Inl s ->
                            matches_args (FStar_List.append out s) rest_a
                              rest_p
                        | m -> m)
                   | uu____19447 -> FStar_Util.Inr false
                  in
                                                 ...
                                                 let uu____19708 =
                                                   FStar_Util.mk_ref
                                                     (FStar_Pervasives_Native.Some
                                                        ([], t2))
                                                    in
                                                 ([], t2, uu____19708, false)
                                                  in
                                               Clos uu____19677  in
                                             (uu____19672, uu____19676)  in
                                           uu____19665 :: env2) env1 s
                                 in
                              let uu____19825 = guard_when_clause wopt b rest
                                 in
                              norm cfg env2 stack1 uu____19825)))
                    in
                 if Prims.op_Negation (cfg.steps).iota
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____20128 =
                     let uu____20129 =
                       let uu____20136 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____20136)  in
           ...
           | (head1,args) ->
               ...
               (match uu____20306 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____20310,thead) ->
                    let uu____20336 = FStar_Syntax_Util.arrow_formals thead
                       in
...
let rec elim_delayed_subst_term :
  ...
  fun t  ->
    ...
    let elim_bv x =
      ...
      let uu____20460 = elim_delayed_subst_term x.FStar_Syntax_Syntax.sort
         in
      {
        FStar_Syntax_Syntax.ppname =
    ...
    | FStar_Syntax_Syntax.Tm_match (t2,branches) ->
        ...
        let elim_branch uu____20868 =
          ...
          | (pat,wopt,t3) ->
              ...
              (uu____20894, uu____20897, uu____20900)
           in
        let uu____20905 =
          let uu____20906 =
          ...
          | (tc,topt) ->
              let uu____21074 =
                ...
                | FStar_Util.Inr c ->
                    ...
                    FStar_Util.Inr uu____21086
                 in
              let uu____21087 =
                FStar_Util.map_opt topt elim_delayed_subst_term  in
              (uu____21074, uu____21087)
           in
        let uu____21096 =
          let uu____21097 =
    ...
    | FStar_Syntax_Syntax.Tm_uvar (uv,t2) ->
        let uu____21240 =
          let uu____21241 =
            let uu____21258 = elim_delayed_subst_term t2  in
            (uv, uu____21258)  in
...
and elim_delayed_subst_meta :
  ...
  fun uu___92_21370  ->
    ...
    | FStar_Syntax_Syntax.Meta_monadic (m,t) ->
        let uu____21415 =
          let uu____21422 = elim_delayed_subst_term t  in (m, uu____21422)
           in
    ...
    | FStar_Syntax_Syntax.Meta_alien (d,s,t) ->
        let uu____21447 =
          let uu____21456 = elim_delayed_subst_term t  in (d, s, uu____21456)
           in
          ...
          let t =
            ...
            | (uu____21605,FStar_Util.Inl t) ->
                ...
                uu____21611 FStar_Pervasives_Native.None
                  t.FStar_Syntax_Syntax.pos
             in
          let uu____21632 = FStar_Syntax_Subst.open_univ_vars univ_names t
             in
                ...
                | uu____21715 ->
                    ...
                    (match uu____21716 with
                     ...
                     | (uu____21827,FStar_Util.Inl uu____21828) ->
                         ([], (FStar_Util.Inl t4))
                     | uu____21851 -> failwith "Impossible")
                 in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____22405 with
           | (univs1,binders,signature) ->
               let uu____22433 =
                 let uu____22442 = FStar_Syntax_Subst.univ_var_opening univs1
                    in
                 match uu____22442 with
                 | (univs_opening,univs2) ->
                     let uu____22469 =
                       FStar_Syntax_Subst.univ_var_closing univs2  in
                     (univs_opening, uu____22469)
                  in
                         ...
                         let elim_action a =
                           ...
                           let destruct_action_typ_templ t =
                             ...
                             | FStar_Syntax_Syntax.Tm_abs
                                 ...
                                 let uu____22866 = destruct_action_body body
                                    in
                           ...
                           | (action_univs,t) ->
                               let uu____22970 = destruct_action_typ_templ t
                                  in
