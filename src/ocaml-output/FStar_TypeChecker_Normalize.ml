...
let env_to_string : closure Prims.list  ->  Prims.string = (fun env -> (let _0_258 = (FStar_List.map closure_to_string env)
in (FStar_All.pipe_right _0_258 (FStar_String.concat "; "))))


let stack_elt_to_string : stack_elt  ->  Prims.string = (fun uu___123_591 -> (match (uu___123_591) with
| Arg (c, uu____593, uu____594) -> begin
(let _0_259 = (closure_to_string c)
in (FStar_Util.format1 "Closure %s" _0_259))
end
| MemoLazy (uu____595) -> begin
"MemoLazy"
end
| Abs (uu____599, bs, uu____601, uu____602, uu____603) -> begin
(let _0_260 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
in (FStar_Util.format1 "Abs %s" _0_260))
end
...
(let _0_261 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format1 "App %s" _0_261))
end
...
| Debug (t) -> begin
(let _0_262 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format1 "Debug %s" _0_262))
end))


let stack_to_string : stack_elt Prims.list  ->  Prims.string = (fun s -> (let _0_263 = (FStar_List.map stack_elt_to_string s)
...
with
| uu____683 -> begin
(failwith (let _0_264 = (FStar_Syntax_Print.db_to_string x)
...
| true -> begin
(Prims.raise (FStar_Errors.Error ((let _0_268 = (let _0_267 = (FStar_Util.string_of_int (FStar_List.length binders))
in (let _0_266 = (FStar_Util.string_of_int ((FStar_List.length c.FStar_Syntax_Syntax.effect_args) + (Prims.parse_int "1")))
in (let _0_265 = (FStar_Syntax_Print.comp_to_string (FStar_Syntax_Syntax.mk_Comp c))
in (FStar_Util.format3 "Effect constructor is not fully applied; expected %s args, got %s args, i.e., %s" _0_267 _0_266 _0_265))))
in ((_0_268), (comp.FStar_Syntax_Syntax.pos))))))
end
| uu____752 -> begin
()
end);
...
let inst = (let _0_270 = (let _0_269 = (FStar_Syntax_Syntax.as_arg c.FStar_Syntax_Syntax.result_typ)
in (_0_269)::c.FStar_Syntax_Syntax.effect_args)
...
in (FStar_All.pipe_right _0_271 FStar_Syntax_Syntax.mk_Comp))
...
let us = (let _0_272 = (FStar_List.collect aux us)
in (FStar_All.pipe_right _0_272 norm_univs))
in (match (us) with
| (u_k)::(hd)::rest -> begin
(
...
(let _0_274 = (aux u)
in (FStar_List.map (fun _0_273 -> FStar_Syntax_Syntax.U_succ (_0_273)) _0_274))
end)))
in (
...
let rec closure_as_term : cfg  ->  closure Prims.list  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun cfg env t -> ((log cfg (fun uu____1030 -> (let _0_276 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_275 = (FStar_Syntax_Print.term_to_string t)
...
(let _0_277 = FStar_Syntax_Syntax.Tm_type ((norm_universe cfg env u))
in (mk _0_277 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_uinst (t, us) -> begin
(let _0_278 = (FStar_List.map (norm_universe cfg env) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst t _0_278))
end
...
in (let _0_280 = FStar_Syntax_Syntax.Tm_abs ((let _0_279 = (close_lcomp_opt cfg env lopt)
in ((bs), (body), (_0_279))))
...
let uu____1222 = (let _0_282 = (let _0_281 = (FStar_Syntax_Syntax.mk_binder x)
in (_0_281)::[])
in (closures_as_binders_delayed cfg env _0_282))
in (match (uu____1222) with
| (x, env) -> begin
(

let phi = (closure_as_term_delayed cfg env phi)
in (let _0_285 = FStar_Syntax_Syntax.Tm_refine ((let _0_284 = (let _0_283 = (FStar_List.hd x)
in (FStar_All.pipe_right _0_283 Prims.fst))
in ((_0_284), (phi))))
in (mk _0_285 t.FStar_Syntax_Syntax.pos)))
end))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inl (t2), lopt) -> begin
(let _0_290 = FStar_Syntax_Syntax.Tm_ascribed ((let _0_289 = (closure_as_term_delayed cfg env t1)
in (let _0_288 = (let _0_287 = (closure_as_term_delayed cfg env t2)
in (FStar_All.pipe_left (fun _0_286 -> FStar_Util.Inl (_0_286)) _0_287))
in ((_0_289), (_0_288), (lopt)))))
in (mk _0_290 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inr (c), lopt) -> begin
(let _0_295 = FStar_Syntax_Syntax.Tm_ascribed ((let _0_294 = (closure_as_term_delayed cfg env t1)
in (let _0_293 = (let _0_292 = (close_comp cfg env c)
in (FStar_All.pipe_left (fun _0_291 -> FStar_Util.Inr (_0_291)) _0_292))
in ((_0_294), (_0_293), (lopt)))))
in (mk _0_295 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', FStar_Syntax_Syntax.Meta_pattern (args)) -> begin
(let _0_298 = FStar_Syntax_Syntax.Tm_meta ((let _0_297 = (closure_as_term_delayed cfg env t')
in (let _0_296 = FStar_Syntax_Syntax.Meta_pattern ((FStar_All.pipe_right args (FStar_List.map (closures_as_args_delayed cfg env))))
in ((_0_297), (_0_296)))))
...
in (let _0_300 = FStar_Syntax_Syntax.Meta_monadic ((let _0_299 = (closure_as_term_delayed cfg env tbody)
in ((m), (_0_299))))
in ((_0_301), (_0_300)))))
...
(let _0_306 = FStar_Syntax_Syntax.Tm_meta ((let _0_305 = (closure_as_term_delayed cfg env t')
in (let _0_304 = FStar_Syntax_Syntax.Meta_monadic_lift ((let _0_303 = (closure_as_term_delayed cfg env tbody)
in ((m1), (m2), (_0_303))))
in ((_0_305), (_0_304)))))
in (mk _0_306 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', m) -> begin
(let _0_308 = FStar_Syntax_Syntax.Tm_meta ((let _0_307 = (closure_as_term_delayed cfg env t')
in ((_0_307), (m))))
in (mk _0_308 t.FStar_Syntax_Syntax.pos))
end
...
in (let _0_310 = (closure_as_term cfg env_univs lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_309 = (closure_as_term cfg env lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___138_1480.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___138_1480.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _0_310; FStar_Syntax_Syntax.lbeff = uu___138_1480.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _0_309}))))))
in (
...
let uu___141_1849 = x
in (let _0_311 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___141_1849.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___141_1849.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_311}))
in (((
...
let uu___143_1858 = x
in (let _0_312 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___143_1858.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___143_1858.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_312}))
in (((
...
let uu___145_1872 = x
in (let _0_313 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___145_1872.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___145_1872.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_313}))
in (
...
in (let _0_315 = FStar_Syntax_Syntax.Tm_match ((let _0_314 = (FStar_All.pipe_right branches (FStar_List.map (norm_one_branch env)))
in ((head), (_0_314))))
...
| (x, imp) -> begin
(let _0_316 = (closure_as_term_delayed cfg env x)
in ((_0_316), (imp)))
end)) args)
end))
...
let uu___147_2072 = b
in (let _0_317 = (closure_as_term_delayed cfg env b.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___147_2072.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___147_2072.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_317}))
in (
...
(let _0_319 = (closure_as_term_delayed cfg env t)
in (let _0_318 = (FStar_Option.map (norm_universe cfg env) uopt)
in (FStar_Syntax_Syntax.mk_Total' _0_319 _0_318)))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(let _0_321 = (closure_as_term_delayed cfg env t)
in (let _0_320 = (FStar_Option.map (norm_universe cfg env) uopt)
in (FStar_Syntax_Syntax.mk_GTotal' _0_321 _0_320)))
end
...
let uu___148_2156 = c
in (let _0_322 = (FStar_List.map (norm_universe cfg env) c.FStar_Syntax_Syntax.comp_univs)
in {FStar_Syntax_Syntax.comp_univs = _0_322; FStar_Syntax_Syntax.effect_name = uu___148_2156.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = rt; FStar_Syntax_Syntax.effect_args = args; FStar_Syntax_Syntax.flags = flags}))))))
end)
end))
...
let int_as_const = (fun i -> FStar_Const.Const_int ((let _0_323 = (FStar_Util.string_of_int i)
in ((_0_323), (None)))))
in (

let bool_as_const = (fun b -> FStar_Const.Const_bool (b))
in (let _0_332 = (FStar_List.flatten (FStar_List.map (fun m -> (let _0_331 = (let _0_324 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("add")::[]))
in ((_0_324), ((fun x y -> (int_as_const (x + y))))))
in (let _0_330 = (let _0_329 = (let _0_325 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("sub")::[]))
in ((_0_325), ((fun x y -> (int_as_const (x - y))))))
in (let _0_328 = (let _0_327 = (let _0_326 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("mul")::[]))
in ((_0_326), ((fun x y -> (int_as_const (x * y))))))
in (_0_327)::[])
in (_0_329)::_0_328))
in (_0_331)::_0_330))) (("Int8")::("UInt8")::("Int16")::("UInt16")::("Int32")::("UInt32")::("Int64")::("UInt64")::("UInt128")::[])))
...
let name = (fun x -> (mk (FStar_Syntax_Syntax.Tm_fvar ((let _0_333 = (FStar_Syntax_Const.p2l x)
in (FStar_Syntax_Syntax.lid_as_fv _0_333 FStar_Syntax_Syntax.Delta_constant None))))))
in (

let ctor = (fun x -> (mk (FStar_Syntax_Syntax.Tm_fvar ((let _0_334 = (FStar_Syntax_Const.p2l x)
in (FStar_Syntax_Syntax.lid_as_fv _0_334 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))))))
in (let _0_351 = (let _0_350 = (FStar_Syntax_Const.p2l (("FStar")::("String")::("list_of_string")::[]))
in ((_0_350), ((fun s -> (let _0_349 = (FStar_String.list_of_string s)
in (let _0_348 = (mk (FStar_Syntax_Syntax.Tm_app ((let _0_347 = (let _0_343 = (ctor (("Prims")::("Nil")::[]))
in (FStar_Syntax_Syntax.mk_Tm_uinst _0_343 ((FStar_Syntax_Syntax.U_zero)::[])))
in (let _0_346 = (let _0_345 = (let _0_344 = (name (("FStar")::("Char")::("char")::[]))
in ((_0_344), (Some (FStar_Syntax_Syntax.Implicit (true)))))
in (_0_345)::[])
in ((_0_347), (_0_346)))))))
in (FStar_List.fold_right (fun c a -> (mk (FStar_Syntax_Syntax.Tm_app ((let _0_342 = (let _0_335 = (ctor (("Prims")::("Cons")::[]))
in (FStar_Syntax_Syntax.mk_Tm_uinst _0_335 ((FStar_Syntax_Syntax.U_zero)::[])))
in (let _0_341 = (let _0_340 = (let _0_336 = (name (("FStar")::("Char")::("char")::[]))
in ((_0_336), (Some (FStar_Syntax_Syntax.Implicit (true)))))
in (let _0_339 = (let _0_338 = (let _0_337 = (mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_char (c))))
in ((_0_337), (None)))
in (_0_338)::(((a), (None)))::[])
in (_0_340)::_0_339))
in ((_0_342), (_0_341)))))))) _0_349 _0_348)))))))
in (_0_351)::[]))))
...
let c = (let _0_353 = (FStar_Util.int_of_string i)
in (let _0_352 = (FStar_Util.int_of_string j)
in (op _0_353 _0_352)))
in (mk (FStar_Syntax_Syntax.Tm_constant (c)) tm.FStar_Syntax_Syntax.pos)))
in (

let uu____2843 = (let _0_355 = (FStar_Syntax_Subst.compress a1).FStar_Syntax_Syntax.n
in (let _0_354 = (FStar_Syntax_Subst.compress a2).FStar_Syntax_Syntax.n
in ((_0_355), (_0_354))))
...
let uu____2896 = (let _0_359 = (FStar_Syntax_Subst.compress head1).FStar_Syntax_Syntax.n
in (let _0_358 = (FStar_Syntax_Subst.compress head2).FStar_Syntax_Syntax.n
in (let _0_357 = (FStar_Syntax_Subst.compress arg1).FStar_Syntax_Syntax.n
in (let _0_356 = (FStar_Syntax_Subst.compress arg2).FStar_Syntax_Syntax.n
in ((_0_359), (_0_358), (_0_357), (_0_356))))))
...
(let _0_363 = (mk (FStar_Syntax_Syntax.Tm_fvar (fv1)) tm.FStar_Syntax_Syntax.pos)
in (let _0_362 = (let _0_361 = (let _0_360 = (norm i j)
in ((_0_360), (None)))
in (_0_361)::[])
in (FStar_Syntax_Util.mk_app _0_363 _0_362)))
end
| uu____2938 -> begin
tm
end))
...
let uu____3850 = (let _0_364 = (FStar_Syntax_Util.un_uinst hd).FStar_Syntax_Syntax.n
in ((_0_364), (args)))
...
let t = (FStar_Syntax_Subst.compress t)
in ((log cfg (fun uu____3991 -> (let _0_367 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_366 = (FStar_Syntax_Print.term_to_string t)
in (let _0_365 = (stack_to_string stack)
in (FStar_Util.print3 ">>> %s\nNorm %s with top of the stack %s \n" _0_367 _0_366 _0_365))))));
...
in (let _0_368 = (mk (FStar_Syntax_Syntax.Tm_type (u)) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack _0_368)))
end
| FStar_Syntax_Syntax.Tm_uinst (t', us) -> begin
(
...
let us = UnivArgs ((let _0_369 = (FStar_List.map (norm_universe cfg env) us)
in ((_0_369), (t.FStar_Syntax_Syntax.pos))))
in (
...
let r_env = (let _0_370 = (FStar_Syntax_Syntax.range_of_fv f)
in (FStar_TypeChecker_Env.set_range cfg.tcenv _0_370))
in (
...
| Some (us, t) -> begin
((log cfg (fun uu____4284 -> (let _0_372 = (FStar_Syntax_Print.term_to_string t0)
in (let _0_371 = (FStar_Syntax_Print.term_to_string t)
...
| uu____4305 -> begin
(failwith (let _0_373 = (FStar_Syntax_Print.lid_to_string f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_Util.format1 "Impossible: missing universe instantiation on %s" _0_373)))
end)
end
| uu____4310 -> begin
(norm cfg env stack t)
...
| Some (env, t') -> begin
((log cfg (fun uu____4347 -> (let _0_375 = (FStar_Syntax_Print.term_to_string t)
...
((log cfg (fun uu____4431 -> (let _0_376 = (closure_to_string c)
...
((log cfg (fun uu____4448 -> (let _0_377 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_377))));
(norm cfg ((c)::env) stack_rest body);
)
end
| Some (FStar_Util.Inl (lc)) when (FStar_Syntax_Util.is_tot_or_gtot_lcomp lc) -> begin
((log cfg (fun uu____4459 -> (let _0_378 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_378))));
(norm cfg ((c)::env) stack_rest body);
)
end
...
in (let _0_379 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_379)))
end)
end
| (uu____4476)::tl -> begin
((log cfg (fun uu____4486 -> (let _0_380 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_380))));
(
...
((set_memo r ((env), (t)));
(log cfg (fun uu____4520 -> (let _0_381 = (FStar_Syntax_Print.term_to_string t)
...
| true -> begin
(let _0_382 = (closure_as_term cfg env t)
...
(let _0_388 = (let _0_386 = (let _0_384 = (let _0_383 = (l.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp opening _0_383))
in (FStar_All.pipe_right _0_384 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right _0_386 (fun _0_385 -> FStar_Util.Inl (_0_385))))
...
in ((log cfg (fun uu____4604 -> (let _0_389 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
...
| (a, aq) -> begin
(let _0_392 = Arg ((let _0_391 = Clos ((let _0_390 = (FStar_Util.mk_ref None)
in ((env), (a), (_0_390), (false))))
in ((_0_391), (aq), (t.FStar_Syntax_Syntax.pos))))
in (_0_392)::stack)
end)) args))
in ((log cfg (fun uu____4661 -> (let _0_393 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
...
let t = (let _0_396 = FStar_Syntax_Syntax.Tm_refine ((let _0_395 = (FStar_Syntax_Subst.close closing f)
in (((

let uu___154_4704 = x
in {FStar_Syntax_Syntax.ppname = uu___154_4704.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___154_4704.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (_0_395))))
in (mk _0_396 t.FStar_Syntax_Syntax.pos))
in (rebuild cfg env stack t)))
end)))
end)
end
...
let c = (let _0_398 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env uu____4729 -> (Dummy)::env) env))
in (norm_comp cfg _0_398 c))
in (

let t = (let _0_399 = (norm_binders cfg env bs)
in (FStar_Syntax_Util.arrow _0_399 c))
in (rebuild cfg env stack t)))
end))
end)
end
...
in (let _0_400 = (mk (FStar_Syntax_Syntax.Tm_ascribed (((t1), (tc), (l)))) t.FStar_Syntax_Syntax.pos)
...
let env = (let _0_402 = Clos ((let _0_401 = (FStar_Util.mk_ref None)
in ((env), (lb.FStar_Syntax_Syntax.lbdef), (_0_401), (false))))
in (_0_402)::env)
...
let uu____4891 = (let _0_405 = (let _0_404 = (let _0_403 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.left)
in (FStar_All.pipe_right _0_403 FStar_Syntax_Syntax.mk_binder))
in (_0_404)::[])
in (FStar_Syntax_Subst.open_term _0_405 body))
...
in (let _0_411 = (let _0_408 = (let _0_406 = (FStar_List.hd bs)
in (FStar_All.pipe_right _0_406 Prims.fst))
in (FStar_All.pipe_right _0_408 (fun _0_407 -> FStar_Util.Inl (_0_407))))
in (let _0_410 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_409 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _0_411; FStar_Syntax_Syntax.lbunivs = uu___155_4899.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _0_410; FStar_Syntax_Syntax.lbeff = uu___155_4899.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _0_409}))))
in (
...
(let _0_412 = (closure_as_term cfg env t)
...
let body_env = (FStar_List.fold_right (fun lb env -> (let _0_414 = Clos ((let _0_413 = (FStar_Util.mk_ref None)
in ((rec_env), (lb.FStar_Syntax_Syntax.lbdef), (_0_413), (false))))
in (_0_414)::env)) (Prims.snd lbs) env)
...
let body = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_abs ((let _0_416 = (let _0_415 = (FStar_Syntax_Syntax.mk_binder x)
in (_0_415)::[])
in ((_0_416), (body), (None)))))) None body.FStar_Syntax_Syntax.pos)
in (
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_420 = (let _0_419 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_418 = (let _0_417 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_0_417)::[])
in (_0_419)::_0_418))
in ((bind), (_0_420)))))) None t.FStar_Syntax_Syntax.pos)
end
| uu____5251 -> begin
...
let reified = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_432 = (let _0_431 = (FStar_Syntax_Syntax.as_arg lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_430 = (let _0_429 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_428 = (let _0_427 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_426 = (let _0_425 = (FStar_Syntax_Syntax.as_arg head)
in (let _0_424 = (let _0_423 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_422 = (let _0_421 = (FStar_Syntax_Syntax.as_arg body)
in (_0_421)::[])
in (_0_423)::_0_422))
in (_0_425)::_0_424))
in (_0_427)::_0_426))
in (_0_429)::_0_428))
in (_0_431)::_0_430))
in ((bind_inst), (_0_432)))))) None t.FStar_Syntax_Syntax.pos)
in (let _0_433 = (FStar_List.tl stack)
in (norm cfg env _0_433 reified)))))))
end
...
| Some (x) when (let _0_434 = (FStar_Syntax_Syntax.lid_of_fv x)
in (FStar_TypeChecker_Env.is_action cfg.tcenv _0_434)) -> begin
(
...
let body = (let _0_437 = (let _0_436 = (let _0_435 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_0_435), (q)))
in (_0_436)::acc)
in (bind_on_lift es _0_437))
in (
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_441 = (let _0_440 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t')
in (let _0_439 = (let _0_438 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_0_438)::[])
in (_0_440)::_0_439))
in ((bind), (_0_441)))))) None e0.FStar_Syntax_Syntax.pos)
end
| uu____5512 -> begin
(failwith "NIY : Reification of indexed effects")
end))
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_453 = (let _0_452 = (FStar_Syntax_Syntax.as_arg t')
in (let _0_451 = (let _0_450 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_449 = (let _0_448 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_447 = (let _0_446 = (FStar_Syntax_Syntax.as_arg lifted_e0)
in (let _0_445 = (let _0_444 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_443 = (let _0_442 = (FStar_Syntax_Syntax.as_arg continuation)
in (_0_442)::[])
in (_0_444)::_0_443))
in (_0_446)::_0_445))
in (_0_448)::_0_447))
in (_0_450)::_0_449))
in (_0_452)::_0_451))
in ((bind_inst), (_0_453)))))) None e0.FStar_Syntax_Syntax.pos))))))
end
...
let binded_head = (let _0_455 = (let _0_454 = (FStar_Syntax_Syntax.as_arg head)
in (_0_454)::args)
in (bind_on_lift _0_455 []))
in (let _0_456 = (FStar_List.tl stack)
in (norm cfg env _0_456 binded_head)))))
end)))
end
...
| true -> begin
(let _0_458 = (FStar_List.tl stack)
in (let _0_457 = (reify_lift cfg.tcenv head m m' t)
in (norm cfg env _0_458 _0_457)))
end
| uu____5587 -> begin
(
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_460 = (let _0_459 = (env.FStar_TypeChecker_Env.universe_of env t)
in (_0_459)::[])
in ((return_tm), (_0_460)))))) None e.FStar_Syntax_Syntax.pos)
end
| uu____5674 -> begin
(failwith "NIY : Reification of indexed effects")
end))
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_464 = (let _0_463 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_462 = (let _0_461 = (FStar_Syntax_Syntax.as_arg e)
in (_0_461)::[])
in (_0_463)::_0_462))
in ((return_inst), (_0_464)))))) None e.FStar_Syntax_Syntax.pos))
end)))
end
| uu____5688 -> begin
...
in (let _0_468 = FStar_Syntax_Syntax.Total ((let _0_467 = (norm cfg env [] t)
in (let _0_466 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_0_467), (_0_466)))))
in {FStar_Syntax_Syntax.n = _0_468; FStar_Syntax_Syntax.tk = uu___159_5739.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___159_5739.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___159_5739.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(

let uu___160_5755 = comp
in (let _0_471 = FStar_Syntax_Syntax.GTotal ((let _0_470 = (norm cfg env [] t)
in (let _0_469 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_0_470), (_0_469)))))
in {FStar_Syntax_Syntax.n = _0_471; FStar_Syntax_Syntax.tk = uu___160_5755.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___160_5755.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___160_5755.FStar_Syntax_Syntax.vars}))
end
...
in (let _0_476 = FStar_Syntax_Syntax.Comp ((

let uu___162_5806 = ct
in (let _0_475 = (FStar_List.map (norm_universe cfg env) ct.FStar_Syntax_Syntax.comp_univs)
in (let _0_474 = (norm cfg env [] ct.FStar_Syntax_Syntax.result_typ)
in (let _0_473 = (norm_args ct.FStar_Syntax_Syntax.effect_args)
in {FStar_Syntax_Syntax.comp_univs = _0_475; FStar_Syntax_Syntax.effect_name = uu___162_5806.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _0_474; FStar_Syntax_Syntax.effect_args = _0_473; FStar_Syntax_Syntax.flags = flags})))))
in {FStar_Syntax_Syntax.n = _0_476; FStar_Syntax_Syntax.tk = uu___161_5803.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___161_5803.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___161_5803.FStar_Syntax_Syntax.vars}))))
end)))
...
let uu___168_5869 = x
in (let _0_477 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___168_5869.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___168_5869.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_477}))
in ((_0_478), (imp)))
end))
...
| true -> begin
Some (FStar_Util.Inl ((FStar_Syntax_Util.lcomp_of_comp (let _0_479 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.comp_set_flags _0_479 flags)))))
end
| uu____5925 -> begin
Some (FStar_Util.Inl ((FStar_Syntax_Util.lcomp_of_comp (let _0_480 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.comp_set_flags _0_480 flags)))))
end)))
end
| uu____5928 -> begin
Some (FStar_Util.Inr (((lc.FStar_Syntax_Syntax.eff_name), (flags))))
...
| true -> begin
(let _0_482 = (FStar_Syntax_Print.term_to_string tm)
in (let _0_481 = (FStar_Syntax_Print.term_to_string t)
...
| (MemoLazy (r))::stack -> begin
((set_memo r ((env), (t)));
(log cfg (fun uu____5978 -> (let _0_483 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print1 "\tSet memo %s\n" _0_483))));
(rebuild cfg env stack t);
)
end
...
in (rebuild cfg env stack _0_484))))
end
...
((log cfg (fun uu____6053 -> (let _0_485 = (FStar_Syntax_Print.term_to_string tm)
...
in (let _0_486 = (maybe_simplify cfg.steps t)
in (rebuild cfg env stack _0_486)))
end
| (Match (env, branches, r))::stack -> begin
((log cfg (fun uu____6118 -> (let _0_487 = (FStar_Syntax_Print.term_to_string t)
...
let uu___174_6430 = x
in (let _0_488 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___174_6430.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___174_6430.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_488}))
in (((
...
let uu___176_6439 = x
in (let _0_489 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___176_6439.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___176_6439.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_489}))
in (((
...
let uu___178_6453 = x
in (let _0_490 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___178_6453.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___178_6453.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_490}))
in (
...
in (let _0_491 = (mk (FStar_Syntax_Syntax.Tm_match (((scrutinee), (branches)))) r)
...
| FStar_Util.Inl (s) -> begin
((log cfg (fun uu____6909 -> (let _0_494 = (FStar_Syntax_Print.pat_to_string p)
in (let _0_493 = (let _0_492 = (FStar_List.map FStar_Syntax_Print.term_to_string s)
in (FStar_All.pipe_right _0_492 (FStar_String.concat "; ")))
in (FStar_Util.print2 "Matches pattern %s with subst = %s\n" _0_494 _0_493)))));
(

let env = (FStar_List.fold_left (fun env t -> (let _0_496 = Clos ((let _0_495 = (FStar_Util.mk_ref (Some ((([]), (t)))))
in (([]), (t), (_0_495), (false))))
in (_0_496)::env)) env s)
in (let _0_497 = (guard_when_clause wopt b rest)
in (norm cfg env stack _0_497)));
)
end))
end))
in (
...
let normalize : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun s e t -> (let _0_498 = (config s e)
in (norm _0_498 [] [] t)))


let normalize_comp : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun s e t -> (let _0_499 = (config s e)
in (norm_comp _0_499 [] t)))


let normalize_universe : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.universe  ->  FStar_Syntax_Syntax.universe = (fun env u -> (let _0_500 = (config [] env)
in (norm_universe _0_500 [] u)))


let ghost_to_pure : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun env c -> (let _0_501 = (config [] env)
in (ghost_to_pure_aux _0_501 [] c)))
...
in {FStar_Syntax_Syntax.eff_name = pure_eff; FStar_Syntax_Syntax.res_typ = uu___180_6999.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___180_6999.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____7000 -> (let _0_502 = (lc.FStar_Syntax_Syntax.comp ())
in (ghost_to_pure env _0_502)))})
end
| None -> begin
lc
end)
...
let comp_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  Prims.string = (fun env c -> (FStar_Syntax_Print.comp_to_string (let _0_503 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp _0_503 [] c))))
...
(let _0_505 = FStar_Syntax_Syntax.Tm_refine ((let _0_504 = (FStar_Syntax_Util.mk_conj phi1 phi)
in ((y), (_0_504))))
in (mk _0_505 t0.FStar_Syntax_Syntax.pos))
end
| uu____7052 -> begin
t
end))
...
| (binders, args) -> begin
(let _0_510 = ((FStar_Syntax_Syntax.mk_Tm_app t args) None t.FStar_Syntax_Syntax.pos)
in (let _0_509 = (let _0_508 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _0_506 -> FStar_Util.Inl (_0_506)))
in (FStar_All.pipe_right _0_508 (fun _0_507 -> Some (_0_507))))
in (FStar_Syntax_Util.abs binders _0_510 _0_509)))
end))
end)
end)))
...
let uu____7126 = (let _0_511 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in ((_0_511), (t.FStar_Syntax_Syntax.n)))
in (match (uu____7126) with
| (Some (sort), uu____7135) -> begin
(let _0_512 = (mk sort t.FStar_Syntax_Syntax.pos)
in (eta_expand_with_type t _0_512))
end
