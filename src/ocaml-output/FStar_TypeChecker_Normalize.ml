...
let eta_expand_with_type:
  ...
  fun t  ->
    fun sort  ->
      let uu____8125 = FStar_Syntax_Util.arrow_formals_comp sort in
           ...
           | uu____8141 ->
               ...
               (match uu____8145 with
                | (binders1,args) ->
                    ...
                    FStar_Syntax_Util.abs binders1 uu____8155 uu____8160))
let eta_expand:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun t  ->
      let uu____8203 =
        let uu____8207 = FStar_ST.read t.FStar_Syntax_Syntax.tk in
        (uu____8207, (t.FStar_Syntax_Syntax.n)) in
      match uu____8203 with
      | (Some sort,uu____8214) ->
          let uu____8216 = mk sort t.FStar_Syntax_Syntax.pos in
          eta_expand_with_type t uu____8216
      | (uu____8217,FStar_Syntax_Syntax.Tm_name x) ->
          eta_expand_with_type t x.FStar_Syntax_Syntax.sort
      | uu____8221 ->
          let uu____8225 = FStar_Syntax_Util.head_and_args t in
          (match uu____8225 with
           | (head1,args) ->
               let uu____8251 =
                 let uu____8252 = FStar_Syntax_Subst.compress head1 in
                 uu____8252.FStar_Syntax_Syntax.n in
               (match uu____8251 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____8255,thead) ->
                    let uu____8269 = FStar_Syntax_Util.arrow_formals thead in
                         ...
                         then t
                           ...
                           (let uu____8300 =
                              env.FStar_TypeChecker_Env.type_of
                                (let uu___194_8304 = env in
                                 {
                                   FStar_TypeChecker_Env.solver =
                                     (uu___194_8304.FStar_TypeChecker_Env.solver);
                                   FStar_TypeChecker_Env.range =
                                     (uu___194_8304.FStar_TypeChecker_Env.range);
                                   FStar_TypeChecker_Env.curmodule =
                                     (uu___194_8304.FStar_TypeChecker_Env.curmodule);
                                   FStar_TypeChecker_Env.gamma =
                                     (uu___194_8304.FStar_TypeChecker_Env.gamma);
                                   FStar_TypeChecker_Env.gamma_cache =
                                     (uu___194_8304.FStar_TypeChecker_Env.gamma_cache);
                                   FStar_TypeChecker_Env.modules =
                                     (uu___194_8304.FStar_TypeChecker_Env.modules);
                                   FStar_TypeChecker_Env.expected_typ = None;
                                   FStar_TypeChecker_Env.sigtab =
                                     (uu___194_8304.FStar_TypeChecker_Env.sigtab);
                                   FStar_TypeChecker_Env.is_pattern =
                                     (uu___194_8304.FStar_TypeChecker_Env.is_pattern);
                                   FStar_TypeChecker_Env.instantiate_imp =
                                     (uu___194_8304.FStar_TypeChecker_Env.instantiate_imp);
                                   FStar_TypeChecker_Env.effects =
                                     (uu___194_8304.FStar_TypeChecker_Env.effects);
                                   FStar_TypeChecker_Env.generalize =
                                     (uu___194_8304.FStar_TypeChecker_Env.generalize);
                                   FStar_TypeChecker_Env.letrecs =
                                     (uu___194_8304.FStar_TypeChecker_Env.letrecs);
                                   FStar_TypeChecker_Env.top_level =
                                     (uu___194_8304.FStar_TypeChecker_Env.top_level);
                                   FStar_TypeChecker_Env.check_uvars =
                                     (uu___194_8304.FStar_TypeChecker_Env.check_uvars);
                                   FStar_TypeChecker_Env.use_eq =
                                     (uu___194_8304.FStar_TypeChecker_Env.use_eq);
                                   FStar_TypeChecker_Env.is_iface =
                                     (uu___194_8304.FStar_TypeChecker_Env.is_iface);
                                   FStar_TypeChecker_Env.admit =
                                     (uu___194_8304.FStar_TypeChecker_Env.admit);
                                   FStar_TypeChecker_Env.lax = true;
                                   FStar_TypeChecker_Env.lax_universes =
                                     (uu___194_8304.FStar_TypeChecker_Env.lax_universes);
                                   FStar_TypeChecker_Env.type_of =
                                     (uu___194_8304.FStar_TypeChecker_Env.type_of);
                                   FStar_TypeChecker_Env.universe_of =
                                     (uu___194_8304.FStar_TypeChecker_Env.universe_of);
                                   FStar_TypeChecker_Env.use_bv_sorts = true;
                                   FStar_TypeChecker_Env.qname_and_index =
                                     (uu___194_8304.FStar_TypeChecker_Env.qname_and_index)
                                 }) t in
                            match uu____8300 with
                            | (uu____8305,ty,uu____8307) ->
                                eta_expand_with_type t ty))
                | uu____8308 ->
                    let uu____8309 =
                      env.FStar_TypeChecker_Env.type_of
                        (let uu___195_8313 = env in
                         {
                           FStar_TypeChecker_Env.solver =
                             (uu___195_8313.FStar_TypeChecker_Env.solver);
                           FStar_TypeChecker_Env.range =
                             (uu___195_8313.FStar_TypeChecker_Env.range);
                           FStar_TypeChecker_Env.curmodule =
                             (uu___195_8313.FStar_TypeChecker_Env.curmodule);
                           FStar_TypeChecker_Env.gamma =
                             (uu___195_8313.FStar_TypeChecker_Env.gamma);
                           FStar_TypeChecker_Env.gamma_cache =
                             (uu___195_8313.FStar_TypeChecker_Env.gamma_cache);
                           FStar_TypeChecker_Env.modules =
                             (uu___195_8313.FStar_TypeChecker_Env.modules);
                           FStar_TypeChecker_Env.expected_typ = None;
                           FStar_TypeChecker_Env.sigtab =
                             (uu___195_8313.FStar_TypeChecker_Env.sigtab);
                           FStar_TypeChecker_Env.is_pattern =
                             (uu___195_8313.FStar_TypeChecker_Env.is_pattern);
                           FStar_TypeChecker_Env.instantiate_imp =
                             (uu___195_8313.FStar_TypeChecker_Env.instantiate_imp);
                           FStar_TypeChecker_Env.effects =
                             (uu___195_8313.FStar_TypeChecker_Env.effects);
                           FStar_TypeChecker_Env.generalize =
                             (uu___195_8313.FStar_TypeChecker_Env.generalize);
                           FStar_TypeChecker_Env.letrecs =
                             (uu___195_8313.FStar_TypeChecker_Env.letrecs);
                           FStar_TypeChecker_Env.top_level =
                             (uu___195_8313.FStar_TypeChecker_Env.top_level);
                           FStar_TypeChecker_Env.check_uvars =
                             (uu___195_8313.FStar_TypeChecker_Env.check_uvars);
                           FStar_TypeChecker_Env.use_eq =
                             (uu___195_8313.FStar_TypeChecker_Env.use_eq);
                           FStar_TypeChecker_Env.is_iface =
                             (uu___195_8313.FStar_TypeChecker_Env.is_iface);
                           FStar_TypeChecker_Env.admit =
                             (uu___195_8313.FStar_TypeChecker_Env.admit);
                           FStar_TypeChecker_Env.lax = true;
                           FStar_TypeChecker_Env.lax_universes =
                             (uu___195_8313.FStar_TypeChecker_Env.lax_universes);
                           FStar_TypeChecker_Env.type_of =
                             (uu___195_8313.FStar_TypeChecker_Env.type_of);
                           FStar_TypeChecker_Env.universe_of =
                             (uu___195_8313.FStar_TypeChecker_Env.universe_of);
                           FStar_TypeChecker_Env.use_bv_sorts = true;
                           FStar_TypeChecker_Env.qname_and_index =
                             (uu___195_8313.FStar_TypeChecker_Env.qname_and_index)
                         }) t in
                    (match uu____8309 with
                     | (uu____8314,ty,uu____8316) ->
                         eta_expand_with_type t ty)))