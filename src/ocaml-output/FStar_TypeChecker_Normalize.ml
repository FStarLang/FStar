          ...
          (match t.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_uinst (t',us) ->
               ...
               then norm cfg env stack t'
                 ...
                 (let us =
                    UnivArgs
                      (let _0_381 = FStar_List.map (norm_universe cfg env) us
                          in
               ...
               then rebuild cfg env stack t
                 ...
                 (let r_env =
                  ...
                  | Some (us,t) ->
                      (log cfg
                         (fun uu____4284  ->
                            let _0_384 = FStar_Syntax_Print.term_to_string t0
                               in
                            let _0_383 = FStar_Syntax_Print.term_to_string t
                               in
                 ...
                 (let t_x = norm cfg env [] x.FStar_Syntax_Syntax.sort  in
                  ...
                  | (closing,f) ->
                      ...
                      let t =
                        let _0_408 =
                          FStar_Syntax_Syntax.Tm_refine
                            (let _0_407 = FStar_Syntax_Subst.close closing f
                                in
                   ...
                   let _0_414 =
                     Clos
                       (let _0_413 = FStar_Util.mk_ref None  in
                        (env, (lb.FStar_Syntax_Syntax.lbdef), _0_413, false))
                      in
                   _0_414 :: env  in
