               ...
               (if
                ...
                (let inst =
                     ...
                     (fun uu____761  ->
                        fun uu____762  ->
                          ...
                          | ((x,uu____776),(t,uu____778)) ->
                              FStar_Syntax_Syntax.NT (x, t)) binders _0_282 in
                 ...
                 let c =
                   ...
                   FStar_All.pipe_right _0_283 FStar_Syntax_Syntax.mk_Comp in
      ...
      fun u  ->
        ...
        let rec aux u =
          ...
          | FStar_Syntax_Syntax.U_succ u ->
              let _0_286 = aux u in
              FStar_List.map
                (fun _0_285  -> FStar_Syntax_Syntax.U_succ _0_285) _0_286 in
        let uu____931 =
                    ...
                    FStar_Syntax_Syntax.Tm_ascribed
                      (let _0_301 = closure_as_term_delayed cfg env t1 in
                       let _0_300 =
                         ...
                         FStar_All.pipe_left
                           (fun _0_298  -> FStar_Util.Inl _0_298) _0_299 in
                       (_0_301, _0_300, lopt)) in
                    ...
                    FStar_Syntax_Syntax.Tm_ascribed
                      (let _0_306 = closure_as_term_delayed cfg env t1 in
                       let _0_305 =
                         ...
                         FStar_All.pipe_left
                           (fun _0_303  -> FStar_Util.Inr _0_303) _0_304 in
                       (_0_306, _0_305, lopt)) in
        ...
        | uu____2117 ->
            (match c.FStar_Syntax_Syntax.n with
             | FStar_Syntax_Syntax.Total (t,uopt) ->
                 ...
                 let _0_330 = FStar_Option.map (norm_universe cfg env) uopt in
                 FStar_Syntax_Syntax.mk_Total' _0_331 _0_330
             | FStar_Syntax_Syntax.GTotal (t,uopt) ->
                 let _0_333 = closure_as_term_delayed cfg env t in
                 let _0_332 = FStar_Option.map (norm_universe cfg env) uopt in
...
let arith_ops:
  ...
  let int_as_const i =
    FStar_Const.Const_int
      (let _0_335 = FStar_Util.string_of_int i in (_0_335, None)) in
...
let un_ops:
  ...
  let _0_363 =
    let _0_362 = FStar_Syntax_Const.p2l ["FStar"; "String"; "list_of_string"] in
    (_0_362,
      (fun s  ->
                     ...
                     (let _0_354 =
                      ...
                      let _0_353 =
                        ...
                        let _0_351 =
                          ...
                          [_0_350; (a, None)] in
                        _0_352 :: _0_351 in
                      (_0_354, _0_353)))) _0_361 _0_360)) in
  [_0_363]
let reduce_equality:
  (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
    FStar_Syntax_Syntax.syntax ->
                       ...
                       (match uu____2896 with
                        | (FStar_Syntax_Syntax.Tm_fvar
                           ...
                           (FStar_Const.Const_int (j,None ))) when
                            ...
                            let _0_374 =
                              let _0_373 =
                                let _0_372 = norm i j in (_0_372, None) in
                              [_0_373] in
          ...
          (match t.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_uinst (t',us) ->
               ...
               then norm cfg env stack t'
                 ...
                 (let us =
                    UnivArgs
                      (let _0_381 = FStar_List.map (norm_universe cfg env) us in
                       (_0_381, (t.FStar_Syntax_Syntax.pos))) in
               ...
               then rebuild cfg env stack t
                 ...
                 (let r_env =
                  ...
                  | Some (us,t) ->
                      (log cfg
                         (fun uu____4284  ->
                            let _0_384 = FStar_Syntax_Print.term_to_string t0 in
                            let _0_383 = FStar_Syntax_Print.term_to_string t in
               ...
               (match stack with
                ...
                | (MemoLazy r)::stack ->
                    (set_memo r (env, t);
                     log cfg
                       (fun uu____4520  ->
                          let _0_393 = FStar_Syntax_Print.term_to_string t in
                             ...
                             | Some (FStar_Util.Inl l) ->
                                 let _0_400 =
                                   ...
                                   FStar_All.pipe_right _0_398
                                     (fun _0_397  -> FStar_Util.Inl _0_397) in
                           ...
                           | (a,aq) ->
                               let _0_404 =
                                 Arg
                                   (let _0_403 =
                                      Clos
                                        (let _0_402 = FStar_Util.mk_ref None in
                                         (env, a, _0_402, false)) in
                                    (_0_403, aq, (t.FStar_Syntax_Syntax.pos))) in
                               _0_404 :: stack) args) in
               (log cfg
                  (fun uu____4661  ->
                     let _0_405 =
                 ...
                 (let t_x = norm cfg env [] x.FStar_Syntax_Syntax.sort in
                  ...
                  | (closing,f) ->
                      ...
                      let t =
                        let _0_408 =
                          FStar_Syntax_Syntax.Tm_refine
                            (let _0_407 = FStar_Syntax_Subst.close closing f in
                   ...
                   let _0_414 =
                     Clos
                       (let _0_413 = FStar_Util.mk_ref None in
                        (env, (lb.FStar_Syntax_Syntax.lbdef), _0_413, false)) in
                   _0_414 :: env in
                      ...
                      let lb =
                        ...
                        let _0_423 =
                          ...
                          FStar_All.pipe_right _0_420
                            (fun _0_419  -> FStar_Util.Inl _0_419) in
                        let _0_422 =
                             ...
                             let _0_426 =
                               Clos
                                 (let _0_425 = FStar_Util.mk_ref None in
                                  (rec_env, (lb.FStar_Syntax_Syntax.lbdef),
                                    _0_425, false)) in
                             _0_426 :: env) (Prims.snd lbs) env in
            ...
            let _0_480 =
              FStar_Syntax_Syntax.Total
                (let _0_479 = norm cfg env [] t in
                 let _0_478 = FStar_Option.map (norm_universe cfg env) uopt in
                 (_0_479, _0_478)) in
            {
              FStar_Syntax_Syntax.n = _0_480;
            ...
            let _0_483 =
              FStar_Syntax_Syntax.GTotal
                (let _0_482 = norm cfg env [] t in
                 let _0_481 = FStar_Option.map (norm_universe cfg env) uopt in
                 (_0_482, _0_481)) in
            {
              FStar_Syntax_Syntax.n = _0_483;
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____5787  ->
                      ...
                      | (a,i) ->
                          let _0_484 = norm cfg env [] a in (_0_484, i))) in
            let flags =
            ...
            let _0_488 =
              FStar_Syntax_Syntax.Comp
                (let uu___163_5806 = ct in
                 ...
                 let _0_485 = norm_args ct.FStar_Syntax_Syntax.effect_args in
                 {
                 ...
                 Some
                   (FStar_Util.Inl
                      (FStar_Syntax_Util.lcomp_of_comp
                         (let _0_491 = FStar_Syntax_Syntax.mk_Total t in
                          FStar_Syntax_Util.comp_set_flags _0_491 flags)))
               else
                 Some
                   (FStar_Util.Inl
                      (FStar_Syntax_Util.lcomp_of_comp
                         (let _0_492 = FStar_Syntax_Syntax.mk_GTotal t in
                    ...
                    let _0_521 =
                      let _0_520 =
                        FStar_All.pipe_right
                          ...
                          (fun _0_518  -> FStar_Util.Inl _0_518) in
                      FStar_All.pipe_right _0_520
                        (fun _0_519  -> Some _0_519) in
