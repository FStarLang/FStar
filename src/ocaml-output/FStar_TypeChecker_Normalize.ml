      ...
      FStar_List.map
        (fun uu___1  ->
           ...
           | (bopt,c) ->
               ...
               FStar_Util.format2 "(%s, %s)" uu___2 uu___3) env1
       in
    ...
    fun x  ->
      try
        (fun uu___  ->
           match () with
           | () ->
               let uu___1 = FStar_List.nth env1 x.FStar_Syntax_Syntax.index
                  in
...
let (downgrade_ghost_effect_name :
  ...
  fun l  ->
    let uu___ = FStar_Ident.lid_equals l FStar_Parser_Const.effect_Ghost_lid
       in
    if uu___
        ...
        let norm_univs_for_max us =
          ...
          let uu___ =
            FStar_List.fold_left
              ...
              us1
             in
          match uu___ with | (uu___1,u1,out) -> FStar_List.rev (u1 :: out)
           in
        let rec aux u1 =
          ...
          | FStar_Syntax_Syntax.U_succ u3 ->
              let uu___ = aux u3  in
              FStar_List.map
                (fun uu___1  -> FStar_Syntax_Syntax.U_succ uu___1) uu___
           in
        if
           ...
           | uu___1 ->
               (match t.FStar_Syntax_Syntax.n with
                ...
                | FStar_Syntax_Syntax.Tm_uinst (t',us) ->
                    let t1 =
                      let uu___2 = FStar_List.map (norm_universe cfg env1) us
                         in
                ...
                | FStar_Syntax_Syntax.Tm_let ((uu___2,lbs),body) ->
                    ...
                    let body1 =
                      let body_env =
                        FStar_List.fold_right
                          (fun uu___3  -> fun env2  -> dummy :: env2) lbs1
                          env1
                         in
        ...
        | uu___ ->
            (match c.FStar_Syntax_Syntax.n with
             | FStar_Syntax_Syntax.Total (t,uopt) ->
                 ...
                 let uu___2 = FStar_Option.map (norm_universe cfg env1) uopt
                    in
                   ...
                   FStar_All.pipe_right c1.FStar_Syntax_Syntax.effect_args
                     (FStar_List.map
                        (fun uu___1  ->
                           match uu___1 with
                           | (a,q) ->
                               let uu___2 = inline_closure_env cfg env1 [] a
                                  in
                               (uu___2, q)))
                    in
                 let flags =
                     ...
                     (FStar_List.map
                        (fun uu___1  ->
                           ...
                           | FStar_Syntax_Syntax.DECREASES t ->
                               let uu___2 = inline_closure_env cfg env1 [] t
                                  in
             ...
             | (head,args) ->
                 ...
                 (match uu___2 with
                                ...
                                (fun uu___5  ->
                                   let uu___6 =
                                     FStar_Syntax_Print.lid_to_string
                                      ...
                                      in
                                   let uu___7 = FStar_Util.string_of_int l
                                      in
                                   let uu___8 =
                                     FStar_Util.string_of_int
                  ...
                  | FStar_Syntax_Syntax.Tm_constant
                      ...
                      (FStar_TypeChecker_Cfg.log_primops cfg
                         (fun uu___4  ->
                            let uu___5 = FStar_Syntax_Print.term_to_string tm
                               in
    ...
    fun args  ->
      ...
      | uu___1 ->
          let uu___2 =
            ...
            FStar_String.op_Hat
              "Impossible! invalid rejig_norm_request for: %s" uu___3
             in
          failwith uu___2
...
let (tr_norm_steps :
  ...
  fun s  ->
    ...
    let add_exclude s2 z =
      let uu___ = FStar_Util.for_some (FStar_TypeChecker_Env.eq_step z) s2
         in
    ...
    fun full_norm  ->
      fun args  ->
        ...
        | (steps,uu___)::uu___1::(tm,uu___2)::[] ->
            let uu___3 = let uu___4 = full_norm steps  in parse_steps uu___4
               in
            (match uu___3 with
    ...
    fun stack1  ->
      ...
      | (App
          (uu___1,{
                    ...
                    FStar_Syntax_Syntax.vars = uu___3;_},uu___4,uu___5))::uu___6
              ...
              then
                ...
                (match (qninfo,
                    ...
                    (FStar_Util.Inr
                     ({
                        FStar_Syntax_Syntax.sigel =
                          FStar_Syntax_Syntax.Sig_let ((is_rec,uu___),uu___1);
                        FStar_Syntax_Syntax.sigrng = uu___2;
                        FStar_Syntax_Syntax.sigquals = qs;
                        FStar_Syntax_Syntax.sigmeta = uu___3;
                        FStar_Syntax_Syntax.sigattrs = uu___4;
                        FStar_Syntax_Syntax.sigopts = uu___5;_},uu___6),uu___7),uu___8,uu___9,uu___10)
                     when
                 ...
                 | (FStar_Pervasives_Native.Some
                    (FStar_Util.Inr
                     ...
                     (FStar_TypeChecker_Cfg.log_unfolding cfg
                      ...
                      no)
                 | (uu___,FStar_Pervasives_Native.Some uu___1,uu___2,uu___3)
                     ->
                     (FStar_TypeChecker_Cfg.log_unfolding cfg
                        (fun uu___5  ->
                           let uu___6 = FStar_Syntax_Print.fv_to_string fv
                              in
                           FStar_Util.print1
                                   ...
                                   FStar_Util.for_some
                                     (fun at  ->
                                        FStar_Util.for_some
                                          ...
                                          lids) attrs
                                    in
                                 FStar_All.pipe_left yesno uu___9
                              in
                           let uu___9 =
                             let uu___10 =
                               ...
                               | FStar_Pervasives_Native.Some lids ->
                                   let uu___11 =
                                     FStar_Util.for_some
                                       ...
                                       lids
                                      in
                                   FStar_All.pipe_left fullyno uu___11
                                in
                             [uu___10]  in
                           uu___8 :: uu___9  in
                         uu___6 :: uu___7  in
                 ...
                 | (uu___,uu___1,FStar_Pervasives_Native.Some uu___2,uu___3)
                     ...
                     (FStar_TypeChecker_Cfg.log_unfolding cfg
                      ...
                      (let uu___5 =
                         ...
                         uu___6 :: uu___7  in
                       comb_or uu___5))
                 | (uu___,uu___1,uu___2,FStar_Pervasives_Native.Some uu___3)
                     ->
                     (FStar_TypeChecker_Cfg.log_unfolding cfg
                        (fun uu___5  ->
                           let uu___6 = FStar_Syntax_Print.fv_to_string fv
                 ...
                 | uu___ ->
                     (FStar_TypeChecker_Cfg.log_unfolding cfg
                        (fun uu___2  ->
                           let uu___3 = FStar_Syntax_Print.fv_to_string fv
                              in
                           let uu___4 =
                              ...
                              (fun uu___3  ->
                                 ...
                                 | FStar_TypeChecker_Env.Unfold l ->
                                     ...
                                     FStar_TypeChecker_Common.delta_depth_greater_than
                                       uu___4 l))
                          in
                       FStar_All.pipe_left yesno uu___2)))
             in
          FStar_TypeChecker_Cfg.log_unfolding cfg
            (fun uu___1  ->
               let uu___2 = FStar_Syntax_Print.fv_to_string fv  in
          ...
          (match res with
           ...
           | uu___1 ->
               let uu___2 =
                 ...
                 FStar_Util.format1 "Unexpected unfolding result: %s" uu___3
                  in
        ...
        fun t  ->
          ...
          FStar_TypeChecker_Cfg.log cfg
            (fun uu___1  ->
               ...
               let uu___5 = FStar_Util.string_of_int (FStar_List.length env1)
                  in
               let uu___6 =
                 let uu___7 =
          ...
          (match t1.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_fvar fv ->
               ...
               (match uu___2 with
                | FStar_Pervasives_Native.Some
                    ...
                    (FStar_TypeChecker_Cfg.log_unfolding cfg
                       (fun uu___5  ->
                          let uu___6 = FStar_Syntax_Print.term_to_string t1
                             in
                          FStar_Util.print1 ">>> Tm_fvar case 0 for %s\n"
                            uu___6);
                     rebuild cfg env1 stack1 t1)
           ...
           | FStar_Syntax_Syntax.Tm_app (hd,args) when
               ...
               (if
                ...
                (let cfg' =
                 ...
                 let uu___3 = get_norm_request cfg (norm cfg' env1 []) args
                    in
                 match uu___3 with
                 | FStar_Pervasives_Native.None  ->
                     (if
                     ...
                     (if
                      ...
                      then
                        (let cfg'1 =
                         ...
                         let uu___6 = FStar_Syntax_Print.term_to_string tm'
                            in
                         let uu___7 =
                 ...
                 | FStar_Pervasives_Native.Some (s,tm) ->
                     ...
                     let stack' =
                       ...
                       then
                         let uu___4 =
                           let uu___5 =
                             let uu___6 = FStar_Util.now ()  in (tm, uu___6)
                              in
                           Debug uu___5  in
                         uu___4 :: tail
                       else tail  in
           ...
           | FStar_Syntax_Syntax.Tm_uinst (t',us) ->
               ...
               then norm cfg env1 stack1 t'
                 ...
                 (let us1 =
                    let uu___3 =
                      let uu___4 = FStar_List.map (norm_universe cfg env1) us
                         in
                 ...
                 (let t_x = norm cfg env1 [] x.FStar_Syntax_Syntax.sort  in
                  ...
                  | (closing,f1) ->
                      ...
                      let t2 =
                        let uu___4 =
                          let uu___5 =
                            let uu___6 = FStar_Syntax_Subst.close closing f2
                               in
                            ((let uu___7 = x  in
                              {
                                FStar_Syntax_Syntax.ppname =
                  ...
                  | (bs1,c1) ->
                      let c2 =
                        let uu___4 =
                          FStar_All.pipe_right bs1
                            (FStar_List.fold_left
                               (fun env2  -> fun uu___5  -> dummy :: env2)
                               env1)
                           in
               ...
               (match stack1 with
                ...
                | (App
                    (uu___2,{
                              ...
                              FStar_Syntax_Syntax.vars = uu___4;_},uu___5,uu___6))::uu___7
                    when
                    (cfg.FStar_TypeChecker_Cfg.steps).FStar_TypeChecker_Cfg.beta
                    ->
                    (FStar_TypeChecker_Cfg.log cfg
                      ...
                      (let tc1 =
                       ...
                       | (Cfg cfg1)::stack2 ->
                           let t2 =
                             let uu___5 =
                               let uu___6 =
                                 let uu___7 = FStar_Syntax_Util.unascribe t12
                                    in
                       ...
                       | uu___5 ->
                           let uu___6 =
                             let uu___7 =
                               let uu___8 =
                                 let uu___9 = FStar_Syntax_Util.unascribe t12
                                    in
           ...
           | FStar_Syntax_Syntax.Tm_let ((b,lbs),lbody) when
               ...
               rebuild cfg env1 stack1 uu___2
           | FStar_Syntax_Syntax.Tm_let
               ((uu___2,{ FStar_Syntax_Syntax.lbname = FStar_Util.Inr uu___3;
                          ...
                          FStar_Syntax_Syntax.lbpos = uu___9;_}::uu___10),uu___11)
               -> rebuild cfg env1 stack1 t1
           | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
               let uu___2 =
                    ...
                    (cfg.FStar_TypeChecker_Cfg.steps).FStar_TypeChecker_Cfg.reify_
                      ...
                      (let uu___5 =
                         FStar_TypeChecker_Env.norm_eff_name
                          ...
                          in
                       FStar_Syntax_Util.is_div_effect uu___5)
                     in
                  if uu___4
                  then
                    let ffun =
                      ...
                      FStar_List.map
                        (fun lb  ->
                           ...
                           | (xs,def_body,lopt) ->
                               ...
                               let env2 =
                                 let uu___4 =
                                   FStar_List.map (fun uu___5  -> dummy) xs1
                                    in
                                 let uu___5 =
                                   let uu___6 =
                       ...
                       in
                    let env' =
                      let uu___3 = FStar_List.map (fun uu___4  -> dummy) lbs2
                         in
                      FStar_List.append uu___3 env1  in
                    let body2 = norm cfg env' [] body1  in
                    let uu___3 = FStar_Syntax_Subst.close_let_rec lbs2 body2
                       in
                    (match uu___3 with
                     | (lbs3,body3) ->
                         let t2 =
                 ...
                 | uu___3 ->
                     ...
                     then norm cfg env1 stack1 head
                       ...
                       (match stack1 with
                        | uu___5::uu___6 ->
                            (match m with
                             | FStar_Syntax_Syntax.Meta_labeled (l,r,uu___7)
                                 ->
                                 ...
                                 | FStar_Util.Inl x ->
                                     ...
                                     (match uu___7 with
                                      | FStar_Pervasives_Native.Some e ->
                                          ...
                                          let uu___8 = FStar_List.tl stack1
                                             in
                                          let uu___9 =
                                            let uu___10 =
                                              let uu___11 =
                      ...
                      ((let uu___4 = FStar_Options.defensive ()  in
                        ...
                        then
                          let is_arg_impure uu___5 =
                            ...
                            | (e,q) ->
                                let uu___6 =
                                  let uu___7 = FStar_Syntax_Subst.compress e
                                     in
                          ...
                          let uu___5 =
                            let uu___6 =
                              let uu___7 = FStar_Syntax_Syntax.as_arg head
                                 in
                              uu___7 :: args  in
          ...
          fun t  ->
            ...
            (let uu___1 =
             ...
             then
               ...
               (let uu___3 = FStar_TypeChecker_Env.monad_leq env1 msrc mtgt
                   in
                match uu___3 with
                | FStar_Pervasives_Native.None  ->
                    let uu___4 =
      ...
      fun comp  ->
        FStar_TypeChecker_Cfg.log cfg
          (fun uu___1  ->
             ...
             let uu___3 = FStar_Util.string_of_int (FStar_List.length env1)
                in
                    ...
                    (match uu___4 with
                     | FStar_Syntax_Syntax.Tm_name bv when
                         ...
                         (if
                          ...
                          then
                            (let uu___6 = FStar_Syntax_Print.term_to_string t
                                in
                             let uu___7 = FStar_Syntax_Print.bv_to_string bv
                                in
                             let uu___8 =
             ...
             let is_quantified_const bv phi =
               ...
               | FStar_Pervasives_Native.Some (FStar_Syntax_Util.BaseConn
                   ...
                   (if
                    ...
                    (let uu___6 = FStar_Syntax_Util.destruct_typ_as_formula p
                        in
                     match uu___6 with
                     | FStar_Pervasives_Native.None  ->
                         let uu___7 =
                     ...
                     | FStar_Pervasives_Native.Some
                         (FStar_Syntax_Util.BaseConn (lid1,(p1,uu___7)::[]))
                         when
                     ...
                     | FStar_Pervasives_Native.Some (FStar_Syntax_Util.QAll
                         ...
                         (match uu___7 with
                          | FStar_Pervasives_Native.None  ->
                              let uu___8 = is_applied_maybe_squashed bs phi1
                                 in
                              (match uu___8 with
                          ...
                          | FStar_Pervasives_Native.Some
                              ...
                              FStar_Ident.lid_equals lid1
                                FStar_Parser_Const.not_lid
                              ->
                              let uu___9 = is_applied_maybe_squashed bs p1
                                 in
                              (match uu___9 with
                               | FStar_Pervasives_Native.Some bv' when
                                   FStar_Syntax_Syntax.bv_eq bv bv' ->
                   ...
                   (if
                    ...
                    then
                      (let uu___6 = FStar_Syntax_Print.bv_to_string bv  in
                       let uu___7 = FStar_Syntax_Print.term_to_string phi'
                          in
                      ...
                      ({
                         FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_uinst
                           ({
                              ...
                              FStar_Syntax_Syntax.vars = uu___5;_},uu___6);
                         FStar_Syntax_Syntax.pos = uu___7;
                         FStar_Syntax_Syntax.vars = uu___8;_},args)
                      ->
                      let uu___9 =
                        FStar_Syntax_Syntax.fv_eq_lid fv
                           ...
                           (let uu___13 =
                            ...
                            then
                              ...
                              | (uu___15,(p,uu___16))::(uu___17,(q,uu___18))::[]
                                  ->
                                  let uu___19 = FStar_Syntax_Util.term_eq p q
                                     in
                                  (if uu___19
                               ...
                               then
                                 ...
                                 | (FStar_Pervasives_Native.Some (false
                                     ...
                                     let uu___20 =
                                       FStar_Syntax_Util.mk_neg arg  in
                                     maybe_auto_squash uu___20
                                 | (uu___17,(p,uu___18))::(uu___19,(q,uu___20))::[]
                                     ->
                                     let uu___21 =
                                              ...
                                              let uu___23 =
                                                let uu___24 =
                                                  FStar_Syntax_Subst.compress
                                                    t
                                                   in
                                                uu___24.FStar_Syntax_Syntax.n
                                                 in
                                              (match uu___23 with
                                               | FStar_Syntax_Syntax.Tm_abs
                                                   (uu___24::[],body,uu___25)
                                                   ->
                                                   let uu___26 = simp_t body
                                                      in
                                                   (match uu___26 with
                                                    | FStar_Pervasives_Native.Some
                                                        (false ) ->
                                              ...
                                              let uu___24 =
                                                let uu___25 =
                                                  FStar_Syntax_Subst.compress
                                                    t
                                                   in
                                                uu___25.FStar_Syntax_Syntax.n
                                                 in
                                              (match uu___24 with
                                               | FStar_Syntax_Syntax.Tm_abs
                                                   (uu___25::[],body,uu___26)
                                                   ->
                                                   let uu___27 = simp_t body
                                                      in
                                                   (match uu___27 with
                                                    | FStar_Pervasives_Native.Some
                                                        (false ) ->
                           ...
                           (let uu___10 =
                            ...
                            then
                              ...
                              | (uu___12,(p,uu___13))::(uu___14,(q,uu___15))::[]
                                  ->
                                  let uu___16 = FStar_Syntax_Util.term_eq p q
                                     in
                                  (if uu___16
                                   then w FStar_Syntax_Util.t_true
                                   else squashed_head_un_auto_squash_args tm1)
            ...
            (fun uu___1  ->
               (let uu___3 = FStar_Syntax_Print.tag_of_term t  in
                ...
                let uu___6 =
                  let uu___7 =
                    let uu___8 = firstn (Prims.of_int (4)) stack1  in
                    FStar_All.pipe_left FStar_Pervasives_Native.fst uu___8
                     in
                  stack_to_string uu___7  in
                FStar_Util.print4
           ...
           then
             ...
             (let t1 = maybe_simplify cfg env1 stack1 t  in
                  ...
                  (if
                   ...
                   then
                     (let time_now = FStar_Util.now ()  in
                      ...
                      let uu___5 = FStar_Syntax_Print.term_to_string tm  in
                      let uu___6 = FStar_TypeChecker_Cfg.cfg_to_string cfg
                         in
                      let uu___7 = FStar_Syntax_Print.term_to_string t1  in
                      FStar_Util.print4
              ...
              | (Arg (Univ uu___3,uu___4,uu___5))::uu___6 ->
                  failwith "Impossible"
              | (Arg (Dummy ,uu___3,uu___4))::uu___5 -> failwith "Impossible"
              | (UnivArgs (us,r))::stack2 ->
                  let t2 = FStar_Syntax_Syntax.mk_Tm_uinst t1 us  in
                  rebuild cfg env1 stack2 t2
              | (Arg (Clos (env_arg,tm,uu___3,uu___4),aq,r))::stack2 when
                  ...
                  (match uu___3 with
                   ...
                   | FStar_Syntax_Syntax.Tm_app
                       ({
                          ...
                          FStar_Syntax_Syntax.vars = uu___6;_},(e,uu___7)::[])
                   ...
                   (let scrutinee_env = env1  in
                         ...
                         then cfg1
                           ...
                           (let new_delta =
                              FStar_All.pipe_right
                               ...
                               in
                            let steps =
                              let uu___7 = cfg1.FStar_TypeChecker_Cfg.steps
                                 in
                              {
                                FStar_TypeChecker_Cfg.beta =
                       ...
                       let maybe_commute_matches uu___6 =
                         let can_commute =
                           ...
                           | ({
                                ...
                                FStar_Syntax_Syntax.p = uu___8;_},uu___9,uu___10)::uu___11
                               ->
                           ...
                           | uu___7 -> false  in
                         let uu___7 =
                           let uu___8 = FStar_Syntax_Util.unascribe scrutinee
                              in
                           uu___8.FStar_Syntax_Syntax.n  in
                         match uu___7 with
                         | FStar_Syntax_Syntax.Tm_match (sc0,branches0) when
                             ...
                             let reduce_branch b =
                               ...
                               let uu___8 = FStar_Syntax_Subst.open_branch b
                                  in
                               match uu___8 with
                               | (p,wopt,e) ->
                         ...
                         | uu___8 ->
                                   ...
                                   (let uu___10 = cfg1  in
                                    {
                                      FStar_TypeChecker_Cfg.steps =
                                        (let uu___11 =
                                           cfg1.FStar_TypeChecker_Cfg.steps
                                            in
                                         {
                                           FStar_TypeChecker_Cfg.beta =
                             ...
                             let uu___9 =
                               FStar_Syntax_Syntax.mk
                                ...
                                in
                             rebuild cfg1 env2 stack2 uu___9
                          in
                    ...
                    let rec matches_pat scrutinee_orig p =
                      ...
                      let scrutinee2 = FStar_Syntax_Util.unlazy scrutinee1
                         in
                      let uu___4 = FStar_Syntax_Util.head_and_args scrutinee2
                         in
                      match uu___4 with
                      | (head,args) ->
                          (match p.FStar_Syntax_Syntax.v with
                           ...
                           | FStar_Syntax_Syntax.Pat_cons (fv,arg_pats) ->
                               let uu___5 =
                                 let uu___6 = FStar_Syntax_Util.un_uinst head
                                    in
                                     ...
                                     (fun env4  ->
                                        fun uu___6  ->
                                          ...
                                          | (bv,t2) ->
                                              ...
                                              uu___7 :: env4) env2 s
                                    in
                                 let uu___6 = guard_when_clause wopt b rest
                                    in
                                 norm cfg1 env3 stack2 uu___6)))
                       in
                    if
                      (cfg1.FStar_TypeChecker_Cfg.steps).FStar_TypeChecker_Cfg.iota
      ...
      | FStar_Syntax_Syntax.Comp ct ->
          ...
          then
            let ct1 =
              ...
              | FStar_Pervasives_Native.None  ->
                  let ct2 = FStar_TypeChecker_Env.unfold_effect_abbrev env1 c
                     in
                  let uu___2 = ct2  in
                  {
                    FStar_Syntax_Syntax.comp_univs =
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu___ =
                     let uu___1 =
                       let uu___2 = FStar_Syntax_Util.mk_conj_simp phi1 phi
                          in
                       (y, uu___2)  in
          ...
          | (univ_names1,t1) ->
              ...
              let uu___1 =
                ...
                | uu___2 ->
                    ...
                    (match uu___3 with
                     | (FStar_Syntax_Syntax.Tm_arrow
                        (binders1,c),FStar_Util.Inr uu___4) ->
                         (binders1, (FStar_Util.Inr c))
                     | (FStar_Syntax_Syntax.Tm_arrow
                        (binders1,c),FStar_Util.Inl uu___4) ->
                         (binders1,
                 ...
                 (fun lb  ->
                    ...
                    | (opening,lbunivs) ->
                        let elim t =
                          let uu___1 =
                            let uu___2 =
                              let uu___3 = FStar_Syntax_Subst.subst opening t
                                 in
                              remove_uvar_solutions env1 uu___3  in
                            FStar_Syntax_Subst.close_univ_vars lbunivs uu___2
                             in
           ...
           | (univs,binders,uu___1) ->
               let uu___2 =
                 ...
                 | (univs_opening,univs1) ->
                     let uu___4 = FStar_Syntax_Subst.univ_var_closing univs1
                        in
                     (univs_opening, uu___4)
                  in
               (match uu___2 with
                     ...
                     | (b_opening,b_closing) ->
                                                   ...
                                                   let t4 =
                                                     let uu___11 =
                                                       ...
                                                       FStar_Syntax_Subst.subst
                                                        ...
                                                        in
                                                     FStar_Syntax_Subst.subst
                                                       univs_closing1 uu___11
                                                      in
                                                   (us1, t4)))))
                            in
                         let elim_term t =
                           let uu___4 = elim_uvars_aux_t env1 univs binders t
                              in
                         ...
                         let elim_action a =
                           ...
                           let destruct_action_body body =
                             let uu___4 =
                               let uu___5 = FStar_Syntax_Subst.compress body
                                  in
                               uu___5.FStar_Syntax_Syntax.n  in
                             match uu___4 with
                             | FStar_Syntax_Syntax.Tm_ascribed
                           ...
                           let destruct_action_typ_templ t =
                             let uu___4 =
                               ...
                               uu___5.FStar_Syntax_Syntax.n  in
                             match uu___4 with
                             | FStar_Syntax_Syntax.Tm_abs (pars,body,uu___5)
                                 ->
      ...
      | FStar_Syntax_Syntax.Sig_sub_effect sub_eff ->
          let elim_tscheme_opt uu___ =
            ...
            | FStar_Pervasives_Native.Some (us,t) ->
                ...
                (match uu___1 with
                 | (us1,uu___2,t1) -> FStar_Pervasives_Native.Some (us1, t1))
             in
          let sub_eff1 =
            let uu___ = sub_eff  in
            let uu___1 = elim_tscheme_opt sub_eff.FStar_Syntax_Syntax.lift_wp
               in
            let uu___2 = elim_tscheme_opt sub_eff.FStar_Syntax_Syntax.lift
               in
            {
