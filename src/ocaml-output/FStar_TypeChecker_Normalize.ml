         ...
         | uu____1143 ->
             ...
             (match t1.FStar_Syntax_Syntax.n with
              ...
              | FStar_Syntax_Syntax.Tm_uinst (t',us) ->
                  let uu____1182 = FStar_List.map (norm_universe cfg env) us
                     in
              ...
              | FStar_Syntax_Syntax.Tm_ascribed (t11,(annot,tacopt),lopt) ->
                  let annot1 =
                    match annot with
                    | FStar_Util.Inl t2 ->
                        let uu____1429 = closure_as_term_delayed cfg env t2
                           in
                        FStar_Util.Inl uu____1429
                    | FStar_Util.Inr c ->
                        let uu____1443 = close_comp cfg env c  in
                        FStar_Util.Inr uu____1443
                     in
                  let tacopt1 =
                  ...
                  let uu____1458 =
                    let uu____1459 =
                      let uu____1477 = closure_as_term_delayed cfg env t11
                         in
                  ...
                  let norm_one_lb env1 lb =
                    let env_univs =
                      FStar_List.fold_right
                       ...
                       in
                    let env2 =
                      let uu____1707 = FStar_Syntax_Syntax.is_top_level lbs
                         in
                      if uu____1707
                      then env_univs
                      else
...
let built_in_primitive_steps : primitive_step Prims.list =
  ...
  let int_as_const p i =
    let uu____2438 =
      let uu____2439 =
        let uu____2445 = FStar_Util.string_of_int i  in (uu____2445, None)
         in
  ...
  let lift_binary f aopts =
    match aopts with
    | (Some a0)::(Some a1)::[] ->
        let uu____2783 = f a0 a1  in Some uu____2783
    | uu____2784 -> None  in
  let unary_op as_a f r args =
    let uu____2828 = FStar_List.map as_a args  in lift_unary (f r) uu____2828
     in
  let binary_op as_a f r args =
    let uu____2878 = FStar_List.map as_a args  in
    lift_binary (f r) uu____2878  in
  ...
  let unary_int_op f =
    unary_op arg_as_int
      (fun r  -> fun x  -> let uu____2933 = f x  in int_as_const r uu____2933)
     in
  let binary_int_op f =
    binary_op arg_as_int
      (fun r  ->
         fun x  ->
           fun y  -> let uu____2956 = f x y  in int_as_const r uu____2956)
     in
  let unary_bool_op f =
    unary_op arg_as_bool
      (fun r  ->
         fun x  -> let uu____2973 = f x  in bool_as_const r uu____2973)
     in
  let binary_bool_op f =
    binary_op arg_as_bool
      (fun r  ->
         fun x  ->
           fun y  -> let uu____2996 = f x y  in bool_as_const r uu____2996)
     in
  let binary_string_op f =
    binary_op arg_as_string
      (fun r  ->
         fun x  ->
           fun y  -> let uu____3019 = f x y  in string_as_const r uu____3019)
     in
                                    ...
                                    let uu____3392 =
                                      let uu____3402 =
                                        ...
                                        (FStar_Syntax_Const.op_notEq,
                                          (Prims.parse_int "3"),
                                          (decidable_eq true)) :: uu____3412
                                         in
                                      (FStar_Syntax_Const.op_Eq,
                                        (Prims.parse_int "3"),
                                        (decidable_eq false)) :: uu____3402
                                       in
    ...
    FStar_All.pipe_right bounded_int_types
      (FStar_List.collect
         (fun m  ->
            ...
            let uu____3897 =
              let uu____3907 =
                let uu____3916 = FStar_Syntax_Const.p2l ["FStar"; m; "sub"]
                   in
              ...
              let uu____3943 =
                let uu____3953 =
                  let uu____3962 = FStar_Syntax_Const.p2l ["FStar"; m; "mul"]
                     in
               ...
               (match stack1 with
                          ...
                          | uu____6963::[] ->
                              (match lopt with
                               | None  when FStar_Options.__unit_tests () ->
                                   (log cfg
                                      (fun uu____6971  ->
                                         let uu____6972 = closure_to_string c
                                            in
                               ...
                               | Some rc when
                                   ...
                                   (log cfg
                                      (fun uu____6978  ->
                                         let uu____6979 = closure_to_string c
                                            in
                                         FStar_Util.print1 "\tShifted %s\n"
                                           uu____6979);
                                    norm cfg (c :: env) stack_rest body)
                ...
                | (Debug uu____7032)::uu____7033 ->
                    ...
                    then
                      ...
                      (let uu____7037 = FStar_Syntax_Subst.open_term' bs body
                          in
                ...
                | (Meta uu____7089)::uu____7090 ->
                    ...
                    then
                      ...
                      (let uu____7096 = FStar_Syntax_Subst.open_term' bs body
                          in
                ...
                | (Let uu____7148)::uu____7149 ->
                    ...
                    then
                      ...
                      (let uu____7157 = FStar_Syntax_Subst.open_term' bs body
                          in
                ...
                | (App uu____7209)::uu____7210 ->
                    ...
                    then
                      ...
                      (let uu____7217 = FStar_Syntax_Subst.open_term' bs body
                          in
                ...
                | (Abs uu____7269)::uu____7270 ->
                    ...
                    then
                      ...
                      (let uu____7280 = FStar_Syntax_Subst.open_term' bs body
                          in
                ...
                | [] ->
                    ...
                    then
                      ...
                      (let uu____7334 = FStar_Syntax_Subst.open_term' bs body
                          in
           ...
           | FStar_Syntax_Syntax.Tm_refine (x,f) ->
               ...
               then
                 ...
                 (let t_x = norm cfg env [] x.FStar_Syntax_Syntax.sort  in
                  let uu____7485 = FStar_Syntax_Subst.open_term [(x, None)] f
                     in
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                    ...
                    then
                      ...
                      (let uu____8085 =
                         let uu____8086 = FStar_Syntax_Subst.compress head1
                            in
                       ...
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____8100 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                           ...
                                           let uu____8128 =
                                             let uu____8129 =
                                               FStar_Syntax_Subst.compress e1
                                                in
                                             uu____8129.FStar_Syntax_Syntax.n
                                              in
                                               ...
                                               let uu____8253 =
                                                 let uu____8254 =
                                                   FStar_Syntax_Subst.compress
                                                     bind_repr
                                                    in
                                                 uu____8254.FStar_Syntax_Syntax.n
                                                  in
                       ...
                       | FStar_Syntax_Syntax.Tm_app (head_app,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____8362 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                ...
                                ((let is_arg_impure uu____8434 =
                                    ...
                                    | (e,q) ->
                                        let uu____8439 =
                                          let uu____8440 =
                                            FStar_Syntax_Subst.compress e  in
                                          uu____8440.FStar_Syntax_Syntax.n
                                           in
        ...
        fun mtgt  ->
          fun t  ->
            ...
            then
              ...
              (let uu____8830 = FStar_TypeChecker_Env.monad_leq env msrc mtgt
                  in
        ...
        | FStar_Syntax_Syntax.Comp ct ->
            ...
            let uu____9009 =
              let uu____9010 =
                ...
                let uu____9016 = norm_args ct.FStar_Syntax_Syntax.effect_args
                   in
                {
               ...
               (let scrutinee = t  in
                  ...
                  (let whnf = FStar_List.contains WHNF cfg.steps  in
                             ...
                             (FStar_List.fold_left
                                (fun uu____9445  ->
                                   fun uu____9446  ->
                                     ...
                                     | ((pats1,env3),(p1,b)) ->
                                         let uu____9511 = norm_pat env3 p1
                                            in
                   ...
                   let uu____9682 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r
                      in
                   rebuild cfg env1 stack2 uu____9682)
                   in
                ...
                let rec matches_pat scrutinee_orig p =
                  let scrutinee1 = FStar_Syntax_Util.unmeta scrutinee_orig
                     in
                  let uu____9811 = FStar_Syntax_Util.head_and_args scrutinee1
                     in
                      ...
                      (match uu____9950 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____9964 -> FStar_Util.Inr false
                 in
                                 ...
                                 (fun env2  ->
                                    fun t1  ->
                                      let uu____10057 =
                                        ...
                                        Clos uu____10058  in
                                      uu____10057 :: env2) env1 s
                                in
                             let uu____10091 = guard_when_clause wopt b rest
                                in
                             norm cfg env2 stack2 uu____10091)))
                   in
                let uu____10092 =
                  FStar_All.pipe_right cfg.steps
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____10271 =
                     let uu____10272 =
                       let uu____10277 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____10277)  in
           ...
           | (head1,args) ->
               ...
               (match uu____10424 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____10428,thead) ->
                    let uu____10442 = FStar_Syntax_Util.arrow_formals thead
                       in
