...
let _54_343 = (let _154_332 = (let _154_331 = (FStar_Syntax_Syntax.mk_binder x)
in (_154_331)::[])
...
in {FStar_Syntax_Syntax.lbname = _54_423.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _54_423.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _154_380; FStar_Syntax_Syntax.lbeff = _54_423.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _154_379}))))))
in (
...
in {FStar_Syntax_Syntax.ppname = _54_481.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _54_481.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _154_395}))
in (((
...
in {FStar_Syntax_Syntax.ppname = _54_488.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _54_488.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _154_396}))
in (((
...
in {FStar_Syntax_Syntax.ppname = _54_497.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _54_497.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _154_397}))
in (
...
in {FStar_Syntax_Syntax.ppname = _54_535.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _54_535.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _154_415}))
in (
...
in {FStar_Syntax_Syntax.comp_univs = _154_425; FStar_Syntax_Syntax.effect_name = _54_565.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = rt; FStar_Syntax_Syntax.effect_args = args; FStar_Syntax_Syntax.flags = flags}))
...
let c = (let _154_699 = (FStar_Util.int_of_string i)
in (let _154_698 = (FStar_Util.int_of_string j)
in (op _154_699 _154_698)))
in (mk (FStar_Syntax_Syntax.Tm_constant (c)) tm.FStar_Syntax_Syntax.pos)))
in (match ((let _154_703 = (let _154_700 = (FStar_Syntax_Subst.compress a1)
in _154_700.FStar_Syntax_Syntax.n)
in (let _154_702 = (let _154_701 = (FStar_Syntax_Subst.compress a2)
in _154_701.FStar_Syntax_Syntax.n)
in ((_154_703), (_154_702))))) with
| (FStar_Syntax_Syntax.Tm_app (head1, ((arg1, _54_660))::[]), FStar_Syntax_Syntax.Tm_app (head2, ((arg2, _54_668))::[])) -> begin
(match ((let _154_711 = (let _154_704 = (FStar_Syntax_Subst.compress head1)
in _154_704.FStar_Syntax_Syntax.n)
in (let _154_710 = (let _154_705 = (FStar_Syntax_Subst.compress head2)
in _154_705.FStar_Syntax_Syntax.n)
in (let _154_709 = (let _154_706 = (FStar_Syntax_Subst.compress arg1)
in _154_706.FStar_Syntax_Syntax.n)
in (let _154_708 = (let _154_707 = (FStar_Syntax_Subst.compress arg2)
in _154_707.FStar_Syntax_Syntax.n)
in ((_154_711), (_154_710), (_154_709), (_154_708))))))) with
...
(let _154_715 = (mk (FStar_Syntax_Syntax.Tm_fvar (fv1)) tm.FStar_Syntax_Syntax.pos)
in (let _154_714 = (let _154_713 = (let _154_712 = (norm i j)
in ((_154_712), (None)))
in (_154_713)::[])
in (FStar_Syntax_Util.mk_app _154_715 _154_714)))
end
| _54_690 -> begin
tm
end)
...
(match ((let _154_718 = (FStar_Syntax_Subst.compress a1)
in _154_718.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_string (b, _54_720)) -> begin
(let _154_719 = (FStar_Bytes.unicode_bytes_as_string b)
in (op _154_719))
end
| _54_725 -> begin
tm
...
(match ((let _154_730 = (FStar_Syntax_Subst.compress t)
in _154_730.FStar_Syntax_Syntax.n)) with
...
let is_norm_request = (fun hd args -> (match ((let _154_734 = (let _154_733 = (FStar_Syntax_Util.un_uinst hd)
in _154_733.FStar_Syntax_Syntax.n)
in ((_154_734), (args)))) with
...
| () -> begin
(let _154_776 = (FStar_Syntax_Print.tag_of_term t)
in (let _154_775 = (FStar_Syntax_Print.term_to_string t)
in (let _154_774 = (let _154_773 = (let _154_772 = (FStar_Util.first_N (Prims.parse_int "4") stack)
in (FStar_All.pipe_left Prims.fst _154_772))
in (stack_to_string _154_773))
in (FStar_Util.print3 ">>> %s\nNorm %s with top of the stack %s \n" _154_776 _154_775 _154_774))))
end)))
in (match (t.FStar_Syntax_Syntax.n) with
...
let a = (let _154_780 = (FStar_All.pipe_left FStar_Syntax_Util.unascribe (Prims.fst a))
in (FStar_Syntax_Subst.compress _154_780))
...
in (let _154_781 = (mk (FStar_Syntax_Syntax.Tm_type (u)) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack _154_781)))
end
| FStar_Syntax_Syntax.Tm_uinst (t', us) -> begin
...
let us = (let _154_783 = (let _154_782 = (FStar_List.map (norm_universe cfg env) us)
in ((_154_782), (t.FStar_Syntax_Syntax.pos)))
in UnivArgs (_154_783))
in (
...
let r_env = (let _154_785 = (FStar_Syntax_Syntax.range_of_fv f)
in (FStar_TypeChecker_Env.set_range cfg.tcenv _154_785))
...
| () -> begin
(let _154_789 = (FStar_Syntax_Print.term_to_string t0)
...
| _54_1135 -> begin
(let _154_793 = (let _154_792 = (FStar_Syntax_Print.lid_to_string f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_Util.format1 "Impossible: missing universe instantiation on %s" _154_792))
in (failwith _154_793))
end)
end else begin
(norm cfg env stack t)
end))
...
| () -> begin
(let _154_796 = (FStar_Syntax_Print.term_to_string t)
in (let _154_795 = (FStar_Syntax_Print.term_to_string t')
in (FStar_Util.print2 "Lazy hit: %s cached to %s\n" _154_796 _154_795)))
end)))
in (match ((let _154_797 = (FStar_Syntax_Subst.compress t')
in _154_797.FStar_Syntax_Syntax.n)) with
...
| () -> begin
(let _154_799 = (closure_to_string c)
...
| () -> begin
(let _154_802 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _154_802))
end)))
in (norm cfg ((c)::env) stack_rest body))
end
...
| () -> begin
(let _154_804 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _154_804))
end)))
in (norm cfg ((c)::env) stack_rest body))
end
...
in (let _154_805 = (closure_as_term cfg env t)
in (rebuild cfg env stack _154_805)))
end)
end
| (_54_1227)::tl -> begin
(
...
| () -> begin
(let _154_809 = (FStar_Syntax_Print.term_to_string t)
...
(let _154_810 = (closure_as_term cfg env t)
in (rebuild cfg env stack _154_810))
end else begin
(
...
(let _154_816 = (let _154_814 = (let _154_812 = (let _154_811 = (l.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp opening _154_811))
in (FStar_All.pipe_right _154_812 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right _154_814 (fun _154_813 -> FStar_Util.Inl (_154_813))))
in (FStar_All.pipe_right _154_816 (fun _154_815 -> Some (_154_815))))
end
| _54_1289 -> begin
lopt
end)
...
| () -> begin
(let _154_820 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
...
| (a, aq) -> begin
(let _154_827 = (let _154_826 = (let _154_825 = (let _154_824 = (let _154_823 = (FStar_Util.mk_ref None)
in ((env), (a), (_154_823), (false)))
in Clos (_154_824))
in ((_154_825), (aq), (t.FStar_Syntax_Syntax.pos)))
in Arg (_154_826))
in (_154_827)::stack)
end)) args))
in (
...
| () -> begin
(let _154_829 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
...
| _54_1322 -> begin
(let _154_830 = (closure_as_term cfg env t)
in (rebuild cfg env stack _154_830))
end)
end else begin
(
...
let t = (let _154_833 = (let _154_832 = (let _154_831 = (FStar_Syntax_Subst.close closing f)
in (((

let _54_1328 = x
in {FStar_Syntax_Syntax.ppname = _54_1328.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _54_1328.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (_154_831)))
in FStar_Syntax_Syntax.Tm_refine (_154_832))
in (mk _154_833 t.FStar_Syntax_Syntax.pos))
in (rebuild cfg env stack t)))
end)))
end
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
if (FStar_List.contains WHNF cfg.steps) then begin
(let _154_834 = (closure_as_term cfg env t)
in (rebuild cfg env stack _154_834))
end else begin
(
...
let c = (let _154_837 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _54_1339 -> (Dummy)::env) env))
in (norm_comp cfg _154_837 c))
in (

let t = (let _154_838 = (norm_binders cfg env bs)
in (FStar_Syntax_Util.arrow _154_838 c))
in (rebuild cfg env stack t)))
end))
end
end
...
(let _154_840 = (norm cfg env [] t)
in FStar_Util.Inl (_154_840))
end
| FStar_Util.Inr (c) -> begin
(let _154_841 = (norm_comp cfg env c)
in FStar_Util.Inr (_154_841))
end)
in (let _154_842 = (mk (FStar_Syntax_Syntax.Tm_ascribed (((t1), (tc), (l)))) t.FStar_Syntax_Syntax.pos)
...
let env = (let _154_845 = (let _154_844 = (let _154_843 = (FStar_Util.mk_ref None)
in ((env), (lb.FStar_Syntax_Syntax.lbdef), (_154_843), (false)))
in Clos (_154_844))
in (_154_845)::env)
...
let _54_1433 = (let _154_848 = (let _154_847 = (let _154_846 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.left)
in (FStar_All.pipe_right _154_846 FStar_Syntax_Syntax.mk_binder))
in (_154_847)::[])
in (FStar_Syntax_Subst.open_term _154_848 body))
...
let _54_1434 = lb
in (let _154_854 = (let _154_851 = (let _154_849 = (FStar_List.hd bs)
in (FStar_All.pipe_right _154_849 Prims.fst))
in (FStar_All.pipe_right _154_851 (fun _154_850 -> FStar_Util.Inl (_154_850))))
in (let _154_853 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp)
in (let _154_852 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _154_854; FStar_Syntax_Syntax.lbunivs = _54_1434.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _154_853; FStar_Syntax_Syntax.lbeff = _54_1434.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _154_852}))))
in (
...
(let _154_857 = (closure_as_term cfg env t)
in (rebuild cfg env stack _154_857))
end
...
in (FStar_Syntax_Syntax.bv_to_tm _154_860))
in (
...
let body_env = (FStar_List.fold_right (fun lb env -> (let _154_867 = (let _154_866 = (let _154_865 = (FStar_Util.mk_ref None)
in ((rec_env), (lb.FStar_Syntax_Syntax.lbdef), (_154_865), (false)))
in Clos (_154_866))
in (_154_867)::env)) (Prims.snd lbs) env)
...
(match ((let _154_868 = (FStar_Syntax_Subst.compress head)
in _154_868.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_let ((false, (lb)::[]), body) -> begin
(
...
let body = (let _154_872 = (let _154_871 = (let _154_870 = (let _154_869 = (FStar_Syntax_Syntax.mk_binder x)
in (_154_869)::[])
in ((_154_870), (body), (None)))
in FStar_Syntax_Syntax.Tm_abs (_154_871))
in (FStar_Syntax_Syntax.mk _154_872 None body.FStar_Syntax_Syntax.pos))
in (

let bind_inst = (match ((let _154_873 = (FStar_Syntax_Subst.compress bind_repr)
in _154_873.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uinst (bind, (_54_1527)::(_54_1525)::[]) -> begin
(let _154_879 = (let _154_878 = (let _154_877 = (let _154_876 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv lb.FStar_Syntax_Syntax.lbtyp)
in (let _154_875 = (let _154_874 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_154_874)::[])
in (_154_876)::_154_875))
in ((bind), (_154_877)))
in FStar_Syntax_Syntax.Tm_uinst (_154_878))
in (FStar_Syntax_Syntax.mk _154_879 None t.FStar_Syntax_Syntax.pos))
end
| _54_1532 -> begin
...
let reified = (let _154_893 = (let _154_892 = (let _154_891 = (let _154_890 = (FStar_Syntax_Syntax.as_arg lb.FStar_Syntax_Syntax.lbtyp)
in (let _154_889 = (let _154_888 = (FStar_Syntax_Syntax.as_arg t)
in (let _154_887 = (let _154_886 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _154_885 = (let _154_884 = (FStar_Syntax_Syntax.as_arg head)
in (let _154_883 = (let _154_882 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _154_881 = (let _154_880 = (FStar_Syntax_Syntax.as_arg body)
in (_154_880)::[])
in (_154_882)::_154_881))
in (_154_884)::_154_883))
in (_154_886)::_154_885))
in (_154_888)::_154_887))
in (_154_890)::_154_889))
in ((bind_inst), (_154_891)))
in FStar_Syntax_Syntax.Tm_app (_154_892))
in (FStar_Syntax_Syntax.mk _154_893 None t.FStar_Syntax_Syntax.pos))
in (let _154_894 = (FStar_List.tl stack)
in (norm cfg env _154_894 reified)))))))
end
...
let t = (match ((let _154_899 = (FStar_Syntax_Subst.compress t)
in _154_899.FStar_Syntax_Syntax.n)) with
...
in (match ((let _154_900 = (FStar_Syntax_Subst.compress t)
in _154_900.FStar_Syntax_Syntax.n)) with
...
| Some (x) when (let _154_901 = (FStar_Syntax_Syntax.lid_of_fv x)
in (FStar_TypeChecker_Env.is_action cfg.tcenv _154_901)) -> begin
(
...
| ((e, q))::es -> begin
(match ((let _154_908 = (FStar_Syntax_Subst.compress e)
...
let body = (let _154_911 = (let _154_910 = (let _154_909 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_154_909), (q)))
in (_154_910)::acc)
in (bind_on_lift es _154_911))
in (
...
let bind_inst = (match ((let _154_912 = (FStar_Syntax_Subst.compress bind_repr)
in _154_912.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uinst (bind, (_54_1617)::(_54_1615)::[]) -> begin
(let _154_918 = (let _154_917 = (let _154_916 = (let _154_915 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t')
in (let _154_914 = (let _154_913 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_154_913)::[])
in (_154_915)::_154_914))
in ((bind), (_154_916)))
in FStar_Syntax_Syntax.Tm_uinst (_154_917))
in (FStar_Syntax_Syntax.mk _154_918 None e0.FStar_Syntax_Syntax.pos))
end
| _54_1622 -> begin
(failwith "NIY : Reification of indexed effects")
end)
in (let _154_932 = (let _154_931 = (let _154_930 = (let _154_929 = (FStar_Syntax_Syntax.as_arg t')
in (let _154_928 = (let _154_927 = (FStar_Syntax_Syntax.as_arg t)
in (let _154_926 = (let _154_925 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _154_924 = (let _154_923 = (FStar_Syntax_Syntax.as_arg lifted_e0)
in (let _154_922 = (let _154_921 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _154_920 = (let _154_919 = (FStar_Syntax_Syntax.as_arg continuation)
in (_154_919)::[])
in (_154_921)::_154_920))
in (_154_923)::_154_922))
in (_154_925)::_154_924))
in (_154_927)::_154_926))
in (_154_929)::_154_928))
in ((bind_inst), (_154_930)))
in FStar_Syntax_Syntax.Tm_app (_154_931))
in (FStar_Syntax_Syntax.mk _154_932 None e0.FStar_Syntax_Syntax.pos)))))))
end
...
let binded_head = (let _154_934 = (let _154_933 = (FStar_Syntax_Syntax.as_arg head)
in (_154_933)::args)
in (bind_on_lift _154_934 []))
in (let _154_935 = (FStar_List.tl stack)
in (norm cfg env _154_935 binded_head)))))
end)))
end
...
(let _154_937 = (FStar_List.tl stack)
in (let _154_936 = (reify_lift cfg.tcenv head m m' t)
in (norm cfg env _154_937 _154_936)))
end else begin
...
let m = (match (m) with
| FStar_Syntax_Syntax.Meta_pattern (args) -> begin
(let _154_938 = (norm_pattern_args cfg env args)
in FStar_Syntax_Syntax.Meta_pattern (_154_938))
end
| _54_1698 -> begin
m
end)
...
let return_inst = (match ((let _154_944 = (FStar_Syntax_Subst.compress return_repr)
in _154_944.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_uinst (return_tm, (_54_1713)::[]) -> begin
(let _154_948 = (let _154_947 = (let _154_946 = (let _154_945 = (env.FStar_TypeChecker_Env.universe_of env t)
in (_154_945)::[])
in ((return_tm), (_154_946)))
in FStar_Syntax_Syntax.Tm_uinst (_154_947))
in (FStar_Syntax_Syntax.mk _154_948 None e.FStar_Syntax_Syntax.pos))
end
| _54_1718 -> begin
(failwith "NIY : Reification of indexed effects")
end)
in (let _154_954 = (let _154_953 = (let _154_952 = (let _154_951 = (FStar_Syntax_Syntax.as_arg t)
in (let _154_950 = (let _154_949 = (FStar_Syntax_Syntax.as_arg e)
in (_154_949)::[])
in (_154_951)::_154_950))
in ((return_inst), (_154_952)))
in FStar_Syntax_Syntax.Tm_app (_154_953))
...
let _54_1734 = comp
in (let _154_966 = (let _154_965 = (let _154_964 = (norm cfg env [] t)
in (let _154_963 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_154_964), (_154_963))))
in FStar_Syntax_Syntax.Total (_154_965))
in {FStar_Syntax_Syntax.n = _154_966; FStar_Syntax_Syntax.tk = _54_1734.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _54_1734.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _54_1734.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(

let _54_1740 = comp
in (let _154_970 = (let _154_969 = (let _154_968 = (norm cfg env [] t)
in (let _154_967 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_154_968), (_154_967))))
in FStar_Syntax_Syntax.GTotal (_154_969))
in {FStar_Syntax_Syntax.n = _154_970; FStar_Syntax_Syntax.tk = _54_1740.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _54_1740.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _54_1740.FStar_Syntax_Syntax.vars}))
end
...
| FStar_Syntax_Syntax.DECREASES (t) -> begin
(let _154_976 = (norm cfg env [] t)
in FStar_Syntax_Syntax.DECREASES (_154_976))
end
| f -> begin
f
end))))
...
let _54_1754 = comp
in (let _154_981 = (let _154_980 = (

let _54_1756 = ct
in (let _154_979 = (FStar_List.map (norm_universe cfg env) ct.FStar_Syntax_Syntax.comp_univs)
in (let _154_978 = (norm cfg env [] ct.FStar_Syntax_Syntax.result_typ)
in (let _154_977 = (norm_args ct.FStar_Syntax_Syntax.effect_args)
in {FStar_Syntax_Syntax.comp_univs = _154_979; FStar_Syntax_Syntax.effect_name = _54_1756.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _154_978; FStar_Syntax_Syntax.effect_args = _154_977; FStar_Syntax_Syntax.flags = flags}))))
in FStar_Syntax_Syntax.Comp (_154_980))
in {FStar_Syntax_Syntax.n = _154_981; FStar_Syntax_Syntax.tk = _54_1754.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _54_1754.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _54_1754.FStar_Syntax_Syntax.vars}))))
end)))
...
let non_info = (fun t -> (let _154_989 = (norm t)
in (FStar_Syntax_Util.non_informative _154_989)))
...
let _54_1797 = x
in (let _154_993 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _54_1797.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _54_1797.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _154_993}))
in ((_154_994), (imp)))
end))
...
in if (FStar_Syntax_Util.is_total_lcomp lc) then begin
(let _154_1006 = (let _154_1005 = (let _154_1004 = (let _154_1003 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.comp_set_flags _154_1003 flags))
in (FStar_Syntax_Util.lcomp_of_comp _154_1004))
in FStar_Util.Inl (_154_1005))
in Some (_154_1006))
end else begin
(let _154_1010 = (let _154_1009 = (let _154_1008 = (let _154_1007 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.comp_set_flags _154_1007 flags))
in (FStar_Syntax_Util.lcomp_of_comp _154_1008))
in FStar_Util.Inl (_154_1009))
in Some (_154_1010))
end)
end else begin
Some (FStar_Util.Inr (((lc.FStar_Syntax_Syntax.eff_name), (flags))))
...
(let _154_1016 = (FStar_Syntax_Print.term_to_string tm)
in (let _154_1015 = (FStar_Syntax_Print.term_to_string t)
...
| () -> begin
(let _154_1018 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print1 "\tSet memo %s\n" _154_1018))
end)))
in (rebuild cfg env stack t)))
end
...
in (rebuild cfg env stack _154_1019))))
end
...
| () -> begin
(let _154_1021 = (FStar_Syntax_Print.term_to_string tm)
...
in (let _154_1022 = (maybe_simplify cfg.steps t)
in (rebuild cfg env stack _154_1022)))
end
...
let tl = (FStar_All.pipe_right tl (FStar_List.map (fun p -> (let _154_1037 = (norm_pat env p)
in (Prims.fst _154_1037)))))
in (((
...
let _54_2011 = x
in (let _154_1040 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _54_2011.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _54_2011.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _154_1040}))
in (((
...
let _54_2018 = x
in (let _154_1041 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _54_2018.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _54_2018.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _154_1041}))
in (((
...
let _54_2027 = x
in (let _154_1042 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _54_2027.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _54_2027.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _154_1042}))
in (
...
| Some (w) -> begin
(let _154_1044 = (norm_or_whnf env w)
in Some (_154_1044))
end)
in (
...
in (let _154_1045 = (mk (FStar_Syntax_Syntax.Tm_match (((scrutinee), (branches)))) r)
in (rebuild cfg env stack _154_1045)))))))
end))
in (
...
| _54_2126 -> begin
(let _154_1062 = (not ((is_cons head)))
in FStar_Util.Inr (_154_1062))
end)
end
| FStar_Syntax_Syntax.Pat_cons (fv, arg_pats) -> begin
(match ((let _154_1063 = (FStar_Syntax_Util.un_uinst head)
in _154_1063.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv') when (FStar_Syntax_Syntax.fv_eq fv fv') -> begin
(matches_args [] args arg_pats)
end
| _54_2134 -> begin
(let _154_1064 = (not ((is_cons head)))
in FStar_Util.Inr (_154_1064))
end)
end)
end))))
...
| () -> begin
(let _154_1075 = (FStar_Syntax_Print.pat_to_string p)
in (let _154_1074 = (let _154_1073 = (FStar_List.map FStar_Syntax_Print.term_to_string s)
in (FStar_All.pipe_right _154_1073 (FStar_String.concat "; ")))
in (FStar_Util.print2 "Matches pattern %s with subst = %s\n" _154_1075 _154_1074)))
end)))
in (

let env = (FStar_List.fold_left (fun env t -> (let _154_1080 = (let _154_1079 = (let _154_1078 = (FStar_Util.mk_ref (Some ((([]), (t)))))
in (([]), (t), (_154_1078), (false)))
in Clos (_154_1079))
in (_154_1080)::env)) env s)
in (let _154_1081 = (guard_when_clause wopt b rest)
in (norm cfg env stack _154_1081))))
end)
end))
...
let normalize : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun s e t -> (let _154_1093 = (config s e)
in (norm _154_1093 [] [] t)))


let normalize_comp : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun s e t -> (let _154_1100 = (config s e)
in (norm_comp _154_1100 [] t)))


let normalize_universe : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.universe  ->  FStar_Syntax_Syntax.universe = (fun env u -> (let _154_1105 = (config [] env)
in (norm_universe _154_1105 [] u)))


let ghost_to_pure : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun env c -> (let _154_1110 = (config [] env)
in (ghost_to_pure_aux _154_1110 [] c)))
...
let non_info = (fun t -> (let _154_1117 = (norm cfg [] [] t)
in (FStar_Syntax_Util.non_informative _154_1117)))
...
| () -> begin
(let _154_1119 = (lc.FStar_Syntax_Syntax.comp ())
in (ghost_to_pure env _154_1119))
end))})
end
| None -> begin
lc
...
let term_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  Prims.string = (fun env t -> (let _154_1124 = (normalize ((AllowUnboundUniverses)::[]) env t)
in (FStar_Syntax_Print.term_to_string _154_1124)))


let comp_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  Prims.string = (fun env c -> (let _154_1130 = (let _154_1129 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp _154_1129 [] c))
in (FStar_Syntax_Print.comp_to_string _154_1130)))
...
(let _154_1141 = (let _154_1140 = (let _154_1139 = (FStar_Syntax_Util.mk_conj phi1 phi)
in ((y), (_154_1139)))
in FStar_Syntax_Syntax.Tm_refine (_154_1140))
in (mk _154_1141 t0.FStar_Syntax_Syntax.pos))
end
| _54_2237 -> begin
t
end))
...
| (binders, args) -> begin
(let _154_1150 = (FStar_Syntax_Syntax.mk_Tm_app t args None t.FStar_Syntax_Syntax.pos)
in (let _154_1149 = (let _154_1148 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _154_1146 -> FStar_Util.Inl (_154_1146)))
in (FStar_All.pipe_right _154_1148 (fun _154_1147 -> Some (_154_1147))))
in (FStar_Syntax_Util.abs binders _154_1150 _154_1149)))
end))
end)
end)))


let eta_expand : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun env t -> (match ((let _154_1155 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in ((_154_1155), (t.FStar_Syntax_Syntax.n)))) with
| (Some (sort), _54_2256) -> begin
(let _154_1156 = (mk sort t.FStar_Syntax_Syntax.pos)
in (eta_expand_with_type t _154_1156))
end
...
| (head, args) -> begin
(match ((let _154_1157 = (FStar_Syntax_Subst.compress head)
in _154_1157.FStar_Syntax_Syntax.n)) with
