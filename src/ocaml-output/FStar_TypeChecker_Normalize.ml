...
| ((head, uu____5417))::args -> begin
(

let uu____5432 = (maybe_unfold_action head)
...
let uu____5478 = (FStar_Syntax_Subst.compress e).FStar_Syntax_Syntax.n
...
let body = (let _0_432 = (let _0_431 = (let _0_430 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_0_430), (q)))
in (_0_431)::acc)
in (bind_on_lift es _0_432))
in (
...
let uu____5520 = (FStar_Syntax_Subst.compress bind_repr).FStar_Syntax_Syntax.n
in (match (uu____5520) with
| FStar_Syntax_Syntax.Tm_uinst (bind, (uu____5524)::(uu____5525)::[]) -> begin
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_436 = (let _0_435 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t')
in (let _0_434 = (let _0_433 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_0_433)::[])
in (_0_435)::_0_434))
in ((bind), (_0_436)))))) None e0.FStar_Syntax_Syntax.pos)
end
| uu____5542 -> begin
(failwith "NIY : Reification of indexed effects")
end))
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_448 = (let _0_447 = (FStar_Syntax_Syntax.as_arg t')
in (let _0_446 = (let _0_445 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_444 = (let _0_443 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_442 = (let _0_441 = (FStar_Syntax_Syntax.as_arg lifted_e0)
in (let _0_440 = (let _0_439 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_438 = (let _0_437 = (FStar_Syntax_Syntax.as_arg continuation)
in (_0_437)::[])
in (_0_439)::_0_438))
in (_0_441)::_0_440))
in (_0_443)::_0_442))
in (_0_445)::_0_444))
in (_0_447)::_0_446))
in ((bind_inst), (_0_448)))))) None e0.FStar_Syntax_Syntax.pos))))))
end
| FStar_Syntax_Syntax.Tm_meta (e0, FStar_Syntax_Syntax.Meta_monadic_lift (uu____5557)) -> begin
...
let binded_head = (let _0_450 = (let _0_449 = (FStar_Syntax_Syntax.as_arg head)
in (_0_449)::args)
in (bind_on_lift _0_450 []))
in (let _0_451 = (FStar_List.tl stack)
in (norm cfg env _0_451 binded_head)))))
end)))
end
...
let should_reify = (match (stack) with
| (App ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = uu____5605; FStar_Syntax_Syntax.pos = uu____5606; FStar_Syntax_Syntax.vars = uu____5607}, uu____5608, uu____5609))::uu____5610 -> begin
(FStar_All.pipe_right cfg.steps (FStar_List.contains Reify))
end
| uu____5616 -> begin
false
...
| true -> begin
(let _0_453 = (FStar_List.tl stack)
in (let _0_452 = (reify_lift cfg.tcenv head m m' t)
in (norm cfg env _0_453 _0_452)))
end
| uu____5617 -> begin
(

let uu____5618 = (((FStar_Syntax_Util.is_pure_effect m) || (FStar_Syntax_Util.is_ghost_effect m)) && (FStar_All.pipe_right cfg.steps (FStar_List.contains PureSubtermsWithinComputations)))
...
let uu___158_5623 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::[]; tcenv = uu___158_5623.tcenv; delta_level = (FStar_TypeChecker_Env.Inlining)::(FStar_TypeChecker_Env.Eager_unfolding_only)::[]})
...
| uu____5629 -> begin
(match (stack) with
| (uu____5630)::uu____5631 -> begin
(match (m) with
| FStar_Syntax_Syntax.Meta_labeled (l, r, uu____5635) -> begin
...
let uu____5675 = ed.FStar_Syntax_Syntax.return_repr
in (match (uu____5675) with
| (uu____5676, return_repr) -> begin
(

let return_inst = (

let uu____5683 = (FStar_Syntax_Subst.compress return_repr).FStar_Syntax_Syntax.n
in (match (uu____5683) with
| FStar_Syntax_Syntax.Tm_uinst (return_tm, (uu____5687)::[]) -> begin
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_455 = (let _0_454 = (env.FStar_TypeChecker_Env.universe_of env t)
in (_0_454)::[])
in ((return_tm), (_0_455)))))) None e.FStar_Syntax_Syntax.pos)
end
| uu____5704 -> begin
(failwith "NIY : Reification of indexed effects")
end))
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_459 = (let _0_458 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_457 = (let _0_456 = (FStar_Syntax_Syntax.as_arg e)
in (_0_456)::[])
in (_0_458)::_0_457))
in ((return_inst), (_0_459)))))) None e.FStar_Syntax_Syntax.pos))
end)))
end
| uu____5718 -> begin
(failwith "NYI: non pure monadic lift normalisation")
end))
and norm_pattern_args : cfg  ->  env  ->  ((FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax * FStar_Syntax_Syntax.aqual) Prims.list Prims.list  ->  ((FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax * FStar_Syntax_Syntax.aqual) Prims.list Prims.list = (fun cfg env args -> (FStar_All.pipe_right args (FStar_List.map (FStar_List.map (fun uu____5748 -> (match (uu____5748) with
| (a, imp) -> begin
(let _0_460 = (norm cfg env [] a)
in ((_0_460), (imp)))
end))))))
...
let uu___159_5769 = comp
in (let _0_463 = FStar_Syntax_Syntax.Total ((let _0_462 = (norm cfg env [] t)
in (let _0_461 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_0_462), (_0_461)))))
in {FStar_Syntax_Syntax.n = _0_463; FStar_Syntax_Syntax.tk = uu___159_5769.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___159_5769.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___159_5769.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(

let uu___160_5785 = comp
in (let _0_466 = FStar_Syntax_Syntax.GTotal ((let _0_465 = (norm cfg env [] t)
in (let _0_464 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_0_465), (_0_464)))))
in {FStar_Syntax_Syntax.n = _0_466; FStar_Syntax_Syntax.tk = uu___160_5785.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___160_5785.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___160_5785.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(

let norm_args = (fun args -> (FStar_All.pipe_right args (FStar_List.map (fun uu____5817 -> (match (uu____5817) with
| (a, i) -> begin
(let _0_467 = (norm cfg env [] a)
in ((_0_467), (i)))
end)))))
in (

let flags = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___129_5828 -> (match (uu___129_5828) with
| FStar_Syntax_Syntax.DECREASES (t) -> begin
...
let uu___161_5833 = comp
in (let _0_471 = FStar_Syntax_Syntax.Comp ((

let uu___162_5836 = ct
in (let _0_470 = (FStar_List.map (norm_universe cfg env) ct.FStar_Syntax_Syntax.comp_univs)
in (let _0_469 = (norm cfg env [] ct.FStar_Syntax_Syntax.result_typ)
in (let _0_468 = (norm_args ct.FStar_Syntax_Syntax.effect_args)
in {FStar_Syntax_Syntax.comp_univs = _0_470; FStar_Syntax_Syntax.effect_name = uu___162_5836.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _0_469; FStar_Syntax_Syntax.effect_args = _0_468; FStar_Syntax_Syntax.flags = flags})))))
in {FStar_Syntax_Syntax.n = _0_471; FStar_Syntax_Syntax.tk = uu___161_5833.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___161_5833.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___161_5833.FStar_Syntax_Syntax.vars}))))
end)))
...
let uu___163_5848 = cfg
in {steps = (Eager_unfolding)::(UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::(AllowUnboundUniverses)::[]; tcenv = uu___163_5848.tcenv; delta_level = uu___163_5848.delta_level}) env [] t))
in (

let non_info = (fun t -> (FStar_Syntax_Util.non_informative (norm t)))
in (match (c.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (uu____5855) -> begin
c
end
...
let uu___164_5869 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (((t), (uopt))); FStar_Syntax_Syntax.tk = uu___164_5869.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___164_5869.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___164_5869.FStar_Syntax_Syntax.vars})
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(
...
let uu____5879 = ((FStar_Syntax_Util.is_ghost_effect l) && (non_info ct.FStar_Syntax_Syntax.result_typ))
...
let uu___165_5884 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___165_5884.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = pure_eff; FStar_Syntax_Syntax.result_typ = uu___165_5884.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___165_5884.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___165_5884.FStar_Syntax_Syntax.flags})
end
| None -> begin
(
...
let uu___166_5886 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___166_5886.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.result_typ = uu___166_5886.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___166_5886.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___166_5886.FStar_Syntax_Syntax.flags}))
end)
in (

let uu___167_5887 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (ct); FStar_Syntax_Syntax.tk = uu___167_5887.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___167_5887.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___167_5887.FStar_Syntax_Syntax.vars}))
end
| uu____5892 -> begin
c
end)))
...
and norm_binder : cfg  ->  env  ->  FStar_Syntax_Syntax.binder  ->  FStar_Syntax_Syntax.binder = (fun cfg env uu____5896 -> (match (uu____5896) with
| (x, imp) -> begin
(let _0_473 = (

let uu___168_5899 = x
in (let _0_472 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___168_5899.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___168_5899.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_472}))
in ((_0_473), (imp)))
end))
and norm_binders : cfg  ->  env  ->  FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.binders = (fun cfg env bs -> (

let uu____5903 = (FStar_List.fold_left (fun uu____5910 b -> (match (uu____5910) with
| (nbs', env) -> begin
(
...
let uu____5944 = (FStar_Syntax_Util.is_tot_or_gtot_lcomp lc)
...
let uu____5949 = (FStar_Syntax_Util.is_total_lcomp lc)
in (match (uu____5949) with
| true -> begin
Some (FStar_Util.Inl ((FStar_Syntax_Util.lcomp_of_comp (let _0_474 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.comp_set_flags _0_474 flags)))))
end
| uu____5955 -> begin
Some (FStar_Util.Inl ((FStar_Syntax_Util.lcomp_of_comp (let _0_475 = (FStar_Syntax_Syntax.mk_GTotal t)
...
let uu____5980 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug cfg.tcenv) (FStar_Options.Other ("print_normalized_terms")))
in (match (uu____5980) with
| true -> begin
(let _0_477 = (FStar_Syntax_Print.term_to_string tm)
in (let _0_476 = (FStar_Syntax_Print.term_to_string t)
...
let uu___169_5988 = cfg
in {steps = s; tcenv = uu___169_5988.tcenv; delta_level = dl}) env stack t)
end
...
| (MemoLazy (r))::stack -> begin
((set_memo r ((env), (t)));
(log cfg (fun uu____6008 -> (let _0_478 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print1 "\tSet memo %s\n" _0_478))));
(rebuild cfg env stack t);
)
end
...
let uu___170_6045 = (FStar_Syntax_Util.abs bs t lopt)
in {FStar_Syntax_Syntax.n = uu___170_6045.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___170_6045.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___170_6045.FStar_Syntax_Syntax.vars})
...
| (Arg (Clos (env, tm, m, uu____6067), aq, r))::stack -> begin
((log cfg (fun uu____6083 -> (let _0_480 = (FStar_Syntax_Print.term_to_string tm)
...
let uu____6094 = (FStar_ST.read m)
...
in (let _0_481 = (maybe_simplify cfg.steps t)
in (rebuild cfg env stack _0_481)))
end
| (Match (env, branches, r))::stack -> begin
((log cfg (fun uu____6148 -> (let _0_482 = (FStar_Syntax_Print.term_to_string t)
...
let norm_and_rebuild_match = (fun uu____6153 -> (
...
let new_delta = (FStar_All.pipe_right cfg.delta_level (FStar_List.filter (fun uu___130_6160 -> (match (uu___130_6160) with
| (FStar_TypeChecker_Env.Inlining) | (FStar_TypeChecker_Env.Eager_unfolding_only) -> begin
true
end
| uu____6161 -> begin
...
let uu____6164 = (FStar_All.pipe_right cfg.steps (FStar_List.contains PureSubtermsWithinComputations))
...
let uu___171_6167 = cfg
in {steps = (FStar_List.append steps' cfg.steps); tcenv = uu___171_6167.tcenv; delta_level = new_delta})))
in (
...
let rec norm_pat = (fun env p -> (match (p.FStar_Syntax_Syntax.v) with
| FStar_Syntax_Syntax.Pat_constant (uu____6201) -> begin
((p), (env))
end
| FStar_Syntax_Syntax.Pat_disj ([]) -> begin
(failwith "Impossible")
...
let uu____6221 = (norm_pat env hd)
...
let uu___172_6263 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd)::tl); FStar_Syntax_Syntax.ty = uu___172_6263.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___172_6263.FStar_Syntax_Syntax.p})), (env')))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(

let uu____6280 = (FStar_All.pipe_right pats (FStar_List.fold_left (fun uu____6314 uu____6315 -> (match (((uu____6314), (uu____6315))) with
| ((pats, env), (p, b)) -> begin
(

let uu____6380 = (norm_pat env p)
...
let uu___173_6446 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats)))); FStar_Syntax_Syntax.ty = uu___173_6446.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___173_6446.FStar_Syntax_Syntax.p})), (env))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___174_6460.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___174_6460.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_483}))
in (((

let uu___175_6464 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = uu___175_6464.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___175_6464.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___176_6469.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___176_6469.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_484}))
in (((

let uu___177_6473 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = uu___177_6473.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___177_6473.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t) -> begin
(
...
in {FStar_Syntax_Syntax.ppname = uu___178_6483.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___178_6483.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_485}))
in (
...
let uu___179_6488 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t))); FStar_Syntax_Syntax.ty = uu___179_6488.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___179_6488.FStar_Syntax_Syntax.p})), (env))))
end))
in (
...
let uu____6495 = (FStar_Syntax_Subst.open_branch branch)
in (match (uu____6495) with
| (p, wopt, e) -> begin
(

let uu____6513 = (norm_pat env p)
...
in (let _0_486 = (mk (FStar_Syntax_Syntax.Tm_match (((scrutinee), (branches)))) r)
in (rebuild cfg env stack _0_486))))))))
in (

let rec is_cons = (fun head -> (match (head.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_uinst (h, uu____6550) -> begin
(is_cons h)
end
...
let uu____6660 = (FStar_Syntax_Util.head_and_args scrutinee)
...
in (match (m) with
| FStar_Util.Inl (uu____6717) -> begin
Some (m)
end
...
| FStar_Syntax_Syntax.Pat_dot_term (uu____6748) -> begin
FStar_Util.Inl ([])
end
...
let uu____6774 = (FStar_Syntax_Util.un_uinst head).FStar_Syntax_Syntax.n
...
| (((t, uu____6813))::rest_a, ((p, uu____6816))::rest_p) -> begin
(

let uu____6844 = (matches_pat t p)
...
let uu____6929 = (matches_pat scrutinee p)
...
| FStar_Util.Inl (s) -> begin
((log cfg (fun uu____6939 -> (let _0_489 = (FStar_Syntax_Print.pat_to_string p)
in (let _0_488 = (let _0_487 = (FStar_List.map FStar_Syntax_Print.term_to_string s)
in (FStar_All.pipe_right _0_487 (FStar_String.concat "; ")))
in (FStar_Util.print2 "Matches pattern %s with subst = %s\n" _0_489 _0_488)))));
(

let env = (FStar_List.fold_left (fun env t -> (let _0_491 = Clos ((let _0_490 = (FStar_Util.mk_ref (Some ((([]), (t)))))
in (([]), (t), (_0_490), (false))))
in (_0_491)::env)) env s)
in (let _0_492 = (guard_when_clause wopt b rest)
in (norm cfg env stack _0_492)));
)
end))
end))
in (

let uu____6963 = (FStar_All.pipe_right cfg.steps (FStar_List.contains (Exclude (Iota))))
...
let d = (FStar_All.pipe_right s (FStar_List.collect (fun uu___131_6977 -> (match (uu___131_6977) with
| UnfoldUntil (k) -> begin
...
let normalize : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun s e t -> (let _0_493 = (config s e)
in (norm _0_493 [] [] t)))


let normalize_comp : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun s e t -> (let _0_494 = (config s e)
in (norm_comp _0_494 [] t)))


let normalize_universe : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.universe  ->  FStar_Syntax_Syntax.universe = (fun env u -> (let _0_495 = (config [] env)
in (norm_universe _0_495 [] u)))


let ghost_to_pure : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun env c -> (let _0_496 = (config [] env)
in (ghost_to_pure_aux _0_496 [] c)))
...
let uu____7027 = ((FStar_Syntax_Util.is_ghost_effect lc.FStar_Syntax_Syntax.eff_name) && (non_info lc.FStar_Syntax_Syntax.res_typ))
...
let uu___180_7029 = lc
in {FStar_Syntax_Syntax.eff_name = pure_eff; FStar_Syntax_Syntax.res_typ = uu___180_7029.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___180_7029.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____7030 -> (let _0_497 = (lc.FStar_Syntax_Syntax.comp ())
in (ghost_to_pure env _0_497)))})
end
| None -> begin
lc
end)
...
let comp_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  Prims.string = (fun env c -> (FStar_Syntax_Print.comp_to_string (let _0_498 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp _0_498 [] c))))
...
(let _0_500 = FStar_Syntax_Syntax.Tm_refine ((let _0_499 = (FStar_Syntax_Util.mk_conj phi1 phi)
in ((y), (_0_499))))
in (mk _0_500 t0.FStar_Syntax_Syntax.pos))
end
| uu____7082 -> begin
t
end))
...
let uu____7090 = (FStar_Syntax_Util.arrow_formals_comp sort)
...
let uu____7110 = (FStar_All.pipe_right binders FStar_Syntax_Util.args_of_binders)
in (match (uu____7110) with
| (binders, args) -> begin
(let _0_505 = ((FStar_Syntax_Syntax.mk_Tm_app t args) None t.FStar_Syntax_Syntax.pos)
in (let _0_504 = (let _0_503 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _0_501 -> FStar_Util.Inl (_0_501)))
in (FStar_All.pipe_right _0_503 (fun _0_502 -> Some (_0_502))))
in (FStar_Syntax_Util.abs binders _0_505 _0_504)))
end))
end)
end)))
...
let uu____7180 = (let _0_506 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in ((_0_506), (t.FStar_Syntax_Syntax.n)))
in (match (uu____7180) with
| (Some (sort), uu____7189) -> begin
(let _0_507 = (mk sort t.FStar_Syntax_Syntax.pos)
in (eta_expand_with_type t _0_507))
end
| (uu____7191, FStar_Syntax_Syntax.Tm_name (x)) -> begin
(eta_expand_with_type t x.FStar_Syntax_Syntax.sort)
end
| uu____7195 -> begin
(

let uu____7199 = (FStar_Syntax_Util.head_and_args t)
in (match (uu____7199) with
| (head, args) -> begin
(

let uu____7225 = (FStar_Syntax_Subst.compress head).FStar_Syntax_Syntax.n
in (match (uu____7225) with
| FStar_Syntax_Syntax.Tm_uvar (uu____7226, thead) -> begin
(

let uu____7240 = (FStar_Syntax_Util.arrow_formals thead)
...
let uu____7271 = (env.FStar_TypeChecker_Env.type_of (

let uu___181_7275 = env
in {FStar_TypeChecker_Env.solver = uu___181_7275.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___181_7275.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___181_7275.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___181_7275.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___181_7275.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___181_7275.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = uu___181_7275.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___181_7275.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___181_7275.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___181_7275.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___181_7275.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___181_7275.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___181_7275.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___181_7275.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___181_7275.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___181_7275.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___181_7275.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___181_7275.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___181_7275.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___181_7275.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___181_7275.FStar_TypeChecker_Env.qname_and_index}) t)
in (match (uu____7271) with
| (uu____7276, ty, uu____7278) -> begin
...
let uu____7280 = (env.FStar_TypeChecker_Env.type_of (

let uu___182_7284 = env
in {FStar_TypeChecker_Env.solver = uu___182_7284.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___182_7284.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___182_7284.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___182_7284.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___182_7284.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___182_7284.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = uu___182_7284.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___182_7284.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___182_7284.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___182_7284.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___182_7284.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___182_7284.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___182_7284.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___182_7284.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___182_7284.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___182_7284.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___182_7284.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___182_7284.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___182_7284.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___182_7284.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___182_7284.FStar_TypeChecker_Env.qname_and_index}) t)
in (match (uu____7280) with
| (uu____7285, ty, uu____7287) -> begin
(eta_expand_with_type t ty)
end))
end))
end))
