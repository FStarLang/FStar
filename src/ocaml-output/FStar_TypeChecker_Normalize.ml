...
let closure_to_string : closure  ->  Prims.string = (fun uu___136_174 -> (match (uu___136_174) with
...
let env_to_string : closure Prims.list  ->  Prims.string = (fun env -> (let _0_337 = (FStar_List.map closure_to_string env)
in (FStar_All.pipe_right _0_337 (FStar_String.concat "; "))))


let stack_elt_to_string : stack_elt  ->  Prims.string = (fun uu___137_591 -> (match (uu___137_591) with
| Arg (c, uu____593, uu____594) -> begin
(let _0_338 = (closure_to_string c)
in (FStar_Util.format1 "Closure %s" _0_338))
end
| MemoLazy (uu____595) -> begin
"MemoLazy"
end
| Abs (uu____599, bs, uu____601, uu____602, uu____603) -> begin
(let _0_339 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
in (FStar_Util.format1 "Abs %s" _0_339))
end
...
(let _0_340 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format1 "App %s" _0_340))
end
...
in (FStar_Util.format1 "Debug %s" _0_341))
end))


let stack_to_string : stack_elt Prims.list  ->  Prims.string = (fun s -> (let _0_342 = (FStar_List.map stack_elt_to_string s)
in (FStar_All.pipe_right _0_342 (FStar_String.concat "; "))))
...
let is_empty = (fun uu___138_663 -> (match (uu___138_663) with
| [] -> begin
true
end
| uu____665 -> begin
...
with
| uu____683 -> begin
(failwith (let _0_343 = (FStar_Syntax_Print.db_to_string x)
...
| true -> begin
(Prims.raise (FStar_Errors.Error ((let _0_347 = (let _0_346 = (FStar_Util.string_of_int (FStar_List.length binders))
in (let _0_345 = (FStar_Util.string_of_int ((FStar_List.length c.FStar_Syntax_Syntax.effect_args) + (Prims.parse_int "1")))
in (let _0_344 = (FStar_Syntax_Print.comp_to_string (FStar_Syntax_Syntax.mk_Comp c))
in (FStar_Util.format3 "Effect constructor is not fully applied; expected %s args, got %s args, i.e., %s" _0_346 _0_345 _0_344))))
in ((_0_347), (comp.FStar_Syntax_Syntax.pos))))))
end
| uu____752 -> begin
()
end);
...
let inst = (let _0_349 = (let _0_348 = (FStar_Syntax_Syntax.as_arg c.FStar_Syntax_Syntax.result_typ)
in (_0_348)::c.FStar_Syntax_Syntax.effect_args)
...
let uu___148_793 = (comp_to_comp_typ env c1)
in {FStar_Syntax_Syntax.comp_univs = uu___148_793.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = uu___148_793.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu___148_793.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___148_793.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = c.FStar_Syntax_Syntax.flags})
in (FStar_All.pipe_right _0_350 FStar_Syntax_Syntax.mk_Comp))
...
let us = (let _0_351 = (FStar_List.collect aux us)
in (FStar_All.pipe_right _0_351 norm_univs))
in (match (us) with
| (u_k)::(hd)::rest -> begin
(
...
(let _0_353 = (aux u)
in (FStar_List.map (fun _0_352 -> FStar_Syntax_Syntax.U_succ (_0_352)) _0_353))
end)))
in (
...
let rec closure_as_term : cfg  ->  closure Prims.list  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun cfg env t -> ((log cfg (fun uu____1030 -> (let _0_355 = (FStar_Syntax_Print.tag_of_term t)
...
(let _0_356 = FStar_Syntax_Syntax.Tm_type ((norm_universe cfg env u))
in (mk _0_356 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_uinst (t, us) -> begin
(let _0_357 = (FStar_List.map (norm_universe cfg env) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst t _0_357))
end
...
in (let _0_359 = FStar_Syntax_Syntax.Tm_abs ((let _0_358 = (close_lcomp_opt cfg env lopt)
in ((bs), (body), (_0_358))))
in (mk _0_359 t.FStar_Syntax_Syntax.pos)))
end))
end
...
let uu____1222 = (let _0_361 = (let _0_360 = (FStar_Syntax_Syntax.mk_binder x)
in (_0_360)::[])
in (closures_as_binders_delayed cfg env _0_361))
in (match (uu____1222) with
| (x, env) -> begin
(

let phi = (closure_as_term_delayed cfg env phi)
in (let _0_364 = FStar_Syntax_Syntax.Tm_refine ((let _0_363 = (let _0_362 = (FStar_List.hd x)
in (FStar_All.pipe_right _0_362 Prims.fst))
in ((_0_363), (phi))))
in (mk _0_364 t.FStar_Syntax_Syntax.pos)))
end))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inl (t2), lopt) -> begin
(let _0_369 = FStar_Syntax_Syntax.Tm_ascribed ((let _0_368 = (closure_as_term_delayed cfg env t1)
in (let _0_367 = (let _0_366 = (closure_as_term_delayed cfg env t2)
in (FStar_All.pipe_left (fun _0_365 -> FStar_Util.Inl (_0_365)) _0_366))
in ((_0_368), (_0_367), (lopt)))))
in (mk _0_369 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inr (c), lopt) -> begin
(let _0_374 = FStar_Syntax_Syntax.Tm_ascribed ((let _0_373 = (closure_as_term_delayed cfg env t1)
in (let _0_372 = (let _0_371 = (close_comp cfg env c)
in (FStar_All.pipe_left (fun _0_370 -> FStar_Util.Inr (_0_370)) _0_371))
in ((_0_373), (_0_372), (lopt)))))
in (mk _0_374 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', FStar_Syntax_Syntax.Meta_pattern (args)) -> begin
(let _0_377 = FStar_Syntax_Syntax.Tm_meta ((let _0_376 = (closure_as_term_delayed cfg env t')
in (let _0_375 = FStar_Syntax_Syntax.Meta_pattern ((FStar_All.pipe_right args (FStar_List.map (closures_as_args_delayed cfg env))))
in ((_0_376), (_0_375)))))
in (mk _0_377 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', FStar_Syntax_Syntax.Meta_monadic (m, tbody)) -> begin
(let _0_381 = FStar_Syntax_Syntax.Tm_meta ((let _0_380 = (closure_as_term_delayed cfg env t')
in (let _0_379 = FStar_Syntax_Syntax.Meta_monadic ((let _0_378 = (closure_as_term_delayed cfg env tbody)
in ((m), (_0_378))))
in ((_0_380), (_0_379)))))
in (mk _0_381 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', FStar_Syntax_Syntax.Meta_monadic_lift (m1, m2, tbody)) -> begin
(let _0_385 = FStar_Syntax_Syntax.Tm_meta ((let _0_384 = (closure_as_term_delayed cfg env t')
in (let _0_383 = FStar_Syntax_Syntax.Meta_monadic_lift ((let _0_382 = (closure_as_term_delayed cfg env tbody)
in ((m1), (m2), (_0_382))))
in ((_0_384), (_0_383)))))
in (mk _0_385 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', m) -> begin
(let _0_387 = FStar_Syntax_Syntax.Tm_meta ((let _0_386 = (closure_as_term_delayed cfg env t')
in ((_0_386), (m))))
in (mk _0_387 t.FStar_Syntax_Syntax.pos))
end
...
let uu___151_1437 = lb
in {FStar_Syntax_Syntax.lbname = uu___151_1437.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___151_1437.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = typ; FStar_Syntax_Syntax.lbeff = uu___151_1437.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = def})
...
let uu___152_1480 = lb
in (let _0_389 = (closure_as_term cfg env_univs lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_388 = (closure_as_term cfg env lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___152_1480.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___152_1480.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _0_389; FStar_Syntax_Syntax.lbeff = uu___152_1480.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _0_388}))))))
in (
...
let uu___153_1652 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd)::tl); FStar_Syntax_Syntax.ty = uu___153_1652.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___153_1652.FStar_Syntax_Syntax.p})), (env')))
end))
end
...
let uu___154_1835 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats)))); FStar_Syntax_Syntax.ty = uu___154_1835.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___154_1835.FStar_Syntax_Syntax.p})), (env))
end))
end
...
let uu___155_1849 = x
in (let _0_390 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___155_1849.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___155_1849.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_390}))
in (((

let uu___156_1853 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = uu___156_1853.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___156_1853.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
...
let uu___157_1858 = x
in (let _0_391 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___157_1858.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___157_1858.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_391}))
in (((

let uu___158_1862 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = uu___158_1862.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___158_1862.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
...
let uu___159_1872 = x
in (let _0_392 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___159_1872.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___159_1872.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_392}))
in (
...
let uu___160_1877 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t))); FStar_Syntax_Syntax.ty = uu___160_1877.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___160_1877.FStar_Syntax_Syntax.p})), (env))))
end))
in (
...
in (let _0_394 = FStar_Syntax_Syntax.Tm_match ((let _0_393 = (FStar_All.pipe_right branches (FStar_List.map (norm_one_branch env)))
in ((head), (_0_393))))
in (mk _0_394 t.FStar_Syntax_Syntax.pos))))
end))
end);
))
...
| (x, imp) -> begin
(let _0_395 = (closure_as_term_delayed cfg env x)
in ((_0_395), (imp)))
end)) args)
end))
...
let uu___161_2072 = b
in (let _0_396 = (closure_as_term_delayed cfg env b.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___161_2072.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___161_2072.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_396}))
in (
...
(let _0_398 = (closure_as_term_delayed cfg env t)
in (let _0_397 = (FStar_Option.map (norm_universe cfg env) uopt)
in (FStar_Syntax_Syntax.mk_Total' _0_398 _0_397)))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(let _0_400 = (closure_as_term_delayed cfg env t)
in (let _0_399 = (FStar_Option.map (norm_universe cfg env) uopt)
in (FStar_Syntax_Syntax.mk_GTotal' _0_400 _0_399)))
end
...
let flags = (FStar_All.pipe_right c.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___139_2151 -> (match (uu___139_2151) with
...
let uu___162_2156 = c
in (let _0_401 = (FStar_List.map (norm_universe cfg env) c.FStar_Syntax_Syntax.comp_univs)
in {FStar_Syntax_Syntax.comp_univs = _0_401; FStar_Syntax_Syntax.effect_name = uu___162_2156.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = rt; FStar_Syntax_Syntax.effect_args = args; FStar_Syntax_Syntax.flags = flags}))))))
end)
end))
and filter_out_lcomp_cflags : FStar_Syntax_Syntax.lcomp  ->  FStar_Syntax_Syntax.cflags Prims.list = (fun lc -> (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.filter (fun uu___140_2160 -> (match (uu___140_2160) with
...
let int_as_const = (fun i -> FStar_Const.Const_int ((let _0_402 = (FStar_Util.string_of_int i)
in ((_0_402), (None)))))
in (

let bool_as_const = (fun b -> FStar_Const.Const_bool (b))
in (let _0_411 = (FStar_List.flatten (FStar_List.map (fun m -> (let _0_410 = (let _0_403 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("add")::[]))
in ((_0_403), ((fun x y -> (int_as_const (x + y))))))
in (let _0_409 = (let _0_408 = (let _0_404 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("sub")::[]))
in ((_0_404), ((fun x y -> (int_as_const (x - y))))))
in (let _0_407 = (let _0_406 = (let _0_405 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("mul")::[]))
in ((_0_405), ((fun x y -> (int_as_const (x * y))))))
in (_0_406)::[])
in (_0_408)::_0_407))
in (_0_410)::_0_409))) (("Int8")::("UInt8")::("Int16")::("UInt16")::("Int32")::("UInt32")::("Int64")::("UInt64")::("UInt128")::[])))
...
let name = (fun x -> (mk (FStar_Syntax_Syntax.Tm_fvar ((let _0_412 = (FStar_Syntax_Const.p2l x)
in (FStar_Syntax_Syntax.lid_as_fv _0_412 FStar_Syntax_Syntax.Delta_constant None))))))
in (

let ctor = (fun x -> (mk (FStar_Syntax_Syntax.Tm_fvar ((let _0_413 = (FStar_Syntax_Const.p2l x)
in (FStar_Syntax_Syntax.lid_as_fv _0_413 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))))))
in (let _0_430 = (let _0_429 = (FStar_Syntax_Const.p2l (("FStar")::("String")::("list_of_string")::[]))
in ((_0_429), ((fun s -> (let _0_428 = (FStar_String.list_of_string s)
in (let _0_427 = (mk (FStar_Syntax_Syntax.Tm_app ((let _0_426 = (let _0_422 = (ctor (("Prims")::("Nil")::[]))
in (FStar_Syntax_Syntax.mk_Tm_uinst _0_422 ((FStar_Syntax_Syntax.U_zero)::[])))
in (let _0_425 = (let _0_424 = (let _0_423 = (name (("FStar")::("Char")::("char")::[]))
in ((_0_423), (Some (FStar_Syntax_Syntax.Implicit (true)))))
in (_0_424)::[])
in ((_0_426), (_0_425)))))))
in (FStar_List.fold_right (fun c a -> (mk (FStar_Syntax_Syntax.Tm_app ((let _0_421 = (let _0_414 = (ctor (("Prims")::("Cons")::[]))
in (FStar_Syntax_Syntax.mk_Tm_uinst _0_414 ((FStar_Syntax_Syntax.U_zero)::[])))
in (let _0_420 = (let _0_419 = (let _0_415 = (name (("FStar")::("Char")::("char")::[]))
in ((_0_415), (Some (FStar_Syntax_Syntax.Implicit (true)))))
in (let _0_418 = (let _0_417 = (let _0_416 = (mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_char (c))))
in ((_0_416), (None)))
in (_0_417)::(((a), (None)))::[])
in (_0_419)::_0_418))
in ((_0_421), (_0_420)))))))) _0_428 _0_427)))))))
in (_0_430)::[]))))
...
let c = (let _0_432 = (FStar_Util.int_of_string i)
in (let _0_431 = (FStar_Util.int_of_string j)
in (op _0_432 _0_431)))
in (mk (FStar_Syntax_Syntax.Tm_constant (c)) tm.FStar_Syntax_Syntax.pos)))
in (

let uu____2843 = (let _0_434 = (FStar_Syntax_Subst.compress a1).FStar_Syntax_Syntax.n
in (let _0_433 = (FStar_Syntax_Subst.compress a2).FStar_Syntax_Syntax.n
in ((_0_434), (_0_433))))
...
let uu____2896 = (let _0_438 = (FStar_Syntax_Subst.compress head1).FStar_Syntax_Syntax.n
in (let _0_437 = (FStar_Syntax_Subst.compress head2).FStar_Syntax_Syntax.n
in (let _0_436 = (FStar_Syntax_Subst.compress arg1).FStar_Syntax_Syntax.n
in (let _0_435 = (FStar_Syntax_Subst.compress arg2).FStar_Syntax_Syntax.n
in ((_0_438), (_0_437), (_0_436), (_0_435))))))
...
(let _0_442 = (mk (FStar_Syntax_Syntax.Tm_fvar (fv1)) tm.FStar_Syntax_Syntax.pos)
in (let _0_441 = (let _0_440 = (let _0_439 = (norm i j)
in ((_0_439), (None)))
in (_0_440)::[])
in (FStar_Syntax_Util.mk_app _0_442 _0_441)))
end
| uu____2938 -> begin
tm
end))
...
let uu___163_3051 = t
in {FStar_Syntax_Syntax.n = uu___163_3051.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___163_3051.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = tm.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___163_3051.FStar_Syntax_Syntax.vars}))
in (
...
let uu____3850 = (let _0_443 = (FStar_Syntax_Util.un_uinst hd).FStar_Syntax_Syntax.n
in ((_0_443), (args)))
...
let t = (FStar_Syntax_Subst.compress t)
in ((log cfg (fun uu____3991 -> (let _0_446 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_445 = (FStar_Syntax_Print.term_to_string t)
in (let _0_444 = (stack_to_string stack)
...
let uu___164_4051 = cfg
in {steps = s; tcenv = uu___164_4051.tcenv; delta_level = (FStar_TypeChecker_Env.Unfold (FStar_Syntax_Syntax.Delta_constant))::[]})
in (
...
in (let _0_447 = (mk (FStar_Syntax_Syntax.Tm_type (u)) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack _0_447)))
end
| FStar_Syntax_Syntax.Tm_uinst (t', us) -> begin
(
...
let us = UnivArgs ((let _0_448 = (FStar_List.map (norm_universe cfg env) us)
in ((_0_448), (t.FStar_Syntax_Syntax.pos))))
in (
...
let should_delta = (FStar_All.pipe_right cfg.delta_level (FStar_Util.for_some (fun uu___141_4263 -> (match (uu___141_4263) with
...
let r_env = (let _0_449 = (FStar_Syntax_Syntax.range_of_fv f)
in (FStar_TypeChecker_Env.set_range cfg.tcenv _0_449))
in (
...
| Some (us, t) -> begin
((log cfg (fun uu____4284 -> (let _0_451 = (FStar_Syntax_Print.term_to_string t0)
in (let _0_450 = (FStar_Syntax_Print.term_to_string t)
...
| uu____4305 -> begin
(failwith (let _0_452 = (FStar_Syntax_Print.lid_to_string f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_Util.format1 "Impossible: missing universe instantiation on %s" _0_452)))
end)
end
| uu____4310 -> begin
(norm cfg env stack t)
...
| Some (env, t') -> begin
((log cfg (fun uu____4347 -> (let _0_454 = (FStar_Syntax_Print.term_to_string t)
in (let _0_453 = (FStar_Syntax_Print.term_to_string t')
...
((log cfg (fun uu____4431 -> (let _0_455 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_455))));
(norm cfg ((c)::env) stack_rest body);
)
end
| Some (FStar_Util.Inr (l, cflags)) when (((FStar_Ident.lid_equals l FStar_Syntax_Const.effect_Tot_lid) || (FStar_Ident.lid_equals l FStar_Syntax_Const.effect_GTot_lid)) || (FStar_All.pipe_right cflags (FStar_Util.for_some (fun uu___142_4445 -> (match (uu___142_4445) with
...
((log cfg (fun uu____4448 -> (let _0_456 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_456))));
(norm cfg ((c)::env) stack_rest body);
)
end
| Some (FStar_Util.Inl (lc)) when (FStar_Syntax_Util.is_tot_or_gtot_lcomp lc) -> begin
((log cfg (fun uu____4459 -> (let _0_457 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_457))));
(norm cfg ((c)::env) stack_rest body);
)
end
...
let uu___165_4475 = cfg
in {steps = (WHNF)::(Exclude (Iota))::(Exclude (Zeta))::cfg.steps; tcenv = uu___165_4475.tcenv; delta_level = uu___165_4475.delta_level})
in (let _0_458 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_458)))
end)
end
| (uu____4476)::tl -> begin
((log cfg (fun uu____4486 -> (let _0_459 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_459))));
(
...
let uu___166_4507 = cfg
in {steps = s; tcenv = uu___166_4507.tcenv; delta_level = dl}) env stack t)
end
| (MemoLazy (r))::stack -> begin
((set_memo r ((env), (t)));
(log cfg (fun uu____4520 -> (let _0_460 = (FStar_Syntax_Print.term_to_string t)
...
| true -> begin
(let _0_461 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_461))
end
| uu____4531 -> begin
(
...
(let _0_467 = (let _0_465 = (let _0_463 = (let _0_462 = (l.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp opening _0_462))
in (FStar_All.pipe_right _0_463 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right _0_465 (fun _0_464 -> FStar_Util.Inl (_0_464))))
in (FStar_All.pipe_right _0_467 (fun _0_466 -> Some (_0_466))))
end
| uu____4585 -> begin
lopt
end)
...
in ((log cfg (fun uu____4604 -> (let _0_468 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
...
| (a, aq) -> begin
(let _0_471 = Arg ((let _0_470 = Clos ((let _0_469 = (FStar_Util.mk_ref None)
in ((env), (a), (_0_469), (false))))
in ((_0_470), (aq), (t.FStar_Syntax_Syntax.pos))))
in (_0_471)::stack)
end)) args))
in ((log cfg (fun uu____4661 -> (let _0_472 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
...
let uu___167_4682 = x
in {FStar_Syntax_Syntax.ppname = uu___167_4682.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___167_4682.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (f)))) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack t)))
end
| uu____4683 -> begin
(let _0_473 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_473))
end)
end
| uu____4686 -> begin
(
...
let t = (let _0_475 = FStar_Syntax_Syntax.Tm_refine ((let _0_474 = (FStar_Syntax_Subst.close closing f)
in (((

let uu___168_4704 = x
in {FStar_Syntax_Syntax.ppname = uu___168_4704.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___168_4704.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (_0_474))))
in (mk _0_475 t.FStar_Syntax_Syntax.pos))
in (rebuild cfg env stack t)))
end)))
end)
end
...
(match ((FStar_List.contains WHNF cfg.steps)) with
| true -> begin
(let _0_476 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_476))
end
| uu____4717 -> begin
(
...
let c = (let _0_477 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env uu____4729 -> (Dummy)::env) env))
in (norm_comp cfg _0_477 c))
in (

let t = (let _0_478 = (norm_binders cfg env bs)
in (FStar_Syntax_Util.arrow _0_478 c))
in (rebuild cfg env stack t)))
end))
end)
end
...
in (let _0_479 = (mk (FStar_Syntax_Syntax.Tm_ascribed (((t1), (tc), (l)))) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack _0_479)));
))
end)
end
| FStar_Syntax_Syntax.Tm_match (head, branches) -> begin
...
let env = (let _0_481 = Clos ((let _0_480 = (FStar_Util.mk_ref None)
in ((env), (lb.FStar_Syntax_Syntax.lbdef), (_0_480), (false))))
in (_0_481)::env)
...
let uu____4891 = (let _0_484 = (let _0_483 = (let _0_482 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.left)
in (FStar_All.pipe_right _0_482 FStar_Syntax_Syntax.mk_binder))
in (_0_483)::[])
in (FStar_Syntax_Subst.open_term _0_484 body))
...
let uu___169_4899 = lb
in (let _0_490 = (let _0_487 = (let _0_485 = (FStar_List.hd bs)
in (FStar_All.pipe_right _0_485 Prims.fst))
in (FStar_All.pipe_right _0_487 (fun _0_486 -> FStar_Util.Inl (_0_486))))
in (let _0_489 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_488 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _0_490; FStar_Syntax_Syntax.lbunivs = uu___169_4899.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _0_489; FStar_Syntax_Syntax.lbeff = uu___169_4899.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _0_488}))))
in (
...
(let _0_491 = (closure_as_term cfg env t)
...
let uu___170_5002 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = uu___170_5002.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = uu___170_5002.FStar_Syntax_Syntax.sort}))
in (
...
let body_env = (FStar_List.fold_right (fun lb env -> (let _0_493 = Clos ((let _0_492 = (FStar_Util.mk_ref None)
in ((rec_env), (lb.FStar_Syntax_Syntax.lbdef), (_0_492), (false))))
in (_0_493)::env)) (Prims.snd lbs) env)
...
let uu___171_5167 = cfg
in {steps = (FStar_List.append ((NoDeltaSteps)::(Exclude (Zeta))::[]) cfg.steps); tcenv = uu___171_5167.tcenv; delta_level = (FStar_TypeChecker_Env.NoDelta)::[]})
...
let body = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_abs ((let _0_495 = (let _0_494 = (FStar_Syntax_Syntax.mk_binder x)
in (_0_494)::[])
in ((_0_495), (body), (None)))))) None body.FStar_Syntax_Syntax.pos)
in (
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_499 = (let _0_498 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_497 = (let _0_496 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_0_496)::[])
in (_0_498)::_0_497))
in ((bind), (_0_499)))))) None t.FStar_Syntax_Syntax.pos)
end
| uu____5251 -> begin
...
let reified = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_511 = (let _0_510 = (FStar_Syntax_Syntax.as_arg lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_509 = (let _0_508 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_507 = (let _0_506 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_505 = (let _0_504 = (FStar_Syntax_Syntax.as_arg head)
in (let _0_503 = (let _0_502 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_501 = (let _0_500 = (FStar_Syntax_Syntax.as_arg body)
in (_0_500)::[])
in (_0_502)::_0_501))
in (_0_504)::_0_503))
in (_0_506)::_0_505))
in (_0_508)::_0_507))
in (_0_510)::_0_509))
in ((bind_inst), (_0_511)))))) None t.FStar_Syntax_Syntax.pos)
in (let _0_512 = (FStar_List.tl stack)
in (norm cfg env _0_512 reified)))))))
end
...
| Some (x) when (let _0_513 = (FStar_Syntax_Syntax.lid_of_fv x)
in (FStar_TypeChecker_Env.is_action cfg.tcenv _0_513)) -> begin
(
...
let body = (let _0_516 = (let _0_515 = (let _0_514 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_0_514), (q)))
in (_0_515)::acc)
in (bind_on_lift es _0_516))
in (
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_520 = (let _0_519 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t')
in (let _0_518 = (let _0_517 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_0_517)::[])
in (_0_519)::_0_518))
in ((bind), (_0_520)))))) None e0.FStar_Syntax_Syntax.pos)
end
| uu____5512 -> begin
(failwith "NIY : Reification of indexed effects")
end))
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_532 = (let _0_531 = (FStar_Syntax_Syntax.as_arg t')
in (let _0_530 = (let _0_529 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_528 = (let _0_527 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_526 = (let _0_525 = (FStar_Syntax_Syntax.as_arg lifted_e0)
in (let _0_524 = (let _0_523 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_522 = (let _0_521 = (FStar_Syntax_Syntax.as_arg continuation)
in (_0_521)::[])
in (_0_523)::_0_522))
in (_0_525)::_0_524))
in (_0_527)::_0_526))
in (_0_529)::_0_528))
in (_0_531)::_0_530))
in ((bind_inst), (_0_532)))))) None e0.FStar_Syntax_Syntax.pos))))))
end
...
let binded_head = (let _0_534 = (let _0_533 = (FStar_Syntax_Syntax.as_arg head)
in (_0_533)::args)
in (bind_on_lift _0_534 []))
in (let _0_535 = (FStar_List.tl stack)
in (norm cfg env _0_535 binded_head)))))
end)))
end
...
| true -> begin
(let _0_537 = (FStar_List.tl stack)
in (let _0_536 = (reify_lift cfg.tcenv head m m' t)
in (norm cfg env _0_537 _0_536)))
end
| uu____5587 -> begin
(
...
let uu___172_5593 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::[]; tcenv = uu___172_5593.tcenv; delta_level = (FStar_TypeChecker_Env.Inlining)::(FStar_TypeChecker_Env.Eager_unfolding_only)::[]})
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_539 = (let _0_538 = (env.FStar_TypeChecker_Env.universe_of env t)
in (_0_538)::[])
in ((return_tm), (_0_539)))))) None e.FStar_Syntax_Syntax.pos)
end
| uu____5674 -> begin
(failwith "NIY : Reification of indexed effects")
end))
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_543 = (let _0_542 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_541 = (let _0_540 = (FStar_Syntax_Syntax.as_arg e)
in (_0_540)::[])
in (_0_542)::_0_541))
in ((return_inst), (_0_543)))))) None e.FStar_Syntax_Syntax.pos))
end)))
end
| uu____5688 -> begin
...
let uu___173_5739 = comp
in (let _0_547 = FStar_Syntax_Syntax.Total ((let _0_546 = (norm cfg env [] t)
in (let _0_545 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_0_546), (_0_545)))))
in {FStar_Syntax_Syntax.n = _0_547; FStar_Syntax_Syntax.tk = uu___173_5739.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___173_5739.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___173_5739.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(

let uu___174_5755 = comp
in (let _0_550 = FStar_Syntax_Syntax.GTotal ((let _0_549 = (norm cfg env [] t)
in (let _0_548 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_0_549), (_0_548)))))
in {FStar_Syntax_Syntax.n = _0_550; FStar_Syntax_Syntax.tk = uu___174_5755.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___174_5755.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___174_5755.FStar_Syntax_Syntax.vars}))
end
...
| (a, i) -> begin
(let _0_551 = (norm cfg env [] a)
in ((_0_551), (i)))
end)))))
in (

let flags = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___143_5798 -> (match (uu___143_5798) with
| FStar_Syntax_Syntax.DECREASES (t) -> begin
...
let uu___175_5803 = comp
in (let _0_555 = FStar_Syntax_Syntax.Comp ((

let uu___176_5806 = ct
in (let _0_554 = (FStar_List.map (norm_universe cfg env) ct.FStar_Syntax_Syntax.comp_univs)
in (let _0_553 = (norm cfg env [] ct.FStar_Syntax_Syntax.result_typ)
in (let _0_552 = (norm_args ct.FStar_Syntax_Syntax.effect_args)
in {FStar_Syntax_Syntax.comp_univs = _0_554; FStar_Syntax_Syntax.effect_name = uu___176_5806.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _0_553; FStar_Syntax_Syntax.effect_args = _0_552; FStar_Syntax_Syntax.flags = flags})))))
in {FStar_Syntax_Syntax.n = _0_555; FStar_Syntax_Syntax.tk = uu___175_5803.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___175_5803.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___175_5803.FStar_Syntax_Syntax.vars}))))
end)))
...
let uu___177_5818 = cfg
in {steps = (Eager_unfolding)::(UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::(AllowUnboundUniverses)::[]; tcenv = uu___177_5818.tcenv; delta_level = uu___177_5818.delta_level}) env [] t))
in (
...
let uu___178_5839 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (((t), (uopt))); FStar_Syntax_Syntax.tk = uu___178_5839.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___178_5839.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___178_5839.FStar_Syntax_Syntax.vars})
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(
...
let uu___179_5854 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___179_5854.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = pure_eff; FStar_Syntax_Syntax.result_typ = uu___179_5854.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___179_5854.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___179_5854.FStar_Syntax_Syntax.flags})
end
| None -> begin
(
...
let uu___180_5856 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___180_5856.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.result_typ = uu___180_5856.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___180_5856.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___180_5856.FStar_Syntax_Syntax.flags}))
end)
in (

let uu___181_5857 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (ct); FStar_Syntax_Syntax.tk = uu___181_5857.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___181_5857.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___181_5857.FStar_Syntax_Syntax.vars}))
end
| uu____5862 -> begin
c
end)))
...
let uu___182_5869 = x
in (let _0_556 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___182_5869.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___182_5869.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_556}))
in ((_0_557), (imp)))
end))
...
| true -> begin
Some (FStar_Util.Inl ((FStar_Syntax_Util.lcomp_of_comp (let _0_558 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.comp_set_flags _0_558 flags)))))
end
| uu____5925 -> begin
Some (FStar_Util.Inl ((FStar_Syntax_Util.lcomp_of_comp (let _0_559 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.comp_set_flags _0_559 flags)))))
end)))
end
| uu____5928 -> begin
Some (FStar_Util.Inr (((lc.FStar_Syntax_Syntax.eff_name), (flags))))
...
| true -> begin
(let _0_561 = (FStar_Syntax_Print.term_to_string tm)
in (let _0_560 = (FStar_Syntax_Print.term_to_string t)
...
let uu___183_5958 = cfg
in {steps = s; tcenv = uu___183_5958.tcenv; delta_level = dl}) env stack t)
end
...
| (MemoLazy (r))::stack -> begin
((set_memo r ((env), (t)));
(log cfg (fun uu____5978 -> (let _0_562 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print1 "\tSet memo %s\n" _0_562))));
(rebuild cfg env stack t);
)
end
...
let uu___184_6015 = (FStar_Syntax_Util.abs bs t lopt)
in {FStar_Syntax_Syntax.n = uu___184_6015.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___184_6015.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___184_6015.FStar_Syntax_Syntax.vars})
in (rebuild cfg env stack _0_563))))
end
...
((log cfg (fun uu____6053 -> (let _0_564 = (FStar_Syntax_Print.term_to_string tm)
...
in (let _0_565 = (maybe_simplify cfg.steps t)
in (rebuild cfg env stack _0_565)))
end
| (Match (env, branches, r))::stack -> begin
((log cfg (fun uu____6118 -> (let _0_566 = (FStar_Syntax_Print.term_to_string t)
...
let new_delta = (FStar_All.pipe_right cfg.delta_level (FStar_List.filter (fun uu___144_6130 -> (match (uu___144_6130) with
| (FStar_TypeChecker_Env.Inlining) | (FStar_TypeChecker_Env.Eager_unfolding_only) -> begin
true
end
| uu____6131 -> begin
...
let uu___185_6137 = cfg
in {steps = (FStar_List.append steps' cfg.steps); tcenv = uu___185_6137.tcenv; delta_level = new_delta})))
in (
...
let uu___186_6233 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd)::tl); FStar_Syntax_Syntax.ty = uu___186_6233.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___186_6233.FStar_Syntax_Syntax.p})), (env')))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
...
let uu___187_6416 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats)))); FStar_Syntax_Syntax.ty = uu___187_6416.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___187_6416.FStar_Syntax_Syntax.p})), (env))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
let uu___188_6430 = x
in (let _0_567 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___188_6430.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___188_6430.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_567}))
in (((

let uu___189_6434 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = uu___189_6434.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___189_6434.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu___190_6439 = x
in (let _0_568 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___190_6439.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___190_6439.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_568}))
in (((

let uu___191_6443 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = uu___191_6443.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___191_6443.FStar_Syntax_Syntax.p})), ((Dummy)::env)))
end
| FStar_Syntax_Syntax.Pat_dot_term (x, t) -> begin
(
...
let uu___192_6453 = x
in (let _0_569 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___192_6453.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___192_6453.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_569}))
in (
...
let uu___193_6458 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x), (t))); FStar_Syntax_Syntax.ty = uu___193_6458.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___193_6458.FStar_Syntax_Syntax.p})), (env))))
end))
in (
...
in (let _0_570 = (mk (FStar_Syntax_Syntax.Tm_match (((scrutinee), (branches)))) r)
in (rebuild cfg env stack _0_570))))))))
in (
...
| FStar_Util.Inl (s) -> begin
((log cfg (fun uu____6909 -> (let _0_573 = (FStar_Syntax_Print.pat_to_string p)
in (let _0_572 = (let _0_571 = (FStar_List.map FStar_Syntax_Print.term_to_string s)
in (FStar_All.pipe_right _0_571 (FStar_String.concat "; ")))
in (FStar_Util.print2 "Matches pattern %s with subst = %s\n" _0_573 _0_572)))));
(

let env = (FStar_List.fold_left (fun env t -> (let _0_575 = Clos ((let _0_574 = (FStar_Util.mk_ref (Some ((([]), (t)))))
in (([]), (t), (_0_574), (false))))
in (_0_575)::env)) env s)
in (let _0_576 = (guard_when_clause wopt b rest)
in (norm cfg env stack _0_576)));
)
end))
end))
in (
...
let d = (FStar_All.pipe_right s (FStar_List.collect (fun uu___145_6947 -> (match (uu___145_6947) with
| UnfoldUntil (k) -> begin
...
let normalize : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun s e t -> (let _0_577 = (config s e)
in (norm _0_577 [] [] t)))


let normalize_comp : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun s e t -> (let _0_578 = (config s e)
in (norm_comp _0_578 [] t)))


let normalize_universe : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.universe  ->  FStar_Syntax_Syntax.universe = (fun env u -> (let _0_579 = (config [] env)
in (norm_universe _0_579 [] u)))


let ghost_to_pure : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun env c -> (let _0_580 = (config [] env)
in (ghost_to_pure_aux _0_580 [] c)))
...
let uu___194_6999 = lc
in {FStar_Syntax_Syntax.eff_name = pure_eff; FStar_Syntax_Syntax.res_typ = uu___194_6999.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___194_6999.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____7000 -> (let _0_581 = (lc.FStar_Syntax_Syntax.comp ())
in (ghost_to_pure env _0_581)))})
end
| None -> begin
lc
end)
...
let comp_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  Prims.string = (fun env c -> (FStar_Syntax_Print.comp_to_string (let _0_582 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp _0_582 [] c))))
...
(let _0_584 = FStar_Syntax_Syntax.Tm_refine ((let _0_583 = (FStar_Syntax_Util.mk_conj phi1 phi)
in ((y), (_0_583))))
in (mk _0_584 t0.FStar_Syntax_Syntax.pos))
end
| uu____7052 -> begin
t
end))
...
| (binders, args) -> begin
(let _0_589 = ((FStar_Syntax_Syntax.mk_Tm_app t args) None t.FStar_Syntax_Syntax.pos)
in (let _0_588 = (let _0_587 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _0_585 -> FStar_Util.Inl (_0_585)))
in (FStar_All.pipe_right _0_587 (fun _0_586 -> Some (_0_586))))
in (FStar_Syntax_Util.abs binders _0_589 _0_588)))
end))
end)
end)))
...
let uu____7150 = (let _0_590 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in ((_0_590), (t.FStar_Syntax_Syntax.n)))
in (match (uu____7150) with
| (Some (sort), uu____7159) -> begin
(let _0_591 = (mk sort t.FStar_Syntax_Syntax.pos)
in (eta_expand_with_type t _0_591))
end
...
let uu___195_7245 = env
in {FStar_TypeChecker_Env.solver = uu___195_7245.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___195_7245.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___195_7245.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___195_7245.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___195_7245.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___195_7245.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = uu___195_7245.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___195_7245.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___195_7245.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___195_7245.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___195_7245.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___195_7245.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___195_7245.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___195_7245.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___195_7245.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___195_7245.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___195_7245.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___195_7245.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___195_7245.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___195_7245.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___195_7245.FStar_TypeChecker_Env.qname_and_index}) t)
...
let uu___196_7254 = env
in {FStar_TypeChecker_Env.solver = uu___196_7254.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___196_7254.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___196_7254.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___196_7254.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___196_7254.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___196_7254.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = uu___196_7254.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___196_7254.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___196_7254.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___196_7254.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___196_7254.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___196_7254.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___196_7254.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___196_7254.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___196_7254.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___196_7254.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___196_7254.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___196_7254.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___196_7254.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___196_7254.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___196_7254.FStar_TypeChecker_Env.qname_and_index}) t)
