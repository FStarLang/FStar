                          ...
                          | uu____5658::[] ->
                              (match lopt with
                               | None  when FStar_Options.__unit_tests () ->
                                   (log cfg
                                      (fun uu____5671  ->
                                         let uu____5672 = closure_to_string c
                                            in
                               ...
                               | Some (FStar_Util.Inr (l,cflags)) when
                                   ...
                                   (log cfg
                                      (fun uu____5689  ->
                                         let uu____5690 = closure_to_string c
                                            in
                                         FStar_Util.print1 "\tShifted %s\n"
                                           uu____5690);
                                    norm cfg (c :: env) stack_rest body)
                               | Some (FStar_Util.Inl lc) when
                                   ...
                                   (log cfg
                                      (fun uu____5701  ->
                                         let uu____5702 = closure_to_string c
                                            in
                                         FStar_Util.print1 "\tShifted %s\n"
                                           uu____5702);
                                    norm cfg (c :: env) stack_rest body)
                ...
                | (Debug _)::_
                  |(Meta _)::_|(Let _)::_|(App _)::_|(Abs _)::_|[] ->
                    ...
                    then
                      ...
                      (let uu____5782 = FStar_Syntax_Subst.open_term' bs body
                          in
           ...
           | FStar_Syntax_Syntax.Tm_refine (x,f) ->
               ...
               then
                 ...
                 (let t_x = norm cfg env [] x.FStar_Syntax_Syntax.sort  in
                  let uu____5982 = FStar_Syntax_Subst.open_term [(x, None)] f
                     in
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                    ...
                    then
                      ...
                      (let uu____6567 =
                         let uu____6568 = FStar_Syntax_Subst.compress head1
                            in
                       ...
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____6582 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                           ...
                                           let uu____6610 =
                                             let uu____6611 =
                                               FStar_Syntax_Subst.compress e1
                                                in
                                             uu____6611.FStar_Syntax_Syntax.n
                                              in
                                               ...
                                               let uu____6751 =
                                                 let uu____6752 =
                                                   FStar_Syntax_Subst.compress
                                                     bind_repr
                                                    in
                                                 uu____6752.FStar_Syntax_Syntax.n
                                                  in
                       ...
                       | FStar_Syntax_Syntax.Tm_app (head_app,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____6860 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                ...
                                ((let is_arg_impure uu____6932 =
                                    ...
                                    | (e,q) ->
                                        let uu____6937 =
                                          let uu____6938 =
                                            FStar_Syntax_Subst.compress e  in
                                          uu____6938.FStar_Syntax_Syntax.n
                                           in
                                              ...
                                              (FStar_Syntax_Syntax.Tm_meta
                                                 (body,
                                                   (FStar_Syntax_Syntax.Meta_monadic
                                                      (m1, t2))))
                                        | Some (true ) -> body  in
                                      let uu____7000 = FStar_List.tl stack1
                                         in
        ...
        fun mtgt  ->
          fun t  ->
            ...
            then
              ...
              (let uu____7326 = FStar_TypeChecker_Env.monad_leq env msrc mtgt
                  in
        ...
        | FStar_Syntax_Syntax.Comp ct ->
            ...
            let uu____7505 =
              let uu____7506 =
                ...
                let uu____7512 = norm_args ct.FStar_Syntax_Syntax.effect_args
                   in
                {
              ...
              (log cfg
               ...
               (let scrutinee = t  in
                  ...
                  (let whnf = FStar_List.contains WHNF cfg.steps  in
                             ...
                             (FStar_List.fold_left
                                (fun uu____8054  ->
                                   fun uu____8055  ->
                                     ...
                                     | ((pats1,env3),(p1,b)) ->
                                         let uu____8120 = norm_pat env3 p1
                                            in
                   ...
                   let uu____8291 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r
                      in
                   rebuild cfg env1 stack2 uu____8291)
                   in
                ...
                let rec matches_pat scrutinee1 p =
                  ...
                  let uu____8411 = FStar_Syntax_Util.head_and_args scrutinee2
                     in
                      ...
                      (match uu____8602 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____8616 -> FStar_Util.Inr false
                 in
                                 ...
                                 (fun env2  ->
                                    fun t1  ->
                                      let uu____8709 =
                                        ...
                                        Clos uu____8710  in
                                      uu____8709 :: env2) env1 s
                                in
                             let uu____8743 = guard_when_clause wopt b rest
                                in
                             norm cfg env2 stack2 uu____8743)))
                   in
                let uu____8744 =
                  FStar_All.pipe_right cfg.steps
...
let normalize_universe :
  ...
  fun env  ->
    fun u  ->
      let uu____8811 = config [] env  in norm_universe uu____8811 [] u
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____8898 =
                     let uu____8899 =
                       let uu____8904 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____8904)  in
                             ...
                             let uu____8999 =
                               let uu____9006 =
                                 FStar_All.pipe_right
                                   ...
                                   (fun _0_34  -> FStar_Util.Inl _0_34)
                                  in
           ...
           | (head1,args) ->
               ...
               (match uu____9090 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____9094,thead) ->
                    let uu____9108 = FStar_Syntax_Util.arrow_formals thead
                       in
