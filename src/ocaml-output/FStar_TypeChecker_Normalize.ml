                         ...
                         | (pat1,env2) ->
                             let w_opt1 =
                               ...
                               | FStar_Pervasives_Native.Some w ->
                                   ...
                                   FStar_Pervasives_Native.Some uu____2153
                                in
...
let built_in_primitive_steps : primitive_step Prims.list =
  ...
  let arg_as_bounded_int uu____2574 =
    ...
    | (a,uu____2581) ->
        ...
        (match uu____2585 with
         ...
         | uu____2633 -> FStar_Pervasives_Native.None)
     in
  ...
  let arg_as_string uu____2682 =
    ...
    | (a,uu____2687) ->
        ...
        (match uu____2689 with
         ...
         | uu____2698 -> FStar_Pervasives_Native.None)
     in
  ...
  let unary_op as_a f r args =
    let uu____2898 = FStar_List.map as_a args  in lift_unary (f r) uu____2898
     in
  let binary_op as_a f r args =
    let uu____2948 = FStar_List.map as_a args  in
    lift_binary (f r) uu____2948  in
  ...
  let unary_int_op f =
    unary_op arg_as_int
      (fun r  -> fun x  -> let uu____3006 = f x  in int_as_const r uu____3006)
     in
  let binary_int_op f =
    binary_op arg_as_int
      (fun r  ->
         fun x  ->
           fun y  -> let uu____3033 = f x y  in int_as_const r uu____3033)
     in
  let unary_bool_op f =
    unary_op arg_as_bool
      (fun r  ->
         fun x  -> let uu____3053 = f x  in bool_as_const r uu____3053)
     in
  let binary_bool_op f =
    binary_op arg_as_bool
      (fun r  ->
         fun x  ->
           fun y  -> let uu____3080 = f x y  in bool_as_const r uu____3080)
     in
  let binary_string_op f =
    binary_op arg_as_string
      (fun r  ->
         fun x  ->
           fun y  -> let uu____3107 = f x y  in string_as_const r uu____3107)
     in
        ...
        let uu____3339 =
          let uu____3349 =
                                    ...
                                    let uu____3479 =
                                      let uu____3489 =
                                        ...
                                        (FStar_Parser_Const.op_notEq,
                                          (Prims.parse_int "3"),
                                          (decidable_eq true)) :: uu____3499
                                         in
                                      (FStar_Parser_Const.op_Eq,
                                        (Prims.parse_int "3"),
                                        (decidable_eq false)) :: uu____3489
                                       in
            ...
            (FStar_Parser_Const.op_Division, (Prims.parse_int "2"),
              (binary_int_op (fun x  -> fun y  -> x / y))) :: uu____3359
             in
          (FStar_Parser_Const.op_Multiply, (Prims.parse_int "2"),
            (binary_int_op (fun x  -> fun y  -> x * y))) :: uu____3349
           in
        (FStar_Parser_Const.op_Subtraction, (Prims.parse_int "2"),
          (binary_int_op (fun x  -> fun y  -> x - y))) :: uu____3339
         in
      (FStar_Parser_Const.op_Addition, (Prims.parse_int "2"),
        (binary_int_op (fun x  -> fun y  -> x + y))) :: uu____3329
       in
    (FStar_Parser_Const.op_Minus, (Prims.parse_int "1"),
      (unary_int_op (fun x  -> - x))) :: uu____3319
     in
            ...
            (fun uu____6589  ->
               ...
               let uu____6592 =
                 let uu____6593 =
                   ...
                   FStar_All.pipe_left FStar_Pervasives_Native.fst uu____6595
                    in
                                           ...
                                           let uu____8587 =
                                             let uu____8588 =
                                               FStar_Syntax_Subst.compress e1
                                                in
                                             uu____8588.FStar_Syntax_Syntax.n
                                              in
                                               ...
                                               let uu____8712 =
                                                 let uu____8713 =
                                                   FStar_Syntax_Subst.compress
                                                     bind_repr
                                                    in
                                                 uu____8713.FStar_Syntax_Syntax.n
                                                  in
                                ...
                                ((let is_arg_impure uu____8893 =
                                    ...
                                    | (e,q) ->
                                        let uu____8898 =
                                          let uu____8899 =
                                            FStar_Syntax_Subst.compress e  in
                                          uu____8899.FStar_Syntax_Syntax.n
                                           in
                  ...
                  (let whnf = FStar_List.contains WHNF cfg.steps  in
                   ...
                   let uu____10143 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r
                      in
                   rebuild cfg env1 stack2 uu____10143)
                   in
                      ...
                      (match uu____10397 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____10411 -> FStar_Util.Inr false
                 in
                                 ...
                                 (fun env2  ->
                                    fun t1  ->
                                      let uu____10510 =
                                        ...
                                        Clos uu____10511  in
                                      uu____10510 :: env2) env1 s
                                in
                             let uu____10544 = guard_when_clause wopt b rest
                                in
                             norm cfg env2 stack2 uu____10544)))
                   in
                let uu____10545 =
                  FStar_All.pipe_right cfg.steps
                ...
                | uu____11119 ->
                    ...
                    (match uu____11120 with
                     ...
                     | (uu____11192,FStar_Util.Inl uu____11193) ->
                         ([], (FStar_Util.Inl t3))
                     | uu____11207 -> failwith "Impossible")
                 in
    ...
    fun s  ->
           ...
           | (univ_names1,binders1,typ1) ->
               let uu___221_11420 = s  in
               {
                 ...
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___221_11420.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_bundle (sigs,lids) ->
            ...
            FStar_Syntax_Syntax.Sig_bundle uu____11434  in
          {
            ...
            FStar_Syntax_Syntax.sigattrs =
              (uu___222_11432.FStar_Syntax_Syntax.sigattrs)
          }
          ...
          (match uu____11451 with
           | (univ_names1,uu____11461,typ1) ->
               let uu___223_11469 = s  in
               {
                 ...
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___223_11469.FStar_Syntax_Syntax.sigattrs)
               })
          ...
          (match uu____11474 with
           | (univ_names1,uu____11484,typ1) ->
               let uu___224_11492 = s  in
               {
                 ...
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___224_11492.FStar_Syntax_Syntax.sigattrs)
               })
                    ...
                    | (opening,lbunivs) ->
                        let elim t =
                          let uu____11531 =
                            ...
                            remove_uvar_solutions env uu____11532  in
                          FStar_Syntax_Subst.close_univ_vars lbunivs
                            uu____11531
                           in
                        let lbtyp = elim lb.FStar_Syntax_Syntax.lbtyp  in
                        let lbdef = elim lb.FStar_Syntax_Syntax.lbdef  in
                        let uu___225_11535 = lb  in
                        {
                          FStar_Syntax_Syntax.lbname =
                            (uu___225_11535.FStar_Syntax_Syntax.lbname);
                          FStar_Syntax_Syntax.lbunivs = lbunivs;
                          FStar_Syntax_Syntax.lbtyp = lbtyp;
                          FStar_Syntax_Syntax.lbeff =
                            (uu___225_11535.FStar_Syntax_Syntax.lbeff);
                          FStar_Syntax_Syntax.lbdef = lbdef
                        }))
             in
          let uu___226_11536 = s  in
          {
            FStar_Syntax_Syntax.sigel =
              (FStar_Syntax_Syntax.Sig_let ((b, lbs1), lids));
            FStar_Syntax_Syntax.sigrng =
              (uu___226_11536.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___226_11536.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___226_11536.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___226_11536.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_main t ->
          let uu___227_11543 = s  in
          let uu____11544 =
            let uu____11545 = remove_uvar_solutions env t  in
            FStar_Syntax_Syntax.Sig_main uu____11545  in
          {
            FStar_Syntax_Syntax.sigel = uu____11544;
            FStar_Syntax_Syntax.sigrng =
              (uu___227_11543.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___227_11543.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___227_11543.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___227_11543.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_assume (l,us,t) ->
          let uu____11549 = elim_uvars_aux_t env us [] t  in
          (match uu____11549 with
           | (us1,uu____11559,t1) ->
               let uu___228_11567 = s  in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_assume (l, us1, t1));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___228_11567.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___228_11567.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___228_11567.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___228_11567.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____11568 ->
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____11570 with
           | (univs1,binders,signature) ->
               let uu____11586 =
                 let uu____11591 = FStar_Syntax_Subst.univ_var_opening univs1
                    in
                 match uu____11591 with
                 | (univs_opening,univs2) ->
                     let uu____11606 =
                       FStar_Syntax_Subst.univ_var_closing univs2  in
                     (univs_opening, uu____11606)
                  in
               (match uu____11586 with
                | (univs_opening,univs_closing) ->
                    let uu____11616 =
                      ...
                      (uu____11620, uu____11621)  in
                    (match uu____11616 with
                     | (b_opening,b_closing) ->
                         let n1 = FStar_List.length univs1  in
                         let n_binders = FStar_List.length binders  in
                         let elim_tscheme uu____11640 =
                                              ...
                                              let t2 =
                                                let uu____11705 =
                                                  FStar_Syntax_Subst.subst
                                                   ...
                                                   in
                                                FStar_Syntax_Subst.subst
                                                  univs_opening1 uu____11705
                                                 in
                                              let uu____11706 =
                                                elim_uvars_aux_t env [] [] t2
                                                 in
                                              (match uu____11706 with
                                               | (uu____11717,uu____11718,t3)
                                                   ->
                                                   let t4 =
                                                     let uu____11727 =
                                                       let uu____11728 =
                         ...
                         let elim_term t =
                           ...
                           | (uu____11740,uu____11741,t1) -> t1  in
                         let elim_action a =
                           ...
                           let destruct_action_body body =
                             ...
                             | FStar_Syntax_Syntax.Tm_ascribed
                                 ...
                                 -> (defn, typ)
                             | uu____11855 -> failwith "Impossible"  in
                           let destruct_action_typ_templ t =
                             ...
                             | FStar_Syntax_Syntax.Tm_abs
                                 (pars,body,uu____11892) ->
                                 let uu____11905 = destruct_action_body body
                                    in
                                 (match uu____11905 with
                                  | (defn,typ) -> (pars, defn, typ))
                             | uu____11939 ->
                                 let uu____11940 = destruct_action_body t  in
                           ...
                           | (action_univs,t) ->
                               let uu____11983 = destruct_action_typ_templ t
                                  in
                               (match uu____11983 with
                                | (action_params,action_defn,action_typ) ->
                                    let a' =
                                      let uu___229_12012 = a  in
                                      {
                                        FStar_Syntax_Syntax.action_name =
                                          (uu___229_12012.FStar_Syntax_Syntax.action_name);
                                        FStar_Syntax_Syntax.action_unqualified_name
                                          =
                                          (uu___229_12012.FStar_Syntax_Syntax.action_unqualified_name);
                         ...
                         let ed1 =
                              ...
                              in
                           {
                             FStar_Syntax_Syntax.cattributes =
                               (uu___230_12014.FStar_Syntax_Syntax.cattributes);
                             FStar_Syntax_Syntax.mname =
                               (uu___230_12014.FStar_Syntax_Syntax.mname);
                             FStar_Syntax_Syntax.univs = univs1;
                             FStar_Syntax_Syntax.binders = binders;
                             FStar_Syntax_Syntax.signature = signature;
                             FStar_Syntax_Syntax.ret_wp = uu____12015;
                             FStar_Syntax_Syntax.bind_wp = uu____12016;
                             FStar_Syntax_Syntax.if_then_else = uu____12017;
                             FStar_Syntax_Syntax.ite_wp = uu____12018;
                             FStar_Syntax_Syntax.stronger = uu____12019;
                             FStar_Syntax_Syntax.close_wp = uu____12020;
                             FStar_Syntax_Syntax.assert_p = uu____12021;
                             FStar_Syntax_Syntax.assume_p = uu____12022;
                             FStar_Syntax_Syntax.null_wp = uu____12023;
                             FStar_Syntax_Syntax.trivial = uu____12024;
                             FStar_Syntax_Syntax.repr = uu____12025;
                             FStar_Syntax_Syntax.return_repr = uu____12026;
                             FStar_Syntax_Syntax.bind_repr = uu____12027;
                             FStar_Syntax_Syntax.actions = uu____12028
                           }  in
                         let uu___231_12030 = s  in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_new_effect ed1);
                           FStar_Syntax_Syntax.sigrng =
                             (uu___231_12030.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             (uu___231_12030.FStar_Syntax_Syntax.sigquals);
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___231_12030.FStar_Syntax_Syntax.sigmeta);
                           FStar_Syntax_Syntax.sigattrs =
                             (uu___231_12030.FStar_Syntax_Syntax.sigattrs)
                         })))
      | FStar_Syntax_Syntax.Sig_sub_effect sub_eff ->
          let elim_tscheme_opt uu___150_12041 =
            match uu___150_12041 with
            | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
            | FStar_Pervasives_Native.Some (us,t) ->
                let uu____12056 = elim_uvars_aux_t env us [] t  in
                (match uu____12056 with
                 | (us1,uu____12069,t1) ->
                     FStar_Pervasives_Native.Some (us1, t1))
             in
          let sub_eff1 =
            let uu___232_12080 = sub_eff  in
            let uu____12081 =
              ...
              elim_tscheme_opt sub_eff.FStar_Syntax_Syntax.lift  in
            {
              FStar_Syntax_Syntax.source =
                (uu___232_12080.FStar_Syntax_Syntax.source);
              FStar_Syntax_Syntax.target =
                (uu___232_12080.FStar_Syntax_Syntax.target);
              FStar_Syntax_Syntax.lift_wp = uu____12081;
              FStar_Syntax_Syntax.lift = uu____12083
            }  in
          let uu___233_12085 = s  in
          {
            FStar_Syntax_Syntax.sigel =
              (FStar_Syntax_Syntax.Sig_sub_effect sub_eff1);
            FStar_Syntax_Syntax.sigrng =
              (uu___233_12085.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___233_12085.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___233_12085.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___233_12085.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_effect_abbrev
          (lid,univ_names,binders,comp,flags) ->
          let uu____12093 = elim_uvars_aux_c env univ_names binders comp  in
          (match uu____12093 with
           | (univ_names1,binders1,comp1) ->
               let uu___234_12115 = s  in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_effect_abbrev
                      (lid, univ_names1, binders1, comp1, flags));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___234_12115.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___234_12115.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___234_12115.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___234_12115.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_pragma uu____12122 -> s
