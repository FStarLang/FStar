...
(let _143_267 = (let _143_266 = (let _143_265 = (closure_as_term_delayed cfg env t')
in (_143_265, m))
in FStar_Syntax_Syntax.Tm_meta (_143_266))
in (mk _143_267 t.FStar_Syntax_Syntax.pos))
end
...
let env = (FStar_List.fold_left (fun env _59_274 -> (Dummy)::env) env lb.FStar_Syntax_Syntax.lbunivs)
in (
...
| FStar_Util.Inr (_59_280) -> begin
body
end
| FStar_Util.Inl (_59_283) -> begin
...
# 275 "FStar.TypeChecker.Normalize.fst"
let _59_286 = lb
in {FStar_Syntax_Syntax.lbname = _59_286.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _59_286.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = typ; FStar_Syntax_Syntax.lbeff = _59_286.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = def})
in (mk (FStar_Syntax_Syntax.Tm_let (((false, (lb)::[]), body))) t.FStar_Syntax_Syntax.pos)))))))
end
| FStar_Syntax_Syntax.Tm_let ((_59_290, lbs), body) -> begin
(
# 279 "FStar.TypeChecker.Normalize.fst"
let norm_one_lb = (fun env lb -> (
# 280 "FStar.TypeChecker.Normalize.fst"
let env_univs = (FStar_List.fold_right (fun _59_299 env -> (Dummy)::env) lb.FStar_Syntax_Syntax.lbunivs env)
in (
# 281 "FStar.TypeChecker.Normalize.fst"
let env = if (FStar_Syntax_Syntax.is_top_level lbs) then begin
env_univs
end else begin
(FStar_List.fold_right (fun _59_303 env -> (Dummy)::env) lbs env_univs)
end
in (
# 284 "FStar.TypeChecker.Normalize.fst"
let _59_307 = lb
in (let _143_279 = (closure_as_term cfg env_univs lb.FStar_Syntax_Syntax.lbtyp)
in (let _143_278 = (closure_as_term cfg env lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _59_307.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _59_307.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _143_279; FStar_Syntax_Syntax.lbeff = _59_307.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _143_278}))))))
in (
...
let body_env = (FStar_List.fold_right (fun _59_310 env -> (Dummy)::env) lbs env)
...
let norm_one_branch = (fun env _59_325 -> (match (_59_325) with
| (pat, w_opt, tm) -> begin
(
# 295 "FStar.TypeChecker.Normalize.fst"
let rec norm_pat = (fun env p -> (match (p.FStar_Syntax_Syntax.v) with
| FStar_Syntax_Syntax.Pat_constant (_59_330) -> begin
(p, env)
end
...
let _59_340 = (norm_pat env hd)
in (match (_59_340) with
| (hd, env') -> begin
(
# 300 "FStar.TypeChecker.Normalize.fst"
let tl = (FStar_All.pipe_right tl (FStar_List.map (fun p -> (let _143_291 = (norm_pat env p)
in (Prims.fst _143_291)))))
in ((
# 301 "FStar.TypeChecker.Normalize.fst"
let _59_343 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd)::tl); FStar_Syntax_Syntax.ty = _59_343.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _59_343.FStar_Syntax_Syntax.p}), env'))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(
# 303 "FStar.TypeChecker.Normalize.fst"
let _59_360 = (FStar_All.pipe_right pats (FStar_List.fold_left (fun _59_351 _59_354 -> (match ((_59_351, _59_354)) with
| ((pats, env), (p, b)) -> begin
(
# 304 "FStar.TypeChecker.Normalize.fst"
let _59_357 = (norm_pat env p)
...
let _59_361 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons ((fv, (FStar_List.rev pats))); FStar_Syntax_Syntax.ty = _59_361.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _59_361.FStar_Syntax_Syntax.p}), env)
end))
end
...
# 308 "FStar.TypeChecker.Normalize.fst"
let _59_365 = x
in (let _143_294 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _59_365.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _59_365.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _143_294}))
in ((
# 309 "FStar.TypeChecker.Normalize.fst"
let _59_368 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x); FStar_Syntax_Syntax.ty = _59_368.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _59_368.FStar_Syntax_Syntax.p}), (Dummy)::env))
end
...
# 311 "FStar.TypeChecker.Normalize.fst"
let _59_372 = x
in (let _143_295 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _59_372.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _59_372.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _143_295}))
in ((
# 312 "FStar.TypeChecker.Normalize.fst"
let _59_375 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x); FStar_Syntax_Syntax.ty = _59_375.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _59_375.FStar_Syntax_Syntax.p}), (Dummy)::env))
end
...
# 314 "FStar.TypeChecker.Normalize.fst"
let _59_381 = x
in (let _143_296 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _59_381.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _59_381.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _143_296}))
in (
...
let _59_385 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term ((x, t)); FStar_Syntax_Syntax.ty = _59_385.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _59_385.FStar_Syntax_Syntax.p}), env)))
end))
in (
# 317 "FStar.TypeChecker.Normalize.fst"
let _59_389 = (norm_pat env pat)
in (match (_59_389) with
| (pat, env) -> begin
(
...
| Some (w) -> begin
(let _143_297 = (closure_as_term cfg env w)
in Some (_143_297))
end)
in (
...
in (let _143_300 = (let _143_299 = (let _143_298 = (FStar_All.pipe_right branches (FStar_List.map (norm_one_branch env)))
in (head, _143_298))
in FStar_Syntax_Syntax.Tm_match (_143_299))
in (mk _143_300 t.FStar_Syntax_Syntax.pos))))
end))
end)))
...
| _59_399 when (FStar_All.pipe_right cfg.steps (FStar_List.contains BetaUVars)) -> begin
...
| _59_408 -> begin
(FStar_List.map (fun _59_411 -> (match (_59_411) with
| (x, imp) -> begin
(let _143_308 = (closure_as_term_delayed cfg env x)
in (_143_308, imp))
end)) args)
end))
...
let _59_427 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun _59_417 _59_420 -> (match ((_59_417, _59_420)) with
| ((env, out), (b, imp)) -> begin
(
...
# 339 "FStar.TypeChecker.Normalize.fst"
let _59_421 = b
in (let _143_314 = (closure_as_term_delayed cfg env b.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _59_421.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _59_421.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _143_314}))
in (
...
(let _143_318 = (closure_as_term_delayed cfg env t)
in (FStar_Syntax_Syntax.mk_Total _143_318))
end
| FStar_Syntax_Syntax.GTotal (t) -> begin
(let _143_319 = (closure_as_term_delayed cfg env t)
in (FStar_Syntax_Syntax.mk_GTotal _143_319))
end
...
(let _143_321 = (closure_as_term_delayed cfg env t)
in FStar_Syntax_Syntax.DECREASES (_143_321))
end
| f -> begin
f
end))))
...
let _59_447 = c
in {FStar_Syntax_Syntax.effect_name = _59_447.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = rt; FStar_Syntax_Syntax.effect_args = args; FStar_Syntax_Syntax.flags = flags})))))
end)
end))
...
let _59_455 = lc
in (let _143_327 = (closure_as_term_delayed cfg env lc.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = _59_455.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _143_327; FStar_Syntax_Syntax.cflags = _59_455.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _59_457 -> (match (()) with
| () -> begin
(let _143_326 = (lc.FStar_Syntax_Syntax.comp ())
in (close_comp cfg env _143_326))
end))}))
in Some (_143_328))
end))
...
# 371 "FStar.TypeChecker.Normalize.fst"
let _59_462 = t
in {FStar_Syntax_Syntax.n = _59_462.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _59_462.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = tm.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _59_462.FStar_Syntax_Syntax.vars}))
in (
...
| (Some (true), _59_619)::(_59_610, (arg, _59_613))::[] -> begin
arg
end
| _59_623 -> begin
tm
...
(match ((FStar_All.pipe_right args (FStar_List.map simplify))) with
| (Some (true), _59_627)::[] -> begin
(w FStar_Syntax_Util.t_false)
end
| (Some (false), _59_633)::[] -> begin
(w FStar_Syntax_Util.t_true)
end
| _59_637 -> begin
tm
...
(match ((let _143_339 = (FStar_Syntax_Subst.compress t)
in _143_339.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_abs (_59_655::[], body, _59_659) -> begin
...
let _59_680 = (log cfg (fun _59_679 -> (match (()) with
| () -> begin
(let _143_366 = (FStar_Syntax_Print.tag_of_term t)
in (let _143_365 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print2 ">>> %s\nNorm %s\n" _143_366 _143_365)))
end)))
in (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (_59_683) -> begin
(FStar_All.failwith "Impossible")
end
...
in (let _143_370 = (mk (FStar_Syntax_Syntax.Tm_type (u)) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack _143_370)))
end
| FStar_Syntax_Syntax.Tm_uinst (t', us) -> begin
...
let us = (let _143_372 = (let _143_371 = (FStar_List.map (norm_universe cfg env) us)
in (_143_371, t.FStar_Syntax_Syntax.pos))
in UnivArgs (_143_372))
in (
...
(match (stack) with
| UnivArgs (us', _59_744)::stack -> begin
(
# 474 "FStar.TypeChecker.Normalize.fst"
let env = (FStar_All.pipe_right us' (FStar_List.fold_left (fun env u -> (Univ (u))::env) env))
in (norm cfg env stack t))
end
| _59_752 when (FStar_All.pipe_right cfg.steps (FStar_List.contains EraseUniverses)) -> begin
(norm cfg env stack t)
end
| _59_754 -> begin
(let _143_376 = (let _143_375 = (FStar_Syntax_Print.lid_to_string f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_Util.format1 "Impossible: missing universe instantiation on %s" _143_375))
in (FStar_All.failwith _143_376))
end)
end else begin
(norm cfg env stack t)
end)
...
let _59_771 = (log cfg (fun _59_770 -> (match (()) with
| () -> begin
(let _143_379 = (FStar_Syntax_Print.term_to_string t)
in (let _143_378 = (FStar_Syntax_Print.term_to_string t')
in (FStar_Util.print2 "Lazy hit: %s cached to %s\n" _143_379 _143_378)))
end)))
in (match ((let _143_380 = (FStar_Syntax_Subst.compress t')
in _143_380.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_abs (_59_774) -> begin
(norm cfg env stack t')
end
| _59_777 -> begin
(rebuild cfg env stack t')
...
let _59_826 = (log cfg (fun _59_825 -> (match (()) with
| () -> begin
(let _143_382 = (closure_to_string c)
...
let _59_832 = (set_memo r (env, t))
in (
# 527 "FStar.TypeChecker.Normalize.fst"
let _59_835 = (log cfg (fun _59_834 -> (match (()) with
| () -> begin
...
(let _143_384 = (closure_as_term cfg env t)
in (rebuild cfg env stack _143_384))
end else begin
(
# 535 "FStar.TypeChecker.Normalize.fst"
let _59_852 = (FStar_Syntax_Subst.open_term bs body)
in (match (_59_852) with
| (bs, body) -> begin
(
# 536 "FStar.TypeChecker.Normalize.fst"
let env' = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _59_854 -> (Dummy)::env) env))
in (
# 537 "FStar.TypeChecker.Normalize.fst"
let _59_858 = (log cfg (fun _59_857 -> (match (()) with
| () -> begin
(let _143_388 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
...
let stack = (FStar_All.pipe_right stack (FStar_List.fold_right (fun _59_866 stack -> (match (_59_866) with
| (a, aq) -> begin
(let _143_395 = (let _143_394 = (let _143_393 = (let _143_392 = (let _143_391 = (FStar_Util.mk_ref None)
in (env, a, _143_391))
in Clos (_143_392))
in (_143_393, aq, t.FStar_Syntax_Syntax.pos))
in Arg (_143_394))
in (_143_395)::stack)
end)) args))
in (
# 543 "FStar.TypeChecker.Normalize.fst"
let _59_870 = (log cfg (fun _59_869 -> (match (()) with
| () -> begin
(let _143_397 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
...
# 551 "FStar.TypeChecker.Normalize.fst"
let _59_880 = x
in {FStar_Syntax_Syntax.ppname = _59_880.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _59_880.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x}), f))) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack t)))
end
| _59_884 -> begin
(let _143_398 = (closure_as_term cfg env t)
in (rebuild cfg env stack _143_398))
end)
end else begin
(
...
let _59_888 = (FStar_Syntax_Subst.open_term (((x, None))::[]) f)
...
let t = (let _143_401 = (let _143_400 = (let _143_399 = (FStar_Syntax_Subst.close closing f)
in ((
# 557 "FStar.TypeChecker.Normalize.fst"
let _59_890 = x
in {FStar_Syntax_Syntax.ppname = _59_890.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _59_890.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x}), _143_399))
in FStar_Syntax_Syntax.Tm_refine (_143_400))
in (mk _143_401 t.FStar_Syntax_Syntax.pos))
in (rebuild cfg env stack t)))
end)))
end
end
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
if (FStar_List.contains WHNF cfg.steps) then begin
(let _143_402 = (closure_as_term cfg env t)
in (rebuild cfg env stack _143_402))
end else begin
(
# 563 "FStar.TypeChecker.Normalize.fst"
let _59_899 = (FStar_Syntax_Subst.open_comp bs c)
in (match (_59_899) with
| (bs, c) -> begin
(
# 564 "FStar.TypeChecker.Normalize.fst"
let c = (let _143_405 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env _59_901 -> (Dummy)::env) env))
in (norm_comp cfg _143_405 c))
in (
# 565 "FStar.TypeChecker.Normalize.fst"
let t = (let _143_406 = (norm_binders cfg env bs)
in (FStar_Syntax_Util.arrow _143_406 c))
in (rebuild cfg env stack t)))
end))
end
end
...
let _59_932 = (log cfg (fun _59_931 -> (match (()) with
| () -> begin
...
in (let _143_408 = (mk (FStar_Syntax_Syntax.Tm_ascribed ((t1, t2, l))) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack _143_408)))))
end)
end
| FStar_Syntax_Syntax.Tm_match (head, branches) -> begin
(
...
let env = (let _143_411 = (let _143_410 = (let _143_409 = (FStar_Util.mk_ref None)
in (env, lb.FStar_Syntax_Syntax.lbdef, _143_409))
in Clos (_143_410))
in (_143_411)::env)
in (norm cfg env stack body))
end
| FStar_Syntax_Syntax.Tm_let ((_59_949, {FStar_Syntax_Syntax.lbname = FStar_Util.Inr (_59_961); FStar_Syntax_Syntax.lbunivs = _59_959; FStar_Syntax_Syntax.lbtyp = _59_957; FStar_Syntax_Syntax.lbeff = _59_955; FStar_Syntax_Syntax.lbdef = _59_953}::_59_951), _59_967) -> begin
(rebuild cfg env stack t)
end
| FStar_Syntax_Syntax.Tm_let (lbs, body) -> begin
(
# 604 "FStar.TypeChecker.Normalize.fst"
let _59_989 = (FStar_List.fold_right (fun lb _59_978 -> (match (_59_978) with
| (rec_env, memos, i) -> begin
(
# 605 "FStar.TypeChecker.Normalize.fst"
let f_i = (let _143_414 = (
# 605 "FStar.TypeChecker.Normalize.fst"
let _59_979 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = _59_979.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = _59_979.FStar_Syntax_Syntax.sort})
in (FStar_Syntax_Syntax.bv_to_tm _143_414))
in (
...
| (rec_env, memos, _59_988) -> begin
(
# 610 "FStar.TypeChecker.Normalize.fst"
let _59_992 = (FStar_List.map2 (fun lb memo -> (FStar_ST.op_Colon_Equals memo (Some ((rec_env, lb.FStar_Syntax_Syntax.lbdef))))) (Prims.snd lbs) memos)
in (
# 611 "FStar.TypeChecker.Normalize.fst"
let body_env = (FStar_List.fold_right (fun lb env -> (let _143_421 = (let _143_420 = (let _143_419 = (FStar_Util.mk_ref None)
in (rec_env, lb.FStar_Syntax_Syntax.lbdef, _143_419))
in Clos (_143_420))
in (_143_421)::env)) (Prims.snd lbs) env)
in (norm cfg body_env stack body)))
end))
end
| FStar_Syntax_Syntax.Tm_meta (head, m) -> begin
(match (stack) with
| _59_1004::_59_1002 -> begin
(match (m) with
| FStar_Syntax_Syntax.Meta_labeled (l, r, _59_1009) -> begin
...
let m = (match (m) with
| FStar_Syntax_Syntax.Meta_pattern (args) -> begin
(let _143_422 = (norm_pattern_args cfg env args)
in FStar_Syntax_Syntax.Meta_pattern (_143_422))
end
| _59_1023 -> begin
m
end)
...
and norm_pattern_args : cfg  ->  env  ->  FStar_Syntax_Syntax.args Prims.list  ->  FStar_Syntax_Syntax.args Prims.list = (fun cfg env args -> (FStar_All.pipe_right args (FStar_List.map (FStar_List.map (fun _59_1031 -> (match (_59_1031) with
| (a, imp) -> begin
(let _143_427 = (norm cfg env [] a)
in (_143_427, imp))
end))))))
...
let _59_1037 = comp
in (let _143_432 = (let _143_431 = (norm cfg env [] t)
in FStar_Syntax_Syntax.Total (_143_431))
in {FStar_Syntax_Syntax.n = _143_432; FStar_Syntax_Syntax.tk = _59_1037.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _59_1037.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _59_1037.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t) -> begin
(
# 649 "FStar.TypeChecker.Normalize.fst"
let _59_1041 = comp
in (let _143_434 = (let _143_433 = (norm cfg env [] t)
in FStar_Syntax_Syntax.GTotal (_143_433))
in {FStar_Syntax_Syntax.n = _143_434; FStar_Syntax_Syntax.tk = _59_1041.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _59_1041.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _59_1041.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(
# 652 "FStar.TypeChecker.Normalize.fst"
let norm_args = (fun args -> (FStar_All.pipe_right args (FStar_List.map (fun _59_1049 -> (match (_59_1049) with
| (a, i) -> begin
(let _143_438 = (norm cfg env [] a)
in (_143_438, i))
end)))))
in (
# 653 "FStar.TypeChecker.Normalize.fst"
let _59_1050 = comp
in (let _143_442 = (let _143_441 = (
# 653 "FStar.TypeChecker.Normalize.fst"
let _59_1052 = ct
in (let _143_440 = (norm cfg env [] ct.FStar_Syntax_Syntax.result_typ)
in (let _143_439 = (norm_args ct.FStar_Syntax_Syntax.effect_args)
in {FStar_Syntax_Syntax.effect_name = _59_1052.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _143_440; FStar_Syntax_Syntax.effect_args = _143_439; FStar_Syntax_Syntax.flags = _59_1052.FStar_Syntax_Syntax.flags})))
in FStar_Syntax_Syntax.Comp (_143_441))
in {FStar_Syntax_Syntax.n = _143_442; FStar_Syntax_Syntax.tk = _59_1050.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = _59_1050.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = _59_1050.FStar_Syntax_Syntax.vars})))
end))
and norm_binder : cfg  ->  env  ->  FStar_Syntax_Syntax.binder  ->  FStar_Syntax_Syntax.binder = (fun cfg env _59_1058 -> (match (_59_1058) with
| (x, imp) -> begin
(let _143_447 = (
# 657 "FStar.TypeChecker.Normalize.fst"
let _59_1059 = x
in (let _143_446 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _59_1059.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _59_1059.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _143_446}))
in (_143_447, imp))
end))
and norm_binders : cfg  ->  env  ->  FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.binders = (fun cfg env bs -> (
# 661 "FStar.TypeChecker.Normalize.fst"
let _59_1072 = (FStar_List.fold_left (fun _59_1066 b -> (match (_59_1066) with
| (nbs', env) -> begin
(
...
let _59_1102 = (FStar_Syntax_Util.abs bs t lopt)
in {FStar_Syntax_Syntax.n = _59_1102.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = _59_1102.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = _59_1102.FStar_Syntax_Syntax.vars})
in (rebuild cfg env stack _143_457))))
end
...
let _59_1145 = (log cfg (fun _59_1144 -> (match (()) with
| () -> begin
(let _143_459 = (FStar_Syntax_Print.term_to_string tm)
...
in (let _143_460 = (maybe_simplify cfg.steps t)
in (rebuild cfg env stack _143_460)))
end
| Match (env, branches, r)::stack -> begin
(
# 717 "FStar.TypeChecker.Normalize.fst"
let norm_and_rebuild_match = (fun _59_1173 -> (match (()) with
| () -> begin
(
...
# 719 "FStar.TypeChecker.Normalize.fst"
let _59_1175 = cfg
in (let _143_463 = (FStar_TypeChecker_Env.glb_delta cfg.delta_level FStar_TypeChecker_Env.OnlyInline)
in {steps = _59_1175.steps; tcenv = _59_1175.tcenv; delta_level = _143_463}))
in (
...
let _59_1188 = (FStar_Syntax_Subst.open_branch branch)
in (match (_59_1188) with
| (p, wopt, e) -> begin
(
# 729 "FStar.TypeChecker.Normalize.fst"
let env = (let _143_471 = (FStar_Syntax_Syntax.pat_bvs p)
in (FStar_All.pipe_right _143_471 (FStar_List.fold_left (fun env x -> (Dummy)::env) env)))
in (
...
| Some (w) -> begin
(let _143_472 = (norm_or_whnf env w)
in Some (_143_472))
end)
in (
...
in (let _143_473 = (mk (FStar_Syntax_Syntax.Tm_match ((t, branches))) r)
in (rebuild cfg env stack _143_473))))))
end))
in (
# 738 "FStar.TypeChecker.Normalize.fst"
let rec is_cons = (fun head -> (match (head.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_uinst (h, _59_1202) -> begin
(is_cons h)
end
...
let _59_1244 = (FStar_Syntax_Util.head_and_args t)
...
| FStar_Syntax_Syntax.Pat_dot_term (_59_1267) -> begin
FStar_Util.Inl ([])
end
...
| _59_1274 -> begin
(let _143_490 = (not ((is_cons head)))
in FStar_Util.Inr (_143_490))
end)
end
...
| _59_1282 -> begin
(let _143_491 = (not ((is_cons head)))
in FStar_Util.Inr (_143_491))
end)
end)
end))))
...
| ((t, _59_1292)::rest_a, (p, _59_1298)::rest_p) -> begin
...
let env = (FStar_List.fold_right (fun t env -> (let _143_503 = (let _143_502 = (let _143_501 = (FStar_Util.mk_ref (Some (([], t))))
in ([], t, _143_501))
in Clos (_143_502))
in (_143_503)::env)) s env)
in (let _143_504 = (guard_when_clause wopt b rest)
in (norm cfg env stack _143_504)))
end)
end))
...
let normalize : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun s e t -> (let _143_516 = (config s e)
in (norm _143_516 [] [] t)))

# 823 "FStar.TypeChecker.Normalize.fst"
let normalize_comp : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun s e t -> (let _143_523 = (config s e)
in (norm_comp _143_523 [] t)))

# 824 "FStar.TypeChecker.Normalize.fst"
let normalize_universe : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.universe  ->  FStar_Syntax_Syntax.universe = (fun env u -> (let _143_528 = (config [] env)
in (norm_universe _143_528 [] u)))

# 826 "FStar.TypeChecker.Normalize.fst"
let term_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  Prims.string = (fun env t -> (let _143_533 = (normalize ((AllowUnboundUniverses)::[]) env t)
in (FStar_Syntax_Print.term_to_string _143_533)))

# 827 "FStar.TypeChecker.Normalize.fst"
let comp_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  Prims.string = (fun env c -> (let _143_539 = (let _143_538 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp _143_538 [] c))
in (FStar_Syntax_Print.comp_to_string _143_539)))
...
(let _143_550 = (let _143_549 = (let _143_548 = (FStar_Syntax_Util.mk_conj phi1 phi)
in (y, _143_548))
in FStar_Syntax_Syntax.Tm_refine (_143_549))
in (mk _143_550 t0.FStar_Syntax_Syntax.pos))
end
| _59_1366 -> begin
t
end))
...
in (match ((let _143_555 = (env.FStar_TypeChecker_Env.universe_of env c.FStar_Syntax_Syntax.result_typ)
in (FStar_TypeChecker_Env.lookup_effect_abbrev env _143_555 c.FStar_Syntax_Syntax.effect_name))) with
| None -> begin
c
end
...
let _59_1379 = (FStar_Syntax_Subst.open_comp binders cdef)
in (match (_59_1379) with
| (binders, cdef) -> begin
(
# 850 "FStar.TypeChecker.Normalize.fst"
let inst = (let _143_559 = (let _143_558 = (FStar_Syntax_Syntax.as_arg c.FStar_Syntax_Syntax.result_typ)
in (_143_558)::c.FStar_Syntax_Syntax.effect_args)
in (FStar_List.map2 (fun _59_1383 _59_1387 -> (match ((_59_1383, _59_1387)) with
| ((x, _59_1382), (t, _59_1386)) -> begin
FStar_Syntax_Syntax.NT ((x, t))
end)) binders _143_559))
in (
...
# 852 "FStar.TypeChecker.Normalize.fst"
let _59_1390 = (FStar_Syntax_Util.comp_to_comp_typ c1)
in {FStar_Syntax_Syntax.effect_name = _59_1390.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _59_1390.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _59_1390.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = c.FStar_Syntax_Syntax.flags}) FStar_Syntax_Syntax.mk_Comp)
in (unfold_effect_abbrev env c))))
end))
end)))

# 855 "FStar.TypeChecker.Normalize.fst"
let normalize_sigelt : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.sigelt  ->  FStar_Syntax_Syntax.sigelt = (fun _59_1393 _59_1395 _59_1397 -> (FStar_All.failwith "NYI: normalize_sigelt"))

# 856 "FStar.TypeChecker.Normalize.fst"
let eta_expand : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun _59_1399 t -> (match (t.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_name (x) -> begin
(
# 859 "FStar.TypeChecker.Normalize.fst"
let _59_1406 = (FStar_Syntax_Util.arrow_formals_comp x.FStar_Syntax_Syntax.sort)
in (match (_59_1406) with
| (binders, c) -> begin
(match (binders) with
| [] -> begin
t
...
let _59_1412 = (FStar_All.pipe_right binders FStar_Syntax_Util.args_of_binders)
in (match (_59_1412) with
| (binders, args) -> begin
(let _143_572 = (FStar_Syntax_Syntax.mk_Tm_app t args None t.FStar_Syntax_Syntax.pos)
in (let _143_571 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _143_570 -> Some (_143_570)))
in (FStar_Syntax_Util.abs binders _143_572 _143_571)))
end))
end)
end))
end
| _59_1414 -> begin
(let _143_575 = (let _143_574 = (FStar_Syntax_Print.tag_of_term t)
in (let _143_573 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format2 "NYI: eta_expand(%s) %s" _143_574 _143_573)))
in (FStar_All.failwith _143_575))
end))
