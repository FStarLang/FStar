...
| FStar_Syntax_Syntax.Tm_fvar ({FStar_Syntax_Syntax.fv_name = uu____12204; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_constant_at_level (_0_18); FStar_Syntax_Syntax.fv_qual = uu____12205}) when (_0_18 = (Prims.parse_int "0")) -> begin
(rebuild cfg env stack t1)
end
...
in (FStar_All.pipe_left (fun _0_19 -> FStar_Pervasives_Native.Some (_0_19)) uu____18178))
end
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end)
...
in (FStar_All.pipe_left (fun _0_20 -> FStar_Pervasives_Native.Some (_0_20)) uu____18201))
end
| FStar_Pervasives_Native.None -> begin
FStar_Pervasives_Native.None
end)
