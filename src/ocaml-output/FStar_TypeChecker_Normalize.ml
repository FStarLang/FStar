            ...
            fun qninfo ->
              ...
              | Should_unfold_fully ->
                  let cfg' =
                    ...
                    {
                      FStar_TypeChecker_Cfg.steps =
                        (let uu___298_8066 = cfg.FStar_TypeChecker_Cfg.steps in
                         {
                           FStar_TypeChecker_Cfg.beta =
              ...
              | Should_unfold_reify ->
                  let ref =
                    let uu____8103 =
                      let uu____8110 =
                        let uu____8111 =
                          let uu____8112 = FStar_Syntax_Syntax.lid_of_fv fv in
        ...
        fun t ->
            ...
            (fun uu____8433 ->
               ...
               let uu____8444 =
                 let uu____8445 =
                   ...
                   FStar_All.pipe_left FStar_Pervasives_Native.fst uu____8448 in
          ...
          (match t1.FStar_Syntax_Syntax.n with
           | FStar_Syntax_Syntax.Tm_unknown ->
               (FStar_TypeChecker_Cfg.log_unfolding cfg
                  (fun uu____8479 ->
                     let uu____8480 = FStar_Syntax_Print.term_to_string t1 in
           ...
           | FStar_Syntax_Syntax.Tm_constant uu____8481 ->
               (FStar_TypeChecker_Cfg.log_unfolding cfg
                  (fun uu____8485 ->
                     let uu____8486 = FStar_Syntax_Print.term_to_string t1 in
                     FStar_Util.print1 ">>> Tm_fvar case 0 for %s\n"
                       uu____8486);
                rebuild cfg env stack t1)
           | FStar_Syntax_Syntax.Tm_name uu____8487 ->
               (FStar_TypeChecker_Cfg.log_unfolding cfg
                  (fun uu____8491 ->
                     let uu____8492 = FStar_Syntax_Print.term_to_string t1 in
                     FStar_Util.print1 ">>> Tm_fvar case 0 for %s\n"
                       uu____8492);
                rebuild cfg env stack t1)
           | FStar_Syntax_Syntax.Tm_lazy uu____8493 ->
               (FStar_TypeChecker_Cfg.log_unfolding cfg
                  (fun uu____8497 ->
                     let uu____8498 = FStar_Syntax_Print.term_to_string t1 in
                     FStar_Util.print1 ">>> Tm_fvar case 0 for %s\n"
                       uu____8498);
                rebuild cfg env stack t1)
           | FStar_Syntax_Syntax.Tm_fvar
               ...
               (FStar_TypeChecker_Cfg.log_unfolding cfg
                  (fun uu____8504 ->
                     let uu____8505 = FStar_Syntax_Print.term_to_string t1 in
                     FStar_Util.print1 ">>> Tm_fvar case 0 for %s\n"
                       uu____8505);
                rebuild cfg env stack t1)
           | FStar_Syntax_Syntax.Tm_fvar
               ...
               (FStar_TypeChecker_Cfg.log_unfolding cfg
                  (fun uu____8518 ->
                     let uu____8519 = FStar_Syntax_Print.term_to_string t1 in
                     FStar_Util.print1 ">>> Tm_fvar case 0 for %s\n"
                       uu____8519);
                rebuild cfg env stack t1)
           | FStar_Syntax_Syntax.Tm_fvar fv ->
           ...
           | FStar_Syntax_Syntax.Tm_app (hd1, args) when
               ...
               (if
                ...
                (let cfg' =
                   ...
                   {
                     FStar_TypeChecker_Cfg.steps =
                       (let uu___300_8611 = cfg.FStar_TypeChecker_Cfg.steps in
                        {
                          FStar_TypeChecker_Cfg.beta =
                                           ...
                                           let uu____8669 =
                                             let uu____8670 =
                                               let uu____8701 =
                                                 FStar_Util.mk_ref
                                                   FStar_Pervasives_Native.None in
                                               (env, a, uu____8701, false) in
                                             Clos uu____8670 in
                                           (uu____8669, aq,
                                             (t1.FStar_Syntax_Syntax.pos)) in
                                         Arg uu____8662 in
                                       uu____8661 :: stack1) args) in
                       FStar_TypeChecker_Cfg.log cfg
                         (fun uu____8789 ->
                            let uu____8790 =
                     ...
                     (if
                      ...
                      (let tm' = closure_as_term cfg env tm in
                       ...
                       then
                         (let uu____8819 =
                            let uu____8820 =
                              let uu____8821 = FStar_Util.time_diff start fin in
               ...
               (match stack with
                ...
                | (Match uu____9314)::uu____9315 ->
                    ...
                    then
                      ...
                      (let uu____9328 = FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs1, body1, opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1 ->
                                     fun uu____9364 -> dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                ...
                | (Debug uu____9436)::uu____9437 ->
                    ...
                    then
                      ...
                      (let uu____9446 = FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs1, body1, opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1 ->
                                     fun uu____9482 -> dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                ...
                | (Meta uu____9554)::uu____9555 ->
                    ...
                    then
                      ...
                      (let uu____9566 = FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs1, body1, opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1 ->
                                     fun uu____9602 -> dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                ...
                | (Let uu____9674)::uu____9675 ->
                    ...
                    then
                      ...
                      (let uu____9688 = FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs1, body1, opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1 ->
                                     fun uu____9724 -> dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                ...
                | (App uu____9796)::uu____9797 ->
                    ...
                    then
                      ...
                      (let uu____9810 = FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs1, body1, opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1 ->
                                     fun uu____9846 -> dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                ...
                | (Abs uu____9918)::uu____9919 ->
                    ...
                    then
                      ...
                      (let uu____9936 = FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs1, body1, opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1 ->
                                     fun uu____9972 -> dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                       ...
                       | (bs1, body1, opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1 ->
                                     fun uu____10082 -> dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                  ...
                  | (bs1, c1) ->
                      let c2 =
                        let uu____10480 =
                          FStar_All.pipe_right bs1
                            (FStar_List.fold_left
                               (fun env1 -> fun uu____10506 -> dummy :: env1)
                               env) in
                    ...
                    (uu____10671,
                     {
                       ...
                       FStar_Syntax_Syntax.vars = uu____10673;_},
                     uu____10674, uu____10675))::uu____10676
                    when
                    (cfg.FStar_TypeChecker_Cfg.steps).FStar_TypeChecker_Cfg.beta
                    ->
                    (FStar_TypeChecker_Cfg.log cfg
                       ...
                       | (Cfg cfg1)::stack1 ->
                           let t2 =
                             let uu____10766 =
                               ...
                               FStar_Syntax_Syntax.Tm_ascribed uu____10767 in
                       ...
                       | uu____10829 ->
                           let uu____10830 =
                             let uu____10831 =
                               ...
                               FStar_Syntax_Syntax.Tm_ascribed uu____10832 in
           ...
           | FStar_Syntax_Syntax.Tm_match (head1, branches) ->
               ...
               then
                 let cfg' =
                   ...
                   {
                     FStar_TypeChecker_Cfg.steps =
                       (let uu___308_10939 = cfg.FStar_TypeChecker_Cfg.steps in
                        {
                          FStar_TypeChecker_Cfg.beta =
           ...
           | FStar_Syntax_Syntax.Tm_let
               ((uu____11019,
                 { FStar_Syntax_Syntax.lbname = FStar_Util.Inr uu____11020;
                   ...
                   FStar_Syntax_Syntax.lbpos = uu____11026;_}::uu____11027),
                uu____11028)
               -> rebuild cfg env stack t1
           | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), body) ->
               let n1 =
                          ...
                          (let lb1 =
                           ...
                           let env' =
                             FStar_All.pipe_right bs
                               (FStar_List.fold_left
                                  (fun env1 ->
                                     fun uu____11320 -> dummy :: env1) env) in
                           let stack1 = (Cfg cfg) :: stack in
                           let cfg1 =
                           ...
                           | (xs, def_body, lopt) ->
                               ...
                               let env1 =
                                 ...
                                 let uu____11446 =
                                   let uu____11455 =
                                     FStar_List.map
                                       (fun uu____11477 -> dummy) xs1 in
                                   FStar_List.append uu____11455 env in
                                 FStar_List.append uu____11429 uu____11446 in
                                 ...
                                 let uu____12414 =
                                   let uu____12445 =
                                     FStar_Util.mk_ref
                                       FStar_Pervasives_Native.None in
                                   (rec_env, (lb.FStar_Syntax_Syntax.lbdef),
                                     uu____12445, false) in
                                 Clos uu____12414 in
                               (FStar_Pervasives_Native.None, uu____12413) in
                             uu____12406 :: env1)
          ...
          fun qninfo ->
            fun f ->
              ...
              | FStar_Pervasives_Native.None ->
                  (FStar_TypeChecker_Cfg.log_unfolding cfg
                     (fun uu____12721 ->
                        let uu____12722 = FStar_Syntax_Print.fv_to_string f in
              ...
              | FStar_Pervasives_Native.Some (us, t) ->
                  (FStar_TypeChecker_Cfg.log_unfolding cfg
                     (fun uu____12733 ->
                        ...
                        let uu____12735 = FStar_Syntax_Print.term_to_string t in
            ...
            fun m ->
              fun t ->
                (match stack with
                 | (App
                     (uu____12856,
                      ...
                      uu____12859, uu____12860))::uu____12861
                     -> ()
                 | uu____12866 ->
                     let uu____12869 =
                ...
                (let head0 = head1 in
                 ...
                 FStar_TypeChecker_Cfg.log cfg
                   (fun uu____12877 ->
                      let uu____12878 = FStar_Syntax_Print.tag_of_term head2 in
                      let uu____12879 =
                  ...
                  | FStar_Syntax_Syntax.Tm_let ((false, lb::[]), body) ->
                      let ed =
                        ...
                        FStar_TypeChecker_Env.get_effect_decl
                          cfg.FStar_TypeChecker_Cfg.tcenv uu____12900 in
                            ...
                            | FStar_Util.Inl x ->
                                ...
                                (match uu____12960 with
                                 | FStar_Pervasives_Native.Some e ->
                                     ...
                                     let uu____12966 = FStar_List.tl stack in
                                     let uu____12967 =
                                       let uu____12968 =
                                         let uu____12975 =
                                           let uu____12976 =
                                          ...
                                          let uu____13113 =
                                            let uu____13114 =
                                              FStar_Syntax_Subst.compress
                                                bind_repr in
                                            uu____13114.FStar_Syntax_Syntax.n in
                      ...
                      ((let uu____13543 = FStar_Options.defensive () in
                             ...
                             let uu____13623 =
                               let uu____13628 =
                                 ...
                                 FStar_Util.format1
                                   ...
                                   uu____13629 in
                               (FStar_Errors.Warning_Defensive, uu____13628) in
                       ...
                       (let fallback1 uu____13637 =
                          ...
                          (let uu____13643 = FStar_List.tl stack in
                           let uu____13644 = FStar_Syntax_Util.mk_reify head3 in
                           norm cfg env uu____13643 uu____13644) in
                        let fallback2 uu____13650 =
                          ...
                          (let uu____13656 = FStar_List.tl stack in
                           ...
                           norm cfg env uu____13656 uu____13657) in
                        let uu____13662 =
                          let uu____13663 =
                     ...
                     let uu____14010 =
                       let uu____14011 =
                         let uu____14028 =
                           ...
                           let uu____14048 =
                             let uu____14059 = FStar_Syntax_Syntax.as_arg e in
                             [uu____14059] in
      ...
      fun b ->
        ...
        | (x, imp) ->
            let x1 =
              ...
              let uu____14446 = norm cfg env [] x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
            ...
            (let w t =
               ...
               (let uu____14923 = FStar_Syntax_Util.head_and_args' t in
                ...
                | (hd1, args) ->
                    ...
                    (match uu____14962 with
                     ...
                     | uu____14974 -> FStar_Pervasives_Native.None)) in
                ...
                | uu____15017 ->
                    ...
                    (match uu____15026 with
                     | FStar_Pervasives_Native.Some (uu____15037, t') ->
                         is_applied bs t'
                     | uu____15049 -> is_applied bs t)) in
             let is_quantified_const bv phi =
               ...
               | FStar_Pervasives_Native.Some (FStar_Syntax_Util.BaseConn
                   ...
                   (if
                      (cfg.FStar_TypeChecker_Cfg.debug).FStar_TypeChecker_Cfg.wpe
                    then
                      (let uu____15124 = FStar_Syntax_Print.term_to_string p in
                       let uu____15125 = FStar_Syntax_Print.term_to_string q in
                    ...
                    (let uu____15127 =
                     ...
                     | FStar_Pervasives_Native.None ->
                         let uu____15132 =
                           let uu____15133 = FStar_Syntax_Subst.compress p in
                     ...
                     | FStar_Pervasives_Native.Some
                         ...
                         ->
                         let uu____15172 =
                           let uu____15173 = FStar_Syntax_Subst.compress p1 in
             ...
             let is_forall_const phi =
               ...
               | FStar_Pervasives_Native.Some (FStar_Syntax_Util.QAll
                   ...
                   (if
                      (cfg.FStar_TypeChecker_Cfg.debug).FStar_TypeChecker_Cfg.wpe
                    then
                      (let uu____15299 = FStar_Syntax_Print.bv_to_string bv in
                       let uu____15300 =
             ...
             let squashed_head_un_auto_squash_args t =
               let maybe_un_auto_squash_arg uu____15531 =
                 ...
                 | (t1, q) ->
                     let uu____15552 = FStar_Syntax_Util.is_auto_squash t1 in
             ...
             | FStar_Pervasives_Native.Some tm' ->
                 (if
                    (cfg.FStar_TypeChecker_Cfg.debug).FStar_TypeChecker_Cfg.wpe
                  then
                    (let uu____15758 = FStar_Syntax_Print.term_to_string tm1 in
                     let uu____15759 = FStar_Syntax_Print.term_to_string tm' in
                 ...
                 (match uu____15762 with
                  | FStar_Syntax_Syntax.Tm_app
                      ({
                         ...
                         FStar_Syntax_Syntax.vars = uu____15771;_},
                       args)
                      ->
                      let uu____15801 =
                        FStar_Syntax_Syntax.fv_eq_lid fv
                      ...
                      then
                        ...
                        (let uu____16137 =
                         ...
                         then
                           ...
                           | uu____16257::(FStar_Pervasives_Native.Some
                                           (true), uu____16258)::[]
                               -> w FStar_Syntax_Util.t_true
                           | (FStar_Pervasives_Native.Some (false),
                                           ...
                                           (match uu____17672 with
                                            | FStar_Syntax_Syntax.Tm_abs
                                                (uu____17676::[], body,
                                                 uu____17678)
                                                ->
                                                let uu____17713 = simp_t body in
                                           ...
                                           (match uu____17762 with
                                            | FStar_Syntax_Syntax.Tm_abs
                                                (uu____17766::[], body,
                                                 uu____17768)
                                                ->
                                                let uu____17803 = simp_t body in
                                          ...
                                          | (t, uu____17824)::[] ->
                                              let uu____17849 =
                                                let uu____17850 =
                                                  FStar_Syntax_Subst.compress
                                                    t in
                                                uu____17850.FStar_Syntax_Syntax.n in
                  ...
                  | FStar_Syntax_Syntax.Tm_app
                      ({
                         ...
                         FStar_Syntax_Syntax.vars = uu____18111;_},
                       args)
                      ->
                      let uu____18137 =
                        FStar_Syntax_Syntax.fv_eq_lid fv
                               ...
                               then
                                 ...
                                 | (FStar_Pervasives_Native.Some (false),
                                    uu____19403)::(FStar_Pervasives_Native.Some
                                                   (true), uu____19404)::[]
                                     -> w FStar_Syntax_Util.t_false
                                 | (uu____19469, (arg, uu____19471))::
                                     (FStar_Pervasives_Native.Some (true),
                                      uu____19472)::[]
                                     -> maybe_auto_squash arg
                                 | (FStar_Pervasives_Native.Some (true),
                                    uu____19537)::(uu____19538,
                                                   (arg, uu____19540))::[]
                                     -> maybe_auto_squash arg
                                 | (uu____19605, (arg, uu____19607))::
                                     (FStar_Pervasives_Native.Some (false),
                                      uu____19608)::[]
                                     ->
                                     let uu____19673 =
                                           ...
                                           (match uu____20008 with
                                            | FStar_Syntax_Syntax.Tm_abs
                                                (uu____20012::[], body,
                                                 uu____20014)
                                                ->
                                                let uu____20049 = simp_t body in
                                           ...
                                           (match uu____20098 with
                                            | FStar_Syntax_Syntax.Tm_abs
                                                (uu____20102::[], body,
                                                 uu____20104)
                                                ->
                                                let uu____20139 = simp_t body in
                                             ...
                                             uu____20234))::(t, uu____20236)::[]
                                              ...
                                              let uu____20275 =
                                                let uu____20276 =
                                                  FStar_Syntax_Subst.compress
                                                    t in
                                                uu____20276.FStar_Syntax_Syntax.n in
            ...
            (fun uu____20490 ->
               ...
               (let uu____20528 =
                ...
                then
                  ...
                  | [] -> ()
                  | bvs ->
                      ((let uu____20536 = FStar_Syntax_Print.tag_of_term t in
                        let uu____20537 = FStar_Syntax_Print.term_to_string t in
                        let uu____20538 =
                          let uu____20539 =
          ...
          (let t1 = maybe_simplify cfg env stack t in
           ...
           | (MemoLazy r)::stack1 ->
               (set_memo cfg r (env, t1);
                FStar_TypeChecker_Cfg.log cfg
                  (fun uu____20622 ->
                     let uu____20623 = FStar_Syntax_Print.term_to_string t1 in
                     FStar_Util.print1 "\tSet memo %s\n" uu____20623);
                rebuild cfg env stack1 t1)
           ...
           | (UnivArgs (us, r))::stack1 ->
               ...
               rebuild cfg env stack1 t2
           | (Arg
               (Clos (env_arg, tm, uu____20688, uu____20689), aq, r))::stack1
               when
           ...
           | (Arg (Clos (env_arg, tm, m, uu____20761), aq, r))::stack1 ->
               (FStar_TypeChecker_Cfg.log cfg
                  (fun uu____20814 ->
                     let uu____20815 = FStar_Syntax_Print.term_to_string tm in
           ...
           | (App (env1, head1, aq, r))::stack' when should_reify cfg stack
               ...
               let fallback msg uu____21025 =
                 FStar_TypeChecker_Cfg.log cfg
                   (fun uu____21029 ->
                      let uu____21030 = FStar_Syntax_Print.term_to_string t1 in
               ...
               (match uu____21038 with
                ...
                | FStar_Syntax_Syntax.Tm_app
                    ({
                       ...
                       FStar_Syntax_Syntax.vars = uu____21075;_},
                     (e, uu____21077)::[])
                ...
                | FStar_Syntax_Syntax.Tm_app uu____21116 when
                    ...
                    (match uu____21133 with
                     | (hd1, args) ->
                         let uu____21176 =
                           let uu____21177 = FStar_Syntax_Util.un_uinst hd1 in
           ...
           | (Match (env', branches, cfg1, r))::stack1 ->
               (FStar_TypeChecker_Cfg.log cfg1
                  (fun uu____21250 ->
                     let uu____21251 = FStar_Syntax_Print.term_to_string t1 in
                     FStar_Util.print1
                   ...
                   (let whnf =
                        ...
                        FStar_All.pipe_right
                          ...
                          (FStar_List.filter
                             (fun uu___268_21323 ->
                                ...
                                | FStar_TypeChecker_Env.Eager_unfolding_only
                                    -> true
                                | uu____21324 -> false)) in
                      let steps =
                        let uu___329_21326 = cfg1.FStar_TypeChecker_Cfg.steps in
                        {
                          FStar_TypeChecker_Cfg.beta =
                              ...
                              (FStar_List.fold_left
                                 (fun uu____21516 ->
                                    fun uu____21517 ->
                                      ...
                                      | ((pats1, env3), (p1, b)) ->
                                          let uu____21656 = norm_pat env3 p1 in
                    ...
                    let uu____22086 =
                      mk
                        ...
                        r in
                    rebuild cfg1 env1 stack1 uu____22086) in
                       ...
                       (match uu____22617 with
                        | FStar_Util.Inl s ->
                            matches_args (FStar_List.append out s) rest_a
                              rest_p
                        | m -> m)
                   | uu____22666 -> FStar_Util.Inr false in
                                               ...
                                               let uu____22911 =
                                                 let uu____22942 =
                                                   FStar_Util.mk_ref
                                                     (FStar_Pervasives_Native.Some
                                                        ([], t2)) in
                                                 ([], t2, uu____22942, false) in
                                               Clos uu____22911 in
                                             (uu____22906, uu____22910) in
                                           uu____22899 :: env2) env1 s in
                              let uu____23055 = guard_when_clause wopt b rest in
                              norm cfg1 env2 stack1 uu____23055))) in
                 if
                   (cfg1.FStar_TypeChecker_Cfg.steps).FStar_TypeChecker_Cfg.iota
          ...
          (let uu____23087 = is_nbe_request s in
           ...
           then
             (FStar_TypeChecker_Cfg.log_top c
              ...
              FStar_TypeChecker_Cfg.log_top c
                (fun uu____23096 ->
                   let uu____23097 = FStar_TypeChecker_Cfg.cfg_to_string c in
                   FStar_Util.print1 ">>> cfg = %s\n" uu____23097);
             ...
             (FStar_TypeChecker_Cfg.log_top c
              ...
              FStar_TypeChecker_Cfg.log_top c
                (fun uu____23113 ->
                   let uu____23114 = FStar_TypeChecker_Cfg.cfg_to_string c in
                   FStar_Util.print1 ">>> cfg = %s\n" uu____23114);
              (let r = norm c [] [] t in
               FStar_TypeChecker_Cfg.log_top c
                 (fun uu____23125 ->
    ...
    fun t ->
      let t1 =
        ...
        | uu___344_23299 ->
            ((let uu____23301 =
                let uu____23306 =
                  let uu____23307 = FStar_Util.message_of_exn uu___344_23299 in
    ...
    fun c ->
      let c1 =
        ...
        | uu___346_23331 ->
            ((let uu____23333 =
                let uu____23338 =
                  let uu____23339 = FStar_Util.message_of_exn uu___346_23331 in
                  FStar_Util.format1 "Normalization failed with error %s\n"
                    uu____23339 in
                                ...
                                (let uu___348_23706 = env in
                                 {
                                   ...
                                   FStar_TypeChecker_Env.fv_delta_depths =
                                     (uu___348_23706.FStar_TypeChecker_Env.fv_delta_depths);
                        ...
                        (let uu___349_23719 = env in
                         {
                           ...
                           FStar_TypeChecker_Env.fv_delta_depths =
                             (uu___349_23719.FStar_TypeChecker_Env.fv_delta_depths);
                           FStar_TypeChecker_Env.proof_ns =
...
let rec (elim_delayed_subst_term :
  ...
  fun t ->
    ...
    let elim_bv x =
      ...
      let uu____23804 = elim_delayed_subst_term x.FStar_Syntax_Syntax.sort in
      {
        FStar_Syntax_Syntax.ppname =
    ...
    | FStar_Syntax_Syntax.Tm_match (t2, branches) ->
                  ...
                  let uu____24196 =
                    FStar_List.map
                      (fun uu____24219 ->
                         ...
                         | (x, b) ->
                             let uu____24232 = elim_pat x in (uu____24232, b))
                      pats in
                  (fv, uu____24196) in
        ...
        let elim_branch uu____24269 =
          ...
          | (pat, wopt, t3) ->
              ...
              (uu____24295, uu____24298, uu____24301) in
        let uu____24306 =
          let uu____24307 =
          ...
          | (tc, topt) ->
              let uu____24499 =
                ...
                | FStar_Util.Inr c ->
                    ...
                    FStar_Util.Inr uu____24511 in
              let uu____24512 =
                FStar_Util.map_opt topt elim_delayed_subst_term in
              (uu____24499, uu____24512) in
        let uu____24521 =
          let uu____24522 =
...
and (elim_delayed_subst_meta :
  ...
  fun uu___270_24824 ->
    ...
    | FStar_Syntax_Syntax.Meta_monadic (m, t) ->
        let uu____24877 =
          let uu____24884 = elim_delayed_subst_term t in (m, uu____24884) in
          ...
          let t =
            ...
            | (uu____25144, FStar_Util.Inl t) ->
                ...
                uu____25166 FStar_Pervasives_Native.None
                  t.FStar_Syntax_Syntax.pos in
          let uu____25205 = FStar_Syntax_Subst.open_univ_vars univ_names t in
                ...
                | uu____25310 ->
                    ...
                    (match uu____25311 with
                     | (FStar_Syntax_Syntax.Tm_arrow (binders1, c),
                        FStar_Util.Inr uu____25350) ->
                         (binders1, (FStar_Util.Inr c))
                     | (FStar_Syntax_Syntax.Tm_arrow (binders1, c),
                        FStar_Util.Inl uu____25397) ->
                         (binders1,
                           (FStar_Util.Inl (FStar_Syntax_Util.comp_result c)))
                     | (uu____25442, FStar_Util.Inl uu____25443) ->
                         ([], (FStar_Util.Inl t4))
                     | uu____25474 -> failwith "Impossible") in
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____26154 with
           | (univs1, binders, signature) ->
               let uu____26194 =
                 let uu____26199 = FStar_Syntax_Subst.univ_var_opening univs1 in
                 match uu____26199 with
                 | (univs_opening, univs2) ->
                     let uu____26222 =
                       FStar_Syntax_Subst.univ_var_closing univs2 in
                     (univs_opening, uu____26222) in
                                              ...
                                              let t2 =
                                                let uu____26386 =
                                                  FStar_Syntax_Subst.subst
                                                    b_opening1 t1 in
                                                FStar_Syntax_Subst.subst
                                                  univs_opening1 uu____26386 in
                                              let uu____26387 =
                                                elim_uvars_aux_t env [] [] t2 in
                                              (match uu____26387 with
                                               | (uu____26414, uu____26415,
                                                  t3) ->
                                                   let t4 =
                                                     let uu____26438 =
                                                       let uu____26439 =
                         ...
                         let elim_action a =
                           ...
                           let destruct_action_typ_templ t =
                             ...
                             | FStar_Syntax_Syntax.Tm_abs
                                 ...
                                 let uu____26713 = destruct_action_body body in
                           ...
                           | (action_univs, t) ->
                               let uu____26827 = destruct_action_typ_templ t in
