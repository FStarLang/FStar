...
let built_in_primitive_steps: primitive_step Prims.list =
  ...
  let set_range_of1 r args =
    ...
    | uu____5266::(t,uu____5268)::(r1,uu____5270)::[] ->
        ...
        FStar_Pervasives_Native.Some
          (let uu___183_5295 = t in
           {
             FStar_Syntax_Syntax.n = (uu___183_5295.FStar_Syntax_Syntax.n);
             FStar_Syntax_Syntax.pos = r2;
             FStar_Syntax_Syntax.vars =
               (uu___183_5295.FStar_Syntax_Syntax.vars)
           })
  ...
  let interp_prop r args =
    ...
    | (_typ,uu____7070)::(a1,uu____7072)::(a2,uu____7074)::[] ->
        ...
        (match uu____7111 with
         | FStar_Syntax_Util.Equal  ->
             FStar_Pervasives_Native.Some
               (let uu___184_7117 = FStar_Syntax_Util.t_true in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___184_7117.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.pos = r;
                  FStar_Syntax_Syntax.vars =
                    (uu___184_7117.FStar_Syntax_Syntax.vars)
                })
         | FStar_Syntax_Util.NotEqual  ->
             FStar_Pervasives_Native.Some
               (let uu___185_7121 = FStar_Syntax_Util.t_false in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___185_7121.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.pos = r;
                  FStar_Syntax_Syntax.vars =
                    (uu___185_7121.FStar_Syntax_Syntax.vars)
                })
    ...
    | (_typ,uu____7124)::uu____7125::(a1,uu____7127)::(a2,uu____7129)::[] ->
        ...
        (match uu____7178 with
         | FStar_Syntax_Util.Equal  ->
             FStar_Pervasives_Native.Some
               (let uu___184_7184 = FStar_Syntax_Util.t_true in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___184_7184.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.pos = r;
                  FStar_Syntax_Syntax.vars =
                    (uu___184_7184.FStar_Syntax_Syntax.vars)
                })
         | FStar_Syntax_Util.NotEqual  ->
             FStar_Pervasives_Native.Some
               (let uu___185_7188 = FStar_Syntax_Util.t_false in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___185_7188.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.pos = r;
                  FStar_Syntax_Syntax.vars =
                    (uu___185_7188.FStar_Syntax_Syntax.vars)
                })
...
let reduce_equality:
  ...
  fun cfg  ->
    fun tm  ->
      reduce_primops
        (let uu___186_7275 = cfg in
         {
           steps = [Primops];
           tcenv = (uu___186_7275.tcenv);
           delta_level = (uu___186_7275.delta_level);
...
let maybe_simplify:
  ...
  fun cfg  ->
    fun tm  ->
      ...
      let w t =
        let uu___187_7299 = t in
        {
          FStar_Syntax_Syntax.n = (uu___187_7299.FStar_Syntax_Syntax.n);
          FStar_Syntax_Syntax.pos = (tm.FStar_Syntax_Syntax.pos);
          FStar_Syntax_Syntax.vars = (uu___187_7299.FStar_Syntax_Syntax.vars)
        } in
      let simp_t t =
        ...
        fun t  ->
          ...
          (match t1.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_app (hd1,args) when
               ...
               let t2 =
                 let uu___188_10863 = t1 in
                 {
                   FStar_Syntax_Syntax.n =
                     (FStar_Syntax_Syntax.Tm_app (hd2, args1));
                   FStar_Syntax_Syntax.pos =
                     (uu___188_10863.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___188_10863.FStar_Syntax_Syntax.vars)
                 } in
           ...
           | FStar_Syntax_Syntax.Tm_app (hd1,args) when
               ...
               ->
               let cfg' =
                 let uu___189_10904 = cfg in
                 let uu____10905 =
                   FStar_List.filter
                     (fun uu___157_10908  ->
                        match uu___157_10908 with
                        | UnfoldOnly uu____10909 -> false
                        | NoDeltaSteps  -> false
                        | uu____10912 -> true) cfg.steps in
                 {
                   steps = uu____10905;
                   tcenv = (uu___189_10904.tcenv);
                   delta_level =
                     [FStar_TypeChecker_Env.Unfold
                        FStar_Syntax_Syntax.Delta_constant];
                   primitive_steps = (uu___189_10904.primitive_steps)
                 } in
               ...
               (match uu____10913 with
                | (s,tm) ->
                    ...
                    let cfg'1 =
                      let uu___190_10944 = cfg in
                      {
                        steps = s;
                        tcenv = (uu___190_10944.tcenv);
                        delta_level;
                        primitive_steps = (uu___190_10944.primitive_steps)
                      } in
                    let stack' =
                      let tail1 =
                        (Steps
                       ...
                       | FStar_Pervasives_Native.Some (env2,t') ->
                           (log cfg
                            ...
                            (let uu____11496 =
                               let uu____11497 =
                                 FStar_Syntax_Subst.compress t' in
                               uu____11497.FStar_Syntax_Syntax.n in
                             match uu____11496 with
                             | FStar_Syntax_Syntax.Tm_abs uu____11500 ->
                                 norm cfg env2 stack1 t'
                             | uu____11517 -> rebuild cfg env2 stack1 t'))
                       | FStar_Pervasives_Native.None  ->
                           norm cfg env1 ((MemoLazy r) :: stack1) t0)
                    else norm cfg env1 stack1 t0)
           | FStar_Syntax_Syntax.Tm_abs (bs,body,lopt) ->
               (match stack1 with
                | (UnivArgs uu____11569)::uu____11570 ->
                    failwith
                      "Ill-typed term: universes cannot be applied to term abstraction"
                | (Match uu____11579)::uu____11580 ->
                    failwith
                      "Ill-typed term: cannot pattern match an abstraction"
                | (Arg (c,uu____11590,uu____11591))::stack_rest ->
                    (match c with
                     | Univ uu____11595 -> norm cfg (c :: env) stack_rest t1
                     | uu____11596 ->
                         (match bs with
                          | [] -> failwith "Impossible"
                          | uu____11601::[] ->
                              (log cfg
                                 (fun uu____11617  ->
                                    let uu____11618 = closure_to_string c in
                          ...
                          | uu____11619::tl1 ->
                              (log cfg
                                 (fun uu____11638  ->
                                    let uu____11639 = closure_to_string c in
                                    FStar_Util.print1 "\tShifted %s\n"
                                      uu____11639);
                               (let body1 =
                                  mk
                ...
                | (Debug uu____11732)::uu____11733 ->
                    if FStar_List.contains WHNF cfg.steps
                    then
                      let uu____11740 = closure_as_term cfg env t1 in
                      rebuild cfg env stack1 uu____11740
                    else
                      (let uu____11742 =
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11766  -> Dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                                       ...
                                       (fun t2  ->
                                          let uu____11792 =
                                            FStar_Syntax_Subst.subst opening
                                              t2 in
                                          norm cfg env' [] uu____11792)
                                   else
                                     FStar_Util.map_opt
                                       rc.FStar_Syntax_Syntax.residual_typ
                                       (FStar_Syntax_Subst.subst opening) in
                                 FStar_Pervasives_Native.Some
                                   (let uu___192_11797 = rc in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___192_11797.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ = rct;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___192_11797.FStar_Syntax_Syntax.residual_flags)
                                    })
                             | uu____11798 -> lopt in
                           (log cfg
                              (fun uu____11804  ->
                            ...
                            (let stack2 =
                               ...
                               :: stack1 in
                             let cfg1 =
                               let uu___193_11818 = cfg in
                               let uu____11819 =
                                 FStar_List.filter
                                   (fun ps  -> ps.strong_reduction_ok)
                                   cfg.primitive_steps in
                               {
                                 steps = (uu___193_11818.steps);
                                 tcenv = (uu___193_11818.tcenv);
                                 delta_level = (uu___193_11818.delta_level);
                                 primitive_steps = uu____11819
                               } in
                             norm cfg1 env'
                               ((Abs
                                   (env, bs1, env', lopt1,
                                     (t1.FStar_Syntax_Syntax.pos))) ::
                               stack2) body1)))
                | (Meta uu____11828)::uu____11829 ->
                    if FStar_List.contains WHNF cfg.steps
                    then
                      let uu____11836 = closure_as_term cfg env t1 in
                      rebuild cfg env stack1 uu____11836
                    else
                      (let uu____11838 =
                         FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____11862  -> Dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                                     ...
                                     FStar_Util.map_opt
                                       ...
                                       (fun t2  ->
                                          let uu____11888 =
                                            FStar_Syntax_Subst.subst opening
                                              t2 in
                                          norm cfg env' [] uu____11888)
                                   else
                                     FStar_Util.map_opt
                                       rc.FStar_Syntax_Syntax.residual_typ
                                       (FStar_Syntax_Subst.subst opening) in
                                 FStar_Pervasives_Native.Some
                                   (let uu___192_11893 = rc in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___192_11893.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ = rct;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___192_11893.FStar_Syntax_Syntax.residual_flags)
                                    })
                             | uu____11894 -> lopt in
                           (log cfg
                              (fun uu____11900  ->
                            ...
                            (let stack2 =
                               ...
                               :: stack1 in
                             let cfg1 =
                               let uu___193_11914 = cfg in
                               let uu____11915 =
                                 FStar_List.filter
                                   (fun ps  -> ps.strong_reduction_ok)
                                   cfg.primitive_steps in
                               {
                                 steps = (uu___193_11914.steps);
                                 tcenv = (uu___193_11914.tcenv);
                                 delta_level = (uu___193_11914.delta_level);
                                 primitive_steps = uu____11915
                               } in
                             norm cfg1 env'
                               ((Abs
                                   (env, bs1, env', lopt1,
                                     (t1.FStar_Syntax_Syntax.pos))) ::
                               stack2) body1)))
                | (Let uu____11924)::uu____11925 ->
                    if FStar_List.contains WHNF cfg.steps
                    then
                      let uu____11936 = closure_as_term cfg env t1 in
                                     ...
                                     FStar_Util.map_opt
                                       ...
                                       (fun t2  ->
                                          let uu____11988 =
                                            FStar_Syntax_Subst.subst opening
                                              t2 in
                                          norm cfg env' [] uu____11988)
                                   else
                                     FStar_Util.map_opt
                                       rc.FStar_Syntax_Syntax.residual_typ
                                       (FStar_Syntax_Subst.subst opening) in
                                 FStar_Pervasives_Native.Some
                                   (let uu___192_11993 = rc in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___192_11993.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ = rct;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___192_11993.FStar_Syntax_Syntax.residual_flags)
                                    })
                             | uu____11994 -> lopt in
                           (log cfg
                              (fun uu____12000  ->
                            ...
                            (let stack2 =
                               ...
                               :: stack1 in
                             let cfg1 =
                               let uu___193_12014 = cfg in
                               let uu____12015 =
                                 FStar_List.filter
                                   (fun ps  -> ps.strong_reduction_ok)
                                   cfg.primitive_steps in
                               {
                                 steps = (uu___193_12014.steps);
                                 tcenv = (uu___193_12014.tcenv);
                                 delta_level = (uu___193_12014.delta_level);
                                 primitive_steps = uu____12015
                               } in
                             norm cfg1 env'
                               ((Abs
                                   (env, bs1, env', lopt1,
                                     (t1.FStar_Syntax_Syntax.pos))) ::
                               stack2) body1)))
                | (App uu____12024)::uu____12025 ->
                    if FStar_List.contains WHNF cfg.steps
                    then
                      let uu____12034 = closure_as_term cfg env t1 in
                      rebuild cfg env stack1 uu____12034
                    else
                      (let uu____12036 =
                         FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12060  -> Dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                                     ...
                                     FStar_Util.map_opt
                                       ...
                                       (fun t2  ->
                                          let uu____12086 =
                                            FStar_Syntax_Subst.subst opening
                                              t2 in
                                          norm cfg env' [] uu____12086)
                                   else
                                     FStar_Util.map_opt
                                       rc.FStar_Syntax_Syntax.residual_typ
                                       (FStar_Syntax_Subst.subst opening) in
                                 FStar_Pervasives_Native.Some
                                   (let uu___192_12091 = rc in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___192_12091.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ = rct;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___192_12091.FStar_Syntax_Syntax.residual_flags)
                                    })
                             | uu____12092 -> lopt in
                           (log cfg
                              (fun uu____12098  ->
                            ...
                            (let stack2 =
                               ...
                               :: stack1 in
                             let cfg1 =
                               let uu___193_12112 = cfg in
                               let uu____12113 =
                                 FStar_List.filter
                                   (fun ps  -> ps.strong_reduction_ok)
                                   cfg.primitive_steps in
                               {
                                 steps = (uu___193_12112.steps);
                                 tcenv = (uu___193_12112.tcenv);
                                 delta_level = (uu___193_12112.delta_level);
                                 primitive_steps = uu____12113
                               } in
                             norm cfg1 env'
                               ((Abs
                                   (env, bs1, env', lopt1,
                                     (t1.FStar_Syntax_Syntax.pos))) ::
                               stack2) body1)))
                | (Abs uu____12122)::uu____12123 ->
                    if FStar_List.contains WHNF cfg.steps
                    then
                      let uu____12138 = closure_as_term cfg env t1 in
                      rebuild cfg env stack1 uu____12138
                    else
                      (let uu____12140 =
                         FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12164  -> Dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                                   ...
                                   then
                                     ...
                                     FStar_Util.map_opt
                                       ...
                                       (FStar_Syntax_Subst.subst opening) in
                                 FStar_Pervasives_Native.Some
                                   (let uu___192_12195 = rc in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___192_12195.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ = rct;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___192_12195.FStar_Syntax_Syntax.residual_flags)
                                    })
                             | uu____12196 -> lopt in
                           (log cfg
                              (fun uu____12202  ->
                            ...
                            (let stack2 =
                               ...
                               :: stack1 in
                             let cfg1 =
                               let uu___193_12216 = cfg in
                               let uu____12217 =
                                 FStar_List.filter
                                   (fun ps  -> ps.strong_reduction_ok)
                                   cfg.primitive_steps in
                               {
                                 steps = (uu___193_12216.steps);
                                 tcenv = (uu___193_12216.tcenv);
                                 delta_level = (uu___193_12216.delta_level);
                                 primitive_steps = uu____12217
                               } in
                             norm cfg1 env'
                               ((Abs
                                   (env, bs1, env', lopt1,
                       ...
                       | (bs1,body1,opening) ->
                           let env' =
                             FStar_All.pipe_right bs1
                               (FStar_List.fold_left
                                  (fun env1  ->
                                     fun uu____12252  -> Dummy :: env1) env) in
                           let lopt1 =
                             match lopt with
                             | FStar_Pervasives_Native.Some rc ->
                                 let rct =
                                   ...
                                   then
                                     ...
                                     FStar_Util.map_opt
                                       ...
                                       (FStar_Syntax_Subst.subst opening) in
                                 FStar_Pervasives_Native.Some
                                   (let uu___192_12283 = rc in
                                    {
                                      FStar_Syntax_Syntax.residual_effect =
                                        (uu___192_12283.FStar_Syntax_Syntax.residual_effect);
                                      FStar_Syntax_Syntax.residual_typ = rct;
                                      FStar_Syntax_Syntax.residual_flags =
                                        (uu___192_12283.FStar_Syntax_Syntax.residual_flags)
                                    })
                             | uu____12284 -> lopt in
                           (log cfg
                              (fun uu____12290  ->
                            ...
                            (let stack2 =
                               ...
                               :: stack1 in
                             let cfg1 =
                               let uu___193_12304 = cfg in
                               let uu____12305 =
                                 FStar_List.filter
                                   (fun ps  -> ps.strong_reduction_ok)
                                   cfg.primitive_steps in
                               {
                                 steps = (uu___193_12304.steps);
                                 tcenv = (uu___193_12304.tcenv);
                                 delta_level = (uu___193_12304.delta_level);
                                 primitive_steps = uu____12305
                               } in
                             norm cfg1 env'
                               ((Abs
                                   (env, bs1, env', lopt1,
                                   ...
                                   let uu____12372 =
                                     let uu____12373 =
                                       let uu____12392 =
                                         FStar_Util.mk_ref
                                           FStar_Pervasives_Native.None in
                                       (env, a, uu____12392, false) in
                                     Clos uu____12373 in
                                   (uu____12372, aq,
                                     (t1.FStar_Syntax_Syntax.pos)) in
                                 Arg uu____12365 in
                               uu____12364 :: stack2) args) in
               (log cfg
                  (fun uu____12444  ->
                     let uu____12445 =
                      ...
                      let t2 =
                        mk
                          (FStar_Syntax_Syntax.Tm_refine
                             ((let uu___194_12469 = x in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___194_12469.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___194_12469.FStar_Syntax_Syntax.index);
                      ...
                      let t2 =
                        let uu____12503 =
                          let uu____12504 =
                            ...
                            ((let uu___195_12513 = x in
                              {
                                FStar_Syntax_Syntax.ppname =
                                  (uu___195_12513.FStar_Syntax_Syntax.ppname);
                                FStar_Syntax_Syntax.index =
                                  (uu___195_12513.FStar_Syntax_Syntax.index);
                                FStar_Syntax_Syntax.sort = t_x
                              }), uu____12511) in
                          FStar_Syntax_Syntax.Tm_refine uu____12504 in
                        mk uu____12503 t1.FStar_Syntax_Syntax.pos in
                      rebuild cfg env stack1 t2)
           | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
               if FStar_List.contains WHNF cfg.steps
               then
                 ...
                 (let uu____12534 = FStar_Syntax_Subst.open_comp bs c in
                  ...
                  | (bs1,c1) ->
                      let c2 =
                        ...
                        norm_comp cfg uu____12542 c1 in
                      let t2 =
                        let uu____12564 = norm_binders cfg env bs1 in
                        FStar_Syntax_Util.arrow uu____12564 c2 in
                      rebuild cfg env stack1 t2)
           | FStar_Syntax_Syntax.Tm_ascribed (t11,(tc,tacopt),l) ->
               (match stack1 with
                | (Match uu____12623)::uu____12624 -> norm cfg env stack1 t11
                | (Arg uu____12633)::uu____12634 -> norm cfg env stack1 t11
                | (App
                    ({
                       FStar_Syntax_Syntax.n =
                         FStar_Syntax_Syntax.Tm_constant
                         (FStar_Const.Const_reify );
                       FStar_Syntax_Syntax.pos = uu____12643;
                       FStar_Syntax_Syntax.vars = uu____12644;_},uu____12645,uu____12646))::uu____12647
                    -> norm cfg env stack1 t11
                | (MemoLazy uu____12654)::uu____12655 ->
                    norm cfg env stack1 t11
                | uu____12664 ->
                    ...
                    (log cfg
                     ...
                     (let tc1 =
                        match tc with
                        | FStar_Util.Inl t2 ->
                            let uu____12685 = norm cfg env [] t2 in
                            FStar_Util.Inl uu____12685
                        | FStar_Util.Inr c ->
                            let uu____12693 = norm_comp cfg env c in
                            FStar_Util.Inr uu____12693 in
                      let tacopt1 =
                        FStar_Util.map_opt tacopt (norm cfg env []) in
                      let uu____12699 =
                        let uu____12700 =
                          let uu____12701 =
                            let uu____12728 = FStar_Syntax_Util.unascribe t12 in
                            (uu____12728, (tc1, tacopt1), l) in
                          FStar_Syntax_Syntax.Tm_ascribed uu____12701 in
                        mk uu____12700 t1.FStar_Syntax_Syntax.pos in
                      rebuild cfg env stack1 uu____12699)))
           | FStar_Syntax_Syntax.Tm_match (head1,branches) ->
               let stack2 =
           ...
           | FStar_Syntax_Syntax.Tm_let
               ((uu____12804,{
                               FStar_Syntax_Syntax.lbname = FStar_Util.Inr
                                 uu____12805;
                               FStar_Syntax_Syntax.lbunivs = uu____12806;
                               FStar_Syntax_Syntax.lbtyp = uu____12807;
                               FStar_Syntax_Syntax.lbeff = uu____12808;
                               FStar_Syntax_Syntax.lbdef = uu____12809;_}::uu____12810),uu____12811)
               -> rebuild cfg env stack1 t1
           | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
               let n1 =
                   ...
                   ((FStar_Syntax_Util.is_pure_effect n1) ||
                      ((FStar_Syntax_Util.is_ghost_effect n1) &&
                         (let uu____12852 =
                          ...
                          Prims.op_Negation uu____12852))) in
               if uu____12847
               then
                 let env1 =
                   let uu____12856 =
                     let uu____12857 =
                       ...
                       (env, (lb.FStar_Syntax_Syntax.lbdef), uu____12876,
                         false) in
                     Clos uu____12857 in
                   uu____12856 :: env in
                 ...
                 (let uu____12928 =
                  ...
                  | (bs,body1) ->
                      ...
                      let lbname =
                        let x =
                          let uu____12949 = FStar_List.hd bs in
                          FStar_Pervasives_Native.fst uu____12949 in
                        FStar_Util.Inl
                          (let uu___196_12959 = x in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___196_12959.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___196_12959.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = ty
                           }) in
                      let lb1 =
                        let uu___197_12961 = lb in
                        let uu____12962 =
                          norm cfg env [] lb.FStar_Syntax_Syntax.lbdef in
                        {
                          FStar_Syntax_Syntax.lbname = lbname;
                          FStar_Syntax_Syntax.lbunivs =
                            (uu___197_12961.FStar_Syntax_Syntax.lbunivs);
                          FStar_Syntax_Syntax.lbtyp = ty;
                          FStar_Syntax_Syntax.lbeff =
                            (uu___197_12961.FStar_Syntax_Syntax.lbeff);
                          FStar_Syntax_Syntax.lbdef = uu____12962
                        } in
                      let env' =
                        FStar_All.pipe_right bs
                          (FStar_List.fold_left
                             (fun env1  -> fun uu____12979  -> Dummy :: env1)
                             env) in
                      norm cfg env'
               ...
               (FStar_List.contains CompressUvars cfg.steps) ||
                 ((FStar_List.contains (Exclude Zeta) cfg.steps) &&
                    (FStar_List.contains PureSubtermsWithinComputations
                       cfg.steps))
               ->
               let uu____13002 = FStar_Syntax_Subst.open_let_rec lbs body in
               (match uu____13002 with
                | (lbs1,body1) ->
                        ...
                        (fun lb  ->
                           ...
                           let lbname =
                             let uu____13038 =
                               ...
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___198_13039.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___198_13039.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = ty
                               } in
                             FStar_Util.Inl uu____13038 in
                           let uu____13040 =
                           ...
                           | (xs,def_body,lopt) ->
                               ...
                               let env1 =
                                 let uu____13060 =
                                   FStar_List.map (fun uu____13064  -> Dummy)
                                     lbs1 in
                                 let uu____13065 =
                                   let uu____13068 =
                                     FStar_List.map
                                       (fun uu____13076  -> Dummy) xs1 in
                                   FStar_List.append uu____13068 env in
                                 FStar_List.append uu____13060 uu____13065 in
                               let def_body1 = norm cfg env1 [] def_body in
                               let lopt1 =
                                 match lopt with
                                 | FStar_Pervasives_Native.Some rc ->
                                     let uu____13088 =
                                       let uu___199_13089 = rc in
                                       let uu____13090 =
                                         FStar_Util.map_opt
                                           rc.FStar_Syntax_Syntax.residual_typ
                                           (norm cfg env1 []) in
                                       {
                                         FStar_Syntax_Syntax.residual_effect
                                           =
                                           (uu___199_13089.FStar_Syntax_Syntax.residual_effect);
                                         FStar_Syntax_Syntax.residual_typ =
                                           uu____13090;
                                         FStar_Syntax_Syntax.residual_flags =
                                           (uu___199_13089.FStar_Syntax_Syntax.residual_flags)
                                       } in
                                     FStar_Pervasives_Native.Some uu____13088
                                 | uu____13097 -> lopt in
                               let def =
                                 FStar_Syntax_Util.abs xs1 def_body1 lopt1 in
                               let uu___200_13101 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname = lbname;
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___200_13101.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp = ty;
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___200_13101.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef = def
                               }) lbs1 in
                    let env' =
                      let uu____13105 =
                        FStar_List.map (fun uu____13109  -> Dummy) lbs2 in
                    ...
                    (match uu____13111 with
                     | (lbs3,body3) ->
                         let t2 =
                           let uu___201_13127 = t1 in
                           {
                             FStar_Syntax_Syntax.n =
                               (FStar_Syntax_Syntax.Tm_let
                                  ((true, lbs3), body3));
                             FStar_Syntax_Syntax.pos =
                               (uu___201_13127.FStar_Syntax_Syntax.pos);
                             FStar_Syntax_Syntax.vars =
                               (uu___201_13127.FStar_Syntax_Syntax.vars)
                           } in
                         rebuild cfg env stack1 t2))
           | FStar_Syntax_Syntax.Tm_let (lbs,body) when
               FStar_List.contains (Exclude Zeta) cfg.steps ->
               let uu____13154 = closure_as_term cfg env t1 in
               rebuild cfg env stack1 uu____13154
                        ...
                        | (rec_env,memos,i) ->
                            let f_i =
                              let uu____13297 =
                                ...
                                {
                                  FStar_Syntax_Syntax.ppname =
                                    (uu___202_13298.FStar_Syntax_Syntax.ppname);
                                  FStar_Syntax_Syntax.index = i;
                                  FStar_Syntax_Syntax.sort =
                                    (uu___202_13298.FStar_Syntax_Syntax.sort)
                                } in
                              FStar_Syntax_Syntax.bv_to_tm uu____13297 in
                            let fix_f_i =
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                      ...
                      | (App
                          ({
                             FStar_Syntax_Syntax.n =
                               FStar_Syntax_Syntax.Tm_constant
                               (FStar_Const.Const_reify );
                             FStar_Syntax_Syntax.pos = uu____13948;
                             FStar_Syntax_Syntax.vars = uu____13949;_},uu____13950,uu____13951))::uu____13952
                          ->
                          FStar_All.pipe_right cfg.steps
                    ...
                    then
                        ...
                        then
                          let uu___203_13970 = cfg in
                          {
                            steps =
                              ...
                              Exclude Zeta;
                              NoDeltaSteps];
                            tcenv = (uu___203_13970.tcenv);
                            delta_level =
                              [FStar_TypeChecker_Env.Inlining;
                              FStar_TypeChecker_Env.Eager_unfolding_only];
                            primitive_steps =
                              (uu___203_13970.primitive_steps)
                          }
                        else
                          (let uu___204_13972 = cfg in
                           {
                             steps =
                               (FStar_List.append [Exclude Zeta] cfg.steps);
                             tcenv = (uu___204_13972.tcenv);
                             delta_level = (uu___204_13972.delta_level);
                             primitive_steps =
                               (uu___204_13972.primitive_steps)
                           }) in
                      norm cfg1 env
                        ((Meta
                      ...
                      (let uu____13974 =
                         let uu____13975 = FStar_Syntax_Subst.compress head1 in
                       ...
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1 in
                           let uu____13993 = ed.FStar_Syntax_Syntax.bind_repr in
                           (match uu____13993 with
                            | (uu____13994,bind_repr) ->
                                (match lb.FStar_Syntax_Syntax.lbname with
                                 | FStar_Util.Inr uu____14000 ->
                                     failwith
                                 ...
                                 | FStar_Util.Inl x ->
                                     ...
                                     (match uu____14046 with
                                      | FStar_Pervasives_Native.Some e ->
                                          let lb1 =
                                            let uu___205_14051 = lb in
                                            {
                                              FStar_Syntax_Syntax.lbname =
                                                (uu___205_14051.FStar_Syntax_Syntax.lbname);
                                              FStar_Syntax_Syntax.lbunivs =
                                                (uu___205_14051.FStar_Syntax_Syntax.lbunivs);
                                              FStar_Syntax_Syntax.lbtyp =
                                                (uu___205_14051.FStar_Syntax_Syntax.lbtyp);
                                              FStar_Syntax_Syntax.lbeff =
                                          ...
                                          norm cfg env uu____14052
                                            uu____14053
                                      | FStar_Pervasives_Native.None  ->
                                          let uu____14087 =
                                            let uu____14088 = is_return body in
                                          ...
                                          then
                                            ...
                                            (let head2 =
                                             ...
                                             let uu____14261 =
                                               FStar_List.tl stack1 in
                                             norm cfg env uu____14261 reified))))
                       | FStar_Syntax_Syntax.Tm_app (head_app,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1 in
                           let uu____14285 = ed.FStar_Syntax_Syntax.bind_repr in
                           (match uu____14285 with
                            | (uu____14286,bind_repr) ->
                                let maybe_unfold_action head2 =
                                  let maybe_extract_fv t3 =
                                    let t4 =
                                      ...
                                      | FStar_Syntax_Syntax.Tm_uinst
                                          (t4,uu____14322) -> t4
                                      | uu____14327 -> head2 in
                                    let uu____14328 =
                                      let uu____14329 =
                                        FStar_Syntax_Subst.compress t4 in
                                      uu____14329.FStar_Syntax_Syntax.n in
                                    match uu____14328 with
                                    | FStar_Syntax_Syntax.Tm_fvar x ->
                                        FStar_Pervasives_Native.Some x
                                    | uu____14335 ->
                                        FStar_Pervasives_Native.None in
                                  let uu____14336 = maybe_extract_fv head2 in
                                  match uu____14336 with
                                  | FStar_Pervasives_Native.Some x when
                                      let uu____14346 =
                                        FStar_Syntax_Syntax.lid_of_fv x in
                                      FStar_TypeChecker_Env.is_action
                                        cfg.tcenv uu____14346
                                      ->
                                ...
                                ((let is_arg_impure uu____14377 =
                                 ...
                                 (let uu____14417 =
                                  ...
                                  | (head_app1,found_action) ->
                                      ...
                                      let uu____14456 = FStar_List.tl stack1 in
                                      norm cfg env uu____14456 body1)))
                       | FStar_Syntax_Syntax.Tm_meta
                           (e,FStar_Syntax_Syntax.Meta_monadic_lift
                            (msrc,mtgt,t'))
                           ->
                           let lifted =
                             let uu____14470 = closure_as_term cfg env t' in
                             reify_lift cfg.tcenv e msrc mtgt uu____14470 in
                           let uu____14471 = FStar_List.tl stack1 in
                           norm cfg env uu____14471 lifted
                               ...
                               (FStar_List.map
                                  (fun uu____14592  ->
                                     ...
                                     | (pat,wopt,tm) ->
                                         ...
                                         (pat, wopt, uu____14640))) in
                           let tm =
                             mk (FStar_Syntax_Syntax.Tm_match (e, branches1))
                               t2.FStar_Syntax_Syntax.pos in
                           let uu____14672 = FStar_List.tl stack1 in
                           norm cfg env uu____14672 tm
                       | uu____14673 -> norm cfg env stack1 head1)
                      ...
                      | (App
                          ({
                             FStar_Syntax_Syntax.n =
                               FStar_Syntax_Syntax.Tm_constant
                               (FStar_Const.Const_reify );
                             FStar_Syntax_Syntax.pos = uu____14682;
                             FStar_Syntax_Syntax.vars = uu____14683;_},uu____14684,uu____14685))::uu____14686
                          ->
                          FStar_All.pipe_right cfg.steps
                            (FStar_List.contains Reify)
                      | uu____14693 -> false in
                    if should_reify
                    then
                      let uu____14694 = FStar_List.tl stack1 in
                      let uu____14695 =
                        let uu____14696 = closure_as_term cfg env t2 in
                        reify_lift cfg.tcenv head1 m1 m' uu____14696 in
                      norm cfg env uu____14694 uu____14695
                    else
                      (let t3 = norm cfg env [] t2 in
                       let uu____14699 =
                         ...
                         let cfg1 =
                           let uu___206_14708 = cfg in
                           {
                             steps =
                               ...
                               EraseUniverses;
                               Exclude Zeta];
                             tcenv = (uu___206_14708.tcenv);
                             delta_level =
                               [FStar_TypeChecker_Env.Inlining;
                               FStar_TypeChecker_Env.Eager_unfolding_only];
                             primitive_steps =
                               (uu___206_14708.primitive_steps)
                           } in
                         norm cfg1 env
                           ((Meta
                                ...
                                norm cfg env
                                  ((Meta
                                      ((FStar_Syntax_Syntax.Meta_pattern
                                        ...
                                        (t1.FStar_Syntax_Syntax.pos))) ::
                                  stack1) head1
                            | uu____14743 -> norm cfg env stack1 head1)
                       | [] ->
                           ...
                           let m1 =
                             ...
                             | FStar_Syntax_Syntax.Meta_pattern args ->
                                 ...
                                 FStar_Syntax_Syntax.Meta_pattern uu____14757
                             | uu____14768 -> m in
                           let t2 =
        ...
        fun mtgt  ->
          fun t  ->
            ...
            then
              ...
              let uu____14780 = ed.FStar_Syntax_Syntax.return_repr in
              match uu____14780 with
              | (uu____14781,return_repr) ->
                  let return_inst =
                    let uu____14790 =
                      let uu____14791 =
                          ...
                          let uu____14807 =
                            let uu____14808 =
                              let uu____14815 =
                                ...
                                [uu____14818] in
                              (return_tm, uu____14815) in
                            FStar_Syntax_Syntax.Tm_uinst uu____14808 in
                          FStar_Syntax_Syntax.mk uu____14807 in
                        uu____14804 FStar_Pervasives_Native.None
                  ...
                  let uu____14829 =
                    let uu____14832 =
                      let uu____14833 =
                        let uu____14848 =
                          let uu____14851 = FStar_Syntax_Syntax.as_arg t in
                          let uu____14852 =
                            let uu____14855 = FStar_Syntax_Syntax.as_arg e in
                            [uu____14855] in
                          uu____14851 :: uu____14852 in
                        (return_inst, uu____14848) in
                      FStar_Syntax_Syntax.Tm_app uu____14833 in
              ...
              (let uu____14864 =
               ...
               | FStar_Pervasives_Native.None  ->
                   ...
                   failwith uu____14867
               | FStar_Pervasives_Native.Some
                   { FStar_TypeChecker_Env.msource = uu____14868;
                     FStar_TypeChecker_Env.mtarget = uu____14869;
                     FStar_TypeChecker_Env.mlift =
                       { FStar_TypeChecker_Env.mlift_wp = uu____14870;
               ...
               | FStar_Pervasives_Native.Some
                   { FStar_TypeChecker_Env.msource = uu____14881;
                     FStar_TypeChecker_Env.mtarget = uu____14882;
                     FStar_TypeChecker_Env.mlift =
                       { FStar_TypeChecker_Env.mlift_wp = uu____14883;
                         FStar_TypeChecker_Env.mlift_term =
                           FStar_Pervasives_Native.Some lift;_};_}
                   ->
                   let uu____14901 = FStar_Syntax_Util.mk_reify e in
                   lift t FStar_Syntax_Syntax.tun uu____14901)
          ...
          (FStar_List.map
             (FStar_List.map
                (fun uu____14957  ->
                   ...
                   | (a,imp) ->
                       let uu____14968 = norm cfg env [] a in
                       (uu____14968, imp))))
and norm_comp:
  ...
  fun cfg  ->
    fun env  ->
      fun comp  ->
        ...
        | FStar_Syntax_Syntax.Total (t,uopt) ->
            let uu___207_14985 = comp1 in
            let uu____14988 =
              let uu____14989 =
                let uu____14998 = norm cfg env [] t in
                let uu____14999 =
                  FStar_Option.map (norm_universe cfg env) uopt in
                (uu____14998, uu____14999) in
              FStar_Syntax_Syntax.Total uu____14989 in
            {
              FStar_Syntax_Syntax.n = uu____14988;
              FStar_Syntax_Syntax.pos =
                (uu___207_14985.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___207_14985.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.GTotal (t,uopt) ->
            let uu___208_15014 = comp1 in
            let uu____15017 =
              let uu____15018 =
              ...
              FStar_Syntax_Syntax.GTotal uu____15018 in
            {
              FStar_Syntax_Syntax.n = uu____15017;
              FStar_Syntax_Syntax.pos =
                (uu___208_15014.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___208_15014.FStar_Syntax_Syntax.vars)
            }
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____15080  ->
                      ...
                      | (a,i) ->
                          let uu____15091 = norm cfg env [] a in
                          (uu____15091, i))) in
            let flags =
              FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
                (FStar_List.map
                   (fun uu___161_15102  ->
                      match uu___161_15102 with
                      | FStar_Syntax_Syntax.DECREASES t ->
                          let uu____15106 = norm cfg env [] t in
                          FStar_Syntax_Syntax.DECREASES uu____15106
                      | f -> f)) in
            let uu___209_15110 = comp1 in
            let uu____15113 =
              let uu____15114 =
                let uu___210_15115 = ct in
                let uu____15116 =
                  FStar_List.map (norm_universe cfg env)
                ...
                {
                  FStar_Syntax_Syntax.comp_univs = uu____15116;
                  FStar_Syntax_Syntax.effect_name =
                    (uu___210_15115.FStar_Syntax_Syntax.effect_name);
                  FStar_Syntax_Syntax.result_typ = uu____15117;
                  FStar_Syntax_Syntax.effect_args = uu____15120;
                  FStar_Syntax_Syntax.flags = flags
                } in
              FStar_Syntax_Syntax.Comp uu____15114 in
            {
              FStar_Syntax_Syntax.n = uu____15113;
              FStar_Syntax_Syntax.pos =
                (uu___209_15110.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___209_15110.FStar_Syntax_Syntax.vars)
            }
  ...
  fun cfg  ->
    fun env  ->
      fun c  ->
        let norm1 t =
          norm
            (let uu___211_15138 = cfg in
             {
               steps =
                 [Eager_unfolding;
                 UnfoldUntil FStar_Syntax_Syntax.Delta_constant;
                 AllowUnboundUniverses];
               tcenv = (uu___211_15138.tcenv);
               delta_level = (uu___211_15138.delta_level);
               primitive_steps = (uu___211_15138.primitive_steps)
             }) env [] t in
        let non_info t =
          let uu____15143 = norm1 t in
          FStar_Syntax_Util.non_informative uu____15143 in
        match c.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Total uu____15146 -> c
        | FStar_Syntax_Syntax.GTotal (t,uopt) when non_info t ->
            let uu___212_15165 = c in
            {
              FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Total (t, uopt));
              FStar_Syntax_Syntax.pos =
                (uu___212_15165.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___212_15165.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.Comp ct ->
            let l =
              FStar_TypeChecker_Env.norm_eff_name cfg.tcenv
            ...
            then
              let ct1 =
                ...
                | FStar_Pervasives_Native.Some pure_eff ->
                    ...
                    let uu___213_15183 = ct in
                    {
                      FStar_Syntax_Syntax.comp_univs =
                        (uu___213_15183.FStar_Syntax_Syntax.comp_univs);
                      FStar_Syntax_Syntax.effect_name = pure_eff;
                      FStar_Syntax_Syntax.result_typ =
                        (uu___213_15183.FStar_Syntax_Syntax.result_typ);
                      FStar_Syntax_Syntax.effect_args =
                        (uu___213_15183.FStar_Syntax_Syntax.effect_args);
                      FStar_Syntax_Syntax.flags = flags
                    }
                | FStar_Pervasives_Native.None  ->
                    let ct1 =
                      FStar_TypeChecker_Env.unfold_effect_abbrev cfg.tcenv c in
                    let uu___214_15185 = ct1 in
                    {
                      FStar_Syntax_Syntax.comp_univs =
                        (uu___214_15185.FStar_Syntax_Syntax.comp_univs);
                      FStar_Syntax_Syntax.effect_name =
                        FStar_Parser_Const.effect_PURE_lid;
                      FStar_Syntax_Syntax.result_typ =
                        (uu___214_15185.FStar_Syntax_Syntax.result_typ);
                      FStar_Syntax_Syntax.effect_args =
                        (uu___214_15185.FStar_Syntax_Syntax.effect_args);
                      FStar_Syntax_Syntax.flags =
                        (uu___214_15185.FStar_Syntax_Syntax.flags)
                    } in
              let uu___215_15186 = c in
              {
                FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct1);
                FStar_Syntax_Syntax.pos =
                  (uu___215_15186.FStar_Syntax_Syntax.pos);
                FStar_Syntax_Syntax.vars =
                  (uu___215_15186.FStar_Syntax_Syntax.vars)
              }
            else c
        | uu____15188 -> c
and norm_binder:
  ...
  fun cfg  ->
    fun env  ->
      fun uu____15191  ->
        ...
        | (x,imp) ->
            let uu____15194 =
              let uu___216_15195 = x in
              let uu____15196 = norm cfg env [] x.FStar_Syntax_Syntax.sort in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___216_15195.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___216_15195.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____15196
              } in
            (uu____15194, imp)
and norm_binders:
  ...
  fun cfg  ->
    fun env  ->
      fun bs  ->
        ...
        match uu____15202 with | (nbs,uu____15248) -> FStar_List.rev nbs
and norm_lcomp_opt:
  cfg ->
    env ->
      FStar_Syntax_Syntax.residual_comp FStar_Pervasives_Native.option ->
    ...
    fun env  ->
      fun lopt  ->
        ...
        | FStar_Pervasives_Native.Some rc ->
            ...
            let uu____15264 =
              let uu___217_15265 = rc in
              let uu____15266 =
                FStar_Util.map_opt rc.FStar_Syntax_Syntax.residual_typ
                  (norm cfg env []) in
              {
                FStar_Syntax_Syntax.residual_effect =
                  (uu___217_15265.FStar_Syntax_Syntax.residual_effect);
                FStar_Syntax_Syntax.residual_typ = uu____15266;
                FStar_Syntax_Syntax.residual_flags =
                  (uu___217_15265.FStar_Syntax_Syntax.residual_flags)
              } in
            FStar_Pervasives_Native.Some uu____15264
        | uu____15273 -> lopt
and rebuild:
  cfg -> env -> stack -> FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
  =
        ...
        fun t  ->
                ...
                then
                  ...
                  let uu____15288 =
                    let uu____15289 =
                      ...
                      FStar_Pervasives_Native.snd uu____15290 in
                    FStar_Util.string_of_int uu____15289 in
                  let uu____15295 = FStar_Syntax_Print.term_to_string tm in
                  let uu____15296 = FStar_Syntax_Print.term_to_string t in
                  FStar_Util.print3 "Normalized (%s ms) %s\n\tto %s\n"
                    uu____15288 uu____15295 uu____15296
                else ());
               rebuild cfg env stack2 t)
          | (Steps (s,ps,dl))::stack2 ->
              rebuild
                (let uu___218_15314 = cfg in
                 {
                   steps = s;
                   tcenv = (uu___218_15314.tcenv);
                   delta_level = dl;
                   primitive_steps = ps
                 }) env stack2 t
          | (Meta (m,r))::stack2 ->
          ...
          | (MemoLazy r)::stack2 ->
              (set_memo r (env, t);
               log cfg
                 (fun uu____15383  ->
                    let uu____15384 = FStar_Syntax_Print.term_to_string t in
                    FStar_Util.print1 "\tSet memo %s\n" uu____15384);
               rebuild cfg env stack2 t)
          ...
          | (Abs (env',bs,env'',lopt,r))::stack2 ->
              ...
              let uu____15420 =
                let uu___219_15421 = FStar_Syntax_Util.abs bs1 t lopt1 in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___219_15421.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.pos = r;
                  FStar_Syntax_Syntax.vars =
                    (uu___219_15421.FStar_Syntax_Syntax.vars)
                } in
              rebuild cfg env stack2 uu____15420
          | (Arg (Univ uu____15422,uu____15423,uu____15424))::uu____15425 ->
              failwith "Impossible"
          | (Arg (Dummy ,uu____15428,uu____15429))::uu____15430 ->
              failwith "Impossible"
          | (UnivArgs (us,r))::stack2 ->
              let t1 = FStar_Syntax_Syntax.mk_Tm_uinst t us in
              rebuild cfg env stack2 t1
          | (Arg (Clos (env1,tm,m,uu____15446),aq,r))::stack2 ->
              (log cfg
                 (fun uu____15475  ->
                    let uu____15476 = FStar_Syntax_Print.term_to_string tm in
               ...
               then
                 ...
                 (let uu____15486 = FStar_ST.op_Bang m in
                  ...
                  | FStar_Pervasives_Native.None  ->
                      ...
                      then
                        ...
                        (let stack3 = (MemoLazy m) :: (App (t, aq, r)) ::
                           stack2 in
                         norm cfg env1 stack3 tm)
                  | FStar_Pervasives_Native.Some (uu____15586,a) ->
                      let t1 =
          ...
          | (App (head1,aq,r))::stack2 ->
              let t1 =
                FStar_Syntax_Syntax.extend_app head1 (t, aq)
                  FStar_Pervasives_Native.None r in
              let uu____15610 = maybe_simplify cfg t1 in
              rebuild cfg env stack2 uu____15610
          | (Match (env1,branches,r))::stack2 ->
              (log cfg
                 (fun uu____15620  ->
                    let uu____15621 = FStar_Syntax_Print.term_to_string t in
                    FStar_Util.print1
                      "Rebuilding with match, scrutinee is %s ...\n"
                      uu____15621);
               (let scrutinee = t in
                let norm_and_rebuild_match uu____15626 =
                  log cfg
                    (fun uu____15631  ->
                       let uu____15632 =
                           ...
                           FStar_All.pipe_right branches
                             (FStar_List.map
                                (fun uu____15651  ->
                                   ...
                                   | (p,uu____15661,uu____15662) ->
                                       FStar_Syntax_Print.pat_to_string p)) in
                         FStar_All.pipe_right uu____15634
                           (FStar_String.concat "\n\t") in
                       FStar_Util.print2
                  ...
                  (let whnf1 = FStar_List.contains WHNF cfg.steps in
                   let cfg_exclude_iota_zeta =
                     ...
                     let uu___220_15688 = cfg in
                     {
                       steps = (FStar_List.append steps' cfg.steps);
                       tcenv = (uu___220_15688.tcenv);
                       delta_level = new_delta;
                       primitive_steps = (uu___220_15688.primitive_steps)
                     } in
                   ...
                   let rec norm_pat env2 p =
                     match p.FStar_Syntax_Syntax.v with
                     | FStar_Syntax_Syntax.Pat_constant uu____15732 ->
                         (p, env2)
                     | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
                         let uu____15755 =
                           FStar_All.pipe_right pats
                             (FStar_List.fold_left
                                (fun uu____15821  ->
                                   fun uu____15822  ->
                                     match (uu____15821, uu____15822) with
                                     | ((pats1,env3),(p1,b)) ->
                                         let uu____15925 = norm_pat env3 p1 in
                         ...
                         (match uu____15755 with
                          | (pats1,env3) ->
                              ((let uu___221_16027 = p in
                                {
                                  FStar_Syntax_Syntax.v =
                                    (FStar_Syntax_Syntax.Pat_cons
                                       (fv, (FStar_List.rev pats1)));
                                  FStar_Syntax_Syntax.p =
                                    (uu___221_16027.FStar_Syntax_Syntax.p)
                                }), env3))
                     | FStar_Syntax_Syntax.Pat_var x ->
                         let x1 =
                           let uu___222_16046 = x in
                           let uu____16047 =
                             norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___222_16046.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___222_16046.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____16047
                           } in
                         ((let uu___223_16055 = p in
                           {
                             FStar_Syntax_Syntax.v =
                               (FStar_Syntax_Syntax.Pat_var x1);
                             FStar_Syntax_Syntax.p =
                               (uu___223_16055.FStar_Syntax_Syntax.p)
                           }), (Dummy :: env2))
                     | FStar_Syntax_Syntax.Pat_wild x ->
                         let x1 =
                           let uu___224_16060 = x in
                           let uu____16061 =
                             norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___224_16060.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___224_16060.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____16061
                           } in
                         ((let uu___225_16069 = p in
                           {
                             FStar_Syntax_Syntax.v =
                               (FStar_Syntax_Syntax.Pat_wild x1);
                             FStar_Syntax_Syntax.p =
                               (uu___225_16069.FStar_Syntax_Syntax.p)
                           }), (Dummy :: env2))
                     | FStar_Syntax_Syntax.Pat_dot_term (x,t1) ->
                         let x1 =
                           let uu___226_16079 = x in
                           let uu____16080 =
                             norm_or_whnf env2 x.FStar_Syntax_Syntax.sort in
                           {
                             FStar_Syntax_Syntax.ppname =
                               (uu___226_16079.FStar_Syntax_Syntax.ppname);
                             FStar_Syntax_Syntax.index =
                               (uu___226_16079.FStar_Syntax_Syntax.index);
                             FStar_Syntax_Syntax.sort = uu____16080
                           } in
                         let t2 = norm_or_whnf env2 t1 in
                         ((let uu___227_16089 = p in
                           {
                             FStar_Syntax_Syntax.v =
                               (FStar_Syntax_Syntax.Pat_dot_term (x1, t2));
                             FStar_Syntax_Syntax.p =
                               (uu___227_16089.FStar_Syntax_Syntax.p)
                           }), env2) in
                   let branches1 =
                     match env1 with
                     | [] when whnf1 -> branches
                         ...
                         FStar_All.pipe_right branches
                           (FStar_List.map
                              (fun branch1  ->
                                 ...
                                 | (p,wopt,e) ->
                                     let uu____16127 = norm_pat env1 p in
                   ...
                   let uu____16164 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r in
                   rebuild cfg env1 stack2 uu____16164) in
                let rec is_cons head1 =
                  match head1.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Tm_uinst (h,uu____16174) -> is_cons h
                  | FStar_Syntax_Syntax.Tm_constant uu____16179 -> true
                  | FStar_Syntax_Syntax.Tm_fvar
                      { FStar_Syntax_Syntax.fv_name = uu____16180;
                        FStar_Syntax_Syntax.fv_delta = uu____16181;
                        FStar_Syntax_Syntax.fv_qual =
                          FStar_Pervasives_Native.Some
                          (FStar_Syntax_Syntax.Data_ctor );_}
                      -> true
                  | FStar_Syntax_Syntax.Tm_fvar
                      { FStar_Syntax_Syntax.fv_name = uu____16182;
                        FStar_Syntax_Syntax.fv_delta = uu____16183;
                        FStar_Syntax_Syntax.fv_qual =
                          FStar_Pervasives_Native.Some
                          (FStar_Syntax_Syntax.Record_ctor uu____16184);_}
                      -> true
                  | uu____16191 -> false in
                ...
                let rec matches_pat scrutinee_orig p =
                  ...
                  | (head1,args) ->
                      (match p.FStar_Syntax_Syntax.v with
                       | FStar_Syntax_Syntax.Pat_var uu____16369 ->
                           FStar_Util.Inl [scrutinee_orig]
                       | FStar_Syntax_Syntax.Pat_wild uu____16372 ->
                           FStar_Util.Inl [scrutinee_orig]
                       | FStar_Syntax_Syntax.Pat_dot_term uu____16375 ->
                           FStar_Util.Inl []
                       | FStar_Syntax_Syntax.Pat_constant s ->
                           (match scrutinee1.FStar_Syntax_Syntax.n with
                            ...
                            | uu____16394 ->
                                let uu____16395 =
                                  let uu____16396 = is_cons head1 in
                                  Prims.op_Negation uu____16396 in
                                FStar_Util.Inr uu____16395)
                       | FStar_Syntax_Syntax.Pat_cons (fv,arg_pats) ->
                           let uu____16417 =
                             let uu____16418 =
                               FStar_Syntax_Util.un_uinst head1 in
                             uu____16418.FStar_Syntax_Syntax.n in
                           (match uu____16417 with
                            ...
                            | uu____16428 ->
                                let uu____16429 =
                                  let uu____16430 = is_cons head1 in
                                  Prims.op_Negation uu____16430 in
                                FStar_Util.Inr uu____16429))
                and matches_args out a p =
                  match (a, p) with
                  | ([],[]) -> FStar_Util.Inl out
                  | ((t1,uu____16483)::rest_a,(p1,uu____16486)::rest_p) ->
                      let uu____16530 = matches_pat t1 p1 in
                      (match uu____16530 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____16555 -> FStar_Util.Inr false in
                let rec matches scrutinee1 p =
                  match p with
                  | [] -> norm_and_rebuild_match ()
                  | (p1,wopt,b)::rest ->
                      let uu____16657 = matches_pat scrutinee1 p1 in
                                        ...
                                        let uu____16698 =
                                          let uu____16717 =
                                            FStar_Util.mk_ref
                                              (FStar_Pervasives_Native.Some
                                                 ([], t1)) in
                                          ([], t1, uu____16717, false) in
                                        Clos uu____16698 in
                                      uu____16697 :: env2) env1 s in
                             let uu____16770 = guard_when_clause wopt b rest in
                             norm cfg env2 stack2 uu____16770))) in
                let uu____16771 =
                  FStar_All.pipe_right cfg.steps
    ...
    fun s  ->
      fun e  ->
        fun t  ->
          let c = config s e in
          let c1 =
            let uu___228_16833 = config s e in
            {
              steps = (uu___228_16833.steps);
              tcenv = (uu___228_16833.tcenv);
              delta_level = (uu___228_16833.delta_level);
...
let normalize_comp:
  ...
  fun s  ->
    fun e  ->
      fun t  -> let uu____16858 = config s e in norm_comp uu____16858 [] t
let normalize_universe:
  ...
  fun env  ->
    fun u  ->
      let uu____16867 = config [] env in norm_universe uu____16867 [] u
let ghost_to_pure:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp -> FStar_Syntax_Syntax.comp
  =
  fun env  ->
    fun c  ->
      let uu____16876 = config [] env in ghost_to_pure_aux uu____16876 [] c
let ghost_to_pure_lcomp:
  ...
  fun env  ->
    fun lc  ->
      ...
      let non_info t =
        let uu____16890 = norm cfg [] [] t in
        FStar_Syntax_Util.non_informative uu____16890 in
      let uu____16891 =
      ...
      then
        ...
        with
        | FStar_Pervasives_Native.Some pure_eff ->
            let uu___229_16893 = lc in
            {
              FStar_Syntax_Syntax.eff_name = pure_eff;
              FStar_Syntax_Syntax.res_typ =
                (uu___229_16893.FStar_Syntax_Syntax.res_typ);
              FStar_Syntax_Syntax.cflags =
                (uu___229_16893.FStar_Syntax_Syntax.cflags);
              FStar_Syntax_Syntax.comp =
                ((fun uu____16896  ->
                    let uu____16897 = lc.FStar_Syntax_Syntax.comp () in
                    ghost_to_pure env uu____16897))
            }
  ...
  fun env  ->
    fun t  ->
      let t1 =
        ...
        with
        | e ->
            ((let uu____16916 = FStar_Util.message_of_exn e in
...
let comp_to_string:
  ...
  fun env  ->
    fun c  ->
      let c1 =
        try
          let uu____16929 = config [AllowUnboundUniverses] env in
          norm_comp uu____16929 [] c
        with
        | e ->
            ((let uu____16936 = FStar_Util.message_of_exn e in
              FStar_Util.print1_warning "Normalization failed with error %s"
                uu____16936);
             c) in
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____16976 =
                     let uu____16977 =
                       let uu____16984 = FStar_Syntax_Util.mk_conj phi1 phi in
                       (y, uu____16984) in
                     FStar_Syntax_Syntax.Tm_refine uu____16977 in
                   mk uu____16976 t01.FStar_Syntax_Syntax.pos
               | uu____16989 -> t2)
          | uu____16990 -> t2 in
        aux t
let unfold_whnf:
...
let eta_expand_with_type:
  ...
  fun env  ->
    fun e  ->
      fun t_e  ->
        let uu____17042 = FStar_Syntax_Util.arrow_formals_comp t_e in
        match uu____17042 with
        | (formals,c) ->
            (match formals with
             | [] -> e
             | uu____17071 ->
                 let uu____17078 = FStar_Syntax_Util.abs_formals e in
                 (match uu____17078 with
                  | (actuals,uu____17088,uu____17089) ->
                      if
                      ...
                      then e
                        ...
                        (let uu____17103 =
                         ...
                         | (binders,args) ->
                             ...
                             FStar_Syntax_Util.abs binders uu____17120
                               (FStar_Pervasives_Native.Some
    ...
    fun t  ->
      ...
      | uu____17130 ->
          ...
          (match uu____17131 with
           | (head1,args) ->
               let uu____17168 =
                 let uu____17169 = FStar_Syntax_Subst.compress head1 in
                 uu____17169.FStar_Syntax_Syntax.n in
               (match uu____17168 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____17172,thead) ->
                    let uu____17198 = FStar_Syntax_Util.arrow_formals thead in
                         ...
                         then t
                           ...
                           (let uu____17240 =
                              env.FStar_TypeChecker_Env.type_of
                                (let uu___234_17248 = env in
                                 {
                                   FStar_TypeChecker_Env.solver =
                                     (uu___234_17248.FStar_TypeChecker_Env.solver);
                                   FStar_TypeChecker_Env.range =
                                     (uu___234_17248.FStar_TypeChecker_Env.range);
                                   FStar_TypeChecker_Env.curmodule =
                                     (uu___234_17248.FStar_TypeChecker_Env.curmodule);
                                   FStar_TypeChecker_Env.gamma =
                                     (uu___234_17248.FStar_TypeChecker_Env.gamma);
                                   FStar_TypeChecker_Env.gamma_cache =
                                     (uu___234_17248.FStar_TypeChecker_Env.gamma_cache);
                                   FStar_TypeChecker_Env.modules =
                                     (uu___234_17248.FStar_TypeChecker_Env.modules);
                                   FStar_TypeChecker_Env.expected_typ =
                                     FStar_Pervasives_Native.None;
                                   FStar_TypeChecker_Env.sigtab =
                                     (uu___234_17248.FStar_TypeChecker_Env.sigtab);
                                   FStar_TypeChecker_Env.is_pattern =
                                     (uu___234_17248.FStar_TypeChecker_Env.is_pattern);
                                   FStar_TypeChecker_Env.instantiate_imp =
                                     (uu___234_17248.FStar_TypeChecker_Env.instantiate_imp);
                                   FStar_TypeChecker_Env.effects =
                                     (uu___234_17248.FStar_TypeChecker_Env.effects);
                                   FStar_TypeChecker_Env.generalize =
                                     (uu___234_17248.FStar_TypeChecker_Env.generalize);
                                   FStar_TypeChecker_Env.letrecs =
                                     (uu___234_17248.FStar_TypeChecker_Env.letrecs);
                                   FStar_TypeChecker_Env.top_level =
                                     (uu___234_17248.FStar_TypeChecker_Env.top_level);
                                   FStar_TypeChecker_Env.check_uvars =
                                     (uu___234_17248.FStar_TypeChecker_Env.check_uvars);
                                   FStar_TypeChecker_Env.use_eq =
                                     (uu___234_17248.FStar_TypeChecker_Env.use_eq);
                                   FStar_TypeChecker_Env.is_iface =
                                     (uu___234_17248.FStar_TypeChecker_Env.is_iface);
                                   FStar_TypeChecker_Env.admit =
                                     (uu___234_17248.FStar_TypeChecker_Env.admit);
                                   FStar_TypeChecker_Env.lax = true;
                                   FStar_TypeChecker_Env.lax_universes =
                                     (uu___234_17248.FStar_TypeChecker_Env.lax_universes);
                                   FStar_TypeChecker_Env.failhard =
                                     (uu___234_17248.FStar_TypeChecker_Env.failhard);
                                   FStar_TypeChecker_Env.nosynth =
                                     (uu___234_17248.FStar_TypeChecker_Env.nosynth);
                                   FStar_TypeChecker_Env.tc_term =
                                     (uu___234_17248.FStar_TypeChecker_Env.tc_term);
                                   FStar_TypeChecker_Env.type_of =
                                     (uu___234_17248.FStar_TypeChecker_Env.type_of);
                                   FStar_TypeChecker_Env.universe_of =
                                     (uu___234_17248.FStar_TypeChecker_Env.universe_of);
                                   FStar_TypeChecker_Env.use_bv_sorts = true;
                                   FStar_TypeChecker_Env.qname_and_index =
                                     (uu___234_17248.FStar_TypeChecker_Env.qname_and_index);
                                   FStar_TypeChecker_Env.proof_ns =
                                     (uu___234_17248.FStar_TypeChecker_Env.proof_ns);
                                   FStar_TypeChecker_Env.synth =
                                     (uu___234_17248.FStar_TypeChecker_Env.synth);
                                   FStar_TypeChecker_Env.is_native_tactic =
                                     (uu___234_17248.FStar_TypeChecker_Env.is_native_tactic);
                                   FStar_TypeChecker_Env.identifier_info =
                                     (uu___234_17248.FStar_TypeChecker_Env.identifier_info)
                                 }) t in
                            match uu____17240 with
                            | (uu____17249,ty,uu____17251) ->
                                eta_expand_with_type env t ty))
                | uu____17252 ->
                    let uu____17253 =
                      env.FStar_TypeChecker_Env.type_of
                        (let uu___235_17261 = env in
                         {
                           FStar_TypeChecker_Env.solver =
                             (uu___235_17261.FStar_TypeChecker_Env.solver);
                           FStar_TypeChecker_Env.range =
                             (uu___235_17261.FStar_TypeChecker_Env.range);
                           FStar_TypeChecker_Env.curmodule =
                             (uu___235_17261.FStar_TypeChecker_Env.curmodule);
                           FStar_TypeChecker_Env.gamma =
                             (uu___235_17261.FStar_TypeChecker_Env.gamma);
                           FStar_TypeChecker_Env.gamma_cache =
                             (uu___235_17261.FStar_TypeChecker_Env.gamma_cache);
                           FStar_TypeChecker_Env.modules =
                             (uu___235_17261.FStar_TypeChecker_Env.modules);
                           FStar_TypeChecker_Env.expected_typ =
                             FStar_Pervasives_Native.None;
                           FStar_TypeChecker_Env.sigtab =
                             (uu___235_17261.FStar_TypeChecker_Env.sigtab);
                           FStar_TypeChecker_Env.is_pattern =
                             (uu___235_17261.FStar_TypeChecker_Env.is_pattern);
                           FStar_TypeChecker_Env.instantiate_imp =
                             (uu___235_17261.FStar_TypeChecker_Env.instantiate_imp);
                           FStar_TypeChecker_Env.effects =
                             (uu___235_17261.FStar_TypeChecker_Env.effects);
                           FStar_TypeChecker_Env.generalize =
                             (uu___235_17261.FStar_TypeChecker_Env.generalize);
                           FStar_TypeChecker_Env.letrecs =
                             (uu___235_17261.FStar_TypeChecker_Env.letrecs);
                           FStar_TypeChecker_Env.top_level =
                             (uu___235_17261.FStar_TypeChecker_Env.top_level);
                           FStar_TypeChecker_Env.check_uvars =
                             (uu___235_17261.FStar_TypeChecker_Env.check_uvars);
                           FStar_TypeChecker_Env.use_eq =
                             (uu___235_17261.FStar_TypeChecker_Env.use_eq);
                           FStar_TypeChecker_Env.is_iface =
                             (uu___235_17261.FStar_TypeChecker_Env.is_iface);
                           FStar_TypeChecker_Env.admit =
                             (uu___235_17261.FStar_TypeChecker_Env.admit);
                           FStar_TypeChecker_Env.lax = true;
                           FStar_TypeChecker_Env.lax_universes =
                             (uu___235_17261.FStar_TypeChecker_Env.lax_universes);
                           FStar_TypeChecker_Env.failhard =
                             (uu___235_17261.FStar_TypeChecker_Env.failhard);
                           FStar_TypeChecker_Env.nosynth =
                             (uu___235_17261.FStar_TypeChecker_Env.nosynth);
                           FStar_TypeChecker_Env.tc_term =
                             (uu___235_17261.FStar_TypeChecker_Env.tc_term);
                           FStar_TypeChecker_Env.type_of =
                             (uu___235_17261.FStar_TypeChecker_Env.type_of);
                           FStar_TypeChecker_Env.universe_of =
                             (uu___235_17261.FStar_TypeChecker_Env.universe_of);
                           FStar_TypeChecker_Env.use_bv_sorts = true;
                           FStar_TypeChecker_Env.qname_and_index =
                             (uu___235_17261.FStar_TypeChecker_Env.qname_and_index);
                           FStar_TypeChecker_Env.proof_ns =
                             (uu___235_17261.FStar_TypeChecker_Env.proof_ns);
                           FStar_TypeChecker_Env.synth =
                             (uu___235_17261.FStar_TypeChecker_Env.synth);
                           FStar_TypeChecker_Env.is_native_tactic =
                             (uu___235_17261.FStar_TypeChecker_Env.is_native_tactic);
                           FStar_TypeChecker_Env.identifier_info =
                             (uu___235_17261.FStar_TypeChecker_Env.identifier_info)
                         }) t in
                    (match uu____17253 with
                     | (uu____17262,ty,uu____17264) ->
                         eta_expand_with_type env t ty)))
      ...
      fun binders  ->
        fun tc  ->
          let t =
            ...
            | (uu____17342,FStar_Util.Inr c) ->
                FStar_Syntax_Syntax.mk
                  (FStar_Syntax_Syntax.Tm_arrow (binders, c))
                  FStar_Pervasives_Native.None c.FStar_Syntax_Syntax.pos
            | (uu____17348,FStar_Util.Inl t) ->
                let uu____17354 =
                  let uu____17357 =
                    let uu____17358 =
                      let uu____17371 = FStar_Syntax_Syntax.mk_Total t in
                      (binders, uu____17371) in
                    FStar_Syntax_Syntax.Tm_arrow uu____17358 in
                  FStar_Syntax_Syntax.mk uu____17357 in
                uu____17354 FStar_Pervasives_Native.None
                  t.FStar_Syntax_Syntax.pos in
          let uu____17375 = FStar_Syntax_Subst.open_univ_vars univ_names t in
          ...
          | (univ_names1,t1) ->
              ...
              let uu____17402 =
                ...
                | uu____17457 ->
                    let uu____17458 =
                      let uu____17467 =
                        let uu____17468 = FStar_Syntax_Subst.compress t3 in
                        uu____17468.FStar_Syntax_Syntax.n in
                      (uu____17467, tc) in
                    (match uu____17458 with
                     | (FStar_Syntax_Syntax.Tm_arrow
                        (binders1,c),FStar_Util.Inr uu____17493) ->
                         (binders1, (FStar_Util.Inr c))
                     | (FStar_Syntax_Syntax.Tm_arrow
                        (binders1,c),FStar_Util.Inl uu____17530) ->
                         (binders1,
                           (FStar_Util.Inl (FStar_Syntax_Util.comp_result c)))
                     | (uu____17569,FStar_Util.Inl uu____17570) ->
                         ([], (FStar_Util.Inl t3))
                     | uu____17593 -> failwith "Impossible") in
      ...
      fun binders  ->
        fun t  ->
          ...
          | (univ_names1,binders1,tc) ->
              let uu____17760 = FStar_Util.left tc in
              (univ_names1, binders1, uu____17760)
    ...
    fun univ_names  ->
      fun binders  ->
        fun c  ->
          ...
          | (univ_names1,binders1,tc) ->
              let uu____17859 = FStar_Util.right tc in
              (univ_names1, binders1, uu____17859)
let rec elim_uvars:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun s  ->
      ...
      | FStar_Syntax_Syntax.Sig_inductive_typ
          ...
          let uu____17894 = elim_uvars_aux_t env univ_names binders typ in
          (match uu____17894 with
           | (univ_names1,binders1,typ1) ->
               let uu___236_17922 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_inductive_typ
                      (lid, univ_names1, binders1, typ1, lids, lids'));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___236_17922.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___236_17922.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___236_17922.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___236_17922.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_bundle (sigs,lids) ->
          let uu___237_17943 = s in
          let uu____17944 =
            let uu____17945 =
              let uu____17954 = FStar_List.map (elim_uvars env) sigs in
              (uu____17954, lids) in
            FStar_Syntax_Syntax.Sig_bundle uu____17945 in
          {
            FStar_Syntax_Syntax.sigel = uu____17944;
            FStar_Syntax_Syntax.sigrng =
              (uu___237_17943.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___237_17943.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___237_17943.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___237_17943.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_datacon (lid,univ_names,typ,lident,i,lids) ->
          let uu____17971 = elim_uvars_aux_t env univ_names [] typ in
          (match uu____17971 with
           | (univ_names1,uu____17989,typ1) ->
               let uu___238_18003 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_datacon
                      (lid, univ_names1, typ1, lident, i, lids));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___238_18003.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___238_18003.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___238_18003.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___238_18003.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_declare_typ (lid,univ_names,typ) ->
          let uu____18009 = elim_uvars_aux_t env univ_names [] typ in
          (match uu____18009 with
           | (univ_names1,uu____18027,typ1) ->
               let uu___239_18041 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_declare_typ
                      (lid, univ_names1, typ1));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___239_18041.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___239_18041.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___239_18041.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___239_18041.FStar_Syntax_Syntax.sigattrs)
               })
                    ...
                    | (opening,lbunivs) ->
                        let elim t =
                          let uu____18098 =
                            ...
                            remove_uvar_solutions env uu____18099 in
                          FStar_Syntax_Subst.close_univ_vars lbunivs
                            uu____18098 in
                        let lbtyp = elim lb.FStar_Syntax_Syntax.lbtyp in
                        let lbdef = elim lb.FStar_Syntax_Syntax.lbdef in
                        let uu___240_18102 = lb in
                        {
                          FStar_Syntax_Syntax.lbname =
                            (uu___240_18102.FStar_Syntax_Syntax.lbname);
                          FStar_Syntax_Syntax.lbunivs = lbunivs;
                          FStar_Syntax_Syntax.lbtyp = lbtyp;
                          FStar_Syntax_Syntax.lbeff =
                            (uu___240_18102.FStar_Syntax_Syntax.lbeff);
                          FStar_Syntax_Syntax.lbdef = lbdef
                        })) in
          let uu___241_18103 = s in
          {
            FStar_Syntax_Syntax.sigel =
              (FStar_Syntax_Syntax.Sig_let ((b, lbs1), lids));
            FStar_Syntax_Syntax.sigrng =
              (uu___241_18103.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___241_18103.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___241_18103.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___241_18103.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_main t ->
          let uu___242_18115 = s in
          let uu____18116 =
            let uu____18117 = remove_uvar_solutions env t in
            FStar_Syntax_Syntax.Sig_main uu____18117 in
          {
            FStar_Syntax_Syntax.sigel = uu____18116;
            FStar_Syntax_Syntax.sigrng =
              (uu___242_18115.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___242_18115.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___242_18115.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___242_18115.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_assume (l,us,t) ->
          let uu____18121 = elim_uvars_aux_t env us [] t in
          (match uu____18121 with
           | (us1,uu____18139,t1) ->
               let uu___243_18153 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_assume (l, us1, t1));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___243_18153.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___243_18153.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___243_18153.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___243_18153.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_new_effect_for_free uu____18154 ->
      ...
      | FStar_Syntax_Syntax.Sig_new_effect ed ->
          ...
          (match uu____18156 with
           | (univs1,binders,signature) ->
               let uu____18184 =
                 let uu____18193 = FStar_Syntax_Subst.univ_var_opening univs1 in
                 match uu____18193 with
                 | (univs_opening,univs2) ->
                     let uu____18220 =
                       FStar_Syntax_Subst.univ_var_closing univs2 in
                     (univs_opening, uu____18220) in
               (match uu____18184 with
                | (univs_opening,univs_closing) ->
                    let uu____18237 =
                      ...
                      (uu____18243, uu____18244) in
                    (match uu____18237 with
                     | (b_opening,b_closing) ->
                         let n1 = FStar_List.length univs1 in
                         let n_binders = FStar_List.length binders in
                         let elim_tscheme uu____18266 =
                                              ...
                                              let t2 =
                                                let uu____18350 =
                                                  FStar_Syntax_Subst.subst
                                                    b_opening1 t1 in
                                                FStar_Syntax_Subst.subst
                                                  univs_opening1 uu____18350 in
                                              let uu____18351 =
                                                elim_uvars_aux_t env [] [] t2 in
                                              (match uu____18351 with
                                               | (uu____18372,uu____18373,t3)
                                                   ->
                                                   let t4 =
                                                     let uu____18388 =
                                                       let uu____18389 =
                         ...
                         let elim_term t =
                           ...
                           | (uu____18407,uu____18408,t1) -> t1 in
                         let elim_action a =
                           ...
                           let destruct_action_body body =
                             ...
                             | FStar_Syntax_Syntax.Tm_ascribed
                                 ...
                                 -> (defn, typ)
                             | uu____18545 -> failwith "Impossible" in
                           let destruct_action_typ_templ t =
                             ...
                             | FStar_Syntax_Syntax.Tm_abs
                                 (pars,body,uu____18596) ->
                                 let uu____18617 = destruct_action_body body in
                                 (match uu____18617 with
                                  | (defn,typ) -> (pars, defn, typ))
                             | uu____18662 ->
                                 let uu____18663 = destruct_action_body t in
                           ...
                           | (action_univs,t) ->
                               let uu____18721 = destruct_action_typ_templ t in
                               (match uu____18721 with
                                | (action_params,action_defn,action_typ) ->
                                    let a' =
                                      let uu___244_18762 = a in
                                      {
                                        FStar_Syntax_Syntax.action_name =
                                          (uu___244_18762.FStar_Syntax_Syntax.action_name);
                                        FStar_Syntax_Syntax.action_unqualified_name
                                          =
                                          (uu___244_18762.FStar_Syntax_Syntax.action_unqualified_name);
                         ...
                         let ed1 =
                               ...
                               ed.FStar_Syntax_Syntax.actions in
                           {
                             FStar_Syntax_Syntax.cattributes =
                               (uu___245_18764.FStar_Syntax_Syntax.cattributes);
                             FStar_Syntax_Syntax.mname =
                               (uu___245_18764.FStar_Syntax_Syntax.mname);
                             FStar_Syntax_Syntax.univs = univs1;
                             FStar_Syntax_Syntax.binders = binders;
                             FStar_Syntax_Syntax.signature = signature;
                             FStar_Syntax_Syntax.ret_wp = uu____18765;
                             FStar_Syntax_Syntax.bind_wp = uu____18766;
                             FStar_Syntax_Syntax.if_then_else = uu____18767;
                             FStar_Syntax_Syntax.ite_wp = uu____18768;
                             FStar_Syntax_Syntax.stronger = uu____18769;
                             FStar_Syntax_Syntax.close_wp = uu____18770;
                             FStar_Syntax_Syntax.assert_p = uu____18771;
                             FStar_Syntax_Syntax.assume_p = uu____18772;
                             FStar_Syntax_Syntax.null_wp = uu____18773;
                             FStar_Syntax_Syntax.trivial = uu____18774;
                             FStar_Syntax_Syntax.repr = uu____18775;
                             FStar_Syntax_Syntax.return_repr = uu____18776;
                             FStar_Syntax_Syntax.bind_repr = uu____18777;
                             FStar_Syntax_Syntax.actions = uu____18778
                           } in
                         let uu___246_18781 = s in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_new_effect ed1);
                           FStar_Syntax_Syntax.sigrng =
                             (uu___246_18781.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             (uu___246_18781.FStar_Syntax_Syntax.sigquals);
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___246_18781.FStar_Syntax_Syntax.sigmeta);
                           FStar_Syntax_Syntax.sigattrs =
                             (uu___246_18781.FStar_Syntax_Syntax.sigattrs)
                         })))
      | FStar_Syntax_Syntax.Sig_sub_effect sub_eff ->
          let elim_tscheme_opt uu___164_18798 =
            match uu___164_18798 with
            | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
            | FStar_Pervasives_Native.Some (us,t) ->
                let uu____18825 = elim_uvars_aux_t env us [] t in
                (match uu____18825 with
                 | (us1,uu____18849,t1) ->
                     FStar_Pervasives_Native.Some (us1, t1)) in
          let sub_eff1 =
            let uu___247_18868 = sub_eff in
            let uu____18869 =
              ...
              elim_tscheme_opt sub_eff.FStar_Syntax_Syntax.lift in
            {
              FStar_Syntax_Syntax.source =
                (uu___247_18868.FStar_Syntax_Syntax.source);
              FStar_Syntax_Syntax.target =
                (uu___247_18868.FStar_Syntax_Syntax.target);
              FStar_Syntax_Syntax.lift_wp = uu____18869;
              FStar_Syntax_Syntax.lift = uu____18872
            } in
          let uu___248_18875 = s in
          {
            FStar_Syntax_Syntax.sigel =
              (FStar_Syntax_Syntax.Sig_sub_effect sub_eff1);
            FStar_Syntax_Syntax.sigrng =
              (uu___248_18875.FStar_Syntax_Syntax.sigrng);
            FStar_Syntax_Syntax.sigquals =
              (uu___248_18875.FStar_Syntax_Syntax.sigquals);
            FStar_Syntax_Syntax.sigmeta =
              (uu___248_18875.FStar_Syntax_Syntax.sigmeta);
            FStar_Syntax_Syntax.sigattrs =
              (uu___248_18875.FStar_Syntax_Syntax.sigattrs)
          }
      | FStar_Syntax_Syntax.Sig_effect_abbrev
          (lid,univ_names,binders,comp,flags) ->
          let uu____18885 = elim_uvars_aux_c env univ_names binders comp in
          (match uu____18885 with
           | (univ_names1,binders1,comp1) ->
               let uu___249_18919 = s in
               {
                 FStar_Syntax_Syntax.sigel =
                   (FStar_Syntax_Syntax.Sig_effect_abbrev
                      (lid, univ_names1, binders1, comp1, flags));
                 FStar_Syntax_Syntax.sigrng =
                   (uu___249_18919.FStar_Syntax_Syntax.sigrng);
                 FStar_Syntax_Syntax.sigquals =
                   (uu___249_18919.FStar_Syntax_Syntax.sigquals);
                 FStar_Syntax_Syntax.sigmeta =
                   (uu___249_18919.FStar_Syntax_Syntax.sigmeta);
                 FStar_Syntax_Syntax.sigattrs =
                   (uu___249_18919.FStar_Syntax_Syntax.sigattrs)
               })
      | FStar_Syntax_Syntax.Sig_pragma uu____18930 -> s