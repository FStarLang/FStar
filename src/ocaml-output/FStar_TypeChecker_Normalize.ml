               ...
               (match m with
                                   ...
                                   (match lb.FStar_Syntax_Syntax.lbname with
                                    | FStar_Util.Inl x ->
                                          ...
                                          let uu____5853 =
                                            let uu____5856 =
                                              ...
                                              FStar_Syntax_Syntax.Tm_abs
                                                uu____5857
                                               in
                                            FStar_Syntax_Syntax.mk uu____5856
                                             in
                                          uu____5853 None
                                          ...
                                          let uu____5904 =
                                            let uu____5905 =
                                              FStar_Syntax_Subst.compress
                                                bind_repr
                                               in
                                            uu____5905.FStar_Syntax_Syntax.n
                                             in
                                          match uu____5904 with
                                          | FStar_Syntax_Syntax.Tm_uinst
                                              (bind,uu____5911::uu____5912::[])
                                              ->
                                              let uu____5918 =
                                                let uu____5921 =
                                                  let uu____5922 =
                                        ...
                                        let uu____5993 = FStar_List.tl stack
                                           in
                                        norm cfg env uu____5993 reified
                               ...
                               | (uu____6013,bind_repr) ->
                                   let maybe_unfold_action head =
                                         ...
                                         let uu____6036 =
                                           let uu____6037 =
                                             FStar_Syntax_Subst.compress t
                                              in
                                           uu____6037.FStar_Syntax_Syntax.n
                                            in
                                     ...
                                     | Some x when
                                         ...
                                         let action_unfolded =
                                           ...
                                           | Some uu____6069 -> Some true
                                           | uu____6070 -> Some false  in
                                         (head, action_unfolded)
                                     | uu____6073 -> (head, None)  in
                                         ...
                                         let uu____6181 =
                                           let uu____6182 =
                                             FStar_Syntax_Subst.compress e
                                              in
                                           uu____6182.FStar_Syntax_Syntax.n
                                            in
                                                ...
                                                let uu____6236 =
                                                  let uu____6237 =
                                                    FStar_Syntax_Subst.compress
                                                      bind_repr
                                                     in
                                                  uu____6237.FStar_Syntax_Syntax.n
                                                   in
                                                match uu____6236 with
                                                | FStar_Syntax_Syntax.Tm_uinst
                                                    (bind,uu____6243::uu____6244::[])
                                                    ->
                                                    let uu____6250 =
                                                      let uu____6253 =
                                                        let uu____6254 =
                                   ...
                                   let binded_head =
                                     let uu____6345 =
                                       ...
                                       uu____6349 :: args  in
                                     bind_on_lift uu____6345 []  in
                                   let uu____6354 = FStar_List.tl stack  in
                                   norm cfg env uu____6354 binded_head)
                          | FStar_Syntax_Syntax.Tm_meta
                              ...
                              let uu____6368 = FStar_List.tl stack  in
                              norm cfg env uu____6368 lifted
                          | FStar_Syntax_Syntax.Tm_match (e,branches) ->
                              ...
                              let tm =
                                mk
                                  ...
                                  t.FStar_Syntax_Syntax.pos
                                 in
                              let uu____6515 = FStar_List.tl stack  in
                              norm cfg env uu____6515 tm
                          | uu____6516 -> norm cfg env stack head))
                | FStar_Syntax_Syntax.Meta_monadic_lift (m,m',t) ->
                      ...
                      | (App
                          ({
                             FStar_Syntax_Syntax.n =
                               FStar_Syntax_Syntax.Tm_constant
                               (FStar_Const.Const_reify );
                             FStar_Syntax_Syntax.tk = uu____6525;
                             FStar_Syntax_Syntax.pos = uu____6526;
                             FStar_Syntax_Syntax.vars = uu____6527;_},uu____6528,uu____6529))::uu____6530
                          ->
                          FStar_All.pipe_right cfg.steps
                            (FStar_List.contains Reify)
                      | uu____6536 -> false  in
                    (match should_reify with
                     | true  ->
                         let uu____6537 = FStar_List.tl stack  in
                         let uu____6538 = reify_lift cfg.tcenv head m m' t
                            in
                         norm cfg env uu____6537 uu____6538
                     | uu____6539 ->
                         let uu____6540 =
                ...
                | uu____6551 ->
                    (match stack with
                     | uu____6552::uu____6553 ->
                         (match m with
                          | FStar_Syntax_Syntax.Meta_labeled (l,r,uu____6557)
                          ...
                          | FStar_Syntax_Syntax.Meta_pattern args ->
                              ...
                              norm cfg env
                                ...
                                head
                          | uu____6572 -> norm cfg env stack head)
                     | uu____6573 ->
                         let head = norm cfg env [] head  in
                         let m =
                           match m with
                           | FStar_Syntax_Syntax.Meta_pattern args ->
                               ...
                               FStar_Syntax_Syntax.Meta_pattern uu____6583
                           | uu____6590 -> m  in
                         let t =
        ...
        fun mtgt  ->
          fun t  ->
            ...
            | true  ->
                ...
                let uu____6604 = ed.FStar_Syntax_Syntax.return_repr  in
                (match uu____6604 with
                 | (uu____6605,return_repr) ->
                     let return_inst =
                       let uu____6612 =
                         let uu____6613 =
                                 ...
                                 let uu____6634 =
                                   let uu____6636 =
                                     env.FStar_TypeChecker_Env.universe_of
                                      ...
                                      in
                                   [uu____6636]  in
                                 (return_tm, uu____6634)  in
                               FStar_Syntax_Syntax.Tm_uinst uu____6629  in
                             FStar_Syntax_Syntax.mk uu____6628  in
                           uu____6625 None e.FStar_Syntax_Syntax.pos
                       | uu____6648 ->
                           ...
                           let uu____6665 =
                             ...
                             let uu____6668 =
                               let uu____6670 = FStar_Syntax_Syntax.as_arg e
                                  in
                               [uu____6670]  in
                             uu____6667 :: uu____6668  in
                           (return_inst, uu____6665)  in
                         FStar_Syntax_Syntax.Tm_app uu____6655  in
                       FStar_Syntax_Syntax.mk uu____6654  in
                     uu____6651 None e.FStar_Syntax_Syntax.pos)
            | uu____6682 ->
          ...
          (FStar_List.map
             (FStar_List.map
                (fun uu____6712  ->
                   ...
                   | (a,imp) ->
                       let uu____6719 = norm cfg env [] a  in
                       (uu____6719, imp))))
  ...
  fun cfg  ->
    fun env  ->
      fun comp  ->
        ...
        | FStar_Syntax_Syntax.Total (t,uopt) ->
            let uu___160_6734 = comp  in
            let uu____6737 =
              let uu____6738 =
                let uu____6744 = norm cfg env [] t  in
                let uu____6745 =
                  FStar_Option.map (norm_universe cfg env) uopt  in
                (uu____6744, uu____6745)  in
              FStar_Syntax_Syntax.Total uu____6738  in
            {
              FStar_Syntax_Syntax.n = uu____6737;
              FStar_Syntax_Syntax.tk = (uu___160_6734.FStar_Syntax_Syntax.tk);
              FStar_Syntax_Syntax.pos =
                (uu___160_6734.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___160_6734.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.GTotal (t,uopt) ->
            let uu___161_6760 = comp  in
            let uu____6763 =
              let uu____6764 =
                let uu____6770 = norm cfg env [] t  in
                let uu____6771 =
                  FStar_Option.map (norm_universe cfg env) uopt  in
                (uu____6770, uu____6771)  in
              FStar_Syntax_Syntax.GTotal uu____6764  in
            {
              FStar_Syntax_Syntax.n = uu____6763;
              FStar_Syntax_Syntax.tk = (uu___161_6760.FStar_Syntax_Syntax.tk);
              FStar_Syntax_Syntax.pos =
                (uu___161_6760.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___161_6760.FStar_Syntax_Syntax.vars)
            }
              ...
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____6802  ->
                      ...
                      | (a,i) ->
                          let uu____6809 = norm cfg env [] a  in
                          (uu____6809, i)))
               in
            let flags =
              FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags
                (FStar_List.map
                   (fun uu___130_6814  ->
                      match uu___130_6814 with
                      | FStar_Syntax_Syntax.DECREASES t ->
                          let uu____6818 = norm cfg env [] t  in
                          FStar_Syntax_Syntax.DECREASES uu____6818
                      | f -> f))
               in
            let uu___162_6822 = comp  in
            let uu____6825 =
              let uu____6826 =
                let uu___163_6827 = ct  in
                let uu____6828 =
                  FStar_List.map (norm_universe cfg env)
                ...
                let uu____6832 = norm_args ct.FStar_Syntax_Syntax.effect_args
                   in
                {
                  FStar_Syntax_Syntax.comp_univs = uu____6828;
                  FStar_Syntax_Syntax.effect_name =
                    (uu___163_6827.FStar_Syntax_Syntax.effect_name);
                  FStar_Syntax_Syntax.result_typ = uu____6829;
                  FStar_Syntax_Syntax.effect_args = uu____6832;
                  FStar_Syntax_Syntax.flags = flags
                }  in
              FStar_Syntax_Syntax.Comp uu____6826  in
            {
              FStar_Syntax_Syntax.n = uu____6825;
              FStar_Syntax_Syntax.tk = (uu___162_6822.FStar_Syntax_Syntax.tk);
              FStar_Syntax_Syntax.pos =
                (uu___162_6822.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___162_6822.FStar_Syntax_Syntax.vars)
            }
  ...
  fun cfg  ->
    fun env  ->
      fun c  ->
        let norm t =
          norm
            (let uu___164_6849 = cfg  in
             {
               steps =
                 [Eager_unfolding;
                 UnfoldUntil FStar_Syntax_Syntax.Delta_constant;
                 AllowUnboundUniverses];
               tcenv = (uu___164_6849.tcenv);
               delta_level = (uu___164_6849.delta_level)
             }) env [] t
           in
        let non_info t =
          let uu____6854 = norm t  in
          FStar_Syntax_Util.non_informative uu____6854  in
        match c.FStar_Syntax_Syntax.n with
        | FStar_Syntax_Syntax.Total uu____6857 -> c
        | FStar_Syntax_Syntax.GTotal (t,uopt) when non_info t ->
            let uu___165_6871 = c  in
            {
              FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Total (t, uopt));
              FStar_Syntax_Syntax.tk = (uu___165_6871.FStar_Syntax_Syntax.tk);
              FStar_Syntax_Syntax.pos =
                (uu___165_6871.FStar_Syntax_Syntax.pos);
              FStar_Syntax_Syntax.vars =
                (uu___165_6871.FStar_Syntax_Syntax.vars)
            }
        | FStar_Syntax_Syntax.Comp ct ->
            let l =
              FStar_TypeChecker_Env.norm_eff_name cfg.tcenv
            ...
            (match uu____6881 with
             | true  ->
                 let ct =
                   ...
                   with
                   | Some pure_eff ->
                       let uu___166_6886 = ct  in
                       {
                         FStar_Syntax_Syntax.comp_univs =
                           (uu___166_6886.FStar_Syntax_Syntax.comp_univs);
                         FStar_Syntax_Syntax.effect_name = pure_eff;
                         FStar_Syntax_Syntax.result_typ =
                           (uu___166_6886.FStar_Syntax_Syntax.result_typ);
                         FStar_Syntax_Syntax.effect_args =
                           (uu___166_6886.FStar_Syntax_Syntax.effect_args);
                         FStar_Syntax_Syntax.flags =
                           (uu___166_6886.FStar_Syntax_Syntax.flags)
                       }
                   | None  ->
                       let ct = unfold_effect_abbrev cfg.tcenv c  in
                       let uu___167_6888 = ct  in
                       {
                         FStar_Syntax_Syntax.comp_univs =
                           (uu___167_6888.FStar_Syntax_Syntax.comp_univs);
                         FStar_Syntax_Syntax.effect_name =
                           FStar_Syntax_Const.effect_PURE_lid;
                         FStar_Syntax_Syntax.result_typ =
                           (uu___167_6888.FStar_Syntax_Syntax.result_typ);
                         FStar_Syntax_Syntax.effect_args =
                           (uu___167_6888.FStar_Syntax_Syntax.effect_args);
                         FStar_Syntax_Syntax.flags =
                           (uu___167_6888.FStar_Syntax_Syntax.flags)
                       }
                    in
                 let uu___168_6889 = c  in
                 {
                   FStar_Syntax_Syntax.n = (FStar_Syntax_Syntax.Comp ct);
                   FStar_Syntax_Syntax.tk =
                     (uu___168_6889.FStar_Syntax_Syntax.tk);
                   FStar_Syntax_Syntax.pos =
                     (uu___168_6889.FStar_Syntax_Syntax.pos);
                   FStar_Syntax_Syntax.vars =
                     (uu___168_6889.FStar_Syntax_Syntax.vars)
                 }
             | uu____6894 -> c)
        | uu____6895 -> c
  ...
  fun cfg  ->
    fun env  ->
      fun uu____6898  ->
        ...
        | (x,imp) ->
            let uu____6901 =
              let uu___169_6902 = x  in
              let uu____6903 = norm cfg env [] x.FStar_Syntax_Syntax.sort  in
              {
                FStar_Syntax_Syntax.ppname =
                  (uu___169_6902.FStar_Syntax_Syntax.ppname);
                FStar_Syntax_Syntax.index =
                  (uu___169_6902.FStar_Syntax_Syntax.index);
                FStar_Syntax_Syntax.sort = uu____6903
              }  in
            (uu____6901, imp)
      ...
      fun bs  ->
        let uu____6909 =
          FStar_List.fold_left
           ...
           in
        match uu____6909 with | (nbs,uu____6933) -> FStar_List.rev nbs
  ...
  fun cfg  ->
    fun env  ->
      fun lopt  ->
        ...
        | Some (FStar_Util.Inl lc) ->
            let flags = filter_out_lcomp_cflags lc  in
            let uu____6950 = FStar_Syntax_Util.is_tot_or_gtot_lcomp lc  in
            (match uu____6950 with
             | true  ->
                 let t = norm cfg env [] lc.FStar_Syntax_Syntax.res_typ  in
                 let uu____6955 = FStar_Syntax_Util.is_total_lcomp lc  in
                        ...
                        let uu____6962 =
                          let uu____6963 =
                            let uu____6966 = FStar_Syntax_Syntax.mk_Total t
                               in
                            FStar_Syntax_Util.comp_set_flags uu____6966 flags
                             in
                          FStar_Syntax_Util.lcomp_of_comp uu____6963  in
                        FStar_Util.Inl uu____6962  in
                      Some uu____6959
                  | uu____6969 ->
                      let uu____6970 =
                        let uu____6973 =
                          let uu____6974 =
                            let uu____6977 = FStar_Syntax_Syntax.mk_GTotal t
                               in
                            FStar_Syntax_Util.comp_set_flags uu____6977 flags
                             in
                          FStar_Syntax_Util.lcomp_of_comp uu____6974  in
                        FStar_Util.Inl uu____6973  in
                      Some uu____6970)
             | uu____6980 ->
                 Some
        ...
        fun t  ->
          ...
          | (Debug tm)::stack ->
              ((let uu____7002 =
                ...
                | true  ->
                    let uu____7003 = FStar_Syntax_Print.term_to_string tm  in
          ...
          | (Steps (s,dl))::stack ->
              rebuild
                (let uu___170_7012 = cfg  in
                 { steps = s; tcenv = (uu___170_7012.tcenv); delta_level = dl
                 }) env stack t
          | (Meta (m,r))::stack ->
          ...
          | (MemoLazy r)::stack ->
              (set_memo r (env, t);
               log cfg
                 (fun uu____7032  ->
                    let uu____7033 = FStar_Syntax_Print.term_to_string t  in
                    FStar_Util.print1 "\tSet memo %s\n" uu____7033);
               rebuild cfg env stack t)
          ...
          | (Abs (env',bs,env'',lopt,r))::stack ->
              ...
              let uu____7070 =
                let uu___171_7071 = FStar_Syntax_Util.abs bs t lopt  in
                {
                  FStar_Syntax_Syntax.n =
                    (uu___171_7071.FStar_Syntax_Syntax.n);
                  FStar_Syntax_Syntax.tk =
                    (uu___171_7071.FStar_Syntax_Syntax.tk);
                  FStar_Syntax_Syntax.pos = r;
                  FStar_Syntax_Syntax.vars =
                    (uu___171_7071.FStar_Syntax_Syntax.vars)
                }  in
              rebuild cfg env stack uu____7070
          | (Arg (Univ _,_,_))::_|(Arg (Dummy ,_,_))::_ ->
              failwith "Impossible"
          | (UnivArgs (us,r))::stack ->
              let t = FStar_Syntax_Syntax.mk_Tm_uinst t us  in
              rebuild cfg env stack t
          | (Arg (Clos (env,tm,m,uu____7093),aq,r))::stack ->
              (log cfg
                 (fun uu____7109  ->
                    let uu____7110 = FStar_Syntax_Print.term_to_string tm  in
                ...
                | true  ->
                    (match FStar_List.contains WHNF cfg.steps with
                     ...
                     | uu____7117 ->
                         ...
                         norm cfg env stack tm)
                | uu____7120 ->
                    let uu____7121 = FStar_ST.read m  in
          ...
          | (App (head,aq,r))::stack ->
              ...
              let uu____7169 = maybe_simplify cfg.steps t  in
              rebuild cfg env stack uu____7169
              ...
              (log cfg
                 (fun uu____7176  ->
                    ...
                    FStar_Util.print1
                      ...
                      uu____7177);
               (let scrutinee = t  in
                let norm_and_rebuild_match uu____7182 =
                  ...
                  let cfg_exclude_iota_zeta =
                    ...
                    let steps' =
                      ...
                      | true  -> [Exclude Zeta]
                      | uu____7195 -> [Exclude Iota; Exclude Zeta]  in
                    let uu___172_7196 = cfg  in
                    {
                      steps = (FStar_List.append steps' cfg.steps);
                      tcenv = (uu___172_7196.tcenv);
                      delta_level = new_delta
                    }  in
                  let norm_or_whnf env t =
                    match whnf with
                    | true  -> closure_as_term cfg_exclude_iota_zeta env t
                    | uu____7206 -> norm cfg_exclude_iota_zeta env [] t  in
                  let rec norm_pat env p =
                    match p.FStar_Syntax_Syntax.v with
                    | FStar_Syntax_Syntax.Pat_constant uu____7230 -> (p, env)
                    | FStar_Syntax_Syntax.Pat_disj [] ->
                        failwith "Impossible"
                    | FStar_Syntax_Syntax.Pat_disj (hd::tl) ->
                        let uu____7250 = norm_pat env hd  in
                         ...
                         | (hd,env') ->
                             let tl =
                               FStar_All.pipe_right tl
                                 (FStar_List.map
                                    (fun p  ->
                                       let uu____7286 = norm_pat env p  in
                                       Prims.fst uu____7286))
                                in
                             ((let uu___173_7298 = p  in
                               {
                                 FStar_Syntax_Syntax.v =
                                   (FStar_Syntax_Syntax.Pat_disj (hd :: tl));
                                 FStar_Syntax_Syntax.ty =
                                   (uu___173_7298.FStar_Syntax_Syntax.ty);
                                 FStar_Syntax_Syntax.p =
                                   (uu___173_7298.FStar_Syntax_Syntax.p)
                               }), env'))
                    | FStar_Syntax_Syntax.Pat_cons (fv,pats) ->
                        let uu____7315 =
                          FStar_All.pipe_right pats
                            (FStar_List.fold_left
                               (fun uu____7349  ->
                                  fun uu____7350  ->
                                    match (uu____7349, uu____7350) with
                                    | ((pats,env),(p,b)) ->
                                        let uu____7415 = norm_pat env p  in
                        ...
                        (match uu____7315 with
                         | (pats,env) ->
                             ((let uu___174_7481 = p  in
                               {
                                 FStar_Syntax_Syntax.v =
                                   (FStar_Syntax_Syntax.Pat_cons
                                      (fv, (FStar_List.rev pats)));
                                 FStar_Syntax_Syntax.ty =
                                   (uu___174_7481.FStar_Syntax_Syntax.ty);
                                 FStar_Syntax_Syntax.p =
                                   (uu___174_7481.FStar_Syntax_Syntax.p)
                               }), env))
                    | FStar_Syntax_Syntax.Pat_var x ->
                        let x =
                          let uu___175_7495 = x  in
                          let uu____7496 =
                            norm_or_whnf env x.FStar_Syntax_Syntax.sort  in
                          {
                            FStar_Syntax_Syntax.ppname =
                              (uu___175_7495.FStar_Syntax_Syntax.ppname);
                            FStar_Syntax_Syntax.index =
                              (uu___175_7495.FStar_Syntax_Syntax.index);
                            FStar_Syntax_Syntax.sort = uu____7496
                          }  in
                        ((let uu___176_7502 = p  in
                          {
                            FStar_Syntax_Syntax.v =
                              (FStar_Syntax_Syntax.Pat_var x);
                            FStar_Syntax_Syntax.ty =
                              (uu___176_7502.FStar_Syntax_Syntax.ty);
                            FStar_Syntax_Syntax.p =
                              (uu___176_7502.FStar_Syntax_Syntax.p)
                          }), (Dummy :: env))
                    | FStar_Syntax_Syntax.Pat_wild x ->
                        let x =
                          let uu___177_7507 = x  in
                          let uu____7508 =
                            norm_or_whnf env x.FStar_Syntax_Syntax.sort  in
                          {
                            FStar_Syntax_Syntax.ppname =
                              (uu___177_7507.FStar_Syntax_Syntax.ppname);
                            FStar_Syntax_Syntax.index =
                              (uu___177_7507.FStar_Syntax_Syntax.index);
                            FStar_Syntax_Syntax.sort = uu____7508
                          }  in
                        ((let uu___178_7514 = p  in
                          {
                            FStar_Syntax_Syntax.v =
                              (FStar_Syntax_Syntax.Pat_wild x);
                            FStar_Syntax_Syntax.ty =
                              (uu___178_7514.FStar_Syntax_Syntax.ty);
                            FStar_Syntax_Syntax.p =
                              (uu___178_7514.FStar_Syntax_Syntax.p)
                          }), (Dummy :: env))
                    | FStar_Syntax_Syntax.Pat_dot_term (x,t) ->
                        let x =
                          let uu___179_7524 = x  in
                          let uu____7525 =
                            norm_or_whnf env x.FStar_Syntax_Syntax.sort  in
                          {
                            FStar_Syntax_Syntax.ppname =
                              (uu___179_7524.FStar_Syntax_Syntax.ppname);
                            FStar_Syntax_Syntax.index =
                              (uu___179_7524.FStar_Syntax_Syntax.index);
                            FStar_Syntax_Syntax.sort = uu____7525
                          }  in
                        let t = norm_or_whnf env t  in
                        ((let uu___180_7532 = p  in
                          {
                            FStar_Syntax_Syntax.v =
                              (FStar_Syntax_Syntax.Pat_dot_term (x, t));
                            FStar_Syntax_Syntax.ty =
                              (uu___180_7532.FStar_Syntax_Syntax.ty);
                            FStar_Syntax_Syntax.p =
                              (uu___180_7532.FStar_Syntax_Syntax.p)
                          }), env)
                     in
                  let branches =
                    match env with
                        ...
                        FStar_All.pipe_right branches
                          (FStar_List.map
                             (fun branch  ->
                                ...
                                | (p,wopt,e) ->
                                    let uu____7557 = norm_pat env p  in
                  ...
                  let uu____7586 =
                    mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches)) r
                     in
                  rebuild cfg env stack uu____7586  in
                let rec is_cons head =
                  match head.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Tm_uinst (h,uu____7596) -> is_cons h
                  | FStar_Syntax_Syntax.Tm_constant _
                    |FStar_Syntax_Syntax.Tm_fvar
                     { FStar_Syntax_Syntax.fv_name = _;
                       FStar_Syntax_Syntax.fv_delta = _;
                ...
                let rec matches_pat scrutinee p =
                  ...
                  | (head,args) ->
                      (match p.FStar_Syntax_Syntax.v with
                           ...
                           let mopt =
                             FStar_Util.find_map ps
                               (fun p  ->
                                  ...
                                  match m with
                                  | FStar_Util.Inl uu____7763 -> Some m
                       ...
                       | FStar_Syntax_Syntax.Pat_dot_term uu____7794 ->
                           FStar_Util.Inl []
                       | FStar_Syntax_Syntax.Pat_constant s ->
                           (match scrutinee.FStar_Syntax_Syntax.n with
                            ...
                            | uu____7806 ->
                                let uu____7807 =
                                  let uu____7808 = is_cons head  in
                                  Prims.op_Negation uu____7808  in
                       ...
                       | FStar_Syntax_Syntax.Pat_cons (fv,arg_pats) ->
                           ...
                           (match uu____7822 with
                            ...
                            | uu____7830 ->
                                let uu____7831 =
                                  let uu____7832 = is_cons head  in
                                  Prims.op_Negation uu____7832  in
                                FStar_Util.Inr uu____7831))
                
                and matches_args out a p =
                  match (a, p) with
                  | ([],[]) -> FStar_Util.Inl out
                  | ((t,uu____7866)::rest_a,(p,uu____7869)::rest_p) ->
                      let uu____7897 = matches_pat t p  in
                      (match uu____7897 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____7911 -> FStar_Util.Inr false
                 in
                let rec matches scrutinee p =
                  match p with
                  | [] -> norm_and_rebuild_match ()
                  | (p,wopt,b)::rest ->
                      let uu____7982 = matches_pat scrutinee p  in
                                        ...
                                        let uu____8005 =
                                          let uu____8015 =
                                            FStar_Util.mk_ref (Some ([], t))
                                             in
                                          ([], t, uu____8015, false)  in
                                        Clos uu____8005  in
                                      uu____8004 :: env) env s
                                in
                             let uu____8038 = guard_when_clause wopt b rest
                                in
                             norm cfg env stack uu____8038)))
                   in
                let uu____8039 =
                  FStar_All.pipe_right cfg.steps
                ...
                | uu____8040 -> matches scrutinee branches))
...
let normalize :
  ...
  fun s  ->
    fun e  ->
      fun t  -> let uu____8071 = config s e  in norm uu____8071 [] [] t
...
let normalize_comp :
  ...
  fun s  ->
    fun e  ->
      fun t  -> let uu____8081 = config s e  in norm_comp uu____8081 [] t
...
let normalize_universe :
  ...
  fun env  ->
    fun u  ->
      let uu____8088 = config [] env  in norm_universe uu____8088 [] u
...
let ghost_to_pure :
  ...
  fun env  ->
    fun c  ->
      let uu____8095 = config [] env  in ghost_to_pure_aux uu____8095 [] c
    ...
    fun lc  ->
      let cfg =
        config
         ...
         in
      let non_info t =
        let uu____8107 = norm cfg [] [] t  in
        FStar_Syntax_Util.non_informative uu____8107  in
      let uu____8108 =
      ...
      | true  ->
          (match downgrade_ghost_effect_name lc.FStar_Syntax_Syntax.eff_name
           with
           | Some pure_eff ->
               let uu___181_8110 = lc  in
               {
                 FStar_Syntax_Syntax.eff_name = pure_eff;
                 FStar_Syntax_Syntax.res_typ =
                   (uu___181_8110.FStar_Syntax_Syntax.res_typ);
                 FStar_Syntax_Syntax.cflags =
                   (uu___181_8110.FStar_Syntax_Syntax.cflags);
                 FStar_Syntax_Syntax.comp =
                   ((fun uu____8111  ->
                       let uu____8112 = lc.FStar_Syntax_Syntax.comp ()  in
                       ghost_to_pure env uu____8112))
               }
           | None  -> lc)
      | uu____8113 -> lc
...
let term_to_string :
  ...
  fun env  ->
    fun t  ->
      let uu____8120 = normalize [AllowUnboundUniverses] env t  in
      FStar_Syntax_Print.term_to_string uu____8120
...
let comp_to_string :
  ...
  fun env  ->
    fun c  ->
      let uu____8127 =
        let uu____8128 = config [AllowUnboundUniverses] env  in
        norm_comp uu____8128 [] c  in
      FStar_Syntax_Print.comp_to_string uu____8127
                   ...
                   let uu____8165 =
                     let uu____8166 =
                       let uu____8171 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____8171)  in
                     FStar_Syntax_Syntax.Tm_refine uu____8166  in
                   mk uu____8165 t0.FStar_Syntax_Syntax.pos
               | uu____8176 -> t)
          | uu____8177 -> t  in
        aux t
...
let eta_expand_with_type :
  ...
  fun t  ->
    fun sort  ->
      let uu____8184 = FStar_Syntax_Util.arrow_formals_comp sort  in
                ...
                | (binders,args) ->
                    ...
                    let uu____8219 =
                      ...
                      FStar_All.pipe_right uu____8226
                       ...
                       in
                    FStar_Syntax_Util.abs binders uu____8214 uu____8219))
...
let eta_expand :
  ...
  fun env  ->
    fun t  ->
      let uu____8262 =
        let uu____8266 = FStar_ST.read t.FStar_Syntax_Syntax.tk  in
        (uu____8266, (t.FStar_Syntax_Syntax.n))  in
      match uu____8262 with
      | (Some sort,uu____8273) ->
          let uu____8275 = mk sort t.FStar_Syntax_Syntax.pos  in
          eta_expand_with_type t uu____8275
      | (uu____8276,FStar_Syntax_Syntax.Tm_name x) ->
          eta_expand_with_type t x.FStar_Syntax_Syntax.sort
      | uu____8280 ->
          let uu____8284 = FStar_Syntax_Util.head_and_args t  in
          (match uu____8284 with
           | (head,args) ->
               let uu____8310 =
                 let uu____8311 = FStar_Syntax_Subst.compress head  in
                 uu____8311.FStar_Syntax_Syntax.n  in
               (match uu____8310 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____8314,thead) ->
                          ...
                          | uu____8358 ->
                              let uu____8359 =
                                env.FStar_TypeChecker_Env.type_of
                                  (let uu___182_8363 = env  in
                                   {
                                     FStar_TypeChecker_Env.solver =
                                       (uu___182_8363.FStar_TypeChecker_Env.solver);
                                     FStar_TypeChecker_Env.range =
                                       (uu___182_8363.FStar_TypeChecker_Env.range);
                                     FStar_TypeChecker_Env.curmodule =
                                       (uu___182_8363.FStar_TypeChecker_Env.curmodule);
                                     FStar_TypeChecker_Env.gamma =
                                       (uu___182_8363.FStar_TypeChecker_Env.gamma);
                                     FStar_TypeChecker_Env.gamma_cache =
                                       (uu___182_8363.FStar_TypeChecker_Env.gamma_cache);
                                     FStar_TypeChecker_Env.modules =
                                       (uu___182_8363.FStar_TypeChecker_Env.modules);
                                     FStar_TypeChecker_Env.expected_typ =
                                       None;
                                     FStar_TypeChecker_Env.sigtab =
                                       (uu___182_8363.FStar_TypeChecker_Env.sigtab);
                                     FStar_TypeChecker_Env.is_pattern =
                                       (uu___182_8363.FStar_TypeChecker_Env.is_pattern);
                                     FStar_TypeChecker_Env.instantiate_imp =
                                       (uu___182_8363.FStar_TypeChecker_Env.instantiate_imp);
                                     FStar_TypeChecker_Env.effects =
                                       (uu___182_8363.FStar_TypeChecker_Env.effects);
                                     FStar_TypeChecker_Env.generalize =
                                       (uu___182_8363.FStar_TypeChecker_Env.generalize);
                                     FStar_TypeChecker_Env.letrecs =
                                       (uu___182_8363.FStar_TypeChecker_Env.letrecs);
                                     FStar_TypeChecker_Env.top_level =
                                       (uu___182_8363.FStar_TypeChecker_Env.top_level);
                                     FStar_TypeChecker_Env.check_uvars =
                                       (uu___182_8363.FStar_TypeChecker_Env.check_uvars);
                                     FStar_TypeChecker_Env.use_eq =
                                       (uu___182_8363.FStar_TypeChecker_Env.use_eq);
                                     FStar_TypeChecker_Env.is_iface =
                                       (uu___182_8363.FStar_TypeChecker_Env.is_iface);
                                     FStar_TypeChecker_Env.admit =
                                       (uu___182_8363.FStar_TypeChecker_Env.admit);
                                     FStar_TypeChecker_Env.lax = true;
                                     FStar_TypeChecker_Env.lax_universes =
                                       (uu___182_8363.FStar_TypeChecker_Env.lax_universes);
                                     FStar_TypeChecker_Env.type_of =
                                       (uu___182_8363.FStar_TypeChecker_Env.type_of);
                                     FStar_TypeChecker_Env.universe_of =
                                       (uu___182_8363.FStar_TypeChecker_Env.universe_of);
                                     FStar_TypeChecker_Env.use_bv_sorts =
                                       true;
                                     FStar_TypeChecker_Env.qname_and_index =
                                       (uu___182_8363.FStar_TypeChecker_Env.qname_and_index)
                                   }) t
                                 in
                              (match uu____8359 with
                               | (uu____8364,ty,uu____8366) ->
                                   eta_expand_with_type t ty)))
                | uu____8367 ->
                    let uu____8368 =
                      env.FStar_TypeChecker_Env.type_of
                        (let uu___183_8372 = env  in
                         {
                           FStar_TypeChecker_Env.solver =
                             (uu___183_8372.FStar_TypeChecker_Env.solver);
                           FStar_TypeChecker_Env.range =
                             (uu___183_8372.FStar_TypeChecker_Env.range);
                           FStar_TypeChecker_Env.curmodule =
                             (uu___183_8372.FStar_TypeChecker_Env.curmodule);
                           FStar_TypeChecker_Env.gamma =
                             (uu___183_8372.FStar_TypeChecker_Env.gamma);
                           FStar_TypeChecker_Env.gamma_cache =
                             (uu___183_8372.FStar_TypeChecker_Env.gamma_cache);
                           FStar_TypeChecker_Env.modules =
                             (uu___183_8372.FStar_TypeChecker_Env.modules);
                           FStar_TypeChecker_Env.expected_typ = None;
                           FStar_TypeChecker_Env.sigtab =
                             (uu___183_8372.FStar_TypeChecker_Env.sigtab);
                           FStar_TypeChecker_Env.is_pattern =
                             (uu___183_8372.FStar_TypeChecker_Env.is_pattern);
                           FStar_TypeChecker_Env.instantiate_imp =
                             (uu___183_8372.FStar_TypeChecker_Env.instantiate_imp);
                           FStar_TypeChecker_Env.effects =
                             (uu___183_8372.FStar_TypeChecker_Env.effects);
                           FStar_TypeChecker_Env.generalize =
                             (uu___183_8372.FStar_TypeChecker_Env.generalize);
                           FStar_TypeChecker_Env.letrecs =
                             (uu___183_8372.FStar_TypeChecker_Env.letrecs);
                           FStar_TypeChecker_Env.top_level =
                             (uu___183_8372.FStar_TypeChecker_Env.top_level);
                           FStar_TypeChecker_Env.check_uvars =
                             (uu___183_8372.FStar_TypeChecker_Env.check_uvars);
                           FStar_TypeChecker_Env.use_eq =
                             (uu___183_8372.FStar_TypeChecker_Env.use_eq);
                           FStar_TypeChecker_Env.is_iface =
                             (uu___183_8372.FStar_TypeChecker_Env.is_iface);
                           FStar_TypeChecker_Env.admit =
                             (uu___183_8372.FStar_TypeChecker_Env.admit);
                           FStar_TypeChecker_Env.lax = true;
                           FStar_TypeChecker_Env.lax_universes =
                             (uu___183_8372.FStar_TypeChecker_Env.lax_universes);
                           FStar_TypeChecker_Env.type_of =
                             (uu___183_8372.FStar_TypeChecker_Env.type_of);
                           FStar_TypeChecker_Env.universe_of =
                             (uu___183_8372.FStar_TypeChecker_Env.universe_of);
                           FStar_TypeChecker_Env.use_bv_sorts = true;
                           FStar_TypeChecker_Env.qname_and_index =
                             (uu___183_8372.FStar_TypeChecker_Env.qname_and_index)
                         }) t
                       in
                    (match uu____8368 with
                     | (uu____8373,ty,uu____8375) ->
                         eta_expand_with_type t ty)))
