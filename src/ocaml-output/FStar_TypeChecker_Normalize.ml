...
let env_to_string : closure Prims.list  ->  Prims.string = (fun env -> (let _0_269 = (FStar_List.map closure_to_string env)
...
(let _0_270 = (closure_to_string c)
in (FStar_Util.format1 "Closure %s" _0_270))
end
| MemoLazy (uu____595) -> begin
"MemoLazy"
end
| Abs (uu____599, bs, uu____601, uu____602, uu____603) -> begin
(let _0_271 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
in (FStar_Util.format1 "Abs %s" _0_271))
end
...
(let _0_272 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format1 "App %s" _0_272))
end
...
in (FStar_Util.format1 "Debug %s" _0_273))
end))


let stack_to_string : stack_elt Prims.list  ->  Prims.string = (fun s -> (let _0_274 = (FStar_List.map stack_elt_to_string s)
in (FStar_All.pipe_right _0_274 (FStar_String.concat "; "))))
...
with
| uu____683 -> begin
(failwith (let _0_275 = (FStar_Syntax_Print.db_to_string x)
...
| true -> begin
(Prims.raise (FStar_Errors.Error ((let _0_279 = (let _0_278 = (FStar_Util.string_of_int (FStar_List.length binders))
in (let _0_277 = (FStar_Util.string_of_int ((FStar_List.length c.FStar_Syntax_Syntax.effect_args) + (Prims.parse_int "1")))
in (let _0_276 = (FStar_Syntax_Print.comp_to_string (FStar_Syntax_Syntax.mk_Comp c))
in (FStar_Util.format3 "Effect constructor is not fully applied; expected %s args, got %s args, i.e., %s" _0_278 _0_277 _0_276))))
in ((_0_279), (comp.FStar_Syntax_Syntax.pos))))))
end
| uu____752 -> begin
()
end);
...
let inst = (let _0_281 = (let _0_280 = (FStar_Syntax_Syntax.as_arg c.FStar_Syntax_Syntax.result_typ)
in (_0_280)::c.FStar_Syntax_Syntax.effect_args)
...
in (FStar_All.pipe_right _0_282 FStar_Syntax_Syntax.mk_Comp))
...
let us = (let _0_283 = (FStar_List.collect aux us)
in (FStar_All.pipe_right _0_283 norm_univs))
in (match (us) with
| (u_k)::(hd)::rest -> begin
(
...
(let _0_285 = (aux u)
in (FStar_List.map (fun _0_284 -> FStar_Syntax_Syntax.U_succ (_0_284)) _0_285))
end)))
in (
...
let rec closure_as_term : cfg  ->  closure Prims.list  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun cfg env t -> ((log cfg (fun uu____1030 -> (let _0_287 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_286 = (FStar_Syntax_Print.term_to_string t)
...
(let _0_288 = FStar_Syntax_Syntax.Tm_type ((norm_universe cfg env u))
in (mk _0_288 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_uinst (t, us) -> begin
(let _0_289 = (FStar_List.map (norm_universe cfg env) us)
in (FStar_Syntax_Syntax.mk_Tm_uinst t _0_289))
end
...
in (let _0_291 = FStar_Syntax_Syntax.Tm_abs ((let _0_290 = (close_lcomp_opt cfg env lopt)
in ((bs), (body), (_0_290))))
...
let uu____1222 = (let _0_293 = (let _0_292 = (FStar_Syntax_Syntax.mk_binder x)
in (_0_292)::[])
in (closures_as_binders_delayed cfg env _0_293))
in (match (uu____1222) with
| (x, env) -> begin
(

let phi = (closure_as_term_delayed cfg env phi)
in (let _0_296 = FStar_Syntax_Syntax.Tm_refine ((let _0_295 = (let _0_294 = (FStar_List.hd x)
in (FStar_All.pipe_right _0_294 Prims.fst))
in ((_0_295), (phi))))
in (mk _0_296 t.FStar_Syntax_Syntax.pos)))
end))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inl (t2), lopt) -> begin
(let _0_301 = FStar_Syntax_Syntax.Tm_ascribed ((let _0_300 = (closure_as_term_delayed cfg env t1)
in (let _0_299 = (let _0_298 = (closure_as_term_delayed cfg env t2)
in (FStar_All.pipe_left (fun _0_297 -> FStar_Util.Inl (_0_297)) _0_298))
in ((_0_300), (_0_299), (lopt)))))
in (mk _0_301 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_ascribed (t1, FStar_Util.Inr (c), lopt) -> begin
(let _0_306 = FStar_Syntax_Syntax.Tm_ascribed ((let _0_305 = (closure_as_term_delayed cfg env t1)
in (let _0_304 = (let _0_303 = (close_comp cfg env c)
in (FStar_All.pipe_left (fun _0_302 -> FStar_Util.Inr (_0_302)) _0_303))
in ((_0_305), (_0_304), (lopt)))))
in (mk _0_306 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', FStar_Syntax_Syntax.Meta_pattern (args)) -> begin
(let _0_309 = FStar_Syntax_Syntax.Tm_meta ((let _0_308 = (closure_as_term_delayed cfg env t')
in (let _0_307 = FStar_Syntax_Syntax.Meta_pattern ((FStar_All.pipe_right args (FStar_List.map (closures_as_args_delayed cfg env))))
in ((_0_308), (_0_307)))))
in (mk _0_309 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', FStar_Syntax_Syntax.Meta_monadic (m, tbody)) -> begin
(let _0_313 = FStar_Syntax_Syntax.Tm_meta ((let _0_312 = (closure_as_term_delayed cfg env t')
in (let _0_311 = FStar_Syntax_Syntax.Meta_monadic ((let _0_310 = (closure_as_term_delayed cfg env tbody)
in ((m), (_0_310))))
in ((_0_312), (_0_311)))))
in (mk _0_313 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', FStar_Syntax_Syntax.Meta_monadic_lift (m1, m2, tbody)) -> begin
(let _0_317 = FStar_Syntax_Syntax.Tm_meta ((let _0_316 = (closure_as_term_delayed cfg env t')
in (let _0_315 = FStar_Syntax_Syntax.Meta_monadic_lift ((let _0_314 = (closure_as_term_delayed cfg env tbody)
in ((m1), (m2), (_0_314))))
in ((_0_316), (_0_315)))))
in (mk _0_317 t.FStar_Syntax_Syntax.pos))
end
| FStar_Syntax_Syntax.Tm_meta (t', m) -> begin
(let _0_319 = FStar_Syntax_Syntax.Tm_meta ((let _0_318 = (closure_as_term_delayed cfg env t')
in ((_0_318), (m))))
in (mk _0_319 t.FStar_Syntax_Syntax.pos))
end
...
in (let _0_321 = (closure_as_term cfg env_univs lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_320 = (closure_as_term cfg env lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu___139_1480.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___139_1480.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _0_321; FStar_Syntax_Syntax.lbeff = uu___139_1480.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _0_320}))))))
in (
...
let uu___142_1849 = x
in (let _0_322 = (closure_as_term cfg env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___142_1849.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___142_1849.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_322}))
in (((
...
in {FStar_Syntax_Syntax.ppname = uu___144_1858.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___144_1858.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_323}))
in (((
...
in {FStar_Syntax_Syntax.ppname = uu___146_1872.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___146_1872.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_324}))
in (
...
in (let _0_326 = FStar_Syntax_Syntax.Tm_match ((let _0_325 = (FStar_All.pipe_right branches (FStar_List.map (norm_one_branch env)))
in ((head), (_0_325))))
in (mk _0_326 t.FStar_Syntax_Syntax.pos))))
end))
end);
))
...
| (x, imp) -> begin
(let _0_327 = (closure_as_term_delayed cfg env x)
in ((_0_327), (imp)))
end)) args)
end))
...
let uu___148_2072 = b
in (let _0_328 = (closure_as_term_delayed cfg env b.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___148_2072.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___148_2072.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_328}))
in (
...
(let _0_330 = (closure_as_term_delayed cfg env t)
in (let _0_329 = (FStar_Option.map (norm_universe cfg env) uopt)
in (FStar_Syntax_Syntax.mk_Total' _0_330 _0_329)))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(let _0_332 = (closure_as_term_delayed cfg env t)
in (let _0_331 = (FStar_Option.map (norm_universe cfg env) uopt)
in (FStar_Syntax_Syntax.mk_GTotal' _0_332 _0_331)))
end
...
let uu___149_2156 = c
in (let _0_333 = (FStar_List.map (norm_universe cfg env) c.FStar_Syntax_Syntax.comp_univs)
in {FStar_Syntax_Syntax.comp_univs = _0_333; FStar_Syntax_Syntax.effect_name = uu___149_2156.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = rt; FStar_Syntax_Syntax.effect_args = args; FStar_Syntax_Syntax.flags = flags}))))))
end)
end))
...
let int_as_const = (fun i -> FStar_Const.Const_int ((let _0_334 = (FStar_Util.string_of_int i)
in ((_0_334), (None)))))
in (

let bool_as_const = (fun b -> FStar_Const.Const_bool (b))
in (let _0_343 = (FStar_List.flatten (FStar_List.map (fun m -> (let _0_342 = (let _0_335 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("add")::[]))
in ((_0_335), ((fun x y -> (int_as_const (x + y))))))
in (let _0_341 = (let _0_340 = (let _0_336 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("sub")::[]))
in ((_0_336), ((fun x y -> (int_as_const (x - y))))))
in (let _0_339 = (let _0_338 = (let _0_337 = (FStar_Syntax_Const.p2l (("FStar")::(m)::("mul")::[]))
in ((_0_337), ((fun x y -> (int_as_const (x * y))))))
in (_0_338)::[])
in (_0_340)::_0_339))
in (_0_342)::_0_341))) (("Int8")::("UInt8")::("Int16")::("UInt16")::("Int32")::("UInt32")::("Int64")::("UInt64")::("UInt128")::[])))
...
let name = (fun x -> (mk (FStar_Syntax_Syntax.Tm_fvar ((let _0_344 = (FStar_Syntax_Const.p2l x)
in (FStar_Syntax_Syntax.lid_as_fv _0_344 FStar_Syntax_Syntax.Delta_constant None))))))
in (

let ctor = (fun x -> (mk (FStar_Syntax_Syntax.Tm_fvar ((let _0_345 = (FStar_Syntax_Const.p2l x)
in (FStar_Syntax_Syntax.lid_as_fv _0_345 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))))))
in (let _0_362 = (let _0_361 = (FStar_Syntax_Const.p2l (("FStar")::("String")::("list_of_string")::[]))
in ((_0_361), ((fun s -> (let _0_360 = (FStar_String.list_of_string s)
in (let _0_359 = (mk (FStar_Syntax_Syntax.Tm_app ((let _0_358 = (let _0_354 = (ctor (("Prims")::("Nil")::[]))
in (FStar_Syntax_Syntax.mk_Tm_uinst _0_354 ((FStar_Syntax_Syntax.U_zero)::[])))
in (let _0_357 = (let _0_356 = (let _0_355 = (name (("FStar")::("Char")::("char")::[]))
in ((_0_355), (Some (FStar_Syntax_Syntax.Implicit (true)))))
in (_0_356)::[])
in ((_0_358), (_0_357)))))))
in (FStar_List.fold_right (fun c a -> (mk (FStar_Syntax_Syntax.Tm_app ((let _0_353 = (let _0_346 = (ctor (("Prims")::("Cons")::[]))
in (FStar_Syntax_Syntax.mk_Tm_uinst _0_346 ((FStar_Syntax_Syntax.U_zero)::[])))
in (let _0_352 = (let _0_351 = (let _0_347 = (name (("FStar")::("Char")::("char")::[]))
in ((_0_347), (Some (FStar_Syntax_Syntax.Implicit (true)))))
in (let _0_350 = (let _0_349 = (let _0_348 = (mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_char (c))))
in ((_0_348), (None)))
in (_0_349)::(((a), (None)))::[])
in (_0_351)::_0_350))
in ((_0_353), (_0_352)))))))) _0_360 _0_359)))))))
in (_0_362)::[]))))
...
let c = (let _0_364 = (FStar_Util.int_of_string i)
in (let _0_363 = (FStar_Util.int_of_string j)
in (op _0_364 _0_363)))
in (mk (FStar_Syntax_Syntax.Tm_constant (c)) tm.FStar_Syntax_Syntax.pos)))
in (

let uu____2843 = (let _0_366 = (FStar_Syntax_Subst.compress a1).FStar_Syntax_Syntax.n
in (let _0_365 = (FStar_Syntax_Subst.compress a2).FStar_Syntax_Syntax.n
in ((_0_366), (_0_365))))
...
let uu____2896 = (let _0_370 = (FStar_Syntax_Subst.compress head1).FStar_Syntax_Syntax.n
in (let _0_369 = (FStar_Syntax_Subst.compress head2).FStar_Syntax_Syntax.n
in (let _0_368 = (FStar_Syntax_Subst.compress arg1).FStar_Syntax_Syntax.n
in (let _0_367 = (FStar_Syntax_Subst.compress arg2).FStar_Syntax_Syntax.n
in ((_0_370), (_0_369), (_0_368), (_0_367))))))
...
(let _0_374 = (mk (FStar_Syntax_Syntax.Tm_fvar (fv1)) tm.FStar_Syntax_Syntax.pos)
in (let _0_373 = (let _0_372 = (let _0_371 = (norm i j)
in ((_0_371), (None)))
in (_0_372)::[])
in (FStar_Syntax_Util.mk_app _0_374 _0_373)))
end
| uu____2938 -> begin
tm
end))
...
let uu____3850 = (let _0_375 = (FStar_Syntax_Util.un_uinst hd).FStar_Syntax_Syntax.n
in ((_0_375), (args)))
...
let t = (FStar_Syntax_Subst.compress t)
in ((log cfg (fun uu____3991 -> (let _0_378 = (FStar_Syntax_Print.tag_of_term t)
in (let _0_377 = (FStar_Syntax_Print.term_to_string t)
in (let _0_376 = (stack_to_string stack)
...
in (let _0_379 = (mk (FStar_Syntax_Syntax.Tm_type (u)) t.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack _0_379)))
end
| FStar_Syntax_Syntax.Tm_uinst (t', us) -> begin
(
...
let us = UnivArgs ((let _0_380 = (FStar_List.map (norm_universe cfg env) us)
in ((_0_380), (t.FStar_Syntax_Syntax.pos))))
in (
...
let r_env = (let _0_381 = (FStar_Syntax_Syntax.range_of_fv f)
in (FStar_TypeChecker_Env.set_range cfg.tcenv _0_381))
in (
...
| Some (us, t) -> begin
((log cfg (fun uu____4284 -> (let _0_383 = (FStar_Syntax_Print.term_to_string t0)
in (let _0_382 = (FStar_Syntax_Print.term_to_string t)
...
| uu____4305 -> begin
(failwith (let _0_384 = (FStar_Syntax_Print.lid_to_string f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_Util.format1 "Impossible: missing universe instantiation on %s" _0_384)))
end)
end
| uu____4310 -> begin
(norm cfg env stack t)
...
| Some (env, t') -> begin
((log cfg (fun uu____4347 -> (let _0_386 = (FStar_Syntax_Print.term_to_string t)
...
((log cfg (fun uu____4431 -> (let _0_387 = (closure_to_string c)
...
((log cfg (fun uu____4448 -> (let _0_388 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_388))));
(norm cfg ((c)::env) stack_rest body);
)
end
| Some (FStar_Util.Inl (lc)) when (FStar_Syntax_Util.is_tot_or_gtot_lcomp lc) -> begin
((log cfg (fun uu____4459 -> (let _0_389 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_389))));
(norm cfg ((c)::env) stack_rest body);
)
end
...
in (let _0_390 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_390)))
end)
end
| (uu____4476)::tl -> begin
((log cfg (fun uu____4486 -> (let _0_391 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" _0_391))));
(
...
((set_memo r ((env), (t)));
(log cfg (fun uu____4520 -> (let _0_392 = (FStar_Syntax_Print.term_to_string t)
...
| true -> begin
(let _0_393 = (closure_as_term cfg env t)
...
(let _0_399 = (let _0_397 = (let _0_395 = (let _0_394 = (l.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp opening _0_394))
in (FStar_All.pipe_right _0_395 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right _0_397 (fun _0_396 -> FStar_Util.Inl (_0_396))))
...
in ((log cfg (fun uu____4604 -> (let _0_400 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs))
...
| (a, aq) -> begin
(let _0_403 = Arg ((let _0_402 = Clos ((let _0_401 = (FStar_Util.mk_ref None)
in ((env), (a), (_0_401), (false))))
in ((_0_402), (aq), (t.FStar_Syntax_Syntax.pos))))
in (_0_403)::stack)
end)) args))
in ((log cfg (fun uu____4661 -> (let _0_404 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
...
| uu____4683 -> begin
(let _0_405 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_405))
end)
end
| uu____4686 -> begin
(
...
let t = (let _0_407 = FStar_Syntax_Syntax.Tm_refine ((let _0_406 = (FStar_Syntax_Subst.close closing f)
in (((

let uu___155_4704 = x
in {FStar_Syntax_Syntax.ppname = uu___155_4704.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___155_4704.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (_0_406))))
in (mk _0_407 t.FStar_Syntax_Syntax.pos))
in (rebuild cfg env stack t)))
end)))
end)
end
...
let c = (let _0_409 = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env uu____4729 -> (Dummy)::env) env))
in (norm_comp cfg _0_409 c))
in (

let t = (let _0_410 = (norm_binders cfg env bs)
in (FStar_Syntax_Util.arrow _0_410 c))
in (rebuild cfg env stack t)))
end))
end)
end
...
in (let _0_411 = (mk (FStar_Syntax_Syntax.Tm_ascribed (((t1), (tc), (l)))) t.FStar_Syntax_Syntax.pos)
...
let env = (let _0_413 = Clos ((let _0_412 = (FStar_Util.mk_ref None)
in ((env), (lb.FStar_Syntax_Syntax.lbdef), (_0_412), (false))))
in (_0_413)::env)
...
let uu____4891 = (let _0_416 = (let _0_415 = (let _0_414 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.left)
in (FStar_All.pipe_right _0_414 FStar_Syntax_Syntax.mk_binder))
in (_0_415)::[])
in (FStar_Syntax_Subst.open_term _0_416 body))
...
in (let _0_422 = (let _0_419 = (let _0_417 = (FStar_List.hd bs)
in (FStar_All.pipe_right _0_417 Prims.fst))
in (FStar_All.pipe_right _0_419 (fun _0_418 -> FStar_Util.Inl (_0_418))))
in (let _0_421 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_420 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _0_422; FStar_Syntax_Syntax.lbunivs = uu___156_4899.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _0_421; FStar_Syntax_Syntax.lbeff = uu___156_4899.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _0_420}))))
in (
...
(let _0_423 = (closure_as_term cfg env t)
in (rebuild cfg env stack _0_423))
end
...
let body_env = (FStar_List.fold_right (fun lb env -> (let _0_425 = Clos ((let _0_424 = (FStar_Util.mk_ref None)
in ((rec_env), (lb.FStar_Syntax_Syntax.lbdef), (_0_424), (false))))
in (_0_425)::env)) (Prims.snd lbs) env)
...
let body = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_abs ((let _0_427 = (let _0_426 = (FStar_Syntax_Syntax.mk_binder x)
in (_0_426)::[])
in ((_0_427), (body), (None)))))) None body.FStar_Syntax_Syntax.pos)
in (
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_431 = (let _0_430 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_429 = (let _0_428 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_0_428)::[])
in (_0_430)::_0_429))
in ((bind), (_0_431)))))) None t.FStar_Syntax_Syntax.pos)
end
| uu____5251 -> begin
...
let reified = ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_443 = (let _0_442 = (FStar_Syntax_Syntax.as_arg lb.FStar_Syntax_Syntax.lbtyp)
in (let _0_441 = (let _0_440 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_439 = (let _0_438 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_437 = (let _0_436 = (FStar_Syntax_Syntax.as_arg head)
in (let _0_435 = (let _0_434 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_433 = (let _0_432 = (FStar_Syntax_Syntax.as_arg body)
in (_0_432)::[])
in (_0_434)::_0_433))
in (_0_436)::_0_435))
in (_0_438)::_0_437))
in (_0_440)::_0_439))
in (_0_442)::_0_441))
in ((bind_inst), (_0_443)))))) None t.FStar_Syntax_Syntax.pos)
in (let _0_444 = (FStar_List.tl stack)
in (norm cfg env _0_444 reified)))))))
end
...
| Some (x) when (let _0_445 = (FStar_Syntax_Syntax.lid_of_fv x)
in (FStar_TypeChecker_Env.is_action cfg.tcenv _0_445)) -> begin
(
...
let body = (let _0_448 = (let _0_447 = (let _0_446 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_0_446), (q)))
in (_0_447)::acc)
in (bind_on_lift es _0_448))
in (
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_452 = (let _0_451 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t')
in (let _0_450 = (let _0_449 = (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv t)
in (_0_449)::[])
in (_0_451)::_0_450))
in ((bind), (_0_452)))))) None e0.FStar_Syntax_Syntax.pos)
end
| uu____5512 -> begin
(failwith "NIY : Reification of indexed effects")
end))
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_464 = (let _0_463 = (FStar_Syntax_Syntax.as_arg t')
in (let _0_462 = (let _0_461 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_460 = (let _0_459 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_458 = (let _0_457 = (FStar_Syntax_Syntax.as_arg lifted_e0)
in (let _0_456 = (let _0_455 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (let _0_454 = (let _0_453 = (FStar_Syntax_Syntax.as_arg continuation)
in (_0_453)::[])
in (_0_455)::_0_454))
in (_0_457)::_0_456))
in (_0_459)::_0_458))
in (_0_461)::_0_460))
in (_0_463)::_0_462))
in ((bind_inst), (_0_464)))))) None e0.FStar_Syntax_Syntax.pos))))))
end
...
let binded_head = (let _0_466 = (let _0_465 = (FStar_Syntax_Syntax.as_arg head)
in (_0_465)::args)
in (bind_on_lift _0_466 []))
in (let _0_467 = (FStar_List.tl stack)
in (norm cfg env _0_467 binded_head)))))
end)))
end
...
| true -> begin
(let _0_469 = (FStar_List.tl stack)
in (let _0_468 = (reify_lift cfg.tcenv head m m' t)
in (norm cfg env _0_469 _0_468)))
end
| uu____5587 -> begin
(
...
((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_uinst ((let _0_471 = (let _0_470 = (env.FStar_TypeChecker_Env.universe_of env t)
in (_0_470)::[])
in ((return_tm), (_0_471)))))) None e.FStar_Syntax_Syntax.pos)
end
| uu____5674 -> begin
(failwith "NIY : Reification of indexed effects")
end))
in ((FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_app ((let _0_475 = (let _0_474 = (FStar_Syntax_Syntax.as_arg t)
in (let _0_473 = (let _0_472 = (FStar_Syntax_Syntax.as_arg e)
in (_0_472)::[])
in (_0_474)::_0_473))
in ((return_inst), (_0_475)))))) None e.FStar_Syntax_Syntax.pos))
end)))
end
| uu____5688 -> begin
...
in (let _0_479 = FStar_Syntax_Syntax.Total ((let _0_478 = (norm cfg env [] t)
in (let _0_477 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_0_478), (_0_477)))))
in {FStar_Syntax_Syntax.n = _0_479; FStar_Syntax_Syntax.tk = uu___160_5739.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___160_5739.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___160_5739.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(

let uu___161_5755 = comp
in (let _0_482 = FStar_Syntax_Syntax.GTotal ((let _0_481 = (norm cfg env [] t)
in (let _0_480 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((_0_481), (_0_480)))))
in {FStar_Syntax_Syntax.n = _0_482; FStar_Syntax_Syntax.tk = uu___161_5755.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___161_5755.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___161_5755.FStar_Syntax_Syntax.vars}))
end
...
in (let _0_487 = FStar_Syntax_Syntax.Comp ((

let uu___163_5806 = ct
in (let _0_486 = (FStar_List.map (norm_universe cfg env) ct.FStar_Syntax_Syntax.comp_univs)
in (let _0_485 = (norm cfg env [] ct.FStar_Syntax_Syntax.result_typ)
in (let _0_484 = (norm_args ct.FStar_Syntax_Syntax.effect_args)
in {FStar_Syntax_Syntax.comp_univs = _0_486; FStar_Syntax_Syntax.effect_name = uu___163_5806.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _0_485; FStar_Syntax_Syntax.effect_args = _0_484; FStar_Syntax_Syntax.flags = flags})))))
in {FStar_Syntax_Syntax.n = _0_487; FStar_Syntax_Syntax.tk = uu___162_5803.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___162_5803.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___162_5803.FStar_Syntax_Syntax.vars}))))
end)))
...
let uu___169_5869 = x
in (let _0_488 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___169_5869.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___169_5869.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_488}))
in ((_0_489), (imp)))
end))
...
| true -> begin
Some (FStar_Util.Inl ((FStar_Syntax_Util.lcomp_of_comp (let _0_490 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.comp_set_flags _0_490 flags)))))
end
| uu____5925 -> begin
Some (FStar_Util.Inl ((FStar_Syntax_Util.lcomp_of_comp (let _0_491 = (FStar_Syntax_Syntax.mk_GTotal t)
...
| true -> begin
(let _0_493 = (FStar_Syntax_Print.term_to_string tm)
in (let _0_492 = (FStar_Syntax_Print.term_to_string t)
...
| (MemoLazy (r))::stack -> begin
((set_memo r ((env), (t)));
(log cfg (fun uu____5978 -> (let _0_494 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print1 "\tSet memo %s\n" _0_494))));
(rebuild cfg env stack t);
)
end
...
in (rebuild cfg env stack _0_495))))
end
...
((log cfg (fun uu____6053 -> (let _0_496 = (FStar_Syntax_Print.term_to_string tm)
...
in (let _0_497 = (maybe_simplify cfg.steps t)
in (rebuild cfg env stack _0_497)))
end
| (Match (env, branches, r))::stack -> begin
((log cfg (fun uu____6118 -> (let _0_498 = (FStar_Syntax_Print.term_to_string t)
...
let uu___175_6430 = x
in (let _0_499 = (norm_or_whnf env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___175_6430.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___175_6430.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_499}))
in (((
...
in {FStar_Syntax_Syntax.ppname = uu___177_6439.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___177_6439.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_500}))
in (((
...
in {FStar_Syntax_Syntax.ppname = uu___179_6453.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___179_6453.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _0_501}))
in (
...
in (let _0_502 = (mk (FStar_Syntax_Syntax.Tm_match (((scrutinee), (branches)))) r)
...
| FStar_Util.Inl (s) -> begin
((log cfg (fun uu____6909 -> (let _0_505 = (FStar_Syntax_Print.pat_to_string p)
in (let _0_504 = (let _0_503 = (FStar_List.map FStar_Syntax_Print.term_to_string s)
in (FStar_All.pipe_right _0_503 (FStar_String.concat "; ")))
in (FStar_Util.print2 "Matches pattern %s with subst = %s\n" _0_505 _0_504)))));
(

let env = (FStar_List.fold_left (fun env t -> (let _0_507 = Clos ((let _0_506 = (FStar_Util.mk_ref (Some ((([]), (t)))))
in (([]), (t), (_0_506), (false))))
in (_0_507)::env)) env s)
in (let _0_508 = (guard_when_clause wopt b rest)
in (norm cfg env stack _0_508)));
)
end))
end))
in (
...
let normalize : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun s e t -> (let _0_509 = (config s e)
in (norm _0_509 [] [] t)))


let normalize_comp : steps  ->  FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun s e t -> (let _0_510 = (config s e)
in (norm_comp _0_510 [] t)))


let normalize_universe : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.universe  ->  FStar_Syntax_Syntax.universe = (fun env u -> (let _0_511 = (config [] env)
in (norm_universe _0_511 [] u)))


let ghost_to_pure : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun env c -> (let _0_512 = (config [] env)
in (ghost_to_pure_aux _0_512 [] c)))
...
in {FStar_Syntax_Syntax.eff_name = pure_eff; FStar_Syntax_Syntax.res_typ = uu___181_6999.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___181_6999.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____7000 -> (let _0_513 = (lc.FStar_Syntax_Syntax.comp ())
in (ghost_to_pure env _0_513)))})
end
| None -> begin
lc
end)
...
let comp_to_string : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.comp  ->  Prims.string = (fun env c -> (FStar_Syntax_Print.comp_to_string (let _0_514 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp _0_514 [] c))))
...
(let _0_516 = FStar_Syntax_Syntax.Tm_refine ((let _0_515 = (FStar_Syntax_Util.mk_conj phi1 phi)
in ((y), (_0_515))))
in (mk _0_516 t0.FStar_Syntax_Syntax.pos))
end
| uu____7052 -> begin
t
end))
...
| (binders, args) -> begin
(let _0_521 = ((FStar_Syntax_Syntax.mk_Tm_app t args) None t.FStar_Syntax_Syntax.pos)
in (let _0_520 = (let _0_519 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _0_517 -> FStar_Util.Inl (_0_517)))
in (FStar_All.pipe_right _0_519 (fun _0_518 -> Some (_0_518))))
in (FStar_Syntax_Util.abs binders _0_521 _0_520)))
end))
end)
end)))
...
let uu____7126 = (let _0_522 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in ((_0_522), (t.FStar_Syntax_Syntax.n)))
in (match (uu____7126) with
| (Some (sort), uu____7135) -> begin
(let _0_523 = (mk sort t.FStar_Syntax_Syntax.pos)
in (eta_expand_with_type t _0_523))
end
