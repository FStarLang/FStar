...
let closure_to_string : closure  ->  Prims.string = (fun uu___133_212 -> (match (uu___133_212) with
...
let stack_elt_to_string : stack_elt  ->  Prims.string = (fun uu___134_651 -> (match (uu___134_651) with
...
let is_empty = (fun uu___135_732 -> (match (uu___135_732) with
| [] -> begin
true
end
| uu____734 -> begin
...
let uu___148_1557 = lb
in {FStar_Syntax_Syntax.lbname = uu___148_1557.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___148_1557.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = typ; FStar_Syntax_Syntax.lbeff = uu___148_1557.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = def})
...
in {FStar_Syntax_Syntax.lbname = uu___149_1600.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___149_1600.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu____1601; FStar_Syntax_Syntax.lbeff = uu___149_1600.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____1604}))))))
in (
...
let uu___150_1784 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd2)::tl2); FStar_Syntax_Syntax.ty = uu___150_1784.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___150_1784.FStar_Syntax_Syntax.p})), (env')))
end))
end
...
let uu___151_1967 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.ty = uu___151_1967.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___151_1967.FStar_Syntax_Syntax.p})), (env3))
end))
end
...
in {FStar_Syntax_Syntax.ppname = uu___152_1981.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___152_1981.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1982}))
in (((

let uu___153_1988 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.ty = uu___153_1988.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___153_1988.FStar_Syntax_Syntax.p})), ((Dummy)::env2)))
end
...
in {FStar_Syntax_Syntax.ppname = uu___154_1993.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___154_1993.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____1994}))
in (((

let uu___155_2000 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.ty = uu___155_2000.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___155_2000.FStar_Syntax_Syntax.p})), ((Dummy)::env2)))
end
...
in {FStar_Syntax_Syntax.ppname = uu___156_2010.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___156_2010.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2011}))
in (
...
let uu___157_2018 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t3))); FStar_Syntax_Syntax.ty = uu___157_2018.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___157_2018.FStar_Syntax_Syntax.p})), (env2))))
end))
in (
...
in {FStar_Syntax_Syntax.ppname = uu___158_2242.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___158_2242.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____2243}))
in (
...
let flags = (FStar_All.pipe_right c1.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___136_2330 -> (match (uu___136_2330) with
...
let uu___159_2339 = c1
in (

let uu____2340 = (FStar_List.map (norm_universe cfg env) c1.FStar_Syntax_Syntax.comp_univs)
in {FStar_Syntax_Syntax.comp_univs = uu____2340; FStar_Syntax_Syntax.effect_name = uu___159_2339.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = rt; FStar_Syntax_Syntax.effect_args = args; FStar_Syntax_Syntax.flags = flags}))
in (FStar_Syntax_Syntax.mk_Comp uu____2338)))))
end)
end))
and filter_out_lcomp_cflags : FStar_Syntax_Syntax.lcomp  ->  FStar_Syntax_Syntax.cflags Prims.list = (fun lc -> (FStar_All.pipe_right lc.FStar_Syntax_Syntax.cflags (FStar_List.filter (fun uu___137_2344 -> (match (uu___137_2344) with
...
let uu___160_3332 = cfg
in {steps = (Primops)::[]; tcenv = uu___160_3332.tcenv; delta_level = uu___160_3332.delta_level; primitive_steps = equality_ops}) tm))
...
let uu___161_3354 = t
in {FStar_Syntax_Syntax.n = uu___161_3354.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___161_3354.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = tm.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___161_3354.FStar_Syntax_Syntax.vars}))
in (
...
let is_reify_head : stack_elt Prims.list  ->  Prims.bool = (fun uu___138_4184 -> (match (uu___138_4184) with
...
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
(FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.fstar_tactics_embed_lid)
end
| uu____4207 -> begin
false
end)))
...
in ((log cfg (fun uu____4321 -> (

let uu____4322 = (FStar_Syntax_Print.tag_of_term t1)
in (

let uu____4323 = (FStar_Syntax_Print.term_to_string t1)
in (
...
let uu____4327 = (firstn (Prims.parse_int "4") stack1)
in (FStar_All.pipe_left Prims.fst uu____4327))
in (stack_to_string uu____4325))
in (FStar_Util.print3 ">>> %s\nNorm %s with top of the stack %s \n" uu____4322 uu____4323 uu____4324))))));
(match (t1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_delayed (uu____4339) -> begin
(failwith "Impossible")
end
| (FStar_Syntax_Syntax.Tm_unknown) | (FStar_Syntax_Syntax.Tm_uvar (_)) | (FStar_Syntax_Syntax.Tm_constant (_)) | (FStar_Syntax_Syntax.Tm_name (_)) | (FStar_Syntax_Syntax.Tm_fvar ({FStar_Syntax_Syntax.fv_name = _; FStar_Syntax_Syntax.fv_delta = FStar_Syntax_Syntax.Delta_constant; FStar_Syntax_Syntax.fv_qual = _})) | (FStar_Syntax_Syntax.Tm_fvar ({FStar_Syntax_Syntax.fv_name = _; FStar_Syntax_Syntax.fv_delta = _; FStar_Syntax_Syntax.fv_qual = Some (FStar_Syntax_Syntax.Data_ctor)})) | (FStar_Syntax_Syntax.Tm_fvar ({FStar_Syntax_Syntax.fv_name = _; FStar_Syntax_Syntax.fv_delta = _; FStar_Syntax_Syntax.fv_qual = Some (FStar_Syntax_Syntax.Record_ctor (_))})) -> begin
(rebuild cfg env stack1 t1)
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar (fv); FStar_Syntax_Syntax.tk = uu____4371; FStar_Syntax_Syntax.pos = uu____4372; FStar_Syntax_Syntax.vars = uu____4373}, uu____4374) when (FStar_Syntax_Syntax.fv_eq_lid fv FStar_Syntax_Const.fstar_tactics_embed_lid) -> begin
(rebuild cfg env stack1 t1)
end
...
let uu___162_4414 = t1
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_app (((hd1), (args1))); FStar_Syntax_Syntax.tk = uu___162_4414.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___162_4414.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___162_4414.FStar_Syntax_Syntax.vars})
in (
...
let uu____4443 = (FStar_All.pipe_right cfg.steps (FStar_List.contains NoFullNorm))
in (not (uu____4443))) && (is_norm_request hd1 args)) && (not ((FStar_Ident.lid_equals cfg.tcenv.FStar_TypeChecker_Env.curmodule FStar_Syntax_Const.prims_lid)))) -> begin
(
...
let uu___163_4456 = cfg
in {steps = s; tcenv = uu___163_4456.tcenv; delta_level = (FStar_TypeChecker_Env.Unfold (FStar_Syntax_Syntax.Delta_constant))::[]; primitive_steps = uu___163_4456.primitive_steps})
in (

let stack' = (Debug (t1))::(Steps (((cfg.steps), (cfg.primitive_steps), (cfg.delta_level))))::stack1
in (norm cfg' env stack' tm)))))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = uu____4461; FStar_Syntax_Syntax.pos = uu____4462; FStar_Syntax_Syntax.vars = uu____4463}, (a1)::(a2)::rest) -> begin
(

let uu____4497 = (FStar_Syntax_Util.head_and_args t1)
in (match (uu____4497) with
| (hd1, uu____4508) -> begin
(
...
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reflect (uu____4563)); FStar_Syntax_Syntax.tk = uu____4564; FStar_Syntax_Syntax.pos = uu____4565; FStar_Syntax_Syntax.vars = uu____4566}, (a)::[]) when ((FStar_All.pipe_right cfg.steps (FStar_List.contains Reify)) && (is_reify_head stack1)) -> begin
(

let uu____4589 = (FStar_List.tl stack1)
in (norm cfg env uu____4589 (Prims.fst a)))
end
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = uu____4592; FStar_Syntax_Syntax.pos = uu____4593; FStar_Syntax_Syntax.vars = uu____4594}, (a)::[]) when (FStar_All.pipe_right cfg.steps (FStar_List.contains Reify)) -> begin
(

let uu____4617 = (FStar_Syntax_Util.head_and_args t1)
in (match (uu____4617) with
| (reify_head, uu____4628) -> begin
(

let a1 = (

let uu____4644 = (FStar_All.pipe_left FStar_Syntax_Util.unascribe (Prims.fst a))
in (FStar_Syntax_Subst.compress uu____4644))
in (match (a1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_app ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reflect (uu____4647)); FStar_Syntax_Syntax.tk = uu____4648; FStar_Syntax_Syntax.pos = uu____4649; FStar_Syntax_Syntax.vars = uu____4650}, (a2)::[]) -> begin
...
let uu____4683 = (mk (FStar_Syntax_Syntax.Tm_type (u1)) t1.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack1 uu____4683)))
end
| FStar_Syntax_Syntax.Tm_uinst (t', us) -> begin
(

let uu____4690 = (FStar_All.pipe_right cfg.steps (FStar_List.contains EraseUniverses))
...
let uu____4697 = (FStar_List.map (norm_universe cfg env) us)
in ((uu____4697), (t1.FStar_Syntax_Syntax.pos)))
in UnivArgs (uu____4693))
in (
...
let should_delta = (FStar_All.pipe_right cfg.delta_level (FStar_Util.for_some (fun uu___139_4706 -> (match (uu___139_4706) with
...
let uu____4710 = (FStar_Syntax_Syntax.range_of_fv f)
in (FStar_TypeChecker_Env.set_range cfg.tcenv uu____4710))
in (

let uu____4711 = (FStar_TypeChecker_Env.lookup_definition cfg.delta_level r_env f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (match (uu____4711) with
| None -> begin
((log cfg (fun uu____4722 -> (FStar_Util.print "Tm_fvar case 2\n" [])));
(rebuild cfg env stack1 t1);
)
end
| Some (us, t2) -> begin
((log cfg (fun uu____4728 -> (

let uu____4729 = (FStar_Syntax_Print.term_to_string t0)
in (

let uu____4730 = (FStar_Syntax_Print.term_to_string t2)
...
| true -> begin
(match (stack1) with
| (UnivArgs (us', uu____4737))::stack2 -> begin
(

let env1 = (FStar_All.pipe_right us' (FStar_List.fold_left (fun env1 u -> (Univ (u))::env1) env))
in (norm cfg env1 stack2 t2))
end
| uu____4750 when (FStar_All.pipe_right cfg.steps (FStar_List.contains EraseUniverses)) -> begin
...
let uu____4753 = (FStar_Syntax_Print.lid_to_string f.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_Util.format1 "Impossible: missing universe instantiation on %s" uu____4753))
in (failwith uu____4752))
end)
end
| uu____4758 -> begin
(norm cfg env stack1 t2)
...
let uu____4760 = (lookup_bvar env x)
in (match (uu____4760) with
| Univ (uu____4761) -> begin
(failwith "Impossible: term variable is bound to a universe")
end
| Dummy -> begin
...
let uu____4776 = (FStar_ST.read r)
in (match (uu____4776) with
| Some (env2, t') -> begin
((log cfg (fun uu____4795 -> (

let uu____4796 = (FStar_Syntax_Print.term_to_string t1)
in (

let uu____4797 = (FStar_Syntax_Print.term_to_string t')
in (FStar_Util.print2 "Lazy hit: %s cached to %s\n" uu____4796 uu____4797)))));
(

let uu____4798 = (

let uu____4799 = (FStar_Syntax_Subst.compress t')
in uu____4799.FStar_Syntax_Syntax.n)
in (match (uu____4798) with
| FStar_Syntax_Syntax.Tm_abs (uu____4802) -> begin
...
| FStar_Syntax_Syntax.Tm_abs (bs, body, lopt) -> begin
(match (stack1) with
| (UnivArgs (uu____4850))::uu____4851 -> begin
(failwith "Ill-typed term: universes cannot be applied to term abstraction")
end
| (Match (uu____4856))::uu____4857 -> begin
(failwith "Ill-typed term: cannot pattern match an abstraction")
end
| (Arg (c, uu____4863, uu____4864))::stack_rest -> begin
(match (c) with
| Univ (uu____4867) -> begin
...
((log cfg (fun uu____4884 -> (

let uu____4885 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" uu____4885))));
(norm cfg ((c)::env) stack_rest body);
)
end
| Some (FStar_Util.Inr (l, cflags)) when (((FStar_Ident.lid_equals l FStar_Syntax_Const.effect_Tot_lid) || (FStar_Ident.lid_equals l FStar_Syntax_Const.effect_GTot_lid)) || (FStar_All.pipe_right cflags (FStar_Util.for_some (fun uu___140_4899 -> (match (uu___140_4899) with
...
((log cfg (fun uu____4902 -> (

let uu____4903 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" uu____4903))));
(norm cfg ((c)::env) stack_rest body);
)
end
| Some (FStar_Util.Inl (lc)) when (FStar_Syntax_Util.is_tot_or_gtot_lcomp lc) -> begin
((log cfg (fun uu____4914 -> (

let uu____4915 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" uu____4915))));
(norm cfg ((c)::env) stack_rest body);
)
end
| uu____4916 when (FStar_All.pipe_right cfg.steps (FStar_List.contains Reify)) -> begin
(norm cfg ((c)::env) stack_rest body)
end
| uu____4923 -> begin
(
...
let uu___164_4931 = cfg
in {steps = (WHNF)::(Exclude (Iota))::(Exclude (Zeta))::cfg.steps; tcenv = uu___164_4931.tcenv; delta_level = uu___164_4931.delta_level; primitive_steps = uu___164_4931.primitive_steps})
in (

let uu____4932 = (closure_as_term cfg1 env t1)
in (rebuild cfg1 env stack1 uu____4932)))
end)
end
| (uu____4933)::tl1 -> begin
((log cfg (fun uu____4943 -> (

let uu____4944 = (closure_to_string c)
in (FStar_Util.print1 "\tShifted %s\n" uu____4944))));
(
...
let uu___165_4968 = cfg
in {steps = s; tcenv = uu___165_4968.tcenv; delta_level = dl; primitive_steps = ps}) env stack2 t1)
end
| (MemoLazy (r))::stack2 -> begin
((set_memo r ((env), (t1)));
(log cfg (fun uu____4981 -> (

let uu____4982 = (FStar_Syntax_Print.term_to_string t1)
...
let uu____4993 = (closure_as_term cfg env t1)
in (rebuild cfg env stack1 uu____4993))
end
| uu____4994 -> begin
(

let uu____4995 = (FStar_Syntax_Subst.open_term' bs body)
...
let uu____5032 = (l.FStar_Syntax_Syntax.comp ())
in (FStar_Syntax_Subst.subst_comp opening uu____5032))
in (FStar_All.pipe_right uu____5031 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right uu____5030 (fun _0_30 -> FStar_Util.Inl (_0_30))))
in (FStar_All.pipe_right uu____5024 (fun _0_31 -> Some (_0_31))))
end
| uu____5057 -> begin
lopt
end)
...
let env' = (FStar_All.pipe_right bs1 (FStar_List.fold_left (fun env1 uu____5071 -> (Dummy)::env1) env))
in ((log cfg (fun uu____5076 -> (

let uu____5077 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length bs1))
...
let uu___166_5087 = cfg
in (

let uu____5088 = (FStar_List.filter (fun ps -> ps.strong_reduction_ok) cfg.primitive_steps)
in {steps = uu___166_5087.steps; tcenv = uu___166_5087.tcenv; delta_level = uu___166_5087.delta_level; primitive_steps = uu____5088}))
...
let stack2 = (FStar_All.pipe_right stack1 (FStar_List.fold_right (fun uu____5120 stack2 -> (match (uu____5120) with
| (a, aq) -> begin
(
...
let uu____5144 = (FStar_Util.mk_ref None)
in ((env), (a), (uu____5144), (false)))
in Clos (uu____5134))
in ((uu____5133), (aq), (t1.FStar_Syntax_Syntax.pos)))
in Arg (uu____5129))
in (uu____5128)::stack2)
end)) args))
in ((log cfg (fun uu____5166 -> (

let uu____5167 = (FStar_All.pipe_left FStar_Util.string_of_int (FStar_List.length args))
...
let uu___167_5188 = x
in {FStar_Syntax_Syntax.ppname = uu___167_5188.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___167_5188.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (f)))) t1.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack1 t2)))
end
| uu____5189 -> begin
(

let uu____5192 = (closure_as_term cfg env t1)
in (rebuild cfg env stack1 uu____5192))
end)
end
| uu____5193 -> begin
(
...
let uu____5195 = (FStar_Syntax_Subst.open_term ((((x), (None)))::[]) f)
...
let uu____5217 = (FStar_Syntax_Subst.close closing f2)
in (((

let uu___168_5218 = x
in {FStar_Syntax_Syntax.ppname = uu___168_5218.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___168_5218.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t_x})), (uu____5217)))
in FStar_Syntax_Syntax.Tm_refine (uu____5212))
in (mk uu____5211 t1.FStar_Syntax_Syntax.pos))
in (rebuild cfg env stack1 t2)))
end)))
end)
end
...
let uu____5231 = (closure_as_term cfg env t1)
in (rebuild cfg env stack1 uu____5231))
end
| uu____5232 -> begin
(

let uu____5233 = (FStar_Syntax_Subst.open_comp bs c)
...
let uu____5239 = (FStar_All.pipe_right bs1 (FStar_List.fold_left (fun env1 uu____5245 -> (Dummy)::env1) env))
in (norm_comp cfg uu____5239 c1))
in (

let t2 = (

let uu____5252 = (norm_binders cfg env bs1)
in (FStar_Syntax_Util.arrow uu____5252 c2))
in (rebuild cfg env stack1 t2)))
end))
end)
end
...
in ((log cfg (fun uu____5312 -> (FStar_Util.print_string "+++ Normalizing ascription \n")));
(
...
let uu____5325 = (norm cfg env [] t2)
in FStar_Util.Inl (uu____5325))
end
| FStar_Util.Inr (c) -> begin
(

let uu____5333 = (norm_comp cfg env c)
in FStar_Util.Inr (uu____5333))
end)
in (
...
let uu____5338 = (mk (FStar_Syntax_Syntax.Tm_ascribed (((t12), (((tc1), (tacopt1))), (l)))) t1.FStar_Syntax_Syntax.pos)
in (rebuild cfg env stack1 uu____5338))));
))
end)
end
| FStar_Syntax_Syntax.Tm_match (head1, branches) -> begin
...
| FStar_Syntax_Syntax.Tm_let ((uu____5389, ({FStar_Syntax_Syntax.lbname = FStar_Util.Inr (uu____5390); FStar_Syntax_Syntax.lbunivs = uu____5391; FStar_Syntax_Syntax.lbtyp = uu____5392; FStar_Syntax_Syntax.lbeff = uu____5393; FStar_Syntax_Syntax.lbdef = uu____5394})::uu____5395), uu____5396) -> begin
(rebuild cfg env stack1 t1)
end
| FStar_Syntax_Syntax.Tm_let ((false, (lb)::[]), body) -> begin
(
...
let uu____5423 = (FStar_All.pipe_right cfg.steps (FStar_List.contains NoDeltaSteps))
in (not (uu____5423))) && ((FStar_Syntax_Util.is_pure_effect n1) || ((FStar_Syntax_Util.is_ghost_effect n1) && (

let uu____5424 = (FStar_All.pipe_right cfg.steps (FStar_List.contains PureSubtermsWithinComputations))
in (not (uu____5424))))))
...
let uu____5438 = (FStar_Util.mk_ref None)
in ((env), (lb.FStar_Syntax_Syntax.lbdef), (uu____5438), (false)))
in Clos (uu____5428))
in (uu____5427)::env)
...
let uu____5467 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.left)
in (FStar_All.pipe_right uu____5467 FStar_Syntax_Syntax.mk_binder))
in (uu____5466)::[])
in (FStar_Syntax_Subst.open_term uu____5465 body))
...
let uu____5478 = (FStar_List.hd bs)
in (FStar_All.pipe_right uu____5478 Prims.fst))
in (FStar_All.pipe_right uu____5477 (fun _0_32 -> FStar_Util.Inl (_0_32))))
in (

let uu____5487 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbtyp)
in (

let uu____5490 = (norm cfg env [] lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = uu____5474; FStar_Syntax_Syntax.lbunivs = uu___169_5473.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu____5487; FStar_Syntax_Syntax.lbeff = uu___169_5473.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = uu____5490}))))
in (

let env' = (FStar_All.pipe_right bs (FStar_List.fold_left (fun env1 uu____5500 -> (Dummy)::env1) env))
...
let uu____5516 = (closure_as_term cfg env t1)
in (rebuild cfg env stack1 uu____5516))
end
| FStar_Syntax_Syntax.Tm_let (lbs, body) -> begin
(

let uu____5529 = (FStar_List.fold_right (fun lb uu____5551 -> (match (uu____5551) with
...
let uu___170_5591 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in {FStar_Syntax_Syntax.ppname = uu___170_5591.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = i; FStar_Syntax_Syntax.sort = uu___170_5591.FStar_Syntax_Syntax.sort})
in (FStar_Syntax_Syntax.bv_to_tm uu____5590))
in (
...
| (rec_env, memos, uu____5651) -> begin
(

let uu____5666 = (FStar_List.map2 (fun lb memo -> (FStar_ST.write memo (Some (((rec_env), (lb.FStar_Syntax_Syntax.lbdef)))))) (Prims.snd lbs) memos)
in (
...
let uu____5719 = (FStar_Util.mk_ref None)
in ((rec_env), (lb.FStar_Syntax_Syntax.lbdef), (uu____5719), (false)))
in Clos (uu____5709))
in (uu____5708)::env1)) (Prims.snd lbs) env)
...
| (App ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = uu____5757; FStar_Syntax_Syntax.pos = uu____5758; FStar_Syntax_Syntax.vars = uu____5759}, uu____5760, uu____5761))::uu____5762 -> begin
...
let uu____5775 = (FStar_All.pipe_right cfg.steps (FStar_List.contains PureSubtermsWithinComputations))
in (match (uu____5775) with
| true -> begin
(

let uu___171_5776 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::(NoDeltaSteps)::[]; tcenv = uu___171_5776.tcenv; delta_level = (FStar_TypeChecker_Env.Inlining)::(FStar_TypeChecker_Env.Eager_unfolding_only)::[]; primitive_steps = uu___171_5776.primitive_steps})
end
| uu____5777 -> begin
(

let uu___172_5778 = cfg
in {steps = (FStar_List.append ((NoDeltaSteps)::(Exclude (Zeta))::[]) cfg.steps); tcenv = uu___172_5778.tcenv; delta_level = (FStar_TypeChecker_Env.NoDelta)::[]; primitive_steps = uu___172_5778.primitive_steps})
end))
...
let uu____5781 = (FStar_Syntax_Subst.compress head1)
in uu____5781.FStar_Syntax_Syntax.n)
...
let uu____5795 = ed.FStar_Syntax_Syntax.bind_repr
in (match (uu____5795) with
| (uu____5796, bind_repr) -> begin
(match (lb.FStar_Syntax_Syntax.lbname) with
| FStar_Util.Inr (uu____5800) -> begin
...
let uu____5808 = (FStar_Syntax_Subst.compress e)
in uu____5808.FStar_Syntax_Syntax.n)
in (match (uu____5807) with
| FStar_Syntax_Syntax.Tm_meta (e1, FStar_Syntax_Syntax.Meta_monadic (uu____5813, uu____5814)) -> begin
(

let uu____5823 = (

let uu____5824 = (FStar_Syntax_Subst.compress e1)
in uu____5824.FStar_Syntax_Syntax.n)
in (match (uu____5823) with
| FStar_Syntax_Syntax.Tm_meta (e2, FStar_Syntax_Syntax.Meta_monadic_lift (uu____5829, msrc, uu____5831)) when (FStar_Syntax_Util.is_pure_effect msrc) -> begin
(

let uu____5840 = (FStar_Syntax_Subst.compress e2)
in Some (uu____5840))
end
| uu____5841 -> begin
None
...
let uu____5843 = (is_return lb.FStar_Syntax_Syntax.lbdef)
...
let uu___173_5847 = lb
in {FStar_Syntax_Syntax.lbname = uu___173_5847.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = uu___173_5847.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = uu___173_5847.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.lbdef = e})
in (

let uu____5848 = (FStar_List.tl stack1)
in (
...
let uu____5862 = (FStar_Syntax_Util.mk_reify body)
in ((((false), ((lb1)::[]))), (uu____5862)))
in FStar_Syntax_Syntax.Tm_let (uu____5854))
in (FStar_Syntax_Syntax.mk uu____5853))
in (uu____5850 None head1.FStar_Syntax_Syntax.pos))
in (norm cfg env uu____5848 uu____5849))))
end
| None -> begin
(
...
let uu____5880 = (is_return body)
in (match (uu____5880) with
| Some ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_bvar (y); FStar_Syntax_Syntax.tk = uu____5883; FStar_Syntax_Syntax.pos = uu____5884; FStar_Syntax_Syntax.vars = uu____5885}) -> begin
...
let uu____5931 = (FStar_Syntax_Syntax.mk_binder x)
in (uu____5931)::[])
in ((uu____5929), (body1), (Some (FStar_Util.Inr (((m1), ([])))))))
in FStar_Syntax_Syntax.Tm_abs (uu____5914))
in (FStar_Syntax_Syntax.mk uu____5913))
in (uu____5910 None body1.FStar_Syntax_Syntax.pos))
in (
...
let uu____5965 = (FStar_Syntax_Subst.compress bind_repr)
in uu____5965.FStar_Syntax_Syntax.n)
in (match (uu____5964) with
| FStar_Syntax_Syntax.Tm_uinst (bind1, (uu____5971)::(uu____5972)::[]) -> begin
(
...
let uu____5990 = (close1 lb.FStar_Syntax_Syntax.lbtyp)
in (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv uu____5990))
in (
...
let uu____5994 = (close1 t2)
in (cfg.tcenv.FStar_TypeChecker_Env.universe_of cfg.tcenv uu____5994))
in (uu____5993)::[])
in (uu____5989)::uu____5991))
in ((bind1), (uu____5987)))
in FStar_Syntax_Syntax.Tm_uinst (uu____5982))
in (FStar_Syntax_Syntax.mk uu____5981))
in (uu____5978 None t2.FStar_Syntax_Syntax.pos))
end
| uu____6006 -> begin
...
let uu____6028 = (FStar_Syntax_Syntax.as_arg lb.FStar_Syntax_Syntax.lbtyp)
in (

let uu____6029 = (

let uu____6031 = (FStar_Syntax_Syntax.as_arg t2)
in (

let uu____6032 = (

let uu____6034 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (

let uu____6035 = (

let uu____6037 = (FStar_Syntax_Syntax.as_arg head2)
in (

let uu____6038 = (

let uu____6040 = (FStar_Syntax_Syntax.as_arg FStar_Syntax_Syntax.tun)
in (

let uu____6041 = (

let uu____6043 = (FStar_Syntax_Syntax.as_arg body2)
in (uu____6043)::[])
in (uu____6040)::uu____6041))
in (uu____6037)::uu____6038))
in (uu____6034)::uu____6035))
in (uu____6031)::uu____6032))
in (uu____6028)::uu____6029))
in ((bind_inst), (uu____6026)))
in FStar_Syntax_Syntax.Tm_app (uu____6016))
in (FStar_Syntax_Syntax.mk uu____6015))
in (uu____6012 None t2.FStar_Syntax_Syntax.pos))
in (

let uu____6055 = (FStar_List.tl stack1)
in (norm cfg env uu____6055 reified))))))))
end))
end)))
end)
end)))
...
let uu____6073 = ed.FStar_Syntax_Syntax.bind_repr
in (match (uu____6073) with
| (uu____6074, bind_repr) -> begin
(
...
let uu____6098 = (FStar_Syntax_Subst.compress t3)
in uu____6098.FStar_Syntax_Syntax.n)
in (match (uu____6097) with
| FStar_Syntax_Syntax.Tm_uinst (t4, uu____6104) -> begin
t4
end
| uu____6109 -> begin
head2
...
let uu____6111 = (FStar_Syntax_Subst.compress t4)
...
let uu____6117 = (maybe_extract_fv head2)
in (match (uu____6117) with
| Some (x) when (

let uu____6123 = (FStar_Syntax_Syntax.lid_of_fv x)
in (FStar_TypeChecker_Env.is_action cfg.tcenv uu____6123)) -> begin
(
...
let uu____6127 = (maybe_extract_fv head3)
in (match (uu____6127) with
| Some (uu____6130) -> begin
Some (true)
end
| uu____6131 -> begin
Some (false)
...
let is_arg_impure = (fun uu____6145 -> (match (uu____6145) with
| (e, q) -> begin
(

let uu____6150 = (

let uu____6151 = (FStar_Syntax_Subst.compress e)
in uu____6151.FStar_Syntax_Syntax.n)
...
let uu____6172 = (FStar_Syntax_Syntax.as_arg head_app)
in (uu____6172)::args)
in (FStar_Util.for_some is_arg_impure uu____6168))
...
let uu____6176 = (FStar_Syntax_Print.term_to_string head1)
...
let uu____6178 = (maybe_unfold_action head_app)
...
let uu____6213 = (FStar_List.tl stack1)
in (norm cfg env uu____6213 body1)))))
end));
))
end)))
end
...
let uu____6227 = (closure_as_term cfg env t')
in (reify_lift cfg.tcenv e msrc mtgt uu____6227))
in (

let uu____6228 = (FStar_List.tl stack1)
in (norm cfg env uu____6228 lifted)))
end
| FStar_Syntax_Syntax.Tm_match (e, branches) -> begin
(

let branches1 = (FStar_All.pipe_right branches (FStar_List.map (fun uu____6311 -> (match (uu____6311) with
| (pat, wopt, tm) -> begin
(

let uu____6349 = (FStar_Syntax_Util.mk_reify tm)
in ((pat), (wopt), (uu____6349)))
end))))
in (
...
let uu____6375 = (FStar_List.tl stack1)
in (norm cfg env uu____6375 tm))))
end
| uu____6376 -> begin
...
let should_reify = (match (stack1) with
| (App ({FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_reify); FStar_Syntax_Syntax.tk = uu____6385; FStar_Syntax_Syntax.pos = uu____6386; FStar_Syntax_Syntax.vars = uu____6387}, uu____6388, uu____6389))::uu____6390 -> begin
(FStar_All.pipe_right cfg.steps (FStar_List.contains Reify))
end
| uu____6396 -> begin
false
...
let uu____6397 = (FStar_List.tl stack1)
in (

let uu____6398 = (

let uu____6399 = (closure_as_term cfg env t2)
in (reify_lift cfg.tcenv head1 m1 m' uu____6399))
in (norm cfg env uu____6397 uu____6398)))
end
| uu____6400 -> begin
(

let uu____6401 = (((FStar_Syntax_Util.is_pure_effect m1) || (FStar_Syntax_Util.is_ghost_effect m1)) && (FStar_All.pipe_right cfg.steps (FStar_List.contains PureSubtermsWithinComputations)))
...
let uu___174_6407 = cfg
in {steps = (PureSubtermsWithinComputations)::(Primops)::(AllowUnboundUniverses)::(EraseUniverses)::(Exclude (Zeta))::[]; tcenv = uu___174_6407.tcenv; delta_level = (FStar_TypeChecker_Env.Inlining)::(FStar_TypeChecker_Env.Eager_unfolding_only)::[]; primitive_steps = uu___174_6407.primitive_steps})
...
| uu____6413 -> begin
(match (stack1) with
| (uu____6414)::uu____6415 -> begin
(match (m) with
| FStar_Syntax_Syntax.Meta_labeled (l, r, uu____6419) -> begin
...
let uu____6444 = (norm_pattern_args cfg env args)
in FStar_Syntax_Syntax.Meta_pattern (uu____6444))
end
| uu____6451 -> begin
m
end)
...
let uu____6463 = ed.FStar_Syntax_Syntax.return_repr
in (match (uu____6463) with
| (uu____6464, return_repr) -> begin
(
...
let uu____6472 = (FStar_Syntax_Subst.compress return_repr)
in uu____6472.FStar_Syntax_Syntax.n)
in (match (uu____6471) with
| FStar_Syntax_Syntax.Tm_uinst (return_tm, (uu____6478)::[]) -> begin
(
...
let uu____6495 = (env.FStar_TypeChecker_Env.universe_of env t)
in (uu____6495)::[])
in ((return_tm), (uu____6493)))
in FStar_Syntax_Syntax.Tm_uinst (uu____6488))
in (FStar_Syntax_Syntax.mk uu____6487))
in (uu____6484 None e.FStar_Syntax_Syntax.pos))
end
| uu____6507 -> begin
(failwith "NIY : Reification of indexed effects")
end))
...
let uu____6526 = (FStar_Syntax_Syntax.as_arg t)
in (

let uu____6527 = (

let uu____6529 = (FStar_Syntax_Syntax.as_arg e)
in (uu____6529)::[])
in (uu____6526)::uu____6527))
in ((return_inst), (uu____6524)))
in FStar_Syntax_Syntax.Tm_app (uu____6514))
in (FStar_Syntax_Syntax.mk uu____6513))
in (uu____6510 None e.FStar_Syntax_Syntax.pos)))
end)))
end
| uu____6541 -> begin
(

let uu____6542 = (FStar_TypeChecker_Env.monad_leq env msrc mtgt)
in (match (uu____6542) with
| None -> begin
(

let uu____6544 = (FStar_Util.format2 "Impossible : trying to reify a lift between unrelated effects (%s and %s)" (FStar_Ident.text_of_lid msrc) (FStar_Ident.text_of_lid mtgt))
in (failwith uu____6544))
end
| Some ({FStar_TypeChecker_Env.msource = uu____6545; FStar_TypeChecker_Env.mtarget = uu____6546; FStar_TypeChecker_Env.mlift = {FStar_TypeChecker_Env.mlift_wp = uu____6547; FStar_TypeChecker_Env.mlift_term = None}}) -> begin
(failwith "Impossible : trying to reify a non-reifiable lift (from %s to %s)")
end
| Some ({FStar_TypeChecker_Env.msource = uu____6558; FStar_TypeChecker_Env.mtarget = uu____6559; FStar_TypeChecker_Env.mlift = {FStar_TypeChecker_Env.mlift_wp = uu____6560; FStar_TypeChecker_Env.mlift_term = Some (lift)}}) -> begin
(

let uu____6578 = (FStar_Syntax_Util.mk_reify e)
in (lift t FStar_Syntax_Syntax.tun uu____6578))
end))
end))
and norm_pattern_args : cfg  ->  env  ->  ((FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax * FStar_Syntax_Syntax.aqual) Prims.list Prims.list  ->  ((FStar_Syntax_Syntax.term', FStar_Syntax_Syntax.term') FStar_Syntax_Syntax.syntax * FStar_Syntax_Syntax.aqual) Prims.list Prims.list = (fun cfg env args -> (FStar_All.pipe_right args (FStar_List.map (FStar_List.map (fun uu____6608 -> (match (uu____6608) with
| (a, imp) -> begin
(

let uu____6615 = (norm cfg env [] a)
in ((uu____6615), (imp)))
end))))))
...
let uu____6640 = (norm cfg env [] t)
in (

let uu____6641 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((uu____6640), (uu____6641))))
in FStar_Syntax_Syntax.Total (uu____6634))
in {FStar_Syntax_Syntax.n = uu____6633; FStar_Syntax_Syntax.tk = uu___175_6630.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___175_6630.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___175_6630.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(

let uu___176_6656 = comp1
in (
...
let uu____6666 = (norm cfg env [] t)
in (

let uu____6667 = (FStar_Option.map (norm_universe cfg env) uopt)
in ((uu____6666), (uu____6667))))
in FStar_Syntax_Syntax.GTotal (uu____6660))
in {FStar_Syntax_Syntax.n = uu____6659; FStar_Syntax_Syntax.tk = uu___176_6656.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___176_6656.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___176_6656.FStar_Syntax_Syntax.vars}))
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(

let norm_args = (fun args -> (FStar_All.pipe_right args (FStar_List.map (fun uu____6698 -> (match (uu____6698) with
| (a, i) -> begin
(

let uu____6705 = (norm cfg env [] a)
in ((uu____6705), (i)))
end)))))
in (

let flags = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_List.map (fun uu___141_6710 -> (match (uu___141_6710) with
| FStar_Syntax_Syntax.DECREASES (t) -> begin
(

let uu____6714 = (norm cfg env [] t)
in FStar_Syntax_Syntax.DECREASES (uu____6714))
end
| f -> begin
f
end))))
...
let uu___178_6723 = ct
in (

let uu____6724 = (FStar_List.map (norm_universe cfg env) ct.FStar_Syntax_Syntax.comp_univs)
in (

let uu____6725 = (norm cfg env [] ct.FStar_Syntax_Syntax.result_typ)
in (

let uu____6728 = (norm_args ct.FStar_Syntax_Syntax.effect_args)
in {FStar_Syntax_Syntax.comp_univs = uu____6724; FStar_Syntax_Syntax.effect_name = uu___178_6723.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = uu____6725; FStar_Syntax_Syntax.effect_args = uu____6728; FStar_Syntax_Syntax.flags = flags}))))
in FStar_Syntax_Syntax.Comp (uu____6722))
in {FStar_Syntax_Syntax.n = uu____6721; FStar_Syntax_Syntax.tk = uu___177_6718.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___177_6718.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___177_6718.FStar_Syntax_Syntax.vars}))))
end)))
...
let uu___179_6745 = cfg
in {steps = (Eager_unfolding)::(UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::(AllowUnboundUniverses)::[]; tcenv = uu___179_6745.tcenv; delta_level = uu___179_6745.delta_level; primitive_steps = uu___179_6745.primitive_steps}) env [] t))
in (

let non_info = (fun t -> (

let uu____6750 = (norm1 t)
in (FStar_Syntax_Util.non_informative uu____6750)))
in (match (c.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Total (uu____6753) -> begin
c
end
...
let uu___180_6767 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Total (((t), (uopt))); FStar_Syntax_Syntax.tk = uu___180_6767.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___180_6767.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___180_6767.FStar_Syntax_Syntax.vars})
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(
...
let uu____6777 = ((FStar_Syntax_Util.is_ghost_effect l) && (non_info ct.FStar_Syntax_Syntax.result_typ))
...
let uu___181_6782 = ct
in {FStar_Syntax_Syntax.comp_univs = uu___181_6782.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = pure_eff; FStar_Syntax_Syntax.result_typ = uu___181_6782.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___181_6782.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___181_6782.FStar_Syntax_Syntax.flags})
end
| None -> begin
(
...
let uu___182_6784 = ct1
in {FStar_Syntax_Syntax.comp_univs = uu___182_6784.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = FStar_Syntax_Const.effect_PURE_lid; FStar_Syntax_Syntax.result_typ = uu___182_6784.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = uu___182_6784.FStar_Syntax_Syntax.effect_args; FStar_Syntax_Syntax.flags = uu___182_6784.FStar_Syntax_Syntax.flags}))
end)
in (

let uu___183_6785 = c
in {FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Comp (ct1); FStar_Syntax_Syntax.tk = uu___183_6785.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = uu___183_6785.FStar_Syntax_Syntax.pos; FStar_Syntax_Syntax.vars = uu___183_6785.FStar_Syntax_Syntax.vars}))
end
| uu____6790 -> begin
c
end)))
...
and norm_binder : cfg  ->  env  ->  FStar_Syntax_Syntax.binder  ->  FStar_Syntax_Syntax.binder = (fun cfg env uu____6794 -> (match (uu____6794) with
| (x, imp) -> begin
(
...
let uu____6799 = (norm cfg env [] x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___184_6798.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___184_6798.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____6799}))
in ((uu____6797), (imp)))
end))
and norm_binders : cfg  ->  env  ->  FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.binders = (fun cfg env bs -> (

let uu____6805 = (FStar_List.fold_left (fun uu____6812 b -> (match (uu____6812) with
| (nbs', env1) -> begin
(
...
let uu____6846 = (FStar_Syntax_Util.is_tot_or_gtot_lcomp lc)
...
let uu____6851 = (FStar_Syntax_Util.is_total_lcomp lc)
...
let uu____6862 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Util.comp_set_flags uu____6862 flags))
in (FStar_Syntax_Util.lcomp_of_comp uu____6859))
in FStar_Util.Inl (uu____6858))
in Some (uu____6855))
end
| uu____6865 -> begin
(
...
let uu____6873 = (FStar_Syntax_Syntax.mk_GTotal t)
in (FStar_Syntax_Util.comp_set_flags uu____6873 flags))
in (FStar_Syntax_Util.lcomp_of_comp uu____6870))
in FStar_Util.Inl (uu____6869))
in Some (uu____6866))
end)))
end
| uu____6876 -> begin
...
let uu____6898 = (FStar_All.pipe_left (FStar_TypeChecker_Env.debug cfg.tcenv) (FStar_Options.Other ("print_normalized_terms")))
in (match (uu____6898) with
| true -> begin
(

let uu____6899 = (FStar_Syntax_Print.term_to_string tm)
in (

let uu____6900 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print2 "Normalized %s to %s\n" uu____6899 uu____6900)))
end
| uu____6901 -> begin
()
end));
...
let uu___185_6911 = cfg
in {steps = s; tcenv = uu___185_6911.tcenv; delta_level = dl; primitive_steps = ps}) env stack2 t)
end
...
| (MemoLazy (r))::stack2 -> begin
((set_memo r ((env), (t)));
(log cfg (fun uu____6931 -> (

let uu____6932 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.print1 "\tSet memo %s\n" uu____6932))));
(rebuild cfg env stack2 t);
)
end
...
let uu___186_6970 = (FStar_Syntax_Util.abs bs1 t lopt1)
in {FStar_Syntax_Syntax.n = uu___186_6970.FStar_Syntax_Syntax.n; FStar_Syntax_Syntax.tk = uu___186_6970.FStar_Syntax_Syntax.tk; FStar_Syntax_Syntax.pos = r; FStar_Syntax_Syntax.vars = uu___186_6970.FStar_Syntax_Syntax.vars})
in (rebuild cfg env stack2 uu____6969))))
end
...
| (Arg (Clos (env1, tm, m, uu____6992), aq, r))::stack2 -> begin
((log cfg (fun uu____7008 -> (

let uu____7009 = (FStar_Syntax_Print.term_to_string tm)
...
let uu____7020 = (FStar_ST.read m)
...
let uu____7068 = (maybe_simplify cfg t1)
in (rebuild cfg env stack2 uu____7068)))
end
| (Match (env1, branches, r))::stack2 -> begin
((log cfg (fun uu____7075 -> (
...
let norm_and_rebuild_match = (fun uu____7081 -> ((log cfg (fun uu____7083 -> (

let uu____7084 = (FStar_Syntax_Print.term_to_string scrutinee)
in (

let uu____7085 = (

let uu____7086 = (FStar_All.pipe_right branches (FStar_List.map (fun uu____7093 -> (match (uu____7093) with
| (p, uu____7099, uu____7100) -> begin
(FStar_Syntax_Print.pat_to_string p)
end))))
in (FStar_All.pipe_right uu____7086 (FStar_String.concat "\n\t")))
...
let new_delta = (FStar_All.pipe_right cfg.delta_level (FStar_List.filter (fun uu___142_7110 -> (match (uu___142_7110) with
| (FStar_TypeChecker_Env.Inlining) | (FStar_TypeChecker_Env.Eager_unfolding_only) -> begin
true
end
| uu____7111 -> begin
...
let uu____7114 = (FStar_All.pipe_right cfg.steps (FStar_List.contains PureSubtermsWithinComputations))
...
let uu___187_7117 = cfg
in {steps = (FStar_List.append steps' cfg.steps); tcenv = uu___187_7117.tcenv; delta_level = new_delta; primitive_steps = uu___187_7117.primitive_steps})))
in (
...
let rec norm_pat = (fun env2 p -> (match (p.FStar_Syntax_Syntax.v) with
| FStar_Syntax_Syntax.Pat_constant (uu____7151) -> begin
((p), (env2))
end
| FStar_Syntax_Syntax.Pat_disj ([]) -> begin
(failwith "Impossible")
...
let uu____7171 = (norm_pat env2 hd1)
...
let uu____7207 = (norm_pat env2 p1)
in (Prims.fst uu____7207)))))
in (((

let uu___188_7219 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_disj ((hd2)::tl2); FStar_Syntax_Syntax.ty = uu___188_7219.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___188_7219.FStar_Syntax_Syntax.p})), (env')))
end))
end
| FStar_Syntax_Syntax.Pat_cons (fv, pats) -> begin
(

let uu____7236 = (FStar_All.pipe_right pats (FStar_List.fold_left (fun uu____7270 uu____7271 -> (match (((uu____7270), (uu____7271))) with
| ((pats1, env3), (p1, b)) -> begin
(

let uu____7336 = (norm_pat env3 p1)
...
let uu___189_7402 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_cons (((fv), ((FStar_List.rev pats1)))); FStar_Syntax_Syntax.ty = uu___189_7402.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___189_7402.FStar_Syntax_Syntax.p})), (env3))
end))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
let uu____7417 = (norm_or_whnf env2 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___190_7416.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___190_7416.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____7417}))
in (((

let uu___191_7423 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_var (x1); FStar_Syntax_Syntax.ty = uu___191_7423.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___191_7423.FStar_Syntax_Syntax.p})), ((Dummy)::env2)))
end
| FStar_Syntax_Syntax.Pat_wild (x) -> begin
(
...
let uu____7429 = (norm_or_whnf env2 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___192_7428.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___192_7428.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____7429}))
in (((

let uu___193_7435 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_wild (x1); FStar_Syntax_Syntax.ty = uu___193_7435.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___193_7435.FStar_Syntax_Syntax.p})), ((Dummy)::env2)))
end
...
let uu____7446 = (norm_or_whnf env2 x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = uu___194_7445.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = uu___194_7445.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = uu____7446}))
in (
...
let uu___195_7453 = p
in {FStar_Syntax_Syntax.v = FStar_Syntax_Syntax.Pat_dot_term (((x1), (t2))); FStar_Syntax_Syntax.ty = uu___195_7453.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = uu___195_7453.FStar_Syntax_Syntax.p})), (env2))))
end))
in (
...
let uu____7460 = (FStar_Syntax_Subst.open_branch branch1)
in (match (uu____7460) with
| (p, wopt, e) -> begin
(

let uu____7478 = (norm_pat env1 p)
...
let uu____7502 = (norm_or_whnf env2 w)
in Some (uu____7502))
end)
in (
...
let uu____7507 = (mk (FStar_Syntax_Syntax.Tm_match (((scrutinee), (branches1)))) r)
in (rebuild cfg env1 stack2 uu____7507)))))));
))
in (

let rec is_cons = (fun head1 -> (match (head1.FStar_Syntax_Syntax.n) with
| FStar_Syntax_Syntax.Tm_uinst (h, uu____7517) -> begin
(is_cons h)
end
...
let uu____7627 = (FStar_Syntax_Util.head_and_args scrutinee2)
...
in (match (m) with
| FStar_Util.Inl (uu____7684) -> begin
Some (m)
end
...
| FStar_Syntax_Syntax.Pat_dot_term (uu____7715) -> begin
FStar_Util.Inl ([])
end
...
let uu____7729 = (is_cons head1)
in (not (uu____7729)))
in FStar_Util.Inr (uu____7728))
end)
end
...
let uu____7744 = (FStar_Syntax_Util.un_uinst head1)
in uu____7744.FStar_Syntax_Syntax.n)
...
let uu____7753 = (is_cons head1)
in (not (uu____7753)))
in FStar_Util.Inr (uu____7752))
end))
end)
end))))
...
| (((t1, uu____7787))::rest_a, ((p1, uu____7790))::rest_p) -> begin
(

let uu____7818 = (matches_pat t1 p1)
...
let uu____7903 = (matches_pat scrutinee1 p1)
...
| FStar_Util.Inl (s) -> begin
((log cfg (fun uu____7913 -> (

let uu____7914 = (FStar_Syntax_Print.pat_to_string p1)
in (

let uu____7915 = (

let uu____7916 = (FStar_List.map FStar_Syntax_Print.term_to_string s)
in (FStar_All.pipe_right uu____7916 (FStar_String.concat "; ")))
...
let uu____7936 = (FStar_Util.mk_ref (Some ((([]), (t1)))))
in (([]), (t1), (uu____7936), (false)))
in Clos (uu____7926))
in (uu____7925)::env2)) env1 s)
in (

let uu____7959 = (guard_when_clause wopt b rest)
in (norm cfg env2 stack2 uu____7959)));
)
end))
end))
in (

let uu____7960 = (FStar_All.pipe_right cfg.steps (FStar_List.contains (Exclude (Iota))))
...
let d = (FStar_All.pipe_right s (FStar_List.collect (fun uu___143_7974 -> (match (uu___143_7974) with
| UnfoldUntil (k) -> begin
...
let uu___196_8001 = (config s e)
in {steps = uu___196_8001.steps; tcenv = uu___196_8001.tcenv; delta_level = uu___196_8001.delta_level; primitive_steps = (FStar_List.append c.primitive_steps ps)})
in (norm c1 [] [] t))))
...
let uu____8046 = (norm cfg [] [] t)
in (FStar_Syntax_Util.non_informative uu____8046)))
in (

let uu____8047 = ((FStar_Syntax_Util.is_ghost_effect lc.FStar_Syntax_Syntax.eff_name) && (non_info lc.FStar_Syntax_Syntax.res_typ))
...
let uu___197_8049 = lc
in {FStar_Syntax_Syntax.eff_name = pure_eff; FStar_Syntax_Syntax.res_typ = uu___197_8049.FStar_Syntax_Syntax.res_typ; FStar_Syntax_Syntax.cflags = uu___197_8049.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun uu____8050 -> (

let uu____8051 = (lc.FStar_Syntax_Syntax.comp ())
in (ghost_to_pure env uu____8051)))})
end
| None -> begin
lc
end)
...
let uu____8059 = (normalize ((AllowUnboundUniverses)::[]) env t)
in (FStar_Syntax_Print.term_to_string uu____8059)))
...
let uu____8067 = (config ((AllowUnboundUniverses)::[]) env)
in (norm_comp uu____8067 [] c))
in (FStar_Syntax_Print.comp_to_string uu____8066)))
...
let uu____8110 = (FStar_Syntax_Util.mk_conj phi1 phi)
in ((y), (uu____8110)))
in FStar_Syntax_Syntax.Tm_refine (uu____8105))
in (mk uu____8104 t01.FStar_Syntax_Syntax.pos))
end
| uu____8115 -> begin
t2
end))
...
let uu____8132 = (FStar_Syntax_Util.arrow_formals_comp t_e)
...
let uu____8152 = (FStar_Syntax_Util.abs_formals e)
in (match (uu____8152) with
| (actuals, uu____8163, uu____8164) -> begin
...
let uu____8186 = (FStar_All.pipe_right formals FStar_Syntax_Util.args_of_binders)
in (match (uu____8186) with
| (binders, args) -> begin
(

let uu____8196 = ((FStar_Syntax_Syntax.mk_Tm_app e args) None e.FStar_Syntax_Syntax.pos)
in (

let uu____8201 = (

let uu____8208 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _0_33 -> FStar_Util.Inl (_0_33)))
in (FStar_All.pipe_right uu____8208 (fun _0_34 -> Some (_0_34))))
in (FStar_Syntax_Util.abs binders uu____8196 uu____8201)))
end))
end)
end))
end)
...
let uu____8248 = (FStar_ST.read t.FStar_Syntax_Syntax.tk)
in ((uu____8248), (t.FStar_Syntax_Syntax.n)))
in (match (uu____8244) with
| (Some (sort), uu____8255) -> begin
(

let uu____8257 = (mk sort t.FStar_Syntax_Syntax.pos)
in (eta_expand_with_type env t uu____8257))
end
| (uu____8258, FStar_Syntax_Syntax.Tm_name (x)) -> begin
(eta_expand_with_type env t x.FStar_Syntax_Syntax.sort)
end
| uu____8262 -> begin
(

let uu____8266 = (FStar_Syntax_Util.head_and_args t)
...
let uu____8293 = (FStar_Syntax_Subst.compress head1)
in uu____8293.FStar_Syntax_Syntax.n)
in (match (uu____8292) with
| FStar_Syntax_Syntax.Tm_uvar (uu____8296, thead) -> begin
(

let uu____8310 = (FStar_Syntax_Util.arrow_formals thead)
...
let uu____8341 = (env.FStar_TypeChecker_Env.type_of (

let uu___198_8345 = env
in {FStar_TypeChecker_Env.solver = uu___198_8345.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___198_8345.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___198_8345.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___198_8345.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___198_8345.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___198_8345.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = uu___198_8345.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___198_8345.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___198_8345.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___198_8345.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___198_8345.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___198_8345.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___198_8345.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___198_8345.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___198_8345.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___198_8345.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___198_8345.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___198_8345.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___198_8345.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___198_8345.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___198_8345.FStar_TypeChecker_Env.qname_and_index}) t)
in (match (uu____8341) with
| (uu____8346, ty, uu____8348) -> begin
...
let uu____8350 = (env.FStar_TypeChecker_Env.type_of (

let uu___199_8354 = env
in {FStar_TypeChecker_Env.solver = uu___199_8354.FStar_TypeChecker_Env.solver; FStar_TypeChecker_Env.range = uu___199_8354.FStar_TypeChecker_Env.range; FStar_TypeChecker_Env.curmodule = uu___199_8354.FStar_TypeChecker_Env.curmodule; FStar_TypeChecker_Env.gamma = uu___199_8354.FStar_TypeChecker_Env.gamma; FStar_TypeChecker_Env.gamma_cache = uu___199_8354.FStar_TypeChecker_Env.gamma_cache; FStar_TypeChecker_Env.modules = uu___199_8354.FStar_TypeChecker_Env.modules; FStar_TypeChecker_Env.expected_typ = None; FStar_TypeChecker_Env.sigtab = uu___199_8354.FStar_TypeChecker_Env.sigtab; FStar_TypeChecker_Env.is_pattern = uu___199_8354.FStar_TypeChecker_Env.is_pattern; FStar_TypeChecker_Env.instantiate_imp = uu___199_8354.FStar_TypeChecker_Env.instantiate_imp; FStar_TypeChecker_Env.effects = uu___199_8354.FStar_TypeChecker_Env.effects; FStar_TypeChecker_Env.generalize = uu___199_8354.FStar_TypeChecker_Env.generalize; FStar_TypeChecker_Env.letrecs = uu___199_8354.FStar_TypeChecker_Env.letrecs; FStar_TypeChecker_Env.top_level = uu___199_8354.FStar_TypeChecker_Env.top_level; FStar_TypeChecker_Env.check_uvars = uu___199_8354.FStar_TypeChecker_Env.check_uvars; FStar_TypeChecker_Env.use_eq = uu___199_8354.FStar_TypeChecker_Env.use_eq; FStar_TypeChecker_Env.is_iface = uu___199_8354.FStar_TypeChecker_Env.is_iface; FStar_TypeChecker_Env.admit = uu___199_8354.FStar_TypeChecker_Env.admit; FStar_TypeChecker_Env.lax = true; FStar_TypeChecker_Env.lax_universes = uu___199_8354.FStar_TypeChecker_Env.lax_universes; FStar_TypeChecker_Env.type_of = uu___199_8354.FStar_TypeChecker_Env.type_of; FStar_TypeChecker_Env.universe_of = uu___199_8354.FStar_TypeChecker_Env.universe_of; FStar_TypeChecker_Env.use_bv_sorts = true; FStar_TypeChecker_Env.qname_and_index = uu___199_8354.FStar_TypeChecker_Env.qname_and_index}) t)
in (match (uu____8350) with
| (uu____8355, ty, uu____8357) -> begin
(eta_expand_with_type env t ty)
end))
end))
end))
