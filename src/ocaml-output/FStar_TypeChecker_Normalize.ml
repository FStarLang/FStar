                          ...
                          | uu____5651::[] ->
                              (match lopt with
                               | None  when FStar_Options.__unit_tests () ->
                                   (log cfg
                                      (fun uu____5664  ->
                                         let uu____5665 = closure_to_string c
                                            in
                               ...
                               | Some (FStar_Util.Inr (l,cflags)) when
                                   ...
                                   (log cfg
                                      (fun uu____5682  ->
                                         let uu____5683 = closure_to_string c
                                            in
                                         FStar_Util.print1 "\tShifted %s\n"
                                           uu____5683);
                                    norm cfg (c :: env) stack_rest body)
                               | Some (FStar_Util.Inl lc) when
                                   ...
                                   (log cfg
                                      (fun uu____5694  ->
                                         let uu____5695 = closure_to_string c
                                            in
                                         FStar_Util.print1 "\tShifted %s\n"
                                           uu____5695);
                                    norm cfg (c :: env) stack_rest body)
                ...
                | (Debug _)::_
                  |(Meta _)::_|(Let _)::_|(App _)::_|(Abs _)::_|[] ->
                    ...
                    then
                      ...
                      (let uu____5775 = FStar_Syntax_Subst.open_term' bs body
                          in
           ...
           | FStar_Syntax_Syntax.Tm_refine (x,f) ->
               ...
               then
                 ...
                 (let t_x = norm cfg env [] x.FStar_Syntax_Syntax.sort  in
                  let uu____5975 = FStar_Syntax_Subst.open_term [(x, None)] f
                     in
                             ...
                             let uu____6488 =
                               let uu____6489 =
                                 ...
                                 (rec_env, (lb.FStar_Syntax_Syntax.lbdef),
                                  ...
                                  in
                               Clos uu____6489  in
                             uu____6488 :: env1) (Prims.snd lbs) env
                       in
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m1,t2) ->
                    ...
                    then
                      ...
                      (let uu____6560 =
                         let uu____6561 = FStar_Syntax_Subst.compress head1
                            in
                       ...
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____6575 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                           ...
                                           let uu____6603 =
                                             let uu____6604 =
                                               FStar_Syntax_Subst.compress e1
                                                in
                                             uu____6604.FStar_Syntax_Syntax.n
                                              in
                       ...
                       | FStar_Syntax_Syntax.Tm_app (head_app,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m1
                              in
                           let uu____6853 = ed.FStar_Syntax_Syntax.bind_repr
                              in
                                ...
                                ((let is_arg_impure uu____6925 =
                                    ...
                                    | (e,q) ->
                                        let uu____6930 =
                                          let uu____6931 =
                                            FStar_Syntax_Subst.compress e  in
                                          uu____6931.FStar_Syntax_Syntax.n
                                           in
                                              ...
                                              (FStar_Syntax_Syntax.Tm_meta
                                                 (body,
                                                   (FStar_Syntax_Syntax.Meta_monadic
                                                      (m1, t2))))
                                        | Some (true ) -> body  in
                                      let uu____6993 = FStar_List.tl stack1
                                         in
        ...
        fun mtgt  ->
          fun t  ->
            ...
            then
              ...
              (let uu____7319 = FStar_TypeChecker_Env.monad_leq env msrc mtgt
                  in
        ...
        | FStar_Syntax_Syntax.Comp ct ->
            ...
            let uu____7498 =
              let uu____7499 =
                ...
                let uu____7505 = norm_args ct.FStar_Syntax_Syntax.effect_args
                   in
                {
              ...
              (log cfg
               ...
               (let scrutinee = t  in
                  ...
                  (let whnf = FStar_List.contains WHNF cfg.steps  in
                             ...
                             (FStar_List.fold_left
                                (fun uu____8047  ->
                                   fun uu____8048  ->
                                     ...
                                     | ((pats1,env3),(p1,b)) ->
                                         let uu____8113 = norm_pat env3 p1
                                            in
                   ...
                   let uu____8284 =
                     mk (FStar_Syntax_Syntax.Tm_match (scrutinee, branches1))
                       r
                      in
                   rebuild cfg env1 stack2 uu____8284)
                   in
                ...
                let rec matches_pat scrutinee1 p =
                  ...
                  let uu____8404 = FStar_Syntax_Util.head_and_args scrutinee2
                     in
                      ...
                      (match uu____8595 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____8609 -> FStar_Util.Inr false
                 in
                                 ...
                                 (fun env2  ->
                                    fun t1  ->
                                      let uu____8702 =
                                        ...
                                        Clos uu____8703  in
                                      uu____8702 :: env2) env1 s
                                in
                             let uu____8736 = guard_when_clause wopt b rest
                                in
                             norm cfg env2 stack2 uu____8736)))
                   in
                let uu____8737 =
                  FStar_All.pipe_right cfg.steps
...
let normalize_universe :
  ...
  fun env  ->
    fun u  ->
      let uu____8804 = config [] env  in norm_universe uu____8804 [] u
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t01.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____8891 =
                     let uu____8892 =
                       let uu____8897 = FStar_Syntax_Util.mk_conj phi1 phi
                          in
                       (y, uu____8897)  in
           ...
           | (head1,args) ->
               ...
               (match uu____9079 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____9083,thead) ->
                    let uu____9097 = FStar_Syntax_Util.arrow_formals thead
                       in
